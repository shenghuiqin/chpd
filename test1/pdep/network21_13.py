...
species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(2.81983,'amu*angstrom^2'), symmetry=1, barrier=(64.8334,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.81917,'amu*angstrom^2'), symmetry=1, barrier=(64.8182,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.108775,'amu*angstrom^2'), symmetry=1, barrier=(20.2812,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (80.1277,'amu'),
...
species(
    ...
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.641849,0.068887,-5.10449e-05,1.98521e-08,-3.18226e-12,47060.3,27.2927], Tmin=(100,'K'), Tmax=(1446.1,'K')), NASAPolynomial(coeffs=[13.855,0.0323386,-1.31343e-05,2.37495e-09,-1.60838e-13,43238.8,-41.3271], Tmin=(1446.1,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(390.244,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(390.78,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(CdJ2_singlet-Cds)"""),
)
...
reaction(
    label = 'reaction849',
    reactants = ['CH2(S)(28)', 'C=C[C]CC=C(703)'],
    products = ['C=C[C]CC=CC(348)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(9.18309e+11,'s^-1'), n=0.345439, Ea=(91.3359,'kJ/mol'), T0=(1,'K'), Tmin=(303.03,'K'), Tmax=(2000,'K'), comment="""From training reaction 2 used for CsJ2-C;CsJ2(CsC);CH=C
...
network(
    ...
    reactants = [
        ('H(10)', 'C=C[C]=CC1CC1(125)'),
        ('CH3(23)', '[CH]1C=CC=CC1(277)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
