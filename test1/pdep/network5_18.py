...
species(
    label = 'C=C1C=C[CH]C1(480)',
    structure = SMILES('C=C1[CH]C=CC1'),
    E0 = (184.116,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,2950,3050,3150,900,950,1000,1050,1100,2950,3100,1380,975,1025,1650,300,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (79.1198,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.71234,0.00330101,0.000118073,-1.57973e-07,6.14727e-11,22213.3,15.3366], Tmin=(100,'K'), Tmax=(938.882,'K')), NASAPolynomial(coeffs=[14.941,0.0151427,-2.9999e-06,5.32874e-10,-4.77306e-14,17098.9,-57.8966], Tmin=(938.882,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(184.116,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(332.579,'J/(mol*K)'), comment="""QM MopacMolPM3 calculation attempt 1 + radical(C=CCJC=C)"""),
)

species(
    label = 'C=C1C=C[C](C)C1(481)',
    structure = SMILES('C=C1[CH]C=C(C)C1'),
    E0 = (138.26,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,2750,2800,2850,1350,1500,750,1050,1375,1000,2950,3100,1380,975,1025,1650,300,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (93.1464,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.93278,0.0221952,8.97978e-05,-1.31968e-07,5.20577e-11,16724.4,19.3881], Tmin=(100,'K'), Tmax=(951.056,'K')), NASAPolynomial(coeffs=[15.2443,0.0250784,-7.59796e-06,1.38884e-09,-1.05586e-13,11530,-58.1612], Tmin=(951.056,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(138.26,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(403.252,'J/(mol*K)'), comment="""QM MopacMolPM3 calculation attempt 2 + radical(C=CCJC=C)"""),
)

species(
    label = 'C=C1[CH]C(C)C=C1(482)',
    structure = SMILES('C=C1[CH]C(C)C=C1'),
    E0 = (197.645,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,2750,2800,2850,1350,1500,750,1050,1375,1000,2950,3100,1380,975,1025,1650,300,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
    ...
    molecularWeight = (93.1464,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.92561,0.0248082,7.58748e-05,-1.12396e-07,4.35208e-11,23864.5,19.2675], Tmin=(100,'K'), Tmax=(971.331,'K')), NASAPolynomial(coeffs=[13.7739,0.0282291,-1.00388e-05,1.91092e-09,-1.4276e-13,19099.7,-50.2278], Tmin=(971.331,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(197.645,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(403.252,'J/(mol*K)'), comment="""QM MopacMolPM3 calculation attempt 1 + radical(Allyl_S)"""),
)

species(
    label = '[CH2]C1C=CC(=C)C1(483)',
    structure = SMILES('[CH2]C1C=CC(=C)C1'),
    E0 = (261.614,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,2950,3050,3150,900,950,1000,1050,1100,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,300,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (93.1464,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.74417,0.0317375,5.43411e-05,-9.13223e-08,3.69203e-11,31562.3,22.1134], Tmin=(100,'K'), Tmax=(956.854,'K')), NASAPolynomial(coeffs=[13.4664,0.0274327,-8.98134e-06,1.61654e-09,-1.1747e-13,27272.8,-44.6152], Tmin=(956.854,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(261.614,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(403.252,'J/(mol*K)'), comment="""QM MopacMolPM3 calculation attempt 1 + radical(Isobutyl)"""),
)

species(
    label = 'C=C1C=[C]C(C)C1(484)',
    structure = SMILES('C=C1C=[C]C(C)C1'),
    E0 = (314.039,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,2750,2800,2850,1350,1500,750,1050,1375,1000,2950,3100,1380,975,1025,1650,300,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (93.1464,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.68631,0.0347238,4.18387e-05,-7.42972e-08,2.94558e-11,37867.8,21.0138], Tmin=(100,'K'), Tmax=(987.729,'K')), NASAPolynomial(coeffs=[12.594,0.0301273,-1.12832e-05,2.12326e-09,-1.54202e-13,33782.4,-41.2476], Tmin=(987.729,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(314.039,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(403.252,'J/(mol*K)'), comment="""QM MopacMolPM3 calculation attempt 1 + radical(cyclopentene-vinyl)"""),
)

species(
    label = 'C=C1[C]=CC(C)C1(485)',
    structure = SMILES('C=C1[C]=CC(C)C1'),
    E0 = (255.527,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,2750,2800,2850,1350,1500,750,1050,1375,1000,2950,3100,1380,975,1025,1650,300,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (93.1464,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.63451,0.0367571,3.71739e-05,-7.01556e-08,2.83943e-11,30831.7,21.0153], Tmin=(100,'K'), Tmax=(976.034,'K')), NASAPolynomial(coeffs=[12.2241,0.0307438,-1.10397e-05,2.02003e-09,-1.44533e-13,26983.7,-38.9391], Tmin=(976.034,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(255.527,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(403.252,'J/(mol*K)'), comment="""QM MopacMolPM3 calculation attempt 1 + radical(C=CJC=C)"""),
)

species(
    label = '[CH]=C1C=CC(C)C1(486)',
    structure = SMILES('[CH]=C1C=CC(C)C1'),
    E0 = (303.628,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,2950,3050,3150,900,950,1000,1050,1100,2750,2800,2850,1350,1500,750,1050,1375,1000,3120,650,792.5,1650,300,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (93.1464,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.64675,0.0336374,4.99775e-05,-8.6159e-08,3.44784e-11,36619,21.778], Tmin=(100,'K'), Tmax=(975.639,'K')), NASAPolynomial(coeffs=[13.9768,0.0278719,-1.00153e-05,1.88567e-09,-1.38842e-13,32081.5,-48.3272], Tmin=(975.639,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(303.628,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(403.252,'J/(mol*K)'), comment="""QM MopacMolPM3 calculation attempt 1 + radical(Cds_P)"""),
)

species(
    label = 'C=C1[CH]C[C](C)C1(487)',
    structure = SMILES('[CH2]C1=CC[C](C)C1'),
    E0 = (261.229,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,2950,3050,3150,900,950,1000,1050,1100,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,300,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    ...
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.62401,0.0390783,2.87231e-05,-5.46114e-08,2.06689e-11,31515.5,23.8913], Tmin=(100,'K'), Tmax=(1038.8,'K')), NASAPolynomial(coeffs=[10.0894,0.0380309,-1.53208e-05,2.89085e-09,-2.05687e-13,28054.4,-25.4651], Tmin=(1038.8,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(261.229,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(448.981,'J/(mol*K)'), comment="""QM MopacMolPM3 calculation attempt 1 + radical(Allyl_P) + radical(Tertalkyl)"""),
)

species(
    label = '[CH2]C1[CH]C(C)C=C1(488)',
    structure = SMILES('[CH2]C1[CH]C(C)C=C1'),
    E0 = (336.6,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,2950,3050,3150,900,950,1000,1050,1100,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,300,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.78769,0.0333962,4.68298e-05,-7.62769e-08,2.93742e-11,40576.8,25.4247], Tmin=(100,'K'), Tmax=(990.062,'K')), NASAPolynomial(coeffs=[10.57,0.0354607,-1.3183e-05,2.43717e-09,-1.73973e-13,36997.6,-26.1505], Tmin=(990.062,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(336.6,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(448.981,'J/(mol*K)'), comment="""QM MopacMolPM3 calculation attempt 1 + radical(cyclopentene-4) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]C1[C]=CC(C)C1(489)',
    ...
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.59016,0.0374167,4.0227e-05,-7.31946e-08,2.9271e-11,49064.1,24.2595], Tmin=(100,'K'), Tmax=(978.948,'K')), NASAPolynomial(coeffs=[11.9506,0.0332743,-1.19436e-05,2.18452e-09,-1.55973e-13,45205.6,-34.8499], Tmin=(978.948,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(407.105,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(448.981,'J/(mol*K)'), comment="""QM MopacMolPM3 calculation attempt 1 + radical(Isobutyl) + radical(cyclopentene-vinyl)"""),
)

species(
    label = 'C=C1[CH]CC(C)[CH]1(490)',
    structure = SMILES('[CH2]C1[CH]C(C)CC=1'),
    E0 = (203.112,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,2950,3050,3150,900,950,1000,1050,1100,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,300,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.75542,0.0262624,8.48459e-05,-1.24964e-07,4.83496e-11,24530.3,20.4817], Tmin=(100,'K'), Tmax=(971.482,'K')), NASAPolynomial(coeffs=[14.9207,0.0300776,-1.06327e-05,2.03545e-09,-1.53016e-13,19234.3,-56.744], Tmin=(971.482,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(203.112,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(448.981,'J/(mol*K)'), comment="""QM MopacMolPM3 calculation attempt 1 + radical(Allyl_P) + radical(cyclopentene-allyl)"""),
)

species(
    label = '[CH2]C1C[CH]C(=C)C1(491)',
    structure = SMILES('[CH2]C1=CCC([CH2])C1'),
    E0 = (280.889,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2830,2910,2990,3070,3150,900,940,980,1020,1060,1100,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,300,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    ...
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.57331,0.0332004,6.32785e-05,-1.03841e-07,4.1725e-11,33888.7,24.0231], Tmin=(100,'K'), Tmax=(958.747,'K')), NASAPolynomial(coeffs=[14.6133,0.0292808,-9.57497e-06,1.74099e-09,-1.27719e-13,29068,-50.4387], Tmin=(958.747,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(280.889,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(448.981,'J/(mol*K)'), comment="""QM MopacMolPM3 calculation attempt 1 + radical(Isobutyl) + radical(Allyl_P)"""),
)

species(
    label = '[CH2]C1C=C[C](C)C1(492)',
    structure = SMILES('[CH2]C1[CH]C=C(C)C1'),
    E0 = (256.695,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,2950,3050,3150,900,950,1000,1050,1100,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,300,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
    ...
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.767,0.0305288,6.34434e-05,-9.85876e-08,3.84814e-11,30970.3,21.9409], Tmin=(100,'K'), Tmax=(970.236,'K')), NASAPolynomial(coeffs=[12.5065,0.0326081,-1.14367e-05,2.10662e-09,-1.52785e-13,26704.5,-40.7901], Tmin=(970.236,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(256.695,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(448.981,'J/(mol*K)'), comment="""QM MopacMolPM3 calculation attempt 1 + radical(Isobutyl) + radical(cyclopentene-allyl)"""),
)

species(
    label = 'C=C1[CH]C(C)[CH]C1(493)',
    ...
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.70361,0.0326469,5.5781e-05,-8.81227e-08,3.37172e-11,31895.4,24.2237], Tmin=(100,'K'), Tmax=(996.426,'K')), NASAPolynomial(coeffs=[12.286,0.0343247,-1.32208e-05,2.51982e-09,-1.83663e-13,27594.3,-37.7925], Tmin=(996.426,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(264.375,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(448.981,'J/(mol*K)'), comment="""QM MopacMolPM3 calculation attempt 1 + radical(Allyl_P) + radical(cyclopentene-4)"""),
)

species(
    label = '[CH]=C1C[CH]C(C)C1(494)',
    structure = SMILES('[CH]=C1C[CH]C(C)C1'),
    E0 = (378.678,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2830,2910,2990,3070,3150,900,940,980,1020,1060,1100,2750,2800,2850,1350,1500,750,1050,1375,1000,3120,650,792.5,1650,300,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.72569,0.0325108,5.38287e-05,-8.52468e-08,3.24906e-11,45641.7,25.0322], Tmin=(100,'K'), Tmax=(1001.65,'K')), NASAPolynomial(coeffs=[12.1774,0.034046,-1.32728e-05,2.5441e-09,-1.85722e-13,41377.1,-36.2445], Tmin=(1001.65,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(378.678,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""QM MopacMolPM3 calculation attempt 1 + radical(Cds_P) + radical(Cs_S)"""),
)

species(
    label = '[CH2]C1C=[C]C(C)C1(495)',
    structure = SMILES('[CH2]C1C=[C]C(C)C1'),
    E0 = (407.105,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,2950,3050,3150,900,950,1000,1050,1100,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,300,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
    ...
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.59016,0.0374167,4.0227e-05,-7.31946e-08,2.9271e-11,49064.1,24.2595], Tmin=(100,'K'), Tmax=(978.948,'K')), NASAPolynomial(coeffs=[11.9506,0.0332743,-1.19436e-05,2.18452e-09,-1.55973e-13,45205.6,-34.8499], Tmin=(978.948,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(407.105,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(448.981,'J/(mol*K)'), comment="""QM MopacMolPM3 calculation attempt 1 + radical(cyclopentene-vinyl) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]C1[CH]CC(=C)C1(496)',
    structure = SMILES('[CH2]C1[CH]CC(=C)C1'),
    E0 = (336.664,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2830,2910,2990,3070,3150,900,940,980,1020,1060,1100,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,300,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.82076,0.030654,5.79602e-05,-8.99729e-08,3.46778e-11,40585.2,25.375], Tmin=(100,'K'), Tmax=(981.575,'K')), NASAPolynomial(coeffs=[11.6021,0.0337117,-1.22972e-05,2.28838e-09,-1.65439e-13,36597.4,-32.164], Tmin=(981.575,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(336.664,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""QM MopacMolPM3 calculation attempt 1 + radical(Cs_S) + radical(Isobutyl)"""),
)

species(
    label = 'C[C]1C=C[C](C)C1(497)',
    structure = SMILES('C[C]1C=C[C](C)C1'),
    E0 = (208.478,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,300,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    ...
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.16296,0.0203021,8.86175e-05,-1.20791e-07,4.53212e-11,25158.2,17.1483], Tmin=(100,'K'), Tmax=(972.016,'K')), NASAPolynomial(coeffs=[10.9164,0.0350635,-1.25301e-05,2.33134e-09,-1.69844e-13,21057.5,-37.1741], Tmin=(972.016,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(208.478,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(448.981,'J/(mol*K)'), comment="""QM MopacMolPM3 calculation attempt 1 + radical(Allyl_T) + radical(Allyl_T)"""),
)

species(
    label = '[CH]=C1[CH]CC(C)C1(498)',
    structure = SMILES('[CH]C1=CCC(C)C1'),
    E0 = (294.992,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2830,2910,2990,3070,3150,900,940,980,1020,1060,1100,2750,2800,2850,1350,1500,750,1050,1375,1000,300,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    ...
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.55043,0.0339786,6.75259e-05,-1.03529e-07,3.9603e-11,35585.2,23.1528], Tmin=(100,'K'), Tmax=(986.281,'K')), NASAPolynomial(coeffs=[12.5752,0.0386302,-1.46247e-05,2.74669e-09,-1.98766e-13,31009.5,-42.0545], Tmin=(986.281,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(294.992,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(448.981,'J/(mol*K)'), comment="""QM MopacMolPM3 calculation attempt 1 + radical(AllylJ2_triplet)"""),
)

species(
    label = 'C[C]1C=[C]C(C)C1(499)',
    structure = SMILES('C[C]1C=[C]C(C)C1'),
    E0 = (334.004,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,300,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
    ...
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.84868,0.0303349,5.82601e-05,-8.86421e-08,3.3656e-11,40263.8,20.4972], Tmin=(100,'K'), Tmax=(990.79,'K')), NASAPolynomial(coeffs=[11.0174,0.0354838,-1.33697e-05,2.50715e-09,-1.80938e-13,36377.4,-34.0956], Tmin=(990.79,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(334.004,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(448.981,'J/(mol*K)'), comment="""QM MopacMolPM3 calculation attempt 1 + radical(cyclopentene-vinyl) + radical(Allyl_T)"""),
)

species(
    label = '[CH2]C1C=CC([CH2])C1(500)',
    ...
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.65152,0.0343799,5.29545e-05,-9.05922e-08,3.69352e-11,42758.5,24.6539], Tmin=(100,'K'), Tmax=(948.165,'K')), NASAPolynomial(coeffs=[12.848,0.0305398,-9.61986e-06,1.67282e-09,-1.18839e-13,38684.7,-39.0528], Tmin=(948.165,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(354.681,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(448.981,'J/(mol*K)'), comment="""QM MopacMolPM3 calculation attempt 1 + radical(Isobutyl) + radical(Isobutyl)"""),
)

species(
    label = 'C=C1C[CH][C](C)C1(501)',
    structure = SMILES('C=C1C[CH][C](C)C1'),
    E0 = (317.004,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,2950,3050,3150,900,950,1000,1050,1100,2750,2800,2850,1350,1500,750,1050,1375,1000,2950,3100,1380,975,1025,1650,300,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.8749,0.0363967,2.43561e-05,-4.27309e-08,1.48237e-11,38211.8,25.2368], Tmin=(100,'K'), Tmax=(1112.34,'K')), NASAPolynomial(coeffs=[7.64494,0.0415587,-1.75466e-05,3.3251e-09,-2.34278e-13,35325.2,-10.4201], Tmin=(1112.34,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(317.004,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""QM MopacMolPM3 calculation attempt 1 + radical(Cs_S) + radical(Tertalkyl)"""),
)

species(
    label = 'C[C]1[C]=CC(C)C1(502)',
    ...
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.71052,0.0334856,5.11138e-05,-8.19033e-08,3.12208e-11,37275.7,20.8371], Tmin=(100,'K'), Tmax=(1002.08,'K')), NASAPolynomial(coeffs=[11.6925,0.035208,-1.36857e-05,2.60118e-09,-1.88529e-13,33188.1,-37.7545], Tmin=(1002.08,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(309.119,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(448.981,'J/(mol*K)'), comment="""QM MopacMolPM3 calculation attempt 1 + radical(cyclopentene-vinyl) + radical(cyclopentene-allyl)"""),
)

species(
    label = 'C[C]1[CH]C(C)C=C1(503)',
    structure = SMILES('CC1[CH]C(C)[CH]C=1'),
    E0 = (178.918,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,300,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.95137,0.0235583,8.51552e-05,-1.19949e-07,4.52329e-11,21611.8,18.3917], Tmin=(100,'K'), Tmax=(982.318,'K')), NASAPolynomial(coeffs=[12.8301,0.0333789,-1.24801e-05,2.39782e-09,-1.77819e-13,16863.4,-47.1882], Tmin=(982.318,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(178.918,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(448.981,'J/(mol*K)'), comment="""QM MopacMolPM3 calculation attempt 1 + radical(cyclopentene-allyl) + radical(cyclopentene-allyl)"""),
)

species(
    label = 'C=C1C=CCC1(504)',
    structure = SMILES('C=C1C=CCC1'),
    E0 = (83.3307,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (80.1277,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.42683,0.0150025,8.17508e-05,-1.14316e-07,4.40221e-11,10096.7,16.1611], Tmin=(100,'K'), Tmax=(960.19,'K')), NASAPolynomial(coeffs=[12.5051,0.0225803,-7.51292e-06,1.41742e-09,-1.0744e-13,5876.58,-43.9488], Tmin=(960.19,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(83.3307,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(332.579,'J/(mol*K)'), comment="""QM MopacMolPM3 calculation attempt 1"""),
)

species(
    label = '[CH]=CC(C)C[C]=C(505)',
    structure = SMILES('[CH]=CC(C)C[C]=C'),
    E0 = (516.886,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,1685,370,3010,987.5,1337.5,450,1655,2750,2800,2850,1350,1500,750,1050,1375,1000,2950,3100,1380,975,1025,1650,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.145074,'amu*angstrom^2'), symmetry=1, barrier=(13.5893,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0165958,'amu*angstrom^2'), symmetry=1, barrier=(2.54354,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0901128,'amu*angstrom^2'), symmetry=1, barrier=(13.5749,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.593084,'amu*angstrom^2'), symmetry=1, barrier=(13.6362,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (94.1543,'amu'),
...
species(
    label = '[CH]=CC(=C)C[CH]C(506)',
    structure = SMILES('[CH]=CC(=C)C[CH]C'),
    E0 = (451.447,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,350,440,435,1725,2750,2850,1437.5,1250,1305,750,350,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.0134223,'amu*angstrom^2'), symmetry=1, barrier=(12.5937,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.548206,'amu*angstrom^2'), symmetry=1, barrier=(12.6043,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.221231,'amu*angstrom^2'), symmetry=1, barrier=(5.08653,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0627105,'amu*angstrom^2'), symmetry=1, barrier=(16.8816,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.475854,0.0694845,-5.26275e-05,2.12494e-08,-3.50685e-12,54430,29.5473], Tmin=(100,'K'), Tmax=(1427.66,'K')), NASAPolynomial(coeffs=[14.5046,0.0301791,-1.13309e-05,1.96546e-09,-1.30044e-13,50424.3,-43.1284], Tmin=(1427.66,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(451.447,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(390.78,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cds_P) + radical(RCCJC)"""),
)

species(
    label = '[CH2]C(C)C=C[C]=C(507)',
    structure = SMILES('[CH2]C(C)C=C[C]=C'),
    E0 = (407.576,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,2995,3025,975,1000,1300,1375,400,500,1630,1680,2750,2800,2850,1350,1500,750,1050,1375,1000,2950,3100,1380,975,1025,1650,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,302.392,302.396],'cm^-1')),
        HinderedRotor(inertia=(0.183731,'amu*angstrom^2'), symmetry=1, barrier=(11.9188,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.183679,'amu*angstrom^2'), symmetry=1, barrier=(11.9184,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.339041,'amu*angstrom^2'), symmetry=1, barrier=(21.9942,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.12692,'amu*angstrom^2'), symmetry=1, barrier=(73.1064,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (94.1543,'amu'),
...
species(
    ...
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.48055,0.0369429,4.92667e-05,-8.66353e-08,3.46333e-11,37629,21.7499], Tmin=(100,'K'), Tmax=(978.804,'K')), NASAPolynomial(coeffs=[14.0227,0.0311258,-1.14517e-05,2.1475e-09,-1.56595e-13,32997.1,-49.609], Tmin=(978.804,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(311.974,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(403.252,'J/(mol*K)'), comment="""QM MopacMolPM3 calculation attempt 1"""),
)

species(
    label = 'C=C1[C]CC(C)C1(509)',
    structure = SMILES('C=C1[C]CC(C)C1'),
    E0 = (313.03,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,2950,3050,3150,900,950,1000,1050,1100,2750,2800,2850,1350,1500,750,1050,1375,1000,2950,3100,1380,975,1025,1650,300,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
    ...
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.5824,0.0345786,5.41597e-05,-9.03107e-08,3.55745e-11,37752.5,21.5742], Tmin=(100,'K'), Tmax=(980.927,'K')), NASAPolynomial(coeffs=[13.5006,0.0318598,-1.18423e-05,2.22857e-09,-1.62555e-13,33206.9,-46.9461], Tmin=(980.927,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(313.03,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(403.252,'J/(mol*K)'), comment="""QM MopacMolPM3 calculation attempt 1"""),
)

species(
    label = '[CH]C1C=CC(C)C1(510)',
    structure = SMILES('[CH]C1C=CC(C)C1'),
    E0 = (392.572,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2830,2910,2990,3070,3150,900,940,980,1020,1060,1100,2750,2800,2850,1350,1500,750,1050,1375,1000,300,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
    ...
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.52421,0.0350054,5.60995e-05,-9.43823e-08,3.75057e-11,47322,21.3897], Tmin=(100,'K'), Tmax=(975.776,'K')), NASAPolynomial(coeffs=[14.3025,0.030708,-1.1212e-05,2.10792e-09,-1.54547e-13,42539.1,-51.6749], Tmin=(975.776,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(392.572,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(399.095,'J/(mol*K)'), comment="""QM MopacMolPM3 calculation attempt 1"""),
)

species(
    label = 'CC1CC2=CC1C2(511)',
    structure = SMILES('CC1CC2=CC1C2'),
    E0 = (497.749,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.9554,0.0184733,0.000108804,-1.53319e-07,5.95068e-11,59963,19.0452], Tmin=(100,'K'), Tmax=(956.666,'K')), NASAPolynomial(coeffs=[16.1737,0.0260944,-8.30859e-06,1.577e-09,-1.22094e-13,54173.4,-64.9612], Tmin=(956.666,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(497.749,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(403.252,'J/(mol*K)'), comment="""QM MopacMolPM3 calculation attempt 1"""),
)
...
reaction(
    label = 'reaction553',
    reactants = ['CH3(23)', 'C=C1C=C[CH]C1(480)'],
    products = ['C=C1C=CC(C)C1(399)'],
    transitionState = 'TS553',
    kinetics = Arrhenius(A=(2.66327e+09,'m^3/(mol*s)'), n=-0.416379, Ea=(6.36255,'kJ/mol'), T0=(1,'K'), Tmin=(303.03,'K'), Tmax=(2000,'K'), comment="""Estimated using template [C_rad/H/CdCs;Y_rad] for rate rule [C_rad/H/CdCs;C_methyl]
Euclidian distance = 2.0
family: R_Recombination"""),
)
...
reaction(
    label = 'reaction554',
    reactants = ['H(10)', 'C=C1C=C[C](C)C1(481)'],
    products = ['C=C1C=CC(C)C1(399)'],
...
reaction(
    label = 'reaction555',
    reactants = ['H(10)', 'C=C1[CH]C(C)C=C1(482)'],
    products = ['C=C1C=CC(C)C1(399)'],
...
reaction(
    label = 'reaction556',
    reactants = ['H(10)', '[CH2]C1C=CC(=C)C1(483)'],
    products = ['C=C1C=CC(C)C1(399)'],
...
reaction(
    label = 'reaction557',
    reactants = ['H(10)', 'C=C1C=[C]C(C)C1(484)'],
    products = ['C=C1C=CC(C)C1(399)'],
...
reaction(
    label = 'reaction558',
    reactants = ['H(10)', 'C=C1[C]=CC(C)C1(485)'],
    products = ['C=C1C=CC(C)C1(399)'],
...
reaction(
    label = 'reaction559',
    reactants = ['H(10)', '[CH]=C1C=CC(C)C1(486)'],
    products = ['C=C1C=CC(C)C1(399)'],
...
reaction(
    label = 'reaction560',
    reactants = ['C=C1[CH]C[C](C)C1(487)'],
    products = ['C=C1C=CC(C)C1(399)'],
...
reaction(
    label = 'reaction561',
    reactants = ['[CH2]C1[CH]C(C)C=C1(488)'],
    products = ['C=C1C=CC(C)C1(399)'],
...
reaction(
    label = 'reaction562',
    reactants = ['[CH2]C1[C]=CC(C)C1(489)'],
    products = ['C=C1C=CC(C)C1(399)'],
...
reaction(
    label = 'reaction563',
    reactants = ['C=C1[CH]CC(C)[CH]1(490)'],
    products = ['C=C1C=CC(C)C1(399)'],
...
reaction(
    label = 'reaction564',
    reactants = ['[CH2]C1C[CH]C(=C)C1(491)'],
    products = ['C=C1C=CC(C)C1(399)'],
...
reaction(
    label = 'reaction565',
    reactants = ['[CH2]C1C=C[C](C)C1(492)'],
    products = ['C=C1C=CC(C)C1(399)'],
...
reaction(
    label = 'reaction566',
    reactants = ['C=C1[CH]C(C)[CH]C1(493)'],
    products = ['C=C1C=CC(C)C1(399)'],
...
reaction(
    label = 'reaction567',
    reactants = ['[CH]=C1C[CH]C(C)C1(494)'],
    products = ['C=C1C=CC(C)C1(399)'],
...
reaction(
    label = 'reaction568',
    reactants = ['[CH2]C1C=[C]C(C)C1(495)'],
    products = ['C=C1C=CC(C)C1(399)'],
...
reaction(
    label = 'reaction569',
    reactants = ['[CH2]C1[CH]CC(=C)C1(496)'],
    products = ['C=C1C=CC(C)C1(399)'],
...
reaction(
    label = 'reaction570',
    reactants = ['C[C]1C=C[C](C)C1(497)'],
    products = ['C=C1C=CC(C)C1(399)'],
    transitionState = 'TS570',
    kinetics = Arrhenius(A=(2.68987e+09,'s^-1'), n=0.311, Ea=(13.075,'kJ/mol'), T0=(1,'K'), comment="""Estimated using average of templates [R4;Y_rad;XH_Rrad_De] + [R4;Y_rad_NDe;XH_Rrad] for rate rule [R4radEndo;Y_rad_NDe;XH_Rrad_De]
Euclidian distance = 1.41421356237
Multiplied by reaction path degeneracy 6.0
family: Intra_Disproportionation"""),
)
...
reaction(
    label = 'reaction571',
    reactants = ['[CH]=C1[CH]CC(C)C1(498)'],
    products = ['C=C1C=CC(C)C1(399)'],
...
reaction(
    label = 'reaction573',
    reactants = ['[CH2]C1C=CC([CH2])C1(500)'],
    products = ['C=C1C=CC(C)C1(399)'],
...
reaction(
    label = 'reaction576',
    reactants = ['C[C]1[CH]C(C)C=C1(503)'],
    products = ['C=C1C=CC(C)C1(399)'],
...
reaction(
    label = 'reaction577',
    reactants = ['CH2(S)(28)', 'C=C1C=CCC1(504)'],
    products = ['C=C1C=CC(C)C1(399)'],
...
reaction(
    label = 'reaction580',
    reactants = ['[CH2]C(C)C=C[C]=C(507)'],
    products = ['C=C1C=CC(C)C1(399)'],
    transitionState = 'TS580',
    kinetics = Arrhenius(A=(7.76e+09,'s^-1'), n=0.311, Ea=(7.1128,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R5;C_rad_out_2H;Ypri_rad_out] for rate rule [R5_SSDS;C_rad_out_2H;Ypri_rad_out]
Euclidian distance = 1.0
family: Birad_recombination"""),
)
...
reaction(
    label = 'reaction584',
    reactants = ['C=C1C=CC(C)C1(399)'],
    products = ['CC1CC2=CC1C2(511)'],
    transitionState = 'TS584',
    kinetics = Arrhenius(A=(4.99998e+11,'s^-1'), n=0.0559095, Ea=(441.213,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [1,3-butadiene_backbone;C=C_1;C=C_2] for rate rule [1,3-butadiene_backbone;CdH2_1;CdH(C)_2]
Euclidian distance = 1.41421356237
family: Intra_2+2_cycloaddition_Cd
Ea raised from 439.8 to 441.2 kJ/mol to match endothermicity of reaction."""),
)
