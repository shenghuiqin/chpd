...
species(
    label = 'C=CC1[CH]CCC=1(512)',
    structure = SMILES('C=CC1[CH]CCC=1'),
    E0 = (184.193,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2830,2910,2990,3070,3150,900,940,980,1020,1060,1100,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,300,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (93.1464,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.00948,0.0224607,8.19979e-05,-1.17992e-07,4.52659e-11,22244.1,17.806], Tmin=(100,'K'), Tmax=(972.48,'K')), NASAPolynomial(coeffs=[13.5325,0.0286796,-1.02935e-05,1.96972e-09,-1.47487e-13,17467.7,-50.4995], Tmin=(972.48,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(184.193,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(403.252,'J/(mol*K)'), comment="""QM MopacMolPM3 calculation attempt 1 + radical(cyclopentene-allyl)"""),
)
...
species(
    ...
    molecularWeight = (67.1091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.99589,0.00512063,8.38156e-05,-1.0783e-07,4.02204e-11,30819.4,14.4988], Tmin=(100,'K'), Tmax=(964.985,'K')), NASAPolynomial(coeffs=[9.80229,0.0201927,-6.89709e-06,1.32329e-09,-1.00718e-13,27490.5,-28.538], Tmin=(964.985,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(255.82,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(307.635,'J/(mol*K)'), comment="""QM MopacMolPM3 calculation attempt 1 + radical(cyclopentene-vinyl)"""),
)

species(
    label = 'C=CC1=[C]CCC1(514)',
    structure = SMILES('C=CC1=[C]CCC1'),
    E0 = (314.394,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,3100,1380,975,1025,1650,2750,2830,2910,2990,3070,3150,900,940,980,1020,1060,1100,3010,987.5,1337.5,450,1655,300,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
    ...
    molecularWeight = (93.1464,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.77064,0.0323702,4.79867e-05,-7.99312e-08,3.12197e-11,37908,20.937], Tmin=(100,'K'), Tmax=(988.63,'K')), NASAPolynomial(coeffs=[12.3536,0.0305764,-1.15371e-05,2.1819e-09,-1.58916e-13,33810.6,-40.1385], Tmin=(988.63,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(314.394,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(403.252,'J/(mol*K)'), comment="""QM MopacMolPM3 calculation attempt 1 + radical(cyclopentene-vinyl)"""),
)

species(
    label = 'C=[C]C1=CCCC1(515)',
    structure = SMILES('C=C=C1[CH]CCC1'),
    E0 = (240.357,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2816.67,2883.33,2950,3016.67,3083.33,3150,900,933.333,966.667,1000,1033.33,1066.67,1100,540,610,2055,2950,3100,1380,975,1025,1650,300,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (93.1464,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.96497,0.0238695,7.79726e-05,-1.13895e-07,4.38488e-11,29000.3,20.102], Tmin=(100,'K'), Tmax=(973.106,'K')), NASAPolynomial(coeffs=[13.5536,0.0286835,-1.02967e-05,1.96673e-09,-1.46945e-13,24261.6,-48.2501], Tmin=(973.106,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(240.357,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(407.409,'J/(mol*K)'), comment="""QM MopacMolPM3 calculation attempt 1 + radical(Allyl_S)"""),
)

species(
    label = '[CH]=CC1=CCCC1(516)',
    ...
    molecularWeight = (93.1464,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.73068,0.0312891,5.61047e-05,-9.17622e-08,3.62273e-11,36659.2,21.0095], Tmin=(100,'K'), Tmax=(976.845,'K')), NASAPolynomial(coeffs=[13.7361,0.0283214,-1.02694e-05,1.94434e-09,-1.43559e-13,32109.8,-47.9093], Tmin=(976.845,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(303.984,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(403.252,'J/(mol*K)'), comment="""QM MopacMolPM3 calculation attempt 1 + radical(Cds_P)"""),
)

species(
    label = '[CH2]CC1[CH]CCC=1(517)',
    structure = SMILES('[CH2]CC1[CH]CCC=1'),
    E0 = (263.424,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2830,2910,2990,3070,3150,900,940,980,1020,1060,1100,3000,3100,440,815,1455,1000,2750,2850,1437.5,1250,1305,750,350,300,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.92326,0.0247926,8.01745e-05,-1.14601e-07,4.33528e-11,31776,21.5352], Tmin=(100,'K'), Tmax=(983.383,'K')), NASAPolynomial(coeffs=[12.8072,0.0329833,-1.23421e-05,2.36913e-09,-1.7544e-13,27098.7,-43.6887], Tmin=(983.383,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(263.424,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(448.981,'J/(mol*K)'), comment="""QM MopacMolPM3 calculation attempt 1 + radical(cyclopentene-allyl) + radical(RCCJ)"""),
)

species(
    label = '[CH2]CC1=[C]CCC1(518)',
    structure = SMILES('[CH2]CC1=[C]CCC1'),
    E0 = (393.625,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2830,2910,2990,3070,3150,900,940,980,1020,1060,1100,3000,3100,440,815,1455,1000,300,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
    ...
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.68172,0.0347271,4.61126e-05,-7.65371e-08,2.93371e-11,47439.9,24.6763], Tmin=(100,'K'), Tmax=(1004.52,'K')), NASAPolynomial(coeffs=[11.6778,0.0347989,-1.354e-05,2.57073e-09,-1.86005e-13,43419.8,-33.6084], Tmin=(1004.52,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(393.625,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(448.981,'J/(mol*K)'), comment="""QM MopacMolPM3 calculation attempt 1 + radical(cyclopentene-vinyl) + radical(RCCJ)"""),
)

species(
    label = 'C[CH]C1[CH]CCC=1(519)',
    structure = SMILES('C[CH]C1[CH]CCC=1'),
    E0 = (199.29,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2830,2910,2990,3070,3150,900,940,980,1020,1060,1100,2750,2800,2850,1350,1500,750,1050,1375,1000,300,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.08756,0.0187972,9.9696e-05,-1.35466e-07,5.08031e-11,24058.8,18.0522], Tmin=(100,'K'), Tmax=(977.841,'K')), NASAPolynomial(coeffs=[13.0686,0.0327713,-1.20822e-05,2.33399e-09,-1.74749e-13,19095.6,-49.0758], Tmin=(977.841,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(199.29,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(448.981,'J/(mol*K)'), comment="""QM MopacMolPM3 calculation attempt 1 + radical(Allyl_S) + radical(cyclopentene-allyl)"""),
)

species(
    label = 'C[CH]C1=[C]CCC1(520)',
    structure = SMILES('C[CH]C1=[C]CCC1'),
    E0 = (329.492,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2830,2910,2990,3070,3150,900,940,980,1020,1060,1100,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,300,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
    ...
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.84917,0.0286985,6.57288e-05,-9.74883e-08,3.6805e-11,39722.6,21.1818], Tmin=(100,'K'), Tmax=(993.727,'K')), NASAPolynomial(coeffs=[11.9024,0.0346475,-1.33144e-05,2.54355e-09,-1.85965e-13,35432.8,-38.7871], Tmin=(993.727,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(329.492,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(448.981,'J/(mol*K)'), comment="""QM MopacMolPM3 calculation attempt 1 + radical(Allyl_S) + radical(cyclopentene-vinyl)"""),
)

species(
    label = '[CH2]CC1=CC[CH]C1(521)',
    structure = SMILES('[CH2]CC1=CC[CH]C1'),
    E0 = (323.12,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2830,2910,2990,3070,3150,900,940,980,1020,1060,1100,3000,3100,440,815,1455,1000,2750,2850,1437.5,1250,1305,750,350,300,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.88213,0.0306651,5.28993e-05,-7.99203e-08,2.95988e-11,38952.5,25.8317], Tmin=(100,'K'), Tmax=(1015.56,'K')), NASAPolynomial(coeffs=[10.3235,0.0369438,-1.47568e-05,2.81824e-09,-2.03593e-13,35199.7,-25.059], Tmin=(1015.56,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(323.12,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(448.981,'J/(mol*K)'), comment="""QM MopacMolPM3 calculation attempt 1 + radical(cyclopentene-4) + radical(RCCJ)"""),
)

species(
    label = '[CH]=C(C=C)CC[CH2](522)',
    structure = SMILES('[CH]=C(C=C)CC[CH2]'),
    E0 = (462.247,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,350,440,435,1725,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3100,440,815,1455,1000,290.141,291.977],'cm^-1')),
        HinderedRotor(inertia=(0.00198309,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.259428,'amu*angstrom^2'), symmetry=1, barrier=(16.0559,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.27033,'amu*angstrom^2'), symmetry=1, barrier=(16.039,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.25793,'amu*angstrom^2'), symmetry=1, barrier=(16.0415,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.378752,0.0693586,-4.18913e-05,3.49272e-09,4.06169e-12,55734.8,28.9404], Tmin=(100,'K'), Tmax=(1024.59,'K')), NASAPolynomial(coeffs=[15.9439,0.0282954,-1.06202e-05,1.91451e-09,-1.32869e-13,51511.1,-51.5774], Tmin=(1024.59,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(462.247,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(390.78,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(RCCJ) + radical(Cds_P)"""),
)

species(
    label = '[CH2]C=C(C=C)C[CH2](523)',
    structure = SMILES('[CH2]C=C(C=C)C[CH2]'),
    E0 = (320.962,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,3100,1380,975,1025,1650,2750,2850,1437.5,1250,1305,750,350,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,2995,3025,975,1000,1300,1375,400,500,1630,1680,350,440,435,1725,668.94,675.743],'cm^-1')),
        HinderedRotor(inertia=(0.00829394,'amu*angstrom^2'), symmetry=1, barrier=(2.63311,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.949113,'amu*angstrom^2'), symmetry=1, barrier=(21.822,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.938317,'amu*angstrom^2'), symmetry=1, barrier=(21.5738,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(3.4362,'amu*angstrom^2'), symmetry=1, barrier=(79.005,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.825197,0.0566309,-4.85149e-06,-3.4497e-08,1.75489e-11,38728.9,27.3604], Tmin=(100,'K'), Tmax=(974.507,'K')), NASAPolynomial(coeffs=[15.0126,0.0293167,-1.04016e-05,1.85868e-09,-1.30466e-13,34495.6,-48.252], Tmin=(974.507,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(320.962,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(390.78,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + radical(RCCJ) + radical(C=CC=CCJ)"""),
)

species(
    label = '[CH2]CC=C([CH2])C=C(524)',
    structure = SMILES('[CH2]CC=C([CH2])C=C'),
    E0 = (354.405,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.541252,0.0630768,-1.96561e-05,-2.18207e-08,1.3527e-11,42761.2,27.7956], Tmin=(100,'K'), Tmax=(985.672,'K')), NASAPolynomial(coeffs=[16.594,0.0272936,-9.88297e-06,1.79003e-09,-1.26541e-13,38170.3,-56.6529], Tmin=(985.672,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(354.405,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(390.78,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + radical(Allyl_P) + radical(RCCJ)"""),
)

species(
    label = 'C[C]C1=CCCC1(525)',
    structure = SMILES('C[C]C1=CCCC1'),
    E0 = (304.545,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2816.67,2883.33,2950,3016.67,3083.33,3150,900,933.333,966.667,1000,1033.33,1066.67,1100,2750,2800,2850,1350,1500,750,1050,1375,1000,300,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.56681,0.0361567,4.73851e-05,-8.14875e-08,3.19757e-11,36731.4,22.3234], Tmin=(100,'K'), Tmax=(989.814,'K')), NASAPolynomial(coeffs=[12.7985,0.0332916,-1.27155e-05,2.39566e-09,-1.73503e-13,32424.8,-42.2709], Tmin=(989.814,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(304.545,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(399.095,'J/(mol*K)'), comment="""QM MopacMolPM3 calculation attempt 1"""),
)

species(
    label = '[CH]CC1=CCCC1(526)',
    structure = SMILES('[CH]CC1=CCCC1'),
    E0 = (382.662,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2816.67,2883.33,2950,3016.67,3083.33,3150,900,933.333,966.667,1000,1033.33,1066.67,1100,2750,2850,1437.5,1250,1305,750,350,300,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
    ...
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.4796,0.0374345,4.70725e-05,-8.32246e-08,3.3063e-11,46130.4,22.6165], Tmin=(100,'K'), Tmax=(985.189,'K')), NASAPolynomial(coeffs=[13.6217,0.0322353,-1.2155e-05,2.28934e-09,-1.6644e-13,41597.8,-46.6426], Tmin=(985.189,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(382.662,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(399.095,'J/(mol*K)'), comment="""QM MopacMolPM3 calculation attempt 1"""),
)

species(
    label = 'C1CC2CCCC=12(527)',
    ...
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.27244,0.0105623,0.000126831,-1.6845e-07,6.39342e-11,17935.1,18.8092], Tmin=(100,'K'), Tmax=(959.666,'K')), NASAPolynomial(coeffs=[14.8635,0.0278281,-9.17337e-06,1.76273e-09,-1.36344e-13,12306.7,-58.1503], Tmin=(959.666,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(148.397,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(407.409,'J/(mol*K)'), comment="""QM MopacMolPM3 calculation attempt 1"""),
)
...
reaction(
    label = 'reaction587',
    reactants = ['H(10)', 'C=CC1[CH]CCC=1(512)'],
    products = ['C=CC1=CCCC1(253)'],
...
reaction(
    label = 'reaction589',
    reactants = ['[C]1=CCCC1(513)', 'C2H3(32)'],
    products = ['C=CC1=CCCC1(253)'],
...
reaction(
    label = 'reaction590',
    reactants = ['H(10)', 'C=CC1=[C]CCC1(514)'],
    products = ['C=CC1=CCCC1(253)'],
...
reaction(
    label = 'reaction591',
    reactants = ['H(10)', 'C=[C]C1=CCCC1(515)'],
    products = ['C=CC1=CCCC1(253)'],
...
reaction(
    label = 'reaction592',
    reactants = ['H(10)', '[CH]=CC1=CCCC1(516)'],
    products = ['C=CC1=CCCC1(253)'],
...
reaction(
    label = 'reaction596',
    reactants = ['[CH2]CC1[CH]CCC=1(517)'],
    products = ['C=CC1=CCCC1(253)'],
    transitionState = 'TS310',
    kinetics = Arrhenius(A=(2.9748e+09,'s^-1'), n=1.045, Ea=(63.4002,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [R3radExo;Y_rad_NDe;XH_Rrad]
Euclidian distance = 0
Multiplied by reaction path degeneracy 4.0
family: Intra_Disproportionation"""),
)
...
reaction(
    label = 'reaction599',
    reactants = ['C[CH]C1[CH]CCC=1(519)'],
    products = ['C=CC1=CCCC1(253)'],
...
reaction(
    label = 'reaction604',
    reactants = ['[CH2]CC1=CC[CH]C1(521)'],
    products = ['C=CC1=CCCC1(253)'],
...
reaction(
    label = 'reaction606',
    reactants = ['CC=C1[CH]C[CH]C1(236)'],
    products = ['C=CC1=CCCC1(253)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(7.76e+09,'s^-1'), n=0.311, Ea=(7.1128,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R5;C_rad_out_2H;Ypri_rad_out] for rate rule [R5_SSSD;C_rad_out_2H;CdsinglepriDe_rad_out]
Euclidian distance = 2.2360679775
family: Birad_recombination"""),
)
...
reaction(
    label = 'reaction611',
    reactants = ['[CH2]C=C(C=C)C[CH2](523)'],
    products = ['C=CC1=CCCC1(253)'],
    transitionState = 'TS325',
    kinetics = Arrhenius(A=(1.552e+10,'s^-1'), n=0.311, Ea=(7.1128,'kJ/mol'), T0=(1,'K'), Tmin=(600,'K'), Tmax=(2000,'K'), comment="""Estimated using template [R5;C_rad_out_2H;Cpri_rad_out_2H] for rate rule [R5_SSDS;C_rad_out_2H;Cpri_rad_out_2H]
Euclidian distance = 1.0
Multiplied by reaction path degeneracy 2.0
family: Birad_recombination"""),
)
...
reaction(
    label = 'reaction612',
    reactants = ['[CH2]CC=C([CH2])C=C(524)'],
    products = ['C=CC1=CCCC1(253)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(9.18309e+11,'s^-1'), n=0.345439, Ea=(91.3359,'kJ/mol'), T0=(1,'K'), Tmin=(303.03,'K'), Tmax=(2000,'K'), comment="""Estimated using template [CsJ2-C;CsJ2(CsC);CH] for rate rule [CsJ2-C;CsJ2(CsC);CH(C)C]
Euclidian distance = 1.0
family: Singlet_Carbene_Intra_Disproportionation"""),
)
