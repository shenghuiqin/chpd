...
species(
    label = '[CH2]C=CC=C(645)',
    structure = SMILES('[CH2]C=CC=C'),
    E0 = (175.951,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,3100,1380,975,1025,1650,2995,3010,3025,975,987.5,1000,1300,1337.5,1375,400,450,500,1630,1655,1680,3000,3100,440,815,1455,1000,180],'cm^-1')),
        HinderedRotor(inertia=(1.53107,'amu*angstrom^2'), symmetry=1, barrier=(35.2024,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.52474,'amu*angstrom^2'), symmetry=1, barrier=(35.0568,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (67.1091,'amu'),
...
species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.719499,'amu*angstrom^2'), symmetry=1, barrier=(16.5427,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.720454,'amu*angstrom^2'), symmetry=1, barrier=(16.5647,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.719037,'amu*angstrom^2'), symmetry=1, barrier=(16.5321,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (93.1464,'amu'),
...
species(
    ...
    E0 = (335.846,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3120,650,792.5,1650,2995,3025,975,1000,1300,1375,400,500,1630,1680,2950,3100,1380,975,1025,1650,249.836],'cm^-1')),
        HinderedRotor(inertia=(0.328281,'amu*angstrom^2'), symmetry=1, barrier=(14.5401,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.328189,'amu*angstrom^2'), symmetry=1, barrier=(14.54,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (67.1091,'amu'),
...
species(
    label = 'C=C[C]=CCC=C(649)',
    structure = SMILES('C=C[C]=CCC=C'),
    E0 = (339.517,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,1685,370,2995,3010,3025,975,987.5,1000,1300,1337.5,1375,400,450,500,1630,1655,1680,2950,3000,3050,3100,1330,1430,900,1050,1000,1050,1600,1700,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.942856,'amu*angstrom^2'), symmetry=1, barrier=(21.6781,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.943191,'amu*angstrom^2'), symmetry=1, barrier=(21.6858,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.943555,'amu*angstrom^2'), symmetry=1, barrier=(21.6942,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (93.1464,'amu'),
...
species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.802318,'amu*angstrom^2'), symmetry=1, barrier=(18.4469,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.800958,'amu*angstrom^2'), symmetry=1, barrier=(18.4156,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.802482,'amu*angstrom^2'), symmetry=1, barrier=(18.4506,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (93.1464,'amu'),
...
species(
    label = 'C=[C]C[CH]CC=C(653)',
    structure = SMILES('C=[C]C[CH]CC=C'),
    E0 = (472.22,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,3000,3050,3100,1330,1430,900,1050,1000,1050,1600,1700,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,1685,370,3010,987.5,1337.5,450,1655,3025,407.5,1350,352.5,325.332,325.333,325.335,1613.89],'cm^-1')),
        HinderedRotor(inertia=(0.00159281,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.136921,'amu*angstrom^2'), symmetry=1, barrier=(10.2837,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.136926,'amu*angstrom^2'), symmetry=1, barrier=(10.2837,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00556379,'amu*angstrom^2'), symmetry=1, barrier=(10.2837,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (94.1543,'amu'),
...
species(
    label = '[CH2]C=CCC[C]=C(639)',
    structure = SMILES('[CH2]C=CCC[C]=C'),
    E0 = (417.015,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,3100,1380,975,1025,1650,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,1685,370,2995,3025,975,1000,1300,1375,400,500,1630,1680,3000,3100,440,815,1455,1000,180,1120.97,1121.71],'cm^-1')),
        HinderedRotor(inertia=(0.284459,'amu*angstrom^2'), symmetry=1, barrier=(6.54026,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.784554,'amu*angstrom^2'), symmetry=1, barrier=(18.0385,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.784324,'amu*angstrom^2'), symmetry=1, barrier=(18.0332,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.784409,'amu*angstrom^2'), symmetry=1, barrier=(18.0351,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (94.1543,'amu'),
...
species(
    label = '[CH]=CC[CH]CC=C(654)',
    structure = SMILES('[CH]=CC[CH]CC=C'),
    E0 = (481.474,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,3100,1380,975,1025,1650,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3120,650,792.5,1650,2995,3025,975,1000,1300,1375,400,500,1630,1680,3025,407.5,1350,352.5,353.276,355.522,356.136],'cm^-1')),
        HinderedRotor(inertia=(0.0611619,'amu*angstrom^2'), symmetry=1, barrier=(5.5125,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00751342,'amu*angstrom^2'), symmetry=1, barrier=(5.53153,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0615404,'amu*angstrom^2'), symmetry=1, barrier=(5.52328,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0618948,'amu*angstrom^2'), symmetry=1, barrier=(5.51237,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (94.1543,'amu'),
...
species(
    ...
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.23402,0.0123946,0.000120425,-1.60964e-07,6.1076e-11,11598,18.4758], Tmin=(100,'K'), Tmax=(961.546,'K')), NASAPolynomial(coeffs=[14.4863,0.0285911,-9.61901e-06,1.84391e-09,-1.41361e-13,6136.82,-56.2999], Tmin=(961.546,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(95.7041,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(407.409,'J/(mol*K)'), comment="""QM MopacMolPM3 calculation attempt 1"""),
)

species(
    label = 'C=CC[C]CC=C(656)',
    structure = SMILES('C=CC[C]CC=C'),
    E0 = (466.314,'kJ/mol'),
    modes = [
...
species(
    label = 'C=CCC=C[C]C(658)',
    structure = SMILES('C=CCC=C[C]C'),
    E0 = (457.608,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,3100,1380,975,1025,1650,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3010,3025,975,987.5,1000,1300,1337.5,1375,400,450,500,1630,1655,1680,267.522,267.523,267.523,267.524],'cm^-1')),
        HinderedRotor(inertia=(0.36797,'amu*angstrom^2'), symmetry=1, barrier=(18.688,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.181524,'amu*angstrom^2'), symmetry=1, barrier=(9.21923,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.01029,'amu*angstrom^2'), symmetry=1, barrier=(51.3086,'kJ/mol'), semiclassical=False),
...
species(
    ...
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.6731,0.0303084,6.92363e-05,-1.08332e-07,4.26023e-11,23333,21.872], Tmin=(100,'K'), Tmax=(969.28,'K')), NASAPolynomial(coeffs=[14.4123,0.0298089,-1.05746e-05,1.98654e-09,-1.46891e-13,18417.3,-51.8077], Tmin=(969.28,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(193.149,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(399.095,'J/(mol*K)'), comment="""QM MopacMolPM3 calculation attempt 1"""),
)
...
reaction(
    label = 'reaction251',
    reactants = ['CH2CHCHCH(119)', 'allyl(644)'],
    products = ['C=CC=CCC=C(111)'],
...
reaction(
    label = 'reaction795',
    reactants = ['C2H3(32)', '[CH2]C=CC=C(645)'],
    products = ['C=CC=CCC=C(111)'],
...
reaction(
    label = 'reaction797',
    reactants = ['H(10)', 'C=CC=[C]CC=C(646)'],
    products = ['C=CC=CCC=C(111)'],
...
reaction(
    label = 'reaction798',
    reactants = ['H(10)', 'C=[C]CC=CC=C(647)'],
    products = ['C=CC=CCC=C(111)'],
...
reaction(
    label = 'reaction799',
    reactants = ['C2H3(32)', '[CH]=CCC=C(648)'],
    products = ['C=CC=CCC=C(111)'],
...
reaction(
    label = 'reaction800',
    reactants = ['H(10)', 'C=C[C]=CCC=C(649)'],
    products = ['C=CC=CCC=C(111)'],
...
reaction(
    label = 'reaction801',
    reactants = ['H(10)', 'C=[C]C=CCC=C(650)'],
    products = ['C=CC=CCC=C(111)'],
...
reaction(
    label = 'reaction802',
    reactants = ['H(10)', '[CH]=CCC=CC=C(651)'],
    products = ['C=CC=CCC=C(111)'],
...
reaction(
    label = 'reaction803',
    reactants = ['H(10)', '[CH]=CC=CCC=C(652)'],
    products = ['C=CC=CCC=C(111)'],
