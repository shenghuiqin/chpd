...
species(
    label = 'CC([O])C1CCC([O])O1(18911)',
    structure = SMILES('CC([O])C1CCC([O])O1'),
    E0 = (-175.401,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (130.142,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.60195,0.0621669,-3.3386e-06,-3.77216e-08,1.89967e-11,-20962.2,29.3495], Tmin=(100,'K'), Tmax=(954.819,'K')), NASAPolynomial(coeffs=[13.5619,0.0381164,-1.30656e-05,2.24191e-09,-1.52363e-13,-24815.6,-39.7945], Tmin=(954.819,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-175.401,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(448.981,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + ring(Tetrahydrofuran) + radical(CC(C)OJ) + radical(CCOJ)"""),
)
...
species(
    label = 'CC([O])C(=O)CCC=O(18912)',
    structure = SMILES('CC([O])C(=O)CCC=O'),
    E0 = (-316.339,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2782.5,750,1395,475,1775,1000,375,552.5,462.5,1710,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.399026,0.085901,-9.52591e-05,6.69146e-08,-2.05542e-11,-37923.2,35.1291], Tmin=(100,'K'), Tmax=(771.514,'K')), NASAPolynomial(coeffs=[7.56997,0.0487222,-2.29748e-05,4.45331e-09,-3.14227e-13,-39029.7,2.39361], Tmin=(771.514,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-316.339,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-O2d)CsOsH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsCs) + group(Cds-OdCsH) + radical(C=OCOJ)"""),
)

species(
    label = 'CC(=O)C([O])CCC=O(18913)',
    structure = SMILES('CC(=O)C([O])CCC=O'),
    E0 = (-314.702,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2782.5,750,1395,475,1775,1000,375,552.5,462.5,1710,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1200,1600],'cm^-1')),
    ...
    molecularWeight = (129.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.73981,0.0762273,-6.26837e-05,2.89036e-08,-5.79921e-12,-37736.4,34.8072], Tmin=(100,'K'), Tmax=(1131.85,'K')), NASAPolynomial(coeffs=[9.80846,0.0441788,-2.02116e-05,3.88766e-09,-2.73824e-13,-39789.3,-10.0671], Tmin=(1131.85,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-314.702,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-O2d)CsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-(Cds-O2d)HHH) + group(Cds-OdCsCs) + group(Cds-OdCsH) + radical(C=OCOJ)"""),
)
...
species(
    label = 'CC([O])C(O)[CH]CC=O(18916)',
    structure = SMILES('CC([O])C(O)[CH]CC=O'),
    E0 = (-189.342,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1277.5,1000,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,2750,2850,1437.5,1250,1305,750,350,2782.5,750,1395,475,1775,1000,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'CC([O])C1CC[CH]OO1(18926)',
    structure = SMILES('CC([O])C1CC[CH]OO1'),
    E0 = (27.6722,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (130.142,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.178485,0.0661355,7.97428e-06,-6.62568e-08,3.3719e-11,3482.43,28.9311], Tmin=(100,'K'), Tmax=(914.379,'K')), NASAPolynomial(coeffs=[19.575,0.0283293,-7.18153e-06,1.06114e-09,-7.06186e-14,-2031.4,-73.6639], Tmin=(914.379,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(27.6722,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(448.981,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(12dioxane) + radical(CCsJOOC) + radical(CC(C)OJ)"""),
)
...
species(
    ...
    molecularWeight = (130.142,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.419288,0.0802008,-6.29247e-05,2.62998e-08,-4.6415e-12,-67036.9,35.1678], Tmin=(100,'K'), Tmax=(1293.4,'K')), NASAPolynomial(coeffs=[12.7093,0.0421925,-1.8845e-05,3.57944e-09,-2.49896e-13,-70216.1,-27.2861], Tmin=(1293.4,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-558.435,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-O2d)CsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-(Cds-O2d)HHH) + group(Cds-OdCsCs) + group(Cds-OdCsH)"""),
)
...
species(
    ...
    molecularWeight = (130.142,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.07028,0.0967185,-7.05471e-05,9.97931e-09,6.47858e-12,-13910.5,35.703], Tmin=(100,'K'), Tmax=(975.007,'K')), NASAPolynomial(coeffs=[24.6981,0.0235305,-7.99342e-06,1.42468e-09,-1.01417e-13,-20481.5,-95.8912], Tmin=(975.007,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-117.287,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CC(C)OJ) + radical(CC(C)OJ)"""),
)

species(
    label = 'CC([O])C([O])CC=CO(18930)',
    structure = SMILES('CC([O])C([O])CC=CO'),
    E0 = (-157.094,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,3615,1277.5,1000,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (130.142,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.997983,0.0950304,-6.67715e-05,4.98356e-09,8.81537e-12,-18700.6,36.6966], Tmin=(100,'K'), Tmax=(957.539,'K')), NASAPolynomial(coeffs=[24.7771,0.0220898,-6.91651e-06,1.19086e-09,-8.43628e-14,-25229,-94.8491], Tmin=(957.539,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-157.094,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(CC(C)OJ) + radical(CC(C)OJ)"""),
)
...
species(
    label = 'CC([O])[CH]CCC=O(18931)',
    structure = SMILES('CC([O])[CH]CCC=O'),
    E0 = (-16.8715,'kJ/mol'),
    modes = [
...
reaction(
    label = 'reaction2',
    reactants = ['CC([O])C([O])CCC=O(18427)'],
    products = ['CC([O])C1CCC([O])O1(18911)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', 'CC([O])C(=O)CCC=O(18912)'],
    products = ['CC([O])C([O])CCC=O(18427)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)', 'CC(=O)C([O])CCC=O(18913)'],
    products = ['CC([O])C([O])CCC=O(18427)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(0.0366254,'m^3/(mol*s)'), n=1.743, Ea=(71.4418,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [CO-CsCs_O;YJ] for rate rule [CO-CsCs_O;HJ]
Euclidian distance = 1.0
...
reaction(
    label = 'reaction6',
    reactants = ['CH3CHOCHO(2229)', 'CH2CH2CHO(560)'],
    products = ['CC([O])C([O])CCC=O(18427)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['C[CH][O](176)', 'O=CCCC=O(5767)'],
    products = ['CC([O])C([O])CCC=O(18427)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['CH3(17)', '[O]C(C=O)CCC=O(18894)'],
    products = ['CC([O])C([O])CCC=O(18427)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction12',
    reactants = ['CC([O])C(O)[CH]CC=O(18916)'],
    products = ['CC([O])C([O])CCC=O(18427)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CC([O])C([O])CCC=O(18427)'],
    products = ['C[C]([O])C(O)CCC=O(18917)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CC([O])C([O])CCC=O(18427)'],
    products = ['CC([O])C(O)C[CH]C=O(18921)'],
...
reaction(
    label = 'reaction20',
    reactants = ['CC([O])C([O])CCC=O(18427)'],
    products = ['CC([O])C(O)CC[C]=O(18924)'],
...
reaction(
    label = 'reaction23',
    reactants = ['CC([O])C([O])CCC=O(18427)'],
    products = ['CC([O])C1CC[CH]OO1(18926)'],
...
reaction(
    label = 'reaction27',
    reactants = ['CH2(S)(23)', '[O]CC([O])CCC=O(18419)'],
    products = ['CC([O])C([O])CCC=O(18427)'],
...
reaction(
    label = 'reaction28',
    reactants = ['CO(12)', 'CCC([O])C(C)[O](11101)'],
    products = ['CC([O])C([O])CCC=O(18427)'],
...
reaction(
    label = 'reaction30',
    reactants = ['C=COCC([O])C(C)[O](18929)'],
    products = ['CC([O])C([O])CCC=O(18427)'],
...
reaction(
    label = 'reaction31',
    reactants = ['CC([O])C([O])CC=CO(18930)'],
    products = ['CC([O])C([O])CCC=O(18427)'],
...
reaction(
    label = 'reaction32',
    reactants = ['O(4)', 'CC([O])[CH]CCC=O(18931)'],
    products = ['CC([O])C([O])CCC=O(18427)'],
...
reaction(
    label = 'reaction33',
    reactants = ['O(4)', 'C[CH]C([O])CCC=O(18491)'],
    products = ['CC([O])C([O])CCC=O(18427)'],
