...
species(
    label = 'CCC=CCC[O](1811)',
    structure = SMILES('CCC=CCC[O]'),
    E0 = (-9.31519,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,315.171,315.48,324.432,2044.52],'cm^-1')),
        HinderedRotor(inertia=(0.00166353,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.125323,'amu*angstrom^2'), symmetry=1, barrier=(8.75298,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.120583,'amu*angstrom^2'), symmetry=1, barrier=(8.75374,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.124024,'amu*angstrom^2'), symmetry=1, barrier=(8.70151,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
species(
    label = 'CCCC=CC[O](1812)',
    structure = SMILES('CCCC=CC[O]'),
    E0 = (-3.75827,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,304.218,304.222,304.228,2305.5],'cm^-1')),
        HinderedRotor(inertia=(0.104055,'amu*angstrom^2'), symmetry=1, barrier=(6.83463,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.104063,'amu*angstrom^2'), symmetry=1, barrier=(6.83462,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.10406,'amu*angstrom^2'), symmetry=1, barrier=(6.83463,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00182155,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (99.1509,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.60972,0.0572879,-2.82772e-05,6.14263e-09,-5.07848e-13,-370.932,27.3184], Tmin=(100,'K'), Tmax=(2635.08,'K')), NASAPolynomial(coeffs=[28.3565,0.0188977,-7.68252e-06,1.25065e-09,-7.39372e-14,-15234.6,-129.091], Tmin=(2635.08,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-3.75827,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(415.724,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(CCOJ)"""),
)
...
species(
    ...
    molecularWeight = (100.159,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.62237,0.0562364,-2.51317e-05,4.52408e-09,-2.81133e-13,8255.85,25.1831], Tmin=(100,'K'), Tmax=(2830.67,'K')), NASAPolynomial(coeffs=[44.841,0.00560114,-3.0813e-06,4.57026e-10,-2.13988e-14,-19260.7,-228.812], Tmin=(2830.67,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(68.4594,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(RCCJC) + radical(CCOJ)"""),
)
...
species(
    ...
    molecularWeight = (100.159,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.10666,0.0684762,-5.1631e-05,2.56432e-08,-6.16782e-12,5231.87,32.2597], Tmin=(100,'K'), Tmax=(912.01,'K')), NASAPolynomial(coeffs=[5.16989,0.0506548,-2.23192e-05,4.21625e-09,-2.9413e-13,4490.74,13.0313], Tmin=(912.01,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(42.6683,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(CCJCO)"""),
)
...
species(
    ...
    molecularWeight = (100.159,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.849485,0.0772594,-9.29144e-05,8.32546e-08,-3.13581e-11,4581.36,33.4037], Tmin=(100,'K'), Tmax=(824.056,'K')), NASAPolynomial(coeffs=[1.8726,0.056167,-2.51668e-05,4.69887e-09,-3.21663e-13,4960.28,31.988], Tmin=(824.056,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(37.2126,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(RCCJC) + radical(RCCJCC)"""),
)

species(
    label = '[CH2]CC[CH]CCO(1822)',
...
species(
    ...
    molecularWeight = (100.159,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.578269,0.067609,-4.13079e-05,1.27519e-08,-1.61111e-12,-27468.8,30.1844], Tmin=(100,'K'), Tmax=(1787.31,'K')), NASAPolynomial(coeffs=[15.4798,0.0342598,-1.33199e-05,2.31244e-09,-1.50908e-13,-32795.5,-50.3603], Tmin=(1787.31,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-229.463,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'CCC=CCC[O](1811)'],
    products = ['CCC[CH]CC[O](998)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', 'CCC[CH]CC=O(1813)'],
    products = ['CCC[CH]CC[O](998)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['C2H5(29)', 'C=CCC[O](1706)'],
    products = ['CCC[CH]CC[O](998)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['C=CCCC(134)', '[CH2][O](167)'],
    products = ['CCC[CH]CC[O](998)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction22',
    reactants = ['CH2(S)(23)', 'CC[CH]CC[O](986)'],
    products = ['CCC[CH]CC[O](998)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[CH]CCC(133)', '[CH2]C[O](96)'],
    products = ['CCC[CH]CC[O](998)'],
...
reaction(
    label = 'reaction27',
    reactants = ['O(4)', '[CH2]C[CH]CCC(203)'],
    products = ['CCC[CH]CC[O](998)'],
