...
species(
    label = '[CH2]OCC=CC(1693)',
    structure = SMILES('[CH2]OCC=CC'),
    E0 = (25.4797,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,318.734,318.861,1625.71],'cm^-1')),
        HinderedRotor(inertia=(0.00165783,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.103207,'amu*angstrom^2'), symmetry=1, barrier=(7.44517,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.103206,'amu*angstrom^2'), symmetry=1, barrier=(7.44446,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.103244,'amu*angstrom^2'), symmetry=1, barrier=(7.44459,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
species(
    label = '[CH2]OC=CCC(1694)',
    structure = SMILES('[CH2]OC=CCC'),
    E0 = (-14.6227,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,333.517,333.663,333.752],'cm^-1')),
        HinderedRotor(inertia=(0.00151539,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.217274,'amu*angstrom^2'), symmetry=1, barrier=(17.18,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.217341,'amu*angstrom^2'), symmetry=1, barrier=(17.1824,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.217665,'amu*angstrom^2'), symmetry=1, barrier=(17.1785,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (85.1244,'amu'),
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', '[CH2]OCC=CC(1693)'],
    products = ['[CH2]OC[CH]CC(988)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['CH3(17)', '[CH2]OCC=C(1681)'],
    products = ['[CH2]OC[CH]CC(988)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction15',
    reactants = ['CH2(S)(23)', '[CH2]OC[CH]C(1005)'],
    products = ['[CH2]OC[CH]CC(988)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CH2(19)', 'CC[CH]C[O](1679)'],
    products = ['[CH2]OC[CH]CC(988)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2]O[CH2](103)', '[CH]CC(144)'],
    products = ['[CH2]OC[CH]CC(988)'],
