species(
    label = 'C=[C]OC[CH]CCCC(1136)',
    structure = SMILES('C=[C]OC[CH]CCCC'),
    E0 = (159.018,'kJ/mol'),
    modes = [
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.08869,0.0986717,-6.94273e-05,2.02998e-08,-8.01692e-13,19319.9,41.5565], Tmin=(100,'K'), Tmax=(1109.62,'K')), NASAPolynomial(coeffs=[19.9888,0.0408587,-1.58346e-05,2.85649e-09,-1.96093e-13,13523.8,-67.3627], Tmin=(1109.62,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(159.018,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(527.969,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C=CJO) + radical(CCJCO)"""),
)
...
species(
    label = 'C=[C]OCC=CCCC(3125)',
    structure = SMILES('C=[C]OCC=CCCC'),
    E0 = (81.3448,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2950,3100,1380,975,1025,1650,1685,370,2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.717966,0.0907397,-5.71365e-05,1.08325e-08,1.97276e-12,9964.43,38.8159], Tmin=(100,'K'), Tmax=(1088.46,'K')), NASAPolynomial(coeffs=[18.7196,0.0399635,-1.56269e-05,2.84275e-09,-1.9648e-13,4509.48,-62.2271], Tmin=(1088.46,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(81.3448,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C=CJO)"""),
)

species(
    label = 'C=[C]OC=CCCCC(3126)',
    structure = SMILES('C=[C]OC=CCCCC'),
    E0 = (103.326,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2950,3100,1380,975,1025,1650,1685,370,2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (125.188,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.783919,0.0931409,-6.92762e-05,2.67429e-08,-4.18822e-12,12609.5,40.5628], Tmin=(100,'K'), Tmax=(1502.49,'K')), NASAPolynomial(coeffs=[19.6728,0.0386802,-1.4906e-05,2.61849e-09,-1.74163e-13,6462.23,-66.4576], Tmin=(1502.49,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(103.326,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C=CJO)"""),
)

species(
    label = 'C#COC[CH]CCCC(3127)',
    ...
    molecularWeight = (125.188,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.26655,0.102215,-7.76712e-05,2.42752e-08,-1.08154e-12,15668.3,36.5205], Tmin=(100,'K'), Tmax=(1073.32,'K')), NASAPolynomial(coeffs=[22.0179,0.0360127,-1.39023e-05,2.52491e-09,-1.75015e-13,9485,-82.9812], Tmin=(1073.32,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(128.601,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Ct-CtOs) + group(Ct-CtH) + radical(CCJCO)"""),
)
...
species(
    label = 'C=[C]OCC[CH]CCC(3128)',
    structure = SMILES('C=[C]OCC[CH]CCC'),
    E0 = (153.575,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,2950,3100,1380,975,1025,1650,1685,370,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (126.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.415232,0.0971882,-7.71691e-05,3.39527e-08,-6.34103e-12,18629.4,39.202], Tmin=(100,'K'), Tmax=(1233.62,'K')), NASAPolynomial(coeffs=[13.6269,0.051657,-2.18062e-05,4.03379e-09,-2.77818e-13,15164.9,-31.4911], Tmin=(1233.62,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(153.575,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(527.969,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(RCCJCC) + radical(C=CJO)"""),
)
...
species(
    label = 'C=CO[CH][CH]CCCC(3130)',
    structure = SMILES('C=CO[CH][CH]CCCC'),
    E0 = (113.201,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (126.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.54943,0.105042,-6.55471e-05,6.27095e-11,1.02782e-11,13830,39.5492], Tmin=(100,'K'), Tmax=(979.899,'K')), NASAPolynomial(coeffs=[25.4442,0.0322038,-1.12245e-05,2.00395e-09,-1.41366e-13,6746.54,-99.2813], Tmin=(979.899,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(113.201,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(527.969,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CCJCO) + radical(CCsJOC(O))"""),
)

species(
    label = 'C=[C]OCCC[CH]CC(3131)',
    structure = SMILES('C=[C]OCCC[CH]CC'),
    E0 = (153.575,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,2950,3100,1380,975,1025,1650,1685,370,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'C=[C]OCCCC[CH]C(3132)',
    structure = SMILES('C=[C]OCCCC[CH]C'),
    E0 = (153.562,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (126.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.608604,0.0985673,-7.8523e-05,3.41462e-08,-6.20867e-12,18637.3,40.0666], Tmin=(100,'K'), Tmax=(1279.31,'K')), NASAPolynomial(coeffs=[15.3531,0.04866,-2.00064e-05,3.65246e-09,-2.49642e-13,14553.3,-40.8712], Tmin=(1279.31,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(153.562,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(527.969,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(RCCJC) + radical(C=CJO)"""),
)

species(
    label = '[CH]=[C]OCCCCCC(3133)',
    structure = SMILES('[CH]=[C]OCCCCCC'),
    E0 = (206.212,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2761.11,2772.22,2783.33,2794.44,2805.56,2816.67,2827.78,2838.89,2850,1425,1431.25,1437.5,1443.75,1450,1225,1237.5,1250,1262.5,1275,1270,1287.5,1305,1322.5,1340,700,725,750,775,800,300,325,350,375,400,3120,650,792.5,1650,2750,2800,2850,1350,1500,750,1050,1375,1000,1685,370,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (126.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.20962,0.105672,-8.85809e-05,3.90226e-08,-6.96289e-12,24996.5,39.8964], Tmin=(100,'K'), Tmax=(1333.49,'K')), NASAPolynomial(coeffs=[20.1758,0.0415242,-1.64236e-05,2.94847e-09,-1.99853e-13,19293,-69.4306], Tmin=(1333.49,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(206.212,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(527.969,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(Cds_P) + radical(C=CJO)"""),
)

species(
    label = '[CH2]CCCCCO[C]=C(3134)',
    structure = SMILES('[CH2]CCCCCO[C]=C'),
    E0 = (164.363,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2761.11,2772.22,2783.33,2794.44,2805.56,2816.67,2827.78,2838.89,2850,1425,1431.25,1437.5,1443.75,1450,1225,1237.5,1250,1262.5,1275,1270,1287.5,1305,1322.5,1340,700,725,750,775,800,300,325,350,375,400,1685,370,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (126.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.14488,0.103393,-8.39894e-05,3.5739e-08,-6.16552e-12,19961.5,41.0496], Tmin=(100,'K'), Tmax=(1374.78,'K')), NASAPolynomial(coeffs=[20.176,0.0413596,-1.6306e-05,2.91784e-09,-1.9714e-13,14099.1,-68.5979], Tmin=(1374.78,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(164.363,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(527.969,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(RCCJ) + radical(C=CJO)"""),
)

species(
    label = 'C=COC[CH][CH]CCC(3135)',
    structure = SMILES('C=COC[CH][CH]CCC'),
    E0 = (113.732,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (126.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.99731,0.0968578,-6.47669e-05,1.56299e-08,8.89997e-13,13869.9,40.6618], Tmin=(100,'K'), Tmax=(1077.91,'K')), NASAPolynomial(coeffs=[19.3982,0.0414541,-1.58916e-05,2.85731e-09,-1.96211e-13,8294.73,-64.7303], Tmin=(1077.91,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(113.732,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(527.969,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CCJCO) + radical(RCCJCC)"""),
)

species(
    label = 'C=COC[CH]C[CH]CC(3136)',
    structure = SMILES('C=COC[CH]C[CH]CC'),
    E0 = (113.732,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (126.196,'amu'),
...
species(
    label = 'C=COC[CH]CC[CH]C(3137)',
    structure = SMILES('C=COC[CH]CC[CH]C'),
    E0 = (113.72,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (126.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.99123,0.0959239,-5.826e-05,6.03165e-09,4.99985e-12,13869.1,40.8089], Tmin=(100,'K'), Tmax=(1028.2,'K')), NASAPolynomial(coeffs=[20.0052,0.0403007,-1.51307e-05,2.71725e-09,-1.87789e-13,8173.94,-67.7694], Tmin=(1028.2,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(113.72,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(527.969,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(RCCJC) + radical(CCJCO)"""),
)

species(
    label = '[CH2]CCC[CH]COC=C(3138)',
    structure = SMILES('[CH2]CCC[CH]COC=C'),
    E0 = (124.52,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (126.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.15158,0.0964488,-4.93171e-05,-1.01433e-08,1.2226e-11,15176.7,40.4347], Tmin=(100,'K'), Tmax=(994.061,'K')), NASAPolynomial(coeffs=[22.8425,0.0362118,-1.32159e-05,2.39317e-09,-1.68645e-13,8612.31,-84.204], Tmin=(994.061,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(124.52,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(527.969,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CCJCO) + radical(RCCJ)"""),
)
...
species(
    label = 'C=COC=CCCCC(3139)',
    structure = SMILES('C=COC=CCCCC'),
    E0 = (-136.418,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (126.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.812774,0.0895139,-3.7183e-05,-1.67667e-08,1.31304e-11,-16219.7,37.5214], Tmin=(100,'K'), Tmax=(1007.47,'K')), NASAPolynomial(coeffs=[20.4264,0.0398913,-1.49713e-05,2.72712e-09,-1.91537e-13,-22260.4,-73.8439], Tmin=(1007.47,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-136.418,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(532.126,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + group(Cds-CdsHH)"""),
)

species(
    label = 'C=COCC=CCCC(3140)',
    structure = SMILES('C=COCC=CCCC'),
    E0 = (-158.399,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (126.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.844757,0.0880835,-2.7551e-05,-3.07142e-08,1.90013e-11,-18860.2,36.1378], Tmin=(100,'K'), Tmax=(988.226,'K')), NASAPolynomial(coeffs=[21.9922,0.0372641,-1.35828e-05,2.47726e-09,-1.75993e-13,-25406,-84.0488], Tmin=(988.226,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-158.399,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(532.126,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-CdsHH)"""),
)
...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.288072,0.0821207,-4.96543e-05,4.95777e-09,4.25005e-12,22150.5,36.4346], Tmin=(100,'K'), Tmax=(1037.92,'K')), NASAPolynomial(coeffs=[17.9817,0.0342492,-1.30423e-05,2.3626e-09,-1.64048e-13,17144,-58.2348], Tmin=(1037.92,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(182.799,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C=CJO) + radical(CCJCO)"""),
)

species(
    label = '[CH2]C(CCC)CO[C]=C(3141)',
    structure = SMILES('[CH2]C(CCC)CO[C]=C'),
    E0 = (158.504,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (126.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.45029,0.105279,-8.77904e-05,3.86906e-08,-6.83469e-12,19272.1,41.8655], Tmin=(100,'K'), Tmax=(1362.65,'K')), NASAPolynomial(coeffs=[21.614,0.0375756,-1.32628e-05,2.22868e-09,-1.45208e-13,12986.4,-76.5434], Tmin=(1362.65,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(158.504,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(527.969,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(Isobutyl) + radical(C=CJO)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'C=[C]OCC=CCCC(3125)'],
    products = ['C=[C]OC[CH]CCCC(1136)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'C=[C]OC=CCCCC(3126)'],
    products = ['C=[C]OC[CH]CCCC(1136)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', 'C#COC[CH]CCCC(3127)'],
    products = ['C=[C]OC[CH]CCCC(1136)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['npropyl(83)', 'C=[C]OCC=C(2614)'],
    products = ['C=[C]OC[CH]CCCC(1136)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction16',
    reactants = ['C=[C]OC[CH]CCCC(1136)'],
    products = ['C=COC[CH]C[CH]CC(3136)'],
...
reaction(
    label = 'reaction17',
    reactants = ['C=[C]OC[CH]CCCC(1136)'],
    products = ['C=COC[CH]CC[CH]C(3137)'],
...
reaction(
    label = 'reaction18',
    reactants = ['C=[C]OC[CH]CCCC(1136)'],
    products = ['[CH2]CCC[CH]COC=C(3138)'],
...
reaction(
    label = 'reaction22',
    reactants = ['CH2(S)(23)', 'C=[C]OC[CH]CCC(1144)'],
    products = ['C=[C]OC[CH]CCCC(1136)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH2]C(CCC)CO[C]=C(3141)'],
    products = ['C=[C]OC[CH]CCCC(1136)'],
...
reaction(
    label = 'reaction25',
    reactants = ['H2CC(41)', 'CCCC[CH]C[O](1762)'],
    products = ['C=[C]OC[CH]CCCC(1136)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[CH]CCCC(141)', '[CH2]O[C]=C(2374)'],
    products = ['C=[C]OC[CH]CCCC(1136)'],
