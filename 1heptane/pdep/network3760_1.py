...
species(
    label = '[O]C1CCC1OO[CH]C=O(21654)',
    structure = SMILES('[O]C1CCC1OO[CH]C=O'),
    E0 = (5.07026,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (144.125,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.500983,0.08517,-5.65157e-05,1.27654e-08,6.047e-13,783.357,35.9872], Tmin=(100,'K'), Tmax=(1178.4,'K')), NASAPolynomial(coeffs=[20.4625,0.0331128,-1.45665e-05,2.78903e-09,-1.97158e-13,-5483.6,-74.2184], Tmin=(1178.4,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(5.07026,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(415.724,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)OsHH) + group(Cds-OdCsH) + ring(Cyclobutane) + radical(CC(C)OJ) + radical(OCJC=O)"""),
)
...
species(
    label = 'O=C[CH]OOC=CCC=O(21657)',
    structure = SMILES('O=C[CH]OOC=CCC=O'),
    E0 = (-143.164,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2695,2870,700,800,1380,1410,450,500,1750,1800,900,1100,3025,407.5,1350,352.5,2995,3025,975,1000,1300,1375,400,500,1630,1680,2750,2850,1437.5,1250,1305,750,350,200,800],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.133696,0.0837852,-6.60407e-05,2.47012e-08,-3.71903e-12,-17079.3,35.4951], Tmin=(100,'K'), Tmax=(1532.2,'K')), NASAPolynomial(coeffs=[19.3139,0.0337135,-1.70219e-05,3.37321e-09,-2.39109e-13,-22957,-65.223], Tmin=(1532.2,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-143.164,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(Cs-(Cds-O2d)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-OdCsH) + group(Cds-OdCsH) + radical(OCJC=O)"""),
)

species(
    label = 'O=C=COO[CH]CCC=O(21658)',
    structure = SMILES('O=C=COO[CH]CCC=O'),
    E0 = (-51.0081,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2120,512.5,787.5,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,350,500,795,815,2782.5,750,1395,475,1775,1000,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (143.117,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.583732,0.10911,-0.000156331,1.29004e-07,-4.36054e-11,-5977.68,37.2832], Tmin=(100,'K'), Tmax=(762.111,'K')), NASAPolynomial(coeffs=[10.7967,0.0451428,-2.20909e-05,4.28266e-09,-2.9958e-13,-7589.29,-13.7222], Tmin=(762.111,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-51.0081,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cds-OdCsH) + group(Cds-(Cdd-O2d)OsH) + radical(CCsJOOC)"""),
)
...
species(
    label = 'O=C[CH]OOC[CH]CC=O(21659)',
    structure = SMILES('O=C[CH]OOC[CH]CC=O'),
    E0 = (-80.7387,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (144.125,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.611381,0.0917862,-4.71541e-05,-1.19819e-07,1.53764e-10,-9606.7,35.9425], Tmin=(100,'K'), Tmax=(453.782,'K')), NASAPolynomial(coeffs=[8.52893,0.053845,-2.70208e-05,5.27795e-09,-3.69917e-13,-10653.2,0.387612], Tmin=(453.782,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-80.7387,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(403.252,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-O2d)OsHH) + group(Cds-OdCsH) + group(Cds-OdCsH) + radical(OCJC=O) + radical(CCJCOOH)"""),
)

species(
    label = 'O=[C]COO[CH]CCC=O(21660)',
    structure = SMILES('O=[C]COO[CH]CCC=O'),
    E0 = (-78.5268,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,3025,407.5,1350,352.5,2782.5,750,1395,475,1775,1000,1855,455,950,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (144.125,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.335797,0.0953593,-7.96253e-05,-2.3846e-08,6.48905e-11,-9327.57,35.7197], Tmin=(100,'K'), Tmax=(495.397,'K')), NASAPolynomial(coeffs=[8.5873,0.0533251,-2.68099e-05,5.27983e-09,-3.73518e-13,-10446.9,-1.3388], Tmin=(495.397,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-78.5268,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(403.252,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-O2d)OsHH) + group(Cds-OdCsH) + group(Cds-OdCsH) + radical(CCsJOOC) + radical(CsCJ=O)"""),
)

species(
    label = 'O=C[CH]CCOO[CH]C=O(21661)',
    structure = SMILES('[O]C=CCCOO[CH]C=O'),
    E0 = (-137.902,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (144.125,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.740125,0.100174,-9.50841e-05,4.56565e-08,-8.7794e-12,-16411.8,37.8808], Tmin=(100,'K'), Tmax=(1246.74,'K')), NASAPolynomial(coeffs=[19.9808,0.0336934,-1.50996e-05,2.8868e-09,-2.0312e-13,-21578.5,-66.6556], Tmin=(1246.74,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-137.902,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(407.409,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-O2d)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-OdCsH) + radical(C=COJ) + radical(OCJC=O)"""),
)

species(
    label = 'O=[C]CCCOO[CH]C=O(21662)',
    structure = SMILES('O=[C]CCCOO[CH]C=O'),
    E0 = (-121.193,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (144.125,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.748942,0.113733,-0.000163258,1.37981e-07,-4.79646e-11,-14414,39.0189], Tmin=(100,'K'), Tmax=(765.943,'K')), NASAPolynomial(coeffs=[9.89124,0.0506586,-2.50308e-05,4.87194e-09,-3.41511e-13,-15823.7,-8.03893], Tmin=(765.943,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-121.193,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(403.252,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-O2d)OsHH) + group(Cds-OdCsH) + group(Cds-OdCsH) + radical(OCJC=O) + radical(CCCJ=O)"""),
)

species(
    label = 'O=CC[CH][CH]OOCC=O(21663)',
    structure = SMILES('O=CC[CH][CH]OOCC=O'),
    E0 = (-32.7828,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,3000,3050,390,425,1340,1360,335,370,2695,2870,700,800,1380,1410,450,500,1750,1800,900,1100,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (144.125,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.5724,0.0920645,-5.44034e-05,-9.66209e-08,1.31625e-10,-3836.82,36.5909], Tmin=(100,'K'), Tmax=(461.313,'K')), NASAPolynomial(coeffs=[8.50369,0.053444,-2.6864e-05,5.26123e-09,-3.69727e-13,-4889.4,0.98602], Tmin=(461.313,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-32.7828,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(403.252,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-O2d)OsHH) + group(Cds-OdCsH) + group(Cds-OdCsH) + radical(CCsJOOC) + radical(CCJCOOH)"""),
)

species(
    label = 'O=[C][CH]OOCCCC=O(21664)',
    structure = SMILES('O=[C][CH]OOCCCC=O'),
    E0 = (-126.483,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (144.125,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.376734,0.095117,-7.31371e-05,-4.36476e-08,8.27844e-11,-15097.6,35.0616], Tmin=(100,'K'), Tmax=(485.015,'K')), NASAPolynomial(coeffs=[8.59721,0.0537582,-2.69881e-05,5.30212e-09,-3.74204e-13,-16206,-1.85483], Tmin=(485.015,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-126.483,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(403.252,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-O2d)OsHH) + group(Cds-OdCsH) + group(Cds-OdCsH) + radical(OCJC=O) + radical(CsCJ=O)"""),
)

species(
    label = 'O=C[CH]C[CH]OOCC=O(21665)',
    structure = SMILES('[O]C=CC[CH]OOCC=O'),
    E0 = (-89.9461,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2782.5,750,1395,475,1775,1000,3025,407.5,1350,352.5,2995,3025,975,1000,1300,1375,400,500,1630,1680,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (144.125,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.734432,0.0993266,-9.37536e-05,4.45883e-08,-8.47408e-12,-10643.6,38.3988], Tmin=(100,'K'), Tmax=(1262.34,'K')), NASAPolynomial(coeffs=[20.2869,0.0327172,-1.46052e-05,2.78919e-09,-1.96146e-13,-15951,-67.9146], Tmin=(1262.34,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-89.9461,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(407.409,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-O2d)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-OdCsH) + radical(C=COJ) + radical(CCsJOOC)"""),
)

species(
    label = 'O=[C]CC[CH]OOCC=O(21666)',
    structure = SMILES('O=[C]CC[CH]OOCC=O'),
    E0 = (-73.2372,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,3025,407.5,1350,352.5,2782.5,750,1395,475,1775,1000,1855,455,950,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,200,800,1600],'cm^-1')),
    ...
    molecularWeight = (144.125,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.694055,0.112298,-0.000159836,1.34168e-07,-4.6481e-11,-8647.99,39.3611], Tmin=(100,'K'), Tmax=(757.499,'K')), NASAPolynomial(coeffs=[9.94684,0.0500995,-2.47735e-05,4.82979e-09,-3.39102e-13,-10087.7,-7.88189], Tmin=(757.499,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-73.2372,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(403.252,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-O2d)OsHH) + group(Cds-OdCsH) + group(Cds-OdCsH) + radical(CCCJ=O) + radical(CCsJOOC)"""),
)
...
species(
    label = 'O=CCC[CH]OOC1[CH]O1(21667)',
    structure = SMILES('O=CCC[CH]OOC1[CH]O1'),
    E0 = (6.44624,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (144.125,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.813652,0.108833,-0.000132291,8.97467e-08,-2.45864e-11,945.967,37.17], Tmin=(100,'K'), Tmax=(889.828,'K')), NASAPolynomial(coeffs=[14.4781,0.0400937,-1.6418e-05,2.93511e-09,-1.96802e-13,-1775.48,-34.8191], Tmin=(889.828,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(6.44624,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(407.409,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cds-OdCsH) + ring(Ethylene_oxide) + radical(CCsJOOC) + radical(CCsJO)"""),
)

species(
    label = 'O=C[CH]OOC1CC[CH]O1(21668)',
    structure = SMILES('O=C[CH]OOC1CC[CH]O1'),
    E0 = (-112.56,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (144.125,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.347772,0.0836255,-4.91236e-05,-1.49396e-09,8.55772e-12,-13370.5,32.5397], Tmin=(100,'K'), Tmax=(959.424,'K')), NASAPolynomial(coeffs=[18.7761,0.0314958,-1.07746e-05,1.84391e-09,-1.2536e-13,-18310.4,-65.5502], Tmin=(959.424,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-112.56,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(415.724,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-(Cds-O2d)OsHH) + group(Cds-OdCsH) + ring(Tetrahydrofuran) + radical(CCsJOCs) + radical(OCJC=O)"""),
)
...
species(
    label = 'O=CCC=COOCC=O(21669)',
    structure = SMILES('O=CCC=COOCC=O'),
    E0 = (-281.649,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (144.125,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.273698,0.0855169,-6.45546e-05,2.27298e-08,-3.16208e-12,-33714.2,37.2263], Tmin=(100,'K'), Tmax=(1681.93,'K')), NASAPolynomial(coeffs=[23.5011,0.0289744,-1.41274e-05,2.74165e-09,-1.91028e-13,-41711.5,-89.8344], Tmin=(1681.93,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-281.649,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(407.409,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(Cs-(Cds-O2d)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-OdCsH) + group(Cds-OdCsH)"""),
)

species(
    label = 'O=C=COOCCCC=O(21670)',
    structure = SMILES('O=C=COOCCCC=O'),
    E0 = (-237.449,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (144.125,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.414113,0.104914,-0.000132624,9.71341e-08,-2.96355e-11,-28406.6,36.3958], Tmin=(100,'K'), Tmax=(790.46,'K')), NASAPolynomial(coeffs=[11.0314,0.046993,-2.27042e-05,4.42403e-09,-3.12312e-13,-30216,-16.1302], Tmin=(790.46,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-237.449,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(407.409,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cds-OdCsH) + group(Cds-(Cdd-O2d)OsH)"""),
)
...
species(
    ...
    collisionModel = TransportData(shapeIndex=2, epsilon=(3721.09,'J/mol'), sigma=(6.38055,'angstroms'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with Tc=581.23 K, Pc=32.5 bar (from Joback method)"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
...
species(
    label = '[CH2]C(CC=O)OO[CH]C=O(21671)',
    structure = SMILES('[CH2]C(CC=O)OO[CH]C=O'),
    E0 = (-79.834,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,350,500,795,815,2695,2870,700,800,1380,1410,450,500,1750,1800,900,1100,200,800],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (144.125,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.523656,0.108379,-0.000138471,1.03289e-07,-3.23227e-11,-9447,39.0628], Tmin=(100,'K'), Tmax=(769.003,'K')), NASAPolynomial(coeffs=[10.6615,0.0502047,-2.50072e-05,4.9338e-09,-3.50671e-13,-11167.4,-11.962], Tmin=(769.003,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-79.834,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(403.252,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsOsH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)OsHH) + group(Cds-OdCsH) + group(Cds-OdCsH) + radical(OCJC=O) + radical(CJCOOH)"""),
)
...
species(
    label = 'C=COC[CH]OO[CH]C=O(21672)',
    structure = SMILES('C=COC[CH]OO[CH]C=O'),
    E0 = (-53.1165,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3050,390,425,1340,1360,335,370,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,2750,2850,1437.5,1250,1305,750,350,350,500,795,815,2782.5,750,1395,475,1775,1000,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (144.125,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.19047,0.110371,-0.000115384,6.05286e-08,-1.2567e-11,-6198.3,37.13], Tmin=(100,'K'), Tmax=(1168.53,'K')), NASAPolynomial(coeffs=[21.8889,0.0313679,-1.39697e-05,2.66942e-09,-1.88271e-13,-11592,-77.809], Tmin=(1168.53,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-53.1165,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(403.252,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-O2d)OsHH) + group(Cds-CdsOsH) + group(Cds-OdCsH) + group(Cds-CdsHH) + radical(OCJC=O) + radical(CCsJOOC)"""),
)

species(
    label = 'O=C[CH]OO[CH]CC=CO(21673)',
    structure = SMILES('O=C[CH]OO[CH]CC=CO'),
    E0 = (-92.9239,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3050,390,425,1340,1360,335,370,2995,3025,975,1000,1300,1375,400,500,1630,1680,3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,350,500,795,815,2782.5,750,1395,475,1775,1000,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (144.125,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.22801,0.109989,-0.000116228,6.16117e-08,-1.2868e-11,-10983.6,38.5169], Tmin=(100,'K'), Tmax=(1165.94,'K')), NASAPolynomial(coeffs=[22.2458,0.0294573,-1.26231e-05,2.37215e-09,-1.65972e-13,-16457.5,-78.3346], Tmin=(1165.94,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-92.9239,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(403.252,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-O2d)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-OdCsH) + radical(CCsJOOC) + radical(OCJC=O)"""),
)
...
species(
    label = '[O][CH]C1OOC1CCC=O(21674)',
    structure = SMILES('[O][CH]C1OOC1CCC=O'),
    E0 = (27.2582,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (144.125,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.409478,0.109353,-0.000167858,1.5486e-07,-5.69366e-11,3425.2,33.6438], Tmin=(100,'K'), Tmax=(815.798,'K')), NASAPolynomial(coeffs=[5.5858,0.0565959,-2.79017e-05,5.38711e-09,-3.74037e-13,3224.37,10.705], Tmin=(815.798,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(27.2582,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(415.724,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cds-OdCsH) + ring(12dioxetane) + radical(CCOJ) + radical(CCsJOH)"""),
)

species(
    label = 'O=CCC[CH]OOC=[C]O(21675)',
    structure = SMILES('O=CCC[CH]OOC=[C]O'),
    E0 = (7.26026,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,3615,1277.5,1000,1685,370,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,350,500,795,815,2782.5,750,1395,475,1775,1000,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (144.125,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.866177,0.111483,-0.000136093,8.82312e-08,-2.29802e-11,1044.67,40.6339], Tmin=(100,'K'), Tmax=(933.593,'K')), NASAPolynomial(coeffs=[16.4174,0.0374314,-1.7115e-05,3.27046e-09,-2.29222e-13,-2182.49,-41.5617], Tmin=(933.593,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(7.26026,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(403.252,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cds-OdCsH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + radical(CCsJOOC) + radical(C=CJO)"""),
)

species(
    label = 'O=CCC[CH]OO[C]=CO(21676)',
    structure = SMILES('O=CCC[CH]OO[C]=CO'),
    E0 = (7.26026,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,3615,1277.5,1000,1685,370,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,350,500,795,815,2782.5,750,1395,475,1775,1000,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (144.125,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.866164,0.111483,-0.000136093,8.82307e-08,-2.298e-11,1044.67,40.6338], Tmin=(100,'K'), Tmax=(933.622,'K')), NASAPolynomial(coeffs=[16.4174,0.0374313,-1.71149e-05,3.27045e-09,-2.29221e-13,-2182.5,-41.5618], Tmin=(933.622,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(7.26026,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(403.252,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cds-OdCsH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + radical(C=CJO) + radical(CCsJOOC)"""),
)

species(
    label = '[O]C=[C]OOCCCC=O(21677)',
    structure = SMILES('[O]C=[C]OOCCCC=O'),
    E0 = (-37.7178,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,3010,987.5,1337.5,450,1655,1685,370,2782.5,750,1395,475,1775,1000,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (144.125,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.329999,0.101042,-0.000112573,6.90632e-08,-1.75118e-11,-4385.35,39.8292], Tmin=(100,'K'), Tmax=(944.582,'K')), NASAPolynomial(coeffs=[13.3877,0.042952,-2.03266e-05,3.95788e-09,-2.8065e-13,-6976.87,-25.569], Tmin=(944.582,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-37.7178,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(407.409,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cds-OdCsH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + radical(C=CJO) + radical(C=COJ)"""),
)

species(
    label = 'O=CC[CH][CH]OOC=CO(21678)',
    structure = SMILES('O=CC[CH][CH]OOC=CO'),
    E0 = (-32.069,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3050,390,425,1340,1360,335,370,2995,3025,975,1000,1300,1375,400,500,1630,1680,3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,350,500,795,815,2782.5,750,1395,475,1775,1000,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (144.125,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.17725,0.113375,-0.000131376,7.74624e-08,-1.80269e-11,-3670.01,40.9173], Tmin=(100,'K'), Tmax=(1049.56,'K')), NASAPolynomial(coeffs=[20.4823,0.0308261,-1.33981e-05,2.5227e-09,-1.76304e-13,-8216.52,-64.6248], Tmin=(1049.56,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-32.069,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(403.252,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cds-OdCsH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + radical(CCJCOOH) + radical(CCsJOOC)"""),
)

species(
    label = 'O=C[CH]C[CH]OOC=CO(21679)',
    structure = SMILES('[O]C=CC[CH]OOC=CO'),
    E0 = (-89.2323,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2995,3005,3015,3025,975,983.333,991.667,1000,1300,1325,1350,1375,400,433.333,466.667,500,1630,1646.67,1663.33,1680,3025,407.5,1350,352.5,3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (144.125,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.76727,0.118283,-0.000123388,6.02444e-08,-1.09468e-11,-10462.3,44.0455], Tmin=(100,'K'), Tmax=(1540.55,'K')), NASAPolynomial(coeffs=[32.7791,0.00899131,-4.2436e-07,-1.2892e-10,1.27329e-14,-19397.7,-136.26], Tmin=(1540.55,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-89.2323,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(407.409,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + radical(C=COJ) + radical(CCsJOOC)"""),
)

species(
    label = '[CH]1CC[CH]OOC=COO1(21680)',
    structure = SMILES('[CH]1CC[CH]OOC=COO1'),
    E0 = (268.781,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (144.125,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.765017,0.109268,-0.00011671,6.52843e-08,-1.48792e-11,32494.8,20.0409], Tmin=(100,'K'), Tmax=(1050.2,'K')), NASAPolynomial(coeffs=[16.9888,0.0416477,-2.01287e-05,3.97496e-09,-2.84574e-13,28765.8,-66.4807], Tmin=(1050.2,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(268.781,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(O2s-O2s(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + ring(Cyclodecane) + radical(CCsJOOC) + radical(CCsJOOC)"""),
)

species(
    label = 'O=CCC=COOC=CO(21681)',
    structure = SMILES('O=CCC=COOC=CO'),
    E0 = (-280.935,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (144.125,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.03283,0.090136,-4.72397e-05,-1.80093e-08,1.65365e-11,-33589.2,38.2581], Tmin=(100,'K'), Tmax=(991.567,'K')), NASAPolynomial(coeffs=[28.3481,0.017469,-6.68174e-06,1.36167e-09,-1.06482e-13,-41670.2,-114.607], Tmin=(991.567,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-280.935,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(407.409,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-O2s(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-OdCsH) + group(Cds-CdsOsH) + group(Cds-CdsOsH)"""),
)
...
species(
    ...
    opticalIsomers = 1,
    molecularWeight = (144.125,'amu'),
    collisionModel = TransportData(shapeIndex=2, epsilon=(4631.93,'J/mol'), sigma=(7.43372,'angstroms'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with Tc=723.50 K, Pc=25.59 bar (from Joback method)"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
...
reaction(
    label = 'reaction2',
    reactants = ['O=C[CH]OO[CH]CCC=O(21348)'],
    products = ['[O]C1CCC1OO[CH]C=O(21654)'],
    transitionState = 'TS2',
...
reaction(
    ...
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(1.19e+11,'s^-1'), n=0.08, Ea=(69.8728,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R8;multiplebond_intra;radadd_intra_cs] for rate rule [R8;carbonylbond_intra_H;radadd_intra_csHDe]
Euclidian distance = 2.2360679775
family: Intra_R_Add_Exocyclic"""),
)
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)', 'O=C[CH]OOC=CCC=O(21657)'],
    products = ['O=C[CH]OO[CH]CCC=O(21348)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['H(3)', 'O=C=COO[CH]CCC=O(21658)'],
    products = ['O=C[CH]OO[CH]CCC=O(21348)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['CH2CHO(40)', 'C=COO[CH]C=O(4460)'],
    products = ['O=C[CH]OO[CH]CCC=O(21348)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['O=C[CH]OO[CH]CCC=O(21348)'],
    products = ['O=C[CH]OOC[CH]CC=O(21659)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['O=[C]COO[CH]CCC=O(21660)'],
    products = ['O=C[CH]OO[CH]CCC=O(21348)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['O=C[CH]OO[CH]CCC=O(21348)'],
    products = ['O=C[CH]CCOO[CH]C=O(21661)'],
...
reaction(
    label = 'reaction11',
    reactants = ['O=C[CH]OO[CH]CCC=O(21348)'],
    products = ['O=[C]CCCOO[CH]C=O(21662)'],
...
reaction(
    label = 'reaction12',
    reactants = ['O=CC[CH][CH]OOCC=O(21663)'],
    products = ['O=C[CH]OO[CH]CCC=O(21348)'],
...
reaction(
    label = 'reaction13',
    reactants = ['O=C[CH]OO[CH]CCC=O(21348)'],
    products = ['O=[C][CH]OOCCCC=O(21664)'],
...
reaction(
    label = 'reaction14',
    reactants = ['O=C[CH]C[CH]OOCC=O(21665)'],
    products = ['O=C[CH]OO[CH]CCC=O(21348)'],
    transitionState = 'TS14',
    kinetics = Arrhenius(A=(3.12565e+08,'s^-1'), n=1.41663, Ea=(114.216,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [RnH;C_rad_out_H/OneDe;Cs_H_out_H/OneDe] for rate rule [R6HJ_2;C_rad_out_H/OneDe;Cs_H_out_H/CO]
Euclidian distance = 2.2360679775
Multiplied by reaction path degeneracy 2.0
family: intra_H_migration"""),
)
...
reaction(
    label = 'reaction15',
    reactants = ['O=[C]CC[CH]OOCC=O(21666)'],
    products = ['O=C[CH]OO[CH]CCC=O(21348)'],
    transitionState = 'TS15',
    kinetics = Arrhenius(A=(5.18e+08,'s^-1'), n=1.01, Ea=(110.458,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R7Hall;Y_rad_out;Cs_H_out_H/OneDe] for rate rule [R7HJ_3;CO_rad_out;Cs_H_out_H/CO]
...
reaction(
    label = 'reaction17',
    reactants = ['O=C[CH]OO[CH]CCC=O(21348)'],
    products = ['O=CCC[CH]OOC1[CH]O1(21667)'],
...
reaction(
    label = 'reaction18',
    reactants = ['O=C[CH]OO[CH]CCC=O(21348)'],
    products = ['O=C[CH]OOC1CC[CH]O1(21668)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(2.47297e+10,'s^-1'), n=0.420959, Ea=(52.8552,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R6plus;multiplebond_intra;radadd_intra_csHDe] for rate rule [R8_linear;carbonyl_intra_H;radadd_intra_csHCO]
Euclidian distance = 3.0
family: Intra_R_Add_Endocyclic"""),
)
...
reaction(
    label = 'reaction23',
    reactants = ['CO(12)', 'CC[CH]OO[CH]C=O(11387)'],
    products = ['O=C[CH]OO[CH]CCC=O(21348)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[CH2]C(CC=O)OO[CH]C=O(21671)'],
    products = ['O=C[CH]OO[CH]CCC=O(21348)'],
...
reaction(
    label = 'reaction26',
    reactants = ['C=COC[CH]OO[CH]C=O(21672)'],
    products = ['O=C[CH]OO[CH]CCC=O(21348)'],
...
reaction(
    label = 'reaction27',
    reactants = ['O=C[CH]OO[CH]CC=CO(21673)'],
    products = ['O=C[CH]OO[CH]CCC=O(21348)'],
...
reaction(
    label = 'reaction28',
    reactants = ['[O]O[CH]C=O(3604)', '[CH]CCC=O(18484)'],
    products = ['O=C[CH]OO[CH]CCC=O(21348)'],
...
reaction(
    label = 'reaction29',
    reactants = ['CHCHO(47)', '[O]O[CH]CCC=O(16180)'],
    products = ['O=C[CH]OO[CH]CCC=O(21348)'],
...
reaction(
    label = 'reaction30',
    reactants = ['O=C[CH]OO[CH]CCC=O(21348)'],
    products = ['[O][CH]C1OOC1CCC=O(21674)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(91214,'m^3/(mol*s)'), n=0.695, Ea=(234.174,'kJ/mol'), T0=(1,'K'), comment="""Estimated using average of templates [R_R;O_rad/OneDe] + [Od_CO-CsH;YJ] for rate rule [Od_CO-CsH;O_rad/OneDe]
...
reaction(
    label = 'reaction32',
    reactants = ['O=CCC[CH]OOC=[C]O(21675)'],
    products = ['O=C[CH]OO[CH]CCC=O(21348)'],
...
reaction(
    label = 'reaction33',
    reactants = ['O=CCC[CH]OO[C]=CO(21676)'],
    products = ['O=C[CH]OO[CH]CCC=O(21348)'],
...
reaction(
    label = 'reaction34',
    reactants = ['[O]C=[C]OOCCCC=O(21677)'],
    products = ['O=C[CH]OO[CH]CCC=O(21348)'],
...
reaction(
    label = 'reaction35',
    reactants = ['O=CC[CH][CH]OOC=CO(21678)'],
    products = ['O=C[CH]OO[CH]CCC=O(21348)'],
...
reaction(
    label = 'reaction36',
    reactants = ['O=C[CH]C[CH]OOC=CO(21679)'],
    products = ['O=C[CH]OO[CH]CCC=O(21348)'],
...
reaction(
    label = 'reaction37',
    reactants = ['O=C[CH]OO[CH]CCC=O(21348)'],
    products = ['[CH]1CC[CH]OOC=COO1(21680)'],
    transitionState = 'TS37',
    kinetics = Arrhenius(A=(5.649e+12,'s^-1'), n=0.287, Ea=(364.344,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R6plus;carbonyl_intra_H;radadd_intra] for rate rule [R10_linear;carbonyl_intra_H;radadd_intra_O]
Euclidian distance = 2.2360679775
family: Intra_R_Add_Endocyclic"""),
)
...
reaction(
    label = 'reaction39',
    reactants = ['O=C[CH]OO[CH]CCC=O(21348)'],
    products = ['C1=COO1(3609)', '[O][CH]CCC=O(5764)'],
    transitionState = 'TS39',
    kinetics = Arrhenius(A=(3.11355e+11,'s^-1'), n=0, Ea=(259.818,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R3OO;Y_rad_intra;OO_intra] for rate rule [R3OO_SD;Y_rad_intra;OO_intra]
Euclidian distance = 1.0
...
reaction(
    label = 'reaction42',
    reactants = ['O(4)', '[CH]=COO[CH]CCC=O(21490)'],
    products = ['O=C[CH]OO[CH]CCC=O(21348)'],
