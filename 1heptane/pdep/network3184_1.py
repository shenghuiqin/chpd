...
species(
    label = 'CCCC(CC=COC[O])OO(17627)',
    structure = SMILES('CCCC(CC=COC[O])OO'),
    E0 = (-343.495,'kJ/mol'),
    modes = [
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-3.14998,0.137375,-0.000104627,2.84365e-08,1.00637e-12,-41038.3,49.4777], Tmin=(100,'K'), Tmax=(1051.38,'K')), NASAPolynomial(coeffs=[30.8196,0.0418676,-1.6491e-05,3.06547e-09,-2.16825e-13,-50045.6,-124.974], Tmin=(1051.38,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-343.495,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(619.428,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-OsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(OCOJ)"""),
)
...
species(
    label = 'CCCC(C[CH]COC[O])OO(17629)',
    structure = SMILES('CCCC(C[CH]COC[O])OO'),
    E0 = (-220.348,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2761.11,2772.22,2783.33,2794.44,2805.56,2816.67,2827.78,2838.89,2850,1425,1431.25,1437.5,1443.75,1450,1225,1237.5,1250,1262.5,1275,1270,1287.5,1305,1322.5,1340,700,725,750,775,800,300,325,350,375,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,200,800,914.286,1028.57,1142.86,1257.14,1371.43,1485.71,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (176.21,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.02723,0.135367,-0.000117455,5.451e-08,-1.05734e-11,-26287.3,50.0181], Tmin=(100,'K'), Tmax=(1200.27,'K')), NASAPolynomial(coeffs=[19.0922,0.0649845,-2.94977e-05,5.65569e-09,-3.97723e-13,-31357.1,-55.7261], Tmin=(1200.27,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-220.348,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(640.214,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsOsHH) + radical(OCOJ) + radical(CCJCO)"""),
)
...
species(
    label = 'CCCC(CCCO[CH][O])OO(17631)',
    structure = SMILES('CCCC(CCCO[CH][O])OO'),
    E0 = (-231.29,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2761.11,2772.22,2783.33,2794.44,2805.56,2816.67,2827.78,2838.89,2850,1425,1431.25,1437.5,1443.75,1450,1225,1237.5,1250,1262.5,1275,1270,1287.5,1305,1322.5,1340,700,725,750,775,800,300,325,350,375,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,200,800,914.286,1028.57,1142.86,1257.14,1371.43,1485.71,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (176.21,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.72102,0.162385,-0.000227005,1.97575e-07,-7.11424e-11,-27589.8,49.797], Tmin=(100,'K'), Tmax=(780.825,'K')), NASAPolynomial(coeffs=[8.84196,0.0843553,-4.09991e-05,7.93585e-09,-5.54639e-13,-28822.6,0.542064], Tmin=(780.825,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-231.29,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(640.214,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsOsHH) + radical(OCOJ) + radical(OCJO)"""),
)

species(
    label = 'CCCC([CH]CCOC[O])OO(17632)',
    structure = SMILES('CCCC([CH]CCOC[O])OO'),
    E0 = (-219.836,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2761.11,2772.22,2783.33,2794.44,2805.56,2816.67,2827.78,2838.89,2850,1425,1431.25,1437.5,1443.75,1450,1225,1237.5,1250,1262.5,1275,1270,1287.5,1305,1322.5,1340,700,725,750,775,800,300,325,350,375,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,200,800,914.286,1028.57,1142.86,1257.14,1371.43,1485.71,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (176.21,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.0132,0.140197,-0.000132586,6.99301e-08,-1.56564e-11,-26230.2,49.7953], Tmin=(100,'K'), Tmax=(1044.43,'K')), NASAPolynomial(coeffs=[16.0746,0.0709228,-3.30948e-05,6.42397e-09,-4.55157e-13,-30008.4,-38.254], Tmin=(1044.43,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-219.836,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(640.214,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsOsHH) + radical(CCJCOOH) + radical(OCOJ)"""),
)

species(
    label = 'CCC[C](CCCOC[O])OO(17633)',
    structure = SMILES('CCC[C](CCCOC[O])OO'),
    E0 = (-233.351,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (176.21,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.90059,0.140454,-0.000139912,8.19434e-08,-2.07993e-11,-27862.2,47.3955], Tmin=(100,'K'), Tmax=(921.897,'K')), NASAPolynomial(coeffs=[12.7578,0.0768522,-3.64249e-05,7.10558e-09,-5.04473e-13,-30564.9,-22.1306], Tmin=(921.897,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-233.351,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(640.214,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsOsHH) + radical(C2CsJOOH) + radical(OCOJ)"""),
)

species(
    label = 'CCCC(C[CH][CH]OCO)OO(17634)',
    structure = SMILES('CCCC(C[CH][CH]OCO)OO'),
    E0 = (-267.29,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (176.21,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-3.99605,0.158374,-0.000158394,7.95568e-08,-1.56036e-11,-31844.9,56.0551], Tmin=(100,'K'), Tmax=(1248.95,'K')), NASAPolynomial(coeffs=[33.5756,0.0380435,-1.38763e-05,2.41585e-09,-1.62481e-13,-41229.9,-133.559], Tmin=(1248.95,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-267.29,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(636.057,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsOsHH) + radical(CCJCO) + radical(CCsJOCs)"""),
)

species(
    label = 'CC[CH]C(CCCOC[O])OO(17635)',
    structure = SMILES('CC[CH]C(CCCOC[O])OO'),
    E0 = (-219.836,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2761.11,2772.22,2783.33,2794.44,2805.56,2816.67,2827.78,2838.89,2850,1425,1431.25,1437.5,1443.75,1450,1225,1237.5,1250,1262.5,1275,1270,1287.5,1305,1322.5,1340,700,725,750,775,800,300,325,350,375,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,200,800,914.286,1028.57,1142.86,1257.14,1371.43,1485.71,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'CCCC(CCCOC[O])O[O](17636)',
    structure = SMILES('CCCC(CCCOC[O])O[O]'),
    E0 = (-268.246,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (176.21,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.84147,0.135421,-0.000124575,6.45528e-08,-1.4263e-11,-32057.9,47.6293], Tmin=(100,'K'), Tmax=(1055.21,'K')), NASAPolynomial(coeffs=[15.3005,0.070441,-3.22047e-05,6.19427e-09,-4.36665e-13,-35675.6,-35.9921], Tmin=(1055.21,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-268.246,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(644.372,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsOsHH) + radical(ROOJ) + radical(OCOJ)"""),
)

species(
    label = 'C[CH]CC(CCCOC[O])OO(17637)',
    structure = SMILES('C[CH]CC(CCCOC[O])OO'),
    E0 = (-225.804,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2761.11,2772.22,2783.33,2794.44,2805.56,2816.67,2827.78,2838.89,2850,1425,1431.25,1437.5,1443.75,1450,1225,1237.5,1250,1262.5,1275,1270,1287.5,1305,1322.5,1340,700,725,750,775,800,300,325,350,375,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,200,800,914.286,1028.57,1142.86,1257.14,1371.43,1485.71,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (176.21,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.8454,0.138291,-0.000135191,7.7441e-08,-1.91882e-11,-26955.7,49.6346], Tmin=(100,'K'), Tmax=(943.685,'K')), NASAPolynomial(coeffs=[12.9911,0.0754063,-3.52384e-05,6.83277e-09,-4.83562e-13,-29756,-21.0837], Tmin=(943.685,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-225.804,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(640.214,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsOsHH) + radical(OCOJ) + radical(RCCJC)"""),
)

species(
    label = 'CCCC([CH]C[CH]OCO)OO(17638)',
    structure = SMILES('CCCC([CH]C[CH]OCO)OO'),
    E0 = (-266.777,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (176.21,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-3.77386,0.161058,-0.00016729,8.83661e-08,-1.83754e-11,-31797.5,55.0629], Tmin=(100,'K'), Tmax=(1173.45,'K')), NASAPolynomial(coeffs=[30.6631,0.0436716,-1.72393e-05,3.11914e-09,-2.13915e-13,-39879.6,-116.584], Tmin=(1173.45,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-266.777,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(636.057,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsOsHH) + radical(CCsJOCs) + radical(CCJCOOH)"""),
)

species(
    label = '[CH2]CCC(CCCOC[O])OO(17639)',
    structure = SMILES('[CH2]CCC(CCCOC[O])OO'),
    E0 = (-215.004,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (176.21,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.02801,0.139298,-0.000128832,6.55953e-08,-1.41105e-11,-25647.6,49.3243], Tmin=(100,'K'), Tmax=(1085.86,'K')), NASAPolynomial(coeffs=[16.9775,0.0692874,-3.21195e-05,6.2182e-09,-4.39935e-13,-29775,-43.9319], Tmin=(1085.86,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-215.004,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(640.214,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsOsHH) + radical(OCOJ) + radical(RCCJ)"""),
)

species(
    label = 'CCC[C](CC[CH]OCO)OO(17640)',
    structure = SMILES('CCC[C](CC[CH]OCO)OO'),
    E0 = (-280.293,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (176.21,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-3.40733,0.158513,-0.000165668,8.98226e-08,-1.93958e-11,-33440.9,51.7391], Tmin=(100,'K'), Tmax=(1123.83,'K')), NASAPolynomial(coeffs=[27.1097,0.0498948,-2.06918e-05,3.82129e-09,-2.64401e-13,-40300.1,-99.0506], Tmin=(1123.83,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-280.293,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(636.057,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsOsHH) + radical(CCsJOCs) + radical(C2CsJOOH)"""),
)

species(
    label = 'CC[CH]C(CC[CH]OCO)OO(17641)',
    structure = SMILES('CC[CH]C(CC[CH]OCO)OO'),
    E0 = (-266.777,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (176.21,'amu'),
...
species(
    label = 'CCCC(CCCOC=O)OO(17642)',
    structure = SMILES('CCCC(CCCOC=O)OO'),
    E0 = (-627.485,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (176.21,'amu'),
...
species(
    label = 'CCCC(CC=COCO)OO(17643)',
    structure = SMILES('CCCC(CC=COCO)OO'),
    E0 = (-570.893,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (176.21,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-3.572,0.138786,-7.59268e-05,-2.49601e-08,2.61793e-11,-68364.7,50.5123], Tmin=(100,'K'), Tmax=(952.292,'K')), NASAPolynomial(coeffs=[38.4763,0.0290227,-8.34135e-06,1.44816e-09,-1.07465e-13,-79404.6,-166.207], Tmin=(952.292,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-570.893,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(640.214,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-OsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH)"""),
)
...
species(
    label = 'CCC(CC[CH]OC[O])OO(17644)',
    structure = SMILES('CCC(CC[CH]OC[O])OO'),
    E0 = (-216.014,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,200,800,933.333,1066.67,1200,1333.33,1466.67,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.91338,0.133135,-0.000132114,7.02043e-08,-1.53235e-11,-25770.1,44.3222], Tmin=(100,'K'), Tmax=(1090.79,'K')), NASAPolynomial(coeffs=[19.2965,0.0553567,-2.5156e-05,4.83345e-09,-3.40904e-13,-30397.1,-59.8462], Tmin=(1090.79,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-216.014,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(569.541,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsOsHH) + radical(OCOJ) + radical(CCsJOCs)"""),
)
...
species(
    label = 'CCCC1CCC(OC[O])O1(17645)',
    structure = SMILES('CCCC1CCC(OC[O])O1'),
    E0 = (-426.59,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (159.203,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.946666,0.0872801,3.20008e-06,-6.57912e-08,3.17332e-11,-51109.5,37.8482], Tmin=(100,'K'), Tmax=(967.372,'K')), NASAPolynomial(coeffs=[20.6689,0.0491657,-1.71898e-05,3.04118e-09,-2.12361e-13,-57690.2,-78.1153], Tmin=(967.372,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-426.59,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(611.114,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-OsOsHH) + ring(Tetrahydrofuran) + radical(OCOJ)"""),
)

species(
    label = '[CH2]C(CC(CCC)OO)OC[O](17646)',
    structure = SMILES('[CH2]C(CC(CCC)OO)OC[O]'),
    E0 = (-220.291,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (176.21,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.50546,0.150072,-0.000153793,8.67154e-08,-2.03257e-11,-26266.4,48.6654], Tmin=(100,'K'), Tmax=(1013.96,'K')), NASAPolynomial(coeffs=[18.5303,0.0670865,-3.1028e-05,5.9987e-09,-4.24205e-13,-30532.3,-53.1116], Tmin=(1013.96,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-220.291,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(640.214,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-OsOsHH) + radical(OCOJ) + radical(CJC(C)OC)"""),
)
...
species(
    label = 'CCCC([O])CCC(O)OC[O](17647)',
    structure = SMILES('CCCC([O])CCC(O)OC[O]'),
    E0 = (-461.626,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (176.21,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.07299,0.134793,-0.000116976,5.39465e-08,-1.03325e-11,-55303.3,49.8894], Tmin=(100,'K'), Tmax=(1219.99,'K')), NASAPolynomial(coeffs=[19.9833,0.0624768,-2.80625e-05,5.35988e-09,-3.76191e-13,-60685.1,-60.9055], Tmin=(1219.99,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-461.626,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(644.372,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-OsOsHH) + radical(OCOJ) + radical(CC(C)OJ)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['CCCC(CC[CH]OC[O])OO(17518)'],
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'CCCC(CC=COC[O])OO(17627)'],
    products = ['CCCC(CC[CH]OC[O])OO(17518)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'CCCC(CC[CH]OC=O)OO(17628)'],
    products = ['CCCC(CC[CH]OC[O])OO(17518)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['[CH2]C(CCC)OO(331)', 'C=COC[O](961)'],
    products = ['CCCC(CC[CH]OC[O])OO(17518)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['CCCC(C[CH]COC[O])OO(17629)'],
    products = ['CCCC(CC[CH]OC[O])OO(17518)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['CCCC(CC[CH]OC[O])OO(17518)'],
    products = ['CCCC(CC[CH]O[CH]O)OO(17630)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['CCCC(CCCO[CH][O])OO(17631)'],
    products = ['CCCC(CC[CH]OC[O])OO(17518)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['CCCC([CH]CCOC[O])OO(17632)'],
    products = ['CCCC(CC[CH]OC[O])OO(17518)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['CCC[C](CCCOC[O])OO(17633)'],
    products = ['CCCC(CC[CH]OC[O])OO(17518)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CCCC(CC[CH]OC[O])OO(17518)'],
    products = ['CCCC(C[CH][CH]OCO)OO(17634)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CC[CH]C(CCCOC[O])OO(17635)'],
    products = ['CCCC(CC[CH]OC[O])OO(17518)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CCCC(CC[CH]OC[O])OO(17518)'],
    products = ['CCCC(CCCOC[O])O[O](17636)'],
...
reaction(
    label = 'reaction14',
    reactants = ['C[CH]CC(CCCOC[O])OO(17637)'],
    products = ['CCCC(CC[CH]OC[O])OO(17518)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CCCC(CC[CH]OC[O])OO(17518)'],
    products = ['CCCC([CH]C[CH]OCO)OO(17638)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]CCC(CCCOC[O])OO(17639)'],
    products = ['CCCC(CC[CH]OC[O])OO(17518)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CCCC(CC[CH]OC[O])OO(17518)'],
    products = ['CCC[C](CC[CH]OCO)OO(17640)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CCCC(CC[CH]OC[O])OO(17518)'],
    products = ['CC[CH]C(CC[CH]OCO)OO(17641)'],
...
reaction(
    label = 'reaction20',
    reactants = ['CCCC(CC[CH]OC[O])OO(17518)'],
    products = ['CCCC(CCCOC=O)OO(17642)'],
...
reaction(
    label = 'reaction21',
    reactants = ['CCCC(CC[CH]OC[O])OO(17518)'],
    products = ['CCCC(CC=COCO)OO(17643)'],
...
reaction(
    label = 'reaction22',
    reactants = ['CH2(S)(23)', 'CCC(CC[CH]OC[O])OO(17644)'],
    products = ['CCCC(CC[CH]OC[O])OO(17518)'],
...
reaction(
    label = 'reaction23',
    reactants = ['CCCC(CC[CH]OC[O])OO(17518)'],
    products = ['OH(5)', 'CCCC1CCC(OC[O])O1(17645)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[CH2]C(CC(CCC)OO)OC[O](17646)'],
    products = ['CCCC(CC[CH]OC[O])OO(17518)'],
...
reaction(
    label = 'reaction26',
    reactants = ['CCCC(CC[CH]OC[O])OO(17518)'],
    products = ['CCCC([O])CCC(O)OC[O](17647)'],
...
reaction(
    label = 'reaction27',
    reactants = ['[O]C[O](170)', '[CH]CCC(CCC)OO(17474)'],
    products = ['CCCC(CC[CH]OC[O])OO(17518)'],
