...
species(
    label = 'C#C[CH]CC=CCC(27112)',
    structure = SMILES('C#C[CH]CC=CCC'),
    E0 = (317.342,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,2175,525,750,770,3400,2100,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.184057,0.075782,-4.97154e-05,1.23394e-08,7.82989e-13,38311.9,31.1358], Tmin=(100,'K'), Tmax=(1016.51,'K')), NASAPolynomial(coeffs=[13.7483,0.0367323,-1.32324e-05,2.27685e-09,-1.52037e-13,34814.1,-38.1667], Tmin=(1016.51,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(317.342,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CtCsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Ct-CtCs) + group(Ct-CtH) + radical(Sec_Propargyl)"""),
)

species(
    label = 'C#CC=CC[CH]CC(27113)',
    structure = SMILES('C#CC=CC[CH]CC'),
    E0 = (358.934,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2995,3025,975,1000,1300,1375,400,500,1630,1680,2750,2800,2850,1350,1500,750,1050,1375,1000,2175,525,750,770,3400,2100,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (107.173,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.607686,0.0727146,-4.80887e-05,1.64671e-08,-2.36593e-12,43292.8,30.8323], Tmin=(100,'K'), Tmax=(1549.75,'K')), NASAPolynomial(coeffs=[13.0422,0.0406203,-1.70247e-05,3.10407e-09,-2.1026e-13,39438.7,-34.6046], Tmin=(1549.75,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(358.934,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCtH) + group(Ct-Ct(Cds-Cds)) + group(Ct-CtH) + radical(RCCJCC)"""),
)

species(
    label = 'C#C[CH]CCC=CC(27114)',
    ...
    molecularWeight = (107.173,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.142692,0.0792076,-6.28935e-05,2.81483e-08,-5.24389e-12,38174.5,30.6169], Tmin=(100,'K'), Tmax=(1265.29,'K')), NASAPolynomial(coeffs=[13.1765,0.038004,-1.40473e-05,2.41224e-09,-1.58955e-13,34876.2,-35.3309], Tmin=(1265.29,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(316.208,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CtCsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Ct-CtCs) + group(Ct-CtH) + radical(Sec_Propargyl)"""),
)
...
species(
    ...
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.279156,0.0834436,-7.46203e-05,4.21097e-08,-1.03403e-11,47654.2,32.8344], Tmin=(100,'K'), Tmax=(957.514,'K')), NASAPolynomial(coeffs=[8.77988,0.0479314,-1.89873e-05,3.37468e-09,-2.2666e-13,46026.3,-7.80749], Tmin=(957.514,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(395.117,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CtCsHH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(RCCJC) + radical(Sec_Propargyl)"""),
)

species(
    label = 'C#C[CH][CH]CCCC(27116)',
    ...
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.151169,0.0809259,-5.69063e-05,2.10683e-08,-3.19885e-12,42049.4,32.105], Tmin=(100,'K'), Tmax=(1533.27,'K')), NASAPolynomial(coeffs=[16.6449,0.0371082,-1.40393e-05,2.42971e-09,-1.59826e-13,36898.9,-56.105], Tmin=(1533.27,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(348.306,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(Allyl_S) + radical(C=C=CJ)"""),
)

species(
    label = 'C#CCC[CH][CH]CC(27117)',
...
species(
    ...
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.041245,0.0859347,-7.2843e-05,3.54799e-08,-7.23405e-12,48968.5,33.0282], Tmin=(100,'K'), Tmax=(1159.3,'K')), NASAPolynomial(coeffs=[12.6882,0.0420134,-1.60139e-05,2.79982e-09,-1.86668e-13,46017.1,-30.2659], Tmin=(1159.3,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(405.917,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CtCsHH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(Sec_Propargyl) + radical(RCCJ)"""),
)

species(
    label = '[C]#CCCC[CH]CC(27119)',
    structure = SMILES('[C]#CCCC[CH]CC'),
    E0 = (586.063,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,2175,525,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.254903,0.0876779,-9.78209e-05,7.51544e-08,-2.47796e-11,70616.8,33.6504], Tmin=(100,'K'), Tmax=(837.195,'K')), NASAPolynomial(coeffs=[5.87681,0.0531506,-2.22223e-05,4.01621e-09,-2.7025e-13,69944.1,9.13154], Tmin=(837.195,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(586.063,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CtCsHH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(RCCJCC) + radical(Acetyl)"""),
)

species(
    label = 'C#CCCC[CH][CH]C(27120)',
    ...
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.468504,0.0839155,-9.33391e-05,7.54049e-08,-2.63316e-11,53445.7,34.8762], Tmin=(100,'K'), Tmax=(828.044,'K')), NASAPolynomial(coeffs=[4.06127,0.0561188,-2.40709e-05,4.40808e-09,-2.98899e-13,53208.6,20.3826], Tmin=(828.044,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(443.365,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CtCsHH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(RCCJC) + radical(RCCJCC)"""),
)

species(
    label = 'C#CCCC[CH]C[CH2](27121)',
    structure = SMILES('C#CCCC[CH]C[CH2]'),
    E0 = (454.165,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,750,770,3400,2100,2175,525,3000,3100,440,815,1455,1000,3025,407.5,1350,352.5,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.443049,0.082646,-7.70827e-05,4.808e-08,-1.35193e-11,54747.6,34.0309], Tmin=(100,'K'), Tmax=(829.97,'K')), NASAPolynomial(coeffs=[6.72493,0.052373,-2.23744e-05,4.13912e-09,-2.84552e-13,53704.8,4.8947], Tmin=(829.97,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(454.165,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CtCsHH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(RCCJ) + radical(RCCJCC)"""),
)

species(
    label = '[C]#C[CH]CCCCC(27122)',
    ...
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0113927,0.0881819,-8.28614e-05,4.72925e-08,-1.13883e-11,64828.6,31.8802], Tmin=(100,'K'), Tmax=(990.568,'K')), NASAPolynomial(coeffs=[10.7653,0.044664,-1.69618e-05,2.94027e-09,-1.94435e-13,62693.6,-20.0088], Tmin=(990.568,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(537.814,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CtCsHH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(Acetyl) + radical(Sec_Propargyl)"""),
)

species(
    label = 'CC[CH]CCC1[C]=C1(27123)',
    structure = SMILES('CC[CH]CCC1[C]=C1'),
    E0 = (568.637,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.05289,0.0745765,-3.58285e-05,-3.68962e-08,4.65538e-11,68487.8,28.379], Tmin=(100,'K'), Tmax=(516.27,'K')), NASAPolynomial(coeffs=[5.30021,0.0563486,-2.55198e-05,4.86877e-09,-3.41107e-13,67853.7,8.80147], Tmin=(516.27,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(568.637,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cyclopropene) + radical(cyclopropenyl-vinyl) + radical(RCCJCC)"""),
)
...
species(
    ...
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0920076,0.0759711,-4.44201e-05,8.05104e-09,1.44572e-12,20731.6,31.6317], Tmin=(100,'K'), Tmax=(1095.63,'K')), NASAPolynomial(coeffs=[14.2161,0.0394353,-1.49764e-05,2.65551e-09,-1.8e-13,16734.5,-41.9158], Tmin=(1095.63,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(171.132,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CtCsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Ct-CtCs) + group(Ct-CtH)"""),
)

species(
    label = 'C#CC=CCCCC(27125)',
    ...
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0483506,0.0768719,-4.0064e-05,9.36819e-10,4.04027e-12,19937.9,30.6332], Tmin=(100,'K'), Tmax=(1103.65,'K')), NASAPolynomial(coeffs=[16.2603,0.038237,-1.53797e-05,2.83437e-09,-1.97007e-13,15091.2,-55.3035], Tmin=(1103.65,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(164.476,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCtH) + group(Ct-Ct(Cds-Cds)) + group(Ct-CtH)"""),
)

species(
    label = 'C#CCCCC=CC(27126)',
    ...
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0902114,0.0789074,-5.57521e-05,2.12447e-08,-3.37006e-12,20592.4,30.972], Tmin=(100,'K'), Tmax=(1455.17,'K')), NASAPolynomial(coeffs=[14.4119,0.0395397,-1.51717e-05,2.65336e-09,-1.76042e-13,16424.3,-43.4942], Tmin=(1455.17,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(169.997,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CtCsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Ct-CtCs) + group(Ct-CtH)"""),
)
...
species(
    label = 'C#C[CH]CCC([CH2])C(27127)',
    structure = SMILES('C#C[CH]CCC([CH2])C'),
    E0 = (400.059,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,2175,525,1380,1390,370,380,2900,435,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3100,440,815,1455,1000,750,770,3400,2100,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH]=[C]C1CCC1CC(27128)',
    structure = SMILES('[CH]=[C]C1CCC1CC'),
    E0 = (514.459,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (108.181,'amu'),
...
species(
    ...
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.881883,0.0725846,-4.99526e-05,2.12335e-08,-4.26977e-12,46645.2,32.896], Tmin=(100,'K'), Tmax=(1070.8,'K')), NASAPolynomial(coeffs=[6.11709,0.0530285,-2.25581e-05,4.1782e-09,-2.87875e-13,45524,7.28103], Tmin=(1070.8,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(386.925,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CtCsHH) + group(Cs-CsHHH) + group(Cs-CtHHH) + group(Ct-CtCs) + group(Ct-CtCs) + radical(RCCJCC) + radical(Propargyl)"""),
)

species(
    label = '[CH]=C=[C]CCCCC(27130)',
    structure = SMILES('[CH]=C=[C]CCCCC'),
    E0 = (445.035,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,540,610,2055,3120,650,792.5,1650,2750,2800,2850,1350,1500,750,1050,1375,1000,1685,370,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.184158,0.08428,-6.90346e-05,3.22707e-08,-6.43755e-12,53662.3,32.4693], Tmin=(100,'K'), Tmax=(1162.26,'K')), NASAPolynomial(coeffs=[11.5017,0.0453301,-1.87665e-05,3.43732e-09,-2.3556e-13,51031.5,-23.833], Tmin=(1162.26,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(445.035,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(C=C=CJ) + radical(Cds_S)"""),
)
...
species(
    label = 'C=C=CC[CH][CH]CC(27131)',
    structure = SMILES('C=C=CC[CH][CH]CC'),
    E0 = (441.633,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([540,610,2055,3000,3050,390,425,1340,1360,335,370,3010,987.5,1337.5,450,1655,2750,2800,2850,1350,1500,750,1050,1375,1000,2950,3100,1380,975,1025,1650,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.676782,0.0800719,-8.61578e-05,7.33175e-08,-2.79892e-11,53229.1,34.7291], Tmin=(100,'K'), Tmax=(778.395,'K')), NASAPolynomial(coeffs=[2.36097,0.0605517,-2.76032e-05,5.23473e-09,-3.63251e-13,53296.1,29.1402], Tmin=(778.395,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(441.633,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(RCCJCC) + radical(RCCJCC)"""),
)
...
species(
    label = '[CH2]C[CH]CCC=C=C(27132)',
    structure = SMILES('[CH2]C[CH]CCC=C=C'),
    E0 = (452.421,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([540,610,2055,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3000,3100,440,815,1455,1000,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.830069,0.0757516,-5.54069e-05,2.46634e-08,-5.17332e-12,54522.7,33.4151], Tmin=(100,'K'), Tmax=(1031.93,'K')), NASAPolynomial(coeffs=[6.32654,0.054446,-2.44374e-05,4.65598e-09,-3.26242e-13,53388.3,6.72507], Tmin=(1031.93,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(452.421,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(RCCJ) + radical(RCCJCC)"""),
)

species(
    label = 'C=C=CCC=CCC(27133)',
    structure = SMILES('C=C=CCC=CCC'),
    E0 = (170.657,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.185683,0.0723413,-3.36577e-05,-1.81897e-09,4.20987e-12,20672.3,32.1005], Tmin=(100,'K'), Tmax=(1128.5,'K')), NASAPolynomial(coeffs=[14.7891,0.0398653,-1.61258e-05,2.9681e-09,-2.05529e-13,16148.2,-45.5591], Tmin=(1128.5,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(170.657,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(465.61,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cdd-CdsCds)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['C#C[CH]CC[CH]CC(26534)'],
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'C#C[CH]CC=CCC(27112)'],
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', 'C#CC=CC[CH]CC(27113)'],
    products = ['C#C[CH]CC[CH]CC(26534)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)', 'C#C[CH]CCC=CC(27114)'],
    products = ['C#C[CH]CC[CH]CC(26534)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(1.46e+08,'cm^3/(mol*s)'), n=1.64, Ea=(5.73208,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""From training reaction 2555 used for Cds-CsH_Cds-CsH;HJ
Exact match found for rate rule [Cds-CsH_Cds-CsH;HJ]
...
reaction(
    label = 'reaction8',
    reactants = ['CH3(17)', 'C#C[CH]CCC=C(26866)'],
    products = ['C#C[CH]CC[CH]CC(26534)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['C#CC[CH]C[CH]CC(27072)'],
    products = ['C#C[CH]CC[CH]CC(26534)'],
...
reaction(
    label = 'reaction11',
    reactants = ['C#C[CH]CC[CH]CC(26534)'],
    products = ['C#C[CH]CCC[CH]C(27115)'],
...
reaction(
    label = 'reaction13',
    reactants = ['C#CCC[CH][CH]CC(27117)'],
    products = ['C#C[CH]CC[CH]CC(26534)'],
...
reaction(
    label = 'reaction14',
    reactants = ['C#C[CH]CCCC[CH2](27118)'],
    products = ['C#C[CH]CC[CH]CC(26534)'],
...
reaction(
    label = 'reaction16',
    reactants = ['C#CCCC[CH][CH]C(27120)'],
    products = ['C#C[CH]CC[CH]CC(26534)'],
...
reaction(
    label = 'reaction17',
    reactants = ['C#CCCC[CH]C[CH2](27121)'],
    products = ['C#C[CH]CC[CH]CC(26534)'],
...
reaction(
    label = 'reaction20',
    reactants = ['C#C[CH]CC[CH]CC(26534)'],
    products = ['CC[CH]CCC1[C]=C1(27123)'],
...
reaction(
    label = 'reaction25',
    reactants = ['CH2(S)(23)', 'C#C[CH]CC[CH]C(26544)'],
    products = ['C#C[CH]CC[CH]CC(26534)'],
...
reaction(
    label = 'reaction28',
    reactants = ['C#C[CH]CCC([CH2])C(27127)'],
    products = ['C#C[CH]CC[CH]CC(26534)'],
...
reaction(
    label = 'reaction30',
    reactants = ['[CH]CC(144)', '[CH]=C=CC[CH2](26618)'],
    products = ['C#C[CH]CC[CH]CC(26534)'],
...
reaction(
    label = 'reaction31',
    reactants = ['[CH2]C[CH]CC(135)', 'C3H2(81)'],
    products = ['C#C[CH]CC[CH]CC(26534)'],
...
reaction(
    label = 'reaction36',
    reactants = ['C=C=CC[CH][CH]CC(27131)'],
    products = ['C#C[CH]CC[CH]CC(26534)'],
...
reaction(
    label = 'reaction37',
    reactants = ['C#C[CH]CC[CH]CC(26534)'],
    products = ['[CH2][C]=CCCC=CC(19740)'],
    transitionState = 'TS37',
    kinetics = Arrhenius(A=(1.846e+10,'s^-1'), n=0.74, Ea=(145.185,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""Estimated using template [RnH;Cd_rad_out_singleH;Cs_H_out_H/NonDeC] for rate rule [R7HJ_5;Cd_rad_out_singleH;Cs_H_out_H/NonDeC]
Euclidian distance = 2.0
Multiplied by reaction path degeneracy 2.0
family: intra_H_migration"""),
)
...
reaction(
    label = 'reaction38',
    reactants = ['[CH2]C[CH]CCC=C=C(27132)'],
    products = ['C#C[CH]CC[CH]CC(26534)'],
