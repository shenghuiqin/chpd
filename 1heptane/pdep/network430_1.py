...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.520344,0.0698846,-2.92991e-05,1.4457e-10,1.59074e-12,-25796.7,32.6499], Tmin=(100,'K'), Tmax=(1533.61,'K')), NASAPolynomial(coeffs=[18.1063,0.0421533,-1.99148e-05,3.7765e-09,-2.58365e-13,-33323.5,-66.666], Tmin=(1533.61,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-215.571,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-OdCsOs) + radical(CCOJ)"""),
)

species(
    label = 'CCCCC=CC([O])=O(2726)',
    structure = SMILES('CCCCC=CC([O])=O'),
    E0 = (-134.371,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,180,180,180,354.546,804.56,1600,1828.57,2971.43,3200],'cm^-1')),
        HinderedRotor(inertia=(0.167189,'amu*angstrom^2'), symmetry=1, barrier=(3.84399,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.167189,'amu*angstrom^2'), symmetry=1, barrier=(3.84399,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.167189,'amu*angstrom^2'), symmetry=1, barrier=(3.84399,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.167189,'amu*angstrom^2'), symmetry=1, barrier=(3.84399,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.167189,'amu*angstrom^2'), symmetry=1, barrier=(3.84399,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.35812,0.0887519,-0.000106949,9.62759e-08,-3.79742e-11,-16038.3,34.4175], Tmin=(100,'K'), Tmax=(752.659,'K')), NASAPolynomial(coeffs=[2.701,0.063402,-3.07228e-05,5.98907e-09,-4.22047e-13,-16025.6,26.2072], Tmin=(752.659,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-134.371,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cd-Cd(CO)H) + group(Cds-O2d(Cds-Cds)O2s) + radical(CCOJ)"""),
)
...
species(
    ...
    molecularWeight = (128.169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.72606,0.0653784,-2.90356e-05,4.68734e-09,-2.05355e-13,-17307.8,26.7863], Tmin=(100,'K'), Tmax=(2681.07,'K')), NASAPolynomial(coeffs=[52.7071,0.00627569,-4.62184e-06,7.68284e-10,-4.05444e-14,-49667,-274.002], Tmin=(2681.07,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-143.967,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(482.239,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsOs) + radical(CCOJ) + radical(RCCJCC)"""),
)
...
species(
    ...
    molecularWeight = (128.169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.05664,0.0991131,-8.37821e-05,3.6498e-08,-6.35468e-12,-20400.5,34.9208], Tmin=(100,'K'), Tmax=(1378.46,'K')), NASAPolynomial(coeffs=[21.3251,0.0341661,-1.31089e-05,2.31831e-09,-1.55821e-13,-26571,-80.2422], Tmin=(1378.46,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-171.217,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(482.239,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsCs) + radical(Allyl_S) + radical(C=COJ)"""),
)

species(
    label = 'C[CH]CCCCC([O])=O(2731)',
    ...
    molecularWeight = (128.169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.51066,0.067012,-3.11858e-05,5.73891e-09,-3.64368e-13,-17299.2,27.7289], Tmin=(100,'K'), Tmax=(2831.89,'K')), NASAPolynomial(coeffs=[56.4009,0.0021271,-2.76806e-06,4.49803e-10,-2.11103e-14,-52326.2,-296.311], Tmin=(2831.89,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-143.979,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(482.239,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsOs) + radical(CCOJ) + radical(RCCJC)"""),
)

species(
    label = '[CH2]CCCCCC([O])=O(2732)',
    ...
    molecularWeight = (128.169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.266626,0.0896408,-9.13e-05,7.25347e-08,-2.7605e-11,-15890.3,35.041], Tmin=(100,'K'), Tmax=(698.608,'K')), NASAPolynomial(coeffs=[3.46913,0.0666261,-3.18396e-05,6.20744e-09,-4.39335e-13,-16223.6,21.5564], Tmin=(698.608,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-133.179,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(482.239,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsOs) + radical(CCOJ) + radical(RCCJ)"""),
)

species(
    label = 'CCC[CH][CH]CC(=O)O(2733)',
    ...
    molecularWeight = (128.169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.06835,0.075137,-2.35567e-05,-6.05128e-08,6.28524e-11,-20323.7,35.4257], Tmin=(100,'K'), Tmax=(492.631,'K')), NASAPolynomial(coeffs=[4.3321,0.0628239,-2.92637e-05,5.67035e-09,-4.01425e-13,-20817.4,20.2435], Tmin=(492.631,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-169.77,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(478.082,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsOs) + radical(RCCJCC) + radical(CCJCC=O)"""),
)

species(
    label = 'CC[CH]C[CH]CC(=O)O(2734)',
...
species(
    ...
    molecularWeight = (128.169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.540809,0.0830716,-6.52993e-05,3.29235e-08,-7.9618e-12,-20301.5,37.3513], Tmin=(100,'K'), Tmax=(909.666,'K')), NASAPolynomial(coeffs=[5.73683,0.0602244,-2.76267e-05,5.31545e-09,-3.74662e-13,-21246.8,12.7753], Tmin=(909.666,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-169.782,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(478.082,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsOs) + radical(RCCJC) + radical(CCJCC=O)"""),
)

species(
    label = '[CH2]CCC[CH]CC(=O)O(2736)',
    ...
    molecularWeight = (128.169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.370905,0.0841256,-5.98142e-05,2.28595e-08,-3.80008e-12,-18994.6,36.9795], Tmin=(100,'K'), Tmax=(1320.52,'K')), NASAPolynomial(coeffs=[10.9936,0.0519482,-2.32634e-05,4.40672e-09,-3.06617e-13,-21800.1,-17.2224], Tmin=(1320.52,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-158.982,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(478.082,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsOs) + radical(RCCJ) + radical(CCJCC=O)"""),
)

species(
    label = 'CCCC[CH]C[C]1OO1(2737)',
    ...
    molecularWeight = (128.169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.37008,0.0867274,-6.38141e-05,2.52575e-08,-4.12005e-12,26409.9,38.6936], Tmin=(100,'K'), Tmax=(1433.88,'K')), NASAPolynomial(coeffs=[16.3162,0.0401792,-1.51198e-05,2.61778e-09,-1.72807e-13,21624.6,-47.8217], Tmin=(1433.88,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(218.212,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(482.239,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + ring(dioxirane) + radical(Cs_P) + radical(RCCJCC)"""),
)
...
species(
    ...
    molecularWeight = (128.169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.444195,0.0857634,-7.21468e-05,3.75885e-08,-9.05724e-12,-43185.5,33.9692], Tmin=(100,'K'), Tmax=(931.045,'K')), NASAPolynomial(coeffs=[6.9707,0.0577238,-2.69724e-05,5.24167e-09,-3.71617e-13,-44400.8,2.94885], Tmin=(931.045,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-360.076,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(482.239,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cd-Cd(CO)H) + group(Cds-O2d(Cds-Cds)O2s)"""),
)

species(
    label = 'CCCC=CCC(=O)O(2739)',
    structure = SMILES('CCCC=CCC(=O)O'),
    E0 = (-441.276,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0309732,0.0752779,-2.81293e-05,-7.97922e-09,5.4294e-12,-52917.3,34.4318], Tmin=(100,'K'), Tmax=(1230.54,'K')), NASAPolynomial(coeffs=[17.1195,0.0440902,-2.00522e-05,3.86546e-09,-2.72411e-13,-58997.8,-59.4232], Tmin=(1230.54,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-441.276,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(482.239,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-OdCsOs)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'CCCC=CCC([O])=O(2725)'],
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', 'CCCCC=CC([O])=O(2726)'],
    products = ['CCCC[CH]CC([O])=O(886)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['npropyl(83)', 'C=CCC([O])=O(2504)'],
    products = ['CCCC[CH]CC([O])=O(886)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction11',
    reactants = ['CCCC[CH]CC([O])=O(886)'],
    products = ['CCCC[CH][CH]C(=O)O(2730)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CCCC[CH]CC([O])=O(886)'],
    products = ['CCC[CH][CH]CC(=O)O(2733)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CCCC[CH]CC([O])=O(886)'],
    products = ['CC[CH]C[CH]CC(=O)O(2734)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CCCC[CH]CC([O])=O(886)'],
    products = ['C[CH]CC[CH]CC(=O)O(2735)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CCCC[CH]CC([O])=O(886)'],
    products = ['[CH2]CCC[CH]CC(=O)O(2736)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CCCC[CH]CC([O])=O(886)'],
    products = ['CCCC[CH]C[C]1OO1(2737)'],
...
reaction(
    label = 'reaction23',
    reactants = ['CH2(S)(23)', 'CCC[CH]CC([O])=O(904)'],
    products = ['CCCC[CH]CC([O])=O(886)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[CH2]C(CCC)CC([O])=O(2740)'],
    products = ['CCCC[CH]CC([O])=O(886)'],
