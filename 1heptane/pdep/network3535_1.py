...
species(
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.10582,0.0587444,-5.1323e-05,2.48325e-08,-4.88552e-12,29464,27.3531], Tmin=(100,'K'), Tmax=(1221.51,'K')), NASAPolynomial(coeffs=[11.7783,0.0237959,-8.40677e-06,1.41003e-09,-9.17884e-14,26856.7,-26.2712], Tmin=(1221.51,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(244.077,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_P) + radical(Isobutyl)"""),
)
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)', '[CH2]C(C=C)C=O(19526)'],
    products = ['[CH2]C(C=C)C[O](18940)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['C2H3(30)', 'allyloxy(559)'],
    products = ['[CH2]C(C=C)C[O](18940)'],
    transitionState = 'TS7',
...
reaction(
    ...
    products = ['[CH2]C(C=C)C[O](18940)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(450.719,'m^3/(mol*s)'), n=0.996465, Ea=(67.0268,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [CO-HH_O;CJ]
Euclidian distance = 0
Multiplied by reaction path degeneracy 2.0
family: R_Addition_MultipleBond
Ea raised from 62.2 to 67.0 kJ/mol to match endothermicity of reaction."""),
)
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]C([CH]O)C=C(19528)'],
    products = ['[CH2]C(C=C)C[O](18940)'],
...
reaction(
    label = 'reaction26',
    reactants = ['O(4)', '[CH2]C([CH2])C=C(2950)'],
    products = ['[CH2]C(C=C)C[O](18940)'],
