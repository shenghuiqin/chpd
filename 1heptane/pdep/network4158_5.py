...
species(
    ...
    molecularWeight = (54.0904,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.59813,0.0301253,-1.77974e-05,5.47282e-09,-7.04417e-13,56398,15.4011], Tmin=(100,'K'), Tmax=(1698.32,'K')), NASAPolynomial(coeffs=[7.75984,0.0179681,-7.05988e-06,1.25785e-09,-8.39547e-14,54644.8,-12.235], Tmin=(1698.32,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(468.498,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo library: DFT_QCI_thermo + radical(Cds_P) + radical(Cds_S)"""),
)

species(
    label = 'CC1C=C1(25428)',
    structure = SMILES('CC1C=C1'),
    E0 = (241.082,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (54.0904,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.6968,0.0212766,1.49187e-05,-3.16128e-08,1.28846e-11,29048.9,10.3254], Tmin=(100,'K'), Tmax=(985.532,'K')), NASAPolynomial(coeffs=[8.00815,0.0175219,-6.46251e-06,1.17979e-09,-8.35043e-14,27137.4,-19.6076], Tmin=(985.532,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(241.082,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)CsH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cyclopropene)"""),
)
...
reaction(
    label = 'reaction33',
    reactants = ['CH2(19)', '[CH]=C[CH2](2461)'],
    products = ['[CH2][CH]C=C(2458)'],
...
reaction(
    label = 'reaction38',
    reactants = ['CH2(S)(23)', '[CH]=C[CH2](2461)'],
    products = ['[CH]=C[CH]C(2456)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(249.395,'m^3/(mol*s)'), n=1.58825, Ea=(4.24467,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [Cds-HH_Cds-OneDeH;HJ]
Euclidian distance = 0
family: R_Addition_MultipleBond"""),
)
...
reaction(
    label = 'reaction46',
    reactants = ['C2H2(T)(175)', 'CHCH3(T)(95)'],
    products = ['[CH]=C[CH]C(2456)'],
