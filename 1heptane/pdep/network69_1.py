...
reaction(
    label = 'reaction1',
    reactants = ['OH(5)', 'HCO(16)'],
    products = ['HOCHO(59)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(1.07458e+07,'m^3/(mol*s)'), n=0.0225, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using average of templates [Y_rad;CO_pri_rad] + [O_pri_rad;Y_rad] for rate rule [O_pri_rad;CO_pri_rad]
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'OCHO(66)'],
    products = ['HOCHO(59)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(1.4e+12,'cm^3/(mol*s)'), n=0.493, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(200,'K'), Tmax=(2500,'K'), comment="""From training reaction 25 used for H_rad;O_rad/OneDe
...
reaction(
    label = 'reaction4',
    reactants = ['HOCHO(59)'],
    products = ['H2(6)', 'CO2(13)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(4.5e+13,'s^-1'), n=0, Ea=(68240,'cal/mol'), T0=(1,'K'), comment="""Kinetics taken from the arrheniusHigh attribute of a Troe/Lindemann exprssion. Originally from reaction library Klippenstein_Glarborg2016"""),
)
...
reaction(
    label = 'reaction6',
    reactants = ['HOCHO(59)'],
    products = ['CO(12)', 'H2O(7)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(7.5e+14,'s^-1'), n=0, Ea=(68710,'cal/mol'), T0=(1,'K'), comment="""Kinetics taken from the arrheniusHigh attribute of a Troe/Lindemann exprssion. Originally from reaction library Klippenstein_Glarborg2016"""),
)
