species(
    ...
    E0 = (-185.048,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,492.5,1135,1000,3615,1277.5,1000,785.428],'cm^-1')),
        HinderedRotor(inertia=(0.608035,'amu*angstrom^2'), symmetry=1, barrier=(13.9799,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.09369,'amu*angstrom^2'), symmetry=1, barrier=(48.138,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0225039,'amu*angstrom^2'), symmetry=1, barrier=(104.769,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.556418,0.0412519,-3.10647e-05,1.2293e-08,-1.99691e-12,-22047.4,24.9983], Tmin=(298,'K'), Tmax=(800,'K')), NASAPolynomial(coeffs=[0.556418,0.0412519,-3.10647e-05,1.2293e-08,-1.99691e-12,-22047.4,24.9983], Tmin=(800,'K'), Tmax=(2500,'K'))], Tmin=(298,'K'), Tmax=(2500,'K'), E0=(-185.048,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), label="""HOCH2CH2OO""", comment="""Thermo library: Klippenstein_Glarborg2016"""),
)
...
species(
    ...
    E0 = (-156.311,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3025,407.5,1350,352.5,3615,1310,387.5,850,1000,3615,1277.5,1000,183.588],'cm^-1')),
        HinderedRotor(inertia=(0.00822403,'amu*angstrom^2'), symmetry=1, barrier=(8.43166,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(4.98977,'amu*angstrom^2'), symmetry=1, barrier=(119.627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(4.44678,'amu*angstrom^2'), symmetry=1, barrier=(106.495,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.351576,'amu*angstrom^2'), symmetry=1, barrier=(8.4303,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (77.0593,'amu'),
...
species(
    ...
    E0 = (-119.188,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3615,1310,387.5,850,1000,180,1462.54],'cm^-1')),
        HinderedRotor(inertia=(0.253528,'amu*angstrom^2'), symmetry=1, barrier=(5.8291,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.255479,'amu*angstrom^2'), symmetry=1, barrier=(5.87397,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.36645,'amu*angstrom^2'), symmetry=1, barrier=(54.4093,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (77.0593,'amu'),
...
species(
    ...
    E0 = (32.8163,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,492.5,1135,1000,180,2368.95],'cm^-1')),
...
species(
    ...
    E0 = (-4.30631,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3025,407.5,1350,352.5,3615,1277.5,1000,492.5,1135,1000,180],'cm^-1')),
        HinderedRotor(inertia=(0.226902,'amu*angstrom^2'), symmetry=1, barrier=(5.21692,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.223673,'amu*angstrom^2'), symmetry=1, barrier=(5.14268,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.224715,'amu*angstrom^2'), symmetry=1, barrier=(5.16665,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (76.0514,'amu'),
...
species(
    ...
    E0 = (-12.5909,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3025,407.5,1350,352.5,492.5,1135,1000,3615,1277.5,1000,180],'cm^-1')),
        HinderedRotor(inertia=(0.30522,'amu*angstrom^2'), symmetry=1, barrier=(7.0176,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.305538,'amu*angstrom^2'), symmetry=1, barrier=(7.02493,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.305417,'amu*angstrom^2'), symmetry=1, barrier=(7.02215,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (76.0514,'amu'),
...
species(
    ...
    E0 = (-181.006,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3615,1277.5,1000,263.86,264.683],'cm^-1')),
        HinderedRotor(inertia=(0.298722,'amu*angstrom^2'), symmetry=1, barrier=(14.7846,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.299029,'amu*angstrom^2'), symmetry=1, barrier=(14.7657,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
reaction(
    label = 'reaction4',
    reactants = ['O2(2)', 'CH2CH2OH(43)'],
    products = ['HOCH2CH2OO(56)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(4.2e+26,'cm^3/(mol*s)'), n=-4.46, Ea=(3940,'cal/mol'), T0=(1,'K')),
)

reaction(
    label = 'reaction1',
    reactants = ['OC[CH]OO(115)'],
    products = ['HOCH2CH2OO(56)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction2',
    reactants = ['HOCH2CH2OO(56)'],
    products = ['O[CH]COO(116)'],
    transitionState = 'TS3',
