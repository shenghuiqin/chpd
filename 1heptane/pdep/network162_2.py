species(
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.66361,0.131883,-0.000134122,7.81587e-08,-1.92539e-11,-31743,43.6908], Tmin=(100,'K'), Tmax=(960.896,'K')), NASAPolynomial(coeffs=[14.4088,0.0649768,-2.96782e-05,5.69552e-09,-4.00805e-13,-34831.7,-33.208], Tmin=(960.896,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-265.571,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(594.485,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ)"""),
)

species(
    label = 'CCC[C](CC(C)OO)OO(338)',
    structure = SMILES('CCC[C](CC(C)OO)OO'),
    E0 = (-230.676,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,360,370,350,3580,3650,1300,1320,350,425,825,875,900,1100,1380,1390,370,380,2900,435,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (163.192,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.81623,0.13815,-0.000154346,1.02628e-07,-2.9115e-11,-27543.5,43.7829], Tmin=(100,'K'), Tmax=(838.756,'K')), NASAPolynomial(coeffs=[12.3676,0.070509,-3.33806e-05,6.48259e-09,-4.58189e-13,-29922.9,-22.1522], Tmin=(838.756,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-230.676,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(590.328,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(C2CsJOOH)"""),
)
...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.55552,0.130127,-0.000145267,9.59394e-08,-2.6727e-11,-13465.8,44.0616], Tmin=(100,'K'), Tmax=(858.422,'K')), NASAPolynomial(coeffs=[12.75,0.0634686,-2.87897e-05,5.48172e-09,-3.83088e-13,-15921.8,-22.7704], Tmin=(858.422,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-113.566,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(573.699,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(ROOJ)"""),
)
...
species(
    label = 'CCC[C](CC(C)O[O])OO(346)',
    structure = SMILES('CCC[C](CC(C)O[O])OO'),
    E0 = (-78.6718,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,492.5,1135,1000,360,370,350,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (162.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.82949,0.13811,-0.000172913,1.32253e-07,-4.27377e-11,-9261.31,44.571], Tmin=(100,'K'), Tmax=(745.358,'K')), NASAPolynomial(coeffs=[11.2221,0.0680592,-3.19191e-05,6.12812e-09,-4.28464e-13,-11206.7,-14.5577], Tmin=(745.358,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-78.6718,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(569.541,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(C2CsJOOH) + radical(ROOJ)"""),
)
...
species(
    label = 'CCCC(C[CH]O[O])OO(347)',
    structure = SMILES('CCCC(C[CH]O[O])OO'),
    E0 = (-40.5652,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,492.5,1135,1000,3615,1310,387.5,850,1000,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.32367,0.125871,-0.000162395,1.24911e-07,-4.01049e-11,-4695.34,40.7083], Tmin=(100,'K'), Tmax=(753.2,'K')), NASAPolynomial(coeffs=[11.4532,0.0579989,-2.71923e-05,5.20999e-09,-3.63501e-13,-6619.53,-17.308], Tmin=(753.2,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-40.5652,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(498.868,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCsJOOH) + radical(ROOJ)"""),
)
...
species(
    label = 'CCCC([CH]C(C)O[O])OO(349)',
    structure = SMILES('CCCC([CH]C(C)O[O])OO'),
    E0 = (-65.156,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,492.5,1135,1000,3615,1310,387.5,850,1000,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (162.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.73966,0.135048,-0.000153783,1.01963e-07,-2.83934e-11,-7637.47,46.2721], Tmin=(100,'K'), Tmax=(859.683,'K')), NASAPolynomial(coeffs=[13.5492,0.0639105,-2.96581e-05,5.70655e-09,-4.01192e-13,-10266.2,-25.1763], Tmin=(859.683,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-65.156,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(569.541,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(CCJCOOH)"""),
)

species(
    label = '[CH2]C(CC(C)O[O])OO(350)',
    structure = SMILES('[CH2]C(CC(C)O[O])OO'),
    E0 = (-4.04784,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,492.5,1135,1000,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,3615,1310,387.5,850,1000,200,800],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.585502,0.106843,-0.000126068,8.3186e-08,-2.25759e-11,-326.9,37.3215], Tmin=(100,'K'), Tmax=(888.704,'K')), NASAPolynomial(coeffs=[13.3243,0.044234,-2.03918e-05,3.90995e-09,-2.74348e-13,-2799.17,-28.1435], Tmin=(888.704,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-4.04784,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(428.195,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJCOOH) + radical(ROOJ)"""),
)
...
species(
    label = '[CH2]CC(CC(C)O[O])OO(352)',
    structure = SMILES('[CH2]CC(CC(C)O[O])OO'),
    E0 = (-36.5443,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,492.5,1135,1000,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3100,440,815,1455,1000,3615,1310,387.5,850,1000,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    ...
    molecularWeight = (162.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.73422,0.135389,-0.000165805,1.23963e-07,-3.9158e-11,-8356.4,46.6717], Tmin=(100,'K'), Tmax=(761.794,'K')), NASAPolynomial(coeffs=[11.3151,0.0668699,-3.08885e-05,5.89351e-09,-4.10809e-13,-10344.6,-12.7333], Tmin=(761.794,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-71.1246,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(569.541,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(RCCJC)"""),
)

species(
    label = '[CH2]C(CC(CCC)OO)O[O](354)',
    structure = SMILES('[CH2]C(CC(CCC)OO)O[O]'),
    E0 = (-51.6084,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,492.5,1135,1000,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3000,3100,440,815,1455,1000,3615,1310,387.5,850,1000,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (162.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.81772,0.135629,-0.000150791,9.52111e-08,-2.50299e-11,-6004.11,46.2402], Tmin=(100,'K'), Tmax=(911.027,'K')), NASAPolynomial(coeffs=[15.163,0.0610722,-2.80313e-05,5.37768e-09,-3.77908e-13,-9098.05,-34.0994], Tmin=(911.027,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-51.6084,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(569.541,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(CJCOOH)"""),
)

species(
    label = '[CH2]CCC(CC(C)O[O])OO(355)',
...
species(
    ...
    molecularWeight = (149.165,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.04616,0.117463,-0.000121621,7.19053e-08,-1.79007e-11,-28904.4,39.2273], Tmin=(100,'K'), Tmax=(953.46,'K')), NASAPolynomial(coeffs=[13.4574,0.0566159,-2.58936e-05,4.97024e-09,-3.49756e-13,-31670.1,-30.0523], Tmin=(953.46,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-241.791,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(523.812,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ)"""),
)

species(
    label = 'CCCC(C[C](C)OO)OO(335)',
...
species(
    label = 'CCCC([CH]C(C)OO)OO(336)',
    structure = SMILES('CCCC([CH]C(C)OO)OO'),
    E0 = (-217.161,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3025,407.5,1350,352.5,3580,3650,1300,1320,350,425,825,875,900,1100,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (163.192,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.84224,0.136741,-0.000142427,8.39195e-08,-2.08106e-11,-25914.9,45.8814], Tmin=(100,'K'), Tmax=(956.258,'K')), NASAPolynomial(coeffs=[15.2098,0.0654138,-3.0543e-05,5.91931e-09,-4.18812e-13,-29176.2,-35.6223], Tmin=(956.258,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-217.161,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(590.328,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJCOOH)"""),
)

species(
    label = '[CH2]C(CC(CCC)OO)OO(337)',
    structure = SMILES('[CH2]C(CC(CCC)OO)OO'),
    E0 = (-203.613,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3580,3650,1300,1320,350,425,825,875,900,1100,3000,3100,440,815,1455,1000,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (163.192,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.9754,0.138023,-0.00014211,8.09461e-08,-1.91943e-11,-24279.3,46.0435], Tmin=(100,'K'), Tmax=(1002.55,'K')), NASAPolynomial(coeffs=[17.0209,0.0622319,-2.87146e-05,5.54228e-09,-3.91499e-13,-28088.3,-45.6511], Tmin=(1002.55,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-203.613,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(590.328,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJCOOH)"""),
)

species(
    label = 'CC[CH]C(CC(C)OO)OO(339)',
...
species(
    ...
    molecularWeight = (163.192,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.74345,0.135751,-0.000148666,9.66902e-08,-2.68036e-11,-26637.7,45.9608], Tmin=(100,'K'), Tmax=(857.815,'K')), NASAPolynomial(coeffs=[12.5308,0.0691884,-3.22689e-05,6.2279e-09,-4.38809e-13,-29086.5,-20.7148], Tmin=(857.815,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-223.129,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(590.328,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJC)"""),
)

species(
    label = '[CH2]CCC(CC(C)OO)OO(342)',
    ...
    molecularWeight = (163.192,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.82855,0.13549,-0.00013738,7.78601e-08,-1.85199e-11,-25333.5,45.3096], Tmin=(100,'K'), Tmax=(995.247,'K')), NASAPolynomial(coeffs=[15.9422,0.0640668,-2.97331e-05,5.75247e-09,-4.0681e-13,-28870.7,-40.339], Tmin=(995.247,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-212.329,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(590.328,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJ)"""),
)

species(
    label = 'CCCC1CC(C)OOO1(358)',
    ...
    molecularWeight = (146.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.991599,0.0914558,-2.00434e-05,-4.64763e-08,2.75039e-11,-25786.4,31.7309], Tmin=(100,'K'), Tmax=(928.472,'K')), NASAPolynomial(coeffs=[21.8667,0.0397163,-1.19629e-05,1.93814e-09,-1.30466e-13,-32045.6,-87.6996], Tmin=(928.472,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-216.034,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(565.384,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(123trioxane)"""),
)

species(
    label = 'CC=CC(CCC)OO(316)',
...
species(
    ...
    molecularWeight = (162.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.41644,0.121624,-0.000108795,5.19043e-08,-1.02954e-11,-34726.8,44.6169], Tmin=(100,'K'), Tmax=(1180.64,'K')), NASAPolynomial(coeffs=[17.9124,0.0561371,-2.55933e-05,4.92295e-09,-3.47024e-13,-39290.9,-51.8429], Tmin=(1180.64,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-290.339,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(569.541,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH)"""),
)

species(
    label = 'CCC=C(CC(C)OO)OO(1962)',
    structure = SMILES('CCC=C(CC(C)OO)OO'),
    E0 = (-290.002,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3010,987.5,1337.5,450,1655,3580,3650,1300,1320,350,425,825,875,900,1100,350,440,435,1725,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,1380,1390,370,380,2900,435,200,800,1600],'cm^-1')),
    ...
    molecularWeight = (162.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.37954,0.123694,-0.000116671,6.05575e-08,-1.32074e-11,-34690,43.5856], Tmin=(100,'K'), Tmax=(1076.57,'K')), NASAPolynomial(coeffs=[15.8594,0.059643,-2.74274e-05,5.29331e-09,-3.73961e-13,-38401.7,-40.8541], Tmin=(1076.57,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-290.002,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(569.541,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH)"""),
)
...
species(
    label = 'C=C(CCC)OO(1963)',
    structure = SMILES('C=C(CCC)OO'),
    E0 = (-130.366,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2950,3100,1380,975,1025,1650,350,440,435,1725,3615,1310,387.5,850,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,180,827],'cm^-1')),
        HinderedRotor(inertia=(0.607058,'amu*angstrom^2'), symmetry=1, barrier=(13.9575,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.203594,'amu*angstrom^2'), symmetry=1, barrier=(4.68103,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.203662,'amu*angstrom^2'), symmetry=1, barrier=(4.68259,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.607156,'amu*angstrom^2'), symmetry=1, barrier=(13.9597,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.028761,'amu*angstrom^2'), symmetry=1, barrier=(13.9604,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (102.132,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.847438,0.0675266,-4.90359e-05,1.85574e-08,-2.92761e-12,-15564.8,27.736], Tmin=(100,'K'), Tmax=(1443.26,'K')), NASAPolynomial(coeffs=[12.7331,0.0345855,-1.47996e-05,2.74309e-09,-1.88263e-13,-18995.6,-33.9662], Tmin=(1443.26,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-130.366,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH)"""),
)

species(
    label = 'C=C(CC(C)OO)OO(1964)',
    structure = SMILES('C=C(CC(C)OO)OO'),
    E0 = (-231.331,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,2950,3100,1380,975,1025,1650,3580,3650,1300,1320,350,425,825,875,900,1100,350,440,435,1725,2750,2850,1437.5,1250,1305,750,350,1380,1390,370,380,2900,435,200,800],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (134.13,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.23535,0.098013,-9.98072e-05,5.56567e-08,-1.29168e-11,-27674.2,34.7613], Tmin=(100,'K'), Tmax=(1022.11,'K')), NASAPolynomial(coeffs=[13.5523,0.044056,-2.06233e-05,4.00986e-09,-2.84462e-13,-30492.7,-32.0577], Tmin=(1022.11,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-231.331,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(428.195,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH)"""),
)
...
species(
    label = 'C[CH]C[C](CCC)OO(319)',
    structure = SMILES('C[CH]C[C](CCC)OO'),
    E0 = (64.7352,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,360,370,350,3615,1310,387.5,850,1000,3025,407.5,1350,352.5,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (130.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.706825,0.0877628,-1.45673e-05,-1.42132e-07,1.48528e-10,7888.48,34.6135], Tmin=(100,'K'), Tmax=(456.869,'K')), NASAPolynomial(coeffs=[6.05557,0.0668439,-3.09568e-05,5.91982e-09,-4.13276e-13,7129.33,10.0394], Tmin=(456.869,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(64.7352,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(523.812,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJC) + radical(C2CsJOOH)"""),
)
...
species(
    label = '[CH2][C](CCC)OO(1969)',
    structure = SMILES('[CH2][C](CCC)OO'),
    E0 = (131.812,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,360,370,350,3615,1310,387.5,850,1000,3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (102.132,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.696352,0.0783789,-8.042e-05,5.08724e-08,-1.40732e-11,15967.3,29.1363], Tmin=(100,'K'), Tmax=(849.984,'K')), NASAPolynomial(coeffs=[7.89676,0.0444949,-2.06255e-05,3.97521e-09,-2.80036e-13,14743.2,-4.43137], Tmin=(849.984,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(131.812,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJCOOH) + radical(C2CsJOOH)"""),
)

species(
    label = 'CCC[C](C[CH]OO)OO(1970)',
    structure = SMILES('CCC[C](C[CH]OO)OO'),
    E0 = (-5.67083,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,360,370,350,3580,3650,1300,1320,350,425,825,875,900,1100,3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (148.157,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.5743,0.133632,-0.000189532,1.60933e-07,-5.61409e-11,-491.892,41.1308], Tmin=(100,'K'), Tmax=(782.542,'K')), NASAPolynomial(coeffs=[10.0563,0.0623356,-3.01614e-05,5.81597e-09,-4.05359e-13,-1949.46,-9.8107], Tmin=(782.542,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-5.67083,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(494.711,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCsJOOH) + radical(C2CsJOOH)"""),
)

species(
    label = 'CCC[C](C[C](C)OO)OO(1971)',
    structure = SMILES('CCC[C](C[C](C)OO)OO'),
    E0 = (-43.7774,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,360,363.333,366.667,370,300,400,3580,3650,1300,1320,350,425,825,875,900,1100,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (162.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.717159,0.123915,-8.29792e-05,-8.13481e-08,1.24978e-10,-5116.01,40.4134], Tmin=(100,'K'), Tmax=(483.322,'K')), NASAPolynomial(coeffs=[9.87539,0.07233,-3.48594e-05,6.729e-09,-4.70012e-13,-6561.34,-7.34759], Tmin=(483.322,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-43.7774,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(565.384,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(C2CsJOOH) + radical(C2CsJOOH)"""),
)

species(
    label = '[CH2][C](CC(C)OO)OO(1972)',
    structure = SMILES('[CH2][C](CC(C)OO)OO'),
    E0 = (30.8466,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,3580,3650,1300,1320,350,425,825,875,900,1100,200,800],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (134.13,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.812198,0.114183,-0.000151019,1.15257e-07,-3.63811e-11,3875.58,37.6666], Tmin=(100,'K'), Tmax=(767.337,'K')), NASAPolynomial(coeffs=[11.6862,0.0490271,-2.36446e-05,4.58665e-09,-3.2231e-13,1957.6,-19.3201], Tmin=(767.337,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(30.8466,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(424.038,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJCOOH) + radical(C2CsJOOH)"""),
)

species(
    label = '[CH2]C[C](CC(C)OO)OO(1973)',
    structure = SMILES('[CH2]C[C](CC(C)OO)OO'),
    E0 = (-1.64988,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3100,440,815,1455,1000,3580,3650,1300,1320,350,425,825,875,900,1100,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (148.157,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.31936,0.126494,-0.000160245,1.20308e-07,-3.78803e-11,-15.6034,41.5277], Tmin=(100,'K'), Tmax=(765.441,'K')), NASAPolynomial(coeffs=[11.5461,0.0592564,-2.84722e-05,5.52887e-09,-3.89294e-13,-1984.98,-17.1006], Tmin=(765.441,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1.64988,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(494.711,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJ) + radical(C2CsJOOH)"""),
)

species(
    label = 'C[CH]C[C](CC(C)OO)OO(1974)',
    structure = SMILES('C[CH]C[C](CC(C)OO)OO'),
    E0 = (-36.2302,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,3025,407.5,1350,352.5,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,360,370,350,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3580,3650,1300,1320,350,425,825,875,900,1100,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (162.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.739044,0.123285,-8.84859e-05,-5.897e-08,1.02929e-10,-4206.18,42.8984], Tmin=(100,'K'), Tmax=(494.586,'K')), NASAPolynomial(coeffs=[9.8966,0.0712799,-3.39166e-05,6.51653e-09,-4.54283e-13,-5674.22,-5.13002], Tmin=(494.586,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-36.2302,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(565.384,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(C2CsJOOH) + radical(RCCJC)"""),
)

species(
    label = 'CCC[C]([CH]C(C)OO)OO(1975)',
    ...
    molecularWeight = (162.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.01412,0.143017,-0.00018127,1.37899e-07,-4.41554e-11,-3432.98,46.7845], Tmin=(100,'K'), Tmax=(752.151,'K')), NASAPolynomial(coeffs=[11.9902,0.0685613,-3.28256e-05,6.36252e-09,-4.47399e-13,-5540.23,-16.7935], Tmin=(752.151,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-30.2615,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(565.384,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJCOOH) + radical(C2CsJOOH)"""),
)

species(
    label = 'CC[CH][C](CC(C)OO)OO(1976)',
    structure = SMILES('CC[CH][C](CC(C)OO)OO'),
    E0 = (-30.2615,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,3025,407.5,1350,352.5,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,360,370,350,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3580,3650,1300,1320,350,425,825,875,900,1100,200,800,1200,1600],'cm^-1')),
...
species(
    label = '[CH2]C(C[C](CCC)OO)OO(1977)',
    structure = SMILES('[CH2]C(C[C](CCC)OO)OO'),
    E0 = (-16.7139,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3000,3100,440,815,1455,1000,3580,3650,1300,1320,350,425,825,875,900,1100,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (162.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.00945,0.142461,-0.000173472,1.23571e-07,-3.68715e-11,-1803.07,46.4659], Tmin=(100,'K'), Tmax=(805.954,'K')), NASAPolynomial(coeffs=[13.3611,0.0661689,-3.14701e-05,6.10029e-09,-4.29804e-13,-4280.44,-24.371], Tmin=(805.954,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-16.7139,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(565.384,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJCOOH) + radical(C2CsJOOH)"""),
)

species(
    label = '[CH2]CC[C](CC(C)OO)OO(1978)',
...
species(
    label = 'CCC[C](CCOO)OO(1979)',
    structure = SMILES('CCC[C](CCOO)OO'),
    E0 = (-194.253,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,360,370,350,3580,3650,1300,1320,350,425,825,875,900,1100,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (149.165,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.942806,0.121727,-0.000130507,6.5382e-08,-2.58669e-12,-23197.6,38.8098], Tmin=(100,'K'), Tmax=(583.996,'K')), NASAPolynomial(coeffs=[10.1288,0.0644208,-3.09036e-05,6.0033e-09,-4.23088e-13,-24806.7,-11.3544], Tmin=(583.996,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-194.253,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(519.654,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(C2CsJOOH)"""),
)

species(
    label = 'CC[C](CC(C)OO)OO(1980)',
    structure = SMILES('CC[C](CC(C)OO)OO'),
    E0 = (-206.896,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,360,370,350,3580,3650,1300,1320,350,425,825,875,900,1100,1380,1390,370,380,2900,435,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (149.165,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.21298,0.123929,-0.000142686,9.76775e-08,-2.84152e-11,-24704.4,39.3684], Tmin=(100,'K'), Tmax=(820.634,'K')), NASAPolynomial(coeffs=[11.4881,0.0620181,-2.95176e-05,5.73821e-09,-4.05518e-13,-26788.9,-19.3958], Tmin=(820.634,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-206.896,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(519.654,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(C2CsJOOH)"""),
)

species(
    label = 'CCCC1(CC(C)O1)OO(1981)',
    ...
    molecularWeight = (146.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.45058,0.0922936,5.79567e-06,-9.45407e-08,5.00622e-11,-42761.9,35.2229], Tmin=(100,'K'), Tmax=(912.034,'K')), NASAPolynomial(coeffs=[30.4899,0.0252301,-4.00244e-06,4.07623e-10,-2.76738e-14,-51625,-132.58], Tmin=(912.034,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-357.388,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(557.07,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Oxetane)"""),
)

species(
    label = '[CH2]C(CCC)(OO)C(C)OO(1982)',
    structure = SMILES('[CH2]C(CCC)(OO)C(C)OO'),
    E0 = (-214.902,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3580,3650,1300,1320,350,425,825,875,900,1100,3000,3100,440,815,1455,1000,1380,1390,370,380,2900,435,200,800,933.333,1066.67,1200,1333.33,1466.67,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    ...
    molecularWeight = (163.192,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.07153,0.132861,-0.000125256,6.27459e-08,-1.28477e-11,-56219.5,44.7106], Tmin=(100,'K'), Tmax=(1162.26,'K')), NASAPolynomial(coeffs=[20.8026,0.0541376,-2.36564e-05,4.46849e-09,-3.12282e-13,-61536.6,-69.0832], Tmin=(1162.26,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-469.257,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(594.485,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)(O)OJ)"""),
)

species(
    label = 'CCCC(O)(CC(C)[O])OO(1985)',
    ...
    molecularWeight = (163.192,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-3.10483,0.138457,-0.000116428,3.8034e-08,-9.08316e-13,-56363.1,46.9523], Tmin=(100,'K'), Tmax=(1008.4,'K')), NASAPolynomial(coeffs=[31.1905,0.0356641,-1.29778e-05,2.33615e-09,-1.63813e-13,-64970.2,-127.171], Tmin=(1008.4,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-470.887,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(594.485,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ)"""),
)
...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.10118,0.0661776,-6.41118e-05,3.37556e-08,-7.39047e-12,27568,22.2137], Tmin=(100,'K'), Tmax=(1079.46,'K')), NASAPolynomial(coeffs=[10.881,0.029938,-1.37539e-05,2.65498e-09,-1.87655e-13,25456.6,-25.7159], Tmin=(1079.46,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(228.362,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CH2_triplet)"""),
)

species(
    label = 'CC(C[C]OO)OO(1988)',
    ...
    molecularWeight = (120.104,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.255004,0.0999178,-0.000126228,8.5283e-08,-2.335e-11,15470,30.2152], Tmin=(100,'K'), Tmax=(885.41,'K')), NASAPolynomial(coeffs=[13.946,0.0357642,-1.7546e-05,3.45374e-09,-2.45768e-13,12955.2,-36.5683], Tmin=(885.41,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(127.396,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(353.365,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CH2_triplet)"""),
)
...
reaction(
    label = 'reaction10',
    reactants = ['CCCC([O])CC(C)O[O](343)', 'OH(5)'],
    products = ['CCCC(CC(C)O[O])OO(334)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction11',
    reactants = ['CCC[CH]CC(C)O[O](223)', 'HO2(10)'],
    products = ['CCCC(CC(C)O[O])OO(334)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction1',
    reactants = ['O2(2)', 'C[CH]CC(CCC)OO(255)'],
    products = ['CCCC(CC(C)O[O])OO(334)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction12',
    reactants = ['H(3)', 'CCCC(CC(C)O[O])O[O](344)'],
    products = ['CCCC(CC(C)O[O])OO(334)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction13',
    reactants = ['CCC[CH]OO(265)', '[CH2]C(C)O[O](218)'],
    products = ['CCCC(CC(C)O[O])OO(334)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction14',
    reactants = ['CC(C[CH]OO)O[O](345)', 'npropyl(83)'],
    products = ['CCCC(CC(C)O[O])OO(334)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(1.15e+14,'cm^3/(mol*s)','*|/',2), n=-0.35, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2500,'K'), comment="""Estimated using template [C_rad/H/NonDe;C_rad/H2/Cs] for rate rule [C_rad/H/CsO;C_rad/H2/Cs]
Euclidian distance = 2.0
...
reaction(
    label = 'reaction15',
    reactants = ['H(3)', 'CCC[C](CC(C)O[O])OO(346)'],
    products = ['CCCC(CC(C)O[O])OO(334)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction16',
    reactants = ['C[CH]O[O](97)', '[CH2]C(CCC)OO(331)'],
    products = ['CCCC(CC(C)O[O])OO(334)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction17',
    reactants = ['CCCC(C[CH]O[O])OO(347)', 'CH3(17)'],
    products = ['CCCC(CC(C)O[O])OO(334)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction18',
    reactants = ['H(3)', 'CCCC(C[C](C)O[O])OO(348)'],
    products = ['CCCC(CC(C)O[O])OO(334)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(3)', 'CCCC([CH]C(C)O[O])OO(349)'],
    products = ['CCCC(CC(C)O[O])OO(334)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2]C(CC(C)O[O])OO(350)', 'C2H5(29)'],
    products = ['CCCC(CC(C)O[O])OO(334)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(3)', 'CC[CH]C(CC(C)O[O])OO(351)'],
    products = ['CCCC(CC(C)O[O])OO(334)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH2]CC(CC(C)O[O])OO(352)', 'CH3(17)'],
    products = ['CCCC(CC(C)O[O])OO(334)'],
...
reaction(
    label = 'reaction23',
    reactants = ['H(3)', 'C[CH]CC(CC(C)O[O])OO(353)'],
    products = ['CCCC(CC(C)O[O])OO(334)'],
...
reaction(
    label = 'reaction24',
    reactants = ['H(3)', '[CH2]C(CC(CCC)OO)O[O](354)'],
    products = ['CCCC(CC(C)O[O])OO(334)'],
...
reaction(
    label = 'reaction25',
    reactants = ['H(3)', '[CH2]CCC(CC(C)O[O])OO(355)'],
    products = ['CCCC(CC(C)O[O])OO(334)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CCC(CC(C)O[O])OO(357)', 'CH2(S)(23)'],
    products = ['CCCC(CC(C)O[O])OO(334)'],
...
reaction(
    label = 'reaction2',
    reactants = ['CCCC(CC(C)O[O])OO(334)'],
    products = ['CCCC(C[C](C)OO)OO(335)'],
...
reaction(
    label = 'reaction3',
    reactants = ['CCCC([CH]C(C)OO)OO(336)'],
    products = ['CCCC(CC(C)O[O])OO(334)'],
...
reaction(
    label = 'reaction4',
    reactants = ['CCCC(CC(C)O[O])OO(334)'],
    products = ['[CH2]C(CC(CCC)OO)OO(337)'],
...
reaction(
    label = 'reaction6',
    reactants = ['CC[CH]C(CC(C)OO)OO(339)'],
    products = ['CCCC(CC(C)O[O])OO(334)'],
...
reaction(
    label = 'reaction7',
    reactants = ['CCCC(CC(C)OO)O[O](340)'],
    products = ['CCCC(CC(C)O[O])OO(334)'],
...
reaction(
    label = 'reaction8',
    reactants = ['CCCC(CC(C)O[O])OO(334)'],
    products = ['C[CH]CC(CC(C)OO)OO(341)'],
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]CCC(CC(C)OO)OO(342)'],
    products = ['CCCC(CC(C)O[O])OO(334)'],
...
reaction(
    label = 'reaction28',
    reactants = ['CCCC(CC(C)O[O])OO(334)'],
    products = ['CCCC1CC(C)OOO1(358)', 'OH(5)'],
...
reaction(
    label = 'reaction29',
    reactants = ['CCCC(CC(C)O[O])OO(334)'],
    products = ['HO2(10)', 'CC=CC(CCC)OO(316)'],
...
reaction(
    label = 'reaction30',
    reactants = ['CCCC(CC(C)O[O])OO(334)'],
    products = ['HO2(10)', 'C=CCC(CCC)OO(317)'],
...
reaction(
    label = 'reaction31',
    reactants = ['CCCC(CC(C)[O])OO(359)', 'O(4)'],
    products = ['CCCC(CC(C)O[O])OO(334)'],
...
reaction(
    label = 'reaction32',
    reactants = ['H(3)', 'CCCC(=CC(C)OO)OO(1961)'],
    products = ['CCC[C](CC(C)OO)OO(338)'],
...
reaction(
    label = 'reaction33',
    reactants = ['H(3)', 'CCC=C(CC(C)OO)OO(1962)'],
    products = ['CCC[C](CC(C)OO)OO(338)'],
...
reaction(
    label = 'reaction34',
    reactants = ['CH3CHOOH(63)', 'C=C(CCC)OO(1963)'],
    products = ['CCC[C](CC(C)OO)OO(338)'],
...
reaction(
    label = 'reaction35',
    reactants = ['C2H5(29)', 'C=C(CC(C)OO)OO(1964)'],
    products = ['CCC[C](CC(C)OO)OO(338)'],
...
reaction(
    label = 'reaction36',
    reactants = ['OH(5)', 'CCCC(=O)CC(C)OO(1965)'],
    products = ['CCC[C](CC(C)OO)OO(338)'],
...
reaction(
    label = 'reaction40',
    reactants = ['CCCC(C[C](C)OO)OO(335)'],
    products = ['CCC[C](CC(C)OO)OO(338)'],
...
reaction(
    label = 'reaction41',
    reactants = ['C[CH]CC(CC(C)OO)OO(341)'],
    products = ['CCC[C](CC(C)OO)OO(338)'],
...
reaction(
    label = 'reaction42',
    reactants = ['[CH2]C(CC(CCC)OO)OO(337)'],
    products = ['CCC[C](CC(C)OO)OO(338)'],
...
reaction(
    label = 'reaction44',
    reactants = ['OH(5)', 'CCC[C](CC(C)[O])OO(1966)'],
    products = ['CCC[C](CC(C)OO)OO(338)'],
...
reaction(
    label = 'reaction45',
    reactants = ['C[CH]C[C](CCC)OO(319)', 'HO2(10)'],
    products = ['CCC[C](CC(C)OO)OO(338)'],
...
reaction(
    label = 'reaction46',
    reactants = ['OH(5)', 'CCC[C]([O])CC(C)OO(1967)'],
    products = ['CCC[C](CC(C)OO)OO(338)'],
...
reaction(
    label = 'reaction48',
    reactants = ['H(3)', 'CCC[C](CC(C)OO)O[O](1968)'],
    products = ['CCC[C](CC(C)OO)OO(338)'],
...
reaction(
    label = 'reaction49',
    reactants = ['CH3CHOOH(63)', '[CH2][C](CCC)OO(1969)'],
    products = ['CCC[C](CC(C)OO)OO(338)'],
...
reaction(
    label = 'reaction50',
    reactants = ['CH3(17)', 'CCC[C](C[CH]OO)OO(1970)'],
    products = ['CCC[C](CC(C)OO)OO(338)'],
...
reaction(
    label = 'reaction51',
    reactants = ['H(3)', 'CCC[C](C[C](C)OO)OO(1971)'],
    products = ['CCC[C](CC(C)OO)OO(338)'],
...
reaction(
    label = 'reaction52',
    reactants = ['C2H5(29)', '[CH2][C](CC(C)OO)OO(1972)'],
    products = ['CCC[C](CC(C)OO)OO(338)'],
...
reaction(
    label = 'reaction53',
    reactants = ['CH3(17)', '[CH2]C[C](CC(C)OO)OO(1973)'],
    products = ['CCC[C](CC(C)OO)OO(338)'],
...
reaction(
    label = 'reaction54',
    reactants = ['H(3)', 'C[CH]C[C](CC(C)OO)OO(1974)'],
    products = ['CCC[C](CC(C)OO)OO(338)'],
...
reaction(
    label = 'reaction55',
    reactants = ['H(3)', 'CCC[C]([CH]C(C)OO)OO(1975)'],
    products = ['CCC[C](CC(C)OO)OO(338)'],
...
reaction(
    label = 'reaction56',
    reactants = ['H(3)', 'CC[CH][C](CC(C)OO)OO(1976)'],
    products = ['CCC[C](CC(C)OO)OO(338)'],
...
reaction(
    label = 'reaction57',
    reactants = ['H(3)', '[CH2]C(C[C](CCC)OO)OO(1977)'],
    products = ['CCC[C](CC(C)OO)OO(338)'],
...
reaction(
    label = 'reaction58',
    reactants = ['H(3)', '[CH2]CC[C](CC(C)OO)OO(1978)'],
    products = ['CCC[C](CC(C)OO)OO(338)'],
...
reaction(
    label = 'reaction59',
    reactants = ['CH2(S)(23)', 'CCC[C](CCOO)OO(1979)'],
    products = ['CCC[C](CC(C)OO)OO(338)'],
...
reaction(
    label = 'reaction60',
    reactants = ['CH2(S)(23)', 'CC[C](CC(C)OO)OO(1980)'],
    products = ['CCC[C](CC(C)OO)OO(338)'],
...
reaction(
    label = 'reaction61',
    reactants = ['CCC[C](CC(C)OO)OO(338)'],
    products = ['OH(5)', 'CCCC1(CC(C)O1)OO(1981)'],
...
reaction(
    label = 'reaction62',
    reactants = ['[CH2]C(CCC)(OO)C(C)OO(1982)'],
    products = ['CCC[C](CC(C)OO)OO(338)'],
...
reaction(
    label = 'reaction63',
    reactants = ['[CH2]C(CC)(CC(C)OO)OO(1983)'],
    products = ['CCC[C](CC(C)OO)OO(338)'],
...
reaction(
    label = 'reaction64',
    reactants = ['CCC[C](CC(C)OO)OO(338)'],
    products = ['CCCC([O])(O)CC(C)OO(1984)'],
...
reaction(
    label = 'reaction65',
    reactants = ['CCC[C](CC(C)OO)OO(338)'],
    products = ['CCCC(O)(CC(C)[O])OO(1985)'],
...
reaction(
    label = 'reaction66',
    reactants = ['HO2(10)', 'CCC[C]CC(C)OO(1986)'],
    products = ['CCC[C](CC(C)OO)OO(338)'],
...
reaction(
    label = 'reaction67',
    reactants = ['QOOH_3(717)', 'CCC[C]OO(1987)'],
    products = ['CCC[C](CC(C)OO)OO(338)'],
...
reaction(
    label = 'reaction68',
    reactants = ['npropyl(83)', 'CC(C[C]OO)OO(1988)'],
    products = ['CCC[C](CC(C)OO)OO(338)'],
...
network(
    label = '162',
    isomers = [
        'CCCC(CC(C)O[O])OO(334)',
        'CCC[C](CC(C)OO)OO(338)',
    ],
    reactants = [
        ('O2(2)', 'C[CH]CC(CCC)OO(255)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
