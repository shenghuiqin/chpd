...
species(
    label = '[CH]=C1[CH]CCC1CCC(28484)',
    structure = SMILES('[CH]C1=CCCC1CCC'),
    E0 = (274.314,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (122.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0216753,0.0671524,3.12083e-05,-8.0108e-08,3.30301e-11,33155.8,32.7621], Tmin=(100,'K'), Tmax=(1003.56,'K')), NASAPolynomial(coeffs=[16.5756,0.0511881,-1.99467e-05,3.70737e-09,-2.63412e-13,27297.2,-59.9613], Tmin=(1003.56,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(274.314,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(540.441,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + ring(Cyclopentene) + radical(AllylJ2_triplet)"""),
)
...
species(
    label = 'C#C[CH]CCC=CCC(28661)',
    structure = SMILES('C#C[CH]CCC=CCC'),
    E0 = (293.562,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,2175,525,750,770,3400,2100,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.680033,0.093051,-7.18272e-05,3.04241e-08,-5.30317e-12,35484,36.487], Tmin=(100,'K'), Tmax=(1355.43,'K')), NASAPolynomial(coeffs=[16.6476,0.0419157,-1.5238e-05,2.5909e-09,-1.69528e-13,30786.8,-52.3784], Tmin=(1355.43,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(293.562,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CtCsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Ct-CtCs) + group(Ct-CtH) + radical(Sec_Propargyl)"""),
)

species(
    label = 'C#C[CH]CC=CCCC(28662)',
    structure = SMILES('C#C[CH]CC=CCCC'),
    E0 = (293.562,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,2175,525,750,770,3400,2100,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'C#CC=CC[CH]CCC(28663)',
    structure = SMILES('C#CC=CC[CH]CCC'),
    E0 = (335.154,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2995,3025,975,1000,1300,1375,400,500,1630,1680,2750,2800,2850,1350,1500,750,1050,1375,1000,2175,525,750,770,3400,2100,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (121.2,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0432862,0.0865955,-5.90709e-05,2.11899e-08,-3.22097e-12,40451.8,35.0992], Tmin=(100,'K'), Tmax=(1463.89,'K')), NASAPolynomial(coeffs=[13.6169,0.0495064,-2.10669e-05,3.88265e-09,-2.65272e-13,36477.7,-35.5585], Tmin=(1463.89,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(335.154,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCtH) + group(Ct-Ct(Cds-Cds)) + group(Ct-CtH) + radical(RCCJCC)"""),
)
...
species(
    label = 'C#C[CH]CCC[CH]CC(28664)',
    structure = SMILES('C#C[CH]CCC[CH]CC'),
    E0 = (371.349,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,750,770,3400,2100,2175,525,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3050,390,425,1340,1360,335,370,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    ...
    molecularWeight = (122.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.16388,0.0994606,-0.000113499,9.3619e-08,-3.32718e-11,50608.2,39.2193], Tmin=(100,'K'), Tmax=(817.94,'K')), NASAPolynomial(coeffs=[3.94134,0.0663971,-2.9047e-05,5.37343e-09,-3.66561e-13,50371.1,22.8947], Tmin=(817.94,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(419.597,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(527.969,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CtCsHH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(RCCJCC) + radical(RCCJCC)"""),
)

species(
    label = 'C#C[CH]CCCC[CH]C(28666)',
    structure = SMILES('C#C[CH]CCCC[CH]C'),
    E0 = (371.337,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (122.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.340526,0.0978877,-8.71963e-05,4.84503e-08,-1.17272e-11,44815.7,37.306], Tmin=(100,'K'), Tmax=(968.411,'K')), NASAPolynomial(coeffs=[9.72768,0.0562995,-2.27765e-05,4.10114e-09,-2.77813e-13,42865.8,-10.9437], Tmin=(968.411,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(371.337,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(527.969,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CtCsHH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(RCCJC) + radical(Sec_Propargyl)"""),
)

species(
    label = 'C#C[CH][CH]CCCCC(28667)',
    structure = SMILES('[CH]=C=C[CH]CCCCC'),
    E0 = (324.525,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (122.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.700513,0.0946761,-6.75925e-05,2.55571e-08,-3.99432e-12,39207.5,36.3139], Tmin=(100,'K'), Tmax=(1479.94,'K')), NASAPolynomial(coeffs=[17.4492,0.045621,-1.78728e-05,3.16009e-09,-2.10907e-13,33835.4,-58.363], Tmin=(1479.94,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(324.525,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(532.126,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(C=C=CJ) + radical(Allyl_S)"""),
)

species(
    label = 'C#CCC[CH][CH]CCC(28668)',
...
species(
    label = '[C]#CCCC[CH]CCC(28669)',
    structure = SMILES('[C]#CCCC[CH]CCC'),
    E0 = (562.282,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (122.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.396161,0.102503,-0.000111801,8.3485e-08,-2.71265e-11,67779.7,38.234], Tmin=(100,'K'), Tmax=(811.961,'K')), NASAPolynomial(coeffs=[6.79948,0.0615677,-2.60426e-05,4.75051e-09,-3.22086e-13,66792,6.13182], Tmin=(811.961,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(562.282,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(527.969,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CtCsHH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(Acetyl) + radical(RCCJCC)"""),
)

species(
    label = 'C#C[CH]CCCCC[CH2](28670)',
    structure = SMILES('C#C[CH]CCCCC[CH2]'),
    E0 = (382.137,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (122.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.647752,0.100247,-8.50554e-05,4.14619e-08,-8.50639e-12,46129.4,37.4508], Tmin=(100,'K'), Tmax=(1147.21,'K')), NASAPolynomial(coeffs=[13.6756,0.0503051,-1.9755e-05,3.51421e-09,-2.36774e-13,42843.1,-33.6179], Tmin=(1147.21,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(382.137,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(527.969,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CtCsHH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(RCCJ) + radical(Sec_Propargyl)"""),
)

species(
    label = 'C#CCCC[CH][CH]CC(28671)',
...
species(
    ...
    molecularWeight = (122.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.33942,0.0732403,3.63135e-05,-2.44675e-07,2.33524e-10,50544.5,34.3904], Tmin=(100,'K'), Tmax=(427.398,'K')), NASAPolynomial(coeffs=[5.25281,0.0640301,-2.75778e-05,5.06442e-09,-3.44013e-13,49959.6,15.9078], Tmin=(427.398,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(419.585,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(527.969,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CtCsHH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(RCCJC) + radical(RCCJCC)"""),
)

species(
    label = '[C]#C[CH]CCCCCC(28673)',
    structure = SMILES('[C]#C[CH]CCCCCC'),
    E0 = (514.034,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2761.11,2772.22,2783.33,2794.44,2805.56,2816.67,2827.78,2838.89,2850,1425,1431.25,1437.5,1443.75,1450,1225,1237.5,1250,1262.5,1275,1270,1287.5,1305,1322.5,1340,700,725,750,775,800,300,325,350,375,400,2175,525,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (122.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.631506,0.102633,-9.54721e-05,5.36887e-08,-1.28026e-11,61990.1,36.3532], Tmin=(100,'K'), Tmax=(995.922,'K')), NASAPolynomial(coeffs=[11.7224,0.0530156,-2.07412e-05,3.66434e-09,-2.45387e-13,59529.4,-23.1969], Tmin=(995.922,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(514.034,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(527.969,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CtCsHH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(Sec_Propargyl) + radical(Acetyl)"""),
)

species(
    label = 'C#CCCC[CH]CC[CH2](28674)',
    structure = SMILES('C#CCCC[CH]CC[CH2]'),
    E0 = (430.385,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2761.11,2772.22,2783.33,2794.44,2805.56,2816.67,2827.78,2838.89,2850,1425,1431.25,1437.5,1443.75,1450,1225,1237.5,1250,1262.5,1275,1270,1287.5,1305,1322.5,1340,700,725,750,775,800,300,325,350,375,400,750,770,3400,2100,2175,525,3000,3100,440,815,1455,1000,3025,407.5,1350,352.5,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (122.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.164739,0.0969274,-8.89846e-05,5.33958e-08,-1.44011e-11,51908.6,38.4613], Tmin=(100,'K'), Tmax=(862.375,'K')), NASAPolynomial(coeffs=[7.61418,0.0608465,-2.62268e-05,4.88095e-09,-3.37008e-13,50567,2.08418], Tmin=(862.375,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(430.385,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(527.969,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CtCsHH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(RCCJ) + radical(RCCJCC)"""),
)

species(
    label = 'CCC[CH]CCC1[C]=C1(28675)',
    structure = SMILES('CCC[CH]CCC1[C]=C1'),
    E0 = (544.857,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (122.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.129863,0.0978363,-9.3555e-05,6.08518e-08,-1.81963e-11,65673.6,34.7547], Tmin=(100,'K'), Tmax=(776.265,'K')), NASAPolynomial(coeffs=[6.33632,0.064517,-2.91713e-05,5.55853e-09,-3.88944e-13,64669.7,5.19671], Tmin=(776.265,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(544.857,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(532.126,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cyclopropene) + radical(cyclopropenyl-vinyl) + radical(RCCJCC)"""),
)
...
species(
    ...
    molecularWeight = (122.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.775806,0.09318,-6.5862e-05,2.46748e-08,-3.79586e-12,17904,37.0035], Tmin=(100,'K'), Tmax=(1515.16,'K')), NASAPolynomial(coeffs=[18.2692,0.0429014,-1.60864e-05,2.77359e-09,-1.82177e-13,12132.8,-62.7912], Tmin=(1515.16,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(147.352,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(532.126,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CtCsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Ct-CtCs) + group(Ct-CtH)"""),
)

species(
    label = 'C#CC=CCCCCC(28677)',
    ...
    molecularWeight = (122.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.87494,0.0936466,-6.02402e-05,1.62814e-08,-8.02081e-13,17108.5,35.8539], Tmin=(100,'K'), Tmax=(1219.23,'K')), NASAPolynomial(coeffs=[18.9722,0.0437536,-1.75837e-05,3.19632e-09,-2.18537e-13,11137.5,-68.4709], Tmin=(1219.23,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(140.695,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(532.126,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCtH) + group(Ct-Ct(Cds-Cds)) + group(Ct-CtH)"""),
)

species(
    label = 'C#CCCCC=CCC(28678)',
...
species(
    ...
    collisionModel = TransportData(shapeIndex=2, epsilon=(3506.75,'J/mol'), sigma=(6.43503,'angstroms'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with Tc=547.75 K, Pc=29.86 bar (from Joback method)"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
...
species(
    label = 'C#C[CH]CCC([CH2])CC(28679)',
    structure = SMILES('C#C[CH]CCC([CH2])CC'),
    E0 = (379.626,'kJ/mol'),
    modes = [
...
species(
    ...
    opticalIsomers = 1,
    molecularWeight = (122.207,'amu'),
    collisionModel = TransportData(shapeIndex=2, epsilon=(3672.37,'J/mol'), sigma=(6.78007,'angstroms'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with Tc=573.62 K, Pc=26.74 bar (from Joback method)"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.910936,0.101729,-8.78007e-05,4.34193e-08,-8.86728e-12,45840.5,38.1078], Tmin=(100,'K'), Tmax=(1169.97,'K')), NASAPolynomial(coeffs=[15.367,0.046076,-1.6449e-05,2.76185e-09,-1.79529e-13,42031.6,-42.9791], Tmin=(1169.97,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(379.626,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(527.969,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CtCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(Sec_Propargyl) + radical(Isobutyl)"""),
)

species(
    label = 'C#CC([CH2])C[CH]CCC(28449)',
    structure = SMILES('C#CC([CH2])C[CH]CCC'),
    E0 = (421.096,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,2175,525,1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3000,3100,440,815,1455,1000,750,770,3400,2100,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (122.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.275246,0.0966931,-8.60885e-05,4.8445e-08,-1.19432e-11,50797.8,38.5648], Tmin=(100,'K'), Tmax=(949.794,'K')), NASAPolynomial(coeffs=[9.21734,0.0567167,-2.29558e-05,4.13286e-09,-2.79861e-13,48994.5,-6.74272], Tmin=(949.794,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(421.096,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(527.969,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CtCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(Isobutyl) + radical(RCCJCC)"""),
)

species(
    label = 'C#CC1CCC1CCC(28457)',
...
species(
    label = '[CH]=[C]C1CCC1CCC(28680)',
    structure = SMILES('[CH]=[C]C1CCC1CCC'),
    E0 = (490.679,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (122.207,'amu'),
...
species(
    ...
    molecularWeight = (122.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.263338,0.0870208,-6.25243e-05,2.75956e-08,-5.67501e-12,43806.7,37.3631], Tmin=(100,'K'), Tmax=(1063.25,'K')), NASAPolynomial(coeffs=[7.08369,0.0613625,-2.63267e-05,4.89962e-09,-3.38599e-13,42356.3,4.04052], Tmin=(1063.25,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(363.145,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(527.969,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CtCsHH) + group(Cs-CsHHH) + group(Cs-CtHHH) + group(Ct-CtCs) + group(Ct-CtCs) + radical(Propargyl) + radical(RCCJCC)"""),
)

species(
    label = '[CH]=C=[C]CCCCCC(28682)',
    structure = SMILES('[CH]=C=[C]CCCCCC'),
    E0 = (421.254,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2761.11,2772.22,2783.33,2794.44,2805.56,2816.67,2827.78,2838.89,2850,1425,1431.25,1437.5,1443.75,1450,1225,1237.5,1250,1262.5,1275,1270,1287.5,1305,1322.5,1340,700,725,750,775,800,300,325,350,375,400,540,610,2055,3120,650,792.5,1650,2750,2800,2850,1350,1500,750,1050,1375,1000,1685,370,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (122.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.425051,0.0986183,-8.13154e-05,3.83169e-08,-7.72964e-12,50823.4,36.9021], Tmin=(100,'K'), Tmax=(1147.31,'K')), NASAPolynomial(coeffs=[12.4732,0.0536502,-2.25247e-05,4.15584e-09,-2.86017e-13,47863.7,-27.0973], Tmin=(1147.31,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(421.254,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(532.126,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(Cds_S) + radical(C=C=CJ)"""),
)
...
species(
    label = 'C=C=CC[CH][CH]CCC(28683)',
    structure = SMILES('C=C=CC[CH][CH]CCC'),
    E0 = (417.853,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (122.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0322594,0.094815,-9.98452e-05,8.13002e-08,-3.02297e-11,50391.7,39.2896], Tmin=(100,'K'), Tmax=(760.751,'K')), NASAPolynomial(coeffs=[3.23581,0.0690557,-3.1476e-05,5.98188e-09,-4.16181e-13,50162.3,26.4059], Tmin=(760.751,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(417.853,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(532.126,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(RCCJCC) + radical(RCCJCC)"""),
)

species(
    label = 'C=C=CCC[CH][CH]CC(28684)',
    structure = SMILES('C=C=CCC[CH][CH]CC'),
    E0 = (417.853,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([540,610,2055,3000,3050,390,425,1340,1360,335,370,3010,987.5,1337.5,450,1655,2750,2800,2850,1350,1500,750,1050,1375,1000,2950,3100,1380,975,1025,1650,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'C=C=CCC[CH]C[CH]C(28685)',
    structure = SMILES('C=C=CCC[CH]C[CH]C'),
    E0 = (417.841,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([540,610,2055,3000,3050,390,425,1340,1360,335,370,3010,987.5,1337.5,450,1655,2750,2800,2850,1350,1500,750,1050,1375,1000,2950,3100,1380,975,1025,1650,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (122.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.39991,0.0710311,3.49991e-05,-2.19554e-07,2.04471e-10,50333.6,34.9051], Tmin=(100,'K'), Tmax=(424.364,'K')), NASAPolynomial(coeffs=[4.11044,0.0675263,-3.05325e-05,5.80477e-09,-4.05076e-13,49905,21.8131], Tmin=(424.364,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(417.841,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(532.126,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(RCCJC) + radical(RCCJCC)"""),
)

species(
    label = 'C=C=CCC=CCCC(28686)',
...
species(
    label = 'C=C=CCCC=CCC(28687)',
    structure = SMILES('C=C=CCCC=CCC'),
    E0 = (145.608,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (122.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.656144,0.089348,-5.45015e-05,1.41614e-08,-7.91016e-13,17690.9,37.3531], Tmin=(100,'K'), Tmax=(1289.48,'K')), NASAPolynomial(coeffs=[18.0067,0.0447053,-1.79835e-05,3.24997e-09,-2.20455e-13,11776.3,-61.7006], Tmin=(1289.48,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(145.608,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(536.283,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cdd-CdsCds)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['C#C[CH]CC[CH]CCC(28448)'],
...
reaction(
    label = 'reaction2',
    reactants = ['C#C[CH]CC[CH]CCC(28448)'],
    products = ['[CH]=C1[CH]CCC1CCC(28484)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'C#C[CH]CCC=CCC(28661)'],
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', 'C#C[CH]CC=CCCC(28662)'],
    products = ['C#C[CH]CC[CH]CCC(28448)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(1.46e+08,'cm^3/(mol*s)'), n=1.64, Ea=(5.73208,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""From training reaction 2555 used for Cds-CsH_Cds-CsH;HJ
Exact match found for rate rule [Cds-CsH_Cds-CsH;HJ]
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)', 'C#CC=CC[CH]CCC(28663)'],
    products = ['C#C[CH]CC[CH]CCC(28448)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['C2H5(29)', 'C#C[CH]CCC=C(26866)'],
    products = ['C#C[CH]CC[CH]CCC(28448)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['C#C[CH]CCC[CH]CC(28664)'],
    products = ['C#C[CH]CC[CH]CCC(28448)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['C#CC[CH]C[CH]CCC(28665)'],
    products = ['C#C[CH]CC[CH]CCC(28448)'],
...
reaction(
    label = 'reaction12',
    reactants = ['C#C[CH]CC[CH]CCC(28448)'],
    products = ['C#C[CH]CCCC[CH]C(28666)'],
...
reaction(
    label = 'reaction13',
    reactants = ['C#C[CH]CC[CH]CCC(28448)'],
    products = ['C#C[CH][CH]CCCCC(28667)'],
...
reaction(
    label = 'reaction14',
    reactants = ['C#CCC[CH][CH]CCC(28668)'],
    products = ['C#C[CH]CC[CH]CCC(28448)'],
...
reaction(
    label = 'reaction16',
    reactants = ['C#C[CH]CCCCC[CH2](28670)'],
    products = ['C#C[CH]CC[CH]CCC(28448)'],
...
reaction(
    label = 'reaction17',
    reactants = ['C#CCCC[CH][CH]CC(28671)'],
    products = ['C#C[CH]CC[CH]CCC(28448)'],
...
reaction(
    label = 'reaction18',
    reactants = ['C#CCCC[CH]C[CH]C(28672)'],
    products = ['C#C[CH]CC[CH]CCC(28448)'],
...
reaction(
    label = 'reaction20',
    reactants = ['C#CCCC[CH]CC[CH2](28674)'],
    products = ['C#C[CH]CC[CH]CCC(28448)'],
    transitionState = 'TS20',
    kinetics = Arrhenius(A=(5.18e+08,'s^-1'), n=1.01, Ea=(110.458,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R7Hall;C_rad_out_2H;Cs_H_out_H/OneDe] for rate rule [R7HJ_3;C_rad_out_2H;Cs_H_out_H/Ct]
Euclidian distance = 1.41421356237
Multiplied by reaction path degeneracy 2.0
family: intra_H_migration"""),
)
...
reaction(
    label = 'reaction22',
    reactants = ['C#C[CH]CC[CH]CCC(28448)'],
    products = ['CCC[CH]CCC1[C]=C1(28675)'],
...
reaction(
    label = 'reaction27',
    reactants = ['CH2(S)(23)', 'C#C[CH]CC[CH]CC(26534)'],
    products = ['C#C[CH]CC[CH]CCC(28448)'],
...
reaction(
    label = 'reaction28',
    reactants = ['C#C[CH]CCC([CH2])CC(28679)'],
    products = ['C#C[CH]CC[CH]CCC(28448)'],
...
reaction(
    label = 'reaction30',
    reactants = ['C#CC([CH2])C[CH]CCC(28449)'],
    products = ['C#C[CH]CC[CH]CCC(28448)'],
...
reaction(
    label = 'reaction32',
    reactants = ['[CH]CCC(133)', '[CH]=C=CC[CH2](26618)'],
    products = ['C#C[CH]CC[CH]CCC(28448)'],
...
reaction(
    label = 'reaction33',
    reactants = ['C3H2(81)', '[CH2]C[CH]CCC(203)'],
    products = ['C#C[CH]CC[CH]CCC(28448)'],
...
reaction(
    label = 'reaction34',
    reactants = ['C#C[CH]CC[CH]CCC(28448)'],
    products = ['[CH]=[C]C1CCC1CCC(28680)'],
    transitionState = 'TS34',
    kinetics = Arrhenius(A=(4.73e+06,'s^-1'), n=1.31, Ea=(119.33,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2500,'K'), comment="""Estimated using an average for rate rule [R5_SS_D;doublebond_intra;radadd_intra_csHNd]
Euclidian distance = 0
family: Intra_R_Add_Exocyclic
...
reaction(
    label = 'reaction35',
    reactants = ['C#C[CH]CC[CH]CCC(28448)'],
    products = ['C=C=[C]CC[CH]CCC(28681)'],
...
reaction(
    label = 'reaction37',
    reactants = ['C#C[CH]CC[CH]CCC(28448)'],
    products = ['C=[C]C=CC[CH]CCC(28610)'],
...
reaction(
    label = 'reaction38',
    reactants = ['C=C=CC[CH][CH]CCC(28683)'],
    products = ['C#C[CH]CC[CH]CCC(28448)'],
...
reaction(
    label = 'reaction39',
    reactants = ['C=C=CCC[CH][CH]CC(28684)'],
    products = ['C#C[CH]CC[CH]CCC(28448)'],
...
reaction(
    label = 'reaction40',
    reactants = ['C=C=CCC[CH]C[CH]C(28685)'],
    products = ['C#C[CH]CC[CH]CCC(28448)'],
