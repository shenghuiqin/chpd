...
species(
    label = 'CC=COO[CH]C=O(11445)',
    structure = SMILES('CC=COO[CH]C=O'),
    E0 = (-43.9018,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2782.5,750,1395,475,1775,1000,3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,266.029],'cm^-1')),
        HinderedRotor(inertia=(0.165791,'amu*angstrom^2'), symmetry=1, barrier=(8.33003,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.558195,'amu*angstrom^2'), symmetry=1, barrier=(28.0587,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.32964,'amu*angstrom^2'), symmetry=1, barrier=(16.5497,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.557619,'amu*angstrom^2'), symmetry=1, barrier=(28.0654,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.10284,'amu*angstrom^2'), symmetry=1, barrier=(55.4105,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (115.107,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.747476,0.0723021,-6.32015e-05,2.88876e-08,-5.46307e-12,-5163.85,28.795], Tmin=(100,'K'), Tmax=(1235.49,'K')), NASAPolynomial(coeffs=[12.9997,0.0326342,-1.50406e-05,2.89996e-09,-2.04453e-13,-8191.33,-32.9058], Tmin=(1235.49,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-43.9018,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-(Cds-O2d)OsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-OdCsH) + radical(OCJC=O)"""),
)

species(
    label = 'CC[CH]OOC=C=O(11446)',
    structure = SMILES('CC[CH]OOC=C=O'),
    E0 = (55.5715,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2120,512.5,787.5,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2850,1437.5,1250,1305,750,350,350,500,795,815,180,607.21],'cm^-1')),
        HinderedRotor(inertia=(0.0787859,'amu*angstrom^2'), symmetry=1, barrier=(10.4483,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0399881,'amu*angstrom^2'), symmetry=1, barrier=(10.451,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.84408,'amu*angstrom^2'), symmetry=1, barrier=(65.3909,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.454482,'amu*angstrom^2'), symmetry=1, barrier=(10.4494,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.38289,'amu*angstrom^2'), symmetry=1, barrier=(31.7953,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (115.107,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.585732,0.0794115,-8.57765e-05,5.15265e-08,-1.28617e-11,6803.04,28.821], Tmin=(100,'K'), Tmax=(956.569,'K')), NASAPolynomial(coeffs=[11.1672,0.0351644,-1.6393e-05,3.17111e-09,-2.24087e-13,4778.65,-21.7586], Tmin=(956.569,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(55.5715,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-(Cdd-O2d)OsH) + radical(CCsJOOC)"""),
)
...
species(
    label = 'C[CH]COO[CH]C=O(11447)',
    structure = SMILES('C[CH]COO[CH]C=O'),
    E0 = (25.841,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (116.115,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.588754,0.0820832,-8.91419e-05,5.83916e-08,-1.66383e-11,3224.61,31.4513], Tmin=(100,'K'), Tmax=(827.421,'K')), NASAPolynomial(coeffs=[8.24199,0.0450852,-2.20699e-05,4.3508e-09,-3.10228e-13,1958.12,-4.02132], Tmin=(827.421,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(25.841,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)OsHH) + group(Cds-OdCsH) + radical(CCJCOOH) + radical(OCJC=O)"""),
)

species(
    label = 'CC[CH]OOC[C]=O(11448)',
    structure = SMILES('CC[CH]OOC[C]=O'),
    E0 = (28.0528,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,1855,455,950,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,200,800],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (116.115,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.75135,0.0780691,-7.63736e-05,4.32883e-08,-1.06844e-11,3485.4,29.7772], Tmin=(100,'K'), Tmax=(941.675,'K')), NASAPolynomial(coeffs=[8.91766,0.0433795,-2.11143e-05,4.16573e-09,-2.97608e-13,1947.45,-9.12946], Tmin=(941.675,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(28.0528,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)OsHH) + group(Cds-OdCsH) + radical(CsCJ=O) + radical(CCsJOOC)"""),
)

species(
    label = '[CH2]CCOO[CH]C=O(11449)',
    structure = SMILES('[CH2]CCOO[CH]C=O'),
    E0 = (30.6724,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (116.115,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.667634,0.0800209,-8.10697e-05,4.8128e-08,-1.24191e-11,3803.33,30.6487], Tmin=(100,'K'), Tmax=(905.873,'K')), NASAPolynomial(coeffs=[8.82824,0.0439871,-2.14035e-05,4.21776e-09,-3.01022e-13,2324.82,-7.91486], Tmin=(905.873,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(30.6724,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)OsHH) + group(Cds-OdCsH) + radical(OCJC=O) + radical(RCCJ)"""),
)

species(
    label = 'C[CH][CH]OOCC=O(11450)',
    structure = SMILES('C[CH][CH]OOCC=O'),
    E0 = (73.7968,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2782.5,750,1395,475,1775,1000,3000,3050,390,425,1340,1360,335,370,2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2850,1437.5,1250,1305,750,350,200,800],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (116.115,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.658401,0.0804825,-8.51787e-05,5.39001e-08,-1.48572e-11,8990,31.74], Tmin=(100,'K'), Tmax=(852.22,'K')), NASAPolynomial(coeffs=[8.33506,0.044453,-2.17661e-05,4.29689e-09,-3.06793e-13,7681.49,-4.06829], Tmin=(852.22,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(73.7968,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)OsHH) + group(Cds-OdCsH) + radical(CCJCOOH) + radical(CCsJOOC)"""),
)

species(
    label = 'CCCOO[CH][C]=O(11451)',
    structure = SMILES('CCCOO[CH][C]=O'),
    E0 = (-19.9031,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (116.115,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.690924,0.0795339,-7.9736e-05,4.68234e-08,-1.19783e-11,-2280.34,29.4573], Tmin=(100,'K'), Tmax=(911.844,'K')), NASAPolynomial(coeffs=[8.76352,0.0441226,-2.14851e-05,4.23599e-09,-3.02433e-13,-3752.56,-8.74349], Tmin=(911.844,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-19.9031,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)OsHH) + group(Cds-OdCsH) + radical(OCJC=O) + radical(CsCJ=O)"""),
)

species(
    label = '[CH2]C[CH]OOCC=O(11452)',
    structure = SMILES('[CH2]C[CH]OOCC=O'),
    E0 = (78.6282,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2782.5,750,1395,475,1775,1000,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,200,800],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (116.115,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.728187,0.0785524,-7.76845e-05,4.4551e-08,-1.11025e-11,9569.07,30.9683], Tmin=(100,'K'), Tmax=(934.692,'K')), NASAPolynomial(coeffs=[8.97615,0.0432553,-2.10396e-05,4.14917e-09,-2.9634e-13,8027.21,-8.26627], Tmin=(934.692,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(78.6282,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)OsHH) + group(Cds-OdCsH) + radical(CCsJOOC) + radical(RCCJ)"""),
)
...
species(
    label = 'CC[CH]OOC1[CH]O1(11453)',
    structure = SMILES('CC[CH]OOC1[CH]O1'),
    E0 = (113.026,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (116.115,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0556973,0.0843043,-8.1484e-05,4.07239e-08,-7.50441e-12,13744.3,30.1643], Tmin=(100,'K'), Tmax=(955.104,'K')), NASAPolynomial(coeffs=[15.5125,0.02896,-1.00434e-05,1.66199e-09,-1.07802e-13,10320.9,-46.5812], Tmin=(955.104,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(113.026,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CCsJO) + radical(CCsJOOC)"""),
)
...
species(
    label = 'CC=COOCC=O(11454)',
    structure = SMILES('CC=COOCC=O'),
    E0 = (-182.387,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (116.115,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.486871,0.0726126,-5.79536e-05,2.33636e-08,-3.82078e-12,-21806,29.9755], Tmin=(100,'K'), Tmax=(1432.27,'K')), NASAPolynomial(coeffs=[15.8539,0.0296961,-1.30077e-05,2.44309e-09,-1.69143e-13,-26208,-49.6824], Tmin=(1432.27,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-182.387,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-(Cds-O2d)OsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-OdCsH)"""),
)

species(
    label = 'CCCOOC=C=O(11455)',
    structure = SMILES('CCCOOC=C=O'),
    E0 = (-130.869,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (116.115,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.541337,0.0781242,-7.41141e-05,3.81172e-08,-8.13974e-12,-15617.1,28.6763], Tmin=(100,'K'), Tmax=(1106.14,'K')), NASAPolynomial(coeffs=[12.4063,0.0352192,-1.5933e-05,3.05218e-09,-2.14796e-13,-18242,-29.7622], Tmin=(1106.14,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-130.869,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-(Cdd-O2d)OsH)"""),
)
...
species(
    label = '[CH2]C(C)OO[CH]C=O(11456)',
    structure = SMILES('[CH2]C(C)OO[CH]C=O'),
    E0 = (26.7456,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,1380,1390,370,380,2900,435,350,500,795,815,2782.5,750,1395,475,1775,1000,200],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (116.115,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.526382,0.0804574,-7.58984e-05,3.87577e-08,-8.3122e-12,3338.46,31.005], Tmin=(100,'K'), Tmax=(1091.57,'K')), NASAPolynomial(coeffs=[11.9673,0.0385332,-1.82881e-05,3.57298e-09,-2.53988e-13,840.734,-25.1932], Tmin=(1091.57,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(26.7456,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)OsHH) + group(Cds-OdCsH) + radical(CJCOOH) + radical(OCJC=O)"""),
)
...
species(
    label = 'CCC1OOC1[CH][O](11457)',
    structure = SMILES('CCC1OOC1[CH][O]'),
    E0 = (133.838,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (116.115,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.597788,0.0816881,-0.000105157,8.9087e-08,-3.21317e-11,16212.9,25.7566], Tmin=(100,'K'), Tmax=(764.066,'K')), NASAPolynomial(coeffs=[5.87095,0.0467853,-2.2311e-05,4.30283e-09,-3.00932e-13,15620.1,3.12952], Tmin=(764.066,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(133.838,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(369.994,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(12dioxetane) + radical(CCOJ) + radical(CCsJOH)"""),
)

species(
    label = 'CC[CH]OOC=[C]O(11458)',
    structure = SMILES('CC[CH]OOC=[C]O'),
    E0 = (113.84,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,1685,370,2750,2850,1437.5,1250,1305,750,350,350,500,795,815,200,800],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (116.115,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.278818,0.0890499,-9.29431e-05,4.94824e-08,-1.03855e-11,13850.2,34.2338], Tmin=(100,'K'), Tmax=(1162.19,'K')), NASAPolynomial(coeffs=[18.4477,0.0245976,-9.75677e-06,1.76436e-09,-1.20857e-13,9497.4,-58.9256], Tmin=(1162.19,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(113.84,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + radical(CCsJOOC) + radical(C=CJO)"""),
)

species(
    label = 'CC[CH]OO[C]=CO(11459)',
    structure = SMILES('CC[CH]OO[C]=CO'),
    E0 = (113.84,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,1685,370,2750,2850,1437.5,1250,1305,750,350,350,500,795,815,200,800],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (116.115,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.278819,0.0890499,-9.29431e-05,4.94824e-08,-1.03855e-11,13850.2,34.2338], Tmin=(100,'K'), Tmax=(1162.19,'K')), NASAPolynomial(coeffs=[18.4477,0.0245976,-9.75678e-06,1.76436e-09,-1.20857e-13,9497.4,-58.9256], Tmin=(1162.19,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(113.84,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + radical(C=CJO) + radical(CCsJOOC)"""),
)

species(
    label = 'CCCOO[C]=C[O](11460)',
    structure = SMILES('CCCOO[C]=C[O]'),
    E0 = (68.8618,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,3010,987.5,1337.5,450,1655,1685,370,2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (116.115,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.202569,0.0793006,-7.19866e-05,3.372e-08,-6.36168e-12,8422.33,33.6218], Tmin=(100,'K'), Tmax=(1267.05,'K')), NASAPolynomial(coeffs=[16.1911,0.0288253,-1.22309e-05,2.27886e-09,-1.58019e-13,4370.71,-47.2979], Tmin=(1267.05,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(68.8618,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + radical(C=COJ) + radical(C=CJO)"""),
)

species(
    label = 'C[CH][CH]OOC=CO(11461)',
    structure = SMILES('C[CH][CH]OOC=CO'),
    E0 = (74.5107,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2995,3025,975,1000,1300,1375,400,500,1630,1680,3000,3050,390,425,1340,1360,335,370,3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (116.115,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.857725,0.0939155,-9.78093e-05,5.00983e-08,-9.89017e-12,9147.44,35.4908], Tmin=(100,'K'), Tmax=(1262.13,'K')), NASAPolynomial(coeffs=[23.235,0.0168798,-5.44696e-06,8.85025e-10,-5.75592e-14,3119.97,-86.1369], Tmin=(1262.13,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(74.5107,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + radical(CCsJOOC) + radical(CCJCOOH)"""),
)

species(
    label = '[CH2]C[CH]OOC=CO(11462)',
    structure = SMILES('[CH2]C[CH]OOC=CO'),
    E0 = (79.3421,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2995,3025,975,1000,1300,1375,400,500,1630,1680,3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,350,500,795,815,3000,3100,440,815,1455,1000,200,800],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (116.115,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.958735,0.0939193,-9.67335e-05,4.86758e-08,-9.39005e-12,9734.05,35.3374], Tmin=(100,'K'), Tmax=(1338.87,'K')), NASAPolynomial(coeffs=[24.0838,0.0153775,-4.56602e-06,7.04696e-10,-4.46484e-14,3362.18,-91.5396], Tmin=(1338.87,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(79.3421,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + radical(CCsJOOC) + radical(RCCJ)"""),
)

species(
    label = 'CC=COOC=CO(11463)',
    structure = SMILES('CC=COOC=CO'),
    E0 = (-181.673,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (116.115,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.267682,0.0768581,-3.77849e-05,-2.33443e-08,1.94063e-11,-21680.9,31.0116], Tmin=(100,'K'), Tmax=(935.379,'K')), NASAPolynomial(coeffs=[24.9975,0.0117291,-2.15965e-06,3.12487e-10,-2.55215e-14,-28284.7,-99.2255], Tmin=(935.379,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-181.673,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-O2s(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + group(Cds-CdsOsH)"""),
)
...
species(
    label = '[CH]=COO[CH]CC(11025)',
    structure = SMILES('[CH]=COO[CH]CC'),
    E0 = (329.985,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2850,1437.5,1250,1305,750,350,350,500,795,815,964.802],'cm^-1')),
        HinderedRotor(inertia=(0.984018,'amu*angstrom^2'), symmetry=1, barrier=(22.6245,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.535671,'amu*angstrom^2'), symmetry=1, barrier=(12.3161,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.334887,'amu*angstrom^2'), symmetry=1, barrier=(7.69972,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.983948,'amu*angstrom^2'), symmetry=1, barrier=(22.6229,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.6712,'amu*angstrom^2'), symmetry=1, barrier=(61.4161,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.793626,0.0712625,-6.47897e-05,3.15428e-08,-6.35782e-12,39802.8,27.8021], Tmin=(100,'K'), Tmax=(1168.49,'K')), NASAPolynomial(coeffs=[12.2903,0.0319064,-1.42674e-05,2.71762e-09,-1.9058e-13,37116,-29.4529], Tmin=(1168.49,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(329.985,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(Cds_P) + radical(CCsJOOC)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'CC=COO[CH]C=O(11445)'],
    products = ['CC[CH]OO[CH]C=O(11387)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', 'CC[CH]OOC=C=O(11446)'],
    products = ['CC[CH]OO[CH]C=O(11387)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CH3(17)', 'C=COO[CH]C=O(4460)'],
    products = ['CC[CH]OO[CH]C=O(11387)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['CC[CH]OO[CH]C=O(11387)'],
    products = ['C[CH]COO[CH]C=O(11447)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['CC[CH]OO[CH]C=O(11387)'],
    products = ['[CH2]CCOO[CH]C=O(11449)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['C[CH][CH]OOCC=O(11450)'],
    products = ['CC[CH]OO[CH]C=O(11387)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]C[CH]OOCC=O(11452)'],
    products = ['CC[CH]OO[CH]C=O(11387)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CC[CH]OO[CH]C=O(11387)'],
    products = ['CC[CH]OOC1[CH]O1(11453)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CH2(S)(23)', 'C[CH]OO[CH]C=O(1192)'],
    products = ['CC[CH]OO[CH]C=O(11387)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2]C(C)OO[CH]C=O(11456)'],
    products = ['CC[CH]OO[CH]C=O(11387)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH]CC(144)', '[O]O[CH]C=O(3604)'],
    products = ['CC[CH]OO[CH]C=O(11387)'],
...
reaction(
    label = 'reaction21',
    reactants = ['CC[CH]O[O](238)', 'CHCHO(47)'],
    products = ['CC[CH]OO[CH]C=O(11387)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(45607,'m^3/(mol*s)'), n=0.695, Ea=(235.049,'kJ/mol'), T0=(1,'K'), comment="""Estimated using average of templates [R_R;O_rad/OneDe] + [Od_CO-CsH;YJ] for rate rule [Od_CO-CsH;O_rad/OneDe]
...
reaction(
    label = 'reaction27',
    reactants = ['C[CH][CH]OOC=CO(11461)'],
    products = ['CC[CH]OO[CH]C=O(11387)'],
...
reaction(
    label = 'reaction28',
    reactants = ['[CH2]C[CH]OOC=CO(11462)'],
    products = ['CC[CH]OO[CH]C=O(11387)'],
...
reaction(
    label = 'reaction30',
    reactants = ['CC[CH]OO[CH]C=O(11387)'],
    products = ['CC[CH][O](563)', 'C1=COO1(3609)'],
    transitionState = 'TS30',
    kinetics = Arrhenius(A=(3.11355e+11,'s^-1'), n=0, Ea=(266.21,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R3OO;Y_rad_intra;OO_intra] for rate rule [R3OO_SD;Y_rad_intra;OO_intra]
Euclidian distance = 1.0
...
reaction(
    label = 'reaction33',
    reactants = ['O(4)', '[CH]=COO[CH]CC(11025)'],
    products = ['CC[CH]OO[CH]C=O(11387)'],
