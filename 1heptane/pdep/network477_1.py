...
species(
    ...
    E0 = (26.1241,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,180,1585.5,1585.99],'cm^-1')),
        HinderedRotor(inertia=(0.178484,'amu*angstrom^2'), symmetry=1, barrier=(4.10369,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (60.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.85382,0.0354446,-7.02827e-05,8.23566e-08,-3.43447e-11,3173.35,13.6116], Tmin=(100,'K'), Tmax=(849.198,'K')), NASAPolynomial(coeffs=[-1.87194,0.0312395,-1.61081e-05,3.12771e-09,-2.16045e-13,4930.21,41.2566], Tmin=(849.198,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(26.1241,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-OsOsHH) + group(Cs-OsHHH) + radical(OCJO) + radical(OCOJ)"""),
)

species(
    label = 'methyl_formate(720)',
    ...
    molecularWeight = (60.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.28123,0.0113181,1.84478e-05,-2.41945e-08,7.75136e-12,-44672.6,12.0364], Tmin=(100,'K'), Tmax=(1141.77,'K')), NASAPolynomial(coeffs=[4.90989,0.018753,-8.58329e-06,1.66847e-09,-1.18612e-13,-45901,0.212202], Tmin=(1141.77,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-371.674,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), label="""methyl_formate""", comment="""Thermo library: DFT_QCI_thermo"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'CH2OCHO(1808)'],
    products = ['[CH2]OC[O](933)'],
    transitionState = 'TS2',
