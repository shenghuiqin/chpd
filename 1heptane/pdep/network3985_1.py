...
species(
    label = 'CC[C]1OCC1(O)C1CCC([O])O1(22733)',
    structure = SMILES('CC[C]1OCC1(O)C1CCC([O])O1'),
    E0 = (-302.821,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (186.205,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.61024,0.126478,-0.000107508,5.18896e-08,-1.00265e-11,-36166.9,45.2824], Tmin=(100,'K'), Tmax=(1371.38,'K')), NASAPolynomial(coeffs=[20.9593,0.0493472,-1.39733e-05,1.96176e-09,-1.12053e-13,-41843.1,-72.9961], Tmin=(1371.38,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-302.821,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(640.214,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Tetrahydrofuran) + ring(Oxetane) + radical(CCOJ) + radical(C2CsJOCs)"""),
)
...
species(
    label = 'CC[C]1OCC1(O)C(=O)CCC=O(22734)',
    structure = SMILES('CC[C]1OCC1(O)C(=O)CCC=O'),
    E0 = (-449.275,'kJ/mol'),
    modes = [
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.70828,0.15581,-0.000210844,1.63934e-07,-5.08206e-11,-53801.6,46.9156], Tmin=(100,'K'), Tmax=(888.051,'K')), NASAPolynomial(coeffs=[14.7732,0.0613607,-2.47778e-05,4.33398e-09,-2.83515e-13,-56287.1,-31.8594], Tmin=(888.051,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-449.275,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(602.799,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-(Cds-O2d)CsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdCsCs) + group(Cds-OdCsH) + ring(Oxetane) + radical(C2CsJOCs)"""),
)

species(
    label = 'CC=C1OCC1(O)C([O])CCC=O(22735)',
    structure = SMILES('CC=C1OCC1(O)C([O])CCC=O'),
    E0 = (-409.14,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,3150,900,1100,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,1380,1390,370,380,2900,435,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2782.5,750,1395,475,1775,1000,300,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (185.197,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-3.37434,0.141895,-0.000137217,6.82568e-08,-1.32541e-11,-48925.4,48.6145], Tmin=(100,'K'), Tmax=(1304.26,'K')), NASAPolynomial(coeffs=[30.1408,0.0356352,-1.10154e-05,1.70736e-09,-1.06503e-13,-57372.5,-120.847], Tmin=(1304.26,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-409.14,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(606.956,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + group(Cds-OdCsH) + ring(2methyleneoxetane) + radical(CC(C)OJ)"""),
)
...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.039705,0.0877932,-8.11552e-05,3.24895e-08,-6.84175e-13,-31413.5,30.1545], Tmin=(100,'K'), Tmax=(789.632,'K')), NASAPolynomial(coeffs=[14.5213,0.0321809,-9.98829e-06,1.51156e-09,-9.16676e-14,-34278.9,-40.2373], Tmin=(789.632,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-262.408,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(415.724,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-(Cds-O2d)CsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + ring(Oxetane) + radical(C2CsJOCs)"""),
)
...
species(
    label = 'C=C1OCC1(O)C([O])CCC=O(22736)',
    structure = SMILES('C=C1OCC1(O)C([O])CCC=O'),
    E0 = (-373.114,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,3150,900,1100,3615,1277.5,1000,2950,3100,1380,975,1025,1650,1380,1390,370,380,2900,435,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2782.5,750,1395,475,1775,1000,300,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.97104,0.129138,-0.00012633,6.22091e-08,-1.17457e-11,-44603.7,44.6712], Tmin=(100,'K'), Tmax=(1423.78,'K')), NASAPolynomial(coeffs=[29.8582,0.0262066,-6.61496e-06,8.75426e-10,-4.93825e-14,-52867.4,-121.501], Tmin=(1423.78,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-373.114,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(536.283,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsOs) + group(Cds-OdCsH) + group(Cds-CdsHH) + ring(2methyleneoxetane) + radical(CC(C)OJ)"""),
)
...
species(
    label = 'CCC1OCC=1C([O])CCC=O(22737)',
    structure = SMILES('CCC1OCC=1C([O])CCC=O'),
    E0 = (-194.124,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2800,2850,1350,1500,750,1050,1375,1000,2782.5,750,1395,475,1775,1000,1380,1390,370,380,2900,435,2750,3150,900,1100,300,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.01595,0.114334,-7.42509e-05,1.18618e-08,4.01059e-12,-23115.7,45.8255], Tmin=(100,'K'), Tmax=(1071.93,'K')), NASAPolynomial(coeffs=[25.405,0.042812,-1.72681e-05,3.22901e-09,-2.27995e-13,-30764,-96.6237], Tmin=(1071.93,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-194.124,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(582.013,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsOs) + group(Cds-OdCsH) + ring(Cyclobutene) + radical(CC(C)OJ)"""),
)

species(
    label = 'CC[C]1OCC1(O)[C](O)CCC=O(22738)',
    structure = SMILES('CC[C]1OCC1(O)[C](O)CCC=O'),
    E0 = (-340.036,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (186.205,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-3.12621,0.164647,-0.000223947,1.72206e-07,-5.25392e-11,-40647.8,50.0597], Tmin=(100,'K'), Tmax=(897.623,'K')), NASAPolynomial(coeffs=[16.6037,0.0609042,-2.41437e-05,4.17463e-09,-2.70885e-13,-43552.4,-39.4443], Tmin=(897.623,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-340.036,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(623.585,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + ring(Oxetane) + radical(C2CsJOH) + radical(C2CsJOCs)"""),
)
...
species(
    ...
    E0 = (-267.105,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2950,3150,900,1000,1100,2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1277.5,1000,1380,1390,370,380,2900,435,3025,407.5,1350,352.5,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2782.5,750,1395,475,1775,1000,300,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    ...
    E0 = (-286.551,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,3150,900,1100,2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1277.5,1000,1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2782.5,750,1395,475,1775,1000,300,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    ...
    opticalIsomers = 1,
    molecularWeight = (186.205,'amu'),
    collisionModel = TransportData(shapeIndex=2, epsilon=(5464.31,'J/mol'), sigma=(9.08199,'angstroms'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with Tc=853.51 K, Pc=16.55 bar (from Joback method)"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
...
species(
    label = 'CC[C]1OCC1(O)C(O)[CH]CC=O(22739)',
    structure = SMILES('CC[C]1OCC1(O)C(O)[CH]CC=O'),
    E0 = (-316.762,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (186.205,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.74145,0.150231,-0.000176408,1.17711e-07,-3.17186e-11,-37856.8,51.7535], Tmin=(100,'K'), Tmax=(905.465,'K')), NASAPolynomial(coeffs=[18.4202,0.0567505,-2.1555e-05,3.70183e-09,-2.4204e-13,-41689.2,-48.2388], Tmin=(905.465,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-316.762,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(623.585,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + ring(Oxetane) + radical(CCJCO) + radical(C2CsJOCs)"""),
)
...
species(
    label = 'CC[C]1O[CH]C1(O)C(O)CCC=O(22740)',
    structure = SMILES('CC[C]1O[CH]C1(O)C(O)CCC=O'),
    E0 = (-336.208,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (186.205,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-3.31326,0.163409,-0.000207745,1.45811e-07,-4.06616e-11,-40175.6,50.7515], Tmin=(100,'K'), Tmax=(914.387,'K')), NASAPolynomial(coeffs=[20.7985,0.0533764,-1.97696e-05,3.31234e-09,-2.11851e-13,-44394.7,-62.3741], Tmin=(914.387,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-336.208,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(623.585,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + ring(Oxetane) + radical(C2CsJOCs) + radical(CCsJOCs)"""),
)
...
species(
    label = 'CC[C]1OCC1(O)C(O)C[CH]C=O(22741)',
    structure = SMILES('CC[C]1OCC1(O)C(O)CC=C[O]'),
    E0 = (-373.412,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (186.205,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-3.06239,0.145667,-0.000135533,5.58589e-08,-4.81083e-12,-44647.8,50.1194], Tmin=(100,'K'), Tmax=(898.546,'K')), NASAPolynomial(coeffs=[26.8126,0.0425274,-1.31919e-05,2.064e-09,-1.3108e-13,-51221.7,-97.5203], Tmin=(898.546,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-373.412,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(627.743,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + ring(Oxetane) + radical(C=COJ) + radical(C2CsJOCs)"""),
)

species(
    label = 'C[CH][C]1OCC1(O)C(O)CCC=O(22742)',
    structure = SMILES('C[CH][C]1OCC1(O)C(O)CCC=O'),
    E0 = (-316.762,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (186.205,'amu'),
...
species(
    label = 'CC[C]1OCC1(O)C(O)CC[C]=O(22743)',
    structure = SMILES('CC[C]1OCC1(O)C(O)CC[C]=O'),
    E0 = (-356.703,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (186.205,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.52526,0.151687,-0.000170706,9.22145e-08,-1.20813e-11,-42673.7,49.3595], Tmin=(100,'K'), Tmax=(688.207,'K')), NASAPolynomial(coeffs=[18.3602,0.0567838,-2.15909e-05,3.6923e-09,-2.40183e-13,-46175.7,-48.154], Tmin=(688.207,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-356.703,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(623.585,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + ring(Oxetane) + radical(CCCJ=O) + radical(C2CsJOCs)"""),
)
...
species(
    label = '[CH2]C[C]1OCC1(O)C(O)CCC=O(22744)',
    structure = SMILES('[CH2]C[C]1OCC1(O)C(O)CCC=O'),
    E0 = (-311.418,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (186.205,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.41949,0.149567,-0.000166908,9.21016e-08,-1.3665e-11,-37231.1,49.9446], Tmin=(100,'K'), Tmax=(687.394,'K')), NASAPolynomial(coeffs=[17.1984,0.0595978,-2.33639e-05,4.07701e-09,-2.69012e-13,-40499.6,-41.5034], Tmin=(687.394,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-311.418,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(623.585,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + ring(Oxetane) + radical(RCCJ) + radical(C2CsJOCs)"""),
)

species(
    label = 'CC[C]1OCC1(O)C1CC[CH]OO1(22745)',
    structure = SMILES('CC[C]1OCC1(O)C1CC[CH]OO1'),
    E0 = (-99.7478,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (186.205,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-3.72389,0.138542,-0.000124448,6.01684e-08,-1.11838e-11,-11692,47.3445], Tmin=(100,'K'), Tmax=(1520.46,'K')), NASAPolynomial(coeffs=[25.9552,0.0408008,-8.62427e-06,8.78688e-10,-3.67343e-14,-18444.4,-100.802], Tmin=(1520.46,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-99.7478,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(640.214,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Oxetane) + ring(12dioxane) + radical(CCsJOOC) + radical(C2CsJOCs)"""),
)
...
species(
    label = '[CH2]OC(CC)=C(O)C([O])CCC=O(22746)',
    ...
    molecularWeight = (186.205,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-3.36351,0.149217,-0.000146166,7.23292e-08,-1.41031e-11,-43794.8,55.0614], Tmin=(100,'K'), Tmax=(1247.31,'K')), NASAPolynomial(coeffs=[30.2774,0.0413362,-1.64327e-05,2.99012e-09,-2.05638e-13,-52187.1,-114.672], Tmin=(1247.31,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-366.424,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(619.428,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsOs) + group(Cds-OdCsH) + radical(C=COCJ) + radical(CC(C)OJ)"""),
)
...
species(
    label = 'CC=C1OCC1(O)C(O)CCC=O(22747)',
    structure = SMILES('CC=C1OCC1(O)C(O)CCC=O'),
    E0 = (-639.5,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (186.205,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-3.48714,0.14533,-0.000141304,7.11148e-08,-1.40045e-11,-76628.2,49.2092], Tmin=(100,'K'), Tmax=(1273.41,'K')), NASAPolynomial(coeffs=[29.9986,0.0377603,-1.17845e-05,1.83671e-09,-1.14871e-13,-84963,-119.675], Tmin=(1273.41,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-639.5,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(627.743,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + group(Cds-OdCsH) + ring(2methyleneoxetane)"""),
)
...
species(
    label = 'C[C]1OCC1(O)C([O])CCC=O(22748)',
    structure = SMILES('C[C]1OCC1(O)C([O])CCC=O'),
    E0 = (-262.523,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,3150,900,1100,2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1277.5,1000,1380,1390,370,380,2900,435,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2782.5,750,1395,475,1775,1000,300,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.78471,0.132135,-0.000146673,8.50084e-08,-1.66125e-11,-31370.1,43.4159], Tmin=(100,'K'), Tmax=(735.597,'K')), NASAPolynomial(coeffs=[16.2946,0.0518788,-1.98345e-05,3.42247e-09,-2.24782e-13,-34518.4,-41.575], Tmin=(735.597,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-262.523,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(557.07,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + ring(Oxetane) + radical(C2CsJOCs) + radical(CC(C)OJ)"""),
)
...
species(
    label = 'CCC1(CO1)[C](O)C([O])CCC=O(22749)',
    structure = SMILES('CCC1(CO1)[C](O)C([O])CCC=O'),
    E0 = (-284.847,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,3150,900,1100,2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1277.5,1000,360,370,350,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2782.5,750,1395,475,1775,1000,1380,1390,370,380,2900,435,300,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (186.205,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.96122,0.158819,-0.000186998,1.15851e-07,-2.60323e-11,-34013.5,48.9916], Tmin=(100,'K'), Tmax=(748.75,'K')), NASAPolynomial(coeffs=[19.7501,0.0570009,-2.21092e-05,3.84041e-09,-2.53026e-13,-37961.4,-57.6581], Tmin=(748.75,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-284.847,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(623.585,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + ring(Ethylene_oxide) + radical(CC(C)OJ) + radical(C2CsJOH)"""),
)

species(
    label = '[CH2]C1(C)OCC1(O)C([O])CCC=O(22750)',
    structure = SMILES('[CH2]C1(C)OCC1(O)C([O])CCC=O'),
    E0 = (-274.48,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (186.205,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-3.42509,0.160051,-0.000185441,1.1606e-07,-2.87548e-11,-32742.2,48.3937], Tmin=(100,'K'), Tmax=(990.724,'K')), NASAPolynomial(coeffs=[24.108,0.048891,-1.7145e-05,2.81585e-09,-1.79586e-13,-38197.9,-84.1818], Tmin=(990.724,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-274.48,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(627.743,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + ring(Oxetane) + radical(CJC(C)OC) + radical(CC(C)OJ)"""),
)
...
species(
    label = 'CC[C]1OC[C]1C(CCC=O)OO(22751)',
    structure = SMILES('CC[C]1OC[C]1C(CCC=O)OO'),
    E0 = (-72.8356,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,3150,900,1100,2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1310,387.5,850,1000,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2782.5,750,1395,475,1775,1000,1380,1390,370,380,2900,435,300,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (186.205,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.74592,0.13069,-0.000128735,7.70567e-08,-1.96725e-11,-8556.92,51.5901], Tmin=(100,'K'), Tmax=(930.049,'K')), NASAPolynomial(coeffs=[12.7068,0.0685288,-2.84778e-05,5.18948e-09,-3.53777e-13,-11245.2,-17.0877], Tmin=(930.049,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-72.8356,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(623.585,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + ring(Oxetane) + radical(C2CsJOCs) + radical(C2CJCOOH)"""),
)

species(
    label = 'C=COCC([O])C1(O)CO[C]1CC(22752)',
    structure = SMILES('C=COCC([O])C1(O)CO[C]1CC'),
    E0 = (-244.707,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,3150,900,1100,2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1277.5,1000,2950,3100,1380,975,1025,1650,3010,987.5,1337.5,450,1655,1380,1390,370,380,2900,435,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,300,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (186.205,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-4.1185,0.15915,-0.000168364,9.16085e-08,-1.92282e-11,-29122.5,51.0436], Tmin=(100,'K'), Tmax=(1258.91,'K')), NASAPolynomial(coeffs=[31.8687,0.0351592,-9.13381e-06,1.19986e-09,-6.57099e-14,-37419,-127.823], Tmin=(1258.91,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-244.707,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(627.743,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + ring(Oxetane) + radical(CC(C)OJ) + radical(C2CsJOCs)"""),
)

species(
    label = 'CC[C]1OCC1(O)C([O])CC=CO(22753)',
    structure = SMILES('CC[C]1OCC1(O)C([O])CC=CO'),
    E0 = (-284.514,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3580,3650,1210,1345,900,1100,2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,2750,3150,900,1100,1380,1390,370,380,2900,435,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,300,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (186.205,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-4.13645,0.158552,-0.000168533,9.19336e-08,-1.92562e-11,-33908.7,52.3593], Tmin=(100,'K'), Tmax=(1281.1,'K')), NASAPolynomial(coeffs=[31.9218,0.0337273,-8.04844e-06,9.61828e-10,-4.81748e-14,-42143.2,-126.613], Tmin=(1281.1,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-284.514,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(627.743,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + ring(Oxetane) + radical(C2CsJOCs) + radical(CC(C)OJ)"""),
)
...
species(
    label = 'CC[C]1OCC1(O)[CH]CCC=O(22754)',
    structure = SMILES('CC[C]1OCC1(O)[CH]CCC=O'),
    E0 = (-144.291,'kJ/mol'),
    modes = [
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.9894,0.132373,-0.000140895,8.75233e-08,-2.23135e-11,-17139.2,46.6963], Tmin=(100,'K'), Tmax=(949.211,'K')), NASAPolynomial(coeffs=[15.934,0.0568522,-2.15662e-05,3.72368e-09,-2.45203e-13,-20542.2,-38.8415], Tmin=(949.211,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-144.291,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(602.799,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + ring(Oxetane) + radical(CCJCO) + radical(C2CsJOCs)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CC[C]1OCC1(O)C([O])CCC=O(19026)'],
    products = ['CC[C]1OCC1(O)C1CCC([O])O1(22733)'],
    transitionState = 'TS2',
...
reaction(
    ...
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(2020,'s^-1'), n=1.67, Ea=(27.6914,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R7_SSSS;multiplebond_intra;radadd_intra_csNdNd] for rate rule [R7_SSSS_CO;carbonylbond_intra_H;radadd_intra_csNdNd]
Euclidian distance = 2.2360679775
family: Intra_R_Add_Exocyclic
Ea raised from 23.9 to 27.7 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction4',
    reactants = ['H(3)', 'CC[C]1OCC1(O)C(=O)CCC=O(22734)'],
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)', 'CC=C1OCC1(O)C([O])CCC=O(22735)'],
    products = ['CC[C]1OCC1(O)C([O])CCC=O(19026)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['CH2CH2CHO(560)', 'CC[C]1OCC1(O)C=O(5523)'],
    products = ['CC[C]1OCC1(O)C([O])CCC=O(19026)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['CH3(17)', 'C=C1OCC1(O)C([O])CCC=O(22736)'],
    products = ['CC[C]1OCC1(O)C([O])CCC=O(19026)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['OH(5)', 'CCC1OCC=1C([O])CCC=O(22737)'],
    products = ['CC[C]1OCC1(O)C([O])CCC=O(19026)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CC[C]1OCC1(O)C([O])CCC=O(19026)'],
    products = ['CC[C]1OCC1(O)[C](O)CCC=O(22738)'],
...
reaction(
    label = 'reaction12',
    reactants = ['C[CH]C1OCC1(O)C([O])CCC=O(20489)'],
    products = ['CC[C]1OCC1(O)C([O])CCC=O(19026)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CCC1O[CH]C1(O)C([O])CCC=O(20485)'],
    products = ['CC[C]1OCC1(O)C([O])CCC=O(19026)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CC[C]1OCC1(O)C(O)[CH]CC=O(22739)'],
    products = ['CC[C]1OCC1(O)C([O])CCC=O(19026)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]CC1OCC1(O)C([O])CCC=O(20493)'],
    products = ['CC[C]1OCC1(O)C([O])CCC=O(19026)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CC[C]1OCC1(O)C([O])CCC=O(19026)'],
    products = ['CC[C]1O[CH]C1(O)C(O)CCC=O(22740)'],
...
reaction(
    label = 'reaction20',
    reactants = ['CCC1OCC1(O)C([O])[CH]CC=O(20490)'],
    products = ['CC[C]1OCC1(O)C([O])CCC=O(19026)'],
...
reaction(
    label = 'reaction21',
    reactants = ['CC[C]1OCC1(O)C([O])CCC=O(19026)'],
    products = ['CC[C]1OCC1(O)C(O)C[CH]C=O(22741)'],
...
reaction(
    label = 'reaction22',
    reactants = ['CC[C]1OCC1(O)C([O])CCC=O(19026)'],
    products = ['C[CH][C]1OCC1(O)C(O)CCC=O(22742)'],
...
reaction(
    label = 'reaction24',
    reactants = ['CC[C]1OCC1(O)C([O])CCC=O(19026)'],
    products = ['CC[C]1OCC1(O)C(O)CC[C]=O(22743)'],
...
reaction(
    label = 'reaction26',
    reactants = ['CC[C]1OCC1(O)C([O])CCC=O(19026)'],
    products = ['[CH2]C[C]1OCC1(O)C(O)CCC=O(22744)'],
...
reaction(
    label = 'reaction28',
    reactants = ['CC[C]1OCC1(O)C([O])CCC=O(19026)'],
    products = ['CC[C]1OCC1(O)C1CC[CH]OO1(22745)'],
...
reaction(
    label = 'reaction30',
    reactants = ['[CH2]OC(CC)=C(O)C([O])CCC=O(22746)'],
    products = ['CC[C]1OCC1(O)C([O])CCC=O(19026)'],
...
reaction(
    label = 'reaction33',
    reactants = ['CC[C]1OCC1(O)C([O])CCC=O(19026)'],
    products = ['CC=C1OCC1(O)C(O)CCC=O(22747)'],
...
reaction(
    label = 'reaction34',
    reactants = ['CH2(S)(23)', 'C[C]1OCC1(O)C([O])CCC=O(22748)'],
    products = ['CC[C]1OCC1(O)C([O])CCC=O(19026)'],
...
reaction(
    label = 'reaction35',
    reactants = ['CO(12)', 'CC[C]1OCC1(O)C([O])CC(12114)'],
    products = ['CC[C]1OCC1(O)C([O])CCC=O(19026)'],
...
reaction(
    label = 'reaction37',
    reactants = ['CCC1(CO1)[C](O)C([O])CCC=O(22749)'],
    products = ['CC[C]1OCC1(O)C([O])CCC=O(19026)'],
...
reaction(
    label = 'reaction38',
    reactants = ['[CH2]C1(C)OCC1(O)C([O])CCC=O(22750)'],
    products = ['CC[C]1OCC1(O)C([O])CCC=O(19026)'],
...
reaction(
    label = 'reaction40',
    reactants = ['CC[C]1OC[C]1C(CCC=O)OO(22751)'],
    products = ['CC[C]1OCC1(O)C([O])CCC=O(19026)'],
...
reaction(
    label = 'reaction41',
    reactants = ['C=COCC([O])C1(O)CO[C]1CC(22752)'],
    products = ['CC[C]1OCC1(O)C([O])CCC=O(19026)'],
...
reaction(
    label = 'reaction42',
    reactants = ['CC[C]1OCC1(O)C([O])CC=CO(22753)'],
    products = ['CC[C]1OCC1(O)C([O])CCC=O(19026)'],
...
reaction(
    label = 'reaction43',
    reactants = ['O(4)', 'CC[C]1OCC1(O)[CH]CCC=O(22754)'],
    products = ['CC[C]1OCC1(O)C([O])CCC=O(19026)'],
