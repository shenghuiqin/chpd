...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.566856,0.107523,-0.000100608,5.46277e-08,-1.28413e-11,-27576,39.7481], Tmin=(100,'K'), Tmax=(989.236,'K')), NASAPolynomial(coeffs=[11.3718,0.0592486,-2.74085e-05,5.29661e-09,-3.74278e-13,-29938,-17.7197], Tmin=(989.236,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-230.598,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(523.812,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)HHH) + group(Cds-OdCsCs) + radical(CCJCC=O)"""),
)

species(
    label = 'CC([O])CC=CC(C)OO(6189)',
    ...
    molecularWeight = (145.176,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.23263,0.10753,-8.77676e-05,3.67305e-08,-6.23364e-12,-16930.5,42.0223], Tmin=(100,'K'), Tmax=(1388.91,'K')), NASAPolynomial(coeffs=[21.0934,0.0432327,-1.83275e-05,3.39988e-09,-2.34248e-13,-23132.3,-73.0225], Tmin=(1388.91,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-142.384,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(527.969,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(CC(C)OJ)"""),
)

species(
    label = 'CC([O])C=CCC(C)OO(6190)',
...
species(
    label = 'CC([O])CC[CH]C(C)OO(6192)',
    structure = SMILES('CC([O])CC[CH]C(C)OO'),
    E0 = (-58.3049,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3025,407.5,1350,352.5,3615,1310,387.5,850,1000,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'CC([O])CCCC(C)O[O](6199)',
    structure = SMILES('CC([O])CCCC(C)O[O]'),
    E0 = (-106.715,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (146.184,'amu'),
...
species(
    label = 'CC(=O)CCCC(C)OO(6204)',
    structure = SMILES('CC(=O)CCCC(C)OO'),
    E0 = (-430.5,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (146.184,'amu'),
...
species(
    label = 'CC([O])C[CH]CCOO(6207)',
    structure = SMILES('CC([O])C[CH]CCOO'),
    E0 = (-27.8383,'kJ/mol'),
    modes = [
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0851663,0.0975404,-8.54684e-05,1.79085e-08,1.97969e-11,-3218.16,36.4547], Tmin=(100,'K'), Tmax=(554.069,'K')), NASAPolynomial(coeffs=[7.94017,0.0584396,-2.72793e-05,5.24709e-09,-3.68168e-13,-4358.87,0.758094], Tmin=(554.069,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-27.8383,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(478.082,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(CC(C)OJ)"""),
)
...
species(
    label = 'CC([O])CC1CC(C)O1(6208)',
    structure = SMILES('CC([O])CC1CC(C)O1'),
    E0 = (-158.836,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (129.177,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.13687,0.0750234,-4.34018e-06,-5.14329e-08,2.72808e-11,-18939.9,32.0819], Tmin=(100,'K'), Tmax=(924.344,'K')), NASAPolynomial(coeffs=[17.7718,0.0385455,-1.17109e-05,1.89257e-09,-1.26438e-13,-24003,-62.3874], Tmin=(924.344,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-158.836,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(515.497,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Oxetane) + radical(CC(C)OJ)"""),
)

species(
    label = '[CH2]C(CC(C)[O])C(C)OO(6209)',
...
species(
    ...
    molecularWeight = (146.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.26081,0.114849,-0.00010391,5.0837e-08,-1.02548e-11,-32564.2,41.2203], Tmin=(100,'K'), Tmax=(1173.43,'K')), NASAPolynomial(coeffs=[17.6536,0.0503729,-2.14887e-05,4.01028e-09,-2.78237e-13,-37003.1,-53.0556], Tmin=(1173.43,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-272.334,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(552.912,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(CC(C)OJ)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'CC(=O)C[CH]CC(C)OO(6188)'],
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'CC([O])CC=CC(C)OO(6189)'],
    products = ['CC([O])C[CH]CC(C)OO(5877)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', 'CC([O])C=CCC(C)OO(6190)'],
    products = ['CC([O])C[CH]CC(C)OO(5877)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(1.46e+08,'cm^3/(mol*s)'), n=1.64, Ea=(5.73208,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""From training reaction 2555 used for Cds-CsH_Cds-CsH;HJ
Exact match found for rate rule [Cds-CsH_Cds-CsH;HJ]
...
reaction(
    label = 'reaction6',
    reactants = ['CH3(17)', 'CC(C[CH]CC=O)OO(5431)'],
    products = ['CC([O])C[CH]CC(C)OO(5877)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['CH3CHOOH(63)', 'C=CCC(C)[O](1922)'],
    products = ['CC([O])C[CH]CC(C)OO(5877)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction10',
    reactants = ['CC([O])CC[CH]C(C)OO(6192)'],
    products = ['CC([O])C[CH]CC(C)OO(5877)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CC([O])[CH]CCC(C)OO(6117)'],
    products = ['CC([O])C[CH]CC(C)OO(5877)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]C(CCCC(C)[O])OO(6197)'],
    products = ['CC([O])C[CH]CC(C)OO(5877)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]C([O])CCCC(C)OO(6198)'],
    products = ['CC([O])C[CH]CC(C)OO(5877)'],
...
reaction(
    label = 'reaction27',
    reactants = ['CH2(S)(23)', 'CC([O])C[CH]CCOO(6207)'],
    products = ['CC([O])C[CH]CC(C)OO(5877)'],
...
reaction(
    label = 'reaction28',
    reactants = ['CH2(S)(23)', 'CC(C[CH]CC[O])OO(5265)'],
    products = ['CC([O])C[CH]CC(C)OO(5877)'],
...
reaction(
    label = 'reaction29',
    reactants = ['CC([O])C[CH]CC(C)OO(5877)'],
    products = ['OH(5)', 'CC([O])CC1CC(C)O1(6208)'],
...
reaction(
    label = 'reaction30',
    reactants = ['[CH2]C(CC(C)[O])C(C)OO(6209)'],
    products = ['CC([O])C[CH]CC(C)OO(5877)'],
...
reaction(
    label = 'reaction33',
    reactants = ['CC([O])C[CH]CC(C)OO(5877)'],
    products = ['CC([O])CC(O)CC(C)[O](6210)'],
