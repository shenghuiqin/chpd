...
species(
    label = '[CH2][C](O)C1(C=C(O)O1)CC(25429)',
    structure = SMILES('[CH2][C](O)C1(C=C(O)O1)CC'),
    E0 = (-75.2677,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (142.152,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.68635,0.124887,-0.000134809,7.00657e-08,-1.37452e-11,-8792.93,38.9994], Tmin=(100,'K'), Tmax=(1378.59,'K')), NASAPolynomial(coeffs=[31.4332,0.0146506,-2.63554e-06,2.35312e-10,-9.46937e-15,-17132.4,-132.689], Tmin=(1378.59,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-75.2677,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsCs) + ring(Cyclobutene) + radical(C2CsJOH) + radical(CJCO)"""),
)
...
species(
    label = '[CH]=C(O)OC(=C=C)CC(25430)',
    structure = SMILES('[CH]=C(O)OC(=C=C)CC'),
    E0 = (135.915,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,540,610,2055,3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,2950,3100,1380,975,1025,1650,325,375,415,465,420,450,1700,1750,2750,2850,1437.5,1250,1305,750,350,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.494035,0.100615,-0.00011277,6.71988e-08,-1.61073e-11,16507.2,33.1463], Tmin=(100,'K'), Tmax=(1011.14,'K')), NASAPolynomial(coeffs=[16.1341,0.0348352,-1.51855e-05,2.85888e-09,-1.9937e-13,13144.6,-47.2588], Tmin=(1011.14,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(135.915,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(Cds_P)"""),
)
...
species(
    label = '[CH]=C(O)OC(CC)=C(C)[O](25431)',
    ...
    molecularWeight = (142.152,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.2389,0.116582,-0.000136916,8.49154e-08,-2.09765e-11,-13937.6,38.3236], Tmin=(100,'K'), Tmax=(987.575,'K')), NASAPolynomial(coeffs=[18.5291,0.0365145,-1.53027e-05,2.81886e-09,-1.93975e-13,-17842,-56.7983], Tmin=(987.575,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-117.443,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsOs) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(C=C(C)OJ) + radical(Cds_P)"""),
)
...
species(
    ...
    opticalIsomers = 1,
    molecularWeight = (142.152,'amu'),
    collisionModel = TransportData(shapeIndex=2, epsilon=(4442.64,'J/mol'), sigma=(7.23183,'angstroms'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with Tc=693.93 K, Pc=26.65 bar (from Joback method)"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
...
species(
    label = '[CH]=C(O)OC([CH]C)=C(C)O(25432)',
    structure = SMILES('[CH]=C(O)OC([CH]C)=C(C)O'),
    E0 = (-55.3459,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([325,350,375,415,440,465,420,435,450,1700,1725,1750,3025,407.5,1350,352.5,3580,3650,1210,1345,900,1100,3120,650,792.5,1650,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (142.152,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.70178,0.11889,-0.000133648,7.55745e-08,-1.66476e-11,-6445.62,40.9716], Tmin=(100,'K'), Tmax=(1116.36,'K')), NASAPolynomial(coeffs=[23.9688,0.02691,-1.00592e-05,1.76999e-09,-1.19714e-13,-12177.1,-85.6997], Tmin=(1116.36,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-55.3459,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsOs) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(CCJCO) + radical(Cds_P)"""),
)
...
species(
    label = '[CH]=C(O)OC(C[CH2])=C(C)O(25433)',
    structure = SMILES('[CH]=C(O)OC(C[CH2])=C(C)O'),
    E0 = (-50.0016,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,3580,3650,1210,1345,900,1100,2750,2800,2850,1350,1500,750,1050,1375,1000,325,350,375,415,440,465,420,435,450,1700,1725,1750,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (142.152,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.67913,0.122666,-0.000144938,8.69925e-08,-2.04462e-11,-5807.25,40.1842], Tmin=(100,'K'), Tmax=(1044.66,'K')), NASAPolynomial(coeffs=[22.4934,0.0301093,-1.20368e-05,2.1789e-09,-1.49091e-13,-10857.6,-77.4901], Tmin=(1044.66,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-50.0016,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsOs) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(RCCJ) + radical(Cds_P)"""),
)
...
species(
    label = '[CH]=C(O)OC1(CC)C[C]1O(25434)',
    structure = SMILES('[CH]=C(O)OC1(CC)C[C]1O'),
    E0 = (-30.761,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (142.152,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.59607,0.127578,-0.000142393,7.68754e-08,-1.57833e-11,-3447.25,38.0408], Tmin=(100,'K'), Tmax=(1271.62,'K')), NASAPolynomial(coeffs=[30.8479,0.0162836,-3.92237e-06,5.11377e-10,-2.92769e-14,-11460.2,-129.406], Tmin=(1271.62,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-30.761,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + ring(Cyclopropane) + radical(C2CsJOH) + radical(Cds_P)"""),
)
...
species(
    label = '[CH]=C(O)OC(C)=C([CH2])O(25436)',
    structure = SMILES('[CH]=C(O)OC(C)=C([CH2])O'),
    E0 = (-73.6858,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([325,350,375,415,440,465,420,435,450,1700,1725,1750,3120,650,792.5,1650,3580,3650,1210,1345,900,1100,3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.27972,0.112736,-0.000142972,8.98528e-08,-2.17707e-11,-8669.24,34.7373], Tmin=(100,'K'), Tmax=(1021.94,'K')), NASAPolynomial(coeffs=[22.3832,0.0201169,-7.02728e-06,1.16922e-09,-7.5946e-14,-13505.7,-79.9363], Tmin=(1021.94,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-73.6858,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsOs) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(C=C(O)CJ) + radical(Cds_P)"""),
)
...
species(
    label = '[CH]=C(O)OC(CC)C([CH2])=O(25438)',
    structure = SMILES('[CH]=C(O)OC(CC)C(=C)[O]'),
    E0 = (-128.839,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (142.152,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.51246,0.123136,-0.00013192,6.82972e-08,-1.34358e-11,-15244.1,41.5836], Tmin=(100,'K'), Tmax=(1342.32,'K')), NASAPolynomial(coeffs=[30.8518,0.0161464,-3.90652e-06,5.19401e-10,-3.04228e-14,-23519.5,-126.663], Tmin=(1342.32,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-128.839,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cds_P) + radical(C=C(C)OJ)"""),
)
...
species(
    label = '[CH]=C(O)OC(=[C]O)CC(25439)',
    structure = SMILES('[CH]=C(O)OC(=[C]O)CC'),
    E0 = (26.2878,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,3580,3650,1210,1345,900,1100,2750,2800,2850,1350,1500,750,1050,1375,1000,1685,370,325,375,415,465,420,450,1700,1750,2750,2850,1437.5,1250,1305,750,350,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (128.126,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.05217,0.107037,-0.00012958,7.83151e-08,-1.83284e-11,3347.2,37.268], Tmin=(100,'K'), Tmax=(1055.28,'K')), NASAPolynomial(coeffs=[21.5668,0.0212989,-7.70618e-06,1.32051e-09,-8.76786e-14,-1426.55,-73.0718], Tmin=(1055.28,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(26.2878,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsCs) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C=CJO) + radical(Cds_P)"""),
)
...
species(
    label = '[CH]=C(O)OC(=CC)C(=C)O(25440)',
    structure = SMILES('[CH]=C(O)OC(=CC)C(=C)O'),
    E0 = (-143.474,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,3010,987.5,1337.5,450,1655,3580,3650,1210,1345,900,1100,2950,3100,1380,975,1025,1650,2750,2800,2850,1350,1500,750,1050,1375,1000,325,350,375,415,440,465,420,435,450,1700,1725,1750,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.84482,0.127496,-0.000162328,1.03671e-07,-2.57248e-11,-17044.4,35.281], Tmin=(100,'K'), Tmax=(994.292,'K')), NASAPolynomial(coeffs=[23.1737,0.0268455,-1.04842e-05,1.85865e-09,-1.25166e-13,-22019.5,-85.275], Tmin=(994.292,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-143.474,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)HHH) + group(Cds-Cds(Cds-Cds)O2s) + group(Cds-Cds(Cds-Cds)O2s) + group(Cds-CdsCsH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cds_P)"""),
)
...
species(
    label = '[CH]=C(O)OC(=C)C(=C)O(25441)',
    structure = SMILES('[CH]=C(O)OC(=C)C(=C)O'),
    E0 = (-107.448,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([325,350,375,415,440,465,420,435,450,1700,1725,1750,3120,650,792.5,1650,3580,3650,1210,1345,900,1100,2950,3000,3050,3100,1330,1430,900,1050,1000,1050,1600,1700,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.34092,0.113662,-0.000148117,9.3808e-08,-2.2759e-11,-12727.3,31.6617], Tmin=(100,'K'), Tmax=(1023.16,'K')), NASAPolynomial(coeffs=[23.5378,0.0164002,-5.52708e-06,8.99791e-10,-5.77802e-14,-17818.3,-88.9337], Tmin=(1023.16,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-107.448,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(Cds-Cds(Cds-Cds)O2s) + group(Cds-Cds(Cds-Cds)O2s) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cds_P)"""),
)

species(
    label = '[CH]=C(O)OC([CH]C)C(=C)O(25442)',
    structure = SMILES('[CH]=C(O)OC([CH]C)C(=C)O'),
    E0 = (-66.7418,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,3580,3650,1210,1345,900,1100,2950,3100,1380,975,1025,1650,1380,1390,370,380,2900,435,325,375,415,465,420,450,1700,1750,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (142.152,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-3.23109,0.128191,-0.000137158,6.86859e-08,-1.27859e-11,-7740.41,45.1689], Tmin=(100,'K'), Tmax=(1501.76,'K')), NASAPolynomial(coeffs=[34.867,0.00870076,1.86017e-07,-2.72101e-10,2.33231e-14,-17151.9,-147.361], Tmin=(1501.76,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-66.7418,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cds_P) + radical(CCJCO)"""),
)

species(
    label = '[CH]=C(O)OC(C[CH2])C(=C)O(25443)',
    structure = SMILES('[CH]=C(O)OC(C[CH2])C(=C)O'),
    E0 = (-61.3975,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,3580,3650,1210,1345,900,1100,2950,3100,1380,975,1025,1650,1380,1390,370,380,2900,435,325,375,415,465,420,450,1700,1750,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (142.152,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-3.05138,0.130296,-0.000143343,7.43713e-08,-1.44646e-11,-7109.32,43.8048], Tmin=(100,'K'), Tmax=(1400.41,'K')), NASAPolynomial(coeffs=[34.2807,0.01058,-1.09888e-06,-1.62207e-11,6.02964e-15,-16282.4,-144.292], Tmin=(1400.41,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-61.3975,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cds_P) + radical(RCCJ)"""),
)

species(
    label = '[CH]=C(O)OC(CC)C(=[CH])O(25444)',
    structure = SMILES('[CH]=C(O)OC(CC)C(=[CH])O'),
    E0 = (-19.5477,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3115,3125,620,680,785,800,1600,1700,2750,2800,2850,1350,1500,750,1050,1375,1000,3580,3650,1210,1345,900,1100,1380,1390,370,380,2900,435,325,375,415,465,420,450,1700,1750,2750,2850,1437.5,1250,1305,750,350,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (142.152,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-3.12335,0.132659,-0.00014821,7.79668e-08,-1.53719e-11,-2074.02,42.6774], Tmin=(100,'K'), Tmax=(1378.01,'K')), NASAPolynomial(coeffs=[34.6552,0.0101658,-9.05041e-07,-5.54905e-11,8.89513e-15,-11267.5,-147.275], Tmin=(1378.01,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-19.5477,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cds_P) + radical(Cds_P)"""),
)
...
species(
    label = '[CH]=C(O)OC([CH2])(C)C(=C)O(25446)',
    structure = SMILES('[CH]=C(O)OC([CH2])(C)C(=C)O'),
    E0 = (-81.1736,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,3580,3650,1210,1345,900,1100,2750,2800,2850,1350,1500,750,1050,1375,1000,2950,3100,1380,975,1025,1650,325,375,415,465,420,450,1700,1750,3000,3100,440,815,1455,1000,180,180,180,180,1600,1615.18,2875.91,3200],'cm^-1')),
        HinderedRotor(inertia=(0.151367,'amu*angstrom^2'), symmetry=1, barrier=(3.48022,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.151367,'amu*angstrom^2'), symmetry=1, barrier=(3.48022,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.151367,'amu*angstrom^2'), symmetry=1, barrier=(3.48022,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.151367,'amu*angstrom^2'), symmetry=1, barrier=(3.48022,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.151367,'amu*angstrom^2'), symmetry=1, barrier=(3.48022,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (142.152,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-3.41066,0.14326,-0.000173769,9.88987e-08,-2.10166e-11,-9479.09,41.3292], Tmin=(100,'K'), Tmax=(1281.83,'K')), NASAPolynomial(coeffs=[35.2365,0.00846818,5.72216e-07,-4.11962e-10,3.68948e-14,-18221,-150.169], Tmin=(1281.83,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-81.1736,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cds_P) + radical(CJC(C)OC)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[CH]=C(O)OC(CC)=C([CH2])O(9607)'],
    products = ['[CH2][C](O)C1(C=C(O)O1)CC(25429)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['OH(5)', '[CH]=C(O)OC(=C=C)CC(25430)'],
    products = ['[CH]=C(O)OC(CC)=C([CH2])O(9607)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['OH(5)', 'C#COC(CC)=C([CH2])O(12343)'],
    products = ['[CH]=C(O)OC(CC)=C([CH2])O(9607)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH]=C(O)OC(CC)=C([CH2])O(9607)'],
    products = ['[CH]=C(O)OC(CC)=C(C)[O](25431)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH]=C(O)OC([CH]C)=C(C)O(25432)'],
    products = ['[CH]=C(O)OC(CC)=C([CH2])O(9607)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH]=C(O)OC(CC)=C([CH2])O(9607)'],
    products = ['[CH2]C(O)=C([CH]C)OC(=C)O(9608)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH]=C(O)OC(C[CH2])=C(C)O(25433)'],
    products = ['[CH]=C(O)OC(CC)=C([CH2])O(9607)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH]=C(O)OC(CC)=C([CH2])O(9607)'],
    products = ['[CH]=C([O])OC(CC)=C(C)O(9609)'],
    transitionState = 'TS11',
    kinetics = Arrhenius(A=(5470,'s^-1'), n=1.94, Ea=(87.4456,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R6H_SMSSR;C_rad_out_2H;XH_out] for rate rule [R6H_SMSSR;C_rad_out_2H;O_H_out]
Euclidian distance = 1.0
family: intra_H_migration"""),
)
...
reaction(
    label = 'reaction12',
    reactants = ['[CH]=C(O)OC(CC)=C([CH2])O(9607)'],
    products = ['[CH2]CC(OC(=C)O)=C([CH2])O(9610)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH]=C(O)OC(CC)=C([CH2])O(9607)'],
    products = ['[CH2]C([O])=C(CC)OC(=C)O(9611)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]C(O)=[C]CC(4618)', '[CH]=C([O])O(7862)'],
    products = ['[CH]=C(O)OC(CC)=C([CH2])O(9607)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH]=C(O)OC(CC)=C([CH2])O(9607)'],
    products = ['[CH]=C(O)OC1(CC)C[C]1O(25434)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CH2(S)(23)', '[CH]=C(O)OC(C)=C([CH2])O(25436)'],
    products = ['[CH]=C(O)OC(CC)=C([CH2])O(9607)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH]=C(O)OC(CC)=C([CH2])O(9607)'],
    products = ['[CH]=C(O)C([CH2])(O)C(=O)CC(9512)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH]=C(O)OC(CC)=C([CH2])O(9607)'],
    products = ['[CH]=C(O)OC(CC)C([CH2])=O(25438)'],
...
reaction(
    label = 'reaction22',
    reactants = ['CH2(19)', '[CH]=C(O)OC(=[C]O)CC(25439)'],
    products = ['[CH]=C(O)OC(CC)=C([CH2])O(9607)'],
...
reaction(
    label = 'reaction23',
    reactants = ['H(3)', '[CH]=C(O)OC(=CC)C(=C)O(25440)'],
    products = ['[CH]=C(O)OC(CC)=C([CH2])O(9607)'],
...
reaction(
    label = 'reaction25',
    reactants = ['CH3(17)', '[CH]=C(O)OC(=C)C(=C)O(25441)'],
    products = ['[CH]=C(O)OC(CC)=C([CH2])O(9607)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[CH]=C(O)OC([CH]C)C(=C)O(25442)'],
    products = ['[CH]=C(O)OC(CC)=C([CH2])O(9607)'],
...
reaction(
    label = 'reaction27',
    reactants = ['[CH]=C(O)OC(C[CH2])C(=C)O(25443)'],
    products = ['[CH]=C(O)OC(CC)=C([CH2])O(9607)'],
...
reaction(
    label = 'reaction28',
    reactants = ['[CH]=C(O)OC(CC)C(=[CH])O(25444)'],
    products = ['[CH]=C(O)OC(CC)=C([CH2])O(9607)'],
...
reaction(
    label = 'reaction29',
    reactants = ['[CH]=C(O)OC(CC)=C([CH2])O(9607)'],
    products = ['[CH]=C([O])OC(CC)C(=C)O(9613)'],
...
reaction(
    label = 'reaction30',
    reactants = ['[CH]=C(O)OC(CC)=C([CH2])O(9607)'],
    products = ['[CH]=C(O)[C](CC)OC(=C)O(9614)'],
...
reaction(
    label = 'reaction33',
    reactants = ['[CH]=C(O)OC([CH2])(C)C(=C)O(25446)'],
    products = ['[CH]=C(O)OC(CC)=C([CH2])O(9607)'],
