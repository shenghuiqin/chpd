...
species(
    label = '[CH2][C](O)C1(CC)OOO1(4903)',
    structure = SMILES('[CH2][C](O)C1(CC)OOO1'),
    E0 = (98.4482,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (132.115,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.726429,0.0768805,-2.71033e-06,-7.58577e-08,4.10861e-11,12035.7,34.06], Tmin=(100,'K'), Tmax=(936.436,'K')), NASAPolynomial(coeffs=[31.9212,0.00602586,9.01131e-07,-1.99613e-10,2.83943e-15,2913.39,-137.362], Tmin=(936.436,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(98.4482,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsOs) + group(Cs-CsCsOsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Cyclobutane) + radical(C2CsJOH) + radical(CJCO)"""),
)
...
species(
    label = 'C=C=C(CC)OO[O](4904)',
    structure = SMILES('C=C=C(CC)OO[O]'),
    E0 = (221.975,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2950,3100,1380,975,1025,1650,540,610,2055,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.691218,0.0690462,-6.22617e-05,2.95904e-08,-5.6872e-12,26819.6,31.7885], Tmin=(100,'K'), Tmax=(1244.42,'K')), NASAPolynomial(coeffs=[14.0081,0.02624,-1.06626e-05,1.94679e-09,-1.33534e-13,23505.3,-35.3693], Tmin=(1244.42,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(221.975,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsOs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(ROOJ)"""),
)
...
species(
    label = 'C[CH]C(OO[O])=C(C)O(4905)',
    structure = SMILES('C[CH]C(OO[O])=C(C)O'),
    E0 = (30.7141,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([325,375,415,465,420,450,1700,1750,3025,407.5,1350,352.5,3615,1277.5,1000,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (132.115,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.295339,0.0846231,-7.34121e-05,2.51601e-08,-7.6592e-13,3857.49,38.8277], Tmin=(100,'K'), Tmax=(977.92,'K')), NASAPolynomial(coeffs=[20.2151,0.0210654,-7.11648e-06,1.23023e-09,-8.47071e-14,-1126.44,-64.6372], Tmin=(977.92,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(30.7141,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(O2s-OsOs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsOs) + radical(ROOJ) + radical(CCJCO)"""),
)

species(
    label = '[CH2]C(O)=C([CH]C)OOO(4906)',
    structure = SMILES('[CH2]C(O)=C([CH]C)OOO'),
    E0 = (37.626,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([325,375,415,465,420,450,1700,1750,3025,407.5,1350,352.5,3615,1277.5,1000,3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,933.333,1066.67,1200,1333.33,1466.67,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (132.115,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.2895,0.096769,-9.91177e-05,4.91681e-08,-9.23314e-12,4732.51,42.3372], Tmin=(100,'K'), Tmax=(1443.22,'K')), NASAPolynomial(coeffs=[25.5617,0.0132533,-2.86304e-06,3.38434e-10,-1.8273e-14,-2070.71,-93.774], Tmin=(1443.22,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(37.626,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(378.308,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(O2s-OsOs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsOs) + radical(C=C(O)CJ) + radical(CCJCO)"""),
)

species(
    label = '[CH2]CC(OO[O])=C(C)O(4907)',
    ...
    molecularWeight = (132.115,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.534734,0.0915099,-9.56007e-05,5.06085e-08,-1.04564e-11,4507.1,38.9782], Tmin=(100,'K'), Tmax=(1188.36,'K')), NASAPolynomial(coeffs=[20.1415,0.0219127,-7.75053e-06,1.32392e-09,-8.80735e-14,-406.986,-64.3407], Tmin=(1188.36,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(36.0584,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(O2s-OsOs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsOs) + radical(RCCJ) + radical(ROOJ)"""),
)

species(
    label = '[CH2]CC(OOO)=C([CH2])O(4908)',
    structure = SMILES('[CH2]CC(OOO)=C([CH2])O'),
    E0 = (42.9703,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (132.115,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.13079,0.0990946,-0.000105969,5.5591e-08,-1.11794e-11,5364.59,41.0505], Tmin=(100,'K'), Tmax=(1274.19,'K')), NASAPolynomial(coeffs=[24.3798,0.0159932,-4.58806e-06,6.89323e-10,-4.29217e-14,-891.537,-87.2436], Tmin=(1274.19,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(42.9703,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(378.308,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(O2s-OsOs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsOs) + radical(C=C(O)CJ) + radical(RCCJ)"""),
)
...
species(
    label = 'CCC1(C[C]1O)OO[O](4909)',
    structure = SMILES('CCC1(C[C]1O)OO[O]'),
    E0 = (67.7022,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (132.115,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.72704,0.0920017,-9.25696e-05,4.69229e-08,-9.24388e-12,8323.03,35.9149], Tmin=(100,'K'), Tmax=(1249.12,'K')), NASAPolynomial(coeffs=[21.6045,0.0204892,-6.6926e-06,1.08872e-09,-7.04091e-14,2744.19,-76.7886], Tmin=(1249.12,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(67.7022,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsOs) + group(O2s-OsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(ROOJ) + radical(C2CsJOH)"""),
)
...
species(
    label = '[CH2]C(O)=C(C)OO[O](4911)',
    structure = SMILES('[CH2]C(O)=C(C)OO[O]'),
    E0 = (12.3742,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([325,375,415,465,420,450,1700,1750,3615,1277.5,1000,3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.105825,0.0812216,-9.23647e-05,5.18456e-08,-1.11167e-11,1643.89,33.4265], Tmin=(100,'K'), Tmax=(1213.67,'K')), NASAPolynomial(coeffs=[19.65,0.0125536,-3.10048e-06,3.98212e-10,-2.18362e-14,-2889.56,-64.6306], Tmin=(1213.67,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(12.3742,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(O2s-OsOs) + group(O2s-OsH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsOs) + radical(ROOJ) + radical(C=C(O)CJ)"""),
)
...
species(
    ...
    opticalIsomers = 1,
    molecularWeight = (132.115,'amu'),
    collisionModel = TransportData(shapeIndex=2, epsilon=(4515.16,'J/mol'), sigma=(7.38563,'angstroms'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with Tc=705.26 K, Pc=25.43 bar (from Joback method)"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
...
species(
    ...
    molecularWeight = (118.088,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0572126,0.0762435,-8.1308e-05,4.3085e-08,-8.75447e-12,13663.2,36.1914], Tmin=(100,'K'), Tmax=(1280.91,'K')), NASAPolynomial(coeffs=[19.0996,0.0133073,-3.5423e-06,4.95227e-10,-2.91755e-14,9069.64,-59.28], Tmin=(1280.91,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(112.348,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(O2s-OsOs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + radical(ROOJ) + radical(C=CJO)"""),
)
...
species(
    label = 'C=C(O)C(=CC)OO[O](4916)',
    structure = SMILES('C=C(O)C(=CC)OO[O]'),
    E0 = (-57.4136,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([325,375,415,465,420,450,1700,1750,2950,3100,1380,975,1025,1650,3010,987.5,1337.5,450,1655,3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.61406,0.0953527,-0.000109702,6.32653e-08,-1.41284e-11,-6733.83,33.7632], Tmin=(100,'K'), Tmax=(1105.73,'K')), NASAPolynomial(coeffs=[20.3989,0.0193378,-6.58281e-06,1.09243e-09,-7.1375e-14,-11380.7,-69.7239], Tmin=(1105.73,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-57.4136,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(O2s-OsOs) + group(O2s-OsH) + group(Cs-(Cds-Cds)HHH) + group(Cds-Cds(Cds-Cds)O2s) + group(Cds-Cds(Cds-Cds)O2s) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(ROOJ)"""),
)
...
species(
    label = 'C=C(O)C(=C)OO[O](4917)',
    structure = SMILES('C=C(O)C(=C)OO[O]'),
    E0 = (-21.388,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([325,375,415,465,420,450,1700,1750,3615,1277.5,1000,2950,3000,3050,3100,1330,1430,900,1050,1000,1050,1600,1700,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.131389,0.0785833,-8.48409e-05,3.90959e-08,-4.85858e-12,-2427.06,29.2836], Tmin=(100,'K'), Tmax=(918.86,'K')), NASAPolynomial(coeffs=[19.848,0.0104579,-2.53232e-06,3.48428e-10,-2.18533e-14,-6797.86,-68.2365], Tmin=(918.86,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-21.388,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(O2s-OsOs) + group(O2s-OsH) + group(Cds-Cds(Cds-Cds)O2s) + group(Cds-Cds(Cds-Cds)O2s) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(ROOJ)"""),
)
...
species(
    label = '[CH]=C(O)[C](CC)OOO(4918)',
    structure = SMILES('[CH]C(O)=C(CC)OOO'),
    E0 = (49.4918,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,325,375,415,465,420,450,1700,1750,3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,180,964.084,964.084,964.084,964.084,964.084,964.084,964.084,964.084,964.084,2317.7],'cm^-1')),
        HinderedRotor(inertia=(0.100741,'amu*angstrom^2'), symmetry=1, barrier=(2.31623,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.100741,'amu*angstrom^2'), symmetry=1, barrier=(2.31623,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.100741,'amu*angstrom^2'), symmetry=1, barrier=(2.31623,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.100741,'amu*angstrom^2'), symmetry=1, barrier=(2.31623,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.100741,'amu*angstrom^2'), symmetry=1, barrier=(2.31623,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (132.115,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.789709,0.0937496,-7.81676e-05,2.60332e-08,-9.67687e-13,6135.12,38.4565], Tmin=(100,'K'), Tmax=(1009.3,'K')), NASAPolynomial(coeffs=[21.542,0.0265013,-9.81405e-06,1.74967e-09,-1.21097e-13,544.628,-74.8508], Tmin=(1009.3,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(49.4918,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(378.308,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(O2s-OsOs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsOs) + radical(AllylJ2_triplet)"""),
)
...
species(
    label = 'C=C(O)C(=CC)OOO(4920)',
    structure = SMILES('C=C(O)C(=CC)OOO'),
    E0 = (-209.418,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (132.115,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.983904,0.100158,-0.000109044,5.88633e-08,-1.22932e-11,-24999.7,34.3334], Tmin=(100,'K'), Tmax=(1180.93,'K')), NASAPolynomial(coeffs=[22.7753,0.019682,-6.82433e-06,1.15772e-09,-7.70504e-14,-30611.3,-84.2424], Tmin=(1180.93,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-209.418,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(O2s-OsOs) + group(O2s-OsH) + group(Cs-(Cds-Cds)HHH) + group(Cds-Cds(Cds-Cds)O2s) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)O2s) + group(Cds-CdsHH)"""),
)
...
species(
    label = '[CH2]C(C)(OO[O])C(=C)O(4923)',
    structure = SMILES('[CH2]C(C)(OO[O])C(=C)O'),
    E0 = (20.7421,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,440,435,1725,2950,3100,1380,975,1025,1650,3615,1277.5,1000,3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,300,800,800,800,800,800,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (132.115,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.6493,0.102129,-0.000108627,5.53827e-08,-1.05601e-11,2717.03,41.8432], Tmin=(100,'K'), Tmax=(1460.62,'K')), NASAPolynomial(coeffs=[26.825,0.0107016,-9.22659e-07,-8.01501e-11,1.19193e-14,-4166.41,-101.406], Tmin=(1460.62,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(20.7421,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-(Cds-Cd)H) + group(O2s-OsOs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(ROOJ) + radical(CJCOOH)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['C=C(O)[C](CC)OO[O](3513)'],
    products = ['[CH2][C](O)C1(CC)OOO1(4903)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['OH(5)', 'C=C=C(CC)OO[O](4904)'],
    products = ['C=C(O)[C](CC)OO[O](3513)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['C[CH]C(OO[O])=C(C)O(4905)'],
    products = ['C=C(O)[C](CC)OO[O](3513)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2]C(O)=C([CH]C)OOO(4906)'],
    products = ['C=C(O)[C](CC)OO[O](3513)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2]CC(OO[O])=C(C)O(4907)'],
    products = ['C=C(O)[C](CC)OO[O](3513)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['C=C(O)[C](CC)OO[O](3513)'],
    products = ['[CH2]CC(OOO)=C([CH2])O(4908)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction12',
    reactants = ['C=C(O)[C](CC)OO[O](3513)'],
    products = ['CCC1(C[C]1O)OO[O](4909)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CH2(S)(23)', '[CH2]C(O)=C(C)OO[O](4911)'],
    products = ['C=C(O)[C](CC)OO[O](3513)'],
...
reaction(
    label = 'reaction20',
    reactants = ['CH2(19)', 'CCC(=[C]O)OO[O](4915)'],
    products = ['C=C(O)[C](CC)OO[O](3513)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(3)', 'C=C(O)C(=CC)OO[O](4916)'],
    products = ['C=C(O)[C](CC)OO[O](3513)'],
...
reaction(
    label = 'reaction22',
    reactants = ['CH3(17)', 'C=C(O)C(=C)OO[O](4917)'],
    products = ['C=C(O)[C](CC)OO[O](3513)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(1.278e+07,'cm^3/(mol*s)'), n=2.09, Ea=(356.818,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""Estimated using template [Od_CO-CdCs;YJ] for rate rule [Od_CO-CdCs;O2b]
Euclidian distance = 2.0
Multiplied by reaction path degeneracy 2.0
family: R_Addition_MultipleBond
Ea raised from 351.4 to 356.8 kJ/mol to match endothermicity of reaction."""),
)
...
reaction(
    label = 'reaction27',
    reactants = ['[CH]=C(O)[C](CC)OOO(4918)'],
    products = ['C=C(O)[C](CC)OO[O](3513)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(1.46e+06,'s^-1'), n=1.02, Ea=(45.6888,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R6_linear;doublebond_intra_secNd_2H;radadd_intra] for rate rule [R6_linear;doublebond_intra_secNd_2H;radadd_intra_O]
Euclidian distance = 1.0
family: Intra_R_Add_Endocyclic"""),
)
...
reaction(
    ...
    kinetics = Arrhenius(A=(3.09e+12,'s^-1'), n=0, Ea=(54.7981,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R2OO;C_ter_rad_intra;OO] for rate rule [R2OO;C_rad/Cs2_intra;OOJ]
Euclidian distance = 2.2360679775
family: Cyclic_Ether_Formation"""),
)
...
reaction(
    label = 'reaction32',
    reactants = ['[CH2]C(C)(OO[O])C(=C)O(4923)'],
    products = ['C=C(O)[C](CC)OO[O](3513)'],
