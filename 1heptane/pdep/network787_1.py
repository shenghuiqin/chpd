...
species(
    ...
    molecularWeight = (100.159,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.1401,0.0835412,-7.48596e-05,3.81056e-08,-8.07411e-12,6822.87,30.2785], Tmin=(100,'K'), Tmax=(1120.15,'K')), NASAPolynomial(coeffs=[12.5564,0.0392025,-1.54847e-05,2.76769e-09,-1.87151e-13,4041.27,-31.0318], Tmin=(1120.15,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(55.5634,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCsJOCs) + radical(Isobutyl)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'C[CH]OCC=CC(2002)'],
    products = ['C[CH]OC[CH]CC(1203)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'C[CH]OC=CCC(2003)'],
    products = ['C[CH]OC[CH]CC(1203)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', 'C=COC[CH]CC(2004)'],
    products = ['C[CH]OC[CH]CC(1203)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['CH3(17)', 'C=CCO[CH]C(1893)'],
    products = ['C[CH]OC[CH]CC(1203)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction22',
    reactants = ['CHCH3(T)(95)', 'CC[CH]C[O](1679)'],
    products = ['C[CH]OC[CH]CC(1203)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH]CC(144)', '[CH2]O[CH]C(567)'],
    products = ['C[CH]OC[CH]CC(1203)'],
