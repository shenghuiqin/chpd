...
species(
    label = 'C[CH][C]=O(11589)',
    structure = SMILES('C[CH][C]=O'),
    E0 = (123.153,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,1855,455,950],'cm^-1')),
