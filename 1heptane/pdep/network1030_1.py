...
species(
    label = 'CC(CC1CO1)O[O](1946)',
    structure = SMILES('CC(CC1CO1)O[O]'),
    E0 = (-99.9517,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2950,3150,900,1000,1100,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,492.5,1135,1000,1380,1390,370,380,2900,435,200,800,900,1000,1100,1200,1300,1400,1500,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0663208,0.0809205,-7.66684e-05,4.08273e-08,-8.64665e-12,-11867.8,29.7155], Tmin=(100,'K'), Tmax=(1240.1,'K')), NASAPolynomial(coeffs=[14.6752,0.028898,-8.33241e-06,1.18175e-09,-6.78443e-14,-15180,-43.1891], Tmin=(1240.1,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-99.9517,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(390.78,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(ROOJ)"""),
)
...
species(
    label = 'CC(C[C]1CO1)OO(1947)',
    structure = SMILES('CC(C[C]1CO1)OO'),
    E0 = (-71.8517,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1310,387.5,850,1000,2750,3150,900,1100,1380,1390,370,380,2900,435,200,800,914.286,1028.57,1142.86,1257.14,1371.43,1485.71,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (117.123,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.191152,0.084095,-8.22023e-05,4.03897e-08,-5.6467e-12,-8504.63,29.1675], Tmin=(100,'K'), Tmax=(788.248,'K')), NASAPolynomial(coeffs=[12.6234,0.0340742,-1.18815e-05,1.94646e-09,-1.24266e-13,-10870.5,-30.4279], Tmin=(788.248,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-71.8517,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(C2CsJO)"""),
)
...
species(
    label = 'OO[CH]CC1CO1(1949)',
    structure = SMILES('OO[CH]CC1CO1'),
    E0 = (-26.9508,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3025,407.5,1350,352.5,3615,1310,387.5,850,1000,2750,2950,3150,900,1000,1100,200,800,900,1000,1100,1200,1300,1400,1500,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'C[C](CC1CO1)OO(1950)',
    structure = SMILES('C[C](CC1CO1)OO'),
    E0 = (-65.0573,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2950,3150,900,1000,1100,2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350,3615,1310,387.5,850,1000,2750,2850,1437.5,1250,1305,750,350,200,800,900,1000,1100,1200,1300,1400,1500,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (117.123,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0907171,0.083615,-8.47193e-05,4.9796e-08,-1.19337e-11,-7681.83,28.6915], Tmin=(100,'K'), Tmax=(1012.38,'K')), NASAPolynomial(coeffs=[12.4915,0.0346158,-1.21156e-05,1.98304e-09,-1.26088e-13,-10192.6,-31.2873], Tmin=(1012.38,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-65.0573,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(C2CsJOOH)"""),
)

species(
    label = 'CC([CH]C1CO1)OO(1951)',
    structure = SMILES('CC([CH]C1CO1)OO'),
    E0 = (-51.5415,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2950,3150,900,1000,1100,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,200,800,900,1000,1100,1200,1300,1400,1500,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (117.123,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.08771,0.081758,-7.0418e-05,2.69144e-08,-1.41111e-12,-6054.04,30.719], Tmin=(100,'K'), Tmax=(875.293,'K')), NASAPolynomial(coeffs=[14.7724,0.0305481,-9.90273e-06,1.57313e-09,-9.98046e-14,-9233.7,-41.6487], Tmin=(875.293,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-51.5415,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CCJCOOH)"""),
)

species(
    label = 'CC(CC1[CH]O1)OO(1952)',
    ...
    molecularWeight = (117.123,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.739707,0.0904984,-8.95202e-05,4.64606e-08,-9.32118e-12,-8024.27,31.5783], Tmin=(100,'K'), Tmax=(1347.32,'K')), NASAPolynomial(coeffs=[19.3612,0.023035,-5.74281e-06,7.17279e-10,-3.74267e-14,-12734,-68.7666], Tmin=(1347.32,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-68.234,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CCsJO)"""),
)

species(
    label = '[CH2]C(CC1CO1)OO(1953)',
    structure = SMILES('[CH2]C(CC1CO1)OO'),
    E0 = (-37.9939,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,1380,1390,370,380,2900,435,3615,1310,387.5,850,1000,3000,3100,440,815,1455,1000,2750,2950,3150,900,1000,1100,200,800,900,1000,1100,1200,1300,1400,1500,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'OOCCC1CO1(1954)',
    structure = SMILES('OOCCC1CO1'),
    E0 = (-215.533,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3615,1310,387.5,850,1000,2750,2950,3150,900,1000,1100,200,800,900,1000,1100,1200,1300,1400,1500,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.366339,0.0713059,-6.67406e-05,3.47851e-08,-7.18233e-12,-25784.5,25.5056], Tmin=(100,'K'), Tmax=(1282.31,'K')), NASAPolynomial(coeffs=[13.8509,0.0247301,-6.97966e-06,9.71506e-10,-5.50116e-14,-28871.8,-41.4564], Tmin=(1282.31,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-215.533,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + ring(Ethylene_oxide)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['OH(5)', 'CC([O])CC1CO1(1944)'],
    products = ['CC(CC1CO1)OO(1801)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['HO2(10)', 'C[CH]CC1CO1(1945)'],
    products = ['CC(CC1CO1)OO(1801)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'CC(CC1CO1)O[O](1946)'],
    products = ['CC(CC1CO1)OO(1801)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['cC2H3O(58)', 'QOOH_3(717)'],
    products = ['CC(CC1CO1)OO(1801)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)', 'CC(C[C]1CO1)OO(1947)'],
    products = ['CC(CC1CO1)OO(1801)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['CH3CHOOH(63)', 'oxiranylmethyl(1948)'],
    products = ['CC(CC1CO1)OO(1801)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['CH3(17)', 'OO[CH]CC1CO1(1949)'],
    products = ['CC(CC1CO1)OO(1801)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(3)', 'C[C](CC1CO1)OO(1950)'],
    products = ['CC(CC1CO1)OO(1801)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(6.68468e+06,'m^3/(mol*s)'), n=-0.0135, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [C_rad/NonDe;Y_rad] for rate rule [C_rad/NonDeCO;H_rad]
Euclidian distance = 2.2360679775
...
reaction(
    label = 'reaction9',
    reactants = ['H(3)', 'CC([CH]C1CO1)OO(1951)'],
    products = ['CC(CC1CO1)OO(1801)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(3)', 'CC(CC1[CH]O1)OO(1952)'],
    products = ['CC(CC1CO1)OO(1801)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(3)', '[CH2]C(CC1CO1)OO(1953)'],
    products = ['CC(CC1CO1)OO(1801)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CH2(S)(23)', 'OOCCC1CO1(1954)'],
    products = ['CC(CC1CO1)OO(1801)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2]O[CH]CC(C)OO(1955)'],
    products = ['CC(CC1CO1)OO(1801)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]C([O])CC(C)OO(1956)'],
    products = ['CC(CC1CO1)OO(1801)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CH2(S)(23)', 'CC(CC=O)OO(1957)'],
    products = ['CC(CC1CO1)OO(1801)'],
...
reaction(
    label = 'reaction17',
    reactants = ['O(S)(102)', 'C=CCC(C)OO(1790)'],
    products = ['CC(CC1CO1)OO(1801)'],
