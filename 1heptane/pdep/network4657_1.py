species(
    label = 'C[CH]OO[C](CCCC)CCOO(28737)',
    structure = SMILES('C[CH]OO[C](CCCC)CCOO'),
    E0 = (-70.0955,'kJ/mol'),
    modes = [
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.2758,0.159258,-0.000139395,7.73146e-09,5.71426e-11,-8225.38,49.9975], Tmin=(100,'K'), Tmax=(527.09,'K')), NASAPolynomial(coeffs=[10.9581,0.0923929,-4.46297e-05,8.68596e-09,-6.12322e-13,-10086.7,-9.79662], Tmin=(527.09,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-70.0955,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(706.73,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCsJOOC) + radical(C2CsJOOC)"""),
)
...
species(
    label = 'C[CH]OOC(=CCCC)CCOO(28740)',
    structure = SMILES('C[CH]OOC(=CCCC)CCOO'),
    E0 = (-128.542,'kJ/mol'),
    modes = [
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.51254,0.154935,-0.00016064,9.81403e-08,-2.58226e-11,-15235.5,52.4056], Tmin=(100,'K'), Tmax=(895.029,'K')), NASAPolynomial(coeffs=[13.7111,0.0824294,-3.91272e-05,7.63085e-09,-5.41459e-13,-18139.6,-24.0648], Tmin=(895.029,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-128.542,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(685.944,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + radical(CCsJOOC)"""),
)

species(
    label = 'C[CH]OOC(=CCOO)CCCC(28741)',
    structure = SMILES('C[CH]OOC(=CCOO)CCCC'),
    E0 = (-122.985,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3010,987.5,1337.5,450,1655,3615,1310,387.5,850,1000,350,440,435,1725,350,500,795,815,2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (189.229,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.45335,0.154056,-0.000162274,1.02855e-07,-2.82757e-11,-14569.8,52.5782], Tmin=(100,'K'), Tmax=(857.011,'K')), NASAPolynomial(coeffs=[12.5019,0.0842555,-4.01082e-05,7.82493e-09,-5.55064e-13,-17133.3,-17.2648], Tmin=(857.011,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-122.985,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(685.944,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + radical(CCsJOOC)"""),
)

species(
    label = 'C=COO[C](CCCC)CCOO(28742)',
    structure = SMILES('C=COO[C](CCCC)CCOO'),
    E0 = (-113.619,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,360,370,350,2750,2761.11,2772.22,2783.33,2794.44,2805.56,2816.67,2827.78,2838.89,2850,1425,1431.25,1437.5,1443.75,1450,1225,1237.5,1250,1262.5,1275,1270,1287.5,1305,1322.5,1340,700,725,750,775,800,300,325,350,375,400,350,500,795,815,3615,1310,387.5,850,1000,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (189.229,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.74351,0.159862,-0.00017039,1.05859e-07,-2.80408e-11,-13432.2,51.8645], Tmin=(100,'K'), Tmax=(893.928,'K')), NASAPolynomial(coeffs=[14.8205,0.0812667,-3.8502e-05,7.49756e-09,-5.31419e-13,-16572.3,-30.9018], Tmin=(893.928,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-113.619,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(685.944,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C2CsJOOC)"""),
)
...
species(
    label = 'C=C(CCOO)OO[CH]C(28743)',
    structure = SMILES('C=C(CCOO)OO[CH]C'),
    E0 = (-46.0909,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,2950,3100,1380,975,1025,1650,3615,1310,387.5,850,1000,350,440,435,1725,350,500,795,815,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.870805,0.116404,-0.000137463,9.59633e-08,-2.84254e-11,-5376.32,39.537], Tmin=(100,'K'), Tmax=(806.824,'K')), NASAPolynomial(coeffs=[11.0085,0.057508,-2.79654e-05,5.4847e-09,-3.89385e-13,-7293.18,-15.2237], Tmin=(806.824,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-46.0909,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(473.925,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(CCsJOOC)"""),
)
...
species(
    label = 'C=C(CCCC)OO[CH]C(28744)',
    structure = SMILES('C=C(CCCC)OO[CH]C'),
    E0 = (-5.32891,'kJ/mol'),
    modes = [
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.606398,0.107817,-8.49383e-05,3.71988e-08,-7.12042e-12,-480.703,39.5883], Tmin=(100,'K'), Tmax=(1173.31,'K')), NASAPolynomial(coeffs=[12.137,0.0643728,-2.93987e-05,5.64178e-09,-3.96544e-13,-3471.11,-23.9278], Tmin=(1173.31,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-5.32891,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(573.699,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(CCsJOOC)"""),
)

species(
    label = 'C[CH]OOC([CH]CCC)CCOO(28745)',
    structure = SMILES('C[CH]OOC([CH]CCC)CCOO'),
    E0 = (-55.7006,'kJ/mol'),
    modes = [
...
species(
    label = 'C[CH]OOC([CH]COO)CCCC(28746)',
    structure = SMILES('C[CH]OOC([CH]COO)CCCC'),
    E0 = (-55.7006,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3050,390,425,1340,1360,335,370,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3615,1310,387.5,850,1000,2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,350,500,795,815,1380,1390,370,380,2900,435,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2]COO[C](CCCC)CCOO(28747)',
    structure = SMILES('[CH2]COO[C](CCCC)CCOO'),
    E0 = (-42.5737,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (190.237,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.84987,0.168284,-0.000182311,9.71336e-08,-9.17143e-12,-4890.32,53.6402], Tmin=(100,'K'), Tmax=(589.772,'K')), NASAPolynomial(coeffs=[12.235,0.0897925,-4.32561e-05,8.42461e-09,-5.9482e-13,-7083.88,-14.6824], Tmin=(589.772,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-42.5737,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(706.73,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(C2CsJOOC) + radical(CJCOOH)"""),
)

species(
    label = 'C[CH]OOC(C[CH]CC)CCOO(28748)',
    structure = SMILES('C[CH]OOC(C[CH]CC)CCOO'),
    E0 = (-61.6573,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3050,390,425,1340,1360,335,370,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3615,1310,387.5,850,1000,2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,350,500,795,815,1380,1390,370,380,2900,435,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (190.237,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.03964,0.154119,-0.00012424,-1.71119e-08,7.40829e-11,-7219.23,51.8085], Tmin=(100,'K'), Tmax=(517.687,'K')), NASAPolynomial(coeffs=[10.4961,0.0918352,-4.39577e-05,8.51882e-09,-5.98985e-13,-8980.47,-4.89092], Tmin=(517.687,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-61.6573,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(706.73,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCsJOOC) + radical(RCCJCC)"""),
)

species(
    label = 'C[CH]OOC(C[CH]OO)CCCC(28749)',
    structure = SMILES('C[CH]OOC(C[CH]OO)CCCC'),
    E0 = (-67.5331,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3050,390,425,1340,1360,335,370,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3615,1310,387.5,850,1000,2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,350,500,795,815,1380,1390,370,380,2900,435,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (190.237,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-3.18616,0.171129,-0.000196726,1.35744e-07,-3.99858e-11,-7875.22,53.2882], Tmin=(100,'K'), Tmax=(809.499,'K')), NASAPolynomial(coeffs=[13.7395,0.0874964,-4.17607e-05,8.12583e-09,-5.74473e-13,-10615.6,-24.7918], Tmin=(809.499,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-67.5331,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(706.73,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCsJOOC) + radical(CCsJOOH)"""),
)

species(
    label = 'C[CH]CCC(CCOO)OO[CH]C(28750)',
    structure = SMILES('C[CH]CCC(CCOO)OO[CH]C'),
    E0 = (-61.6693,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3050,390,425,1340,1360,335,370,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3615,1310,387.5,850,1000,2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,350,500,795,815,1380,1390,370,380,2900,435,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'CCC[CH][C](CCOO)OOCC(28751)',
    structure = SMILES('CCC[CH][C](CCOO)OOCC'),
    E0 = (-56.1213,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,360,370,350,2750,2761.11,2772.22,2783.33,2794.44,2805.56,2816.67,2827.78,2838.89,2850,1425,1431.25,1437.5,1443.75,1450,1225,1237.5,1250,1262.5,1275,1270,1287.5,1305,1322.5,1340,700,725,750,775,800,300,325,350,375,400,350,500,795,815,3615,1310,387.5,850,1000,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (190.237,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.20223,0.158327,-0.000134022,-7.95462e-09,7.09216e-11,-6548.16,51.7664], Tmin=(100,'K'), Tmax=(518.495,'K')), NASAPolynomial(coeffs=[10.9921,0.0919554,-4.44744e-05,8.6536e-09,-6.09606e-13,-8392.49,-7.81328], Tmin=(518.495,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-56.1213,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(706.73,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(C2CsJOOC) + radical(CCJCOOH)"""),
)

species(
    label = 'CCCC[C]([CH]COO)OOCC(28752)',
    structure = SMILES('CCCC[C]([CH]COO)OOCC'),
    E0 = (-56.1213,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,360,370,350,2750,2761.11,2772.22,2783.33,2794.44,2805.56,2816.67,2827.78,2838.89,2850,1425,1431.25,1437.5,1443.75,1450,1225,1237.5,1250,1262.5,1275,1270,1287.5,1305,1322.5,1340,700,725,750,775,800,300,325,350,375,400,350,500,795,815,3615,1310,387.5,850,1000,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2][CH]OOC(CCCC)CCOO(28753)',
    structure = SMILES('[CH2][CH]OOC(CCCC)CCOO'),
    E0 = (-42.153,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (190.237,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-3.17717,0.170173,-0.000189677,1.23706e-07,-3.42151e-11,-4822.09,55.103], Tmin=(100,'K'), Tmax=(860.936,'K')), NASAPolynomial(coeffs=[15.3186,0.0842399,-3.99572e-05,7.77036e-09,-5.49826e-13,-8006.84,-31.3592], Tmin=(860.936,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-42.153,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(706.73,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJCOOH) + radical(CCsJOOC)"""),
)

species(
    label = '[CH2]CCCC(CCOO)OO[CH]C(28754)',
    structure = SMILES('[CH2]CCCC(CCOO)OO[CH]C'),
    E0 = (-50.8692,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1310,387.5,850,1000,2750,2761.11,2772.22,2783.33,2794.44,2805.56,2816.67,2827.78,2838.89,2850,1425,1431.25,1437.5,1443.75,1450,1225,1237.5,1250,1262.5,1275,1270,1287.5,1305,1322.5,1340,700,725,750,775,800,300,325,350,375,400,350,500,795,815,3000,3100,440,815,1455,1000,1380,1390,370,380,2900,435,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'C[CH]OOC(CCCC)CCO[O](28755)',
    structure = SMILES('C[CH]OOC(CCCC)CCO[O]'),
    E0 = (-104.111,'kJ/mol'),
    modes = [
...
species(
    label = 'CC[CH]C[C](CCOO)OOCC(28756)',
    structure = SMILES('CC[CH]C[C](CCOO)OOCC'),
    E0 = (-62.0779,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,360,370,350,2750,2761.11,2772.22,2783.33,2794.44,2805.56,2816.67,2827.78,2838.89,2850,1425,1431.25,1437.5,1443.75,1450,1225,1237.5,1250,1262.5,1275,1270,1287.5,1305,1322.5,1340,700,725,750,775,800,300,325,350,375,400,350,500,795,815,3615,1310,387.5,850,1000,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (190.237,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-3.33313,0.177655,-0.000246602,2.16203e-07,-7.83801e-11,-7217.98,55.8205], Tmin=(100,'K'), Tmax=(788.004,'K')), NASAPolynomial(coeffs=[8.14339,0.0959156,-4.63045e-05,8.92933e-09,-6.22536e-13,-8297.58,7.81355], Tmin=(788.004,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-62.0779,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(706.73,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(C2CsJOOC) + radical(RCCJCC)"""),
)

species(
    label = 'CCCC[C](C[CH]OO)OOCC(28757)',
    structure = SMILES('CCCC[C](C[CH]OO)OOCC'),
    E0 = (-67.9537,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,360,370,350,2750,2761.11,2772.22,2783.33,2794.44,2805.56,2816.67,2827.78,2838.89,2850,1425,1431.25,1437.5,1443.75,1450,1225,1237.5,1250,1262.5,1275,1270,1287.5,1305,1322.5,1340,700,725,750,775,800,300,325,350,375,400,350,500,795,815,3615,1310,387.5,850,1000,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (190.237,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.18945,0.158398,-0.000131004,-1.65654e-08,7.81985e-11,-7972.16,49.5772], Tmin=(100,'K'), Tmax=(514.77,'K')), NASAPolynomial(coeffs=[10.967,0.0924745,-4.47086e-05,8.6937e-09,-6.12078e-13,-9807.74,-9.8313], Tmin=(514.77,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-67.9537,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(706.73,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(C2CsJOOC) + radical(CCsJOOH)"""),
)

species(
    label = 'C[CH]CC[C](CCOO)OOCC(28758)',
    structure = SMILES('C[CH]CC[C](CCOO)OOCC'),
    E0 = (-62.0899,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,360,370,350,2750,2761.11,2772.22,2783.33,2794.44,2805.56,2816.67,2827.78,2838.89,2850,1425,1431.25,1437.5,1443.75,1450,1225,1237.5,1250,1262.5,1275,1270,1287.5,1305,1322.5,1340,700,725,750,775,800,300,325,350,375,400,350,500,795,815,3615,1310,387.5,850,1000,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (190.237,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.11491,0.139577,-3.12711e-05,-2.67195e-07,2.99081e-10,-7312.11,48.605], Tmin=(100,'K'), Tmax=(443.287,'K')), NASAPolynomial(coeffs=[9.57755,0.0933188,-4.46937e-05,8.58519e-09,-5.96969e-13,-8753.54,0.152795], Tmin=(443.287,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-62.0899,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(706.73,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(C2CsJOOC) + radical(RCCJC)"""),
)

species(
    label = '[CH2]CCC[C](CCOO)OOCC(28759)',
    structure = SMILES('[CH2]CCC[C](CCOO)OOCC'),
    E0 = (-51.2899,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350,2750,2759.09,2768.18,2777.27,2786.36,2795.45,2804.55,2813.64,2822.73,2831.82,2840.91,2850,1425,1430,1435,1440,1445,1450,1225,1235,1245,1255,1265,1275,1270,1284,1298,1312,1326,1340,700,720,740,760,780,800,300,320,340,360,380,400,350,500,795,815,3000,3100,440,815,1455,1000,3615,1310,387.5,850,1000,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (190.237,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.48569,0.162118,-0.00015763,5.10274e-08,2.28749e-11,-5953.9,52.1826], Tmin=(100,'K'), Tmax=(553.04,'K')), NASAPolynomial(coeffs=[11.2799,0.0914182,-4.41548e-05,8.60673e-09,-6.07818e-13,-7917.87,-10.0654], Tmin=(553.04,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-51.2899,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(706.73,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(C2CsJOOC) + radical(RCCJ)"""),
)

species(
    label = 'CCCC[C](CCO[O])OOCC(28760)',
    structure = SMILES('CCCC[C](CCO[O])OOCC'),
    E0 = (-104.532,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (190.237,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.8413,0.150499,-0.000109449,-4.99468e-08,1.0056e-10,-12384,48.9641], Tmin=(100,'K'), Tmax=(504.008,'K')), NASAPolynomial(coeffs=[10.2688,0.0913662,-4.3513e-05,8.40534e-09,-5.89464e-13,-14074.4,-5.82224], Tmin=(504.008,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-104.532,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(710.887,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(C2CsJOOC) + radical(ROOJ)"""),
)
...
species(
    label = 'CCCC=C(CCOO)OOCC(28761)',
    structure = SMILES('CCCC=C(CCOO)OOCC'),
    E0 = (-314.983,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (190.237,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.44196,0.152294,-0.000144277,7.86834e-08,-1.85348e-11,-37660.6,51.8488], Tmin=(100,'K'), Tmax=(987.888,'K')), NASAPolynomial(coeffs=[14.699,0.0828879,-3.88894e-05,7.56246e-09,-5.36234e-13,-41047.2,-30.6372], Tmin=(987.888,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-314.983,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(710.887,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH)"""),
)

species(
    label = 'CCCCC(=CCOO)OOCC(28762)',
    structure = SMILES('CCCCC(=CCOO)OOCC'),
    E0 = (-309.426,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (190.237,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.34497,0.150923,-0.000143993,8.06387e-08,-1.96922e-11,-36996.4,51.8891], Tmin=(100,'K'), Tmax=(951.531,'K')), NASAPolynomial(coeffs=[13.3445,0.0849684,-4.002e-05,7.7924e-09,-5.52844e-13,-39982.2,-23.024], Tmin=(951.531,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-309.426,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(710.887,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH)"""),
)

species(
    label = 'C=COOC(CCCC)CCOO(28763)',
...
species(
    label = 'C[CH]OOC1(CCCC)CCO1(28764)',
    structure = SMILES('C[CH]OOC1(CCCC)CCO1'),
    E0 = (-195.928,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (173.229,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.83829,0.126971,-5.21397e-05,-3.62975e-08,2.76045e-11,-23297.1,45.6201], Tmin=(100,'K'), Tmax=(939.683,'K')), NASAPolynomial(coeffs=[30.073,0.0449354,-1.38661e-05,2.30085e-09,-1.57644e-13,-32045.7,-124.75], Tmin=(939.683,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-195.928,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(673.472,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsOsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Oxetane) + radical(CCsJOOC)"""),
)

species(
    label = '[CH2]C(CCC)(CCOO)OO[CH]C(28765)',
    structure = SMILES('[CH2]C(CCC)(CCOO)OO[CH]C'),
    E0 = (-53.4423,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3615,1310,387.5,850,1000,2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,350,500,795,815,3000,3100,440,815,1455,1000,200,800,900,1000,1100,1200,1300,1400,1500,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (190.237,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-3.46822,0.17543,-0.00019862,1.28316e-07,-3.46251e-11,-6168.31,53.9108], Tmin=(100,'K'), Tmax=(887.236,'K')), NASAPolynomial(coeffs=[17.6709,0.0801272,-3.74961e-05,7.24741e-09,-5.11134e-13,-9919.38,-45.5439], Tmin=(887.236,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-53.4423,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(706.73,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCsJOOC) + radical(CJCOOH)"""),
)

species(
    label = '[CH2]C(CCCC)(COO)OO[CH]C(28766)',
    structure = SMILES('[CH2]C(CCCC)(COO)OO[CH]C'),
    E0 = (-56.7895,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3615,1310,387.5,850,1000,2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,350,500,795,815,3000,3100,440,815,1455,1000,200,800,900,1000,1100,1200,1300,1400,1500,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (190.237,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-3.46822,0.17543,-0.00019862,1.28316e-07,-3.46251e-11,-6570.89,53.9108], Tmin=(100,'K'), Tmax=(887.236,'K')), NASAPolynomial(coeffs=[17.6709,0.0801272,-3.74961e-05,7.24741e-09,-5.11134e-13,-10322,-45.5439], Tmin=(887.236,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-56.7895,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(706.73,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJCOOH) + radical(CCsJOOC)"""),
)
...
species(
    label = 'C[CH]OOC(O)(CC[O])CCCC(28767)',
    structure = SMILES('C[CH]OOC(O)(CC[O])CCCC'),
    E0 = (-314.083,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (190.237,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-3.52447,0.165141,-0.000159277,8.15044e-08,-1.70077e-11,-37504.1,54.2459], Tmin=(100,'K'), Tmax=(1143.51,'K')), NASAPolynomial(coeffs=[24.9037,0.0656997,-2.88352e-05,5.45697e-09,-3.8183e-13,-44005.7,-86.7158], Tmin=(1143.51,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-314.083,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(710.887,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(CCsJOOC)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['C[CH]OO[C](CCCC)CCOO(28737)'],
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'C[CH]OOC(=CCCC)CCOO(28740)'],
    products = ['C[CH]OO[C](CCCC)CCOO(28737)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'C[CH]OOC(=CCOO)CCCC(28741)'],
    products = ['C[CH]OO[C](CCCC)CCOO(28737)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(137.12,'m^3/(mol*s)'), n=1.63155, Ea=(4.2466,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Cds-CsH_Cds;HJ] for rate rule [Cds-CsH_Cds-OsCs;HJ]
Euclidian distance = 1.0
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', 'C=COO[C](CCCC)CCOO(28742)'],
    products = ['C[CH]OO[C](CCCC)CCOO(28737)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['npropyl(83)', 'C=C(CCOO)OO[CH]C(28743)'],
    products = ['C[CH]OO[C](CCCC)CCOO(28737)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['CH2OOH(35)', 'C=C(CCCC)OO[CH]C(28744)'],
    products = ['C[CH]OO[C](CCCC)CCOO(28737)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['C[CH]OOC([CH]CCC)CCOO(28745)'],
    products = ['C[CH]OO[C](CCCC)CCOO(28737)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['C[CH]OOC([CH]COO)CCCC(28746)'],
    products = ['C[CH]OO[C](CCCC)CCOO(28737)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(1557.48,'s^-1'), n=2.79033, Ea=(132.312,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R2H_S;C_rad_out_H/NonDeC;Cs_H_out] for rate rule [R2H_S;C_rad_out_H/NonDeC;Cs_H_out_OOH/Cs]
Euclidian distance = 2.0
...
reaction(
    label = 'reaction9',
    reactants = ['C[CH]OO[C](CCCC)CCOO(28737)'],
    products = ['[CH2]COO[C](CCCC)CCOO(28747)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['C[CH]OOC(C[CH]CC)CCOO(28748)'],
    products = ['C[CH]OO[C](CCCC)CCOO(28737)'],
...
reaction(
    label = 'reaction11',
    reactants = ['C[CH]OOC(C[CH]OO)CCCC(28749)'],
    products = ['C[CH]OO[C](CCCC)CCOO(28737)'],
...
reaction(
    label = 'reaction12',
    reactants = ['C[CH]CCC(CCOO)OO[CH]C(28750)'],
    products = ['C[CH]OO[C](CCCC)CCOO(28737)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CCC[CH][C](CCOO)OOCC(28751)'],
    products = ['C[CH]OO[C](CCCC)CCOO(28737)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CCCC[C]([CH]COO)OOCC(28752)'],
    products = ['C[CH]OO[C](CCCC)CCOO(28737)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2][CH]OOC(CCCC)CCOO(28753)'],
    products = ['C[CH]OO[C](CCCC)CCOO(28737)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]CCCC(CCOO)OO[CH]C(28754)'],
    products = ['C[CH]OO[C](CCCC)CCOO(28737)'],
...
reaction(
    label = 'reaction17',
    reactants = ['C[CH]OOC(CCCC)CCO[O](28755)'],
    products = ['C[CH]OO[C](CCCC)CCOO(28737)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CC[CH]C[C](CCOO)OOCC(28756)'],
    products = ['C[CH]OO[C](CCCC)CCOO(28737)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CCCC[C](C[CH]OO)OOCC(28757)'],
    products = ['C[CH]OO[C](CCCC)CCOO(28737)'],
    transitionState = 'TS19',
    kinetics = Arrhenius(A=(9.4e-19,'s^-1'), n=8.84, Ea=(125.52,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2500,'K'), comment="""Estimated using template [RnH;C_rad_out_H/NonDeO;Cs_H_out_H/NonDeC] for rate rule [R6HJ_2;C_rad_out_H/NonDeO;Cs_H_out_H/NonDeC]
Euclidian distance = 2.0
Multiplied by reaction path degeneracy 2.0
family: intra_H_migration"""),
)
...
reaction(
    label = 'reaction20',
    reactants = ['C[CH]CC[C](CCOO)OOCC(28758)'],
    products = ['C[CH]OO[C](CCCC)CCOO(28737)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH2]CCC[C](CCOO)OOCC(28759)'],
    products = ['C[CH]OO[C](CCCC)CCOO(28737)'],
...
reaction(
    label = 'reaction22',
    reactants = ['C[CH]OO[C](CCCC)CCOO(28737)'],
    products = ['CCCC[C](CCO[O])OOCC(28760)'],
...
reaction(
    label = 'reaction24',
    reactants = ['C[CH]OO[C](CCCC)CCOO(28737)'],
    products = ['CCCC=C(CCOO)OOCC(28761)'],
...
reaction(
    label = 'reaction25',
    reactants = ['C[CH]OO[C](CCCC)CCOO(28737)'],
    products = ['CCCCC(=CCOO)OOCC(28762)'],
...
reaction(
    label = 'reaction26',
    reactants = ['C[CH]OO[C](CCCC)CCOO(28737)'],
    products = ['C=COOC(CCCC)CCOO(28763)'],
...
reaction(
    label = 'reaction28',
    reactants = ['C[CH]OO[C](CCCC)CCOO(28737)'],
    products = ['OH(5)', 'C[CH]OOC1(CCCC)CCO1(28764)'],
...
reaction(
    label = 'reaction29',
    reactants = ['[CH2]C(CCC)(CCOO)OO[CH]C(28765)'],
    products = ['C[CH]OO[C](CCCC)CCOO(28737)'],
...
reaction(
    label = 'reaction30',
    reactants = ['[CH2]C(CCCC)(COO)OO[CH]C(28766)'],
    products = ['C[CH]OO[C](CCCC)CCOO(28737)'],
...
reaction(
    label = 'reaction32',
    reactants = ['C[CH]OO[C](CCCC)CCOO(28737)'],
    products = ['C[CH]OOC(O)(CC[O])CCCC(28767)'],
...
reaction(
    label = 'reaction33',
    reactants = ['C[CH]O[O](97)', 'CCCC[C]CCOO(28384)'],
    products = ['C[CH]OO[C](CCCC)CCOO(28737)'],
...
reaction(
    label = 'reaction34',
    reactants = ['CHCH3(T)(95)', 'CCCC[C](CCOO)O[O](28369)'],
    products = ['C[CH]OO[C](CCCC)CCOO(28737)'],
