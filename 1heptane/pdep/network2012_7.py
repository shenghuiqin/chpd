...
species(
    label = '[CH2]CC(O)C(=C)[O](11049)',
    structure = SMILES('[CH2]CC(O)C(=C)[O]'),
    E0 = (-84.6161,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2950,3100,1380,975,1025,1650,1380,1390,370,380,2900,435,350,440,435,1725,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,458.647,459.169,460.617],'cm^-1')),
        HinderedRotor(inertia=(0.000803549,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0522011,'amu*angstrom^2'), symmetry=1, barrier=(7.90008,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0516811,'amu*angstrom^2'), symmetry=1, barrier=(7.89209,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.052853,'amu*angstrom^2'), symmetry=1, barrier=(7.88464,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (100.116,'amu'),
...
species(
    label = '[CH]=C([O])C(O)CC(11050)',
    structure = SMILES('[CH]=C([O])C(O)CC'),
    E0 = (-42.7663,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1277.5,1000,1380,1390,370,380,2900,435,350,440,435,1725,2750,2850,1437.5,1250,1305,750,350,330.98,331.166],'cm^-1')),
        HinderedRotor(inertia=(0.00153611,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.126064,'amu*angstrom^2'), symmetry=1, barrier=(9.80512,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.126006,'amu*angstrom^2'), symmetry=1, barrier=(9.80273,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.125986,'amu*angstrom^2'), symmetry=1, barrier=(9.80387,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.478686,0.0693494,-5.7795e-05,2.03237e-08,-1.29526e-12,-5009.73,30.1894], Tmin=(100,'K'), Tmax=(1011.96,'K')), NASAPolynomial(coeffs=[16.3807,0.0209589,-7.50953e-06,1.32219e-09,-9.07985e-14,-8968.86,-50.3773], Tmin=(1011.96,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-42.7663,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(C=C(C)OJ) + radical(Cds_P)"""),
)
...
species(
    label = 'CCC([O])[C]1CO1(11051)',
    structure = SMILES('CCC([O])[C]1CO1'),
    E0 = (87.0041,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (100.116,'amu'),
...
species(
    label = '[CH2]CC([O])C(C)=O(11054)',
    structure = SMILES('[CH2]CC([O])C(C)=O'),
    E0 = (-2.87631,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,375,552.5,462.5,1710,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,180,932.561,4000],'cm^-1')),
        HinderedRotor(inertia=(0.109298,'amu*angstrom^2'), symmetry=1, barrier=(2.51297,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.109422,'amu*angstrom^2'), symmetry=1, barrier=(2.51583,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.109724,'amu*angstrom^2'), symmetry=1, barrier=(2.52276,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0302232,'amu*angstrom^2'), symmetry=1, barrier=(18.6568,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.0384,0.0580543,-4.08833e-05,1.46549e-08,-2.13303e-12,-233.578,31.2511], Tmin=(100,'K'), Tmax=(1596.93,'K')), NASAPolynomial(coeffs=[14.1299,0.0252624,-1.00816e-05,1.79609e-09,-1.19972e-13,-4414.81,-38.0358], Tmin=(1596.93,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-2.87631,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-O2d)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)HHH) + group(Cds-OdCsCs) + radical(RCCJ) + radical(C=OCOJ)"""),
)

species(
    label = '[CH2][C]1OOC1CC(11055)',
    structure = SMILES('[CH2][C]1OOC1CC'),
    E0 = (288.248,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.58103,0.0583657,-4.35395e-05,1.91834e-08,-3.92826e-12,34751,21.9177], Tmin=(100,'K'), Tmax=(1059.05,'K')), NASAPolynomial(coeffs=[6.20099,0.0409159,-1.88239e-05,3.62474e-09,-2.55409e-13,33772.5,-0.635913], Tmin=(1059.05,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(288.248,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(12dioxetane) + radical(C2CsJOO) + radical(CJCOOH)"""),
)
...
species(
    label = '[CH2]C(=C[O])OCC(11056)',
    structure = SMILES('[CH2]C(=C[O])OCC'),
    E0 = (-135.712,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,350,440,435,1725,336.278,336.29,336.3,336.331],'cm^-1')),
        HinderedRotor(inertia=(0.237493,'amu*angstrom^2'), symmetry=1, barrier=(19.0659,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.237422,'amu*angstrom^2'), symmetry=1, barrier=(19.0648,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.23756,'amu*angstrom^2'), symmetry=1, barrier=(19.0652,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.237544,'amu*angstrom^2'), symmetry=1, barrier=(19.0654,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.256447,0.0657537,-2.09045e-05,-3.5612e-08,2.30249e-11,-16172.3,26.0842], Tmin=(100,'K'), Tmax=(927.226,'K')), NASAPolynomial(coeffs=[22.8095,0.011152,-1.63609e-06,1.89261e-10,-1.60075e-14,-22189.8,-90.9132], Tmin=(927.226,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-135.712,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + radical(C=C(O)CJ) + radical(C=COJ)"""),
)
...
species(
    label = 'CC=COC[C]=O(11032)',
    structure = SMILES('CC=COC[C]=O'),
    E0 = (-133.451,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,1855,455,950,2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.859062,'amu*angstrom^2'), symmetry=1, barrier=(19.7515,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.859272,'amu*angstrom^2'), symmetry=1, barrier=(19.7563,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.859592,'amu*angstrom^2'), symmetry=1, barrier=(19.7637,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.859445,'amu*angstrom^2'), symmetry=1, barrier=(19.7603,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.734958,0.0577348,-1.87185e-05,-2.59315e-08,1.64e-11,-15920.1,25.0965], Tmin=(100,'K'), Tmax=(960.895,'K')), NASAPolynomial(coeffs=[19.0698,0.0150998,-4.75321e-06,8.6616e-10,-6.49285e-14,-20999,-70.72], Tmin=(960.895,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-133.451,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-O2d)OsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-OdCsH) + radical(CsCJ=O)"""),
)
...
species(
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.337,0.062874,-5.29713e-05,2.53527e-08,-5.31617e-12,-367.747,27.4726], Tmin=(100,'K'), Tmax=(1084.23,'K')), NASAPolynomial(coeffs=[8.36051,0.0369628,-1.71242e-05,3.31143e-09,-2.33979e-13,-1890.78,-6.97986], Tmin=(1084.23,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-3.8248,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-O2d)OsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(RCCJ) + radical(CsCJ=O)"""),
)
...
species(
    label = '[CH2]C[CH]OCC=O(11035)',
    structure = SMILES('[CH2]C[CH]OCC=O'),
    E0 = (21.9603,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.820742,0.071509,-6.97398e-05,3.71076e-08,-8.16046e-12,2754.4,28.0895], Tmin=(100,'K'), Tmax=(1080.59,'K')), NASAPolynomial(coeffs=[11.6959,0.0312529,-1.38592e-05,2.63235e-09,-1.84451e-13,404.086,-25.2196], Tmin=(1080.59,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(21.9603,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-O2d)OsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(CCsJOCs) + radical(RCCJ)"""),
)
...
species(
    label = 'C[CH]OC[C]=O(1087)',
    structure = SMILES('C[CH]OC[C]=O'),
    E0 = (-4.8349,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,1855,455,950,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,180,180,790.381],'cm^-1')),
        HinderedRotor(inertia=(0.00859068,'amu*angstrom^2'), symmetry=1, barrier=(3.81312,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.645594,'amu*angstrom^2'), symmetry=1, barrier=(14.8435,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.645831,'amu*angstrom^2'), symmetry=1, barrier=(14.8489,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.10217,'amu*angstrom^2'), symmetry=1, barrier=(14.8501,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.45154,0.0567119,-5.62564e-05,2.99659e-08,-6.53082e-12,-490.259,22.4708], Tmin=(100,'K'), Tmax=(1096,'K')), NASAPolynomial(coeffs=[10.6799,0.0230313,-1.01603e-05,1.92659e-09,-1.3494e-13,-2513.11,-22.8968], Tmin=(1096,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-4.8349,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsOsHH) + group(Cs-(Cds-O2d)OsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(CCsJOCs) + radical(CsCJ=O)"""),
)

species(
    label = '[CH2]C(C)OC[C]=O(3343)',
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.826005,0.0740523,-7.93769e-05,4.83666e-08,-1.23413e-11,-985.209,26.9332], Tmin=(100,'K'), Tmax=(934.111,'K')), NASAPolynomial(coeffs=[10.058,0.0345194,-1.58945e-05,3.05959e-09,-2.15586e-13,-2709.94,-16.9766], Tmin=(934.111,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-9.112,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)OsHH) + group(Cds-OdCsH) + radical(CJC(C)OC) + radical(CsCJ=O)"""),
)
...
reaction(
    label = 'reaction4',
    reactants = ['C2H5(29)', 'C=C([O])C=O(734)'],
    products = ['[CH2]C(=O)C([O])CC(3472)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]CC(O)C(=C)[O](11049)'],
    products = ['[CH2]C(=O)C([O])CC(3472)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CH2(S)(23)', 'C=C([O])C(C)[O](1082)'],
    products = ['[CH2]C(=O)C([O])CC(3472)'],
...
reaction(
    label = 'reaction21',
    reactants = ['O(4)', 'C=C([O])[CH]CC(2377)'],
    products = ['[CH2]C(=O)C([O])CC(3472)'],
...
reaction(
    label = 'reaction22',
    reactants = ['O(4)', 'C=[C]C([O])CC(11052)'],
    products = ['[CH2]C(=O)C([O])CC(3472)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[CH2]CC([O])C(C)=O(11054)'],
    products = ['[CH2]C(=O)C([O])CC(3472)'],
...
reaction(
    label = 'reaction31',
    reactants = ['CH2(19)', 'CCC([O])[C]=O(2578)'],
    products = ['[CH2]C(=O)C([O])CC(3472)'],
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'CC=COC[C]=O(11032)'],
    products = ['CC[CH]OC[C]=O(3471)'],
...
reaction(
    label = 'reaction5',
    reactants = ['CH3(17)', 'C=COC[C]=O(3177)'],
    products = ['CC[CH]OC[C]=O(3471)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]C[CH]OCC=O(11035)'],
    products = ['CC[CH]OC[C]=O(3471)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CH2(S)(23)', 'C[CH]OC[C]=O(1087)'],
    products = ['CC[CH]OC[C]=O(3471)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CO(12)', '[CH2]O[CH]CC(1682)'],
    products = ['CC[CH]OC[C]=O(3471)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[O]C[C]=O(113)', '[CH]CC(144)'],
    products = ['CC[CH]OC[C]=O(3471)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[C]=O(361)', '[CH2]O[CH]CC(1682)'],
    products = ['CC[CH]OC[C]=O(3471)'],
