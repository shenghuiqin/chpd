...
species(
    label = 'C[CH]OOC=CCCC(12007)',
    structure = SMILES('C[CH]OOC=CCCC'),
    E0 = (24.2173,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2995,3025,975,1000,1300,1375,400,500,1630,1680,3025,407.5,1350,352.5,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.470155,0.0957277,-7.30251e-05,2.91764e-08,-4.8457e-12,3075.28,36.648], Tmin=(100,'K'), Tmax=(1385.16,'K')), NASAPolynomial(coeffs=[16.4134,0.0469726,-2.02282e-05,3.76592e-09,-2.5954e-13,-1602.04,-50.3063], Tmin=(1385.16,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(24.2173,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(CCsJOOC)"""),
)
...
species(
    label = 'C[CH]OOC[CH]CCC(12009)',
    structure = SMILES('C[CH]OOC[CH]CCC'),
    E0 = (92.8253,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,3000,3050,390,425,1340,1360,335,370,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (130.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.431707,0.106027,-0.000101741,6.10029e-08,-1.64029e-11,11316.5,37.9389], Tmin=(100,'K'), Tmax=(861.286,'K')), NASAPolynomial(coeffs=[8.36314,0.0651821,-3.06055e-05,5.94147e-09,-4.20567e-13,9801.53,-3.17784], Tmin=(861.286,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(92.8253,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(523.812,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJCOOH) + radical(CCsJOOC)"""),
)

species(
    label = '[CH2]COO[CH]CCCC(12010)',
    structure = SMILES('[CH2]COO[CH]CCCC'),
    E0 = (106.373,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (130.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.486747,0.106394,-9.82539e-05,5.39286e-08,-1.30216e-11,12948.8,37.8206], Tmin=(100,'K'), Tmax=(957.351,'K')), NASAPolynomial(coeffs=[10.1211,0.0620723,-2.88104e-05,5.57078e-09,-3.93678e-13,10917.7,-12.8939], Tmin=(957.351,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(106.373,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(523.812,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCsJOOC) + radical(CJCOOH)"""),
)

species(
    label = 'C[CH]OOCC[CH]CC(12011)',
    structure = SMILES('C[CH]OOCC[CH]CC'),
    E0 = (86.8686,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,3000,3050,390,425,1340,1360,335,370,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (130.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.558025,0.109097,-0.000128243,1.05897e-07,-3.85571e-11,10603.6,38.6234], Tmin=(100,'K'), Tmax=(749.036,'K')), NASAPolynomial(coeffs=[5.30248,0.0696067,-3.27508e-05,6.3004e-09,-4.40969e-13,9955.52,13.5778], Tmin=(749.036,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(86.8686,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(523.812,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(CCsJOOC)"""),
)

species(
    label = 'C[CH]CCCOO[CH]C(12012)',
    structure = SMILES('C[CH]CCCOO[CH]C'),
    E0 = (86.8566,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,3000,3050,390,425,1340,1360,335,370,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (130.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.427952,0.0925136,-3.9731e-05,-7.40639e-08,8.72636e-11,10561,35.4732], Tmin=(100,'K'), Tmax=(487.489,'K')), NASAPolynomial(coeffs=[5.98988,0.0684454,-3.20418e-05,6.18276e-09,-4.35061e-13,9762.43,10.0076], Tmin=(487.489,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(86.8566,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(523.812,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCsJOOC) + radical(RCCJC)"""),
)

species(
    label = 'CCC[CH][CH]OOCC(12013)',
    structure = SMILES('CCC[CH][CH]OOCC'),
    E0 = (92.8253,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,3000,3050,390,425,1340,1360,335,370,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2][CH]OOCCCCC(12014)',
    structure = SMILES('[CH2][CH]OOCCCCC'),
    E0 = (106.373,'kJ/mol'),
    modes = [
...
species(
    label = '[CH2]CCCCOO[CH]C(12015)',
    structure = SMILES('[CH2]CCCCOO[CH]C'),
    E0 = (97.6567,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (130.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.357868,0.10406,-9.41621e-05,5.16039e-08,-1.265e-11,11895.4,37.152], Tmin=(100,'K'), Tmax=(935.79,'K')), NASAPolynomial(coeffs=[9.02785,0.0639397,-2.98511e-05,5.78682e-09,-4.09515e-13,10138.8,-7.50555], Tmin=(935.79,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(97.6567,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(523.812,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCsJOOC) + radical(RCCJ)"""),
)

species(
    label = 'CC[CH]C[CH]OOCC(12016)',
    structure = SMILES('CC[CH]C[CH]OOCC'),
    E0 = (86.8686,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,3000,3050,390,425,1340,1360,335,370,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'C[CH]CC[CH]OOCC(12017)',
    structure = SMILES('C[CH]CC[CH]OOCC'),
    E0 = (86.8566,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,3000,3050,390,425,1340,1360,335,370,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2]CCC[CH]OOCC(12018)',
    structure = SMILES('[CH2]CCC[CH]OOCC'),
    E0 = (97.6567,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (130.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.357909,0.10406,-9.41634e-05,5.16053e-08,-1.26506e-11,11895.4,37.1521], Tmin=(100,'K'), Tmax=(935.74,'K')), NASAPolynomial(coeffs=[9.02775,0.0639399,-2.98512e-05,5.78686e-09,-4.09518e-13,10138.9,-7.50498], Tmin=(935.74,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(97.6567,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(523.812,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJ) + radical(CCsJOOC)"""),
)
...
species(
    label = 'CCCC=COOCC(12019)',
    structure = SMILES('CCCC=COOCC'),
    E0 = (-162.223,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (130.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.795774,0.0974699,-7.06939e-05,2.62592e-08,-3.99176e-12,-19332.1,37.5321], Tmin=(100,'K'), Tmax=(1521.19,'K')), NASAPolynomial(coeffs=[19.3613,0.0444663,-1.84284e-05,3.3536e-09,-2.27329e-13,-25464.7,-68.1698], Tmin=(1521.19,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-162.223,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(527.969,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH)"""),
)

species(
    label = 'C=COOCCCCC(12020)',
    structure = SMILES('C=COOCCCCC'),
    E0 = (-151.113,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (130.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.732188,0.0990084,-7.40232e-05,2.86865e-08,-4.58574e-12,-18000.6,37.067], Tmin=(100,'K'), Tmax=(1443.24,'K')), NASAPolynomial(coeffs=[18.0772,0.0468778,-1.98426e-05,3.65941e-09,-2.50539e-13,-23429.9,-60.5786], Tmin=(1443.24,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-151.113,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(527.969,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH)"""),
)
...
species(
    label = 'C[CH]OO[CH]CCC(12021)',
    structure = SMILES('C[CH]OO[CH]CCC'),
    E0 = (102.631,'kJ/mol'),
    modes = [
...
species(
    label = '[CH2]C(CCC)OO[CH]C(12022)',
    structure = SMILES('[CH2]C(CCC)OO[CH]C'),
    E0 = (93.73,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,1380,1390,370,380,2900,435,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,350,500,795,815,3000,3100,440,815,1455,1000,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (130.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.501075,0.104561,-8.93855e-05,4.2931e-08,-8.90184e-12,11430.5,37.5121], Tmin=(100,'K'), Tmax=(1107.08,'K')), NASAPolynomial(coeffs=[12.3314,0.0581956,-2.6564e-05,5.10068e-09,-3.58999e-13,8589.18,-25.7027], Tmin=(1107.08,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(93.73,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(523.812,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJCOOH) + radical(CCsJOOC)"""),
)

species(
    label = 'CCCCC1OOC1C(11954)',
    structure = SMILES('CCCCC1OOC1C'),
    E0 = (-159.898,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (130.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.44755,0.0897784,-5.71313e-05,1.81672e-08,-2.35988e-12,-19065.1,30.8997], Tmin=(100,'K'), Tmax=(1740.28,'K')), NASAPolynomial(coeffs=[19.2276,0.0445553,-1.81518e-05,3.23482e-09,-2.14755e-13,-25913.1,-74.9221], Tmin=(1740.28,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-159.898,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(536.283,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(12dioxetane)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['C[CH]OO[CH]CCCC(11953)'],
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'C[CH]OOC=CCCC(12007)'],
    products = ['C[CH]OO[CH]CCCC(11953)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'C=COO[CH]CCCC(12008)'],
    products = ['C[CH]OO[CH]CCCC(11953)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['npropyl(83)', 'C=COO[CH]C(2478)'],
    products = ['C[CH]OO[CH]CCCC(11953)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['C[CH]OOC[CH]CCC(12009)'],
    products = ['C[CH]OO[CH]CCCC(11953)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['C[CH]OO[CH]CCCC(11953)'],
    products = ['[CH2]COO[CH]CCCC(12010)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['C[CH]OOCC[CH]CC(12011)'],
    products = ['C[CH]OO[CH]CCCC(11953)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['C[CH]CCCOO[CH]C(12012)'],
    products = ['C[CH]OO[CH]CCCC(11953)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['CCC[CH][CH]OOCC(12013)'],
    products = ['C[CH]OO[CH]CCCC(11953)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2][CH]OOCCCCC(12014)'],
    products = ['C[CH]OO[CH]CCCC(11953)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]CCCCOO[CH]C(12015)'],
    products = ['C[CH]OO[CH]CCCC(11953)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CC[CH]C[CH]OOCC(12016)'],
    products = ['C[CH]OO[CH]CCCC(11953)'],
...
reaction(
    label = 'reaction13',
    reactants = ['C[CH]CC[CH]OOCC(12017)'],
    products = ['C[CH]OO[CH]CCCC(11953)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]CCC[CH]OOCC(12018)'],
    products = ['C[CH]OO[CH]CCCC(11953)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CH2(S)(23)', 'C[CH]OO[CH]CCC(12021)'],
    products = ['C[CH]OO[CH]CCCC(11953)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2]C(CCC)OO[CH]C(12022)'],
    products = ['C[CH]OO[CH]CCCC(11953)'],
...
reaction(
    label = 'reaction21',
    reactants = ['C[CH]O[O](97)', '[CH]CCCC(141)'],
    products = ['C[CH]OO[CH]CCCC(11953)'],
...
reaction(
    label = 'reaction22',
    reactants = ['CCCC[CH]O[O](239)', 'CHCH3(T)(95)'],
    products = ['C[CH]OO[CH]CCCC(11953)'],
