...
species(
    label = '[CH]=C1CC1C([O])CCCC(30291)',
    structure = SMILES('[CH]=C1CC1C([O])CCCC'),
    E0 = (365.058,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (138.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.28608,0.101257,-6.20644e-05,9.67513e-09,3.10979e-12,44109.4,40.0075], Tmin=(100,'K'), Tmax=(1084.24,'K')), NASAPolynomial(coeffs=[20.7777,0.0444558,-1.75108e-05,3.20351e-09,-2.22336e-13,37879.1,-74.8895], Tmin=(1084.24,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(365.058,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(561.227,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + ring(Methylene_cyclopropane) + radical(Cds_P) + radical(CC(C)OJ)"""),
)
...
species(
    label = 'C#CC([CH2])C(=O)CCCC(30292)',
    structure = SMILES('C#CC([CH2])C(=O)CCCC'),
    E0 = (118.616,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,2175,525,1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,375,552.5,462.5,1710,750,770,3400,2100,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.50892,0.130173,-0.000176351,1.43038e-07,-4.73423e-11,14455.9,38.7037], Tmin=(100,'K'), Tmax=(823.867,'K')), NASAPolynomial(coeffs=[10.7734,0.0591605,-2.63408e-05,4.88487e-09,-3.32603e-13,12818.4,-15.8279], Tmin=(823.867,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(118.616,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(527.969,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsCsH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdCsCs) + group(Ct-CtCs) + group(Ct-CtH) + radical(CJC(C)C=O)"""),
)

species(
    label = 'C#CC(=C)C([O])CCCC(30293)',
    structure = SMILES('C#CC(=C)C([O])CCCC'),
    E0 = (193.819,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2175,525,2750,2800,2850,1350,1500,750,1050,1375,1000,2950,3100,1380,975,1025,1650,1380,1390,370,380,2900,435,350,440,435,1725,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,750,770,3400,2100,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (137.199,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.23153,0.105029,-8.46062e-05,3.53377e-08,-5.97522e-12,23507.6,39.9686], Tmin=(100,'K'), Tmax=(1400.14,'K')), NASAPolynomial(coeffs=[20.9435,0.0416782,-1.67363e-05,3.02175e-09,-2.05053e-13,17298,-74.4766], Tmin=(1400.14,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(193.819,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(532.126,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cds-CdsCtCs) + group(Cds-CdsHH) + group(Ct-Ct(Cds-Cds)) + group(Ct-CtH) + radical(CC(C)OJ)"""),
)
...
species(
    ...
    molecularWeight = (138.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.49376,0.123526,-0.000137357,8.83852e-08,-2.33326e-11,27953.6,42.1553], Tmin=(100,'K'), Tmax=(916.959,'K')), NASAPolynomial(coeffs=[14.8262,0.0523357,-2.0902e-05,3.7189e-09,-2.49459e-13,24960.6,-35.1645], Tmin=(916.959,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(230.795,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(548.755,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CtCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(C2CsJOH) + radical(Isobutyl)"""),
)

species(
    label = 'C#C[C](C)C([O])CCCC(30295)',
    ...
    molecularWeight = (138.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.23726,0.111174,-9.49514e-05,4.38568e-08,-8.34544e-12,27336.3,40.9276], Tmin=(100,'K'), Tmax=(1241.09,'K')), NASAPolynomial(coeffs=[17.9642,0.049287,-2.01525e-05,3.67695e-09,-2.51645e-13,22570.2,-55.8554], Tmin=(1241.09,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(225.692,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(557.07,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(CC(C)OJ) + radical(C=C=CJ)"""),
)

species(
    label = 'C#CC([CH2])C(O)[CH]CCC(30296)',
    structure = SMILES('C#CC([CH2])C(O)[CH]CCC'),
    E0 = (254.069,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1277.5,1000,2175,525,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3100,440,815,1455,1000,750,770,3400,2100,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (138.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.40805,0.112812,-0.000103531,5.26445e-08,-1.08992e-11,30757.4,44.9095], Tmin=(100,'K'), Tmax=(1161.35,'K')), NASAPolynomial(coeffs=[18.0686,0.0457294,-1.68865e-05,2.90687e-09,-1.92334e-13,26233.5,-51.9676], Tmin=(1161.35,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(254.069,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(548.755,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CtCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(Isobutyl) + radical(CCJCO)"""),
)

species(
    label = 'C#C[C]([CH2])C(O)CCCC(30297)',
    structure = SMILES('[CH]=C=C([CH2])C(O)CCCC'),
    E0 = (146.83,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (138.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.63856,0.115449,-0.000101844,4.76611e-08,-9.01292e-12,17869.7,42.842], Tmin=(100,'K'), Tmax=(1266.54,'K')), NASAPolynomial(coeffs=[21.025,0.0438727,-1.70744e-05,3.0414e-09,-2.05558e-13,12128.8,-71.8517], Tmin=(1266.54,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(146.83,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(552.912,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(C=C=CJ) + radical(Allyl_P)"""),
)

species(
    label = 'C#CC(C)[C]([O])CCCC(30298)',
    structure = SMILES('C#CC(C)[C]([O])CCCC'),
    E0 = (256.073,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (138.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.17992,0.115854,-0.000111976,6.17832e-08,-1.42271e-11,30983.5,39.0557], Tmin=(100,'K'), Tmax=(1033.21,'K')), NASAPolynomial(coeffs=[14.7063,0.054351,-2.26858e-05,4.1692e-09,-2.86419e-13,27700.7,-38.1052], Tmin=(1033.21,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(256.073,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(552.912,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CtCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(CC(C)OJ) + radical(C2CsJOH)"""),
)

species(
    label = 'C#CC([CH2])C(O)C[CH]CC(30299)',
    structure = SMILES('C#CC([CH2])C(O)C[CH]CC'),
    E0 = (248.625,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1277.5,1000,2175,525,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3100,440,815,1455,1000,750,770,3400,2100,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (138.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.05225,0.11484,-0.000122592,7.9906e-08,-2.18967e-11,30081.3,43.7119], Tmin=(100,'K'), Tmax=(876.46,'K')), NASAPolynomial(coeffs=[11.704,0.0566206,-2.29505e-05,4.11295e-09,-2.76893e-13,27845.3,-16.1472], Tmin=(876.46,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(248.625,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(548.755,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CtCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(RCCJCC) + radical(Isobutyl)"""),
)

species(
    label = 'C#CC(C)C([O])[CH]CCC(30300)',
    ...
    molecularWeight = (138.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.36312,0.108233,-8.85443e-05,3.88471e-08,-6.94834e-12,33798.8,42.7789], Tmin=(100,'K'), Tmax=(1327.76,'K')), NASAPolynomial(coeffs=[19.6065,0.0450602,-1.71766e-05,3.01361e-09,-2.01372e-13,28230.3,-64.3324], Tmin=(1327.76,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(279.348,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(552.912,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CtCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(CCJCO) + radical(CC(C)OJ)"""),
)

species(
    label = '[C]#CC(C)C([O])CCCC(30301)',
    structure = SMILES('[C]#CC(C)C([O])CCCC'),
    E0 = (416.589,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2175,525,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (138.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.12645,0.112193,-0.000103162,5.41759e-08,-1.18636e-11,50289.2,40.1761], Tmin=(100,'K'), Tmax=(1084.93,'K')), NASAPolynomial(coeffs=[14.9523,0.0529129,-2.12034e-05,3.81396e-09,-2.58772e-13,46800.3,-38.7051], Tmin=(1084.93,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(416.589,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(552.912,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CtCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(CC(C)OJ) + radical(Acetyl)"""),
)

species(
    label = 'C#CC([CH2])C(O)CC[CH]C(30302)',
    structure = SMILES('C#CC([CH2])C(O)CC[CH]C'),
    E0 = (248.613,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (138.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.10813,0.11462,-0.000118472,7.31623e-08,-1.88661e-11,30083.2,44.0819], Tmin=(100,'K'), Tmax=(931.302,'K')), NASAPolynomial(coeffs=[12.889,0.0545007,-2.16385e-05,3.84371e-09,-2.57819e-13,27476.1,-22.4496], Tmin=(931.302,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(248.613,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(548.755,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CtCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(RCCJC) + radical(Isobutyl)"""),
)

species(
    label = 'C#CC(C)C([O])C[CH]CC(30303)',
    ...
    molecularWeight = (138.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.69509,0.106642,-9.53072e-05,5.07377e-08,-1.16499e-11,33109.3,40.4579], Tmin=(100,'K'), Tmax=(1017.95,'K')), NASAPolynomial(coeffs=[11.4745,0.0588218,-2.48412e-05,4.5884e-09,-3.15934e-13,30631.7,-18.4697], Tmin=(1017.95,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(273.904,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(552.912,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CtCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(RCCJCC) + radical(CC(C)OJ)"""),
)

species(
    label = '[C]#CC([CH2])C(O)CCCC(30304)',
    structure = SMILES('[C]#CC([CH2])C(O)CCCC'),
    E0 = (391.311,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1277.5,1000,2175,525,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3000,3100,440,815,1455,1000,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (138.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.39015,0.119256,-0.000126346,7.78573e-08,-1.97006e-11,47257.3,43.0973], Tmin=(100,'K'), Tmax=(955.607,'K')), NASAPolynomial(coeffs=[14.8523,0.0512705,-1.96343e-05,3.41431e-09,-2.26007e-13,44152.9,-34.5263], Tmin=(955.607,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(391.311,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(548.755,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CtCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(Acetyl) + radical(Isobutyl)"""),
)

species(
    label = 'C#CC([CH2])C(O)CCC[CH2](30305)',
    structure = SMILES('C#CC([CH2])C(O)CCC[CH2]'),
    E0 = (259.413,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (138.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.36768,0.116379,-0.000114095,6.31507e-08,-1.43282e-11,31395,44.0588], Tmin=(100,'K'), Tmax=(1060.04,'K')), NASAPolynomial(coeffs=[16.4397,0.0491831,-1.90082e-05,3.34937e-09,-2.24471e-13,27619.7,-42.8898], Tmin=(1060.04,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(259.413,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(548.755,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CtCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(Isobutyl) + radical(RCCJ)"""),
)

species(
    label = 'C#CC(C)C([O])CC[CH]C(30306)',
    ...
    molecularWeight = (138.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.810474,0.107175,-9.4028e-05,4.79365e-08,-1.04003e-11,33113.6,41.0377], Tmin=(100,'K'), Tmax=(1080.43,'K')), NASAPolynomial(coeffs=[12.9656,0.0561727,-2.32202e-05,4.24556e-09,-2.90715e-13,30136.8,-26.4896], Tmin=(1080.43,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(273.892,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(552.912,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CtCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(RCCJC) + radical(CC(C)OJ)"""),
)

species(
    label = 'C#CC(C)C([O])CCC[CH2](30307)',
    structure = SMILES('C#CC(C)C([O])CCC[CH2]'),
    E0 = (284.692,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,2175,525,750,770,3400,2100,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3000,3100,440,815,1455,1000,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (138.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.20819,0.110557,-9.52512e-05,4.49999e-08,-8.77675e-12,34431.3,41.5098], Tmin=(100,'K'), Tmax=(1213.39,'K')), NASAPolynomial(coeffs=[17.2887,0.0495814,-1.98719e-05,3.58443e-09,-2.43711e-13,29942.5,-51.3044], Tmin=(1213.39,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(284.692,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(552.912,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CtCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(RCCJ) + radical(CC(C)OJ)"""),
)
...
species(
    ...
    molecularWeight = (138.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.0439,0.117834,-0.000131436,9.18297e-08,-2.74617e-11,-10877.1,36.6977], Tmin=(100,'K'), Tmax=(799.61,'K')), NASAPolynomial(coeffs=[10.0341,0.0624129,-2.74621e-05,5.13557e-09,-3.54467e-13,-12648.5,-14.2691], Tmin=(799.61,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-91.8948,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(552.912,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsCsH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdCsCs) + group(Ct-CtCs) + group(Ct-CtH)"""),
)

species(
    label = 'C#CC(=C)C(O)CCCC(30309)',
    structure = SMILES('C#CC(=C)C(O)CCCC'),
    E0 = (-36.5415,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (138.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.32866,0.108294,-8.81727e-05,3.76266e-08,-6.52676e-12,-4195.88,40.5062], Tmin=(100,'K'), Tmax=(1363.95,'K')), NASAPolynomial(coeffs=[20.5062,0.0442602,-1.77514e-05,3.20629e-09,-2.17824e-13,-10152.2,-71.6114], Tmin=(1363.95,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-36.5415,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(552.912,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cds-CdsCtCs) + group(Cds-CdsHH) + group(Ct-Ct(Cds-Cds)) + group(Ct-CtH)"""),
)
...
species(
    label = 'C#CC([CH2])C([O])CCC(30310)',
    structure = SMILES('C#CC([CH2])C([O])CCC'),
    E0 = (308.308,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,2175,525,750,770,3400,2100,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3100,440,815,1455,1000,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.731524,0.098503,-8.9699e-05,4.53634e-08,-9.35202e-12,37255.9,37.5485], Tmin=(100,'K'), Tmax=(1165.52,'K')), NASAPolynomial(coeffs=[16.216,0.04034,-1.48446e-05,2.54753e-09,-1.68183e-13,33305.4,-46.8096], Tmin=(1165.52,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(308.308,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(482.239,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CtCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(CC(C)OJ) + radical(Isobutyl)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['C#CC([CH2])C([O])CCCC(29706)'],
    products = ['[CH]=C1CC1C([O])CCCC(30291)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', 'C#CC([CH2])C(=O)CCCC(30292)'],
    products = ['C#CC([CH2])C([O])CCCC(29706)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)', 'C#CC(=C)C([O])CCCC(30293)'],
    products = ['C#CC([CH2])C([O])CCCC(29706)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['butyl_1(82)', 'C#CC([CH2])C=O(26979)'],
    products = ['C#CC([CH2])C([O])CCCC(29706)'],
    transitionState = 'TS6',
...
reaction(
    ...
    products = ['C#CC([CH2])C([O])CCCC(29706)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(0.0201871,'m^3/(mol*s)'), n=2.2105, Ea=(83.8276,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [CO-CsH_O;YJ] for rate rule [CO-CsH_O;CJ]
Euclidian distance = 1.0
family: R_Addition_MultipleBond
...
reaction(
    label = 'reaction9',
    reactants = ['C2H(33)', 'C=CC([O])CCCC(10637)'],
    products = ['C#CC([CH2])C([O])CCCC(29706)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['C#CC([CH2])C([O])CCCC(29706)'],
    products = ['C#CC([CH2])[C](O)CCCC(30294)'],
...
reaction(
    label = 'reaction11',
    reactants = ['C#C[C](C)C([O])CCCC(30295)'],
    products = ['C#CC([CH2])C([O])CCCC(29706)'],
...
reaction(
    label = 'reaction12',
    reactants = ['C#CC([CH2])C(O)[CH]CCC(30296)'],
    products = ['C#CC([CH2])C([O])CCCC(29706)'],
...
reaction(
    label = 'reaction13',
    reactants = ['C#CC([CH2])C([O])CCCC(29706)'],
    products = ['C#C[C]([CH2])C(O)CCCC(30297)'],
...
reaction(
    label = 'reaction14',
    reactants = ['C#CC([CH2])C([O])CCCC(29706)'],
    products = ['C#CC(C)[C]([O])CCCC(30298)'],
...
reaction(
    label = 'reaction15',
    reactants = ['C#CC([CH2])C(O)C[CH]CC(30299)'],
    products = ['C#CC([CH2])C([O])CCCC(29706)'],
...
reaction(
    label = 'reaction16',
    reactants = ['C#CC([CH2])C([O])CCCC(29706)'],
    products = ['C#CC(C)C([O])[CH]CCC(30300)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[C]#CC(C)C([O])CCCC(30301)'],
    products = ['C#CC([CH2])C([O])CCCC(29706)'],
...
reaction(
    label = 'reaction18',
    reactants = ['C#CC([CH2])C([O])CCCC(29706)'],
    products = ['C#CC([CH2])C(O)CC[CH]C(30302)'],
...
reaction(
    label = 'reaction19',
    reactants = ['C#CC([CH2])C([O])CCCC(29706)'],
    products = ['C#CC(C)C([O])C[CH]CC(30303)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[C]#CC([CH2])C(O)CCCC(30304)'],
    products = ['C#CC([CH2])C([O])CCCC(29706)'],
...
reaction(
    label = 'reaction21',
    reactants = ['C#CC([CH2])C([O])CCCC(29706)'],
    products = ['C#CC([CH2])C(O)CCC[CH2](30305)'],
...
reaction(
    label = 'reaction22',
    reactants = ['C#CC([CH2])C([O])CCCC(29706)'],
    products = ['C#CC(C)C([O])CC[CH]C(30306)'],
...
reaction(
    label = 'reaction23',
    reactants = ['C#CC(C)C([O])CCC[CH2](30307)'],
    products = ['C#CC([CH2])C([O])CCCC(29706)'],
...
reaction(
    label = 'reaction27',
    reactants = ['C#CC([CH2])C([O])CCCC(29706)'],
    products = ['C#CC(C)C(=O)CCCC(30308)'],
...
reaction(
    label = 'reaction28',
    reactants = ['C#CC([CH2])C([O])CCCC(29706)'],
    products = ['C#CC(=C)C(O)CCCC(30309)'],
...
reaction(
    label = 'reaction29',
    reactants = ['CH2(S)(23)', 'C#CC([CH2])C([O])CCC(30310)'],
    products = ['C#CC([CH2])C([O])CCCC(29706)'],
...
reaction(
    label = 'reaction33',
    reactants = ['O(4)', 'C#CC([CH2])[CH]CCCC(28542)'],
    products = ['C#CC([CH2])C([O])CCCC(29706)'],
