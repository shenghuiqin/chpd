...
species(
    label = 'C[CH]OOC=O(5084)',
    structure = SMILES('C[CH]OOC=O'),
    E0 = (-241.067,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2782.5,750,1395,475,1775,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5],'cm^-1')),
        HinderedRotor(inertia=(0.513342,'amu*angstrom^2'), symmetry=1, barrier=(42.524,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.51333,'amu*angstrom^2'), symmetry=1, barrier=(42.524,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.513349,'amu*angstrom^2'), symmetry=1, barrier=(42.524,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.513314,'amu*angstrom^2'), symmetry=1, barrier=(42.5241,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
species(
    label = 'C[CH]OOC[O](5086)',
    structure = SMILES('C[CH]OOC[O]'),
    E0 = (36.7401,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2850,1437.5,1250,1305,750,350,554.364,555.853],'cm^-1')),
        HinderedRotor(inertia=(1.71298,'amu*angstrom^2'), symmetry=1, barrier=(39.3849,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.181393,'amu*angstrom^2'), symmetry=1, barrier=(39.3717,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0166697,'amu*angstrom^2'), symmetry=1, barrier=(3.60437,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.71208,'amu*angstrom^2'), symmetry=1, barrier=(39.3641,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (90.0779,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.5798,0.0516132,-3.78388e-05,1.35702e-08,-1.98279e-12,4506.79,22.2036], Tmin=(100,'K'), Tmax=(1562.69,'K')), NASAPolynomial(coeffs=[12.546,0.0235436,-1.08955e-05,2.07594e-09,-1.4396e-13,1079.41,-35.5973], Tmin=(1562.69,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(36.7401,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsOsHH) + radical(OCOJ) + radical(CCsJOOC)"""),
)

species(
    label = '[CH2]COO[CH]O(5087)',
    structure = SMILES('[CH2]COO[CH]O'),
    E0 = (25.8242,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (90.0779,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.901439,0.0716425,-9.28563e-05,6.39503e-08,-1.76407e-11,3214.46,25.6633], Tmin=(100,'K'), Tmax=(884.383,'K')), NASAPolynomial(coeffs=[11.604,0.0232345,-1.07499e-05,2.05544e-09,-1.43702e-13,1321.47,-24.6552], Tmin=(884.383,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(25.8242,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(261.906,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsOsHH) + radical(OCJO) + radical(CJCOOH)"""),
)

species(
    label = '[CH2][CH]OOCO(5088)',
    structure = SMILES('[CH2][CH]OOCO'),
    E0 = (23.3048,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,3025,407.5,1350,352.5,3615,1277.5,1000,3000,3100,440,815,1455,1000,2750,2850,1437.5,1250,1305,750,350,282.708],'cm^-1')),
        HinderedRotor(inertia=(0.00211197,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.457907,'amu*angstrom^2'), symmetry=1, barrier=(25.9831,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.458637,'amu*angstrom^2'), symmetry=1, barrier=(25.9894,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.458688,'amu*angstrom^2'), symmetry=1, barrier=(25.9756,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.45851,'amu*angstrom^2'), symmetry=1, barrier=(25.9856,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (90.0779,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.725813,0.0600319,-3.72938e-05,-7.55432e-09,1.07292e-11,2931.75,26.7878], Tmin=(100,'K'), Tmax=(945.663,'K')), NASAPolynomial(coeffs=[19.8688,0.00839846,-1.92939e-06,3.21303e-10,-2.57343e-14,-2000.64,-71.4325], Tmin=(945.663,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(23.3048,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(261.906,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsOsHH) + radical(CCsJOOC) + radical(CJCOOH)"""),
)

species(
    label = 'CCOO[CH][O](5089)',
    structure = SMILES('CCOO[CH][O]'),
    E0 = (39.2596,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2850,1437.5,1250,1305,750,350,2233.08,2233.12],'cm^-1')),
        HinderedRotor(inertia=(1.79497,'amu*angstrom^2'), symmetry=1, barrier=(41.2699,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.459921,'amu*angstrom^2'), symmetry=1, barrier=(10.5745,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.7947,'amu*angstrom^2'), symmetry=1, barrier=(41.2636,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.79471,'amu*angstrom^2'), symmetry=1, barrier=(41.2639,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (90.0779,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.38414,0.067913,-0.00011173,1.12565e-07,-4.41552e-11,4805.91,22.3955], Tmin=(100,'K'), Tmax=(814.885,'K')), NASAPolynomial(coeffs=[1.9747,0.0420071,-2.16936e-05,4.25833e-09,-2.97967e-13,5473.54,24.3543], Tmin=(814.885,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(39.2596,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsOsHH) + radical(OCJO) + radical(OCOJ)"""),
)
...
species(
    label = 'C=COOCO(5090)',
    structure = SMILES('C=COOCO'),
    E0 = (-234.181,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (90.0779,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.02877,0.0458654,1.18012e-05,-6.61154e-08,3.36632e-11,-28040.4,24.0921], Tmin=(100,'K'), Tmax=(925.142,'K')), NASAPolynomial(coeffs=[23.0046,0.00123521,2.46888e-06,-5.20644e-10,2.92965e-14,-34262.8,-91.8725], Tmin=(925.142,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-234.181,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(O2s-CsH) + group(Cs-OsOsHH) + group(Cds-CdsOsH) + group(Cds-CdsHH)"""),
)

species(
    label = 'CCOOC=O(5091)',
    structure = SMILES('CCOOC=O'),
    E0 = (-427.508,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (90.0779,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.68995,0.0364598,1.72227e-05,-4.90882e-08,2.09881e-11,-51321.5,21.667], Tmin=(100,'K'), Tmax=(1001.98,'K')), NASAPolynomial(coeffs=[14.541,0.0192157,-7.94883e-06,1.58328e-09,-1.18806e-13,-55606.4,-48.8887], Tmin=(1001.98,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-427.508,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-O2d)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdOsH)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'C[CH]OOC=O(5084)'],
    products = ['C[CH]OO[CH]O(1198)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction12',
    reactants = ['CHCH3(T)(95)', '[O]O[CH]O(4538)'],
    products = ['C[CH]OO[CH]O(1198)'],
...
reaction(
    label = 'reaction13',
    reactants = ['C[CH]O[O](97)', 'HCOH(T)(285)'],
    products = ['C[CH]OO[CH]O(1198)'],
