...
species(
    ...
    molecularWeight = (111.205,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.57948,0.0888845,-5.97029e-05,2.1274e-08,-3.12689e-12,9120.08,35.56], Tmin=(100,'K'), Tmax=(1572.23,'K')), NASAPolynomial(coeffs=[17.4425,0.0430343,-1.59597e-05,2.72605e-09,-1.77612e-13,3453.06,-59.5408], Tmin=(1572.23,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(74.3769,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(532.126,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + longDistanceInteraction_noncyclic(CdCs-ST) + group(Cds-CdsHH) + radical(Isobutyl)"""),
)
...
species(
    ...
    molecularWeight = (112.213,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.449847,0.0874979,-5.33632e-05,1.67816e-08,-2.17864e-12,18469,38.3546], Tmin=(100,'K'), Tmax=(1737.53,'K')), NASAPolynomial(coeffs=[17.6384,0.0458563,-1.7414e-05,2.98828e-09,-1.94002e-13,12183.3,-58.9036], Tmin=(1737.53,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(152.158,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(552.912,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Isobutyl) + radical(Cs_S)"""),
)

species(
    label = '[CH2][C](CCC)C(C)C(546)',
    structure = SMILES('[CH2][C](CCC)C(C)C'),
    E0 = (143.039,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
species(
    ...
    molecularWeight = (112.213,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.449847,0.0874979,-5.33632e-05,1.67816e-08,-2.17864e-12,18469,37.6615], Tmin=(100,'K'), Tmax=(1737.53,'K')), NASAPolynomial(coeffs=[17.6384,0.0458563,-1.7414e-05,2.98828e-09,-1.94002e-13,12183.3,-59.5967], Tmin=(1737.53,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(152.158,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(552.912,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Isobutyl) + radical(Cs_S)"""),
)

species(
    label = '[CH2]C([CH2])C(C)CCC(548)',
    ...
    molecularWeight = (112.213,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.568573,0.0900911,-5.4943e-05,1.39233e-08,-2.68243e-14,19741.3,37.2917], Tmin=(100,'K'), Tmax=(1097.42,'K')), NASAPolynomial(coeffs=[14.4816,0.0491891,-1.81105e-05,3.13525e-09,-2.08879e-13,15597.7,-40.5445], Tmin=(1097.42,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(162.698,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(552.912,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Isobutyl) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]C(C)C(C)C[CH]C(549)',
    ...
    molecularWeight = (112.213,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.16312,0.0859452,-5.2318e-05,1.70338e-08,-2.35491e-12,18442.8,37.4827], Tmin=(100,'K'), Tmax=(1597.33,'K')), NASAPolynomial(coeffs=[13.6998,0.05123,-1.9718e-05,3.4277e-09,-2.25407e-13,14014.1,-35.8901], Tmin=(1597.33,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(152.062,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(552.912,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Isobutyl) + radical(RCCJC)"""),
)

species(
    label = '[CH2]C(C[CH]C)C(C)C(550)',
    ...
    molecularWeight = (112.213,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.16312,0.0859452,-5.2318e-05,1.70338e-08,-2.35491e-12,18442.8,36.7896], Tmin=(100,'K'), Tmax=(1597.33,'K')), NASAPolynomial(coeffs=[13.6998,0.05123,-1.9718e-05,3.4277e-09,-2.25407e-13,14014.1,-36.5833], Tmin=(1597.33,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(152.062,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(552.912,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Isobutyl) + radical(RCCJC)"""),
)

species(
    label = '[CH2]CCC(C)C([CH2])C(551)',
...
species(
    ...
    molecularWeight = (112.213,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.799052,0.0917091,-6.01774e-05,2.08085e-08,-2.95872e-12,19772.1,38.1491], Tmin=(100,'K'), Tmax=(1625,'K')), NASAPolynomial(coeffs=[18.6077,0.0439385,-1.60814e-05,2.71773e-09,-1.7552e-13,13464.9,-64.8992], Tmin=(1625,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(162.862,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(552.912,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Isobutyl) + radical(RCCJ)"""),
)

species(
    label = 'C=C(CCC)C(C)C(553)',
    ...
    molecularWeight = (112.213,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.342825,0.0814529,-2.67801e-05,-1.52658e-08,9.56904e-12,-15415.5,32.8901], Tmin=(100,'K'), Tmax=(1074.8,'K')), NASAPolynomial(coeffs=[15.5849,0.0491817,-1.94318e-05,3.55421e-09,-2.46321e-13,-20399.1,-52.3574], Tmin=(1074.8,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-129.571,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(557.07,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + longDistanceInteraction_noncyclic(CdCs-ST) + group(Cds-CdsHH)"""),
)

species(
    label = 'C=C(C)C(C)CCC(554)',
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(C)C([CH2])CCC(516)'],
    products = ['C=CCCC(134)', 'C3H6(72)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', '[CH2]C(C)C(=C)CCC(540)'],
    products = ['[CH2]C(C)C([CH2])CCC(516)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', '[CH2]C(CCC)C(=C)C(541)'],
    products = ['[CH2]C(C)C([CH2])CCC(516)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(0.0051739,'m^3/(mol*s)'), n=2.82163, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(303.03,'K'), Tmax=(2000,'K'), comment="""From training reaction 102 used for Cds-CsCs_Cds-HH;HJ
Exact match found for rate rule [Cds-CsCs_Cds-HH;HJ]
...
reaction(
    label = 'reaction4',
    reactants = ['C=CCCC(134)', 'C3H6(T)(143)'],
    products = ['[CH2]C(C)C([CH2])CCC(516)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['npropyl(83)', '[CH2]C(C)C=C(431)'],
    products = ['[CH2]C(C)C([CH2])CCC(516)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2][CH]CCC(137)', 'C3H6(72)'],
    products = ['[CH2]C(C)C([CH2])CCC(516)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(0.00168615,'m^3/(mol*s)'), n=2.52599, Ea=(19.6608,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [Cds-CsH_Cds-HH;CJ]
Euclidian distance = 0
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2]C(C=C)CCC(440)', 'CH3(17)'],
    products = ['[CH2]C(C)C([CH2])CCC(516)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]C(C)C([CH2])CCC(516)'],
    products = ['[CH2]C(C)C(C)[CH]CC(545)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2]C(C)C([CH2])CCC(516)'],
    products = ['[CH2]C([CH]CC)C(C)C(547)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]C([CH2])C(C)CCC(548)'],
    products = ['[CH2]C(C)C([CH2])CCC(516)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]C(C)C([CH2])CCC(516)'],
    products = ['[CH2]C(C)C(C)C[CH]C(549)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]C(C)C([CH2])CCC(516)'],
    products = ['[CH2]C(C[CH]C)C(C)C(550)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]CCC(C)C([CH2])C(551)'],
    products = ['[CH2]C(C)C([CH2])CCC(516)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2]CCC([CH2])C(C)C(552)'],
    products = ['[CH2]C(C)C([CH2])CCC(516)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2][CH]CCC(137)', 'C3H6(T)(143)'],
    products = ['[CH2]C(C)C([CH2])CCC(516)'],
...
reaction(
    label = 'reaction22',
    reactants = ['CH2(S)(23)', '[CH2]CC([CH2])CCC(402)'],
    products = ['[CH2]C(C)C([CH2])CCC(516)'],
...
reaction(
    label = 'reaction23',
    reactants = ['CH2(S)(23)', '[CH2]C(C)C([CH2])CC(555)'],
    products = ['[CH2]C(C)C([CH2])CCC(516)'],
...
reaction(
    label = 'reaction29',
    reactants = ['CH2(19)', '[CH2]C(C)[CH]CCC(558)'],
    products = ['[CH2]C(C)C([CH2])CCC(516)'],
...
reaction(
    label = 'reaction30',
    reactants = ['[CH2]C([CH]C)CCC(442)', 'CH2(19)'],
    products = ['[CH2]C(C)C([CH2])CCC(516)'],
