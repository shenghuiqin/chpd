...
species(
    label = '[CH2]C(C)C1(CC)OCC1=O(14389)',
    structure = SMILES('[CH2]C(C)C1(CC)OCC1=O'),
    E0 = (-133.774,'kJ/mol'),
    modes = [
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.978352,0.0927987,-4.01058e-05,-1.63803e-08,1.35629e-11,-15895.3,36.6395], Tmin=(100,'K'), Tmax=(999.597,'K')), NASAPolynomial(coeffs=[21.1651,0.0400761,-1.48424e-05,2.68667e-09,-1.88335e-13,-22115.1,-79.1492], Tmin=(999.597,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-133.774,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(536.283,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-O2d)CsCsOs) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)OsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdCsCs) + ring(Cyclobutane) + radical(Isobutyl)"""),
)

species(
    label = 'C=C(C)C1(CC)OC[C]1O(14390)',
    structure = SMILES('C=C(C)C1(CC)OC[C]1O'),
    E0 = (-136.575,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (141.188,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.77674,0.109894,-9.83445e-05,4.8082e-08,-9.27492e-12,-16203.6,39.0442], Tmin=(100,'K'), Tmax=(1374.56,'K')), NASAPolynomial(coeffs=[20.9563,0.0364018,-1.01364e-05,1.41646e-09,-8.10989e-14,-21759.9,-75.3396], Tmin=(1374.56,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-136.575,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(536.283,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + ring(Oxetane) + radical(C2CsJOH)"""),
)

species(
    label = '[CH2]C(C)C1(CC)OC=C1O(14391)',
    structure = SMILES('[CH2]C(C)C1(CC)OC=C1O'),
    E0 = (-176.176,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3615,1277.5,1000,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2950,1000,300,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (141.188,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.62875,0.0915296,1.17493e-05,-1.09691e-07,5.75998e-11,-20956.3,36.8027], Tmin=(100,'K'), Tmax=(914.987,'K')), NASAPolynomial(coeffs=[35.7728,0.0130006,1.17798e-06,-4.87114e-10,2.90348e-14,-31357.8,-159.753], Tmin=(914.987,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-176.176,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(532.126,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + ring(Cyclobutene) + radical(Isobutyl)"""),
)
...
species(
    label = '[CH2]C(C)C1OCC=1O(14392)',
    structure = SMILES('[CH2]C(C)C1OCC=1O'),
    E0 = (-100.846,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,3150,900,1100,2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1277.5,1000,3000,3100,440,815,1455,1000,1380,1390,370,380,2900,435,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.180347,0.0604065,1.9177e-05,-8.69063e-08,4.34373e-11,-11969.5,28.5113], Tmin=(100,'K'), Tmax=(918.946,'K')), NASAPolynomial(coeffs=[25.8066,0.0104472,1.97301e-07,-2.06833e-10,9.91261e-15,-19279.7,-107.103], Tmin=(918.946,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-100.846,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(390.78,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsOs) + ring(Cyclobutene) + radical(Isobutyl)"""),
)
...
species(
    label = '[CH2]C(C)C1(CC)OCC1[O](14393)',
    structure = SMILES('[CH2]C(C)C1(CC)OCC1[O]'),
    E0 = (8.08394,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (142.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.984812,0.0956219,-3.71623e-05,-2.91651e-08,2.2596e-11,1164.95,36.9881], Tmin=(100,'K'), Tmax=(892.678,'K')), NASAPolynomial(coeffs=[20.3342,0.0401237,-1.11705e-05,1.65752e-09,-1.04324e-13,-4236.19,-72.3769], Tmin=(892.678,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(8.08394,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(561.227,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Oxetane) + radical(CC(C)OJ) + radical(Isobutyl)"""),
)

species(
    label = 'CCC1(OC[C]1O)[C](C)C(14394)',
    structure = SMILES('CCC1(OC[C]1O)[C](C)C'),
    E0 = (-98.1574,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (142.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.06932,0.100327,-5.77129e-05,-1.61247e-09,1.06811e-11,-11612.8,35.3178], Tmin=(100,'K'), Tmax=(914.625,'K')), NASAPolynomial(coeffs=[18.7031,0.0437578,-1.3979e-05,2.25592e-09,-1.46846e-13,-16480.4,-65.1458], Tmin=(914.625,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-98.1574,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(557.07,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Oxetane) + radical(CCJ(C)CO) + radical(C2CsJOH)"""),
)

species(
    label = '[CH2]C(C)C1(CC)O[CH]C1O(14395)',
    structure = SMILES('[CH2]C(C)C1(CC)O[CH]C1O'),
    E0 = (-41.8208,'kJ/mol'),
    modes = [
...
species(
    label = '[CH2][C](C)C1(CC)OCC1O(14396)',
    structure = SMILES('[CH2][C](C)C1(CC)OCC1O'),
    E0 = (-69.7029,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (142.196,'amu'),
...
species(
    label = '[CH2]C(C)C1([CH]C)OCC1O(14397)',
    structure = SMILES('[CH2]C(C)C1([CH]C)OCC1O'),
    E0 = (-22.3748,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,3025,407.5,1350,352.5,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3615,1277.5,1000,1380,1390,370,380,2900,435,2750,2950,3150,900,1000,1100,300,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (142.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.946441,0.0943015,-3.39685e-05,-3.4456e-08,2.53146e-11,-2499.23,39.5401], Tmin=(100,'K'), Tmax=(885.012,'K')), NASAPolynomial(coeffs=[20.9717,0.0376089,-9.69458e-06,1.35521e-09,-8.27396e-14,-8038.13,-72.8994], Tmin=(885.012,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-22.3748,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(557.07,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Oxetane) + radical(Isobutyl) + radical(CCJCO)"""),
)

species(
    label = 'C[CH]C1(OC[C]1O)C(C)C(14398)',
    structure = SMILES('C[CH]C1(OC[C]1O)C(C)C'),
    E0 = (-50.8293,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (142.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.04059,0.112219,-9.6641e-05,4.51687e-08,-8.31559e-12,-5878.31,41.1099], Tmin=(100,'K'), Tmax=(1451.82,'K')), NASAPolynomial(coeffs=[22.0644,0.0372127,-1.02677e-05,1.42985e-09,-8.18614e-14,-11972,-81.0509], Tmin=(1451.82,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-50.8293,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(557.07,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Oxetane) + radical(CCJCO) + radical(C2CsJOH)"""),
)

species(
    label = '[CH2]C([CH2])C1(CC)OCC1O(14399)',
    structure = SMILES('[CH2]C([CH2])C1(CC)OCC1O'),
    E0 = (-17.1945,'kJ/mol'),
    modes = [
...
species(
    label = '[CH2]CC1(OCC1O)C([CH2])C(14400)',
    structure = SMILES('[CH2]CC1(OCC1O)C([CH2])C'),
    E0 = (-17.0305,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1277.5,1000,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2950,3150,900,1000,1100,300,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'CCC1(O[CH][C]1O)C(C)C(14401)',
    structure = SMILES('CCC1(O[CH][C]1O)C(C)C'),
    E0 = (-70.2753,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (142.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.3465,0.122381,-0.000117956,6.09777e-08,-1.23008e-11,-8209,39.1456], Tmin=(100,'K'), Tmax=(1324.57,'K')), NASAPolynomial(coeffs=[23.5016,0.0354116,-9.37637e-06,1.24907e-09,-6.88192e-14,-14274.7,-89.8709], Tmin=(1324.57,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-70.2753,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(557.07,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Oxetane) + radical(C2CsJOH) + radical(CCsJOCs)"""),
)

species(
    label = '[CH2]CC1(OC[C]1O)C(C)C(14402)',
    structure = SMILES('[CH2]CC1(OC[C]1O)C(C)C'),
    E0 = (-45.485,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3615,1277.5,1000,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,3150,900,1100,300,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (142.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.87312,0.114454,-0.00010323,5.13166e-08,-1.01683e-11,-5246.65,39.7908], Tmin=(100,'K'), Tmax=(1292.21,'K')), NASAPolynomial(coeffs=[20.8355,0.0400245,-1.20308e-05,1.78918e-09,-1.07175e-13,-10770.2,-74.2503], Tmin=(1292.21,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-45.485,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(557.07,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Oxetane) + radical(C2CsJOH) + radical(RCCJ)"""),
)

species(
    label = 'CCC1(OC[C]1[O])C(C)C(14403)',
    structure = SMILES('CCC1(OC[C]1[O])C(C)C'),
    E0 = (-20.3706,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (142.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.18332,0.103042,-6.33568e-05,3.32843e-09,9.07421e-12,-2253.27,35.3398], Tmin=(100,'K'), Tmax=(916.06,'K')), NASAPolynomial(coeffs=[19.1171,0.0436496,-1.39984e-05,2.26306e-09,-1.47348e-13,-7199.81,-67.5168], Tmin=(916.06,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-20.3706,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(561.227,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Oxetane) + radical(C2CsJOH) + radical(CC(C)OJ)"""),
)
...
species(
    label = '[CH2]C(C)C(CC)=C(O)C[O](14404)',
    structure = SMILES('[CH2]C(C)C(CC)=C(O)C[O]'),
    E0 = (-78.7229,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (142.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.17555,0.11053,-9.79465e-05,4.7942e-08,-9.67783e-12,-9279.09,42.5848], Tmin=(100,'K'), Tmax=(1176.69,'K')), NASAPolynomial(coeffs=[16.9199,0.0490164,-1.95312e-05,3.5148e-09,-2.38778e-13,-13537.6,-47.6596], Tmin=(1176.69,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-78.7229,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(552.912,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + longDistanceInteraction_noncyclic(CdCs-ST) + group(Cds-CdsCsOs) + radical(CCOJ) + radical(Isobutyl)"""),
)

species(
    label = 'C=C(C)C1(CC)OCC1O(14405)',
    structure = SMILES('C=C(C)C1(CC)OCC1O'),
    E0 = (-313.203,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (142.196,'amu'),
...
species(
    label = 'CCC1(OCC1=O)C(C)C(14406)',
    structure = SMILES('CCC1(OCC1=O)C(C)C'),
    E0 = (-338.856,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (142.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.00843,0.0912292,-2.78775e-05,-2.87191e-08,1.71911e-11,-40558.1,34.2744], Tmin=(100,'K'), Tmax=(1018.62,'K')), NASAPolynomial(coeffs=[21.5763,0.043118,-1.67814e-05,3.12477e-09,-2.22143e-13,-47264.2,-85.4333], Tmin=(1018.62,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-338.856,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(561.227,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-O2d)CsCsOs) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)OsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdCsCs) + ring(Cyclobutane)"""),
)

species(
    label = 'CCC1(OC=C1O)C(C)C(14407)',
    structure = SMILES('CCC1(OC=C1O)C(C)C'),
    E0 = (-381.258,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (142.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.65771,0.0900034,2.35186e-05,-1.20902e-07,6.04692e-11,-45619.2,34.4302], Tmin=(100,'K'), Tmax=(926.678,'K')), NASAPolynomial(coeffs=[35.9215,0.0164727,-1.00258e-06,6.91166e-12,-9.34243e-15,-56391.5,-164.55], Tmin=(926.678,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-381.258,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(557.07,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + ring(Cyclobutene)"""),
)
...
species(
    label = '[CH2]CC1(CC)OC[C]1O(6526)',
    structure = SMILES('[CH2]CC1(CC)OC[C]1O'),
    E0 = (-12.6632,'kJ/mol'),
    modes = [
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.09725,0.100556,-9.39173e-05,4.86874e-08,-1.00347e-11,-1329.69,35.7316], Tmin=(100,'K'), Tmax=(1257.71,'K')), NASAPolynomial(coeffs=[18.1431,0.034871,-1.02201e-05,1.48205e-09,-8.69278e-14,-5814.08,-60.0908], Tmin=(1257.71,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-12.6632,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(486.397,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Oxetane) + radical(C2CsJOH) + radical(RCCJ)"""),
)

species(
    label = '[CH2]C(C)C1(C)OC[C]1O(14408)',
    structure = SMILES('[CH2]C(C)C1(C)OC[C]1O'),
    E0 = (-21.8688,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,3150,900,1100,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3615,1277.5,1000,3000,3100,440,815,1455,1000,1380,1390,370,380,2900,435,300,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (128.169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.32996,0.10169,-9.55348e-05,4.93583e-08,-9.93436e-12,-2425.02,36.279], Tmin=(100,'K'), Tmax=(1367.1,'K')), NASAPolynomial(coeffs=[18.775,0.0323064,-7.82104e-06,9.35279e-10,-4.62148e-14,-6935.43,-63.3938], Tmin=(1367.1,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-21.8688,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(486.397,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Oxetane) + radical(Isobutyl) + radical(C2CsJOH)"""),
)
...
species(
    label = '[CH2]C(C)[C]1OCC1(O)CC(14409)',
    structure = SMILES('[CH2]C(C)[C]1OCC1(O)CC'),
    E0 = (-41.573,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3615,1277.5,1000,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,3150,900,1100,300,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'C[CH]C1(CC)OC[C]1O(8939)',
    structure = SMILES('C[CH]C1(CC)OC[C]1O'),
    E0 = (-18.0075,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (128.169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.2393,0.0980555,-8.65475e-05,4.17067e-08,-7.89392e-12,-1962.55,36.957], Tmin=(100,'K'), Tmax=(1425.35,'K')), NASAPolynomial(coeffs=[19.2577,0.0322389,-8.55425e-06,1.14461e-09,-6.33601e-14,-6962.99,-66.2378], Tmin=(1425.35,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-18.0075,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(486.397,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Oxetane) + radical(CCJCO) + radical(C2CsJOH)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', '[CH2]C(C)C1(CC)OCC1=O(14389)'],
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'C=C(C)C1(CC)OC[C]1O(14390)'],
    products = ['[CH2]C(C)C1(CC)OC[C]1O(6796)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', '[CH2]C(C)C1(CC)OC=C1O(14391)'],
    products = ['[CH2]C(C)C1(CC)OC[C]1O(6796)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['C2H5(29)', '[CH2]C(C)C1OCC=1O(14392)'],
    products = ['[CH2]C(C)C1(CC)OC[C]1O(6796)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['CH3(17)', 'C=CC1(CC)OC[C]1O(13723)'],
    products = ['[CH2]C(C)C1(CC)OC[C]1O(6796)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]C(C)C1(CC)OCC1[O](14393)'],
    products = ['[CH2]C(C)C1(CC)OC[C]1O(6796)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]C(C)C1(CC)OC[C]1O(6796)'],
    products = ['CCC1(OC[C]1O)[C](C)C(14394)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]C(C)C1(CC)O[CH]C1O(14395)'],
    products = ['[CH2]C(C)C1(CC)OC[C]1O(6796)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]C(C)C1(CC)OC[C]1O(6796)'],
    products = ['[CH2][C](C)C1(CC)OCC1O(14396)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2]C(C)C1([CH]C)OCC1O(14397)'],
    products = ['[CH2]C(C)C1(CC)OC[C]1O(6796)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]C(C)C1(CC)OC[C]1O(6796)'],
    products = ['C[CH]C1(OC[C]1O)C(C)C(14398)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]C([CH2])C1(CC)OCC1O(14399)'],
    products = ['[CH2]C(C)C1(CC)OC[C]1O(6796)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]CC1(OCC1O)C([CH2])C(14400)'],
    products = ['[CH2]C(C)C1(CC)OC[C]1O(6796)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]C(C)C1(CC)OC[C]1O(6796)'],
    products = ['CCC1(O[CH][C]1O)C(C)C(14401)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2]CC1(OC[C]1O)C(C)C(14402)'],
    products = ['[CH2]C(C)C1(CC)OC[C]1O(6796)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CCC1(OC[C]1[O])C(C)C(14403)'],
    products = ['[CH2]C(C)C1(CC)OC[C]1O(6796)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH2]C(C)C(CC)=C(O)C[O](14404)'],
    products = ['[CH2]C(C)C1(CC)OC[C]1O(6796)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH2]C(C)C1(CC)OC[C]1O(6796)'],
    products = ['C=C(C)C1(CC)OCC1O(14405)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[CH2]C(C)C1(CC)OC[C]1O(6796)'],
    products = ['CCC1(OCC1=O)C(C)C(14406)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[CH2]C(C)C1(CC)OC[C]1O(6796)'],
    products = ['CCC1(OC=C1O)C(C)C(14407)'],
...
reaction(
    label = 'reaction26',
    reactants = ['CH2(S)(23)', '[CH2]CC1(CC)OC[C]1O(6526)'],
    products = ['[CH2]C(C)C1(CC)OC[C]1O(6796)'],
...
reaction(
    label = 'reaction27',
    reactants = ['CH2(S)(23)', '[CH2]C(C)C1(C)OC[C]1O(14408)'],
    products = ['[CH2]C(C)C1(CC)OC[C]1O(6796)'],
...
reaction(
    label = 'reaction29',
    reactants = ['[CH2]C(C)[C]1OCC1(O)CC(14409)'],
    products = ['[CH2]C(C)C1(CC)OC[C]1O(6796)'],
...
reaction(
    label = 'reaction33',
    reactants = ['CH2(19)', 'C[CH]C1(CC)OC[C]1O(8939)'],
    products = ['[CH2]C(C)C1(CC)OC[C]1O(6796)'],
