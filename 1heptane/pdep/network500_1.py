...
species(
    label = '[CH2][CH]OOC(2203)',
    structure = SMILES('[CH2][CH]OOC'),
    E0 = (215.261,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,3025,407.5,1350,352.5],'cm^-1')),
        HinderedRotor(inertia=(2.26901,'amu*angstrom^2'), symmetry=1, barrier=(52.169,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00478136,'amu*angstrom^2'), symmetry=1, barrier=(5.72301,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.249078,'amu*angstrom^2'), symmetry=1, barrier=(5.72679,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.26837,'amu*angstrom^2'), symmetry=1, barrier=(52.1543,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (74.0785,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.32341,0.0431352,-2.54414e-05,-1.97262e-08,2.97236e-11,25944.1,19.2312], Tmin=(100,'K'), Tmax=(498.391,'K')), NASAPolynomial(coeffs=[5.06757,0.0303218,-1.45984e-05,2.85101e-09,-2.01972e-13,25556.2,6.75553], Tmin=(498.391,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(215.261,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(CJCOOH) + radical(CCsJOOC)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', '[CH2]OOC=C(960)'],
    products = ['[CH2]OO[CH]C(953)'],
    transitionState = 'TS2',
