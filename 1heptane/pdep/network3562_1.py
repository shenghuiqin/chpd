...
species(
    label = '[CH2][CH]C1CCC1CCC(19666)',
    structure = SMILES('[CH2][CH]C1CCC1CCC'),
    E0 = (276.677,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (124.223,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0621267,0.0702318,1.70596e-05,-6.11237e-08,2.51149e-11,33439.3,38.0686], Tmin=(100,'K'), Tmax=(1038.8,'K')), NASAPolynomial(coeffs=[15.6131,0.0534379,-2.15977e-05,4.05715e-09,-2.87679e-13,27832.1,-49.4658], Tmin=(1038.8,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(276.677,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(586.17,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Cyclobutane) + radical(RCCJ) + radical(Cs_S)"""),
)
...
species(
    label = '[CH2]C=CCCC=CCC(19667)',
    structure = SMILES('[CH2]C=CCCC=CCC'),
    E0 = (120.502,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,2995,3005,3015,3025,975,983.333,991.667,1000,1300,1325,1350,1375,400,433.333,466.667,500,1630,1646.67,1663.33,1680,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.579098,0.0860536,-3.38821e-05,-1.00879e-08,7.97534e-12,14670.3,38.2891], Tmin=(100,'K'), Tmax=(1096.12,'K')), NASAPolynomial(coeffs=[16.9824,0.0488249,-1.96896e-05,3.63417e-09,-2.52811e-13,9206.98,-55.4066], Tmin=(1096.12,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(120.502,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(557.07,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Allyl_P)"""),
)

species(
    label = '[CH2]C=CCC=CCCC(19668)',
    ...
    molecularWeight = (123.215,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.576678,0.0859179,-3.33154e-05,-1.08889e-08,8.31217e-12,14823,38.307], Tmin=(100,'K'), Tmax=(1091.53,'K')), NASAPolynomial(coeffs=[17.0284,0.0486689,-1.95968e-05,3.61732e-09,-2.51787e-13,9355.4,-55.6097], Tmin=(1091.53,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(121.772,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(557.07,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Allyl_P)"""),
)

species(
    label = 'C=C=CCC[CH]CCC(19669)',
    structure = SMILES('C=C=CCC[CH]CCC'),
    E0 = (223.394,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (123.215,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.235635,0.0890949,-5.76538e-05,2.03382e-08,-3.2137e-12,26997.7,35.9809], Tmin=(100,'K'), Tmax=(1331.14,'K')), NASAPolynomial(coeffs=[9.21738,0.0621052,-2.72401e-05,5.10625e-09,-3.52993e-13,24606.5,-9.91992], Tmin=(1331.14,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(223.394,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(557.07,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(RCCJCC)"""),
)
...
species(
    label = '[CH2]C=CCCC[CH]CC(19670)',
    structure = SMILES('[CH2]C=CCCC[CH]CC'),
    E0 = (198.289,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,2995,3025,975,1000,1300,1375,400,500,1630,1680,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,3025,407.5,1350,352.5,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2]C=CCCCC[CH]C(19672)',
    structure = SMILES('[CH2]C=CCCCC[CH]C'),
    E0 = (198.277,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (124.223,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.422471,0.0931647,-5.73387e-05,1.79713e-08,-2.34559e-12,24008.9,39.7504], Tmin=(100,'K'), Tmax=(1690.26,'K')), NASAPolynomial(coeffs=[16.6321,0.0528051,-2.15221e-05,3.84458e-09,-2.56162e-13,18243.6,-51.4796], Tmin=(1690.26,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(198.277,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(577.856,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(RCCJC) + radical(Allyl_P)"""),
)

species(
    label = '[CH2]C=C[CH]CCCCC(19673)',
    structure = SMILES('[CH2]C=C[CH]CCCCC'),
    E0 = (144.943,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (124.223,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.862172,0.092727,-4.57995e-05,2.26492e-09,3.40837e-12,17619.5,37.5019], Tmin=(100,'K'), Tmax=(1173.1,'K')), NASAPolynomial(coeffs=[17.4305,0.0518785,-2.10914e-05,3.86472e-09,-2.65857e-13,11846.5,-59.9829], Tmin=(1173.1,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(144.943,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(577.856,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Allyl_P) + radical(Allyl_S)"""),
)
...
species(
    label = '[CH2]C=CCCCCC[CH2](19675)',
    structure = SMILES('[CH2]C=CCCCCC[CH2]'),
    E0 = (209.077,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2761.11,2772.22,2783.33,2794.44,2805.56,2816.67,2827.78,2838.89,2850,1425,1431.25,1437.5,1443.75,1450,1225,1237.5,1250,1262.5,1275,1270,1287.5,1305,1322.5,1340,700,725,750,775,800,300,325,350,375,400,2995,3025,975,1000,1300,1375,400,500,1630,1680,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (124.223,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.07034,0.0990296,-6.54184e-05,2.1913e-08,-2.99004e-12,25338.9,41.1563], Tmin=(100,'K'), Tmax=(1684.65,'K')), NASAPolynomial(coeffs=[21.3239,0.0458574,-1.80745e-05,3.17771e-09,-2.09756e-13,17793.5,-78.5632], Tmin=(1684.65,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(209.077,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(577.856,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Allyl_P) + radical(RCCJ)"""),
)

species(
    label = '[CH2]C=[C]CCCCCC(19676)',
    structure = SMILES('[CH2]C=[C]CCCCCC'),
    E0 = (241.673,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (124.223,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.739892,0.0985296,-6.5959e-05,2.28028e-08,-3.2743e-12,29241.2,38.6313], Tmin=(100,'K'), Tmax=(1572.64,'K')), NASAPolynomial(coeffs=[17.7132,0.0515945,-2.11922e-05,3.82549e-09,-2.57536e-13,23437.1,-58.749], Tmin=(1572.64,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(241.673,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(577.856,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Allyl_P) + radical(Cds_S)"""),
)

species(
    label = 'CC=C[CH]C[CH]CCC(19677)',
    structure = SMILES('CC=C[CH]C[CH]CCC'),
    E0 = (187.903,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (124.223,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.251611,0.0860827,-4.63946e-05,1.18508e-08,-1.22459e-12,22729.1,35.743], Tmin=(100,'K'), Tmax=(2061.09,'K')), NASAPolynomial(coeffs=[17.855,0.0519193,-2.15314e-05,3.80863e-09,-2.49117e-13,15472.7,-61.9145], Tmin=(2061.09,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(187.903,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(577.856,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(RCCJCC) + radical(Allyl_S)"""),
)

species(
    label = '[CH2][C]=CCCCCCC(19678)',
    structure = SMILES('[CH2][C]=CCCCCCC'),
    E0 = (241.673,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2761.11,2772.22,2783.33,2794.44,2805.56,2816.67,2827.78,2838.89,2850,1425,1431.25,1437.5,1443.75,1450,1225,1237.5,1250,1262.5,1275,1270,1287.5,1305,1322.5,1340,700,725,750,775,800,300,325,350,375,400,1685,370,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,3010,987.5,1337.5,450,1655,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'CC=CC[CH][CH]CCC(19679)',
    structure = SMILES('CC=CC[CH][CH]CCC'),
    E0 = (241.248,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (124.223,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.64211,0.0777581,-3.64557e-05,7.33291e-09,-5.54819e-13,29071.6,34.2822], Tmin=(100,'K'), Tmax=(3149.04,'K')), NASAPolynomial(coeffs=[49.2946,0.0172288,-7.62351e-06,1.22902e-09,-7.02377e-14,-940.406,-250.276], Tmin=(3149.04,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(241.248,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(577.856,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(RCCJCC) + radical(RCCJCC)"""),
)

species(
    label = 'CC=CCC[CH][CH]CC(19680)',
    structure = SMILES('CC=CCC[CH][CH]CC'),
    E0 = (241.248,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2995,3025,975,1000,1300,1375,400,500,1630,1680,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3000,3050,390,425,1340,1360,335,370,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'C[CH]C[CH]CCC=CC(19681)',
    structure = SMILES('C[CH]C[CH]CCC=CC'),
    E0 = (241.236,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2995,3025,975,1000,1300,1375,400,500,1630,1680,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3000,3050,390,425,1340,1360,335,370,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (124.223,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0643319,0.0932925,-8.01242e-05,5.65727e-08,-2.03508e-11,29149.5,40.3011], Tmin=(100,'K'), Tmax=(717.321,'K')), NASAPolynomial(coeffs=[2.77996,0.0745882,-3.35645e-05,6.38001e-09,-4.45613e-13,28851.5,28.7406], Tmin=(717.321,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(241.236,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(577.856,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(RCCJC) + radical(RCCJCC)"""),
)
...
species(
    label = 'CCC[CH]CCC1[CH]C1(19682)',
    structure = SMILES('CCC[CH]CCC1[CH]C1'),
    E0 = (310.721,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (124.223,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.319783,0.0844853,-4.10815e-05,7.28578e-09,2.62281e-14,37535.3,40.5604], Tmin=(100,'K'), Tmax=(1528.15,'K')), NASAPolynomial(coeffs=[16.9639,0.0515153,-2.07637e-05,3.67657e-09,-2.42957e-13,30820.1,-54.8403], Tmin=(1528.15,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(310.721,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(582.013,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(RCCJCC) + radical(cyclopropane)"""),
)

species(
    label = '[CH2]C1[CH]CCC1CCC(19294)',
    structure = SMILES('[CH2]C1[CH]CCC1CCC'),
    E0 = (194.747,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (124.223,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.304959,0.0595829,4.84869e-05,-9.66388e-08,3.90629e-11,23574.9,36.9339], Tmin=(100,'K'), Tmax=(982.579,'K')), NASAPolynomial(coeffs=[15.2944,0.0511036,-1.87782e-05,3.42074e-09,-2.4197e-13,18092.9,-48.0244], Tmin=(982.579,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(194.747,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(590.328,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Cyclopentane) + radical(Isobutyl) + radical(Cs_S)"""),
)

species(
    label = 'CC=CCC=CCCC(19683)',
    structure = SMILES('CC=CCC=CCCC'),
    E0 = (-29.7272,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (124.223,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.661899,0.0892377,-4.38853e-05,3.82112e-09,2.27443e-12,-3396.63,38.3444], Tmin=(100,'K'), Tmax=(1226.07,'K')), NASAPolynomial(coeffs=[16.5,0.0519205,-2.10758e-05,3.84049e-09,-2.62397e-13,-9008.47,-53.6735], Tmin=(1226.07,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-29.7272,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(582.013,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH)"""),
)

species(
    label = 'C=C=CCCCCCC(19684)',
    structure = SMILES('C=C=CCCCCCC'),
    E0 = (28.9359,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (124.223,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.822139,0.0977473,-6.40246e-05,2.13668e-08,-2.93306e-12,3660.11,37.2362], Tmin=(100,'K'), Tmax=(1652.33,'K')), NASAPolynomial(coeffs=[19.2774,0.0490891,-1.98515e-05,3.54392e-09,-2.36395e-13,-2981.99,-69.8257], Tmin=(1652.33,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(28.9359,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(582.013,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cdd-CdsCds)"""),
)

species(
    label = 'CC=CCCC=CCC(19685)',
    structure = SMILES('CC=CCCC=CCC'),
    E0 = (-30.9967,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (124.223,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.666495,0.089388,-4.44546e-05,4.56311e-09,1.98613e-12,-3549.21,38.335], Tmin=(100,'K'), Tmax=(1238.23,'K')), NASAPolynomial(coeffs=[16.5638,0.0519098,-2.10802e-05,3.83774e-09,-2.61873e-13,-9210.1,-54.1014], Tmin=(1238.23,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-30.9967,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(582.013,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH)"""),
)
...
species(
    label = '[CH2]C=CCCC([CH2])CC(19686)',
    structure = SMILES('[CH2]C=CCCC([CH2])CC'),
    E0 = (206.566,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (124.223,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.00456,0.0969264,-5.70261e-05,1.14194e-08,1.13568e-12,25035.3,40.6139], Tmin=(100,'K'), Tmax=(1133.17,'K')), NASAPolynomial(coeffs=[17.3478,0.0503351,-1.94316e-05,3.46811e-09,-2.35473e-13,19708.1,-55.3731], Tmin=(1133.17,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(206.566,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(577.856,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Allyl_P) + radical(Isobutyl)"""),
)
...
species(
    label = '[CH]=CCC[CH]CCC(3382)',
    structure = SMILES('[CH]=CCC[CH]CCC'),
    E0 = (329.912,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (110.197,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.688227,0.0784142,-4.84868e-05,1.60298e-08,-2.35678e-12,39793,33.8947], Tmin=(100,'K'), Tmax=(1409.74,'K')), NASAPolynomial(coeffs=[8.78258,0.0554471,-2.40489e-05,4.47303e-09,-3.07313e-13,37510.8,-7.93542], Tmin=(1409.74,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(329.912,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_P) + radical(RCCJCC)"""),
)

species(
    label = 'C=CC=CC[CH]CCC(19687)',
    structure = SMILES('C=CC=CC[CH]CCC'),
    E0 = (158.368,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (123.215,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.54376,0.091925,-5.96641e-05,1.99893e-08,-2.76981e-12,19217,38.3307], Tmin=(100,'K'), Tmax=(1633.85,'K')), NASAPolynomial(coeffs=[17.6171,0.0474639,-1.88457e-05,3.33414e-09,-2.21379e-13,13282.5,-58.2009], Tmin=(1633.85,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(158.368,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(557.07,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + radical(RCCJCC)"""),
)

species(
    label = 'C=CC[CH]C[CH]CCC(19664)',
    structure = SMILES('C=CC[CH]C[CH]CCC'),
    E0 = (253.494,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,2950,3100,1380,975,1025,1650,3010,987.5,1337.5,450,1655,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3050,390,425,1340,1360,335,370,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (124.223,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0637178,0.0934159,-8.01103e-05,5.65342e-08,-2.04161e-11,30623.6,40.5712], Tmin=(100,'K'), Tmax=(712.024,'K')), NASAPolynomial(coeffs=[2.74752,0.0749013,-3.38642e-05,6.45349e-09,-4.51487e-13,30328.6,29.1468], Tmin=(712.024,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(253.494,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(577.856,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(RCCJCC) + radical(RCCJCC)"""),
)

species(
    label = 'C=[C]CCC[CH]CCC(19688)',
    structure = SMILES('C=[C]CCC[CH]CCC'),
    E0 = (296.877,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (124.223,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0901621,0.093723,-6.6795e-05,2.94715e-08,-6.26446e-12,35840.3,38.3936], Tmin=(100,'K'), Tmax=(1004.69,'K')), NASAPolynomial(coeffs=[6.04649,0.0700094,-3.13912e-05,5.97959e-09,-4.19007e-13,34643.5,9.62981], Tmin=(1004.69,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(296.877,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(577.856,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(RCCJCC) + radical(Cds_S)"""),
)

species(
    label = 'C=CCC[CH][CH]CCC(19689)',
    structure = SMILES('C=CCC[CH][CH]CCC'),
    E0 = (253.494,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,2950,3100,1380,975,1025,1650,3010,987.5,1337.5,450,1655,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3050,390,425,1340,1360,335,370,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH]=CCCC[CH]CCC(19690)',
    structure = SMILES('[CH]=CCCC[CH]CCC'),
    E0 = (306.131,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (124.223,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0644636,0.0928529,-6.08817e-05,2.20254e-08,-3.5838e-12,36955,38.3858], Tmin=(100,'K'), Tmax=(1299.73,'K')), NASAPolynomial(coeffs=[9.24554,0.0645975,-2.82725e-05,5.29926e-09,-3.66567e-13,34568.4,-8.31443], Tmin=(1299.73,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(306.131,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(577.856,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_P) + radical(RCCJCC)"""),
)

species(
    label = 'C=CCCC[CH][CH]CC(19691)',
    structure = SMILES('C=CCCC[CH][CH]CC'),
    E0 = (253.494,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,2950,3100,1380,975,1025,1650,3010,987.5,1337.5,450,1655,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3050,390,425,1340,1360,335,370,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'C=CCCC[CH]C[CH]C(19692)',
    structure = SMILES('C=CCCC[CH]C[CH]C'),
    E0 = (253.482,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,2950,3100,1380,975,1025,1650,3010,987.5,1337.5,450,1655,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3050,390,425,1340,1360,335,370,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (124.223,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.906902,0.0791893,-4.65589e-06,-9.41507e-08,8.27181e-11,30587.1,37.8983], Tmin=(100,'K'), Tmax=(486.215,'K')), NASAPolynomial(coeffs=[3.29569,0.0740098,-3.33256e-05,6.3788e-09,-4.49317e-13,30183.7,26.3371], Tmin=(486.215,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(253.482,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(577.856,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(RCCJC) + radical(RCCJCC)"""),
)

species(
    label = '[CH]=C[CH]CCCCCC(19693)',
    structure = SMILES('[CH]C=CCCCCCC'),
    E0 = (223.016,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2761.11,2772.22,2783.33,2794.44,2805.56,2816.67,2827.78,2838.89,2850,1425,1431.25,1437.5,1443.75,1450,1225,1237.5,1250,1262.5,1275,1270,1287.5,1305,1322.5,1340,700,725,750,775,800,300,325,350,375,400,2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,200,800,933.333,1066.67,1200,1333.33,1466.67,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (124.223,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.04189,0.099881,-5.99179e-05,1.78446e-08,-2.16703e-12,27013,40.0999], Tmin=(100,'K'), Tmax=(1850.46,'K')), NASAPolynomial(coeffs=[21.7164,0.050686,-2.00401e-05,3.47785e-09,-2.26055e-13,18590.3,-83.7022], Tmin=(1850.46,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(223.016,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(577.856,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[CH2]CC[CH]CCCC=C(19694)',
    structure = SMILES('[CH2]CC[CH]CCCC=C'),
    E0 = (264.282,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (124.223,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.204888,0.0898995,-5.47105e-05,1.74425e-08,-2.44121e-12,31915.8,39.2495], Tmin=(100,'K'), Tmax=(1478.19,'K')), NASAPolynomial(coeffs=[10.2063,0.0628353,-2.72469e-05,5.05628e-09,-3.4637e-13,28959,-12.9103], Tmin=(1478.19,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(264.282,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(577.856,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(RCCJ) + radical(RCCJCC)"""),
)
...
species(
    label = 'C=CCCC=CCCC(19695)',
    structure = SMILES('C=CCCC=CCCC'),
    E0 = (-18.7513,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (124.223,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.678332,0.0888666,-3.93107e-05,-2.84774e-09,4.93839e-12,-2075.22,38.8082], Tmin=(100,'K'), Tmax=(1152.34,'K')), NASAPolynomial(coeffs=[16.5871,0.0518821,-2.10382e-05,3.86192e-09,-2.66351e-13,-7577.91,-53.5463], Tmin=(1152.34,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-18.7513,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(582.013,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH)"""),
)

species(
    label = 'C=CC=CCCCCC(19696)',
    structure = SMILES('C=CC=CCCCCC'),
    E0 = (-36.0906,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (124.223,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.918573,0.0930128,-4.19955e-05,-6.60736e-09,7.78624e-12,-4150.71,37.1054], Tmin=(100,'K'), Tmax=(1071.43,'K')), NASAPolynomial(coeffs=[18.3748,0.0488685,-1.92314e-05,3.5187e-09,-2.44271e-13,-9885.5,-64.774], Tmin=(1071.43,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-36.0906,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(582.013,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH)"""),
)

species(
    label = 'C=CCCCC=CCC(19697)',
    structure = SMILES('C=CCCCC=CCC'),
    E0 = (-18.7513,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (124.223,'amu'),
...
species(
    label = 'C=CC1CCC1CCC(18968)',
    structure = SMILES('C=CC1CCC1CCC'),
    E0 = (5.74062,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (124.223,'amu'),
...
reaction(
    label = 'reaction1',
    reactants = ['C=C[CH]CC[CH]CCC(18962)'],
...
reaction(
    label = 'reaction2',
    reactants = ['C=C[CH]CC[CH]CCC(18962)'],
    products = ['[CH2][CH]C1CCC1CCC(19666)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', '[CH2]C=CCCC=CCC(19667)'],
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', '[CH2]C=CCC=CCCC(19668)'],
    products = ['C=C[CH]CC[CH]CCC(18962)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(1.46e+08,'cm^3/(mol*s)'), n=1.64, Ea=(5.73208,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""From training reaction 2555 used for Cds-CsH_Cds-CsH;HJ
Exact match found for rate rule [Cds-CsH_Cds-CsH;HJ]
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)', 'C=C=CCC[CH]CCC(19669)'],
    products = ['C=C[CH]CC[CH]CCC(18962)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['C2H5(29)', '[CH2]C=CCCC=C(19224)'],
    products = ['C=C[CH]CC[CH]CCC(18962)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]C=CCCC[CH]CC(19670)'],
    products = ['C=C[CH]CC[CH]CCC(18962)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction11',
    reactants = ['C=C[CH]CC[CH]CCC(18962)'],
    products = ['[CH2]C=CCCCC[CH]C(19672)'],
...
reaction(
    label = 'reaction12',
    reactants = ['C=C[CH]CC[CH]CCC(18962)'],
    products = ['[CH2]C=C[CH]CCCCC(19673)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]C=CCCCCC[CH2](19675)'],
    products = ['C=C[CH]CC[CH]CCC(18962)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]C=[C]CCCCCC(19676)'],
    products = ['C=C[CH]CC[CH]CCC(18962)'],
...
reaction(
    label = 'reaction16',
    reactants = ['C=C[CH]CC[CH]CCC(18962)'],
    products = ['CC=C[CH]C[CH]CCC(19677)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CC=CC[CH][CH]CCC(19679)'],
    products = ['C=C[CH]CC[CH]CCC(18962)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CC=CCC[CH][CH]CC(19680)'],
    products = ['C=C[CH]CC[CH]CCC(18962)'],
...
reaction(
    label = 'reaction20',
    reactants = ['C[CH]C[CH]CCC=CC(19681)'],
    products = ['C=C[CH]CC[CH]CCC(18962)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH2]C[CH]CCC(203)', '[CH]=C[CH2](2461)'],
    products = ['C=C[CH]CC[CH]CCC(18962)'],
...
reaction(
    label = 'reaction23',
    reactants = ['C=C[CH]CC[CH]CCC(18962)'],
    products = ['CCC[CH]CCC1[CH]C1(19682)'],
...
reaction(
    label = 'reaction24',
    reactants = ['C=C[CH]CC[CH]CCC(18962)'],
    products = ['[CH2]C1[CH]CCC1CCC(19294)'],
...
reaction(
    label = 'reaction28',
    reactants = ['CH2(S)(23)', 'C=C[CH]CC[CH]CC(18956)'],
    products = ['C=C[CH]CC[CH]CCC(18962)'],
...
reaction(
    label = 'reaction29',
    reactants = ['[CH2]C=CCCC([CH2])CC(19686)'],
    products = ['C=C[CH]CC[CH]CCC(18962)'],
...
reaction(
    label = 'reaction32',
    reactants = ['[CH]CCC(133)', '[CH2]C=CC[CH2](18993)'],
    products = ['C=C[CH]CC[CH]CCC(18962)'],
...
reaction(
    label = 'reaction33',
    reactants = ['CH2(19)', '[CH]=CCC[CH]CCC(3382)'],
    products = ['C=C[CH]CC[CH]CCC(18962)'],
...
reaction(
    label = 'reaction34',
    reactants = ['H(3)', 'C=CC=CC[CH]CCC(19687)'],
    products = ['C=C[CH]CC[CH]CCC(18962)'],
...
reaction(
    label = 'reaction36',
    reactants = ['C=CC[CH]C[CH]CCC(19664)'],
    products = ['C=C[CH]CC[CH]CCC(18962)'],
...
reaction(
    label = 'reaction37',
    reactants = ['C=[C]CCC[CH]CCC(19688)'],
    products = ['C=C[CH]CC[CH]CCC(18962)'],
...
reaction(
    label = 'reaction38',
    reactants = ['C=CCC[CH][CH]CCC(19689)'],
    products = ['C=C[CH]CC[CH]CCC(18962)'],
...
reaction(
    label = 'reaction40',
    reactants = ['C=CCCC[CH][CH]CC(19691)'],
    products = ['C=C[CH]CC[CH]CCC(18962)'],
...
reaction(
    label = 'reaction41',
    reactants = ['C=CCCC[CH]C[CH]C(19692)'],
    products = ['C=C[CH]CC[CH]CCC(18962)'],
...
reaction(
    label = 'reaction42',
    reactants = ['[CH]=C[CH]CCCCCC(19693)'],
    products = ['C=C[CH]CC[CH]CCC(18962)'],
...
reaction(
    label = 'reaction43',
    reactants = ['[CH2]CC[CH]CCCC=C(19694)'],
    products = ['C=C[CH]CC[CH]CCC(18962)'],
