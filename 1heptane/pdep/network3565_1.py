...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.651134,0.0988222,-7.44477e-05,3.09491e-08,-5.42826e-12,21191.4,36.7978], Tmin=(100,'K'), Tmax=(1314.03,'K')), NASAPolynomial(coeffs=[14.7743,0.051866,-2.08457e-05,3.75425e-09,-2.54288e-13,17137.6,-41.8334], Tmin=(1314.03,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(174.782,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(557.07,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)CsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Isobutyl)"""),
)
...
species(
    label = '[CH2]C(C=C)C(C)[CH]CC(19282)',
    structure = SMILES('[CH2]C(C=C)C(C)[CH]CC'),
    E0 = (253.882,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (124.223,'amu'),
...
species(
    label = '[CH2]C(C=C)C(C)C[CH]C(19287)',
    structure = SMILES('[CH2]C(C=C)C(C)C[CH]C'),
    E0 = (253.787,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (124.223,'amu'),
...
species(
    label = '[CH]=CC([CH2])C(C)CCC(19290)',
    structure = SMILES('[CH]=CC([CH2])C(C)CCC'),
    E0 = (306.436,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,3010,987.5,1337.5,450,1655,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3100,440,815,1455,1000,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (124.223,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.32089,0.10215,-7.27915e-05,2.74484e-08,-4.22768e-12,37059.7,42.0799], Tmin=(100,'K'), Tmax=(1522.81,'K')), NASAPolynomial(coeffs=[20.4258,0.0450267,-1.65232e-05,2.81449e-09,-1.83485e-13,30436.6,-71.981], Tmin=(1522.81,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(306.436,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(577.856,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsCsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Isobutyl) + radical(Cds_P)"""),
)

species(
    label = '[CH2]CCC(C)C([CH2])C=C(19291)',
    structure = SMILES('[CH2]CCC(C)C([CH2])C=C'),
    E0 = (264.587,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3010,987.5,1337.5,450,1655,2750,2800,2850,1350,1500,750,1050,1375,1000,2950,3100,1380,975,1025,1650,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    ...
    molecularWeight = (110.197,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.113648,0.0815702,-5.14754e-05,1.6841e-08,-2.27803e-12,33832.6,37.9298], Tmin=(100,'K'), Tmax=(1674.43,'K')), NASAPolynomial(coeffs=[16.3408,0.0422629,-1.6263e-05,2.82148e-09,-1.8486e-13,28322.2,-49.9352], Tmin=(1674.43,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(280.01,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Isobutyl) + radical(Cs_S)"""),
)

species(
    label = '[CH2]C([CH]C=C)CCC(19299)',
    structure = SMILES('[CH2]C=CC([CH2])CCC'),
    E0 = (224.721,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (110.197,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.188267,0.0799377,-3.53415e-05,-6.45283e-09,7.20643e-12,27189,35.4686], Tmin=(100,'K'), Tmax=(1041.26,'K')), NASAPolynomial(coeffs=[15.314,0.0436384,-1.65474e-05,2.96112e-09,-2.03094e-13,22700.1,-46.0009], Tmin=(1041.26,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(224.721,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Allyl_P) + radical(Isobutyl)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]C(C=C)C([CH2])CCC(18965)'],
    products = ['[CH2]C(CCC)C1CC1[CH2](19275)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', '[CH2]C(C=C)C(=C)CCC(19277)'],
...
reaction(
    label = 'reaction7',
    reactants = ['npropyl(83)', '[CH2]C(C=C)C=C(18999)'],
    products = ['[CH2]C(C=C)C([CH2])CCC(18965)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]C(C=C)CCC(440)', 'C2H3(30)'],
    products = ['[CH2]C(C=C)C([CH2])CCC(18965)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]C(C=C)C([CH2])CCC(18965)'],
    products = ['[CH2]C(C=C)[C](C)CCC(19279)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2]C(C=C)C([CH2])CCC(18965)'],
    products = ['[CH2]C(C=C)C(C)[CH]CC(19282)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2]C(C=C)C([CH2])CCC(18965)'],
    products = ['[CH2]C(C=C)C(C)C[CH]C(19287)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH]=CC([CH2])C(C)CCC(19290)'],
    products = ['[CH2]C(C=C)C([CH2])CCC(18965)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH2]CCC(C)C([CH2])C=C(19291)'],
    products = ['[CH2]C(C=C)C([CH2])CCC(18965)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH2]CCC([CH2])C(C)C=C(19292)'],
    products = ['[CH2]C(C=C)C([CH2])CCC(18965)'],
...
reaction(
    label = 'reaction29',
    reactants = ['CH2(S)(23)', '[CH2]C(C=C)C([CH2])CC(18958)'],
    products = ['[CH2]C(C=C)C([CH2])CCC(18965)'],
...
reaction(
    label = 'reaction33',
    reactants = ['[CH2]C(C=C)C([CH2])CCC(18965)'],
    products = ['[CH2]C([CH]CC=C)CCC(19298)'],
...
reaction(
    label = 'reaction35',
    reactants = ['CH2(19)', '[CH2]C([CH]CCC)C=C(3417)'],
    products = ['[CH2]C(C=C)C([CH2])CCC(18965)'],
...
reaction(
    label = 'reaction36',
    reactants = ['CH2(19)', '[CH2]C([CH]C=C)CCC(19299)'],
    products = ['[CH2]C(C=C)C([CH2])CCC(18965)'],
