...
species(
    label = '[CH2]C1C=C1O[CH]CC(26669)',
    structure = SMILES('[CH2]C1C=C1O[CH]CC'),
    E0 = (382.889,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (110.154,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.777597,0.096339,-9.24877e-05,4.08054e-08,-5.50307e-12,46230.7,29.8172], Tmin=(100,'K'), Tmax=(972.707,'K')), NASAPolynomial(coeffs=[20.9867,0.0242335,-8.1185e-06,1.36532e-09,-9.1413e-14,41173.8,-78.8105], Tmin=(972.707,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(382.889,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)(Cds-Cds)CsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + ring(Cyclopropene) + radical(CCsJOC(O)) + radical(Isobutyl)"""),
)
...
species(
    label = '[CH]=C(C=C)OC=CC(26671)',
    structure = SMILES('[CH]=C(C=C)OC=CC'),
    E0 = (227.556,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,440,435,1725,2950,3100,1380,975,1025,1650,3120,650,792.5,1650,2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3010,3025,975,987.5,1000,1300,1337.5,1375,400,450,500,1630,1655,1680,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.787167,'amu*angstrom^2'), symmetry=1, barrier=(18.0985,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.788014,'amu*angstrom^2'), symmetry=1, barrier=(18.118,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.786464,'amu*angstrom^2'), symmetry=1, barrier=(18.0824,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.786926,'amu*angstrom^2'), symmetry=1, barrier=(18.093,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (109.146,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.27212,0.0832158,-7.50307e-05,3.47007e-08,-6.34631e-12,27531.5,30.6084], Tmin=(100,'K'), Tmax=(1326.9,'K')), NASAPolynomial(coeffs=[19.0763,0.0248892,-9.09515e-06,1.57303e-09,-1.04759e-13,22396.8,-68.2089], Tmin=(1326.9,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(227.556,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(390.78,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cs-(Cds-Cds)HHH) + group(Cds-Cds(Cds-Cds)O2s) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cds_P)"""),
)
...
species(
    label = 'C#CO[CH]CC(11159)',
    structure = SMILES('C#CO[CH]CC'),
    E0 = (180.495,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,750,770,3400,2100,2175,525,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(1.00032,'amu*angstrom^2'), symmetry=1, barrier=(22.9993,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.00012,'amu*angstrom^2'), symmetry=1, barrier=(22.9948,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.00006,'amu*angstrom^2'), symmetry=1, barrier=(22.9933,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.999883,'amu*angstrom^2'), symmetry=1, barrier=(22.9893,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (83.1085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.120658,0.0734495,-7.49582e-05,3.66788e-08,-6.74005e-12,21871.6,22.631], Tmin=(100,'K'), Tmax=(1505.77,'K')), NASAPolynomial(coeffs=[20.8638,0.00864114,-1.36854e-06,9.98731e-11,-3.18176e-15,16579.7,-83.7835], Tmin=(1505.77,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(180.495,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Ct-CtOs) + group(Ct-CtH) + radical(CCsJOCs)"""),
)

species(
    label = '[CH]=C(C=C)OC[CH]C(26673)',
    structure = SMILES('[CH]=C(C=C)OC[CH]C'),
    E0 = (284.383,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,2750,2800,2850,1350,1500,750,1050,1375,1000,2950,3100,1380,975,1025,1650,350,440,435,1725,2750,2850,1437.5,1250,1305,750,350,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (110.154,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.396191,0.0836027,-5.56191e-05,3.60836e-09,7.07511e-12,34373.3,31.6257], Tmin=(100,'K'), Tmax=(976.757,'K')), NASAPolynomial(coeffs=[21.2028,0.0239532,-8.2475e-06,1.46523e-09,-1.03318e-13,28780,-79.1022], Tmin=(976.757,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(284.383,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-Cds(Cds-Cds)O2s) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cds_P) + radical(CCJCO)"""),
)

species(
    label = '[CH]=C(C=C)OCC[CH2](26674)',
    structure = SMILES('[CH]=C(C=C)OCC[CH2]'),
    E0 = (289.727,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,350,440,435,1725,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3100,440,815,1455,1000,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (110.154,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.582156,0.089877,-7.57726e-05,2.66165e-08,-1.67695e-12,35020.6,31.5837], Tmin=(100,'K'), Tmax=(1017.17,'K')), NASAPolynomial(coeffs=[20.667,0.0255617,-9.31051e-06,1.65856e-09,-1.14845e-13,29702.2,-76.1871], Tmin=(1017.17,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(289.727,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-Cds(Cds-Cds)O2s) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(RCCJ) + radical(Cds_P)"""),
)

species(
    label = 'C=[C]C(=C)O[CH]CC(26675)',
    ...
    molecularWeight = (110.154,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.12862,0.103189,-0.000110333,5.98496e-08,-1.26265e-11,27892.4,30.4249], Tmin=(100,'K'), Tmax=(1167.66,'K')), NASAPolynomial(coeffs=[22.1925,0.023299,-7.70347e-06,1.25416e-09,-8.09566e-14,22446.2,-85.7008], Tmin=(1167.66,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(230.307,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-Cds(Cds-Cds)O2s) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(C=CJC=C) + radical(CCsJOC(O))"""),
)

species(
    label = '[CH]=C([C]=C)OCCC(26676)',
    ...
    molecularWeight = (110.154,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.716663,0.0906093,-7.34348e-05,3.06228e-08,-5.11613e-12,31473.7,31.8455], Tmin=(100,'K'), Tmax=(1431.92,'K')), NASAPolynomial(coeffs=[20.1998,0.0321803,-1.22278e-05,2.1263e-09,-1.40906e-13,25483.6,-76.5734], Tmin=(1431.92,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(260.184,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[CH]=CC(=C)O[CH]CC(26677)',
...
species(
    label = 'C=CC(=C)O[CH][CH]C(26678)',
    structure = SMILES('[CH2]C=C([CH2])OC=CC'),
    E0 = (166.387,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (110.154,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0617151,0.0789884,-5.62381e-05,1.47583e-08,6.0011e-13,20166.9,32.2053], Tmin=(100,'K'), Tmax=(1046.7,'K')), NASAPolynomial(coeffs=[17.1762,0.030432,-1.14726e-05,2.05429e-09,-1.41323e-13,15609.6,-56.2762], Tmin=(1046.7,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(166.387,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(Allyl_P) + radical(C=C(O)CJ)"""),
)

species(
    label = '[CH]=CC(=[CH])OCCC(26679)',
    structure = SMILES('[CH]=CC(=[CH])OCCC'),
    E0 = (331.577,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3010,987.5,1337.5,450,1655,3115,3125,620,680,785,800,1600,1700,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (110.154,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.698549,0.0927322,-8.22205e-05,3.20759e-08,-3.30365e-12,40057.9,30.6179], Tmin=(100,'K'), Tmax=(1017.53,'K')), NASAPolynomial(coeffs=[21.1422,0.0249743,-9.0167e-06,1.59574e-09,-1.10035e-13,34676.2,-79.7347], Tmin=(1017.53,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(331.577,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-Cds(Cds-Cds)O2s) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cds_P) + radical(Cds_P)"""),
)

species(
    label = '[CH2]C[CH]OC(=C)C=C(26680)',
    ...
    molecularWeight = (110.154,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.853695,0.0955021,-8.51822e-05,3.09217e-08,-1.83154e-12,28636.1,31.6282], Tmin=(100,'K'), Tmax=(988.369,'K')), NASAPolynomial(coeffs=[22.7254,0.0222544,-7.67708e-06,1.34714e-09,-9.36074e-14,22891.9,-87.3316], Tmin=(988.369,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(236.558,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-Cds(Cds-Cds)O2s) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(RCCJ) + radical(CCsJOC(O))"""),
)
...
species(
    label = 'CC[CH]OC1[CH]CC=1(26681)',
    structure = SMILES('CC[CH]OC1[CH]CC=1'),
    E0 = (281.095,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (110.154,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.103968,0.0646552,4.92326e-06,-6.31527e-08,3.1584e-11,33967.2,30.3277], Tmin=(100,'K'), Tmax=(954.634,'K')), NASAPolynomial(coeffs=[23.1325,0.0198352,-5.84246e-06,1.06478e-09,-8.17768e-14,27216,-92.0342], Tmin=(954.634,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(281.095,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(415.724,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + ring(Cyclobutene) + radical(CCsJOC(O)) + radical(CCJCO)"""),
)
...
species(
    ...
    molecularWeight = (110.154,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0388883,0.0779087,-5.26113e-05,1.05753e-08,2.11913e-12,-2195.28,29.3624], Tmin=(100,'K'), Tmax=(1039.99,'K')), NASAPolynomial(coeffs=[17.4886,0.0298916,-1.13317e-05,2.04767e-09,-1.42006e-13,-6889.92,-60.9279], Tmin=(1039.99,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-19.5401,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(415.724,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cs-(Cds-Cds)HHH) + group(Cds-Cds(Cds-Cds)O2s) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(Cds-CdsHH)"""),
)
...
species(
    label = '[CH]=C(C=C)O[CH]C(26684)',
    structure = SMILES('[CH]=C(C=C)O[CH]C'),
    E0 = (302.188,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,2750,2800,2850,1350,1500,750,1050,1375,1000,2950,3100,1380,975,1025,1650,350,440,435,1725,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.867702,'amu*angstrom^2'), symmetry=1, barrier=(19.9502,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.867569,'amu*angstrom^2'), symmetry=1, barrier=(19.9471,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.865784,'amu*angstrom^2'), symmetry=1, barrier=(19.9061,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.867266,'amu*angstrom^2'), symmetry=1, barrier=(19.9401,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (96.1271,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.726527,0.0882094,-9.3436e-05,4.77917e-08,-9.26092e-12,36528.5,27.5495], Tmin=(100,'K'), Tmax=(1382.69,'K')), NASAPolynomial(coeffs=[23.459,0.011296,-2.46075e-06,2.94119e-10,-1.6025e-14,30504.3,-94.5669], Tmin=(1382.69,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(302.188,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-Cds(Cds-Cds)O2s) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cds_P) + radical(CCsJOC(O))"""),
)

species(
    label = '[CH]=C(C=C)OC([CH2])C(26685)',
    structure = SMILES('[CH]=C(C=C)OC([CH2])C'),
    E0 = (282.348,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,3010,987.5,1337.5,450,1655,2750,2800,2850,1350,1500,750,1050,1375,1000,2950,3100,1380,975,1025,1650,1380,1390,370,380,2900,435,350,440,435,1725,3000,3100,440,815,1455,1000,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (110.154,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.20197,0.102383,-0.000106952,5.58377e-08,-1.12916e-11,34156.1,31.4309], Tmin=(100,'K'), Tmax=(1219.22,'K')), NASAPolynomial(coeffs=[23.5854,0.02106,-6.89967e-06,1.12854e-09,-7.34236e-14,28112,-93.0664], Tmin=(1219.22,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(282.348,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-Cds(Cds-Cds)O2s) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(CJC(C)OC) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH]=C(C=C)O[CH]CC(26561)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[CH]=C(C=C)O[CH]CC(26561)'],
    products = ['[CH2]C1C=C1O[CH]CC(26669)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', '[CH]=C(C=C)OC=CC(26671)'],
    products = ['[CH]=C(C=C)O[CH]CC(26561)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['CH3(17)', '[CH]=C(C=C)OC=C(26672)'],
    products = ['[CH]=C(C=C)O[CH]CC(26561)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['C2H3(30)', 'C#CO[CH]CC(11159)'],
    products = ['[CH]=C(C=C)O[CH]CC(26561)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH]=C(C=C)OC[CH]C(26673)'],
    products = ['[CH]=C(C=C)O[CH]CC(26561)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH]=C(C=C)OCC[CH2](26674)'],
    products = ['[CH]=C(C=C)O[CH]CC(26561)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH]=C(C=C)O[CH]CC(26561)'],
    products = ['C=[C]C(=C)O[CH]CC(26675)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH]=CC(=C)O[CH]CC(26677)'],
    products = ['[CH]=C(C=C)O[CH]CC(26561)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH]=C(C=C)O[CH]CC(26561)'],
    products = ['C=CC(=C)O[CH][CH]C(26678)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH]=C(C=C)O[CH]CC(26561)'],
    products = ['[CH2]C[CH]OC(=C)C=C(26680)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH]=C(C=C)O[CH]CC(26561)'],
    products = ['CC[CH]OC1[CH]CC=1(26681)'],
...
reaction(
    label = 'reaction20',
    reactants = ['CH2(S)(23)', '[CH]=C(C=C)O[CH]C(26684)'],
    products = ['[CH]=C(C=C)O[CH]CC(26561)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH]=C(C=C)OC([CH2])C(26685)'],
    products = ['[CH]=C(C=C)O[CH]CC(26561)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH]CC(144)', '[CH]=C([O])C=C(5816)'],
    products = ['[CH]=C(C=C)O[CH]CC(26561)'],
