...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.555,0.132069,-0.000147654,1.01853e-07,-3.03329e-11,-30600.3,44.6331], Tmin=(100,'K'), Tmax=(798.105,'K')), NASAPolynomial(coeffs=[10.5693,0.0713061,-3.34581e-05,6.4681e-09,-4.55714e-13,-32535.7,-11.126], Tmin=(798.105,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-256.015,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(594.485,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdCsCs) + radical(CCJCC=O)"""),
)

species(
    label = 'CCC=CC([O])CC(C)OO(8250)',
    structure = SMILES('CCC=CC([O])CC(C)OO'),
    E0 = (-166.165,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (159.203,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.8069,0.121517,-9.90623e-05,4.17776e-08,-7.19504e-12,-19771.2,46.3251], Tmin=(100,'K'), Tmax=(1362.3,'K')), NASAPolynomial(coeffs=[21.9925,0.0516363,-2.2118e-05,4.12337e-09,-2.84952e-13,-26255.5,-75.8515], Tmin=(1362.3,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-166.165,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(598.642,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(CC(C)OJ)"""),
)

species(
    label = 'CC=CCC([O])CC(C)OO(8251)',
    ...
    molecularWeight = (159.203,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.47826,0.123217,-0.000107551,5.10776e-08,-1.01837e-11,-19886.2,43.5725], Tmin=(100,'K'), Tmax=(1169.09,'K')), NASAPolynomial(coeffs=[16.8729,0.0604293,-2.69914e-05,5.13908e-09,-3.60151e-13,-24177,-47.8284], Tmin=(1169.09,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-166.963,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(598.642,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(CC(C)OJ)"""),
)
...
species(
    label = 'CC[CH]C[C](O)CC(C)OO(8252)',
    structure = SMILES('CC[CH]C[C](O)CC(C)OO'),
    E0 = (-141.775,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (160.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.2468,0.148159,-0.000194573,1.57968e-07,-5.3566e-11,-16836.9,48.4755], Tmin=(100,'K'), Tmax=(779.471,'K')), NASAPolynomial(coeffs=[10.6912,0.0732062,-3.3865e-05,6.43112e-09,-4.45439e-13,-18593.8,-9.05168], Tmin=(779.471,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-141.775,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(615.271,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(C2CsJOH)"""),
)
...
species(
    label = 'C[CH]CCC([O])CC(C)OO(8253)',
    structure = SMILES('C[CH]CCC([O])CC(C)OO'),
    E0 = (-88.0538,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (160.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.51996,0.12934,-0.000124969,7.13416e-08,-1.75903e-11,-10398.3,46.4443], Tmin=(100,'K'), Tmax=(949.998,'K')), NASAPolynomial(coeffs=[12.4552,0.0704962,-3.20561e-05,6.1388e-09,-4.31443e-13,-13053.6,-20.2608], Tmin=(949.998,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-88.0538,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(619.428,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(RCCJC)"""),
)

species(
    label = 'CC[CH]CC(O)[CH]C(C)OO(8254)',
    structure = SMILES('CC[CH]CC(O)[CH]C(C)OO'),
    E0 = (-117.988,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (160.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.86932,0.138835,-0.000162841,1.18826e-07,-3.71083e-11,-13988.2,50.0188], Tmin=(100,'K'), Tmax=(766.399,'K')), NASAPolynomial(coeffs=[10.7845,0.072801,-3.36147e-05,6.43e-09,-4.49469e-13,-15928,-7.66352], Tmin=(766.399,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-117.988,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(615.271,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJCOOH) + radical(RCCJCC)"""),
)

species(
    label = 'CC[CH][CH]C(O)CC(C)OO(8255)',
    structure = SMILES('CC[CH][CH]C(O)CC(C)OO'),
    E0 = (-118.5,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (160.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.49898,0.129127,-0.000129131,7.72348e-08,-1.99335e-11,-14061.3,48.8877], Tmin=(100,'K'), Tmax=(911.852,'K')), NASAPolynomial(coeffs=[11.9865,0.0699702,-3.18181e-05,6.0885e-09,-4.27525e-13,-16520.6,-14.9278], Tmin=(911.852,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-118.5,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(615.271,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(CCJCO)"""),
)

species(
    label = 'CCCC[C]([O])CC(C)OO(8256)',
    structure = SMILES('CCCC[C]([O])CC(C)OO'),
    E0 = (-105.872,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (160.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.91534,0.138344,-0.000144122,8.68226e-08,-2.21355e-11,-12527.5,44.5538], Tmin=(100,'K'), Tmax=(930.336,'K')), NASAPolynomial(coeffs=[14.35,0.0684115,-3.13695e-05,6.02641e-09,-4.24155e-13,-15553.9,-32.7428], Tmin=(930.336,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-105.872,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(619.428,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(C2CsJOH) + radical(CC(C)OJ)"""),
)

species(
    label = '[CH2]CCCC([O])CC(C)OO(8257)',
    structure = SMILES('[CH2]CCCC([O])CC(C)OO'),
    E0 = (-77.2537,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (160.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.7313,0.13066,-0.000119594,6.06389e-08,-1.2954e-11,-9088.94,46.2388], Tmin=(100,'K'), Tmax=(1096.41,'K')), NASAPolynomial(coeffs=[16.4258,0.0644174,-2.89661e-05,5.53211e-09,-3.88538e-13,-13070.4,-43.0298], Tmin=(1096.41,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-77.2537,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(619.428,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(RCCJ)"""),
)

species(
    label = 'CC[CH]CC(O)C[C](C)OO(8258)',
    structure = SMILES('CC[CH]CC(O)C[C](C)OO'),
    E0 = (-131.503,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (160.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.489708,0.118328,-5.65038e-05,-1.19125e-07,1.47207e-10,-15674.7,43.3733], Tmin=(100,'K'), Tmax=(475.764,'K')), NASAPolynomial(coeffs=[8.64825,0.0766106,-3.56742e-05,6.80292e-09,-4.7264e-13,-16941.6,1.89988], Tmin=(475.764,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-131.503,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(615.271,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(C2CsJOOH)"""),
)

species(
    label = 'CCCCC([O])[CH]C(C)OO(8259)',
    structure = SMILES('CCCCC([O])[CH]C(C)OO'),
    E0 = (-82.0851,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3025,407.5,1350,352.5,3615,1310,387.5,850,1000,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (160.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.70783,0.131466,-0.000123066,6.46582e-08,-1.4383e-11,-9671.94,46.6781], Tmin=(100,'K'), Tmax=(1053.74,'K')), NASAPolynomial(coeffs=[15.5276,0.0660403,-2.99323e-05,5.73538e-09,-4.0353e-13,-13304.3,-37.3749], Tmin=(1053.74,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-82.0851,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(619.428,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJCOOH) + radical(CC(C)OJ)"""),
)

species(
    label = '[CH2]C(CC(O)C[CH]CC)OO(8260)',
    structure = SMILES('[CH2]C(CC(O)C[CH]CC)OO'),
    E0 = (-104.44,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (160.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.87908,0.138486,-0.000155965,1.06025e-07,-3.06537e-11,-12357.7,49.7498], Tmin=(100,'K'), Tmax=(826.093,'K')), NASAPolynomial(coeffs=[12.1968,0.0703306,-3.2211e-05,6.15578e-09,-4.30842e-13,-14683.3,-15.4695], Tmin=(826.093,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-104.44,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(615.271,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(CJCOOH)"""),
)

species(
    label = 'CCCCC([O])C[C](C)OO(8261)',
    structure = SMILES('CCCCC([O])C[C](C)OO'),
    E0 = (-95.601,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (160.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.57096,0.131456,-0.000129535,7.56542e-08,-1.91237e-11,-11305.1,44.1901], Tmin=(100,'K'), Tmax=(927.181,'K')), NASAPolynomial(coeffs=[12.225,0.0719353,-3.32379e-05,6.41036e-09,-4.52243e-13,-13863.2,-21.3235], Tmin=(927.181,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-95.601,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(619.428,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(C2CsJOOH) + radical(CC(C)OJ)"""),
)

species(
    label = 'C[CH][CH]CC(O)CC(C)OO(8262)',
    structure = SMILES('C[CH][CH]CC(O)CC(C)OO'),
    E0 = (-123.956,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (160.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.521159,0.117884,-6.32455e-05,-9.34215e-08,1.22079e-10,-14764.5,45.8891], Tmin=(100,'K'), Tmax=(487.619,'K')), NASAPolynomial(coeffs=[8.66614,0.0755674,-3.47358e-05,6.59159e-09,-4.57012e-13,-16053.4,4.13544], Tmin=(487.619,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-123.956,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(615.271,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJC) + radical(RCCJCC)"""),
)

species(
    label = 'CC[CH]CC(O)CC(C)O[O](8263)',
    structure = SMILES('CC[CH]CC(O)CC(C)O[O]'),
    E0 = (-166.398,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (160.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.68418,0.133918,-0.000154421,1.13053e-07,-3.56124e-11,-19816.6,47.8037], Tmin=(100,'K'), Tmax=(759.242,'K')), NASAPolynomial(coeffs=[10.0109,0.0723094,-3.27149e-05,6.19729e-09,-4.30681e-13,-21592.6,-5.39837], Tmin=(759.242,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-166.398,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(619.428,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(ROOJ)"""),
)

species(
    label = '[CH2]C(CC([O])CCCC)OO(8264)',
    structure = SMILES('[CH2]C(CC([O])CCCC)OO'),
    E0 = (-68.5375,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1310,387.5,850,1000,3000,3100,440,815,1455,1000,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (160.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.89079,0.133328,-0.00012473,6.41763e-08,-1.37956e-11,-8034.16,47.0192], Tmin=(100,'K'), Tmax=(1096.12,'K')), NASAPolynomial(coeffs=[17.4842,0.0626235,-2.79741e-05,5.32868e-09,-3.73821e-13,-12281.6,-48.2322], Tmin=(1096.12,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-68.5375,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(619.428,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJCOOH) + radical(CC(C)OJ)"""),
)

species(
    label = '[CH2]C[CH]CC(O)CC(C)OO(8265)',
    structure = SMILES('[CH2]C[CH]CC(O)CC(C)OO'),
    E0 = (-113.156,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (160.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.77702,0.136511,-0.000153336,1.0591e-07,-3.13746e-11,-13410,49.1745], Tmin=(100,'K'), Tmax=(804.647,'K')), NASAPolynomial(coeffs=[11.1948,0.0720345,-3.31538e-05,6.34808e-09,-4.44669e-13,-15497.8,-10.5888], Tmin=(804.647,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-113.156,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(615.271,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJ) + radical(RCCJCC)"""),
)

species(
    label = 'CCCCC([O])CC(C)O[O](8266)',
    ...
    molecularWeight = (160.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.5385,0.126717,-0.000115135,5.93698e-08,-1.30228e-11,-15499.6,44.5208], Tmin=(100,'K'), Tmax=(1065.53,'K')), NASAPolynomial(coeffs=[14.7519,0.0655624,-2.90449e-05,5.50642e-09,-3.85106e-13,-18971.2,-35.1051], Tmin=(1065.53,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-130.495,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(623.585,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(CC(C)OJ)"""),
)

species(
    label = 'CCCCC(=O)CC(C)OO(8267)',
    structure = SMILES('CCCCC(=O)CC(C)OO'),
    E0 = (-455.917,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (160.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.79753,0.137916,-0.000158862,1.15364e-07,-3.62761e-11,-54634.9,43.0029], Tmin=(100,'K'), Tmax=(757.801,'K')), NASAPolynomial(coeffs=[10.011,0.075591,-3.55073e-05,6.85508e-09,-4.82059e-13,-56424.8,-10.6926], Tmin=(757.801,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-455.917,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(619.428,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdCsCs)"""),
)

species(
    label = 'CCC=CC(O)CC(C)OO(8268)',
    structure = SMILES('CCC=CC(O)CC(C)OO'),
    E0 = (-396.525,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (160.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.91479,0.124885,-0.000102901,4.43226e-08,-7.82501e-12,-47474.1,46.9031], Tmin=(100,'K'), Tmax=(1328.98,'K')), NASAPolynomial(coeffs=[21.5637,0.0542178,-2.31382e-05,4.31002e-09,-2.97953e-13,-53714.5,-73.0442], Tmin=(1328.98,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-396.525,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(619.428,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH)"""),
)

species(
    label = 'CC=CCC(O)CC(C)OO(8269)',
    structure = SMILES('CC=CCC(O)CC(C)OO'),
    E0 = (-397.324,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (160.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.62791,0.127024,-0.000112687,5.5011e-08,-1.12971e-11,-47587.1,44.3041], Tmin=(100,'K'), Tmax=(1137.62,'K')), NASAPolynomial(coeffs=[16.6739,0.0626729,-2.7838e-05,5.28834e-09,-3.70272e-13,-51751.3,-46.3514], Tmin=(1137.62,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-397.324,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(619.428,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH)"""),
)
...
species(
    label = 'CC[CH]CC1CC(C)OO1(8271)',
    structure = SMILES('CC[CH]CC1CC(C)OO1'),
    E0 = (-74.1492,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (143.203,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.61576,0.0872391,-2.15495e-05,-3.15654e-08,1.86882e-11,-8739.04,37.2278], Tmin=(100,'K'), Tmax=(952.913,'K')), NASAPolynomial(coeffs=[16.2419,0.0505091,-1.73033e-05,2.94277e-09,-1.97871e-13,-13497,-51.395], Tmin=(952.913,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-74.1492,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(586.17,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(12dioxolane) + radical(RCCJCC)"""),
)

species(
    label = 'CCC1CC([O])CC(C)O1(8272)',
    structure = SMILES('CCC1CC([O])CC(C)O1'),
    E0 = (-282.899,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (143.203,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.468363,0.0767389,2.26609e-05,-8.49779e-08,3.92983e-11,-33844.3,31.674], Tmin=(100,'K'), Tmax=(940.021,'K')), NASAPolynomial(coeffs=[19.3381,0.0463124,-1.47237e-05,2.48181e-09,-1.70559e-13,-39947.4,-75.3119], Tmin=(940.021,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-282.899,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(594.485,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Oxane) + radical(CC(C)OJ)"""),
)
...
species(
    label = '[CH2]C(C)CC([O])CC(C)OO(8273)',
...
reaction(
    label = 'reaction1',
    reactants = ['CC[CH]CC([O])CC(C)OO(8048)'],
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'CC[CH]CC(=O)CC(C)OO(8249)'],
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'CCC=CC([O])CC(C)OO(8250)'],
    products = ['CC[CH]CC([O])CC(C)OO(8048)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', 'CC=CCC([O])CC(C)OO(8251)'],
    products = ['CC[CH]CC([O])CC(C)OO(8048)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(1.46e+08,'cm^3/(mol*s)'), n=1.64, Ea=(5.73208,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""From training reaction 2555 used for Cds-CsH_Cds-CsH;HJ
Exact match found for rate rule [Cds-CsH_Cds-CsH;HJ]
...
reaction(
    label = 'reaction5',
    reactants = ['QOOH_3(717)', 'CC[CH]CC=O(1724)'],
    products = ['CC[CH]CC([O])CC(C)OO(8048)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['CH3(17)', 'C=CCC([O])CC(C)OO(7689)'],
    products = ['CC[CH]CC([O])CC(C)OO(8048)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['CC[CH]CC([O])CC(C)OO(8048)'],
    products = ['CC[CH]C[C](O)CC(C)OO(8252)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['CCC[CH]C([O])CC(C)OO(8248)'],
    products = ['CC[CH]CC([O])CC(C)OO(8048)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CC[CH]CC([O])CC(C)OO(8048)'],
    products = ['C[CH]CCC([O])CC(C)OO(8253)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CC[CH]CC(O)[CH]C(C)OO(8254)'],
    products = ['CC[CH]CC([O])CC(C)OO(8048)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CC[CH]CC([O])CC(C)OO(8048)'],
    products = ['CC[CH][CH]C(O)CC(C)OO(8255)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CC[CH]CC([O])CC(C)OO(8048)'],
    products = ['CCCC[C]([O])CC(C)OO(8256)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]CCCC([O])CC(C)OO(8257)'],
    products = ['CC[CH]CC([O])CC(C)OO(8048)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CC[CH]CC([O])CC(C)OO(8048)'],
    products = ['CC[CH]CC(O)C[C](C)OO(8258)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CCCCC([O])[CH]C(C)OO(8259)'],
    products = ['CC[CH]CC([O])CC(C)OO(8048)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CC[CH]CC([O])CC(C)OO(8048)'],
    products = ['[CH2]C(CC(O)C[CH]CC)OO(8260)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CC[CH]CC([O])CC(C)OO(8048)'],
    products = ['CCCCC([O])C[C](C)OO(8261)'],
...
reaction(
    label = 'reaction20',
    reactants = ['CC[CH]CC([O])CC(C)OO(8048)'],
    products = ['C[CH][CH]CC(O)CC(C)OO(8262)'],
...
reaction(
    label = 'reaction21',
    reactants = ['CC[CH]CC([O])CC(C)OO(8048)'],
    products = ['CC[CH]CC(O)CC(C)O[O](8263)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH2]C(CC([O])CCCC)OO(8264)'],
    products = ['CC[CH]CC([O])CC(C)OO(8048)'],
...
reaction(
    label = 'reaction23',
    reactants = ['CC[CH]CC([O])CC(C)OO(8048)'],
    products = ['[CH2]C[CH]CC(O)CC(C)OO(8265)'],
...
reaction(
    label = 'reaction24',
    reactants = ['CC[CH]CC([O])CC(C)OO(8048)'],
    products = ['CCCCC([O])CC(C)O[O](8266)'],
...
reaction(
    label = 'reaction27',
    reactants = ['CC[CH]CC([O])CC(C)OO(8048)'],
    products = ['CCC=CC(O)CC(C)OO(8268)'],
...
reaction(
    label = 'reaction28',
    reactants = ['CC[CH]CC([O])CC(C)OO(8048)'],
    products = ['CC=CCC(O)CC(C)OO(8269)'],
...
reaction(
    label = 'reaction29',
    reactants = ['CH2(S)(23)', 'CC[CH]CC([O])CCOO(8270)'],
    products = ['CC[CH]CC([O])CC(C)OO(8048)'],
...
reaction(
    label = 'reaction30',
    reactants = ['CH2(S)(23)', 'C[CH]CC([O])CC(C)OO(2163)'],
    products = ['CC[CH]CC([O])CC(C)OO(8048)'],
...
reaction(
    label = 'reaction31',
    reactants = ['CC[CH]CC([O])CC(C)OO(8048)'],
    products = ['OH(5)', 'CC[CH]CC1CC(C)OO1(8271)'],
...
reaction(
    label = 'reaction32',
    reactants = ['CC[CH]CC([O])CC(C)OO(8048)'],
    products = ['OH(5)', 'CCC1CC([O])CC(C)O1(8272)'],
...
reaction(
    label = 'reaction34',
    reactants = ['[CH2]C(C)CC([O])CC(C)OO(8273)'],
    products = ['CC[CH]CC([O])CC(C)OO(8048)'],
...
reaction(
    label = 'reaction36',
    reactants = ['O(4)', 'CC[CH]C[CH]CC(C)OO(6613)'],
    products = ['CC[CH]CC([O])CC(C)OO(8048)'],
