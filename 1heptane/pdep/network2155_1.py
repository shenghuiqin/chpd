species(
    label = 'CC[CH]CO[CH]CCCC(11666)',
    structure = SMILES('CC[CH]CO[CH]CCCC'),
    E0 = (-11.9161,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2761.11,2772.22,2783.33,2794.44,2805.56,2816.67,2827.78,2838.89,2850,1425,1431.25,1437.5,1443.75,1450,1225,1237.5,1250,1262.5,1275,1270,1287.5,1305,1322.5,1340,700,725,750,775,800,300,325,350,375,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3000,3050,390,425,1340,1360,335,370,180,180,180,180,1600,1682.67,2818.64,3200],'cm^-1')),
        HinderedRotor(inertia=(0.154225,'amu*angstrom^2'), symmetry=1, barrier=(3.54594,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.154225,'amu*angstrom^2'), symmetry=1, barrier=(3.54594,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.154225,'amu*angstrom^2'), symmetry=1, barrier=(3.54594,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.154225,'amu*angstrom^2'), symmetry=1, barrier=(3.54594,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.154225,'amu*angstrom^2'), symmetry=1, barrier=(3.54594,'kJ/mol'), semiclassical=False),
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.46911,0.121609,-9.89241e-05,4.46134e-08,-8.54207e-12,-1237.56,43.782], Tmin=(100,'K'), Tmax=(1205.52,'K')), NASAPolynomial(coeffs=[15.82,0.0642422,-2.75435e-05,5.13882e-09,-3.55815e-13,-5406.02,-42.8595], Tmin=(1205.52,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-11.9161,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(644.372,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJCO) + radical(CCsJOCs)"""),
)
...
species(
    label = 'CC[CH]COC=CCCC(11725)',
    structure = SMILES('CC[CH]COC=CCCC'),
    E0 = (-115.617,'kJ/mol'),
    modes = [
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.81361,0.108074,-4.68194e-05,-1.93674e-08,1.59457e-11,-13678.7,43.4987], Tmin=(100,'K'), Tmax=(1001.81,'K')), NASAPolynomial(coeffs=[24.4466,0.0456867,-1.69892e-05,3.09256e-09,-2.17722e-13,-21071.2,-93.8744], Tmin=(1001.81,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-115.617,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(623.585,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(CCJCO)"""),
)

species(
    label = 'CC=CCO[CH]CCCC(11726)',
    structure = SMILES('CC=CCO[CH]CCCC'),
    E0 = (-90.7243,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,3025,407.5,1350,352.5,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,2995,3025,975,1000,1300,1375,400,500,1630,1680,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (141.231,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.04291,0.115866,-9.5179e-05,4.47482e-08,-9.14515e-12,-10734.2,40.1832], Tmin=(100,'K'), Tmax=(1118.82,'K')), NASAPolynomial(coeffs=[12.6794,0.0668064,-2.94045e-05,5.55535e-09,-3.87508e-13,-13804.8,-27.5595], Tmin=(1118.82,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-90.7243,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(623.585,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(CCsJOCs)"""),
)

species(
    label = 'CCC=CO[CH]CCCC(11727)',
    structure = SMILES('CCC=CO[CH]CCCC'),
    E0 = (-121.591,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,3025,407.5,1350,352.5,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,2995,3025,975,1000,1300,1375,400,500,1630,1680,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (141.231,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.39507,0.122912,-8.30913e-05,1.36895e-08,5.31868e-12,-14378.3,42.5628], Tmin=(100,'K'), Tmax=(1015.4,'K')), NASAPolynomial(coeffs=[26.5096,0.0432927,-1.60641e-05,2.8975e-09,-2.02041e-13,-22013.7,-106.021], Tmin=(1015.4,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-121.591,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(623.585,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(CCsJOC(O))"""),
)
...
species(
    label = 'C=CCO[CH]CCCC(11280)',
    structure = SMILES('C=CCO[CH]CCCC'),
    E0 = (-54.6987,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,2950,3100,1380,975,1025,1650,3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.571568,0.102452,-8.2547e-05,3.70037e-08,-7.08315e-12,-6415.9,36.6776], Tmin=(100,'K'), Tmax=(1200.12,'K')), NASAPolynomial(coeffs=[13.4754,0.0556346,-2.40313e-05,4.49872e-09,-3.12042e-13,-9787.56,-33.6535], Tmin=(1200.12,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-54.6987,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(552.912,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CCsJOCs)"""),
)

species(
    label = 'CC[CH]COC[CH]CCC(11728)',
    structure = SMILES('CC[CH]COC[CH]CCC'),
    E0 = (7.52996,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2761.11,2772.22,2783.33,2794.44,2805.56,2816.67,2827.78,2838.89,2850,1425,1431.25,1437.5,1443.75,1450,1225,1237.5,1250,1262.5,1275,1270,1287.5,1305,1322.5,1340,700,725,750,775,800,300,325,350,375,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3000,3050,390,425,1340,1360,335,370,200,800,933.333,1066.67,1200,1333.33,1466.67,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (142.239,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.07243,0.110649,-7.57842e-05,2.73444e-08,-4.17656e-12,1088.13,45.3983], Tmin=(100,'K'), Tmax=(1460.51,'K')), NASAPolynomial(coeffs=[16.4087,0.062772,-2.66131e-05,4.89972e-09,-3.34648e-13,-4018.17,-45.5599], Tmin=(1460.51,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(7.52996,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(644.372,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJCO) + radical(CCJCO)"""),
)

species(
    label = 'C[CH]CCO[CH]CCCC(11729)',
    structure = SMILES('C[CH]CCO[CH]CCCC'),
    E0 = (-17.3719,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (142.239,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.33513,0.125138,-0.000118924,7.06462e-08,-1.85369e-11,-1903.96,43.567], Tmin=(100,'K'), Tmax=(889.382,'K')), NASAPolynomial(coeffs=[9.9903,0.0742021,-3.30177e-05,6.25294e-09,-4.36432e-13,-3918.5,-9.74403], Tmin=(889.382,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-17.3719,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(644.372,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCsJOCs) + radical(RCCJC)"""),
)

species(
    label = 'CCC[CH]O[CH]CCCC(11723)',
    structure = SMILES('CCC[CH]O[CH]CCCC'),
    E0 = (-31.3621,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (142.239,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.9693,0.133777,-0.000126091,6.66514e-08,-1.47077e-11,-3559.08,42.5358], Tmin=(100,'K'), Tmax=(1073,'K')), NASAPolynomial(coeffs=[17.0657,0.0628181,-2.68938e-05,5.01966e-09,-3.48182e-13,-7644.02,-50.6384], Tmin=(1073,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-31.3621,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(644.372,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCsJOCs) + radical(CCsJOCs)"""),
)

species(
    label = 'CC[CH][CH]OCCCCC(11730)',
    structure = SMILES('CC[CH][CH]OCCCCC'),
    E0 = (-11.9161,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2761.11,2772.22,2783.33,2794.44,2805.56,2816.67,2827.78,2838.89,2850,1425,1431.25,1437.5,1443.75,1450,1225,1237.5,1250,1262.5,1275,1270,1287.5,1305,1322.5,1340,700,725,750,775,800,300,325,350,375,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3000,3050,390,425,1340,1360,335,370,180,180,180,180,1600,1682.67,2818.64,3200],'cm^-1')),
        HinderedRotor(inertia=(0.154225,'amu*angstrom^2'), symmetry=1, barrier=(3.54594,'kJ/mol'), semiclassical=False),
...
species(
    label = 'CC[CH]CCOC[CH]CC(11731)',
    structure = SMILES('CC[CH]CCOC[CH]CC'),
    E0 = (2.08621,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2761.11,2772.22,2783.33,2794.44,2805.56,2816.67,2827.78,2838.89,2850,1425,1431.25,1437.5,1443.75,1450,1225,1237.5,1250,1262.5,1275,1270,1287.5,1305,1322.5,1340,700,725,750,775,800,300,325,350,375,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3000,3050,390,425,1340,1360,335,370,180,180,180,180,1600,1664.55,2857.07,3200],'cm^-1')),
        HinderedRotor(inertia=(0.154029,'amu*angstrom^2'), symmetry=1, barrier=(3.54143,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.154029,'amu*angstrom^2'), symmetry=1, barrier=(3.54143,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.154029,'amu*angstrom^2'), symmetry=1, barrier=(3.54143,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.154029,'amu*angstrom^2'), symmetry=1, barrier=(3.54143,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.154029,'amu*angstrom^2'), symmetry=1, barrier=(3.54143,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (142.239,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.69878,0.112074,-9.13224e-05,4.87616e-08,-1.23837e-11,412.622,44.1681], Tmin=(100,'K'), Tmax=(879.297,'K')), NASAPolynomial(coeffs=[6.4136,0.0797191,-3.61284e-05,6.91481e-09,-4.85957e-13,-838.163,10.7698], Tmin=(879.297,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(2.08621,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(644.372,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJCO) + radical(RCCJCC)"""),
)

species(
    label = '[CH2]CCCO[CH]CCCC(11732)',
    structure = SMILES('[CH2]CCCO[CH]CCCC'),
    E0 = (-6.57178,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2759.09,2768.18,2777.27,2786.36,2795.45,2804.55,2813.64,2822.73,2831.82,2840.91,2850,1425,1430,1435,1440,1445,1450,1225,1235,1245,1255,1265,1275,1270,1284,1298,1312,1326,1340,700,720,740,760,780,800,300,320,340,360,380,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,3025,407.5,1350,352.5,180,180,180,180,1600,1645.15,2858.03,3200],'cm^-1')),
    ...
    molecularWeight = (142.239,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.47526,0.125605,-0.000110523,5.59766e-08,-1.21911e-11,-597.576,43.1074], Tmin=(100,'K'), Tmax=(1065.92,'K')), NASAPolynomial(coeffs=[13.7489,0.0684738,-3.01253e-05,5.69208e-09,-3.97273e-13,-3843.09,-31.3121], Tmin=(1065.92,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-6.57178,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(644.372,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCsJOCs) + radical(RCCJ)"""),
)

species(
    label = 'C[CH]CCCOC[CH]CC(11733)',
    structure = SMILES('C[CH]CCCOC[CH]CC'),
    E0 = (2.07419,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2761.11,2772.22,2783.33,2794.44,2805.56,2816.67,2827.78,2838.89,2850,1425,1431.25,1437.5,1443.75,1450,1225,1237.5,1250,1262.5,1275,1270,1287.5,1305,1322.5,1340,700,725,750,775,800,300,325,350,375,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3000,3050,390,425,1340,1360,335,370,200,800,933.333,1066.67,1200,1333.33,1466.67,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (142.239,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.68158,0.111122,-8.52095e-05,4.0112e-08,-8.77733e-12,411.179,44.2671], Tmin=(100,'K'), Tmax=(1008.65,'K')), NASAPolynomial(coeffs=[7.92845,0.0769773,-3.44308e-05,6.54961e-09,-4.5861e-13,-1325.71,2.65464], Tmin=(1008.65,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(2.07419,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(644.372,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJC) + radical(CCJCO)"""),
)

species(
    label = 'CCC[CH][CH]OCCCC(11734)',
    structure = SMILES('CCC[CH][CH]OCCCC'),
    E0 = (-11.9161,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2761.11,2772.22,2783.33,2794.44,2805.56,2816.67,2827.78,2838.89,2850,1425,1431.25,1437.5,1443.75,1450,1225,1237.5,1250,1262.5,1275,1270,1287.5,1305,1322.5,1340,700,725,750,775,800,300,325,350,375,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3000,3050,390,425,1340,1360,335,370,180,180,180,180,1600,1682.67,2818.64,3200],'cm^-1')),
        HinderedRotor(inertia=(0.154225,'amu*angstrom^2'), symmetry=1, barrier=(3.54594,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2]CCCCOC[CH]CC(11735)',
    structure = SMILES('[CH2]CCCCOC[CH]CC'),
    E0 = (12.8743,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (142.239,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.932141,0.113045,-8.2421e-05,3.31657e-08,-5.82402e-12,1721.71,44.1906], Tmin=(100,'K'), Tmax=(1264.91,'K')), NASAPolynomial(coeffs=[12.9645,0.0690999,-3.03083e-05,5.69982e-09,-3.95587e-13,-1793.88,-26.1183], Tmin=(1264.91,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(12.8743,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(644.372,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJ) + radical(CCJCO)"""),
)

species(
    label = 'C[CH][CH]COCCCCC(11736)',
    structure = SMILES('C[CH][CH]COCCCCC'),
    E0 = (2.07419,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2761.11,2772.22,2783.33,2794.44,2805.56,2816.67,2827.78,2838.89,2850,1425,1431.25,1437.5,1443.75,1450,1225,1237.5,1250,1262.5,1275,1270,1287.5,1305,1322.5,1340,700,725,750,775,800,300,325,350,375,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3000,3050,390,425,1340,1360,335,370,200,800,933.333,1066.67,1200,1333.33,1466.67,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2]C[CH]COCCCCC(11737)',
    structure = SMILES('[CH2]C[CH]COCCCCC'),
    E0 = (12.8743,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2759.09,2768.18,2777.27,2786.36,2795.45,2804.55,2813.64,2822.73,2831.82,2840.91,2850,1425,1430,1435,1440,1445,1450,1225,1235,1245,1255,1265,1275,1270,1284,1298,1312,1326,1340,700,720,740,760,780,800,300,320,340,360,380,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,3025,407.5,1350,352.5,200,800,933.333,1066.67,1200,1333.33,1466.67,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'CC[CH]C[CH]OCCCC(11738)',
    structure = SMILES('CC[CH]C[CH]OCCCC'),
    E0 = (-17.3598,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (142.239,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.34946,0.1262,-0.00012607,8.14873e-08,-2.34249e-11,-1902.87,43.4478], Tmin=(100,'K'), Tmax=(815.929,'K')), NASAPolynomial(coeffs=[8.83166,0.0762889,-3.43162e-05,6.51999e-09,-4.55392e-13,-3564.32,-3.59928], Tmin=(815.929,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-17.3598,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(644.372,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCsJOCs) + radical(RCCJCC)"""),
)

species(
    label = 'C[CH]CC[CH]OCCCC(11739)',
    structure = SMILES('C[CH]CC[CH]OCCCC'),
    E0 = (-17.3719,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (142.239,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.33513,0.125138,-0.000118924,7.06463e-08,-1.85369e-11,-1903.96,43.567], Tmin=(100,'K'), Tmax=(889.379,'K')), NASAPolynomial(coeffs=[9.9903,0.0742021,-3.30177e-05,6.25294e-09,-4.36432e-13,-3918.5,-9.74401], Tmin=(889.379,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-17.3719,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(644.372,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJC) + radical(CCsJOCs)"""),
)

species(
    label = '[CH2]CCC[CH]OCCCC(11740)',
    structure = SMILES('[CH2]CCC[CH]OCCCC'),
    E0 = (-6.57178,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2759.09,2768.18,2777.27,2786.36,2795.45,2804.55,2813.64,2822.73,2831.82,2840.91,2850,1425,1430,1435,1440,1445,1450,1225,1235,1245,1255,1265,1275,1270,1284,1298,1312,1326,1340,700,720,740,760,780,800,300,320,340,360,380,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,3025,407.5,1350,352.5,180,180,180,180,1600,1645.15,2858.03,3200],'cm^-1')),
        HinderedRotor(inertia=(0.153323,'amu*angstrom^2'), symmetry=1, barrier=(3.52521,'kJ/mol'), semiclassical=False),
...
species(
    label = 'CCC=COCCCCC(11741)',
    structure = SMILES('CCC=COCCCCC'),
    E0 = (-315.519,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (142.239,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.02772,0.113499,-5.60774e-05,-9.24884e-09,1.19304e-11,-37714.5,41.7717], Tmin=(100,'K'), Tmax=(1020.71,'K')), NASAPolynomial(coeffs=[24.1216,0.0495851,-1.88195e-05,3.42847e-09,-2.39871e-13,-45061.4,-94.7596], Tmin=(1020.71,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-315.519,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(648.529,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH)"""),
)

species(
    label = 'CCCC=COCCCC(11742)',
    structure = SMILES('CCCC=COCCCC'),
    E0 = (-315.519,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (142.239,'amu'),
...
species(
    label = 'CC=CCOCCCCC(11743)',
    structure = SMILES('CC=CCOCCCCC'),
    E0 = (-271.18,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (142.239,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.567558,0.107087,-7.0861e-05,2.52248e-08,-3.9579e-12,-32457.4,39.0076], Tmin=(100,'K'), Tmax=(1361.2,'K')), NASAPolynomial(coeffs=[11.6206,0.0712706,-3.13929e-05,5.89478e-09,-4.07721e-13,-35775.5,-23.5517], Tmin=(1361.2,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-271.18,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(648.529,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH)"""),
)
...
species(
    label = 'CC[CH]CO[CH]CCC(11744)',
    structure = SMILES('CC[CH]CO[CH]CCC'),
    E0 = (11.8642,'kJ/mol'),
    modes = [
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.865891,0.107335,-8.6837e-05,3.87801e-08,-7.32628e-12,1601.66,39.3713], Tmin=(100,'K'), Tmax=(1223.55,'K')), NASAPolynomial(coeffs=[14.8705,0.05589,-2.37689e-05,4.41679e-09,-3.05091e-13,-2249.21,-39.7227], Tmin=(1223.55,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(11.8642,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(573.699,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJCO) + radical(CCsJOCs)"""),
)

species(
    label = 'C[CH]CO[CH]CCCC(11274)',
    structure = SMILES('C[CH]CO[CH]CCCC'),
    E0 = (11.8642,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3000,3050,390,425,1340,1360,335,370,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2]C(CCC)OC[CH]CC(11745)',
    structure = SMILES('[CH2]C(CCC)OC[CH]CC'),
    E0 = (7.58707,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (142.239,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.38814,0.12346,-0.000105775,5.19282e-08,-1.09902e-11,1102.36,43.4638], Tmin=(100,'K'), Tmax=(1091.45,'K')), NASAPolynomial(coeffs=[13.6451,0.0683642,-3.0055e-05,5.67719e-09,-3.96117e-13,-2179.18,-30.3779], Tmin=(1091.45,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(7.58707,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(644.372,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJC(C)OC) + radical(CCJCO)"""),
)

species(
    label = '[CH2]C(C)CO[CH]CCCC(11746)',
    ...
    molecularWeight = (142.239,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.69625,0.126652,-0.000112004,5.65916e-08,-1.20809e-11,-1693.61,43.6085], Tmin=(100,'K'), Tmax=(1100.11,'K')), NASAPolynomial(coeffs=[15.5041,0.0641119,-2.67322e-05,4.9173e-09,-3.38051e-13,-5478.1,-41.0146], Tmin=(1100.11,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-15.7773,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(644.372,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCsJOCs) + radical(Isobutyl)"""),
)

species(
    label = 'CCCCC1OCC1CC(11669)',
    structure = SMILES('CCCCC1OCC1CC'),
    E0 = (-260.685,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (142.239,'amu'),
...
reaction(
    label = 'reaction1',
    reactants = ['CC[CH]CO[CH]CCCC(11666)'],
    products = ['butene1(127)', 'CCCCC=O(1733)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'CC[CH]COC=CCCC(11725)'],
    products = ['CC[CH]CO[CH]CCCC(11666)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'CC=CCO[CH]CCCC(11726)'],
    products = ['CC[CH]CO[CH]CCCC(11666)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', 'CCC=CO[CH]CCCC(11727)'],
    products = ['CC[CH]CO[CH]CCCC(11666)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[CH2][CH]CC(130)', 'CCCCC=O(1733)'],
    products = ['CC[CH]CO[CH]CCCC(11666)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['npropyl(83)', 'C=COC[CH]CC(2004)'],
    products = ['CC[CH]CO[CH]CCCC(11666)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['CH3(17)', 'C=CCO[CH]CCCC(11280)'],
    products = ['CC[CH]CO[CH]CCCC(11666)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['CC[CH]COC[CH]CCC(11728)'],
    products = ['CC[CH]CO[CH]CCCC(11666)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['CC[CH]CO[CH]CCCC(11666)'],
    products = ['C[CH]CCO[CH]CCCC(11729)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['CC[CH]CO[CH]CCCC(11666)'],
    products = ['CCC[CH]O[CH]CCCC(11723)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CC[CH][CH]OCCCCC(11730)'],
    products = ['CC[CH]CO[CH]CCCC(11666)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CC[CH]CCOC[CH]CC(11731)'],
    products = ['CC[CH]CO[CH]CCCC(11666)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2]CCCO[CH]CCCC(11732)'],
    products = ['CC[CH]CO[CH]CCCC(11666)'],
...
reaction(
    label = 'reaction14',
    reactants = ['C[CH]CCCOC[CH]CC(11733)'],
    products = ['CC[CH]CO[CH]CCCC(11666)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CCC[CH][CH]OCCCC(11734)'],
    products = ['CC[CH]CO[CH]CCCC(11666)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]CCCCOC[CH]CC(11735)'],
    products = ['CC[CH]CO[CH]CCCC(11666)'],
...
reaction(
    label = 'reaction17',
    reactants = ['C[CH][CH]COCCCCC(11736)'],
    products = ['CC[CH]CO[CH]CCCC(11666)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2]C[CH]COCCCCC(11737)'],
    products = ['CC[CH]CO[CH]CCCC(11666)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CC[CH]CO[CH]CCCC(11666)'],
    products = ['CC[CH]C[CH]OCCCC(11738)'],
    transitionState = 'TS19',
    kinetics = Arrhenius(A=(1.21161e+08,'s^-1'), n=1.12, Ea=(281.374,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [RnH;C_rad_out_H/NonDeC;Cs_H_out_H/(NonDeC/Cs)] for rate rule [R6HJ_3;C_rad_out_H/NonDeC;Cs_H_out_H/(NonDeC/Cs)]
...
reaction(
    label = 'reaction20',
    reactants = ['CC[CH]CO[CH]CCCC(11666)'],
    products = ['C[CH]CC[CH]OCCCC(11739)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH2]CCC[CH]OCCCC(11740)'],
    products = ['CC[CH]CO[CH]CCCC(11666)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH2][CH]CC(130)', 'CCCC[CH][O](1728)'],
    products = ['CC[CH]CO[CH]CCCC(11666)'],
...
reaction(
    label = 'reaction26',
    reactants = ['CH2(S)(23)', 'CC[CH]CO[CH]CCC(11744)'],
    products = ['CC[CH]CO[CH]CCCC(11666)'],
...
reaction(
    label = 'reaction27',
    reactants = ['CH2(S)(23)', 'C[CH]CO[CH]CCCC(11274)'],
    products = ['CC[CH]CO[CH]CCCC(11666)'],
...
reaction(
    label = 'reaction28',
    reactants = ['[CH2]C(CCC)OC[CH]CC(11745)'],
    products = ['CC[CH]CO[CH]CCCC(11666)'],
...
reaction(
    label = 'reaction29',
    reactants = ['CC[CH]CO[CH]CCCC(11666)'],
    products = ['[CH2]C(C)CO[CH]CCCC(11746)'],
...
reaction(
    label = 'reaction31',
    reactants = ['[CH]CCCC(141)', 'CC[CH]C[O](1679)'],
    products = ['CC[CH]CO[CH]CCCC(11666)'],
...
reaction(
    label = 'reaction32',
    reactants = ['[CH]CC(144)', '[CH2]O[CH]CCCC(1766)'],
    products = ['CC[CH]CO[CH]CCCC(11666)'],
...
network(
    label = '2155',
    isomers = [
        'CC[CH]CO[CH]CCCC(11666)',
    ],
    reactants = [
        ('butene1(127)', 'CCCCC=O(1733)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
