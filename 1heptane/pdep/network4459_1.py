...
species(
    label = '[CH]=C1CC1C[CH2](26619)',
    structure = SMILES('[CH]=C1CC1C[CH2]'),
    E0 = (583.754,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (80.1277,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.60872,0.0399414,1.18226e-05,-4.41538e-08,1.98463e-11,70306.9,22.4993], Tmin=(100,'K'), Tmax=(973.494,'K')), NASAPolynomial(coeffs=[13.2922,0.0223422,-7.91264e-06,1.44688e-09,-1.04088e-13,66591.3,-40.9533], Tmin=(973.494,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(583.754,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(324.264,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + ring(Methylene_cyclopropane) + radical(Cds_P) + radical(RCCJ)"""),
)
...
species(
    label = 'C#CC(=C)C[CH2](26621)',
    structure = SMILES('C#CC(=C)C[CH2]'),
    E0 = (412.852,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2175,525,2950,3100,1380,975,1025,1650,750,770,3400,2100,350,440,435,1725,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,180],'cm^-1')),
        HinderedRotor(inertia=(0.135896,'amu*angstrom^2'), symmetry=1, barrier=(3.12452,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.12774,'amu*angstrom^2'), symmetry=1, barrier=(25.929,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0329583,'amu*angstrom^2'), symmetry=1, barrier=(21.1438,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (79.1198,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.48535,0.0484724,-2.86723e-05,4.07595e-09,1.60424e-12,49751,22.1889], Tmin=(100,'K'), Tmax=(1073.24,'K')), NASAPolynomial(coeffs=[11.3807,0.02293,-8.81963e-06,1.58745e-09,-1.0903e-13,46974,-29.292], Tmin=(1073.24,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(412.852,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCtCs) + group(Cds-CdsHH) + group(Ct-Ct(Cds-Cds)) + group(Ct-CtH) + radical(RCCJ)"""),
)
...
species(
    label = 'C#C[C](C)C[CH2](26622)',
    structure = SMILES('C#C[C](C)C[CH2]'),
    E0 = (433.263,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,2175,525,750,770,3400,2100,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,360,370,350,180],'cm^-1')),
        HinderedRotor(inertia=(0.152272,'amu*angstrom^2'), symmetry=1, barrier=(3.50103,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(3.53309,'amu*angstrom^2'), symmetry=1, barrier=(81.2326,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00945676,'amu*angstrom^2'), symmetry=1, barrier=(81.1446,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(3.52255,'amu*angstrom^2'), symmetry=1, barrier=(80.9905,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (80.1277,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.21621,0.0586681,-5.33496e-05,2.87365e-08,-6.41263e-12,52211.9,23.3224], Tmin=(100,'K'), Tmax=(1076.44,'K')), NASAPolynomial(coeffs=[9.69135,0.0271736,-9.46087e-06,1.55396e-09,-9.9308e-14,50387.3,-18.1891], Tmin=(1076.44,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(433.263,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CtCsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(RCCJ) + radical(Tert_Propargyl)"""),
)
...
species(
    label = '[C]#CC(C)C[CH2](26624)',
    structure = SMILES('[C]#CC(C)C[CH2]'),
    E0 = (635.286,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2175,525,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,347.919,2717.16],'cm^-1')),
        HinderedRotor(inertia=(0.0805454,'amu*angstrom^2'), symmetry=1, barrier=(6.8789,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.807926,'amu*angstrom^2'), symmetry=1, barrier=(73.7814,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0734248,'amu*angstrom^2'), symmetry=1, barrier=(6.77324,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.793654,'amu*angstrom^2'), symmetry=1, barrier=(73.889,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (80.1277,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.31383,0.0562239,-4.78419e-05,2.41101e-08,-5.08312e-12,76506.4,24.2985], Tmin=(100,'K'), Tmax=(1129.2,'K')), NASAPolynomial(coeffs=[9.4081,0.0275515,-9.75461e-06,1.62404e-09,-1.04828e-13,74678.3,-15.7353], Tmin=(1129.2,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(635.286,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CtCsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(RCCJ) + radical(Acetyl)"""),
)

species(
    label = '[C]#CC([CH2])CC(26625)',
    structure = SMILES('[C]#CC([CH2])CC'),
    E0 = (635.122,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2175,525,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,180,2828.96],'cm^-1')),
        HinderedRotor(inertia=(0.00228102,'amu*angstrom^2'), symmetry=1, barrier=(12.9627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(3.19113,'amu*angstrom^2'), symmetry=1, barrier=(73.3704,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(3.19365,'amu*angstrom^2'), symmetry=1, barrier=(73.4282,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(3.19285,'amu*angstrom^2'), symmetry=1, barrier=(73.4098,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (80.1277,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.48581,0.0546587,-3.96799e-05,8.65022e-09,3.78661e-12,76478.9,23.6926], Tmin=(100,'K'), Tmax=(776.184,'K')), NASAPolynomial(coeffs=[9.10875,0.0270058,-8.71781e-06,1.36321e-09,-8.46963e-14,74945.2,-13.4093], Tmin=(776.184,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(635.122,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CtCsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(Isobutyl) + radical(Acetyl)"""),
)
...
species(
    ...
    molecularWeight = (80.1277,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.46503,0.0475531,-1.76433e-05,-8.80689e-09,6.25243e-12,25067.6,20.4745], Tmin=(100,'K'), Tmax=(1029.98,'K')), NASAPolynomial(coeffs=[11.4401,0.0254644,-9.72258e-06,1.76117e-09,-1.22179e-13,22129.6,-32.2312], Tmin=(1029.98,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(207.606,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCtCs) + group(Cds-CdsHH) + group(Ct-Ct(Cds-Cds)) + group(Ct-CtH)"""),
)

species(
    label = 'C#CC(C)C=C(26627)',
    ...
    molecularWeight = (80.1277,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.03642,0.0576604,-4.47466e-05,1.82735e-08,-3.02204e-12,23774.1,20.3877], Tmin=(100,'K'), Tmax=(1435.03,'K')), NASAPolynomial(coeffs=[13.4327,0.0231065,-8.62795e-06,1.49379e-09,-9.87753e-14,20216.4,-43.8945], Tmin=(1435.03,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(196.731,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CtCsH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Ct-CtCs) + group(Ct-CtH)"""),
)
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', 'C#CC(=C)C[CH2](26621)'],
    products = ['C#CC([CH2])C[CH2](26492)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)', 'C#CC([CH2])C=C(21151)'],
    products = ['C#CC([CH2])C[CH2](26492)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['buten3yl1(363)', 'C2H(33)'],
    products = ['C#CC([CH2])C[CH2](26492)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction24',
    reactants = ['CH2(19)', 'C#CC([CH2])[CH2](26629)'],
    products = ['C#CC([CH2])C[CH2](26492)'],
