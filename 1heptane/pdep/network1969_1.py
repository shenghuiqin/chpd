...
species(
    label = '[CH2]COC=CCCC(10646)',
    structure = SMILES('[CH2]COC=CCCC'),
    E0 = (-56.3692,'kJ/mol'),
    modes = [
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.682146,0.0867076,-3.97039e-05,-1.7123e-08,1.46879e-11,-6596.52,33.0852], Tmin=(100,'K'), Tmax=(975.83,'K')), NASAPolynomial(coeffs=[21.941,0.0309324,-1.07798e-05,1.92877e-09,-1.36402e-13,-12771.5,-84.5211], Tmin=(975.83,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-56.3692,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(482.239,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(CJCO)"""),
)
...
species(
    label = '[CH2]COCC[CH]CC(10648)',
    structure = SMILES('[CH2]COCC[CH]CC'),
    E0 = (61.3337,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,3025,407.5,1350,352.5,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (114.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.19367,0.0759936,8.81352e-06,-1.77681e-07,1.75652e-10,7462.76,31.3178], Tmin=(100,'K'), Tmax=(439.856,'K')), NASAPolynomial(coeffs=[5.38077,0.0624158,-2.84309e-05,5.39638e-09,-3.75029e-13,6857.41,11.8623], Tmin=(439.856,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(61.3337,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJCO) + radical(RCCJCC)"""),
)

species(
    label = '[CH2]COCCC[CH]C(10649)',
    structure = SMILES('[CH2]COCCC[CH]C'),
    E0 = (61.3217,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,3025,407.5,1350,352.5,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (114.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.596845,0.0857473,-4.92289e-05,-2.86811e-08,4.48934e-11,7487.23,33.4477], Tmin=(100,'K'), Tmax=(525.684,'K')), NASAPolynomial(coeffs=[6.03254,0.0613019,-2.77429e-05,5.28247e-09,-3.6935e-13,6682.01,8.49607], Tmin=(525.684,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(61.3217,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJCO) + radical(RCCJC)"""),
)
...
species(
    label = '[CH2]CCCCOC[CH2](10650)',
    structure = SMILES('[CH2]CCCCOC[CH2]'),
    E0 = (72.1218,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (114.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.00103032,0.0937491,-8.14273e-05,4.22289e-08,-9.67913e-12,8813.5,34.5185], Tmin=(100,'K'), Tmax=(1001.57,'K')), NASAPolynomial(coeffs=[9.39981,0.0562041,-2.51972e-05,4.80031e-09,-3.36503e-13,6930.42,-10.8497], Tmin=(1001.57,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(72.1218,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJ) + radical(CJCO)"""),
)

species(
    label = 'CC[CH]C[CH]OCC(10651)',
    structure = SMILES('CC[CH]C[CH]OCC'),
    E0 = (30.2007,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (114.185,'amu'),
...
species(
    label = 'C[CH]CC[CH]OCC(10652)',
    structure = SMILES('C[CH]CC[CH]OCC'),
    E0 = (30.1886,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (114.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.117967,0.0965375,-9.48968e-05,5.95941e-08,-1.6535e-11,3773.88,34.7017], Tmin=(100,'K'), Tmax=(845.717,'K')), NASAPolynomial(coeffs=[8.17222,0.0573291,-2.53584e-05,4.78056e-09,-3.32491e-13,2371.59,-3.90483], Tmin=(845.717,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(30.1886,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJC) + radical(CCsJOCs)"""),
)

species(
    label = '[CH2]CCC[CH]OCC(10653)',
    structure = SMILES('[CH2]CCC[CH]OCC'),
    E0 = (40.9887,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (114.185,'amu'),
...
species(
    label = '[CH2]CO[CH]CCC(10654)',
    structure = SMILES('[CH2]CO[CH]CCC'),
    E0 = (71.1117,'kJ/mol'),
    modes = [
...
species(
    ...
    molecularWeight = (114.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.516414,0.105026,-0.000108366,6.61437e-08,-1.71583e-11,8196.11,33.9913], Tmin=(100,'K'), Tmax=(914.892,'K')), NASAPolynomial(coeffs=[11.285,0.053429,-2.37708e-05,4.50105e-09,-3.14116e-13,6036.7,-21.894], Tmin=(914.892,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(66.8346,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJC(C)OC) + radical(CJCO)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]CO[CH]CCCC(10574)'],
    products = ['C2H4(21)', 'CCCCC=O(1733)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', '[CH2]COC=CCCC(10646)'],
    products = ['[CH2]CO[CH]CCCC(10574)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'C=CO[CH]CCCC(10647)'],
    products = ['[CH2]CO[CH]CCCC(10574)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['C2H4(T)(94)', 'CCCCC=O(1733)'],
    products = ['[CH2]CO[CH]CCCC(10574)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['npropyl(83)', '[CH2]COC=C(1028)'],
    products = ['[CH2]CO[CH]CCCC(10574)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]COCC[CH]CC(10648)'],
    products = ['[CH2]CO[CH]CCCC(10574)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]COCCC[CH]C(10649)'],
    products = ['[CH2]CO[CH]CCCC(10574)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]CCCCOC[CH2](10650)'],
    products = ['[CH2]CO[CH]CCCC(10574)'],
...
reaction(
    label = 'reaction16',
    reactants = ['C2H4(T)(94)', 'CCCC[CH][O](1728)'],
    products = ['[CH2]CO[CH]CCCC(10574)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CH2(S)(23)', '[CH2]CO[CH]CCC(10654)'],
    products = ['[CH2]CO[CH]CCCC(10574)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2]COC([CH2])CCC(2072)'],
    products = ['[CH2]CO[CH]CCCC(10574)'],
...
reaction(
    label = 'reaction23',
    reactants = ['CH2(19)', '[CH2]O[CH]CCCC(1766)'],
    products = ['[CH2]CO[CH]CCCC(10574)'],
...
network(
    label = '1969',
    isomers = [
        '[CH2]CO[CH]CCCC(10574)',
    ],
    reactants = [
        ('C2H4(21)', 'CCCCC=O(1733)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
