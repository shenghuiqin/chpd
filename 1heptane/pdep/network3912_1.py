...
species(
    label = 'C=C(O)C1(O)CO[C]1CC(23056)',
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.12306,0.113589,-0.000115028,6.02043e-08,-1.19482e-11,-36805.6,40.1022], Tmin=(100,'K'), Tmax=(1418,'K')), NASAPolynomial(coeffs=[23.8724,0.0245302,-4.18058e-06,2.67723e-10,-1.98226e-15,-42596.6,-88.814], Tmin=(1418,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-308.002,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(486.397,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + ring(Oxetane) + radical(C2CsJOCs)"""),
)

species(
    label = '[CH2]C(O)C1(O)COC1=CC(23057)',
    structure = SMILES('[CH2]C(O)C1(O)COC1=CC'),
    E0 = (-297.551,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3580,3650,1210,1345,900,1100,2750,3150,900,1100,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,300,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (143.16,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.73821,0.116843,-0.000114918,5.58719e-08,-1.01657e-11,-35517.7,40.6458], Tmin=(100,'K'), Tmax=(1566.85,'K')), NASAPolynomial(coeffs=[28.1613,0.0185353,-2.20926e-06,4.56776e-12,1.06279e-14,-42816.3,-114.694], Tmin=(1566.85,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-297.551,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(486.397,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + ring(2methyleneoxetane) + radical(CJCO)"""),
)
...
species(
    label = '[CH2]C(O)C1(O)COC1=C(23058)',
    structure = SMILES('[CH2]C(O)C1(O)COC1=C'),
    E0 = (-261.526,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,3100,1380,975,1025,1650,2750,3150,900,1100,3580,3650,1210,1345,900,1100,3000,3100,440,815,1455,1000,1380,1390,370,380,2900,435,300,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.37857,0.104534,-0.000105334,5.12107e-08,-9.1389e-12,-31193.8,36.8643], Tmin=(100,'K'), Tmax=(1648.3,'K')), NASAPolynomial(coeffs=[26.0073,0.0117354,8.7694e-07,-5.48685e-10,4.64792e-14,-37303,-104.413], Tmin=(1648.3,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-261.526,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(415.724,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + ring(2methyleneoxetane) + radical(CJCO)"""),
)
...
species(
    label = '[CH2]C(O)C1COC=1CC(23059)',
    structure = SMILES('[CH2]C(O)C1COC=1CC'),
    E0 = (-82.5356,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,3150,900,1100,2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1277.5,1000,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.525533,0.0794469,-1.8565e-05,-4.25479e-08,2.45198e-11,-9745.7,34.7746], Tmin=(100,'K'), Tmax=(966.399,'K')), NASAPolynomial(coeffs=[24.1522,0.0250717,-8.30902e-06,1.5241e-09,-1.12661e-13,-16746,-94.9782], Tmin=(966.399,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-82.5356,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsOs) + ring(Cyclobutene) + radical(CJCO)"""),
)
...
species(
    label = '[CH2]C(O)C1(O)COC1[CH]C(15507)',
    structure = SMILES('[CH2]C(O)C1(O)COC1[CH]C'),
    E0 = (-155.517,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2950,3150,900,1000,1100,2750,2800,2850,1350,1500,750,1050,1375,1000,3580,3650,1210,1345,900,1100,1380,1390,370,380,2900,435,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,300,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2][C](O)C1(O)COC1CC(15505)',
    structure = SMILES('[CH2][C](O)C1(O)COC1CC'),
    E0 = (-178.791,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (144.168,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.44459,0.115627,-0.000112207,4.9436e-08,-4.65764e-12,-21303.4,37.5064], Tmin=(100,'K'), Tmax=(841.889,'K')), NASAPolynomial(coeffs=[20.2061,0.0357575,-1.08775e-05,1.64299e-09,-1.00517e-13,-25763.9,-68.0597], Tmin=(841.889,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-178.791,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Oxetane) + radical(CJCO) + radical(C2CsJOH)"""),
)
...
species(
    label = '[CH2]CC1OCC1(O)C([CH2])O(15508)',
    structure = SMILES('[CH2]CC1OCC1(O)C([CH2])O'),
    E0 = (-150.172,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2950,3150,900,1000,1100,2750,2850,1437.5,1250,1305,750,350,3580,3650,1210,1345,900,1100,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,1380,1390,370,380,2900,435,300,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2]OC(CC)=C(O)C([CH2])O(23060)',
    ...
    molecularWeight = (144.168,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.97664,0.115547,-9.4775e-05,2.36318e-08,3.87737e-12,-30420.2,44.3828], Tmin=(100,'K'), Tmax=(967.61,'K')), NASAPolynomial(coeffs=[28.6507,0.0241896,-7.80009e-06,1.35973e-09,-9.63315e-14,-37997.5,-110.896], Tmin=(967.61,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-254.836,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(498.868,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsOs) + radical(CJCO) + radical(C=COCJ)"""),
)
...
species(
    label = '[CH2]C(O)C1(O)CO[C]1C(23061)',
    structure = SMILES('[CH2]C(O)C1(O)CO[C]1C'),
    E0 = (-150.935,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,3150,900,1100,2750,2800,2850,1350,1500,750,1050,1375,1000,3580,3650,1210,1345,900,1100,3000,3100,440,815,1455,1000,1380,1390,370,380,2900,435,300,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.01033,0.106241,-0.000125315,8.00254e-08,-1.98771e-11,-17969.4,34.8995], Tmin=(100,'K'), Tmax=(1083.96,'K')), NASAPolynomial(coeffs=[17.364,0.0301524,-8.56016e-06,1.16766e-09,-6.36431e-14,-21466.2,-52.9828], Tmin=(1083.96,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-150.935,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Oxetane) + radical(CJCO) + radical(C2CsJOCs)"""),
)
...
species(
    label = '[CH2]C(O)[C](O)C1(CC)CO1(23062)',
    structure = SMILES('[CH2]C(O)[C](O)C1(CC)CO1'),
    E0 = (-173.259,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,3150,900,1100,2750,2800,2850,1350,1500,750,1050,1375,1000,3580,3650,1210,1345,900,1100,360,370,350,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,1380,1390,370,380,2900,435,300,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (144.168,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.15603,0.132511,-0.000163886,1.07976e-07,-2.76829e-11,-20614.1,40.3675], Tmin=(100,'K'), Tmax=(1031.22,'K')), NASAPolynomial(coeffs=[20.9294,0.0350923,-1.07315e-05,1.56145e-09,-8.99007e-14,-24956.8,-69.6867], Tmin=(1031.22,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-173.259,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CJCO) + radical(C2CsJOH)"""),
)
...
species(
    label = '[CH2]C(O)C1(O)COC1([CH2])C(23063)',
    structure = SMILES('[CH2]C(O)C1(O)COC1([CH2])C'),
    E0 = (-162.892,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,3150,900,1100,2750,2800,2850,1350,1500,750,1050,1375,1000,3580,3650,1210,1345,900,1100,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,1380,1390,370,380,2900,435,300,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (144.168,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.87472,0.124066,-0.000123802,5.02578e-08,-1.44121e-12,-19374.6,37.151], Tmin=(100,'K'), Tmax=(825.916,'K')), NASAPolynomial(coeffs=[23.9982,0.0293007,-7.15768e-06,8.74702e-10,-4.50719e-14,-24690,-89.0281], Tmin=(825.916,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-162.892,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Oxetane) + radical(CJCO) + radical(CJC(C)OC)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'C=C(O)C1(O)CO[C]1CC(23056)'],
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', '[CH2]C(O)C1(O)COC1=CC(23057)'],
    products = ['[CH2]C(O)C1(O)CO[C]1CC(9063)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['CH3(17)', '[CH2]C(O)C1(O)COC1=C(23058)'],
    products = ['[CH2]C(O)C1(O)CO[C]1CC(9063)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['OH(5)', '[CH2]C(O)C1COC=1CC(23059)'],
    products = ['[CH2]C(O)C1(O)CO[C]1CC(9063)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['OH(5)', 'C=CC1(O)CO[C]1CC(13738)'],
    products = ['[CH2]C(O)C1(O)CO[C]1CC(9063)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]C(O)C1(O)COC1[CH]C(15507)'],
    products = ['[CH2]C(O)C1(O)CO[C]1CC(9063)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]C(O)C1(O)[CH]OC1CC(15506)'],
    products = ['[CH2]C(O)C1(O)CO[C]1CC(9063)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2]C(O)C1(O)CO[C]1CC(9063)'],
    products = ['[CH2][C](O)C1(O)COC1CC(15505)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]CC1OCC1(O)C([CH2])O(15508)'],
    products = ['[CH2]C(O)C1(O)CO[C]1CC(9063)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH2]OC(CC)=C(O)C([CH2])O(23060)'],
    products = ['[CH2]C(O)C1(O)CO[C]1CC(9063)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[CH2]C(O)C1(O)CO[C]1CC(9063)'],
    products = ['C=C(O)C1(O)COC1CC(15509)'],
...
reaction(
    label = 'reaction26',
    reactants = ['CH2(S)(23)', '[CH2]C(O)C1(O)CO[C]1C(23061)'],
    products = ['[CH2]C(O)C1(O)CO[C]1CC(9063)'],
...
reaction(
    label = 'reaction28',
    reactants = ['[CH2]C(O)[C](O)C1(CC)CO1(23062)'],
    products = ['[CH2]C(O)C1(O)CO[C]1CC(9063)'],
...
reaction(
    label = 'reaction30',
    reactants = ['[CH2]C(O)C1(O)COC1([CH2])C(23063)'],
    products = ['[CH2]C(O)C1(O)CO[C]1CC(9063)'],
...
reaction(
    label = 'reaction32',
    reactants = ['CH2(19)', 'CC[C]1OCC1(O)[CH]O(5526)'],
    products = ['[CH2]C(O)C1(O)CO[C]1CC(9063)'],
