...
species(
    ...
    molecularWeight = (88.0621,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.93259,0.016917,1.12702e-05,-1.39156e-08,3.17363e-12,-4380.55,14.9925], Tmin=(100,'K'), Tmax=(1766.87,'K')), NASAPolynomial(coeffs=[10.0724,0.0250441,-1.43292e-05,2.79914e-09,-1.89717e-13,-9988.42,-27.8531], Tmin=(1766.87,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-36.3292,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-OsOsOsH) + group(Cs-CsHHH) + ring(Cyclobutane) + radical(OCOJ) + radical(Cs_P)"""),
)
...
species(
    ...
    E0 = (-15.2577,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,1855,455,950,430.552,433.005],'cm^-1')),
        HinderedRotor(inertia=(0.0968322,'amu*angstrom^2'), symmetry=1, barrier=(12.9066,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0981033,'amu*angstrom^2'), symmetry=1, barrier=(12.8637,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0960098,'amu*angstrom^2'), symmetry=1, barrier=(12.8697,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
reaction(
    label = 'reaction1',
    reactants = ['C[CH]OC([O])=O(816)'],
    products = ['CO2(13)', 'CH3CHO(37)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'C=COC([O])=O(829)'],
    products = ['C[CH]OC([O])=O(816)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction7',
    reactants = ['C[CH][O](176)', '[O][C]=O(669)'],
    products = ['C[CH]OC([O])=O(816)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction12',
    reactants = ['CHCH3(T)(95)', 'CO3t1(671)'],
    products = ['C[CH]OC([O])=O(816)'],
