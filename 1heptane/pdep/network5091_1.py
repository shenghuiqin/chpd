...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.737418,0.112363,-0.000107528,6.14049e-08,-1.53425e-11,-51613.5,37.8701], Tmin=(100,'K'), Tmax=(931.302,'K')), NASAPolynomial(coeffs=[10.4992,0.0641036,-2.98019e-05,5.76759e-09,-4.07765e-13,-53706.5,-15.5408], Tmin=(931.302,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-430.5,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(548.755,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)HHH) + group(Cds-OdCsCs)"""),
)
...
species(
    label = 'CC([O])CC[CH]OO(31558)',
    structure = SMILES('CC([O])CC[CH]OO'),
    E0 = (-9.9339,'kJ/mol'),
    modes = [
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.12886,0.0908996,-9.60539e-05,5.87969e-08,-1.52473e-11,-1060.27,31.5446], Tmin=(100,'K'), Tmax=(915.084,'K')), NASAPolynomial(coeffs=[10.6215,0.0450345,-2.08724e-05,4.02512e-09,-2.838e-13,-2980.61,-18.1453], Tmin=(915.084,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-9.9339,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(407.409,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(CCsJOOH)"""),
)

species(
    label = 'CC[C](CCC(C)[O])OO(31559)',
...
species(
    ...
    molecularWeight = (146.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.09095,0.117046,-0.000110539,5.83392e-08,-1.29914e-11,-6833.34,42.2172], Tmin=(100,'K'), Tmax=(1054.77,'K')), NASAPolynomial(coeffs=[14.5527,0.0577215,-2.61729e-05,5.01623e-09,-3.52999e-13,-10133.5,-34.0887], Tmin=(1054.77,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-58.3049,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(548.755,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(CCJCOOH)"""),
)
...
species(
    label = 'CCC(C[CH]C(C)[O])OO(31561)',
    structure = SMILES('CCC(C[CH]C(C)[O])OO'),
    E0 = (-58.8178,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3025,407.5,1350,352.5,3615,1310,387.5,850,1000,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'C[CH]C(CCC(C)[O])OO(31563)',
    structure = SMILES('C[CH]C(CCC(C)[O])OO'),
    E0 = (-58.3049,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3025,407.5,1350,352.5,3615,1310,387.5,850,1000,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'CCC(CC[C](C)[O])OO(31565)',
    structure = SMILES('CCC(CC[C](C)[O])OO'),
    E0 = (-82.092,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,360,370,350,3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2]C([O])CCC(CC)OO(31566)',
    structure = SMILES('[CH2]C([O])CCC(CC)OO'),
    E0 = (-47.1307,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1310,387.5,850,1000,3000,3100,440,815,1455,1000,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    ...
    molecularWeight = (133.166,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.400393,0.105076,-0.00011426,8.09868e-08,-2.54853e-11,-27145.1,36.5956], Tmin=(100,'K'), Tmax=(750.152,'K')), NASAPolynomial(coeffs=[7.53994,0.062734,-2.95876e-05,5.73354e-09,-4.04484e-13,-28336.4,0.571254], Tmin=(750.152,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-226.952,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCOJ)"""),
)

species(
    label = 'CCC(CC[C](C)O)OO(31568)',
    structure = SMILES('CCC(CC[C](C)O)OO'),
    E0 = (-312.453,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
reaction(
    label = 'reaction1',
    reactants = ['H(3)', 'CCC(CCC(C)=O)OO(31557)'],
    products = ['CCC(CCC(C)[O])OO(4222)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['CH3CHO(37)', '[CH2]CC(CC)OO(2965)'],
    products = ['CCC(CCC(C)[O])OO(4222)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH3(17)', 'CCC(CCC=O)OO(17507)'],
    products = ['CCC(CCC(C)[O])OO(4222)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['H(3)', 'CCC(CCC(C)[O])O[O](3735)'],
    products = ['CCC(CCC(C)[O])OO(4222)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['CC[CH]OO(288)', '[CH2]CC(C)[O](1023)'],
    products = ['CCC(CCC(C)[O])OO(4222)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['C2H5(29)', 'CC([O])CC[CH]OO(31558)'],
    products = ['CCC(CCC(C)[O])OO(4222)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(1.15e+14,'cm^3/(mol*s)','*|/',2), n=-0.35, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2500,'K'), comment="""Estimated using template [C_rad/H/NonDe;C_rad/H2/Cs] for rate rule [C_rad/H/CsO;C_rad/H2/Cs]
Euclidian distance = 2.0
...
reaction(
    label = 'reaction9',
    reactants = ['H(3)', 'CC[C](CCC(C)[O])OO(31559)'],
    products = ['CCC(CCC(C)[O])OO(4222)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]C(CC)OO(715)', '[CH2]C(C)[O](1669)'],
    products = ['CCC(CCC(C)[O])OO(4222)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(3)', 'CCC([CH]CC(C)[O])OO(31560)'],
    products = ['CCC(CCC(C)[O])OO(4222)'],
...
reaction(
    label = 'reaction12',
    reactants = ['C[CH][O](176)', '[CH2]CC(CC)OO(2965)'],
    products = ['CCC(CCC(C)[O])OO(4222)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(3)', 'CCC(C[CH]C(C)[O])OO(31561)'],
    products = ['CCC(CCC(C)[O])OO(4222)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CH3(17)', '[CH2]C(CCC(C)[O])OO(31562)'],
    products = ['CCC(CCC(C)[O])OO(4222)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(3)', 'C[CH]C(CCC(C)[O])OO(31563)'],
    products = ['CCC(CCC(C)[O])OO(4222)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CH3(17)', 'CCC(CC[CH][O])OO(31564)'],
    products = ['CCC(CCC(C)[O])OO(4222)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(3)', 'CCC(CC[C](C)[O])OO(31565)'],
    products = ['CCC(CCC(C)[O])OO(4222)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(3)', '[CH2]CC(CCC(C)[O])OO(4071)'],
    products = ['CCC(CCC(C)[O])OO(4222)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(3)', '[CH2]C([O])CCC(CC)OO(31566)'],
    products = ['CCC(CCC(C)[O])OO(4222)'],
...
reaction(
    label = 'reaction21',
    reactants = ['CH2(S)(23)', 'CCC(CCC[O])OO(31567)'],
    products = ['CCC(CCC(C)[O])OO(4222)'],
...
reaction(
    label = 'reaction22',
    reactants = ['CCC(CCC(C)[O])OO(4222)'],
    products = ['CCC(CC[C](C)O)OO(31568)'],
...
reaction(
    label = 'reaction23',
    reactants = ['CCC(C[CH]C(C)O)OO(31569)'],
    products = ['CCC(CCC(C)[O])OO(4222)'],
...
reaction(
    label = 'reaction24',
    reactants = ['CCC(CCC(C)[O])OO(4222)'],
    products = ['[CH2]C(O)CCC(CC)OO(31570)'],
...
reaction(
    label = 'reaction25',
    reactants = ['CCC([CH]CC(C)O)OO(31571)'],
    products = ['CCC(CCC(C)[O])OO(4222)'],
...
reaction(
    label = 'reaction26',
    reactants = ['CCC(CCC(C)[O])OO(4222)'],
    products = ['CC[C](CCC(C)O)OO(31572)'],
...
reaction(
    label = 'reaction27',
    reactants = ['CCC(CCC(C)[O])OO(4222)'],
    products = ['C[CH]C(CCC(C)O)OO(31573)'],
...
reaction(
    label = 'reaction28',
    reactants = ['CCC(CCC(C)[O])OO(4222)'],
    products = ['CCC(CCC(C)O)O[O](31574)'],
...
reaction(
    label = 'reaction29',
    reactants = ['CCC(CCC(C)[O])OO(4222)'],
    products = ['[CH2]CC(CCC(C)O)OO(31575)'],
...
reaction(
    label = 'reaction31',
    reactants = ['C[CH]CCC(CC)OO(236)', 'O(4)'],
    products = ['CCC(CCC(C)[O])OO(4222)'],
