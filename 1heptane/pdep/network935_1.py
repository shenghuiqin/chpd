...
species(
    label = 'CC[CH]CC=C=O(2906)',
    structure = SMILES('CC[CH]CC=C=O'),
    E0 = (45.2144,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2120,512.5,787.5,3010,987.5,1337.5,450,1655,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,188.8,1619.54,1620.89],'cm^-1')),
        HinderedRotor(inertia=(0.00478557,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.312173,'amu*angstrom^2'), symmetry=1, barrier=(7.91691,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.305265,'amu*angstrom^2'), symmetry=1, barrier=(7.912,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.311426,'amu*angstrom^2'), symmetry=1, barrier=(7.91757,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (97.1351,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.21969,0.0478143,1.54754e-05,-1.18498e-07,1.08344e-10,5493.08,24.46], Tmin=(100,'K'), Tmax=(436.06,'K')), NASAPolynomial(coeffs=[3.84537,0.0456366,-2.08402e-05,3.99577e-09,-2.80856e-13,5230.22,16.578], Tmin=(436.06,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(45.2144,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cdd-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-(Cdd-O2d)CsH) + radical(RCCJCC)"""),
)

species(
    label = 'CC=CCC=[C]O(7774)',
    structure = SMILES('CC=CCC=[C]O'),
    E0 = (83.6757,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2995,3010,3025,975,987.5,1000,1300,1337.5,1375,400,450,500,1630,1655,1680,1685,370,3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,191.373,191.502],'cm^-1')),
        HinderedRotor(inertia=(0.515215,'amu*angstrom^2'), symmetry=1, barrier=(13.3769,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.514253,'amu*angstrom^2'), symmetry=1, barrier=(13.3775,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.514409,'amu*angstrom^2'), symmetry=1, barrier=(13.3767,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.514833,'amu*angstrom^2'), symmetry=1, barrier=(13.3772,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (97.1351,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.717795,0.0617016,-3.00698e-05,-7.97194e-09,8.43105e-12,10191.4,29.3977], Tmin=(100,'K'), Tmax=(982.326,'K')), NASAPolynomial(coeffs=[15.5549,0.0244829,-8.65959e-06,1.53749e-09,-1.07148e-13,6157.15,-47.6151], Tmin=(982.326,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(83.6757,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(C=CJO)"""),
)

species(
    label = 'CCC=CC=[C]O(7775)',
    structure = SMILES('CCC=CC=[C]O'),
    E0 = (66.2017,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2995,3010,3025,975,987.5,1000,1300,1337.5,1375,400,450,500,1630,1655,1680,1685,370,3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.74811,'amu*angstrom^2'), symmetry=1, barrier=(17.2005,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.747517,'amu*angstrom^2'), symmetry=1, barrier=(17.1869,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.748201,'amu*angstrom^2'), symmetry=1, barrier=(17.2026,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.749171,'amu*angstrom^2'), symmetry=1, barrier=(17.2249,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (97.1351,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.520147,0.0623713,-1.87294e-05,-2.98279e-08,1.88921e-11,8100.5,28.1912], Tmin=(100,'K'), Tmax=(937.545,'K')), NASAPolynomial(coeffs=[19.1969,0.0182247,-4.95478e-06,8.06666e-10,-5.73905e-14,3036.61,-69.0381], Tmin=(937.545,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(66.2017,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsOsH) + radical(C=CJO)"""),
)

species(
    label = 'CC[CH]CC#CO(7776)',
    structure = SMILES('CC[CH]CC#CO'),
    E0 = (155.014,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2100,2250,500,550,3025,407.5,1350,352.5,3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (97.1351,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.42109,0.0604199,-5.16219e-05,3.06317e-08,-8.59045e-12,18733.4,27.5814], Tmin=(100,'K'), Tmax=(813.751,'K')), NASAPolynomial(coeffs=[5.08266,0.0424206,-1.84422e-05,3.44808e-09,-2.38752e-13,18137.5,10.6712], Tmin=(813.751,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(155.014,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CtH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CtCsHH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtOs) + radical(RCCJCC)"""),
)
...
species(
    ...
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.367007,0.0704987,-4.7295e-05,8.72603e-09,2.52652e-12,20839.8,32.3807], Tmin=(100,'K'), Tmax=(1010.91,'K')), NASAPolynomial(coeffs=[15.8593,0.0272583,-9.93199e-06,1.75851e-09,-1.20827e-13,16784.7,-47.0929], Tmin=(1010.91,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(172.116,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(C=CJO) + radical(RCCJ)"""),
)

species(
    label = 'CCCC[C]=[C]O(7780)',
    structure = SMILES('CCCC[C]=[C]O'),
    E0 = (204.711,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,1670,1700,300,440,3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.194922,0.0755009,-6.52556e-05,2.98688e-08,-5.48926e-12,24764.9,31.6892], Tmin=(100,'K'), Tmax=(1309.23,'K')), NASAPolynomial(coeffs=[15.9883,0.0272485,-9.97242e-06,1.71844e-09,-1.13907e-13,20629.4,-48.7603], Tmin=(1309.23,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(204.711,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(C=CJO) + radical(Cds_S)"""),
)

species(
    label = 'CC[CH][CH]C=CO(7781)',
    structure = SMILES('CC[CH]C=C[CH]O'),
    E0 = (28.9444,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.02229,0.0511736,6.73431e-06,-4.30213e-08,1.93333e-11,3601.02,28.0628], Tmin=(100,'K'), Tmax=(1002.38,'K')), NASAPolynomial(coeffs=[14.5144,0.0304234,-1.17313e-05,2.19277e-09,-1.57037e-13,-766.226,-45.3532], Tmin=(1002.38,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(28.9444,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(C=CCJO) + radical(Allyl_S)"""),
)
...
species(
    ...
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.44453,0.0688204,-4.2971e-05,4.28236e-09,4.21663e-12,15390.4,31.5375], Tmin=(100,'K'), Tmax=(991.084,'K')), NASAPolynomial(coeffs=[15.4882,0.0275026,-9.7956e-06,1.71516e-09,-1.17376e-13,11455.8,-45.7109], Tmin=(991.084,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(126.83,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(RCCJ) + radical(RCCJCC)"""),
)

species(
    label = 'CCC=CC=CO(7784)',
    structure = SMILES('CCC=CC=CO'),
    E0 = (-173.542,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.311162,0.0605971,8.24619e-06,-6.88027e-08,3.52344e-11,-20720.5,25.8131], Tmin=(100,'K'), Tmax=(926.519,'K')), NASAPolynomial(coeffs=[23.3262,0.0141176,-2.11874e-06,2.57525e-10,-2.18804e-14,-27255.1,-95.7135], Tmin=(926.519,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-173.542,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(390.78,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsOsH)"""),
)
...
species(
    label = 'C[CH]CC=[C]O(1361)',
    structure = SMILES('C[CH]CC=[C]O'),
    E0 = (185.096,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,3615,1277.5,1000,1685,370,2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2850,1437.5,1250,1305,750,350,386.167,391.526],'cm^-1')),
        HinderedRotor(inertia=(0.0011166,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0871596,'amu*angstrom^2'), symmetry=1, barrier=(9.49653,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0896031,'amu*angstrom^2'), symmetry=1, barrier=(9.49924,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0885312,'amu*angstrom^2'), symmetry=1, barrier=(9.48639,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.282,0.0539184,-3.79604e-05,1.11242e-08,-1.41886e-13,22364.8,27.8008], Tmin=(100,'K'), Tmax=(1024.1,'K')), NASAPolynomial(coeffs=[11.4911,0.0239665,-8.6253e-06,1.48995e-09,-9.98989e-14,19753.4,-24.2362], Tmin=(1024.1,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(185.096,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(RCCJC) + radical(C=CJO)"""),
)

species(
    label = '[CH2]C(C)CC=[C]O(7786)',
    structure = SMILES('[CH2]C(C)CC=[C]O'),
    E0 = (162.91,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,1685,370,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,384.638,384.639],'cm^-1')),
        HinderedRotor(inertia=(0.00113945,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.127879,'amu*angstrom^2'), symmetry=1, barrier=(13.4255,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.127878,'amu*angstrom^2'), symmetry=1, barrier=(13.4255,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.127879,'amu*angstrom^2'), symmetry=1, barrier=(13.4255,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.127878,'amu*angstrom^2'), symmetry=1, barrier=(13.4255,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
...
species(
    label = 'CCC1CC=C1O(7754)',
    structure = SMILES('CCC1CC=C1O'),
    E0 = (-125.623,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (98.143,'amu'),
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'CC[CH]CC=C=O(2906)'],
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)', 'CC[CH]CC#CO(7776)'],
    products = ['CC[CH]CC=[C]O(1349)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['CH3(17)', 'C=CCC=[C]O(7335)'],
    products = ['CC[CH]CC=[C]O(1349)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction23',
    reactants = ['CH2(S)(23)', 'C[CH]CC=[C]O(1361)'],
    products = ['CC[CH]CC=[C]O(1349)'],
...
reaction(
    label = 'reaction27',
    reactants = ['[CH]CC(144)', '[CH2]C=[C]O(6303)'],
    products = ['CC[CH]CC=[C]O(1349)'],
