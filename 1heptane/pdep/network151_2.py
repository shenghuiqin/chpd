...
species(
    label = 'C[CH]CC=CC(523)',
    structure = SMILES('C[CH]CC=CC'),
    E0 = (118.119,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2995,3025,975,1000,1300,1375,400,500,1630,1680,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3025,407.5,1350,352.5,315.554,1832.88],'cm^-1')),
        HinderedRotor(inertia=(0.0963039,'amu*angstrom^2'), symmetry=1, barrier=(6.80065,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.09609,'amu*angstrom^2'), symmetry=1, barrier=(6.80121,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0961345,'amu*angstrom^2'), symmetry=1, barrier=(6.79986,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0963232,'amu*angstrom^2'), symmetry=1, barrier=(6.80061,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (83.1515,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.47152,0.0514182,-2.3141e-05,3.93235e-09,-7.49599e-14,14301,25.9702], Tmin=(100,'K'), Tmax=(1757.11,'K')), NASAPolynomial(coeffs=[12.8225,0.032391,-1.27139e-05,2.18284e-09,-1.40002e-13,9260.29,-38.1824], Tmin=(1757.11,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(118.119,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(390.78,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(RCCJC)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'C[CH]CC=CC(523)'],
    products = ['C[CH]CC[CH]C(376)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]C[CH]C(129)', 'CHCH3(T)(95)'],
    products = ['C[CH]CC[CH]C(376)'],
