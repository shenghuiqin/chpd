...
species(
    label = '[CH2]C(C=C)C=CC(19165)',
    structure = SMILES('[CH2]C(C=C)C=CC'),
    E0 = (224.237,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,3100,1380,975,1025,1650,2995,3010,3025,975,987.5,1000,1300,1337.5,1375,400,450,500,1630,1655,1680,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,252.531,252.531],'cm^-1')),
        HinderedRotor(inertia=(0.145605,'amu*angstrom^2'), symmetry=1, barrier=(6.58916,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.145605,'amu*angstrom^2'), symmetry=1, barrier=(6.58916,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.145604,'amu*angstrom^2'), symmetry=1, barrier=(6.58916,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.390208,'amu*angstrom^2'), symmetry=1, barrier=(17.6584,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (95.1622,'amu'),
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]C(C=C)C[CH]C(3299)'],
    products = ['[CH2]C1CC1C[CH]C(19163)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)', '[CH2]C(C=C)C=CC(19165)'],
    products = ['[CH2]C(C=C)C[CH]C(3299)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['H(3)', '[CH2]C(C=C)CC=C(19166)'],
    products = ['[CH2]C(C=C)C[CH]C(3299)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['C=CC[CH]C(380)', 'C2H3(30)'],
    products = ['[CH2]C(C=C)C[CH]C(3299)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]C([CH]CC)C=C(3297)'],
    products = ['[CH2]C(C=C)C[CH]C(3299)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]CCC([CH2])C=C(3301)'],
    products = ['[CH2]C(C=C)C[CH]C(3299)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2][CH]CC(C)C=C(18363)'],
    products = ['[CH2]C(C=C)C[CH]C(3299)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH2]C(C=C)C[CH]C(3299)'],
    products = ['[CH2]C1[CH]CC(C)C1(19150)'],
...
reaction(
    label = 'reaction30',
    reactants = ['CH2(19)', '[CH2]C=CC[CH]C(18984)'],
    products = ['[CH2]C(C=C)C[CH]C(3299)'],
...
reaction(
    label = 'reaction31',
    reactants = ['CHCH3(T)(95)', '[CH2]C([CH2])C=C(2950)'],
    products = ['[CH2]C(C=C)C[CH]C(3299)'],
