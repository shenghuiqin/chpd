...
species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.51336,'amu*angstrom^2'), symmetry=1, barrier=(34.7952,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.51362,'amu*angstrom^2'), symmetry=1, barrier=(34.801,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (71.0547,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.92374,0.031601,7.25278e-06,-4.5051e-08,2.29001e-11,11731.1,14.1484], Tmin=(100,'K'), Tmax=(935.324,'K')), NASAPolynomial(coeffs=[17.8879,-0.000879502,1.94286e-06,-3.53678e-10,1.7701e-14,7179.2,-70.171], Tmin=(935.324,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(96.8086,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-OsOsHH) + group(Ct-CtOs) + group(Ct-CtH) + radical(OCOJ)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'C=[C]OC=O(2719)'],
    products = ['C=[C]OC[O](940)'],
    transitionState = 'TS2',
