species(
    label = '[CH2]OO[CH]CCC(CCC)OO(17520)',
    structure = SMILES('[CH2]OO[CH]CCC(CCC)OO'),
    E0 = (-24.971,'kJ/mol'),
    modes = [
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.3527,0.150882,-0.000163337,1.03597e-07,-2.80363e-11,-2784.17,48.0115], Tmin=(100,'K'), Tmax=(875.979,'K')), NASAPolynomial(coeffs=[13.8583,0.0768578,-3.65818e-05,7.13023e-09,-5.05427e-13,-5624.29,-28.0508], Tmin=(875.979,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-24.971,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(636.057,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(CsJOOC) + radical(CCsJOOC)"""),
)
...
species(
    label = '[CH2]OOC=CCC(CCC)OO(17609)',
    structure = SMILES('[CH2]OOC=CCC(CCC)OO'),
    E0 = (-79.6048,'kJ/mol'),
    modes = [
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.1757,0.138426,-0.000128351,6.36775e-08,-1.30791e-11,-9354.08,47.96], Tmin=(100,'K'), Tmax=(1147.8,'K')), NASAPolynomial(coeffs=[19.8707,0.0615971,-2.79477e-05,5.36167e-09,-3.77567e-13,-14415.1,-61.4401], Tmin=(1147.8,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-79.6048,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(615.271,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(CsJOOC)"""),
)
...
species(
    label = '[CH2]OOC[CH]CC(CCC)OO(17610)',
    structure = SMILES('[CH2]OOC[CH]CC(CCC)OO'),
    E0 = (-10.9967,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1310,387.5,850,1000,2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,350,500,795,815,3000,3100,440,815,1455,1000,1380,1390,370,380,2900,435,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2]OOCC[CH]C(CCC)OO(17611)',
    structure = SMILES('[CH2]OOCC[CH]C(CCC)OO'),
    E0 = (-10.9967,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1310,387.5,850,1000,2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,350,500,795,815,3000,3100,440,815,1455,1000,1380,1390,370,380,2900,435,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2]OOCCC[C](CCC)OO(17612)',
    structure = SMILES('[CH2]OOCCC[C](CCC)OO'),
    E0 = (-24.5126,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (176.21,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.48554,0.154809,-0.000186483,1.38553e-07,-4.41257e-11,-2725.79,48.4764], Tmin=(100,'K'), Tmax=(751.212,'K')), NASAPolynomial(coeffs=[11.3952,0.0808957,-3.88926e-05,7.57096e-09,-5.34452e-13,-4811.23,-14.5191], Tmin=(751.212,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-24.5126,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(636.057,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(CsJOOC) + radical(C2CsJOOH)"""),
)

species(
    label = 'CCCC(C[CH][CH]OOC)OO(17613)',
    structure = SMILES('CCCC(C[CH][CH]OOC)OO'),
    E0 = (-18.1529,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (176.21,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.52747,0.155722,-0.000189137,1.40635e-07,-4.46397e-11,-1959.37,51.2365], Tmin=(100,'K'), Tmax=(754.69,'K')), NASAPolynomial(coeffs=[11.7818,0.0798797,-3.83927e-05,7.47167e-09,-5.27298e-13,-4119.17,-13.7702], Tmin=(754.69,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-18.1529,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(636.057,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(CCsJOOC) + radical(CCJCOOH)"""),
)

species(
    label = '[CH2]OOCCCC([CH]CC)OO(17614)',
    structure = SMILES('[CH2]OOCCCC([CH]CC)OO'),
    E0 = (-10.9967,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1310,387.5,850,1000,2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,350,500,795,815,3000,3100,440,815,1455,1000,1380,1390,370,380,2900,435,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2]OOCCCC(CCC)O[O](17615)',
    structure = SMILES('[CH2]OOCCCC(CCC)O[O]'),
    E0 = (-59.407,'kJ/mol'),
    modes = [
...
species(
    label = '[CH2]OOCCCC(C[CH]C)OO(17616)',
    structure = SMILES('[CH2]OOCCCC(C[CH]C)OO'),
    E0 = (-16.9654,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1310,387.5,850,1000,2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,350,500,795,815,3000,3100,440,815,1455,1000,1380,1390,370,380,2900,435,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'CCCC([CH]C[CH]OOC)OO(17617)',
    structure = SMILES('CCCC([CH]C[CH]OOC)OO'),
    E0 = (-18.1529,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (176.21,'amu'),
...
species(
    label = '[CH2]CCC(CCCOO[CH2])OO(17618)',
    structure = SMILES('[CH2]CCC(CCCOO[CH2])OO'),
    E0 = (-6.16534,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (176.21,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.31569,0.149704,-0.000159524,9.85801e-08,-2.5936e-11,-523.296,49.3688], Tmin=(100,'K'), Tmax=(900.002,'K')), NASAPolynomial(coeffs=[14.3758,0.0755206,-3.58849e-05,6.99625e-09,-4.96234e-13,-3527.78,-29.3994], Tmin=(900.002,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-6.16534,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(636.057,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(CsJOOC) + radical(RCCJ)"""),
)

species(
    label = 'CCC[C](CC[CH]OOC)OO(17619)',
    structure = SMILES('CCC[C](CC[CH]OOC)OO'),
    E0 = (-31.6687,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (176.21,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.17634,0.135679,-8.5507e-05,-9.0373e-08,1.33242e-10,-3644.76,44.6868], Tmin=(100,'K'), Tmax=(483.146,'K')), NASAPolynomial(coeffs=[9.61643,0.0837525,-4.04948e-05,7.85581e-09,-5.51476e-13,-5124.5,-4.05185], Tmin=(483.146,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-31.6687,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(636.057,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(CCsJOOC) + radical(C2CsJOOH)"""),
)

species(
    label = 'CC[CH]C(CC[CH]OOC)OO(17620)',
    structure = SMILES('CC[CH]C(CC[CH]OOC)OO'),
    E0 = (-18.1529,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (176.21,'amu'),
...
species(
    label = 'CCCC(CC=COOC)OO(17621)',
    structure = SMILES('CCCC(CC=COOC)OO'),
    E0 = (-273.202,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (176.21,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.03509,0.137044,-0.000122608,5.95667e-08,-1.21477e-11,-32644.9,47.7601], Tmin=(100,'K'), Tmax=(1144.63,'K')), NASAPolynomial(coeffs=[18.1144,0.0666312,-3.03361e-05,5.8258e-09,-4.10272e-13,-37257.8,-52.1718], Tmin=(1144.63,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-273.202,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(640.214,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH)"""),
)
...
species(
    label = '[CH2]OO[CH]CCC(CC)OO(17622)',
    structure = SMILES('[CH2]OO[CH]CCC(CC)OO'),
    E0 = (-1.19075,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1310,387.5,850,1000,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,350,500,795,815,3000,3100,440,815,1455,1000,1380,1390,370,380,2900,435,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.74439,0.136584,-0.000151331,9.80763e-08,-2.70361e-11,54.7664,43.5799], Tmin=(100,'K'), Tmax=(862.243,'K')), NASAPolynomial(coeffs=[12.9484,0.068423,-3.27532e-05,6.39432e-09,-4.5348e-13,-2478.97,-25.1266], Tmin=(862.243,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1.19075,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(565.384,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(CsJOOC) + radical(CCsJOOC)"""),
)
...
species(
    label = '[CH2]OOC1CCC(CCC)O1(17623)',
    structure = SMILES('[CH2]OOC1CCC(CCC)O1'),
    E0 = (-217.751,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (159.203,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.25612,0.0982407,-3.06789e-05,-2.72534e-08,1.70714e-11,-25984.8,37.9497], Tmin=(100,'K'), Tmax=(995.458,'K')), NASAPolynomial(coeffs=[19.4339,0.0529628,-1.95012e-05,3.46688e-09,-2.38865e-13,-31979.9,-71.1954], Tmin=(995.458,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-217.751,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(606.956,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-OsHHH) + ring(Tetrahydrofuran) + radical(CsJOOC)"""),
)

species(
    label = '[CH2]OOC([CH2])CC(CCC)OO(17624)',
    structure = SMILES('[CH2]OOC([CH2])CC(CCC)OO'),
    E0 = (-10.0921,'kJ/mol'),
    modes = [
...
species(
    label = '[CH2]OOC(O)CCC([O])CCC(17625)',
    structure = SMILES('[CH2]OOC(O)CCC([O])CCC'),
    E0 = (-252.787,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (176.21,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.11416,0.142316,-0.000137787,7.44891e-08,-1.70243e-11,-30189.6,49.0496], Tmin=(100,'K'), Tmax=(1027.84,'K')), NASAPolynomial(coeffs=[16.3844,0.0703252,-3.27249e-05,6.34368e-09,-4.49165e-13,-33992.2,-40.7029], Tmin=(1027.84,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-252.787,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(640.214,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(CsJOOC) + radical(CC(C)OJ)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]OO[CH]CCC(CCC)OO(17520)'],
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', '[CH2]OOC=CCC(CCC)OO(17609)'],
    products = ['[CH2]OO[CH]CCC(CCC)OO(17520)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH2]C(CCC)OO(331)', '[CH2]OOC=C(960)'],
    products = ['[CH2]OO[CH]CCC(CCC)OO(17520)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[CH2]OOC[CH]CC(CCC)OO(17610)'],
    products = ['[CH2]OO[CH]CCC(CCC)OO(17520)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[CH2]OOCC[CH]C(CCC)OO(17611)'],
    products = ['[CH2]OO[CH]CCC(CCC)OO(17520)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2]OOCCC[C](CCC)OO(17612)'],
    products = ['[CH2]OO[CH]CCC(CCC)OO(17520)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2]OO[CH]CCC(CCC)OO(17520)'],
    products = ['CCCC(C[CH][CH]OOC)OO(17613)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]OOCCCC([CH]CC)OO(17614)'],
    products = ['[CH2]OO[CH]CCC(CCC)OO(17520)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]OOCCCC(CCC)O[O](17615)'],
    products = ['[CH2]OO[CH]CCC(CCC)OO(17520)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]OOCCCC(C[CH]C)OO(17616)'],
    products = ['[CH2]OO[CH]CCC(CCC)OO(17520)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]OO[CH]CCC(CCC)OO(17520)'],
    products = ['CCCC([CH]C[CH]OOC)OO(17617)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]CCC(CCCOO[CH2])OO(17618)'],
    products = ['[CH2]OO[CH]CCC(CCC)OO(17520)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2]OO[CH]CCC(CCC)OO(17520)'],
    products = ['CCC[C](CC[CH]OOC)OO(17619)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]OO[CH]CCC(CCC)OO(17520)'],
    products = ['CC[CH]C(CC[CH]OOC)OO(17620)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]OO[CH]CCC(CCC)OO(17520)'],
    products = ['CCCC(CC=COOC)OO(17621)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CH2(S)(23)', '[CH2]OO[CH]CCC(CC)OO(17622)'],
    products = ['[CH2]OO[CH]CCC(CCC)OO(17520)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2]OO[CH]CCC(CCC)OO(17520)'],
    products = ['OH(5)', '[CH2]OOC1CCC(CCC)O1(17623)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2]OOC([CH2])CC(CCC)OO(17624)'],
    products = ['[CH2]OO[CH]CCC(CCC)OO(17520)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH2]OO[CH]CCC(CCC)OO(17520)'],
    products = ['[CH2]OOC(O)CCC([O])CCC(17625)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH2]O[O](92)', '[CH]CCC(CCC)OO(17474)'],
    products = ['[CH2]OO[CH]CCC(CCC)OO(17520)'],
...
reaction(
    label = 'reaction23',
    reactants = ['CH2(19)', 'CCCC(CC[CH]O[O])OO(17626)'],
    products = ['[CH2]OO[CH]CCC(CCC)OO(17520)'],
