...
species(
    label = '[CH2][CH]C1CC(CC)O1(20882)',
    structure = SMILES('[CH2][CH]C1CC(CC)O1'),
    E0 = (188.422,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.671987,0.056814,2.30178e-05,-7.33528e-08,3.43304e-11,22797,31.2962], Tmin=(100,'K'), Tmax=(914.607,'K')), NASAPolynomial(coeffs=[15.6963,0.0338727,-9.49782e-06,1.47422e-09,-9.78003e-14,18259.9,-49.6253], Tmin=(914.607,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(188.422,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(465.61,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Oxetane) + radical(RCCJ) + radical(CCJCO)"""),
)
...
species(
    label = 'C=C=CCC([O])CC(20883)',
    structure = SMILES('C=C=CCC([O])CC'),
    E0 = (134.387,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([540,610,2055,3010,987.5,1337.5,450,1655,2750,2800,2850,1350,1500,750,1050,1375,1000,2950,3100,1380,975,1025,1650,1380,1390,370,380,2900,435,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,300.418,301.966,302.135,305.264],'cm^-1')),
        HinderedRotor(inertia=(0.00181715,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.219204,'amu*angstrom^2'), symmetry=1, barrier=(14.3875,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.217405,'amu*angstrom^2'), symmetry=1, barrier=(14.3947,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.219685,'amu*angstrom^2'), symmetry=1, barrier=(14.3974,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (111.162,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.049018,0.0801581,-5.98066e-05,2.31511e-08,-3.66895e-12,16310.5,31.7798], Tmin=(100,'K'), Tmax=(1468.76,'K')), NASAPolynomial(coeffs=[16.2878,0.0359336,-1.46414e-05,2.65073e-09,-1.79552e-13,11540.4,-52.8056], Tmin=(1468.76,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(134.387,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(440.667,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(CC(C)OJ)"""),
)
...
species(
    ...
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0179456,0.0870109,-7.26324e-05,3.32265e-08,-6.36505e-12,6824.69,32.7294], Tmin=(100,'K'), Tmax=(1217.77,'K')), NASAPolynomial(coeffs=[13.5072,0.0427025,-1.80546e-05,3.34769e-09,-2.31086e-13,3539.36,-35.0059], Tmin=(1217.77,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(55.5487,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(C2CsJOH) + radical(Allyl_P)"""),
)

species(
    label = 'C[C]=CCC([O])CC(20885)',
    structure = SMILES('C[C]=CCC([O])CC'),
    E0 = (195.624,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
species(
    label = '[CH2]C=CCC(O)[CH]C(20886)',
    structure = SMILES('[CH2]C=CCC(O)[CH]C'),
    E0 = (78.823,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0965398,0.0784719,-4.56625e-05,5.55297e-09,2.89008e-12,9637.56,36.2155], Tmin=(100,'K'), Tmax=(1086.05,'K')), NASAPolynomial(coeffs=[16.4825,0.0366095,-1.43614e-05,2.61655e-09,-1.80977e-13,4904.15,-50.35], Tmin=(1086.05,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(78.823,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Allyl_P) + radical(CCJCO)"""),
)

species(
    label = '[CH2]C=C[CH]C(O)CC(20887)',
    structure = SMILES('[CH2]C=C[CH]C(O)CC'),
    E0 = (-4.1624,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.570483,0.0882836,-6.38933e-05,2.06786e-08,-1.82855e-12,-325.839,32.6239], Tmin=(100,'K'), Tmax=(1162.14,'K')), NASAPolynomial(coeffs=[18.8141,0.0356502,-1.41404e-05,2.56788e-09,-1.76305e-13,-5782.64,-67.9011], Tmin=(1162.14,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-4.1624,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Allyl_P) + radical(C=CCJCO)"""),
)
...
species(
    label = '[CH2]C=CCC(O)C[CH2](20889)',
    structure = SMILES('[CH2]C=CCC(O)C[CH2]'),
    E0 = (84.1673,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2995,3025,975,1000,1300,1375,400,500,1630,1680,3615,1277.5,1000,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,1380,1390,370,380,2900,435,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.253075,0.084301,-6.37452e-05,2.50681e-08,-4.01058e-12,10283.6,36.0738], Tmin=(100,'K'), Tmax=(1468.23,'K')), NASAPolynomial(coeffs=[17.6043,0.0356507,-1.40419e-05,2.49953e-09,-1.67745e-13,5039.91,-56.9357], Tmin=(1468.23,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(84.1673,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Allyl_P) + radical(RCCJ)"""),
)

species(
    label = '[CH2]C=[C]CC(O)CC(20890)',
    structure = SMILES('[CH2]C=[C]CC(O)CC'),
    E0 = (116.763,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,1685,370,1380,1390,370,380,2900,435,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3100,440,815,1455,1000,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.00681203,0.084597,-6.63248e-05,2.78134e-08,-4.83987e-12,14190.2,33.8665], Tmin=(100,'K'), Tmax=(1336.67,'K')), NASAPolynomial(coeffs=[14.778,0.0403537,-1.66761e-05,3.05131e-09,-2.0864e-13,10237.7,-41.7523], Tmin=(1336.67,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(116.763,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Allyl_P) + radical(Cds_S)"""),
)

species(
    label = 'CC=C[CH]C([O])CC(20891)',
    ...
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.336171,0.0858568,-6.28396e-05,2.34905e-08,-3.56743e-12,9148,31.3159], Tmin=(100,'K'), Tmax=(1536.45,'K')), NASAPolynomial(coeffs=[18.542,0.0367084,-1.48566e-05,2.67037e-09,-1.79682e-13,3347,-67.8681], Tmin=(1536.45,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(74.6992,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(CC(C)OJ) + radical(C=CCJCO)"""),
)

species(
    label = '[CH2][C]=CCC(O)CC(20892)',
    structure = SMILES('[CH2][C]=CCC(O)CC'),
    E0 = (116.763,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,1685,370,1380,1390,370,380,2900,435,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3100,440,815,1455,1000,200,800,1600],'cm^-1')),
...
species(
    label = 'CC=CC[C]([O])CC(20893)',
    structure = SMILES('CC=CC[C]([O])CC'),
    E0 = (134.41,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2995,3025,975,1000,1300,1375,400,500,1630,1680,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,360,370,350,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'C[CH]C([O])CC=CC(20894)',
    structure = SMILES('C[CH]C([O])CC=CC'),
    E0 = (157.685,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2995,3025,975,1000,1300,1375,400,500,1630,1680,3025,407.5,1350,352.5,1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2]CC([O])CC=CC(20895)',
    structure = SMILES('[CH2]CC([O])CC=CC'),
    E0 = (163.029,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2995,3025,975,1000,1300,1375,400,500,1630,1680,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.187775,0.07966,-5.59398e-05,2.04487e-08,-3.10456e-12,19748.1,34.0094], Tmin=(100,'K'), Tmax=(1500.71,'K')), NASAPolynomial(coeffs=[14.8823,0.0404931,-1.67913e-05,3.05759e-09,-2.07412e-13,15337.6,-42.8482], Tmin=(1500.71,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(163.029,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(RCCJ) + radical(CC(C)OJ)"""),
)
...
species(
    label = 'CCC([O])CC1[CH]C1(20896)',
    structure = SMILES('CCC([O])CC1[CH]C1'),
    E0 = (221.713,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.397912,0.0657207,-1.26013e-05,-2.46372e-08,1.24008e-11,26807.2,33.057], Tmin=(100,'K'), Tmax=(1052.39,'K')), NASAPolynomial(coeffs=[14.624,0.0398644,-1.5963e-05,2.9678e-09,-2.0864e-13,22250.5,-43.7252], Tmin=(1052.39,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(221.713,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(465.61,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(CC(C)OJ) + radical(cyclopropane)"""),
)

species(
    label = '[CH2]C1[CH]CC(CC)O1(20829)',
    structure = SMILES('[CH2]C1[CH]CC(CC)O1'),
    E0 = (115.223,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.626469,0.0571062,2.49948e-05,-7.76217e-08,3.65004e-11,13995.6,27.2256], Tmin=(100,'K'), Tmax=(910.292,'K')), NASAPolynomial(coeffs=[16.463,0.032511,-8.61801e-06,1.29377e-09,-8.51132e-14,9248.22,-57.9276], Tmin=(910.292,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(115.223,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(469.768,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Tetrahydrofuran) + radical(CJC(C)OC) + radical(CCJCO)"""),
)

species(
    label = 'CC=CCC(=O)CC(20897)',
    structure = SMILES('CC=CCC(=O)CC'),
    E0 = (-209.452,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.614507,0.0722183,-4.08436e-05,1.02064e-08,-9.80469e-13,-25067.6,28.5884], Tmin=(100,'K'), Tmax=(2413.18,'K')), NASAPolynomial(coeffs=[29.7369,0.0239481,-1.08407e-05,1.9181e-09,-1.2186e-13,-39123.7,-137.567], Tmin=(2413.18,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-209.452,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)CsHH) + group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-OdCsCs) + group(Cds-CdsCsH) + group(Cds-CdsCsH)"""),
)

species(
    label = 'C=C=CCC(O)CC(20898)',
    structure = SMILES('C=C=CCC(O)CC'),
    E0 = (-95.974,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.04211,0.0833605,-6.31922e-05,2.52545e-08,-4.15985e-12,-11393.2,32.2952], Tmin=(100,'K'), Tmax=(1411.87,'K')), NASAPolynomial(coeffs=[15.7151,0.0387178,-1.57623e-05,2.85851e-09,-1.94144e-13,-15842.6,-49.1592], Tmin=(1411.87,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-95.974,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cdd-CdsCds)"""),
)
...
species(
    label = 'CCC1CC=CCO1(20590)',
    structure = SMILES('CCC1CC=CCO1'),
    E0 = (-180.449,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.966615,0.0480726,4.3794e-05,-8.75251e-08,3.64258e-11,-21577,23.7975], Tmin=(100,'K'), Tmax=(957.335,'K')), NASAPolynomial(coeffs=[14.3605,0.038201,-1.29572e-05,2.28668e-09,-1.60971e-13,-26253.6,-51.2675], Tmin=(957.335,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-180.449,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(473.925,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(36dihydro2hpyran)"""),
)
...
species(
    label = '[CH]=CCC([O])CC(20899)',
    structure = SMILES('[CH]=CCC([O])CC'),
    E0 = (240.904,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3010,987.5,1337.5,450,1655,3120,650,792.5,1650,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,180,180,738.961],'cm^-1')),
        HinderedRotor(inertia=(0.103497,'amu*angstrom^2'), symmetry=1, barrier=(11.2608,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0291738,'amu*angstrom^2'), symmetry=1, barrier=(11.2663,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0287501,'amu*angstrom^2'), symmetry=1, barrier=(11.2818,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.490082,'amu*angstrom^2'), symmetry=1, barrier=(11.268,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (98.143,'amu'),
...
species(
    label = 'C=CC=CC([O])CC(20900)',
    structure = SMILES('C=CC=CC([O])CC'),
    E0 = (69.024,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2950,3100,1380,975,1025,1650,2995,3010,3025,975,987.5,1000,1300,1337.5,1375,400,450,500,1630,1655,1680,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,342.951,342.951,342.951,342.951],'cm^-1')),
        HinderedRotor(inertia=(0.177281,'amu*angstrom^2'), symmetry=1, barrier=(14.7963,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.177281,'amu*angstrom^2'), symmetry=1, barrier=(14.7963,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.177281,'amu*angstrom^2'), symmetry=1, barrier=(14.7963,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.177281,'amu*angstrom^2'), symmetry=1, barrier=(14.7963,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (111.162,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0659966,0.0714037,-2.23335e-05,-2.41663e-08,1.48075e-11,8456.65,32.1536], Tmin=(100,'K'), Tmax=(999.365,'K')), NASAPolynomial(coeffs=[18.5831,0.0307483,-1.15333e-05,2.1314e-09,-1.52069e-13,3084.72,-65.5284], Tmin=(999.365,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(69.024,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(440.667,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + radical(CC(C)OJ)"""),
)

species(
    label = 'C=CC[CH]C([O])CC(20853)',
...
species(
    label = 'C=CCC[C]([O])CC(20902)',
    structure = SMILES('C=CCC[C]([O])CC'),
    E0 = (146.656,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2950,3100,1380,975,1025,1650,3010,987.5,1337.5,450,1655,2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.22417,0.084238,-6.70153e-05,2.93863e-08,-5.48618e-12,17773.4,31.9546], Tmin=(100,'K'), Tmax=(1228.81,'K')), NASAPolynomial(coeffs=[12.1519,0.0454108,-1.96187e-05,3.67189e-09,-2.54567e-13,14842,-28.0472], Tmin=(1228.81,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(146.656,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CC(C)OJ) + radical(C2CsJOH)"""),
)

species(
    label = '[CH]=CCCC([O])CC(20903)',
    structure = SMILES('[CH]=CCCC([O])CC'),
    E0 = (217.124,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.17,'amu'),
...
species(
    label = '[CH2]CC([O])CCC=C(20905)',
    structure = SMILES('[CH2]CC([O])CCC=C'),
    E0 = (175.274,'kJ/mol'),
    modes = [
...
species(
    ...
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.18414,0.0847626,-5.72304e-05,2.00746e-08,-2.91975e-12,11955.7,34.8655], Tmin=(100,'K'), Tmax=(1565.55,'K')), NASAPolynomial(coeffs=[16.1259,0.0430904,-1.73033e-05,3.07239e-09,-2.04711e-13,6848.81,-51.1322], Tmin=(1565.55,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(98.1062,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(AllylJ2_triplet)"""),
)

species(
    label = 'CCC1C[CH][CH]CO1(20868)',
    structure = SMILES('CCC1C[CH][CH]CO1'),
    E0 = (89.9944,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.30544,0.0444713,4.37451e-05,-8.22171e-08,3.41933e-11,10934.4,27.6892], Tmin=(100,'K'), Tmax=(930.223,'K')), NASAPolynomial(coeffs=[10.4364,0.0426713,-1.37628e-05,2.29185e-09,-1.54243e-13,7614.74,-24.4143], Tmin=(930.223,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(89.9944,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(473.925,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Oxane) + radical(RCCJCC) + radical(CCJCO)"""),
)

species(
    label = 'C=CCCC(=O)CC(20907)',
    ...
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.690148,0.0793386,-6.44874e-05,3.32507e-08,-8.05827e-12,-24348.4,29.1807], Tmin=(100,'K'), Tmax=(919.344,'K')), NASAPolynomial(coeffs=[6.20086,0.0553622,-2.5368e-05,4.88347e-09,-3.44371e-13,-25361.7,3.05806], Tmin=(919.344,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-203.389,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsCs) + group(Cds-CdsCsH) + group(Cds-CdsHH)"""),
)

species(
    label = 'C=CC=CC(O)CC(20908)',
    structure = SMILES('C=CC=CC(O)CC'),
    E0 = (-161.337,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.098513,0.0754189,-2.83199e-05,-1.9021e-08,1.3153e-11,-19243.8,32.9358], Tmin=(100,'K'), Tmax=(1000.67,'K')), NASAPolynomial(coeffs=[18.6578,0.0325242,-1.2109e-05,2.21644e-09,-1.56847e-13,-24603.7,-65.5902], Tmin=(1000.67,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-161.337,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH)"""),
)
...
species(
    ...
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.786591,0.0504231,4.63189e-05,-1.00005e-07,4.41728e-11,-10603.5,27.9846], Tmin=(100,'K'), Tmax=(920.566,'K')), NASAPolynomial(coeffs=[17.1156,0.031739,-8.40322e-06,1.30105e-09,-8.88946e-14,-15824.6,-61.4708], Tmin=(920.566,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-89.2803,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(469.768,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Oxetane)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['C=C[CH]CC([O])CC(20586)'],
    products = ['C2H5CHO(70)', 'butadiene13(2459)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['C=C[CH]CC([O])CC(20586)'],
    products = ['[CH2][CH]C1CC(CC)O1(20882)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', '[CH2]C=CCC(=O)CC(20175)'],
    products = ['C=C[CH]CC([O])CC(20586)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', 'C=C=CCC([O])CC(20883)'],
    products = ['C=C[CH]CC([O])CC(20586)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['C2H5(29)', 'C=C[CH]CC=O(18209)'],
    products = ['C=C[CH]CC([O])CC(20586)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['C2H5CHO(70)', '[CH2][CH]C=C(2458)'],
    products = ['C=C[CH]CC([O])CC(20586)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(0.000108643,'m^3/(mol*s)'), n=3.00879, Ea=(38.8981,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [CO_O;CsJ-OneDeHH] for rate rule [CO-CsH_O;CsJ-CdHH]
Euclidian distance = 2.2360679775
Multiplied by reaction path degeneracy 2.0
family: R_Addition_MultipleBond
Ea raised from 34.2 to 38.9 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction7',
    reactants = ['C=C[CH]CC([O])CC(20586)'],
    products = ['[CH2]C=CC[C](O)CC(20884)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]C=CCC(O)[CH]C(20886)'],
    products = ['C=C[CH]CC([O])CC(20586)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['C=C[CH]CC([O])CC(20586)'],
    products = ['[CH2]C=C[CH]C(O)CC(20887)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]C=CCC(O)C[CH2](20889)'],
    products = ['C=C[CH]CC([O])CC(20586)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2]C=[C]CC(O)CC(20890)'],
    products = ['C=C[CH]CC([O])CC(20586)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2][C]=CCC(O)CC(20892)'],
    products = ['C=C[CH]CC([O])CC(20586)'],
...
reaction(
    label = 'reaction17',
    reactants = ['C[CH]C([O])CC=CC(20894)'],
    products = ['C=C[CH]CC([O])CC(20586)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2]CC([O])CC=CC(20895)'],
    products = ['C=C[CH]CC([O])CC(20586)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CC[CH][O](563)', '[CH2][CH]C=C(2458)'],
    products = ['C=C[CH]CC([O])CC(20586)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2]C([O])CC(1666)', '[CH]=C[CH2](2461)'],
    products = ['C=C[CH]CC([O])CC(20586)'],
...
reaction(
    label = 'reaction21',
    reactants = ['C=C[CH]CC([O])CC(20586)'],
    products = ['CCC([O])CC1[CH]C1(20896)'],
...
reaction(
    label = 'reaction22',
    reactants = ['C=C[CH]CC([O])CC(20586)'],
    products = ['[CH2]C1[CH]CC(CC)O1(20829)'],
...
reaction(
    label = 'reaction25',
    reactants = ['CH2(S)(23)', 'C=C[CH]CC(C)[O](18949)'],
    products = ['C=C[CH]CC([O])CC(20586)'],
...
reaction(
    label = 'reaction27',
    reactants = ['O(4)', '[CH2]C=CC[CH]CC(19153)'],
    products = ['C=C[CH]CC([O])CC(20586)'],
...
reaction(
    label = 'reaction28',
    reactants = ['CH2(19)', '[CH]=CCC([O])CC(20899)'],
    products = ['C=C[CH]CC([O])CC(20586)'],
...
reaction(
    label = 'reaction29',
    reactants = ['H(3)', 'C=CC=CC([O])CC(20900)'],
    products = ['C=C[CH]CC([O])CC(20586)'],
...
reaction(
    label = 'reaction30',
    reactants = ['CC[CH][O](563)', 'butadiene13(2459)'],
    products = ['C=C[CH]CC([O])CC(20586)'],
...
reaction(
    label = 'reaction31',
    reactants = ['C=CC[CH]C([O])CC(20853)'],
    products = ['C=C[CH]CC([O])CC(20586)'],
...
reaction(
    label = 'reaction36',
    reactants = ['[CH2]CC([O])CCC=C(20905)'],
    products = ['C=C[CH]CC([O])CC(20586)'],
...
reaction(
    label = 'reaction37',
    reactants = ['C=C[CH]CC([O])CC(20586)'],
    products = ['[CH]=C[CH]CC(O)CC(20906)'],
...
reaction(
    label = 'reaction38',
    reactants = ['C=C[CH]CC([O])CC(20586)'],
    products = ['CCC1C[CH][CH]CO1(20868)'],
...
reaction(
    label = 'reaction28',
    reactants = ['[CH2]C(C=C)C([O])CC(20587)'],
    products = ['C=C[CH]CC([O])CC(20586)'],
...
network(
    label = '3691',
    isomers = [
        'C=C[CH]CC([O])CC(20586)',
    ],
    reactants = [
        ('C2H5CHO(70)', 'butadiene13(2459)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
