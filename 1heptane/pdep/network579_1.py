...
species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.17441,'amu*angstrom^2'), symmetry=1, barrier=(27.0019,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.17361,'amu*angstrom^2'), symmetry=1, barrier=(26.9836,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.17248,'amu*angstrom^2'), symmetry=1, barrier=(26.9576,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (69.0819,'amu'),
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'C=[C]OC=C(2409)'],
    products = ['[CH2]CO[C]=C(1019)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction13',
    reactants = ['CH2(19)', '[CH2]O[C]=C(2374)'],
    products = ['[CH2]CO[C]=C(1019)'],
