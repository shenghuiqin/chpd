...
species(
    label = 'C=C(CC)O[CH]CC(C)OO(8080)',
    structure = SMILES('C=C(CC)O[CH]CC(C)OO'),
    E0 = (-204.543,'kJ/mol'),
    modes = [
...
species(
    label = '[CH2]C(CC)OC=CC(C)OO(8081)',
    structure = SMILES('[CH2]C(CC)OC=CC(C)OO'),
    E0 = (-195.173,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (159.203,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-3.36791,0.143686,-0.000137983,6.63428e-08,-1.24728e-11,-23193.2,47.7829], Tmin=(100,'K'), Tmax=(1299.83,'K')), NASAPolynomial(coeffs=[31.7949,0.0354787,-1.31123e-05,2.29832e-09,-1.54941e-13,-32334.3,-131.078], Tmin=(1299.83,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-195.173,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(594.485,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(CJC(C)OC)"""),
)
...
species(
    label = 'CC[C](C)O[CH]CC(C)OO(8082)',
    structure = SMILES('CC[C](C)O[CH]CC(C)OO'),
    E0 = (-118.85,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (160.211,'amu'),
...
species(
    label = '[CH2]C(CC)OC[CH]C(C)OO(8083)',
    structure = SMILES('[CH2]C(CC)OC[CH]C(C)OO'),
    E0 = (-69.0852,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3615,1310,387.5,850,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3100,440,815,1455,1000,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2][C](CC)OCCC(C)OO(8084)',
    structure = SMILES('[CH2][C](CC)OCCC(C)OO'),
    E0 = (-88.7963,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (160.211,'amu'),
...
species(
    label = 'C[CH]C(C)O[CH]CC(C)OO(8085)',
    structure = SMILES('C[CH]C(C)O[CH]CC(C)OO'),
    E0 = (-99.6522,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (160.211,'amu'),
...
species(
    label = '[CH2]C(CC)OCC[C](C)OO(8086)',
    structure = SMILES('[CH2]C(CC)OCC[C](C)OO'),
    E0 = (-82.601,'kJ/mol'),
    modes = [
...
species(
    label = '[CH2]C(CCOC([CH2])CC)OO(8087)',
    structure = SMILES('[CH2]C(CCOC([CH2])CC)OO'),
    E0 = (-55.5376,'kJ/mol'),
    modes = [
...
species(
    label = '[CH2]C([CH]C)OCCC(C)OO(8088)',
    structure = SMILES('[CH2]C([CH]C)OCCC(C)OO'),
    E0 = (-69.5981,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3615,1310,387.5,850,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3100,440,815,1455,1000,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2]CC(C)O[CH]CC(C)OO(8089)',
    structure = SMILES('[CH2]CC(C)O[CH]CC(C)OO'),
    E0 = (-94.3079,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (160.211,'amu'),
...
species(
    label = 'CCC(C)O[CH][CH]C(C)OO(8090)',
    structure = SMILES('CCC(C)O[CH][CH]C(C)OO'),
    E0 = (-99.1393,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (160.211,'amu'),
...
species(
    label = '[CH2]C(CC)OCCC(C)O[O](8091)',
    structure = SMILES('[CH2]C(CC)OCCC(C)O[O]'),
    E0 = (-117.495,'kJ/mol'),
    modes = [
...
species(
    label = '[CH2]CC([CH2])OCCC(C)OO(8092)',
    structure = SMILES('[CH2]CC([CH2])OCCC(C)OO'),
    E0 = (-64.2538,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1310,387.5,850,1000,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'CCC(C)O[CH]C[C](C)OO(8093)',
    structure = SMILES('CCC(C)O[CH]C[C](C)OO'),
    E0 = (-112.655,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (160.211,'amu'),
...
species(
    label = '[CH2]C(C[CH]OC(C)CC)OO(8094)',
    structure = SMILES('[CH2]C(C[CH]OC(C)CC)OO'),
    E0 = (-85.5917,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (160.211,'amu'),
...
species(
    label = 'CCC(C)O[CH]CC(C)O[O](8095)',
    structure = SMILES('CCC(C)O[CH]CC(C)O[O]'),
    E0 = (-147.55,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (160.211,'amu'),
...
species(
    label = 'C=C(CC)OCCC(C)OO(8096)',
    structure = SMILES('C=C(CC)OCCC(C)OO'),
    E0 = (-398.47,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (160.211,'amu'),
...
species(
    label = 'CCC(C)OC=CC(C)OO(8097)',
    structure = SMILES('CCC(C)OC=CC(C)OO'),
    E0 = (-405.683,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (160.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.7289,0.127687,-8.3953e-05,9.1767e-09,7.64103e-12,-48532.4,45.7282], Tmin=(100,'K'), Tmax=(1019.56,'K')), NASAPolynomial(coeffs=[29.3254,0.0416886,-1.59234e-05,2.94167e-09,-2.08694e-13,-57135.1,-119.67], Tmin=(1019.56,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-405.683,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(619.428,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH)"""),
)
...
species(
    label = '[CH2]C(CC)O[CH]CCOO(8098)',
    structure = SMILES('[CH2]C(CC)O[CH]CCOO'),
    E0 = (-52.621,'kJ/mol'),
    modes = [
...
species(
    label = '[CH2]C(CC)OC([CH2])C(C)OO(8101)',
    structure = SMILES('[CH2]C(CC)OC([CH2])C(C)OO'),
    E0 = (-69.541,'kJ/mol'),
    modes = [
...
species(
    label = '[CH2]C(CC)OC(O)CC(C)[O](8102)',
    structure = SMILES('[CH2]C(CC)OC(O)CC(C)[O]'),
    E0 = (-310.875,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (160.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.0905,0.141181,-0.000151109,9.14794e-08,-2.30803e-11,-37176.4,46.5829], Tmin=(100,'K'), Tmax=(946.551,'K')), NASAPolynomial(coeffs=[16.122,0.0642166,-2.91424e-05,5.5764e-09,-3.91722e-13,-40624.2,-40.2811], Tmin=(946.551,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-310.875,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(619.428,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJC(C)OC) + radical(CC(C)OJ)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(CC)O[CH]CC(C)OO(8051)'],
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'C=C(CC)O[CH]CC(C)OO(8080)'],
    products = ['[CH2]C(CC)O[CH]CC(C)OO(8051)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', '[CH2]C(CC)OC=CC(C)OO(8081)'],
    products = ['[CH2]C(CC)O[CH]CC(C)OO(8051)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['C2H5(29)', 'C=CO[CH]CC(C)OO(7647)'],
    products = ['[CH2]C(CC)O[CH]CC(C)OO(8051)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['CH3CHOOH(63)', '[CH2]C(CC)OC=C(2017)'],
    products = ['[CH2]C(CC)O[CH]CC(C)OO(8051)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2]C(CC)O[CH]CC(C)OO(8051)'],
    products = ['CC[C](C)O[CH]CC(C)OO(8082)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]C(CC)OC[CH]C(C)OO(8083)'],
    products = ['[CH2]C(CC)O[CH]CC(C)OO(8051)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]C(CC)O[CH]CC(C)OO(8051)'],
    products = ['[CH2][C](CC)OCCC(C)OO(8084)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]C(CC)O[CH]CC(C)OO(8051)'],
    products = ['C[CH]C(C)O[CH]CC(C)OO(8085)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]C(CC)OCC[C](C)OO(8086)'],
    products = ['[CH2]C(CC)O[CH]CC(C)OO(8051)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]C(CCOC([CH2])CC)OO(8087)'],
    products = ['[CH2]C(CC)O[CH]CC(C)OO(8051)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2]C([CH]C)OCCC(C)OO(8088)'],
    products = ['[CH2]C(CC)O[CH]CC(C)OO(8051)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]C(CC)O[CH]CC(C)OO(8051)'],
    products = ['[CH2]CC(C)O[CH]CC(C)OO(8089)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]C(CC)O[CH]CC(C)OO(8051)'],
    products = ['CCC(C)O[CH][CH]C(C)OO(8090)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]C(CC)OCCC(C)O[O](8091)'],
    products = ['[CH2]C(CC)O[CH]CC(C)OO(8051)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]CC([CH2])OCCC(C)OO(8092)'],
    products = ['[CH2]C(CC)O[CH]CC(C)OO(8051)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2]C(CC)O[CH]CC(C)OO(8051)'],
    products = ['CCC(C)O[CH]C[C](C)OO(8093)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2]C(CC)O[CH]CC(C)OO(8051)'],
    products = ['[CH2]C(C[CH]OC(C)CC)OO(8094)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2]C(CC)O[CH]CC(C)OO(8051)'],
    products = ['CCC(C)O[CH]CC(C)O[O](8095)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH2]C(CC)O[CH]CC(C)OO(8051)'],
    products = ['C=C(CC)OCCC(C)OO(8096)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH2]C(CC)O[CH]CC(C)OO(8051)'],
    products = ['CCC(C)OC=CC(C)OO(8097)'],
...
reaction(
    label = 'reaction24',
    reactants = ['CH2(S)(23)', '[CH2]C(CC)O[CH]CCOO(8098)'],
    products = ['[CH2]C(CC)O[CH]CC(C)OO(8051)'],
...
reaction(
    label = 'reaction25',
    reactants = ['CH2(S)(23)', '[CH2]C(C)O[CH]CC(C)OO(7404)'],
    products = ['[CH2]C(CC)O[CH]CC(C)OO(8051)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[CH2]C(CC)O[CH]CC(C)OO(8051)'],
    products = ['OH(5)', '[CH2]C(CC)OC1CC(C)O1(8099)'],
...
reaction(
    label = 'reaction28',
    reactants = ['[CH2]C(CC)OC([CH2])C(C)OO(8101)'],
    products = ['[CH2]C(CC)O[CH]CC(C)OO(8051)'],
...
reaction(
    label = 'reaction30',
    reactants = ['[CH2]C(CC)O[CH]CC(C)OO(8051)'],
    products = ['[CH2]C(CC)OC(O)CC(C)[O](8102)'],
...
reaction(
    label = 'reaction31',
    reactants = ['[CH]CC(C)OO(1806)', '[CH2]C([O])CC(1666)'],
    products = ['[CH2]C(CC)O[CH]CC(C)OO(8051)'],
