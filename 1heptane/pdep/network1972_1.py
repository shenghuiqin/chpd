...
species(
    ...
    molecularWeight = (86.1323,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.13061,0.0664475,-6.19328e-05,3.49597e-08,-8.57555e-12,5070.09,25.7283], Tmin=(100,'K'), Tmax=(953.571,'K')), NASAPolynomial(coeffs=[8.04534,0.0374421,-1.63067e-05,3.06147e-09,-2.12776e-13,3751.34,-7.30261], Tmin=(953.571,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(41.3195,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(C2CsJOH) + radical(RCCJ)"""),
)
...
species(
    label = '[CH2]CC(O)[CH]C(10593)',
    structure = SMILES('[CH2]CC(O)[CH]C'),
    E0 = (64.5937,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1277.5,1000,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,1046.35,4000],'cm^-1')),
        HinderedRotor(inertia=(0.245693,'amu*angstrom^2'), symmetry=1, barrier=(6.06068,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00780133,'amu*angstrom^2'), symmetry=1, barrier=(6.061,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00485031,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.899082,'amu*angstrom^2'), symmetry=1, barrier=(22.1669,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.898347,'amu*angstrom^2'), symmetry=1, barrier=(22.1669,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.1323,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.97729,0.0584601,-3.71981e-05,1.03621e-08,-6.16018e-13,7884.3,29.346], Tmin=(100,'K'), Tmax=(1202.65,'K')), NASAPolynomial(coeffs=[12.5138,0.0288456,-1.11819e-05,1.99399e-09,-1.3487e-13,4476.24,-31.0721], Tmin=(1202.65,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(64.5937,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJCO) + radical(RCCJ)"""),
)

species(
    label = '[CH2][CH]C(O)CC(10594)',
    structure = SMILES('[CH2][CH]C(O)CC'),
    E0 = (64.5937,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (86.1323,'amu'),
...
species(
    label = 'CC[C]([O])CC(10595)',
    structure = SMILES('CC[C]([O])CC'),
    E0 = (66.4339,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (86.1323,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.25615,0.0618805,-4.67644e-05,1.98708e-08,-3.66542e-12,8087.51,22.5941], Tmin=(100,'K'), Tmax=(1224.01,'K')), NASAPolynomial(coeffs=[9.03265,0.0364674,-1.56213e-05,2.90855e-09,-2.00947e-13,6183.79,-16.4949], Tmin=(1224.01,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(66.4339,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(C2CsJOH)"""),
)

species(
    label = '[CH2]CC(O)C[CH2](10596)',
    structure = SMILES('[CH2]CC(O)C[CH2]'),
    E0 = (69.938,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3615,1277.5,1000,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,1380,1390,370,380,2900,435,1675.46,4000],'cm^-1')),
        HinderedRotor(inertia=(0.0610702,'amu*angstrom^2'), symmetry=1, barrier=(6.49425,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.244217,'amu*angstrom^2'), symmetry=1, barrier=(25.9964,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0610157,'amu*angstrom^2'), symmetry=1, barrier=(6.49514,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0609834,'amu*angstrom^2'), symmetry=1, barrier=(6.49471,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.243709,'amu*angstrom^2'), symmetry=1, barrier=(25.9951,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.1323,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.11959,0.0609909,-4.4792e-05,1.77379e-08,-2.94802e-12,8517.01,27.4238], Tmin=(100,'K'), Tmax=(1379.68,'K')), NASAPolynomial(coeffs=[11.2229,0.0316991,-1.29459e-05,2.34985e-09,-1.59683e-13,5729.12,-24.5708], Tmin=(1379.68,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(69.938,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJ) + radical(RCCJ)"""),
)

species(
    label = 'CCC(=O)CC(10597)',
    ...
    molecularWeight = (86.1323,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.44538,0.0435085,3.97538e-05,-1.8534e-07,1.7285e-10,-34064.5,17.4765], Tmin=(100,'K'), Tmax=(401.709,'K')), NASAPolynomial(coeffs=[3.69798,0.0453769,-2.07731e-05,3.97964e-09,-2.79146e-13,-34280.8,11.1356], Tmin=(401.709,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-283.611,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)CsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdCsCs)"""),
)

species(
    label = 'C=CC(O)CC(10598)',
    structure = SMILES('C=CC(O)CC'),
    E0 = (-213.109,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (86.1323,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.20045,0.0508794,-1.01894e-05,-2.03952e-08,1.06564e-11,-25521,25.6393], Tmin=(100,'K'), Tmax=(1025.75,'K')), NASAPolynomial(coeffs=[12.8538,0.0284537,-1.10544e-05,2.04295e-09,-1.44002e-13,-29122.6,-36.78], Tmin=(1025.75,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-213.109,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]CC([O])CC(10552)'],
    products = ['C2H5CHO(70)', 'C2H4(21)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', '[CH2]CC(=O)CC(6517)'],
    products = ['[CH2]CC([O])CC(10552)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['C2H5CHO(70)', 'C2H4(T)(94)'],
    products = ['[CH2]CC([O])CC(10552)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]CC(O)C[CH2](10596)'],
    products = ['[CH2]CC([O])CC(10552)'],
...
reaction(
    label = 'reaction13',
    reactants = ['C2H4(T)(94)', 'CC[CH][O](563)'],
    products = ['[CH2]CC([O])CC(10552)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CH2(S)(23)', '[CH2]CC(C)[O](1023)'],
    products = ['[CH2]CC([O])CC(10552)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CH2(19)', '[CH2]C([O])CC(1666)'],
    products = ['[CH2]CC([O])CC(10552)'],
