species(
    label = '[CH]=CC([O])CCCC(17399)',
    structure = SMILES('[CH]=CC([O])CCCC'),
    E0 = (216.788,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3010,987.5,1337.5,450,1655,3120,650,792.5,1650,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1200,1600],'cm^-1')),
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.379408,0.0841089,-6.16864e-05,2.30073e-08,-3.45686e-12,26241.3,36.0313], Tmin=(100,'K'), Tmax=(1566.83,'K')), NASAPolynomial(coeffs=[19.5308,0.0332803,-1.30265e-05,2.30339e-09,-1.53435e-13,20002.1,-68.9649], Tmin=(1566.83,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(216.788,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CC(C)OJ) + radical(Cds_P)"""),
)
...
species(
    label = '[CH]=CC(O)[CH]CCC(17479)',
    structure = SMILES('[CH]=CC(O)[CH]CCC'),
    E0 = (186.329,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,3615,1277.5,1000,3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,1380,1390,370,380,2900,435,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.243177,0.0818782,-5.64588e-05,1.67315e-08,-1.02968e-12,22572.5,38.216], Tmin=(100,'K'), Tmax=(1161.79,'K')), NASAPolynomial(coeffs=[17.3693,0.0350547,-1.38417e-05,2.51218e-09,-1.72427e-13,17547.8,-53.4077], Tmin=(1161.79,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(186.329,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CCJCO) + radical(Cds_P)"""),
)

species(
    label = '[CH]=[C]C(O)CCCC(17480)',
    structure = SMILES('[CH]=[C]C(O)CCCC'),
    E0 = (224.269,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1277.5,1000,1685,370,1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0200843,0.0860327,-7.06305e-05,3.12174e-08,-5.74015e-12,27117.6,35.2399], Tmin=(100,'K'), Tmax=(1268.18,'K')), NASAPolynomial(coeffs=[14.2897,0.0410244,-1.73945e-05,3.23174e-09,-2.23241e-13,23498.4,-36.9928], Tmin=(1268.18,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(224.269,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_S) + radical(Cds_P)"""),
)

species(
    label = 'C=C[C]([O])CCCC(17481)',
    ...
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.187293,0.0807784,-4.97322e-05,8.2016e-09,2.41033e-12,-2889.98,33.2432], Tmin=(100,'K'), Tmax=(1065.55,'K')), NASAPolynomial(coeffs=[16.6867,0.0363953,-1.39449e-05,2.51113e-09,-1.72778e-13,-7562.4,-54.2864], Tmin=(1065.55,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-25.3625,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + radical(Allyl_P) + radical(C=C(C)OJ)"""),
)

species(
    label = '[CH]=CC(O)C[CH]CC(17482)',
    structure = SMILES('[CH]=CC(O)C[CH]CC'),
    E0 = (180.885,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,3615,1277.5,1000,3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,1380,1390,370,380,2900,435,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.525028,0.0793103,-6.05968e-05,2.60383e-08,-4.87433e-12,21878,35.5199], Tmin=(100,'K'), Tmax=(1203.67,'K')), NASAPolynomial(coeffs=[10.1939,0.047179,-2.05553e-05,3.86087e-09,-2.68131e-13,19550.4,-12.9193], Tmin=(1203.67,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(180.885,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_P) + radical(RCCJCC)"""),
)

species(
    label = 'C=CC([O])[CH]CCC(17483)',
...
species(
    label = '[CH]=CC(O)CC[CH]C(17484)',
    structure = SMILES('[CH]=CC(O)CC[CH]C'),
    E0 = (180.873,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.346762,0.0805434,-6.15647e-05,2.58649e-08,-4.62758e-12,21885.1,36.3278], Tmin=(100,'K'), Tmax=(1276.04,'K')), NASAPolynomial(coeffs=[11.9836,0.0440655,-1.86845e-05,3.46212e-09,-2.3847e-13,18915.3,-22.6497], Tmin=(1276.04,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(180.873,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_P) + radical(RCCJC)"""),
)

species(
    label = 'C=CC([O])C[CH]CC(17485)',
...
species(
    ...
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.186575,0.0853483,-6.70024e-05,2.74574e-08,-4.59215e-12,23209.1,37.2991], Tmin=(100,'K'), Tmax=(1404.02,'K')), NASAPolynomial(coeffs=[16.9437,0.0365443,-1.48616e-05,2.69938e-09,-1.83683e-13,18398.8,-51.1575], Tmin=(1404.02,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(191.673,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_P) + radical(RCCJ)"""),
)

species(
    label = 'C=CC([O])CC[CH]C(17487)',
    structure = SMILES('C=CC([O])CC[CH]C'),
    E0 = (164.138,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.280389,0.0764643,-5.02981e-05,1.69584e-08,-2.36436e-12,19879,35.978], Tmin=(100,'K'), Tmax=(1620.16,'K')), NASAPolynomial(coeffs=[15.2367,0.0395385,-1.61106e-05,2.89075e-09,-1.93619e-13,15032.7,-43.3943], Tmin=(1620.16,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(164.138,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CC(C)OJ) + radical(RCCJC)"""),
)

species(
    label = '[CH2]CCCC([O])C=C(17488)',
    structure = SMILES('[CH2]CCCC([O])C=C'),
    E0 = (174.938,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.204744,0.0806632,-5.36058e-05,1.59981e-08,-1.38489e-12,21201.3,36.7813], Tmin=(100,'K'), Tmax=(1259.9,'K')), NASAPolynomial(coeffs=[17.3685,0.0364125,-1.46634e-05,2.66307e-09,-1.81645e-13,15857.2,-55.6945], Tmin=(1259.9,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(174.938,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(RCCJ) + radical(CC(C)OJ)"""),
)

species(
    label = 'C=CC(=O)CCCC(17489)',
    structure = SMILES('C=CC(=O)CCCC'),
    E0 = (-199.471,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.938435,0.0752946,-5.49536e-05,2.54423e-08,-5.94458e-12,-23887.3,28.2487], Tmin=(100,'K'), Tmax=(897.748,'K')), NASAPolynomial(coeffs=[4.54506,0.0592247,-2.81031e-05,5.50294e-09,-3.91936e-13,-24534.9,11.2379], Tmin=(897.748,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-199.471,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-O2d(Cds-Cds)Cs) + group(Cd-Cd(CO)H) + group(Cds-CdsHH)"""),
)
...
species(
    label = '[CH]=CC([O])CCC(17490)',
    structure = SMILES('[CH]=CC([O])CCC'),
    E0 = (240.568,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3010,987.5,1337.5,450,1655,3120,650,792.5,1650,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,391.009,391.011,391.013],'cm^-1')),
        HinderedRotor(inertia=(0.00110262,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.110613,'amu*angstrom^2'), symmetry=1, barrier=(12.0009,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.110614,'amu*angstrom^2'), symmetry=1, barrier=(12.0009,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.110613,'amu*angstrom^2'), symmetry=1, barrier=(12.0009,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', '[CH]=CC(=O)CCCC(17476)'],
    products = ['[CH]=CC([O])CCCC(17399)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'C#CC([O])CCCC(17477)'],
    products = ['[CH]=CC([O])CCCC(17399)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['butyl_1(82)', 'CHCHCHO(723)'],
    products = ['[CH]=CC([O])CCCC(17399)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['C2H2(32)', 'CCCC[CH][O](1728)'],
    products = ['[CH]=CC([O])CCCC(17399)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH]=CC(O)[CH]CCC(17479)'],
    products = ['[CH]=CC([O])CCCC(17399)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction12',
    reactants = ['[CH]=CC(O)C[CH]CC(17482)'],
    products = ['[CH]=CC([O])CCCC(17399)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH]=CC([O])CCCC(17399)'],
    products = ['[CH]=CC(O)CC[CH]C(17484)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH]=CC([O])CCCC(17399)'],
    products = ['[CH]=CC(O)CCC[CH2](17486)'],
...
reaction(
    label = 'reaction21',
    reactants = ['CH2(S)(23)', '[CH]=CC([O])CCC(17490)'],
    products = ['[CH]=CC([O])CCCC(17399)'],
...
reaction(
    label = 'reaction23',
    reactants = ['O(4)', '[CH]=C[CH]CCCC(3303)'],
    products = ['[CH]=CC([O])CCCC(17399)'],
