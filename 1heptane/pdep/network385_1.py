species(
    ...
    E0 = (-199.811,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1855,455,950,3615,1277.5,1000,3000,3100,440,815,1455,1000,1380,1390,370,380,2900,435,288.798,288.853],'cm^-1')),
        HinderedRotor(inertia=(0.00202424,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.302383,'amu*angstrom^2'), symmetry=1, barrier=(17.9155,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.086003,'amu*angstrom^2'), symmetry=1, barrier=(119.627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.534391,'amu*angstrom^2'), symmetry=1, barrier=(31.4595,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'C=C(O)O[C]=O(5061)'],
...
reaction(
    ...
    products = ['[CH2]C(O)O[C]=O(841)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(23.3993,'m^3/(mol*s)'), n=2.021, Ea=(59.836,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Od_R;YJ] for rate rule [Od_Cdd-O2d;CJ]
