...
species(
    label = '[CH2]C(O)C=CCC(3449)',
    structure = SMILES('[CH2]C(O)C=CCC'),
    E0 = (-36.4105,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,379.036,379.037],'cm^-1')),
        HinderedRotor(inertia=(0.00117339,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.10696,'amu*angstrom^2'), symmetry=1, barrier=(10.9046,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.106959,'amu*angstrom^2'), symmetry=1, barrier=(10.9046,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.10696,'amu*angstrom^2'), symmetry=1, barrier=(10.9046,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.10696,'amu*angstrom^2'), symmetry=1, barrier=(10.9046,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
...
species(
    label = '[CH2]C(O)CC=CC(3450)',
    structure = SMILES('[CH2]C(O)CC=CC'),
    E0 = (-37.2089,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,327.778,327.784],'cm^-1')),
        HinderedRotor(inertia=(0.00156905,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.131554,'amu*angstrom^2'), symmetry=1, barrier=(10.0304,'kJ/mol'), semiclassical=False),
...
species(
    ...
    molecularWeight = (100.159,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.279602,0.0858453,-8.55753e-05,5.05494e-08,-1.27082e-11,3002.9,29.877], Tmin=(100,'K'), Tmax=(941.944,'K')), NASAPolynomial(coeffs=[10.0854,0.0442037,-1.92618e-05,3.61473e-09,-2.51096e-13,1155.63,-16.8437], Tmin=(941.944,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(23.882,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(C2CsJOH) + radical(CJCO)"""),
)

species(
    label = '[CH2]CCCC([CH2])O(3453)',
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'C=C(O)C[CH]CC(3448)'],
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', '[CH2]C(O)C=CCC(3449)'],
    products = ['[CH2]C(O)C[CH]CC(1271)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', '[CH2]C(O)CC=CC(3450)'],
    products = ['[CH2]C(O)C[CH]CC(1271)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(1.46e+08,'cm^3/(mol*s)'), n=1.64, Ea=(5.73208,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""From training reaction 2555 used for Cds-CsH_Cds-CsH;HJ
Exact match found for rate rule [Cds-CsH_Cds-CsH;HJ]
...
reaction(
    label = 'reaction7',
    reactants = ['CH3(17)', '[CH2]C(O)CC=C(2981)'],
    products = ['[CH2]C(O)C[CH]CC(1271)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction23',
    reactants = ['CH2(S)(23)', '[CH2]C(O)C[CH]C(1305)'],
    products = ['[CH2]C(O)C[CH]CC(1271)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[CH2]C(C)CC([CH2])O(3455)'],
    products = ['[CH2]C(O)C[CH]CC(1271)'],
...
reaction(
    label = 'reaction29',
    reactants = ['[CH]CC(144)', '[CH2]C([CH2])O(2453)'],
    products = ['[CH2]C(O)C[CH]CC(1271)'],
