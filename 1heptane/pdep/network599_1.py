...
species(
    ...
    E0 = (20.2278,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3615,1277.5,1000,3000,3100,440,815,1455,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,180],'cm^-1')),
        HinderedRotor(inertia=(0.535851,'amu*angstrom^2'), symmetry=1, barrier=(12.3203,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.53631,'amu*angstrom^2'), symmetry=1, barrier=(12.3308,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.53679,'amu*angstrom^2'), symmetry=1, barrier=(12.3419,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (71.0978,'amu'),
...
species(
    label = '[CH2]C[CH]CO(2464)',
    structure = SMILES('[CH2]C[CH]CO'),
    E0 = (108.232,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3615,1277.5,1000,3000,3100,440,815,1455,1000,3025,407.5,1350,352.5,1831.05,4000],'cm^-1')),
        HinderedRotor(inertia=(0.0103793,'amu*angstrom^2'), symmetry=1, barrier=(24.6934,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.256167,'amu*angstrom^2'), symmetry=1, barrier=(24.693,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0768407,'amu*angstrom^2'), symmetry=1, barrier=(7.40865,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0768639,'amu*angstrom^2'), symmetry=1, barrier=(7.40939,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (72.1057,'amu'),
...
species(
    ...
    E0 = (102.776,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3615,1277.5,1000,3000,3100,440,815,1455,1000,3025,407.5,1350,352.5,1859.27,1861.18],'cm^-1')),
        HinderedRotor(inertia=(0.147841,'amu*angstrom^2'), symmetry=1, barrier=(3.39916,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.148318,'amu*angstrom^2'), symmetry=1, barrier=(3.41013,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.148581,'amu*angstrom^2'), symmetry=1, barrier=(3.41618,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.147822,'amu*angstrom^2'), symmetry=1, barrier=(3.39871,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (72.1057,'amu'),
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2]C[CH2](128)', 'HCOH(T)(285)'],
    products = ['[CH2]CC[CH]O(1032)'],
