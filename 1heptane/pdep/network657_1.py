...
species(
    ...
    E0 = (426.236,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2175,525,750,770,3400,2100,3010,987.5,1337.5,450,1655,3120,650,792.5,1650,180],'cm^-1')),
        HinderedRotor(inertia=(1.42782,'amu*angstrom^2'), symmetry=1, barrier=(32.8284,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.42404,'amu*angstrom^2'), symmetry=1, barrier=(32.7415,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (67.066,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.53111,0.0435354,-4.5171e-05,2.21032e-08,-4.03866e-12,51362.5,17.7681], Tmin=(100,'K'), Tmax=(1523.99,'K')), NASAPolynomial(coeffs=[14.4017,0.00389666,-3.91029e-07,-7.6352e-12,2.18389e-15,48119.8,-47.5162], Tmin=(1523.99,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(426.236,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(Ct-CtOs) + group(Ct-CtH) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'C#CO[C]=C(5800)'],
    products = ['[CH]=CO[C]=C(1080)'],
    transitionState = 'TS2',
