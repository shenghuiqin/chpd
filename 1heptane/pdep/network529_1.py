species(
    label = '[CH2]OC([O])O(982)',
    structure = SMILES('[CH2]OC([O])O'),
    E0 = (-164.689,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,3000,3100,440,815,1455,1000,1380,1390,370,380,2900,435,180,1854.06,1858.07],'cm^-1')),
        HinderedRotor(inertia=(0.139984,'amu*angstrom^2'), symmetry=1, barrier=(3.21851,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.140881,'amu*angstrom^2'), symmetry=1, barrier=(3.23913,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0013064,'amu*angstrom^2'), symmetry=1, barrier=(3.19634,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (76.0514,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.5921,0.0475696,-0.00010937,1.33129e-07,-5.61997e-11,-19772.9,19.3422], Tmin=(100,'K'), Tmax=(846.68,'K')), NASAPolynomial(coeffs=[-5.54513,0.0424852,-2.32484e-05,4.59907e-09,-3.20127e-13,-16834.8,66.4587], Tmin=(846.68,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-164.689,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-OsOsOsH) + group(Cs-OsHHH) + radical(OCOJ) + radical(CsJOCH3)"""),
)
...
species(
    label = '[CH2]OC(=O)O(4527)',
    structure = SMILES('[CH2]OC(=O)O'),
    E0 = (-404.773,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,3000,3100,440,815,1455,1000,544.491,544.492,544.493,544.495,544.497,544.498],'cm^-1')),
        HinderedRotor(inertia=(0.000568609,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.150259,'amu*angstrom^2'), symmetry=1, barrier=(31.6119,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.150266,'amu*angstrom^2'), symmetry=1, barrier=(31.6128,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (75.0434,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.20391,0.0287384,1.87976e-06,-2.92938e-08,1.45283e-11,-48608.6,16.8272], Tmin=(100,'K'), Tmax=(975.644,'K')), NASAPolynomial(coeffs=[14.1868,0.00541935,-1.94882e-06,4.36287e-10,-3.74662e-14,-52175.2,-46.9833], Tmin=(975.644,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-404.773,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(170.447,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-(Cds-O2d)H) + group(Cs-OsHHH) + group(Cds-OdOsOs) + radical(CsJOC(O))"""),
)
...
species(
    ...
    molecularWeight = (76.0514,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.07594,0.0510943,-9.4958e-05,9.5104e-08,-3.57652e-11,-22410.9,20.7185], Tmin=(100,'K'), Tmax=(847.814,'K')), NASAPolynomial(coeffs=[3.32974,0.0249685,-1.29775e-05,2.52266e-09,-1.74101e-13,-21897.2,19.1603], Tmin=(847.814,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-186.841,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(191.233,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-OsOsOsH) + group(Cs-OsHHH) + radical(CsJOCH3) + radical(Cs_P)"""),
)

species(
    label = 'CO[C]([O])O(4529)',
    structure = SMILES('CO[C]([O])O'),
    E0 = (-147.314,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([360,370,350,3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,2146.44,2148.17,2151.32],'cm^-1')),
        HinderedRotor(inertia=(0.132628,'amu*angstrom^2'), symmetry=1, barrier=(3.04938,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.133288,'amu*angstrom^2'), symmetry=1, barrier=(3.06456,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.13441,'amu*angstrom^2'), symmetry=1, barrier=(3.09034,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (76.0514,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.72929,0.046893,-0.000115051,1.44498e-07,-6.16267e-11,-17690.3,18.7471], Tmin=(100,'K'), Tmax=(851.468,'K')), NASAPolynomial(coeffs=[-7.77947,0.0460896,-2.52511e-05,4.98582e-09,-3.46187e-13,-14082.1,78.4358], Tmin=(851.468,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-147.314,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-OsOsOsH) + group(Cs-OsHHH) + radical(OCOJ) + radical(Cs_P)"""),
)

species(
    label = 'COC([O])[O](4530)',
    structure = SMILES('COC([O])[O]'),
    E0 = (-125.162,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,1794.38,1794.71,1794.93,1795.37],'cm^-1')),
        HinderedRotor(inertia=(0.221876,'amu*angstrom^2'), symmetry=1, barrier=(5.10136,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00222634,'amu*angstrom^2'), symmetry=1, barrier=(5.09657,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (76.0514,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.24608,0.0433599,-0.000129428,1.82468e-07,-8.20331e-11,-15052.4,15.9823], Tmin=(100,'K'), Tmax=(849.672,'K')), NASAPolynomial(coeffs=[-16.6549,0.0636075,-3.55227e-05,7.06238e-09,-4.92227e-13,-9019.51,124.351], Tmin=(849.672,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-125.162,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-OsOsOsH) + group(Cs-OsHHH) + radical(OCOJ) + radical(OCOJ)"""),
)
...
species(
    ...
    molecularWeight = (76.0514,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.52453,0.0229973,1.35723e-05,-3.37403e-08,1.4067e-11,-72998.3,15.9175], Tmin=(100,'K'), Tmax=(1007.63,'K')), NASAPolynomial(coeffs=[10.6261,0.0133538,-5.59217e-06,1.11678e-09,-8.36452e-14,-75774.1,-28.9018], Tmin=(1007.63,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-607.453,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-(Cds-O2d)H) + group(Cs-OsHHH) + group(Cds-OdOsOs)"""),
)

species(
    label = 'OC1OCO1(985)',
    structure = SMILES('OC1OCO1'),
    E0 = (-423.151,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (76.0514,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.73325,0.00871834,6.87377e-05,-1.01927e-07,4.09276e-11,-50830.3,15.0304], Tmin=(100,'K'), Tmax=(951.087,'K')), NASAPolynomial(coeffs=[15.4527,0.00382631,-2.00021e-07,1.24982e-10,-2.09524e-14,-55448,-57.2523], Tmin=(951.087,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-423.151,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(O2s-CsH) + group(Cs-OsOsOsH) + group(Cs-OsOsHH) + ring(Cyclobutane)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]OC([O])O(982)'],
    products = ['HOCHO(59)', 'CH2O(15)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', '[CH2]OC(=O)O(4527)'],
    products = ['[CH2]OC([O])O(982)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2][O](167)', '[O][CH]O(171)'],
    products = ['[CH2]OC([O])O(982)'],
    transitionState = 'TS8',
