...
species(
    label = '[CH2]CCC(=O)COO(2923)',
    structure = SMILES('[CH2]CCC(=O)COO'),
    E0 = (-150.477,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3615,1310,387.5,850,1000,3000,3100,440,815,1455,1000,375,552.5,462.5,1710,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'C[CH]CC(=O)CO[O](2926)',
    structure = SMILES('C[CH]CC(=O)CO[O]'),
    E0 = (-3.81614,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,375,552.5,462.5,1710,3025,407.5,1350,352.5,492.5,1135,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.62653,0.0798094,-9.33123e-05,6.64134e-08,-2.01064e-11,-342.583,31.3348], Tmin=(100,'K'), Tmax=(790.835,'K')), NASAPolynomial(coeffs=[8.39188,0.0405324,-1.88138e-05,3.61131e-09,-2.53106e-13,-1570.79,-4.30623], Tmin=(790.835,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-3.81614,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-(Cds-O2d)OsHH) + group(Cs-CsHHH) + group(Cds-OdCsCs) + radical(CCJCC=O) + radical(ROOJ)"""),
)
...
species(
    ...
    molecularWeight = (116.115,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.249699,0.0901115,-0.000126928,1.08403e-07,-3.78243e-11,-7718.06,29.933], Tmin=(100,'K'), Tmax=(804.629,'K')), NASAPolynomial(coeffs=[7.4553,0.0436829,-2.06004e-05,3.92159e-09,-2.71026e-13,-8534.23,-1.12967], Tmin=(804.629,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-65.2334,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-(Cds-O2d)OsHH) + group(Cs-CsHHH) + group(Cds-OdCsCs) + radical(ROOJ) + radical(OCJC=O)"""),
)

species(
    label = 'CCC[C]1COOO1(2930)',
...
species(
    label = 'CCC(=O)CO[O](2931)',
    structure = SMILES('CCC(=O)CO[O]'),
    E0 = (-179.938,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,375,552.5,462.5,1710,492.5,1135,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,186.374,186.385],'cm^-1')),
        HinderedRotor(inertia=(0.229232,'amu*angstrom^2'), symmetry=1, barrier=(5.6488,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.229246,'amu*angstrom^2'), symmetry=1, barrier=(5.64877,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.229217,'amu*angstrom^2'), symmetry=1, barrier=(5.64867,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.229256,'amu*angstrom^2'), symmetry=1, barrier=(5.64879,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
species(
    label = 'CCC=C(O)CO[O](2933)',
    structure = SMILES('CCC=C(O)CO[O]'),
    E0 = (-196.732,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,350,440,435,1725,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,492.5,1135,1000,301.9,302.772],'cm^-1')),
        HinderedRotor(inertia=(0.167588,'amu*angstrom^2'), symmetry=1, barrier=(10.4152,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.160978,'amu*angstrom^2'), symmetry=1, barrier=(10.4622,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.162002,'amu*angstrom^2'), symmetry=1, barrier=(10.4519,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.160996,'amu*angstrom^2'), symmetry=1, barrier=(10.4147,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.159498,'amu*angstrom^2'), symmetry=1, barrier=(10.4196,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (117.123,'amu'),
...
species(
    label = 'CCCC(O)=CO[O](2934)',
    structure = SMILES('CCCC(O)=CO[O]'),
    E0 = (-187.154,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1277.5,1000,3010,987.5,1337.5,450,1655,350,440,435,1725,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,492.5,1135,1000,236.398,237.124],'cm^-1')),
        HinderedRotor(inertia=(0.286247,'amu*angstrom^2'), symmetry=1, barrier=(11.355,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.286206,'amu*angstrom^2'), symmetry=1, barrier=(11.3442,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.280903,'amu*angstrom^2'), symmetry=1, barrier=(11.3398,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.282294,'amu*angstrom^2'), symmetry=1, barrier=(11.3513,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.283256,'amu*angstrom^2'), symmetry=1, barrier=(11.3488,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (117.123,'amu'),
...
species(
    label = 'CC[C]=C(O)COO(3182)',
    structure = SMILES('CC[C]=C(O)COO'),
    E0 = (-110.895,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1277.5,1000,1685,370,3615,1310,387.5,850,1000,350,440,435,1725,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,200,800],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2]CC=C(O)COO(3184)',
    structure = SMILES('[CH2]CC=C(O)COO'),
    E0 = (-143.49,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3010,987.5,1337.5,450,1655,3615,1277.5,1000,3615,1310,387.5,850,1000,350,440,435,1725,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3100,440,815,1455,1000,200,800],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'C[CH]C=C([O])COO(3188)',
    structure = SMILES('C[CH]C=C([O])COO'),
    E0 = (-69.8193,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1310,387.5,850,1000,350,440,435,1725,2750,2850,1437.5,1250,1305,750,350,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'CC[C]=C([O])COO(3191)',
    structure = SMILES('CC[C]=C([O])COO'),
    E0 = (26.9098,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,350,440,435,1725,1685,370,3615,1310,387.5,850,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'CC=C([O])COO(3193)',
    structure = SMILES('CC=C([O])COO'),
    E0 = (-188.286,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,350,440,435,1725,3615,1310,387.5,850,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,248.687,248.731],'cm^-1')),
        HinderedRotor(inertia=(0.00272619,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.226358,'amu*angstrom^2'), symmetry=1, barrier=(9.93923,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.226337,'amu*angstrom^2'), symmetry=1, barrier=(9.93928,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.459861,'amu*angstrom^2'), symmetry=1, barrier=(20.1869,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (103.097,'amu'),
...
species(
    label = 'CCC=[C]COO(3195)',
    structure = SMILES('CCC=[C]COO'),
    E0 = (103.664,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3010,987.5,1337.5,450,1655,1685,370,3615,1310,387.5,850,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,265.287,2053.59],'cm^-1')),
        HinderedRotor(inertia=(0.244063,'amu*angstrom^2'), symmetry=1, barrier=(12.181,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.244174,'amu*angstrom^2'), symmetry=1, barrier=(12.1856,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.244327,'amu*angstrom^2'), symmetry=1, barrier=(12.1791,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.242885,'amu*angstrom^2'), symmetry=1, barrier=(12.1783,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.844063,'amu*angstrom^2'), symmetry=1, barrier=(41.6914,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (101.124,'amu'),
...
species(
    label = 'CC=CC(=O)COO(3196)',
    structure = SMILES('CC=CC(=O)COO'),
    E0 = (-236.268,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2995,3025,975,1000,1300,1375,400,500,1630,1680,375,552.5,462.5,1710,3615,1310,387.5,850,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,180,4000],'cm^-1')),
        HinderedRotor(inertia=(1.40707,'amu*angstrom^2'), symmetry=1, barrier=(32.3514,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.468359,'amu*angstrom^2'), symmetry=1, barrier=(10.7685,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.01428,'amu*angstrom^2'), symmetry=1, barrier=(23.3203,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.4077,'amu*angstrom^2'), symmetry=1, barrier=(32.3657,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.468395,'amu*angstrom^2'), symmetry=1, barrier=(10.7693,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (116.115,'amu'),
...
species(
    label = 'CCC([C]=O)COO(3200)',
    structure = SMILES('CCC([C]=O)COO'),
    E0 = (-186.278,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,1855,455,950,3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,200,800],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
reaction(
    label = 'reaction1',
    reactants = ['O2(2)', '[CH2]C(=O)CCC(2148)'],
    products = ['CCCC(=O)CO[O](2417)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['CCCC(=O)CO[O](2417)'],
    products = ['CCCC1([O])COO1(2919)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction7',
    reactants = ['C2H5(29)', '[CH2]C(=O)CO[O](2924)'],
    products = ['CCCC(=O)CO[O](2417)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['CH3(17)', '[CH2]CC(=O)CO[O](2925)'],
    products = ['CCCC(=O)CO[O](2417)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(3)', 'C[CH]CC(=O)CO[O](2926)'],
    products = ['CCCC(=O)CO[O](2417)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['npropyl(83)', '[O]OC[C]=O(407)'],
    products = ['CCCC(=O)CO[O](2417)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(3)', 'CC[CH]C(=O)CO[O](2927)'],
    products = ['CCCC(=O)CO[O](2417)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(3)', '[CH2]CCC(=O)CO[O](2928)'],
    products = ['CCCC(=O)CO[O](2417)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2]O[O](92)', 'CCC[C]=O(2154)'],
    products = ['CCCC(=O)CO[O](2417)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(3)', 'CCCC(=O)[CH]O[O](2929)'],
    products = ['CCCC(=O)CO[O](2417)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CH2(S)(23)', 'CCC(=O)CO[O](2931)'],
    products = ['CCCC(=O)CO[O](2417)'],
...
reaction(
    label = 'reaction22',
    reactants = ['CH2OOH(35)', 'CCC=C=O(2396)'],
    products = ['CC[CH]C(=O)COO(2921)'],
...
reaction(
    label = 'reaction23',
    reactants = ['CC[CH]C(=O)COO(2921)'],
    products = ['CCC=C(O)[CH]OO(3181)'],
...
reaction(
    label = 'reaction28',
    reactants = ['OH(5)', 'CCC=C([O])C[O](3185)'],
    products = ['CC[CH]C(=O)COO(2921)'],
...
reaction(
    label = 'reaction29',
    reactants = ['HO2(10)', 'C=C([O])[CH]CC(2377)'],
    products = ['CC[CH]C(=O)COO(2921)'],
...
reaction(
    label = 'reaction31',
    reactants = ['CH3(17)', '[CH2]C=C([O])COO(3186)'],
    products = ['CC[CH]C(=O)COO(2921)'],
...
reaction(
    label = 'reaction32',
    reactants = ['C2H5(29)', '[CH]=C([O])COO(3187)'],
    products = ['CC[CH]C(=O)COO(2921)'],
...
reaction(
    label = 'reaction33',
    reactants = ['H(3)', 'C[CH]C=C([O])COO(3188)'],
    products = ['CC[CH]C(=O)COO(2921)'],
...
reaction(
    label = 'reaction34',
    reactants = ['CH2OOH(35)', 'CC[CH][C]=O(2394)'],
    products = ['CC[CH]C(=O)COO(2921)'],
...
reaction(
    label = 'reaction35',
    reactants = ['H(3)', 'CCC=C([O])[CH]OO(3189)'],
    products = ['CC[CH]C(=O)COO(2921)'],
...
reaction(
    label = 'reaction36',
    reactants = ['H(3)', '[CH2]CC=C([O])COO(3190)'],
    products = ['CC[CH]C(=O)COO(2921)'],
...
reaction(
    label = 'reaction37',
    reactants = ['H(3)', 'CC[C]=C([O])COO(3191)'],
    products = ['CC[CH]C(=O)COO(2921)'],
...
reaction(
    label = 'reaction39',
    reactants = ['CH2(S)(23)', 'CC=C([O])COO(3193)'],
    products = ['CC[CH]C(=O)COO(2921)'],
...
reaction(
    label = 'reaction42',
    reactants = ['H(3)', 'CC=CC(=O)COO(3196)'],
    products = ['CC[CH]C(=O)COO(2921)'],
...
reaction(
    label = 'reaction43',
    reactants = ['CH3(17)', 'C=CC(=O)COO(3197)'],
    products = ['CC[CH]C(=O)COO(2921)'],
...
reaction(
    label = 'reaction48',
    reactants = ['[CH2]C(C)C(=O)COO(3199)'],
    products = ['CC[CH]C(=O)COO(2921)'],
...
reaction(
    label = 'reaction51',
    reactants = ['[CH]CC(144)', 'hoo_acetyl(705)'],
    products = ['CC[CH]C(=O)COO(2921)'],
