...
species(
    label = 'CCC1(OCC1=O)C(C)[O](8917)',
    structure = SMILES('CCC1(OCC1=O)C(C)[O]'),
    E0 = (-248.144,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,1380,1390,370,380,2900,435,2750,3150,900,1100,300,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.919304,0.0922882,-5.17192e-05,-2.02223e-09,7.94132e-12,-29653.9,34.8496], Tmin=(100,'K'), Tmax=(1034.71,'K')), NASAPolynomial(coeffs=[21.9219,0.0350633,-1.38103e-05,2.57817e-09,-1.83135e-13,-36044.2,-84.1635], Tmin=(1034.71,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-248.144,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(490.554,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-(Cds-O2d)CsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)OsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdCsCs) + ring(Cyclobutane) + radical(CC(C)OJ)"""),
)

species(
    label = 'CCC1(OC[C]1O)C(C)=O(8918)',
    structure = SMILES('CCC1(OC[C]1O)C(C)=O'),
    E0 = (-321.355,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (143.16,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.908259,0.103158,-9.22728e-05,3.7266e-08,-2.63959e-12,-38468.6,34.3304], Tmin=(100,'K'), Tmax=(864.702,'K')), NASAPolynomial(coeffs=[17.7672,0.0367331,-1.168e-05,1.83286e-09,-1.1534e-13,-42444.8,-57.3691], Tmin=(864.702,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-321.355,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(486.397,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-(Cds-O2d)CsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)HHH) + group(Cds-OdCsCs) + ring(Oxetane) + radical(C2CsJOH)"""),
)

species(
    label = 'CCC1(OC=C1O)C(C)[O](8919)',
    structure = SMILES('CCC1(OC=C1O)C(C)[O]'),
    E0 = (-290.546,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,1000,2750,2850,1437.5,1250,1305,750,350,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3615,1277.5,1000,1380,1390,370,380,2900,435,300,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (143.16,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.55554,0.0909088,2.12859e-07,-9.48995e-08,5.15175e-11,-34715.5,34.9586], Tmin=(100,'K'), Tmax=(922.383,'K')), NASAPolynomial(coeffs=[36.1928,0.00854051,1.89947e-06,-5.23615e-10,2.83483e-14,-45139,-162.86], Tmin=(922.383,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-290.546,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(486.397,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + ring(Cyclobutene) + radical(CC(C)OJ)"""),
)
...
species(
    label = 'CC([O])C1OCC=1O(8920)',
    structure = SMILES('CC([O])C1OCC=1O'),
    E0 = (-216.622,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,3150,900,1100,2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1277.5,1000,1380,1390,370,380,2900,435,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.296239,0.056929,1.82364e-05,-8.45231e-08,4.19716e-11,-25897.6,27.3884], Tmin=(100,'K'), Tmax=(931.971,'K')), NASAPolynomial(coeffs=[27.1006,0.00461121,1.48486e-06,-3.22976e-10,1.28086e-14,-33617.9,-114.653], Tmin=(931.971,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-216.622,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsOs) + ring(Cyclobutene) + radical(CC(C)OJ)"""),
)
...
species(
    label = 'CCC1(OCC1[O])C(C)[O](8921)',
    structure = SMILES('CCC1(OCC1[O])C(C)[O]'),
    E0 = (-106.286,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,2750,2950,3150,900,1000,1100,1380,1390,370,380,2900,435,300,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (144.168,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.929638,0.0952368,-4.96434e-05,-1.29473e-08,1.58015e-11,-12593.5,35.2073], Tmin=(100,'K'), Tmax=(909.544,'K')), NASAPolynomial(coeffs=[20.7693,0.0356343,-1.04306e-05,1.61641e-09,-1.04612e-13,-18022.6,-75.5665], Tmin=(909.544,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-106.286,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(515.497,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Oxetane) + radical(CC(C)OJ) + radical(CC(C)OJ)"""),
)
...
species(
    label = 'CCC1(O[CH]C1O)C(C)[O](8923)',
    structure = SMILES('CCC1(O[CH]C1O)C(C)[O]'),
    E0 = (-156.191,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,1380,1390,370,380,2900,435,3615,1277.5,1000,2750,3150,900,1100,300,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'C[CH]C1(OCC1O)C(C)[O](8924)',
    structure = SMILES('C[CH]C1(OCC1O)C(C)[O]'),
    E0 = (-136.745,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,1380,1390,370,380,2900,435,3615,1277.5,1000,2750,2950,3150,900,1000,1100,300,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'CCC1(OCC1O)[C](C)[O](8925)',
    structure = SMILES('CCC1(OCC1O)[C](C)[O]'),
    E0 = (-160.019,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,360,370,350,3615,1277.5,1000,2750,2950,3150,900,1000,1100,300,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2]CC1(OCC1O)C(C)[O](8928)',
...
species(
    label = 'CCC(=C(O)C[O])C(C)[O](8933)',
    structure = SMILES('CCC(=C(O)C[O])C(C)[O]'),
    E0 = (-198.683,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (144.168,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.981057,0.106096,-9.5338e-05,4.53089e-08,-8.77167e-12,-23713.9,41.1812], Tmin=(100,'K'), Tmax=(1228.39,'K')), NASAPolynomial(coeffs=[18.4638,0.0427775,-1.80198e-05,3.34717e-09,-2.31696e-13,-28491.1,-56.6288], Tmin=(1228.39,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-198.683,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsOs) + radical(CC(C)OJ) + radical(CCOJ)"""),
)

species(
    label = 'CCC1(OCC1O)C(C)=O(8934)',
    structure = SMILES('CCC1(OCC1O)C(C)=O'),
    E0 = (-497.982,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
species(
    label = 'CC([O])C1(C)OC[C]1O(8937)',
    structure = SMILES('CC([O])C1(C)OC[C]1O'),
    E0 = (-136.239,'kJ/mol'),
    modes = [
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.06065,0.0987243,-9.86767e-05,5.29032e-08,-1.10253e-11,-16192.8,33.7331], Tmin=(100,'K'), Tmax=(1293.2,'K')), NASAPolynomial(coeffs=[19.3007,0.0277467,-7.07219e-06,8.97151e-10,-4.7052e-14,-20790.3,-67.1482], Tmin=(1293.2,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-136.239,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(440.667,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Oxetane) + radical(C2CsJOH) + radical(CC(C)OJ)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'CCC1(OCC1=O)C(C)[O](8917)'],
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'CCC1(OC[C]1O)C(C)=O(8918)'],
    products = ['CCC1(OC[C]1O)C(C)[O](7281)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', 'CCC1(OC=C1O)C(C)[O](8919)'],
    products = ['CCC1(OC[C]1O)C(C)[O](7281)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['C2H5(29)', 'CC([O])C1OCC=1O(8920)'],
    products = ['CCC1(OC[C]1O)C(C)[O](7281)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['CH3(17)', 'CCC1(C=O)OC[C]1O(5471)'],
    products = ['CCC1(OC[C]1O)C(C)[O](7281)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['CCC1(OCC1[O])C(C)[O](8921)'],
    products = ['CCC1(OC[C]1O)C(C)[O](7281)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['CCC1(O[CH]C1O)C(C)[O](8923)'],
    products = ['CCC1(OC[C]1O)C(C)[O](7281)'],
...
reaction(
    label = 'reaction12',
    reactants = ['C[CH]C1(OCC1O)C(C)[O](8924)'],
    products = ['CCC1(OC[C]1O)C(C)[O](7281)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CCC1(OCC1O)[C](C)[O](8925)'],
    products = ['CCC1(OC[C]1O)C(C)[O](7281)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]CC1(OCC1O)C(C)[O](8928)'],
    products = ['CCC1(OC[C]1O)C(C)[O](7281)'],
...
reaction(
    label = 'reaction23',
    reactants = ['CCC(=C(O)C[O])C(C)[O](8933)'],
    products = ['CCC1(OC[C]1O)C(C)[O](7281)'],
...
reaction(
    label = 'reaction24',
    reactants = ['CCC1(OC[C]1O)C(C)[O](7281)'],
    products = ['CCC1(OCC1O)C(C)=O(8934)'],
...
reaction(
    label = 'reaction27',
    reactants = ['CH2(S)(23)', 'CC([O])C1(C)OC[C]1O(8937)'],
    products = ['CCC1(OC[C]1O)C(C)[O](7281)'],
...
reaction(
    label = 'reaction28',
    reactants = ['CH2(S)(23)', 'CCC1(C[O])OC[C]1O(5278)'],
    products = ['CCC1(OC[C]1O)C(C)[O](7281)'],
...
reaction(
    label = 'reaction29',
    reactants = ['CCC1(O)CO[C]1C(C)[O](8938)'],
    products = ['CCC1(OC[C]1O)C(C)[O](7281)'],
...
reaction(
    label = 'reaction32',
    reactants = ['O(4)', 'C[CH]C1(CC)OC[C]1O(8939)'],
    products = ['CCC1(OC[C]1O)C(C)[O](7281)'],
