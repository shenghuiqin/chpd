...
species(
    label = '[CH2]C(O)C1=CCC1(23851)',
    structure = SMILES('[CH2]C(O)C1=CCC1'),
    E0 = (121.549,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,3615,1277.5,1000,3000,3100,440,815,1455,1000,2750,2850,2950,3050,3150,900,950,1000,1050,1100,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
...
species(
    ...
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.25005,0.0424247,3.62558e-05,-7.61754e-08,3.17133e-11,18031.4,26.438], Tmin=(100,'K'), Tmax=(976.063,'K')), NASAPolynomial(coeffs=[15.3459,0.0287223,-1.0403e-05,1.94475e-09,-1.42114e-13,13180.7,-51.9772], Tmin=(976.063,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(148.964,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(394.937,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cyclobutane) + radical(CJCO) + radical(CCJ(C)CO)"""),
)
...
species(
    label = '[CH2]C(O)C1C[CH]C1(23855)',
    structure = SMILES('[CH2]C(O)C1C[CH]C1'),
    E0 = (184.228,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2830,2910,2990,3070,3150,900,940,980,1020,1060,1100,3615,1277.5,1000,3000,3100,440,815,1455,1000,1380,1390,370,380,2900,435,300,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
...
species(
    ...
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.801964,0.0580584,-1.29466e-05,-2.33095e-08,1.26743e-11,20935.1,27.276], Tmin=(100,'K'), Tmax=(1010,'K')), NASAPolynomial(coeffs=[14.643,0.0301586,-1.14854e-05,2.11142e-09,-1.4902e-13,16766.3,-46.433], Tmin=(1010,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(173.018,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(394.937,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cyclobutane) + radical(C2CsJOH) + radical(CJCO)"""),
)
...
species(
    label = '[CH2]CC=CC([CH2])O(23857)',
    structure = SMILES('[CH2]CC=CC([CH2])O'),
    E0 = (168.836,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2995,3025,975,1000,1300,1375,400,500,1630,1680,3615,1277.5,1000,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,1380,1390,370,380,2900,435,180,555.965],'cm^-1')),
        HinderedRotor(inertia=(0.0467268,'amu*angstrom^2'), symmetry=1, barrier=(10.2493,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0467285,'amu*angstrom^2'), symmetry=1, barrier=(10.2493,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0467265,'amu*angstrom^2'), symmetry=1, barrier=(10.2493,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.015355,'amu*angstrom^2'), symmetry=1, barrier=(3.36816,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0467259,'amu*angstrom^2'), symmetry=1, barrier=(10.2493,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.382612,0.0700099,-5.09629e-05,1.6896e-08,-1.62088e-12,20444.5,33.4736], Tmin=(100,'K'), Tmax=(1161.16,'K')), NASAPolynomial(coeffs=[15.6069,0.0283534,-1.10873e-05,2.00352e-09,-1.37247e-13,16181.6,-45.3813], Tmin=(1161.16,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(168.836,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(CJCO) + radical(RCCJ)"""),
)
...
species(
    ...
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.18117,0.0367903,6.83254e-05,-1.22295e-07,5.15069e-11,-15322.7,24.0641], Tmin=(100,'K'), Tmax=(943.697,'K')), NASAPolynomial(coeffs=[20.4125,0.0189987,-4.68262e-06,8.34823e-10,-6.77716e-14,-21789.9,-82.6355], Tmin=(943.697,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-128.436,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(399.095,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + ring(Cyclobutane)"""),
)
...
species(
    label = '[CH2]C(O)[CH]C1CC1(23859)',
    structure = SMILES('[CH2]C(O)[CH]C1CC1'),
    E0 = (200.711,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,2950,3050,3150,900,950,1000,1050,1100,3025,407.5,1350,352.5,3615,1277.5,1000,3000,3100,440,815,1455,1000,1380,1390,370,380,2900,435,300,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.878063,0.0529735,6.88961e-06,-4.95986e-08,2.35954e-11,24266.5,30.0598], Tmin=(100,'K'), Tmax=(966.429,'K')), NASAPolynomial(coeffs=[16.753,0.0250931,-8.54579e-06,1.54793e-09,-1.11775e-13,19431.7,-55.1246], Tmin=(966.429,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(200.711,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(390.78,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(CJCO) + radical(CCJCO)"""),
)
...
species(
    ...
    E0 = (196.85,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,3615,1277.5,1000,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,300,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', '[CH2]C(O)C1=CCC1(23851)'],
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'C=C(O)C1[CH]CC1(23852)'],
    products = ['[CH2]C(O)C1[CH]CC1(20930)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', '[CH2]C(O)C1C=CC1(23853)'],
    products = ['[CH2]C(O)C1[CH]CC1(20930)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['OH(5)', 'C=CC1[CH]CC1(22318)'],
    products = ['[CH2]C(O)C1[CH]CC1(20930)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]C(O)C1[CH]CC1(20930)'],
    products = ['[CH2]C(O)[C]1CCC1(23854)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]C(O)C1C[CH]C1(23855)'],
    products = ['[CH2]C(O)C1[CH]CC1(20930)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2]CC=CC([CH2])O(23857)'],
    products = ['[CH2]C(O)C1[CH]CC1(20930)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH2]C(O)[CH]C1CC1(23859)'],
    products = ['[CH2]C(O)C1[CH]CC1(20930)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[CH2]C(O)C1CC1[CH2](20923)'],
    products = ['[CH2]C(O)C1[CH]CC1(20930)'],
...
reaction(
    label = 'reaction27',
    reactants = ['CH2(19)', 'O[CH]C1[CH]CC1(23430)'],
    products = ['[CH2]C(O)C1[CH]CC1(20930)'],
