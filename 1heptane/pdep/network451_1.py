...
species(
    label = 'C=C(CCC)O[C]=O(2510)',
    structure = SMILES('C=C(CCC)O[C]=O'),
    E0 = (-185.968,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2950,3100,1380,975,1025,1650,1855,455,950,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.35504,0.0779854,-6.55288e-05,2.86942e-08,-5.15449e-12,-22234,27.9981], Tmin=(100,'K'), Tmax=(1305.68,'K')), NASAPolynomial(coeffs=[14.7722,0.033818,-1.47881e-05,2.78653e-09,-1.93923e-13,-25998.8,-45.4016], Tmin=(1305.68,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-185.968,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + group(Cds-OdOsH) + radical((O)CJOC)"""),
)
...
species(
    ...
    molecularWeight = (114.142,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.366108,0.0831846,-8.20958e-05,4.63277e-08,-1.09929e-11,-11494.4,31.297], Tmin=(100,'K'), Tmax=(998.843,'K')), NASAPolynomial(coeffs=[11.0777,0.0402895,-1.768e-05,3.33509e-09,-2.32574e-13,-13634.2,-20.3681], Tmin=(998.843,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-96.635,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(407.409,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdOsH) + radical((O)CJOCC2) + radical(C2CsJOC(O)H)"""),
)

species(
    label = '[CH2][C](CCC)OC=O(2512)',
    ...
    molecularWeight = (114.142,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.368736,0.0855254,-8.92272e-05,5.55247e-08,-1.4818e-11,-9661.12,32.3555], Tmin=(100,'K'), Tmax=(886.484,'K')), NASAPolynomial(coeffs=[9.34735,0.0450121,-2.06756e-05,3.97159e-09,-2.79349e-13,-11253,-9.87933], Tmin=(886.484,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-81.3738,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(407.409,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdOsH) + radical(CJC(C)OC) + radical(C2CsJOC(O)H)"""),
)

species(
    label = 'CC[CH]C(C)O[C]=O(2513)',
    ...
    molecularWeight = (114.142,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.160596,0.0761333,-5.79337e-05,2.27081e-08,-3.61074e-12,-11455.4,33.5873], Tmin=(100,'K'), Tmax=(1478.03,'K')), NASAPolynomial(coeffs=[16.6643,0.0314694,-1.26058e-05,2.26288e-09,-1.52555e-13,-16334,-52.4815], Tmin=(1478.03,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-96.4506,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(407.409,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdOsH) + radical(CCJCO) + radical((O)CJOCC2)"""),
)

species(
    label = 'C[CH]CC(C)O[C]=O(2514)',
    ...
    molecularWeight = (114.142,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.789287,0.0742521,-6.08869e-05,2.8997e-08,-6.063e-12,-12144,31.5684], Tmin=(100,'K'), Tmax=(1089.82,'K')), NASAPolynomial(coeffs=[8.97881,0.0441936,-1.95148e-05,3.68859e-09,-2.57323e-13,-13929,-8.64563], Tmin=(1089.82,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-101.906,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(407.409,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdOsH) + radical(RCCJC) + radical((O)CJOCC2)"""),
)

species(
    label = '[CH2]C([CH]CC)OC=O(2515)',
...
species(
    ...
    molecularWeight = (114.142,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.380654,0.0777914,-6.2737e-05,2.69078e-08,-4.79095e-12,-10826,32.0772], Tmin=(100,'K'), Tmax=(1306.27,'K')), NASAPolynomial(coeffs=[13.7401,0.0368828,-1.57614e-05,2.93343e-09,-2.0262e-13,-14316.2,-35.9437], Tmin=(1306.27,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-91.1063,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(407.409,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdOsH) + radical(RCCJ) + radical((O)CJOCC2)"""),
)

species(
    label = '[CH2]C(C[CH]C)OC=O(2517)',
    ...
    molecularWeight = (114.142,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.79457,0.0764866,-6.73372e-05,3.69551e-08,-9.2376e-12,-10310.7,31.9296], Tmin=(100,'K'), Tmax=(911.731,'K')), NASAPolynomial(coeffs=[6.96276,0.0494247,-2.28135e-05,4.39845e-09,-3.10295e-13,-11435.4,2.74179], Tmin=(911.731,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-86.6453,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(407.409,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdOsH) + radical(RCCJC) + radical(CJC(C)OC)"""),
)

species(
    label = '[CH2]CCC([CH2])OC=O(2518)',
    ...
    molecularWeight = (114.142,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.585452,0.0778597,-6.2432e-05,2.71155e-08,-5.02548e-12,-9001.65,31.7099], Tmin=(100,'K'), Tmax=(1229.46,'K')), NASAPolynomial(coeffs=[11.482,0.0424088,-1.91806e-05,3.66302e-09,-2.56677e-13,-11681,-23.1105], Tmin=(1229.46,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-75.8452,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(407.409,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdOsH) + radical(RCCJ) + radical(CJC(C)OC)"""),
)
...
species(
    ...
    molecularWeight = (114.142,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.104585,0.0752475,-5.32242e-05,1.85357e-08,-2.58686e-12,-45845.3,30.2962], Tmin=(100,'K'), Tmax=(1673.05,'K')), NASAPolynomial(coeffs=[19.2031,0.0295858,-1.22852e-05,2.22252e-09,-1.49215e-13,-52235.8,-71.6721], Tmin=(1673.05,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-382.417,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + group(Cds-OdOsH)"""),
)
...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.745448,0.0736476,-7.6632e-05,4.40836e-08,-1.04384e-11,-7348.87,26.4985], Tmin=(100,'K'), Tmax=(1011.68,'K')), NASAPolynomial(coeffs=[11.4912,0.0311595,-1.36334e-05,2.56791e-09,-1.78988e-13,-9523.04,-25.4678], Tmin=(1011.68,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-62.0624,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdOsH) + radical((O)CJOCC2) + radical(CJC(C)OC)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'C=C(CCC)O[C]=O(2510)'],
    products = ['[CH2]C(CCC)O[C]=O(907)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['npropyl(83)', 'C=CO[C]=O(735)'],
    products = ['[CH2]C(CCC)O[C]=O(907)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]C(CCC)O[C]=O(907)'],
    products = ['[CH2]C([CH]CC)OC=O(2515)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]C(CCC)O[C]=O(907)'],
    products = ['[CH2]C(C[CH]C)OC=O(2517)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]CCC([CH2])OC=O(2518)'],
    products = ['[CH2]C(CCC)O[C]=O(907)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CH2(S)(23)', '[CH2]C(CC)O[C]=O(875)'],
    products = ['[CH2]C(CCC)O[C]=O(907)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CO(12)', '[CH2]C([O])CCC(1786)'],
    products = ['[CH2]C(CCC)O[C]=O(907)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[C]=O(361)', '[CH2]C([O])CCC(1786)'],
    products = ['[CH2]C(CCC)O[C]=O(907)'],
...
reaction(
    label = 'reaction20',
    reactants = ['CH2(19)', 'CCC[CH]O[C]=O(2521)'],
    products = ['[CH2]C(CCC)O[C]=O(907)'],
