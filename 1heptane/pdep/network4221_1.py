...
species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.991093,'amu*angstrom^2'), symmetry=1, barrier=(22.7872,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.98957,'amu*angstrom^2'), symmetry=1, barrier=(22.7522,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.989217,'amu*angstrom^2'), symmetry=1, barrier=(22.7441,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (111.119,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.131435,0.0726866,-4.74541e-05,-4.87584e-10,8.13467e-12,303.305,29.0577], Tmin=(100,'K'), Tmax=(967.37,'K')), NASAPolynomial(coeffs=[20.3278,0.0174845,-5.75289e-06,1.02429e-09,-7.37364e-14,-4928.73,-74.5545], Tmin=(967.37,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(1.27094,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(C=COJ)"""),
)

species(
    label = 'C=[C]C(C)OC=C=O(25153)',
    structure = SMILES('C=[C]C(C)OC=C=O'),
    E0 = (92.2605,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2120,512.5,787.5,1685,370,3010,987.5,1337.5,450,1655,2750,2800,2850,1350,1500,750,1050,1375,1000,2950,3100,1380,975,1025,1650,1380,1390,370,380,2900,435,189.697,189.709,189.737,189.742],'cm^-1')),
        HinderedRotor(inertia=(0.757225,'amu*angstrom^2'), symmetry=1, barrier=(19.341,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.757391,'amu*angstrom^2'), symmetry=1, barrier=(19.341,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.757278,'amu*angstrom^2'), symmetry=1, barrier=(19.3408,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.756975,'amu*angstrom^2'), symmetry=1, barrier=(19.3407,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (111.119,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0424207,0.0734997,-4.65467e-05,-4.69457e-09,1.04503e-11,11251.1,29.5523], Tmin=(100,'K'), Tmax=(958.096,'K')), NASAPolynomial(coeffs=[21.7931,0.0146351,-4.39874e-06,7.76564e-10,-5.74781e-14,5617.17,-82.1023], Tmin=(958.096,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(92.2605,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-(Cdd-O2d)OsH) + group(Cds-CdsHH) + radical(Cds_S)"""),
)

species(
    label = 'C#CC(C)OC=C[O](25154)',
    structure = SMILES('C#CC(C)OC=C[O]'),
    E0 = (-19.6444,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2175,525,750,770,3400,2100,2995,3025,975,1000,1300,1375,400,500,1630,1680,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,180,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(1.2745,'amu*angstrom^2'), symmetry=1, barrier=(29.3034,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.27724,'amu*angstrom^2'), symmetry=1, barrier=(29.3662,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.27711,'amu*angstrom^2'), symmetry=1, barrier=(29.3632,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.2789,'amu*angstrom^2'), symmetry=1, barrier=(29.4043,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (111.119,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.186792,0.0674324,1.8431e-06,-7.84094e-08,4.3247e-11,-2188.84,28.1266], Tmin=(100,'K'), Tmax=(908.954,'K')), NASAPolynomial(coeffs=[30.2064,-0.000459727,5.20006e-06,-1.15955e-09,7.59875e-14,-10434.6,-130.567], Tmin=(908.954,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-19.6444,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + group(Ct-CtCs) + group(Ct-CtH) + radical(C=COJ)"""),
)
...
species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.36333,'amu*angstrom^2'), symmetry=1, barrier=(31.3456,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.36212,'amu*angstrom^2'), symmetry=1, barrier=(31.3179,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
species(
    label = 'C=[C]C(C)OC=[C]O(25156)',
    structure = SMILES('C=[C]C(C)OC=[C]O'),
    E0 = (150.529,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1670,1700,300,440,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,1380,1390,370,380,2900,435,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.404633,0.0780032,-3.48329e-05,-3.24106e-08,2.43558e-11,18280.5,33.4823], Tmin=(100,'K'), Tmax=(923.139,'K')), NASAPolynomial(coeffs=[27.3033,0.00711035,4.69478e-07,-2.10112e-10,1.07544e-14,11069.9,-109.324], Tmin=(923.139,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(150.529,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(Cds_S) + radical(C=CJO)"""),
)
...
species(
    label = 'C=[C]C(C)O[C]=CO(25157)',
    structure = SMILES('C=[C]C(C)O[C]=CO'),
    E0 = (150.529,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1670,1700,300,440,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,1380,1390,370,380,2900,435,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.25489,0.0925239,-9.34166e-05,4.53296e-08,-8.24367e-12,8934.08,34.3391], Tmin=(100,'K'), Tmax=(1535.09,'K')), NASAPolynomial(coeffs=[25.1014,0.011197,-1.58783e-06,8.15284e-11,-4.71346e-16,2332.73,-99.2559], Tmin=(1535.09,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(72.545,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + radical(Cds_S) + radical(Allyl_P)"""),
)
...
species(
    label = '[CH]=[C]C(C)OC=CO(25159)',
    structure = SMILES('[CH]=[C]C(C)OC=CO'),
    E0 = (157.881,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,1685,370,1380,1390,370,380,2900,435,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.68895,0.0797642,-2.45236e-05,-5.40572e-08,3.48421e-11,19179.3,31.778], Tmin=(100,'K'), Tmax=(914.639,'K')), NASAPolynomial(coeffs=[31.7104,0.000107222,4.37571e-06,-9.66519e-10,6.18341e-14,10657.7,-135.824], Tmin=(914.639,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(157.881,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(Cds_S) + radical(Cds_P)"""),
)
...
species(
    label = 'C=[C]C(C)OC1[CH]O1(25160)',
    structure = SMILES('C=[C]C(C)OC1[CH]O1'),
    E0 = (204.766,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.434355,0.0814298,-7.62893e-05,3.71539e-08,-6.96957e-12,24801.1,33.3085], Tmin=(100,'K'), Tmax=(1458.65,'K')), NASAPolynomial(coeffs=[18.764,0.0204132,-4.93616e-06,6.08696e-10,-3.18384e-14,20090.7,-63.5081], Tmin=(1458.65,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(204.766,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Ethylene_oxide) + radical(Cds_S) + radical(CCsJO)"""),
)
...
species(
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0248284,0.0706686,-2.16153e-05,-3.63211e-08,2.28158e-11,-8425.48,29.1935], Tmin=(100,'K'), Tmax=(945.087,'K')), NASAPolynomial(coeffs=[23.4768,0.0153707,-3.95472e-06,6.73764e-10,-5.17733e-14,-14840.3,-93.2972], Tmin=(945.087,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-71.3939,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)OsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C=CCJ(O)C) + radical(C=COJ)"""),
)
...
species(
    label = 'C=[C]C(C)OC[C]=O(25164)',
    structure = SMILES('C=[C]C(C)OC[C]=O'),
    E0 = (119.793,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,1855,455,950,2750,2800,2850,1350,1500,750,1050,1375,1000,2950,3100,1380,975,1025,1650,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.754255,0.0710864,-5.83784e-05,2.48477e-08,-4.3724e-12,14524.6,31.5233], Tmin=(100,'K'), Tmax=(1318.2,'K')), NASAPolynomial(coeffs=[13.3543,0.0328523,-1.4871e-05,2.84416e-09,-1.99355e-13,11202.8,-32.7454], Tmin=(1318.2,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(119.793,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)OsHH) + group(Cds-CdsCsH) + group(Cds-OdCsH) + group(Cds-CdsHH) + radical(CsCJ=O) + radical(Cds_S)"""),
)

species(
    label = 'C=[C][C](C)OCC=O(25165)',
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.218386,0.0808755,-7.3022e-05,3.29256e-08,-5.82701e-12,7309.39,30.6099], Tmin=(100,'K'), Tmax=(1373.66,'K')), NASAPolynomial(coeffs=[20.1818,0.0214717,-8.15477e-06,1.44418e-09,-9.75288e-14,1704.81,-74.2856], Tmin=(1373.66,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(59.4279,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-O2d)OsHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + group(Cds-OdCsH) + radical(Allyl_P) + radical(Cds_S)"""),
)
...
species(
    label = '[CH]=[C]C(C)OCC=O(25166)',
    structure = SMILES('[CH]=[C]C(C)OCC=O'),
    E0 = (212.219,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,2750,2800,2850,1350,1500,750,1050,1375,1000,1685,370,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2782.5,750,1395,475,1775,1000,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.651313,0.0739735,-6.45188e-05,2.94942e-08,-5.56651e-12,25644.2,31.6193], Tmin=(100,'K'), Tmax=(1240.48,'K')), NASAPolynomial(coeffs=[13.3525,0.0330179,-1.49951e-05,2.87895e-09,-2.0261e-13,22493,-32.3937], Tmin=(1240.48,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(212.219,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-(Cds-O2d)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-OdCsH) + group(Cds-CdsHH) + radical(Cds_S) + radical(Cds_P)"""),
)
...
species(
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0361607,0.0764067,-5.94827e-05,1.81837e-08,-5.15566e-13,-18286.8,27.9869], Tmin=(100,'K'), Tmax=(1070,'K')), NASAPolynomial(coeffs=[18.6274,0.0238011,-9.4201e-06,1.74802e-09,-1.23119e-13,-23232.5,-67.4822], Tmin=(1070,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-153.309,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-O2d)OsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-OdCsH) + group(Cds-CdsHH) + group(Cdd-CdsCds)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'C=C=C(C)OC=C[O](25152)'],
    products = ['C=[C]C(C)OC=C[O](21000)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', 'C=[C]C(C)OC=C=O(25153)'],
    products = ['C=[C]C(C)OC=C[O](21000)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)', 'C#CC(C)OC=C[O](25154)'],
    products = ['C=[C]C(C)OC=C[O](21000)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['CH3(17)', 'C=C=COC=C[O](25155)'],
    products = ['C=[C]C(C)OC=C[O](21000)'],
    transitionState = 'TS6',
...
reaction(
    ...
    products = ['C=[C]C(C)OC=C[O](21000)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(2.6e+11,'cm^3/(mol*s)'), n=0, Ea=(60.12,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""Estimated using template [Cd_R;O_rad/OneDe] for rate rule [Cds-CsH_Ca;O_rad/OneDe]
...
reaction(
    label = 'reaction9',
    reactants = ['C=[C]C(C)OC=[C]O(25156)'],
    products = ['C=[C]C(C)OC=C[O](21000)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction12',
    reactants = ['C=[C]C(C)O[C]=CO(25157)'],
    products = ['C=[C]C(C)OC=C[O](21000)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH]=[C]C(C)OC=CO(25159)'],
    products = ['C=[C]C(C)OC=C[O](21000)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CHCHO(47)', 'C=[C]C(C)[O](3245)'],
    products = ['C=[C]C(C)OC=C[O](21000)'],
...
reaction(
    label = 'reaction20',
    reactants = ['C=[C]C(C)OC=C[O](21000)'],
    products = ['C=[C]C(C)OC1[CH]O1(25160)'],
...
reaction(
    label = 'reaction25',
    reactants = ['C=[C]C(C)OC=C[O](21000)'],
    products = ['C=C(C)[CH]OC=C[O](25163)'],
...
reaction(
    label = 'reaction28',
    reactants = ['H2CC(41)', 'C[CH]OC=C[O](2538)'],
    products = ['C=[C]C(C)OC=C[O](21000)'],
...
reaction(
    label = 'reaction29',
    reactants = ['O(4)', '[CH]=COC(C)[C]=C(25023)'],
    products = ['C=[C]C(C)OC=C[O](21000)'],
...
reaction(
    label = 'reaction31',
    reactants = ['C=[C]C(C)OC[C]=O(25164)'],
    products = ['C=[C]C(C)OC=C[O](21000)'],
...
reaction(
    label = 'reaction34',
    reactants = ['[CH]=[C]C(C)OCC=O(25166)'],
    products = ['C=[C]C(C)OC=C[O](21000)'],
