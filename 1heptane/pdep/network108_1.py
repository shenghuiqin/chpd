...
species(
    label = '[CH2]CC(=C)CC(419)',
    structure = SMILES('[CH2]CC(=C)CC'),
    E0 = (127.024,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2950,3100,1380,975,1025,1650,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,350,440,435,1725,614.713,623.804],'cm^-1')),
        HinderedRotor(inertia=(0.12035,'amu*angstrom^2'), symmetry=1, barrier=(2.76707,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.502527,'amu*angstrom^2'), symmetry=1, barrier=(11.5541,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0102948,'amu*angstrom^2'), symmetry=1, barrier=(2.80809,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.501789,'amu*angstrom^2'), symmetry=1, barrier=(11.5371,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (83.1515,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.1293,0.0535975,-1.47256e-05,-1.28685e-08,7.12773e-12,15388.9,25.841], Tmin=(100,'K'), Tmax=(1076.88,'K')), NASAPolynomial(coeffs=[11.4192,0.0340473,-1.35006e-05,2.47314e-09,-1.71481e-13,12090.1,-29.5905], Tmin=(1076.88,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(127.024,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(390.78,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(RCCJ)"""),
)
...
species(
    ...
    molecularWeight = (84.1595,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.97979,0.0547295,-2.65263e-05,5.76402e-09,-4.86714e-13,23689.2,23.9148], Tmin=(100,'K'), Tmax=(2565.56,'K')), NASAPolynomial(coeffs=[17.1226,0.03112,-1.27225e-05,2.17706e-09,-1.37184e-13,15919.3,-63.4078], Tmin=(2565.56,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(196.457,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJ) + radical(Tertalkyl)"""),
)
...
species(
    ...
    molecularWeight = (84.1595,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.04855,0.057148,-2.54636e-05,2.12546e-09,9.50385e-13,24837.7,28.7721], Tmin=(100,'K'), Tmax=(1373.7,'K')), NASAPolynomial(coeffs=[11.6438,0.0369438,-1.50283e-05,2.70347e-09,-1.81659e-13,20922.2,-29.3646], Tmin=(1373.7,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(205.577,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJ) + radical(Cs_S)"""),
)

species(
    label = '[CH2][CH]C(C)CC(424)',
...
species(
    ...
    molecularWeight = (84.1595,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.03446,0.0509485,1.07711e-05,-9.45377e-08,8.03707e-11,23671.5,23.2572], Tmin=(100,'K'), Tmax=(471.143,'K')), NASAPolynomial(coeffs=[3.66008,0.049031,-2.09592e-05,3.8977e-09,-2.69545e-13,23386.5,15.2382], Tmin=(471.143,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(196.293,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Isobutyl) + radical(Tertalkyl)"""),
)

species(
    label = '[CH2]CC(C)C[CH2](426)',
    structure = SMILES('[CH2]CC(C)C[CH2]'),
    E0 = (216.281,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,1380,1390,370,380,2900,435,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,2750,2800,2850,1350,1500,750,1050,1375,1000,180,1163.63],'cm^-1')),
        HinderedRotor(inertia=(0.139056,'amu*angstrom^2'), symmetry=1, barrier=(3.19718,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.139641,'amu*angstrom^2'), symmetry=1, barrier=(3.21062,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00331547,'amu*angstrom^2'), symmetry=1, barrier=(3.18024,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.139337,'amu*angstrom^2'), symmetry=1, barrier=(3.20364,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.777678,'amu*angstrom^2'), symmetry=1, barrier=(17.8803,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.1595,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.908197,0.0591481,-2.56194e-05,-1.11592e-09,2.74546e-12,26131.2,27.7991], Tmin=(100,'K'), Tmax=(1174.87,'K')), NASAPolynomial(coeffs=[11.5147,0.0368117,-1.46882e-05,2.66058e-09,-1.81622e-13,22688.3,-29.1261], Tmin=(1174.87,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(216.281,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJ) + radical(RCCJ)"""),
)
...
species(
    ...
    molecularWeight = (84.1595,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.10232,0.0527599,-3.99629e-06,-2.53437e-08,1.15945e-11,-9294.24,23.4572], Tmin=(100,'K'), Tmax=(1047.64,'K')), NASAPolynomial(coeffs=[11.4876,0.0365644,-1.43929e-05,2.64421e-09,-1.84402e-13,-12757.5,-33.2724], Tmin=(1047.64,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-78.2223,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(415.724,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH)"""),
)
...
species(
    ...
    molecularWeight = (84.1595,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.21827,0.0488304,8.49336e-06,-3.919e-08,1.67107e-11,-8555.22,24.3075], Tmin=(100,'K'), Tmax=(1018.92,'K')), NASAPolynomial(coeffs=[11.6698,0.0359251,-1.39121e-05,2.55992e-09,-1.79822e-13,-12145,-33.4752], Tmin=(1018.92,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-72.0542,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(415.724,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', '[CH2]CC(=C)CC(419)'],
    products = ['[CH2]CC([CH2])CC(397)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', '[CH2]C(C=C)CC(420)'],
    products = ['[CH2]CC([CH2])CC(397)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction21',
    reactants = ['[CH2]C([CH2])CC(429)', 'CH2(19)'],
    products = ['[CH2]CC([CH2])CC(397)'],
