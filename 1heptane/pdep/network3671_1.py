...
species(
    label = '[CH2]C(O)CC=C=C(20956)',
    structure = SMILES('[CH2]C(O)CC=C=C'),
    E0 = (139.395,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([540,610,2055,3010,987.5,1337.5,450,1655,3615,1277.5,1000,2950,3100,1380,975,1025,1650,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,219.269,220.173],'cm^-1')),
        HinderedRotor(inertia=(0.419831,'amu*angstrom^2'), symmetry=1, barrier=(14.639,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0034787,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.425847,'amu*angstrom^2'), symmetry=1, barrier=(14.6446,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.422006,'amu*angstrom^2'), symmetry=1, barrier=(14.6477,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (97.1351,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.580259,0.0722854,-6.4144e-05,3.03884e-08,-5.87192e-12,16890.9,28.4491], Tmin=(100,'K'), Tmax=(1231.25,'K')), NASAPolynomial(coeffs=[13.7248,0.0295826,-1.21204e-05,2.21994e-09,-1.52449e-13,13654.1,-37.7], Tmin=(1231.25,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(139.395,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(CJCO)"""),
)
...
species(
    ...
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.24965,0.0774365,-6.56536e-05,2.92089e-08,-5.28052e-12,9725.74,27.7822], Tmin=(100,'K'), Tmax=(1312.38,'K')), NASAPolynomial(coeffs=[15.4427,0.0311298,-1.2727e-05,2.32316e-09,-1.58975e-13,5737.93,-49.6455], Tmin=(1312.38,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(79.7078,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(CJCO) + radical(C=CCJCO)"""),
)
...
species(
    ...
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.819921,0.0590759,-2.08787e-05,-1.28967e-08,8.56034e-12,27392.2,30.1211], Tmin=(100,'K'), Tmax=(1032.49,'K')), NASAPolynomial(coeffs=[13.9416,0.0305384,-1.18137e-05,2.16694e-09,-1.51725e-13,23494.1,-39.3586], Tmin=(1032.49,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(226.722,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(390.78,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(CJCO) + radical(cyclopropane)"""),
)

species(
    label = '[CH2]C1[CH]CC(O)C1(20950)',
    ...
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.70839,0.0328794,5.4196e-05,-9.12915e-08,3.69586e-11,12445.4,27.8008], Tmin=(100,'K'), Tmax=(952.74,'K')), NASAPolynomial(coeffs=[12.9357,0.0295948,-9.67449e-06,1.71211e-09,-1.22525e-13,8315.73,-36.2661], Tmin=(952.74,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(102.658,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(399.095,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cyclopentane) + radical(Cs_S) + radical(Isobutyl)"""),
)
...
species(
    label = '[CH]=CCC([CH2])O(20961)',
    structure = SMILES('[CH]=CCC([CH2])O'),
    E0 = (245.913,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,3010,987.5,1337.5,450,1655,3615,1277.5,1000,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,324.393],'cm^-1')),
        HinderedRotor(inertia=(0.16166,'amu*angstrom^2'), symmetry=1, barrier=(12.0744,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00160116,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.161668,'amu*angstrom^2'), symmetry=1, barrier=(12.0756,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.161717,'amu*angstrom^2'), symmetry=1, barrier=(12.0752,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
...
species(
    label = '[CH2]C(O)C=CC=C(20962)',
    structure = SMILES('[CH2]C(O)C=CC=C'),
    E0 = (74.0325,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,3100,1380,975,1025,1650,2995,3010,3025,975,987.5,1000,1300,1337.5,1375,400,450,500,1630,1655,1680,3615,1277.5,1000,3000,3100,440,815,1455,1000,1380,1390,370,380,2900,435,284.014,284.014],'cm^-1')),
        HinderedRotor(inertia=(0.26272,'amu*angstrom^2'), symmetry=1, barrier=(15.0384,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.26272,'amu*angstrom^2'), symmetry=1, barrier=(15.0384,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.262719,'amu*angstrom^2'), symmetry=1, barrier=(15.0384,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.26272,'amu*angstrom^2'), symmetry=1, barrier=(15.0384,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
species(
    ...
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.624639,0.0750538,-6.82683e-05,3.46114e-08,-7.32992e-12,25724.2,30.1518], Tmin=(100,'K'), Tmax=(1113.96,'K')), NASAPolynomial(coeffs=[11.6106,0.0356056,-1.51494e-05,2.82154e-09,-1.95495e-13,23276.6,-24.0346], Tmin=(1113.96,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(212.878,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_S) + radical(CJCO)"""),
)

species(
    label = '[CH2][C](O)CCC=C(20964)',
    structure = SMILES('[CH2][C](O)CCC=C'),
    E0 = (151.664,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3010,987.5,1337.5,450,1655,3615,1277.5,1000,2950,3100,1380,975,1025,1650,360,370,350,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3100,440,815,1455,1000,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.539374,0.0786893,-7.84784e-05,4.45615e-08,-1.05735e-11,18363.5,29.4142], Tmin=(100,'K'), Tmax=(1002.62,'K')), NASAPolynomial(coeffs=[11.0143,0.0368992,-1.59569e-05,2.98945e-09,-2.07684e-13,16263,-21.1486], Tmin=(1002.62,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(151.664,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(C2CsJOH) + radical(CJCO)"""),
)

species(
    label = '[CH]=CCCC([CH2])O(20965)',
    ...
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.420009,0.0759477,-6.71563e-05,3.191e-08,-6.20261e-12,26847.6,30.8121], Tmin=(100,'K'), Tmax=(1222.46,'K')), NASAPolynomial(coeffs=[13.9075,0.0318153,-1.30042e-05,2.37803e-09,-1.63137e-13,23550,-36.9661], Tmin=(1222.46,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(222.133,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_P) + radical(CJCO)"""),
)
...
species(
    ...
    E0 = (121.886,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,3615,1277.5,1000,1380,1390,370,380,2900,435,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    ...
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.50713,0.0626787,-1.66575e-05,-2.82214e-08,1.67524e-11,-18005.6,27.6349], Tmin=(100,'K'), Tmax=(967.772,'K')), NASAPolynomial(coeffs=[17.9742,0.0238106,-8.0686e-06,1.44533e-09,-1.03342e-13,-22947.1,-64.1244], Tmin=(967.772,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-150.859,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(390.78,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cds-CdsHH)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]C=CCC([CH2])O(19704)'],
    products = ['[CH2][CH]C1CC(O)C1(20955)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', '[CH2]C=CCC(=C)O(19825)'],
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', '[CH2]C(O)CC=C=C(20956)'],
    products = ['[CH2]C=CCC([CH2])O(19704)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['OH(5)', '[CH2]C=CCC=C(18982)'],
    products = ['[CH2]C=CCC([CH2])O(19704)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2]C=CCC([CH2])O(19704)'],
    products = ['[CH2]C(O)[CH]C=CC(20959)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2]C([CH2])O(2453)', '[CH]=C[CH2](2461)'],
    products = ['[CH2]C=CCC([CH2])O(19704)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2]C=CCC([CH2])O(19704)'],
    products = ['[CH2]C(O)CC1[CH]C1(20960)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2]C=CCC([CH2])O(19704)'],
    products = ['[CH2]C1[CH]CC(O)C1(20950)'],
...
reaction(
    label = 'reaction25',
    reactants = ['CH2(19)', '[CH2]C=CC[CH]O(19596)'],
    products = ['[CH2]C=CCC([CH2])O(19704)'],
...
reaction(
    label = 'reaction26',
    reactants = ['CH2(19)', '[CH]=CCC([CH2])O(20961)'],
    products = ['[CH2]C=CCC([CH2])O(19704)'],
...
reaction(
    label = 'reaction27',
    reactants = ['H(3)', '[CH2]C(O)C=CC=C(20962)'],
    products = ['[CH2]C=CCC([CH2])O(19704)'],
...
reaction(
    label = 'reaction30',
    reactants = ['[CH2]C(O)CC[C]=C(20963)'],
    products = ['[CH2]C=CCC([CH2])O(19704)'],
...
reaction(
    label = 'reaction34',
    reactants = ['[CH]=C[CH]CC(C)O(19717)'],
    products = ['[CH2]C=CCC([CH2])O(19704)'],
