species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.546485,'amu*angstrom^2'), symmetry=1, barrier=(12.5648,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.546441,'amu*angstrom^2'), symmetry=1, barrier=(12.5638,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
species(
    ...
    E0 = (-98.9365,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2995,3025,975,1000,1300,1375,400,500,1630,1680,3615,1277.5,1000,492.5,1135,1000],'cm^-1')),
...
reaction(
    label = 'reaction4',
    reactants = ['hoo_acetyl(705)'],
    products = ['vinoxyperoxy(408)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['O2(2)', 'CH2CHO(40)'],
    products = ['vinoxyperoxy(408)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(311.435,'m^3/(mol*s)'), n=1.07778, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [O2_birad;C_pri_rad] for rate rule [O2_birad;C_rad/H2/CO]
Euclidian distance = 1.0
Multiplied by reaction path degeneracy 2.0
