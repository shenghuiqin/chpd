...
species(
    label = 'CCC=CC([O])O(4937)',
    structure = SMILES('CCC=CC([O])O'),
    E0 = (-186.901,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,3615,1277.5,1000,1380,1390,370,380,2900,435,281.393,283.675,3949.15],'cm^-1')),
        HinderedRotor(inertia=(0.110578,'amu*angstrom^2'), symmetry=1, barrier=(6.32404,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.110456,'amu*angstrom^2'), symmetry=1, barrier=(6.33345,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.109632,'amu*angstrom^2'), symmetry=1, barrier=(6.33308,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.402396,'amu*angstrom^2'), symmetry=1, barrier=(22.7592,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (101.124,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.44405,0.0618119,-5.21358e-05,2.91818e-08,-7.87105e-12,-22391.8,27.8047], Tmin=(100,'K'), Tmax=(827.458,'K')), NASAPolynomial(coeffs=[4.99785,0.0446326,-2.09938e-05,4.09153e-09,-2.90562e-13,-22979.9,11.3327], Tmin=(827.458,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-186.901,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(CCOJ)"""),
)

species(
    label = 'CC=CCC([O])O(4938)',
...
species(
    ...
    molecularWeight = (102.132,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.54077,0.0642522,-2.71091e-05,-6.30925e-08,7.41453e-11,-15369.4,29.2714], Tmin=(100,'K'), Tmax=(482.071,'K')), NASAPolynomial(coeffs=[6.10114,0.0442084,-2.01153e-05,3.81329e-09,-2.647e-13,-16015.8,8.4531], Tmin=(482.071,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-128.438,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(Cs_P)"""),
)

species(
    label = 'CCCC[C]([O])O(4942)',
    structure = SMILES('CCCC[C]([O])O'),
    E0 = (-97.1913,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,360,370,350,3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (102.132,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.43875,0.064849,-3.86843e-05,-1.80128e-08,3.13875e-11,-11605.5,28.5599], Tmin=(100,'K'), Tmax=(518.143,'K')), NASAPolynomial(coeffs=[5.18127,0.0475892,-2.23922e-05,4.35192e-09,-3.08176e-13,-12149.5,11.4583], Tmin=(518.143,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-97.1913,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + radical(CCOJ) + radical(Cs_P)"""),
)

species(
    label = '[CH2]CCCC([O])O(4943)',
    ...
    molecularWeight = (102.132,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.43891,0.0648463,-3.86698e-05,-1.8044e-08,3.14106e-11,-11605.5,29.6579], Tmin=(100,'K'), Tmax=(518.118,'K')), NASAPolynomial(coeffs=[5.18123,0.0475893,-2.23923e-05,4.35193e-09,-3.08177e-13,-12149.4,12.5571], Tmin=(518.118,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-97.1913,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + radical(RCCJ) + radical(CCOJ)"""),
)

species(
    label = 'CC[CH][CH]C(O)O(4944)',
    ...
    molecularWeight = (102.132,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.10122,0.0683527,-6.39301e-05,3.83666e-08,-1.03405e-11,-15989.9,32.4997], Tmin=(100,'K'), Tmax=(861.208,'K')), NASAPolynomial(coeffs=[6.64992,0.0425806,-1.90411e-05,3.6172e-09,-2.52929e-13,-16945.6,6.55956], Tmin=(861.208,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-133.782,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + radical(CCJCO) + radical(RCCJCC)"""),
)
...
species(
    ...
    molecularWeight = (102.132,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.89196,0.0765608,-0.000103134,9.31133e-08,-3.41967e-11,-16642.5,33.4724], Tmin=(100,'K'), Tmax=(832.812,'K')), NASAPolynomial(coeffs=[3.36451,0.0480632,-2.18674e-05,4.09398e-09,-2.79927e-13,-16477.9,25.4568], Tmin=(832.812,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-139.238,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(RCCJC)"""),
)

species(
    label = '[CH2]C[CH]CC(O)O(4947)',
    ...
    molecularWeight = (102.132,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.54092,0.0642497,-2.70952e-05,-6.3124e-08,7.417e-11,-15369.4,30.3696], Tmin=(100,'K'), Tmax=(482.059,'K')), NASAPolynomial(coeffs=[6.10111,0.0442085,-2.01153e-05,3.8133e-09,-2.64701e-13,-16015.8,9.55188], Tmin=(482.059,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-128.438,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + radical(RCCJ) + radical(RCCJCC)"""),
)

species(
    label = 'CCC=CC(O)O(4948)',
    structure = SMILES('CCC=CC(O)O'),
    E0 = (-412.606,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (102.132,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.856235,0.0675608,-5.17532e-05,2.11697e-08,-3.61879e-12,-49510.8,28.3355], Tmin=(100,'K'), Tmax=(1347.24,'K')), NASAPolynomial(coeffs=[12.1772,0.0339482,-1.43291e-05,2.65067e-09,-1.82283e-13,-52561.2,-29.656], Tmin=(1347.24,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-412.606,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH)"""),
)

species(
    label = 'CCCCC(=O)O(4949)',
    structure = SMILES('CCCCC(=O)O'),
    E0 = (-516.57,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (102.132,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.30184,0.0605867,-3.54883e-05,1.00558e-08,-1.16966e-12,-62034.2,24.8588], Tmin=(100,'K'), Tmax=(1849.78,'K')), NASAPolynomial(coeffs=[12.8255,0.0356675,-1.52809e-05,2.77296e-09,-1.85366e-13,-66297.4,-37.824], Tmin=(1849.78,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-516.57,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsOs)"""),
)

species(
    label = 'CC=CCC(O)O(4950)',
    structure = SMILES('CC=CCC(O)O'),
    E0 = (-412.606,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (102.132,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.856235,0.0675608,-5.17532e-05,2.11697e-08,-3.61879e-12,-49510.8,28.3355], Tmin=(100,'K'), Tmax=(1347.24,'K')), NASAPolynomial(coeffs=[12.1772,0.0339482,-1.43291e-05,2.65067e-09,-1.82283e-13,-52561.2,-29.656], Tmin=(1347.24,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-412.606,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsOsH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH)"""),
)
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', 'CC[CH]CC(=O)O(4939)'],
    products = ['CC[CH]CC([O])O(1385)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['CH3(17)', 'C=CCC([O])O(4405)'],
    products = ['CC[CH]CC([O])O(1385)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['OH(5)', 'CC[CH]CC=O(1724)'],
    products = ['CC[CH]CC([O])O(1385)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction22',
    reactants = ['CH2(S)(23)', 'C[CH]CC([O])O(1403)'],
    products = ['CC[CH]CC([O])O(1385)'],
...
reaction(
    label = 'reaction27',
    reactants = ['[CH]CC(144)', '[CH2]C([O])O(3174)'],
    products = ['CC[CH]CC([O])O(1385)'],
