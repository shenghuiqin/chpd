...
species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.54026,'amu*angstrom^2'), symmetry=1, barrier=(35.4137,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.54029,'amu*angstrom^2'), symmetry=1, barrier=(35.4143,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.54025,'amu*angstrom^2'), symmetry=1, barrier=(35.4134,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (85.0813,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.53522,0.0587323,-6.73274e-05,4.39917e-08,-1.20961e-11,40759.1,20.1142], Tmin=(100,'K'), Tmax=(867.727,'K')), NASAPolynomial(coeffs=[8.28482,0.027618,-1.35407e-05,2.66727e-09,-1.90033e-13,39587.8,-11.491], Tmin=(867.727,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(338.185,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCt) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Ct-CtOs) + group(Ct-CtH) + radical(CCsJOOC)"""),
)

species(
    label = '[CH2]COO[C]=C(3204)',
    ...
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.68995,0.0549445,-5.71718e-05,3.54178e-08,-9.47644e-12,45053.6,26.7781], Tmin=(100,'K'), Tmax=(880.456,'K')), NASAPolynomial(coeffs=[7.26931,0.0295975,-1.399e-05,2.7219e-09,-1.92836e-13,44071.1,0.571149], Tmin=(880.456,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(373.935,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C=CJO) + radical(CJCOOH)"""),
)
...
species(
    ...
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.3316,0.0570618,-5.22953e-05,2.49259e-08,-4.82039e-12,38660.4,25.2167], Tmin=(100,'K'), Tmax=(1230.97,'K')), NASAPolynomial(coeffs=[12.1084,0.0220424,-9.62192e-06,1.81475e-09,-1.26646e-13,36007.2,-29.0148], Tmin=(1230.97,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(320.631,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CJCOOH) + radical(CCsJOOC)"""),
)

species(
    label = '[CH]=[C]OOCC(3207)',
    structure = SMILES('[CH]=[C]OOCC'),
    E0 = (407.068,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,1685,370,2750,2800,2850,1350,1500,750,1050,1375,1000,3120,650,792.5,1650,2750,2850,1437.5,1250,1305,750,350],'cm^-1')),
        HinderedRotor(inertia=(0.457955,'amu*angstrom^2'), symmetry=1, barrier=(13.5073,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.237791,'amu*angstrom^2'), symmetry=1, barrier=(7.01337,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.237771,'amu*angstrom^2'), symmetry=1, barrier=(7.01338,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.59891,'amu*angstrom^2'), symmetry=1, barrier=(47.1593,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.64902,0.0561347,-6.2053e-05,4.21099e-08,-1.23872e-11,49039.7,25.3327], Tmin=(100,'K'), Tmax=(805.434,'K')), NASAPolynomial(coeffs=[6.78047,0.0306544,-1.46069e-05,2.84425e-09,-2.0129e-13,48213,1.6859], Tmin=(805.434,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(407.068,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(Cds_P) + radical(C=CJO)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'C=[C]OOC=C(3202)'],
    products = ['C=[C]OO[CH]C(1085)'],
    transitionState = 'TS2',
...
reaction(
    ...
    products = ['C=[C]OO[CH]C(1085)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(7.46075e+06,'m^3/(mol*s)'), n=0.027223, Ea=(28.6273,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [Y_rad;Y_rad]
Euclidian distance = 0
