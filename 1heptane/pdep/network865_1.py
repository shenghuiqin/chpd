...
species(
    label = 'C=C(C[CH]O)CCCC(3751)',
    structure = SMILES('C=C(C[CH]O)CCCC'),
    E0 = (-105.312,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (127.204,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.73922,0.105569,-9.00598e-05,4.29934e-08,-8.67774e-12,-12496.7,37.5032], Tmin=(100,'K'), Tmax=(1154.45,'K')), NASAPolynomial(coeffs=[14.1461,0.0539938,-2.30467e-05,4.2949e-09,-2.97445e-13,-15933.6,-36.4476], Tmin=(1154.45,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-105.312,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(552.912,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(CCsJOH)"""),
)

species(
    label = '[CH2]C(C=CO)CCCC(3752)',
    ...
    molecularWeight = (127.204,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.22046,0.0974107,-4.20974e-05,-2.3385e-08,1.88952e-11,-14628.8,39.1884], Tmin=(100,'K'), Tmax=(948.401,'K')), NASAPolynomial(coeffs=[23.3622,0.0358829,-1.14532e-05,1.93799e-09,-1.33417e-13,-21187.4,-88.1007], Tmin=(948.401,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-123.325,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(552.912,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(Isobutyl)"""),
)
...
species(
    ...
    molecularWeight = (128.212,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.200107,0.0986889,-7.68484e-05,3.77077e-08,-8.60604e-12,3656.39,38.7441], Tmin=(100,'K'), Tmax=(976.518,'K')), NASAPolynomial(coeffs=[7.27046,0.0680886,-2.9845e-05,5.61925e-09,-3.91162e-13,2197.34,2.88027], Tmin=(976.518,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(29.1878,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(577.856,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Isobutyl) + radical(CCOJ)"""),
)

species(
    label = 'CCCC[C](C)C[CH]O(3754)',
    structure = SMILES('CCCC[C](C)C[CH]O'),
    E0 = (-35.8791,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.212,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.171028,0.100066,-4.16343e-05,-1.00848e-07,1.17918e-10,-4193.61,35.7082], Tmin=(100,'K'), Tmax=(482.188,'K')), NASAPolynomial(coeffs=[7.40023,0.0683539,-3.08872e-05,5.82909e-09,-4.03322e-13,-5219.28,2.69825], Tmin=(482.188,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-35.8791,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(573.699,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCsJOH) + radical(Tertalkyl)"""),
)

species(
    label = '[CH2]C([CH]CO)CCCC(3755)',
    structure = SMILES('[CH2]C([CH]CO)CCCC'),
    E0 = (3.38476,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1277.5,1000,1380,1390,370,380,2900,435,2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,3000,3100,440,815,1455,1000,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (128.212,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.83806,0.102064,-7.75766e-05,3.26445e-08,-5.77933e-12,584.651,42.647], Tmin=(100,'K'), Tmax=(1307.65,'K')), NASAPolynomial(coeffs=[15.3245,0.0526244,-2.08654e-05,3.73227e-09,-2.5187e-13,-3642.37,-39.6633], Tmin=(1307.65,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(3.38476,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(573.699,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Isobutyl) + radical(CCJCO)"""),
)

species(
    label = 'CCC[CH]C(C)C[CH]O(3756)',
    structure = SMILES('CCC[CH]C(C)C[CH]O'),
    E0 = (-26.7596,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.212,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.551417,0.106066,-9.07534e-05,4.60613e-08,-1.02981e-11,-3059.54,39.4645], Tmin=(100,'K'), Tmax=(1026.1,'K')), NASAPolynomial(coeffs=[10.4516,0.0631733,-2.80498e-05,5.3218e-09,-3.72221e-13,-5317.55,-13.902], Tmin=(1026.1,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-26.7596,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(573.699,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCsJOH) + radical(Cs_S)"""),
)

species(
    label = 'CCCCC(C)[CH][CH]O(3757)',
    structure = SMILES('CCCCC(C)[CH][CH]O'),
    E0 = (-21.3997,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.212,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.843664,0.105793,-8.46618e-05,3.74185e-08,-6.98205e-12,-2398.99,40.4356], Tmin=(100,'K'), Tmax=(1240.16,'K')), NASAPolynomial(coeffs=[14.9846,0.0547404,-2.29122e-05,4.22391e-09,-2.9042e-13,-6324.9,-39.3336], Tmin=(1240.16,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-21.3997,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(573.699,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJCO) + radical(CCsJOH)"""),
)

species(
    label = '[CH2][C](CCO)CCCC(3758)',
    structure = SMILES('[CH2][C](CCO)CCCC'),
    E0 = (-11.0946,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2761.11,2772.22,2783.33,2794.44,2805.56,2816.67,2827.78,2838.89,2850,1425,1431.25,1437.5,1443.75,1450,1225,1237.5,1250,1262.5,1275,1270,1287.5,1305,1322.5,1340,700,725,750,775,800,300,325,350,375,400,360,370,350,3615,1277.5,1000,3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (128.212,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.267884,0.0960719,-3.97005e-05,-8.25046e-08,9.48351e-11,-1214.11,37.5515], Tmin=(100,'K'), Tmax=(497.776,'K')), NASAPolynomial(coeffs=[6.94931,0.0675479,-2.95822e-05,5.51037e-09,-3.78975e-13,-2191.06,6.84664], Tmin=(497.776,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-11.0946,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(573.699,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Tertalkyl) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]C([CH]CCC)CCO(3759)',
    structure = SMILES('[CH2]C([CH]CCC)CCO'),
    E0 = (-1.97516,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1277.5,1000,1380,1390,370,380,2900,435,2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,3000,3100,440,815,1455,1000,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (128.212,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.436975,0.101181,-8.01756e-05,3.74374e-08,-7.70193e-12,-80.8619,41.2766], Tmin=(100,'K'), Tmax=(1105.74,'K')), NASAPolynomial(coeffs=[10.5755,0.0613435,-2.61343e-05,4.85531e-09,-3.3539e-13,-2516.26,-12.9592], Tmin=(1105.74,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1.97516,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(573.699,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Isobutyl) + radical(Cs_S)"""),
)

species(
    label = 'CC[CH]CC(C)C[CH]O(3760)',
    structure = SMILES('CC[CH]CC(C)C[CH]O'),
    E0 = (-26.8434,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.212,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.66943,0.109806,-0.000110086,7.24519e-08,-2.1235e-11,-3066.76,39.9011], Tmin=(100,'K'), Tmax=(801.724,'K')), NASAPolynomial(coeffs=[7.94143,0.0668426,-2.97008e-05,5.606e-09,-3.89892e-13,-4447.42,0.261924], Tmin=(801.724,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-26.8434,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(573.699,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCsJOH) + radical(RCCJCC)"""),
)

species(
    label = '[CH2]C(C[CH]CC)CCO(3761)',
    structure = SMILES('[CH2]C(C[CH]CC)CCO'),
    E0 = (-2.05899,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1277.5,1000,1380,1390,370,380,2900,435,2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,3000,3100,440,815,1455,1000,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (128.212,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.457519,0.103676,-9.47397e-05,5.70701e-08,-1.55e-11,-92.0989,41.3704], Tmin=(100,'K'), Tmax=(856.018,'K')), NASAPolynomial(coeffs=[7.67076,0.0656934,-2.81817e-05,5.23378e-09,-3.60921e-13,-1483.66,3.41993], Tmin=(856.018,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-2.05899,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(573.699,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Isobutyl) + radical(RCCJCC)"""),
)

species(
    label = 'C[CH]CCC(C)C[CH]O(3762)',
    structure = SMILES('C[CH]CCC(C)C[CH]O'),
    E0 = (-26.8555,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.212,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.654313,0.108719,-0.000102777,6.1287e-08,-1.61567e-11,-3067.87,40.0185], Tmin=(100,'K'), Tmax=(885.974,'K')), NASAPolynomial(coeffs=[9.07102,0.0648105,-2.84363e-05,5.34739e-09,-3.7166e-13,-4791.12,-5.72306], Tmin=(885.974,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-26.8555,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(573.699,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCsJOH) + radical(RCCJC)"""),
)

species(
    label = 'CCCCC(C)C[CH][O](3763)',
    structure = SMILES('CCCCC(C)C[CH][O]'),
    E0 = (4.40339,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (128.212,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.397915,0.104556,-9.08248e-05,5.0686e-08,-1.30416e-11,681.255,37.2307], Tmin=(100,'K'), Tmax=(884.444,'K')), NASAPolynomial(coeffs=[7.32247,0.0696397,-3.1609e-05,6.05165e-09,-4.25275e-13,-684.414,0.932225], Tmin=(884.444,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(4.40339,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(577.856,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCsJOH) + radical(CCOJ)"""),
)

species(
    label = '[CH2]C(CCO)CC[CH]C(3764)',
    structure = SMILES('[CH2]C(CCO)CC[CH]C'),
    E0 = (-2.07101,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1277.5,1000,1380,1390,370,380,2900,435,2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,3000,3100,440,815,1455,1000,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (128.212,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.481959,0.103113,-8.95401e-05,4.9063e-08,-1.1972e-11,-91.5695,41.6258], Tmin=(100,'K'), Tmax=(948.221,'K')), NASAPolynomial(coeffs=[8.92213,0.0634433,-2.67869e-05,4.94359e-09,-3.40018e-13,-1875.03,-3.24361], Tmin=(948.221,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-2.07101,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(573.699,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJC) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]CCCC(C)C[CH]O(3765)',
    structure = SMILES('[CH2]CCCC(C)C[CH]O'),
    E0 = (-16.0554,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1277.5,1000,1380,1390,370,380,2900,435,2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,3000,3100,440,815,1455,1000,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (128.212,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.816201,0.10943,-9.51712e-05,4.75742e-08,-1.01923e-11,-1760.53,39.6377], Tmin=(100,'K'), Tmax=(1084.91,'K')), NASAPolynomial(coeffs=[12.8439,0.0590665,-2.55386e-05,4.78597e-09,-3.32498e-13,-4724.55,-27.3778], Tmin=(1084.91,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-16.0554,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(573.699,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCsJOH) + radical(RCCJ)"""),
)

species(
    label = '[CH2]CCCC([CH2])CCO(3766)',
    structure = SMILES('[CH2]CCCC([CH2])CCO'),
    E0 = (8.72906,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (128.212,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.740909,0.104966,-8.58904e-05,4.04155e-08,-8.14225e-12,1219.91,41.593], Tmin=(100,'K'), Tmax=(1150.01,'K')), NASAPolynomial(coeffs=[12.9826,0.0572324,-2.36296e-05,4.32262e-09,-2.96029e-13,-1936.53,-26.5333], Tmin=(1150.01,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(8.72906,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(573.699,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Isobutyl) + radical(RCCJ)"""),
)

species(
    label = 'C=C(CCO)CCCC(3767)',
    structure = SMILES('C=C(CCO)CCCC'),
    E0 = (-285.61,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.212,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.784051,0.10057,-7.19108e-05,2.72969e-08,-4.3313e-12,-34175.4,38.1094], Tmin=(100,'K'), Tmax=(1439.31,'K')), NASAPolynomial(coeffs=[16.6759,0.0520471,-2.13413e-05,3.8737e-09,-2.62797e-13,-39201.4,-52.4827], Tmin=(1439.31,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-285.61,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(577.856,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH)"""),
)

species(
    label = 'CCCCC(C)C=CO(3768)',
    structure = SMILES('CCCCC(C)C=CO'),
    E0 = (-328.407,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.212,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.26113,0.0959984,-3.05867e-05,-3.45198e-08,2.18751e-11,-39291.2,37.5523], Tmin=(100,'K'), Tmax=(970.585,'K')), NASAPolynomial(coeffs=[23.6733,0.0390834,-1.34791e-05,2.39579e-09,-1.6881e-13,-46290.8,-93.1217], Tmin=(970.585,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-328.407,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(577.856,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH)"""),
)

species(
    label = 'CCCCC(C)CC=O(3769)',
    structure = SMILES('CCCCC(C)CC=O'),
    E0 = (-327.919,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.212,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.235353,0.0934482,-5.84425e-05,1.8676e-08,-2.5152e-12,-39288.5,35.5214], Tmin=(100,'K'), Tmax=(1613.91,'K')), NASAPolynomial(coeffs=[14.8422,0.0560793,-2.37112e-05,4.32939e-09,-2.92868e-13,-44155.3,-44.4361], Tmin=(1613.91,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-327.919,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(577.856,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdCsH)"""),
)
...
species(
    label = 'CCCCC[CH]C[CH]O(3770)',
    structure = SMILES('CCCCC[CH]C[CH]O'),
    E0 = (-24.4963,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.212,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0795418,0.100001,-5.47931e-05,-5.18702e-08,7.13864e-11,-2818.74,37.6719], Tmin=(100,'K'), Tmax=(510.487,'K')), NASAPolynomial(coeffs=[7.02644,0.068727,-3.09477e-05,5.85893e-09,-4.0741e-13,-3829.76,5.8725], Tmin=(510.487,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-24.4963,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(573.699,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(CCsJOH)"""),
)

species(
    label = 'CCCC[CH]CC[CH]O(1279)',
    structure = SMILES('CCCC[CH]CC[CH]O'),
    E0 = (-24.4963,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.212,'amu'),
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(C[CH]O)CCCC(1280)'],
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', '[CH2]C(CC=O)CCCC(3750)'],
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'C=C(C[CH]O)CCCC(3751)'],
    products = ['[CH2]C(C[CH]O)CCCC(1280)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', '[CH2]C(C=CO)CCCC(3752)'],
    products = ['[CH2]C(C[CH]O)CCCC(1280)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['butyl_1(82)', 'C=CC[CH]O(2463)'],
    products = ['[CH2]C(C[CH]O)CCCC(1280)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]C(CC[O])CCCC(3753)'],
    products = ['[CH2]C(C[CH]O)CCCC(1280)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]C([CH]CO)CCCC(3755)'],
    products = ['[CH2]C(C[CH]O)CCCC(1280)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]C(C[CH]O)CCCC(1280)'],
    products = ['CCC[CH]C(C)C[CH]O(3756)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]C([CH]CCC)CCO(3759)'],
    products = ['[CH2]C(C[CH]O)CCCC(1280)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]C(C[CH]O)CCCC(1280)'],
    products = ['CC[CH]CC(C)C[CH]O(3760)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]C(C[CH]CC)CCO(3761)'],
    products = ['[CH2]C(C[CH]O)CCCC(1280)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]C(C[CH]O)CCCC(1280)'],
    products = ['C[CH]CCC(C)C[CH]O(3762)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2]C(CCO)CC[CH]C(3764)'],
    products = ['[CH2]C(C[CH]O)CCCC(1280)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2]CCCC(C)C[CH]O(3765)'],
    products = ['[CH2]C(C[CH]O)CCCC(1280)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH2]CCCC([CH2])CCO(3766)'],
    products = ['[CH2]C(C[CH]O)CCCC(1280)'],
...
reaction(
    label = 'reaction26',
    reactants = ['CH2(S)(23)', '[CH2]C(C[CH]O)CCC(1290)'],
    products = ['[CH2]C(C[CH]O)CCCC(1280)'],
...
reaction(
    label = 'reaction31',
    reactants = ['CH2(19)', 'CCCC[CH]C[CH]O(1878)'],
    products = ['[CH2]C(C[CH]O)CCCC(1280)'],
...
reaction(
    label = 'reaction32',
    reactants = ['HCOH(T)(285)', '[CH2]C([CH2])CCCC(488)'],
    products = ['[CH2]C(C[CH]O)CCCC(1280)'],
