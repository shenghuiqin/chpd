...
species(
    label = 'C[CH]OC(C)=O(2467)',
    structure = SMILES('C[CH]OC(C)=O'),
    E0 = (-269.56,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2]COC(C)([O])OO(10344)',
    structure = SMILES('[CH2]COC(C)([O])OO'),
    E0 = (-145.183,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3615,1310,387.5,850,1000,3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,914.286,1028.57,1142.86,1257.14,1371.43,1485.71,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (120.104,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0073794,0.0991476,-0.000157391,1.44129e-07,-5.1831e-11,-17328.6,32.5876], Tmin=(100,'K'), Tmax=(834.327,'K')), NASAPolynomial(coeffs=[6.27883,0.0466688,-2.27484e-05,4.3471e-09,-2.99141e-13,-17595.1,8.14211], Tmin=(834.327,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-145.183,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsOsOsOs) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJCO) + radical(CCOJ)"""),
)

species(
    label = '[CH2]C(O)(OO)O[CH]C(10345)',
    structure = SMILES('[CH2]C(O)(OO)O[CH]C'),
    E0 = (-188.058,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (120.104,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.550441,0.106149,-0.000156234,1.23503e-07,-3.87325e-11,-22460.1,34.5405], Tmin=(100,'K'), Tmax=(826.102,'K')), NASAPolynomial(coeffs=[13.6747,0.032759,-1.47823e-05,2.74026e-09,-1.85918e-13,-24656.4,-30.4384], Tmin=(826.102,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-188.058,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(353.365,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsOsOsOs) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCsJOCs) + radical(CJCOOH)"""),
)

species(
    label = 'C[CH]OC(C)(O)O[O](10346)',
    ...
    molecularWeight = (120.104,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.23483,0.100026,-0.00014856,1.21401e-07,-3.91636e-11,-29924.1,32.1697], Tmin=(100,'K'), Tmax=(857.401,'K')), NASAPolynomial(coeffs=[11.3158,0.0350456,-1.54693e-05,2.82597e-09,-1.89482e-13,-31497,-19.4004], Tmin=(857.401,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-250.016,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsOsOsOs) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(CCsJOCs)"""),
)

species(
    label = '[CH2]C([O])(OO)OCC(10347)',
    structure = SMILES('[CH2]C([O])(OO)OCC'),
    E0 = (-142.809,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3615,1310,387.5,850,1000,3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,914.286,1028.57,1142.86,1257.14,1371.43,1485.71,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (120.104,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0936621,0.0966835,-0.000150813,1.37563e-07,-4.95676e-11,-17045.7,33.6395], Tmin=(100,'K'), Tmax=(829.429,'K')), NASAPolynomial(coeffs=[6.15943,0.0466309,-2.26784e-05,4.338e-09,-2.99028e-13,-17336.5,9.82306], Tmin=(829.429,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-142.809,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsOsOsOs) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(CJCOOH)"""),
)

species(
    label = '[CH2][CH]OC(C)(O)OO(10348)',
    ...
    molecularWeight = (120.104,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.645009,0.108722,-0.000163246,1.30725e-07,-4.13241e-11,-22742.6,33.5177], Tmin=(100,'K'), Tmax=(837.852,'K')), NASAPolynomial(coeffs=[13.81,0.0327683,-1.4835e-05,2.74516e-09,-1.85673e-13,-24921.1,-32.2074], Tmin=(837.852,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-190.432,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(353.365,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsOsOsOs) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJCO) + radical(CCsJOCs)"""),
)

species(
    label = 'CCOC(C)([O])O[O](10349)',
    ...
    molecularWeight = (120.104,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.428318,0.0903107,-0.000142134,1.33932e-07,-4.92279e-11,-24510.5,31.2019], Tmin=(100,'K'), Tmax=(844.52,'K')), NASAPolynomial(coeffs=[3.76926,0.0489742,-2.33997e-05,4.43205e-09,-3.03302e-13,-24165,21.0347], Tmin=(844.52,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-204.767,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsOsOsOs) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(CCOJ)"""),
)
...
species(
    ...
    molecularWeight = (120.104,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.826619,0.0919503,-9.49825e-05,4.82235e-08,-9.40013e-12,-59302.1,31.7909], Tmin=(100,'K'), Tmax=(1321.36,'K')), NASAPolynomial(coeffs=[23.2279,0.0157536,-4.64843e-06,7.11787e-10,-4.47666e-14,-65364,-89.845], Tmin=(1321.36,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-494.611,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsOsOsOs) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH)"""),
)
...
species(
    label = 'C[CH]OC([O])OO(10351)',
    structure = SMILES('C[CH]OC([O])OO'),
    E0 = (-138.147,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.874454,0.0873957,-0.000171707,1.8352e-07,-7.24245e-11,-16520.8,26.7547], Tmin=(100,'K'), Tmax=(839.864,'K')), NASAPolynomial(coeffs=[-1.22848,0.0522316,-2.82123e-05,5.56578e-09,-3.87544e-13,-14574.1,46.0193], Tmin=(839.864,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-138.147,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(286.849,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsOsHH) + group(Cs-OsOsOsH) + group(Cs-CsHHH) + radical(CCsJOCs) + radical(OCOJ)"""),
)
...
species(
    label = 'C[CH]OC1(C)OO1(10352)',
    structure = SMILES('C[CH]OC1(C)OO1'),
    E0 = (-79.3148,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (103.097,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.11119,0.069873,-6.60908e-05,3.20625e-08,-5.93093e-12,-9385.97,26.9594], Tmin=(100,'K'), Tmax=(1506.62,'K')), NASAPolynomial(coeffs=[17.1473,0.0157196,-3.29114e-06,3.42965e-10,-1.52601e-14,-13506.6,-58.8515], Tmin=(1506.62,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-79.3148,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsOsOsOs) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(dioxirane) + radical(CCsJOCs)"""),
)

species(
    label = 'CC1OC(C)([O])O1(10353)',
    ...
    molecularWeight = (103.097,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.72064,0.0435309,-1.22323e-05,-6.20729e-09,3.01733e-12,-33558.2,23.0766], Tmin=(100,'K'), Tmax=(1314.35,'K')), NASAPolynomial(coeffs=[10.3236,0.0311558,-1.3866e-05,2.61354e-09,-1.80641e-13,-37012.2,-25.3158], Tmin=(1314.35,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-279.745,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(324.264,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsOsOs) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Cyclobutane) + radical(CCOJ)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'C=COC(C)([O])OO(10342)'],
    products = ['C[CH]OC(C)([O])OO(8873)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['CH3(17)', 'C[CH]OC(=O)OO(10343)'],
    products = ['C[CH]OC(C)([O])OO(8873)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['HO2(10)', 'C[CH]OC(C)=O(2467)'],
    products = ['C[CH]OC(C)([O])OO(8873)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2]COC(C)([O])OO(10344)'],
    products = ['C[CH]OC(C)([O])OO(8873)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['C[CH]OC(C)([O])OO(8873)'],
    products = ['[CH2]C(O)(OO)O[CH]C(10345)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['C[CH]OC(C)([O])OO(8873)'],
    products = ['C[CH]OC(C)(O)O[O](10346)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]C([O])(OO)OCC(10347)'],
    products = ['C[CH]OC(C)([O])OO(8873)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['C[CH]OC(C)([O])OO(8873)'],
    products = ['[CH2][CH]OC(C)(O)OO(10348)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CH2(S)(23)', 'C[CH]OC([O])OO(10351)'],
    products = ['C[CH]OC(C)([O])OO(8873)'],
...
reaction(
    label = 'reaction15',
    reactants = ['C[CH]OC(C)([O])OO(8873)'],
    products = ['OH(5)', 'C[CH]OC1(C)OO1(10352)'],
...
reaction(
    label = 'reaction16',
    reactants = ['C[CH]OC(C)([O])OO(8873)'],
    products = ['OH(5)', 'CC1OC(C)([O])O1(10353)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CHCH3(T)(95)', 'CC([O])([O])OO(5655)'],
    products = ['C[CH]OC(C)([O])OO(8873)'],
