species(
    label = 'CCC(CCO[O])OO(31615)',
    structure = SMILES('CCC(CCO[O])OO'),
    E0 = (-205.367,'kJ/mol'),
    modes = [
...
species(
    label = 'CCC(C[CH]OO)OO(31619)',
    structure = SMILES('CCC(C[CH]OO)OO'),
    E0 = (-168.79,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (135.138,'amu'),
...
species(
    label = 'CCC([CH]COO)OO(31620)',
    structure = SMILES('CCC([CH]COO)OO'),
    E0 = (-156.957,'kJ/mol'),
    modes = [
...
species(
    label = 'C[CH]C(CCOO)OO(31622)',
    structure = SMILES('C[CH]C(CCOO)OO'),
    E0 = (-156.957,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (135.138,'amu'),
...
species(
    label = 'CCC(CCOO)O[O](31623)',
    structure = SMILES('CCC(CCOO)O[O]'),
    E0 = (-205.367,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2800,2850,1350,1500,750,1050,1375,1000,1380,1390,370,380,2900,435,3615,1310,387.5,850,1000,492.5,1135,1000,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2]CC(CCOO)OO(28416)',
    structure = SMILES('[CH2]CC(CCOO)OO'),
    E0 = (-152.126,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (135.138,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.622409,0.1091,-0.000123844,8.02189e-08,-2.1756e-11,-18136.5,36.8376], Tmin=(100,'K'), Tmax=(881.718,'K')), NASAPolynomial(coeffs=[12.3278,0.0503497,-2.38974e-05,4.64904e-09,-3.29077e-13,-20420.1,-24.0094], Tmin=(881.718,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-152.126,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(448.981,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(RCCJ)"""),
)
...
species(
    label = 'CCC(CCO[O])O[O](31624)',
    structure = SMILES('CCC(CCO[O])O[O]'),
    E0 = (-53.3628,'kJ/mol'),
    modes = [
...
species(
    label = 'CC[C](CCO[O])OO(31625)',
    structure = SMILES('CC[C](CCO[O])OO'),
    E0 = (-18.4684,'kJ/mol'),
    modes = [
...
species(
    label = 'CCC([CH]CO[O])OO(31626)',
    structure = SMILES('CCC([CH]CO[O])OO'),
    E0 = (-4.95253,'kJ/mol'),
    modes = [
...
species(
    label = 'C[CH]C(CCO[O])OO(31627)',
    structure = SMILES('C[CH]C(CCO[O])OO'),
    E0 = (-4.95253,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,1380,1390,370,380,2900,435,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,492.5,1135,1000,3615,1310,387.5,850,1000,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'CCC(C[CH]O[O])OO(31628)',
    structure = SMILES('CCC(C[CH]O[O])OO'),
    E0 = (-16.785,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,1380,1390,370,380,2900,435,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,492.5,1135,1000,3615,1310,387.5,850,1000,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'CCC1CCOOO1(31629)',
    structure = SMILES('CCC1CCOOO1'),
    E0 = (-155.831,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (118.131,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.468906,0.0620526,4.14397e-06,-5.82522e-08,3.05185e-11,-18600.4,23.0402], Tmin=(100,'K'), Tmax=(903.882,'K')), NASAPolynomial(coeffs=[18.0287,0.0263499,-6.31571e-06,8.76684e-10,-5.60462e-14,-23490.7,-69.3929], Tmin=(903.882,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-155.831,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(424.038,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(123trioxane)"""),
)
...
species(
    label = 'CCC(CC[O])OO(31630)',
    structure = SMILES('CCC(CC[O])OO'),
    E0 = (-203.172,'kJ/mol'),
    modes = [
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.699478,0.0831625,-6.37459e-05,-1.37939e-09,2.79604e-11,-24327.4,30.4978], Tmin=(100,'K'), Tmax=(532.021,'K')), NASAPolynomial(coeffs=[6.5396,0.0544948,-2.58908e-05,5.03227e-09,-3.55639e-13,-25164.5,3.981], Tmin=(532.021,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-203.172,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCOJ)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['O2(2)', '[CH2]CC(CC)OO(2965)'],
    products = ['CCC(CCO[O])OO(31615)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['CCC(CCO[O])OO(31615)'],
    products = ['CCC(C[CH]OO)OO(31619)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction8',
    reactants = ['OH(5)', 'CCC([O])CCO[O](16376)'],
    products = ['CCC(CCO[O])OO(31615)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['CC[CH]CCO[O](279)', 'HO2(10)'],
    products = ['CCC(CCO[O])OO(31615)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(3)', 'CCC(CCO[O])O[O](31624)'],
    products = ['CCC(CCO[O])OO(31615)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CC[CH]OO(288)', '[CH2]CO[O](98)'],
    products = ['CCC(CCO[O])OO(31615)'],
...
reaction(
    label = 'reaction12',
    reactants = ['C2H5(29)', '[O]OCC[CH]OO(25608)'],
    products = ['CCC(CCO[O])OO(31615)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(3)', 'CC[C](CCO[O])OO(31625)'],
    products = ['CCC(CCO[O])OO(31615)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]O[O](92)', '[CH2]C(CC)OO(715)'],
    products = ['CCC(CCO[O])OO(31615)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(3)', 'CCC([CH]CO[O])OO(31626)'],
    products = ['CCC(CCO[O])OO(31615)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CH3(17)', '[CH2]C(CCO[O])OO(25610)'],
    products = ['CCC(CCO[O])OO(31615)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(3)', 'C[CH]C(CCO[O])OO(31627)'],
    products = ['CCC(CCO[O])OO(31615)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(3)', 'CCC(C[CH]O[O])OO(31628)'],
    products = ['CCC(CCO[O])OO(31615)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(3)', '[CH2]CC(CCO[O])OO(25612)'],
    products = ['CCC(CCO[O])OO(31615)'],
...
reaction(
    label = 'reaction20',
    reactants = ['CH2(S)(23)', 'CC(CCO[O])OO(601)'],
    products = ['CCC(CCO[O])OO(31615)'],
...
reaction(
    label = 'reaction21',
    reactants = ['CCC(CCO[O])OO(31615)'],
    products = ['OH(5)', 'CCC1CCOOO1(31629)'],
...
reaction(
    label = 'reaction22',
    reactants = ['CCC(CCO[O])OO(31615)'],
    products = ['HO2(10)', 'C=CC(CC)OO(31603)'],
...
reaction(
    label = 'reaction23',
    reactants = ['O(4)', 'CCC(CC[O])OO(31630)'],
    products = ['CCC(CCO[O])OO(31615)'],
