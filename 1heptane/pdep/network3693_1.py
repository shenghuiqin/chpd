...
species(
    label = '[CH2]C1[CH]COC1CC(20850)',
    structure = SMILES('[CH2]C1[CH]COC1CC'),
    E0 = (113.397,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.0635,0.0450299,5.76576e-05,-1.11284e-07,4.89425e-11,13762.6,27.7533], Tmin=(100,'K'), Tmax=(899.684,'K')), NASAPolynomial(coeffs=[15.6191,0.0321818,-7.39536e-06,9.97374e-10,-6.33497e-14,9044.4,-52.5962], Tmin=(899.684,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(113.397,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(469.768,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Tetrahydrofuran) + radical(Isobutyl) + radical(CCJCO)"""),
)
...
species(
    label = 'C=C[CH]COC=CC(20855)',
    structure = SMILES('C=C[CH]COC=CC'),
    E0 = (-24.3941,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2950,3100,1380,975,1025,1650,2995,3010,3025,975,987.5,1000,1300,1337.5,1375,400,450,500,1630,1655,1680,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    ...
    molecularWeight = (111.162,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.837919,0.0872358,-3.91109e-05,-2.91102e-08,2.24769e-11,4571.15,30.4018], Tmin=(100,'K'), Tmax=(937.502,'K')), NASAPolynomial(coeffs=[26.8613,0.0171577,-3.95353e-06,6.21422e-10,-4.68176e-14,-2736.45,-112.718], Tmin=(937.502,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(36.4121,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CCsJOC(O))"""),
)

species(
    label = 'C=C=CCO[CH]CC(20857)',
    structure = SMILES('C=C=CCO[CH]CC'),
    E0 = (133.44,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([540,610,2055,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,2750,2800,2850,1350,1500,750,1050,1375,1000,2950,3100,1380,975,1025,1650,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (111.162,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.170595,0.087301,-8.10883e-05,4.2717e-08,-9.51818e-12,16184.5,30.3928], Tmin=(100,'K'), Tmax=(1054.44,'K')), NASAPolynomial(coeffs=[11.6216,0.0438613,-1.9292e-05,3.6459e-09,-2.54575e-13,13769.7,-25.4585], Tmin=(1054.44,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(133.44,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(CCsJOCs)"""),
)
...
species(
    label = 'C=C[CH]COC[CH]C(20858)',
    structure = SMILES('C=C[CH]COC[CH]C'),
    E0 = (99.8874,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2950,3100,1380,975,1025,1650,3010,987.5,1337.5,450,1655,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3050,390,425,1340,1360,335,370,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0951698,0.0847532,-6.21044e-05,2.34548e-08,-3.64568e-12,12165.1,32.5908], Tmin=(100,'K'), Tmax=(1482.64,'K')), NASAPolynomial(coeffs=[16.5082,0.0399591,-1.6786e-05,3.07743e-09,-2.09705e-13,7241.69,-54.0499], Tmin=(1482.64,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(99.8874,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(C=CCJCO) + radical(CCJCO)"""),
)

species(
    label = 'C=CC[CH]O[CH]CC(20832)',
    structure = SMILES('C=CC[CH]O[CH]CC'),
    E0 = (143.981,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2950,3100,1380,975,1025,1650,3000,3050,390,425,1340,1360,335,370,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.537068,0.0984761,-9.62327e-05,5.08263e-08,-1.09189e-11,17481.4,33.373], Tmin=(100,'K'), Tmax=(1117.2,'K')), NASAPolynomial(coeffs=[16.1564,0.0387058,-1.59807e-05,2.93649e-09,-2.02183e-13,13751.5,-49.0131], Tmin=(1117.2,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(143.981,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CCsJOCs) + radical(CCsJOCs)"""),
)

species(
    label = 'C=[C]CCO[CH]CC(20859)',
    structure = SMILES('C=[C]CCO[CH]CC'),
    E0 = (201.366,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0413091,0.0932137,-9.12182e-05,5.17742e-08,-1.24723e-11,24360.7,32.6336], Tmin=(100,'K'), Tmax=(980.156,'K')), NASAPolynomial(coeffs=[11.2151,0.0472767,-2.09179e-05,3.95872e-09,-2.76484e-13,22154.1,-21.4466], Tmin=(980.156,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(201.366,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_S) + radical(CCsJOCs)"""),
)

species(
    label = 'C=C[CH][CH]OCCC(20860)',
    structure = SMILES('[CH2]C=C[CH]OCCC'),
    E0 = (38.8186,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.786304,0.0744652,-4.58044e-05,1.41291e-08,-1.84426e-12,4780.01,30.8678], Tmin=(100,'K'), Tmax=(1625.6,'K')), NASAPolynomial(coeffs=[11.8391,0.0472688,-2.07097e-05,3.83783e-09,-2.61588e-13,1186.48,-27.8259], Tmin=(1625.6,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(38.8186,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(C=CCJ(O)C) + radical(Allyl_P)"""),
)

species(
    label = '[CH2]CCOC[CH]C=C(20861)',
    structure = SMILES('[CH2]CCOC[CH]C=C'),
    E0 = (105.232,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2950,3100,1380,975,1025,1650,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,3025,407.5,1350,352.5,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.10218,0.0866167,-6.7401e-05,2.80735e-08,-4.9415e-12,12795.7,31.1673], Tmin=(100,'K'), Tmax=(1297.35,'K')), NASAPolynomial(coeffs=[13.3529,0.0457622,-2.01651e-05,3.80062e-09,-2.64125e-13,9357.52,-36.2093], Tmin=(1297.35,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(105.232,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(RCCJ) + radical(C=CCJCO)"""),
)

species(
    label = '[CH]=CCCO[CH]CC(20862)',
    structure = SMILES('[CH]=CCCO[CH]CC'),
    E0 = (210.621,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3010,987.5,1337.5,450,1655,3120,650,792.5,1650,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.145384,0.0929922,-8.65311e-05,4.48684e-08,-9.72138e-12,25479.6,32.9285], Tmin=(100,'K'), Tmax=(1089.96,'K')), NASAPolynomial(coeffs=[13.2255,0.0439234,-1.90035e-05,3.56602e-09,-2.48104e-13,22564.8,-32.7301], Tmin=(1089.96,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(210.621,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_P) + radical(CCsJOCs)"""),
)

species(
    label = 'C=CCCO[CH][CH]C(20863)',
    ...
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.111527,0.0871038,-7.1482e-05,3.14591e-08,-5.71942e-12,19806.3,34.8929], Tmin=(100,'K'), Tmax=(1289.83,'K')), NASAPolynomial(coeffs=[15.1448,0.0397906,-1.64589e-05,3.01933e-09,-2.07063e-13,15870.7,-42.5931], Tmin=(1289.83,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(163.427,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CCJCO) + radical(CCsJOCs)"""),
)

species(
    label = 'C=[C][CH]COCCC(20864)',
    ...
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.177489,0.0886279,-7.47648e-05,3.56386e-08,-7.3577e-12,16710.6,29.5958], Tmin=(100,'K'), Tmax=(1109.55,'K')), NASAPolynomial(coeffs=[10.8683,0.0500874,-2.26627e-05,4.33385e-09,-3.04324e-13,14338.1,-23.0926], Tmin=(1109.55,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(137.827,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(C=CCJCO) + radical(Cds_S)"""),
)

species(
    label = '[CH]=C[CH]COCCC(20865)',
    structure = SMILES('[CH]C=CCOCCC'),
    E0 = (147.065,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.612701,0.0788241,-4.7678e-05,1.47506e-08,-1.96861e-12,17804.9,31.3829], Tmin=(100,'K'), Tmax=(1563.84,'K')), NASAPolynomial(coeffs=[10.6624,0.0531189,-2.30219e-05,4.23958e-09,-2.88283e-13,14661.7,-21.5945], Tmin=(1563.84,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(147.065,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[CH2]C[CH]OCCC=C(20866)',
    structure = SMILES('[CH2]C[CH]OCCC=C'),
    E0 = (168.771,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2950,3100,1380,975,1025,1650,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,3025,407.5,1350,352.5,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0289683,0.0901642,-8.02837e-05,3.97744e-08,-8.27939e-12,20442.2,33.8921], Tmin=(100,'K'), Tmax=(1126.54,'K')), NASAPolynomial(coeffs=[12.9041,0.0442433,-1.91403e-05,3.59127e-09,-2.49767e-13,17528.3,-30.0436], Tmin=(1126.54,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(168.771,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CCsJOCs) + radical(RCCJ)"""),
)
...
species(
    label = 'CC[CH]OCC1[CH]C1(20867)',
    structure = SMILES('CC[CH]OCC1[CH]C1'),
    E0 = (215.21,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.218389,0.0814757,-5.78429e-05,2.10854e-08,-3.11809e-12,26045,33.9475], Tmin=(100,'K'), Tmax=(1580.69,'K')), NASAPolynomial(coeffs=[18.2723,0.0346842,-1.344e-05,2.35821e-09,-1.56216e-13,20199.4,-63.7255], Tmin=(1580.69,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(215.21,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(CCsJOCs) + radical(cyclopropane)"""),
)
...
species(
    ...
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.477111,0.0779209,-1.25474e-05,-5.12845e-08,2.86726e-11,-18764.8,29.6328], Tmin=(100,'K'), Tmax=(947.284,'K')), NASAPolynomial(coeffs=[24.4097,0.0235516,-6.76474e-06,1.16512e-09,-8.5675e-14,-25755.3,-101.095], Tmin=(947.284,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-157.515,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsOsH) + group(Cds-CdsHH)"""),
)

species(
    label = 'C=CCCOC=CC(20870)',
...
species(
    label = 'C=C=CCOCCC(20871)',
    structure = SMILES('C=C=CCOCCC'),
    E0 = (-47.0155,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.626609,0.0786063,-5.65802e-05,2.25314e-08,-3.95804e-12,-5537.21,29.2987], Tmin=(100,'K'), Tmax=(1250.14,'K')), NASAPolynomial(coeffs=[9.5794,0.0499607,-2.22093e-05,4.20241e-09,-2.92653e-13,-7775.67,-15.8921], Tmin=(1250.14,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-47.0155,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cdd-CdsCds)"""),
)
...
species(
    label = 'C=C[CH]CO[CH]C(18951)',
    structure = SMILES('C=C[CH]CO[CH]C'),
    E0 = (104.222,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2950,3100,1380,975,1025,1650,3010,987.5,1337.5,450,1655,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3050,390,425,1340,1360,335,370,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2]C(C)OC[CH]C=C(20872)',
    structure = SMILES('[CH2]C(C)OC[CH]C=C'),
    E0 = (99.9445,'kJ/mol'),
    modes = [
...
species(
    ...
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.802032,0.0524122,3.6796e-05,-8.7976e-08,3.96239e-11,-10003.9,27.1206], Tmin=(100,'K'), Tmax=(914.284,'K')), NASAPolynomial(coeffs=[15.749,0.0337221,-9.16273e-06,1.40624e-09,-9.36761e-14,-14689.1,-54.3257], Tmin=(914.284,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-84.273,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(469.768,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Oxetane)"""),
)
...
species(
    label = '[CH2][CH]C1COC1CC(20873)',
    structure = SMILES('[CH2][CH]C1COC1CC'),
    E0 = (186.664,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.717157,0.0600807,3.41388e-06,-4.48832e-08,2.19799e-11,22579.7,31.2578], Tmin=(100,'K'), Tmax=(930.695,'K')), NASAPolynomial(coeffs=[12.6028,0.039603,-1.29088e-05,2.14201e-09,-1.42872e-13,19041.9,-32.351], Tmin=(930.695,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(186.664,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(465.61,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Oxetane) + radical(Cs_S) + radical(RCCJ)"""),
)
...
species(
    label = '[CH]=CCO[CH]CC(20881)',
    structure = SMILES('[CH]=CCO[CH]CC'),
    E0 = (239.958,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3010,987.5,1337.5,450,1655,3120,650,792.5,1650,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.621147,0.0766093,-7.17765e-05,3.81491e-08,-8.54216e-12,28980,28.3172], Tmin=(100,'K'), Tmax=(1052.75,'K')), NASAPolynomial(coeffs=[10.8497,0.037745,-1.64007e-05,3.08143e-09,-2.14469e-13,26826.4,-21.5552], Tmin=(1052.75,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(239.958,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_P) + radical(CCsJOCs)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['C=C[CH]CO[CH]CC(20588)'],
...
reaction(
    label = 'reaction2',
    reactants = ['C=C[CH]CO[CH]CC(20588)'],
    products = ['[CH2]C1[CH]COC1CC(20850)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'C=C[CH]COC=CC(20855)'],
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', 'C=CC=CO[CH]CC(20856)'],
    products = ['C=C[CH]CO[CH]CC(20588)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)', 'C=C=CCO[CH]CC(20857)'],
    products = ['C=C[CH]CO[CH]CC(20588)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['CH3(17)', 'C=C[CH]COC=C(19540)'],
    products = ['C=C[CH]CO[CH]CC(20588)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['C=C[CH]COC[CH]C(20858)'],
    products = ['C=C[CH]CO[CH]CC(20588)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['C=CC[CH]O[CH]CC(20832)'],
    products = ['C=C[CH]CO[CH]CC(20588)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]CCOC[CH]C=C(20861)'],
    products = ['C=C[CH]CO[CH]CC(20588)'],
...
reaction(
    label = 'reaction14',
    reactants = ['C=CCCO[CH][CH]C(20863)'],
    products = ['C=C[CH]CO[CH]CC(20588)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]C[CH]OCCC=C(20866)'],
    products = ['C=C[CH]CO[CH]CC(20588)'],
...
reaction(
    label = 'reaction19',
    reactants = ['C=C[CH]CO[CH]CC(20588)'],
    products = ['CC[CH]OCC1[CH]C1(20867)'],
...
reaction(
    label = 'reaction24',
    reactants = ['CH2(S)(23)', 'C=C[CH]CO[CH]C(18951)'],
    products = ['C=C[CH]CO[CH]CC(20588)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[CH2]C(C)OC[CH]C=C(20872)'],
    products = ['C=C[CH]CO[CH]CC(20588)'],
...
reaction(
    label = 'reaction27',
    reactants = ['[CH]CC(144)', 'C=C[CH]C[O](19517)'],
    products = ['C=C[CH]CO[CH]CC(20588)'],
...
reaction(
    label = 'reaction28',
    reactants = ['[CH2]O[CH]CC(1682)', '[CH]=C[CH2](2461)'],
    products = ['C=C[CH]CO[CH]CC(20588)'],
...
reaction(
    label = 'reaction29',
    reactants = ['C=C[CH]CO[CH]CC(20588)'],
    products = ['[CH2][CH]C1COC1CC(20873)'],
...
reaction(
    label = 'reaction34',
    reactants = ['C[CH][CH]OCC=CC(20878)'],
    products = ['C=C[CH]CO[CH]CC(20588)'],
...
reaction(
    label = 'reaction35',
    reactants = ['[CH2]C[CH]OCC=CC(20879)'],
    products = ['C=C[CH]CO[CH]CC(20588)'],
...
reaction(
    label = 'reaction38',
    reactants = ['CH2(19)', '[CH]=CCO[CH]CC(20881)'],
    products = ['C=C[CH]CO[CH]CC(20588)'],
