...
species(
    label = '[CH]=COC=CC(11158)',
    structure = SMILES('[CH]=COC=CC'),
    E0 = (180.884,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3010,3025,975,987.5,1000,1300,1337.5,1375,400,450,500,1630,1655,1680,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.888461,'amu*angstrom^2'), symmetry=1, barrier=(20.4275,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.887532,'amu*angstrom^2'), symmetry=1, barrier=(20.4061,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.889784,'amu*angstrom^2'), symmetry=1, barrier=(20.4579,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (83.1085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.26708,0.0490847,-1.48468e-05,-2.1573e-08,1.34879e-11,21863.8,23.0574], Tmin=(100,'K'), Tmax=(954.246,'K')), NASAPolynomial(coeffs=[15.4566,0.0162504,-5.11838e-06,8.92209e-10,-6.38523e-14,17942.5,-51.091], Tmin=(954.246,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(180.884,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(Cds_P)"""),
)
...
species(
    label = '[CH]=COCC[CH2](11160)',
    structure = SMILES('[CH]=COCC[CH2]'),
    E0 = (243.055,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3120,650,792.5,1650,3000,3100,440,815,1455,1000,3010,987.5,1337.5,450,1655,376.226,376.226,376.23],'cm^-1')),
        HinderedRotor(inertia=(0.176355,'amu*angstrom^2'), symmetry=1, barrier=(17.7141,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.176355,'amu*angstrom^2'), symmetry=1, barrier=(17.7141,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.176352,'amu*angstrom^2'), symmetry=1, barrier=(17.7141,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.176355,'amu*angstrom^2'), symmetry=1, barrier=(17.7142,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.791236,0.0575832,-2.14184e-05,-2.30229e-08,1.57523e-11,29360.2,24.6349], Tmin=(100,'K'), Tmax=(944.272,'K')), NASAPolynomial(coeffs=[18.5283,0.0145361,-4.00979e-06,6.73865e-10,-4.92784e-14,24579.9,-67.494], Tmin=(944.272,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(243.055,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(RCCJ) + radical(Cds_P)"""),
)
...
species(
    label = '[CH2]C[CH]OC=C(11161)',
    structure = SMILES('[CH2]C[CH]OC=C'),
    E0 = (189.887,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.501761,0.0634043,-3.1426e-05,-1.81003e-08,1.5418e-11,22976.5,24.7446], Tmin=(100,'K'), Tmax=(934.026,'K')), NASAPolynomial(coeffs=[20.7469,0.0109627,-2.22555e-06,3.27271e-10,-2.51512e-14,17700.2,-79.5445], Tmin=(934.026,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(189.887,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CCsJOC(O)) + radical(RCCJ)"""),
)
...
species(
    label = '[CH]=CO[CH]C(1161)',
    structure = SMILES('[CH]=CO[CH]C'),
    E0 = (255.517,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,3120,650,792.5,1650,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.959477,'amu*angstrom^2'), symmetry=1, barrier=(22.0603,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.962641,'amu*angstrom^2'), symmetry=1, barrier=(22.133,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.962589,'amu*angstrom^2'), symmetry=1, barrier=(22.1318,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', '[CH]=COC=CC(11158)'],
    products = ['[CH]=CO[CH]CC(10715)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'C#CO[CH]CC(11159)'],
    products = ['[CH]=CO[CH]CC(10715)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['CH3(17)', '[CH]=COC=C(4301)'],
    products = ['[CH]=CO[CH]CC(10715)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction14',
    reactants = ['CH2(S)(23)', '[CH]=CO[CH]C(1161)'],
    products = ['[CH]=CO[CH]CC(10715)'],
