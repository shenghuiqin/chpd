...
species(
    label = 'CCC([O])C1(CC)OCC1=O(15062)',
    structure = SMILES('CCC([O])C1(CC)OCC1=O'),
    E0 = (-271.924,'kJ/mol'),
    modes = [
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.69044,0.108509,-7.04304e-05,1.20855e-08,3.35071e-12,-32485.8,39.8646], Tmin=(100,'K'), Tmax=(1074.33,'K')), NASAPolynomial(coeffs=[23.6919,0.0420577,-1.68172e-05,3.12154e-09,-2.19207e-13,-39558.6,-91.945], Tmin=(1074.33,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-271.924,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(561.227,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-(Cds-O2d)CsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)OsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdCsCs) + ring(Cyclobutane) + radical(CC(C)OJ)"""),
)

species(
    label = 'CCC(=O)C1(CC)OC[C]1O(15063)',
    structure = SMILES('CCC(=O)C1(CC)OC[C]1O'),
    E0 = (-346.771,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (157.187,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.88545,0.127796,-0.000140659,8.75462e-08,-2.19457e-11,-41493.7,39.1616], Tmin=(100,'K'), Tmax=(973.209,'K')), NASAPolynomial(coeffs=[17.6417,0.0475401,-1.69646e-05,2.81576e-09,-1.80624e-13,-45294.6,-54.5158], Tmin=(973.209,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-346.771,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(557.07,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-(Cds-O2d)CsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdCsCs) + ring(Oxetane) + radical(C2CsJOH)"""),
)

species(
    label = 'CCC([O])C1(CC)OC=C1O(15064)',
    structure = SMILES('CCC([O])C1(CC)OC=C1O'),
    E0 = (-314.326,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,2950,1000,3615,1277.5,1000,1380,1390,370,380,2900,435,300,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (157.187,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.2771,0.106606,-1.6992e-05,-8.21846e-08,4.72371e-11,-37549.6,39.7923], Tmin=(100,'K'), Tmax=(929.392,'K')), NASAPolynomial(coeffs=[37.4046,0.0164515,-1.62284e-06,1.39226e-10,-1.74929e-14,-48408,-167.478], Tmin=(929.392,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-314.326,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(557.07,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + ring(Cyclobutene) + radical(CC(C)OJ)"""),
)
...
species(
    label = 'CCC([O])C1OCC=1O(15065)',
    structure = SMILES('CCC([O])C1OCC=1O'),
    E0 = (-240.402,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,2750,3150,900,1100,3615,1277.5,1000,1380,1390,370,380,2900,435,300,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.425861,0.0726277,1.05166e-06,-7.18825e-08,3.77492e-11,-28731.7,32.2243], Tmin=(100,'K'), Tmax=(941.338,'K')), NASAPolynomial(coeffs=[28.3342,0.0124858,-2.01673e-06,3.35019e-10,-3.2634e-14,-36896.2,-119.395], Tmin=(941.338,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-240.402,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(415.724,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsOs) + ring(Cyclobutene) + radical(CC(C)OJ)"""),
)
...
species(
    label = 'CCC([O])C1(CC)OCC1[O](15066)',
    structure = SMILES('CCC([O])C1(CC)OCC1[O]'),
    E0 = (-130.067,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,1380,1390,370,380,2900,435,2750,2950,3150,900,1000,1100,300,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (158.195,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.66867,0.111155,-6.76965e-05,9.84994e-10,1.09444e-11,-15426.9,40.1027], Tmin=(100,'K'), Tmax=(928.299,'K')), NASAPolynomial(coeffs=[22.0187,0.0434786,-1.39132e-05,2.26968e-09,-1.49646e-13,-21306.5,-80.3943], Tmin=(928.299,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-130.067,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(586.17,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Oxetane) + radical(CC(C)OJ) + radical(CC(C)OJ)"""),
)

species(
    label = 'CC[C](O)C1(CC)OC[C]1O(15067)',
    structure = SMILES('CC[C](O)C1(CC)OC[C]1O'),
    E0 = (-237.532,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (158.195,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.33963,0.137083,-0.000155442,9.81735e-08,-2.47566e-11,-28338.3,42.4343], Tmin=(100,'K'), Tmax=(971.372,'K')), NASAPolynomial(coeffs=[19.5443,0.0469583,-1.62572e-05,2.6389e-09,-1.66531e-13,-32589.4,-62.505], Tmin=(971.372,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-237.532,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(577.856,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Oxetane) + radical(C2CsJOH) + radical(C2CsJOH)"""),
)

species(
    label = 'CCC([O])C1(CC)O[CH]C1O(15068)',
    structure = SMILES('CCC([O])C1(CC)O[CH]C1O'),
    E0 = (-179.971,'kJ/mol'),
    modes = [
...
species(
    label = 'CC[C]([O])C1(CC)OCC1O(15069)',
    structure = SMILES('CC[C]([O])C1(CC)OCC1O'),
    E0 = (-183.799,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2950,3150,900,1000,1100,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,360,370,350,3615,1277.5,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,300,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (158.195,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.96011,0.123573,-0.000109533,4.6753e-08,-5.61576e-12,-21884.5,40.7657], Tmin=(100,'K'), Tmax=(917.817,'K')), NASAPolynomial(coeffs=[20.6525,0.0454432,-1.52171e-05,2.48581e-09,-1.60728e-13,-26895.4,-71.0731], Tmin=(917.817,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-183.799,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(582.013,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Oxetane) + radical(CC(C)OJ) + radical(C2CsJOH)"""),
)

species(
    label = 'C[CH]C1(OCC1O)C([O])CC(15070)',
    structure = SMILES('C[CH]C1(OCC1O)C([O])CC'),
    E0 = (-160.525,'kJ/mol'),
    modes = [
...
species(
    ...
    molecularWeight = (158.195,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.3721,0.127669,-0.000125774,6.73895e-08,-1.42973e-11,-25529.3,45.6192], Tmin=(100,'K'), Tmax=(1191.04,'K')), NASAPolynomial(coeffs=[22.7153,0.0405111,-1.23502e-05,1.85548e-09,-1.11973e-13,-31299.3,-78.9342], Tmin=(1191.04,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-214.258,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(577.856,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Oxetane) + radical(CCJCO) + radical(C2CsJOH)"""),
)

species(
    label = 'C[CH]C1(OC[C]1O)C(O)CC(15072)',
    structure = SMILES('C[CH]C1(OC[C]1O)C(O)CC'),
    E0 = (-214.258,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (158.195,'amu'),
...
species(
    label = 'C[CH]C([O])C1(CC)OCC1O(15073)',
    structure = SMILES('C[CH]C([O])C1(CC)OCC1O'),
    E0 = (-160.525,'kJ/mol'),
    modes = [
...
species(
    label = '[CH2]CC1(OCC1O)C([O])CC(15074)',
    structure = SMILES('[CH2]CC1(OCC1O)C([O])CC'),
    E0 = (-155.181,'kJ/mol'),
    modes = [
...
species(
    label = '[CH2]CC(O)C1(CC)OC[C]1O(15075)',
    structure = SMILES('[CH2]CC(O)C1(CC)OC[C]1O'),
    E0 = (-208.914,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3580,3650,1210,1345,900,1100,2750,2800,2850,1350,1500,750,1050,1375,1000,2750,3150,900,1100,1380,1390,370,380,2900,435,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3100,440,815,1455,1000,300,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (158.195,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.03235,0.127628,-0.000123329,6.03856e-08,-9.93603e-12,-24904.6,43.6994], Tmin=(100,'K'), Tmax=(889.665,'K')), NASAPolynomial(coeffs=[20.3772,0.0451768,-1.51729e-05,2.46387e-09,-1.57886e-13,-29616.3,-65.8646], Tmin=(889.665,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-208.914,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(577.856,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Oxetane) + radical(RCCJ) + radical(C2CsJOH)"""),
)

species(
    label = 'CCC(O)C1(CC)O[CH][C]1O(15076)',
    structure = SMILES('CCC(O)C1(CC)O[CH][C]1O'),
    E0 = (-233.704,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (158.195,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.32438,0.133289,-0.000129458,5.77656e-08,-6.25094e-12,-27874.7,42.4114], Tmin=(100,'K'), Tmax=(861.429,'K')), NASAPolynomial(coeffs=[23.2561,0.0402824,-1.23873e-05,1.89795e-09,-1.17702e-13,-33238.2,-82.7347], Tmin=(861.429,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-233.704,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(577.856,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Oxetane) + radical(CCsJOCs) + radical(C2CsJOH)"""),
)

species(
    label = '[CH2]CC1(OC[C]1O)C(O)CC(15077)',
    structure = SMILES('[CH2]CC1(OC[C]1O)C(O)CC'),
    E0 = (-208.914,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (158.195,'amu'),
...
species(
    label = 'CCC(O)C1(CC)OC[C]1[O](15078)',
    structure = SMILES('CCC(O)C1(CC)OC[C]1[O]'),
    E0 = (-183.799,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,2750,3150,900,1100,3615,1277.5,1000,1380,1390,370,380,2900,435,300,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (158.195,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.96011,0.123573,-0.000109533,4.6753e-08,-5.61576e-12,-21884.5,41.4588], Tmin=(100,'K'), Tmax=(917.817,'K')), NASAPolynomial(coeffs=[20.6525,0.0454432,-1.52171e-05,2.48581e-09,-1.60728e-13,-26895.4,-70.3799], Tmin=(917.817,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-183.799,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(582.013,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Oxetane) + radical(CC(C)OJ) + radical(C2CsJOH)"""),
)

species(
    label = '[CH2]CC([O])C1(CC)OCC1O(15079)',
    structure = SMILES('[CH2]CC([O])C1(CC)OCC1O'),
    E0 = (-155.181,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1277.5,1000,2750,2950,3150,900,1000,1100,1380,1390,370,380,2900,435,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3100,440,815,1455,1000,300,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'CCC(=C(O)C[O])C([O])CC(15080)',
    structure = SMILES('CCC(=C(O)C[O])C([O])CC'),
    E0 = (-222.463,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (158.195,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.57943,0.120323,-0.000107303,5.10264e-08,-9.95157e-12,-26553.4,45.5738], Tmin=(100,'K'), Tmax=(1214.21,'K')), NASAPolynomial(coeffs=[19.4373,0.0510863,-2.17682e-05,4.06282e-09,-2.81879e-13,-31657.1,-59.899], Tmin=(1214.21,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-222.463,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(577.856,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsOs) + radical(CCOJ) + radical(CC(C)OJ)"""),
)

species(
    label = 'CCC(=O)C1(CC)OCC1O(15081)',
    structure = SMILES('CCC(=O)C1(CC)OCC1O'),
    E0 = (-523.399,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (158.195,'amu'),
...
species(
    label = 'CCC(O)C1(CC)OCC1=O(15082)',
    structure = SMILES('CCC(O)C1(CC)OCC1=O'),
    E0 = (-502.285,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (158.195,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.86921,0.112685,-7.69353e-05,1.78356e-08,1.47027e-12,-60185.7,40.6984], Tmin=(100,'K'), Tmax=(1084.95,'K')), NASAPolynomial(coeffs=[23.8788,0.0436504,-1.72903e-05,3.18285e-09,-2.22049e-13,-67296.7,-92.6433], Tmin=(1084.95,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-502.285,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(582.013,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-(Cds-O2d)CsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)OsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdCsCs) + ring(Cyclobutane)"""),
)

species(
    label = 'CCC(O)C1(CC)OC=C1O(15083)',
    structure = SMILES('CCC(O)C1(CC)OC=C1O'),
    E0 = (-544.687,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (158.195,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.43536,0.110544,-2.26901e-05,-7.744e-08,4.57662e-11,-65250.3,40.5523], Tmin=(100,'K'), Tmax=(928.387,'K')), NASAPolynomial(coeffs=[37.4624,0.0182567,-2.21571e-06,2.28356e-10,-2.26134e-14,-76089.5,-167.445], Tmin=(928.387,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-544.687,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(577.856,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + ring(Cyclobutene)"""),
)
...
species(
    label = 'CCC([O])C1(C)OC[C]1O(15084)',
    structure = SMILES('CCC([O])C1(C)OC[C]1O'),
    E0 = (-160.019,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,2750,3150,900,1100,3615,1277.5,1000,1380,1390,370,380,2900,435,300,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'CCC([O])[C]1OCC1(O)CC(15085)',
    structure = SMILES('CCC([O])[C]1OCC1(O)CC'),
    E0 = (-179.723,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,2750,3150,900,1100,3615,1277.5,1000,1380,1390,370,380,2900,435,300,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
reaction(
    label = 'reaction1',
    reactants = ['CCC([O])C1(CC)OC[C]1O(12270)'],
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'CCC([O])C1(CC)OCC1=O(15062)'],
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'CCC(=O)C1(CC)OC[C]1O(15063)'],
    products = ['CCC([O])C1(CC)OC[C]1O(12270)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', 'CCC([O])C1(CC)OC=C1O(15064)'],
    products = ['CCC([O])C1(CC)OC[C]1O(12270)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['C2H5(29)', 'CCC([O])C1OCC=1O(15065)'],
    products = ['CCC([O])C1(CC)OC[C]1O(12270)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['C2H5(29)', 'CCC1(C=O)OC[C]1O(5471)'],
    products = ['CCC([O])C1(CC)OC[C]1O(12270)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['CCC([O])C1(CC)OCC1[O](15066)'],
    products = ['CCC([O])C1(CC)OC[C]1O(12270)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['CCC([O])C1(CC)OC[C]1O(12270)'],
    products = ['CC[C](O)C1(CC)OC[C]1O(15067)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CCC([O])C1(CC)O[CH]C1O(15068)'],
    products = ['CCC([O])C1(CC)OC[C]1O(12270)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CC[C]([O])C1(CC)OCC1O(15069)'],
    products = ['CCC([O])C1(CC)OC[C]1O(12270)'],
...
reaction(
    label = 'reaction13',
    reactants = ['C[CH]C1(OCC1O)C([O])CC(15070)'],
    products = ['CCC([O])C1(CC)OC[C]1O(12270)'],
...
reaction(
    label = 'reaction14',
    reactants = ['C[CH]C(O)C1(CC)OC[C]1O(15071)'],
    products = ['CCC([O])C1(CC)OC[C]1O(12270)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CCC([O])C1(CC)OC[C]1O(12270)'],
    products = ['C[CH]C1(OC[C]1O)C(O)CC(15072)'],
...
reaction(
    label = 'reaction16',
    reactants = ['C[CH]C([O])C1(CC)OCC1O(15073)'],
    products = ['CCC([O])C1(CC)OC[C]1O(12270)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]CC1(OCC1O)C([O])CC(15074)'],
    products = ['CCC([O])C1(CC)OC[C]1O(12270)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2]CC(O)C1(CC)OC[C]1O(15075)'],
    products = ['CCC([O])C1(CC)OC[C]1O(12270)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CCC([O])C1(CC)OC[C]1O(12270)'],
    products = ['CCC(O)C1(CC)O[CH][C]1O(15076)'],
...
reaction(
    label = 'reaction20',
    reactants = ['CCC([O])C1(CC)OC[C]1O(12270)'],
    products = ['[CH2]CC1(OC[C]1O)C(O)CC(15077)'],
...
reaction(
    label = 'reaction21',
    reactants = ['CCC(O)C1(CC)OC[C]1[O](15078)'],
    products = ['CCC([O])C1(CC)OC[C]1O(12270)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH2]CC([O])C1(CC)OCC1O(15079)'],
    products = ['CCC([O])C1(CC)OC[C]1O(12270)'],
...
reaction(
    label = 'reaction25',
    reactants = ['CCC(=C(O)C[O])C([O])CC(15080)'],
    products = ['CCC([O])C1(CC)OC[C]1O(12270)'],
...
reaction(
    label = 'reaction26',
    reactants = ['CCC([O])C1(CC)OC[C]1O(12270)'],
    products = ['CCC(=O)C1(CC)OCC1O(15081)'],
...
reaction(
    label = 'reaction27',
    reactants = ['CCC([O])C1(CC)OC[C]1O(12270)'],
    products = ['CCC(O)C1(CC)OCC1=O(15082)'],
...
reaction(
    label = 'reaction28',
    reactants = ['CCC([O])C1(CC)OC[C]1O(12270)'],
    products = ['CCC(O)C1(CC)OC=C1O(15083)'],
...
reaction(
    label = 'reaction29',
    reactants = ['CH2(S)(23)', 'CCC1(OC[C]1O)C(C)[O](7281)'],
    products = ['CCC([O])C1(CC)OC[C]1O(12270)'],
...
reaction(
    label = 'reaction30',
    reactants = ['CH2(S)(23)', 'CCC([O])C1(C)OC[C]1O(15084)'],
    products = ['CCC([O])C1(CC)OC[C]1O(12270)'],
...
reaction(
    label = 'reaction32',
    reactants = ['CCC([O])[C]1OCC1(O)CC(15085)'],
    products = ['CCC([O])C1(CC)OC[C]1O(12270)'],
...
reaction(
    label = 'reaction34',
    reactants = ['O(4)', 'CC[CH]C1(CC)OC[C]1O(14357)'],
    products = ['CCC([O])C1(CC)OC[C]1O(12270)'],
