...
species(
    label = '[CH2][C](O)C1(O)C(C)CC1C(32464)',
    structure = SMILES('[CH2][C](O)C1(O)C(C)CC1C'),
    E0 = (-74.0385,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (142.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.63039,0.109467,-7.92341e-05,2.05657e-08,1.20313e-12,-8689.61,38.9542], Tmin=(100,'K'), Tmax=(1032.89,'K')), NASAPolynomial(coeffs=[22.8331,0.0399412,-1.48817e-05,2.66281e-09,-1.83708e-13,-15088.1,-86.3701], Tmin=(1032.89,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-74.0385,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(557.07,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Cyclobutane) + radical(C2CsJOH) + radical(CJCO)"""),
)
...
species(
    label = '[CH2]C(O)=C(O)C(C)C=CC(32465)',
    structure = SMILES('[CH2]C(O)=C(O)C(C)C=CC'),
    E0 = (-287.072,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3580,3650,1210,1345,900,1100,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,2995,3025,975,1000,1300,1375,400,500,1630,1680,1380,1390,370,380,2900,435,325,375,415,465,420,450,1700,1750,3000,3100,440,815,1455,1000,200,800],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.10217,0.12249,-0.00011483,4.84903e-08,-5.78027e-12,-34296.6,38.7271], Tmin=(100,'K'), Tmax=(974.761,'K')), NASAPolynomial(coeffs=[25.8338,0.0312689,-1.04895e-05,1.77362e-09,-1.19368e-13,-40855.2,-101.04], Tmin=(974.761,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-287.072,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(527.969,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)(Cds-Cds)CsH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(C=C(O)CJ)"""),
)

species(
    label = '[CH2]C(O)=C(O)C(C)CC=C(32466)',
    structure = SMILES('[CH2]C(O)=C(O)C(C)CC=C'),
    E0 = (-274.278,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (141.188,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.86699,0.110188,-6.77083e-05,-9.04611e-09,1.68693e-11,-32759.5,40.7085], Tmin=(100,'K'), Tmax=(937.756,'K')), NASAPolynomial(coeffs=[29.0852,0.0251429,-6.82239e-06,1.09401e-09,-7.66924e-14,-40630.4,-117.643], Tmin=(937.756,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-274.278,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(527.969,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(C=C(O)CJ)"""),
)
...
species(
    label = 'C=C=C(O)C(C)C[CH]C(32467)',
    structure = SMILES('C=C=C(O)C(C)C[CH]C'),
    E0 = (24.632,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([540,610,2055,3025,407.5,1350,352.5,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3615,1277.5,1000,2950,3100,1380,975,1025,1650,1380,1390,370,380,2900,435,350,440,435,1725,2750,2850,1437.5,1250,1305,750,350,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.00444,0.099682,-8.33765e-05,3.69329e-08,-6.60651e-12,3151.32,38.1862], Tmin=(100,'K'), Tmax=(1336.51,'K')), NASAPolynomial(coeffs=[19.5417,0.0381906,-1.43636e-05,2.50877e-09,-1.67381e-13,-2340.74,-66.8969], Tmin=(1336.51,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(24.632,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cdd-Cd)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(RCCJC)"""),
)
...
species(
    label = '[CH2]CCC(C)C(O)=C([CH2])O(32468)',
    structure = SMILES('[CH2]CCC(C)C(O)=C([CH2])O'),
    E0 = (-196.814,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (142.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.14792,0.118839,-8.82435e-05,1.34957e-08,8.29005e-12,-23435,43.0288], Tmin=(100,'K'), Tmax=(946.732,'K')), NASAPolynomial(coeffs=[28.2605,0.0296023,-9.0313e-06,1.49753e-09,-1.02819e-13,-30951.3,-111.298], Tmin=(946.732,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-196.814,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(548.755,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsOs) + radical(C=C(O)CJ) + radical(RCCJ)"""),
)

species(
    label = '[CH2]C(O)=C(O)[C](C)CCC(32469)',
    structure = SMILES('[CH2]C(O)=C(O)[C](C)CCC'),
    E0 = (-249.487,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (142.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.91659,0.111496,-6.66036e-05,-8.24528e-09,1.57221e-11,-29776.3,40.607], Tmin=(100,'K'), Tmax=(947.399,'K')), NASAPolynomial(coeffs=[28.0218,0.0301545,-9.16174e-06,1.53784e-09,-1.07309e-13,-37471.3,-112.884], Tmin=(947.399,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-249.487,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(548.755,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsOs) + radical(CCJ(C)CO) + radical(C=C(O)CJ)"""),
)

species(
    label = 'C[CH]CC(C)C(O)=C(C)[O](32470)',
    structure = SMILES('C[CH]CC(C)C(O)=C(C)[O]'),
    E0 = (-228.726,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (142.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.64513,0.114478,-0.000103718,5.01401e-08,-9.73659e-12,-27298,42.9862], Tmin=(100,'K'), Tmax=(1242.18,'K')), NASAPolynomial(coeffs=[21.119,0.0411742,-1.51987e-05,2.63249e-09,-1.75212e-13,-32953.4,-71.7744], Tmin=(1242.18,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-228.726,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(552.912,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsOs) + radical(RCCJC) + radical(C=C(C)OJ)"""),
)

species(
    label = '[CH2]C(O)=C(O)C([CH2])CCC(32471)',
    structure = SMILES('[CH2]C(O)=C(O)C([CH2])CCC'),
    E0 = (-196.978,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,3580,3650,1210,1345,900,1100,1380,1390,370,380,2900,435,325,375,415,465,420,450,1700,1750,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (142.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-3.16543,0.131413,-0.000130268,6.46607e-08,-1.22199e-11,-23410.7,46.6844], Tmin=(100,'K'), Tmax=(1446.76,'K')), NASAPolynomial(coeffs=[30.5957,0.0244928,-5.33545e-06,6.04756e-10,-3.00716e-14,-31758.5,-123.751], Tmin=(1446.76,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-196.978,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(548.755,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsOs) + radical(Isobutyl) + radical(C=C(O)CJ)"""),
)

species(
    label = 'C[CH]CC(C)C([O])=C(C)O(32472)',
    structure = SMILES('C[CH]CC(C)C([O])=C(C)O'),
    E0 = (-228.726,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
species(
    label = 'C[CH]C[C](C)C(O)=C(C)O(32473)',
    structure = SMILES('C[CH]C[C](C)C(O)=C(C)O'),
    E0 = (-213.957,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (142.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.68687,0.111226,-8.3111e-05,2.15733e-08,1.88856e-12,-25516.1,41.828], Tmin=(100,'K'), Tmax=(996.576,'K')), NASAPolynomial(coeffs=[23.4011,0.0377322,-1.34367e-05,2.35452e-09,-1.61332e-13,-31867.4,-85.8983], Tmin=(996.576,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-213.957,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(548.755,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsOs) + radical(RCCJC) + radical(CCJ(C)CO)"""),
)

species(
    label = '[CH2]C(O)=C([O])C(C)CCC(32474)',
    structure = SMILES('[CH2]C(O)=C([O])C(C)CCC'),
    E0 = (-264.256,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (142.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.84812,0.114487,-8.66138e-05,2.01333e-08,3.87415e-12,-31559.4,41.6665], Tmin=(100,'K'), Tmax=(964.934,'K')), NASAPolynomial(coeffs=[24.8752,0.0350066,-1.1713e-05,1.99826e-09,-1.36077e-13,-38173.7,-93.8539], Tmin=(964.934,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-264.256,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(552.912,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsOs) + radical(C=C(O)CJ) + radical(C=C(C)OJ)"""),
)

species(
    label = 'C[CH][CH]C(C)C(O)=C(C)O(32475)',
    structure = SMILES('C[CH][CH]C(C)C(O)=C(C)O'),
    E0 = (-171.989,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([325,375,415,465,420,450,1700,1750,2750,2762.5,2775,2787.5,2800,2812.5,2825,2837.5,2850,1350,1380,1410,1440,1470,1500,700,750,800,1000,1050,1100,1350,1375,1400,900,1000,1100,3000,3050,390,425,1340,1360,335,370,3580,3650,1210,1345,900,1100,1380,1390,370,380,2900,435,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (142.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.85983,0.117671,-0.00010899,5.28484e-08,-1.02021e-11,-20465.1,44.8135], Tmin=(100,'K'), Tmax=(1255.18,'K')), NASAPolynomial(coeffs=[23.0567,0.0382658,-1.40968e-05,2.4471e-09,-1.63356e-13,-26720,-81.0574], Tmin=(1255.18,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-171.989,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(548.755,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsOs) + radical(RCCJC) + radical(Cs_S)"""),
)

species(
    label = '[CH2]C(C[CH]C)C(O)=C(C)O(32476)',
    ...
    molecularWeight = (142.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.30729,0.123843,-0.000121692,6.2468e-08,-1.25787e-11,-19178.1,45.6428], Tmin=(100,'K'), Tmax=(1234.44,'K')), NASAPolynomial(coeffs=[25.2166,0.0334826,-1.04673e-05,1.63026e-09,-1.01774e-13,-25884,-92.5788], Tmin=(1234.44,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-161.449,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(548.755,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsOs) + radical(Isobutyl) + radical(RCCJC)"""),
)

species(
    label = '[CH2]C([O])=C(O)C(C)CCC(32477)',
    structure = SMILES('[CH2]C([O])=C(O)C(C)CCC'),
    E0 = (-264.256,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (142.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.84812,0.114487,-8.66138e-05,2.01333e-08,3.87415e-12,-31559.4,41.6665], Tmin=(100,'K'), Tmax=(964.934,'K')), NASAPolynomial(coeffs=[24.8752,0.0350066,-1.1713e-05,1.99826e-09,-1.36077e-13,-38173.7,-93.8539], Tmin=(964.934,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-264.256,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(552.912,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsOs) + radical(C=C(C)OJ) + radical(C=C(O)CJ)"""),
)

species(
    label = '[CH2][CH]CC(C)C(O)=C(C)O(32478)',
    structure = SMILES('[CH2][CH]CC(C)C(O)=C(C)O'),
    E0 = (-161.285,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3580,3650,1210,1345,900,1100,1380,1390,370,380,2900,435,325,375,415,465,420,450,1700,1750,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (142.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.20991,0.121919,-0.000115999,5.71399e-08,-1.10816e-11,-19162.1,45.3015], Tmin=(100,'K'), Tmax=(1259.57,'K')), NASAPolynomial(coeffs=[25.3635,0.0343542,-1.17193e-05,1.94658e-09,-1.26798e-13,-26108.2,-94.0874], Tmin=(1259.57,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-161.285,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(548.755,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsOs) + radical(RCCJ) + radical(RCCJC)"""),
)
...
species(
    label = 'C[CH]CC(C)C1(O)C[C]1O(32479)',
    structure = SMILES('C[CH]CC(C)C1(O)C[C]1O'),
    E0 = (-74.3733,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (142.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.24827,0.112118,-0.000101611,5.03863e-08,-1.02467e-11,-8753.31,41.3375], Tmin=(100,'K'), Tmax=(1171.96,'K')), NASAPolynomial(coeffs=[17.6372,0.0476599,-1.91102e-05,3.45598e-09,-2.35605e-13,-13179.9,-52.7708], Tmin=(1171.96,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-74.3733,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(552.912,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(RCCJC) + radical(C2CsJOH)"""),
)

species(
    label = '[CH2]C1(O)[C](O)C(C)CC1C(32279)',
    structure = SMILES('[CH2]C1(O)[C](O)C(C)CC1C'),
    E0 = (-155.378,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (142.196,'amu'),
...
species(
    label = 'CC=CC(C)C(O)=C(C)O(32480)',
    structure = SMILES('CC=CC(C)C(O)=C(C)O'),
    E0 = (-445.988,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (142.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.29572,0.124562,-0.000120271,5.96883e-08,-1.16488e-11,-53401.6,38.7371], Tmin=(100,'K'), Tmax=(1251.62,'K')), NASAPolynomial(coeffs=[25.9582,0.0342656,-1.20545e-05,2.04685e-09,-1.35288e-13,-60474.2,-103.913], Tmin=(1251.62,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-445.988,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(552.912,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)(Cds-Cds)CsH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + group(Cds-CdsCsH)"""),
)

species(
    label = 'C=CCC(C)C(O)=C(C)O(32481)',
    structure = SMILES('C=CCC(C)C(O)=C(C)O'),
    E0 = (-433.195,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (142.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.84008,0.109763,-6.49687e-05,-7.52606e-09,1.46719e-11,-51874.2,39.9217], Tmin=(100,'K'), Tmax=(959.285,'K')), NASAPolynomial(coeffs=[27.5841,0.0308024,-9.88222e-06,1.71339e-09,-1.20895e-13,-59531.5,-111.297], Tmin=(959.285,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-433.195,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(552.912,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + group(Cds-CdsHH)"""),
)
...
species(
    ...
    opticalIsomers = 1,
    molecularWeight = (142.196,'amu'),
    collisionModel = TransportData(shapeIndex=2, epsilon=(4753.89,'J/mol'), sigma=(8.05217,'angstroms'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with Tc=742.55 K, Pc=20.66 bar (from Joback method)"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
...
species(
    label = 'CC1CC(O)=C(O)C(C)C1(32072)',
    structure = SMILES('CC1CC(O)=C(O)C(C)C1'),
    E0 = (-514.96,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (142.196,'amu'),
...
species(
    label = '[CH2]C(O)C(=O)C(C)C[CH]C(32482)',
    structure = SMILES('[CH2]C(O)C(=O)C(C)C[CH]C'),
    E0 = (-124.558,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (142.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.734638,0.109221,-0.00010155,5.49138e-08,-1.27252e-11,-14814.7,44.1026], Tmin=(100,'K'), Tmax=(1010.21,'K')), NASAPolynomial(coeffs=[12.1629,0.0581513,-2.57183e-05,4.86922e-09,-3.4022e-13,-17420.5,-18.2514], Tmin=(1010.21,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-124.558,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(548.755,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-O2d)CsCsH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdCsCs) + radical(RCCJC) + radical(CJCO)"""),
)

species(
    label = '[CH2]C(=O)C(O)C(C)C[CH]C(32483)',
    structure = SMILES('C=C([O])C(O)C(C)C[CH]C'),
    E0 = (-172.451,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (142.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.13206,0.107366,-9.03345e-05,4.10545e-08,-7.66361e-12,-20551.9,44.7576], Tmin=(100,'K'), Tmax=(1267.02,'K')), NASAPolynomial(coeffs=[18.0266,0.0468821,-1.87298e-05,3.37861e-09,-2.29707e-13,-25406.8,-52.2061], Tmin=(1267.02,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-172.451,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(552.912,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(RCCJC) + radical(C=C(C)OJ)"""),
)
...
species(
    label = 'C[CH]CC(C)C(O)=[C]O(32484)',
    structure = SMILES('C[CH]CC(C)C(O)=[C]O'),
    E0 = (-84.9952,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3580,3650,1210,1345,900,1100,1685,370,1380,1390,370,380,2900,435,350,440,435,1725,2750,2850,1437.5,1250,1305,750,350,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (128.169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.63592,0.106834,-0.00010222,5.01492e-08,-9.56233e-12,-10005.1,42.5814], Tmin=(100,'K'), Tmax=(1359.22,'K')), NASAPolynomial(coeffs=[24.2389,0.0258863,-7.58956e-06,1.13634e-09,-6.94272e-14,-16595.5,-88.5593], Tmin=(1359.22,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-84.9952,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(478.082,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + radical(C=CJO) + radical(RCCJC)"""),
)

species(
    label = 'C=C(O)C(=O)C(C)C[CH]C(32485)',
    structure = SMILES('C=C(O)C(=O)C(C)C[CH]C'),
    E0 = (-241.123,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (141.188,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.817362,0.111112,-0.000109949,6.23151e-08,-1.49104e-11,-28831.2,38.0474], Tmin=(100,'K'), Tmax=(988.506,'K')), NASAPolynomial(coeffs=[13.1077,0.0547635,-2.44422e-05,4.64666e-09,-3.25417e-13,-31584.1,-28.9716], Tmin=(988.506,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-241.123,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(527.969,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-O2d)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-O2d(Cds-Cds)Cs) + group(Cds-Cds(Cds-O2d)O2s) + group(Cds-CdsHH) + radical(RCCJC)"""),
)

species(
    label = 'C=C(O)C(O)=C(C)C[CH]C(32486)',
    structure = SMILES('C=C(O)C(O)=C(C)C[CH]C'),
    E0 = (-260.925,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,3580,3650,1210,1345,900,1100,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,2950,3100,1380,975,1025,1650,325,350,375,415,440,465,420,435,450,1700,1725,1750,2750,2850,1437.5,1250,1305,750,350,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (141.188,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.18811,0.127212,-0.000134309,7.34828e-08,-1.57912e-11,-31151.6,39.1454], Tmin=(100,'K'), Tmax=(1140.84,'K')), NASAPolynomial(coeffs=[24.3353,0.0342158,-1.20367e-05,2.03112e-09,-1.33561e-13,-37203.4,-92.3095], Tmin=(1140.84,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-260.925,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(527.969,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-Cds(Cds-Cds)O2s) + group(Cds-Cds(Cds-Cds)O2s) + group(Cds-CdsHH) + radical(RCCJC)"""),
)
...
species(
    label = 'C=C(O)C(O)=CC[CH]C(32487)',
    structure = SMILES('C=C(O)C(O)=CC[CH]C'),
    E0 = (-221.87,'kJ/mol'),
    modes = [
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.27312,0.10637,-0.000100869,4.28036e-08,-4.93345e-12,-26486.2,35.105], Tmin=(100,'K'), Tmax=(957.279,'K')), NASAPolynomial(coeffs=[22.8264,0.0266015,-8.67383e-06,1.4384e-09,-9.57967e-14,-32059.3,-85.1185], Tmin=(957.279,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-221.87,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-Cds(Cds-Cds)O2s) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)O2s) + group(Cds-CdsHH) + radical(RCCJC)"""),
)

species(
    label = 'C=C(O)C([O])C(C)C[CH]C(32488)',
    structure = SMILES('C=C(O)C([O])C(C)C[CH]C'),
    E0 = (-79.8953,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (142.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.8237,0.112908,-9.54785e-05,4.18077e-08,-7.30259e-12,-9386.84,45.5595], Tmin=(100,'K'), Tmax=(1378.28,'K')), NASAPolynomial(coeffs=[23.9396,0.0381362,-1.4101e-05,2.44464e-09,-1.62471e-13,-16488.4,-86.9982], Tmin=(1378.28,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-79.8953,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(552.912,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(CC(C)OJ) + radical(RCCJC)"""),
)

species(
    label = 'C=C(O)C(O)[C](C)C[CH]C(32489)',
    structure = SMILES('C=C(O)C(O)[C](C)C[CH]C'),
    E0 = (-157.682,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (142.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.77289,0.110898,-9.2133e-05,3.96423e-08,-6.8059e-12,-18743.5,45.7671], Tmin=(100,'K'), Tmax=(1401.31,'K')), NASAPolynomial(coeffs=[23.8649,0.0377148,-1.3795e-05,2.37296e-09,-1.56808e-13,-25928.7,-86.5703], Tmin=(1401.31,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-157.682,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(548.755,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(RCCJC) + radical(CCJ(C)CO)"""),
)

species(
    label = 'C=C(O)C(O)C(C)[CH][CH]C(32490)',
    structure = SMILES('C=C(O)C(O)C(C)[CH][CH]C'),
    E0 = (-115.714,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3050,390,425,1340,1360,335,370,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3580,3650,1210,1345,900,1100,2950,3100,1380,975,1025,1650,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,350,440,435,1725,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (142.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.34722,0.110565,-9.56334e-05,4.3798e-08,-8.14322e-12,-13718.9,46.5864], Tmin=(100,'K'), Tmax=(1280.95,'K')), NASAPolynomial(coeffs=[19.9922,0.0439287,-1.76029e-05,3.18745e-09,-2.17381e-13,-19185.9,-61.6476], Tmin=(1280.95,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-115.714,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(548.755,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(RCCJC) + radical(Cs_S)"""),
)

species(
    label = '[CH2]C(C[CH]C)C(O)C(=C)O(32491)',
    structure = SMILES('[CH2]C(C[CH]C)C(O)C(=C)O'),
    E0 = (-105.174,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (142.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.80027,0.116784,-0.000108433,5.34798e-08,-1.05294e-11,-12431.6,47.4373], Tmin=(100,'K'), Tmax=(1231.36,'K')), NASAPolynomial(coeffs=[22.0443,0.0393263,-1.40769e-05,2.39495e-09,-1.57812e-13,-18303.8,-72.5617], Tmin=(1231.36,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-105.174,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(548.755,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(Isobutyl) + radical(RCCJC)"""),
)

species(
    label = '[CH]=C(O)C(O)C(C)C[CH]C(32492)',
    structure = SMILES('[CH]=C(O)C(O)C(C)C[CH]C'),
    E0 = (-63.1599,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,3025,407.5,1350,352.5,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3580,3650,1210,1345,900,1100,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,350,440,435,1725,2750,2850,1437.5,1250,1305,750,350,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (142.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.77707,0.117248,-0.000107692,5.18543e-08,-9.98326e-12,-7380.18,45.9766], Tmin=(100,'K'), Tmax=(1253.98,'K')), NASAPolynomial(coeffs=[22.4575,0.0399422,-1.52168e-05,2.68977e-09,-1.81351e-13,-13458,-76.4256], Tmin=(1253.98,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-63.1599,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(548.755,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(RCCJC) + radical(Cds_P)"""),
)

species(
    label = '[CH2][CH]CC(C)C(O)C(=C)O(32493)',
    structure = SMILES('[CH2][CH]CC(C)C(O)C(=C)O'),
    E0 = (-105.01,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,3580,3650,1210,1345,900,1100,2950,3100,1380,975,1025,1650,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,350,440,435,1725,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,200,800,1200,1600],'cm^-1')),
    ...
    molecularWeight = (142.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.69995,0.114838,-0.000102708,4.81505e-08,-9.04126e-12,-12415.8,47.0845], Tmin=(100,'K'), Tmax=(1282.7,'K')), NASAPolynomial(coeffs=[22.2862,0.0400402,-1.52392e-05,2.69032e-09,-1.8111e-13,-18569.2,-74.6069], Tmin=(1282.7,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-105.01,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(548.755,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(RCCJ) + radical(RCCJC)"""),
)

species(
    label = '[CH]=C(O)[C](O)C(C)CCC(32494)',
    structure = SMILES('[CH]C(O)=C(O)C(C)CCC'),
    E0 = (-190.293,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,325,375,415,465,420,450,1700,1750,3580,3650,1210,1345,900,1100,1380,1390,370,380,2900,435,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (142.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.15303,0.117529,-7.43191e-05,1.56968e-09,1.11423e-11,-22649.4,41.6796], Tmin=(100,'K'), Tmax=(966.8,'K')), NASAPolynomial(coeffs=[26.8458,0.0377548,-1.29254e-05,2.24785e-09,-1.55566e-13,-30135.6,-106.961], Tmin=(966.8,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-190.293,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(548.755,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsOs) + radical(AllylJ2_triplet)"""),
)

species(
    label = 'CC1C[C](O)[C](O)C(C)C1(32330)',
    structure = SMILES('CC1C[C](O)[C](O)C(C)C1'),
    E0 = (-199.196,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (142.196,'amu'),
...
species(
    label = 'C=C(O)C(O)=C(C)CCC(32495)',
    structure = SMILES('C=C(O)C(O)=C(C)CCC'),
    E0 = (-455.371,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (142.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.84176,0.132266,-0.000132757,6.7344e-08,-1.32566e-11,-54506.7,38.7617], Tmin=(100,'K'), Tmax=(1277.72,'K')), NASAPolynomial(coeffs=[29.3994,0.0291003,-9.02244e-06,1.41657e-09,-8.96112e-14,-62563.5,-123.972], Tmin=(1277.72,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-455.371,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(552.912,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-Cds(Cds-Cds)O2s) + group(Cds-Cds(Cds-Cds)O2s) + group(Cds-CdsHH)"""),
)

species(
    label = 'C=C(O)C(O)C(C)C=CC(32496)',
    structure = SMILES('C=C(O)C(O)C(C)C=CC'),
    E0 = (-391.443,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (142.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.57094,0.106001,-6.65768e-05,4.03446e-09,7.85374e-12,-46864.6,42.166], Tmin=(100,'K'), Tmax=(1002.11,'K')), NASAPolynomial(coeffs=[24.3304,0.0365347,-1.33713e-05,2.41744e-09,-1.69781e-13,-53759,-91.3457], Tmin=(1002.11,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-391.443,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(552.912,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH)"""),
)

species(
    label = 'C=C(O)C(=O)C(C)CCC(32497)',
    structure = SMILES('C=C(O)C(=O)C(C)CCC'),
    E0 = (-435.569,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (142.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.22837,0.113614,-0.000100756,4.77841e-08,-9.32981e-12,-52197.6,36.7709], Tmin=(100,'K'), Tmax=(1209.29,'K')), NASAPolynomial(coeffs=[18.1288,0.0495854,-2.13346e-05,4.00001e-09,-2.78172e-13,-56879.2,-60.2949], Tmin=(1209.29,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-435.569,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(552.912,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-O2d)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-O2d(Cds-Cds)Cs) + group(Cds-Cds(Cds-O2d)O2s) + group(Cds-CdsHH)"""),
)

species(
    label = 'C=CCC(C)C(O)C(=C)O(32498)',
    structure = SMILES('C=CCC(C)C(O)C(=C)O'),
    E0 = (-380.267,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (142.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.61406,0.106015,-6.3292e-05,-1.45887e-09,1.02695e-11,-45518,42.7245], Tmin=(100,'K'), Tmax=(993.114,'K')), NASAPolynomial(coeffs=[25.1352,0.0354301,-1.2797e-05,2.31514e-09,-1.63495e-13,-52663.2,-95.3649], Tmin=(993.114,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-380.267,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(552.912,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cds-CdsHH)"""),
)
...
species(
    label = 'C=C(O)C(C)(O)[CH]C[CH]C(32499)',
    structure = SMILES('C=C(O)C(C)(O)[CH]C[CH]C'),
    E0 = (-129.7,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3050,390,425,1340,1360,335,370,3580,3650,1210,1345,900,1100,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,2950,3100,1380,975,1025,1650,350,440,435,1725,2750,2850,1437.5,1250,1305,750,350,180,180,180,538.322,600.994,1600,1828.57,2971.43,3200],'cm^-1')),
        HinderedRotor(inertia=(0.157741,'amu*angstrom^2'), symmetry=1, barrier=(3.62678,'kJ/mol'), semiclassical=False),
...
reaction(
    label = 'reaction1',
    reactants = ['C=C(O)[C](O)C(C)C[CH]C(32069)'],
...
reaction(
    label = 'reaction2',
    reactants = ['C=C(O)[C](O)C(C)C[CH]C(32069)'],
    products = ['[CH2][C](O)C1(O)C(C)CC1C(32464)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(4.73e+06,'s^-1'), n=1.31, Ea=(133.576,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2500,'K'), comment="""Estimated using an average for rate rule [R5_SS_D;doublebond_intra;radadd_intra_csHNd]
Euclidian distance = 0
family: Intra_R_Add_Exocyclic
Ea raised from 132.3 to 133.6 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction3',
    reactants = ['H(3)', '[CH2]C(O)=C(O)C(C)C=CC(32465)'],
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', '[CH2]C(O)=C(O)C(C)CC=C(32466)'],
    products = ['C=C(O)[C](O)C(C)C[CH]C(32069)'],
    transitionState = 'TS4',
...
reaction(
    ...
    products = ['C=C(O)[C](O)C(C)C[CH]C(32069)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(3860,'cm^3/(mol*s)'), n=2.41, Ea=(47.5721,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""From training reaction 242 used for Cds-HH_Cds-Cs\H3/H;CsJ-CdCsH
...
reaction(
    label = 'reaction6',
    reactants = ['OH(5)', 'C=C=C(O)C(C)C[CH]C(32467)'],
    products = ['C=C(O)[C](O)C(C)C[CH]C(32069)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2]C(O)=C(O)C(C)[CH]CC(32402)'],
    products = ['C=C(O)[C](O)C(C)C[CH]C(32069)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]CCC(C)C(O)=C([CH2])O(32468)'],
    products = ['C=C(O)[C](O)C(C)C[CH]C(32069)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['C=C(O)[C](O)C(C)C[CH]C(32069)'],
    products = ['[CH2]C(O)=C(O)[C](C)CCC(32469)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['C=C(O)[C](O)C(C)C[CH]C(32069)'],
    products = ['C[CH]CC(C)C(O)=C(C)[O](32470)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]C(O)=C(O)C([CH2])CCC(32471)'],
    products = ['C=C(O)[C](O)C(C)C[CH]C(32069)'],
...
reaction(
    label = 'reaction12',
    reactants = ['C=C(O)[C](O)C(C)C[CH]C(32069)'],
    products = ['C[CH]CC(C)C([O])=C(C)O(32472)'],
...
reaction(
    label = 'reaction13',
    reactants = ['C=C(O)[C](O)C(C)C[CH]C(32069)'],
    products = ['C[CH]C[C](C)C(O)=C(C)O(32473)'],
...
reaction(
    label = 'reaction14',
    reactants = ['C=C(O)[C](O)C(C)C[CH]C(32069)'],
    products = ['[CH2]C(O)=C([O])C(C)CCC(32474)'],
...
reaction(
    label = 'reaction15',
    reactants = ['C[CH][CH]C(C)C(O)=C(C)O(32475)'],
    products = ['C=C(O)[C](O)C(C)C[CH]C(32069)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]C(C[CH]C)C(O)=C(C)O(32476)'],
    products = ['C=C(O)[C](O)C(C)C[CH]C(32069)'],
...
reaction(
    label = 'reaction17',
    reactants = ['C=C(O)[C](O)C(C)C[CH]C(32069)'],
    products = ['[CH2]C([O])=C(O)C(C)CCC(32477)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2][CH]CC(C)C(O)=C(C)O(32478)'],
    products = ['C=C(O)[C](O)C(C)C[CH]C(32069)'],
...
reaction(
    label = 'reaction20',
    reactants = ['C[CH]C[CH]C(384)', '[CH2]C(O)=[C]O(31700)'],
    products = ['C=C(O)[C](O)C(C)C[CH]C(32069)'],
    transitionState = 'TS20',
    kinetics = Arrhenius(A=(5.59093e+07,'m^3/(mol*s)'), n=-0.206, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Y_rad;C_rad/H/NonDeC] for rate rule [Cd_rad;C_rad/H/NonDeC]
Euclidian distance = 1.0
Multiplied by reaction path degeneracy 2.0
family: R_Recombination
...
reaction(
    label = 'reaction21',
    reactants = ['C=C(O)[C](O)C(C)C[CH]C(32069)'],
    products = ['C[CH]CC(C)C1(O)C[C]1O(32479)'],
...
reaction(
    label = 'reaction22',
    reactants = ['C=C(O)[C](O)C(C)C[CH]C(32069)'],
    products = ['[CH2]C1(O)[C](O)C(C)CC1C(32279)'],
    transitionState = 'TS22',
    kinetics = Arrhenius(A=(4.64e+06,'s^-1'), n=1.15, Ea=(58.1576,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R5_CsCs_RH_D;doublebond_intra;radadd_intra_csHCs] for rate rule [R5_CsCs_RH_D;doublebond_intra_secNd;radadd_intra_csHCs]
Euclidian distance = 1.0
family: Intra_R_Add_Endocyclic"""),
)
...
reaction(
    label = 'reaction23',
    reactants = ['C=C(O)[C](O)C(C)C[CH]C(32069)'],
    products = ['CC=CC(C)C(O)=C(C)O(32480)'],
...
reaction(
    label = 'reaction24',
    reactants = ['C=C(O)[C](O)C(C)C[CH]C(32069)'],
    products = ['C=CCC(C)C(O)=C(C)O(32481)'],
...
reaction(
    label = 'reaction27',
    reactants = ['C=C(O)[C](O)C(C)C[CH]C(32069)'],
    products = ['CC1CC(O)=C(O)C(C)C1(32072)'],
...
reaction(
    label = 'reaction28',
    reactants = ['C=C(O)[C](O)C(C)C[CH]C(32069)'],
    products = ['[CH2]C(O)C(=O)C(C)C[CH]C(32482)'],
...
reaction(
    label = 'reaction29',
    reactants = ['C=C(O)[C](O)C(C)C[CH]C(32069)'],
    products = ['[CH2]C(=O)C(O)C(C)C[CH]C(32483)'],
...
reaction(
    label = 'reaction31',
    reactants = ['CH2(19)', 'C[CH]CC(C)C(O)=[C]O(32484)'],
    products = ['C=C(O)[C](O)C(C)C[CH]C(32069)'],
...
reaction(
    label = 'reaction32',
    reactants = ['H(3)', 'C=C(O)C(=O)C(C)C[CH]C(32485)'],
    products = ['C=C(O)[C](O)C(C)C[CH]C(32069)'],
...
reaction(
    label = 'reaction33',
    reactants = ['H(3)', 'C=C(O)C(O)=C(C)C[CH]C(32486)'],
    products = ['C=C(O)[C](O)C(C)C[CH]C(32069)'],
...
reaction(
    label = 'reaction35',
    reactants = ['CH3(17)', 'C=C(O)C(O)=CC[CH]C(32487)'],
    products = ['C=C(O)[C](O)C(C)C[CH]C(32069)'],
...
reaction(
    label = 'reaction36',
    reactants = ['C=C(O)C([O])C(C)C[CH]C(32488)'],
    products = ['C=C(O)[C](O)C(C)C[CH]C(32069)'],
...
reaction(
    label = 'reaction37',
    reactants = ['C=C(O)C(O)[C](C)C[CH]C(32489)'],
    products = ['C=C(O)[C](O)C(C)C[CH]C(32069)'],
...
reaction(
    label = 'reaction38',
    reactants = ['C=C(O)C(O)C(C)[CH][CH]C(32490)'],
    products = ['C=C(O)[C](O)C(C)C[CH]C(32069)'],
...
reaction(
    label = 'reaction39',
    reactants = ['[CH2]C(C[CH]C)C(O)C(=C)O(32491)'],
    products = ['C=C(O)[C](O)C(C)C[CH]C(32069)'],
...
reaction(
    label = 'reaction40',
    reactants = ['[CH]=C(O)C(O)C(C)C[CH]C(32492)'],
    products = ['C=C(O)[C](O)C(C)C[CH]C(32069)'],
...
reaction(
    label = 'reaction41',
    reactants = ['[CH2][CH]CC(C)C(O)C(=C)O(32493)'],
    products = ['C=C(O)[C](O)C(C)C[CH]C(32069)'],
...
reaction(
    label = 'reaction42',
    reactants = ['[CH]=C(O)[C](O)C(C)CCC(32494)'],
    products = ['C=C(O)[C](O)C(C)C[CH]C(32069)'],
...
reaction(
    label = 'reaction43',
    reactants = ['C=C(O)[C](O)C(C)C[CH]C(32069)'],
    products = ['CC1C[C](O)[C](O)C(C)C1(32330)'],
...
reaction(
    label = 'reaction44',
    reactants = ['C=C(O)[C](O)C(C)C[CH]C(32069)'],
    products = ['C=C(O)C(O)=C(C)CCC(32495)'],
...
reaction(
    label = 'reaction45',
    reactants = ['C=C(O)[C](O)C(C)C[CH]C(32069)'],
    products = ['C=C(O)C(O)C(C)C=CC(32496)'],
...
reaction(
    label = 'reaction46',
    reactants = ['C=C(O)[C](O)C(C)C[CH]C(32069)'],
    products = ['C=C(O)C(=O)C(C)CCC(32497)'],
...
reaction(
    label = 'reaction47',
    reactants = ['C=C(O)[C](O)C(C)C[CH]C(32069)'],
    products = ['C=CCC(C)C(O)C(=C)O(32498)'],
...
reaction(
    label = 'reaction49',
    reactants = ['C=C(O)C(C)(O)[CH]C[CH]C(32499)'],
    products = ['C=C(O)[C](O)C(C)C[CH]C(32069)'],
