...
species(
    label = 'C=C(CC)C[O](1736)',
    structure = SMILES('C=C(CC)C[O]'),
    E0 = (16.9926,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2950,3100,1380,975,1025,1650,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,270.597,270.597,1963.07],'cm^-1')),
        HinderedRotor(inertia=(0.00230235,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.116799,'amu*angstrom^2'), symmetry=1, barrier=(6.06889,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.116807,'amu*angstrom^2'), symmetry=1, barrier=(6.06925,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
species(
    label = '[CH2]CC(C)C[O](1744)',
    structure = SMILES('[CH2]CC(C)C[O]'),
    E0 = (97.3454,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,180,1273.81,1274.28],'cm^-1')),
        HinderedRotor(inertia=(0.160811,'amu*angstrom^2'), symmetry=1, barrier=(3.69736,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.160659,'amu*angstrom^2'), symmetry=1, barrier=(3.69387,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.16078,'amu*angstrom^2'), symmetry=1, barrier=(3.69665,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.161317,'amu*angstrom^2'), symmetry=1, barrier=(3.709,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.1323,'amu'),
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'C=C(CC)C[O](1736)'],
    products = ['[CH2]C(CC)C[O](987)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', '[CH2]C(C=O)CC(1737)'],
    products = ['[CH2]C(CC)C[O](987)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['C2H5(29)', 'allyloxy(559)'],
    products = ['[CH2]C(CC)C[O](987)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction23',
    reactants = ['[CH2]C([CH2])CC(429)', 'O(4)'],
    products = ['[CH2]C(CC)C[O](987)'],
