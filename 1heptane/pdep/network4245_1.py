...
species(
    label = 'C=C=C(C)C[CH]C(24287)',
    structure = SMILES('C=C=C(C)C[CH]C'),
    E0 = (255.668,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([540,610,2055,3025,407.5,1350,352.5,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,2950,3100,1380,975,1025,1650,350,440,435,1725,2750,2850,1437.5,1250,1305,750,350,308.025,308.186],'cm^-1')),
        HinderedRotor(inertia=(0.00177857,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.109922,'amu*angstrom^2'), symmetry=1, barrier=(7.38014,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.10975,'amu*angstrom^2'), symmetry=1, barrier=(7.37779,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.109503,'amu*angstrom^2'), symmetry=1, barrier=(7.37708,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (95.1622,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.24021,0.0647714,-4.27179e-05,1.59601e-08,-2.71677e-12,30845.4,26.5781], Tmin=(100,'K'), Tmax=(1245.58,'K')), NASAPolynomial(coeffs=[7.16537,0.0457437,-1.9804e-05,3.69613e-09,-2.55298e-13,29369.4,-3.30862], Tmin=(1245.58,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(255.668,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(415.724,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(RCCJC)"""),
)

species(
    label = 'C=[C]C(C)C=CC(24288)',
    structure = SMILES('C=[C]C(C)C=CC'),
    E0 = (256.996,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,3100,1380,975,1025,1650,2995,3025,975,1000,1300,1375,400,500,1630,1680,1685,370,1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,214.547,214.568],'cm^-1')),
        HinderedRotor(inertia=(0.305305,'amu*angstrom^2'), symmetry=1, barrier=(9.97369,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.305312,'amu*angstrom^2'), symmetry=1, barrier=(9.97367,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.305341,'amu*angstrom^2'), symmetry=1, barrier=(9.97368,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.305312,'amu*angstrom^2'), symmetry=1, barrier=(9.97375,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (95.1622,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.15211,0.0664012,-4.56943e-05,1.76382e-08,-3.04649e-12,31008.6,24.9096], Tmin=(100,'K'), Tmax=(1252.79,'K')), NASAPolynomial(coeffs=[8.0363,0.0444206,-1.93762e-05,3.63296e-09,-2.51656e-13,29283.7,-9.85415], Tmin=(1252.79,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(256.996,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(415.724,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)CsH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_S)"""),
)
...
species(
    label = 'C#CC(C)C[CH]C(24289)',
    structure = SMILES('C#CC(C)C[CH]C'),
    E0 = (263.562,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,2175,525,750,770,3400,2100,2750,2850,1437.5,1250,1305,750,350,1380,1390,370,380,2900,435,180,3372.67],'cm^-1')),
        HinderedRotor(inertia=(3.61953,'amu*angstrom^2'), symmetry=1, barrier=(83.2201,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0605441,'amu*angstrom^2'), symmetry=1, barrier=(17.1678,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.426816,'amu*angstrom^2'), symmetry=1, barrier=(9.81334,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0103065,'amu*angstrom^2'), symmetry=1, barrier=(83.2327,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(3.62184,'amu*angstrom^2'), symmetry=1, barrier=(83.2732,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (95.1622,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.882756,0.0660524,-4.50451e-05,1.75833e-08,-2.97691e-12,31813.3,28.2959], Tmin=(100,'K'), Tmax=(1331.45,'K')), NASAPolynomial(coeffs=[9.67824,0.0396286,-1.52763e-05,2.67783e-09,-1.78165e-13,29471.1,-16.6551], Tmin=(1331.45,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(263.562,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CtCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(RCCJC)"""),
)
...
species(
    label = 'C=C=CC[CH]C(24290)',
    structure = SMILES('C=C=CC[CH]C'),
    E0 = (294.723,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([540,610,2055,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,2750,2800,2850,1350,1500,750,1050,1375,1000,2950,3100,1380,975,1025,1650,2750,2850,1437.5,1250,1305,750,350,275.308,275.33],'cm^-1')),
        HinderedRotor(inertia=(0.171445,'amu*angstrom^2'), symmetry=1, barrier=(9.22798,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.171419,'amu*angstrom^2'), symmetry=1, barrier=(9.22731,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH]=CC(C)C[CH]C(3298)',
    structure = SMILES('[CH]=CC(C)C[CH]C'),
    E0 = (345.708,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,331.656,3088],'cm^-1')),
        HinderedRotor(inertia=(0.00153315,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0850271,'amu*angstrom^2'), symmetry=1, barrier=(6.62966,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0849953,'amu*angstrom^2'), symmetry=1, barrier=(6.62964,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.47626,'amu*angstrom^2'), symmetry=1, barrier=(37.1209,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.139275,'amu*angstrom^2'), symmetry=1, barrier=(10.8544,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (96.1702,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.693831,0.0672611,-4.05009e-05,1.24824e-08,-1.59523e-12,41702.2,31.58], Tmin=(100,'K'), Tmax=(1739.86,'K')), NASAPolynomial(coeffs=[13.7844,0.0371654,-1.45542e-05,2.54034e-09,-1.66661e-13,37147,-38.8242], Tmin=(1739.86,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(345.708,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(RCCJC) + radical(Cds_P)"""),
)

species(
    label = 'C=CC(C)[CH][CH]C(19168)',
    ...
    molecularWeight = (96.1702,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.97538,0.0619874,-3.20868e-05,7.76726e-09,-7.41022e-13,35371.1,32.7486], Tmin=(100,'K'), Tmax=(2367.82,'K')), NASAPolynomial(coeffs=[20.7965,0.0285022,-1.08735e-05,1.79441e-09,-1.10376e-13,25984.8,-79.9615], Tmin=(2367.82,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(293.154,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(RCCJC) + radical(Cs_S)"""),
)
...
species(
    ...
    molecularWeight = (96.1702,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.632402,0.06485,-3.11059e-05,2.67483e-09,1.6211e-12,33082,27.3913], Tmin=(100,'K'), Tmax=(1209.75,'K')), NASAPolynomial(coeffs=[12.028,0.0397974,-1.56988e-05,2.81209e-09,-1.90225e-13,29400.8,-33.5747], Tmin=(1209.75,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(273.988,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Allyl_T) + radical(Cds_S)"""),
)
...
species(
    label = '[CH]=[C]C(C)CCC(3295)',
    structure = SMILES('[CH]=[C]C(C)CCC'),
    E0 = (389.104,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,1685,370,1380,1390,370,380,2900,435,3120,650,792.5,1650,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,364.94,364.941],'cm^-1')),
        HinderedRotor(inertia=(0.109961,'amu*angstrom^2'), symmetry=1, barrier=(10.3912,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00126596,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.109962,'amu*angstrom^2'), symmetry=1, barrier=(10.3912,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.109933,'amu*angstrom^2'), symmetry=1, barrier=(10.3913,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.109943,'amu*angstrom^2'), symmetry=1, barrier=(10.3915,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (96.1702,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.387614,0.0725277,-4.8895e-05,1.71314e-08,-2.47668e-12,46933.8,30.4178], Tmin=(100,'K'), Tmax=(1582.54,'K')), NASAPolynomial(coeffs=[14.8736,0.0359134,-1.41905e-05,2.51173e-09,-1.67159e-13,42348.9,-46.1181], Tmin=(1582.54,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(389.104,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_P) + radical(Cds_S)"""),
)

species(
    label = '[CH2][CH]CC(C)C=C(18363)',
    ...
    molecularWeight = (96.1702,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.689819,0.0656371,-3.76022e-05,1.07496e-08,-1.25464e-12,36670.6,32.9921], Tmin=(100,'K'), Tmax=(1912.42,'K')), NASAPolynomial(coeffs=[15.5232,0.0346121,-1.3268e-05,2.26687e-09,-1.4575e-13,30997.1,-48.188], Tmin=(1912.42,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(303.858,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(RCCJ) + radical(RCCJC)"""),
)

species(
    label = 'C=C=C(C)CCC(24293)',
    structure = SMILES('C=C=C(C)CCC'),
    E0 = (61.2217,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (96.1702,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.439949,0.0714134,-4.60273e-05,1.51402e-08,-2.04744e-12,7496.79,26.7293], Tmin=(100,'K'), Tmax=(1677.38,'K')), NASAPolynomial(coeffs=[15.3238,0.0359204,-1.42877e-05,2.5255e-09,-1.67325e-13,2503.59,-52.7753], Tmin=(1677.38,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(61.2217,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(440.667,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + group(Cdd-CdsCds)"""),
)

species(
    label = 'C=CC(C)C=CC(19171)',
...
species(
    label = 'C=[C]CC[CH]C(24294)',
    structure = SMILES('C=[C]CC[CH]C'),
    E0 = (368.206,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2950,3100,1380,975,1025,1650,1685,370,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,283.5,283.575,1802.79],'cm^-1')),
        HinderedRotor(inertia=(0.00209681,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00209679,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.129401,'amu*angstrom^2'), symmetry=1, barrier=(7.38394,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.129397,'amu*angstrom^2'), symmetry=1, barrier=(7.38398,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (82.1436,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.97806,0.0497516,-2.54688e-05,6.19658e-09,-6.16041e-13,44351.5,24.9956], Tmin=(100,'K'), Tmax=(2044.1,'K')), NASAPolynomial(coeffs=[9.87288,0.0343025,-1.41319e-05,2.49912e-09,-1.63827e-13,41123.9,-18.7368], Tmin=(2044.1,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(368.206,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_S) + radical(RCCJC)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'C=C=C(C)C[CH]C(24287)'],
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'C=[C]C(C)C=CC(24288)'],
    products = ['C=[C]C(C)C[CH]C(19169)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', 'C=[C]C(C)CC=C(24173)'],
    products = ['C=[C]C(C)C[CH]C(19169)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)', 'C#CC(C)C[CH]C(24289)'],
    products = ['C=[C]C(C)C[CH]C(19169)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['CH3(17)', 'C=C=CC[CH]C(24290)'],
    products = ['C=[C]C(C)C[CH]C(19169)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction18',
    reactants = ['C=[C]C(C)C[CH]C(19169)'],
    products = ['[CH2][CH]CC(C)C=C(18363)'],
...
reaction(
    label = 'reaction23',
    reactants = ['CH2(S)(23)', 'C=[C]CC[CH]C(24294)'],
    products = ['C=[C]C(C)C[CH]C(19169)'],
...
reaction(
    label = 'reaction25',
    reactants = ['C=[C]C(C)C[CH]C(19169)'],
    products = ['C=C(C)[CH]C[CH]C(24295)'],
...
reaction(
    label = 'reaction28',
    reactants = ['C[CH]C[CH]C(384)', 'H2CC(41)'],
    products = ['C=[C]C(C)C[CH]C(19169)'],
