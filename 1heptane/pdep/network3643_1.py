...
species(
    label = 'CC[CH]OC1CCC([O])O1(20318)',
    structure = SMILES('CC[CH]OC1CCC([O])O1'),
    E0 = (-233.445,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (144.168,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.571087,0.0898978,-5.57013e-05,1.19231e-08,1.41576e-12,-27903.3,35.2674], Tmin=(100,'K'), Tmax=(1048.75,'K')), NASAPolynomial(coeffs=[15.6673,0.0453059,-1.67275e-05,2.91636e-09,-1.9601e-13,-32263,-48.3934], Tmin=(1048.75,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-233.445,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(515.497,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Tetrahydrofuran) + radical(CCOJ) + radical(CCsJOCs)"""),
)
...
species(
    label = 'CC=COC([O])CCC=O(20320)',
    structure = SMILES('CC=COC([O])CCC=O'),
    E0 = (-326.418,'kJ/mol'),
    modes = [
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.551306,0.10167,-9.13372e-05,4.38761e-08,-8.7476e-12,-39096.6,37.3715], Tmin=(100,'K'), Tmax=(1177.38,'K')), NASAPolynomial(coeffs=[15.7179,0.0463982,-2.09207e-05,4.00474e-09,-2.81606e-13,-42927.6,-43.7751], Tmin=(1177.38,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-326.418,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(482.239,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-OdCsH) + radical(CCOJ)"""),
)

species(
    label = 'CC[CH]OC(=O)CCC=O(20321)',
    structure = SMILES('CC[CH]OC(=O)CCC=O'),
    E0 = (-425.337,'kJ/mol'),
    modes = [
...
species(
    label = 'C[CH]COC([O])CCC=O(20322)',
    structure = SMILES('C[CH]COC([O])CCC=O'),
    E0 = (-202.137,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2782.5,750,1395,475,1775,1000,3025,407.5,1350,352.5,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'CC[CH]O[C](O)CCC=O(20323)',
    structure = SMILES('CC[CH]O[C](O)CCC=O'),
    E0 = (-242.042,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (144.168,'amu'),
...
species(
    label = 'CCCO[C]([O])CCC=O(20324)',
    structure = SMILES('CCCO[C]([O])CCC=O'),
    E0 = (-196.793,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (144.168,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.772746,0.116826,-0.000162579,1.47188e-07,-5.5098e-11,-23508.3,41.5874], Tmin=(100,'K'), Tmax=(786.488,'K')), NASAPolynomial(coeffs=[4.95866,0.06838,-3.33776e-05,6.47373e-09,-4.52857e-13,-23813,19.1074], Tmin=(786.488,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-196.793,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(CCOJ) + radical(Cs_P)"""),
)

species(
    label = '[CH2]CCOC([O])CCC=O(20325)',
    structure = SMILES('[CH2]CCOC([O])CCC=O'),
    E0 = (-196.793,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (144.168,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.77258,0.116824,-0.00016257,1.47173e-07,-5.50903e-11,-23508.3,42.6854], Tmin=(100,'K'), Tmax=(786.524,'K')), NASAPolynomial(coeffs=[4.9584,0.0683804,-3.33779e-05,6.4738e-09,-4.52863e-13,-23812.9,20.2075], Tmin=(786.524,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-196.793,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(RCCJ) + radical(CCOJ)"""),
)

species(
    label = 'CC[CH]OC(O)[CH]CC=O(20326)',
    structure = SMILES('CC[CH]OC(O)[CH]CC=O'),
    E0 = (-247.386,'kJ/mol'),
    modes = [
...
species(
    label = 'CC[CH]OC(O)C[CH]C=O(20327)',
    structure = SMILES('CC[CH]OC(O)CC=C[O]'),
    E0 = (-304.036,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (144.168,'amu'),
...
species(
    label = 'CCCOC([O])[CH]CC=O(20328)',
    structure = SMILES('CCCOC([O])[CH]CC=O'),
    E0 = (-202.137,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2782.5,750,1395,475,1775,1000,3025,407.5,1350,352.5,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'C[CH][CH]OC(O)CCC=O(20329)',
    structure = SMILES('C[CH][CH]OC(O)CCC=O'),
    E0 = (-247.386,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (144.168,'amu'),
...
species(
    label = 'CCCOC([O])C[CH]C=O(20331)',
    structure = SMILES('CCCOC([O])CC=C[O]'),
    E0 = (-258.787,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (144.168,'amu'),
...
species(
    label = '[CH2]C[CH]OC(O)CCC=O(20333)',
    structure = SMILES('[CH2]C[CH]OC(O)CCC=O'),
    E0 = (-242.042,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (144.168,'amu'),
...
species(
    label = 'CC[CH]OC1CC[CH]OO1(20334)',
    structure = SMILES('CC[CH]OC1CC[CH]OO1'),
    E0 = (-30.3719,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (144.168,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.906483,0.0928703,-4.11615e-05,-2.03106e-08,1.745e-11,-3462.46,34.5308], Tmin=(100,'K'), Tmax=(933.146,'K')), NASAPolynomial(coeffs=[21.0448,0.0365799,-1.14471e-05,1.87681e-09,-1.25892e-13,-9205.17,-78.6717], Tmin=(933.146,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-30.3719,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(515.497,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(12dioxane) + radical(CCsJOOC) + radical(CCsJOCs)"""),
)
...
species(
    label = 'CCCOC(=O)CCC=O(20336)',
    structure = SMILES('CCCOC(=O)CCC=O'),
    E0 = (-619.264,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (144.168,'amu'),
...
species(
    ...
    molecularWeight = (144.168,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.44391,0.11067,-0.000100904,4.71669e-08,-8.79677e-12,-66201.6,39.7136], Tmin=(100,'K'), Tmax=(1290.75,'K')), NASAPolynomial(coeffs=[22.4556,0.0366054,-1.48317e-05,2.71087e-09,-1.86223e-13,-72371.2,-81.6875], Tmin=(1290.75,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-552.123,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-OdCsH)"""),
)
...
species(
    label = '[CH2]C(C)OC([O])CCC=O(20338)',
    structure = SMILES('[CH2]C(C)OC([O])CCC=O'),
    E0 = (-202.08,'kJ/mol'),
    modes = [
...
species(
    label = 'C=COCC([O])O[CH]CC(20339)',
    structure = SMILES('C=COCC([O])O[CH]CC'),
    E0 = (-179.986,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (144.168,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.59262,0.120305,-0.000121874,6.41175e-08,-1.35152e-11,-21443.7,40.3427], Tmin=(100,'K'), Tmax=(1145.15,'K')), NASAPolynomial(coeffs=[21.2588,0.0404847,-1.73186e-05,3.24803e-09,-2.26548e-13,-26677.3,-72.9992], Tmin=(1145.15,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-179.986,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CCsJOCs) + radical(CCOJ)"""),
)

species(
    label = 'CC[CH]OC([O])CC=CO(20340)',
    structure = SMILES('CC[CH]OC([O])CC=CO'),
    E0 = (-219.794,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (144.168,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.62898,0.119912,-0.000122692,6.5179e-08,-1.38107e-11,-26229.1,41.7253], Tmin=(100,'K'), Tmax=(1143.41,'K')), NASAPolynomial(coeffs=[21.627,0.0385544,-1.59604e-05,2.94797e-09,-2.04015e-13,-31547.2,-73.5876], Tmin=(1143.41,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-219.794,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(CCsJOCs) + radical(CCOJ)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['CC[CH]OC([O])CCC=O(20314)'],
...
reaction(
    label = 'reaction2',
    reactants = ['CC[CH]OC([O])CCC=O(20314)'],
    products = ['CC[CH]OC1CCC([O])O1(20318)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', 'CC=COC([O])CCC=O(20320)'],
    products = ['CC[CH]OC([O])CCC=O(20314)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)', 'CC[CH]OC(=O)CCC=O(20321)'],
    products = ['CC[CH]OC([O])CCC=O(20314)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['CH3(17)', 'C=COC([O])CCC=O(18636)'],
    products = ['CC[CH]OC([O])CCC=O(20314)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['CH2CH2CHO(560)', 'CC[CH]OC=O(10830)'],
    products = ['CC[CH]OC([O])CCC=O(20314)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['C[CH]COC([O])CCC=O(20322)'],
    products = ['CC[CH]OC([O])CCC=O(20314)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['CC[CH]OC([O])CCC=O(20314)'],
    products = ['CC[CH]O[C](O)CCC=O(20323)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CCCO[C]([O])CCC=O(20324)'],
    products = ['CC[CH]OC([O])CCC=O(20314)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]CCOC([O])CCC=O(20325)'],
    products = ['CC[CH]OC([O])CCC=O(20314)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CC[CH]OC(O)[CH]CC=O(20326)'],
    products = ['CC[CH]OC([O])CCC=O(20314)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CC[CH]OC([O])CCC=O(20314)'],
    products = ['CC[CH]OC(O)C[CH]C=O(20327)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CCCOC([O])[CH]CC=O(20328)'],
    products = ['CC[CH]OC([O])CCC=O(20314)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CC[CH]OC([O])CCC=O(20314)'],
    products = ['C[CH][CH]OC(O)CCC=O(20329)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CC[CH]OC([O])CCC=O(20314)'],
    products = ['CC[CH]OC(O)CC[C]=O(20330)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CC[CH]OC([O])CCC=O(20314)'],
    products = ['CCCOC([O])C[CH]C=O(20331)'],
...
reaction(
    label = 'reaction20',
    reactants = ['CC[CH]OC([O])CCC=O(20314)'],
    products = ['[CH2]C[CH]OC(O)CCC=O(20333)'],
...
reaction(
    label = 'reaction22',
    reactants = ['CC[CH]OC([O])CCC=O(20314)'],
    products = ['CC[CH]OC1CC[CH]OO1(20334)'],
...
reaction(
    label = 'reaction26',
    reactants = ['CH2(S)(23)', 'C[CH]OC([O])CCC=O(18429)'],
    products = ['CC[CH]OC([O])CCC=O(20314)'],
...
reaction(
    label = 'reaction28',
    reactants = ['[CH2]C(C)OC([O])CCC=O(20338)'],
    products = ['CC[CH]OC([O])CCC=O(20314)'],
...
reaction(
    label = 'reaction30',
    reactants = ['C=COCC([O])O[CH]CC(20339)'],
    products = ['CC[CH]OC([O])CCC=O(20314)'],
...
reaction(
    label = 'reaction31',
    reactants = ['CC[CH]OC([O])CC=CO(20340)'],
    products = ['CC[CH]OC([O])CCC=O(20314)'],
...
reaction(
    label = 'reaction32',
    reactants = ['[CH]CC(144)', '[O]C([O])CCC=O(18653)'],
    products = ['CC[CH]OC([O])CCC=O(20314)'],
