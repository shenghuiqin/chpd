...
species(
    ...
    E0 = (212.585,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,393.267],'cm^-1')),
        HinderedRotor(inertia=(0.112193,'amu*angstrom^2'), symmetry=1, barrier=(12.3061,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.112028,'amu*angstrom^2'), symmetry=1, barrier=(12.3051,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (44.0526,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.04366,0.0151888,6.56951e-06,-1.92982e-08,8.23822e-12,25607.7,10.8689], Tmin=(100,'K'), Tmax=(1011.13,'K')), NASAPolynomial(coeffs=[8.44426,0.00772988,-2.99426e-06,6.08657e-10,-4.65979e-14,23804.7,-18.7608], Tmin=(1011.13,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(212.585,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo library: Klippenstein_Glarborg2016 + radical(CH2_triplet)"""),
)
...
species(
    ...
    E0 = (199.812,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3615,1277.5,1000,672.483,672.507,1599.06],'cm^-1')),
        HinderedRotor(inertia=(0.0117463,'amu*angstrom^2'), symmetry=1, barrier=(3.76892,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.163949,'amu*angstrom^2'), symmetry=1, barrier=(3.76952,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (44.0526,'amu'),
...
reaction(
    label = 'reaction9',
    reactants = ['CH3CHOH(55)'],
    products = ['H(3)', 'CH3CHO(37)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(6.2e+09,'s^-1'), n=1.31, Ea=(33778,'cal/mol'), T0=(1,'K'), comment="""Kinetics taken from the arrheniusHigh attribute of a Troe/Lindemann exprssion. Originally from reaction library Klippenstein_Glarborg2016"""),
)

reaction(
    label = 'reaction10',
    reactants = ['CH3CHOH(55)'],
    products = ['H(3)', 'CH2CHOH(42)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(6.4e+09,'s^-1'), n=1.33, Ea=(35974,'cal/mol'), T0=(1,'K'), comment="""Kinetics taken from the arrheniusHigh attribute of a Troe/Lindemann exprssion. Originally from reaction library Klippenstein_Glarborg2016"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['H(3)', 'CH3CHO(37)'],
    products = ['CH3CH2O(38)'],
    transitionState = 'TS10',
    kinetics = Arrhenius(A=(4.6e+07,'cm^3/(mol*s)'), n=1.71, Ea=(7090,'cal/mol'), T0=(1,'K'), comment="""Reaction library: 'Klippenstein_Glarborg2016'"""),
)

reaction(
    label = 'reaction2',
    reactants = ['CH3CH2O(38)'],
    products = ['CH2O(15)', 'CH3(17)'],
    transitionState = 'TS11',
    kinetics = Arrhenius(A=(6.3e+10,'s^-1'), n=0.93, Ea=(17098,'cal/mol'), T0=(1,'K'), comment="""Kinetics taken from the arrheniusHigh attribute of a Troe/Lindemann exprssion. Originally from reaction library Klippenstein_Glarborg2016"""),
)

reaction(
    label = 'reaction4',
    reactants = ['[CH2][O](167)', 'CH3(17)'],
    products = ['CH3CH2O(38)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CH2CH2OH(43)'],
    products = ['H(3)', 'CH2CHOH(42)'],
    transitionState = 'TS17',
    kinetics = Arrhenius(A=(2.7e+27,'s^-1'), n=-4.44, Ea=(37205,'cal/mol'), T0=(1,'K')),
)

reaction(
    label = 'reaction18',
    reactants = ['OH(5)', 'C2H4(T)(94)'],
    products = ['CH2CH2OH(43)'],
