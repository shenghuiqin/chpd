...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.30467,0.0289913,1.57551e-05,-3.18655e-08,1.163e-11,21474.3,20.7632], Tmin=(100,'K'), Tmax=(1082.55,'K')), NASAPolynomial(coeffs=[7.50551,0.0295422,-1.23991e-05,2.34091e-09,-1.65006e-13,19189.9,-10.0902], Tmin=(1082.55,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(177.982,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(303.478,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + ring(Cyclobutene) + radical(CCOJ)"""),
)

species(
    label = '[O]CC1C=CC1(23426)',
...
species(
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.46699,0.0211642,4.9638e-05,-6.84416e-08,2.43927e-11,24060.7,20.4015], Tmin=(100,'K'), Tmax=(1028.32,'K')), NASAPolynomial(coeffs=[7.67264,0.0327043,-1.35666e-05,2.59705e-09,-1.86567e-13,21309.3,-13.0305], Tmin=(1028.32,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(199.503,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(328.422,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + ring(Cyclobutane) + radical(CCOJ) + radical(CCJ(C)CO)"""),
)

species(
    label = '[O]CC1C[CH]C1(23429)',
...
species(
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.93525,0.0364053,7.80789e-06,-2.77065e-08,1.0807e-11,27411,21.6661], Tmin=(100,'K'), Tmax=(1081.77,'K')), NASAPolynomial(coeffs=[8.89016,0.0310146,-1.29017e-05,2.4256e-09,-1.70648e-13,24717,-17.931], Tmin=(1081.77,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(227.227,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(328.422,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + ring(Cyclobutane) + radical(CCsJOH) + radical(CCOJ)"""),
)

species(
    label = 'OC[C]1[CH]CC1(23432)',
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.29891,0.0242028,4.43999e-05,-6.75493e-08,2.53831e-11,19513.2,23.1819], Tmin=(100,'K'), Tmax=(1001.5,'K')), NASAPolynomial(coeffs=[9.36828,0.0286789,-1.12977e-05,2.14025e-09,-1.54385e-13,16456.7,-19.1244], Tmin=(1001.5,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(161.636,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(324.264,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + ring(Cyclobutane) + radical(CCJ(C)CO) + radical(cyclobutane)"""),
)

species(
    label = 'OCC1[CH]C[CH]1(23433)',
...
species(
    label = '[CH2]CC=CC[O](23435)',
    structure = SMILES('[CH2]CC=CC[O]'),
    E0 = (225.268,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2995,3025,975,1000,1300,1375,400,500,1630,1680,3000,3100,440,815,1455,1000,238.398,1613.9,1613.9],'cm^-1')),
        HinderedRotor(inertia=(0.131372,'amu*angstrom^2'), symmetry=1, barrier=(5.29846,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.131375,'amu*angstrom^2'), symmetry=1, barrier=(5.29844,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.131376,'amu*angstrom^2'), symmetry=1, barrier=(5.29842,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.46982,0.0413249,-1.8894e-05,3.44447e-09,-1.98751e-13,27141,23.7604], Tmin=(100,'K'), Tmax=(2386.5,'K')), NASAPolynomial(coeffs=[21.0442,0.0162163,-6.8986e-06,1.15125e-09,-6.93214e-14,16560,-85.601], Tmin=(2386.5,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(225.268,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(CCOJ) + radical(RCCJ)"""),
)

species(
    label = 'OCC1=CCC1(23436)',
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.98418,0.0313478,2.88572e-05,-5.70361e-08,2.32757e-11,-5655.62,21.0472], Tmin=(100,'K'), Tmax=(979.667,'K')), NASAPolynomial(coeffs=[11.4543,0.0243441,-8.89942e-06,1.64836e-09,-1.18856e-13,-9030.56,-32.2009], Tmin=(979.667,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-47.7233,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(324.264,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + ring(Cyclobutene)"""),
)

species(
    label = 'O=CC1CCC1(23437)',
...
species(
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.98603,0.0289038,4.10508e-05,-7.33331e-08,2.99624e-11,-5579.88,20.5381], Tmin=(100,'K'), Tmax=(963.521,'K')), NASAPolynomial(coeffs=[12.8975,0.0218217,-7.41845e-06,1.36788e-09,-1.00652e-13,-9456.5,-40.9033], Tmin=(963.521,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-47.1121,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(324.264,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cyclobutene)"""),
)

species(
    label = '[O]C[CH]C1CC1(23439)',
    structure = SMILES('[O]C[CH]C1CC1'),
    E0 = (251.25,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,2950,3050,3150,900,950,1000,1050,1100,3025,407.5,1350,352.5,2750,2850,1437.5,1250,1305,750,350,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.08203,0.0318748,1.96631e-05,-4.10107e-08,1.58803e-11,30296.4,24.0693], Tmin=(100,'K'), Tmax=(1031.15,'K')), NASAPolynomial(coeffs=[9.09998,0.0290384,-1.16873e-05,2.19484e-09,-1.55771e-13,27552.6,-16.2903], Tmin=(1031.15,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(251.25,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(324.264,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + ring(Cyclopropane) + radical(CCOJ) + radical(CCJCO)"""),
)

species(
    label = '[CH2]C1CC1C[O](19524)',
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.9608,0.0357718,1.0194e-05,-3.33163e-08,1.40549e-11,29835.4,22.8146], Tmin=(100,'K'), Tmax=(996.206,'K')), NASAPolynomial(coeffs=[9.05931,0.0284213,-1.05866e-05,1.90336e-09,-1.32099e-13,27371.5,-16.6725], Tmin=(996.206,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(247.389,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(324.264,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(Isobutyl) + radical(CCOJ)"""),
)

species(
    label = 'C1CC2OCC12(23339)',
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.48185,0.0172545,6.72769e-05,-9.0702e-08,3.3001e-11,2288.83,14.4358], Tmin=(100,'K'), Tmax=(1006.21,'K')), NASAPolynomial(coeffs=[9.67824,0.0295967,-1.21683e-05,2.38094e-09,-1.75339e-13,-1232.4,-30.6283], Tmin=(1006.21,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(18.458,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(332.579,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + polycyclic(s2_4_4_ane)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[O]CC1[CH]CC1(19535)'],
    products = ['CH2O(15)', 'C1=CCC1(2460)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', '[O]CC1=CCC1(23425)'],
    products = ['[O]CC1[CH]CC1(19535)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', '[O]CC1C=CC1(23426)'],
    products = ['[O]CC1[CH]CC1(19535)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', 'O=CC1[CH]CC1(23427)'],
    products = ['[O]CC1[CH]CC1(19535)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[CH2][O](167)', 'C1=CCC1(2460)'],
    products = ['[O]CC1[CH]CC1(19535)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['CH2O(15)', '[CH]1[CH]CC1(20477)'],
    products = ['[O]CC1[CH]CC1(19535)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2][O](167)', '[CH]1[CH]CC1(20477)'],
    products = ['[O]CC1[CH]CC1(19535)'],
...
reaction(
    label = 'reaction23',
    reactants = ['O(4)', '[CH2]C1[CH]CC1(22328)'],
    products = ['[O]CC1[CH]CC1(19535)'],
