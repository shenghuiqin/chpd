...
species(
    label = 'C[C](C)O[O](5468)',
    structure = SMILES('C[C](C)O[O]'),
    E0 = (118.847,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([360,370,350,492.5,1135,1000,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100],'cm^-1')),
        HinderedRotor(inertia=(0.16272,'amu*angstrom^2'), symmetry=1, barrier=(3.74126,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.163969,'amu*angstrom^2'), symmetry=1, barrier=(3.76996,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.160235,'amu*angstrom^2'), symmetry=1, barrier=(3.68413,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (74.0785,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.0335,0.0488472,-7.02162e-05,6.40893e-08,-2.31813e-11,14359.4,18.5471], Tmin=(100,'K'), Tmax=(849.41,'K')), NASAPolynomial(coeffs=[3.93385,0.0280254,-1.24795e-05,2.31839e-09,-1.57498e-13,14464.9,12.2104], Tmin=(849.41,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(118.847,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo library: DFT_QCI_thermo + radical(ROOJ) + radical(C2CsJOOH)"""),
)

species(
    label = '[CH2][C](C)OO(5699)',
    structure = SMILES('[CH2][C](C)OO'),
    E0 = (180.804,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([360,370,350,3615,1310,387.5,850,1000,3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000],'cm^-1')),
        HinderedRotor(inertia=(0.146679,'amu*angstrom^2'), symmetry=1, barrier=(3.37244,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.145135,'amu*angstrom^2'), symmetry=1, barrier=(3.33695,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.142266,'amu*angstrom^2'), symmetry=1, barrier=(3.27097,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.380547,'amu*angstrom^2'), symmetry=1, barrier=(8.74952,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (74.0785,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.70657,0.0551279,-7.85491e-05,6.72297e-08,-2.32928e-11,21823.8,21.6499], Tmin=(100,'K'), Tmax=(812.83,'K')), NASAPolynomial(coeffs=[6.31131,0.0257064,-1.17773e-05,2.23127e-09,-1.53902e-13,21298.6,1.76282], Tmin=(812.83,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(180.804,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo library: DFT_QCI_thermo + radical(CJCOOH) + radical(C2CsJOOH)"""),
)
...
species(
    ...
    molecularWeight = (74.0785,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.69183,0.0477287,-4.52038e-05,2.28281e-08,-4.62515e-12,-12240.8,17.6577], Tmin=(100,'K'), Tmax=(1192.95,'K')), NASAPolynomial(coeffs=[10.9068,0.0168302,-6.35181e-06,1.11584e-09,-7.49609e-14,-14439.4,-28.4248], Tmin=(1192.95,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-102.488,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), label="""propen2ooh""", comment="""Thermo library: DFT_QCI_thermo"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'propen2peroxy(5698)'],
    products = ['[CH2]C(C)O[O](218)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]CO[O](98)', 'CH2(S)(23)'],
    products = ['[CH2]C(C)O[O](218)'],
