...
species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.0301876,'amu*angstrom^2'), symmetry=1, barrier=(11.7519,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.80394,'amu*angstrom^2'), symmetry=1, barrier=(41.4762,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00780025,'amu*angstrom^2'), symmetry=1, barrier=(41.4824,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.33265,'amu*angstrom^2'), symmetry=1, barrier=(7.64828,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.80325,'amu*angstrom^2'), symmetry=1, barrier=(41.4602,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (88.1051,'amu'),
...
species(
    ...
    molecularWeight = (88.1051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.64311,0.0437994,-1.07343e-05,-1.09814e-08,5.57835e-12,-10559.5,15.9581], Tmin=(100,'K'), Tmax=(1118.64,'K')), NASAPolynomial(coeffs=[10.0755,0.0292121,-1.20452e-05,2.23815e-09,-1.55807e-13,-13419.9,-30.0218], Tmin=(1118.64,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-88.5574,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(324.264,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(12dioxetane)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'C=COO[CH]C(2478)'],
    products = ['C[CH]OO[CH]C(1180)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction8',
    reactants = ['C[CH]O[O](97)', 'CHCH3(T)(95)'],
    products = ['C[CH]OO[CH]C(1180)'],
    transitionState = 'TS8',
