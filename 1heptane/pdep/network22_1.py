...
species(
    label = 'hydroxyketene(114)',
    structure = SMILES('O=C=CO'),
    E0 = (-165.709,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2120,512.5,787.5,3615,1277.5,1000,3010,987.5,1337.5,450,1655],'cm^-1')),
