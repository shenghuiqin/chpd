...
species(
    ...
    E0 = (194.529,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3615,1277.5,1000,236.178,1681.15,3288.65],'cm^-1')),
        HinderedRotor(inertia=(0.242146,'amu*angstrom^2'), symmetry=1, barrier=(9.56371,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00301886,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (44.0526,'amu'),
