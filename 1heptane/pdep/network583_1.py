...
reaction(
    label = 'reaction3',
    reactants = ['butyl_1(82)'],
    products = ['butyl_2(132)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[CH2]C[CH2](128)', 'CH3(17)'],
    products = ['butyl_1(82)'],
    transitionState = 'TS5',
