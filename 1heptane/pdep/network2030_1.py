...
species(
    label = 'CCC=CC([O])CC(10929)',
    structure = SMILES('CCC=CC([O])CC'),
    E0 = (-41.419,'kJ/mol'),
    modes = [
...
species(
    ...
    molecularWeight = (113.178,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.103901,0.081707,-5.42616e-05,1.83628e-08,-2.54421e-12,-4923.08,33.285], Tmin=(100,'K'), Tmax=(1651.05,'K')), NASAPolynomial(coeffs=[17.4281,0.0392324,-1.56729e-05,2.78138e-09,-1.84899e-13,-10712.3,-60.0875], Tmin=(1651.05,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-42.2175,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(486.397,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(CC(C)OJ)"""),
)
...
species(
    label = 'CC[CH]C[C](O)CC(10931)',
    structure = SMILES('CC[CH]C[C](O)CC'),
    E0 = (-17.0291,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (114.185,'amu'),
...
species(
    label = 'C[CH]C(O)C[CH]CC(10932)',
    structure = SMILES('C[CH]C(O)C[CH]CC'),
    E0 = (6.24518,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3000,3050,390,425,1340,1360,335,370,3615,1277.5,1000,1380,1390,370,380,2900,435,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'CC[CH][CH]C(O)CC(10933)',
    structure = SMILES('CC[CH][CH]C(O)CC'),
    E0 = (6.24518,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (114.185,'amu'),
...
species(
    label = 'C[CH][CH]CC(O)CC(10934)',
    structure = SMILES('C[CH][CH]CC(O)CC'),
    E0 = (0.789405,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (114.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.230189,0.0894688,-9.42866e-05,7.45859e-08,-2.66468e-11,224.435,37.5306], Tmin=(100,'K'), Tmax=(776.13,'K')), NASAPolynomial(coeffs=[4.04905,0.0624179,-2.77636e-05,5.21128e-09,-3.59826e-13,-146.395,21.5045], Tmin=(776.13,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(0.789405,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJC) + radical(RCCJCC)"""),
)

species(
    label = '[CH2]C[CH]CC(O)CC(10935)',
...
species(
    ...
    molecularWeight = (114.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.170145,0.0846724,-5.7035e-05,1.99062e-08,-2.87046e-12,-32628.1,33.7067], Tmin=(100,'K'), Tmax=(1580.91,'K')), NASAPolynomial(coeffs=[16.4903,0.0425183,-1.70384e-05,3.03971e-09,-2.03256e-13,-37895.8,-54.301], Tmin=(1580.91,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-272.578,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'CC[CH]CC(=O)CC(7363)'],
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'CCC=CC([O])CC(10929)'],
    products = ['CC[CH]CC([O])CC(10553)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', 'CC=CCC([O])CC(10930)'],
    products = ['CC[CH]CC([O])CC(10553)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(1.46e+08,'cm^3/(mol*s)'), n=1.64, Ea=(5.73208,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""From training reaction 2555 used for Cds-CsH_Cds-CsH;HJ
Exact match found for rate rule [Cds-CsH_Cds-CsH;HJ]
...
reaction(
    label = 'reaction5',
    reactants = ['C2H5(29)', 'CC[CH]CC=O(1724)'],
    products = ['CC[CH]CC([O])CC(10553)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['CH3(17)', 'C=CCC([O])CC(10656)'],
    products = ['CC[CH]CC([O])CC(10553)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction12',
    reactants = ['C[CH]C(O)C[CH]CC(10932)'],
    products = ['CC[CH]CC([O])CC(10553)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CC[CH]CC([O])CC(10553)'],
    products = ['CC[CH][CH]C(O)CC(10933)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]CC(O)C[CH]CC(10641)'],
    products = ['CC[CH]CC([O])CC(10553)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CC[CH]CC([O])CC(10553)'],
    products = ['C[CH][CH]CC(O)CC(10934)'],
...
reaction(
    label = 'reaction20',
    reactants = ['CC[CH]CC([O])CC(10553)'],
    products = ['[CH2]C[CH]CC(O)CC(10935)'],
...
reaction(
    label = 'reaction26',
    reactants = ['CH2(S)(23)', 'C[CH]CC([O])CC(10579)'],
    products = ['CC[CH]CC([O])CC(10553)'],
...
reaction(
    label = 'reaction28',
    reactants = ['[CH2]C(C)CC([O])CC(10938)'],
    products = ['CC[CH]CC([O])CC(10553)'],
...
reaction(
    label = 'reaction30',
    reactants = ['CC[CH]C[CH]CC(194)', 'O(4)'],
    products = ['CC[CH]CC([O])CC(10553)'],
