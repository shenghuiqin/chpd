...
species(
    label = 'CCCC=CCC[CH]OO(11618)',
    structure = SMILES('CCCC=CCC[CH]OO'),
    E0 = (-22.4933,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,2995,3025,975,1000,1300,1375,400,500,1630,1680,3025,407.5,1350,352.5,3615,1310,387.5,850,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.777599,0.110065,-8.96372e-05,4.06986e-08,-7.98301e-12,-2537.62,40.0547], Tmin=(100,'K'), Tmax=(1161.66,'K')), NASAPolynomial(coeffs=[13.0783,0.0623544,-2.80316e-05,5.34392e-09,-3.74429e-13,-5756.81,-28.8684], Tmin=(1161.66,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-22.4933,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(573.699,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(CCsJOOH)"""),
)

species(
    label = 'CCCCC=CC[CH]OO(11619)',
    structure = SMILES('CCCCC=CC[CH]OO'),
    E0 = (-22.4933,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,2995,3025,975,1000,1300,1375,400,500,1630,1680,3025,407.5,1350,352.5,3615,1310,387.5,850,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'CCCC[CH]CC=COO(11620)',
    structure = SMILES('CCCC[CH]CC=COO'),
    E0 = (-1.48228,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,2995,3025,975,1000,1300,1375,400,500,1630,1680,3025,407.5,1350,352.5,3615,1310,387.5,850,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (143.203,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.624103,0.106375,-8.58718e-05,3.94374e-08,-7.88734e-12,-15.7886,42.127], Tmin=(100,'K'), Tmax=(1137.86,'K')), NASAPolynomial(coeffs=[11.992,0.0620257,-2.74086e-05,5.18464e-09,-3.61777e-13,-2886.9,-20.3679], Tmin=(1137.86,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1.48228,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(573.699,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(RCCJCC)"""),
)
...
species(
    label = 'CCC[CH]CCC[CH]OO(11622)',
    structure = SMILES('CCC[CH]CCC[CH]OO'),
    E0 = (55.2933,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2761.11,2772.22,2783.33,2794.44,2805.56,2816.67,2827.78,2838.89,2850,1425,1431.25,1437.5,1443.75,1450,1225,1237.5,1250,1262.5,1275,1270,1287.5,1305,1322.5,1340,700,725,750,775,800,300,325,350,375,400,3000,3050,390,425,1340,1360,335,370,3615,1310,387.5,850,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'CCCC[CH]C[CH]COO(11623)',
    structure = SMILES('CCCC[CH]C[CH]COO'),
    E0 = (67.1257,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (144.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0565911,0.105847,-4.4664e-05,-9.82294e-08,1.1547e-10,8202.5,41.7548], Tmin=(100,'K'), Tmax=(481.363,'K')), NASAPolynomial(coeffs=[6.91188,0.0753488,-3.5036e-05,6.72245e-09,-4.7065e-13,7214.09,9.93255], Tmin=(481.363,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(67.1257,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(594.485,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(CCJCOOH)"""),
)

species(
    label = 'CCCC[CH]CCCO[O](11624)',
    structure = SMILES('CCCC[CH]CCCO[O]'),
    E0 = (18.7155,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2759.09,2768.18,2777.27,2786.36,2795.45,2804.55,2813.64,2822.73,2831.82,2840.91,2850,1425,1430,1435,1440,1445,1450,1225,1235,1245,1255,1265,1275,1270,1284,1298,1312,1326,1340,700,720,740,760,780,800,300,320,340,360,380,400,3025,407.5,1350,352.5,492.5,1135,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (144.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.05306,0.119882,-0.000136603,1.08065e-07,-3.76851e-11,2424.62,43.5141], Tmin=(100,'K'), Tmax=(759.34,'K')), NASAPolynomial(coeffs=[6.30486,0.0745078,-3.39046e-05,6.42951e-09,-4.46505e-13,1497.88,11.2977], Tmin=(759.34,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(18.7155,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(598.642,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(ROOJ)"""),
)

species(
    label = 'CC[CH]CCCC[CH]OO(11625)',
    structure = SMILES('CC[CH]CCCC[CH]OO'),
    E0 = (55.2933,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2761.11,2772.22,2783.33,2794.44,2805.56,2816.67,2827.78,2838.89,2850,1425,1431.25,1437.5,1443.75,1450,1225,1237.5,1250,1262.5,1275,1270,1287.5,1305,1322.5,1340,700,725,750,775,800,300,325,350,375,400,3000,3050,390,425,1340,1360,335,370,3615,1310,387.5,850,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'CCCCCC[CH][CH]OO(11626)',
    structure = SMILES('CCCCCC[CH][CH]OO'),
    E0 = (61.2499,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2761.11,2772.22,2783.33,2794.44,2805.56,2816.67,2827.78,2838.89,2850,1425,1431.25,1437.5,1443.75,1450,1225,1237.5,1250,1262.5,1275,1270,1287.5,1305,1322.5,1340,700,725,750,775,800,300,325,350,375,400,3000,3050,390,425,1340,1360,335,370,3615,1310,387.5,850,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (144.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.19987,0.123334,-0.000123142,7.55615e-08,-2.03469e-11,7546.16,43.1981], Tmin=(100,'K'), Tmax=(869.787,'K')), NASAPolynomial(coeffs=[10.1903,0.0709521,-3.28064e-05,6.32192e-09,-4.45523e-13,5564.77,-10.1637], Tmin=(869.787,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(61.2499,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(594.485,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCsJOOH) + radical(CCJCOOH)"""),
)

species(
    label = 'CCCC[CH][CH]CCOO(11627)',
    structure = SMILES('CCCC[CH][CH]CCOO'),
    E0 = (61.1691,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2761.11,2772.22,2783.33,2794.44,2805.56,2816.67,2827.78,2838.89,2850,1425,1431.25,1437.5,1443.75,1450,1225,1237.5,1250,1262.5,1275,1270,1287.5,1305,1322.5,1340,700,725,750,775,800,300,325,350,375,400,3000,3050,390,425,1340,1360,335,370,3615,1310,387.5,850,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'C[CH]CCCCC[CH]OO(11628)',
    structure = SMILES('C[CH]CCCCC[CH]OO'),
    E0 = (55.2812,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (144.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.611476,0.114677,-9.0233e-05,9.89702e-09,2.6963e-11,6802.21,41.6216], Tmin=(100,'K'), Tmax=(553.098,'K')), NASAPolynomial(coeffs=[7.64474,0.0745356,-3.4439e-05,6.61165e-09,-4.64167e-13,5589.6,3.97387], Tmin=(553.098,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(55.2812,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(594.485,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCsJOOH) + radical(RCCJC)"""),
)

species(
    label = '[CH2]CCCCCC[CH]OO(11629)',
    structure = SMILES('[CH2]CCCCCC[CH]OO'),
    E0 = (66.0813,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (144.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.14063,0.121523,-0.000116048,6.67147e-08,-1.68049e-11,8125.69,42.4646], Tmin=(100,'K'), Tmax=(924.512,'K')), NASAPolynomial(coeffs=[10.8189,0.0697798,-3.20964e-05,6.17847e-09,-4.35446e-13,5914.3,-14.2949], Tmin=(924.512,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(66.0813,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(594.485,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCsJOOH) + radical(RCCJ)"""),
)

species(
    label = 'CCC[CH][CH]CCCOO(11630)',
    structure = SMILES('CCC[CH][CH]CCCOO'),
    E0 = (61.1691,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2761.11,2772.22,2783.33,2794.44,2805.56,2816.67,2827.78,2838.89,2850,1425,1431.25,1437.5,1443.75,1450,1225,1237.5,1250,1262.5,1275,1270,1287.5,1305,1322.5,1340,700,725,750,775,800,300,325,350,375,400,3000,3050,390,425,1340,1360,335,370,3615,1310,387.5,850,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'CC[CH]C[CH]CCCOO(11631)',
    structure = SMILES('CC[CH]C[CH]CCCOO'),
    E0 = (61.1691,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2761.11,2772.22,2783.33,2794.44,2805.56,2816.67,2827.78,2838.89,2850,1425,1431.25,1437.5,1443.75,1450,1225,1237.5,1250,1262.5,1275,1270,1287.5,1305,1322.5,1340,700,725,750,775,800,300,325,350,375,400,3000,3050,390,425,1340,1360,335,370,3615,1310,387.5,850,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'CCCCCCC[CH]O[O](11632)',
    structure = SMILES('CCCCCCC[CH]O[O]'),
    E0 = (12.8397,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (144.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.0164,0.11842,-0.000114647,6.956e-08,-1.86883e-11,1717.88,40.99], Tmin=(100,'K'), Tmax=(868.834,'K')), NASAPolynomial(coeffs=[9.38902,0.0705141,-3.19404e-05,6.0977e-09,-4.27472e-13,-90.2249,-7.74701], Tmin=(868.834,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(12.8397,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(598.642,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCsJOOH) + radical(ROOJ)"""),
)

species(
    label = 'C[CH]CC[CH]CCCOO(11633)',
    structure = SMILES('C[CH]CC[CH]CCCOO'),
    E0 = (61.1571,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (144.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.16362,0.124308,-0.00015402,1.31597e-07,-4.79032e-11,7531.08,45.8817], Tmin=(100,'K'), Tmax=(790.258,'K')), NASAPolynomial(coeffs=[4.91939,0.0778075,-3.59368e-05,6.82408e-09,-4.727e-13,7060.22,21.0704], Tmin=(790.258,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(61.1571,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(594.485,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(RCCJC)"""),
)

species(
    label = '[CH2]CCC[CH]CCCOO(11634)',
    structure = SMILES('[CH2]CCC[CH]CCCOO'),
    E0 = (71.9571,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2759.09,2768.18,2777.27,2786.36,2795.45,2804.55,2813.64,2822.73,2831.82,2840.91,2850,1425,1430,1435,1440,1445,1450,1225,1235,1245,1255,1265,1275,1270,1284,1298,1312,1326,1340,700,720,740,760,780,800,300,320,340,360,380,400,3615,1310,387.5,850,1000,3000,3100,440,815,1455,1000,3025,407.5,1350,352.5,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (144.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.380014,0.110536,-7.49413e-05,-1.99587e-08,4.8916e-11,8798.33,42.2936], Tmin=(100,'K'), Tmax=(526.981,'K')), NASAPolynomial(coeffs=[7.1459,0.0749199,-3.47865e-05,6.69352e-09,-4.70441e-13,7706.47,7.97278], Tmin=(526.981,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(71.9571,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(594.485,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(RCCJ) + radical(RCCJCC)"""),
)

species(
    label = 'CCCCC=CCCOO(11635)',
    structure = SMILES('CCCCC=CCCOO'),
    E0 = (-211.076,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (144.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.965763,0.109641,-8.13498e-05,3.20932e-08,-5.35473e-12,-25208.7,40.5682], Tmin=(100,'K'), Tmax=(1357.08,'K')), NASAPolynomial(coeffs=[16.0603,0.0594567,-2.58802e-05,4.84366e-09,-3.34844e-13,-29829.9,-46.7715], Tmin=(1357.08,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-211.076,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(598.642,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH)"""),
)

species(
    label = 'CCCCCCC=COO(11636)',
    structure = SMILES('CCCCCCC=COO'),
    E0 = (-195.941,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (144.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.46643,0.112864,-8.6221e-05,3.44563e-08,-5.66113e-12,-23363.7,42.5816], Tmin=(100,'K'), Tmax=(1416.49,'K')), NASAPolynomial(coeffs=[20.2602,0.05151,-2.12503e-05,3.87802e-09,-2.64285e-13,-29518.8,-69.8019], Tmin=(1416.49,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-195.941,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(598.642,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH)"""),
)

species(
    label = 'CCCC=CCCCOO(11637)',
    structure = SMILES('CCCC=CCCCOO'),
    E0 = (-211.076,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (144.211,'amu'),
...
species(
    label = '[CH2]C(CCC)CC[CH]OO(11639)',
    structure = SMILES('[CH2]C(CCC)CC[CH]OO'),
    E0 = (63.5702,'kJ/mol'),
    modes = [
...
species(
    label = 'CCCC[CH]CCC([O])O(11640)',
    structure = SMILES('CCCC[CH]CCC([O])O'),
    E0 = (-179.32,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (144.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.937113,0.118606,-0.000140151,1.18366e-07,-4.37456e-11,-21399,45.5926], Tmin=(100,'K'), Tmax=(764.655,'K')), NASAPolynomial(coeffs=[4.49944,0.0779359,-3.63765e-05,6.97095e-09,-4.86499e-13,-21872.9,23.1614], Tmin=(764.655,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-179.32,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(598.642,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + radical(CCOJ) + radical(RCCJCC)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['CCCC[CH]CC[CH]OO(8893)'],
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'CCCC=CCC[CH]OO(11618)'],
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'CCCCC=CC[CH]OO(11619)'],
    products = ['CCCC[CH]CC[CH]OO(8893)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(1.46e+08,'cm^3/(mol*s)'), n=1.64, Ea=(5.73208,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""From training reaction 2555 used for Cds-CsH_Cds-CsH;HJ
Exact match found for rate rule [Cds-CsH_Cds-CsH;HJ]
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', 'CCCC[CH]CC=COO(11620)'],
    products = ['CCCC[CH]CC[CH]OO(8893)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['npropyl(83)', 'C=CCC[CH]OO(11621)'],
    products = ['CCCC[CH]CC[CH]OO(8893)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['OH(5)', 'CCCC[CH]CCC=O(3771)'],
    products = ['CCCC[CH]CC[CH]OO(8893)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['CCC[CH]CCC[CH]OO(11622)'],
    products = ['CCCC[CH]CC[CH]OO(8893)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['CCCC[CH]CC[CH]OO(8893)'],
    products = ['CCCC[CH]C[CH]COO(11623)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CCCC[CH]CCCO[O](11624)'],
    products = ['CCCC[CH]CC[CH]OO(8893)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CC[CH]CCCC[CH]OO(11625)'],
    products = ['CCCC[CH]CC[CH]OO(8893)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CCCCCC[CH][CH]OO(11626)'],
    products = ['CCCC[CH]CC[CH]OO(8893)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CCCC[CH][CH]CCOO(11627)'],
    products = ['CCCC[CH]CC[CH]OO(8893)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CCCC[CH]CC[CH]OO(8893)'],
    products = ['C[CH]CCCCC[CH]OO(11628)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]CCCCCC[CH]OO(11629)'],
    products = ['CCCC[CH]CC[CH]OO(8893)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CCC[CH][CH]CCCOO(11630)'],
    products = ['CCCC[CH]CC[CH]OO(8893)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CC[CH]C[CH]CCCOO(11631)'],
    products = ['CCCC[CH]CC[CH]OO(8893)'],
...
reaction(
    label = 'reaction21',
    reactants = ['CCCC[CH]CC[CH]OO(8893)'],
    products = ['C[CH]CC[CH]CCCOO(11633)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH2]CCC[CH]CCCOO(11634)'],
    products = ['CCCC[CH]CC[CH]OO(8893)'],
...
reaction(
    label = 'reaction27',
    reactants = ['CH2(S)(23)', 'CCC[CH]CC[CH]OO(11638)'],
    products = ['CCCC[CH]CC[CH]OO(8893)'],
...
reaction(
    label = 'reaction28',
    reactants = ['[CH2]C(CCC)CC[CH]OO(11639)'],
    products = ['CCCC[CH]CC[CH]OO(8893)'],
...
reaction(
    label = 'reaction32',
    reactants = ['CCCC[CH]CC[CH]OO(8893)'],
    products = ['CCCC[CH]CCC([O])O(11640)'],
...
reaction(
    label = 'reaction33',
    reactants = ['[CH]CCCC(141)', '[CH2]C[CH]OO(468)'],
    products = ['CCCC[CH]CC[CH]OO(8893)'],
...
reaction(
    label = 'reaction34',
    reactants = ['[CH2]C[CH]CCCC(199)', '[CH]OO(168)'],
    products = ['CCCC[CH]CC[CH]OO(8893)'],
