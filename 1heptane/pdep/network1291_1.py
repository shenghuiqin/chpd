...
species(
    label = 'O1OOO1(5569)',
    structure = SMILES('O1OOO1'),
    E0 = (252.902,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (63.9976,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[4.59422,-0.0495004,0.000211019,-2.59805e-07,1.02245e-10,30429.8,13.1354], Tmin=(100,'K'), Tmax=(907.946,'K')), NASAPolynomial(coeffs=[20.5663,-0.0259014,1.67943e-05,-3.20981e-09,2.06742e-13,23656.4,-83.707], Tmin=(907.946,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(252.902,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(83.1447,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsOs) + group(O2s-OsOs) + group(O2s-OsOs) + group(O2s-OsOs) + ring(Cyclobutane)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[O]OO[O](4544)'],
    products = ['O2(S)(4921)', 'O2(S)(4921)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['[O]OO[O](4544)'],
    products = ['O(4)', '[O-][O+]=O(4545)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(4.60322e+09,'s^-1'), n=1.08, Ea=(235.828,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [R2OO;Y_rad_intra;OOJ]
Euclidian distance = 0
Multiplied by reaction path degeneracy 2.0
family: Cyclic_Ether_Formation
Ea raised from 235.8 to 235.8 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction3',
    reactants = ['[O]OO[O](4544)'],
    products = ['O1OOO1(5569)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O(4)', '[O]O[O](145)'],
    products = ['[O]OO[O](4544)'],
    transitionState = 'TS4',
