...
species(
    label = '[CH2]C1C=C1O[CH]C(28564)',
    structure = SMILES('[CH2]C1C=C1O[CH]C'),
    E0 = (406.669,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (96.1271,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.4321,0.0850661,-9.07073e-05,4.80409e-08,-9.72279e-12,49081.2,26.3333], Tmin=(100,'K'), Tmax=(1308.56,'K')), NASAPolynomial(coeffs=[20.9003,0.0144289,-3.51354e-06,4.4847e-10,-2.46176e-14,43963,-80.5443], Tmin=(1308.56,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(406.669,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)(Cds-Cds)CsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + ring(Cyclopropene) + radical(CCsJOC(O)) + radical(Isobutyl)"""),
)
...
species(
    label = 'C#CO[CH]C(4302)',
    structure = SMILES('C#CO[CH]C'),
    E0 = (204.276,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,750,770,3400,2100,2750,2800,2850,1350,1500,750,1050,1375,1000,2175,525,180,180],'cm^-1')),
        HinderedRotor(inertia=(1.17654,'amu*angstrom^2'), symmetry=1, barrier=(27.0509,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.17542,'amu*angstrom^2'), symmetry=1, barrier=(27.0253,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.17489,'amu*angstrom^2'), symmetry=1, barrier=(27.0131,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
species(
    label = '[CH]=C(C=C)OC[CH2](28566)',
    structure = SMILES('[CH]=C(C=C)OC[CH2]'),
    E0 = (319.85,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,350,440,435,1725,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.840926,'amu*angstrom^2'), symmetry=1, barrier=(19.3345,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.841347,'amu*angstrom^2'), symmetry=1, barrier=(19.3442,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.841378,'amu*angstrom^2'), symmetry=1, barrier=(19.3449,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.842033,'amu*angstrom^2'), symmetry=1, barrier=(19.36,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (96.1271,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.480072,0.0836048,-8.47976e-05,4.21905e-08,-8.02017e-12,38643.1,27.827], Tmin=(100,'K'), Tmax=(1391.24,'K')), NASAPolynomial(coeffs=[21.9435,0.0137398,-3.65471e-06,5.20738e-10,-3.14689e-14,32925.8,-85.8815], Tmin=(1391.24,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(319.85,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-Cds(Cds-Cds)O2s) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cds_P) + radical(CJCO)"""),
)

species(
    label = 'C=[C]C(=C)O[CH]C(28567)',
    ...
    molecularWeight = (96.1271,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.209952,0.0851762,-8.51147e-05,3.69635e-08,-4.14052e-12,30718,24.8842], Tmin=(100,'K'), Tmax=(935.375,'K')), NASAPolynomial(coeffs=[19.9889,0.0170481,-5.12782e-06,8.13101e-10,-5.33963e-14,26141,-75.4818], Tmin=(935.375,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(254.088,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-Cds(Cds-Cds)O2s) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(C=CJC=C) + radical(CCsJOC(O))"""),
)

species(
    label = '[CH]=C([C]=C)OCC(28568)',
    ...
    molecularWeight = (96.1271,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.252938,0.0722216,-4.79647e-05,8.91098e-09,2.23083e-12,34296.8,26.107], Tmin=(100,'K'), Tmax=(1039.59,'K')), NASAPolynomial(coeffs=[16.3251,0.0285022,-1.10298e-05,1.99294e-09,-1.37787e-13,29975.9,-56.7656], Tmin=(1039.59,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(283.965,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[CH]=CC(=C)O[CH]C(28569)',
...
species(
    label = '[CH]=CC(=[CH])OCC(28570)',
    structure = SMILES('[CH]=CC(=[CH])OCC'),
    E0 = (355.357,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,3115,3125,620,680,785,800,1600,1700,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.802554,'amu*angstrom^2'), symmetry=1, barrier=(18.4523,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.80381,'amu*angstrom^2'), symmetry=1, barrier=(18.4812,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.802732,'amu*angstrom^2'), symmetry=1, barrier=(18.4564,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (96.1271,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0688687,0.0765133,-6.33084e-05,1.73802e-08,1.69072e-12,42890,25.6188], Tmin=(100,'K'), Tmax=(968.77,'K')), NASAPolynomial(coeffs=[19.6106,0.0175992,-5.80031e-06,1.00461e-09,-7.01078e-14,38082.1,-73.3118], Tmin=(968.77,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(355.357,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-Cds(Cds-Cds)O2s) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cds_P) + radical(Cds_P)"""),
)
...
species(
    label = 'C[CH]OC1[CH]CC=1(28571)',
    structure = SMILES('C[CH]OC1[CH]CC=1'),
    E0 = (304.875,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (96.1271,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.829569,0.0489189,2.2217e-05,-7.58917e-08,3.58242e-11,36801.2,25.4791], Tmin=(100,'K'), Tmax=(942.674,'K')), NASAPolynomial(coeffs=[21.8638,0.0120195,-2.37451e-06,4.14674e-10,-3.69856e-14,30509.3,-87.0953], Tmin=(942.674,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(304.875,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + ring(Cyclobutene) + radical(CCJCO) + radical(CCsJOC(O))"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH]=C(C=C)O[CH]C(26684)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[CH]=C(C=C)O[CH]C(26684)'],
    products = ['[CH2]C1C=C1O[CH]C(28564)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', '[CH]=C(C=C)OC=C(26672)'],
    products = ['[CH]=C(C=C)O[CH]C(26684)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['C2H3(30)', 'C#CO[CH]C(4302)'],
    products = ['[CH]=C(C=C)O[CH]C(26684)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH]=C(C=C)OC[CH2](28566)'],
    products = ['[CH]=C(C=C)O[CH]C(26684)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH]=CC(=C)O[CH]C(28569)'],
    products = ['[CH]=C(C=C)O[CH]C(26684)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH]=C(C=C)O[CH]C(26684)'],
    products = ['C[CH]OC1[CH]CC=1(28571)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CHCH3(T)(95)', '[CH]=C([O])C=C(5816)'],
    products = ['[CH]=C(C=C)O[CH]C(26684)'],
