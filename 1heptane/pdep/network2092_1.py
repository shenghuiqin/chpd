...
species(
    label = 'CC=COC(C)[O](11343)',
    structure = SMILES('CC=COC(C)[O]'),
    E0 = (-196.058,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2995,3025,975,1000,1300,1375,400,500,1630,1680,1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,180,180,180,4000],'cm^-1')),
        HinderedRotor(inertia=(0.941326,'amu*angstrom^2'), symmetry=1, barrier=(21.6429,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.941311,'amu*angstrom^2'), symmetry=1, barrier=(21.6426,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.941172,'amu*angstrom^2'), symmetry=1, barrier=(21.6394,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.941216,'amu*angstrom^2'), symmetry=1, barrier=(21.6404,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (101.124,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.49999,0.0664031,-4.03312e-05,3.92798e-09,3.34245e-12,-23445.3,27.0753], Tmin=(100,'K'), Tmax=(1061.51,'K')), NASAPolynomial(coeffs=[16.117,0.026429,-1.05157e-05,1.95327e-09,-1.37477e-13,-27824.2,-54.209], Tmin=(1061.51,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-196.058,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(CCOJ)"""),
)
...
species(
    ...
    molecularWeight = (102.132,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.37516,0.0640478,-4.93711e-05,2.4785e-08,-6.19747e-12,-8543.66,29.1945], Tmin=(100,'K'), Tmax=(861.75,'K')), NASAPolynomial(coeffs=[4.6149,0.0490098,-2.31952e-05,4.53463e-09,-3.22676e-13,-9102.03,14.0467], Tmin=(861.75,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-71.777,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(CCJCO)"""),
)

species(
    label = 'CC[CH]O[C](C)O(11113)',
    ...
    molecularWeight = (102.132,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.397459,0.0818509,-8.37482e-05,4.75769e-08,-1.11794e-11,-13304.6,29.464], Tmin=(100,'K'), Tmax=(1016.12,'K')), NASAPolynomial(coeffs=[12.0925,0.0358129,-1.57864e-05,2.98761e-09,-2.08843e-13,-15681.3,-27.1446], Tmin=(1016.12,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-111.682,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCsJOCs) + radical(Cs_P)"""),
)

species(
    label = 'CCCO[C](C)[O](11346)',
    ...
    molecularWeight = (102.132,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.93324,0.0737084,-8.33643e-05,6.92909e-08,-2.60964e-11,-7885.5,28.9498], Tmin=(100,'K'), Tmax=(724.626,'K')), NASAPolynomial(coeffs=[4.20221,0.0503711,-2.41e-05,4.68789e-09,-3.30712e-13,-8220.31,15.1906], Tmin=(724.626,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-66.4327,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Cs_P) + radical(CCOJ)"""),
)

species(
    label = '[CH2]CCOC(C)[O](11347)',
    ...
    molecularWeight = (102.132,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.93324,0.0737084,-8.33643e-05,6.92909e-08,-2.60964e-11,-7885.5,30.0485], Tmin=(100,'K'), Tmax=(724.626,'K')), NASAPolynomial(coeffs=[4.20221,0.0503711,-2.41e-05,4.68789e-09,-3.30712e-13,-8220.31,16.2892], Tmin=(724.626,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-66.4327,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJ) + radical(CCOJ)"""),
)
...
species(
    label = '[CH2]C([O])OCCC(11117)',
    structure = SMILES('[CH2]C([O])OCCC'),
    E0 = (-60.0899,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (102.132,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.69245,0.062368,-4.79627e-06,-1.2078e-07,1.25624e-10,-7156.23,26.4118], Tmin=(100,'K'), Tmax=(442.133,'K')), NASAPolynomial(coeffs=[5.30104,0.0487677,-2.32744e-05,4.51791e-09,-3.18229e-13,-7661.49,9.84229], Tmin=(442.133,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-60.0899,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJCO) + radical(CCOJ)"""),
)

species(
    label = 'C[CH][CH]OC(C)O(11118)',
    ...
    molecularWeight = (102.132,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.402228,0.0778132,-7.17923e-05,3.55577e-08,-7.20404e-12,-13944.4,31.2469], Tmin=(100,'K'), Tmax=(1174.97,'K')), NASAPolynomial(coeffs=[13.7999,0.0322027,-1.35645e-05,2.5197e-09,-1.74485e-13,-17092.7,-35.5495], Tmin=(1174.97,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-117.026,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJCO) + radical(CCsJOCs)"""),
)

species(
    label = '[CH2]C[CH]OC(C)O(11119)',
    ...
    molecularWeight = (102.132,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.397459,0.0818509,-8.37482e-05,4.75769e-08,-1.11794e-11,-13304.6,30.5626], Tmin=(100,'K'), Tmax=(1016.12,'K')), NASAPolynomial(coeffs=[12.0925,0.0358129,-1.57864e-05,2.98761e-09,-2.08843e-13,-15681.3,-26.046], Tmin=(1016.12,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-111.682,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCsJOCs) + radical(RCCJ)"""),
)
...
species(
    ...
    molecularWeight = (102.132,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.10409,0.0558165,-2.32127e-05,-9.47651e-11,1.61466e-12,-58494.2,26.5], Tmin=(100,'K'), Tmax=(1344.85,'K')), NASAPolynomial(coeffs=[11.7698,0.0364144,-1.53148e-05,2.80256e-09,-1.90341e-13,-62477.1,-32.2584], Tmin=(1344.85,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-487.268,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)HHH) + group(Cds-OdCsOs)"""),
)

species(
    label = 'CC=COC(C)O(11121)',
    structure = SMILES('CC=COC(C)O'),
    E0 = (-421.764,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (102.132,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.215224,0.0683075,-2.54999e-05,-2.37073e-08,1.61405e-11,-50576.7,27.2331], Tmin=(100,'K'), Tmax=(965.636,'K')), NASAPolynomial(coeffs=[20.0709,0.0212361,-7.02462e-06,1.26369e-09,-9.16318e-14,-56051.5,-76.3572], Tmin=(965.636,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-421.764,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH)"""),
)
...
species(
    label = 'C[CH]OC(C)[O](1179)',
    structure = SMILES('C[CH]OC(C)[O]'),
    E0 = (-67.4428,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,315.203,315.216,315.441,315.718],'cm^-1')),
        HinderedRotor(inertia=(0.0016905,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0869272,'amu*angstrom^2'), symmetry=1, barrier=(6.11638,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0862302,'amu*angstrom^2'), symmetry=1, barrier=(6.11469,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00168939,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
species(
    ...
    molecularWeight = (102.132,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.47617,0.0843425,-0.00010817,9.03257e-08,-3.21313e-11,-8505.54,29.3084], Tmin=(100,'K'), Tmax=(759.26,'K')), NASAPolynomial(coeffs=[6.39413,0.0470274,-2.23249e-05,4.30252e-09,-3.00942e-13,-9227.29,3.55258], Tmin=(759.26,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-71.7199,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJC(C)OC) + radical(CCOJ)"""),
)

species(
    label = 'CCC1OC(C)O1(11272)',
    structure = SMILES('CCC1OC(C)O1'),
    E0 = (-348.852,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (102.132,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.25519,0.0444982,2.41538e-05,-5.66525e-08,2.24715e-11,-41844.7,24.2561], Tmin=(100,'K'), Tmax=(1038.32,'K')), NASAPolynomial(coeffs=[13.7631,0.0337433,-1.43825e-05,2.80872e-09,-2.04417e-13,-46459.8,-46.2739], Tmin=(1038.32,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-348.852,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(394.937,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Cyclobutane)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'CC=COC(C)[O](11343)'],
    products = ['CC[CH]OC(C)[O](11116)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'CC[CH]OC(C)=O(11344)'],
    products = ['CC[CH]OC(C)[O](11116)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['CH3(17)', 'C=COC(C)[O](2314)'],
    products = ['CC[CH]OC(C)[O](11116)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['CH3(17)', 'CC[CH]OC=O(10830)'],
    products = ['CC[CH]OC(C)[O](11116)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction11',
    reactants = ['CC[CH]OC(C)[O](11116)'],
    products = ['[CH2]C(O)O[CH]CC(10719)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CC[CH]OC(C)[O](11116)'],
    products = ['[CH2]C[CH]OC(C)O(11119)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CH2(S)(23)', 'C[CH]OC(C)[O](1179)'],
    products = ['CC[CH]OC(C)[O](11116)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CH2(S)(23)', 'CC[CH]OC[O](10705)'],
    products = ['CC[CH]OC(C)[O](11116)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2]C(C)OC(C)[O](11349)'],
    products = ['CC[CH]OC(C)[O](11116)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH]CC(144)', 'CC([O])[O](2201)'],
    products = ['CC[CH]OC(C)[O](11116)'],
...
reaction(
    label = 'reaction23',
    reactants = ['O(4)', 'C[CH]O[CH]CC(1894)'],
    products = ['CC[CH]OC(C)[O](11116)'],
