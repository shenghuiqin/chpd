...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0704783,0.07933,-4.37243e-05,1.17101e-08,-1.26561e-12,8769.74,36.1539], Tmin=(100,'K'), Tmax=(2057.35,'K')), NASAPolynomial(coeffs=[19.6287,0.0413043,-1.60003e-05,2.72646e-09,-1.73962e-13,722.048,-72.313], Tmin=(2057.35,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(71.6929,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(532.126,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(RCCJC)"""),
)

species(
    label = 'CC=CC[CH]CCC(612)',
    ...
    molecularWeight = (111.205,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.758733,0.0758533,-3.92444e-05,9.4646e-09,-9.10754e-13,8598.2,32.7821], Tmin=(100,'K'), Tmax=(2226.82,'K')), NASAPolynomial(coeffs=[18.133,0.0446442,-1.82218e-05,3.17084e-09,-2.04169e-13,860.322,-64.9481], Tmin=(2226.82,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(70.5702,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(532.126,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(RCCJCC)"""),
)

species(
    label = 'C[CH]CC=CCCC(613)',
...
species(
    ...
    molecularWeight = (112.213,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.41826,0.0680119,2.71661e-05,-1.56138e-07,1.31985e-10,18058.1,32.8837], Tmin=(100,'K'), Tmax=(447.836,'K')), NASAPolynomial(coeffs=[2.8375,0.0703965,-3.12669e-05,5.94383e-09,-4.16982e-13,17780,25.4906], Tmin=(447.836,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(149.468,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(552.912,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJC) + radical(RCCJC)"""),
)

species(
    label = 'CCC[CH][CH]CCC(499)',
...
species(
    ...
    molecularWeight = (112.213,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.447726,0.083168,-4.79777e-05,1.41592e-08,-1.80077e-12,19397.9,35.825], Tmin=(100,'K'), Tmax=(1617.34,'K')), NASAPolynomial(coeffs=[10.7068,0.0577954,-2.4446e-05,4.4595e-09,-3.01439e-13,16079.4,-18.6016], Tmin=(1617.34,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(160.268,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(552.912,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJ) + radical(RCCJC)"""),
)

species(
    label = '[CH2][CH]CCCCCC(495)',
...
species(
    ...
    molecularWeight = (112.213,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.554112,0.0867123,-5.06134e-05,1.44888e-08,-1.66707e-12,-14724.7,35.0218], Tmin=(100,'K'), Tmax=(1981.74,'K')), NASAPolynomial(coeffs=[22.6406,0.0398967,-1.51791e-05,2.56887e-09,-1.63383e-13,-23918.1,-92.7443], Tmin=(1981.74,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-123.888,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(557.07,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH)"""),
)
...
species(
    ...
    molecularWeight = (112.213,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.262018,0.080941,-3.17241e-05,-5.78609e-09,5.24173e-12,-14599.8,33.9021], Tmin=(100,'K'), Tmax=(1159.54,'K')), NASAPolynomial(coeffs=[14.6809,0.0508556,-2.05693e-05,3.76328e-09,-2.58751e-13,-19508,-46.6224], Tmin=(1159.54,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-122.753,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(557.07,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH)"""),
)
...
species(
    ...
    molecularWeight = (112.213,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.426647,0.0849512,-4.26978e-05,5.19306e-09,1.55006e-12,-13258,34.9638], Tmin=(100,'K'), Tmax=(1248.81,'K')), NASAPolynomial(coeffs=[15.7327,0.0496311,-2.00188e-05,3.62701e-09,-2.46632e-13,-18575.8,-51.7182], Tmin=(1248.81,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-111.643,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(557.07,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH)"""),
)
...
species(
    ...
    molecularWeight = (112.213,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.262018,0.080941,-3.17241e-05,-5.78609e-09,5.24173e-12,-14599.8,34.5952], Tmin=(100,'K'), Tmax=(1159.54,'K')), NASAPolynomial(coeffs=[14.6809,0.0508556,-2.05693e-05,3.76328e-09,-2.58751e-13,-19508,-45.9293], Tmin=(1159.54,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-122.753,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(557.07,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'C[CH]CCC=CCC(611)'],
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'CC=CC[CH]CCC(612)'],
    products = ['C[CH]CC[CH]CCC(501)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(1.46e+08,'cm^3/(mol*s)'), n=1.64, Ea=(5.73208,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""From training reaction 2555 used for Cds-CsH_Cds-CsH;HJ
Exact match found for rate rule [Cds-CsH_Cds-CsH;HJ]
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', 'C[CH]CC=CCCC(613)'],
    products = ['C[CH]CC[CH]CCC(501)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(1.46e+08,'cm^3/(mol*s)'), n=1.64, Ea=(5.73208,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""From training reaction 2555 used for Cds-CsH_Cds-CsH;HJ
Exact match found for rate rule [Cds-CsH_Cds-CsH;HJ]
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)', 'C=CCC[CH]CCC(614)'],
    products = ['C[CH]CC[CH]CCC(501)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['C=CCC[CH]C(370)', 'C2H5(29)'],
    products = ['C[CH]CC[CH]CCC(501)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction25',
    reactants = ['C[CH]CC[CH]CC(181)', 'CH2(S)(23)'],
    products = ['C[CH]CC[CH]CCC(501)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[CH2]C(CC)CC[CH]C(482)'],
    products = ['C[CH]CC[CH]CCC(501)'],
...
reaction(
    label = 'reaction28',
    reactants = ['[CH2]C(C[CH]C)CCC(515)'],
    products = ['C[CH]CC[CH]CCC(501)'],
...
reaction(
    label = 'reaction30',
    reactants = ['[CH2]C[CH]CCC(203)', 'CHCH3(T)(95)'],
    products = ['C[CH]CC[CH]CCC(501)'],
...
reaction(
    label = 'reaction31',
    reactants = ['[CH2]C[CH]C(129)', '[CH]CCC(133)'],
    products = ['C[CH]CC[CH]CCC(501)'],
