...
species(
    label = 'C=C(CCC)O[O](5692)',
    structure = SMILES('C=C(CCC)O[O]'),
    E0 = (21.6389,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2950,3100,1380,975,1025,1650,350,440,435,1725,492.5,1135,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,302.1,4000],'cm^-1')),
        HinderedRotor(inertia=(0.156088,'amu*angstrom^2'), symmetry=1, barrier=(10.1088,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156105,'amu*angstrom^2'), symmetry=1, barrier=(10.1088,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156098,'amu*angstrom^2'), symmetry=1, barrier=(10.1088,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156098,'amu*angstrom^2'), symmetry=1, barrier=(10.1088,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.25291,0.0622568,-4.79796e-05,2.07773e-08,-3.89971e-12,2699.8,27.0426], Tmin=(100,'K'), Tmax=(1206.7,'K')), NASAPolynomial(coeffs=[9.08965,0.0362793,-1.56881e-05,2.93719e-09,-2.03646e-13,808.481,-12.2376], Tmin=(1206.7,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(21.6389,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(ROOJ)"""),
)

species(
    label = 'CCC[C](C)O[O](5693)',
    ...
    molecularWeight = (102.132,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.46528,0.064758,-3.2121e-05,-3.76886e-08,4.8021e-11,8483.83,25.2528], Tmin=(100,'K'), Tmax=(505.746,'K')), NASAPolynomial(coeffs=[5.54392,0.046813,-2.13501e-05,4.07342e-09,-2.84875e-13,7888.22,6.54639], Tmin=(505.746,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(69.8541,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(C2CsJOOH) + radical(ROOJ)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'C=C(CCC)O[O](5692)'],
    products = ['[CH2]C(CCC)O[O](259)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2CHOO(46)', 'npropyl(83)'],
    products = ['[CH2]C(CCC)O[O](259)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]C(CC)O[O](241)', 'CH2(S)(23)'],
    products = ['[CH2]C(CCC)O[O](259)'],
...
reaction(
    label = 'reaction20',
    reactants = ['O(4)', '[CH2]C([O])CCC(1786)'],
    products = ['[CH2]C(CCC)O[O](259)'],
...
reaction(
    label = 'reaction21',
    reactants = ['CCC[CH]O[O](257)', 'CH2(19)'],
    products = ['[CH2]C(CCC)O[O](259)'],
