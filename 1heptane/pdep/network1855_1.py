species(
    label = 'CCCC[CH]CO[C](C)OO(8900)',
    structure = SMILES('CCCC[CH]CO[C](C)OO'),
    E0 = (-92.0715,'kJ/mol'),
    modes = [
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.43517,0.1274,-0.000115907,5.97663e-08,-1.32639e-11,-10884.5,46.5998], Tmin=(100,'K'), Tmax=(1044.26,'K')), NASAPolynomial(coeffs=[13.8154,0.0689819,-3.19928e-05,6.1934e-09,-4.38111e-13,-14069.5,-27.6358], Tmin=(1044.26,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-92.0715,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(615.271,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Cs_P) + radical(CCJCO)"""),
)
...
species(
    label = 'CCCC=CCO[C](C)OO(10108)',
    structure = SMILES('CCCC=CCO[C](C)OO'),
    E0 = (-169.745,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2995,3025,975,1000,1300,1375,400,500,1630,1680,360,370,350,3615,1310,387.5,850,1000,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.08282,0.119712,-0.000104567,5.15996e-08,-1.10479e-11,-20239.2,43.9229], Tmin=(100,'K'), Tmax=(1071.57,'K')), NASAPolynomial(coeffs=[12.9151,0.0674602,-3.14237e-05,6.09418e-09,-4.31401e-13,-23239.1,-24.5765], Tmin=(1071.57,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-169.745,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(594.485,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsOsH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Cs_P)"""),
)

species(
    label = 'CCCCC=CO[C](C)OO(10109)',
    structure = SMILES('CCCCC=CO[C](C)OO'),
    E0 = (-215.218,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2995,3025,975,1000,1300,1375,400,500,1630,1680,360,370,350,3615,1310,387.5,850,1000,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (159.203,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.9324,0.133813,-0.000118198,5.24599e-08,-9.18441e-12,-25619.6,47.4007], Tmin=(100,'K'), Tmax=(1382.72,'K')), NASAPolynomial(coeffs=[29.9839,0.0385917,-1.49001e-05,2.65592e-09,-1.79728e-13,-34722.4,-122.068], Tmin=(1382.72,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-215.218,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(594.485,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(Cs_P)"""),
)

species(
    label = 'C=C(OO)OC[CH]CCCC(10110)',
    structure = SMILES('C=C(OO)OC[CH]CCCC'),
    E0 = (-113.368,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (159.203,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.68657,0.128549,-0.000121907,6.3305e-08,-1.36817e-11,-13433.1,44.4105], Tmin=(100,'K'), Tmax=(1093.13,'K')), NASAPolynomial(coeffs=[17.3457,0.0589058,-2.63428e-05,5.02352e-09,-3.52707e-13,-17594.1,-49.1041], Tmin=(1093.13,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-113.368,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(594.485,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(CCJCO)"""),
)
...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.687146,0.0955531,-5.8327e-05,1.74227e-08,-2.11287e-12,-42968.1,42.1561], Tmin=(100,'K'), Tmax=(1848.76,'K')), NASAPolynomial(coeffs=[21.2878,0.0480078,-1.97508e-05,3.51198e-09,-2.31781e-13,-51093.4,-77.3641], Tmin=(1848.76,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-358.706,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(573.699,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)HHH) + group(Cds-OdCsOs) + radical(CCJCO)"""),
)

species(
    label = 'CCC[CH]CCO[C](C)OO(10113)',
    structure = SMILES('CCC[CH]CCO[C](C)OO'),
    E0 = (-97.5153,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,3025,407.5,1350,352.5,3615,1310,387.5,850,1000,360,370,350,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (160.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.838503,0.123251,-9.11874e-05,-2.12285e-08,6.06026e-11,-11570.7,44.7141], Tmin=(100,'K'), Tmax=(516.978,'K')), NASAPolynomial(coeffs=[8.32374,0.078527,-3.73435e-05,7.24254e-09,-5.10408e-13,-12867.7,3.17449], Tmin=(516.978,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-97.5153,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(615.271,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Cs_P) + radical(RCCJCC)"""),
)
...
species(
    label = '[CH2]C(OO)OC[CH]CCCC(10115)',
    structure = SMILES('[CH2]C(OO)OC[CH]CCCC'),
    E0 = (-83.3553,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (160.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.58795,0.129998,-0.000120846,6.3098e-08,-1.40343e-11,-9830.01,48.4539], Tmin=(100,'K'), Tmax=(1048.98,'K')), NASAPolynomial(coeffs=[14.8944,0.0671491,-3.09766e-05,5.98395e-09,-4.22874e-13,-13288,-31.8524], Tmin=(1048.98,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-83.3553,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(615.271,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJCO) + radical(CJCOOH)"""),
)

species(
    label = 'CCCC[CH][CH]OC(C)OO(10116)',
    structure = SMILES('CCCC[CH][CH]OC(C)OO'),
    E0 = (-116.862,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (160.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.91987,0.135476,-0.000131195,7.01434e-08,-1.56757e-11,-13846.4,47.0923], Tmin=(100,'K'), Tmax=(1056.92,'K')), NASAPolynomial(coeffs=[17.1566,0.0632793,-2.8732e-05,5.51361e-09,-3.88382e-13,-17878.9,-45.9968], Tmin=(1056.92,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-116.862,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(615.271,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCsJOCs) + radical(CCJCO)"""),
)

species(
    label = 'CCCC[CH]COC(C)O[O](10117)',
    structure = SMILES('CCCC[CH]COC(C)O[O]'),
    E0 = (-145.313,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (160.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.26812,0.123743,-0.000112376,5.96017e-08,-1.37657e-11,-17294,46.0738], Tmin=(100,'K'), Tmax=(1002.12,'K')), NASAPolynomial(coeffs=[12.1767,0.0700779,-3.20481e-05,6.16299e-09,-4.34341e-13,-19988.7,-18.8182], Tmin=(1002.12,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-145.313,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(619.428,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(CCJCO)"""),
)

species(
    label = 'CC[CH]CCCO[C](C)OO(10118)',
    structure = SMILES('CC[CH]CCCO[C](C)OO'),
    E0 = (-97.5153,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,3025,407.5,1350,352.5,3615,1310,387.5,850,1000,360,370,350,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'C[CH]CCCCO[C](C)OO(10119)',
    structure = SMILES('C[CH]CCCCO[C](C)OO'),
    E0 = (-97.5273,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (160.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.71222,0.136072,-0.000155241,1.12843e-07,-3.57467e-11,-11533.7,47.8381], Tmin=(100,'K'), Tmax=(750.81,'K')), NASAPolynomial(coeffs=[9.49075,0.0763867,-3.5996e-05,6.96053e-09,-4.89985e-13,-13215.9,-2.99876], Tmin=(750.81,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-97.5273,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(615.271,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Cs_P) + radical(RCCJC)"""),
)

species(
    label = '[CH2][C](OO)OCCCCCC(10120)',
    structure = SMILES('[CH2][C](OO)OCCCCCC'),
    E0 = (-78.011,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (160.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.74719,0.13578,-0.000138534,8.20733e-08,-2.07955e-11,-9183.52,47.23], Tmin=(100,'K'), Tmax=(929.955,'K')), NASAPolynomial(coeffs=[13.4669,0.0703399,-3.29813e-05,6.40499e-09,-4.53626e-13,-12013.2,-25.0646], Tmin=(929.955,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-78.011,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(615.271,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Cs_P) + radical(CJCOOH)"""),
)

species(
    label = '[CH2]CCCCCO[C](C)OO(10121)',
    structure = SMILES('[CH2]CCCCCO[C](C)OO'),
    E0 = (-86.7272,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2761.11,2772.22,2783.33,2794.44,2805.56,2816.67,2827.78,2838.89,2850,1425,1431.25,1437.5,1443.75,1450,1225,1237.5,1250,1262.5,1275,1270,1287.5,1305,1322.5,1340,700,725,750,775,800,300,325,350,375,400,360,370,350,3615,1310,387.5,850,1000,3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (160.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.61975,0.133469,-0.00013455,7.99214e-08,-2.05104e-11,-10236.9,46.5661], Tmin=(100,'K'), Tmax=(914.423,'K')), NASAPolynomial(coeffs=[12.393,0.0721727,-3.40013e-05,6.616e-09,-4.69037e-13,-12799.6,-19.7835], Tmin=(914.423,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-86.7272,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(615.271,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJ) + radical(Cs_P)"""),
)

species(
    label = 'CCC[CH][CH]COC(C)OO(10122)',
    structure = SMILES('CCC[CH][CH]COC(C)OO'),
    E0 = (-102.86,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (160.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.40449,0.129129,-0.000135493,9.06814e-08,-2.69165e-11,-12185.7,48.379], Tmin=(100,'K'), Tmax=(791.689,'K')), NASAPolynomial(coeffs=[8.9764,0.0766816,-3.61252e-05,7.00899e-09,-4.95307e-13,-13829.4,0.721711], Tmin=(791.689,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-102.86,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(615.271,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(CCJCO)"""),
)

species(
    label = 'CC[CH]C[CH]COC(C)OO(10123)',
    structure = SMILES('CC[CH]C[CH]COC(C)OO'),
    E0 = (-102.86,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (160.211,'amu'),
...
species(
    label = 'CCCCCCO[C](C)O[O](10124)',
    structure = SMILES('CCCCCCO[C](C)O[O]'),
    E0 = (-139.969,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (160.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.49654,0.130382,-0.000133233,8.29058e-08,-2.24661e-11,-16644.6,45.0949], Tmin=(100,'K'), Tmax=(867.617,'K')), NASAPolynomial(coeffs=[10.9762,0.072883,-3.38308e-05,6.5317e-09,-4.60762e-13,-18809.1,-13.3083], Tmin=(867.617,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-139.969,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(619.428,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Cs_P) + radical(ROOJ)"""),
)

species(
    label = 'C[CH]CC[CH]COC(C)OO(10125)',
    structure = SMILES('C[CH]CC[CH]COC(C)OO'),
    E0 = (-102.872,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (160.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.36099,0.127696,-0.000126911,7.77473e-08,-2.10118e-11,-12188,48.3954], Tmin=(100,'K'), Tmax=(864.356,'K')), NASAPolynomial(coeffs=[10.101,0.0746532,-3.48606e-05,6.74992e-09,-4.77008e-13,-14169.4,-5.23112], Tmin=(864.356,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-102.872,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(615.271,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJCO) + radical(RCCJC)"""),
)

species(
    label = '[CH2]CCC[CH]COC(C)OO(10126)',
    structure = SMILES('[CH2]CCC[CH]COC(C)OO'),
    E0 = (-92.0715,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (160.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.43517,0.1274,-0.000115907,5.97663e-08,-1.32639e-11,-10884.5,47.6984], Tmin=(100,'K'), Tmax=(1044.26,'K')), NASAPolynomial(coeffs=[13.8154,0.0689819,-3.19928e-05,6.1934e-09,-4.38111e-13,-14069.5,-26.5372], Tmin=(1044.26,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-92.0715,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(615.271,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJCO) + radical(RCCJ)"""),
)
...
species(
    label = 'CCCCC=COC(C)OO(10127)',
    structure = SMILES('CCCCC=COC(C)OO'),
    E0 = (-420.465,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (160.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.77563,0.130977,-0.000101281,3.31106e-08,-2.27072e-12,-50310.9,46.1383], Tmin=(100,'K'), Tmax=(1098.92,'K')), NASAPolynomial(coeffs=[27.9142,0.0444825,-1.76344e-05,3.24481e-09,-2.26249e-13,-58578.6,-111.745], Tmin=(1098.92,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-420.465,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(619.428,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH)"""),
)

species(
    label = 'C=C(OO)OCCCCCC(10128)',
    structure = SMILES('C=C(OO)OCCCCCC'),
    E0 = (-313.27,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (160.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.79305,0.132656,-0.000126372,6.70453e-08,-1.49421e-11,-37473.4,42.3013], Tmin=(100,'K'), Tmax=(1056.97,'K')), NASAPolynomial(coeffs=[16.3708,0.0639148,-2.88161e-05,5.51178e-09,-3.87522e-13,-41313,-46.3348], Tmin=(1056.97,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-313.27,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(619.428,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH)"""),
)

species(
    label = 'CCCC=CCOC(C)OO(10129)',
    structure = SMILES('CCCC=CCOC(C)OO'),
    E0 = (-374.991,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (160.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.129,0.119262,-9.57945e-05,4.2227e-08,-8.04235e-12,-44922,43.387], Tmin=(100,'K'), Tmax=(1188.43,'K')), NASAPolynomial(coeffs=[14.0697,0.068106,-3.12255e-05,6.00556e-09,-4.22645e-13,-48534.5,-32.5617], Tmin=(1188.43,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-374.991,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(619.428,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsOsH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH)"""),
)
...
species(
    label = '[CH2]C(CCC)CO[C](C)OO(10130)',
    structure = SMILES('[CH2]C(CCC)CO[C](C)OO'),
    E0 = (-92.5855,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (160.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.74237,0.133404,-0.000132365,7.60518e-08,-1.85802e-11,-10934.6,46.7112], Tmin=(100,'K'), Tmax=(965.947,'K')), NASAPolynomial(coeffs=[14.0758,0.0679004,-3.0645e-05,5.84725e-09,-4.10142e-13,-13990.5,-29.0539], Tmin=(965.947,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-92.5855,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(615.271,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Isobutyl) + radical(Cs_P)"""),
)
...
species(
    ...
    molecularWeight = (160.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.622934,0.116656,-8.2397e-05,-1.8591e-08,5.16402e-11,-38755.7,45.1151], Tmin=(100,'K'), Tmax=(528.714,'K')), NASAPolynomial(coeffs=[7.85031,0.076279,-3.51641e-05,6.73505e-09,-4.7171e-13,-39983.3,6.50031], Tmin=(528.714,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-323.496,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(619.428,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsOs) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(CCJCO)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['CCCC[CH]CO[C](C)OO(8900)'],
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'CCCC=CCO[C](C)OO(10108)'],
    products = ['CCCC[CH]CO[C](C)OO(8900)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'CCCCC=CO[C](C)OO(10109)'],
    products = ['CCCC[CH]CO[C](C)OO(8900)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', 'C=C(OO)OC[CH]CCCC(10110)'],
    products = ['CCCC[CH]CO[C](C)OO(8900)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['npropyl(83)', 'C=CCO[C](C)OO(10111)'],
    products = ['CCCC[CH]CO[C](C)OO(8900)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['OH(5)', 'CCCC[CH]COC(C)=O(10112)'],
    products = ['CCCC[CH]CO[C](C)OO(8900)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['CCC[CH]CCO[C](C)OO(10113)'],
    products = ['CCCC[CH]CO[C](C)OO(8900)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]C(OO)OC[CH]CCCC(10115)'],
    products = ['CCCC[CH]CO[C](C)OO(8900)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CCCC[CH]CO[C](C)OO(8900)'],
    products = ['CCCC[CH][CH]OC(C)OO(10116)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CCCC[CH]COC(C)O[O](10117)'],
    products = ['CCCC[CH]CO[C](C)OO(8900)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CC[CH]CCCO[C](C)OO(10118)'],
    products = ['CCCC[CH]CO[C](C)OO(8900)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CCCC[CH]CO[C](C)OO(8900)'],
    products = ['C[CH]CCCCO[C](C)OO(10119)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2][C](OO)OCCCCCC(10120)'],
    products = ['CCCC[CH]CO[C](C)OO(8900)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]CCCCCO[C](C)OO(10121)'],
    products = ['CCCC[CH]CO[C](C)OO(8900)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CCCC[CH]CO[C](C)OO(8900)'],
    products = ['CCC[CH][CH]COC(C)OO(10122)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CCCC[CH]CO[C](C)OO(8900)'],
    products = ['CC[CH]C[CH]COC(C)OO(10123)'],
    transitionState = 'TS18',
    kinetics = Arrhenius(A=(4.8852e+09,'s^-1'), n=0.909873, Ea=(161.496,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [RnH;C_rad_out_NonDe;Cs_H_out_H/NonDeC] for rate rule [R6HJ_3;C_rad_out_NDMustO;Cs_H_out_H/(NonDeC/Cs)]
Euclidian distance = 2.44948974278
Multiplied by reaction path degeneracy 2.0
family: intra_H_migration"""),
)
...
reaction(
    label = 'reaction19',
    reactants = ['CCCC[CH]CO[C](C)OO(8900)'],
    products = ['CCCCCCO[C](C)O[O](10124)'],
...
reaction(
    label = 'reaction20',
    reactants = ['CCCC[CH]CO[C](C)OO(8900)'],
    products = ['C[CH]CC[CH]COC(C)OO(10125)'],
...
reaction(
    label = 'reaction21',
    reactants = ['CCCC[CH]CO[C](C)OO(8900)'],
    products = ['[CH2]CCC[CH]COC(C)OO(10126)'],
...
reaction(
    label = 'reaction26',
    reactants = ['CH2(S)(23)', 'CCC[CH]CO[C](C)OO(8906)'],
    products = ['CCCC[CH]CO[C](C)OO(8900)'],
...
reaction(
    label = 'reaction27',
    reactants = ['[CH2]C(CCC)CO[C](C)OO(10130)'],
    products = ['CCCC[CH]CO[C](C)OO(8900)'],
...
reaction(
    label = 'reaction29',
    reactants = ['CCCC[CH]CO[C](C)OO(8900)'],
    products = ['CCCC[CH]COC(C)([O])O(10131)'],
...
reaction(
    label = 'reaction30',
    reactants = ['C[C]OO(178)', 'CCCC[CH]C[O](1762)'],
    products = ['CCCC[CH]CO[C](C)OO(8900)'],
...
reaction(
    label = 'reaction31',
    reactants = ['[CH]CCCC(141)', '[CH2]O[C](C)OO(5656)'],
    products = ['CCCC[CH]CO[C](C)OO(8900)'],
