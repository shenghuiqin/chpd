species(
    label = '[CH]=CC([O])O(1168)',
    structure = SMILES('[CH]=CC([O])O'),
    E0 = (118.866,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,3010,987.5,1337.5,450,1655,3615,1277.5,1000,1380,1390,370,380,2900,435,180],'cm^-1')),
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.28885,0.0426998,-6.44268e-05,6.05678e-08,-2.28061e-11,14353,20.4324], Tmin=(100,'K'), Tmax=(808.627,'K')), NASAPolynomial(coeffs=[4.04147,0.0242245,-1.19658e-05,2.32054e-09,-1.61752e-13,14390.2,14.3316], Tmin=(808.627,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(118.866,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CCOJ) + radical(Cds_P)"""),
)
...
species(
    ...
    E0 = (-6.74845,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,3615,1277.5,1000,3010,987.5,1337.5,450,1655,180,180,180,3197.04],'cm^-1')),
        HinderedRotor(inertia=(0.208217,'amu*angstrom^2'), symmetry=1, barrier=(4.78733,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0115033,'amu*angstrom^2'), symmetry=1, barrier=(4.53505,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (71.0547,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.48108,0.0382876,-6.09602e-05,5.82577e-08,-2.1977e-11,-761.702,17.8253], Tmin=(100,'K'), Tmax=(813.165,'K')), NASAPolynomial(coeffs=[4.07009,0.0206848,-1.04369e-05,2.03638e-09,-1.42166e-13,-696.574,12.4773], Tmin=(813.165,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-6.74845,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cd-Cd(CO)H) + group(Cds-O2d(Cds-Cds)O2s) + group(Cds-CdsHH) + radical(Cds_P)"""),
)
...
species(
    ...
    molecularWeight = (72.0627,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.762042,0.0569545,-5.89438e-05,2.95253e-08,-5.51673e-12,1437.23,19.5463], Tmin=(100,'K'), Tmax=(1521.39,'K')), NASAPolynomial(coeffs=[16.1493,0.00715116,-6.24628e-07,-6.83298e-11,9.8015e-15,-2162.97,-57.5899], Tmin=(1521.39,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(10.8788,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsCs) + radical(AllylJ2_triplet)"""),
)
...
species(
    label = '[CH]=[C]C(O)O(8436)',
    structure = SMILES('[CH]=[C]C(O)O'),
    E0 = (131.003,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,3120,650,792.5,1650,3580,3650,1210,1345,900,1100,1380,1390,370,380,2900,435],'cm^-1')),
        HinderedRotor(inertia=(0.352017,'amu*angstrom^2'), symmetry=1, barrier=(8.09357,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.352041,'amu*angstrom^2'), symmetry=1, barrier=(8.09412,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.34975,'amu*angstrom^2'), symmetry=1, barrier=(8.04144,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (72.0627,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.89997,0.0499445,-7.63953e-05,6.37142e-08,-2.10006e-11,15828.1,20.7497], Tmin=(100,'K'), Tmax=(834.676,'K')), NASAPolynomial(coeffs=[7.65183,0.0171184,-7.94742e-06,1.49153e-09,-1.0171e-13,15051.2,-4.86234], Tmin=(834.676,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(131.003,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_P) + radical(Cds_S)"""),
)

species(
    label = '[CH2][CH]C(=O)O(2126)',
...
species(
    label = 'OC1C=CO1(8438)',
    structure = SMILES('OC1C=CO1'),
    E0 = (-202.103,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (72.0627,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.2962,0.0166567,5.94107e-05,-1.03606e-07,4.49092e-11,-24226.7,13.5757], Tmin=(100,'K'), Tmax=(923.881,'K')), NASAPolynomial(coeffs=[19.2997,-0.00318009,4.2995e-06,-8.29726e-10,4.84833e-14,-29663.8,-79.532], Tmin=(923.881,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-202.103,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + ring(Cyclobutene)"""),
)

species(
    label = '[CH]=C[CH]OO(8439)',
    structure = SMILES('[CH]C=COO'),
    E0 = (288.064,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,251.995,252.005,252.015],'cm^-1')),
        HinderedRotor(inertia=(1.13103,'amu*angstrom^2'), symmetry=1, barrier=(50.9838,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.13087,'amu*angstrom^2'), symmetry=1, barrier=(50.9841,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.13111,'amu*angstrom^2'), symmetry=1, barrier=(50.9839,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (72.0627,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.09176,0.0405588,-3.08874e-05,1.26447e-08,-2.16273e-12,34715.8,19.4003], Tmin=(100,'K'), Tmax=(1349.54,'K')), NASAPolynomial(coeffs=[8.91717,0.0203284,-8.40151e-06,1.53677e-09,-1.05001e-13,32873.6,-15.5743], Tmin=(1349.54,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(288.064,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo library: DFT_QCI_thermo + radical(AllylJ2_triplet)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH]=CC([O])O(1168)'],
    products = ['HOCHO(59)', 'C2H2(32)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', '[CH]=CC(=O)O(808)'],
    products = ['[CH]=CC([O])O(1168)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction12',
    reactants = ['[O][CH]O(171)', 'C2H2(T)(175)'],
    products = ['[CH]=CC([O])O(1168)'],
