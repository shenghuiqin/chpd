species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.44377,'amu*angstrom^2'), symmetry=1, barrier=(33.1952,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.45016,'amu*angstrom^2'), symmetry=1, barrier=(33.342,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.127171,'amu*angstrom^2'), symmetry=1, barrier=(23.5278,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.02192,'amu*angstrom^2'), symmetry=1, barrier=(23.4959,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (70.0468,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.54909,0.0309637,-2.83825e-05,1.28646e-08,-2.33885e-12,23222.3,17.867], Tmin=(100,'K'), Tmax=(1307.41,'K')), NASAPolynomial(coeffs=[9.17204,0.0107006,-5.13418e-06,1.00977e-09,-7.19707e-14,21490.5,-15.8601], Tmin=(1307.41,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(192.641,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(149.66,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-Cd)) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(Cds-OdOsH) + radical(Cds_P) + radical(C=CJO)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'C#CO[C]=O(747)'],
    products = ['[CH]=CO[C]=O(810)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction8',
    reactants = ['CO(12)', 'CHCHO(47)'],
    products = ['[CH]=CO[C]=O(810)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(3.41e+07,'cm^3/(mol*s)'), n=0, Ea=(22.7161,'kJ/mol'), T0=(1,'K'), Tmin=(250,'K'), Tmax=(2500,'K'), comment="""Estimated using template [COm;O_sec_rad] for rate rule [COm;O_rad/OneDe]
Euclidian distance = 1.0
family: R_Addition_COm
Ea raised from 18.9 to 22.7 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction9',
    reactants = ['[C]=O(361)', 'CHCHO(47)'],
    products = ['[CH]=CO[C]=O(810)'],
    transitionState = 'TS9',
