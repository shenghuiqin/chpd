...
species(
    label = 'CC=[C]CCC=O(25169)',
    structure = SMILES('CC=[C]CCC=O'),
    E0 = (78.7148,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2782.5,750,1395,475,1775,1000,1685,370,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.251642,'amu*angstrom^2'), symmetry=1, barrier=(5.78575,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.251617,'amu*angstrom^2'), symmetry=1, barrier=(5.78518,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.251637,'amu*angstrom^2'), symmetry=1, barrier=(5.78563,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.25168,'amu*angstrom^2'), symmetry=1, barrier=(5.78662,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (97.1351,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.79782,0.0561805,-2.22178e-05,-3.58891e-08,4.03302e-11,9538.86,24.6516], Tmin=(100,'K'), Tmax=(501.089,'K')), NASAPolynomial(coeffs=[4.45023,0.0454113,-2.11247e-05,4.09192e-09,-2.89572e-13,9142.43,12.3846], Tmin=(501.089,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(78.7148,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-OdCsH) + radical(Cds_S)"""),
)

species(
    label = 'CC=[C]CC=CO(25170)',
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.737385,'amu*angstrom^2'), symmetry=1, barrier=(16.9539,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.736653,'amu*angstrom^2'), symmetry=1, barrier=(16.9371,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.737793,'amu*angstrom^2'), symmetry=1, barrier=(16.9633,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.73676,'amu*angstrom^2'), symmetry=1, barrier=(16.9396,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (97.1351,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.494626,0.064319,-2.72406e-05,-1.83375e-08,1.39919e-11,9972.87,27.5435], Tmin=(100,'K'), Tmax=(951.354,'K')), NASAPolynomial(coeffs=[18.3555,0.0201093,-6.23446e-06,1.0686e-09,-7.55424e-14,5176.73,-65.0802], Tmin=(951.354,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(81.7733,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(Cds_S)"""),
)

species(
    label = 'CC=C=CC[CH]O(25171)',
    structure = SMILES('CC=C=CC[CH]O'),
    E0 = (108.502,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([540,610,2055,3025,407.5,1350,352.5,2995,3025,975,1000,1300,1375,400,500,1630,1680,3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2850,1437.5,1250,1305,750,350,199.378,199.379],'cm^-1')),
        HinderedRotor(inertia=(0.384746,'amu*angstrom^2'), symmetry=1, barrier=(10.8531,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.384745,'amu*angstrom^2'), symmetry=1, barrier=(10.8531,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.384745,'amu*angstrom^2'), symmetry=1, barrier=(10.8531,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.384744,'amu*angstrom^2'), symmetry=1, barrier=(10.8531,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (97.1351,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.773336,0.0749824,-7.90688e-05,4.92173e-08,-1.29587e-11,13162.5,26.5918], Tmin=(100,'K'), Tmax=(904.407,'K')), NASAPolynomial(coeffs=[9.29639,0.0372856,-1.65448e-05,3.12754e-09,-2.17987e-13,11620.9,-13.6703], Tmin=(904.407,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(108.502,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cdd-CdsCds) + radical(CCsJOH)"""),
)

species(
    label = 'CC#CCC[CH]O(25172)',
    ...
    molecularWeight = (97.1351,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.811259,0.0720669,-7.03717e-05,3.61287e-08,-5.61292e-12,12632.5,27.3016], Tmin=(100,'K'), Tmax=(749.357,'K')), NASAPolynomial(coeffs=[9.94905,0.0331805,-1.23295e-05,2.10426e-09,-1.37702e-13,10985.3,-15.9992], Tmin=(749.357,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(104.091,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CtCsHH) + group(Cs-CsOsHH) + group(Cs-CtHHH) + group(Ct-CtCs) + group(Ct-CtCs) + radical(CCsJOH)"""),
)
...
species(
    label = 'C#CCC[CH]O(25173)',
    structure = SMILES('C#CCC[CH]O'),
    E0 = (146.272,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,750,770,3400,2100,2175,525,3615,1277.5,1000,3025,407.5,1350,352.5,228.509,1723.85],'cm^-1')),
        HinderedRotor(inertia=(0.349003,'amu*angstrom^2'), symmetry=1, barrier=(12.8037,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.343607,'amu*angstrom^2'), symmetry=1, barrier=(12.7917,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.340034,'amu*angstrom^2'), symmetry=1, barrier=(12.7826,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.80228,'amu*angstrom^2'), symmetry=1, barrier=(68.4064,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
species(
    label = 'CC=[C]CCC[O](25174)',
    structure = SMILES('CC=[C]CCC[O]'),
    E0 = (227.392,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,1685,370,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,295.068,295.217,295.568,2568.46],'cm^-1')),
        HinderedRotor(inertia=(0.105581,'amu*angstrom^2'), symmetry=1, barrier=(6.51558,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.10548,'amu*angstrom^2'), symmetry=1, barrier=(6.51835,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.105585,'amu*angstrom^2'), symmetry=1, barrier=(6.50943,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.105477,'amu*angstrom^2'), symmetry=1, barrier=(6.51823,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (98.143,'amu'),
...
species(
    label = 'CC=[C]C[CH]CO(25175)',
    structure = SMILES('CC=[C]C[CH]CO'),
    E0 = (201.589,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,3615,1277.5,1000,1685,370,2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.11643,0.0659391,-5.16266e-05,2.32096e-08,-4.56696e-12,24347.2,30.1552], Tmin=(100,'K'), Tmax=(1151.42,'K')), NASAPolynomial(coeffs=[8.75349,0.0394082,-1.70638e-05,3.198e-09,-2.21976e-13,22588.5,-7.76608], Tmin=(1151.42,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(201.589,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(CCJCO) + radical(Cds_S)"""),
)
...
species(
    ...
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.36597,0.0675636,-3.96156e-05,-3.56691e-08,5.14964e-11,28893.8,27.376], Tmin=(100,'K'), Tmax=(505.781,'K')), NASAPolynomial(coeffs=[6.42116,0.0442762,-2.00552e-05,3.79825e-09,-2.63745e-13,28169,4.32291], Tmin=(505.781,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(239.528,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Cds_S) + radical(Cds_S)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'CC=[C]CCC=O(25169)'],
    products = ['CC=[C]CC[CH]O(21133)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'CC=[C]CC=CO(25170)'],
    products = ['CC=[C]CC[CH]O(21133)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', 'CC=C=CC[CH]O(25171)'],
    products = ['CC=[C]CC[CH]O(21133)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)', 'CC#CCC[CH]O(25172)'],
    products = ['CC=[C]CC[CH]O(21133)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['CH3(17)', 'C#CCC[CH]O(25173)'],
    products = ['CC=[C]CC[CH]O(21133)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction27',
    reactants = ['HCOH(T)(285)', '[CH2]C[C]=CC(24198)'],
    products = ['CC=[C]CC[CH]O(21133)'],
...
reaction(
    label = 'reaction28',
    reactants = ['[CH2]C[CH]O(562)', '[C]=CC(24199)'],
    products = ['CC=[C]CC[CH]O(21133)'],
