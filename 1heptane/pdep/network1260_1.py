species(
    label = '[CH2]OO[C]1COC1CC(5274)',
    structure = SMILES('[CH2]OO[C]1COC1CC'),
    E0 = (122.053,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2950,3150,900,1000,1100,3000,3100,440,815,1455,1000,2750,2850,1437.5,1250,1305,750,350,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
...
species(
    label = '[CH2]OOC1COC=1CC(5335)',
    structure = SMILES('[CH2]OOC1COC=1CC'),
    E0 = (43.8398,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2750,3150,900,1100,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,2750,2850,1437.5,1250,1305,750,350,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2]OOC1=COC1CC(5336)',
    structure = SMILES('[CH2]OOC1=COC1CC'),
    E0 = (42.1801,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2750,2800,2850,1350,1500,750,1050,1375,1000,2750,3150,900,1100,3000,3100,440,815,1455,1000,2750,2850,1437.5,1250,1305,750,350,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.0801673,'amu*angstrom^2'), symmetry=1, barrier=(1.8432,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0801673,'amu*angstrom^2'), symmetry=1, barrier=(1.8432,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0801673,'amu*angstrom^2'), symmetry=1, barrier=(1.8432,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
...
species(
    ...
    molecularWeight = (130.142,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.196247,0.0906084,-8.47556e-05,4.63978e-08,-1.05654e-11,14192.7,31.6966], Tmin=(100,'K'), Tmax=(1050.86,'K')), NASAPolynomial(coeffs=[12.4665,0.0424084,-1.5954e-05,2.74952e-09,-1.8134e-13,11531.4,-30.0218], Tmin=(1050.86,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(116.737,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + ring(Oxetane) + radical(CsJOOC) + radical(C2CsJOCs)"""),
)

species(
    label = '[CH2]OOC1[CH]OC1CC(5339)',
    ...
    molecularWeight = (130.142,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.464634,0.087695,-5.59418e-05,2.12191e-09,8.7031e-12,14180.8,31.4662], Tmin=(100,'K'), Tmax=(918.43,'K')), NASAPolynomial(coeffs=[18.7535,0.0317423,-9.87596e-06,1.57859e-09,-1.03091e-13,9480.46,-65.9857], Tmin=(918.43,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(116.489,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + ring(Oxetane) + radical(CCsJOCs) + radical(CsJOOC)"""),
)

species(
    label = '[CH2]OOC1COC1[CH]C(5340)',
    structure = SMILES('[CH2]OOC1COC1[CH]C'),
    E0 = (135.935,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,3025,407.5,1350,352.5,2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,180,1082.76,1082.76,1082.76,1082.76,1082.76,1082.76,1082.76,1082.76,1082.76,1082.76,1082.76,1082.76,1082.76,2237.81],'cm^-1')),
    ...
    molecularWeight = (130.142,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.00175653,0.0758279,-2.95107e-05,-1.91542e-08,1.45267e-11,16504.2,32.8418], Tmin=(100,'K'), Tmax=(938.411,'K')), NASAPolynomial(coeffs=[16.7034,0.0345437,-1.13248e-05,1.88752e-09,-1.2653e-13,12052.8,-53.6883], Tmin=(938.411,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(135.935,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + ring(Oxetane) + radical(CsJOOC) + radical(CCJCO)"""),
)

species(
    label = '[CH2]CC1OCC1OO[CH2](5341)',
    structure = SMILES('[CH2]CC1OCC1OO[CH2]'),
    E0 = (141.279,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,2750,2850,1437.5,1250,1305,750,350,180,1087.35,1087.35,1087.35,1087.35,1087.35,1087.35,1087.35,1087.35,1087.35,1087.35,1087.35,1087.35,1087.35,2236.55],'cm^-1')),
        HinderedRotor(inertia=(0.123085,'amu*angstrom^2'), symmetry=1, barrier=(2.82997,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.123085,'amu*angstrom^2'), symmetry=1, barrier=(2.82997,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.123085,'amu*angstrom^2'), symmetry=1, barrier=(2.82997,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.123085,'amu*angstrom^2'), symmetry=1, barrier=(2.82997,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.123085,'amu*angstrom^2'), symmetry=1, barrier=(2.82997,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (130.142,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.162931,0.0818685,-4.89451e-05,3.09786e-09,6.00415e-12,17150.5,32.7225], Tmin=(100,'K'), Tmax=(954.414,'K')), NASAPolynomial(coeffs=[15.9839,0.036457,-1.25606e-05,2.12114e-09,-1.41367e-13,13054.5,-49.735], Tmin=(954.414,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(141.279,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + ring(Oxetane) + radical(CsJOOC) + radical(RCCJ)"""),
)

species(
    label = 'CC[C]1OC[C]1OOC(5342)',
    ...
    molecularWeight = (130.142,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0183458,0.0941536,-0.000112487,8.78097e-08,-2.85517e-11,13268,31.9846], Tmin=(100,'K'), Tmax=(862.515,'K')), NASAPolynomial(coeffs=[6.88129,0.0519989,-2.15122e-05,3.83918e-09,-2.55527e-13,12455.6,1.90841], Tmin=(862.515,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(109.16,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + ring(Oxetane) + radical(C2CsJOOC) + radical(C2CsJOCs)"""),
)

species(
    label = 'CCC1O[CH][C]1OOC(5343)',
    ...
    molecularWeight = (130.142,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.315248,0.091608,-8.50392e-05,4.52572e-08,-9.9227e-12,13257.3,31.8537], Tmin=(100,'K'), Tmax=(1094.57,'K')), NASAPolynomial(coeffs=[13.6895,0.04043,-1.49061e-05,2.54215e-09,-1.66732e-13,10191.4,-36.9767], Tmin=(1094.57,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(108.912,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + ring(Oxetane) + radical(C2CsJOOC) + radical(CCsJOCs)"""),
)

species(
    label = 'C[CH]C1OC[C]1OOC(5344)',
    ...
    molecularWeight = (130.142,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.10018,0.0803136,-6.04093e-05,2.59023e-08,-4.69074e-12,15582.8,33.4132], Tmin=(100,'K'), Tmax=(1286.02,'K')), NASAPolynomial(coeffs=[12.4489,0.0419045,-1.56094e-05,2.67829e-09,-1.76042e-13,12406.6,-29.2687], Tmin=(1286.02,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(128.358,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + ring(Oxetane) + radical(C2CsJOOC) + radical(CCJCO)"""),
)

species(
    label = '[CH2]CC1OC[C]1OOC(5345)',
    ...
    molecularWeight = (130.142,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.187021,0.0833525,-6.92381e-05,3.43437e-08,-7.32538e-12,16218.4,32.3947], Tmin=(100,'K'), Tmax=(1094.8,'K')), NASAPolynomial(coeffs=[10.402,0.046031,-1.81038e-05,3.20622e-09,-2.15105e-13,13981.7,-17.8118], Tmin=(1094.8,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(133.702,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + ring(Oxetane) + radical(RCCJ) + radical(C2CsJOOC)"""),
)
...
species(
    label = '[CH2]OOC(=C)C([O])CC(5346)',
    structure = SMILES('[CH2]OOC(=C)C([O])CC'),
    E0 = (120.709,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,2950,3100,1380,975,1025,1650,1380,1390,370,380,2900,435,350,440,435,1725,350,500,795,815,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (130.142,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0881245,0.0892892,-7.50971e-05,3.27492e-08,-5.88599e-12,14665.4,36.1227], Tmin=(100,'K'), Tmax=(1297.4,'K')), NASAPolynomial(coeffs=[15.9002,0.0399959,-1.81063e-05,3.46464e-09,-2.43066e-13,10516.7,-45.1743], Tmin=(1297.4,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(120.709,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(O2s-CsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(CC(C)OJ) + radical(CsJOOC)"""),
)

species(
    label = '[CH2]OOC(=CCC)C[O](5347)',
    structure = SMILES('[CH2]OOC(=CCC)C[O]'),
    E0 = (123.479,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3010,987.5,1337.5,450,1655,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,350,500,795,815,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3100,440,815,1455,1000,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    ...
    molecularWeight = (130.142,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.138322,0.07634,-3.39812e-05,-1.05535e-08,9.09499e-12,-17850,32.1755], Tmin=(100,'K'), Tmax=(1054.83,'K')), NASAPolynomial(coeffs=[18.9031,0.0330768,-1.36179e-05,2.58934e-09,-1.85083e-13,-23477.3,-68.3371], Tmin=(1054.83,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-149.757,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsOs) + ring(Cyclobutene)"""),
)

species(
    label = 'CCC1OC=C1OOC(5349)',
    ...
    molecularWeight = (130.142,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.315808,0.0726107,-1.89831e-06,-5.85716e-08,2.95885e-11,-18035.8,31.8678], Tmin=(100,'K'), Tmax=(975.452,'K')), NASAPolynomial(coeffs=[24.5108,0.023834,-8.43707e-06,1.62875e-09,-1.2387e-13,-25402.1,-100.221], Tmin=(975.452,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-151.417,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + ring(Cyclobutene)"""),
)
...
species(
    label = '[CH2]OO[C]1COC1C(5350)',
    structure = SMILES('[CH2]OO[C]1COC1C'),
    E0 = (145.833,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2750,2950,3150,900,1000,1100,3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,180,1029.47,1029.47,1029.47,1029.47,1029.47,1029.47,1029.47,1029.47,1029.47,1029.47,1029.47,2287.18],'cm^-1')),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.505585,0.0709889,-5.68356e-05,2.59825e-08,-4.94398e-12,17670.4,26.9136], Tmin=(100,'K'), Tmax=(1244.52,'K')), NASAPolynomial(coeffs=[12.0516,0.0338785,-1.21067e-05,2.02183e-09,-1.30696e-13,14796.5,-31.3151], Tmin=(1244.52,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(145.833,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + ring(Oxetane) + radical(CsJOOC) + radical(C2CsJOOC)"""),
)

species(
    label = '[CH2]OOC1([CH]OC1)CC(5351)',
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]OO[C]1COC1CC(5274)'],
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', '[CH2]OOC1COC=1CC(5335)'],
    products = ['[CH2]OO[C]1COC1CC(5274)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', '[CH2]OOC1=COC1CC(5336)'],
    products = ['[CH2]OO[C]1COC1CC(5274)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['C2H5(29)', '[CH2]OOC1=COC1(5337)'],
    products = ['[CH2]OO[C]1COC1CC(5274)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[CH2]OO[C]1COC1CC(5274)'],
    products = ['[CH2]OOC1CO[C]1CC(5338)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2]OO[C]1COC1CC(5274)'],
    products = ['[CH2]OOC1[CH]OC1CC(5339)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2]OOC1COC1[CH]C(5340)'],
    products = ['[CH2]OO[C]1COC1CC(5274)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]CC1OCC1OO[CH2](5341)'],
    products = ['[CH2]OO[C]1COC1CC(5274)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction11',
    reactants = ['C[CH]C1OC[C]1OOC(5344)'],
    products = ['[CH2]OO[C]1COC1CC(5274)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]CC1OC[C]1OOC(5345)'],
    products = ['[CH2]OO[C]1COC1CC(5274)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]OOC(=C)C([O])CC(5346)'],
    products = ['[CH2]OO[C]1COC1CC(5274)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]OOC(=CCC)C[O](5347)'],
    products = ['[CH2]OO[C]1COC1CC(5274)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CH2(S)(23)', '[CH2]OO[C]1COC1C(5350)'],
    products = ['[CH2]OO[C]1COC1CC(5274)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2]OO[C]1COC1CC(5274)'],
    products = ['[CH2]OOC1([CH]OC1)CC(5351)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH2]O[O](92)', 'CCC1[C]CO1(5334)'],
    products = ['[CH2]OO[C]1COC1CC(5274)'],
...
reaction(
    label = 'reaction22',
    reactants = ['CH2(19)', 'CCC1OC[C]1O[O](5352)'],
    products = ['[CH2]OO[C]1COC1CC(5274)'],
