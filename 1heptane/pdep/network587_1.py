species(
    label = '[CH2]CO[CH]C(1024)',
    structure = SMILES('[CH2]CO[CH]C'),
    E0 = (118.672,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,3025,407.5,1350,352.5,288.262,289.228,289.585],'cm^-1')),
        HinderedRotor(inertia=(0.00201307,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00200778,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.218649,'amu*angstrom^2'), symmetry=1, barrier=(12.9317,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.219111,'amu*angstrom^2'), symmetry=1, barrier=(12.9286,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'C=CO[CH]C(1656)'],
    products = ['[CH2]CO[CH]C(1024)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction12',
    reactants = ['CH2(19)', '[CH2]O[CH]C(567)'],
    products = ['[CH2]CO[CH]C(1024)'],
