...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.185084,0.0870922,-7.03386e-05,3.23661e-08,-6.46165e-12,-5056.8,31.2822], Tmin=(100,'K'), Tmax=(1143.77,'K')), NASAPolynomial(coeffs=[10.7541,0.0501302,-2.18648e-05,4.11234e-09,-2.86072e-13,-7474.5,-21.1269], Tmin=(1143.77,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-43.1638,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(482.239,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(CCsJOCs)"""),
)

species(
    label = 'CC=COC[CH]CC(10872)',
    structure = SMILES('CC=COC[CH]CC'),
    E0 = (-69.191,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2995,3025,975,1000,1300,1375,400,500,1630,1680,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3025,407.5,1350,352.5,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (113.178,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.398298,0.0800006,-2.55746e-05,-2.8311e-08,1.78094e-11,-8148.47,33.2613], Tmin=(100,'K'), Tmax=(979.295,'K')), NASAPolynomial(coeffs=[20.6017,0.0325335,-1.15466e-05,2.08506e-09,-1.47929e-13,-14098.4,-76.991], Tmin=(979.295,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-69.191,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(482.239,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(CCJCO)"""),
)

species(
    label = 'CC[CH]OC=CCC(10873)',
    structure = SMILES('CC[CH]OC=CCC'),
    E0 = (-74.0309,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3025,407.5,1350,352.5,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,2995,3025,975,1000,1300,1375,400,500,1630,1680,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'C[CH]CCO[CH]CC(10874)',
    structure = SMILES('C[CH]CCO[CH]CC'),
    E0 = (30.1886,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (114.185,'amu'),
...
species(
    label = 'C[CH]COC[CH]CC(10875)',
    structure = SMILES('C[CH]COC[CH]CC'),
    E0 = (55.0905,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3000,3050,390,425,1340,1360,335,370,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (114.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0451392,0.0829898,-5.4072e-05,1.81167e-08,-2.52726e-12,6770.83,36.9072], Tmin=(100,'K'), Tmax=(1604,'K')), NASAPolynomial(coeffs=[15.2869,0.0449813,-1.85286e-05,3.34423e-09,-2.24864e-13,1881.16,-43.8277], Tmin=(1604,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(55.0905,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJCO) + radical(CCJCO)"""),
)
...
species(
    label = 'CC[CH][CH]OCCC(10876)',
    structure = SMILES('CC[CH][CH]OCCC'),
    E0 = (35.6444,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3000,3050,390,425,1340,1360,335,370,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2]CCCO[CH]CC(10877)',
    structure = SMILES('[CH2]CCCO[CH]CC'),
    E0 = (40.9887,'kJ/mol'),
    modes = [
...
species(
    label = '[CH2]CCOC[CH]CC(10878)',
    structure = SMILES('[CH2]CCOC[CH]CC'),
    E0 = (60.4348,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,3025,407.5,1350,352.5,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'C[CH][CH]OCCCC(10879)',
    structure = SMILES('C[CH][CH]OCCCC'),
    E0 = (35.6444,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3000,3050,390,425,1340,1360,335,370,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'C[CH][CH]COCCC(10880)',
    structure = SMILES('C[CH][CH]COCCC'),
    E0 = (49.6347,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3000,3050,390,425,1340,1360,335,370,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (114.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.542875,0.082382,-6.04555e-05,2.78099e-08,-6.119e-12,6088.81,35.3794], Tmin=(100,'K'), Tmax=(984.768,'K')), NASAPolynomial(coeffs=[5.96075,0.0603753,-2.69348e-05,5.1171e-09,-3.58056e-13,5021.74,9.3245], Tmin=(984.768,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(49.6347,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJC) + radical(CCJCO)"""),
)

species(
    label = '[CH2]C[CH]COCCC(10881)',
    structure = SMILES('[CH2]C[CH]COCCC'),
    E0 = (60.4348,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,3025,407.5,1350,352.5,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2]C[CH]OCCCC(10882)',
    structure = SMILES('[CH2]C[CH]OCCCC'),
    E0 = (40.9887,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,3025,407.5,1350,352.5,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'CCC=COCCC(10883)',
    structure = SMILES('CCC=COCCC'),
    E0 = (-267.958,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (114.185,'amu'),
...
species(
    label = 'CC=COCCCC(10884)',
    structure = SMILES('CC=COCCCC'),
    E0 = (-269.093,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (114.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.604581,0.085343,-3.45925e-05,-1.84188e-08,1.38481e-11,-32184.6,31.5057], Tmin=(100,'K'), Tmax=(996.132,'K')), NASAPolynomial(coeffs=[20.1904,0.0365735,-1.34564e-05,2.43942e-09,-1.71586e-13,-38050.7,-77.3873], Tmin=(996.132,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-269.093,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH)"""),
)

species(
    label = 'CC=CCOCCC(10885)',
    structure = SMILES('CC=CCOCCC'),
    E0 = (-223.62,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (114.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.636212,0.0786533,-4.73071e-05,1.44495e-08,-1.88725e-12,-26779.4,30.1872], Tmin=(100,'K'), Tmax=(1602.89,'K')), NASAPolynomial(coeffs=[11.221,0.052239,-2.25882e-05,4.16845e-09,-2.83726e-13,-30172.7,-25.8721], Tmin=(1602.89,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-223.62,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH)"""),
)
...
species(
    ...
    molecularWeight = (114.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.47096,0.0979005,-8.721e-05,4.42349e-08,-9.39835e-12,3983.99,34.7179], Tmin=(100,'K'), Tmax=(1112.11,'K')), NASAPolynomial(coeffs=[13.5412,0.0475013,-1.92311e-05,3.48353e-09,-2.3739e-13,867.432,-34.3713], Tmin=(1112.11,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(31.7832,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Isobutyl) + radical(CCsJOCs)"""),
)

species(
    label = '[CH2]C(C)OC[CH]CC(10887)',
    structure = SMILES('[CH2]C(C)OC[CH]CC'),
    E0 = (55.1476,'kJ/mol'),
    modes = [
...
reaction(
    label = 'reaction1',
    reactants = ['CC[CH]CO[CH]CC(10721)'],
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'CC=CCO[CH]CC(10871)'],
    products = ['CC[CH]CO[CH]CC(10721)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'CC=COC[CH]CC(10872)'],
    products = ['CC[CH]CO[CH]CC(10721)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', 'CC[CH]OC=CCC(10873)'],
    products = ['CC[CH]CO[CH]CC(10721)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['CH3(17)', 'C=CCO[CH]CC(10627)'],
    products = ['CC[CH]CO[CH]CC(10721)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['CH3(17)', 'C=COC[CH]CC(2004)'],
    products = ['CC[CH]CO[CH]CC(10721)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['C[CH]COC[CH]CC(10875)'],
    products = ['CC[CH]CO[CH]CC(10721)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]CCCO[CH]CC(10877)'],
    products = ['CC[CH]CO[CH]CC(10721)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2]CCOC[CH]CC(10878)'],
    products = ['CC[CH]CO[CH]CC(10721)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]C[CH]COCCC(10881)'],
    products = ['CC[CH]CO[CH]CC(10721)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]C[CH]OCCCC(10882)'],
    products = ['CC[CH]CO[CH]CC(10721)'],
...
reaction(
    label = 'reaction23',
    reactants = ['CH2(S)(23)', 'C[CH]CO[CH]CC(10580)'],
    products = ['CC[CH]CO[CH]CC(10721)'],
...
reaction(
    label = 'reaction24',
    reactants = ['CC[CH]CO[CH]CC(10721)'],
    products = ['[CH2]C(C)CO[CH]CC(10886)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[CH2]C(C)OC[CH]CC(10887)'],
    products = ['CC[CH]CO[CH]CC(10721)'],
...
reaction(
    label = 'reaction27',
    reactants = ['[CH]CC(144)', 'CC[CH]C[O](1679)'],
    products = ['CC[CH]CO[CH]CC(10721)'],
...
reaction(
    label = 'reaction28',
    reactants = ['[CH]CC(144)', '[CH2]O[CH]CC(1682)'],
    products = ['CC[CH]CO[CH]CC(10721)'],
