...
species(
    label = 'C=C(C[CH]C)CC(C)OO(6616)',
    structure = SMILES('C=C(C[CH]C)CC(C)OO'),
    E0 = (-32.3019,'kJ/mol'),
    modes = [
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.77399,0.109658,-9.08092e-05,4.26462e-08,-8.66973e-12,-3717.1,41.2359], Tmin=(100,'K'), Tmax=(1126.46,'K')), NASAPolynomial(coeffs=[12.5981,0.0621752,-2.75811e-05,5.22668e-09,-3.65146e-13,-6729.75,-24.8692], Tmin=(1126.46,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-32.3019,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(573.699,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(RCCJC)"""),
)

species(
    label = '[CH2]C(C=CC)CC(C)OO(6617)',
    ...
    molecularWeight = (143.203,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.181,0.112097,-9.25769e-05,4.18391e-08,-7.90391e-12,-3148.82,41.8704], Tmin=(100,'K'), Tmax=(1235.67,'K')), NASAPolynomial(coeffs=[16.5746,0.054621,-2.28071e-05,4.19757e-09,-2.88423e-13,-7536.89,-47.5475], Tmin=(1235.67,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-27.7431,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(573.699,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Isobutyl)"""),
)
...
species(
    ...
    molecularWeight = (144.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.27207,0.125945,-0.000153674,1.27293e-07,-4.53384e-11,4646.16,44.2189], Tmin=(100,'K'), Tmax=(776.083,'K')), NASAPolynomial(coeffs=[6.2811,0.0757704,-3.49645e-05,6.64994e-09,-4.61631e-13,3812.41,11.8756], Tmin=(776.083,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(37.1314,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(594.485,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Tertalkyl) + radical(RCCJC)"""),
)
...
species(
    label = '[CH2]CCC([CH2])CC(C)OO(6621)',
    structure = SMILES('[CH2]CCC([CH2])CC(C)OO'),
    E0 = (67.5911,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (144.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.35825,0.118963,-0.000103284,5.01439e-08,-1.02561e-11,8321.29,44.2278], Tmin=(100,'K'), Tmax=(1143.92,'K')), NASAPolynomial(coeffs=[15.645,0.0595056,-2.53173e-05,4.70452e-09,-3.25261e-13,4431.29,-40.0891], Tmin=(1143.92,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(67.5911,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(594.485,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJ) + radical(Isobutyl)"""),
)

species(
    label = 'C[CH]CC(C)[CH]C(C)OO(6622)',
    structure = SMILES('C[CH]CC(C)[CH]C(C)OO'),
    E0 = (52.1237,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (144.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.902472,0.115142,-0.000101953,5.42027e-08,-1.27418e-11,6439.43,44.0832], Tmin=(100,'K'), Tmax=(979.184,'K')), NASAPolynomial(coeffs=[10.4284,0.0688545,-3.10454e-05,5.92526e-09,-4.1572e-13,4220.45,-10.3432], Tmin=(979.184,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(52.1237,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(594.485,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJCOOH) + radical(RCCJC)"""),
)

species(
    label = 'C[CH][CH]C(C)CC(C)OO(6623)',
    structure = SMILES('C[CH][CH]C(C)CC(C)OO'),
    E0 = (46.2509,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (144.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.671444,0.111076,-9.43536e-05,4.89664e-08,-1.15201e-11,5723.9,43.5088], Tmin=(100,'K'), Tmax=(963.405,'K')), NASAPolynomial(coeffs=[8.8727,0.07145,-3.26578e-05,6.27428e-09,-4.41852e-13,3884.89,-2.18048], Tmin=(963.405,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(46.2509,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(594.485,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Cs_S) + radical(RCCJC)"""),
)

species(
    label = '[CH2][C](CCC)CC(C)OO(6624)',
    ...
    molecularWeight = (144.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.36192,0.126088,-0.000140602,1.00657e-07,-3.12449e-11,5930.68,43.6031], Tmin=(100,'K'), Tmax=(767.959,'K')), NASAPolynomial(coeffs=[9.36244,0.0702293,-3.14976e-05,5.94462e-09,-4.1245e-13,4283.49,-5.30431], Tmin=(767.959,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(47.7674,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(594.485,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Isobutyl) + radical(Tertalkyl)"""),
)

species(
    label = '[CH2]C([CH]C(C)OO)CCC(6625)',
    structure = SMILES('[CH2]C([CH]C(C)OO)CCC'),
    E0 = (62.7597,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3615,1310,387.5,850,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3100,440,815,1455,1000,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (144.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.31311,0.119531,-0.000106005,5.32949e-08,-1.13554e-11,7737.33,44.5882], Tmin=(100,'K'), Tmax=(1098.06,'K')), NASAPolynomial(coeffs=[14.7017,0.0611938,-2.63163e-05,4.9147e-09,-3.40771e-13,4220.18,-34.1727], Tmin=(1098.06,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(62.7597,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(594.485,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Isobutyl) + radical(CCJCOOH)"""),
)

species(
    label = 'C[CH]CC(C)C[C](C)OO(6626)',
    structure = SMILES('C[CH]CC(C)C[C](C)OO'),
    E0 = (38.6078,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (144.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.941754,0.117332,-0.000116683,7.67511e-08,-2.28179e-11,4813.65,42.2182], Tmin=(100,'K'), Tmax=(785.407,'K')), NASAPolynomial(coeffs=[7.56778,0.0739945,-3.39151e-05,6.49725e-09,-4.55894e-13,3476.95,3.22009], Tmin=(785.407,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(38.6078,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(594.485,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(C2CsJOOH) + radical(RCCJC)"""),
)

species(
    label = '[CH2]C(CCC)C[C](C)OO(6627)',
...
species(
    label = '[CH2]C(CC(C)C[CH]C)OO(6628)',
    structure = SMILES('[CH2]C(CC(C)C[CH]C)OO'),
    E0 = (65.6713,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3615,1310,387.5,850,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3100,440,815,1455,1000,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (144.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.03883,0.116488,-0.000101972,5.17824e-08,-1.13992e-11,8075.14,44.2548], Tmin=(100,'K'), Tmax=(1050.2,'K')), NASAPolynomial(coeffs=[12.357,0.0654653,-2.90944e-05,5.51868e-09,-3.85919e-13,5261.54,-21.0282], Tmin=(1050.2,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(65.6713,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(594.485,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJCOOH) + radical(RCCJC)"""),
)

species(
    label = '[CH2][CH]CC(C)CC(C)OO(6629)',
    structure = SMILES('[CH2][CH]CC(C)CC(C)OO'),
    E0 = (56.9551,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3615,1310,387.5,850,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3100,440,815,1455,1000,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (144.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.886219,0.113892,-9.70375e-05,4.84549e-08,-1.06301e-11,7020.68,43.4999], Tmin=(100,'K'), Tmax=(1044.26,'K')), NASAPolynomial(coeffs=[11.2772,0.0672997,-3.01115e-05,5.72836e-09,-4.01175e-13,4480.33,-15.7085], Tmin=(1044.26,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(56.9551,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(594.485,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJC) + radical(RCCJ)"""),
)

species(
    label = 'C[CH]CC(C)CC(C)O[O](6630)',
    structure = SMILES('C[CH]CC(C)CC(C)O[O]'),
    E0 = (3.71343,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (144.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.723338,0.110281,-9.36554e-05,4.84679e-08,-1.12021e-11,611.328,41.8905], Tmin=(100,'K'), Tmax=(989.592,'K')), NASAPolynomial(coeffs=[9.63908,0.0683963,-3.01679e-05,5.69836e-09,-3.97448e-13,-1439.61,-7.99396], Tmin=(989.592,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(3.71343,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(598.642,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJC) + radical(ROOJ)"""),
)
...
species(
    ...
    molecularWeight = (144.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.15112,0.114862,-9.83281e-05,4.83015e-08,-1.01077e-11,1909.98,42.4577], Tmin=(100,'K'), Tmax=(1114.36,'K')), NASAPolynomial(coeffs=[13.9376,0.0606999,-2.54212e-05,4.68419e-09,-3.22236e-13,-1452.81,-31.9702], Tmin=(1114.36,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(14.3495,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(598.642,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(Isobutyl)"""),
)

species(
    label = 'C=C(CCC)CC(C)OO(6633)',
    structure = SMILES('C=C(CCC)CC(C)OO'),
    E0 = (-226.748,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (144.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.36999,0.114232,-8.82952e-05,3.59367e-08,-6.06711e-12,-27075.4,40.6293], Tmin=(100,'K'), Tmax=(1369.71,'K')), NASAPolynomial(coeffs=[18.9368,0.0549293,-2.33511e-05,4.32688e-09,-2.97646e-13,-32638.3,-63.7275], Tmin=(1369.71,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-226.748,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(598.642,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH)"""),
)

species(
    label = 'CC=CC(C)CC(C)OO(6634)',
    structure = SMILES('CC=CC(C)CC(C)OO'),
    E0 = (-232.825,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (144.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.26801,0.11121,-8.26445e-05,3.21261e-08,-5.18138e-12,-27809.5,40.3998], Tmin=(100,'K'), Tmax=(1425.16,'K')), NASAPolynomial(coeffs=[18.9069,0.0545848,-2.3045e-05,4.24613e-09,-2.90669e-13,-33559.9,-64.0799], Tmin=(1425.16,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-232.825,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(598.642,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH)"""),
)

species(
    label = 'C=CCC(C)CC(C)OO(6635)',
    structure = SMILES('C=CCC(C)CC(C)OO'),
    E0 = (-218.302,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (144.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.447,0.11276,-8.44324e-05,3.28197e-08,-5.24934e-12,-26054.3,41.4503], Tmin=(100,'K'), Tmax=(1447.6,'K')), NASAPolynomial(coeffs=[20.4042,0.0523808,-2.18677e-05,4.00663e-09,-2.73323e-13,-32380.6,-72.0519], Tmin=(1447.6,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-218.302,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(598.642,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH)"""),
)
...
species(
    label = 'C[CH]CC1COC(C)C1(6637)',
    structure = SMILES('C[CH]CC1COC(C)C1'),
    E0 = (-120.921,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (127.204,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.344279,0.0643289,2.50103e-05,-7.25169e-08,3.20914e-11,-14397.2,31.0328], Tmin=(100,'K'), Tmax=(937.478,'K')), NASAPolynomial(coeffs=[13.1002,0.0501041,-1.65536e-05,2.78311e-09,-1.87399e-13,-18555.5,-39.1057], Tmin=(937.478,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-120.921,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(565.384,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Tetrahydrofuran) + radical(RCCJC)"""),
)

species(
    label = '[CH2]C1CC(C)OC(C)C1(6638)',
    structure = SMILES('[CH2]C1CC(C)OC(C)C1'),
    E0 = (-144.748,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (127.204,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.1927,0.061511,5.19362e-05,-1.1317e-07,4.99441e-11,-17251.5,27.9459], Tmin=(100,'K'), Tmax=(916.694,'K')), NASAPolynomial(coeffs=[17.6444,0.0429674,-1.19843e-05,1.87003e-09,-1.25243e-13,-22871.5,-67.9327], Tmin=(916.694,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-144.748,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(569.541,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Oxane) + radical(Isobutyl)"""),
)

species(
    label = 'C[CH]C[CH]CCC(C)OO(6639)',
    structure = SMILES('C[CH]C[CH]CCC(C)OO'),
    E0 = (48.5141,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (144.211,'amu'),
...
species(
    label = 'C[CH]CC(CO)CC(C)[O](6640)',
    structure = SMILES('C[CH]CC(CO)CC(C)[O]'),
    E0 = (-149.263,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (144.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.888012,0.112919,-9.83446e-05,5.09166e-08,-1.15242e-11,-17780.7,43.4681], Tmin=(100,'K'), Tmax=(1020.93,'K')), NASAPolynomial(coeffs=[11.2246,0.0654625,-2.86188e-05,5.38581e-09,-3.7494e-13,-20253.9,-15.2191], Tmin=(1020.93,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-149.263,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(598.642,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(RCCJC)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(C[CH]C)CC(C)OO(6354)'],
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'C=C(C[CH]C)CC(C)OO(6616)'],
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', '[CH2]C(C=CC)CC(C)OO(6617)'],
    products = ['[CH2]C(C[CH]C)CC(C)OO(6354)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', '[CH2]C(CC=C)CC(C)OO(6618)'],
    products = ['[CH2]C(C[CH]C)CC(C)OO(6354)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['C=CC[CH]C(380)', 'QOOH_3(717)'],
    products = ['[CH2]C(C[CH]C)CC(C)OO(6354)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]C(C[CH]C)CC(C)OO(6354)'],
    products = ['C[CH]C[C](C)CC(C)OO(6619)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]C([CH]CC)CC(C)OO(6620)'],
    products = ['[CH2]C(C[CH]C)CC(C)OO(6354)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]CCC([CH2])CC(C)OO(6621)'],
    products = ['[CH2]C(C[CH]C)CC(C)OO(6354)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]C(C[CH]C)CC(C)OO(6354)'],
    products = ['C[CH]CC(C)[CH]C(C)OO(6622)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]C(C[CH]C)CC(C)OO(6354)'],
    products = ['C[CH][CH]C(C)CC(C)OO(6623)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2]C(C[CH]C)CC(C)OO(6354)'],
    products = ['[CH2][C](CCC)CC(C)OO(6624)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]C([CH]C(C)OO)CCC(6625)'],
    products = ['[CH2]C(C[CH]C)CC(C)OO(6354)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]C(C[CH]C)CC(C)OO(6354)'],
    products = ['C[CH]CC(C)C[C](C)OO(6626)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]C(C[CH]C)CC(C)OO(6354)'],
    products = ['[CH2]C(CCC)C[C](C)OO(6627)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]C(CC(C)C[CH]C)OO(6628)'],
    products = ['[CH2]C(C[CH]C)CC(C)OO(6354)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2][CH]CC(C)CC(C)OO(6629)'],
    products = ['[CH2]C(C[CH]C)CC(C)OO(6354)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2]C(C[CH]C)CC(C)OO(6354)'],
    products = ['C[CH]CC(C)CC(C)O[O](6630)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH2]C(CCC)CC(C)O[O](6632)'],
    products = ['[CH2]C(C[CH]C)CC(C)OO(6354)'],
...
reaction(
    label = 'reaction26',
    reactants = ['CH2(S)(23)', '[CH2]C(C[CH]C)CCOO(6636)'],
    products = ['[CH2]C(C[CH]C)CC(C)OO(6354)'],
...
reaction(
    label = 'reaction27',
    reactants = ['[CH2]C(C[CH]C)CC(C)OO(6354)'],
    products = ['OH(5)', 'C[CH]CC1COC(C)C1(6637)'],
...
reaction(
    label = 'reaction28',
    reactants = ['[CH2]C(C[CH]C)CC(C)OO(6354)'],
    products = ['OH(5)', '[CH2]C1CC(C)OC(C)C1(6638)'],
...
reaction(
    label = 'reaction29',
    reactants = ['[CH2]C(C[CH]C)CC(C)OO(6354)'],
    products = ['C[CH]C[CH]CCC(C)OO(6639)'],
...
reaction(
    label = 'reaction33',
    reactants = ['[CH2]C(C[CH]C)CC(C)OO(6354)'],
    products = ['C[CH]CC(CO)CC(C)[O](6640)'],
...
reaction(
    label = 'reaction35',
    reactants = ['CHCH3(T)(95)', '[CH2]C([CH2])CC(C)OO(5408)'],
    products = ['[CH2]C(C[CH]C)CC(C)OO(6354)'],
