species(
    label = '[CH2]CC([O])CCC(CCC)OO(17523)',
    structure = SMILES('[CH2]CC([O])CCC(CCC)OO'),
    E0 = (-101.034,'kJ/mol'),
    modes = [
...
species(
    label = '[CH2]CC(=O)CCC(CCC)OO(17554)',
    structure = SMILES('[CH2]CC(=O)CCC(CCC)OO'),
    E0 = (-268.108,'kJ/mol'),
    modes = [
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.72755,0.159564,-0.000199017,1.52297e-07,-4.93559e-11,-32014.5,49.2124], Tmin=(100,'K'), Tmax=(742.414,'K')), NASAPolynomial(coeffs=[12.1263,0.0795511,-3.73894e-05,7.19156e-09,-5.03482e-13,-34220.5,-18.028], Tmin=(742.414,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-268.108,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(665.158,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdCsCs) + radical(CJCC=O)"""),
)
...
species(
    label = '[CH2]C[C](O)CCC(CCC)OO(17556)',
    ...
    molecularWeight = (174.237,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.7626,0.158694,-0.000177083,1.15608e-07,-3.17732e-11,-18379.3,51.8219], Tmin=(100,'K'), Tmax=(869.731,'K')), NASAPolynomial(coeffs=[15.1494,0.0763159,-3.50094e-05,6.7077e-09,-4.70647e-13,-21495.1,-32.0935], Tmin=(869.731,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-154.767,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(685.944,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJ) + radical(C2CsJOH)"""),
)

species(
    label = 'C[CH]C([O])CCC(CCC)OO(17557)',
    structure = SMILES('C[CH]C([O])CCC(CCC)OO'),
    E0 = (-106.378,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (174.237,'amu'),
...
species(
    label = '[CH2]CC(O)[CH]CC(CCC)OO(17558)',
    structure = SMILES('[CH2]CC(O)[CH]CC(CCC)OO'),
    E0 = (-131.493,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (174.237,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.40503,0.144942,-0.000133347,6.784e-08,-1.44742e-11,-15587.7,53.5894], Tmin=(100,'K'), Tmax=(1101.43,'K')), NASAPolynomial(coeffs=[18.289,0.0697871,-3.09959e-05,5.88848e-09,-4.12435e-13,-20146.2,-48.2464], Tmin=(1101.43,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-131.493,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(685.944,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJCO) + radical(RCCJ)"""),
)

species(
    label = '[CH2][CH]C(O)CCC(CCC)OO(17559)',
    structure = SMILES('[CH2][CH]C(O)CCC(CCC)OO'),
    E0 = (-131.493,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (174.237,'amu'),
...
species(
    label = 'CCCC(CC[C]([O])CC)OO(17560)',
    structure = SMILES('CCCC(CC[C]([O])CC)OO'),
    E0 = (-129.653,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (174.237,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.53147,0.152746,-0.00015655,9.29701e-08,-2.34388e-11,-15366.1,49.0127], Tmin=(100,'K'), Tmax=(938.628,'K')), NASAPolynomial(coeffs=[15.2926,0.076788,-3.51633e-05,6.75391e-09,-4.75392e-13,-18712.1,-35.8491], Tmin=(938.628,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-129.653,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(690.101,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(C2CsJOH)"""),
)

species(
    label = '[CH2]CC(O)C[CH]C(CCC)OO(17561)',
    structure = SMILES('[CH2]CC(O)C[CH]C(CCC)OO'),
    E0 = (-130.98,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1277.5,1000,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,3000,3100,440,815,1455,1000,3615,1310,387.5,850,1000,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (174.237,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.48616,0.150909,-0.000152457,8.83178e-08,-2.16398e-11,-15526.6,53.7059], Tmin=(100,'K'), Tmax=(965.452,'K')), NASAPolynomial(coeffs=[15.9182,0.0746597,-3.39928e-05,6.51749e-09,-4.58476e-13,-19080.4,-34.4379], Tmin=(965.452,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-130.98,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(685.944,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJ) + radical(CCJCOOH)"""),
)

species(
    label = 'CCCC(C[CH]C([O])CC)OO(17562)',
    structure = SMILES('CCCC(C[CH]C([O])CC)OO'),
    E0 = (-106.378,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (174.237,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.35781,0.141252,-0.000121034,5.61633e-08,-1.09049e-11,-12566.8,51.4323], Tmin=(100,'K'), Tmax=(1200.71,'K')), NASAPolynomial(coeffs=[19.4821,0.0684961,-3.01425e-05,5.6984e-09,-3.97686e-13,-17811.5,-57.9278], Tmin=(1200.71,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-106.378,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(690.101,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJCO) + radical(CC(C)OJ)"""),
)

species(
    label = '[CH2]CC(O)CC[C](CCC)OO(17563)',
    structure = SMILES('[CH2]CC(O)CC[C](CCC)OO'),
    E0 = (-144.496,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (174.237,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.43752,0.152031,-0.000163276,1.05455e-07,-2.92044e-11,-17156.1,51.5276], Tmin=(100,'K'), Tmax=(856.651,'K')), NASAPolynomial(coeffs=[13.0205,0.0798516,-3.68871e-05,7.0943e-09,-4.98983e-13,-19804.5,-20.6564], Tmin=(856.651,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-144.496,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(685.944,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJ) + radical(C2CsJOOH)"""),
)

species(
    label = 'CCCC([CH]CC([O])CC)OO(17564)',
    structure = SMILES('CCCC([CH]CC([O])CC)OO'),
    E0 = (-105.865,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (174.237,'amu'),
...
species(
    label = '[CH2]CC(O)CCC([CH]CC)OO(17565)',
    structure = SMILES('[CH2]CC(O)CCC([CH]CC)OO'),
    E0 = (-130.98,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (174.237,'amu'),
...
species(
    label = 'CCC[C](CCC([O])CC)OO(17566)',
    structure = SMILES('CCC[C](CCC([O])CC)OO'),
    E0 = (-119.381,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (174.237,'amu'),
...
species(
    label = '[CH2]CC(O)CCC(CCC)O[O](17567)',
    structure = SMILES('[CH2]CC(O)CCC(CCC)O[O]'),
    E0 = (-179.39,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (174.237,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.30843,0.146062,-0.000144188,8.26011e-08,-2.01016e-11,-21354.6,51.5185], Tmin=(100,'K'), Tmax=(970.259,'K')), NASAPolynomial(coeffs=[15.1178,0.0742218,-3.31277e-05,6.29362e-09,-4.40463e-13,-24736.3,-32.0274], Tmin=(970.259,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-179.39,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(690.101,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(RCCJ)"""),
)

species(
    label = '[CH2]CC(O)CCC(C[CH]C)OO(17568)',
    structure = SMILES('[CH2]CC(O)CCC(C[CH]C)OO'),
    E0 = (-136.948,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (174.237,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.37025,0.149703,-0.000157873,9.99235e-08,-2.70902e-11,-16250,53.7249], Tmin=(100,'K'), Tmax=(874.493,'K')), NASAPolynomial(coeffs=[13.1941,0.0785127,-3.57646e-05,6.83702e-09,-4.79385e-13,-18972.3,-19.277], Tmin=(874.493,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-136.948,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(685.944,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJ) + radical(RCCJC)"""),
)

species(
    label = 'CC[CH]C(CCC([O])CC)OO(17569)',
    structure = SMILES('CC[CH]C(CCC([O])CC)OO'),
    E0 = (-105.865,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (174.237,'amu'),
...
species(
    label = '[CH2]CCC(CCC(O)C[CH2])OO(17570)',
    structure = SMILES('[CH2]CCC(CCC(O)C[CH2])OO'),
    E0 = (-126.148,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (174.237,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.47673,0.149708,-0.000147587,8.24882e-08,-1.94473e-11,-14944.9,53.1493], Tmin=(100,'K'), Tmax=(1001.79,'K')), NASAPolynomial(coeffs=[16.6603,0.0732967,-3.31741e-05,6.34861e-09,-4.46307e-13,-18779.2,-39.21], Tmin=(1001.79,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-126.148,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(685.944,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJ) + radical(RCCJ)"""),
)

species(
    label = 'CCCC(CCC([O])CC)O[O](17571)',
    structure = SMILES('CCCC(CCC([O])CC)O[O]'),
    E0 = (-154.276,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (174.237,'amu'),
...
species(
    label = 'C[CH]CC(CCC([O])CC)OO(17572)',
    structure = SMILES('C[CH]CC(CCC([O])CC)OO'),
    E0 = (-111.834,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (174.237,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.13576,0.143742,-0.000137414,7.75312e-08,-1.89191e-11,-13237,50.9017], Tmin=(100,'K'), Tmax=(958.29,'K')), NASAPolynomial(coeffs=[13.4097,0.078851,-3.58368e-05,6.86307e-09,-4.82405e-13,-16216.3,-23.4333], Tmin=(958.29,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-111.834,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(690.101,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJC) + radical(CC(C)OJ)"""),
)

species(
    label = 'CCCC(CCC(=O)CC)OO(17573)',
    structure = SMILES('CCCC(CCC(=O)CC)OO'),
    E0 = (-479.697,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (174.237,'amu'),
...
species(
    ...
    molecularWeight = (174.237,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.49603,0.14111,-0.00011944,5.36745e-08,-9.97645e-12,-48979.8,51.004], Tmin=(100,'K'), Tmax=(1259.22,'K')), NASAPolynomial(coeffs=[21.6658,0.064359,-2.80143e-05,5.27162e-09,-3.66851e-13,-55064.8,-71.1322], Tmin=(1259.22,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-409.195,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(690.101,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH)"""),
)
...
species(
    label = '[CH2]CC([O])CCC(CC)OO(17575)',
    structure = SMILES('[CH2]CC([O])CCC(CC)OO'),
    E0 = (-77.2537,'kJ/mol'),
    modes = [
...
species(
    label = '[CH2]CC1CCC(CCC)OO1(17576)',
    structure = SMILES('[CH2]CC1CCC(CCC)OO1'),
    E0 = (-95.3962,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (157.23,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.42657,0.0967475,-1.79409e-06,-6.98004e-08,3.54969e-11,-11257.6,39.7101], Tmin=(100,'K'), Tmax=(945.307,'K')), NASAPolynomial(coeffs=[22.7743,0.0500894,-1.62152e-05,2.75354e-09,-1.89316e-13,-18323.8,-88.8582], Tmin=(945.307,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-95.3962,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(661.001,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(12dioxane) + radical(RCCJ)"""),
)
...
species(
    label = '[CH2]C[CH]CCC(CCC)OO(17577)',
    structure = SMILES('[CH2]C[CH]CCC(CCC)OO'),
    E0 = (35.534,'kJ/mol'),
    modes = [
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.55581,0.131975,-0.000126102,7.59029e-08,-2.04337e-11,4465.35,48.2751], Tmin=(100,'K'), Tmax=(862.476,'K')), NASAPolynomial(coeffs=[9.47381,0.080823,-3.71414e-05,7.14114e-09,-5.02731e-13,2562.74,-3.30486], Tmin=(862.476,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(35.534,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(665.158,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(RCCJ)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]CC([O])CCC(CCC)OO(17523)'],
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', '[CH2]CC(=O)CCC(CCC)OO(17554)'],
    products = ['[CH2]CC([O])CCC(CCC)OO(17523)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'C=CC([O])CCC(CCC)OO(17555)'],
    products = ['[CH2]CC([O])CCC(CCC)OO(17523)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[CH2]CC(CCC)OO(2142)', 'CH2CH2CHO(560)'],
    products = ['[CH2]CC([O])CCC(CCC)OO(17523)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['C2H4(21)', 'CCCC(CC[CH][O])OO(17462)'],
    products = ['[CH2]CC([O])CCC(CCC)OO(17523)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2]CC([O])CCC(CCC)OO(17523)'],
    products = ['[CH2]C[C](O)CCC(CCC)OO(17556)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]CC([O])CCC(CCC)OO(17523)'],
    products = ['C[CH]C([O])CCC(CCC)OO(17557)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]CC(O)[CH]CC(CCC)OO(17558)'],
    products = ['[CH2]CC([O])CCC(CCC)OO(17523)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]CC([O])CCC(CCC)OO(17523)'],
    products = ['[CH2][CH]C(O)CCC(CCC)OO(17559)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]CC([O])CCC(CCC)OO(17523)'],
    products = ['CCCC(CC[C]([O])CC)OO(17560)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]CC(O)C[CH]C(CCC)OO(17561)'],
    products = ['[CH2]CC([O])CCC(CCC)OO(17523)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2]CC([O])CCC(CCC)OO(17523)'],
    products = ['CCCC(C[CH]C([O])CC)OO(17562)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]CC([O])CCC(CCC)OO(17523)'],
    products = ['[CH2]CC(O)CC[C](CCC)OO(17563)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]CC([O])CCC(CCC)OO(17523)'],
    products = ['CCCC([CH]CC([O])CC)OO(17564)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]CC([O])CCC(CCC)OO(17523)'],
    products = ['[CH2]CC(O)CCC([CH]CC)OO(17565)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]CC([O])CCC(CCC)OO(17523)'],
    products = ['CCC[C](CCC([O])CC)OO(17566)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2]CC([O])CCC(CCC)OO(17523)'],
    products = ['[CH2]CC(O)CCC(CCC)O[O](17567)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2]CC([O])CCC(CCC)OO(17523)'],
    products = ['[CH2]CC(O)CCC(C[CH]C)OO(17568)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2]CC([O])CCC(CCC)OO(17523)'],
    products = ['CC[CH]C(CCC([O])CC)OO(17569)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH2]CC([O])CCC(CCC)OO(17523)'],
    products = ['[CH2]CCC(CCC(O)C[CH2])OO(17570)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH2]CC([O])CCC(CCC)OO(17523)'],
    products = ['CCCC(CCC([O])CC)O[O](17571)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH2]CC([O])CCC(CCC)OO(17523)'],
    products = ['C[CH]CC(CCC([O])CC)OO(17572)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[CH2]CC([O])CCC(CCC)OO(17523)'],
    products = ['CCCC(CCC(=O)CC)OO(17573)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[CH2]CC([O])CCC(CCC)OO(17523)'],
    products = ['C=CC(O)CCC(CCC)OO(17574)'],
...
reaction(
    label = 'reaction27',
    reactants = ['CH2(S)(23)', '[CH2]CC([O])CCC(CC)OO(17575)'],
    products = ['[CH2]CC([O])CCC(CCC)OO(17523)'],
...
reaction(
    label = 'reaction28',
    reactants = ['[CH2]CC([O])CCC(CCC)OO(17523)'],
    products = ['OH(5)', '[CH2]CC1CCC(CCC)OO1(17576)'],
...
reaction(
    label = 'reaction30',
    reactants = ['O(4)', '[CH2]C[CH]CCC(CCC)OO(17577)'],
    products = ['[CH2]CC([O])CCC(CCC)OO(17523)'],
...
reaction(
    label = 'reaction31',
    reactants = ['CH2(19)', '[CH2]C([O])CCC(CCC)OO(17578)'],
    products = ['[CH2]CC([O])CCC(CCC)OO(17523)'],
