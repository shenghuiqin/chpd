species(
    label = '[CH2]C(C)C[CH]CCCC(1421)',
    structure = SMILES('[CH2]C(C)C[CH]CCCC'),
    E0 = (130.641,'kJ/mol'),
    modes = [
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.288342,0.0980474,-6.24109e-05,2.23104e-08,-3.58577e-12,15863.2,40.2754], Tmin=(100,'K'), Tmax=(1323.4,'K')), NASAPolynomial(coeffs=[9.62003,0.068099,-2.84658e-05,5.21035e-09,-3.55425e-13,13240.7,-10.3031], Tmin=(1323.4,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(130.641,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(623.585,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(Isobutyl)"""),
)
...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0846023,0.0930294,-5.61678e-05,1.78684e-08,-2.51126e-12,5397.17,36.4067], Tmin=(100,'K'), Tmax=(1462.38,'K')), NASAPolynomial(coeffs=[9.9087,0.0661581,-2.86054e-05,5.30339e-09,-3.63234e-13,2523.84,-14.7228], Tmin=(1462.38,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(43.7605,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(602.799,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(RCCJCC)"""),
)

species(
    label = '[CH2]C(C)C=CCCCC(1543)',
...
species(
    label = '[CH2]C(C)CC=CCCC(1544)',
    structure = SMILES('[CH2]C(C)CC=CCCC'),
    E0 = (49.5072,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2995,3025,975,1000,1300,1375,400,500,1630,1680,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (125.231,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.967434,0.0959987,-5.21377e-05,8.15358e-09,1.73517e-12,6144.18,40.8703], Tmin=(100,'K'), Tmax=(1156.29,'K')), NASAPolynomial(coeffs=[16.5542,0.0536103,-2.07914e-05,3.71161e-09,-2.51553e-13,873.807,-51.4743], Tmin=(1156.29,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(49.5072,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(602.799,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Isobutyl)"""),
)
...
species(
    label = 'CCCC[CH]C[C](C)C(1545)',
    structure = SMILES('CCCC[CH]C[C](C)C'),
    E0 = (110.981,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (126.239,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.458394,0.106467,-0.000106225,8.55411e-08,-3.21982e-11,13500.5,39.56], Tmin=(100,'K'), Tmax=(757.794,'K')), NASAPolynomial(coeffs=[2.34286,0.0815778,-3.69623e-05,7.01453e-09,-4.87971e-13,13366,28.7364], Tmin=(757.794,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(110.981,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(623.585,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(Tertalkyl)"""),
)

species(
    label = '[CH2]C(C)[CH]CCCCC(1541)',
    ...
    molecularWeight = (126.239,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.687181,0.100258,-6.31374e-05,2.09038e-08,-2.93346e-12,15892.7,41.7006], Tmin=(100,'K'), Tmax=(1567.22,'K')), NASAPolynomial(coeffs=[15.2547,0.0595698,-2.41934e-05,4.3376e-09,-2.90821e-13,10895.9,-42.3722], Tmin=(1567.22,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(130.725,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(623.585,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Cs_S) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]C(C)CC[CH]CCC(1546)',
...
species(
    label = 'CCCC[CH][CH]C(C)C(1547)',
    structure = SMILES('CCCC[CH][CH]C(C)C'),
    E0 = (120.101,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (126.239,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.310798,0.0907371,-4.77798e-05,1.18154e-08,-1.18369e-12,14566.2,38.15], Tmin=(100,'K'), Tmax=(2066.87,'K')), NASAPolynomial(coeffs=[16.57,0.0592707,-2.49435e-05,4.44961e-09,-2.92752e-13,7845.05,-52.0963], Tmin=(2066.87,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(120.101,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(623.585,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(Cs_S)"""),
)

species(
    label = '[CH2][C](C)CCCCCC(1548)',
    ...
    molecularWeight = (126.239,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.452382,0.10452,-8.20253e-05,4.21382e-08,-1.02249e-11,14780.4,39.4681], Tmin=(100,'K'), Tmax=(920.38,'K')), NASAPolynomial(coeffs=[6.58402,0.0739401,-3.21877e-05,6.0393e-09,-4.19549e-13,13485.2,6.10523], Tmin=(920.38,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(121.605,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(623.585,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Isobutyl) + radical(Tertalkyl)"""),
)

species(
    label = '[CH2]C(C)CCC[CH]CC(1549)',
    structure = SMILES('[CH2]C(C)CCC[CH]CC'),
    E0 = (130.641,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,3025,407.5,1350,352.5,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2]C([CH2])CCCCCC(1550)',
    structure = SMILES('[CH2]C([CH2])CCCCCC'),
    E0 = (141.265,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (126.239,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.13642,0.106355,-7.52981e-05,2.96735e-08,-4.95141e-12,17180.4,41.8522], Tmin=(100,'K'), Tmax=(1374.21,'K')), NASAPolynomial(coeffs=[15.6036,0.0576286,-2.21117e-05,3.8714e-09,-2.57422e-13,12579.5,-44.2302], Tmin=(1374.21,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(141.265,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(623.585,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Isobutyl) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]C(C)CCCC[CH]C(1551)',
    structure = SMILES('[CH2]C(C)CCCC[CH]C'),
    E0 = (130.629,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (126.239,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.489736,0.0995203,-6.40732e-05,2.28587e-08,-3.58192e-12,15871.4,41.1685], Tmin=(100,'K'), Tmax=(1386.58,'K')), NASAPolynomial(coeffs=[11.552,0.0647821,-2.64932e-05,4.79018e-09,-3.24148e-13,12532,-20.8615], Tmin=(1386.58,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(130.629,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(623.585,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Isobutyl) + radical(RCCJC)"""),
)

species(
    label = '[CH2]CCCCCC([CH2])C(1552)',
    structure = SMILES('[CH2]CCCCCC([CH2])C'),
    E0 = (141.429,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2761.11,2772.22,2783.33,2794.44,2805.56,2816.67,2827.78,2838.89,2850,1425,1431.25,1437.5,1443.75,1450,1225,1237.5,1250,1262.5,1275,1270,1287.5,1305,1322.5,1340,700,725,750,775,800,300,325,350,375,400,1380,1390,370,380,2900,435,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (126.239,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.06022,0.104694,-7.05183e-05,2.54354e-08,-3.85725e-12,17197.1,42.2782], Tmin=(100,'K'), Tmax=(1493.18,'K')), NASAPolynomial(coeffs=[16.7899,0.0568762,-2.24825e-05,3.98871e-09,-2.6649e-13,11866.4,-50.9947], Tmin=(1493.18,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(141.429,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(623.585,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJ) + radical(Isobutyl)"""),
)

species(
    label = 'CCC[CH][CH]CC(C)C(1553)',
    structure = SMILES('CCC[CH][CH]CC(C)C'),
    E0 = (120.017,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (126.239,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.33129,0.0728894,6.32368e-05,-2.67932e-07,2.35088e-10,14515.7,34.9588], Tmin=(100,'K'), Tmax=(412.832,'K')), NASAPolynomial(coeffs=[2.52077,0.0808204,-3.62725e-05,6.92013e-09,-4.85959e-13,14251.7,28.2645], Tmin=(412.832,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(120.017,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(623.585,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(RCCJCC)"""),
)

species(
    label = 'CC[CH]C[CH]CC(C)C(1554)',
    structure = SMILES('CC[CH]C[CH]CC(C)C'),
    E0 = (120.017,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (126.239,'amu'),
...
species(
    label = 'C[CH]CC[CH]CC(C)C(1555)',
    structure = SMILES('C[CH]CC[CH]CC(C)C'),
    E0 = (120.005,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (126.239,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.140978,0.0933029,-5.66648e-05,2.0661e-08,-3.81695e-12,14565.1,39.0218], Tmin=(100,'K'), Tmax=(1054.82,'K')), NASAPolynomial(coeffs=[4.30991,0.0774939,-3.41838e-05,6.45261e-09,-4.49476e-13,13685.6,18.6866], Tmin=(1054.82,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(120.005,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(623.585,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJC) + radical(RCCJCC)"""),
)

species(
    label = '[CH2]CCC[CH]CC(C)C(1556)',
    structure = SMILES('[CH2]CCC[CH]CC(C)C'),
    E0 = (130.805,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,3025,407.5,1350,352.5,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (126.239,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.123336,0.0956138,-5.58818e-05,1.66856e-08,-2.13677e-12,15874.9,38.9733], Tmin=(100,'K'), Tmax=(1623.53,'K')), NASAPolynomial(coeffs=[12.3712,0.0648302,-2.74406e-05,5.00692e-09,-3.38431e-13,11817.8,-27.3606], Tmin=(1623.53,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(130.805,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(623.585,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(RCCJ)"""),
)

species(
    label = 'C=C(C)CCCCCC(1557)',
    ...
    molecularWeight = (126.239,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.05307,0.102422,-6.43755e-05,2.05107e-08,-2.68866e-12,-17936.3,37.9649], Tmin=(100,'K'), Tmax=(1716.38,'K')), NASAPolynomial(coeffs=[20.1184,0.0530815,-2.12548e-05,3.76178e-09,-2.4905e-13,-25203.8,-75.612], Tmin=(1716.38,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-150.698,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(627.743,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH)"""),
)

species(
    label = 'CCCCC=CC(C)C(1558)',
    structure = SMILES('CCCCC=CC(C)C'),
    E0 = (-154.506,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (126.239,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.940198,0.0934928,-3.62195e-05,-9.06949e-09,7.40734e-12,-18392.2,38.3329], Tmin=(100,'K'), Tmax=(1120.15,'K')), NASAPolynomial(coeffs=[16.7985,0.0568001,-2.27729e-05,4.16814e-09,-2.87628e-13,-24038.2,-56.7221], Tmin=(1120.15,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-154.506,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(627.743,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH)"""),
)

species(
    label = 'CCCC=CCC(C)C(1559)',
    structure = SMILES('CCCC=CCC(C)C'),
    E0 = (-155.575,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (126.239,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.947162,0.0938324,-3.78112e-05,-6.91815e-09,6.53333e-12,-18520.8,38.3247], Tmin=(100,'K'), Tmax=(1134.94,'K')), NASAPolynomial(coeffs=[16.767,0.0569822,-2.29178e-05,4.19347e-09,-2.8896e-13,-24189.3,-56.6364], Tmin=(1134.94,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-155.575,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(627.743,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH)"""),
)
...
species(
    label = '[CH2]CC[CH]CCCC(399)',
    structure = SMILES('[CH2]CC[CH]CCCC'),
    E0 = (160.28,'kJ/mol'),
    modes = [
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.710103,0.0811464,-4.50048e-05,1.25012e-08,-1.49917e-12,19386.4,34.6989], Tmin=(100,'K'), Tmax=(1646.34,'K')), NASAPolynomial(coeffs=[9.35922,0.0601324,-2.58586e-05,4.74825e-09,-3.21868e-13,16538.5,-11.3401], Tmin=(1646.34,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(160.28,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(552.912,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(RCCJ)"""),
)
...
species(
    label = 'C[CH]CC[CH]CCCC(1420)',
    structure = SMILES('C[CH]CC[CH]CCCC'),
    E0 = (125.699,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (126.239,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.31079,0.0740219,6.61559e-05,-2.8787e-07,2.57707e-10,15199.1,36.2057], Tmin=(100,'K'), Tmax=(409.743,'K')), NASAPolynomial(coeffs=[2.8682,0.0803802,-3.60557e-05,6.86181e-09,-4.8051e-13,14890.5,27.8729], Tmin=(409.743,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(125.699,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(623.585,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(RCCJC)"""),
)
...
species(
    label = '[CH2]C(C)C([CH2])CCCC(1423)',
    structure = SMILES('[CH2]C(C)C([CH2])CCCC'),
    E0 = (138.918,'kJ/mol'),
    modes = [
...
species(
    label = 'CCCCC1CC(C)C1(1424)',
    structure = SMILES('CCCCC1CC(C)C1'),
    E0 = (-123.111,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (126.239,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.280271,0.0706461,3.89153e-05,-9.12033e-08,3.71159e-11,-14632.1,34.506], Tmin=(100,'K'), Tmax=(1005.05,'K')), NASAPolynomial(coeffs=[17.5467,0.0554056,-2.14826e-05,4.01002e-09,-2.86084e-13,-21029.2,-65.5865], Tmin=(1005.05,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-123.111,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(636.057,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Cyclobutane)"""),
)
...
species(
    label = 'C[CH]C[CH]CCCC(493)',
    structure = SMILES('C[CH]C[CH]CCCC'),
    E0 = (149.48,'kJ/mol'),
    modes = [
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(C)C[CH]CCCC(1421)'],
    products = ['C3H6(72)', 'C=CCCCC(193)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'C=C(C)C[CH]CCCC(1542)'],
    products = ['[CH2]C(C)C[CH]CCCC(1421)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', '[CH2]C(C)C=CCCCC(1543)'],
    products = ['[CH2]C(C)C[CH]CCCC(1421)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', '[CH2]C(C)CC=CCCC(1544)'],
    products = ['[CH2]C(C)C[CH]CCCC(1421)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(1.46e+08,'cm^3/(mol*s)'), n=1.64, Ea=(5.73208,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""From training reaction 2555 used for Cds-CsH_Cds-CsH;HJ
Exact match found for rate rule [Cds-CsH_Cds-CsH;HJ]
...
reaction(
    label = 'reaction5',
    reactants = ['[CH2][CH]CCCC(197)', 'C3H6(72)'],
    products = ['[CH2]C(C)C[CH]CCCC(1421)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['C=CC[CH]CCCC(491)', 'CH3(17)'],
    products = ['[CH2]C(C)C[CH]CCCC(1421)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['C3H6(T)(143)', 'C=CCCCC(193)'],
    products = ['[CH2]C(C)C[CH]CCCC(1421)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['npropyl(83)', '[CH2]C(C)CC=C(526)'],
    products = ['[CH2]C(C)C[CH]CCCC(1421)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]C(C)[CH]CCCCC(1541)'],
    products = ['[CH2]C(C)C[CH]CCCC(1421)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]C(C)CC[CH]CCC(1546)'],
    products = ['[CH2]C(C)C[CH]CCCC(1421)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]C(C)C[CH]CCCC(1421)'],
    products = ['CCCC[CH][CH]C(C)C(1547)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]C(C)CCC[CH]CC(1549)'],
    products = ['[CH2]C(C)C[CH]CCCC(1421)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]C([CH2])CCCCCC(1550)'],
    products = ['[CH2]C(C)C[CH]CCCC(1421)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]C(C)C[CH]CCCC(1421)'],
    products = ['[CH2]C(C)CCCC[CH]C(1551)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]CCCCCC([CH2])C(1552)'],
    products = ['[CH2]C(C)C[CH]CCCC(1421)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2]C(C)C[CH]CCCC(1421)'],
    products = ['CCC[CH][CH]CC(C)C(1553)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2]C(C)C[CH]CCCC(1421)'],
    products = ['CC[CH]C[CH]CC(C)C(1554)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2]C(C)C[CH]CCCC(1421)'],
    products = ['C[CH]CC[CH]CC(C)C(1555)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH2]CCC[CH]CC(C)C(1556)'],
    products = ['[CH2]C(C)C[CH]CCCC(1421)'],
    transitionState = 'TS21',
    kinetics = Arrhenius(A=(1.12247e+06,'s^-1'), n=1.72042, Ea=(122.469,'kJ/mol'), T0=(1,'K'), comment="""Estimated using average of templates [RnH;C_rad_out_2H;Cs_H_out_2H] + [R8Hall;C_rad_out_2H;Cs_H_out] for rate rule [R8Hall;C_rad_out_2H;Cs_H_out_2H]
Euclidian distance = 1.0
...
reaction(
    label = 'reaction22',
    reactants = ['[CH2][CH]CCCC(197)', 'C3H6(T)(143)'],
    products = ['[CH2]C(C)C[CH]CCCC(1421)'],
...
reaction(
    label = 'reaction26',
    reactants = ['CH2(S)(23)', '[CH2]CC[CH]CCCC(399)'],
    products = ['[CH2]C(C)C[CH]CCCC(1421)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[CH2]C(C)C([CH2])CCCC(1423)'],
    products = ['[CH2]C(C)C[CH]CCCC(1421)'],
...
reaction(
    label = 'reaction33',
    reactants = ['CH2(19)', 'C[CH]C[CH]CCCC(493)'],
    products = ['[CH2]C(C)C[CH]CCCC(1421)'],
...
reaction(
    label = 'reaction34',
    reactants = ['[CH2]C([CH2])C(438)', '[CH]CCCC(141)'],
    products = ['[CH2]C(C)C[CH]CCCC(1421)'],
