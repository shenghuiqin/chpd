...
species(
    label = 'CC([O])OC=CC(C)OO(7477)',
    structure = SMILES('CC([O])OC=CC(C)OO'),
    E0 = (-320.006,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,2995,3025,975,1000,1300,1375,400,500,1630,1680,3615,1310,387.5,850,1000,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.65531,0.111189,-0.000100867,4.54193e-08,-8.05884e-12,-38273.2,41.7619], Tmin=(100,'K'), Tmax=(1363.15,'K')), NASAPolynomial(coeffs=[25.6061,0.031194,-1.28414e-05,2.36952e-09,-1.63607e-13,-45705.5,-98.2045], Tmin=(1363.15,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-320.006,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(478.082,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(CCOJ)"""),
)

species(
    label = 'CC(=O)O[CH]CC(C)OO(7478)',
    structure = SMILES('CC(=O)O[CH]CC(C)OO'),
    E0 = (-418.086,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (147.149,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.61663,0.106457,-0.000102373,5.39172e-08,-1.19034e-11,-50122,37.5056], Tmin=(100,'K'), Tmax=(1065.77,'K')), NASAPolynomial(coeffs=[14.3249,0.0503783,-2.3445e-05,4.54486e-09,-3.21825e-13,-53306.8,-35.5301], Tmin=(1065.77,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-418.086,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(473.925,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)HHH) + group(Cds-OdCsOs) + radical(CCsJOC(O))"""),
)
...
species(
    label = 'CC([O])OC[CH]C(C)OO(7479)',
    structure = SMILES('CC([O])OC[CH]C(C)OO'),
    E0 = (-196.01,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3025,407.5,1350,352.5,3615,1310,387.5,850,1000,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (148.157,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0647375,0.104543,-5.99769e-05,-9.62846e-08,1.30217e-10,-23451.4,39.3483], Tmin=(100,'K'), Tmax=(469.553,'K')), NASAPolynomial(coeffs=[8.51635,0.0640702,-3.13927e-05,6.11412e-09,-4.29528e-13,-24592.6,1.26274], Tmin=(469.553,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-196.01,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(498.868,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJCOOH) + radical(CCOJ)"""),
)
...
species(
    label = 'CC([O])OCCC(C)O[O](7487)',
    structure = SMILES('CC([O])OCCC(C)O[O]'),
    E0 = (-244.42,'kJ/mol'),
    modes = [
...
species(
    label = 'CC(=O)OCCC(C)OO(7491)',
    structure = SMILES('CC(=O)OCCC(C)OO'),
    E0 = (-612.013,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (148.157,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.192799,0.0966035,-7.46644e-05,3.09104e-08,-5.48908e-12,-73461.3,36.4941], Tmin=(100,'K'), Tmax=(1266.82,'K')), NASAPolynomial(coeffs=[13.0769,0.0547044,-2.50532e-05,4.80237e-09,-3.36812e-13,-76823.4,-30.6627], Tmin=(1266.82,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-612.013,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(498.868,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)HHH) + group(Cds-OdCsOs)"""),
)
...
species(
    label = 'CC([O])O[CH]CCOO(7493)',
    structure = SMILES('CC([O])O[CH]CCOO'),
    E0 = (-179.546,'kJ/mol'),
    modes = [
...
species(
    label = 'CC([O])OC1CC(C)O1(7494)',
    structure = SMILES('CC([O])OC1CC(C)O1'),
    E0 = (-324.301,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (131.15,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0652877,0.0771924,-4.48413e-05,9.20752e-09,8.96276e-13,-38854.9,33.1501], Tmin=(100,'K'), Tmax=(1094.54,'K')), NASAPolynomial(coeffs=[13.1466,0.0427581,-1.59759e-05,2.78741e-09,-1.8663e-13,-42519.5,-34.8005], Tmin=(1094.54,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-324.301,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(465.61,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Oxetane) + radical(CCOJ)"""),
)

species(
    label = '[CH2]C(OC(C)[O])C(C)OO(7495)',
    structure = SMILES('[CH2]C(OC(C)[O])C(C)OO'),
    E0 = (-196.466,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3615,1310,387.5,850,1000,3000,3100,440,815,1455,1000,1380,1382,1384,1386,1388,1390,370,372,374,376,378,380,2800,2900,3000,430,435,440,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (148.157,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.61663,0.13414,-0.000189607,1.58521e-07,-5.45986e-11,-23437.2,42.1854], Tmin=(100,'K'), Tmax=(767.122,'K')), NASAPolynomial(coeffs=[11.0812,0.0600131,-2.91824e-05,5.65198e-09,-3.95324e-13,-25152.4,-14.19], Tmin=(767.122,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-196.466,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(498.868,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJC(C)OC) + radical(CCOJ)"""),
)
...
species(
    ...
    molecularWeight = (148.157,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.683822,0.112244,-0.000126298,8.65486e-08,-2.56205e-11,-52494.7,41.663], Tmin=(100,'K'), Tmax=(801.548,'K')), NASAPolynomial(coeffs=[9.72503,0.0603006,-2.9094e-05,5.70229e-09,-4.05079e-13,-54163.4,-6.25127], Tmin=(801.548,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-437.8,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(CCOJ)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'CC([O])OC=CC(C)OO(7477)'],
    products = ['CC([O])O[CH]CC(C)OO(7397)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'CC(=O)O[CH]CC(C)OO(7478)'],
    products = ['CC([O])O[CH]CC(C)OO(7397)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['C[CH][O](176)', 'CC(CC=O)OO(1957)'],
    products = ['CC([O])O[CH]CC(C)OO(7397)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CH3CHOOH(63)', 'C=COC(C)[O](2314)'],
    products = ['CC([O])O[CH]CC(C)OO(7397)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['CH3(17)', 'CC(C[CH]OC=O)OO(7442)'],
    products = ['CC([O])O[CH]CC(C)OO(7397)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['CC([O])OC[CH]C(C)OO(7479)'],
    products = ['CC([O])O[CH]CC(C)OO(7397)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['C[C]([O])OCCC(C)OO(7481)'],
    products = ['CC([O])O[CH]CC(C)OO(7397)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['C[C](CCOC(C)[O])OO(7482)'],
    products = ['CC([O])O[CH]CC(C)OO(7397)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]C(CCOC(C)[O])OO(7484)'],
    products = ['CC([O])O[CH]CC(C)OO(7397)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CC([O])OCCC(C)O[O](7487)'],
    products = ['CC([O])O[CH]CC(C)OO(7397)'],
...
reaction(
    label = 'reaction22',
    reactants = ['CH2(S)(23)', 'CC([O])O[CH]CCOO(7493)'],
    products = ['CC([O])O[CH]CC(C)OO(7397)'],
...
reaction(
    label = 'reaction23',
    reactants = ['CH2(S)(23)', 'CC(C[CH]OC[O])OO(7389)'],
    products = ['CC([O])O[CH]CC(C)OO(7397)'],
...
reaction(
    label = 'reaction24',
    reactants = ['CC([O])O[CH]CC(C)OO(7397)'],
    products = ['OH(5)', 'CC([O])OC1CC(C)O1(7494)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[CH2]C(OC(C)[O])C(C)OO(7495)'],
    products = ['CC([O])O[CH]CC(C)OO(7397)'],
...
reaction(
    label = 'reaction27',
    reactants = ['CC([O])O[CH]CC(C)OO(7397)'],
    products = ['CC([O])CC(O)OC(C)[O](7496)'],
...
reaction(
    label = 'reaction28',
    reactants = ['CC([O])[O](2201)', '[CH]CC(C)OO(1806)'],
    products = ['CC([O])O[CH]CC(C)OO(7397)'],
