...
species(
    ...
    E0 = (-127.395,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,523.343,523.423,523.437,523.488,523.577],'cm^-1')),
        HinderedRotor(inertia=(0.000615082,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.192354,'amu*angstrom^2'), symmetry=1, barrier=(37.3926,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (76.0514,'amu'),
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', '[O]COC=O(4539)'],
    products = ['[O]CO[CH]O(981)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['[O]COC[O](4541)'],
    products = ['[O]CO[CH]O(981)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(1.55924e+06,'s^-1'), n=2.1225, Ea=(123.773,'kJ/mol'), T0=(1,'K'), comment="""Estimated using average of templates [R2H_S;Y_rad_out;Cs_H_out_H/NonDeO] + [R2H_S;O_rad_out;Cs_H_out_1H] for rate rule [R2H_S;O_rad_out;Cs_H_out_H/NonDeO]
Euclidian distance = 1.0
...
reaction(
    label = 'reaction11',
    reactants = ['HCOH(T)(285)', '[O]C[O](170)'],
    products = ['[O]CO[CH]O(981)'],
