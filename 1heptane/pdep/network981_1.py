...
species(
    label = 'C=C(CCCC)C([O])O(5017)',
    structure = SMILES('C=C(CCCC)C([O])O'),
    E0 = (-237.491,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1277.5,1000,2950,3100,1380,975,1025,1650,1380,1390,370,380,2900,435,350,440,435,1725,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0378031,0.0947723,-8.60432e-05,4.88917e-08,-1.25946e-11,-28427.4,36.2973], Tmin=(100,'K'), Tmax=(889.942,'K')), NASAPolynomial(coeffs=[7.69782,0.0603435,-2.80143e-05,5.42226e-09,-3.83424e-13,-29790.8,0.235222], Tmin=(889.942,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-237.491,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(CCOJ)"""),
)

species(
    label = '[CH2]C(CCCC)C(=O)O(5018)',
    structure = SMILES('[CH2]C(CCCC)C(=O)O'),
    E0 = (-359.38,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (129.177,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.115346,0.0960454,-8.08322e-05,3.91533e-08,-8.30039e-12,-43079.9,34.6749], Tmin=(100,'K'), Tmax=(1077.2,'K')), NASAPolynomial(coeffs=[10.6008,0.0562524,-2.54199e-05,4.85892e-09,-3.41152e-13,-45388.6,-17.8211], Tmin=(1077.2,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-359.38,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-(Cds-O2d)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdCsOs) + radical(CJC(C)C=O)"""),
)
...
species(
    ...
    molecularWeight = (130.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.304689,0.0876461,-5.79144e-05,2.02593e-08,-3.11082e-12,-24302.6,36.2253], Tmin=(100,'K'), Tmax=(1384.02,'K')), NASAPolynomial(coeffs=[10.4637,0.0582854,-2.60931e-05,4.9314e-09,-3.42081e-13,-27114.7,-16.0874], Tmin=(1384.02,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-203.119,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(527.969,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJ(C)CO) + radical(CCOJ)"""),
)

species(
    label = '[CH2]C(CCCC)[C](O)O(5020)',
    structure = SMILES('[CH2]C(CCCC)[C](O)O'),
    E0 = (-171.069,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (130.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.699461,0.104237,-9.58681e-05,4.99115e-08,-1.08674e-11,-20406.3,40.5703], Tmin=(100,'K'), Tmax=(1086.72,'K')), NASAPolynomial(coeffs=[14.0929,0.0497903,-2.07176e-05,3.8103e-09,-2.6204e-13,-23621.4,-32.025], Tmin=(1086.72,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-171.069,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(523.812,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Isobutyl) + radical(Cs_P)"""),
)

species(
    label = 'CCC[CH]C(C)C([O])O(5021)',
    ...
    molecularWeight = (130.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.111991,0.0937617,-8.05555e-05,4.54158e-08,-1.21516e-11,-19249,39.3256], Tmin=(100,'K'), Tmax=(840.282,'K')), NASAPolynomial(coeffs=[5.95791,0.0659334,-3.08789e-05,6.00328e-09,-4.25663e-13,-20231.5,12.1397], Tmin=(840.282,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-161.15,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(527.969,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Cs_S) + radical(CCOJ)"""),
)

species(
    label = 'CCCCC(C)[C]([O])O(5022)',
    structure = SMILES('CCCCC(C)[C]([O])O'),
    E0 = (-150.446,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,360,370,350,3615,1277.5,1000,1380,1390,370,380,2900,435,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (130.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.000875591,0.0953688,-7.90857e-05,3.95811e-08,-8.99118e-12,-17956.7,37.8457], Tmin=(100,'K'), Tmax=(991.194,'K')), NASAPolynomial(coeffs=[8.30726,0.0618475,-2.83562e-05,5.46049e-09,-3.85085e-13,-19603.3,-2.15421], Tmin=(991.194,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-150.446,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(527.969,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Cs_P) + radical(CCOJ)"""),
)

species(
    label = '[CH2][C](CCCC)C(O)O(5023)',
    structure = SMILES('[CH2][C](CCCC)C(O)O'),
    E0 = (-223.741,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (130.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.594653,0.0984635,-7.99742e-05,3.58035e-08,-6.70526e-12,-26742.4,39.6945], Tmin=(100,'K'), Tmax=(1246.65,'K')), NASAPolynomial(coeffs=[15.0086,0.0483982,-1.97336e-05,3.58846e-09,-2.44851e-13,-30632.7,-39.0219], Tmin=(1246.65,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-223.741,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(523.812,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Isobutyl) + radical(CCJ(C)CO)"""),
)

species(
    label = '[CH2]C([CH]CCC)C(O)O(5024)',
    ...
    molecularWeight = (130.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.417878,0.1007,-9.09519e-05,4.78728e-08,-1.07892e-11,-21706.1,41.4336], Tmin=(100,'K'), Tmax=(1037.81,'K')), NASAPolynomial(coeffs=[11.7493,0.0538045,-2.31711e-05,4.33172e-09,-3.00518e-13,-24231.6,-17.7175], Tmin=(1037.81,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-181.773,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(523.812,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Cs_S) + radical(Isobutyl)"""),
)

species(
    label = 'CC[CH]CC(C)C([O])O(5025)',
    ...
    molecularWeight = (130.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.190021,0.100201,-0.000111992,9.16982e-08,-3.36733e-11,-19248.8,40.3889], Tmin=(100,'K'), Tmax=(750.518,'K')), NASAPolynomial(coeffs=[4.37504,0.0678959,-3.14888e-05,6.03139e-09,-4.21443e-13,-19709.4,21.1715], Tmin=(750.518,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-161.234,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(527.969,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(CCOJ)"""),
)

species(
    label = 'CCCCC(C)C([O])[O](5026)',
    structure = SMILES('CCCCC(C)C([O])[O]'),
    E0 = (-129.987,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (130.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.00581109,0.095998,-9.6565e-05,7.54497e-08,-2.82709e-11,-15497,37.3376], Tmin=(100,'K'), Tmax=(700.122,'K')), NASAPolynomial(coeffs=[3.60217,0.0709942,-3.35884e-05,6.52549e-09,-4.61055e-13,-15894.6,21.9859], Tmin=(700.122,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-129.987,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(532.126,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(CCOJ)"""),
)

species(
    label = '[CH2]C(C[CH]CC)C(O)O(5027)',
    ...
    molecularWeight = (130.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.450191,0.103425,-0.000106702,6.94955e-08,-1.95991e-11,-21717,41.5631], Tmin=(100,'K'), Tmax=(841.219,'K')), NASAPolynomial(coeffs=[9.20478,0.0575155,-2.48385e-05,4.6184e-09,-3.18304e-13,-23341.4,-3.34718], Tmin=(841.219,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-181.857,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(523.812,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(Isobutyl)"""),
)

species(
    label = 'C[CH]CCC(C)C([O])O(5028)',
    ...
    molecularWeight = (130.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.868032,0.0822275,-1.44266e-05,-1.11857e-07,1.13112e-10,-19294.3,37.0069], Tmin=(100,'K'), Tmax=(467.423,'K')), NASAPolynomial(coeffs=[5.09962,0.0666622,-3.0734e-05,5.90219e-09,-4.14529e-13,-19915.5,17.3975], Tmin=(467.423,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-161.246,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(527.969,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJC) + radical(CCOJ)"""),
)

species(
    label = '[CH2]C(CC[CH]C)C(O)O(5029)',
    ...
    molecularWeight = (130.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.472881,0.102811,-0.000101183,6.08849e-08,-1.57345e-11,-21716.6,41.8143], Tmin=(100,'K'), Tmax=(915.681,'K')), NASAPolynomial(coeffs=[10.3786,0.0554085,-2.35311e-05,4.34973e-09,-2.99243e-13,-23703.8,-9.58187], Tmin=(915.681,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-181.869,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(523.812,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Isobutyl) + radical(RCCJC)"""),
)

species(
    label = '[CH2]CCCC(C)C([O])O(5030)',
    ...
    molecularWeight = (130.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.000875591,0.0953688,-7.90857e-05,3.95811e-08,-8.99118e-12,-17956.7,38.9443], Tmin=(100,'K'), Tmax=(991.194,'K')), NASAPolynomial(coeffs=[8.30726,0.0618475,-2.83562e-05,5.46049e-09,-3.85085e-13,-19603.3,-1.0556], Tmin=(991.194,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-150.446,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(527.969,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJ) + radical(CCOJ)"""),
)

species(
    label = '[CH2]CCCC([CH2])C(O)O(5031)',
    ...
    molecularWeight = (130.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.699461,0.104237,-9.58681e-05,4.99115e-08,-1.08674e-11,-20406.3,41.6689], Tmin=(100,'K'), Tmax=(1086.72,'K')), NASAPolynomial(coeffs=[14.0929,0.0497903,-2.07176e-05,3.8103e-09,-2.6204e-13,-23621.4,-30.9264], Tmin=(1086.72,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-171.069,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(523.812,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Isobutyl) + radical(RCCJ)"""),
)

species(
    label = 'C=C(CCCC)C(O)O(5032)',
    structure = SMILES('C=C(CCCC)C(O)O'),
    E0 = (-463.196,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (130.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.488334,0.0998312,-8.34556e-05,3.83683e-08,-7.4379e-12,-55549.1,36.6048], Tmin=(100,'K'), Tmax=(1197.32,'K')), NASAPolynomial(coeffs=[14.2089,0.05073,-2.19411e-05,4.11674e-09,-2.86102e-13,-59068.5,-36.9477], Tmin=(1197.32,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-463.196,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(527.969,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH)"""),
)

species(
    label = 'CCCCC(C)C(=O)O(5033)',
    structure = SMILES('CCCCC(C)C(=O)O'),
    E0 = (-569.891,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (130.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.126867,0.0897812,-5.89465e-05,1.98529e-08,-2.80648e-12,-68393.7,34.343], Tmin=(100,'K'), Tmax=(1564.21,'K')), NASAPolynomial(coeffs=[15.0505,0.0509695,-2.17279e-05,3.99031e-09,-2.7123e-13,-73141.8,-45.669], Tmin=(1564.21,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-569.891,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(527.969,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-(Cds-O2d)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdCsOs)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'C=C(CCCC)C([O])O(5017)'],
    products = ['[CH2]C(CCCC)C([O])O(1392)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', '[CH2]C(CCCC)C(=O)O(5018)'],
    products = ['[CH2]C(CCCC)C([O])O(1392)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['butyl_1(82)', 'C=CC([O])O(3167)'],
    products = ['[CH2]C(CCCC)C([O])O(1392)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['OH(5)', '[CH2]C(C=O)CCCC(1844)'],
    products = ['[CH2]C(CCCC)C([O])O(1392)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]C(CCCC)C([O])O(1392)'],
    products = ['[CH2]C(CCCC)[C](O)O(5020)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]C(CCCC)C([O])O(1392)'],
    products = ['CCC[CH]C(C)C([O])O(5021)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]C(CCCC)C([O])O(1392)'],
    products = ['[CH2][C](CCCC)C(O)O(5023)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2]C([CH]CCC)C(O)O(5024)'],
    products = ['[CH2]C(CCCC)C([O])O(1392)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]C(CCCC)C([O])O(1392)'],
    products = ['CC[CH]CC(C)C([O])O(5025)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]C(CCCC)C([O])O(1392)'],
    products = ['[CH2]C(C[CH]CC)C(O)O(5027)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]C(CCCC)C([O])O(1392)'],
    products = ['C[CH]CCC(C)C([O])O(5028)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2]C(CCCC)C([O])O(1392)'],
    products = ['[CH2]C(CC[CH]C)C(O)O(5029)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2]CCCC(C)C([O])O(5030)'],
    products = ['[CH2]C(CCCC)C([O])O(1392)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2]C(CCCC)C([O])O(1392)'],
    products = ['[CH2]CCCC([CH2])C(O)O(5031)'],
...
reaction(
    label = 'reaction24',
    reactants = ['CH2(S)(23)', '[CH2]C(CCC)C([O])O(1398)'],
    products = ['[CH2]C(CCCC)C([O])O(1392)'],
...
reaction(
    label = 'reaction28',
    reactants = ['[CH2]C([CH]OO)CCCC(5035)'],
    products = ['[CH2]C(CCCC)C([O])O(1392)'],
...
reaction(
    label = 'reaction29',
    reactants = ['CH2(19)', 'CCCC[CH]C([O])O(4479)'],
    products = ['[CH2]C(CCCC)C([O])O(1392)'],
...
reaction(
    label = 'reaction30',
    reactants = ['O(4)', '[CH2]C([CH]O)CCCC(1846)'],
    products = ['[CH2]C(CCCC)C([O])O(1392)'],
