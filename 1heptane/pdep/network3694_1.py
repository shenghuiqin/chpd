...
species(
    label = '[CH2]C1OC(CC)C1[CH2](20816)',
    structure = SMILES('[CH2]C1OC(CC)C1[CH2]'),
    E0 = (189.825,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.200873,0.0721486,-1.67154e-05,-3.80076e-08,2.42687e-11,22978.3,29.2711], Tmin=(100,'K'), Tmax=(870.952,'K')), NASAPolynomial(coeffs=[16.3748,0.0325133,-8.12306e-06,1.08949e-09,-6.41506e-14,18846.9,-54.068], Tmin=(870.952,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(189.825,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(465.61,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Oxetane) + radical(CJC(C)OC) + radical(Isobutyl)"""),
)
...
species(
    label = '[CH2]C(C=C)OC=CC(20818)',
    structure = SMILES('[CH2]C(C=C)OC=CC'),
    E0 = (56.2201,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,3100,1380,975,1025,1650,2995,3010,3025,975,987.5,1000,1300,1337.5,1375,400,450,500,1630,1655,1680,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (111.162,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.589246,0.084792,-4.4802e-05,-1.32764e-08,1.41301e-11,6941.49,32.2404], Tmin=(100,'K'), Tmax=(965.314,'K')), NASAPolynomial(coeffs=[23.3073,0.0233248,-7.64279e-06,1.36151e-09,-9.80985e-14,578.276,-91.2658], Tmin=(965.314,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(56.2201,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CJC(C)OC)"""),
)
...
species(
    label = '[CH2]C(C=C)OC[CH]C(20820)',
    structure = SMILES('[CH2]C(C=C)OC[CH]C'),
    E0 = (180.502,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,2750,2800,2850,1350,1500,750,1050,1375,1000,2950,3100,1380,975,1025,1650,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0777999,0.0870154,-7.09389e-05,3.07407e-08,-5.50652e-12,21858.1,35.6421], Tmin=(100,'K'), Tmax=(1304.3,'K')), NASAPolynomial(coeffs=[15.2315,0.0400657,-1.69451e-05,3.1431e-09,-2.16818e-13,17864.5,-42.2836], Tmin=(1304.3,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(180.502,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CCJCO) + radical(CJC(C)OC)"""),
)
...
species(
    label = '[CH2]CCOC([CH2])C=C(20822)',
    structure = SMILES('[CH2]CCOC([CH2])C=C'),
    E0 = (185.846,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2950,3100,1380,975,1025,1650,1380,1390,370,380,2900,435,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,3010,987.5,1337.5,450,1655,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.00636926,0.0900495,-7.96274e-05,3.88984e-08,-8.00045e-12,22494,34.6362], Tmin=(100,'K'), Tmax=(1135.83,'K')), NASAPolynomial(coeffs=[12.8873,0.0446874,-1.97214e-05,3.73699e-09,-2.61315e-13,19567.9,-29.1473], Tmin=(1135.83,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(185.846,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(RCCJ) + radical(CJC(C)OC)"""),
)
...
species(
    label = '[CH]=CC([CH2])OCCC(20826)',
    structure = SMILES('[CH]=CC([CH2])OCCC'),
    E0 = (227.696,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.111017,0.0928845,-8.58827e-05,4.39864e-08,-9.43543e-12,27531.4,33.6765], Tmin=(100,'K'), Tmax=(1097.23,'K')), NASAPolynomial(coeffs=[13.1872,0.0444046,-1.96062e-05,3.71693e-09,-2.60086e-13,24613.2,-31.7137], Tmin=(1097.23,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(227.696,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_P) + radical(CJC(C)OC)"""),
)
...
species(
    label = '[CH2]C(C=C)O[CH]C(18952)',
    structure = SMILES('[CH2]C(C=C)O[CH]C'),
    E0 = (184.836,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,2750,2800,2850,1350,1500,750,1050,1375,1000,2950,3100,1380,975,1025,1650,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.105822,0.0840365,-8.33187e-05,4.3911e-08,-9.34447e-12,22372.2,29.6907], Tmin=(100,'K'), Tmax=(1131.19,'K')), NASAPolynomial(coeffs=[15.1377,0.0308822,-1.28342e-05,2.37099e-09,-1.63883e-13,18971.4,-44.6826], Tmin=(1131.19,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(184.836,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CJC(C)OC) + radical(CCsJOCs)"""),
)
...
species(
    label = '[CH2]C(C)OC([CH2])C=C(20833)',
    structure = SMILES('[CH2]C(C)OC([CH2])C=C'),
    E0 = (180.559,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,3100,1380,975,1025,1650,3010,987.5,1337.5,450,1655,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.444695,0.100527,-0.000103631,5.88802e-08,-1.37711e-11,21874,33.8817], Tmin=(100,'K'), Tmax=(1023.16,'K')), NASAPolynomial(coeffs=[14.3773,0.0425815,-1.86796e-05,3.52835e-09,-2.46428e-13,18840.9,-37.9652], Tmin=(1023.16,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(180.559,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CJC(C)OC) + radical(CJC(C)OC)"""),
)
...
species(
    label = 'C=C[CH]O[CH]CC(20834)',
    structure = SMILES('[CH2]C=CO[CH]CC'),
    E0 = (100.114,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2995,3025,975,1000,1300,1375,400,500,1630,1680,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,3025,407.5,1350,352.5,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.20429,0.0760142,-3.39064e-05,-2.40935e-08,1.86129e-11,12207.3,27.5786], Tmin=(100,'K'), Tmax=(943.738,'K')), NASAPolynomial(coeffs=[23.3424,0.0168538,-4.47206e-06,7.45597e-10,-5.51464e-14,5953.08,-94.246], Tmin=(943.738,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(100.114,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(CCsJOC(O)) + radical(Allyl_P)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]C(C=C)O[CH]CC(20589)'],
    products = ['[CH2]C1CC1O[CH]CC(20815)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH2]C(C=C)O[CH]CC(20589)'],
    products = ['[CH2]C1OC(CC)C1[CH2](20816)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)', '[CH2]C(C=C)OC=CC(20818)'],
    products = ['[CH2]C(C=C)O[CH]CC(20589)'],
    transitionState = 'TS5',
...
reaction(
    ...
    products = ['[CH2]C(C=C)O[CH]CC(20589)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(8e+09,'cm^3/(mol*s)'), n=1.39, Ea=(90.6719,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), comment="""Estimated using template [Od_CO-CsH;YJ] for rate rule [Od_CO-CsH;CJ]
Euclidian distance = 1.0
Multiplied by reaction path degeneracy 2.0
family: R_Addition_MultipleBond
Ea raised from 89.1 to 90.7 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction7',
    reactants = ['C2H3(30)', 'C=CO[CH]CC(10587)'],
    products = ['[CH2]C(C=C)O[CH]CC(20589)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['CH3(17)', '[CH2]C(C=C)OC=C(19581)'],
    products = ['[CH2]C(C=C)O[CH]CC(20589)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]C(C=C)OC[CH]C(20820)'],
    products = ['[CH2]C(C=C)O[CH]CC(20589)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2]CCOC([CH2])C=C(20822)'],
    products = ['[CH2]C(C=C)O[CH]CC(20589)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH]=CC([CH2])OCCC(20826)'],
    products = ['[CH2]C(C=C)O[CH]CC(20589)'],
...
reaction(
    label = 'reaction24',
    reactants = ['CH2(S)(23)', '[CH2]C(C=C)O[CH]C(18952)'],
    products = ['[CH2]C(C=C)O[CH]CC(20589)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[CH2]C(C=C)O[CH]CC(20589)'],
    products = ['C=CC[CH]O[CH]CC(20832)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[CH2]C(C)OC([CH2])C=C(20833)'],
    products = ['[CH2]C(C=C)O[CH]CC(20589)'],
...
reaction(
    label = 'reaction28',
    reactants = ['[CH]CC(144)', '[CH2]C([O])C=C(4292)'],
    products = ['[CH2]C(C=C)O[CH]CC(20589)'],
...
reaction(
    label = 'reaction29',
    reactants = ['CH2(19)', 'C=C[CH]O[CH]CC(20834)'],
    products = ['[CH2]C(C=C)O[CH]CC(20589)'],
