...
species(
    label = '[CH2]CCCCOO(278)',
    structure = SMILES('[CH2]CCCCOO'),
    E0 = (-51.1604,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,3615,1310,387.5,850,1000,3000,3100,440,815,1455,1000,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.894218,0.0754771,-9.4872e-05,8.32046e-08,-3.05787e-11,10936.2,29.7843], Tmin=(100,'K'), Tmax=(813.65,'K')), NASAPolynomial(coeffs=[3.62277,0.0491009,-2.23499e-05,4.20365e-09,-2.89042e-13,10921.2,19.82], Tmin=(813.65,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(90.0562,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(ROOJ)"""),
)
...
species(
    ...
    molecularWeight = (102.132,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.868212,0.0748545,-8.90976e-05,7.39615e-08,-2.63234e-11,10936.8,30.0504], Tmin=(100,'K'), Tmax=(800.838,'K')), NASAPolynomial(coeffs=[4.67104,0.0472291,-2.11876e-05,3.97101e-09,-2.7308e-13,10604.5,14.2766], Tmin=(800.838,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(90.0442,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(RCCJC) + radical(ROOJ)"""),
)
...
species(
    label = 'C[CH][CH]CCOO(1472)',
    structure = SMILES('C[CH][CH]CCOO'),
    E0 = (132.498,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3050,390,425,1340,1360,335,370,3615,1310,387.5,850,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,206.784,808.031,1636.36],'cm^-1')),
...
species(
    ...
    molecularWeight = (102.132,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.609491,0.081167,-0.000101193,8.47454e-08,-3.02404e-11,15344.9,30.3697], Tmin=(100,'K'), Tmax=(784.124,'K')), NASAPolynomial(coeffs=[5.46297,0.0481599,-2.22731e-05,4.2319e-09,-2.93324e-13,14837.3,9.7517], Tmin=(784.124,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(126.622,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(RCCJC) + radical(CCsJOOH)"""),
)
...
species(
    label = 'C[C]CCCOO(1479)',
    structure = SMILES('C[C]CCCOO'),
    E0 = (191.808,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3615,1310,387.5,850,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
reaction(
    label = 'reaction17',
    reactants = ['CCCCCO[O](165)'],
    products = ['C=CCCC(134)', 'HO2(10)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction3',
    reactants = ['CCC[CH]COO(275)'],
    products = ['CCCCCO[O](165)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2]CO[O](98)', 'npropyl(83)'],
    products = ['CCCCCO[O](165)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction8',
    reactants = ['C2H5(29)', '[CH2]CCO[O](270)'],
    products = ['CCCCCO[O](165)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(8.73e+14,'cm^3/(mol*s)'), n=-0.699, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(200,'K'), Tmax=(2000,'K'), comment="""From training reaction 11 used for C_rad/H2/Cs;C_rad/H2/Cs
Exact match found for rate rule [C_rad/H2/Cs;C_rad/H2/Cs]
...
reaction(
    label = 'reaction10',
    reactants = ['butyl_1(82)', '[CH2]O[O](92)'],
    products = ['CCCCCO[O](165)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]CCCO[O](272)', 'CH3(17)'],
    products = ['CCCCCO[O](165)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CCCCO[O](164)', 'CH2(S)(23)'],
    products = ['CCCCCO[O](165)'],
...
reaction(
    label = 'reaction21',
    reactants = ['CH2CH2OOH(45)', 'C3H6(72)'],
    products = ['C[CH]CCCOO(277)'],
...
reaction(
    label = 'reaction26',
    reactants = ['OH(5)', 'C[CH]CCC[O](1470)'],
    products = ['C[CH]CCCOO(277)'],
...
reaction(
    label = 'reaction27',
    reactants = ['[CH2]CC[CH]C(136)', 'HO2(10)'],
    products = ['C[CH]CCCOO(277)'],
...
reaction(
    label = 'reaction29',
    reactants = ['C3H6(T)(143)', 'CH2CH2OOH(45)'],
    products = ['C[CH]CCCOO(277)'],
...
reaction(
    label = 'reaction30',
    reactants = ['[CH2]C[CH]C(129)', 'CH2OOH(35)'],
    products = ['C[CH]CCCOO(277)'],
...
reaction(
    label = 'reaction31',
    reactants = ['H(3)', 'C[CH]C[CH]COO(1471)'],
    products = ['C[CH]CCCOO(277)'],
...
reaction(
    label = 'reaction32',
    reactants = ['H(3)', 'C[CH][CH]CCOO(1472)'],
    products = ['C[CH]CCCOO(277)'],
...
reaction(
    label = 'reaction33',
    reactants = ['H(3)', 'C[CH]CC[CH]OO(1473)'],
    products = ['C[CH]CCCOO(277)'],
...
reaction(
    label = 'reaction34',
    reactants = ['H(3)', '[CH2][CH]CCCOO(1474)'],
    products = ['C[CH]CCCOO(277)'],
...
reaction(
    label = 'reaction35',
    reactants = ['C[CH]CCCOO(277)'],
    products = ['OH(5)', 'CC1CCCO1(1475)'],
...
reaction(
    label = 'reaction38',
    reactants = ['QOOH_1(290)', 'CHCH3(T)(95)'],
    products = ['C[CH]CCCOO(277)'],
...
reaction(
    label = 'reaction39',
    reactants = ['CH3(17)', '[CH]CCCOO(1478)'],
    products = ['C[CH]CCCOO(277)'],
...
network(
    ...
    reactants = [
        ('C=CCCC(134)', 'HO2(10)'),
        ('O2(2)', '[CH2]CCCC(84)'),
        ('CCCCO[O](164)', 'CH2(S)(23)'),
        ('CH2CH2OOH(45)', 'C3H6(72)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
