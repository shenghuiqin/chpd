species(
    label = 'O=[C]CO[CH]CCC=O(21331)',
    structure = SMILES('O=[C]CO[CH]CCC=O'),
    E0 = (-135.195,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,1855,455,950,2782.5,750,1395,475,1775,1000,3025,407.5,1350,352.5,200,800,1066.67,1333.33,1600],'cm^-1')),
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.148184,0.0983403,-0.000129205,9.84227e-08,-3.10412e-11,-16117.4,34.7431], Tmin=(100,'K'), Tmax=(767.758,'K')), NASAPolynomial(coeffs=[10.5392,0.042657,-2.04103e-05,3.94928e-09,-2.77189e-13,-17758.4,-13.9925], Tmin=(767.758,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-135.195,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-O2d)OsHH) + group(Cds-OdCsH) + group(Cds-OdCsH) + radical(CsCJ=O) + radical(CCsJOCs)"""),
)
...
species(
    ...
    molecularWeight = (128.126,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.351673,0.0658235,-2.06843e-05,-1.97889e-08,1.16551e-11,-3395.46,32.1575], Tmin=(100,'K'), Tmax=(1047.48,'K')), NASAPolynomial(coeffs=[17.5413,0.0301887,-1.26256e-05,2.43093e-09,-1.75347e-13,-8642.8,-59.4277], Tmin=(1047.48,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-29.4269,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(394.937,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)OsHH) + group(Cds-OdCsH) + ring(Cyclobutane) + radical(CC(C)OJ) + radical(CsCJ=O)"""),
)
...
species(
    label = 'O=[C]COC=CCC=O(21506)',
    structure = SMILES('O=[C]COC=CCC=O'),
    E0 = (-232.713,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,1855,455,950,2995,3025,975,1000,1300,1375,400,500,1630,1680,2782.5,750,1395,475,1775,1000,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0229976,0.0708735,-2.73998e-05,-2.20774e-08,1.44013e-11,-27828.7,32.3205], Tmin=(100,'K'), Tmax=(1027.65,'K')), NASAPolynomial(coeffs=[22.6499,0.0204688,-9.06935e-06,1.86805e-09,-1.42051e-13,-34487.1,-87.405], Tmin=(1027.65,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-232.713,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(Cs-(Cds-O2d)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-OdCsH) + group(Cds-OdCsH) + radical(CsCJ=O)"""),
)
...
species(
    label = 'O=[C]COC[CH]CC=O(21508)',
    structure = SMILES('O=[C]COC[CH]CC=O'),
    E0 = (-115.749,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,1855,455,950,2782.5,750,1395,475,1775,1000,3025,407.5,1350,352.5,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (128.126,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.479901,0.0844081,-9.47737e-05,6.55815e-08,-1.97131e-11,-13800.8,35.5488], Tmin=(100,'K'), Tmax=(788.587,'K')), NASAPolynomial(coeffs=[7.9804,0.0463597,-2.23944e-05,4.38739e-09,-3.11518e-13,-14983.7,1.14536], Tmin=(788.587,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-115.749,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-O2d)OsHH) + group(Cds-OdCsH) + group(Cds-OdCsH) + radical(CsCJ=O) + radical(CCJCO)"""),
)
...
species(
    ...
    molecularWeight = (128.126,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.383982,0.0864153,-7.75157e-05,3.49175e-08,-6.22223e-12,-20568.7,35.8497], Tmin=(100,'K'), Tmax=(1355.16,'K')), NASAPolynomial(coeffs=[20.1633,0.0257658,-1.03837e-05,1.89196e-09,-1.29652e-13,-26137.6,-69.5239], Tmin=(1355.16,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-172.399,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-O2d)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-OdCsH) + radical(CsCJ=O) + radical(C=COJ)"""),
)

species(
    label = 'O=[C]CCCOC[C]=O(21512)',
    structure = SMILES('O=[C]CCCOC[C]=O'),
    E0 = (-155.69,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.126,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0113994,0.0955279,-0.000130264,1.07149e-07,-3.66505e-11,-18587.7,35.6152], Tmin=(100,'K'), Tmax=(761.549,'K')), NASAPolynomial(coeffs=[8.79649,0.0447709,-2.14376e-05,4.13316e-09,-2.88714e-13,-19798.9,-3.6229], Tmin=(761.549,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-155.69,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-O2d)OsHH) + group(Cds-OdCsH) + group(Cds-OdCsH) + radical(CsCJ=O) + radical(CCCJ=O)"""),
)

species(
    label = 'O=CC[CH][CH]OCC=O(21513)',
    structure = SMILES('O=CC[CH][CH]OCC=O'),
    E0 = (-89.9637,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2695,2870,700,800,1380,1410,450,500,1750,1800,900,1100,3000,3050,390,425,1340,1360,335,370,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (128.126,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.124837,0.0911397,-0.000104837,6.84374e-08,-1.85993e-11,-10685.7,35.5875], Tmin=(100,'K'), Tmax=(882.404,'K')), NASAPolynomial(coeffs=[11.2418,0.0407454,-1.91707e-05,3.71554e-09,-2.62424e-13,-12647.6,-16.6546], Tmin=(882.404,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-89.9637,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-O2d)OsHH) + group(Cds-OdCsH) + group(Cds-OdCsH) + radical(CCJCO) + radical(CCsJOCs)"""),
)

species(
    label = 'O=C[CH]C[CH]OCC=O(21514)',
    structure = SMILES('[O]C=CC[CH]OCC=O'),
    E0 = (-146.614,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.126,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.883613,0.0948406,-9.35262e-05,4.57168e-08,-8.69002e-12,-17447.2,36.4083], Tmin=(100,'K'), Tmax=(1290.34,'K')), NASAPolynomial(coeffs=[22.9597,0.020928,-7.60444e-06,1.32478e-09,-8.92357e-14,-23600.4,-84.6996], Tmin=(1290.34,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-146.614,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-O2d)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-OdCsH) + radical(C=COJ) + radical(CCsJOCs)"""),
)

species(
    label = 'O=[C]CC[CH]OCC=O(21515)',
    structure = SMILES('O=[C]CC[CH]OCC=O'),
    E0 = (-129.905,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,1855,455,950,2782.5,750,1395,475,1775,1000,3025,407.5,1350,352.5,200,800,1066.67,1333.33,1600],'cm^-1')),
    ...
    molecularWeight = (128.126,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.31813,0.101525,-0.000136899,1.04147e-07,-3.23061e-11,-15474.5,35.4904], Tmin=(100,'K'), Tmax=(784.61,'K')), NASAPolynomial(coeffs=[11.8319,0.039583,-1.84785e-05,3.52716e-09,-2.45299e-13,-17381.1,-20.1793], Tmin=(784.61,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-129.905,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-O2d)OsHH) + group(Cds-OdCsH) + group(Cds-OdCsH) + radical(CCsJOCs) + radical(CCCJ=O)"""),
)
...
species(
    ...
    molecularWeight = (128.126,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.448223,0.0647474,-1.39224e-05,-3.48119e-08,2.06752e-11,-17546.6,28.9258], Tmin=(100,'K'), Tmax=(922.798,'K')), NASAPolynomial(coeffs=[17.3057,0.0262538,-7.55671e-06,1.19429e-09,-7.99908e-14,-22130.1,-59.0242], Tmin=(922.798,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-147.057,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(394.937,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-(Cds-O2d)OsHH) + group(Cds-OdCsH) + ring(Tetrahydrofuran) + radical(CsCJ=O) + radical(CCsJOCs)"""),
)
...
species(
    label = 'O=CCC=COCC=O(21519)',
    structure = SMILES('O=CCC=COCC=O'),
    E0 = (-387.384,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.126,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0745234,0.0705288,-1.79784e-05,-3.33594e-08,1.85129e-11,-46428.1,31.8263], Tmin=(100,'K'), Tmax=(1018.98,'K')), NASAPolynomial(coeffs=[22.8829,0.0226877,-9.78888e-06,1.99983e-09,-1.51842e-13,-53301.7,-90.1317], Tmin=(1018.98,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-387.384,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(Cs-(Cds-O2d)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-OdCsH) + group(Cds-OdCsH)"""),
)
...
species(
    label = '[CH2]C(CC=O)OC[C]=O(21520)',
    structure = SMILES('[CH2]C(CC=O)OC[C]=O'),
    E0 = (-115.692,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2782.5,750,1395,475,1775,1000,1855,455,950,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (128.126,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.344318,0.103789,-0.000150179,1.26287e-07,-4.33002e-11,-13765.9,35.3965], Tmin=(100,'K'), Tmax=(782.822,'K')), NASAPolynomial(coeffs=[9.79409,0.0443019,-2.1473e-05,4.14176e-09,-2.88568e-13,-15117.9,-9.5296], Tmin=(782.822,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-115.692,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(Cs-CsCsOsH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)OsHH) + group(Cds-OdCsH) + group(Cds-OdCsH) + radical(CsCJ=O) + radical(CJC(C)OC)"""),
)
...
species(
    label = 'C=COC[CH]OC[C]=O(21521)',
    structure = SMILES('C=COC[CH]OC[C]=O'),
    E0 = (-93.5983,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2950,3100,1380,975,1025,1650,1855,455,950,3010,987.5,1337.5,450,1655,3025,407.5,1350,352.5,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (128.126,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.33872,0.104177,-0.000111613,5.82105e-08,-1.1669e-11,-11053.8,36.0538], Tmin=(100,'K'), Tmax=(1233.55,'K')), NASAPolynomial(coeffs=[25.534,0.0170364,-5.64926e-06,9.42157e-10,-6.25096e-14,-17683.5,-99.2317], Tmin=(1233.55,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-93.5983,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-O2d)OsHH) + group(Cds-CdsOsH) + group(Cds-OdCsH) + group(Cds-CdsHH) + radical(CsCJ=O) + radical(CCsJOCs)"""),
)

species(
    label = 'O=[C]CO[CH]CC=CO(21522)',
    structure = SMILES('O=[C]CO[CH]CC=CO'),
    E0 = (-133.406,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3025,407.5,1350,352.5,3615,1277.5,1000,1855,455,950,2995,3025,975,1000,1300,1375,400,500,1630,1680,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (128.126,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.37273,0.103752,-0.00011231,5.91145e-08,-1.19015e-11,-15839.3,37.4283], Tmin=(100,'K'), Tmax=(1270.38,'K')), NASAPolynomial(coeffs=[25.7948,0.0152807,-4.38876e-06,6.6468e-10,-4.18196e-14,-22505.5,-99.2105], Tmin=(1270.38,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-133.406,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-O2d)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-OdCsH) + radical(CCsJOCs) + radical(CsCJ=O)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['O=[C]CO[CH]CCC=O(21331)'],
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', 'O=[C]COC=CCC=O(21506)'],
    products = ['O=[C]CO[CH]CCC=O(21331)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['CH2CHO(40)', 'C=COC[C]=O(3177)'],
    products = ['O=[C]CO[CH]CCC=O(21331)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['O=[C]COC[CH]CC=O(21508)'],
    products = ['O=[C]CO[CH]CCC=O(21331)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction11',
    reactants = ['O=[C]CO[CH]CCC=O(21331)'],
    products = ['O=[C]COCC[CH]C=O(21511)'],
...
reaction(
    label = 'reaction13',
    reactants = ['O=CC[CH][CH]OCC=O(21513)'],
    products = ['O=[C]CO[CH]CCC=O(21331)'],
...
reaction(
    label = 'reaction14',
    reactants = ['O=[C]CO[CH]CCC=O(21331)'],
    products = ['O=C[CH]C[CH]OCC=O(21514)'],
...
reaction(
    label = 'reaction15',
    reactants = ['O=[C]CC[CH]OCC=O(21515)'],
    products = ['O=[C]CO[CH]CCC=O(21331)'],
...
reaction(
    label = 'reaction17',
    reactants = ['O=[C]CO[CH]CCC=O(21331)'],
    products = ['O=[C]COC1CC[CH]O1(21516)'],
...
reaction(
    label = 'reaction21',
    reactants = ['CO(12)', 'CC[CH]OC[C]=O(3471)'],
    products = ['O=[C]CO[CH]CCC=O(21331)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH2]C(CC=O)OC[C]=O(21520)'],
    products = ['O=[C]CO[CH]CCC=O(21331)'],
...
reaction(
    label = 'reaction24',
    reactants = ['CO(12)', '[CH2]O[CH]CCC=O(18485)'],
    products = ['O=[C]CO[CH]CCC=O(21331)'],
...
reaction(
    label = 'reaction25',
    reactants = ['C=COC[CH]OC[C]=O(21521)'],
    products = ['O=[C]CO[CH]CCC=O(21331)'],
...
reaction(
    label = 'reaction26',
    reactants = ['O=[C]CO[CH]CC=CO(21522)'],
    products = ['O=[C]CO[CH]CCC=O(21331)'],
...
reaction(
    label = 'reaction27',
    reactants = ['[O]C[C]=O(113)', '[CH]CCC=O(18484)'],
    products = ['O=[C]CO[CH]CCC=O(21331)'],
...
reaction(
    label = 'reaction28',
    reactants = ['[C]=O(361)', '[CH2]O[CH]CCC=O(18485)'],
    products = ['O=[C]CO[CH]CCC=O(21331)'],
