...
species(
    ...
    E0 = (-52.5474,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,2995,3025,975,1000,1300,1375,400,500,1630,1680,273.773],'cm^-1')),
        HinderedRotor(inertia=(0.169063,'amu*angstrom^2'), symmetry=1, barrier=(9.19682,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.168822,'amu*angstrom^2'), symmetry=1, barrier=(9.18017,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.173117,'amu*angstrom^2'), symmetry=1, barrier=(9.20108,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (70.1329,'amu'),
...
species(
    label = 'C[CH][CH]CC(459)',
    structure = SMILES('C[CH][CH]CC'),
    E0 = (220.82,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3000,3050,390,425,1340,1360,335,370,2185.62,2186.2],'cm^-1')),
        HinderedRotor(inertia=(0.0968094,'amu*angstrom^2'), symmetry=1, barrier=(2.22584,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0967051,'amu*angstrom^2'), symmetry=1, barrier=(2.22344,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0968319,'amu*angstrom^2'), symmetry=1, barrier=(2.22635,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.096838,'amu*angstrom^2'), symmetry=1, barrier=(2.2265,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (70.1329,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.82916,0.0356449,-8.78261e-06,-1.57855e-09,6.29743e-13,26591.6,21.3393], Tmin=(100,'K'), Tmax=(2058.93,'K')), NASAPolynomial(coeffs=[12.9598,0.0273796,-1.10782e-05,1.85776e-09,-1.14495e-13,20000.2,-40.7277], Tmin=(2058.93,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(220.82,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJC) + radical(RCCJCC)"""),
)
...
species(
    label = '[CH2]C(C)CC(1014)',
    structure = SMILES('[CH2]C(C)CC'),
    E0 = (31.3037,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3368.9],'cm^-1')),
        HinderedRotor(inertia=(0.600194,'amu*angstrom^2'), symmetry=1, barrier=(13.7996,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.211,'amu*angstrom^2'), symmetry=1, barrier=(4.85131,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.120706,'amu*angstrom^2'), symmetry=1, barrier=(82.3731,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.599694,'amu*angstrom^2'), symmetry=1, barrier=(13.7881,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (71.1408,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.65931,0.0428142,2.16812e-06,-2.73897e-08,1.23515e-11,3856.87,21.7514], Tmin=(100,'K'), Tmax=(991.734,'K')), NASAPolynomial(coeffs=[9.17446,0.032267,-1.17723e-05,2.07624e-09,-1.41959e-13,1394.33,-19.3426], Tmin=(991.734,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(31.3037,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Isobutyl)"""),
)
...
species(
    ...
    E0 = (280.131,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,274.423,274.535,3330.44],'cm^-1')),
        HinderedRotor(inertia=(0.290554,'amu*angstrom^2'), symmetry=1, barrier=(15.5402,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.45422,'amu*angstrom^2'), symmetry=1, barrier=(24.2846,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.117722,'amu*angstrom^2'), symmetry=1, barrier=(6.28725,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.454361,'amu*angstrom^2'), symmetry=1, barrier=(24.2852,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (70.1329,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.49126,0.0476292,-1.77617e-05,-4.75447e-09,3.68063e-12,33788.6,20.0704], Tmin=(100,'K'), Tmax=(1127.24,'K')), NASAPolynomial(coeffs=[10.1002,0.0302049,-1.20402e-05,2.19072e-09,-1.50454e-13,31013.8,-26.1926], Tmin=(1127.24,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(280.131,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJ2_triplet)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['C2H4(21)', 'npropyl(83)'],
    products = ['[CH2]CCCC(84)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH2]CCCC(84)'],
    products = ['C[CH]CCC(139)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH2]C[CH2](128)', 'C2H5(29)'],
    products = ['[CH2]CCCC(84)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['npropyl(83)', 'C2H4(T)(94)'],
    products = ['[CH2]CCCC(84)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2]CC[CH2](131)', 'CH3(17)'],
    products = ['[CH2]CCCC(84)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2][CH]CC(130)', 'CH3(17)'],
    products = ['CC[CH]CC(140)'],
...
reaction(
    label = 'reaction21',
    reactants = ['butyl_2(132)', 'CH2(S)(23)'],
    products = ['CC[CH]CC(140)'],
