...
species(
    label = 'CC([O])OC1CCC1[O](18673)',
    structure = SMILES('CC([O])OC1CCC1[O]'),
    E0 = (-92.0348,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (130.142,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0819735,0.0746142,-4.13708e-05,6.92808e-09,7.65065e-13,-10918.7,34.28], Tmin=(100,'K'), Tmax=(1300.63,'K')), NASAPolynomial(coeffs=[16.9526,0.0378519,-1.64135e-05,3.07496e-09,-2.12566e-13,-16586.3,-56.4623], Tmin=(1300.63,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-92.0348,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(444.824,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + ring(Cyclobutane) + radical(CCOJ) + radical(CC(C)OJ)"""),
)
...
species(
    label = 'CC([O])OC=CCC=O(18674)',
    structure = SMILES('CC([O])OC=CCC=O'),
    E0 = (-295.321,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2782.5,750,1395,475,1775,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.261831,0.0794396,-4.79276e-05,5.27217e-09,2.91266e-12,-35353.6,34.3227], Tmin=(100,'K'), Tmax=(1161.64,'K')), NASAPolynomial(coeffs=[20.6671,0.0302678,-1.3997e-05,2.76602e-09,-1.99406e-13,-41760.7,-76.4322], Tmin=(1161.64,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-295.321,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-OdCsH) + radical(CCOJ)"""),
)

species(
    label = 'CC(=O)O[CH]CCC=O(18675)',
    structure = SMILES('CC(=O)O[CH]CCC=O'),
    E0 = (-399.92,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (129.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.500922,0.0837264,-8.06327e-05,4.6603e-08,-1.18778e-11,-47979,32.4165], Tmin=(100,'K'), Tmax=(910.317,'K')), NASAPolynomial(coeffs=[8.43699,0.0488547,-2.31719e-05,4.52184e-09,-3.21108e-13,-49423.9,-5.12477], Tmin=(910.317,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-399.92,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(407.409,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-O2d)HHH) + group(Cds-OdCsOs) + group(Cds-OdCsH) + radical(CCsJOC(O))"""),
)
...
species(
    label = 'CC([O])OC[CH]CC=O(18677)',
    structure = SMILES('CC([O])OC[CH]CC=O'),
    E0 = (-178.357,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2782.5,750,1395,475,1775,1000,3025,407.5,1350,352.5,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'CC([O])OC1CC[CH]O1(18687)',
    structure = SMILES('CC([O])OC1CC[CH]O1'),
    E0 = (-209.665,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (130.142,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.220269,0.0734103,-3.59258e-05,-3.76184e-09,6.76679e-12,-25072.2,30.8748], Tmin=(100,'K'), Tmax=(985.467,'K')), NASAPolynomial(coeffs=[13.9535,0.0382314,-1.36806e-05,2.36462e-09,-1.59309e-13,-28777.5,-40.2455], Tmin=(985.467,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-209.665,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(444.824,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Tetrahydrofuran) + radical(CCOJ) + radical(CCsJOCs)"""),
)
...
species(
    label = 'CC(=O)OCCCC=O(13155)',
    structure = SMILES('CC(=O)OCCCC=O'),
    E0 = (-593.847,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (130.142,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.16673,0.0713168,-4.51926e-05,1.49306e-08,-2.22013e-12,-71329.6,30.5149], Tmin=(100,'K'), Tmax=(1355,'K')), NASAPolynomial(coeffs=[7.55127,0.0524694,-2.43283e-05,4.66521e-09,-3.26153e-13,-73059.8,-2.22638], Tmin=(1355,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-593.847,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-O2d)HHH) + group(Cds-OdCsOs) + group(Cds-OdCsH)"""),
)
...
species(
    label = '[CH2]C(CC=O)OC(C)[O](18689)',
    structure = SMILES('[CH2]C(CC=O)OC(C)[O]'),
    E0 = (-178.299,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2782.5,750,1395,475,1775,1000,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (130.142,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.538599,0.112107,-0.000171277,1.56718e-07,-5.72468e-11,-21292.9,37.2218], Tmin=(100,'K'), Tmax=(814.755,'K')), NASAPolynomial(coeffs=[6.126,0.0568068,-2.78966e-05,5.38215e-09,-3.7365e-13,-21629.5,11.0337], Tmin=(814.755,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-178.299,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(CJC(C)OC) + radical(CCOJ)"""),
)
...
species(
    label = 'CC([O])O[CH]CC=CO(18691)',
    structure = SMILES('CC([O])O[CH]CC=CO'),
    E0 = (-196.014,'kJ/mol'),
    modes = [
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', 'CC([O])OC=CCC=O(18674)'],
    products = ['CC([O])O[CH]CCC=O(18428)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)', 'CC(=O)O[CH]CCC=O(18675)'],
    products = ['CC([O])O[CH]CCC=O(18428)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['CH2CHO(40)', 'C=COC(C)[O](2314)'],
    products = ['CC([O])O[CH]CCC=O(18428)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['CH3(17)', 'O=CCC[CH]OC=O(18676)'],
    products = ['CC([O])O[CH]CCC=O(18428)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['CC([O])OC[CH]CC=O(18677)'],
    products = ['CC([O])O[CH]CCC=O(18428)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction12',
    reactants = ['CC([O])O[CH]CCC=O(18428)'],
    products = ['CC([O])OCC[CH]C=O(18680)'],
...
reaction(
    label = 'reaction20',
    reactants = ['CC([O])O[CH]CCC=O(18428)'],
    products = ['CC([O])OC1CC[CH]O1(18687)'],
...
reaction(
    label = 'reaction24',
    reactants = ['CH2(S)(23)', '[O]CO[CH]CCC=O(18420)'],
    products = ['CC([O])O[CH]CCC=O(18428)'],
...
reaction(
    label = 'reaction25',
    reactants = ['CO(12)', 'CC[CH]OC(C)[O](11116)'],
    products = ['CC([O])O[CH]CCC=O(18428)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[CH2]C(CC=O)OC(C)[O](18689)'],
    products = ['CC([O])O[CH]CCC=O(18428)'],
...
reaction(
    label = 'reaction28',
    reactants = ['C=COC[CH]OC(C)[O](18690)'],
    products = ['CC([O])O[CH]CCC=O(18428)'],
...
reaction(
    label = 'reaction29',
    reactants = ['CC([O])O[CH]CC=CO(18691)'],
    products = ['CC([O])O[CH]CCC=O(18428)'],
...
reaction(
    label = 'reaction30',
    reactants = ['CC([O])[O](2201)', '[CH]CCC=O(18484)'],
    products = ['CC([O])O[CH]CCC=O(18428)'],
