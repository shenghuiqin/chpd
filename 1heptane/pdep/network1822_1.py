...
species(
    label = 'C=C(OO)OO[CH]C(10330)',
    structure = SMILES('C=C(OO)OO[CH]C'),
    E0 = (74.0267,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,2950,3100,1380,975,1025,1650,3615,1310,387.5,850,1000,350,440,435,1725,350,500,795,815,200],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.129235,0.0965358,-0.000156576,1.45875e-07,-5.35223e-11,9031.69,31.3622], Tmin=(100,'K'), Tmax=(816.891,'K')), NASAPolynomial(coeffs=[6.10342,0.0455914,-2.32007e-05,4.5215e-09,-3.1494e-13,8779.37,8.17834], Tmin=(816.891,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(74.0267,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(332.579,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(CCsJOOC)"""),
)
...
species(
    label = 'C[CH]OOC(C)=O(10332)',
    structure = SMILES('C[CH]OOC(C)=O'),
    E0 = (-296.936,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3025,407.5,1350,352.5,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.10452,0.0516159,-1.06128e-05,-2.15915e-08,1.10972e-11,-35598.6,26.3771], Tmin=(100,'K'), Tmax=(1047.42,'K')), NASAPolynomial(coeffs=[14.4596,0.0262931,-1.11233e-05,2.1403e-09,-1.54035e-13,-39804.8,-45.3963], Tmin=(1047.42,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-296.936,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-O2d)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)HHH) + group(Cds-OdCsOs) + radical(CCsJOOC)"""),
)

species(
    label = '[CH2]C(OO)OO[CH]C(10333)',
    structure = SMILES('[CH2]C(OO)OO[CH]C'),
    E0 = (48.9876,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1310,387.5,850,1000,350,500,795,815,3000,3100,440,815,1455,1000,1380,1390,370,380,2900,435,200],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (120.104,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0686535,0.0942507,-0.00011593,8.10349e-08,-2.36818e-11,6026.54,33.0139], Tmin=(100,'K'), Tmax=(821.285,'K')), NASAPolynomial(coeffs=[10.7031,0.0424539,-2.13229e-05,4.23505e-09,-3.02681e-13,4279.86,-16.1966], Tmin=(821.285,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(48.9876,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(353.365,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCsJOOC) + radical(CJCOOH)"""),
)

species(
    label = '[CH2]COO[C](C)OO(10334)',
    structure = SMILES('[CH2]COO[C](C)OO'),
    E0 = (67.7933,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (120.104,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.118916,0.0928881,-0.000111329,7.47879e-08,-2.09581e-11,8286.87,33.227], Tmin=(100,'K'), Tmax=(855.018,'K')), NASAPolynomial(coeffs=[11.1632,0.0412212,-2.06893e-05,4.11655e-09,-2.94806e-13,6398.23,-18.3255], Tmin=(855.018,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(67.7933,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(353.365,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJCOOH) + radical(Cs_P)"""),
)

species(
    label = 'C[CH]OOC(C)O[O](10335)',
    structure = SMILES('C[CH]OOC(C)O[O]'),
    E0 = (-12.9702,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (120.104,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.234804,0.0900651,-0.00011596,9.05312e-08,-2.99353e-11,-1431.11,31.1684], Tmin=(100,'K'), Tmax=(727.62,'K')), NASAPolynomial(coeffs=[8.54675,0.0443792,-2.17946e-05,4.26871e-09,-3.01854e-13,-2640.91,-6.29035], Tmin=(727.62,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-12.9702,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCsJOOC) + radical(ROOJ)"""),
)

species(
    label = '[CH2][C](OO)OOCC(10336)',
    structure = SMILES('[CH2][C](OO)OOCC'),
    E0 = (67.7933,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350,2750,2850,1437.5,1250,1305,750,350,350,500,795,815,3000,3100,440,815,1455,1000,3615,1310,387.5,850,1000,200],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (120.104,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.118928,0.0928879,-0.000111329,7.47874e-08,-2.09579e-11,8286.87,33.2269], Tmin=(100,'K'), Tmax=(855.038,'K')), NASAPolynomial(coeffs=[11.1632,0.0412212,-2.06892e-05,4.11654e-09,-2.94806e-13,6398.22,-18.3256], Tmin=(855.038,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(67.7933,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(353.365,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Cs_P) + radical(CJCOOH)"""),
)

species(
    label = '[CH2][CH]OOC(C)OO(10337)',
    structure = SMILES('[CH2][CH]OOC(C)OO'),
    E0 = (48.9876,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1310,387.5,850,1000,350,500,795,815,3000,3100,440,815,1455,1000,1380,1390,370,380,2900,435,200],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'CCOO[C](C)O[O](10338)',
    structure = SMILES('CCOO[C](C)O[O]'),
    E0 = (5.83542,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (120.104,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.312191,0.0882972,-0.00010949,8.10998e-08,-2.54497e-11,828.089,31.2893], Tmin=(100,'K'), Tmax=(764.421,'K')), NASAPolynomial(coeffs=[8.90504,0.0433388,-2.12803e-05,4.17992e-09,-2.96542e-13,-485.784,-7.85891], Tmin=(764.421,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(5.83542,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(Cs_P)"""),
)
...
species(
    label = 'C=C(OO)OOCC(10339)',
    structure = SMILES('C=C(OO)OOCC'),
    E0 = (-112.414,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (120.104,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.137418,0.0944966,-0.000141767,1.27887e-07,-4.67468e-11,-13390.4,31.0387], Tmin=(100,'K'), Tmax=(791.68,'K')), NASAPolynomial(coeffs=[6.60537,0.046951,-2.35155e-05,4.5896e-09,-3.21418e-13,-13948.7,4.28771], Tmin=(791.68,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-112.414,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH)"""),
)

species(
    label = 'C=COOC(C)OO(10340)',
    ...
    molecularWeight = (120.104,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.215541,0.0822533,-7.57535e-05,3.54768e-08,-6.73436e-12,-24939.6,30.854], Tmin=(100,'K'), Tmax=(1248.93,'K')), NASAPolynomial(coeffs=[16.1094,0.0313483,-1.46139e-05,2.84042e-09,-2.01364e-13,-28909.6,-49.3575], Tmin=(1248.93,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-208.498,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH)"""),
)
...
species(
    ...
    molecularWeight = (120.104,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.225019,0.0938988,-0.000144584,1.33574e-07,-4.89311e-11,-22865,32.3855], Tmin=(100,'K'), Tmax=(825.127,'K')), NASAPolynomial(coeffs=[5.08926,0.0489026,-2.38536e-05,4.57475e-09,-3.16101e-13,-22938.7,14.271], Tmin=(825.127,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-191.153,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsOsOs) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCsJOOC) + radical(CCOJ)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'C=C(OO)OO[CH]C(10330)'],
    products = ['C[CH]OO[C](C)OO(8874)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'C=COO[C](C)OO(10331)'],
    products = ['C[CH]OO[C](C)OO(8874)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['OH(5)', 'C[CH]OOC(C)=O(10332)'],
    products = ['C[CH]OO[C](C)OO(8874)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[CH2]C(OO)OO[CH]C(10333)'],
    products = ['C[CH]OO[C](C)OO(8874)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2][CH]OOC(C)OO(10337)'],
    products = ['C[CH]OO[C](C)OO(8874)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(1331.42,'s^-1'), n=2.39583, Ea=(60.5745,'kJ/mol'), T0=(1,'K'), comment="""Estimated using average of templates [R5Hall;Y_rad_out;Cs_H_out_OOH/Cs] + [R5Hall;C_rad_out_2H;Cs_H_out] for rate rule [R5HJ_1;C_rad_out_2H;Cs_H_out_OOH/Cs]
...
reaction(
    label = 'reaction16',
    reactants = ['C[CH]O[O](97)', 'C[C]OO(178)'],
    products = ['C[CH]OO[C](C)OO(8874)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CHCH3(T)(95)', 'C[C](O[O])OO(5665)'],
    products = ['C[CH]OO[C](C)OO(8874)'],
