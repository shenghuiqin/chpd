species(
    label = 'CCC[CH]CO[CH]CC(C)OO(13553)',
    structure = SMILES('CCC[CH]CO[CH]CC(C)OO'),
    E0 = (-112.881,'kJ/mol'),
    modes = [
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.67778,0.153512,-0.000154272,8.70611e-08,-2.05556e-11,-13341.5,51.2625], Tmin=(100,'K'), Tmax=(1004.95,'K')), NASAPolynomial(coeffs=[17.8459,0.0718216,-3.2341e-05,6.17409e-09,-4.33484e-13,-17466.6,-47.8536], Tmin=(1004.95,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-112.881,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(685.944,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJCO) + radical(CCsJOCs)"""),
)
...
species(
    label = 'CCC=CCO[CH]CC(C)OO(14209)',
    structure = SMILES('CCC=CCO[CH]CC(C)OO'),
    E0 = (-190.555,'kJ/mol'),
    modes = [
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.33206,0.145878,-0.000143024,7.89102e-08,-1.83141e-11,-22695.9,48.6113], Tmin=(100,'K'), Tmax=(1017.79,'K')), NASAPolynomial(coeffs=[16.8588,0.0704546,-3.18642e-05,6.09727e-09,-4.28668e-13,-26602.3,-44.3117], Tmin=(1017.79,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-190.555,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(665.158,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(CCsJOCs)"""),
)

species(
    label = 'CCC[CH]COC=CC(C)OO(14210)',
    structure = SMILES('CCC[CH]COC=CC(C)OO'),
    E0 = (-216.918,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,2995,3025,975,1000,1300,1375,400,500,1630,1680,3615,1310,387.5,850,1000,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,1380,1390,370,380,2900,435,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (173.229,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-3.31288,0.140999,-0.000105458,2.9158e-08,5.46443e-13,-25808.9,52.9124], Tmin=(100,'K'), Tmax=(1058.58,'K')), NASAPolynomial(coeffs=[30.2338,0.0468552,-1.82763e-05,3.36126e-09,-2.35569e-13,-34738.8,-119.473], Tmin=(1058.58,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-216.918,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(665.158,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(CCJCO)"""),
)

species(
    label = 'CCCC=CO[CH]CC(C)OO(14211)',
    structure = SMILES('CCCC=CO[CH]CC(C)OO'),
    E0 = (-222.557,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,2995,3025,975,1000,1300,1375,400,500,1630,1680,3615,1310,387.5,850,1000,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,1380,1390,370,380,2900,435,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (173.229,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-3.90253,0.158521,-0.000151967,7.39221e-08,-1.41844e-11,-26470.1,51.0994], Tmin=(100,'K'), Tmax=(1266.68,'K')), NASAPolynomial(coeffs=[32.0669,0.0449379,-1.7465e-05,3.13447e-09,-2.13728e-13,-35582.7,-130.936], Tmin=(1266.68,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-222.557,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(665.158,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(CCsJOC(O))"""),
)
...
species(
    label = 'C=CCO[CH]CC(C)OO(7625)',
    structure = SMILES('C=CCO[CH]CC(C)OO'),
    E0 = (-131.884,'kJ/mol'),
    modes = [
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.20337,0.120402,-0.000126961,7.51278e-08,-1.8522e-11,-15679.6,39.8408], Tmin=(100,'K'), Tmax=(967.102,'K')), NASAPolynomial(coeffs=[14.7049,0.0546042,-2.4907e-05,4.77743e-09,-3.36138e-13,-18756.5,-36.3752], Tmin=(967.102,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-131.884,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(523.812,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CCsJOCs)"""),
)
...
species(
    label = 'CC[CH]CCO[CH]CC(C)OO(14212)',
    structure = SMILES('CC[CH]CCO[CH]CC(C)OO'),
    E0 = (-118.325,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3000,3050,390,425,1340,1360,335,370,3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,200,800,933.333,1066.67,1200,1333.33,1466.67,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (174.237,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.86221,0.162082,-0.000197092,1.46657e-07,-4.61864e-11,-13994.4,51.9914], Tmin=(100,'K'), Tmax=(763.48,'K')), NASAPolynomial(coeffs=[12.6644,0.0807387,-3.72839e-05,7.11857e-09,-4.96556e-13,-16365.4,-18.726], Tmin=(763.48,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-118.325,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(685.944,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(CCsJOCs)"""),
)

species(
    label = 'CCC[CH]COC[CH]C(C)OO(14213)',
    structure = SMILES('CCC[CH]COC[CH]C(C)OO'),
    E0 = (-92.9225,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3000,3050,390,425,1340,1360,335,370,3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,200,800,933.333,1066.67,1200,1333.33,1466.67,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (174.237,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.24889,0.147154,-0.000145531,8.45308e-08,-2.11433e-11,-10959.2,52.5935], Tmin=(100,'K'), Tmax=(938.405,'K')), NASAPolynomial(coeffs=[13.7623,0.0789051,-3.64387e-05,7.02846e-09,-4.95944e-13,-13964.2,-23.6335], Tmin=(938.405,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-92.9225,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(685.944,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJCOOH) + radical(CCJCO)"""),
)
...
species(
    label = 'CCC[CH][CH]OCCC(C)OO(14214)',
    structure = SMILES('CCC[CH][CH]OCCC(C)OO'),
    E0 = (-112.881,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3000,3050,390,425,1340,1360,335,370,3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,200,800,933.333,1066.67,1200,1333.33,1466.67,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'C[CH]CCCO[CH]CC(C)OO(14215)',
    structure = SMILES('C[CH]CCCO[CH]CC(C)OO'),
    E0 = (-118.337,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (174.237,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.81987,0.160576,-0.00018781,1.32126e-07,-3.92662e-11,-13996.6,52.0172], Tmin=(100,'K'), Tmax=(807.261,'K')), NASAPolynomial(coeffs=[13.6441,0.0789879,-3.61933e-05,6.90316e-09,-4.82041e-13,-16654.5,-23.8854], Tmin=(807.261,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-118.337,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(685.944,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCsJOCs) + radical(RCCJC)"""),
)

species(
    label = 'CCC[CH]COCC[C](C)OO(14216)',
    structure = SMILES('CCC[CH]COCC[C](C)OO'),
    E0 = (-106.438,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (174.237,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.272,0.149175,-0.000159748,1.06478e-07,-3.09644e-11,-12585.7,50.669], Tmin=(100,'K'), Tmax=(812.485,'K')), NASAPolynomial(coeffs=[10.9915,0.0838796,-3.92072e-05,7.57552e-09,-5.33985e-13,-14741.1,-10.5661], Tmin=(812.485,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-106.438,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(685.944,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(C2CsJOOH) + radical(CCJCO)"""),
)

species(
    label = '[CH2]C(CCOC[CH]CCC)OO(14217)',
    structure = SMILES('[CH2]C(CCOC[CH]CCC)OO'),
    E0 = (-79.3749,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (174.237,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.36375,0.148228,-0.000144531,8.07164e-08,-1.9183e-11,-9324.33,52.6894], Tmin=(100,'K'), Tmax=(989.432,'K')), NASAPolynomial(coeffs=[15.5717,0.0757198,-3.46056e-05,6.64981e-09,-4.68464e-13,-12873.5,-33.6483], Tmin=(989.432,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-79.3749,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(685.944,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJCOOH) + radical(CCJCO)"""),
)

species(
    label = '[CH2]CCCCO[CH]CC(C)OO(14218)',
    structure = SMILES('[CH2]CCCCO[CH]CC(C)OO'),
    E0 = (-107.537,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1310,387.5,850,1000,2750,2761.11,2772.22,2783.33,2794.44,2805.56,2816.67,2827.78,2838.89,2850,1425,1431.25,1437.5,1443.75,1450,1225,1237.5,1250,1262.5,1275,1270,1287.5,1305,1322.5,1340,700,725,750,775,800,300,325,350,375,400,3000,3100,440,815,1455,1000,1380,1390,370,380,2900,435,200,800,933.333,1066.67,1200,1333.33,1466.67,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (174.237,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.83094,0.159283,-0.000172176,1.06606e-07,-2.76571e-11,-12695.4,51.111], Tmin=(100,'K'), Tmax=(919.819,'K')), NASAPolynomial(coeffs=[16.638,0.0746183,-3.41093e-05,6.53768e-09,-4.59366e-13,-16277,-41.1881], Tmin=(919.819,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-107.537,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(685.944,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJ) + radical(CCsJOCs)"""),
)

species(
    label = 'CCCCCO[CH][CH]C(C)OO(14219)',
    structure = SMILES('CCCCCO[CH][CH]C(C)OO'),
    E0 = (-112.369,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (174.237,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.86924,0.160859,-0.000178506,1.14521e-07,-3.08172e-11,-13275.9,51.7687], Tmin=(100,'K'), Tmax=(888.411,'K')), NASAPolynomial(coeffs=[16.0377,0.0757329,-3.47818e-05,6.6715e-09,-4.68594e-13,-16635.4,-37.2096], Tmin=(888.411,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-112.369,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(685.944,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJCOOH) + radical(CCsJOCs)"""),
)

species(
    label = 'CCC[CH]COCCC(C)O[O](14220)',
    structure = SMILES('CCC[CH]COCCC(C)O[O]'),
    E0 = (-141.333,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2761.11,2772.22,2783.33,2794.44,2805.56,2816.67,2827.78,2838.89,2850,1425,1431.25,1437.5,1443.75,1450,1225,1237.5,1250,1262.5,1275,1270,1287.5,1305,1322.5,1340,700,725,750,775,800,300,325,350,375,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3025,407.5,1350,352.5,492.5,1135,1000,1380,1390,370,380,2900,435,180,180,180,180,1600,1623.56,2884.82,3200],'cm^-1')),
    ...
    molecularWeight = (174.237,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.06829,0.142273,-0.000137152,7.86769e-08,-1.9548e-11,-16787.3,50.3957], Tmin=(100,'K'), Tmax=(942.204,'K')), NASAPolynomial(coeffs=[12.9614,0.0784674,-3.55732e-05,6.80444e-09,-4.77915e-13,-19619.6,-21.2192], Tmin=(942.204,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-141.333,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(690.101,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(CCJCO)"""),
)

species(
    label = 'CC[CH][CH]COCCC(C)OO(14221)',
    structure = SMILES('CC[CH][CH]COCCC(C)OO'),
    E0 = (-98.8792,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3000,3050,390,425,1340,1360,335,370,3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,200,800,933.333,1066.67,1200,1333.33,1466.67,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (174.237,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.23634,0.148171,-0.000162707,1.13833e-07,-3.48449e-11,-11677.8,52.8054], Tmin=(100,'K'), Tmax=(774.292,'K')), NASAPolynomial(coeffs=[10.096,0.0844603,-3.92801e-05,7.55977e-09,-5.31154e-13,-13587.5,-3.53621], Tmin=(774.292,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-98.8792,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(685.944,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(CCJCO)"""),
)

species(
    label = 'C[CH]C[CH]COCCC(C)OO(14222)',
    structure = SMILES('C[CH]C[CH]COCCC(C)OO'),
    E0 = (-98.8912,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3000,3050,390,425,1340,1360,335,370,3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,200,800,933.333,1066.67,1200,1333.33,1466.67,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (174.237,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.1899,0.146655,-0.000153591,9.98321e-08,-2.83042e-11,-11680.2,52.8142], Tmin=(100,'K'), Tmax=(832.203,'K')), NASAPolynomial(coeffs=[11.1404,0.0825843,-3.81105e-05,7.32443e-09,-5.14907e-13,-13899,-9.04867], Tmin=(832.203,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-98.8912,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(685.944,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJC) + radical(CCJCO)"""),
)

species(
    label = 'CCCCCO[CH]C[C](C)OO(14223)',
    structure = SMILES('CCCCCO[CH]C[C](C)OO'),
    E0 = (-125.884,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (174.237,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.90241,0.163116,-0.000194113,1.3908e-07,-4.21151e-11,-14902.1,49.8727], Tmin=(100,'K'), Tmax=(792.623,'K')), NASAPolynomial(coeffs=[13.5199,0.0802361,-3.72605e-05,7.14685e-09,-5.00478e-13,-17505.3,-25.5382], Tmin=(792.623,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-125.884,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(685.944,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(C2CsJOOH) + radical(CCsJOCs)"""),
)

species(
    label = '[CH2]CC[CH]COCCC(C)OO(14224)',
    structure = SMILES('[CH2]CC[CH]COCCC(C)OO'),
    E0 = (-88.0911,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1310,387.5,850,1000,2750,2761.11,2772.22,2783.33,2794.44,2805.56,2816.67,2827.78,2838.89,2850,1425,1431.25,1437.5,1443.75,1450,1225,1237.5,1250,1262.5,1275,1270,1287.5,1305,1322.5,1340,700,725,750,775,800,300,325,350,375,400,3000,3100,440,815,1455,1000,1380,1390,370,380,2900,435,200,800,933.333,1066.67,1200,1333.33,1466.67,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (174.237,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.22101,0.14574,-0.000139941,7.77934e-08,-1.85717e-11,-10378.3,51.9705], Tmin=(100,'K'), Tmax=(980.381,'K')), NASAPolynomial(coeffs=[14.4886,0.0775642,-3.56305e-05,6.86164e-09,-4.8392e-13,-13654.7,-28.3126], Tmin=(980.381,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-88.0911,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(685.944,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJ) + radical(CCJCO)"""),
)

species(
    label = '[CH2]C(C[CH]OCCCCC)OO(14225)',
    structure = SMILES('[CH2]C(C[CH]OCCCCC)OO'),
    E0 = (-98.821,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1310,387.5,850,1000,2750,2761.11,2772.22,2783.33,2794.44,2805.56,2816.67,2827.78,2838.89,2850,1425,1431.25,1437.5,1443.75,1450,1225,1237.5,1250,1262.5,1275,1270,1287.5,1305,1322.5,1340,700,725,750,775,800,300,325,350,375,400,3000,3100,440,815,1455,1000,1380,1390,370,380,2900,435,200,800,933.333,1066.67,1200,1333.33,1466.67,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (174.237,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.96447,0.161659,-0.000176365,1.08994e-07,-2.80333e-11,-11641.8,51.7971], Tmin=(100,'K'), Tmax=(930.309,'K')), NASAPolynomial(coeffs=[17.6995,0.07281,-3.3105e-05,6.33063e-09,-4.44302e-13,-15486.5,-46.4016], Tmin=(930.309,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-98.821,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(685.944,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJCOOH) + radical(CCsJOCs)"""),
)

species(
    label = 'CCCCCO[CH]CC(C)O[O](14226)',
    structure = SMILES('CCCCCO[CH]CC(C)O[O]'),
    E0 = (-160.779,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (174.237,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.6864,0.155951,-0.000170033,1.08544e-07,-2.91676e-11,-19104.1,49.5629], Tmin=(100,'K'), Tmax=(888.809,'K')), NASAPolynomial(coeffs=[15.235,0.0752977,-3.39176e-05,6.44774e-09,-4.50584e-13,-22289.9,-34.785], Tmin=(888.809,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-160.779,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(690.101,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCsJOCs) + radical(ROOJ)"""),
)
...
species(
    label = 'CCCC=COCCC(C)OO(14227)',
    structure = SMILES('CCCC=COCCC(C)OO'),
    E0 = (-416.484,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (174.237,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-3.71139,0.151055,-0.000131139,5.81211e-08,-1.02436e-11,-49798.4,50.949], Tmin=(100,'K'), Tmax=(1366.78,'K')), NASAPolynomial(coeffs=[31.2461,0.0487499,-1.88631e-05,3.35712e-09,-2.26736e-13,-59354.3,-128.623], Tmin=(1366.78,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-416.484,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(690.101,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH)"""),
)

species(
    label = 'CCCCCOC=CC(C)OO(14228)',
    structure = SMILES('CCCCCOC=CC(C)OO'),
    E0 = (-416.821,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (174.237,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-3.5791,0.146987,-0.000116421,4.10808e-08,-4.05124e-12,-49842.4,51.3756], Tmin=(100,'K'), Tmax=(1110.81,'K')), NASAPolynomial(coeffs=[30.4433,0.0498894,-1.96263e-05,3.58679e-09,-2.48752e-13,-58968.9,-123.396], Tmin=(1110.81,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-416.821,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(690.101,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH)"""),
)

species(
    label = 'CCC=CCOCCC(C)OO(14229)',
    structure = SMILES('CCC=CCOCCC(C)OO'),
    E0 = (-371.011,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (174.237,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.87803,0.137112,-0.000117933,5.76684e-08,-1.22333e-11,-44417.2,47.532], Tmin=(100,'K'), Tmax=(1082.07,'K')), NASAPolynomial(coeffs=[14.2377,0.0775383,-3.53496e-05,6.78809e-09,-4.77894e-13,-47904.9,-31.4884], Tmin=(1082.07,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-371.011,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(690.101,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH)"""),
)
...
species(
    label = 'CCC[CH]CO[CH]CCOO(14230)',
    structure = SMILES('CCC[CH]CO[CH]CCOO'),
    E0 = (-76.4583,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2761.11,2772.22,2783.33,2794.44,2805.56,2816.67,2827.78,2838.89,2850,1425,1431.25,1437.5,1443.75,1450,1225,1237.5,1250,1262.5,1275,1270,1287.5,1305,1322.5,1340,700,725,750,775,800,300,325,350,375,400,3000,3050,390,425,1340,1360,335,370,3615,1310,387.5,850,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,933.333,1066.67,1200,1333.33,1466.67,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.05566,0.141135,-0.000151763,9.36833e-08,-2.42583e-11,-8984.5,47.1349], Tmin=(100,'K'), Tmax=(921.085,'K')), NASAPolynomial(coeffs=[15.1104,0.0665871,-3.03592e-05,5.81215e-09,-4.08132e-13,-12146.8,-34.2702], Tmin=(921.085,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-76.4583,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(615.271,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCsJOCs) + radical(CCJCO)"""),
)

species(
    label = 'CC[CH]CO[CH]CC(C)OO(8049)',
    structure = SMILES('CC[CH]CO[CH]CC(C)OO'),
    E0 = (-89.1012,'kJ/mol'),
    modes = [
...
species(
    label = 'CCC[CH]COC1CC(C)O1(14231)',
    structure = SMILES('CCC[CH]COC1CC(C)O1'),
    E0 = (-221.214,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (157.23,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.52542,0.106128,-4.59482e-05,-1.22169e-08,1.19836e-11,-26393.5,44.0661], Tmin=(100,'K'), Tmax=(994.275,'K')), NASAPolynomial(coeffs=[18.7829,0.056871,-2.05833e-05,3.59451e-09,-2.43936e-13,-32035.5,-61.8578], Tmin=(994.275,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-221.214,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(652.686,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Oxetane) + radical(CCJCO)"""),
)

species(
    label = '[CH2]C(CC)CO[CH]CC(C)OO(14232)',
    structure = SMILES('[CH2]C(CC)CO[CH]CC(C)OO'),
    E0 = (-113.396,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (174.237,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.96836,0.159372,-0.000170445,1.03222e-07,-2.58993e-11,-13392.5,51.3106], Tmin=(100,'K'), Tmax=(955.395,'K')), NASAPolynomial(coeffs=[18.2731,0.0704372,-3.081e-05,5.78319e-09,-4.01707e-13,-17451.2,-50.1974], Tmin=(955.395,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-113.396,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(685.944,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Isobutyl) + radical(CCsJOCs)"""),
)

species(
    label = '[CH2]C(OC[CH]CCC)C(C)OO(14233)',
    structure = SMILES('[CH2]C(OC[CH]CCC)C(C)OO'),
    E0 = (-93.3783,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3615,1310,387.5,850,1000,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3000,3100,440,815,1455,1000,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (174.237,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.73097,0.156959,-0.000166702,1.01506e-07,-2.59727e-11,-10996,51.4234], Tmin=(100,'K'), Tmax=(930.453,'K')), NASAPolynomial(coeffs=[16.3896,0.0747593,-3.41857e-05,6.5578e-09,-4.61139e-13,-14554.1,-39.444], Tmin=(930.453,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-93.3783,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(685.944,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJCO) + radical(CJC(C)OC)"""),
)
...
species(
    label = 'CCC[CH]COC(O)CC(C)[O](14234)',
    structure = SMILES('CCC[CH]COC(O)CC(C)[O]'),
    E0 = (-334.713,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (174.237,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.13214,0.139726,-0.000123161,6.0267e-08,-1.24974e-11,-40039.9,52.0514], Tmin=(100,'K'), Tmax=(1122,'K')), NASAPolynomial(coeffs=[16.9967,0.0715309,-3.19925e-05,6.09715e-09,-4.27634e-13,-44332.5,-42.4365], Tmin=(1122,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-334.713,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(690.101,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(CCJCO)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['CCC[CH]CO[CH]CC(C)OO(13553)'],
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'CCC=CCO[CH]CC(C)OO(14209)'],
    products = ['CCC[CH]CO[CH]CC(C)OO(13553)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'CCC[CH]COC=CC(C)OO(14210)'],
    products = ['CCC[CH]CO[CH]CC(C)OO(13553)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', 'CCCC=CO[CH]CC(C)OO(14211)'],
    products = ['CCC[CH]CO[CH]CC(C)OO(13553)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['C2H5(29)', 'C=CCO[CH]CC(C)OO(7625)'],
    products = ['CCC[CH]CO[CH]CC(C)OO(13553)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['CH3CHOOH(63)', 'C=COC[CH]CCC(1227)'],
    products = ['CCC[CH]CO[CH]CC(C)OO(13553)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['CC[CH]CCO[CH]CC(C)OO(14212)'],
    products = ['CCC[CH]CO[CH]CC(C)OO(13553)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['CCC[CH]COC[CH]C(C)OO(14213)'],
    products = ['CCC[CH]CO[CH]CC(C)OO(13553)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['CCC[CH]CO[CH]CC(C)OO(13553)'],
    products = ['CCCC[CH]O[CH]CC(C)OO(13719)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CCC[CH][CH]OCCC(C)OO(14214)'],
    products = ['CCC[CH]CO[CH]CC(C)OO(13553)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CCC[CH]CO[CH]CC(C)OO(13553)'],
    products = ['C[CH]CCCO[CH]CC(C)OO(14215)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CCC[CH]COCC[C](C)OO(14216)'],
    products = ['CCC[CH]CO[CH]CC(C)OO(13553)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]C(CCOC[CH]CCC)OO(14217)'],
    products = ['CCC[CH]CO[CH]CC(C)OO(13553)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]CCCCO[CH]CC(C)OO(14218)'],
    products = ['CCC[CH]CO[CH]CC(C)OO(13553)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CCC[CH]CO[CH]CC(C)OO(13553)'],
    products = ['CCCCCO[CH][CH]C(C)OO(14219)'],
    transitionState = 'TS16',
    kinetics = Arrhenius(A=(0.0564,'s^-1'), n=3.28, Ea=(24.7274,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""Estimated using template [R5Hall;C_rad_out_H/NonDeC;Cs_H_out_H/NonDeC] for rate rule [R5HJ_3;C_rad_out_H/NonDeC;Cs_H_out_H/(NonDeC/Cs)]
Euclidian distance = 1.41421356237
Multiplied by reaction path degeneracy 2.0
family: intra_H_migration"""),
)
...
reaction(
    label = 'reaction17',
    reactants = ['CCC[CH]COCCC(C)O[O](14220)'],
    products = ['CCC[CH]CO[CH]CC(C)OO(13553)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CC[CH][CH]COCCC(C)OO(14221)'],
    products = ['CCC[CH]CO[CH]CC(C)OO(13553)'],
...
reaction(
    label = 'reaction19',
    reactants = ['C[CH]C[CH]COCCC(C)OO(14222)'],
    products = ['CCC[CH]CO[CH]CC(C)OO(13553)'],
...
reaction(
    label = 'reaction20',
    reactants = ['CCC[CH]CO[CH]CC(C)OO(13553)'],
    products = ['CCCCCO[CH]C[C](C)OO(14223)'],
    transitionState = 'TS20',
    kinetics = Arrhenius(A=(46.1,'s^-1'), n=3.21, Ea=(60.7935,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R6Hall;C_rad_out_H/NonDeC;Cs_H_out] for rate rule [R6HJ_3;C_rad_out_H/NonDeC;Cs_H_out_OOH/Cs]
...
reaction(
    label = 'reaction21',
    reactants = ['[CH2]CC[CH]COCCC(C)OO(14224)'],
    products = ['CCC[CH]CO[CH]CC(C)OO(13553)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH2]C(C[CH]OCCCCC)OO(14225)'],
    products = ['CCC[CH]CO[CH]CC(C)OO(13553)'],
...
reaction(
    label = 'reaction23',
    reactants = ['CCC[CH]CO[CH]CC(C)OO(13553)'],
    products = ['CCCCCO[CH]CC(C)O[O](14226)'],
...
reaction(
    label = 'reaction25',
    reactants = ['CCC[CH]CO[CH]CC(C)OO(13553)'],
    products = ['CCCC=COCCC(C)OO(14227)'],
...
reaction(
    label = 'reaction26',
    reactants = ['CCC[CH]CO[CH]CC(C)OO(13553)'],
    products = ['CCCCCOC=CC(C)OO(14228)'],
...
reaction(
    label = 'reaction27',
    reactants = ['CCC[CH]CO[CH]CC(C)OO(13553)'],
    products = ['CCC=CCOCCC(C)OO(14229)'],
...
reaction(
    label = 'reaction28',
    reactants = ['CH2(S)(23)', 'CCC[CH]CO[CH]CCOO(14230)'],
    products = ['CCC[CH]CO[CH]CC(C)OO(13553)'],
...
reaction(
    label = 'reaction29',
    reactants = ['CH2(S)(23)', 'CC[CH]CO[CH]CC(C)OO(8049)'],
    products = ['CCC[CH]CO[CH]CC(C)OO(13553)'],
...
reaction(
    label = 'reaction30',
    reactants = ['CCC[CH]CO[CH]CC(C)OO(13553)'],
    products = ['OH(5)', 'CCC[CH]COC1CC(C)O1(14231)'],
...
reaction(
    label = 'reaction31',
    reactants = ['[CH2]C(CC)CO[CH]CC(C)OO(14232)'],
    products = ['CCC[CH]CO[CH]CC(C)OO(13553)'],
...
reaction(
    label = 'reaction32',
    reactants = ['[CH2]C(OC[CH]CCC)C(C)OO(14233)'],
    products = ['CCC[CH]CO[CH]CC(C)OO(13553)'],
...
reaction(
    label = 'reaction34',
    reactants = ['CCC[CH]CO[CH]CC(C)OO(13553)'],
    products = ['CCC[CH]COC(O)CC(C)[O](14234)'],
...
reaction(
    label = 'reaction35',
    reactants = ['CCC[CH]C[O](1725)', '[CH]CC(C)OO(1806)'],
    products = ['CCC[CH]CO[CH]CC(C)OO(13553)'],
...
reaction(
    label = 'reaction36',
    reactants = ['[CH]CCC(133)', '[CH2]O[CH]CC(C)OO(1955)'],
    products = ['CCC[CH]CO[CH]CC(C)OO(13553)'],
