species(
    label = 'C=CC(C)O[O](18324)',
    structure = SMILES('C=CC(C)O[O]'),
    E0 = (34.1812,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,3100,1380,975,1025,1650,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,492.5,1135,1000,1380,1390,370,380,2900,435,287.215],'cm^-1')),
...
species(
    label = 'C=[C]C(C)OO(18398)',
    structure = SMILES('C=[C]C(C)OO'),
    E0 = (120.018,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,3100,1380,975,1025,1650,2750,2800,2850,1350,1500,750,1050,1375,1000,1685,370,3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,282.419],'cm^-1')),
        HinderedRotor(inertia=(0.113841,'amu*angstrom^2'), symmetry=1, barrier=(6.43187,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.376056,'amu*angstrom^2'), symmetry=1, barrier=(21.2553,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.376083,'amu*angstrom^2'), symmetry=1, barrier=(21.2554,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.376258,'amu*angstrom^2'), symmetry=1, barrier=(21.2553,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (87.0972,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.31842,0.0554466,-4.4286e-05,1.80342e-08,-2.98544e-12,14534.1,24.2081], Tmin=(100,'K'), Tmax=(1415.7,'K')), NASAPolynomial(coeffs=[12.7964,0.023016,-9.92424e-06,1.85286e-09,-1.27953e-13,11284.3,-35.1564], Tmin=(1415.7,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(120.018,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_S)"""),
)

species(
    label = '[CH]=CC(C)OO(18399)',
...
reaction(
    label = 'reaction5',
    reactants = ['C=[C]C(C)OO(18398)'],
    products = ['C=CC(C)O[O](18324)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['CH3(17)', 'C=C[CH]O[O](9643)'],
    products = ['C=CC(C)O[O](18324)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['H(3)', '[CH2]C(C=C)O[O](18401)'],
    products = ['C=CC(C)O[O](18324)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(3)', 'C=[C]C(C)O[O](18402)'],
    products = ['C=CC(C)O[O](18324)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(3)', '[CH]=CC(C)O[O](18403)'],
    products = ['C=CC(C)O[O](18324)'],
