...
species(
    label = '[CH2]COC=CC(C)OO(8064)',
    structure = SMILES('[CH2]COC=CC(C)OO'),
    E0 = (-133.891,'kJ/mol'),
    modes = [
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.39609,0.103248,-7.90889e-05,1.66482e-08,4.12317e-12,-15895.4,37.4328], Tmin=(100,'K'), Tmax=(995.463,'K')), NASAPolynomial(coeffs=[25.8756,0.0252458,-9.13994e-06,1.6729e-09,-1.19732e-13,-22889.7,-101.873], Tmin=(995.463,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-133.891,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(CJCO)"""),
)
...
species(
    label = '[CH2]COC[CH]C(C)OO(8065)',
    structure = SMILES('[CH2]COC[CH]C(C)OO'),
    E0 = (-9.89476,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1310,387.5,850,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3100,440,815,1455,1000,1380,1390,370,380,2900,435,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (132.158,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.924845,0.116528,-0.000144674,1.05964e-07,-3.24597e-11,-1020.2,39.2304], Tmin=(100,'K'), Tmax=(786.779,'K')), NASAPolynomial(coeffs=[11.3803,0.053966,-2.53957e-05,4.8922e-09,-3.43117e-13,-2956.43,-17.1836], Tmin=(786.779,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-9.89476,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(473.925,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJCOOH) + radical(CJCO)"""),
)
...
species(
    label = '[CH2][CH]OCCC(C)OO(8066)',
    structure = SMILES('[CH2][CH]OCCC(C)OO'),
    E0 = (-29.8537,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1310,387.5,850,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3100,440,815,1455,1000,1380,1390,370,380,2900,435,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2]COCC[C](C)OO(8067)',
    structure = SMILES('[CH2]COCC[C](C)OO'),
    E0 = (-23.4106,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (132.158,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.00593,0.119572,-0.000164174,1.37387e-07,-4.75929e-11,-2644.45,37.4929], Tmin=(100,'K'), Tmax=(781.214,'K')), NASAPolynomial(coeffs=[9.21582,0.0578018,-2.746e-05,5.26436e-09,-3.66099e-13,-3953.71,-7.45528], Tmin=(781.214,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-23.4106,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(473.925,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJCO) + radical(C2CsJOOH)"""),
)

species(
    label = '[CH2]COCCC([CH2])OO(8068)',
    structure = SMILES('[CH2]COCCC([CH2])OO'),
    E0 = (3.65284,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (132.158,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.955547,0.116463,-0.000138987,9.50366e-08,-2.69796e-11,611.194,39.0342], Tmin=(100,'K'), Tmax=(848.125,'K')), NASAPolynomial(coeffs=[12.8366,0.0514147,-2.39427e-05,4.60588e-09,-3.23456e-13,-1728.3,-25.2331], Tmin=(848.125,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(3.65284,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(473.925,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJCO) + radical(CJCOOH)"""),
)

species(
    label = 'CCO[CH][CH]C(C)OO(8069)',
    structure = SMILES('CCO[CH][CH]C(C)OO'),
    E0 = (-41.0278,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (132.158,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.03004,0.117807,-0.000141975,9.73438e-08,-2.75682e-11,-4759.71,38.4219], Tmin=(100,'K'), Tmax=(851.996,'K')), NASAPolynomial(coeffs=[13.3315,0.0503813,-2.32656e-05,4.45596e-09,-3.12068e-13,-7206.89,-28.5637], Tmin=(851.996,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-41.0278,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(473.925,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJCOOH) + radical(CCsJOCs)"""),
)

species(
    label = '[CH2]COCCC(C)O[O](8070)',
    structure = SMILES('[CH2]COCCC(C)O[O]'),
    E0 = (-58.305,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (132.158,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.739175,0.111599,-0.000136184,1.00052e-07,-3.08785e-11,-6848.58,37.0138], Tmin=(100,'K'), Tmax=(780.542,'K')), NASAPolynomial(coeffs=[10.5998,0.053488,-2.45045e-05,4.66165e-09,-3.24516e-13,-8618.61,-14.8802], Tmin=(780.542,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-58.305,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(478.082,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(CJCO)"""),
)

species(
    label = 'CCO[CH]C[C](C)OO(8071)',
    structure = SMILES('CCO[CH]C[C](C)OO'),
    E0 = (-54.5437,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (132.158,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.11152,0.120803,-0.000161034,1.27786e-07,-4.20906e-11,-6383.92,36.689], Tmin=(100,'K'), Tmax=(759.294,'K')), NASAPolynomial(coeffs=[11.0664,0.0544095,-2.54504e-05,4.85831e-09,-3.37666e-13,-8168.71,-18.2841], Tmin=(759.294,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-54.5437,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(473.925,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCsJOCs) + radical(C2CsJOOH)"""),
)

species(
    label = '[CH2]C(C[CH]OCC)OO(8072)',
    structure = SMILES('[CH2]C(C[CH]OCC)OO'),
    E0 = (-27.4802,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (132.158,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.11173,0.118418,-0.000139024,9.05624e-08,-2.41592e-11,-3126.18,38.4039], Tmin=(100,'K'), Tmax=(905.161,'K')), NASAPolynomial(coeffs=[14.9134,0.0476032,-2.16761e-05,4.1364e-09,-2.89587e-13,-6027.33,-37.3116], Tmin=(905.161,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-27.4802,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(473.925,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCsJOCs) + radical(CJCOOH)"""),
)

species(
    label = 'CCO[CH]CC(C)O[O](8073)',
    structure = SMILES('CCO[CH]CC(C)O[O]'),
    E0 = (-89.4381,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (132.158,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.845321,0.11288,-0.000133442,9.13019e-08,-2.5896e-11,-10588,36.2093], Tmin=(100,'K'), Tmax=(850.301,'K')), NASAPolynomial(coeffs=[12.5341,0.0499358,-2.23948e-05,4.23055e-09,-2.93914e-13,-12863.2,-26.1678], Tmin=(850.301,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-89.4381,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(478.082,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(CCsJOCs)"""),
)
...
species(
    label = 'C=COCCC(C)OO(8074)',
    structure = SMILES('C=COCCC(C)OO'),
    E0 = (-334.033,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (132.158,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.42947,0.10504,-8.22196e-05,2.3353e-08,6.84452e-13,-39966.9,35.7814], Tmin=(100,'K'), Tmax=(1025.55,'K')), NASAPolynomial(coeffs=[24.2373,0.0308566,-1.16371e-05,2.12095e-09,-1.48929e-13,-46594.7,-95.3406], Tmin=(1025.55,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-334.033,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(478.082,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH)"""),
)

species(
    label = 'CCOC=CC(C)OO(8075)',
    structure = SMILES('CCOC=CC(C)OO'),
    E0 = (-345.48,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (132.158,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.24022,0.0980101,-5.9133e-05,-2.83714e-09,1.04474e-11,-41347.7,36.2399], Tmin=(100,'K'), Tmax=(994.329,'K')), NASAPolynomial(coeffs=[25.0887,0.0289826,-1.06498e-05,1.96723e-09,-1.41415e-13,-48407.2,-99.802], Tmin=(994.329,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-345.48,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(478.082,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH)"""),
)
...
species(
    label = '[CH2]CO[CH]CCOO(8076)',
    structure = SMILES('[CH2]CO[CH]CCOO'),
    E0 = (6.56946,'kJ/mol'),
    modes = [
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.700476,0.110194,-0.000150045,1.14305e-07,-3.5342e-11,953.071,33.6568], Tmin=(100,'K'), Tmax=(788.5,'K')), NASAPolynomial(coeffs=[12.8611,0.0413938,-1.91569e-05,3.63597e-09,-2.51846e-13,-1185.49,-28.5468], Tmin=(788.5,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(6.56946,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(403.252,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCsJOCs) + radical(CJCO)"""),
)
...
species(
    label = '[CH2]COC1CC(C)O1(8077)',
    structure = SMILES('[CH2]COC1CC(C)O1'),
    E0 = (-138.186,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (115.15,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.371683,0.0685212,-1.96143e-05,-2.54527e-08,1.62516e-11,-16479,28.6625], Tmin=(100,'K'), Tmax=(927.122,'K')), NASAPolynomial(coeffs=[14.941,0.0344237,-1.098e-05,1.79865e-09,-1.19355e-13,-20416.6,-47.1898], Tmin=(927.122,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-138.186,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(440.667,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Oxetane) + radical(CJCO)"""),
)

species(
    label = '[CH2]COC([CH2])C(C)OO(8078)',
    structure = SMILES('[CH2]COC([CH2])C(C)OO'),
    E0 = (-10.3506,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (132.158,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.36188,0.125798,-0.000163937,1.20352e-07,-3.61015e-11,-1058.96,37.899], Tmin=(100,'K'), Tmax=(809.829,'K')), NASAPolynomial(coeffs=[14.0287,0.0497734,-2.31106e-05,4.41304e-09,-3.07546e-13,-3551.52,-33.1039], Tmin=(809.829,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-10.3506,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(473.925,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJCO) + radical(CJC(C)OC)"""),
)
...
species(
    label = '[CH2]COC(O)CC(C)[O](8079)',
    structure = SMILES('[CH2]COC(O)CC(C)[O]'),
    E0 = (-251.685,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (132.158,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.587828,0.106194,-0.000110785,6.4945e-08,-1.58896e-11,-30109.9,37.9199], Tmin=(100,'K'), Tmax=(973.154,'K')), NASAPolynomial(coeffs=[13.3926,0.0487285,-2.22067e-05,4.26225e-09,-3.00079e-13,-32830.9,-29.147], Tmin=(973.154,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-251.685,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(478.082,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(CJCO)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]CO[CH]CC(C)OO(7662)'],
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', '[CH2]COC=CC(C)OO(8064)'],
    products = ['[CH2]CO[CH]CC(C)OO(7662)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'C=CO[CH]CC(C)OO(7647)'],
    products = ['[CH2]CO[CH]CC(C)OO(7662)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['CH3CHOOH(63)', '[CH2]COC=C(1028)'],
    products = ['[CH2]CO[CH]CC(C)OO(7662)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2]COC[CH]C(C)OO(8065)'],
    products = ['[CH2]CO[CH]CC(C)OO(7662)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2]CO[CH]CC(C)OO(7662)'],
    products = ['C[CH]O[CH]CC(C)OO(6140)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2][CH]OCCC(C)OO(8066)'],
    products = ['[CH2]CO[CH]CC(C)OO(7662)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]COCC[C](C)OO(8067)'],
    products = ['[CH2]CO[CH]CC(C)OO(7662)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]COCCC([CH2])OO(8068)'],
    products = ['[CH2]CO[CH]CC(C)OO(7662)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]CO[CH]CC(C)OO(7662)'],
    products = ['CCO[CH][CH]C(C)OO(8069)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]COCCC(C)O[O](8070)'],
    products = ['[CH2]CO[CH]CC(C)OO(7662)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]CO[CH]CC(C)OO(7662)'],
    products = ['[CH2]C(C[CH]OCC)OO(8072)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CH2(S)(23)', '[CH2]CO[CH]CCOO(8076)'],
    products = ['[CH2]CO[CH]CC(C)OO(7662)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2]CO[CH]CC(C)OO(7662)'],
    products = ['OH(5)', '[CH2]COC1CC(C)O1(8077)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH2]COC([CH2])C(C)OO(8078)'],
    products = ['[CH2]CO[CH]CC(C)OO(7662)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH2]CO[CH]CC(C)OO(7662)'],
    products = ['[CH2]COC(O)CC(C)[O](8079)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[CH2]C[O](96)', '[CH]CC(C)OO(1806)'],
    products = ['[CH2]CO[CH]CC(C)OO(7662)'],
...
reaction(
    label = 'reaction25',
    reactants = ['CH2(19)', '[CH2]O[CH]CC(C)OO(1955)'],
    products = ['[CH2]CO[CH]CC(C)OO(7662)'],
