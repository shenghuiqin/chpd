...
species(
    ...
    molecularWeight = (55.0984,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.04737,0.00545571,7.53308e-05,-1.02227e-07,4.01828e-11,25826.9,14.0791], Tmin=(100,'K'), Tmax=(926.066,'K')), NASAPolynomial(coeffs=[10.2346,0.0141132,-2.99925e-06,4.56621e-10,-3.498e-14,22793.3,-29.2349], Tmin=(926.066,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(214.333,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(253.591,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(Isobutyl)"""),
)
...
species(
    ...
    molecularWeight = (55.0984,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.44169,-0.00180976,8.45331e-05,-9.9986e-08,3.56526e-11,24293,13.5236], Tmin=(100,'K'), Tmax=(977.075,'K')), NASAPolynomial(coeffs=[6.48756,0.0222055,-8.34598e-06,1.60293e-09,-1.18849e-13,21956.2,-10.0125], Tmin=(977.075,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(201.711,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(257.749,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + ring(Cyclobutane) + radical(cyclobutane)"""),
)
...
species(
    ...
    molecularWeight = (55.0984,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.19575,0.0043496,6.95105e-05,-8.8081e-08,3.25732e-11,28324.6,14.1117], Tmin=(100,'K'), Tmax=(963.978,'K')), NASAPolynomial(coeffs=[7.7915,0.0193089,-6.7184e-06,1.25741e-09,-9.31101e-14,25857.5,-16.0924], Tmin=(963.978,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(235.164,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(253.591,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(cyclopropane)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['H(3)', 'butadiene13(2459)'],
    products = ['buten3yl1(363)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['buten3yl1(363)'],
    products = ['[CH2]C1CC1(24124)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction12',
    reactants = ['m1_allyl(362)'],
    products = ['CC1[CH]C1(18178)'],
...
reaction(
    label = 'reaction10',
    reactants = ['CH3(17)', '[CH]=C[CH2](2461)'],
    products = ['m1_allyl(362)'],
...
reaction(
    label = 'reaction8',
    reactants = ['CH2(S)(23)', 'CH2CHCH2(74)'],
    products = ['m1_allyl(362)'],
...
network(
    ...
    reactants = [
        ('H(3)', 'butadiene13(2459)'),
        ('C2H4(21)', 'C2H3(30)'),
        ('H(3)', '[CH2][CH]C=C(2458)'),
        ('CH2(19)', 'CH2CHCH2(74)'),
        ('CH2(S)(23)', 'CH2CHCH2(74)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
