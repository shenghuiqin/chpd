...
species(
    label = 'C[C](OO)OC(C)=O(10519)',
    structure = SMILES('C[C](OO)OC(C)=O'),
    E0 = (-386.967,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([360,370,350,3615,1310,387.5,850,1000,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.21501,0.0648605,-4.91136e-05,1.90018e-08,-3.11109e-12,-46444.7,28.437], Tmin=(100,'K'), Tmax=(1363.04,'K')), NASAPolynomial(coeffs=[11.1472,0.0357132,-1.70376e-05,3.31336e-09,-2.33616e-13,-49152.3,-22.5565], Tmin=(1363.04,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-386.967,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(332.579,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)HHH) + group(Cds-OdCsOs) + radical(Cs_P)"""),
)

species(
    label = 'C=C(OO)OC(C)[O](10520)',
    structure = SMILES('C=C(OO)OC(C)[O]'),
    E0 = (-192.675,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,440,435,1725,2750,2800,2850,1350,1500,750,1050,1375,1000,2950,3100,1380,975,1025,1650,3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (119.096,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.363305,0.0870177,-0.000114674,8.72245e-08,-2.75945e-11,-23048.9,29.6033], Tmin=(100,'K'), Tmax=(763.549,'K')), NASAPolynomial(coeffs=[9.65097,0.0383614,-1.9086e-05,3.76353e-09,-2.67227e-13,-24467.2,-12.6985], Tmin=(763.549,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-192.675,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(CCOJ)"""),
)
...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.11293,0.0453201,-2.1355e-05,3.56526e-09,-9.96791e-14,-52616.5,24.6494], Tmin=(100,'K'), Tmax=(2060.93,'K')), NASAPolynomial(coeffs=[18.6473,0.021363,-9.83846e-06,1.75494e-09,-1.1238e-13,-61159.1,-71.2675], Tmin=(2060.93,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-438.013,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)HHH) + group(Cds-OdCsOs) + radical(CCOJ)"""),
)
...
species(
    ...
    molecularWeight = (120.104,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.865006,0.0812351,-7.12145e-05,-9.47448e-09,4.56882e-11,-19463.2,32.3288], Tmin=(100,'K'), Tmax=(500.539,'K')), NASAPolynomial(coeffs=[7.76568,0.0456461,-2.31699e-05,4.59475e-09,-3.26727e-13,-20399,1.36553], Tmin=(500.539,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-162.662,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsOsOsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJCOOH) + radical(CCOJ)"""),
)

species(
    label = 'C[C]([O])OC(C)OO(10524)',
    ...
    molecularWeight = (120.104,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.262048,0.090441,-0.000126821,1.10858e-07,-4.07173e-11,-20485.3,33.0319], Tmin=(100,'K'), Tmax=(739.654,'K')), NASAPolynomial(coeffs=[6.94977,0.0469751,-2.38702e-05,4.72496e-09,-3.35092e-13,-21275,4.13405], Tmin=(739.654,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-171.378,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsOsOsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Cs_P) + radical(CCOJ)"""),
)

species(
    label = 'CC([O])OC(C)O[O](10525)',
    structure = SMILES('CC([O])OC(C)O[O]'),
    E0 = (-224.62,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,492.5,1135,1000,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (120.104,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.445523,0.0866498,-0.000122997,1.10304e-07,-4.08977e-11,-26895.8,32.4423], Tmin=(100,'K'), Tmax=(776.072,'K')), NASAPolynomial(coeffs=[5.70214,0.0473641,-2.34995e-05,4.59063e-09,-3.22491e-13,-27344.5,10.7802], Tmin=(776.072,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-224.62,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsOsOsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(ROOJ)"""),
)
...
species(
    label = 'CC(=O)OC(C)OO(10530)',
    structure = SMILES('CC(=O)OC(C)OO'),
    E0 = (-592.214,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (120.104,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.995848,0.0662477,-4.58354e-05,1.55425e-08,-2.1692e-12,-71119.7,28.535], Tmin=(100,'K'), Tmax=(1600.72,'K')), NASAPolynomial(coeffs=[13.894,0.034017,-1.5633e-05,2.96396e-09,-2.04704e-13,-75249,-39.7594], Tmin=(1600.72,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-592.214,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)HHH) + group(Cds-OdCsOs)"""),
)
...
species(
    label = 'CC1OC(C)(OO)O1(8876)',
    structure = SMILES('CC1OC(C)(OO)O1'),
    E0 = (-433.945,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (120.104,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.587642,0.0644459,-3.5985e-05,4.23756e-09,1.72129e-12,-52059.9,27.0364], Tmin=(100,'K'), Tmax=(1202.99,'K')), NASAPolynomial(coeffs=[15.4875,0.0305948,-1.33418e-05,2.53194e-09,-1.77513e-13,-56780.2,-52.3194], Tmin=(1202.99,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-433.945,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsOsOsOs) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Cyclobutane)"""),
)

species(
    label = 'CC([O])OC(C)([O])O(10532)',
    structure = SMILES('CC([O])OC(C)([O])O'),
    E0 = (-402.803,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (120.104,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.56871,0.0887003,-0.000144252,1.41905e-07,-5.40246e-11,-48335.2,33.1954], Tmin=(100,'K'), Tmax=(835.579,'K')), NASAPolynomial(coeffs=[1.94678,0.0524354,-2.58924e-05,4.97875e-09,-3.43751e-13,-47529.8,32.992], Tmin=(835.579,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-402.803,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsOsOs) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(CCOJ)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'C[C](OO)OC(C)=O(10519)'],
    products = ['C[C](OO)OC(C)[O](8872)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'C=C(OO)OC(C)[O](10520)'],
    products = ['C[C](OO)OC(C)[O](8872)'],
    transitionState = 'TS3',
...
reaction(
    ...
    products = ['C[C](OO)OC(C)[O](8872)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(0.0323,'m^3/(mol*s)'), n=2.98, Ea=(38.8824,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Od_CO-NdNd;YJ] for rate rule [Od_CO-NdNd;CJ]
Euclidian distance = 1.0
family: R_Addition_MultipleBond
...
reaction(
    label = 'reaction5',
    reactants = ['CH3(17)', 'C[C](OO)OC=O(5667)'],
    products = ['C[C](OO)OC(C)[O](8872)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['OH(5)', 'CC(=O)OC(C)[O](10521)'],
    products = ['C[C](OO)OC(C)[O](8872)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]C(OO)OC(C)[O](10523)'],
    products = ['C[C](OO)OC(C)[O](8872)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction18',
    reactants = ['CH2(S)(23)', 'C[C](OO)OC[O](5258)'],
    products = ['C[C](OO)OC(C)[O](8872)'],
...
reaction(
    label = 'reaction21',
    reactants = ['C[C]OO(178)', 'CC([O])[O](2201)'],
    products = ['C[C](OO)OC(C)[O](8872)'],
...
reaction(
    label = 'reaction22',
    reactants = ['O(4)', 'C[CH]O[C](C)OO(10354)'],
    products = ['C[C](OO)OC(C)[O](8872)'],
