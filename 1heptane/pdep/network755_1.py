...
species(
    label = '[CH]=CC(=C)CC(3267)',
    structure = SMILES('[CH]=CC(=C)CC'),
    E0 = (280.781,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,3010,987.5,1337.5,450,1655,2750,2800,2850,1350,1500,750,1050,1375,1000,2950,3100,1380,975,1025,1650,350,440,435,1725,2750,2850,1437.5,1250,1305,750,350,180],'cm^-1')),
        HinderedRotor(inertia=(0.748798,'amu*angstrom^2'), symmetry=1, barrier=(17.2163,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.749273,'amu*angstrom^2'), symmetry=1, barrier=(17.2273,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.750161,'amu*angstrom^2'), symmetry=1, barrier=(17.2477,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (81.1357,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.09657,0.0525602,-1.31057e-05,-2.26482e-08,1.31225e-11,33884.8,22.3322], Tmin=(100,'K'), Tmax=(975.519,'K')), NASAPolynomial(coeffs=[14.6487,0.0231613,-8.14054e-06,1.45839e-09,-1.02912e-13,29995.5,-49.0953], Tmin=(975.519,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(280.781,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cds_P)"""),
)
...
species(
    ...
    molecularWeight = (82.1436,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.28185,0.0516438,-2.07327e-05,-3.02552e-09,3.06961e-12,44555.3,27.0463], Tmin=(100,'K'), Tmax=(1173.44,'K')), NASAPolynomial(coeffs=[10.9075,0.0322621,-1.31248e-05,2.40561e-09,-1.65423e-13,41371.6,-24.8715], Tmin=(1173.44,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(369.584,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cs_S) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', '[CH]=CC(=C)CC(3267)'],
    products = ['[CH]=CC([CH2])CC(1171)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'C#CC([CH2])CC(3268)'],
    products = ['[CH]=CC([CH2])CC(1171)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['C2H5(29)', 'CH2CHCHCH(2454)'],
    products = ['[CH]=CC([CH2])CC(1171)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction17',
    reactants = ['CH2(S)(23)', '[CH]=CC([CH2])C(1177)'],
    products = ['[CH]=CC([CH2])CC(1171)'],
...
reaction(
    label = 'reaction21',
    reactants = ['CH2(19)', '[CH]=C[CH]CC(2952)'],
    products = ['[CH]=CC([CH2])CC(1171)'],
