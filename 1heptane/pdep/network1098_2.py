...
species(
    label = 'C=CC(CCC(C)OO)OO(4070)',
    structure = SMILES('C=CC(CCC(C)OO)OO'),
    E0 = (-290.13,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,3580,3650,1300,1320,350,425,825,875,900,1100,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (162.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.69887,0.126268,-0.000114839,5.50136e-08,-1.08497e-11,-34690.2,44.4201], Tmin=(100,'K'), Tmax=(1194.99,'K')), NASAPolynomial(coeffs=[19.7424,0.0544967,-2.47488e-05,4.75339e-09,-3.34885e-13,-39814.6,-62.8413], Tmin=(1194.99,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-290.13,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(569.541,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH)"""),
)
...
species(
    label = '[CH2]CC(CCC(C)[O])OO(4071)',
    structure = SMILES('[CH2]CC(CCC(C)[O])OO'),
    E0 = (-53.4735,'kJ/mol'),
    modes = [
...
species(
    label = '[CH2]CC(CCC(C)O[O])OO(4073)',
    structure = SMILES('[CH2]CC(CCC(C)O[O])OO'),
    E0 = (-60.3245,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,492.5,1135,1000,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3000,3100,440,815,1455,1000,3615,1310,387.5,850,1000,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2]C[C](CCC(C)OO)OO(4074)',
    structure = SMILES('[CH2]C[C](CCC(C)OO)OO'),
    E0 = (-25.4301,'kJ/mol'),
    modes = [
...
species(
    label = '[CH2]CC(CC[CH]OO)OO(4075)',
    structure = SMILES('[CH2]CC(CC[CH]OO)OO'),
    E0 = (12.6764,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (148.157,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.41514,0.128433,-0.000161124,1.17398e-07,-3.56415e-11,1711.17,42.075], Tmin=(100,'K'), Tmax=(794.246,'K')), NASAPolynomial(coeffs=[12.6173,0.0577621,-2.76552e-05,5.36683e-09,-3.78015e-13,-517.854,-22.3907], Tmin=(794.246,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(12.6764,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(494.711,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCsJOOH) + radical(RCCJ)"""),
)

species(
    label = '[CH2]CC(CC[C](C)OO)OO(4076)',
    structure = SMILES('[CH2]CC(CC[C](C)OO)OO'),
    E0 = (-25.4301,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3000,3100,440,815,1455,1000,3580,3650,1300,1320,350,425,825,875,900,1100,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2]CC(C[CH]C(C)OO)OO(4077)',
    structure = SMILES('[CH2]CC(C[CH]C(C)OO)OO'),
    E0 = (-11.9143,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (162.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.87182,0.138218,-0.000155288,9.9091e-08,-2.64343e-11,-1229.28,47.7769], Tmin=(100,'K'), Tmax=(896.146,'K')), NASAPolynomial(coeffs=[14.9123,0.063302,-2.98921e-05,5.80668e-09,-4.10834e-13,-4237.52,-31.3565], Tmin=(896.146,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-11.9143,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(565.384,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJ) + radical(CCJCOOH)"""),
)

species(
    label = '[CH2]CC([CH]CC(C)OO)OO(4078)',
    structure = SMILES('[CH2]CC([CH]CC(C)OO)OO'),
    E0 = (-11.9143,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,3580,3650,1300,1320,350,425,825,875,900,1100,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3100,440,815,1455,1000,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (162.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.87181,0.138218,-0.000155288,9.90906e-08,-2.64341e-11,-1229.28,47.7769], Tmin=(100,'K'), Tmax=(896.159,'K')), NASAPolynomial(coeffs=[14.9123,0.063302,-2.9892e-05,5.80668e-09,-4.10833e-13,-4237.53,-31.3566], Tmin=(896.159,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-11.9143,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(565.384,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJCOOH) + radical(RCCJ)"""),
)

species(
    label = '[CH2][CH]C(CCC(C)OO)OO(4079)',
    structure = SMILES('[CH2][CH]C(CCC(C)OO)OO'),
    E0 = (-11.9143,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,3580,3650,1300,1320,350,425,825,875,900,1100,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3100,440,815,1455,1000,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2]CC(CCC([CH2])OO)OO(4080)',
    structure = SMILES('[CH2]CC(CCC([CH2])OO)OO'),
    E0 = (1.63331,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (162.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.97094,0.139074,-0.000153382,9.39253e-08,-2.3828e-11,404.949,47.8188], Tmin=(100,'K'), Tmax=(943.445,'K')), NASAPolynomial(coeffs=[16.6027,0.0603279,-2.81845e-05,5.45834e-09,-3.85908e-13,-3099.75,-40.7072], Tmin=(943.445,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(1.63331,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(565.384,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJCOOH) + radical(RCCJ)"""),
)

species(
    label = '[CH2]CC(CCCOO)OO(4081)',
    structure = SMILES('[CH2]CC(CCCOO)OO'),
    E0 = (-175.906,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (149.165,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.23512,0.123453,-0.000136062,8.60409e-08,-2.28983e-11,-20975.2,41.2848], Tmin=(100,'K'), Tmax=(895.504,'K')), NASAPolynomial(coeffs=[13.2456,0.0587708,-2.7718e-05,5.38306e-09,-3.80865e-13,-23568.7,-26.9781], Tmin=(895.504,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-175.906,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(519.654,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(RCCJ)"""),
)

species(
    label = 'CC(CCC1CCO1)OO(4082)',
    structure = SMILES('CC(CCC1CCO1)OO'),
    E0 = (-305.049,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (146.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.06174,0.0991911,-5.61546e-05,1.72118e-09,7.43861e-12,-36495.8,37.3918], Tmin=(100,'K'), Tmax=(968.272,'K')), NASAPolynomial(coeffs=[18.0736,0.0468267,-1.63734e-05,2.79383e-09,-1.87127e-13,-41452.4,-60.7677], Tmin=(968.272,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-305.049,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(557.07,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Oxetane)"""),
)

species(
    label = 'CC(CCC([O])CCO)OO(4083)',
    structure = SMILES('CC(CCC([O])CCO)OO'),
    E0 = (-418.547,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (163.192,'amu'),
...
species(
    label = '[CH2]C(CCC(C)OO)OO(4084)',
    structure = SMILES('[CH2]C(CCC(C)OO)OO'),
    E0 = (-179.833,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3580,3650,1300,1320,350,425,825,875,900,1100,3000,3100,440,815,1455,1000,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (149.165,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.35704,0.123589,-0.000129548,7.45985e-08,-1.77957e-11,-21440.7,41.5771], Tmin=(100,'K'), Tmax=(999.399,'K')), NASAPolynomial(coeffs=[16.0561,0.0538945,-2.4944e-05,4.82038e-09,-3.40734e-13,-24921.3,-42.421], Tmin=(999.399,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-179.833,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(519.654,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJCOOH)"""),
)

species(
    label = '[CH]CC(CCC(C)OO)OO(4085)',
    structure = SMILES('[CH]CC(CCC(C)OO)OO'),
    E0 = (30.6395,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3580,3650,1300,1320,350,425,825,875,900,1100,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (162.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.96565,0.138361,-0.000148327,8.76992e-08,-2.14902e-11,3893.97,45.0199], Tmin=(100,'K'), Tmax=(974.347,'K')), NASAPolynomial(coeffs=[17.0555,0.0602731,-2.81108e-05,5.44488e-09,-3.85197e-13,187.342,-46.2516], Tmin=(974.347,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(30.6395,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(565.384,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJ2_triplet)"""),
)
...
reaction(
    label = 'reaction31',
    reactants = ['H(3)', 'C=CC(CCC(C)OO)OO(4070)'],
    products = ['[CH2]CC(CCC(C)OO)OO(3731)'],
...
reaction(
    label = 'reaction32',
    reactants = ['C2H4(21)', 'CC(CC[CH]OO)OO(1644)'],
    products = ['[CH2]CC(CCC(C)OO)OO(3731)'],
...
reaction(
    label = 'reaction33',
    reactants = ['[CH2]CC(CCC(C)OO)OO(3731)'],
    products = ['C[CH]C(CCC(C)OO)OO(3729)'],
...
reaction(
    label = 'reaction35',
    reactants = ['[CH2]CC(CCC(C)OO)OO(3731)'],
    products = ['CCC([CH]CC(C)OO)OO(3728)'],
...
reaction(
    label = 'reaction36',
    reactants = ['[CH2]CC(CCC(C)OO)OO(3731)'],
    products = ['CCC(C[CH]C(C)OO)OO(3730)'],
...
reaction(
    label = 'reaction37',
    reactants = ['[CH2]CC(CCC(C)OO)OO(3731)'],
    products = ['CCC(CC[C](C)OO)OO(3732)'],
    transitionState = 'TS37',
    kinetics = Arrhenius(A=(402.634,'s^-1'), n=2.06917, Ea=(51.2331,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R6H_SSSSS;C_rad_out_2H;Cs_H_out] for rate rule [R6H_SSSSS;C_rad_out_2H;Cs_H_out_OOH/Cs]
Euclidian distance = 2.0
family: intra_H_migration"""),
)
...
reaction(
    label = 'reaction38',
    reactants = ['[CH2]C(CCC(CC)OO)OO(3733)'],
    products = ['[CH2]CC(CCC(C)OO)OO(3731)'],
...
reaction(
    label = 'reaction39',
    reactants = ['[CH2]CC(CCC(C)OO)OO(3731)'],
    products = ['CCC(CCC(C)O[O])OO(3734)'],
...
reaction(
    label = 'reaction40',
    reactants = ['OH(5)', '[CH2]CC(CCC(C)[O])OO(4071)'],
    products = ['[CH2]CC(CCC(C)OO)OO(3731)'],
...
reaction(
    label = 'reaction41',
    reactants = ['HO2(10)', '[CH2]CC(CC[CH]C)OO(2139)'],
    products = ['[CH2]CC(CCC(C)OO)OO(3731)'],
...
reaction(
    label = 'reaction42',
    reactants = ['OH(5)', '[CH2]CC([O])CCC(C)OO(4072)'],
    products = ['[CH2]CC(CCC(C)OO)OO(3731)'],
...
reaction(
    label = 'reaction43',
    reactants = ['HO2(10)', '[CH2]C[CH]CCC(C)OO(2097)'],
    products = ['[CH2]CC(CCC(C)OO)OO(3731)'],
...
reaction(
    label = 'reaction44',
    reactants = ['H(3)', '[CH2]CC(CCC(C)O[O])OO(4073)'],
    products = ['[CH2]CC(CCC(C)OO)OO(3731)'],
...
reaction(
    label = 'reaction46',
    reactants = ['[CH2]C[CH]OO(468)', '[CH2]CC(C)OO(2102)'],
    products = ['[CH2]CC(CCC(C)OO)OO(3731)'],
...
reaction(
    label = 'reaction47',
    reactants = ['C2H4(T)(94)', 'CC(CC[CH]OO)OO(1644)'],
    products = ['[CH2]CC(CCC(C)OO)OO(3731)'],
...
reaction(
    label = 'reaction48',
    reactants = ['H(3)', '[CH2]C[C](CCC(C)OO)OO(4074)'],
    products = ['[CH2]CC(CCC(C)OO)OO(3731)'],
...
reaction(
    label = 'reaction49',
    reactants = ['CH3CHOOH(63)', '[CH2]CC(C[CH2])OO(2136)'],
    products = ['[CH2]CC(CCC(C)OO)OO(3731)'],
    transitionState = 'TS49',
    kinetics = Arrhenius(A=(2.3e+14,'cm^3/(mol*s)','*|/',2), n=-0.35, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2500,'K'), comment="""Estimated using template [C_rad/H/NonDe;C_rad/H2/Cs] for rate rule [C_rad/H/CsO;C_rad/H2/Cs]
Euclidian distance = 2.0
Multiplied by reaction path degeneracy 2.0
family: R_Recombination"""),
)
...
reaction(
    label = 'reaction50',
    reactants = ['CH3(17)', '[CH2]CC(CC[CH]OO)OO(4075)'],
    products = ['[CH2]CC(CCC(C)OO)OO(3731)'],
...
reaction(
    label = 'reaction51',
    reactants = ['H(3)', '[CH2]CC(CC[C](C)OO)OO(4076)'],
    products = ['[CH2]CC(CCC(C)OO)OO(3731)'],
...
reaction(
    label = 'reaction52',
    reactants = ['QOOH_3(717)', '[CH2]CC([CH2])OO(2134)'],
    products = ['[CH2]CC(CCC(C)OO)OO(3731)'],
...
reaction(
    label = 'reaction53',
    reactants = ['H(3)', '[CH2]CC(C[CH]C(C)OO)OO(4077)'],
    products = ['[CH2]CC(CCC(C)OO)OO(3731)'],
...
reaction(
    label = 'reaction54',
    reactants = ['H(3)', '[CH2]CC([CH]CC(C)OO)OO(4078)'],
    products = ['[CH2]CC(CCC(C)OO)OO(3731)'],
...
reaction(
    label = 'reaction55',
    reactants = ['H(3)', '[CH2][CH]C(CCC(C)OO)OO(4079)'],
    products = ['[CH2]CC(CCC(C)OO)OO(3731)'],
...
reaction(
    label = 'reaction56',
    reactants = ['H(3)', '[CH2]CC(CCC([CH2])OO)OO(4080)'],
    products = ['[CH2]CC(CCC(C)OO)OO(3731)'],
...
reaction(
    label = 'reaction57',
    reactants = ['CH2(S)(23)', '[CH2]CC(CCCOO)OO(4081)'],
    products = ['[CH2]CC(CCC(C)OO)OO(3731)'],
...
reaction(
    label = 'reaction58',
    reactants = ['[CH2]CC(CCC(C)OO)OO(3731)'],
    products = ['OH(5)', 'CC(CCC1CCO1)OO(4082)'],
...
reaction(
    label = 'reaction60',
    reactants = ['CH2(19)', '[CH2]C(CCC(C)OO)OO(4084)'],
    products = ['[CH2]CC(CCC(C)OO)OO(3731)'],
...
reaction(
    label = 'reaction61',
    reactants = ['H(3)', '[CH]CC(CCC(C)OO)OO(4085)'],
    products = ['[CH2]CC(CCC(C)OO)OO(3731)'],
