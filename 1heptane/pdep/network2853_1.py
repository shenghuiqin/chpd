...
species(
    label = 'CCC([O])C=COO(16373)',
    structure = SMILES('CCC([O])C=COO'),
    E0 = (-67.0458,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (117.123,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.120248,0.0797407,-6.38405e-05,2.30011e-08,-2.47749e-12,-7906.21,34.0934], Tmin=(100,'K'), Tmax=(1125.73,'K')), NASAPolynomial(coeffs=[18.6504,0.0263755,-1.04965e-05,1.92994e-09,-1.34224e-13,-12977.1,-62.4388], Tmin=(1125.73,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-67.0458,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(CC(C)OJ)"""),
)
...
species(
    label = 'CC[C](O)C[CH]OO(16374)',
    structure = SMILES('CC[C](O)C[CH]OO'),
    E0 = (-63.6669,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (118.131,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.528479,0.107939,-0.000155606,1.30058e-07,-4.39624e-11,-7502.28,33.5008], Tmin=(100,'K'), Tmax=(810.271,'K')), NASAPolynomial(coeffs=[10.0154,0.0456616,-2.13864e-05,4.05145e-09,-2.78937e-13,-8875.29,-13.0778], Tmin=(810.271,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-63.6669,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(403.252,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCsJOOH) + radical(C2CsJOH)"""),
)

species(
    label = 'CCC([O])[CH]COO(16375)',
    structure = SMILES('CCC([O])[CH]COO'),
    E0 = (1.89856,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (118.131,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.16212,0.090056,-9.47112e-05,5.74921e-08,-1.47709e-11,361.761,33.5803], Tmin=(100,'K'), Tmax=(923.375,'K')), NASAPolynomial(coeffs=[10.696,0.0444236,-2.05819e-05,3.97109e-09,-2.80132e-13,-1583.56,-16.3996], Tmin=(923.375,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(1.89856,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(407.409,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(CCJCOOH)"""),
)

species(
    label = 'CCC([O])CCO[O](16376)',
    structure = SMILES('CCC([O])CCO[O]'),
    E0 = (-46.5117,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (118.131,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.342997,0.0851713,-8.63142e-05,5.16114e-08,-1.31625e-11,-5466.41,31.3816], Tmin=(100,'K'), Tmax=(927.55,'K')), NASAPolynomial(coeffs=[9.89255,0.0439903,-1.9719e-05,3.74771e-09,-2.62157e-13,-7237.98,-13.9714], Tmin=(927.55,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-46.5117,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(ROOJ)"""),
)

species(
    label = 'C[CH]C(O)C[CH]OO(16377)',
    structure = SMILES('C[CH]C(O)C[CH]OO'),
    E0 = (-40.3926,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3050,390,425,1340,1360,335,370,2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1277.5,1000,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,3615,1310,387.5,850,1000,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (118.131,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.11018,0.0903247,-9.58186e-05,5.78622e-08,-1.46272e-11,-4722.06,34.2965], Tmin=(100,'K'), Tmax=(942.85,'K')), NASAPolynomial(coeffs=[11.4657,0.0421491,-1.91747e-05,3.66896e-09,-2.57657e-13,-6863.37,-19.8192], Tmin=(942.85,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-40.3926,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(403.252,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCJCO) + radical(CCsJOOH)"""),
)

species(
    label = 'CCC(O)[CH][CH]OO(16378)',
    structure = SMILES('CCC(O)[CH][CH]OO'),
    E0 = (-39.8797,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (118.131,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.213215,0.0994554,-0.000127384,9.64519e-08,-3.03993e-11,-4650.99,35.2608], Tmin=(100,'K'), Tmax=(767.218,'K')), NASAPolynomial(coeffs=[10.2232,0.0450446,-2.10067e-05,4.01842e-09,-2.80236e-13,-6252.43,-12.3237], Tmin=(767.218,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-39.8797,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(403.252,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCJCOOH) + radical(CCsJOOH)"""),
)

species(
    label = 'CC[C]([O])CCOO(16379)',
    structure = SMILES('CC[C]([O])CCOO'),
    E0 = (-21.8886,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (118.131,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.183111,0.0987958,-0.000123368,9.10389e-08,-2.80559e-11,-2488.17,31.9338], Tmin=(100,'K'), Tmax=(782.949,'K')), NASAPolynomial(coeffs=[10.2482,0.0454978,-2.12471e-05,4.07554e-09,-2.85014e-13,-4121.43,-15.8375], Tmin=(782.949,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-21.8886,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(407.409,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(C2CsJOH)"""),
)

species(
    label = 'C[CH]C([O])CCOO(16380)',
    structure = SMILES('C[CH]C([O])CCOO'),
    E0 = (1.38566,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (118.131,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.242697,0.0840829,-7.55268e-05,3.68357e-08,-7.4933e-12,300.698,33.4667], Tmin=(100,'K'), Tmax=(1153.61,'K')), NASAPolynomial(coeffs=[13.0999,0.0395019,-1.75596e-05,3.33659e-09,-2.33668e-13,-2665.74,-30.3993], Tmin=(1153.61,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(1.38566,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(407.409,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(CCJCO)"""),
)

species(
    label = '[CH2]CC(O)C[CH]OO(16381)',
    structure = SMILES('[CH2]CC(O)C[CH]OO'),
    E0 = (-35.0483,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (118.131,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.128459,0.0972245,-0.000118227,8.40325e-08,-2.49044e-11,-4072.46,34.4434], Tmin=(100,'K'), Tmax=(812.993,'K')), NASAPolynomial(coeffs=[10.6326,0.0442811,-2.05481e-05,3.93719e-09,-2.75501e-13,-5822.25,-15.2449], Tmin=(812.993,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-35.0483,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(403.252,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCsJOOH) + radical(RCCJ)"""),
)
...
species(
    label = 'CCC(O)C[CH]O[O](16382)',
    structure = SMILES('CCC(O)C[CH]O[O]'),
    E0 = (-88.29,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (118.131,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.309858,0.0896026,-9.59505e-05,4.90508e-08,-3.43257e-12,-10493.8,31.8865], Tmin=(100,'K'), Tmax=(609.361,'K')), NASAPolynomial(coeffs=[9.22713,0.0449849,-2.03796e-05,3.8544e-09,-2.6742e-13,-11839,-8.83725], Tmin=(609.361,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-88.29,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(407.409,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCsJOOH) + radical(ROOJ)"""),
)

species(
    label = 'CCC(=O)CCOO(16383)',
    structure = SMILES('CCC(=O)CCOO'),
    E0 = (-371.933,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (118.131,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0542598,0.0984536,-0.000139473,1.22889e-07,-4.42939e-11,-44596.2,30.3299], Tmin=(100,'K'), Tmax=(800.493,'K')), NASAPolynomial(coeffs=[6.38161,0.0517833,-2.48292e-05,4.76562e-09,-3.30953e-13,-45161.7,3.61666], Tmin=(800.493,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-371.933,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(407.409,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdCsCs)"""),
)

species(
    label = 'CCC(O)C=COO(16384)',
    structure = SMILES('CCC(O)C=COO'),
    E0 = (-297.407,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (118.131,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.395762,0.0849649,-7.35782e-05,3.2325e-08,-5.62423e-12,-35601.7,35.2804], Tmin=(100,'K'), Tmax=(1387.87,'K')), NASAPolynomial(coeffs=[20.0321,0.0260898,-9.94684e-06,1.75977e-09,-1.18482e-13,-41272,-69.9681], Tmin=(1387.87,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-297.407,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(407.409,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH)"""),
)
...
species(
    label = 'CCC1CC(OO)O1(13483)',
    structure = SMILES('CCC1CC(OO)O1'),
    E0 = (-285.249,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (118.131,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.501904,0.0643664,-1.16394e-05,-3.38796e-08,1.93089e-11,-34170,27.4], Tmin=(100,'K'), Tmax=(930.482,'K')), NASAPolynomial(coeffs=[15.5703,0.0314269,-9.8624e-06,1.61931e-09,-1.0867e-13,-38352.4,-51.6165], Tmin=(930.482,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-285.249,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(415.724,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + ring(Oxetane)"""),
)

species(
    label = 'CCC([O])CC([O])O(16385)',
    structure = SMILES('CCC([O])CC([O])O'),
    E0 = (-244.547,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (118.131,'amu'),
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'CCC(=O)C[CH]OO(16372)'],
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'CCC([O])C=COO(16373)'],
    products = ['CCC([O])C[CH]OO(13479)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['C2H5(29)', 'O=CC[CH]OO(2179)'],
    products = ['CCC([O])C[CH]OO(13479)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['OH(5)', 'CCC([O])CC=O(11225)'],
    products = ['CCC([O])C[CH]OO(13479)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction11',
    reactants = ['C[CH]C(O)C[CH]OO(16377)'],
    products = ['CCC([O])C[CH]OO(13479)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]CC(O)C[CH]OO(16381)'],
    products = ['CCC([O])C[CH]OO(13479)'],
...
reaction(
    label = 'reaction21',
    reactants = ['CH2(S)(23)', 'CC([O])C[CH]OO(1990)'],
    products = ['CCC([O])C[CH]OO(13479)'],
...
reaction(
    label = 'reaction25',
    reactants = ['O(4)', 'CC[CH]C[CH]OO(4952)'],
    products = ['CCC([O])C[CH]OO(13479)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[CH]OO(168)', '[CH2]C([O])CC(1666)'],
    products = ['CCC([O])C[CH]OO(13479)'],
