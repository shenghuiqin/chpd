species(
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.480128,0.0847122,-8.00409e-05,5.09463e-08,-1.51685e-11,-11163.8,33.3611], Tmin=(100,'K'), Tmax=(771.234,'K')), NASAPolynomial(coeffs=[5.71456,0.0575656,-2.72459e-05,5.31246e-09,-3.76953e-13,-11971.2,9.46736], Tmin=(771.234,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-93.8208,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(CsJOCH3) + radical(CCOJ)"""),
)
...
species(
    label = '[CH2]O[C](O)CCCC(11692)',
    structure = SMILES('[CH2]O[C](O)CCCC'),
    E0 = (-114.28,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (116.158,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.19884,0.0879274,-7.83701e-05,3.96437e-08,-8.60026e-12,-13611.4,34.1812], Tmin=(100,'K'), Tmax=(1069.52,'K')), NASAPolynomial(coeffs=[11.0766,0.0472444,-2.13119e-05,4.07733e-09,-2.86598e-13,-15938.2,-19.0288], Tmin=(1069.52,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-114.28,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(CsJOCH3) + radical(Cs_P)"""),
)

species(
    label = 'CCCC[C]([O])OC(11693)',
    structure = SMILES('CCCC[C]([O])OC'),
    E0 = (-76.4454,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (116.158,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.370152,0.0873497,-9.94569e-05,8.38499e-08,-3.18169e-11,-9070.7,33.6286], Tmin=(100,'K'), Tmax=(735.787,'K')), NASAPolynomial(coeffs=[3.9179,0.060367,-2.87602e-05,5.57932e-09,-3.92782e-13,-9384.46,19.0169], Tmin=(735.787,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-76.4454,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(CCOJ) + radical(Cs_P)"""),
)

species(
    label = '[CH2]OC(O)[CH]CCC(11694)',
    structure = SMILES('[CH2]OC(O)[CH]CCC'),
    E0 = (-119.624,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (116.158,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.181594,0.0841944,-6.76188e-05,2.92687e-08,-5.32388e-12,-14250.4,36.0391], Tmin=(100,'K'), Tmax=(1268.31,'K')), NASAPolynomial(coeffs=[13.331,0.0427238,-1.85726e-05,3.48847e-09,-2.42286e-13,-17585.9,-30.5249], Tmin=(1268.31,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-119.624,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(CsJOCH3) + radical(CCJCO)"""),
)

species(
    label = '[CH2]OC(O)C[CH]CC(11695)',
    ...
    molecularWeight = (116.158,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.807389,0.0807889,-5.32912e-05,-1.89939e-08,3.95107e-11,-14937.5,33.9959], Tmin=(100,'K'), Tmax=(522.849,'K')), NASAPolynomial(coeffs=[6.33072,0.0547934,-2.53614e-05,4.87415e-09,-3.42293e-13,-15737.4,8.8053], Tmin=(522.849,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-125.068,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(RCCJCC) + radical(CsJOCH3)"""),
)

species(
    label = 'CCC[CH]C([O])OC(11696)',
    structure = SMILES('CCC[CH]C([O])OC'),
    E0 = (-81.7897,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (116.158,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.30146,0.0694467,-2.00821e-05,-5.84592e-08,5.97341e-11,-9749.9,32.2479], Tmin=(100,'K'), Tmax=(485.216,'K')), NASAPolynomial(coeffs=[3.98895,0.0596994,-2.83065e-05,5.54204e-09,-3.94979e-13,-10156.8,19.7207], Tmin=(485.216,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-81.7897,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(CCOJ) + radical(CCJCO)"""),
)

species(
    label = '[CH2]OC(O)CC[CH]C(11697)',
    structure = SMILES('[CH2]OC(O)CC[CH]C'),
    E0 = (-125.08,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (116.158,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.271167,0.0883127,-8.99967e-05,5.88635e-08,-1.70631e-11,-14914.9,35.979], Tmin=(100,'K'), Tmax=(810.36,'K')), NASAPolynomial(coeffs=[7.49171,0.0526733,-2.40302e-05,4.59683e-09,-3.22314e-13,-16085.2,2.66205], Tmin=(810.36,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-125.08,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(CsJOCH3) + radical(RCCJC)"""),
)

species(
    label = 'CC[CH]CC([O])OC(11698)',
    structure = SMILES('CC[CH]CC([O])OC'),
    E0 = (-87.2335,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3025,407.5,1350,352.5,1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (116.158,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.18505,0.0594831,-2.66421e-05,4.44619e-09,-2.26382e-13,-10506.4,25.1467], Tmin=(100,'K'), Tmax=(2840.59,'K')), NASAPolynomial(coeffs=[59.3748,-0.00519532,-1.16216e-07,1.10237e-11,6.39472e-15,-48256.8,-314.858], Tmin=(2840.59,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-87.2335,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(RCCJCC) + radical(CCOJ)"""),
)

species(
    label = '[CH2]CCCC(O)O[CH2](11699)',
    structure = SMILES('[CH2]CCCC(O)O[CH2]'),
    E0 = (-114.28,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (116.158,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.19884,0.0879274,-7.83701e-05,3.96437e-08,-8.60026e-12,-13611.4,35.2798], Tmin=(100,'K'), Tmax=(1069.52,'K')), NASAPolynomial(coeffs=[11.0766,0.0472444,-2.13119e-05,4.07733e-09,-2.86598e-13,-15938.2,-17.9302], Tmin=(1069.52,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-114.28,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(CsJOCH3) + radical(RCCJ)"""),
)

species(
    label = 'C[CH]CCC([O])OC(11700)',
    structure = SMILES('C[CH]CCC([O])OC'),
    E0 = (-87.2455,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3025,407.5,1350,352.5,1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (116.158,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.98601,0.0609963,-2.8577e-05,5.36768e-09,-3.60805e-13,-10498.9,26.0235], Tmin=(100,'K'), Tmax=(3072.93,'K')), NASAPolynomial(coeffs=[65.769,-0.011633,2.43635e-06,-3.97472e-10,2.98654e-14,-53378.5,-354.337], Tmin=(3072.93,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-87.2455,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(RCCJC) + radical(CCOJ)"""),
)

species(
    label = '[CH2]CCCC([O])OC(11701)',
    structure = SMILES('[CH2]CCCC([O])OC'),
    E0 = (-76.4454,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (116.158,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.370156,0.0873496,-9.94567e-05,8.38495e-08,-3.18166e-11,-9070.7,34.7272], Tmin=(100,'K'), Tmax=(735.789,'K')), NASAPolynomial(coeffs=[3.9179,0.060367,-2.87602e-05,5.57932e-09,-3.92782e-13,-9384.46,20.1155], Tmin=(735.789,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-76.4454,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(RCCJ) + radical(CCOJ)"""),
)
...
species(
    label = 'CCCCC(=O)OC(11702)',
    structure = SMILES('CCCCC(=O)OC'),
    E0 = (-498.917,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (116.158,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.2504,0.0677284,-3.54664e-05,8.39768e-09,-7.81037e-13,-59915.6,27.6521], Tmin=(100,'K'), Tmax=(2331.54,'K')), NASAPolynomial(coeffs=[19.0027,0.0372725,-1.58726e-05,2.79514e-09,-1.80304e-13,-68193.6,-73.0204], Tmin=(2331.54,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-498.917,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + group(Cds-OdCsOs)"""),
)
...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.53817,0.0631519,-2.94347e-05,-3.58468e-08,4.44515e-11,-8344.21,27.419], Tmin=(100,'K'), Tmax=(495.997,'K')), NASAPolynomial(coeffs=[4.73235,0.0492962,-2.35323e-05,4.60733e-09,-3.27798e-13,-8807.5,12.7726], Tmin=(495.997,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-70.0406,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(CsJOCH3) + radical(CCOJ)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', '[CH2]OC(=O)CCCC(11691)'],
    products = ['[CH2]OC([O])CCCC(11659)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['butyl_1(82)', 'CH2OCHO(1808)'],
    products = ['[CH2]OC([O])CCCC(11659)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2]OC(O)[CH]CCC(11694)'],
    products = ['[CH2]OC([O])CCCC(11659)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]OC(O)C[CH]CC(11695)'],
    products = ['[CH2]OC([O])CCCC(11659)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]OC([O])CCCC(11659)'],
    products = ['[CH2]OC(O)CC[CH]C(11697)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]OC([O])CCCC(11659)'],
    products = ['[CH2]CCCC(O)O[CH2](11699)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CH2(S)(23)', '[CH2]OC([O])CCC(11703)'],
    products = ['[CH2]OC([O])CCCC(11659)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CH2(19)', 'CCCCC([O])[O](4945)'],
    products = ['[CH2]OC([O])CCCC(11659)'],
