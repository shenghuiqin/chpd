...
species(
    label = 'C=C(C[CH]O)OO(16136)',
    structure = SMILES('C=C(C[CH]O)OO'),
    E0 = (-86.1151,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,3615,1277.5,1000,2950,3100,1380,975,1025,1650,3615,1310,387.5,850,1000,350,440,435,1725,2750,2850,1437.5,1250,1305,750,350,327.31,327.747],'cm^-1')),
        HinderedRotor(inertia=(0.00156959,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.111764,'amu*angstrom^2'), symmetry=1, barrier=(8.54026,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.112531,'amu*angstrom^2'), symmetry=1, barrier=(8.54386,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.112234,'amu*angstrom^2'), symmetry=1, barrier=(8.54478,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.251357,'amu*angstrom^2'), symmetry=1, barrier=(19.0281,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (103.097,'amu'),
...
species(
    label = '[CH2]C(C=CO)OO(16137)',
    structure = SMILES('[CH2]C(C=CO)OO'),
    E0 = (-112.654,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2995,3025,975,1000,1300,1375,400,500,1630,1680,1380,1390,370,380,2900,435,3615,1310,387.5,850,1000,3000,3100,440,815,1455,1000,3615,1277.5,1000,180],'cm^-1')),
        HinderedRotor(inertia=(0.949373,'amu*angstrom^2'), symmetry=1, barrier=(21.828,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.949556,'amu*angstrom^2'), symmetry=1, barrier=(21.8322,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.9497,'amu*angstrom^2'), symmetry=1, barrier=(21.8355,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.949426,'amu*angstrom^2'), symmetry=1, barrier=(21.8292,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.94953,'amu*angstrom^2'), symmetry=1, barrier=(21.8316,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (103.097,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.118134,0.0709337,-4.32181e-05,-1.10952e-08,1.38947e-11,-13396.1,29.8944], Tmin=(100,'K'), Tmax=(938.806,'K')), NASAPolynomial(coeffs=[23.1795,0.00875258,-1.50988e-06,2.20657e-10,-1.91064e-14,-19315.9,-88.3746], Tmin=(938.806,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-112.654,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-(Cds-Cd)H) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(CJCOOH)"""),
)
...
species(
    label = '[CH2]C([CH]CO)OO(16138)',
    structure = SMILES('[CH2]C([CH]CO)OO'),
    E0 = (9.28059,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,3615,1277.5,1000,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,3615,1310,387.5,850,1000,200,800],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (104.105,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.409206,0.0840932,-0.000107695,7.76701e-08,-2.2906e-11,1240.88,32.6285], Tmin=(100,'K'), Tmax=(822.886,'K')), NASAPolynomial(coeffs=[10.8186,0.0334948,-1.54632e-05,2.94921e-09,-2.05564e-13,-472.294,-15.5616], Tmin=(822.886,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(9.28059,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(332.579,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CJCOOH) + radical(CCJCOOH)"""),
)

species(
    label = 'CC([CH][CH]O)OO(16139)',
    structure = SMILES('CC([CH][CH]O)OO'),
    E0 = (-24.3841,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (104.105,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.124948,0.0912029,-0.000130283,1.04462e-07,-3.38411e-11,-2798.86,31.1936], Tmin=(100,'K'), Tmax=(793.528,'K')), NASAPolynomial(coeffs=[10.8195,0.0339645,-1.57925e-05,2.98762e-09,-2.05818e-13,-4391.32,-17.2677], Tmin=(793.528,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-24.3841,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(332.579,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCJCOOH) + radical(CCsJOH)"""),
)

species(
    label = '[CH2][C](CCO)OO(16140)',
    structure = SMILES('[CH2][C](CCO)OO'),
    E0 = (-4.23526,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,360,370,350,3615,1310,387.5,850,1000,3000,3100,440,815,1455,1000,3615,1277.5,1000,200,800],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (104.105,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.380467,0.0864209,-0.000124162,1.04254e-07,-3.54876e-11,-385.583,30.7091], Tmin=(100,'K'), Tmax=(807.243,'K')), NASAPolynomial(coeffs=[8.5446,0.0375341,-1.76525e-05,3.35225e-09,-2.31194e-13,-1428.93,-5.22817], Tmin=(807.243,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-4.23526,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(332.579,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CJCOOH) + radical(C2CsJOOH)"""),
)
...
species(
    label = '[CH2]C(CCO)O[O](16141)',
    structure = SMILES('[CH2]C(CCO)O[O]'),
    E0 = (-39.1297,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,1380,1390,370,380,2900,435,492.5,1135,1000,3000,3100,440,815,1455,1000,3615,1277.5,1000,347.154,347.205],'cm^-1')),
        HinderedRotor(inertia=(0.0788812,'amu*angstrom^2'), symmetry=1, barrier=(6.74733,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0789011,'amu*angstrom^2'), symmetry=1, barrier=(6.74898,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0789191,'amu*angstrom^2'), symmetry=1, barrier=(6.7484,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0788831,'amu*angstrom^2'), symmetry=1, barrier=(6.74853,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0789007,'amu*angstrom^2'), symmetry=1, barrier=(6.74849,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (104.105,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.595269,0.0791535,-9.91351e-05,7.16165e-08,-2.12388e-11,-4587.51,30.4109], Tmin=(100,'K'), Tmax=(818.127,'K')), NASAPolynomial(coeffs=[10.0284,0.0330352,-1.45835e-05,2.72157e-09,-1.87215e-13,-6131.1,-13.2055], Tmin=(818.127,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-39.1297,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CJCOOH) + radical(ROOJ)"""),
)
...
species(
    label = 'C=C(CCO)OO(16142)',
    structure = SMILES('C=C(CCO)OO'),
    E0 = (-266.413,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (104.105,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.986703,0.0697365,-7.03597e-05,4.01979e-08,-9.65132e-12,-31936.5,27.7094], Tmin=(100,'K'), Tmax=(986.955,'K')), NASAPolynomial(coeffs=[9.95094,0.0334061,-1.51443e-05,2.90154e-09,-2.04115e-13,-33705.9,-15.4202], Tmin=(986.955,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-266.413,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH)"""),
)
...
species(
    label = 'OOC1CC(O)C1(13279)',
    structure = SMILES('OOC1CC(O)C1'),
    E0 = (-259.563,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (104.105,'amu'),
...
species(
    ...
    molecularWeight = (104.105,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.218149,0.0879409,-0.000122496,9.49198e-08,-2.95442e-11,-27022.3,30.3033], Tmin=(100,'K'), Tmax=(816.265,'K')), NASAPolynomial(coeffs=[11.3536,0.0310396,-1.36444e-05,2.51556e-09,-1.7073e-13,-28762.4,-20.6821], Tmin=(816.265,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-225.771,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + radical(CC(C)OJ) + radical(CCsJOH)"""),
)

species(
    label = '[CH2]C([O])CC(O)O(16145)',
    ...
    molecularWeight = (104.105,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.536886,0.0777287,-8.59349e-05,5.09473e-08,-1.22007e-11,-28126.5,30.011], Tmin=(100,'K'), Tmax=(1010.02,'K')), NASAPolynomial(coeffs=[13.0669,0.0281061,-1.22396e-05,2.30455e-09,-1.60721e-13,-30657.6,-30.564], Tmin=(1010.02,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-234.883,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(CJCO)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'C=C(C[CH]O)OO(16136)'],
    products = ['[CH2]C(C[CH]O)OO(2187)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', '[CH2]C(C=CO)OO(16137)'],
    products = ['[CH2]C(C[CH]O)OO(2187)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['HO2(10)', 'C=CC[CH]O(2463)'],
    products = ['[CH2]C(C[CH]O)OO(2187)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]C([CH]CO)OO(16138)'],
    products = ['[CH2]C(C[CH]O)OO(2187)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2]C(C[CH]O)OO(2187)'],
    products = ['OH(5)', 'O[CH]CC1CO1(16143)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH2]C(C[CH]O)OO(2187)'],
    products = ['OH(5)', '[CH2]C1CC(O)O1(11390)'],
...
reaction(
    label = 'reaction27',
    reactants = ['CH2(19)', 'O[CH]C[CH]OO(7926)'],
    products = ['[CH2]C(C[CH]O)OO(2187)'],
...
reaction(
    label = 'reaction28',
    reactants = ['HCOH(T)(285)', '[CH2]C([CH2])OO(5700)'],
    products = ['[CH2]C(C[CH]O)OO(2187)'],
