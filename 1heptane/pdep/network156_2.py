...
reaction(
    label = 'reaction17',
    reactants = ['H(3)', 'CC=CCCC(417)'],
    products = ['C[CH]CCCC(188)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction21',
    reactants = ['[CH2]C[CH]C(129)', 'C2H5(29)'],
    products = ['C[CH]CCCC(188)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction22',
    reactants = ['C3H6(T)(143)', 'npropyl(83)'],
    products = ['C[CH]CCCC(188)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction23',
    reactants = ['H(3)', 'C[CH]C[CH]CC(375)'],
    products = ['C[CH]CCCC(188)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction24',
    reactants = ['[CH2]CC[CH]C(136)', 'CH3(17)'],
    products = ['C[CH]CCCC(188)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction25',
    reactants = ['H(3)', 'C[CH]CC[CH]C(376)'],
    products = ['C[CH]CCCC(188)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction27',
    reactants = ['H(3)', '[CH2]CCC[CH]C(183)'],
    products = ['C[CH]CCCC(188)'],
...
reaction(
    label = 'reaction12',
    reactants = ['C[CH]CCC(139)', 'CH2(S)(23)'],
    products = ['C[CH]CCCC(188)'],
...
reaction(
    label = 'reaction31',
    reactants = ['butyl_1(82)', 'CHCH3(T)(95)'],
    products = ['C[CH]CCCC(188)'],
...
reaction(
    label = 'reaction3',
    reactants = ['[CH2]C[CH2](128)', 'npropyl(83)'],
    products = ['[CH2]CCCCC(87)'],
...
reaction(
    label = 'reaction4',
    reactants = ['[CH2]CC[CH2](131)', 'C2H5(29)'],
    products = ['[CH2]CCCCC(87)'],
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)', '[CH2]CC[CH]CC(195)'],
    products = ['[CH2]CCCCC(87)'],
...
reaction(
    label = 'reaction6',
    reactants = ['butyl_1(82)', 'C2H4(T)(94)'],
    products = ['[CH2]CCCCC(87)'],
...
reaction(
    label = 'reaction7',
    reactants = ['H(3)', '[CH2]C[CH]CCC(203)'],
    products = ['[CH2]CCCCC(87)'],
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]CCC[CH2](138)', 'CH3(17)'],
    products = ['[CH2]CCCCC(87)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(3)', '[CH2]CCCC[CH2](377)'],
    products = ['[CH2]CCCCC(87)'],
...
reaction(
    label = 'reaction31',
    reactants = ['[CH2]CCCC(84)', 'CH2(S)(23)'],
    products = ['[CH2]CCCCC(87)'],
