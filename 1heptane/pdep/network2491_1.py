...
species(
    label = '[CH2]COC(=C)OO(15826)',
    structure = SMILES('[CH2]COC(=C)OO'),
    E0 = (-6.55977,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2950,3100,1380,975,1025,1650,3615,1310,387.5,850,1000,3000,3100,440,815,1455,1000,350,440,435,1725,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (103.097,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.481433,0.0805859,-9.72346e-05,6.22544e-08,-1.60236e-11,-664.937,25.7886], Tmin=(100,'K'), Tmax=(943.839,'K')), NASAPolynomial(coeffs=[13.0644,0.0272597,-1.24867e-05,2.39453e-09,-1.68311e-13,-3040.22,-34.1897], Tmin=(943.839,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-6.55977,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(CJCO)"""),
)
...
species(
    label = '[CH2]COC(C)O[O](15828)',
    structure = SMILES('[CH2]COC(C)O[O]'),
    E0 = (-38.5051,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,492.5,1135,1000,3000,3100,440,815,1455,1000,1380,1390,370,380,2900,435,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (104.105,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.684485,0.0785024,-9.806e-05,7.3197e-08,-2.29242e-11,-4516.84,28.212], Tmin=(100,'K'), Tmax=(769.592,'K')), NASAPolynomial(coeffs=[8.64196,0.0371409,-1.74388e-05,3.35463e-09,-2.34977e-13,-5741.58,-8.0938], Tmin=(769.592,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-38.5051,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(CJCO)"""),
)
...
species(
    label = 'CCO[C](C)O[O](15829)',
    structure = SMILES('CCO[C](C)O[O]'),
    E0 = (-44.8479,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (104.105,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.901848,0.0736971,-8.7446e-05,6.44747e-08,-2.03961e-11,-5287.49,27.4874], Tmin=(100,'K'), Tmax=(756.002,'K')), NASAPolynomial(coeffs=[7.48484,0.0388692,-1.83482e-05,3.54655e-09,-2.4942e-13,-6282.91,-2.43084], Tmin=(756.002,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-44.8479,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Cs_P) + radical(ROOJ)"""),
)
...
species(
    ...
    molecularWeight = (104.105,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.697878,0.0820284,-0.000125447,1.14431e-07,-4.10769e-11,-25951.7,29.3481], Tmin=(100,'K'), Tmax=(845.032,'K')), NASAPolynomial(coeffs=[5.06894,0.0418758,-1.96263e-05,3.69221e-09,-2.51915e-13,-25995.5,13.1078], Tmin=(845.032,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-216.688,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsOsOs) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(CJCO)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'C=CO[C](C)OO(10134)'],
    products = ['[CH2]CO[C](C)OO(11653)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', '[CH2]COC(=C)OO(15826)'],
    products = ['[CH2]CO[C](C)OO(11653)'],
    transitionState = 'TS3',
...
reaction(
    ...
    products = ['[CH2]CO[C](C)OO(11653)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(0.0646,'m^3/(mol*s)'), n=2.98, Ea=(64.4517,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Od_CO-NdNd;YJ] for rate rule [Od_CO-NdNd;CJ]
Euclidian distance = 1.0
Multiplied by reaction path degeneracy 2.0
family: R_Addition_MultipleBond
Ea raised from 62.1 to 64.5 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction5',
    reactants = ['OH(5)', '[CH2]COC(C)=O(15827)'],
    products = ['[CH2]CO[C](C)OO(11653)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]C[O](96)', 'C[C]OO(178)'],
    products = ['[CH2]CO[C](C)OO(11653)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CH2(19)', '[CH2]O[C](C)OO(5656)'],
    products = ['[CH2]CO[C](C)OO(11653)'],
