...
species(
    label = 'CC[CH]CCC=CC(C)OO(8198)',
    structure = SMILES('CC[CH]CCC=CC(C)OO'),
    E0 = (-53.377,'kJ/mol'),
    modes = [
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.0913,0.116905,-8.67739e-05,3.5015e-08,-6.11602e-12,-6241.1,46.3932], Tmin=(100,'K'), Tmax=(1277.01,'K')), NASAPolynomial(coeffs=[14.0875,0.0693605,-3.09269e-05,5.85988e-09,-4.08322e-13,-10117.8,-30.5471], Tmin=(1277.01,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-53.377,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(644.372,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(RCCJCC)"""),
)

species(
    label = 'CC[CH]CC=CCC(C)OO(8199)',
    structure = SMILES('CC[CH]CC=CCC(C)OO'),
    E0 = (-53.0407,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,2995,3025,975,1000,1300,1375,400,500,1630,1680,3615,1310,387.5,850,1000,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,1380,1390,370,380,2900,435,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (157.23,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.06995,0.11906,-9.45964e-05,4.3287e-08,-8.79256e-12,-6203.17,45.4258], Tmin=(100,'K'), Tmax=(1105.82,'K')), NASAPolynomial(coeffs=[11.4093,0.07392,-3.33653e-05,6.37249e-09,-4.47029e-13,-8963.13,-16.0346], Tmin=(1105.82,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-53.0407,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(644.372,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(RCCJCC)"""),
)

species(
    label = 'CCC=CC[CH]CC(C)OO(8200)',
    structure = SMILES('CCC=CC[CH]CC(C)OO'),
    E0 = (-53.0407,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,2995,3025,975,1000,1300,1375,400,500,1630,1680,3615,1310,387.5,850,1000,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,1380,1390,370,380,2900,435,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'CC=CCC[CH]CC(C)OO(8201)',
    structure = SMILES('CC=CCC[CH]CC(C)OO'),
    E0 = (-54.1755,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,2995,3025,975,1000,1300,1375,400,500,1630,1680,3615,1310,387.5,850,1000,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,1380,1390,370,380,2900,435,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (157.23,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.1649,0.12287,-0.000108142,5.85757e-08,-1.43206e-11,-6337.66,45.1176], Tmin=(100,'K'), Tmax=(934.303,'K')), NASAPolynomial(coeffs=[9.37798,0.0777329,-3.56735e-05,6.86582e-09,-4.83977e-13,-8307.68,-5.02913], Tmin=(934.303,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-54.1755,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(644.372,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(RCCJCC)"""),
)
...
species(
    label = 'C=CCC[CH]CC(C)OO(6666)',
    structure = SMILES('C=CCC[CH]CC(C)OO'),
    E0 = (-18.1499,'kJ/mol'),
    modes = [
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.572581,0.108091,-9.1038e-05,4.54439e-08,-1.0122e-11,-2024.57,41.1743], Tmin=(100,'K'), Tmax=(1019.3,'K')), NASAPolynomial(coeffs=[9.90983,0.0669563,-3.05049e-05,5.85334e-09,-4.11906e-13,-4161.55,-9.59783], Tmin=(1019.3,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-18.1499,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(573.699,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(RCCJCC)"""),
)

species(
    label = 'CC[CH]CCC[CH]C(C)OO(8202)',
    structure = SMILES('CC[CH]CCC[CH]C(C)OO'),
    E0 = (30.7026,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3000,3050,390,425,1340,1360,335,370,3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (158.238,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.64394,0.134179,-0.000134831,8.72558e-08,-2.52281e-11,3886.99,49.1087], Tmin=(100,'K'), Tmax=(809.137,'K')), NASAPolynomial(coeffs=[8.95044,0.0818052,-3.77371e-05,7.25676e-09,-5.10447e-13,2172.55,0.240879], Tmin=(809.137,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(30.7026,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(665.158,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJCOOH) + radical(RCCJCC)"""),
)
...
species(
    label = 'C[CH]CCC[CH]CC(C)OO(8203)',
    structure = SMILES('C[CH]CCC[CH]CC(C)OO'),
    E0 = (24.7339,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (158.238,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.409805,0.114778,-4.20106e-05,-1.13043e-07,1.26585e-10,3115.51,45.3766], Tmin=(100,'K'), Tmax=(482.115,'K')), NASAPolynomial(coeffs=[6.68707,0.0848608,-3.90443e-05,7.46588e-09,-5.22164e-13,2094.6,12.825], Tmin=(482.115,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(24.7339,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(665.158,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJC) + radical(RCCJCC)"""),
)

species(
    label = 'CC[CH]CCCC[C](C)OO(8204)',
    structure = SMILES('CC[CH]CCCC[C](C)OO'),
    E0 = (17.1867,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (158.238,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.349081,0.114695,-3.20538e-05,-1.46698e-07,1.5854e-10,2204.08,42.7651], Tmin=(100,'K'), Tmax=(467.448,'K')), NASAPolynomial(coeffs=[6.66858,0.0859056,-3.99839e-05,7.67754e-09,-5.37823e-13,1206.47,10.5923], Tmin=(467.448,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(17.1867,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(665.158,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(C2CsJOOH) + radical(RCCJCC)"""),
)

species(
    label = 'CC[CH][CH]CCCC(C)OO(8205)',
    structure = SMILES('CC[CH][CH]CCCC(C)OO'),
    E0 = (24.7459,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3000,3050,390,425,1340,1360,335,370,3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'CCCC[CH][CH]CC(C)OO(8206)',
    structure = SMILES('CCCC[CH][CH]CC(C)OO'),
    E0 = (24.7459,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3000,3050,390,425,1340,1360,335,370,3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2]CCCC[CH]CC(C)OO(8207)',
    structure = SMILES('[CH2]CCCC[CH]CC(C)OO'),
    E0 = (35.534,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (158.238,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.5558,0.131975,-0.000126101,7.59021e-08,-2.04334e-11,4465.35,48.2751], Tmin=(100,'K'), Tmax=(862.499,'K')), NASAPolynomial(coeffs=[9.47384,0.0808229,-3.71413e-05,7.14113e-09,-5.0273e-13,2562.73,-3.30507], Tmin=(862.499,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(35.534,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(665.158,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJ) + radical(RCCJCC)"""),
)

species(
    label = '[CH2]C(CCCC[CH]CC)OO(8208)',
    structure = SMILES('[CH2]C(CCCC[CH]CC)OO'),
    E0 = (44.2502,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1310,387.5,850,1000,2750,2761.11,2772.22,2783.33,2794.44,2805.56,2816.67,2827.78,2838.89,2850,1425,1431.25,1437.5,1443.75,1450,1225,1237.5,1250,1262.5,1275,1270,1287.5,1305,1322.5,1340,700,725,750,775,800,300,325,350,375,400,3000,3100,440,815,1455,1000,1380,1390,370,380,2900,435,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (158.238,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.66749,0.134094,-0.00012939,7.71066e-08,-2.02895e-11,5518.04,48.8829], Tmin=(100,'K'), Tmax=(885.94,'K')), NASAPolynomial(coeffs=[10.5316,0.079016,-3.61354e-05,6.93327e-09,-4.87569e-13,3356.51,-8.49313], Tmin=(885.94,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(44.2502,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(665.158,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJCOOH) + radical(RCCJCC)"""),
)

species(
    label = 'CC[CH]CCCCC(C)O[O](8209)',
    structure = SMILES('CC[CH]CCCCC(C)O[O]'),
    E0 = (-17.7077,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (158.238,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.46052,0.129272,-0.000126388,8.13641e-08,-2.36366e-11,-1941.29,46.9005], Tmin=(100,'K'), Tmax=(802.933,'K')), NASAPolynomial(coeffs=[8.15963,0.0813473,-3.68587e-05,7.02947e-09,-4.92131e-13,-3486.17,2.60021], Tmin=(802.933,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-17.7077,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(669.315,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(ROOJ)"""),
)

species(
    label = 'CCCCC[CH][CH]C(C)OO(8210)',
    structure = SMILES('CCCCC[CH][CH]C(C)OO'),
    E0 = (30.7026,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3000,3050,390,425,1340,1360,335,370,3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'C[CH][CH]CCCCC(C)OO(8211)',
    structure = SMILES('C[CH][CH]CCCCC(C)OO'),
    E0 = (24.7339,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (158.238,'amu'),
...
species(
    label = 'CCCCC[CH]C[C](C)OO(8212)',
    structure = SMILES('CCCCC[CH]C[C](C)OO'),
    E0 = (17.1867,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (158.238,'amu'),
...
species(
    label = '[CH2]C[CH]CCCCC(C)OO(8213)',
    structure = SMILES('[CH2]C[CH]CCCCC(C)OO'),
    E0 = (35.534,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1310,387.5,850,1000,2750,2761.11,2772.22,2783.33,2794.44,2805.56,2816.67,2827.78,2838.89,2850,1425,1431.25,1437.5,1443.75,1450,1225,1237.5,1250,1262.5,1275,1270,1287.5,1305,1322.5,1340,700,725,750,775,800,300,325,350,375,400,3000,3100,440,815,1455,1000,1380,1390,370,380,2900,435,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2]C(C[CH]CCCCC)OO(8214)',
    structure = SMILES('[CH2]C(C[CH]CCCCC)OO'),
    E0 = (44.2502,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1310,387.5,850,1000,2750,2761.11,2772.22,2783.33,2794.44,2805.56,2816.67,2827.78,2838.89,2850,1425,1431.25,1437.5,1443.75,1450,1225,1237.5,1250,1262.5,1275,1270,1287.5,1305,1322.5,1340,700,725,750,775,800,300,325,350,375,400,3000,3100,440,815,1455,1000,1380,1390,370,380,2900,435,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'CCCCC[CH]CC(C)O[O](8215)',
    structure = SMILES('CCCCC[CH]CC(C)O[O]'),
    E0 = (-17.7077,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (158.238,'amu'),
...
species(
    label = 'CCCCC=CCC(C)OO(8216)',
    structure = SMILES('CCCCC=CCC(C)OO'),
    E0 = (-247.499,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (158.238,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.82691,0.124714,-9.26979e-05,3.61165e-08,-5.86421e-12,-29555.3,45.5609], Tmin=(100,'K'), Tmax=(1409.62,'K')), NASAPolynomial(coeffs=[19.975,0.0628479,-2.6865e-05,4.9814e-09,-3.42301e-13,-35701.8,-67.1056], Tmin=(1409.62,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-247.499,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(669.315,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH)"""),
)

species(
    label = 'CCC=CCCCC(C)OO(8217)',
    structure = SMILES('CCC=CCCCC(C)OO'),
    E0 = (-247.499,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (158.238,'amu'),
...
species(
    label = 'CCCCCC=CC(C)OO(8218)',
    structure = SMILES('CCCCCC=CC(C)OO'),
    E0 = (-247.835,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (158.238,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.06937,0.124776,-9.10472e-05,3.40406e-08,-5.21902e-12,-29582.6,47.3506], Tmin=(100,'K'), Tmax=(1505.25,'K')), NASAPolynomial(coeffs=[23.1709,0.0577025,-2.42061e-05,4.43648e-09,-3.02124e-13,-37181.1,-84.7408], Tmin=(1505.25,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-247.835,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(669.315,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH)"""),
)

species(
    label = 'CC=CCCCCC(C)OO(8219)',
    structure = SMILES('CC=CCCCCC(C)OO'),
    E0 = (-248.634,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (158.238,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.60301,0.125067,-9.55153e-05,3.92205e-08,-6.83991e-12,-29704.1,44.0884], Tmin=(100,'K'), Tmax=(1302.28,'K')), NASAPolynomial(coeffs=[16.9461,0.0680928,-2.989e-05,5.62521e-09,-3.90553e-13,-34535.3,-50.2995], Tmin=(1302.28,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-248.634,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(669.315,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH)"""),
)
...
species(
    label = 'CC[CH]CC[CH]CCOO(8220)',
    structure = SMILES('CC[CH]CC[CH]CCOO'),
    E0 = (61.1691,'kJ/mol'),
    modes = [
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.14099,0.124974,-0.000159961,1.41073e-07,-5.22629e-11,7530.55,45.6274], Tmin=(100,'K'), Tmax=(799.557,'K')), NASAPolynomial(coeffs=[3.88351,0.079657,-3.70856e-05,7.05342e-09,-4.88382e-13,7372.13,26.5449], Tmin=(799.557,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(61.1691,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(594.485,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(RCCJCC)"""),
)
...
species(
    label = 'CC[CH]CCC1CC(C)O1(8221)',
    structure = SMILES('CC[CH]CCC1CC(C)O1'),
    E0 = (-69.8285,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (141.231,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.811675,0.0939076,-3.611e-05,-1.12388e-08,9.70222e-12,-8214.78,39.3886], Tmin=(100,'K'), Tmax=(996.352,'K')), NASAPolynomial(coeffs=[13.8213,0.0596898,-2.15224e-05,3.70874e-09,-2.48021e-13,-12348.2,-37.2631], Tmin=(996.352,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-69.8285,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(631.9,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Oxetane) + radical(RCCJCC)"""),
)

species(
    label = '[CH2]C(CC[CH]CC)C(C)OO(8222)',
    structure = SMILES('[CH2]C(CC[CH]CC)C(C)OO'),
    E0 = (33.0228,'kJ/mol'),
    modes = [
...
species(
    label = '[CH2]C(C)CC[CH]CC(C)OO(8223)',
    structure = SMILES('[CH2]C(C)CC[CH]CC(C)OO'),
    E0 = (29.6756,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3615,1310,387.5,850,1000,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3000,3100,440,815,1455,1000,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (158.238,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.63634,0.131405,-0.000122108,6.96137e-08,-1.74281e-11,3765.79,48.27], Tmin=(100,'K'), Tmax=(930.858,'K')), NASAPolynomial(coeffs=[11.1118,0.0766209,-3.38227e-05,6.38074e-09,-4.44493e-13,1392.61,-12.3181], Tmin=(930.858,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(29.6756,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(665.158,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(Isobutyl)"""),
)
...
species(
    label = 'CC[CH]CCC(O)CC(C)[O](8224)',
    structure = SMILES('CC[CH]CCC(O)CC(C)[O]'),
    E0 = (-183.327,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (158.238,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.47071,0.127923,-0.000113972,6.12011e-08,-1.44819e-11,-21858.5,47.5762], Tmin=(100,'K'), Tmax=(976.068,'K')), NASAPolynomial(coeffs=[11.2673,0.0757219,-3.37523e-05,6.41054e-09,-4.48577e-13,-24345.2,-13.5689], Tmin=(976.068,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-183.327,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(669.315,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(RCCJCC)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['CC[CH]CC[CH]CC(C)OO(8042)'],
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'CC[CH]CCC=CC(C)OO(8198)'],
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'CC[CH]CC=CCC(C)OO(8199)'],
    products = ['CC[CH]CC[CH]CC(C)OO(8042)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(1.46e+08,'cm^3/(mol*s)'), n=1.64, Ea=(5.73208,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""From training reaction 2555 used for Cds-CsH_Cds-CsH;HJ
Exact match found for rate rule [Cds-CsH_Cds-CsH;HJ]
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', 'CCC=CC[CH]CC(C)OO(8200)'],
    products = ['CC[CH]CC[CH]CC(C)OO(8042)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(1.46e+08,'cm^3/(mol*s)'), n=1.64, Ea=(5.73208,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""From training reaction 2555 used for Cds-CsH_Cds-CsH;HJ
Exact match found for rate rule [Cds-CsH_Cds-CsH;HJ]
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)', 'CC=CCC[CH]CC(C)OO(8201)'],
    products = ['CC[CH]CC[CH]CC(C)OO(8042)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(1.46e+08,'cm^3/(mol*s)'), n=1.64, Ea=(5.73208,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""From training reaction 2555 used for Cds-CsH_Cds-CsH;HJ
Exact match found for rate rule [Cds-CsH_Cds-CsH;HJ]
...
reaction(
    label = 'reaction6',
    reactants = ['CH3CHOOH(63)', 'C=CCC[CH]CC(1493)'],
    products = ['CC[CH]CC[CH]CC(C)OO(8042)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['CH3(17)', 'C=CCC[CH]CC(C)OO(6666)'],
    products = ['CC[CH]CC[CH]CC(C)OO(8042)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['CC[CH]CCC[CH]C(C)OO(8202)'],
    products = ['CC[CH]CC[CH]CC(C)OO(8042)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CC[CH]CC[CH]CC(C)OO(8042)'],
    products = ['C[CH]CCC[CH]CC(C)OO(8203)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CC[CH]CC[CH]CC(C)OO(8042)'],
    products = ['CC[CH]CCCC[C](C)OO(8204)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CC[CH][CH]CCCC(C)OO(8205)'],
    products = ['CC[CH]CC[CH]CC(C)OO(8042)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CCCC[CH][CH]CC(C)OO(8206)'],
    products = ['CC[CH]CC[CH]CC(C)OO(8042)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]CCCC[CH]CC(C)OO(8207)'],
    products = ['CC[CH]CC[CH]CC(C)OO(8042)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2]C(CCCC[CH]CC)OO(8208)'],
    products = ['CC[CH]CC[CH]CC(C)OO(8042)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CC[CH]CC[CH]CC(C)OO(8042)'],
    products = ['CC[CH]CCCCC(C)O[O](8209)'],
...
reaction(
    label = 'reaction20',
    reactants = ['CCCCC[CH][CH]C(C)OO(8210)'],
    products = ['CC[CH]CC[CH]CC(C)OO(8042)'],
...
reaction(
    label = 'reaction21',
    reactants = ['CC[CH]CC[CH]CC(C)OO(8042)'],
    products = ['C[CH][CH]CCCCC(C)OO(8211)'],
...
reaction(
    label = 'reaction22',
    reactants = ['CC[CH]CC[CH]CC(C)OO(8042)'],
    products = ['CCCCC[CH]C[C](C)OO(8212)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH2]C[CH]CCCCC(C)OO(8213)'],
    products = ['CC[CH]CC[CH]CC(C)OO(8042)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[CH2]C(C[CH]CCCCC)OO(8214)'],
    products = ['CC[CH]CC[CH]CC(C)OO(8042)'],
...
reaction(
    label = 'reaction25',
    reactants = ['CC[CH]CC[CH]CC(C)OO(8042)'],
    products = ['CCCCC[CH]CC(C)O[O](8215)'],
...
reaction(
    label = 'reaction31',
    reactants = ['CH2(S)(23)', 'CC[CH]CC[CH]CCOO(8220)'],
    products = ['CC[CH]CC[CH]CC(C)OO(8042)'],
...
reaction(
    label = 'reaction32',
    reactants = ['CH2(S)(23)', 'C[CH]CC[CH]CC(C)OO(6353)'],
    products = ['CC[CH]CC[CH]CC(C)OO(8042)'],
...
reaction(
    label = 'reaction33',
    reactants = ['CC[CH]CC[CH]CC(C)OO(8042)'],
    products = ['OH(5)', 'CC[CH]CCC1CC(C)O1(8221)'],
...
reaction(
    label = 'reaction34',
    reactants = ['[CH2]C(CC[CH]CC)C(C)OO(8222)'],
    products = ['CC[CH]CC[CH]CC(C)OO(8042)'],
...
reaction(
    label = 'reaction37',
    reactants = ['[CH2]C(C)CC[CH]CC(C)OO(8223)'],
    products = ['CC[CH]CC[CH]CC(C)OO(8042)'],
...
reaction(
    label = 'reaction39',
    reactants = ['CC[CH]CC[CH]CC(C)OO(8042)'],
    products = ['CC[CH]CCC(O)CC(C)[O](8224)'],
...
reaction(
    label = 'reaction40',
    reactants = ['[CH2]C[CH]CC(135)', '[CH]CC(C)OO(1806)'],
    products = ['CC[CH]CC[CH]CC(C)OO(8042)'],
...
reaction(
    label = 'reaction41',
    reactants = ['[CH]CC(144)', '[CH2]C[CH]CC(C)OO(5450)'],
    products = ['CC[CH]CC[CH]CC(C)OO(8042)'],
