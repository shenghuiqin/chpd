...
species(
    label = '[CH]=C(O)C(O)C[CH2](16342)',
    structure = SMILES('[CH]=C(O)C(O)C[CH2]'),
    E0 = (24.6752,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,3580,3650,1210,1345,900,1100,1380,1390,370,380,2900,435,350,440,435,1725,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,368.016],'cm^-1')),
        HinderedRotor(inertia=(0.00124476,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.141104,'amu*angstrom^2'), symmetry=1, barrier=(13.5608,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.141101,'amu*angstrom^2'), symmetry=1, barrier=(13.5607,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.141109,'amu*angstrom^2'), symmetry=1, barrier=(13.5607,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.14111,'amu*angstrom^2'), symmetry=1, barrier=(13.5608,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.192673,0.0735502,-5.89626e-05,1.32052e-08,3.26337e-12,3114.03,31.5015], Tmin=(100,'K'), Tmax=(960.76,'K')), NASAPolynomial(coeffs=[19.6458,0.0157543,-4.94096e-06,8.47842e-10,-5.97074e-14,-1694.43,-67.1409], Tmin=(960.76,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(24.6752,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(Cds_P) + radical(RCCJ)"""),
)
...
species(
    label = '[CH]=[C]C(CC)OO(16343)',
    structure = SMILES('[CH]=[C]C(CC)OO'),
    E0 = (343.334,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,2750,2800,2850,1350,1500,750,1050,1375,1000,1685,370,3615,1310,387.5,850,1000,2750,2850,1437.5,1250,1305,750,350,1380,1390,370,380,2900,435,275.092],'cm^-1')),
        HinderedRotor(inertia=(0.378674,'amu*angstrom^2'), symmetry=1, barrier=(20.492,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.193947,'amu*angstrom^2'), symmetry=1, barrier=(10.6029,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.379616,'amu*angstrom^2'), symmetry=1, barrier=(20.4893,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0780095,'amu*angstrom^2'), symmetry=1, barrier=(4.26077,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.384874,'amu*angstrom^2'), symmetry=1, barrier=(20.4882,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.810562,0.0712634,-6.62565e-05,3.2812e-08,-6.70669e-12,41407.5,28.6803], Tmin=(100,'K'), Tmax=(1155.08,'K')), NASAPolynomial(coeffs=[12.4105,0.0310937,-1.40924e-05,2.70533e-09,-1.90627e-13,38727.6,-28.9552], Tmin=(1155.08,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(343.334,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_S) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['C2H5(29)', '[CH]=C(O)C=O(7868)'],
    products = ['[CH]=C(O)C([O])CC(4631)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['OH(5)', 'C#CC([O])CC(11133)'],
    products = ['[CH]=C(O)C([O])CC(4631)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction11',
    reactants = ['[CH]=C(O)C(O)C[CH2](16342)'],
    products = ['[CH]=C(O)C([O])CC(4631)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CH2(S)(23)', '[CH]=C(O)C(C)[O](3239)'],
    products = ['[CH]=C(O)C([O])CC(4631)'],
...
reaction(
    label = 'reaction20',
    reactants = ['O(4)', '[CH]=C(O)[CH]CC(7319)'],
    products = ['[CH]=C(O)C([O])CC(4631)'],
