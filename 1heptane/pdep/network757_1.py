...
species(
    label = '[CH]=CC(=C)CCCC(3411)',
    structure = SMILES('[CH]=CC(=C)CCCC'),
    E0 = (233.221,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,3010,987.5,1337.5,450,1655,2750,2800,2850,1350,1500,750,1050,1375,1000,2950,3100,1380,975,1025,1650,350,440,435,1725,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.419149,0.0847424,-4.98865e-05,5.16165e-09,3.91383e-12,28219.8,32.2637], Tmin=(100,'K'), Tmax=(1054.91,'K')), NASAPolynomial(coeffs=[17.7678,0.0378298,-1.45318e-05,2.63178e-09,-1.82089e-13,23155.8,-62.2646], Tmin=(1054.91,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(233.221,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(486.397,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cds_P)"""),
)
...
species(
    label = '[CH]=CC(C)[CH]CCC(3414)',
    structure = SMILES('[CH]=CC(C)[CH]CCC'),
    E0 = (322.024,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (110.197,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.124417,0.082395,-5.18004e-05,1.63295e-08,-2.10197e-12,38885.5,36.5936], Tmin=(100,'K'), Tmax=(1758.27,'K')), NASAPolynomial(coeffs=[18.1449,0.0408326,-1.63427e-05,2.88519e-09,-1.90377e-13,32461.1,-61.8552], Tmin=(1758.27,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(322.024,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cs_S) + radical(Cds_P)"""),
)
...
species(
    ...
    molecularWeight = (110.197,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.163674,0.0808279,-5.07137e-05,1.65412e-08,-2.26607e-12,38859.3,35.7167], Tmin=(100,'K'), Tmax=(1614.86,'K')), NASAPolynomial(coeffs=[14.0536,0.0464225,-1.87554e-05,3.34772e-09,-2.23549e-13,34373.3,-37.9507], Tmin=(1614.86,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(321.928,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(RCCJC) + radical(Cds_P)"""),
)
...
species(
    label = '[CH]=CC(C)CCC[CH2](3422)',
    structure = SMILES('[CH]=CC(C)CCC[CH2]'),
    E0 = (332.728,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,3010,987.5,1337.5,450,1655,2750,2800,2850,1350,1500,750,1050,1375,1000,1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3000,3100,440,815,1455,1000,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (110.197,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.474331,0.0866098,-5.86139e-05,2.03482e-08,-2.87811e-12,40188.7,37.0843], Tmin=(100,'K'), Tmax=(1636.97,'K')), NASAPolynomial(coeffs=[18.9428,0.0391633,-1.51375e-05,2.64217e-09,-1.74029e-13,33831.6,-66.1619], Tmin=(1636.97,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(332.728,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(RCCJ) + radical(Cds_P)"""),
)
...
species(
    label = '[CH]=CC([CH2])CCC(1175)',
    structure = SMILES('[CH]=CC([CH2])CCC'),
    E0 = (356.344,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,3010,987.5,1337.5,450,1655,2750,2800,2850,1350,1500,750,1050,1375,1000,1380,1390,370,380,2900,435,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3100,440,815,1455,1000,288.872,288.872],'cm^-1')),
        HinderedRotor(inertia=(0.00202018,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.103355,'amu*angstrom^2'), symmetry=1, barrier=(6.12023,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0020202,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.103353,'amu*angstrom^2'), symmetry=1, barrier=(6.12023,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.374143,'amu*angstrom^2'), symmetry=1, barrier=(22.1552,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.382896,0.0703984,-4.00496e-05,5.94292e-09,1.98765e-12,42996.3,31.7354], Tmin=(100,'K'), Tmax=(1074.05,'K')), NASAPolynomial(coeffs=[13.3018,0.036983,-1.39079e-05,2.45701e-09,-1.66412e-13,39373.4,-35.46], Tmin=(1074.05,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(356.344,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Isobutyl) + radical(Cds_P)"""),
)
...
species(
    ...
    opticalIsomers = 1,
    molecularWeight = (110.197,'amu'),
    collisionModel = TransportData(shapeIndex=2, epsilon=(3496.44,'J/mol'), sigma=(6.48013,'angstroms'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with Tc=546.14 K, Pc=29.16 bar (from Joback method)"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', '[CH]=CC(=C)CCCC(3411)'],
    products = ['[CH]=CC([CH2])CCCC(1173)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'C#CC([CH2])CCCC(3412)'],
    products = ['[CH]=CC([CH2])CCCC(1173)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['butyl_1(82)', 'CH2CHCHCH(2454)'],
    products = ['[CH]=CC([CH2])CCCC(1173)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['C2H2(T)(175)', 'C=CCCCC(193)'],
    products = ['[CH]=CC([CH2])CCCC(1173)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2][CH]CCCC(197)', 'C2H2(32)'],
    products = ['[CH]=CC([CH2])CCCC(1173)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction17',
    reactants = ['[CH]=CC(C)CCC[CH2](3422)'],
    products = ['[CH]=CC([CH2])CCCC(1173)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH]=CC([CH2])CCCC(1173)'],
    products = ['[CH2]CCCC([CH2])C=C(3423)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2][CH]CCCC(197)', 'C2H2(T)(175)'],
    products = ['[CH]=CC([CH2])CCCC(1173)'],
...
reaction(
    label = 'reaction21',
    reactants = ['CH2(S)(23)', '[CH]=CC([CH2])CCC(1175)'],
    products = ['[CH]=CC([CH2])CCCC(1173)'],
...
reaction(
    label = 'reaction25',
    reactants = ['CH2(19)', '[CH]=C[CH]CCCC(3303)'],
    products = ['[CH]=CC([CH2])CCCC(1173)'],
