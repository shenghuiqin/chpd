...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.547981,0.103181,-7.79271e-05,3.22792e-08,-5.76329e-12,-33647.8,40.9626], Tmin=(100,'K'), Tmax=(1261.3,'K')), NASAPolynomial(coeffs=[13.1706,0.0596746,-2.61867e-05,4.93132e-09,-3.42678e-13,-37108.4,-28.4061], Tmin=(1261.3,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-281.1,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(577.856,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdCsCs) + radical(C=OCOJ)"""),
)

species(
    label = 'CCCCC(=O)C([O])CC(14119)',
    structure = SMILES('CCCCC(=O)C([O])CC'),
    E0 = (-281.1,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,375,552.5,462.5,1710,1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,200,800,1000,1200,1400,1600],'cm^-1')),
...
species(
    ...
    molecularWeight = (144.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.31718,0.122484,-0.000117406,6.51247e-08,-1.53642e-11,-21146.7,41.6344], Tmin=(100,'K'), Tmax=(997.957,'K')), NASAPolynomial(coeffs=[13.5568,0.0628662,-2.77946e-05,5.26119e-09,-3.67565e-13,-24115.4,-30.0935], Tmin=(997.957,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-177.377,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(598.642,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(C2CsJOH)"""),
)

species(
    label = 'CCCC[C](O)C([O])CC(14121)',
    ...
    molecularWeight = (144.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.31718,0.122485,-0.000117406,6.51249e-08,-1.53643e-11,-21146.7,41.6344], Tmin=(100,'K'), Tmax=(997.944,'K')), NASAPolynomial(coeffs=[13.5568,0.0628662,-2.77947e-05,5.2612e-09,-3.67566e-13,-24115.4,-30.0934], Tmin=(997.944,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-177.377,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(598.642,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(C2CsJOH) + radical(CC(C)OJ)"""),
)

species(
    label = 'CCCC[C]([O])C(O)CC(14122)',
    structure = SMILES('CCCC[C]([O])C(O)CC'),
    E0 = (-177.377,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
species(
    label = 'C[CH]C(O)C([O])CCCC(14123)',
    structure = SMILES('C[CH]C(O)C([O])CCCC'),
    E0 = (-154.103,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3025,407.5,1350,352.5,3615,1277.5,1000,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (144.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.38201,0.113648,-9.04544e-05,3.84465e-08,-6.76384e-12,-18336.9,44.9195], Tmin=(100,'K'), Tmax=(1326.09,'K')), NASAPolynomial(coeffs=[18.679,0.0531358,-2.20055e-05,4.03479e-09,-2.76349e-13,-23657.4,-57.5251], Tmin=(1326.09,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-154.103,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(598.642,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(CCJCO)"""),
)

species(
    label = 'CCCCC(O)[C]([O])CC(14124)',
    structure = SMILES('CCCCC(O)[C]([O])CC'),
    E0 = (-177.377,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
species(
    ...
    molecularWeight = (144.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.38202,0.113648,-9.04545e-05,3.84466e-08,-6.76388e-12,-18336.9,44.9196], Tmin=(100,'K'), Tmax=(1326.07,'K')), NASAPolynomial(coeffs=[18.679,0.0531359,-2.20056e-05,4.03481e-09,-2.7635e-13,-23657.4,-57.5248], Tmin=(1326.07,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-154.103,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(598.642,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJCO) + radical(CC(C)OJ)"""),
)

species(
    label = 'C[CH]C([O])C(O)CCCC(14126)',
    structure = SMILES('C[CH]C([O])C(O)CCCC'),
    E0 = (-154.103,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
species(
    ...
    molecularWeight = (144.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.854897,0.113518,-0.000101507,5.49736e-08,-1.31327e-11,-19019.9,43.1189], Tmin=(100,'K'), Tmax=(967.509,'K')), NASAPolynomial(coeffs=[10.3045,0.0673821,-2.99806e-05,5.68845e-09,-3.978e-13,-21179.3,-10.3502], Tmin=(967.509,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-159.547,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(598.642,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(CC(C)OJ)"""),
)

species(
    label = 'CCC[CH]C([O])C(O)CC(14128)',
    structure = SMILES('CCC[CH]C([O])C(O)CC'),
    E0 = (-154.103,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3025,407.5,1350,352.5,3615,1277.5,1000,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,200,800,1000,1200,1400,1600],'cm^-1')),
...
species(
    ...
    molecularWeight = (144.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.26041,0.116291,-9.79895e-05,4.53725e-08,-8.82886e-12,-17702.8,43.7759], Tmin=(100,'K'), Tmax=(1196.82,'K')), NASAPolynomial(coeffs=[16.1923,0.0579608,-2.48829e-05,4.64987e-09,-3.22435e-13,-21880.3,-43.5591], Tmin=(1196.82,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-148.759,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(598.642,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(RCCJ)"""),
)

species(
    label = '[CH2]CC([O])C(O)CCCC(14130)',
    structure = SMILES('[CH2]CC([O])C(O)CCCC'),
    E0 = (-148.759,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
species(
    ...
    molecularWeight = (144.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.928331,0.113587,-9.87474e-05,5.04234e-08,-1.11983e-11,-19017.4,43.5462], Tmin=(100,'K'), Tmax=(1041.06,'K')), NASAPolynomial(coeffs=[11.7874,0.0647295,-2.835e-05,5.34194e-09,-3.72188e-13,-21664.9,-18.3112], Tmin=(1041.06,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-159.559,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(598.642,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(RCCJC)"""),
)

species(
    label = '[CH2]CCCC([O])C(O)CC(14135)',
    structure = SMILES('[CH2]CCCC([O])C(O)CC'),
    E0 = (-148.759,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
species(
    ...
    molecularWeight = (144.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.930976,0.107798,-8.0024e-05,3.1608e-08,-5.26161e-12,-62945.4,41.554], Tmin=(100,'K'), Tmax=(1365.53,'K')), NASAPolynomial(coeffs=[16.2607,0.0574394,-2.47062e-05,4.60125e-09,-3.1725e-13,-67640.5,-46.7417], Tmin=(1365.53,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-524.833,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(598.642,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdCsCs)"""),
)

species(
    label = 'CCCCC(=O)C(O)CC(14137)',
    structure = SMILES('CCCCC(=O)C(O)CC'),
    E0 = (-524.833,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
reaction(
    label = 'reaction1',
    reactants = ['CCCCC([O])C([O])CC(13626)'],
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'CCCCC([O])C(=O)CC(14118)'],
    products = ['CCCCC([O])C([O])CC(13626)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'CCCCC(=O)C([O])CC(14119)'],
    products = ['CCCCC([O])C([O])CC(13626)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(0.0366254,'m^3/(mol*s)'), n=1.743, Ea=(71.4418,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [CO-CsCs_O;YJ] for rate rule [CO-CsCs_O;HJ]
Euclidian distance = 1.0
...
reaction(
    label = 'reaction5',
    reactants = ['C2H5(29)', 'CCCCC([O])C=O(11788)'],
    products = ['CCCCC([O])C([O])CC(13626)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['CC[CH][O](563)', 'CCCCC=O(1733)'],
    products = ['CCCCC([O])C([O])CC(13626)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(0.0201871,'m^3/(mol*s)'), n=2.2105, Ea=(56.0866,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [CO-CsH_O;YJ] for rate rule [CO-CsH_O;CJ]
Euclidian distance = 1.0
...
reaction(
    label = 'reaction7',
    reactants = ['butyl_1(82)', 'CCC([O])C=O(10833)'],
    products = ['CCCCC([O])C([O])CC(13626)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(7.94e+10,'cm^3/(mol*s)'), n=0, Ea=(28.0328,'kJ/mol'), T0=(1,'K'), Tmin=(333,'K'), Tmax=(363,'K'), comment="""Estimated using template [CO_O;CsJ-CsHH] for rate rule [CO-CsH_O;CsJ-CsHH]
Euclidian distance = 2.0
...
reaction(
    label = 'reaction9',
    reactants = ['CCCCC([O])C([O])CC(13626)'],
    products = ['CCCC[C](O)C([O])CC(14121)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(4.56178e+08,'s^-1'), n=1.25272, Ea=(165.67,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R2H_S;Y_rad_out;Cs_H_out_Cs2] for rate rule [R2H_S;O_rad_out;Cs_H_out_Cs2]
Euclidian distance = 1.0
family: intra_H_migration"""),
...
reaction(
    label = 'reaction10',
    reactants = ['CCCCC([O])C([O])CC(13626)'],
    products = ['CCCC[C]([O])C(O)CC(14122)'],
...
reaction(
    label = 'reaction11',
    reactants = ['C[CH]C(O)C([O])CCCC(14123)'],
    products = ['CCCCC([O])C([O])CC(13626)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CCC[CH]C(O)C([O])CC(14125)'],
    products = ['CCCCC([O])C([O])CC(13626)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CCCCC([O])C([O])CC(13626)'],
    products = ['C[CH]C([O])C(O)CCCC(14126)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CC[CH]CC(O)C([O])CC(14127)'],
    products = ['CCCCC([O])C([O])CC(13626)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CCC[CH]C([O])C(O)CC(14128)'],
    products = ['CCCCC([O])C([O])CC(13626)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]CC(O)C([O])CCCC(14129)'],
    products = ['CCCCC([O])C([O])CC(13626)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CCCCC([O])C([O])CC(13626)'],
    products = ['[CH2]CC([O])C(O)CCCC(14130)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CCCCC([O])C([O])CC(13626)'],
    products = ['C[CH]CCC(O)C([O])CC(14131)'],
...
reaction(
    label = 'reaction20',
    reactants = ['CCCCC([O])C([O])CC(13626)'],
    products = ['CC[CH]CC([O])C(O)CC(14132)'],
...
reaction(
    label = 'reaction21',
    reactants = ['CCCCC([O])C([O])CC(13626)'],
    products = ['[CH2]CCCC(O)C([O])CC(14133)'],
...
reaction(
    label = 'reaction22',
    reactants = ['CCCCC([O])C([O])CC(13626)'],
    products = ['C[CH]CCC([O])C(O)CC(14134)'],
...
reaction(
    label = 'reaction23',
    reactants = ['CCCCC([O])C([O])CC(13626)'],
    products = ['[CH2]CCCC([O])C(O)CC(14135)'],
...
reaction(
    label = 'reaction27',
    reactants = ['CH2(S)(23)', 'CCCCC([O])C(C)[O](11950)'],
    products = ['CCCCC([O])C([O])CC(13626)'],
...
reaction(
    label = 'reaction28',
    reactants = ['CH2(S)(23)', 'CCCC([O])C([O])CC(14138)'],
    products = ['CCCCC([O])C([O])CC(13626)'],
...
reaction(
    label = 'reaction30',
    reactants = ['O(4)', 'CC[CH]C([O])CCCC(11309)'],
    products = ['CCCCC([O])C([O])CC(13626)'],
...
reaction(
    label = 'reaction31',
    reactants = ['O(4)', 'CCCC[CH]C([O])CC(10783)'],
    products = ['CCCCC([O])C([O])CC(13626)'],
