...
species(
    label = 'C=C(CCC)C([O])O(4510)',
    structure = SMILES('C=C(CCC)C([O])O'),
    E0 = (-213.71,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1277.5,1000,2950,3100,1380,975,1025,1650,1380,1390,370,380,2900,435,350,440,435,1725,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.637295,0.0805695,-7.43257e-05,4.36948e-08,-1.17149e-11,-25588,31.8979], Tmin=(100,'K'), Tmax=(856.59,'K')), NASAPolynomial(coeffs=[6.7655,0.0519526,-2.42136e-05,4.6934e-09,-3.32093e-13,-26637.9,3.28153], Tmin=(856.59,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-213.71,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(CCOJ)"""),
)

species(
    label = '[CH2]C(CCC)C(=O)O(4511)',
    structure = SMILES('[CH2]C(CCC)C(=O)O'),
    E0 = (-335.6,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1277.5,1000,3000,3100,440,815,1455,1000,1380,1390,370,380,2900,435,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (115.15,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.501676,0.081625,-6.83066e-05,3.28406e-08,-6.91261e-12,-40241.3,30.2134], Tmin=(100,'K'), Tmax=(1083.58,'K')), NASAPolynomial(coeffs=[9.63074,0.0479252,-2.16555e-05,4.13858e-09,-2.90523e-13,-42219.7,-14.5618], Tmin=(1083.58,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-335.6,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-(Cds-O2d)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdCsOs) + radical(CJC(C)C=O)"""),
)
...
species(
    ...
    molecularWeight = (116.158,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.914192,0.0733589,-4.59628e-05,1.47198e-08,-2.03304e-12,-21464,31.7863], Tmin=(100,'K'), Tmax=(1519.26,'K')), NASAPolynomial(coeffs=[10.2549,0.048766,-2.16816e-05,4.0649e-09,-2.79738e-13,-24302.2,-17.1839], Tmin=(1519.26,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-179.338,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJ(C)CO) + radical(CCOJ)"""),
)

species(
    label = '[CH2]C(CCC)[C](O)O(4513)',
    structure = SMILES('[CH2]C(CCC)[C](O)O'),
    E0 = (-147.289,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (116.158,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0855422,0.0898477,-8.34304e-05,4.36883e-08,-9.50971e-12,-17567.6,36.1203], Tmin=(100,'K'), Tmax=(1091.49,'K')), NASAPolynomial(coeffs=[13.1117,0.0414839,-1.69661e-05,3.09314e-09,-2.11683e-13,-20448.5,-28.7042], Tmin=(1091.49,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-147.289,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Cs_P) + radical(Isobutyl)"""),
)

species(
    label = 'CC[CH]C(C)C([O])O(4514)',
    ...
    molecularWeight = (116.158,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.685683,0.0798874,-7.01068e-05,4.20651e-08,-1.21672e-11,-16408.6,35.0171], Tmin=(100,'K'), Tmax=(780.02,'K')), NASAPolynomial(coeffs=[5.05157,0.057499,-2.70535e-05,5.26869e-09,-3.73864e-13,-17089.7,15.0388], Tmin=(780.02,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-137.37,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Cs_S) + radical(CCOJ)"""),
)

species(
    label = 'CCCC(C)[C]([O])O(4515)',
    structure = SMILES('CCCC(C)[C]([O])O'),
    E0 = (-126.666,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,360,370,350,3615,1277.5,1000,1380,1390,370,380,2900,435,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (116.158,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.613534,0.0809955,-6.67055e-05,3.34347e-08,-7.66687e-12,-15117.9,33.4001], Tmin=(100,'K'), Tmax=(978.295,'K')), NASAPolynomial(coeffs=[7.32948,0.0535356,-2.46017e-05,4.74264e-09,-3.34673e-13,-16431.9,1.147], Tmin=(978.295,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-126.666,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Cs_P) + radical(CCOJ)"""),
)

species(
    label = '[CH2][C](CCC)C(O)O(4516)',
    structure = SMILES('[CH2][C](CCC)C(O)O'),
    E0 = (-199.961,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (116.158,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0012581,0.084287,-6.81569e-05,3.02395e-08,-5.5775e-12,-23902.7,35.3203], Tmin=(100,'K'), Tmax=(1271.06,'K')), NASAPolynomial(coeffs=[14.0494,0.0400701,-1.59761e-05,2.87103e-09,-1.94542e-13,-27474.6,-35.836], Tmin=(1271.06,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-199.961,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Isobutyl) + radical(CCJ(C)CO)"""),
)

species(
    label = '[CH2]C([CH]CC)C(O)O(4517)',
    structure = SMILES('[CH2]C([CH]CC)C(O)O'),
    E0 = (-157.993,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,3580,3650,1210,1345,900,1100,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (116.158,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.199569,0.0862746,-7.8408e-05,4.15365e-08,-9.39169e-12,-18867.5,36.9706], Tmin=(100,'K'), Tmax=(1037.12,'K')), NASAPolynomial(coeffs=[10.7763,0.0454821,-1.94095e-05,3.61202e-09,-2.49941e-13,-21061.4,-14.4414], Tmin=(1037.12,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-157.993,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Isobutyl) + radical(Cs_S)"""),
)

species(
    label = 'C[CH]CC(C)C([O])O(4518)',
    ...
    molecularWeight = (116.158,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.74267,0.0626641,3.35086e-05,-2.17136e-07,2.09208e-10,-16465.9,31.7244], Tmin=(100,'K'), Tmax=(415.24,'K')), NASAPolynomial(coeffs=[4.52487,0.0575675,-2.64843e-05,5.05939e-09,-3.53234e-13,-16884.1,18.4941], Tmin=(415.24,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-137.466,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJC) + radical(CCOJ)"""),
)

species(
    label = 'CCCC(C)C([O])[O](4519)',
    structure = SMILES('CCCC(C)C([O])[O]'),
    E0 = (-106.207,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (116.158,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.19591,0.0649634,-3.25134e-05,6.89671e-09,-5.5316e-13,-12737.1,27.0082], Tmin=(100,'K'), Tmax=(2780.28,'K')), NASAPolynomial(coeffs=[25.535,0.031386,-1.43983e-05,2.55306e-09,-1.62591e-13,-25715.2,-109.455], Tmin=(2780.28,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-106.207,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(CCOJ)"""),
)

species(
    label = '[CH2]C(C[CH]C)C(O)O(4520)',
    ...
    molecularWeight = (116.158,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.14437,0.0884036,-8.87673e-05,5.47949e-08,-1.44715e-11,-18878,37.3509], Tmin=(100,'K'), Tmax=(899.504,'K')), NASAPolynomial(coeffs=[9.45633,0.0469945,-1.97143e-05,3.61657e-09,-2.47522e-13,-20553.2,-6.58775], Tmin=(899.504,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-158.089,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJC) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]CCC(C)C([O])O(4521)',
    ...
    molecularWeight = (116.158,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.613556,0.0809952,-6.67049e-05,3.3434e-08,-7.66661e-12,-15117.9,34.4987], Tmin=(100,'K'), Tmax=(978.328,'K')), NASAPolynomial(coeffs=[7.32954,0.0535355,-2.46016e-05,4.74262e-09,-3.34671e-13,-16432,2.24525], Tmin=(978.328,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-126.666,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(RCCJ)"""),
)

species(
    label = '[CH2]CCC([CH2])C(O)O(4522)',
    ...
    molecularWeight = (116.158,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0855422,0.0898477,-8.34304e-05,4.36883e-08,-9.50971e-12,-17567.6,37.2189], Tmin=(100,'K'), Tmax=(1091.49,'K')), NASAPolynomial(coeffs=[13.1117,0.0414839,-1.69661e-05,3.09314e-09,-2.11683e-13,-20448.5,-27.6056], Tmin=(1091.49,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-147.289,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJ) + radical(Isobutyl)"""),
)

species(
    label = 'C=C(CCC)C(O)O(4523)',
    structure = SMILES('C=C(CCC)C(O)O'),
    E0 = (-439.416,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (116.158,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.115218,0.0855528,-7.13544e-05,3.25179e-08,-6.21554e-12,-52709.8,32.1929], Tmin=(100,'K'), Tmax=(1217.48,'K')), NASAPolynomial(coeffs=[13.2531,0.042388,-1.81722e-05,3.396e-09,-2.35482e-13,-55908.8,-33.7749], Tmin=(1217.48,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-439.416,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH)"""),
)

species(
    label = 'CCCC(C)C(=O)O(4524)',
    structure = SMILES('CCCC(C)C(=O)O'),
    E0 = (-546.111,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (116.158,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.419342,0.076072,-4.84008e-05,1.55213e-08,-2.0638e-12,-65551.7,30.1448], Tmin=(100,'K'), Tmax=(1667.96,'K')), NASAPolynomial(coeffs=[14.7382,0.0417331,-1.75196e-05,3.17828e-09,-2.13785e-13,-70328.3,-46.2612], Tmin=(1667.96,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-546.111,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-(Cds-O2d)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdCsOs)"""),
)
...
species(
    label = '[CH2]C([CH]O)CCC(1751)',
    structure = SMILES('[CH2]C([CH]O)CCC'),
    E0 = (27.9939,'kJ/mol'),
    modes = [
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'C=C(CCC)C([O])O(4510)'],
    products = ['[CH2]C(CCC)C([O])O(1398)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', '[CH2]C(CCC)C(=O)O(4511)'],
    products = ['[CH2]C(CCC)C([O])O(1398)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['npropyl(83)', 'C=CC([O])O(3167)'],
    products = ['[CH2]C(CCC)C([O])O(1398)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['OH(5)', '[CH2]C(C=O)CCC(1749)'],
    products = ['[CH2]C(CCC)C([O])O(1398)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2]C([CH]CC)C(O)O(4517)'],
    products = ['[CH2]C(CCC)C([O])O(1398)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]C(CCC)C([O])O(1398)'],
    products = ['[CH2]C(C[CH]C)C(O)O(4520)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]CCC(C)C([O])O(4521)'],
    products = ['[CH2]C(CCC)C([O])O(1398)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2]C(CCC)C([O])O(1398)'],
    products = ['[CH2]CCC([CH2])C(O)O(4522)'],
...
reaction(
    label = 'reaction22',
    reactants = ['CH2(S)(23)', '[CH2]C(CC)C([O])O(1386)'],
    products = ['[CH2]C(CCC)C([O])O(1398)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[CH2]C([CH]OO)CCC(4525)'],
    products = ['[CH2]C(CCC)C([O])O(1398)'],
...
reaction(
    label = 'reaction27',
    reactants = ['CH2(19)', 'CCC[CH]C([O])O(4526)'],
    products = ['[CH2]C(CCC)C([O])O(1398)'],
...
reaction(
    label = 'reaction28',
    reactants = ['O(4)', '[CH2]C([CH]O)CCC(1751)'],
    products = ['[CH2]C(CCC)C([O])O(1398)'],
