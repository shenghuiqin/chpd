species(
    ...
    E0 = (-36.5961,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,1380,1390,370,380,2900,435,180,687.129],'cm^-1')),
        HinderedRotor(inertia=(0.100147,'amu*angstrom^2'), symmetry=1, barrier=(2.30257,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.10253,'amu*angstrom^2'), symmetry=1, barrier=(2.35737,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.105581,'amu*angstrom^2'), symmetry=1, barrier=(2.42752,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0410515,'amu*angstrom^2'), symmetry=1, barrier=(13.6443,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
species(
    label = '[CH2][C](O)OC(3588)',
    structure = SMILES('[CH2][C](O)OC'),
    E0 = (-19.2207,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([360,370,350,3615,1277.5,1000,3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,292.099,4000],'cm^-1')),
        HinderedRotor(inertia=(0.128634,'amu*angstrom^2'), symmetry=1, barrier=(7.78861,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.426966,'amu*angstrom^2'), symmetry=1, barrier=(25.8511,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.128639,'amu*angstrom^2'), symmetry=1, barrier=(7.78862,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00644895,'amu*angstrom^2'), symmetry=1, barrier=(25.851,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (74.0785,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.9172,0.0493263,-5.85987e-05,4.2449e-08,-1.30577e-11,-2239.92,21.1211], Tmin=(100,'K'), Tmax=(779.6,'K')), NASAPolynomial(coeffs=[6.67991,0.0248855,-1.15654e-05,2.22226e-09,-1.55803e-13,-2982.4,-0.669658], Tmin=(779.6,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-19.2207,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(Cs_P) + radical(CJCO)"""),
)
...
reaction(
    label = 'reaction12',
    reactants = ['CH2(19)', '[CH2]C([O])O(3174)'],
    products = ['[CH2]OC([CH2])O(967)'],
