...
species(
    ...
    E0 = (341.284,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3120,650,792.5,1650,3615,1277.5,1000,1685,370],'cm^-1')),
        HinderedRotor(inertia=(0.510826,'amu*angstrom^2'), symmetry=1, barrier=(11.7449,'kJ/mol'), semiclassical=False),
...
species(
    ...
    molecularWeight = (56.0633,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.45509,-0.00220289,7.24464e-05,-9.26515e-08,3.52774e-11,4953.89,10.1695], Tmin=(100,'K'), Tmax=(945.85,'K')), NASAPolynomial(coeffs=[9.50805,0.00847933,-2.03007e-06,3.95156e-10,-3.46518e-14,2185.98,-27.2744], Tmin=(945.85,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(40.9181,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(182.918,'J/(mol*K)'), label="""oxetene""", comment="""Thermo library: DFT_QCI_thermo"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH]=CC[O](948)'],
    products = ['CH2O(15)', 'C2H2(32)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'CHCHCHO(723)'],
    products = ['[CH]=CC[O](948)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2][O](167)', 'C2H2(T)(175)'],
    products = ['[CH]=CC[O](948)'],
