...
species(
    label = '[CH2][CH]C1CC2(CC)OCC12O(23137)',
    structure = SMILES('[CH2][CH]C1CC2(CC)OCC12O'),
    E0 = (114.688,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (154.206,'amu'),
...
species(
    label = '[CH2]C=CCC1(CC)OCC1=O(23138)',
    structure = SMILES('[CH2]C=CCC1(CC)OCC1=O'),
    E0 = (-86.5587,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2995,3025,975,1000,1300,1375,400,500,1630,1680,2750,3150,900,1100,3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,300,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.41043,0.099634,-4.24124e-05,-1.82633e-08,1.43145e-11,-10198.9,39.2515], Tmin=(100,'K'), Tmax=(1024.97,'K')), NASAPolynomial(coeffs=[23.7339,0.0416895,-1.64178e-05,3.07702e-09,-2.19537e-13,-17464.1,-92.9718], Tmin=(1024.97,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-86.5587,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(561.227,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-O2d)CsCsOs) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-O2d)OsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-OdCsCs) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cyclobutane) + radical(Allyl_P)"""),
)

species(
    label = '[CH2]C=CCC1(CC)OC=C1O(23139)',
    structure = SMILES('[CH2]C=CCC1(CC)OC=C1O'),
    E0 = (-128.961,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3100,440,815,1455,1000,300,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (153.198,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.05247,0.098335,9.1727e-06,-1.10573e-07,5.75851e-11,-15260.3,39.3807], Tmin=(100,'K'), Tmax=(928.922,'K')), NASAPolynomial(coeffs=[37.9833,0.0152023,-7.28163e-07,-2.01089e-11,-8.43554e-15,-26549.6,-171.547], Tmin=(928.922,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-128.961,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(557.07,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + ring(Cyclobutene) + radical(Allyl_P)"""),
)

species(
    label = 'C=C=CCC1(CC)OC[C]1O(23140)',
    structure = SMILES('C=C=CCC1(CC)OC[C]1O'),
    E0 = (26.6711,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,3150,900,1100,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,540,610,2055,300,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (153.198,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.69202,0.117398,-0.000100847,4.00564e-08,-3.5921e-12,3419.9,39.6643], Tmin=(100,'K'), Tmax=(917.594,'K')), NASAPolynomial(coeffs=[20.1212,0.0434236,-1.4437e-05,2.35383e-09,-1.52319e-13,-1472.13,-68.5394], Tmin=(917.594,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(26.6711,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(561.227,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + ring(Oxetane) + radical(C2CsJOH)"""),
)
...
species(
    label = '[CH2]C=CCC1OCC=1O(23141)',
    structure = SMILES('[CH2]C=CCC1OCC=1O'),
    E0 = (-53.4309,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2995,3025,975,1000,1300,1375,400,500,1630,1680,3615,1277.5,1000,3000,3100,440,815,1455,1000,2750,3150,900,1100,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.24032,0.0673368,1.58034e-05,-8.66699e-08,4.29618e-11,-6249.78,31.0712], Tmin=(100,'K'), Tmax=(938.392,'K')), NASAPolynomial(coeffs=[27.9098,0.0128673,-1.86603e-06,2.92505e-10,-2.97835e-14,-14417.9,-118.318], Tmin=(938.392,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-53.4309,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(415.724,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cyclobutene) + radical(Allyl_P)"""),
)
...
species(
    label = '[CH2]C=CCC1(CC)OCC1[O](23142)',
    structure = SMILES('[CH2]C=CCC1(CC)OCC1[O]'),
    E0 = (55.299,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (154.206,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.44338,0.102876,-4.15007e-05,-2.74466e-08,2.13124e-11,6862.4,39.6888], Tmin=(100,'K'), Tmax=(927.454,'K')), NASAPolynomial(coeffs=[22.5956,0.0422326,-1.30205e-05,2.1108e-09,-1.40627e-13,552.579,-84.4528], Tmin=(927.454,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(55.299,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(586.17,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Oxetane) + radical(Allyl_P) + radical(CC(C)OJ)"""),
)

species(
    label = '[CH2]C=CCC1(CC)O[CH]C1O(23143)',
    structure = SMILES('[CH2]C=CCC1(CC)O[CH]C1O'),
    E0 = (5.39419,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,2750,3150,900,1100,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3100,440,815,1455,1000,300,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2]C=CCC1([CH]C)OCC1O(23145)',
    structure = SMILES('[CH2]C=CCC1([CH]C)OCC1O'),
    E0 = (24.8402,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,2750,2850,1437.5,1250,1305,750,350,2750,2950,3150,900,1000,1100,3000,3100,440,815,1455,1000,300,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2]C=CCC1(C[CH2])OCC1O(23148)',
    structure = SMILES('[CH2]C=CCC1(C[CH2])OCC1O'),
    E0 = (30.1845,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (154.206,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.55381,0.107417,-5.71655e-05,-1.11191e-08,1.57096e-11,3843.92,42.0641], Tmin=(100,'K'), Tmax=(921.5,'K')), NASAPolynomial(coeffs=[22.4055,0.0418148,-1.28862e-05,2.06711e-09,-1.35952e-13,-2202.14,-80.413], Tmin=(921.5,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(30.1845,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(582.013,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Oxetane) + radical(RCCJ) + radical(Allyl_P)"""),
)

species(
    label = '[CH2]C=[C]CC1(CC)OCC1O(23149)',
    structure = SMILES('[CH2]C=[C]CC1(CC)OCC1O'),
    E0 = (62.78,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,1685,370,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2950,3150,900,1000,1100,3000,3100,440,815,1455,1000,300,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (154.206,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.62344,0.11128,-7.15245e-05,5.9875e-09,9.10793e-12,7764.57,41.001], Tmin=(100,'K'), Tmax=(922.621,'K')), NASAPolynomial(coeffs=[21.4255,0.0436034,-1.39289e-05,2.25792e-09,-1.47822e-13,2138.82,-75.7795], Tmin=(922.621,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(62.78,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(582.013,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Oxetane) + radical(Allyl_P) + radical(Cds_S)"""),
)

species(
    label = 'CC=C[CH]C1(CC)OC[C]1O(23150)',
    structure = SMILES('CC=C[CH]C1(CC)OC[C]1O'),
    E0 = (-33.0165,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (154.206,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.99252,0.122243,-0.000101564,3.83192e-08,-2.99475e-12,-3746.57,38.8866], Tmin=(100,'K'), Tmax=(942.398,'K')), NASAPolynomial(coeffs=[21.2327,0.0459435,-1.55812e-05,2.58009e-09,-1.68809e-13,-9113.4,-77.033], Tmin=(942.398,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-33.0165,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(582.013,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Oxetane) + radical(C=CCJCO) + radical(C2CsJOH)"""),
)

species(
    label = '[CH2][C]=CCC1(CC)OCC1O(23151)',
    structure = SMILES('[CH2][C]=CCC1(CC)OCC1O'),
    E0 = (62.78,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,1685,370,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2950,3150,900,1000,1100,3000,3100,440,815,1455,1000,300,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'C[CH]C1(CC=CC)OC[C]1O(23152)',
    structure = SMILES('C[CH]C1(CC=CC)OC[C]1O'),
    E0 = (49.9689,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (154.206,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.09355,0.119116,-0.000106203,5.20396e-08,-1.02047e-11,6241.86,44.5466], Tmin=(100,'K'), Tmax=(1274.27,'K')), NASAPolynomial(coeffs=[21.6399,0.0423838,-1.32525e-05,2.03612e-09,-1.24924e-13,374.427,-74.9953], Tmin=(1274.27,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(49.9689,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(582.013,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Oxetane) + radical(CCJCO) + radical(C2CsJOH)"""),
)

species(
    label = 'CC=CCC1(CC)O[CH][C]1O(23153)',
    structure = SMILES('CC=CCC1(CC)O[CH][C]1O'),
    E0 = (30.5228,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2950,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,3615,1277.5,1000,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,300,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (154.206,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.46651,0.129985,-0.000129647,7.01824e-08,-1.50255e-11,3914.3,42.8289], Tmin=(100,'K'), Tmax=(1180.42,'K')), NASAPolynomial(coeffs=[23.05,0.0406061,-1.23677e-05,1.85591e-09,-1.11882e-13,-1906.78,-83.6462], Tmin=(1180.42,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(30.5228,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(582.013,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Oxetane) + radical(CCsJOCs) + radical(C2CsJOH)"""),
)

species(
    label = '[CH2]CC1(CC=CC)OC[C]1O(23154)',
    structure = SMILES('[CH2]CC1(CC=CC)OC[C]1O'),
    E0 = (55.3132,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,2750,3150,900,1100,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3100,440,815,1455,1000,300,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (154.206,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.74018,0.119065,-0.000104448,4.70181e-08,-7.19018e-12,6865.75,42.568], Tmin=(100,'K'), Tmax=(945.56,'K')), NASAPolynomial(coeffs=[18.8919,0.0476756,-1.64074e-05,2.71799e-09,-1.76623e-13,2253.59,-59.5715], Tmin=(945.56,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(55.3132,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(582.013,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Oxetane) + radical(RCCJ) + radical(C2CsJOH)"""),
)

species(
    label = 'CC=CCC1(CC)OC[C]1[O](23155)',
    structure = SMILES('CC=CCC1(CC)OC[C]1[O]'),
    E0 = (80.4276,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2995,3025,975,1000,1300,1375,400,500,1630,1680,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,2750,3150,900,1100,300,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (154.206,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.6314,0.114541,-8.88233e-05,3.07092e-08,-1.57722e-12,9884.31,40.1988], Tmin=(100,'K'), Tmax=(952.92,'K')), NASAPolynomial(coeffs=[19.1015,0.048061,-1.65231e-05,2.75736e-09,-1.80943e-13,4999.98,-63.7208], Tmin=(952.92,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(80.4276,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(586.17,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Oxetane) + radical(C2CsJOH) + radical(CC(C)OJ)"""),
)
...
species(
    label = '[CH2]C1(CC)OC[C]1O(5490)',
    structure = SMILES('[CH2]C1(CC)OC[C]1O'),
    E0 = (16.3807,'kJ/mol'),
    modes = [
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.158788,0.0893733,-8.14897e-05,2.83496e-08,2.28045e-12,2122.31,28.109], Tmin=(100,'K'), Tmax=(791.713,'K')), NASAPolynomial(coeffs=[16.1341,0.028797,-7.91112e-06,1.07724e-09,-6.02384e-14,-1138.92,-50.9927], Tmin=(791.713,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(16.3807,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(415.724,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Oxetane) + radical(C2CsJOH) + radical(CJC(C)OC)"""),
)

species(
    label = 'CCC1(CC2[CH]C2)OC[C]1O(23156)',
    structure = SMILES('CCC1(CC2[CH]C2)OC[C]1O'),
    E0 = (113.998,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (154.206,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.26848,0.102037,-5.00923e-05,-1.2988e-08,1.50596e-11,13913.1,40.6749], Tmin=(100,'K'), Tmax=(927.086,'K')), NASAPolynomial(coeffs=[20.2461,0.0445391,-1.42228e-05,2.32263e-09,-1.53396e-13,8405.72,-69.6799], Tmin=(927.086,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(113.998,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(586.17,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Oxetane) + ring(Cyclopropane) + radical(cyclopropane) + radical(C2CsJOH)"""),
)

species(
    label = '[CH2]C1[CH]CC2(CC)OCC12O(23157)',
    structure = SMILES('[CH2]C1[CH]CC2(CC)OCC12O'),
    E0 = (31.9485,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (154.206,'amu'),
...
species(
    label = '[CH2]C=CCC(CC)=C(O)C[O](23158)',
    structure = SMILES('[CH2]C=CCC(CC)=C(O)C[O]'),
    E0 = (-35.492,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (154.206,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.54783,0.116852,-9.88938e-05,4.4376e-08,-8.15649e-12,-4064.85,44.9721], Tmin=(100,'K'), Tmax=(1284.38,'K')), NASAPolynomial(coeffs=[19.9327,0.0499537,-2.07645e-05,3.82221e-09,-2.62807e-13,-9582.66,-64.0351], Tmin=(1284.38,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-35.492,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(577.856,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(CCOJ) + radical(Allyl_P)"""),
)

species(
    label = 'C=C=CCC1(CC)OCC1O(23159)',
    structure = SMILES('C=C=CCC1(CC)OCC1O'),
    E0 = (-149.957,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (154.206,'amu'),
...
species(
    label = 'CC=CCC1(CC)OCC1=O(23160)',
    structure = SMILES('CC=CCC1(CC)OCC1=O'),
    E0 = (-238.058,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (154.206,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.45896,0.102651,-5.25261e-05,-3.29822e-09,7.81799e-12,-28420.4,39.1485], Tmin=(100,'K'), Tmax=(1071.71,'K')), NASAPolynomial(coeffs=[22.0745,0.0467023,-1.88482e-05,3.51414e-09,-2.47236e-13,-35295.8,-84.5597], Tmin=(1071.71,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-238.058,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(586.17,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-O2d)CsCsOs) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-O2d)OsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-OdCsCs) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cyclobutane)"""),
)

species(
    label = 'CC=CCC1(CC)OC=C1O(23161)',
    structure = SMILES('CC=CCC1(CC)OC=C1O'),
    E0 = (-280.46,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (154.206,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.05937,0.100929,1.75341e-07,-9.64441e-08,5.11401e-11,-33483.6,39.1243], Tmin=(100,'K'), Tmax=(933.908,'K')), NASAPolynomial(coeffs=[35.7581,0.0211404,-3.67725e-06,5.37002e-10,-4.59293e-14,-44131.3,-159.926], Tmin=(933.908,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-280.46,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(582.013,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + ring(Cyclobutene)"""),
)
...
species(
    label = '[CH2]C=CCC1(C)OC[C]1O(23162)',
    structure = SMILES('[CH2]C=CCC1(C)OC[C]1O'),
    E0 = (25.3463,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,2750,3150,900,1100,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,300,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.80674,0.108938,-9.87714e-05,4.79856e-08,-9.11797e-12,3273.49,39.0593], Tmin=(100,'K'), Tmax=(1410.88,'K')), NASAPolynomial(coeffs=[21.9966,0.0329073,-8.85173e-06,1.20357e-09,-6.77005e-14,-2592.65,-80.9571], Tmin=(1410.88,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(25.3463,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(511.34,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Oxetane) + radical(Allyl_P) + radical(C2CsJOH)"""),
)

species(
    label = '[CH2]C=CC[C]1OCC1(O)CC(23163)',
    structure = SMILES('[CH2]C=CC[C]1OCC1(O)CC'),
    E0 = (5.64199,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,2750,3150,900,1100,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3100,440,815,1455,1000,300,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH]=CCC1(CC)OC[C]1O(23164)',
    structure = SMILES('[CH]=CCC1(CC)OC[C]1O'),
    E0 = (133.189,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,2750,3150,900,1100,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,300,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (140.18,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.11169,0.105101,-8.55491e-05,2.71249e-08,1.25123e-12,16209.9,37.1278], Tmin=(100,'K'), Tmax=(887.3,'K')), NASAPolynomial(coeffs=[19.0878,0.0377623,-1.18123e-05,1.85302e-09,-1.17537e-13,11691.5,-63.1695], Tmin=(887.3,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(133.189,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(511.34,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Oxetane) + radical(C2CsJOH) + radical(Cds_P)"""),
)

species(
    label = 'C=CC=CC1(CC)OC[C]1O(23165)',
    structure = SMILES('C=CC=CC1(CC)OC[C]1O'),
    E0 = (-45.748,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3010,3025,975,987.5,1000,1300,1337.5,1375,400,450,500,1630,1655,1680,2950,3100,1380,975,1025,1650,2750,3150,900,1100,2750,2850,1437.5,1250,1305,750,350,300,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (153.198,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.8369,0.121338,-0.000109123,5.12839e-08,-9.24325e-12,-5231.2,44.7424], Tmin=(100,'K'), Tmax=(1550.14,'K')), NASAPolynomial(coeffs=[25.783,0.0316629,-7.03625e-06,7.9437e-10,-3.84612e-14,-12203,-99.7452], Tmin=(1550.14,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-45.748,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(561.227,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + ring(Oxetane) + radical(C2CsJOH)"""),
)
...
species(
    label = 'C=[C]CCC1(CC)OC[C]1O(23167)',
    structure = SMILES('C=[C]CCC1(CC)OC[C]1O'),
    E0 = (100.154,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1277.5,1000,2950,3100,1380,975,1025,1650,2750,3150,900,1100,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,300,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (154.206,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.01947,0.124656,-0.000121093,6.56676e-08,-1.43478e-11,12269.1,42.6929], Tmin=(100,'K'), Tmax=(1112.06,'K')), NASAPolynomial(coeffs=[19.6727,0.0466303,-1.58482e-05,2.57433e-09,-1.63822e-13,7444.49,-64.263], Tmin=(1112.06,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(100.154,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(582.013,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Oxetane) + radical(Cds_S) + radical(C2CsJOH)"""),
)

species(
    label = '[CH]=CCCC1(CC)OC[C]1O(23168)',
    structure = SMILES('[CH]=CCCC1(CC)OC[C]1O'),
    E0 = (109.408,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (154.206,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.87336,0.121312,-0.000104762,4.27831e-08,-4.45486e-12,13377.5,42.1027], Tmin=(100,'K'), Tmax=(921.588,'K')), NASAPolynomial(coeffs=[20.3688,0.0455482,-1.52594e-05,2.49758e-09,-1.61828e-13,8395.62,-68.1731], Tmin=(921.588,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(109.408,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(582.013,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Oxetane) + radical(C2CsJOH) + radical(Cds_P)"""),
)

species(
    label = 'C=CCCC1([CH]C)OC[C]1O(23169)',
    structure = SMILES('C=CCCC1([CH]C)OC[C]1O'),
    E0 = (62.2142,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,2750,3150,900,1100,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,300,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (154.206,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.29074,0.120624,-0.000107445,5.19178e-08,-9.95112e-12,7724.16,45.6953], Tmin=(100,'K'), Tmax=(1343.98,'K')), NASAPolynomial(coeffs=[23.0647,0.040129,-1.19887e-05,1.78228e-09,-1.06992e-13,1363.16,-82.4353], Tmin=(1343.98,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(62.2142,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(582.013,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Oxetane) + radical(C2CsJOH) + radical(CCJCO)"""),
)

species(
    label = 'C=CCCC1(CC)O[CH][C]1O(23170)',
    structure = SMILES('C=CCCC1(CC)O[CH][C]1O'),
    E0 = (42.7682,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3010,987.5,1337.5,450,1655,3615,1277.5,1000,2950,3100,1380,975,1025,1650,2750,2800,2850,1350,1500,750,1050,1375,1000,2950,1000,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,300,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (154.206,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.63762,0.131216,-0.000130043,6.91209e-08,-1.44304e-11,5395.39,43.8819], Tmin=(100,'K'), Tmax=(1238.35,'K')), NASAPolynomial(coeffs=[24.4269,0.0384264,-1.11444e-05,1.61112e-09,-9.46664e-14,-896.044,-90.8127], Tmin=(1238.35,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(42.7682,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(582.013,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Oxetane) + radical(CCsJOCs) + radical(C2CsJOH)"""),
)

species(
    label = '[CH2]CC1(CCC=C)OC[C]1O(23171)',
    structure = SMILES('[CH2]CC1(CCC=C)OC[C]1O'),
    E0 = (67.5585,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3010,987.5,1337.5,450,1655,3615,1277.5,1000,2950,3100,1380,975,1025,1650,2750,3150,900,1100,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3000,3100,440,815,1455,1000,300,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (154.206,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.77103,0.118634,-9.89877e-05,3.82809e-08,-3.27661e-12,8340.75,43.1182], Tmin=(100,'K'), Tmax=(928.987,'K')), NASAPolynomial(coeffs=[19.9229,0.0460836,-1.55222e-05,2.55291e-09,-1.66007e-13,3410.02,-64.7888], Tmin=(928.987,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(67.5585,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(582.013,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Oxetane) + radical(RCCJ) + radical(C2CsJOH)"""),
)

species(
    label = 'C=CCCC1(CC)OC[C]1[O](23172)',
    structure = SMILES('C=CCCC1(CC)OC[C]1[O]'),
    E0 = (92.6729,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2950,3100,1380,975,1025,1650,3010,987.5,1337.5,450,1655,2750,2800,2850,1350,1500,750,1050,1375,1000,2750,3150,900,1100,300,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (154.206,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.22002,0.120631,-0.000105878,5.07114e-08,-9.71682e-12,11383.6,42.7533], Tmin=(100,'K'), Tmax=(1300.49,'K')), NASAPolynomial(coeffs=[22.4545,0.0426229,-1.3462e-05,2.08549e-09,-1.28741e-13,5144.7,-82.082], Tmin=(1300.49,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(92.6729,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(586.17,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Oxetane) + radical(CC(C)OJ) + radical(C2CsJOH)"""),
)

species(
    label = '[CH]=C[CH]CC1(CC)OCC1O(23173)',
    structure = SMILES('[CH]C=CCC1(CC)OCC1O'),
    E0 = (44.1234,'kJ/mol'),
    modes = [
...
species(
    label = 'C=CC=CC1(CC)OCC1O(23175)',
    structure = SMILES('C=CC=CC1(CC)OCC1O'),
    E0 = (-222.376,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (154.206,'amu'),
...
species(
    label = 'C=CCCC1(CC)OCC1=O(23176)',
    structure = SMILES('C=CCCC1(CC)OCC1=O'),
    E0 = (-225.813,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (154.206,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.49256,0.1023,-4.75842e-05,-1.09793e-08,1.10969e-11,-26945.3,39.7058], Tmin=(100,'K'), Tmax=(1047.07,'K')), NASAPolynomial(coeffs=[22.8911,0.0454516,-1.81505e-05,3.39173e-09,-2.4006e-13,-34041.6,-88.5553], Tmin=(1047.07,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-225.813,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(586.17,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-O2d)CsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-O2d)OsHH) + group(Cs-CsHHH) + group(Cds-OdCsCs) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Cyclobutane)"""),
)

species(
    label = 'C=CCCC1(CC)OC=C1O(23177)',
    structure = SMILES('C=CCCC1(CC)OC=C1O'),
    E0 = (-268.214,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (154.206,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.11363,0.100787,4.56812e-06,-1.03715e-07,5.43918e-11,-32007.6,39.7578], Tmin=(100,'K'), Tmax=(932.129,'K')), NASAPolynomial(coeffs=[36.8641,0.0194183,-2.71604e-06,3.53767e-10,-3.37954e-14,-43005.6,-165.564], Tmin=(932.129,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-268.214,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(582.013,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + ring(Cyclobutene)"""),
)
...
species(
    label = 'C=CC1CC2(CC)OCC12O(22598)',
    structure = SMILES('C=CC1CC2(CC)OCC12O'),
    E0 = (-156.249,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (154.206,'amu'),
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C=CCC1(CC)OC[C]1O(20191)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]C=CCC1(CC)OC[C]1O(20191)'],
    products = ['[CH2][CH]C1CC2(CC)OCC12O(23137)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(102000,'s^-1'), n=1.8, Ea=(113.122,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2500,'K'), comment="""Estimated using an average for rate rule [R5_SS_D;doublebond_intra;radadd_intra_csNdNd]
Euclidian distance = 0
family: Intra_R_Add_Exocyclic
Ea raised from 111.5 to 113.1 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction3',
    reactants = ['H(3)', '[CH2]C=CCC1(CC)OCC1=O(23138)'],
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', '[CH2]C=CCC1(CC)OC=C1O(23139)'],
    products = ['[CH2]C=CCC1(CC)OC[C]1O(20191)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)', 'C=C=CCC1(CC)OC[C]1O(23140)'],
    products = ['[CH2]C=CCC1(CC)OC[C]1O(20191)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['C2H5(29)', '[CH2]C=CCC1OCC=1O(23141)'],
    products = ['[CH2]C=CCC1(CC)OC[C]1O(20191)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]C=CCC1(CC)OCC1[O](23142)'],
    products = ['[CH2]C=CCC1(CC)OC[C]1O(20191)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]C=CCC1(CC)O[CH]C1O(23143)'],
    products = ['[CH2]C=CCC1(CC)OC[C]1O(20191)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]C=CCC1(CC)OC[C]1O(20191)'],
    products = ['C[C]=CCC1(CC)OC[C]1O(23144)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]C=CCC1([CH]C)OCC1O(23145)'],
    products = ['[CH2]C=CCC1(CC)OC[C]1O(20191)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]C=CCC1(CC)OC[C]1O(20191)'],
    products = ['[CH2]C=C[CH]C1(CC)OCC1O(23146)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CC=[C]CC1(CC)OC[C]1O(23147)'],
    products = ['[CH2]C=CCC1(CC)OC[C]1O(20191)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]C=CCC1(C[CH2])OCC1O(23148)'],
    products = ['[CH2]C=CCC1(CC)OC[C]1O(20191)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]C=[C]CC1(CC)OCC1O(23149)'],
    products = ['[CH2]C=CCC1(CC)OC[C]1O(20191)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]C=CCC1(CC)OC[C]1O(20191)'],
    products = ['CC=C[CH]C1(CC)OC[C]1O(23150)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2][C]=CCC1(CC)OCC1O(23151)'],
    products = ['[CH2]C=CCC1(CC)OC[C]1O(20191)'],
...
reaction(
    label = 'reaction18',
    reactants = ['C[CH]C1(CC=CC)OC[C]1O(23152)'],
    products = ['[CH2]C=CCC1(CC)OC[C]1O(20191)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CC=CCC1(CC)O[CH][C]1O(23153)'],
    products = ['[CH2]C=CCC1(CC)OC[C]1O(20191)'],
    transitionState = 'TS19',
    kinetics = Arrhenius(A=(40383.2,'s^-1'), n=1.705, Ea=(72.9062,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [R7H_OOCs4;Y_rad_out;Cs_H_out_2H]
Euclidian distance = 0
Multiplied by reaction path degeneracy 3.0
family: intra_H_migration"""),
)
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2]CC1(CC=CC)OC[C]1O(23154)'],
    products = ['[CH2]C=CCC1(CC)OC[C]1O(20191)'],
...
reaction(
    label = 'reaction21',
    reactants = ['CC=CCC1(CC)OC[C]1[O](23155)'],
    products = ['[CH2]C=CCC1(CC)OC[C]1O(20191)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH]=C[CH2](2461)', '[CH2]C1(CC)OC[C]1O(5490)'],
    products = ['[CH2]C=CCC1(CC)OC[C]1O(20191)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[CH2]C=CCC1(CC)OC[C]1O(20191)'],
    products = ['CCC1(CC2[CH]C2)OC[C]1O(23156)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[CH2]C=CCC1(CC)OC[C]1O(20191)'],
    products = ['[CH2]C1[CH]CC2(CC)OCC12O(23157)'],
...
reaction(
    label = 'reaction27',
    reactants = ['[CH2]C=CCC(CC)=C(O)C[O](23158)'],
    products = ['[CH2]C=CCC1(CC)OC[C]1O(20191)'],
...
reaction(
    label = 'reaction28',
    reactants = ['[CH2]C=CCC1(CC)OC[C]1O(20191)'],
    products = ['C=C=CCC1(CC)OCC1O(23159)'],
...
reaction(
    label = 'reaction29',
    reactants = ['[CH2]C=CCC1(CC)OC[C]1O(20191)'],
    products = ['CC=CCC1(CC)OCC1=O(23160)'],
...
reaction(
    label = 'reaction30',
    reactants = ['[CH2]C=CCC1(CC)OC[C]1O(20191)'],
    products = ['CC=CCC1(CC)OC=C1O(23161)'],
...
reaction(
    label = 'reaction31',
    reactants = ['CH2(S)(23)', '[CH2]C=CCC1(C)OC[C]1O(23162)'],
    products = ['[CH2]C=CCC1(CC)OC[C]1O(20191)'],
...
reaction(
    label = 'reaction32',
    reactants = ['[CH2]C=CC[C]1OCC1(O)CC(23163)'],
    products = ['[CH2]C=CCC1(CC)OC[C]1O(20191)'],
...
reaction(
    label = 'reaction35',
    reactants = ['CH2(19)', '[CH]=CCC1(CC)OC[C]1O(23164)'],
    products = ['[CH2]C=CCC1(CC)OC[C]1O(20191)'],
...
reaction(
    label = 'reaction36',
    reactants = ['H(3)', 'C=CC=CC1(CC)OC[C]1O(23165)'],
    products = ['[CH2]C=CCC1(CC)OC[C]1O(20191)'],
...
reaction(
    label = 'reaction39',
    reactants = ['C=[C]CCC1(CC)OC[C]1O(23167)'],
    products = ['[CH2]C=CCC1(CC)OC[C]1O(20191)'],
...
reaction(
    label = 'reaction40',
    reactants = ['[CH2]C=CCC1(CC)OC[C]1O(20191)'],
    products = ['[CH]=CCCC1(CC)OC[C]1O(23168)'],
...
reaction(
    label = 'reaction41',
    reactants = ['C=CCCC1([CH]C)OC[C]1O(23169)'],
    products = ['[CH2]C=CCC1(CC)OC[C]1O(20191)'],
...
reaction(
    label = 'reaction42',
    reactants = ['C=CCCC1(CC)O[CH][C]1O(23170)'],
    products = ['[CH2]C=CCC1(CC)OC[C]1O(20191)'],
    transitionState = 'TS42',
    kinetics = Arrhenius(A=(8.18646e+06,'s^-1'), n=1.2825, Ea=(60.0195,'kJ/mol'), T0=(1,'K'), comment="""Estimated using average of templates [R5H_SSSS;Y_rad_out;Cs_H_out_H/Cd] + [R5H_SSSS_OCC_C;Y_rad_out;Cs_H_out_1H] for rate rule [R5H_SSSS_OCC_C;Y_rad_out;Cs_H_out_H/Cd]
Euclidian distance = 2.0
Multiplied by reaction path degeneracy 2.0
family: intra_H_migration"""),
)
...
reaction(
    label = 'reaction43',
    reactants = ['[CH2]CC1(CCC=C)OC[C]1O(23171)'],
    products = ['[CH2]C=CCC1(CC)OC[C]1O(20191)'],
...
reaction(
    label = 'reaction44',
    reactants = ['C=CCCC1(CC)OC[C]1[O](23172)'],
    products = ['[CH2]C=CCC1(CC)OC[C]1O(20191)'],
...
reaction(
    label = 'reaction45',
    reactants = ['[CH]=C[CH]CC1(CC)OCC1O(23173)'],
    products = ['[CH2]C=CCC1(CC)OC[C]1O(20191)'],
...
reaction(
    label = 'reaction47',
    reactants = ['[CH2]C=CCC1(CC)OC[C]1O(20191)'],
    products = ['C=CC=CC1(CC)OCC1O(23175)'],
...
reaction(
    label = 'reaction48',
    reactants = ['[CH2]C=CCC1(CC)OC[C]1O(20191)'],
    products = ['C=CCCC1(CC)OCC1=O(23176)'],
...
reaction(
    label = 'reaction49',
    reactants = ['[CH2]C=CCC1(CC)OC[C]1O(20191)'],
    products = ['C=CCCC1(CC)OC=C1O(23177)'],
...
reaction(
    label = 'reaction51',
    reactants = ['[CH2]C=CCC1(CC)OC[C]1O(20191)'],
    products = ['C=CC1CC2(CC)OCC12O(22598)'],
