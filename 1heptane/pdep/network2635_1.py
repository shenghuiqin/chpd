species(
    label = 'CC([O])(C[CH]O)OO(13281)',
    structure = SMILES('CC([O])(C[CH]O)OO'),
    E0 = (-204.976,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,3615,1310,387.5,850,1000,3615,1277.5,1000,200,800,933.333,1066.67,1200,1333.33,1466.67,1600],'cm^-1')),
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.300873,0.0981109,-0.000120568,7.78556e-08,-2.00985e-11,-24501,31.5246], Tmin=(100,'K'), Tmax=(943.587,'K')), NASAPolynomial(coeffs=[15.4814,0.0312079,-1.42141e-05,2.71468e-09,-1.90308e-13,-27479.4,-43.6995], Tmin=(943.587,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-204.976,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CC(C)(O)OJ) + radical(CCsJOH)"""),
)
...
species(
    label = 'CC([O])(CC=O)OO(17273)',
    structure = SMILES('CC([O])(CC=O)OO'),
    E0 = (-308.246,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2782.5,750,1395,475,1775,1000,3615,1310,387.5,850,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'CC([O])(C=CO)OO(17274)',
    structure = SMILES('CC([O])(C=CO)OO'),
    E0 = (-306.535,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,3615,1310,387.5,850,1000,3615,1277.5,1000,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'O=C(C[CH]O)OO(17275)',
    structure = SMILES('O=C(C[CH]O)OO'),
    E0 = (-450.7,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3025,407.5,1350,352.5,3615,1310,387.5,850,1000,3615,1277.5,1000,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'CC(=O)C[CH]O(4855)',
    structure = SMILES('CC(=O)C[CH]O'),
    E0 = (-237.724,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,375,552.5,462.5,1710,3025,407.5,1350,352.5,3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,334.591,2524.32],'cm^-1')),
        HinderedRotor(inertia=(0.107816,'amu*angstrom^2'), symmetry=1, barrier=(8.57139,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.10795,'amu*angstrom^2'), symmetry=1, barrier=(8.56786,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.107654,'amu*angstrom^2'), symmetry=1, barrier=(8.57107,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.107928,'amu*angstrom^2'), symmetry=1, barrier=(8.56551,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
species(
    label = 'CC([O])(CC[O])OO(17276)',
    structure = SMILES('CC([O])(CC[O])OO'),
    E0 = (-159.569,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3615,1310,387.5,850,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,914.286,1028.57,1142.86,1257.14,1371.43,1485.71,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (120.104,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.397089,0.0857,-9.77624e-05,6.46884e-08,-1.80824e-11,-19067.6,30.3403], Tmin=(100,'K'), Tmax=(853.482,'K')), NASAPolynomial(coeffs=[9.84483,0.0414214,-1.99423e-05,3.90192e-09,-2.7697e-13,-20680.2,-13.7427], Tmin=(853.482,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-159.569,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(CC(C)(O)OJ)"""),
)

species(
    label = 'CC([O])([CH]CO)OO(17277)',
    structure = SMILES('CC([O])([CH]CO)OO'),
    E0 = (-184.859,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,3615,1310,387.5,850,1000,3615,1277.5,1000,200,800,933.333,1066.67,1200,1333.33,1466.67,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (120.104,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.00247308,0.0912982,-0.000104944,6.43296e-08,-1.59523e-11,-22092.2,33.1915], Tmin=(100,'K'), Tmax=(975.188,'K')), NASAPolynomial(coeffs=[14.245,0.0328788,-1.50856e-05,2.90023e-09,-2.04363e-13,-24870.1,-35.1629], Tmin=(975.188,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-184.859,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CC(C)(O)OJ) + radical(CCJCOOH)"""),
)

species(
    label = 'CC(O)([CH][CH]O)OO(17278)',
    ...
    molecularWeight = (120.104,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.23485,0.10705,-0.000124636,6.61848e-08,-1.22983e-11,-28254.7,35.8982], Tmin=(100,'K'), Tmax=(955.732,'K')), NASAPolynomial(coeffs=[25.3425,0.0129226,-3.7533e-06,5.91762e-10,-3.93739e-14,-34116.2,-95.2063], Tmin=(955.732,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-236.551,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(353.365,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCsJOH) + radical(CCJCOOH)"""),
)

species(
    label = '[CH2]C(O)(C[CH]O)OO(17279)',
    ...
    molecularWeight = (120.104,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.66506,0.111775,-0.000136086,7.81137e-08,-1.69017e-11,-26606.1,37.1298], Tmin=(100,'K'), Tmax=(1212.05,'K')), NASAPolynomial(coeffs=[27.8846,0.00853895,-1.25014e-06,5.8629e-11,6.74584e-16,-33349.4,-109.381], Tmin=(1212.05,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-223.004,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(353.365,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCsJOH) + radical(CJCOOH)"""),
)

species(
    label = 'CC(O)(C[CH]O)O[O](17280)',
    ...
    molecularWeight = (120.104,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.28093,0.104834,-0.000125527,7.22755e-08,-1.57629e-11,-34073,34.514], Tmin=(100,'K'), Tmax=(1201.22,'K')), NASAPolynomial(coeffs=[25.2154,0.0113546,-2.24295e-06,2.16695e-10,-8.89944e-15,-40060,-96.5971], Tmin=(1201.22,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-284.961,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(CCsJOH)"""),
)

species(
    label = '[CH2]C([O])(CCO)OO(17281)',
    structure = SMILES('[CH2]C([O])(CCO)OO'),
    E0 = (-171.311,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3615,1310,387.5,850,1000,3000,3100,440,815,1455,1000,3615,1277.5,1000,200,800,933.333,1066.67,1200,1333.33,1466.67,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (120.104,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.160157,0.0929033,-0.000105654,6.2565e-08,-1.481e-11,-20455.2,33.461], Tmin=(100,'K'), Tmax=(1025.69,'K')), NASAPolynomial(coeffs=[16.0353,0.0297449,-1.32906e-05,2.53208e-09,-1.77851e-13,-23777.6,-45.0835], Tmin=(1025.69,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-171.311,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CC(C)(O)OJ) + radical(CJCOOH)"""),
)

species(
    label = 'CC([O])(CCO)O[O](17282)',
    structure = SMILES('CC([O])(CCO)O[O]'),
    E0 = (-233.269,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,492.5,1135,1000,3615,1277.5,1000,180,180,180,180,1600,1619.6,2889.33,3200],'cm^-1')),
        HinderedRotor(inertia=(0.150185,'amu*angstrom^2'), symmetry=1, barrier=(3.45304,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.150185,'amu*angstrom^2'), symmetry=1, barrier=(3.45304,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.150185,'amu*angstrom^2'), symmetry=1, barrier=(3.45304,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.150185,'amu*angstrom^2'), symmetry=1, barrier=(3.45304,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.150185,'amu*angstrom^2'), symmetry=1, barrier=(3.45304,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (120.104,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.177251,0.0864823,-9.67733e-05,5.87269e-08,-1.44579e-11,-27920.1,31.0148], Tmin=(100,'K'), Tmax=(981.818,'K')), NASAPolynomial(coeffs=[13.4399,0.0324505,-1.42266e-05,2.67794e-09,-1.86489e-13,-30524.5,-32.7268], Tmin=(981.818,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-233.269,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CC(C)(O)OJ) + radical(ROOJ)"""),
)

species(
    label = 'CC(O)(C[CH][O])OO(17283)',
    structure = SMILES('CC(O)(C[CH][O])OO'),
    E0 = (-211.261,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (120.104,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.841487,0.101568,-0.000118274,6.80301e-08,-1.51721e-11,-25230.2,33.0444], Tmin=(100,'K'), Tmax=(1104.6,'K')), NASAPolynomial(coeffs=[21.5997,0.020303,-7.91975e-06,1.42678e-09,-9.79213e-14,-30187.9,-77.4537], Tmin=(1104.6,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-211.261,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCsJOH) + radical(CCOJ)"""),
)

species(
    label = 'CC(O)(C=CO)OO(17284)',
    structure = SMILES('CC(O)(C=CO)OO'),
    E0 = (-539.582,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (120.104,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-3.12574,0.111978,-0.000121897,5.9607e-08,-1.04922e-11,-64601.4,37.8361], Tmin=(100,'K'), Tmax=(1688.03,'K')), NASAPolynomial(coeffs=[31.9052,-0.00116857,5.42586e-06,-1.25376e-09,8.77974e-14,-72134.5,-136.791], Tmin=(1688.03,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-539.582,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(O2s-OsH) + group(Cs-CsCsOsOs) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH)"""),
)

species(
    label = 'CC(O)(CC=O)OO(17285)',
    structure = SMILES('CC(O)(CC=O)OO'),
    E0 = (-540.236,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (120.104,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.569198,0.0886539,-7.77921e-05,2.40418e-08,7.40499e-13,-64800.3,30.9837], Tmin=(100,'K'), Tmax=(977.575,'K')), NASAPolynomial(coeffs=[23.1942,0.0164861,-5.51884e-06,9.83618e-10,-7.04731e-14,-70644.1,-89.2478], Tmin=(977.575,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-540.236,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsOs) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsH)"""),
)
...
species(
    label = '[O]C(C[CH]O)OO(17286)',
    structure = SMILES('[O]C(C[CH]O)OO'),
    E0 = (-162.902,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,1380,1390,370,380,2900,435,3025,407.5,1350,352.5,3615,1310,387.5,850,1000,3615,1277.5,1000,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.456961,0.0885685,-0.000150494,1.38982e-07,-4.96518e-11,-19475.2,29.8124], Tmin=(100,'K'), Tmax=(838.675,'K')), NASAPolynomial(coeffs=[7.042,0.0358659,-1.81458e-05,3.50149e-09,-2.41421e-13,-19830.8,3.66688], Tmin=(838.675,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-162.902,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(286.849,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + radical(CCOJ) + radical(CCsJOH)"""),
)
...
species(
    label = 'CC1(C[CH]O)OO1(17287)',
    structure = SMILES('CC1(C[CH]O)OO1'),
    E0 = (-114.26,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (103.097,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.170299,0.0615877,3.07385e-06,-7.75054e-08,4.35883e-11,-13583,25.3424], Tmin=(100,'K'), Tmax=(891.3,'K')), NASAPolynomial(coeffs=[28.7991,-0.00399351,7.58625e-06,-1.70301e-09,1.18124e-13,-21184.8,-123.496], Tmin=(891.3,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-114.26,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(dioxirane) + radical(CCsJOH)"""),
)

species(
    label = 'CC1([O])CC(O)O1(17288)',
    structure = SMILES('CC1([O])CC(O)O1'),
    E0 = (-313.15,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (103.097,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.35114,0.0425332,2.34109e-05,-7.21509e-08,3.51995e-11,-37553.1,22.446], Tmin=(100,'K'), Tmax=(893.422,'K')), NASAPolynomial(coeffs=[17.1883,0.0144519,-1.34189e-06,-2.94048e-11,5.47058e-15,-42092.1,-61.7396], Tmin=(893.422,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-313.15,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(324.264,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + ring(Oxetane) + radical(CC(C)(O)OJ)"""),
)
...
species(
    label = 'CC([O])([O])CC(O)O(17289)',
    structure = SMILES('CC([O])([O])CC(O)O'),
    E0 = (-425.02,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (120.104,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.394464,0.0872026,-0.000123033,1.07483e-07,-3.87462e-11,-50995.8,31.7457], Tmin=(100,'K'), Tmax=(781.124,'K')), NASAPolynomial(coeffs=[6.65956,0.0448152,-2.18479e-05,4.23519e-09,-2.962e-13,-51660.2,5.08019], Tmin=(781.124,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-425.02,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + radical(CC(C)(O)OJ) + radical(CC(C)(O)OJ)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['CC([O])(C[CH]O)OO(13281)'],
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'CC([O])(CC=O)OO(17273)'],
    products = ['CC([O])(C[CH]O)OO(13281)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'CC([O])(C=CO)OO(17274)'],
    products = ['CC([O])(C[CH]O)OO(13281)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['CH3(17)', 'O=C(C[CH]O)OO(17275)'],
    products = ['CC([O])(C[CH]O)OO(13281)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(3.16e+10,'cm^3/(mol*s)'), n=0, Ea=(109.537,'kJ/mol'), T0=(1,'K'), Tmin=(413,'K'), Tmax=(563,'K'), comment="""Estimated using an average for rate rule [CO-NdNd_O;CsJ-HHH]
Euclidian distance = 0
family: R_Addition_MultipleBond
Ea raised from 104.7 to 109.5 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction6',
    reactants = ['CH2CHOH(42)', 'C[C]([O])OO(5646)'],
    products = ['CC([O])(C[CH]O)OO(13281)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['HO2(10)', 'CC(=O)C[CH]O(4855)'],
    products = ['CC([O])(C[CH]O)OO(13281)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction10',
    reactants = ['CC([O])(C[CH]O)OO(13281)'],
    products = ['CC(O)([CH][CH]O)OO(17278)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CC([O])(C[CH]O)OO(13281)'],
    products = ['[CH2]C(O)(C[CH]O)OO(17279)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CC([O])(C[CH]O)OO(13281)'],
    products = ['CC(O)(C[CH]O)O[O](17280)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2]C([O])(CCO)OO(17281)'],
    products = ['CC([O])(C[CH]O)OO(13281)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CH2(S)(23)', '[O]C(C[CH]O)OO(17286)'],
    products = ['CC([O])(C[CH]O)OO(13281)'],
...
reaction(
    label = 'reaction20',
    reactants = ['CC([O])(C[CH]O)OO(13281)'],
    products = ['OH(5)', 'CC1(C[CH]O)OO1(17287)'],
...
reaction(
    label = 'reaction21',
    reactants = ['CC([O])(C[CH]O)OO(13281)'],
    products = ['OH(5)', 'CC1([O])CC(O)O1(17288)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH2]C(O)C(C)([O])OO(10508)'],
    products = ['CC([O])(C[CH]O)OO(13281)'],
...
reaction(
    label = 'reaction25',
    reactants = ['O(4)', 'C[C](C[CH]O)OO(2185)'],
    products = ['CC([O])(C[CH]O)OO(13281)'],
...
reaction(
    label = 'reaction26',
    reactants = ['HCOH(T)(285)', '[CH2]C(C)([O])OO(5691)'],
    products = ['CC([O])(C[CH]O)OO(13281)'],
