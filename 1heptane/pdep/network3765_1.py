species(
    label = '[O]C(CCC=O)O[CH]O(21353)',
    structure = SMILES('[O]C(CCC=O)O[CH]O'),
    E0 = (-343.707,'kJ/mol'),
    modes = [
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.427913,0.109238,-0.000175098,1.5884e-07,-5.67057e-11,-41190.5,37.2878], Tmin=(100,'K'), Tmax=(826.11,'K')), NASAPolynomial(coeffs=[7.76545,0.0476912,-2.3628e-05,4.55217e-09,-3.14847e-13,-41797.8,3.8423], Tmin=(826.11,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-343.707,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-OsOsHH) + group(Cds-OdCsH) + radical(OCJO) + radical(CCOJ)"""),
)
...
species(
    label = '[O]C1CCC(O[CH]O)O1(22257)',
    structure = SMILES('[O]C1CCC(O[CH]O)O1'),
    E0 = (-355.57,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (132.115,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.312005,0.0737256,-5.19418e-05,1.35299e-08,1.09279e-12,-42625.8,30.2766], Tmin=(100,'K'), Tmax=(970.987,'K')), NASAPolynomial(coeffs=[14.22,0.0318698,-1.11322e-05,1.88562e-09,-1.25236e-13,-46054.5,-40.1598], Tmin=(970.987,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-355.57,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(394.937,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsOsH) + group(Cs-OsOsHH) + ring(Tetrahydrofuran) + radical(CCOJ) + radical(OCJO)"""),
)
...
species(
    label = '[O]C(CCC=O)OC=O(22259)',
    structure = SMILES('[O]C(CCC=O)OC=O'),
    E0 = (-512.504,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,1380,1390,370,380,2900,435,2695,2870,700,800,1380,1410,450,500,1750,1800,900,1100,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.825216,0.0774126,-9.64361e-05,8.7174e-08,-3.48939e-11,-61532.9,33.461], Tmin=(100,'K'), Tmax=(717.134,'K')), NASAPolynomial(coeffs=[3.61848,0.0529991,-2.68951e-05,5.35089e-09,-3.81765e-13,-61706.4,22.4975], Tmin=(717.134,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-512.504,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-(Cds-O2d)CsHH) + group(Cds-OdCsH) + group(Cds-OdOsH) + radical(CCOJ)"""),
)

species(
    label = 'O=CCCC(=O)O[CH]O(22260)',
    structure = SMILES('O=CCCC(=O)O[CH]O'),
    E0 = (-560.933,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3025,407.5,1350,352.5,3615,1277.5,1000,2782.5,750,1395,475,1775,1000,200,800,914.286,1028.57,1142.86,1257.14,1371.43,1485.71,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (131.107,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0337512,0.0952406,-0.000137755,1.17688e-07,-4.09263e-11,-67329.5,33.5509], Tmin=(100,'K'), Tmax=(795.911,'K')), NASAPolynomial(coeffs=[8.42263,0.0431258,-2.07762e-05,3.98984e-09,-2.77053e-13,-68349.6,-3.0249], Tmin=(795.911,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-560.933,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-OsOsHH) + group(Cds-OdCsOs) + group(Cds-OdCsH) + radical(OCJO)"""),
)
...
species(
    label = '[O]COC([O])CCC=O(22261)',
    structure = SMILES('[O]COC([O])CCC=O'),
    E0 = (-305.27,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,1380,1390,370,380,2900,435,2782.5,750,1395,475,1775,1000,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (132.115,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.24953,0.0732138,-3.16395e-05,-7.87619e-08,9.53712e-11,-36629.5,32.1726], Tmin=(100,'K'), Tmax=(458.773,'K')), NASAPolynomial(coeffs=[5.86286,0.0522915,-2.63378e-05,5.23659e-09,-3.74104e-13,-37255.9,11.297], Tmin=(458.773,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-305.27,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-OsOsHH) + group(Cds-OdCsH) + radical(CCOJ) + radical(OCOJ)"""),
)

species(
    label = 'O=CCC[C](O)O[CH]O(22262)',
    structure = SMILES('O=CCC[C](O)O[CH]O'),
    E0 = (-364.166,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (132.115,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.719091,0.112274,-0.000171456,1.4324e-07,-4.76218e-11,-43637.3,38.1631], Tmin=(100,'K'), Tmax=(813.698,'K')), NASAPolynomial(coeffs=[12.2246,0.0390277,-1.87038e-05,3.56531e-09,-2.4571e-13,-45425.4,-19.6581], Tmin=(813.698,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-364.166,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(378.308,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-OsOsHH) + group(Cds-OdCsH) + radical(Cs_P) + radical(OCJO)"""),
)

species(
    label = '[O][C](CCC=O)OCO(22263)',
    structure = SMILES('[O][C](CCC=O)OCO'),
    E0 = (-327.421,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2782.5,750,1395,475,1775,1000,3615,1277.5,1000,360,370,350,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (132.115,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0884396,0.090484,-9.31006e-05,4.99501e-08,-1.08215e-11,-39232.9,36.9757], Tmin=(100,'K'), Tmax=(1109.13,'K')), NASAPolynomial(coeffs=[15.9855,0.0325142,-1.47013e-05,2.82634e-09,-1.99659e-13,-42798.5,-42.2367], Tmin=(1109.13,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-327.421,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-OsOsHH) + group(Cds-OdCsH) + radical(CCOJ) + radical(Cs_P)"""),
)

species(
    label = 'O=CC[CH]C(O)O[CH]O(22264)',
    structure = SMILES('O=CC[CH]C(O)O[CH]O'),
    E0 = (-369.51,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2782.5,750,1395,475,1775,1000,3000,3050,390,425,1340,1360,335,370,3580,3650,1210,1345,900,1100,1380,1390,370,380,2900,435,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (132.115,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.46949,0.105107,-0.000147446,1.14025e-07,-3.56118e-11,-44287.2,39.0841], Tmin=(100,'K'), Tmax=(781.983,'K')), NASAPolynomial(coeffs=[12.752,0.0374678,-1.76834e-05,3.38462e-09,-2.35394e-13,-46354.8,-21.4488], Tmin=(781.983,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-369.51,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(378.308,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-OsOsHH) + group(Cds-OdCsH) + radical(CCJCO) + radical(OCJO)"""),
)

species(
    label = 'O=C[CH]CC(O)O[CH]O(22265)',
    structure = SMILES('[O]C=CCC(O)O[CH]O'),
    E0 = (-426.161,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (132.115,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.993011,0.10303,-0.000115618,6.41562e-08,-1.38061e-11,-51069.7,38.1692], Tmin=(100,'K'), Tmax=(1144.01,'K')), NASAPolynomial(coeffs=[22.4869,0.0209322,-7.97333e-06,1.42616e-09,-9.76813e-14,-56441.9,-78.2666], Tmin=(1144.01,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-426.161,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-CsOsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-OsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(OCJO) + radical(C=COJ)"""),
)

species(
    label = '[O]C([CH]CC=O)OCO(22266)',
    structure = SMILES('[O]C([CH]CC=O)OCO'),
    E0 = (-332.765,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2782.5,750,1395,475,1775,1000,3025,407.5,1350,352.5,3615,1277.5,1000,1380,1390,370,380,2900,435,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (132.115,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.161062,0.0872945,-8.38194e-05,4.10173e-08,-8.01349e-12,-39869.1,39.0406], Tmin=(100,'K'), Tmax=(1232.37,'K')), NASAPolynomial(coeffs=[17.9477,0.028516,-1.22745e-05,2.31329e-09,-1.61763e-13,-44332.4,-52.1071], Tmin=(1232.37,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-332.765,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-OsOsHH) + group(Cds-OdCsH) + radical(CCOJ) + radical(CCJCO)"""),
)

species(
    label = '[O][CH]OC(O)CCC=O(22267)',
    ...
    molecularWeight = (132.115,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.227428,0.109065,-0.000187114,1.831e-07,-6.8946e-11,-40998.2,36.1797], Tmin=(100,'K'), Tmax=(832.239,'K')), NASAPolynomial(coeffs=[3.41,0.0564362,-2.89098e-05,5.62593e-09,-3.90399e-13,-40386.5,26.6118], Tmin=(832.239,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-342.015,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-OsOsHH) + group(Cds-OdCsH) + radical(OCJO) + radical(OCOJ)"""),
)

species(
    label = 'O=[C]CCC(O)O[CH]O(22268)',
    structure = SMILES('O=[C]CCC(O)O[CH]O'),
    E0 = (-409.452,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (132.115,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.845489,0.114686,-0.00017658,1.45684e-07,-4.74184e-11,-49079,38.7478], Tmin=(100,'K'), Tmax=(832.039,'K')), NASAPolynomial(coeffs=[13.37,0.0362424,-1.69477e-05,3.18464e-09,-2.1722e-13,-51094.8,-25.1182], Tmin=(832.039,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-409.452,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(378.308,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-OsOsHH) + group(Cds-OdCsH) + radical(OCJO) + radical(CCCJ=O)"""),
)

species(
    label = '[O]C(C[CH]C=O)OCO(22269)',
    structure = SMILES('[O]C=CCC([O])OCO'),
    E0 = (-389.416,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (132.115,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.612939,0.0843154,-4.88182e-05,-1.24533e-08,1.48616e-11,-46654.3,37.8749], Tmin=(100,'K'), Tmax=(959.791,'K')), NASAPolynomial(coeffs=[25.6394,0.0154551,-4.57103e-06,8.29603e-10,-6.34907e-14,-53561.3,-97.4296], Tmin=(959.791,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-389.416,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-CsOsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-OsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(C=COJ) + radical(CCOJ)"""),
)

species(
    label = '[O]C(CC[C]=O)OCO(22270)',
    structure = SMILES('[O]C(CC[C]=O)OCO'),
    E0 = (-372.707,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (132.115,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.279871,0.0936844,-0.000101136,5.65294e-08,-1.26129e-11,-44671.7,37.7929], Tmin=(100,'K'), Tmax=(1086.46,'K')), NASAPolynomial(coeffs=[17.0551,0.0298643,-1.30263e-05,2.4654e-09,-1.72842e-13,-48438.5,-47.2761], Tmin=(1086.46,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-372.707,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-OsOsHH) + group(Cds-OdCsH) + radical(CCOJ) + radical(CCCJ=O)"""),
)
...
species(
    label = 'O[CH]OC1CC[CH]OO1(22271)',
    structure = SMILES('O[CH]OC1CC[CH]OO1'),
    E0 = (-152.496,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (132.115,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.17165,0.0899955,-8.28631e-05,3.8925e-08,-6.94086e-12,-18134.5,33.6768], Tmin=(100,'K'), Tmax=(1583.99,'K')), NASAPolynomial(coeffs=[21.215,0.020075,-3.97166e-06,3.85283e-10,-1.59668e-14,-23547,-79.3205], Tmin=(1583.99,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-152.496,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(394.937,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-OsOsHH) + ring(12dioxane) + radical(CCsJOOC) + radical(OCJO)"""),
)
...
species(
    label = 'O=CCCC(=O)OCO(22273)',
    structure = SMILES('O=CCCC(=O)OCO'),
    E0 = (-749.893,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (132.115,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.354377,0.0838228,-7.31683e-05,3.21533e-08,-5.58176e-12,-90024.5,35.1656], Tmin=(100,'K'), Tmax=(1392.81,'K')), NASAPolynomial(coeffs=[20.2221,0.0247294,-9.52715e-06,1.69155e-09,-1.14086e-13,-95756.4,-70.9215], Tmin=(1392.81,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-749.893,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-OsOsHH) + group(Cds-OdCsOs) + group(Cds-OdCsH)"""),
)

species(
    label = 'O=CCCC(O)OC=O(22274)',
    ...
    molecularWeight = (132.115,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.965896,0.073959,-6.0679e-05,2.77671e-08,-5.65238e-12,-88682.9,32.1104], Tmin=(100,'K'), Tmax=(1094.11,'K')), NASAPolynomial(coeffs=[8.61505,0.0459942,-2.23399e-05,4.40623e-09,-3.14516e-13,-90356.7,-5.48033], Tmin=(1094.11,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-738.209,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-(Cds-O2d)CsHH) + group(Cds-OdCsH) + group(Cds-OdOsH)"""),
)
...
species(
    label = 'CCC([O])O[CH]O(11394)',
    structure = SMILES('CCC([O])O[CH]O'),
    E0 = (-237.128,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,3615,1277.5,1000,1380,1390,370,380,2900,435,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.573452,0.0816446,-0.000112645,9.33534e-08,-3.19852e-11,-28402.5,29.4216], Tmin=(100,'K'), Tmax=(773.457,'K')), NASAPolynomial(coeffs=[8.08626,0.0378164,-1.79987e-05,3.45848e-09,-2.40944e-13,-29415.8,-3.93146], Tmin=(773.457,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-237.128,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-OsOsHH) + radical(OCJO) + radical(CCOJ)"""),
)
...
species(
    label = 'C=COCC([O])O[CH]O(22275)',
    structure = SMILES('C=COCC([O])O[CH]O'),
    E0 = (-302.111,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,3615,1277.5,1000,2950,3100,1380,975,1025,1650,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,180,180,180,193.609,1541.78,1600,2933.33,3200],'cm^-1')),
        HinderedRotor(inertia=(0.147834,'amu*angstrom^2'), symmetry=1, barrier=(3.39899,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.147834,'amu*angstrom^2'), symmetry=1, barrier=(3.39899,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.147834,'amu*angstrom^2'), symmetry=1, barrier=(3.39899,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.147834,'amu*angstrom^2'), symmetry=1, barrier=(3.39899,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.147834,'amu*angstrom^2'), symmetry=1, barrier=(3.39899,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (132.115,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.859414,0.10586,-0.000123993,7.31685e-08,-1.69573e-11,-36159.6,35.8926], Tmin=(100,'K'), Tmax=(1056.25,'K')), NASAPolynomial(coeffs=[20.057,0.0266486,-1.15004e-05,2.16607e-09,-1.51618e-13,-40578.1,-66.1614], Tmin=(1056.25,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-302.111,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-OsOsHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(OCJO) + radical(CCOJ)"""),
)

species(
    label = '[O]C(CC=CO)O[CH]O(22276)',
    structure = SMILES('[O]C(CC=CO)O[CH]O'),
    E0 = (-341.918,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (132.115,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.889238,0.105403,-0.000124635,7.40578e-08,-1.7197e-11,-40945.3,37.2507], Tmin=(100,'K'), Tmax=(1057.5,'K')), NASAPolynomial(coeffs=[20.4569,0.0246604,-1.01071e-05,1.85742e-09,-1.28352e-13,-45460,-66.9257], Tmin=(1057.5,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-341.918,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-CsOsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-OsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(CCOJ) + radical(OCJO)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[O]C(CCC=O)O[CH]O(21353)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[O]C(CCC=O)O[CH]O(21353)'],
    products = ['[O]C1CCC(O[CH]O)O1(22257)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', '[O]C(CCC=O)OC=O(22259)'],
    products = ['[O]C(CCC=O)O[CH]O(21353)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)', 'O=CCCC(=O)O[CH]O(22260)'],
    products = ['[O]C(CCC=O)O[CH]O(21353)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['CH2CH2CHO(560)', 'O=CO[CH]O(4540)'],
    products = ['[O]C(CCC=O)O[CH]O(21353)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['[O]C(CCC=O)O[CH]O(21353)'],
    products = ['O=CCC[C](O)O[CH]O(22262)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['O=CC[CH]C(O)O[CH]O(22264)'],
    products = ['[O]C(CCC=O)O[CH]O(21353)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O]C(CCC=O)O[CH]O(21353)'],
    products = ['O=C[CH]CC(O)O[CH]O(22265)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[O]C([CH]CC=O)OCO(22266)'],
    products = ['[O]C(CCC=O)O[CH]O(21353)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[O][CH]OC(O)CCC=O(22267)'],
    products = ['[O]C(CCC=O)O[CH]O(21353)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[O]C(CCC=O)O[CH]O(21353)'],
    products = ['O=[C]CCC(O)O[CH]O(22268)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[O]C(CCC=O)O[CH]O(21353)'],
    products = ['[O]C(C[CH]C=O)OCO(22269)'],
    transitionState = 'TS16',
    kinetics = Arrhenius(A=(31.031,'s^-1'), n=2.57667, Ea=(35.9533,'kJ/mol'), T0=(1,'K'), comment="""Estimated using average of templates [R5H_SSSS;C_rad_out_single;Cs_H_out_H/OneDe] + [R5H_SSSS;C_rad_out_1H;Cs_H_out_1H] for rate rule [R5H_SSSS_OCC;C_rad_out_H/NonDeO;Cs_H_out_H/CO]
Euclidian distance = 2.44948974278
Multiplied by reaction path degeneracy 2.0
family: intra_H_migration"""),
)
...
reaction(
    label = 'reaction17',
    reactants = ['[O]C(CCC=O)O[CH]O(21353)'],
    products = ['[O]C(CC[C]=O)OCO(22270)'],
    transitionState = 'TS17',
    kinetics = Arrhenius(A=(46.1,'s^-1'), n=3.21, Ea=(60.7935,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R6H_SSSSS;C_rad_out_1H;XH_out] for rate rule [R6H_SSSSS_OO;C_rad_out_H/NonDeO;CO_H_out]
...
reaction(
    label = 'reaction19',
    reactants = ['[O]C(CCC=O)O[CH]O(21353)'],
    products = ['O[CH]OC1CC[CH]OO1(22271)'],
...
reaction(
    label = 'reaction23',
    reactants = ['CO(12)', 'CCC([O])O[CH]O(11394)'],
    products = ['[O]C(CCC=O)O[CH]O(21353)'],
...
reaction(
    label = 'reaction25',
    reactants = ['C=COCC([O])O[CH]O(22275)'],
    products = ['[O]C(CCC=O)O[CH]O(21353)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[O]C(CC=CO)O[CH]O(22276)'],
    products = ['[O]C(CCC=O)O[CH]O(21353)'],
...
reaction(
    label = 'reaction27',
    reactants = ['HCOH(T)(285)', '[O]C([O])CCC=O(18653)'],
    products = ['[O]C(CCC=O)O[CH]O(21353)'],
