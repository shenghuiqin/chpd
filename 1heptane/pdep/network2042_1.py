...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0299963,0.0962187,-7.76091e-05,3.92181e-08,-9.2353e-12,-18509.4,36.0344], Tmin=(100,'K'), Tmax=(947.06,'K')), NASAPolynomial(coeffs=[7.07296,0.0662187,-3.00938e-05,5.77057e-09,-4.06006e-13,-19854.8,2.15308], Tmin=(947.06,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-155.05,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(552.912,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdCsCs) + radical(CCJCC=O)"""),
)

species(
    label = 'CCC=CCC([O])CC(10992)',
    structure = SMILES('CCC=CCC([O])CC'),
    E0 = (-64.863,'kJ/mol'),
    modes = [
...
species(
    label = 'CCCC=CC([O])CC(10993)',
    structure = SMILES('CCCC=CC([O])CC'),
    E0 = (-65.1993,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2995,3025,975,1000,1300,1375,400,500,1630,1680,1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (127.204,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.807703,0.091668,-4.92868e-05,4.88305e-09,2.9539e-12,-7656.88,39.6282], Tmin=(100,'K'), Tmax=(1151.64,'K')), NASAPolynomial(coeffs=[18.1468,0.0471752,-1.91334e-05,3.51938e-09,-2.4327e-13,-13437.9,-60.6374], Tmin=(1151.64,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-65.1993,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(557.07,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(CC(C)OJ)"""),
)
...
species(
    label = 'CCC[CH]C[C](O)CC(10994)',
    structure = SMILES('CCC[CH]C[C](O)CC'),
    E0 = (-40.8093,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.212,'amu'),
...
species(
    label = 'CC[CH]CCC([O])CC(10995)',
    structure = SMILES('CC[CH]CCC([O])CC'),
    E0 = (12.9236,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,3025,407.5,1350,352.5,1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'C[CH]C(O)C[CH]CCC(10996)',
    structure = SMILES('C[CH]C(O)C[CH]CCC'),
    E0 = (-17.5351,'kJ/mol'),
    modes = [
...
species(
    label = 'CCC[CH][CH]C(O)CC(10997)',
    structure = SMILES('CCC[CH][CH]C(O)CC'),
    E0 = (-17.5351,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.212,'amu'),
...
species(
    label = 'C[CH]CCCC([O])CC(10998)',
    structure = SMILES('C[CH]CCCC([O])CC'),
    E0 = (12.9116,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.212,'amu'),
...
species(
    label = 'CCCCC[C]([O])CC(10999)',
    structure = SMILES('CCCCC[C]([O])CC'),
    E0 = (-4.90684,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.212,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.576,0.104931,-8.36676e-05,3.80273e-08,-7.53348e-12,-429.093,36.6032], Tmin=(100,'K'), Tmax=(1147.09,'K')), NASAPolynomial(coeffs=[11.8541,0.061586,-2.69873e-05,5.08578e-09,-3.54117e-13,-3280.79,-25.0708], Tmin=(1147.09,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-4.90684,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(577.856,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(C2CsJOH)"""),
)

species(
    label = 'C[CH]C([O])CCCCC(11000)',
    structure = SMILES('C[CH]C([O])CCCCC'),
    E0 = (18.3674,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,3025,407.5,1350,352.5,1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2]CC(O)C[CH]CCC(11001)',
    structure = SMILES('[CH2]CC(O)C[CH]CCC'),
    E0 = (-12.1908,'kJ/mol'),
    modes = [
...
species(
    label = '[CH2]CCCCC([O])CC(11002)',
    structure = SMILES('[CH2]CCCCC([O])CC'),
    E0 = (23.7117,'kJ/mol'),
    modes = [
...
species(
    label = '[CH2]CC([O])CCCCC(11003)',
    structure = SMILES('[CH2]CC([O])CCCCC'),
    E0 = (23.7117,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2761.11,2772.22,2783.33,2794.44,2805.56,2816.67,2827.78,2838.89,2850,1425,1431.25,1437.5,1443.75,1450,1225,1237.5,1250,1262.5,1275,1270,1287.5,1305,1322.5,1340,700,725,750,775,800,300,325,350,375,400,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'CC[CH][CH]CC(O)CC(11004)',
    structure = SMILES('CC[CH][CH]CC(O)CC'),
    E0 = (-22.9788,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.212,'amu'),
...
species(
    label = 'C[CH]C[CH]CC(O)CC(11005)',
    structure = SMILES('C[CH]C[CH]CC(O)CC'),
    E0 = (-22.9908,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.212,'amu'),
...
species(
    label = '[CH2]CC[CH]CC(O)CC(11006)',
    structure = SMILES('[CH2]CC[CH]CC(O)CC'),
    E0 = (-12.1908,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.212,'amu'),
...
species(
    label = 'CCCCCC(=O)CC(11007)',
    structure = SMILES('CCCCCC(=O)CC'),
    E0 = (-354.952,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.212,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.2616,0.101781,-8.7057e-05,4.9308e-08,-1.31824e-11,-42544.3,34.375], Tmin=(100,'K'), Tmax=(844.983,'K')), NASAPolynomial(coeffs=[6.23408,0.0710304,-3.24686e-05,6.23839e-09,-4.3931e-13,-43642.1,4.13137], Tmin=(844.983,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-354.952,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(577.856,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdCsCs)"""),
)

species(
    label = 'CCCC=CC(O)CC(11008)',
    structure = SMILES('CCCC=CC(O)CC'),
    E0 = (-295.56,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.212,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.00461,0.0960297,-5.63153e-05,1.11337e-08,9.33203e-13,-35355.9,40.5289], Tmin=(100,'K'), Tmax=(1185.08,'K')), NASAPolynomial(coeffs=[18.6068,0.0483395,-1.93737e-05,3.52809e-09,-2.41896e-13,-41303.5,-62.8973], Tmin=(1185.08,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-295.56,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(577.856,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH)"""),
)

species(
    label = 'CCC=CCC(O)CC(11009)',
    structure = SMILES('CCC=CCC(O)CC'),
    E0 = (-295.224,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
species(
    label = '[CH2]C(CC)CC([O])CC(11010)',
    structure = SMILES('[CH2]C(CC)CC([O])CC'),
    E0 = (21.2006,'kJ/mol'),
    modes = [
...
reaction(
    label = 'reaction1',
    reactants = ['CCC[CH]CC([O])CC(10732)'],
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'CCC[CH]CC(=O)CC(10991)'],
    products = ['CCC[CH]CC([O])CC(10732)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'CCC=CCC([O])CC(10992)'],
    products = ['CCC[CH]CC([O])CC(10732)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', 'CCCC=CC([O])CC(10993)'],
    products = ['CCC[CH]CC([O])CC(10732)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(1.46e+08,'cm^3/(mol*s)'), n=1.64, Ea=(5.73208,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""From training reaction 2555 used for Cds-CsH_Cds-CsH;HJ
Exact match found for rate rule [Cds-CsH_Cds-CsH;HJ]
...
reaction(
    label = 'reaction5',
    reactants = ['C2H5(29)', 'CCC[CH]CC=O(1813)'],
    products = ['CCC[CH]CC([O])CC(10732)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['C2H5(29)', 'C=CCC([O])CC(10656)'],
    products = ['CCC[CH]CC([O])CC(10732)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['C=CCCC(134)', 'CC[CH][O](563)'],
    products = ['CCC[CH]CC([O])CC(10732)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['CCC[CH]CC([O])CC(10732)'],
    products = ['CCC[CH]C[C](O)CC(10994)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['CC[CH]CCC([O])CC(10995)'],
    products = ['CCC[CH]CC([O])CC(10732)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CCCC[CH]C([O])CC(10783)'],
    products = ['CCC[CH]CC([O])CC(10732)'],
...
reaction(
    label = 'reaction12',
    reactants = ['C[CH]C(O)C[CH]CCC(10996)'],
    products = ['CCC[CH]CC([O])CC(10732)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CCC[CH]CC([O])CC(10732)'],
    products = ['CCC[CH][CH]C(O)CC(10997)'],
...
reaction(
    label = 'reaction16',
    reactants = ['C[CH]C([O])CCCCC(11000)'],
    products = ['CCC[CH]CC([O])CC(10732)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]CC(O)C[CH]CCC(11001)'],
    products = ['CCC[CH]CC([O])CC(10732)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2]CCCCC([O])CC(11002)'],
    products = ['CCC[CH]CC([O])CC(10732)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2]CC([O])CCCCC(11003)'],
    products = ['CCC[CH]CC([O])CC(10732)'],
...
reaction(
    label = 'reaction20',
    reactants = ['CCC[CH]CC([O])CC(10732)'],
    products = ['CC[CH][CH]CC(O)CC(11004)'],
...
reaction(
    label = 'reaction21',
    reactants = ['CCC[CH]CC([O])CC(10732)'],
    products = ['C[CH]C[CH]CC(O)CC(11005)'],
...
reaction(
    label = 'reaction22',
    reactants = ['CCC[CH]CC([O])CC(10732)'],
    products = ['[CH2]CC[CH]CC(O)CC(11006)'],
...
reaction(
    label = 'reaction28',
    reactants = ['CH2(S)(23)', 'CC[CH]CC([O])CC(10553)'],
    products = ['CCC[CH]CC([O])CC(10732)'],
...
reaction(
    label = 'reaction29',
    reactants = ['[CH2]C(CC)CC([O])CC(11010)'],
    products = ['CCC[CH]CC([O])CC(10732)'],
...
reaction(
    label = 'reaction27',
    reactants = ['[CH2]C(CCC)C([O])CC(10734)'],
    products = ['CCC[CH]CC([O])CC(10732)'],
...
reaction(
    label = 'reaction32',
    reactants = ['O(4)', 'CC[CH]C[CH]CCC(500)'],
    products = ['CCC[CH]CC([O])CC(10732)'],
...
reaction(
    label = 'reaction33',
    reactants = ['[CH]CCC(133)', '[CH2]C([O])CC(1666)'],
    products = ['CCC[CH]CC([O])CC(10732)'],
