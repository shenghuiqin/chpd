...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]CC[CH2](131)'],
    products = ['C2H4(21)', 'C2H4(21)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'buten3yl1(363)'],
    products = ['[CH2]CC[CH2](131)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]C[CH2](128)', 'CH2(19)'],
    products = ['[CH2]CC[CH2](131)'],
    transitionState = 'TS9',
