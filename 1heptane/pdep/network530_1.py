species(
    label = '[CH2]OO[CH]O(983)',
    structure = SMILES('[CH2]OO[CH]O'),
    E0 = (43.0062,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,3615,1277.5,1000,3000,3100,440,815,1455,1000,3025,407.5,1350,352.5],'cm^-1')),
        HinderedRotor(inertia=(1.82269,'amu*angstrom^2'), symmetry=1, barrier=(41.9071,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.303875,'amu*angstrom^2'), symmetry=1, barrier=(6.98669,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.708621,'amu*angstrom^2'), symmetry=1, barrier=(16.2926,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0916995,'amu*angstrom^2'), symmetry=1, barrier=(51.2769,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (76.0514,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.70868,0.0525565,-6.72451e-05,4.48146e-08,-1.18963e-11,5253.12,18.6335], Tmin=(100,'K'), Tmax=(919.711,'K')), NASAPolynomial(coeffs=[10.1495,0.0158457,-7.37211e-06,1.41504e-09,-9.92982e-14,3700.48,-21.3823], Tmin=(919.711,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(43.0062,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(191.233,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(Cs-OsOsHH) + group(Cs-OsHHH) + radical(CsJOOC) + radical(OCJO)"""),
)
...
species(
    label = '[CH2]OOC[O](4535)',
    structure = SMILES('[CH2]OOC[O]'),
    E0 = (81.444,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,3000,3100,440,815,1455,1000,2750,2850,1437.5,1250,1305,750,350,474.685],'cm^-1')),
        HinderedRotor(inertia=(0.0797885,'amu*angstrom^2'), symmetry=1, barrier=(39.4306,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.71489,'amu*angstrom^2'), symmetry=1, barrier=(39.4287,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0797388,'amu*angstrom^2'), symmetry=1, barrier=(39.4357,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (76.0514,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.05724,0.0362888,-2.08776e-05,1.90929e-09,1.32565e-12,9870.73,18.0692], Tmin=(100,'K'), Tmax=(1182.33,'K')), NASAPolynomial(coeffs=[11.2833,0.0152326,-7.05002e-06,1.3783e-09,-9.84033e-14,6979.14,-30.9888], Tmin=(1182.33,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(81.444,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(Cs-OsOsHH) + group(Cs-OsHHH) + radical(OCOJ) + radical(CsJOOC)"""),
)

species(
    label = 'COO[CH][O](4536)',
    structure = SMILES('COO[CH][O]'),
    E0 = (76.8073,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,1661.44],'cm^-1')),
        HinderedRotor(inertia=(0.00520122,'amu*angstrom^2'), symmetry=1, barrier=(10.193,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (76.0514,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[4.77031,0.0233068,-8.80261e-06,2.1103e-10,1.7833e-13,9168.66,8.18823], Tmin=(100,'K'), Tmax=(2704.86,'K')), NASAPolynomial(coeffs=[40.3379,-0.0131031,2.41145e-06,-3.40259e-10,2.47771e-14,-15994.2,-209.743], Tmin=(2704.86,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(76.8073,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(Cs-OsOsHH) + group(Cs-OsHHH) + radical(OCJO) + radical(OCOJ)"""),
)
...
species(
    label = 'COOC=O(4537)',
    structure = SMILES('COOC=O'),
    E0 = (-389.96,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (76.0514,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.54271,0.0190405,3.4343e-05,-5.8425e-08,2.32199e-11,-46837.3,16.7753], Tmin=(100,'K'), Tmax=(989.953,'K')), NASAPolynomial(coeffs=[11.9229,0.0132259,-5.46542e-06,1.12485e-09,-8.71379e-14,-50266.8,-36.325], Tmin=(989.953,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-389.96,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-O2d)) + group(Cs-OsHHH) + group(Cds-OdOsH)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', '[CH2]OOC=O(4534)'],
    products = ['[CH2]OO[CH]O(983)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction9',
    reactants = ['CH2(19)', '[O]O[CH]O(4538)'],
    products = ['[CH2]OO[CH]O(983)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(1355.7,'m^3/(mol*s)'), n=1.40819, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(303.03,'K'), Tmax=(2000,'K'), comment="""Estimated using an average for rate rule [O_rad/NonDe;Birad]
Euclidian distance = 0
