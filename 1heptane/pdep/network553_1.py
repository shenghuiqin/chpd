species(
    label = '[CH2]OC[CH]C(1005)',
    structure = SMILES('[CH2]OC[CH]C'),
    E0 = (128.068,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,3025,407.5,1350,352.5,990.99,992.637,2399.88],'cm^-1')),
        HinderedRotor(inertia=(0.11864,'amu*angstrom^2'), symmetry=1, barrier=(2.72777,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.867248,'amu*angstrom^2'), symmetry=1, barrier=(19.9397,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.138864,'amu*angstrom^2'), symmetry=1, barrier=(3.19276,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.117624,'amu*angstrom^2'), symmetry=1, barrier=(2.70441,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
species(
    label = '[CH2]CCO[CH2](1683)',
    structure = SMILES('[CH2]CCO[CH2]'),
    E0 = (133.412,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,180,981.554,984.118],'cm^-1')),
        HinderedRotor(inertia=(0.179955,'amu*angstrom^2'), symmetry=1, barrier=(4.13753,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.180672,'amu*angstrom^2'), symmetry=1, barrier=(4.154,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.180537,'amu*angstrom^2'), symmetry=1, barrier=(4.15091,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00599616,'amu*angstrom^2'), symmetry=1, barrier=(4.12586,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (72.1057,'amu'),
...
species(
    ...
    molecularWeight = (72.1057,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.73838,0.0477373,-3.55488e-05,1.44895e-08,-2.48311e-12,14606.1,21.4589], Tmin=(100,'K'), Tmax=(1344.27,'K')), NASAPolynomial(coeffs=[9.45206,0.0247848,-9.93762e-06,1.78822e-09,-1.21018e-13,12532.3,-18.0374], Tmin=(1344.27,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(120.753,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(CCsJOCs) + radical(CCJCO)"""),
)

species(
    label = '[CH2][CH]COC(1685)',
    structure = SMILES('[CH2][CH]COC'),
    E0 = (145.543,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,3025,407.5,1350,352.5,344.454,1245.27,1245.27],'cm^-1')),
        HinderedRotor(inertia=(0.0725369,'amu*angstrom^2'), symmetry=1, barrier=(6.04181,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0725014,'amu*angstrom^2'), symmetry=1, barrier=(6.03851,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0721828,'amu*angstrom^2'), symmetry=1, barrier=(6.04106,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00548543,'amu*angstrom^2'), symmetry=1, barrier=(6.03661,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (72.1057,'amu'),
...
species(
    ...
    molecularWeight = (72.1057,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.72223,0.0361846,1.80232e-05,-5.43524e-08,2.50014e-11,-22033.5,16.8348], Tmin=(100,'K'), Tmax=(942.239,'K')), NASAPolynomial(coeffs=[14.9043,0.0151728,-4.16373e-06,7.10588e-10,-5.28013e-14,-26069.1,-54.2094], Tmin=(942.239,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-183.985,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)HHH) + group(Cs-OsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH)"""),
)
...
species(
    ...
    molecularWeight = (72.1057,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.18124,0.0373033,-1.57428e-05,1.8033e-09,2.07593e-13,-15118.6,18.8097], Tmin=(100,'K'), Tmax=(1689.23,'K')), NASAPolynomial(coeffs=[10.2866,0.0244593,-9.97538e-06,1.75219e-09,-1.1414e-13,-18762.8,-27.2247], Tmin=(1689.23,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-126.266,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)OsHH) + group(Cs-OsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH)"""),
)
...
species(
    ...
    molecularWeight = (72.1057,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.66096,0.0155579,6.65023e-05,-9.99716e-08,4.18797e-11,-15470.7,13.5542], Tmin=(100,'K'), Tmax=(882.041,'K')), NASAPolynomial(coeffs=[9.94113,0.0195444,-3.20208e-06,2.72537e-10,-1.29882e-14,-18194.4,-28.8139], Tmin=(882.041,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-129.141,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(303.478,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Oxetane)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', '[CH2]OC=CC(1680)'],
    products = ['[CH2]OC[CH]C(1005)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]O[CH2](103)', 'CHCH3(T)(95)'],
    products = ['[CH2]OC[CH]C(1005)'],
