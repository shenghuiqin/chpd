species(
    label = 'O=[C]CO[C]=O(802)',
    structure = SMILES('O=[C]CO[C]=O'),
    E0 = (-121.854,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,1850,1860,440,470,900,1000,744.468,744.975],'cm^-1')),
        HinderedRotor(inertia=(0.110775,'amu*angstrom^2'), symmetry=1, barrier=(2.54695,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.948614,'amu*angstrom^2'), symmetry=1, barrier=(21.8105,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.948851,'amu*angstrom^2'), symmetry=1, barrier=(21.8159,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.0462,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.06199,0.0375154,-3.42725e-05,1.51226e-08,-2.60834e-12,-14581.6,21.0114], Tmin=(100,'K'), Tmax=(1405.73,'K')), NASAPolynomial(coeffs=[12.0417,0.00911811,-3.97072e-06,7.51917e-10,-5.26003e-14,-17387.4,-30.5335], Tmin=(1405.73,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-121.854,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(170.447,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-(Cds-O2d)OsHH) + group(Cds-OdCsH) + group(Cds-OdOsH) + radical((O)CJOCC) + radical(CsCJ=O)"""),
)
...
reaction(
    ...
    products = ['O=[C]CO[C]=O(802)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(23.3993,'m^3/(mol*s)'), n=2.021, Ea=(121.092,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Od_R;YJ] for rate rule [Od_Cdd-O2d;CJ]
Euclidian distance = 2.2360679775
Multiplied by reaction path degeneracy 2.0
family: R_Addition_MultipleBond
Ea raised from 116.4 to 121.1 kJ/mol to match endothermicity of reaction."""),
)
...
reaction(
    label = 'reaction9',
    reactants = ['CO(12)', '[CH2]O[C]=O(2123)'],
    products = ['O=[C]CO[C]=O(802)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction12',
    reactants = ['[C]=O(361)', '[CH2]O[C]=O(2123)'],
    products = ['O=[C]CO[C]=O(802)'],
