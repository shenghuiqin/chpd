...
species(
    ...
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.58494,0.0464048,-3.57977e-05,1.65098e-08,-3.13254e-12,12542,22.7832], Tmin=(100,'K'), Tmax=(1380.25,'K')), NASAPolynomial(coeffs=[9.0361,0.0221133,-6.46688e-06,9.26844e-10,-5.35538e-14,10742.1,-14.6346], Tmin=(1380.25,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(103.51,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CCOJ) + radical(RCCJ)"""),
)

species(
    label = '[O]C1CCC1[O](2570)',
...
species(
    label = '[CH2]CC(=O)C=O(2571)',
    structure = SMILES('[CH2]CC(=O)C=O'),
    E0 = (-99.7259,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2782.5,750,1395,475,1775,1000,375,552.5,462.5,1710,3000,3100,440,815,1455,1000,180],'cm^-1')),
        HinderedRotor(inertia=(0.104694,'amu*angstrom^2'), symmetry=1, barrier=(2.40713,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.105087,'amu*angstrom^2'), symmetry=1, barrier=(2.41615,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.29994,'amu*angstrom^2'), symmetry=1, barrier=(29.8881,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (85.0813,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.12927,0.0481037,-3.71975e-05,-1.01202e-08,2.74396e-11,-11933.8,19.2628], Tmin=(100,'K'), Tmax=(506.565,'K')), NASAPolynomial(coeffs=[5.91103,0.0292997,-1.42603e-05,2.78595e-09,-1.96821e-13,-12458.9,2.18959], Tmin=(506.565,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-99.7259,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-O2d(Cds-O2d)Cs) + group(Cds-O2d(Cds-O2d)H) + radical(CJCC=O)"""),
)
...
species(
    ...
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.06804,0.048436,-2.86728e-06,-4.73538e-08,2.65087e-11,-11084.5,23.7159], Tmin=(100,'K'), Tmax=(917.026,'K')), NASAPolynomial(coeffs=[21.0513,0.00348514,1.60844e-06,-4.08016e-10,2.4939e-14,-16524.6,-80.6389], Tmin=(917.026,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-93.164,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + radical(C=COJ) + radical(RCCJ)"""),
)
...
species(
    ...
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.81693,0.0386831,-6.68621e-06,-1.95959e-08,1.02745e-11,1068.64,28.5687], Tmin=(100,'K'), Tmax=(1004.35,'K')), NASAPolynomial(coeffs=[12.3015,0.0178691,-6.87854e-06,1.2936e-09,-9.32449e-14,-2093.67,-27.3175], Tmin=(1004.35,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(8.16342,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-O2d)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(CCJCO) + radical(RCCJ)"""),
)

species(
    label = '[CH2]CC(O)[C]=O(2576)',
    structure = SMILES('[CH2]CC(O)[C]=O'),
    E0 = (-31.778,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.55143,0.0468384,-3.0259e-05,3.99505e-09,2.29705e-12,-3727.76,27.8438], Tmin=(100,'K'), Tmax=(1027.3,'K')), NASAPolynomial(coeffs=[12.5446,0.017316,-6.54552e-06,1.1914e-09,-8.33491e-14,-6687.26,-28.8992], Tmin=(1027.3,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-31.778,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-O2d)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(RCCJ) + radical(CCCJ=O)"""),
)

species(
    label = 'CC[C]([O])C=O(2577)',
    ...
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.3879,0.0438492,-4.34278e-07,-4.17075e-08,2.24824e-11,-19209.7,22.2817], Tmin=(100,'K'), Tmax=(923.754,'K')), NASAPolynomial(coeffs=[17.5532,0.00908081,-1.18351e-06,1.18733e-10,-1.04759e-14,-23699.4,-62.5604], Tmin=(923.754,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-160.606,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + radical(C=COJ) + radical(C=C(C)OJ)"""),
)
...
species(
    label = '[CH2]CC1[CH]OO1(2579)',
    structure = SMILES('[CH2]CC1[CH]OO1'),
    E0 = (316.779,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.22798,0.0428767,-2.70623e-05,8.87585e-09,-1.28062e-12,38159.7,17.5832], Tmin=(100,'K'), Tmax=(1435.26,'K')), NASAPolynomial(coeffs=[6.91985,0.0298006,-1.33962e-05,2.528e-09,-1.74916e-13,36812.9,-6.74771], Tmin=(1435.26,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(316.779,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(12dioxetane) + radical(RCCJ) + radical(CCsJOO)"""),
)
...
species(
    ...
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.08372,0.0466111,-3.97771e-05,2.2401e-08,-6.09839e-12,-37377.4,18.7218], Tmin=(100,'K'), Tmax=(818.529,'K')), NASAPolynomial(coeffs=[4.71962,0.03373,-1.61718e-05,3.17533e-09,-2.26396e-13,-37808.9,6.53291], Tmin=(818.529,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-311.315,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-O2d(Cds-O2d)Cs) + group(Cds-O2d(Cds-O2d)H)"""),
)

species(
    label = 'C=CC(O)C=O(2581)',
    structure = SMILES('C=CC(O)C=O'),
    E0 = (-270.338,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
species(
    label = '[CH2]CC([O])=CO(2582)',
    structure = SMILES('[CH2]CC([O])=CO'),
    E0 = (-96.8218,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,3615,1277.5,1000,3000,3100,440,815,1455,1000,350,440,435,1725,309.089,309.912],'cm^-1')),
        HinderedRotor(inertia=(0.228273,'amu*angstrom^2'), symmetry=1, barrier=(15.4467,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.230895,'amu*angstrom^2'), symmetry=1, barrier=(15.4737,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.229685,'amu*angstrom^2'), symmetry=1, barrier=(15.4776,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.01634,0.0514971,-1.39563e-05,-3.6359e-08,2.32257e-11,-11524.3,23.9932], Tmin=(100,'K'), Tmax=(900.85,'K')), NASAPolynomial(coeffs=[20.678,0.0029695,2.28233e-06,-5.95956e-10,4.1157e-14,-16640.1,-77.5427], Tmin=(900.85,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-96.8218,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + radical(C=C(C)OJ) + radical(RCCJ)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['[CH2]CC([O])C=O(1037)'],
    products = ['[O]C1CCC1[O](2570)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(1.46159e+06,'s^-1'), n=1.55572, Ea=(77.6593,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R5_SS;multiplebond_intra;radadd_intra_cs2H] for rate rule [R5_SS_CO;carbonylbond_intra_H;radadd_intra_cs2H]
Euclidian distance = 2.2360679775
family: Intra_R_Add_Exocyclic
Ea raised from 76.0 to 77.7 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction4',
    reactants = ['H(3)', '[CH2]CC(=O)C=O(2571)'],
...
reaction(
    ...
    products = ['[CH2]CC([O])C=O(1037)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(0.00620033,'m^3/(mol*s)'), n=2.49247, Ea=(28.7786,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [Cds-HH_Cds-HH;CJ]
Euclidian distance = 0
Multiplied by reaction path degeneracy 4.0
family: R_Addition_MultipleBond
Ea raised from 26.1 to 28.8 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction9',
    reactants = ['[CH2]CC([O])C=O(1037)'],
    products = ['[CH2]C[C](O)C=O(2573)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction24',
    reactants = ['O(4)', '[CH2]C[CH]C=O(2393)'],
    products = ['[CH2]CC([O])C=O(1037)'],
...
reaction(
    label = 'reaction25',
    reactants = ['CH2(19)', '[CH2]C([O])C=O(2583)'],
    products = ['[CH2]CC([O])C=O(1037)'],
