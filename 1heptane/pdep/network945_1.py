...
species(
    label = '[CH]=C(O)CC=CCC(7344)',
    structure = SMILES('[CH]=C(O)CC=CCC'),
    E0 = (62.6163,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,2995,3025,975,1000,1300,1375,400,500,1630,1680,3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,303.429,303.514],'cm^-1')),
        HinderedRotor(inertia=(0.203485,'amu*angstrom^2'), symmetry=1, barrier=(13.2975,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.20345,'amu*angstrom^2'), symmetry=1, barrier=(13.2974,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.20342,'amu*angstrom^2'), symmetry=1, barrier=(13.2973,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.203412,'amu*angstrom^2'), symmetry=1, barrier=(13.2973,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.203413,'amu*angstrom^2'), symmetry=1, barrier=(13.2976,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (111.162,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.189576,0.0784317,-4.07361e-05,-8.55076e-09,1.042e-11,7694.04,33.0396], Tmin=(100,'K'), Tmax=(984.41,'K')), NASAPolynomial(coeffs=[19.6595,0.0280016,-9.94668e-06,1.7866e-09,-1.25931e-13,2321.67,-69.8471], Tmin=(984.41,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(62.6163,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_P)"""),
)

species(
    label = '[CH]=C(O)C=CCCC(7345)',
    structure = SMILES('[CH]=C(O)C=CCCC'),
    E0 = (44.6731,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,2995,3025,975,1000,1300,1375,400,500,1630,1680,3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.689071,'amu*angstrom^2'), symmetry=1, barrier=(15.8431,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.688972,'amu*angstrom^2'), symmetry=1, barrier=(15.8408,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.688844,'amu*angstrom^2'), symmetry=1, barrier=(15.8379,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.689014,'amu*angstrom^2'), symmetry=1, barrier=(15.8418,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.688815,'amu*angstrom^2'), symmetry=1, barrier=(15.8372,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (111.162,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.53007,0.0872647,-6.09365e-05,8.68244e-09,5.33442e-12,5547.1,30.8628], Tmin=(100,'K'), Tmax=(975.335,'K')), NASAPolynomial(coeffs=[20.8284,0.0266209,-9.1186e-06,1.59455e-09,-1.10636e-13,98.8773,-78.2176], Tmin=(975.335,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(44.6731,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)O2s) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + radical(Cds_P)"""),
)
...
species(
    ...
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.125707,0.087565,-7.46581e-05,3.47309e-08,-6.66857e-12,16885,34.6447], Tmin=(100,'K'), Tmax=(1230.38,'K')), NASAPolynomial(coeffs=[14.7072,0.0393429,-1.58691e-05,2.87688e-09,-1.96206e-13,13235,-39.9908], Tmin=(1230.38,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(139.133,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(RCCJCC) + radical(Cds_P)"""),
)
...
species(
    label = '[CH]=C(O)CCC[CH]C(7348)',
    structure = SMILES('[CH]=C(O)CCC[CH]C'),
    E0 = (139.121,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.325679,0.0890045,-7.61585e-05,3.50494e-08,-6.57053e-12,16893.2,35.5344], Tmin=(100,'K'), Tmax=(1270.77,'K')), NASAPolynomial(coeffs=[16.368,0.0364585,-1.41347e-05,2.51112e-09,-1.69328e-13,12650.4,-49.0034], Tmin=(1270.77,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(139.121,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(RCCJC) + radical(Cds_P)"""),
)
...
species(
    label = '[CH]=C(O)CCCC[CH2](7349)',
    structure = SMILES('[CH]=C(O)CCCC[CH2]'),
    E0 = (149.921,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,3120,650,792.5,1650,3615,1277.5,1000,3000,3100,440,815,1455,1000,350,440,435,1725,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.869822,0.0938972,-8.17657e-05,3.67395e-08,-6.54681e-12,18217.8,36.5478], Tmin=(100,'K'), Tmax=(1358.6,'K')), NASAPolynomial(coeffs=[21.0276,0.0294271,-1.05862e-05,1.81187e-09,-1.19729e-13,12267.8,-75.8054], Tmin=(1358.6,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(149.921,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(RCCJ) + radical(Cds_P)"""),
)
...
species(
    label = '[CH]=C(O)CC([CH2])CC(7350)',
    structure = SMILES('[CH]=C(O)CC([CH2])CC'),
    E0 = (144.063,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.534656,0.0884704,-6.1094e-05,9.47713e-09,5.03864e-12,17500.2,35.0491], Tmin=(100,'K'), Tmax=(961.042,'K')), NASAPolynomial(coeffs=[19.534,0.0304005,-1.01944e-05,1.7333e-09,-1.17472e-13,12467.1,-67.0899], Tmin=(961.042,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(144.063,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(Isobutyl) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', '[CH]=C(O)CC=CCC(7344)'],
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', '[CH]=C(O)C=CCCC(7345)'],
    products = ['[CH]=C(O)C[CH]CCC(1359)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['C2H5(29)', '[CH]=C(O)CC=C(7322)'],
    products = ['[CH]=C(O)C[CH]CCC(1359)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['OH(5)', 'C#CC[CH]CCC(3399)'],
    products = ['[CH]=C(O)C[CH]CCC(1359)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH]=C(O)CC[CH]CC(7346)'],
    products = ['[CH]=C(O)C[CH]CCC(1359)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction13',
    reactants = ['[CH]=C(O)CCCC[CH2](7349)'],
    products = ['[CH]=C(O)C[CH]CCC(1359)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH]=C(O)C[CH]CCC(1359)'],
    products = ['C=C(O)C[CH][CH]CC(2826)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH]=C(O)C[CH]CCC(1359)'],
    products = ['C=C(O)C[CH]C[CH]C(2827)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH]=C(O)C[CH]CCC(1359)'],
    products = ['[CH2]CC[CH]CC(=C)O(2828)'],
...
reaction(
    label = 'reaction21',
    reactants = ['CH2(S)(23)', '[CH]=C(O)C[CH]CC(1351)'],
    products = ['[CH]=C(O)C[CH]CCC(1359)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH]=C(O)CC([CH2])CC(7350)'],
    products = ['[CH]=C(O)C[CH]CCC(1359)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[CH]CCC(133)', '[CH]=C([CH2])O(6276)'],
    products = ['[CH]=C(O)C[CH]CCC(1359)'],
