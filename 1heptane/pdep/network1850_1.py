...
species(
    label = '[CH2]C(OO)C(=C)CCCC(11481)',
    structure = SMILES('[CH2]C(OO)C(=C)CCCC'),
    E0 = (-13.1219,'kJ/mol'),
    modes = [
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.51843,0.115256,-9.4252e-05,4.01111e-08,-6.9748e-12,-1374.77,44.0694], Tmin=(100,'K'), Tmax=(1351.13,'K')), NASAPolynomial(coeffs=[20.8419,0.0490585,-2.07611e-05,3.84975e-09,-2.65358e-13,-7417.13,-70.5356], Tmin=(1351.13,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-13.1219,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(573.699,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(CJCOOH)"""),
)

species(
    label = '[CH2]C(CCCC)C(=C)OO(11482)',
    ...
    molecularWeight = (143.203,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.08673,0.111071,-9.2777e-05,4.2789e-08,-8.27969e-12,-369.094,42.9517], Tmin=(100,'K'), Tmax=(1206.19,'K')), NASAPolynomial(coeffs=[15.8192,0.055007,-2.30568e-05,4.25436e-09,-2.92855e-13,-4447.45,-41.779], Tmin=(1206.19,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-4.59609,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(573.699,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(Isobutyl)"""),
)
...
species(
    ...
    molecularWeight = (144.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.04534,0.107845,-7.73791e-05,2.89221e-08,-4.5106e-12,7656.71,46.3674], Tmin=(100,'K'), Tmax=(1456.58,'K')), NASAPolynomial(coeffs=[17.9038,0.0558081,-2.37907e-05,4.39508e-09,-3.00905e-13,2136.53,-52.1778], Tmin=(1456.58,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(62.1358,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(594.485,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJCOOH) + radical(C2CJCOOH)"""),
)
...
species(
    label = '[CH2]C(OO)C(C)[CH]CCC(11485)',
    structure = SMILES('[CH2]C(OO)C(C)[CH]CCC'),
    E0 = (65.7671,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (144.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.04744,0.115212,-9.49647e-05,4.32236e-08,-8.41781e-12,8088.02,44.0953], Tmin=(100,'K'), Tmax=(1177.33,'K')), NASAPolynomial(coeffs=[14.4073,0.0627051,-2.80672e-05,5.34299e-09,-3.74112e-13,4448.92,-32.9881], Tmin=(1177.33,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(65.7671,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(594.485,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJCOOH) + radical(Cs_S)"""),
)

species(
    label = '[CH2][C](OO)C(C)CCCC(11486)',
    structure = SMILES('[CH2][C](OO)C(C)CCCC'),
    E0 = (58.1241,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (144.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.06668,0.118327,-0.000105555,5.48085e-08,-1.23801e-11,7167.41,41.9179], Tmin=(100,'K'), Tmax=(1023.28,'K')), NASAPolynomial(coeffs=[12.0601,0.0670144,-3.03381e-05,5.80459e-09,-4.0789e-13,4480.94,-21.7131], Tmin=(1023.28,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(58.1241,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(594.485,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(C2CsJOOH) + radical(CJCOOH)"""),
)

species(
    label = '[CH2][C](CCCC)C(C)OO(11487)',
    structure = SMILES('[CH2][C](CCCC)C(C)OO'),
    E0 = (53.2556,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (144.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.976008,0.106995,-7.75155e-05,3.01771e-08,-4.96191e-12,6585.81,45.9047], Tmin=(100,'K'), Tmax=(1381.94,'K')), NASAPolynomial(coeffs=[16.024,0.0577894,-2.41073e-05,4.41278e-09,-3.01089e-13,1887.13,-41.6101], Tmin=(1381.94,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(53.2556,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(594.485,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(C2CJCOOH) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]C(CCCC)C(C)O[O](11488)',
...
species(
    label = '[CH2]C([CH]CCC)C(C)OO(11489)',
    structure = SMILES('[CH2]C([CH]CCC)C(C)OO'),
    E0 = (56.8869,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (144.211,'amu'),
...
species(
    label = '[CH2]C(OO)C(C)C[CH]CC(11490)',
    structure = SMILES('[CH2]C(OO)C(C)C[CH]CC'),
    E0 = (65.6833,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (144.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.961816,0.116373,-0.000104554,5.60868e-08,-1.32245e-11,8072.48,43.815], Tmin=(100,'K'), Tmax=(979.801,'K')), NASAPolynomial(coeffs=[10.8469,0.0681644,-3.07519e-05,5.87158e-09,-4.12063e-13,5758.41,-12.9145], Tmin=(979.801,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(65.6833,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(594.485,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(CJCOOH)"""),
)

species(
    label = '[CH2]C(C[CH]CC)C(C)OO(11491)',
    ...
    molecularWeight = (144.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.02199,0.117024,-0.000109755,6.35652e-08,-1.61681e-11,7007.05,43.8175], Tmin=(100,'K'), Tmax=(917.801,'K')), NASAPolynomial(coeffs=[10.1711,0.0682415,-3.00274e-05,5.6529e-09,-3.9323e-13,4952.46,-9.22261], Tmin=(917.801,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(56.8031,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(594.485,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]C(OO)C(C)CC[CH]C(11492)',
    structure = SMILES('[CH2]C(OO)C(C)CC[CH]C'),
    E0 = (65.6713,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (144.211,'amu'),
...
species(
    label = '[CH2]C(O[O])C(C)CCCC(11493)',
    structure = SMILES('[CH2]C(O[O])C(C)CCCC'),
    E0 = (23.2297,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,492.5,1135,1000,3000,3100,440,815,1455,1000,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (144.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.1581,0.115032,-9.60856e-05,4.47086e-08,-8.82039e-12,2978.17,42.6934], Tmin=(100,'K'), Tmax=(1175.33,'K')), NASAPolynomial(coeffs=[15.0365,0.0599159,-2.57435e-05,4.80878e-09,-3.33326e-13,-828.591,-38.0524], Tmin=(1175.33,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(23.2297,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(598.642,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(CJCOOH)"""),
)

species(
    label = '[CH2]C(CC[CH]C)C(C)OO(6685)',
    structure = SMILES('[CH2]C(CC[CH]C)C(C)OO'),
    E0 = (56.7911,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (144.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.0753,0.116832,-0.000105989,5.7605e-08,-1.35952e-11,7008.77,44.1743], Tmin=(100,'K'), Tmax=(988.071,'K')), NASAPolynomial(coeffs=[11.5293,0.0658046,-2.85226e-05,5.33638e-09,-3.70121e-13,4517.96,-16.4841], Tmin=(988.071,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(56.7911,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(594.485,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Isobutyl) + radical(RCCJC)"""),
)

species(
    label = '[CH2]CCCC(C)C([CH2])OO(11494)',
    structure = SMILES('[CH2]CCCC(C)C([CH2])OO'),
    E0 = (76.4714,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1310,387.5,850,1000,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (144.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.37367,0.119228,-0.000101351,4.69138e-08,-9.10667e-12,9389.84,44.4941], Tmin=(100,'K'), Tmax=(1199.85,'K')), NASAPolynomial(coeffs=[16.8051,0.0586245,-2.55863e-05,4.81703e-09,-3.35378e-13,5027.49,-46.5201], Tmin=(1199.85,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(76.4714,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(594.485,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJ) + radical(CJCOOH)"""),
)

species(
    label = '[CH2]CCCC([CH2])C(C)OO(11495)',
    structure = SMILES('[CH2]CCCC([CH2])C(C)OO'),
    E0 = (67.5911,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (144.211,'amu'),
...
species(
    label = 'C=C(CCCC)C(C)OO(11496)',
    structure = SMILES('C=C(CCCC)C(C)OO'),
    E0 = (-227.084,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (144.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.60084,0.114177,-8.63194e-05,3.35402e-08,-5.32068e-12,-27103.3,42.3759], Tmin=(100,'K'), Tmax=(1468.46,'K')), NASAPolynomial(coeffs=[21.9319,0.0500758,-2.08416e-05,3.81414e-09,-2.59952e-13,-34014.7,-80.1978], Tmin=(1468.46,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-227.084,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(598.642,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH)"""),
)

species(
    label = 'C=C(OO)C(C)CCCC(11497)',
    structure = SMILES('C=C(OO)C(C)CCCC'),
    E0 = (-209.678,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (144.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.14826,0.109923,-8.20932e-05,3.23006e-08,-5.29776e-12,-25031,41.3869], Tmin=(100,'K'), Tmax=(1398.32,'K')), NASAPolynomial(coeffs=[17.9694,0.0552351,-2.34291e-05,4.33166e-09,-2.97301e-13,-30377.5,-57.2542], Tmin=(1398.32,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-209.678,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(598.642,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH)"""),
)
...
species(
    label = '[CH2]C(CCCC)C1CO1(11499)',
    structure = SMILES('[CH2]C(CCCC)C1CO1'),
    E0 = (-22.9437,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (127.204,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.586106,0.0904928,-3.92303e-05,-1.63465e-08,1.54395e-11,-2584.65,35.9471], Tmin=(100,'K'), Tmax=(894.786,'K')), NASAPolynomial(coeffs=[16.0501,0.0458808,-1.43286e-05,2.26746e-09,-1.45523e-13,-6753.07,-49.1201], Tmin=(894.786,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-22.9437,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(557.07,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]C1OCC1CCCC(11500)',
    structure = SMILES('[CH2]C1OCC1CCCC'),
    E0 = (-26.395,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (127.204,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.590378,0.0890841,-3.55531e-05,-1.79175e-08,1.47812e-11,-2998.44,33.605], Tmin=(100,'K'), Tmax=(927.732,'K')), NASAPolynomial(coeffs=[16.3166,0.0463467,-1.5215e-05,2.50768e-09,-1.65334e-13,-7433.33,-53.688], Tmin=(927.732,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-26.395,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(561.227,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Oxetane) + radical(CJC(C)OC)"""),
)
...
species(
    label = '[CH2]C(C[CH]OO)CCCC(8894)',
    structure = SMILES('[CH2]C(C[CH]OO)CCCC'),
    E0 = (63.5702,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (144.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.27297,0.121575,-0.00011428,6.33991e-08,-1.51173e-11,7830.91,42.6444], Tmin=(100,'K'), Tmax=(983.543,'K')), NASAPolynomial(coeffs=[12.5209,0.065476,-2.87225e-05,5.40564e-09,-3.7622e-13,5117.56,-23.6741], Tmin=(983.543,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(63.5702,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(594.485,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCsJOOH) + radical(Isobutyl)"""),
)

species(
    label = 'CCCCC1CCC1OO(8897)',
    structure = SMILES('CCCCC1CCC1OO'),
    E0 = (-191.255,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (144.211,'amu'),
...
species(
    ...
    molecularWeight = (144.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.34986,0.117866,-0.000104146,5.20312e-08,-1.09121e-11,-16480.5,44.16], Tmin=(100,'K'), Tmax=(1122.58,'K')), NASAPolynomial(coeffs=[15.5028,0.0578174,-2.3909e-05,4.38167e-09,-3.00643e-13,-20264.3,-39.0934], Tmin=(1122.58,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-138.627,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(598.642,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Isobutyl) + radical(CC(C)OJ)"""),
)

species(
    label = '[CH2]C([O])C(CO)CCCC(11503)',
    structure = SMILES('[CH2]C([O])C(CO)CCCC'),
    E0 = (-132.12,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (144.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.40895,0.120055,-0.000106768,5.26545e-08,-1.08664e-11,-15696.6,43.2247], Tmin=(100,'K'), Tmax=(1138.92,'K')), NASAPolynomial(coeffs=[16.3369,0.0577292,-2.46828e-05,4.60591e-09,-3.19382e-13,-19738.8,-44.697], Tmin=(1138.92,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-132.12,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(598.642,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(CJCO)"""),
)
...
species(
    label = '[CH2]C([CH]OO)CCCC(5035)',
    structure = SMILES('[CH2]C([CH]OO)CCCC'),
    E0 = (84.0032,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1310,387.5,850,1000,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3000,3100,440,815,1455,1000,1380,1390,370,380,2900,435,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', '[CH2]C(OO)C(=C)CCCC(11481)'],
    products = ['[CH2]C(CCCC)C([CH2])OO(8895)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', '[CH2]C(CCCC)C(=C)OO(11482)'],
    products = ['[CH2]C(CCCC)C([CH2])OO(8895)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['butyl_1(82)', '[CH2]C(C=C)OO(11483)'],
    products = ['[CH2]C(CCCC)C([CH2])OO(8895)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['HO2(10)', '[CH2]C(C=C)CCCC(472)'],
    products = ['[CH2]C(CCCC)C([CH2])OO(8895)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]C(CCCC)C([CH2])OO(8895)'],
    products = ['[CH2]C(OO)[C](C)CCCC(11484)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]C(CCCC)C([CH2])OO(8895)'],
    products = ['[CH2]C(CCCC)[C](C)OO(10178)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]C(CCCC)C([CH2])OO(8895)'],
    products = ['[CH2]C(OO)C(C)[CH]CCC(11485)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]C(CCCC)C([CH2])OO(8895)'],
    products = ['[CH2][C](OO)C(C)CCCC(11486)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]C(CCCC)C([CH2])OO(8895)'],
    products = ['[CH2][C](CCCC)C(C)OO(11487)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2]C(CCCC)C(C)O[O](11488)'],
    products = ['[CH2]C(CCCC)C([CH2])OO(8895)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]C(CCCC)C([CH2])OO(8895)'],
    products = ['[CH2]C([CH]CCC)C(C)OO(11489)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]C(CCCC)C([CH2])OO(8895)'],
    products = ['[CH2]C(OO)C(C)C[CH]CC(11490)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]C(CCCC)C([CH2])OO(8895)'],
    products = ['[CH2]C(C[CH]CC)C(C)OO(11491)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]C(CCCC)C([CH2])OO(8895)'],
    products = ['[CH2]C(OO)C(C)CC[CH]C(11492)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2]C(O[O])C(C)CCCC(11493)'],
    products = ['[CH2]C(CCCC)C([CH2])OO(8895)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2]C(CCCC)C([CH2])OO(8895)'],
    products = ['[CH2]C(CC[CH]C)C(C)OO(6685)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2]CCCC(C)C([CH2])OO(11494)'],
    products = ['[CH2]C(CCCC)C([CH2])OO(8895)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH2]C(CCCC)C([CH2])OO(8895)'],
    products = ['[CH2]CCCC([CH2])C(C)OO(11495)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH2]C(CCCC)C([CH2])OO(8895)'],
    products = ['C=C(CCCC)C(C)OO(11496)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[CH2]C(CCCC)C([CH2])OO(8895)'],
    products = ['C=C(OO)C(C)CCCC(11497)'],
...
reaction(
    label = 'reaction25',
    reactants = ['CH2(S)(23)', '[CH2]C(CCC)C([CH2])OO(11498)'],
    products = ['[CH2]C(CCCC)C([CH2])OO(8895)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[CH2]C(CCCC)C([CH2])OO(8895)'],
    products = ['OH(5)', '[CH2]C(CCCC)C1CO1(11499)'],
...
reaction(
    label = 'reaction27',
    reactants = ['[CH2]C(CCCC)C([CH2])OO(8895)'],
    products = ['OH(5)', '[CH2]C1OCC1CCCC(11500)'],
...
reaction(
    label = 'reaction30',
    reactants = ['[CH2]C(CCCC)C([CH2])OO(8895)'],
    products = ['[CH2]C(C[CH]OO)CCCC(8894)'],
...
reaction(
    label = 'reaction32',
    reactants = ['[CH2]C(CCCC)C([CH2])OO(8895)'],
    products = ['[CH2]C(CCCC)C([O])CO(11502)'],
...
reaction(
    label = 'reaction33',
    reactants = ['[CH2]C(CCCC)C([CH2])OO(8895)'],
    products = ['[CH2]C([O])C(CO)CCCC(11503)'],
...
reaction(
    label = 'reaction34',
    reactants = ['CH2(19)', '[CH2]C([CH]CCCC)OO(11504)'],
    products = ['[CH2]C(CCCC)C([CH2])OO(8895)'],
...
reaction(
    label = 'reaction35',
    reactants = ['CH2(19)', '[CH2]C([CH]OO)CCCC(5035)'],
    products = ['[CH2]C(CCCC)C([CH2])OO(8895)'],
