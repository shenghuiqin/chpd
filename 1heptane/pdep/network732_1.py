...
species(
    label = 'C=[C]OC(=C)C(2418)',
    structure = SMILES('C=[C]OC(=C)C'),
    E0 = (167.766,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,440,435,1725,1685,370,2750,2800,2850,1350,1500,750,1050,1375,1000,2950,3000,3050,3100,1330,1430,900,1050,1000,1050,1600,1700,437.326,437.332,437.335],'cm^-1')),
        HinderedRotor(inertia=(0.064086,'amu*angstrom^2'), symmetry=1, barrier=(8.69169,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0640916,'amu*angstrom^2'), symmetry=1, barrier=(8.69364,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0640365,'amu*angstrom^2'), symmetry=1, barrier=(8.69476,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
species(
    label = 'C#COC([CH2])C(2419)',
    structure = SMILES('C#COC([CH2])C'),
    E0 = (197.906,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2175,525,750,770,3400,2100,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,180,180],'cm^-1')),
        HinderedRotor(inertia=(1.01418,'amu*angstrom^2'), symmetry=1, barrier=(23.3181,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.01522,'amu*angstrom^2'), symmetry=1, barrier=(23.342,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.00928,'amu*angstrom^2'), symmetry=1, barrier=(23.2053,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.02034,'amu*angstrom^2'), symmetry=1, barrier=(23.4597,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (83.1085,'amu'),
...
species(
    label = '[CH]=[C]OC(C)C(2424)',
    structure = SMILES('[CH]=[C]OC(C)C'),
    E0 = (264.91,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,3120,650,792.5,1650,1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,318.378,318.513],'cm^-1')),
        HinderedRotor(inertia=(0.220794,'amu*angstrom^2'), symmetry=1, barrier=(16.0431,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.226279,'amu*angstrom^2'), symmetry=1, barrier=(16.0865,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.224122,'amu*angstrom^2'), symmetry=1, barrier=(16.0525,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.223717,'amu*angstrom^2'), symmetry=1, barrier=(16.0747,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
...
species(
    label = '[CH2]CO[C]=C(1019)',
    structure = SMILES('[CH2]CO[C]=C'),
    E0 = (265.826,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,1685,370,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,408.512,408.518,408.52],'cm^-1')),
        HinderedRotor(inertia=(0.137003,'amu*angstrom^2'), symmetry=1, barrier=(16.2241,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.137004,'amu*angstrom^2'), symmetry=1, barrier=(16.2241,'kJ/mol'), semiclassical=False),
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'C=[C]OC(=C)C(2418)'],
    products = ['[CH2]C(C)O[C]=C(1153)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'C#COC([CH2])C(2419)'],
    products = ['[CH2]C(C)O[C]=C(1153)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['CH3(17)', 'C=[C]OC=C(2409)'],
    products = ['[CH2]C(C)O[C]=C(1153)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction13',
    reactants = ['CH2(S)(23)', '[CH2]CO[C]=C(1019)'],
    products = ['[CH2]C(C)O[C]=C(1153)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H2CC(41)', '[CH2]C(C)[O](1669)'],
    products = ['[CH2]C(C)O[C]=C(1153)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CH2(19)', 'C=[C]O[CH]C(2411)'],
    products = ['[CH2]C(C)O[C]=C(1153)'],
