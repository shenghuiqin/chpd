...
species(
    ...
    molecularWeight = (97.1781,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.665202,0.0651145,-3.17406e-05,5.97443e-09,-9.63912e-14,11609.6,31.7778], Tmin=(100,'K'), Tmax=(1529.27,'K')), NASAPolynomial(coeffs=[13.4993,0.0402464,-1.5883e-05,2.78202e-09,-1.82724e-13,6666.8,-38.9178], Tmin=(1529.27,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(95.4732,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(RCCJC)"""),
)

species(
    label = 'C[CH]CCC=CC(1492)',
    ...
    molecularWeight = (97.1781,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.952076,0.0649224,-3.33013e-05,8.0142e-09,-7.64296e-13,11457.2,30.0621], Tmin=(100,'K'), Tmax=(2327.41,'K')), NASAPolynomial(coeffs=[19.4481,0.0331343,-1.28141e-05,2.14582e-09,-1.33941e-13,2847.6,-74.7952], Tmin=(2327.41,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(94.3384,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(RCCJC)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'CC=CC[CH]CC(1490)'],
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'C[CH]CC=CCC(1491)'],
    products = ['C[CH]CC[CH]CC(181)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(1.46e+08,'cm^3/(mol*s)'), n=1.64, Ea=(5.73208,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""From training reaction 2555 used for Cds-CsH_Cds-CsH;HJ
Exact match found for rate rule [Cds-CsH_Cds-CsH;HJ]
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', 'C[CH]CCC=CC(1492)'],
    products = ['C[CH]CC[CH]CC(181)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(1.46e+08,'cm^3/(mol*s)'), n=1.64, Ea=(5.73208,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""From training reaction 2555 used for Cds-CsH_Cds-CsH;HJ
Exact match found for rate rule [Cds-CsH_Cds-CsH;HJ]
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)', 'C=CCC[CH]CC(1493)'],
    products = ['C[CH]CC[CH]CC(181)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['C=CCC[CH]C(370)', 'CH3(17)'],
    products = ['C[CH]CC[CH]CC(181)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction22',
    reactants = ['C[CH]CC[CH]C(376)', 'CH2(S)(23)'],
    products = ['C[CH]CC[CH]CC(181)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[CH2]C(C)CC[CH]C(1446)'],
    products = ['C[CH]CC[CH]CC(181)'],
...
reaction(
    label = 'reaction27',
    reactants = ['[CH2]C[CH]CC(135)', 'CHCH3(T)(95)'],
    products = ['C[CH]CC[CH]CC(181)'],
...
reaction(
    label = 'reaction28',
    reactants = ['[CH2]C[CH]C(129)', '[CH]CC(144)'],
    products = ['C[CH]CC[CH]CC(181)'],
