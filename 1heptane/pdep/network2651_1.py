...
species(
    label = 'CC(C=CCC[CH]O)OO(16055)',
    structure = SMILES('CC(C=CCC[CH]O)OO'),
    E0 = (-179.804,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (145.176,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.14766,0.116318,-0.000114346,6.11572e-08,-1.35178e-11,-21442.6,41.8107], Tmin=(100,'K'), Tmax=(1075.01,'K')), NASAPolynomial(coeffs=[16.498,0.0506602,-2.27321e-05,4.3428e-09,-3.05298e-13,-25236.5,-44.5958], Tmin=(1075.01,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-179.804,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(523.812,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(CCsJOH)"""),
)

species(
    label = 'CC(CC=CC[CH]O)OO(16056)',
    structure = SMILES('CC(CC=CC[CH]O)OO'),
    E0 = (-179.468,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,1380,1390,370,380,2900,435,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3615,1310,387.5,850,1000,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (145.176,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.17398,0.119151,-0.000124918,7.3263e-08,-1.78587e-11,-21403.2,41.0041], Tmin=(100,'K'), Tmax=(978.816,'K')), NASAPolynomial(coeffs=[14.9215,0.0533759,-2.41189e-05,4.60893e-09,-3.23681e-13,-24554.1,-36.3025], Tmin=(978.816,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-179.468,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(523.812,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(CCsJOH)"""),
)

species(
    label = 'CC(C[CH]CC=CO)OO(16057)',
    structure = SMILES('CC(C[CH]CC=CO)OO'),
    E0 = (-203.162,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (145.176,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.61255,0.116978,-0.000110399,5.46903e-08,-1.08797e-11,-24227.3,42.5012], Tmin=(100,'K'), Tmax=(1210.67,'K')), NASAPolynomial(coeffs=[21.3206,0.0412079,-1.65211e-05,2.99571e-09,-2.04889e-13,-29780.2,-72.522], Tmin=(1210.67,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-203.162,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(523.812,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-(Cds-Cd)H) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(RCCJCC)"""),
)
...
species(
    ...
    molecularWeight = (146.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.1038,0.124414,-0.000168472,1.5004e-07,-5.53459e-11,-6596.21,43.9035], Tmin=(100,'K'), Tmax=(797.975,'K')), NASAPolynomial(coeffs=[4.96844,0.0736993,-3.50277e-05,6.71147e-09,-4.66181e-13,-6919.76,20.0238], Tmin=(797.975,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-56.2742,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(548.755,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(RCCJCC)"""),
)

species(
    label = 'CC([CH]CCC[CH]O)OO(16059)',
    structure = SMILES('CC([CH]CCC[CH]O)OO'),
    E0 = (-95.7249,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3050,390,425,1340,1360,335,370,2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1277.5,1000,1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3615,1310,387.5,850,1000,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'CC(C[CH]C[CH]CO)OO(16061)',
    structure = SMILES('CC(C[CH]C[CH]CO)OO'),
    E0 = (-82.0773,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3050,390,425,1340,1360,335,370,2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1277.5,1000,1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3615,1310,387.5,850,1000,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (146.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.01465,0.118542,-0.000133675,9.41708e-08,-2.85861e-11,-9698.53,45.2431], Tmin=(100,'K'), Tmax=(785.257,'K')), NASAPolynomial(coeffs=[9.70644,0.0639312,-2.93598e-05,5.61178e-09,-3.92516e-13,-11382.3,-3.88846], Tmin=(785.257,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-82.0773,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(544.598,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(CCJCO)"""),
)

species(
    label = 'C[C](CCCC[CH]O)OO(16062)',
    structure = SMILES('C[C](CCCC[CH]O)OO'),
    E0 = (-109.241,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (146.184,'amu'),
...
species(
    label = 'CC(CCC[CH][CH]O)OO(16063)',
    structure = SMILES('CC(CCC[CH][CH]O)OO'),
    E0 = (-96.2378,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3050,390,425,1340,1360,335,370,2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1277.5,1000,1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3615,1310,387.5,850,1000,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'CC(C[CH][CH]CCO)OO(16064)',
    structure = SMILES('CC(C[CH][CH]CCO)OO'),
    E0 = (-87.5211,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3050,390,425,1340,1360,335,370,2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1277.5,1000,1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3615,1310,387.5,850,1000,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (146.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.21758,0.127684,-0.000180153,1.60753e-07,-5.81228e-11,-10351,46.0154], Tmin=(100,'K'), Tmax=(822.749,'K')), NASAPolynomial(coeffs=[5.50813,0.0710305,-3.31901e-05,6.28185e-09,-4.32082e-13,-10646.9,19.8072], Tmin=(822.749,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-87.5211,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(544.598,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(RCCJCC)"""),
)

species(
    label = '[CH2]C(CCCC[CH]O)OO(16065)',
    structure = SMILES('[CH2]C(CCCC[CH]O)OO'),
    E0 = (-82.1773,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (146.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.74435,0.134096,-0.000160369,1.09078e-07,-3.06096e-11,-9683.62,44.3472], Tmin=(100,'K'), Tmax=(860.071,'K')), NASAPolynomial(coeffs=[14.8149,0.0570821,-2.60534e-05,4.96617e-09,-3.46946e-13,-12532,-33.0455], Tmin=(860.071,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-82.1773,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(544.598,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCsJOH) + radical(CJCOOH)"""),
)

species(
    label = 'CC(CCCC[CH]O)O[O](16066)',
    structure = SMILES('CC(CCCC[CH]O)O[O]'),
    E0 = (-144.135,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (146.184,'amu'),
...
species(
    label = 'CC([CH][CH]CCCO)OO(16067)',
    structure = SMILES('CC([CH][CH]CCCO)OO'),
    E0 = (-81.5644,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3050,390,425,1340,1360,335,370,2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1277.5,1000,1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3615,1310,387.5,850,1000,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (146.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.39766,0.128611,-0.000169711,1.40406e-07,-4.85221e-11,-9625.03,46.4068], Tmin=(100,'K'), Tmax=(784.782,'K')), NASAPolynomial(coeffs=[8.88836,0.0660334,-3.07027e-05,5.84004e-09,-4.04676e-13,-10926.9,1.26686], Tmin=(784.782,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-81.5644,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(544.598,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCJCOOH) + radical(RCCJCC)"""),
)

species(
    label = 'CC(CCCC[CH][O])OO(16068)',
    structure = SMILES('CC(CCCC[CH][O])OO'),
    E0 = (-70.4347,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'C[C](C[CH]CCCO)OO(16069)',
    structure = SMILES('C[C](C[CH]CCCO)OO'),
    E0 = (-95.0803,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (146.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.33855,0.129778,-0.000181451,1.59704e-07,-5.73651e-11,-11255.2,44.1798], Tmin=(100,'K'), Tmax=(813.081,'K')), NASAPolynomial(coeffs=[6.48545,0.0703075,-3.3034e-05,6.27779e-09,-4.3326e-13,-11834,12.317], Tmin=(813.081,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-95.0803,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(544.598,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(C2CsJOOH)"""),
)

species(
    label = '[CH2]C(C[CH]CCCO)OO(16070)',
    structure = SMILES('[CH2]C(C[CH]CCCO)OO'),
    E0 = (-68.0168,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,3615,1277.5,1000,1380,1390,370,380,2900,435,2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,3000,3100,440,815,1455,1000,3615,1310,387.5,850,1000,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (146.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.44791,0.128754,-0.000164645,1.3016e-07,-4.32968e-11,-7992.79,46.282], Tmin=(100,'K'), Tmax=(761.989,'K')), NASAPolynomial(coeffs=[10.2737,0.0636202,-2.93371e-05,5.57578e-09,-3.86938e-13,-9674.57,-6.39563], Tmin=(761.989,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-68.0168,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(544.598,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(CJCOOH)"""),
)

species(
    label = 'CC(C[CH]CCCO)O[O](16071)',
    structure = SMILES('CC(C[CH]CCCO)O[O]'),
    E0 = (-129.975,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (146.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.17418,0.123177,-0.000159138,1.31241e-07,-4.525e-11,-15455,44.0581], Tmin=(100,'K'), Tmax=(798.927,'K')), NASAPolynomial(coeffs=[8.05059,0.0656604,-2.98754e-05,5.62517e-09,-3.87413e-13,-16567.4,3.88784], Tmin=(798.927,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-129.975,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(548.755,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(RCCJCC)"""),
)

species(
    label = 'CC(CC=CCCO)OO(16072)',
    ...
    molecularWeight = (146.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.962902,0.111293,-9.75778e-05,4.68319e-08,-9.43395e-12,-43093,40.6829], Tmin=(100,'K'), Tmax=(1159.44,'K')), NASAPolynomial(coeffs=[15.5087,0.0544664,-2.40578e-05,4.55792e-09,-3.18614e-13,-46912.5,-41.2196], Tmin=(1159.44,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-359.766,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(548.755,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH)"""),
)

species(
    label = 'CC(CCCC=CO)OO(16073)',
    structure = SMILES('CC(CCCC=CO)OO'),
    E0 = (-397.621,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (146.184,'amu'),
...
species(
    label = 'CC(C=CCCCO)OO(16074)',
    structure = SMILES('CC(C=CCCCO)OO'),
    E0 = (-360.102,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (146.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.07079,0.109991,-9.20716e-05,4.0838e-08,-7.49546e-12,-43126.7,41.9735], Tmin=(100,'K'), Tmax=(1272.96,'K')), NASAPolynomial(coeffs=[17.8557,0.0505189,-2.19931e-05,4.13727e-09,-2.87766e-13,-47945.3,-53.9039], Tmin=(1272.96,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-360.102,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(548.755,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH)"""),
)

species(
    label = 'CC(CCCCC=O)OO(16075)',
    structure = SMILES('CC(CCCCC=O)OO'),
    E0 = (-399.41,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (146.184,'amu'),
...
species(
    label = 'O[CH]CC[CH]CCOO(16076)',
    structure = SMILES('O[CH]CC[CH]CCOO'),
    E0 = (-65.2583,'kJ/mol'),
    modes = [
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.04351,0.122746,-0.000182208,1.60066e-07,-5.61339e-11,-7678.54,40.4769], Tmin=(100,'K'), Tmax=(832.17,'K')), NASAPolynomial(coeffs=[7.98938,0.0580356,-2.71879e-05,5.13058e-09,-3.51471e-13,-8444.69,2.98756], Tmin=(832.17,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-65.2583,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(473.925,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + radical(RCCJCC) + radical(CCsJOH)"""),
)
...
species(
    label = 'CC1CC(CC[CH]O)O1(16077)',
    structure = SMILES('CC1CC(CC[CH]O)O1'),
    E0 = (-196.256,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (129.177,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.504527,0.0891859,-4.96801e-05,-3.08297e-09,1.00809e-11,-23432.8,33.4887], Tmin=(100,'K'), Tmax=(912.092,'K')), NASAPolynomial(coeffs=[16.8052,0.0400024,-1.27511e-05,2.05395e-09,-1.33469e-13,-27702.2,-54.5226], Tmin=(912.092,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-196.256,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(511.34,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Oxetane) + radical(CCsJOH)"""),
)

species(
    label = '[CH2]C(CC[CH]O)C(C)OO(16078)',
    structure = SMILES('[CH2]C(CC[CH]O)C(C)OO'),
    E0 = (-93.4046,'kJ/mol'),
    modes = [
...
species(
    label = 'CC([O])CC(O)CC[CH]O(16079)',
    structure = SMILES('CC([O])CC(O)CC[CH]O'),
    E0 = (-309.754,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (146.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.55798,0.127967,-0.000144748,9.24544e-08,-2.4319e-11,-37059.6,43.0833], Tmin=(100,'K'), Tmax=(915.99,'K')), NASAPolynomial(coeffs=[15.3377,0.0541817,-2.39111e-05,4.50283e-09,-3.1304e-13,-40154.7,-36.9452], Tmin=(915.99,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-309.754,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(548.755,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(CCsJOH)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['CC(C[CH]CC[CH]O)OO(13295)'],
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'CC(C[CH]CCC=O)OO(16054)'],
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'CC(C=CCC[CH]O)OO(16055)'],
    products = ['CC(C[CH]CC[CH]O)OO(13295)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', 'CC(CC=CC[CH]O)OO(16056)'],
    products = ['CC(C[CH]CC[CH]O)OO(13295)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(1.46e+08,'cm^3/(mol*s)'), n=1.64, Ea=(5.73208,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""From training reaction 2555 used for Cds-CsH_Cds-CsH;HJ
Exact match found for rate rule [Cds-CsH_Cds-CsH;HJ]
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)', 'CC(C[CH]CC=CO)OO(16057)'],
    products = ['CC(C[CH]CC[CH]O)OO(13295)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['CH3CHOOH(63)', 'C=CCC[CH]O(2985)'],
    products = ['CC(C[CH]CC[CH]O)OO(13295)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['CC(C[CH]CCC[O])OO(16058)'],
    products = ['CC(C[CH]CC[CH]O)OO(13295)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['CC([CH]CCC[CH]O)OO(16059)'],
    products = ['CC(C[CH]CC[CH]O)OO(13295)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CC(C[CH]C[CH]CO)OO(16061)'],
    products = ['CC(C[CH]CC[CH]O)OO(13295)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CC(C[CH]CC[CH]O)OO(13295)'],
    products = ['C[C](CCCC[CH]O)OO(16062)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CC(CCC[CH][CH]O)OO(16063)'],
    products = ['CC(C[CH]CC[CH]O)OO(13295)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CC(C[CH][CH]CCO)OO(16064)'],
    products = ['CC(C[CH]CC[CH]O)OO(13295)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]C(CCCC[CH]O)OO(16065)'],
    products = ['CC(C[CH]CC[CH]O)OO(13295)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CC(C[CH]CC[CH]O)OO(13295)'],
    products = ['CC(CCCC[CH]O)O[O](16066)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CC([CH][CH]CCCO)OO(16067)'],
    products = ['CC(C[CH]CC[CH]O)OO(13295)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CC(CCCC[CH][O])OO(16068)'],
    products = ['CC(C[CH]CC[CH]O)OO(13295)'],
...
reaction(
    label = 'reaction20',
    reactants = ['C[C](C[CH]CCCO)OO(16069)'],
    products = ['CC(C[CH]CC[CH]O)OO(13295)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH2]C(C[CH]CCCO)OO(16070)'],
    products = ['CC(C[CH]CC[CH]O)OO(13295)'],
...
reaction(
    label = 'reaction22',
    reactants = ['CC(C[CH]CC[CH]O)OO(13295)'],
    products = ['CC(C[CH]CCCO)O[O](16071)'],
...
reaction(
    label = 'reaction28',
    reactants = ['CH2(S)(23)', 'O[CH]CC[CH]CCOO(16076)'],
    products = ['CC(C[CH]CC[CH]O)OO(13295)'],
...
reaction(
    label = 'reaction29',
    reactants = ['CC(C[CH]CC[CH]O)OO(13295)'],
    products = ['OH(5)', 'CC1CC(CC[CH]O)O1(16077)'],
...
reaction(
    label = 'reaction30',
    reactants = ['[CH2]C(CC[CH]O)C(C)OO(16078)'],
    products = ['CC(C[CH]CC[CH]O)OO(13295)'],
...
reaction(
    label = 'reaction34',
    reactants = ['CC(C[CH]CC[CH]O)OO(13295)'],
    products = ['CC([O])CC(O)CC[CH]O(16079)'],
...
reaction(
    label = 'reaction35',
    reactants = ['[CH]CC(C)OO(1806)', '[CH2]C[CH]O(562)'],
    products = ['CC(C[CH]CC[CH]O)OO(13295)'],
...
reaction(
    label = 'reaction36',
    reactants = ['HCOH(T)(285)', '[CH2]C[CH]CC(C)OO(5450)'],
    products = ['CC(C[CH]CC[CH]O)OO(13295)'],
