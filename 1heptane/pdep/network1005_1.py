...
species(
    label = 'C=C(CC)C[CH]CCC(1620)',
    structure = SMILES('C=C(CC)C[CH]CCC'),
    E0 = (44.8953,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,2950,3100,1380,975,1025,1650,3025,407.5,1350,352.5,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,350,440,435,1725,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.188511,0.0932004,-5.48902e-05,1.63438e-08,-2.0477e-12,5548.03,38.0587], Tmin=(100,'K'), Tmax=(1704.28,'K')), NASAPolynomial(coeffs=[14.6071,0.0584749,-2.43272e-05,4.38855e-09,-2.93996e-13,504.826,-41.2098], Tmin=(1704.28,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(44.8953,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(602.799,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(RCCJCC)"""),
)

species(
    label = '[CH2]C(C=CCCC)CC(1621)',
    ...
    molecularWeight = (125.231,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.948213,0.095524,-5.01193e-05,5.51489e-09,2.78868e-12,6272.23,40.8338], Tmin=(100,'K'), Tmax=(1129.05,'K')), NASAPolynomial(coeffs=[16.475,0.0536052,-2.0744e-05,3.70854e-09,-2.5202e-13,1075.38,-50.9289], Tmin=(1129.05,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(50.5768,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(602.799,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]C(CC)CC=CCC(1622)',
    ...
    molecularWeight = (125.231,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.967434,0.0959987,-5.21377e-05,8.15358e-09,1.73517e-12,6546.75,40.8703], Tmin=(100,'K'), Tmax=(1156.29,'K')), NASAPolynomial(coeffs=[16.5542,0.0536103,-2.07914e-05,3.71161e-09,-2.51553e-13,1276.38,-51.4743], Tmin=(1156.29,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(52.8544,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(602.799,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Isobutyl)"""),
)
...
species(
    label = 'CCC[CH]C[C](C)CC(1623)',
    structure = SMILES('CCC[CH]C[C](C)CC'),
    E0 = (114.329,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (126.239,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.458394,0.106467,-0.000106225,8.55411e-08,-3.21982e-11,13903.1,40.2532], Tmin=(100,'K'), Tmax=(757.794,'K')), NASAPolynomial(coeffs=[2.34286,0.0815778,-3.69623e-05,7.01453e-09,-4.87971e-13,13768.6,29.4296], Tmin=(757.794,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(114.329,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(623.585,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(Tertalkyl)"""),
)

species(
    label = '[CH2]C([CH]CCCC)CC(1580)',
    ...
    molecularWeight = (126.239,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.687181,0.100258,-6.31374e-05,2.09038e-08,-2.93346e-12,16295.3,41.7006], Tmin=(100,'K'), Tmax=(1567.22,'K')), NASAPolynomial(coeffs=[15.2547,0.0595698,-2.41934e-05,4.3376e-09,-2.90821e-13,11298.5,-42.3722], Tmin=(1567.22,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(134.072,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(623.585,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Cs_S) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]C(CC)CC[CH]CC(1619)',
...
species(
    ...
    molecularWeight = (126.239,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.310798,0.0907371,-4.77798e-05,1.18154e-08,-1.18369e-12,14968.8,38.8431], Tmin=(100,'K'), Tmax=(2066.87,'K')), NASAPolynomial(coeffs=[16.57,0.0592707,-2.49435e-05,4.44961e-09,-2.92752e-13,8247.62,-51.4031], Tmin=(2066.87,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(123.448,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(623.585,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(Cs_S)"""),
)

species(
    label = 'CCC[CH][CH]C(C)CC(1625)',
    structure = SMILES('CCC[CH][CH]C(C)CC'),
    E0 = (123.448,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (126.239,'amu'),
...
species(
    label = '[CH2][C](CC)CCCCC(1626)',
    structure = SMILES('[CH2][C](CC)CCCCC'),
    E0 = (124.953,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (126.239,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.452371,0.10452,-8.2025e-05,4.21378e-08,-1.02247e-11,15183,39.468], Tmin=(100,'K'), Tmax=(920.397,'K')), NASAPolynomial(coeffs=[6.58404,0.0739401,-3.21877e-05,6.03929e-09,-4.19548e-13,13887.8,6.10509], Tmin=(920.397,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(124.953,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(623.585,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Tertalkyl) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]C(CC)CCC[CH]C(1627)',
    ...
    molecularWeight = (126.239,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.489736,0.0995203,-6.40732e-05,2.28587e-08,-3.58192e-12,16274,41.1685], Tmin=(100,'K'), Tmax=(1386.58,'K')), NASAPolynomial(coeffs=[11.552,0.0647821,-2.64932e-05,4.79018e-09,-3.24148e-13,12934.6,-20.8615], Tmin=(1386.58,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(133.976,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(623.585,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Isobutyl) + radical(RCCJC)"""),
)

species(
    label = '[CH2]C([CH]C)CCCCC(1628)',
    structure = SMILES('[CH2]C([CH]C)CCCCC'),
    E0 = (134.072,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,3025,407.5,1350,352.5,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    ...
    molecularWeight = (126.239,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.06022,0.104694,-7.05183e-05,2.54354e-08,-3.85725e-12,17599.7,42.2782], Tmin=(100,'K'), Tmax=(1493.18,'K')), NASAPolynomial(coeffs=[16.7899,0.0568762,-2.24825e-05,3.98871e-09,-2.6649e-13,12269,-50.9947], Tmin=(1493.18,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(144.776,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(623.585,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Isobutyl) + radical(RCCJ)"""),
)

species(
    label = '[CH2]CC([CH2])CCCCC(1631)',
    structure = SMILES('[CH2]CC([CH2])CCCCC'),
    E0 = (144.776,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2761.11,2772.22,2783.33,2794.44,2805.56,2816.67,2827.78,2838.89,2850,1425,1431.25,1437.5,1443.75,1450,1225,1237.5,1250,1262.5,1275,1270,1287.5,1305,1322.5,1340,700,725,750,775,800,300,325,350,375,400,1380,1390,370,380,2900,435,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'CC[CH][CH]CC(C)CC(1632)',
    structure = SMILES('CC[CH][CH]CC(C)CC'),
    E0 = (123.364,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (126.239,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.33129,0.0728894,6.32368e-05,-2.67932e-07,2.35088e-10,14918.3,35.6519], Tmin=(100,'K'), Tmax=(412.832,'K')), NASAPolynomial(coeffs=[2.52077,0.0808204,-3.62725e-05,6.92013e-09,-4.85959e-13,14654.3,28.9577], Tmin=(412.832,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(123.364,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(623.585,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(RCCJCC)"""),
)

species(
    label = 'C[CH]C[CH]CC(C)CC(1633)',
    ...
    molecularWeight = (126.239,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.140978,0.0933029,-5.66648e-05,2.0661e-08,-3.81695e-12,14967.6,39.7149], Tmin=(100,'K'), Tmax=(1054.82,'K')), NASAPolynomial(coeffs=[4.30991,0.0774939,-3.41838e-05,6.45261e-09,-4.49476e-13,14088.1,19.3797], Tmin=(1054.82,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(123.352,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(623.585,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(RCCJC)"""),
)

species(
    label = '[CH2]CC[CH]CC(C)CC(1634)',
    ...
    molecularWeight = (126.239,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.123336,0.0956138,-5.58818e-05,1.66856e-08,-2.13677e-12,16277.5,39.6664], Tmin=(100,'K'), Tmax=(1623.53,'K')), NASAPolynomial(coeffs=[12.3712,0.0648302,-2.74406e-05,5.00692e-09,-3.38431e-13,12220.4,-26.6675], Tmin=(1623.53,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(134.152,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(623.585,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(RCCJ)"""),
)

species(
    label = 'C=C(CC)CCCCC(1635)',
    structure = SMILES('C=C(CC)CCCCC'),
    E0 = (-149.563,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (126.239,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.43823,0.103563,-6.52872e-05,2.0715e-08,-2.66423e-12,-17779,40.0489], Tmin=(100,'K'), Tmax=(1787.16,'K')), NASAPolynomial(coeffs=[23.6865,0.0473307,-1.80912e-05,3.10977e-09,-2.01558e-13,-26759.6,-95.7521], Tmin=(1787.16,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-149.563,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(627.743,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH)"""),
)

species(
    label = 'CCCC=CC(C)CC(1636)',
    structure = SMILES('CCCC=CC(C)CC'),
    E0 = (-154.506,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (126.239,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.940198,0.0934928,-3.62195e-05,-9.06949e-09,7.40734e-12,-18392.2,39.026], Tmin=(100,'K'), Tmax=(1120.15,'K')), NASAPolynomial(coeffs=[16.7985,0.0568001,-2.27729e-05,4.16814e-09,-2.87628e-13,-24038.2,-56.0289], Tmin=(1120.15,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-154.506,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(627.743,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH)"""),
)

species(
    label = 'CCC=CCC(C)CC(1637)',
    structure = SMILES('CCC=CCC(C)CC'),
    E0 = (-152.228,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (126.239,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.947162,0.0938324,-3.78112e-05,-6.91815e-09,6.53333e-12,-18118.2,39.0179], Tmin=(100,'K'), Tmax=(1134.94,'K')), NASAPolynomial(coeffs=[16.767,0.0569822,-2.29178e-05,4.19347e-09,-2.8896e-13,-23786.7,-55.9432], Tmin=(1134.94,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-152.228,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(627.743,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH)"""),
)
...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.31835,0.0837672,-5.04103e-05,1.66638e-08,-2.45926e-12,19104.6,35.8489], Tmin=(100,'K'), Tmax=(1417.47,'K')), NASAPolynomial(coeffs=[9.04088,0.0591528,-2.43628e-05,4.41308e-09,-2.98602e-13,16631.9,-9.27534], Tmin=(1417.47,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(157.768,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(552.912,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]C(C)C[CH]CCC(514)',
    ...
    collisionModel = TransportData(shapeIndex=2, epsilon=(3517.68,'J/mol'), sigma=(6.71113,'angstroms'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with Tc=549.45 K, Pc=26.41 bar (from Joback method)"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.31835,0.0837672,-5.04103e-05,1.66638e-08,-2.45926e-12,18702.1,35.8489], Tmin=(100,'K'), Tmax=(1417.47,'K')), NASAPolynomial(coeffs=[9.04088,0.0591528,-2.43628e-05,4.41308e-09,-2.98602e-13,16229.3,-9.27534], Tmin=(1417.47,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(154.421,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(552.912,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(Isobutyl)"""),
)

species(
    label = 'CCC[CH]C[CH]CCC(1612)',
    structure = SMILES('CCC[CH]C[CH]CCC'),
    E0 = (125.711,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (126.239,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.34562,0.0848296,-4.02649e-05,8.33552e-09,-6.58883e-13,15185.1,34.5995], Tmin=(100,'K'), Tmax=(2804.73,'K')), NASAPolynomial(coeffs=[30.0479,0.0438963,-1.83737e-05,3.13223e-09,-1.95094e-13,-915.629,-133.474], Tmin=(2804.73,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(125.711,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(623.585,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(RCCJCC)"""),
)

species(
    label = 'CC[CH]CC[CH]CCC(1412)',
    ...
    opticalIsomers = 1,
    molecularWeight = (126.239,'amu'),
    collisionModel = TransportData(shapeIndex=2, epsilon=(3640.43,'J/mol'), sigma=(6.99143,'angstroms'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with Tc=568.63 K, Pc=24.17 bar (from Joback method)"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.34562,0.0848296,-4.02649e-05,8.33552e-09,-6.58883e-13,15185.1,35.2926], Tmin=(100,'K'), Tmax=(2804.73,'K')), NASAPolynomial(coeffs=[30.0479,0.0438963,-1.83737e-05,3.13223e-09,-1.95094e-13,-915.629,-132.781], Tmin=(2804.73,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(125.711,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(623.585,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(RCCJCC)"""),
)

species(
    label = '[CH2]C(CC)C([CH2])CCC(1415)',
    structure = SMILES('[CH2]C(CC)C([CH2])CCC'),
    E0 = (142.265,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    opticalIsomers = 1,
    molecularWeight = (126.239,'amu'),
    collisionModel = TransportData(shapeIndex=2, epsilon=(3682.18,'J/mol'), sigma=(7.05481,'angstroms'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with Tc=575.15 K, Pc=23.8 bar (from Joback method)"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.37611,0.106664,-7.44831e-05,2.84863e-08,-4.54198e-12,17313.5,43.1351], Tmin=(100,'K'), Tmax=(1452.98,'K')), NASAPolynomial(coeffs=[17.8859,0.0536362,-1.97387e-05,3.36793e-09,-2.20088e-13,11716.1,-56.9896], Tmin=(1452.98,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(142.265,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(623.585,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Isobutyl) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]C(CC)CC([CH2])CC(1638)',
    ...
    molecularWeight = (126.239,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.37611,0.106664,-7.44831e-05,2.84863e-08,-4.54198e-12,17313.5,42.4419], Tmin=(100,'K'), Tmax=(1452.98,'K')), NASAPolynomial(coeffs=[17.8859,0.0536362,-1.97387e-05,3.36793e-09,-2.20088e-13,11716.1,-57.6827], Tmin=(1452.98,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(142.265,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(623.585,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Isobutyl) + radical(Isobutyl)"""),
)

species(
    label = 'CCCC1CC(CC)C1(1416)',
    ...
    molecularWeight = (126.239,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.280271,0.0706461,3.89153e-05,-9.12033e-08,3.71159e-11,-14632.1,33.1197], Tmin=(100,'K'), Tmax=(1005.05,'K')), NASAPolynomial(coeffs=[17.5467,0.0554056,-2.14826e-05,4.01002e-09,-2.86084e-13,-21029.2,-66.9728], Tmin=(1005.05,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-123.111,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(636.057,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Cyclobutane)"""),
)
...
species(
    ...
    molecularWeight = (112.213,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.70778,0.0726084,-3.2785e-05,6.20385e-09,-4.23475e-13,18038.8,31.8172], Tmin=(100,'K'), Tmax=(2765.76,'K')), NASAPolynomial(coeffs=[46.2104,0.0165949,-6.93415e-06,1.06411e-09,-5.75424e-14,-9771.1,-233.928], Tmin=(2765.76,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(149.492,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(552.912,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(RCCJCC)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(CC)C[CH]CCC(1414)'],
    products = ['C=CCCC(134)', 'butene1(127)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'C=C(CC)C[CH]CCC(1620)'],
    products = ['[CH2]C(CC)C[CH]CCC(1414)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', '[CH2]C(C=CCCC)CC(1621)'],
    products = ['[CH2]C(CC)C[CH]CCC(1414)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', '[CH2]C(CC)CC=CCC(1622)'],
    products = ['[CH2]C(CC)C[CH]CCC(1414)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(1.46e+08,'cm^3/(mol*s)'), n=1.64, Ea=(5.73208,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""From training reaction 2555 used for Cds-CsH_Cds-CsH;HJ
Exact match found for rate rule [Cds-CsH_Cds-CsH;HJ]
...
reaction(
    label = 'reaction5',
    reactants = ['C=CC[CH]CCC(456)', 'C2H5(29)'],
    products = ['[CH2]C(CC)C[CH]CCC(1414)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2][CH]CCC(137)', 'butene1(127)'],
    products = ['[CH2]C(CC)C[CH]CCC(1414)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2][CH]CC(130)', 'C=CCCC(134)'],
    products = ['[CH2]C(CC)C[CH]CCC(1414)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['C2H5(29)', '[CH2]C(CC)CC=C(1458)'],
    products = ['[CH2]C(CC)C[CH]CCC(1414)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]C([CH]CCCC)CC(1580)'],
    products = ['[CH2]C(CC)C[CH]CCC(1414)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]C(CC)CC[CH]CC(1619)'],
    products = ['[CH2]C(CC)C[CH]CCC(1414)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]C(CC)C[CH]CCC(1414)'],
    products = ['C[CH]C(C)C[CH]CCC(1624)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2]C(CC)C[CH]CCC(1414)'],
    products = ['CCC[CH][CH]C(C)CC(1625)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]C(CC)C[CH]CCC(1414)'],
    products = ['[CH2]C(CC)CCC[CH]C(1627)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]C([CH]C)CCCCC(1628)'],
    products = ['[CH2]C(CC)C[CH]CCC(1414)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]CC(C)C[CH]CCC(1629)'],
    products = ['[CH2]C(CC)C[CH]CCC(1414)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2]CCCCC([CH2])CC(1630)'],
    products = ['[CH2]C(CC)C[CH]CCC(1414)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2]CC([CH2])CCCCC(1631)'],
    products = ['[CH2]C(CC)C[CH]CCC(1414)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2]C(CC)C[CH]CCC(1414)'],
    products = ['CC[CH][CH]CC(C)CC(1632)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH2]C(CC)C[CH]CCC(1414)'],
    products = ['C[CH]C[CH]CC(C)CC(1633)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH2]CC[CH]CC(C)CC(1634)'],
    products = ['[CH2]C(CC)C[CH]CCC(1414)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH2][CH]CC(130)', '[CH2][CH]CCC(137)'],
    products = ['[CH2]C(CC)C[CH]CCC(1414)'],
...
reaction(
    label = 'reaction27',
    reactants = ['CH2(S)(23)', '[CH2]C(CC)C[CH]CC(480)'],
    products = ['[CH2]C(CC)C[CH]CCC(1414)'],
...
reaction(
    label = 'reaction28',
    reactants = ['CH2(S)(23)', '[CH2]C(C)C[CH]CCC(514)'],
    products = ['[CH2]C(CC)C[CH]CCC(1414)'],
...
reaction(
    label = 'reaction27',
    reactants = ['[CH2]C(CC)C([CH2])CCC(1415)'],
    products = ['[CH2]C(CC)C[CH]CCC(1414)'],
...
reaction(
    label = 'reaction32',
    reactants = ['[CH2]C(CC)CC([CH2])CC(1638)'],
    products = ['[CH2]C(CC)C[CH]CCC(1414)'],
...
reaction(
    label = 'reaction34',
    reactants = ['CH2(19)', 'CC[CH]C[CH]CCC(500)'],
    products = ['[CH2]C(CC)C[CH]CCC(1414)'],
...
reaction(
    label = 'reaction35',
    reactants = ['[CH]CCC(133)', '[CH2]C([CH2])CC(429)'],
    products = ['[CH2]C(CC)C[CH]CCC(1414)'],
...
network(
    label = '1005',
    isomers = [
        '[CH2]C(CC)C[CH]CCC(1414)',
    ],
    reactants = [
        ('C=CCCC(134)', 'butene1(127)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
