...
species(
    label = 'C=C(CC)O[C]=O(2637)',
    structure = SMILES('C=C(CC)O[C]=O'),
    E0 = (-162.188,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2950,3100,1380,975,1025,1650,1855,455,950,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,180,180,487.825],'cm^-1')),
        HinderedRotor(inertia=(0.79074,'amu*angstrom^2'), symmetry=1, barrier=(18.1807,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.79072,'amu*angstrom^2'), symmetry=1, barrier=(18.1802,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.790628,'amu*angstrom^2'), symmetry=1, barrier=(18.1781,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0161467,'amu*angstrom^2'), symmetry=1, barrier=(18.1749,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.93881,0.063906,-5.3984e-05,2.34057e-08,-4.11742e-12,-19393.8,23.6597], Tmin=(100,'K'), Tmax=(1342.5,'K')), NASAPolynomial(coeffs=[13.8478,0.0254432,-1.10088e-05,2.06477e-09,-1.43307e-13,-22859.9,-42.421], Tmin=(1342.5,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-162.188,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-Cd)) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + group(Cds-OdOsH) + radical((O)CJOC)"""),
)
...
species(
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.984821,0.0687476,-6.95259e-05,3.99737e-08,-9.59299e-12,-8655.84,26.8293], Tmin=(100,'K'), Tmax=(992.476,'K')), NASAPolynomial(coeffs=[10.1155,0.0319476,-1.39066e-05,2.6125e-09,-1.81751e-13,-10468.2,-17.1518], Tmin=(992.476,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-72.8547,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdOsH) + radical(C2CsJOC(O)H) + radical((O)CJOCC2)"""),
)
...
species(
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.830211,0.061103,-4.33879e-05,1.4035e-08,-1.35266e-12,-8618.95,28.9374], Tmin=(100,'K'), Tmax=(1196.49,'K')), NASAPolynomial(coeffs=[14.1749,0.0255421,-1.01547e-05,1.84105e-09,-1.25981e-13,-12460.2,-40.5447], Tmin=(1196.49,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-72.6704,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdOsH) + radical((O)CJOCC2) + radical(CCJCO)"""),
)

species(
    label = '[CH2]C([CH]C)OC=O(2641)',
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.991945,0.0617204,-4.50621e-05,1.66947e-08,-2.52885e-12,-6793.1,28.7199], Tmin=(100,'K'), Tmax=(1523.73,'K')), NASAPolynomial(coeffs=[13.8172,0.0280522,-1.19179e-05,2.19321e-09,-1.4956e-13,-10701.5,-38.5558], Tmin=(1523.73,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-57.4092,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdOsH) + radical(CJC(C)OC) + radical(CCJCO)"""),
)

species(
    label = '[CH2]CC(C)O[C]=O(2642)',
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.964989,0.0637071,-5.11817e-05,2.16117e-08,-3.75219e-12,-7985.85,27.7365], Tmin=(100,'K'), Tmax=(1347.24,'K')), NASAPolynomial(coeffs=[12.8263,0.0284907,-1.19723e-05,2.20938e-09,-1.51817e-13,-11181.8,-33.0226], Tmin=(1347.24,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-67.3261,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdOsH) + radical(RCCJ) + radical((O)CJOCC2)"""),
)

species(
    label = '[CH2]CC([CH2])OC=O(2643)',
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.18885,0.0635882,-5.03701e-05,2.13262e-08,-3.82986e-12,-6162.46,27.298], Tmin=(100,'K'), Tmax=(1268.71,'K')), NASAPolynomial(coeffs=[10.5813,0.0339764,-1.53611e-05,2.93055e-09,-2.05099e-13,-8545.78,-20.2508], Tmin=(1268.71,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-52.0649,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdOsH) + radical(RCCJ) + radical(CJC(C)OC)"""),
)
...
species(
    label = '[CH2]C(C)O[C]=O(931)',
    structure = SMILES('[CH2]C(C)O[C]=O'),
    E0 = (-38.2821,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1855,455,950,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,505.207,512.78],'cm^-1')),
        HinderedRotor(inertia=(0.485404,'amu*angstrom^2'), symmetry=1, barrier=(11.1604,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.155956,'amu*angstrom^2'), symmetry=1, barrier=(3.58574,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0592206,'amu*angstrom^2'), symmetry=1, barrier=(11.1635,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.801452,'amu*angstrom^2'), symmetry=1, barrier=(18.427,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'C=C(CC)O[C]=O(2637)'],
    products = ['[CH2]C(CC)O[C]=O(875)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['C2H5(29)', 'C=CO[C]=O(735)'],
    products = ['[CH2]C(CC)O[C]=O(875)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]CC([CH2])OC=O(2643)'],
    products = ['[CH2]C(CC)O[C]=O(875)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CH2(S)(23)', '[CH2]C(C)O[C]=O(931)'],
    products = ['[CH2]C(CC)O[C]=O(875)'],
