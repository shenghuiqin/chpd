species(
    ...
    E0 = (-24.4963,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2761.11,2772.22,2783.33,2794.44,2805.56,2816.67,2827.78,2838.89,2850,1425,1431.25,1437.5,1443.75,1450,1225,1237.5,1250,1262.5,1275,1270,1287.5,1305,1322.5,1340,700,725,750,775,800,300,325,350,375,400,3000,3050,390,425,1340,1360,335,370,3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1000,1200,1400,1600],'cm^-1')),
...
species(
    label = 'CCCC[CH]CCC=O(3771)',
    structure = SMILES('CCCC[CH]CCC=O'),
    E0 = (-127.766,'kJ/mol'),
    modes = [
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.45922,0.0709178,5.68052e-05,-2.84646e-07,2.67385e-10,-15291.2,32.7305], Tmin=(100,'K'), Tmax=(405.613,'K')), NASAPolynomial(coeffs=[3.79255,0.0715325,-3.28368e-05,6.28946e-09,-4.40781e-13,-15674.9,21.1834], Tmin=(405.613,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-127.766,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(552.912,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(RCCJCC)"""),
)

species(
    label = 'CCCC=CCC[CH]O(3772)',
    structure = SMILES('CCCC=CCC[CH]O'),
    E0 = (-102.283,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,2995,3025,975,1000,1300,1375,400,500,1630,1680,3025,407.5,1350,352.5,3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (127.204,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.569036,0.101504,-8.14878e-05,3.63188e-08,-6.88531e-12,-12138.3,37.9382], Tmin=(100,'K'), Tmax=(1214.64,'K')), NASAPolynomial(coeffs=[13.7681,0.0542891,-2.31809e-05,4.31642e-09,-2.985e-13,-15621.2,-34.0181], Tmin=(1214.64,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-102.283,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(552.912,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(CCsJOH)"""),
)

species(
    label = 'CCCCC=CC[CH]O(3773)',
    structure = SMILES('CCCCC=CC[CH]O'),
    E0 = (-102.283,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,2995,3025,975,1000,1300,1375,400,500,1630,1680,3025,407.5,1350,352.5,3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    ...
    molecularWeight = (127.204,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.16682,0.100925,-7.1422e-05,2.23106e-08,-1.4754e-12,-14954.8,40.0276], Tmin=(100,'K'), Tmax=(1105.08,'K')), NASAPolynomial(coeffs=[19.2732,0.0437137,-1.65338e-05,2.93365e-09,-1.99202e-13,-20496.6,-65.2599], Tmin=(1105.08,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-125.977,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(552.912,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(RCCJCC)"""),
)
...
species(
    ...
    molecularWeight = (128.212,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.322497,0.104399,-0.000115612,9.96186e-08,-3.82487e-11,2661.66,40.2262], Tmin=(100,'K'), Tmax=(772.586,'K')), NASAPolynomial(coeffs=[2.08983,0.0776134,-3.585e-05,6.84014e-09,-4.76278e-13,2715.58,31.9718], Tmin=(772.586,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(20.9109,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(577.856,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(CCOJ)"""),
)

species(
    label = 'CCC[CH]CCC[CH]O(3776)',
    structure = SMILES('CCC[CH]CCC[CH]O'),
    E0 = (-24.4963,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2761.11,2772.22,2783.33,2794.44,2805.56,2816.67,2827.78,2838.89,2850,1425,1431.25,1437.5,1443.75,1450,1225,1237.5,1250,1262.5,1275,1270,1287.5,1305,1322.5,1340,700,725,750,775,800,300,325,350,375,400,3000,3050,390,425,1340,1360,335,370,3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'CCCC[CH]C[CH]CO(3777)',
    structure = SMILES('CCCC[CH]C[CH]CO'),
    E0 = (-4.89216,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2761.11,2772.22,2783.33,2794.44,2805.56,2816.67,2827.78,2838.89,2850,1425,1431.25,1437.5,1443.75,1450,1225,1237.5,1250,1262.5,1275,1270,1287.5,1305,1322.5,1340,700,725,750,775,800,300,325,350,375,400,3000,3050,390,425,1340,1360,335,370,3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (128.212,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.106634,0.0970828,-7.59123e-05,3.73271e-08,-8.55966e-12,-446.225,41.1076], Tmin=(100,'K'), Tmax=(969.849,'K')), NASAPolynomial(coeffs=[7.11739,0.0672888,-2.98325e-05,5.65266e-09,-3.94993e-13,-1847.49,6.47691], Tmin=(969.849,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-4.89216,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(573.699,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCJCO) + radical(RCCJCC)"""),
)

species(
    label = 'CC[CH]CCCC[CH]O(3778)',
    structure = SMILES('CC[CH]CCCC[CH]O'),
    E0 = (-24.4963,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2761.11,2772.22,2783.33,2794.44,2805.56,2816.67,2827.78,2838.89,2850,1425,1431.25,1437.5,1443.75,1450,1225,1237.5,1250,1262.5,1275,1270,1287.5,1305,1322.5,1340,700,725,750,775,800,300,325,350,375,400,3000,3050,390,425,1340,1360,335,370,3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (128.212,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0791078,0.100009,-5.48327e-05,-5.17838e-08,7.13216e-11,-2818.72,37.6733], Tmin=(100,'K'), Tmax=(510.519,'K')), NASAPolynomial(coeffs=[7.02656,0.0687268,-3.09475e-05,5.85889e-09,-4.07407e-13,-3829.8,5.87188], Tmin=(510.519,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-24.4963,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(573.699,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCsJOH) + radical(RCCJCC)"""),
)

species(
    label = 'CCCCCC[CH][CH]O(3779)',
    structure = SMILES('CCCCCC[CH][CH]O'),
    E0 = (-19.0526,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2761.11,2772.22,2783.33,2794.44,2805.56,2816.67,2827.78,2838.89,2850,1425,1431.25,1437.5,1443.75,1450,1225,1237.5,1250,1262.5,1275,1270,1287.5,1305,1322.5,1340,700,725,750,775,800,300,325,350,375,400,3000,3050,390,425,1340,1360,335,370,3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (128.212,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.727564,0.106727,-8.89603e-05,4.21299e-08,-8.55566e-12,-2123.64,40.3052], Tmin=(100,'K'), Tmax=(1137.13,'K')), NASAPolynomial(coeffs=[13.0329,0.0583231,-2.51098e-05,4.69622e-09,-3.25796e-13,-5253.13,-27.8494], Tmin=(1137.13,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-19.0526,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(573.699,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCsJOH) + radical(CCJCO)"""),
)

species(
    label = 'CCCC[CH][CH]CCO(3780)',
    structure = SMILES('CCCC[CH][CH]CCO'),
    E0 = (-10.3359,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2761.11,2772.22,2783.33,2794.44,2805.56,2816.67,2827.78,2838.89,2850,1425,1431.25,1437.5,1443.75,1450,1225,1237.5,1250,1262.5,1275,1270,1287.5,1305,1322.5,1340,700,725,750,775,800,300,325,350,375,400,3000,3050,390,425,1340,1360,335,370,3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,180,180,540.417,1600,1781.48,3200],'cm^-1')),
        HinderedRotor(inertia=(0.143834,'amu*angstrom^2'), symmetry=1, barrier=(3.30703,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.143834,'amu*angstrom^2'), symmetry=1, barrier=(3.30703,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.143834,'amu*angstrom^2'), symmetry=1, barrier=(3.30703,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.143834,'amu*angstrom^2'), symmetry=1, barrier=(3.30703,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.143834,'amu*angstrom^2'), symmetry=1, barrier=(3.30703,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (128.212,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.452312,0.107873,-0.000128061,1.11375e-07,-4.14672e-11,-1092.43,42.3946], Tmin=(100,'K'), Tmax=(803.683,'K')), NASAPolynomial(coeffs=[2.69598,0.0748244,-3.39399e-05,6.39284e-09,-4.40676e-13,-1037.19,31.3859], Tmin=(803.683,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-10.3359,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(573.699,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(RCCJCC)"""),
)

species(
    label = 'C[CH]CCCCC[CH]O(3781)',
    structure = SMILES('C[CH]CCCCC[CH]O'),
    E0 = (-24.5084,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.212,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.803682,0.112914,-0.000119047,8.23386e-08,-2.50913e-11,-2781.32,40.8309], Tmin=(100,'K'), Tmax=(776.863,'K')), NASAPolynomial(coeffs=[8.19068,0.0665977,-2.96096e-05,5.57969e-09,-3.87255e-13,-4178.66,-0.289765], Tmin=(776.863,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-24.5084,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(573.699,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(RCCJC) + radical(CCsJOH)"""),
)

species(
    label = '[CH2]CCCCCC[CH]O(3782)',
    structure = SMILES('[CH2]CCCCCC[CH]O'),
    E0 = (-13.7083,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (128.212,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.810345,0.111604,-0.000103498,5.70773e-08,-1.36309e-11,-1480.38,39.9065], Tmin=(100,'K'), Tmax=(977.804,'K')), NASAPolynomial(coeffs=[11.3197,0.0619819,-2.73765e-05,5.17773e-09,-3.61472e-13,-3852.56,-18.3419], Tmin=(977.804,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-13.7083,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(573.699,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(RCCJ) + radical(CCsJOH)"""),
)

species(
    label = 'CCC[CH][CH]CCCO(3783)',
    structure = SMILES('CCC[CH][CH]CCCO'),
    E0 = (-10.3359,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2761.11,2772.22,2783.33,2794.44,2805.56,2816.67,2827.78,2838.89,2850,1425,1431.25,1437.5,1443.75,1450,1225,1237.5,1250,1262.5,1275,1270,1287.5,1305,1322.5,1340,700,725,750,775,800,300,325,350,375,400,3000,3050,390,425,1340,1360,335,370,3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,180,180,540.417,1600,1781.48,3200],'cm^-1')),
        HinderedRotor(inertia=(0.143834,'amu*angstrom^2'), symmetry=1, barrier=(3.30703,'kJ/mol'), semiclassical=False),
...
species(
    label = 'CCCCCCC[CH][O](3784)',
    structure = SMILES('CCCCCCC[CH][O]'),
    E0 = (6.75049,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (128.212,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0911401,0.101594,-7.07813e-05,-5.32942e-12,2.598e-11,948.19,36.5029], Tmin=(100,'K'), Tmax=(551.25,'K')), NASAPolynomial(coeffs=[6.16095,0.0719962,-3.31516e-05,6.37869e-09,-4.49216e-13,19.3082,7.89054], Tmin=(551.25,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(6.75049,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(577.856,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(CCsJOH)"""),
)

species(
    label = 'CC[CH]C[CH]CCCO(3785)',
    structure = SMILES('CC[CH]C[CH]CCCO'),
    E0 = (-10.3359,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2761.11,2772.22,2783.33,2794.44,2805.56,2816.67,2827.78,2838.89,2850,1425,1431.25,1437.5,1443.75,1450,1225,1237.5,1250,1262.5,1275,1270,1287.5,1305,1322.5,1340,700,725,750,775,800,300,325,350,375,400,3000,3050,390,425,1340,1360,335,370,3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,180,180,540.417,1600,1781.48,3200],'cm^-1')),
        HinderedRotor(inertia=(0.143834,'amu*angstrom^2'), symmetry=1, barrier=(3.30703,'kJ/mol'), semiclassical=False),
...
species(
    label = 'C[CH]CC[CH]CCCO(3786)',
    structure = SMILES('C[CH]CC[CH]CCCO'),
    E0 = (-10.3479,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2761.11,2772.22,2783.33,2794.44,2805.56,2816.67,2827.78,2838.89,2850,1425,1431.25,1437.5,1443.75,1450,1225,1237.5,1250,1262.5,1275,1270,1287.5,1305,1322.5,1340,700,725,750,775,800,300,325,350,375,400,3000,3050,390,425,1340,1360,335,370,3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,180,180,699.015,1600,1644.04,3200],'cm^-1')),
        HinderedRotor(inertia=(0.147437,'amu*angstrom^2'), symmetry=1, barrier=(3.38987,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.147437,'amu*angstrom^2'), symmetry=1, barrier=(3.38987,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.147437,'amu*angstrom^2'), symmetry=1, barrier=(3.38987,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.147437,'amu*angstrom^2'), symmetry=1, barrier=(3.38987,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.147437,'amu*angstrom^2'), symmetry=1, barrier=(3.38987,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (128.212,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.474999,0.107208,-0.000122117,1.01886e-07,-3.7096e-11,-1091.89,42.6491], Tmin=(100,'K'), Tmax=(793.537,'K')), NASAPolynomial(coeffs=[3.7341,0.0729709,-3.27888e-05,6.16291e-09,-4.24945e-13,-1349.97,25.899], Tmin=(793.537,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-10.3479,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(573.699,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(RCCJC)"""),
)

species(
    label = '[CH2]CCC[CH]CCCO(3787)',
    structure = SMILES('[CH2]CCC[CH]CCCO'),
    E0 = (0.452145,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2759.09,2768.18,2777.27,2786.36,2795.45,2804.55,2813.64,2822.73,2831.82,2840.91,2850,1425,1430,1435,1440,1445,1450,1225,1235,1245,1255,1265,1275,1270,1284,1298,1312,1326,1340,700,720,740,760,780,800,300,320,340,360,380,400,3615,1277.5,1000,3000,3100,440,815,1455,1000,3025,407.5,1350,352.5,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (128.212,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.107544,0.0967077,-6.06227e-05,-1.21141e-08,3.2247e-11,183.978,39.7351], Tmin=(100,'K'), Tmax=(547.638,'K')), NASAPolynomial(coeffs=[5.94208,0.0701114,-3.1653e-05,6.03545e-09,-4.22921e-13,-695.287,12.9068], Tmin=(547.638,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(0.452145,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(573.699,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(RCCJ) + radical(RCCJCC)"""),
)

species(
    label = 'CCCCC=CCCO(3788)',
    structure = SMILES('CCCCC=CCCO'),
    E0 = (-282.581,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.212,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.690679,0.0973085,-6.56962e-05,2.30998e-08,-3.37923e-12,-33813.5,38.8269], Tmin=(100,'K'), Tmax=(1547.88,'K')), NASAPolynomial(coeffs=[17.2667,0.0509037,-2.07271e-05,3.73193e-09,-2.51124e-13,-39372.8,-55.6527], Tmin=(1547.88,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-282.581,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(577.856,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH)"""),
)

species(
    label = 'CCCCCCC=CO(3789)',
    structure = SMILES('CCCCCCC=CO'),
    E0 = (-320.435,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.212,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.32392,0.0993932,-4.42457e-05,-1.72293e-08,1.48774e-11,-38332.1,38.0232], Tmin=(100,'K'), Tmax=(989.116,'K')), NASAPolynomial(coeffs=[22.6818,0.041161,-1.4848e-05,2.66335e-09,-1.86428e-13,-44981.3,-87.1338], Tmin=(989.116,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-320.435,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(577.856,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH)"""),
)

species(
    label = 'CCCC=CCCCO(3790)',
    structure = SMILES('CCCC=CCCCO'),
    E0 = (-282.581,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.212,'amu'),
...
species(
    label = 'CCCCCCCC=O(151)',
    structure = SMILES('CCCCCCCC=O'),
    E0 = (-322.224,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.212,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.00298168,0.093119,-5.90965e-05,1.96179e-08,-2.8268e-12,-38616.2,34.9401], Tmin=(100,'K'), Tmax=(1471.92,'K')), NASAPolynomial(coeffs=[11.6623,0.0614345,-2.68077e-05,4.99355e-09,-3.42919e-13,-42048.5,-25.8163], Tmin=(1471.92,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-322.224,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(577.856,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsH)"""),
)
...
species(
    label = '[CH2]C(CCC)CC[CH]O(3791)',
    structure = SMILES('[CH2]C(CCC)CC[CH]O'),
    E0 = (-16.2194,'kJ/mol'),
    modes = [
...
reaction(
    label = 'reaction1',
    reactants = ['CCCC[CH]CC[CH]O(1279)'],
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'CCCC[CH]CCC=O(3771)'],
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'CCCC=CCC[CH]O(3772)'],
    products = ['CCCC[CH]CC[CH]O(1279)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', 'CCCCC=CC[CH]O(3773)'],
    products = ['CCCC[CH]CC[CH]O(1279)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(1.46e+08,'cm^3/(mol*s)'), n=1.64, Ea=(5.73208,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""From training reaction 2555 used for Cds-CsH_Cds-CsH;HJ
Exact match found for rate rule [Cds-CsH_Cds-CsH;HJ]
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)', 'CCCC[CH]CC=CO(3774)'],
    products = ['CCCC[CH]CC[CH]O(1279)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['npropyl(83)', 'C=CCC[CH]O(2985)'],
    products = ['CCCC[CH]CC[CH]O(1279)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction10',
    reactants = ['CCC[CH]CCC[CH]O(3776)'],
    products = ['CCCC[CH]CC[CH]O(1279)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CCCC[CH]C[CH]CO(3777)'],
    products = ['CCCC[CH]CC[CH]O(1279)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CC[CH]CCCC[CH]O(3778)'],
    products = ['CCCC[CH]CC[CH]O(1279)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]CCCCCC[CH]O(3782)'],
    products = ['CCCC[CH]CC[CH]O(1279)'],
...
reaction(
    label = 'reaction20',
    reactants = ['CC[CH]C[CH]CCCO(3785)'],
    products = ['CCCC[CH]CC[CH]O(1279)'],
...
reaction(
    label = 'reaction21',
    reactants = ['C[CH]CC[CH]CCCO(3786)'],
    products = ['CCCC[CH]CC[CH]O(1279)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH2]CCC[CH]CCCO(3787)'],
    products = ['CCCC[CH]CC[CH]O(1279)'],
...
reaction(
    label = 'reaction28',
    reactants = ['CH2(S)(23)', 'CCC[CH]CC[CH]O(1289)'],
    products = ['CCCC[CH]CC[CH]O(1279)'],
...
reaction(
    label = 'reaction29',
    reactants = ['[CH2]C(CCC)CC[CH]O(3791)'],
    products = ['CCCC[CH]CC[CH]O(1279)'],
...
reaction(
    label = 'reaction28',
    reactants = ['[CH2]C(O)C[CH]CCCC(1281)'],
    products = ['CCCC[CH]CC[CH]O(1279)'],
...
reaction(
    label = 'reaction33',
    reactants = ['[CH]CCCC(141)', '[CH2]C[CH]O(562)'],
    products = ['CCCC[CH]CC[CH]O(1279)'],
...
reaction(
    label = 'reaction34',
    reactants = ['[CH2]C[CH]CCCC(199)', 'HCOH(T)(285)'],
    products = ['CCCC[CH]CC[CH]O(1279)'],
