species(
    label = '[CH]=CO[CH]O(1169)',
    structure = SMILES('[CH]=CO[CH]O'),
    E0 = (96.1405,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,3120,650,792.5,1650,3615,1277.5,1000,3010,987.5,1337.5,450,1655,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.964885,'amu*angstrom^2'), symmetry=1, barrier=(22.1846,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.964779,'amu*angstrom^2'), symmetry=1, barrier=(22.1822,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.965173,'amu*angstrom^2'), symmetry=1, barrier=(22.1912,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (72.0627,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.238212,0.0604662,-7.0337e-05,3.62107e-08,-6.65958e-12,11717.7,22.4687], Tmin=(100,'K'), Tmax=(1622.78,'K')), NASAPolynomial(coeffs=[19.1446,-0.00323544,4.35048e-06,-9.65455e-10,6.79805e-14,7832.98,-70.9598], Tmin=(1622.78,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(96.1405,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-OsOsHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(OCJO) + radical(Cds_P)"""),
)
...
species(
    ...
    E0 = (-47.1032,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,3010,987.5,1337.5,450,1655,2782.5,750,1395,475,1775,1000,180],'cm^-1')),
        HinderedRotor(inertia=(1.29415,'amu*angstrom^2'), symmetry=1, barrier=(29.755,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.29323,'amu*angstrom^2'), symmetry=1, barrier=(29.7339,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (71.0547,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.19391,0.03094,-7.7284e-06,-1.74814e-08,1.00755e-11,-5592.31,16.0124], Tmin=(100,'K'), Tmax=(977.485,'K')), NASAPolynomial(coeffs=[13.1042,0.00690242,-2.46642e-06,4.9879e-10,-3.95315e-14,-8709.78,-41.411], Tmin=(977.485,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-47.1032,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-Cd)) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(Cds-OdOsH) + radical(Cds_P)"""),
)
...
species(
    ...
    E0 = (146.924,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3120,650,792.5,1650,3615,1277.5,1000,1685,370,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.95043,'amu*angstrom^2'), symmetry=1, barrier=(21.8523,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.95205,'amu*angstrom^2'), symmetry=1, barrier=(21.8895,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.949587,'amu*angstrom^2'), symmetry=1, barrier=(21.8329,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (72.0627,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.5221,0.0338835,2.49846e-05,-8.27987e-08,4.2075e-11,17779.6,21.1923], Tmin=(100,'K'), Tmax=(896.588,'K')), NASAPolynomial(coeffs=[24.6117,-0.0131482,1.00152e-05,-2.03077e-09,1.36741e-13,11389.3,-100.229], Tmin=(896.588,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(146.924,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-OsOsHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C=CJO) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', '[CH]=COC=O(807)'],
    products = ['[CH]=CO[CH]O(1169)'],
    transitionState = 'TS2',
...
reaction(
    ...
    products = ['[CH]=CO[CH]O(1169)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(8000,'m^3/(mol*s)'), n=1.39, Ea=(35.8862,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Od_CO-NdH;YJ] for rate rule [Od_CO-NdH;CJ]
Euclidian distance = 1.0
