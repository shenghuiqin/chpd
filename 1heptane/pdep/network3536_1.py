species(
    label = '[CH2]OC[CH]C=C(18941)',
    structure = SMILES('[CH2]OC[CH]C=C'),
    E0 = (149.085,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2950,3100,1380,975,1025,1650,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,3025,407.5,1350,352.5,316.81,316.877,529.99,1645.15],'cm^-1')),
        HinderedRotor(inertia=(0.390649,'amu*angstrom^2'), symmetry=1, barrier=(27.8778,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00168071,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.391235,'amu*angstrom^2'), symmetry=1, barrier=(27.8779,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.44556,'amu*angstrom^2'), symmetry=1, barrier=(103.003,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.958191,0.0580248,-4.30205e-05,1.6349e-08,-2.50433e-12,18047.7,23.9406], Tmin=(100,'K'), Tmax=(1542.07,'K')), NASAPolynomial(coeffs=[14.5503,0.022768,-8.7256e-06,1.52269e-09,-1.00694e-13,13855.7,-47.5207], Tmin=(1542.07,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(149.085,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-OsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CsJOCC) + radical(C=CCJCO)"""),
)
...
species(
    label = '[CH2]OC=CC=C(19506)',
    structure = SMILES('[CH2]OC=CC=C'),
    E0 = (95.8203,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,3100,1380,975,1025,1650,2995,3010,3025,975,987.5,1000,1300,1337.5,1375,400,450,500,1630,1655,1680,3000,3100,440,815,1455,1000,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.962605,'amu*angstrom^2'), symmetry=1, barrier=(22.1322,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.961667,'amu*angstrom^2'), symmetry=1, barrier=(22.1106,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.95963,'amu*angstrom^2'), symmetry=1, barrier=(22.0638,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
species(
    label = '[CH2]OCC=C=C(19507)',
    structure = SMILES('[CH2]OCC=C=C'),
    E0 = (202.084,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2950,3100,1380,975,1025,1650,540,610,2055,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.00112267,'amu*angstrom^2'), symmetry=1, barrier=(7.76997,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0255784,'amu*angstrom^2'), symmetry=1, barrier=(16.7051,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.44289,'amu*angstrom^2'), symmetry=1, barrier=(33.175,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (83.1085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.78419,0.0478898,-3.37348e-05,1.28081e-08,-2.06548e-12,24385.3,22.7576], Tmin=(100,'K'), Tmax=(1397.49,'K')), NASAPolynomial(coeffs=[9.13282,0.0268561,-1.11583e-05,2.03806e-09,-1.38821e-13,22331.4,-15.1547], Tmin=(1397.49,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(202.084,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)OsHH) + group(Cs-OsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(CsJOCC)"""),
)
...
species(
    ...
    E0 = (212.624,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2950,3100,1380,975,1025,1650,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,3025,407.5,1350,352.5,180,180,180,632.436],'cm^-1')),
        HinderedRotor(inertia=(0.0433545,'amu*angstrom^2'), symmetry=1, barrier=(12.3043,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00774409,'amu*angstrom^2'), symmetry=1, barrier=(2.19785,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00774359,'amu*angstrom^2'), symmetry=1, barrier=(2.19767,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2]OCC[C]=C(19508)',
    structure = SMILES('[CH2]OCC[C]=C'),
    E0 = (270.01,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,1685,370,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,339.713,339.713,339.714,4000],'cm^-1')),
        HinderedRotor(inertia=(0.0756755,'amu*angstrom^2'), symmetry=1, barrier=(6.19735,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.642685,'amu*angstrom^2'), symmetry=1, barrier=(52.6321,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00157617,'amu*angstrom^2'), symmetry=1, barrier=(17.896,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.376371,'amu*angstrom^2'), symmetry=1, barrier=(30.8226,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.66971,0.052693,-4.02132e-05,1.74992e-08,-3.32265e-12,32557.3,24.647], Tmin=(100,'K'), Tmax=(1190.81,'K')), NASAPolynomial(coeffs=[8.00515,0.031412,-1.3407e-05,2.49202e-09,-1.72066e-13,31048.4,-7.02425], Tmin=(1190.81,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(270.01,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-OsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CsJOCC) + radical(Cds_S)"""),
)

species(
    label = 'C=C[CH][CH]OC(19509)',
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.01485,0.0449902,-2.26203e-05,4.96352e-09,-4.08305e-13,12114.9,22.4184], Tmin=(100,'K'), Tmax=(2344.77,'K')), NASAPolynomial(coeffs=[19.8262,0.0179216,-7.42528e-06,1.24643e-09,-7.62964e-14,2850.62,-80.6334], Tmin=(2344.77,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(100.147,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)OsHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-OsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Allyl_P) + radical(C=CCJ(O)C)"""),
)

species(
    label = '[CH]=CCCO[CH2](19510)',
    structure = SMILES('[CH]=CCCO[CH2]'),
    E0 = (279.264,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3120,650,792.5,1650,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,312.738,313.758,1433.38],'cm^-1')),
        HinderedRotor(inertia=(0.108598,'amu*angstrom^2'), symmetry=1, barrier=(7.5485,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00199349,'amu*angstrom^2'), symmetry=1, barrier=(7.54784,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.278563,'amu*angstrom^2'), symmetry=1, barrier=(19.2514,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.27808,'amu*angstrom^2'), symmetry=1, barrier=(19.2604,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.42395,0.0540345,-4.0488e-05,1.63474e-08,-2.75559e-12,33682.5,25.4572], Tmin=(100,'K'), Tmax=(1370.16,'K')), NASAPolynomial(coeffs=[10.6617,0.027066,-1.09636e-05,1.98185e-09,-1.3441e-13,31151.1,-22.0185], Tmin=(1370.16,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(279.264,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-OsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_P) + radical(CsJOCC)"""),
)

species(
    label = 'C=[C][CH]COC(19511)',
    structure = SMILES('C=[C][CH]COC'),
    E0 = (199.155,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2950,3100,1380,975,1025,1650,1685,370,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,180.018,180.146,503.024,2936.66],'cm^-1')),
        HinderedRotor(inertia=(0.11802,'amu*angstrom^2'), symmetry=1, barrier=(15.7611,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.684563,'amu*angstrom^2'), symmetry=1, barrier=(15.7412,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.536081,'amu*angstrom^2'), symmetry=1, barrier=(42.1724,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.251303,'amu*angstrom^2'), symmetry=1, barrier=(42.1595,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.5687,0.0576516,-4.78821e-05,2.32911e-08,-5.05754e-12,24036.9,20.5292], Tmin=(100,'K'), Tmax=(1040.46,'K')), NASAPolynomial(coeffs=[7.23358,0.0358732,-1.64846e-05,3.17342e-09,-2.23667e-13,22858.1,-7.02526], Tmin=(1040.46,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(199.155,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-OsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_S) + radical(C=CCJCO)"""),
)

species(
    label = '[CH]=C[CH]COC(19512)',
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.87289,0.0490796,-2.38982e-05,5.1245e-09,-4.18142e-13,25137.9,22.8109], Tmin=(100,'K'), Tmax=(2517.64,'K')), NASAPolynomial(coeffs=[22.4087,0.0190985,-7.6121e-06,1.22941e-09,-7.28141e-14,13959,-96.8889], Tmin=(2517.64,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(208.393,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)OsHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-OsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(AllylJ2_triplet)"""),
)
...
species(
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.91457,0.0360958,9.46283e-06,-3.30705e-08,1.38881e-11,34223.3,24.4412], Tmin=(100,'K'), Tmax=(1014.36,'K')), NASAPolynomial(coeffs=[9.92293,0.0270477,-1.04769e-05,1.93329e-09,-1.36252e-13,31439.5,-20.0225], Tmin=(1014.36,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(283.854,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-OsHHH) + ring(Cyclopropane) + radical(cyclopropane) + radical(CsJOCC)"""),
)
...
species(
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.09372,0.0448341,2.17395e-05,-7.33976e-08,3.52678e-11,-11446.4,19.9207], Tmin=(100,'K'), Tmax=(926.374,'K')), NASAPolynomial(coeffs=[20.6562,0.00952508,-6.88329e-07,2.74568e-11,-6.82528e-15,-17180.2,-84.3461], Tmin=(926.374,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-96.1873,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-OsHHH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsOsH) + group(Cds-CdsHH)"""),
)

species(
    label = 'C=C=CCOC(19516)',
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.10108,0.0468568,-2.77559e-05,8.42011e-09,-1.12324e-12,1784.72,19.9165], Tmin=(100,'K'), Tmax=(1503.13,'K')), NASAPolynomial(coeffs=[6.83731,0.0342531,-1.51785e-05,2.84182e-09,-1.95467e-13,360.886,-4.86336], Tmin=(1503.13,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(14.3125,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)OsHH) + group(Cs-OsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cdd-CdsCds)"""),
)

species(
    label = 'C=CC1COC1(18945)',
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.24997,0.0231531,6.05123e-05,-9.92178e-08,4.246e-11,-2817.42,17.7819], Tmin=(100,'K'), Tmax=(889.709,'K')), NASAPolynomial(coeffs=[11.9937,0.0202143,-3.43371e-06,3.25407e-10,-1.76461e-14,-6168.74,-37.1774], Tmin=(889.709,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-24.0696,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(328.422,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Oxetane)"""),
)
...
species(
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.18391,0.030594,2.79462e-05,-5.71973e-08,2.52722e-11,29765.4,21.8522], Tmin=(100,'K'), Tmax=(889.583,'K')), NASAPolynomial(coeffs=[8.76608,0.0262357,-7.26164e-06,1.08066e-09,-6.84671e-14,27595.7,-14.7458], Tmin=(889.583,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(246.867,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(324.264,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Oxetane) + radical(RCCJ) + radical(Cs_S)"""),
)

species(
    label = '[CH2]OCC=[C]C(19519)',
    structure = SMILES('[CH2]OCC=[C]C'),
    E0 = (263.321,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.83469,0.0511929,-4.29266e-05,2.4434e-08,-6.60562e-12,31745.1,24.0127], Tmin=(100,'K'), Tmax=(836.253,'K')), NASAPolynomial(coeffs=[4.96103,0.0362389,-1.61036e-05,3.0506e-09,-2.13035e-13,31222.2,9.48897], Tmin=(836.253,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(263.321,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)OsHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-OsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(CsJOCC) + radical(Cds_S)"""),
)

species(
    label = '[CH2]OC[C]=CC(19520)',
    structure = SMILES('[CH2]OC[C]=CC'),
    E0 = (263.321,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,1685,370,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,3010,987.5,1337.5,450,1655,322.729,322.729,2148.63],'cm^-1')),
        HinderedRotor(inertia=(0.00161854,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.104145,'amu*angstrom^2'), symmetry=1, barrier=(7.69743,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.104136,'amu*angstrom^2'), symmetry=1, barrier=(7.69736,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.104164,'amu*angstrom^2'), symmetry=1, barrier=(7.69743,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
...
species(
    label = '[CH2]C=[C]COC(19521)',
    structure = SMILES('[CH2]C=[C]COC'),
    E0 = (227.049,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,1685,370,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,3010,987.5,1337.5,450,1655,313.516,313.563,2611.85],'cm^-1')),
        HinderedRotor(inertia=(0.00171501,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.132951,'amu*angstrom^2'), symmetry=1, barrier=(9.27565,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.132937,'amu*angstrom^2'), symmetry=1, barrier=(9.27556,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.655872,'amu*angstrom^2'), symmetry=1, barrier=(45.7397,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.91021,0.0503193,-3.69579e-05,1.70038e-08,-3.78607e-12,27379.3,22.3331], Tmin=(100,'K'), Tmax=(965.167,'K')), NASAPolynomial(coeffs=[4.99592,0.0375313,-1.70841e-05,3.2768e-09,-2.30549e-13,26783.6,7.55568], Tmin=(965.167,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(227.049,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)OsHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-OsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Allyl_P) + radical(Cds_S)"""),
)

species(
    label = '[CH2]O[CH]C=CC(19522)',
...
species(
    label = '[CH]=CCO[CH2](19523)',
    structure = SMILES('[CH]=CCO[CH2]'),
    E0 = (308.601,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3120,650,792.5,1650,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,180,914.922],'cm^-1')),
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', '[CH2]OC=CC=C(19506)'],
    products = ['[CH2]OC[CH]C=C(18941)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', '[CH2]OCC=C=C(19507)'],
    products = ['[CH2]OC[CH]C=C(18941)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction18',
    reactants = ['CH2(19)', 'C=C[CH]C[O](19517)'],
    products = ['[CH2]OC[CH]C=C(18941)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2]O[CH2](103)', '[CH]=C[CH2](2461)'],
    products = ['[CH2]OC[CH]C=C(18941)'],
...
reaction(
    label = 'reaction26',
    reactants = ['CH2(19)', '[CH]=CCO[CH2](19523)'],
    products = ['[CH2]OC[CH]C=C(18941)'],
