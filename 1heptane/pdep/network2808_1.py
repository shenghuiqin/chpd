...
species(
    label = 'C=C(C)C[CH]OO(15001)',
    structure = SMILES('C=C(C)C[CH]OO'),
    E0 = (44.6832,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,2950,3100,1380,975,1025,1650,3615,1310,387.5,850,1000,350,440,435,1725,2750,2850,1437.5,1250,1305,750,350,180,363.793],'cm^-1')),
        HinderedRotor(inertia=(0.137055,'amu*angstrom^2'), symmetry=1, barrier=(13.0214,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00334829,'amu*angstrom^2'), symmetry=1, barrier=(13.0164,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.33644,'amu*angstrom^2'), symmetry=1, barrier=(42.8663,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.566573,'amu*angstrom^2'), symmetry=1, barrier=(13.0266,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.448053,'amu*angstrom^2'), symmetry=1, barrier=(42.8643,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (101.124,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.849035,0.0742557,-7.29322e-05,4.23704e-08,-1.06464e-11,5483.43,25.777], Tmin=(100,'K'), Tmax=(932.556,'K')), NASAPolynomial(coeffs=[8.71007,0.0405388,-1.87012e-05,3.60314e-09,-2.54049e-13,4017.2,-11.5994], Tmin=(932.556,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(44.6832,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(CCsJOOH)"""),
)

species(
    label = '[CH2]C(C)C=COO(15002)',
    structure = SMILES('[CH2]C(C)C=COO'),
    E0 = (72.5106,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,3615,1310,387.5,850,1000,3000,3100,440,815,1455,1000,1380,1390,370,380,2900,435,640.415],'cm^-1')),
        HinderedRotor(inertia=(0.629259,'amu*angstrom^2'), symmetry=1, barrier=(14.4679,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.196688,'amu*angstrom^2'), symmetry=1, barrier=(4.52223,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0497033,'amu*angstrom^2'), symmetry=1, barrier=(14.4685,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.629319,'amu*angstrom^2'), symmetry=1, barrier=(14.4693,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(3.4374,'amu*angstrom^2'), symmetry=1, barrier=(79.0325,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (101.124,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.572303,0.0666253,-4.32524e-05,5.90308e-09,3.53416e-12,8852.18,30.0633], Tmin=(100,'K'), Tmax=(986.975,'K')), NASAPolynomial(coeffs=[15.0727,0.0260535,-9.24451e-06,1.61058e-09,-1.09838e-13,5103.65,-44.1923], Tmin=(986.975,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(72.5106,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(Isobutyl)"""),
)
...
species(
    ...
    molecularWeight = (102.132,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.481342,0.0862246,-0.000119967,1.07801e-07,-3.95486e-11,13577.1,28.2532], Tmin=(100,'K'), Tmax=(813.309,'K')), NASAPolynomial(coeffs=[4.54839,0.0501138,-2.36581e-05,4.50535e-09,-3.11298e-13,13448.3,12.7477], Tmin=(813.309,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(111.904,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCsJOOH) + radical(Tertalkyl)"""),
)

species(
    label = '[CH2]C(C)[CH]COO(15004)',
    ...
    molecularWeight = (102.132,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.611141,0.0774881,-7.54844e-05,4.33898e-08,-1.0603e-11,17366.1,31.2954], Tmin=(100,'K'), Tmax=(968.176,'K')), NASAPolynomial(coeffs=[9.73477,0.0397942,-1.70853e-05,3.17756e-09,-2.19557e-13,15599.5,-12.4258], Tmin=(968.176,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(143.396,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Isobutyl) + radical(CCJCOOH)"""),
)

species(
    label = '[CH2]C(C)CCO[O](15005)',
    structure = SMILES('[CH2]C(C)CCO[O]'),
    E0 = (94.986,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,492.5,1135,1000,3000,3100,440,815,1455,1000,1380,1390,370,380,2900,435,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.109977,'amu*angstrom^2'), symmetry=1, barrier=(2.52858,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.1108,'amu*angstrom^2'), symmetry=1, barrier=(2.54752,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.110345,'amu*angstrom^2'), symmetry=1, barrier=(2.53705,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.110132,'amu*angstrom^2'), symmetry=1, barrier=(2.53215,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.480062,'amu*angstrom^2'), symmetry=1, barrier=(11.0376,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (102.132,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.787289,0.0726574,-6.72677e-05,3.77339e-08,-9.08808e-12,11538.2,29.1138], Tmin=(100,'K'), Tmax=(978.437,'K')), NASAPolynomial(coeffs=[8.93171,0.0393617,-1.62236e-05,2.95457e-09,-2.01622e-13,9944.4,-10.0008], Tmin=(978.437,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(94.986,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(Isobutyl)"""),
)

species(
    label = 'CC(C)[CH][CH]OO(15006)',
    structure = SMILES('CC(C)[CH][CH]OO'),
    E0 = (126.896,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (102.132,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.743958,0.076712,-7.29997e-05,4.15164e-08,-1.03054e-11,15375.1,28.5001], Tmin=(100,'K'), Tmax=(938.879,'K')), NASAPolynomial(coeffs=[8.54206,0.0434887,-1.992e-05,3.82584e-09,-2.69292e-13,13910.8,-8.62938], Tmin=(938.879,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(126.896,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJCOOH) + radical(CCsJOOH)"""),
)

species(
    label = '[CH2][C](C)CCOO(15007)',
    ...
    molecularWeight = (102.132,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.471715,0.0854121,-0.000116191,1.00379e-07,-3.52644e-11,15562.9,30.615], Tmin=(100,'K'), Tmax=(836.695,'K')), NASAPolynomial(coeffs=[5.51891,0.0468156,-2.10597e-05,3.91423e-09,-2.66391e-13,15224.7,10.1913], Tmin=(836.695,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(128.404,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Tertalkyl) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]C([CH2])CCOO(15008)',
    structure = SMILES('[CH2]C([CH2])CCOO'),
    E0 = (148.064,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (102.132,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.437378,0.079187,-7.95397e-05,4.68051e-08,-1.14579e-11,17935.5,30.6969], Tmin=(100,'K'), Tmax=(979.602,'K')), NASAPolynomial(coeffs=[10.8284,0.0367577,-1.45707e-05,2.59068e-09,-1.7413e-13,15899.7,-19.2196], Tmin=(979.602,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(148.064,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Isobutyl) + radical(Isobutyl)"""),
)

species(
    label = 'CC(C)C[CH]O[O](15009)',
    structure = SMILES('CC(C)C[CH]O[O]'),
    E0 = (78.4861,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (102.132,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.924739,0.0718297,-6.46161e-05,3.56595e-08,-8.70971e-12,9546.89,26.3016], Tmin=(100,'K'), Tmax=(947.506,'K')), NASAPolynomial(coeffs=[7.74233,0.0430487,-1.90531e-05,3.60148e-09,-2.51232e-13,8254.94,-6.22172], Tmin=(947.506,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(78.4861,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(CCsJOOH)"""),
)

species(
    label = 'C=C(C)CCOO(15010)',
    ...
    molecularWeight = (102.132,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.840137,0.0717954,-5.79585e-05,2.57758e-08,-4.90747e-12,-17195.4,25.6436], Tmin=(100,'K'), Tmax=(1200.63,'K')), NASAPolynomial(coeffs=[10.5555,0.0394276,-1.752e-05,3.32168e-09,-2.31965e-13,-19528.3,-23.004], Tmin=(1200.63,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-143.899,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH)"""),
)

species(
    label = 'CC(C)C=COO(15011)',
    structure = SMILES('CC(C)C=COO'),
    E0 = (-132.572,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (102.132,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.531571,0.0651836,-3.14794e-05,-5.83619e-09,6.90358e-12,-15810.2,27.7362], Tmin=(100,'K'), Tmax=(1027.13,'K')), NASAPolynomial(coeffs=[15.5261,0.0290237,-1.11423e-05,2.03895e-09,-1.4284e-13,-20063.3,-50.7142], Tmin=(1027.13,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-132.572,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'C=C(C)C[CH]OO(15001)'],
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', '[CH2]C(C)C=COO(15002)'],
    products = ['[CH2]C(C)C[CH]OO(13435)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction7',
    reactants = ['OH(5)', '[CH2]C(C)CC=O(1232)'],
    products = ['[CH2]C(C)C[CH]OO(13435)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]C(C)[CH]COO(15004)'],
    products = ['[CH2]C(C)C[CH]OO(13435)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction18',
    reactants = ['CH2(S)(23)', '[CH2]CC[CH]OO(2083)'],
    products = ['[CH2]C(C)C[CH]OO(13435)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[CH2]C([CH2])C(438)', '[CH]OO(168)'],
    products = ['[CH2]C(C)C[CH]OO(13435)'],
