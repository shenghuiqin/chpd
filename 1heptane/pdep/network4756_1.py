...
species(
    label = 'CCCCC(=O)CCO[O](28396)',
    structure = SMILES('CCCCC(=O)CCO[O]'),
    E0 = (-267.489,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2761.11,2772.22,2783.33,2794.44,2805.56,2816.67,2827.78,2838.89,2850,1425,1431.25,1437.5,1443.75,1450,1225,1237.5,1250,1262.5,1275,1270,1287.5,1305,1322.5,1340,700,725,750,775,800,300,325,350,375,400,375,552.5,462.5,1710,492.5,1135,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.17436,0.125539,-0.000175996,1.54139e-07,-5.50644e-11,-31996.5,39.5982], Tmin=(100,'K'), Tmax=(812.608,'K')), NASAPolynomial(coeffs=[6.85472,0.0665703,-3.12475e-05,5.93747e-09,-4.09761e-13,-32659.4,6.4793], Tmin=(812.608,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-267.489,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(527.969,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdCsCs) + radical(ROOJ)"""),
)
...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.247081,0.104124,-0.000160875,1.44026e-07,-5.11519e-11,-19142.4,31.6551], Tmin=(100,'K'), Tmax=(826.01,'K')), NASAPolynomial(coeffs=[7.42605,0.0475989,-2.3057e-05,4.40861e-09,-3.04023e-13,-19749.3,0.102821], Tmin=(826.01,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-160.344,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdCsCs) + radical(CJCC=O)"""),
)
...
species(
    label = '[CH2]C(=O)CCOO(28398)',
    structure = SMILES('C=C([O])CCOO'),
    E0 = (-181.598,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2950,3100,1380,975,1025,1650,3615,1310,387.5,850,1000,350,440,435,1725,327.206,329.975,330.038],'cm^-1')),
        HinderedRotor(inertia=(0.00155818,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.165692,'amu*angstrom^2'), symmetry=1, barrier=(12.8529,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.164654,'amu*angstrom^2'), symmetry=1, barrier=(12.8168,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.320674,'amu*angstrom^2'), symmetry=1, barrier=(24.6925,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
species(
    ...
    molecularWeight = (145.176,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.178613,0.107454,-7.93881e-05,-3.20523e-08,6.86254e-11,-26275.9,37.973], Tmin=(100,'K'), Tmax=(506.793,'K')), NASAPolynomial(coeffs=[8.54073,0.0648254,-3.07395e-05,5.929e-09,-4.15477e-13,-27496,-1.48505], Tmin=(506.793,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-219.592,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(523.812,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdCsCs) + radical(CCJCC=O)"""),
)
...
species(
    label = '[CH2]CCC(=O)CCOO(28400)',
    structure = SMILES('[CH2]CCC(=O)CCOO'),
    E0 = (-190.467,'kJ/mol'),
    modes = [
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.714963,0.114602,-0.000166136,1.46585e-07,-5.24888e-11,-22748.7,36.7321], Tmin=(100,'K'), Tmax=(806.072,'K')), NASAPolynomial(coeffs=[7.2626,0.0576134,-2.77068e-05,5.3152e-09,-3.68626e-13,-23469.4,3.47133], Tmin=(806.072,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-190.467,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdCsCs) + radical(RCCJ)"""),
)

species(
    label = 'C[CH]CCC(=O)CCOO(28401)',
    ...
    molecularWeight = (145.176,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.23667,0.129331,-0.000190865,1.73852e-07,-6.34074e-11,-26892.1,41.7969], Tmin=(100,'K'), Tmax=(824.449,'K')), NASAPolynomial(coeffs=[5.34398,0.0700985,-3.34181e-05,6.36593e-09,-4.38843e-13,-27049.2,16.9473], Tmin=(824.449,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-225.048,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(523.812,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdCsCs) + radical(RCCJC)"""),
)
...
species(
    label = 'O=[C]CCOO(28402)',
    structure = SMILES('O=[C]CCOO'),
    E0 = (-121.386,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3615,1310,387.5,850,1000,1855,455,950,180],'cm^-1')),
        HinderedRotor(inertia=(0.392298,'amu*angstrom^2'), symmetry=1, barrier=(9.01969,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.39189,'amu*angstrom^2'), symmetry=1, barrier=(9.01033,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.391597,'amu*angstrom^2'), symmetry=1, barrier=(9.00359,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.392357,'amu*angstrom^2'), symmetry=1, barrier=(9.02107,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (89.07,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.054,0.0752745,-0.000135801,1.2694e-07,-4.46376e-11,-14503.3,22.6875], Tmin=(100,'K'), Tmax=(874.551,'K')), NASAPolynomial(coeffs=[6.24287,0.0277301,-1.34135e-05,2.51238e-09,-1.68804e-13,-14500.3,3.55582], Tmin=(874.551,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-121.386,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo library: DFT_QCI_thermo + radical(CCCJ=O)"""),
)

species(
    label = 'CCC[CH]C(=O)CCOO(28403)',
    structure = SMILES('CCCC=C([O])CCOO'),
    E0 = (-264.049,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,350,440,435,1725,3010,987.5,1337.5,450,1655,3615,1310,387.5,850,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (145.176,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.03496,0.110454,-0.00010022,4.92763e-08,-1.00095e-11,-31576.3,40.14], Tmin=(100,'K'), Tmax=(1164.21,'K')), NASAPolynomial(coeffs=[16.8506,0.0490026,-2.10445e-05,3.93774e-09,-2.7357e-13,-35740.8,-48.8667], Tmin=(1164.21,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-264.049,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(527.969,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-(Cds-Cd)H) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + radical(C=C(C)OJ)"""),
)
...
species(
    ...
    molecularWeight = (145.176,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.86247,0.108243,-9.72207e-05,4.79956e-08,-9.89186e-12,-30915.5,39.9062], Tmin=(100,'K'), Tmax=(1140.97,'K')), NASAPolynomial(coeffs=[15.4082,0.0512008,-2.22292e-05,4.178e-09,-2.90877e-13,-34628.3,-40.7362], Tmin=(1140.97,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-258.492,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(527.969,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-(Cds-Cd)H) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + radical(C=C(C)OJ)"""),
)
...
species(
    ...
    molecularWeight = (145.176,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.259136,0.102203,-2.71737e-05,-1.92466e-07,2.19325e-10,-25654.4,35.9025], Tmin=(100,'K'), Tmax=(444.859,'K')), NASAPolynomial(coeffs=[8.61055,0.065228,-3.10292e-05,5.92551e-09,-4.09766e-13,-26774.6,-1.86294], Tmin=(444.859,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-214.247,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(523.812,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdCsCs) + radical(RCCJ)"""),
)
...
species(
    label = 'CC[CH]C[C](O)CCOO(28407)',
    structure = SMILES('CC[CH]C[C](O)CCOO'),
    E0 = (-105.352,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (146.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.63508,0.136049,-0.000193603,1.67247e-07,-5.85828e-11,-12479.6,44.3751], Tmin=(100,'K'), Tmax=(817.948,'K')), NASAPolynomial(coeffs=[8.53144,0.0669249,-3.12498e-05,5.91423e-09,-4.06895e-13,-13493.6,1.33901], Tmin=(817.948,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-105.352,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(544.598,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(C2CsJOH) + radical(RCCJCC)"""),
)
...
species(
    label = 'C[CH]CC[C](O)CCOO(28408)',
    structure = SMILES('C[CH]CC[C](O)CCOO'),
    E0 = (-105.364,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1277.5,1000,360,370,350,2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,3615,1310,387.5,850,1000,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (146.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.66381,0.135462,-0.000187968,1.58208e-07,-5.44252e-11,-12478.8,44.6509], Tmin=(100,'K'), Tmax=(810.635,'K')), NASAPolynomial(coeffs=[9.58762,0.0650387,-3.00789e-05,5.67949e-09,-3.90755e-13,-13813.3,-4.24826], Tmin=(810.635,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-105.364,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(544.598,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(C2CsJOH) + radical(RCCJC)"""),
)
...
species(
    label = '[CH2]CCC[C](O)CCOO(28409)',
    structure = SMILES('[CH2]CCC[C](O)CCOO'),
    E0 = (-94.5635,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (146.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.40995,0.130138,-0.000153051,9.78518e-08,-2.19761e-11,-11188.8,42.8466], Tmin=(100,'K'), Tmax=(640.556,'K')), NASAPolynomial(coeffs=[11.9574,0.0618577,-2.87368e-05,5.49944e-09,-3.84118e-13,-13213,-18.1223], Tmin=(640.556,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-94.5635,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(544.598,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(C2CsJOH) + radical(RCCJ)"""),
)

species(
    label = 'CCCC[C](O)CCO[O](28410)',
    structure = SMILES('CCCC[C](O)CCO[O]'),
    E0 = (-147.805,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2761.11,2772.22,2783.33,2794.44,2805.56,2816.67,2827.78,2838.89,2850,1425,1431.25,1437.5,1443.75,1450,1225,1237.5,1250,1262.5,1275,1270,1287.5,1305,1322.5,1340,700,725,750,775,800,300,325,350,375,400,2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350,492.5,1135,1000,3615,1277.5,1000,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (146.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.56941,0.131248,-0.000171402,1.35937e-07,-4.48117e-11,-17584.6,42.3399], Tmin=(100,'K'), Tmax=(783.72,'K')), NASAPolynomial(coeffs=[11.024,0.0616458,-2.79901e-05,5.27102e-09,-3.63373e-13,-19394.9,-14.3031], Tmin=(783.72,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-147.805,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(548.755,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(C2CsJOH) + radical(ROOJ)"""),
)
...
species(
    label = 'C=C(CCOO)OCCC(28411)',
    structure = SMILES('C=C(CCOO)OCCC'),
    E0 = (-362.047,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (146.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.70112,0.118796,-0.000105741,4.88881e-08,-9.12967e-12,-43333.5,39.7755], Tmin=(100,'K'), Tmax=(1277.34,'K')), NASAPolynomial(coeffs=[21.965,0.0446842,-1.87104e-05,3.46477e-09,-2.39368e-13,-49379.4,-80.1927], Tmin=(1277.34,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-362.047,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(548.755,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH)"""),
)

species(
    label = 'CCCC=C(O)CCOO(28412)',
    structure = SMILES('CCCC=C(O)CCOO'),
    E0 = (-401.854,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (146.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.74256,0.118446,-0.00010665,5.00091e-08,-9.43458e-12,-48118.7,41.1776], Tmin=(100,'K'), Tmax=(1270.17,'K')), NASAPolynomial(coeffs=[22.2459,0.0429019,-1.74375e-05,3.18488e-09,-2.18508e-13,-54212.6,-80.2899], Tmin=(1270.17,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-401.854,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(548.755,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-(Cds-Cd)H) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH)"""),
)

species(
    label = 'C=C(CCCC)OCOO(28413)',
    structure = SMILES('C=C(CCCC)OCOO'),
    E0 = (-380.408,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,2950,3100,1380,975,1025,1650,350,440,435,1725,3615,1310,387.5,850,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (146.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.07199,0.108318,-4.17035e-05,-4.13067e-08,2.83824e-11,-45511.1,40.7245], Tmin=(100,'K'), Tmax=(956.78,'K')), NASAPolynomial(coeffs=[32.1394,0.025999,-7.82287e-06,1.40255e-09,-1.05316e-13,-54836.3,-137.335], Tmin=(956.78,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-380.408,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(548.755,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-OsOsHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH)"""),
)

species(
    label = 'CCCCC(O)=CCOO(28414)',
    structure = SMILES('CCCCC(O)=CCOO'),
    E0 = (-396.297,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,3615,1310,387.5,850,1000,350,440,435,1725,2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,200,800,1200,1600],'cm^-1')),
    ...
    molecularWeight = (146.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.54755,0.116005,-0.000102997,4.80514e-08,-9.08678e-12,-47458.9,40.8603], Tmin=(100,'K'), Tmax=(1260.56,'K')), NASAPolynomial(coeffs=[20.8019,0.0450863,-1.86073e-05,3.42038e-09,-2.35347e-13,-53093.5,-72.1377], Tmin=(1260.56,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-396.297,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(548.755,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-(Cds-Cd)H) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH)"""),
)
...
reaction(
    label = 'reaction31',
    reactants = ['OH(5)', 'CCCCC(=O)CC[O](28395)'],
...
reaction(
    label = 'reaction32',
    reactants = ['HO2(10)', '[CH2]CC(=O)CCCC(10636)'],
    products = ['CCCCC(=O)CCOO(16766)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction33',
    reactants = ['H(3)', 'CCCCC(=O)CCO[O](28396)'],
    products = ['CCCCC(=O)CCOO(16766)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction34',
    reactants = ['C2H5(29)', '[CH2]CC(=O)CCOO(28397)'],
    products = ['CCCCC(=O)CCOO(16766)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction35',
    reactants = ['npropyl(83)', '[CH2]C(=O)CCOO(28398)'],
    products = ['CCCCC(=O)CCOO(16766)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction36',
    reactants = ['H(3)', 'CC[CH]CC(=O)CCOO(28399)'],
    products = ['CCCCC(=O)CCOO(16766)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction37',
    reactants = ['CH3(17)', '[CH2]CCC(=O)CCOO(28400)'],
    products = ['CCCCC(=O)CCOO(16766)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction38',
    reactants = ['H(3)', 'C[CH]CCC(=O)CCOO(28401)'],
    products = ['CCCCC(=O)CCOO(16766)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(2e+13,'cm^3/(mol*s)','*|/',3.16), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), comment="""From training reaction 59 used for H_rad;C_rad/H/NonDeC
Exact match found for rate rule [C_rad/H/NonDeC;H_rad]
...
reaction(
    label = 'reaction39',
    reactants = ['butyl_1(82)', 'O=[C]CCOO(28402)'],
    products = ['CCCCC(=O)CCOO(16766)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction40',
    reactants = ['H(3)', 'CCC[CH]C(=O)CCOO(28403)'],
    products = ['CCCCC(=O)CCOO(16766)'],
...
reaction(
    label = 'reaction41',
    reactants = ['CH2OOH(35)', '[CH2]C(=O)CCCC(28404)'],
    products = ['CCCCC(=O)CCOO(16766)'],
    transitionState = 'TS11',
    kinetics = Arrhenius(A=(1.59829e+09,'m^3/(mol*s)'), n=-0.710125, Ea=(0.281191,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [C_pri_rad;C_pri_rad] for rate rule [C_rad/H2/O;C_rad/H2/CO]
...
reaction(
    label = 'reaction42',
    reactants = ['CH2CH2OOH(45)', 'CCCC[C]=O(2388)'],
    products = ['CCCCC(=O)CCOO(16766)'],
...
reaction(
    label = 'reaction43',
    reactants = ['H(3)', 'CCCCC(=O)[CH]COO(28405)'],
    products = ['CCCCC(=O)CCOO(16766)'],
...
reaction(
    label = 'reaction45',
    reactants = ['H(3)', '[CH2]CCCC(=O)CCOO(28406)'],
    products = ['CCCCC(=O)CCOO(16766)'],
...
reaction(
    label = 'reaction49',
    reactants = ['CC[CH]C[C](O)CCOO(28407)'],
    products = ['CCCCC(=O)CCOO(16766)'],
...
reaction(
    label = 'reaction50',
    reactants = ['CCCC[C](O)C[CH]OO(16753)'],
    products = ['CCCCC(=O)CCOO(16766)'],
...
reaction(
    label = 'reaction51',
    reactants = ['C[CH]CCC([O])CCOO(16763)'],
    products = ['CCCCC(=O)CCOO(16766)'],
...
reaction(
    label = 'reaction52',
    reactants = ['C[CH]CC[C](O)CCOO(28408)'],
    products = ['CCCCC(=O)CCOO(16766)'],
...
reaction(
    label = 'reaction55',
    reactants = ['[CH2]CCC[C](O)CCOO(28409)'],
    products = ['CCCCC(=O)CCOO(16766)'],
...
reaction(
    label = 'reaction56',
    reactants = ['CCCC[C](O)CCO[O](28410)'],
    products = ['CCCCC(=O)CCOO(16766)'],
