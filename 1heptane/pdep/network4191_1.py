...
species(
    label = '[CH2]CC(C)=C=C(24200)',
    structure = SMILES('[CH2]CC(C)=C=C'),
    E0 = (290.248,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([540,610,2055,2750,2800,2850,1350,1500,750,1050,1375,1000,2950,3100,1380,975,1025,1650,350,440,435,1725,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,197.654],'cm^-1')),
        HinderedRotor(inertia=(0.466671,'amu*angstrom^2'), symmetry=1, barrier=(10.7297,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.758075,'amu*angstrom^2'), symmetry=1, barrier=(17.4296,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0745262,'amu*angstrom^2'), symmetry=1, barrier=(1.71354,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (81.1357,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.28144,0.0556145,-3.70239e-05,1.275e-08,-1.81831e-12,35009.8,23.2427], Tmin=(100,'K'), Tmax=(1590.33,'K')), NASAPolynomial(coeffs=[12.0304,0.0285785,-1.15234e-05,2.06016e-09,-1.37857e-13,31590.9,-33.6017], Tmin=(1590.33,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(290.248,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(RCCJ)"""),
)
...
species(
    label = 'C#CC(C)C[CH2](24202)',
    structure = SMILES('C#CC(C)C[CH2]'),
    E0 = (298.142,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,2175,525,750,770,3400,2100,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,1380,1390,370,380,2900,435,180],'cm^-1')),
        HinderedRotor(inertia=(0.00179884,'amu*angstrom^2'), symmetry=1, barrier=(14.8892,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.041663,'amu*angstrom^2'), symmetry=1, barrier=(17.9497,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(3.62438,'amu*angstrom^2'), symmetry=1, barrier=(83.3315,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(3.61975,'amu*angstrom^2'), symmetry=1, barrier=(83.2252,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (81.1357,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.28316,0.052761,-2.54961e-05,-2.54518e-09,4.63802e-12,35962.2,23.6671], Tmin=(100,'K'), Tmax=(994.169,'K')), NASAPolynomial(coeffs=[10.9983,0.0281182,-1.01107e-05,1.75334e-09,-1.18259e-13,33316.6,-26.7363], Tmin=(994.169,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(298.142,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CtCsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(RCCJ)"""),
)
...
species(
    label = '[CH2]CC=C=C(24203)',
    structure = SMILES('[CH2]CC=C=C'),
    E0 = (329.303,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2950,3100,1380,975,1025,1650,540,610,2055,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,180],'cm^-1')),
        HinderedRotor(inertia=(0.0373523,'amu*angstrom^2'), symmetry=1, barrier=(9.4537,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.818798,'amu*angstrom^2'), symmetry=1, barrier=(18.8258,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
species(
    ...
    molecularWeight = (82.1436,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.43398,0.0483436,-1.17435e-05,-1.17887e-08,6.15983e-12,35912.5,22.2621], Tmin=(100,'K'), Tmax=(1084.77,'K')), NASAPolynomial(coeffs=[9.5994,0.0338339,-1.3251e-05,2.39488e-09,-1.64255e-13,33223.1,-22.0263], Tmin=(1084.77,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(297.768,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_S) + radical(Allyl_T)"""),
)
...
species(
    label = '[CH]=[C]C(C)CC(3271)',
    structure = SMILES('[CH]=[C]C(C)CC'),
    E0 = (412.884,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,1685,370,1380,1390,370,380,2900,435,3120,650,792.5,1650,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,329.083],'cm^-1')),
        HinderedRotor(inertia=(0.455944,'amu*angstrom^2'), symmetry=1, barrier=(10.483,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0332104,'amu*angstrom^2'), symmetry=1, barrier=(10.5284,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.457077,'amu*angstrom^2'), symmetry=1, barrier=(10.5091,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0332822,'amu*angstrom^2'), symmetry=1, barrier=(10.5013,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (82.1436,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.916044,0.05897,-3.86833e-05,1.30563e-08,-1.79725e-12,49776.9,26.2884], Tmin=(100,'K'), Tmax=(1678.39,'K')), NASAPolynomial(coeffs=[14.2689,0.0271469,-1.02425e-05,1.7594e-09,-1.14556e-13,45294.6,-45.0463], Tmin=(1678.39,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(412.884,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_P) + radical(Cds_S)"""),
)

species(
    label = 'C=C=C(C)CC(24206)',
    structure = SMILES('C=C=C(C)CC'),
    E0 = (85.0019,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (82.1436,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.950612,0.0580145,-3.61907e-05,1.13761e-08,-1.45068e-12,10340.8,22.6678], Tmin=(100,'K'), Tmax=(1799.74,'K')), NASAPolynomial(coeffs=[14.9891,0.0268139,-1.01867e-05,1.74379e-09,-1.12677e-13,5287.62,-53.3093], Tmin=(1799.74,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(85.0019,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(369.994,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + group(Cdd-CdsCds)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', '[CH2]CC(C)=C=C(24200)'],
    products = ['[CH2]CC(C)[C]=C(19002)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'C=[C]C(C)C=C(24201)'],
    products = ['[CH2]CC(C)[C]=C(19002)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', 'C#CC(C)C[CH2](24202)'],
    products = ['[CH2]CC(C)[C]=C(19002)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['CH3(17)', '[CH2]CC=C=C(24203)'],
    products = ['[CH2]CC(C)[C]=C(19002)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction23',
    reactants = ['[CH2]C[CH]C(129)', 'H2CC(41)'],
    products = ['[CH2]CC(C)[C]=C(19002)'],
...
reaction(
    label = 'reaction24',
    reactants = ['CH2(19)', '[CH2]C(C)[C]=C(2594)'],
    products = ['[CH2]CC(C)[C]=C(19002)'],
