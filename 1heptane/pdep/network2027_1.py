...
species(
    label = '[CH2]C(O)OC=CC(11110)',
    structure = SMILES('[CH2]C(O)OC=CC'),
    E0 = (-210.175,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,3615,1277.5,1000,3000,3100,440,815,1455,1000,1380,1390,370,380,2900,435,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0647709,0.0734789,-4.52084e-05,-4.56311e-09,9.97093e-12,-25124.7,28.4067], Tmin=(100,'K'), Tmax=(960.999,'K')), NASAPolynomial(coeffs=[20.8436,0.0175241,-5.52924e-06,9.7283e-10,-7.02389e-14,-30528.3,-78.3483], Tmin=(960.999,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-210.175,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(CJCO)"""),
)
...
species(
    ...
    molecularWeight = (102.132,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.710819,0.0740693,-6.55334e-05,3.19649e-08,-6.556e-12,-10213.6,31.33], Tmin=(100,'K'), Tmax=(1139.61,'K')), NASAPolynomial(coeffs=[11.4084,0.036521,-1.61109e-05,3.053e-09,-2.13502e-13,-12651.8,-21.6777], Tmin=(1139.61,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-85.893,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJCO) + radical(CJCO)"""),
)
...
species(
    label = '[CH2][C](O)OCCC(11114)',
    structure = SMILES('[CH2][C](O)OCCC'),
    E0 = (-80.5487,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,360,370,350,3615,1277.5,1000,3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (102.132,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.618823,0.0790759,-8.06102e-05,4.76967e-08,-1.19914e-11,-9569.99,29.8641], Tmin=(100,'K'), Tmax=(940.656,'K')), NASAPolynomial(coeffs=[9.81419,0.0399741,-1.82575e-05,3.50587e-09,-2.46786e-13,-11299.9,-13.9357], Tmin=(940.656,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-80.5487,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJCO) + radical(Cs_P)"""),
)

species(
    label = '[CH2]CCOC([CH2])O(11115)',
    ...
    molecularWeight = (102.132,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.618823,0.0790759,-8.06102e-05,4.76967e-08,-1.19914e-11,-9569.99,30.9627], Tmin=(100,'K'), Tmax=(940.656,'K')), NASAPolynomial(coeffs=[9.81419,0.0399741,-1.82575e-05,3.50587e-09,-2.46786e-13,-11299.9,-12.8371], Tmin=(940.656,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-80.5487,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJ) + radical(CJCO)"""),
)
...
species(
    label = 'C=C(O)OCCC(11120)',
    structure = SMILES('C=C(O)OCCC'),
    E0 = (-366.424,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (102.132,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.113444,0.0796693,-5.9877e-05,1.28979e-08,3.05648e-12,-43912.9,25.4788], Tmin=(100,'K'), Tmax=(979.979,'K')), NASAPolynomial(coeffs=[19.4517,0.0227412,-7.84006e-06,1.37589e-09,-9.56183e-14,-48848.7,-74.1343], Tmin=(979.979,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-366.424,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH)"""),
)
...
species(
    label = '[CH2]C(C)OC([CH2])O(11122)',
    structure = SMILES('[CH2]C(C)OC([CH2])O'),
    E0 = (-85.8359,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1277.5,1000,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (102.132,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.108853,0.0903456,-0.000107772,7.22074e-08,-1.98391e-11,-10187.7,30.4121], Tmin=(100,'K'), Tmax=(879.896,'K')), NASAPolynomial(coeffs=[11.8663,0.0368938,-1.66458e-05,3.16114e-09,-2.2052e-13,-12256.7,-24.806], Tmin=(879.896,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-85.8359,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJC(C)OC) + radical(CJCO)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(O)O[CH]CC(10719)'],
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', '[CH2]C(O)OC=CC(11110)'],
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'C=C(O)O[CH]CC(11111)'],
    products = ['[CH2]C(O)O[CH]CC(10719)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['CH3(17)', '[CH2]C(O)OC=C(4702)'],
    products = ['[CH2]C(O)O[CH]CC(10719)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['OH(5)', 'C=CO[CH]CC(10587)'],
    products = ['[CH2]C(O)O[CH]CC(10719)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2]C(O)OC[CH]C(11112)'],
    products = ['[CH2]C(O)O[CH]CC(10719)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]CCOC([CH2])O(11115)'],
    products = ['[CH2]C(O)O[CH]CC(10719)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CH2(S)(23)', '[CH2]C(O)O[CH]C(1186)'],
    products = ['[CH2]C(O)O[CH]CC(10719)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2]C(C)OC([CH2])O(11122)'],
    products = ['[CH2]C(O)O[CH]CC(10719)'],
