...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.252306,0.0863387,-6.56701e-05,2.67058e-08,-4.47256e-12,-12826.1,34.6993], Tmin=(100,'K'), Tmax=(1396.78,'K')), NASAPolynomial(coeffs=[16.0697,0.0395969,-1.54741e-05,2.74788e-09,-1.84486e-13,-17385.7,-49.4992], Tmin=(1396.78,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-107.963,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(482.239,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(RCCJCC)"""),
)

species(
    label = '[CH2]C(O)CC=CCC(3535)',
    ...
    molecularWeight = (113.178,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.328065,0.0870039,-6.56713e-05,2.60449e-08,-4.22721e-12,-7036.42,35.574], Tmin=(100,'K'), Tmax=(1442.08,'K')), NASAPolynomial(coeffs=[17.1647,0.0384834,-1.52025e-05,2.71366e-09,-1.82547e-13,-12081.7,-55.2228], Tmin=(1442.08,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-59.8544,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(482.239,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(CJCO)"""),
)

species(
    label = '[CH2]C(O)C=CCCC(3536)',
    structure = SMILES('[CH2]C(O)C=CCCC'),
    E0 = (-60.1907,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,1380,1390,370,380,2900,435,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3100,440,815,1455,1000,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (113.178,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.43662,0.0855969,-5.94423e-05,1.88743e-08,-1.76796e-12,-7069.59,36.8767], Tmin=(100,'K'), Tmax=(1202.95,'K')), NASAPolynomial(coeffs=[17.846,0.0372383,-1.46468e-05,2.64136e-09,-1.80109e-13,-12367.9,-58.4439], Tmin=(1202.95,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-60.1907,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(482.239,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(CJCO)"""),
)
...
species(
    ...
    molecularWeight = (114.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0554491,0.0912962,-7.90898e-05,4.15919e-08,-9.65065e-12,2293.52,36.2377], Tmin=(100,'K'), Tmax=(994.165,'K')), NASAPolynomial(coeffs=[9.18063,0.0545805,-2.36919e-05,4.44243e-09,-3.08591e-13,479.171,-7.73246], Tmin=(994.165,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(17.9202,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJCO) + radical(RCCJC)"""),
)

species(
    label = '[CH2][C](O)CCCCC(3540)',
    ...
    molecularWeight = (114.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.338068,0.100266,-9.80715e-05,5.67883e-08,-1.40521e-11,164.348,34.3414], Tmin=(100,'K'), Tmax=(953.593,'K')), NASAPolynomial(coeffs=[11.0315,0.0525743,-2.30523e-05,4.34144e-09,-3.02267e-13,-2004.03,-19.97], Tmin=(953.593,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(0.101721,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJCO) + radical(C2CsJOH)"""),
)

species(
    label = '[CH2]CCCCC([CH2])O(3541)',
    structure = SMILES('[CH2]CCCCC([CH2])O'),
    E0 = (28.7203,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (114.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.252515,0.0937265,-7.74302e-05,3.54503e-08,-6.84855e-12,3607.07,36.3803], Tmin=(100,'K'), Tmax=(1202.3,'K')), NASAPolynomial(coeffs=[13.516,0.0479201,-2.02831e-05,3.76335e-09,-2.59867e-13,296.215,-32.5819], Tmin=(1202.3,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(28.7203,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJCO) + radical(RCCJ)"""),
)
...
species(
    label = 'C=C(O)CCCCC(3542)',
    structure = SMILES('C=C(O)CCCCC'),
    E0 = (-302.421,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (114.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.57598,0.0867652,-4.53719e-05,-3.78529e-09,7.94291e-12,-36196,33.2937], Tmin=(100,'K'), Tmax=(1019.04,'K')), NASAPolynomial(coeffs=[18.9794,0.0377897,-1.41788e-05,2.56335e-09,-1.78439e-13,-41624.2,-68.4967], Tmin=(1019.04,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-302.421,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'C=C(O)C[CH]CCC(3534)'],
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', '[CH2]C(O)CC=CCC(3535)'],
    products = ['[CH2]C(O)C[CH]CCC(1291)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', '[CH2]C(O)C=CCCC(3536)'],
    products = ['[CH2]C(O)C[CH]CCC(1291)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(1.46e+08,'cm^3/(mol*s)'), n=1.64, Ea=(5.73208,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""From training reaction 2555 used for Cds-CsH_Cds-CsH;HJ
Exact match found for rate rule [Cds-CsH_Cds-CsH;HJ]
...
reaction(
    label = 'reaction6',
    reactants = ['C2H5(29)', '[CH2]C(O)CC=C(2981)'],
    products = ['[CH2]C(O)C[CH]CCC(1291)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['C=CC[CH]CCC(456)', 'OH(5)'],
    products = ['[CH2]C(O)C[CH]CCC(1291)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]C(O)CC[CH]CC(3537)'],
    products = ['[CH2]C(O)C[CH]CCC(1291)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]C(O)[CH]CCCC(3538)'],
    products = ['[CH2]C(O)C[CH]CCC(1291)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]C(O)C[CH]CCC(1291)'],
    products = ['[CH2]C(O)CCC[CH]C(3539)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]CCCCC([CH2])O(3541)'],
    products = ['[CH2]C(O)C[CH]CCC(1291)'],
...
reaction(
    label = 'reaction25',
    reactants = ['CH2(S)(23)', '[CH2]C(O)C[CH]CC(1271)'],
    products = ['[CH2]C(O)C[CH]CCC(1291)'],
...
reaction(
    label = 'reaction27',
    reactants = ['[CH2]C(O)CC([CH2])CC(3543)'],
    products = ['[CH2]C(O)C[CH]CCC(1291)'],
...
reaction(
    label = 'reaction31',
    reactants = ['[CH]CCC(133)', '[CH2]C([CH2])O(2453)'],
    products = ['[CH2]C(O)C[CH]CCC(1291)'],
