...
species(
    ...
    molecularWeight = (96.1271,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.650934,0.0658574,-4.90987e-05,1.41878e-08,1.98804e-13,53289.8,26.194], Tmin=(100,'K'), Tmax=(1012.13,'K')), NASAPolynomial(coeffs=[14.713,0.0244924,-8.85282e-06,1.54904e-09,-1.05374e-13,49715.5,-45.4122], Tmin=(1012.13,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(442.017,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)(Cds-Cds)CsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + ring(Cyclopropene) + radical(Isobutyl) + radical(CC(C)OJ)"""),
)
...
species(
    label = '[CH]=C(C=C)C(C)=O(29030)',
    structure = SMILES('[CH]=C(C=C)C(C)=O'),
    E0 = (181.909,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,3010,987.5,1337.5,450,1655,2750,2800,2850,1350,1500,750,1050,1375,1000,2950,3100,1380,975,1025,1650,350,440,435,1725,375,552.5,462.5,1710,207.96],'cm^-1')),
        HinderedRotor(inertia=(0.513319,'amu*angstrom^2'), symmetry=1, barrier=(16.0031,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.502303,'amu*angstrom^2'), symmetry=1, barrier=(16.0109,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.517335,'amu*angstrom^2'), symmetry=1, barrier=(16.0066,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (95.1192,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.843631,0.0601091,-4.05643e-05,7.91846e-09,1.53787e-12,22000.2,23.9415], Tmin=(100,'K'), Tmax=(1076.92,'K')), NASAPolynomial(coeffs=[15.3526,0.0217572,-8.78873e-06,1.64599e-09,-1.16317e-13,17974.1,-51.3146], Tmin=(1076.92,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(181.909,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)HHH) + group(Cds-Cds(Cds-O2d)(Cds-Cds)) + group(Cds-O2d(Cds-Cds)Cs) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cds_P)"""),
)
...
species(
    ...
    molecularWeight = (96.1271,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.551619,0.0662428,-4.2847e-05,3.14233e-09,5.15677e-12,35039.9,26.5566], Tmin=(100,'K'), Tmax=(974.044,'K')), NASAPolynomial(coeffs=[16.3885,0.0223176,-7.71272e-06,1.34563e-09,-9.28948e-14,30953.3,-54.5712], Tmin=(974.044,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(290.235,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(CC(C)OJ) + radical(C=CJC=C)"""),
)
...
species(
    label = 'CC([O])C1[CH]CC=1(29033)',
    structure = SMILES('CC([O])C1[CH]CC=1'),
    E0 = (304.864,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (96.1271,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.56359,0.033839,4.97652e-05,-9.02014e-08,3.70073e-11,36772.2,22.9899], Tmin=(100,'K'), Tmax=(968.632,'K')), NASAPolynomial(coeffs=[16.2759,0.0220076,-7.67511e-06,1.47592e-09,-1.12283e-13,31626.9,-59.3668], Tmin=(968.632,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(304.864,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(349.208,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + ring(Cyclobutene) + radical(cyclobutene-allyl) + radical(CC(C)OJ)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[CH]=C(C=C)C(C)[O](27149)'],
    products = ['[CH2]C1C=C1C(C)[O](29029)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', '[CH]=C(C=C)C(C)=O(29030)'],
    products = ['[CH]=C(C=C)C(C)[O](27149)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CH3(17)', '[CH]=C(C=C)C=O(26939)'],
    products = ['[CH]=C(C=C)C(C)[O](27149)'],
    transitionState = 'TS5',
...
reaction(
    ...
    products = ['[CH]=C(C=C)C(C)[O](27149)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(0.0201871,'m^3/(mol*s)'), n=2.2105, Ea=(65.5168,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [CO-CsH_O;YJ] for rate rule [CO-CsH_O;CJ]
Euclidian distance = 1.0
family: R_Addition_MultipleBond
Ea raised from 61.4 to 65.5 kJ/mol to match endothermicity of reaction."""),
)
...
reaction(
    label = 'reaction8',
    reactants = ['C2H3(30)', 'C#CC(C)[O](4289)'],
    products = ['[CH]=C(C=C)C(C)[O](27149)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction18',
    reactants = ['[CH]=C(C=C)C(C)[O](27149)'],
    products = ['CC([O])C1[CH]CC=1(29033)'],
...
reaction(
    label = 'reaction21',
    reactants = ['CH2(S)(23)', '[CH]=C(C=C)C[O](26481)'],
    products = ['[CH]=C(C=C)C(C)[O](27149)'],
...
reaction(
    label = 'reaction23',
    reactants = ['O(4)', '[CH]=C([CH]C)C=C(24786)'],
    products = ['[CH]=C(C=C)C(C)[O](27149)'],
