...
species(
    label = 'CCC=CCC(C)OO(2086)',
    structure = SMILES('CCC=CCC(C)OO'),
    E0 = (-199.939,'kJ/mol'),
    modes = [
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.695162,0.0969099,-7.05773e-05,2.64853e-08,-4.08838e-12,-23873.3,37.0174], Tmin=(100,'K'), Tmax=(1492.65,'K')), NASAPolynomial(coeffs=[18.4183,0.0456897,-1.91046e-05,3.49586e-09,-2.37922e-13,-29579.2,-62.8497], Tmin=(1492.65,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-199.939,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(527.969,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH)"""),
)

species(
    label = 'CC=CCCC(C)OO(2087)',
...
species(
    label = 'C=CCCC(C)OO(2088)',
    structure = SMILES('C=CCCC(C)OO'),
    E0 = (-165.048,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,3615,1310,387.5,850,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,1380,1390,370,380,2900,435,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0745067,0.0846285,-6.30527e-05,2.42814e-08,-3.84771e-12,-19700.2,32.314], Tmin=(100,'K'), Tmax=(1458.07,'K')), NASAPolynomial(coeffs=[16.3704,0.0395139,-1.66404e-05,3.06035e-09,-2.09126e-13,-24495.8,-53.2249], Tmin=(1458.07,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-165.048,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH)"""),
)
...
species(
    label = 'CC[CH]CC[CH]OO(2090)',
    structure = SMILES('CC[CH]CC[CH]OO'),
    E0 = (102.854,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3000,3050,390,425,1340,1360,335,370,3615,1310,387.5,850,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (116.158,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0263099,0.0967595,-0.000121561,1.03312e-07,-3.73813e-11,12507.5,34.7246], Tmin=(100,'K'), Tmax=(782.647,'K')), NASAPolynomial(coeffs=[5.33935,0.0584447,-2.72529e-05,5.19815e-09,-3.61062e-13,12001.2,12.2845], Tmin=(782.647,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(102.854,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(CCsJOOH)"""),
)

species(
    label = 'CC[CH]CC[C](C)OO(2091)',
    ...
    molecularWeight = (130.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.551739,0.109268,-0.000133222,1.12493e-07,-4.09937e-11,7942.41,38.6554], Tmin=(100,'K'), Tmax=(772.678,'K')), NASAPolynomial(coeffs=[5.14439,0.0684375,-3.19382e-05,6.10599e-09,-4.25141e-13,7400.76,14.835], Tmin=(772.678,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(64.7472,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(523.812,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(C2CsJOOH)"""),
)
...
species(
    label = 'CC[CH]C[CH]C(C)OO(2092)',
    structure = SMILES('CC[CH]C[CH]C(C)OO'),
    E0 = (78.2631,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (130.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.104762,0.100701,-8.69415e-05,3.06454e-08,6.24051e-12,9550.95,39.1468], Tmin=(100,'K'), Tmax=(580.858,'K')), NASAPolynomial(coeffs=[7.0312,0.0651485,-3.02225e-05,5.82227e-09,-4.09887e-13,8492.72,6.62327], Tmin=(580.858,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(78.2631,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(523.812,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJCOOH) + radical(RCCJCC)"""),
)

species(
    label = 'CC[CH][CH]CC(C)OO(2093)',
    structure = SMILES('CC[CH][CH]CC(C)OO'),
    E0 = (72.3064,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3000,3050,390,425,1340,1360,335,370,3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (130.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.445971,0.10737,-0.000132682,1.14619e-07,-4.22415e-11,8847.3,40.5445], Tmin=(100,'K'), Tmax=(789.428,'K')), NASAPolynomial(coeffs=[4.22017,0.0690642,-3.20362e-05,6.09586e-09,-4.22757e-13,8567.47,22.0301], Tmin=(789.428,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(72.3064,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(523.812,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(RCCJCC)"""),
)

species(
    label = '[CH2][CH]CCC(C)OO(2094)',
    structure = SMILES('[CH2][CH]CCC(C)OO'),
    E0 = (106.863,'kJ/mol'),
    modes = [
...
species(
    label = '[CH2]C(CC[CH]CC)OO(2096)',
    structure = SMILES('[CH2]C(CC[CH]CC)OO'),
    E0 = (91.8107,'kJ/mol'),
    modes = [
...
species(
    label = '[CH2]C[CH]CCC(C)OO(2097)',
    structure = SMILES('[CH2]C[CH]CCC(C)OO'),
    E0 = (83.0945,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1310,387.5,850,1000,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3000,3100,440,815,1455,1000,1380,1390,370,380,2900,435,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2]C(CC)CC(C)OO(2099)',
    structure = SMILES('[CH2]C(CC)CC(C)OO'),
    E0 = (-113.875,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (131.193,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.889179,0.105146,-8.50556e-05,3.77185e-08,-7.00225e-12,-13518.2,38.5076], Tmin=(100,'K'), Tmax=(1254.66,'K')), NASAPolynomial(coeffs=[15.7976,0.0519471,-2.14546e-05,3.92423e-09,-2.68573e-13,-17705.5,-45.7823], Tmin=(1254.66,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-113.875,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(548.755,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]C(C)CCC(C)OO(2100)',
...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.499938,0.0773172,-6.67738e-05,3.10477e-08,-6.01429e-12,21674.3,28.537], Tmin=(100,'K'), Tmax=(1207,'K')), NASAPolynomial(coeffs=[12.8159,0.036502,-1.60507e-05,3.03161e-09,-2.11458e-13,18701.2,-33.1975], Tmin=(1207,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(179.165,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJ2_triplet)"""),
)

species(
    label = 'CC[C]CCC(C)OO(2104)',
    structure = SMILES('CC[C]CCC(C)OO'),
    E0 = (131.605,'kJ/mol'),
    modes = [
...
species(
    label = 'CCCCC[CH]O[O](216)',
    structure = SMILES('CCCCC[CH]O[O]'),
    E0 = (60.4002,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,3025,407.5,1350,352.5,492.5,1135,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (116.158,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.190344,0.0899589,-9.11922e-05,5.93782e-08,-1.7121e-11,7396.16,32.161], Tmin=(100,'K'), Tmax=(814.959,'K')), NASAPolynomial(coeffs=[7.60101,0.0535868,-2.42484e-05,4.61738e-09,-3.22857e-13,6188.24,-2.07504], Tmin=(814.959,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(60.4002,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(CCsJOOH)"""),
)

species(
    label = 'CCCCC[C](C)O[O](217)',
...
species(
    ...
    molecularWeight = (130.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.468649,0.102018,-8.93157e-05,4.47445e-08,-9.60741e-12,6094.06,38.2611], Tmin=(100,'K'), Tmax=(1081.87,'K')), NASAPolynomial(coeffs=[12.2598,0.0549574,-2.40669e-05,4.53715e-09,-3.16263e-13,3339.96,-24.1478], Tmin=(1081.87,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(49.3571,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(527.969,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(CJCOOH)"""),
)

species(
    label = '[CH2]CCCCC(C)O[O](227)',
...
reaction(
    label = 'reaction27',
    reactants = ['H(3)', 'CCC=CCC(C)OO(2086)'],
    products = ['CC[CH]CCC(C)OO(213)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction28',
    reactants = ['H(3)', 'CC=CCCC(C)OO(2087)'],
    products = ['CC[CH]CCC(C)OO(213)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(1.46e+08,'cm^3/(mol*s)'), n=1.64, Ea=(5.73208,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""From training reaction 2555 used for Cds-CsH_Cds-CsH;HJ
Exact match found for rate rule [Cds-CsH_Cds-CsH;HJ]
...
reaction(
    label = 'reaction29',
    reactants = ['butene1(127)', 'QOOH_3(717)'],
    products = ['CC[CH]CCC(C)OO(213)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction30',
    reactants = ['CH3(17)', 'C=CCCC(C)OO(2088)'],
    products = ['CC[CH]CCC(C)OO(213)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction37',
    reactants = ['OH(5)', 'CC[CH]CCC(C)[O](2089)'],
    products = ['CC[CH]CCC(C)OO(213)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction39',
    reactants = ['H(3)', 'CC[CH]CCC(C)O[O](222)'],
    products = ['CC[CH]CCC(C)OO(213)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction40',
    reactants = ['[CH2]C[CH]CC(135)', 'CH3CHOOH(63)'],
    products = ['CC[CH]CCC(C)OO(213)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction41',
    reactants = ['CH3(17)', 'CC[CH]CC[CH]OO(2090)'],
    products = ['CC[CH]CCC(C)OO(213)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction42',
    reactants = ['H(3)', 'CC[CH]CC[C](C)OO(2091)'],
    products = ['CC[CH]CCC(C)OO(213)'],
...
reaction(
    label = 'reaction43',
    reactants = ['[CH2][CH]CC(130)', 'QOOH_3(717)'],
    products = ['CC[CH]CCC(C)OO(213)'],
...
reaction(
    label = 'reaction44',
    reactants = ['H(3)', 'CC[CH]C[CH]C(C)OO(2092)'],
    products = ['CC[CH]CCC(C)OO(213)'],
...
reaction(
    label = 'reaction45',
    reactants = ['H(3)', 'CC[CH][CH]CC(C)OO(2093)'],
    products = ['CC[CH]CCC(C)OO(213)'],
...
reaction(
    label = 'reaction46',
    reactants = ['CH3(17)', '[CH2][CH]CCC(C)OO(2094)'],
    products = ['CC[CH]CCC(C)OO(213)'],
...
reaction(
    label = 'reaction47',
    reactants = ['H(3)', 'C[CH][CH]CCC(C)OO(2095)'],
    products = ['CC[CH]CCC(C)OO(213)'],
...
reaction(
    label = 'reaction48',
    reactants = ['H(3)', '[CH2]C(CC[CH]CC)OO(2096)'],
    products = ['CC[CH]CCC(C)OO(213)'],
...
reaction(
    label = 'reaction49',
    reactants = ['H(3)', '[CH2]C[CH]CCC(C)OO(2097)'],
    products = ['CC[CH]CCC(C)OO(213)'],
...
reaction(
    label = 'reaction32',
    reactants = ['CC[CH]CCC(C)OO(213)'],
    products = ['C[CH]CCCC(C)OO(214)'],
...
reaction(
    label = 'reaction53',
    reactants = ['[CH2]C(CC)CC(C)OO(2099)'],
    products = ['CC[CH]CCC(C)OO(213)'],
...
reaction(
    label = 'reaction54',
    reactants = ['[CH2]C(C)CCC(C)OO(2100)'],
    products = ['CC[CH]CCC(C)OO(213)'],
...
reaction(
    label = 'reaction56',
    reactants = ['[CH]CC(144)', '[CH2]CC(C)OO(2102)'],
    products = ['CC[CH]CCC(C)OO(213)'],
...
reaction(
    label = 'reaction57',
    reactants = ['C2H5(29)', '[CH]CCC(C)OO(2103)'],
    products = ['CC[CH]CCC(C)OO(213)'],
...
reaction(
    label = 'reaction58',
    reactants = ['H(3)', 'CC[C]CCC(C)OO(2104)'],
    products = ['CC[CH]CCC(C)OO(213)'],
...
reaction(
    label = 'reaction9',
    reactants = ['C[CH]O[O](97)', '[CH2]CCCC(84)'],
    products = ['CCCCCC(C)O[O](206)'],
...
reaction(
    label = 'reaction10',
    reactants = ['CCCCC[CH]O[O](216)', 'CH3(17)'],
    products = ['CCCCCC(C)O[O](206)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(3)', 'CCCCC[C](C)O[O](217)'],
    products = ['CCCCCC(C)O[O](206)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]C(C)O[O](218)', 'butyl_1(82)'],
    products = ['CCCCCC(C)O[O](206)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(3)', 'CCCC[CH]C(C)O[O](219)'],
    products = ['CCCCCC(C)O[O](206)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]CC(C)O[O](220)', 'npropyl(83)'],
    products = ['CCCCCC(C)O[O](206)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]CCC(C)O[O](221)', 'C2H5(29)'],
    products = ['CCCCCC(C)O[O](206)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(3)', 'CCC[CH]CC(C)O[O](223)'],
    products = ['CCCCCC(C)O[O](206)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2]CCCC(C)O[O](224)', 'CH3(17)'],
    products = ['CCCCCC(C)O[O](206)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(3)', 'C[CH]CCCC(C)O[O](225)'],
    products = ['CCCCCC(C)O[O](206)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(3)', '[CH2]C(CCCCC)O[O](226)'],
    products = ['CCCCCC(C)O[O](206)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(3)', '[CH2]CCCCC(C)O[O](227)'],
    products = ['CCCCCC(C)O[O](206)'],
