...
species(
    ...
    E0 = (-117.823,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,3100,1380,975,1025,1650,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,180],'cm^-1')),
        HinderedRotor(inertia=(0.573047,'amu*angstrom^2'), symmetry=1, barrier=(13.1755,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.915558,'amu*angstrom^2'), symmetry=1, barrier=(21.0505,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.915575,'amu*angstrom^2'), symmetry=1, barrier=(21.0509,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0424511,'amu*angstrom^2'), symmetry=1, barrier=(21.0494,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
reaction(
    label = 'reaction23',
    reactants = ['OH(5)', '[CH2]CC(C)[O](1023)'],
    products = ['[CH2]CC(C)OO(2102)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction26',
    reactants = ['CH3CHOOH(63)', 'C2H4(T)(94)'],
    products = ['[CH2]CC(C)OO(2102)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction27',
    reactants = ['CH3(17)', '[CH2]C[CH]OO(468)'],
    products = ['[CH2]CC(C)OO(2102)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction28',
    reactants = ['H(3)', '[CH2]C[C](C)OO(14348)'],
    products = ['[CH2]CC(C)OO(2102)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction29',
    reactants = ['H(3)', '[CH2][CH]C(C)OO(4721)'],
    products = ['[CH2]CC(C)OO(2102)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction30',
    reactants = ['H(3)', '[CH2]CC([CH2])OO(2134)'],
    products = ['[CH2]CC(C)OO(2102)'],
