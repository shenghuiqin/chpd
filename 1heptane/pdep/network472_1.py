...
species(
    label = 'CC=CC([O])=O(2503)',
    structure = SMILES('CC=CC([O])=O'),
    E0 = (-64.1651,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,180,180,180,2088.54,2091.44,2092.97],'cm^-1')),
        HinderedRotor(inertia=(0.289708,'amu*angstrom^2'), symmetry=1, barrier=(6.66096,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.288657,'amu*angstrom^2'), symmetry=1, barrier=(6.6368,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (85.0813,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.26517,0.0477187,-7.79876e-05,8.62591e-08,-3.61889e-11,-7664.16,20.1674], Tmin=(100,'K'), Tmax=(819.19,'K')), NASAPolynomial(coeffs=[-1.02636,0.0400321,-2.04087e-05,3.99657e-09,-2.79471e-13,-6327.69,40.2564], Tmin=(819.19,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-64.1651,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cd-Cd(CO)H) + group(Cds-O2d(Cds-Cds)O2s) + radical(CCOJ)"""),
)
...
species(
    ...
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.17413,0.0344729,-1.3467e-05,1.05981e-09,1.65212e-13,-7423.32,17.8155], Tmin=(100,'K'), Tmax=(2305.73,'K')), NASAPolynomial(coeffs=[21.7044,0.0132918,-6.82117e-06,1.20086e-09,-7.37194e-14,-18883.3,-93.3834], Tmin=(2305.73,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-61.8383,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsOs) + radical(RCCJ) + radical(CCOJ)"""),
)

species(
    label = 'C[CH][CH]C(=O)O(2506)',
    ...
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.3049,0.0499155,-2.59439e-05,-7.81336e-09,8.18403e-12,-11906.8,19.7009], Tmin=(100,'K'), Tmax=(966.615,'K')), NASAPolynomial(coeffs=[15.0586,0.0146768,-4.89783e-06,8.70916e-10,-6.22408e-14,-15578.4,-51.4241], Tmin=(966.615,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-99.8758,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsCs) + radical(Allyl_S) + radical(C=COJ)"""),
)

species(
    label = '[CH2][CH]CC(=O)O(2507)',
    ...
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.11668,0.0420035,-2.56983e-05,7.67255e-09,-9.45074e-13,-10474.3,23.9786], Tmin=(100,'K'), Tmax=(1761.02,'K')), NASAPolynomial(coeffs=[9.95067,0.0242096,-1.0542e-05,1.93494e-09,-1.30557e-13,-13233.5,-18.2492], Tmin=(1761.02,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-87.6414,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsOs) + radical(RCCJ) + radical(CCJCC=O)"""),
)

species(
    label = 'C[CH]C[C]1OO1(2508)',
    ...
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.9261,0.0373484,-1.65452e-06,-2.6514e-08,1.39465e-11,34906,23.8828], Tmin=(100,'K'), Tmax=(927.472,'K')), NASAPolynomial(coeffs=[11.1308,0.0187514,-5.7043e-06,9.27202e-10,-6.23588e-14,32291,-24.7242], Tmin=(927.472,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(289.541,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + ring(dioxirane) + radical(RCCJC) + radical(Cs_P)"""),
)

species(
    label = 'CC1C[C]([O])O1(2509)',
    ...
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.34046,0.0292099,1.59238e-05,-4.04223e-08,1.8379e-11,11850.6,20.0384], Tmin=(100,'K'), Tmax=(894.685,'K')), NASAPolynomial(coeffs=[8.09905,0.0231111,-6.79065e-06,1.04777e-09,-6.72683e-14,10033.8,-11.4971], Tmin=(894.685,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(97.9779,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(278.535,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + ring(Oxetane) + radical(CCOJ) + radical(Cs_P)"""),
)
...
species(
    ...
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.96971,0.0496262,-6.25277e-05,5.67836e-08,-2.21203e-11,-34795,21.0642], Tmin=(100,'K'), Tmax=(765.336,'K')), NASAPolynomial(coeffs=[3.45454,0.0339905,-1.64478e-05,3.19941e-09,-2.24915e-13,-34791.7,15.8046], Tmin=(765.336,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-289.87,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cd-Cd(CO)H) + group(Cds-O2d(Cds-Cds)O2s)"""),
)
...
reaction(
    label = 'reaction18',
    reactants = ['CHCH3(T)(95)', '[CH2]C([O])=O(1440)'],
    products = ['C[CH]CC([O])=O(928)'],
