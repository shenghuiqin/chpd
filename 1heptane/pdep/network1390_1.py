...
species(
    label = 'C[CH]CCC=CC(C)OO(6663)',
    structure = SMILES('C[CH]CCC=CC(C)OO'),
    E0 = (-29.6088,'kJ/mol'),
    modes = [
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.692224,0.104138,-7.64686e-05,2.98771e-08,-4.95314e-12,-3393.58,42.8852], Tmin=(100,'K'), Tmax=(1359.82,'K')), NASAPolynomial(coeffs=[15.1313,0.0575919,-2.51243e-05,4.70492e-09,-3.25283e-13,-7696.99,-38.3173], Tmin=(1359.82,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-29.6088,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(573.699,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(RCCJC)"""),
)

species(
    label = 'C[CH]CC=CCC(C)OO(6664)',
    structure = SMILES('C[CH]CC=CCC(C)OO'),
    E0 = (-29.2725,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,2995,3025,975,1000,1300,1375,400,500,1630,1680,3615,1310,387.5,850,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,1380,1390,370,380,2900,435,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (143.203,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.583201,0.105384,-8.16439e-05,3.536e-08,-6.66983e-12,-3359.7,41.5945], Tmin=(100,'K'), Tmax=(1194.49,'K')), NASAPolynomial(coeffs=[12.2517,0.0624034,-2.76709e-05,5.23669e-09,-3.65182e-13,-6425.92,-22.6073], Tmin=(1194.49,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-29.2725,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(573.699,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(RCCJC)"""),
)

species(
    label = 'CC=CC[CH]CC(C)OO(6665)',
    structure = SMILES('CC=CC[CH]CC(C)OO'),
    E0 = (-30.3952,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,2995,3025,975,1000,1300,1375,400,500,1630,1680,3615,1310,387.5,850,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,1380,1390,370,380,2900,435,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (143.203,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.556685,0.108555,-9.59847e-05,5.27445e-08,-1.31408e-11,-3498.69,40.6876], Tmin=(100,'K'), Tmax=(916.816,'K')), NASAPolynomial(coeffs=[8.42109,0.0693849,-3.1898e-05,6.14297e-09,-4.33147e-13,-5144.86,-1.84516], Tmin=(916.816,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-30.3952,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(573.699,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(RCCJCC)"""),
)
...
species(
    label = 'C[CH]CCC[CH]C(C)OO(6667)',
    structure = SMILES('C[CH]CCC[CH]C(C)OO'),
    E0 = (54.4708,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3000,3050,390,425,1340,1360,335,370,3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (144.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.00843,0.118663,-0.000115098,7.00866e-08,-1.89637e-11,6724.3,44.7505], Tmin=(100,'K'), Tmax=(861.463,'K')), NASAPolynomial(coeffs=[9.19405,0.0712904,-3.26131e-05,6.25436e-09,-4.39575e-13,4966.46,-2.94925], Tmin=(861.463,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(54.4708,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(594.485,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJC) + radical(CCJCOOH)"""),
)
...
species(
    label = 'C[CH]CCCC[C](C)OO(6669)',
    structure = SMILES('C[CH]CCCC[C](C)OO'),
    E0 = (40.9549,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (144.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.111671,0.105971,-5.15216e-05,-7.20067e-08,9.01557e-11,5058.21,39.7282], Tmin=(100,'K'), Tmax=(495.318,'K')), NASAPolynomial(coeffs=[6.68378,0.075826,-3.51315e-05,6.74304e-09,-4.72825e-13,4081.63,8.65564], Tmin=(495.318,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(40.9549,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(594.485,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(C2CsJOOH) + radical(RCCJC)"""),
)

species(
    label = 'C[CH][CH]CCCC(C)OO(6670)',
    structure = SMILES('C[CH][CH]CCCC(C)OO'),
    E0 = (48.5141,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3000,3050,390,425,1340,1360,335,370,3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'C[CH]CCCCC(C)O[O](6673)',
    structure = SMILES('C[CH]CCCCC(C)O[O]'),
    E0 = (6.06053,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (144.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.824904,0.113748,-0.000106603,6.40871e-08,-1.73069e-11,896.014,42.5422], Tmin=(100,'K'), Tmax=(859.535,'K')), NASAPolynomial(coeffs=[8.39346,0.0708511,-3.17463e-05,6.02995e-09,-4.21508e-13,-688.77,-0.536199], Tmin=(859.535,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(6.06053,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(598.642,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJC) + radical(ROOJ)"""),
)
...
species(
    label = '[CH2][CH]CCCCC(C)OO(6675)',
    structure = SMILES('[CH2][CH]CCCCC(C)OO'),
    E0 = (59.3022,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1310,387.5,850,1000,2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,3000,3100,440,815,1455,1000,1380,1390,370,380,2900,435,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (144.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.944452,0.116795,-0.000107795,6.0955e-08,-1.52925e-11,7303.62,44.0001], Tmin=(100,'K'), Tmax=(922.507,'K')), NASAPolynomial(coeffs=[9.8188,0.0701242,-3.19063e-05,6.11161e-09,-4.29553e-13,5317.83,-7.05795], Tmin=(922.507,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(59.3022,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(594.485,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJC) + radical(RCCJ)"""),
)
...
species(
    label = 'CC=CCCCC(C)OO(6680)',
    structure = SMILES('CC=CCCCC(C)OO'),
    E0 = (-224.854,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (144.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.01017,0.110904,-8.37629e-05,3.37494e-08,-5.75057e-12,-26864.4,39.7155], Tmin=(100,'K'), Tmax=(1333.24,'K')), NASAPolynomial(coeffs=[16.0913,0.0595974,-2.604e-05,4.88657e-09,-3.38526e-13,-31424.6,-47.708], Tmin=(1333.24,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-224.854,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(598.642,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH)"""),
)
...
species(
    label = 'C=CCCCCC(C)OO(6682)',
    structure = SMILES('C=CCCCCC(C)OO'),
    E0 = (-212.608,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (144.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.21863,0.112552,-8.54885e-05,3.42085e-08,-5.71331e-12,-25381.7,40.9038], Tmin=(100,'K'), Tmax=(1373.57,'K')), NASAPolynomial(coeffs=[18.0057,0.0565692,-2.43532e-05,4.5366e-09,-3.12849e-13,-30662.9,-57.9447], Tmin=(1373.57,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-212.608,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(598.642,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH)"""),
)
...
species(
    label = 'C[CH]CC[CH]CCOO(6683)',
    structure = SMILES('C[CH]CC[CH]CCOO'),
    E0 = (84.9373,'kJ/mol'),
    modes = [
...
species(
    label = 'C[CH]CCC1CC(C)O1(6684)',
    structure = SMILES('C[CH]CCC1CC(C)O1'),
    E0 = (-46.0603,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (127.204,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0641426,0.0770014,-1.1243e-05,-3.53239e-08,1.89643e-11,-5382.23,34.6334], Tmin=(100,'K'), Tmax=(942.714,'K')), NASAPolynomial(coeffs=[13.3099,0.050491,-1.71715e-05,2.89153e-09,-1.92676e-13,-9247.37,-36.2256], Tmin=(942.714,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-46.0603,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(561.227,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Oxetane) + radical(RCCJC)"""),
)
...
species(
    label = 'C[CH]CCC(O)CC(C)[O](6686)',
    structure = SMILES('C[CH]CCC(O)CC(C)[O]'),
    E0 = (-159.559,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (144.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.928346,0.113587,-9.87479e-05,5.04238e-08,-1.11984e-11,-19017.4,43.5462], Tmin=(100,'K'), Tmax=(1041.04,'K')), NASAPolynomial(coeffs=[11.7873,0.0647296,-2.83501e-05,5.34196e-09,-3.7219e-13,-21664.9,-18.3109], Tmin=(1041.04,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-159.559,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(598.642,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJC) + radical(CC(C)OJ)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['C[CH]CC[CH]CC(C)OO(6353)'],
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'C[CH]CCC=CC(C)OO(6663)'],
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'C[CH]CC=CCC(C)OO(6664)'],
    products = ['C[CH]CC[CH]CC(C)OO(6353)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(1.46e+08,'cm^3/(mol*s)'), n=1.64, Ea=(5.73208,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""From training reaction 2555 used for Cds-CsH_Cds-CsH;HJ
Exact match found for rate rule [Cds-CsH_Cds-CsH;HJ]
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', 'CC=CC[CH]CC(C)OO(6665)'],
    products = ['C[CH]CC[CH]CC(C)OO(6353)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(1.46e+08,'cm^3/(mol*s)'), n=1.64, Ea=(5.73208,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""From training reaction 2555 used for Cds-CsH_Cds-CsH;HJ
Exact match found for rate rule [Cds-CsH_Cds-CsH;HJ]
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)', 'C=CCC[CH]CC(C)OO(6666)'],
    products = ['C[CH]CC[CH]CC(C)OO(6353)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['C=CCC[CH]C(370)', 'CH3CHOOH(63)'],
    products = ['C[CH]CC[CH]CC(C)OO(6353)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['C[CH]CCC[CH]C(C)OO(6667)'],
    products = ['C[CH]CC[CH]CC(C)OO(6353)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['CC[CH]C[CH]CC(C)OO(6613)'],
    products = ['C[CH]CC[CH]CC(C)OO(6353)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]CCC[CH]CC(C)OO(6668)'],
    products = ['C[CH]CC[CH]CC(C)OO(6353)'],
...
reaction(
    label = 'reaction13',
    reactants = ['C[CH]CC[CH]CC(C)OO(6353)'],
    products = ['C[CH]CCCC[C](C)OO(6669)'],
...
reaction(
    label = 'reaction14',
    reactants = ['C[CH][CH]CCCC(C)OO(6670)'],
    products = ['C[CH]CC[CH]CC(C)OO(6353)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CCC[CH][CH]CC(C)OO(6671)'],
    products = ['C[CH]CC[CH]CC(C)OO(6353)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]C(CCCC[CH]C)OO(6672)'],
    products = ['C[CH]CC[CH]CC(C)OO(6353)'],
...
reaction(
    label = 'reaction17',
    reactants = ['C[CH]CC[CH]CC(C)OO(6353)'],
    products = ['C[CH]CCCCC(C)O[O](6673)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CCCC[CH][CH]C(C)OO(6674)'],
    products = ['C[CH]CC[CH]CC(C)OO(6353)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2][CH]CCCCC(C)OO(6675)'],
    products = ['C[CH]CC[CH]CC(C)OO(6353)'],
...
reaction(
    label = 'reaction22',
    reactants = ['C[CH]CC[CH]CC(C)OO(6353)'],
    products = ['CCCC[CH]CC(C)O[O](6678)'],
...
reaction(
    label = 'reaction28',
    reactants = ['CH2(S)(23)', 'C[CH]CC[CH]CCOO(6683)'],
    products = ['C[CH]CC[CH]CC(C)OO(6353)'],
...
reaction(
    label = 'reaction29',
    reactants = ['C[CH]CC[CH]CC(C)OO(6353)'],
    products = ['OH(5)', 'C[CH]CCC1CC(C)O1(6684)'],
...
reaction(
    label = 'reaction30',
    reactants = ['[CH2]C(CC[CH]C)C(C)OO(6685)'],
    products = ['C[CH]CC[CH]CC(C)OO(6353)'],
...
reaction(
    label = 'reaction34',
    reactants = ['C[CH]CC[CH]CC(C)OO(6353)'],
    products = ['C[CH]CCC(O)CC(C)[O](6686)'],
...
reaction(
    label = 'reaction35',
    reactants = ['[CH2]C[CH]C(129)', '[CH]CC(C)OO(1806)'],
    products = ['C[CH]CC[CH]CC(C)OO(6353)'],
...
reaction(
    label = 'reaction36',
    reactants = ['CHCH3(T)(95)', '[CH2]C[CH]CC(C)OO(5450)'],
    products = ['C[CH]CC[CH]CC(C)OO(6353)'],
