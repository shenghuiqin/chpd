...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.78629,0.10964,-9.91981e-05,4.9177e-08,-1.02774e-11,-25760.3,41.5631], Tmin=(100,'K'), Tmax=(1116.47,'K')), NASAPolynomial(coeffs=[14.658,0.0543082,-2.48583e-05,4.7874e-09,-3.37734e-13,-29208.9,-34.6481], Tmin=(1116.47,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-215.585,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(523.812,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdCsCs) + radical(CJCOOH)"""),
)

species(
    label = 'C=C(OO)C([O])CCCC(16550)',
    structure = SMILES('C=C(OO)C([O])CCCC'),
    E0 = (-120.372,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (145.176,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.890571,0.106634,-9.02188e-05,4.02676e-08,-7.42956e-12,-14300.8,41.5407], Tmin=(100,'K'), Tmax=(1266.87,'K')), NASAPolynomial(coeffs=[17.5175,0.0485125,-2.14006e-05,4.05295e-09,-2.82997e-13,-18964.9,-51.6218], Tmin=(1266.87,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-120.372,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(527.969,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(CC(C)OJ)"""),
)
...
species(
    label = '[CH2]C(OO)C(O)[CH]CCC(16552)',
    structure = SMILES('[CH2]C(OO)C(O)[CH]CCC'),
    E0 = (-75.216,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (146.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.33884,0.118854,-0.000113678,5.90093e-08,-1.26295e-11,-8855.31,45.4777], Tmin=(100,'K'), Tmax=(1110.04,'K')), NASAPolynomial(coeffs=[17.3858,0.0513802,-2.25013e-05,4.25092e-09,-2.97024e-13,-13012.3,-46.8125], Tmin=(1110.04,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-75.216,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(544.598,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJCOOH) + radical(CCJCO)"""),
)

species(
    label = '[CH2][C](OO)C(O)CCCC(16553)',
    structure = SMILES('[CH2][C](OO)C(O)CCCC'),
    E0 = (-88.2189,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (146.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.33342,0.125569,-0.00014261,9.57159e-08,-2.7112e-11,-10425.5,43.2749], Tmin=(100,'K'), Tmax=(844.511,'K')), NASAPolynomial(coeffs=[12.2641,0.0611645,-2.82175e-05,5.41301e-09,-3.79792e-13,-12722.2,-20.0275], Tmin=(844.511,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-88.2189,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(544.598,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJCOOH) + radical(C2CsJOOH)"""),
)

species(
    label = 'CCCC[C]([O])C(C)OO(16554)',
    structure = SMILES('CCCC[C]([O])C(C)OO'),
    E0 = (-82.092,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (146.184,'amu'),
...
species(
    label = 'CCCCC([O])C(C)O[O](16555)',
    structure = SMILES('CCCCC([O])C(C)O[O]'),
    E0 = (-106.715,'kJ/mol'),
    modes = [
...
species(
    label = '[CH2]C(OO)C(O)C[CH]CC(16556)',
    structure = SMILES('[CH2]C(OO)C(O)C[CH]CC'),
    E0 = (-80.6597,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1277.5,1000,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3100,440,815,1455,1000,3615,1310,387.5,850,1000,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'CCC[CH]C([O])C(C)OO(16557)',
    structure = SMILES('CCC[CH]C([O])C(C)OO'),
    E0 = (-58.8178,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (146.184,'amu'),
...
species(
    label = '[CH2]C(OO)C(O)CC[CH]C(16558)',
    structure = SMILES('[CH2]C(OO)C(O)CC[CH]C'),
    E0 = (-80.6718,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (146.184,'amu'),
...
species(
    label = 'CC[CH]CC([O])C(C)OO(16559)',
    structure = SMILES('CC[CH]CC([O])C(C)OO'),
    E0 = (-64.2615,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (146.184,'amu'),
...
species(
    label = '[CH2]C(O[O])C(O)CCCC(16560)',
    structure = SMILES('[CH2]C(O[O])C(O)CCCC'),
    E0 = (-123.113,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (146.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.214,0.11968,-0.00012366,7.28515e-08,-1.79304e-11,-14623.5,43.3026], Tmin=(100,'K'), Tmax=(968.615,'K')), NASAPolynomial(coeffs=[14.2831,0.0556819,-2.45491e-05,4.63494e-09,-3.23218e-13,-17625.6,-30.9673], Tmin=(968.615,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-123.113,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(548.755,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(CJCOOH)"""),
)

species(
    label = '[CH2]CCCC(O)C([CH2])OO(16561)',
    structure = SMILES('[CH2]CCCC(O)C([CH2])OO'),
    E0 = (-69.8717,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (146.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.38791,0.123385,-0.000127228,7.29164e-08,-1.73384e-11,-8213.63,44.9542], Tmin=(100,'K'), Tmax=(1002.75,'K')), NASAPolynomial(coeffs=[15.8074,0.0547914,-2.46171e-05,4.6953e-09,-3.29527e-13,-11662.1,-38.0499], Tmin=(1002.75,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-69.8717,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(544.598,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJ) + radical(CJCOOH)"""),
)

species(
    label = 'C[CH]CCC([O])C(C)OO(16562)',
    structure = SMILES('C[CH]CCC([O])C(C)OO'),
    E0 = (-64.2735,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (146.184,'amu'),
...
species(
    label = '[CH2]CCCC([O])C(C)OO(16563)',
    structure = SMILES('[CH2]CCCC([O])C(C)OO'),
    E0 = (-53.4735,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (146.184,'amu'),
...
species(
    ...
    molecularWeight = (146.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.71753,0.107001,-8.67439e-05,3.78811e-08,-7.01729e-12,-51495.8,39.3114], Tmin=(100,'K'), Tmax=(1235.69,'K')), NASAPolynomial(coeffs=[14.8439,0.0566276,-2.55962e-05,4.89139e-09,-3.42947e-13,-55341.7,-39.0567], Tmin=(1235.69,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-429.548,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(548.755,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdCsCs)"""),
)

species(
    label = 'C=C(OO)C(O)CCCC(16565)',
    structure = SMILES('C=C(OO)C(O)CCCC'),
    E0 = (-350.733,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (146.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.01965,0.110219,-9.46739e-05,4.34453e-08,-8.27026e-12,-42002.7,42.1971], Tmin=(100,'K'), Tmax=(1229.48,'K')), NASAPolynomial(coeffs=[17.2039,0.0509299,-2.23389e-05,4.2224e-09,-2.94702e-13,-46483.8,-49.486], Tmin=(1229.48,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-350.733,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(548.755,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH)"""),
)
...
species(
    label = 'CCCCC([O])C1CO1(16567)',
    structure = SMILES('CCCCC([O])C1CO1'),
    E0 = (-140.661,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
species(
    label = '[CH2]C1OOC1CCCC(16568)',
    structure = SMILES('[CH2]C1OOC1CCCC'),
    E0 = (54.0644,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (129.177,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.286332,0.090085,-6.2998e-05,2.2782e-08,-3.42088e-12,6659.6,32.2987], Tmin=(100,'K'), Tmax=(1512.78,'K')), NASAPolynomial(coeffs=[16.3709,0.0460412,-1.93266e-05,3.53651e-09,-2.40427e-13,1619.82,-54.9583], Tmin=(1512.78,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(54.0644,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(511.34,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(12dioxetane) + radical(CJCOOH)"""),
)
...
species(
    ...
    molecularWeight = (146.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.11176,0.115211,-0.000108158,5.64903e-08,-1.23314e-11,-31051.9,41.7306], Tmin=(100,'K'), Tmax=(1081.83,'K')), NASAPolynomial(coeffs=[15.3511,0.0543412,-2.37598e-05,4.48119e-09,-3.12664e-13,-34613.9,-38.9882], Tmin=(1081.83,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-259.692,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(552.912,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(CC(C)OJ)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', '[CH2]C(OO)C(=O)CCCC(16549)'],
    products = ['[CH2]C(OO)C([O])CCCC(13475)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'C=C(OO)C([O])CCCC(16550)'],
    products = ['[CH2]C(OO)C([O])CCCC(13475)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['butyl_1(82)', '[CH2]C(C=O)OO(10685)'],
    products = ['[CH2]C(OO)C([O])CCCC(13475)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['HO2(10)', 'C=CC([O])CCCC(10637)'],
    products = ['[CH2]C(OO)C([O])CCCC(13475)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]C(OO)C([O])CCCC(13475)'],
    products = ['[CH2]C(OO)[C](O)CCCC(16551)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]C(OO)C(O)[CH]CCC(16552)'],
    products = ['[CH2]C(OO)C([O])CCCC(13475)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]C(OO)C([O])CCCC(13475)'],
    products = ['[CH2][C](OO)C(O)CCCC(16553)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]C(OO)C([O])CCCC(13475)'],
    products = ['CCCC[C]([O])C(C)OO(16554)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CCCCC([O])C(C)O[O](16555)'],
    products = ['[CH2]C(OO)C([O])CCCC(13475)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]C(OO)C(O)C[CH]CC(16556)'],
    products = ['[CH2]C(OO)C([O])CCCC(13475)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]C(OO)C([O])CCCC(13475)'],
    products = ['CCC[CH]C([O])C(C)OO(16557)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]C(OO)C([O])CCCC(13475)'],
    products = ['[CH2]C(OO)C(O)CC[CH]C(16558)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]C(OO)C([O])CCCC(13475)'],
    products = ['CC[CH]CC([O])C(C)OO(16559)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2]C(OO)C([O])CCCC(13475)'],
    products = ['[CH2]C(O[O])C(O)CCCC(16560)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2]C(OO)C([O])CCCC(13475)'],
    products = ['[CH2]CCCC(O)C([CH2])OO(16561)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2]C(OO)C([O])CCCC(13475)'],
    products = ['C[CH]CCC([O])C(C)OO(16562)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH2]C(OO)C([O])CCCC(13475)'],
    products = ['[CH2]CCCC([O])C(C)OO(16563)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[CH2]C(OO)C([O])CCCC(13475)'],
    products = ['C=C(OO)C(O)CCCC(16565)'],
...
reaction(
    label = 'reaction25',
    reactants = ['CH2(S)(23)', '[CH2]C(OO)C([O])CCC(16566)'],
    products = ['[CH2]C(OO)C([O])CCCC(13475)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[CH2]C(OO)C([O])CCCC(13475)'],
    products = ['OH(5)', 'CCCCC([O])C1CO1(16567)'],
...
reaction(
    label = 'reaction27',
    reactants = ['[CH2]C(OO)C([O])CCCC(13475)'],
    products = ['OH(5)', '[CH2]C1OOC1CCCC(16568)'],
...
reaction(
    label = 'reaction31',
    reactants = ['O(4)', '[CH2]C([CH]CCCC)OO(11504)'],
    products = ['[CH2]C(OO)C([O])CCCC(13475)'],
...
reaction(
    label = 'reaction32',
    reactants = ['CH2(19)', 'CCCCC([O])[CH]OO(14651)'],
    products = ['[CH2]C(OO)C([O])CCCC(13475)'],
