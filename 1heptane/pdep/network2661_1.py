...
species(
    label = 'CC(CC([O])CC=O)OO(16019)',
    structure = SMILES('CC(CC([O])CC=O)OO'),
    E0 = (-317.739,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,2782.5,750,1395,475,1775,1000,3615,1310,387.5,850,1000,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.718385,0.111515,-0.000122718,7.80327e-08,-2.09555e-11,-38051.9,38.3745], Tmin=(100,'K'), Tmax=(886.524,'K')), NASAPolynomial(coeffs=[12.0099,0.0540872,-2.5553e-05,4.96656e-09,-3.51528e-13,-40308.8,-21.4995], Tmin=(886.524,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-317.739,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(478.082,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(CC(C)OJ)"""),
)
...
species(
    label = 'CC(CC([O])C=CO)OO(16020)',
    structure = SMILES('CC(CC([O])C=CO)OO'),
    E0 = (-316.286,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (147.149,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.87729,0.113785,-9.5032e-05,2.78661e-08,1.16992e-12,-37815.1,41.7158], Tmin=(100,'K'), Tmax=(994.361,'K')), NASAPolynomial(coeffs=[27.6552,0.0259525,-9.24967e-06,1.67286e-09,-1.18854e-13,-45219.2,-108.292], Tmin=(994.361,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-316.286,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(478.082,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(CC(C)OJ)"""),
)
...
species(
    ...
    molecularWeight = (148.157,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.00801,0.119204,-0.00014503,1.08013e-07,-3.42592e-11,-20161.4,40.9396], Tmin=(100,'K'), Tmax=(756.115,'K')), NASAPolynomial(coeffs=[10.0575,0.0606611,-2.88813e-05,5.59731e-09,-3.94032e-13,-21834.7,-9.3507], Tmin=(756.115,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-169.062,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(CCOJ)"""),
)

species(
    label = 'CC(C[C](O)C[CH]O)OO(16022)',
    structure = SMILES('CC(C[C](O)C[CH]O)OO'),
    E0 = (-268.202,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (148.157,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.18804,0.146438,-0.000218854,1.8001e-07,-5.89402e-11,-32044.3,43.4607], Tmin=(100,'K'), Tmax=(824.872,'K')), NASAPolynomial(coeffs=[14.8913,0.0514137,-2.38638e-05,4.48301e-09,-3.0638e-13,-34446.8,-33.1323], Tmin=(824.872,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-268.202,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(494.711,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCsJOH) + radical(C2CsJOH)"""),
)

species(
    label = 'CC(CC([O])[CH]CO)OO(16023)',
    structure = SMILES('CC(CC([O])[CH]CO)OO'),
    E0 = (-194.865,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1277.5,1000,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3615,1310,387.5,850,1000,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (148.157,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.07343,0.115618,-0.000120496,6.88412e-08,-1.62056e-11,-23257.5,42.8043], Tmin=(100,'K'), Tmax=(1015.62,'K')), NASAPolynomial(coeffs=[15.8547,0.0489473,-2.2028e-05,4.20621e-09,-2.95466e-13,-26696,-39.1268], Tmin=(1015.62,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-194.865,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(498.868,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCJCO) + radical(CC(C)OJ)"""),
)

species(
    label = 'CC([CH]C(O)C[CH]O)OO(16024)',
    structure = SMILES('CC([CH]C(O)C[CH]O)OO'),
    E0 = (-244.415,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3050,390,425,1340,1360,335,370,2750,2800,2850,1350,1500,750,1050,1375,1000,3580,3650,1210,1345,900,1100,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,2750,2850,1437.5,1250,1305,750,350,3615,1310,387.5,850,1000,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (148.157,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.65465,0.134844,-0.0001766,1.22043e-07,-3.11672e-11,-29202.3,44.4689], Tmin=(100,'K'), Tmax=(667.737,'K')), NASAPolynomial(coeffs=[14.9389,0.0511067,-2.36794e-05,4.49909e-09,-3.11943e-13,-31767.6,-31.4989], Tmin=(667.737,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-244.415,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(494.711,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCsJOH) + radical(CCJCOOH)"""),
)

species(
    label = 'CC(CC(O)[CH][CH]O)OO(16025)',
    structure = SMILES('CC(CC(O)[CH][CH]O)OO'),
    E0 = (-244.928,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (148.157,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.57619,0.129114,-0.000159978,1.08923e-07,-3.00853e-11,-29262.9,44.3544], Tmin=(100,'K'), Tmax=(879.22,'K')), NASAPolynomial(coeffs=[16.2267,0.0481167,-2.17854e-05,4.13361e-09,-2.87949e-13,-32393.3,-39.2418], Tmin=(879.22,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-244.928,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(494.711,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCsJOH) + radical(CCJCO)"""),
)

species(
    label = 'CC(C[C]([O])CCO)OO(16026)',
    structure = SMILES('CC(C[C]([O])CCO)OO'),
    E0 = (-218.139,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (148.157,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.59767,0.131635,-0.000173505,1.30496e-07,-4.0237e-11,-26042.4,41.6142], Tmin=(100,'K'), Tmax=(787.728,'K')), NASAPolynomial(coeffs=[13.7664,0.0536162,-2.49377e-05,4.75916e-09,-3.31241e-13,-28462.9,-28.8426], Tmin=(787.728,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-218.139,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(498.868,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(C2CsJOH)"""),
)

species(
    label = 'C[C](CC(O)C[CH]O)OO(16027)',
    structure = SMILES('C[C](CC(O)C[CH]O)OO'),
    E0 = (-257.931,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (148.157,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.88772,0.140117,-0.000206495,1.72144e-07,-5.75552e-11,-30820.1,43.2521], Tmin=(100,'K'), Tmax=(817.516,'K')), NASAPolynomial(coeffs=[12.8404,0.0548052,-2.56534e-05,4.84789e-09,-3.32858e-13,-32785.4,-22.1273], Tmin=(817.516,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-257.931,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(494.711,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCsJOH) + radical(C2CsJOOH)"""),
)

species(
    label = 'CC([CH]C([O])CCO)OO(16028)',
    structure = SMILES('CC([CH]C([O])CCO)OO'),
    E0 = (-194.352,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1277.5,1000,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3615,1310,387.5,850,1000,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (148.157,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.25142,0.12283,-0.000144368,9.59673e-08,-2.63752e-11,-23192.4,43.2605], Tmin=(100,'K'), Tmax=(876.147,'K')), NASAPolynomial(coeffs=[14.0953,0.0527647,-2.44098e-05,4.68878e-09,-3.29289e-13,-25881.6,-28.7489], Tmin=(876.147,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-194.352,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(498.868,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(CCJCOOH)"""),
)

species(
    label = '[CH2]C(CC(O)C[CH]O)OO(16029)',
    structure = SMILES('[CH2]C(CC(O)C[CH]O)OO'),
    E0 = (-230.867,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (148.157,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.93596,0.138288,-0.000186413,1.37533e-07,-4.08651e-11,-27560.2,45.1402], Tmin=(100,'K'), Tmax=(821.69,'K')), NASAPolynomial(coeffs=[16.5627,0.0482372,-2.20283e-05,4.16338e-09,-2.88019e-13,-30600.3,-40.4724], Tmin=(821.69,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-230.867,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(494.711,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CJCOOH) + radical(CCsJOH)"""),
)

species(
    label = 'C[C](CC([O])CCO)OO(16030)',
    structure = SMILES('C[C](CC([O])CCO)OO'),
    E0 = (-207.868,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (148.157,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.30545,0.125415,-0.000161535,1.23211e-07,-3.91495e-11,-24817.8,41.4343], Tmin=(100,'K'), Tmax=(761.067,'K')), NASAPolynomial(coeffs=[11.7055,0.0570273,-2.67397e-05,5.12719e-09,-3.57993e-13,-26798.1,-17.7829], Tmin=(761.067,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-207.868,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(498.868,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(C2CsJOOH)"""),
)

species(
    label = 'CC(CC(O)C[CH][O])OO(16031)',
    structure = SMILES('CC(CC(O)C[CH][O])OO'),
    E0 = (-219.125,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (148.157,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.64242,0.134612,-0.000192939,1.61584e-07,-5.50732e-11,-26161.5,42.9389], Tmin=(100,'K'), Tmax=(795.746,'K')), NASAPolynomial(coeffs=[11.3068,0.0582274,-2.76656e-05,5.2861e-09,-3.66164e-13,-27864.8,-14.3286], Tmin=(795.746,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-219.125,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(498.868,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCsJOH) + radical(CCOJ)"""),
)

species(
    label = 'CC(CC(O)C[CH]O)O[O](16032)',
    structure = SMILES('CC(CC(O)C[CH]O)O[O]'),
    E0 = (-292.825,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (148.157,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.31896,0.12774,-0.000158036,9.79913e-08,-1.85198e-11,-35037.1,41.7368], Tmin=(100,'K'), Tmax=(640.323,'K')), NASAPolynomial(coeffs=[14.0903,0.050761,-2.28719e-05,4.28963e-09,-2.95176e-13,-37405.8,-28.8212], Tmin=(640.323,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-292.825,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(498.868,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(CCsJOH)"""),
)

species(
    label = '[CH2]C(CC([O])CCO)OO(16033)',
    structure = SMILES('[CH2]C(CC([O])CCO)OO'),
    E0 = (-180.804,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (148.157,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.34701,0.123624,-0.00014215,9.02729e-08,-2.34925e-11,-21558.3,43.291], Tmin=(100,'K'), Tmax=(926.373,'K')), NASAPolynomial(coeffs=[15.7275,0.0498966,-2.27665e-05,4.35617e-09,-3.05705e-13,-24721.7,-37.7772], Tmin=(926.373,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-180.804,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(498.868,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(CJCOOH)"""),
)

species(
    label = 'CC(CC([O])CCO)O[O](16034)',
    structure = SMILES('CC(CC([O])CCO)O[O]'),
    E0 = (-242.762,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2800,2850,1350,1500,750,1050,1375,1000,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,492.5,1135,1000,3615,1277.5,1000,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (148.157,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.06797,0.117917,-0.000135873,8.99651e-08,-2.47161e-11,-29020.7,41.0525], Tmin=(100,'K'), Tmax=(875.799,'K')), NASAPolynomial(coeffs=[13.2937,0.0523271,-2.35441e-05,4.46464e-09,-3.11246e-13,-31536.5,-26.3308], Tmin=(875.799,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-242.762,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(ROOJ)"""),
)

species(
    label = 'CC(CC(=O)CCO)OO(16035)',
    structure = SMILES('CC(CC(=O)CCO)OO'),
    E0 = (-568.184,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (148.157,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.46184,0.131197,-0.000189207,1.61705e-07,-5.6139e-11,-68150.7,39.986], Tmin=(100,'K'), Tmax=(803.113,'K')), NASAPolynomial(coeffs=[9.88393,0.0599313,-2.8538e-05,5.45374e-09,-3.77566e-13,-69497.2,-9.30013], Tmin=(803.113,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-568.184,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(498.868,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdCsCs)"""),
)

species(
    label = 'CC(CC(O)C=CO)OO(16036)',
    structure = SMILES('CC(CC(O)C=CO)OO'),
    E0 = (-546.647,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (148.157,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.04187,0.117802,-0.000101023,3.30184e-08,-4.88063e-13,-65515.6,42.4983], Tmin=(100,'K'), Tmax=(995.555,'K')), NASAPolynomial(coeffs=[27.7296,0.0277289,-9.82568e-06,1.75796e-09,-1.23637e-13,-72907.5,-108.352], Tmin=(995.555,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-546.647,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(498.868,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH)"""),
)

species(
    label = 'CC(CC(O)CC=O)OO(16037)',
    structure = SMILES('CC(CC(O)CC=O)OO'),
    E0 = (-548.1,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (148.157,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.912744,0.115887,-0.000129972,8.48658e-08,-2.33579e-11,-65751.1,39.2635], Tmin=(100,'K'), Tmax=(867.509,'K')), NASAPolynomial(coeffs=[12.1163,0.0558126,-2.61013e-05,5.04543e-09,-3.55815e-13,-68011.7,-21.7427], Tmin=(867.509,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-548.1,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(498.868,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsH)"""),
)
...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.843891,0.115948,-0.000150957,1.03198e-07,-2.56109e-11,-21248.2,37.1604], Tmin=(100,'K'), Tmax=(657.844,'K')), NASAPolynomial(coeffs=[13.164,0.0448553,-2.09613e-05,3.9978e-09,-2.77801e-13,-23395.9,-26.8693], Tmin=(657.844,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-178.046,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(428.195,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + radical(CCsJOH) + radical(CC(C)OJ)"""),
)
...
species(
    label = 'CC1CC(C[CH]O)OO1(16039)',
    structure = SMILES('CC1CC(C[CH]O)OO1'),
    E0 = (-200.577,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (131.15,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.35956,0.0831038,-3.70695e-05,-2.10966e-08,1.82081e-11,-23954.9,31.5113], Tmin=(100,'K'), Tmax=(901.698,'K')), NASAPolynomial(coeffs=[19.5466,0.0302806,-8.22189e-06,1.21503e-09,-7.72882e-14,-28987.2,-70.4629], Tmin=(901.698,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-200.577,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(465.61,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(12dioxolane) + radical(CCsJOH)"""),
)

species(
    label = 'CC1CC([O])CC(O)O1(16040)',
    ...
    molecularWeight = (131.15,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.336785,0.062061,2.03189e-05,-7.51834e-08,3.5515e-11,-50717.3,27.8003], Tmin=(100,'K'), Tmax=(926.224,'K')), NASAPolynomial(coeffs=[18.0325,0.0330477,-9.47056e-06,1.51899e-09,-1.03636e-13,-56028.9,-67.1928], Tmin=(926.224,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-422.926,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(473.925,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + ring(Oxane) + radical(CC(C)OJ)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['CC(CC([O])C[CH]O)OO(13300)'],
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'CC(CC([O])CC=O)OO(16019)'],
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'CC(CC(=O)C[CH]O)OO(10395)'],
    products = ['CC(CC([O])C[CH]O)OO(13300)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', 'CC(CC([O])C=CO)OO(16020)'],
    products = ['CC(CC([O])C[CH]O)OO(13300)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['QOOH_3(717)', 'O=CC[CH]O(3984)'],
    products = ['CC(CC([O])C[CH]O)OO(13300)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['CC(CC([O])CC[O])OO(16021)'],
    products = ['CC(CC([O])C[CH]O)OO(13300)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['CC(CC([O])C[CH]O)OO(13300)'],
    products = ['CC(C[C](O)C[CH]O)OO(16022)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['CC(CC([O])[CH]CO)OO(16023)'],
    products = ['CC(CC([O])C[CH]O)OO(13300)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CC([CH]C(O)C[CH]O)OO(16024)'],
    products = ['CC(CC([O])C[CH]O)OO(13300)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CC(CC([O])C[CH]O)OO(13300)'],
    products = ['CC(CC(O)[CH][CH]O)OO(16025)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CC(CC([O])C[CH]O)OO(13300)'],
    products = ['CC(C[C]([O])CCO)OO(16026)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CC(CC([O])C[CH]O)OO(13300)'],
    products = ['C[C](CC(O)C[CH]O)OO(16027)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CC([CH]C([O])CCO)OO(16028)'],
    products = ['CC(CC([O])C[CH]O)OO(13300)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CC(CC([O])C[CH]O)OO(13300)'],
    products = ['[CH2]C(CC(O)C[CH]O)OO(16029)'],
...
reaction(
    label = 'reaction17',
    reactants = ['C[C](CC([O])CCO)OO(16030)'],
    products = ['CC(CC([O])C[CH]O)OO(13300)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CC(CC([O])C[CH]O)OO(13300)'],
    products = ['CC(CC(O)C[CH][O])OO(16031)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CC(CC([O])C[CH]O)OO(13300)'],
    products = ['CC(CC(O)C[CH]O)O[O](16032)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2]C(CC([O])CCO)OO(16033)'],
    products = ['CC(CC([O])C[CH]O)OO(13300)'],
...
reaction(
    label = 'reaction21',
    reactants = ['CC(CC([O])CCO)O[O](16034)'],
    products = ['CC(CC([O])C[CH]O)OO(13300)'],
...
reaction(
    label = 'reaction24',
    reactants = ['CC(CC([O])C[CH]O)OO(13300)'],
    products = ['CC(CC(O)C=CO)OO(16036)'],
...
reaction(
    label = 'reaction25',
    reactants = ['CC(CC([O])C[CH]O)OO(13300)'],
    products = ['CC(CC(O)CC=O)OO(16037)'],
...
reaction(
    label = 'reaction26',
    reactants = ['CH2(S)(23)', '[O]C(C[CH]O)CCOO(16038)'],
    products = ['CC(CC([O])C[CH]O)OO(13300)'],
...
reaction(
    label = 'reaction27',
    reactants = ['CC(CC([O])C[CH]O)OO(13300)'],
    products = ['OH(5)', 'CC1CC(C[CH]O)OO1(16039)'],
...
reaction(
    label = 'reaction28',
    reactants = ['CC(CC([O])C[CH]O)OO(13300)'],
    products = ['OH(5)', 'CC1CC([O])CC(O)O1(16040)'],
...
reaction(
    label = 'reaction32',
    reactants = ['HCOH(T)(285)', '[CH2]C([O])CC(C)OO(1956)'],
    products = ['CC(CC([O])C[CH]O)OO(13300)'],
