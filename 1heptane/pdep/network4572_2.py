...
species(
    ...
    E0 = (-218.034,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2761.11,2772.22,2783.33,2794.44,2805.56,2816.67,2827.78,2838.89,2850,1425,1431.25,1437.5,1443.75,1450,1225,1237.5,1250,1262.5,1275,1270,1287.5,1305,1322.5,1340,700,725,750,775,800,300,325,350,375,400,360,370,350,3580,3650,1300,1320,350,425,825,875,900,1100,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'CCCC=C(CCOO)OO(28364)',
    structure = SMILES('CCCC=C(CCOO)OO'),
    E0 = (-277.359,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,3010,987.5,1337.5,450,1655,350,440,435,1725,3580,3650,1300,1320,350,425,825,875,900,1100,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (162.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.33818,0.125256,-0.000124789,7.07986e-08,-1.70733e-11,-33172.9,43.7936], Tmin=(100,'K'), Tmax=(976.031,'K')), NASAPolynomial(coeffs=[13.7875,0.063267,-2.95206e-05,5.72584e-09,-4.05435e-13,-36125.5,-28.8119], Tmin=(976.031,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-277.359,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(569.541,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH)"""),
)

species(
    label = 'CCCCC(=CCOO)OO(28365)',
    structure = SMILES('CCCCC(=CCOO)OO'),
    E0 = (-271.802,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,3010,987.5,1337.5,450,1655,350,440,435,1725,3580,3650,1300,1320,350,425,825,875,900,1100,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (162.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.23891,0.123872,-0.000124512,7.28277e-08,-1.82848e-11,-32508.9,43.8247], Tmin=(100,'K'), Tmax=(936.008,'K')), NASAPolynomial(coeffs=[12.4732,0.0652745,-3.0607e-05,5.94496e-09,-4.21124e-13,-35075.9,-21.4217], Tmin=(936.008,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-271.802,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(569.541,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH)"""),
)

species(
    label = 'C=C(CCOO)OO(28366)',
    structure = SMILES('C=C(CCOO)OO'),
    E0 = (-194.908,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2950,3100,1380,975,1025,1650,3580,3650,1300,1320,350,425,825,875,900,1100,350,440,435,1725,200,800],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (120.104,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.371005,0.08582,-9.79324e-05,6.31025e-08,-1.69772e-11,-23316.5,30.6905], Tmin=(100,'K'), Tmax=(889.105,'K')), NASAPolynomial(coeffs=[10.8162,0.038826,-1.86457e-05,3.6492e-09,-2.59237e-13,-25173.8,-18.4733], Tmin=(889.105,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-194.908,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH)"""),
)
...
species(
    label = 'C=C(CCCC)OO(7773)',
    structure = SMILES('C=C(CCCC)OO'),
    E0 = (-154.146,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2950,3100,1380,975,1025,1650,350,440,435,1725,3615,1310,387.5,850,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.271313,0.0815249,-6.03399e-05,2.35927e-08,-3.87974e-12,-18405.3,32.0465], Tmin=(100,'K'), Tmax=(1381.08,'K')), NASAPolynomial(coeffs=[13.5099,0.0431822,-1.86958e-05,3.49058e-09,-2.40901e-13,-22062,-36.0964], Tmin=(1381.08,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-154.146,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH)"""),
)
...
species(
    label = '[CH2]CCCC(CCOO)OO(28367)',
    structure = SMILES('[CH2]CCCC(CCOO)OO'),
    E0 = (-199.686,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2761.11,2772.22,2783.33,2794.44,2805.56,2816.67,2827.78,2838.89,2850,1425,1431.25,1437.5,1443.75,1450,1225,1237.5,1250,1262.5,1275,1270,1287.5,1305,1322.5,1340,700,725,750,775,800,300,325,350,375,400,3580,3650,1300,1320,350,425,825,875,900,1100,3000,3100,440,815,1455,1000,1380,1390,370,380,2900,435,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'CCCC[C](CC[O])OO(28368)',
    structure = SMILES('CCCC[C](CC[O])OO'),
    E0 = (-63.8334,'kJ/mol'),
    modes = [
...
species(
    label = '[CH2]C[C](CCOO)OO(28370)',
    structure = SMILES('[CH2]C[C](CCOO)OO'),
    E0 = (34.7733,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3580,3650,1300,1320,350,425,825,875,900,1100,3000,3100,440,815,1455,1000,360,370,350,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (134.13,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.851876,0.116326,-0.000167359,1.42281e-07,-4.95031e-11,4347.76,37.9302], Tmin=(100,'K'), Tmax=(782.643,'K')), NASAPolynomial(coeffs=[9.6581,0.0524736,-2.55508e-05,4.93659e-09,-3.44302e-13,3013.12,-8.21507], Tmin=(782.643,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(34.7733,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(424.038,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(C2CsJOOH) + radical(RCCJ)"""),
)

species(
    label = '[CH2][C](CCOO)OO(28371)',
    structure = SMILES('[CH2][C](CCOO)OO'),
    E0 = (67.2697,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3580,3650,1300,1320,350,425,825,875,900,1100,3000,3100,440,815,1455,1000,360,370,350,200,800],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (120.104,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.30689,0.103504,-0.000155989,1.33838e-07,-4.62233e-11,8237.33,33.9373], Tmin=(100,'K'), Tmax=(799.284,'K')), NASAPolynomial(coeffs=[9.73033,0.04237,-2.08001e-05,4.01333e-09,-2.78942e-13,6981.08,-10.0592], Tmin=(799.284,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(67.2697,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(353.365,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(C2CsJOOH) + radical(CJCOOH)"""),
)

species(
    label = 'CC[CH]C[C](CCOO)OO(28372)',
    structure = SMILES('CC[CH]C[C](CCOO)OO'),
    E0 = (-23.5753,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,360,370,350,3580,3650,1300,1320,350,425,825,875,900,1100,3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2]CC[C](CCOO)OO(28373)',
    structure = SMILES('[CH2]CC[C](CCOO)OO'),
    E0 = (10.993,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (148.157,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.494,0.131036,-0.000180904,1.50026e-07,-5.16104e-11,1510.28,42.4824], Tmin=(100,'K'), Tmax=(763.87,'K')), NASAPolynomial(coeffs=[10.532,0.0609794,-2.94247e-05,5.68402e-09,-3.97256e-13,-120.329,-10.9442], Tmin=(763.87,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(10.993,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(494.711,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(C2CsJOOH) + radical(RCCJ)"""),
)

species(
    label = 'C[CH]CC[C](CCOO)OO(28374)',
    structure = SMILES('C[CH]CC[C](CCOO)OO'),
    E0 = (-23.5873,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,360,370,350,3580,3650,1300,1320,350,425,825,875,900,1100,3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (162.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.05473,0.146275,-0.000207655,1.80274e-07,-6.3961e-11,-2631.51,47.684], Tmin=(100,'K'), Tmax=(801.11,'K')), NASAPolynomial(coeffs=[8.72521,0.0732611,-3.5013e-05,6.70467e-09,-4.64913e-13,-3742.93,1.91079], Tmin=(801.11,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-23.5873,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(565.384,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(C2CsJOOH) + radical(RCCJC)"""),
)

species(
    label = 'CCC[CH][C](CCOO)OO(28375)',
    structure = SMILES('CCC[CH][C](CCOO)OO'),
    E0 = (-17.6186,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,360,370,350,3580,3650,1300,1320,350,425,825,875,900,1100,3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1066.67,1333.33,1600],'cm^-1')),
...
species(
    label = '[CH2][C](CCCC)OO(7768)',
    structure = SMILES('[CH2][C](CCCC)OO'),
    E0 = (108.032,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,360,370,350,3615,1310,387.5,850,1000,3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (116.158,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0905497,0.0926467,-9.23215e-05,5.62531e-08,-1.50107e-11,13128.3,33.559], Tmin=(100,'K'), Tmax=(877.837,'K')), NASAPolynomial(coeffs=[8.8071,0.0529283,-2.4453e-05,4.71081e-09,-3.31953e-13,11597.9,-7.3576], Tmin=(877.837,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(108.032,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(C2CsJOOH) + radical(CJCOOH)"""),
)

species(
    label = 'CCCC[C]([CH]COO)OO(28376)',
...
species(
    label = 'CCCC[C](C[CH]OO)OO(28377)',
    structure = SMILES('CCCC[C](C[CH]OO)OO'),
    E0 = (-29.4511,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,360,370,350,3580,3650,1300,1320,350,425,825,875,900,1100,3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2]CCC[C](CCOO)OO(28378)',
    structure = SMILES('[CH2]CCC[C](CCOO)OO'),
    E0 = (-12.7872,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (162.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.36185,0.13403,-0.000137099,4.76715e-08,1.83588e-11,-1360.37,44.3978], Tmin=(100,'K'), Tmax=(555.412,'K')), NASAPolynomial(coeffs=[11.0574,0.0701728,-3.37376e-05,6.54285e-09,-4.5995e-13,-3134.56,-11.7674], Tmin=(555.412,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-12.7872,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(565.384,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(RCCJ) + radical(C2CsJOOH)"""),
)
...
species(
    label = 'CCCCC1(CCO1)OO(28379)',
    structure = SMILES('CCCCC1(CCO1)OO'),
    E0 = (-344.745,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (146.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.44373,0.0944249,-5.00462e-06,-7.99905e-08,4.40569e-11,-41243.7,36.2363], Tmin=(100,'K'), Tmax=(912.86,'K')), NASAPolynomial(coeffs=[29.0706,0.0276914,-5.40208e-06,6.72187e-10,-4.49535e-14,-49605.4,-123.48], Tmin=(912.86,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-344.745,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(557.07,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Oxetane)"""),
)

species(
    label = '[CH2]C(CCC)(CCOO)OO(28380)',
    structure = SMILES('[CH2]C(CCC)(CCOO)OO'),
    E0 = (-202.259,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,3580,3650,1300,1320,350,425,825,875,900,1100,3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,914.286,1028.57,1142.86,1257.14,1371.43,1485.71,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (163.192,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.30373,0.145823,-0.000162818,1.00791e-07,-2.57067e-11,-24105.2,45.3373], Tmin=(100,'K'), Tmax=(941.748,'K')), NASAPolynomial(coeffs=[17.6198,0.0612002,-2.80334e-05,5.37785e-09,-3.78146e-13,-27857.9,-49.5867], Tmin=(941.748,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-202.259,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(590.328,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(O2s-OsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJCOOH)"""),
)

species(
    label = '[CH2]C(CCCC)(COO)OO(28381)',
    structure = SMILES('[CH2]C(CCCC)(COO)OO'),
    E0 = (-205.607,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,3580,3650,1300,1320,350,425,825,875,900,1100,3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,914.286,1028.57,1142.86,1257.14,1371.43,1485.71,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (163.192,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.30373,0.145823,-0.000162818,1.00791e-07,-2.57067e-11,-24507.8,45.3373], Tmin=(100,'K'), Tmax=(941.748,'K')), NASAPolynomial(coeffs=[17.6198,0.0612002,-2.80334e-05,5.37785e-09,-3.78146e-13,-28260.4,-49.5867], Tmin=(941.748,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-205.607,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(590.328,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(O2s-OsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJCOOH)"""),
)

species(
    label = 'CCCCC([O])(O)CCOO(28382)',
    ...
    molecularWeight = (163.192,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.92179,0.133218,-0.000129498,6.8402e-08,-1.49281e-11,-54707.2,44.525], Tmin=(100,'K'), Tmax=(1088.12,'K')), NASAPolynomial(coeffs=[18.5206,0.0580711,-2.59074e-05,4.93464e-09,-3.46312e-13,-59156,-55.8241], Tmin=(1088.12,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-456.615,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(594.485,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CC(C)(O)OJ)"""),
)

species(
    label = 'CCCCC(O)(CC[O])OO(28383)',
    structure = SMILES('CCCCC(O)(CC[O])OO'),
    E0 = (-462.9,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (163.192,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.63755,0.138685,-0.000133941,6.68584e-08,-1.33324e-11,-55428.9,46.6762], Tmin=(100,'K'), Tmax=(1210.25,'K')), NASAPolynomial(coeffs=[25.4514,0.0458491,-1.88805e-05,3.47839e-09,-2.40257e-13,-62227.9,-94.1975], Tmin=(1210.25,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-462.9,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(594.485,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCOJ)"""),
)
...
species(
    label = 'OO[C]CCOO(28385)',
    structure = SMILES('OO[C]CCOO'),
    E0 = (163.82,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3580,3650,1300,1320,350,425,825,875,900,1100,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (106.077,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.238109,0.0892986,-0.00013099,1.02991e-07,-3.25511e-11,19832.3,26.5348], Tmin=(100,'K'), Tmax=(773.405,'K')), NASAPolynomial(coeffs=[11.8088,0.0294536,-1.49184e-05,2.93475e-09,-2.07107e-13,18042.6,-26.3137], Tmin=(773.405,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(163.82,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(282.692,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + radical(CH2_triplet)"""),
)
...
species(
    label = 'CCCC[C]OO(28386)',
    structure = SMILES('CCCC[C]OO'),
    E0 = (204.582,'kJ/mol'),
    modes = [
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.485498,0.0805847,-7.66015e-05,4.00334e-08,-8.76708e-12,24729.3,26.6702], Tmin=(100,'K'), Tmax=(1074.58,'K')), NASAPolynomial(coeffs=[11.8575,0.0382534,-1.7511e-05,3.37354e-09,-2.38133e-13,22285.3,-29.0111], Tmin=(1074.58,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(204.582,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CH2_triplet)"""),
)
...
reaction(
    label = 'reaction29',
    reactants = ['H(3)', 'CCCC=C(CCOO)OO(28364)'],
    products = ['CCCC[C](CCOO)OO(25602)'],
...
reaction(
    label = 'reaction30',
    reactants = ['H(3)', 'CCCCC(=CCOO)OO(28365)'],
    products = ['CCCC[C](CCOO)OO(25602)'],
...
reaction(
    label = 'reaction31',
    reactants = ['npropyl(83)', 'C=C(CCOO)OO(28366)'],
    products = ['CCCC[C](CCOO)OO(25602)'],
...
reaction(
    label = 'reaction32',
    reactants = ['CH2OOH(35)', 'C=C(CCCC)OO(7773)'],
    products = ['CCCC[C](CCOO)OO(25602)'],
...
reaction(
    label = 'reaction33',
    reactants = ['OH(5)', 'CCCCC(=O)CCOO(16766)'],
    products = ['CCCC[C](CCOO)OO(25602)'],
...
reaction(
    label = 'reaction38',
    reactants = ['CCCCC(C[CH]OO)OO(25600)'],
    products = ['CCCC[C](CCOO)OO(25602)'],
...
reaction(
    label = 'reaction40',
    reactants = ['[CH2]CCCC(CCOO)OO(28367)'],
    products = ['CCCC[C](CCOO)OO(25602)'],
...
reaction(
    label = 'reaction41',
    reactants = ['OH(5)', 'CCCC[C](CC[O])OO(28368)'],
    products = ['CCCC[C](CCOO)OO(25602)'],
...
reaction(
    label = 'reaction42',
    reactants = ['HO2(10)', '[CH2]C[C](CCCC)OO(2133)'],
    products = ['CCCC[C](CCOO)OO(25602)'],
    transitionState = 'TS42',
    kinetics = Arrhenius(A=(2.58895e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using average of templates [Cs_rad;O_rad/NonDe] + [C_rad/H2/Cs;O_rad] for rate rule [C_rad/H2/Cs;O_rad/NonDe]
Euclidian distance = 2.0
family: R_Recombination"""),
)
...
reaction(
    label = 'reaction43',
    reactants = ['OH(5)', 'CCCC[C]([O])CCOO(16758)'],
    products = ['CCCC[C](CCOO)OO(25602)'],
...
reaction(
    label = 'reaction45',
    reactants = ['H(3)', 'CCCC[C](CCOO)O[O](28369)'],
    products = ['CCCC[C](CCOO)OO(25602)'],
...
reaction(
    label = 'reaction46',
    reactants = ['C2H5(29)', '[CH2]C[C](CCOO)OO(28370)'],
    products = ['CCCC[C](CCOO)OO(25602)'],
...
reaction(
    label = 'reaction47',
    reactants = ['npropyl(83)', '[CH2][C](CCOO)OO(28371)'],
    products = ['CCCC[C](CCOO)OO(25602)'],
...
reaction(
    label = 'reaction48',
    reactants = ['H(3)', 'CC[CH]C[C](CCOO)OO(28372)'],
    products = ['CCCC[C](CCOO)OO(25602)'],
...
reaction(
    label = 'reaction49',
    reactants = ['CH3(17)', '[CH2]CC[C](CCOO)OO(28373)'],
    products = ['CCCC[C](CCOO)OO(25602)'],
...
reaction(
    label = 'reaction50',
    reactants = ['H(3)', 'C[CH]CC[C](CCOO)OO(28374)'],
    products = ['CCCC[C](CCOO)OO(25602)'],
...
reaction(
    label = 'reaction51',
    reactants = ['H(3)', 'CCC[CH][C](CCOO)OO(28375)'],
    products = ['CCCC[C](CCOO)OO(25602)'],
...
reaction(
    label = 'reaction52',
    reactants = ['CH2OOH(35)', '[CH2][C](CCCC)OO(7768)'],
    products = ['CCCC[C](CCOO)OO(25602)'],
...
reaction(
    label = 'reaction53',
    reactants = ['H(3)', 'CCCC[C]([CH]COO)OO(28376)'],
    products = ['CCCC[C](CCOO)OO(25602)'],
...
reaction(
    label = 'reaction54',
    reactants = ['H(3)', 'CCCC[C](C[CH]OO)OO(28377)'],
    products = ['CCCC[C](CCOO)OO(25602)'],
...
reaction(
    label = 'reaction55',
    reactants = ['H(3)', '[CH2]CCC[C](CCOO)OO(28378)'],
    products = ['CCCC[C](CCOO)OO(25602)'],
...
reaction(
    label = 'reaction57',
    reactants = ['CCCC[C](CCOO)OO(25602)'],
    products = ['OH(5)', 'CCCCC1(CCO1)OO(28379)'],
...
reaction(
    label = 'reaction58',
    reactants = ['[CH2]C(CCC)(CCOO)OO(28380)'],
    products = ['CCCC[C](CCOO)OO(25602)'],
...
reaction(
    label = 'reaction59',
    reactants = ['[CH2]C(CCCC)(COO)OO(28381)'],
    products = ['CCCC[C](CCOO)OO(25602)'],
...
reaction(
    label = 'reaction61',
    reactants = ['CCCC[C](CCOO)OO(25602)'],
    products = ['CCCCC(O)(CC[O])OO(28383)'],
...
reaction(
    label = 'reaction62',
    reactants = ['HO2(10)', 'CCCC[C]CCOO(28384)'],
    products = ['CCCC[C](CCOO)OO(25602)'],
...
reaction(
    label = 'reaction63',
    reactants = ['butyl_1(82)', 'OO[C]CCOO(28385)'],
    products = ['CCCC[C](CCOO)OO(25602)'],
...
reaction(
    label = 'reaction64',
    reactants = ['CH2CH2OOH(45)', 'CCCC[C]OO(28386)'],
    products = ['CCCC[C](CCOO)OO(25602)'],
