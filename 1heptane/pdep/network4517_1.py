...
species(
    ...
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.983832,0.0673206,-5.49446e-05,2.72939e-08,-5.93447e-12,66874.4,26.9088], Tmin=(100,'K'), Tmax=(1063.33,'K')), NASAPolynomial(coeffs=[8.31994,0.0397235,-1.60139e-05,2.8855e-09,-1.95737e-13,65314.3,-8.93409], Tmin=(1063.33,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(555.129,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(390.78,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)CsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + ring(Cyclopropene) + radical(Isobutyl) + radical(RCCJC)"""),
)
...
species(
    label = '[CH]=C(C=C)C=CC(26836)',
    structure = SMILES('[CH]=C(C=C)C=CC'),
    E0 = (375.864,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,440,435,1725,2950,3100,1380,975,1025,1650,3120,650,792.5,1650,2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3010,3025,975,987.5,1000,1300,1337.5,1375,400,450,500,1630,1655,1680,180],'cm^-1')),
        HinderedRotor(inertia=(0.833142,'amu*angstrom^2'), symmetry=1, barrier=(19.1556,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.831195,'amu*angstrom^2'), symmetry=1, barrier=(19.1108,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.832011,'amu*angstrom^2'), symmetry=1, barrier=(19.1296,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (93.1464,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.05333,0.0544111,-1.51365e-05,-1.62275e-08,9.32016e-12,45321.1,23.8192], Tmin=(100,'K'), Tmax=(1028.64,'K')), NASAPolynomial(coeffs=[12.8679,0.0302609,-1.16984e-05,2.14004e-09,-1.49526e-13,41737.6,-39.1168], Tmin=(1028.64,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(375.864,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(369.994,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(Cds-Cds(Cds-Cds)(Cds-Cds)) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cds_P)"""),
)
...
species(
    label = '[CH]=C(C=C)CC[CH2](26838)',
    structure = SMILES('[CH]=C(C=C)CC[CH2]'),
    E0 = (462.247,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,350,440,435,1725,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3100,440,815,1455,1000,292.358,292.372],'cm^-1')),
        HinderedRotor(inertia=(0.00197206,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.264513,'amu*angstrom^2'), symmetry=1, barrier=(16.0455,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.264534,'amu*angstrom^2'), symmetry=1, barrier=(16.0456,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.264507,'amu*angstrom^2'), symmetry=1, barrier=(16.0456,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.378764,0.0693585,-4.18908e-05,3.49211e-09,4.06194e-12,55734.8,28.9403], Tmin=(100,'K'), Tmax=(1024.58,'K')), NASAPolynomial(coeffs=[15.9438,0.0282955,-1.06202e-05,1.91453e-09,-1.3287e-13,51511.1,-51.5771], Tmin=(1024.58,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(462.247,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(390.78,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(RCCJ) + radical(Cds_P)"""),
)

species(
    label = 'C=CC(=C)[CH][CH]C(26839)',
    structure = SMILES('[CH2]C=C([CH2])C=CC'),
    E0 = (253.834,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (94.1543,'amu'),
...
species(
    ...
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.726084,0.0696285,-5.56051e-05,2.53612e-08,-4.88541e-12,48631.2,27.8353], Tmin=(100,'K'), Tmax=(1212.61,'K')), NASAPolynomial(coeffs=[10.9312,0.0359651,-1.39634e-05,2.4675e-09,-1.65486e-13,46156.2,-23.366], Tmin=(1212.61,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(403.347,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(390.78,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(RCCJC) + radical(C=CJC=C)"""),
)

species(
    label = '[CH]=C([C]=C)CCC(26841)',
    structure = SMILES('[CH]C(=C=C)CCC'),
    E0 = (431.906,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.428066,0.0714836,-4.61716e-05,1.52629e-08,-2.08368e-12,52080.4,27.8801], Tmin=(100,'K'), Tmax=(1658.1,'K')), NASAPolynomial(coeffs=[14.8965,0.0365797,-1.45956e-05,2.56715e-09,-1.69455e-13,47282.5,-49.2378], Tmin=(1658.1,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(431.906,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(390.78,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[CH]=CC(=C)C[CH]C(26842)',
...
species(
    ...
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.519405,0.0674144,-4.8603e-05,1.85157e-08,-2.88169e-12,49396.1,30.7796], Tmin=(100,'K'), Tmax=(1506.6,'K')), NASAPolynomial(coeffs=[14.7235,0.0297028,-1.10566e-05,1.90162e-09,-1.24805e-13,45116.1,-43.5685], Tmin=(1506.6,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(409.598,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(390.78,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(RCCJ) + radical(RCCJC)"""),
)

species(
    label = '[CH]=CC(=[CH])CCC(26844)',
    structure = SMILES('[CH]=CC(=[CH])CCC'),
    E0 = (504.097,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3010,987.5,1337.5,450,1655,3115,3125,620,680,785,800,1600,1700,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,180],'cm^-1')),
        HinderedRotor(inertia=(0.656604,'amu*angstrom^2'), symmetry=1, barrier=(15.0966,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.656556,'amu*angstrom^2'), symmetry=1, barrier=(15.0955,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.657042,'amu*angstrom^2'), symmetry=1, barrier=(15.1067,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.657007,'amu*angstrom^2'), symmetry=1, barrier=(15.1059,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.261653,0.0722221,-4.83678e-05,8.98852e-09,2.41989e-12,60772.2,27.9771], Tmin=(100,'K'), Tmax=(1025.67,'K')), NASAPolynomial(coeffs=[16.4226,0.0277021,-1.0323e-05,1.85091e-09,-1.27994e-13,56483.6,-55.1448], Tmin=(1025.67,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(504.097,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(390.78,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cds_P) + radical(Cds_P)"""),
)

species(
    label = 'C[CH]CC1[CH]CC=1(26845)',
    structure = SMILES('C[CH]CC1[CH]CC=1'),
    E0 = (417.976,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.59362,0.0389132,3.11348e-05,-6.03418e-08,2.36673e-11,50369.8,24.7881], Tmin=(100,'K'), Tmax=(1006.95,'K')), NASAPolynomial(coeffs=[10.9159,0.0354901,-1.38315e-05,2.57572e-09,-1.83062e-13,46788.6,-28.7116], Tmin=(1006.95,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(417.976,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(394.937,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + ring(Cyclobutene) + radical(RCCJC) + radical(cyclobutene-allyl)"""),
)
...
species(
    ...
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.1362,0.050784,1.86858e-06,-3.40292e-08,1.53985e-11,15601,23.1185], Tmin=(100,'K'), Tmax=(1013.93,'K')), NASAPolynomial(coeffs=[12.5606,0.0332052,-1.27956e-05,2.35356e-09,-1.65607e-13,11871.2,-39.1242], Tmin=(1013.93,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(128.768,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(394.937,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(Cds-Cds(Cds-Cds)(Cds-Cds)) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + group(Cds-CdsHH)"""),
)

species(
    label = 'C=CCC(=C)C=C(26847)',
    ...
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.759861,0.0567806,-3.27402e-06,-3.81869e-08,1.92142e-11,16842.2,25.8834], Tmin=(100,'K'), Tmax=(977.01,'K')), NASAPolynomial(coeffs=[16.3899,0.0268219,-9.52886e-06,1.73427e-09,-1.23997e-13,12163.8,-57.4716], Tmin=(977.01,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(138.957,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(394.937,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + group(Cds-CdsHH) + group(Cds-CdsHH)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH]=C(C=C)C[CH]C(26547)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[CH]=C(C=C)C[CH]C(26547)'],
    products = ['[CH2]C1C=C1C[CH]C(26835)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', '[CH]=C(C=C)C=CC(26836)'],
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)', '[CH]=C(C=C)CC=C(26837)'],
    products = ['[CH]=C(C=C)C[CH]C(26547)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['C2H3(30)', 'C#CC[CH]C(2956)'],
    products = ['[CH]=C(C=C)C[CH]C(26547)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH]=C([CH]CC)C=C(26786)'],
    products = ['[CH]=C(C=C)C[CH]C(26547)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH]=C(C=C)CC[CH2](26838)'],
    products = ['[CH]=C(C=C)C[CH]C(26547)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH]=CC(=C)C[CH]C(26842)'],
    products = ['[CH]=C(C=C)C[CH]C(26547)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH]=C(C=C)C[CH]C(26547)'],
    products = ['[CH2][CH]CC(=C)C=C(26843)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH]=C(C=C)C[CH]C(26547)'],
    products = ['C[CH]CC1[CH]CC=1(26845)'],
...
reaction(
    label = 'reaction24',
    reactants = ['CHCH3(T)(95)', '[CH]=C([CH2])C=C(26636)'],
    products = ['[CH]=C(C=C)C[CH]C(26547)'],
