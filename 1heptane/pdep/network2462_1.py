species(
    label = 'CCCCC([O])O[C]=O(13144)',
    structure = SMILES('CCCCC([O])O[C]=O'),
    E0 = (-257.036,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,1855,455,950,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1000,1200,1400,1600],'cm^-1')),
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.528813,0.08429,-7.73279e-05,4.54978e-08,-1.24589e-11,-30796.2,33.3987], Tmin=(100,'K'), Tmax=(830.6,'K')), NASAPolynomial(coeffs=[6.27527,0.0566154,-2.73481e-05,5.38125e-09,-3.83943e-13,-31750.8,6.74215], Tmin=(830.6,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-257.036,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cds-OdOsH) + radical(CCOJ) + radical((O)CJOC)"""),
)
...
species(
    label = 'CCCCC(=O)O[C]=O(13929)',
    structure = SMILES('CCCCC(=O)O[C]=O'),
    E0 = (-417.086,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2800,2850,1350,1500,750,1050,1375,1000,1855,455,950,180,180,180,481.391,674.066,1600,1828.57,2971.43,3200],'cm^-1')),
        HinderedRotor(inertia=(0.162073,'amu*angstrom^2'), symmetry=1, barrier=(3.72639,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.162073,'amu*angstrom^2'), symmetry=1, barrier=(3.72639,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.162073,'amu*angstrom^2'), symmetry=1, barrier=(3.72639,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.162073,'amu*angstrom^2'), symmetry=1, barrier=(3.72639,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.162073,'amu*angstrom^2'), symmetry=1, barrier=(3.72639,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.00182792,0.0950344,-0.000123676,9.98424e-08,-3.39373e-11,-50026.4,34.2558], Tmin=(100,'K'), Tmax=(757.16,'K')), NASAPolynomial(coeffs=[8.31322,0.0474868,-2.23088e-05,4.27579e-09,-2.98089e-13,-51181.8,-2.86125], Tmin=(757.16,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-417.086,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(407.409,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-O2d)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsOs) + group(Cds-OdOsH) + radical((O)CJOC)"""),
)
...
species(
    label = 'CCCC[C](O)O[C]=O(13930)',
    structure = SMILES('CCCC[C](O)O[C]=O'),
    E0 = (-277.495,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (130.142,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.180853,0.0883715,-7.90499e-05,3.91215e-08,-8.24022e-12,-33241.1,34.4524], Tmin=(100,'K'), Tmax=(1101.53,'K')), NASAPolynomial(coeffs=[11.8873,0.0458612,-2.11612e-05,4.08586e-09,-2.88558e-13,-35820.1,-23.1564], Tmin=(1101.53,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-277.495,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(428.195,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cds-OdOsH) + radical(Cs_P) + radical((O)CJOC)"""),
)

species(
    label = 'CCCC[C]([O])OC=O(13931)',
    ...
    molecularWeight = (130.142,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.151862,0.0962444,-0.00013497,1.29217e-07,-5.0657e-11,-32889.4,33.8097], Tmin=(100,'K'), Tmax=(793.816,'K')), NASAPolynomial(coeffs=[1.85608,0.0646816,-3.19146e-05,6.20736e-09,-4.34516e-13,-32436,30.5409], Tmin=(793.816,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-274.516,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cs-OsOsHH) + group(Cds-OdCsOs) + radical(OCOJ) + radical(OCJO)"""),
)

species(
    label = 'CCC[CH]C(O)O[C]=O(13932)',
    structure = SMILES('CCC[CH]C(O)O[C]=O'),
    E0 = (-282.839,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1855,455,950,3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1277.5,1000,1380,1390,370,380,2900,435,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (130.142,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.139466,0.0849038,-6.91333e-05,2.96993e-08,-5.3178e-12,-33879,36.3981], Tmin=(100,'K'), Tmax=(1291.81,'K')), NASAPolynomial(coeffs=[14.2741,0.0411372,-1.83136e-05,3.47295e-09,-2.42347e-13,-37530.9,-35.4128], Tmin=(1291.81,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-282.839,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(428.195,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cds-OdOsH) + radical(CCJCO) + radical((O)CJOC)"""),
)

species(
    label = 'CC[CH]CC(O)O[C]=O(13933)',
    structure = SMILES('CC[CH]CC(O)O[C]=O'),
    E0 = (-288.283,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1855,455,950,3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1277.5,1000,1380,1390,370,380,2900,435,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (130.142,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.235178,0.0898799,-9.81793e-05,6.99691e-08,-2.21328e-11,-34543.3,36.1436], Tmin=(100,'K'), Tmax=(746.597,'K')), NASAPolynomial(coeffs=[7.00479,0.0536112,-2.53122e-05,4.90394e-09,-3.45838e-13,-35554.2,5.46235], Tmin=(746.597,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-288.283,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(428.195,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cds-OdOsH) + radical((O)CJOC) + radical(RCCJCC)"""),
)

species(
    label = 'CCC[CH]C([O])OC=O(13934)',
    structure = SMILES('CCC[CH]C([O])OC=O'),
    E0 = (-253.583,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (130.142,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.0396,0.0708171,-4.14901e-05,1.11215e-08,-1.19133e-12,-30399.4,35.3703], Tmin=(100,'K'), Tmax=(2016.06,'K')), NASAPolynomial(coeffs=[17.0598,0.0390318,-1.78408e-05,3.30116e-09,-2.2157e-13,-36858.8,-53.15], Tmin=(2016.06,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-253.583,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cds-OdOsH) + radical(CCOJ) + radical(CCJCO)"""),
)

species(
    label = 'C[CH]CCC(O)O[C]=O(13935)',
    structure = SMILES('C[CH]CCC(O)O[C]=O'),
    E0 = (-288.295,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (130.142,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.2953,0.088194,-8.84182e-05,5.50259e-08,-1.51237e-11,-34546.3,36.1038], Tmin=(100,'K'), Tmax=(850.952,'K')), NASAPolynomial(coeffs=[8.05421,0.0517241,-2.41349e-05,4.66658e-09,-3.29408e-13,-35866.9,-0.0765603], Tmin=(850.952,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-288.295,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(428.195,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cds-OdOsH) + radical((O)CJOC) + radical(RCCJC)"""),
)

species(
    label = 'CC[CH]CC([O])OC=O(13936)',
    structure = SMILES('CC[CH]CC([O])OC=O'),
    E0 = (-259.026,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (130.142,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.38274,0.0627283,-3.09111e-05,6.10197e-09,-4.30849e-13,-31123.8,30.5079], Tmin=(100,'K'), Tmax=(2806.96,'K')), NASAPolynomial(coeffs=[49.6813,0.00341669,-3.53907e-06,6.27777e-10,-3.47443e-14,-60864,-252.175], Tmin=(2806.96,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-259.026,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cds-OdOsH) + radical(CCOJ) + radical(RCCJCC)"""),
)

species(
    label = '[CH2]CCCC(O)O[C]=O(13937)',
    structure = SMILES('[CH2]CCCC(O)O[C]=O'),
    E0 = (-277.495,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (130.142,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.180853,0.0883715,-7.90499e-05,3.91215e-08,-8.24022e-12,-33241.1,35.551], Tmin=(100,'K'), Tmax=(1101.53,'K')), NASAPolynomial(coeffs=[11.8873,0.0458612,-2.11612e-05,4.08586e-09,-2.88558e-13,-35820.1,-22.0578], Tmin=(1101.53,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-277.495,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(428.195,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cds-OdOsH) + radical(RCCJ) + radical((O)CJOC)"""),
)

species(
    label = 'C[CH]CCC([O])OC=O(13938)',
    structure = SMILES('C[CH]CCC([O])OC=O'),
    E0 = (-259.038,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (130.142,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.19058,0.0641915,-3.27587e-05,6.97246e-09,-5.56018e-13,-31116.9,31.357], Tmin=(100,'K'), Tmax=(2905.66,'K')), NASAPolynomial(coeffs=[33.3519,0.0212942,-1.06138e-05,1.89161e-09,-1.1887e-13,-49225.8,-152.217], Tmin=(2905.66,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-259.038,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cds-OdOsH) + radical(CCOJ) + radical(RCCJC)"""),
)

species(
    label = '[CH2]CCCC([O])OC=O(13939)',
    structure = SMILES('[CH2]CCCC([O])OC=O'),
    E0 = (-248.238,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2782.5,750,1395,475,1775,1000,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (130.142,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.24009,0.0725074,-4.58872e-05,1.45416e-08,-2.04307e-12,-29767.8,33.9503], Tmin=(100,'K'), Tmax=(1412.13,'K')), NASAPolynomial(coeffs=[7.97319,0.0534352,-2.56282e-05,4.97737e-09,-3.49836e-13,-31669.4,-0.856638], Tmin=(1412.13,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-248.238,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cds-OdOsH) + radical(CCOJ) + radical(RCCJ)"""),
)
...
species(
    ...
    molecularWeight = (130.142,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.551009,0.0828821,-7.85025e-05,4.66287e-08,-1.25081e-11,-73673,33.6661], Tmin=(100,'K'), Tmax=(859.675,'K')), NASAPolynomial(coeffs=[7.19712,0.0519582,-2.45449e-05,4.7852e-09,-3.39652e-13,-74815.7,2.60734], Tmin=(859.675,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-613.535,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-O2d)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsOs) + group(Cds-OdOsH)"""),
)
...
species(
    label = 'CCCC([O])O[C]=O(13941)',
    structure = SMILES('CCCC([O])O[C]=O'),
    E0 = (-233.256,'kJ/mol'),
    modes = [
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.09999,0.0704541,-6.7058e-05,4.24506e-08,-1.26406e-11,-27955.7,29.0987], Tmin=(100,'K'), Tmax=(767.885,'K')), NASAPolynomial(coeffs=[5.37971,0.0481608,-2.35104e-05,4.64359e-09,-3.3188e-13,-28613,9.5818], Tmin=(767.885,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-233.256,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cds-OdOsH) + radical((O)CJOC) + radical(CCOJ)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'CCCCC(=O)O[C]=O(13929)'],
    products = ['CCCCC([O])O[C]=O(13144)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['butyl_1(82)', 'O=[C]OC=O(3228)'],
    products = ['CCCCC([O])O[C]=O(13144)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['CCC[CH]C(O)O[C]=O(13932)'],
    products = ['CCCCC([O])O[C]=O(13144)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['CC[CH]CC(O)O[C]=O(13933)'],
    products = ['CCCCC([O])O[C]=O(13144)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['CCCCC([O])O[C]=O(13144)'],
    products = ['CCC[CH]C([O])OC=O(13934)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['CCCCC([O])O[C]=O(13144)'],
    products = ['C[CH]CCC(O)O[C]=O(13935)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CCCCC([O])O[C]=O(13144)'],
    products = ['CC[CH]CC([O])OC=O(13936)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CCCCC([O])O[C]=O(13144)'],
    products = ['[CH2]CCCC(O)O[C]=O(13937)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CCCCC([O])O[C]=O(13144)'],
    products = ['C[CH]CCC([O])OC=O(13938)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]CCCC([O])OC=O(13939)'],
    products = ['CCCCC([O])O[C]=O(13144)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CH2(S)(23)', 'CCCC([O])O[C]=O(13941)'],
    products = ['CCCCC([O])O[C]=O(13144)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CO(12)', 'CCCCC([O])[O](4945)'],
    products = ['CCCCC([O])O[C]=O(13144)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[C]=O(361)', 'CCCCC([O])[O](4945)'],
    products = ['CCCCC([O])O[C]=O(13144)'],
