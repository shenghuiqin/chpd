species(
    label = 'O=[C]CO[CH]O(1123)',
    structure = SMILES('O=[C]CO[CH]O'),
    E0 = (-150.74,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,1855,455,950,3615,1277.5,1000,3025,407.5,1350,352.5,746.287,746.317,746.336],'cm^-1')),
        HinderedRotor(inertia=(0.168756,'amu*angstrom^2'), symmetry=1, barrier=(3.88002,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.600296,'amu*angstrom^2'), symmetry=1, barrier=(13.802,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.600297,'amu*angstrom^2'), symmetry=1, barrier=(13.802,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.600291,'amu*angstrom^2'), symmetry=1, barrier=(13.8019,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (88.0621,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.47665,0.0577621,-7.46353e-05,5.01017e-08,-1.33541e-11,-18040.9,22.8084], Tmin=(100,'K'), Tmax=(917.451,'K')), NASAPolynomial(coeffs=[10.8643,0.0168322,-7.7157e-06,1.47397e-09,-1.03174e-13,-19763.4,-21.6729], Tmin=(917.451,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-150.74,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-(Cds-O2d)OsHH) + group(Cs-OsOsHH) + group(Cds-OdCsH) + radical(OCJO) + radical(CsCJ=O)"""),
)
...
species(
    label = 'O=[C]COC=O(7820)',
    structure = SMILES('O=[C]COC=O'),
    E0 = (-319.536,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2782.5,750,1395,475,1775,1000,1855,455,950,506.917,1384.43],'cm^-1')),
        HinderedRotor(inertia=(1.16124,'amu*angstrom^2'), symmetry=1, barrier=(26.6992,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(5.20297,'amu*angstrom^2'), symmetry=1, barrier=(119.627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0195609,'amu*angstrom^2'), symmetry=1, barrier=(26.6885,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (87.0541,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.35299,0.0302836,-1.03405e-05,-5.09729e-09,2.93919e-12,-38367.2,20.3366], Tmin=(100,'K'), Tmax=(1198.74,'K')), NASAPolynomial(coeffs=[9.75863,0.017007,-8.0357e-06,1.57843e-09,-1.12611e-13,-40964.2,-20.1606], Tmin=(1198.74,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-319.536,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-(Cds-O2d)OsHH) + group(Cds-OdCsH) + group(Cds-OdOsH) + radical(CsCJ=O)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'O=[C]COC=O(7820)'],
    products = ['O=[C]CO[CH]O(1123)'],
    transitionState = 'TS2',
...
reaction(
    ...
    products = ['O=[C]CO[CH]O(1123)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(4000,'m^3/(mol*s)'), n=1.39, Ea=(78.2861,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Od_CO-NdH;YJ] for rate rule [Od_CO-NdH;CJ]
Euclidian distance = 1.0
family: R_Addition_MultipleBond
Ea raised from 76.3 to 78.3 kJ/mol to match endothermicity of reaction."""),
)
...
reaction(
    label = 'reaction13',
    reactants = ['CO(12)', '[CH2]O[CH]O(1809)'],
    products = ['O=[C]CO[CH]O(1123)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[O]C[C]=O(113)', 'HCOH(T)(285)'],
    products = ['O=[C]CO[CH]O(1123)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[C]=O(361)', '[CH2]O[CH]O(1809)'],
    products = ['O=[C]CO[CH]O(1123)'],
