...
species(
    label = 'CC=C1CC1([O])[O](24833)',
    structure = SMILES('CC=C1CC1([O])[O]'),
    E0 = (231.239,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.780314,0.0641214,-6.51422e-05,3.49177e-08,-7.33605e-12,27933.3,24.1201], Tmin=(100,'K'), Tmax=(1197.33,'K')), NASAPolynomial(coeffs=[14.4231,0.017429,-5.2495e-06,7.91882e-10,-4.82458e-14,24746.2,-43.8215], Tmin=(1197.33,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(231.239,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(303.478,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + ring(Methylene_cyclopropane) + radical(C=CC(C)(O)OJ) + radical(C=CC(C)(O)OJ)"""),
)
...
species(
    label = 'C[C]=C(C)C([O])=O(24841)',
    structure = SMILES('C[C]=C(C)C([O])=O'),
    E0 = (130.333,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,440,435,1725,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,1685,370,180,180,1927.35,1934.09,4000,4000],'cm^-1')),
        HinderedRotor(inertia=(0.285426,'amu*angstrom^2'), symmetry=1, barrier=(6.56251,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.09816,'amu*angstrom^2'), symmetry=1, barrier=(25.2489,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.10188,'amu*angstrom^2'), symmetry=1, barrier=(25.3343,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[4.9157,0.0328032,-1.17304e-05,2.70593e-10,2.31034e-13,15587.7,12.1763], Tmin=(100,'K'), Tmax=(2727.35,'K')), NASAPolynomial(coeffs=[52.6617,-0.0157772,3.19367e-06,-4.94403e-10,3.68907e-14,-18432.2,-280.698], Tmin=(2727.35,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(130.333,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cd-CdCs(CO)) + group(Cds-CdsCsH) + group(Cds-O2d(Cds-Cds)O2s) + radical(CCOJ) + radical(Cds_S)"""),
)

species(
    label = '[CH2]C(=[C]C)C(=O)O(24842)',
    structure = SMILES('[CH2]C(=[C]C)C(=O)O'),
    E0 = (60.9797,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,440,435,1725,1685,370,3615,1277.5,1000,3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1066.67,1333.33,1600],'cm^-1')),
    ...
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.15274,0.0694882,-0.000102486,9.13194e-08,-3.2829e-11,7430.05,25.3241], Tmin=(100,'K'), Tmax=(809.771,'K')), NASAPolynomial(coeffs=[5.87598,0.0346763,-1.67347e-05,3.21372e-09,-2.22868e-13,7041.52,5.85803], Tmin=(809.771,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(60.9797,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cd-CdCs(CO)) + group(Cds-CdsCsH) + group(Cds-O2d(Cds-Cds)O2s) + radical(Cds_S) + radical(C=C(C=O)CJ)"""),
)
...
species(
    ...
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.15971,0.0301792,2.22117e-05,-4.10297e-08,1.49497e-11,1217.93,21.9924], Tmin=(100,'K'), Tmax=(1076.54,'K')), NASAPolynomial(coeffs=[8.72587,0.030764,-1.34116e-05,2.58644e-09,-1.84808e-13,-1643.45,-16.8933], Tmin=(1076.54,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(9.50334,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-CsCsCsH) + group(Cs-(Cds-O2d)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cds-OdCsOs) + ring(Cyclopropane) + radical(CCOJ) + radical(CCJ(C)CO)"""),
)

species(
    label = '[CH2]C(=CC)[C]1OO1(24844)',
    ...
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.16729,0.0508736,-1.38033e-05,-2.56675e-08,1.58357e-11,38833.1,24.2758], Tmin=(100,'K'), Tmax=(934.648,'K')), NASAPolynomial(coeffs=[15.9764,0.0163118,-4.58262e-06,7.42778e-10,-5.19053e-14,34806.1,-52.902], Tmin=(934.648,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(321.941,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsOsOsH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + ring(dioxirane) + radical(Cs_P) + radical(Allyl_P)"""),
)

species(
    label = 'CC=C1CO[C]1[O](24845)',
    structure = SMILES('C[CH][C]1COC1=O'),
    E0 = (2.69005,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.45069,0.0161186,7.62187e-05,-1.11946e-07,4.51905e-11,395.937,24.1089], Tmin=(100,'K'), Tmax=(921.992,'K')), NASAPolynomial(coeffs=[12.2442,0.0197098,-4.59119e-06,6.92527e-10,-4.98789e-14,-3368.51,-32.9649], Tmin=(921.992,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(2.69005,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-(Cds-O2d)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdCsOs) + ring(Beta-Propiolactone) + radical(CCJCC=O) + radical(CCJ(C)CO)"""),
)

species(
    label = '[CH2][C]1C(=O)OC1C(24846)',
    structure = SMILES('[CH2][C]1C(=O)OC1C'),
    E0 = (0.655812,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.99273,0.0288621,4.3932e-05,-8.10338e-08,3.47788e-11,165.301,23.2626], Tmin=(100,'K'), Tmax=(920.526,'K')), NASAPolynomial(coeffs=[13.2492,0.0193447,-4.75478e-06,7.1816e-10,-5.00897e-14,-3576.21,-39.1773], Tmin=(920.526,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(0.655812,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-(Cds-O2d)CsCsH) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdCsOs) + ring(Beta-Propiolactone) + radical(CJC(C)C=O) + radical(CCJ(C)CO)"""),
)
...
species(
    label = '[CH2]C(=C)C([O])=O(24847)',
    structure = SMILES('[CH2]C(=C)C([O])=O'),
    E0 = (84.8686,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,440,435,1725,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,180,180,1343.92,1344.06,1344.09,1344.11],'cm^-1')),
        HinderedRotor(inertia=(0.135334,'amu*angstrom^2'), symmetry=1, barrier=(3.1116,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.135359,'amu*angstrom^2'), symmetry=1, barrier=(3.11216,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
species(
    label = 'CC=[C]C([O])=O(24848)',
    structure = SMILES('CC=C=C([O])[O]'),
    E0 = (63.6983,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,440,435,1725,540,610,2055,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.964756,'amu*angstrom^2'), symmetry=1, barrier=(22.1816,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.0734,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.80747,0.0485433,-4.79997e-05,2.50285e-08,-5.31157e-12,7739.83,18.3648], Tmin=(100,'K'), Tmax=(1125.96,'K')), NASAPolynomial(coeffs=[10.1616,0.0188652,-8.46298e-06,1.61941e-09,-1.14034e-13,5858.53,-22.9303], Tmin=(1125.96,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(63.6983,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsCs) + group(Cdd-CdsCds) + radical(C=COJ) + radical(C=COJ)"""),
)
...
species(
    label = '[CH2]CC(=C)C([O])=O(24851)',
    structure = SMILES('[CH2]CC(=C)C([O])=O'),
    E0 = (111.118,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2950,3100,1380,975,1025,1650,3000,3100,440,815,1455,1000,350,440,435,1725,202.728,807.926,968.735,1128.35,1303.85,1492.41,1653.25],'cm^-1')),
    ...
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.81217,0.0376244,-1.72424e-05,2.73655e-09,-1.13481e-13,13336,18.6687], Tmin=(100,'K'), Tmax=(2821.18,'K')), NASAPolynomial(coeffs=[44.8246,-0.00886372,1.27484e-06,-1.74049e-10,1.46085e-14,-14445.3,-229.954], Tmin=(2821.18,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(111.118,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cd-CdCs(CO)) + group(Cds-O2d(Cds-Cds)O2s) + group(Cds-CdsHH) + radical(RCCJ) + radical(CCOJ)"""),
)

species(
    label = '[CH]=C(CC)C([O])=O(24852)',
    structure = SMILES('[CH]=C(CC)C([O])=O'),
    E0 = (152.968,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3120,650,792.5,1650,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,180.6,198.976,202.35,1901.38,1901.66,1902.77],'cm^-1')),
        HinderedRotor(inertia=(0.157894,'amu*angstrom^2'), symmetry=1, barrier=(4.04699,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.140241,'amu*angstrom^2'), symmetry=1, barrier=(4.04048,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.163821,'amu*angstrom^2'), symmetry=1, barrier=(4.06334,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.51193,0.063922,-9.78989e-05,9.78763e-08,-3.87321e-11,18478.4,25.7355], Tmin=(100,'K'), Tmax=(809.276,'K')), NASAPolynomial(coeffs=[1.70139,0.0428465,-2.15073e-05,4.19628e-09,-2.93393e-13,19107.2,28.9361], Tmin=(809.276,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(152.968,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cd-CdCs(CO)) + group(Cds-O2d(Cds-Cds)O2s) + group(Cds-CdsHH) + radical(CCOJ) + radical(Cds_P)"""),
)

species(
    label = '[CH]=C([CH]C)C(=O)O(24853)',
    structure = SMILES('[CH]C(=CC)C(=O)O'),
    E0 = (37.4709,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
species(
    label = 'C=C1C(=O)OC1C(24832)',
    structure = SMILES('C=C1C(=O)OC1C'),
    E0 = (-146.97,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (98.0999,'amu'),
...
reaction(
    label = 'reaction1',
    reactants = ['C=C([CH]C)C([O])=O(24149)'],
...
reaction(
    label = 'reaction2',
    reactants = ['C=C([CH]C)C([O])=O(24149)'],
    products = ['CC=C1CC1([O])[O](24833)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(1.34238e+09,'s^-1'), n=0.889391, Ea=(182.639,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4_S;multiplebond_intra;radadd_intra_cs2H] for rate rule [R4_S_CO;carbonylbond_intra;radadd_intra_cs2H]
...
reaction(
    ...
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(3.36e+09,'s^-1'), n=0.84, Ea=(69.32,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4_S_D;doublebond_intra_HNd;radadd_intra] for rate rule [R4_S_(CO)_D;doublebond_intra_HNd;radadd_intra_O]
...
reaction(
    ...
    products = ['C=C([CH]C)C([O])=O(24149)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(8.04,'m^3/(mol*s)'), n=1.68, Ea=(90.9179,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Cdd_Od;CJ] for rate rule [CO2;CJ]
Euclidian distance = 1.0
family: R_Addition_MultipleBond
Ea raised from 86.9 to 90.9 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction6',
    reactants = ['C[C]=C(C)C([O])=O(24841)'],
    products = ['C=C([CH]C)C([O])=O(24149)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2]C(=[C]C)C(=O)O(24842)'],
    products = ['C=C([CH]C)C([O])=O(24149)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction12',
    reactants = ['C=C([CH]C)C([O])=O(24149)'],
    products = ['[CH2]C(=CC)[C]1OO1(24844)'],
...
reaction(
    label = 'reaction14',
    reactants = ['C=C([CH]C)C([O])=O(24149)'],
    products = ['[CH2][C]1C(=O)OC1C(24846)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CH2(S)(23)', '[CH2]C(=C)C([O])=O(24847)'],
    products = ['C=C([CH]C)C([O])=O(24149)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CH2(19)', 'CC=[C]C([O])=O(24848)'],
    products = ['C=C([CH]C)C([O])=O(24149)'],
...
reaction(
    label = 'reaction19',
    reactants = ['O(4)', '[CH2]C([C]=O)=CC(24849)'],
    products = ['C=C([CH]C)C([O])=O(24149)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH2]CC(=C)C([O])=O(24851)'],
    products = ['C=C([CH]C)C([O])=O(24149)'],
...
reaction(
    label = 'reaction24',
    reactants = ['C=C([CH]C)C([O])=O(24149)'],
    products = ['[CH]=C([CH]C)C(=O)O(24853)'],
...
reaction(
    label = 'reaction28',
    reactants = ['CHCH3(T)(95)', 'C=[C]C([O])=O(4692)'],
    products = ['C=C([CH]C)C([O])=O(24149)'],
