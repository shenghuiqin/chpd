...
species(
    label = 'CCC=CCO[O](5706)',
    structure = SMILES('CCC=CCO[O]'),
    E0 = (17.8265,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2995,3025,975,1000,1300,1375,400,500,1630,1680,492.5,1135,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,238.657,239.175],'cm^-1')),
        HinderedRotor(inertia=(0.164948,'amu*angstrom^2'), symmetry=1, barrier=(6.84024,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.167986,'amu*angstrom^2'), symmetry=1, barrier=(6.83749,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.162713,'amu*angstrom^2'), symmetry=1, barrier=(6.84117,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.162115,'amu*angstrom^2'), symmetry=1, barrier=(6.83898,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
species(
    label = 'CCCC=CO[O](5707)',
    structure = SMILES('CCCC=CO[O]'),
    E0 = (27.4049,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2995,3025,975,1000,1300,1375,400,500,1630,1680,492.5,1135,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,239.95,239.95],'cm^-1')),
        HinderedRotor(inertia=(0.209848,'amu*angstrom^2'), symmetry=1, barrier=(8.5738,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.209848,'amu*angstrom^2'), symmetry=1, barrier=(8.5738,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.209848,'amu*angstrom^2'), symmetry=1, barrier=(8.5738,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.209848,'amu*angstrom^2'), symmetry=1, barrier=(8.5738,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (101.124,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.714439,0.0651256,-4.99328e-05,2.02506e-08,-3.34904e-12,3420.17,28.782], Tmin=(100,'K'), Tmax=(1425.4,'K')), NASAPolynomial(coeffs=[14.0263,0.0277694,-1.06214e-05,1.86437e-09,-1.24287e-13,-374.756,-40.1582], Tmin=(1425.4,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(27.4049,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(ROOJ)"""),
)
...
species(
    label = 'CC[CH][CH]COO(5709)',
    structure = SMILES('CC[CH][CH]COO'),
    E0 = (138.466,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3050,390,425,1340,1360,335,370,3615,1310,387.5,850,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (102.132,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.66204,0.0810247,-0.0001059,9.30488e-08,-3.41815e-11,16766.5,32.1635], Tmin=(100,'K'), Tmax=(798.241,'K')), NASAPolynomial(coeffs=[4.48366,0.0494318,-2.31518e-05,4.41229e-09,-3.05775e-13,16552.8,17.0706], Tmin=(798.241,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(138.466,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(CCJCOOH)"""),
)
...
species(
    label = '[CH2]CC[CH]COO(5710)',
    structure = SMILES('[CH2]CC[CH]COO'),
    E0 = (149.255,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (102.132,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.725646,0.0776611,-7.81024e-05,4.78955e-08,-1.28363e-11,18064.2,31.1785], Tmin=(100,'K'), Tmax=(875.081,'K')), NASAPolynomial(coeffs=[8.08963,0.0439998,-2.04021e-05,3.9368e-09,-2.77651e-13,16775.4,-3.36571], Tmin=(875.081,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(149.255,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(RCCJ) + radical(CCJCOOH)"""),
)
...
species(
    label = 'CCC=CCOO(5712)',
    structure = SMILES('CCC=CCOO'),
    E0 = (-134.178,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (102.132,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.96481,0.0651483,-4.36709e-05,1.49535e-08,-2.13419e-12,-16027.9,27.2913], Tmin=(100,'K'), Tmax=(1565.5,'K')), NASAPolynomial(coeffs=[12.6524,0.0352855,-1.50575e-05,2.76845e-09,-1.88323e-13,-19687.3,-34.3329], Tmin=(1565.5,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-134.178,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH)"""),
)
...
species(
    label = 'CCCC1CO1(5696)',
    structure = SMILES('CCCC1CO1'),
    E0 = (-150.991,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (86.1323,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.49038,0.0449491,1.21349e-05,-5.08079e-08,2.52214e-11,-18059.9,20.2594], Tmin=(100,'K'), Tmax=(880.844,'K')), NASAPolynomial(coeffs=[11.7515,0.0272798,-7.03707e-06,9.8576e-10,-6.02884e-14,-20989.9,-34.3131], Tmin=(880.844,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-150.991,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(369.994,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Ethylene_oxide)"""),
)

species(
    label = '[CH2]C(CC)CO[O](5713)',
...
species(
    ...
    molecularWeight = (102.132,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.948722,0.0610843,-3.5402e-05,9.89688e-09,-1.11178e-12,-11875.8,22.4454], Tmin=(100,'K'), Tmax=(2001.41,'K')), NASAPolynomial(coeffs=[16.6446,0.0297138,-1.18901e-05,2.06491e-09,-1.33451e-13,-18158.5,-64.1684], Tmin=(2001.41,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-99.6948,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(394.937,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(12dioxetane)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['CCC[CH]CO[O](280)'],
    products = ['C=CCCC(134)', 'O2(S)(4921)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'CCC=CCO[O](5706)'],
    products = ['CCC[CH]CO[O](280)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['C2H5(29)', 'allylperoxy(5703)'],
    products = ['CCC[CH]CO[O](280)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction17',
    reactants = ['CH2(S)(23)', 'CC[CH]CO[O](269)'],
    products = ['CCC[CH]CO[O](280)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH]CCC(133)', '[CH2]O[O](92)'],
    products = ['CCC[CH]CO[O](280)'],
