...
species(
    label = '[CH2]C(C=C)OC=O(21250)',
    structure = SMILES('[CH2]C(C=C)OC=O'),
    E0 = (-129.865,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,3100,1380,975,1025,1650,2782.5,750,1395,475,1775,1000,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,3010,987.5,1337.5,450,1655,180,1072.81,1072.82],'cm^-1')),
        HinderedRotor(inertia=(0.0789533,'amu*angstrom^2'), symmetry=1, barrier=(1.81529,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.784169,'amu*angstrom^2'), symmetry=1, barrier=(24.1883,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.05204,'amu*angstrom^2'), symmetry=1, barrier=(24.1886,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.935239,0.0583849,-3.97913e-05,1.1507e-08,-8.34093e-13,-15501.4,27.8199], Tmin=(100,'K'), Tmax=(1259.41,'K')), NASAPolynomial(coeffs=[14.8114,0.0239295,-1.02074e-05,1.90979e-09,-1.3252e-13,-19759.2,-45.353], Tmin=(1259.41,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-129.865,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cds-OdOsH) + radical(CJC(C)OC)"""),
)
...
species(
    label = '[CH2]C(C=C)OC[O](21252)',
    structure = SMILES('[CH2]C(C=C)OC[O]'),
    E0 = (77.3688,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2950,3100,1380,975,1025,1650,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,3010,987.5,1337.5,450,1655,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.394395,0.0697315,-5.80939e-05,2.41268e-08,-3.97386e-12,9443.05,29.7753], Tmin=(100,'K'), Tmax=(1455.59,'K')), NASAPolynomial(coeffs=[17.7315,0.0220894,-8.99905e-06,1.64149e-09,-1.12046e-13,4395.82,-60.3751], Tmin=(1455.59,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(77.3688,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cs-OsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(OCOJ) + radical(CJC(C)OC)"""),
)
...
species(
    label = '[CH]=CC([CH2])OCO(21259)',
    structure = SMILES('[CH]=CC([CH2])OCO'),
    E0 = (97.067,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,3010,987.5,1337.5,450,1655,3615,1277.5,1000,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0529082,0.0742297,-4.51732e-05,-1.21108e-08,1.50008e-11,11834.1,31.295], Tmin=(100,'K'), Tmax=(931.884,'K')), NASAPolynomial(coeffs=[24.007,0.00892324,-1.16764e-06,1.28805e-10,-1.20121e-14,5701.35,-91.9282], Tmin=(931.884,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(97.067,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cs-OsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CJC(C)OC) + radical(Cds_P)"""),
)
...
species(
    label = 'C=C[CH]O[CH]O(21264)',
    structure = SMILES('[CH2]C=CO[CH]O'),
    E0 = (-35.4821,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,3615,1277.5,1000,3000,3100,440,815,1455,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,214.148,214.375,214.384],'cm^-1')),
        HinderedRotor(inertia=(0.676132,'amu*angstrom^2'), symmetry=1, barrier=(22.0161,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.676316,'amu*angstrom^2'), symmetry=1, barrier=(22.0139,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.675784,'amu*angstrom^2'), symmetry=1, barrier=(22.0107,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.67348,'amu*angstrom^2'), symmetry=1, barrier=(22.013,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.676762,0.0582186,-2.48029e-05,-2.88671e-08,2.10312e-11,-4133.95,22.5697], Tmin=(100,'K'), Tmax=(910.815,'K')), NASAPolynomial(coeffs=[22.6387,0.00174433,2.36882e-06,-5.68076e-10,3.73204e-14,-9792.74,-90.4348], Tmin=(910.815,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-35.4821,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-OsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(OCJO) + radical(Allyl_P)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]C(C=C)O[CH]O(21218)'],
    products = ['[CH2]C1CC1O[CH]O(21249)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', '[CH2]C(C=C)OC=O(21250)'],
...
reaction(
    ...
    products = ['[CH2]C(C=C)O[CH]O(21218)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(8000,'m^3/(mol*s)'), n=1.39, Ea=(153.428,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Od_CO-NdH;YJ] for rate rule [Od_CO-NdH;CJ]
Euclidian distance = 1.0
Multiplied by reaction path degeneracy 2.0
family: R_Addition_MultipleBond
Ea raised from 153.4 to 153.4 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction7',
    reactants = ['C2H3(30)', 'C=CO[CH]O(3175)'],
    products = ['[CH2]C(C=C)O[CH]O(21218)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]C(C=C)OC[O](21252)'],
    products = ['[CH2]C(C=C)O[CH]O(21218)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction23',
    reactants = ['HCOH(T)(285)', '[CH2]C([O])C=C(4292)'],
    products = ['[CH2]C(C=C)O[CH]O(21218)'],
...
reaction(
    label = 'reaction24',
    reactants = ['CH2(19)', 'C=C[CH]O[CH]O(21264)'],
    products = ['[CH2]C(C=C)O[CH]O(21218)'],
