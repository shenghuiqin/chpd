...
species(
    label = 'CC([O])[CH]CO(4857)',
    structure = SMILES('CC([O])[CH]CO'),
    E0 = (-46.3391,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,3615,1277.5,1000,1380,1390,370,380,2900,435,305.034,1430.38,4000],'cm^-1')),
        HinderedRotor(inertia=(0.315214,'amu*angstrom^2'), symmetry=1, barrier=(20.8406,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0018082,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.31443,'amu*angstrom^2'), symmetry=1, barrier=(20.8395,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.141667,'amu*angstrom^2'), symmetry=1, barrier=(9.38899,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (88.1051,'amu'),
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'CC(=O)C[CH]O(4855)'],
    products = ['CC([O])C[CH]O(1183)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['CH3(17)', 'O=CC[CH]O(3984)'],
    products = ['CC([O])C[CH]O(1183)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction20',
    reactants = ['CH2(S)(23)', '[O]CC[CH]O(964)'],
    products = ['CC([O])C[CH]O(1183)'],
