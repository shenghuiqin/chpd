...
species(
    ...
    molecularWeight = (76.0514,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.70768,0.0164336,4.24911e-05,-7.72282e-08,3.54278e-11,-5876.37,11.8232], Tmin=(100,'K'), Tmax=(861.623,'K')), NASAPolynomial(coeffs=[12.2738,0.00575049,2.37473e-06,-7.59438e-10,5.89961e-14,-8776.77,-40.1679], Tmin=(861.623,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-49.3417,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(207.862,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsOs) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + ring(123trioxolane)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]COO[O](160)'],
    products = ['O2(2)', 'cC2H4O(44)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'C=COO[O](409)'],
    products = ['[CH2]COO[O](160)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['C2H4(21)', '[O]O[O](145)'],
    products = ['[CH2]COO[O](160)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(142.4,'cm^3/(mol*s)'), n=3.22, Ea=(46.4424,'kJ/mol'), T0=(1,'K'), Tmin=(400,'K'), Tmax=(1100,'K'), comment="""From training reaction 2769 used for Cds-HH_Cds-HH;OJ-O2s
...
reaction(
    label = 'reaction6',
    reactants = ['O2(2)', '[CH2]C[O](96)'],
    products = ['[CH2]COO[O](160)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(7.75733e+07,'m^3/(mol*s)'), n=-0.180109, Ea=(36.6083,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [O_rad/NonDe;Y_rad] for rate rule [O_rad/NonDe;O2_birad]
Euclidian distance = 1.0
Multiplied by reaction path degeneracy 2.0
family: R_Recombination
Ea raised from -0.2 to 36.6 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction7',
    reactants = ['C2H4(T)(94)', '[O]O[O](145)'],
    products = ['[CH2]COO[O](160)'],
    transitionState = 'TS7',
