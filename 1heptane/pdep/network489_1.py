species(
    label = '[CH2]OO[C]=C(943)',
    structure = SMILES('[CH2]OO[C]=C'),
    E0 = (391.117,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,1685,370,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650],'cm^-1')),
        HinderedRotor(inertia=(0.531674,'amu*angstrom^2'), symmetry=1, barrier=(12.2242,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.70622,'amu*angstrom^2'), symmetry=1, barrier=(39.2292,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0154671,'amu*angstrom^2'), symmetry=1, barrier=(46.3312,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.8165,'amu*angstrom^2'), symmetry=1, barrier=(41.7649,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.81743,'amu*angstrom^2'), symmetry=1, barrier=(41.7864,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
species(
    ...
    E0 = (444.616,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,3120,650,792.5,1650,2750,2800,2850,1350,1500,750,1050,1375,1000,1685,370],'cm^-1')),
        HinderedRotor(inertia=(0.370562,'amu*angstrom^2'), symmetry=1, barrier=(8.51996,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.370965,'amu*angstrom^2'), symmetry=1, barrier=(8.52921,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (72.0627,'amu'),
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'C#COO[CH2](2633)'],
    products = ['[CH2]OO[C]=C(943)'],
    transitionState = 'TS2',
...
reaction(
    ...
    products = ['[CH2]OO[C]=C(943)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(7.46075e+06,'m^3/(mol*s)'), n=0.027223, Ea=(38.0282,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [Y_rad;Y_rad]
Euclidian distance = 0
