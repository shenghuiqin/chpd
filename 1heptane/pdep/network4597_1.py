species(
    label = '[CH]=C(C=C)C([O])O(28441)',
    structure = SMILES('[CH]=C(C=C)C([O])O'),
    E0 = (169.073,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,3010,987.5,1337.5,450,1655,3615,1277.5,1000,2950,3100,1380,975,1025,1650,1380,1390,370,380,2900,435,350,440,435,1725,338.851,338.889],'cm^-1')),
        HinderedRotor(inertia=(0.141222,'amu*angstrom^2'), symmetry=1, barrier=(11.5553,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.140771,'amu*angstrom^2'), symmetry=1, barrier=(11.5438,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.141217,'amu*angstrom^2'), symmetry=1, barrier=(11.5405,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.07195,0.0681247,-7.88791e-05,5.07523e-08,-1.34256e-11,20437.1,26.2451], Tmin=(100,'K'), Tmax=(910.533,'K')), NASAPolynomial(coeffs=[10.1783,0.0281189,-1.29722e-05,2.49574e-09,-1.75652e-13,18778.8,-16.8342], Tmin=(910.533,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(169.073,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cds_P) + radical(CCOJ)"""),
)
...
species(
    ...
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.950028,0.0735119,-0.000108152,9.25338e-08,-3.14799e-11,32908.6,25.8575], Tmin=(100,'K'), Tmax=(847.492,'K')), NASAPolynomial(coeffs=[7.18569,0.0323888,-1.46736e-05,2.72147e-09,-1.84365e-13,32271.5,-0.716933], Tmin=(847.492,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(272.755,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-(Cds-Cds)(Cds-Cds)CsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + ring(Cyclopropene) + radical(Isobutyl) + radical(CCOJ)"""),
)
...
species(
    label = '[CH]=C(C=C)C(=O)O(29141)',
    structure = SMILES('[CH]=C(C=C)C(=O)O'),
    E0 = (54.558,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,440,435,1725,2950,3100,1380,975,1025,1650,3120,650,792.5,1650,3615,1277.5,1000,3010,987.5,1337.5,450,1655,344.385,344.386,344.389,344.389,344.39],'cm^-1')),
        HinderedRotor(inertia=(0.00142132,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.132494,'amu*angstrom^2'), symmetry=1, barrier=(11.1515,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.132493,'amu*angstrom^2'), symmetry=1, barrier=(11.1514,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (97.092,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.00169,0.0636925,-6.82215e-05,3.70916e-08,-7.95742e-12,6671.73,23.9353], Tmin=(100,'K'), Tmax=(1135.81,'K')), NASAPolynomial(coeffs=[14.0851,0.0176163,-7.3709e-06,1.37491e-09,-9.58746e-14,3699.7,-40.8504], Tmin=(1135.81,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(54.558,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cds-Cds(Cds-O2d)(Cds-Cds)) + group(Cds-Cds(Cds-Cds)H) + group(Cds-O2d(Cds-Cds)O2s) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cds_P)"""),
)
...
species(
    ...
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.22861,0.0682631,-7.49036e-05,3.10238e-08,5.50374e-12,14642.5,24.9294], Tmin=(100,'K'), Tmax=(581.988,'K')), NASAPolynomial(coeffs=[8.79609,0.030374,-1.36474e-05,2.54887e-09,-1.7469e-13,13522.5,-9.53774], Tmin=(581.988,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(120.973,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(CCOJ) + radical(C=CJC=C)"""),
)

species(
    label = 'C=CC(=C)C([O])[O](29144)',
    ...
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.34847,0.0639282,-8.28471e-05,7.12758e-08,-2.62481e-11,17852.2,25.0051], Tmin=(100,'K'), Tmax=(749.622,'K')), NASAPolynomial(coeffs=[5.25091,0.037359,-1.81847e-05,3.54432e-09,-2.49523e-13,17428.6,8.37952], Tmin=(749.622,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(147.682,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(CCOJ) + radical(CCOJ)"""),
)

species(
    label = '[CH]=C([C]=C)C(O)O(29145)',
    structure = SMILES('[CH]C(=C=C)C(O)O'),
    E0 = (118.273,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.824117,0.0736101,-8.20382e-05,5.25307e-08,-1.40329e-11,14336.1,26.4724], Tmin=(100,'K'), Tmax=(897.464,'K')), NASAPolynomial(coeffs=[9.7976,0.0336147,-1.51901e-05,2.87314e-09,-1.99934e-13,12725.5,-15.8486], Tmin=(897.464,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(118.273,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[CH]=CC(=C)C([O])O(29146)',
...
species(
    ...
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.443517,0.0768256,-9.25026e-05,5.61296e-08,-1.32896e-11,23036.9,27.339], Tmin=(100,'K'), Tmax=(1038.82,'K')), NASAPolynomial(coeffs=[15.8179,0.017625,-7.0188e-06,1.26908e-09,-8.68173e-14,19842.7,-47.4189], Tmin=(1038.82,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(190.464,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cds_P) + radical(Cds_P)"""),
)

species(
    label = '[O]C(O)C1[CH]CC=1(29148)',
    ...
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.66312,0.0436599,-1.58177e-05,-5.2528e-09,3.48917e-12,16399.7,23.38], Tmin=(100,'K'), Tmax=(1188.27,'K')), NASAPolynomial(coeffs=[10.992,0.0262163,-1.142e-05,2.16654e-09,-1.51835e-13,13197,-27.3828], Tmin=(1188.27,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(135.602,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsOsH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + ring(Cyclobutene) + radical(cyclobutene-allyl) + radical(CCOJ)"""),
)
...
species(
    label = '[CH]=C([CH]OO)C=C(29149)',
    structure = SMILES('[CH]=C([CH]OO)C=C'),
    E0 = (339.091,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,3615,1310,387.5,850,1000,350,440,435,1725,180],'cm^-1')),
        HinderedRotor(inertia=(1.30019,'amu*angstrom^2'), symmetry=1, barrier=(29.8939,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.29927,'amu*angstrom^2'), symmetry=1, barrier=(29.8727,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.29914,'amu*angstrom^2'), symmetry=1, barrier=(29.8697,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.2993,'amu*angstrom^2'), symmetry=1, barrier=(29.8734,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.616401,0.0624227,-3.70646e-05,-5.51559e-09,8.81272e-12,40915.8,26.2577], Tmin=(100,'K'), Tmax=(977.549,'K')), NASAPolynomial(coeffs=[18.914,0.014567,-5.08643e-06,9.46673e-10,-6.99295e-14,36047.6,-68.2043], Tmin=(977.549,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(339.091,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(C=CCJO) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH]=C(C=C)C([O])O(28441)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[CH]=C(C=C)C([O])O(28441)'],
    products = ['[CH2]C1C=C1C([O])O(29140)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', '[CH]=C(C=C)C(=O)O(29141)'],
    products = ['[CH]=C(C=C)C([O])O(28441)'],
    transitionState = 'TS4',
...
reaction(
    ...
    products = ['[CH]=C(C=C)C([O])O(28441)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(6.87291,'m^3/(mol*s)'), n=1.39198, Ea=(106.7,'kJ/mol'), T0=(1,'K'), comment="""Estimated using average of templates [CO_O;CJ] + [CO-NdH_O;YJ] for rate rule [CO-NdH_O;CJ]
Euclidian distance = 1.0
family: R_Addition_MultipleBond
Ea raised from 104.8 to 106.7 kJ/mol to match endothermicity of reaction."""),
)
...
reaction(
    label = 'reaction7',
    reactants = ['C2H3(30)', 'C#CC([O])O(8434)'],
    products = ['[CH]=C(C=C)C([O])O(28441)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['OH(5)', '[CH]=C(C=C)C=O(26939)'],
    products = ['[CH]=C(C=C)C([O])O(28441)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction17',
    reactants = ['[CH]=C(C=C)C([O])O(28441)'],
    products = ['[O]C(O)C1[CH]CC=1(29148)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH]=C([CH]OO)C=C(29149)'],
    products = ['[CH]=C(C=C)C([O])O(28441)'],
...
reaction(
    label = 'reaction22',
    reactants = ['O(4)', '[CH]=C([CH]O)C=C(26940)'],
    products = ['[CH]=C(C=C)C([O])O(28441)'],
