...
species(
    label = '[CH2]OC(=O)C(CC)O[CH2](5299)',
    structure = SMILES('[CH2]OC(=O)C(CC)O[CH2]'),
    E0 = (-238.983,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,1380,1390,370,380,2900,435,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,900,1000,1100,1200,1300,1400,1500,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (130.142,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.290234,0.0895437,-7.39139e-05,3.09513e-08,-5.25771e-12,-28584.9,36.2256], Tmin=(100,'K'), Tmax=(1383.9,'K')), NASAPolynomial(coeffs=[18.2279,0.036019,-1.58986e-05,3.00348e-09,-2.0896e-13,-33710.3,-59.1305], Tmin=(1383.9,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-238.983,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(428.195,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-Cs(Cds-O2d)) + group(Cs-(Cds-O2d)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + group(Cs-OsHHH) + group(Cds-OdCsOs) + radical(CsJOCC2) + radical(CsJOC(O)C)"""),
)

species(
    label = '[CH2]OC(=O)CO[CH]CC(5300)',
    structure = SMILES('[CH2]OC(=O)CO[CH]CC'),
    E0 = (-229.615,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,3025,407.5,1350,352.5,300,800,800,800,800,800,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (130.142,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.236119,0.0961272,-9.242e-05,4.78508e-08,-1.02688e-11,-27466.2,33.7193], Tmin=(100,'K'), Tmax=(1101.49,'K')), NASAPolynomial(coeffs=[14.4869,0.0426618,-1.9612e-05,3.78487e-09,-2.67455e-13,-30709.7,-38.7342], Tmin=(1101.49,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-229.615,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(428.195,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-Cs(Cds-O2d)) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-O2d)OsHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + group(Cds-OdCsOs) + radical(CCsJOCs) + radical(CsJOC(O)C)"""),
)
...
species(
    ...
    molecularWeight = (130.142,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.36563,0.0950733,-8.46219e-05,3.93838e-08,-7.0439e-12,-12772.8,34.4326], Tmin=(100,'K'), Tmax=(1558.21,'K')), NASAPolynomial(coeffs=[21.0754,0.025349,-5.83768e-06,6.86068e-10,-3.45202e-14,-18295.3,-79.0654], Tmin=(1558.21,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-107.968,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(440.667,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + ring(Oxetane) + radical(CC(C)(O)OJ) + radical(CCsJOCs)"""),
)
...
species(
    ...
    molecularWeight = (130.142,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.156067,0.0709182,-1.58178e-05,-3.62311e-08,2.17984e-11,-10495.7,32.0104], Tmin=(100,'K'), Tmax=(916.466,'K')), NASAPolynomial(coeffs=[17.5135,0.0309501,-8.9799e-06,1.4068e-09,-9.2771e-14,-15180.3,-58.4154], Tmin=(916.466,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-88.5221,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(440.667,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + ring(Oxetane) + radical(CC(C)(O)OJ) + radical(CCJCO)"""),
)

species(
    label = '[CH2]CC1OCC1([O])OC(5308)',
    ...
    molecularWeight = (130.142,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.00530802,0.0767926,-3.46671e-05,-1.4732e-08,1.35891e-11,-9849.95,31.8413], Tmin=(100,'K'), Tmax=(920.517,'K')), NASAPolynomial(coeffs=[16.7286,0.0329754,-1.02804e-05,1.65575e-09,-1.08882e-13,-14151.1,-54.0934], Tmin=(920.517,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-83.1778,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(440.667,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + ring(Oxetane) + radical(RCCJ) + radical(CC(C)(O)OJ)"""),
)
...
species(
    label = '[CH2]OC1([O])COC1C(5309)',
    structure = SMILES('[CH2]OC1([O])COC1C'),
    E0 = (-76.773,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2950,3150,900,1000,1100,3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,300,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
...
species(
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.51102,0.0569726,-3.76495e-05,1.25176e-08,-1.75377e-12,-8756.72,26.6744], Tmin=(100,'K'), Tmax=(1551.93,'K')), NASAPolynomial(coeffs=[10.5454,0.0336869,-1.51428e-05,2.84926e-09,-1.96294e-13,-11560.9,-20.882], Tmin=(1551.93,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-73.5302,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + group(Cds-OdCsOs) + radical(CCJCO) + radical(CsJOC(O)C)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]OC(=O)C(CC)O[CH2](5299)'],
    products = ['[CH2]OC1([O])COC1CC(5273)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH2]OC(=O)CO[CH]CC(5300)'],
    products = ['[CH2]OC1([O])COC1CC(5273)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2]OC1([O])COC1CC(5273)'],
    products = ['[CH2]OC1(O)[CH]OC1CC(5302)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2]OC1([O])COC1CC(5273)'],
    products = ['[CH2]OC1(O)COC1[CH]C(5303)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['CCC1O[CH]C1([O])OC(5305)'],
    products = ['[CH2]OC1([O])COC1CC(5273)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]OC1([O])COC1CC(5273)'],
    products = ['[CH2]CC1OCC1(O)O[CH2](5306)'],
...
reaction(
    label = 'reaction11',
    reactants = ['C[CH]C1OCC1([O])OC(5307)'],
    products = ['[CH2]OC1([O])COC1CC(5273)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]CC1OCC1([O])OC(5308)'],
    products = ['[CH2]OC1([O])COC1CC(5273)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CH2(S)(23)', '[CH2]OC1([O])COC1C(5309)'],
    products = ['[CH2]OC1([O])COC1CC(5273)'],
...
reaction(
    label = 'reaction16',
    reactants = ['C2H5CHO(70)', '[CH2]OC(=C)[O](942)'],
    products = ['[CH2]OC1([O])COC1CC(5273)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CH2O(15)', '[CH2]OC([O])=CCC(5310)'],
    products = ['[CH2]OC1([O])COC1CC(5273)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CH2(19)', 'CCC1OCC1([O])[O](5311)'],
    products = ['[CH2]OC1([O])COC1CC(5273)'],
