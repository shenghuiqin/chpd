...
species(
    label = '[CH2]C(O)C(=O)CCC(CCC)OO(18037)',
    structure = SMILES('[CH2]C(O)C(=O)CCC(CCC)OO'),
    E0 = (-437.99,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1277.5,1000,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,375,552.5,462.5,1710,3615,1310,387.5,850,1000,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.83604,0.158354,-0.000164024,9.47257e-08,-2.28226e-11,-52438.5,54.4236], Tmin=(100,'K'), Tmax=(986.893,'K')), NASAPolynomial(coeffs=[18.3812,0.0723559,-3.33114e-05,6.42441e-09,-4.53577e-13,-56626.2,-47.6567], Tmin=(986.893,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-437.99,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(685.944,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsOsH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdCsCs) + radical(CJCO)"""),
)

species(
    label = 'C=C(O)C([O])CCC(CCC)OO(18038)',
    ...
    molecularWeight = (189.229,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-3.72782,0.160445,-0.000152054,7.40488e-08,-1.44021e-11,-47028.1,55.2936], Tmin=(100,'K'), Tmax=(1238.95,'K')), NASAPolynomial(coeffs=[29.5417,0.0530326,-2.20081e-05,4.07218e-09,-2.81873e-13,-55271.9,-112.341], Tmin=(1238.95,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-393.393,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(690.101,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(CC(C)OJ)"""),
)
...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.37267,0.137585,-0.000115158,5.06795e-08,-9.19821e-12,-21277.6,50.3687], Tmin=(100,'K'), Tmax=(1288.59,'K')), NASAPolynomial(coeffs=[22.0098,0.0618973,-2.70534e-05,5.09735e-09,-3.54777e-13,-27561.4,-73.4446], Tmin=(1288.59,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-178.834,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(669.315,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CC(C)OJ)"""),
)

species(
    label = '[CH2]C(O)[C](O)CCC(CCC)OO(18039)',
    structure = SMILES('[CH2]C(O)[C](O)CCC(CCC)OO'),
    E0 = (-320.895,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (190.237,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-3.79797,0.182174,-0.000226264,1.58811e-07,-4.57144e-11,-38323.4,56.7392], Tmin=(100,'K'), Tmax=(841.422,'K')), NASAPolynomial(coeffs=[18.8886,0.0743232,-3.39952e-05,6.47195e-09,-4.51224e-13,-42141.2,-48.7931], Tmin=(841.422,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-320.895,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(706.73,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJCO) + radical(C2CsJOH)"""),
)

species(
    label = 'CCCC(CCC([O])[C](C)O)OO(17774)',
...
species(
    label = '[CH2]C(O)C(O)[CH]CC(CCC)OO(18040)',
    structure = SMILES('[CH2]C(O)C(O)[CH]CC(CCC)OO'),
    E0 = (-297.62,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,3580,3650,1210,1345,900,1100,1380,1382,1384,1386,1388,1390,370,372,374,376,378,380,2800,2900,3000,430,435,440,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3000,3100,440,815,1455,1000,3615,1310,387.5,850,1000,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (190.237,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-3.3473,0.167133,-0.000177212,1.0314e-07,-2.46559e-11,-35535.4,58.1862], Tmin=(100,'K'), Tmax=(1003.06,'K')), NASAPolynomial(coeffs=[21.1968,0.0692571,-3.08465e-05,5.86074e-09,-4.10505e-13,-40459.3,-60.3002], Tmin=(1003.06,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-297.62,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(706.73,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJCO) + radical(CCJCO)"""),
)

species(
    label = '[CH2][C](O)C(O)CCC(CCC)OO(18041)',
    structure = SMILES('[CH2][C](O)C(O)CCC(CCC)OO'),
    E0 = (-320.895,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (190.237,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-3.79796,0.182174,-0.000226264,1.58811e-07,-4.57142e-11,-38323.4,56.7391], Tmin=(100,'K'), Tmax=(841.445,'K')), NASAPolynomial(coeffs=[18.8887,0.0743232,-3.39952e-05,6.47194e-09,-4.51224e-13,-42141.2,-48.7933], Tmin=(841.445,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-320.895,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(706.73,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(C2CsJOH) + radical(CJCO)"""),
)

species(
    label = 'CCCC(CCC([O])C(C)[O])OO(17526)',
    structure = SMILES('CCCC(CCC([O])C(C)[O])OO'),
    E0 = (-248.39,'kJ/mol'),
    modes = [
...
species(
    label = 'CCCC(CC[C]([O])C(C)O)OO(17777)',
...
species(
    label = '[CH2]C(O)C(O)C[CH]C(CCC)OO(18042)',
    structure = SMILES('[CH2]C(O)C(O)C[CH]C(CCC)OO'),
    E0 = (-297.107,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,3580,3650,1210,1345,900,1100,1380,1382,1384,1386,1388,1390,370,372,374,376,378,380,2800,2900,3000,430,435,440,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3000,3100,440,815,1455,1000,3615,1310,387.5,850,1000,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (190.237,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-3.5019,0.174061,-0.000200044,1.28845e-07,-3.41824e-11,-35471.4,58.5591], Tmin=(100,'K'), Tmax=(907.693,'K')), NASAPolynomial(coeffs=[19.4002,0.073137,-3.3264e-05,6.35168e-09,-4.45017e-13,-39629,-49.7122], Tmin=(907.693,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-297.107,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(706.73,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJCOOH) + radical(CJCO)"""),
)

species(
    label = 'CCCC(C[CH]C([O])C(C)O)OO(17780)',
...
species(
    label = '[CH2]C([O])C(O)CCC(CCC)OO(17781)',
    structure = SMILES('[CH2]C([O])C(O)CCC(CCC)OO'),
    E0 = (-267.162,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1277.5,1000,1380,1382,1384,1386,1388,1390,370,372,374,376,378,380,2800,2900,3000,430,435,440,2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,3000,3100,440,815,1455,1000,3615,1310,387.5,850,1000,200,800,960,1120,1280,1440,1600],'cm^-1')),
...
species(
    label = '[CH2]C(O)C(O)CC[C](CCC)OO(18043)',
    structure = SMILES('[CH2]C(O)C(O)CC[C](CCC)OO'),
    E0 = (-310.623,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (190.237,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-3.47894,0.175593,-0.000212798,1.49184e-07,-4.34114e-11,-37100,56.4658], Tmin=(100,'K'), Tmax=(828.83,'K')), NASAPolynomial(coeffs=[16.7792,0.0778235,-3.58515e-05,6.85329e-09,-4.79113e-13,-40458,-37.464], Tmin=(828.83,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-310.623,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(706.73,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJCO) + radical(C2CsJOOH)"""),
)

species(
    label = 'CCCC([CH]CC([O])C(C)O)OO(17783)',
...
species(
    label = '[CH2]C(O)C(O)CCC([CH]CC)OO(18044)',
    structure = SMILES('[CH2]C(O)C(O)CCC([CH]CC)OO'),
    E0 = (-297.107,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (190.237,'amu'),
...
species(
    label = 'CCC[C](CCC([O])C(C)O)OO(17785)',
...
species(
    label = '[CH2]C(O)C(O)CCC(CCC)O[O](18045)',
    structure = SMILES('[CH2]C(O)C(O)CCC(CCC)O[O]'),
    E0 = (-345.518,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (190.237,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-3.32043,0.169169,-0.000191621,1.22928e-07,-3.25579e-11,-41299.6,56.3583], Tmin=(100,'K'), Tmax=(908.8,'K')), NASAPolynomial(coeffs=[18.5957,0.0727055,-3.24022e-05,6.12854e-09,-4.27061e-13,-45283,-47.2781], Tmin=(908.8,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-345.518,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(710.887,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJCO) + radical(ROOJ)"""),
)

species(
    label = '[CH2]C(O)C(O)CCC(C[CH]C)OO(18046)',
    structure = SMILES('[CH2]C(O)C(O)CCC(C[CH]C)OO'),
    E0 = (-303.076,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (190.237,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-3.4085,0.173212,-0.000207136,1.43206e-07,-4.10551e-11,-36194,58.6527], Tmin=(100,'K'), Tmax=(841.237,'K')), NASAPolynomial(coeffs=[16.9227,0.0765404,-3.47634e-05,6.6045e-09,-4.60244e-13,-39614.7,-35.9191], Tmin=(841.237,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-303.076,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(706.73,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJCO) + radical(RCCJC)"""),
)

species(
    label = 'CC[CH]C(CCC([O])C(C)O)OO(17788)',
    ...
    molecularWeight = (190.237,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-3.07897,0.163649,-0.000170272,9.94889e-08,-2.42583e-11,-33227.8,56.2127], Tmin=(100,'K'), Tmax=(976.37,'K')), NASAPolynomial(coeffs=[18.5471,0.075051,-3.41566e-05,6.5485e-09,-4.60717e-13,-37450.7,-47.6032], Tmin=(976.37,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-278.336,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(710.887,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(CCJCOOH)"""),
)

species(
    label = '[CH2]CCC(CCC(O)C([CH2])O)OO(18047)',
    structure = SMILES('[CH2]CCC(CCC(O)C([CH2])O)OO'),
    E0 = (-292.276,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (190.237,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-3.47675,0.172642,-0.000194273,1.21675e-07,-3.13528e-11,-34890.4,57.9485], Tmin=(100,'K'), Tmax=(933.613,'K')), NASAPolynomial(coeffs=[20.0126,0.0720037,-3.25816e-05,6.21568e-09,-4.3562e-13,-39276.4,-53.7603], Tmin=(933.613,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-292.276,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(706.73,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJ) + radical(CJCO)"""),
)

species(
    label = 'CCCC(CCC([O])C(C)O)O[O](17790)',
...
species(
    label = 'C[CH]CC(CCC([O])C(C)O)OO(17791)',
...
species(
    label = 'CCCC(CCC(=O)C(C)O)OO(17792)',
    structure = SMILES('CCCC(CCC(=O)C(C)O)OO'),
    E0 = (-649.579,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
species(
    label = 'C=C(O)C(O)CCC(CCC)OO(18048)',
    structure = SMILES('C=C(O)C(O)CCC(CCC)OO'),
    E0 = (-623.754,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (190.237,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-3.85018,0.163971,-0.000156376,7.71266e-08,-1.52201e-11,-74730.3,55.9243], Tmin=(100,'K'), Tmax=(1220.97,'K')), NASAPolynomial(coeffs=[29.324,0.0552875,-2.28526e-05,4.21948e-09,-2.9174e-13,-82831.1,-110.745], Tmin=(1220.97,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-623.754,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(710.887,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH)"""),
)
...
species(
    label = '[CH2]C(O)C([O])CCC(CC)OO(18049)',
    structure = SMILES('[CH2]C(O)C([O])CCC(CC)OO'),
    E0 = (-243.381,'kJ/mol'),
    modes = [
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.68771,0.153015,-0.000164005,9.66135e-08,-2.341e-11,-29036.1,50.8866], Tmin=(100,'K'), Tmax=(989.364,'K')), NASAPolynomial(coeffs=[19.3726,0.0638251,-2.87825e-05,5.49663e-09,-3.85987e-13,-33401.2,-55.306], Tmin=(989.364,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-243.381,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(640.214,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJCO) + radical(CC(C)OJ)"""),
)

species(
    label = '[CH2]C(O)C1CCC(CCC)OO1(18050)',
    structure = SMILES('[CH2]C(O)C1CCC(CCC)OO1'),
    E0 = (-261.524,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (173.229,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.34839,0.118825,-4.57697e-05,-3.38156e-08,2.48612e-11,-31206.5,43.531], Tmin=(100,'K'), Tmax=(941.187,'K')), NASAPolynomial(coeffs=[26.2439,0.0485625,-1.54725e-05,2.58238e-09,-1.75279e-13,-38858.7,-104.737], Tmin=(941.187,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-261.524,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(681.787,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(12dioxane) + radical(CJCO)"""),
)
...
species(
    label = '[CH2][CH]C(CCC(CCC)OO)OO(18051)',
    structure = SMILES('[CH2][CH]C(CCC(CCC)OO)OO'),
    E0 = (-59.4748,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,3580,3650,1300,1320,350,425,825,875,900,1100,2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,3000,3100,440,815,1455,1000,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (190.237,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-3.10063,0.166971,-0.000179922,1.11039e-07,-2.88688e-11,-6906.64,56.683], Tmin=(100,'K'), Tmax=(914.883,'K')), NASAPolynomial(coeffs=[16.7671,0.0801096,-3.75125e-05,7.26965e-09,-5.13982e-13,-10542.1,-37.4008], Tmin=(914.883,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-59.4748,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(706.73,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJ) + radical(CCJCOOH)"""),
)
...
species(
    label = '[CH2]C(O)[CH]CCC(CCC)OO(18052)',
    structure = SMILES('[CH2]C(O)[CH]CCC(CCC)OO'),
    E0 = (-125.15,'kJ/mol'),
    modes = [
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.62617,0.149744,-0.000143768,7.61301e-08,-1.6776e-11,-14816.7,53.2324], Tmin=(100,'K'), Tmax=(1074.53,'K')), NASAPolynomial(coeffs=[19.1994,0.068496,-3.03464e-05,5.75935e-09,-4.03289e-13,-19507.1,-53.6319], Tmin=(1074.53,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-125.15,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(685.944,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJCO) + radical(CJCO)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', '[CH2]C(O)C(=O)CCC(CCC)OO(18037)'],
    products = ['[CH2]C(O)C([O])CCC(CCC)OO(17778)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'C=C(O)C([O])CCC(CCC)OO(18038)'],
    products = ['[CH2]C(O)C([O])CCC(CCC)OO(17778)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[CH2]CC(CCC)OO(2142)', '[CH2]C(O)C=O(740)'],
    products = ['[CH2]C(O)C([O])CCC(CCC)OO(17778)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['OH(5)', 'C=CC([O])CCC(CCC)OO(17555)'],
    products = ['[CH2]C(O)C([O])CCC(CCC)OO(17778)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]C(O)C([O])CCC(CCC)OO(17778)'],
    products = ['[CH2]C(O)[C](O)CCC(CCC)OO(18039)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]C(O)C([O])CCC(CCC)OO(17778)'],
    products = ['CCCC(CCC([O])[C](C)O)OO(17774)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]C(O)C(O)[CH]CC(CCC)OO(18040)'],
    products = ['[CH2]C(O)C([O])CCC(CCC)OO(17778)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]C(O)C([O])CCC(CCC)OO(17778)'],
    products = ['[CH2][C](O)C(O)CCC(CCC)OO(18041)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CCCC(CCC([O])C(C)[O])OO(17526)'],
    products = ['[CH2]C(O)C([O])CCC(CCC)OO(17778)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2]C(O)C([O])CCC(CCC)OO(17778)'],
    products = ['CCCC(CC[C]([O])C(C)O)OO(17777)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]C(O)C(O)C[CH]C(CCC)OO(18042)'],
    products = ['[CH2]C(O)C([O])CCC(CCC)OO(17778)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]C(O)C([O])CCC(CCC)OO(17778)'],
    products = ['CCCC(C[CH]C([O])C(C)O)OO(17780)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]C([O])C(O)CCC(CCC)OO(17781)'],
    products = ['[CH2]C(O)C([O])CCC(CCC)OO(17778)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]C(O)C([O])CCC(CCC)OO(17778)'],
    products = ['[CH2]C(O)C(O)CC[C](CCC)OO(18043)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2]C(O)C([O])CCC(CCC)OO(17778)'],
    products = ['CCCC([CH]CC([O])C(C)O)OO(17783)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2]C(O)C([O])CCC(CCC)OO(17778)'],
    products = ['[CH2]C(O)C(O)CCC([CH]CC)OO(18044)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2]C(O)C([O])CCC(CCC)OO(17778)'],
    products = ['CCC[C](CCC([O])C(C)O)OO(17785)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH2]C(O)C([O])CCC(CCC)OO(17778)'],
    products = ['[CH2]C(O)C(O)CCC(CCC)O[O](18045)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH2]C(O)C([O])CCC(CCC)OO(17778)'],
    products = ['[CH2]C(O)C(O)CCC(C[CH]C)OO(18046)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH2]C(O)C([O])CCC(CCC)OO(17778)'],
    products = ['CC[CH]C(CCC([O])C(C)O)OO(17788)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[CH2]C(O)C([O])CCC(CCC)OO(17778)'],
    products = ['[CH2]CCC(CCC(O)C([CH2])O)OO(18047)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[CH2]C(O)C([O])CCC(CCC)OO(17778)'],
    products = ['CCCC(CCC([O])C(C)O)O[O](17790)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[CH2]C(O)C([O])CCC(CCC)OO(17778)'],
    products = ['C[CH]CC(CCC([O])C(C)O)OO(17791)'],
    transitionState = 'TS26',
    kinetics = Arrhenius(A=(4.54e+06,'s^-1'), n=1.5, Ea=(141.001,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R8H;C_rad_out_2H;Cs_H_out_1H] for rate rule [R8H;C_rad_out_2H;Cs_H_out_H/NonDeC]
Euclidian distance = 1.0
Multiplied by reaction path degeneracy 2.0
family: intra_H_migration"""),
)
...
reaction(
    label = 'reaction28',
    reactants = ['[CH2]C(O)C([O])CCC(CCC)OO(17778)'],
    products = ['CCCC(CCC(=O)C(C)O)OO(17792)'],
...
reaction(
    label = 'reaction29',
    reactants = ['[CH2]C(O)C([O])CCC(CCC)OO(17778)'],
    products = ['C=C(O)C(O)CCC(CCC)OO(18048)'],
...
reaction(
    label = 'reaction30',
    reactants = ['CH2(S)(23)', '[CH2]C(O)C([O])CCC(CC)OO(18049)'],
    products = ['[CH2]C(O)C([O])CCC(CCC)OO(17778)'],
...
reaction(
    label = 'reaction31',
    reactants = ['[CH2]C(O)C([O])CCC(CCC)OO(17778)'],
    products = ['OH(5)', '[CH2]C(O)C1CCC(CCC)OO1(18050)'],
...
reaction(
    label = 'reaction34',
    reactants = ['[CH2][CH]C(CCC(CCC)OO)OO(18051)'],
    products = ['[CH2]C(O)C([O])CCC(CCC)OO(17778)'],
...
reaction(
    label = 'reaction35',
    reactants = ['O(4)', '[CH2]C(O)[CH]CCC(CCC)OO(18052)'],
    products = ['[CH2]C(O)C([O])CCC(CCC)OO(17778)'],
...
reaction(
    label = 'reaction36',
    reactants = ['CH2(19)', 'CCCC(CCC([O])[CH]O)OO(17750)'],
    products = ['[CH2]C(O)C([O])CCC(CCC)OO(17778)'],
