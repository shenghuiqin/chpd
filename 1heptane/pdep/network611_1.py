...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', '[CH]=C(O)C=C(6273)'],
    products = ['[CH]=C(O)C[CH2](1041)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction13',
    reactants = ['CH2(19)', '[CH]=C([CH2])O(6276)'],
    products = ['[CH]=C(O)C[CH2](1041)'],
