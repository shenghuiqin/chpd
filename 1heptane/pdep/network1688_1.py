...
species(
    label = '[CH2]C1(O)OC1(CC)C([O])=O(10235)',
    ...
    molecularWeight = (144.125,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.27562,0.115161,-0.00012388,6.54106e-08,-1.29252e-11,-37461.9,36.0182], Tmin=(100,'K'), Tmax=(1426.28,'K')), NASAPolynomial(coeffs=[27.1987,0.0155985,-1.39649e-06,-1.48664e-10,2.24213e-14,-44150.5,-110.617], Tmin=(1426.28,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-313.518,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-(Cds-O2d)H) + group(Cs-(Cds-O2d)CsCsOs) + group(Cs-CsCsOsOs) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdCsOs) + ring(Ethylene_oxide) + radical(CJC(O)2C) + radical(CCOJ)"""),
)
...
species(
    label = '[CH2]C1(O)OC(=O)C1([O])CC(9907)',
    ...
    molecularWeight = (144.125,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-3.0377,0.111465,-0.000113171,5.47222e-08,-9.63051e-12,-38212.1,43.5968], Tmin=(100,'K'), Tmax=(1693.32,'K')), NASAPolynomial(coeffs=[27.4939,0.0103008,2.17002e-06,-8.16271e-10,6.44591e-14,-44388.4,-107.487], Tmin=(1693.32,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-320.132,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(415.724,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-(Cds-O2d)CsCsOs) + group(Cs-CsCsOsOs) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdCsOs) + ring(Beta-Propiolactone) + radical(CC(C)(C=O)OJ) + radical(CJC(C)OC)"""),
)
...
species(
    label = 'C=C(O)C(=O)C([O])=O(10237)',
    structure = SMILES('C=C(O)C(=O)C([O])=O'),
    E0 = (-386.595,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,440,435,1725,2950,3100,1380,975,1025,1650,3615,1277.5,1000,375,552.5,462.5,1710,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
...
species(
    label = '[CH2]CC([O])(C(=C)O)C(=O)O(10244)',
    structure = SMILES('[CH2]CC([O])(C(=C)O)C(=O)O'),
    E0 = (-358.738,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (144.125,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.00674,0.114921,-0.000149574,1.03273e-07,-2.84367e-11,-42970.1,37.8568], Tmin=(100,'K'), Tmax=(887.914,'K')), NASAPolynomial(coeffs=[16.5374,0.0358845,-1.60511e-05,3.01907e-09,-2.08999e-13,-46085.6,-44.6976], Tmin=(887.914,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-358.738,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(407.409,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(O2s-(Cds-O2d)H) + group(Cs-(Cds-O2d)CsCsOs) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-OdCsOs) + group(Cds-CdsHH) + radical(RCCJ) + radical(C=CC(C)(C=O)OJ)"""),
)

species(
    label = 'C=C([O])C([O])(CC)C(=O)O(10245)',
    structure = SMILES('C=C([O])C([O])(CC)C(=O)O'),
    E0 = (-426.179,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (144.125,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.771231,0.111396,-0.000151204,1.14795e-07,-3.52962e-11,-51091.7,36.7211], Tmin=(100,'K'), Tmax=(793.708,'K')), NASAPolynomial(coeffs=[13.1314,0.0413201,-1.87495e-05,3.52354e-09,-2.42556e-13,-53298.3,-27.137], Tmin=(793.708,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-426.179,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(O2s-(Cds-O2d)H) + group(Cs-(Cds-O2d)CsCsOs) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-OdCsOs) + group(Cds-CdsHH) + radical(C=CC(C)(C=O)OJ) + radical(C=C(C)OJ)"""),
)

species(
    label = '[CH]=C(O)C([O])(CC)C(=O)O(10246)',
    structure = SMILES('[CH]=C(O)C([O])(CC)C(=O)O'),
    E0 = (-316.888,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (144.125,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.14326,0.118023,-0.000156924,1.09961e-07,-3.0614e-11,-37931.9,36.9627], Tmin=(100,'K'), Tmax=(879.834,'K')), NASAPolynomial(coeffs=[17.0754,0.0351891,-1.56946e-05,2.94135e-09,-2.02948e-13,-41137.6,-48.5984], Tmin=(879.834,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-316.888,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(407.409,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(O2s-(Cds-O2d)H) + group(Cs-(Cds-O2d)CsCsOs) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-OdCsOs) + group(Cds-CdsHH) + radical(Cds_P) + radical(C=CC(C)(C=O)OJ)"""),
)

species(
    label = 'C=C(O)C([O])(CC)[C]1OO1(10247)',
    structure = SMILES('C=C(O)C([O])(CC)[C]1OO1'),
    E0 = (-7.98594,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (144.125,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.23101,0.106187,-0.000105096,5.00487e-08,-8.88077e-12,-709.626,43.878], Tmin=(100,'K'), Tmax=(1604.22,'K')), NASAPolynomial(coeffs=[27.9269,0.013086,-1.30281e-06,-4.20915e-11,9.53555e-15,-8081.74,-108.689], Tmin=(1604.22,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-7.98594,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + ring(dioxirane) + radical(Cs_P) + radical(C=CC(C)2OJ)"""),
)
...
species(
    label = 'C=C(O)C(C)([O])C([O])=O(10249)',
    structure = SMILES('C=C(O)C(C)([O])C([O])=O'),
    E0 = (-314.499,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,440,435,1725,2950,3100,1380,975,1025,1650,3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.154433,0.0982103,-0.000143743,1.17254e-07,-3.85207e-11,-37682.3,30.9233], Tmin=(100,'K'), Tmax=(795.094,'K')), NASAPolynomial(coeffs=[11.2328,0.0359957,-1.70756e-05,3.25262e-09,-2.24709e-13,-39337.4,-20.423], Tmin=(795.094,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-314.499,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(O2s-(Cds-O2d)H) + group(Cs-(Cds-O2d)CsCsOs) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-OdCsOs) + group(Cds-CdsHH) + radical(CCOJ) + radical(C=CC(C)(C=O)OJ)"""),
)
...
species(
    label = 'C=[C]C(CC)(OO)C([O])=O(10250)',
    structure = SMILES('C=[C]C(CC)(OO)C([O])=O'),
    E0 = (-58.66,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2950,3100,1380,975,1025,1650,1685,370,3615,1310,387.5,850,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (144.125,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.734088,0.113134,-0.000160302,1.34071e-07,-4.62711e-11,-6893.28,35.4358], Tmin=(100,'K'), Tmax=(760.519,'K')), NASAPolynomial(coeffs=[10.0192,0.0505113,-2.48256e-05,4.8266e-09,-3.3834e-13,-8353.49,-12.3457], Tmin=(760.519,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-58.66,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(407.409,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-(Cds-O2d)H) + group(O2s-OsH) + group(Cs-(Cds-O2d)CsCsOs) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-OdCsOs) + group(Cds-CdsHH) + radical(CCOJ) + radical(Cds_S)"""),
)

species(
    label = 'CCC([O])(C(C)=O)C([O])=O(10251)',
    ...
    molecularWeight = (144.125,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.208084,0.0917329,-0.000118162,1.03156e-07,-3.85648e-11,-44784.2,36.8881], Tmin=(100,'K'), Tmax=(757.332,'K')), NASAPolynomial(coeffs=[5.01909,0.0560859,-2.72835e-05,5.30852e-09,-3.73178e-13,-45219.4,16.9532], Tmin=(757.332,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-373.426,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-O2d)H) + group(Cs-CsCsCsOs) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)HHH) + group(Cds-OdCsCs) + group(Cds-OdCsOs) + radical(CC(C)(C=O)OJ) + radical(CCOJ)"""),
)

species(
    label = 'C=C(O)C([O])=C([O])OCC(10252)',
    structure = SMILES('C=C(O)C([O])=C([O])OCC'),
    E0 = (-439.39,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2950,3100,1380,975,1025,1650,325,350,375,415,440,465,420,435,450,1700,1725,1750,3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (144.125,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.99833,0.123018,-0.000141155,7.29437e-08,-1.25758e-11,-52622.3,34.0332], Tmin=(100,'K'), Tmax=(932.709,'K')), NASAPolynomial(coeffs=[28.2168,0.0156615,-4.2431e-06,6.30568e-10,-4.05507e-14,-59225.3,-114.815], Tmin=(932.709,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-439.39,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-Cds(Cds-Cds)O2s) + group(Cds-Cds(Cds-Cds)O2s) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(C=COJ) + radical(C=C(C)OJ)"""),
)

species(
    label = 'C=C(O)OC([O])=C([O])CC(10253)',
    structure = SMILES('[CH2][C](O)OC(=O)C(=O)CC'),
    E0 = (-373.672,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350,2750,2850,1437.5,1250,1305,750,350,375,552.5,462.5,1710,200,800,914.286,1028.57,1142.86,1257.14,1371.43,1485.71,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (144.125,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.104012,0.103087,-0.000115993,5.06323e-08,7.90221e-12,-44807,37.1473], Tmin=(100,'K'), Tmax=(552.094,'K')), NASAPolynomial(coeffs=[9.87687,0.0502422,-2.5308e-05,4.99732e-09,-3.54437e-13,-46205.8,-7.76264], Tmin=(552.094,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-373.672,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(403.252,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-O2d(Cds-O2d)Cs) + group(Cds-O2d(Cds-O2d)O2s) + radical(CJCO) + radical(Cs_P)"""),
)
...
species(
    label = 'C=C(O)[C](CC)C([O])=O(10254)',
    structure = SMILES('C=C(O)C(CC)=C([O])[O]'),
    E0 = (-263.212,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2950,3100,1380,975,1025,1650,325,350,375,415,440,465,420,435,450,1700,1725,1750,3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,187.238,187.285,187.289,187.501],'cm^-1')),
        HinderedRotor(inertia=(0.722517,'amu*angstrom^2'), symmetry=1, barrier=(17.9926,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.722924,'amu*angstrom^2'), symmetry=1, barrier=(17.9941,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.722497,'amu*angstrom^2'), symmetry=1, barrier=(17.9932,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.725115,'amu*angstrom^2'), symmetry=1, barrier=(17.9935,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (128.126,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.38983,0.104141,-0.000112283,5.91112e-08,-1.19129e-11,-31450.7,32.5658], Tmin=(100,'K'), Tmax=(1270.78,'K')), NASAPolynomial(coeffs=[25.6449,0.0159588,-4.55358e-06,6.84331e-10,-4.27502e-14,-38072.7,-103.36], Tmin=(1270.78,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-263.212,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(390.78,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-Cds(Cds-Cds)O2s) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(C=COJ) + radical(C=COJ)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['C=C(O)C([O])(CC)C([O])=O(8742)'],
    products = ['[CH2]C1(O)OC1(CC)C([O])=O(10235)'],
    transitionState = 'TS2',
...
reaction(
    ...
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(7.785e+11,'s^-1'), n=0.342, Ea=(122.156,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4_S;multiplebond_intra;radadd_intra_O] for rate rule [R4_S_CO;carbonylbond_intra;radadd_intra_O]
Euclidian distance = 1.41421356237
family: Intra_R_Add_Exocyclic
Ea raised from 120.2 to 122.2 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction4',
    reactants = ['C=C(O)C([O])(CC)C([O])=O(8742)'],
    products = ['[CH2]C1(O)OC(=O)C1([O])CC(9907)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['C2H5(29)', 'C=C(O)C(=O)C([O])=O(10237)'],
...
reaction(
    label = 'reaction6',
    reactants = ['CH2COH(99)', 'CCC(=O)C([O])=O(10238)'],
    products = ['C=C(O)C([O])(CC)C([O])=O(8742)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(2.89058,'m^3/(mol*s)'), n=1.56134, Ea=(37.303,'kJ/mol'), T0=(1,'K'), comment="""Estimated using average of templates [Cd_R;CdsJ] + [CO_O;CJ] for rate rule [CO-DeNd_O;CdsJ-O2s]
...
reaction(
    ...
    products = ['C=C(O)C([O])(CC)C([O])=O(8742)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(8.04,'m^3/(mol*s)'), n=1.68, Ea=(249.795,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Cdd_Od;CJ] for rate rule [CO2;CJ]
Euclidian distance = 1.0
family: R_Addition_MultipleBond
Ea raised from 247.2 to 249.8 kJ/mol to match endothermicity of reaction."""),
)
...
reaction(
    label = 'reaction10',
    reactants = ['C=C(O)C([O])(CC)C([O])=O(8742)'],
    products = ['C=C(O)C([O])([CH]C)C(=O)O(10240)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]CC(O)(C(=C)O)C([O])=O(10241)'],
    products = ['C=C(O)C([O])(CC)C([O])=O(8742)'],
...
reaction(
    label = 'reaction14',
    reactants = ['C=C(O)C([O])(CC)C([O])=O(8742)'],
    products = ['[CH2]CC([O])(C(=C)O)C(=O)O(10244)'],
...
reaction(
    label = 'reaction15',
    reactants = ['C=C(O)C([O])(CC)C([O])=O(8742)'],
    products = ['C=C([O])C([O])(CC)C(=O)O(10245)'],
...
reaction(
    label = 'reaction16',
    reactants = ['C=C(O)C([O])(CC)C([O])=O(8742)'],
    products = ['[CH]=C(O)C([O])(CC)C(=O)O(10246)'],
...
reaction(
    label = 'reaction18',
    reactants = ['C=C(O)C([O])(CC)C([O])=O(8742)'],
    products = ['C=C(O)C([O])(CC)[C]1OO1(10247)'],
    transitionState = 'TS18',
    kinetics = Arrhenius(A=(1.55936e+11,'s^-1'), n=0.551275, Ea=(330.293,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R3_linear;multiplebond_intra;radadd_intra] for rate rule [R3_CO;carbonyl_intra_Nd;radadd_intra_O]
Euclidian distance = 2.44948974278
family: Intra_R_Add_Endocyclic
Ea raised from 327.7 to 330.3 kJ/mol to match endothermicity of reaction."""),
)
...
reaction(
    label = 'reaction22',
    reactants = ['CH2(S)(23)', 'C=C(O)C(C)([O])C([O])=O(10249)'],
    products = ['C=C(O)C([O])(CC)C([O])=O(8742)'],
...
reaction(
    label = 'reaction24',
    reactants = ['C=[C]C(CC)(OO)C([O])=O(10250)'],
    products = ['C=C(O)C([O])(CC)C([O])=O(8742)'],
...
reaction(
    label = 'reaction25',
    reactants = ['C=C(O)C([O])(CC)C([O])=O(8742)'],
    products = ['CCC([O])(C(C)=O)C([O])=O(10251)'],
...
reaction(
    label = 'reaction26',
    reactants = ['C=C(O)C([O])=C([O])OCC(10252)'],
    products = ['C=C(O)C([O])(CC)C([O])=O(8742)'],
...
reaction(
    label = 'reaction27',
    reactants = ['C=C(O)OC([O])=C([O])CC(10253)'],
    products = ['C=C(O)C([O])(CC)C([O])=O(8742)'],
...
reaction(
    label = 'reaction28',
    reactants = ['O(4)', 'C=C(O)[C](CC)C([O])=O(10254)'],
    products = ['C=C(O)C([O])(CC)C([O])=O(8742)'],
...
reaction(
    label = 'reaction29',
    reactants = ['O(4)', 'C=C(O)C([O])([C]=O)CC(9639)'],
    products = ['C=C(O)C([O])(CC)C([O])=O(8742)'],
