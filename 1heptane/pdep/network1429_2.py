...
species(
    label = 'CC=CC([O])CC(C)OO(7688)',
    structure = SMILES('CC=CC([O])CC(C)OO'),
    E0 = (-143.519,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (145.176,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.993623,0.107753,-9.02974e-05,3.96182e-08,-7.15875e-12,-17080.2,40.4916], Tmin=(100,'K'), Tmax=(1294.59,'K')), NASAPolynomial(coeffs=[18.3351,0.0480327,-2.11017e-05,3.98536e-09,-2.77719e-13,-22084.8,-57.7489], Tmin=(1294.59,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-143.519,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(527.969,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(CC(C)OJ)"""),
)
...
species(
    label = 'C[CH]CC(O)[CH]C(C)OO(7690)',
    structure = SMILES('C[CH]CC(O)[CH]C(C)OO'),
    E0 = (-94.2194,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3050,390,425,1340,1360,335,370,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3615,1277.5,1000,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,2750,2850,1437.5,1250,1305,750,350,3615,1310,387.5,850,1000,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (146.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.22528,0.123154,-0.000142208,9.99773e-08,-2.98729e-11,-11151.2,45.6339], Tmin=(100,'K'), Tmax=(801.297,'K')), NASAPolynomial(coeffs=[10.9299,0.0624726,-2.86069e-05,5.4566e-09,-3.81104e-13,-13099.1,-10.3146], Tmin=(801.297,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-94.2194,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(544.598,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJC) + radical(CCJCOOH)"""),
)

species(
    label = 'C[CH][CH]C(O)CC(C)OO(7691)',
    structure = SMILES('C[CH][CH]C(O)CC(C)OO'),
    E0 = (-94.7323,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (146.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.927446,0.114423,-0.000112521,6.45489e-08,-1.57951e-11,-11221.3,44.7549], Tmin=(100,'K'), Tmax=(963.29,'K')), NASAPolynomial(coeffs=[12.3669,0.0592177,-2.65551e-05,5.05294e-09,-3.53885e-13,-13782.5,-18.885], Tmin=(963.29,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-94.7323,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(544.598,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJC) + radical(CCJCO)"""),
)
...
species(
    label = 'C[CH]CC(O)C[C](C)OO(7692)',
    structure = SMILES('C[CH]CC(O)C[C](C)OO'),
    E0 = (-107.735,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (146.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.198651,0.108652,-7.02787e-05,-5.82143e-08,9.03965e-11,-12822.8,40.1602], Tmin=(100,'K'), Tmax=(498.212,'K')), NASAPolynomial(coeffs=[8.66001,0.0665388,-3.08273e-05,5.86987e-09,-4.07773e-13,-14065.6,-0.0189256], Tmin=(498.212,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-107.735,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(544.598,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(C2CsJOOH) + radical(RCCJC)"""),
)
...
species(
    label = '[CH2]C(CC(O)C[CH]C)OO(7693)',
    structure = SMILES('[CH2]C(CC(O)C[CH]C)OO'),
    E0 = (-80.6718,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (146.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.26596,0.123232,-0.000137148,9.00647e-08,-2.49279e-11,-9519.44,45.4719], Tmin=(100,'K'), Tmax=(863.964,'K')), NASAPolynomial(coeffs=[12.4245,0.0598503,-2.71103e-05,5.15951e-09,-3.6052e-13,-11885.2,-18.5754], Tmin=(863.964,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-80.6718,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(544.598,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJC) + radical(CJCOOH)"""),
)
...
species(
    label = '[CH2][CH]CC(O)CC(C)OO(7694)',
    structure = SMILES('[CH2][CH]CC(O)CC(C)OO'),
    E0 = (-89.388,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (146.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.15091,0.121087,-0.000133834,8.89158e-08,-2.51323e-11,-10572.3,44.8512], Tmin=(100,'K'), Tmax=(843.766,'K')), NASAPolynomial(coeffs=[11.3974,0.0615992,-2.80801e-05,5.35836e-09,-3.74901e-13,-12689.8,-13.5555], Tmin=(843.766,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-89.388,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(544.598,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJC) + radical(RCCJ)"""),
)

species(
    label = 'C[CH]CC(O)CC(C)O[O](7695)',
    structure = SMILES('C[CH]CC(O)CC(C)O[O]'),
    E0 = (-142.63,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (146.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.03973,0.118224,-0.000133696,9.40108e-08,-2.82554e-11,-16979.6,43.4178], Tmin=(100,'K'), Tmax=(795.791,'K')), NASAPolynomial(coeffs=[10.1445,0.062004,-2.77216e-05,5.22755e-09,-3.62634e-13,-18759.6,-7.98462], Tmin=(795.791,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-142.63,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(548.755,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJC) + radical(ROOJ)"""),
)
...
species(
    ...
    molecularWeight = (146.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.11669,0.111276,-9.45694e-05,4.26027e-08,-7.93333e-12,-44782.3,41.1259], Tmin=(100,'K'), Tmax=(1257.35,'K')), NASAPolynomial(coeffs=[17.9875,0.0504998,-2.20654e-05,4.16028e-09,-2.89843e-13,-49586.5,-55.4162], Tmin=(1257.35,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-373.88,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(548.755,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH)"""),
)

species(
    label = 'C=CCC(O)CC(C)OO(7697)',
    structure = SMILES('C=CCC(O)CC(C)OO'),
    E0 = (-361.298,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (146.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.17487,0.113791,-0.000100552,4.776e-08,-9.39658e-12,-43267.9,40.8667], Tmin=(100,'K'), Tmax=(1195.28,'K')), NASAPolynomial(coeffs=[17.4001,0.0516302,-2.25439e-05,4.25117e-09,-2.96471e-13,-47708.4,-52.0603], Tmin=(1195.28,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-361.298,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(548.755,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH)"""),
)
...
species(
    label = 'C[CH]CC([O])CCOO(7698)',
    structure = SMILES('C[CH]CC([O])CCOO'),
    E0 = (-27.8504,'kJ/mol'),
    modes = [
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.400851,0.104082,-0.000115889,8.02137e-08,-2.39507e-11,-3197.72,38.2773], Tmin=(100,'K'), Tmax=(797.04,'K')), NASAPolynomial(coeffs=[9.12447,0.0562782,-2.59237e-05,4.96393e-09,-3.47701e-13,-4716.12,-5.51596], Tmin=(797.04,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-27.8504,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(478.082,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(RCCJC) + radical(CC(C)OJ)"""),
)

species(
    label = 'C[CH]CC1CC(C)OO1(7699)',
    structure = SMILES('C[CH]CC1CC(C)OO1'),
    E0 = (-50.381,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (129.177,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0935789,0.0707713,1.86431e-06,-5.393e-08,2.73108e-11,-5904.84,32.6102], Tmin=(100,'K'), Tmax=(924.302,'K')), NASAPolynomial(coeffs=[15.9757,0.0408979,-1.27165e-05,2.07017e-09,-1.37953e-13,-10500.7,-51.7411], Tmin=(924.302,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-50.381,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(515.497,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(12dioxolane) + radical(RCCJC)"""),
)

species(
    label = 'CC1CC([O])CC(C)O1(7700)',
    structure = SMILES('CC1CC([O])CC(C)O1'),
    E0 = (-259.118,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (129.177,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.26038,0.060957,4.01605e-05,-9.80635e-08,4.37278e-11,-31010.5,26.1215], Tmin=(100,'K'), Tmax=(928.55,'K')), NASAPolynomial(coeffs=[18.0885,0.038466,-1.12387e-05,1.82781e-09,-1.25453e-13,-36662.6,-71.1744], Tmin=(928.55,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-259.118,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(523.812,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Oxane) + radical(CC(C)OJ)"""),
)

species(
    label = '[CH2]C(C)C([O])CC(C)OO(7403)',
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.35633,0.117507,-0.000109204,5.56512e-08,-1.17109e-11,-6942.83,42.356], Tmin=(100,'K'), Tmax=(1128.59,'K')), NASAPolynomial(coeffs=[17.189,0.0517774,-2.18421e-05,4.0458e-09,-2.79474e-13,-11128.8,-49.358], Tmin=(1128.59,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-59.3318,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(548.755,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Isobutyl) + radical(CC(C)OJ)"""),
)

species(
    label = 'CC(CC1CC(C)O1)OO(5881)',
    structure = SMILES('CC(CC1CC(C)O1)OO'),
    E0 = (-317.692,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (146.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.04716,0.0968056,-4.44663e-05,-1.39604e-08,1.39092e-11,-38014.9,36.3017], Tmin=(100,'K'), Tmax=(951.843,'K')), NASAPolynomial(coeffs=[19.3864,0.0445466,-1.50783e-05,2.55398e-09,-1.71898e-13,-43427.4,-69.2681], Tmin=(951.843,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-317.692,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(557.07,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Oxetane)"""),
)
...
reaction(
    ...
    products = ['C3H6(72)', 'CC(CC=O)OO(1957)'],
    transitionState = 'TS1',
...
reaction(
    ...
    products = ['C[CH]CC([O])CC(C)OO(2163)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'CC=CC([O])CC(C)OO(7688)'],
    products = ['C[CH]CC([O])CC(C)OO(2163)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', 'C=CCC([O])CC(C)OO(7689)'],
    products = ['C[CH]CC([O])CC(C)OO(2163)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['QOOH_3(717)', 'C4H7OJ_13(1705)'],
    products = ['C[CH]CC([O])CC(C)OO(2163)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['C3H6(T)(143)', 'CC(CC=O)OO(1957)'],
    products = ['C[CH]CC([O])CC(C)OO(2163)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['C3H6(72)', 'CC(C[CH][O])OO(1991)'],
    products = ['C[CH]CC([O])CC(C)OO(2163)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['C[CH]CC([O])CC(C)OO(2163)'],
    products = ['C[CH]C[C](O)CC(C)OO(2165)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction11',
    reactants = ['C[CH]CC(O)[CH]C(C)OO(7690)'],
    products = ['C[CH]CC([O])CC(C)OO(2163)'],
...
reaction(
    label = 'reaction12',
    reactants = ['C[CH]CC([O])CC(C)OO(2163)'],
    products = ['C[CH][CH]C(O)CC(C)OO(7691)'],
...
reaction(
    label = 'reaction14',
    reactants = ['C[CH]CC([O])CC(C)OO(2163)'],
    products = ['C[CH]CC(O)C[C](C)OO(7692)'],
...
reaction(
    label = 'reaction16',
    reactants = ['C[CH]CC([O])CC(C)OO(2163)'],
    products = ['[CH2]C(CC(O)C[CH]C)OO(7693)'],
...
reaction(
    label = 'reaction18',
    reactants = ['C[CH]CC([O])CC(C)OO(2163)'],
    products = ['[CH2][CH]CC(O)CC(C)OO(7694)'],
...
reaction(
    label = 'reaction19',
    reactants = ['C[CH]CC([O])CC(C)OO(2163)'],
    products = ['C[CH]CC(O)CC(C)O[O](7695)'],
...
reaction(
    label = 'reaction22',
    reactants = ['C3H6(T)(143)', 'CC(C[CH][O])OO(1991)'],
    products = ['C[CH]CC([O])CC(C)OO(2163)'],
...
reaction(
    label = 'reaction26',
    reactants = ['CH2(S)(23)', 'C[CH]CC([O])CCOO(7698)'],
    products = ['C[CH]CC([O])CC(C)OO(2163)'],
...
reaction(
    label = 'reaction27',
    reactants = ['C[CH]CC([O])CC(C)OO(2163)'],
    products = ['OH(5)', 'C[CH]CC1CC(C)OO1(7699)'],
...
reaction(
    label = 'reaction28',
    reactants = ['C[CH]CC([O])CC(C)OO(2163)'],
    products = ['OH(5)', 'CC1CC([O])CC(C)O1(7700)'],
...
reaction(
    label = 'reaction28',
    reactants = ['[CH2]C(C)C([O])CC(C)OO(7403)'],
    products = ['C[CH]CC([O])CC(C)OO(2163)'],
...
reaction(
    label = 'reaction30',
    reactants = ['C[CH]CC([O])CC(C)OO(2163)'],
    products = ['CC(CC1CC(C)O1)OO(5881)'],
...
reaction(
    label = 'reaction31',
    reactants = ['O(4)', 'C[CH]C[CH]CC(C)OO(6211)'],
    products = ['C[CH]CC([O])CC(C)OO(2163)'],
...
reaction(
    label = 'reaction32',
    reactants = ['CHCH3(T)(95)', '[CH2]C([O])CC(C)OO(1956)'],
    products = ['C[CH]CC([O])CC(C)OO(2163)'],
...
network(
    label = '1429',
    isomers = [
        'C[CH]CC([O])CC(C)OO(2163)',
        'CCCC(=O)CC(C)OO(1965)',
    ],
    reactants = [
        ('C3H6(72)', 'CC(CC=O)OO(1957)'),
        ('OH(5)', 'CCCC(=O)CC(C)[O](2145)'),
        ('CH3CHOOH(63)', '[CH2]C(=O)CCC(2148)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
