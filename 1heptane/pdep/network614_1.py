...
species(
    label = '[CH2]CC(=O)O(805)',
    structure = SMILES('[CH2]CC(=O)O'),
    E0 = (-257.42,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3615,1277.5,1000,3000,3100,440,815,1455,1000,335.302,336.699,1848.84,1853.37,2841.9],'cm^-1')),
        HinderedRotor(inertia=(0.284716,'amu*angstrom^2'), symmetry=1, barrier=(22.8387,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.515186,'amu*angstrom^2'), symmetry=1, barrier=(41.1708,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.537816,'amu*angstrom^2'), symmetry=1, barrier=(42.6934,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (73.0706,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.51589,0.0352419,-2.40095e-05,8.72328e-09,-1.39591e-12,-30909.5,16.6561], Tmin=(100,'K'), Tmax=(1337.83,'K')), NASAPolynomial(coeffs=[6.54184,0.0232046,-1.05131e-05,1.99776e-09,-1.39108e-13,-31986.8,-3.93856], Tmin=(1337.83,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-257.42,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsOs) + radical(CJCC=O)"""),
)
...
species(
    ...
    molecularWeight = (74.0785,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.98315,0.0455769,-4.44899e-05,2.42715e-08,-5.50879e-12,-8358.2,22.247], Tmin=(100,'K'), Tmax=(1046.64,'K')), NASAPolynomial(coeffs=[8.45158,0.0208567,-9.06265e-06,1.70618e-09,-1.18963e-13,-9712.25,-9.25443], Tmin=(1046.64,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-70.0896,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + radical(Cs_P) + radical(RCCJ)"""),
)
...
species(
    ...
    E0 = (-49.6308,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,360,370,350,3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,306.978,2423.26],'cm^-1')),
        HinderedRotor(inertia=(0.108812,'amu*angstrom^2'), symmetry=1, barrier=(7.27037,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0076365,'amu*angstrom^2'), symmetry=1, barrier=(7.26837,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.108685,'amu*angstrom^2'), symmetry=1, barrier=(7.27166,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (74.0785,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.20715,0.0433615,-5.12508e-05,4.45809e-08,-1.70726e-11,-5908.42,21.2062], Tmin=(100,'K'), Tmax=(754.987,'K')), NASAPolynomial(coeffs=[3.75376,0.029952,-1.42474e-05,2.7567e-09,-1.93516e-13,-5993.32,15.1637], Tmin=(754.987,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-49.6308,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + radical(Cs_P) + radical(CCOJ)"""),
)

species(
    label = '[CH2][CH]C(O)O(3171)',
    ...
    molecularWeight = (74.0785,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.90133,0.0424797,-3.54621e-05,1.55799e-08,-2.77088e-12,-8994.03,24.346], Tmin=(100,'K'), Tmax=(1338.33,'K')), NASAPolynomial(coeffs=[10.5364,0.0166713,-6.53628e-06,1.17101e-09,-7.93166e-14,-11305.4,-19.8297], Tmin=(1338.33,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-75.4339,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + radical(CCJCO) + radical(RCCJ)"""),
)
...
species(
    ...
    molecularWeight = (74.0785,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.04314,0.0413771,-3.31798e-05,1.41723e-08,-2.50006e-12,-42496.8,19.3585], Tmin=(100,'K'), Tmax=(1324.47,'K')), NASAPolynomial(coeffs=[9.42878,0.0190721,-7.91901e-06,1.45758e-09,-1.0011e-13,-44453.2,-18.3485], Tmin=(1324.47,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-353.935,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cds-CdsCsH) + group(Cds-CdsHH)"""),
)
...
species(
    ...
    molecularWeight = (74.0785,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.3182,0.0338019,-1.57455e-05,2.38742e-09,8.05918e-14,-56345.6,16.7584], Tmin=(100,'K'), Tmax=(1644.51,'K')), NASAPolynomial(coeffs=[10.1,0.0204141,-8.58767e-06,1.53431e-09,-1.01151e-13,-59654.2,-26.9332], Tmin=(1644.51,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-469.01,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsOs)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'C=CC([O])O(3167)'],
    products = ['[CH2]CC([O])O(1043)'],
    transitionState = 'TS2',
