species(
    label = 'C#CC([CH2])O[CH2](26483)',
    structure = SMILES('C#CC([CH2])O[CH2]'),
    E0 = (391.462,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2175,525,750,770,3400,2100,1380,1390,370,380,2900,435,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,317.534,318.448],'cm^-1')),
        HinderedRotor(inertia=(1.67567,'amu*angstrom^2'), symmetry=1, barrier=(119.627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.173361,'amu*angstrom^2'), symmetry=1, barrier=(12.3682,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.172797,'amu*angstrom^2'), symmetry=1, barrier=(12.3373,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.66549,'amu*angstrom^2'), symmetry=1, barrier=(119.627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (82.1005,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.705629,0.0717268,-9.14635e-05,6.00983e-08,-1.53878e-11,47201.3,23.2934], Tmin=(100,'K'), Tmax=(964.424,'K')), NASAPolynomial(coeffs=[13.9618,0.0167443,-5.94451e-06,9.8053e-10,-6.2584e-14,44644.5,-40.1791], Tmin=(964.424,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(391.462,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cs-OsHHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(CJC(C)OC) + radical(CsJOCC2)"""),
)
...
species(
    label = '[CH]=C1CC1O[CH2](26735)',
    structure = SMILES('[CH]=C1CC1O[CH2]'),
    E0 = (465.565,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (82.1005,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.3726,0.0471735,-1.75157e-05,-1.60795e-08,1.0771e-11,56098.6,21.3383], Tmin=(100,'K'), Tmax=(979.334,'K')), NASAPolynomial(coeffs=[15.277,0.014764,-5.21986e-06,9.71802e-10,-7.12896e-14,52206,-51.4212], Tmin=(979.334,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(465.565,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-OsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + ring(Methylene_cyclopropane) + radical(Cds_P) + radical(CsJOCC2)"""),
)
...
species(
    label = 'C#CC(=C)O[CH2](26737)',
    structure = SMILES('C#CC(=C)O[CH2]'),
    E0 = (267.506,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,440,435,1725,750,770,3400,2100,2175,525,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,284.604,284.947],'cm^-1')),
        HinderedRotor(inertia=(0.456797,'amu*angstrom^2'), symmetry=1, barrier=(26.255,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.457982,'amu*angstrom^2'), symmetry=1, barrier=(26.26,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.456255,'amu*angstrom^2'), symmetry=1, barrier=(26.2593,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (81.0926,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.32648,0.0495948,-3.00946e-05,-3.4956e-09,6.72406e-12,32278.1,19.8482], Tmin=(100,'K'), Tmax=(972.354,'K')), NASAPolynomial(coeffs=[15.6234,0.0117148,-3.95237e-06,7.21704e-10,-5.28599e-14,28508.1,-53.8141], Tmin=(972.354,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(267.506,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-OsHHH) + group(Cds-Cds(Cds-Cds)O2s) + group(Cds-CdsHH) + group(Ct-Ct(Cds-Cds)) + group(Ct-CtH) + radical(C=COCJ)"""),
)
...
species(
    ...
    molecularWeight = (82.1005,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.27175,0.0533687,-3.95445e-05,7.27091e-09,3.01367e-12,35862.7,22.6215], Tmin=(100,'K'), Tmax=(942.77,'K')), NASAPolynomial(coeffs=[13.9576,0.0155718,-4.90709e-06,8.09224e-10,-5.44204e-14,32758.5,-41.6102], Tmin=(942.77,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(297.312,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)HHH) + group(Cs-OsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(C=COCJ) + radical(C=C=CJ)"""),
)

species(
    label = 'C#C[C]([CH2])OC(26739)',
    ...
    molecularWeight = (82.1005,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.588342,0.0622391,-6.27345e-05,3.16933e-08,-6.05955e-12,31912.3,23.2801], Tmin=(100,'K'), Tmax=(1454.64,'K')), NASAPolynomial(coeffs=[16.323,0.0111508,-1.98846e-06,1.57182e-10,-4.43036e-15,28162,-55.6834], Tmin=(1454.64,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(264.221,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)HHH) + group(Cs-OsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(C=C=CJ) + radical(C=C(O)CJ)"""),
)

species(
    label = '[C]#CC(C)O[CH2](26740)',
    structure = SMILES('[C]#CC(C)O[CH2]'),
    E0 = (518.096,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2175,525,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,284.573,284.791,3210.18],'cm^-1')),
        HinderedRotor(inertia=(0.28242,'amu*angstrom^2'), symmetry=1, barrier=(16.2745,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.34673,'amu*angstrom^2'), symmetry=1, barrier=(77.5942,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.282285,'amu*angstrom^2'), symmetry=1, barrier=(16.27,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.34324,'amu*angstrom^2'), symmetry=1, barrier=(77.5818,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (82.1005,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.13502,0.0618246,-6.79797e-05,3.86494e-08,-8.13032e-12,62416.9,22.7446], Tmin=(100,'K'), Tmax=(869.183,'K')), NASAPolynomial(coeffs=[12.0114,0.0189904,-6.5167e-06,1.06272e-09,-6.78829e-14,60253.5,-29.7714], Tmin=(869.183,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(518.096,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cs-OsHHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(Acetyl) + radical(CsJOCC2)"""),
)

species(
    label = '[C]#CC([CH2])OC(26741)',
    structure = SMILES('[C]#CC([CH2])OC'),
    E0 = (545.021,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2175,525,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,288.954,289.799,1551.65],'cm^-1')),
        HinderedRotor(inertia=(0.162788,'amu*angstrom^2'), symmetry=1, barrier=(9.65391,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.162619,'amu*angstrom^2'), symmetry=1, barrier=(9.64775,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.163015,'amu*angstrom^2'), symmetry=1, barrier=(9.65297,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.11074,'amu*angstrom^2'), symmetry=1, barrier=(65.8661,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (82.1005,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.05799,0.0684105,-9.71358e-05,7.61203e-08,-2.33094e-11,65653.3,23.3536], Tmin=(100,'K'), Tmax=(918.357,'K')), NASAPolynomial(coeffs=[9.28916,0.0235441,-9.12903e-06,1.54442e-09,-9.82307e-14,64521.7,-13.5863], Tmin=(918.357,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(545.021,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cs-OsHHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(CJC(C)OC) + radical(Acetyl)"""),
)
...
species(
    label = '[CH2]C1[C]=CCO1(26742)',
    structure = SMILES('[CH2]C1[C]=CCO1'),
    E0 = (326.45,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (82.1005,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.88945,0.0349568,9.61891e-06,-3.8141e-08,1.71375e-11,39349.1,19.7235], Tmin=(100,'K'), Tmax=(982.443,'K')), NASAPolynomial(coeffs=[12.6761,0.0183567,-6.74494e-06,1.26612e-09,-9.24601e-14,35911.3,-38.8345], Tmin=(982.443,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(326.45,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(278.535,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(25dihydrofuran) + radical(Cds_S) + radical(CJC(C)OC)"""),
)

species(
    label = 'C#CC(=C)OC(26743)',
    ...
    molecularWeight = (82.1005,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.20713,0.0517277,-2.85407e-05,-6.04977e-09,7.61923e-12,9189.61,17.7911], Tmin=(100,'K'), Tmax=(975.812,'K')), NASAPolynomial(coeffs=[15.6431,0.014487,-5.0125e-06,9.11395e-10,-6.58138e-14,5327.94,-56.8516], Tmin=(975.812,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(75.4985,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-OsHHH) + group(Cds-Cds(Cds-Cds)O2s) + group(Cds-CdsHH) + group(Ct-Ct(Cds-Cds)) + group(Ct-CtH)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['C#CC([CH2])O[CH2](26483)'],
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', 'C#CC(=C)O[CH2](26737)'],
    products = ['C#CC([CH2])O[CH2](26483)'],
    transitionState = 'TS4',
...
reaction(
    ...
    products = ['C#CC([CH2])O[CH2](26483)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(2330,'cm^3/(mol*s)'), n=3.17, Ea=(58.933,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""Estimated using template [Od_CO-HH;YJ] for rate rule [Od_CO-HH;CJ]
Euclidian distance = 1.0
family: R_Addition_MultipleBond
Ea raised from 57.5 to 58.9 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction6',
    reactants = ['C2H(33)', 'CH2OCHCH2(566)'],
    products = ['C#CC([CH2])O[CH2](26483)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction17',
    reactants = ['CH2(19)', 'C#CC([CH2])[O](26706)'],
    products = ['C#CC([CH2])O[CH2](26483)'],
...
network(
    label = '4449',
    isomers = [
        'C#CC([CH2])O[CH2](26483)',
    ],
    reactants = [
        ('CH2O(15)', 'CH2CHCCH(26391)'),
        ('C2H(33)', 'CH2OCHCH2(566)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
