...
species(
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.72003,0.0526637,-2.67537e-05,-7.90005e-09,1.27298e-11,8370.3,25.534], Tmin=(100,'K'), Tmax=(659.015,'K')), NASAPolynomial(coeffs=[6.10546,0.0363851,-1.32356e-05,2.23201e-09,-1.45164e-13,7567.77,4.5021], Tmin=(659.015,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(68.9294,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(RCCJC) + radical(CCOJ)"""),
)
...
species(
    label = 'CC=CC([O])C=O(3624)',
    structure = SMILES('CC=CC([O])C=O'),
    E0 = (-62.63,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2782.5,750,1395,475,1775,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,185.671,4000],'cm^-1')),
        HinderedRotor(inertia=(0.724333,'amu*angstrom^2'), symmetry=1, barrier=(16.6538,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.12352,'amu*angstrom^2'), symmetry=1, barrier=(2.83997,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.72508,'amu*angstrom^2'), symmetry=1, barrier=(16.671,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.36376,0.0522304,-3.46139e-05,1.14452e-08,-1.53567e-12,-7433.17,28.3179], Tmin=(100,'K'), Tmax=(1708.48,'K')), NASAPolynomial(coeffs=[13.4565,0.023918,-9.75622e-06,1.74543e-09,-1.16295e-13,-11565.2,-36.4993], Tmin=(1708.48,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-62.63,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-O2d)CsOsH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-OdCsH) + radical(C=OCOJ)"""),
)

species(
    label = 'C[CH]CC(=O)C=O(3625)',
    structure = SMILES('C[CH]CC(=O)C=O'),
    E0 = (-135.193,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2782.5,750,1395,475,1775,1000,375,552.5,462.5,1710,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,2431.13,2431.14],'cm^-1')),
        HinderedRotor(inertia=(0.0763035,'amu*angstrom^2'), symmetry=1, barrier=(10.6461,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.22404,'amu*angstrom^2'), symmetry=1, barrier=(28.1431,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0763008,'amu*angstrom^2'), symmetry=1, barrier=(10.6457,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.18494,'amu*angstrom^2'), symmetry=1, barrier=(28.1433,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.7156,0.055349,-4.27768e-05,1.89164e-08,-3.79743e-12,-16182,24.7746], Tmin=(100,'K'), Tmax=(1092.66,'K')), NASAPolynomial(coeffs=[6.78965,0.0367741,-1.72775e-05,3.35865e-09,-2.37847e-13,-17290.9,-0.154441], Tmin=(1092.66,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-135.193,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-O2d(Cds-O2d)Cs) + group(Cds-O2d(Cds-O2d)H) + radical(CCJCC=O)"""),
)
...
species(
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.542165,0.0632104,-2.77361e-05,-1.99165e-08,1.55118e-11,-15227.8,28.7959], Tmin=(100,'K'), Tmax=(932.404,'K')), NASAPolynomial(coeffs=[19.154,0.0159374,-4.08546e-06,6.38871e-10,-4.49764e-14,-20114.4,-67.2855], Tmin=(932.404,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-127.744,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + radical(C=COJ) + radical(RCCJC)"""),
)

species(
    label = '[CH2]CCC([O])C=O(3628)',
    structure = SMILES('[CH2]CCC([O])C=O'),
    E0 = (28.2142,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2782.5,750,1395,475,1775,1000,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,180,1258.33,4000],'cm^-1')),
        HinderedRotor(inertia=(0.134292,'amu*angstrom^2'), symmetry=1, barrier=(3.08764,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.870587,'amu*angstrom^2'), symmetry=1, barrier=(20.0165,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00275007,'amu*angstrom^2'), symmetry=1, barrier=(3.08999,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.870576,'amu*angstrom^2'), symmetry=1, barrier=(20.0163,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.980553,0.058291,-4.06343e-05,1.4322e-08,-2.04121e-12,3508.77,32.1161], Tmin=(100,'K'), Tmax=(1634.59,'K')), NASAPolynomial(coeffs=[14.7358,0.024631,-9.74634e-06,1.72458e-09,-1.14539e-13,-988.138,-41.0045], Tmin=(1634.59,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(28.2142,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(C=OCOJ) + radical(RCCJ)"""),
)

species(
    label = 'CCC[C]([O])C=O(3629)',
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.662217,0.0595943,-1.78022e-05,-2.87948e-08,1.81267e-11,-22043.7,27.1301], Tmin=(100,'K'), Tmax=(940.974,'K')), NASAPolynomial(coeffs=[18.7896,0.01695,-4.6817e-06,7.75871e-10,-5.5844e-14,-26978.7,-67.3165], Tmin=(940.974,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-184.386,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + radical(C=COJ) + radical(C=C(C)OJ)"""),
)

species(
    label = 'C[CH][CH]C(O)C=O(3630)',
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.0988,0.0553957,-3.67829e-05,1.23836e-08,-1.69022e-12,-3065.76,34.3604], Tmin=(100,'K'), Tmax=(1697.28,'K')), NASAPolynomial(coeffs=[14.2372,0.0244324,-9.41874e-06,1.6354e-09,-1.07075e-13,-7525.68,-35.9752], Tmin=(1697.28,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-26.4169,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(CCJCO) + radical(RCCJC)"""),
)

species(
    label = 'C[CH]CC(O)[C]=O(3631)',
    structure = SMILES('C[CH]CC(O)[C]=O'),
    E0 = (-66.3584,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.22754,0.0592234,-4.66404e-05,2.00528e-08,-3.60837e-12,-7879.94,32.1986], Tmin=(100,'K'), Tmax=(1290.37,'K')), NASAPolynomial(coeffs=[10.8139,0.0295069,-1.20964e-05,2.20568e-09,-1.50628e-13,-10353.9,-16.4937], Tmin=(1290.37,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-66.3584,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(RCCJC) + radical(CCCJ=O)"""),
)

species(
    label = 'CCCC([O])[C]=O(3632)',
    structure = SMILES('CCCC([O])[C]=O'),
    E0 = (-17.0715,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.865131,0.0606849,-4.62494e-05,1.82879e-08,-2.92067e-12,-1933.54,31.5558], Tmin=(100,'K'), Tmax=(1482.39,'K')), NASAPolynomial(coeffs=[14.4553,0.024014,-9.14298e-06,1.60029e-09,-1.06365e-13,-5962.73,-39.3587], Tmin=(1482.39,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-17.0715,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsOsH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(C=OCOJ) + radical(CCCJ=O)"""),
)

species(
    label = '[CH2][CH]CC(O)C=O(3633)',
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.40195,0.0562586,-3.95152e-05,1.4663e-08,-2.29536e-12,-2440.58,32.5376], Tmin=(100,'K'), Tmax=(1437.62,'K')), NASAPolynomial(coeffs=[10.5024,0.0309379,-1.30958e-05,2.41159e-09,-1.6486e-13,-5057.17,-14.67], Tmin=(1437.62,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-21.0726,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(RCCJC) + radical(RCCJ)"""),
)

species(
    label = 'C[CH]CC1[CH]OO1(3634)',
    structure = SMILES('C[CH]CC1[CH]OO1'),
    E0 = (282.199,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.47896,0.0601114,-6.01661e-05,4.73795e-08,-1.76004e-11,34027,23.4799], Tmin=(100,'K'), Tmax=(738.234,'K')), NASAPolynomial(coeffs=[3.51976,0.0448476,-2.06059e-05,3.93667e-09,-2.75088e-13,33840.3,15.0299], Tmin=(738.234,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(282.199,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(12dioxetane) + radical(RCCJC) + radical(CCsJOO)"""),
)

species(
    label = 'CC1CC([O])[CH]O1(3340)',
    structure = SMILES('CC1CC([O])[CH]O1'),
    E0 = (3.36117,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.37342,0.0407904,3.6206e-05,-8.71513e-08,4.10561e-11,514.888,19.7664], Tmin=(100,'K'), Tmax=(888.381,'K')), NASAPolynomial(coeffs=[17.0004,0.0167996,-1.58155e-06,-3.95541e-11,7.62437e-15,-4091.48,-64.0737], Tmin=(888.381,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(3.36117,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(353.365,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Tetrahydrofuran) + radical(CCsJOCs) + radical(CC(C)OJ)"""),
)

species(
    label = 'CC=CC(O)C=O(3635)',
    structure = SMILES('CC=CC(O)C=O'),
    E0 = (-306.363,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.08416,0.055665,-3.28689e-05,6.3719e-09,5.61243e-13,-36735,28.5377], Tmin=(100,'K'), Tmax=(1205.11,'K')), NASAPolynomial(coeffs=[13.0821,0.0270289,-1.11504e-05,2.06031e-09,-1.4232e-13,-40439.1,-34.9542], Tmin=(1205.11,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-306.363,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-O2d)CsOsH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-OdCsH)"""),
)

species(
    label = 'CCCC(=O)C=O(3636)',
    structure = SMILES('CCCC(=O)C=O'),
    E0 = (-335.095,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.50322,0.0605988,-5.07817e-05,2.67114e-08,-6.60607e-12,-40217.6,23.0526], Tmin=(100,'K'), Tmax=(901.24,'K')), NASAPolynomial(coeffs=[5.6787,0.0420667,-1.99373e-05,3.89514e-09,-2.76929e-13,-40970.2,3.34245], Tmin=(901.24,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-335.095,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-O2d(Cds-O2d)Cs) + group(Cds-O2d(Cds-O2d)H)"""),
)

species(
    label = 'C=CCC(O)C=O(3637)',
    structure = SMILES('C=CCC(O)C=O'),
    E0 = (-292.983,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.16256,0.0511434,-1.25319e-05,-1.94883e-08,1.068e-11,-35125.8,29.3541], Tmin=(100,'K'), Tmax=(1026.19,'K')), NASAPolynomial(coeffs=[14.048,0.0251603,-9.98858e-06,1.88094e-09,-1.34457e-13,-39046.8,-39.3632], Tmin=(1026.19,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-292.983,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-O2d)CsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-OdCsH) + group(Cds-CdsHH)"""),
)
...
species(
    label = 'C[CH]CC([O])=CO(3638)',
    structure = SMILES('C[CH]CC([O])=CO'),
    E0 = (-131.402,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,2750,2850,1437.5,1250,1305,750,350,443.243,443.243,443.243],'cm^-1')),
        HinderedRotor(inertia=(0.0813407,'amu*angstrom^2'), symmetry=1, barrier=(11.3402,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0813409,'amu*angstrom^2'), symmetry=1, barrier=(11.3402,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0813409,'amu*angstrom^2'), symmetry=1, barrier=(11.3402,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0813409,'amu*angstrom^2'), symmetry=1, barrier=(11.3402,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.372915,0.0762928,-7.32398e-05,3.50221e-08,-6.30899e-12,-15629.5,32.1826], Tmin=(100,'K'), Tmax=(1566.59,'K')), NASAPolynomial(coeffs=[19.7193,0.0135769,-2.26082e-06,1.65935e-10,-4.3799e-15,-20524.2,-69.3], Tmin=(1566.59,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-131.402,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + radical(C=C(C)OJ) + radical(RCCJC)"""),
)
...
species(
    label = 'C[CH]C[CH]C=O(2432)',
    structure = SMILES('C[CH]CC=C[O]'),
    E0 = (86.8142,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2995,3025,975,1000,1300,1375,400,500,1630,1680,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,303.635,903.72,903.844],'cm^-1')),
        HinderedRotor(inertia=(0.568761,'amu*angstrom^2'), symmetry=1, barrier=(13.0769,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.568593,'amu*angstrom^2'), symmetry=1, barrier=(13.0731,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0222841,'amu*angstrom^2'), symmetry=1, barrier=(13.1043,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
reaction(
    ...
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(2.13771e+06,'s^-1'), n=1.58803, Ea=(79.4179,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R5_SS;multiplebond_intra;radadd_intra_csHNd] for rate rule [R5_SS_CO;carbonylbond_intra_H;radadd_intra_csHNd]
Euclidian distance = 2.2360679775
family: Intra_R_Add_Exocyclic
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', 'CC=CC([O])C=O(3624)'],
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)', 'C[CH]CC(=O)C=O(3625)'],
    products = ['C[CH]CC([O])C=O(1339)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['H(3)', 'C=CCC([O])C=O(3626)'],
    products = ['C[CH]CC([O])C=O(1339)'],
    transitionState = 'TS6',
...
reaction(
    ...
    products = ['C[CH]CC([O])C=O(1339)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(0.0124089,'m^3/(mol*s)'), n=2.46568, Ea=(30.2839,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [Cds-HH_Cds-Cs\H3/H;CJ]
Euclidian distance = 0
Multiplied by reaction path degeneracy 2.0
family: R_Addition_MultipleBond
Ea raised from 27.7 to 30.3 kJ/mol to match endothermicity of reaction."""),
)
...
reaction(
    label = 'reaction9',
    reactants = ['HCO(16)', 'C4H7OJ_13(1705)'],
    products = ['C[CH]CC([O])C=O(1339)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction29',
    reactants = ['CHCH3(T)(95)', '[CH2]C([O])C=O(2583)'],
    products = ['C[CH]CC([O])C=O(1339)'],
...
reaction(
    label = 'reaction30',
    reactants = ['O(4)', 'C[CH]C[CH]C=O(2432)'],
    products = ['C[CH]CC([O])C=O(1339)'],
