...
species(
    label = 'C=C(C)C[CH]CC(C)OO(6592)',
    structure = SMILES('C=C(C)C[CH]CC(C)OO'),
    E0 = (-33.4246,'kJ/mol'),
    modes = [
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.774784,0.113224,-0.000106797,6.24305e-08,-1.6239e-11,-3855.15,40.4211], Tmin=(100,'K'), Tmax=(891.596,'K')), NASAPolynomial(coeffs=[9.22077,0.0683825,-3.13601e-05,6.02681e-09,-4.24287e-13,-5637.62,-6.65516], Tmin=(891.596,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-33.4246,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(573.699,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(RCCJCC)"""),
)

species(
    label = '[CH2]C(C)C=CCC(C)OO(6593)',
    structure = SMILES('[CH2]C(C)C=CCC(C)OO'),
    E0 = (-26.6083,'kJ/mol'),
    modes = [
...
species(
    label = '[CH2]C(C)CC=CC(C)OO(6594)',
    structure = SMILES('[CH2]C(C)CC=CC(C)OO'),
    E0 = (-28.0142,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,2995,3025,975,1000,1300,1375,400,500,1630,1680,3615,1310,387.5,850,1000,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (143.203,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.56462,0.111151,-8.65486e-05,3.5208e-08,-5.82656e-12,-3159.87,44.7989], Tmin=(100,'K'), Tmax=(1424.16,'K')), NASAPolynomial(coeffs=[21.4971,0.0463773,-1.83245e-05,3.27103e-09,-2.20202e-13,-9728.49,-74.6144], Tmin=(1424.16,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-28.0142,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(573.699,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Isobutyl)"""),
)
...
species(
    label = '[CH2]C(C)CC=C(526)',
    structure = SMILES('[CH2]C(C)CC=C'),
    E0 = (131.959,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3010,987.5,1337.5,450,1655,2750,2800,2850,1350,1500,750,1050,1375,1000,2950,3100,1380,975,1025,1650,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,772.087,3550.73],'cm^-1')),
        HinderedRotor(inertia=(0.119695,'amu*angstrom^2'), symmetry=1, barrier=(2.75202,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.739669,'amu*angstrom^2'), symmetry=1, barrier=(17.0064,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.739243,'amu*angstrom^2'), symmetry=1, barrier=(16.9967,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(3.64726,'amu*angstrom^2'), symmetry=1, barrier=(83.8576,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
species(
    ...
    molecularWeight = (144.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.25826,0.126727,-0.000160087,1.37484e-07,-5.0053e-11,4243.42,43.3023], Tmin=(100,'K'), Tmax=(788.79,'K')), NASAPolynomial(coeffs=[5.26647,0.077581,-3.60897e-05,6.8735e-09,-4.76819e-13,3713.68,16.5391], Tmin=(788.79,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(33.7962,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(594.485,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Tertalkyl) + radical(RCCJCC)"""),
)
...
species(
    label = '[CH2]C(C)CC[CH]C(C)OO(6597)',
    ...
    molecularWeight = (144.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.31311,0.119531,-0.000106005,5.32949e-08,-1.13554e-11,7334.75,44.5882], Tmin=(100,'K'), Tmax=(1098.06,'K')), NASAPolynomial(coeffs=[14.7017,0.0611938,-2.63163e-05,4.9147e-09,-3.40771e-13,3817.61,-34.1727], Tmin=(1098.06,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(59.4125,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(594.485,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJCOOH) + radical(Isobutyl)"""),
)

species(
    label = 'CC(C)[CH][CH]CC(C)OO(6598)',
    structure = SMILES('CC(C)[CH][CH]CC(C)OO'),
    E0 = (42.9157,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (144.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.68662,0.112054,-0.000100773,5.82791e-08,-1.55093e-11,5322.58,42.7058], Tmin=(100,'K'), Tmax=(858.795,'K')), NASAPolynomial(coeffs=[7.49637,0.0739402,-3.42035e-05,6.60232e-09,-4.66038e-13,3917.07,4.4732], Tmin=(858.795,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(42.9157,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(594.485,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(Cs_S)"""),
)

species(
    label = '[CH2][C](C)CCCC(C)OO(6599)',
    structure = SMILES('[CH2][C](C)CCCC(C)OO'),
    E0 = (44.4202,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (144.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.36192,0.126088,-0.000140602,1.00657e-07,-3.12449e-11,5528.1,43.6031], Tmin=(100,'K'), Tmax=(767.959,'K')), NASAPolynomial(coeffs=[9.36244,0.0702293,-3.14976e-05,5.94462e-09,-4.1245e-13,3880.92,-5.30431], Tmin=(767.959,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(44.4202,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(594.485,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Isobutyl) + radical(Tertalkyl)"""),
)

species(
    label = '[CH2]C(C)CCC[C](C)OO(6600)',
    ...
    molecularWeight = (144.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.11443,0.118808,-0.000110068,6.12851e-08,-1.48573e-11,5698.94,41.8775], Tmin=(100,'K'), Tmax=(962.154,'K')), NASAPolynomial(coeffs=[11.2825,0.0672695,-2.97183e-05,5.61104e-09,-3.91164e-13,3313.41,-17.4521], Tmin=(962.154,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(45.8967,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(594.485,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Isobutyl) + radical(C2CsJOOH)"""),
)

species(
    label = '[CH2]C([CH2])CCCC(C)OO(6601)',
    structure = SMILES('[CH2]C([CH2])CCCC(C)OO'),
    E0 = (64.0799,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (144.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.51233,0.12149,-0.000110806,5.74909e-08,-1.24823e-11,7905.34,44.084], Tmin=(100,'K'), Tmax=(1090.22,'K')), NASAPolynomial(coeffs=[15.7024,0.0583306,-2.39084e-05,4.35423e-09,-2.97611e-13,4151.7,-40.4545], Tmin=(1090.22,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(64.0799,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(594.485,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Isobutyl) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]C(C)CCCC([CH2])OO(6602)',
    structure = SMILES('[CH2]C(C)CCCC([CH2])OO'),
    E0 = (72.9601,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1310,387.5,850,1000,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (144.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.52072,0.121658,-0.000108491,5.37442e-08,-1.11157e-11,8973.65,45.0194], Tmin=(100,'K'), Tmax=(1139.26,'K')), NASAPolynomial(coeffs=[16.681,0.0577517,-2.43491e-05,4.50685e-09,-3.1103e-13,4826.33,-45.1664], Tmin=(1139.26,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(72.9601,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(594.485,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJCOOH) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]C(C)CCCC(C)O[O](6603)',
    ...
    molecularWeight = (144.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.15112,0.114862,-9.83281e-05,4.83015e-08,-1.01077e-11,1507.41,42.4577], Tmin=(100,'K'), Tmax=(1114.36,'K')), NASAPolynomial(coeffs=[13.9376,0.0606999,-2.54212e-05,4.68419e-09,-3.22236e-13,-1855.39,-31.9702], Tmin=(1114.36,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(11.0023,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(598.642,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(Isobutyl)"""),
)

species(
    label = 'CC(C)C[CH][CH]C(C)OO(6604)',
    structure = SMILES('CC(C)C[CH][CH]C(C)OO'),
    E0 = (48.7885,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (144.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.879478,0.115673,-0.000106829,6.15149e-08,-1.58659e-11,6036.46,43.1431], Tmin=(100,'K'), Tmax=(895.57,'K')), NASAPolynomial(coeffs=[9.04571,0.0713452,-3.25867e-05,6.2514e-09,-4.39691e-13,4258.64,-3.646], Tmin=(895.57,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(48.7885,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(594.485,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJCOOH) + radical(RCCJCC)"""),
)

species(
    label = 'C[C](C[CH]CC(C)C)OO(6605)',
    ...
    molecularWeight = (144.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.124373,0.10527,-5.57992e-05,-5.23714e-08,7.1139e-11,4376.43,38.5976], Tmin=(100,'K'), Tmax=(507.103,'K')), NASAPolynomial(coeffs=[6.36832,0.0761987,-3.53033e-05,6.78961e-09,-4.77224e-13,3433.23,8.87579], Tmin=(507.103,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(35.2727,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(594.485,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(C2CsJOOH)"""),
)

species(
    label = '[CH2]C(C[CH]CC(C)C)OO(6606)',
    ...
    molecularWeight = (144.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.961816,0.116373,-0.000104554,5.60868e-08,-1.32245e-11,7669.9,43.1219], Tmin=(100,'K'), Tmax=(979.801,'K')), NASAPolynomial(coeffs=[10.8469,0.0681644,-3.07519e-05,5.87158e-09,-4.12063e-13,5355.83,-13.6077], Tmin=(979.801,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(62.3361,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(594.485,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJCOOH) + radical(RCCJCC)"""),
)

species(
    label = 'CC(C)C[CH]CC(C)O[O](6607)',
    structure = SMILES('CC(C)C[CH]CC(C)O[O]'),
    E0 = (0.378259,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (144.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.696457,0.110764,-9.83504e-05,5.55328e-08,-1.42152e-11,208.205,40.9366], Tmin=(100,'K'), Tmax=(897.232,'K')), NASAPolynomial(coeffs=[8.24377,0.0709086,-3.17215e-05,6.02742e-09,-4.21662e-13,-1396.14,-1.22558], Tmin=(897.232,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(0.378259,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(598.642,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(ROOJ)"""),
)

species(
    label = 'C=C(C)CCCC(C)OO(6608)',
    structure = SMILES('C=C(C)CCCC(C)OO'),
    E0 = (-227.883,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (144.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.16208,0.114754,-9.16088e-05,3.95621e-08,-7.21881e-12,-27223.5,39.2155], Tmin=(100,'K'), Tmax=(1259.03,'K')), NASAPolynomial(coeffs=[16.1149,0.0598642,-2.62139e-05,4.93511e-09,-3.43116e-13,-31574,-48.1158], Tmin=(1259.03,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-227.883,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(598.642,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH)"""),
)

species(
    label = 'CC(C)C=CCC(C)OO(6609)',
    structure = SMILES('CC(C)C=CCC(C)OO'),
    E0 = (-231.691,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (144.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.56639,0.111566,-8.16629e-05,3.07182e-08,-4.71432e-12,-27656.9,41.4596], Tmin=(100,'K'), Tmax=(1515.7,'K')), NASAPolynomial(coeffs=[22.027,0.0493017,-2.00433e-05,3.61533e-09,-2.43945e-13,-34809,-82.1769], Tmin=(1515.7,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-231.691,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(598.642,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH)"""),
)

species(
    label = 'CC(C)CC=CC(C)OO(6610)',
    structure = SMILES('CC(C)CC=CC(C)OO'),
    E0 = (-233.097,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (144.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.80654,0.111776,-8.06675e-05,2.93795e-08,-4.31085e-12,-27812.8,43.2152], Tmin=(100,'K'), Tmax=(1598.37,'K')), NASAPolynomial(coeffs=[24.9474,0.0448221,-1.78332e-05,3.17142e-09,-2.11602e-13,-36365.3,-98.4038], Tmin=(1598.37,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-233.097,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(598.642,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH)"""),
)
...
species(
    label = '[CH2]C(C)C[CH]CCOO(6611)',
    structure = SMILES('[CH2]C(C)C[CH]CCOO'),
    E0 = (89.8791,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1310,387.5,850,1000,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3000,3100,440,815,1455,1000,1380,1390,370,380,2900,435,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (130.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.539106,0.106486,-0.000114617,8.11554e-08,-2.52195e-11,10967.3,40.1763], Tmin=(100,'K'), Tmax=(764.248,'K')), NASAPolynomial(coeffs=[7.93761,0.0621132,-2.75131e-05,5.16215e-09,-3.57006e-13,9671.8,1.56136], Tmin=(764.248,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(89.8791,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(523.812,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(Isobutyl)"""),
)
...
species(
    label = '[CH2]C(C)CC1CC(C)O1(6612)',
    structure = SMILES('[CH2]C(C)CC1CC(C)O1'),
    E0 = (-41.1185,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (127.204,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.197752,0.0754892,7.78617e-06,-6.7063e-08,3.37559e-11,-4778.61,33.8824], Tmin=(100,'K'), Tmax=(908.593,'K')), NASAPolynomial(coeffs=[17.3212,0.0430594,-1.24642e-05,1.93672e-09,-1.26394e-13,-9807.05,-59.1098], Tmin=(908.593,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-41.1185,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(561.227,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Oxetane) + radical(Isobutyl)"""),
)
...
species(
    label = '[CH2]C(C)CC([CH2])C(C)OO(6614)',
...
species(
    label = 'CC1CC(C1)CC(C)OO(6357)',
    structure = SMILES('CC1CC(C1)CC(C)OO'),
    E0 = (-200.296,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (144.211,'amu'),
...
species(
    label = '[CH2]C(C)CC(O)CC(C)[O](6615)',
    structure = SMILES('[CH2]C(C)CC(O)CC(C)[O]'),
    E0 = (-154.617,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (144.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.534,0.117879,-0.000101038,4.76456e-08,-9.29767e-12,-18393.8,44.4715], Tmin=(100,'K'), Tmax=(1210.82,'K')), NASAPolynomial(coeffs=[17.8788,0.0537472,-2.15887e-05,3.90082e-09,-2.65497e-13,-23094.8,-52.8974], Tmin=(1210.82,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-154.617,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(598.642,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Isobutyl) + radical(CC(C)OJ)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(C)C[CH]CC(C)OO(6355)'],
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'C=C(C)C[CH]CC(C)OO(6592)'],
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', '[CH2]C(C)C=CCC(C)OO(6593)'],
    products = ['[CH2]C(C)C[CH]CC(C)OO(6355)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', '[CH2]C(C)CC=CC(C)OO(6594)'],
    products = ['[CH2]C(C)C[CH]CC(C)OO(6355)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(1.46e+08,'cm^3/(mol*s)'), n=1.64, Ea=(5.73208,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""From training reaction 2555 used for Cds-CsH_Cds-CsH;HJ
Exact match found for rate rule [Cds-CsH_Cds-CsH;HJ]
...
reaction(
    label = 'reaction6',
    reactants = ['CH3(17)', 'C=CC[CH]CC(C)OO(6398)'],
    products = ['[CH2]C(C)C[CH]CC(C)OO(6355)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['CH3CHOOH(63)', '[CH2]C(C)CC=C(526)'],
    products = ['[CH2]C(C)C[CH]CC(C)OO(6355)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]C(C)C[CH]CC(C)OO(6355)'],
    products = ['C[C](C)C[CH]CC(C)OO(6595)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]C(C)[CH]CCC(C)OO(6596)'],
    products = ['[CH2]C(C)C[CH]CC(C)OO(6355)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]C(C)CC[CH]C(C)OO(6597)'],
    products = ['[CH2]C(C)C[CH]CC(C)OO(6355)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]C(C)C[CH]CC(C)OO(6355)'],
    products = ['CC(C)[CH][CH]CC(C)OO(6598)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2]C(C)C[CH]CC(C)OO(6355)'],
    products = ['[CH2][C](C)CCCC(C)OO(6599)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]C(C)C[CH]CC(C)OO(6355)'],
    products = ['[CH2]C(C)CCC[C](C)OO(6600)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]C([CH2])CCCC(C)OO(6601)'],
    products = ['[CH2]C(C)C[CH]CC(C)OO(6355)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]C(C)CCCC([CH2])OO(6602)'],
    products = ['[CH2]C(C)C[CH]CC(C)OO(6355)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]C(C)C[CH]CC(C)OO(6355)'],
    products = ['[CH2]C(C)CCCC(C)O[O](6603)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2]C(C)C[CH]CC(C)OO(6355)'],
    products = ['CC(C)C[CH][CH]C(C)OO(6604)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2]C(C)C[CH]CC(C)OO(6355)'],
    products = ['C[C](C[CH]CC(C)C)OO(6605)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2]C(C[CH]CC(C)C)OO(6606)'],
    products = ['[CH2]C(C)C[CH]CC(C)OO(6355)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH2]C(C)C[CH]CC(C)OO(6355)'],
    products = ['CC(C)C[CH]CC(C)O[O](6607)'],
...
reaction(
    label = 'reaction26',
    reactants = ['CH2(S)(23)', '[CH2]CC[CH]CC(C)OO(6312)'],
    products = ['[CH2]C(C)C[CH]CC(C)OO(6355)'],
...
reaction(
    label = 'reaction27',
    reactants = ['CH2(S)(23)', '[CH2]C(C)C[CH]CCOO(6611)'],
    products = ['[CH2]C(C)C[CH]CC(C)OO(6355)'],
...
reaction(
    label = 'reaction28',
    reactants = ['[CH2]C(C)C[CH]CC(C)OO(6355)'],
    products = ['OH(5)', '[CH2]C(C)CC1CC(C)O1(6612)'],
...
reaction(
    label = 'reaction32',
    reactants = ['[CH2]C(C)CC([CH2])C(C)OO(6614)'],
    products = ['[CH2]C(C)C[CH]CC(C)OO(6355)'],
...
reaction(
    label = 'reaction33',
    reactants = ['[CH2]C(C)C[CH]CC(C)OO(6355)'],
    products = ['CC1CC(C1)CC(C)OO(6357)'],
...
reaction(
    label = 'reaction34',
    reactants = ['[CH2]C(C)C[CH]CC(C)OO(6355)'],
    products = ['[CH2]C(C)CC(O)CC(C)[O](6615)'],
...
reaction(
    label = 'reaction35',
    reactants = ['CH2(19)', 'C[CH]C[CH]CC(C)OO(6211)'],
    products = ['[CH2]C(C)C[CH]CC(C)OO(6355)'],
...
reaction(
    label = 'reaction36',
    reactants = ['[CH2]C([CH2])C(438)', '[CH]CC(C)OO(1806)'],
    products = ['[CH2]C(C)C[CH]CC(C)OO(6355)'],
