...
species(
    label = 'C=CC=CO[O](20909)',
    structure = SMILES('C=CC=CO[O]'),
    E0 = (161.628,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,3100,1380,975,1025,1650,492.5,1135,1000,2995,3010,3025,975,987.5,1000,1300,1337.5,1375,400,450,500,1630,1655,1680,180],'cm^-1')),
        HinderedRotor(inertia=(0.8194,'amu*angstrom^2'), symmetry=1, barrier=(18.8396,'kJ/mol'), semiclassical=False),
...
species(
    label = 'C=C=CCO[O](20910)',
    structure = SMILES('C=C=CCO[O]'),
    E0 = (217.076,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2950,3100,1380,975,1025,1650,540,610,2055,492.5,1135,1000,3010,987.5,1337.5,450,1655,180],'cm^-1')),
        HinderedRotor(inertia=(0.582653,'amu*angstrom^2'), symmetry=1, barrier=(13.3963,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.583229,'amu*angstrom^2'), symmetry=1, barrier=(13.4096,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (85.0813,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.91127,0.049258,-5.44386e-05,3.76882e-08,-1.12679e-11,26180.5,20.8075], Tmin=(100,'K'), Tmax=(796.079,'K')), NASAPolynomial(coeffs=[6.37168,0.0268462,-1.22097e-05,2.32433e-09,-1.62253e-13,25470.3,0.305817], Tmin=(796.079,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(217.076,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(ROOJ)"""),
)
...
species(
    ...
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.49408,0.0435504,-6.16583e-06,-2.54423e-08,1.31375e-11,19014.6,23.3619], Tmin=(100,'K'), Tmax=(1001.13,'K')), NASAPolynomial(coeffs=[14.4943,0.0178759,-7.05454e-06,1.35799e-09,-9.97508e-14,15095.3,-45.9456], Tmin=(1001.13,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(157.262,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(C=CCJO) + radical(Allyl_P)"""),
)
...
species(
    label = 'C=[C][CH]COO(20914)',
    structure = SMILES('C=[C][CH]COO'),
    E0 = (249.914,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2950,3100,1380,975,1025,1650,1685,370,3615,1310,387.5,850,1000,3025,407.5,1350,352.5,257.534,257.537],'cm^-1')),
        HinderedRotor(inertia=(0.531022,'amu*angstrom^2'), symmetry=1, barrier=(24.9935,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.00026,'amu*angstrom^2'), symmetry=1, barrier=(47.0775,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.00025,'amu*angstrom^2'), symmetry=1, barrier=(47.0774,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.531036,'amu*angstrom^2'), symmetry=1, barrier=(24.9936,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
...
species(
    label = '[CH]=C[CH]COO(20915)',
    structure = SMILES('[CH]C=CCOO'),
    E0 = (259.152,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3615,1310,387.5,850,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,354.532,354.533,354.534,354.628],'cm^-1')),
        HinderedRotor(inertia=(0.57728,'amu*angstrom^2'), symmetry=1, barrier=(51.4876,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.576845,'amu*angstrom^2'), symmetry=1, barrier=(51.4868,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.577287,'amu*angstrom^2'), symmetry=1, barrier=(51.4881,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.577096,'amu*angstrom^2'), symmetry=1, barrier=(51.4873,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.78351,0.0512614,-3.44455e-05,1.22576e-08,-1.9079e-12,31246,22.5462], Tmin=(100,'K'), Tmax=(1381.78,'K')), NASAPolynomial(coeffs=[8.04348,0.0331398,-1.47734e-05,2.76635e-09,-1.90673e-13,29516.1,-9.67883], Tmin=(1381.78,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(259.152,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[O]OCC1[CH]C1(20916)',
    structure = SMILES('[O]OCC1[CH]C1'),
    E0 = (298.846,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.96823,0.0384193,-1.47936e-05,-3.69207e-09,2.97276e-12,36021.2,22.7462], Tmin=(100,'K'), Tmax=(1130.86,'K')), NASAPolynomial(coeffs=[9.28283,0.0234881,-9.5016e-06,1.74396e-09,-1.20417e-13,33667.2,-16.5354], Tmin=(1130.86,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(298.846,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + ring(Cyclopropane) + radical(cyclopropane) + radical(ROOJ)"""),
)

species(
    label = '[CH]1[CH]COOC1(20917)',
    structure = SMILES('[CH]1[CH]COOC1'),
    E0 = (244.374,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.22349,0.0256329,4.21651e-05,-7.96383e-08,3.56694e-11,29468.2,19.5982], Tmin=(100,'K'), Tmax=(884.886,'K')), NASAPolynomial(coeffs=[12.6155,0.0151153,-1.80707e-06,5.03835e-11,1.21428e-15,26201.6,-37.3316], Tmin=(884.886,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(244.374,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(282.692,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + ring(12dioxane) + radical(CCJCOOH) + radical(CCJCOOH)"""),
)

species(
    label = 'C=CC=COO(20918)',
    ...
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.28424,0.0488455,-1.92603e-05,-1.74228e-08,1.22539e-11,1265.09,21.6444], Tmin=(100,'K'), Tmax=(954.217,'K')), NASAPolynomial(coeffs=[16.1589,0.0127703,-3.85996e-06,6.78153e-10,-4.98078e-14,-2770,-55.6891], Tmin=(954.217,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(9.62343,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsOsH) + group(Cds-CdsHH)"""),
)

species(
    label = 'C=C=CCOO(20919)',
    ...
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.79453,0.0511701,-4.40421e-05,2.10615e-08,-4.32363e-12,7903.47,20.4635], Tmin=(100,'K'), Tmax=(1120.4,'K')), NASAPolynomial(coeffs=[8.33387,0.0278237,-1.27856e-05,2.46312e-09,-1.73676e-13,6438.13,-11.8285], Tmin=(1120.4,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(65.0716,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cdd-CdsCds)"""),
)
...
species(
    ...
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.24162,0.0426388,-2.74811e-05,9.35271e-09,-1.41424e-12,39718.9,19.619], Tmin=(100,'K'), Tmax=(1374.4,'K')), NASAPolynomial(coeffs=[6.65498,0.0297943,-1.34629e-05,2.55307e-09,-1.77404e-13,38505.8,-3.07642], Tmin=(1374.4,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(329.747,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(12dioxetane) + radical(CCJCOOH) + radical(RCCJ)"""),
)
...
species(
    label = '[CH2]C=[C]COO(20921)',
    structure = SMILES('[CH2]C=[C]COO'),
    E0 = (277.808,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,1685,370,3615,1310,387.5,850,1000,3000,3100,440,815,1455,1000,3010,987.5,1337.5,450,1655,180],'cm^-1')),
        HinderedRotor(inertia=(1.62839,'amu*angstrom^2'), symmetry=1, barrier=(37.4398,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00684698,'amu*angstrom^2'), symmetry=1, barrier=(13.4574,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.585053,'amu*angstrom^2'), symmetry=1, barrier=(13.4515,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.63105,'amu*angstrom^2'), symmetry=1, barrier=(60.493,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.7142,0.0536444,-5.09498e-05,2.78149e-08,-6.52987e-12,33492.1,22.4582], Tmin=(100,'K'), Tmax=(994.1,'K')), NASAPolynomial(coeffs=[7.91435,0.0286971,-1.33073e-05,2.57145e-09,-1.81668e-13,32259.4,-7.41736], Tmin=(994.1,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(277.808,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Cds_S) + radical(Allyl_P)"""),
)
...
species(
    label = 'C1=CCOC1(20922)',
    structure = SMILES('C1=CCOC1'),
    E0 = (-79.5852,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (70.0898,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.07629,0.00564055,7.27085e-05,-9.36039e-08,3.47929e-11,-9525.42,12.8131], Tmin=(100,'K'), Tmax=(966.726,'K')), NASAPolynomial(coeffs=[8.741,0.0195847,-6.93211e-06,1.31783e-09,-9.86182e-14,-12367.5,-23.359], Tmin=(966.726,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-79.5852,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(257.749,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)OsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(25dihydrofuran)"""),
)
...
species(
    label = 'C1=CCOOC1(20582)',
    structure = SMILES('C1=CCOOC1'),
    E0 = (-31.5411,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.61744,0.0130145,7.09128e-05,-9.91536e-08,3.79972e-11,-3728.07,14.0674], Tmin=(100,'K'), Tmax=(967.349,'K')), NASAPolynomial(coeffs=[11.7602,0.0191465,-6.72618e-06,1.30619e-09,-1.00015e-13,-7552.66,-40.3632], Tmin=(967.349,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-31.5411,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(282.692,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-(Cds-Cds)OsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(36dihydro12dioxin)"""),
)
...
reaction(
    ...
    products = ['[CH2]C=CCO[O](18411)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(520,'cm^3/(mol*s)'), n=3.01, Ea=(98.7424,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""Matched reaction 2810 C4H6 + O2 <=> C4H6O2 in R_Addition_MultipleBond/training
This reaction matched rate rule [Cds-HH_Cds-CdH;O2b]
family: R_Addition_MultipleBond"""),
)

reaction(
    label = 'reaction2',
    reactants = ['[CH2]C=CCO[O](18411)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(5e+12,'s^-1'), n=0, Ea=(18.0629,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""Exact match found for rate rule [RJJ]
Euclidian distance = 0
family: 1,4_Linear_birad_scission
Ea raised from 0.0 to 18.1 kJ/mol to match endothermicity of reaction."""),
)
...
reaction(
    label = 'reaction19',
    reactants = ['O(4)', 'C=C[CH]C[O](19517)'],
    products = ['[CH2]C=CCO[O](18411)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2]O[O](92)', '[CH]=C[CH2](2461)'],
    products = ['[CH2]C=CCO[O](18411)'],
...
reaction(
    label = 'reaction29',
    reactants = ['CH2(19)', '[CH]=CCO[O](9645)'],
    products = ['[CH2]C=CCO[O](18411)'],
