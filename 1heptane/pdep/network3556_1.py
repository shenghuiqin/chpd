...
species(
    label = '[CH2]C1CC(CC)C1[CH2](19173)',
    ...
    molecularWeight = (110.197,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.563305,0.054972,4.38933e-05,-9.45099e-08,4.02806e-11,36439.7,31.822], Tmin=(100,'K'), Tmax=(949.687,'K')), NASAPolynomial(coeffs=[16.3686,0.0396809,-1.29492e-05,2.24949e-09,-1.58014e-13,31125.2,-55.7883], Tmin=(949.687,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(301.792,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(515.497,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Cyclobutane) + radical(Isobutyl) + radical(Isobutyl)"""),
)
...
species(
    ...
    molecularWeight = (109.189,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0406846,0.0813277,-5.6245e-05,2.10125e-08,-3.29343e-12,24392.8,33.1231], Tmin=(100,'K'), Tmax=(1457.64,'K')), NASAPolynomial(coeffs=[14.016,0.0429768,-1.6779e-05,2.96207e-09,-1.97565e-13,20318.7,-39.5656], Tmin=(1457.64,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(201.591,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(486.397,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)CsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]C(C=C)CC=CC(19267)',
    ...
    molecularWeight = (109.189,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0987252,0.0748721,-3.50048e-05,-1.89579e-09,4.72424e-12,24325,34.6336], Tmin=(100,'K'), Tmax=(1077.18,'K')), NASAPolynomial(coeffs=[13.9708,0.0423918,-1.62776e-05,2.9162e-09,-1.99287e-13,20232.3,-38.4476], Tmin=(1077.18,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(201.005,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(486.397,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Isobutyl)"""),
)
...
species(
    ...
    molecularWeight = (110.197,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.153314,0.0801971,-5.08637e-05,1.74618e-08,-2.55489e-12,33807.5,37.1332], Tmin=(100,'K'), Tmax=(1519.61,'K')), NASAPolynomial(coeffs=[12.6324,0.0473488,-1.8439e-05,3.23668e-09,-2.14608e-13,30014.9,-28.2928], Tmin=(1519.61,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(279.914,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(RCCJC) + radical(Isobutyl)"""),
)
...
species(
    ...
    molecularWeight = (110.197,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.468756,0.0858388,-5.84405e-05,2.10064e-08,-3.09829e-12,35136,38.4395], Tmin=(100,'K'), Tmax=(1575.8,'K')), NASAPolynomial(coeffs=[17.6316,0.0398929,-1.47045e-05,2.50311e-09,-1.62738e-13,29431.6,-57.1153], Tmin=(1575.8,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(290.714,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(RCCJ) + radical(Isobutyl)"""),
)
...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.500241,0.0877929,-6.21614e-05,2.34579e-08,-3.6392e-12,40169.4,37.1618], Tmin=(100,'K'), Tmax=(1503.51,'K')), NASAPolynomial(coeffs=[17.2274,0.0406296,-1.51082e-05,2.5942e-09,-1.7004e-13,34838.6,-55.5934], Tmin=(1503.51,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(332.564,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_P) + radical(Isobutyl)"""),
)
...
species(
    label = '[CH2]C(C)CC([CH2])C=C(19274)',
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]C(C=C)C[CH]CC(3419)'],
    products = ['[CH2]C1CC1C[CH]CC(19264)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH2]C(C=C)C[CH]CC(3419)'],
    products = ['[CH2]C1CC(CC)C1[CH2](19173)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)', '[CH2]C(C=C)C=CCC(19266)'],
    products = ['[CH2]C(C=C)C[CH]CC(3419)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['H(3)', '[CH2]C(C=C)CC=CC(19267)'],
    products = ['[CH2]C(C=C)C[CH]CC(3419)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(1.46e+08,'cm^3/(mol*s)'), n=1.64, Ea=(5.73208,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""From training reaction 2555 used for Cds-CsH_Cds-CsH;HJ
Exact match found for rate rule [Cds-CsH_Cds-CsH;HJ]
...
reaction(
    label = 'reaction8',
    reactants = ['C2H3(30)', 'C=CC[CH]CC(368)'],
    products = ['[CH2]C(C=C)C[CH]CC(3419)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['CH3(17)', '[CH2]C(C=C)CC=C(19166)'],
    products = ['[CH2]C(C=C)C[CH]CC(3419)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]C(C=C)C[CH]CC(3419)'],
    products = ['[CH2]C([CH]CCC)C=C(3417)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2]C(C=C)C[CH]CC(3419)'],
    products = ['[CH2]C(C=C)CC[CH]C(3421)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]CCCC([CH2])C=C(3423)'],
    products = ['[CH2]C(C=C)C[CH]CC(3419)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH2]C[CH]CC(C)C=C(19271)'],
    products = ['[CH2]C(C=C)C[CH]CC(3419)'],
...
reaction(
    label = 'reaction29',
    reactants = ['CH2(S)(23)', '[CH2]C(C=C)C[CH]C(3299)'],
    products = ['[CH2]C(C=C)C[CH]CC(3419)'],
...
reaction(
    label = 'reaction33',
    reactants = ['[CH2]C(C)CC([CH2])C=C(19274)'],
    products = ['[CH2]C(C=C)C[CH]CC(3419)'],
...
reaction(
    label = 'reaction36',
    reactants = ['[CH]CC(144)', '[CH2]C([CH2])C=C(2950)'],
    products = ['[CH2]C(C=C)C[CH]CC(3419)'],
