...
species(
    ...
    molecularWeight = (70.0898,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.0556,0.00891025,5.78918e-05,-7.39928e-08,2.67145e-11,-13898.6,14.1555], Tmin=(100,'K'), Tmax=(991.996,'K')), NASAPolynomial(coeffs=[7.12928,0.0227903,-8.9225e-06,1.70676e-09,-1.24562e-13,-16198,-12.9809], Tmin=(991.996,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-115.929,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(257.749,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cds-OdCsCs) + ring(Cyclobutanone)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]CC[C]=O(1020)'],
    products = ['C2H4(21)', 'CH2CO(28)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'C=CC[C]=O(2390)'],
    products = ['[CH2]CC[C]=O(1020)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction16',
    reactants = ['CH2(19)', '[CH2]C[C]=O(2129)'],
    products = ['[CH2]CC[C]=O(1020)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]C[CH2](128)', '[C]=O(361)'],
    products = ['[CH2]CC[C]=O(1020)'],
