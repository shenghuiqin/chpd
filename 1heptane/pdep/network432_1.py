species(
    label = 'CCCC[CH]CO[C]=O(888)',
    structure = SMILES('CCCC[CH]CO[C]=O'),
    E0 = (-105.155,'kJ/mol'),
    modes = [
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.305547,0.0887053,-6.66813e-05,2.60405e-08,-4.17833e-12,-12487.6,38.0924], Tmin=(100,'K'), Tmax=(1446.26,'K')), NASAPolynomial(coeffs=[17.0547,0.0406905,-1.68819e-05,3.08476e-09,-2.10151e-13,-17509.1,-52.0662], Tmin=(1446.26,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-105.155,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(478.082,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdOsH) + radical(CCJCO) + radical((O)CJOCC)"""),
)
...
species(
    label = 'CCCC=CCO[C]=O(2758)',
    structure = SMILES('CCCC=CCO[C]=O'),
    E0 = (-182.829,'kJ/mol'),
    modes = [
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0532439,0.0820766,-5.85127e-05,2.1312e-08,-3.17604e-12,-21837.8,35.7828], Tmin=(100,'K'), Tmax=(1548.22,'K')), NASAPolynomial(coeffs=[17.0967,0.0377675,-1.55833e-05,2.8263e-09,-1.91028e-13,-27148.1,-54.4517], Tmin=(1548.22,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-182.829,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-OdOsH) + radical((O)CJOCC)"""),
)

species(
    label = 'CCCCC=CO[C]=O(2759)',
    structure = SMILES('CCCCC=CO[C]=O'),
    E0 = (-203.982,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,1855,455,950,2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.797031,0.0952229,-7.9796e-05,3.41926e-08,-5.8721e-12,-24352.3,34.1879], Tmin=(100,'K'), Tmax=(1390.48,'K')), NASAPolynomial(coeffs=[20.527,0.0338801,-1.36217e-05,2.46524e-09,-1.67726e-13,-30282.4,-75.7175], Tmin=(1390.48,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-203.982,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-OdOsH) + radical((O)CJOC)"""),
)
...
species(
    label = 'CCC[CH]CCO[C]=O(2760)',
    structure = SMILES('CCC[CH]CCO[C]=O'),
    E0 = (-110.599,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,1855,455,950,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (128.169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.304991,0.087666,-7.49078e-05,3.93923e-08,-9.39208e-12,-13174.3,35.9876], Tmin=(100,'K'), Tmax=(952.879,'K')), NASAPolynomial(coeffs=[7.76392,0.0563554,-2.56202e-05,4.90951e-09,-3.45235e-13,-14595.8,0.362481], Tmin=(952.879,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-110.599,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(478.082,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdOsH) + radical((O)CJOCC) + radical(RCCJCC)"""),
)
...
species(
    label = 'CCCC[CH][CH]OC=O(2761)',
    structure = SMILES('CCCC[CH][CH]OC=O'),
    E0 = (-108.158,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.489224,0.0914267,-6.97489e-05,2.7332e-08,-4.3679e-12,-12841.1,38.6694], Tmin=(100,'K'), Tmax=(1460.37,'K')), NASAPolynomial(coeffs=[18.4407,0.0395771,-1.64923e-05,3.02012e-09,-2.05965e-13,-18370.1,-59.8251], Tmin=(1460.37,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-108.158,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(478.082,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdOsH) + radical(CCsJOC(O)H) + radical(CCJCO)"""),
)

species(
    label = 'CC[CH]CCCO[C]=O(2762)',
    structure = SMILES('CC[CH]CCCO[C]=O'),
    E0 = (-110.599,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,1855,455,950,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (128.169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.304991,0.087666,-7.49078e-05,3.93923e-08,-9.39208e-12,-13174.3,35.9876], Tmin=(100,'K'), Tmax=(952.879,'K')), NASAPolynomial(coeffs=[7.76392,0.0563554,-2.56202e-05,4.90951e-09,-3.45235e-13,-14595.8,0.362481], Tmin=(952.879,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-110.599,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(478.082,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdOsH) + radical(RCCJCC) + radical((O)CJOCC)"""),
)

species(
    label = 'C[CH]CCCCO[C]=O(2763)',
    structure = SMILES('C[CH]CCCCO[C]=O'),
    E0 = (-110.611,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.249146,0.0875588,-7.16594e-05,3.43529e-08,-7.29585e-12,-13172.6,36.3495], Tmin=(100,'K'), Tmax=(1068.09,'K')), NASAPolynomial(coeffs=[9.33072,0.053548,-2.3895e-05,4.53971e-09,-3.1763e-13,-15112.6,-8.06197], Tmin=(1068.09,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-110.611,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(478.082,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdOsH) + radical(RCCJC) + radical((O)CJOCC)"""),
)

species(
    label = '[CH2]CCCCCO[C]=O(2764)',
    structure = SMILES('[CH2]CCCCCO[C]=O'),
    E0 = (-99.8108,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (128.169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.117899,0.0906716,-7.2282e-05,3.09781e-08,-5.58082e-12,-11856.6,36.7044], Tmin=(100,'K'), Tmax=(1278.68,'K')), NASAPolynomial(coeffs=[14.1015,0.0461902,-2.01016e-05,3.77287e-09,-2.61818e-13,-15493,-35.3916], Tmin=(1278.68,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-99.8108,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(478.082,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdOsH) + radical(RCCJ) + radical((O)CJOCC)"""),
)

species(
    label = 'CCC[CH][CH]COC=O(2765)',
    structure = SMILES('CCC[CH][CH]COC=O'),
    E0 = (-108.379,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.976145,0.0739038,-4.07827e-05,1.04531e-08,-1.08065e-12,-12934.9,36.3718], Tmin=(100,'K'), Tmax=(2035.39,'K')), NASAPolynomial(coeffs=[15.4166,0.0455251,-1.98689e-05,3.60301e-09,-2.39282e-13,-18813.3,-43.5579], Tmin=(2035.39,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-108.379,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(478.082,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdOsH) + radical(RCCJCC) + radical(CCJCO)"""),
)

species(
    label = 'CC[CH]C[CH]COC=O(2766)',
    structure = SMILES('CC[CH]C[CH]COC=O'),
    E0 = (-108.379,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.169,'amu'),
...
species(
    label = 'C[CH]CC[CH]COC=O(2767)',
    structure = SMILES('C[CH]CC[CH]COC=O'),
    E0 = (-108.391,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.69786,0.0760367,-4.39281e-05,1.21858e-08,-1.38732e-12,-12922.2,37.5623], Tmin=(100,'K'), Tmax=(1869.64,'K')), NASAPolynomial(coeffs=[14.6862,0.0461092,-1.99175e-05,3.62417e-09,-2.42502e-13,-18152.8,-38.6765], Tmin=(1869.64,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-108.391,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(478.082,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdOsH) + radical(RCCJC) + radical(CCJCO)"""),
)

species(
    label = '[CH2]CCC[CH]COC=O(2768)',
    structure = SMILES('[CH2]CCC[CH]COC=O'),
    E0 = (-97.5906,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (128.169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0300823,0.0820585,-5.23142e-05,1.63299e-08,-2.07359e-12,-11590.9,39.0467], Tmin=(100,'K'), Tmax=(1770.35,'K')), NASAPolynomial(coeffs=[18.3401,0.0406883,-1.72617e-05,3.1301e-09,-2.09589e-13,-18074,-59.7469], Tmin=(1770.35,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-97.5906,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(478.082,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdOsH) + radical(CCJCO) + radical(RCCJ)"""),
)
...
species(
    label = 'CCCCC=COC=O(895)',
    structure = SMILES('CCCCC=COC=O'),
    E0 = (-400.431,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.623117,0.0878884,-5.32854e-05,8.17372e-09,2.42514e-12,-47982.7,34.936], Tmin=(100,'K'), Tmax=(1122.55,'K')), NASAPolynomial(coeffs=[19.3082,0.0383442,-1.57813e-05,2.94441e-09,-2.06037e-13,-53810.7,-69.5524], Tmin=(1122.55,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-400.431,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(482.239,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-OdOsH)"""),
)

species(
    label = 'CCCC=CCOC=O(2769)',
    structure = SMILES('CCCC=CCOC=O'),
    E0 = (-380.51,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.00478853,0.0773475,-4.18467e-05,8.70117e-09,-2.11137e-13,-45611.8,36.0047], Tmin=(100,'K'), Tmax=(1465.59,'K')), NASAPolynomial(coeffs=[17.3562,0.0418257,-1.76306e-05,3.20784e-09,-2.16039e-13,-51974.5,-58.7346], Tmin=(1465.59,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-380.51,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(482.239,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-OdOsH)"""),
)
...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.251915,0.0748802,-5.58091e-05,2.13881e-08,-3.33629e-12,-9646.14,33.8527], Tmin=(100,'K'), Tmax=(1497.73,'K')), NASAPolynomial(coeffs=[16.2405,0.0321793,-1.30435e-05,2.35229e-09,-1.58842e-13,-14435.4,-49.7414], Tmin=(1497.73,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-81.3748,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(407.409,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdOsH) + radical((O)CJOCC) + radical(CCJCO)"""),
)

species(
    label = '[CH2]C(CCC)CO[C]=O(2770)',
    structure = SMILES('[CH2]C(CCC)CO[C]=O'),
    E0 = (-105.669,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (128.169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.41126,0.0924497,-7.58291e-05,3.37209e-08,-6.19475e-12,-12546.6,37.4743], Tmin=(100,'K'), Tmax=(1280.64,'K')), NASAPolynomial(coeffs=[15.6924,0.0421496,-1.69116e-05,3.04919e-09,-2.07033e-13,-16671.1,-44.1996], Tmin=(1280.64,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-105.669,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(478.082,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdOsH) + radical((O)CJOCC) + radical(Isobutyl)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'CCCC=CCO[C]=O(2758)'],
    products = ['CCCC[CH]CO[C]=O(888)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'CCCCC=CO[C]=O(2759)'],
    products = ['CCCC[CH]CO[C]=O(888)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['npropyl(83)', 'C=CCO[C]=O(2483)'],
    products = ['CCCC[CH]CO[C]=O(888)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction13',
    reactants = ['CCCC[CH]CO[C]=O(888)'],
    products = ['CC[CH]C[CH]COC=O(2766)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CCCC[CH]CO[C]=O(888)'],
    products = ['C[CH]CC[CH]COC=O(2767)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]CCC[CH]COC=O(2768)'],
    products = ['CCCC[CH]CO[C]=O(888)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CH2(S)(23)', 'CCC[CH]CO[C]=O(906)'],
    products = ['CCCC[CH]CO[C]=O(888)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2]C(CCC)CO[C]=O(2770)'],
    products = ['CCCC[CH]CO[C]=O(888)'],
...
reaction(
    label = 'reaction22',
    reactants = ['CO(12)', 'CCCC[CH]C[O](1762)'],
    products = ['CCCC[CH]CO[C]=O(888)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[C]=O(361)', 'CCCC[CH]C[O](1762)'],
    products = ['CCCC[CH]CO[C]=O(888)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[CH]CCCC(141)', '[CH2]O[C]=O(2123)'],
    products = ['CCCC[CH]CO[C]=O(888)'],
