...
species(
    label = 'C#COC(C)[O](3216)',
    structure = SMILES('C#COC(C)[O]'),
    E0 = (49.2936,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2175,525,750,770,3400,2100,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,288.244,288.345,288.493],'cm^-1')),
        HinderedRotor(inertia=(0.404377,'amu*angstrom^2'), symmetry=1, barrier=(23.8531,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.404175,'amu*angstrom^2'), symmetry=1, barrier=(23.8528,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.403791,'amu*angstrom^2'), symmetry=1, barrier=(23.8537,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (85.0813,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.22169,0.0555526,-5.25065e-05,2.45274e-08,-4.50692e-12,6033.3,20.1369], Tmin=(100,'K'), Tmax=(1318.95,'K')), NASAPolynomial(coeffs=[14.6104,0.0149483,-6.32856e-06,1.18661e-09,-8.28009e-14,2501.48,-48.1625], Tmin=(1318.95,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(49.2936,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Ct-CtOs) + group(Ct-CtH) + radical(CCOJ)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'C=[C]OC(C)=O(3215)'],
    products = ['C=[C]OC(C)[O](1084)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['CH3(17)', 'C=[C]OC=O(2719)'],
    products = ['C=[C]OC(C)[O](1084)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction14',
    reactants = ['CH2(S)(23)', 'C=[C]OC[O](940)'],
    products = ['C=[C]OC(C)[O](1084)'],
