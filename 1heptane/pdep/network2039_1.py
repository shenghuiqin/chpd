species(
    label = '[CH2]C(CCCC)O[CH]CC(10729)',
    structure = SMILES('[CH2]C(CCCC)O[CH]CC'),
    E0 = (-11.859,'kJ/mol'),
    modes = [
...
species(
    label = 'C=C(CCCC)O[CH]CC(10909)',
    structure = SMILES('C=C(CCCC)O[CH]CC'),
    E0 = (-127.357,'kJ/mol'),
    modes = [
...
species(
    label = '[CH2]C(CCCC)OC=CC(10910)',
    structure = SMILES('[CH2]C(CCCC)OC=CC'),
    E0 = (-118.786,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (141.231,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.75028,0.131193,-0.000113874,5.10803e-08,-9.11123e-12,-14029.2,43.1159], Tmin=(100,'K'), Tmax=(1354.19,'K')), NASAPolynomial(coeffs=[27.2873,0.0424681,-1.55966e-05,2.6985e-09,-1.79387e-13,-22164.6,-110.906], Tmin=(1354.19,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-118.786,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(623.585,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(CJC(C)OC)"""),
)
...
species(
    label = '[CH2]C(CCCC)OC=C(2106)',
    structure = SMILES('[CH2]C(CCCC)OC=C'),
    E0 = (-82.7608,'kJ/mol'),
    modes = [
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.77381,0.11194,-8.15159e-05,1.8996e-08,2.71728e-12,-9732.75,37.7922], Tmin=(100,'K'), Tmax=(1010.04,'K')), NASAPolynomial(coeffs=[24.2946,0.0374864,-1.36929e-05,2.44451e-09,-1.6946e-13,-16467,-95.5015], Tmin=(1010.04,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-82.7608,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(552.912,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CJC(C)OC)"""),
)

species(
    label = 'CC[CH]O[C](C)CCCC(10911)',
    structure = SMILES('CC[CH]O[C](C)CCCC'),
    E0 = (-41.6652,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (142.239,'amu'),
...
species(
    label = '[CH2]C(CCCC)OC[CH]C(10912)',
    structure = SMILES('[CH2]C(CCCC)OC[CH]C'),
    E0 = (7.58707,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,3025,407.5,1350,352.5,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2][C](CCCC)OCCC(10913)',
    structure = SMILES('[CH2][C](CCCC)OCCC'),
    E0 = (-11.6112,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (142.239,'amu'),
...
species(
    label = 'CC[CH]OC(C)[CH]CCC(10914)',
    structure = SMILES('CC[CH]OC(C)[CH]CCC'),
    E0 = (-22.467,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (142.239,'amu'),
...
species(
    label = '[CH2]CCOC([CH2])CCCC(10915)',
    structure = SMILES('[CH2]CCOC([CH2])CCCC'),
    E0 = (12.9314,'kJ/mol'),
    modes = [
...
species(
    label = 'CC[CH]CC(C)O[CH]CC(10916)',
    structure = SMILES('CC[CH]CC(C)O[CH]CC'),
    E0 = (-27.9108,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (142.239,'amu'),
...
species(
    label = '[CH2]C([CH]CCC)OCCC(10917)',
    structure = SMILES('[CH2]C([CH]CCC)OCCC'),
    E0 = (7.58707,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,3025,407.5,1350,352.5,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'C[CH][CH]OC(C)CCCC(10918)',
    structure = SMILES('C[CH][CH]OC(C)CCCC'),
    E0 = (-22.467,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (142.239,'amu'),
...
species(
    label = 'C[CH]CCC(C)O[CH]CC(10919)',
    structure = SMILES('C[CH]CCC(C)O[CH]CC'),
    E0 = (-27.9228,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (142.239,'amu'),
...
species(
    label = '[CH2]C(C[CH]CC)OCCC(10920)',
    structure = SMILES('[CH2]C(C[CH]CC)OCCC'),
    E0 = (2.14332,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,3025,407.5,1350,352.5,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2]CCCC(C)O[CH]CC(10921)',
    structure = SMILES('[CH2]CCCC(C)O[CH]CC'),
    E0 = (-17.1227,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (142.239,'amu'),
...
species(
    label = '[CH2]C(CC[CH]C)OCCC(10922)',
    structure = SMILES('[CH2]C(CC[CH]C)OCCC'),
    E0 = (2.1313,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,3025,407.5,1350,352.5,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2]C[CH]OC(C)CCCC(10923)',
    structure = SMILES('[CH2]C[CH]OC(C)CCCC'),
    E0 = (-17.1227,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (142.239,'amu'),
...
species(
    label = '[CH2]CCCC([CH2])OCCC(10924)',
    structure = SMILES('[CH2]CCCC([CH2])OCCC'),
    E0 = (12.9314,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2761.11,2772.22,2783.33,2794.44,2805.56,2816.67,2827.78,2838.89,2850,1425,1431.25,1437.5,1443.75,1450,1225,1237.5,1250,1262.5,1275,1270,1287.5,1305,1322.5,1340,700,725,750,775,800,300,325,350,375,400,1380,1390,370,380,2900,435,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'C=C(CCCC)OCCC(10925)',
    structure = SMILES('C=C(CCCC)OCCC'),
    E0 = (-321.285,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (142.239,'amu'),
...
species(
    label = 'CC=COC(C)CCCC(10926)',
    structure = SMILES('CC=COC(C)CCCC'),
    E0 = (-329.296,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (142.239,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.09418,0.11503,-5.9438e-05,-6.38455e-09,1.10391e-11,-39369.3,40.9973], Tmin=(100,'K'), Tmax=(1022.7,'K')), NASAPolynomial(coeffs=[24.4392,0.0492598,-1.8719e-05,3.41131e-09,-2.38657e-13,-46784.1,-97.3243], Tmin=(1022.7,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-329.296,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(648.529,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH)"""),
)
...
species(
    label = '[CH2]C(CCCC)O[CH]C(1210)',
    structure = SMILES('[CH2]C(CCCC)O[CH]C'),
    E0 = (11.9213,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3025,407.5,1350,352.5,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2]C(C)OC([CH2])CCCC(10928)',
    structure = SMILES('[CH2]C(C)OC([CH2])CCCC'),
    E0 = (7.64418,'kJ/mol'),
    modes = [
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(CCCC)O[CH]CC(10729)'],
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'C=C(CCCC)O[CH]CC(10909)'],
    products = ['[CH2]C(CCCC)O[CH]CC(10729)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', '[CH2]C(CCCC)OC=CC(10910)'],
    products = ['[CH2]C(CCCC)O[CH]CC(10729)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['butyl_1(82)', 'C=CO[CH]CC(10587)'],
    products = ['[CH2]C(CCCC)O[CH]CC(10729)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['CH3(17)', '[CH2]C(CCCC)OC=C(2106)'],
    products = ['[CH2]C(CCCC)O[CH]CC(10729)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2]C(CCCC)O[CH]CC(10729)'],
    products = ['CC[CH]O[C](C)CCCC(10911)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]C(CCCC)OC[CH]C(10912)'],
    products = ['[CH2]C(CCCC)O[CH]CC(10729)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]C(CCCC)O[CH]CC(10729)'],
    products = ['[CH2][C](CCCC)OCCC(10913)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]C(CCCC)O[CH]CC(10729)'],
    products = ['CC[CH]OC(C)[CH]CCC(10914)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]CCOC([CH2])CCCC(10915)'],
    products = ['[CH2]C(CCCC)O[CH]CC(10729)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]C(CCCC)O[CH]CC(10729)'],
    products = ['CC[CH]CC(C)O[CH]CC(10916)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2]C([CH]CCC)OCCC(10917)'],
    products = ['[CH2]C(CCCC)O[CH]CC(10729)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]C(CCCC)O[CH]CC(10729)'],
    products = ['C[CH][CH]OC(C)CCCC(10918)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]C(CCCC)O[CH]CC(10729)'],
    products = ['C[CH]CCC(C)O[CH]CC(10919)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]C(C[CH]CC)OCCC(10920)'],
    products = ['[CH2]C(CCCC)O[CH]CC(10729)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]C(CCCC)O[CH]CC(10729)'],
    products = ['[CH2]CCCC(C)O[CH]CC(10921)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2]C(CC[CH]C)OCCC(10922)'],
    products = ['[CH2]C(CCCC)O[CH]CC(10729)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2]C(CCCC)O[CH]CC(10729)'],
    products = ['[CH2]C[CH]OC(C)CCCC(10923)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2]CCCC([CH2])OCCC(10924)'],
    products = ['[CH2]C(CCCC)O[CH]CC(10729)'],
...
reaction(
    label = 'reaction24',
    reactants = ['CH2(S)(23)', '[CH2]C(CCC)O[CH]CC(10735)'],
    products = ['[CH2]C(CCCC)O[CH]CC(10729)'],
...
reaction(
    label = 'reaction25',
    reactants = ['CH2(S)(23)', '[CH2]C(CCCC)O[CH]C(1210)'],
    products = ['[CH2]C(CCCC)O[CH]CC(10729)'],
...
reaction(
    label = 'reaction27',
    reactants = ['[CH2]C(C)OC([CH2])CCCC(10928)'],
    products = ['[CH2]C(CCCC)O[CH]CC(10729)'],
...
reaction(
    label = 'reaction29',
    reactants = ['[CH]CC(144)', '[CH2]C([O])CCCC(1842)'],
    products = ['[CH2]C(CCCC)O[CH]CC(10729)'],
