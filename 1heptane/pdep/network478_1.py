...
species(
    ...
    molecularWeight = (60.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.14404,0.0161339,3.97574e-06,-9.75402e-09,3.12595e-12,-1856.7,8.16056], Tmin=(100,'K'), Tmax=(1249.43,'K')), NASAPolynomial(coeffs=[4.88616,0.0182404,-7.77809e-06,1.43977e-09,-9.87317e-14,-2891.78,-3.03222], Tmin=(1249.43,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-15.7111,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(182.918,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + ring(12dioxetane)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]OO[CH2](934)'],
    products = ['CH2O(15)', 'CH2O(15)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2][O](167)', '[CH2][O](167)'],
    products = ['[CH2]OO[CH2](934)'],
    transitionState = 'TS2',
