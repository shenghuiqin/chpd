...
species(
    label = '[CH2]OC(CC)C(=O)C([CH2])C(7554)',
    structure = SMILES('[CH2]OC(CC)C(=O)C([CH2])C'),
    E0 = (-91.972,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,375,552.5,462.5,1710,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (142.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.22681,0.119506,-0.000118287,6.5074e-08,-1.49307e-11,-10877.2,41.3606], Tmin=(100,'K'), Tmax=(1033.49,'K')), NASAPolynomial(coeffs=[15.4291,0.0550421,-2.47257e-05,4.72152e-09,-3.31692e-13,-14320,-39.5434], Tmin=(1033.49,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-91.972,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(548.755,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-O2d)CsCsH) + group(Cs-(Cds-O2d)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + group(Cds-OdCsCs) + radical(CsJOCC2) + radical(CJC(C)C=O)"""),
)

species(
    label = '[CH2]C(C)C(=O)CO[CH]CC(7555)',
    structure = SMILES('[CH2]C(C)C(=O)CO[CH]CC'),
    E0 = (-82.6038,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (142.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.62897,0.131413,-0.000155014,1.04907e-07,-2.94059e-11,-9738.95,40.4927], Tmin=(100,'K'), Tmax=(859.756,'K')), NASAPolynomial(coeffs=[14.2473,0.0575475,-2.61408e-05,4.97504e-09,-3.47337e-13,-12468.9,-33.7019], Tmin=(859.756,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-82.6038,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(548.755,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-O2d)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-O2d)OsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdCsCs) + radical(CJC(C)C=O) + radical(CCsJOCs)"""),
)
...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.554439,0.0867679,-2.97449e-05,-2.54662e-08,1.78055e-11,-9938.65,35.7545], Tmin=(100,'K'), Tmax=(930.505,'K')), NASAPolynomial(coeffs=[17.4622,0.0431496,-1.3967e-05,2.30232e-09,-1.52885e-13,-14756.2,-57.7378], Tmin=(930.505,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-84.1001,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(540.441,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + ring(Oxetane) + radical(C=CC(C)2OJ)"""),
)
...
species(
    label = 'CCC1OCC1([O])[C](C)C(7558)',
    structure = SMILES('CCC1OCC1([O])[C](C)C'),
    E0 = (-45.8693,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (142.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.729407,0.0880163,-1.99629e-05,-3.98474e-08,2.35936e-11,-5331.87,34.0404], Tmin=(100,'K'), Tmax=(932.223,'K')), NASAPolynomial(coeffs=[18.9164,0.0440338,-1.40603e-05,2.32077e-09,-1.55377e-13,-10746.5,-68.7559], Tmin=(932.223,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-45.8693,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(561.227,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Oxetane) + radical(CC(C)2OJ) + radical(CCJ(C)CO)"""),
)
...
species(
    label = 'CCC1O[CH]C1([O])C(C)C(7562)',
    structure = SMILES('CCC1O[CH]C1([O])C(C)C'),
    E0 = (-17.9872,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (142.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.26918,0.101256,-4.8793e-05,-1.89335e-08,1.88546e-11,-1960.01,35.2305], Tmin=(100,'K'), Tmax=(908.413,'K')), NASAPolynomial(coeffs=[21.9925,0.0386528,-1.118e-05,1.72261e-09,-1.11348e-13,-7829.44,-83.8034], Tmin=(908.413,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-17.9872,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(561.227,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Oxetane) + radical(CC(C)2OJ) + radical(CCsJOCs)"""),
)
...
species(
    label = 'C[CH]C1OCC1([O])C(C)C(7565)',
    structure = SMILES('C[CH]C1OCC1([O])C(C)C'),
    E0 = (1.45885,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (142.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.801684,0.0893815,-2.23694e-05,-4.01388e-08,2.46141e-11,363.301,36.6018], Tmin=(100,'K'), Tmax=(922.952,'K')), NASAPolynomial(coeffs=[19.9159,0.0414985,-1.26541e-05,2.03743e-09,-1.35273e-13,-5245.79,-71.3565], Tmin=(922.952,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(1.45885,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(561.227,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Oxetane) + radical(CCJCO) + radical(CC(C)2OJ)"""),
)
...
species(
    label = '[CH2]CC1OCC1([O])C(C)C(7567)',
    structure = SMILES('[CH2]CC1OCC1([O])C(C)C'),
    E0 = (6.80315,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2950,3150,900,1000,1100,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,2750,2850,1437.5,1250,1305,750,350,300,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (142.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.955216,0.0952895,-4.13389e-05,-1.84811e-08,1.6337e-11,1009.2,36.4426], Tmin=(100,'K'), Tmax=(928.075,'K')), NASAPolynomial(coeffs=[19.1426,0.0435037,-1.3943e-05,2.28362e-09,-1.51153e-13,-4221.48,-67.0999], Tmin=(928.075,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(6.80315,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(561.227,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Oxetane) + radical(CC(C)2OJ) + radical(RCCJ)"""),
)
...
species(
    label = '[CH2]C(C)C1([O])COC1C(7570)',
    structure = SMILES('[CH2]C(C)C1([O])COC1C'),
    E0 = (30.4194,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,2750,2950,3150,900,1000,1100,300,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (128.169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.208104,0.0799377,-2.36294e-05,-3.5035e-08,2.36038e-11,3822.09,32.2102], Tmin=(100,'K'), Tmax=(883.027,'K')), NASAPolynomial(coeffs=[17.9881,0.0344234,-9.01682e-06,1.27191e-09,-7.7793e-14,-830.539,-61.4608], Tmin=(883.027,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(30.4194,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(490.554,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Oxetane) + radical(CC(C)2OJ) + radical(Isobutyl)"""),
)
...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.005933,0.0774739,-4.17629e-05,-1.71444e-09,6.89679e-12,2725.51,34.5131], Tmin=(100,'K'), Tmax=(981.063,'K')), NASAPolynomial(coeffs=[15.9049,0.0354713,-1.25086e-05,2.16671e-09,-1.47e-13,-1496.96,-47.5522], Tmin=(981.063,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(21.3836,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + radical(Isobutyl) + radical(C=C(C)OJ)"""),
)
...
species(
    label = '[CH2]C(C)[C]1COC1CC(7573)',
    structure = SMILES('[CH2]C(C)[C]1COC1CC'),
    E0 = (111.71,'kJ/mol'),
    modes = [
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.124401,0.0680768,1.97645e-05,-7.64644e-08,3.65683e-11,13591.1,33.6795], Tmin=(100,'K'), Tmax=(908.391,'K')), NASAPolynomial(coeffs=[16.3587,0.0419647,-1.20418e-05,1.86502e-09,-1.21881e-13,8769.6,-53.386], Tmin=(908.391,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(111.71,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(536.283,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Oxetane) + radical(CCJ(C)CO) + radical(Isobutyl)"""),
)
...
species(
    label = 'C[CH]C1([O])COC1CC(5589)',
    structure = SMILES('C[CH]C1([O])COC1CC'),
    E0 = (34.2806,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3025,407.5,1350,352.5,2750,2950,3150,900,1000,1100,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,300,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (128.169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.119677,0.0765284,-1.64071e-05,-3.88911e-08,2.33112e-11,4284.41,32.8833], Tmin=(100,'K'), Tmax=(912.217,'K')), NASAPolynomial(coeffs=[17.7785,0.0354424,-1.03396e-05,1.61417e-09,-1.05572e-13,-536.933,-60.3489], Tmin=(912.217,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(34.2806,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(490.554,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Oxetane) + radical(CCJCO) + radical(CC(C)2OJ)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]OC(CC)C(=O)C([CH2])C(7554)'],
    products = ['[CH2]C(C)C1([O])COC1CC(7408)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(1.46159e+06,'s^-1'), n=1.55572, Ea=(98.6111,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R5_SS;multiplebond_intra;radadd_intra_cs2H] for rate rule [R5_SS_CO;carbonylbond_intra_Nd;radadd_intra_cs2H]
Euclidian distance = 2.2360679775
family: Intra_R_Add_Exocyclic
Ea raised from 95.0 to 98.6 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction3',
    reactants = ['[CH2]C(C)C(=O)CO[CH]CC(7555)'],
    products = ['[CH2]C(C)C1([O])COC1CC(7408)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(2.13771e+06,'s^-1'), n=1.58803, Ea=(89.2429,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R5_SS;multiplebond_intra;radadd_intra_csHNd] for rate rule [R5_SS_CO;carbonylbond_intra_Nd;radadd_intra_csHNd]
Euclidian distance = 2.2360679775
family: Intra_R_Add_Exocyclic
Ea raised from 84.2 to 89.2 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction4',
    reactants = ['H(3)', 'C=C(C)C1([O])COC1CC(7556)'],
    products = ['[CH2]C(C)C1([O])COC1CC(7408)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['CH3(17)', 'C=CC1([O])COC1CC(7557)'],
    products = ['[CH2]C(C)C1([O])COC1CC(7408)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]C(C)C1([O])COC1CC(7408)'],
    products = ['CCC1OCC1([O])[C](C)C(7558)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]C(C)C1([O])COC1CC(7408)'],
    products = ['[CH2]C(C)C1(O)[CH]OC1CC(7560)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2]C(C)C1([O])COC1CC(7408)'],
    products = ['CCC1O[CH]C1([O])C(C)C(7562)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]C(C)C1([O])COC1CC(7408)'],
    products = ['[CH2]C(C)C1(O)COC1[CH]C(7564)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]C(C)C1([O])COC1CC(7408)'],
    products = ['C[CH]C1OCC1([O])C(C)C(7565)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]C(C)C1([O])COC1CC(7408)'],
    products = ['[CH2]CC1OCC1(O)C([CH2])C(7566)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2]CC1OCC1([O])C(C)C(7567)'],
    products = ['[CH2]C(C)C1([O])COC1CC(7408)'],
...
reaction(
    label = 'reaction21',
    reactants = ['CH2(S)(23)', '[CH2]CC1([O])COC1CC(7569)'],
    products = ['[CH2]C(C)C1([O])COC1CC(7408)'],
...
reaction(
    label = 'reaction22',
    reactants = ['CH2(S)(23)', '[CH2]C(C)C1([O])COC1C(7570)'],
    products = ['[CH2]C(C)C1([O])COC1CC(7408)'],
...
reaction(
    label = 'reaction26',
    reactants = ['C2H5CHO(70)', '[CH2]C(C)C(=C)[O](1151)'],
    products = ['[CH2]C(C)C1([O])COC1CC(7408)'],
...
reaction(
    label = 'reaction27',
    reactants = ['CH2O(15)', '[CH2]C(C)C([O])=CCC(7572)'],
    products = ['[CH2]C(C)C1([O])COC1CC(7408)'],
...
reaction(
    label = 'reaction28',
    reactants = ['O(4)', '[CH2]C(C)[C]1COC1CC(7573)'],
    products = ['[CH2]C(C)C1([O])COC1CC(7408)'],
...
reaction(
    label = 'reaction29',
    reactants = ['CH2(19)', 'C[CH]C1([O])COC1CC(5589)'],
    products = ['[CH2]C(C)C1([O])COC1CC(7408)'],
