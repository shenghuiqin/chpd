...
species(
    label = '[CH2][C]1CO1(2367)',
    structure = SMILES('[CH2][C]1CO1'),
    E0 = (284.409,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,3150,900,1100,3000,3100,440,815,1455,1000,180,180,1265.71,1265.76,1266.96,1267.05,2933.07],'cm^-1')),
...
species(
    label = '[CH2]C1[CH]O1(2368)',
    structure = SMILES('[CH2]C1[CH]O1'),
    E0 = (288.027,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,3150,900,1100,3000,3100,440,815,1455,1000,180,383.424,846.27,846.298,846.378,846.39,4000],'cm^-1')),
        HinderedRotor(inertia=(0.0428408,'amu*angstrom^2'), symmetry=1, barrier=(21.774,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (56.0633,'amu'),
...
species(
    ...
    E0 = (291.144,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,231.448],'cm^-1')),
...
reaction(
    label = 'reaction1',
    reactants = ['CH2OCHCH2(566)'],
    products = ['oxiranylmethyl(1948)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction4',
    reactants = ['oxiranylmethyl(1948)'],
    products = ['C[C]1CO1(2365)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['H(3)', '[CH2]C1[CH]O1(2368)'],
    products = ['oxiranylmethyl(1948)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction13',
    reactants = ['CH2O(15)', 'C2H3(30)'],
    products = ['CH2OCHCH2(566)'],
