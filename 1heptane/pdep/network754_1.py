...
species(
    label = '[CH]=CCC=CC(3279)',
    structure = SMILES('[CH]=CCC=CC'),
    E0 = (299.82,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3120,650,792.5,1650,2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3010,3025,975,987.5,1000,1300,1337.5,1375,400,450,500,1630,1655,1680,206.257],'cm^-1')),
        HinderedRotor(inertia=(0.384451,'amu*angstrom^2'), symmetry=1, barrier=(11.5974,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.38418,'amu*angstrom^2'), symmetry=1, barrier=(11.5974,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.384078,'amu*angstrom^2'), symmetry=1, barrier=(11.5974,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.736826,'amu*angstrom^2'), symmetry=1, barrier=(16.9411,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.736696,'amu*angstrom^2'), symmetry=1, barrier=(16.9381,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.736735,'amu*angstrom^2'), symmetry=1, barrier=(16.939,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (81.1357,'amu'),
...
species(
    label = '[CH]=[C]CCCC(3284)',
    structure = SMILES('[CH]=[C]CCCC'),
    E0 = (420.856,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3120,650,792.5,1650,2750,2800,2850,1350,1500,750,1050,1375,1000,1685,370,311.614,311.692],'cm^-1')),
        HinderedRotor(inertia=(0.00173512,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.134562,'amu*angstrom^2'), symmetry=1, barrier=(9.30392,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.135606,'amu*angstrom^2'), symmetry=1, barrier=(9.30423,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.135492,'amu*angstrom^2'), symmetry=1, barrier=(9.30453,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (82.1436,'amu'),
...
reaction(
    label = 'reaction1',
    reactants = ['[CH]=CC[CH]CC(1170)'],
    products = ['butene1(127)', 'C2H2(32)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', '[CH]=CCC=CC(3279)'],
    products = ['[CH]=CC[CH]CC(1170)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['CH3(17)', '[CH]=CCC=C(2955)'],
    products = ['[CH]=CC[CH]CC(1170)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['butene1(127)', 'C2H2(T)(175)'],
    products = ['[CH]=CC[CH]CC(1170)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2][CH]CC(130)', 'C2H2(32)'],
    products = ['[CH]=CC[CH]CC(1170)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2][CH]CC(130)', 'C2H2(T)(175)'],
    products = ['[CH]=CC[CH]CC(1170)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CH2(S)(23)', '[CH]=CC[CH]C(1176)'],
    products = ['[CH]=CC[CH]CC(1170)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH]CC(144)', '[CH]=C[CH2](2461)'],
    products = ['[CH]=CC[CH]CC(1170)'],
