...
species(
    label = '[CH2]OC(C)=C=C(24523)',
    structure = SMILES('[CH2]OC(C)=C=C'),
    E0 = (142.836,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,440,435,1725,2950,3100,1380,975,1025,1650,540,610,2055,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,393.781,395.602],'cm^-1')),
        HinderedRotor(inertia=(0.127835,'amu*angstrom^2'), symmetry=1, barrier=(14.2374,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.127927,'amu*angstrom^2'), symmetry=1, barrier=(14.2161,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.12981,'amu*angstrom^2'), symmetry=1, barrier=(14.2266,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (83.1085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.23054,0.052687,-3.26289e-05,2.60601e-09,3.29376e-12,17286,22.1438], Tmin=(100,'K'), Tmax=(1024.95,'K')), NASAPolynomial(coeffs=[13.7935,0.0195648,-7.43388e-06,1.35968e-09,-9.54959e-14,13875.3,-42.8503], Tmin=(1024.95,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(142.836,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)HHH) + group(Cs-OsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(C=COCJ)"""),
)

species(
    label = 'C#CC(C)O[CH2](24524)',
    structure = SMILES('C#CC(C)O[CH2]'),
    E0 = (180.952,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2175,525,750,770,3400,2100,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,364.337,364.364],'cm^-1')),
        HinderedRotor(inertia=(0.139059,'amu*angstrom^2'), symmetry=1, barrier=(13.104,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.26941,'amu*angstrom^2'), symmetry=1, barrier=(119.627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.2693,'amu*angstrom^2'), symmetry=1, barrier=(119.627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.139079,'amu*angstrom^2'), symmetry=1, barrier=(13.1042,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (83.1085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.02082,0.0594088,-4.95889e-05,1.75509e-08,-9.77109e-13,21876.2,22.4087], Tmin=(100,'K'), Tmax=(977.674,'K')), NASAPolynomial(coeffs=[13.9047,0.0190317,-6.56548e-06,1.11867e-09,-7.51806e-14,18767.5,-42.4727], Tmin=(977.674,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(180.952,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cs-OsHHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(CsJOCC2)"""),
)
...
species(
    label = '[CH2]OC=C=C(24525)',
    structure = SMILES('[CH2]OC=C=C'),
    E0 = (184.627,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,3100,1380,975,1025,1650,540,610,2055,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,180,180],'cm^-1')),
        HinderedRotor(inertia=(1.08974,'amu*angstrom^2'), symmetry=1, barrier=(25.0553,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.09332,'amu*angstrom^2'), symmetry=1, barrier=(25.1375,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (69.0819,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.89049,0.0335701,7.93565e-06,-4.41758e-08,2.22063e-11,22293.3,17.7705], Tmin=(100,'K'), Tmax=(928.025,'K')), NASAPolynomial(coeffs=[16.0111,0.00567338,-2.58427e-07,-1.13625e-11,-2.7969e-15,18252.9,-56.9467], Tmin=(928.025,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(184.627,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-OsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(C=COCJ)"""),
)
...
species(
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.02251,0.0574644,-3.8859e-05,8.2239e-09,1.30091e-12,19786.4,22.106], Tmin=(100,'K'), Tmax=(1048.82,'K')), NASAPolynomial(coeffs=[13.8355,0.0224392,-8.56206e-06,1.54892e-09,-1.07316e-13,16337.4,-43.9494], Tmin=(1048.82,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(163.565,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-OsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + radical(Allyl_P) + radical(Cds_S)"""),
)
...
species(
    label = '[CH]=[C]C(C)OC(24527)',
    structure = SMILES('[CH]=[C]C(C)OC'),
    E0 = (316.355,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,3120,650,792.5,1650,1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,348.766,349.96],'cm^-1')),
        HinderedRotor(inertia=(0.00138851,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.113216,'amu*angstrom^2'), symmetry=1, barrier=(9.7899,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.113751,'amu*angstrom^2'), symmetry=1, barrier=(9.78962,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.113501,'amu*angstrom^2'), symmetry=1, barrier=(9.80008,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.64435,0.0533677,-3.95608e-05,1.5784e-08,-2.6989e-12,38132,24.0117], Tmin=(100,'K'), Tmax=(1311.81,'K')), NASAPolynomial(coeffs=[9.11099,0.0306003,-1.35274e-05,2.55376e-09,-1.77532e-13,36173,-14.037], Tmin=(1311.81,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(316.355,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cs-OsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_P) + radical(Cds_S)"""),
)
...
species(
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.11029,0.0548288,-3.10982e-05,6.75517e-11,4.18934e-12,-5802.4,20.0901], Tmin=(100,'K'), Tmax=(1026.51,'K')), NASAPolynomial(coeffs=[13.8256,0.0223167,-8.4826e-06,1.54673e-09,-1.08234e-13,-9310.41,-45.9583], Tmin=(1026.51,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-49.172,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)HHH) + group(Cs-OsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + group(Cdd-CdsCds)"""),
)
...
species(
    label = '[CH2]O[CH]C(=C)C(24530)',
    structure = SMILES('[CH2]OC=C([CH2])C'),
    E0 = (120.467,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.00994,0.0514099,-4.96941e-06,-3.88899e-08,2.10949e-11,14609.6,22.9141], Tmin=(100,'K'), Tmax=(943.162,'K')), NASAPolynomial(coeffs=[17.998,0.0151163,-4.11041e-06,6.95544e-10,-5.15839e-14,9814.87,-66.4796], Tmin=(943.162,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(120.467,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-OsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsOsH) + radical(C=COCJ) + radical(Allyl_P)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', '[CH2]OC(C)=C=C(24523)'],
    products = ['[CH2]OC(C)[C]=C(19496)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'C#CC(C)O[CH2](24524)'],
    products = ['[CH2]OC(C)[C]=C(19496)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['CH3(17)', '[CH2]OC=C=C(24525)'],
    products = ['[CH2]OC(C)[C]=C(19496)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction17',
    reactants = ['CH2(19)', 'C=[C]C(C)[O](3245)'],
    products = ['[CH2]OC(C)[C]=C(19496)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H2CC(41)', '[CH2]O[CH]C(567)'],
    products = ['[CH2]OC(C)[C]=C(19496)'],
