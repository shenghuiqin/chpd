...
species(
    label = 'C=C(CC)C[CH]CC(C)OO(8118)',
    structure = SMILES('C=C(CC)C[CH]CC(C)OO'),
    E0 = (-56.0701,'kJ/mol'),
    modes = [
...
species(
    label = '[CH2]C(C=CCC(C)OO)CC(8119)',
    structure = SMILES('[CH2]C(C=CCC(C)OO)CC'),
    E0 = (-50.3886,'kJ/mol'),
    modes = [
...
species(
    label = '[CH2]C(CC)CC=CC(C)OO(8120)',
    ...
    molecularWeight = (157.23,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.13094,0.125062,-9.76483e-05,4.00753e-08,-6.73406e-12,-5598.33,49.0719], Tmin=(100,'K'), Tmax=(1395.69,'K')), NASAPolynomial(coeffs=[22.3936,0.0547748,-2.21074e-05,3.99202e-09,-2.70657e-13,-12444,-77.421], Tmin=(1395.69,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-48.4473,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(644.372,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Isobutyl)"""),
)
...
species(
    label = '[CH2]C(CC)CC=C(1458)',
    structure = SMILES('[CH2]C(CC)CC=C'),
    E0 = (111.526,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3010,987.5,1337.5,450,1655,2750,2800,2850,1350,1500,750,1050,1375,1000,2950,3100,1380,975,1025,1650,1380,1390,370,380,2900,435,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3100,440,815,1455,1000,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'CC[C](C)C[CH]CC(C)OO(8121)',
    structure = SMILES('CC[C](C)C[CH]CC(C)OO'),
    E0 = (13.3632,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (158.238,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.90869,0.141548,-0.000174089,1.45934e-07,-5.2519e-11,1808.87,48.5766], Tmin=(100,'K'), Tmax=(776.247,'K')), NASAPolynomial(coeffs=[6.15854,0.0860532,-3.99431e-05,7.6159e-09,-5.29343e-13,975.963,14.4025], Tmin=(776.247,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(13.3632,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(665.158,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(Tertalkyl)"""),
)
...
species(
    label = '[CH2]C(CC)CC[CH]C(C)OO(8123)',
    structure = SMILES('[CH2]C(CC)CC[CH]C(C)OO'),
    E0 = (38.9795,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3615,1310,387.5,850,1000,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3000,3100,440,815,1455,1000,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'C[CH]C(C)C[CH]CC(C)OO(8124)',
    structure = SMILES('C[CH]C(C)C[CH]CC(C)OO'),
    E0 = (22.4826,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (158.238,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.28516,0.126245,-0.000112452,6.34246e-08,-1.63664e-11,2885.79,47.795], Tmin=(100,'K'), Tmax=(884.805,'K')), NASAPolynomial(coeffs=[8.4289,0.0823305,-3.80037e-05,7.33105e-09,-5.17356e-13,1166.77,2.1191], Tmin=(884.805,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(22.4826,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(665.158,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(Cs_S)"""),
)

species(
    label = 'CCC(C)[CH][CH]CC(C)OO(8125)',
    structure = SMILES('CCC(C)[CH][CH]CC(C)OO'),
    E0 = (22.4826,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (158.238,'amu'),
...
species(
    label = '[CH2][C](CC)CCCC(C)OO(8126)',
    structure = SMILES('[CH2][C](CC)CCCC(C)OO'),
    E0 = (23.9872,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (158.238,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.9592,0.140206,-0.000151725,1.04632e-07,-3.1387e-11,3091.3,47.9983], Tmin=(100,'K'), Tmax=(791.675,'K')), NASAPolynomial(coeffs=[10.1929,0.0788135,-3.54187e-05,6.70352e-09,-4.66377e-13,1166.95,-7.7915], Tmin=(791.675,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(23.9872,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(665.158,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Isobutyl) + radical(Tertalkyl)"""),
)

species(
    label = '[CH2]C(CC)CCC[C](C)OO(8127)',
    structure = SMILES('[CH2]C(CC)CCC[C](C)OO'),
    E0 = (25.4636,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (158.238,'amu'),
...
species(
    label = '[CH2]C([CH]C)CCCC(C)OO(8128)',
    structure = SMILES('[CH2]C([CH]C)CCCC(C)OO'),
    E0 = (33.1067,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3615,1310,387.5,850,1000,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3000,3100,440,815,1455,1000,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (158.238,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.66768,0.129561,-0.00010999,5.33697e-08,-1.11663e-11,4181.75,48.3593], Tmin=(100,'K'), Tmax=(1102.56,'K')), NASAPolynomial(coeffs=[14.22,0.0719214,-3.15724e-05,5.95409e-09,-4.14954e-13,678.333,-29.8409], Tmin=(1102.56,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(33.1067,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(665.158,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Isobutyl) + radical(Cs_S)"""),
)

species(
    label = '[CH2]C(CC)CCCC([CH2])OO(8129)',
    structure = SMILES('[CH2]C(CC)CCCC([CH2])OO'),
    E0 = (52.5271,'kJ/mol'),
    modes = [
...
species(
    label = '[CH2]CC([CH2])CCCC(C)OO(8131)',
    structure = SMILES('[CH2]CC([CH2])CCCC(C)OO'),
    E0 = (43.8109,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1310,387.5,850,1000,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2]C(C[CH]CC(C)CC)OO(8135)',
...
species(
    label = 'C=C(CC)CCCC(C)OO(8137)',
    structure = SMILES('C=C(CC)CCCC(C)OO'),
    E0 = (-250.528,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (158.238,'amu'),
...
species(
    label = 'CCC(C)C=CCC(C)OO(8138)',
    structure = SMILES('CCC(C)C=CCC(C)OO'),
    E0 = (-255.471,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (158.238,'amu'),
...
species(
    label = 'CCC(C)CC=CC(C)OO(8139)',
    structure = SMILES('CCC(C)CC=CC(C)OO'),
    E0 = (-253.53,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (158.238,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.34253,0.125403,-9.105e-05,3.36026e-08,-5.03139e-12,-30252.9,48.0666], Tmin=(100,'K'), Tmax=(1556.86,'K')), NASAPolynomial(coeffs=[25.6682,0.0534347,-2.17085e-05,3.90917e-09,-2.63145e-13,-38974.5,-99.468], Tmin=(1556.86,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-253.53,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(669.315,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH)"""),
)
...
species(
    label = '[CH2]C(CC)C[CH]CCOO(8140)',
    structure = SMILES('[CH2]C(CC)C[CH]CCOO'),
    E0 = (69.446,'kJ/mol'),
    modes = [
...
species(
    label = '[CH2]C(CC)CC1CC(C)O1(8141)',
    structure = SMILES('[CH2]C(CC)CC1CC(C)O1'),
    E0 = (-61.5516,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (141.231,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.929062,0.0913127,-9.92186e-06,-5.35962e-08,2.91041e-11,-7209.73,38.7503], Tmin=(100,'K'), Tmax=(922.343,'K')), NASAPolynomial(coeffs=[18.5419,0.0509534,-1.59758e-05,2.5969e-09,-1.72006e-13,-12676.6,-63.7764], Tmin=(922.343,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-61.5516,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(631.9,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Oxetane) + radical(Isobutyl)"""),
)
...
species(
    label = '[CH2]C(CC)CC([CH2])C(C)OO(8143)',
    structure = SMILES('[CH2]C(CC)CC([CH2])C(C)OO'),
    E0 = (41.2998,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3615,1310,387.5,850,1000,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,1380,1382,1384,1386,1388,1390,370,372,374,376,378,380,2800,2900,3000,430,435,440,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2]C(CC)CC(O)CC(C)[O](8144)',
    structure = SMILES('[CH2]C(CC)CC(O)CC(C)[O]'),
    E0 = (-175.05,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (158.238,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.1346,0.13213,-0.000113069,5.34329e-08,-1.05016e-11,-20830.5,48.8723], Tmin=(100,'K'), Tmax=(1198.16,'K')), NASAPolynomial(coeffs=[18.8566,0.0620506,-2.53348e-05,4.61607e-09,-3.15656e-13,-25860.7,-56.1929], Tmin=(1198.16,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-175.05,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(669.315,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Isobutyl) + radical(CC(C)OJ)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(CC)C[CH]CC(C)OO(8044)'],
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'C=C(CC)C[CH]CC(C)OO(8118)'],
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', '[CH2]C(C=CCC(C)OO)CC(8119)'],
    products = ['[CH2]C(CC)C[CH]CC(C)OO(8044)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', '[CH2]C(CC)CC=CC(C)OO(8120)'],
    products = ['[CH2]C(CC)C[CH]CC(C)OO(8044)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(1.46e+08,'cm^3/(mol*s)'), n=1.64, Ea=(5.73208,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""From training reaction 2555 used for Cds-CsH_Cds-CsH;HJ
Exact match found for rate rule [Cds-CsH_Cds-CsH;HJ]
...
reaction(
    label = 'reaction5',
    reactants = ['C2H5(29)', 'C=CC[CH]CC(C)OO(6398)'],
    products = ['[CH2]C(CC)C[CH]CC(C)OO(8044)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['CH3CHOOH(63)', '[CH2]C(CC)CC=C(1458)'],
    products = ['[CH2]C(CC)C[CH]CC(C)OO(8044)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]C(CC)C[CH]CC(C)OO(8044)'],
    products = ['CC[C](C)C[CH]CC(C)OO(8121)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]C([CH]CCC(C)OO)CC(8122)'],
    products = ['[CH2]C(CC)C[CH]CC(C)OO(8044)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]C(CC)CC[CH]C(C)OO(8123)'],
    products = ['[CH2]C(CC)C[CH]CC(C)OO(8044)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]C(CC)C[CH]CC(C)OO(8044)'],
    products = ['C[CH]C(C)C[CH]CC(C)OO(8124)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2]C(CC)C[CH]CC(C)OO(8044)'],
    products = ['CCC(C)[CH][CH]CC(C)OO(8125)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]C(CC)C[CH]CC(C)OO(8044)'],
    products = ['[CH2][C](CC)CCCC(C)OO(8126)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]C(CC)C[CH]CC(C)OO(8044)'],
    products = ['[CH2]C(CC)CCC[C](C)OO(8127)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]C([CH]C)CCCC(C)OO(8128)'],
    products = ['[CH2]C(CC)C[CH]CC(C)OO(8044)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]C(CC)CCCC([CH2])OO(8129)'],
    products = ['[CH2]C(CC)C[CH]CC(C)OO(8044)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2]CC(C)C[CH]CC(C)OO(8130)'],
    products = ['[CH2]C(CC)C[CH]CC(C)OO(8044)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2]CC([CH2])CCCC(C)OO(8131)'],
    products = ['[CH2]C(CC)C[CH]CC(C)OO(8044)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2]C(CC)C[CH]CC(C)OO(8044)'],
    products = ['[CH2]C(CC)CCCC(C)O[O](8132)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH2]C(CC)C[CH]CC(C)OO(8044)'],
    products = ['CCC(C)C[CH][CH]C(C)OO(8133)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH2]C(CC)C[CH]CC(C)OO(8044)'],
    products = ['CCC(C)C[CH]C[C](C)OO(8134)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH2]C(C[CH]CC(C)CC)OO(8135)'],
    products = ['[CH2]C(CC)C[CH]CC(C)OO(8044)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[CH2]C(CC)C[CH]CC(C)OO(8044)'],
    products = ['CCC(C)C[CH]CC(C)O[O](8136)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[CH2]C(CC)C[CH]CC(C)OO(8044)'],
    products = ['C=C(CC)CCCC(C)OO(8137)'],
...
reaction(
    label = 'reaction27',
    reactants = ['[CH2]C(CC)C[CH]CC(C)OO(8044)'],
    products = ['CCC(C)C=CCC(C)OO(8138)'],
...
reaction(
    label = 'reaction28',
    reactants = ['[CH2]C(CC)C[CH]CC(C)OO(8044)'],
    products = ['CCC(C)CC=CC(C)OO(8139)'],
...
reaction(
    label = 'reaction29',
    reactants = ['CH2(S)(23)', '[CH2]C(CC)C[CH]CCOO(8140)'],
    products = ['[CH2]C(CC)C[CH]CC(C)OO(8044)'],
...
reaction(
    label = 'reaction30',
    reactants = ['CH2(S)(23)', '[CH2]C(C)C[CH]CC(C)OO(6355)'],
    products = ['[CH2]C(CC)C[CH]CC(C)OO(8044)'],
...
reaction(
    label = 'reaction31',
    reactants = ['[CH2]C(CC)C[CH]CC(C)OO(8044)'],
    products = ['OH(5)', '[CH2]C(CC)CC1CC(C)O1(8141)'],
...
reaction(
    label = 'reaction32',
    reactants = ['[CH2]C(CC)C[CH]CC(C)OO(8044)'],
    products = ['CCC[CH]C[CH]CC(C)OO(8142)'],
...
reaction(
    label = 'reaction35',
    reactants = ['[CH2]C(CC)CC([CH2])C(C)OO(8143)'],
    products = ['[CH2]C(CC)C[CH]CC(C)OO(8044)'],
...
reaction(
    label = 'reaction37',
    reactants = ['[CH2]C(CC)C[CH]CC(C)OO(8044)'],
    products = ['[CH2]C(CC)CC(O)CC(C)[O](8144)'],
...
reaction(
    label = 'reaction39',
    reactants = ['[CH2]C([CH2])CC(429)', '[CH]CC(C)OO(1806)'],
    products = ['[CH2]C(CC)C[CH]CC(C)OO(8044)'],
