...
species(
    ...
    molecularWeight = (114.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.103302,0.0952795,-8.69233e-05,4.74722e-08,-1.12913e-11,-607.088,34.6513], Tmin=(100,'K'), Tmax=(978.49,'K')), NASAPolynomial(coeffs=[9.96012,0.0541421,-2.38626e-05,4.50877e-09,-3.14596e-13,-2576.54,-13.6803], Tmin=(978.49,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-6.241,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(C2CsJOH) + radical(RCCJ)"""),
)
...
species(
    label = '[CH2]CC(O)[CH]CCC(10639)',
    structure = SMILES('[CH2]CC(O)[CH]CCC'),
    E0 = (17.0332,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (114.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.24879,0.08731,-6.26121e-05,2.36871e-08,-3.71386e-12,2206.3,38.2314], Tmin=(100,'K'), Tmax=(1468.03,'K')), NASAPolynomial(coeffs=[16.0272,0.0429627,-1.72998e-05,3.10997e-09,-2.09709e-13,-2572.51,-46.5399], Tmin=(1468.03,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(17.0332,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJCO) + radical(RCCJ)"""),
)

species(
    label = '[CH2][CH]C(O)CCCC(10640)',
    structure = SMILES('[CH2][CH]C(O)CCCC'),
    E0 = (17.0332,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (114.185,'amu'),
...
species(
    label = '[CH2]CC(O)CC[CH]C(10642)',
    structure = SMILES('[CH2]CC(O)CC[CH]C'),
    E0 = (11.5775,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (114.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.296324,0.0862659,-6.79042e-05,3.23573e-08,-6.96736e-12,1521.76,36.5237], Tmin=(100,'K'), Tmax=(1044.31,'K')), NASAPolynomial(coeffs=[8.20376,0.055978,-2.43999e-05,4.58485e-09,-3.18805e-13,-129.797,-1.96789], Tmin=(1044.31,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(11.5775,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJ) + radical(RCCJC)"""),
)
...
species(
    label = '[CH2]CCCC(O)C[CH2](10643)',
    structure = SMILES('[CH2]CCCC(O)C[CH2]'),
    E0 = (22.3775,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (114.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0552233,0.0892155,-6.80392e-05,2.8448e-08,-5.0586e-12,2837.08,36.8216], Tmin=(100,'K'), Tmax=(1284.13,'K')), NASAPolynomial(coeffs=[12.9863,0.0485919,-2.05866e-05,3.81266e-09,-2.6251e-13,-512.349,-29.358], Tmin=(1284.13,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(22.3775,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJ) + radical(RCCJ)"""),
)
...
species(
    ...
    molecularWeight = (114.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.354287,0.0834252,-4.7766e-05,7.72512e-09,1.64025e-12,-31184.2,35.7169], Tmin=(100,'K'), Tmax=(1155.59,'K')), NASAPolynomial(coeffs=[16.7434,0.0418948,-1.67711e-05,3.06261e-09,-2.10773e-13,-36314.5,-54.3417], Tmin=(1155.59,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-260.669,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', '[CH2]CC(=O)CCCC(10636)'],
    products = ['[CH2]CC([O])CCCC(2132)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'C=CC([O])CCCC(10637)'],
    products = ['[CH2]CC([O])CCCC(2132)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['butyl_1(82)', 'CH2CH2CHO(560)'],
    products = ['[CH2]CC([O])CCCC(2132)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['C2H4(21)', 'CCCC[CH][O](1728)'],
    products = ['[CH2]CC([O])CCCC(2132)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]CC(O)[CH]CCC(10639)'],
    products = ['[CH2]CC([O])CCCC(2132)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]CC([O])CCCC(2132)'],
    products = ['[CH2][CH]C(O)CCCC(10640)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]CC([O])CCCC(2132)'],
    products = ['[CH2]CC(O)CC[CH]C(10642)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]CC([O])CCCC(2132)'],
    products = ['[CH2]CCCC(O)C[CH2](10643)'],
...
reaction(
    label = 'reaction22',
    reactants = ['CH2(S)(23)', '[CH2]CC([O])CCC(10645)'],
    products = ['[CH2]CC([O])CCCC(2132)'],
