species(
    label = '[CH2]C(CC(C)OO)O[CH]O(13377)',
    structure = SMILES('[CH2]C(CC(C)OO)O[CH]O'),
    E0 = (-211.169,'kJ/mol'),
    modes = [
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.19934,0.144361,-0.000199221,1.48439e-07,-4.42965e-11,-25181.8,42.3824], Tmin=(100,'K'), Tmax=(819.752,'K')), NASAPolynomial(coeffs=[17.6829,0.0473535,-2.17318e-05,4.10796e-09,-2.8389e-13,-28441.8,-49.5879], Tmin=(819.752,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-211.169,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(494.711,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-OsOsHH) + radical(OCJO) + radical(CJC(C)OC)"""),
)
...
species(
    label = '[CH2]C(CC(C)OO)OC=O(16889)',
    structure = SMILES('[CH2]C(CC(C)OO)OC=O'),
    E0 = (-382.057,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,3615,1310,387.5,850,1000,2750,2850,1437.5,1250,1305,750,350,2782.5,750,1395,475,1775,1000,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.707721,0.109626,-0.000109574,6.03842e-08,-1.39584e-11,-45786.3,37.7041], Tmin=(100,'K'), Tmax=(1021.14,'K')), NASAPolynomial(coeffs=[14.1018,0.0516138,-2.43566e-05,4.74803e-09,-3.37201e-13,-48810.8,-34.0527], Tmin=(1021.14,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-382.057,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(473.925,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdOsH) + radical(CJC(C)OC)"""),
)

species(
    label = 'C=C(CC(C)OO)O[CH]O(16890)',
    structure = SMILES('C=C(CC(C)OO)O[CH]O'),
    E0 = (-340.138,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (147.149,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.06035,0.125714,-0.00013639,7.40219e-08,-1.56952e-11,-40684.5,40.5888], Tmin=(100,'K'), Tmax=(1155.84,'K')), NASAPolynomial(coeffs=[25.689,0.0296823,-1.17637e-05,2.13936e-09,-1.47456e-13,-47099.2,-97.3045], Tmin=(1155.84,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-340.138,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(473.925,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-OsOsHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(OCJO)"""),
)
...
species(
    label = '[CH2]C(CC(C)OO)OC[O](16891)',
    structure = SMILES('[CH2]C(CC(C)OO)OC[O]'),
    E0 = (-172.731,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (148.157,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.26902,0.121206,-0.000128669,7.40133e-08,-1.75235e-11,-20589.4,39.7336], Tmin=(100,'K'), Tmax=(1009.51,'K')), NASAPolynomial(coeffs=[16.5953,0.0504216,-2.34926e-05,4.55632e-09,-3.22796e-13,-24196.2,-46.6208], Tmin=(1009.51,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-172.731,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(498.868,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-OsOsHH) + radical(OCOJ) + radical(CJC(C)OC)"""),
)

species(
    label = 'C[C](CC(C)OO)O[CH]O(16892)',
    structure = SMILES('C[C](CC(C)OO)O[CH]O'),
    E0 = (-240.975,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (148.157,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.07854,0.144064,-0.000213608,1.76226e-07,-5.81347e-11,-28773.6,42.1301], Tmin=(100,'K'), Tmax=(817.478,'K')), NASAPolynomial(coeffs=[14.192,0.0527693,-2.46578e-05,4.65363e-09,-3.19193e-13,-31043.5,-30.6994], Tmin=(817.478,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-240.975,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(494.711,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-OsOsHH) + radical(OCJO) + radical(C2CsJOCs)"""),
)

species(
    label = '[CH2][C](CC(C)OO)OCO(16893)',
    structure = SMILES('[CH2][C](CC(C)OO)OCO'),
    E0 = (-219.425,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (148.157,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.25274,0.138831,-0.000170059,1.07309e-07,-2.67014e-11,-26166.6,42.7255], Tmin=(100,'K'), Tmax=(984.671,'K')), NASAPolynomial(coeffs=[22.6586,0.0376344,-1.59023e-05,2.93856e-09,-2.02586e-13,-31072.5,-77.0727], Tmin=(984.671,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-219.425,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(494.711,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-OsOsHH) + radical(C2CsJOCs) + radical(CJC(C)OC)"""),
)

species(
    label = 'CC([CH]C(C)O[CH]O)OO(16894)',
    structure = SMILES('CC([CH]C(C)O[CH]O)OO'),
    E0 = (-221.264,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (148.157,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.65551,0.131546,-0.000163832,1.11936e-07,-3.1069e-11,-26414.5,42.9907], Tmin=(100,'K'), Tmax=(874.257,'K')), NASAPolynomial(coeffs=[16.3158,0.0493202,-2.27529e-05,4.35452e-09,-3.04825e-13,-29556.8,-41.2953], Tmin=(874.257,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-221.264,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(494.711,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-OsOsHH) + radical(CCJCOOH) + radical(OCJO)"""),
)

species(
    label = 'C[C](CC(C)O[CH]O)OO(16895)',
    structure = SMILES('C[C](CC(C)O[CH]O)OO'),
    E0 = (-234.78,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (148.157,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.68338,0.1338,-0.000179728,1.37311e-07,-4.29188e-11,-28041,41.072], Tmin=(100,'K'), Tmax=(777.985,'K')), NASAPolynomial(coeffs=[13.914,0.0536021,-2.50932e-05,4.79527e-09,-3.33715e-13,-30467.7,-30.2599], Tmin=(777.985,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-234.78,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(494.711,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-OsOsHH) + radical(C2CsJOOH) + radical(OCJO)"""),
)

species(
    label = '[CH2]C([CH]C(C)OO)OCO(16896)',
    structure = SMILES('[CH2]C([CH]C(C)OO)OCO'),
    E0 = (-199.714,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1277.5,1000,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,3615,1310,387.5,850,1000,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (148.157,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.41919,0.133687,-0.000148101,8.21367e-08,-1.77687e-11,-23782.4,45.6727], Tmin=(100,'K'), Tmax=(1134.8,'K')), NASAPolynomial(coeffs=[26.801,0.0306883,-1.19531e-05,2.1517e-09,-1.47454e-13,-30414.1,-98.9924], Tmin=(1134.8,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-199.714,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(494.711,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-OsOsHH) + radical(CCJCOOH) + radical(CJC(C)OC)"""),
)

species(
    label = 'CC(CC(C)O[CH][O])OO(16897)',
    structure = SMILES('CC(CC(C)O[CH][O])OO'),
    E0 = (-194.281,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (148.157,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.264679,0.102433,-3.06404e-05,-1.90957e-07,2.21828e-10,-23253.5,34.6718], Tmin=(100,'K'), Tmax=(441.638,'K')), NASAPolynomial(coeffs=[8.6532,0.0645954,-3.16638e-05,6.12798e-09,-4.27165e-13,-24366.4,-3.15321], Tmin=(441.638,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-194.281,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(498.868,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-OsOsHH) + radical(OCOJ) + radical(OCJO)"""),
)

species(
    label = '[CH2]C(CC(C)O[CH]O)OO(16898)',
    structure = SMILES('[CH2]C(CC(C)O[CH]O)OO'),
    E0 = (-207.716,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (148.157,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.75412,0.132364,-0.000161654,1.0623e-07,-2.81574e-11,-24780.2,43.0328], Tmin=(100,'K'), Tmax=(916.589,'K')), NASAPolynomial(coeffs=[17.9204,0.0465038,-2.11415e-05,4.02985e-09,-2.81924e-13,-28386.9,-50.1717], Tmin=(916.589,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-207.716,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(494.711,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-OsOsHH) + radical(CJCOOH) + radical(OCJO)"""),
)

species(
    label = '[CH2]C(C[C](C)OO)OCO(16899)',
    structure = SMILES('[CH2]C(C[C](C)OO)OCO'),
    E0 = (-213.23,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (148.157,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.08422,0.131492,-0.000147594,8.48946e-08,-1.9285e-11,-25424.4,42.4637], Tmin=(100,'K'), Tmax=(1074.82,'K')), NASAPolynomial(coeffs=[23.3898,0.0366872,-1.52835e-05,2.82624e-09,-1.95727e-13,-30900.3,-82.2711], Tmin=(1074.82,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-213.23,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(494.711,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-OsOsHH) + radical(C2CsJOOH) + radical(CJC(C)OC)"""),
)

species(
    label = 'CC(CC(C)O[CH]O)O[O](16900)',
    structure = SMILES('CC(CC(C)O[CH]O)O[O]'),
    E0 = (-269.674,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (148.157,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.47188,0.12663,-0.000155331,1.05927e-07,-2.9407e-11,-32242.8,40.782], Tmin=(100,'K'), Tmax=(873.944,'K')), NASAPolynomial(coeffs=[15.5147,0.0488818,-2.18866e-05,4.13024e-09,-2.8677e-13,-35211.8,-38.8795], Tmin=(873.944,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-269.674,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(498.868,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-OsOsHH) + radical(ROOJ) + radical(OCJO)"""),
)

species(
    label = '[CH2]C(CC([CH2])OCO)OO(16901)',
    structure = SMILES('[CH2]C(CC([CH2])OCO)OO'),
    E0 = (-186.166,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (148.157,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.65325,0.136082,-0.000151345,8.3367e-08,-1.77947e-11,-22142.3,46.202], Tmin=(100,'K'), Tmax=(1154.21,'K')), NASAPolynomial(coeffs=[28.7147,0.027373,-1.00657e-05,1.76388e-09,-1.19448e-13,-29383.2,-109.629], Tmin=(1154.21,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-186.166,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(494.711,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-OsOsHH) + radical(CJCOOH) + radical(CJC(C)OC)"""),
)

species(
    label = '[CH2]C(CC(C)O[O])OCO(16902)',
    structure = SMILES('[CH2]C(CC(C)O[O])OCO'),
    E0 = (-248.124,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (148.157,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.26978,0.129146,-0.000140791,7.75259e-08,-1.66528e-11,-29609.2,43.5888], Tmin=(100,'K'), Tmax=(1143.8,'K')), NASAPolynomial(coeffs=[26.0103,0.0302469,-1.10915e-05,1.92965e-09,-1.29655e-13,-36078.5,-96.6458], Tmin=(1143.8,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-248.124,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(498.868,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-OsOsHH) + radical(ROOJ) + radical(CJC(C)OC)"""),
)
...
species(
    label = 'C=C(CC(C)OO)OCO(16903)',
    structure = SMILES('C=C(CC(C)OO)OCO'),
    E0 = (-529.099,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (148.157,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.0766,0.11018,-5.90071e-05,-2.50628e-08,2.37414e-11,-63395.6,40.8549], Tmin=(100,'K'), Tmax=(946.31,'K')), NASAPolynomial(coeffs=[33.3139,0.0181531,-4.3841e-06,7.40005e-10,-5.81314e-14,-72671.3,-141.55], Tmin=(946.31,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-529.099,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(498.868,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-OsOsHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH)"""),
)

species(
    label = 'CC(CC(C)OC=O)OO(16904)',
    structure = SMILES('CC(CC(C)OC=O)OO'),
    E0 = (-592.567,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (148.157,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.572198,0.0996894,-7.69069e-05,3.04224e-08,-4.98894e-12,-71104.6,37.4418], Tmin=(100,'K'), Tmax=(1397.56,'K')), NASAPolynomial(coeffs=[17.3581,0.0483707,-2.18269e-05,4.1481e-09,-2.88943e-13,-76116.4,-55.0636], Tmin=(1397.56,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-592.567,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(498.868,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdOsH)"""),
)
...
species(
    label = '[CH2]C(CCOO)O[CH]O(16905)',
    structure = SMILES('[CH2]C(CCOO)O[CH]O'),
    E0 = (-174.745,'kJ/mol'),
    modes = [
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.66662,0.133296,-0.000202517,1.64319e-07,-5.27161e-11,-20821.2,38.5586], Tmin=(100,'K'), Tmax=(826.73,'K')), NASAPolynomial(coeffs=[15.6316,0.0408747,-1.8997e-05,3.56184e-09,-2.42858e-13,-23383.2,-39.8001], Tmin=(826.73,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-174.745,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(424.038,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsOsHH) + radical(CJC(C)OC) + radical(OCJO)"""),
)
...
species(
    label = 'CC1CC(CO1)O[CH]O(16906)',
    structure = SMILES('CC1CC(CO1)O[CH]O'),
    E0 = (-389.706,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (131.15,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.125733,0.0773328,-2.4651e-05,-3.1217e-08,2.1098e-11,-46709.8,28.929], Tmin=(100,'K'), Tmax=(906.419,'K')), NASAPolynomial(coeffs=[18.5471,0.0313057,-8.6788e-06,1.30977e-09,-8.44971e-14,-51589.2,-67.5648], Tmin=(906.419,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-389.706,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(465.61,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsOsHH) + ring(Tetrahydrofuran) + radical(OCJO)"""),
)

species(
    label = '[CH2]C1CC(C)OC(O)O1(16907)',
    structure = SMILES('[CH2]C1CC(C)OC(O)O1'),
    E0 = (-414.431,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (131.15,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.254143,0.073486,-2.50474e-05,-2.3935e-08,1.76525e-11,-49701.2,26.2521], Tmin=(100,'K'), Tmax=(871.932,'K')), NASAPolynomial(coeffs=[14.0825,0.0376776,-1.09766e-05,1.6482e-09,-1.02536e-13,-53162.9,-44.5892], Tmin=(871.932,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-414.431,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(469.768,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-OsOsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(1,3-Dioxane) + radical(CJC(C)OC)"""),
)
...
species(
    label = 'CC([O])CC(CO)O[CH]O(16909)',
    structure = SMILES('CC([O])CC(CO)O[CH]O'),
    E0 = (-422.65,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (148.157,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.61191,0.128942,-0.000158729,1.06501e-07,-2.88484e-11,-50635.8,42.2737], Tmin=(100,'K'), Tmax=(897.872,'K')), NASAPolynomial(coeffs=[16.9637,0.0461883,-2.04796e-05,3.85187e-09,-2.67134e-13,-53971.5,-45.3419], Tmin=(897.872,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-422.65,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(498.868,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(O2s-CsH) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsOsHH) + radical(OCJO) + radical(CC(C)OJ)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(CC(C)OO)O[CH]O(13377)'],
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', '[CH2]C(CC(C)OO)OC=O(16889)'],
    products = ['[CH2]C(CC(C)OO)O[CH]O(13377)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'C=C(CC(C)OO)O[CH]O(16890)'],
    products = ['[CH2]C(CC(C)OO)O[CH]O(13377)'],
    transitionState = 'TS3',
...
reaction(
    ...
    products = ['[CH2]C(CC(C)OO)O[CH]O(13377)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(4000,'m^3/(mol*s)'), n=1.39, Ea=(48.3428,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Od_CO-NdH;YJ] for rate rule [Od_CO-NdH;CJ]
Euclidian distance = 1.0
family: R_Addition_MultipleBond"""),
)
...
reaction(
    label = 'reaction5',
    reactants = ['QOOH_3(717)', 'C=CO[CH]O(3175)'],
    products = ['[CH2]C(CC(C)OO)O[CH]O(13377)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2]C(CC(C)OO)OC[O](16891)'],
    products = ['[CH2]C(CC(C)OO)O[CH]O(13377)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2]C(CC(C)OO)O[CH]O(13377)'],
    products = ['C[C](CC(C)OO)O[CH]O(16892)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]C(CC(C)OO)O[CH]O(13377)'],
    products = ['[CH2][C](CC(C)OO)OCO(16893)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]C(CC(C)OO)O[CH]O(13377)'],
    products = ['CC([CH]C(C)O[CH]O)OO(16894)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]C(CC(C)OO)O[CH]O(13377)'],
    products = ['C[C](CC(C)O[CH]O)OO(16895)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]C([CH]C(C)OO)OCO(16896)'],
    products = ['[CH2]C(CC(C)OO)O[CH]O(13377)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CC(CC(C)O[CH][O])OO(16897)'],
    products = ['[CH2]C(CC(C)OO)O[CH]O(13377)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2]C(CC(C)OO)O[CH]O(13377)'],
    products = ['[CH2]C(CC(C)O[CH]O)OO(16898)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]C(CC(C)OO)O[CH]O(13377)'],
    products = ['[CH2]C(C[C](C)OO)OCO(16899)'],
    transitionState = 'TS14',
    kinetics = Arrhenius(A=(0.0378492,'s^-1'), n=3.26, Ea=(26.8822,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R5H_SSSS;C_rad_out_1H;Cs_H_out] for rate rule [R5H_SSSS_OCC;C_rad_out_H/NonDeO;Cs_H_out_OOH/Cs]
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]C(CC(C)OO)O[CH]O(13377)'],
    products = ['CC(CC(C)O[CH]O)O[O](16900)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]C(CC([CH2])OCO)OO(16901)'],
    products = ['[CH2]C(CC(C)OO)O[CH]O(13377)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]C(CC(C)O[O])OCO(16902)'],
    products = ['[CH2]C(CC(C)OO)O[CH]O(13377)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2]C(CC(C)OO)O[CH]O(13377)'],
    products = ['C=C(CC(C)OO)OCO(16903)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2]C(CC(C)OO)O[CH]O(13377)'],
    products = ['CC(CC(C)OC=O)OO(16904)'],
...
reaction(
    label = 'reaction21',
    reactants = ['CH2(S)(23)', '[CH2]C(CCOO)O[CH]O(16905)'],
    products = ['[CH2]C(CC(C)OO)O[CH]O(13377)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH2]C(CC(C)OO)O[CH]O(13377)'],
    products = ['OH(5)', 'CC1CC(CO1)O[CH]O(16906)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH2]C(CC(C)OO)O[CH]O(13377)'],
    products = ['OH(5)', '[CH2]C1CC(C)OC(O)O1(16907)'],
    transitionState = 'TS23',
    kinetics = Arrhenius(A=(2.17006e+11,'s^-1'), n=0, Ea=(58.6304,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [RnOO;C_sec_rad_intra;OOH] for rate rule [R5OO;C_rad/H/NonDeO_intra;OOH]
...
reaction(
    label = 'reaction26',
    reactants = ['[CH2]C(CC(C)OO)O[CH]O(13377)'],
    products = ['CC([O])CC(CO)O[CH]O(16909)'],
