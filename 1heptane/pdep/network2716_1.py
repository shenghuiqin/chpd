species(
    label = 'CCCC[CH]OO[CH]C=O(13351)',
    structure = SMILES('CCCC[CH]OO[CH]C=O'),
    E0 = (-35.6938,'kJ/mol'),
    modes = [
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.590341,0.109855,-0.000109157,6.45927e-08,-1.6724e-11,-4135.24,38.1697], Tmin=(100,'K'), Tmax=(900.919,'K')), NASAPolynomial(coeffs=[10.153,0.0621531,-2.97329e-05,5.81754e-09,-4.13596e-13,-6070.94,-12.5395], Tmin=(900.919,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-35.6938,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(498.868,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)OsHH) + group(Cds-OdCsH) + radical(OCJC=O) + radical(CCsJOOC)"""),
)
...
species(
    label = 'CCCCC1OO[CH]C1[O](14091)',
    structure = SMILES('CCCCC1OO[CH]C1[O]'),
    E0 = (12.1467,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (144.168,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.687011,0.0884813,-3.34427e-05,-2.54491e-08,1.87403e-11,1643.07,35.4825], Tmin=(100,'K'), Tmax=(930.005,'K')), NASAPolynomial(coeffs=[19.6172,0.0381636,-1.19816e-05,1.95925e-09,-1.30787e-13,-3734.13,-69.6054], Tmin=(930.005,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(12.1467,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(515.497,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(12dioxolane) + radical(CC(C)OJ) + radical(CCsJOOC)"""),
)
...
species(
    label = 'CCCC=COO[CH]C=O(14092)',
    structure = SMILES('CCCC=COO[CH]C=O'),
    E0 = (-90.3276,'kJ/mol'),
    modes = [
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.629647,0.0999449,-8.29539e-05,3.57765e-08,-6.35399e-12,-10696,38.8929], Tmin=(100,'K'), Tmax=(1313.76,'K')), NASAPolynomial(coeffs=[17.5158,0.0446975,-1.98747e-05,3.76698e-09,-2.62793e-13,-15463.7,-53.6002], Tmin=(1313.76,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-90.3276,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(478.082,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-OdCsH) + radical(OCJC=O)"""),
)

species(
    label = 'CCCC[CH]OOC=C=O(14093)',
    structure = SMILES('CCCC[CH]OOC=C=O'),
    E0 = (8.01099,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2120,512.5,787.5,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,350,500,795,815,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (143.16,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.649999,0.108262,-0.000110821,6.40947e-08,-1.55965e-11,1125.95,37.7508], Tmin=(100,'K'), Tmax=(973.706,'K')), NASAPolynomial(coeffs=[13.0754,0.0518768,-2.39567e-05,4.62033e-09,-3.26073e-13,-1546.89,-28.1003], Tmin=(973.706,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(8.01099,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(478.082,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-(Cdd-O2d)OsH) + radical(CCsJOOC)"""),
)
...
species(
    label = 'CCC[CH]COO[CH]C=O(14094)',
    structure = SMILES('CCC[CH]COO[CH]C=O'),
    E0 = (-21.7195,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2782.5,750,1395,475,1775,1000,3000,3050,390,425,1340,1360,335,370,2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (144.168,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.613907,0.110511,-0.000112552,6.86139e-08,-1.82653e-11,-2453.85,40.2648], Tmin=(100,'K'), Tmax=(879.393,'K')), NASAPolynomial(coeffs=[10.0613,0.0619527,-2.97245e-05,5.82176e-09,-4.14033e-13,-4331.36,-9.86476], Tmin=(879.393,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-21.7195,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(498.868,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)OsHH) + group(Cds-OdCsH) + radical(OCJC=O) + radical(CCJCOOH)"""),
)

species(
    label = 'CCCC[CH]OOC[C]=O(14095)',
    structure = SMILES('CCCC[CH]OOC[C]=O'),
    E0 = (-19.5077,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,1855,455,950,2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (144.168,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.474692,0.106815,-0.000101094,5.54852e-08,-1.3277e-11,-2192.12,38.6716], Tmin=(100,'K'), Tmax=(968.248,'K')), NASAPolynomial(coeffs=[10.8439,0.0600562,-2.86551e-05,5.60914e-09,-3.99086e-13,-4383.96,-15.5687], Tmin=(968.248,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-19.5077,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(498.868,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)OsHH) + group(Cds-OdCsH) + radical(CCsJOOC) + radical(CsCJ=O)"""),
)

species(
    label = 'CC[CH]CCOO[CH]C=O(14096)',
    structure = SMILES('CC[CH]CCOO[CH]C=O'),
    E0 = (-27.6762,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2782.5,750,1395,475,1775,1000,3000,3050,390,425,1340,1360,335,370,2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (144.168,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.752949,0.113711,-0.000139429,1.13932e-07,-4.06079e-11,-3166.19,40.9963], Tmin=(100,'K'), Tmax=(730.413,'K')), NASAPolynomial(coeffs=[6.92498,0.0665216,-3.196e-05,6.20326e-09,-4.36389e-13,-4150.63,7.30564], Tmin=(730.413,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-27.6762,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(498.868,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)OsHH) + group(Cds-OdCsH) + radical(OCJC=O) + radical(RCCJCC)"""),
)

species(
    label = 'C[CH]CCCOO[CH]C=O(14097)',
    structure = SMILES('C[CH]CCCOO[CH]C=O'),
    E0 = (-27.6882,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2782.5,750,1395,475,1775,1000,3000,3050,390,425,1340,1360,335,370,2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (144.168,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.248706,0.105193,-9.58983e-05,3.43151e-08,8.21591e-12,-3188.23,39.4507], Tmin=(100,'K'), Tmax=(566.36,'K')), NASAPolynomial(coeffs=[7.54605,0.0654755,-3.1318e-05,6.10152e-09,-4.31802e-13,-4317.08,4.10596], Tmin=(566.36,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-27.6882,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(498.868,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)OsHH) + group(Cds-OdCsH) + radical(OCJC=O) + radical(RCCJC)"""),
)

species(
    label = 'CCC[CH][CH]OOCC=O(14098)',
    structure = SMILES('CCC[CH][CH]OOCC=O'),
    E0 = (26.2363,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2782.5,750,1395,475,1775,1000,3000,3050,390,425,1340,1360,335,370,2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (144.168,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.550248,0.108997,-0.00010897,6.47305e-08,-1.67962e-11,3311.77,40.5738], Tmin=(100,'K'), Tmax=(899.7,'K')), NASAPolynomial(coeffs=[10.1866,0.0612616,-2.93851e-05,5.75911e-09,-4.09854e-13,1379.78,-10.0905], Tmin=(899.7,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(26.2363,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(498.868,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)OsHH) + group(Cds-OdCsH) + radical(CCsJOOC) + radical(CCJCOOH)"""),
)

species(
    label = 'CCCCCOO[CH][C]=O(14099)',
    structure = SMILES('CCCCCOO[CH][C]=O'),
    E0 = (-67.4636,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (144.168,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.530617,0.108222,-0.00010423,5.86997e-08,-1.44231e-11,-7958.05,38.3359], Tmin=(100,'K'), Tmax=(945.438,'K')), NASAPolynomial(coeffs=[10.67,0.0608336,-2.90459e-05,5.68419e-09,-4.04311e-13,-10075.9,-15.0721], Tmin=(945.438,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-67.4636,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(498.868,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)OsHH) + group(Cds-OdCsH) + radical(OCJC=O) + radical(CsCJ=O)"""),
)

species(
    label = '[CH2]CCCCOO[CH]C=O(14100)',
    structure = SMILES('[CH2]CCCCOO[CH]C=O'),
    E0 = (-16.8881,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (144.168,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.553472,0.108701,-0.000105528,5.99457e-08,-1.4834e-11,-1874.39,39.5259], Tmin=(100,'K'), Tmax=(940.299,'K')), NASAPolynomial(coeffs=[10.7282,0.0607099,-2.89714e-05,5.66768e-09,-4.03047e-13,-3996.03,-14.207], Tmin=(940.299,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-16.8881,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(498.868,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)OsHH) + group(Cds-OdCsH) + radical(OCJC=O) + radical(RCCJ)"""),
)

species(
    label = 'CC[CH]C[CH]OOCC=O(14101)',
    structure = SMILES('CC[CH]C[CH]OOCC=O'),
    E0 = (20.2797,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2782.5,750,1395,475,1775,1000,3000,3050,390,425,1340,1360,335,370,2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (144.168,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.306845,0.0962251,-5.14916e-05,-6.72884e-08,8.93596e-11,2556.88,37.9553], Tmin=(100,'K'), Tmax=(484.134,'K')), NASAPolynomial(coeffs=[6.7638,0.0664037,-3.19898e-05,6.23493e-09,-4.40495e-13,1655.95,8.64049], Tmin=(484.134,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(20.2797,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(498.868,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)OsHH) + group(Cds-OdCsH) + radical(CCsJOOC) + radical(RCCJCC)"""),
)

species(
    label = 'C[CH]CC[CH]OOCC=O(14102)',
    structure = SMILES('C[CH]CC[CH]OOCC=O'),
    E0 = (20.2677,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2782.5,750,1395,475,1775,1000,3000,3050,390,425,1340,1360,335,370,2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (144.168,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.592334,0.109852,-0.000122581,8.85513e-08,-2.82703e-11,2594.92,41.1468], Tmin=(100,'K'), Tmax=(741.227,'K')), NASAPolynomial(coeffs=[7.81268,0.0644932,-3.07878e-05,5.98961e-09,-4.23264e-13,1348.95,3.1145], Tmin=(741.227,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(20.2677,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(498.868,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)OsHH) + group(Cds-OdCsH) + radical(CCsJOOC) + radical(RCCJC)"""),
)

species(
    label = '[CH2]CCC[CH]OOCC=O(14103)',
    structure = SMILES('[CH2]CCC[CH]OOCC=O'),
    E0 = (31.0677,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2782.5,750,1395,475,1775,1000,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (144.168,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.497331,0.107291,-0.000102371,5.66964e-08,-1.36703e-11,3891.52,39.8609], Tmin=(100,'K'), Tmax=(962.57,'K')), NASAPolynomial(coeffs=[10.8969,0.0599418,-2.85861e-05,5.59398e-09,-3.97936e-13,1697.97,-14.6748], Tmin=(962.57,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(31.0677,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(498.868,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)OsHH) + group(Cds-OdCsH) + radical(CCsJOOC) + radical(RCCJ)"""),
)
...
species(
    label = 'CCCC[CH]OOC1[CH]O1(14104)',
    structure = SMILES('CCCC[CH]OOC1[CH]O1'),
    E0 = (65.4654,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (144.168,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.38855,0.114354,-0.000110932,5.92219e-08,-1.28335e-11,8071.25,39.4384], Tmin=(100,'K'), Tmax=(1112.91,'K')), NASAPolynomial(coeffs=[17.9938,0.04469,-1.7037e-05,2.97592e-09,-1.98526e-13,3757.11,-56.1436], Tmin=(1112.91,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(65.4654,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CCsJO) + radical(CCsJOOC)"""),
)
...
species(
    label = 'CCCC=COOCC=O(14106)',
    structure = SMILES('CCCC=COOCC=O'),
    E0 = (-228.812,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (144.168,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.928618,0.100637,-7.87547e-05,3.12878e-08,-5.04378e-12,-27336.3,40.2165], Tmin=(100,'K'), Tmax=(1452.87,'K')), NASAPolynomial(coeffs=[20.5363,0.0415396,-1.77398e-05,3.29016e-09,-2.2608e-13,-33573.4,-71.3573], Tmin=(1452.87,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-228.812,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-OdCsH)"""),
)

species(
    label = 'CCCCCOOC=C=O(14107)',
    structure = SMILES('CCCCCOOC=C=O'),
    E0 = (-178.43,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (144.168,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.686975,0.106906,-9.89951e-05,5.05632e-08,-1.08527e-11,-21294.5,37.5781], Tmin=(100,'K'), Tmax=(1093.17,'K')), NASAPolynomial(coeffs=[14.3601,0.0518471,-2.34448e-05,4.48862e-09,-3.15687e-13,-24584.3,-36.3555], Tmin=(1093.17,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-178.43,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-(Cdd-O2d)OsH)"""),
)
...
species(
    label = 'CCC[CH]OO[CH]C=O(14108)',
    structure = SMILES('CCC[CH]OO[CH]C=O'),
    E0 = (-11.9135,'kJ/mol'),
    modes = [
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0159967,0.09557,-9.71487e-05,5.90064e-08,-1.56701e-11,-1296.2,33.7458], Tmin=(100,'K'), Tmax=(880.54,'K')), NASAPolynomial(coeffs=[9.21941,0.0537629,-2.59318e-05,5.08848e-09,-3.62239e-13,-2917.03,-9.48471], Tmin=(880.54,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-11.9135,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(428.195,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)OsHH) + group(Cds-OdCsH) + radical(OCJC=O) + radical(CCsJOOC)"""),
)

species(
    label = '[CH2]C(CCC)OO[CH]C=O(14109)',
    structure = SMILES('[CH2]C(CCC)OO[CH]C=O'),
    E0 = (-20.8149,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (144.168,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.705291,0.109274,-0.000100881,5.13116e-08,-1.10632e-11,-2338.84,39.9192], Tmin=(100,'K'), Tmax=(1080.95,'K')), NASAPolynomial(coeffs=[13.9146,0.055174,-2.58082e-05,5.01153e-09,-3.55064e-13,-5499.52,-31.7513], Tmin=(1080.95,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-20.8149,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(498.868,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)OsHH) + group(Cds-OdCsH) + radical(OCJC=O) + radical(CJCOOH)"""),
)

species(
    label = 'CCCCC1OOC1C=O(13352)',
    structure = SMILES('CCCCC1OOC1C=O'),
    E0 = (-240.109,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (144.168,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.698735,0.0897503,-5.66686e-05,1.57774e-08,-1.31484e-12,-28698.1,36.3026], Tmin=(100,'K'), Tmax=(1363.65,'K')), NASAPolynomial(coeffs=[19.8437,0.0417725,-1.74009e-05,3.18367e-09,-2.16648e-13,-35442.3,-73.3608], Tmin=(1363.65,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-240.109,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(511.34,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + ring(12dioxetane)"""),
)
...
species(
    label = 'CCCCC1OOC1[CH][O](14110)',
    structure = SMILES('CCCCC1OOC1[CH][O]'),
    E0 = (86.2773,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (144.168,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0604566,0.0996301,-7.48879e-05,-8.36343e-09,3.97967e-11,10506,32.3256], Tmin=(100,'K'), Tmax=(526.701,'K')), NASAPolynomial(coeffs=[7.25891,0.0645046,-3.05099e-05,5.91205e-09,-4.16832e-13,9476.6,-0.360972], Tmin=(526.701,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(86.2773,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(511.34,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(12dioxetane) + radical(CCOJ) + radical(CCsJOH)"""),
)

species(
    label = 'CCCC[CH]OOC=[C]O(14111)',
    structure = SMILES('CCCC[CH]OOC=[C]O'),
    E0 = (66.2794,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,1685,370,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,350,500,795,815,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (144.168,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.48962,0.117653,-0.00011731,6.13907e-08,-1.29126e-11,8171.89,43.0708], Tmin=(100,'K'), Tmax=(1146.41,'K')), NASAPolynomial(coeffs=[20.4332,0.0411613,-1.72272e-05,3.19023e-09,-2.20823e-13,3145.34,-65.6897], Tmin=(1146.41,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(66.2794,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(498.868,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + radical(CCsJOOC) + radical(C=CJO)"""),
)

species(
    label = 'CCCC[CH]OO[C]=CO(14112)',
    structure = SMILES('CCCC[CH]OO[C]=CO'),
    E0 = (66.2794,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,1685,370,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,350,500,795,815,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'CCCCCOO[C]=C[O](14113)',
    structure = SMILES('CCCCCOO[C]=C[O]'),
    E0 = (21.3013,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,3010,987.5,1337.5,450,1655,1685,370,2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (144.168,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.986353,0.107676,-9.569e-05,4.49229e-08,-8.64352e-12,2743.03,42.378], Tmin=(100,'K'), Tmax=(1228.74,'K')), NASAPolynomial(coeffs=[18.1271,0.0454546,-1.97315e-05,3.71057e-09,-2.58388e-13,-1954.04,-53.7706], Tmin=(1228.74,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(21.3013,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + radical(C=CJO) + radical(C=COJ)"""),
)

species(
    label = 'CCC[CH][CH]OOC=CO(14114)',
    structure = SMILES('CCC[CH][CH]OOC=CO'),
    E0 = (26.9502,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (144.168,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.03952,0.122226,-0.000121357,6.11709e-08,-1.21371e-11,3467.76,44.2199], Tmin=(100,'K'), Tmax=(1228.48,'K')), NASAPolynomial(coeffs=[25.2482,0.0333768,-1.28708e-05,2.29848e-09,-1.56407e-13,-3236.76,-93.0427], Tmin=(1228.48,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(26.9502,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(498.868,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + radical(CCJCOOH) + radical(CCsJOOC)"""),
)

species(
    label = 'CC[CH]C[CH]OOC=CO(14115)',
    structure = SMILES('CC[CH]C[CH]OOC=CO'),
    E0 = (20.9935,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,3000,3050,390,425,1340,1360,335,370,2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,350,500,795,815,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (144.168,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.47479,0.116716,-0.000115582,6.03049e-08,-1.26466e-11,2725.23,42.4523], Tmin=(100,'K'), Tmax=(1150.31,'K')), NASAPolynomial(coeffs=[20.2963,0.0410118,-1.68656e-05,3.09403e-09,-2.13009e-13,-2283.53,-65.6294], Tmin=(1150.31,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(20.9935,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(498.868,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + radical(RCCJCC) + radical(CCsJOOC)"""),
)

species(
    label = 'CCCC=COOC=CO(14116)',
    structure = SMILES('CCCC=COOC=CO'),
    E0 = (-228.099,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (144.168,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.66678,0.104764,-5.85827e-05,-1.4737e-08,1.7558e-11,-27211.9,41.1894], Tmin=(100,'K'), Tmax=(956.96,'K')), NASAPolynomial(coeffs=[28.6471,0.025206,-7.78546e-06,1.36266e-09,-9.88175e-14,-35172.7,-115.004], Tmin=(956.96,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-228.099,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-O2s(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + group(Cds-CdsOsH)"""),
)
...
species(
    label = 'CCCC[CH]OC([O])C=O(13349)',
    structure = SMILES('CCCC[CH]OC([O])C=O'),
    E0 = (-201.765,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (144.168,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.726226,0.110781,-0.000117464,7.21788e-08,-1.87493e-11,-24102.3,41.0032], Tmin=(100,'K'), Tmax=(914.704,'K')), NASAPolynomial(coeffs=[12.1641,0.0544144,-2.50346e-05,4.81641e-09,-3.392e-13,-26460.6,-20.0364], Tmin=(914.704,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-201.765,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(C=OCOJ) + radical(CCsJOCs)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['CCCC[CH]OO[CH]C=O(13351)'],
...
reaction(
    label = 'reaction2',
    reactants = ['CCCC[CH]OO[CH]C=O(13351)'],
    products = ['CCCCC1OO[CH]C1[O](14091)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'CCCC=COO[CH]C=O(14092)'],
    products = ['CCCC[CH]OO[CH]C=O(13351)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', 'CCCC[CH]OOC=C=O(14093)'],
    products = ['CCCC[CH]OO[CH]C=O(13351)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['npropyl(83)', 'C=COO[CH]C=O(4460)'],
    products = ['CCCC[CH]OO[CH]C=O(13351)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['CCC[CH]COO[CH]C=O(14094)'],
    products = ['CCCC[CH]OO[CH]C=O(13351)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['CCCC[CH]OOC[C]=O(14095)'],
    products = ['CCCC[CH]OO[CH]C=O(13351)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['CC[CH]CCOO[CH]C=O(14096)'],
    products = ['CCCC[CH]OO[CH]C=O(13351)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['C[CH]CCCOO[CH]C=O(14097)'],
    products = ['CCCC[CH]OO[CH]C=O(13351)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['CCC[CH][CH]OOCC=O(14098)'],
    products = ['CCCC[CH]OO[CH]C=O(13351)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]CCCCOO[CH]C=O(14100)'],
    products = ['CCCC[CH]OO[CH]C=O(13351)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CC[CH]C[CH]OOCC=O(14101)'],
    products = ['CCCC[CH]OO[CH]C=O(13351)'],
...
reaction(
    label = 'reaction14',
    reactants = ['C[CH]CC[CH]OOCC=O(14102)'],
    products = ['CCCC[CH]OO[CH]C=O(13351)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]CCC[CH]OOCC=O(14103)'],
    products = ['CCCC[CH]OO[CH]C=O(13351)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CCCC[CH]OO[CH]C=O(13351)'],
    products = ['CCCC[CH]OOC1[CH]O1(14104)'],
...
reaction(
    label = 'reaction21',
    reactants = ['CH2(S)(23)', 'CCC[CH]OO[CH]C=O(14108)'],
    products = ['CCCC[CH]OO[CH]C=O(13351)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH2]C(CCC)OO[CH]C=O(14109)'],
    products = ['CCCC[CH]OO[CH]C=O(13351)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[CH]CCCC(141)', '[O]O[CH]C=O(3604)'],
    products = ['CCCC[CH]OO[CH]C=O(13351)'],
...
reaction(
    label = 'reaction25',
    reactants = ['CCCC[CH]O[O](239)', 'CHCHO(47)'],
    products = ['CCCC[CH]OO[CH]C=O(13351)'],
...
reaction(
    label = 'reaction26',
    reactants = ['CCCC[CH]OO[CH]C=O(13351)'],
    products = ['CCCCC1OOC1[CH][O](14110)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(45607,'m^3/(mol*s)'), n=0.695, Ea=(234.174,'kJ/mol'), T0=(1,'K'), comment="""Estimated using average of templates [R_R;O_rad/OneDe] + [Od_CO-CsH;YJ] for rate rule [Od_CO-CsH;O_rad/OneDe]
...
reaction(
    label = 'reaction28',
    reactants = ['CCCC[CH]OOC=[C]O(14111)'],
    products = ['CCCC[CH]OO[CH]C=O(13351)'],
...
reaction(
    label = 'reaction29',
    reactants = ['CCCC[CH]OO[C]=CO(14112)'],
    products = ['CCCC[CH]OO[CH]C=O(13351)'],
...
reaction(
    label = 'reaction31',
    reactants = ['CCC[CH][CH]OOC=CO(14114)'],
    products = ['CCCC[CH]OO[CH]C=O(13351)'],
...
reaction(
    label = 'reaction32',
    reactants = ['CC[CH]C[CH]OOC=CO(14115)'],
    products = ['CCCC[CH]OO[CH]C=O(13351)'],
...
reaction(
    label = 'reaction34',
    reactants = ['CCCC[CH]OO[CH]C=O(13351)'],
    products = ['CCCC[CH][O](1728)', 'C1=COO1(3609)'],
...
reaction(
    label = 'reaction36',
    reactants = ['CCCC[CH]OO[CH]C=O(13351)'],
    products = ['CCCC[CH]OC([O])C=O(13349)'],
...
reaction(
    label = 'reaction37',
    reactants = ['O(4)', '[CH]=COO[CH]CCCC(13778)'],
    products = ['CCCC[CH]OO[CH]C=O(13351)'],
