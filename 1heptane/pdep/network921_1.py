...
species(
    label = 'CCCC1COC1[CH][O](3919)',
    structure = SMILES('CCCC1COC1[CH][O]'),
    E0 = (33.0507,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.256691,0.0876435,-6.82619e-05,3.12169e-08,-6.02651e-12,4133.3,33.522], Tmin=(100,'K'), Tmax=(1218.28,'K')), NASAPolynomial(coeffs=[12.6339,0.0453196,-1.61507e-05,2.70062e-09,-1.74762e-13,992.426,-31.2129], Tmin=(1218.28,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(33.0507,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(490.554,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Oxetane) + radical(CCOJ) + radical(CCsJOH)"""),
)
...
species(
    label = 'CCC=CCOC=C[O](3920)',
    structure = SMILES('CCC=CCOC=C[O]'),
    E0 = (-201.949,'kJ/mol'),
    modes = [
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.718583,0.0808422,-1.04092e-05,-5.94603e-08,3.28387e-11,-24098,34.7096], Tmin=(100,'K'), Tmax=(944.433,'K')), NASAPolynomial(coeffs=[26.9677,0.0206186,-5.34809e-06,9.13228e-10,-6.98853e-14,-31871.3,-110.745], Tmin=(944.433,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-201.949,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + radical(C=COJ)"""),
)

species(
    label = 'CCCC=COC=C[O](3921)',
    ...
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.671771,0.0821107,-1.95483e-05,-4.60195e-08,2.71138e-11,-21458.1,36.0393], Tmin=(100,'K'), Tmax=(949.65,'K')), NASAPolynomial(coeffs=[25.2639,0.0234747,-6.8664e-06,1.19336e-09,-8.79167e-14,-28666,-99.7603], Tmin=(949.65,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-179.968,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + radical(C=COJ)"""),
)

species(
    label = 'CCC[CH]COC=C=O(3922)',
    structure = SMILES('CCC[CH]COC=C=O'),
    E0 = (-84.2625,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.843009,0.0929826,-6.45969e-05,1.00448e-08,4.86003e-12,-9948.11,35.9594], Tmin=(100,'K'), Tmax=(995.335,'K')), NASAPolynomial(coeffs=[21.8928,0.0293786,-1.05871e-05,1.8958e-09,-1.32594e-13,-15849.4,-80.5302], Tmin=(995.335,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-84.2625,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-(Cdd-O2d)OsH) + radical(CCJCO)"""),
)
...
species(
    ...
    molecularWeight = (128.169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.993273,0.0940351,-5.37887e-05,-6.27507e-09,1.17375e-11,-15407.7,37.1722], Tmin=(100,'K'), Tmax=(970.579,'K')), NASAPolynomial(coeffs=[23.199,0.0301065,-1.02759e-05,1.81236e-09,-1.27249e-13,-21788.8,-87.4991], Tmin=(970.579,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-129.719,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(482.239,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + radical(RCCJCC) + radical(C=COJ)"""),
)
...
species(
    label = 'CCC[CH]COC=[C]O(3925)',
    structure = SMILES('CCC[CH]COC=[C]O'),
    E0 = (-25.9941,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,3615,1277.5,1000,1685,370,2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (128.169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.26094,0.0971615,-5.18619e-05,-1.87762e-08,1.91147e-11,-2919.96,39.784], Tmin=(100,'K'), Tmax=(939.217,'K')), NASAPolynomial(coeffs=[27.1688,0.0222463,-5.94286e-06,9.61615e-10,-6.86898e-14,-10296.4,-106.429], Tmin=(939.217,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-25.9941,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(478.082,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + radical(C=CJO) + radical(CCJCO)"""),
)

species(
    label = 'C[CH]CCCOC=C[O](3926)',
    ...
    molecularWeight = (128.169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.02239,0.0934756,-4.83768e-05,-1.48057e-08,1.55634e-11,-15406.9,37.448], Tmin=(100,'K'), Tmax=(958.126,'K')), NASAPolynomial(coeffs=[24.186,0.0283329,-9.16791e-06,1.5921e-09,-1.12288e-13,-22078,-92.6945], Tmin=(958.126,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-129.731,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(482.239,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + radical(RCCJC) + radical(C=COJ)"""),
)

species(
    label = 'CCC[CH]CO[C]=CO(3927)',
    structure = SMILES('CCC[CH]CO[C]=CO'),
    E0 = (-25.9941,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,3615,1277.5,1000,1685,370,2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'CCCCCO[C]=C[O](3928)',
    structure = SMILES('CCCCCO[C]=C[O]'),
    E0 = (-84.4336,'kJ/mol'),
    modes = [
...
species(
    ...
    molecularWeight = (128.169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.21149,0.0943215,-4.04539e-05,-2.98422e-08,2.24002e-11,-14098,37.1779], Tmin=(100,'K'), Tmax=(950.977,'K')), NASAPolynomial(coeffs=[27.2558,0.0238583,-7.03468e-06,1.2171e-09,-8.89634e-14,-21740.5,-110.444], Tmin=(950.977,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-118.931,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(482.239,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + radical(RCCJ) + radical(C=COJ)"""),
)
...
species(
    label = 'CCC[CH][CH]OC=CO(3931)',
    structure = SMILES('CCC[CH][CH]OC=CO'),
    E0 = (-71.8109,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (128.169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.82814,0.104664,-5.12763e-05,-3.58715e-08,2.94239e-11,-8405.18,38.166], Tmin=(100,'K'), Tmax=(921.069,'K')), NASAPolynomial(coeffs=[33.7657,0.0117194,-2.81228e-07,-1.34531e-10,5.9458e-15,-17576.4,-144.819], Tmin=(921.069,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-71.8109,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(478.082,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + radical(CCJCO) + radical(CCsJOC(O))"""),
)

species(
    label = 'CC[CH][CH]COC=CO(3932)',
    structure = SMILES('CC[CH][CH]COC=CO'),
    E0 = (-71.28,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2995,3025,975,1000,1300,1375,400,500,1630,1680,3000,3050,390,425,1340,1360,335,370,3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (128.169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.19281,0.0955829,-4.78243e-05,-2.29588e-08,2.07516e-11,-8368.92,38.9752], Tmin=(100,'K'), Tmax=(934.024,'K')), NASAPolynomial(coeffs=[26.8944,0.0223303,-5.71568e-06,8.97117e-10,-6.35023e-14,-15667.3,-105.595], Tmin=(934.024,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-71.28,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(478.082,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + radical(RCCJCC) + radical(CCJCO)"""),
)

species(
    label = 'C[CH]C[CH]COC=CO(3933)',
    structure = SMILES('C[CH]C[CH]COC=CO'),
    E0 = (-71.292,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2995,3025,975,1000,1300,1375,400,500,1630,1680,3000,3050,390,425,1340,1360,335,370,3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (128.169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.22854,0.0950948,-4.26238e-05,-3.12884e-08,2.45322e-11,-8367.83,39.275], Tmin=(100,'K'), Tmax=(928.128,'K')), NASAPolynomial(coeffs=[27.9438,0.0204525,-4.54822e-06,6.62933e-10,-4.73927e-14,-15983.2,-111.142], Tmin=(928.128,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-71.292,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(478.082,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + radical(CCJCO) + radical(RCCJC)"""),
)
...
species(
    label = 'CCC[CH]COC1[CH]O1(3934)',
    structure = SMILES('CCC[CH]COC1[CH]O1'),
    E0 = (28.2434,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.620426,0.0927379,-6.60672e-05,1.56399e-08,2.74452e-12,3571.32,37.2017], Tmin=(100,'K'), Tmax=(938.585,'K')), NASAPolynomial(coeffs=[17.2798,0.0379073,-1.27287e-05,2.10931e-09,-1.3871e-13,-733.904,-53.0564], Tmin=(938.585,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(28.2434,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(482.239,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CCJCO) + radical(CCsJO)"""),
)
...
species(
    label = 'CCCC=COC=CO(3935)',
    structure = SMILES('CCCC=COC=CO'),
    E0 = (-321.43,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.08109,0.0890508,-2.28203e-05,-5.2458e-08,3.19826e-11,-38455.3,36.0987], Tmin=(100,'K'), Tmax=(932.517,'K')), NASAPolynomial(coeffs=[28.5278,0.01977,-4.23289e-06,6.36247e-10,-4.81255e-14,-46487.3,-118.136], Tmin=(932.517,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-321.43,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(482.239,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + group(Cds-CdsOsH)"""),
)
...
species(
    label = 'CCC=CCOC=CO(3937)',
    structure = SMILES('CCC=CCOC=CO'),
    E0 = (-343.412,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.13034,0.0878097,-1.37679e-05,-6.58049e-08,3.76781e-11,-41095.1,34.7778], Tmin=(100,'K'), Tmax=(929.856,'K')), NASAPolynomial(coeffs=[30.2506,0.0168817,-2.69615e-06,3.51776e-10,-2.97356e-14,-49700.6,-129.227], Tmin=(929.856,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-343.412,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(482.239,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-CdsOsH)"""),
)
...
species(
    label = '[CH2]C(CC)COC=C[O](3938)',
    structure = SMILES('[CH2]C(CC)COC=C[O]'),
    E0 = (-124.79,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (128.169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.16696,0.0921184,-3.00284e-05,-4.54244e-08,2.97527e-11,-14802.8,36.7347], Tmin=(100,'K'), Tmax=(927.039,'K')), NASAPolynomial(coeffs=[28.156,0.0209671,-4.49653e-06,6.45459e-10,-4.66628e-14,-22618.9,-115.343], Tmin=(927.039,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-124.79,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(482.239,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + radical(C=COJ) + radical(Isobutyl)"""),
)
...
species(
    label = '[CH]=COC[CH]CCC(2869)',
    structure = SMILES('[CH]=COC[CH]CCC'),
    E0 = (190.15,'kJ/mol'),
    modes = [
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.520499,0.0833189,-3.76581e-05,-1.83652e-08,1.51789e-11,23047,34.5414], Tmin=(100,'K'), Tmax=(970.931,'K')), NASAPolynomial(coeffs=[21.8931,0.0280696,-9.60311e-06,1.71516e-09,-1.21922e-13,16946.4,-81.9331], Tmin=(970.931,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(190.15,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CCJCO) + radical(Cds_P)"""),
)
...
species(
    label = 'CC[CH][CH]COCC=O(3942)',
    structure = SMILES('CC[CH][CH]COCC=O'),
    E0 = (-16.9422,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2782.5,750,1395,475,1775,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3050,390,425,1340,1360,335,370,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (128.169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.388659,0.0865559,-7.48325e-05,4.17248e-08,-1.08555e-11,-1913.76,37.9791], Tmin=(100,'K'), Tmax=(869.296,'K')), NASAPolynomial(coeffs=[6.37496,0.0590104,-2.73019e-05,5.27344e-09,-3.72462e-13,-2954.54,9.93717], Tmin=(869.296,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-16.9422,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(478.082,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-O2d)OsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(CCJCO) + radical(RCCJCC)"""),
)

species(
    label = 'C[CH]C[CH]COCC=O(3943)',
    structure = SMILES('C[CH]C[CH]COCC=O'),
    E0 = (-16.9543,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2782.5,750,1395,475,1775,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3050,390,425,1340,1360,335,370,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (128.169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.397266,0.0856926,-6.89705e-05,3.333e-08,-7.33226e-12,-1914.81,38.1099], Tmin=(100,'K'), Tmax=(1016.74,'K')), NASAPolynomial(coeffs=[7.86357,0.0563193,-2.56362e-05,4.91628e-09,-3.45813e-13,-3433.08,1.96528], Tmin=(1016.74,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-16.9543,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(478.082,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-O2d)OsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(RCCJC) + radical(CCJCO)"""),
)

species(
    label = '[CH2]CC[CH]COCC=O(3944)',
    structure = SMILES('[CH2]CC[CH]COCC=O'),
    E0 = (-6.15419,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (128.169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0948411,0.0881446,-6.76951e-05,2.79603e-08,-4.9218e-12,-601.832,38.2254], Tmin=(100,'K'), Tmax=(1286.67,'K')), NASAPolynomial(coeffs=[12.8015,0.0486425,-2.16438e-05,4.09973e-09,-2.85708e-13,-3871.7,-26.2797], Tmin=(1286.67,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-6.15419,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(478.082,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-O2d)OsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(RCCJ) + radical(CCJCO)"""),
)
...
species(
    label = 'CCC=CCOCC=O(3947)',
    structure = SMILES('CCC=CCOCC=O'),
    E0 = (-289.074,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.175726,0.0824361,-5.49965e-05,1.85757e-08,-2.60777e-12,-34629.4,34.7367], Tmin=(100,'K'), Tmax=(1588.58,'K')), NASAPolynomial(coeffs=[15.2502,0.0444793,-1.91564e-05,3.53509e-09,-2.40789e-13,-39418.8,-44.966], Tmin=(1588.58,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-289.074,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(482.239,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-(Cds-O2d)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-OdCsH)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'CCC=CCOC=C[O](3920)'],
    products = ['CCC[CH]CO[CH]C=O(1335)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', 'CCCC=COC=C[O](3921)'],
    products = ['CCC[CH]CO[CH]C=O(1335)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)', 'CCC[CH]COC=C=O(3922)'],
    products = ['CCC[CH]CO[CH]C=O(1335)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['C2H5(29)', 'C=CCOC=C[O](3307)'],
    products = ['CCC[CH]CO[CH]C=O(1335)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction16',
    reactants = ['CCC[CH][CH]OC=CO(3931)'],
    products = ['CCC[CH]CO[CH]C=O(1335)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CC[CH][CH]COC=CO(3932)'],
    products = ['CCC[CH]CO[CH]C=O(1335)'],
...
reaction(
    label = 'reaction18',
    reactants = ['C[CH]C[CH]COC=CO(3933)'],
    products = ['CCC[CH]CO[CH]C=O(1335)'],
...
reaction(
    label = 'reaction20',
    reactants = ['CHCHO(47)', 'CCC[CH]C[O](1725)'],
    products = ['CCC[CH]CO[CH]C=O(1335)'],
...
reaction(
    label = 'reaction21',
    reactants = ['CCC[CH]CO[CH]C=O(1335)'],
    products = ['CCC[CH]COC1[CH]O1(3934)'],
...
reaction(
    label = 'reaction26',
    reactants = ['CH2(S)(23)', 'CC[CH]CO[CH]C=O(1323)'],
    products = ['CCC[CH]CO[CH]C=O(1335)'],
...
reaction(
    label = 'reaction27',
    reactants = ['[CH2]C(CC)COC=C[O](3938)'],
    products = ['CCC[CH]CO[CH]C=O(1335)'],
...
reaction(
    label = 'reaction30',
    reactants = ['[CH]CCC(133)', '[CH2]OC=C[O](2549)'],
    products = ['CCC[CH]CO[CH]C=O(1335)'],
...
reaction(
    label = 'reaction31',
    reactants = ['O(4)', '[CH]=COC[CH]CCC(2869)'],
    products = ['CCC[CH]CO[CH]C=O(1335)'],
...
reaction(
    label = 'reaction35',
    reactants = ['CC[CH][CH]COCC=O(3942)'],
    products = ['CCC[CH]CO[CH]C=O(1335)'],
...
reaction(
    label = 'reaction36',
    reactants = ['C[CH]C[CH]COCC=O(3943)'],
    products = ['CCC[CH]CO[CH]C=O(1335)'],
...
reaction(
    label = 'reaction37',
    reactants = ['[CH2]CC[CH]COCC=O(3944)'],
    products = ['CCC[CH]CO[CH]C=O(1335)'],
