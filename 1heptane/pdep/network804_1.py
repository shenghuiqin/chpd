...
species(
    label = 'C=C(C)C(C)[O](1909)',
    structure = SMILES('C=C(C)C(C)[O]'),
    E0 = (1.97728,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,440,435,1725,2950,3100,1380,975,1025,1650,1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,453.211,453.558],'cm^-1')),
        HinderedRotor(inertia=(0.077848,'amu*angstrom^2'), symmetry=1, barrier=(11.3428,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0779045,'amu*angstrom^2'), symmetry=1, barrier=(11.3475,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.077948,'amu*angstrom^2'), symmetry=1, barrier=(11.3422,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'C=C(C)C(C)[O](1909)'],
    products = ['[CH2]C(C)C(C)[O](1219)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', '[CH2]C(C)C(C)=O(1910)'],
    products = ['[CH2]C(C)C(C)[O](1219)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['CH3(17)', 'C=CC(C)[O](1661)'],
    products = ['[CH2]C(C)C(C)[O](1219)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['CH3(17)', 'iC4H7OJ_48(1671)'],
    products = ['[CH2]C(C)C(C)[O](1219)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2]C([CH2])C(C)O(1915)'],
    products = ['[CH2]C(C)C(C)[O](1219)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CH2(S)(23)', '[CH2]C(C)C[O](1004)'],
    products = ['[CH2]C(C)C(C)[O](1219)'],
...
reaction(
    label = 'reaction23',
    reactants = ['CH2(19)', 'C[CH]C(C)[O](1663)'],
    products = ['[CH2]C(C)C(C)[O](1219)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[CH2]C(C)[CH]C(433)', 'O(4)'],
    products = ['[CH2]C(C)C(C)[O](1219)'],
