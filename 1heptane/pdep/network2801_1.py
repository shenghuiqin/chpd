...
species(
    label = 'CCC=CCC[CH]OO(15778)',
    structure = SMILES('CCC=CCC[CH]OO'),
    E0 = (1.28691,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2995,3025,975,1000,1300,1375,400,500,1630,1680,3025,407.5,1350,352.5,3615,1310,387.5,850,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.165644,0.0957016,-7.7298e-05,3.46057e-08,-6.67946e-12,301.193,35.6115], Tmin=(100,'K'), Tmax=(1179.48,'K')), NASAPolynomial(coeffs=[12.1354,0.0539846,-2.42442e-05,4.6184e-09,-3.23386e-13,-2600.55,-25.7644], Tmin=(1179.48,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(1.28691,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(CCsJOOH)"""),
)

species(
    label = 'CCCC=CC[CH]OO(15779)',
    structure = SMILES('CCCC=CC[CH]OO'),
    E0 = (1.28691,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2995,3025,975,1000,1300,1375,400,500,1630,1680,3025,407.5,1350,352.5,3615,1310,387.5,850,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'CCC[CH]CC=COO(15780)',
    structure = SMILES('CCC[CH]CC=COO'),
    E0 = (22.298,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2995,3025,975,1000,1300,1375,400,500,1630,1680,3025,407.5,1350,352.5,3615,1310,387.5,850,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (129.177,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0104425,0.0919928,-7.34703e-05,3.32717e-08,-6.55625e-12,2822.95,37.6776], Tmin=(100,'K'), Tmax=(1153.27,'K')), NASAPolynomial(coeffs=[11.0376,0.0536739,-2.3631e-05,4.46132e-09,-3.1091e-13,274.662,-17.1984], Tmin=(1153.27,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(22.298,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(RCCJCC)"""),
)
...
species(
    label = 'CC[CH]CCC[CH]OO(15781)',
    structure = SMILES('CC[CH]CCC[CH]OO'),
    E0 = (79.0735,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,3000,3050,390,425,1340,1360,335,370,3615,1310,387.5,850,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'C[CH]CCCC[CH]OO(15782)',
    structure = SMILES('C[CH]CCCC[CH]OO'),
    E0 = (79.0615,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (130.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.214463,0.0967297,-5.76549e-05,-4.23521e-08,6.44549e-11,9631.84,36.4644], Tmin=(100,'K'), Tmax=(508.987,'K')), NASAPolynomial(coeffs=[6.92223,0.0657467,-3.03907e-05,5.82102e-09,-4.07502e-13,8667.51,5.86806], Tmin=(508.987,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(79.0615,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(523.812,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(RCCJC) + radical(CCsJOOH)"""),
)

species(
    label = 'CCCCC[CH][CH]OO(15783)',
    structure = SMILES('CCCCC[CH][CH]OO'),
    E0 = (85.0302,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,3000,3050,390,425,1340,1360,335,370,3615,1310,387.5,850,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (130.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.595104,0.109079,-0.000111295,7.02632e-08,-1.94498e-11,10385.2,38.7791], Tmin=(100,'K'), Tmax=(848.51,'K')), NASAPolynomial(coeffs=[9.2828,0.0625136,-2.89758e-05,5.58558e-09,-3.93543e-13,8708.94,-7.25345], Tmin=(848.51,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(85.0302,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(523.812,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCJCOOH) + radical(CCsJOOH)"""),
)
...
species(
    label = '[CH2]CCCCC[CH]OO(15784)',
    structure = SMILES('[CH2]CCCCC[CH]OO'),
    E0 = (89.8616,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (130.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.529085,0.107174,-0.0001038,6.07975e-08,-1.55996e-11,10964.5,38.0222], Tmin=(100,'K'), Tmax=(909.387,'K')), NASAPolynomial(coeffs=[9.87648,0.0614044,-2.83038e-05,5.45138e-09,-3.84251e-13,9071.98,-11.1902], Tmin=(909.387,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(89.8616,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(523.812,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(RCCJ) + radical(CCsJOOH)"""),
)
...
species(
    label = 'CCCCCC=COO(15785)',
    structure = SMILES('CCCCCC=COO'),
    E0 = (-172.16,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (130.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.90255,0.0989773,-7.51905e-05,2.9658e-08,-4.77565e-12,-20522.6,38.3177], Tmin=(100,'K'), Tmax=(1452.54,'K')), NASAPolynomial(coeffs=[19.407,0.0430488,-1.74346e-05,3.14989e-09,-2.13275e-13,-26422.6,-67.2459], Tmin=(1452.54,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-172.16,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(527.969,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH)"""),
)
...
species(
    label = '[CH2]C(CC)CC[CH]OO(15786)',
    structure = SMILES('[CH2]C(CC)CC[CH]OO'),
    E0 = (87.3504,'kJ/mol'),
    modes = [
...
reaction(
    label = 'reaction1',
    reactants = ['CCC[CH]CC[CH]OO(11638)'],
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'CCC=CCC[CH]OO(15778)'],
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'CCCC=CC[CH]OO(15779)'],
    products = ['CCC[CH]CC[CH]OO(11638)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(1.46e+08,'cm^3/(mol*s)'), n=1.64, Ea=(5.73208,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""From training reaction 2555 used for Cds-CsH_Cds-CsH;HJ
Exact match found for rate rule [Cds-CsH_Cds-CsH;HJ]
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', 'CCC[CH]CC=COO(15780)'],
    products = ['CCC[CH]CC[CH]OO(11638)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['C2H5(29)', 'C=CCC[CH]OO(11621)'],
    products = ['CCC[CH]CC[CH]OO(11638)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['OH(5)', 'CCC[CH]CCC=O(1225)'],
    products = ['CCC[CH]CC[CH]OO(11638)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['CC[CH]CCC[CH]OO(15781)'],
    products = ['CCC[CH]CC[CH]OO(11638)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['CCC[CH]CC[CH]OO(11638)'],
    products = ['CCC[CH]C[CH]COO(12923)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CCC[CH]CC[CH]OO(11638)'],
    products = ['C[CH]CCCC[CH]OO(15782)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CCCCC[CH][CH]OO(15783)'],
    products = ['CCC[CH]CC[CH]OO(11638)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CCC[CH][CH]CCOO(12927)'],
    products = ['CCC[CH]CC[CH]OO(11638)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]CCCCC[CH]OO(15784)'],
    products = ['CCC[CH]CC[CH]OO(11638)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CC[CH][CH]CCCOO(12926)'],
    products = ['CCC[CH]CC[CH]OO(11638)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CCC[CH]CC[CH]OO(11638)'],
    products = ['C[CH]C[CH]CCCOO(12925)'],
    transitionState = 'TS18',
    kinetics = Arrhenius(A=(9.4e-19,'s^-1'), n=8.84, Ea=(125.52,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2500,'K'), comment="""Estimated using template [RnH;C_rad_out_H/NonDeO;Cs_H_out_H/NonDeC] for rate rule [R6HJ_3;C_rad_out_H/NonDeO;Cs_H_out_H/NonDeC]
Euclidian distance = 2.0
Multiplied by reaction path degeneracy 2.0
family: intra_H_migration"""),
)
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2]CC[CH]CCCOO(12928)'],
    products = ['CCC[CH]CC[CH]OO(11638)'],
...
reaction(
    label = 'reaction25',
    reactants = ['CH2(S)(23)', 'CC[CH]CC[CH]OO(2090)'],
    products = ['CCC[CH]CC[CH]OO(11638)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[CH2]C(CC)CC[CH]OO(15786)'],
    products = ['CCC[CH]CC[CH]OO(11638)'],
...
reaction(
    label = 'reaction31',
    reactants = ['[CH]CCC(133)', '[CH2]C[CH]OO(468)'],
    products = ['CCC[CH]CC[CH]OO(11638)'],
...
reaction(
    label = 'reaction32',
    reactants = ['[CH]OO(168)', '[CH2]C[CH]CCC(203)'],
    products = ['CCC[CH]CC[CH]OO(11638)'],
