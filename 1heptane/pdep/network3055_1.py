...
species(
    label = '[CH]=C(O)OC[CH2](16714)',
    structure = SMILES('[CH]=C(O)OC[CH2]'),
    E0 = (116.042,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3120,650,792.5,1650,3615,1277.5,1000,3000,3100,440,815,1455,1000,350,440,435,1725,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.704975,'amu*angstrom^2'), symmetry=1, barrier=(16.2088,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.705965,'amu*angstrom^2'), symmetry=1, barrier=(16.2315,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.705233,'amu*angstrom^2'), symmetry=1, barrier=(16.2147,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.133289,0.0756502,-8.96112e-05,5.06377e-08,-1.07976e-11,14103.9,23.3838], Tmin=(100,'K'), Tmax=(1243.22,'K')), NASAPolynomial(coeffs=[19.9267,0.00714049,-1.12926e-06,6.80015e-11,-6.45576e-16,9555.26,-74.9174], Tmin=(1243.22,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(116.042,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(Cds_P) + radical(CJCO)"""),
)
...
species(
    ...
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.75948,0.0432707,-2.57253e-05,7.24336e-09,-8.09743e-13,-1750.97,22.9148], Tmin=(100,'K'), Tmax=(2047.43,'K')), NASAPolynomial(coeffs=[14.5324,0.0183166,-7.44321e-06,1.29045e-09,-8.28646e-14,-6981.26,-47.8598], Tmin=(2047.43,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-15.2724,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)HHH) + group(Cds-OdCsOs) + radical(CCJ2_triplet)"""),
)
...
species(
    ...
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.41325,0.0347135,4.12642e-05,-9.46214e-08,4.32327e-11,-23295.4,16.8488], Tmin=(100,'K'), Tmax=(927.977,'K')), NASAPolynomial(coeffs=[22.3265,0.00163154,2.50024e-06,-5.08144e-10,2.6328e-14,-29633.7,-95.7206], Tmin=(927.977,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-194.634,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsCs) + ring(Cyclobutene)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', '[CH]=C(O)OC=C(16328)'],
    products = ['[CH]=C(O)O[CH]C(3256)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction12',
    reactants = ['CHCH3(T)(95)', '[CH]=C([O])O(7862)'],
    products = ['[CH]=C(O)O[CH]C(3256)'],
