species(
    ...
    E0 = (-178.064,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3615,1310,387.5,850,1000,2750,2800,2850,1350,1500,750,1050,1375,1000],'cm^-1')),
        HinderedRotor(inertia=(0.608718,'amu*angstrom^2'), symmetry=1, barrier=(13.9956,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.107619,'amu*angstrom^2'), symmetry=1, barrier=(2.47438,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0268676,'amu*angstrom^2'), symmetry=1, barrier=(13.953,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[4.14672,0.00978668,4.91492e-05,-7.42532e-08,3.11169e-11,-21467.1,9.84025], Tmin=(200,'K'), Tmax=(1000,'K')), NASAPolynomial(coeffs=[9.58691,0.0148604,-5.29788e-06,8.47317e-10,-5.03436e-14,-23836.8,-22.8311], Tmin=(1000,'K'), Tmax=(6000,'K'))], Tmin=(200,'K'), Tmax=(6000,'K'), E0=(-178.064,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), label="""CH3CH2OOH""", comment="""Thermo library: Klippenstein_Glarborg2016"""),
)
...
species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.191013,'amu*angstrom^2'), symmetry=1, barrier=(4.39177,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
reaction(
    label = 'reaction1',
    reactants = ['CH3CH2OOH(62)'],
    products = ['OH(5)', 'CH3CH2O(38)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(1.38e+33,'s^-1'), n=-5.27, Ea=(48696,'cal/mol'), T0=(1,'K')),
)

reaction(
    label = 'reaction2',
    reactants = ['HO2(10)', 'C2H5(29)'],
    products = ['CH3CH2OOH(62)'],
    transitionState = 'TS2',
