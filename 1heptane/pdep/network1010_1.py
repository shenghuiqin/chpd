...
species(
    label = 'C=C(C)C[CH]CC(1442)',
    structure = SMILES('C=C(C)C[CH]CC'),
    E0 = (91.321,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2950,3100,1380,975,1025,1650,3025,407.5,1350,352.5,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,350,440,435,1725,200,800,1600],'cm^-1')),
...
species(
    label = '[CH2]C(C)C=CCC(1443)',
    structure = SMILES('[CH2]C(C)C=CCC'),
    E0 = (98.1373,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2995,3025,975,1000,1300,1375,400,500,1630,1680,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,567.624,567.625],'cm^-1')),
        HinderedRotor(inertia=(0.121443,'amu*angstrom^2'), symmetry=1, barrier=(2.7922,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.121444,'amu*angstrom^2'), symmetry=1, barrier=(2.79223,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.12144,'amu*angstrom^2'), symmetry=1, barrier=(2.79215,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.616539,'amu*angstrom^2'), symmetry=1, barrier=(14.1754,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2]C(C)CC=CC(1444)',
    structure = SMILES('[CH2]C(C)CC=CC'),
    E0 = (95.933,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2995,3025,975,1000,1300,1375,400,500,1630,1680,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,245.209,246.994],'cm^-1')),
        HinderedRotor(inertia=(0.14328,'amu*angstrom^2'), symmetry=1, barrier=(6.03951,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00279643,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.138192,'amu*angstrom^2'), symmetry=1, barrier=(6.08807,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00271354,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.380333,'amu*angstrom^2'), symmetry=1, barrier=(17.0897,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (97.1781,'amu'),
...
species(
    ...
    molecularWeight = (98.1861,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.36545,0.0603672,-2.56064e-05,4.1662e-09,-1.96242e-13,19101.9,24.8044], Tmin=(100,'K'), Tmax=(2638.69,'K')), NASAPolynomial(coeffs=[39.5847,0.0154772,-6.64283e-06,1.03112e-09,-5.61151e-14,-4554.39,-198.477], Tmin=(2638.69,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(158.542,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(482.239,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Tertalkyl) + radical(RCCJCC)"""),
)
...
species(
    ...
    molecularWeight = (98.1861,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.660991,0.0715562,-4.16095e-05,1.2975e-08,-1.74726e-12,21552.3,32.5515], Tmin=(100,'K'), Tmax=(1590.35,'K')), NASAPolynomial(coeffs=[10.4815,0.046856,-1.83125e-05,3.20901e-09,-2.12057e-13,18428.7,-19.3828], Tmin=(1590.35,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(178.19,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(482.239,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJC) + radical(Isobutyl)"""),
)

species(
    label = 'CC[CH][CH]C(C)C(1447)',
    ...
    molecularWeight = (98.1861,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.1872,0.0651562,-3.07362e-05,6.25722e-09,-4.59661e-13,20262.9,30.5903], Tmin=(100,'K'), Tmax=(2314.98,'K')), NASAPolynomial(coeffs=[25.4873,0.0293978,-1.16026e-05,1.90949e-09,-1.15664e-13,7342.89,-110.646], Tmin=(2314.98,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(167.661,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(482.239,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Cs_S) + radical(RCCJCC)"""),
)

species(
    label = '[CH2][C](C)CCCC(1448)',
    ...
    molecularWeight = (98.1861,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.750935,0.0760595,-5.83798e-05,3.1446e-08,-8.32658e-12,20458.9,30.654], Tmin=(100,'K'), Tmax=(838.452,'K')), NASAPolynomial(coeffs=[4.70913,0.0571759,-2.45965e-05,4.584e-09,-3.17087e-13,19795.2,12.2555], Tmin=(838.452,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(169.166,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(482.239,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Tertalkyl) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]CCCC([CH2])C(1449)',
    ...
    molecularWeight = (98.1861,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0269333,0.0773043,-4.94345e-05,1.67238e-08,-2.34481e-12,22881.5,33.9038], Tmin=(100,'K'), Tmax=(1629.7,'K')), NASAPolynomial(coeffs=[15.4282,0.0395031,-1.46423e-05,2.49139e-09,-1.61555e-13,17861.5,-47.9208], Tmin=(1629.7,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(188.99,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(482.239,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Isobutyl) + radical(RCCJ)"""),
)
...
species(
    ...
    molecularWeight = (98.1861,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.54468,0.0630055,-2.83808e-05,5.50503e-09,-3.88662e-13,20232.5,29.4438], Tmin=(100,'K'), Tmax=(2551.5,'K')), NASAPolynomial(coeffs=[29.856,0.0246795,-9.4107e-06,1.47897e-09,-8.53558e-14,3813.39,-137.525], Tmin=(2551.5,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(167.566,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(482.239,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(RCCJC)"""),
)

species(
    label = '[CH2]C[CH]CC(C)C(1451)',
    structure = SMILES('[CH2]C[CH]CC(C)C'),
    E0 = (178.366,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3025,407.5,1350,352.5,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,215.812,913.351,1830.29],'cm^-1')),
    ...
    molecularWeight = (98.1861,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.940212,0.0684935,-3.56111e-05,8.78833e-09,-8.72799e-13,21560,30.6824], Tmin=(100,'K'), Tmax=(2162.62,'K')), NASAPolynomial(coeffs=[16.1193,0.0404181,-1.6138e-05,2.7854e-09,-1.78858e-13,14994.7,-54.256], Tmin=(2162.62,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(178.366,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(482.239,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJ) + radical(RCCJCC)"""),
)

species(
    label = 'C=C(C)CCCC(1452)',
    ...
    molecularWeight = (98.1861,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.183787,0.0734567,-3.86623e-05,6.98526e-09,4.17467e-13,-12258.6,29.0408], Tmin=(100,'K'), Tmax=(1300.42,'K')), NASAPolynomial(coeffs=[14.1904,0.0425138,-1.69744e-05,3.046e-09,-2.05395e-13,-16928,-46.1593], Tmin=(1300.42,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-103.137,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(486.397,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH)"""),
)

species(
    label = 'CCC=CC(C)C(1453)',
...
species(
    ...
    molecularWeight = (98.1861,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.497198,0.0654794,-1.58984e-05,-1.6249e-08,8.34351e-12,-12991.9,27.9792], Tmin=(100,'K'), Tmax=(1104.02,'K')), NASAPolynomial(coeffs=[12.4043,0.0446572,-1.7932e-05,3.29033e-09,-2.27604e-13,-16981.2,-36.804], Tmin=(1104.02,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-109.149,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(486.397,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'C=C(C)C[CH]CC(1442)'],
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', '[CH2]C(C)C=CCC(1443)'],
    products = ['[CH2]C(C)C[CH]CC(635)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', '[CH2]C(C)CC=CC(1444)'],
    products = ['[CH2]C(C)C[CH]CC(635)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(1.46e+08,'cm^3/(mol*s)'), n=1.64, Ea=(5.73208,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""From training reaction 2555 used for Cds-CsH_Cds-CsH;HJ
Exact match found for rate rule [Cds-CsH_Cds-CsH;HJ]
...
reaction(
    label = 'reaction6',
    reactants = ['CH3(17)', 'C=CC[CH]CC(368)'],
    products = ['[CH2]C(C)C[CH]CC(635)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['CH3(17)', '[CH2]C(C)CC=C(526)'],
    products = ['[CH2]C(C)C[CH]CC(635)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]C[CH]CC(C)C(1451)'],
    products = ['[CH2]C(C)C[CH]CC(635)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH2]CC[CH]CC(195)', 'CH2(S)(23)'],
    products = ['[CH2]C(C)C[CH]CC(635)'],
...
reaction(
    label = 'reaction23',
    reactants = ['CH2(S)(23)', '[CH2]C(C)C[CH]C(519)'],
    products = ['[CH2]C(C)C[CH]CC(635)'],
...
reaction(
    label = 'reaction27',
    reactants = ['[CH2]C(C)CC([CH2])C(1455)'],
    products = ['[CH2]C(C)C[CH]CC(635)'],
...
reaction(
    label = 'reaction29',
    reactants = ['C[CH]C[CH]CC(375)', 'CH2(19)'],
    products = ['[CH2]C(C)C[CH]CC(635)'],
...
reaction(
    label = 'reaction30',
    reactants = ['[CH2]C([CH2])C(438)', '[CH]CC(144)'],
    products = ['[CH2]C(C)C[CH]CC(635)'],
