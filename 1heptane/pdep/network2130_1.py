...
species(
    label = 'CC[CH]OOC=O(11538)',
    structure = SMILES('CC[CH]OOC=O'),
    E0 = (-264.847,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2782.5,750,1395,475,1775,1000,3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2850,1437.5,1250,1305,750,350,476.066],'cm^-1')),
        HinderedRotor(inertia=(0.220066,'amu*angstrom^2'), symmetry=1, barrier=(35.3929,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.220066,'amu*angstrom^2'), symmetry=1, barrier=(35.3928,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.220066,'amu*angstrom^2'), symmetry=1, barrier=(35.3929,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.220066,'amu*angstrom^2'), symmetry=1, barrier=(35.3929,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.220066,'amu*angstrom^2'), symmetry=1, barrier=(35.3928,'kJ/mol'), semiclassical=False),
    ],
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.970119,0.0540111,-1.38187e-05,-2.01089e-08,1.08511e-11,-31733.8,26.793], Tmin=(100,'K'), Tmax=(1051.69,'K')), NASAPolynomial(coeffs=[15.488,0.0254,-1.09596e-05,2.13414e-09,-1.5469e-13,-36258.9,-50.9744], Tmin=(1051.69,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-264.847,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-O2d)) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdOsH) + radical(CCsJOOC)"""),
)

species(
    label = 'CC=COO[CH]O(11539)',
    structure = SMILES('CC=COO[CH]O'),
    E0 = (-81.2464,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2995,3025,975,1000,1300,1375,400,500,1630,1680,3025,407.5,1350,352.5,3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,357.896],'cm^-1')),
        HinderedRotor(inertia=(0.435888,'amu*angstrom^2'), symmetry=1, barrier=(10.0219,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.7084,'amu*angstrom^2'), symmetry=1, barrier=(16.2875,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.706964,'amu*angstrom^2'), symmetry=1, barrier=(16.2545,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.706689,'amu*angstrom^2'), symmetry=1, barrier=(16.2482,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (103.097,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.522987,0.0755094,-8.10972e-05,4.50959e-08,-9.99377e-12,-9645.6,27.5067], Tmin=(100,'K'), Tmax=(1095.06,'K')), NASAPolynomial(coeffs=[14.7036,0.0237112,-1.01453e-05,1.90111e-09,-1.3256e-13,-12751.4,-42.1946], Tmin=(1095.06,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-81.2464,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(O2s-CsH) + group(Cs-(Cds-Cds)HHH) + group(Cs-OsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(OCJO)"""),
)
...
species(
    label = 'CC[CH]OOC[O](11540)',
    structure = SMILES('CC[CH]OOC[O]'),
    E0 = (12.9599,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (104.105,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.01958,0.0654569,-4.87332e-05,1.82202e-08,-2.81831e-12,1665.5,26.4545], Tmin=(100,'K'), Tmax=(1466.93,'K')), NASAPolynomial(coeffs=[13.1519,0.0323749,-1.49055e-05,2.8468e-09,-1.98327e-13,-1893.96,-36.7257], Tmin=(1466.93,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(12.9599,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsOsHH) + radical(CCsJOOC) + radical(OCOJ)"""),
)

species(
    label = 'C[CH]COO[CH]O(11541)',
    structure = SMILES('C[CH]COO[CH]O'),
    E0 = (-11.5036,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (104.105,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.357781,0.0855466,-0.000108653,7.74674e-08,-2.26321e-11,-1257.28,30.173], Tmin=(100,'K'), Tmax=(829.387,'K')), NASAPolynomial(coeffs=[10.9658,0.034388,-1.61329e-05,3.1025e-09,-2.17424e-13,-3016.99,-19.0205], Tmin=(829.387,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-11.5036,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(332.579,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsOsHH) + radical(OCJO) + radical(CCJCOOH)"""),
)

species(
    label = '[CH2]CCOO[CH]O(11542)',
    structure = SMILES('[CH2]CCOO[CH]O'),
    E0 = (-6.67223,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (104.105,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.411562,0.083748,-0.000101353,6.80188e-08,-1.86926e-11,-677.458,29.4625], Tmin=(100,'K'), Tmax=(879.564,'K')), NASAPolynomial(coeffs=[11.4731,0.0334432,-1.55633e-05,2.99389e-09,-2.10344e-13,-2623.31,-22.4834], Tmin=(879.564,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-6.67223,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(332.579,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsOsHH) + radical(OCJO) + radical(RCCJ)"""),
)

species(
    label = 'C[CH][CH]OOCO(11543)',
    structure = SMILES('C[CH][CH]OOCO'),
    E0 = (-14.0231,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2750,2850,1437.5,1250,1305,750,350,3000,3050,390,425,1340,1360,335,370,3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (104.105,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0712752,0.0752987,-5.80786e-05,1.26559e-08,2.82794e-12,-1535.29,31.6913], Tmin=(100,'K'), Tmax=(994.084,'K')), NASAPolynomial(coeffs=[19.8456,0.0184862,-6.68913e-06,1.21956e-09,-8.70132e-14,-6591.11,-69.2463], Tmin=(994.084,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-14.0231,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(332.579,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsOsHH) + radical(CCJCOOH) + radical(CCsJOOC)"""),
)

species(
    label = 'CCCOO[CH][O](11544)',
    structure = SMILES('CCCOO[CH][O]'),
    E0 = (15.4793,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (104.105,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.710067,0.0830442,-0.000126974,1.22873e-07,-4.75324e-11,1969.79,27.0596], Tmin=(100,'K'), Tmax=(802.561,'K')), NASAPolynomial(coeffs=[2.92545,0.0503724,-2.54824e-05,4.9849e-09,-3.49144e-13,2310.8,21.1988], Tmin=(802.561,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(15.4793,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsOsHH) + radical(OCJO) + radical(OCOJ)"""),
)

species(
    label = '[CH2]C[CH]OOCO(11545)',
    structure = SMILES('[CH2]C[CH]OOCO'),
    E0 = (-9.19167,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,3025,407.5,1350,352.5,3615,1277.5,1000,3000,3100,440,815,1455,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,200,800],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (104.105,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.095086,0.0738708,-5.21729e-05,5.20398e-09,5.80622e-12,-954.177,31.0873], Tmin=(100,'K'), Tmax=(980.99,'K')), NASAPolynomial(coeffs=[20.304,0.0176272,-6.17035e-06,1.12322e-09,-8.09698e-14,-6177.78,-72.4362], Tmin=(980.99,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-9.19167,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(332.579,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsOsHH) + radical(CCsJOOC) + radical(RCCJ)"""),
)
...
species(
    label = 'CC=COOCO(11546)',
    structure = SMILES('CC=COOCO'),
    E0 = (-270.207,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (104.105,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.36164,0.0616994,-9.76185e-06,-4.62058e-08,2.618e-11,-32350.5,28.2918], Tmin=(100,'K'), Tmax=(940.142,'K')), NASAPolynomial(coeffs=[23.1219,0.0108494,-2.00389e-06,3.22926e-10,-2.84729e-14,-38662.5,-90.9172], Tmin=(940.142,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-270.207,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(O2s-CsH) + group(Cs-(Cds-Cds)HHH) + group(Cs-OsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH)"""),
)

species(
    label = 'CCCOOC=O(11547)',
    structure = SMILES('CCCOOC=O'),
    E0 = (-451.288,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (104.105,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.952156,0.0523116,-3.21394e-07,-3.62897e-08,1.68582e-11,-54154.8,26.561], Tmin=(100,'K'), Tmax=(1026.48,'K')), NASAPolynomial(coeffs=[16.016,0.0266923,-1.12259e-05,2.18911e-09,-1.59975e-13,-58990.2,-54.9963], Tmin=(1026.48,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-451.288,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-O2d)) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdOsH)"""),
)
...
species(
    label = 'C[CH]OO[CH]O(1198)',
    structure = SMILES('C[CH]OO[CH]O'),
    E0 = (-1.69764,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,3000,3050,390,425,1340,1360,335,370,3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,352.228],'cm^-1')),
        HinderedRotor(inertia=(0.0787445,'amu*angstrom^2'), symmetry=1, barrier=(6.78552,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.532925,'amu*angstrom^2'), symmetry=1, barrier=(46.4351,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.169214,'amu*angstrom^2'), symmetry=1, barrier=(14.9642,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0770918,'amu*angstrom^2'), symmetry=1, barrier=(6.74487,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.529606,'amu*angstrom^2'), symmetry=1, barrier=(46.3958,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.988657,0.0705983,-9.32406e-05,6.7874e-08,-2.00542e-11,-99.6837,23.6503], Tmin=(100,'K'), Tmax=(823.369,'K')), NASAPolynomial(coeffs=[10.1317,0.0261832,-1.23308e-05,2.36686e-09,-1.65425e-13,-1605.4,-18.6834], Tmin=(823.369,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1.69764,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(261.906,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsOsHH) + radical(CCsJOOC) + radical(OCJO)"""),
)

species(
    label = '[CH2]C(C)OO[CH]O(11548)',
    structure = SMILES('[CH2]C(C)OO[CH]O'),
    E0 = (-10.599,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1277.5,1000,1380,1390,370,380,2900,435,350,500,795,815,3000,3100,440,815,1455,1000,200],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (104.105,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.265664,0.0841259,-9.55027e-05,5.72174e-08,-1.37853e-11,-1141.88,29.8436], Tmin=(100,'K'), Tmax=(1005.63,'K')), NASAPolynomial(coeffs=[14.1882,0.0287482,-1.29023e-05,2.45942e-09,-1.7265e-13,-3942.1,-37.403], Tmin=(1005.63,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-10.599,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(332.579,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-OsOsHH) + radical(OCJO) + radical(CJCOOH)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'CC[CH]OOC=O(11538)'],
    products = ['CC[CH]OO[CH]O(11395)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'CC=COO[CH]O(11539)'],
    products = ['CC[CH]OO[CH]O(11395)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CH3(17)', 'C=COO[CH]O(5085)'],
    products = ['CC[CH]OO[CH]O(11395)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction14',
    reactants = ['CH2(S)(23)', 'C[CH]OO[CH]O(1198)'],
    products = ['CC[CH]OO[CH]O(11395)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]C(C)OO[CH]O(11548)'],
    products = ['CC[CH]OO[CH]O(11395)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH]CC(144)', '[O]O[CH]O(4538)'],
    products = ['CC[CH]OO[CH]O(11395)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CC[CH]O[O](238)', 'HCOH(T)(285)'],
    products = ['CC[CH]OO[CH]O(11395)'],
