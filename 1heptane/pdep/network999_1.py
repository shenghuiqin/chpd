...
species(
    ...
    molecularWeight = (111.205,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.148121,0.078995,-3.04968e-05,-9.52742e-09,7.66871e-12,9102.87,35.7128], Tmin=(100,'K'), Tmax=(1057.55,'K')), NASAPolynomial(coeffs=[14.3668,0.0471522,-1.80358e-05,3.23347e-09,-2.21473e-13,4743.44,-41.2215], Tmin=(1057.55,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(74.3571,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(532.126,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]C(CC)CC=CC(1482)',
    ...
    molecularWeight = (111.205,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.479771,0.0857328,-5.40473e-05,1.77245e-08,-2.38865e-12,9252.49,36.2282], Tmin=(100,'K'), Tmax=(1700.07,'K')), NASAPolynomial(coeffs=[18.0544,0.0421253,-1.5572e-05,2.63695e-09,-1.70006e-13,2950.55,-63.0242], Tmin=(1700.07,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(75.4999,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(532.126,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Isobutyl)"""),
)
...
species(
    ...
    molecularWeight = (112.213,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.97982,0.0727627,-3.34007e-05,6.4889e-09,-4.67841e-13,16652.4,29.0672], Tmin=(100,'K'), Tmax=(3059.37,'K')), NASAPolynomial(coeffs=[57.8827,0.00503877,-2.82713e-06,4.00008e-10,-1.71351e-14,-20064.6,-307.248], Tmin=(3059.37,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(138.109,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(552.912,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(Tertalkyl)"""),
)
...
species(
    ...
    molecularWeight = (112.213,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.774923,0.0777537,-3.89084e-05,8.82168e-09,-7.80157e-13,17815.3,34.9594], Tmin=(100,'K'), Tmax=(2499.72,'K')), NASAPolynomial(coeffs=[24.5499,0.0397107,-1.60807e-05,2.73381e-09,-1.71321e-13,5928.78,-101.524], Tmin=(2499.72,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(147.228,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(552.912,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(Cs_S)"""),
)

species(
    label = 'CC[CH][CH]C(C)CC(1485)',
...
species(
    ...
    molecularWeight = (112.213,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.152329,0.0902483,-7.00314e-05,3.65332e-08,-9.14836e-12,18022.1,35.0505], Tmin=(100,'K'), Tmax=(888.974,'K')), NASAPolynomial(coeffs=[5.63449,0.0655796,-2.8405e-05,5.31477e-09,-3.68582e-13,17047.5,9.24765], Tmin=(888.974,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(148.733,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(552.912,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Isobutyl) + radical(Tertalkyl)"""),
)

species(
    label = '[CH2]CCCC([CH2])CC(484)',
...
species(
    ...
    molecularWeight = (112.213,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.437776,0.0817985,-4.51705e-05,1.22861e-08,-1.39253e-12,19118.4,35.4081], Tmin=(100,'K'), Tmax=(1840.94,'K')), NASAPolynomial(coeffs=[13.4011,0.0536318,-2.22202e-05,3.975e-09,-2.63881e-13,14345.4,-35.0436], Tmin=(1840.94,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(157.933,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(552.912,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJ) + radical(RCCJCC)"""),
)
...
species(
    ...
    molecularWeight = (112.213,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.457484,0.0853299,-4.14912e-05,2.43659e-09,2.8206e-12,-14957.2,34.2486], Tmin=(100,'K'), Tmax=(1183.71,'K')), NASAPolynomial(coeffs=[15.6631,0.0495615,-1.98701e-05,3.6101e-09,-2.46884e-13,-20084.2,-51.7784], Tmin=(1183.71,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-125.783,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(557.07,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH)"""),
)

species(
    label = 'CCC=CC(C)CC(1488)',
    ...
    molecularWeight = (112.213,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.165696,0.07726,-1.76026e-05,-2.28596e-08,1.17786e-11,-15560.5,33.9971], Tmin=(100,'K'), Tmax=(1071.9,'K')), NASAPolynomial(coeffs=[14.8246,0.0501252,-1.99394e-05,3.66391e-09,-2.54691e-13,-20428.9,-47.0823], Tmin=(1071.9,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-130.725,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(557.07,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH)"""),
)

species(
    label = 'CC=CCC(C)CC(1489)',
    ...
    molecularWeight = (112.213,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.287938,0.0818022,-3.46677e-05,-2.48502e-09,4.07384e-12,-15420.5,33.7418], Tmin=(100,'K'), Tmax=(1180.36,'K')), NASAPolynomial(coeffs=[14.697,0.0508368,-2.04984e-05,3.73457e-09,-2.55756e-13,-20338.5,-46.8842], Tmin=(1180.36,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-129.582,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(557.07,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(CC)C[CH]CC(480)'],
    products = ['butene1(127)', 'butene1(127)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'C=C(CC)C[CH]CC(1480)'],
    products = ['[CH2]C(CC)C[CH]CC(480)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', '[CH2]C(C=CCC)CC(1481)'],
    products = ['[CH2]C(CC)C[CH]CC(480)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', '[CH2]C(CC)CC=CC(1482)'],
    products = ['[CH2]C(CC)C[CH]CC(480)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(1.46e+08,'cm^3/(mol*s)'), n=1.64, Ea=(5.73208,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""From training reaction 2555 used for Cds-CsH_Cds-CsH;HJ
Exact match found for rate rule [Cds-CsH_Cds-CsH;HJ]
...
reaction(
    label = 'reaction5',
    reactants = ['C2H5(29)', 'C=CC[CH]CC(368)'],
    products = ['[CH2]C(CC)C[CH]CC(480)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2][CH]CC(130)', 'butene1(127)'],
    products = ['[CH2]C(CC)C[CH]CC(480)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['CH3(17)', '[CH2]C(CC)CC=C(1458)'],
    products = ['[CH2]C(CC)C[CH]CC(480)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]C(CC)C[CH]CC(480)'],
    products = ['C[CH]C(C)C[CH]CC(1484)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]CC(C)C[CH]CC(479)'],
    products = ['[CH2]C(CC)C[CH]CC(480)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2]C[CH]CC(C)CC(1487)'],
    products = ['[CH2]C(CC)C[CH]CC(480)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2][CH]CC(130)', '[CH2][CH]CC(130)'],
    products = ['[CH2]C(CC)C[CH]CC(480)'],
...
reaction(
    label = 'reaction24',
    reactants = ['CH2(S)(23)', '[CH2]C(C)C[CH]CC(635)'],
    products = ['[CH2]C(CC)C[CH]CC(480)'],
...
reaction(
    label = 'reaction25',
    reactants = ['CH2(S)(23)', '[CH2]C(CC)C[CH]C(448)'],
    products = ['[CH2]C(CC)C[CH]CC(480)'],
...
reaction(
    label = 'reaction28',
    reactants = ['[CH2]C(CC)C([CH2])CC(1409)'],
    products = ['[CH2]C(CC)C[CH]CC(480)'],
...
reaction(
    label = 'reaction29',
    reactants = ['[CH2]C(C)CC([CH2])CC(636)'],
    products = ['[CH2]C(CC)C[CH]CC(480)'],
...
reaction(
    label = 'reaction31',
    reactants = ['CC[CH]C[CH]CC(194)', 'CH2(19)'],
    products = ['[CH2]C(CC)C[CH]CC(480)'],
...
reaction(
    label = 'reaction32',
    reactants = ['[CH2]C([CH2])CC(429)', '[CH]CC(144)'],
    products = ['[CH2]C(CC)C[CH]CC(480)'],
...
network(
    label = '999',
    isomers = [
        '[CH2]C(CC)C[CH]CC(480)',
    ],
    reactants = [
        ('butene1(127)', 'butene1(127)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
