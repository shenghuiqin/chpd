...
species(
    label = 'CCC=CO[O](5723)',
    structure = SMILES('CCC=CO[O]'),
    E0 = (51.1851,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2995,3025,975,1000,1300,1375,400,500,1630,1680,492.5,1135,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,180],'cm^-1')),
        HinderedRotor(inertia=(0.429844,'amu*angstrom^2'), symmetry=1, barrier=(9.88296,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.429758,'amu*angstrom^2'), symmetry=1, barrier=(9.88098,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.430305,'amu*angstrom^2'), symmetry=1, barrier=(9.89355,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (87.0972,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.48081,0.049001,-3.17741e-05,7.19655e-09,6.44128e-13,6252.31,23.7818], Tmin=(100,'K'), Tmax=(1068.9,'K')), NASAPolynomial(coeffs=[11.373,0.0221481,-8.35611e-06,1.48786e-09,-1.01551e-13,3556.83,-27.3179], Tmin=(1068.9,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(51.1851,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(ROOJ)"""),
)
...
species(
    ...
    molecularWeight = (88.1051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.40689,0.0582131,-5.4686e-05,3.138e-08,-7.69341e-12,13974.1,24.6426], Tmin=(100,'K'), Tmax=(966.18,'K')), NASAPolynomial(coeffs=[7.9798,0.031001,-1.24388e-05,2.22919e-09,-1.50562e-13,12703.9,-6.84177], Tmin=(966.18,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(115.419,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Isobutyl) + radical(ROOJ)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'CC=CCO[O](5722)'],
    products = ['CC[CH]CO[O](269)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['CH3(17)', 'allylperoxy(5703)'],
    products = ['CC[CH]CO[O](269)'],
    transitionState = 'TS4',
...
reaction(
    ...
    products = ['CC[CH]CO[O](269)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(552,'cm^3/(mol*s)'), n=2.78, Ea=(144.847,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""Estimated using an average for rate rule [Cds-HH_Cds-CsH;O2b]
Euclidian distance = 0
Multiplied by reaction path degeneracy 2.0
family: R_Addition_MultipleBond
Ea raised from 142.4 to 144.8 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction6',
    reactants = ['CC[CH]CO[O](269)'],
    products = ['C[CH]CCO[O](271)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction15',
    reactants = ['C[CH]CO[O](291)', 'CH2(S)(23)'],
    products = ['CC[CH]CO[O](269)'],
