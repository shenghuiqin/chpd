...
species(
    label = 'CC=CC(C)[O](1921)',
    structure = SMILES('CC=CC(C)[O]'),
    E0 = (5.00671,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2995,3025,975,1000,1300,1375,400,500,1630,1680,1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,247.303,247.306],'cm^-1')),
        HinderedRotor(inertia=(0.00275645,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.288426,'amu*angstrom^2'), symmetry=1, barrier=(12.5184,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.288439,'amu*angstrom^2'), symmetry=1, barrier=(12.5184,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (85.1244,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.41036,0.0470877,-8.75713e-06,-1.8269e-08,9.16299e-12,703.863,24.2568], Tmin=(100,'K'), Tmax=(1050.98,'K')), NASAPolynomial(coeffs=[11.8388,0.0281292,-1.12883e-05,2.1061e-09,-1.48497e-13,-2633.12,-32.0201], Tmin=(1050.98,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(5.00671,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(CC(C)OJ)"""),
)
...
species(
    ...
    molecularWeight = (86.1323,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.25615,0.0618805,-4.67644e-05,1.98708e-08,-3.66542e-12,8087.51,23.2873], Tmin=(100,'K'), Tmax=(1224.01,'K')), NASAPolynomial(coeffs=[9.03265,0.0364674,-1.56213e-05,2.90855e-09,-2.00947e-13,6183.79,-15.8018], Tmin=(1224.01,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(66.4339,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(C2CsJOH)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'C[CH]CC(C)=O(1920)'],
...
reaction(
    label = 'reaction6',
    reactants = ['CH3(17)', 'C4H7OJ_13(1705)'],
    products = ['C[CH]CC(C)[O](1218)'],
    transitionState = 'TS6',
