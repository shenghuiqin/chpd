...
species(
    label = 'C=C(CC(C)OO)C([O])CC(14608)',
    structure = SMILES('C=C(CC(C)OO)C([O])CC'),
    E0 = (-169.194,'kJ/mol'),
    modes = [
...
species(
    label = '[CH2]C(CC(C)OO)C(=O)CC(14609)',
    structure = SMILES('[CH2]C(CC(C)OO)C(=O)CC'),
    E0 = (-251.167,'kJ/mol'),
    modes = [
...
species(
    label = 'CCC([O])[C](C)CC(C)OO(14610)',
    structure = SMILES('CCC([O])[C](C)CC(C)OO'),
    E0 = (-132.273,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (160.211,'amu'),
...
species(
    label = '[CH2]C(CC(C)OO)[C](O)CC(14611)',
    structure = SMILES('[CH2]C(CC(C)OO)[C](O)CC'),
    E0 = (-133.498,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
species(
    label = '[CH2][C](CC(C)OO)C(O)CC(14614)',
    structure = SMILES('[CH2][C](CC(C)OO)C(O)CC'),
    E0 = (-157.552,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
species(
    label = '[CH2]C(CC(C)OO)C(O)[CH]C(14615)',
    structure = SMILES('[CH2]C(CC(C)OO)C(O)[CH]C'),
    E0 = (-110.224,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (160.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.03321,0.13182,-0.000123048,6.29472e-08,-1.32637e-11,-13038.8,49.7183], Tmin=(100,'K'), Tmax=(1129.28,'K')), NASAPolynomial(coeffs=[19.0441,0.0571628,-2.38817e-05,4.40464e-09,-3.03585e-13,-17799.3,-54.5301], Tmin=(1129.28,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-110.224,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(615.271,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Isobutyl) + radical(CCJCO)"""),
)

species(
    label = '[CH2]C([CH]C(C)OO)C(O)CC(14616)',
    structure = SMILES('[CH2]C([CH]C(C)OO)C(O)CC'),
    E0 = (-109.711,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3615,1277.5,1000,1380,1382,1384,1386,1388,1390,370,372,374,376,378,380,2800,2900,3000,430,435,440,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,3615,1310,387.5,850,1000,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'C[CH]C([O])C(C)CC(C)OO(14618)',
    structure = SMILES('C[CH]C([O])C(C)CC(C)OO'),
    E0 = (-84.9451,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (160.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.91357,0.126487,-0.000105933,4.69708e-08,-8.58117e-12,-10000.9,47.3102], Tmin=(100,'K'), Tmax=(1283.96,'K')), NASAPolynomial(coeffs=[20.5621,0.056467,-2.41317e-05,4.49763e-09,-3.11218e-13,-15772.5,-66.7395], Tmin=(1283.96,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-84.9451,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(619.428,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(CCJCO)"""),
)

species(
    label = '[CH2]CC(O)C([CH2])CC(C)OO(14619)',
    structure = SMILES('[CH2]CC(O)C([CH2])CC(C)OO'),
    E0 = (-104.879,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1277.5,1000,1380,1382,1384,1386,1388,1390,370,372,374,376,378,380,2800,2900,3000,430,435,440,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,3615,1310,387.5,850,1000,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2]C(C[C](C)OO)C(O)CC(14620)',
    structure = SMILES('[CH2]C(C[C](C)OO)C(O)CC'),
    E0 = (-123.227,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (160.211,'amu'),
...
species(
    label = '[CH2]C(CC(C)C([O])CC)OO(14621)',
    structure = SMILES('[CH2]C(CC(C)C([O])CC)OO'),
    E0 = (-70.8846,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3615,1310,387.5,850,1000,3000,3100,440,815,1455,1000,1380,1382,1384,1386,1388,1390,370,372,374,376,378,380,2800,2900,3000,430,435,440,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2]CC([O])C(C)CC(C)OO(14622)',
    structure = SMILES('[CH2]CC([O])C(C)CC(C)OO'),
    E0 = (-79.6008,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3615,1310,387.5,850,1000,3000,3100,440,815,1455,1000,1380,1382,1384,1386,1388,1390,370,372,374,376,378,380,2800,2900,3000,430,435,440,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'CCC([O])C(C)CC(C)O[O](14623)',
    structure = SMILES('CCC([O])C(C)CC(C)O[O]'),
    E0 = (-132.842,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (160.211,'amu'),
...
species(
    label = '[CH2]C(CC([CH2])C(O)CC)OO(14624)',
    structure = SMILES('[CH2]C(CC([CH2])C(O)CC)OO'),
    E0 = (-96.1631,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (160.211,'amu'),
...
species(
    label = '[CH2]C(CC(C)O[O])C(O)CC(14625)',
    structure = SMILES('[CH2]C(CC(C)O[O])C(O)CC'),
    E0 = (-158.121,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (160.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.85981,0.132101,-0.000131241,7.46271e-08,-1.77029e-11,-18809.2,47.3673], Tmin=(100,'K'), Tmax=(1004.83,'K')), NASAPolynomial(coeffs=[15.8495,0.0616036,-2.60023e-05,4.80452e-09,-3.31009e-13,-22368.1,-38.155], Tmin=(1004.83,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-158.121,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(619.428,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Isobutyl) + radical(ROOJ)"""),
)

species(
    label = 'C=C(CC(C)OO)C(O)CC(14626)',
    structure = SMILES('C=C(CC(C)OO)C(O)CC'),
    E0 = (-399.555,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
species(
    label = '[CH2]C(CCOO)C([O])CC(14628)',
    structure = SMILES('[CH2]C(CCOO)C([O])CC'),
    E0 = (-43.3417,'kJ/mol'),
    modes = [
...
species(
    label = 'CCC([O])C1COC(C)C1(14629)',
    structure = SMILES('CCC([O])C1COC(C)C1'),
    E0 = (-257.477,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (143.203,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.465656,0.0782383,1.40174e-05,-7.49863e-08,3.57231e-11,-30788.3,33.3706], Tmin=(100,'K'), Tmax=(936.979,'K')), NASAPolynomial(coeffs=[18.8348,0.0459648,-1.45542e-05,2.43247e-09,-1.65792e-13,-36605.3,-70.2271], Tmin=(936.979,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-257.477,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(590.328,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Tetrahydrofuran) + radical(CC(C)OJ)"""),
)

species(
    label = '[CH2]C1CC(C)OOC1CC(14630)',
    structure = SMILES('[CH2]C1CC(C)OOC1CC'),
    E0 = (-80.8215,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (143.203,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.649973,0.0787095,2.63911e-05,-9.89375e-08,4.75496e-11,-9531.27,33.7032], Tmin=(100,'K'), Tmax=(914.276,'K')), NASAPolynomial(coeffs=[22.461,0.0392926,-1.01589e-05,1.52023e-09,-1.01283e-13,-16335.8,-89.8241], Tmin=(914.276,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-80.8215,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(590.328,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(12dioxane) + radical(Isobutyl)"""),
)

species(
    label = 'CCC([O])[CH]CCC(C)OO(14631)',
    structure = SMILES('CCC([O])[CH]CCC(C)OO'),
    E0 = (-82.598,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (160.211,'amu'),
...
species(
    label = 'CCC([O])C(CO)CC(C)[O](14632)',
    structure = SMILES('CCC([O])C(CO)CC(C)[O]'),
    E0 = (-285.819,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (160.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.80804,0.128284,-0.000115048,5.65258e-08,-1.15508e-11,-34167.4,46.1891], Tmin=(100,'K'), Tmax=(1153.15,'K')), NASAPolynomial(coeffs=[18.0304,0.059469,-2.55357e-05,4.77656e-09,-3.31714e-13,-38742.8,-52.3471], Tmin=(1153.15,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-285.819,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(623.585,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(CC(C)OJ)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(CC(C)OO)C([O])CC(13570)'],
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'C=C(CC(C)OO)C([O])CC(14608)'],
    products = ['[CH2]C(CC(C)OO)C([O])CC(13570)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', '[CH2]C(CC(C)OO)C(=O)CC(14609)'],
    products = ['[CH2]C(CC(C)OO)C([O])CC(13570)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['QOOH_3(717)', 'C=CC([O])CC(10590)'],
    products = ['[CH2]C(CC(C)OO)C([O])CC(13570)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['C=CCC(C)OO(1790)', 'CC[CH][O](563)'],
    products = ['[CH2]C(CC(C)OO)C([O])CC(13570)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['C2H5(29)', '[CH2]C(C=O)CC(C)OO(5388)'],
    products = ['[CH2]C(CC(C)OO)C([O])CC(13570)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]C(CC(C)OO)C([O])CC(13570)'],
    products = ['CCC([O])[C](C)CC(C)OO(14610)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]C(CC(C)OO)C([O])CC(13570)'],
    products = ['[CH2]C(CC(C)OO)[C](O)CC(14611)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]C(CC(C)OO)C([O])CC(13570)'],
    products = ['CCC([O])C(C)[CH]C(C)OO(14612)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]C(CC(C)OO)C([O])CC(13570)'],
    products = ['CC[C]([O])C(C)CC(C)OO(14613)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]C(CC(C)OO)C([O])CC(13570)'],
    products = ['[CH2][C](CC(C)OO)C(O)CC(14614)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2]C(CC(C)OO)C(O)[CH]C(14615)'],
    products = ['[CH2]C(CC(C)OO)C([O])CC(13570)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]C([CH]C(C)OO)C(O)CC(14616)'],
    products = ['[CH2]C(CC(C)OO)C([O])CC(13570)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]C(CC(C)OO)C([O])CC(13570)'],
    products = ['CCC([O])C(C)C[C](C)OO(14617)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]C(CC(C)OO)C([O])CC(13570)'],
    products = ['C[CH]C([O])C(C)CC(C)OO(14618)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]CC(O)C([CH2])CC(C)OO(14619)'],
    products = ['[CH2]C(CC(C)OO)C([O])CC(13570)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2]C(CC(C)OO)C([O])CC(13570)'],
    products = ['[CH2]C(C[C](C)OO)C(O)CC(14620)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2]C(CC(C)C([O])CC)OO(14621)'],
    products = ['[CH2]C(CC(C)OO)C([O])CC(13570)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2]CC([O])C(C)CC(C)OO(14622)'],
    products = ['[CH2]C(CC(C)OO)C([O])CC(13570)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH2]C(CC(C)OO)C([O])CC(13570)'],
    products = ['CCC([O])C(C)CC(C)O[O](14623)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH2]C(CC(C)OO)C([O])CC(13570)'],
    products = ['[CH2]C(CC([CH2])C(O)CC)OO(14624)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH2]C(CC(C)OO)C([O])CC(13570)'],
    products = ['[CH2]C(CC(C)O[O])C(O)CC(14625)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[CH2]C(CC(C)OO)C([O])CC(13570)'],
    products = ['C=C(CC(C)OO)C(O)CC(14626)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[CH2]C(CC(C)OO)C([O])CC(13570)'],
    products = ['CCC(=O)C(C)CC(C)OO(14627)'],
...
reaction(
    label = 'reaction27',
    reactants = ['CH2(S)(23)', '[CH2]C(CCOO)C([O])CC(14628)'],
    products = ['[CH2]C(CC(C)OO)C([O])CC(13570)'],
...
reaction(
    label = 'reaction28',
    reactants = ['CH2(S)(23)', '[CH2]C(CC(C)OO)C(C)[O](5878)'],
    products = ['[CH2]C(CC(C)OO)C([O])CC(13570)'],
...
reaction(
    label = 'reaction29',
    reactants = ['[CH2]C(CC(C)OO)C([O])CC(13570)'],
    products = ['OH(5)', 'CCC([O])C1COC(C)C1(14629)'],
...
reaction(
    label = 'reaction30',
    reactants = ['[CH2]C(CC(C)OO)C([O])CC(13570)'],
    products = ['OH(5)', '[CH2]C1CC(C)OOC1CC(14630)'],
...
reaction(
    label = 'reaction31',
    reactants = ['[CH2]C(CC(C)OO)C([O])CC(13570)'],
    products = ['CCC([O])[CH]CCC(C)OO(14631)'],
...
reaction(
    label = 'reaction32',
    reactants = ['[CH2]C(CC(C)OO)C([O])CC(13570)'],
    products = ['CCC([O])C[CH]CC(C)OO(13568)'],
...
reaction(
    label = 'reaction34',
    reactants = ['[CH2]C(CC(C)OO)C([O])CC(13570)'],
    products = ['CCC([O])C(CO)CC(C)[O](14632)'],
...
reaction(
    label = 'reaction35',
    reactants = ['CH2(19)', 'CCC([O])[CH]CC(C)OO(13903)'],
    products = ['[CH2]C(CC(C)OO)C([O])CC(13570)'],
...
reaction(
    label = 'reaction36',
    reactants = ['O(4)', '[CH2]C([CH]CC)CC(C)OO(6620)'],
    products = ['[CH2]C(CC(C)OO)C([O])CC(13570)'],
