...
reaction(
    label = 'reaction3',
    reactants = ['O2(2)', 'C2H4(21)'],
    products = ['[CH2]CO[O](98)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(444,'cm^3/(mol*s)'), n=2.9, Ea=(154.794,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""Matched reaction 2807 C2H4 + O2 <=> C2H4O2 in R_Addition_MultipleBond/training
This reaction matched rate rule [Cds-HH_Cds-HH;O2b]
family: R_Addition_MultipleBond
Ea raised from 132.2 to 154.8 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction4',
    reactants = ['[CH2]CO[O](98)'],
    products = ['C[CH]O[O](97)'],
    transitionState = 'TS4',
