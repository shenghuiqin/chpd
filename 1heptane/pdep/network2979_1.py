species(
    label = 'CCCC[CH]OO[CH]CC(C)OO(13586)',
    structure = SMILES('CCCC[CH]OO[CH]CC(C)OO'),
    E0 = (-69.6749,'kJ/mol'),
    modes = [
...
species(
    label = 'CCCC[CH]OOC=CC(C)OO(13988)',
    structure = SMILES('CCCC[CH]OOC=CC(C)OO'),
    E0 = (-124.645,'kJ/mol'),
    modes = [
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.7673,0.152354,-0.000138942,6.78556e-08,-1.37748e-11,-14750.7,53.4223], Tmin=(100,'K'), Tmax=(1156.61,'K')), NASAPolynomial(coeffs=[21.1099,0.0697767,-3.18475e-05,6.12581e-09,-4.31882e-13,-20273.9,-65.2452], Tmin=(1156.61,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-124.645,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(685.944,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(CCsJOOC)"""),
)

species(
    label = 'CCCC=COO[CH]CC(C)OO(13989)',
    structure = SMILES('CCCC=COO[CH]CC(C)OO'),
    E0 = (-124.309,'kJ/mol'),
    modes = [
...
species(
    label = 'CCCC[CH]OOC[CH]C(C)OO(13990)',
    structure = SMILES('CCCC[CH]OOC[CH]C(C)OO'),
    E0 = (-55.7006,'kJ/mol'),
    modes = [
...
species(
    label = 'CCC[CH]COO[CH]CC(C)OO(13991)',
    structure = SMILES('CCC[CH]COO[CH]CC(C)OO'),
    E0 = (-55.7006,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3050,390,425,1340,1360,335,370,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3615,1310,387.5,850,1000,2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,350,500,795,815,1380,1390,370,380,2900,435,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'CCCC[CH]OOCC[C](C)OO(13992)',
    structure = SMILES('CCCC[CH]OOCC[C](C)OO'),
    E0 = (-69.2165,'kJ/mol'),
    modes = [
...
species(
    label = 'CC[CH]CCOO[CH]CC(C)OO(13993)',
    structure = SMILES('CC[CH]CCOO[CH]CC(C)OO'),
    E0 = (-61.6573,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3050,390,425,1340,1360,335,370,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3615,1310,387.5,850,1000,2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,350,500,795,815,1380,1390,370,380,2900,435,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2]C(CCOO[CH]CCCC)OO(13994)',
    structure = SMILES('[CH2]C(CCOO[CH]CCCC)OO'),
    E0 = (-42.153,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (190.237,'amu'),
...
species(
    label = 'C[CH]CCCOO[CH]CC(C)OO(13995)',
    structure = SMILES('C[CH]CCCOO[CH]CC(C)OO'),
    E0 = (-61.6693,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3050,390,425,1340,1360,335,370,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3615,1310,387.5,850,1000,2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,350,500,795,815,1380,1390,370,380,2900,435,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'CCC[CH][CH]OOCCC(C)OO(13996)',
    structure = SMILES('CCC[CH][CH]OOCCC(C)OO'),
    E0 = (-55.7006,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3050,390,425,1340,1360,335,370,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3615,1310,387.5,850,1000,2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,350,500,795,815,1380,1390,370,380,2900,435,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'CCCCCOO[CH][CH]C(C)OO(13997)',
    structure = SMILES('CCCCCOO[CH][CH]C(C)OO'),
    E0 = (-55.7006,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3050,390,425,1340,1360,335,370,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,1380,1390,370,380,2900,435,2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,350,500,795,815,3615,1310,387.5,850,1000,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'CCCC[CH]OOCCC(C)O[O](13998)',
    structure = SMILES('CCCC[CH]OOCCC(C)O[O]'),
    E0 = (-104.111,'kJ/mol'),
    modes = [
...
species(
    label = '[CH2]CCCCOO[CH]CC(C)OO(13999)',
    structure = SMILES('[CH2]CCCCOO[CH]CC(C)OO'),
    E0 = (-50.8692,'kJ/mol'),
    modes = [
...
species(
    label = 'CC[CH]C[CH]OOCCC(C)OO(14000)',
    structure = SMILES('CC[CH]C[CH]OOCCC(C)OO'),
    E0 = (-61.6573,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3050,390,425,1340,1360,335,370,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3615,1310,387.5,850,1000,2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,350,500,795,815,1380,1390,370,380,2900,435,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'CCCCCOO[CH]C[C](C)OO(14001)',
    structure = SMILES('CCCCCOO[CH]C[C](C)OO'),
    E0 = (-69.2165,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,360,370,350,2750,2761.11,2772.22,2783.33,2794.44,2805.56,2816.67,2827.78,2838.89,2850,1425,1431.25,1437.5,1443.75,1450,1225,1237.5,1250,1262.5,1275,1270,1287.5,1305,1322.5,1340,700,725,750,775,800,300,325,350,375,400,350,500,795,815,3615,1310,387.5,850,1000,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'C[CH]CC[CH]OOCCC(C)OO(14002)',
    structure = SMILES('C[CH]CC[CH]OOCCC(C)OO'),
    E0 = (-61.6693,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3050,390,425,1340,1360,335,370,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3615,1310,387.5,850,1000,2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,350,500,795,815,1380,1390,370,380,2900,435,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (190.237,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.5507,0.161604,-0.000163401,7.26061e-08,3.92172e-12,-7197.76,53.6909], Tmin=(100,'K'), Tmax=(577.584,'K')), NASAPolynomial(coeffs=[11.3378,0.0903356,-4.30188e-05,8.34047e-09,-5.8762e-13,-9217.69,-9.28726], Tmin=(577.584,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-61.6693,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(706.73,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJC) + radical(CCsJOOC)"""),
)

species(
    label = '[CH2]C(C[CH]OOCCCCC)OO(14003)',
    structure = SMILES('[CH2]C(C[CH]OOCCCCC)OO'),
    E0 = (-42.153,'kJ/mol'),
    modes = [
...
species(
    label = '[CH2]CCC[CH]OOCCC(C)OO(14004)',
    structure = SMILES('[CH2]CCC[CH]OOCCC(C)OO'),
    E0 = (-50.8692,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1310,387.5,850,1000,2750,2761.11,2772.22,2783.33,2794.44,2805.56,2816.67,2827.78,2838.89,2850,1425,1431.25,1437.5,1443.75,1450,1225,1237.5,1250,1262.5,1275,1270,1287.5,1305,1322.5,1340,700,725,750,775,800,300,325,350,375,400,350,500,795,815,3000,3100,440,815,1455,1000,1380,1390,370,380,2900,435,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'CCCCCOO[CH]CC(C)O[O](14005)',
    structure = SMILES('CCCCCOO[CH]CC(C)O[O]'),
    E0 = (-104.111,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (190.237,'amu'),
...
species(
    label = 'CCCC=COOCCC(C)OO(14006)',
    structure = SMILES('CCCC=COOCCC(C)OO'),
    E0 = (-310.749,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (190.237,'amu'),
...
species(
    label = 'CCCCCOOC=CC(C)OO(14007)',
    structure = SMILES('CCCCCOOC=CC(C)OO'),
    E0 = (-311.086,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (190.237,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.93788,0.152516,-0.000132116,6.03338e-08,-1.13885e-11,-37165.4,53.732], Tmin=(100,'K'), Tmax=(1240.5,'K')), NASAPolynomial(coeffs=[23.0577,0.0686934,-3.0759e-05,5.86326e-09,-4.10984e-13,-43615,-77.2844], Tmin=(1240.5,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-311.086,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(710.887,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH)"""),
)
...
species(
    label = 'CCCC[CH]OO[CH]CCOO(14008)',
    structure = SMILES('CCCC[CH]OO[CH]CCOO'),
    E0 = (-33.2517,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3050,390,425,1340,1360,335,370,3615,1310,387.5,850,1000,2750,2761.11,2772.22,2783.33,2794.44,2805.56,2816.67,2827.78,2838.89,2850,1425,1431.25,1437.5,1443.75,1450,1225,1237.5,1250,1262.5,1275,1270,1287.5,1305,1322.5,1340,700,725,750,775,800,300,325,350,375,400,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.72008,0.160121,-0.000201297,1.5519e-07,-5.0833e-11,-3768.7,49.8419], Tmin=(100,'K'), Tmax=(733.929,'K')), NASAPolynomial(coeffs=[11.8724,0.0805861,-3.87363e-05,7.5206e-09,-5.29324e-13,-5910.56,-16.0434], Tmin=(733.929,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-33.2517,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(636.057,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCsJOOC) + radical(CCsJOOC)"""),
)

species(
    label = 'CCC[CH]OO[CH]CC(C)OO(14009)',
    structure = SMILES('CCC[CH]OO[CH]CC(C)OO'),
    E0 = (-45.8946,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3050,390,425,1340,1360,335,370,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3615,1310,387.5,850,1000,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,350,500,795,815,1380,1390,370,380,2900,435,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'CCCC[CH]OOC1CC(C)O1(14010)',
    structure = SMILES('CCCC[CH]OOC1CC(C)O1'),
    E0 = (-183.992,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (173.229,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.52154,0.130281,-9.88575e-05,4.04238e-08,-6.80457e-12,-21883.6,47.1293], Tmin=(100,'K'), Tmax=(1394.87,'K')), NASAPolynomial(coeffs=[22.2597,0.0592165,-2.2436e-05,3.8984e-09,-2.58138e-13,-28796.9,-80.673], Tmin=(1394.87,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-183.992,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(673.472,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Oxetane) + radical(CCsJOOC)"""),
)

species(
    label = '[CH2]C(OO[CH]CCCC)C(C)OO(14011)',
    structure = SMILES('[CH2]C(OO[CH]CCCC)C(C)OO'),
    E0 = (-54.7959,'kJ/mol'),
    modes = [
...
species(
    label = '[CH2]C(CCC)OO[CH]CC(C)OO(14012)',
    structure = SMILES('[CH2]C(CCC)OO[CH]CC(C)OO'),
    E0 = (-54.7959,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3615,1310,387.5,850,1000,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,350,500,795,815,3000,3100,440,815,1455,1000,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'CCCC[CH]OOC(O)CC(C)[O](14013)',
    structure = SMILES('CCCC[CH]OOC(O)CC(C)[O]'),
    E0 = (-297.491,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (190.237,'amu'),
...
reaction(
    label = 'reaction1',
    reactants = ['CCCC[CH]OO[CH]CC(C)OO(13586)'],
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'CCCC[CH]OOC=CC(C)OO(13988)'],
    products = ['CCCC[CH]OO[CH]CC(C)OO(13586)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'CCCC=COO[CH]CC(C)OO(13989)'],
    products = ['CCCC[CH]OO[CH]CC(C)OO(13586)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(3.72e+08,'cm^3/(mol*s)'), n=1.477, Ea=(6.73624,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), comment="""From training reaction 2825 used for Cds-CsH_Cds-OsH;HJ
Exact match found for rate rule [Cds-CsH_Cds-OsH;HJ]
...
reaction(
    label = 'reaction4',
    reactants = ['CH3CHOOH(63)', 'C=COO[CH]CCCC(12008)'],
    products = ['CCCC[CH]OO[CH]CC(C)OO(13586)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['npropyl(83)', 'C=COO[CH]CC(C)OO(7516)'],
    products = ['CCCC[CH]OO[CH]CC(C)OO(13586)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['CCCC[CH]OOC[CH]C(C)OO(13990)'],
    products = ['CCCC[CH]OO[CH]CC(C)OO(13586)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['CCC[CH]COO[CH]CC(C)OO(13991)'],
    products = ['CCCC[CH]OO[CH]CC(C)OO(13586)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(3114.97,'s^-1'), n=2.79033, Ea=(132.312,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R2H_S;C_rad_out_H/NonDeC;Cs_H_out] for rate rule [R2H_S;C_rad_out_H/NonDeC;Cs_H_out_OOH/H]
Euclidian distance = 2.0
...
reaction(
    label = 'reaction8',
    reactants = ['CCCC[CH]OOCC[C](C)OO(13992)'],
    products = ['CCCC[CH]OO[CH]CC(C)OO(13586)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['CC[CH]CCOO[CH]CC(C)OO(13993)'],
    products = ['CCCC[CH]OO[CH]CC(C)OO(13586)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['CCCC[CH]OO[CH]CC(C)OO(13586)'],
    products = ['[CH2]C(CCOO[CH]CCCC)OO(13994)'],
...
reaction(
    label = 'reaction11',
    reactants = ['C[CH]CCCOO[CH]CC(C)OO(13995)'],
    products = ['CCCC[CH]OO[CH]CC(C)OO(13586)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CCC[CH][CH]OOCCC(C)OO(13996)'],
    products = ['CCCC[CH]OO[CH]CC(C)OO(13586)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CCCCCOO[CH][CH]C(C)OO(13997)'],
    products = ['CCCC[CH]OO[CH]CC(C)OO(13586)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CCCC[CH]OOCCC(C)O[O](13998)'],
    products = ['CCCC[CH]OO[CH]CC(C)OO(13586)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]CCCCOO[CH]CC(C)OO(13999)'],
    products = ['CCCC[CH]OO[CH]CC(C)OO(13586)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CC[CH]C[CH]OOCCC(C)OO(14000)'],
    products = ['CCCC[CH]OO[CH]CC(C)OO(13586)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CCCCCOO[CH]C[C](C)OO(14001)'],
    products = ['CCCC[CH]OO[CH]CC(C)OO(13586)'],
...
reaction(
    label = 'reaction18',
    reactants = ['C[CH]CC[CH]OOCCC(C)OO(14002)'],
    products = ['CCCC[CH]OO[CH]CC(C)OO(13586)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2]C(C[CH]OOCCCCC)OO(14003)'],
    products = ['CCCC[CH]OO[CH]CC(C)OO(13586)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2]CCC[CH]OOCCC(C)OO(14004)'],
    products = ['CCCC[CH]OO[CH]CC(C)OO(13586)'],
...
reaction(
    label = 'reaction21',
    reactants = ['CCCC[CH]OO[CH]CC(C)OO(13586)'],
    products = ['CCCCCOO[CH]CC(C)O[O](14005)'],
...
reaction(
    label = 'reaction23',
    reactants = ['CCCC[CH]OO[CH]CC(C)OO(13586)'],
    products = ['CCCC=COOCCC(C)OO(14006)'],
...
reaction(
    label = 'reaction24',
    reactants = ['CCCC[CH]OO[CH]CC(C)OO(13586)'],
    products = ['CCCCCOOC=CC(C)OO(14007)'],
...
reaction(
    label = 'reaction25',
    reactants = ['CH2(S)(23)', 'CCCC[CH]OO[CH]CCOO(14008)'],
    products = ['CCCC[CH]OO[CH]CC(C)OO(13586)'],
...
reaction(
    label = 'reaction26',
    reactants = ['CH2(S)(23)', 'CCC[CH]OO[CH]CC(C)OO(14009)'],
    products = ['CCCC[CH]OO[CH]CC(C)OO(13586)'],
...
reaction(
    label = 'reaction27',
    reactants = ['CCCC[CH]OO[CH]CC(C)OO(13586)'],
    products = ['OH(5)', 'CCCC[CH]OOC1CC(C)O1(14010)'],
...
reaction(
    label = 'reaction28',
    reactants = ['[CH2]C(OO[CH]CCCC)C(C)OO(14011)'],
    products = ['CCCC[CH]OO[CH]CC(C)OO(13586)'],
...
reaction(
    label = 'reaction29',
    reactants = ['[CH2]C(CCC)OO[CH]CC(C)OO(14012)'],
    products = ['CCCC[CH]OO[CH]CC(C)OO(13586)'],
...
reaction(
    label = 'reaction31',
    reactants = ['CCCC[CH]OO[CH]CC(C)OO(13586)'],
    products = ['CCCC[CH]OOC(O)CC(C)[O](14013)'],
...
reaction(
    label = 'reaction32',
    reactants = ['[CH]CCCC(141)', 'CC(C[CH]O[O])OO(1992)'],
    products = ['CCCC[CH]OO[CH]CC(C)OO(13586)'],
...
reaction(
    label = 'reaction33',
    reactants = ['CCCC[CH]O[O](239)', '[CH]CC(C)OO(1806)'],
    products = ['CCCC[CH]OO[CH]CC(C)OO(13586)'],
