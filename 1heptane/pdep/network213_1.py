...
reaction(
    label = 'reaction1',
    reactants = ['CH3OOH(34)'],
    products = ['CH3O(25)', 'OH(5)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(4.1e+19,'s^-1'), n=-1.153, Ea=(44226,'cal/mol'), T0=(1,'K'), comment="""Kinetics taken from the arrheniusHigh attribute of a Troe/Lindemann exprssion. Originally from reaction library Klippenstein_Glarborg2016"""),
)

reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'CH3OO(27)'],
    products = ['CH3OOH(34)'],
    transitionState = 'TS3',
