...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'C=COO[C]=O(745)'],
    products = ['C[CH]OO[C]=O(818)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction9',
    reactants = ['CO3t2(123)', 'CHCH3(T)(95)'],
    products = ['C[CH]OO[C]=O(818)'],
    transitionState = 'TS9',
