...
species(
    label = '[CH]=CC(=C)C(2945)',
    structure = SMILES('[CH]=CC(=C)C'),
    E0 = (303.427,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,440,435,1725,2950,3100,1380,975,1025,1650,3120,650,792.5,1650,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655],'cm^-1')),
        HinderedRotor(inertia=(0.897243,'amu*angstrom^2'), symmetry=1, barrier=(20.6294,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.894779,'amu*angstrom^2'), symmetry=1, barrier=(20.5727,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
species(
    label = '[CH]=C[C](C)C(2947)',
    structure = SMILES('[CH]C=C(C)C'),
    E0 = (301.728,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,440,435,1725,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3010,987.5,1337.5,450,1655,324.135,324.137,324.137],'cm^-1')),
        HinderedRotor(inertia=(0.697362,'amu*angstrom^2'), symmetry=1, barrier=(51.9915,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.697367,'amu*angstrom^2'), symmetry=1, barrier=(51.9915,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.697357,'amu*angstrom^2'), symmetry=1, barrier=(51.9913,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (68.117,'amu'),
...
species(
    label = '[CH]=[C]C(C)C(2948)',
    structure = SMILES('[CH]=[C]C(C)C'),
    E0 = (436.664,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,3120,650,792.5,1650,1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100],'cm^-1')),
        HinderedRotor(inertia=(0.123448,'amu*angstrom^2'), symmetry=1, barrier=(11.1996,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.123448,'amu*angstrom^2'), symmetry=1, barrier=(11.1997,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.123483,'amu*angstrom^2'), symmetry=1, barrier=(11.1997,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (68.117,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.81804,0.0414355,-1.6398e-05,-4.34762e-09,3.68045e-12,52602.7,20.0947], Tmin=(100,'K'), Tmax=(1078.33,'K')), NASAPolynomial(coeffs=[9.61303,0.0245127,-9.53973e-06,1.72579e-09,-1.18692e-13,50224.3,-21.3324], Tmin=(1078.33,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(436.664,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_S) + radical(Cds_P)"""),
)

species(
    label = '[CH2][C](C)C=C(2949)',
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', '[CH]=CC(=C)C(2945)'],
    products = ['[CH]=CC([CH2])C(1177)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['CH3(17)', 'CH2CHCHCH(2454)'],
    products = ['[CH]=CC([CH2])C(1177)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction14',
    reactants = ['CH2(S)(23)', '[CH]=CC[CH2](1022)'],
    products = ['[CH]=CC([CH2])C(1177)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CH2(19)', '[CH]=C[CH]C(2456)'],
    products = ['[CH]=CC([CH2])C(1177)'],
