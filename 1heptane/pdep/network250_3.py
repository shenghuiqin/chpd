...
species(
    ...
    E0 = (120.933,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,3615,1277.5,1000,458.887,459.577,459.893,460.323],'cm^-1')),
