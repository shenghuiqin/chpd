...
species(
    label = 'CCC(=O)C[CH]CC(C)OO(14817)',
    structure = SMILES('CCC(=O)C[CH]CC(C)OO'),
    E0 = (-256.015,'kJ/mol'),
    modes = [
...
species(
    label = 'CCC([O])CC=CC(C)OO(14818)',
    structure = SMILES('CCC([O])CC=CC(C)OO'),
    E0 = (-166.165,'kJ/mol'),
    modes = [
...
species(
    label = 'CCC([O])C=CCC(C)OO(14819)',
    structure = SMILES('CCC([O])C=CCC(C)OO'),
    E0 = (-166.165,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,2995,3025,975,1000,1300,1375,400,500,1630,1680,3615,1310,387.5,850,1000,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'C=CCC([O])CC(10656)',
    structure = SMILES('C=CCC([O])CC'),
    E0 = (-6.19189,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2950,3100,1380,975,1025,1650,3010,987.5,1337.5,450,1655,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,323.002,323.03,323.033,323.085],'cm^-1')),
        HinderedRotor(inertia=(0.00161487,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00161557,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.181294,'amu*angstrom^2'), symmetry=1, barrier=(13.4216,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.181194,'amu*angstrom^2'), symmetry=1, barrier=(13.4195,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
species(
    label = 'CC[C](O)C[CH]CC(C)OO(14820)',
    structure = SMILES('CC[C](O)C[CH]CC(C)OO'),
    E0 = (-141.775,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (160.211,'amu'),
...
species(
    label = 'CCC([O])CC[CH]C(C)OO(14821)',
    structure = SMILES('CCC([O])CC[CH]C(C)OO'),
    E0 = (-82.0851,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3025,407.5,1350,352.5,3615,1310,387.5,850,1000,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (160.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.70783,0.131466,-0.000123066,6.4658e-08,-1.43829e-11,-9671.94,46.6781], Tmin=(100,'K'), Tmax=(1053.74,'K')), NASAPolynomial(coeffs=[15.5276,0.0660403,-2.99323e-05,5.73538e-09,-4.03529e-13,-13304.3,-37.375], Tmin=(1053.74,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-82.0851,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(619.428,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(CCJCOOH)"""),
)
...
species(
    label = 'C[CH]C(O)C[CH]CC(C)OO(14822)',
    structure = SMILES('C[CH]C(O)C[CH]CC(C)OO'),
    E0 = (-118.5,'kJ/mol'),
    modes = [
...
species(
    label = 'CCC(O)[CH][CH]CC(C)OO(14823)',
    structure = SMILES('CCC(O)[CH][CH]CC(C)OO'),
    E0 = (-118.5,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (160.211,'amu'),
...
species(
    label = 'CCC([O])CCC[C](C)OO(14824)',
    structure = SMILES('CCC([O])CCC[C](C)OO'),
    E0 = (-95.601,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (160.211,'amu'),
...
species(
    label = 'CC[C]([O])CCCC(C)OO(14825)',
    structure = SMILES('CC[C]([O])CCCC(C)OO'),
    E0 = (-105.872,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (160.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.91533,0.138344,-0.000144122,8.68223e-08,-2.21354e-11,-12527.5,44.5537], Tmin=(100,'K'), Tmax=(930.348,'K')), NASAPolynomial(coeffs=[14.35,0.0684114,-3.13694e-05,6.0264e-09,-4.24155e-13,-15553.9,-32.7429], Tmin=(930.348,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-105.872,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(619.428,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(C2CsJOH)"""),
)

species(
    label = '[CH2]C(CCCC([O])CC)OO(14826)',
    structure = SMILES('[CH2]C(CCCC([O])CC)OO'),
    E0 = (-68.5375,'kJ/mol'),
    modes = [
...
species(
    label = 'C[CH]C([O])CCCC(C)OO(14827)',
    structure = SMILES('C[CH]C([O])CCCC(C)OO'),
    E0 = (-82.598,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3025,407.5,1350,352.5,3615,1310,387.5,850,1000,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2]CC(O)C[CH]CC(C)OO(14828)',
    structure = SMILES('[CH2]CC(O)C[CH]CC(C)OO'),
    E0 = (-113.156,'kJ/mol'),
    modes = [
...
species(
    label = 'CCC([O])CCCC(C)O[O](14829)',
    structure = SMILES('CCC([O])CCCC(C)O[O]'),
    E0 = (-130.495,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (160.211,'amu'),
...
species(
    label = '[CH2]CC([O])CCCC(C)OO(14830)',
    structure = SMILES('[CH2]CC([O])CCCC(C)OO'),
    E0 = (-77.2537,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1310,387.5,850,1000,3000,3100,440,815,1455,1000,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'CCC(O)C[CH][CH]C(C)OO(14831)',
    structure = SMILES('CCC(O)C[CH][CH]C(C)OO'),
    E0 = (-117.988,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (160.211,'amu'),
...
species(
    label = 'CCC(O)C[CH]C[C](C)OO(14832)',
    structure = SMILES('CCC(O)C[CH]C[C](C)OO'),
    E0 = (-131.503,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (160.211,'amu'),
...
species(
    label = '[CH2]C(C[CH]CC(O)CC)OO(14833)',
    structure = SMILES('[CH2]C(C[CH]CC(O)CC)OO'),
    E0 = (-104.44,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (160.211,'amu'),
...
species(
    label = 'CCC(O)C[CH]CC(C)O[O](14834)',
    structure = SMILES('CCC(O)C[CH]CC(C)O[O]'),
    E0 = (-166.398,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (160.211,'amu'),
...
species(
    label = 'CCC(=O)CCCC(C)OO(14835)',
    structure = SMILES('CCC(=O)CCCC(C)OO'),
    E0 = (-455.917,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (160.211,'amu'),
...
species(
    label = 'CCC([O])C[CH]CCOO(14838)',
    structure = SMILES('CCC([O])C[CH]CCOO'),
    E0 = (-51.6186,'kJ/mol'),
    modes = [
...
species(
    label = 'CCC([O])CC1CC(C)O1(14839)',
    structure = SMILES('CCC([O])CC1CC(C)O1'),
    E0 = (-182.616,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (143.203,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.872136,0.0908871,-2.21488e-05,-3.79113e-08,2.26485e-11,-21773.4,36.9643], Tmin=(100,'K'), Tmax=(940.504,'K')), NASAPolynomial(coeffs=[19.0377,0.0463635,-1.5179e-05,2.54252e-09,-1.71205e-13,-27294.4,-67.3088], Tmin=(940.504,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-182.616,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(586.17,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Oxetane) + radical(CC(C)OJ)"""),
)

species(
    label = '[CH2]C(CC([O])CC)C(C)OO(14840)',
    structure = SMILES('[CH2]C(CC([O])CC)C(C)OO'),
    E0 = (-79.7648,'kJ/mol'),
    modes = [
...
species(
    label = 'CCC([O])CC(O)CC(C)[O](14841)',
    structure = SMILES('CCC([O])CC(O)CC(C)[O]'),
    E0 = (-296.115,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (160.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.86701,0.129157,-0.000116105,5.67955e-08,-1.15173e-11,-35403.3,46.335], Tmin=(100,'K'), Tmax=(1163.43,'K')), NASAPolynomial(coeffs=[18.6312,0.0586807,-2.5239e-05,4.7268e-09,-3.28519e-13,-40172.8,-55.6596], Tmin=(1163.43,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-296.115,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(623.585,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(CC(C)OJ)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['CCC([O])C[CH]CC(C)OO(13568)'],
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'CCC(=O)C[CH]CC(C)OO(14817)'],
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'CCC([O])CC=CC(C)OO(14818)'],
    products = ['CCC([O])C[CH]CC(C)OO(13568)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', 'CCC([O])C=CCC(C)OO(14819)'],
    products = ['CCC([O])C[CH]CC(C)OO(13568)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(1.46e+08,'cm^3/(mol*s)'), n=1.64, Ea=(5.73208,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""From training reaction 2555 used for Cds-CsH_Cds-CsH;HJ
Exact match found for rate rule [Cds-CsH_Cds-CsH;HJ]
...
reaction(
    label = 'reaction5',
    reactants = ['C2H5(29)', 'CC(C[CH]CC=O)OO(5431)'],
    products = ['CCC([O])C[CH]CC(C)OO(13568)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['CH3CHOOH(63)', 'C=CCC([O])CC(10656)'],
    products = ['CCC([O])C[CH]CC(C)OO(13568)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['CCC([O])C[CH]CC(C)OO(13568)'],
    products = ['CC[C](O)C[CH]CC(C)OO(14820)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['CCC([O])CC[CH]C(C)OO(14821)'],
    products = ['CCC([O])C[CH]CC(C)OO(13568)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CCC([O])[CH]CCC(C)OO(14631)'],
    products = ['CCC([O])C[CH]CC(C)OO(13568)'],
...
reaction(
    label = 'reaction12',
    reactants = ['C[CH]C(O)C[CH]CC(C)OO(14822)'],
    products = ['CCC([O])C[CH]CC(C)OO(13568)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CCC([O])C[CH]CC(C)OO(13568)'],
    products = ['CCC(O)[CH][CH]CC(C)OO(14823)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CCC([O])C[CH]CC(C)OO(13568)'],
    products = ['CCC([O])CCC[C](C)OO(14824)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CCC([O])C[CH]CC(C)OO(13568)'],
    products = ['CC[C]([O])CCCC(C)OO(14825)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]C(CCCC([O])CC)OO(14826)'],
    products = ['CCC([O])C[CH]CC(C)OO(13568)'],
...
reaction(
    label = 'reaction17',
    reactants = ['C[CH]C([O])CCCC(C)OO(14827)'],
    products = ['CCC([O])C[CH]CC(C)OO(13568)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2]CC(O)C[CH]CC(C)OO(14828)'],
    products = ['CCC([O])C[CH]CC(C)OO(13568)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CCC([O])C[CH]CC(C)OO(13568)'],
    products = ['CCC([O])CCCC(C)O[O](14829)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2]CC([O])CCCC(C)OO(14830)'],
    products = ['CCC([O])C[CH]CC(C)OO(13568)'],
...
reaction(
    label = 'reaction21',
    reactants = ['CCC([O])C[CH]CC(C)OO(13568)'],
    products = ['CCC(O)C[CH][CH]C(C)OO(14831)'],
...
reaction(
    label = 'reaction22',
    reactants = ['CCC([O])C[CH]CC(C)OO(13568)'],
    products = ['CCC(O)C[CH]C[C](C)OO(14832)'],
...
reaction(
    label = 'reaction23',
    reactants = ['CCC([O])C[CH]CC(C)OO(13568)'],
    products = ['[CH2]C(C[CH]CC(O)CC)OO(14833)'],
...
reaction(
    label = 'reaction24',
    reactants = ['CCC([O])C[CH]CC(C)OO(13568)'],
    products = ['CCC(O)C[CH]CC(C)O[O](14834)'],
...
reaction(
    label = 'reaction26',
    reactants = ['CCC([O])C[CH]CC(C)OO(13568)'],
    products = ['CCC(=O)CCCC(C)OO(14835)'],
...
reaction(
    label = 'reaction27',
    reactants = ['CCC([O])C[CH]CC(C)OO(13568)'],
    products = ['CCC(O)C=CCC(C)OO(14836)'],
...
reaction(
    label = 'reaction28',
    reactants = ['CCC([O])C[CH]CC(C)OO(13568)'],
    products = ['CCC(O)CC=CC(C)OO(14837)'],
...
reaction(
    label = 'reaction29',
    reactants = ['CH2(S)(23)', 'CCC([O])C[CH]CCOO(14838)'],
    products = ['CCC([O])C[CH]CC(C)OO(13568)'],
...
reaction(
    label = 'reaction30',
    reactants = ['CH2(S)(23)', 'CC([O])C[CH]CC(C)OO(5877)'],
    products = ['CCC([O])C[CH]CC(C)OO(13568)'],
...
reaction(
    label = 'reaction31',
    reactants = ['CCC([O])C[CH]CC(C)OO(13568)'],
    products = ['OH(5)', 'CCC([O])CC1CC(C)O1(14839)'],
...
reaction(
    label = 'reaction32',
    reactants = ['[CH2]C(CC([O])CC)C(C)OO(14840)'],
    products = ['CCC([O])C[CH]CC(C)OO(13568)'],
...
reaction(
    label = 'reaction35',
    reactants = ['CCC([O])C[CH]CC(C)OO(13568)'],
    products = ['CCC([O])CC(O)CC(C)[O](14841)'],
