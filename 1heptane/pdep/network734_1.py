...
species(
    label = 'C=C(C)C[C]=O(2439)',
    structure = SMILES('C=C(C)C[C]=O'),
    E0 = (27.7668,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2950,3100,1380,975,1025,1650,1855,455,950,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,459.949],'cm^-1')),
        HinderedRotor(inertia=(0.0839177,'amu*angstrom^2'), symmetry=1, barrier=(12.4722,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0833095,'amu*angstrom^2'), symmetry=1, barrier=(12.4817,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0825717,'amu*angstrom^2'), symmetry=1, barrier=(12.4652,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (83.1085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.64313,0.044088,-1.85054e-05,-2.79306e-09,2.62498e-12,3430.72,21.7175], Tmin=(100,'K'), Tmax=(1246.29,'K')), NASAPolynomial(coeffs=[12.1488,0.0241776,-1.11604e-05,2.16752e-09,-1.53287e-13,-260.256,-35.5816], Tmin=(1246.29,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(27.7668,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-OdCsH) + group(Cds-CdsHH) + radical(CCCJ=O)"""),
)

species(
    label = '[CH2]C(C)C=C=O(2440)',
    structure = SMILES('[CH2]C(C)C=C=O'),
    E0 = (76.2087,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2120,512.5,787.5,3010,987.5,1337.5,450,1655,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,293.312],'cm^-1')),
        HinderedRotor(inertia=(0.171656,'amu*angstrom^2'), symmetry=1, barrier=(10.653,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.172257,'amu*angstrom^2'), symmetry=1, barrier=(10.6478,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.171373,'amu*angstrom^2'), symmetry=1, barrier=(10.6367,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (83.1085,'amu'),
...
species(
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.55895,0.0612134,-8.48193e-05,7.94885e-08,-2.98905e-11,10358.8,23.6217], Tmin=(100,'K'), Tmax=(837.263,'K')), NASAPolynomial(coeffs=[2.44216,0.040646,-1.86836e-05,3.50768e-09,-2.39922e-13,10784,22.9395], Tmin=(837.263,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(85.4581,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(CCCJ=O) + radical(Tertalkyl)"""),
)
...
species(
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.44899,0.049605,-2.77469e-05,3.64001e-09,1.58998e-12,8223.54,22.644], Tmin=(100,'K'), Tmax=(1071.65,'K')), NASAPolynomial(coeffs=[10.5362,0.0262688,-9.89536e-06,1.7492e-09,-1.1852e-13,5668.2,-24.6607], Tmin=(1071.65,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(67.5649,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(CCCJ=O) + radical(CCJCHO)"""),
)

species(
    label = '[CH2][C](C)CC=O(2444)',
    structure = SMILES('[CH2][C](C)CC=O'),
    E0 = (130.58,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2782.5,750,1395,475,1775,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,360,370,350,2540.12],'cm^-1')),
        HinderedRotor(inertia=(0.145689,'amu*angstrom^2'), symmetry=1, barrier=(3.34968,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.145724,'amu*angstrom^2'), symmetry=1, barrier=(3.35047,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.146082,'amu*angstrom^2'), symmetry=1, barrier=(3.35871,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.145781,'amu*angstrom^2'), symmetry=1, barrier=(3.35179,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.62105,0.0602553,-8.32766e-05,7.87291e-08,-2.95203e-11,15783.1,25.0556], Tmin=(100,'K'), Tmax=(855.393,'K')), NASAPolynomial(coeffs=[1.69625,0.0416614,-1.86815e-05,3.4544e-09,-2.33747e-13,16437.7,28.6056], Tmin=(855.393,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(130.58,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(Isobutyl) + radical(Tertalkyl)"""),
)

species(
    label = '[CH2]C([CH2])CC=O(2445)',
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.122288,'amu*angstrom^2'), symmetry=1, barrier=(2.81163,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.121552,'amu*angstrom^2'), symmetry=1, barrier=(2.79471,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.121419,'amu*angstrom^2'), symmetry=1, barrier=(2.79165,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00453827,'amu*angstrom^2'), symmetry=1, barrier=(2.80222,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
...
species(
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.35295,0.0509393,-3.15839e-05,8.68836e-09,-6.16103e-13,-16120.7,21.468], Tmin=(100,'K'), Tmax=(1273.5,'K')), NASAPolynomial(coeffs=[11.6652,0.0256261,-1.01043e-05,1.80765e-09,-1.21996e-13,-19321.1,-33.0287], Tmin=(1273.5,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-134.877,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cdd-O2d)CsCsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-(Cdd-O2d)CsH)"""),
)
...
species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.079452,'amu*angstrom^2'), symmetry=1, barrier=(1.82676,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0795486,'amu*angstrom^2'), symmetry=1, barrier=(1.82898,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.28264,0.0404476,-3.73114e-05,2.29496e-08,-6.45088e-12,16669.5,20.4151], Tmin=(100,'K'), Tmax=(823.357,'K')), NASAPolynomial(coeffs=[5.17712,0.0263865,-1.16961e-05,2.21015e-09,-1.54001e-13,16192.8,7.01331], Tmin=(823.357,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(138.104,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(CCCJ=O) + radical(RCCJ)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'C=C(C)C[C]=O(2439)'],
    products = ['[CH2]C(C)C[C]=O(1155)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', '[CH2]C(C)C=C=O(2440)'],
    products = ['[CH2]C(C)C[C]=O(1155)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['CH3(17)', 'C=CC[C]=O(2390)'],
    products = ['[CH2]C(C)C[C]=O(1155)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction15',
    reactants = ['CH2(S)(23)', '[CH2]CC[C]=O(1020)'],
    products = ['[CH2]C(C)C[C]=O(1155)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2]C([CH2])C(438)', 'CO(12)'],
    products = ['[CH2]C(C)C[C]=O(1155)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH2]C([CH2])C(438)', '[C]=O(361)'],
    products = ['[CH2]C(C)C[C]=O(1155)'],
