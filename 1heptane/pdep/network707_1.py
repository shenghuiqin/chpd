...
species(
    label = 'C=[C]OCC=CC(2992)',
    structure = SMILES('C=[C]OCC=CC'),
    E0 = (127.771,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2950,3100,1380,975,1025,1650,1685,370,2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,265.481,265.484,265.484,265.486],'cm^-1')),
        HinderedRotor(inertia=(0.00239176,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.310062,'amu*angstrom^2'), symmetry=1, barrier=(15.5078,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.310061,'amu*angstrom^2'), symmetry=1, barrier=(15.5078,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.310058,'amu*angstrom^2'), symmetry=1, barrier=(15.5078,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (97.1351,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.728797,0.0623365,-3.49474e-05,1.00193e-09,4.05443e-12,15493.3,28.4632], Tmin=(100,'K'), Tmax=(1041.88,'K')), NASAPolynomial(coeffs=[14.5007,0.0274173,-1.05226e-05,1.91317e-09,-1.33027e-13,11649.1,-43.2197], Tmin=(1041.88,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(127.771,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)OsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C=CJO)"""),
)

species(
    label = 'C=[C]OC=CCC(2993)',
    structure = SMILES('C=[C]OC=CCC'),
    E0 = (150.887,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2950,3100,1380,975,1025,1650,1685,370,2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,312.041,312.554,312.73,314.299],'cm^-1')),
        HinderedRotor(inertia=(0.00169273,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.212202,'amu*angstrom^2'), symmetry=1, barrier=(15.0556,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.217662,'amu*angstrom^2'), symmetry=1, barrier=(15.0726,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.212311,'amu*angstrom^2'), symmetry=1, barrier=(15.0861,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (97.1351,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.841911,0.0598684,-2.96907e-05,-3.22624e-09,5.30671e-12,18269.5,30.2228], Tmin=(100,'K'), Tmax=(1035.22,'K')), NASAPolynomial(coeffs=[13.8432,0.02823,-1.07946e-05,1.95827e-09,-1.36012e-13,14581.1,-37.7642], Tmin=(1035.22,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(150.887,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C=CJO)"""),
)

species(
    label = 'C#COC[CH]CC(2994)',
    ...
    molecularWeight = (97.1351,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.272095,0.0697764,-4.00669e-05,-4.47946e-09,8.46999e-12,21332.4,26.5059], Tmin=(100,'K'), Tmax=(983.205,'K')), NASAPolynomial(coeffs=[18.716,0.021644,-7.67956e-06,1.39058e-09,-9.90305e-14,16405.2,-68.7757], Tmin=(983.205,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(176.161,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Ct-CtOs) + group(Ct-CtH) + radical(CCJCO)"""),
)
...
species(
    ...
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.561836,0.0703781,-5.53444e-05,2.34758e-08,-4.10285e-12,24317.5,31.379], Tmin=(100,'K'), Tmax=(1344.31,'K')), NASAPolynomial(coeffs=[13.4751,0.0319544,-1.24707e-05,2.21398e-09,-1.48804e-13,20845.6,-34.741], Tmin=(1344.31,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(201.123,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C=CJO) + radical(RCCJC)"""),
)
...
species(
    ...
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0739044,0.0732843,-2.9981e-05,-2.6634e-08,1.92461e-11,19496.8,29.7648], Tmin=(100,'K'), Tmax=(943.068,'K')), NASAPolynomial(coeffs=[22.77,0.0168037,-4.42143e-06,7.3503e-10,-5.43728e-14,13391.1,-88.6322], Tmin=(943.068,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(160.762,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CCJCO) + radical(CCsJOC(O))"""),
)

species(
    label = '[CH2]CCCO[C]=C(2998)',
    structure = SMILES('[CH2]CCCO[C]=C'),
    E0 = (211.923,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,1685,370,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.272388,0.0724187,-5.17161e-05,1.4284e-08,8.50354e-14,25630.9,31.469], Tmin=(100,'K'), Tmax=(1065.31,'K')), NASAPolynomial(coeffs=[16.0443,0.0282678,-1.07674e-05,1.93653e-09,-1.33329e-13,21415.4,-49.6325], Tmin=(1065.31,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(211.923,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C=CJO) + radical(RCCJ)"""),
)

species(
    label = '[CH]=[C]OCCCC(2999)',
    structure = SMILES('[CH]=[C]OCCCC'),
    E0 = (253.773,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3120,650,792.5,1650,2750,2800,2850,1350,1500,750,1050,1375,1000,1685,370,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.146818,0.0753791,-5.85157e-05,2.0172e-08,-1.71118e-12,30668.6,30.5363], Tmin=(100,'K'), Tmax=(1075.7,'K')), NASAPolynomial(coeffs=[16.5775,0.0275848,-1.04198e-05,1.86121e-09,-1.27495e-13,26364,-53.5089], Tmin=(1075.7,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(253.773,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C=CJO) + radical(Cds_P)"""),
)
...
species(
    ...
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.328402,0.0646503,-1.36734e-05,-3.68271e-08,2.11293e-11,20843.4,30.6336], Tmin=(100,'K'), Tmax=(954.15,'K')), NASAPolynomial(coeffs=[20.0916,0.0209381,-6.4842e-06,1.14082e-09,-8.30099e-14,15290.3,-73.1208], Tmin=(954.15,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(172.081,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(RCCJ) + radical(CCJCO)"""),
)
...
species(
    ...
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.671801,0.0576722,-1.44742e-06,-4.34682e-08,2.19895e-11,-10553.2,27.7032], Tmin=(100,'K'), Tmax=(963.614,'K')), NASAPolynomial(coeffs=[17.5999,0.0247417,-8.30941e-06,1.49097e-09,-1.07226e-13,-15549.2,-62.3326], Tmin=(963.614,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-88.8573,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(390.78,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + group(Cds-CdsHH)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'C=[C]OCC=CC(2992)'],
    products = ['C=[C]OC[CH]CC(1128)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', 'C#COC[CH]CC(2994)'],
    products = ['C=[C]OC[CH]CC(1128)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['CH3(17)', 'C=[C]OCC=C(2614)'],
    products = ['C=[C]OC[CH]CC(1128)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction18',
    reactants = ['CH2(S)(23)', 'C=[C]OC[CH]C(1152)'],
    products = ['C=[C]OC[CH]CC(1128)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H2CC(41)', 'CC[CH]C[O](1679)'],
    products = ['C=[C]OC[CH]CC(1128)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH]CC(144)', '[CH2]O[C]=C(2374)'],
    products = ['C=[C]OC[CH]CC(1128)'],
