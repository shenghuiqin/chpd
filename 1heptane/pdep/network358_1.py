...
species(
    label = 'CC(=O)C([O])=O(4294)',
    structure = SMILES('CC(=O)C([O])=O'),
    E0 = (-283.377,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,375,552.5,462.5,1710,180,180,180,866.001,866.748,4000],'cm^-1')),
        HinderedRotor(inertia=(0.00750104,'amu*angstrom^2'), symmetry=1, barrier=(3.99191,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.07481,'amu*angstrom^2'), symmetry=1, barrier=(24.712,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
species(
    label = '[CH2]C([O])C(=O)O(4297)',
    structure = SMILES('[CH2]C([O])C(=O)O'),
    E0 = (-183.569,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,3000,3100,440,815,1455,1000,1380,1390,370,380,2900,435,180,961.387,961.396,961.401,961.409,961.435],'cm^-1')),
        HinderedRotor(inertia=(0.216957,'amu*angstrom^2'), symmetry=1, barrier=(4.98827,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.216948,'amu*angstrom^2'), symmetry=1, barrier=(4.98806,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0557163,'amu*angstrom^2'), symmetry=1, barrier=(36.5445,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (88.0621,'amu'),
...
species(
    ...
    molecularWeight = (88.0621,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.16544,0.0313398,-1.57045e-05,3.09228e-09,-2.12744e-13,21495.7,14.6242], Tmin=(100,'K'), Tmax=(2690.15,'K')), NASAPolynomial(coeffs=[25.4457,0.00285251,-2.4083e-06,4.38618e-10,-2.57372e-14,7828.75,-118.035], Tmin=(2690.15,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(178.586,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + ring(12dioxetane) + radical(CCOJ) + radical(Cs_P)"""),
)
...
species(
    ...
    E0 = (-230.963,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,440,435,1725,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,180,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.98929,'amu*angstrom^2'), symmetry=1, barrier=(22.7457,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.99187,'amu*angstrom^2'), symmetry=1, barrier=(22.805,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (88.0621,'amu'),
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'CC(=O)C([O])=O(4294)'],
    products = ['CC([O])C([O])=O(815)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CH3(17)', '[O]C(=O)C=O(3577)'],
    products = ['CC([O])C([O])=O(815)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction15',
    reactants = ['CH2(S)(23)', '[O]CC([O])=O(781)'],
    products = ['CC([O])C([O])=O(815)'],
