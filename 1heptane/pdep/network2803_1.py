...
species(
    label = 'C=C(C[CH]CCC)OO(15769)',
    structure = SMILES('C=C(C[CH]CCC)OO'),
    E0 = (16.532,'kJ/mol'),
    modes = [
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0367488,0.0945061,-8.85635e-05,5.37702e-08,-1.48799e-11,2124.65,37.7292], Tmin=(100,'K'), Tmax=(833.878,'K')), NASAPolynomial(coeffs=[7.04829,0.060874,-2.80678e-05,5.40721e-09,-3.8111e-13,955.247,5.17603], Tmin=(833.878,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(16.532,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(RCCJCC)"""),
)

species(
    label = '[CH2]C(C=CCCC)OO(15770)',
    ...
    molecularWeight = (129.177,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.841859,0.0979062,-7.64238e-05,3.0521e-08,-4.94439e-12,1827.39,40.4521], Tmin=(100,'K'), Tmax=(1449.56,'K')), NASAPolynomial(coeffs=[20.0631,0.0402195,-1.67295e-05,3.06685e-09,-2.09466e-13,-4233.19,-68.1635], Tmin=(1449.56,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(13.6877,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(CJCOOH)"""),
)

species(
    label = '[CH2]C(CC=CCC)OO(15771)',
    structure = SMILES('[CH2]C(CC=CCC)OO'),
    E0 = (14.0241,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,3615,1310,387.5,850,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3100,440,815,1455,1000,1380,1390,370,380,2900,435,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (129.177,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.618231,0.0980352,-7.86116e-05,3.31324e-08,-5.76061e-12,1855.59,38.7321], Tmin=(100,'K'), Tmax=(1340.59,'K')), NASAPolynomial(coeffs=[17.1949,0.0448851,-1.91415e-05,3.55834e-09,-2.45505e-13,-2920.44,-52.4272], Tmin=(1340.59,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(14.0241,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(CJCOOH)"""),
)
...
species(
    label = 'CCC[CH][CH]C(C)OO(6403)',
    structure = SMILES('CCC[CH][CH]C(C)OO'),
    E0 = (78.2631,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (130.185,'amu'),
...
species(
    ...
    molecularWeight = (130.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.518112,0.106956,-0.000104402,6.19157e-08,-1.60913e-11,10289.3,37.9914], Tmin=(100,'K'), Tmax=(898.833,'K')), NASAPolynomial(coeffs=[9.73361,0.0613323,-2.82626e-05,5.44206e-09,-3.835e-13,8446.45,-10.3736], Tmin=(898.833,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(84.2515,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(523.812,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(C2CsJOOH) + radical(CJCOOH)"""),
)

species(
    label = '[CH2]C(CCC[CH]C)OO(15773)',
...
species(
    label = '[CH2]CCCCC([CH2])OO(6402)',
    structure = SMILES('[CH2]CCCCC([CH2])OO'),
    E0 = (102.599,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (130.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.665174,0.106006,-9.39287e-05,4.62056e-08,-9.61627e-12,12504.9,39.9923], Tmin=(100,'K'), Tmax=(1119.92,'K')), NASAPolynomial(coeffs=[13.9607,0.053768,-2.39631e-05,4.55707e-09,-3.19224e-13,9228.87,-32.2258], Tmin=(1119.92,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(102.599,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(523.812,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJCOOH) + radical(RCCJ)"""),
)
...
species(
    label = 'C=C(CCCCC)OO(15774)',
    structure = SMILES('C=C(CCCCC)OO'),
    E0 = (-177.926,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (130.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.315021,0.0956229,-7.19112e-05,2.88838e-08,-4.9111e-12,-21245.3,36.3951], Tmin=(100,'K'), Tmax=(1334.5,'K')), NASAPolynomial(coeffs=[14.3309,0.0517235,-2.25677e-05,4.23362e-09,-2.93247e-13,-25154.3,-38.4893], Tmin=(1334.5,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-177.926,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(527.969,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH)"""),
)

species(
    label = 'CCCC=CC(C)OO(6407)',
    structure = SMILES('CCCC=CC(C)OO'),
    E0 = (-200.275,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (130.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.98144,0.0973788,-6.99407e-05,2.53068e-08,-3.6998e-12,-23898.3,38.9733], Tmin=(100,'K'), Tmax=(1596.15,'K')), NASAPolynomial(coeffs=[21.7478,0.0404183,-1.64113e-05,2.94898e-09,-1.97949e-13,-31154.1,-81.3103], Tmin=(1596.15,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-200.275,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(527.969,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH)"""),
)
...
species(
    ...
    molecularWeight = (130.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.349445,0.102595,-0.000104445,6.92201e-08,-2.03652e-11,-14657.9,39.4045], Tmin=(100,'K'), Tmax=(799.544,'K')), NASAPolynomial(coeffs=[7.8213,0.0617155,-2.77488e-05,5.26735e-09,-3.6754e-13,-15964.5,1.81368], Tmin=(799.544,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-123.124,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(527.969,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(CC(C)OJ)"""),
)

species(
    label = '[CH2]C([O])CC(O)CCC(15777)',
    ...
    molecularWeight = (130.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.858517,0.106586,-9.5529e-05,4.68566e-08,-9.53153e-12,-14093.5,38.9372], Tmin=(100,'K'), Tmax=(1160.68,'K')), NASAPolynomial(coeffs=[15.9562,0.0486376,-2.06375e-05,3.83987e-09,-2.65915e-13,-17996.7,-44.689], Tmin=(1160.68,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-118.636,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(527.969,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJCO) + radical(CC(C)OJ)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(C[CH]CCC)OO(6405)'],
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'C=C(C[CH]CCC)OO(15769)'],
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', '[CH2]C(C=CCCC)OO(15770)'],
    products = ['[CH2]C(C[CH]CCC)OO(6405)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', '[CH2]C(CC=CCC)OO(15771)'],
    products = ['[CH2]C(C[CH]CCC)OO(6405)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(1.46e+08,'cm^3/(mol*s)'), n=1.64, Ea=(5.73208,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""From training reaction 2555 used for Cds-CsH_Cds-CsH;HJ
Exact match found for rate rule [Cds-CsH_Cds-CsH;HJ]
...
reaction(
    label = 'reaction7',
    reactants = ['C2H5(29)', '[CH2]C(CC=C)OO(1934)'],
    products = ['[CH2]C(C[CH]CCC)OO(6405)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['C=CC[CH]CCC(456)', 'HO2(10)'],
    products = ['[CH2]C(C[CH]CCC)OO(6405)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]C(CC[CH]CC)OO(2096)'],
    products = ['[CH2]C(C[CH]CCC)OO(6405)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]C(C[CH]CCC)OO(6405)'],
    products = ['CCC[CH][CH]C(C)OO(6403)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]C(C[CH]CCC)OO(6405)'],
    products = ['[CH2]C(CCC[CH]C)OO(15773)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]CCCCC([CH2])OO(6402)'],
    products = ['[CH2]C(C[CH]CCC)OO(6405)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2]C(C[CH]CCC)OO(6405)'],
    products = ['CC[CH][CH]CC(C)OO(2093)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2]C(C[CH]CCC)OO(6405)'],
    products = ['C[CH]C[CH]CC(C)OO(6211)'],
...
reaction(
    label = 'reaction25',
    reactants = ['CH2(S)(23)', '[CH2]C(C[CH]CC)OO(7770)'],
    products = ['[CH2]C(C[CH]CCC)OO(6405)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[CH2]C(C[CH]CCC)OO(6405)'],
    products = ['OH(5)', 'CCC[CH]CC1CO1(15775)'],
...
reaction(
    label = 'reaction27',
    reactants = ['[CH2]C(C[CH]CCC)OO(6405)'],
    products = ['OH(5)', '[CH2]C1CC(CCC)O1(1228)'],
...
reaction(
    label = 'reaction33',
    reactants = ['[CH2]C(C[CH]CCC)OO(6405)'],
    products = ['[CH2]C([O])CC(O)CCC(15777)'],
...
reaction(
    label = 'reaction35',
    reactants = ['[CH]CCC(133)', '[CH2]C([CH2])OO(5700)'],
    products = ['[CH2]C(C[CH]CCC)OO(6405)'],
