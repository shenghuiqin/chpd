...
species(
    ...
    molecularWeight = (189.229,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.74502,0.149541,-0.000133581,6.32615e-08,-1.23837e-11,-48815.7,51.9183], Tmin=(100,'K'), Tmax=(1200.29,'K')), NASAPolynomial(coeffs=[22.1181,0.0666818,-3.00298e-05,5.74563e-09,-4.03869e-13,-54784.2,-72.5702], Tmin=(1200.29,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-407.887,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(690.101,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + radical(CCOJ)"""),
)

species(
    label = 'CCC[C](CC(C)OO)OC(C)=O(4330)',
    structure = SMILES('CCC[C](CC(C)OO)OC(C)=O'),
    E0 = (-495.208,'kJ/mol'),
    modes = [
...
species(
    label = 'C=C(CC(C)OO)OC(C)[O](4331)',
    structure = SMILES('C=C(CC(C)OO)OC(C)[O]'),
    E0 = (-349.216,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,2950,3100,1380,975,1025,1650,3615,1310,387.5,850,1000,350,440,435,1725,2750,2850,1437.5,1250,1305,750,350,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.56623,0.123455,-0.000115346,5.66723e-08,-1.14202e-11,-41801.4,42.97], Tmin=(100,'K'), Tmax=(1174.58,'K')), NASAPolynomial(coeffs=[19.5643,0.0514956,-2.34491e-05,4.51362e-09,-3.18552e-13,-46765.3,-62.3727], Tmin=(1174.58,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-349.216,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(548.755,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(CCOJ)"""),
)
...
species(
    label = 'CCCC([CH]C(C)OO)OC(C)[O](4332)',
    ...
    molecularWeight = (190.237,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.81059,0.162864,-0.000183817,1.27534e-07,-3.82789e-11,-33190.3,55.7958], Tmin=(100,'K'), Tmax=(791.194,'K')), NASAPolynomial(coeffs=[11.9563,0.0882028,-4.22585e-05,8.24787e-09,-5.84302e-13,-35526.8,-11.9861], Tmin=(791.194,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-277.901,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(710.887,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJCOOH) + radical(CCOJ)"""),
)

species(
    label = 'CC[CH]C(CC(C)OO)OC(C)[O](4333)',
    ...
    molecularWeight = (190.237,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.42648,0.153097,-0.000150407,8.70686e-08,-2.19169e-11,-33264,54.6087], Tmin=(100,'K'), Tmax=(927.251,'K')), NASAPolynomial(coeffs=[13.363,0.0849829,-4.02193e-05,7.84576e-09,-5.57118e-13,-36192.1,-20.3737], Tmin=(927.251,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-278.414,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(710.887,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJCO) + radical(CCOJ)"""),
)
...
species(
    label = 'CCCC(CC(C)OO)O[C](C)[O](4335)',
    ...
    molecularWeight = (190.237,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.71647,0.160555,-0.000174547,1.15216e-07,-3.29439e-11,-32612.1,53.8442], Tmin=(100,'K'), Tmax=(826.995,'K')), NASAPolynomial(coeffs=[12.4238,0.0873257,-4.17279e-05,8.14841e-09,-5.77978e-13,-35116.4,-16.323], Tmin=(826.995,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-273.07,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(710.887,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(Cs_P)"""),
)

species(
    label = 'CCCC(C[C](C)OO)OC(C)[O](4336)',
    ...
    molecularWeight = (190.237,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.8167,0.148808,-0.00011418,-2.47243e-08,7.61498e-11,-34860.6,50.4369], Tmin=(100,'K'), Tmax=(512.368,'K')), NASAPolynomial(coeffs=[9.55797,0.0925325,-4.46515e-05,8.70573e-09,-6.14919e-13,-36453.2,-0.99924], Tmin=(512.368,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-291.417,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(710.887,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(C2CsJOOH) + radical(CCOJ)"""),
)

species(
    label = 'C[CH]CC(CC(C)OO)OC(C)[O](4337)',
    ...
    molecularWeight = (190.237,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.85968,0.148438,-0.000120425,-2.68228e-09,5.60892e-11,-33949.8,52.9965], Tmin=(100,'K'), Tmax=(526.832,'K')), NASAPolynomial(coeffs=[9.60847,0.0914221,-4.36691e-05,8.483e-09,-5.98281e-13,-35575.3,1.06013], Tmin=(526.832,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-283.87,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(710.887,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(RCCJC)"""),
)
...
species(
    label = '[CH2]C(CC(CCC)OC(C)[O])OO(4339)',
    ...
    molecularWeight = (190.237,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.81896,0.162549,-0.000177319,1.15628e-07,-3.24027e-11,-31559.8,55.5187], Tmin=(100,'K'), Tmax=(845.471,'K')), NASAPolynomial(coeffs=[13.452,0.0855721,-4.07541e-05,7.94837e-09,-5.63482e-13,-34311.3,-20.2488], Tmin=(845.471,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-264.354,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(710.887,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJCOOH) + radical(CCOJ)"""),
)

species(
    label = '[CH2]CCC(CC(C)OO)OC(C)[O](4340)',
    ...
    molecularWeight = (190.237,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.71647,0.160555,-0.000174547,1.15216e-07,-3.29439e-11,-32612.1,54.9428], Tmin=(100,'K'), Tmax=(826.995,'K')), NASAPolynomial(coeffs=[12.4238,0.0873257,-4.17279e-05,8.14841e-09,-5.77978e-13,-35116.4,-15.2244], Tmin=(826.995,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-273.07,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(710.887,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(RCCJ)"""),
)
...
species(
    label = 'CCCC(CC(C)O[O])OC(C)[O](4344)',
    ...
    molecularWeight = (190.237,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.62708,0.157959,-0.000175401,1.21707e-07,-3.67289e-11,-39018.6,53.587], Tmin=(100,'K'), Tmax=(785.94,'K')), NASAPolynomial(coeffs=[11.171,0.0877343,-4.13735e-05,8.01889e-09,-5.65839e-13,-41187.4,-9.65711], Tmin=(785.94,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-326.312,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(715.045,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(CCOJ)"""),
)
...
species(
    label = 'CCCC(CC(C)OO)OC(C)=O(4350)',
    structure = SMILES('CCCC(CC(C)OO)OC(C)=O'),
    E0 = (-695.997,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
species(
    label = 'CC[C](CC(C)OO)OC(C)[O](4354)',
    ...
    molecularWeight = (176.21,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.716379,0.128845,-3.85935e-05,-2.33727e-07,2.70084e-10,-32791.1,44.1562], Tmin=(100,'K'), Tmax=(444.86,'K')), NASAPolynomial(coeffs=[9.837,0.0814999,-3.9273e-05,7.5473e-09,-5.24013e-13,-34200.5,-3.49747], Tmin=(444.86,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-273.832,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(640.214,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(C2CsJOCs) + radical(CCOJ)"""),
)
...
species(
    ...
    opticalIsomers = 1,
    molecularWeight = (176.21,'amu'),
    collisionModel = TransportData(shapeIndex=2, epsilon=(4951.81,'J/mol'), sigma=(8.5535,'angstroms'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with Tc=773.46 K, Pc=17.95 bar (from Joback method)"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
...
species(
    label = 'CCCC1(CC(C)O1)OC(C)[O](4355)',
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.4925,0.11952,-4.04983e-05,-4.33101e-08,2.89174e-11,-50286,45.3855], Tmin=(100,'K'), Tmax=(944.223,'K')), NASAPolynomial(coeffs=[28.3506,0.0460095,-1.45085e-05,2.44135e-09,-1.68122e-13,-58658.2,-115.135], Tmin=(944.223,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-420.221,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(677.629,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Oxetane) + radical(CCOJ)"""),
)

species(
    label = '[CH2]C(CCC)(OC(C)[O])C(C)OO(4356)',
    structure = SMILES('[CH2]C(CCC)(OC(C)[O])C(C)OO'),
    E0 = (-277.004,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2762.5,2775,2787.5,2800,2812.5,2825,2837.5,2850,1350,1380,1410,1440,1470,1500,700,750,800,1000,1050,1100,1350,1375,1400,900,1000,1100,3615,1310,387.5,850,1000,3000,3100,440,815,1455,1000,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,300,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (190.237,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-3.64475,0.180943,-0.000228255,1.68923e-07,-5.21061e-11,-33052.2,53.992], Tmin=(100,'K'), Tmax=(782.459,'K')), NASAPolynomial(coeffs=[15.694,0.0820865,-3.87524e-05,7.47225e-09,-5.24138e-13,-36078.7,-34.5633], Tmin=(782.459,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-277.004,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(710.887,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-SQ) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(CJC(C)OC)"""),
)

species(
    label = '[CH2]C(CC)(CC(C)OO)OC(C)[O](4357)',
...
species(
    label = 'CCCC(O)(CC(C)[O])OC(C)[O](4358)',
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'CCCC(=CC(C)OO)OC(C)[O](4328)'],
    products = ['CCC[C](CC(C)OO)OC(C)[O](3721)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'CCC=C(CC(C)OO)OC(C)[O](4329)'],
    products = ['CCC[C](CC(C)OO)OC(C)[O](3721)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(137.12,'m^3/(mol*s)'), n=1.63155, Ea=(4.2466,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Cds-CsH_Cds;HJ] for rate rule [Cds-CsH_Cds-OsCs;HJ]
Euclidian distance = 1.0
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', 'CCC[C](CC(C)OO)OC(C)=O(4330)'],
    products = ['CCC[C](CC(C)OO)OC(C)[O](3721)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['C[CH][O](176)', 'CCCC(=O)CC(C)OO(1965)'],
    products = ['CCC[C](CC(C)OO)OC(C)[O](3721)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['CH3CHOOH(63)', 'C=C(CCC)OC(C)[O](2351)'],
    products = ['CCC[C](CC(C)OO)OC(C)[O](3721)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['C2H5(29)', 'C=C(CC(C)OO)OC(C)[O](4331)'],
    products = ['CCC[C](CC(C)OO)OC(C)[O](3721)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['CH3(17)', 'CCC[C](CC(C)OO)OC=O(3846)'],
    products = ['CCC[C](CC(C)OO)OC(C)[O](3721)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['CCCC([CH]C(C)OO)OC(C)[O](4332)'],
    products = ['CCC[C](CC(C)OO)OC(C)[O](3721)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['CC[CH]C(CC(C)OO)OC(C)[O](4333)'],
    products = ['CCC[C](CC(C)OO)OC(C)[O](3721)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CCCC(CC(C)OO)O[C](C)[O](4335)'],
    products = ['CCC[C](CC(C)OO)OC(C)[O](3721)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CCCC(C[C](C)OO)OC(C)[O](4336)'],
    products = ['CCC[C](CC(C)OO)OC(C)[O](3721)'],
...
reaction(
    label = 'reaction14',
    reactants = ['C[CH]CC(CC(C)OO)OC(C)[O](4337)'],
    products = ['CCC[C](CC(C)OO)OC(C)[O](3721)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]C(CC(CCC)OC(C)[O])OO(4339)'],
    products = ['CCC[C](CC(C)OO)OC(C)[O](3721)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]CCC(CC(C)OO)OC(C)[O](4340)'],
    products = ['CCC[C](CC(C)OO)OC(C)[O](3721)'],
...
reaction(
    label = 'reaction21',
    reactants = ['CCCC(CC(C)O[O])OC(C)[O](4344)'],
    products = ['CCC[C](CC(C)OO)OC(C)[O](3721)'],
...
reaction(
    label = 'reaction28',
    reactants = ['CCC[C](CC(C)OO)OC(C)[O](3721)'],
    products = ['CCCC(CC(C)OO)OC(C)=O(4350)'],
...
reaction(
    label = 'reaction32',
    reactants = ['CH2(S)(23)', 'CC[C](CC(C)OO)OC(C)[O](4354)'],
    products = ['CCC[C](CC(C)OO)OC(C)[O](3721)'],
...
reaction(
    label = 'reaction33',
    reactants = ['CH2(S)(23)', 'CCC[C](CC(C)OO)OC[O](3715)'],
    products = ['CCC[C](CC(C)OO)OC(C)[O](3721)'],
...
reaction(
    label = 'reaction34',
    reactants = ['CCC[C](CC(C)OO)OC(C)[O](3721)'],
    products = ['OH(5)', 'CCCC1(CC(C)O1)OC(C)[O](4355)'],
...
reaction(
    label = 'reaction35',
    reactants = ['[CH2]C(CCC)(OC(C)[O])C(C)OO(4356)'],
    products = ['CCC[C](CC(C)OO)OC(C)[O](3721)'],
...
reaction(
    label = 'reaction36',
    reactants = ['[CH2]C(CC)(CC(C)OO)OC(C)[O](4357)'],
    products = ['CCC[C](CC(C)OO)OC(C)[O](3721)'],
...
reaction(
    label = 'reaction38',
    reactants = ['CCC[C](CC(C)OO)OC(C)[O](3721)'],
    products = ['CCCC(O)(CC(C)[O])OC(C)[O](4358)'],
...
reaction(
    label = 'reaction39',
    reactants = ['CC([O])[O](2201)', 'CCC[C]CC(C)OO(1986)'],
    products = ['CCC[C](CC(C)OO)OC(C)[O](3721)'],
