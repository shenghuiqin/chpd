...
species(
    label = '[CH2]OC(=C)CC(1714)',
    structure = SMILES('[CH2]OC(=C)CC'),
    E0 = (-20.3887,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2950,3100,1380,975,1025,1650,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,350,440,435,1725,483.373,483.402,483.404],'cm^-1')),
        HinderedRotor(inertia=(0.0754504,'amu*angstrom^2'), symmetry=1, barrier=(12.5102,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.000721512,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0754553,'amu*angstrom^2'), symmetry=1, barrier=(12.5104,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0754358,'amu*angstrom^2'), symmetry=1, barrier=(12.5102,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
species(
    ...
    molecularWeight = (86.1323,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.793986,0.0757958,-9.46633e-05,7.57774e-08,-2.55897e-11,8571.81,24.173], Tmin=(100,'K'), Tmax=(791.533,'K')), NASAPolynomial(coeffs=[6.83045,0.0403425,-1.81001e-05,3.3943e-09,-2.33554e-13,7771.21,-2.55904], Tmin=(791.533,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(70.3521,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(C2CsJOCs) + radical(CsJOCC2)"""),
)

species(
    label = '[CH2][C](CC)OC(1716)',
...
species(
    ...
    molecularWeight = (86.1323,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.775772,0.0634123,-4.68664e-05,1.80724e-08,-2.83911e-12,10892.6,26.7949], Tmin=(100,'K'), Tmax=(1492.48,'K')), NASAPolynomial(coeffs=[14.2451,0.0273129,-1.05848e-05,1.86581e-09,-1.24384e-13,6872.12,-43.5802], Tmin=(1492.48,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(89.5503,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(CsJOCC2) + radical(CCJCO)"""),
)

species(
    label = '[CH2]C([CH]C)OC(1718)',
...
species(
    ...
    molecularWeight = (86.1323,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.991179,0.0651179,-5.18048e-05,2.241e-08,-4.0649e-12,11522.2,25.302], Tmin=(100,'K'), Tmax=(1277.22,'K')), NASAPolynomial(coeffs=[11.3448,0.0326925,-1.37236e-05,2.53286e-09,-1.74187e-13,8877.48,-27.1814], Tmin=(1277.22,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(94.8947,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(CsJOCC2) + radical(RCCJ)"""),
)

species(
    label = '[CH2]CC([CH2])OC(1720)',
...
species(
    label = '[CH2]OC([CH2])C(1006)',
    structure = SMILES('[CH2]OC([CH2])C'),
    E0 = (123.939,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,2750,2800,2850,1350,1500,750,1050,1375,1000,331.984,825.427],'cm^-1')),
        HinderedRotor(inertia=(0.0222856,'amu*angstrom^2'), symmetry=1, barrier=(10.7732,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.46855,'amu*angstrom^2'), symmetry=1, barrier=(10.7729,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.46852,'amu*angstrom^2'), symmetry=1, barrier=(10.7722,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.468546,'amu*angstrom^2'), symmetry=1, barrier=(10.7728,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', '[CH2]OC(=C)CC(1714)'],
    products = ['[CH2]OC([CH2])CC(989)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['C2H5(29)', 'CH2OCHCH2(566)'],
    products = ['[CH2]OC([CH2])CC(989)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction13',
    reactants = ['CH2(S)(23)', '[CH2]OC([CH2])C(1006)'],
    products = ['[CH2]OC([CH2])CC(989)'],
