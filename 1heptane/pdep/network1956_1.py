...
species(
    label = 'CC=CCC(CC)OOOC(16840)',
    structure = SMILES('CC=CCC(CC)OOOC'),
    E0 = (-165.172,'kJ/mol'),
    modes = [
...
species(
    label = 'C=CCCC(CC)OOOC(16841)',
    structure = SMILES('C=CCCC(CC)OOOC'),
    E0 = (-152.927,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (160.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.79578,0.118019,-8.69808e-05,3.27053e-08,-5.02202e-12,-18176.9,47.114], Tmin=(100,'K'), Tmax=(1509.59,'K')), NASAPolynomial(coeffs=[22.8575,0.0526955,-2.20722e-05,4.0405e-09,-2.74937e-13,-25620.2,-81.9772], Tmin=(1509.59,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-152.927,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(619.428,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH)"""),
)
...
species(
    label = '[CH2]C(CC)OOOC(16842)',
    structure = SMILES('[CH2]C(CC)OOOC'),
    E0 = (4.5943,'kJ/mol'),
    modes = [
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.118383,0.0828632,-6.36598e-05,2.49965e-08,-3.98405e-12,706.981,35.8795], Tmin=(100,'K'), Tmax=(1470.6,'K')), NASAPolynomial(coeffs=[17.6867,0.0344335,-1.42617e-05,2.60279e-09,-1.77131e-13,-4529.84,-56.8867], Tmin=(1470.6,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(4.5943,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(428.195,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(CJCOOH)"""),
)

species(
    label = 'CC[CH]CC(CC)OOOC(16843)',
    structure = SMILES('CC[CH]CC(CC)OOOC'),
    E0 = (-86.2507,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3025,407.5,1350,352.5,1380,1390,370,380,2900,435,2750,2762.5,2775,2787.5,2800,2812.5,2825,2837.5,2850,1350,1380,1410,1440,1470,1500,700,750,800,1000,1050,1100,1350,1375,1400,900,1000,1100,200,800,900,1000,1100,1200,1300,1400,1500,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2]CCCC(CC)OOOC(16844)',
    structure = SMILES('[CH2]CCCC(CC)OOOC'),
    E0 = (-75.4627,'kJ/mol'),
    modes = [
...
species(
    label = 'CCC[CH]C(CC)OOOC(16845)',
    structure = SMILES('CCC[CH]C(CC)OOOC'),
    E0 = (-80.2941,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3025,407.5,1350,352.5,1380,1390,370,380,2900,435,2750,2762.5,2775,2787.5,2800,2812.5,2825,2837.5,2850,1350,1380,1410,1440,1470,1500,700,750,800,1000,1050,1100,1350,1375,1400,900,1000,1100,200,800,900,1000,1100,1200,1300,1400,1500,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'CCCC[C](CC)OOOC(16846)',
    structure = SMILES('CCCC[C](CC)OOOC'),
    E0 = (-94.0856,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (161.219,'amu'),
...
species(
    label = 'C[CH]C(CCCC)OOOC(16847)',
    structure = SMILES('C[CH]C(CCCC)OOOC'),
    E0 = (-80.2941,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3025,407.5,1350,352.5,1380,1390,370,380,2900,435,2750,2762.5,2775,2787.5,2800,2812.5,2825,2837.5,2850,1350,1380,1410,1440,1470,1500,700,750,800,1000,1050,1100,1350,1375,1400,900,1000,1100,200,800,900,1000,1100,1200,1300,1400,1500,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2]CC(CCCC)OOOC(16848)',
    structure = SMILES('[CH2]CC(CCCC)OOOC'),
    E0 = (-75.4627,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,200,800,900,1000,1100,1200,1300,1400,1500,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2]OOOC(CC)CCCC(3708)',
    structure = SMILES('[CH2]OOOC(CC)CCCC'),
    E0 = (-86.5616,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,200,800,900,1000,1100,1200,1300,1400,1500,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'CC[CH]OOOC(13187)',
    structure = SMILES('CC[CH]OOOC'),
    E0 = (14.5021,'kJ/mol'),
    modes = [
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.02313,0.0650339,-4.69811e-05,1.75814e-08,-2.75687e-12,1851.24,28.0983], Tmin=(100,'K'), Tmax=(1439.47,'K')), NASAPolynomial(coeffs=[12.0212,0.0344725,-1.51346e-05,2.8322e-09,-1.95295e-13,-1315.02,-28.967], Tmin=(1439.47,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(14.5021,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsOs) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(CCsJOO)"""),
)
...
species(
    label = 'C[CH]CC[CH]OOOC(16849)',
    structure = SMILES('C[CH]CC[CH]OOOC'),
    E0 = (161.388,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3000,3050,390,425,1340,1360,335,370,200,800,914.286,1028.57,1142.86,1257.14,1371.43,1485.71,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.137591,0.0919917,-8.29758e-05,4.6666e-08,-1.18733e-11,19543.6,38.5317], Tmin=(100,'K'), Tmax=(901.205,'K')), NASAPolynomial(coeffs=[7.72836,0.0582999,-2.68976e-05,5.182e-09,-3.65357e-13,18175.4,2.70029], Tmin=(901.205,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(161.388,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(473.925,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(RCCJC) + radical(CCsJOO)"""),
)

species(
    label = 'C[CH]CC[C](CC)OOOC(16850)',
    structure = SMILES('C[CH]CC[C](CC)OOOC'),
    E0 = (100.361,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (160.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.02875,0.120134,-0.000110583,6.51501e-08,-1.75251e-11,12243.4,46.7548], Tmin=(100,'K'), Tmax=(854.053,'K')), NASAPolynomial(coeffs=[8.03399,0.0776886,-3.60342e-05,6.9582e-09,-4.91128e-13,10695.4,4.46201], Tmin=(854.053,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(100.361,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(615.271,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(C2CsJOO) + radical(RCCJC)"""),
)
...
species(
    label = 'C[CH]C[CH]C(CC)OOOC(16851)',
    structure = SMILES('C[CH]C[CH]C(CC)OOOC'),
    E0 = (114.152,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (160.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.04724,0.118212,-9.78021e-05,4.66092e-08,-9.77637e-12,13905,49.0001], Tmin=(100,'K'), Tmax=(1082.69,'K')), NASAPolynomial(coeffs=[11.794,0.0707703,-3.20739e-05,6.13698e-09,-4.31053e-13,11124.4,-13.9716], Tmin=(1082.69,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(114.152,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(615.271,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(RCCJC) + radical(CCJCOOH)"""),
)

species(
    label = '[CH2]C(CC[CH]C)OOOC(16852)',
    structure = SMILES('[CH2]C(CC[CH]C)OOOC'),
    E0 = (151.48,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (146.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.617433,0.105721,-8.72324e-05,4.02386e-08,-7.98954e-12,18381.5,44.8934], Tmin=(100,'K'), Tmax=(1153.58,'K')), NASAPolynomial(coeffs=[12.9139,0.0588006,-2.62216e-05,4.97935e-09,-3.4818e-13,15259.7,-22.3203], Tmin=(1153.58,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(151.48,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(544.598,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(RCCJC) + radical(CJCOOH)"""),
)

species(
    label = 'C[CH]CCC([CH]C)OOOC(16853)',
    structure = SMILES('C[CH]CCC([CH]C)OOOC'),
    E0 = (114.152,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3050,390,425,1340,1360,335,370,1380,1390,370,380,2900,435,2750,2762.5,2775,2787.5,2800,2812.5,2825,2837.5,2850,1350,1380,1410,1440,1470,1500,700,750,800,1000,1050,1100,1350,1375,1400,900,1000,1100,200,800,900,1000,1100,1200,1300,1400,1500,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (160.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.04724,0.118212,-9.78022e-05,4.66093e-08,-9.77642e-12,13905,49.0001], Tmin=(100,'K'), Tmax=(1082.68,'K')), NASAPolynomial(coeffs=[11.794,0.0707704,-3.2074e-05,6.13698e-09,-4.31054e-13,11124.4,-13.9715], Tmin=(1082.68,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(114.152,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(615.271,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(CCJCOOH) + radical(RCCJC)"""),
)

species(
    label = 'C[CH][CH]CC(CC)OOOC(16854)',
    structure = SMILES('C[CH][CH]CC(CC)OOOC'),
    E0 = (108.196,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3050,390,425,1340,1360,335,370,1380,1390,370,380,2900,435,2750,2762.5,2775,2787.5,2800,2812.5,2825,2837.5,2850,1350,1380,1410,1440,1470,1500,700,750,800,1000,1050,1100,1350,1375,1400,900,1000,1100,200,800,900,1000,1100,1200,1300,1400,1500,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    ...
    molecularWeight = (160.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.06522,0.117375,-9.43391e-05,4.27195e-08,-8.43451e-12,14487.7,48.5385], Tmin=(100,'K'), Tmax=(1147.64,'K')), NASAPolynomial(coeffs=[12.8499,0.0688745,-3.09482e-05,5.89564e-09,-4.12879e-13,11293.7,-20.5104], Tmin=(1147.64,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(118.984,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(615.271,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(RCCJC) + radical(RCCJ)"""),
)

species(
    label = '[CH2][CH]CCC(CC)OOOC(16856)',
    structure = SMILES('[CH2][CH]CCC(CC)OOOC'),
    E0 = (118.984,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3025,407.5,1350,352.5,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,200,800,900,1000,1100,1200,1300,1400,1500,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2]C(C)CC(CC)OOOC(16858)',
    structure = SMILES('[CH2]C(C)CC(CC)OOOC'),
    E0 = (-81.321,'kJ/mol'),
    modes = [
...
species(
    label = '[CH2]CC(CC)OOOC(16859)',
    structure = SMILES('[CH2]CC(CC)OOOC'),
    E0 = (-27.9021,'kJ/mol'),
    modes = [
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.525556,0.0941367,-6.98042e-05,2.66061e-08,-4.17037e-12,-3188.95,39.3711], Tmin=(100,'K'), Tmax=(1471.53,'K')), NASAPolynomial(coeffs=[17.924,0.0439861,-1.86836e-05,3.44636e-09,-2.35751e-13,-8618.8,-56.7648], Tmin=(1471.53,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-27.9021,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(498.868,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(RCCJ)"""),
)

species(
    label = '[CH]CCC(CC)OOOC(16860)',
    structure = SMILES('[CH]CCC(CC)OOOC'),
    E0 = (191.286,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (146.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.14409,0.109933,-8.85462e-05,3.7321e-08,-6.49337e-12,23193.9,43.0499], Tmin=(100,'K'), Tmax=(1337.65,'K')), NASAPolynomial(coeffs=[18.7373,0.0504812,-2.18784e-05,4.09462e-09,-2.83499e-13,17875.1,-58.6501], Tmin=(1337.65,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(191.286,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(544.598,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(CCJ2_triplet)"""),
)

species(
    label = 'C[C]CCC(CC)OOOC(16861)',
    structure = SMILES('C[C]CCC(CC)OOOC'),
    E0 = (167.506,'kJ/mol'),
    modes = [
...
reaction(
    label = 'reaction1',
    reactants = ['C[CH]CCC(CC)OOOC(10391)'],
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'CC=CCC(CC)OOOC(16840)'],
    products = ['C[CH]CCC(CC)OOOC(10391)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'C=CCCC(CC)OOOC(16841)'],
    products = ['C[CH]CCC(CC)OOOC(10391)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['C3H6(72)', '[CH2]C(CC)OOOC(16842)'],
    products = ['C[CH]CCC(CC)OOOC(10391)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CC[CH]CC(CC)OOOC(16843)'],
    products = ['C[CH]CCC(CC)OOOC(10391)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2]CCCC(CC)OOOC(16844)'],
    products = ['C[CH]CCC(CC)OOOC(10391)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['CCC[CH]C(CC)OOOC(16845)'],
    products = ['C[CH]CCC(CC)OOOC(10391)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['C[CH]C(CCCC)OOOC(16847)'],
    products = ['C[CH]CCC(CC)OOOC(10391)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]CC(CCCC)OOOC(16848)'],
    products = ['C[CH]CCC(CC)OOOC(10391)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]OOOC(CC)CCCC(3708)'],
    products = ['C[CH]CCC(CC)OOOC(10391)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CH3OO(27)', 'C[CH]CCC([O])CC(9700)'],
    products = ['C[CH]CCC(CC)OOOC(10391)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CH3O(25)', 'C[CH]CCC(CC)O[O](248)'],
    products = ['C[CH]CCC(CC)OOOC(10391)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CH3(17)', 'C[CH]CCC(CC)OO[O](9704)'],
    products = ['C[CH]CCC(CC)OOOC(10391)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]C[CH]C(129)', 'CC[CH]OOOC(13187)'],
    products = ['C[CH]CCC(CC)OOOC(10391)'],
...
reaction(
    label = 'reaction17',
    reactants = ['C2H5(29)', 'C[CH]CC[CH]OOOC(16849)'],
    products = ['C[CH]CCC(CC)OOOC(10391)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(3)', 'C[CH]CC[C](CC)OOOC(16850)'],
    products = ['C[CH]CCC(CC)OOOC(10391)'],
...
reaction(
    label = 'reaction19',
    reactants = ['C3H6(T)(143)', '[CH2]C(CC)OOOC(16842)'],
    products = ['C[CH]CCC(CC)OOOC(10391)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(3)', 'C[CH]C[CH]C(CC)OOOC(16851)'],
    products = ['C[CH]CCC(CC)OOOC(10391)'],
...
reaction(
    label = 'reaction21',
    reactants = ['CH3(17)', '[CH2]C(CC[CH]C)OOOC(16852)'],
    products = ['C[CH]CCC(CC)OOOC(10391)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(3)', 'C[CH]CCC([CH]C)OOOC(16853)'],
    products = ['C[CH]CCC(CC)OOOC(10391)'],
...
reaction(
    label = 'reaction23',
    reactants = ['H(3)', 'C[CH][CH]CC(CC)OOOC(16854)'],
    products = ['C[CH]CCC(CC)OOOC(10391)'],
...
reaction(
    label = 'reaction24',
    reactants = ['H(3)', '[CH2]CC(CC[CH]C)OOOC(16855)'],
    products = ['C[CH]CCC(CC)OOOC(10391)'],
...
reaction(
    label = 'reaction25',
    reactants = ['H(3)', '[CH2][CH]CCC(CC)OOOC(16856)'],
    products = ['C[CH]CCC(CC)OOOC(10391)'],
...
reaction(
    label = 'reaction26',
    reactants = ['H(3)', '[CH2]OOOC(CC)CC[CH]C(16857)'],
    products = ['C[CH]CCC(CC)OOOC(10391)'],
...
reaction(
    label = 'reaction28',
    reactants = ['CH2(S)(23)', 'C[CH]CCC(CC)OOO(10380)'],
    products = ['C[CH]CCC(CC)OOOC(10391)'],
...
reaction(
    label = 'reaction30',
    reactants = ['[CH2]C(C)CC(CC)OOOC(16858)'],
    products = ['C[CH]CCC(CC)OOOC(10391)'],
...
reaction(
    label = 'reaction31',
    reactants = ['CHCH3(T)(95)', '[CH2]CC(CC)OOOC(16859)'],
    products = ['C[CH]CCC(CC)OOOC(10391)'],
...
reaction(
    label = 'reaction32',
    reactants = ['CH3(17)', '[CH]CCC(CC)OOOC(16860)'],
    products = ['C[CH]CCC(CC)OOOC(10391)'],
...
reaction(
    label = 'reaction33',
    reactants = ['H(3)', 'C[C]CCC(CC)OOOC(16861)'],
    products = ['C[CH]CCC(CC)OOOC(10391)'],
