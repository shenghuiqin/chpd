...
species(
    label = '[CH]=C1CC1C[CH]CCC(28698)',
    structure = SMILES('[CH]=C1CC1C[CH]CCC'),
    E0 = (501.626,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (122.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.503978,0.0882675,-5.62607e-05,1.82621e-08,-2.42582e-12,60502.5,37.6186], Tmin=(100,'K'), Tmax=(1716.74,'K')), NASAPolynomial(coeffs=[18.9046,0.0430455,-1.6748e-05,2.918e-09,-1.91334e-13,53838.6,-66.5057], Tmin=(1716.74,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(501.626,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(536.283,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + ring(Methylene_cyclopropane) + radical(Cds_P) + radical(RCCJCC)"""),
)

species(
    label = '[CH]=C1C([CH2])CC1CCC(28469)',
    structure = SMILES('[CH]=C1C([CH2])CC1CCC'),
    E0 = (441.467,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (122.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[9.22061,0.0182815,0.000107959,-1.16221e-07,2.72634e-11,52791.7,-6.3268], Tmin=(100,'K'), Tmax=(1728.49,'K')), NASAPolynomial(coeffs=[81.7764,0.0399798,-7.54104e-05,1.79643e-08,-1.32321e-12,-614.612,-478.005], Tmin=(1728.49,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(441.467,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(540.441,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + ring(methylenecyclobutane) + radical(Cds_P) + radical(Isobutyl)"""),
)
...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.218055,0.0872045,-6.50134e-05,2.79555e-08,-5.34697e-12,39909.5,34.2512], Tmin=(100,'K'), Tmax=(1164.43,'K')), NASAPolynomial(coeffs=[9.47394,0.0554092,-2.40554e-05,4.50602e-09,-3.1245e-13,37753.9,-11.8122], Tmin=(1164.43,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(330.723,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCtCs) + group(Cds-CdsHH) + group(Ct-Ct(Cds-Cds)) + group(Ct-CtH) + radical(RCCJCC)"""),
)

species(
    label = 'C#CC([CH2])CC=CCC(28700)',
    structure = SMILES('C#CC([CH2])CC=CCC'),
    E0 = (343.309,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (121.2,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.818518,0.0933009,-7.20885e-05,3.04124e-08,-5.23532e-12,41474.6,38.6523], Tmin=(100,'K'), Tmax=(1382.41,'K')), NASAPolynomial(coeffs=[17.7683,0.0395195,-1.37318e-05,2.2697e-09,-1.45841e-13,36335.8,-57.0371], Tmin=(1382.41,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(343.309,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CtCsCsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Ct-CtCs) + group(Ct-CtH) + radical(Isobutyl)"""),
)

species(
    label = 'C#CC([CH2])C=CCCC(28701)',
    structure = SMILES('C#CC([CH2])C=CCCC'),
    E0 = (319.362,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2995,3025,975,1000,1300,1375,400,500,1630,1680,2750,2800,2850,1350,1500,750,1050,1375,1000,2175,525,1380,1390,370,380,2900,435,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3100,440,815,1455,1000,750,770,3400,2100,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (121.2,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.633398,0.0987127,-8.4678e-05,4.03038e-08,-7.95456e-12,38579.8,35.1184], Tmin=(100,'K'), Tmax=(1197.67,'K')), NASAPolynomial(coeffs=[15.2797,0.045566,-1.81153e-05,3.25259e-09,-2.20533e-13,34768.1,-44.5233], Tmin=(1197.67,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(319.362,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CtCsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Ct-CtCs) + group(Ct-CtH) + radical(Isobutyl)"""),
)
...
species(
    ...
    molecularWeight = (122.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0910126,0.0942214,-6.97762e-05,9.35564e-09,1.62823e-11,42364.8,34.9614], Tmin=(100,'K'), Tmax=(602.532,'K')), NASAPolynomial(coeffs=[7.70469,0.0599423,-2.49313e-05,4.54019e-09,-3.09125e-13,41152.1,-0.363104], Tmin=(602.532,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(351.134,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(527.969,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CtCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(RCCJCC) + radical(Tert_Propargyl)"""),
)

species(
    label = 'C#CC([CH2])CC[CH]CC(28703)',
    structure = SMILES('C#CC([CH2])CC[CH]CC'),
    E0 = (421.096,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,2175,525,1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3000,3100,440,815,1455,1000,750,770,3400,2100,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'C#CC([CH2])[CH]CCCC(28542)',
    structure = SMILES('C#CC([CH2])[CH]CCCC'),
    E0 = (421.18,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (122.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.408166,0.0959613,-7.74808e-05,3.62956e-08,-7.26538e-12,50815.7,39.0244], Tmin=(100,'K'), Tmax=(1161.23,'K')), NASAPolynomial(coeffs=[12.3453,0.0520301,-2.07331e-05,3.71639e-09,-2.51398e-13,47853.7,-24.4103], Tmin=(1161.23,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(421.18,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(527.969,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CtCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(Isobutyl) + radical(Cs_S)"""),
)

species(
    label = 'C#CC(C)[CH][CH]CCC(28704)',
    ...
    molecularWeight = (122.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.100247,0.0912617,-7.55454e-05,4.11773e-08,-1.04416e-11,49514.1,38.0016], Tmin=(100,'K'), Tmax=(894.574,'K')), NASAPolynomial(coeffs=[6.56189,0.0623691,-2.7099e-05,5.0734e-09,-3.51859e-13,48358,7.54779], Tmin=(894.574,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(410.556,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(527.969,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CtCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(RCCJCC) + radical(Cs_S)"""),
)

species(
    label = 'C#CC([CH2])CCC[CH]C(28705)',
    structure = SMILES('C#CC([CH2])CCC[CH]C'),
    E0 = (421.084,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (122.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.36751,0.0969429,-8.37864e-05,4.42903e-08,-1.01115e-11,50801.2,39.0625], Tmin=(100,'K'), Tmax=(1026.73,'K')), NASAPolynomial(coeffs=[10.5837,0.0542786,-2.1456e-05,3.81854e-09,-2.57001e-13,48552.4,-14.0596], Tmin=(1026.73,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(421.084,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(527.969,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CtCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(RCCJC) + radical(Isobutyl)"""),
)

species(
    label = 'C#C[C]([CH2])CCCCC(28706)',
    structure = SMILES('[CH]=C=C([CH2])CCCCC'),
    E0 = (319.637,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (122.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.973986,0.101237,-8.00869e-05,3.40459e-08,-5.94501e-12,38629.2,37.1907], Tmin=(100,'K'), Tmax=(1348.72,'K')), NASAPolynomial(coeffs=[18.0106,0.0449327,-1.74674e-05,3.09322e-09,-2.07584e-13,33508.2,-60.0781], Tmin=(1348.72,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(319.637,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(532.126,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(C=C=CJ) + radical(Allyl_P)"""),
)

species(
    label = 'C#CC([CH2])CCCC[CH2](28707)',
    structure = SMILES('C#CC([CH2])CCCC[CH2]'),
    E0 = (431.884,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (122.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.737717,0.100007,-8.39335e-05,4.00357e-08,-7.96516e-12,52117.7,39.4358], Tmin=(100,'K'), Tmax=(1187.96,'K')), NASAPolynomial(coeffs=[14.7018,0.0480208,-1.82938e-05,3.20033e-09,-2.13492e-13,48449.3,-37.7107], Tmin=(1187.96,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(431.884,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(527.969,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CtCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(RCCJ) + radical(Isobutyl)"""),
)

species(
    label = '[C]#CC(C)C[CH]CCC(28708)',
    structure = SMILES('[C]#CC(C)C[CH]CCC'),
    E0 = (553.157,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (122.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.273765,0.0985746,-9.62138e-05,6.29845e-08,-1.82918e-11,66679.1,37.5215], Tmin=(100,'K'), Tmax=(812.306,'K')), NASAPolynomial(coeffs=[7.55578,0.0600204,-2.50207e-05,4.55633e-09,-3.09807e-13,65407.1,1.37594], Tmin=(812.306,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(553.157,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(527.969,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CtCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(Acetyl) + radical(RCCJCC)"""),
)

species(
    label = '[C]#CC([CH2])CCCCC(28709)',
    structure = SMILES('[C]#CC([CH2])CCCCC'),
    E0 = (563.781,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (122.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.674191,0.101863,-9.2624e-05,5.02001e-08,-1.14534e-11,67976.3,38.1668], Tmin=(100,'K'), Tmax=(1042.37,'K')), NASAPolynomial(coeffs=[12.5813,0.0509955,-1.94237e-05,3.38293e-09,-2.24702e-13,65212.9,-26.333], Tmin=(1042.37,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(563.781,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(527.969,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CtCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(Acetyl) + radical(Isobutyl)"""),
)

species(
    label = 'C#CC(C)C[CH][CH]CC(28710)',
    ...
    molecularWeight = (122.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0841211,0.096097,-0.000100211,7.66583e-08,-2.62463e-11,49509.4,38.6559], Tmin=(100,'K'), Tmax=(796.999,'K')), NASAPolynomial(coeffs=[4.76931,0.0647191,-2.79459e-05,5.15987e-09,-3.52632e-13,48958.7,17.7408], Tmin=(796.999,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(410.472,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(527.969,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CtCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(RCCJCC) + radical(RCCJCC)"""),
)

species(
    label = 'C#CC(C)C[CH]C[CH]C(28711)',
    ...
    molecularWeight = (122.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.795241,0.0814782,-2.37495e-05,-7.40602e-08,7.54061e-11,49471.4,35.8523], Tmin=(100,'K'), Tmax=(507.182,'K')), NASAPolynomial(coeffs=[5.51478,0.0634449,-2.71652e-05,5.02407e-09,-3.45138e-13,48745.8,13.8543], Tmin=(507.182,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(410.46,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(527.969,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CtCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(RCCJCC) + radical(RCCJC)"""),
)

species(
    label = 'C#CC(C)C[CH]CC[CH2](28712)',
    structure = SMILES('C#CC(C)C[CH]CC[CH2]'),
    E0 = (421.26,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,2175,525,1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3000,3100,440,815,1455,1000,750,770,3400,2100,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (122.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0930068,0.0937991,-7.71606e-05,3.91692e-08,-8.87312e-12,50810,37.9174], Tmin=(100,'K'), Tmax=(1010.99,'K')), NASAPolynomial(coeffs=[8.84795,0.0584229,-2.46714e-05,4.55568e-09,-3.13531e-13,49002.3,-5.31503], Tmin=(1010.99,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(421.26,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(527.969,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CtCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(RCCJCC) + radical(RCCJ)"""),
)
...
species(
    ...
    molecularWeight = (122.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.704463,0.0945051,-6.76541e-05,2.53025e-08,-3.88999e-12,16565.4,35.0033], Tmin=(100,'K'), Tmax=(1506.3,'K')), NASAPolynomial(coeffs=[18.2435,0.0441889,-1.75488e-05,3.12679e-09,-2.09522e-13,10857.1,-64.1722], Tmin=(1506.3,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(136.265,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(532.126,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCtCs) + group(Cds-CdsHH) + group(Ct-Ct(Cds-Cds)) + group(Ct-CtH)"""),
)

species(
    label = 'C#CC(C)C=CCCC(28714)',
    ...
    molecularWeight = (122.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.714516,0.0977362,-7.43817e-05,3.01136e-08,-5.04391e-12,13919,33.6287], Tmin=(100,'K'), Tmax=(1387.61,'K')), NASAPolynomial(coeffs=[17.1319,0.046292,-1.87716e-05,3.3965e-09,-2.30476e-13,8966.14,-58.3162], Tmin=(1387.61,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(114.279,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(532.126,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CtCsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Ct-CtCs) + group(Ct-CtH)"""),
)

species(
    label = 'C#CC(C)CC=CCC(28715)',
    ...
    molecularWeight = (122.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.582108,0.0887231,-4.99793e-05,6.1856e-09,3.06698e-12,16800,36.0154], Tmin=(100,'K'), Tmax=(1073.92,'K')), NASAPolynomial(coeffs=[16.3391,0.0455126,-1.73018e-05,3.08109e-09,-2.0988e-13,12023,-52.1462], Tmin=(1073.92,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(138.227,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(532.126,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CtCsCsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Ct-CtCs) + group(Ct-CtH)"""),
)
...
species(
    ...
    opticalIsomers = 1,
    molecularWeight = (122.207,'amu'),
    collisionModel = TransportData(shapeIndex=2, epsilon=(3649.09,'J/mol'), sigma=(6.74704,'angstroms'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with Tc=569.98 K, Pc=26.96 bar (from Joback method)"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
...
species(
    label = 'C#CC([CH2])CC([CH2])CC(28716)',
    structure = SMILES('C#CC([CH2])CC([CH2])CC'),
    E0 = (429.373,'kJ/mol'),
    modes = [
...
reaction(
    label = 'reaction2',
    reactants = ['C#CC([CH2])C[CH]CCC(28449)'],
    products = ['[CH]=C1CC1C[CH]CCC(28698)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['C#CC([CH2])C[CH]CCC(28449)'],
    products = ['[CH]=C1C([CH2])CC1CCC(28469)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', 'C#CC(=C)C[CH]CCC(28699)'],
    products = ['C#CC([CH2])C[CH]CCC(28449)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)', 'C#CC([CH2])CC=CCC(28700)'],
    products = ['C#CC([CH2])C[CH]CCC(28449)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['H(3)', 'C#CC([CH2])C=CCCC(28701)'],
    products = ['C#CC([CH2])C[CH]CCC(28449)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(1.46e+08,'cm^3/(mol*s)'), n=1.64, Ea=(5.73208,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""From training reaction 2555 used for Cds-CsH_Cds-CsH;HJ
Exact match found for rate rule [Cds-CsH_Cds-CsH;HJ]
...
reaction(
    label = 'reaction8',
    reactants = ['C=CC[CH]CCC(456)', 'C2H(33)'],
    products = ['C#CC([CH2])C[CH]CCC(28449)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['C2H5(29)', 'C#CC([CH2])CC=C(26851)'],
    products = ['C#CC([CH2])C[CH]CCC(28449)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['C#C[C](C)C[CH]CCC(28702)'],
    products = ['C#CC([CH2])C[CH]CCC(28449)'],
...
reaction(
    label = 'reaction12',
    reactants = ['C#CC([CH2])CC[CH]CC(28703)'],
    products = ['C#CC([CH2])C[CH]CCC(28449)'],
...
reaction(
    label = 'reaction13',
    reactants = ['C#CC([CH2])C[CH]CCC(28449)'],
    products = ['C#CC([CH2])[CH]CCCC(28542)'],
...
reaction(
    label = 'reaction14',
    reactants = ['C#CC([CH2])C[CH]CCC(28449)'],
    products = ['C#CC(C)[CH][CH]CCC(28704)'],
...
reaction(
    label = 'reaction15',
    reactants = ['C#CC([CH2])C[CH]CCC(28449)'],
    products = ['C#CC([CH2])CCC[CH]C(28705)'],
...
reaction(
    label = 'reaction16',
    reactants = ['C#CC([CH2])C[CH]CCC(28449)'],
    products = ['C#C[C]([CH2])CCCCC(28706)'],
...
reaction(
    label = 'reaction17',
    reactants = ['C#CC([CH2])CCCC[CH2](28707)'],
    products = ['C#CC([CH2])C[CH]CCC(28449)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[C]#CC(C)C[CH]CCC(28708)'],
    products = ['C#CC([CH2])C[CH]CCC(28449)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[C]#CC([CH2])CCCCC(28709)'],
    products = ['C#CC([CH2])C[CH]CCC(28449)'],
...
reaction(
    label = 'reaction20',
    reactants = ['C#CC([CH2])C[CH]CCC(28449)'],
    products = ['C#CC(C)C[CH][CH]CC(28710)'],
...
reaction(
    label = 'reaction21',
    reactants = ['C#CC([CH2])C[CH]CCC(28449)'],
    products = ['C#CC(C)C[CH]C[CH]C(28711)'],
...
reaction(
    label = 'reaction22',
    reactants = ['C#CC(C)C[CH]CC[CH2](28712)'],
    products = ['C#CC([CH2])C[CH]CCC(28449)'],
...
reaction(
    label = 'reaction29',
    reactants = ['CH2(S)(23)', 'C#CC([CH2])C[CH]CC(26535)'],
    products = ['C#CC([CH2])C[CH]CCC(28449)'],
...
reaction(
    label = 'reaction31',
    reactants = ['C#CC([CH2])C[CH]CCC(28449)'],
    products = ['C#CC[CH]C[CH]CCC(28665)'],
...
reaction(
    label = 'reaction32',
    reactants = ['C#CC([CH2])CC([CH2])CC(28716)'],
    products = ['C#CC([CH2])C[CH]CCC(28449)'],
...
reaction(
    label = 'reaction36',
    reactants = ['[CH]CCC(133)', 'C#CC([CH2])[CH2](26629)'],
    products = ['C#CC([CH2])C[CH]CCC(28449)'],
