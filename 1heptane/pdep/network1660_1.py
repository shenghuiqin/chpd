species(
    label = 'CC(C[CH]CO[C]=O)OO(8714)',
    structure = SMILES('CC(C[CH]CO[C]=O)OO'),
    E0 = (-182.34,'kJ/mol'),
    modes = [
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.625008,0.103223,-0.000100263,5.16953e-08,-1.09251e-11,-21765.2,40.1187], Tmin=(100,'K'), Tmax=(1125.23,'K')), NASAPolynomial(coeffs=[16.4717,0.0424469,-1.92452e-05,3.69452e-09,-2.60447e-13,-25612.7,-44.3802], Tmin=(1125.23,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-182.34,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(448.981,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdOsH) + radical((O)CJOCC) + radical(CCJCO)"""),
)
...
species(
    label = 'CC(C=CCO[C]=O)OO(9746)',
    structure = SMILES('CC(C=CCO[C]=O)OO'),
    E0 = (-260.35,'kJ/mol'),
    modes = [
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.412782,0.0945745,-8.44522e-05,3.86864e-08,-7.19386e-12,-31152.1,38.8508], Tmin=(100,'K'), Tmax=(1273.47,'K')), NASAPolynomial(coeffs=[17.9197,0.0369919,-1.66266e-05,3.17948e-09,-2.23369e-13,-35821.3,-54.0244], Tmin=(1273.47,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-260.35,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(428.195,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-OdOsH) + radical((O)CJOCC)"""),
)

species(
    label = 'CC(CC=CO[C]=O)OO(9747)',
    structure = SMILES('CC(CC=CO[C]=O)OO'),
    E0 = (-281.168,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1855,455,950,2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,3615,1310,387.5,850,1000,2750,2850,1437.5,1250,1305,750,350,1380,1390,370,380,2900,435,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (145.133,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.07094,0.10931,-0.000112269,5.88132e-08,-1.22977e-11,-33632.1,36.0423], Tmin=(100,'K'), Tmax=(1154.97,'K')), NASAPolynomial(coeffs=[20.44,0.0348108,-1.55147e-05,2.96478e-09,-2.08927e-13,-38601,-70.8348], Tmin=(1154.97,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-281.168,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(428.195,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-(Cds-O2d)(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-OdOsH) + radical((O)CJOC)"""),
)
...
species(
    label = 'CC([CH]CCO[C]=O)OO(9748)',
    structure = SMILES('CC([CH]CCO[C]=O)OO'),
    E0 = (-181.827,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,1855,455,950,3615,1310,387.5,850,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,1380,1390,370,380,2900,435,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (146.141,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.676464,0.108873,-0.0001184,7.10785e-08,-1.76836e-11,-21705.4,40.1265], Tmin=(100,'K'), Tmax=(960.431,'K')), NASAPolynomial(coeffs=[14.1114,0.047286,-2.2216e-05,4.31617e-09,-3.058e-13,-24546,-30.6196], Tmin=(960.431,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-181.827,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(448.981,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdOsH) + radical(CCJCOOH) + radical((O)CJOCC)"""),
)

species(
    label = 'CC(CC[CH]O[C]=O)OO(9749)',
    structure = SMILES('CC(CC[CH]O[C]=O)OO'),
    E0 = (-187.564,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (146.141,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.25386,0.117819,-0.000133487,7.909e-08,-1.87837e-11,-22371.3,39.4342], Tmin=(100,'K'), Tmax=(1020.95,'K')), NASAPolynomial(coeffs=[18.899,0.0388614,-1.74823e-05,3.34056e-09,-2.3497e-13,-26486.3,-58.2098], Tmin=(1020.95,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-187.564,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(448.981,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdOsH) + radical(CCsJOC(O)H) + radical((O)CJOCC)"""),
)

species(
    label = 'CC(C[CH][CH]OC=O)OO(9750)',
    structure = SMILES('CC(C[CH][CH]OC=O)OO'),
    E0 = (-185.344,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (146.141,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.767016,0.105514,-0.00010208,5.16702e-08,-1.06621e-11,-22120.6,40.5418], Tmin=(100,'K'), Tmax=(1153.72,'K')), NASAPolynomial(coeffs=[17.6658,0.0416066,-1.89919e-05,3.6585e-09,-2.58416e-13,-26373.9,-51.0216], Tmin=(1153.72,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-185.344,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(448.981,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdOsH) + radical(CCsJOC(O)H) + radical(CCJCO)"""),
)

species(
    label = 'C[C](CCCO[C]=O)OO(9751)',
    structure = SMILES('C[C](CCCO[C]=O)OO'),
    E0 = (-195.343,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (146.141,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.642499,0.110212,-0.000130186,8.97637e-08,-2.60393e-11,-23334.4,37.9979], Tmin=(100,'K'), Tmax=(826.005,'K')), NASAPolynomial(coeffs=[11.3197,0.0522851,-2.49936e-05,4.86442e-09,-3.43878e-13,-25310.6,-17.4262], Tmin=(826.005,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-195.343,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(448.981,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdOsH) + radical(C2CsJOOH) + radical((O)CJOCC)"""),
)

species(
    label = '[CH2]C(CCCO[C]=O)OO(9752)',
    structure = SMILES('[CH2]C(CCCO[C]=O)OO'),
    E0 = (-168.28,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (146.141,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.820063,0.110269,-0.000118448,6.85351e-08,-1.62361e-11,-20069.3,40.3266], Tmin=(100,'K'), Tmax=(1011.95,'K')), NASAPolynomial(coeffs=[15.9143,0.0441224,-2.04002e-05,3.94246e-09,-2.78786e-13,-23456.2,-40.6061], Tmin=(1011.95,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-168.28,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(448.981,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdOsH) + radical((O)CJOCC) + radical(CJCOOH)"""),
)

species(
    label = 'CC(CCCO[C]=O)O[O](9753)',
    structure = SMILES('CC(CCCO[C]=O)O[O]'),
    E0 = (-230.238,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (146.141,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.498847,0.104026,-0.00011013,6.53587e-08,-1.6143e-11,-27533.4,37.9395], Tmin=(100,'K'), Tmax=(966.032,'K')), NASAPolynomial(coeffs=[13.309,0.0468518,-2.1353e-05,4.09283e-09,-2.87833e-13,-30201.2,-28.1982], Tmin=(966.032,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-230.238,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdOsH) + radical((O)CJOCC) + radical(ROOJ)"""),
)

species(
    label = 'CC([CH][CH]COC=O)OO(9754)',
    structure = SMILES('CC([CH][CH]COC=O)OO'),
    E0 = (-179.607,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (146.141,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0918113,0.0954977,-8.36105e-05,3.97109e-08,-8.03486e-12,-21459.1,40.8774], Tmin=(100,'K'), Tmax=(1138.07,'K')), NASAPolynomial(coeffs=[12.8352,0.0500626,-2.37257e-05,4.63089e-09,-3.28773e-13,-24401.4,-23.1596], Tmin=(1138.07,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-179.607,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(448.981,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdOsH) + radical(CCJCO) + radical(CCJCOOH)"""),
)

species(
    label = 'C[C](C[CH]COC=O)OO(9755)',
    structure = SMILES('C[C](C[CH]COC=O)OO'),
    E0 = (-193.123,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (146.141,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0509812,0.0953354,-8.92303e-05,4.92754e-08,-1.2067e-11,-23092.3,38.3744], Tmin=(100,'K'), Tmax=(938.901,'K')), NASAPolynomial(coeffs=[9.12873,0.0566617,-2.7445e-05,5.40498e-09,-3.85795e-13,-24796.9,-4.84827], Tmin=(938.901,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-193.123,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(448.981,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdOsH) + radical(C2CsJOOH) + radical(CCJCO)"""),
)

species(
    label = '[CH2]C(C[CH]COC=O)OO(9756)',
    structure = SMILES('[CH2]C(C[CH]COC=O)OO'),
    E0 = (-166.06,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (146.141,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.304323,0.0976904,-8.6345e-05,4.04903e-08,-7.93212e-12,-19820,41.3254], Tmin=(100,'K'), Tmax=(1188.27,'K')), NASAPolynomial(coeffs=[14.9182,0.0464484,-2.1661e-05,4.20033e-09,-2.97167e-13,-23437.7,-34.7402], Tmin=(1188.27,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-166.06,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(448.981,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdOsH) + radical(CCJCO) + radical(CJCOOH)"""),
)

species(
    label = 'CC(C[CH]COC=O)O[O](9757)',
    structure = SMILES('CC(C[CH]COC=O)O[O]'),
    E0 = (-228.017,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (146.141,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0713278,0.0908257,-7.59602e-05,3.47862e-08,-6.82459e-12,-27286.5,38.7419], Tmin=(100,'K'), Tmax=(1166.47,'K')), NASAPolynomial(coeffs=[12.1334,0.0494623,-2.27691e-05,4.38582e-09,-3.09029e-13,-30100.5,-21.3081], Tmin=(1166.47,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-228.017,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdOsH) + radical(CCJCO) + radical(ROOJ)"""),
)
...
species(
    label = 'CC(CC=COC=O)OO(8720)',
    structure = SMILES('CC(CC=COC=O)OO'),
    E0 = (-477.616,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (146.141,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.0984,0.104299,-9.35004e-05,4.2053e-08,-7.54776e-12,-57254,37.5142], Tmin=(100,'K'), Tmax=(1333.85,'K')), NASAPolynomial(coeffs=[22.1666,0.0345315,-1.5043e-05,2.83977e-09,-1.98181e-13,-63460.5,-81.428], Tmin=(1333.85,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-477.616,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-(Cds-O2d)(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-OdOsH)"""),
)

species(
    label = 'CC(C=CCOC=O)OO(9758)',
    structure = SMILES('CC(C=CCOC=O)OO'),
    E0 = (-458.032,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (146.141,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.226172,0.0885655,-6.45883e-05,2.32187e-08,-3.39572e-12,-54933.5,38.5486], Tmin=(100,'K'), Tmax=(1568.32,'K')), NASAPolynomial(coeffs=[18.9058,0.0397686,-1.79164e-05,3.37898e-09,-2.33095e-13,-60934.4,-62.3614], Tmin=(1568.32,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-458.032,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-OdOsH)"""),
)
...
species(
    label = 'O=[C]OC[CH]CCOO(9759)',
    structure = SMILES('O=[C]OC[CH]CCOO'),
    E0 = (-145.917,'kJ/mol'),
    modes = [
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0967234,0.0896582,-9.3574e-05,5.29069e-08,-1.23359e-11,-17412.3,35.6353], Tmin=(100,'K'), Tmax=(1023.01,'K')), NASAPolynomial(coeffs=[13.3428,0.0378657,-1.76332e-05,3.41867e-09,-2.42156e-13,-20122.5,-28.571], Tmin=(1023.01,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-145.917,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(378.308,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cds-OdOsH) + radical((O)CJOCC) + radical(CCJCO)"""),
)
...
species(
    label = 'CC1CC(CO[C]=O)O1(9760)',
    structure = SMILES('CC1CC(CO[C]=O)O1'),
    E0 = (-282.358,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (129.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.368928,0.0658414,-8.93454e-06,-4.27049e-08,2.42668e-11,-33816.1,29.6585], Tmin=(100,'K'), Tmax=(911.181,'K')), NASAPolynomial(coeffs=[17.5413,0.0277168,-7.5117e-06,1.13247e-09,-7.40772e-14,-38492.3,-60.0785], Tmin=(911.181,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-282.358,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(415.724,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-Cs(Cds-O2d)) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdOsH) + ring(Oxetane) + radical((O)CJOCC)"""),
)

species(
    label = '[CH2]C(CO[C]=O)C(C)OO(9761)',
    structure = SMILES('[CH2]C(CO[C]=O)C(C)OO'),
    E0 = (-182.854,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (146.141,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.866599,0.108474,-0.000114197,6.48671e-08,-1.49801e-11,-21818.2,39.9937], Tmin=(100,'K'), Tmax=(1042.43,'K')), NASAPolynomial(coeffs=[16.5452,0.0416623,-1.80595e-05,3.38504e-09,-2.35416e-13,-25448.3,-44.732], Tmin=(1042.43,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-182.854,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(448.981,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdOsH) + radical((O)CJOCC) + radical(Isobutyl)"""),
)
...
species(
    label = 'CC([O])CC(O)CO[C]=O(9763)',
    structure = SMILES('CC([O])CC(O)CO[C]=O'),
    E0 = (-395.857,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (146.141,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.750104,0.105566,-0.000108037,5.89664e-08,-1.30848e-11,-47440.4,39.4763], Tmin=(100,'K'), Tmax=(1081.5,'K')), NASAPolynomial(coeffs=[16.8253,0.040562,-1.78776e-05,3.38938e-09,-2.37444e-13,-51241.9,-46.6917], Tmin=(1081.5,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-395.857,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdOsH) + radical(CC(C)OJ) + radical((O)CJOCC)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['CC(C[CH]CO[C]=O)OO(8714)'],
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'CC(C=CCO[C]=O)OO(9746)'],
    products = ['CC(C[CH]CO[C]=O)OO(8714)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'CC(CC=CO[C]=O)OO(9747)'],
    products = ['CC(C[CH]CO[C]=O)OO(8714)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['CH3CHOOH(63)', 'C=CCO[C]=O(2483)'],
    products = ['CC(C[CH]CO[C]=O)OO(8714)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['CC([CH]CCO[C]=O)OO(9748)'],
    products = ['CC(C[CH]CO[C]=O)OO(8714)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['CC(C[CH]CO[C]=O)OO(8714)'],
    products = ['CC(CC[CH]O[C]=O)OO(9749)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['CC(C[CH]CO[C]=O)OO(8714)'],
    products = ['CC(C[CH][CH]OC=O)OO(9750)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]C(CCCO[C]=O)OO(9752)'],
    products = ['CC(C[CH]CO[C]=O)OO(8714)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CC(CCCO[C]=O)O[O](9753)'],
    products = ['CC(C[CH]CO[C]=O)OO(8714)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CC(C[CH]CO[C]=O)OO(8714)'],
    products = ['CC([CH][CH]COC=O)OO(9754)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CC(C[CH]CO[C]=O)OO(8714)'],
    products = ['C[C](C[CH]COC=O)OO(9755)'],
    transitionState = 'TS13',
    kinetics = Arrhenius(A=(2287.12,'s^-1'), n=1.71494, Ea=(69.5544,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R6Hall;Y_rad_out;Cs_H_out_OOH] for rate rule [R6HJ_3;CO_rad_out;Cs_H_out_OOH/Cs]
Euclidian distance = 1.73205080757
family: intra_H_migration"""),
)
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]C(C[CH]COC=O)OO(9756)'],
    products = ['CC(C[CH]CO[C]=O)OO(8714)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CC(C[CH]CO[C]=O)OO(8714)'],
    products = ['CC(C[CH]COC=O)O[O](9757)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CH2(S)(23)', 'O=[C]OC[CH]CCOO(9759)'],
    products = ['CC(C[CH]CO[C]=O)OO(8714)'],
...
reaction(
    label = 'reaction20',
    reactants = ['CC(C[CH]CO[C]=O)OO(8714)'],
    products = ['OH(5)', 'CC1CC(CO[C]=O)O1(9760)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH2]C(CO[C]=O)C(C)OO(9761)'],
    products = ['CC(C[CH]CO[C]=O)OO(8714)'],
...
reaction(
    label = 'reaction23',
    reactants = ['CO(12)', 'CC(C[CH]C[O])OO(1792)'],
    products = ['CC(C[CH]CO[C]=O)OO(8714)'],
...
reaction(
    label = 'reaction24',
    reactants = ['CC(C[CH]CO[C]=O)OO(8714)'],
    products = ['CC([O])CC(O)CO[C]=O(9763)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[C]=O(361)', 'CC(C[CH]C[O])OO(1792)'],
    products = ['CC(C[CH]CO[C]=O)OO(8714)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[CH]CC(C)OO(1806)', '[CH2]O[C]=O(2123)'],
    products = ['CC(C[CH]CO[C]=O)OO(8714)'],
