...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.96602,0.0252716,5.57921e-05,-9.56095e-08,3.96989e-11,17001.3,20.7783], Tmin=(100,'K'), Tmax=(948.551,'K')), NASAPolynomial(coeffs=[16.3449,0.0137239,-3.57141e-06,6.69299e-10,-5.5274e-14,12065.2,-59.4723], Tmin=(948.551,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(140.601,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-OsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + ring(Cyclobutene) + radical(C=COCJ)"""),
)

species(
    label = '[CH2]OC1C=CC1(23372)',
    ...
    molecularWeight = (83.1085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.80043,0.032692,3.00071e-05,-6.46166e-08,2.74315e-11,21260.2,20.5239], Tmin=(100,'K'), Tmax=(969.86,'K')), NASAPolynomial(coeffs=[14.835,0.0174794,-6.08022e-06,1.16795e-09,-8.87868e-14,16919,-51.3073], Tmin=(969.86,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(175.992,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-OsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cyclobutene) + radical(CsJOCC2)"""),
)
...
species(
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.29884,0.0256766,3.62359e-05,-5.64519e-08,2.0748e-11,30126.1,23.8199], Tmin=(100,'K'), Tmax=(1029.61,'K')), NASAPolynomial(coeffs=[8.61963,0.0300913,-1.24022e-05,2.36945e-09,-1.70099e-13,27288.9,-14.3158], Tmin=(1029.61,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(249.889,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(324.264,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-OsHHH) + ring(Cyclobutane) + radical(CCJCO) + radical(cyclobutane)"""),
)
...
species(
    label = '[CH2]CC=CO[CH2](23378)',
    structure = SMILES('[CH2]CC=CO[CH2]'),
    E0 = (190.624,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2995,3025,975,1000,1300,1375,400,500,1630,1680,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,464.053,464.071,464.112],'cm^-1')),
        HinderedRotor(inertia=(0.000782713,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.108518,'amu*angstrom^2'), symmetry=1, barrier=(16.5875,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.108501,'amu*angstrom^2'), symmetry=1, barrier=(16.5864,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.108507,'amu*angstrom^2'), symmetry=1, barrier=(16.5874,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.21565,0.0468274,2.98811e-06,-4.43333e-08,2.236e-11,23040.1,25.8373], Tmin=(100,'K'), Tmax=(947.32,'K')), NASAPolynomial(coeffs=[17.0212,0.0158328,-4.53099e-06,7.87357e-10,-5.84921e-14,18441.7,-58.025], Tmin=(947.32,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(190.624,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(C=COCJ) + radical(RCCJ)"""),
)

species(
    label = 'COC1=CCC1(23379)',
...
species(
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.11368,0.0260058,4.64089e-05,-7.5019e-08,2.9205e-11,-831.589,19.9832], Tmin=(100,'K'), Tmax=(988.498,'K')), NASAPolynomial(coeffs=[11.9337,0.0245417,-9.44688e-06,1.82028e-09,-1.34489e-13,-4642.89,-36.7373], Tmin=(988.498,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-7.59328,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(324.264,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-OsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cyclobutene)"""),
)

species(
    label = '[CH2]O[CH]C1CC1(23381)',
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.4702,0.0422962,9.23325e-06,-4.64056e-08,2.21809e-11,28775.7,23.1332], Tmin=(100,'K'), Tmax=(947.224,'K')), NASAPolynomial(coeffs=[14.9449,0.0185301,-5.60472e-06,9.68792e-10,-6.98392e-14,24736.5,-48.9909], Tmin=(947.224,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(238.397,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-OsHHH) + ring(Cyclopropane) + radical(CCsJOCs) + radical(CsJOCC)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]OC1[CH]CC1(19500)'],
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', '[CH2]OC1=CCC1(23371)'],
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', '[CH2]OC1C=CC1(23372)'],
    products = ['[CH2]OC1[CH]CC1(19500)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction8',
    reactants = ['COC1[CH]C[CH]1(23376)'],
    products = ['[CH2]OC1[CH]CC1(19500)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]OC1CC1[CH2](19492)'],
    products = ['[CH2]OC1[CH]CC1(19500)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CH2(19)', '[O]C1[CH]CC1(23382)'],
    products = ['[CH2]OC1[CH]CC1(19500)'],
