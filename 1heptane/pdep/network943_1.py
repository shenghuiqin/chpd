...
species(
    label = 'CCC=CCC=[C]O(7720)',
    structure = SMILES('CCC=CCC=[C]O'),
    E0 = (61.0302,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2995,3010,3025,975,987.5,1000,1300,1337.5,1375,400,450,500,1630,1655,1680,1685,370,3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (111.162,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0478963,0.0738197,-3.33443e-05,-1.2483e-08,1.10261e-11,7494.16,34.7146], Tmin=(100,'K'), Tmax=(986.926,'K')), NASAPolynomial(coeffs=[17.9567,0.0301108,-1.07993e-05,1.93344e-09,-1.35322e-13,2552.95,-58.5741], Tmin=(986.926,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(61.0302,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(C=CJO)"""),
)

species(
    label = 'CCCC=CC=[C]O(7721)',
    ...
    molecularWeight = (111.162,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.213346,0.0782052,-3.63869e-05,-1.65847e-08,1.4422e-11,5266.9,33.0678], Tmin=(100,'K'), Tmax=(956.639,'K')), NASAPolynomial(coeffs=[20.488,0.0260014,-8.39983e-06,1.45129e-09,-1.01723e-13,-265.844,-74.1028], Tmin=(956.639,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(42.4214,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsOsH) + radical(C=CJO)"""),
)

species(
    label = 'CCC[CH]CC#CO(7722)',
    structure = SMILES('CCC[CH]CC#CO'),
    E0 = (131.233,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2100,2250,500,550,3025,407.5,1350,352.5,3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (111.162,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.820815,0.0746156,-6.32371e-05,3.55865e-08,-9.31858e-12,15894.1,31.9847], Tmin=(100,'K'), Tmax=(869.558,'K')), NASAPolynomial(coeffs=[5.98206,0.0508735,-2.22812e-05,4.18646e-09,-2.90904e-13,14996.6,7.80611], Tmin=(869.558,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(131.233,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CtH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CtCsHH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtOs) + radical(RCCJCC)"""),
)
...
species(
    ...
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.140434,0.0826266,-6.61701e-05,2.94263e-08,-5.49316e-12,16683.8,36.2159], Tmin=(100,'K'), Tmax=(1248.14,'K')), NASAPolynomial(coeffs=[12.9716,0.0415058,-1.67517e-05,3.03062e-09,-2.06156e-13,13480.8,-28.531], Tmin=(1248.14,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(137.547,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(RCCJCC) + radical(C=CJO)"""),
)
...
species(
    label = 'CCC[CH]C[C]=CO(7725)',
    structure = SMILES('CCC[CH]C[C]=CO'),
    E0 = (135.645,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,3615,1277.5,1000,1685,370,2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.381278,0.0887211,-7.53068e-05,3.4327e-08,-6.35045e-12,16478.4,35.4357], Tmin=(100,'K'), Tmax=(1291.2,'K')), NASAPolynomial(coeffs=[16.8369,0.035381,-1.33411e-05,2.33315e-09,-1.55855e-13,12032,-52.0326], Tmin=(1291.2,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(135.645,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(RCCJCC) + radical(Cds_S)"""),
)

species(
    label = 'C[CH]CCCC=[C]O(7726)',
    ...
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0624865,0.0840978,-6.77674e-05,2.98511e-08,-5.43266e-12,16692.2,37.1164], Tmin=(100,'K'), Tmax=(1293.92,'K')), NASAPolynomial(coeffs=[14.6639,0.0385727,-1.49912e-05,2.65901e-09,-1.78814e-13,12881.3,-37.7245], Tmin=(1293.92,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(137.535,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(C=CJO) + radical(RCCJC)"""),
)

species(
    label = 'CCCCC[C]=[C]O(7727)',
    structure = SMILES('CCCCC[C]=[C]O'),
    E0 = (180.931,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,1670,1700,300,440,3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.388153,0.0895772,-7.68056e-05,3.51764e-08,-6.53644e-12,21924.7,36.0247], Tmin=(100,'K'), Tmax=(1284.65,'K')), NASAPolynomial(coeffs=[16.9693,0.0355317,-1.37008e-05,2.42847e-09,-1.63569e-13,17465,-52.0631], Tmin=(1284.65,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(180.931,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(Cds_S) + radical(C=CJO)"""),
)

species(
    label = 'CCC[CH][CH]C=CO(7728)',
    structure = SMILES('CCC[CH]C=C[CH]O'),
    E0 = (5.16415,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.277028,0.0671134,-1.11148e-05,-2.98343e-08,1.50421e-11,767.949,32.9835], Tmin=(100,'K'), Tmax=(1029.4,'K')), NASAPolynomial(coeffs=[16.0268,0.0378373,-1.49727e-05,2.79021e-09,-1.97515e-13,-4166.03,-51.6719], Tmin=(1029.4,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(5.16415,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Allyl_S) + radical(C=CCJO)"""),
)

species(
    label = '[CH2]CCCCC=[C]O(7729)',
    structure = SMILES('[CH2]CCCCC=[C]O'),
    E0 = (148.335,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,1685,370,3615,1277.5,1000,3000,3100,440,815,1455,1000,3010,987.5,1337.5,450,1655,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.617498,0.0891006,-7.36855e-05,3.18567e-08,-5.51269e-12,18017.3,38.1701], Tmin=(100,'K'), Tmax=(1388.75,'K')), NASAPolynomial(coeffs=[19.4103,0.0314143,-1.13775e-05,1.94571e-09,-1.28131e-13,12454.6,-65.0298], Tmin=(1388.75,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(148.335,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(C=CJO) + radical(RCCJ)"""),
)

species(
    label = 'CC[CH][CH]CC=CO(7730)',
    structure = SMILES('CC[CH][CH]CC=CO'),
    E0 = (92.2614,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.150362,0.0817409,-6.45921e-05,2.8501e-08,-5.28326e-12,11237.4,35.6155], Tmin=(100,'K'), Tmax=(1257.03,'K')), NASAPolynomial(coeffs=[12.8464,0.0413405,-1.63826e-05,2.93294e-09,-1.98238e-13,8045.54,-28.5399], Tmin=(1257.03,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(92.2614,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(RCCJCC) + radical(RCCJCC)"""),
)
...
species(
    label = 'C[CH]C[CH]CC=CO(7731)',
    structure = SMILES('C[CH]C[CH]CC=CO'),
    E0 = (92.2494,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0557016,0.0832429,-6.62727e-05,2.90069e-08,-5.24865e-12,11245.9,36.5277], Tmin=(100,'K'), Tmax=(1301.97,'K')), NASAPolynomial(coeffs=[14.5355,0.0384155,-1.46279e-05,2.56287e-09,-1.71035e-13,7446.39,-37.7172], Tmin=(1301.97,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(92.2494,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(RCCJCC) + radical(RCCJC)"""),
)

species(
    label = '[CH2]CC[CH]CC=CO(7732)',
    structure = SMILES('[CH2]CC[CH]CC=CO'),
    E0 = (103.049,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.343625,0.0852637,-6.25607e-05,1.96795e-08,-9.90377e-13,12559.2,36.6122], Tmin=(100,'K'), Tmax=(1059.75,'K')), NASAPolynomial(coeffs=[17.2182,0.0345529,-1.28299e-05,2.26415e-09,-1.53863e-13,7962.3,-53.2593], Tmin=(1059.75,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(103.049,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(RCCJCC) + radical(RCCJ)"""),
)

species(
    label = 'CCCC=CC=CO(7733)',
    structure = SMILES('CCCC=CC=CO'),
    E0 = (-197.323,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.41332,0.0763273,-9.06704e-06,-5.59651e-08,3.09125e-11,-23554.5,30.6573], Tmin=(100,'K'), Tmax=(937.798,'K')), NASAPolynomial(coeffs=[24.5585,0.0219938,-5.62096e-06,9.15626e-10,-6.73289e-14,-30532.7,-100.447], Tmin=(937.798,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-197.323,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsOsH)"""),
)

species(
    label = 'CCC=CCC=CO(7734)',
    structure = SMILES('CCC=CCC=CO'),
    E0 = (-178.714,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.139919,0.0718096,-5.62774e-06,-5.22558e-08,2.76178e-11,-21327.8,32.2598], Tmin=(100,'K'), Tmax=(952.422,'K')), NASAPolynomial(coeffs=[21.9139,0.0262924,-8.12808e-06,1.42295e-09,-1.03e-13,-27665.2,-84.278], Tmin=(952.422,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-178.714,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsOsH)"""),
)
...
species(
    ...
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.297129,0.0838588,-5.37085e-05,5.56181e-09,5.63312e-12,17300.3,36.7238], Tmin=(100,'K'), Tmax=(962.659,'K')), NASAPolynomial(coeffs=[17.8266,0.0325172,-1.10512e-05,1.88111e-09,-1.26942e-13,12700.5,-55.7905], Tmin=(962.659,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(142.477,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(C=CJO) + radical(Isobutyl)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'CCC=CCC=[C]O(7720)'],
    products = ['CCC[CH]CC=[C]O(1357)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', 'CCCC=CC=[C]O(7721)'],
    products = ['CCC[CH]CC=[C]O(1357)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)', 'CCC[CH]CC#CO(7722)'],
    products = ['CCC[CH]CC=[C]O(1357)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['C2H5(29)', 'C=CCC=[C]O(7335)'],
    products = ['CCC[CH]CC=[C]O(1357)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction19',
    reactants = ['CCC[CH]CC=[C]O(1357)'],
    products = ['C[CH]C[CH]CC=CO(7731)'],
    transitionState = 'TS19',
    kinetics = Arrhenius(A=(1.182e+10,'s^-1'), n=0.86, Ea=(149.369,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [RnH;Cd_rad_out_singleNd;Cs_H_out_H/NonDeC] for rate rule [R6HJ_3;Cd_rad_out_singleNd;Cs_H_out_H/NonDeC]
...
reaction(
    label = 'reaction20',
    reactants = ['CCC[CH]CC=[C]O(1357)'],
    products = ['[CH2]CC[CH]CC=CO(7732)'],
    transitionState = 'TS20',
    kinetics = Arrhenius(A=(7.74e+09,'s^-1'), n=1.08, Ea=(161.921,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [RnH;Cd_rad_out_singleNd;Cs_H_out_2H] for rate rule [R7HJ_3;Cd_rad_out_singleNd;Cs_H_out_2H]
Euclidian distance = 2.0
...
reaction(
    label = 'reaction25',
    reactants = ['CH2(S)(23)', 'CC[CH]CC=[C]O(1349)'],
    products = ['CCC[CH]CC=[C]O(1357)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[CH2]C(CC)CC=[C]O(7735)'],
    products = ['CCC[CH]CC=[C]O(1357)'],
...
reaction(
    label = 'reaction29',
    reactants = ['[CH]CCC(133)', '[CH2]C=[C]O(6303)'],
    products = ['CCC[CH]CC=[C]O(1357)'],
