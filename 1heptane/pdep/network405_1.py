species(
    label = 'O=[C]OO[CH]O(861)',
    structure = SMILES('O=[C]OO[CH]O'),
    E0 = (-196.508,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,1855,455,950,3615,1277.5,1000,3025,407.5,1350,352.5],'cm^-1')),
        HinderedRotor(inertia=(1.66501,'amu*angstrom^2'), symmetry=1, barrier=(38.2818,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.66748,'amu*angstrom^2'), symmetry=1, barrier=(38.3387,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.6676,'amu*angstrom^2'), symmetry=1, barrier=(38.3415,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.66756,'amu*angstrom^2'), symmetry=1, barrier=(38.3404,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (90.0349,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.834663,0.0566055,-6.33005e-05,3.1982e-08,-5.99355e-12,-23509.3,23.2403], Tmin=(100,'K'), Tmax=(1470.45,'K')), NASAPolynomial(coeffs=[18.7806,0.000903741,5.43071e-07,-1.46956e-10,1.01811e-14,-28042.8,-67.7274], Tmin=(1470.45,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-196.508,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(166.289,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-O2d)) + group(O2s-CsH) + group(Cs-OsOsHH) + group(Cds-OdOsH) + radical(OCJO) + radical((O)CJOC)"""),
)
...
species(
    label = 'O=[C]OOC=O(8322)',
    structure = SMILES('O=[C]OOC=O'),
    E0 = (-435.877,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2782.5,750,1395,475,1775,1000,1855,455,950],'cm^-1')),
        HinderedRotor(inertia=(1.89374,'amu*angstrom^2'), symmetry=1, barrier=(43.5409,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.89213,'amu*angstrom^2'), symmetry=1, barrier=(43.5039,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (89.0269,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.26636,0.0157922,6.27647e-05,-1.06118e-07,4.47153e-11,-52341,18.9319], Tmin=(100,'K'), Tmax=(945.57,'K')), NASAPolynomial(coeffs=[20.082,-0.00293732,2.63334e-06,-3.79908e-10,1.17877e-14,-58242.1,-79.4093], Tmin=(945.57,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-435.877,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(145.503,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-O2d)) + group(O2s-O2s(Cds-O2d)) + group(Cds-OdOsH) + group(Cds-OdOsH) + radical((O)CJOC)"""),
)

species(
    label = '[O]COO[C]=O(8323)',
    structure = SMILES('[O]COO[C]=O'),
    E0 = (-158.07,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,1855,455,950,2750,2850,1437.5,1250,1305,750,350,180],'cm^-1')),
        HinderedRotor(inertia=(1.88661,'amu*angstrom^2'), symmetry=1, barrier=(43.3769,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.88598,'amu*angstrom^2'), symmetry=1, barrier=(43.3625,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.88656,'amu*angstrom^2'), symmetry=1, barrier=(43.3756,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (90.0349,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.8703,0.0323895,1.00822e-05,-4.47152e-08,2.1059e-11,-18921.8,20.2015], Tmin=(100,'K'), Tmax=(973.244,'K')), NASAPolynomial(coeffs=[17.0145,0.00516054,-1.91528e-06,4.67946e-10,-4.26383e-14,-23527.8,-60.9691], Tmin=(973.244,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-158.07,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(170.447,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-O2d)) + group(O2s-CsH) + group(Cs-OsOsHH) + group(Cds-OdOsH) + radical(OCOJ) + radical((O)CJOC)"""),
)

species(
    label = '[O][CH]OOC=O(8324)',
    structure = SMILES('[O][CH]OOC=O'),
    E0 = (-165.558,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2782.5,750,1395,475,1775,1000,3025,407.5,1350,352.5,499.423],'cm^-1')),
        HinderedRotor(inertia=(0.270828,'amu*angstrom^2'), symmetry=1, barrier=(47.9291,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.271167,'amu*angstrom^2'), symmetry=1, barrier=(47.9279,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.271059,'amu*angstrom^2'), symmetry=1, barrier=(47.9316,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (90.0349,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.44036,0.0361798,-2.53491e-05,7.79926e-09,-9.473e-13,-19858.4,19.311], Tmin=(100,'K'), Tmax=(1847.45,'K')), NASAPolynomial(coeffs=[12.1279,0.0152047,-8.3187e-06,1.65368e-09,-1.15665e-13,-23437.8,-33.3719], Tmin=(1847.45,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-165.558,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(170.447,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-O2d)) + group(O2s-CsH) + group(Cs-OsOsHH) + group(Cds-OdOsH) + radical(OCJO) + radical(OCOJ)"""),
)
...
species(
    label = 'O=COOC=O(8325)',
    structure = SMILES('O=COOC=O'),
    E0 = (-632.326,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (90.0349,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.47354,0.00805342,9.07829e-05,-1.34278e-07,5.40136e-11,-75973,19.5609], Tmin=(100,'K'), Tmax=(951.826,'K')), NASAPolynomial(coeffs=[19.7784,9.96109e-05,1.24677e-06,-7.50782e-11,-1.25605e-14,-82201.2,-78.4829], Tmin=(951.826,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-632.326,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(170.447,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-O2d)) + group(O2s-O2s(Cds-O2d)) + group(Cds-OdOsH) + group(Cds-OdOsH)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'O=[C]OOC=O(8322)'],
    products = ['O=[C]OO[CH]O(861)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction9',
    reactants = ['CO3t2(123)', 'HCOH(T)(285)'],
    products = ['O=[C]OO[CH]O(861)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[C]=O(361)', '[O]O[CH]O(4538)'],
    products = ['O=[C]OO[CH]O(861)'],
