...
species(
    label = '[CH2]C(C)C1=CCC1(22987)',
    structure = SMILES('[CH2]C(C)C1=CCC1'),
    E0 = (256.097,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,2750,2850,2950,3050,3150,900,950,1000,1050,1100,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.23794,0.0427028,4.10518e-05,-8.29572e-08,3.48921e-11,30917.2,26.6639], Tmin=(100,'K'), Tmax=(955.31,'K')), NASAPolynomial(coeffs=[14.8586,0.0304605,-1.00526e-05,1.78399e-09,-1.27633e-13,26271,-49.1222], Tmin=(955.31,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(256.097,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(419.881,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + ring(Cyclobutene) + radical(Isobutyl)"""),
)

species(
    label = 'C=C(C)C1[CH]CC1(22988)',
    structure = SMILES('C=C(C)C1[CH]CC1'),
    E0 = (234.906,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,440,435,1725,2950,3100,1380,975,1025,1650,2750,2830,2910,2990,3070,3150,900,940,980,1020,1060,1100,2750,2800,2850,1350,1500,750,1050,1375,1000,300,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    ...
    molecularWeight = (95.1622,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.50133,0.0386404,4.2271e-05,-7.41435e-08,2.8665e-11,28357,25.9636], Tmin=(100,'K'), Tmax=(1005.56,'K')), NASAPolynomial(coeffs=[11.8485,0.0371177,-1.45838e-05,2.74931e-09,-1.97395e-13,24272.1,-33.9772], Tmin=(1005.56,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(234.906,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(424.038,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + ring(Cyclobutane) + radical(cyclobutane)"""),
)

species(
    label = '[CH2]C(C)C1C=CC1(22989)',
    structure = SMILES('[CH2]C(C)C1C=CC1'),
    E0 = (261.196,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,2950,3050,3150,900,950,1000,1050,1100,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (95.1622,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.34105,0.0391847,5.16949e-05,-9.43341e-08,3.90127e-11,31527.8,26.1407], Tmin=(100,'K'), Tmax=(952.71,'K')), NASAPolynomial(coeffs=[15.0046,0.0300024,-9.71274e-06,1.72352e-09,-1.24225e-13,26737.6,-50.5926], Tmin=(952.71,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(261.196,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(419.881,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cyclobutene) + radical(Isobutyl)"""),
)
...
species(
    ...
    molecularWeight = (96.1702,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.40277,0.0472539,8.86008e-06,-3.01181e-08,1.08989e-11,35907.8,27.4684], Tmin=(100,'K'), Tmax=(1144.74,'K')), NASAPolynomial(coeffs=[8.29357,0.0459157,-1.91836e-05,3.56698e-09,-2.474e-13,32840.3,-13.215], Tmin=(1144.74,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(297.71,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(444.824,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Cyclobutane) + radical(cyclobutane) + radical(Tertalkyl)"""),
)

species(
    label = '[CH2]C(C)C1C[CH]C1(22992)',
...
species(
    ...
    molecularWeight = (96.1702,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.40277,0.0472539,8.86008e-06,-3.01181e-08,1.08989e-11,35907.8,28.1615], Tmin=(100,'K'), Tmax=(1144.74,'K')), NASAPolynomial(coeffs=[8.29357,0.0459157,-1.91836e-05,3.56698e-09,-2.474e-13,32840.3,-12.5219], Tmin=(1144.74,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(297.71,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(444.824,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Cyclobutane) + radical(cyclobutane) + radical(Tertalkyl)"""),
)

species(
    label = 'CC(C)C1[CH]C[CH]1(22995)',
    ...
    molecularWeight = (96.1702,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.50983,0.0402124,3.75556e-05,-6.48316e-08,2.40695e-11,36199,28.2887], Tmin=(100,'K'), Tmax=(1037.53,'K')), NASAPolynomial(coeffs=[9.89672,0.0431069,-1.75602e-05,3.3087e-09,-2.34818e-13,32562.5,-21.6199], Tmin=(1037.53,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(300.126,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(444.824,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Cyclobutane) + radical(cyclobutane) + radical(cyclobutane)"""),
)

species(
    label = '[CH2]C([CH2])C1CCC1(22996)',
    structure = SMILES('[CH2]C([CH2])C1CCC1'),
    E0 = (334.614,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2816.67,2883.33,2950,3016.67,3083.33,3150,900,933.333,966.667,1000,1033.33,1066.67,1100,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,1380,1390,370,380,2900,435,180,1102.8,1102.8,1102.8,1102.8,1102.8,1102.8,1102.8,1102.8,1102.8,1102.8,1102.8,1102.8,1102.8,1102.8,2232.96],'cm^-1')),
        HinderedRotor(inertia=(0.0719673,'amu*angstrom^2'), symmetry=1, barrier=(1.65467,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0719673,'amu*angstrom^2'), symmetry=1, barrier=(1.65467,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0719673,'amu*angstrom^2'), symmetry=1, barrier=(1.65467,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    ...
    molecularWeight = (96.1702,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.24128,0.0421772,4.95931e-05,-9.28209e-08,3.87362e-11,40360.9,28.1173], Tmin=(100,'K'), Tmax=(944.021,'K')), NASAPolynomial(coeffs=[14.211,0.0336573,-1.06526e-05,1.83034e-09,-1.28645e-13,35843.1,-44.6659], Tmin=(944.021,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(334.614,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(444.824,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Cyclobutane) + radical(Isobutyl) + radical(Isobutyl)"""),
)

species(
    label = 'CC(C)C1[CH][CH]C1(22997)',
...
species(
    label = '[CH2]CC=CC([CH2])C(22998)',
    structure = SMILES('[CH2]CC=CC([CH2])C'),
    E0 = (303.384,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2995,3025,975,1000,1300,1375,400,500,1630,1680,1380,1390,370,380,2900,435,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,2750,2800,2850,1350,1500,750,1050,1375,1000,958.457,3423.65],'cm^-1')),
        HinderedRotor(inertia=(0.735204,'amu*angstrom^2'), symmetry=1, barrier=(16.9038,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.735225,'amu*angstrom^2'), symmetry=1, barrier=(16.9043,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.244259,'amu*angstrom^2'), symmetry=1, barrier=(5.616,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.244274,'amu*angstrom^2'), symmetry=1, barrier=(5.61634,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.1284,'amu*angstrom^2'), symmetry=1, barrier=(83.5987,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (96.1702,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.648657,0.0636256,-2.25583e-05,-1.11141e-08,7.77771e-12,36618,32.3933], Tmin=(100,'K'), Tmax=(1029.07,'K')), NASAPolynomial(coeffs=[12.5408,0.0376206,-1.41255e-05,2.51647e-09,-1.72272e-13,33099.8,-30.5219], Tmin=(1029.07,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(303.384,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Isobutyl) + radical(RCCJ)"""),
)

species(
    label = 'CC(C)C1=CCC1(22999)',
    ...
    molecularWeight = (96.1702,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.212,0.0411075,5.32468e-05,-9.50457e-08,3.83096e-11,6254.16,24.2825], Tmin=(100,'K'), Tmax=(973.652,'K')), NASAPolynomial(coeffs=[15.1334,0.0337247,-1.2116e-05,2.25081e-09,-1.63783e-13,1182.26,-54.633], Tmin=(973.652,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(51.0149,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(444.824,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + ring(Cyclobutene)"""),
)

species(
    label = 'C=C(C)C1CCC1(23000)',
    ...
    molecularWeight = (96.1702,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.33946,0.03804,6.04774e-05,-1.00275e-07,3.94638e-11,5775.02,24.196], Tmin=(100,'K'), Tmax=(979.958,'K')), NASAPolynomial(coeffs=[14.3311,0.0355752,-1.31479e-05,2.46652e-09,-1.79611e-13,800.856,-50.606], Tmin=(979.958,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(47.0679,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(448.981,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + ring(Cyclobutane)"""),
)

species(
    label = 'CC(C)C1C=CC1(23001)',
    ...
    molecularWeight = (96.1702,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.3159,0.0375818,6.39074e-05,-1.06428e-07,4.24238e-11,6864.79,23.7563], Tmin=(100,'K'), Tmax=(969.926,'K')), NASAPolynomial(coeffs=[15.2673,0.0332866,-1.17875e-05,2.19297e-09,-1.60592e-13,1654.08,-56.0352], Tmin=(969.926,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(56.1134,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(444.824,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cyclobutene)"""),
)
...
species(
    label = '[CH2]C(C)[CH]C1CC1(23002)',
    structure = SMILES('[CH2]C(C)[CH]C1CC1'),
    E0 = (331.84,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2850,2950,3050,3150,900,950,1000,1050,1100,3000,3100,440,815,1455,1000,1380,1390,370,380,2900,435,804.188,804.188,804.188,804.188,804.188,804.188,804.188,804.188,804.188,916.988,3158.42,3158.42],'cm^-1')),
...
species(
    ...
    E0 = (329.992,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,1380,1390,370,380,2900,435,300,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(C)C1[CH]CC1(19132)'],
    products = ['C3H6(72)', 'C1=CCC1(2460)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', '[CH2]C(C)C1=CCC1(22987)'],
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'C=C(C)C1[CH]CC1(22988)'],
    products = ['[CH2]C(C)C1[CH]CC1(19132)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', '[CH2]C(C)C1C=CC1(22989)'],
    products = ['[CH2]C(C)C1[CH]CC1(19132)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['C3H6(T)(143)', 'C1=CCC1(2460)'],
    products = ['[CH2]C(C)C1[CH]CC1(19132)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['C3H6(72)', '[CH]1[CH]CC1(20477)'],
    products = ['[CH2]C(C)C1[CH]CC1(19132)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['CH3(17)', 'C=CC1[CH]CC1(22318)'],
    products = ['[CH2]C(C)C1[CH]CC1(19132)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]C(C)C1[CH]CC1(19132)'],
    products = ['[CH2]C(C)[C]1CCC1(22990)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]C(C)C1[CH]CC1(19132)'],
    products = ['C[C](C)C1[CH]CC1(22991)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]C(C)C1C[CH]C1(22992)'],
    products = ['[CH2]C(C)C1[CH]CC1(19132)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]C(C)C1[CH]CC1(19132)'],
    products = ['CC(C)[C]1[CH]CC1(22994)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2]C(C)C1[CH]CC1(19132)'],
    products = ['CC(C)C1[CH]C[CH]1(22995)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]C([CH2])C1CCC1(22996)'],
    products = ['[CH2]C(C)C1[CH]CC1(19132)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]C(C)C1[CH]CC1(19132)'],
    products = ['CC(C)C1[CH][CH]C1(22997)'],
...
reaction(
    label = 'reaction16',
    reactants = ['C3H6(T)(143)', '[CH]1[CH]CC1(20477)'],
    products = ['[CH2]C(C)C1[CH]CC1(19132)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2]CC=CC([CH2])C(22998)'],
    products = ['[CH2]C(C)C1[CH]CC1(19132)'],
...
reaction(
    label = 'reaction22',
    reactants = ['CH2(S)(23)', '[CH2]CC1[CH]CC1(19003)'],
    products = ['[CH2]C(C)C1[CH]CC1(19132)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH2]C(C)[CH]C1CC1(23002)'],
    products = ['[CH2]C(C)C1[CH]CC1(19132)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[CH2]C(C)C1[CH]CC1(19132)'],
    products = ['C[CH]CC1[CH]CC1(19170)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[CH2]C(C)C1[CH]CC1(19132)'],
    products = ['CC[CH]C1[CH]CC1(23003)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[CH2]C(C)C1CC1[CH2](19121)'],
    products = ['[CH2]C(C)C1[CH]CC1(19132)'],
...
reaction(
    label = 'reaction28',
    reactants = ['CH2(19)', 'C[CH]C1[CH]CC1(22321)'],
    products = ['[CH2]C(C)C1[CH]CC1(19132)'],
...
network(
    label = '4021',
    isomers = [
        '[CH2]C(C)C1[CH]CC1(19132)',
    ],
    reactants = [
        ('C3H6(72)', 'C1=CCC1(2460)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
