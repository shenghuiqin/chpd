...
species(
    label = 'O=[C]OC1=CCC1(23860)',
    structure = SMILES('O=[C]OC1=CCC1'),
    E0 = (-1.19858,'kJ/mol'),
    modes = [
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.51517,0.0422124,-1.18048e-06,-3.10742e-08,1.51468e-11,-43.6998,20.8128], Tmin=(100,'K'), Tmax=(1000.66,'K')), NASAPolynomial(coeffs=[14.8863,0.0174036,-6.92373e-06,1.35437e-09,-1.00766e-13,-4153.62,-50.8689], Tmin=(1000.66,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1.19858,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-Cd)) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + group(Cds-OdOsH) + ring(Cyclobutene) + radical((O)CJOC)"""),
)

species(
    label = 'O=[C]OC1C=CC1(23861)',
    structure = SMILES('O=[C]OC1C=CC1'),
    E0 = (15.8628,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,2950,3050,3150,900,950,1000,1050,1100,1855,455,950,300,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (97.092,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.86847,0.0301932,3.43084e-05,-6.99771e-08,2.95944e-11,1999.64,22.6192], Tmin=(100,'K'), Tmax=(968.192,'K')), NASAPolynomial(coeffs=[15.6926,0.0142874,-4.89087e-06,9.73751e-10,-7.69271e-14,-2608.61,-53.6014], Tmin=(968.192,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(15.8628,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-OdOsH) + ring(Cyclobutene) + radical((O)CJOCC2)"""),
)
...
species(
    ...
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.5717,0.0425099,-3.32113e-06,-2.65341e-08,1.3164e-11,10359,24.2816], Tmin=(100,'K'), Tmax=(998.225,'K')), NASAPolynomial(coeffs=[13.2437,0.0206312,-7.84945e-06,1.47093e-09,-1.06031e-13,6788.52,-38.2201], Tmin=(998.225,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(85.3223,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cds-OdOsH) + ring(Cyclobutane) + radical((O)CJOCC2) + radical(C2CsJOC(O)H)"""),
)

species(
    label = 'O=[C]OC1C[CH]C1(23863)',
    structure = SMILES('O=[C]OC1C[CH]C1'),
    E0 = (73.443,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.85724,0.0350993,1.54385e-05,-4.18407e-08,1.72661e-11,8920.8,24.6642], Tmin=(100,'K'), Tmax=(1018.9,'K')), NASAPolynomial(coeffs=[11.8629,0.0240491,-9.85322e-06,1.89986e-09,-1.38046e-13,5416.46,-30.9857], Tmin=(1018.9,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(73.443,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cds-OdOsH) + ring(Cyclobutane) + radical(cyclobutane) + radical((O)CJOCC2)"""),
)

species(
    label = 'O=CO[C]1[CH]CC1(23864)',
    structure = SMILES('O=CO[C]1[CH]CC1'),
    E0 = (89.9755,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.06767,0.0276065,3.86287e-05,-6.70286e-08,2.64122e-11,10904.3,26.306], Tmin=(100,'K'), Tmax=(995.147,'K')), NASAPolynomial(coeffs=[12.3666,0.0227176,-9.0312e-06,1.76441e-09,-1.31048e-13,7046.79,-32.4131], Tmin=(995.147,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(89.9755,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cds-OdOsH) + ring(Cyclobutane) + radical(CCJCO) + radical(C2CsJOC(O)H)"""),
)

species(
    label = 'O=COC1[CH]C[CH]1(23865)',
    structure = SMILES('O=COC1[CH]C[CH]1'),
    E0 = (90.1598,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.38032,0.0144637,8.38469e-05,-1.17328e-07,4.48198e-11,10921,26.045], Tmin=(100,'K'), Tmax=(974.346,'K')), NASAPolynomial(coeffs=[13.9343,0.0204588,-7.63427e-06,1.54309e-09,-1.20529e-13,6133.42,-42.4103], Tmin=(974.346,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(90.1598,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cds-OdOsH) + ring(Cyclobutane) + radical(CCJCO) + radical(CCJCO)"""),
)

species(
    label = 'O=COC1[CH][CH]C1(23866)',
    structure = SMILES('O=COC1[CH][CH]C1'),
    E0 = (78.0961,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.35736,0.0201485,5.75443e-05,-8.25205e-08,3.05845e-11,9465.97,25.9804], Tmin=(100,'K'), Tmax=(1009.14,'K')), NASAPolynomial(coeffs=[10.9561,0.026185,-1.1063e-05,2.19988e-09,-1.63599e-13,5687.69,-25.7032], Tmin=(1009.14,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(78.0961,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cds-OdOsH) + ring(Cyclobutane) + radical(CCJCO) + radical(cyclobutane)"""),
)
...
species(
    label = '[CH2]CC=CO[C]=O(23867)',
    structure = SMILES('[CH2]CC=CO[C]=O'),
    E0 = (48.8244,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,1855,455,950,2995,3025,975,1000,1300,1375,400,500,1630,1680,3000,3100,440,815,1455,1000,256.84,256.842,256.843],'cm^-1')),
        HinderedRotor(inertia=(0.0459724,'amu*angstrom^2'), symmetry=1, barrier=(19.5239,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.417066,'amu*angstrom^2'), symmetry=1, barrier=(19.5239,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.599071,'amu*angstrom^2'), symmetry=1, barrier=(28.0435,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.417066,'amu*angstrom^2'), symmetry=1, barrier=(19.5239,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.583561,0.0657868,-6.04511e-05,2.76772e-08,-4.96717e-12,6003.07,26.5295], Tmin=(100,'K'), Tmax=(1356.33,'K')), NASAPolynomial(coeffs=[17.13,0.0169892,-6.48477e-06,1.15161e-09,-7.79587e-14,1514.56,-58.3408], Tmin=(1356.33,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(48.8244,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-Cd)) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-OdOsH) + radical(RCCJ) + radical((O)CJOC)"""),
)

species(
    label = 'O=COC1=CCC1(23692)',
    structure = SMILES('O=COC1=CCC1'),
    E0 = (-197.647,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.72702,0.0344114,2.70934e-05,-5.96289e-08,2.46454e-11,-23675.8,21.4255], Tmin=(100,'K'), Tmax=(998.603,'K')), NASAPolynomial(coeffs=[14.5939,0.0204232,-8.30108e-06,1.65715e-09,-1.24952e-13,-28118,-50.0067], Tmin=(998.603,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-197.647,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-Cd)) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + group(Cds-OdOsH) + ring(Cyclobutene)"""),
)

species(
    label = 'O=COC1C=CC1(23691)',
    structure = SMILES('O=COC1C=CC1'),
    E0 = (-179.386,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.16594,0.020543,6.75355e-05,-1.0093e-07,3.90131e-11,-21491.4,22.1667], Tmin=(100,'K'), Tmax=(982.796,'K')), NASAPolynomial(coeffs=[14.3505,0.0205037,-8.03371e-06,1.63358e-09,-1.26589e-13,-26279.5,-48.5801], Tmin=(982.796,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-179.386,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-OdOsH) + ring(Cyclobutene)"""),
)

species(
    label = 'O=[C]O[CH]C1CC1(23868)',
    structure = SMILES('O=[C]O[CH]C1CC1'),
    E0 = (90.7367,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,2950,3050,3150,900,950,1000,1050,1100,1855,455,950,3025,407.5,1350,352.5,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.12056,0.0486914,-3.80676e-06,-3.92214e-08,2.10368e-11,11030.1,24.8082], Tmin=(100,'K'), Tmax=(948.697,'K')), NASAPolynomial(coeffs=[18.3769,0.0121233,-3.20865e-06,5.68045e-10,-4.44795e-14,6127.33,-66.1181], Tmin=(948.697,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(90.7367,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cds-OdOsH) + ring(Cyclopropane) + radical(CCsJOC(O)H) + radical((O)CJOCC)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['O=[C]OC1[CH]CC1(21070)'],
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'O=[C]OC1=CCC1(23860)'],
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'O=[C]OC1C=CC1(23861)'],
    products = ['O=[C]OC1[CH]CC1(21070)'],
    transitionState = 'TS3',
...
reaction(
    ...
    products = ['O=[C]OC1[CH]CC1(21070)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(46.7986,'m^3/(mol*s)'), n=2.021, Ea=(99.088,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Od_R;YJ] for rate rule [Od_Cdd-O2d;CJ]
Euclidian distance = 2.2360679775
Multiplied by reaction path degeneracy 4.0
family: R_Addition_MultipleBond
Ea raised from 95.3 to 99.1 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction5',
    reactants = ['O=[C]O[C]1CCC1(23862)'],
    products = ['O=[C]OC1[CH]CC1(21070)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['O=[C]OC1[CH]CC1(21070)'],
    products = ['O=CO[C]1[CH]CC1(23864)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['O=[C]OC1[CH]CC1(21070)'],
    products = ['O=COC1[CH]C[CH]1(23865)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['O=[C]OC1[CH]CC1(21070)'],
    products = ['O=COC1[CH][CH]C1(23866)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction15',
    reactants = ['O=[C]O[CH]C1CC1(23868)'],
    products = ['O=[C]OC1[CH]CC1(21070)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]C1CC1O[C]=O(21061)'],
    products = ['O=[C]OC1[CH]CC1(21070)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CO(12)', '[O]C1[CH]CC1(23382)'],
    products = ['O=[C]OC1[CH]CC1(21070)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[C]=O(361)', '[O]C1[CH]CC1(23382)'],
    products = ['O=[C]OC1[CH]CC1(21070)'],
