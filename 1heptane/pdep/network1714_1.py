species(
    label = '[CH2]OC[CH]OO(8768)',
    structure = SMILES('[CH2]OC[CH]OO'),
    E0 = (52.2064,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3615,1310,387.5,850,1000,3000,3100,440,815,1455,1000,3025,407.5,1350,352.5,200,800,1600],'cm^-1')),
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.19466,0.0668336,-9.45899e-05,7.88205e-08,-2.67357e-11,6375.08,24.5301], Tmin=(100,'K'), Tmax=(805.383,'K')), NASAPolynomial(coeffs=[7.48373,0.0295347,-1.38283e-05,2.62069e-09,-1.8061e-13,5558.71,-3.22895], Tmin=(805.383,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(52.2064,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(261.906,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-OsHHH) + radical(CsJOCC) + radical(CCsJOOH)"""),
)
...
species(
    label = '[CH2]OC=COO(10542)',
    structure = SMILES('[CH2]OC=COO'),
    E0 = (-40.2495,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,3000,3100,440,815,1455,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,260.147,260.169],'cm^-1')),
        HinderedRotor(inertia=(0.443954,'amu*angstrom^2'), symmetry=1, barrier=(21.2902,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.439431,'amu*angstrom^2'), symmetry=1, barrier=(21.2895,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.440483,'amu*angstrom^2'), symmetry=1, barrier=(21.297,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.44112,'amu*angstrom^2'), symmetry=1, barrier=(21.2914,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (89.07,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.11589,0.0500711,-1.838e-05,-2.67592e-08,1.80448e-11,-4724.68,23.5931], Tmin=(100,'K'), Tmax=(926.276,'K')), NASAPolynomial(coeffs=[19.8215,0.0038218,6.00943e-07,-1.7694e-10,8.7329e-15,-9671.23,-73.2137], Tmin=(926.276,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-40.2495,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-OsHHH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + radical(C=COCJ)"""),
)
...
species(
    label = '[CH2]O[CH]COO(10543)',
    structure = SMILES('[CH2]O[CH]COO'),
    E0 = (44.0799,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (90.0779,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.946168,0.0703541,-9.37637e-05,6.75094e-08,-1.94411e-11,5408.66,24.7239], Tmin=(100,'K'), Tmax=(849.595,'K')), NASAPolynomial(coeffs=[11.0074,0.0229836,-1.01273e-05,1.87962e-09,-1.28677e-13,3699.11,-22.1755], Tmin=(849.595,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(44.0799,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(261.906,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-OsHHH) + radical(CsJOCC) + radical(CCsJOCs)"""),
)

species(
    label = 'CO[CH][CH]OO(10544)',
    structure = SMILES('CO[CH][CH]OO'),
    E0 = (44.8909,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (90.0779,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.815713,0.0773089,-0.000122911,1.07222e-07,-3.66651e-11,5506.8,23.6449], Tmin=(100,'K'), Tmax=(842.577,'K')), NASAPolynomial(coeffs=[8.20853,0.0291623,-1.39649e-05,2.63906e-09,-1.80151e-13,4724.25,-8.00583], Tmin=(842.577,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(44.8909,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(261.906,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-OsHHH) + radical(CCsJOOH) + radical(CCsJOCs)"""),
)

species(
    label = '[CH2]OCCO[O](10545)',
    structure = SMILES('[CH2]OCCO[O]'),
    E0 = (15.6286,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,492.5,1135,1000,3000,3100,440,815,1455,1000,198.765,1249.87,1249.88],'cm^-1')),
        HinderedRotor(inertia=(0.245223,'amu*angstrom^2'), symmetry=1, barrier=(6.8754,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.245279,'amu*angstrom^2'), symmetry=1, barrier=(6.8754,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.245183,'amu*angstrom^2'), symmetry=1, barrier=(6.87542,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.245254,'amu*angstrom^2'), symmetry=1, barrier=(6.87546,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (90.0779,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.45437,0.060511,-8.24742e-05,6.80532e-08,-2.28583e-11,1967.01,24.2072], Tmin=(100,'K'), Tmax=(831.168,'K')), NASAPolynomial(coeffs=[6.67541,0.0286333,-1.27606e-05,2.3641e-09,-1.60731e-13,1332.31,1.38711], Tmin=(831.168,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(15.6286,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-OsHHH) + radical(CsJOCC) + radical(ROOJ)"""),
)

species(
    label = 'COC[CH]O[O](10546)',
    structure = SMILES('COC[CH]O[O]'),
    E0 = (16.4396,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (90.0779,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.38792,0.0666363,-0.000108336,1.02874e-07,-3.76715e-11,2062.43,22.9032], Tmin=(100,'K'), Tmax=(853.645,'K')), NASAPolynomial(coeffs=[3.74745,0.0350441,-1.67374e-05,3.15736e-09,-2.15069e-13,2407.83,16.2759], Tmin=(853.645,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(16.4396,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-OsHHH) + radical(CCsJOOH) + radical(ROOJ)"""),
)
...
species(
    label = 'COC=COO(10547)',
    structure = SMILES('COC=COO'),
    E0 = (-232.257,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (90.0779,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.998814,0.0521792,-1.67519e-05,-2.9386e-08,1.89578e-11,-27813.2,21.5277], Tmin=(100,'K'), Tmax=(929.226,'K')), NASAPolynomial(coeffs=[19.8201,0.00662928,-4.79342e-07,1.74738e-11,-4.61042e-15,-32842.4,-76.1323], Tmin=(929.226,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-232.257,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-OsHHH) + group(Cds-CdsOsH) + group(Cds-CdsOsH)"""),
)
...
species(
    ...
    molecularWeight = (90.0779,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.59789,0.0588629,-8.44614e-05,7.58675e-08,-2.76002e-11,-21857.8,26.1897], Tmin=(100,'K'), Tmax=(814.707,'K')), NASAPolynomial(coeffs=[4.83524,0.0321259,-1.52719e-05,2.91531e-09,-2.01561e-13,-22025.5,13.4431], Tmin=(814.707,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-182.407,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-OsHHH) + radical(CsJOCC) + radical(CCOJ)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', '[CH2]OC=COO(10542)'],
    products = ['[CH2]OC[CH]OO(8768)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]O[CH2](103)', '[CH]OO(168)'],
    products = ['[CH2]OC[CH]OO(8768)'],
