...
species(
    ...
    molecularWeight = (112.213,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.52536,0.0796429,-4.15263e-05,1.0164e-08,-9.96152e-13,17826.3,36.0388], Tmin=(100,'K'), Tmax=(2190.74,'K')), NASAPolynomial(coeffs=[18.5806,0.0466761,-1.89537e-05,3.29485e-09,-2.12259e-13,9915.51,-65.2269], Tmin=(2190.74,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(147.216,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(552.912,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Cs_S) + radical(RCCJC)"""),
)

species(
    label = 'C[CH][CH]C(C)CCC(642)',
...
species(
    ...
    molecularWeight = (112.213,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.152329,0.0902483,-7.00314e-05,3.65332e-08,-9.14836e-12,18022.1,34.3573], Tmin=(100,'K'), Tmax=(888.974,'K')), NASAPolynomial(coeffs=[5.63449,0.0655796,-2.8405e-05,5.31477e-09,-3.68582e-13,17047.5,8.5545], Tmin=(888.974,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(148.733,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(552.912,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Isobutyl) + radical(Tertalkyl)"""),
)

species(
    label = 'C[CH]CC(C)C[CH]C(644)',
    ...
    molecularWeight = (112.213,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.867032,0.0776075,-3.93727e-05,9.53104e-09,-9.47463e-13,17797.1,34.2627], Tmin=(100,'K'), Tmax=(2018.53,'K')), NASAPolynomial(coeffs=[12.239,0.0550724,-2.26266e-05,4.00024e-09,-2.62462e-13,13206.1,-28.5879], Tmin=(2018.53,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(147.12,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(552.912,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJC) + radical(RCCJC)"""),
)

species(
    label = '[CH2]CCC(C)C[CH]C(645)',
...
species(
    ...
    molecularWeight = (112.213,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.279862,0.0814576,-3.30945e-05,-4.56557e-09,4.89987e-12,-15694.6,33.7454], Tmin=(100,'K'), Tmax=(1157.89,'K')), NASAPolynomial(coeffs=[14.6537,0.050769,-2.04143e-05,3.72274e-09,-2.55492e-13,-20553.9,-46.5399], Tmin=(1157.89,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-131.86,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(557.07,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH)"""),
)

species(
    label = 'C=CCC(C)CCC(649)',
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'C=C(C[CH]C)CCC(637)'],
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', '[CH2]C(C=CC)CCC(638)'],
    products = ['[CH2]C(C[CH]C)CCC(515)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', '[CH2]C(CC=C)CCC(639)'],
    products = ['[CH2]C(C[CH]C)CCC(515)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['C=CC[CH]C(380)', 'npropyl(83)'],
    products = ['[CH2]C(C[CH]C)CCC(515)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]CCC(C)C[CH]C(645)'],
    products = ['[CH2]C(C[CH]C)CCC(515)'],
...
reaction(
    label = 'reaction27',
    reactants = ['[CH2]C([CH2])CCC(453)', 'CHCH3(T)(95)'],
    products = ['[CH2]C(C[CH]C)CCC(515)'],
