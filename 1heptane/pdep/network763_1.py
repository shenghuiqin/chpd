...
species(
    label = 'CCO[C](C)[O](2470)',
    structure = SMILES('CCO[C](C)[O]'),
    E0 = (-42.6524,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,360,370,350,227.277,231.959,1314.15,1315.21],'cm^-1')),
        HinderedRotor(inertia=(0.0031073,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.160361,'amu*angstrom^2'), symmetry=1, barrier=(6.0555,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.164326,'amu*angstrom^2'), symmetry=1, barrier=(6.06483,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.153596,'amu*angstrom^2'), symmetry=1, barrier=(6.05984,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (88.1051,'amu'),
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'C[CH]OC(C)=O(2467)'],
    products = ['C[CH]OC(C)[O](1179)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['C[CH][O](176)', 'CH3CHO(37)'],
    products = ['C[CH]OC(C)[O](1179)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CH3(17)', 'C[CH]OC=O(2205)'],
    products = ['C[CH]OC(C)[O](1179)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction12',
    reactants = ['C[CH][O](176)', 'C[CH][O](176)'],
    products = ['C[CH]OC(C)[O](1179)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CHCH3(T)(95)', 'CC([O])[O](2201)'],
    products = ['C[CH]OC(C)[O](1179)'],
...
reaction(
    label = 'reaction18',
    reactants = ['O(4)', 'C[CH]O[CH]C(1657)'],
    products = ['C[CH]OC(C)[O](1179)'],
