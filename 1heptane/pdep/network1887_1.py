...
species(
    label = '[CH2]C1CC1=O(12301)',
    structure = SMILES('[CH2]C1CC1=O'),
    E0 = (182.768,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (69.0819,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.12251,0.0358516,-1.80012e-05,-2.73009e-09,3.92007e-12,22054.3,15.7348], Tmin=(100,'K'), Tmax=(987.087,'K')), NASAPolynomial(coeffs=[9.88662,0.0160913,-5.75648e-06,1.01064e-09,-6.92974e-14,19951.4,-24.5095], Tmin=(987.087,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(182.768,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)CsCsH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsCs) + ring(cyclopropanone) + radical(CJC(C)C=O)"""),
)
...
species(
    label = 'C=[C]CC=O(12302)',
    structure = SMILES('C=[C]CC=O'),
    E0 = (144.703,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,1685,370,2782.5,750,1395,475,1775,1000,2950,3100,1380,975,1025,1650,840.092],'cm^-1')),
        HinderedRotor(inertia=(0.709386,'amu*angstrom^2'), symmetry=1, barrier=(16.3102,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0647867,'amu*angstrom^2'), symmetry=1, barrier=(16.307,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (69.0819,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.56931,0.0252416,3.86061e-06,-1.67088e-08,6.00601e-12,17460.3,17.29], Tmin=(100,'K'), Tmax=(1209.1,'K')), NASAPolynomial(coeffs=[8.862,0.0205063,-1.02165e-05,2.05384e-09,-1.48051e-13,14763,-19.1248], Tmin=(1209.1,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(144.703,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(Cds-CdsCsH) + group(Cds-OdCsH) + group(Cds-CdsHH) + radical(Cds_S)"""),
)
...
species(
    ...
    E0 = (194.756,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1855,455,950,2995,3025,975,1000,1300,1375,400,500,1630,1680,3000,3100,440,815,1455,1000],'cm^-1')),
        HinderedRotor(inertia=(1.05214,'amu*angstrom^2'), symmetry=1, barrier=(24.1907,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.05255,'amu*angstrom^2'), symmetry=1, barrier=(24.2001,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (68.074,'amu'),
...
species(
    label = 'O=C1C[CH]C1(12303)',
    structure = SMILES('O=C1C[CH]C1'),
    E0 = (83.9726,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (69.0819,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.2487,0.00372518,6.63531e-05,-8.31601e-08,3.03673e-11,10138.1,15.9582], Tmin=(100,'K'), Tmax=(975.719,'K')), NASAPolynomial(coeffs=[7.59864,0.0186518,-6.95596e-06,1.33903e-09,-9.97978e-14,7729.82,-12.9118], Tmin=(975.719,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(83.9726,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(232.805,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cds-OdCsCs) + ring(Cyclobutanone) + radical(CCJCC=O)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['CO(12)', 'CH2CHCH2(74)'],
    products = ['C=CC[C]=O(2390)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(2461.18,'m^3/(mol*s)'), n=1.0523, Ea=(29.1133,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [COm;C_pri_rad] for rate rule [COm;C_rad/H2/Cd]
Euclidian distance = 1.0
Multiplied by reaction path degeneracy 2.0
family: R_Addition_COm
Ea raised from 25.6 to 29.1 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction2',
    reactants = ['C=CC[C]=O(2390)'],
    products = ['[CH2]C1CC1=O(12301)'],
    transitionState = 'TS2',
