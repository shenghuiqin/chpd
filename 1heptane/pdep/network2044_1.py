...
species(
    label = 'C=C(CCC)C([O])CC(10765)',
    structure = SMILES('C=C(CCC)C([O])CC'),
    E0 = (-68.2287,'kJ/mol'),
    modes = [
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.0074,0.0961054,-5.92162e-05,1.33041e-08,4.53987e-13,-8014.1,39.2967], Tmin=(100,'K'), Tmax=(1177.02,'K')), NASAPolynomial(coeffs=[19.1487,0.0458482,-1.84155e-05,3.36182e-09,-2.31043e-13,-14022.5,-66.5975], Tmin=(1177.02,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-68.2287,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(557.07,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(CC(C)OJ)"""),
)

species(
    label = '[CH2]C(CCC)C(=O)CC(10766)',
    structure = SMILES('[CH2]C(CCC)C(=O)CC'),
    E0 = (-150.201,'kJ/mol'),
    modes = [
...
species(
    label = 'CCC[C](C)C([O])CC(10767)',
    structure = SMILES('CCC[C](C)C([O])CC'),
    E0 = (-31.3079,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.212,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.19953,0.0989856,-6.44623e-05,2.11707e-08,-2.81625e-12,-3565.39,39.3685], Tmin=(100,'K'), Tmax=(1736.99,'K')), NASAPolynomial(coeffs=[22.696,0.0439579,-1.69422e-05,2.93217e-09,-1.91223e-13,-11866.6,-89.1077], Tmin=(1736.99,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-31.3079,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(577.856,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJ(C)CO) + radical(CC(C)OJ)"""),
)

species(
    label = '[CH2]C(CCC)[C](O)CC(10768)',
    structure = SMILES('[CH2]C(CCC)[C](O)CC'),
    E0 = (-32.5324,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
species(
    label = 'CCCC(C)[C]([O])CC(10769)',
    structure = SMILES('CCCC(C)[C]([O])CC'),
    E0 = (-7.25394,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.212,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.686204,0.103953,-7.93088e-05,3.33214e-08,-5.98283e-12,-704.796,36.7102], Tmin=(100,'K'), Tmax=(1268.04,'K')), NASAPolynomial(coeffs=[13.9649,0.0577359,-2.46366e-05,4.57749e-09,-3.15766e-13,-4420.41,-37.4522], Tmin=(1268.04,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-7.25394,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(577.856,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(C2CsJOH)"""),
)

species(
    label = 'CC[CH]C(C)C([O])CC(10770)',
    structure = SMILES('CC[CH]C(C)C([O])CC'),
    E0 = (10.6604,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.212,'amu'),
...
species(
    label = '[CH2]C(CCC)C(O)[CH]C(10772)',
    structure = SMILES('[CH2]C(CCC)C(O)[CH]C'),
    E0 = (-9.25816,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (128.212,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.12597,0.103149,-7.75856e-05,3.15387e-08,-5.29084e-12,-921.162,43.3417], Tmin=(100,'K'), Tmax=(1395.57,'K')), NASAPolynomial(coeffs=[18.1405,0.0479276,-1.82325e-05,3.18584e-09,-2.11792e-13,-6298.74,-56.0295], Tmin=(1395.57,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-9.25816,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(573.699,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Isobutyl) + radical(CCJCO)"""),
)

species(
    label = '[CH2]C([CH]CC)C(O)CC(10773)',
    structure = SMILES('[CH2]C([CH]CC)C(O)CC'),
    E0 = (-14.6181,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3615,1277.5,1000,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3100,440,815,1455,1000,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'C[CH]C([O])C(C)CCC(10774)',
    structure = SMILES('C[CH]C([O])C(C)CCC'),
    E0 = (16.0203,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.212,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.29689,0.100757,-6.87773e-05,2.40068e-08,-3.39652e-12,2130.64,42.0121], Tmin=(100,'K'), Tmax=(1647.37,'K')), NASAPolynomial(coeffs=[22.3377,0.0433695,-1.6523e-05,2.86011e-09,-1.8735e-13,-5656.29,-83.8087], Tmin=(1647.37,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(16.0203,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(577.856,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJCO) + radical(CC(C)OJ)"""),
)

species(
    label = 'C[CH]CC(C)C([O])CC(10775)',
    structure = SMILES('C[CH]CC(C)C([O])CC'),
    E0 = (10.5645,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.212,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.382055,0.0960715,-6.41534e-05,2.29255e-08,-3.50761e-12,1427.88,38.9228], Tmin=(100,'K'), Tmax=(1444.58,'K')), NASAPolynomial(coeffs=[13.5953,0.0573681,-2.39646e-05,4.37826e-09,-2.97778e-13,-2610.34,-33.6509], Tmin=(1444.58,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(10.5645,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(577.856,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJC) + radical(CC(C)OJ)"""),
)

species(
    label = '[CH2]CC(O)C([CH2])CCC(10776)',
    structure = SMILES('[CH2]CC(O)C([CH2])CCC'),
    E0 = (-3.91385,'kJ/mol'),
    modes = [
...
species(
    label = '[CH2]C(C[CH]C)C(O)CC(10777)',
    structure = SMILES('[CH2]C(C[CH]C)C(O)CC'),
    E0 = (-14.7139,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.212,'amu'),
...
species(
    label = '[CH2]CC([O])C(C)CCC(10778)',
    structure = SMILES('[CH2]CC([O])C(C)CCC'),
    E0 = (21.3646,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,3000,3100,440,815,1455,1000,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (128.212,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.975988,0.101461,-7.11306e-05,2.59673e-08,-3.91473e-12,2754.85,40.1215], Tmin=(100,'K'), Tmax=(1522.53,'K')), NASAPolynomial(coeffs=[18.7592,0.049613,-2.00504e-05,3.60116e-09,-2.42234e-13,-3254.68,-63.3855], Tmin=(1522.53,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(21.3646,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(577.856,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJ) + radical(CC(C)OJ)"""),
)

species(
    label = '[CH2]CCC(C)C([O])CC(10779)',
    structure = SMILES('[CH2]CCC(C)C([O])CC'),
    E0 = (21.3646,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,3000,3100,440,815,1455,1000,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2]CCC([CH2])C(O)CC(10780)',
    structure = SMILES('[CH2]CCC([CH2])C(O)CC'),
    E0 = (-3.91385,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.212,'amu'),
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'C=C(CCC)C([O])CC(10765)'],
    products = ['[CH2]C(CCC)C([O])CC(10734)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', '[CH2]C(CCC)C(=O)CC(10766)'],
    products = ['[CH2]C(CCC)C([O])CC(10734)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['npropyl(83)', 'C=CC([O])CC(10590)'],
    products = ['[CH2]C(CCC)C([O])CC(10734)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['C2H5(29)', '[CH2]C(C=O)CCC(1749)'],
    products = ['[CH2]C(CCC)C([O])CC(10734)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]C(CCC)C([O])CC(10734)'],
    products = ['[CH2]C(CCC)[C](O)CC(10768)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]C(CCC)C([O])CC(10734)'],
    products = ['CC[CH]C(C)C([O])CC(10770)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]C(CCC)C([O])CC(10734)'],
    products = ['[CH2][C](CCC)C(O)CC(10771)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2]C(CCC)C(O)[CH]C(10772)'],
    products = ['[CH2]C(CCC)C([O])CC(10734)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]C([CH]CC)C(O)CC(10773)'],
    products = ['[CH2]C(CCC)C([O])CC(10734)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]C(CCC)C([O])CC(10734)'],
    products = ['C[CH]C([O])C(C)CCC(10774)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]C(CCC)C([O])CC(10734)'],
    products = ['C[CH]CC(C)C([O])CC(10775)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]CC(O)C([CH2])CCC(10776)'],
    products = ['[CH2]C(CCC)C([O])CC(10734)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2]C(CCC)C([O])CC(10734)'],
    products = ['[CH2]C(C[CH]C)C(O)CC(10777)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2]CC([O])C(C)CCC(10778)'],
    products = ['[CH2]C(CCC)C([O])CC(10734)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2]CCC(C)C([O])CC(10779)'],
    products = ['[CH2]C(CCC)C([O])CC(10734)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH2]C(CCC)C([O])CC(10734)'],
    products = ['[CH2]CCC([CH2])C(O)CC(10780)'],
...
reaction(
    label = 'reaction25',
    reactants = ['CH2(S)(23)', '[CH2]C(CCC)C(C)[O](1214)'],
    products = ['[CH2]C(CCC)C([O])CC(10734)'],
...
reaction(
    label = 'reaction26',
    reactants = ['CH2(S)(23)', '[CH2]C(CC)C([O])CC(10722)'],
    products = ['[CH2]C(CCC)C([O])CC(10734)'],
...
reaction(
    label = 'reaction30',
    reactants = ['CH2(19)', 'CCC[CH]C([O])CC(10551)'],
    products = ['[CH2]C(CCC)C([O])CC(10734)'],
...
reaction(
    label = 'reaction31',
    reactants = ['O(4)', '[CH2]C([CH]CC)CCC(557)'],
    products = ['[CH2]C(CCC)C([O])CC(10734)'],
