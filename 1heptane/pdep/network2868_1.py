species(
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.63552,0.134901,-0.000148151,9.56084e-08,-2.64315e-11,-3543.33,44.571], Tmin=(100,'K'), Tmax=(856.714,'K')), NASAPolynomial(coeffs=[12.3467,0.0696167,-3.38456e-05,6.65824e-09,-4.74327e-13,-5939.05,-20.7226], Tmin=(856.714,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-31.0693,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(565.384,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCsJOOC) + radical(Cs_P)"""),
)
...
species(
    label = 'CCCC=COO[C](C)OO(15296)',
    structure = SMILES('CCCC=COO[C](C)OO'),
    E0 = (-85.7031,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,2995,3025,975,1000,1300,1375,400,500,1630,1680,360,370,350,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,350,500,795,815,3615,1310,387.5,850,1000,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.43125,0.122141,-0.00011216,5.44142e-08,-1.09196e-11,-10114.5,44.4203], Tmin=(100,'K'), Tmax=(1171.45,'K')), NASAPolynomial(coeffs=[18.4851,0.0541355,-2.50815e-05,4.85838e-09,-3.43833e-13,-14780.7,-54.8162], Tmin=(1171.45,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-85.7031,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(544.598,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(Cs_P)"""),
)

species(
    label = 'C=C(OO)OO[CH]CCCC(15297)',
    structure = SMILES('C=C(OO)OO[CH]CCCC'),
    E0 = (2.68596,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (161.176,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.17551,0.113445,-4.41894e-05,-1.77796e-07,2.12776e-10,450.663,39.6203], Tmin=(100,'K'), Tmax=(449.68,'K')), NASAPolynomial(coeffs=[9.21255,0.0702034,-3.42669e-05,6.6265e-09,-4.62028e-13,-800.786,-2.69535], Tmin=(449.68,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(2.68596,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(544.598,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(CCsJOOC)"""),
)
...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.43992,0.102503,-7.23384e-05,2.51752e-08,-3.50212e-12,-44083.3,42.2866], Tmin=(100,'K'), Tmax=(1687.49,'K')), NASAPolynomial(coeffs=[25.4615,0.038736,-1.5656e-05,2.78191e-09,-1.84559e-13,-53162.4,-101.573], Tmin=(1687.49,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-368.277,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(523.812,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-O2d)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)HHH) + group(Cds-OdCsOs) + radical(CCsJOOC)"""),
)

species(
    label = 'CCC[CH]COO[C](C)OO(15299)',
    structure = SMILES('CCC[CH]COO[C](C)OO'),
    E0 = (-17.0951,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (162.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.66147,0.1356,-0.000151772,1.00026e-07,-2.81875e-11,-1861.85,46.6736], Tmin=(100,'K'), Tmax=(842.323,'K')), NASAPolynomial(coeffs=[12.2882,0.0693549,-3.37997e-05,6.65321e-09,-4.73971e-13,-4211.82,-18.2315], Tmin=(842.323,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-17.0951,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(565.384,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJCOOH) + radical(Cs_P)"""),
)

species(
    label = '[CH2]C(OO)OO[CH]CCCC(15300)',
    structure = SMILES('[CH2]C(OO)OO[CH]CCCC'),
    E0 = (-22.3531,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (162.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.74765,0.137021,-0.000151419,9.67545e-08,-2.62496e-11,-2490.61,46.2793], Tmin=(100,'K'), Tmax=(875.347,'K')), NASAPolynomial(coeffs=[13.3938,0.0678298,-3.28521e-05,6.45345e-09,-4.5943e-13,-5141.39,-24.7533], Tmin=(875.347,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-22.3531,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(565.384,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCsJOOC) + radical(CJCOOH)"""),
)

species(
    label = 'CCCC[CH]OOC(C)O[O](15301)',
    structure = SMILES('CCCC[CH]OOC(C)O[O]'),
    E0 = (-84.311,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (162.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.53433,0.132129,-0.000148205,1.00769e-07,-2.95025e-11,-9950.21,44.2737], Tmin=(100,'K'), Tmax=(811.206,'K')), NASAPolynomial(coeffs=[11.0398,0.0701262,-3.35533e-05,6.54408e-09,-4.63507e-13,-11990.2,-13.7582], Tmin=(811.206,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-84.311,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(569.541,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCsJOOC) + radical(ROOJ)"""),
)

species(
    label = 'CC[CH]CCOO[C](C)OO(15302)',
    structure = SMILES('CC[CH]CCOO[C](C)OO'),
    E0 = (-23.0517,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3615,1310,387.5,850,1000,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,350,500,795,815,360,370,350,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (162.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.818195,0.123448,-9.99991e-05,-1.45194e-08,6.11237e-11,-2616.32,44.0818], Tmin=(100,'K'), Tmax=(512.013,'K')), NASAPolynomial(coeffs=[8.98641,0.0742722,-3.62664e-05,7.09489e-09,-5.01683e-13,-3979.77,-0.166458], Tmin=(512.013,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-23.0517,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(565.384,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(Cs_P)"""),
)

species(
    label = 'C[CH]CCCOO[C](C)OO(15303)',
    structure = SMILES('C[CH]CCCOO[C](C)OO'),
    E0 = (-23.0638,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3615,1310,387.5,850,1000,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,350,500,795,815,360,370,350,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (162.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.71906,0.136758,-0.000167046,1.26952e-07,-4.1455e-11,-2578.12,47.2948], Tmin=(100,'K'), Tmax=(732.959,'K')), NASAPolynomial(coeffs=[10.106,0.0722241,-3.49774e-05,6.82763e-09,-4.82544e-13,-4311.56,-6.08051], Tmin=(732.959,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-23.0638,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(565.384,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJC) + radical(Cs_P)"""),
)

species(
    label = '[CH2][C](OO)OOCCCCC(15304)',
    structure = SMILES('[CH2][C](OO)OOCCCCC'),
    E0 = (-3.54748,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (162.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.71011,0.135838,-0.000147588,9.17192e-08,-2.41427e-11,-229.762,46.536], Tmin=(100,'K'), Tmax=(901.121,'K')), NASAPolynomial(coeffs=[13.9128,0.0664895,-3.21533e-05,6.31898e-09,-4.50196e-13,-3045.42,-27.2091], Tmin=(901.121,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-3.54748,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(565.384,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJCOOH) + radical(Cs_P)"""),
)

species(
    label = 'CCC[CH][CH]OOC(C)OO(15305)',
    structure = SMILES('CCC[CH][CH]OOC(C)OO'),
    E0 = (-35.9007,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (162.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.71822,0.137044,-0.000156676,1.06705e-07,-3.11173e-11,-4121.91,46.4836], Tmin=(100,'K'), Tmax=(815.504,'K')), NASAPolynomial(coeffs=[11.8318,0.0705818,-3.44303e-05,6.77104e-09,-4.81794e-13,-6331.95,-16.1242], Tmin=(815.504,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-35.9007,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(565.384,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJCOOH) + radical(CCsJOOC)"""),
)

species(
    label = '[CH2]CCCCOO[C](C)OO(15306)',
    structure = SMILES('[CH2]CCCCOO[C](C)OO'),
    E0 = (-12.2637,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350,2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,350,500,795,815,3000,3100,440,815,1455,1000,3615,1310,387.5,850,1000,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (162.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.5902,0.133619,-0.000143946,9.00387e-08,-2.40724e-11,-1282.8,45.8989], Tmin=(100,'K'), Tmax=(884.4,'K')), NASAPolynomial(coeffs=[12.8516,0.0683009,-3.3161e-05,6.52715e-09,-4.65373e-13,-3837.25,-22.0002], Tmin=(884.4,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-12.2637,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(565.384,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Cs_P) + radical(RCCJ)"""),
)

species(
    label = 'CCCCCOO[C](C)O[O](15307)',
    structure = SMILES('CCCCCOO[C](C)O[O]'),
    E0 = (-65.5053,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (162.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.47763,0.130684,-0.000143276,9.40339e-08,-2.65377e-11,-7690.15,44.4641], Tmin=(100,'K'), Tmax=(839.703,'K')), NASAPolynomial(coeffs=[11.4905,0.0689102,-3.29295e-05,6.42795e-09,-4.55831e-13,-9868.06,-15.8341], Tmin=(839.703,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-65.5053,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(569.541,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Cs_P) + radical(ROOJ)"""),
)

species(
    label = 'CC[CH]C[CH]OOC(C)OO(15308)',
    structure = SMILES('CC[CH]C[CH]OOC(C)OO'),
    E0 = (-41.8574,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (162.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.608427,0.120377,-7.90481e-05,-6.79761e-08,1.06611e-10,-4887.66,43.0054], Tmin=(100,'K'), Tmax=(486.307,'K')), NASAPolynomial(coeffs=[8.72374,0.075127,-3.66634e-05,7.15411e-09,-5.04422e-13,-6167.9,0.880021], Tmin=(486.307,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-41.8574,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(565.384,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(CCsJOOC)"""),
)

species(
    label = 'C[CH]CC[CH]OOC(C)OO(15309)',
    structure = SMILES('C[CH]CC[CH]OOC(C)OO'),
    E0 = (-41.8694,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (162.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.12924,0.128343,-0.000123151,3.85931e-08,1.88011e-11,-4865.94,44.9058], Tmin=(100,'K'), Tmax=(550.743,'K')), NASAPolynomial(coeffs=[9.47337,0.0738124,-3.5844e-05,7.00631e-09,-4.95744e-13,-6374.66,-3.01584], Tmin=(550.743,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-41.8694,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(565.384,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCsJOOC) + radical(RCCJC)"""),
)

species(
    label = '[CH2]CCC[CH]OOC(C)OO(15310)',
    structure = SMILES('[CH2]CCC[CH]OOC(C)OO'),
    E0 = (-31.0693,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (162.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.63552,0.134901,-0.000148151,9.56084e-08,-2.64315e-11,-3543.33,45.6696], Tmin=(100,'K'), Tmax=(856.714,'K')), NASAPolynomial(coeffs=[12.3467,0.0696167,-3.38456e-05,6.65824e-09,-4.74327e-13,-5939.05,-19.624], Tmin=(856.714,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-31.0693,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(565.384,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCsJOOC) + radical(RCCJ)"""),
)
...
species(
    label = 'C=C(OO)OOCCCCC(15311)',
    structure = SMILES('C=C(OO)OOCCCCC'),
    E0 = (-183.755,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (162.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.662926,0.120769,-8.92563e-05,-4.21329e-08,8.49661e-11,-21951,40.8985], Tmin=(100,'K'), Tmax=(497.89,'K')), NASAPolynomial(coeffs=[9.039,0.0728581,-3.53937e-05,6.89828e-09,-4.86166e-13,-23289.4,-2.88009], Tmin=(497.89,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-183.755,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(569.541,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH)"""),
)

species(
    label = 'CCCC=COOC(C)OO(15312)',
    structure = SMILES('CCCC=COOC(C)OO'),
    E0 = (-290.949,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (162.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.56567,0.122615,-0.000106117,4.79808e-08,-8.9534e-12,-34793.2,44.2093], Tmin=(100,'K'), Tmax=(1253.44,'K')), NASAPolynomial(coeffs=[19.7058,0.0547325,-2.48817e-05,4.77406e-09,-3.35727e-13,-40125.7,-63.218], Tmin=(1253.44,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-290.949,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(569.541,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH)"""),
)
...
species(
    label = 'CCC[CH]OO[C](C)OO(15313)',
    structure = SMILES('CCC[CH]OO[C](C)OO'),
    E0 = (-7.28909,'kJ/mol'),
    modes = [
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.03243,0.120671,-0.000136412,9.04813e-08,-2.56228e-11,-704.174,40.1577], Tmin=(100,'K'), Tmax=(838.872,'K')), NASAPolynomial(coeffs=[11.4477,0.0611627,-3.00057e-05,5.91959e-09,-4.2215e-13,-2798.04,-17.859], Tmin=(838.872,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-7.28909,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(494.711,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Cs_P) + radical(CCsJOOC)"""),
)

species(
    label = '[CH2]C(CCC)OO[C](C)OO(15314)',
    ...
    molecularWeight = (162.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.67395,0.13333,-0.000136053,7.69269e-08,-1.82931e-11,-1750.02,46.0526], Tmin=(100,'K'), Tmax=(993,'K')), NASAPolynomial(coeffs=[15.7003,0.0633437,-3.03332e-05,5.95045e-09,-4.23994e-13,-5200.56,-37.6462], Tmin=(993,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-16.1904,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(565.384,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Cs_P) + radical(CJCOOH)"""),
)
...
species(
    ...
    molecularWeight = (162.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0750945,0.107905,-1.35409e-05,-2.38982e-07,2.61741e-10,-31452.2,40.1423], Tmin=(100,'K'), Tmax=(437.565,'K')), NASAPolynomial(coeffs=[8.33299,0.073254,-3.47552e-05,6.63825e-09,-4.59577e-13,-32565.9,2.66065], Tmin=(437.565,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-262.493,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(569.541,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsOs) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(CCsJOOC)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['CCCC[CH]OO[C](C)OO(13490)'],
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'CCCC=COO[C](C)OO(15296)'],
    products = ['CCCC[CH]OO[C](C)OO(13490)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'C=C(OO)OO[CH]CCCC(15297)'],
    products = ['CCCC[CH]OO[C](C)OO(13490)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['npropyl(83)', 'C=COO[C](C)OO(10331)'],
    products = ['CCCC[CH]OO[C](C)OO(13490)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['OH(5)', 'CCCC[CH]OOC(C)=O(15298)'],
    products = ['CCCC[CH]OO[C](C)OO(13490)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['CCC[CH]COO[C](C)OO(15299)'],
    products = ['CCCC[CH]OO[C](C)OO(13490)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2]C(OO)OO[CH]CCCC(15300)'],
    products = ['CCCC[CH]OO[C](C)OO(13490)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['CCCC[CH]OO[C](C)OO(13490)'],
    products = ['CCCC[CH]OOC(C)O[O](15301)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['CC[CH]CCOO[C](C)OO(15302)'],
    products = ['CCCC[CH]OO[C](C)OO(13490)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['C[CH]CCCOO[C](C)OO(15303)'],
    products = ['CCCC[CH]OO[C](C)OO(13490)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2][C](OO)OOCCCCC(15304)'],
    products = ['CCCC[CH]OO[C](C)OO(13490)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CCCC[CH]OO[C](C)OO(13490)'],
    products = ['CCC[CH][CH]OOC(C)OO(15305)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2]CCCCOO[C](C)OO(15306)'],
    products = ['CCCC[CH]OO[C](C)OO(13490)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CCCC[CH]OO[C](C)OO(13490)'],
    products = ['CCCCCOO[C](C)O[O](15307)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CCCC[CH]OO[C](C)OO(13490)'],
    products = ['CC[CH]C[CH]OOC(C)OO(15308)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CCCC[CH]OO[C](C)OO(13490)'],
    products = ['C[CH]CC[CH]OOC(C)OO(15309)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CCCC[CH]OO[C](C)OO(13490)'],
    products = ['[CH2]CCC[CH]OOC(C)OO(15310)'],
...
reaction(
    label = 'reaction21',
    reactants = ['CH2(S)(23)', 'CCC[CH]OO[C](C)OO(15313)'],
    products = ['CCCC[CH]OO[C](C)OO(13490)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH2]C(CCC)OO[C](C)OO(15314)'],
    products = ['CCCC[CH]OO[C](C)OO(13490)'],
...
reaction(
    label = 'reaction24',
    reactants = ['CCCC[CH]OO[C](C)OO(13490)'],
    products = ['CCCC[CH]OOC(C)([O])O(15315)'],
...
reaction(
    label = 'reaction25',
    reactants = ['CCCC[CH]O[O](239)', 'C[C]OO(178)'],
    products = ['CCCC[CH]OO[C](C)OO(13490)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[CH]CCCC(141)', 'C[C](O[O])OO(5665)'],
    products = ['CCCC[CH]OO[C](C)OO(13490)'],
