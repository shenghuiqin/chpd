...
species(
    label = '[CH]=C1CC1O[CH]CC(26687)',
    structure = SMILES('[CH]=C1CC1O[CH]CC'),
    E0 = (401.108,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (110.154,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.228282,0.0810643,-5.60822e-05,1.10243e-08,2.50726e-12,48404.7,31.1888], Tmin=(100,'K'), Tmax=(1038.16,'K')), NASAPolynomial(coeffs=[19.1114,0.0281387,-1.08062e-05,1.98179e-09,-1.39119e-13,43225.7,-68.4418], Tmin=(1038.16,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(401.108,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(415.724,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + ring(Methylene_cyclopropane) + radical(CCsJOCs) + radical(Cds_P)"""),
)

species(
    label = '[CH]=C1C([CH2])OC1CC(26688)',
    structure = SMILES('[CH]=C1C([CH2])OC1CC'),
    E0 = (358.753,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (110.154,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.268422,0.0641529,-3.48999e-06,-4.47295e-08,2.22292e-11,43298.3,30.9258], Tmin=(100,'K'), Tmax=(992.403,'K')), NASAPolynomial(coeffs=[19.7337,0.0271779,-1.03023e-05,1.96633e-09,-1.44622e-13,37392.1,-73.1261], Tmin=(992.403,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(358.753,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(419.881,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + ring(Cyclobutane) + radical(Cds_P) + radical(CJC(C)OC)"""),
)
...
species(
    label = 'C#CC([CH2])OC=CC(26689)',
    structure = SMILES('C#CC([CH2])OC=CC'),
    E0 = (222.17,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2995,3025,975,1000,1300,1375,400,500,1630,1680,2750,2800,2850,1350,1500,750,1050,1375,1000,2175,525,750,770,3400,2100,3000,3100,440,815,1455,1000,1380,1390,370,380,2900,435,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.51335,0.0981018,-9.95273e-05,4.90559e-08,-9.07779e-12,26939.2,33.185], Tmin=(100,'K'), Tmax=(1509.02,'K')), NASAPolynomial(coeffs=[25.5166,0.0131695,-1.89893e-06,9.15916e-11,5.52196e-16,20293.8,-103.33], Tmin=(1509.02,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(222.17,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Ct-CtCs) + group(Ct-CtH) + radical(CJC(C)OC)"""),
)

species(
    label = 'C#CC(=C)O[CH]CC(26690)',
    structure = SMILES('C#CC(=C)O[CH]CC'),
    E0 = (208.098,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2175,525,3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,2950,3100,1380,975,1025,1650,750,770,3400,2100,350,440,435,1725,2750,2850,1437.5,1250,1305,750,350,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (109.146,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.982434,0.0970704,-9.91429e-05,5.00035e-08,-9.76375e-12,25218.4,29.2034], Tmin=(100,'K'), Tmax=(1260.72,'K')), NASAPolynomial(coeffs=[23.4882,0.0194302,-6.76696e-06,1.15534e-09,-7.71966e-14,19048.2,-94.5229], Tmin=(1260.72,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(208.098,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-Cds(Cds-Cds)O2s) + group(Cds-CdsHH) + group(Ct-Ct(Cds-Cds)) + group(Ct-CtH) + radical(CCsJOC(O))"""),
)
...
species(
    label = 'C#CC([CH2])OC[CH]C(26692)',
    structure = SMILES('C#CC([CH2])OC[CH]C'),
    E0 = (346.452,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,2175,525,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,750,770,3400,2100,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (110.154,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.17206,0.0906883,-9.27416e-05,5.16434e-08,-1.16446e-11,41819.7,33.6008], Tmin=(100,'K'), Tmax=(1070.93,'K')), NASAPolynomial(coeffs=[14.9215,0.0343125,-1.37779e-05,2.48716e-09,-1.69368e-13,38586.9,-40.2509], Tmin=(1070.93,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(346.452,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(407.409,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(CJC(C)OC) + radical(CCJCO)"""),
)

species(
    label = 'C#C[C](C)O[CH]CC(26693)',
    ...
    molecularWeight = (110.154,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.921475,0.0995677,-0.000104554,5.61628e-08,-1.17898e-11,28797.8,31.5561], Tmin=(100,'K'), Tmax=(1170.21,'K')), NASAPolynomial(coeffs=[21.0147,0.0245858,-8.44039e-06,1.40748e-09,-9.20939e-14,23663.8,-77.7215], Tmin=(1170.21,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(237.904,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(CCsJOC(O)) + radical(C=C=CJ)"""),
)

species(
    label = 'C#C[C]([CH2])OCCC(26694)',
    structure = SMILES('[CH]=C=C([CH2])OCCC'),
    E0 = (202.893,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (110.154,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.851116,0.0937387,-9.12234e-05,4.58045e-08,-8.98257e-12,24588.1,32.5226], Tmin=(100,'K'), Tmax=(1290.36,'K')), NASAPolynomial(coeffs=[21.0093,0.0237665,-7.31779e-06,1.12917e-09,-7.01805e-14,19130.2,-77.8022], Tmin=(1290.36,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(202.893,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(C=C=CJ) + radical(C=C(O)CJ)"""),
)

species(
    label = 'C#CC([CH2])OCC[CH2](26695)',
    structure = SMILES('C#CC([CH2])OCC[CH2]'),
    E0 = (351.796,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,750,770,3400,2100,2175,525,1380,1390,370,380,2900,435,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (110.154,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.233246,0.0954147,-0.000107174,6.6901e-08,-1.69895e-11,42461.8,33.1167], Tmin=(100,'K'), Tmax=(953.363,'K')), NASAPolynomial(coeffs=[13.6402,0.0372063,-1.55901e-05,2.85887e-09,-1.95782e-13,39816.5,-33.1522], Tmin=(953.363,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(351.796,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(407.409,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(CJC(C)OC) + radical(RCCJ)"""),
)

species(
    label = '[C]#CC(C)O[CH]CC(26696)',
    structure = SMILES('[C]#CC(C)O[CH]CC'),
    E0 = (453.639,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2175,525,3025,407.5,1350,352.5,1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (110.154,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.354137,0.0944361,-0.000102296,6.06525e-08,-1.44387e-11,54718.1,32.1922], Tmin=(100,'K'), Tmax=(1022.4,'K')), NASAPolynomial(coeffs=[15.2634,0.0333353,-1.26541e-05,2.2014e-09,-1.46293e-13,51524.6,-43.4997], Tmin=(1022.4,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(453.639,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(407.409,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(Acetyl) + radical(CCsJOCs)"""),
)

species(
    label = 'C#CC(C)O[CH][CH]C(26697)',
    ...
    molecularWeight = (110.154,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.520844,0.0896589,-8.49074e-05,4.19389e-08,-8.19368e-12,38224.8,34.5442], Tmin=(100,'K'), Tmax=(1247.12,'K')), NASAPolynomial(coeffs=[19.0484,0.0268923,-9.41318e-06,1.58214e-09,-1.03637e-13,33343.8,-64.1876], Tmin=(1247.12,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(316.398,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(407.409,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(CCJCO) + radical(CCsJOCs)"""),
)

species(
    label = '[C]#CC([CH2])OCCC(26698)',
    structure = SMILES('[C]#CC([CH2])OCCC'),
    E0 = (483.693,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2175,525,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (110.154,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.371833,0.0997493,-0.000124923,8.92824e-08,-2.58697e-11,58328.9,32.5657], Tmin=(100,'K'), Tmax=(841.664,'K')), NASAPolynomial(coeffs=[12.5224,0.0384772,-1.57375e-05,2.8094e-09,-1.87744e-13,56158.1,-27.4203], Tmin=(841.664,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(483.693,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(407.409,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(Acetyl) + radical(CJC(C)OC)"""),
)

species(
    label = 'C#CC(C)O[CH]C[CH2](26699)',
    structure = SMILES('C#CC(C)O[CH]C[CH2]'),
    E0 = (321.742,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (110.154,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.403671,0.092399,-9.29228e-05,4.95746e-08,-1.05637e-11,38859,33.4124], Tmin=(100,'K'), Tmax=(1139.26,'K')), NASAPolynomial(coeffs=[17.1573,0.0307418,-1.17425e-05,2.07012e-09,-1.39325e-13,34857.7,-53.5988], Tmin=(1139.26,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(321.742,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(407.409,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(CCsJOCs) + radical(RCCJ)"""),
)
...
species(
    ...
    molecularWeight = (110.154,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.419559,0.0854288,-6.47213e-05,1.80578e-08,4.17609e-13,1873.61,27.7061], Tmin=(100,'K'), Tmax=(1044.01,'K')), NASAPolynomial(coeffs=[19.8933,0.0276885,-1.06212e-05,1.93997e-09,-1.35702e-13,-3462.41,-76.4093], Tmin=(1044.01,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(14.1705,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-Cds(Cds-Cds)O2s) + group(Cds-CdsHH) + group(Ct-Ct(Cds-Cds)) + group(Ct-CtH)"""),
)

species(
    label = 'C#CC(C)OC=CC(26702)',
    ...
    molecularWeight = (110.154,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.227301,0.0744877,-1.87935e-05,-4.30892e-08,2.61959e-11,1571.6,28.8064], Tmin=(100,'K'), Tmax=(932.143,'K')), NASAPolynomial(coeffs=[23.776,0.0184921,-4.32891e-06,6.65736e-10,-4.86846e-14,-4945.49,-96.2631], Tmin=(932.143,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(11.66,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Ct-CtCs) + group(Ct-CtH)"""),
)
...
species(
    label = 'C#CC([CH2])OC([CH2])C(26704)',
    structure = SMILES('C#CC([CH2])OC([CH2])C'),
    E0 = (346.509,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2175,525,750,770,3400,2100,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (110.154,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.719227,0.106406,-0.000133377,9.01772e-08,-2.43054e-11,41843,32.4799], Tmin=(100,'K'), Tmax=(908.002,'K')), NASAPolynomial(coeffs=[15.6885,0.0341267,-1.39761e-05,2.51312e-09,-1.694e-13,38863.3,-45.0947], Tmin=(908.002,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(346.509,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(407.409,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(CJC(C)OC) + radical(CJC(C)OC)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['C#CC([CH2])O[CH]CC(26559)'],
...
reaction(
    label = 'reaction2',
    reactants = ['C#CC([CH2])O[CH]CC(26559)'],
    products = ['[CH]=C1CC1O[CH]CC(26687)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['C#CC([CH2])O[CH]CC(26559)'],
    products = ['[CH]=C1C([CH2])OC1CC(26688)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', 'C#CC([CH2])OC=CC(26689)'],
    products = ['C#CC([CH2])O[CH]CC(26559)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)', 'C#CC(=C)O[CH]CC(26690)'],
    products = ['C#CC([CH2])O[CH]CC(26559)'],
    transitionState = 'TS5',
...
reaction(
    ...
    products = ['C#CC([CH2])O[CH]CC(26559)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(4e+09,'cm^3/(mol*s)'), n=1.39, Ea=(79.7519,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), comment="""Estimated using template [Od_CO-CsH;YJ] for rate rule [Od_CO-CsH;CJ]
Euclidian distance = 1.0
family: R_Addition_MultipleBond
Ea raised from 78.9 to 79.8 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction7',
    reactants = ['CH3(17)', 'C#CC([CH2])OC=C(26691)'],
    products = ['C#CC([CH2])O[CH]CC(26559)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['C2H(33)', 'C=CO[CH]CC(10587)'],
    products = ['C#CC([CH2])O[CH]CC(26559)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['C#CC([CH2])OC[CH]C(26692)'],
    products = ['C#CC([CH2])O[CH]CC(26559)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['C#CC([CH2])O[CH]CC(26559)'],
    products = ['C#C[C](C)O[CH]CC(26693)'],
...
reaction(
    label = 'reaction12',
    reactants = ['C#CC([CH2])OCC[CH2](26695)'],
    products = ['C#CC([CH2])O[CH]CC(26559)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[C]#CC(C)O[CH]CC(26696)'],
    products = ['C#CC([CH2])O[CH]CC(26559)'],
...
reaction(
    label = 'reaction14',
    reactants = ['C#CC([CH2])O[CH]CC(26559)'],
    products = ['C#CC(C)O[CH][CH]C(26697)'],
...
reaction(
    label = 'reaction16',
    reactants = ['C#CC([CH2])O[CH]CC(26559)'],
    products = ['C#CC(C)O[CH]C[CH2](26699)'],
...
reaction(
    label = 'reaction22',
    reactants = ['CH2(S)(23)', 'C#CC([CH2])O[CH]C(26703)'],
    products = ['C#CC([CH2])O[CH]CC(26559)'],
...
reaction(
    label = 'reaction23',
    reactants = ['C#CC([CH2])OC([CH2])C(26704)'],
    products = ['C#CC([CH2])O[CH]CC(26559)'],
...
reaction(
    label = 'reaction24',
    reactants = ['C#CC([CH2])O[CH]CC(26559)'],
    products = ['C#CC[CH]O[CH]CC(26705)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[CH]CC(144)', 'C#CC([CH2])[O](26706)'],
    products = ['C#CC([CH2])O[CH]CC(26559)'],
