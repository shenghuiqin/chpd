...
species(
    label = 'CCCCCC(C)=O(2224)',
    structure = SMILES('CCCCCC(C)=O'),
    E0 = (-329.535,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,375,552.5,462.5,1710,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.625477,0.079004,-4.83872e-05,1.52643e-08,-2.07786e-12,-39517.6,29.8068], Tmin=(100,'K'), Tmax=(1540.59,'K')), NASAPolynomial(coeffs=[10.6943,0.0528613,-2.29333e-05,4.24956e-09,-2.90432e-13,-42620,-23.1207], Tmin=(1540.59,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-329.535,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)HHH) + group(Cds-OdCsCs)"""),
)
...
species(
    ...
    E0 = (-274.664,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,2750,2800,2850,1350,1500,750,1050,1375,1000,2782.5,750,1395,475,1775,1000,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.14527,0.065281,-3.70977e-05,1.02695e-08,-1.1746e-12,-32935.2,26.3499], Tmin=(100,'K'), Tmax=(1851.18,'K')), NASAPolynomial(coeffs=[12.5076,0.0407295,-1.72038e-05,3.10513e-09,-2.07056e-13,-37142,-35.4642], Tmin=(1851.18,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-274.664,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsH)"""),
)
...
species(
    label = '[CH2]CC(C)[O](1023)',
    structure = SMILES('[CH2]CC(C)[O]'),
    E0 = (119.551,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,1667.34,4000],'cm^-1')),
        HinderedRotor(inertia=(0.82848,'amu*angstrom^2'), symmetry=1, barrier=(19.0484,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.14976,'amu*angstrom^2'), symmetry=1, barrier=(26.4352,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.438619,'amu*angstrom^2'), symmetry=1, barrier=(10.0847,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.8392,0.0456813,-3.00029e-05,1.02467e-08,-1.45619e-12,14457.6,19.8469], Tmin=(100,'K'), Tmax=(1580.37,'K')), NASAPolynomial(coeffs=[10.1548,0.0246339,-1.00259e-05,1.81954e-09,-1.2309e-13,11829.2,-24.077], Tmin=(1580.37,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(119.551,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo library: CBS_QB3_1dHR + radical(RCCJ) + radical(CC(C)OJ)"""),
)

species(
    label = 'CCC[CH]CC(C)[O](1213)',
...
species(
    label = 'CCCCC[CH][O](1817)',
    structure = SMILES('CCCCC[CH][O]'),
    E0 = (54.311,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (100.159,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.66157,0.0634291,1.1492e-05,-1.55282e-07,1.51375e-10,6603.66,25.8794], Tmin=(100,'K'), Tmax=(435.676,'K')), NASAPolynomial(coeffs=[4.82425,0.0541972,-2.49105e-05,4.76024e-09,-3.326e-13,6140.12,11.0919], Tmin=(435.676,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(54.311,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(CCsJOH)"""),
)

species(
    label = 'CCCCC[C](C)[O](2218)',
    structure = SMILES('CCCCC[C](C)[O]'),
    E0 = (18.8734,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,360,370,350,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (114.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0368223,0.0905578,-7.12949e-05,3.18944e-08,-6.21457e-12,2409.68,32.1569], Tmin=(100,'K'), Tmax=(1164.39,'K')), NASAPolynomial(coeffs=[10.9031,0.0532291,-2.3207e-05,4.36189e-09,-3.03206e-13,-120.831,-21.9204], Tmin=(1164.39,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(18.8734,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(C2CsJOH) + radical(CC(C)OJ)"""),
)

species(
    label = '[CH2]CCCC(C)[O](2063)',
...
species(
    ...
    molecularWeight = (114.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.304866,0.0911083,-6.8388e-05,2.73877e-08,-4.57561e-12,6632.39,34.5872], Tmin=(100,'K'), Tmax=(1378.66,'K')), NASAPolynomial(coeffs=[15.3729,0.0456212,-1.88971e-05,3.45577e-09,-2.35884e-13,2309.55,-46.0833], Tmin=(1378.66,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(53.8347,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(CJCO)"""),
)

species(
    label = '[CH2]CCCCC(C)[O](2219)',
...
species(
    ...
    molecularWeight = (115.193,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.124367,0.0944822,-7.67675e-05,3.61787e-08,-7.44856e-12,-25290.8,32.9312], Tmin=(100,'K'), Tmax=(1109.42,'K')), NASAPolynomial(coeffs=[10.683,0.0555156,-2.40814e-05,4.51823e-09,-3.13948e-13,-27688.7,-20.33], Tmin=(1109.42,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-211.487,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(527.969,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(C2CsJOH)"""),
)

species(
    label = 'CCCC[CH]C(C)O(4889)',
    structure = SMILES('CCCC[CH]C(C)O'),
    E0 = (-188.213,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3025,407.5,1350,352.5,3615,1277.5,1000,1380,1390,370,380,2900,435,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (115.193,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.532014,0.0892737,-6.07097e-05,2.13892e-08,-3.0898e-12,-22465.3,37.4755], Tmin=(100,'K'), Tmax=(1596.28,'K')), NASAPolynomial(coeffs=[18.2923,0.042103,-1.63839e-05,2.87699e-09,-1.9051e-13,-28475,-62.1444], Tmin=(1596.28,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-188.213,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(527.969,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJCO)"""),
)

species(
    label = '[CH2]C(O)CCCCC(4890)',
    structure = SMILES('[CH2]C(O)CCCCC'),
    E0 = (-176.526,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (115.193,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.415106,0.0944969,-7.22707e-05,2.99656e-08,-5.21317e-12,-21070.4,35.1742], Tmin=(100,'K'), Tmax=(1325.36,'K')), NASAPolynomial(coeffs=[14.9001,0.0482748,-1.9958e-05,3.65187e-09,-2.49659e-13,-25130,-43.0269], Tmin=(1325.36,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-176.526,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(527.969,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJCO)"""),
)

species(
    label = 'CCC[CH]CC(C)O(4891)',
    structure = SMILES('CCC[CH]CC(C)O'),
    E0 = (-193.657,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3025,407.5,1350,352.5,3615,1277.5,1000,1380,1390,370,380,2900,435,200,800,1200,1600],'cm^-1')),
    ...
    molecularWeight = (115.193,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.390728,0.0849677,-5.9261e-05,2.42898e-08,-4.59007e-12,-23166.4,34.2208], Tmin=(100,'K'), Tmax=(1140.57,'K')), NASAPolynomial(coeffs=[7.58294,0.0597447,-2.60898e-05,4.90133e-09,-3.40381e-13,-24807.1,-1.42352], Tmin=(1140.57,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-193.657,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(527.969,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJCC)"""),
)

species(
    label = 'CC[CH]CCC(C)O(4892)',
    structure = SMILES('CC[CH]CCC(C)O'),
    E0 = (-193.657,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
species(
    ...
    molecularWeight = (115.193,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.255905,0.0857743,-5.90771e-05,2.29939e-08,-3.984e-12,-23161.4,34.8664], Tmin=(100,'K'), Tmax=(1260.25,'K')), NASAPolynomial(coeffs=[9.53121,0.0563346,-2.40365e-05,4.4575e-09,-3.06854e-13,-25499.2,-12.0271], Tmin=(1260.25,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-193.669,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(527.969,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJC)"""),
)

species(
    label = '[CH2]CCCCC(C)O(4894)',
    structure = SMILES('[CH2]CCCCC(C)O'),
    E0 = (-182.869,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (115.193,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.252626,0.0903562,-6.3986e-05,2.41453e-08,-3.82942e-12,-21838.8,35.743], Tmin=(100,'K'), Tmax=(1431.74,'K')), NASAPolynomial(coeffs=[14.8036,0.048292,-1.99164e-05,3.62507e-09,-2.46319e-13,-26150.1,-42.2982], Tmin=(1431.74,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-182.869,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(527.969,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJ)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['H(3)', 'CCCCCC(C)=O(2224)'],
    products = ['CCCCCC(C)[O](230)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]CCCC(84)', 'CH3CHO(37)'],
    products = ['CCCCCC(C)[O](230)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH3(17)', 'CCCCCC=O(1824)'],
    products = ['CCCCCC(C)[O](230)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['butyl_1(82)', '[CH2]C(C)[O](1669)'],
    products = ['CCCCCC(C)[O](230)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[CH2]CCCC(84)', 'C[CH][O](176)'],
    products = ['CCCCCC(C)[O](230)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['H(3)', 'CCCC[CH]C(C)[O](2215)'],
    products = ['CCCCCC(C)[O](230)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['npropyl(83)', '[CH2]CC(C)[O](1023)'],
    products = ['CCCCCC(C)[O](230)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(8.73e+14,'cm^3/(mol*s)'), n=-0.699, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(200,'K'), Tmax=(2000,'K'), comment="""From training reaction 11 used for C_rad/H2/Cs;C_rad/H2/Cs
Exact match found for rate rule [C_rad/H2/Cs;C_rad/H2/Cs]
...
reaction(
    label = 'reaction8',
    reactants = ['H(3)', 'CCC[CH]CC(C)[O](1213)'],
    products = ['CCCCCC(C)[O](230)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(2e+13,'cm^3/(mol*s)','*|/',3.16), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), comment="""From training reaction 59 used for H_rad;C_rad/H/NonDeC
Exact match found for rate rule [C_rad/H/NonDeC;H_rad]
...
reaction(
    label = 'reaction9',
    reactants = ['C2H5(29)', '[CH2]CCC(C)[O](1924)'],
    products = ['CCCCCC(C)[O](230)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(8.73e+14,'cm^3/(mol*s)'), n=-0.699, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(200,'K'), Tmax=(2000,'K'), comment="""From training reaction 11 used for C_rad/H2/Cs;C_rad/H2/Cs
Exact match found for rate rule [C_rad/H2/Cs;C_rad/H2/Cs]
...
reaction(
    label = 'reaction10',
    reactants = ['H(3)', 'CC[CH]CCC(C)[O](2089)'],
    products = ['CCCCCC(C)[O](230)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CH3(17)', 'CCCCC[CH][O](1817)'],
    products = ['CCCCCC(C)[O](230)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(3)', 'CCCCC[C](C)[O](2218)'],
    products = ['CCCCCC(C)[O](230)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CH3(17)', '[CH2]CCCC(C)[O](2063)'],
    products = ['CCCCCC(C)[O](230)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(3)', 'C[CH]CCCC(C)[O](2217)'],
    products = ['CCCCCC(C)[O](230)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(3)', '[CH2]C([O])CCCCC(2220)'],
    products = ['CCCCCC(C)[O](230)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(3)', '[CH2]CCCCC(C)[O](2219)'],
    products = ['CCCCCC(C)[O](230)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CH2(S)(23)', 'CCCCC(C)[O](592)'],
    products = ['CCCCCC(C)[O](230)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CCCCCC(C)[O](230)'],
    products = ['CCCCC[C](C)O(4888)'],
