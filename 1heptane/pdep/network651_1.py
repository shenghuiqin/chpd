...
species(
    label = 'C#COC([CH2])=O(4575)',
    structure = SMILES('C#COC([CH2])=O'),
    E0 = (90.4817,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2175,525,3000,3100,440,815,1455,1000,750,770,3400,2100,180,180,180,756.354,756.364,756.493],'cm^-1')),
        HinderedRotor(inertia=(0.0964501,'amu*angstrom^2'), symmetry=1, barrier=(39.1531,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.096445,'amu*angstrom^2'), symmetry=1, barrier=(39.1532,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0964436,'amu*angstrom^2'), symmetry=1, barrier=(39.1532,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
species(
    label = '[CH]=COC([CH2])=O(4576)',
    structure = SMILES('[CH]=COC([CH2])=O'),
    E0 = (108.616,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,180,180,180,180,811.636,1063.8],'cm^-1')),
        HinderedRotor(inertia=(0.0244933,'amu*angstrom^2'), symmetry=1, barrier=(19.6684,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0244561,'amu*angstrom^2'), symmetry=1, barrier=(19.6581,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.01013,'amu*angstrom^2'), symmetry=1, barrier=(23.2248,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.0734,'amu'),
...
species(
    label = '[CH]=[C]OC(C)=O(4577)',
    structure = SMILES('[CH]=[C]OC(C)=O'),
    E0 = (136.771,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,2750,2800,2850,1350,1500,750,1050,1375,1000,3120,650,792.5,1650,316.923,317.633,320.085,321.832,2041.52,4000],'cm^-1')),
        HinderedRotor(inertia=(0.318583,'amu*angstrom^2'), symmetry=1, barrier=(23.3157,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0500762,'amu*angstrom^2'), symmetry=1, barrier=(23.3363,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.599325,'amu*angstrom^2'), symmetry=1, barrier=(44.0993,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.0734,'amu'),
...
species(
    label = '[CH]=C(O)O[C]=C(1111)',
    structure = SMILES('[CH]=C(O)O[C]=C'),
    E0 = (299.517,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,440,435,1725,1685,370,3615,1277.5,1000,3120,650,792.5,1650,2950,3100,1380,975,1025,1650,264.648,264.962],'cm^-1')),
        HinderedRotor(inertia=(0.278345,'amu*angstrom^2'), symmetry=1, barrier=(13.8605,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.278432,'amu*angstrom^2'), symmetry=1, barrier=(13.8608,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.279018,'amu*angstrom^2'), symmetry=1, barrier=(13.8602,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.0734,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.343,0.0596436,-7.95332e-05,5.45447e-08,-1.46568e-11,36118.2,23.8989], Tmin=(100,'K'), Tmax=(916.415,'K')), NASAPolynomial(coeffs=[11.6281,0.0147502,-6.05007e-06,1.08698e-09,-7.31718e-14,34233.2,-24.8229], Tmin=(916.415,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(299.517,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cds-CdsCsCs) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cds_P) + radical(C=CJO)"""),
)

species(
    label = '[CH]=C([O])OC=C(4582)',
...
species(
    label = '[CH]=[C]OC(=C)O(4583)',
    structure = SMILES('C#CO[C]([CH2])O'),
    E0 = (240.424,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2175,525,750,770,3400,2100,3615,1277.5,1000,3000,3100,440,815,1455,1000,360,370,350,262.383,262.857],'cm^-1')),
        HinderedRotor(inertia=(0.410073,'amu*angstrom^2'), symmetry=1, barrier=(20.282,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.413101,'amu*angstrom^2'), symmetry=1, barrier=(20.2832,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.411459,'amu*angstrom^2'), symmetry=1, barrier=(20.281,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.43433,'amu*angstrom^2'), symmetry=1, barrier=(119.627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.0734,'amu'),
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'C#COC([CH2])=O(4575)'],
    products = ['C=[C]OC(=C)[O](1074)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction11',
    reactants = ['H2CC(41)', '[CH2]C([O])=O(1440)'],
    products = ['C=[C]OC(=C)[O](1074)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CH2(19)', 'C=[C]O[C]=O(4581)'],
    products = ['C=[C]OC(=C)[O](1074)'],
