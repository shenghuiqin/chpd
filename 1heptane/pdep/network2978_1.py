species(
    label = 'CCCCC([O])O[CH]CC(C)OO(13585)',
    structure = SMILES('CCCCC([O])O[CH]CC(C)OO'),
    E0 = (-287.309,'kJ/mol'),
    modes = [
...
species(
    label = 'CCCCC([O])OC=CC(C)OO(14262)',
    structure = SMILES('CCCCC([O])OC=CC(C)OO'),
    E0 = (-391.346,'kJ/mol'),
    modes = [
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-3.38827,0.153255,-0.000135065,6.08894e-08,-1.10533e-11,-46794.7,54.7079], Tmin=(100,'K'), Tmax=(1312.37,'K')), NASAPolynomial(coeffs=[28.4698,0.0561539,-2.40805e-05,4.51073e-09,-3.13415e-13,-55156.5,-107.649], Tmin=(1312.37,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-391.346,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(690.101,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(CCOJ)"""),
)

species(
    label = 'CCCCC(=O)O[CH]CC(C)OO(14263)',
    structure = SMILES('CCCCC(=O)O[CH]CC(C)OO'),
    E0 = (-491.063,'kJ/mol'),
    modes = [
...
species(
    label = 'CC(C[CH]OC=O)OO(7442)',
    structure = SMILES('CC(C[CH]OC=O)OO'),
    E0 = (-361.465,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1310,387.5,850,1000,2750,2850,1437.5,1250,1305,750,350,2782.5,750,1395,475,1775,1000,1380,1390,370,380,2900,435,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.23647,0.0949792,-9.33151e-05,4.8276e-08,-1.02208e-11,-43323.2,33.8983], Tmin=(100,'K'), Tmax=(1123.53,'K')), NASAPolynomial(coeffs=[15.6616,0.0383785,-1.77484e-05,3.43688e-09,-2.4342e-13,-46895.6,-44.6523], Tmin=(1123.53,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-361.465,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(403.252,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdOsH) + radical(CCsJOC(O)H)"""),
)

species(
    label = 'CCCCC([O])OC[CH]C(C)OO(14264)',
    structure = SMILES('CCCCC([O])OC[CH]C(C)OO'),
    E0 = (-267.35,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (190.237,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.30058,0.15686,-0.000151938,5.50659e-08,1.54329e-11,-31945.4,54.4286], Tmin=(100,'K'), Tmax=(559.529,'K')), NASAPolynomial(coeffs=[10.5672,0.0906771,-4.36953e-05,8.52674e-09,-6.03131e-13,-33789.3,-3.78892], Tmin=(559.529,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-267.35,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(710.887,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(CCJCOOH)"""),
)

species(
    label = 'CCCC[C](O)O[CH]CC(C)OO(14265)',
    structure = SMILES('CCCC[C](O)O[CH]CC(C)OO'),
    E0 = (-307.768,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (190.237,'amu'),
...
species(
    label = 'CCCC[C]([O])OCCC(C)OO(14266)',
    structure = SMILES('CCCC[C]([O])OCCC(C)OO'),
    E0 = (-262.519,'kJ/mol'),
    modes = [
...
species(
    label = 'CCCCC([O])OCC[C](C)OO(14267)',
    structure = SMILES('CCCCC([O])OCC[C](C)OO'),
    E0 = (-280.866,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2761.11,2772.22,2783.33,2794.44,2805.56,2816.67,2827.78,2838.89,2850,1425,1431.25,1437.5,1443.75,1450,1225,1237.5,1250,1262.5,1275,1270,1287.5,1305,1322.5,1340,700,725,750,775,800,300,325,350,375,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,360,370,350,3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,200,800,914.286,1028.57,1142.86,1257.14,1371.43,1485.71,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'CCC[CH]C(O)O[CH]CC(C)OO(14268)',
    structure = SMILES('CCC[CH]C(O)O[CH]CC(C)OO'),
    E0 = (-313.113,'kJ/mol'),
    modes = [
...
species(
    label = '[CH2]C(CCOC([O])CCCC)OO(14269)',
    structure = SMILES('[CH2]C(CCOC([O])CCCC)OO'),
    E0 = (-253.803,'kJ/mol'),
    modes = [
...
species(
    label = 'CCC[CH]C([O])OCCC(C)OO(14271)',
    structure = SMILES('CCC[CH]C([O])OCCC(C)OO'),
    E0 = (-267.863,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3025,407.5,1350,352.5,3615,1310,387.5,850,1000,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,200,800,914.286,1028.57,1142.86,1257.14,1371.43,1485.71,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'CCCCC(O)O[CH][CH]C(C)OO(14272)',
    structure = SMILES('CCCCC(O)O[CH][CH]C(C)OO'),
    E0 = (-312.6,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (190.237,'amu'),
...
species(
    label = 'CCCCC([O])OCCC(C)O[O](14273)',
    structure = SMILES('CCCCC([O])OCCC(C)O[O]'),
    E0 = (-315.761,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2761.11,2772.22,2783.33,2794.44,2805.56,2816.67,2827.78,2838.89,2850,1425,1431.25,1437.5,1443.75,1450,1225,1237.5,1250,1262.5,1275,1270,1287.5,1305,1322.5,1340,700,725,750,775,800,300,325,350,375,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,492.5,1135,1000,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,180,180,180,446.275,714.233,1600,1828.57,2971.43,3200],'cm^-1')),
...
species(
    label = 'C[CH]CCC(O)O[CH]CC(C)OO(14274)',
    structure = SMILES('C[CH]CCC(O)O[CH]CC(C)OO'),
    E0 = (-318.568,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (190.237,'amu'),
...
species(
    label = 'CC[CH]CC([O])OCCC(C)OO(14275)',
    structure = SMILES('CC[CH]CC([O])OCCC(C)OO'),
    E0 = (-273.307,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3025,407.5,1350,352.5,3615,1310,387.5,850,1000,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,200,800,914.286,1028.57,1142.86,1257.14,1371.43,1485.71,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2]CCCC(O)O[CH]CC(C)OO(14276)',
    structure = SMILES('[CH2]CCCC(O)O[CH]CC(C)OO'),
    E0 = (-307.768,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (190.237,'amu'),
...
species(
    label = 'C[CH]CCC([O])OCCC(C)OO(14277)',
    structure = SMILES('C[CH]CCC([O])OCCC(C)OO'),
    E0 = (-273.319,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3025,407.5,1350,352.5,3615,1310,387.5,850,1000,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,200,800,914.286,1028.57,1142.86,1257.14,1371.43,1485.71,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2]C(C[CH]OC(O)CCCC)OO(14280)',
    structure = SMILES('[CH2]C(C[CH]OC(O)CCCC)OO'),
    E0 = (-299.052,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (190.237,'amu'),
...
species(
    label = 'CCCCC(O)O[CH]CC(C)O[O](14281)',
    structure = SMILES('CCCCC(O)O[CH]CC(C)O[O]'),
    E0 = (-361.01,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (190.237,'amu'),
...
species(
    label = 'CCCCC(=O)OCCC(C)OO(14282)',
    structure = SMILES('CCCCC(=O)OCCC(C)OO'),
    E0 = (-684.991,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (190.237,'amu'),
...
species(
    label = 'CCCCC(O)OC=CC(C)OO(14283)',
    structure = SMILES('CCCCC(O)OC=CC(C)OO'),
    E0 = (-617.052,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (190.237,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-4.37456,0.163182,-0.000147169,6.66894e-08,-1.19138e-11,-73895.1,57.3998], Tmin=(100,'K'), Tmax=(1356.51,'K')), NASAPolynomial(coeffs=[35.2203,0.0464269,-1.80648e-05,3.24019e-09,-2.20337e-13,-84637.3,-145.696], Tmin=(1356.51,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-617.052,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(710.887,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH)"""),
)
...
species(
    label = 'CCCCC([O])O[CH]CCOO(14284)',
    structure = SMILES('CCCCC([O])O[CH]CCOO'),
    E0 = (-250.886,'kJ/mol'),
    modes = [
...
species(
    label = 'CCCC([O])O[CH]CC(C)OO(14285)',
    structure = SMILES('CCCC([O])O[CH]CC(C)OO'),
    E0 = (-263.529,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3025,407.5,1350,352.5,3615,1310,387.5,850,1000,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,200,800,933.333,1066.67,1200,1333.33,1466.67,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'CCCCC([O])OC1CC(C)O1(14286)',
    structure = SMILES('CCCCC([O])OC1CC(C)O1'),
    E0 = (-395.642,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (173.229,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.87759,0.121621,-8.66969e-05,3.3647e-08,-5.48861e-12,-47367.2,46.8557], Tmin=(100,'K'), Tmax=(1406.3,'K')), NASAPolynomial(coeffs=[18.4251,0.0638722,-2.51e-05,4.44621e-09,-2.97475e-13,-53077.5,-58.0151], Tmin=(1406.3,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-395.642,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(677.629,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Oxetane) + radical(CCOJ)"""),
)

species(
    label = '[CH2]C(OC([O])CCCC)C(C)OO(14287)',
    structure = SMILES('[CH2]C(OC([O])CCCC)C(C)OO'),
    E0 = (-267.806,'kJ/mol'),
    modes = [
...
species(
    label = 'CCCCC([O])OC(O)CC(C)[O](14288)',
    structure = SMILES('CCCCC([O])OC(O)CC(C)[O]'),
    E0 = (-509.141,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (190.237,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.48288,0.154793,-0.000160932,1.01016e-07,-2.75782e-11,-61012.6,54.8676], Tmin=(100,'K'), Tmax=(861.413,'K')), NASAPolynomial(coeffs=[12.394,0.085714,-4.06451e-05,7.92588e-09,-5.62261e-13,-63575.7,-14.6858], Tmin=(861.413,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-509.141,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(715.045,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(CC(C)OJ)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['CCCCC([O])O[CH]CC(C)OO(13585)'],
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'CCCCC([O])OC=CC(C)OO(14262)'],
    products = ['CCCCC([O])O[CH]CC(C)OO(13585)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'CCCCC(=O)O[CH]CC(C)OO(14263)'],
    products = ['CCCCC([O])O[CH]CC(C)OO(13585)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['CH3CHOOH(63)', 'C=COC([O])CCCC(11991)'],
    products = ['CCCCC([O])O[CH]CC(C)OO(13585)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['butyl_1(82)', 'CC(C[CH]OC=O)OO(7442)'],
    products = ['CCCCC([O])O[CH]CC(C)OO(13585)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['CCCCC([O])OC[CH]C(C)OO(14264)'],
    products = ['CCCCC([O])O[CH]CC(C)OO(13585)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['CCCCC([O])O[CH]CC(C)OO(13585)'],
    products = ['CCCC[C](O)O[CH]CC(C)OO(14265)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['CCCC[C]([O])OCCC(C)OO(14266)'],
    products = ['CCCCC([O])O[CH]CC(C)OO(13585)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['CCCCC([O])OCC[C](C)OO(14267)'],
    products = ['CCCCC([O])O[CH]CC(C)OO(13585)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CCC[CH]C(O)O[CH]CC(C)OO(14268)'],
    products = ['CCCCC([O])O[CH]CC(C)OO(13585)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]C(CCOC([O])CCCC)OO(14269)'],
    products = ['CCCCC([O])O[CH]CC(C)OO(13585)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CC[CH]CC(O)O[CH]CC(C)OO(14270)'],
    products = ['CCCCC([O])O[CH]CC(C)OO(13585)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CCC[CH]C([O])OCCC(C)OO(14271)'],
    products = ['CCCCC([O])O[CH]CC(C)OO(13585)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CCCCC([O])O[CH]CC(C)OO(13585)'],
    products = ['CCCCC(O)O[CH][CH]C(C)OO(14272)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CCCCC([O])OCCC(C)O[O](14273)'],
    products = ['CCCCC([O])O[CH]CC(C)OO(13585)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CCCCC([O])O[CH]CC(C)OO(13585)'],
    products = ['C[CH]CCC(O)O[CH]CC(C)OO(14274)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CC[CH]CC([O])OCCC(C)OO(14275)'],
    products = ['CCCCC([O])O[CH]CC(C)OO(13585)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CCCCC([O])O[CH]CC(C)OO(13585)'],
    products = ['[CH2]CCCC(O)O[CH]CC(C)OO(14276)'],
...
reaction(
    label = 'reaction20',
    reactants = ['C[CH]CCC([O])OCCC(C)OO(14277)'],
    products = ['CCCCC([O])O[CH]CC(C)OO(13585)'],
...
reaction(
    label = 'reaction21',
    reactants = ['CCCCC([O])O[CH]CC(C)OO(13585)'],
    products = ['CCCCC(O)O[CH]C[C](C)OO(14278)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH2]CCCC([O])OCCC(C)OO(14279)'],
    products = ['CCCCC([O])O[CH]CC(C)OO(13585)'],
...
reaction(
    label = 'reaction23',
    reactants = ['CCCCC([O])O[CH]CC(C)OO(13585)'],
    products = ['[CH2]C(C[CH]OC(O)CCCC)OO(14280)'],
...
reaction(
    label = 'reaction24',
    reactants = ['CCCCC([O])O[CH]CC(C)OO(13585)'],
    products = ['CCCCC(O)O[CH]CC(C)O[O](14281)'],
...
reaction(
    label = 'reaction26',
    reactants = ['CCCCC([O])O[CH]CC(C)OO(13585)'],
    products = ['CCCCC(=O)OCCC(C)OO(14282)'],
...
reaction(
    label = 'reaction27',
    reactants = ['CCCCC([O])O[CH]CC(C)OO(13585)'],
    products = ['CCCCC(O)OC=CC(C)OO(14283)'],
...
reaction(
    label = 'reaction28',
    reactants = ['CH2(S)(23)', 'CCCCC([O])O[CH]CCOO(14284)'],
    products = ['CCCCC([O])O[CH]CC(C)OO(13585)'],
...
reaction(
    label = 'reaction29',
    reactants = ['CH2(S)(23)', 'CCCC([O])O[CH]CC(C)OO(14285)'],
    products = ['CCCCC([O])O[CH]CC(C)OO(13585)'],
...
reaction(
    label = 'reaction30',
    reactants = ['CCCCC([O])O[CH]CC(C)OO(13585)'],
    products = ['OH(5)', 'CCCCC([O])OC1CC(C)O1(14286)'],
...
reaction(
    label = 'reaction31',
    reactants = ['[CH2]C(OC([O])CCCC)C(C)OO(14287)'],
    products = ['CCCCC([O])O[CH]CC(C)OO(13585)'],
...
reaction(
    label = 'reaction33',
    reactants = ['CCCCC([O])O[CH]CC(C)OO(13585)'],
    products = ['CCCCC([O])OC(O)CC(C)[O](14288)'],
...
reaction(
    label = 'reaction34',
    reactants = ['[CH]CC(C)OO(1806)', 'CCCCC([O])[O](4945)'],
    products = ['CCCCC([O])O[CH]CC(C)OO(13585)'],
