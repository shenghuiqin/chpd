species(
    label = 'C#CCCO[O](28435)',
    structure = SMILES('C#CCCO[O]'),
    E0 = (213.264,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,750,770,3400,2100,492.5,1135,1000,2175,525,180],'cm^-1')),
        HinderedRotor(inertia=(0.431727,'amu*angstrom^2'), symmetry=1, barrier=(9.92625,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.432155,'amu*angstrom^2'), symmetry=1, barrier=(9.9361,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.80587,'amu*angstrom^2'), symmetry=1, barrier=(64.5124,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (85.0813,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.5455,0.0561735,-7.18532e-05,5.33713e-08,-1.59746e-11,25736,20.9557], Tmin=(100,'K'), Tmax=(887.199,'K')), NASAPolynomial(coeffs=[8.23737,0.0224599,-8.86337e-06,1.5381e-09,-1.00465e-13,24688,-9.742], Tmin=(887.199,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(213.264,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CtCsHH) + group(Cs-CsOsHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(ROOJ)"""),
)
...
species(
    ...
    molecularWeight = (85.0813,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.55867,0.0160363,5.60883e-05,-8.32062e-08,3.2375e-11,27350.7,19.8054], Tmin=(100,'K'), Tmax=(971.021,'K')), NASAPolynomial(coeffs=[11.8733,0.0169838,-6.11239e-06,1.19821e-09,-9.19227e-14,23688.1,-34.4029], Tmin=(971.021,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(226.858,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(257.749,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + ring(Cyclopentane) + radical(Cds_P)"""),
)

species(
    label = 'C#CC[CH]OO(29670)',
    ...
    molecularWeight = (85.0813,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.29989,0.0623084,-8.31935e-05,6.29134e-08,-1.92035e-11,30143.5,21.2292], Tmin=(100,'K'), Tmax=(836.124,'K')), NASAPolynomial(coeffs=[9.0455,0.0233625,-9.93215e-06,1.79499e-09,-1.20372e-13,28914.3,-14.3573], Tmin=(836.124,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(249.842,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CtCsHH) + group(Cs-CsOsHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(CCsJOOH)"""),
)

species(
    label = 'C#C[CH]COO(28433)',
    structure = SMILES('[CH]=C=CCOO'),
    E0 = (219.548,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,540,610,2055,3120,650,792.5,1650,3615,1310,387.5,850,1000,3010,987.5,1337.5,450,1655],'cm^-1')),
        HinderedRotor(inertia=(1.20831,'amu*angstrom^2'), symmetry=1, barrier=(27.7814,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.39744,'amu*angstrom^2'), symmetry=1, barrier=(55.122,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.75862,'amu*angstrom^2'), symmetry=1, barrier=(17.4422,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (85.0813,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.59623,0.0546398,-6.05617e-05,3.804e-08,-9.8251e-12,26490.6,21.803], Tmin=(100,'K'), Tmax=(933.629,'K')), NASAPolynomial(coeffs=[8.96628,0.0230634,-9.82929e-06,1.81353e-09,-1.24529e-13,25114.4,-13.247], Tmin=(933.629,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(219.548,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(C=C=CJ)"""),
)
...
species(
    ...
    E0 = (398.403,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3615,1310,387.5,850,1000,2175,525,180,2441.81],'cm^-1')),
        HinderedRotor(inertia=(0.630794,'amu*angstrom^2'), symmetry=1, barrier=(14.5032,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.93339,'amu*angstrom^2'), symmetry=1, barrier=(67.4445,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.93079,'amu*angstrom^2'), symmetry=1, barrier=(67.3846,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.92995,'amu*angstrom^2'), symmetry=1, barrier=(67.3652,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (85.0813,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.28666,0.0635204,-9.04695e-05,7.19155e-08,-2.24176e-11,48010.8,21.8678], Tmin=(100,'K'), Tmax=(907.2,'K')), NASAPolynomial(coeffs=[8.44262,0.0231956,-9.28936e-06,1.59973e-09,-1.03005e-13,47073.5,-9.96897], Tmin=(907.2,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(398.403,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsOsHH) + group(Cs-CtCsHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(Acetyl)"""),
)
...
species(
    label = '[C]1=COOCC1(29672)',
    structure = SMILES('[C]1=COOCC1'),
    E0 = (200.061,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (85.0813,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.30698,0.0251181,3.09882e-05,-6.14649e-08,2.68444e-11,24134,15.5917], Tmin=(100,'K'), Tmax=(920.24,'K')), NASAPolynomial(coeffs=[11.8253,0.0150371,-3.58627e-06,5.34139e-10,-3.72871e-14,21057.2,-36.7365], Tmin=(920.24,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(200.061,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(257.749,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + ring(34dihydro12dioxin) + radical(Cds_S)"""),
)
...
species(
    ...
    E0 = (215.459,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,750,770,3400,2100,2175,525,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.00283909,'amu*angstrom^2'), symmetry=1, barrier=(5.92559,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.73246,'amu*angstrom^2'), symmetry=1, barrier=(62.8247,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
reaction(
    label = 'reaction4',
    reactants = ['C#C[CH]COO(28433)'],
    products = ['C#CCCO[O](28435)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['H2CCCH(80)', '[CH2]O[O](92)'],
    products = ['C#CCCO[O](28435)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(5.83525e+09,'m^3/(mol*s)'), n=-0.923, Ea=(0.316832,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [C_rad/H2/Ct;C_pri_rad] for rate rule [C_rad/H2/Ct;C_rad/H2/O]
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]CO[O](98)', 'C2H(33)'],
    products = ['C#CCCO[O](28435)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(5.25602e+06,'m^3/(mol*s)'), n=0.135617, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Y_rad;C_rad/H2/Cs] for rate rule [Ct_rad/Ct;C_rad/H2/Cs]
Euclidian distance = 2.0
family: R_Recombination
Ea raised from -1.8 to 0 kJ/mol."""),
)
...
reaction(
    label = 'reaction9',
    reactants = ['H(3)', 'C#C[CH]CO[O](26532)'],
    products = ['C#CCCO[O](28435)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(1.59671e+07,'m^3/(mol*s)'), n=0.0113737, Ea=(2.96199,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [C_rad/H/OneDeC;H_rad] for rate rule [C_rad/H/CtCs;H_rad]
Euclidian distance = 1.0
family: R_Recombination"""),
)
...
reaction(
    label = 'reaction10',
    reactants = ['H(3)', 'C#CC[CH]O[O](28970)'],
    products = ['C#CCCO[O](28435)'],
