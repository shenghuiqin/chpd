...
species(
    label = 'C=[C]C(C)OC1CCC1[O](25863)',
    structure = SMILES('C=[C]C(C)OC1CCC1[O]'),
    E0 = (187.575,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (140.18,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.652316,0.0846894,-2.79129e-05,-2.28639e-08,1.39447e-11,22742.8,38.8741], Tmin=(100,'K'), Tmax=(1045.86,'K')), NASAPolynomial(coeffs=[20.4663,0.0403205,-1.64856e-05,3.13088e-09,-2.2392e-13,16334.5,-73.4757], Tmin=(1045.86,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(187.575,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(515.497,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Cyclobutane) + radical(Cds_S) + radical(CC(C)OJ)"""),
)
...
species(
    label = 'C=C=C(C)O[CH]CCC=O(25865)',
    structure = SMILES('C=C=C(C)O[CH]CCC=O'),
    E0 = (-23.1523,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([540,610,2055,3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,2950,3100,1380,975,1025,1650,350,440,435,1725,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2782.5,750,1395,475,1775,1000,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.24056,0.11772,-0.000128423,7.44679e-08,-1.74552e-11,-2597.82,36.3648], Tmin=(100,'K'), Tmax=(1029.73,'K')), NASAPolynomial(coeffs=[18.1002,0.0425917,-1.89854e-05,3.61637e-09,-2.5394e-13,-6581,-57.5098], Tmin=(1029.73,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-23.1523,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(482.239,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-OdCsH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(CCsJOC(O))"""),
)

species(
    label = 'C=[C]C(C)OC=CCC=O(25866)',
    structure = SMILES('C=[C]C(C)OC=CCC=O'),
    E0 = (-15.7107,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,2995,3025,975,1000,1300,1375,400,500,1630,1680,2750,2800,2850,1350,1500,750,1050,1375,1000,2950,3100,1380,975,1025,1650,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2782.5,750,1395,475,1775,1000,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (139.172,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.02512,0.0897175,-3.45523e-05,-2.52493e-08,1.67312e-11,-1690.5,39.0305], Tmin=(100,'K'), Tmax=(1028.89,'K')), NASAPolynomial(coeffs=[25.5661,0.0306154,-1.29378e-05,2.56998e-09,-1.90787e-13,-9505.98,-101.403], Tmin=(1028.89,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-15.7107,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(482.239,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-OdCsH) + group(Cds-CdsHH) + radical(Cds_S)"""),
)

species(
    label = 'C#CC(C)O[CH]CCC=O(25867)',
    structure = SMILES('C#CC(C)O[CH]CCC=O'),
    E0 = (9.91582,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,2175,525,1380,1390,370,380,2900,435,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2782.5,750,1395,475,1775,1000,750,770,3400,2100,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (139.172,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.04977,0.114378,-0.000126696,7.75549e-08,-1.93747e-11,1371.68,38.2349], Tmin=(100,'K'), Tmax=(966.207,'K')), NASAPolynomial(coeffs=[15.6154,0.0453854,-1.95874e-05,3.65185e-09,-2.52714e-13,-1848.72,-41.592], Tmin=(966.207,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(9.91582,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(478.082,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + group(Ct-CtCs) + group(Ct-CtH) + radical(CCsJOCs)"""),
)
...
species(
    label = 'C=C=CO[CH]CCC=O(25868)',
    structure = SMILES('C=C=CO[CH]CCC=O'),
    E0 = (18.6392,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([540,610,2055,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2782.5,750,1395,475,1775,1000,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.14169,0.105353,-0.000112004,5.96241e-08,-1.23943e-11,2433.51,33.9942], Tmin=(100,'K'), Tmax=(1179.14,'K')), NASAPolynomial(coeffs=[22.5883,0.0248523,-9.59614e-06,1.7233e-09,-1.17999e-13,-3162.57,-84.399], Tmin=(1179.14,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(18.6392,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cds-OdCsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(CCsJOC(O))"""),
)
...
species(
    label = 'C=[C]C(C)OC[CH]CC=O(25869)',
    structure = SMILES('C=[C]C(C)OC[CH]CC=O'),
    E0 = (101.254,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,2950,3100,1380,975,1025,1650,1380,1390,370,380,2900,435,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2782.5,750,1395,475,1775,1000,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (140.18,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.218497,0.0997185,-8.97426e-05,4.66588e-08,-1.05787e-11,12324.1,41.166], Tmin=(100,'K'), Tmax=(1016.58,'K')), NASAPolynomial(coeffs=[10.6924,0.0567862,-2.63939e-05,5.11476e-09,-3.62005e-13,10105.8,-11.6523], Tmin=(1016.58,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(101.254,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-OdCsH) + group(Cds-CdsHH) + radical(Cds_S) + radical(CCJCO)"""),
)
...
species(
    ...
    molecularWeight = (140.18,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.876451,0.109997,-0.000106081,5.59508e-08,-1.22391e-11,-348.995,37.2828], Tmin=(100,'K'), Tmax=(1083.55,'K')), NASAPolynomial(coeffs=[15.5913,0.0492049,-2.19242e-05,4.17225e-09,-2.92619e-13,-3917.73,-43.4862], Tmin=(1083.55,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-4.34301,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + group(Cds-OdCsH) + radical(Allyl_P) + radical(Cds_S)"""),
)
...
species(
    label = 'C=[C]C(C)OCC[CH]C=O(25871)',
    structure = SMILES('C=[C]C(C)OCCC=C[O]'),
    E0 = (44.6032,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (140.18,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.56144,0.107196,-9.08417e-05,3.89269e-08,-6.6165e-12,5577.35,43.1976], Tmin=(100,'K'), Tmax=(1416.47,'K')), NASAPolynomial(coeffs=[24.4422,0.0337638,-1.30798e-05,2.32815e-09,-1.5703e-13,-1789.38,-91.309], Tmin=(1416.47,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(44.6032,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C=COJ) + radical(Cds_S)"""),
)
...
species(
    ...
    molecularWeight = (140.18,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.63032,0.109503,-0.000118608,7.6699e-08,-2.12026e-11,7534.21,40.9726], Tmin=(100,'K'), Tmax=(858.925,'K')), NASAPolynomial(coeffs=[10.7158,0.0566649,-2.63359e-05,5.08227e-09,-3.58199e-13,5585.07,-12.0408], Tmin=(858.925,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(61.3121,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-OdCsH) + group(Cds-CdsHH) + radical(Cds_S) + radical(CCCJ=O)"""),
)
...
species(
    label = '[CH]=[C]C(C)OCCCC=O(25873)',
    structure = SMILES('[CH]=[C]C(C)OCCCC=O'),
    E0 = (148.448,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,2750,2800,2850,1350,1500,750,1050,1375,1000,1685,370,1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2782.5,750,1395,475,1775,1000,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (140.18,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.60952,0.109768,-0.000119044,7.8117e-08,-2.21169e-11,18012.8,40.485], Tmin=(100,'K'), Tmax=(836.316,'K')), NASAPolynomial(coeffs=[10.0235,0.0589121,-2.78319e-05,5.40899e-09,-3.82673e-13,16234.2,-8.91271], Tmin=(836.316,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(148.448,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-OdCsH) + group(Cds-CdsHH) + radical(Cds_P) + radical(Cds_S)"""),
)
...
species(
    label = 'C=[C]C(C)OC1CC[CH]O1(25874)',
    structure = SMILES('C=[C]C(C)OC1CC[CH]O1'),
    E0 = (69.9454,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (140.18,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.548466,0.0835496,-2.1051e-05,-3.7802e-08,2.28167e-11,8591.31,35.615], Tmin=(100,'K'), Tmax=(939.104,'K')), NASAPolynomial(coeffs=[20.0948,0.0366094,-1.15428e-05,1.92352e-09,-1.30961e-13,2906.7,-72.3028], Tmin=(939.104,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(69.9454,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(515.497,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Tetrahydrofuran) + radical(Cds_S) + radical(CCsJOCs)"""),
)
...
species(
    ...
    molecularWeight = (140.18,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.832151,0.107914,-0.000100394,5.05994e-08,-1.05648e-11,-25936,35.4196], Tmin=(100,'K'), Tmax=(1131.67,'K')), NASAPolynomial(coeffs=[16.028,0.0483197,-2.14032e-05,4.06544e-09,-2.84837e-13,-29752,-48.0063], Tmin=(1131.67,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-217.08,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-OdCsH) + group(Cds-CdsHH) + group(Cdd-CdsCds)"""),
)
...
species(
    label = 'C=[C]C(C)O[CH]CC(20821)',
    structure = SMILES('C=[C]C(C)O[CH]CC'),
    E0 = (188.387,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,3025,407.5,1350,352.5,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,2950,3100,1380,975,1025,1650,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.206279,0.0905068,-7.80428e-05,3.60273e-08,-6.8537e-12,22810.7,33.7748], Tmin=(100,'K'), Tmax=(1238.45,'K')), NASAPolynomial(coeffs=[15.4028,0.0400921,-1.69812e-05,3.15753e-09,-2.1846e-13,18944.5,-44.8682], Tmin=(1238.45,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(188.387,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CCsJOCs) + radical(Cds_S)"""),
)

species(
    label = 'C=C(C)[CH]O[CH]CCC=O(25877)',
    ...
    molecularWeight = (140.18,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.01265,0.123059,-0.000124309,6.38808e-08,-1.29308e-11,-5250.63,39.1046], Tmin=(100,'K'), Tmax=(1204.27,'K')), NASAPolynomial(coeffs=[24.8428,0.0338575,-1.32026e-05,2.37334e-09,-1.62139e-13,-11718.9,-95.4493], Tmin=(1204.27,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-45.5209,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsOsH) + group(Cds-OdCsH) + radical(Allyl_P) + radical(CCsJOC(O))"""),
)

species(
    label = '[CH2]C(CC=O)OC(C)[C]=C(25878)',
    structure = SMILES('[CH2]C(CC=O)OC(C)[C]=C'),
    E0 = (101.311,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,2750,2850,1437.5,1250,1305,750,350,2782.5,750,1395,475,1775,1000,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (140.18,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.988733,0.118055,-0.000139514,9.71343e-08,-2.84458e-11,12357.1,40.846], Tmin=(100,'K'), Tmax=(819.107,'K')), NASAPolynomial(coeffs=[11.6561,0.0563078,-2.64423e-05,5.10883e-09,-3.59619e-13,10285.5,-17.6354], Tmin=(819.107,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(101.311,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-OdCsH) + group(Cds-CdsHH) + radical(Cds_S) + radical(CJC(C)OC)"""),
)
...
species(
    label = 'C=[C]C(C)O[CH]COC=C(25880)',
    structure = SMILES('C=[C]C(C)O[CH]COC=C'),
    E0 = (123.404,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,2750,2800,2850,1350,1500,750,1050,1375,1000,2950,3000,3050,3100,1330,1430,900,1050,1000,1050,1600,1700,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,180,180,180,180,1549.69,1600,2933.33,3200],'cm^-1')),
        HinderedRotor(inertia=(0.14906,'amu*angstrom^2'), symmetry=1, barrier=(3.42719,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.14906,'amu*angstrom^2'), symmetry=1, barrier=(3.42719,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.14906,'amu*angstrom^2'), symmetry=1, barrier=(3.42719,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.14906,'amu*angstrom^2'), symmetry=1, barrier=(3.42719,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.14906,'amu*angstrom^2'), symmetry=1, barrier=(3.42719,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (140.18,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.11477,0.120427,-0.000110064,4.43365e-08,-5.04386e-12,15074.5,41.9483], Tmin=(100,'K'), Tmax=(1023.38,'K')), NASAPolynomial(coeffs=[27.1975,0.0292358,-1.06701e-05,1.91096e-09,-1.33049e-13,7850.72,-106.125], Tmin=(1023.38,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(123.404,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cds_S) + radical(CCsJOCs)"""),
)

species(
    label = 'C=[C]C(C)O[CH]CC=CO(25881)',
    structure = SMILES('C=[C]C(C)O[CH]CC=CO'),
    E0 = (83.5965,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1685,370,3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,2950,3100,1380,975,1025,1650,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (140.18,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.02176,0.118509,-0.000105568,3.85534e-08,-2.44683e-12,10283.5,42.8668], Tmin=(100,'K'), Tmax=(991.105,'K')), NASAPolynomial(coeffs=[27.1046,0.0280795,-9.75408e-06,1.71459e-09,-1.19068e-13,3177.98,-104.111], Tmin=(991.105,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(83.5965,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CCsJOCs) + radical(Cds_S)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['C=[C]C(C)O[CH]CCC=O(22008)'],
    products = ['C=[C]C(C)OC1CCC1[O](25863)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', 'C=C=C(C)O[CH]CCC=O(25865)'],
    products = ['C=[C]C(C)O[CH]CCC=O(22008)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)', 'C=[C]C(C)OC=CCC=O(25866)'],
    products = ['C=[C]C(C)O[CH]CCC=O(22008)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['H(3)', 'C#CC(C)O[CH]CCC=O(25867)'],
    products = ['C=[C]C(C)O[CH]CCC=O(22008)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['CH3(17)', 'C=C=CO[CH]CCC=O(25868)'],
    products = ['C=[C]C(C)O[CH]CCC=O(22008)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['CH2CHO(40)', 'C=[C]C(C)OC=C(24633)'],
    products = ['C=[C]C(C)O[CH]CCC=O(22008)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['C=[C]C(C)OC[CH]CC=O(25869)'],
    products = ['C=[C]C(C)O[CH]CCC=O(22008)'],
...
reaction(
    label = 'reaction13',
    reactants = ['C=[C]C(C)O[CH]CCC=O(22008)'],
    products = ['C=[C][C](C)OCCCC=O(25870)'],
...
reaction(
    label = 'reaction15',
    reactants = ['C=[C]C(C)O[CH]CCC=O(22008)'],
    products = ['C=[C]C(C)OCC[CH]C=O(25871)'],
...
reaction(
    label = 'reaction17',
    reactants = ['C=[C]C(C)O[CH]CCC=O(22008)'],
    products = ['C=[C]C(C)OCCC[C]=O(25872)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH]=[C]C(C)OCCCC=O(25873)'],
    products = ['C=[C]C(C)O[CH]CCC=O(22008)'],
...
reaction(
    label = 'reaction23',
    reactants = ['C=[C]C(C)O[CH]CCC=O(22008)'],
    products = ['C=[C]C(C)OC1CC[CH]O1(25874)'],
...
reaction(
    label = 'reaction25',
    reactants = ['C=[C]C(C)O[CH]CCC=O(22008)'],
    products = ['C=C=C(C)OCCCC=O(25875)'],
...
reaction(
    label = 'reaction28',
    reactants = ['CO(12)', 'C=[C]C(C)O[CH]CC(20821)'],
    products = ['C=[C]C(C)O[CH]CCC=O(22008)'],
...
reaction(
    label = 'reaction29',
    reactants = ['C=[C]C(C)O[CH]CCC=O(22008)'],
    products = ['C=C(C)[CH]O[CH]CCC=O(25877)'],
...
reaction(
    label = 'reaction30',
    reactants = ['[CH2]C(CC=O)OC(C)[C]=C(25878)'],
    products = ['C=[C]C(C)O[CH]CCC=O(22008)'],
...
reaction(
    label = 'reaction32',
    reactants = ['C=[C]C(C)O[CH]COC=C(25880)'],
    products = ['C=[C]C(C)O[CH]CCC=O(22008)'],
...
reaction(
    label = 'reaction33',
    reactants = ['C=[C]C(C)O[CH]CC=CO(25881)'],
    products = ['C=[C]C(C)O[CH]CCC=O(22008)'],
...
reaction(
    label = 'reaction34',
    reactants = ['C=[C]C(C)[O](3245)', '[CH]CCC=O(18484)'],
    products = ['C=[C]C(C)O[CH]CCC=O(22008)'],
...
reaction(
    label = 'reaction35',
    reactants = ['H2CC(41)', 'C[CH]O[CH]CCC=O(18470)'],
    products = ['C=[C]C(C)O[CH]CCC=O(22008)'],
