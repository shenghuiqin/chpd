...
species(
    label = 'CC=CC[CH]OO(15018)',
    structure = SMILES('CC=CC[CH]OO'),
    E0 = (47.7126,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2995,3025,975,1000,1300,1375,400,500,1630,1680,3025,407.5,1350,352.5,3615,1310,387.5,850,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,328.72,328.725],'cm^-1')),
        HinderedRotor(inertia=(0.352505,'amu*angstrom^2'), symmetry=1, barrier=(27.0303,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.103194,'amu*angstrom^2'), symmetry=1, barrier=(7.9125,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.103198,'amu*angstrom^2'), symmetry=1, barrier=(7.91268,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.103191,'amu*angstrom^2'), symmetry=1, barrier=(7.91245,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.831003,'amu*angstrom^2'), symmetry=1, barrier=(63.7222,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (101.124,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.06311,0.0696509,-6.24177e-05,3.3163e-08,-7.78816e-12,5840.02,26.0566], Tmin=(100,'K'), Tmax=(978.442,'K')), NASAPolynomial(coeffs=[7.96167,0.0414491,-1.91839e-05,3.70592e-09,-2.61775e-13,4490.03,-7.07471], Tmin=(978.442,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(47.7126,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(CCsJOOH)"""),
)

species(
    label = 'C[CH]CC=COO(15019)',
    structure = SMILES('C[CH]CC=COO'),
    E0 = (69.8464,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2995,3025,975,1000,1300,1375,400,500,1630,1680,3025,407.5,1350,352.5,3615,1310,387.5,850,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,238.574,4000],'cm^-1')),
        HinderedRotor(inertia=(0.352153,'amu*angstrom^2'), symmetry=1, barrier=(14.1234,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00296246,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.264726,'amu*angstrom^2'), symmetry=1, barrier=(10.6236,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.781372,'amu*angstrom^2'), symmetry=1, barrier=(31.4667,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.46401,'amu*angstrom^2'), symmetry=1, barrier=(98.9987,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (101.124,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.02773,0.0645737,-4.99624e-05,2.11131e-08,-3.76759e-12,8508.07,29.627], Tmin=(100,'K'), Tmax=(1288.78,'K')), NASAPolynomial(coeffs=[10.926,0.0338523,-1.42059e-05,2.61675e-09,-1.7962e-13,5956.75,-20.6374], Tmin=(1288.78,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(69.8464,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(RCCJC)"""),
)
...
species(
    label = '[CH2]CCC[CH]OO(15020)',
    structure = SMILES('[CH2]CCC[CH]OO'),
    E0 = (137.422,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (102.132,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.688153,0.0785579,-7.96469e-05,4.94855e-08,-1.34459e-11,16642.4,29.1577], Tmin=(100,'K'), Tmax=(863.96,'K')), NASAPolynomial(coeffs=[8.02392,0.0445956,-2.06839e-05,3.98874e-09,-2.81145e-13,15374.8,-5.16072], Tmin=(863.96,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(137.422,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(RCCJ) + radical(CCsJOOH)"""),
)
...
species(
    label = 'CCC[CH][CH]OO(5708)',
    structure = SMILES('CCC[CH][CH]OO'),
    E0 = (132.591,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3050,390,425,1340,1360,335,370,3615,1310,387.5,850,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (102.132,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.602705,0.0807483,-8.84139e-05,6.10159e-08,-1.83759e-11,16063.9,29.9806], Tmin=(100,'K'), Tmax=(786.729,'K')), NASAPolynomial(coeffs=[7.53202,0.0455173,-2.12416e-05,4.09483e-09,-2.88034e-13,14973.6,-1.78723], Tmin=(786.729,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(132.591,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCJCOOH) + radical(CCsJOOH)"""),
)
...
species(
    label = 'CCCC=COO(5711)',
    structure = SMILES('CCCC=COO'),
    E0 = (-124.6,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (102.132,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.413199,0.069153,-4.67384e-05,1.28883e-08,-4.08102e-13,-14848.6,29.1047], Tmin=(100,'K'), Tmax=(1147.04,'K')), NASAPolynomial(coeffs=[15.2582,0.0299351,-1.18646e-05,2.15817e-09,-1.48426e-13,-19079.8,-48.1495], Tmin=(1147.04,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-124.6,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH)"""),
)
...
species(
    ...
    molecularWeight = (102.132,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.00391,0.073312,-9.15286e-05,8.24874e-08,-3.14467e-11,-12887.7,32.0602], Tmin=(100,'K'), Tmax=(795.854,'K')), NASAPolynomial(coeffs=[2.83618,0.0507117,-2.36928e-05,4.52067e-09,-3.13778e-13,-12755.2,26.3033], Tmin=(795.854,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-107.991,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + radical(RCCJC) + radical(CCOJ)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'CC=CC[CH]OO(15018)'],
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'C[CH]CC=COO(15019)'],
    products = ['C[CH]CC[CH]OO(1473)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', 'C=CCC[CH]OO(11621)'],
    products = ['C[CH]CC[CH]OO(1473)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['OH(5)', 'C[CH]CCC=O(1233)'],
    products = ['C[CH]CC[CH]OO(1473)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2][CH]CCCOO(1474)'],
    products = ['C[CH]CC[CH]OO(1473)'],
    transitionState = 'TS14',
    kinetics = Arrhenius(A=(53044.5,'s^-1'), n=1.90573, Ea=(64.3238,'kJ/mol'), T0=(1,'K'), comment="""Estimated using average of templates [R5Hall;Y_rad_out;Cs_H_out_OOH/H] + [R5Hall;C_rad_out_2H;Cs_H_out] for rate rule [R5HJ_1;C_rad_out_2H;Cs_H_out_OOH/H]
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2]C(C)C[CH]OO(13435)'],
    products = ['C[CH]CC[CH]OO(1473)'],
...
reaction(
    label = 'reaction24',
    reactants = ['CHCH3(T)(95)', '[CH2]C[CH]OO(468)'],
    products = ['C[CH]CC[CH]OO(1473)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[CH2]C[CH]C(129)', '[CH]OO(168)'],
    products = ['C[CH]CC[CH]OO(1473)'],
