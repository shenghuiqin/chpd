...
reaction(
    label = 'reaction1',
    reactants = ['OH(5)', 'CCCCCCC[O](663)'],
    products = ['CCCCCCCOO(1465)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]CCCCCC(89)', 'HO2(10)'],
    products = ['CCCCCCCOO(1465)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['npropyl(83)', '[CH2]CCCOO(268)'],
    products = ['CCCCCCCOO(1465)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[CH2]CCCCOO(278)', 'C2H5(29)'],
    products = ['CCCCCCCOO(1465)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(8.73e+14,'cm^3/(mol*s)'), n=-0.699, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(200,'K'), Tmax=(2000,'K'), comment="""From training reaction 11 used for C_rad/H2/Cs;C_rad/H2/Cs
Exact match found for rate rule [C_rad/H2/Cs;C_rad/H2/Cs]
...
reaction(
    label = 'reaction6',
    reactants = ['H(3)', 'CC[CH]CCCCOO(654)'],
    products = ['CCCCCCCOO(1465)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['QOOH_1(290)', 'butyl_1(82)'],
    products = ['CCCCCCCOO(1465)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(8.73e+14,'cm^3/(mol*s)'), n=-0.699, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(200,'K'), Tmax=(2000,'K'), comment="""From training reaction 11 used for C_rad/H2/Cs;C_rad/H2/Cs
Exact match found for rate rule [C_rad/H2/Cs;C_rad/H2/Cs]
...
reaction(
    label = 'reaction8',
    reactants = ['H(3)', 'CCC[CH]CCCOO(653)'],
    products = ['CCCCCCCOO(1465)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(2e+13,'cm^3/(mol*s)','*|/',3.16), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), comment="""From training reaction 59 used for H_rad;C_rad/H/NonDeC
Exact match found for rate rule [C_rad/H/NonDeC;H_rad]
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]CCCC(84)', 'CH2CH2OOH(45)'],
    products = ['CCCCCCCOO(1465)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(8.73e+14,'cm^3/(mol*s)'), n=-0.699, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(200,'K'), Tmax=(2000,'K'), comment="""From training reaction 11 used for C_rad/H2/Cs;C_rad/H2/Cs
Exact match found for rate rule [C_rad/H2/Cs;C_rad/H2/Cs]
...
reaction(
    label = 'reaction10',
    reactants = ['H(3)', 'CCCC[CH]CCOO(652)'],
    products = ['CCCCCCCOO(1465)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]CCCCC(87)', 'CH2OOH(35)'],
    products = ['CCCCCCCOO(1465)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(3)', 'CCCCC[CH]COO(651)'],
    products = ['CCCCCCCOO(1465)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CH3(17)', '[CH2]CCCCCOO(575)'],
    products = ['CCCCCCCOO(1465)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(3)', 'C[CH]CCCCCOO(655)'],
    products = ['CCCCCCCOO(1465)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(3)', 'CCCCCC[CH]OO(650)'],
    products = ['CCCCCCCOO(1465)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(3)', '[CH2]CCCCCCOO(2968)'],
    products = ['CCCCCCCOO(1465)'],
...
network(
    ...
    reactants = [
        ('[CH2]CCCCCC(89)', 'HO2(10)'),
        ('H(3)', 'CCCCCCCO[O](513)'),
        ('QOOH_1(290)', 'butyl_1(82)'),
        ('[CH2]CCCC(84)', 'CH2CH2OOH(45)'),
        ('[CH2]CCCCC(87)', 'CH2OOH(35)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
