...
species(
    label = 'CC[C](O)C([O])CC(11180)',
    structure = SMILES('CC[C](O)C([O])CC'),
    E0 = (-129.817,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (116.158,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0805867,0.0936194,-9.2294e-05,5.24486e-08,-1.25765e-11,-15469.6,32.7019], Tmin=(100,'K'), Tmax=(987.613,'K')), NASAPolynomial(coeffs=[11.6312,0.0461847,-2.02494e-05,3.81642e-09,-2.65954e-13,-17783,-23.6546], Tmin=(987.613,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-129.817,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(C2CsJOH)"""),
)

species(
    label = 'CC[C]([O])C(O)CC(11181)',
    structure = SMILES('CC[C]([O])C(O)CC'),
    E0 = (-129.817,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
species(
    label = 'C[CH]C(O)C([O])CC(11182)',
    structure = SMILES('C[CH]C(O)C([O])CC'),
    E0 = (-106.543,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3025,407.5,1350,352.5,3615,1277.5,1000,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (116.158,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.227337,0.0856144,-6.76981e-05,2.81884e-08,-4.78898e-12,-12656,36.2909], Tmin=(100,'K'), Tmax=(1386.96,'K')), NASAPolynomial(coeffs=[16.8446,0.0363783,-1.44485e-05,2.59275e-09,-1.75305e-13,-17391.5,-51.6556], Tmin=(1386.96,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-106.543,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(CCJCO)"""),
)

species(
    label = 'C[CH]C([O])C(O)CC(11183)',
    structure = SMILES('C[CH]C([O])C(O)CC'),
    E0 = (-106.543,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
species(
    ...
    molecularWeight = (116.158,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.05728,0.0877736,-7.38944e-05,3.37776e-08,-6.41845e-12,-12024.2,34.9667], Tmin=(100,'K'), Tmax=(1233.1,'K')), NASAPolynomial(coeffs=[14.2705,0.0412964,-1.73576e-05,3.21154e-09,-2.21469e-13,-15557.7,-37.1589], Tmin=(1233.1,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-101.198,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(RCCJ)"""),
)

species(
    label = '[CH2]CC([O])C(O)CC(11185)',
    structure = SMILES('[CH2]CC([O])C(O)CC'),
    E0 = (-101.198,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (116.158,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0572768,0.0877736,-7.38943e-05,3.37776e-08,-6.41843e-12,-12024.2,34.9667], Tmin=(100,'K'), Tmax=(1233.11,'K')), NASAPolynomial(coeffs=[14.2706,0.0412964,-1.73575e-05,3.21154e-09,-2.21469e-13,-15557.7,-37.159], Tmin=(1233.11,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-101.198,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJ) + radical(CC(C)OJ)"""),
)

species(
    label = 'CCC(=O)C(O)CC(11186)',
    structure = SMILES('CCC(=O)C(O)CC'),
    E0 = (-477.273,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (116.158,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.219287,0.0798192,-5.74556e-05,2.15686e-08,-3.36518e-12,-57264.3,32.9407], Tmin=(100,'K'), Tmax=(1463.58,'K')), NASAPolynomial(coeffs=[14.6854,0.0402827,-1.69351e-05,3.11127e-09,-2.1239e-13,-61498.7,-42.3598], Tmin=(1463.58,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-477.273,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-O2d)CsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdCsCs)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'CCC(=O)C([O])CC(11179)'],
    products = ['CCC([O])C([O])CC(10740)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['C2H5(29)', 'CCC([O])C=O(10833)'],
    products = ['CCC([O])C([O])CC(10740)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['C[CH]C(O)C([O])CC(11182)'],
    products = ['CCC([O])C([O])CC(10740)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['CCC([O])C([O])CC(10740)'],
    products = ['C[CH]C([O])C(O)CC(11183)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]CC(O)C([O])CC(11184)'],
    products = ['CCC([O])C([O])CC(10740)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['CCC([O])C([O])CC(10740)'],
    products = ['[CH2]CC([O])C(O)CC(11185)'],
    transitionState = 'TS10',
    kinetics = Arrhenius(A=(2.4e+11,'s^-1'), n=0, Ea=(31.8402,'kJ/mol'), T0=(1,'K'), Tmin=(200,'K'), Tmax=(1000,'K'), comment="""From training reaction 306 used for R5H_CCC;O_rad_out;Cs_H_out_2H
...
reaction(
    label = 'reaction13',
    reactants = ['CH2(S)(23)', 'CCC([O])C(C)[O](11101)'],
    products = ['CCC([O])C([O])CC(10740)'],
...
reaction(
    label = 'reaction15',
    reactants = ['O(4)', 'CC[CH]C([O])CC(10624)'],
    products = ['CCC([O])C([O])CC(10740)'],
