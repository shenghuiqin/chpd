...
species(
    label = '[CH]=C(O)C=C=O(8517)',
    structure = SMILES('[CH]=C(O)C=C=O'),
    E0 = (53.7651,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,440,435,1725,2120,512.5,787.5,3120,650,792.5,1650,3615,1277.5,1000,3010,987.5,1337.5,450,1655],'cm^-1')),
        HinderedRotor(inertia=(0.965364,'amu*angstrom^2'), symmetry=1, barrier=(22.1956,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.969686,'amu*angstrom^2'), symmetry=1, barrier=(22.295,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (83.0654,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.32208,0.0550801,-6.40228e-05,3.29541e-08,-5.46365e-12,6566.43,19.0929], Tmin=(100,'K'), Tmax=(915.983,'K')), NASAPolynomial(coeffs=[14.9904,0.00612363,-1.42649e-06,1.86153e-10,-1.12246e-14,3612.23,-48.1068], Tmin=(915.983,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(53.7651,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cds-Cds(Cds-Cds)O2s) + group(Cds-(Cdd-O2d)CsH) + group(Cds-CdsHH) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', '[CH]=C(O)C=C=O(8517)'],
    products = ['[CH]=C(O)C[C]=O(1113)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction14',
    reactants = ['CO(12)', '[CH]=C([CH2])O(6276)'],
    products = ['[CH]=C(O)C[C]=O(1113)'],
    transitionState = 'TS14',
    kinetics = Arrhenius(A=(1230.59,'m^3/(mol*s)'), n=1.0523, Ea=(34.2057,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [COm;C_pri_rad] for rate rule [COm;C_rad/H2/Cd]
Euclidian distance = 1.0
...
reaction(
    label = 'reaction15',
    reactants = ['[C]=O(361)', '[CH]=C([CH2])O(6276)'],
    products = ['[CH]=C(O)C[C]=O(1113)'],
