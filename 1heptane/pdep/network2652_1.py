...
species(
    label = 'C=C(C[CH]O)CC(C)OO(16081)',
    structure = SMILES('C=C(C[CH]O)CC(C)OO'),
    E0 = (-182.498,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (145.176,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.37456,0.123609,-0.000134966,8.19223e-08,-2.05019e-11,-21760.4,40.6753], Tmin=(100,'K'), Tmax=(958.861,'K')), NASAPolynomial(coeffs=[15.6881,0.0524283,-2.36119e-05,4.49992e-09,-3.15404e-13,-25032.4,-40.925], Tmin=(958.861,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-182.498,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(523.812,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(CCsJOH)"""),
)

species(
    label = '[CH2]C(C=CO)CC(C)OO(16082)',
    structure = SMILES('[CH2]C(C=CO)CC(C)OO'),
    E0 = (-200.51,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (145.176,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.97618,0.11709,-9.36462e-05,2.5195e-08,2.60225e-12,-23887.7,42.7762], Tmin=(100,'K'), Tmax=(965.434,'K')), NASAPolynomial(coeffs=[26.1534,0.0321344,-1.07337e-05,1.83489e-09,-1.25523e-13,-30791.4,-99.5681], Tmin=(965.434,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-200.51,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(523.812,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-(Cds-Cd)H) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(Isobutyl)"""),
)
...
species(
    label = '[CH2]C(CC[O])CC(C)OO(16083)',
    structure = SMILES('[CH2]C(CC[O])CC(C)OO'),
    E0 = (-47.9973,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (146.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.09246,0.119951,-0.000133865,9.34838e-08,-2.81232e-11,-5596.57,42.8241], Tmin=(100,'K'), Tmax=(792.298,'K')), NASAPolynomial(coeffs=[9.8393,0.0647652,-2.93919e-05,5.58296e-09,-3.89062e-13,-7328.93,-7.3709], Tmin=(792.298,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-47.9973,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(548.755,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Isobutyl) + radical(CCOJ)"""),
)

species(
    label = 'C[C](C[CH]O)CC(C)OO(16084)',
    structure = SMILES('C[C](C[CH]O)CC(C)OO'),
    E0 = (-113.064,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (146.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.83651,0.139645,-0.000197591,1.66706e-07,-5.71988e-11,-13399.2,43.5151], Tmin=(100,'K'), Tmax=(810.628,'K')), NASAPolynomial(coeffs=[10.3539,0.06427,-2.99479e-05,5.66926e-09,-3.90411e-13,-14875.4,-9.65231], Tmin=(810.628,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-113.064,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(544.598,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Tertalkyl) + radical(CCsJOH)"""),
)

species(
    label = '[CH2]C([CH]CO)CC(C)OO(16085)',
    structure = SMILES('[CH2]C([CH]CO)CC(C)OO'),
    E0 = (-73.8004,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1277.5,1000,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3100,440,815,1455,1000,3615,1310,387.5,850,1000,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (146.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.28734,0.117997,-0.000115567,6.32659e-08,-1.43413e-11,-8687.11,45.1464], Tmin=(100,'K'), Tmax=(1051.86,'K')), NASAPolynomial(coeffs=[15.92,0.0525616,-2.22531e-05,4.12395e-09,-2.84834e-13,-12307.1,-38.7392], Tmin=(1051.86,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-73.8004,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(544.598,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Isobutyl) + radical(CCJCO)"""),
)

species(
    label = 'CC([CH]C(C)OO)C[CH]O(16086)',
    structure = SMILES('CC([CH]C(C)OO)C[CH]O'),
    E0 = (-98.072,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (146.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.57329,0.130063,-0.000150081,9.92908e-08,-2.72846e-11,-11601.2,43.7639], Tmin=(100,'K'), Tmax=(875.004,'K')), NASAPolynomial(coeffs=[14.2124,0.0578977,-2.63657e-05,5.02841e-09,-3.51728e-13,-14363.6,-30.2847], Tmin=(875.004,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-98.072,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(544.598,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCsJOH) + radical(CCJCOOH)"""),
)

species(
    label = 'CC([CH][CH]O)CC(C)OO(16087)',
    structure = SMILES('CC([CH][CH]O)CC(C)OO'),
    E0 = (-98.5849,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (146.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.39137,0.1228,-0.000126012,7.18838e-08,-1.69853e-11,-11666.3,43.294], Tmin=(100,'K'), Tmax=(1009.97,'K')), NASAPolynomial(coeffs=[15.9502,0.0541182,-2.40061e-05,4.55118e-09,-3.18352e-13,-15169.2,-40.5412], Tmin=(1009.97,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-98.5849,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(544.598,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJCO) + radical(CCsJOH)"""),
)

species(
    label = '[CH2][C](CCO)CC(C)OO(16088)',
    structure = SMILES('[CH2][C](CCO)CC(C)OO'),
    E0 = (-88.2798,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (146.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.60804,0.133258,-0.000181025,1.49232e-07,-5.0317e-11,-10425.2,44.9287], Tmin=(100,'K'), Tmax=(819.978,'K')), NASAPolynomial(coeffs=[9.98344,0.0633089,-2.85454e-05,5.32606e-09,-3.63941e-13,-11875.5,-5.94504], Tmin=(819.978,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-88.2798,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(544.598,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Isobutyl) + radical(Tertalkyl)"""),
)

species(
    label = '[CH2]C([CH]C(C)OO)CCO(16089)',
    structure = SMILES('[CH2]C([CH]C(C)OO)CCO'),
    E0 = (-73.2875,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1277.5,1000,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3100,440,815,1455,1000,3615,1310,387.5,850,1000,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (146.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.40167,0.124443,-0.000136692,8.67344e-08,-2.29048e-11,-8624.8,45.3754], Tmin=(100,'K'), Tmax=(908.792,'K')), NASAPolynomial(coeffs=[14.0019,0.0566441,-2.47856e-05,4.6417e-09,-3.21547e-13,-11424.5,-27.4646], Tmin=(908.792,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-73.2875,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(544.598,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJCOOH) + radical(Isobutyl)"""),
)

species(
    label = 'C[C](CC(C)C[CH]O)OO(16090)',
    structure = SMILES('C[C](CC(C)C[CH]O)OO'),
    E0 = (-111.588,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (146.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.62373,0.132603,-0.000167082,1.26293e-07,-3.99407e-11,-13226.7,41.925], Tmin=(100,'K'), Tmax=(763.729,'K')), NASAPolynomial(coeffs=[11.8234,0.0621584,-2.86942e-05,5.46645e-09,-3.80397e-13,-15280.2,-19.3223], Tmin=(763.729,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-111.588,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(544.598,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(C2CsJOOH) + radical(CCsJOH)"""),
)

species(
    label = '[CH2]C(CCO)C[C](C)OO(16091)',
    structure = SMILES('[CH2]C(CCO)C[C](C)OO'),
    E0 = (-86.8033,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1277.5,1000,3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3000,3100,440,815,1455,1000,360,370,350,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (146.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.39749,0.126253,-0.000150693,1.09121e-07,-3.32167e-11,-10252.6,43.346], Tmin=(100,'K'), Tmax=(791.244,'K')), NASAPolynomial(coeffs=[11.4807,0.0611454,-2.72596e-05,5.11528e-09,-3.53241e-13,-12290.4,-15.7675], Tmin=(791.244,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-86.8033,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(544.598,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Isobutyl) + radical(C2CsJOOH)"""),
)

species(
    label = '[CH2]C(CC(C)C[CH]O)OO(16092)',
    structure = SMILES('[CH2]C(CC(C)C[CH]O)OO'),
    E0 = (-84.5244,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1277.5,1000,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3100,440,815,1455,1000,3615,1310,387.5,850,1000,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (146.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.66815,0.130847,-0.00014782,9.35276e-08,-2.43678e-11,-9967.08,43.792], Tmin=(100,'K'), Tmax=(923.808,'K')), NASAPolynomial(coeffs=[15.8396,0.0550386,-2.47278e-05,4.69713e-09,-3.28256e-13,-13201.8,-39.2852], Tmin=(923.808,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-84.5244,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(544.598,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCsJOH) + radical(CJCOOH)"""),
)

species(
    label = 'CC(C[CH][O])CC(C)OO(16093)',
    structure = SMILES('CC(C[CH][O])CC(C)OO'),
    E0 = (-72.7818,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (146.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.32539,0.126382,-0.000150535,1.11036e-07,-3.50217e-11,-8570.35,41.4271], Tmin=(100,'K'), Tmax=(759.381,'K')), NASAPolynomial(coeffs=[10.1758,0.0657914,-3.08352e-05,5.9364e-09,-4.16422e-13,-10316.9,-10.8921], Tmin=(759.381,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-72.7818,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(548.755,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(CCsJOH)"""),
)

species(
    label = 'CC(C[CH]O)CC(C)O[O](16094)',
    structure = SMILES('CC(C[CH]O)CC(C)O[O]'),
    E0 = (-146.482,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (146.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.38975,0.125148,-0.000141584,9.32852e-08,-2.56242e-11,-17429.4,41.5556], Tmin=(100,'K'), Tmax=(874.646,'K')), NASAPolynomial(coeffs=[13.4111,0.0574597,-2.54997e-05,4.8042e-09,-3.33678e-13,-20018.5,-27.8677], Tmin=(874.646,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-146.482,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(548.755,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(CCsJOH)"""),
)

species(
    label = '[CH2]C(CCO)CC([CH2])OO(16095)',
    structure = SMILES('[CH2]C(CCO)CC([CH2])OO'),
    E0 = (-59.7399,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (146.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.52293,0.125552,-0.000135632,8.26268e-08,-2.07416e-11,-6989.6,45.4972], Tmin=(100,'K'), Tmax=(957.831,'K')), NASAPolynomial(coeffs=[15.6848,0.05369,-2.30929e-05,4.29746e-09,-2.97002e-13,-10286,-36.7786], Tmin=(957.831,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-59.7399,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(544.598,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Isobutyl) + radical(CJCOOH)"""),
)

species(
    label = '[CH2]C(CCO)CC(C)O[O](16096)',
    structure = SMILES('[CH2]C(CCO)CC(C)O[O]'),
    E0 = (-121.698,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,492.5,1135,1000,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (146.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.22042,0.119554,-0.000128276,8.08269e-08,-2.12838e-11,-14453,43.1754], Tmin=(100,'K'), Tmax=(910.482,'K')), NASAPolynomial(coeffs=[13.1971,0.0562133,-2.39242e-05,4.41867e-09,-3.03602e-13,-17078.3,-25.0286], Tmin=(910.482,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-121.698,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(548.755,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Isobutyl) + radical(ROOJ)"""),
)

species(
    label = 'C=C(CCO)CC(C)OO(16097)',
    structure = SMILES('C=C(CCO)CC(C)OO'),
    E0 = (-362.795,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (146.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.14042,0.115449,-0.000106468,5.39058e-08,-1.13852e-11,-43451.1,40.2738], Tmin=(100,'K'), Tmax=(1115.52,'K')), NASAPolynomial(coeffs=[16.0006,0.053985,-2.38194e-05,4.51231e-09,-3.15594e-13,-47275.3,-44.2956], Tmin=(1115.52,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-362.795,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(548.755,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH)"""),
)

species(
    label = 'CC(C=CO)CC(C)OO(16098)',
    structure = SMILES('CC(C=CO)CC(C)OO'),
    E0 = (-405.592,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (146.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.0262,0.115777,-8.24164e-05,1.43096e-08,5.53611e-12,-48549.7,41.1744], Tmin=(100,'K'), Tmax=(994.849,'K')), NASAPolynomial(coeffs=[26.5637,0.0351706,-1.26666e-05,2.27103e-09,-1.59139e-13,-55937.9,-105.15], Tmin=(994.849,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-405.592,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(548.755,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-(Cds-Cd)H) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH)"""),
)

species(
    label = 'CC(CC=O)CC(C)OO(16099)',
    ...
    molecularWeight = (146.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.678506,0.109106,-9.48592e-05,4.68907e-08,-1.00378e-11,-48559.5,38.0175], Tmin=(100,'K'), Tmax=(1074.72,'K')), NASAPolynomial(coeffs=[12.2093,0.0611387,-2.79117e-05,5.36234e-09,-3.7763e-13,-51329.7,-25.0876], Tmin=(1074.72,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-405.104,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(548.755,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdCsH)"""),
)
...
species(
    label = '[CH2]C(C[CH]O)CCOO(16100)',
    structure = SMILES('[CH2]C(C[CH]O)CCOO'),
    E0 = (-56.9814,'kJ/mol'),
    modes = [
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.18237,0.120281,-0.000155772,1.16114e-07,-3.53499e-11,-6672.53,39.9226], Tmin=(100,'K'), Tmax=(799.483,'K')), NASAPolynomial(coeffs=[13.1503,0.0485709,-2.123e-05,3.92312e-09,-2.67622e-13,-8964.28,-26.0168], Tmin=(799.483,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-56.9814,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(473.925,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCsJOH) + radical(Isobutyl)"""),
)
...
species(
    label = 'CC1CC(C[CH]O)CO1(16101)',
    structure = SMILES('CC1CC(C[CH]O)CO1'),
    E0 = (-271.117,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (129.177,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.110475,0.0766915,-1.409e-05,-3.93574e-08,2.27897e-11,-32447.1,29.9391], Tmin=(100,'K'), Tmax=(916.788,'K')), NASAPolynomial(coeffs=[16.6399,0.0395382,-1.20879e-05,1.93471e-09,-1.27287e-13,-37028.4,-57.6516], Tmin=(916.788,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-271.117,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(515.497,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Tetrahydrofuran) + radical(CCsJOH)"""),
)

species(
    label = '[CH2]C1CC(C)OC(O)C1(16102)',
    structure = SMILES('[CH2]C1CC(C)OC(O)C1'),
    E0 = (-308.556,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (129.177,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.270279,0.0625986,3.21653e-05,-9.04047e-08,4.17929e-11,-36958.4,29.6206], Tmin=(100,'K'), Tmax=(912.857,'K')), NASAPolynomial(coeffs=[17.5915,0.0375443,-1.02134e-05,1.56061e-09,-1.03378e-13,-42239.2,-63.9688], Tmin=(912.857,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-308.556,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(519.654,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Oxane) + radical(Isobutyl)"""),
)

species(
    label = 'CC(CC[CH]C[CH]O)OO(16060)',
    structure = SMILES('CC(CC[CH]C[CH]O)OO'),
    E0 = (-101.681,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (146.184,'amu'),
...
species(
    label = 'CC([O])CC(CO)C[CH]O(16103)',
    structure = SMILES('CC([O])CC(CO)C[CH]O'),
    E0 = (-299.459,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (146.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.52748,0.127438,-0.000144919,9.38023e-08,-2.50497e-11,-35822.6,43.0388], Tmin=(100,'K'), Tmax=(902.327,'K')), NASAPolynomial(coeffs=[14.8701,0.0547471,-2.40807e-05,4.52284e-09,-3.13784e-13,-38781.8,-34.3847], Tmin=(902.327,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-299.459,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(548.755,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(CCsJOH)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(C[CH]O)CC(C)OO(13296)'],
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', '[CH2]C(CC=O)CC(C)OO(16080)'],
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'C=C(C[CH]O)CC(C)OO(16081)'],
    products = ['[CH2]C(C[CH]O)CC(C)OO(13296)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', '[CH2]C(C=CO)CC(C)OO(16082)'],
    products = ['[CH2]C(C[CH]O)CC(C)OO(13296)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['QOOH_3(717)', 'C=CC[CH]O(2463)'],
    products = ['[CH2]C(C[CH]O)CC(C)OO(13296)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]C(CC[O])CC(C)OO(16083)'],
    products = ['[CH2]C(C[CH]O)CC(C)OO(13296)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]C(C[CH]O)CC(C)OO(13296)'],
    products = ['C[C](C[CH]O)CC(C)OO(16084)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]C([CH]CO)CC(C)OO(16085)'],
    products = ['[CH2]C(C[CH]O)CC(C)OO(13296)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]C(C[CH]O)CC(C)OO(13296)'],
    products = ['CC([CH]C(C)OO)C[CH]O(16086)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]C(C[CH]O)CC(C)OO(13296)'],
    products = ['CC([CH][CH]O)CC(C)OO(16087)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2][C](CCO)CC(C)OO(16088)'],
    products = ['[CH2]C(C[CH]O)CC(C)OO(13296)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]C([CH]C(C)OO)CCO(16089)'],
    products = ['[CH2]C(C[CH]O)CC(C)OO(13296)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]C(C[CH]O)CC(C)OO(13296)'],
    products = ['C[C](CC(C)C[CH]O)OO(16090)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]C(CCO)C[C](C)OO(16091)'],
    products = ['[CH2]C(C[CH]O)CC(C)OO(13296)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]C(CC(C)C[CH]O)OO(16092)'],
    products = ['[CH2]C(C[CH]O)CC(C)OO(13296)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CC(C[CH][O])CC(C)OO(16093)'],
    products = ['[CH2]C(C[CH]O)CC(C)OO(13296)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2]C(C[CH]O)CC(C)OO(13296)'],
    products = ['CC(C[CH]O)CC(C)O[O](16094)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2]C(CCO)CC([CH2])OO(16095)'],
    products = ['[CH2]C(C[CH]O)CC(C)OO(13296)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH2]C(CCO)CC(C)O[O](16096)'],
    products = ['[CH2]C(C[CH]O)CC(C)OO(13296)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH2]C(C[CH]O)CC(C)OO(13296)'],
    products = ['C=C(CCO)CC(C)OO(16097)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[CH2]C(C[CH]O)CC(C)OO(13296)'],
    products = ['CC(C=CO)CC(C)OO(16098)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[CH2]C(C[CH]O)CC(C)OO(13296)'],
    products = ['CC(CC=O)CC(C)OO(16099)'],
...
reaction(
    label = 'reaction26',
    reactants = ['CH2(S)(23)', '[CH2]C(C[CH]O)CCOO(16100)'],
    products = ['[CH2]C(C[CH]O)CC(C)OO(13296)'],
...
reaction(
    label = 'reaction27',
    reactants = ['[CH2]C(C[CH]O)CC(C)OO(13296)'],
    products = ['OH(5)', 'CC1CC(C[CH]O)CO1(16101)'],
...
reaction(
    label = 'reaction28',
    reactants = ['[CH2]C(C[CH]O)CC(C)OO(13296)'],
    products = ['OH(5)', '[CH2]C1CC(C)OC(O)C1(16102)'],
...
reaction(
    label = 'reaction29',
    reactants = ['[CH2]C(C[CH]O)CC(C)OO(13296)'],
    products = ['CC(CC[CH]C[CH]O)OO(16060)'],
...
reaction(
    label = 'reaction33',
    reactants = ['[CH2]C(C[CH]O)CC(C)OO(13296)'],
    products = ['CC([O])CC(CO)C[CH]O(16103)'],
...
reaction(
    label = 'reaction35',
    reactants = ['HCOH(T)(285)', '[CH2]C([CH2])CC(C)OO(5408)'],
    products = ['[CH2]C(C[CH]O)CC(C)OO(13296)'],
