...
species(
    label = 'C=CC#CC[O](26909)',
    structure = SMILES('C=CC#CC[O]'),
    E0 = (301.096,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2100,2250,500,550,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,289.868,289.874,1558.19],'cm^-1')),
        HinderedRotor(inertia=(1.26251,'amu*angstrom^2'), symmetry=1, barrier=(75.2748,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.26247,'amu*angstrom^2'), symmetry=1, barrier=(75.275,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (81.0926,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.18014,0.0368866,-2.10017e-05,5.98914e-09,-7.03011e-13,36281.3,21.465], Tmin=(100,'K'), Tmax=(1877.48,'K')), NASAPolynomial(coeffs=[9.80727,0.0206369,-8.01905e-06,1.37916e-09,-8.9157e-14,33417.4,-20.136], Tmin=(1877.48,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(301.096,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CtOsHH) + group(Cds-CdsCtH) + group(Cds-CdsHH) + group(Ct-CtCs) + group(Ct-Ct(Cds-Cds)) + radical(CCOJ)"""),
)

species(
    label = 'C=C=C=CC[O](26910)',
    structure = SMILES('C=C=C=CC[O]'),
    E0 = (359.85,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,540,563.333,586.667,610,1970,2140,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.519669,'amu*angstrom^2'), symmetry=1, barrier=(11.9482,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (81.0926,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.98025,0.0497148,-6.59999e-05,6.06429e-08,-2.32304e-11,43347.6,20.7489], Tmin=(100,'K'), Tmax=(791.501,'K')), NASAPolynomial(coeffs=[3.4442,0.0327521,-1.57274e-05,3.03228e-09,-2.11525e-13,43415.5,15.9211], Tmin=(791.501,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(359.85,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(253.591,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + group(Cdd-CdsCds) + radical(CCOJ)"""),
)
...
species(
    label = 'C=C[C]=[C]CO(26914)',
    structure = SMILES('[CH2][CH]C#CCO'),
    E0 = (305.721,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (82.1005,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.57371,0.0496153,-4.7965e-05,2.75759e-08,-6.31252e-12,36860.4,26.1159], Tmin=(100,'K'), Tmax=(1203.89,'K')), NASAPolynomial(coeffs=[8.86876,0.0204907,-5.58879e-06,7.38264e-10,-3.93077e-14,35458,-8.96149], Tmin=(1203.89,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(305.721,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CtCsHH) + group(Cs-CsHHH) + group(Cs-CtOsHH) + group(Ct-CtCs) + group(Ct-CtCs) + radical(RCCJ) + radical(Sec_Propargyl)"""),
)

species(
    label = 'C=CC=C[CH][O](26915)',
...
species(
    ...
    molecularWeight = (82.1005,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.78301,0.0503106,-3.54204e-05,1.40178e-08,-2.4612e-12,39554.7,22.651], Tmin=(100,'K'), Tmax=(1252.28,'K')), NASAPolynomial(coeffs=[7.40126,0.032365,-1.39248e-05,2.57433e-09,-1.7668e-13,38147.6,-5.71773], Tmin=(1252.28,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(328.225,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cdd-CdsCds) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[O]CC=C1[CH]C1(26919)',
    structure = SMILES('[O]CC=C1[CH]C1'),
    E0 = (364.601,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (82.1005,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.3193,0.0305627,3.14732e-06,-1.73031e-08,6.44024e-12,43917.1,19.5325], Tmin=(100,'K'), Tmax=(1152.98,'K')), NASAPolynomial(coeffs=[7.3821,0.0274958,-1.17234e-05,2.20092e-09,-1.53444e-13,41786,-9.79204], Tmin=(1152.98,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(364.601,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(278.535,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + ring(Methylene_cyclopropane) + radical(CCOJ) + radical(Allyl_S)"""),
)
...
species(
    label = 'C[C]=C=CC[O](26922)',
    structure = SMILES('CC#C[CH]C[O]'),
    E0 = (373.18,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2100,2250,500,550,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,180,1943.51,1943.73],'cm^-1')),
        HinderedRotor(inertia=(0.0039452,'amu*angstrom^2'), symmetry=1, barrier=(10.5804,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.94563,'amu*angstrom^2'), symmetry=1, barrier=(67.7259,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.94515,'amu*angstrom^2'), symmetry=1, barrier=(67.7148,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (82.1005,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.12697,0.0426724,-3.75667e-05,2.47063e-08,-7.45267e-12,44949.2,24.1268], Tmin=(100,'K'), Tmax=(867.727,'K')), NASAPolynomial(coeffs=[4.49985,0.0296866,-1.15795e-05,2.02132e-09,-1.33507e-13,44614.5,13.4598], Tmin=(867.727,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(373.18,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CtCsHH) + group(Cs-CsOsHH) + group(Cs-CtHHH) + group(Ct-CtCs) + group(Ct-CtCs) + radical(CCOJ) + radical(CCJCO)"""),
)

species(
    label = 'CC=C=[C]C[O](26923)',
    ...
    molecularWeight = (82.1005,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.06849,0.0440294,-4.1914e-05,2.93132e-08,-8.82272e-12,39298.4,22.7277], Tmin=(100,'K'), Tmax=(954.69,'K')), NASAPolynomial(coeffs=[4.33801,0.0293173,-1.06233e-05,1.75394e-09,-1.11002e-13,39102.2,13.1256], Tmin=(954.69,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(326.18,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CtCsHH) + group(Cs-CsHHH) + group(Cs-CtOsHH) + group(Ct-CtCs) + group(Ct-CtCs) + radical(CCOJ) + radical(Sec_Propargyl)"""),
)

species(
    label = 'CC=C=C[CH][O](26924)',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'C=C[C]=CC=O(26908)'],
    products = ['C=C[C]=CC[O](26480)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)', 'C=C=C=CC[O](26910)'],
    products = ['C=C[C]=CC[O](26480)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction22',
    reactants = ['O(4)', '[CH2]C=[C]C=C(26613)'],
    products = ['C=C[C]=CC[O](26480)'],
...
reaction(
    label = 'reaction27',
    reactants = ['C=C[C]=CC[O](26480)'],
    products = ['[CH2]C=C1[CH]CO1(26925)'],
