...
species(
    ...
    collisionModel = TransportData(shapeIndex=2, epsilon=(3941.8,'J/mol'), sigma=(6.99692,'angstroms'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with Tc=615.70 K, Pc=26.11 bar (from Joback method)"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.146861,0.0876129,-7.6833e-05,3.84755e-08,-8.23437e-12,8932.73,33.8052], Tmin=(100,'K'), Tmax=(1087.29,'K')), NASAPolynomial(coeffs=[11.2843,0.0466403,-2.03088e-05,3.81836e-09,-2.65766e-13,6510.78,-20.8586], Tmin=(1087.29,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(73.1373,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(CJCOOH)"""),
)
...
species(
    ...
    molecularWeight = (130.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.222152,0.0995233,-9.48852e-05,5.89944e-08,-1.65162e-11,3735.18,38.1301], Tmin=(100,'K'), Tmax=(831.451,'K')), NASAPolynomial(coeffs=[7.49585,0.0623945,-2.79047e-05,5.2909e-09,-3.69297e-13,2451.7,2.31945], Tmin=(831.451,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(29.8408,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(527.969,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(RCCJC)"""),
)

species(
    label = '[CH2]CCCC(CC)O[O](249)',
...
species(
    label = '[CH2]C[C](CCCC)OO(2133)',
    structure = SMILES('[CH2]C[C](CCCC)OO'),
    E0 = (75.5353,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,360,370,350,3615,1310,387.5,850,1000,3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2]CC(C[CH2])OO(2136)',
    structure = SMILES('[CH2]CC(C[CH2])OO'),
    E0 = (141.443,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3615,1310,387.5,850,1000,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,1380,1390,370,380,2900,435,200,800],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2]CCC(C[CH2])OO(2138)',
    structure = SMILES('[CH2]CCC(C[CH2])OO'),
    E0 = (117.663,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3615,1310,387.5,850,1000,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,1380,1390,370,380,2900,435,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'C[CH]C[CH]C(CC)OO(25624)',
    structure = SMILES('C[CH]C[CH]C(CC)OO'),
    E0 = (78.251,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3000,3050,390,425,1340,1360,335,370,3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'C[CH]CCC(C)OO(585)',
    structure = SMILES('C[CH]CCC(C)OO'),
    E0 = (-98.3837,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3025,407.5,1350,352.5,3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
reaction(
    label = 'reaction1',
    reactants = ['O2(2)', 'CC[CH]CCCC(85)'],
    products = ['CCCCC(CC)O[O](207)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction9',
    reactants = ['CC[CH]O[O](238)', 'butyl_1(82)'],
    products = ['CCCCC(CC)O[O](207)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction10',
    reactants = ['CCCC[CH]O[O](239)', 'C2H5(29)'],
    products = ['CCCCC(CC)O[O](207)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction11',
    reactants = ['H(3)', 'CCCC[C](CC)O[O](240)'],
    products = ['CCCCC(CC)O[O](207)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]C(CC)O[O](241)', 'npropyl(83)'],
    products = ['CCCCC(CC)O[O](207)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction13',
    reactants = ['H(3)', 'CCC[CH]C(CC)O[O](242)'],
    products = ['CCCCC(CC)O[O](207)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]CC(CC)O[O](243)', 'C2H5(29)'],
    products = ['CCCCC(CC)O[O](207)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(8.73e+14,'cm^3/(mol*s)'), n=-0.699, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(200,'K'), Tmax=(2000,'K'), comment="""From training reaction 11 used for C_rad/H2/Cs;C_rad/H2/Cs
Exact match found for rate rule [C_rad/H2/Cs;C_rad/H2/Cs]
...
reaction(
    label = 'reaction15',
    reactants = ['H(3)', 'CC[CH]CC(CC)O[O](244)'],
    products = ['CCCCC(CC)O[O](207)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(2e+13,'cm^3/(mol*s)','*|/',3.16), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), comment="""From training reaction 59 used for H_rad;C_rad/H/NonDeC
Exact match found for rate rule [C_rad/H/NonDeC;H_rad]
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]C(CCCC)O[O](245)', 'CH3(17)'],
    products = ['CCCCC(CC)O[O](207)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction17',
    reactants = ['H(3)', 'C[CH]C(CCCC)O[O](246)'],
    products = ['CCCCC(CC)O[O](207)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2]CCC(CC)O[O](247)', 'CH3(17)'],
    products = ['CCCCC(CC)O[O](207)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(3)', 'C[CH]CCC(CC)O[O](248)'],
    products = ['CCCCC(CC)O[O](207)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(3)', '[CH2]CCCC(CC)O[O](249)'],
    products = ['CCCCC(CC)O[O](207)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(3)', '[CH2]CC(CCCC)O[O](250)'],
    products = ['CCCCC(CC)O[O](207)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CH2(S)(23)', 'CCCCC(C)O[O](229)'],
    products = ['CCCCC(CC)O[O](207)'],
...
reaction(
    label = 'reaction2',
    reactants = ['CCCCC(CC)O[O](207)'],
    products = ['CCCC[C](CC)OO(231)'],
...
reaction(
    label = 'reaction27',
    reactants = ['H(3)', 'C=CC(CCCC)OO(2131)'],
    products = ['[CH2]CC(CCCC)OO(235)'],
...
reaction(
    label = 'reaction28',
    reactants = ['CCCC[CH]OO(274)', 'C2H4(21)'],
    products = ['[CH2]CC(CCCC)OO(235)'],
...
reaction(
    label = 'reaction29',
    reactants = ['[CH2]CC(CCCC)OO(235)'],
    products = ['C[CH]C(CCCC)OO(233)'],
...
reaction(
    label = 'reaction35',
    reactants = ['OH(5)', '[CH2]CC([O])CCCC(2132)'],
    products = ['[CH2]CC(CCCC)OO(235)'],
...
reaction(
    label = 'reaction36',
    reactants = ['[CH2]C[CH]CCCC(199)', 'HO2(10)'],
    products = ['[CH2]CC(CCCC)OO(235)'],
...
reaction(
    label = 'reaction38',
    reactants = ['butyl_1(82)', '[CH2]C[CH]OO(468)'],
    products = ['[CH2]CC(CCCC)OO(235)'],
...
reaction(
    label = 'reaction39',
    reactants = ['CCCC[CH]OO(274)', 'C2H4(T)(94)'],
    products = ['[CH2]CC(CCCC)OO(235)'],
...
reaction(
    label = 'reaction40',
    reactants = ['H(3)', '[CH2]C[C](CCCC)OO(2133)'],
    products = ['[CH2]CC(CCCC)OO(235)'],
...
reaction(
    label = 'reaction41',
    reactants = ['npropyl(83)', '[CH2]CC([CH2])OO(2134)'],
    products = ['[CH2]CC(CCCC)OO(235)'],
...
reaction(
    label = 'reaction42',
    reactants = ['H(3)', '[CH2]CC([CH]CCC)OO(2135)'],
    products = ['[CH2]CC(CCCC)OO(235)'],
...
reaction(
    label = 'reaction43',
    reactants = ['C2H5(29)', '[CH2]CC(C[CH2])OO(2136)'],
    products = ['[CH2]CC(CCCC)OO(235)'],
...
reaction(
    label = 'reaction44',
    reactants = ['H(3)', '[CH2]CC(C[CH]CC)OO(2137)'],
    products = ['[CH2]CC(CCCC)OO(235)'],
...
reaction(
    label = 'reaction45',
    reactants = ['CH3(17)', '[CH2]CCC(C[CH2])OO(2138)'],
    products = ['[CH2]CC(CCCC)OO(235)'],
...
reaction(
    label = 'reaction46',
    reactants = ['H(3)', '[CH2]CC(CC[CH]C)OO(2139)'],
    products = ['[CH2]CC(CCCC)OO(235)'],
...
reaction(
    label = 'reaction47',
    reactants = ['H(3)', '[CH2][CH]C(CCCC)OO(2140)'],
    products = ['[CH2]CC(CCCC)OO(235)'],
...
reaction(
    label = 'reaction48',
    reactants = ['H(3)', '[CH2]CCCC(C[CH2])OO(2141)'],
    products = ['[CH2]CC(CCCC)OO(235)'],
...
reaction(
    label = 'reaction49',
    reactants = ['CH2(S)(23)', '[CH2]CC(CCC)OO(2142)'],
    products = ['[CH2]CC(CCCC)OO(235)'],
...
reaction(
    label = 'reaction52',
    reactants = ['CH2(19)', '[CH2]C(CCCC)OO(583)'],
    products = ['[CH2]CC(CCCC)OO(235)'],
...
reaction(
    label = 'reaction53',
    reactants = ['H(3)', '[CH]CC(CCCC)OO(2144)'],
    products = ['[CH2]CC(CCCC)OO(235)'],
...
reaction(
    label = 'reaction54',
    reactants = ['H(3)', 'CC=CCC(CC)OO(25621)'],
    products = ['C[CH]CCC(CC)OO(236)'],
...
reaction(
    label = 'reaction55',
    reactants = ['H(3)', 'C=CCCC(CC)OO(25622)'],
    products = ['C[CH]CCC(CC)OO(236)'],
...
reaction(
    label = 'reaction56',
    reactants = ['C3H6(72)', '[CH2]C(CC)OO(715)'],
    products = ['C[CH]CCC(CC)OO(236)'],
...
reaction(
    label = 'reaction62',
    reactants = ['OH(5)', 'C[CH]CCC([O])CC(9700)'],
    products = ['C[CH]CCC(CC)OO(236)'],
...
reaction(
    label = 'reaction63',
    reactants = ['C[CH]CC[CH]CC(181)', 'HO2(10)'],
    products = ['C[CH]CCC(CC)OO(236)'],
...
reaction(
    label = 'reaction65',
    reactants = ['[CH2]C[CH]C(129)', 'CC[CH]OO(288)'],
    products = ['C[CH]CCC(CC)OO(236)'],
...
reaction(
    label = 'reaction66',
    reactants = ['C2H5(29)', 'C[CH]CC[CH]OO(1473)'],
    products = ['C[CH]CCC(CC)OO(236)'],
...
reaction(
    label = 'reaction67',
    reactants = ['H(3)', 'C[CH]CC[C](CC)OO(25623)'],
    products = ['C[CH]CCC(CC)OO(236)'],
...
reaction(
    label = 'reaction68',
    reactants = ['C3H6(T)(143)', '[CH2]C(CC)OO(715)'],
    products = ['C[CH]CCC(CC)OO(236)'],
...
reaction(
    label = 'reaction69',
    reactants = ['H(3)', 'C[CH]C[CH]C(CC)OO(25624)'],
    products = ['C[CH]CCC(CC)OO(236)'],
...
reaction(
    label = 'reaction70',
    reactants = ['CH3(17)', '[CH2]C(CC[CH]C)OO(7771)'],
    products = ['C[CH]CCC(CC)OO(236)'],
...
reaction(
    label = 'reaction71',
    reactants = ['H(3)', 'C[CH]CCC([CH]C)OO(25625)'],
    products = ['C[CH]CCC(CC)OO(236)'],
...
reaction(
    label = 'reaction72',
    reactants = ['H(3)', 'C[CH][CH]CC(CC)OO(25626)'],
    products = ['C[CH]CCC(CC)OO(236)'],
...
reaction(
    label = 'reaction74',
    reactants = ['H(3)', '[CH2][CH]CCC(CC)OO(25627)'],
    products = ['C[CH]CCC(CC)OO(236)'],
...
reaction(
    label = 'reaction75',
    reactants = ['CH2(S)(23)', 'C[CH]CCC(C)OO(585)'],
    products = ['C[CH]CCC(CC)OO(236)'],
...
reaction(
    label = 'reaction76',
    reactants = ['C[CH]CCC(CC)OO(236)'],
    products = ['OH(5)', 'CCC1CCC(C)O1(2098)'],
...
reaction(
    label = 'reaction77',
    reactants = ['[CH2]C(C)CC(CC)OO(25628)'],
    products = ['C[CH]CCC(CC)OO(236)'],
...
reaction(
    label = 'reaction79',
    reactants = ['CHCH3(T)(95)', '[CH2]CC(CC)OO(2965)'],
    products = ['C[CH]CCC(CC)OO(236)'],
...
reaction(
    label = 'reaction80',
    reactants = ['CH3(17)', '[CH]CCC(CC)OO(25630)'],
    products = ['C[CH]CCC(CC)OO(236)'],
...
reaction(
    label = 'reaction81',
    reactants = ['H(3)', 'C[C]CCC(CC)OO(25631)'],
    products = ['C[CH]CCC(CC)OO(236)'],
...
network(
    ...
    reactants = [
        ('O2(2)', 'CC[CH]CCCC(85)'),
        ('CH2(S)(23)', 'CCCCC(C)O[O](229)'),
        ('CCCCC([O])CC(252)', 'O(4)'),
        ('OH(5)', 'CCC1CCC(C)O1(2098)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
