...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.691829,0.0953568,-7.17008e-05,2.74816e-08,-4.2895e-12,772.954,39.7049], Tmin=(100,'K'), Tmax=(1491.82,'K')), NASAPolynomial(coeffs=[19.4793,0.0412718,-1.7319e-05,3.17932e-09,-2.16887e-13,-5245.36,-65.6775], Tmin=(1491.82,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(4.97155,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(RCCJ)"""),
)

species(
    label = '[CH2]CC=CCC(C)OO(6397)',
    structure = SMILES('[CH2]CC=CCC(C)OO'),
    E0 = (5.30786,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,3615,1310,387.5,850,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3100,440,815,1455,1000,1380,1390,370,380,2900,435,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (129.177,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.456233,0.0953645,-7.35486e-05,2.97541e-08,-4.99733e-12,800.583,37.9405], Tmin=(100,'K'), Tmax=(1373.47,'K')), NASAPolynomial(coeffs=[16.4188,0.046219,-1.98759e-05,3.70216e-09,-2.55353e-13,-3834.92,-48.8271], Tmin=(1373.47,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(5.30786,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(RCCJ)"""),
)
...
species(
    label = '[CH2]CCCC[C](C)OO(6400)',
    structure = SMILES('[CH2]CCCC[C](C)OO'),
    E0 = (75.5353,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (130.185,'amu'),
...
species(
    label = '[CH2]CC[CH]CCOO(6408)',
    structure = SMILES('[CH2]CC[CH]CCOO'),
    E0 = (119.518,'kJ/mol'),
    modes = [
...
species(
    label = '[CH2]CCC1CC(C)O1(6409)',
    structure = SMILES('[CH2]CCC1CC(C)O1'),
    E0 = (-11.4799,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (113.178,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.478526,0.0620225,1.43681e-05,-6.37554e-08,3.03963e-11,-1239.69,29.4936], Tmin=(100,'K'), Tmax=(921.378,'K')), NASAPolynomial(coeffs=[15.1421,0.0381507,-1.15429e-05,1.86016e-09,-1.24055e-13,-5630.69,-49.214], Tmin=(921.378,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-11.4799,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(490.554,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Oxetane) + radical(RCCJ)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]CC[CH]CC(C)OO(6312)'],
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', '[CH2]CCC=CC(C)OO(6396)'],
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', '[CH2]CC=CCC(C)OO(6397)'],
    products = ['[CH2]CC[CH]CC(C)OO(6312)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(1.46e+08,'cm^3/(mol*s)'), n=1.64, Ea=(5.73208,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""From training reaction 2555 used for Cds-CsH_Cds-CsH;HJ
Exact match found for rate rule [Cds-CsH_Cds-CsH;HJ]
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', 'C=CC[CH]CC(C)OO(6398)'],
    products = ['[CH2]CC[CH]CC(C)OO(6312)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CH3CHOOH(63)', '[CH2]CCC=C(369)'],
    products = ['[CH2]CC[CH]CC(C)OO(6312)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]CCC[CH]C(C)OO(6399)'],
    products = ['[CH2]CC[CH]CC(C)OO(6312)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]CC[CH]CC(C)OO(6312)'],
    products = ['[CH2][CH]CCCC(C)OO(6401)'],
...
reaction(
    label = 'reaction24',
    reactants = ['CH2(S)(23)', '[CH2]CC[CH]CCOO(6408)'],
    products = ['[CH2]CC[CH]CC(C)OO(6312)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[CH2]CC[CH]CC(C)OO(6312)'],
    products = ['OH(5)', '[CH2]CCC1CC(C)O1(6409)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[CH2]CCC([CH2])C(C)OO(6410)'],
    products = ['[CH2]CC[CH]CC(C)OO(6312)'],
...
reaction(
    label = 'reaction29',
    reactants = ['[CH2]CC[CH]CC(C)OO(6312)'],
    products = ['[CH2]CCC(O)CC(C)[O](6411)'],
...
reaction(
    label = 'reaction30',
    reactants = ['[CH2]C[CH2](128)', '[CH]CC(C)OO(1806)'],
    products = ['[CH2]CC[CH]CC(C)OO(6312)'],
