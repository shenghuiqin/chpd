...
species(
    label = '[CH2]CC1(CC)OC1([CH2])O(6515)',
    structure = SMILES('[CH2]CC1(CC)OC1([CH2])O'),
    E0 = (-19.7164,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-3.26077,0.123181,-0.00012481,6.21319e-08,-1.14288e-11,-2078.5,40.4203], Tmin=(100,'K'), Tmax=(1587.03,'K')), NASAPolynomial(coeffs=[28.6841,0.0169208,-4.40538e-08,-5.00775e-10,4.77826e-14,-8975.79,-118.235], Tmin=(1587.03,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-19.7164,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(482.239,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CJC(O)2C) + radical(RCCJ)"""),
)
...
species(
    label = '[CH2]CC(=O)CC(6517)',
    structure = SMILES('[CH2]CC(=O)CC'),
    E0 = (-72.0217,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,375,552.5,462.5,1710,295.531,2253.02],'cm^-1')),
        HinderedRotor(inertia=(0.129225,'amu*angstrom^2'), symmetry=1, barrier=(7.99337,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.128907,'amu*angstrom^2'), symmetry=1, barrier=(8.00587,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.129341,'amu*angstrom^2'), symmetry=1, barrier=(7.99014,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.130442,'amu*angstrom^2'), symmetry=1, barrier=(7.993,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (85.1244,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.21396,0.0666988,-8.14593e-05,6.81229e-08,-2.44381e-11,-8567.1,22.9488], Tmin=(100,'K'), Tmax=(781.946,'K')), NASAPolynomial(coeffs=[4.94901,0.0408029,-1.87593e-05,3.5625e-09,-2.47032e-13,-8943.65,7.17527], Tmin=(781.946,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-72.0217,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)CsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdCsCs) + radical(CJCC=O)"""),
)
...
species(
    label = '[CH2][CH]C(O)(CC)C(=C)O(6520)',
    structure = SMILES('[CH2][CH]C(O)(CC)C(=C)O'),
    E0 = (-95.1193,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.169,'amu'),
...
species(
    label = '[CH2]CC(O)(C[CH2])C(=C)O(6521)',
    structure = SMILES('[CH2]CC(O)(C[CH2])C(=C)O'),
    E0 = (-89.775,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2950,3100,1380,975,1025,1650,3580,3650,1210,1345,900,1100,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,350,440,435,1725,180,180,180,180,1600,1618.9,2873.32,3200],'cm^-1')),
        HinderedRotor(inertia=(0.151486,'amu*angstrom^2'), symmetry=1, barrier=(3.48297,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.151486,'amu*angstrom^2'), symmetry=1, barrier=(3.48297,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.151486,'amu*angstrom^2'), symmetry=1, barrier=(3.48297,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.151486,'amu*angstrom^2'), symmetry=1, barrier=(3.48297,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.151486,'amu*angstrom^2'), symmetry=1, barrier=(3.48297,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (128.169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.75874,0.110395,-0.000108428,5.4032e-08,-1.04582e-11,-10576.3,41.974], Tmin=(100,'K'), Tmax=(1311.71,'K')), NASAPolynomial(coeffs=[25.2636,0.02516,-7.71846e-06,1.20139e-09,-7.54984e-14,-17421.7,-94.7962], Tmin=(1311.71,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-89.775,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(478.082,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(RCCJ) + radical(RCCJ)"""),
)

species(
    label = '[CH2]CC(O)(CC)C(=C)[O](6522)',
    structure = SMILES('[CH2]CC(O)(CC)C(=C)[O]'),
    E0 = (-157.217,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.1943,0.102963,-9.61869e-05,4.70905e-08,-9.13735e-12,-18712.3,40.3527], Tmin=(100,'K'), Tmax=(1254.06,'K')), NASAPolynomial(coeffs=[21.101,0.0318483,-1.11248e-05,1.87051e-09,-1.22548e-13,-24304.1,-72.2564], Tmin=(1254.06,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-157.217,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(482.239,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(C=C(C)OJ) + radical(RCCJ)"""),
)

species(
    label = '[CH]=C(O)C(O)(C[CH2])CC(6523)',
    structure = SMILES('[CH]=C(O)C(O)(C[CH2])CC'),
    E0 = (-47.9252,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,3580,3650,1210,1345,900,1100,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3100,440,815,1455,1000,200,800,960,1120,1280,1440,1600],'cm^-1')),
    ...
    molecularWeight = (128.169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.83312,0.112784,-0.000113373,5.77185e-08,-1.14007e-11,-5540.88,41.5487], Tmin=(100,'K'), Tmax=(1279.59,'K')), NASAPolynomial(coeffs=[25.5221,0.0249189,-7.61541e-06,1.18211e-09,-7.42042e-14,-12349,-96.416], Tmin=(1279.59,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-47.9252,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(478.082,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(RCCJ) + radical(Cds_P)"""),
)

species(
    label = 'C=C([O])C([O])(CC)CC(6524)',
    structure = SMILES('C=C([O])C([O])(CC)CC'),
    E0 = (-133.36,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.75319,0.0947294,-7.79655e-05,3.38506e-08,-5.94442e-12,-15860.3,37.5074], Tmin=(100,'K'), Tmax=(1357.14,'K')), NASAPolynomial(coeffs=[18.8488,0.0369556,-1.41107e-05,2.48349e-09,-1.66316e-13,-21180.9,-63.0469], Tmin=(1357.14,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-133.36,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(486.397,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(C=CC(C)2OJ) + radical(C=C(C)OJ)"""),
)

species(
    label = '[CH]=C(O)C([O])(CC)CC(6525)',
    structure = SMILES('[CH]=C(O)C([O])(CC)CC'),
    E0 = (-24.0689,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,350,440,435,1725,3120,650,792.5,1650,3615,1277.5,1000,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,180,180,180,180,1600,1651.03,2848.4,3200],'cm^-1')),
        HinderedRotor(inertia=(0.15213,'amu*angstrom^2'), symmetry=1, barrier=(3.49776,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.15213,'amu*angstrom^2'), symmetry=1, barrier=(3.49776,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.15213,'amu*angstrom^2'), symmetry=1, barrier=(3.49776,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.15213,'amu*angstrom^2'), symmetry=1, barrier=(3.49776,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.15213,'amu*angstrom^2'), symmetry=1, barrier=(3.49776,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (128.169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.39667,0.104587,-9.5216e-05,4.45065e-08,-8.20657e-12,-2688.66,38.7217], Tmin=(100,'K'), Tmax=(1319.56,'K')), NASAPolynomial(coeffs=[23.1182,0.030274,-1.07403e-05,1.8273e-09,-1.20606e-13,-9158.35,-86.3459], Tmin=(1319.56,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-24.0689,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(482.239,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(Cds_P) + radical(C=CC(C)2OJ)"""),
)
...
species(
    ...
    molecularWeight = (128.169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.94988,0.0935692,-5.81596e-05,1.59008e-09,7.89642e-12,-45354.4,35.8942], Tmin=(100,'K'), Tmax=(1000.86,'K')), NASAPolynomial(coeffs=[22.8026,0.0304346,-1.11891e-05,2.04288e-09,-1.44824e-13,-51701.3,-86.6734], Tmin=(1000.86,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-378.692,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(482.239,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)(Cds-Cds)CsOs) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cds-CdsHH)"""),
)
...
species(
    label = '[CH2]CC(C)([O])C(=C)O(6529)',
    structure = SMILES('[CH2]CC(C)([O])C(=C)O'),
    E0 = (-42.1384,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,2950,3100,1380,975,1025,1650,350,440,435,1725,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,180,180,180,180,1600,1618.36,2874.6,3200],'cm^-1')),
        HinderedRotor(inertia=(0.149681,'amu*angstrom^2'), symmetry=1, barrier=(3.44146,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.149681,'amu*angstrom^2'), symmetry=1, barrier=(3.44146,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.149681,'amu*angstrom^2'), symmetry=1, barrier=(3.44146,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.149681,'amu*angstrom^2'), symmetry=1, barrier=(3.44146,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.149681,'amu*angstrom^2'), symmetry=1, barrier=(3.44146,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.265103,0.0827368,-6.0866e-05,1.37807e-08,2.43605e-12,-4904.75,34.4835], Tmin=(100,'K'), Tmax=(996.677,'K')), NASAPolynomial(coeffs=[19.2738,0.0264516,-9.46373e-06,1.67698e-09,-1.16175e-13,-9898.73,-65.2295], Tmin=(996.677,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-42.1384,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(RCCJ) + radical(C=CC(C)2OJ)"""),
)
...
species(
    label = '[CH2]CC([C]=C)(CC)OO(6530)',
    structure = SMILES('[CH2]CC([C]=C)(CC)OO'),
    E0 = (228.884,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,2750,2800,2850,1350,1500,750,1050,1375,1000,2950,3100,1380,975,1025,1650,3615,1310,387.5,850,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3100,440,815,1455,1000,200,800,933.333,1066.67,1200,1333.33,1466.67,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (128.169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.650396,0.10242,-9.63092e-05,4.92243e-08,-1.03628e-11,27695.7,38.0807], Tmin=(100,'K'), Tmax=(1128.82,'K')), NASAPolynomial(coeffs=[15.7754,0.0442142,-1.89645e-05,3.54553e-09,-2.46275e-13,23987.4,-43.1547], Tmin=(1128.82,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(228.884,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(478.082,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(RCCJ) + radical(Cds_S)"""),
)

species(
    label = '[CH2]CC([O])(CC)C(C)=O(6531)',
    structure = SMILES('[CH2]CC([O])(CC)C(C)=O'),
    E0 = (-62.3147,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.256652,0.0995242,-0.00010605,6.8699e-08,-1.90259e-11,-7346.64,37.0148], Tmin=(100,'K'), Tmax=(858.904,'K')), NASAPolynomial(coeffs=[9.93041,0.0520806,-2.31914e-05,4.38396e-09,-3.05262e-13,-9096.53,-10.5822], Tmin=(858.904,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-62.3147,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(482.239,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-O2d)CsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)HHH) + group(Cds-OdCsCs) + radical(RCCJ) + radical(CC(C)(C=O)OJ)"""),
)
...
species(
    label = '[CH2]C[C](CC)C(=C)O(6532)',
    structure = SMILES('[CH2]CC(CC)=C([CH2])O'),
    E0 = (35.3566,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,325,375,415,465,420,450,1700,1750,3615,1277.5,1000,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.554657,0.0885321,-6.18003e-05,1.12133e-08,3.93618e-12,4426.74,34.4335], Tmin=(100,'K'), Tmax=(982.675,'K')), NASAPolynomial(coeffs=[19.6873,0.0305918,-1.0687e-05,1.86204e-09,-1.27666e-13,-732.264,-68.8764], Tmin=(982.675,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(35.3566,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsOs) + radical(RCCJ) + radical(C=C(O)CJ)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]CC([O])(CC)C(=C)O(6315)'],
    products = ['[CH2]CC1(CC)OC1([CH2])O(6515)'],
    transitionState = 'TS2',
...
reaction(
    ...
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(6.48e+06,'s^-1'), n=1.25, Ea=(68.475,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2500,'K'), comment="""From training reaction 349 used for R5_SS_D;doublebond_intra_2H_secNd;radadd_intra_cs2H
Exact match found for rate rule [R5_SS_D;doublebond_intra_2H_secNd;radadd_intra_cs2H]
Euclidian distance = 0
family: Intra_R_Add_Exocyclic
Ea raised from 68.3 to 68.5 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction4',
    reactants = ['H(3)', 'C=CC([O])(CC)C(=C)O(6516)'],
    products = ['[CH2]CC([O])(CC)C(=C)O(6315)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['C2H5(29)', '[CH2]CC(=O)C(=C)O(5558)'],
    products = ['[CH2]CC([O])(CC)C(=C)O(6315)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['CH2COH(99)', '[CH2]CC(=O)CC(6517)'],
    products = ['[CH2]CC([O])(CC)C(=C)O(6315)'],
    transitionState = 'TS7',
...
reaction(
    ...
    products = ['[CH2]CC([O])(CC)C(=C)O(6315)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(0.00310016,'m^3/(mol*s)'), n=2.49247, Ea=(76.9624,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [Cds-HH_Cds-HH;CJ]
Euclidian distance = 0
Multiplied by reaction path degeneracy 2.0
family: R_Addition_MultipleBond
Ea raised from 72.3 to 77.0 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction9',
    reactants = ['[CH2]CC([O])(CC)C(=C)O(6315)'],
    products = ['C=C(O)C([O])([CH]C)CC(6518)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]CC(O)([CH]C)C(=C)O(6519)'],
    products = ['[CH2]CC([O])(CC)C(=C)O(6315)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]CC([O])(CC)C(=C)O(6315)'],
    products = ['[CH2][CH]C(O)(CC)C(=C)O(6520)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]CC(O)(C[CH2])C(=C)O(6521)'],
    products = ['[CH2]CC([O])(CC)C(=C)O(6315)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2]CC([O])(CC)C(=C)O(6315)'],
    products = ['[CH2]CC(O)(CC)C(=C)[O](6522)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH]=C(O)C(O)(C[CH2])CC(6523)'],
    products = ['[CH2]CC([O])(CC)C(=C)O(6315)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH]=C(O)C([O])(CC)CC(6525)'],
    products = ['[CH2]CC([O])(CC)C(=C)O(6315)'],
...
reaction(
    label = 'reaction21',
    reactants = ['CH2(S)(23)', '[CH2]CC(C)([O])C(=C)O(6529)'],
    products = ['[CH2]CC([O])(CC)C(=C)O(6315)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH2]CC([C]=C)(CC)OO(6530)'],
    products = ['[CH2]CC([O])(CC)C(=C)O(6315)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[CH2]CC([O])(CC)C(=C)O(6315)'],
    products = ['[CH2]CC([O])(CC)C(C)=O(6531)'],
...
reaction(
    label = 'reaction25',
    reactants = ['O(4)', '[CH2]C[C](CC)C(=C)O(6532)'],
    products = ['[CH2]CC([O])(CC)C(=C)O(6315)'],
...
reaction(
    label = 'reaction26',
    reactants = ['CH2(19)', '[CH2]C([O])(CC)C(=C)O(6187)'],
    products = ['[CH2]CC([O])(CC)C(=C)O(6315)'],
