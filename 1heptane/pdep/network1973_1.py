...
species(
    label = '[CH2]COC=CC(10586)',
    structure = SMILES('[CH2]COC=CC'),
    E0 = (-9.94348,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,232.705,232.706,232.709],'cm^-1')),
        HinderedRotor(inertia=(0.456421,'amu*angstrom^2'), symmetry=1, barrier=(17.537,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.456386,'amu*angstrom^2'), symmetry=1, barrier=(17.5369,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.456374,'amu*angstrom^2'), symmetry=1, barrier=(17.5369,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.456373,'amu*angstrom^2'), symmetry=1, barrier=(17.5369,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (85.1244,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.723906,0.0587281,-1.86991e-05,-2.5907e-08,1.65618e-11,-1065.84,22.8819], Tmin=(100,'K'), Tmax=(948.434,'K')), NASAPolynomial(coeffs=[18.2174,0.0175789,-5.22421e-06,8.95012e-10,-6.4457e-14,-5851.65,-68.3243], Tmin=(948.434,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-9.94348,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(CJCO)"""),
)
...
species(
    label = '[CH2]CCOC[CH2](10588)',
    structure = SMILES('[CH2]CCOC[CH2]'),
    E0 = (119.682,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (86.1323,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.2312,0.0649293,-5.64473e-05,2.96932e-08,-6.94108e-12,14490.8,25.602], Tmin=(100,'K'), Tmax=(981.743,'K')), NASAPolynomial(coeffs=[7.46056,0.0395485,-1.76681e-05,3.35956e-09,-2.3524e-13,13267.6,-4.33625], Tmin=(981.743,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(119.682,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJ) + radical(CJCO)"""),
)
...
species(
    label = '[CH2]C[CH]OCC(10589)',
    structure = SMILES('[CH2]C[CH]OCC'),
    E0 = (88.5492,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (86.1323,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.98897,0.0679609,-6.05187e-05,3.08162e-08,-6.66712e-12,10757,25.2759], Tmin=(100,'K'), Tmax=(1081.56,'K')), NASAPolynomial(coeffs=[9.84556,0.0352067,-1.50933e-05,2.81691e-09,-1.95279e-13,8841.16,-18.1466], Tmin=(1081.56,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(88.5492,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCsJOCs) + radical(RCCJ)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', '[CH2]COC=CC(10586)'],
    products = ['[CH2]CO[CH]CC(10575)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'C=CO[CH]CC(10587)'],
    products = ['[CH2]CO[CH]CC(10575)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['CH3(17)', '[CH2]COC=C(1028)'],
    products = ['[CH2]CO[CH]CC(10575)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction19',
    reactants = ['CH2(19)', '[CH2]O[CH]CC(1682)'],
    products = ['[CH2]CO[CH]CC(10575)'],
