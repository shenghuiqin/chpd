species(
    label = '[CH2]OC[CH]CCCC(994)',
    structure = SMILES('[CH2]OC[CH]CCCC'),
    E0 = (56.7274,'kJ/mol'),
    modes = [
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.00361614,0.0837834,-5.63806e-05,1.9976e-08,-2.96548e-12,6969.86,36.6889], Tmin=(100,'K'), Tmax=(1519.08,'K')), NASAPolynomial(coeffs=[14.6011,0.0453265,-1.84066e-05,3.31056e-09,-2.2279e-13,2532.74,-39.8766], Tmin=(1519.08,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(56.7274,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(CCJCO) + radical(CsJOCC)"""),
)
...
species(
    label = '[CH2]OCC=CCCC(1860)',
    structure = SMILES('[CH2]OCC=CCCC'),
    E0 = (-20.946,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.233958,0.0773039,-4.86257e-05,1.56487e-08,-2.08632e-12,-2379.63,34.4338], Tmin=(100,'K'), Tmax=(1678.82,'K')), NASAPolynomial(coeffs=[15.2471,0.0415331,-1.6665e-05,2.95699e-09,-1.96342e-13,-7420.51,-45.7743], Tmin=(1678.82,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-20.946,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(482.239,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(CsJOCC)"""),
)

species(
    label = '[CH2]OC=CCCCC(1861)',
    structure = SMILES('[CH2]OC=CCCCC'),
    E0 = (-62.1833,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (113.178,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.293803,0.0778049,-2.19219e-05,-3.02224e-08,1.80051e-11,-7309.53,33.9575], Tmin=(100,'K'), Tmax=(984.245,'K')), NASAPolynomial(coeffs=[19.9275,0.033486,-1.20797e-05,2.1937e-09,-1.55676e-13,-13123.9,-72.5934], Tmin=(984.245,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-62.1833,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(482.239,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(C=COCJ)"""),
)
...
species(
    label = '[CH2]OCC[CH]CCC(1862)',
    structure = SMILES('[CH2]OCC[CH]CCC'),
    E0 = (51.2837,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,3025,407.5,1350,352.5,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (114.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.402995,0.0850875,-7.25861e-05,4.35487e-08,-1.25685e-11,6292.2,35.3203], Tmin=(100,'K'), Tmax=(785.632,'K')), NASAPolynomial(coeffs=[5.05251,0.0614142,-2.73859e-05,5.19216e-09,-3.62605e-13,5561.65,14.011], Tmin=(785.632,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(51.2837,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(CsJOCC) + radical(RCCJCC)"""),
)

species(
    label = '[CH2]O[CH]CCCCC(1841)',
    ...
    molecularWeight = (114.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.343239,0.0941974,-7.8096e-05,3.59153e-08,-6.92662e-12,4641.29,34.8581], Tmin=(100,'K'), Tmax=(1211.44,'K')), NASAPolynomial(coeffs=[14.0559,0.0466535,-1.92272e-05,3.51917e-09,-2.41153e-13,1152.56,-37.3713], Tmin=(1211.44,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(37.2814,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(CsJOCC) + radical(CCsJOCs)"""),
)

species(
    label = 'CCCC[CH][CH]OC(1863)',
    structure = SMILES('CCCC[CH][CH]OC'),
    E0 = (49.4119,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (114.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0487639,0.0903287,-7.11437e-05,3.1296e-08,-5.89549e-12,6087.41,34.6081], Tmin=(100,'K'), Tmax=(1215.46,'K')), NASAPolynomial(coeffs=[12.2205,0.0499515,-2.13141e-05,3.96497e-09,-2.73964e-13,3104.85,-26.9779], Tmin=(1215.46,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(49.4119,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(CCJCO) + radical(CCsJOCs)"""),
)

species(
    label = '[CH2]OCCC[CH]CC(1864)',
    structure = SMILES('[CH2]OCCC[CH]CC'),
    E0 = (51.2837,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,3025,407.5,1350,352.5,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2]OCCCC[CH]C(1865)',
    structure = SMILES('[CH2]OCCCC[CH]C'),
    E0 = (51.2717,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (114.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.445648,0.0837353,-6.46179e-05,3.18709e-08,-7.39977e-12,6289.83,35.335], Tmin=(100,'K'), Tmax=(955.514,'K')), NASAPolynomial(coeffs=[6.3305,0.0591004,-2.59459e-05,4.88975e-09,-3.40587e-13,5165.2,7.21171], Tmin=(955.514,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(51.2717,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(CsJOCC) + radical(RCCJC)"""),
)

species(
    label = '[CH2]CCCCCO[CH2](1866)',
    structure = SMILES('[CH2]CCCCCO[CH2]'),
    E0 = (62.0717,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2761.11,2772.22,2783.33,2794.44,2805.56,2816.67,2827.78,2838.89,2850,1425,1431.25,1437.5,1443.75,1450,1225,1237.5,1250,1262.5,1275,1270,1287.5,1305,1322.5,1340,700,725,750,775,800,300,325,350,375,400,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (114.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.186304,0.0857078,-6.17998e-05,2.46753e-08,-4.27674e-12,7600.92,35.2943], Tmin=(100,'K'), Tmax=(1288.46,'K')), NASAPolynomial(coeffs=[11.1983,0.0515213,-2.20006e-05,4.08268e-09,-2.81162e-13,4763.22,-20.6231], Tmin=(1288.46,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(62.0717,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(CsJOCC) + radical(RCCJ)"""),
)

species(
    label = 'CCC[CH][CH]COC(1867)',
    structure = SMILES('CCC[CH][CH]COC'),
    E0 = (63.4142,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (114.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.8258,0.0608077,5.82387e-05,-2.63294e-07,2.4399e-10,7691.4,31.3866], Tmin=(100,'K'), Tmax=(401.552,'K')), NASAPolynomial(coeffs=[3.47799,0.0642873,-2.92367e-05,5.58384e-09,-3.91038e-13,7397.97,22.9218], Tmin=(401.552,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(63.4142,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(CCJCO) + radical(RCCJCC)"""),
)

species(
    label = 'CC[CH]C[CH]COC(1868)',
    structure = SMILES('CC[CH]C[CH]COC'),
    E0 = (63.4142,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3000,3050,390,425,1340,1360,335,370,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (114.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.8258,0.0608077,5.82387e-05,-2.63294e-07,2.4399e-10,7691.4,31.3866], Tmin=(100,'K'), Tmax=(401.552,'K')), NASAPolynomial(coeffs=[3.47799,0.0642873,-2.92367e-05,5.58384e-09,-3.91038e-13,7397.97,22.9218], Tmin=(401.552,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(63.4142,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(RCCJCC) + radical(CCJCO)"""),
)

species(
    label = 'C[CH]CC[CH]COC(1869)',
    structure = SMILES('C[CH]CC[CH]COC'),
    E0 = (63.4022,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3000,3050,390,425,1340,1360,335,370,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (114.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.557016,0.081927,-6.44566e-05,3.56324e-08,-9.83954e-12,7744.04,35.7486], Tmin=(100,'K'), Tmax=(799.382,'K')), NASAPolynomial(coeffs=[4.42173,0.0625895,-2.81725e-05,5.37389e-09,-3.76923e-13,7126.13,17.9688], Tmin=(799.382,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(63.4022,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(CCJCO) + radical(RCCJC)"""),
)

species(
    label = '[CH2]CCC[CH]COC(1870)',
    structure = SMILES('[CH2]CCC[CH]COC'),
    E0 = (74.2023,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,3025,407.5,1350,352.5,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (114.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.504622,0.0816257,-5.43487e-05,1.9651e-08,-3.14099e-12,9045.75,34.9532], Tmin=(100,'K'), Tmax=(1340.6,'K')), NASAPolynomial(coeffs=[9.6539,0.0543268,-2.38042e-05,4.4616e-09,-3.08429e-13,6592.63,-11.8686], Tmin=(1340.6,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(74.2023,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(RCCJ) + radical(CCJCO)"""),
)
...
species(
    label = 'CCCCC=COC(1871)',
    structure = SMILES('CCCCC=COC'),
    E0 = (-254.191,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (114.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.413326,0.0799393,-2.03709e-05,-3.27773e-08,1.89028e-11,-30398,31.901], Tmin=(100,'K'), Tmax=(985.919,'K')), NASAPolynomial(coeffs=[19.9503,0.0362529,-1.31369e-05,2.38271e-09,-1.68574e-13,-36305.5,-75.6489], Tmin=(985.919,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-254.191,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH)"""),
)

species(
    label = 'CCCC=CCOC(1872)',
    structure = SMILES('CCCC=CCOC'),
    E0 = (-208.718,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (114.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.547717,0.0763528,-4.30144e-05,1.17153e-08,-1.3028e-12,-24980.5,31.5987], Tmin=(100,'K'), Tmax=(1937.41,'K')), NASAPolynomial(coeffs=[15.8264,0.0448082,-1.85917e-05,3.31145e-09,-2.18378e-13,-30900.7,-52.2168], Tmin=(1937.41,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-208.718,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH)"""),
)
...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.542945,0.0700638,-4.57866e-05,1.55828e-08,-2.20085e-12,9811.88,32.49], Tmin=(100,'K'), Tmax=(1603.96,'K')), NASAPolynomial(coeffs=[13.9896,0.0365301,-1.44262e-05,2.54818e-09,-1.69216e-13,5498.33,-38.7353], Tmin=(1603.96,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(80.5077,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(CsJOCC) + radical(CCJCO)"""),
)

species(
    label = '[CH2]OCC([CH2])CCC(1873)',
    structure = SMILES('[CH2]OCC([CH2])CCC'),
    E0 = (56.2134,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (114.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.108993,0.0875038,-6.53915e-05,2.74575e-08,-4.90202e-12,6911.03,36.0715], Tmin=(100,'K'), Tmax=(1288.39,'K')), NASAPolynomial(coeffs=[12.7739,0.0475073,-1.88261e-05,3.36273e-09,-2.26689e-13,3591.38,-29.3454], Tmin=(1288.39,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(56.2134,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(CsJOCC) + radical(Isobutyl)"""),
)

species(
    label = 'CCCCC1COC1(997)',
    ...
    molecularWeight = (114.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.491621,0.0627381,1.43798e-05,-6.08102e-08,2.84059e-11,-23972.8,28.0699], Tmin=(100,'K'), Tmax=(926.787,'K')), NASAPolynomial(coeffs=[13.4738,0.0434487,-1.38663e-05,2.28379e-09,-1.52381e-13,-27957.1,-42.0873], Tmin=(926.787,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-200.482,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(515.497,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Oxetane)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', '[CH2]OCC=CCCC(1860)'],
    products = ['[CH2]OC[CH]CCCC(994)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', '[CH2]OC=CCCCC(1861)'],
    products = ['[CH2]OC[CH]CCCC(994)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['npropyl(83)', '[CH2]OCC=C(1681)'],
    products = ['[CH2]OC[CH]CCCC(994)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction19',
    reactants = ['CH2(S)(23)', '[CH2]OC[CH]CCC(1000)'],
    products = ['[CH2]OC[CH]CCCC(994)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2]OCC([CH2])CCC(1873)'],
    products = ['[CH2]OC[CH]CCCC(994)'],
...
reaction(
    label = 'reaction22',
    reactants = ['CH2(19)', 'CCCC[CH]C[O](1762)'],
    products = ['[CH2]OC[CH]CCCC(994)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH2]O[CH2](103)', '[CH]CCCC(141)'],
    products = ['[CH2]OC[CH]CCCC(994)'],
