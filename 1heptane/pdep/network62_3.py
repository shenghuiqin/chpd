...
species(
    ...
    E0 = (-27.3802,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3615,1310,387.5,850,1000,3000,3100,440,815,1455,1000,289.998,2078.78],'cm^-1')),
        HinderedRotor(inertia=(0.00200452,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.717646,'amu*angstrom^2'), symmetry=1, barrier=(42.8277,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.161089,'amu*angstrom^2'), symmetry=1, barrier=(9.61352,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.161089,'amu*angstrom^2'), symmetry=1, barrier=(9.61355,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.405615,'amu*angstrom^2'), symmetry=1, barrier=(24.2066,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (89.1131,'amu'),
...
species(
    label = 'C[CH][CH]COO(308)',
    structure = SMILES('C[CH][CH]COO'),
    E0 = (162.235,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3000,3050,390,425,1340,1360,335,370,3615,1310,387.5,850,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,180,3070.01],'cm^-1')),
        HinderedRotor(inertia=(1.82788,'amu*angstrom^2'), symmetry=1, barrier=(42.0267,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00627932,'amu*angstrom^2'), symmetry=1, barrier=(42.0177,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.161571,'amu*angstrom^2'), symmetry=1, barrier=(3.71484,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (88.1051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.29794,0.0654316,-8.55343e-05,7.44939e-08,-2.70526e-11,19603.8,27.8082], Tmin=(100,'K'), Tmax=(804.143,'K')), NASAPolynomial(coeffs=[4.60467,0.0391518,-1.81748e-05,3.44674e-09,-2.38096e-13,19389.9,14.5524], Tmin=(804.143,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(162.235,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCJCOOH) + radical(RCCJC)"""),
)
...
species(
    label = '[CH2][CH]CCOO(310)',
    structure = SMILES('[CH2][CH]CCOO'),
    E0 = (167.066,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3615,1310,387.5,850,1000,3000,3100,440,815,1455,1000,3025,407.5,1350,352.5,1842.41,1843.45],'cm^-1')),
        HinderedRotor(inertia=(0.204753,'amu*angstrom^2'), symmetry=1, barrier=(9.22363,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.208519,'amu*angstrom^2'), symmetry=1, barrier=(9.26148,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00383821,'amu*angstrom^2'), symmetry=1, barrier=(9.25006,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.12134,'amu*angstrom^2'), symmetry=1, barrier=(49.1916,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.07868,'amu*angstrom^2'), symmetry=1, barrier=(49.2764,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (88.1051,'amu'),
...
species(
    label = '[CH2]C(C)COO(312)',
    structure = SMILES('[CH2]C(C)COO'),
    E0 = (-36.5857,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1310,387.5,850,1000,3000,3100,440,815,1455,1000,1380,1390,370,380,2900,435,199.379],'cm^-1')),
        HinderedRotor(inertia=(0.457221,'amu*angstrom^2'), symmetry=1, barrier=(12.9746,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00423632,'amu*angstrom^2'), symmetry=1, barrier=(0.119751,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.458367,'amu*angstrom^2'), symmetry=1, barrier=(12.976,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.64437,'amu*angstrom^2'), symmetry=1, barrier=(74.8234,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0267402,'amu*angstrom^2'), symmetry=1, barrier=(74.8241,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (89.1131,'amu'),
...
species(
    label = '[CH2]C[CH]COO(2082)',
    structure = SMILES('[CH2]C[CH]COO'),
    E0 = (173.035,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3615,1310,387.5,850,1000,3000,3100,440,815,1455,1000,3025,407.5,1350,352.5,359.746,2020.54],'cm^-1')),
        HinderedRotor(inertia=(0.00355485,'amu*angstrom^2'), symmetry=1, barrier=(10.3,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.412618,'amu*angstrom^2'), symmetry=1, barrier=(37.9518,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.112283,'amu*angstrom^2'), symmetry=1, barrier=(10.2948,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.111948,'amu*angstrom^2'), symmetry=1, barrier=(10.298,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.411175,'amu*angstrom^2'), symmetry=1, barrier=(37.9524,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (88.1051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.33069,0.0634044,-6.62501e-05,4.25938e-08,-1.19396e-11,20903.3,26.7584], Tmin=(100,'K'), Tmax=(840.727,'K')), NASAPolynomial(coeffs=[7.18344,0.0355588,-1.65699e-05,3.20006e-09,-2.25637e-13,19919.2,-0.462476], Tmin=(840.727,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(173.035,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCJCOOH) + radical(RCCJ)"""),
)
...
species(
    label = 'C1CCOC1(2084)',
    structure = SMILES('C1CCOC1'),
    E0 = (-198.562,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (72.1057,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.95658,0.00679407,8.96491e-05,-1.21626e-07,4.87548e-11,-23828.7,11.2647], Tmin=(100,'K'), Tmax=(894.417,'K')), NASAPolynomial(coeffs=[9.31094,0.0203815,-3.58381e-06,3.74509e-10,-2.23399e-14,-26645.6,-28.075], Tmin=(894.417,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-198.562,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(307.635,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + ring(Tetrahydrofuran)"""),
)

species(
    label = '[O]CCCCO(2085)',
    structure = SMILES('[O]CCCCO'),
    E0 = (-238.254,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (89.1131,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.3875,0.0632506,-7.66222e-05,6.6697e-08,-2.48614e-11,-28566.8,25.2487], Tmin=(100,'K'), Tmax=(792.314,'K')), NASAPolynomial(coeffs=[3.62181,0.0425533,-1.96094e-05,3.72396e-09,-2.58028e-13,-28625.3,16.8549], Tmin=(792.314,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-238.254,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + radical(CCOJ)"""),
)
...
reaction(
    label = 'reaction23',
    reactants = ['[CH2]C[CH]C(129)', 'HO2(10)'],
    products = ['C[CH]CCOO(267)'],
...
reaction(
    label = 'reaction25',
    reactants = ['C3H6(T)(143)', 'CH2OOH(35)'],
    products = ['C[CH]CCOO(267)'],
...
reaction(
    label = 'reaction27',
    reactants = ['H(3)', 'C[CH]C[CH]OO(309)'],
    products = ['C[CH]CCOO(267)'],
...
reaction(
    label = 'reaction29',
    reactants = ['C[CH]CCOO(267)'],
    products = ['OH(5)', 'CC1CCO1(311)'],
...
reaction(
    label = 'reaction32',
    reactants = ['CH2CH2OOH(45)', 'CHCH3(T)(95)'],
    products = ['C[CH]CCOO(267)'],
...
reaction(
    label = 'reaction36',
    reactants = ['C2H4(21)', 'CH2CH2OOH(45)'],
    products = ['[CH2]CCCOO(268)'],
...
reaction(
    label = 'reaction40',
    reactants = ['[CH2]CC[CH2](131)', 'HO2(10)'],
    products = ['[CH2]CCCOO(268)'],
...
reaction(
    label = 'reaction42',
    reactants = ['CH2CH2OOH(45)', 'C2H4(T)(94)'],
    products = ['[CH2]CCCOO(268)'],
...
reaction(
    label = 'reaction43',
    reactants = ['[CH2]C[CH2](128)', 'CH2OOH(35)'],
    products = ['[CH2]CCCOO(268)'],
    transitionState = 'TS43',
    kinetics = Arrhenius(A=(2.67556e+08,'m^3/(mol*s)'), n=-0.3495, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [C_pri_rad;C_rad/H2/Cs] for rate rule [C_rad/H2/O;C_rad/H2/Cs]
Euclidian distance = 1.0
Multiplied by reaction path degeneracy 2.0
family: R_Recombination
Ea raised from -0.3 to 0 kJ/mol."""),
...
reaction(
    label = 'reaction44',
    reactants = ['H(3)', '[CH2]C[CH]COO(2082)'],
    products = ['[CH2]CCCOO(268)'],
...
reaction(
    label = 'reaction46',
    reactants = ['H(3)', '[CH2]CC[CH]OO(2083)'],
    products = ['[CH2]CCCOO(268)'],
...
reaction(
    label = 'reaction48',
    reactants = ['[CH2]CCCOO(268)'],
    products = ['[O]CCCCO(2085)'],
    transitionState = 'TS48',
    kinetics = Arrhenius(A=(1.12e+10,'s^-1'), n=0, Ea=(68.1992,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""Matched reaction 6 C4H9O2-3 <=> C4H9O2-4 in intra_OH_migration/training
This reaction matched rate rule [R4OOH_SSS;C_rad_out_2H]
family: intra_OH_migration"""),
)

reaction(
    label = 'reaction49',
    reactants = ['QOOH_1(290)', 'CH2(19)'],
    products = ['[CH2]CCCOO(268)'],
