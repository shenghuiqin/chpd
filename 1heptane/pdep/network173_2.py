...
reaction(
    label = 'reaction4',
    reactants = ['OH(5)', 'CO(12)'],
    products = ['HOCO(14)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(1.1e+20,'cm^3/(mol*s)'), n=-2.78, Ea=(2056,'cal/mol'), T0=(1,'K')),
)
...
reaction(
    ...
    products = ['H(3)', 'CO2(13)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(8.2e+11,'s^-1'), n=0.413, Ea=(35335,'cal/mol'), T0=(1,'K'), comment="""Kinetics taken from the arrheniusHigh attribute of a Troe/Lindemann exprssion. Originally from reaction library Klippenstein_Glarborg2016"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', '[O][C]=O(669)'],
    products = ['HOCO(14)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(8.69202e+06,'m^3/(mol*s)'), n=0.278532, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Y_rad]
...
reaction(
    ...
    products = ['H(3)', 'CO2(13)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(1e+10,'s^-1'), n=0, Ea=(0,'cal/mol'), T0=(1,'K'), comment="""Reaction library: 'Klippenstein_Glarborg2016'"""),
)
...
reaction(
    label = 'reaction4',
    reactants = ['OCHO(66)'],
    products = ['[CH]1OO1(670)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(1.55936e+11,'s^-1'), n=0.551275, Ea=(311.729,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R3_linear;multiplebond_intra;radadd_intra] for rate rule [R3_CO;carbonyl_intra_H;radadd_intra_O]
Euclidian distance = 2.44948974278
family: Intra_R_Add_Endocyclic
Ea raised from 310.6 to 311.7 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction5',
    reactants = ['O(4)', 'HCO(16)'],
    products = ['OCHO(66)'],
    transitionState = 'TS9',
