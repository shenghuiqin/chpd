...
species(
    label = 'CCCC=CCO[O](7755)',
    structure = SMILES('CCCC=CCO[O]'),
    E0 = (-5.95373,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2995,3025,975,1000,1300,1375,400,500,1630,1680,492.5,1135,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.797303,0.0738211,-5.36824e-05,2.19006e-08,-3.94045e-12,-603.824,30.899], Tmin=(100,'K'), Tmax=(1230.02,'K')), NASAPolynomial(coeffs=[9.21056,0.0464611,-2.03167e-05,3.81632e-09,-2.64807e-13,-2673.5,-11.4318], Tmin=(1230.02,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-5.95373,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(ROOJ)"""),
)

species(
    label = 'CCCCC=CO[O](7756)',
    ...
    molecularWeight = (115.15,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.146853,0.079049,-6.10659e-05,2.51498e-08,-4.26645e-12,579.196,33.0597], Tmin=(100,'K'), Tmax=(1378.74,'K')), NASAPolynomial(coeffs=[14.9314,0.0361551,-1.43986e-05,2.58419e-09,-1.74657e-13,-3497.54,-43.0154], Tmin=(1378.74,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(3.62461,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(ROOJ)"""),
)
...
species(
    label = 'CCC[CH][CH]COO(7758)',
    structure = SMILES('CCC[CH][CH]COO'),
    E0 = (114.686,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3000,3050,390,425,1340,1360,335,370,3615,1310,387.5,850,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'C[CH]CC[CH]COO(7760)',
    structure = SMILES('C[CH]CC[CH]COO'),
    E0 = (114.674,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3000,3050,390,425,1340,1360,335,370,3615,1310,387.5,850,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (116.158,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.997943,0.0789727,-2.77931e-05,-9.14149e-08,1.02886e-10,13886.9,33.6062], Tmin=(100,'K'), Tmax=(472.882,'K')), NASAPolynomial(coeffs=[6.29236,0.0563008,-2.6018e-05,4.96709e-09,-3.46314e-13,13138.9,9.41461], Tmin=(472.882,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(114.674,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCJCOOH) + radical(RCCJC)"""),
)

species(
    label = '[CH2]CCC[CH]COO(7761)',
    structure = SMILES('[CH2]CCC[CH]COO'),
    E0 = (125.474,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (116.158,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.117025,0.0919692,-9.01787e-05,5.35512e-08,-1.39131e-11,15225.3,35.6108], Tmin=(100,'K'), Tmax=(899.618,'K')), NASAPolynomial(coeffs=[9.01551,0.052405,-2.42125e-05,4.66822e-09,-3.29213e-13,13624.2,-6.37821], Tmin=(899.618,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(125.474,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(RCCJ) + radical(CCJCOOH)"""),
)
...
species(
    label = 'CCCC=CCOO(7763)',
    structure = SMILES('CCCC=CCOO'),
    E0 = (-157.958,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (116.158,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.40217,0.0790124,-5.46091e-05,1.96359e-08,-2.97731e-12,-18869.1,31.5516], Tmin=(100,'K'), Tmax=(1471.02,'K')), NASAPolynomial(coeffs=[13.2032,0.0442041,-1.91154e-05,3.55025e-09,-2.43572e-13,-22635.2,-35.1466], Tmin=(1471.02,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-157.958,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH)"""),
)
...
species(
    label = 'CCCCC1CO1(7764)',
    structure = SMILES('CCCCC1CO1'),
    E0 = (-174.771,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (100.159,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.763928,0.060725,-5.46523e-06,-3.73645e-08,2.05112e-11,-20893.8,25.1093], Tmin=(100,'K'), Tmax=(900.188,'K')), NASAPolynomial(coeffs=[12.9145,0.0352716,-1.0605e-05,1.65921e-09,-1.06999e-13,-24237.7,-38.655], Tmin=(900.188,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-174.771,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(440.667,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Ethylene_oxide)"""),
)

species(
    label = '[CH2]C(CCC)CO[O](7765)',
    ...
    molecularWeight = (116.158,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.168356,0.0870957,-7.98368e-05,4.40808e-08,-1.0483e-11,8699.66,33.5824], Tmin=(100,'K'), Tmax=(987.314,'K')), NASAPolynomial(coeffs=[9.88941,0.0477118,-2.00019e-05,3.67836e-09,-2.52548e-13,6780.12,-13.1919], Tmin=(987.314,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(71.2057,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(Isobutyl)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['CCCC[CH]CO[O](387)'],
    products = ['C=CCCCC(193)', 'O2(S)(4921)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'CCCC=CCO[O](7755)'],
    products = ['CCCC[CH]CO[O](387)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['npropyl(83)', 'allylperoxy(5703)'],
    products = ['CCCC[CH]CO[O](387)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction16',
    reactants = ['O2(2)', '[CH2][CH]CCCC(197)'],
    products = ['CCCC[CH]CO[O](387)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CCC[CH]CO[O](280)', 'CH2(S)(23)'],
    products = ['CCCC[CH]CO[O](387)'],
