species(
    label = 'CCCC[CH]OO[C]=O(13145)',
    structure = SMILES('CCCC[CH]OO[C]=O'),
    E0 = (-115.959,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,1855,455,950,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,200,800,1600],'cm^-1')),
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.687582,0.0930663,-7.50648e-05,3.04025e-08,-4.94188e-12,-13769.8,35.8671], Tmin=(100,'K'), Tmax=(1457.45,'K')), NASAPolynomial(coeffs=[20.7919,0.0341152,-1.43923e-05,2.64957e-09,-1.8133e-13,-20030.8,-75.85], Tmin=(1457.45,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-115.959,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(428.195,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-O2d)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdOsH) + radical(CCsJOOC) + radical((O)CJOC)"""),
)
...
species(
    label = 'CCCC=COO[C]=O(13943)',
    structure = SMILES('CCCC=COO[C]=O'),
    E0 = (-170.593,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2995,3025,975,1000,1300,1375,400,500,1630,1680,1855,455,950,2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,200,800],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.329899,0.0782356,-3.09808e-05,-2.17015e-08,1.51047e-11,-20346.7,35.1876], Tmin=(100,'K'), Tmax=(1000.51,'K')), NASAPolynomial(coeffs=[21.7821,0.0272061,-1.05076e-05,1.99257e-09,-1.45081e-13,-26641.9,-80.8493], Tmin=(1000.51,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-170.593,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(407.409,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-O2s(Cds-O2d)) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-OdOsH) + radical((O)CJOC)"""),
)
...
species(
    label = 'CCC[CH]COO[C]=O(13944)',
    structure = SMILES('CCC[CH]COO[C]=O'),
    E0 = (-101.985,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,1855,455,950,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (130.142,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.632235,0.0928409,-7.55904e-05,3.09618e-08,-5.09679e-12,-12091.9,37.6757], Tmin=(100,'K'), Tmax=(1438.32,'K')), NASAPolynomial(coeffs=[20.3844,0.0343933,-1.46364e-05,2.70941e-09,-1.86134e-13,-18137.6,-71.3563], Tmin=(1438.32,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-101.985,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(428.195,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-O2d)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdOsH) + radical(CCJCOOH) + radical((O)CJOC)"""),
)

species(
    label = 'CC[CH]CCOO[C]=O(13945)',
    structure = SMILES('CC[CH]CCOO[C]=O'),
    E0 = (-107.942,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,1855,455,950,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (130.142,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0426667,0.0862052,-6.65951e-05,2.67638e-08,-4.48285e-12,-12839.7,35.5], Tmin=(100,'K'), Tmax=(1368.57,'K')), NASAPolynomial(coeffs=[14.8965,0.0427912,-1.90123e-05,3.58509e-09,-2.48779e-13,-16905.4,-40.8222], Tmin=(1368.57,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-107.942,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(428.195,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-O2d)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdOsH) + radical((O)CJOC) + radical(RCCJCC)"""),
)

species(
    label = 'C[CH]CCCOO[C]=O(13946)',
    structure = SMILES('C[CH]CCCOO[C]=O'),
    E0 = (-107.954,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,1855,455,950,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (130.142,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.18079,0.087881,-6.87568e-05,2.77482e-08,-4.60281e-12,-12830.3,36.4769], Tmin=(100,'K'), Tmax=(1400.26,'K')), NASAPolynomial(coeffs=[16.6648,0.0397592,-1.72067e-05,3.20483e-09,-2.20841e-13,-17547.9,-50.4645], Tmin=(1400.26,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-107.954,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(428.195,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-O2d)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdOsH) + radical(RCCJC) + radical((O)CJOC)"""),
)

species(
    label = 'CCC[CH][CH]OOC=O(13947)',
    structure = SMILES('CCC[CH][CH]OOC=O'),
    E0 = (-111.993,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (130.142,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.570329,0.0885019,-6.60363e-05,2.41638e-08,-3.53297e-12,-13295.2,39.1383], Tmin=(100,'K'), Tmax=(1608.32,'K')), NASAPolynomial(coeffs=[21.9138,0.0325825,-1.38833e-05,2.54587e-09,-1.7266e-13,-20527.6,-80.019], Tmin=(1608.32,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-111.993,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(428.195,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-O2d)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdOsH) + radical(CCJCOOH) + radical(CCsJOOC)"""),
)

species(
    label = '[CH2]CCCCOO[C]=O(13948)',
    structure = SMILES('[CH2]CCCCOO[C]=O'),
    E0 = (-97.1536,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,1855,455,950,3000,3100,440,815,1455,1000,2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (130.142,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.768587,0.0932065,-7.55497e-05,3.06031e-08,-4.94985e-12,-11503.6,37.6531], Tmin=(100,'K'), Tmax=(1471.32,'K')), NASAPolynomial(coeffs=[21.642,0.0322802,-1.3436e-05,2.45901e-09,-1.67737e-13,-18098.3,-79.1191], Tmin=(1471.32,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-97.1536,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(428.195,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-O2d)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdOsH) + radical((O)CJOC) + radical(RCCJ)"""),
)

species(
    label = 'CC[CH]C[CH]OOC=O(13949)',
    structure = SMILES('CC[CH]C[CH]OOC=O'),
    E0 = (-117.949,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (130.142,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.164397,0.0813277,-5.57542e-05,1.8876e-08,-2.61952e-12,-14046.3,36.734], Tmin=(100,'K'), Tmax=(1625.7,'K')), NASAPolynomial(coeffs=[16.8804,0.0401982,-1.78047e-05,3.31367e-09,-2.26329e-13,-19481.3,-52.0338], Tmin=(1625.7,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-117.949,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(428.195,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-O2d)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdOsH) + radical(RCCJCC) + radical(CCsJOOC)"""),
)

species(
    label = 'C[CH]CC[CH]OOC=O(13950)',
    structure = SMILES('C[CH]CC[CH]OOC=O'),
    E0 = (-117.961,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (130.142,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.089353,0.0832769,-5.85719e-05,2.04185e-08,-2.89365e-12,-14035.3,37.8266], Tmin=(100,'K'), Tmax=(1619.52,'K')), NASAPolynomial(coeffs=[18.4215,0.0375577,-1.62269e-05,2.98753e-09,-2.02897e-13,-20031,-60.4024], Tmin=(1619.52,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-117.961,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(428.195,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-O2d)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdOsH) + radical(CCsJOOC) + radical(RCCJC)"""),
)

species(
    label = '[CH2]CCC[CH]OOC=O(13951)',
    structure = SMILES('[CH2]CCC[CH]OOC=O'),
    E0 = (-107.161,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2782.5,750,1395,475,1775,1000,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (130.142,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.728719,0.0890703,-6.64969e-05,2.42442e-08,-3.51019e-12,-12705.8,39.1994], Tmin=(100,'K'), Tmax=(1635.44,'K')), NASAPolynomial(coeffs=[23.2829,0.0303425,-1.26331e-05,2.28745e-09,-1.53818e-13,-20559.8,-88.4546], Tmin=(1635.44,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-107.161,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(428.195,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-O2d)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdOsH) + radical(RCCJ) + radical(CCsJOOC)"""),
)
...
species(
    label = 'CCCC=COOC=O(13952)',
    structure = SMILES('CCCC=COOC=O'),
    E0 = (-367.041,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (130.142,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.117528,0.0704282,-2.68449e-06,-5.02856e-08,2.46159e-11,-43978.8,35.7984], Tmin=(100,'K'), Tmax=(998.787,'K')), NASAPolynomial(coeffs=[21.4875,0.0302295,-1.18871e-05,2.29585e-09,-1.69308e-13,-50605.3,-79.9749], Tmin=(998.787,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-367.041,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-O2s(Cds-O2d)) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-OdOsH)"""),
)
...
species(
    label = 'CCC[CH]OO[C]=O(13953)',
    structure = SMILES('CCC[CH]OO[C]=O'),
    E0 = (-92.179,'kJ/mol'),
    modes = [
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.135114,0.0792856,-6.42967e-05,2.5836e-08,-4.12278e-12,-10928,31.6465], Tmin=(100,'K'), Tmax=(1497.28,'K')), NASAPolynomial(coeffs=[19.927,0.0256893,-1.06028e-05,1.92858e-09,-1.30969e-13,-16935.7,-73.2396], Tmin=(1497.28,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-92.179,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-O2d)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdOsH) + radical(CCsJOOC) + radical((O)CJOC)"""),
)

species(
    label = '[CH2]C(CCC)OO[C]=O(13954)',
    structure = SMILES('[CH2]C(CCC)OO[C]=O'),
    E0 = (-101.08,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,1855,455,950,1380,1390,370,380,2900,435,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,350,500,795,815,3000,3100,440,815,1455,1000,200,800],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (130.142,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.860046,0.0930168,-6.81492e-05,1.85815e-08,8.52676e-14,-11970.4,37.8349], Tmin=(100,'K'), Tmax=(1098.99,'K')), NASAPolynomial(coeffs=[21.6687,0.0318617,-1.31277e-05,2.46169e-09,-1.73479e-13,-18180.9,-78.7065], Tmin=(1098.99,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-101.08,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(428.195,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-O2d)) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdOsH) + radical(CJCOOH) + radical((O)CJOC)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['CCCC[CH]OO[C]=O(13145)'],
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'CCCC=COO[C]=O(13943)'],
    products = ['CCCC[CH]OO[C]=O(13145)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['npropyl(83)', 'C=COO[C]=O(745)'],
    products = ['CCCC[CH]OO[C]=O(13145)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CCC[CH]COO[C]=O(13944)'],
    products = ['CCCC[CH]OO[C]=O(13145)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CC[CH]CCOO[C]=O(13945)'],
    products = ['CCCC[CH]OO[C]=O(13145)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['C[CH]CCCOO[C]=O(13946)'],
    products = ['CCCC[CH]OO[C]=O(13145)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['CCCC[CH]OO[C]=O(13145)'],
    products = ['CCC[CH][CH]OOC=O(13947)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]CCCCOO[C]=O(13948)'],
    products = ['CCCC[CH]OO[C]=O(13145)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['CCCC[CH]OO[C]=O(13145)'],
    products = ['CC[CH]C[CH]OOC=O(13949)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(8.93443e+06,'s^-1'), n=0.836584, Ea=(61.225,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R6Hall;Y_rad_out;Cs_H_out_H/NonDeC] for rate rule [R6HJ_3;CO_rad_out;Cs_H_out_H/(NonDeC/Cs)]
Euclidian distance = 1.73205080757
Multiplied by reaction path degeneracy 2.0
family: intra_H_migration"""),
)
...
reaction(
    label = 'reaction10',
    reactants = ['CCCC[CH]OO[C]=O(13145)'],
    products = ['C[CH]CC[CH]OOC=O(13950)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]CCC[CH]OOC=O(13951)'],
    products = ['CCCC[CH]OO[C]=O(13145)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CH2(S)(23)', 'CCC[CH]OO[C]=O(13953)'],
    products = ['CCCC[CH]OO[C]=O(13145)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]C(CCC)OO[C]=O(13954)'],
    products = ['CCCC[CH]OO[C]=O(13145)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CCCC[CH]O[O](239)', 'CO(12)'],
    products = ['CCCC[CH]OO[C]=O(13145)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CO3t2(123)', '[CH]CCCC(141)'],
    products = ['CCCC[CH]OO[C]=O(13145)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CCCC[CH]O[O](239)', '[C]=O(361)'],
    products = ['CCCC[CH]OO[C]=O(13145)'],
