...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.03454,0.0736304,-4.3386e-05,1.31702e-08,-1.77433e-12,-3577.88,30.5586], Tmin=(100,'K'), Tmax=(1472.68,'K')), NASAPolynomial(coeffs=[7.89831,0.0549874,-2.43972e-05,4.57421e-09,-3.15085e-13,-5599.51,-5.21201], Tmin=(1472.68,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-30.568,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(486.397,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(CCOJ)"""),
)
...
species(
    ...
    molecularWeight = (114.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.762802,0.0753822,-4.02021e-05,9.97168e-09,-9.88e-13,-236.435,31.4066], Tmin=(100,'K'), Tmax=(2169.33,'K')), NASAPolynomial(coeffs=[18.0264,0.0435495,-1.81908e-05,3.20715e-09,-2.08421e-13,-7726.38,-65.2491], Tmin=(2169.33,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-2.88752,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(CCJ(C)CO)"""),
)
...
species(
    ...
    molecularWeight = (114.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.674362,0.0801728,-5.82043e-05,2.9628e-08,-8.02344e-12,4813.91,34.1464], Tmin=(100,'K'), Tmax=(780.151,'K')), NASAPolynomial(coeffs=[3.49194,0.0657264,-3.04279e-05,5.89194e-09,-4.17164e-13,4374.28,21.2527], Tmin=(780.151,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(39.0807,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(Cs_S)"""),
)

species(
    label = 'CCCCC(C)[CH][O](1848)',
    ...
    molecularWeight = (114.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.200708,0.090365,-7.91593e-05,4.55699e-08,-1.22026e-11,3118.04,32.8343], Tmin=(100,'K'), Tmax=(850.628,'K')), NASAPolynomial(coeffs=[6.39409,0.0612417,-2.7804e-05,5.32174e-09,-3.73855e-13,2064.37,3.95662], Tmin=(850.628,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(24.8364,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCsJOH) + radical(CCOJ)"""),
)

species(
    label = '[CH2][C](CO)CCCC(1849)',
    ...
    molecularWeight = (114.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.107091,0.0857311,-6.04468e-05,2.33325e-08,-3.80555e-12,-2676.28,35.4779], Tmin=(100,'K'), Tmax=(1399.57,'K')), NASAPolynomial(coeffs=[13.6599,0.0463849,-1.82772e-05,3.24562e-09,-2.17512e-13,-6529.86,-35.5677], Tmin=(1399.57,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-23.5103,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Isobutyl) + radical(CCJ(C)CO)"""),
)

species(
    label = '[CH2]C([CH]CCC)CO(1850)',
    ...
    molecularWeight = (114.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.177951,0.086783,-6.77199e-05,3.12038e-08,-6.34359e-12,2355.25,36.8227], Tmin=(100,'K'), Tmax=(1116.92,'K')), NASAPolynomial(coeffs=[9.60704,0.0530147,-2.23696e-05,4.13497e-09,-2.84766e-13,248.95,-9.70979], Tmin=(1116.92,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(18.4579,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Cs_S) + radical(Isobutyl)"""),
)

species(
    label = 'CC[CH]CC(C)C[O](1851)',
    ...
    molecularWeight = (114.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.11706,0.0681726,-3.20494e-05,6.39195e-09,-4.76892e-13,4728.36,28.7635], Tmin=(100,'K'), Tmax=(3238.88,'K')), NASAPolynomial(coeffs=[50.0469,0.0089792,-4.63538e-06,7.49233e-10,-4.13442e-14,-26319.3,-258.799], Tmin=(3238.88,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(38.9969,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(CCOJ)"""),
)

species(
    label = '[CH2]C(CO)C[CH]CC(1852)',
    ...
    molecularWeight = (114.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.149738,0.0894035,-8.28825e-05,5.18322e-08,-1.46607e-11,2344.29,36.9417], Tmin=(100,'K'), Tmax=(824.592,'K')), NASAPolynomial(coeffs=[6.78659,0.0572104,-2.43234e-05,4.4905e-09,-3.0834e-13,1249.7,6.20244], Tmin=(824.592,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(18.3741,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Isobutyl) + radical(RCCJCC)"""),
)

species(
    label = 'C[CH]CCC(C)C[O](1853)',
    ...
    molecularWeight = (114.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.427156,0.084992,-8.01375e-05,6.13749e-08,-2.2767e-11,4811.41,35.1887], Tmin=(100,'K'), Tmax=(735.851,'K')), NASAPolynomial(coeffs=[2.9387,0.0658394,-2.9884e-05,5.68858e-09,-3.97023e-13,4590.7,24.8542], Tmin=(735.851,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(38.9849,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(RCCJC)"""),
)

species(
    label = '[CH2]C(CO)CC[CH]C(1854)',
...
species(
    ...
    molecularWeight = (114.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.675846,0.0806429,-5.35373e-05,2.04861e-08,-3.70161e-12,6100.95,33.3473], Tmin=(100,'K'), Tmax=(1145.4,'K')), NASAPolynomial(coeffs=[6.42235,0.0605748,-2.72565e-05,5.18974e-09,-3.62969e-13,4784.53,4.84358], Tmin=(1145.4,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(49.7849,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJ) + radical(CCOJ)"""),
)

species(
    label = '[CH2]CCCC([CH2])CO(1856)',
...
species(
    ...
    molecularWeight = (114.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.011246,0.0841199,-5.69371e-05,2.02986e-08,-3.03161e-12,-30675.3,33.4749], Tmin=(100,'K'), Tmax=(1511.22,'K')), NASAPolynomial(coeffs=[14.6298,0.0453668,-1.84716e-05,3.3297e-09,-2.24451e-13,-35100.4,-43.2054], Tmin=(1511.22,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-256.273,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH)"""),
)

species(
    label = 'CCCCC(C)C=O(1858)',
    ...
    molecularWeight = (114.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.255965,0.0808227,-5.01296e-05,1.58225e-08,-2.08928e-12,-36452.3,31.6623], Tmin=(100,'K'), Tmax=(1658.51,'K')), NASAPolynomial(coeffs=[14.2644,0.0470372,-1.95732e-05,3.53985e-09,-2.37826e-13,-41099,-43.0074], Tmin=(1658.51,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-304.205,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdCsH)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'C=C(C[O])CCCC(1843)'],
    products = ['[CH2]C(C[O])CCCC(993)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', '[CH2]C(C=O)CCCC(1844)'],
    products = ['[CH2]C(C[O])CCCC(993)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['butyl_1(82)', 'allyloxy(559)'],
    products = ['[CH2]C(C[O])CCCC(993)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]C([CH]CCC)CO(1850)'],
    products = ['[CH2]C(C[O])CCCC(993)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]C(C[O])CCCC(993)'],
    products = ['[CH2]C(CO)C[CH]CC(1852)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]C(C[O])CCCC(993)'],
    products = ['[CH2]C(CO)CC[CH]C(1854)'],
...
reaction(
    label = 'reaction22',
    reactants = ['CH2(S)(23)', '[CH2]C(C[O])CCC(999)'],
    products = ['[CH2]C(C[O])CCCC(993)'],
...
reaction(
    label = 'reaction27',
    reactants = ['O(4)', '[CH2]C([CH2])CCCC(488)'],
    products = ['[CH2]C(C[O])CCCC(993)'],
