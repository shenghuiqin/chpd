species(
    label = 'CCCC[CH]OC[CH]O(12328)',
    structure = SMILES('CCCC[CH]OC[CH]O'),
    E0 = (-143.787,'kJ/mol'),
    modes = [
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.40319,0.125967,-0.000156411,1.12872e-07,-3.35896e-11,-17105.6,38.8268], Tmin=(100,'K'), Tmax=(813.971,'K')), NASAPolynomial(coeffs=[13.2046,0.0541815,-2.41245e-05,4.52528e-09,-3.12367e-13,-19483.6,-28.6405], Tmin=(813.971,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-143.787,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(523.812,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCsJOH) + radical(CCsJOCs)"""),
)
...
species(
    label = 'CCCC=COC[CH]O(12698)',
    structure = SMILES('CCCC=COC[CH]O'),
    E0 = (-247.488,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (129.177,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.79413,0.113057,-0.000106595,5.1416e-08,-9.74795e-12,-29545.2,38.702], Tmin=(100,'K'), Tmax=(1287.48,'K')), NASAPolynomial(coeffs=[24.6573,0.0308776,-1.0851e-05,1.83947e-09,-1.21376e-13,-36356.4,-95.5952], Tmin=(1287.48,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-247.488,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(CCsJOH)"""),
)

species(
    label = 'CCCC[CH]OC=CO(12699)',
    structure = SMILES('CCCC[CH]OC=CO'),
    E0 = (-271.713,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2995,3025,975,1000,1300,1375,400,500,1630,1680,3025,407.5,1350,352.5,3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (129.177,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.02034,0.109856,-5.98549e-05,-2.6386e-08,2.55479e-11,-32441.9,36.359], Tmin=(100,'K'), Tmax=(925.917,'K')), NASAPolynomial(coeffs=[33.2128,0.0159955,-2.32531e-06,2.51201e-10,-2.02929e-14,-41467.7,-144.415], Tmin=(925.917,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-271.713,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + radical(CCsJOC(O))"""),
)
...
species(
    ...
    molecularWeight = (130.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.100086,0.100464,-6.3427e-05,-4.94927e-08,7.69246e-11,-11706.7,34.9422], Tmin=(100,'K'), Tmax=(501.937,'K')), NASAPolynomial(coeffs=[7.85008,0.0639207,-2.95827e-05,5.64951e-09,-3.93859e-13,-12802.4,-0.269578], Tmin=(501.937,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-98.38,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(527.969,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(CCsJOCs)"""),
)

species(
    label = 'CCC[CH]COC[CH]O(12701)',
    structure = SMILES('CCC[CH]COC[CH]O'),
    E0 = (-124.341,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,3000,3050,390,425,1340,1360,335,370,3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (130.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.780621,0.112138,-0.000122543,8.10796e-08,-2.28689e-11,-14788.8,39.65], Tmin=(100,'K'), Tmax=(845.043,'K')), NASAPolynomial(coeffs=[10.7049,0.0577716,-2.60383e-05,4.94581e-09,-3.45175e-13,-16730,-13.8271], Tmin=(845.043,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-124.341,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(523.812,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCsJOH) + radical(CCJCO)"""),
)

species(
    label = 'CCCC[CH]O[CH]CO(12702)',
    structure = SMILES('CCCC[CH]O[CH]CO'),
    E0 = (-143.629,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,3000,3050,390,425,1340,1360,335,370,3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (130.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.42641,0.12414,-0.000143967,9.35917e-08,-2.48477e-11,-17083.3,38.8068], Tmin=(100,'K'), Tmax=(911.651,'K')), NASAPolynomial(coeffs=[15.5453,0.0496724,-2.14374e-05,3.98704e-09,-2.74996e-13,-20177.7,-41.5016], Tmin=(911.651,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-143.629,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(523.812,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCsJOCs) + radical(CCsJOCs)"""),
)

species(
    label = 'CCCCCO[CH][CH]O(12703)',
    structure = SMILES('CCCCCO[CH][CH]O'),
    E0 = (-143.787,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,3000,3050,390,425,1340,1360,335,370,3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'CC[CH]CCOC[CH]O(12704)',
    structure = SMILES('CC[CH]CCOC[CH]O'),
    E0 = (-129.785,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,3000,3050,390,425,1340,1360,335,370,3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (130.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.00281,0.121489,-0.000169659,1.48376e-07,-5.26709e-11,-15440.4,40.4925], Tmin=(100,'K'), Tmax=(825.55,'K')), NASAPolynomial(coeffs=[6.45381,0.0649748,-2.9935e-05,5.6327e-09,-3.86212e-13,-15976.9,10.1553], Tmin=(825.55,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-129.785,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(523.812,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(CCsJOH)"""),
)

species(
    label = 'C[CH]CCCOC[CH]O(12705)',
    structure = SMILES('C[CH]CCCOC[CH]O'),
    E0 = (-129.797,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,3000,3050,390,425,1340,1360,335,370,3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (130.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.03474,0.120943,-0.000164186,1.39573e-07,-4.86254e-11,-15439.5,40.7795], Tmin=(100,'K'), Tmax=(819.489,'K')), NASAPolynomial(coeffs=[7.51916,0.0630721,-2.87542e-05,5.39554e-09,-3.69866e-13,-16300.2,4.51704], Tmin=(819.489,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-129.797,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(523.812,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(RCCJC) + radical(CCsJOH)"""),
)

species(
    label = 'CCC[CH][CH]OCCO(12706)',
    structure = SMILES('CCC[CH][CH]OCCO'),
    E0 = (-124.183,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,3000,3050,390,425,1340,1360,335,370,3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (130.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.83734,0.110808,-0.000112316,6.53553e-08,-1.5945e-11,-14765.3,39.7435], Tmin=(100,'K'), Tmax=(975.188,'K')), NASAPolynomial(coeffs=[13.3087,0.0527829,-2.30608e-05,4.33645e-09,-3.01744e-13,-17524.2,-28.1474], Tmin=(975.188,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-124.183,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(523.812,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCsJOCs) + radical(CCJCO)"""),
)

species(
    label = '[CH2]CCCCOC[CH]O(12707)',
    structure = SMILES('[CH2]CCCCOC[CH]O'),
    E0 = (-118.997,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (130.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.584237,0.112531,-0.000113474,4.75506e-08,5.3377e-12,-14158,38.3109], Tmin=(100,'K'), Tmax=(585.431,'K')), NASAPolynomial(coeffs=[9.91976,0.0598474,-2.7391e-05,5.21131e-09,-3.62935e-13,-15714.9,-9.53433], Tmin=(585.431,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-118.997,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(523.812,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCsJOH) + radical(RCCJ)"""),
)

species(
    label = 'CCCCCOC[CH][O](12708)',
    structure = SMILES('CCCCCOC[CH][O]'),
    E0 = (-98.5381,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2761.11,2772.22,2783.33,2794.44,2805.56,2816.67,2827.78,2838.89,2850,1425,1431.25,1437.5,1443.75,1450,1225,1237.5,1250,1262.5,1275,1270,1287.5,1305,1322.5,1340,700,725,750,775,800,300,325,350,375,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,180,180,180,180,1600,1604.95,2922.33,3200],'cm^-1')),
        HinderedRotor(inertia=(0.151682,'amu*angstrom^2'), symmetry=1, barrier=(3.48748,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.151682,'amu*angstrom^2'), symmetry=1, barrier=(3.48748,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.151682,'amu*angstrom^2'), symmetry=1, barrier=(3.48748,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.151682,'amu*angstrom^2'), symmetry=1, barrier=(3.48748,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.151682,'amu*angstrom^2'), symmetry=1, barrier=(3.48748,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (130.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.884616,0.118159,-0.000157735,1.37282e-07,-4.96954e-11,-11685.9,38.3652], Tmin=(100,'K'), Tmax=(796.834,'K')), NASAPolynomial(coeffs=[5.90832,0.0676542,-3.17791e-05,6.06392e-09,-4.20448e-13,-12247.6,10.4041], Tmin=(796.834,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-98.5381,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(527.969,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(CCsJOH)"""),
)

species(
    label = 'CC[CH]C[CH]OCCO(12709)',
    structure = SMILES('CC[CH]C[CH]OCCO'),
    E0 = (-129.627,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,3000,3050,390,425,1340,1360,335,370,3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (130.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.04404,0.119838,-0.000157666,1.29499e-07,-4.40488e-11,-15417.4,40.5395], Tmin=(100,'K'), Tmax=(808.548,'K')), NASAPolynomial(coeffs=[8.66876,0.0607026,-2.73949e-05,5.13105e-09,-3.51995e-13,-16625.7,-2.01435], Tmin=(808.548,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-129.627,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(523.812,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(CCsJOCs)"""),
)

species(
    label = 'C[CH]CC[CH]OCCO(12710)',
    structure = SMILES('C[CH]CC[CH]OCCO'),
    E0 = (-129.639,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,3000,3050,390,425,1340,1360,335,370,3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (130.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.06105,0.119096,-0.000151407,1.19514e-07,-3.94176e-11,-15417.1,40.7742], Tmin=(100,'K'), Tmax=(794.635,'K')), NASAPolynomial(coeffs=[9.69924,0.0588633,-2.62523e-05,4.90322e-09,-3.36444e-13,-16935.6,-7.45892], Tmin=(794.635,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-129.639,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(523.812,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(RCCJC) + radical(CCsJOCs)"""),
)

species(
    label = '[CH2]CCC[CH]OCCO(12711)',
    structure = SMILES('[CH2]CCC[CH]OCCO'),
    E0 = (-118.839,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2761.11,2772.22,2783.33,2794.44,2805.56,2816.67,2827.78,2838.89,2850,1425,1431.25,1437.5,1443.75,1450,1225,1237.5,1250,1262.5,1275,1270,1287.5,1305,1322.5,1340,700,725,750,775,800,300,325,350,375,400,3615,1277.5,1000,3000,3100,440,815,1455,1000,3025,407.5,1350,352.5,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (130.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.025,0.117047,-0.000132121,8.77157e-08,-2.43909e-11,-14117.8,39.7116], Tmin=(100,'K'), Tmax=(862.893,'K')), NASAPolynomial(coeffs=[12.3176,0.055195,-2.46004e-05,4.64481e-09,-3.2297e-13,-16420.4,-22.6912], Tmin=(862.893,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-118.839,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(523.812,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(RCCJ) + radical(CCsJOCs)"""),
)
...
species(
    label = 'CCCCCOC=CO(12712)',
    structure = SMILES('CCCCCOC=CO'),
    E0 = (-465.64,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (130.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.66066,0.10056,-3.33869e-05,-4.83841e-08,3.16405e-11,-55777.8,35.5937], Tmin=(100,'K'), Tmax=(934.59,'K')), NASAPolynomial(coeffs=[30.7451,0.0224158,-5.15134e-06,7.98333e-10,-5.94305e-14,-64479.4,-132.701], Tmin=(934.59,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-465.64,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(527.969,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsOsH)"""),
)

species(
    label = 'CCCC=COCCO(12713)',
    structure = SMILES('CCCC=COCCO'),
    E0 = (-427.786,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (130.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.29474,0.10172,-6.68971e-05,9.04249e-09,5.31165e-12,-51247.2,37.3538], Tmin=(100,'K'), Tmax=(1007.93,'K')), NASAPolynomial(coeffs=[22.461,0.0366246,-1.34465e-05,2.41134e-09,-1.67699e-13,-57518.2,-84.7942], Tmin=(1007.93,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-427.786,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(527.969,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH)"""),
)

species(
    label = 'CCCCCOCC=O(12714)',
    structure = SMILES('CCCCCOCC=O'),
    E0 = (-411.303,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (130.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.107783,0.0923485,-6.50743e-05,2.41846e-08,-3.83284e-12,-49322.8,34.6632], Tmin=(100,'K'), Tmax=(1401.29,'K')), NASAPolynomial(coeffs=[13.4961,0.053516,-2.35063e-05,4.4084e-09,-3.04622e-13,-53135.4,-35.5572], Tmin=(1401.29,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-411.303,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(527.969,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)OsHH) + group(Cds-OdCsH)"""),
)
...
species(
    label = 'CCC[CH]OC[CH]O(12715)',
    structure = SMILES('CCC[CH]OC[CH]O'),
    E0 = (-120.007,'kJ/mol'),
    modes = [
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.624669,0.109312,-0.000134138,9.01342e-08,-2.28704e-11,-14273.9,33.8046], Tmin=(100,'K'), Tmax=(684.755,'K')), NASAPolynomial(coeffs=[12.1764,0.045971,-2.04353e-05,3.82409e-09,-2.63416e-13,-16295.1,-25.063], Tmin=(684.755,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-120.007,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCsJOCs) + radical(CCsJOH)"""),
)

species(
    label = '[CH2]C(CCC)OC[CH]O(12716)',
    structure = SMILES('[CH2]C(CCC)OC[CH]O'),
    E0 = (-124.284,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (130.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.98846,0.122389,-0.000134605,6.17407e-08,3.64893e-12,-14780.3,37.3897], Tmin=(100,'K'), Tmax=(589.725,'K')), NASAPolynomial(coeffs=[12.1301,0.0564697,-2.55951e-05,4.82077e-09,-3.32721e-13,-16728.5,-22.3717], Tmin=(589.725,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-124.284,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(523.812,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCsJOH) + radical(CJC(C)OC)"""),
)

species(
    label = 'CCCCC1OCC1O(12329)',
    structure = SMILES('CCCCC1OCC1O'),
    E0 = (-376.554,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (130.185,'amu'),
...
reaction(
    label = 'reaction1',
    reactants = ['CCCC[CH]OC[CH]O(12328)'],
    products = ['CH2CHOH(42)', 'CCCCC=O(1733)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'CCCC[CH]OCC=O(12697)'],
    products = ['CCCC[CH]OC[CH]O(12328)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'CCCC=COC[CH]O(12698)'],
    products = ['CCCC[CH]OC[CH]O(12328)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', 'CCCC[CH]OC=CO(12699)'],
    products = ['CCCC[CH]OC[CH]O(12328)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[CH2][CH]O(284)', 'CCCCC=O(1733)'],
    products = ['CCCC[CH]OC[CH]O(12328)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['npropyl(83)', 'C=COC[CH]O(4708)'],
    products = ['CCCC[CH]OC[CH]O(12328)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['CCC[CH]COC[CH]O(12701)'],
    products = ['CCCC[CH]OC[CH]O(12328)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['CCCC[CH]O[CH]CO(12702)'],
    products = ['CCCC[CH]OC[CH]O(12328)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['CCCCCO[CH][CH]O(12703)'],
    products = ['CCCC[CH]OC[CH]O(12328)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CC[CH]CCOC[CH]O(12704)'],
    products = ['CCCC[CH]OC[CH]O(12328)'],
...
reaction(
    label = 'reaction12',
    reactants = ['C[CH]CCCOC[CH]O(12705)'],
    products = ['CCCC[CH]OC[CH]O(12328)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CCC[CH][CH]OCCO(12706)'],
    products = ['CCCC[CH]OC[CH]O(12328)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]CCCCOC[CH]O(12707)'],
    products = ['CCCC[CH]OC[CH]O(12328)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CC[CH]C[CH]OCCO(12709)'],
    products = ['CCCC[CH]OC[CH]O(12328)'],
...
reaction(
    label = 'reaction17',
    reactants = ['C[CH]CC[CH]OCCO(12710)'],
    products = ['CCCC[CH]OC[CH]O(12328)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2]CCC[CH]OCCO(12711)'],
    products = ['CCCC[CH]OC[CH]O(12328)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2][CH]O(284)', 'CCCC[CH][O](1728)'],
    products = ['CCCC[CH]OC[CH]O(12328)'],
...
reaction(
    label = 'reaction23',
    reactants = ['CH2(S)(23)', 'CCC[CH]OC[CH]O(12715)'],
    products = ['CCCC[CH]OC[CH]O(12328)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[CH2]C(CCC)OC[CH]O(12716)'],
    products = ['CCCC[CH]OC[CH]O(12328)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[CH]CCCC(141)', '[O]C[CH]O(1827)'],
    products = ['CCCC[CH]OC[CH]O(12328)'],
...
reaction(
    label = 'reaction27',
    reactants = ['HCOH(T)(285)', '[CH2]O[CH]CCCC(1766)'],
    products = ['CCCC[CH]OC[CH]O(12328)'],
...
network(
    label = '2262',
    isomers = [
        'CCCC[CH]OC[CH]O(12328)',
    ],
    reactants = [
        ('CH2CHOH(42)', 'CCCCC=O(1733)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
