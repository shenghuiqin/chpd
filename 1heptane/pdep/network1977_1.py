...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.08162,0.00561761,6.05944e-05,-9.02406e-08,3.77133e-11,-7481.23,11.8243], Tmin=(100,'K'), Tmax=(904.346,'K')), NASAPolynomial(coeffs=[12.3305,0.00280395,2.07449e-06,-5.20751e-10,3.41216e-14,-10711.9,-40.4792], Tmin=(904.346,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-62.591,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(178.761,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + ring(dioxirane)"""),
)
...
species(
    ...
    molecularWeight = (76.0514,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.00076,0.00150326,8.94675e-05,-1.19937e-07,4.61444e-11,-2516.69,15.2093], Tmin=(100,'K'), Tmax=(958.9,'K')), NASAPolynomial(coeffs=[13.9467,0.0079889,-2.24923e-06,5.39622e-10,-5.13423e-14,-7013.27,-49.6396], Tmin=(958.9,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-21.3786,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsOs) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + ring(Cyclobutane)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['O2(2)', 'CH3CHO(37)'],
    products = ['C[CH]OO[O](156)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(8e+09,'cm^3/(mol*s)'), n=1.39, Ea=(377.75,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), comment="""Estimated using template [Od_CO-CsH;YJ] for rate rule [Od_CO-CsH;O2b]
Euclidian distance = 2.0
Multiplied by reaction path degeneracy 2.0
family: R_Addition_MultipleBond
Ea raised from 373.9 to 377.7 kJ/mol to match endothermicity of reaction."""),
)
...
reaction(
    label = 'reaction6',
    reactants = ['O2(2)', 'C[CH][O](176)'],
    products = ['C[CH]OO[O](156)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(2.30125e+06,'m^3/(mol*s)'), n=0.185611, Ea=(41.3842,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [Y_rad;O2_birad]
Euclidian distance = 0
Multiplied by reaction path degeneracy 2.0
family: R_Recombination
Ea raised from -25.4 to 41.4 kJ/mol to match endothermicity of reaction."""),
)
...
reaction(
    label = 'reaction10',
    reactants = ['CHCH3(T)(95)', '[O]O[O](145)'],
    products = ['C[CH]OO[O](156)'],
