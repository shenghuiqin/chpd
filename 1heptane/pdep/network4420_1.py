...
species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.0919187,'amu*angstrom^2'), symmetry=1, barrier=(2.11339,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.701123,'amu*angstrom^2'), symmetry=1, barrier=(16.1202,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (53.0825,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.59111,0.0279501,-1.83514e-05,6.95959e-09,-1.12243e-12,58865.5,13.5392], Tmin=(100,'K'), Tmax=(1425.12,'K')), NASAPolynomial(coeffs=[6.98752,0.0156103,-5.3633e-06,8.83781e-10,-5.65868e-14,57612.4,-9.22834], Tmin=(1425.12,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(488.993,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo library: DFT_QCI_thermo + radical(Acetyl)"""),
)
...
species(
    ...
    molecularWeight = (53.0825,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.63103,0.0262286,-1.09244e-05,-1.25941e-09,1.59214e-12,56496.3,11.0373], Tmin=(100,'K'), Tmax=(1123.15,'K')), NASAPolynomial(coeffs=[7.19264,0.0164112,-6.39804e-06,1.14971e-09,-7.83778e-14,55066.2,-13.3046], Tmin=(1123.15,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(469.3,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)CsH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cyclopropene) + radical(cyclopropenyl-vinyl)"""),
)
...
species(
    ...
    E0 = (537.926,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,2750,2800,2850,1350,1500,750,1050,1375,1000,540,610,2055,180,1116.64,3127.03],'cm^-1')),
        HinderedRotor(inertia=(0.393336,'amu*angstrom^2'), symmetry=1, barrier=(9.04357,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (52.0746,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.75202,0.0272122,-2.40389e-05,1.33609e-08,-3.14659e-12,64742.7,13.8069], Tmin=(100,'K'), Tmax=(1011.27,'K')), NASAPolynomial(coeffs=[5.9843,0.0144276,-5.07626e-06,8.60427e-10,-5.63912e-14,64089,-1.82337], Tmin=(1011.27,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(537.926,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), comment="""Thermo library: DFT_QCI_thermo + radical(C=C=CJ) + radical(Cds_S)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['H(3)', 'CH2CHCCH(26391)'],
    products = ['CH3CHCCH(24127)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(1.163e+09,'cm^3/(mol*s)'), n=1.493, Ea=(1.378,'kcal/mol'), T0=(1,'K'), comment="""Matched reaction 197 C4H4 + H <=> C4H5-9 in R_Addition_MultipleBond/training
This reaction matched rate rule [Cds-HH_Cds-CtH;HJ]
family: R_Addition_MultipleBond"""),
)

reaction(
    label = 'reaction2',
    reactants = ['C#CC[CH2](2455)'],
    products = ['CH3CHCCH(24127)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(5.471e+06,'s^-1'), n=1.841, Ea=(29.797,'kcal/mol'), T0=(1,'K'), comment="""Matched reaction 120 C4H5-5 <=> C4H5-6 in intra_H_migration/training
This reaction matched rate rule [R2H_S;C_rad_out_H/Ct;Cs_H_out_2H]
family: intra_H_migration"""),
)

reaction(
    label = 'reaction3',
    reactants = ['[C]#CCC(26392)'],
    products = ['CH3CHCCH(24127)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['CH3CHCCH(24127)'],
    products = ['CC1[C]=C1(26394)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['C3H2(81)', 'CH3(17)'],
    products = ['CH3CHCCH(24127)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(2.13464e+06,'m^3/(mol*s)'), n=0.472793, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Y_rad;Birad] for rate rule [C_methyl;Birad]
Euclidian distance = 2.0
Multiplied by reaction path degeneracy 2.0
...
reaction(
    label = 'reaction8',
    reactants = ['C2H(33)', 'CHCH3(T)(95)'],
    products = ['CH3CHCCH(24127)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(1.06732e+06,'m^3/(mol*s)'), n=0.472793, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Y_rad;Birad] for rate rule [Ct_rad;Birad]
...
reaction(
    label = 'reaction10',
    reactants = ['C=C=[C]C(24126)'],
    products = ['CH3CHCCH(24127)'],
    transitionState = 'TS10',
    kinetics = Arrhenius(A=(1.65028e+09,'s^-1'), n=1.32317, Ea=(166.12,'kJ/mol'), T0=(1,'K'), comment="""Estimated using average of templates [RnH;Cd_rad_out_Cs;Cd_H_out_singleH] + [R3H;Cd_rad_out_Cs;XH_out] for rate rule [R3H;Cd_rad_out_Cs;Cd_H_out_singleH]
Euclidian distance = 2.0
Multiplied by reaction path degeneracy 2.0
family: intra_H_migration"""),
)
...
reaction(
    label = 'reaction11',
    reactants = ['CH3CHCCH(24127)'],
    products = ['CH2CHCCH2(18933)'],
    transitionState = 'TS11',
    kinetics = Arrhenius(A=(3.992e-05,'s^-1'), n=4.805, Ea=(56.041,'kcal/mol'), T0=(1,'K'), comment="""Matched reaction 118 C4H5 <=> C4H5-2 in intra_H_migration/training
This reaction matched rate rule [R4H_MMS;Cd_rad_out_singleH;Cs_H_out_2H]
family: intra_H_migration"""),
)

reaction(
    label = 'reaction12',
    reactants = ['H2CCCH(80)', 'CH2(S)(23)'],
    products = ['CH3CHCCH(24127)'],
