species(
    label = 'C#CC([CH2])C([CH2])CC(26539)',
    structure = SMILES('C#CC([CH2])C([CH2])CC'),
    E0 = (453.153,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,2175,525,750,770,3400,2100,2750,2850,1437.5,1250,1305,750,350,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,200,800],'cm^-1')),
...
species(
    ...
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.183588,0.0694474,-1.32632e-05,-3.2905e-08,1.80641e-11,63935,31.8183], Tmin=(100,'K'), Tmax=(971.978,'K')), NASAPolynomial(coeffs=[16.7479,0.0350479,-1.22889e-05,2.1701e-09,-1.5091e-13,59119.9,-55.8299], Tmin=(971.978,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(530.336,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(465.61,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + ring(Methylene_cyclopropane) + radical(Isobutyl) + radical(Cds_P)"""),
)

species(
    label = '[CH]=C1CC(CC)C1[CH2](26989)',
    ...
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[9.84901,0.00396062,0.000119797,-1.21569e-07,2.82667e-11,55501,-10.86], Tmin=(100,'K'), Tmax=(1720.11,'K')), NASAPolynomial(coeffs=[77.5164,0.0364862,-7.4151e-05,1.77762e-08,-1.31301e-12,4131.17,-455.672], Tmin=(1720.11,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(464.178,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(469.768,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + ring(methylenecyclobutane) + radical(Isobutyl) + radical(Cds_P)"""),
)
...
species(
    label = 'C#CC([CH2])C(=C)CC(26990)',
    structure = SMILES('C#CC([CH2])C(=C)CC'),
    E0 = (340.112,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2175,525,2750,2800,2850,1350,1500,750,1050,1375,1000,2950,3100,1380,975,1025,1650,1380,1390,370,380,2900,435,350,440,435,1725,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,750,770,3400,2100,180,400.194],'cm^-1')),
        HinderedRotor(inertia=(0.202409,'amu*angstrom^2'), symmetry=1, barrier=(10.8481,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0954538,'amu*angstrom^2'), symmetry=1, barrier=(10.8482,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.19124,'amu*angstrom^2'), symmetry=1, barrier=(21.7341,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.09545,'amu*angstrom^2'), symmetry=1, barrier=(10.8482,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.6601,'amu*angstrom^2'), symmetry=1, barrier=(75.0191,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (107.173,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.185297,0.0883571,-8.07703e-05,4.07674e-08,-8.41181e-12,41059.9,30.2162], Tmin=(100,'K'), Tmax=(1160.66,'K')), NASAPolynomial(coeffs=[14.7768,0.0367929,-1.41305e-05,2.49043e-09,-1.67169e-13,37586.7,-44.1966], Tmin=(1160.66,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(340.112,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CtCsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(Isobutyl)"""),
)

species(
    label = 'C#CC(=C)C([CH2])CC(26991)',
    structure = SMILES('C#CC(=C)C([CH2])CC'),
    E0 = (357.156,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2175,525,2750,2800,2850,1350,1500,750,1050,1375,1000,2950,3100,1380,975,1025,1650,1380,1390,370,380,2900,435,350,440,435,1725,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,750,770,3400,2100,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.591929,'amu*angstrom^2'), symmetry=1, barrier=(13.6096,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0825741,'amu*angstrom^2'), symmetry=1, barrier=(1.89854,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.786034,'amu*angstrom^2'), symmetry=1, barrier=(18.0725,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0169798,'amu*angstrom^2'), symmetry=1, barrier=(13.6631,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0942806,'amu*angstrom^2'), symmetry=1, barrier=(75.5788,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (107.173,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0462128,0.0778815,-5.29921e-05,1.42082e-08,2.70143e-13,43106.1,31.5915], Tmin=(100,'K'), Tmax=(1041,'K')), NASAPolynomial(coeffs=[15.0191,0.0352078,-1.29137e-05,2.25366e-09,-1.51939e-13,39183.6,-45.113], Tmin=(1041,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(357.156,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCtCs) + group(Cds-CdsHH) + group(Ct-Ct(Cds-Cds)) + group(Ct-CtH) + radical(Isobutyl)"""),
)
...
species(
    ...
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.189767,0.0866733,-8.64087e-05,5.5737e-08,-1.554e-11,52271.8,32.939], Tmin=(100,'K'), Tmax=(853.67,'K')), NASAPolynomial(coeffs=[8.31716,0.0485889,-1.94858e-05,3.47095e-09,-2.32751e-13,50884.2,-4.98467], Tmin=(853.67,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(433.493,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CtCsCsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(Isobutyl) + radical(Tertalkyl)"""),
)

species(
    label = 'C#C[C](C)C([CH2])CC(26993)',
    structure = SMILES('C#C[C](C)C([CH2])CC'),
    E0 = (383.191,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([750,770,3400,2100,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,2175,525,360,370,350,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,1380,1390,370,380,2900,435,200,800],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.251806,0.0886868,-8.02517e-05,4.23564e-08,-9.20675e-12,46244.4,32.7947], Tmin=(100,'K'), Tmax=(1106.66,'K')), NASAPolynomial(coeffs=[13.3429,0.0395483,-1.3647e-05,2.23241e-09,-1.42425e-13,43235.5,-34.1696], Tmin=(1106.66,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(383.191,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CtCsCsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(Isobutyl) + radical(Tert_Propargyl)"""),
)

species(
    label = 'C#C[C]([CH2])C(C)CC(26994)',
    ...
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.264509,0.0830973,-5.29964e-05,9.77821e-09,2.44228e-12,40507.6,32.1515], Tmin=(100,'K'), Tmax=(1029.67,'K')), NASAPolynomial(coeffs=[16.5691,0.0368971,-1.36542e-05,2.40944e-09,-1.64093e-13,36023.5,-54.4938], Tmin=(1029.67,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(335.445,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cdd-Cd)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(Allyl_P) + radical(C=C=CJ)"""),
)

species(
    label = 'C#CC([CH2])C(C)[CH]C(26995)',
...
species(
    label = 'C#CC([CH2])C(C)C[CH2](26997)',
    ...
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.323053,0.0855167,-6.9522e-05,3.14543e-08,-5.81736e-12,54685.1,35.4256], Tmin=(100,'K'), Tmax=(1292.65,'K')), NASAPolynomial(coeffs=[15.552,0.0363932,-1.25192e-05,2.0562e-09,-1.31775e-13,50580.9,-45.2374], Tmin=(1292.65,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(453.317,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CtCsCsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(Isobutyl) + radical(RCCJ)"""),
)

species(
    label = '[C]#CC(C)C([CH2])CC(26998)',
    structure = SMILES('[C]#CC(C)C([CH2])CC'),
    E0 = (585.214,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2175,525,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,3000,3100,440,815,1455,1000,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.158355,0.0862895,-7.4897e-05,3.79127e-08,-7.94826e-12,70539.1,33.7859], Tmin=(100,'K'), Tmax=(1141.4,'K')), NASAPolynomial(coeffs=[13.0813,0.0398913,-1.39215e-05,2.29806e-09,-1.47587e-13,67516.8,-31.8388], Tmin=(1141.4,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(585.214,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CtCsCsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(Isobutyl) + radical(Acetyl)"""),
)

species(
    label = 'C#CC(C)C([CH2])C[CH2](26999)',
    ...
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.323053,0.0855167,-6.9522e-05,3.14543e-08,-5.81736e-12,54685.1,35.4256], Tmin=(100,'K'), Tmax=(1292.65,'K')), NASAPolynomial(coeffs=[15.552,0.0363932,-1.25192e-05,2.0562e-09,-1.31775e-13,50580.9,-45.2374], Tmin=(1292.65,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(453.317,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CtCsCsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(RCCJ) + radical(Isobutyl)"""),
)

species(
    label = '[C]#CC([CH2])C(C)CC(27000)',
    structure = SMILES('[C]#CC([CH2])C(C)CC'),
    E0 = (585.214,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2175,525,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,3000,3100,440,815,1455,1000,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,200,800,1600],'cm^-1')),
...
species(
    label = '[CH2]C1[C]=CCC1CC(27002)',
    structure = SMILES('[CH2]C1[C]=CCC1CC'),
    E0 = (396.232,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.863487,0.0505024,3.57077e-05,-7.89532e-08,3.3082e-11,47785.2,28.9999], Tmin=(100,'K'), Tmax=(970.791,'K')), NASAPolynomial(coeffs=[15.0533,0.0370738,-1.31338e-05,2.37709e-09,-1.69162e-13,42907.8,-49.9681], Tmin=(970.791,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(396.232,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(469.768,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cyclopentene) + radical(cyclopentene-vinyl) + radical(Isobutyl)"""),
)

species(
    label = 'C#CC(C)C(=C)CC(27003)',
    ...
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.253171,0.0872184,-6.99099e-05,2.98927e-08,-5.24101e-12,16398.6,28.6798], Tmin=(100,'K'), Tmax=(1343.44,'K')), NASAPolynomial(coeffs=[16.2208,0.0381684,-1.51439e-05,2.71577e-09,-1.8369e-13,11972.2,-55.6614], Tmin=(1343.44,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(135.03,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CtCsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + group(Ct-CtCs) + group(Ct-CtH)"""),
)

species(
    label = 'C#CC(=C)C(C)CC(27004)',
    structure = SMILES('C#CC(=C)C(C)CC'),
    E0 = (152.074,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0137609,0.0763216,-4.07054e-05,1.65157e-09,4.05668e-12,18443.4,29.9292], Tmin=(100,'K'), Tmax=(1071.71,'K')), NASAPolynomial(coeffs=[15.5439,0.0380686,-1.47532e-05,2.66908e-09,-1.83917e-13,13982.7,-51.3513], Tmin=(1071.71,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(152.074,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCtCs) + group(Cds-CdsHH) + group(Ct-Ct(Cds-Cds)) + group(Ct-CtH)"""),
)
...
species(
    ...
    collisionModel = TransportData(shapeIndex=2, epsilon=(3412.9,'J/mol'), sigma=(6.18987,'angstroms'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with Tc=533.09 K, Pc=32.65 bar (from Joback method)"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
...
species(
    ...
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.344278,0.0822536,-7.354e-05,4.21541e-08,-1.05826e-11,53636.2,34.0936], Tmin=(100,'K'), Tmax=(935.638,'K')), NASAPolynomial(coeffs=[8.27884,0.0483318,-1.91564e-05,3.40393e-09,-2.28498e-13,52151.5,-3.65816], Tmin=(935.638,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(444.876,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CtCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(RCCJCC) + radical(Isobutyl)"""),
)

species(
    label = 'C#CC([CH2])[CH]CCC(27005)',
    structure = SMILES('C#CC([CH2])[CH]CCC'),
    E0 = (444.96,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.197548,0.0816582,-6.52985e-05,3.03496e-08,-6.00683e-12,53654.8,34.6046], Tmin=(100,'K'), Tmax=(1177.7,'K')), NASAPolynomial(coeffs=[11.3656,0.0437261,-1.69852e-05,3.00044e-09,-2.01165e-13,51024.3,-21.1015], Tmin=(1177.7,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(444.96,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CtCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(Cs_S) + radical(Isobutyl)"""),
)
...
species(
    ...
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.197548,0.0816582,-6.52985e-05,3.03496e-08,-6.00684e-12,54470,34.6046], Tmin=(100,'K'), Tmax=(1177.69,'K')), NASAPolynomial(coeffs=[11.3656,0.0437262,-1.69852e-05,3.00044e-09,-2.01165e-13,51839.5,-21.1015], Tmin=(1177.69,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(451.738,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CtCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(Cs_S) + radical(Isobutyl)"""),
)

species(
    label = 'C#CC1CCC1CC(26543)',
    ...
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.801426,0.0498066,4.45082e-05,-9.21829e-08,3.87948e-11,23523.2,26.6935], Tmin=(100,'K'), Tmax=(959.333,'K')), NASAPolynomial(coeffs=[16.5049,0.0350849,-1.18327e-05,2.11917e-09,-1.51891e-13,18174.7,-60.5875], Tmin=(959.333,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(194.471,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(469.768,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CtCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtH) + ring(Cyclobutane)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['C#CC([CH2])C([CH2])CC(26539)'],
...
reaction(
    label = 'reaction2',
    reactants = ['C#CC([CH2])C([CH2])CC(26539)'],
    products = ['[CH]=C1CC1C([CH2])CC(26988)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['C#CC([CH2])C([CH2])CC(26539)'],
    products = ['[CH]=C1CC(CC)C1[CH2](26989)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', 'C#CC([CH2])C(=C)CC(26990)'],
    products = ['C#CC([CH2])C([CH2])CC(26539)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)', 'C#CC(=C)C([CH2])CC(26991)'],
    products = ['C#CC([CH2])C([CH2])CC(26539)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['C2H5(29)', 'C#CC([CH2])C=C(21151)'],
    products = ['C#CC([CH2])C([CH2])CC(26539)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['C2H(33)', '[CH2]C(C=C)CC(420)'],
    products = ['C#CC([CH2])C([CH2])CC(26539)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['C#CC([CH2])C([CH2])CC(26539)'],
    products = ['C#CC([CH2])[C](C)CC(26992)'],
...
reaction(
    label = 'reaction11',
    reactants = ['C#C[C](C)C([CH2])CC(26993)'],
    products = ['C#CC([CH2])C([CH2])CC(26539)'],
...
reaction(
    label = 'reaction12',
    reactants = ['C#CC([CH2])C([CH2])CC(26539)'],
    products = ['C#C[C]([CH2])C(C)CC(26994)'],
...
reaction(
    label = 'reaction13',
    reactants = ['C#CC([CH2])C([CH2])CC(26539)'],
    products = ['C#CC([CH2])C(C)[CH]C(26995)'],
...
reaction(
    label = 'reaction15',
    reactants = ['C#CC([CH2])C([CH2])CC(26539)'],
    products = ['C#CC(C)C([CH2])[CH]C(26996)'],
...
reaction(
    label = 'reaction16',
    reactants = ['C#CC([CH2])C(C)C[CH2](26997)'],
    products = ['C#CC([CH2])C([CH2])CC(26539)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[C]#CC(C)C([CH2])CC(26998)'],
    products = ['C#CC([CH2])C([CH2])CC(26539)'],
...
reaction(
    label = 'reaction18',
    reactants = ['C#CC(C)C([CH2])C[CH2](26999)'],
    products = ['C#CC([CH2])C([CH2])CC(26539)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[C]#CC([CH2])C(C)CC(27000)'],
    products = ['C#CC([CH2])C([CH2])CC(26539)'],
...
reaction(
    label = 'reaction22',
    reactants = ['C#CC([CH2])C([CH2])CC(26539)'],
    products = ['[CH2]C1[C]=CCC1CC(27002)'],
...
reaction(
    label = 'reaction25',
    reactants = ['CH2(S)(23)', 'C#CC([CH2])C([CH2])C(26549)'],
    products = ['C#CC([CH2])C([CH2])CC(26539)'],
...
reaction(
    label = 'reaction26',
    reactants = ['C#CC([CH2])C([CH2])CC(26539)'],
    products = ['C#CC([CH2])C[CH]CC(26535)'],
...
reaction(
    label = 'reaction27',
    reactants = ['C#CC([CH2])C([CH2])CC(26539)'],
    products = ['C#CC([CH2])[CH]CCC(27005)'],
...
reaction(
    label = 'reaction28',
    reactants = ['C#CC([CH2])C([CH2])CC(26539)'],
    products = ['C#C[CH]CC([CH2])CC(26538)'],
...
reaction(
    label = 'reaction29',
    reactants = ['C#CC([CH2])C([CH2])CC(26539)'],
    products = ['C#CC[CH]C([CH2])CC(27006)'],
...
reaction(
    label = 'reaction31',
    reactants = ['CH2(19)', 'C#CC([CH2])[CH]CC(26834)'],
    products = ['C#CC([CH2])C([CH2])CC(26539)'],
