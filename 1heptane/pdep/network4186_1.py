...
species(
    label = 'CC=C=CC[O](24550)',
    structure = SMILES('CC=C=CC[O]'),
    E0 = (183.246,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,540,610,2055,2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.196487,'amu*angstrom^2'), symmetry=1, barrier=(4.51763,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.19628,'amu*angstrom^2'), symmetry=1, barrier=(4.51287,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (83.1085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.08194,0.0376715,-1.70175e-05,2.97438e-09,-1.66201e-13,22054.4,17.6515], Tmin=(100,'K'), Tmax=(2696.47,'K')), NASAPolynomial(coeffs=[29.5777,0.00545968,-3.04421e-06,4.95135e-10,-2.6781e-14,5186.84,-141.239], Tmin=(2696.47,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(183.246,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cdd-CdsCds) + radical(CCOJ)"""),
)
...
species(
    label = 'CC#CCC[O](24551)',
    structure = SMILES('CC#CCC[O]'),
    E0 = (173.278,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,2100,2250,500,550,180,180,1408.42],'cm^-1')),
        HinderedRotor(inertia=(0.00528473,'amu*angstrom^2'), symmetry=1, barrier=(7.44989,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.32376,'amu*angstrom^2'), symmetry=1, barrier=(7.44387,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.73629,'amu*angstrom^2'), symmetry=1, barrier=(62.9127,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (83.1085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.95052,0.0476726,-4.54565e-05,3.32846e-08,-1.0943e-11,20911.8,22.2637], Tmin=(100,'K'), Tmax=(860.694,'K')), NASAPolynomial(coeffs=[3.87666,0.0340844,-1.36948e-05,2.42404e-09,-1.61165e-13,20752,14.2578], Tmin=(860.694,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(173.278,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CtCsHH) + group(Cs-CsOsHH) + group(Cs-CtHHH) + group(Ct-CtCs) + group(Ct-CtCs) + radical(CCOJ)"""),
)
...
species(
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.37443,0.0599833,-5.27221e-05,2.63066e-08,-5.61312e-12,17217.5,21.69], Tmin=(100,'K'), Tmax=(1088.89,'K')), NASAPolynomial(coeffs=[9.00324,0.031959,-1.41171e-05,2.67084e-09,-1.86519e-13,15556.1,-15.7642], Tmin=(1088.89,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(142.384,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Cds_S) + radical(C=CCJCO)"""),
)
...
species(
    label = 'C[C]=[C]CCO(24555)',
    structure = SMILES('C[C]=[C]CCO'),
    E0 = (263.309,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,1670,1700,300,440,3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.239004,'amu*angstrom^2'), symmetry=1, barrier=(5.49517,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.238347,'amu*angstrom^2'), symmetry=1, barrier=(5.48008,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.23999,'amu*angstrom^2'), symmetry=1, barrier=(5.51783,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.241037,'amu*angstrom^2'), symmetry=1, barrier=(5.54191,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.34348,0.0632616,-7.95048e-05,6.54834e-08,-2.27238e-11,31759.7,25.071], Tmin=(100,'K'), Tmax=(799.532,'K')), NASAPolynomial(coeffs=[5.67081,0.0355162,-1.60148e-05,3.00786e-09,-2.06991e-13,31262.6,6.38076], Tmin=(799.532,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(263.309,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Cds_S) + radical(Cds_S)"""),
)
...
species(
    label = 'CC=C=CCO(24556)',
    structure = SMILES('CC=C=CCO'),
    E0 = (-42.459,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.80968,0.0500941,-3.48779e-05,1.3509e-08,-2.30409e-12,-5029.62,21.4451], Tmin=(100,'K'), Tmax=(1286.63,'K')), NASAPolynomial(coeffs=[7.63981,0.0319687,-1.37466e-05,2.55971e-09,-1.76578e-13,-6529.86,-8.15128], Tmin=(1286.63,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-42.459,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cdd-CdsCds)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'CC=C=CC[O](24550)'],
    products = ['CC=[C]CC[O](19599)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction7',
    reactants = ['CH3(17)', 'C#CCC[O](24552)'],
    products = ['CC=[C]CC[O](19599)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction22',
    reactants = ['[CH2]C[O](96)', '[C]=CC(24199)'],
    products = ['CC=[C]CC[O](19599)'],
...
reaction(
    label = 'reaction23',
    reactants = ['O(4)', '[CH2]C[C]=CC(24198)'],
    products = ['CC=[C]CC[O](19599)'],
