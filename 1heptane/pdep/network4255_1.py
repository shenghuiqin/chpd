...
species(
    label = 'CC=C=CC([O])CC(24961)',
    structure = SMILES('CC=C=CC([O])CC'),
    E0 = (121.805,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,540,610,2055,2995,3025,975,1000,1300,1375,400,500,1630,1680,1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,197.233,197.235,197.239],'cm^-1')),
        HinderedRotor(inertia=(0.00433317,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.502149,'amu*angstrom^2'), symmetry=1, barrier=(13.8609,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.502093,'amu*angstrom^2'), symmetry=1, barrier=(13.8609,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.502137,'amu*angstrom^2'), symmetry=1, barrier=(13.8608,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (111.162,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0141194,0.0785771,-5.64286e-05,2.05996e-08,-3.05115e-12,14800.6,32.385], Tmin=(100,'K'), Tmax=(1572.26,'K')), NASAPolynomial(coeffs=[17.6566,0.0336927,-1.3607e-05,2.44248e-09,-1.64031e-13,9252.91,-60.713], Tmin=(1572.26,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(121.805,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(440.667,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cdd-CdsCds) + radical(CC(C)OJ)"""),
)

species(
    label = 'CC#CCC([O])CC(24962)',
    structure = SMILES('CC#CCC([O])CC'),
    E0 = (117.73,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2100,2250,500,550,1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (111.162,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0612191,0.0784844,-6.04153e-05,2.59551e-08,-4.61151e-12,14308.2,32.1361], Tmin=(100,'K'), Tmax=(1329.62,'K')), NASAPolynomial(coeffs=[14.0321,0.036455,-1.30003e-05,2.18152e-09,-1.41546e-13,10593,-39.2457], Tmin=(1329.62,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(117.73,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CtCsHH) + group(Cs-CsHHH) + group(Cs-CtHHH) + group(Ct-CtCs) + group(Ct-CtCs) + radical(CC(C)OJ)"""),
)
...
species(
    label = 'C#CCC([O])CC(24963)',
    structure = SMILES('C#CCC([O])CC'),
    E0 = (159.911,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,750,770,3400,2100,2175,525,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,180,440.247,951.173],'cm^-1')),
        HinderedRotor(inertia=(0.554118,'amu*angstrom^2'), symmetry=1, barrier=(12.7403,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0197967,'amu*angstrom^2'), symmetry=1, barrier=(12.7374,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.553775,'amu*angstrom^2'), symmetry=1, barrier=(12.7324,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(3.27615,'amu*angstrom^2'), symmetry=1, barrier=(75.3251,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (97.1351,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.565494,0.0693045,-5.76396e-05,2.61124e-08,-4.82664e-12,19361.7,26.9044], Tmin=(100,'K'), Tmax=(1289.78,'K')), NASAPolynomial(coeffs=[13.5868,0.0289217,-1.06753e-05,1.83756e-09,-1.21442e-13,16002.8,-39.2297], Tmin=(1289.78,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(159.911,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CtCsHH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(CC(C)OJ)"""),
)

species(
    label = 'CC=[C]C[C](O)CC(24964)',
    ...
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0341612,0.0933133,-0.000102406,7.05505e-08,-2.09762e-11,17202.9,32.881], Tmin=(100,'K'), Tmax=(800.658,'K')), NASAPolynomial(coeffs=[8.53058,0.0508667,-2.28851e-05,4.33842e-09,-3.02184e-13,15842.3,-6.22054], Tmin=(800.658,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(141.891,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Cds_S) + radical(C2CsJOH)"""),
)
...
species(
    label = 'C[CH]C(O)C[C]=CC(24965)',
    structure = SMILES('C[CH]C(O)C[C]=CC'),
    E0 = (165.166,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,3025,407.5,1350,352.5,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3010,987.5,1337.5,450,1655,1685,370,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.322312,0.080335,-6.10734e-05,2.53087e-08,-4.44188e-12,19997.4,34.899], Tmin=(100,'K'), Tmax=(1303.29,'K')), NASAPolynomial(coeffs=[12.4721,0.0430452,-1.81553e-05,3.35503e-09,-2.30668e-13,16830.5,-26.9353], Tmin=(1303.29,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(165.166,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(CCJCO) + radical(Cds_S)"""),
)

species(
    label = 'CC=[C][CH]C(O)CC(24966)',
    structure = SMILES('CC=[C][CH]C(O)CC'),
    E0 = (82.1802,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.00134891,0.0883802,-7.33747e-05,3.32161e-08,-6.32116e-12,10027.4,30.7571], Tmin=(100,'K'), Tmax=(1219.63,'K')), NASAPolynomial(coeffs=[13.4361,0.0443188,-1.91849e-05,3.59551e-09,-2.49592e-13,6750.32,-36.7256], Tmin=(1219.63,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(82.1802,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(C=CCJCO) + radical(Cds_S)"""),
)
...
species(
    ...
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.355381,0.0838929,-7.12709e-05,3.50508e-08,-7.48377e-12,20635.7,34.0823], Tmin=(100,'K'), Tmax=(1078.29,'K')), NASAPolynomial(coeffs=[10.0978,0.0477521,-2.09948e-05,3.96633e-09,-2.76765e-13,18534.7,-13.6534], Tmin=(1078.29,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(170.51,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Cds_S) + radical(RCCJ)"""),
)
...
species(
    ...
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.25134,0.0880082,-8.58477e-05,5.16603e-08,-1.36026e-11,24558.1,33.1534], Tmin=(100,'K'), Tmax=(890.167,'K')), NASAPolynomial(coeffs=[8.60353,0.0504772,-2.26048e-05,4.29605e-09,-3.0047e-13,23071.2,-6.16925], Tmin=(890.167,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(203.105,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Cds_S) + radical(Cds_S)"""),
)
...
species(
    ...
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0600579,0.0816182,-5.93978e-05,2.23212e-08,-3.42921e-12,-12904,32.8366], Tmin=(100,'K'), Tmax=(1511.95,'K')), NASAPolynomial(coeffs=[16.9191,0.0366987,-1.48337e-05,2.67165e-09,-1.80183e-13,-18038.3,-56.0972], Tmin=(1511.95,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-108.556,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cdd-CdsCds)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'CC=[C]CC(=O)CC(24960)'],
    products = ['CC=[C]CC([O])CC(20888)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'CC=C=CC([O])CC(24961)'],
    products = ['CC=[C]CC([O])CC(20888)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', 'CC#CCC([O])CC(24962)'],
    products = ['CC=[C]CC([O])CC(20888)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['C2H5(29)', 'CC=[C]CC=O(24131)'],
    products = ['CC=[C]CC([O])CC(20888)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['CH3(17)', 'C#CCC([O])CC(24963)'],
    products = ['CC=[C]CC([O])CC(20888)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction12',
    reactants = ['C[CH]C(O)C[C]=CC(24965)'],
    products = ['CC=[C]CC([O])CC(20888)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]CC(O)C[C]=CC(24967)'],
    products = ['CC=[C]CC([O])CC(20888)'],
...
reaction(
    label = 'reaction20',
    reactants = ['CC=[C]CC([O])CC(20888)'],
    products = ['[CH2]C=[C]CC(O)CC(20890)'],
...
reaction(
    label = 'reaction24',
    reactants = ['CH2(S)(23)', 'CC=[C]CC(C)[O](19705)'],
    products = ['CC=[C]CC([O])CC(20888)'],
...
reaction(
    label = 'reaction28',
    reactants = ['O(4)', 'CC=[C]C[CH]CC(24255)'],
    products = ['CC=[C]CC([O])CC(20888)'],
...
reaction(
    label = 'reaction29',
    reactants = ['[CH2]C([O])CC(1666)', '[C]=CC(24199)'],
    products = ['CC=[C]CC([O])CC(20888)'],
