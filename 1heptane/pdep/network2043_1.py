...
species(
    label = 'CC[CH]OCC=CCC(10784)',
    structure = SMILES('CC[CH]OCC=CCC'),
    E0 = (-65.8093,'kJ/mol'),
    modes = [
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.549185,0.100058,-7.68581e-05,3.22426e-08,-5.73957e-12,-7751.58,36.8225], Tmin=(100,'K'), Tmax=(1284.76,'K')), NASAPolynomial(coeffs=[14.2889,0.0538599,-2.29204e-05,4.25392e-09,-2.93249e-13,-11564.2,-38.4809], Tmin=(1284.76,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-65.8093,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(552.912,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(CCsJOCs)"""),
)

species(
    label = 'CC=COC[CH]CCC(10785)',
    structure = SMILES('CC=COC[CH]CCC'),
    E0 = (-92.9713,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (127.204,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.14453,0.0959661,-4.35868e-05,-1.47946e-08,1.33208e-11,-10981.5,38.1847], Tmin=(100,'K'), Tmax=(1001.35,'K')), NASAPolynomial(coeffs=[22.0442,0.0400594,-1.48498e-05,2.69665e-09,-1.8955e-13,-17466.6,-82.9119], Tmin=(1001.35,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-92.9713,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(552.912,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(CCJCO)"""),
)

species(
    label = 'CC[CH]OC=CCCC(10786)',
    structure = SMILES('CC[CH]OC=CCCC'),
    E0 = (-97.8112,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3025,407.5,1350,352.5,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,2995,3025,975,1000,1300,1375,400,500,1630,1680,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (127.204,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.63665,0.106807,-6.46195e-05,-3.73282e-10,1.00142e-11,-11545.8,37.5955], Tmin=(100,'K'), Tmax=(989.03,'K')), NASAPolynomial(coeffs=[24.9835,0.0359057,-1.28398e-05,2.30432e-09,-1.61932e-13,-18609.3,-99.6271], Tmin=(989.03,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-97.8112,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(552.912,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(CCsJOC(O))"""),
)
...
species(
    label = 'CC[CH]CCO[CH]CC(10787)',
    structure = SMILES('CC[CH]CCO[CH]CC'),
    E0 = (6.42042,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3000,3050,390,425,1340,1360,335,370,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (128.212,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.751909,0.112061,-0.000114781,7.71486e-08,-2.30524e-11,936.498,39.0527], Tmin=(100,'K'), Tmax=(787.847,'K')), NASAPolynomial(coeffs=[7.97443,0.0677563,-3.04276e-05,5.76927e-09,-4.02176e-13,-438.5,-0.965975], Tmin=(787.847,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(6.42042,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(573.699,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(CCsJOCs)"""),
)

species(
    label = 'C[CH]COC[CH]CCC(10788)',
    structure = SMILES('C[CH]COC[CH]CCC'),
    E0 = (31.3102,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3000,3050,390,425,1340,1360,335,370,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (128.212,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.506356,0.0967512,-6.47571e-05,2.25787e-08,-3.30849e-12,3929.1,41.1252], Tmin=(100,'K'), Tmax=(1523.23,'K')), NASAPolynomial(coeffs=[15.7969,0.0539388,-2.25975e-05,4.12678e-09,-2.80067e-13,-1037.6,-44.3894], Tmin=(1523.23,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(31.3102,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(573.699,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJCO) + radical(CCJCO)"""),
)
...
species(
    label = 'CCC[CH][CH]OCCC(10790)',
    structure = SMILES('CCC[CH][CH]OCCC'),
    E0 = (11.8642,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3000,3050,390,425,1340,1360,335,370,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'C[CH]CCCO[CH]CC(10791)',
    structure = SMILES('C[CH]CCCO[CH]CC'),
    E0 = (6.40839,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.212,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.725517,0.110822,-0.000106837,6.49993e-08,-1.74727e-11,934.922,39.1309], Tmin=(100,'K'), Tmax=(870.22,'K')), NASAPolynomial(coeffs=[9.07329,0.0657802,-2.9197e-05,5.51894e-09,-3.84649e-13,-770.465,-6.7803], Tmin=(870.22,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(6.40839,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(573.699,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCsJOCs) + radical(RCCJC)"""),
)

species(
    label = '[CH2]CCOC[CH]CCC(10792)',
    structure = SMILES('[CH2]CCOC[CH]CCC'),
    E0 = (36.6545,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (128.212,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.327508,0.0987677,-7.03671e-05,2.74085e-08,-4.64608e-12,4560.81,39.7736], Tmin=(100,'K'), Tmax=(1304.63,'K')), NASAPolynomial(coeffs=[12.1391,0.0605448,-2.642e-05,4.95145e-09,-3.42711e-13,1307.96,-23.6858], Tmin=(1304.63,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(36.6545,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(573.699,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJ) + radical(CCJCO)"""),
)

species(
    label = '[CH2]CCCCO[CH]CC(10793)',
    structure = SMILES('[CH2]CCCCO[CH]CC'),
    E0 = (17.2085,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2761.11,2772.22,2783.33,2794.44,2805.56,2816.67,2827.78,2838.89,2850,1425,1431.25,1437.5,1443.75,1450,1225,1237.5,1250,1262.5,1275,1270,1287.5,1305,1322.5,1340,700,725,750,775,800,300,325,350,375,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,3025,407.5,1350,352.5,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (128.212,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.858792,0.11119,-9.80096e-05,4.96729e-08,-1.08052e-11,2241.05,38.648], Tmin=(100,'K'), Tmax=(1068.52,'K')), NASAPolynomial(coeffs=[12.7738,0.0601555,-2.63664e-05,4.97304e-09,-3.46753e-13,-672.262,-28.0248], Tmin=(1068.52,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(17.2085,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(573.699,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCsJOCs) + radical(RCCJ)"""),
)

species(
    label = 'C[CH][CH]OCCCCC(10794)',
    structure = SMILES('C[CH][CH]OCCCCC'),
    E0 = (11.8642,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3000,3050,390,425,1340,1360,335,370,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'CC[CH][CH]COCCC(10795)',
    structure = SMILES('CC[CH][CH]COCCC'),
    E0 = (25.8665,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3000,3050,390,425,1340,1360,335,370,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (128.212,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.10883,0.0979833,-7.99965e-05,4.40793e-08,-1.17313e-11,3252.35,39.8029], Tmin=(100,'K'), Tmax=(838.564,'K')), NASAPolynomial(coeffs=[5.47702,0.0713384,-3.2335e-05,6.18791e-09,-4.34804e-13,2315.53,13.8379], Tmin=(838.564,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(25.8665,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(573.699,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(CCJCO)"""),
)

species(
    label = 'C[CH]C[CH]COCCC(10796)',
    structure = SMILES('C[CH]C[CH]COCCC'),
    E0 = (25.8544,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3000,3050,390,425,1340,1360,335,370,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (128.212,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0680827,0.0967385,-7.27906e-05,3.39135e-08,-7.43027e-12,3249.94,39.8187], Tmin=(100,'K'), Tmax=(999.763,'K')), NASAPolynomial(coeffs=[6.94681,0.0686719,-3.06799e-05,5.83263e-09,-4.08269e-13,1847.31,5.97763], Tmin=(999.763,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(25.8544,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(573.699,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJC) + radical(CCJCO)"""),
)

species(
    label = '[CH2]C[CH]OCCCCC(10797)',
    structure = SMILES('[CH2]C[CH]OCCCCC'),
    E0 = (17.2085,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2761.11,2772.22,2783.33,2794.44,2805.56,2816.67,2827.78,2838.89,2850,1425,1431.25,1437.5,1443.75,1450,1225,1237.5,1250,1262.5,1275,1270,1287.5,1305,1322.5,1340,700,725,750,775,800,300,325,350,375,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,3025,407.5,1350,352.5,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2]CC[CH]COCCC(10798)',
    structure = SMILES('[CH2]CC[CH]COCCC'),
    E0 = (36.6545,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2761.11,2772.22,2783.33,2794.44,2805.56,2816.67,2827.78,2838.89,2850,1425,1431.25,1437.5,1443.75,1450,1225,1237.5,1250,1262.5,1275,1270,1287.5,1305,1322.5,1340,700,725,750,775,800,300,325,350,375,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,3025,407.5,1350,352.5,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'CCCC=COCCC(10799)',
    structure = SMILES('CCCC=COCCC'),
    E0 = (-291.739,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.212,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.27378,0.0974521,-3.78308e-05,-2.29832e-08,1.6469e-11,-34881.8,36.8201], Tmin=(100,'K'), Tmax=(997.367,'K')), NASAPolynomial(coeffs=[22.5928,0.0422008,-1.55959e-05,2.83533e-09,-1.99758e-13,-41655.3,-88.3495], Tmin=(997.367,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-291.739,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(577.856,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH)"""),
)

species(
    label = 'CC=COCCCCC(10800)',
    structure = SMILES('CC=COCCCCC'),
    E0 = (-292.873,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.212,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.36003,0.101407,-5.28977e-05,-4.61217e-09,9.28065e-12,-35017.2,36.4627], Tmin=(100,'K'), Tmax=(1023.84,'K')), NASAPolynomial(coeffs=[21.7283,0.0439426,-1.66714e-05,3.03056e-09,-2.11535e-13,-41460.9,-83.849], Tmin=(1023.84,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-292.873,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(577.856,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH)"""),
)

species(
    label = 'CCC=CCOCCC(10801)',
    structure = SMILES('CCC=CCOCCC'),
    E0 = (-246.265,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.212,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.238195,0.0930117,-5.76564e-05,1.81131e-08,-2.385e-12,-29467.4,36.2498], Tmin=(100,'K'), Tmax=(1652.84,'K')), NASAPolynomial(coeffs=[15.4297,0.055094,-2.32449e-05,4.23329e-09,-2.85594e-13,-34646.7,-47.2116], Tmin=(1652.84,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-246.265,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(577.856,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH)"""),
)
...
species(
    label = '[CH2]C(CC)CO[CH]CC(10802)',
    structure = SMILES('[CH2]C(CC)CO[CH]CC'),
    E0 = (11.3501,'kJ/mol'),
    modes = [
...
species(
    label = 'CCCC1COC1CC(10737)',
    structure = SMILES('CCCC1COC1CC'),
    E0 = (-236.905,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.212,'amu'),
...
reaction(
    label = 'reaction1',
    reactants = ['CC[CH]OC[CH]CCC(10733)'],
    products = ['C=CCCC(134)', 'C2H5CHO(70)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'CC[CH]OCC=CCC(10784)'],
    products = ['CC[CH]OC[CH]CCC(10733)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'CC=COC[CH]CCC(10785)'],
    products = ['CC[CH]OC[CH]CCC(10733)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', 'CC[CH]OC=CCCC(10786)'],
    products = ['CC[CH]OC[CH]CCC(10733)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[CH2][CH]CCC(137)', 'C2H5CHO(70)'],
    products = ['CC[CH]OC[CH]CCC(10733)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['C2H5(29)', 'C=CCO[CH]CC(10627)'],
    products = ['CC[CH]OC[CH]CCC(10733)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['CH3(17)', 'C=COC[CH]CCC(1227)'],
    products = ['CC[CH]OC[CH]CCC(10733)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['CC[CH]CCO[CH]CC(10787)'],
    products = ['CC[CH]OC[CH]CCC(10733)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['C[CH]COC[CH]CCC(10788)'],
    products = ['CC[CH]OC[CH]CCC(10733)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['CCC[CH][CH]OCCC(10790)'],
    products = ['CC[CH]OC[CH]CCC(10733)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CC[CH]OC[CH]CCC(10733)'],
    products = ['C[CH]CCCO[CH]CC(10791)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2]CCOC[CH]CCC(10792)'],
    products = ['CC[CH]OC[CH]CCC(10733)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]CCCCO[CH]CC(10793)'],
    products = ['CC[CH]OC[CH]CCC(10733)'],
...
reaction(
    label = 'reaction15',
    reactants = ['C[CH][CH]OCCCCC(10794)'],
    products = ['CC[CH]OC[CH]CCC(10733)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CC[CH][CH]COCCC(10795)'],
    products = ['CC[CH]OC[CH]CCC(10733)'],
...
reaction(
    label = 'reaction17',
    reactants = ['C[CH]C[CH]COCCC(10796)'],
    products = ['CC[CH]OC[CH]CCC(10733)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2]C[CH]OCCCCC(10797)'],
    products = ['CC[CH]OC[CH]CCC(10733)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2]CC[CH]COCCC(10798)'],
    products = ['CC[CH]OC[CH]CCC(10733)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2][CH]CCC(137)', 'CC[CH][O](563)'],
    products = ['CC[CH]OC[CH]CCC(10733)'],
...
reaction(
    label = 'reaction24',
    reactants = ['CH2(S)(23)', 'CC[CH]CO[CH]CC(10721)'],
    products = ['CC[CH]OC[CH]CCC(10733)'],
...
reaction(
    label = 'reaction25',
    reactants = ['CH2(S)(23)', 'C[CH]OC[CH]CCC(1215)'],
    products = ['CC[CH]OC[CH]CCC(10733)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[CH2]C(CC)CO[CH]CC(10802)'],
    products = ['CC[CH]OC[CH]CCC(10733)'],
...
reaction(
    label = 'reaction29',
    reactants = ['[CH]CC(144)', 'CCC[CH]C[O](1725)'],
    products = ['CC[CH]OC[CH]CCC(10733)'],
...
reaction(
    label = 'reaction30',
    reactants = ['[CH]CCC(133)', '[CH2]O[CH]CC(1682)'],
    products = ['CC[CH]OC[CH]CCC(10733)'],
...
network(
    label = '2043',
    isomers = [
        'CC[CH]OC[CH]CCC(10733)',
    ],
    reactants = [
        ('C=CCCC(134)', 'C2H5CHO(70)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
