...
species(
    label = 'CC[C]([O])OO(11858)',
    structure = SMILES('CC[C]([O])OO'),
    E0 = (21.8742,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,360,370,350,3615,1310,387.5,850,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,2011.59,2012.48],'cm^-1')),
        HinderedRotor(inertia=(0.282732,'amu*angstrom^2'), symmetry=1, barrier=(8.48512,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.08449,'amu*angstrom^2'), symmetry=1, barrier=(32.9476,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.278105,'amu*angstrom^2'), symmetry=1, barrier=(8.50677,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.10646,'amu*angstrom^2'), symmetry=1, barrier=(32.9764,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (90.0779,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.51397,0.0605237,-8.34158e-05,7.47121e-08,-2.81049e-11,2714.74,24.4547], Tmin=(100,'K'), Tmax=(759.079,'K')), NASAPolynomial(coeffs=[4.94451,0.0347785,-1.73892e-05,3.41633e-09,-2.41139e-13,2414.84,10.305], Tmin=(759.079,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(21.8742,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + radical(Cs_P) + radical(CCOJ)"""),
)
...
species(
    label = 'C[CH]C([O])OO(11859)',
    structure = SMILES('C[CH]C([O])OO'),
    E0 = (17.0428,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,974.622,977.113],'cm^-1')),
        HinderedRotor(inertia=(0.22265,'amu*angstrom^2'), symmetry=1, barrier=(5.11916,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.220169,'amu*angstrom^2'), symmetry=1, barrier=(5.06211,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.221717,'amu*angstrom^2'), symmetry=1, barrier=(5.09771,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.0709,'amu*angstrom^2'), symmetry=1, barrier=(47.6141,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (90.0779,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.47892,0.0621044,-8.99447e-05,8.30721e-08,-3.14922e-11,2134.1,26.1963], Tmin=(100,'K'), Tmax=(781.185,'K')), NASAPolynomial(coeffs=[4.50148,0.0356014,-1.78828e-05,3.50597e-09,-2.46579e-13,1998.3,14.514], Tmin=(781.185,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(17.0428,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + radical(CCOJ) + radical(CCJCOOH)"""),
)
...
species(
    ...
    molecularWeight = (90.0779,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.59235,0.0428521,-8.75698e-06,-1.91967e-08,1.01127e-11,-56573.2,21.5733], Tmin=(100,'K'), Tmax=(1022.91,'K')), NASAPolynomial(coeffs=[12.9403,0.0205162,-8.32246e-06,1.58364e-09,-1.14e-13,-60047.9,-39.0672], Tmin=(1022.91,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-471.17,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-O2d)) + group(O2s-OsH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsOs)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'CCC(=O)O[O](11857)'],
    products = ['CCC([O])O[O](10578)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['C2H5(29)', 'formylperoxy(697)'],
    products = ['CCC([O])O[O](10578)'],
    transitionState = 'TS3',
...
reaction(
    ...
    products = ['CCC([O])O[O](10578)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(0.0849,'cm^3/(mol*s)'), n=3.486, Ea=(181.585,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1600,'K'), comment="""Estimated using template [CO-CsH_O;OJ] for rate rule [CO-CsH_O;O2b]
Euclidian distance = 1.0
Multiplied by reaction path degeneracy 2.0
family: R_Addition_MultipleBond
Ea raised from 178.1 to 181.6 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction5',
    reactants = ['CCC([O])O[O](10578)'],
    products = ['CC[C](O)O[O](11595)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction13',
    reactants = ['CC([O])O[O](157)', 'CH2(S)(23)'],
    products = ['CCC([O])O[O](10578)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CCC([O])O[O](10578)'],
    products = ['HO2(10)', 'CH3CHCHO(10571)'],
