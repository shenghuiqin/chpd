...
species(
    ...
    E0 = (346.353,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,492.5,1135,1000,180,180,3555.68,3555.93],'cm^-1')),
...
reaction(
    label = 'reaction1',
    reactants = ['CH2CHOO(46)'],
    products = ['[CH2]C1OO1(107)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]C1OO1(107)'],
    products = ['C[C]1OO1(1441)'],
    transitionState = 'TS3',
