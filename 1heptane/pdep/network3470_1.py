...
species(
    label = '[O]COC1CCC1[O](18845)',
    structure = SMILES('[O]COC1CCC1[O]'),
    E0 = (-44.5198,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (116.115,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.898223,0.0496346,2.04706e-05,-6.31464e-08,2.74191e-11,-5226.35,27.8607], Tmin=(100,'K'), Tmax=(995.27,'K')), NASAPolynomial(coeffs=[17.8271,0.0257852,-1.01824e-05,1.99503e-09,-1.4893e-13,-10784.7,-64.7261], Tmin=(995.27,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-44.5198,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(374.151,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-OsOsHH) + ring(Cyclobutane) + radical(CC(C)OJ) + radical(OCOJ)"""),
)
...
species(
    label = '[O]COC=CCC=O(18847)',
    structure = SMILES('[O]COC=CCC=O'),
    E0 = (-247.806,'kJ/mol'),
    modes = [
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.512586,0.0548031,1.33985e-05,-6.50686e-08,3.0056e-11,-29659.1,28.0637], Tmin=(100,'K'), Tmax=(990.633,'K')), NASAPolynomial(coeffs=[23.052,0.015875,-6.51943e-06,1.40746e-09,-1.13618e-13,-36680.3,-93.3626], Tmin=(990.633,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-247.806,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(Cs-OsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-OdCsH) + radical(OCOJ)"""),
)
...
species(
    label = '[O]COC[CH]CC=O(18848)',
    structure = SMILES('[O]COC[CH]CC=O'),
    E0 = (-130.842,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2782.5,750,1395,475,1775,1000,3025,407.5,1350,352.5,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (116.115,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.09304,0.067708,-5.2833e-05,2.20022e-08,-3.93401e-12,-15635.4,30.9921], Tmin=(100,'K'), Tmax=(1256.42,'K')), NASAPolynomial(coeffs=[10.2901,0.038428,-1.78766e-05,3.45408e-09,-2.43364e-13,-17946.5,-15.4776], Tmin=(1256.42,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-130.842,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cs-OsOsHH) + group(Cds-OdCsH) + radical(CCJCO) + radical(OCOJ)"""),
)
...
species(
    label = '[O][CH]OCCCC=O(18850)',
    structure = SMILES('[O][CH]OCCCC=O'),
    E0 = (-141.784,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2782.5,750,1395,475,1775,1000,3025,407.5,1350,352.5,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (116.115,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.406965,0.0946022,-0.000161567,1.62883e-07,-6.27526e-11,-16938.4,30.7438], Tmin=(100,'K'), Tmax=(836.168,'K')), NASAPolynomial(coeffs=[0.941529,0.0562204,-2.84477e-05,5.51083e-09,-3.81513e-13,-15775.4,35.7493], Tmin=(836.168,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-141.784,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cs-OsOsHH) + group(Cds-OdCsH) + radical(OCJO) + radical(OCOJ)"""),
)

species(
    label = '[O]COCC[CH]C=O(18851)',
    structure = SMILES('[O]C=CCCOC[O]'),
    E0 = (-187.492,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (116.115,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.210445,0.0697391,-3.50652e-05,-9.46315e-09,9.67528e-12,-22401.7,31.3765], Tmin=(100,'K'), Tmax=(1008.72,'K')), NASAPolynomial(coeffs=[19.1792,0.0233825,-9.05059e-06,1.70911e-09,-1.23665e-13,-27696.9,-67.5799], Tmin=(1008.72,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-187.492,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-OsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(C=COJ) + radical(OCOJ)"""),
)

species(
    label = '[O]COCCC[C]=O(18852)',
    structure = SMILES('[O]COCCC[C]=O'),
    E0 = (-170.783,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (116.115,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.782388,0.0761305,-7.63035e-05,4.43875e-08,-1.10849e-11,-20429.1,30.4492], Tmin=(100,'K'), Tmax=(940.379,'K')), NASAPolynomial(coeffs=[9.24787,0.0401222,-1.88674e-05,3.66964e-09,-2.60152e-13,-22021.3,-9.8716], Tmin=(940.379,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-170.783,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cs-OsOsHH) + group(Cds-OdCsH) + radical(CCCJ=O) + radical(OCOJ)"""),
)

species(
    label = 'O=CC[CH][CH]OCO(18853)',
    structure = SMILES('O=CC[CH][CH]OCO'),
    E0 = (-177.784,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (116.115,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.901856,0.0909418,-9.42743e-05,4.7433e-08,-9.0593e-12,-21191.6,37.1292], Tmin=(100,'K'), Tmax=(1403.33,'K')), NASAPolynomial(coeffs=[23.9893,0.0127527,-2.96004e-06,3.76715e-10,-2.13617e-14,-27464.7,-88.8506], Tmin=(1403.33,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-177.784,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cs-OsOsHH) + group(Cds-OdCsH) + radical(CCsJOCs) + radical(CCJCO)"""),
)

species(
    label = 'O=C[CH]C[CH]OCO(18854)',
    structure = SMILES('[O]C=CC[CH]OCO'),
    E0 = (-234.434,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (116.115,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.575631,0.078826,-2.73736e-05,-4.75979e-08,3.17489e-11,-28010.8,33.1682], Tmin=(100,'K'), Tmax=(914.924,'K')), NASAPolynomial(coeffs=[30.1972,0.00220098,3.3056e-06,-7.69315e-10,4.9046e-14,-36065.6,-125.803], Tmin=(914.924,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-234.434,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-OsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(C=COJ) + radical(CCsJOCs)"""),
)

species(
    label = 'O=[C]CC[CH]OCO(18855)',
    structure = SMILES('O=[C]CC[CH]OCO'),
    E0 = (-217.725,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (116.115,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.918371,0.0962823,-0.000108551,5.97161e-08,-1.25244e-11,-25999,35.5027], Tmin=(100,'K'), Tmax=(1237.64,'K')), NASAPolynomial(coeffs=[23.4723,0.0134644,-3.34327e-06,4.41232e-10,-2.51312e-14,-31730.9,-86.1344], Tmin=(1237.64,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-217.725,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cs-OsOsHH) + group(Cds-OdCsH) + radical(CCCJ=O) + radical(CCsJOCs)"""),
)
...
species(
    label = '[O]COC1CC[CH]O1(18856)',
    structure = SMILES('[O]COC1CC[CH]O1'),
    E0 = (-162.15,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (116.115,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.959233,0.0489209,2.62774e-05,-7.74755e-08,3.6424e-11,-19376,24.7598], Tmin=(100,'K'), Tmax=(916.942,'K')), NASAPolynomial(coeffs=[18.0656,0.0210691,-4.67319e-06,6.5612e-10,-4.51991e-14,-24479.3,-67.0069], Tmin=(916.942,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-162.15,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(374.151,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-OsOsHH) + ring(Tetrahydrofuran) + radical(OCOJ) + radical(CCsJOCs)"""),
)
...
species(
    label = 'O=CCCCOC=O(18858)',
    structure = SMILES('O=CCCCOC=O'),
    E0 = (-537.978,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (116.115,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.69509,0.0589846,-3.55273e-05,1.02087e-08,-1.2301e-12,-64629.5,26.2843], Tmin=(100,'K'), Tmax=(1695.26,'K')), NASAPolynomial(coeffs=[9.86324,0.0397116,-1.84742e-05,3.50253e-09,-2.41137e-13,-67398.9,-17.4337], Tmin=(1695.26,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-537.978,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cds-OdCsH) + group(Cds-OdOsH)"""),
)

species(
    label = 'O=CCC=COCO(18859)',
    structure = SMILES('O=CCC=COCO'),
    E0 = (-475.204,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (116.115,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0176627,0.0574432,3.80787e-05,-1.13767e-07,5.34983e-11,-56980.8,29.4891], Tmin=(100,'K'), Tmax=(941.77,'K')), NASAPolynomial(coeffs=[31.5048,0.00170637,2.3813e-06,-3.85187e-10,1.01547e-14,-66383.8,-139.097], Tmin=(941.77,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-475.204,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(Cs-OsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-OdCsH)"""),
)
...
species(
    label = '[CH2]C(CC=O)OC[O](18860)',
    structure = SMILES('[CH2]C(CC=O)OC[O]'),
    E0 = (-130.785,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (116.115,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.437923,0.0844604,-9.61546e-05,6.30591e-08,-1.73981e-11,-15606.8,30.2763], Tmin=(100,'K'), Tmax=(865.654,'K')), NASAPolynomial(coeffs=[10.0595,0.0400018,-1.9118e-05,3.73167e-09,-2.64603e-13,-17272.6,-14.7543], Tmin=(865.654,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-130.785,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cs-OsOsHH) + group(Cds-OdCsH) + radical(CJC(C)OC) + radical(OCOJ)"""),
)
...
species(
    label = 'C=COC[CH]OC[O](18861)',
    structure = SMILES('C=COC[CH]OC[O]'),
    E0 = (-108.691,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2950,3100,1380,975,1025,1650,3010,987.5,1337.5,450,1655,3025,407.5,1350,352.5,200,800,933.333,1066.67,1200,1333.33,1466.67,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (116.115,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.539679,0.0850385,-6.02932e-05,1.90748e-09,9.51122e-12,-12895.7,30.8495], Tmin=(100,'K'), Tmax=(958.158,'K')), NASAPolynomial(coeffs=[24.6659,0.014536,-4.27958e-06,7.55745e-10,-5.65321e-14,-19319.7,-97.9927], Tmin=(958.158,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-108.691,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-OsOsHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CCsJOCs) + radical(OCOJ)"""),
)

species(
    label = '[O]CO[CH]CC=CO(18862)',
    structure = SMILES('[O]CO[CH]CC=CO'),
    E0 = (-148.499,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3025,407.5,1350,352.5,3615,1277.5,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (116.115,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.472365,0.0834048,-5.66822e-05,-2.92255e-09,1.18033e-11,-17685.6,31.8613], Tmin=(100,'K'), Tmax=(943.45,'K')), NASAPolynomial(coeffs=[24.7898,0.0130203,-3.15995e-06,5.11927e-10,-3.86553e-14,-24086.5,-97.2043], Tmin=(943.45,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-148.499,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-OsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(OCOJ) + radical(CCsJOCs)"""),
)
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', '[O]COC=CCC=O(18847)'],
    products = ['[O]CO[CH]CCC=O(18420)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)', 'O=CCC[CH]OC=O(18676)'],
    products = ['[O]CO[CH]CCC=O(18420)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['CH2CHO(40)', 'C=COC[O](961)'],
    products = ['[O]CO[CH]CCC=O(18420)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['[O]CO[CH]CCC=O(18420)'],
    products = ['O=CCC[CH]O[CH]O(18849)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction14',
    reactants = ['[O]CO[CH]CCC=O(18420)'],
    products = ['O=C[CH]C[CH]OCO(18854)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH2]C(CC=O)OC[O](18860)'],
    products = ['[O]CO[CH]CCC=O(18420)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[O]C[O](170)', '[CH]CCC=O(18484)'],
    products = ['[O]CO[CH]CCC=O(18420)'],
