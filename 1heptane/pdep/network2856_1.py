...
species(
    label = '[CH2]C(OO)OC=CC(16215)',
    structure = SMILES('[CH2]C(OO)OC=CC'),
    E0 = (-136.296,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,3615,1310,387.5,850,1000,3000,3100,440,815,1455,1000,1380,1390,370,380,2900,435,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.617667,0.0890136,-7.33615e-05,2.15633e-08,5.78758e-13,-16215.4,32.9806], Tmin=(100,'K'), Tmax=(1014.84,'K')), NASAPolynomial(coeffs=[22.5546,0.0212284,-7.97711e-06,1.47617e-09,-1.05553e-13,-22131.2,-85.1283], Tmin=(1014.84,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-136.296,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(CJCOOH)"""),
)

species(
    label = 'C=C(OO)O[CH]CC(16216)',
    structure = SMILES('C=C(OO)O[CH]CC'),
    E0 = (-48.0017,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (117.123,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.385436,0.0996395,-0.000118442,7.41349e-08,-1.85967e-11,-5617.98,29.9856], Tmin=(100,'K'), Tmax=(968.897,'K')), NASAPolynomial(coeffs=[15.8275,0.0327057,-1.4818e-05,2.83395e-09,-1.99123e-13,-8759.68,-47.7199], Tmin=(968.897,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-48.0017,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(CCsJOC(O))"""),
)
...
species(
    label = '[CH2]CCOC([CH2])OO(16217)',
    structure = SMILES('[CH2]CCOC([CH2])OO'),
    E0 = (-6.67026,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (118.131,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0918355,0.0926907,-0.000101687,6.42389e-08,-1.71636e-11,-667.28,34.9852], Tmin=(100,'K'), Tmax=(889.786,'K')), NASAPolynomial(coeffs=[10.6626,0.0451702,-2.15765e-05,4.21697e-09,-2.99459e-13,-2548.43,-14.7783], Tmin=(889.786,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-6.67026,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(403.252,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJ) + radical(CJCOOH)"""),
)

species(
    label = 'CC[CH]OC(C)O[O](16218)',
    structure = SMILES('CC[CH]OC(C)O[O]'),
    E0 = (-93.4185,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (118.131,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0355494,0.094149,-0.000107572,7.0306e-08,-1.90949e-11,-11095,31.859], Tmin=(100,'K'), Tmax=(884.473,'K')), NASAPolynomial(coeffs=[11.4925,0.0420129,-1.91517e-05,3.65804e-09,-2.56207e-13,-13134.2,-22.3416], Tmin=(884.473,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-93.4185,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(407.409,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCsJOCs) + radical(ROOJ)"""),
)
...
species(
    label = '[CH2]C(O[O])OCCC(16219)',
    structure = SMILES('[CH2]C(O[O])OCCC'),
    E0 = (-59.9119,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (118.131,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.211216,0.0896831,-0.000100805,6.80123e-08,-1.9554e-11,-7074.93,33.5254], Tmin=(100,'K'), Tmax=(829.262,'K')), NASAPolynomial(coeffs=[9.32088,0.0457414,-2.13209e-05,4.11165e-09,-2.89383e-13,-8585.77,-8.7178], Tmin=(829.262,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-59.9119,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(407.409,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJCOOH) + radical(ROOJ)"""),
)

species(
    label = '[CH2]C[CH]OC(C)OO(16220)',
    structure = SMILES('[CH2]C[CH]OC(C)OO'),
    E0 = (-40.1768,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (118.131,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.183322,0.0975184,-0.000109849,6.85421e-08,-1.76601e-11,-4686.16,33.4188], Tmin=(100,'K'), Tmax=(931.221,'K')), NASAPolynomial(coeffs=[12.8973,0.041331,-1.93423e-05,3.74777e-09,-2.64976e-13,-7122.34,-28.7556], Tmin=(931.221,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-40.1768,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(403.252,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJ) + radical(CCsJOCs)"""),
)
...
species(
    label = '[CH2]C(OO)O[CH]C(8869)',
    structure = SMILES('[CH2]C(OO)O[CH]C'),
    E0 = (-7.68036,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1310,387.5,850,1000,3000,3100,440,815,1455,1000,1380,1390,370,380,2900,435,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.298371,0.0855057,-0.000101661,6.48592e-08,-1.67695e-11,-793.883,29.6491], Tmin=(100,'K'), Tmax=(936.114,'K')), NASAPolynomial(coeffs=[13.0222,0.0311358,-1.45379e-05,2.81171e-09,-1.98548e-13,-3176,-30.8955], Tmin=(936.114,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-7.68036,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(332.579,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCsJOCs) + radical(CJCOOH)"""),
)
...
species(
    label = 'CC[CH]OC1CO1(16221)',
    structure = SMILES('CC[CH]OC1CO1'),
    E0 = (-127.364,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (101.124,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.046325,0.0757555,-7.06284e-05,3.60641e-08,-7.21269e-12,-15166.5,27.0625], Tmin=(100,'K'), Tmax=(1352.65,'K')), NASAPolynomial(coeffs=[15.2831,0.0242199,-6.29509e-06,8.16227e-10,-4.3716e-14,-18695.9,-48.858], Tmin=(1352.65,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-127.364,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CCsJOCs)"""),
)

species(
    label = '[CH2]C1OC(CC)O1(16222)',
    structure = SMILES('[CH2]C1OC(CC)O1'),
    E0 = (-137.263,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (101.124,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.09493,0.0497829,4.06185e-06,-3.7035e-08,1.61122e-11,-16392.2,25.465], Tmin=(100,'K'), Tmax=(1048.54,'K')), NASAPolynomial(coeffs=[14.602,0.0299217,-1.28252e-05,2.50345e-09,-1.81842e-13,-20965.5,-48.6397], Tmin=(1048.54,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-137.263,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(369.994,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Cyclobutane) + radical(CJCO)"""),
)
...
species(
    label = 'CC[CH]OC([O])CO(16223)',
    structure = SMILES('CC[CH]OC([O])CO'),
    E0 = (-251.05,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (118.131,'amu'),
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(OO)O[CH]CC(13482)'],
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', '[CH2]C(OO)OC=CC(16215)'],
    products = ['[CH2]C(OO)O[CH]CC(13482)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'C=C(OO)O[CH]CC(16216)'],
    products = ['[CH2]C(OO)O[CH]CC(13482)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['CH3(17)', '[CH2]C(OO)OC=C(10667)'],
    products = ['[CH2]C(OO)O[CH]CC(13482)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['HO2(10)', 'C=CO[CH]CC(10587)'],
    products = ['[CH2]C(OO)O[CH]CC(13482)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]CCOC([CH2])OO(16217)'],
    products = ['[CH2]C(OO)O[CH]CC(13482)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CC[CH]OC(C)O[O](16218)'],
    products = ['[CH2]C(OO)O[CH]CC(13482)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]C(OO)O[CH]CC(13482)'],
    products = ['[CH2]C[CH]OC(C)OO(16220)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CH2(S)(23)', '[CH2]C(OO)O[CH]C(8869)'],
    products = ['[CH2]C(OO)O[CH]CC(13482)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2]C(OO)O[CH]CC(13482)'],
    products = ['OH(5)', 'CC[CH]OC1CO1(16221)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2]C(OO)O[CH]CC(13482)'],
    products = ['OH(5)', '[CH2]C1OC(CC)O1(16222)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[CH]CC(144)', '[CH2]C([O])OO(3363)'],
    products = ['[CH2]C(OO)O[CH]CC(13482)'],
...
reaction(
    label = 'reaction25',
    reactants = ['CH2(19)', 'CC[CH]O[CH]OO(11561)'],
    products = ['[CH2]C(OO)O[CH]CC(13482)'],
