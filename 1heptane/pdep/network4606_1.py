...
species(
    label = '[CH2]C1[C]=CCC1CCC(28539)',
    structure = SMILES('[CH2]C1[C]=CCC1CCC'),
    E0 = (372.452,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (122.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.127396,0.0663516,1.80815e-05,-6.58976e-08,2.87685e-11,44951.7,33.8867], Tmin=(100,'K'), Tmax=(987.31,'K')), NASAPolynomial(coeffs=[16.4276,0.0447136,-1.65018e-05,3.00384e-09,-2.12031e-13,39569,-55.5036], Tmin=(987.31,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(372.452,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(540.441,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cyclopentene) + radical(cyclopentene-vinyl) + radical(Isobutyl)"""),
)
...
species(
    label = 'C=C[C]=CCC=CCC(28604)',
    structure = SMILES('C=C[C]=CCC=CCC'),
    E0 = (280.846,'kJ/mol'),
    modes = [
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.568334,0.0881004,-5.13089e-05,6.24795e-09,3.43196e-12,33953,36.1731], Tmin=(100,'K'), Tmax=(1061.78,'K')), NASAPolynomial(coeffs=[17.3107,0.0419284,-1.60062e-05,2.8715e-09,-1.97015e-13,28962.2,-56.7776], Tmin=(1061.78,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(280.846,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(511.34,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + radical(C=CJC=C)"""),
)

species(
    label = 'C=C[C]=CC=CCCC(28605)',
    structure = SMILES('C=C[C]=CC=CCCC'),
    E0 = (262.237,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2950,3100,1380,975,1025,1650,1685,370,2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3005,3015,3025,975,983.333,991.667,1000,1300,1325,1350,1375,400,433.333,466.667,500,1630,1646.67,1663.33,1680,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (121.2,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.798617,0.0921622,-5.34401e-05,1.33176e-09,6.99384e-12,31724.4,34.4129], Tmin=(100,'K'), Tmax=(999.084,'K')), NASAPolynomial(coeffs=[19.4825,0.0384069,-1.39363e-05,2.46559e-09,-1.69638e-13,26302.2,-70.2679], Tmin=(999.084,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(262.237,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(511.34,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + radical(C=CJC=C)"""),
)

species(
    label = 'C=CC#CC[CH]CCC(28606)',
    ...
    molecularWeight = (121.2,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.012027,0.0827471,-5.24166e-05,1.74354e-08,-2.43769e-12,39734.9,37.061], Tmin=(100,'K'), Tmax=(1593.46,'K')), NASAPolynomial(coeffs=[14.3169,0.046838,-1.86136e-05,3.29303e-09,-2.1886e-13,35176,-38.6166], Tmin=(1593.46,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(329.152,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CtCsHH) + group(Cs-CsHHH) + group(Cds-CdsCtH) + group(Cds-CdsHH) + group(Ct-CtCs) + group(Ct-Ct(Cds-Cds)) + radical(RCCJCC)"""),
)

species(
    label = 'C=C=C=CC[CH]CCC(28607)',
    structure = SMILES('C=C=C=CC[CH]CCC'),
    E0 = (387.753,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (121.2,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.224255,0.0896988,-7.23221e-05,3.59087e-08,-8.202e-12,46766.3,34.6685], Tmin=(100,'K'), Tmax=(979.732,'K')), NASAPolynomial(coeffs=[7.44516,0.0602177,-2.71856e-05,5.19515e-09,-3.64774e-13,45351.4,-0.0203241], Tmin=(979.732,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(387.753,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(511.34,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + group(Cdd-CdsCds) + radical(RCCJCC)"""),
)
...
species(
    label = 'C=C[C]=CCC[CH]CC(28608)',
    structure = SMILES('C=C[C]=CCC[CH]CC'),
    E0 = (357.363,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,3025,407.5,1350,352.5,2995,3025,975,1000,1300,1375,400,500,1630,1680,2750,2800,2850,1350,1500,750,1050,1375,1000,2950,3100,1380,975,1025,1650,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'C=C[C]=CCCC[CH]C(28611)',
    structure = SMILES('C=C[C]=CCCC[CH]C'),
    E0 = (357.351,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (122.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.318544,0.0942059,-7.15113e-05,3.07048e-08,-5.65554e-12,43135.3,37.2781], Tmin=(100,'K'), Tmax=(1242.75,'K')), NASAPolynomial(coeffs=[12.5351,0.0528341,-2.15754e-05,3.9169e-09,-2.6669e-13,39940.6,-27.5269], Tmin=(1242.75,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(357.351,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(532.126,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + radical(RCCJC) + radical(C=CJC=C)"""),
)

species(
    label = 'C=C[C]=[C]CCCCC(28612)',
    structure = SMILES('[CH2][CH]C#CCCCCC'),
    E0 = (365.024,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,2100,2250,500,550,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,3025,407.5,1350,352.5,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (122.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.586698,0.0932694,-7.05467e-05,3.06563e-08,-5.59869e-12,44073.7,39.9935], Tmin=(100,'K'), Tmax=(1283.62,'K')), NASAPolynomial(coeffs=[14.1073,0.04748,-1.70384e-05,2.8659e-09,-1.86159e-13,40301.4,-34.5653], Tmin=(1283.62,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(365.024,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(527.969,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CtCsHH) + group(Cs-CtCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtCs) + radical(RCCJ) + radical(Sec_Propargyl)"""),
)

species(
    label = 'C=CC=C[CH][CH]CCC(28613)',
...
species(
    label = '[CH]=CC=CC[CH]CCC(28614)',
    structure = SMILES('[CH]=CC=CC[CH]CCC'),
    E0 = (405.464,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (122.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.323942,0.0922022,-6.59715e-05,2.53168e-08,-4.09335e-12,48923.6,37.9309], Tmin=(100,'K'), Tmax=(1405.93,'K')), NASAPolynomial(coeffs=[14.6811,0.0495116,-2.04247e-05,3.71931e-09,-2.52938e-13,44704.4,-39.572], Tmin=(1405.93,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(405.464,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(532.126,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + radical(Cds_P) + radical(RCCJCC)"""),
)

species(
    label = '[CH2]CCCCC=[C]C=C(28615)',
    structure = SMILES('[CH2]CCCCC=[C]C=C'),
    E0 = (368.151,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,2950,3100,1380,975,1025,1650,1685,370,2995,3025,975,1000,1300,1375,400,500,1630,1680,3000,3100,440,815,1455,1000,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    ...
    molecularWeight = (122.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.496624,0.0934967,-6.90922e-05,2.8524e-08,-4.9689e-12,38039.5,37.3527], Tmin=(100,'K'), Tmax=(1327.11,'K')), NASAPolynomial(coeffs=[14.2294,0.0491117,-1.89252e-05,3.32302e-09,-2.21572e-13,34130.9,-37.8593], Tmin=(1327.11,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(314.897,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(527.969,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CtCsHH) + group(Cs-CsHHH) + group(Cs-CtHHH) + group(Ct-CtCs) + group(Ct-CtCs) + radical(Sec_Propargyl) + radical(Propargyl)"""),
)

species(
    label = 'C=CC=CC[CH]C[CH]C(28618)',
...
species(
    label = '[CH]=C[C]=CCCCCC(28619)',
    structure = SMILES('[CH]C=C=CCCCCC'),
    E0 = (387.375,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,540,610,2055,2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (122.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.580237,0.0957513,-6.14071e-05,2.01166e-08,-2.7447e-12,46758.7,37.0267], Tmin=(100,'K'), Tmax=(1632.84,'K')), NASAPolynomial(coeffs=[17.08,0.0524885,-2.16638e-05,3.8898e-09,-2.60249e-13,40991.4,-56.8326], Tmin=(1632.84,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(387.375,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(532.126,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cdd-CdsCds) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[CH2]CC[CH]CC=CC=C(28620)',
...
species(
    label = 'CCC[CH]CC=C1[CH]C1(28621)',
    structure = SMILES('CCC[CH]CC=C1[CH]C1'),
    E0 = (392.504,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (122.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.126325,0.0788592,-3.3174e-05,-1.53945e-09,3.30389e-12,47365.5,35.9145], Tmin=(100,'K'), Tmax=(1225.89,'K')), NASAPolynomial(coeffs=[14.2705,0.0501836,-2.0479e-05,3.73425e-09,-2.5502e-13,42460.6,-42.0827], Tmin=(1225.89,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(392.504,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(536.283,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + ring(Methylene_cyclopropane) + radical(RCCJCC) + radical(Allyl_S)"""),
)
...
species(
    label = 'C=C=C=CCCCCC(28625)',
    structure = SMILES('C=C=C=CCCCCC'),
    E0 = (193.295,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (122.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.437342,0.0943226,-6.72393e-05,2.5125e-08,-3.92108e-12,23409.9,34.4551], Tmin=(100,'K'), Tmax=(1456.58,'K')), NASAPolynomial(coeffs=[16.0507,0.0490438,-2.0611e-05,3.78363e-09,-2.58162e-13,18606.6,-51.2915], Tmin=(1456.58,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(193.295,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(536.283,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + group(Cdd-CdsCds)"""),
)
...
species(
    ...
    E0 = (381.143,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,3025,407.5,1350,352.5,2995,3025,975,1000,1300,1375,400,500,1630,1680,2750,2800,2850,1350,1500,750,1050,1375,1000,2950,3100,1380,975,1025,1650,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    collisionModel = TransportData(shapeIndex=2, epsilon=(3578.78,'J/mol'), sigma=(6.3507,'angstroms'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with Tc=559.00 K, Pc=31.7 bar (from Joback method)"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
...
species(
    label = 'C=CC1=CCC1CCC(28487)',
    structure = SMILES('C=CC1=CCC1CCC'),
    E0 = (115.362,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (122.207,'amu'),
...
species(
    ...
    molecularWeight = (122.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.067202,0.0916622,-7.74878e-05,4.36013e-08,-1.10279e-11,42594.3,37.3285], Tmin=(100,'K'), Tmax=(918.695,'K')), NASAPolynomial(coeffs=[7.59446,0.0583042,-2.30239e-05,4.07961e-09,-2.73283e-13,41186.5,1.01488], Tmin=(918.695,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(352.948,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(527.969,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CtCsHH) + group(Cs-CsHHH) + group(Cs-CtHHH) + group(Ct-CtCs) + group(Ct-CtCs) + radical(Sec_Propargyl) + radical(RCCJCC)"""),
)

species(
    label = 'CC=C=[C]C[CH]CCC(28628)',
    structure = SMILES('C[CH]C#CC[CH]CCC'),
    E0 = (354.236,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (122.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.00746604,0.0884975,-6.80296e-05,3.35683e-08,-7.45098e-12,42747.9,37.9505], Tmin=(100,'K'), Tmax=(1031.93,'K')), NASAPolynomial(coeffs=[8.1623,0.0568871,-2.20806e-05,3.88308e-09,-2.59225e-13,41064.9,-1.64809], Tmin=(1031.93,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(354.236,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(527.969,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CtCsHH) + group(Cs-CtCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtCs) + radical(Sec_Propargyl) + radical(RCCJCC)"""),
)

species(
    label = 'CC=C=C[CH][CH]CCC(28629)',
    structure = SMILES('CC=[C]C=C[CH]CCC'),
    E0 = (291.772,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (122.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.797309,0.0949707,-6.75884e-05,2.53616e-08,-3.91332e-12,35273.3,34.7293], Tmin=(100,'K'), Tmax=(1505.57,'K')), NASAPolynomial(coeffs=[18.2934,0.0442514,-1.70576e-05,2.98688e-09,-1.98063e-13,29524.8,-65.1838], Tmin=(1505.57,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(291.772,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(532.126,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + radical(Allyl_S) + radical(C=CJC=C)"""),
)

species(
    label = 'CC=C=CC[CH][CH]CC(28630)',
    structure = SMILES('CC=C=CC[CH][CH]CC'),
    E0 = (405.607,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,540,610,2055,2995,3025,975,1000,1300,1375,400,500,1630,1680,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3000,3050,390,425,1340,1360,335,370,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (122.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0471741,0.095465,-0.000106222,9.14308e-08,-3.48178e-11,48917.4,38.7945], Tmin=(100,'K'), Tmax=(782.008,'K')), NASAPolynomial(coeffs=[2.25343,0.0705539,-3.23022e-05,6.13216e-09,-4.25515e-13,48989,31.357], Tmin=(782.008,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(405.607,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(532.126,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cdd-CdsCds) + radical(RCCJCC) + radical(RCCJCC)"""),
)

species(
    label = 'C[CH]C[CH]CC=C=CC(28631)',
    ...
    molecularWeight = (122.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0371383,0.0946329,-9.96094e-05,8.09439e-08,-2.99611e-11,48917.4,39.0047], Tmin=(100,'K'), Tmax=(765.366,'K')), NASAPolynomial(coeffs=[3.25683,0.068764,-3.11896e-05,5.9117e-09,-4.10591e-13,48689.4,26.0626], Tmin=(765.366,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(405.595,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(532.126,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cdd-CdsCds) + radical(RCCJC) + radical(RCCJCC)"""),
)

species(
    label = '[CH2]C=C1[CH]CC1CCC(28632)',
    structure = SMILES('[CH2]C=C1[CH]CC1CCC'),
    E0 = (277.627,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (122.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[9.01643,0.0136341,0.000122393,-1.28109e-07,3.02285e-11,33101.6,-8.06575], Tmin=(100,'K'), Tmax=(1696.81,'K')), NASAPolynomial(coeffs=[77.3524,0.0472932,-7.95253e-05,1.88657e-08,-1.39207e-12,-18125.1,-456.494], Tmin=(1696.81,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(277.627,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(540.441,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + ring(methylenecyclobutane) + radical(Allyl_S) + radical(Allyl_P)"""),
)

species(
    label = 'CCC[CH]CC1[C]=CC1(28633)',
    structure = SMILES('CCC[CH]CC1[C]=CC1'),
    E0 = (464.538,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (122.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0834887,0.0781783,-3.3241e-05,-7.87153e-10,2.95916e-12,56027.6,37.298], Tmin=(100,'K'), Tmax=(1239.01,'K')), NASAPolynomial(coeffs=[14.0859,0.0499783,-2.03405e-05,3.69979e-09,-2.521e-13,51169.7,-39.5322], Tmin=(1239.01,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(464.538,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(536.283,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cyclobutene) + radical(cyclobutene-vinyl) + radical(RCCJCC)"""),
)

species(
    label = 'CC=C=CC=CCCC(28634)',
    structure = SMILES('CC=C=CC=CCCC'),
    E0 = (116.023,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (122.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.880505,0.0940719,-6.29779e-05,1.92214e-08,-1.70399e-12,14141,35.1552], Tmin=(100,'K'), Tmax=(1226.6,'K')), NASAPolynomial(coeffs=[18.7934,0.0431914,-1.69933e-05,3.05319e-09,-2.07301e-13,8315.82,-67.85], Tmin=(1226.6,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(116.023,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(536.283,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cdd-CdsCds)"""),
)

species(
    label = 'CC=C=CCC=CCC(28635)',
    structure = SMILES('CC=C=CCC=CCC'),
    E0 = (134.632,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (122.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.616418,0.0893721,-5.75811e-05,1.86055e-08,-2.43781e-12,16368.7,36.8112], Tmin=(100,'K'), Tmax=(1752.48,'K')), NASAPolynomial(coeffs=[20.6384,0.040858,-1.60562e-05,2.8088e-09,-1.84309e-13,8918.99,-77.6558], Tmin=(1752.48,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(134.632,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(536.283,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cdd-CdsCds)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['C=C[C]=CC[CH]CCC(28450)'],
...
reaction(
    label = 'reaction2',
    reactants = ['C=C[C]=CC[CH]CCC(28450)'],
    products = ['[CH2]C1[C]=CCC1CCC(28539)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'C=C[C]=CCC=CCC(28604)'],
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', 'C=C[C]=CC=CCCC(28605)'],
    products = ['C=C[C]=CC[CH]CCC(28450)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)', 'C=CC#CC[CH]CCC(28606)'],
    products = ['C=C[C]=CC[CH]CCC(28450)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['H(3)', 'C=C=C=CC[CH]CCC(28607)'],
    products = ['C=C[C]=CC[CH]CCC(28450)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['C2H5(29)', 'C=C[C]=CCC=C(26886)'],
    products = ['C=C[C]=CC[CH]CCC(28450)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction10',
    reactants = ['C=C[C]=CCC[CH]CC(28608)'],
    products = ['C=C[C]=CC[CH]CCC(28450)'],
...
reaction(
    label = 'reaction12',
    reactants = ['C=CC=[C]C[CH]CCC(28609)'],
    products = ['C=C[C]=CC[CH]CCC(28450)'],
...
reaction(
    label = 'reaction13',
    reactants = ['C=[C]C=CC[CH]CCC(28610)'],
    products = ['C=C[C]=CC[CH]CCC(28450)'],
...
reaction(
    label = 'reaction14',
    reactants = ['C=C[C]=CC[CH]CCC(28450)'],
    products = ['C=C[C]=CCCC[CH]C(28611)'],
...
reaction(
    label = 'reaction16',
    reactants = ['C=C[C]=CC[CH]CCC(28450)'],
    products = ['C=CC=C[CH][CH]CCC(28613)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH]=CC=CC[CH]CCC(28614)'],
    products = ['C=C[C]=CC[CH]CCC(28450)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2]CCCCC=[C]C=C(28615)'],
    products = ['C=C[C]=CC[CH]CCC(28450)'],
...
reaction(
    label = 'reaction19',
    reactants = ['C=C[C]=CC[CH]CCC(28450)'],
    products = ['C=CC=CC[CH][CH]CC(28616)'],
...
reaction(
    label = 'reaction21',
    reactants = ['C=C[C]=CC[CH]CCC(28450)'],
    products = ['C=CC=CC[CH]C[CH]C(28618)'],
    transitionState = 'TS21',
    kinetics = Arrhenius(A=(6.1583e+09,'s^-1'), n=0.92705, Ea=(170.178,'kJ/mol'), T0=(1,'K'), comment="""Estimated using average of templates [RnH;Cd_rad_out_single;Cs_H_out_H/NonDeC] + [RnH;Cd_rad_out_singleDe_Cd;Cs_H_out] for rate rule [R6HJ_3;Cd_rad_out_singleDe_Cd;Cs_H_out_H/NonDeC]
...
reaction(
    label = 'reaction23',
    reactants = ['[CH2]CC[CH]CC=CC=C(28620)'],
    products = ['C=C[C]=CC[CH]CCC(28450)'],
...
reaction(
    label = 'reaction25',
    reactants = ['C=C[C]=CC[CH]CCC(28450)'],
    products = ['CCC[CH]CC=C1[CH]C1(28621)'],
...
reaction(
    label = 'reaction30',
    reactants = ['CH2(S)(23)', 'C=C[C]=CC[CH]CC(26536)'],
    products = ['C=C[C]=CC[CH]CCC(28450)'],
...
reaction(
    label = 'reaction31',
    reactants = ['[CH2]C(CC)CC=[C]C=C(28626)'],
    products = ['C=C[C]=CC[CH]CCC(28450)'],
...
reaction(
    label = 'reaction34',
    reactants = ['[CH]CCC(133)', '[CH2]C=[C]C=C(26613)'],
    products = ['C=C[C]=CC[CH]CCC(28450)'],
...
reaction(
    label = 'reaction36',
    reactants = ['C=C[C]=CC[CH]CCC(28450)'],
    products = ['C[C]=C=CC[CH]CCC(28627)'],
...
reaction(
    label = 'reaction37',
    reactants = ['C=C[C]=CC[CH]CCC(28450)'],
    products = ['CC=C=[C]C[CH]CCC(28628)'],
...
reaction(
    label = 'reaction38',
    reactants = ['C=C[C]=CC[CH]CCC(28450)'],
    products = ['CC=C=C[CH][CH]CCC(28629)'],
...
reaction(
    label = 'reaction39',
    reactants = ['CC=C=CC[CH][CH]CC(28630)'],
    products = ['C=C[C]=CC[CH]CCC(28450)'],
...
reaction(
    label = 'reaction40',
    reactants = ['C[CH]C[CH]CC=C=CC(28631)'],
    products = ['C=C[C]=CC[CH]CCC(28450)'],
...
reaction(
    label = 'reaction41',
    reactants = ['C=C[C]=CC[CH]CCC(28450)'],
    products = ['[CH2]C=C1[CH]CC1CCC(28632)'],
...
reaction(
    label = 'reaction42',
    reactants = ['C=C[C]=CC[CH]CCC(28450)'],
    products = ['CCC[CH]CC1[C]=CC1(28633)'],
