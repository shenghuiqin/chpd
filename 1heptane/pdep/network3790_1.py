...
species(
    label = '[CH2]C1CC1C1([O])COC1CC(22360)',
    structure = SMILES('[CH2]C1CC1C1([O])COC1CC'),
    E0 = (136.414,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (154.206,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.992156,0.087397,7.09006e-06,-8.29008e-08,4.29405e-11,16607.4,38.0911], Tmin=(100,'K'), Tmax=(908.755,'K')), NASAPolynomial(coeffs=[23.8138,0.0377995,-9.40181e-06,1.35369e-09,-8.82504e-14,9638.38,-92.7478], Tmin=(908.755,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(136.414,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(590.328,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Oxetane) + ring(Cyclopropane) + radical(Isobutyl) + radical(CC(C)2OJ)"""),
)
...
species(
    label = '[CH2]OC(CC)C(=O)C([CH2])C=C(22361)',
    structure = SMILES('[CH2]OC(CC)C(=O)C([CH2])C=C'),
    E0 = (10.8952,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3010,987.5,1337.5,450,1655,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,2950,3100,1380,975,1025,1650,2750,2800,2850,1350,1500,750,1050,1375,1000,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,2750,2850,1437.5,1250,1305,750,350,375,552.5,462.5,1710,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (154.206,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.61595,0.129971,-0.00013568,7.92479e-08,-1.92936e-11,1507.26,44.8151], Tmin=(100,'K'), Tmax=(978.082,'K')), NASAPolynomial(coeffs=[15.7046,0.0591355,-2.7044e-05,5.19992e-09,-3.66486e-13,-1880.88,-38.3624], Tmin=(978.082,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(10.8952,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(573.699,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-O2d)CsCsH) + group(Cs-(Cds-O2d)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + group(Cds-OdCsCs) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CsJOCC2) + radical(CJC(C)C=O)"""),
)

species(
    label = '[CH2]C(C=C)C(=O)CO[CH]CC(22362)',
    structure = SMILES('[CH2]C(C=C)C(=O)CO[CH]CC'),
    E0 = (20.2634,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,2750,2800,2850,1350,1500,750,1050,1375,1000,2950,3100,1380,975,1025,1650,1380,1390,370,380,2900,435,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,375,552.5,462.5,1710,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (154.206,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.08821,0.142795,-0.000176025,1.24341e-07,-3.62607e-11,2648.4,44.1924], Tmin=(100,'K'), Tmax=(828.792,'K')), NASAPolynomial(coeffs=[14.8445,0.0610741,-2.81238e-05,5.37275e-09,-3.75346e-13,-158.386,-34.3186], Tmin=(828.792,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(20.2634,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(573.699,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-O2d)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-O2d)OsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdCsCs) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CCsJOCs) + radical(CJC(C)C=O)"""),
)
...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.17252,0.0952827,-2.5498e-05,-4.52969e-08,2.8456e-11,824.198,38.6477], Tmin=(100,'K'), Tmax=(916.757,'K')), NASAPolynomial(coeffs=[23.2034,0.0375223,-1.05042e-05,1.62233e-09,-1.07179e-13,-5687.3,-87.9712], Tmin=(916.757,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(5.16185,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(565.384,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + group(Cds-CdsHH) + ring(Oxetane) + radical(C=CC(C)2OJ)"""),
)
...
species(
    ...
    molecularWeight = (154.206,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.22527,0.100139,-4.27939e-05,-1.90217e-08,1.64682e-11,3974.94,40.2483], Tmin=(100,'K'), Tmax=(940.278,'K')), NASAPolynomial(coeffs=[19.839,0.0467663,-1.54559e-05,2.58049e-09,-1.72467e-13,-1588.15,-68.5953], Tmin=(940.278,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(31.3735,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(586.17,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + ring(Oxetane) + radical(Allyl_P) + radical(C=CC(C)2OJ)"""),
)
...
species(
    label = '[CH2][C](C=C)C1(O)COC1CC(22365)',
    structure = SMILES('[CH2]C=C([CH2])C1(O)COC1CC'),
    E0 = (-46.23,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (154.206,'amu'),
...
species(
    label = '[CH2]C(C=C)C1(O)[CH]OC1CC(22366)',
    structure = SMILES('[CH2]C(C=C)C1(O)[CH]OC1CC'),
    E0 = (63.2508,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (154.206,'amu'),
...
species(
    label = 'C=[C]C(C)C1([O])COC1CC(22367)',
    structure = SMILES('C=[C]C(C)C1([O])COC1CC'),
    E0 = (144.47,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,3100,1380,975,1025,1650,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,2750,2950,3150,900,1000,1100,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,1685,370,300,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (154.206,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.44558,0.10686,-6.20462e-05,-2.22467e-10,1.01878e-11,17583.6,40.3354], Tmin=(100,'K'), Tmax=(937.332,'K')), NASAPolynomial(coeffs=[20.2804,0.0458511,-1.5153e-05,2.51209e-09,-1.66418e-13,12117.9,-70.5033], Tmin=(937.332,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(144.47,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(586.17,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Oxetane) + radical(CC(C)2OJ) + radical(Cds_S)"""),
)

species(
    label = 'C=CC(C)C1([O])CO[C]1CC(22368)',
    structure = SMILES('C=CC(C)C1([O])CO[C]1CC'),
    E0 = (87.3322,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (154.206,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.83618,0.116798,-0.000101299,4.91322e-08,-9.68066e-12,10723.5,41.9018], Tmin=(100,'K'), Tmax=(1223.19,'K')), NASAPolynomial(coeffs=[19.4691,0.0471259,-1.58579e-05,2.56423e-09,-1.62763e-13,5511.5,-65.1759], Tmin=(1223.19,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(87.3322,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(586.17,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Oxetane) + radical(C2CsJOCs) + radical(CC(C)2OJ)"""),
)

species(
    label = 'C=CC(C)C1([O])[CH]OC1CC(22369)',
    structure = SMILES('C=CC(C)C1([O])[CH]OC1CC'),
    E0 = (87.0844,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (154.206,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.68545,0.108911,-5.49772e-05,-1.79656e-08,1.93683e-11,10693.5,40.1704], Tmin=(100,'K'), Tmax=(914.316,'K')), NASAPolynomial(coeffs=[24.0804,0.0392622,-1.13765e-05,1.76715e-09,-1.15313e-13,4181.52,-91.6722], Tmin=(914.316,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(87.0844,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(586.17,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Oxetane) + radical(CCsJOCs) + radical(CC(C)2OJ)"""),
)

species(
    label = '[CH2]C(C=C)C1(O)COC1[CH]C(22370)',
    structure = SMILES('[CH2]C(C=C)C1(O)COC1[CH]C'),
    E0 = (82.6968,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (154.206,'amu'),
...
species(
    label = '[CH2]C([C]=C)C1(O)COC1CC(22371)',
    structure = SMILES('[CH2]C([C]=C)C1(O)COC1CC'),
    E0 = (120.637,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2950,3150,900,1000,1100,1685,370,2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1277.5,1000,2950,3100,1380,975,1025,1650,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,300,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    ...
    molecularWeight = (154.206,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.48084,0.105707,-5.35967e-05,-1.26235e-08,1.551e-11,18699.7,40.392], Tmin=(100,'K'), Tmax=(930.18,'K')), NASAPolynomial(coeffs=[21.7077,0.0435239,-1.38454e-05,2.26541e-09,-1.50322e-13,12762.1,-78.5291], Tmin=(930.18,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(153.725,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(586.17,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Oxetane) + radical(CC(C)2OJ) + radical(Cds_P)"""),
)

species(
    label = 'C=CC(C)C1([O])COC1[CH]C(22373)',
    structure = SMILES('C=CC(C)C1([O])COC1[CH]C'),
    E0 = (106.53,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (154.206,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.21607,0.0970108,-2.84414e-05,-3.93525e-08,2.52243e-11,13016.7,41.5352], Tmin=(100,'K'), Tmax=(927.301,'K')), NASAPolynomial(coeffs=[22.0076,0.042102,-1.28475e-05,2.08127e-09,-1.39183e-13,6763.39,-79.2471], Tmin=(927.301,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(106.53,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(586.17,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Oxetane) + radical(CC(C)2OJ) + radical(CCJCO)"""),
)

species(
    label = '[CH2]CC1OCC1(O)C([CH2])C=C(22374)',
    structure = SMILES('[CH2]CC1OCC1(O)C([CH2])C=C'),
    E0 = (88.0411,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (154.206,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.68346,0.121581,-0.000107013,5.04658e-08,-9.24838e-12,10851.2,47.8197], Tmin=(100,'K'), Tmax=(1499.58,'K')), NASAPolynomial(coeffs=[24.2442,0.0367287,-9.10828e-06,1.1482e-09,-6.08417e-14,4239.69,-88.1185], Tmin=(1499.58,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(88.0411,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(582.013,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Oxetane) + radical(Isobutyl) + radical(RCCJ)"""),
)

species(
    label = '[CH]=CC([CH2])C1(O)COC1CC(22375)',
    structure = SMILES('[CH]=CC([CH2])C1(O)COC1CC'),
    E0 = (129.891,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (154.206,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.74261,0.123813,-0.000111502,5.36682e-08,-1.00234e-11,15885.9,46.6448], Tmin=(100,'K'), Tmax=(1469.51,'K')), NASAPolynomial(coeffs=[24.6315,0.036305,-8.91299e-06,1.10917e-09,-5.80263e-14,9243.79,-91.182], Tmin=(1469.51,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(129.891,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(582.013,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Oxetane) + radical(Cds_P) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]CC1OCC1([O])C(C)C=C(22376)',
    structure = SMILES('[CH2]CC1OCC1([O])C(C)C=C'),
    E0 = (111.875,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (154.206,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.3709,0.102934,-4.74634e-05,-1.76299e-08,1.69217e-11,13662.7,41.3806], Tmin=(100,'K'), Tmax=(933.002,'K')), NASAPolynomial(coeffs=[21.2413,0.0440952,-1.41294e-05,2.32582e-09,-1.54927e-13,7784.75,-75.0301], Tmin=(933.002,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(111.875,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(586.17,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Oxetane) + radical(RCCJ) + radical(CC(C)2OJ)"""),
)

species(
    label = 'CCC1OCC1([O])C1[CH]CC1(22377)',
    structure = SMILES('CCC1OCC1([O])C1[CH]CC1'),
    E0 = (123.792,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (154.206,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.634445,0.0806214,1.42733e-05,-7.75292e-08,3.68118e-11,15075,38.3564], Tmin=(100,'K'), Tmax=(943.208,'K')), NASAPolynomial(coeffs=[20.0211,0.045958,-1.4782e-05,2.50709e-09,-1.72658e-13,8823.91,-72.5688], Tmin=(943.208,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(123.792,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(594.485,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Cyclobutane) + ring(Oxetane) + radical(CC(C)2OJ) + radical(cyclobutane)"""),
)
...
species(
    label = 'C=CC(=C)C1(O)COC1CC(22379)',
    structure = SMILES('C=CC(=C)C1(O)COC1CC'),
    E0 = (-223.941,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
species(
    label = '[CH2]C(C=C)C1([O])COC1C(22380)',
    structure = SMILES('[CH2]C(C=C)C1([O])COC1C'),
    E0 = (135.491,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2950,3150,900,1000,1100,3010,987.5,1337.5,450,1655,2750,2800,2850,1350,1500,750,1050,1375,1000,2950,3100,1380,975,1025,1650,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,300,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.625616,0.0876151,-2.99331e-05,-3.38346e-08,2.39749e-11,16475.7,36.461], Tmin=(100,'K'), Tmax=(891.54,'K')), NASAPolynomial(coeffs=[20.0583,0.0350623,-9.23006e-06,1.32036e-09,-8.20786e-14,11188,-69.9228], Tmin=(891.54,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(135.491,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(515.497,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Oxetane) + radical(Isobutyl) + radical(CC(C)2OJ)"""),
)
...
species(
    label = '[CH2]C(C=C)C([O])=CCC(22382)',
    structure = SMILES('[CH2]C(C=C)C([O])=CCC'),
    E0 = (124.838,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2995,3025,975,1000,1300,1375,400,500,1630,1680,2750,2800,2850,1350,1500,750,1050,1375,1000,2950,3100,1380,975,1025,1650,1380,1390,370,380,2900,435,350,440,435,1725,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.540436,0.0955077,-8.47087e-05,4.15583e-08,-8.36486e-12,15181.6,36.7654], Tmin=(100,'K'), Tmax=(1185.44,'K')), NASAPolynomial(coeffs=[15.6098,0.0410125,-1.57531e-05,2.77907e-09,-1.86633e-13,11352.6,-43.8975], Tmin=(1185.44,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(124.838,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(486.397,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)(Cds-Cds)CsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(C=C(C)OJ) + radical(Isobutyl)"""),
)
...
species(
    label = '[CH2]C(C=C)[C]1COC1CC(22383)',
    structure = SMILES('[CH2]C(C=C)[C]1COC1CC'),
    E0 = (216.781,'kJ/mol'),
    modes = [
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.289595,0.0757038,1.36867e-05,-7.56453e-08,3.71504e-11,26244.5,37.9182], Tmin=(100,'K'), Tmax=(913.345,'K')), NASAPolynomial(coeffs=[18.4398,0.0425859,-1.22452e-05,1.91122e-09,-1.25985e-13,20783.3,-61.9103], Tmin=(913.345,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(216.781,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(561.227,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Oxetane) + radical(CCJ(C)CO) + radical(Isobutyl)"""),
)
...
species(
    label = 'C=C[CH]C1([O])COC1CC(22384)',
    structure = SMILES('C=C[CH]C1([O])COC1CC'),
    E0 = (55.2972,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2950,3150,900,1000,1100,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,2750,2800,2850,1350,1500,750,1050,1375,1000,2950,3100,1380,975,1025,1650,2750,2850,1437.5,1250,1305,750,350,300,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (140.18,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.946696,0.0936146,-4.0433e-05,-2.23723e-08,1.85758e-11,6842.79,33.272], Tmin=(100,'K'), Tmax=(927.218,'K')), NASAPolynomial(coeffs=[21.2226,0.036791,-1.1299e-05,1.82756e-09,-1.21766e-13,1063.13,-81.0043], Tmin=(927.218,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(55.2972,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(515.497,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Oxetane) + radical(CC(C)2OJ) + radical(C=CCJCO)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]C(C=C)C1([O])COC1CC(21377)'],
    products = ['[CH2]C1CC1C1([O])COC1CC(22360)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['[CH2]OC(CC)C(=O)C([CH2])C=C(22361)'],
    products = ['[CH2]C(C=C)C1([O])COC1CC(21377)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(1.46159e+06,'s^-1'), n=1.55572, Ea=(100.815,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R5_SS;multiplebond_intra;radadd_intra_cs2H] for rate rule [R5_SS_CO;carbonylbond_intra_Nd;radadd_intra_cs2H]
Euclidian distance = 2.2360679775
family: Intra_R_Add_Exocyclic
Ea raised from 96.7 to 100.8 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction5',
    reactants = ['[CH2]C(C=C)C(=O)CO[CH]CC(22362)'],
    products = ['[CH2]C(C=C)C1([O])COC1CC(21377)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(2.13771e+06,'s^-1'), n=1.58803, Ea=(91.4473,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R5_SS;multiplebond_intra;radadd_intra_csHNd] for rate rule [R5_SS_CO;carbonylbond_intra_Nd;radadd_intra_csHNd]
Euclidian distance = 2.2360679775
family: Intra_R_Add_Exocyclic
Ea raised from 85.9 to 91.4 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction6',
    reactants = ['H(3)', 'C=CC(=C)C1([O])COC1CC(22363)'],
    products = ['[CH2]C(C=C)C1([O])COC1CC(21377)'],
    transitionState = 'TS6',
...
reaction(
    ...
    products = ['[CH2]C(C=C)C1([O])COC1CC(21377)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(6.32e+10,'cm^3/(mol*s)'), n=0, Ea=(85.3432,'kJ/mol'), T0=(1,'K'), Tmin=(413,'K'), Tmax=(563,'K'), comment="""Estimated using an average for rate rule [CO-CsCs_O;CJ]
Euclidian distance = 0
Multiplied by reaction path degeneracy 2.0
family: R_Addition_MultipleBond
Ea raised from 83.3 to 85.3 kJ/mol to match endothermicity of reaction."""),
)
...
reaction(
    label = 'reaction9',
    reactants = ['C2H3(30)', 'C=CC1([O])COC1CC(7557)'],
    products = ['[CH2]C(C=C)C1([O])COC1CC(21377)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['C=C[C](C)C1([O])COC1CC(22364)'],
    products = ['[CH2]C(C=C)C1([O])COC1CC(21377)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]C(C=C)C1([O])COC1CC(21377)'],
    products = ['[CH2][C](C=C)C1(O)COC1CC(22365)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2]C(C=C)C1([O])COC1CC(21377)'],
    products = ['[CH2]C(C=C)C1(O)[CH]OC1CC(22366)'],
...
reaction(
    label = 'reaction14',
    reactants = ['C=[C]C(C)C1([O])COC1CC(22367)'],
    products = ['[CH2]C(C=C)C1([O])COC1CC(21377)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]C(C=C)C1([O])COC1CC(21377)'],
    products = ['C=CC(C)C1([O])CO[C]1CC(22368)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]C(C=C)C1([O])COC1CC(21377)'],
    products = ['C=CC(C)C1([O])[CH]OC1CC(22369)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]C(C=C)C1([O])COC1CC(21377)'],
    products = ['[CH2]C(C=C)C1(O)COC1[CH]C(22370)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2]C([C]=C)C1(O)COC1CC(22371)'],
    products = ['[CH2]C(C=C)C1([O])COC1CC(21377)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH]=CC(C)C1([O])COC1CC(22372)'],
    products = ['[CH2]C(C=C)C1([O])COC1CC(21377)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2]C(C=C)C1([O])COC1CC(21377)'],
    products = ['C=CC(C)C1([O])COC1[CH]C(22373)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH2]C(C=C)C1([O])COC1CC(21377)'],
    products = ['[CH2]CC1OCC1(O)C([CH2])C=C(22374)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH2]C(C=C)C1([O])COC1CC(21377)'],
    products = ['[CH]=CC([CH2])C1(O)COC1CC(22375)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH2]CC1OCC1([O])C(C)C=C(22376)'],
    products = ['[CH2]C(C=C)C1([O])COC1CC(21377)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[CH2]C(C=C)C1([O])COC1CC(21377)'],
    products = ['CCC1OCC1([O])C1[CH]CC1(22377)'],
...
reaction(
    label = 'reaction27',
    reactants = ['[CH2]C(C=C)C1([O])COC1CC(21377)'],
    products = ['C=CC(=C)C1(O)COC1CC(22379)'],
...
reaction(
    label = 'reaction28',
    reactants = ['CH2(S)(23)', '[CH2]C(C=C)C1([O])COC1C(22380)'],
    products = ['[CH2]C(C=C)C1([O])COC1CC(21377)'],
...
reaction(
    label = 'reaction32',
    reactants = ['C2H5CHO(70)', '[CH2]C(C=C)C(=C)[O](19794)'],
    products = ['[CH2]C(C=C)C1([O])COC1CC(21377)'],
...
reaction(
    label = 'reaction33',
    reactants = ['CH2O(15)', '[CH2]C(C=C)C([O])=CCC(22382)'],
    products = ['[CH2]C(C=C)C1([O])COC1CC(21377)'],
...
reaction(
    label = 'reaction34',
    reactants = ['O(4)', '[CH2]C(C=C)[C]1COC1CC(22383)'],
    products = ['[CH2]C(C=C)C1([O])COC1CC(21377)'],
...
reaction(
    label = 'reaction35',
    reactants = ['CH2(19)', 'C=C[CH]C1([O])COC1CC(22384)'],
    products = ['[CH2]C(C=C)C1([O])COC1CC(21377)'],
