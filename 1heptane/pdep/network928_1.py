...
species(
    label = 'CC1CC([CH][O])O1(3329)',
    structure = SMILES('CC1CC([CH][O])O1'),
    E0 = (77.0098,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.858525,0.0602781,-4.59567e-05,2.05904e-08,-3.80318e-12,9382.68,24.9675], Tmin=(100,'K'), Tmax=(1381.77,'K')), NASAPolynomial(coeffs=[11.0607,0.0282933,-8.57423e-06,1.27059e-09,-7.54216e-14,6797.28,-26.7043], Tmin=(1381.77,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(77.0098,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(349.208,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Oxetane) + radical(CCsJOH) + radical(CCOJ)"""),
)
...
species(
    label = 'C=C(C)OC=C[O](3330)',
    structure = SMILES('C=C(C)OC=C[O]'),
    E0 = (-139.308,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,440,435,1725,2950,3100,1380,975,1025,1650,2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,227.719,229.478,230.122,230.698],'cm^-1')),
        HinderedRotor(inertia=(0.537376,'amu*angstrom^2'), symmetry=1, barrier=(19.88,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.544254,'amu*angstrom^2'), symmetry=1, barrier=(19.8811,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.541903,'amu*angstrom^2'), symmetry=1, barrier=(19.8734,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.759734,0.0572174,-1.69637e-05,-2.8494e-08,1.76976e-11,-16625.4,25.9431], Tmin=(100,'K'), Tmax=(949.409,'K')), NASAPolynomial(coeffs=[19.0221,0.0147027,-4.18576e-06,7.27235e-10,-5.41986e-14,-21644.7,-69.3854], Tmin=(949.409,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-139.308,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C=COJ)"""),
)

species(
    label = '[CH2]C(C)OC=C=O(3331)',
    structure = SMILES('[CH2]C(C)OC=C=O'),
    E0 = (-38.7369,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2120,512.5,787.5,3010,987.5,1337.5,450,1655,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.819131,'amu*angstrom^2'), symmetry=1, barrier=(18.8334,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.820308,'amu*angstrom^2'), symmetry=1, barrier=(18.8605,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.81899,'amu*angstrom^2'), symmetry=1, barrier=(18.8302,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.820039,'amu*angstrom^2'), symmetry=1, barrier=(18.8543,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.36232,0.0822396,-8.82443e-05,4.5974e-08,-9.08353e-12,-4490.21,26.6585], Tmin=(100,'K'), Tmax=(1354.45,'K')), NASAPolynomial(coeffs=[21.6246,0.0110049,-2.37516e-06,2.73443e-10,-1.41823e-14,-9868.14,-83.9523], Tmin=(1354.45,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-38.7369,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-(Cdd-O2d)OsH) + radical(CJC(C)OC)"""),
)
...
species(
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0986692,0.0684384,-2.5266e-05,-3.34583e-08,2.26425e-11,-10553.1,25.9673], Tmin=(100,'K'), Tmax=(932.224,'K')), NASAPolynomial(coeffs=[24.2362,0.00911415,-1.00364e-06,1.03945e-10,-1.17091e-14,-16976,-99.1002], Tmin=(932.224,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-89.0445,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + radical(C=COJ) + radical(C2CsJOC(O))"""),
)
...
species(
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.45938,0.0943405,-0.000102904,5.2401e-08,-9.79829e-12,2567.76,32.9263], Tmin=(100,'K'), Tmax=(1539.02,'K')), NASAPolynomial(coeffs=[26.0774,0.00477344,1.93301e-06,-6.10422e-10,4.72452e-14,-3776.77,-104.871], Tmin=(1539.02,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(19.5315,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + radical(C=CJO) + radical(CJC(C)OC)"""),
)

species(
    label = 'CC(C)O[C]=C[O](3335)',
    structure = SMILES('CC(C)O[C]=C[O]'),
    E0 = (-49.516,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,3010,987.5,1337.5,450,1655,1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,255.608,255.608,255.608,255.608],'cm^-1')),
        HinderedRotor(inertia=(0.425753,'amu*angstrom^2'), symmetry=1, barrier=(19.7394,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.425754,'amu*angstrom^2'), symmetry=1, barrier=(19.7394,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.425753,'amu*angstrom^2'), symmetry=1, barrier=(19.7394,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.425753,'amu*angstrom^2'), symmetry=1, barrier=(19.7394,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.405864,0.0617342,-1.14539e-05,-4.34137e-08,2.51396e-11,-5810.06,27.1887], Tmin=(100,'K'), Tmax=(934.296,'K')), NASAPolynomial(coeffs=[22.2559,0.0120994,-2.2658e-06,3.35356e-10,-2.75091e-14,-11809.5,-86.9969], Tmin=(934.296,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-49.516,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + radical(C=COJ) + radical(C=CJO)"""),
)

species(
    label = 'CC(C)OC=[C][O](3336)',
...
species(
    label = '[CH2][C](C)OC=CO(3337)',
    structure = SMILES('[CH2][C](C)OC=CO'),
    E0 = (-19.997,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.70234,0.100369,-0.000114711,6.02224e-08,-1.15718e-11,-2178.25,32.1618], Tmin=(100,'K'), Tmax=(1492.35,'K')), NASAPolynomial(coeffs=[28.1207,0.00174937,3.19423e-06,-8.38135e-10,6.2546e-14,-8998.96,-116.686], Tmin=(1492.35,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-19.997,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + radical(CJC(C)OC) + radical(C2CsJOC(O))"""),
)

species(
    label = '[CH2]C([CH2])OC=CO(3338)',
    structure = SMILES('[CH2]C([CH2])OC=CO'),
    E0 = (-9.70262,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2995,3025,975,1000,1300,1375,400,500,1630,1680,3615,1277.5,1000,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,1380,1390,370,380,2900,435,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.13488,0.106821,-0.00012529,6.67083e-08,-1.2895e-11,-921.879,31.2723], Tmin=(100,'K'), Tmax=(1502.22,'K')), NASAPolynomial(coeffs=[29.7878,-0.000949666,5.05741e-06,-1.22826e-09,9.01475e-14,-7943.7,-127.176], Tmin=(1502.22,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-9.70262,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + radical(CJC(C)OC) + radical(CJC(C)OC)"""),
)
...
species(
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.360003,0.0759945,-6.81113e-05,2.23952e-08,1.90592e-12,9259.13,26.1141], Tmin=(100,'K'), Tmax=(836.348,'K')), NASAPolynomial(coeffs=[15.883,0.0214527,-5.62193e-06,7.47583e-10,-4.18808e-14,5973.63,-50.1201], Tmin=(836.348,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(75.8611,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CCsJO) + radical(CJC(C)OC)"""),
)
...
species(
    label = 'C=C(C)OC=CO(3341)',
    structure = SMILES('C=C(C)OC=CO'),
    E0 = (-280.77,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (100.116,'amu'),
...
species(
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.444919,0.0641523,-2.63599e-05,-2.22664e-08,1.61729e-11,-29836.7,23.3134], Tmin=(100,'K'), Tmax=(946.723,'K')), NASAPolynomial(coeffs=[20.0138,0.0159126,-4.49672e-06,7.64047e-10,-5.58799e-14,-35085.4,-78.1751], Tmin=(946.723,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-249.247,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-(Cdd-O2d)OsH)"""),
)
...
species(
    label = '[CH]=COC([CH2])C(2421)',
    structure = SMILES('[CH]=COC([CH2])C'),
    E0 = (235.676,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,3010,987.5,1337.5,450,1655,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.87679,'amu*angstrom^2'), symmetry=1, barrier=(20.1591,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.875965,'amu*angstrom^2'), symmetry=1, barrier=(20.1402,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.87676,'amu*angstrom^2'), symmetry=1, barrier=(20.1584,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.876146,'amu*angstrom^2'), symmetry=1, barrier=(20.1443,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
species(
    label = '[CH2][C](C)OCC=O(3344)',
    structure = SMILES('[CH2][C](C)OCC=O'),
    E0 = (16.9209,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.387945,0.0880445,-0.000134542,1.18536e-07,-4.13661e-11,2156.89,27.757], Tmin=(100,'K'), Tmax=(835.637,'K')), NASAPolynomial(coeffs=[7.36078,0.0390129,-1.84283e-05,3.4833e-09,-2.38521e-13,1538.1,-1.36052], Tmin=(835.637,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(16.9209,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)OsHH) + group(Cds-OdCsH) + radical(C2CsJOCs) + radical(CJC(C)OC)"""),
)

species(
    label = '[CH2]C([CH2])OCC=O(3345)',
    structure = SMILES('[CH2]C([CH2])OCC=O'),
    E0 = (46.7271,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.403918,0.0862942,-0.000110373,7.27407e-08,-1.64193e-11,5742.83,26.8497], Tmin=(100,'K'), Tmax=(647.957,'K')), NASAPolynomial(coeffs=[10.8145,0.0336829,-1.55618e-05,2.95353e-09,-2.04656e-13,4149.03,-20.7459], Tmin=(647.957,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(46.7271,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)OsHH) + group(Cds-OdCsH) + radical(CJC(C)OC) + radical(CJC(C)OC)"""),
)
...
species(
    label = 'C=C(C)OCC=O(3346)',
    structure = SMILES('C=C(C)OCC=O'),
    E0 = (-293.887,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.705201,0.0604969,-2.76666e-05,-1.11765e-08,9.44201e-12,-35217.3,24.7238], Tmin=(100,'K'), Tmax=(1003.46,'K')), NASAPolynomial(coeffs=[16.9154,0.0216865,-8.22816e-06,1.53795e-09,-1.10695e-13,-39769.9,-60.0109], Tmin=(1003.46,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-293.887,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-O2d)OsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-OdCsH) + group(Cds-CdsHH)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'C=C(C)OC=C[O](3330)'],
    products = ['[CH2]C(C)O[CH]C=O(1342)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', '[CH2]C(C)OC=C=O(3331)'],
    products = ['[CH2]C(C)O[CH]C=O(1342)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CH3(17)', 'C=COC=C[O](2535)'],
    products = ['[CH2]C(C)O[CH]C=O(1342)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction10',
    reactants = ['CC(C)O[C]=C[O](3335)'],
    products = ['[CH2]C(C)O[CH]C=O(1342)'],
    transitionState = 'TS10',
    kinetics = Arrhenius(A=(4.63097e+08,'s^-1'), n=1.13, Ea=(140.248,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4H_SSS_O(Cs)Cs;Y_rad_out;Cs_H_out_2H] for rate rule [R4H_SSS_O(Cs)Cs;Cd_rad_out_Cd;Cs_H_out_2H]
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2]C([CH2])OC=CO(3338)'],
    products = ['[CH2]C(C)O[CH]C=O(1342)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CHCHO(47)', '[CH2]C(C)[O](1669)'],
    products = ['[CH2]C(C)O[CH]C=O(1342)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]C(C)O[CH]C=O(1342)'],
    products = ['[CH2]C(C)OC1[CH]O1(3339)'],
...
reaction(
    label = 'reaction20',
    reactants = ['CH2(S)(23)', '[CH2]CO[CH]C=O(1038)'],
    products = ['[CH2]C(C)O[CH]C=O(1342)'],
...
reaction(
    label = 'reaction24',
    reactants = ['CH2(19)', 'C[CH]OC=C[O](2538)'],
    products = ['[CH2]C(C)O[CH]C=O(1342)'],
...
reaction(
    label = 'reaction25',
    reactants = ['O(4)', '[CH]=COC([CH2])C(2421)'],
    products = ['[CH2]C(C)O[CH]C=O(1342)'],
...
reaction(
    label = 'reaction29',
    reactants = ['[CH2]C([CH2])OCC=O(3345)'],
    products = ['[CH2]C(C)O[CH]C=O(1342)'],
