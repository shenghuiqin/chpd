species(
    label = '[CH2]C(C[O])OO(8767)',
    structure = SMILES('[CH2]C(C[O])OO'),
    E0 = (58.351,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3615,1310,387.5,850,1000,3000,3100,440,815,1455,1000,1380,1390,370,380,2900,435,180,1967.74],'cm^-1')),
        HinderedRotor(inertia=(0.429015,'amu*angstrom^2'), symmetry=1, barrier=(9.8639,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.429017,'amu*angstrom^2'), symmetry=1, barrier=(9.86393,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0141824,'amu*angstrom^2'), symmetry=1, barrier=(38.95,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.69403,'amu*angstrom^2'), symmetry=1, barrier=(38.949,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (90.0779,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.28018,0.0660454,-9.64257e-05,8.50248e-08,-3.04661e-11,7109.93,25.8007], Tmin=(100,'K'), Tmax=(799.254,'K')), NASAPolynomial(coeffs=[6.09449,0.0325283,-1.58379e-05,3.05459e-09,-2.12533e-13,6641.34,5.53605], Tmin=(799.254,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(58.351,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(CJCOOH)"""),
)
...
species(
    label = 'C=C(C[O])OO(10684)',
    structure = SMILES('C=C(C[O])OO'),
    E0 = (-11.3707,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2950,3100,1380,975,1025,1650,3615,1310,387.5,850,1000,350,440,435,1725,180,1348.56],'cm^-1')),
        HinderedRotor(inertia=(0.183364,'amu*angstrom^2'), symmetry=1, barrier=(4.2159,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.183533,'amu*angstrom^2'), symmetry=1, barrier=(4.21978,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.1834,'amu*angstrom^2'), symmetry=1, barrier=(4.21672,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
species(
    label = 'C[C](C[O])OO(5690)',
    structure = SMILES('C[C](C[O])OO'),
    E0 = (31.2876,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,360,370,350,3615,1310,387.5,850,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,2136.13,2136.28],'cm^-1')),
        HinderedRotor(inertia=(0.325981,'amu*angstrom^2'), symmetry=1, barrier=(7.49495,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.20057,'amu*angstrom^2'), symmetry=1, barrier=(50.5954,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.326136,'amu*angstrom^2'), symmetry=1, barrier=(7.49852,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.19681,'amu*angstrom^2'), symmetry=1, barrier=(50.5091,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (90.0779,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.46172,0.0661214,-0.000109422,1.0884e-07,-4.1701e-11,3844.44,23.4456], Tmin=(100,'K'), Tmax=(835.711,'K')), NASAPolynomial(coeffs=[2.13001,0.0395362,-1.97287e-05,3.804e-09,-2.62889e-13,4549.42,25.2275], Tmin=(835.711,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(31.2876,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(C2CsJOOH) + radical(CCOJ)"""),
)
...
species(
    label = '[CH2][C](CO)OO(10687)',
    structure = SMILES('[CH2][C](CO)OO'),
    E0 = (19.545,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (90.0779,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.04582,0.0714076,-0.000109415,9.47436e-08,-3.25379e-11,2450.91,26.0755], Tmin=(100,'K'), Tmax=(831.54,'K')), NASAPolynomial(coeffs=[7.59975,0.0291575,-1.38567e-05,2.62393e-09,-1.79867e-13,1731.68,-2.10519], Tmin=(831.54,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(19.545,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(261.906,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CJCOOH) + radical(C2CsJOOH)"""),
)

species(
    label = 'CC(C[O])O[O](10688)',
    structure = SMILES('CC(C[O])O[O]'),
    E0 = (-3.60683,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,492.5,1135,1000,1380,1390,370,380,2900,435,180,1907.65],'cm^-1')),
        HinderedRotor(inertia=(0.312638,'amu*angstrom^2'), symmetry=1, barrier=(7.18816,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.312153,'amu*angstrom^2'), symmetry=1, barrier=(7.17702,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.31202,'amu*angstrom^2'), symmetry=1, barrier=(7.17394,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (90.0779,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.60468,0.0597988,-8.82105e-05,8.20075e-08,-3.03792e-11,-354.442,23.399], Tmin=(100,'K'), Tmax=(830.173,'K')), NASAPolynomial(coeffs=[3.74913,0.0347916,-1.65114e-05,3.13708e-09,-2.15828e-13,-204.816,16.498], Tmin=(830.173,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-3.60683,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(ROOJ)"""),
)

species(
    label = '[CH2]C(CO)O[O](10689)',
    structure = SMILES('[CH2]C(CO)O[O]'),
    E0 = (-15.3494,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (90.0779,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.20558,0.0648653,-8.73232e-05,6.65864e-08,-2.05567e-11,-1748.69,25.97], Tmin=(100,'K'), Tmax=(806.163,'K')), NASAPolynomial(coeffs=[9.18336,0.0244771,-1.06781e-05,1.96646e-09,-1.33609e-13,-3008.84,-10.6372], Tmin=(806.163,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-15.3494,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(CJCOOH)"""),
)

species(
    label = 'C=C(CO)OO(10690)',
    structure = SMILES('C=C(CO)OO'),
    E0 = (-237.076,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (90.0779,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.70506,0.0539288,-5.76357e-05,3.61266e-08,-9.60622e-12,-28434,23.2702], Tmin=(100,'K'), Tmax=(893.756,'K')), NASAPolynomial(coeffs=[7.72763,0.0269748,-1.23988e-05,2.38377e-09,-1.67763e-13,-29510.5,-5.10879], Tmin=(893.756,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-237.076,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH)"""),
)

species(
    label = 'CH3CHOOHCHO(10691)',
    ...
    molecularWeight = (90.0779,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.43375,0.0582182,-6.02718e-05,3.3793e-08,-7.77743e-12,-34772.7,20.5903], Tmin=(100,'K'), Tmax=(1039.02,'K')), NASAPolynomial(coeffs=[10.328,0.0239777,-1.08405e-05,2.07668e-09,-1.46203e-13,-36621,-22.6597], Tmin=(1039.02,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-289.873,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), label="""CH3CHOOHCHO""", comment="""Thermo library: DFT_QCI_thermo"""),
)
...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.61317,0.0205056,2.46541e-05,-4.45973e-08,1.7774e-11,-3204.93,16.9555], Tmin=(100,'K'), Tmax=(990.048,'K')), NASAPolynomial(coeffs=[9.63961,0.01655,-6.37024e-06,1.21982e-09,-8.95998e-14,-5793.68,-22.9201], Tmin=(990.048,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-27.1362,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), label="""oxiranylmethoxy""", comment="""Thermo library: DFT_QCI_thermo"""),
)
...
species(
    label = 'OOC1COC1(8771)',
    structure = SMILES('OOC1COC1'),
    E0 = (-197.285,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (90.0779,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.89457,0.0377365,4.92281e-06,-3.89878e-08,2.06523e-11,-23643.9,17.4608], Tmin=(100,'K'), Tmax=(872.636,'K')), NASAPolynomial(coeffs=[11.6616,0.0178984,-3.83347e-06,4.42897e-10,-2.40483e-14,-26297.8,-33.768], Tmin=(872.636,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-197.285,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + ring(Oxetane)"""),
)

species(
    label = '[O]CC([O])CO(10693)',
    ...
    molecularWeight = (90.0779,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.47463,0.0619645,-9.09528e-05,8.1522e-08,-2.92714e-11,-18747.9,24.8568], Tmin=(100,'K'), Tmax=(827.715,'K')), NASAPolynomial(coeffs=[5.13283,0.0322185,-1.51779e-05,2.87682e-09,-1.97742e-13,-18940.1,10.3969], Tmin=(827.715,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-156.583,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + radical(CC(C)OJ) + radical(CCOJ)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'C=C(C[O])OO(10684)'],
    products = ['[CH2]C(C[O])OO(8767)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', '[CH2]C(C=O)OO(10685)'],
    products = ['[CH2]C(C[O])OO(8767)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CH2CHOOH(64)', '[CH2][O](167)'],
    products = ['[CH2]C(C[O])OO(8767)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]C(C[O])OO(8767)'],
    products = ['OH(5)', 'oxiranylmethoxy(10692)'],
...
reaction(
    label = 'reaction21',
    reactants = ['CH2(19)', '[O]C[CH]OO(4781)'],
    products = ['[CH2]C(C[O])OO(8767)'],
...
reaction(
    label = 'reaction22',
    reactants = ['O(4)', '[CH2]C([CH2])OO(5700)'],
    products = ['[CH2]C(C[O])OO(8767)'],
