...
species(
    label = '[CH2][C](O)OO(10753)',
    structure = SMILES('[CH2][C](O)OO'),
    E0 = (33.9119,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([360,370,350,3615,1310,387.5,850,1000,3000,3100,440,815,1455,1000,3615,1277.5,1000],'cm^-1')),
        HinderedRotor(inertia=(0.12295,'amu*angstrom^2'), symmetry=1, barrier=(9.65873,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.122953,'amu*angstrom^2'), symmetry=1, barrier=(9.65967,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.3617,'amu*angstrom^2'), symmetry=1, barrier=(28.3764,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00942195,'amu*angstrom^2'), symmetry=1, barrier=(28.3734,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (76.0514,'amu'),
...
reaction(
    ...
    products = ['[CH2]C(O)O[O](159)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(0.000167406,'m^3/(mol*s)'), n=2.98833, Ea=(128.017,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Cds_Cds;O2b] for rate rule [Cds-OsH_Cds;O2b]
Euclidian distance = 1.0
Multiplied by reaction path degeneracy 2.0
family: R_Addition_MultipleBond
Ea raised from 124.1 to 128.0 kJ/mol to match endothermicity of reaction."""),
)
