...
species(
    label = 'C[CH]OOC=CC(11350)',
    structure = SMILES('C[CH]OOC=CC'),
    E0 = (70.643,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,3025,407.5,1350,352.5,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,2995,3025,975,1000,1300,1375,400,500,1630,1680,272.892],'cm^-1')),
        HinderedRotor(inertia=(0.152735,'amu*angstrom^2'), symmetry=1, barrier=(8.12723,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.313829,'amu*angstrom^2'), symmetry=1, barrier=(16.1659,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.800551,'amu*angstrom^2'), symmetry=1, barrier=(42.6261,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.483816,'amu*angstrom^2'), symmetry=1, barrier=(25.8698,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.15191,'amu*angstrom^2'), symmetry=1, barrier=(8.12626,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (101.124,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.926043,0.0678874,-5.27013e-05,2.16945e-08,-3.75587e-12,8606.53,26.4797], Tmin=(100,'K'), Tmax=(1320.81,'K')), NASAPolynomial(coeffs=[11.7385,0.0351427,-1.55144e-05,2.92485e-09,-2.03203e-13,5750.27,-28.6926], Tmin=(1320.81,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(70.643,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(CCsJOOC)"""),
)
...
species(
    label = 'C[CH]COO[CH]C(11351)',
    structure = SMILES('C[CH]COO[CH]C'),
    E0 = (140.386,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (102.132,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.754869,0.0778128,-7.91914e-05,5.20841e-08,-1.54284e-11,16995.6,29.1816], Tmin=(100,'K'), Tmax=(787.774,'K')), NASAPolynomial(coeffs=[6.57581,0.0482573,-2.29167e-05,4.46223e-09,-3.16062e-13,16078.5,2.48729], Tmin=(787.774,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(140.386,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCsJOOC) + radical(CCJCOOH)"""),
)

species(
    label = '[CH2]COO[CH]CC(11352)',
    structure = SMILES('[CH2]COO[CH]CC'),
    E0 = (153.933,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (102.132,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.737946,0.077667,-7.36152e-05,4.18542e-08,-1.04877e-11,18626.4,28.9308], Tmin=(100,'K'), Tmax=(925.123,'K')), NASAPolynomial(coeffs=[8.20658,0.0453749,-2.12574e-05,4.12441e-09,-2.91952e-13,17244.5,-6.51987], Tmin=(925.123,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(153.933,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJCOOH) + radical(CCsJOOC)"""),
)

species(
    label = '[CH2]CCOO[CH]C(11353)',
    structure = SMILES('[CH2]CCOO[CH]C'),
    E0 = (145.217,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (102.132,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.854877,0.075475,-7.00245e-05,4.01892e-08,-1.04046e-11,17573.5,28.305], Tmin=(100,'K'), Tmax=(887.631,'K')), NASAPolynomial(coeffs=[7.12326,0.0472278,-2.22908e-05,4.33896e-09,-3.07678e-13,16460.6,-1.18931], Tmin=(887.631,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(145.217,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJ) + radical(CCsJOOC)"""),
)

species(
    label = 'C[CH][CH]OOCC(11354)',
    structure = SMILES('C[CH][CH]OOCC'),
    E0 = (140.386,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,3000,3050,390,425,1340,1360,335,370,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,2750,2850,1437.5,1250,1305,750,350,200,800],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2][CH]OOCCC(11355)',
    structure = SMILES('[CH2][CH]OOCCC'),
    E0 = (153.933,'kJ/mol'),
    modes = [
...
species(
    label = '[CH2]C[CH]OOCC(11356)',
    structure = SMILES('[CH2]C[CH]OOCC'),
    E0 = (145.217,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,200,800],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'CC=COOCC(11357)',
    structure = SMILES('CC=COOCC'),
    E0 = (-115.798,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (102.132,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.623128,0.0694141,-4.98142e-05,1.82654e-08,-2.74883e-12,-13802,27.2782], Tmin=(100,'K'), Tmax=(1528.03,'K')), NASAPolynomial(coeffs=[14.6807,0.0326148,-1.36899e-05,2.50471e-09,-1.70222e-13,-18098.1,-46.5015], Tmin=(1528.03,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-115.798,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH)"""),
)

species(
    label = 'C=COOCCC(11358)',
    structure = SMILES('C=COOCCC'),
    E0 = (-103.552,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (102.132,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.376762,0.0714154,-5.24277e-05,1.95192e-08,-2.94252e-12,-12317.3,28.61], Tmin=(100,'K'), Tmax=(1550.37,'K')), NASAPolynomial(coeffs=[16.5274,0.0297463,-1.21123e-05,2.18334e-09,-1.47086e-13,-17325.2,-56.3895], Tmin=(1550.37,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-103.552,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH)"""),
)
...
species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.129142,'amu*angstrom^2'), symmetry=1, barrier=(2.96922,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(5.20297,'amu*angstrom^2'), symmetry=1, barrier=(119.627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.84585,'amu*angstrom^2'), symmetry=1, barrier=(42.4398,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00521507,'amu*angstrom^2'), symmetry=1, barrier=(42.4371,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.84589,'amu*angstrom^2'), symmetry=1, barrier=(42.4407,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
species(
    label = '[CH2]C(C)OO[CH]C(11359)',
    structure = SMILES('[CH2]C(C)OO[CH]C'),
    E0 = (141.29,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,3025,407.5,1350,352.5,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,200],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (102.132,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.729268,0.0757618,-6.44683e-05,3.04633e-08,-6.18698e-12,17107.8,28.6025], Tmin=(100,'K'), Tmax=(1130.19,'K')), NASAPolynomial(coeffs=[10.4035,0.0415225,-1.90255e-05,3.65783e-09,-2.5757e-13,14921.1,-19.254], Tmin=(1130.19,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(141.29,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJCOOH) + radical(CCsJOOC)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'C[CH]OOC=CC(11350)'],
    products = ['C[CH]OO[CH]CC(10967)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'C=COO[CH]CC(10961)'],
    products = ['C[CH]OO[CH]CC(10967)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CH3(17)', 'C=COO[CH]C(2478)'],
    products = ['C[CH]OO[CH]CC(10967)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction14',
    reactants = ['CH2(S)(23)', 'C[CH]OO[CH]C(1180)'],
    products = ['C[CH]OO[CH]CC(10967)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]C(C)OO[CH]C(11359)'],
    products = ['C[CH]OO[CH]CC(10967)'],
...
reaction(
    label = 'reaction17',
    reactants = ['C[CH]O[O](97)', '[CH]CC(144)'],
    products = ['C[CH]OO[CH]CC(10967)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CC[CH]O[O](238)', 'CHCH3(T)(95)'],
    products = ['C[CH]OO[CH]CC(10967)'],
