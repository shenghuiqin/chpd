...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.449169,0.0952059,-5.78231e-05,1.7967e-08,-2.33969e-12,5559.47,39.1783], Tmin=(100,'K'), Tmax=(1677.61,'K')), NASAPolynomial(coeffs=[15.913,0.0561929,-2.29403e-05,4.10494e-09,-2.73938e-13,69.6242,-48.2248], Tmin=(1677.61,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(44.8833,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(602.799,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(RCCJC)"""),
)

species(
    label = '[CH2]C(C=CC)CCCC(1505)',
    ...
    molecularWeight = (125.231,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.05837,0.0995843,-6.46977e-05,2.20241e-08,-3.09976e-12,6138.05,40.5735], Tmin=(100,'K'), Tmax=(1622.86,'K')), NASAPolynomial(coeffs=[18.9392,0.050295,-1.91403e-05,3.30934e-09,-2.16805e-13,-352.673,-65.5862], Tmin=(1622.86,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(49.4421,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(602.799,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]C(CC=C)CCCC(1506)',
    structure = SMILES('[CH2]C(CC=C)CCCC'),
    E0 = (63.965,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (125.231,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.25663,0.101309,-6.69063e-05,2.30767e-08,-3.26688e-12,7894.29,41.6976], Tmin=(100,'K'), Tmax=(1629.89,'K')), NASAPolynomial(coeffs=[20.3786,0.0482123,-1.80414e-05,3.08971e-09,-2.01186e-13,841.673,-73.2491], Tmin=(1629.89,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(63.965,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(602.799,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Isobutyl)"""),
)
...
species(
    label = 'C[CH]C[C](C)CCCC(1507)',
    structure = SMILES('C[CH]C[C](C)CCCC'),
    E0 = (114.317,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (126.239,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.441332,0.105267,-9.80749e-05,7.26333e-08,-2.60851e-11,13901.9,40.3691], Tmin=(100,'K'), Tmax=(733.8,'K')), NASAPolynomial(coeffs=[3.29021,0.079892,-3.59137e-05,6.80986e-09,-4.74402e-13,13489.8,24.4451], Tmin=(733.8,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(114.317,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(623.585,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJC) + radical(Tertalkyl)"""),
)
...
species(
    label = 'C[CH]CC(C)[CH]CCC(1510)',
    structure = SMILES('C[CH]CC(C)[CH]CCC'),
    E0 = (123.436,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (126.239,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0247875,0.0929284,-5.10329e-05,1.36149e-08,-1.50328e-12,14982,40.0645], Tmin=(100,'K'), Tmax=(1884.7,'K')), NASAPolynomial(coeffs=[15.1625,0.0608011,-2.54635e-05,4.5704e-09,-3.03556e-13,9275.98,-42.56], Tmin=(1884.7,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(123.436,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(623.585,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJC) + radical(Cs_S)"""),
)

species(
    label = 'C[CH][CH]C(C)CCCC(1511)',
    structure = SMILES('C[CH][CH]C(C)CCCC'),
    E0 = (123.436,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (126.239,'amu'),
...
species(
    label = 'C[CH]CCC(C)C[CH]C(1515)',
    structure = SMILES('C[CH]CCC(C)C[CH]C'),
    E0 = (123.34,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (126.239,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.196746,0.0923352,-5.20416e-05,1.53941e-08,-2.04393e-12,14962.7,39.639], Tmin=(100,'K'), Tmax=(1473.97,'K')), NASAPolynomial(coeffs=[8.04523,0.0710363,-3.03665e-05,5.59061e-09,-3.8116e-13,12649.1,-1.27033], Tmin=(1473.97,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(123.34,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(623.585,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJC) + radical(RCCJC)"""),
)

species(
    label = '[CH2][CH]CC(C)CCCC(1516)',
    structure = SMILES('[CH2][CH]CC(C)CCCC'),
    E0 = (134.14,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,3025,407.5,1350,352.5,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (126.239,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.378921,0.0975785,-5.8733e-05,1.82534e-08,-2.41701e-12,16288.6,40.7661], Tmin=(100,'K'), Tmax=(1613.84,'K')), NASAPolynomial(coeffs=[13.8752,0.0622485,-2.58949e-05,4.68808e-09,-3.15588e-13,11687.8,-34.824], Tmin=(1613.84,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(134.14,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(623.585,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJC) + radical(RCCJ)"""),
)
...
species(
    label = '[CH2]CCCC(C)C[CH]C(1518)',
    structure = SMILES('[CH2]CCCC(C)C[CH]C'),
    E0 = (134.14,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,3025,407.5,1350,352.5,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (126.239,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.378933,0.0975786,-5.87333e-05,1.82536e-08,-2.41705e-12,16288.6,40.7661], Tmin=(100,'K'), Tmax=(1613.8,'K')), NASAPolynomial(coeffs=[13.875,0.0622489,-2.58952e-05,4.68813e-09,-3.15592e-13,11688,-34.8226], Tmin=(1613.8,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(134.14,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(623.585,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJ) + radical(RCCJC)"""),
)
...
species(
    label = 'CC=CC(C)CCCC(1521)',
    structure = SMILES('CC=CC(C)CCCC'),
    E0 = (-155.64,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (126.239,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.10387,0.0981523,-5.27837e-05,9.8985e-09,5.18008e-13,-18523.9,38.9604], Tmin=(100,'K'), Tmax=(1285.09,'K')), NASAPolynomial(coeffs=[17.8646,0.0555445,-2.22324e-05,4.00043e-09,-2.70447e-13,-24756.1,-62.589], Tmin=(1285.09,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-155.64,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(627.743,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH)"""),
)

species(
    label = 'C=CCC(C)CCCC(1522)',
    ...
    molecularWeight = (126.239,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.10744,0.0978165,-4.88017e-05,4.2174e-09,2.72681e-12,-16776.7,39.369], Tmin=(100,'K'), Tmax=(1196.14,'K')), NASAPolynomial(coeffs=[17.5563,0.0561533,-2.25757e-05,4.10318e-09,-2.80457e-13,-22726,-60.2205], Tmin=(1196.14,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-141.117,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(627.743,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH)"""),
)
...
species(
    label = 'C[CH]C[CH]CCCCC(1523)',
    structure = SMILES('C[CH]C[CH]CCCCC'),
    E0 = (125.699,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (126.239,'amu'),
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(C[CH]C)CCCC(1422)'],
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'C=C(C[CH]C)CCCC(1504)'],
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', '[CH2]C(C=CC)CCCC(1505)'],
    products = ['[CH2]C(C[CH]C)CCCC(1422)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', '[CH2]C(CC=C)CCCC(1506)'],
    products = ['[CH2]C(C[CH]C)CCCC(1422)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['C=CC[CH]C(380)', 'butyl_1(82)'],
    products = ['[CH2]C(C[CH]C)CCCC(1422)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]C(C[CH]C)CCCC(1422)'],
    products = ['C[CH]CC(C)[CH]CCC(1510)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]C(C[CH]C)CCCC(1422)'],
    products = ['C[CH][CH]C(C)CCCC(1511)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]C(C[CH]C)CCCC(1422)'],
    products = ['C[CH]CCC(C)C[CH]C(1515)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2][CH]CC(C)CCCC(1516)'],
    products = ['[CH2]C(C[CH]C)CCCC(1422)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2]C(CCC)CC[CH]C(1517)'],
    products = ['[CH2]C(C[CH]C)CCCC(1422)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2]CCCC(C)C[CH]C(1518)'],
    products = ['[CH2]C(C[CH]C)CCCC(1422)'],
...
reaction(
    label = 'reaction32',
    reactants = ['CHCH3(T)(95)', '[CH2]C([CH2])CCCC(488)'],
    products = ['[CH2]C(C[CH]C)CCCC(1422)'],
