...
species(
    label = 'CCCC(CCC(=O)C(C)[O])OO(17771)',
    structure = SMILES('CCCC(CCC(=O)C(C)[O])OO'),
    E0 = (-405.846,'kJ/mol'),
    modes = [
...
species(
    label = 'CCCC(CCC([O])C(C)=O)OO(17772)',
    structure = SMILES('CCCC(CCC([O])C(C)=O)OO'),
    E0 = (-404.209,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,375,552.5,462.5,1710,3615,1310,387.5,850,1000,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,200,800,960,1120,1280,1440,1600],'cm^-1')),
    ...
    molecularWeight = (189.229,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.3592,0.143688,-0.000126815,6.09806e-08,-1.2316e-11,-48389.4,53.7528], Tmin=(100,'K'), Tmax=(1154.95,'K')), NASAPolynomial(coeffs=[18.8002,0.0704057,-3.16393e-05,6.04302e-09,-4.24309e-13,-53277.1,-51.3775], Tmin=(1154.95,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-404.209,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(690.101,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)HHH) + group(Cds-OdCsCs) + radical(C=OCOJ)"""),
)
...
species(
    label = 'CCCC(CC[C](O)C(C)[O])OO(17773)',
...
species(
    label = 'CCCC(C[CH]C(O)C(C)[O])OO(17775)',
...
species(
    label = 'CCCC(CCC(O)[C](C)[O])OO(17776)',
    structure = SMILES('CCCC(CCC(O)[C](C)[O])OO'),
    E0 = (-302.123,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
species(
    label = 'CCCC([CH]CC(O)C(C)[O])OO(17779)',
...
species(
    label = 'CCC[C](CCC(O)C(C)[O])OO(17782)',
...
species(
    label = 'CC[CH]C(CCC(O)C(C)[O])OO(17784)',
...
species(
    label = 'CCCC(CCC(O)C(C)[O])O[O](17786)',
...
species(
    label = 'C[CH]CC(CCC(O)C(C)[O])OO(17787)',
...
species(
    label = '[CH2]CCC(CCC(O)C(C)[O])OO(17789)',
...
species(
    label = 'CCCC(CCC(O)C(C)=O)OO(17793)',
    structure = SMILES('CCCC(CCC(O)C(C)=O)OO'),
    E0 = (-647.942,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (190.237,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.69245,0.147768,-0.000127272,5.85095e-08,-1.11761e-11,-77689.2,54.1626], Tmin=(100,'K'), Tmax=(1223.61,'K')), NASAPolynomial(coeffs=[21.453,0.0688367,-3.05119e-05,5.7911e-09,-4.05039e-13,-83598.2,-67.1981], Tmin=(1223.61,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-647.942,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(710.887,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)HHH) + group(Cds-OdCsCs)"""),
)
...
species(
    label = 'CCC(CCC([O])C(C)[O])OO(17794)',
...
species(
    ...
    opticalIsomers = 1,
    molecularWeight = (176.21,'amu'),
    collisionModel = TransportData(shapeIndex=2, epsilon=(5404.18,'J/mol'), sigma=(9.07553,'angstroms'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with Tc=844.12 K, Pc=16.4 bar (from Joback method)"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
...
species(
    label = 'CCCC1CCC(OO1)C(C)[O](17795)',
    structure = SMILES('CCCC1CCC(OO1)C(C)[O]'),
    E0 = (-242.752,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
species(
    label = 'CCCC(CC[CH]C(C)[O])OO(17796)',
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'CCCC(CCC(=O)C(C)[O])OO(17771)'],
    products = ['CCCC(CCC([O])C(C)[O])OO(17526)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'CCCC(CCC([O])C(C)=O)OO(17772)'],
    products = ['CCCC(CCC([O])C(C)[O])OO(17526)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(0.0366254,'m^3/(mol*s)'), n=1.743, Ea=(71.4418,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [CO-CsCs_O;YJ] for rate rule [CO-CsCs_O;HJ]
Euclidian distance = 1.0
...
reaction(
    label = 'reaction4',
    reactants = ['CH3CHOCHO(2229)', '[CH2]CC(CCC)OO(2142)'],
    products = ['CCCC(CCC([O])C(C)[O])OO(17526)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['CH3(17)', 'CCCC(CCC([O])C=O)OO(17748)'],
    products = ['CCCC(CCC([O])C(C)[O])OO(17526)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['CCCC(CCC([O])C(C)[O])OO(17526)'],
    products = ['CCCC(CC[C](O)C(C)[O])OO(17773)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['CCCC(C[CH]C(O)C(C)[O])OO(17775)'],
    products = ['CCCC(CCC([O])C(C)[O])OO(17526)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CCCC(CCC([O])C(C)[O])OO(17526)'],
    products = ['CCCC(CCC(O)[C](C)[O])OO(17776)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CCCC([CH]CC(O)C(C)[O])OO(17779)'],
    products = ['CCCC(CCC([O])C(C)[O])OO(17526)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CCCC(C[CH]C([O])C(C)O)OO(17780)'],
    products = ['CCCC(CCC([O])C(C)[O])OO(17526)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CCCC(CCC([O])C(C)[O])OO(17526)'],
    products = ['CCC[C](CCC(O)C(C)[O])OO(17782)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CCCC(CCC([O])C(C)[O])OO(17526)'],
    products = ['CC[CH]C(CCC(O)C(C)[O])OO(17784)'],
...
reaction(
    label = 'reaction21',
    reactants = ['CCCC(CCC([O])C(C)[O])OO(17526)'],
    products = ['CCCC(CCC(O)C(C)[O])O[O](17786)'],
...
reaction(
    label = 'reaction22',
    reactants = ['CCCC(CCC([O])C(C)[O])OO(17526)'],
    products = ['C[CH]CC(CCC(O)C(C)[O])OO(17787)'],
...
reaction(
    label = 'reaction24',
    reactants = ['CCCC(CCC([O])C(C)[O])OO(17526)'],
    products = ['[CH2]CCC(CCC(O)C(C)[O])OO(17789)'],
...
reaction(
    label = 'reaction29',
    reactants = ['CCCC(CCC([O])C(C)[O])OO(17526)'],
    products = ['CCCC(CCC(O)C(C)=O)OO(17793)'],
...
reaction(
    label = 'reaction30',
    reactants = ['CH2(S)(23)', 'CCC(CCC([O])C(C)[O])OO(17794)'],
    products = ['CCCC(CCC([O])C(C)[O])OO(17526)'],
...
reaction(
    label = 'reaction31',
    reactants = ['CH2(S)(23)', 'CCCC(CCC([O])C[O])OO(17517)'],
    products = ['CCCC(CCC([O])C(C)[O])OO(17526)'],
...
reaction(
    label = 'reaction32',
    reactants = ['CCCC(CCC([O])C(C)[O])OO(17526)'],
    products = ['OH(5)', 'CCCC1CCC(OO1)C(C)[O](17795)'],
...
reaction(
    label = 'reaction34',
    reactants = ['O(4)', 'CCCC(CC[CH]C(C)[O])OO(17796)'],
    products = ['CCCC(CCC([O])C(C)[O])OO(17526)'],
...
reaction(
    label = 'reaction35',
    reactants = ['O(4)', 'C[CH]C([O])CCC(CCC)OO(17557)'],
    products = ['CCCC(CCC([O])C(C)[O])OO(17526)'],
