...
species(
    label = 'CC=CC([O])CC(10655)',
    structure = SMILES('CC=CC([O])CC'),
    E0 = (-18.7735,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2995,3025,975,1000,1300,1375,400,500,1630,1680,1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,341.147,341.154,341.172],'cm^-1')),
        HinderedRotor(inertia=(0.00144842,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.131966,'amu*angstrom^2'), symmetry=1, barrier=(10.8978,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.131993,'amu*angstrom^2'), symmetry=1, barrier=(10.8977,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.131973,'amu*angstrom^2'), symmetry=1, barrier=(10.8978,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (99.1509,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.643692,0.0632398,-2.71486e-05,-4.68725e-09,4.84405e-12,-2128.24,29.2569], Tmin=(100,'K'), Tmax=(1113.08,'K')), NASAPolynomial(coeffs=[13.6998,0.0349839,-1.42206e-05,2.63283e-09,-1.8325e-13,-6190.85,-40.3231], Tmin=(1113.08,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-18.7735,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(415.724,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(CC(C)OJ)"""),
)
...
species(
    label = 'C[CH]C[C](O)CC(10657)',
    structure = SMILES('C[CH]C[C](O)CC'),
    E0 = (6.73917,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (100.159,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.27965,0.0701989,-2.7673e-05,-6.29891e-08,7.14064e-11,898.01,28.5494], Tmin=(100,'K'), Tmax=(494.041,'K')), NASAPolynomial(coeffs=[5.99548,0.0502077,-2.22058e-05,4.16137e-09,-2.87383e-13,210.053,6.87684], Tmin=(494.041,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(6.73917,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(C2CsJOH) + radical(RCCJC)"""),
)
...
species(
    label = 'C[CH]CC(O)[CH]C(10658)',
    structure = SMILES('C[CH]CC(O)[CH]C'),
    E0 = (30.0134,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3000,3050,390,425,1340,1360,335,370,3615,1277.5,1000,1380,1390,370,380,2900,435,254.708,868.272,1891.29],'cm^-1')),
        HinderedRotor(inertia=(0.116066,'amu*angstrom^2'), symmetry=1, barrier=(3.17652,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.116066,'amu*angstrom^2'), symmetry=1, barrier=(3.17652,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.116066,'amu*angstrom^2'), symmetry=1, barrier=(3.17652,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.116066,'amu*angstrom^2'), symmetry=1, barrier=(3.17652,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.116066,'amu*angstrom^2'), symmetry=1, barrier=(3.17652,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (100.159,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.897238,0.0681477,-4.49008e-05,1.61225e-08,-2.50387e-12,3721.08,32.813], Tmin=(100,'K'), Tmax=(1416.33,'K')), NASAPolynomial(coeffs=[10.1149,0.0421153,-1.73307e-05,3.1453e-09,-2.13249e-13,1110.03,-14.8652], Tmin=(1416.33,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(30.0134,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJC) + radical(CCJCO)"""),
)

species(
    label = 'C[CH][CH]C(O)CC(10659)',
    structure = SMILES('C[CH][CH]C(O)CC'),
    E0 = (30.0134,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (100.159,'amu'),
...
species(
    label = 'CCC[C]([O])CC(10660)',
    structure = SMILES('CCC[C]([O])CC'),
    E0 = (42.6537,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (100.159,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.647931,0.0762035,-5.89814e-05,2.58289e-08,-4.92058e-12,5248.53,27.7168], Tmin=(100,'K'), Tmax=(1188.43,'K')), NASAPolynomial(coeffs=[9.96063,0.0448592,-1.94199e-05,3.63646e-09,-2.52173e-13,3035.02,-18.8193], Tmin=(1188.43,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(42.6537,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(C2CsJOH) + radical(CC(C)OJ)"""),
)

species(
    label = 'C[CH]C([O])CCC(10661)',
    structure = SMILES('C[CH]C([O])CCC'),
    E0 = (65.9279,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3025,407.5,1350,352.5,1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2]CC(O)C[CH]C(10662)',
    structure = SMILES('[CH2]CC(O)C[CH]C'),
    E0 = (35.3577,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1277.5,1000,1380,1390,370,380,2900,435,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3100,440,815,1455,1000,215.292,821.471,1673.18],'cm^-1')),
        HinderedRotor(inertia=(0.13249,'amu*angstrom^2'), symmetry=1, barrier=(3.52982,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.13249,'amu*angstrom^2'), symmetry=1, barrier=(3.52982,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.13249,'amu*angstrom^2'), symmetry=1, barrier=(3.52982,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.13249,'amu*angstrom^2'), symmetry=1, barrier=(3.52982,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.13249,'amu*angstrom^2'), symmetry=1, barrier=(3.52982,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (100.159,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.913624,0.0718418,-5.53644e-05,2.60251e-08,-5.57117e-12,4360.34,32.0612], Tmin=(100,'K'), Tmax=(1044.71,'K')), NASAPolynomial(coeffs=[7.23011,0.0476568,-2.0639e-05,3.86533e-09,-2.68243e-13,3040.58,1.31165], Tmin=(1044.71,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(35.3577,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJC) + radical(RCCJ)"""),
)
...
species(
    label = '[CH2][CH]CC(O)CC(10663)',
    structure = SMILES('[CH2][CH]CC(O)CC'),
    E0 = (35.3577,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (100.159,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.913615,0.0718419,-5.53646e-05,2.60254e-08,-5.57126e-12,4360.34,32.0613], Tmin=(100,'K'), Tmax=(1044.7,'K')), NASAPolynomial(coeffs=[7.23008,0.0476569,-2.06391e-05,3.86534e-09,-2.68244e-13,3040.59,1.31183], Tmin=(1044.7,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(35.3577,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJ) + radical(RCCJC)"""),
)

species(
    label = 'CCCC(=O)CC(10664)',
    ...
    molecularWeight = (100.159,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.48015,0.0646468,-1.74036e-05,-5.81842e-08,5.85637e-11,-36889.1,23.7513], Tmin=(100,'K'), Tmax=(491.039,'K')), NASAPolynomial(coeffs=[4.29488,0.0544243,-2.49911e-05,4.81413e-09,-3.39697e-13,-37318.7,10.614], Tmin=(491.039,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-307.391,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdCsCs)"""),
)

species(
    label = 'CC=CC(O)CC(10665)',
    structure = SMILES('CC=CC(O)CC'),
    E0 = (-249.134,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (100.159,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.460765,0.0674549,-3.37482e-05,1.12325e-09,2.96386e-12,-29827.9,30.1063], Tmin=(100,'K'), Tmax=(1137.16,'K')), NASAPolynomial(coeffs=[13.97,0.0364456,-1.46225e-05,2.67805e-09,-1.84802e-13,-33967.8,-41.498], Tmin=(1137.16,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-249.134,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH)"""),
)

species(
    label = 'C=CCC(O)CC(1278)',
    structure = SMILES('C=CCC(O)CC'),
    E0 = (-236.553,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (100.159,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.31746,0.0709594,-4.30573e-05,1.03055e-08,-6.08825e-14,-28309.8,30.1527], Tmin=(100,'K'), Tmax=(1200.89,'K')), NASAPolynomial(coeffs=[14.4614,0.0358198,-1.41191e-05,2.5422e-09,-1.7294e-13,-32570.2,-44.267], Tmin=(1200.89,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-236.553,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'C[CH]CC(=O)CC(6975)'],
    products = ['C[CH]CC([O])CC(10579)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'CC=CC([O])CC(10655)'],
    products = ['C[CH]CC([O])CC(10579)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', 'C=CCC([O])CC(10656)'],
    products = ['C[CH]CC([O])CC(10579)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['C2H5(29)', 'C4H7OJ_13(1705)'],
    products = ['C[CH]CC([O])CC(10579)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction11',
    reactants = ['C[CH]CC(O)[CH]C(10658)'],
    products = ['C[CH]CC([O])CC(10579)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]CC(O)C[CH]C(10662)'],
    products = ['C[CH]CC([O])CC(10579)'],
...
reaction(
    label = 'reaction22',
    reactants = ['CH2(S)(23)', 'C[CH]CC(C)[O](1218)'],
    products = ['C[CH]CC([O])CC(10579)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH2]C(C)C([O])CC(10581)'],
    products = ['C[CH]CC([O])CC(10579)'],
...
reaction(
    label = 'reaction25',
    reactants = ['C[CH]C[CH]CC(375)', 'O(4)'],
    products = ['C[CH]CC([O])CC(10579)'],
...
reaction(
    label = 'reaction26',
    reactants = ['CHCH3(T)(95)', '[CH2]C([O])CC(1666)'],
    products = ['C[CH]CC([O])CC(10579)'],
