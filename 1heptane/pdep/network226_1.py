...
species(
    ...
    E0 = (-69.1109,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000],'cm^-1')),
...
species(
    ...
    molecularWeight = (77.0593,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.01765,0.0457412,-4.66874e-05,2.58117e-08,-5.91175e-12,-21585.5,19.5498], Tmin=(100,'K'), Tmax=(1036.96,'K')), NASAPolynomial(coeffs=[8.70271,0.0199541,-9.38555e-06,1.83018e-09,-1.30073e-13,-22971.9,-12.9444], Tmin=(1036.96,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-180.051,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + radical(Cs_P)"""),
)
...
species(
    ...
    E0 = (-159.592,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,180],'cm^-1')),
        HinderedRotor(inertia=(0.0939564,'amu*angstrom^2'), symmetry=1, barrier=(2.16024,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0910563,'amu*angstrom^2'), symmetry=1, barrier=(2.09356,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.04766,'amu*angstrom^2'), symmetry=1, barrier=(47.0798,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (77.0593,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.18034,0.044306,-5.65101e-05,5.07432e-08,-1.98422e-11,-19133.1,19.131], Tmin=(100,'K'), Tmax=(732.721,'K')), NASAPolynomial(coeffs=[4.02914,0.0290112,-1.45497e-05,2.8761e-09,-2.04263e-13,-19264.3,11.7395], Tmin=(732.721,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-159.592,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + radical(CCOJ)"""),
)

species(
    label = '[CH2]C(O)OO(708)',
...
species(
    ...
    E0 = (-7.5872,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,492.5,1135,1000,1380,1390,370,380,2900,435,180],'cm^-1')),
...
species(
    label = 'C[C](O)O[O](3364)',
    structure = SMILES('C[C](O)O[O]'),
    E0 = (-28.046,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350,492.5,1135,1000,3615,1277.5,1000],'cm^-1')),
        HinderedRotor(inertia=(0.262232,'amu*angstrom^2'), symmetry=1, barrier=(6.02923,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.262219,'amu*angstrom^2'), symmetry=1, barrier=(6.02893,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.262321,'amu*angstrom^2'), symmetry=1, barrier=(6.03127,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (76.0514,'amu'),
...
species(
    ...
    E0 = (-180.609,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,492.5,1135,1000,3615,1277.5,1000],'cm^-1')),
        HinderedRotor(inertia=(0.501503,'amu*angstrom^2'), symmetry=1, barrier=(11.5305,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.501011,'amu*angstrom^2'), symmetry=1, barrier=(11.5192,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.69194,0.0271135,-2.49832e-05,1.1931e-08,-2.28596e-12,-21673.7,14.0558], Tmin=(100,'K'), Tmax=(1253.51,'K')), NASAPolynomial(coeffs=[8.21381,0.00949295,-3.89778e-06,7.16891e-10,-4.94196e-14,-23058.1,-13.8317], Tmin=(1253.51,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-180.609,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(149.66,'J/(mol*K)'), label="""HOCH2OO""", comment="""Thermo library: DFT_QCI_thermo"""),
)
...
species(
    ...
    E0 = (-231.097,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1277.5,1000,1380,1390,370,380,2900,435,2388.59],'cm^-1')),
        HinderedRotor(inertia=(0.139638,'amu*angstrom^2'), symmetry=1, barrier=(3.21055,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.471366,'amu*angstrom^2'), symmetry=1, barrier=(10.8376,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (61.0599,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.2451,0.0229431,-9.99656e-06,1.53635e-09,-4.21802e-14,-27773.5,14.5314], Tmin=(100,'K'), Tmax=(2344.38,'K')), NASAPolynomial(coeffs=[14.1235,0.00901928,-4.05455e-06,6.90304e-10,-4.19272e-14,-34148.4,-49.937], Tmin=(2344.38,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-231.097,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + radical(CCOJ)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['CC(O)O[O](689)'],
    products = ['HO2(10)', 'CH2CHOH(42)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction3',
    reactants = ['CC([O])OO(707)'],
    products = ['CC(O)O[O](689)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction8',
    reactants = ['CH3(17)', '[O]O[CH]O(4538)'],
    products = ['CC(O)O[O](689)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(6.64e+14,'cm^3/(mol*s)'), n=-0.57, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(713,'K'), Tmax=(1800,'K'), comment="""Estimated using template [C_rad/H/NonDe;C_methyl] for rate rule [C_rad/H/O2;C_methyl]
Euclidian distance = 2.0
family: R_Recombination"""),
)
...
reaction(
    label = 'reaction12',
    reactants = ['CH2(S)(23)', 'HOCH2OO(703)'],
    products = ['CC(O)O[O](689)'],
