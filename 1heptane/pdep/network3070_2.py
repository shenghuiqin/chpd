species(
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.695805,0.0816642,-5.07062e-05,1.76564e-08,-2.93796e-12,-17901.7,31.7652], Tmin=(100,'K'), Tmax=(1186.46,'K')), NASAPolynomial(coeffs=[5.7481,0.064631,-2.91718e-05,5.55624e-09,-3.88333e-13,-19100.5,6.52701], Tmin=(1186.46,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-149.767,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(532.126,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCOJ)"""),
)
...
species(
    label = 'C=CCCCO(2991)',
    structure = SMILES('C=CCCCO'),
    E0 = (-200.13,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2950,3100,1380,975,1025,1650,3615,1277.5,1000,3010,987.5,1337.5,450,1655,202.51,202.522,4000],'cm^-1')),
        HinderedRotor(inertia=(0.00411002,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.829234,'amu*angstrom^2'), symmetry=1, barrier=(24.1388,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.641228,'amu*angstrom^2'), symmetry=1, barrier=(18.6583,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.355076,'amu*angstrom^2'), symmetry=1, barrier=(10.333,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (86.1323,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.00729,0.0577258,-3.72968e-05,1.23581e-08,-1.67237e-12,-23955.6,25.7866], Tmin=(100,'K'), Tmax=(1698.35,'K')), NASAPolynomial(coeffs=[13.9482,0.0272468,-1.03773e-05,1.7911e-09,-1.16884e-13,-28351.2,-43.5002], Tmin=(1698.35,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-200.13,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH)"""),
)
...
species(
    label = 'CCC[CH]CCC[O](1877)',
    structure = SMILES('CCC[CH]CCC[O]'),
    E0 = (44.6912,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (114.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.45167,0.0670011,-3.07793e-05,5.79621e-09,-3.93692e-13,5395.24,27.8121], Tmin=(100,'K'), Tmax=(2979.54,'K')), NASAPolynomial(coeffs=[59.053,-0.000323281,-1.24682e-06,1.64126e-10,-2.99898e-15,-32179,-313.505], Tmin=(2979.54,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(44.6912,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(RCCJCC)"""),
)
...
species(
    label = 'CCC[CH]C[CH]CO(3368)',
    structure = SMILES('CCC[CH]C[CH]CO'),
    E0 = (18.8881,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (114.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.502764,0.0827472,-6.366e-05,3.13415e-08,-7.30237e-12,2392.7,36.6738], Tmin=(100,'K'), Tmax=(948.84,'K')), NASAPolynomial(coeffs=[6.14192,0.058974,-2.60768e-05,4.93461e-09,-3.4457e-13,1322.59,9.76436], Tmin=(948.84,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(18.8881,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(CCJCO)"""),
)

species(
    label = '[CH2][CH]CCCO(2989)',
    structure = SMILES('[CH2][CH]CCCO'),
    E0 = (71.7809,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3615,1277.5,1000,3000,3100,440,815,1455,1000,3025,407.5,1350,352.5,232.335,429.209,3053.67],'cm^-1')),
        HinderedRotor(inertia=(0.0616125,'amu*angstrom^2'), symmetry=1, barrier=(2.12757,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0616125,'amu*angstrom^2'), symmetry=1, barrier=(2.12757,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0616125,'amu*angstrom^2'), symmetry=1, barrier=(2.12757,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0616125,'amu*angstrom^2'), symmetry=1, barrier=(2.12757,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0616125,'amu*angstrom^2'), symmetry=1, barrier=(2.12757,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (86.1323,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.04614,0.0508499,-4.9452e-06,-7.2571e-08,6.96105e-11,8695.56,26.2386], Tmin=(100,'K'), Tmax=(476.085,'K')), NASAPolynomial(coeffs=[4.60436,0.0422671,-1.85824e-05,3.48847e-09,-2.41838e-13,8305.65,14.2586], Tmin=(476.085,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(71.7809,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(RCCJ) + radical(RCCJC)"""),
)
...
species(
    label = '[CH2]C[CH]CCCO(3369)',
    structure = SMILES('[CH2]C[CH]CCCO'),
    E0 = (48.0127,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,3615,1277.5,1000,3000,3100,440,815,1455,1000,3025,407.5,1350,352.5,248.592,860.646,1246.83,1858.76],'cm^-1')),
        HinderedRotor(inertia=(0.116201,'amu*angstrom^2'), symmetry=1, barrier=(3.42983,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.116201,'amu*angstrom^2'), symmetry=1, barrier=(3.42983,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.116201,'amu*angstrom^2'), symmetry=1, barrier=(3.42983,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.116201,'amu*angstrom^2'), symmetry=1, barrier=(3.42983,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.116201,'amu*angstrom^2'), symmetry=1, barrier=(3.42983,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.8312,0.0589875,1.95048e-05,-1.63584e-07,1.55629e-10,5840.74,29.2103], Tmin=(100,'K'), Tmax=(432.722,'K')), NASAPolynomial(coeffs=[4.62122,0.0522795,-2.33902e-05,4.41135e-09,-3.05802e-13,5420.62,16.0228], Tmin=(432.722,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(48.0127,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(RCCJ) + radical(RCCJCC)"""),
)
...
species(
    label = 'CC[CH][CH]CCCO(3371)',
    structure = SMILES('CC[CH][CH]CCCO'),
    E0 = (13.4443,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,3000,3050,390,425,1340,1360,335,370,3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,210.861,228.836,452.155,2016.59,3289.78],'cm^-1')),
        HinderedRotor(inertia=(0.0684269,'amu*angstrom^2'), symmetry=1, barrier=(2.33959,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0684269,'amu*angstrom^2'), symmetry=1, barrier=(2.33959,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0684269,'amu*angstrom^2'), symmetry=1, barrier=(2.33959,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0684269,'amu*angstrom^2'), symmetry=1, barrier=(2.33959,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0684269,'amu*angstrom^2'), symmetry=1, barrier=(2.33959,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (114.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.212595,0.092864,-0.000113316,1.01841e-07,-3.84887e-11,1744.08,37.7626], Tmin=(100,'K'), Tmax=(816.613,'K')), NASAPolynomial(coeffs=[1.75979,0.0664323,-3.0135e-05,5.6623e-09,-3.89161e-13,2120.01,34.4606], Tmin=(816.613,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(13.4443,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(RCCJCC)"""),
)

species(
    label = 'CCC[CH][CH]CCO(1884)',
    structure = SMILES('CCC[CH][CH]CCO'),
    E0 = (13.4443,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,3000,3050,390,425,1340,1360,335,370,3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,210.861,228.836,452.155,2016.59,3289.78],'cm^-1')),
        HinderedRotor(inertia=(0.0684269,'amu*angstrom^2'), symmetry=1, barrier=(2.33959,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2]CC[CH]CCCO(3372)',
    structure = SMILES('[CH2]CC[CH]CCCO'),
    E0 = (24.2324,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (114.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.980757,0.0778999,-2.27472e-05,-7.74716e-08,8.08824e-11,3011.62,34.4236], Tmin=(100,'K'), Tmax=(488.671,'K')), NASAPolynomial(coeffs=[5.2281,0.0613062,-2.75945e-05,5.24228e-09,-3.66036e-13,2379.53,14.7539], Tmin=(488.671,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(24.2324,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(RCCJ) + radical(RCCJCC)"""),
)
...
species(
    label = 'CC[CH]CCCO(3373)',
    structure = SMILES('CC[CH]CCCO'),
    E0 = (-157.234,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,3025,407.5,1350,352.5,3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.40377,0.0657333,-1.83381e-05,-5.13025e-08,5.06108e-11,-18825.8,28.8132], Tmin=(100,'K'), Tmax=(508.023,'K')), NASAPolynomial(coeffs=[4.23756,0.0556783,-2.48404e-05,4.72312e-09,-3.30965e-13,-19271.9,15.5041], Tmin=(508.023,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-157.234,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(RCCJCC)"""),
)

species(
    label = 'CC[CH]CCCCO(3264)',
    structure = SMILES('CC[CH]CCCCO'),
    E0 = (-181.014,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2761.11,2772.22,2783.33,2794.44,2805.56,2816.67,2827.78,2838.89,2850,1425,1431.25,1437.5,1443.75,1450,1225,1237.5,1250,1262.5,1275,1270,1287.5,1305,1322.5,1340,700,725,750,775,800,300,325,350,375,400,3025,407.5,1350,352.5,3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,180,578.039,649.041,1600,3200],'cm^-1')),
        HinderedRotor(inertia=(0.152111,'amu*angstrom^2'), symmetry=1, barrier=(3.49733,'kJ/mol'), semiclassical=False),
...
species(
    label = 'CCCC[CH]CCO(3262)',
    structure = SMILES('CCCC[CH]CCO'),
    E0 = (-181.014,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2761.11,2772.22,2783.33,2794.44,2805.56,2816.67,2827.78,2838.89,2850,1425,1431.25,1437.5,1443.75,1450,1225,1237.5,1250,1262.5,1275,1270,1287.5,1305,1322.5,1340,700,725,750,775,800,300,325,350,375,400,3025,407.5,1350,352.5,3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,180,578.039,649.041,1600,3200],'cm^-1')),
        HinderedRotor(inertia=(0.152111,'amu*angstrom^2'), symmetry=1, barrier=(3.49733,'kJ/mol'), semiclassical=False),
...
species(
    label = 'C[CH]CCCCCO(3265)',
    structure = SMILES('C[CH]CCCCCO'),
    E0 = (-181.026,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (115.193,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.298696,0.0871988,-6.62807e-05,3.16508e-08,-7.0775e-12,-21644,35.079], Tmin=(100,'K'), Tmax=(988.408,'K')), NASAPolynomial(coeffs=[6.71732,0.0612234,-2.68611e-05,5.06319e-09,-3.5272e-13,-22912.9,4.18758], Tmin=(988.408,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-181.026,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(527.969,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(RCCJC)"""),
)

species(
    label = 'CCCCC[CH]CO(3261)',
    structure = SMILES('CCCCC[CH]CO'),
    E0 = (-175.57,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2761.11,2772.22,2783.33,2794.44,2805.56,2816.67,2827.78,2838.89,2850,1425,1431.25,1437.5,1443.75,1450,1225,1237.5,1250,1262.5,1275,1270,1287.5,1305,1322.5,1340,700,725,750,775,800,300,325,350,375,400,3025,407.5,1350,352.5,3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (115.193,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.177892,0.0875552,-5.90502e-05,2.09606e-08,-3.11643e-12,-20962.8,36.5316], Tmin=(100,'K'), Tmax=(1517.14,'K')), NASAPolynomial(coeffs=[15.096,0.0472849,-1.92349e-05,3.46487e-09,-2.33424e-13,-25597.3,-43.5229], Tmin=(1517.14,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-175.57,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(527.969,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCJCO)"""),
)

species(
    label = 'CCCCCC[CH]O(3260)',
    structure = SMILES('CCCCCC[CH]O'),
    E0 = (-195.174,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (115.193,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.212753,0.0963552,-8.06681e-05,3.9238e-08,-8.29048e-12,-23325.5,33.7199], Tmin=(100,'K'), Tmax=(1088.97,'K')), NASAPolynomial(coeffs=[11.0079,0.0551398,-2.38961e-05,4.48236e-09,-3.11489e-13,-25769.3,-21.3696], Tmin=(1088.97,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-195.174,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(527.969,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCsJOH)"""),
)

species(
    label = '[CH2]CCCCCCO(3266)',
    structure = SMILES('[CH2]CCCCCCO'),
    E0 = (-170.226,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (115.193,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0145754,0.0894541,-6.43985e-05,2.55896e-08,-4.40509e-12,-20331.9,35.1276], Tmin=(100,'K'), Tmax=(1297.71,'K')), NASAPolynomial(coeffs=[11.6798,0.0534979,-2.28375e-05,4.23871e-09,-2.9192e-13,-23359.5,-24.1902], Tmin=(1297.71,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-170.226,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(527.969,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(RCCJ)"""),
)

species(
    label = 'C=CC[CH]CCC(456)',
...
species(
    label = 'CCC[CH]CO(681)',
    structure = SMILES('CCC[CH]CO'),
    E0 = (-128.01,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3025,407.5,1350,352.5,3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.896813,0.0602819,-3.82582e-05,1.25074e-08,-1.67731e-12,-15277.8,28.2042], Tmin=(100,'K'), Tmax=(1703.77,'K')), NASAPolynomial(coeffs=[13.9671,0.0295961,-1.12423e-05,1.93629e-09,-1.26175e-13,-19731.5,-41.8168], Tmin=(1703.77,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-128.01,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCJCO)"""),
)

species(
    label = '[CH2]C(CC)CCCO(3374)',
    structure = SMILES('[CH2]C(CC)CCCO'),
    E0 = (-172.737,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1277.5,1000,3000,3100,440,815,1455,1000,1380,1390,370,380,2900,435,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (115.193,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.282663,0.091268,-6.80342e-05,2.84101e-08,-5.04122e-12,-20619.1,35.9121], Tmin=(100,'K'), Tmax=(1295.28,'K')), NASAPolynomial(coeffs=[13.2386,0.0495128,-1.96799e-05,3.52277e-09,-2.37781e-13,-24121.8,-32.8184], Tmin=(1295.28,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-172.737,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(527.969,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]C(CCC)CCO(3375)',
    structure = SMILES('[CH2]C(CCC)CCO'),
    E0 = (-172.737,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1277.5,1000,3000,3100,440,815,1455,1000,1380,1390,370,380,2900,435,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH]CCCO(3376)',
    structure = SMILES('[CH]CCCO'),
    E0 = (151.298,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3615,1277.5,1000,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.79287,0.0471217,-3.32973e-05,1.25412e-08,-1.97641e-12,18277.3,21.4404], Tmin=(100,'K'), Tmax=(1443.54,'K')), NASAPolynomial(coeffs=[9.82196,0.0248735,-1.01791e-05,1.86462e-09,-1.27397e-13,15959.3,-20.2428], Tmin=(1443.54,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(151.298,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo library: CBS_QB3_1dHR + radical(CCJ2_triplet)"""),
)
...
species(
    label = 'CCC[C]CCCO(3378)',
    structure = SMILES('CCC[C]CCCO'),
    E0 = (72.7429,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2761.11,2772.22,2783.33,2794.44,2805.56,2816.67,2827.78,2838.89,2850,1425,1431.25,1437.5,1443.75,1450,1225,1237.5,1250,1262.5,1275,1270,1287.5,1305,1322.5,1340,700,725,750,775,800,300,325,350,375,400,3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (114.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0936541,0.0919202,-7.37231e-05,3.31847e-08,-6.40718e-12,8894.62,33.6414], Tmin=(100,'K'), Tmax=(1187.9,'K')), NASAPolynomial(coeffs=[12.1022,0.050854,-2.18686e-05,4.08382e-09,-2.82874e-13,5997.06,-27.297], Tmin=(1187.9,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(72.7429,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCJ2_triplet)"""),
)

species(
    label = 'CCCCCCC=O(1889)',
    structure = SMILES('CCCCCCC=O'),
    E0 = (-298.444,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2761.11,2772.22,2783.33,2794.44,2805.56,2816.67,2827.78,2838.89,2850,1425,1431.25,1437.5,1443.75,1450,1225,1237.5,1250,1262.5,1275,1270,1287.5,1305,1322.5,1340,700,725,750,775,800,300,325,350,375,400,2750,2800,2850,1350,1500,750,1050,1375,1000,2782.5,750,1395,475,1775,1000,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (114.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.591073,0.0790396,-4.76912e-05,1.45849e-08,-1.89968e-12,-35776.6,30.5812], Tmin=(100,'K'), Tmax=(1616.89,'K')), NASAPolynomial(coeffs=[11.6691,0.0516335,-2.22663e-05,4.10171e-09,-2.78793e-13,-39359,-28.187], Tmin=(1616.89,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-298.444,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsH)"""),
)
...
species(
    label = 'CC[CH]CCCC[O](1879)',
    structure = SMILES('CC[CH]CCCC[O]'),
    E0 = (44.6912,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2761.11,2772.22,2783.33,2794.44,2805.56,2816.67,2827.78,2838.89,2850,1425,1431.25,1437.5,1443.75,1450,1225,1237.5,1250,1262.5,1275,1270,1287.5,1305,1322.5,1340,700,725,750,775,800,300,325,350,375,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2]CCCCC[O](1819)',
    structure = SMILES('[CH2]CCCCC[O]'),
    E0 = (79.2595,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2761.11,2772.22,2783.33,2794.44,2805.56,2816.67,2827.78,2838.89,2850,1425,1431.25,1437.5,1443.75,1450,1225,1237.5,1250,1262.5,1275,1270,1287.5,1305,1322.5,1340,700,725,750,775,800,300,325,350,375,400,3000,3100,440,815,1455,1000,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (100.159,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.83331,0.0579506,1.60938e-05,-1.33709e-07,1.21592e-10,9600,27.4536], Tmin=(100,'K'), Tmax=(438.104,'K')), NASAPolynomial(coeffs=[3.64908,0.0557706,-2.57407e-05,4.9692e-09,-3.50993e-13,9302.72,18.6151], Tmin=(438.104,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(79.2595,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(RCCJ) + radical(CCOJ)"""),
)

species(
    label = 'C[CH]CCCCC[O](1882)',
    structure = SMILES('C[CH]CCCCC[O]'),
    E0 = (44.6792,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2761.11,2772.22,2783.33,2794.44,2805.56,2816.67,2827.78,2838.89,2850,1425,1431.25,1437.5,1443.75,1450,1225,1237.5,1250,1262.5,1275,1270,1287.5,1305,1322.5,1340,700,725,750,775,800,300,325,350,375,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (114.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.314411,0.0887919,-9.51821e-05,8.09526e-08,-3.10551e-11,5498.93,35.8674], Tmin=(100,'K'), Tmax=(771.697,'K')), NASAPolynomial(coeffs=[2.21189,0.0673316,-3.0872e-05,5.87433e-09,-4.08578e-13,5552.22,29.4477], Tmin=(771.697,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(44.6792,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(RCCJC) + radical(CCOJ)"""),
)
...
species(
    ...
    molecularWeight = (114.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.881221,0.0769492,-4.52342e-05,1.36212e-08,-1.80502e-12,6133.84,33.5641], Tmin=(100,'K'), Tmax=(1507.85,'K')), NASAPolynomial(coeffs=[8.55382,0.0565955,-2.49864e-05,4.669e-09,-3.20756e-13,3820.02,-6.60279], Tmin=(1507.85,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(50.1349,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(CCJCO)"""),
)

species(
    label = '[CH2]CCCCCC[O](1883)',
    structure = SMILES('[CH2]CCCCCC[O]'),
    E0 = (55.4792,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (114.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.414601,0.0858087,-7.16943e-05,4.21356e-08,-1.22063e-11,6795.54,34.5853], Tmin=(100,'K'), Tmax=(771.958,'K')), NASAPolynomial(coeffs=[4.60757,0.064083,-2.94803e-05,5.68062e-09,-4.00681e-13,6148.16,15.4417], Tmin=(771.958,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(55.4792,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(RCCJ) + radical(CCOJ)"""),
)

species(
    label = 'CCCCCC[CH][O](1880)',
    structure = SMILES('CCCCCC[CH][O]'),
    E0 = (30.5307,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2761.11,2772.22,2783.33,2794.44,2805.56,2816.67,2827.78,2838.89,2850,1425,1431.25,1437.5,1443.75,1450,1225,1237.5,1250,1262.5,1275,1270,1287.5,1305,1322.5,1340,700,725,750,775,800,300,325,350,375,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,200,800,1000,1200,1400,1600],'cm^-1')),
    ...
    molecularWeight = (114.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.803044,0.0824585,-3.12516e-05,-6.85956e-08,7.6724e-11,3774.93,31.1205], Tmin=(100,'K'), Tmax=(490.441,'K')), NASAPolynomial(coeffs=[5.43664,0.0632122,-2.9107e-05,5.58912e-09,-3.9265e-13,3097.39,9.79346], Tmin=(490.441,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(30.5307,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCsJOH) + radical(CCOJ)"""),
)

species(
    label = 'CCCCCC[O](580)',
    structure = SMILES('CCCCCC[O]'),
    E0 = (-125.987,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2761.11,2772.22,2783.33,2794.44,2805.56,2816.67,2827.78,2838.89,2850,1425,1431.25,1437.5,1443.75,1450,1225,1237.5,1250,1262.5,1275,1270,1287.5,1305,1322.5,1340,700,725,750,775,800,300,325,350,375,400,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (101.167,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.5751,0.0650459,-3.34766e-05,7.87157e-09,-7.38764e-13,-15078.7,26.2846], Tmin=(100,'K'), Tmax=(2183.1,'K')), NASAPolynomial(coeffs=[13.3814,0.0434137,-1.86131e-05,3.33259e-09,-2.18975e-13,-20233.5,-39.8914], Tmin=(2183.1,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-125.987,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCOJ)"""),
)
...
reaction(
    label = 'reaction25',
    reactants = ['H(3)', 'CCC=CCCCO(3367)'],
    products = ['CCC[CH]CCCO(3263)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction27',
    reactants = ['C2H5(29)', 'C=CCCCO(2991)'],
    products = ['CCC[CH]CCCO(3263)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction28',
    reactants = ['C=CCCC(134)', 'CH2CH2OH(43)'],
    products = ['CCC[CH]CCCO(3263)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(2130,'cm^3/(mol*s)'), n=2.41, Ea=(19.874,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""Estimated using an average for rate rule [Cds-HH_Cds-CsH;CsJ-CsHH]
Euclidian distance = 0
...
reaction(
    label = 'reaction35',
    reactants = ['[CH2]CC[CH]CCC(204)', 'OH(5)'],
    products = ['CCC[CH]CCCO(3263)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction36',
    reactants = ['H(3)', 'CCC[CH]CCC[O](1877)'],
    products = ['CCC[CH]CCCO(3263)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction37',
    reactants = ['[CH2][CH]CCC(137)', 'CH2CH2OH(43)'],
    products = ['CCC[CH]CCCO(3263)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction38',
    reactants = ['CH2OH(24)', '[CH2]C[CH]CCC(203)'],
    products = ['CCC[CH]CCCO(3263)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction39',
    reactants = ['H(3)', 'CCC[CH]C[CH]CO(3368)'],
    products = ['CCC[CH]CCCO(3263)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction40',
    reactants = ['C2H5(29)', '[CH2][CH]CCCO(2989)'],
    products = ['CCC[CH]CCCO(3263)'],
...
reaction(
    label = 'reaction41',
    reactants = ['CH3(17)', '[CH2]C[CH]CCCO(3369)'],
    products = ['CCC[CH]CCCO(3263)'],
...
reaction(
    label = 'reaction42',
    reactants = ['H(3)', 'C[CH]C[CH]CCCO(3370)'],
    products = ['CCC[CH]CCCO(3263)'],
...
reaction(
    label = 'reaction43',
    reactants = ['H(3)', 'CC[CH][CH]CCCO(3371)'],
    products = ['CCC[CH]CCCO(3263)'],
...
reaction(
    label = 'reaction44',
    reactants = ['H(3)', 'CCC[CH][CH]CCO(1884)'],
    products = ['CCC[CH]CCCO(3263)'],
...
reaction(
    label = 'reaction45',
    reactants = ['H(3)', 'CCC[CH]CC[CH]O(1289)'],
    products = ['CCC[CH]CCCO(3263)'],
...
reaction(
    label = 'reaction46',
    reactants = ['H(3)', '[CH2]CC[CH]CCCO(3372)'],
    products = ['CCC[CH]CCCO(3263)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CH2(S)(23)', 'CC[CH]CCCO(3373)'],
    products = ['CCC[CH]CCCO(3263)'],
...
reaction(
    label = 'reaction31',
    reactants = ['CCC[CH]CCCO(3263)'],
    products = ['C[CH]CCCCCO(3265)'],
...
reaction(
    label = 'reaction47',
    reactants = ['C=CC[CH]CCC(456)', 'H2O(7)'],
    products = ['CCC[CH]CCCO(3263)'],
...
reaction(
    label = 'reaction48',
    reactants = ['C2H4(21)', 'CCC[CH]CO(681)'],
    products = ['CCC[CH]CCCO(3263)'],
...
reaction(
    label = 'reaction52',
    reactants = ['npropyl(83)', '[CH]CCCO(3376)'],
    products = ['CCC[CH]CCCO(3263)'],
...
reaction(
    label = 'reaction53',
    reactants = ['[CH]CCC(133)', 'CH2CH2CH2OH(3377)'],
    products = ['CCC[CH]CCCO(3263)'],
...
reaction(
    label = 'reaction1',
    reactants = ['H(3)', 'CCCCCCC=O(1889)'],
    products = ['CCCCCCC[O](663)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]CCCCC(87)', 'CH2O(15)'],
    products = ['CCCCCCC[O](663)'],
    transitionState = 'TS33',
    kinetics = Arrhenius(A=(7.94e+10,'cm^3/(mol*s)'), n=0, Ea=(28.0328,'kJ/mol'), T0=(1,'K'), Tmin=(333,'K'), Tmax=(363,'K'), comment="""From training reaction 2759 used for CO-HH_O;CsJ-CsHH
...
reaction(
    ...
    kinetics = Arrhenius(A=(3.9e+08,'s^-1'), n=0, Ea=(106.901,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""Matched reaction 144 C7H15O-3 <=> C7H15O-4 in intra_H_migration/training
This reaction matched rate rule [R7H;O_rad_out;Cs_H_out_H/NonDeC]
family: intra_H_migration"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['npropyl(83)', '[CH2]CCC[O](1708)'],
    products = ['CCCCCCC[O](663)'],
...
reaction(
    label = 'reaction4',
    reactants = ['C2H5(29)', '[CH2]CCCC[O](1727)'],
    products = ['CCCCCCC[O](663)'],
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)', 'CC[CH]CCCC[O](1879)'],
    products = ['CCCCCCC[O](663)'],
...
reaction(
    label = 'reaction6',
    reactants = ['butyl_1(82)', '[CH2]CC[O](466)'],
    products = ['CCCCCCC[O](663)'],
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]C[O](96)', '[CH2]CCCC(84)'],
    products = ['CCCCCCC[O](663)'],
...
reaction(
    label = 'reaction9',
    reactants = ['H(3)', 'CCCC[CH]CC[O](992)'],
    products = ['CCCCCCC[O](663)'],
...
reaction(
    label = 'reaction10',
    reactants = ['CH3(17)', '[CH2]CCCCC[O](1819)'],
    products = ['CCCCCCC[O](663)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(3)', 'C[CH]CCCCC[O](1882)'],
    products = ['CCCCCCC[O](663)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2][O](167)', '[CH2]CCCCC(87)'],
    products = ['CCCCCCC[O](663)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(3)', 'CCCCC[CH]C[O](1859)'],
    products = ['CCCCCCC[O](663)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(3)', '[CH2]CCCCCC[O](1883)'],
    products = ['CCCCCCC[O](663)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(3)', 'CCCCCC[CH][O](1880)'],
    products = ['CCCCCCC[O](663)'],
...
reaction(
    label = 'reaction53',
    reactants = ['CH2(S)(23)', 'CCCCCC[O](580)'],
    products = ['CCCCCCC[O](663)'],
...
network(
    ...
    reactants = [
        ('C=CCCC(134)', 'CH2CH2OH(43)'),
        ('[CH2]CCCCC(87)', 'CH2O(15)'),
        ('[CH2]CCCCCC(89)', 'O(4)'),
    ],
    bathGas = {
        'N2': 0.5,
