...
species(
    label = 'CC([O])C=C=O(3211)',
    structure = SMILES('CC([O])C=C=O'),
    E0 = (-52.1701,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2120,512.5,787.5,3010,987.5,1337.5,450,1655,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.594741,'amu*angstrom^2'), symmetry=1, barrier=(13.6743,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.59427,'amu*angstrom^2'), symmetry=1, barrier=(13.6634,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
species(
    label = 'CC(=O)C=[C]O(16719)',
    structure = SMILES('CC(=O)C=[C]O'),
    E0 = (-95.5421,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,3010,987.5,1337.5,450,1655,375,552.5,462.5,1710,3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,364.247],'cm^-1')),
        HinderedRotor(inertia=(0.115151,'amu*angstrom^2'), symmetry=1, barrier=(10.8436,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.115156,'amu*angstrom^2'), symmetry=1, barrier=(10.8438,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.115137,'amu*angstrom^2'), symmetry=1, barrier=(10.8438,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (85.0813,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.75964,0.0464109,-3.96213e-05,1.74315e-08,-3.10221e-12,-11408.1,22.4402], Tmin=(100,'K'), Tmax=(1332.85,'K')), NASAPolynomial(coeffs=[11.2408,0.0179567,-7.59849e-06,1.41415e-09,-9.78375e-14,-13935.5,-26.0252], Tmin=(1332.85,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-95.5421,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-O2d)HHH) + group(Cds-O2d(Cds-Cds)Cs) + group(Cd-Cd(CO)H) + group(Cds-CdsOsH) + radical(C=CJO)"""),
)

species(
    label = 'CC([O])C#CO(16720)',
    structure = SMILES('CC([O])C#CO'),
    E0 = (65.5167,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2100,2250,500,550,2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1277.5,1000,1380,1390,370,380,2900,435,612.95,612.952],'cm^-1')),
        HinderedRotor(inertia=(0.717037,'amu*angstrom^2'), symmetry=1, barrier=(16.4861,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.717013,'amu*angstrom^2'), symmetry=1, barrier=(16.4855,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.109876,'amu*angstrom^2'), symmetry=1, barrier=(29.296,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (85.0813,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.69868,0.0431945,-2.28286e-05,-4.27646e-09,5.61055e-12,7969.31,22.367], Tmin=(100,'K'), Tmax=(981.461,'K')), NASAPolynomial(coeffs=[12.5392,0.0154278,-5.47865e-06,9.78949e-10,-6.87211e-14,5050.82,-33.757], Tmin=(981.461,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(65.5167,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CtH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtOs) + radical(CC(C)OJ)"""),
)
...
species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.831524,'amu*angstrom^2'), symmetry=1, barrier=(19.1184,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.832034,'amu*angstrom^2'), symmetry=1, barrier=(19.1301,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.831779,'amu*angstrom^2'), symmetry=1, barrier=(19.1242,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.04699,0.0512101,-1.54247e-05,-3.08285e-08,1.96658e-11,8547.91,24.0854], Tmin=(100,'K'), Tmax=(923.393,'K')), NASAPolynomial(coeffs=[19.7336,0.00598008,2.78089e-08,-9.50514e-11,3.79925e-15,3574.16,-72.8225], Tmin=(923.393,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(70.0814,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(CC(C)OJ) + radical(Cds_S)"""),
)
...
species(
    ...
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
    collisionModel = TransportData(shapeIndex=2, epsilon=(4148.33,'J/mol'), sigma=(6.72613,'angstroms'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with Tc=647.96 K, Pc=30.93 bar (from Joback method)"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'CC([O])C=C=O(3211)'],
    products = ['CC([O])C=[C]O(8496)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'CC(=O)C=[C]O(16719)'],
    products = ['CC([O])C=[C]O(8496)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['CH3(17)', 'O=CC=[C]O(7927)'],
    products = ['CC([O])C=[C]O(8496)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction19',
    reactants = ['CH2(S)(23)', '[O]CC=[C]O(976)'],
    products = ['CC([O])C=[C]O(8496)'],
