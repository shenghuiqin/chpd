species(
    ...
    E0 = (-5.45386,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1855,455,950,528.233,528.234,528.436,528.509],'cm^-1')),
        HinderedRotor(inertia=(0.225098,'amu*angstrom^2'), symmetry=1, barrier=(44.6399,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.225279,'amu*angstrom^2'), symmetry=1, barrier=(44.633,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
reaction(
    ...
    products = ['[O]OO[C]=O(394)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(46.7986,'m^3/(mol*s)'), n=2.021, Ea=(406.299,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Od_R;YJ] for rate rule [Od_Cdd-O2d;O2b]
