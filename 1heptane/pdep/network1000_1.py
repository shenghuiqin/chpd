...
species(
    ...
    molecularWeight = (112.213,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.449847,0.0874979,-5.33632e-05,1.67816e-08,-2.17864e-12,18871.5,38.3546], Tmin=(100,'K'), Tmax=(1737.53,'K')), NASAPolynomial(coeffs=[17.6384,0.0458563,-1.7414e-05,2.98828e-09,-1.94002e-13,12585.8,-58.9036], Tmin=(1737.53,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(155.505,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(552.912,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Isobutyl) + radical(Cs_S)"""),
)

species(
    label = '[CH2]C([CH]C)C(C)CC(1498)',
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', '[CH2]C(CC)C(=C)CC(1494)'],
    products = ['[CH2]C(CC)C([CH2])CC(1409)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['C2H5(29)', '[CH2]C(C=C)CC(420)'],
    products = ['[CH2]C(CC)C([CH2])CC(1409)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2]C(CC)C([CH2])CC(1409)'],
    products = ['[CH2]C(CC)C(C)[CH]C(1497)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]C(CC)C([CH2])CC(1409)'],
    products = ['[CH2]C([CH]C)C(C)CC(1498)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]C(CC)C([CH2])CC(1409)'],
    products = ['[CH2]CC(C)C([CH2])CC(1499)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]C(CC)C([CH2])CC(1409)'],
    products = ['[CH2]CC([CH2])C(C)CC(1500)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CH2(19)', '[CH2]C([CH]CC)CC(446)'],
    products = ['[CH2]C(CC)C([CH2])CC(1409)'],
