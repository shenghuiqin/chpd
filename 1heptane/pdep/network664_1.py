...
reaction(
    label = 'reaction13',
    reactants = ['CO(12)', '[CH2]O[CH]C(567)'],
    products = ['C[CH]OC[C]=O(1087)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[O]C[C]=O(113)', 'CHCH3(T)(95)'],
    products = ['C[CH]OC[C]=O(1087)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[C]=O(361)', '[CH2]O[CH]C(567)'],
    products = ['C[CH]OC[C]=O(1087)'],
