...
species(
    ...
    E0 = (207.766,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,3615,1310,387.5,850,1000,3010,987.5,1337.5,450,1655],'cm^-1')),
...
species(
    ...
    molecularWeight = (60.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.75094,0.0145252,3.55422e-05,-6.12353e-08,2.54833e-11,-39934.3,13.5047], Tmin=(100,'K'), Tmax=(953.766,'K')), NASAPolynomial(coeffs=[12.7142,0.00531905,-1.21604e-06,2.71932e-10,-2.64266e-14,-43316.6,-41.8586], Tmin=(953.766,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-332.504,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), label="""HOCH2CHO""", comment="""Thermo library: DFT_QCI_thermo"""),
)
...
species(
    ...
    E0 = (168.638,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,262.903,262.912,262.913,2079.12,2079.14,2079.14,2079.15],'cm^-1')),
        HinderedRotor(inertia=(0.136611,'amu*angstrom^2'), symmetry=1, barrier=(6.70068,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.1366,'amu*angstrom^2'), symmetry=1, barrier=(6.70068,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (60.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.74197,0.0370449,-7.19992e-05,8.06274e-08,-3.26739e-11,20318.6,14.7072], Tmin=(100,'K'), Tmax=(850.879,'K')), NASAPolynomial(coeffs=[-0.386652,0.0280662,-1.44143e-05,2.79304e-09,-1.92599e-13,21708.5,34.3343], Tmin=(850.879,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(168.638,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cs-CsHHH) + group(CsJ2_singlet-CsH)"""),
)
...
species(
    ...
    E0 = (266.034,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3615,1310,387.5,850,1000,316.851,317.342,319.327],'cm^-1')),
        HinderedRotor(inertia=(0.00407827,'amu*angstrom^2'), symmetry=1, barrier=(8.75759,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0040567,'amu*angstrom^2'), symmetry=1, barrier=(8.72321,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.566576,'amu*angstrom^2'), symmetry=1, barrier=(40.5654,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (60.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.35727,0.0399961,-5.9106e-05,5.26436e-08,-1.90803e-11,32051.9,14.6171], Tmin=(100,'K'), Tmax=(789.647,'K')), NASAPolynomial(coeffs=[5.23873,0.0197199,-9.80015e-06,1.90755e-09,-1.33452e-13,31773.9,2.51752], Tmin=(789.647,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(266.034,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(170.447,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsOsHH) + group(CsJ2_singlet-CsH)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['CH2CHOOH(64)'],
    products = ['OH(5)', 'CH2CHO(40)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(2.22e+17,'s^-1'), n=-0.42, Ea=(44622,'cal/mol'), T0=(1,'K')),
)

reaction(
    label = 'reaction2',
    reactants = ['HO2(10)', 'C2H3(30)'],
    products = ['CH2CHOOH(64)'],
    transitionState = 'TS2',
