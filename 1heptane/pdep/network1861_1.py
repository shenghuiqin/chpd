species(
    label = 'CCC[CH]CO[C](C)OO(8906)',
    structure = SMILES('CCC[CH]CO[C](C)OO'),
    E0 = (-68.2913,'kJ/mol'),
    modes = [
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.817952,0.112977,-0.00010337,5.34365e-08,-1.18685e-11,-8045.89,42.1376], Tmin=(100,'K'), Tmax=(1044.38,'K')), NASAPolynomial(coeffs=[12.8415,0.0606613,-2.82324e-05,5.47397e-09,-3.87556e-13,-10899,-24.3545], Tmin=(1044.38,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-68.2913,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(544.598,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJCO) + radical(Cs_P)"""),
)
...
species(
    label = 'CCC=CCO[C](C)OO(11892)',
    structure = SMILES('CCC=CCO[C](C)OO'),
    E0 = (-145.965,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2995,3025,975,1000,1300,1375,400,500,1630,1680,360,370,350,3615,1310,387.5,850,1000,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.465583,0.105289,-9.20333e-05,4.52771e-08,-9.65633e-12,-17400.6,39.4606], Tmin=(100,'K'), Tmax=(1075.49,'K')), NASAPolynomial(coeffs=[11.9444,0.059134,-2.76599e-05,5.37396e-09,-3.80781e-13,-20070,-21.3135], Tmin=(1075.49,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-145.965,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(523.812,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsOsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Cs_P)"""),
)

species(
    label = 'CCCC=CO[C](C)OO(11893)',
    structure = SMILES('CCCC=CO[C](C)OO'),
    E0 = (-191.438,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2995,3025,975,1000,1300,1375,400,500,1630,1680,360,370,350,3615,1310,387.5,850,1000,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (145.176,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.96659,0.11548,-9.29798e-05,3.11795e-08,-2.07103e-12,-22796.4,41.6752], Tmin=(100,'K'), Tmax=(1073.91,'K')), NASAPolynomial(coeffs=[25.9327,0.0352,-1.38615e-05,2.55924e-09,-1.79591e-13,-30151.6,-101.258], Tmin=(1073.91,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-191.438,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(523.812,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(Cs_P)"""),
)

species(
    label = 'C=C(OO)OC[CH]CCC(11894)',
    structure = SMILES('C=C(OO)OC[CH]CCC'),
    E0 = (-89.5876,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (145.176,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.07249,0.114159,-0.000109467,5.70813e-08,-1.23245e-11,-10594.4,39.9599], Tmin=(100,'K'), Tmax=(1097.46,'K')), NASAPolynomial(coeffs=[16.3671,0.0505949,-2.25887e-05,4.30572e-09,-3.02296e-13,-14422.2,-45.7979], Tmin=(1097.46,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-89.5876,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(523.812,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(CCJCO)"""),
)
...
species(
    label = 'CCC[CH]COC(C)=O(11895)',
    structure = SMILES('CCC[CH]COC(C)=O'),
    E0 = (-334.926,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3025,407.5,1350,352.5,200,800,900,1000,1100,1200,1300,1400,1500,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.202079,0.0823769,-4.89962e-05,1.40589e-08,-1.61705e-12,-40122.7,38.1932], Tmin=(100,'K'), Tmax=(1973.54,'K')), NASAPolynomial(coeffs=[21.7351,0.0379146,-1.52026e-05,2.64339e-09,-1.70999e-13,-48781.5,-82.5548], Tmin=(1973.54,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-334.926,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)HHH) + group(Cds-OdCsOs) + radical(CCJCO)"""),
)

species(
    label = 'CC[CH]CCO[C](C)OO(11896)',
    structure = SMILES('CC[CH]CCO[C](C)OO'),
    E0 = (-73.735,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3025,407.5,1350,352.5,3615,1310,387.5,850,1000,360,370,350,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (146.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.040172,0.10557,-5.86483e-05,-7.72501e-08,1.0423e-10,-8739.8,39.6578], Tmin=(100,'K'), Tmax=(483.447,'K')), NASAPolynomial(coeffs=[7.65932,0.0696197,-3.32179e-05,6.43204e-09,-4.51988e-13,-9808.6,4.75388], Tmin=(483.447,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-73.735,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(544.598,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Cs_P) + radical(RCCJCC)"""),
)
...
species(
    label = '[CH2]C(OO)OC[CH]CCC(11897)',
    structure = SMILES('[CH2]C(OO)OC[CH]CCC'),
    E0 = (-59.5751,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (146.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.97079,0.115576,-0.000108311,5.67704e-08,-1.26397e-11,-6991.42,43.9919], Tmin=(100,'K'), Tmax=(1049.65,'K')), NASAPolynomial(coeffs=[13.9203,0.0588287,-2.72163e-05,5.26456e-09,-3.72323e-13,-10117.5,-28.5705], Tmin=(1049.65,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-59.5751,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(544.598,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJCOOH) + radical(CCJCO)"""),
)

species(
    label = 'CCC[CH][CH]OC(C)OO(11898)',
    structure = SMILES('CCC[CH][CH]OC(C)OO'),
    E0 = (-93.0816,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (146.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.30326,0.121059,-0.000118676,6.3833e-08,-1.42871e-11,-11007.8,42.6324], Tmin=(100,'K'), Tmax=(1058.08,'K')), NASAPolynomial(coeffs=[16.1809,0.054962,-2.49735e-05,4.7947e-09,-3.37872e-13,-14707.8,-42.706], Tmin=(1058.08,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-93.0816,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(544.598,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCsJOCs) + radical(CCJCO)"""),
)

species(
    label = 'CCC[CH]COC(C)O[O](11899)',
    structure = SMILES('CCC[CH]COC(C)O[O]'),
    E0 = (-121.533,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (146.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.651426,0.109327,-9.98645e-05,5.33076e-08,-1.23861e-11,-14455.4,41.6135], Tmin=(100,'K'), Tmax=(996.997,'K')), NASAPolynomial(coeffs=[11.2069,0.0617502,-2.82835e-05,5.44259e-09,-3.83706e-13,-16819.9,-15.5603], Tmin=(996.997,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-121.533,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(548.755,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(CCJCO)"""),
)

species(
    label = 'C[CH]CCCO[C](C)OO(11900)',
    structure = SMILES('C[CH]CCCO[C](C)OO'),
    E0 = (-73.747,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (146.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.583008,0.113873,-0.000104408,3.24626e-08,1.44207e-11,-8717.13,41.633], Tmin=(100,'K'), Tmax=(560.409,'K')), NASAPolynomial(coeffs=[8.42338,0.0682758,-3.23794e-05,6.27933e-09,-4.42876e-13,-10020,0.779777], Tmin=(560.409,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-73.747,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(544.598,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJC) + radical(Cs_P)"""),
)

species(
    label = '[CH2]CCCCO[C](C)OO(11901)',
    structure = SMILES('[CH2]CCCCO[C](C)OO'),
    E0 = (-62.947,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (146.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.00874,0.119128,-0.000122341,7.40662e-08,-1.93363e-11,-7398.04,42.1256], Tmin=(100,'K'), Tmax=(900.936,'K')), NASAPolynomial(coeffs=[11.4561,0.0637871,-3.02026e-05,5.88741e-09,-4.17715e-13,-9644.08,-16.7101], Tmin=(900.936,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-62.947,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(544.598,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJ) + radical(Cs_P)"""),
)

species(
    label = '[CH2][C](OO)OCCCCC(11902)',
    structure = SMILES('[CH2][C](OO)OCCCCC'),
    E0 = (-54.2308,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,360,370,350,3615,1310,387.5,850,1000,3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (146.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.13328,0.121404,-0.000126195,7.60398e-08,-1.95409e-11,-6344.81,42.7791], Tmin=(100,'K'), Tmax=(919.149,'K')), NASAPolynomial(coeffs=[12.5251,0.0619628,-2.91874e-05,5.67751e-09,-4.02395e-13,-8855.54,-21.9625], Tmin=(919.149,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-54.2308,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(544.598,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Cs_P) + radical(CJCOOH)"""),
)

species(
    label = 'CC[CH][CH]COC(C)OO(11903)',
    structure = SMILES('CC[CH][CH]COC(C)OO'),
    E0 = (-79.0793,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (146.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.817854,0.115137,-0.000124813,8.72985e-08,-2.70426e-11,-9345.86,44.022], Tmin=(100,'K'), Tmax=(761.644,'K')), NASAPolynomial(coeffs=[8.13508,0.06812,-3.22191e-05,6.25397e-09,-4.41725e-13,-10709.7,3.26663], Tmin=(761.644,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-79.0793,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(544.598,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJCO) + radical(RCCJCC)"""),
)

species(
    label = 'C[CH]C[CH]COC(C)OO(11904)',
    structure = SMILES('C[CH]C[CH]COC(C)OO'),
    E0 = (-79.0913,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (146.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.75896,0.113475,-0.000115185,7.26135e-08,-2.01902e-11,-9348.8,43.9861], Tmin=(100,'K'), Tmax=(842.39,'K')), NASAPolynomial(coeffs=[9.19409,0.0662142,-3.103e-05,6.01362e-09,-4.25034e-13,-11025.7,-2.32454], Tmin=(842.39,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-79.0913,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(544.598,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJCO) + radical(RCCJC)"""),
)

species(
    label = 'CCCCCO[C](C)O[O](11905)',
    structure = SMILES('CCCCCO[C](C)O[O]'),
    E0 = (-116.189,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (146.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.891049,0.116121,-0.000121365,7.75867e-08,-2.15625e-11,-13805.6,40.6732], Tmin=(100,'K'), Tmax=(848.501,'K')), NASAPolynomial(coeffs=[10.0712,0.0644396,-2.99972e-05,5.79458e-09,-4.08715e-13,-15665.8,-10.4117], Tmin=(848.501,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-116.189,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(548.755,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Cs_P) + radical(ROOJ)"""),
)

species(
    label = '[CH2]CC[CH]COC(C)OO(11906)',
    structure = SMILES('[CH2]CC[CH]COC(C)OO'),
    E0 = (-68.2913,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (146.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.817934,0.112976,-0.000103369,5.3436e-08,-1.18684e-11,-8045.89,43.2362], Tmin=(100,'K'), Tmax=(1044.4,'K')), NASAPolynomial(coeffs=[12.8415,0.0606612,-2.82323e-05,5.47395e-09,-3.87555e-13,-10899.1,-23.2563], Tmin=(1044.4,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-68.2913,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(544.598,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJ) + radical(CCJCO)"""),
)
...
species(
    label = 'CCCC=COC(C)OO(11907)',
    structure = SMILES('CCCC=COC(C)OO'),
    E0 = (-396.684,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (146.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.97939,0.114477,-8.16825e-05,1.79886e-08,2.68987e-12,-47480.1,41.0322], Tmin=(100,'K'), Tmax=(1047.22,'K')), NASAPolynomial(coeffs=[25.9305,0.0378348,-1.48206e-05,2.74593e-09,-1.93797e-13,-54968.6,-102.749], Tmin=(1047.22,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-396.684,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(548.755,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH)"""),
)

species(
    label = 'C=C(OO)OCCCCC(11908)',
    structure = SMILES('C=C(OO)OCCCCC'),
    E0 = (-289.49,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (146.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.17646,0.118239,-0.000113854,6.07353e-08,-1.35536e-11,-34634.8,37.8414], Tmin=(100,'K'), Tmax=(1058.14,'K')), NASAPolynomial(coeffs=[15.3951,0.0555976,-2.50577e-05,4.79288e-09,-3.37014e-13,-38141.9,-43.0437], Tmin=(1058.14,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-289.49,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(548.755,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH)"""),
)

species(
    label = 'CCC=CCOC(C)OO(11909)',
    structure = SMILES('CCC=CCOC(C)OO'),
    E0 = (-351.211,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (146.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.517442,0.104907,-8.34895e-05,3.61836e-08,-6.76008e-12,-42083.2,38.945], Tmin=(100,'K'), Tmax=(1209.49,'K')), NASAPolynomial(coeffs=[13.1549,0.0596898,-2.74119e-05,5.27396e-09,-3.71105e-13,-45390.5,-29.6169], Tmin=(1209.49,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-351.211,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(548.755,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsOsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH)"""),
)
...
species(
    label = 'CC[CH]CO[C](C)OO(11910)',
    structure = SMILES('CC[CH]CO[C](C)OO'),
    E0 = (-44.511,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3025,407.5,1350,352.5,3615,1310,387.5,850,1000,360,370,350,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.200695,0.098553,-9.08313e-05,4.71056e-08,-1.04728e-11,-5207.3,37.6753], Tmin=(100,'K'), Tmax=(1044.59,'K')), NASAPolynomial(coeffs=[11.8677,0.0523404,-2.44717e-05,4.7545e-09,-3.36998e-13,-7728.61,-21.0741], Tmin=(1044.59,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-44.511,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(473.925,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJCO) + radical(Cs_P)"""),
)

species(
    label = '[CH2]C(CC)CO[C](C)OO(11911)',
    structure = SMILES('[CH2]C(CC)CO[C](C)OO'),
    E0 = (-68.8053,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (146.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.12484,0.118983,-0.000119857,6.97852e-08,-1.72202e-11,-8096.08,42.2476], Tmin=(100,'K'), Tmax=(958.749,'K')), NASAPolynomial(coeffs=[13.1221,0.0595435,-2.68628e-05,5.12256e-09,-3.59143e-13,-10828,-25.8857], Tmin=(958.749,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-68.8053,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(544.598,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Isobutyl) + radical(Cs_P)"""),
)
...
species(
    ...
    molecularWeight = (146.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.174354,0.0990591,-5.08305e-05,-7.10648e-08,9.13474e-11,-35924.8,40.0593], Tmin=(100,'K'), Tmax=(492.456,'K')), NASAPolynomial(coeffs=[7.1692,0.0674059,-3.10609e-05,5.93029e-09,-4.13797e-13,-36918.8,8.17005], Tmin=(492.456,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-299.715,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(548.755,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsOs) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJCO) + radical(CCOJ)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['CCC[CH]CO[C](C)OO(8906)'],
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'CCC=CCO[C](C)OO(11892)'],
    products = ['CCC[CH]CO[C](C)OO(8906)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'CCCC=CO[C](C)OO(11893)'],
    products = ['CCC[CH]CO[C](C)OO(8906)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', 'C=C(OO)OC[CH]CCC(11894)'],
    products = ['CCC[CH]CO[C](C)OO(8906)'],
    transitionState = 'TS4',
...
reaction(
    ...
    products = ['CCC[CH]CO[C](C)OO(8906)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(0.0323,'m^3/(mol*s)'), n=2.98, Ea=(67.9618,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Od_CO-NdNd;YJ] for rate rule [Od_CO-NdNd;CJ]
Euclidian distance = 1.0
family: R_Addition_MultipleBond
...
reaction(
    label = 'reaction6',
    reactants = ['C2H5(29)', 'C=CCO[C](C)OO(10111)'],
    products = ['CCC[CH]CO[C](C)OO(8906)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['OH(5)', 'CCC[CH]COC(C)=O(11895)'],
    products = ['CCC[CH]CO[C](C)OO(8906)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['CC[CH]CCO[C](C)OO(11896)'],
    products = ['CCC[CH]CO[C](C)OO(8906)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['CCC[CH]CO[C](C)OO(8906)'],
    products = ['CCCC[CH]O[C](C)OO(10153)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]C(OO)OC[CH]CCC(11897)'],
    products = ['CCC[CH]CO[C](C)OO(8906)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CCC[CH]CO[C](C)OO(8906)'],
    products = ['CCC[CH][CH]OC(C)OO(11898)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CCC[CH]COC(C)O[O](11899)'],
    products = ['CCC[CH]CO[C](C)OO(8906)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CCC[CH]CO[C](C)OO(8906)'],
    products = ['C[CH]CCCO[C](C)OO(11900)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]CCCCO[C](C)OO(11901)'],
    products = ['CCC[CH]CO[C](C)OO(8906)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2][C](OO)OCCCCC(11902)'],
    products = ['CCC[CH]CO[C](C)OO(8906)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CCC[CH]CO[C](C)OO(8906)'],
    products = ['CC[CH][CH]COC(C)OO(11903)'],
    transitionState = 'TS16',
    kinetics = Arrhenius(A=(4.8852e+09,'s^-1'), n=0.909873, Ea=(161.496,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [RnH;C_rad_out_NonDe;Cs_H_out_H/NonDeC] for rate rule [R5HJ_3;C_rad_out_NDMustO;Cs_H_out_H/(NonDeC/Cs)]
...
reaction(
    label = 'reaction17',
    reactants = ['CCC[CH]CO[C](C)OO(8906)'],
    products = ['C[CH]C[CH]COC(C)OO(11904)'],
    transitionState = 'TS17',
    kinetics = Arrhenius(A=(4.8852e+09,'s^-1'), n=0.909873, Ea=(161.496,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [RnH;C_rad_out_NonDe;Cs_H_out_H/NonDeC] for rate rule [R6HJ_3;C_rad_out_NDMustO;Cs_H_out_H/NonDeC]
...
reaction(
    label = 'reaction19',
    reactants = ['CCC[CH]CO[C](C)OO(8906)'],
    products = ['[CH2]CC[CH]COC(C)OO(11906)'],
    transitionState = 'TS19',
    kinetics = Arrhenius(A=(1.44378e+09,'s^-1'), n=1.25282, Ea=(169.176,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [RnH;C_rad_out_NonDe;Cs_H_out_2H] for rate rule [R7HJ_3;C_rad_out_NDMustO;Cs_H_out_2H]
Euclidian distance = 2.2360679775
...
reaction(
    label = 'reaction24',
    reactants = ['CH2(S)(23)', 'CC[CH]CO[C](C)OO(11910)'],
    products = ['CCC[CH]CO[C](C)OO(8906)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[CH2]C(CC)CO[C](C)OO(11911)'],
    products = ['CCC[CH]CO[C](C)OO(8906)'],
...
reaction(
    label = 'reaction27',
    reactants = ['CCC[CH]CO[C](C)OO(8906)'],
    products = ['CCC[CH]COC(C)([O])O(11912)'],
...
reaction(
    label = 'reaction28',
    reactants = ['C[C]OO(178)', 'CCC[CH]C[O](1725)'],
    products = ['CCC[CH]CO[C](C)OO(8906)'],
...
reaction(
    label = 'reaction29',
    reactants = ['[CH]CCC(133)', '[CH2]O[C](C)OO(5656)'],
    products = ['CCC[CH]CO[C](C)OO(8906)'],
