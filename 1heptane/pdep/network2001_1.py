...
species(
    ...
    molecularWeight = (88.1051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.17857,0.0704387,-0.000104976,9.70771e-08,-3.55408e-11,-8839,25.0764], Tmin=(100,'K'), Tmax=(839.458,'K')), NASAPolynomial(coeffs=[3.94144,0.0396825,-1.85853e-05,3.50587e-09,-2.39948e-13,-8683.04,15.9225], Tmin=(839.458,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-74.2689,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(C2CsJOH) + radical(CCOJ)"""),
)
...
species(
    label = 'C[CH]C(O)C[O](10836)',
    structure = SMILES('C[CH]C(O)C[O]'),
    E0 = (-50.9947,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,3615,1277.5,1000,1380,1390,370,380,2900,435,263.378,1893.38,1893.38],'cm^-1')),
        HinderedRotor(inertia=(0.00243013,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00243012,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.211797,'amu*angstrom^2'), symmetry=1, barrier=(10.4261,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.211803,'amu*angstrom^2'), symmetry=1, barrier=(10.4262,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (88.1051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.73885,0.053742,-4.84063e-05,2.92112e-08,-8.20226e-12,-6055.36,26.154], Tmin=(100,'K'), Tmax=(816.123,'K')), NASAPolynomial(coeffs=[5.27943,0.036389,-1.65126e-05,3.15851e-09,-2.21732e-13,-6633.27,9.7921], Tmin=(816.123,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-50.9947,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCJCO) + radical(CCOJ)"""),
)

species(
    label = 'CCC(O)[CH][O](10837)',
    structure = SMILES('CCC(O)[CH][O]'),
    E0 = (-70.5989,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
species(
    ...
    molecularWeight = (88.1051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.10481,0.0675669,-8.03701e-05,5.74946e-08,-1.72173e-11,-8271.85,24.2981], Tmin=(100,'K'), Tmax=(804.954,'K')), NASAPolynomial(coeffs=[8.25556,0.0320319,-1.41494e-05,2.64825e-09,-1.82703e-13,-9423.01,-8.64841], Tmin=(804.954,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-69.6133,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(C2CsJOH)"""),
)

species(
    label = '[CH2]CC(O)C[O](10839)',
    structure = SMILES('[CH2]CC(O)C[O]'),
    E0 = (-45.6504,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3615,1277.5,1000,3000,3100,440,815,1455,1000,1380,1390,370,380,2900,435,227.936,1550.02,1550.05],'cm^-1')),
        HinderedRotor(inertia=(0.00323966,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.172336,'amu*angstrom^2'), symmetry=1, barrier=(6.36276,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.17214,'amu*angstrom^2'), symmetry=1, barrier=(6.36371,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.172402,'amu*angstrom^2'), symmetry=1, barrier=(6.36475,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (88.1051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.4225,0.0617853,-7.59646e-05,6.38694e-08,-2.29963e-11,-5402.56,26.5655], Tmin=(100,'K'), Tmax=(781.975,'K')), NASAPolynomial(coeffs=[4.83929,0.037791,-1.7438e-05,3.31605e-09,-2.30083e-13,-5737.69,12.1957], Tmin=(781.975,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-45.6504,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(RCCJ)"""),
)

species(
    label = 'C[CH]C([O])CO(10840)',
    structure = SMILES('C[CH]C([O])CO'),
    E0 = (-46.3391,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (88.1051,'amu'),
...
species(
    label = 'CCC(=O)CO(1117)',
    structure = SMILES('CCC(=O)CO'),
    E0 = (-403.448,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (88.1051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.63004,0.0553284,-4.69869e-05,2.34957e-08,-5.17353e-12,-48440.9,21.4649], Tmin=(100,'K'), Tmax=(1039.46,'K')), NASAPolynomial(coeffs=[7.44063,0.0329683,-1.472e-05,2.80099e-09,-1.96237e-13,-49648.9,-6.79275], Tmin=(1039.46,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-403.448,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-(Cds-O2d)OsHH) + group(Cs-CsHHH) + group(Cds-OdCsCs)"""),
)

species(
    label = 'CCC(O)C=O(10842)',
    structure = SMILES('CCC(O)C=O'),
    E0 = (-396.985,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (88.1051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.57515,0.043264,-5.11614e-06,-2.21947e-08,1.08813e-11,-47650.2,25.1544], Tmin=(100,'K'), Tmax=(1023.92,'K')), NASAPolynomial(coeffs=[12.135,0.0241417,-9.52282e-06,1.78281e-09,-1.26884e-13,-50972.8,-31.7052], Tmin=(1023.92,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-396.985,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsOsH) + group(Cs-CsHHH) + group(Cds-OdCsH)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'CCC(=O)C[O](6170)'],
    products = ['CCC([O])C[O](10704)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction18',
    reactants = ['CH2(S)(23)', 'CC([O])C[O](950)'],
    products = ['CCC([O])C[O](10704)'],
