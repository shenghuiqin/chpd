...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.98125,0.0533667,-2.62154e-05,5.17554e-09,-3.71134e-13,-14178,22.1102], Tmin=(100,'K'), Tmax=(3083.28,'K')), NASAPolynomial(coeffs=[54.9418,-0.00840664,1.09511e-06,-1.36681e-10,1.15229e-14,-48898.8,-291.421], Tmin=(3083.28,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-117.909,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(390.78,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cd-CdCs(CO)) + group(Cds-O2d(Cds-Cds)O2s) + group(Cds-CdsHH) + radical(CCOJ)"""),
)
...
species(
    ...
    molecularWeight = (114.142,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.50144,0.0613879,-3.07652e-05,6.52409e-09,-5.07519e-13,-20102,27.3167], Tmin=(100,'K'), Tmax=(2422.47,'K')), NASAPolynomial(coeffs=[29.2338,0.0212068,-9.35915e-06,1.58921e-09,-9.69073e-14,-35184.5,-134.411], Tmin=(2422.47,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-167.832,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-(Cds-O2d)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdCsOs) + radical(CCOJ) + radical(CCJ(C)CO)"""),
)

species(
    label = 'CC[CH]C(C)C([O])=O(2556)',
    ...
    molecularWeight = (114.142,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.51514,0.0622313,-3.30821e-05,7.86531e-09,-7.31145e-13,-14412.7,28.8348], Tmin=(100,'K'), Tmax=(2344.05,'K')), NASAPolynomial(coeffs=[18.5556,0.0331519,-1.44733e-05,2.57271e-09,-1.66661e-13,-22401.3,-67.8919], Tmin=(2344.05,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-120.504,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-(Cds-O2d)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdCsOs) + radical(CCJCC=O) + radical(CCOJ)"""),
)

species(
    label = '[CH2][C](CCC)C(=O)O(2557)',
    structure = SMILES('[CH2][C](CCC)C(=O)O'),
    E0 = (-183.026,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (114.142,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.773968,0.0750817,-5.77721e-05,2.46378e-08,-4.59487e-12,-21900.5,30.1158], Tmin=(100,'K'), Tmax=(1199.33,'K')), NASAPolynomial(coeffs=[9.71513,0.0452616,-2.04766e-05,3.90676e-09,-2.73549e-13,-24045.2,-14.6454], Tmin=(1199.33,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-183.026,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(407.409,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-(Cds-O2d)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdCsOs) + radical(CCJ(C)CO) + radical(CJC(C)C=O)"""),
)

species(
    label = '[CH2]C([CH]CC)C(=O)O(2558)',
    structure = SMILES('[CH2]C([CH]CC)C(=O)O'),
    E0 = (-135.698,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1277.5,1000,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    ...
    molecularWeight = (114.142,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.57443,0.0563007,-2.56472e-05,4.54006e-09,-2.6098e-13,-15123.9,25.1873], Tmin=(100,'K'), Tmax=(2690.47,'K')), NASAPolynomial(coeffs=[41.4238,0.0087368,-4.81302e-06,7.85967e-10,-4.30151e-14,-39718.3,-207.546], Tmin=(2690.47,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-125.959,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-(Cds-O2d)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdCsOs) + radical(CCOJ) + radical(RCCJC)"""),
)

species(
    label = '[CH2]C(C[CH]C)C(=O)O(2560)',
    ...
    molecularWeight = (114.142,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.24812,0.0719088,-2.9529e-05,-7.07979e-08,8.24637e-11,-16889.4,30.4539], Tmin=(100,'K'), Tmax=(480.568,'K')), NASAPolynomial(coeffs=[6.14154,0.0505478,-2.33119e-05,4.44657e-09,-3.09948e-13,-17583.4,8.10479], Tmin=(480.568,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-141.154,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(407.409,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-(Cds-O2d)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdCsOs) + radical(RCCJC) + radical(CJC(C)C=O)"""),
)

species(
    label = '[CH2]CCC(C)C([O])=O(2561)',
    ...
    molecularWeight = (114.142,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.79434,0.0586543,8.88419e-06,-1.14577e-07,1.0481e-10,-13781.5,27.3778], Tmin=(100,'K'), Tmax=(441.354,'K')), NASAPolynomial(coeffs=[3.4646,0.0563443,-2.68608e-05,5.26779e-09,-3.75778e-13,-14053.9,19.2705], Tmin=(441.354,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-115.159,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-(Cds-O2d)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdCsOs) + radical(CCOJ) + radical(RCCJ)"""),
)

species(
    label = '[CH2]CCC([CH2])C(=O)O(2562)',
    ...
    molecularWeight = (114.142,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.489824,0.0828056,-7.9771e-05,4.57824e-08,-1.14383e-11,-15556.3,32.0517], Tmin=(100,'K'), Tmax=(934.42,'K')), NASAPolynomial(coeffs=[8.98905,0.0464226,-2.13663e-05,4.11323e-09,-2.89899e-13,-17144.6,-8.37559], Tmin=(934.42,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-130.354,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(407.409,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-(Cds-O2d)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdCsOs) + radical(RCCJ) + radical(CJC(C)C=O)"""),
)

species(
    label = '[CH2]C(CCC)[C]1OO1(2563)',
...
species(
    ...
    molecularWeight = (114.142,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.906404,0.0603477,-1.97118e-05,-1.21458e-08,8.39249e-12,6615.18,29.7367], Tmin=(100,'K'), Tmax=(966.118,'K')), NASAPolynomial(coeffs=[10.1667,0.0393026,-1.38892e-05,2.36565e-09,-1.57358e-13,4018.74,-18.7967], Tmin=(966.118,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(54.0188,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(419.881,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Oxetane) + radical(Cs_P) + radical(CCOJ)"""),
)

species(
    label = 'C=C(CCC)C(=O)O(917)',
    structure = SMILES('C=C(CCC)C(=O)O'),
    E0 = (-343.614,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (114.142,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.987863,0.0726717,-6.2324e-05,3.35672e-08,-8.38502e-12,-41224.2,29.3186], Tmin=(100,'K'), Tmax=(901.643,'K')), NASAPolynomial(coeffs=[6.32045,0.049015,-2.29687e-05,4.46883e-09,-3.17027e-13,-42185.8,4.14393], Tmin=(901.643,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-343.614,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cd-CdCs(CO)) + group(Cds-O2d(Cds-Cds)O2s) + group(Cds-CdsHH)"""),
)
...
species(
    ...
    molecularWeight = (114.142,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.26354,0.0436689,3.9089e-05,-8.0103e-08,3.40016e-11,-44816,27.2289], Tmin=(100,'K'), Tmax=(942.034,'K')), NASAPolynomial(coeffs=[13.3989,0.0335538,-1.0747e-05,1.83202e-09,-1.27141e-13,-48940,-40.3458], Tmin=(942.034,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-373.566,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(419.881,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-(Cds-O2d)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdCsOs) + ring(Beta-Propiolactone)"""),
)

species(
    label = '[CH2]C=C([O])OCCC(2566)',
    structure = SMILES('[CH2]C=C([O])OCCC'),
    E0 = (-109.488,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,350,440,435,1725,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,3010,987.5,1337.5,450,1655,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'C=C(CCC)C([O])=O(2554)'],
    products = ['[CH2]C(CCC)C([O])=O(905)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['npropyl(83)', 'tSPC_1553(806)'],
    products = ['[CH2]C(CCC)C([O])=O(905)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]C([CH]CC)C(=O)O(2558)'],
    products = ['[CH2]C(CCC)C([O])=O(905)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]C(CCC)C([O])=O(905)'],
    products = ['[CH2]C(C[CH]C)C(=O)O(2560)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]C(CCC)C([O])=O(905)'],
    products = ['[CH2]CCC([CH2])C(=O)O(2562)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]C(CCC)C([O])=O(905)'],
    products = ['[CH2]C(CCC)[C]1OO1(2563)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CH2(S)(23)', '[CH2]C(CC)C([O])=O(873)'],
    products = ['[CH2]C(CCC)C([O])=O(905)'],
...
reaction(
    label = 'reaction24',
    reactants = ['CH2(19)', 'CCC[CH]C([O])=O(2567)'],
    products = ['[CH2]C(CCC)C([O])=O(905)'],
...
reaction(
    label = 'reaction25',
    reactants = ['O(4)', '[CH2]C([C]=O)CCC(2568)'],
    products = ['[CH2]C(CCC)C([O])=O(905)'],
