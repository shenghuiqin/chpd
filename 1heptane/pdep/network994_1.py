...
species(
    label = 'C[CH]COC=O(3991)',
    structure = SMILES('C[CH]COC=O'),
    E0 = (-231.496,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2782.5,750,1395,475,1775,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,495.448,495.463,495.481],'cm^-1')),
        HinderedRotor(inertia=(0.0121818,'amu*angstrom^2'), symmetry=1, barrier=(2.12141,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.012177,'amu*angstrom^2'), symmetry=1, barrier=(2.12103,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0121729,'amu*angstrom^2'), symmetry=1, barrier=(2.12086,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.272038,'amu*angstrom^2'), symmetry=1, barrier=(47.3837,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (87.0972,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.9451,0.0368755,-4.10327e-07,-1.91237e-08,7.9288e-12,-27761.6,23.6498], Tmin=(100,'K'), Tmax=(1110.13,'K')), NASAPolynomial(coeffs=[9.57076,0.0273312,-1.17444e-05,2.23373e-09,-1.57748e-13,-30559.7,-18.9131], Tmin=(1110.13,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-231.496,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdOsH) + radical(CCJCO)"""),
)

species(
    label = 'CC=CO[CH]O(3992)',
    structure = SMILES('CC=CO[CH]O'),
    E0 = (-186.981,'kJ/mol'),
    modes = [
        ...
        HinderedRotor(inertia=(0.785401,'amu*angstrom^2'), symmetry=1, barrier=(18.0579,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.784729,'amu*angstrom^2'), symmetry=1, barrier=(18.0425,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.784321,'amu*angstrom^2'), symmetry=1, barrier=(18.0331,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.782328,'amu*angstrom^2'), symmetry=1, barrier=(17.9873,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (87.0972,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.33731,0.0724127,-7.324e-05,3.5083e-08,-6.20276e-12,-22312.7,25.947], Tmin=(100,'K'), Tmax=(1630.79,'K')), NASAPolynomial(coeffs=[20.7923,0.00655617,2.39371e-07,-2.30665e-10,1.95299e-14,-27338.7,-80.6052], Tmin=(1630.79,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-186.981,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-(Cds-Cds)HHH) + group(Cs-OsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(OCJO)"""),
)
...
species(
    ...
    molecularWeight = (88.1051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.41322,0.0481247,-1.84233e-05,-6.79323e-09,4.87459e-12,-2817.55,25.5727], Tmin=(100,'K'), Tmax=(1105.83,'K')), NASAPolynomial(coeffs=[11.955,0.0263138,-1.09764e-05,2.06388e-09,-1.45105e-13,-6146.94,-30.8579], Tmin=(1105.83,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-24.262,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsOsHH) + radical(OCOJ) + radical(CCJCO)"""),
)
...
species(
    label = '[CH2]CCO[CH]O(3995)',
    structure = SMILES('[CH2]CCO[CH]O'),
    E0 = (-57.3555,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3025,407.5,1350,352.5,3615,1277.5,1000,3000,3100,440,815,1455,1000,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (88.1051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.9852,0.0693405,-8.00011e-05,5.23284e-08,-1.40608e-11,-6792.35,25.7178], Tmin=(100,'K'), Tmax=(898.854,'K')), NASAPolynomial(coeffs=[10.0573,0.0289691,-1.263e-05,2.3605e-09,-1.63239e-13,-8423.25,-17.0823], Tmin=(898.854,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-57.3555,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsOsHH) + radical(RCCJ) + radical(OCJO)"""),
)

species(
    label = 'C[CH][CH]OCO(3996)',
    structure = SMILES('C[CH][CH]OCO'),
    E0 = (-71.2039,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (88.1051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.648979,0.0570402,-1.0582e-05,-4.43845e-08,2.63551e-11,-8427.68,27.2807], Tmin=(100,'K'), Tmax=(916.065,'K')), NASAPolynomial(coeffs=[22.3968,0.00606501,8.60955e-07,-2.95229e-10,1.791e-14,-14257.8,-85.8071], Tmin=(916.065,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-71.2039,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsOsHH) + radical(CCsJOCs) + radical(CCJCO)"""),
)

species(
    label = 'CCCO[CH][O](3997)',
    structure = SMILES('CCCO[CH][O]'),
    E0 = (-35.204,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (88.1051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.36827,0.0675283,-0.000101157,1.00386e-07,-3.94626e-11,-4148.69,23.0183], Tmin=(100,'K'), Tmax=(817.107,'K')), NASAPolynomial(coeffs=[1.37452,0.0461428,-2.26963e-05,4.38739e-09,-3.05084e-13,-3436.82,27.3518], Tmin=(817.107,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-35.204,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsOsHH) + radical(OCJO) + radical(OCOJ)"""),
)

species(
    label = '[CH2][CH]COCO(3998)',
    structure = SMILES('[CH2][CH]COCO'),
    E0 = (-46.4136,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (88.1051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.98113,0.0508439,-2.2473e-06,-4.51941e-08,2.44342e-11,-5459.24,28.4286], Tmin=(100,'K'), Tmax=(931.809,'K')), NASAPolynomial(coeffs=[19.5067,0.0109872,-1.94432e-06,2.75988e-10,-2.27548e-14,-10633.8,-68.8791], Tmin=(931.809,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-46.4136,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsOsHH) + radical(CCJCO) + radical(RCCJ)"""),
)
...
species(
    label = 'CC=COCO(3999)',
    structure = SMILES('CC=COCO'),
    E0 = (-375.941,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (88.1051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.720026,0.0444335,4.69166e-05,-1.18894e-07,5.66029e-11,-45071.3,22.3442], Tmin=(100,'K'), Tmax=(910.146,'K')), NASAPolynomial(coeffs=[28.5474,-0.00468961,7.27664e-06,-1.52167e-09,9.83014e-14,-53167.5,-125.937], Tmin=(910.146,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-375.941,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-(Cds-Cds)HHH) + group(Cs-OsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH)"""),
)

species(
    label = 'CCCOC=O(4000)',
    structure = SMILES('CCCOC=O'),
    E0 = (-431.398,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (88.1051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.73714,0.042157,-8.82745e-06,-1.05798e-08,4.79075e-12,-51797.6,21.9055], Tmin=(100,'K'), Tmax=(1193.53,'K')), NASAPolynomial(coeffs=[9.75604,0.0304392,-1.31494e-05,2.47434e-09,-1.72307e-13,-54791.3,-22.7223], Tmin=(1193.53,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-431.398,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdOsH)"""),
)

species(
    label = 'C=CCOCO(4001)',
    structure = SMILES('C=CCOCO'),
    E0 = (-318.223,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (88.1051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.16357,0.046126,9.2899e-06,-5.50065e-08,2.72973e-11,-38156.3,24.3484], Tmin=(100,'K'), Tmax=(936.417,'K')), NASAPolynomial(coeffs=[18.7003,0.0123853,-2.60949e-06,4.14832e-10,-3.32488e-14,-43245.7,-68.7419], Tmin=(936.417,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-318.223,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-OsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'C[CH]COC=O(3991)'],
    products = ['C[CH]CO[CH]O(1405)'],
    transitionState = 'TS2',
...
reaction(
    ...
    products = ['C[CH]CO[CH]O(1405)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(4000,'m^3/(mol*s)'), n=1.39, Ea=(41.6459,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Od_CO-NdH;YJ] for rate rule [Od_CO-NdH;CJ]
Euclidian distance = 1.0
family: R_Addition_MultipleBond
Ea raised from 39.4 to 41.6 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction6',
    reactants = ['C[CH]COC[O](3994)'],
    products = ['C[CH]CO[CH]O(1405)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction17',
    reactants = ['HCOH(T)(285)', 'C[CH]C[O](561)'],
    products = ['C[CH]CO[CH]O(1405)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CHCH3(T)(95)', '[CH2]O[CH]O(1809)'],
    products = ['C[CH]CO[CH]O(1405)'],
