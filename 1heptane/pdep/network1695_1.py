...
species(
    label = 'CCC1([O])CC1(O)O[C]=O(9906)',
    structure = SMILES('CCC1([O])CC1(O)O[C]=O'),
    E0 = (-306.262,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (144.125,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.15203,0.0891875,-3.01645e-05,-4.81746e-08,3.12526e-11,-36627.1,33.9094], Tmin=(100,'K'), Tmax=(937.977,'K')), NASAPolynomial(coeffs=[31.5986,0.0102437,-1.02314e-06,1.3002e-10,-1.72508e-14,-45442.1,-136.235], Tmin=(937.977,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-306.262,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cds-OdOsH) + ring(Cyclopropane) + radical(CC(C)2OJ) + radical((O)CJOC)"""),
)
...
species(
    label = 'C=C(O[C]=O)C(=O)CC(9908)',
    structure = SMILES('C=C(O[C]=O)C(=O)CC'),
    E0 = (-289.575,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1855,455,950,2750,2800,2850,1350,1500,750,1050,1375,1000,2950,3100,1380,975,1025,1650,350,440,435,1725,2750,2850,1437.5,1250,1305,750,350,375,552.5,462.5,1710,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.00208986,0.0960361,-0.000130883,1.05006e-07,-3.52105e-11,-34691.2,28.3188], Tmin=(100,'K'), Tmax=(720.877,'K')), NASAPolynomial(coeffs=[9.42666,0.0437231,-2.20414e-05,4.35939e-09,-3.09595e-13,-36050.7,-14.0845], Tmin=(720.877,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-289.575,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-Cd)) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-O2d(Cds-Cds)Cs) + group(Cds-Cds(Cds-O2d)O2s) + group(Cds-CdsHH) + group(Cds-OdOsH) + radical((O)CJOC)"""),
)

species(
    label = 'CCC(=O)C(C)([O])O[C]=O(9909)',
    structure = SMILES('CCC(=O)C(C)([O])O[C]=O'),
    E0 = (-377.323,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,1855,455,950,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,375,552.5,462.5,1710,180,180,180,180,789.668,1411.7,1600,1800,3000,3200],'cm^-1')),
        HinderedRotor(inertia=(0.154631,'amu*angstrom^2'), symmetry=1, barrier=(3.55528,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.154631,'amu*angstrom^2'), symmetry=1, barrier=(3.55528,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.154631,'amu*angstrom^2'), symmetry=1, barrier=(3.55528,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.154631,'amu*angstrom^2'), symmetry=1, barrier=(3.55528,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.154631,'amu*angstrom^2'), symmetry=1, barrier=(3.55528,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (144.125,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.31943,0.104436,-0.00010521,5.25229e-08,-1.01957e-11,-45179.4,37.5921], Tmin=(100,'K'), Tmax=(1264.08,'K')), NASAPolynomial(coeffs=[24.4591,0.0228639,-8.41382e-06,1.47378e-09,-9.95988e-14,-51696.6,-92.8155], Tmin=(1264.08,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-377.323,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(407.409,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdCsCs) + group(Cds-OdOsH) + radical(C=OCOJ) + radical((O)CJOC)"""),
)

species(
    label = '[CH2]C([O])(OC=O)C(=O)CC(9910)',
    structure = SMILES('[CH2]C([O])(OC=O)C(=O)CC'),
    E0 = (-363.262,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2782.5,750,1395,475,1775,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,375,552.5,462.5,1710,180,180,180,180,850.73,1353.64,1600,1800,3000,3200],'cm^-1')),
        HinderedRotor(inertia=(0.156452,'amu*angstrom^2'), symmetry=1, barrier=(3.59714,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156452,'amu*angstrom^2'), symmetry=1, barrier=(3.59714,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156452,'amu*angstrom^2'), symmetry=1, barrier=(3.59714,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156452,'amu*angstrom^2'), symmetry=1, barrier=(3.59714,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156452,'amu*angstrom^2'), symmetry=1, barrier=(3.59714,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (144.125,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.251,0.107003,-0.000112339,5.86065e-08,-1.1934e-11,-43494,38.4682], Tmin=(100,'K'), Tmax=(1202.59,'K')), NASAPolynomial(coeffs=[23.4488,0.0248464,-9.86349e-06,1.79745e-09,-1.24084e-13,-49434.7,-85.2502], Tmin=(1202.59,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-363.262,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(407.409,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdCsCs) + group(Cds-OdOsH) + radical(CJC(C)OC) + radical(C=OCOJ)"""),
)
...
species(
    label = '[CH2]CC(=O)C(C)(O)O[C]=O(9913)',
    structure = SMILES('[CH2]CC(=O)C(C)(O)O[C]=O'),
    E0 = (-409.467,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,1855,455,950,3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2850,1437.5,1250,1305,750,350,375,552.5,462.5,1710,200,800,914.286,1028.57,1142.86,1257.14,1371.43,1485.71,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (144.125,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.69527,0.112377,-0.000120711,6.32032e-08,-1.27519e-11,-49031.5,38.7924], Tmin=(100,'K'), Tmax=(1223.42,'K')), NASAPolynomial(coeffs=[26.6918,0.0195645,-6.91566e-06,1.19365e-09,-8.05372e-14,-55977.4,-103.883], Tmin=(1223.42,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-409.467,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(403.252,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdCsCs) + group(Cds-OdOsH) + radical((O)CJOC) + radical(CJCC=O)"""),
)

species(
    label = '[CH2]CC(=O)C([CH2])(O)OC=O(9914)',
    structure = SMILES('[CH2]CC(=O)C([CH2])(O)OC=O'),
    E0 = (-395.406,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2782.5,750,1395,475,1775,1000,3615,1277.5,1000,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,375,552.5,462.5,1710,200,800,914.286,1028.57,1142.86,1257.14,1371.43,1485.71,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (144.125,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.64416,0.115129,-0.000128402,6.9906e-08,-1.47119e-11,-47345.4,39.732], Tmin=(100,'K'), Tmax=(1170.72,'K')), NASAPolynomial(coeffs=[25.7978,0.0213674,-8.26903e-06,1.49579e-09,-1.03313e-13,-53770.7,-96.9849], Tmin=(1170.72,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-395.406,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(403.252,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdCsCs) + group(Cds-OdOsH) + radical(CJC(C)OC) + radical(CJCC=O)"""),
)
...
species(
    label = '[CH2]C(O)(O[C]=O)C(C)=O(9918)',
    structure = SMILES('[CH2]C(O)(O[C]=O)C(C)=O'),
    E0 = (-385.129,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([375,552.5,462.5,1710,1855,455,950,3615,1277.5,1000,3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,933.333,1066.67,1200,1333.33,1466.67,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.24655,0.0992843,-0.000110481,5.81285e-08,-1.15527e-11,-46117.7,34.9708], Tmin=(100,'K'), Tmax=(1330.98,'K')), NASAPolynomial(coeffs=[26.6173,0.00927155,-1.96763e-06,2.34408e-10,-1.3226e-14,-52979.3,-105.335], Tmin=(1330.98,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-385.129,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(332.579,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)HHH) + group(Cds-OdCsCs) + group(Cds-OdOsH) + radical((O)CJOC) + radical(CJC(C)OC)"""),
)

species(
    label = 'CCC(=O)C[C](O)O[C]=O(9919)',
    structure = SMILES('CCC(=O)C[C](O)O[C]=O'),
    E0 = (-393.021,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1855,455,950,2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,375,552.5,462.5,1710,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (144.125,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.670873,0.113369,-0.000171306,1.50949e-07,-5.35936e-11,-47111.6,37.9631], Tmin=(100,'K'), Tmax=(799.948,'K')), NASAPolynomial(coeffs=[8.67473,0.0510607,-2.52612e-05,4.8945e-09,-3.4103e-13,-48108.4,-1.9228], Tmin=(799.948,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-393.021,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(403.252,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsOsH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsCs) + group(Cds-OdOsH) + radical(Cs_P) + radical((O)CJOC)"""),
)
...
species(
    label = '[CH2]C(O[C]=O)=C(CC)OO(9921)',
    structure = SMILES('[CH2]C(O[C]=O)=C(CC)OO'),
    E0 = (-129.361,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1855,455,950,2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1310,387.5,850,1000,325,375,415,465,420,450,1700,1750,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (144.125,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.75917,0.110577,-0.000136327,9.02438e-08,-2.41749e-11,-15392.2,36.3688], Tmin=(100,'K'), Tmax=(905.34,'K')), NASAPolynomial(coeffs=[15.3107,0.0395778,-1.86935e-05,3.62304e-09,-2.55776e-13,-18301.9,-39.5609], Tmin=(905.34,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-129.361,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(403.252,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-Cd)) + group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsOs) + group(Cds-OdOsH) + radical(C=C(O)CJ) + radical((O)CJOC)"""),
)

species(
    label = '[CH2]C(O)(O[C]=O)C(=C)OC(9922)',
    structure = SMILES('[CH2]C(O)(O[C]=O)C(=C)OC'),
    E0 = (-342.257,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1855,455,950,3615,1277.5,1000,2950,3100,1380,975,1025,1650,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,3000,3100,440,815,1455,1000,180,180,180,180,798.429,1396.94,1600,1800,3000,3200],'cm^-1')),
        HinderedRotor(inertia=(0.154894,'amu*angstrom^2'), symmetry=1, barrier=(3.56132,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.154894,'amu*angstrom^2'), symmetry=1, barrier=(3.56132,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.154894,'amu*angstrom^2'), symmetry=1, barrier=(3.56132,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.154894,'amu*angstrom^2'), symmetry=1, barrier=(3.56132,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.154894,'amu*angstrom^2'), symmetry=1, barrier=(3.56132,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (144.125,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.71294,0.124774,-0.000140728,7.41514e-08,-1.46158e-11,-40902.7,39.4748], Tmin=(100,'K'), Tmax=(1380.2,'K')), NASAPolynomial(coeffs=[33.3196,0.00799234,-3.81727e-07,-1.24366e-10,1.275e-14,-49672.4,-141.709], Tmin=(1380.2,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-342.257,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(403.252,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsHHH) + group(Cs-OsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + group(Cds-OdOsH) + radical(CJC(C)OC) + radical((O)CJOC)"""),
)
...
species(
    label = 'CCC(=O)[C](O)O[C]=O(9924)',
    structure = SMILES('CCC([O])=C(O)O[C]=O'),
    E0 = (-390.312,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (130.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.615077,0.101326,-0.000129152,8.21523e-08,-2.03359e-11,-46777.3,30.3877], Tmin=(100,'K'), Tmax=(995.298,'K')), NASAPolynomial(coeffs=[19.2306,0.021568,-8.95037e-06,1.63935e-09,-1.12582e-13,-50727.8,-65.2629], Tmin=(995.298,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-390.312,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsCs) + group(Cds-OdOsH) + radical((O)CJOC) + radical(C=C(C)OJ)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]C(O)(O[C]=O)C(=O)CC(8749)'],
    products = ['CCC1([O])CC1(O)O[C]=O(9906)'],
    transitionState = 'TS2',
...
reaction(
    ...
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(1.98674e+07,'s^-1'), n=1.31443, Ea=(90.4144,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R5_SS;multiplebond_intra;radadd_intra] for rate rule [R5_SS_CO;carbonylbond_intra_Nd;radadd_intra_CO]
Euclidian distance = 2.44948974278
family: Intra_R_Add_Exocyclic
Ea raised from 86.8 to 90.4 kJ/mol to match endothermicity of reaction."""),
)
...
reaction(
    ...
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(23.3993,'m^3/(mol*s)'), n=2.021, Ea=(177.528,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Od_R;YJ] for rate rule [Od_Cdd-O2d;CJ]
Euclidian distance = 2.2360679775
Multiplied by reaction path degeneracy 2.0
family: R_Addition_MultipleBond
Ea raised from 175.7 to 177.5 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction5',
    reactants = ['C2H5CO(71)', 'C=C(O)O[C]=O(5061)'],
    products = ['[CH2]C(O)(O[C]=O)C(=O)CC(8749)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['OH(5)', 'C=C(O[C]=O)C(=O)CC(9908)'],
    products = ['[CH2]C(O)(O[C]=O)C(=O)CC(8749)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['CCC(=O)C(C)([O])O[C]=O(9909)'],
    products = ['[CH2]C(O)(O[C]=O)C(=O)CC(8749)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]C([O])(OC=O)C(=O)CC(9910)'],
    products = ['[CH2]C(O)(O[C]=O)C(=O)CC(8749)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]CC(=O)C(C)(O)O[C]=O(9913)'],
    products = ['[CH2]C(O)(O[C]=O)C(=O)CC(8749)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]CC(=O)C([CH2])(O)OC=O(9914)'],
    products = ['[CH2]C(O)(O[C]=O)C(=O)CC(8749)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CH3CH2OH(54)', '[CH2]C(=C=O)O[C]=O(9917)'],
    products = ['[CH2]C(O)(O[C]=O)C(=O)CC(8749)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CH2(S)(23)', '[CH2]C(O)(O[C]=O)C(C)=O(9918)'],
    products = ['[CH2]C(O)(O[C]=O)C(=O)CC(8749)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CCC(=O)C[C](O)O[C]=O(9919)'],
    products = ['[CH2]C(O)(O[C]=O)C(=O)CC(8749)'],
...
reaction(
    label = 'reaction20',
    reactants = ['CO(12)', '[CH2]C([O])(O)C(=O)CC(4996)'],
    products = ['[CH2]C(O)(O[C]=O)C(=O)CC(8749)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH2]C(O[C]=O)=C(CC)OO(9921)'],
    products = ['[CH2]C(O)(O[C]=O)C(=O)CC(8749)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH2]C(O)(O[C]=O)C(=C)OC(9922)'],
    products = ['[CH2]C(O)(O[C]=O)C(=O)CC(8749)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[C]=O(361)', '[CH2]C([O])(O)C(=O)CC(4996)'],
    products = ['[CH2]C(O)(O[C]=O)C(=O)CC(8749)'],
...
reaction(
    label = 'reaction26',
    reactants = ['CH2(19)', 'CCC(=O)[C](O)O[C]=O(9924)'],
    products = ['[CH2]C(O)(O[C]=O)C(=O)CC(8749)'],
