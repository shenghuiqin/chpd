...
species(
    label = 'C=C(CCCC)O[O](7767)',
    structure = SMILES('C=C(CCCC)O[O]'),
    E0 = (-2.14132,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2950,3100,1380,975,1025,1650,350,440,435,1725,492.5,1135,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.643204,0.0765959,-6.02464e-05,2.67909e-08,-5.17489e-12,-139.113,31.4775], Tmin=(100,'K'), Tmax=(1175.15,'K')), NASAPolynomial(coeffs=[10.0258,0.0446587,-1.94801e-05,3.66367e-09,-2.5476e-13,-2344.27,-15.3023], Tmin=(1175.15,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-2.14132,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(ROOJ)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'C=C(CCCC)O[O](7767)'],
...
reaction(
    label = 'reaction3',
    reactants = ['CH2CHOO(46)', 'butyl_1(82)'],
    products = ['[CH2]C(CCCC)O[O](245)'],
    transitionState = 'TS3',
...
reaction(
    ...
    products = ['[CH2]C(CCCC)O[O](245)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(88.4,'cm^3/(mol*s)'), n=3.08, Ea=(145.841,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""From training reaction 2808 used for Cds-CsH_Cds-HH;O2b
Exact match found for rate rule [Cds-CsH_Cds-HH;O2b]
Euclidian distance = 0
Multiplied by reaction path degeneracy 2.0
family: R_Addition_MultipleBond
Ea raised from 143.7 to 145.8 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction5',
    reactants = ['[CH2]C(CCCC)O[O](245)'],
    products = ['CCCC[C](C)O[O](587)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]C([CH]CCC)OO(7769)'],
    products = ['[CH2]C(CCCC)O[O](245)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]C(CCC)O[O](259)', 'CH2(S)(23)'],
    products = ['[CH2]C(CCCC)O[O](245)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2]C(CCCC)O[O](245)'],
    products = ['C=C[CH]CCC(371)', 'HO2(10)'],
