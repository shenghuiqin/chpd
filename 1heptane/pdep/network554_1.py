...
species(
    label = '[CH2]OC(=C)C(1688)',
    structure = SMILES('[CH2]OC(=C)C'),
    E0 = (2.25681,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,440,435,1725,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,422.812,422.887],'cm^-1')),
        HinderedRotor(inertia=(0.000942812,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.10517,'amu*angstrom^2'), symmetry=1, barrier=(13.3461,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.105269,'amu*angstrom^2'), symmetry=1, barrier=(13.347,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
species(
    label = '[CH2]C([CH2])OC(1691)',
    structure = SMILES('[CH2]C([CH2])OC'),
    E0 = (150.864,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,2750,2800,2850,1350,1500,750,1050,1375,1000,214,214.137],'cm^-1')),
        HinderedRotor(inertia=(0.175707,'amu*angstrom^2'), symmetry=1, barrier=(5.71539,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.175637,'amu*angstrom^2'), symmetry=1, barrier=(5.71553,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.175581,'amu*angstrom^2'), symmetry=1, barrier=(5.71556,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.175648,'amu*angstrom^2'), symmetry=1, barrier=(5.71596,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (72.1057,'amu'),
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', '[CH2]OC(=C)C(1688)'],
    products = ['[CH2]OC([CH2])C(1006)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['CH3(17)', 'CH2OCHCH2(566)'],
    products = ['[CH2]OC([CH2])C(1006)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction10',
    reactants = ['CH2(S)(23)', '[CH2]CO[CH2](512)'],
    products = ['[CH2]OC([CH2])C(1006)'],
