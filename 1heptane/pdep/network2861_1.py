...
species(
    label = 'CC=CCO[C](C)OO(16287)',
    structure = SMILES('CC=CCO[C](C)OO'),
    E0 = (-123.319,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2995,3025,975,1000,1300,1375,400,500,1630,1680,360,370,350,3615,1310,387.5,850,1000,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0467868,0.0948453,-9.38389e-05,5.54988e-08,-1.44035e-11,-14696.2,34.7218], Tmin=(100,'K'), Tmax=(897.459,'K')), NASAPolynomial(coeffs=[9.15556,0.0542475,-2.59847e-05,5.09437e-09,-3.62686e-13,-16331.2,-8.23742], Tmin=(897.459,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-123.319,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsOsOsH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Cs_P)"""),
)

species(
    label = 'CCC=CO[C](C)OO(16288)',
    structure = SMILES('CCC=CO[C](C)OO'),
    E0 = (-167.658,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2995,3025,975,1000,1300,1375,400,500,1630,1680,360,370,350,3615,1310,387.5,850,1000,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (131.15,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.18415,0.0991235,-7.37849e-05,1.64342e-08,2.79467e-12,-19964.9,36.6198], Tmin=(100,'K'), Tmax=(1025.73,'K')), NASAPolynomial(coeffs=[24.1268,0.0282672,-1.08903e-05,2.02436e-09,-1.44226e-13,-26622.3,-93.2752], Tmin=(1025.73,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-167.658,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsOsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(Cs_P)"""),
)

species(
    label = 'C=C(OO)OC[CH]CC(16289)',
    structure = SMILES('C=C(OO)OC[CH]CC'),
    E0 = (-65.8073,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,2950,3100,1380,975,1025,1650,3615,1310,387.5,850,1000,350,440,435,1725,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.527942,0.0668239,-3.3357e-05,4.75358e-09,6.74526e-13,-37289.5,33.3118], Tmin=(100,'K'), Tmax=(1362.71,'K')), NASAPolynomial(coeffs=[14.0994,0.0391623,-1.63102e-05,2.9704e-09,-2.0117e-13,-42118.7,-40.5106], Tmin=(1362.71,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-311.146,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)HHH) + group(Cds-OdCsOs) + radical(CCJCO)"""),
)

species(
    label = 'C[CH]CCO[C](C)OO(16291)',
    structure = SMILES('C[CH]CCO[C](C)OO'),
    E0 = (-49.9668,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (132.158,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.229583,0.0961832,-7.3495e-05,-1.54912e-08,4.81586e-11,-5886.95,36.5188], Tmin=(100,'K'), Tmax=(516.347,'K')), NASAPolynomial(coeffs=[7.69327,0.0595018,-2.83406e-05,5.4911e-09,-3.8642e-13,-6939.5,2.71552], Tmin=(516.347,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-49.9668,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(473.925,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Cs_P) + radical(RCCJC)"""),
)
...
species(
    ...
    molecularWeight = (132.158,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.353694,0.101154,-9.57769e-05,5.04445e-08,-1.12457e-11,-4152.82,39.5302], Tmin=(100,'K'), Tmax=(1050.43,'K')), NASAPolynomial(coeffs=[12.946,0.0505087,-2.34562e-05,4.54522e-09,-3.21777e-13,-6946.9,-25.2876], Tmin=(1050.43,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-35.7948,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(473.925,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJCOOH) + radical(CCJCO)"""),
)

species(
    label = 'CC[CH][CH]OC(C)OO(16293)',
    structure = SMILES('CC[CH][CH]OC(C)OO'),
    E0 = (-69.3014,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (132.158,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.686751,0.106643,-0.000106159,5.75254e-08,-1.28995e-11,-8169.18,38.1729], Tmin=(100,'K'), Tmax=(1059.49,'K')), NASAPolynomial(coeffs=[15.205,0.0466452,-2.12154e-05,4.07586e-09,-2.87369e-13,-11536.6,-39.4138], Tmin=(1059.49,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-69.3014,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(473.925,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJCO) + radical(CCsJOCs)"""),
)

species(
    label = 'CC[CH]COC(C)O[O](16294)',
    structure = SMILES('CC[CH]COC(C)O[O]'),
    E0 = (-97.7527,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3025,407.5,1350,352.5,492.5,1135,1000,1380,1390,370,380,2900,435,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (132.158,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0349089,0.0949128,-8.73616e-05,4.70254e-08,-1.10118e-11,-11616.8,37.1538], Tmin=(100,'K'), Tmax=(990.381,'K')), NASAPolynomial(coeffs=[10.2382,0.0534206,-2.45178e-05,4.72193e-09,-3.33049e-13,-13651.6,-12.3086], Tmin=(990.381,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-97.7527,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(478.082,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJCO) + radical(ROOJ)"""),
)

species(
    label = '[CH2]CCCO[C](C)OO(16295)',
    structure = SMILES('[CH2]CCCO[C](C)OO'),
    E0 = (-39.1667,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,360,370,350,3615,1310,387.5,850,1000,3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (132.158,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.399232,0.104809,-0.00011022,6.83457e-08,-1.82286e-11,-4559.15,37.6902], Tmin=(100,'K'), Tmax=(884.389,'K')), NASAPolynomial(coeffs=[10.5279,0.0553861,-2.63946e-05,5.15658e-09,-3.66202e-13,-6491.91,-13.6845], Tmin=(884.389,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-39.1667,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(473.925,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJ) + radical(Cs_P)"""),
)

species(
    label = '[CH2][C](OO)OCCCC(16296)',
    structure = SMILES('[CH2][C](OO)OCCCC'),
    E0 = (-30.4505,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,360,370,350,3615,1310,387.5,850,1000,3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (132.158,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.520194,0.107039,-0.000113906,7.00848e-08,-1.83248e-11,-3506.06,38.3311], Tmin=(100,'K'), Tmax=(905.992,'K')), NASAPolynomial(coeffs=[11.5895,0.0535743,-2.53867e-05,4.94839e-09,-3.51025e-13,-5700.31,-18.8956], Tmin=(905.992,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-30.4505,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(473.925,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Cs_P) + radical(CJCOOH)"""),
)

species(
    label = 'C[CH][CH]COC(C)OO(16297)',
    structure = SMILES('C[CH][CH]COC(C)OO'),
    E0 = (-55.3111,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (132.158,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.160982,0.0993134,-0.000103723,6.79089e-08,-1.95936e-11,-6509.44,39.5906], Tmin=(100,'K'), Tmax=(814.724,'K')), NASAPolynomial(coeffs=[8.30654,0.0577395,-2.71776e-05,5.27194e-09,-3.72601e-13,-7889.13,0.475039], Tmin=(814.724,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-55.3111,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(473.925,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJC) + radical(CCJCO)"""),
)

species(
    label = '[CH2]C[CH]COC(C)OO(16298)',
    structure = SMILES('[CH2]C[CH]COC(C)OO'),
    E0 = (-44.511,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (132.158,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.200695,0.098553,-9.08313e-05,4.71056e-08,-1.04728e-11,-5207.3,38.7739], Tmin=(100,'K'), Tmax=(1044.59,'K')), NASAPolynomial(coeffs=[11.8677,0.0523404,-2.44717e-05,4.7545e-09,-3.36998e-13,-7728.61,-19.9755], Tmin=(1044.59,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-44.511,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(473.925,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJ) + radical(CCJCO)"""),
)

species(
    label = 'CCCCO[C](C)O[O](16299)',
    structure = SMILES('CCCCO[C](C)O[O]'),
    E0 = (-92.4084,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (132.158,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.288628,0.101904,-0.000109701,7.25983e-08,-2.08323e-11,-10966.4,36.2619], Tmin=(100,'K'), Tmax=(824.673,'K')), NASAPolynomial(coeffs=[9.18263,0.055966,-2.6145e-05,5.05292e-09,-3.56278e-13,-12528.6,-7.6059], Tmin=(824.673,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-92.4084,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(478.082,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Cs_P) + radical(ROOJ)"""),
)
...
species(
    label = 'CCC=COC(C)OO(16300)',
    structure = SMILES('CCC=COC(C)OO'),
    E0 = (-372.904,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (132.158,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.21445,0.0983131,-6.30908e-05,3.9127e-09,7.32316e-12,-44647.9,36.0404], Tmin=(100,'K'), Tmax=(1013.68,'K')), NASAPolynomial(coeffs=[24.2821,0.0306454,-1.17061e-05,2.17798e-09,-1.55737e-13,-51509.5,-95.6606], Tmin=(1013.68,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-372.904,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(478.082,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsOsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH)"""),
)

species(
    label = 'C=C(OO)OCCCC(16301)',
    structure = SMILES('C=C(OO)OCCCC'),
    E0 = (-265.709,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (132.158,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.559905,0.103823,-0.000101336,5.44266e-08,-1.21657e-11,-31796.2,33.3817], Tmin=(100,'K'), Tmax=(1059.67,'K')), NASAPolynomial(coeffs=[14.4193,0.0472805,-2.12994e-05,4.07399e-09,-2.86507e-13,-34970.8,-39.7525], Tmin=(1059.67,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-265.709,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(478.082,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH)"""),
)

species(
    label = 'CC=CCOC(C)OO(16302)',
    structure = SMILES('CC=CCOC(C)OO'),
    E0 = (-328.566,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (132.158,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.105705,0.0931107,-8.04532e-05,4.00906e-08,-8.83302e-12,-39383.3,33.8133], Tmin=(100,'K'), Tmax=(1031.89,'K')), NASAPolynomial(coeffs=[9.70706,0.0558922,-2.63508e-05,5.13696e-09,-3.64678e-13,-41364.8,-12.809], Tmin=(1031.89,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-328.566,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(478.082,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsOsOsH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH)"""),
)
...
species(
    label = '[CH2]C(C)CO[C](C)OO(16303)',
    structure = SMILES('[CH2]C(C)CO[C](C)OO'),
    E0 = (-48.3722,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (132.158,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.507261,0.104562,-0.000107355,6.35338e-08,-1.58688e-11,-5660.1,37.7836], Tmin=(100,'K'), Tmax=(950.07,'K')), NASAPolynomial(coeffs=[12.1724,0.0511795,-2.30764e-05,4.39683e-09,-3.08055e-13,-8069.49,-22.7393], Tmin=(950.07,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-48.3722,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(473.925,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Cs_P) + radical(Isobutyl)"""),
)
...
species(
    ...
    molecularWeight = (132.158,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.959619,0.0814087,-1.69771e-05,-1.34351e-07,1.44562e-10,-33093.1,35.0552], Tmin=(100,'K'), Tmax=(456.211,'K')), NASAPolynomial(coeffs=[6.55046,0.0584036,-2.68727e-05,5.10352e-09,-3.53932e-13,-33873.9,9.50326], Tmin=(456.211,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-275.935,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(478.082,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsOs) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(CCJCO)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['CC[CH]CO[C](C)OO(11910)'],
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'CC=CCO[C](C)OO(16287)'],
    products = ['CC[CH]CO[C](C)OO(11910)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'CCC=CO[C](C)OO(16288)'],
    products = ['CC[CH]CO[C](C)OO(11910)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', 'C=C(OO)OC[CH]CC(16289)'],
    products = ['CC[CH]CO[C](C)OO(11910)'],
    transitionState = 'TS4',
...
reaction(
    ...
    products = ['CC[CH]CO[C](C)OO(11910)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(0.0323,'m^3/(mol*s)'), n=2.98, Ea=(67.6817,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Od_CO-NdNd;YJ] for rate rule [Od_CO-NdNd;CJ]
Euclidian distance = 1.0
family: R_Addition_MultipleBond
Ea raised from 65.3 to 67.7 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction6',
    reactants = ['CH3(17)', 'C=CCO[C](C)OO(10111)'],
    products = ['CC[CH]CO[C](C)OO(11910)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['OH(5)', 'CC[CH]COC(C)=O(16290)'],
    products = ['CC[CH]CO[C](C)OO(11910)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['CC[CH]CO[C](C)OO(11910)'],
    products = ['C[CH]CCO[C](C)OO(16291)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['CC[CH]CO[C](C)OO(11910)'],
    products = ['CCC[CH]O[C](C)OO(11854)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]C(OO)OC[CH]CC(16292)'],
    products = ['CC[CH]CO[C](C)OO(11910)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CC[CH]CO[C](C)OO(11910)'],
    products = ['CC[CH][CH]OC(C)OO(16293)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CC[CH]COC(C)O[O](16294)'],
    products = ['CC[CH]CO[C](C)OO(11910)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2]CCCO[C](C)OO(16295)'],
    products = ['CC[CH]CO[C](C)OO(11910)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2][C](OO)OCCCC(16296)'],
    products = ['CC[CH]CO[C](C)OO(11910)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CC[CH]CO[C](C)OO(11910)'],
    products = ['C[CH][CH]COC(C)OO(16297)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CC[CH]CO[C](C)OO(11910)'],
    products = ['[CH2]C[CH]COC(C)OO(16298)'],
...
reaction(
    label = 'reaction22',
    reactants = ['CH2(S)(23)', 'C[CH]CO[C](C)OO(8912)'],
    products = ['CC[CH]CO[C](C)OO(11910)'],
...
reaction(
    label = 'reaction23',
    reactants = ['CC[CH]CO[C](C)OO(11910)'],
    products = ['[CH2]C(C)CO[C](C)OO(16303)'],
...
reaction(
    label = 'reaction25',
    reactants = ['CC[CH]CO[C](C)OO(11910)'],
    products = ['CC[CH]COC(C)([O])O(16304)'],
...
reaction(
    label = 'reaction26',
    reactants = ['C[C]OO(178)', 'CC[CH]C[O](1679)'],
    products = ['CC[CH]CO[C](C)OO(11910)'],
...
reaction(
    label = 'reaction27',
    reactants = ['[CH]CC(144)', '[CH2]O[C](C)OO(5656)'],
    products = ['CC[CH]CO[C](C)OO(11910)'],
