...
species(
    label = 'O=[C]CC=CO(5757)',
    structure = SMILES('O=[C]CC=CO'),
    E0 = (-141.971,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,1855,455,950,3615,1277.5,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,180],'cm^-1')),
        HinderedRotor(inertia=(0.90757,'amu*angstrom^2'), symmetry=1, barrier=(20.8668,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.909554,'amu*angstrom^2'), symmetry=1, barrier=(20.9124,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.907632,'amu*angstrom^2'), symmetry=1, barrier=(20.8682,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (85.0813,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.46842,0.0399111,5.88546e-06,-4.66491e-08,2.31089e-11,-16969.7,21.4293], Tmin=(100,'K'), Tmax=(960.335,'K')), NASAPolynomial(coeffs=[18.9099,0.0059207,-1.40346e-06,3.27105e-10,-3.20659e-14,-22102.2,-71.2906], Tmin=(960.335,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-141.971,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-OdCsH) + radical(CCCJ=O)"""),
)
...
species(
    label = 'O=[C]C[CH]CO(5760)',
    structure = SMILES('O=[C]C[CH]CO'),
    E0 = (-27.0682,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,1855,455,950,3615,1277.5,1000,3025,407.5,1350,352.5,354.023,3180.45],'cm^-1')),
        HinderedRotor(inertia=(0.00134656,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.100586,'amu*angstrom^2'), symmetry=1, barrier=(8.93173,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.100924,'amu*angstrom^2'), symmetry=1, barrier=(8.94546,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.100377,'amu*angstrom^2'), symmetry=1, barrier=(8.94168,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.82596,0.0524851,-5.47209e-05,2.73157e-08,-1.73867e-12,-3181.58,25.4922], Tmin=(100,'K'), Tmax=(618.545,'K')), NASAPolynomial(coeffs=[7.07315,0.0266602,-1.17554e-05,2.19837e-09,-1.51625e-13,-3985.8,1.44455], Tmin=(618.545,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-27.0682,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cds-OdCsH) + radical(CCJCO) + radical(CCCJ=O)"""),
)
...
species(
    label = '[CH2]C(O)C[C]=O(1097)',
    structure = SMILES('[CH2]C(O)C[C]=O'),
    E0 = (-28.0241,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,1855,455,950,3615,1277.5,1000,3000,3100,440,815,1455,1000,1380,1390,370,380,2900,435,180],'cm^-1')),
        HinderedRotor(inertia=(0.03978,'amu*angstrom^2'), symmetry=1, barrier=(0.914621,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.282098,'amu*angstrom^2'), symmetry=1, barrier=(6.48598,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.282138,'amu*angstrom^2'), symmetry=1, barrier=(6.4869,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.283967,'amu*angstrom^2'), symmetry=1, barrier=(6.52896,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
...
reaction(
    label = 'reaction20',
    reactants = ['CO(12)', '[CH2]C[CH]O(562)'],
    products = ['O=[C]CC[CH]O(1096)'],
...
reaction(
    label = 'reaction21',
    reactants = ['HCOH(T)(285)', '[CH2]C[C]=O(2129)'],
    products = ['O=[C]CC[CH]O(1096)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[C]=O(361)', '[CH2]C[CH]O(562)'],
    products = ['O=[C]CC[CH]O(1096)'],
