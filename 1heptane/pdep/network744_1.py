...
species(
    label = '[CH]=CC(C)=O(4288)',
    structure = SMILES('[CH]=CC(C)=O'),
    E0 = (120.602,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,3010,987.5,1337.5,450,1655,2750,2800,2850,1350,1500,750,1050,1375,1000,375,552.5,462.5,1710],'cm^-1')),
...
species(
    label = '[CH]=[C]C(C)O(4291)',
    structure = SMILES('[CH]=[C]C(C)O'),
    E0 = (295.609,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,2750,2800,2850,1350,1500,750,1050,1375,1000,3120,650,792.5,1650,3615,1277.5,1000,1380,1390,370,380,2900,435],'cm^-1')),
        HinderedRotor(inertia=(0.142602,'amu*angstrom^2'), symmetry=1, barrier=(10.784,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.14155,'amu*angstrom^2'), symmetry=1, barrier=(10.7902,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.14586,'amu*angstrom^2'), symmetry=1, barrier=(10.7844,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (70.0898,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.76724,0.0438308,-3.60782e-05,1.54152e-08,-2.64393e-12,35638.4,22.2405], Tmin=(100,'K'), Tmax=(1393.88,'K')), NASAPolynomial(coeffs=[11.4757,0.015971,-6.09777e-06,1.07629e-09,-7.2213e-14,32931.8,-27.8215], Tmin=(1393.88,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(295.609,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_P) + radical(Cds_S)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', '[CH]=CC(C)=O(4288)'],
    products = ['[CH]=CC(C)[O](1160)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction15',
    reactants = ['CH2(S)(23)', '[CH]=CC[O](948)'],
    products = ['[CH]=CC(C)[O](1160)'],
