species(
    label = '[CH2]CO[C]=O(788)',
    structure = SMILES('[CH2]CO[C]=O'),
    E0 = (1.65298,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,1855,455,950,202.756,203.183],'cm^-1')),
        HinderedRotor(inertia=(0.30507,'amu*angstrom^2'), symmetry=1, barrier=(8.8338,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0178267,'amu*angstrom^2'), symmetry=1, barrier=(18.7426,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0178258,'amu*angstrom^2'), symmetry=1, barrier=(18.7384,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
species(
    ...
    molecularWeight = (72.0627,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.2682,0.02741,8.96112e-06,-3.49162e-08,1.60192e-11,-35312.1,15.3427], Tmin=(100,'K'), Tmax=(975.347,'K')), NASAPolynomial(coeffs=[12.8622,0.00973855,-3.50249e-06,6.98068e-10,-5.44431e-14,-38604.7,-41.788], Tmin=(975.347,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-294.199,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-Cd)) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(Cds-OdOsH)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]CO[C]=O(788)'],
    products = ['C2H4(21)', 'CO2(13)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'C=CO[C]=O(735)'],
    products = ['[CH2]CO[C]=O(788)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CO2(13)', 'C2H4(T)(94)'],
    products = ['[CH2]CO[C]=O(788)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(46.7986,'m^3/(mol*s)'), n=2.021, Ea=(86.638,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Od_R;YJ] for rate rule [Od_Cdd-O2d;CJ]
Euclidian distance = 2.2360679775
Multiplied by reaction path degeneracy 4.0
family: R_Addition_MultipleBond
Ea raised from 82.1 to 86.6 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction4',
    reactants = ['[CH2]CO[C]=O(788)'],
    products = ['C[CH]O[C]=O(2121)'],
    transitionState = 'TS4',
