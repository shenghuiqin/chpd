...
species(
    ...
    molecularWeight = (74.0355,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.35902,0.0280587,-2.49473e-05,1.1973e-08,-2.17798e-12,23723.4,19.1311], Tmin=(100,'K'), Tmax=(1607.17,'K')), NASAPolynomial(coeffs=[8.13847,0.00822979,-1.35891e-06,8.04104e-11,-1.61239e-16,22568.9,-9.30598], Tmin=(1607.17,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(196.699,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(153.818,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(Cs-CsOsOsOs) + group(Cs-CsHHH) + ring(dioxirane) + radical(CCOJ) + radical(CJCOOH)"""),
)
...
species(
    ...
    molecularWeight = (74.0355,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.96993,0.00499062,6.57241e-05,-9.49154e-08,3.77365e-11,47901.1,18.6961], Tmin=(100,'K'), Tmax=(954.815,'K')), NASAPolynomial(coeffs=[14.4077,0.00191864,1.00457e-07,9.31168e-11,-1.88905e-14,43672.7,-46.6603], Tmin=(954.815,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(397.83,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(153.818,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsOs) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + ring(Cyclobutane) + radical(CJCOOH) + radical(Cs_P)"""),
)
...
species(
    ...
    molecularWeight = (74.0355,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.96452,0.0281389,-4.39256e-05,4.93932e-08,-2.14312e-11,25891.7,14.1934], Tmin=(100,'K'), Tmax=(798.223,'K')), NASAPolynomial(coeffs=[0.887671,0.0251378,-1.30891e-05,2.59476e-09,-1.83167e-13,26650.4,26.4207], Tmin=(798.223,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(215.009,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(157.975,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + ring(12dioxetane) + radical(CCOJ) + radical(Cs_P)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(=O)O[O](124)'],
    products = ['CH2CO(28)', 'O2(S)(4921)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]C(=O)O[O](124)'],
    products = ['[CH2]C1([O])OO1(10750)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(7.785e+11,'s^-1'), n=0.342, Ea=(158.558,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4_S;multiplebond_intra;radadd_intra_O] for rate rule [R4_S_CO;carbonylbond_intra;radadd_intra_O]
Euclidian distance = 1.41421356237
family: Intra_R_Add_Exocyclic
Ea raised from 158.3 to 158.6 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction3',
    reactants = ['O2(2)', 'CH2CO(28)'],
    products = ['[CH2]C(=O)O[O](124)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(22.7518,'m^3/(mol*s)'), n=1.72739, Ea=(107.58,'kJ/mol'), T0=(1,'K'), comment="""Estimated using average of templates [Cd_R;O2b] + [Ck_O;YJ] for rate rule [Ck_O;O2b]
Euclidian distance = 2.0
Multiplied by reaction path degeneracy 2.0
family: R_Addition_MultipleBond
Ea raised from 102.1 to 107.6 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction4',
    reactants = ['O2(2)', 'C=[C][O](173)'],
    products = ['[CH2]C(=O)O[O](124)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2]C(=O)O[O](124)'],
    products = ['[CH2][C]1OOO1(10752)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(1.503e+11,'s^-1'), n=0.221, Ea=(359.69,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [R4_S_CO;carbonyl_intra;radadd_intra_O]
Euclidian distance = 0
family: Intra_R_Add_Endocyclic
Ea raised from 357.4 to 359.7 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction7',
    reactants = ['[CH2]C(=O)O[O](124)'],
    products = ['O(4)', 'oxiranone(9536)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2]C(=O)O[O](124)'],
    products = ['[O][C]1COO1(3581)'],
    transitionState = 'TS13',
    kinetics = Arrhenius(A=(1.03419e+08,'s^-1'), n=1.06803, Ea=(176.986,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4_S_D;doublebond_intra;radadd_intra] for rate rule [R4_S_D;doublebond_intra;radadd_intra_O]
Euclidian distance = 1.0
family: Intra_R_Add_Endocyclic"""),
)
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]C(=O)O[O](124)'],
    products = ['O(4)', 'C=C1OO1(2936)'],
    transitionState = 'TS14',
    kinetics = Arrhenius(A=(2.30161e+09,'s^-1'), n=1.08, Ea=(394.035,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [R2OO_S;Y_rad_intra;OOJ]
Euclidian distance = 0
family: Cyclic_Ether_Formation"""),
)
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]C(=O)O[O](124)'],
    products = ['C=C1OOO1(10747)'],
    transitionState = 'TS15',
    kinetics = Arrhenius(A=(1.62e+12,'s^-1'), n=-0.305, Ea=(179.483,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4_SSS;Y_rad_out;Ypri_rad_out] for rate rule [R4_SSS;O_rad;Opri_rad]
Euclidian distance = 1.41421356237
family: Birad_recombination
Ea raised from 176.3 to 179.5 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction16',
    reactants = ['C=[C]O[O](110)', 'O(4)'],
    products = ['[CH2]C(=O)O[O](124)'],
