species(
    label = 'CC[CH]OC[CH]CCCC(10727)',
    structure = SMILES('CC[CH]OC[CH]CCCC'),
    E0 = (-11.9161,'kJ/mol'),
    modes = [
...
species(
    label = 'CC[CH]OCC=CCCC(10939)',
    structure = SMILES('CC[CH]OCC=CCCC'),
    E0 = (-89.5895,'kJ/mol'),
    modes = [
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.14652,0.114269,-8.8757e-05,3.78719e-08,-6.88377e-12,-10591.1,41.2117], Tmin=(100,'K'), Tmax=(1257.37,'K')), NASAPolynomial(coeffs=[15.1982,0.0622727,-2.67267e-05,4.9829e-09,-3.44516e-13,-14701.3,-41.3853], Tmin=(1257.37,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-89.5895,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(623.585,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(CCsJOCs)"""),
)

species(
    label = 'CC=COC[CH]CCCC(10940)',
    structure = SMILES('CC=COC[CH]CCCC'),
    E0 = (-116.752,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (141.231,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.9027,0.11206,-6.19807e-05,-8.97114e-10,8.72642e-12,-13814,43.1516], Tmin=(100,'K'), Tmax=(1028.47,'K')), NASAPolynomial(coeffs=[23.6096,0.0473835,-1.80394e-05,3.28192e-09,-2.2902e-13,-20888.9,-89.5297], Tmin=(1028.47,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-116.752,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(623.585,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(CCJCO)"""),
)

species(
    label = 'CC[CH]OC=CCCCC(10941)',
    structure = SMILES('CC[CH]OC=CCCCC'),
    E0 = (-121.591,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,3025,407.5,1350,352.5,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,2995,3025,975,1000,1300,1375,400,500,1630,1680,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.18789,0.0957051,-3.88337e-05,-2.24307e-08,1.66742e-11,-9505.98,38.7785], Tmin=(100,'K'), Tmax=(989.132,'K')), NASAPolynomial(coeffs=[23.0489,0.0385058,-1.39842e-05,2.53576e-09,-1.79254e-13,-16297.2,-87.9774], Tmin=(989.132,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-80.7259,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(552.912,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CCJCO)"""),
)

species(
    label = 'CC[CH]OCC[CH]CCC(10942)',
    structure = SMILES('CC[CH]OCC[CH]CCC'),
    E0 = (-17.3598,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2761.11,2772.22,2783.33,2794.44,2805.56,2816.67,2827.78,2838.89,2850,1425,1431.25,1437.5,1443.75,1450,1225,1237.5,1250,1262.5,1275,1270,1287.5,1305,1322.5,1340,700,725,750,775,800,300,325,350,375,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3000,3050,390,425,1340,1360,335,370,180,180,180,180,1600,1673.5,2843.15,3200],'cm^-1')),
        HinderedRotor(inertia=(0.154219,'amu*angstrom^2'), symmetry=1, barrier=(3.54579,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.154219,'amu*angstrom^2'), symmetry=1, barrier=(3.54579,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.154219,'amu*angstrom^2'), symmetry=1, barrier=(3.54579,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.154219,'amu*angstrom^2'), symmetry=1, barrier=(3.54579,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.154219,'amu*angstrom^2'), symmetry=1, barrier=(3.54579,'kJ/mol'), semiclassical=False),
...
species(
    label = 'C[CH]COC[CH]CCCC(10943)',
    structure = SMILES('C[CH]COC[CH]CCCC'),
    E0 = (7.52996,'kJ/mol'),
    modes = [
...
species(
    label = 'CC[CH]O[CH]CCCCC(10927)',
    structure = SMILES('CC[CH]O[CH]CCCCC'),
    E0 = (-31.3621,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (142.239,'amu'),
...
species(
    label = 'CCCC[CH][CH]OCCC(10944)',
    structure = SMILES('CCCC[CH][CH]OCCC'),
    E0 = (-11.9161,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2761.11,2772.22,2783.33,2794.44,2805.56,2816.67,2827.78,2838.89,2850,1425,1431.25,1437.5,1443.75,1450,1225,1237.5,1250,1262.5,1275,1270,1287.5,1305,1322.5,1340,700,725,750,775,800,300,325,350,375,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3000,3050,390,425,1340,1360,335,370,180,180,180,180,1600,1682.67,2818.64,3200],'cm^-1')),
        HinderedRotor(inertia=(0.154225,'amu*angstrom^2'), symmetry=1, barrier=(3.54594,'kJ/mol'), semiclassical=False),
...
species(
    label = 'CC[CH]CCCO[CH]CC(10945)',
    structure = SMILES('CC[CH]CCCO[CH]CC'),
    E0 = (-17.3598,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2761.11,2772.22,2783.33,2794.44,2805.56,2816.67,2827.78,2838.89,2850,1425,1431.25,1437.5,1443.75,1450,1225,1237.5,1250,1262.5,1275,1270,1287.5,1305,1322.5,1340,700,725,750,775,800,300,325,350,375,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3000,3050,390,425,1340,1360,335,370,180,180,180,180,1600,1673.5,2843.15,3200],'cm^-1')),
        HinderedRotor(inertia=(0.154219,'amu*angstrom^2'), symmetry=1, barrier=(3.54579,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2]CCOC[CH]CCCC(10946)',
    structure = SMILES('[CH2]CCOC[CH]CCCC'),
    E0 = (12.8743,'kJ/mol'),
    modes = [
...
species(
    label = 'C[CH]CCCCO[CH]CC(10947)',
    structure = SMILES('C[CH]CCCCO[CH]CC'),
    E0 = (-17.3719,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (142.239,'amu'),
...
species(
    label = 'C[CH][CH]OCCCCCC(10948)',
    structure = SMILES('C[CH][CH]OCCCCCC'),
    E0 = (-11.9161,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2761.11,2772.22,2783.33,2794.44,2805.56,2816.67,2827.78,2838.89,2850,1425,1431.25,1437.5,1443.75,1450,1225,1237.5,1250,1262.5,1275,1270,1287.5,1305,1322.5,1340,700,725,750,775,800,300,325,350,375,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3000,3050,390,425,1340,1360,335,370,180,180,180,180,1600,1682.67,2818.64,3200],'cm^-1')),
        HinderedRotor(inertia=(0.154225,'amu*angstrom^2'), symmetry=1, barrier=(3.54594,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2]CCCCCO[CH]CC(10949)',
    structure = SMILES('[CH2]CCCCCO[CH]CC'),
    E0 = (-6.57178,'kJ/mol'),
    modes = [
...
species(
    label = 'CCC[CH][CH]COCCC(10950)',
    structure = SMILES('CCC[CH][CH]COCCC'),
    E0 = (2.08621,'kJ/mol'),
    modes = [
...
species(
    label = 'CC[CH]C[CH]COCCC(10951)',
    structure = SMILES('CC[CH]C[CH]COCCC'),
    E0 = (2.08621,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2761.11,2772.22,2783.33,2794.44,2805.56,2816.67,2827.78,2838.89,2850,1425,1431.25,1437.5,1443.75,1450,1225,1237.5,1250,1262.5,1275,1270,1287.5,1305,1322.5,1340,700,725,750,775,800,300,325,350,375,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3000,3050,390,425,1340,1360,335,370,180,180,180,180,1600,1664.55,2857.07,3200],'cm^-1')),
        HinderedRotor(inertia=(0.154029,'amu*angstrom^2'), symmetry=1, barrier=(3.54143,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2]C[CH]OCCCCCC(10952)',
    structure = SMILES('[CH2]C[CH]OCCCCCC'),
    E0 = (-6.57178,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2759.09,2768.18,2777.27,2786.36,2795.45,2804.55,2813.64,2822.73,2831.82,2840.91,2850,1425,1430,1435,1440,1445,1450,1225,1235,1245,1255,1265,1275,1270,1284,1298,1312,1326,1340,700,720,740,760,780,800,300,320,340,360,380,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,3025,407.5,1350,352.5,180,180,180,180,1600,1645.15,2858.03,3200],'cm^-1')),
        HinderedRotor(inertia=(0.153323,'amu*angstrom^2'), symmetry=1, barrier=(3.52521,'kJ/mol'), semiclassical=False),
...
species(
    label = 'C[CH]CC[CH]COCCC(10953)',
    structure = SMILES('C[CH]CC[CH]COCCC'),
    E0 = (2.07419,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2761.11,2772.22,2783.33,2794.44,2805.56,2816.67,2827.78,2838.89,2850,1425,1431.25,1437.5,1443.75,1450,1225,1237.5,1250,1262.5,1275,1270,1287.5,1305,1322.5,1340,700,725,750,775,800,300,325,350,375,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3000,3050,390,425,1340,1360,335,370,200,800,933.333,1066.67,1200,1333.33,1466.67,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2]CCC[CH]COCCC(10954)',
    structure = SMILES('[CH2]CCC[CH]COCCC'),
    E0 = (12.8743,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2759.09,2768.18,2777.27,2786.36,2795.45,2804.55,2813.64,2822.73,2831.82,2840.91,2850,1425,1430,1435,1440,1445,1450,1225,1235,1245,1255,1265,1275,1270,1284,1298,1312,1326,1340,700,720,740,760,780,800,300,320,340,360,380,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,3025,407.5,1350,352.5,200,800,933.333,1066.67,1200,1333.33,1466.67,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'CCCCC=COCCC(10955)',
    structure = SMILES('CCCCC=COCCC'),
    E0 = (-315.519,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (142.239,'amu'),
...
species(
    label = 'CC=COCCCCCC(10956)',
    structure = SMILES('CC=COCCCCCC'),
    E0 = (-316.654,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (142.239,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.13322,0.117661,-7.1761e-05,9.75033e-09,4.55604e-12,-37849.1,41.4846], Tmin=(100,'K'), Tmax=(1060.56,'K')), NASAPolynomial(coeffs=[23.4598,0.0509968,-1.97105e-05,3.58112e-09,-2.48179e-13,-44957.1,-91.4095], Tmin=(1060.56,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-316.654,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(648.529,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH)"""),
)

species(
    label = 'CCCC=CCOCCC(10957)',
    structure = SMILES('CCCC=CCOCCC'),
    E0 = (-270.046,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (142.239,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.79466,0.106809,-6.84012e-05,2.26012e-08,-3.16717e-12,-32308.8,40.4876], Tmin=(100,'K'), Tmax=(1552.89,'K')), NASAPolynomial(coeffs=[15.6148,0.0645412,-2.75724e-05,5.07308e-09,-3.45315e-13,-37405.2,-45.9006], Tmin=(1552.89,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-270.046,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(648.529,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH)"""),
)
...
species(
    label = '[CH2]C(CCC)CO[CH]CC(10958)',
    structure = SMILES('[CH2]C(CCC)CO[CH]CC'),
    E0 = (-12.4301,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (142.239,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.69625,0.126652,-0.000112004,5.65916e-08,-1.20809e-11,-1291.03,43.6085], Tmin=(100,'K'), Tmax=(1100.11,'K')), NASAPolynomial(coeffs=[15.5041,0.0641119,-2.67322e-05,4.9173e-09,-3.38051e-13,-5075.53,-41.0146], Tmin=(1100.11,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-12.4301,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(644.372,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCsJOCs) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]C(C)OC[CH]CCCC(10959)',
    structure = SMILES('[CH2]C(C)OC[CH]CCCC'),
    E0 = (7.58707,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,3025,407.5,1350,352.5,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
reaction(
    label = 'reaction1',
    reactants = ['CC[CH]OC[CH]CCCC(10727)'],
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'CC[CH]OCC=CCCC(10939)'],
    products = ['CC[CH]OC[CH]CCCC(10727)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'CC=COC[CH]CCCC(10940)'],
    products = ['CC[CH]OC[CH]CCCC(10727)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', 'CC[CH]OC=CCCCC(10941)'],
    products = ['CC[CH]OC[CH]CCCC(10727)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['npropyl(83)', 'C=CCO[CH]CC(10627)'],
    products = ['CC[CH]OC[CH]CCCC(10727)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['CH3(17)', 'C=COC[CH]CCCC(2288)'],
    products = ['CC[CH]OC[CH]CCCC(10727)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['CC[CH]OCC[CH]CCC(10942)'],
    products = ['CC[CH]OC[CH]CCCC(10727)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['C[CH]COC[CH]CCCC(10943)'],
    products = ['CC[CH]OC[CH]CCCC(10727)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['CC[CH]OC[CH]CCCC(10727)'],
    products = ['CC[CH]O[CH]CCCCC(10927)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CCCC[CH][CH]OCCC(10944)'],
    products = ['CC[CH]OC[CH]CCCC(10727)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CC[CH]CCCO[CH]CC(10945)'],
    products = ['CC[CH]OC[CH]CCCC(10727)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2]CCOC[CH]CCCC(10946)'],
    products = ['CC[CH]OC[CH]CCCC(10727)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CC[CH]OC[CH]CCCC(10727)'],
    products = ['C[CH]CCCCO[CH]CC(10947)'],
...
reaction(
    label = 'reaction15',
    reactants = ['C[CH][CH]OCCCCCC(10948)'],
    products = ['CC[CH]OC[CH]CCCC(10727)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]CCCCCO[CH]CC(10949)'],
    products = ['CC[CH]OC[CH]CCCC(10727)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CCC[CH][CH]COCCC(10950)'],
    products = ['CC[CH]OC[CH]CCCC(10727)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CC[CH]C[CH]COCCC(10951)'],
    products = ['CC[CH]OC[CH]CCCC(10727)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2]C[CH]OCCCCCC(10952)'],
    products = ['CC[CH]OC[CH]CCCC(10727)'],
...
reaction(
    label = 'reaction20',
    reactants = ['C[CH]CC[CH]COCCC(10953)'],
    products = ['CC[CH]OC[CH]CCCC(10727)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH2]CCC[CH]COCCC(10954)'],
    products = ['CC[CH]OC[CH]CCCC(10727)'],
...
reaction(
    label = 'reaction26',
    reactants = ['CH2(S)(23)', 'CC[CH]OC[CH]CCC(10733)'],
    products = ['CC[CH]OC[CH]CCCC(10727)'],
...
reaction(
    label = 'reaction27',
    reactants = ['CH2(S)(23)', 'C[CH]OC[CH]CCCC(1209)'],
    products = ['CC[CH]OC[CH]CCCC(10727)'],
...
reaction(
    label = 'reaction28',
    reactants = ['[CH2]C(CCC)CO[CH]CC(10958)'],
    products = ['CC[CH]OC[CH]CCCC(10727)'],
...
reaction(
    label = 'reaction29',
    reactants = ['[CH2]C(C)OC[CH]CCCC(10959)'],
    products = ['CC[CH]OC[CH]CCCC(10727)'],
...
reaction(
    label = 'reaction31',
    reactants = ['[CH]CC(144)', 'CCCC[CH]C[O](1762)'],
    products = ['CC[CH]OC[CH]CCCC(10727)'],
...
reaction(
    label = 'reaction32',
    reactants = ['[CH]CCCC(141)', '[CH2]O[CH]CC(1682)'],
    products = ['CC[CH]OC[CH]CCCC(10727)'],
