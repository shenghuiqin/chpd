species(
    label = 'CC=CC[C]=O(2428)',
    structure = SMILES('CC=CC[C]=O'),
    E0 = (30.7963,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,1855,455,950,2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,386.854],'cm^-1')),
        HinderedRotor(inertia=(0.111628,'amu*angstrom^2'), symmetry=1, barrier=(11.856,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.111623,'amu*angstrom^2'), symmetry=1, barrier=(11.8559,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.11164,'amu*angstrom^2'), symmetry=1, barrier=(11.8561,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (83.1085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.83002,0.0398037,-9.11516e-06,-1.05208e-08,4.83662e-12,3788.49,22.0946], Tmin=(100,'K'), Tmax=(1207.67,'K')), NASAPolynomial(coeffs=[11.1225,0.0255306,-1.18873e-05,2.32623e-09,-1.65551e-13,340.462,-29.4725], Tmin=(1207.67,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(30.7963,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-OdCsH) + radical(CCCJ=O)"""),
)
...
species(
    label = 'C[CH]C1CC1=O(24129)',
    structure = SMILES('C[CH]C1CC1=O'),
    E0 = (148.379,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (83.1085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.86409,0.036523,8.45292e-06,-3.62893e-08,1.64375e-11,17932.1,21.0519], Tmin=(100,'K'), Tmax=(971.257,'K')), NASAPolynomial(coeffs=[11.4864,0.0219523,-7.7428e-06,1.38982e-09,-9.81968e-14,14881.1,-31.1737], Tmin=(971.257,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(148.379,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)CsCsH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsCs) + ring(cyclopropanone) + radical(CCJCC=O)"""),
)
...
species(
    label = 'CC=C[CH][C]=O(24133)',
    structure = SMILES('C[CH]C=C[C]=O'),
    E0 = (161.724,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,1855,455,950,2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,204.404],'cm^-1')),
        HinderedRotor(inertia=(0.565615,'amu*angstrom^2'), symmetry=1, barrier=(16.765,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.565482,'amu*angstrom^2'), symmetry=1, barrier=(16.7649,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.565712,'amu*angstrom^2'), symmetry=1, barrier=(16.7665,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (82.1005,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.99911,0.0478572,-3.55846e-05,1.33834e-08,-2.13732e-12,19519.3,18.7486], Tmin=(100,'K'), Tmax=(1380,'K')), NASAPolynomial(coeffs=[9.08188,0.0273272,-1.32691e-05,2.60279e-09,-1.8429e-13,17564.5,-17.7028], Tmin=(1380,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(161.724,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cd-Cd(CO)H) + group(Cds-O2d(Cds-Cds)H) + radical(C=CCJ=O) + radical(Allyl_S)"""),
)
...
species(
    label = 'CC1[CH]CC1=O(24136)',
    structure = SMILES('CC1[CH]CC1=O'),
    E0 = (54.4318,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (83.1085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.52163,0.0175299,5.87415e-05,-8.39246e-08,3.19027e-11,6613.27,20.6742], Tmin=(100,'K'), Tmax=(976.257,'K')), NASAPolynomial(coeffs=[10.157,0.0238642,-8.79148e-06,1.6631e-09,-1.22291e-13,3329.76,-25.1601], Tmin=(976.257,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(54.4318,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(303.478,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)CsCsH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsCs) + ring(Cyclobutanone) + radical(CCJCC=O)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['m1_allyl(362)', 'CO(12)'],
    products = ['CC=CC[C]=O(2428)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(1230.59,'m^3/(mol*s)'), n=1.0523, Ea=(28.1395,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [COm;C_pri_rad] for rate rule [COm;C_rad/H2/Cd]
Euclidian distance = 1.0
family: R_Addition_COm
Ea raised from 25.6 to 28.1 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction2',
    reactants = ['CC=CC[C]=O(2428)'],
    products = ['C[CH]C1CC1=O(24129)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(1.68e+09,'s^-1'), n=0.84, Ea=(117.582,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2500,'K'), comment="""Estimated using template [R4_S_D;doublebond_intra_HNd_pri;radadd_intra] for rate rule [R4_S_D;doublebond_intra_HNd_pri;radadd_intra_CO]
Euclidian distance = 1.0
family: Intra_R_Add_Exocyclic
Ea raised from 117.4 to 117.6 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'CC=CC=C=O(24130)'],
    products = ['CC=CC[C]=O(2428)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CH2CO(28)', 'CH3CHCH(76)'],
    products = ['CC=CC[C]=O(2428)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(0.0453747,'m^3/(mol*s)'), n=2.17401, Ea=(31.6558,'kJ/mol'), T0=(1,'K'), comment="""Estimated using average of templates [Cds_Cdd;CdsJ-H] + [Cds-HH_Ck;CJ] for rate rule [Cds-HH_Ck;CdsJ-H]
...
reaction(
    label = 'reaction9',
    reactants = ['C=[C][O](173)', 'CH3CHCH(76)'],
    products = ['CC=CC[C]=O(2428)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(3)', 'CC=C[CH][C]=O(24133)'],
    products = ['CC=CC[C]=O(2428)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CH3(17)', '[CH]=CC[C]=O(1081)'],
    products = ['CC=CC[C]=O(2428)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(3)', 'C=C[CH]C[C]=O(20119)'],
    products = ['CC=CC[C]=O(2428)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(3)', 'CC=[C]C[C]=O(24134)'],
    products = ['CC=CC[C]=O(2428)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(3)', 'C[C]=CC[C]=O(24135)'],
    products = ['CC=CC[C]=O(2428)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CC=CC[C]=O(2428)'],
    products = ['CC1[CH]CC1=O(24136)'],
    transitionState = 'TS15',
    kinetics = Arrhenius(A=(1.61e+08,'s^-1'), n=0.96, Ea=(123.01,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4_S_D;doublebond_intra_pri_HNd_Cs;radadd_intra] for rate rule [R4_S_D;doublebond_intra_pri_HNd_Cs;radadd_intra_CO]
Euclidian distance = 1.0
...
reaction(
    label = 'reaction16',
    reactants = ['CH2(S)(23)', 'C=CC[C]=O(2390)'],
    products = ['CC=CC[C]=O(2428)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[C]=O(361)', 'm1_allyl(362)'],
    products = ['CC=CC[C]=O(2428)'],
