...
species(
    label = 'O[CH][CH]OO(10756)',
    structure = SMILES('O[CH][CH]OO'),
    E0 = (23.9869,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3050,390,425,1340,1360,335,370,3615,1310,387.5,850,1000,3615,1277.5,1000,180],'cm^-1')),
        HinderedRotor(inertia=(0.00434402,'amu*angstrom^2'), symmetry=1, barrier=(11.2415,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.488565,'amu*angstrom^2'), symmetry=1, barrier=(11.2331,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.06421,'amu*angstrom^2'), symmetry=1, barrier=(47.4603,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.06006,'amu*angstrom^2'), symmetry=1, barrier=(47.3648,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (76.0514,'amu'),
...
species(
    ...
    E0 = (61.1095,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3615,1310,387.5,850,1000,3025,407.5,1350,352.5,180,1219.25],'cm^-1')),
        HinderedRotor(inertia=(0.268279,'amu*angstrom^2'), symmetry=1, barrier=(6.16827,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.35845,'amu*angstrom^2'), symmetry=1, barrier=(54.2254,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.267519,'amu*angstrom^2'), symmetry=1, barrier=(6.15078,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (76.0514,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.77805,0.0588227,-0.000109181,1.07838e-07,-3.98721e-11,7420.22,19.6674], Tmin=(100,'K'), Tmax=(859.752,'K')), NASAPolynomial(coeffs=[3.55188,0.0274104,-1.39696e-05,2.67785e-09,-1.82878e-13,7971.16,16.3556], Tmin=(859.752,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(61.1095,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + radical(CCsJOH) + radical(CCOJ)"""),
)
...
species(
    ...
    molecularWeight = (76.0514,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.61752,0.0293608,-1.72906e-05,4.78391e-09,-5.28718e-13,-25921.6,13.2054], Tmin=(100,'K'), Tmax=(2016.29,'K')), NASAPolynomial(coeffs=[10.1473,0.0144228,-6.17767e-06,1.10954e-09,-7.31323e-14,-28958,-28.402], Tmin=(2016.29,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-215.942,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + ring(12dioxetane)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[O]OC[CH]O(120)'],
    products = ['CH2CHOH(42)', 'O2(S)(4921)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'vinoxyperoxy(408)'],
    products = ['[O]OC[CH]O(120)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['O2(2)', 'CH2CHOH(42)'],
    products = ['[O]OC[CH]O(120)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(0.000317021,'m^3/(mol*s)'), n=2.89667, Ea=(134.756,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Cds-HH_Cds;O2b] for rate rule [Cds-HH_Cds-OsH;O2b]
Euclidian distance = 1.0
Multiplied by reaction path degeneracy 2.0
family: R_Addition_MultipleBond
Ea raised from 132.2 to 134.8 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction5',
    reactants = ['[O]OC[CH]O(120)'],
    products = ['[O]CCO[O](118)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction15',
    reactants = ['HCOH(T)(285)', '[CH2]O[O](92)'],
    products = ['[O]OC[CH]O(120)'],
