species(
    label = '[CH2]CC([CH2])O(1033)',
    structure = SMILES('[CH2]CC([CH2])O'),
    E0 = (100.779,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3615,1277.5,1000,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,1380,1390,370,380,2900,435,262.529],'cm^-1')),
        HinderedRotor(inertia=(0.00244598,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0927525,'amu*angstrom^2'), symmetry=1, barrier=(4.5364,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0927524,'amu*angstrom^2'), symmetry=1, barrier=(4.53637,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0927526,'amu*angstrom^2'), symmetry=1, barrier=(4.53643,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (72.1057,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.66723,0.053122,-4.94757e-05,2.65841e-08,-6.02731e-12,12203.4,21.2958], Tmin=(100,'K'), Tmax=(1040.1,'K')), NASAPolynomial(coeffs=[8.5478,0.0266609,-1.13144e-05,2.12422e-09,-1.48104e-13,10772.1,-12.1695], Tmin=(1040.1,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(100.779,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo library: CBS_QB3_1dHR + radical(RCCJ) + radical(CJCO)"""),
)
...
species(
    ...
    molecularWeight = (72.1057,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.53773,0.0582363,-7.267e-05,5.81357e-08,-1.96081e-11,8000.81,20.5475], Tmin=(100,'K'), Tmax=(781.309,'K')), NASAPolynomial(coeffs=[6.32505,0.0305865,-1.35568e-05,2.55152e-09,-1.76302e-13,7348.59,-0.753609], Tmin=(781.309,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(65.8176,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo library: CBS_QB3_1dHR + radical(RCCJ) + radical(C2CsJOH)"""),
)
...
species(
    ...
    molecularWeight = (72.1057,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.75069,0.0458429,-3.19987e-05,1.18485e-08,-1.81115e-12,10799.1,22.8558], Tmin=(100,'K'), Tmax=(1507.61,'K')), NASAPolynomial(coeffs=[10.565,0.0224566,-8.73026e-06,1.55913e-09,-1.04898e-13,8141.36,-23.2867], Tmin=(1507.61,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(89.0918,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo library: CBS_QB3_1dHR + radical(RCCJ) + radical(CCJCO)"""),
)

species(
    label = '[CH2][C](O)CC(2451)',
    ...
    molecularWeight = (72.1057,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.32783,0.0629358,-8.28188e-05,6.60942e-08,-2.17255e-11,8771.14,20.1478], Tmin=(100,'K'), Tmax=(800.006,'K')), NASAPolynomial(coeffs=[7.45991,0.0289001,-1.26734e-05,2.36606e-09,-1.62415e-13,7898.02,-7.39258], Tmin=(800.006,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(72.1603,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo library: CBS_QB3_1dHR + radical(C2CsJOH) + radical(CJCO)"""),
)
...
species(
    ...
    molecularWeight = (72.1057,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.64973,0.0390057,8.27856e-06,-4.40005e-08,2.13547e-11,-27696.3,18.5711], Tmin=(100,'K'), Tmax=(941.393,'K')), NASAPolynomial(coeffs=[14.7945,0.0149749,-4.13486e-06,6.97228e-10,-5.09978e-14,-31581.2,-51.54], Tmin=(941.393,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-231.08,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH)"""),
)
...
species(
    label = 'OC1CCC1(1034)',
    structure = SMILES('OC1CCC1'),
    E0 = (-158.597,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (72.1057,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.534,0.0153602,6.76093e-05,-9.65706e-08,3.73972e-11,-19006.8,16.7916], Tmin=(100,'K'), Tmax=(960.452,'K')), NASAPolynomial(coeffs=[11.5578,0.0203926,-6.80295e-06,1.27585e-09,-9.60547e-14,-22705.7,-36.611], Tmin=(960.452,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-158.597,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(303.478,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + ring(Cyclobutane)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]CC([CH2])O(1033)'],
    products = ['C2H4(21)', 'CH2CHOH(42)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', '[CH2]CC(=C)O(2448)'],
    products = ['[CH2]CC([CH2])O(1033)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', '[CH2]C(O)C=C(2449)'],
    products = ['[CH2]CC([CH2])O(1033)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CH2CHOH(42)', 'C2H4(T)(94)'],
    products = ['[CH2]CC([CH2])O(1033)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[CH2][CH]O(284)', 'C2H4(21)'],
    products = ['[CH2]CC([CH2])O(1033)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2][CH]O(284)', 'C2H4(T)(94)'],
    products = ['[CH2]CC([CH2])O(1033)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CH2(19)', '[CH2]C[CH]O(562)'],
    products = ['[CH2]CC([CH2])O(1033)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CH2(19)', '[CH2]C([CH2])O(2453)'],
    products = ['[CH2]CC([CH2])O(1033)'],
