species(
    ...
    E0 = (385.577,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,3100,1380,975,1025,1650,1685,370,180,725.101,728.545,729.935,3364.23],'cm^-1')),
        HinderedRotor(inertia=(0.034399,'amu*angstrom^2'), symmetry=1, barrier=(12.9384,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.216388,'amu*angstrom^2'), symmetry=1, barrier=(4.97518,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
species(
    ...
    E0 = (377.35,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2175,525,750,770,3400,2100,542.284,724.653,730.038,736.995],'cm^-1')),
        HinderedRotor(inertia=(0.645487,'amu*angstrom^2'), symmetry=1, barrier=(14.841,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.55753,'amu*angstrom^2'), symmetry=1, barrier=(35.8106,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (73.0275,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.28702,0.0328616,-3.85594e-05,2.1339e-08,-4.4326e-12,45450.5,17.8911], Tmin=(100,'K'), Tmax=(1297.9,'K')), NASAPolynomial(coeffs=[11.2255,0.00250289,-2.24408e-07,-2.06553e-11,3.12267e-15,43367.1,-26.6501], Tmin=(1297.9,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(377.35,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(124.717,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCt) + group(O2s-OsOs) + group(O2s-OsH) + group(Ct-CtOs) + group(Ct-CtH) + radical(ROOJ)"""),
)
...
species(
    label = '[CH]=[C]OOO(10746)',
    structure = SMILES('[CH]=[C]OOO'),
    E0 = (480.669,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,3120,650,792.5,1650,180,1005.07,1005.1,1005.19,1005.19,1005.23],'cm^-1')),
        HinderedRotor(inertia=(0.271305,'amu*angstrom^2'), symmetry=1, barrier=(6.23785,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00270408,'amu*angstrom^2'), symmetry=1, barrier=(15.9755,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.694817,'amu*angstrom^2'), symmetry=1, barrier=(15.9752,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (74.0355,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.26785,0.0341989,-3.72043e-05,1.97723e-08,-4.04381e-12,57876.8,23.126], Tmin=(100,'K'), Tmax=(1208.71,'K')), NASAPolynomial(coeffs=[10.8534,0.00578686,-1.94541e-06,3.25351e-10,-2.15712e-14,55801.3,-19.9217], Tmin=(1208.71,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(480.669,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(145.503,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsOs) + group(O2s-OsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C=CJO) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'C#COO[O](1345)'],
    products = ['C=[C]OO[O](406)'],
    transitionState = 'TS2',
...
reaction(
    ...
    products = ['C=[C]OO[O](406)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(0.000167406,'m^3/(mol*s)'), n=2.98833, Ea=(455.017,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R_R;O2b] for rate rule [Od_Cdd;O2b]
...
reaction(
    ...
    products = ['C=[C]OO[O](406)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(2.30125e+06,'m^3/(mol*s)'), n=0.185611, Ea=(234.014,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [Y_rad;O2_birad]
Euclidian distance = 0
Multiplied by reaction path degeneracy 2.0
family: R_Recombination
Ea raised from -25.4 to 234.0 kJ/mol to match endothermicity of reaction."""),
)
