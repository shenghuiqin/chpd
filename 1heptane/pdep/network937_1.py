...
species(
    label = '[CH]=C(O)CC=CC(7787)',
    structure = SMILES('[CH]=C(O)CC=CC'),
    E0 = (85.2618,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,2995,3025,975,1000,1300,1375,400,500,1630,1680,3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,2750,2850,1437.5,1250,1305,750,350,180],'cm^-1')),
        HinderedRotor(inertia=(0.622156,'amu*angstrom^2'), symmetry=1, barrier=(14.3046,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.621584,'amu*angstrom^2'), symmetry=1, barrier=(14.2914,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.621611,'amu*angstrom^2'), symmetry=1, barrier=(14.2921,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.622051,'amu*angstrom^2'), symmetry=1, barrier=(14.3022,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (97.1351,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.480367,0.0663127,-3.74576e-05,-4.04705e-09,7.82913e-12,10391.2,27.7226], Tmin=(100,'K'), Tmax=(979.479,'K')), NASAPolynomial(coeffs=[17.2586,0.0223722,-7.80616e-06,1.39046e-09,-9.77422e-14,5925.44,-58.8935], Tmin=(979.479,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(85.2618,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_P)"""),
)

species(
    label = '[CH]=C(O)C=CCC(7788)',
    structure = SMILES('[CH]=C(O)C=CCC'),
    E0 = (68.4534,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,2995,3025,975,1000,1300,1375,400,500,1630,1680,3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,2750,2850,1437.5,1250,1305,750,350,180],'cm^-1')),
        HinderedRotor(inertia=(0.784544,'amu*angstrom^2'), symmetry=1, barrier=(18.0382,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.784138,'amu*angstrom^2'), symmetry=1, barrier=(18.0289,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.785509,'amu*angstrom^2'), symmetry=1, barrier=(18.0604,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.783754,'amu*angstrom^2'), symmetry=1, barrier=(18.02,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (97.1351,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.21369,0.071313,-4.28894e-05,-5.01958e-09,9.97346e-12,8380.25,25.9493], Tmin=(100,'K'), Tmax=(948.289,'K')), NASAPolynomial(coeffs=[19.4693,0.0189587,-5.7391e-06,9.65322e-10,-6.75757e-14,3430.29,-72.7692], Tmin=(948.289,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(68.4534,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)O2s) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + radical(Cds_P)"""),
)
...
species(
    ...
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.260137,0.0749013,-6.45354e-05,2.96705e-08,-5.50055e-12,19733.3,31.1886], Tmin=(100,'K'), Tmax=(1294.84,'K')), NASAPolynomial(coeffs=[15.3864,0.0281736,-1.04043e-05,1.80042e-09,-1.19601e-13,15816.1,-45.6955], Tmin=(1294.84,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(162.902,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(Cds_P) + radical(RCCJC)"""),
)
...
species(
    label = '[CH]=C(O)CCC[CH2](7790)',
    structure = SMILES('[CH]=C(O)CCC[CH2]'),
    E0 = (173.702,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3120,650,792.5,1650,3615,1277.5,1000,3000,3100,440,815,1455,1000,350,440,435,1725,401.349,401.35],'cm^-1')),
        HinderedRotor(inertia=(0.00104658,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.10913,'amu*angstrom^2'), symmetry=1, barrier=(12.4738,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.10913,'amu*angstrom^2'), symmetry=1, barrier=(12.4738,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.109128,'amu*angstrom^2'), symmetry=1, barrier=(12.4738,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.109127,'amu*angstrom^2'), symmetry=1, barrier=(12.4738,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.132007,0.0750825,-5.4594e-05,1.25482e-08,1.96193e-12,21039.5,30.6969], Tmin=(100,'K'), Tmax=(1004.47,'K')), NASAPolynomial(coeffs=[17.5451,0.0251774,-9.09543e-06,1.61541e-09,-1.11744e-13,16560.8,-58.2697], Tmin=(1004.47,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(173.702,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(RCCJ) + radical(Cds_P)"""),
)
...
species(
    label = '[CH]=C(O)CC([CH2])C(7791)',
    structure = SMILES('[CH]=C(O)CC([CH2])C'),
    E0 = (164.496,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1277.5,1000,1380,1390,370,380,2900,435,350,440,435,1725,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,209.862],'cm^-1')),
        HinderedRotor(inertia=(0.00382898,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00382835,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.526468,'amu*angstrom^2'), symmetry=1, barrier=(16.4535,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.526438,'amu*angstrom^2'), symmetry=1, barrier=(16.4535,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.526444,'amu*angstrom^2'), symmetry=1, barrier=(16.4538,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.209827,0.0725013,-4.29387e-05,-4.44696e-09,9.81477e-12,19930.7,30.1335], Tmin=(100,'K'), Tmax=(933.255,'K')), NASAPolynomial(coeffs=[18.2072,0.0226854,-6.78532e-06,1.09725e-09,-7.38554e-14,15381.7,-61.8251], Tmin=(933.255,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(164.496,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(Cds_P) + radical(Isobutyl)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', '[CH]=C(O)CC=CC(7787)'],
    products = ['[CH]=C(O)C[CH]CC(1351)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', '[CH]=C(O)C=CCC(7788)'],
    products = ['[CH]=C(O)C[CH]CC(1351)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CH3(17)', '[CH]=C(O)CC=C(7322)'],
    products = ['[CH]=C(O)C[CH]CC(1351)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['OH(5)', 'C#CC[CH]CC(3281)'],
    products = ['[CH]=C(O)C[CH]CC(1351)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction19',
    reactants = ['CH2(S)(23)', '[CH]=C(O)C[CH]C(1363)'],
    products = ['[CH]=C(O)C[CH]CC(1351)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH]=C(O)CC([CH2])C(7791)'],
    products = ['[CH]=C(O)C[CH]CC(1351)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH]CC(144)', '[CH]=C([CH2])O(6276)'],
    products = ['[CH]=C(O)C[CH]CC(1351)'],
