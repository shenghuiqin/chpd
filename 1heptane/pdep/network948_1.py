...
species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.859087,'amu*angstrom^2'), symmetry=1, barrier=(19.7521,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.858218,'amu*angstrom^2'), symmetry=1, barrier=(19.7321,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.858886,'amu*angstrom^2'), symmetry=1, barrier=(19.7475,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (83.1085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.02226,0.0543168,-2.40784e-05,-1.86162e-08,1.45591e-11,10615.2,22.2722], Tmin=(100,'K'), Tmax=(919.572,'K')), NASAPolynomial(coeffs=[17.5934,0.0115922,-2.27384e-06,2.93333e-10,-2.02271e-14,6326.29,-63.0336], Tmin=(919.572,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(87.2822,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)HHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C=CJO)"""),
)

species(
    label = '[CH2]C(C)C#CO(7326)',
    structure = SMILES('[CH2]C(C)C#CO'),
    E0 = (180.293,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2100,2250,500,550,2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1277.5,1000,3000,3100,440,815,1455,1000,1380,1390,370,380,2900,435,180],'cm^-1')),
        HinderedRotor(inertia=(0.00024286,'amu*angstrom^2'), symmetry=1, barrier=(0.694111,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.701855,'amu*angstrom^2'), symmetry=1, barrier=(16.137,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(3.36886,'amu*angstrom^2'), symmetry=1, barrier=(77.4567,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(3.36663,'amu*angstrom^2'), symmetry=1, barrier=(77.4055,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (83.1085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.63391,0.0469803,-2.62764e-05,4.15586e-10,3.88448e-12,21774,23.4972], Tmin=(100,'K'), Tmax=(937.827,'K')), NASAPolynomial(coeffs=[10.117,0.0231185,-7.8165e-06,1.30109e-09,-8.57249e-14,19641.1,-19.7731], Tmin=(937.827,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(180.293,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CtH) + group(Cs-CtCsCsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtOs) + radical(Isobutyl)"""),
)
...
species(
    label = 'C[C](C)C=[C]O(7327)',
    structure = SMILES('C[C](C)C=[C]O'),
    E0 = (114.658,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,3010,987.5,1337.5,450,1655,360,370,350,3615,1277.5,1000,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,487.35],'cm^-1')),
        HinderedRotor(inertia=(0.0713813,'amu*angstrom^2'), symmetry=1, barrier=(12.0177,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0716898,'amu*angstrom^2'), symmetry=1, barrier=(12.0344,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.136252,'amu*angstrom^2'), symmetry=1, barrier=(22.9936,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0725721,'amu*angstrom^2'), symmetry=1, barrier=(12.0066,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.42205,0.044918,7.46671e-07,-3.79365e-08,1.95942e-11,13893.9,22.5716], Tmin=(100,'K'), Tmax=(931.824,'K')), NASAPolynomial(coeffs=[14.4842,0.0187664,-5.31893e-06,8.61057e-10,-5.96445e-14,10160.6,-46.4934], Tmin=(931.824,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(114.658,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(C=CJO) + radical(Allyl_T)"""),
)

species(
    label = '[CH2]C(C)[C]=CO(7328)',
    structure = SMILES('[CH2]C(C)[C]=CO'),
    E0 = (185.858,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,1685,370,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,278.906],'cm^-1')),
        HinderedRotor(inertia=(0.302951,'amu*angstrom^2'), symmetry=1, barrier=(16.7181,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.30303,'amu*angstrom^2'), symmetry=1, barrier=(16.7186,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.302891,'amu*angstrom^2'), symmetry=1, barrier=(16.7191,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.302887,'amu*angstrom^2'), symmetry=1, barrier=(16.7195,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
...
species(
    label = 'CC(C)[C]=[C]O(7329)',
    structure = SMILES('CC(C)[C]=[C]O'),
    E0 = (220.519,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1670,1700,300,440,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3615,1277.5,1000,1380,1390,370,380,2900,435,293.588],'cm^-1')),
        HinderedRotor(inertia=(0.21474,'amu*angstrom^2'), symmetry=1, barrier=(13.144,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.214811,'amu*angstrom^2'), symmetry=1, barrier=(13.1452,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.215044,'amu*angstrom^2'), symmetry=1, barrier=(13.1479,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.214679,'amu*angstrom^2'), symmetry=1, barrier=(13.1453,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.10536,0.0549998,-2.98926e-05,-5.23263e-09,7.59497e-12,26634.4,25.2348], Tmin=(100,'K'), Tmax=(950.863,'K')), NASAPolynomial(coeffs=[14.5035,0.0193197,-6.23297e-06,1.05404e-09,-7.21381e-14,23151.5,-43.645], Tmin=(950.863,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(220.519,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(C=CJO) + radical(Cds_S)"""),
)

species(
    label = '[CH2][C](C)C=CO(7330)',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'C=C(C)C=[C]O(7325)'],
    products = ['[CH2]C(C)C=[C]O(1362)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', '[CH2]C(C)C#CO(7326)'],
    products = ['[CH2]C(C)C=[C]O(1362)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CH3(17)', 'C=CC=[C]O(6299)'],
    products = ['[CH2]C(C)C=[C]O(1362)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction18',
    reactants = ['CH2(S)(23)', '[CH2]CC=[C]O(1040)'],
    products = ['[CH2]C(C)C=[C]O(1362)'],
...
reaction(
    label = 'reaction22',
    reactants = ['CH2(19)', 'C[CH]C=[C]O(6301)'],
    products = ['[CH2]C(C)C=[C]O(1362)'],
