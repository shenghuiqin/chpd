...
species(
    label = 'C=C(C)C[CH]C(524)',
    structure = SMILES('C=C(C)C[CH]C'),
    E0 = (115.089,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2950,3100,1380,975,1025,1650,3025,407.5,1350,352.5,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,350,440,435,1725,286.482,1572.73],'cm^-1')),
        HinderedRotor(inertia=(0.00206726,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.120639,'amu*angstrom^2'), symmetry=1, barrier=(6.93601,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.120835,'amu*angstrom^2'), symmetry=1, barrier=(6.94152,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.119945,'amu*angstrom^2'), symmetry=1, barrier=(6.93552,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
species(
    label = '[CH2]C(C)C=CC(525)',
    structure = SMILES('[CH2]C(C)C=CC'),
    E0 = (120.783,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2995,3025,975,1000,1300,1375,400,500,1630,1680,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3712.86],'cm^-1')),
        HinderedRotor(inertia=(0.0584209,'amu*angstrom^2'), symmetry=1, barrier=(6.36,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.663278,'amu*angstrom^2'), symmetry=1, barrier=(15.2501,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(3.69837,'amu*angstrom^2'), symmetry=1, barrier=(85.0327,'kJ/mol'), semiclassical=False),
...
species(
    ...
    E0 = (202.134,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3025,407.5,1350,352.5,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,180,1196.54],'cm^-1')),
        HinderedRotor(inertia=(0.157753,'amu*angstrom^2'), symmetry=1, barrier=(3.62704,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.58879,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.159093,'amu*angstrom^2'), symmetry=1, barrier=(3.65786,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.157036,'amu*angstrom^2'), symmetry=1, barrier=(3.61057,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00358806,'amu*angstrom^2'), symmetry=1, barrier=(3.63738,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.1595,'amu'),
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'C=C(C)C[CH]C(524)'],
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', '[CH2]C(C)C=CC(525)'],
    products = ['[CH2]C(C)C[CH]C(519)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', '[CH2]C(C)CC=C(526)'],
    products = ['[CH2]C(C)C[CH]C(519)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['C=CC[CH]C(380)', 'CH3(17)'],
    products = ['[CH2]C(C)C[CH]C(519)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction23',
    reactants = ['C[CH]C[CH]C(384)', 'CH2(19)'],
    products = ['[CH2]C(C)C[CH]C(519)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[CH2]C([CH2])C(438)', 'CHCH3(T)(95)'],
    products = ['[CH2]C(C)C[CH]C(519)'],
