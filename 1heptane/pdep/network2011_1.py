...
species(
    label = 'ketenylperoxy(1346)',
    structure = SMILES('[O]OC=C=O'),
    E0 = (63.7216,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2120,512.5,787.5,492.5,1135,1000,3010,987.5,1337.5,450,1655],'cm^-1')),
...
species(
    ...
    molecularWeight = (74.0355,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.40645,0.0381997,-4.8427e-05,3.38897e-08,-9.80789e-12,5046,16.9553], Tmin=(100,'K'), Tmax=(832.108,'K')), NASAPolynomial(coeffs=[7.05334,0.0158629,-8.16346e-06,1.63294e-09,-1.17082e-13,4272.63,-4.60945], Tmin=(832.108,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(41.5008,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(145.503,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-O2d)OsHH) + group(Cds-OdCsH) + radical(OCJC=O) + radical(CsCJ=O)"""),
)
...
species(
    ...
    molecularWeight = (74.0355,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.24057,0.0368703,-4.26091e-05,2.43521e-08,-5.40201e-12,-8289.81,16.2407], Tmin=(100,'K'), Tmax=(1109.82,'K')), NASAPolynomial(coeffs=[10.38,0.00753397,-2.95877e-06,5.34059e-10,-3.6673e-14,-10096.5,-23.8754], Tmin=(1109.82,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-69.4654,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(149.66,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cds-(Cdd-O2d)OsH)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'ketenylperoxy(1346)'],
    products = ['[O]OC[C]=O(407)'],
    transitionState = 'TS2',
...
reaction(
    ...
    products = ['[O]OC[C]=O(407)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(16.1744,'m^3/(mol*s)'), n=1.77401, Ea=(124.461,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Cds-HH_Ck;YJ] for rate rule [Cds-HH_Ck;O2b]
Euclidian distance = 2.0
Multiplied by reaction path degeneracy 2.0
family: R_Addition_MultipleBond
Ea raised from 120.0 to 124.5 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction4',
    reactants = ['[O]OC[C]=O(407)'],
    products = ['[O]O[CH]C=O(3604)'],
    transitionState = 'TS4',
