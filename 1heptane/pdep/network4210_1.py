...
species(
    label = 'C[CH]OC=C=CC(24660)',
    structure = SMILES('C[CH]OC=C=CC'),
    E0 = (112.974,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,540,610,2055,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,2995,3025,975,1000,1300,1375,400,500,1630,1680,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.893294,'amu*angstrom^2'), symmetry=1, barrier=(20.5386,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.8935,'amu*angstrom^2'), symmetry=1, barrier=(20.5433,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.892995,'amu*angstrom^2'), symmetry=1, barrier=(20.5317,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.892717,'amu*angstrom^2'), symmetry=1, barrier=(20.5253,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (97.1351,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.114406,0.0783439,-5.60943e-05,5.26272e-09,6.87986e-12,13746.7,25.5902], Tmin=(100,'K'), Tmax=(957.235,'K')), NASAPolynomial(coeffs=[21.1697,0.0177321,-5.50552e-06,9.46182e-10,-6.71003e-14,8374.07,-82.9424], Tmin=(957.235,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(112.974,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cdd-CdsCds) + radical(CCsJOC(O))"""),
)
...
species(
    label = 'CC#CCO[CH]C(24662)',
    structure = SMILES('CC#CCO[CH]C'),
    E0 = (140.411,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2100,2250,500,550,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3025,407.5,1350,352.5,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (97.1351,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.63466,0.0725734,-7.12974e-05,4.09083e-08,-9.65861e-12,17009.9,26.6503], Tmin=(100,'K'), Tmax=(1021.6,'K')), NASAPolynomial(coeffs=[11.0148,0.0319293,-1.16185e-05,1.96237e-09,-1.27691e-13,14889.1,-23.6495], Tmin=(1021.6,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(140.411,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CtOsHH) + group(Cs-CtHHH) + group(Ct-CtCs) + group(Ct-CtCs) + radical(CCsJOCs)"""),
)
...
species(
    label = 'C#CCO[CH]C(24663)',
    structure = SMILES('C#CCO[CH]C'),
    E0 = (182.592,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,750,770,3400,2100,2175,525,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,359.045,359.119,359.123],'cm^-1')),
        HinderedRotor(inertia=(0.0912049,'amu*angstrom^2'), symmetry=1, barrier=(8.34295,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.226624,'amu*angstrom^2'), symmetry=1, barrier=(20.7266,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.091196,'amu*angstrom^2'), symmetry=1, barrier=(8.3428,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.775558,'amu*angstrom^2'), symmetry=1, barrier=(70.9678,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
species(
    ...
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.46079,0.0660147,-3.00399e-05,-5.58118e-08,6.74314e-11,30100,26.2819], Tmin=(100,'K'), Tmax=(486.433,'K')), NASAPolynomial(coeffs=[5.94231,0.0461695,-2.12877e-05,4.06873e-09,-2.84176e-13,29462.8,5.82259], Tmin=(486.433,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(249.591,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(CJCO) + radical(Cds_S)"""),
)
...
species(
    ...
    E0 = (218.458,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3025,407.5,1350,352.5,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,1685,370,3010,987.5,1337.5,450,1655,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    ...
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.375868,0.0649831,-1.79059e-05,-2.89521e-08,1.73638e-11,16353.6,25.7768], Tmin=(100,'K'), Tmax=(966.915,'K')), NASAPolynomial(coeffs=[18.692,0.0239455,-8.12705e-06,1.45733e-09,-1.04396e-13,11187.9,-70.3681], Tmin=(966.915,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(134.776,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(Cds_S) + radical(Allyl_S)"""),
)
...
species(
    label = 'C[C]=[C]COCC(24666)',
    structure = SMILES('C[C]=[C]COCC'),
    E0 = (275.844,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,1670,1700,300,440,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.788307,0.0778695,-9.94238e-05,8.70438e-08,-3.20886e-11,33285,28.3689], Tmin=(100,'K'), Tmax=(796.052,'K')), NASAPolynomial(coeffs=[4.21626,0.048915,-2.27628e-05,4.33296e-09,-3.00286e-13,33110.9,14.9473], Tmin=(796.052,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(275.844,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Cds_S) + radical(Cds_S)"""),
)
...
species(
    label = 'CC=C=COCC(24667)',
    structure = SMILES('CC=C=COCC'),
    E0 = (-80.9539,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.24454,0.069044,-2.95444e-05,-1.6963e-08,1.31342e-11,-9589.14,24.8284], Tmin=(100,'K'), Tmax=(971.98,'K')), NASAPolynomial(coeffs=[18.7579,0.0240601,-8.27943e-06,1.4812e-09,-1.05245e-13,-14662.1,-71.5445], Tmin=(971.98,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-80.9539,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(390.78,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cdd-CdsCds)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'C[CH]OC=C=CC(24660)'],
    products = ['C[CH]OC[C]=CC(19557)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'C=COC[C]=CC(24661)'],
    products = ['C[CH]OC[C]=CC(19557)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', 'CC#CCO[CH]C(24662)'],
    products = ['C[CH]OC[C]=CC(19557)'],
    transitionState = 'TS4',
...
reaction(
    ...
    products = ['C[CH]OC[C]=CC(19557)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(4e+09,'cm^3/(mol*s)'), n=1.39, Ea=(36.1671,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), comment="""Estimated using template [Od_CO-CsH;YJ] for rate rule [Od_CO-CsH;CJ]
Euclidian distance = 1.0
family: R_Addition_MultipleBond
Ea raised from 35.9 to 36.2 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction6',
    reactants = ['CH3(17)', 'C#CCO[CH]C(24663)'],
    products = ['C[CH]OC[C]=CC(19557)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction20',
    reactants = ['CHCH3(T)(95)', 'CC=[C]C[O](24539)'],
    products = ['C[CH]OC[C]=CC(19557)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH2]O[CH]C(567)', '[C]=CC(24199)'],
    products = ['C[CH]OC[C]=CC(19557)'],
