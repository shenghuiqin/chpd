...
species(
    label = '[CH2]C(O)=C(CC)OC=C=CC(25994)',
    structure = SMILES('[CH2]C(O)=C(CC)OC=C=CC'),
    E0 = (-81.7376,'kJ/mol'),
    modes = [
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.51015,0.129525,-0.000126958,6.36507e-08,-1.25364e-11,-9584.83,44.5442], Tmin=(100,'K'), Tmax=(1240.68,'K')), NASAPolynomial(coeffs=[26.8566,0.0348458,-1.24902e-05,2.14308e-09,-1.42563e-13,-16871.8,-103.467], Tmin=(1240.68,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-81.7376,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(552.912,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cdd-CdsCds) + radical(C=C(O)CJ)"""),
)

species(
    label = '[CH2]C(O)=C(CC)OCC#CC(25995)',
    structure = SMILES('[CH2]C(O)=C(CC)OCC#CC'),
    E0 = (-108.284,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,2100,2250,500,550,325,375,415,465,420,450,1700,1750,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3100,440,815,1455,1000,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (153.198,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-3.12115,0.13189,-0.000129962,6.4864e-08,-1.23856e-11,-12746,45.8574], Tmin=(100,'K'), Tmax=(1423.72,'K')), NASAPolynomial(coeffs=[29.6872,0.0271294,-6.3296e-06,7.64081e-10,-3.97302e-14,-20812.6,-119.535], Tmin=(1423.72,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-108.284,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(548.755,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CtOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-CtHHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsOs) + group(Ct-CtCs) + group(Ct-CtCs) + radical(C=C(O)CJ)"""),
)
...
species(
    label = 'C#CCOC(CC)=C([CH2])O(25996)',
    structure = SMILES('C#CCOC(CC)=C([CH2])O'),
    E0 = (-66.1025,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,2175,525,750,770,3400,2100,325,375,415,465,420,450,1700,1750,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3100,440,815,1455,1000,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.61545,0.1227,-0.000127174,6.50211e-08,-1.26027e-11,-7692.63,40.6199], Tmin=(100,'K'), Tmax=(1407.56,'K')), NASAPolynomial(coeffs=[29.4238,0.0193157,-3.85373e-06,3.86236e-10,-1.69206e-14,-15490.1,-120.563], Tmin=(1407.56,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-66.1025,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(478.082,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CtOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsOs) + group(Ct-CtCs) + group(Ct-CtH) + radical(C=C(O)CJ)"""),
)
...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.09709,0.107461,-9.16206e-05,4.12391e-08,-7.58923e-12,24483.4,38.1378], Tmin=(100,'K'), Tmax=(1283.99,'K')), NASAPolynomial(coeffs=[18.8749,0.0452431,-1.89356e-05,3.50012e-09,-2.41281e-13,19354.6,-63.208], Tmin=(1283.99,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(202.01,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(532.126,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(Cds_S)"""),
)
...
species(
    label = 'CC=[C]COC(CC)=C(C)[O](25998)',
    structure = SMILES('CC=[C]COC(CC)=C(C)[O]'),
    E0 = (-51.3482,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (154.206,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.77657,0.122649,-0.000113064,5.55682e-08,-1.10922e-11,-5964.12,43.0819], Tmin=(100,'K'), Tmax=(1197.79,'K')), NASAPolynomial(coeffs=[20.5423,0.0481144,-1.97223e-05,3.61521e-09,-2.48567e-13,-11310.7,-68.6217], Tmin=(1197.79,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-51.3482,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(577.856,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Cds_S) + radical(C=C(C)OJ)"""),
)
...
species(
    ...
    opticalIsomers = 1,
    molecularWeight = (154.206,'amu'),
    collisionModel = TransportData(shapeIndex=2, epsilon=(4446.73,'J/mol'), sigma=(7.598,'angstroms'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with Tc=694.57 K, Pc=23 bar (from Joback method)"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
...
species(
    label = 'C[CH]C(OC[C]=CC)=C(C)O(25999)',
    structure = SMILES('C[CH]C(OC[C]=CC)=C(C)O'),
    E0 = (10.749,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,3615,1277.5,1000,1685,370,2750,2762.5,2775,2787.5,2800,2812.5,2825,2837.5,2850,1350,1380,1410,1440,1470,1500,700,750,800,1000,1050,1100,1350,1375,1400,900,1000,1100,325,375,415,465,420,450,1700,1750,2750,2850,1437.5,1250,1305,750,350,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (154.206,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.48907,0.127684,-0.000118374,5.61109e-08,-1.04972e-11,1539.06,46.6403], Tmin=(100,'K'), Tmax=(1299.33,'K')), NASAPolynomial(coeffs=[26.9756,0.0369768,-1.36588e-05,2.38369e-09,-1.59841e-13,-6117.88,-103.225], Tmin=(1299.33,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(10.749,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(573.699,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(CCJCO) + radical(Cds_S)"""),
)
...
species(
    label = 'CC=[C][CH]OC(CC)=C(C)O(26000)',
    structure = SMILES('CC=[C][CH]OC(CC)=C(C)O'),
    E0 = (-78.2138,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (154.206,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.05887,0.125742,-0.000115532,5.53767e-08,-1.06714e-11,-9182.58,43.5302], Tmin=(100,'K'), Tmax=(1245.71,'K')), NASAPolynomial(coeffs=[23.0849,0.045005,-1.83152e-05,3.34926e-09,-2.30076e-13,-15447,-83.2983], Tmin=(1245.71,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-78.2138,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(573.699,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Cds_S) + radical(C=CCJ(O)C)"""),
)

species(
    label = '[CH2]CC(OC[C]=CC)=C(C)O(26001)',
    structure = SMILES('[CH2]CC(OC[C]=CC)=C(C)O'),
    E0 = (16.0933,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3010,987.5,1337.5,450,1655,3615,1277.5,1000,1685,370,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,325,375,415,465,420,450,1700,1750,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3100,440,815,1455,1000,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (154.206,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.32511,0.129929,-0.000124903,6.21282e-08,-1.22937e-11,2171.03,45.3366], Tmin=(100,'K'), Tmax=(1223.87,'K')), NASAPolynomial(coeffs=[24.8093,0.0412446,-1.62094e-05,2.92057e-09,-1.99377e-13,-4470.74,-91.0525], Tmin=(1223.87,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(16.0933,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(573.699,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Cds_S) + radical(RCCJ)"""),
)
...
species(
    label = 'C[C]=[C]COC(CC)=C(C)O(26002)',
    structure = SMILES('C[C]=[C]COC(CC)=C(C)O'),
    E0 = (48.6887,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,325,375,415,465,420,450,1700,1750,1670,1700,300,440,3615,1277.5,1000,2750,2762.5,2775,2787.5,2800,2812.5,2825,2837.5,2850,1350,1380,1410,1440,1470,1500,700,750,800,1000,1050,1100,1350,1375,1400,900,1000,1100,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (154.206,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.18721,0.131348,-0.000130757,6.83171e-08,-1.42986e-11,6082.73,43.5293], Tmin=(100,'K'), Tmax=(1154.78,'K')), NASAPolynomial(coeffs=[22.8305,0.044689,-1.81896e-05,3.32985e-09,-2.29183e-13,304.826,-80.7665], Tmin=(1154.78,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(48.6887,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(573.699,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Cds_S) + radical(Cds_S)"""),
)
...
species(
    label = 'CC=[C]COC1(CC)C[C]1O(26003)',
    structure = SMILES('CC=[C]COC1(CC)C[C]1O'),
    E0 = (102.789,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (154.206,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.4045,0.122484,-0.000118546,6.41378e-08,-1.44852e-11,12554.3,41.2711], Tmin=(100,'K'), Tmax=(1049.21,'K')), NASAPolynomial(coeffs=[15.7497,0.0570865,-2.50509e-05,4.7317e-09,-3.30406e-13,8954.57,-42.3121], Tmin=(1049.21,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(102.789,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(577.856,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cyclopropane) + radical(Cds_S) + radical(C2CsJOH)"""),
)
...
species(
    ...
    molecularWeight = (154.206,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.3244,0.127193,-0.000117355,5.59084e-08,-1.05925e-11,-28706.4,43.1893], Tmin=(100,'K'), Tmax=(1276.6,'K')), NASAPolynomial(coeffs=[25.3084,0.0406107,-1.56205e-05,2.78064e-09,-1.88365e-13,-35761.6,-96.8707], Tmin=(1276.6,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-240.654,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(577.856,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cdd-CdsCds)"""),
)
...
species(
    label = '[CH2]C(O)=C(C)OC[C]=CC(26005)',
    structure = SMILES('[CH2]C(O)=C(C)OC[C]=CC'),
    E0 = (-7.59091,'kJ/mol'),
    modes = [
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.90637,0.119741,-0.000121944,6.36411e-08,-1.30443e-11,-691.679,39.8228], Tmin=(100,'K'), Tmax=(1193.58,'K')), NASAPolynomial(coeffs=[24.2967,0.0319277,-1.15864e-05,2.00171e-09,-1.33737e-13,-6946.76,-91.2286], Tmin=(1193.58,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-7.59091,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)OsHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Cds_S) + radical(C=C(O)CJ)"""),
)

species(
    label = '[CH2]C(O)=C(CC)OC[C]=C(25979)',
    structure = SMILES('[CH2]C(O)=C(CC)OC[C]=C'),
    E0 = (5.78921,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,2950,3100,1380,975,1025,1650,325,375,415,465,420,450,1700,1750,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3100,440,815,1455,1000,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (140.18,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.83031,0.115146,-0.000100886,3.62115e-08,-1.99459e-12,917.84,40.6546], Tmin=(100,'K'), Tmax=(983.415,'K')), NASAPolynomial(coeffs=[25.6866,0.0294202,-1.0089e-05,1.74862e-09,-1.201e-13,-5761.08,-98.0792], Tmin=(983.415,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(5.78921,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_S) + radical(C=C(O)CJ)"""),
)
...
species(
    label = '[CH2]C(=O)C(CC)OC[C]=CC(26006)',
    ...
    molecularWeight = (154.206,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.19754,0.116745,-0.000104193,5.13099e-08,-1.06038e-11,751.655,44.36], Tmin=(100,'K'), Tmax=(1133.66,'K')), NASAPolynomial(coeffs=[15.7737,0.0568649,-2.49644e-05,4.71909e-09,-3.29589e-13,-3096.33,-39.6456], Tmin=(1133.66,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(4.71073,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(577.856,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(C=C(C)OJ) + radical(Cds_S)"""),
)
...
species(
    label = 'CC=[C]COC(=[C]O)CC(26007)',
    structure = SMILES('CC=[C]COC(=[C]O)CC'),
    E0 = (92.3827,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3010,987.5,1337.5,450,1655,3615,1277.5,1000,1670,1700,300,440,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,350,440,435,1725,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (140.18,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.74807,0.114824,-0.00011111,5.51618e-08,-1.0792e-11,11327.8,42.6042], Tmin=(100,'K'), Tmax=(1246.05,'K')), NASAPolynomial(coeffs=[23.9359,0.0323749,-1.18575e-05,2.05943e-09,-1.37877e-13,4927.1,-86.956], Tmin=(1246.05,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(92.3827,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(C=CJO) + radical(Cds_S)"""),
)

species(
    label = 'C=C(O)C(=CC)OC[C]=CC(26008)',
    structure = SMILES('C=C(O)C(=CC)OC[C]=CC'),
    E0 = (-77.3787,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,2995,3025,975,1000,1300,1375,400,500,1630,1680,3615,1277.5,1000,2950,3100,1380,975,1025,1650,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,325,375,415,465,420,450,1700,1750,2750,2850,1437.5,1250,1305,750,350,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (153.198,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.39112,0.133607,-0.000138417,7.40403e-08,-1.56666e-11,-9070.43,40.0746], Tmin=(100,'K'), Tmax=(1151.51,'K')), NASAPolynomial(coeffs=[24.8234,0.0390704,-1.52677e-05,2.74163e-09,-1.86987e-13,-15337.9,-95.0586], Tmin=(1151.51,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-77.3787,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(552.912,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)OsHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-Cds(Cds-Cds)O2s) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)O2s) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_S)"""),
)

species(
    label = 'C=C(O)C(=C)OC[C]=CC(26009)',
    structure = SMILES('C=C(O)C(=C)OC[C]=CC'),
    E0 = (-41.3531,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,3010,987.5,1337.5,450,1655,3615,1277.5,1000,2950,3000,3050,3100,1330,1430,900,1050,1000,1050,1600,1700,2750,2800,2850,1350,1500,750,1050,1375,1000,325,375,415,465,420,450,1700,1750,2750,2850,1437.5,1250,1305,750,350,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (139.172,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.96635,0.120649,-0.000127007,6.74792e-08,-1.39816e-11,-4749.8,36.7432], Tmin=(100,'K'), Tmax=(1185.27,'K')), NASAPolynomial(coeffs=[25.3975,0.0283017,-1.01382e-05,1.74452e-09,-1.16584e-13,-11236.4,-99.9222], Tmin=(1185.27,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-41.3531,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(482.239,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)OsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-Cds(Cds-Cds)O2s) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)O2s) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cds_S)"""),
)

species(
    label = 'C=C(O)C([CH]C)OC[C]=CC(26010)',
    structure = SMILES('C=C(O)C([CH]C)OC[C]=CC'),
    E0 = (66.808,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (154.206,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.83011,0.120979,-0.000107272,4.95979e-08,-9.26028e-12,8250.97,47.621], Tmin=(100,'K'), Tmax=(1278.64,'K')), NASAPolynomial(coeffs=[22.2856,0.0455359,-1.87666e-05,3.45174e-09,-2.37635e-13,2084.01,-74.6505], Tmin=(1278.64,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(66.808,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(573.699,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_S) + radical(CCJCO)"""),
)

species(
    label = 'C=C(O)C(CC)O[CH][C]=CC(26011)',
    structure = SMILES('C=C(O)C(CC)OC=[C][CH]C'),
    E0 = (-36.3199,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (154.206,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.44122,0.117666,-5.9183e-05,-2.55574e-08,2.31906e-11,-4114.62,43.7164], Tmin=(100,'K'), Tmax=(958.08,'K')), NASAPolynomial(coeffs=[32.6274,0.0283519,-8.74383e-06,1.54877e-09,-1.13738e-13,-13454.9,-137.644], Tmin=(958.08,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-36.3199,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(573.699,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(Cds_S) + radical(Allyl_S)"""),
)

species(
    label = '[CH2]CC(OC[C]=CC)C(=C)O(26012)',
    structure = SMILES('[CH2]CC(OC[C]=CC)C(=C)O'),
    E0 = (72.1523,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (154.206,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.71092,0.123669,-0.000115025,5.68345e-08,-1.14551e-11,8885.13,46.4843], Tmin=(100,'K'), Tmax=(1181.67,'K')), NASAPolynomial(coeffs=[20.0806,0.0499037,-2.1389e-05,4.00798e-09,-2.78926e-13,3735.01,-62.2851], Tmin=(1181.67,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(72.1523,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(573.699,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(RCCJ) + radical(Cds_S)"""),
)

species(
    label = '[CH]=C(O)C(CC)OC[C]=CC(26013)',
    structure = SMILES('[CH]=C(O)C(CC)OC[C]=CC'),
    E0 = (114.002,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3615,1277.5,1000,1685,370,3010,987.5,1337.5,450,1655,1380,1390,370,380,2900,435,350,440,435,1725,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (154.206,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.81253,0.126335,-0.000120764,6.13479e-08,-1.26802e-11,13921.9,45.4667], Tmin=(100,'K'), Tmax=(1156.17,'K')), NASAPolynomial(coeffs=[20.3475,0.0496669,-2.12961e-05,3.99242e-09,-2.78024e-13,8797.72,-64.6584], Tmin=(1156.17,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(114.002,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(573.699,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_S) + radical(Cds_P)"""),
)

species(
    label = 'C=C(O)C(CC)OC[C]=[C]C(26014)',
    structure = SMILES('C=C(O)C(CC)OC[C]=[C]C'),
    E0 = (104.748,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (154.206,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.63355,0.12572,-0.000122747,6.50386e-08,-1.41743e-11,12799.6,44.9], Tmin=(100,'K'), Tmax=(1093.03,'K')), NASAPolynomial(coeffs=[18.1577,0.0532932,-2.33543e-05,4.41666e-09,-3.08865e-13,8473.12,-52.3422], Tmin=(1093.03,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(104.748,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(573.699,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_S) + radical(Cds_S)"""),
)
...
species(
    label = 'C=C(O)C(CC)OC=C=CC(26015)',
    structure = SMILES('C=C(O)C(CC)OC=C=CC'),
    E0 = (-252.05,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (154.206,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.57116,0.121711,-7.07698e-05,-1.36286e-08,1.89828e-11,-30057.4,42.763], Tmin=(100,'K'), Tmax=(960.276,'K')), NASAPolynomial(coeffs=[32.6836,0.0284828,-8.9055e-06,1.57482e-09,-1.14766e-13,-39300.7,-138.765], Tmin=(960.276,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-252.05,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(577.856,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(Cdd-CdsCds)"""),
)
...
species(
    label = '[CH2]C(C)(OC[C]=CC)C(=C)O(26016)',
    structure = SMILES('[CH2]C(C)(OC[C]=CC)C(=C)O'),
    E0 = (54.4681,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,3010,987.5,1337.5,450,1655,3615,1277.5,1000,2950,3100,1380,975,1025,1650,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,350,440,435,1725,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,180,180,180,180,1079.92,1140.41,1600,1800,3000,3200],'cm^-1')),
        HinderedRotor(inertia=(0.161559,'amu*angstrom^2'), symmetry=1, barrier=(3.71457,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.161559,'amu*angstrom^2'), symmetry=1, barrier=(3.71457,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.161559,'amu*angstrom^2'), symmetry=1, barrier=(3.71457,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.161559,'amu*angstrom^2'), symmetry=1, barrier=(3.71457,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.161559,'amu*angstrom^2'), symmetry=1, barrier=(3.71457,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (154.206,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.3268,0.139378,-0.000153863,9.08079e-08,-2.14911e-11,6778.76,44.9495], Tmin=(100,'K'), Tmax=(1026.43,'K')), NASAPolynomial(coeffs=[21.254,0.0474831,-1.95683e-05,3.58218e-09,-2.45914e-13,1938.01,-69.4289], Tmin=(1026.43,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(54.4681,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(573.699,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CJC(C)OC) + radical(Cds_S)"""),
)
...
reaction(
    ...
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(8.48517e+07,'s^-1'), n=1.03851, Ea=(80.8205,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R5_SS_D;doublebond_intra;radadd_intra] for rate rule [R5_SS_D;doublebond_intra;radadd_intra_cddouble]
Euclidian distance = 1.0
family: Intra_R_Add_Exocyclic
Ea raised from 78.9 to 80.8 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction3',
    reactants = ['H(3)', '[CH2]C(O)=C(CC)OC=C=CC(25994)'],
    products = ['[CH2]C(O)=C(CC)OC[C]=CC(20006)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', '[CH2]C(O)=C(CC)OCC#CC(25995)'],
    products = ['[CH2]C(O)=C(CC)OC[C]=CC(20006)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CH3(17)', 'C#CCOC(CC)=C([CH2])O(25996)'],
    products = ['[CH2]C(O)=C(CC)OC[C]=CC(20006)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['OH(5)', 'C=C=C(CC)OC[C]=CC(25997)'],
    products = ['[CH2]C(O)=C(CC)OC[C]=CC(20006)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]C(O)=C(CC)OCC=[C]C(20005)'],
    products = ['[CH2]C(O)=C(CC)OC[C]=CC(20006)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]C(O)=C(CC)OC[C]=CC(20006)'],
    products = ['CC=[C]COC(CC)=C(C)[O](25998)'],
...
reaction(
    label = 'reaction12',
    reactants = ['C[CH]C(OC[C]=CC)=C(C)O(25999)'],
    products = ['[CH2]C(O)=C(CC)OC[C]=CC(20006)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]C(O)=C(CC)OC[C]=CC(20006)'],
    products = ['CC=[C][CH]OC(CC)=C(C)O(26000)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]CC(OC[C]=CC)=C(C)O(26001)'],
    products = ['[CH2]C(O)=C(CC)OC[C]=CC(20006)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]C(O)=C(CC)OC[C]=CC(20006)'],
    products = ['[CH2]CC(OCC=CC)=C([CH2])O(20010)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]C(O)=C(CC)OC[C]=CC(20006)'],
    products = ['[CH2]C([O])=C(CC)OCC=CC(20011)'],
...
reaction(
    label = 'reaction18',
    reactants = ['C[C]=[C]COC(CC)=C(C)O(26002)'],
    products = ['[CH2]C(O)=C(CC)OC[C]=CC(20006)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2]C(O)=C(CC)OC[C]=CC(20006)'],
    products = ['[CH2]C=[C]COC(CC)=C(C)O(20008)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH2]C(O)=[C]CC(4618)', 'CC=[C]C[O](24539)'],
    products = ['[CH2]C(O)=C(CC)OC[C]=CC(20006)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH2]C(O)=C(CC)OC[C]=CC(20006)'],
    products = ['CC=[C]COC1(CC)C[C]1O(26003)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[CH2]C(O)=C(CC)OC[C]=CC(20006)'],
    products = ['CC=C=COC(CC)=C(C)O(26004)'],
...
reaction(
    label = 'reaction25',
    reactants = ['CH2(S)(23)', '[CH2]C(O)=C(C)OC[C]=CC(26005)'],
    products = ['[CH2]C(O)=C(CC)OC[C]=CC(20006)'],
...
reaction(
    label = 'reaction26',
    reactants = ['CH2(S)(23)', '[CH2]C(O)=C(CC)OC[C]=C(25979)'],
    products = ['[CH2]C(O)=C(CC)OC[C]=CC(20006)'],
...
reaction(
    label = 'reaction29',
    reactants = ['[CH2]C(O)=C(CC)OC[C]=CC(20006)'],
    products = ['[CH2]C(=O)C(CC)OC[C]=CC(26006)'],
...
reaction(
    label = 'reaction30',
    reactants = ['[CH2]O[C](CC)C(=C)O(5968)', '[C]=CC(24199)'],
    products = ['[CH2]C(O)=C(CC)OC[C]=CC(20006)'],
...
reaction(
    label = 'reaction31',
    reactants = ['CH2(19)', 'CC=[C]COC(=[C]O)CC(26007)'],
    products = ['[CH2]C(O)=C(CC)OC[C]=CC(20006)'],
...
reaction(
    label = 'reaction32',
    reactants = ['H(3)', 'C=C(O)C(=CC)OC[C]=CC(26008)'],
    products = ['[CH2]C(O)=C(CC)OC[C]=CC(20006)'],
...
reaction(
    label = 'reaction34',
    reactants = ['CH3(17)', 'C=C(O)C(=C)OC[C]=CC(26009)'],
    products = ['[CH2]C(O)=C(CC)OC[C]=CC(20006)'],
...
reaction(
    label = 'reaction35',
    reactants = ['C=C(O)C([CH]C)OC[C]=CC(26010)'],
    products = ['[CH2]C(O)=C(CC)OC[C]=CC(20006)'],
...
reaction(
    label = 'reaction36',
    reactants = ['[CH2]C(O)=C(CC)OC[C]=CC(20006)'],
    products = ['C=C(O)C(CC)O[CH][C]=CC(26011)'],
    transitionState = 'TS36',
    kinetics = Arrhenius(A=(8.94198e+07,'s^-1'), n=1.47622, Ea=(175.11,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R3H_SS;C_rad_out_noH;XH_out] for rate rule [R3H_SS_O;C_rad_out_OneDe/Cs;XH_out]
...
reaction(
    label = 'reaction37',
    reactants = ['[CH2]CC(OC[C]=CC)C(=C)O(26012)'],
    products = ['[CH2]C(O)=C(CC)OC[C]=CC(20006)'],
...
reaction(
    label = 'reaction38',
    reactants = ['[CH]=C(O)C(CC)OC[C]=CC(26013)'],
    products = ['[CH2]C(O)=C(CC)OC[C]=CC(20006)'],
...
reaction(
    label = 'reaction39',
    reactants = ['C=C(O)C(CC)OC[C]=[C]C(26014)'],
    products = ['[CH2]C(O)=C(CC)OC[C]=CC(20006)'],
    transitionState = 'TS39',
    kinetics = Arrhenius(A=(8.05e+09,'s^-1'), n=0.86, Ea=(139.746,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [RnH;Cd_rad_out_Cs;Cs_H_out_noH] for rate rule [R5HJ_1;Cd_rad_out_Cs;Cs_H_out_Cd]
...
reaction(
    label = 'reaction40',
    reactants = ['[CH2]C(O)=C(CC)OC[C]=CC(20006)'],
    products = ['[CH]=C(O)[C](CC)OCC=CC(20029)'],
...
reaction(
    label = 'reaction43',
    reactants = ['[CH2]C(O)=C(CC)OC[C]=CC(20006)'],
    products = ['C=C(O)C(CC)OC=C=CC(26015)'],
...
reaction(
    label = 'reaction45',
    reactants = ['[CH2]C(C)(OC[C]=CC)C(=C)O(26016)'],
    products = ['[CH2]C(O)=C(CC)OC[C]=CC(20006)'],
