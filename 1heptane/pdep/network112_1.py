...
species(
    label = '[CH2]CC(=C)CCCC(471)',
    structure = SMILES('[CH2]CC(=C)CCCC'),
    E0 = (79.4636,'kJ/mol'),
    modes = [
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.581987,0.0876338,-5.59797e-05,1.80762e-08,-2.36999e-12,9733.2,36.5057], Tmin=(100,'K'), Tmax=(1754.39,'K')), NASAPolynomial(coeffs=[20.2312,0.0401799,-1.54067e-05,2.65854e-09,-1.72987e-13,2430.3,-75.6054], Tmin=(1754.39,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(79.4636,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(532.126,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(RCCJ)"""),
)
...
species(
    ...
    molecularWeight = (112.213,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.397065,0.086672,-5.89545e-05,2.47414e-08,-5.09175e-12,18031.6,34.1751], Tmin=(100,'K'), Tmax=(1014.2,'K')), NASAPolynomial(coeffs=[5.36163,0.0670917,-2.99954e-05,5.70561e-09,-3.99443e-13,17024.6,10.154], Tmin=(1014.2,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(148.897,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(552.912,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJ) + radical(Tertalkyl)"""),
)
...
species(
    label = '[CH2]CC(C)[CH]CCC(475)',
    structure = SMILES('[CH2]CC(C)[CH]CCC'),
    E0 = (158.016,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.213,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.145062,0.0856645,-4.98466e-05,1.42102e-08,-1.64861e-12,19158,37.5362], Tmin=(100,'K'), Tmax=(1909.24,'K')), NASAPolynomial(coeffs=[18.9456,0.0456682,-1.84235e-05,3.23797e-09,-2.11885e-13,11868.2,-66.9114], Tmin=(1909.24,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(158.016,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(552.912,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJ) + radical(Cs_S)"""),
)

species(
    label = '[CH2][CH]C(C)CCCC(476)',
...
species(
    label = '[CH2]CC(C)CC[CH]C(481)',
    structure = SMILES('[CH2]CC(C)CC[CH]C'),
    E0 = (157.921,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.213,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.167664,0.0838765,-4.82379e-05,1.39915e-08,-1.69964e-12,19130.4,36.5652], Tmin=(100,'K'), Tmax=(1760.97,'K')), NASAPolynomial(coeffs=[14.0928,0.0522463,-2.12954e-05,3.79172e-09,-2.51626e-13,14226.1,-38.4953], Tmin=(1760.97,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(157.921,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(552.912,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJ) + radical(RCCJC)"""),
)
...
species(
    label = '[CH2]CCCC(C)C[CH2](483)',
    structure = SMILES('[CH2]CCCC(C)C[CH2]'),
    E0 = (168.721,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,1380,1390,370,380,2900,435,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (112.213,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.48858,0.0898091,-5.6455e-05,1.80288e-08,-2.3651e-12,20461,38.0039], Tmin=(100,'K'), Tmax=(1722.19,'K')), NASAPolynomial(coeffs=[18.4736,0.0457673,-1.80954e-05,3.17967e-09,-2.09548e-13,13929.7,-63.7854], Tmin=(1722.19,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(168.721,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(552.912,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJ) + radical(RCCJ)"""),
)
...
species(
    ...
    molecularWeight = (112.213,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.302652,0.0810187,-2.80331e-05,-1.21355e-08,8.02001e-12,-14220,34.2612], Tmin=(100,'K'), Tmax=(1101.74,'K')), NASAPolynomial(coeffs=[15.1382,0.0500381,-1.99984e-05,3.6639e-09,-2.53403e-13,-19144.4,-48.6355], Tmin=(1101.74,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-119.615,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(557.07,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH)"""),
)
...
species(
    label = 'CCCCC1CCC1(401)',
    structure = SMILES('CCCCC1CCC1'),
    E0 = (-90.2895,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.213,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.402104,0.0578047,4.47476e-05,-8.96316e-08,3.55926e-11,-10711,30.7853], Tmin=(100,'K'), Tmax=(1004.09,'K')), NASAPolynomial(coeffs=[15.3413,0.0494615,-1.92311e-05,3.60138e-09,-2.57579e-13,-16290.6,-54.1933], Tmin=(1004.09,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-90.2895,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(565.384,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cyclobutane)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', '[CH2]CC(=C)CCCC(471)'],
    products = ['[CH2]CC([CH2])CCCC(400)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', '[CH2]C(C=C)CCCC(472)'],
    products = ['[CH2]CC([CH2])CCCC(400)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['buten3yl1(363)', 'butyl_1(82)'],
    products = ['[CH2]CC([CH2])CCCC(400)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['C=CCCCC(193)', 'C2H4(T)(94)'],
    products = ['[CH2]CC([CH2])CCCC(400)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2][CH]CCCC(197)', 'C2H4(21)'],
    products = ['[CH2]CC([CH2])CCCC(400)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]CCCC(C)C[CH2](483)'],
    products = ['[CH2]CC([CH2])CCCC(400)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2][CH]CCCC(197)', 'C2H4(T)(94)'],
    products = ['[CH2]CC([CH2])CCCC(400)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[CH2]C[CH]CCCC(199)', 'CH2(19)'],
    products = ['[CH2]CC([CH2])CCCC(400)'],
...
reaction(
    label = 'reaction27',
    reactants = ['CH2(19)', '[CH2]C([CH2])CCCC(488)'],
    products = ['[CH2]CC([CH2])CCCC(400)'],
