...
species(
    label = 'C=C(C)C([O])CC(10612)',
    structure = SMILES('C=C(C)C([O])CC'),
    E0 = (-21.803,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2950,3100,1380,975,1025,1650,350,440,435,1725,1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,180,552.922,4000],'cm^-1')),
        HinderedRotor(inertia=(0.722303,'amu*angstrom^2'), symmetry=1, barrier=(16.6072,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.035262,'amu*angstrom^2'), symmetry=1, barrier=(16.6173,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.722595,'amu*angstrom^2'), symmetry=1, barrier=(16.6139,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.722419,'amu*angstrom^2'), symmetry=1, barrier=(16.6098,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (99.1509,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.45818,0.067525,-3.66164e-05,3.23451e-09,2.51588e-12,-2486.1,28.8735], Tmin=(100,'K'), Tmax=(1127.47,'K')), NASAPolynomial(coeffs=[14.5385,0.0339144,-1.36433e-05,2.50716e-09,-1.73587e-13,-6699.88,-45.3517], Tmin=(1127.47,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-21.803,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(415.724,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(CC(C)OJ)"""),
)
...
species(
    label = 'CCC([O])[C](C)C(10613)',
    structure = SMILES('CCC([O])[C](C)C'),
    E0 = (12.9055,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (100.159,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.560193,0.0644422,-2.17101e-05,-1.13649e-08,7.22577e-12,1685.47,27.8323], Tmin=(100,'K'), Tmax=(1085.86,'K')), NASAPolynomial(coeffs=[13.3239,0.0386832,-1.54939e-05,2.84877e-09,-1.97806e-13,-2339.76,-40.5678], Tmin=(1085.86,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(12.9055,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(CCJ(C)CO)"""),
)

species(
    label = '[CH2]C(C)[C](O)CC(10614)',
    structure = SMILES('[CH2]C(C)[C](O)CC'),
    E0 = (11.6809,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (100.159,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.334316,0.0814453,-7.44031e-05,4.00303e-08,-9.11184e-12,1536.21,30.5398], Tmin=(100,'K'), Tmax=(1038.92,'K')), NASAPolynomial(coeffs=[10.7106,0.0414947,-1.67217e-05,3.01621e-09,-2.0487e-13,-619.79,-19.9157], Tmin=(1038.92,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(11.6809,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(C2CsJOH) + radical(Isobutyl)"""),
)

species(
    label = 'CC[C]([O])C(C)C(10615)',
    structure = SMILES('CC[C]([O])C(C)C'),
    E0 = (36.9594,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (100.159,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.498979,0.0756266,-5.57865e-05,2.23445e-08,-3.78791e-12,4572.05,27.2737], Tmin=(100,'K'), Tmax=(1344.77,'K')), NASAPolynomial(coeffs=[12.1916,0.0408477,-1.69935e-05,3.11327e-09,-2.1277e-13,1427.24,-32.6], Tmin=(1344.77,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(36.9594,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(C2CsJOH)"""),
)

species(
    label = '[CH2][C](C)C(O)CC(10616)',
    structure = SMILES('[CH2][C](C)C(O)CC'),
    E0 = (-12.373,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (100.159,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.388898,0.070471,-4.15184e-05,8.23716e-09,1.01978e-12,-1350.58,31.1113], Tmin=(100,'K'), Tmax=(1095.5,'K')), NASAPolynomial(coeffs=[13.0977,0.0372279,-1.40207e-05,2.46963e-09,-1.66605e-13,-4924.78,-34.9649], Tmin=(1095.5,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-12.373,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJ(C)CO) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]C(C)C(O)[CH]C(10617)',
    structure = SMILES('[CH2]C(C)C(O)[CH]C'),
    E0 = (34.9552,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3615,1277.5,1000,3000,3100,440,815,1455,1000,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,209.258,943.636],'cm^-1')),
        HinderedRotor(inertia=(0.128987,'amu*angstrom^2'), symmetry=1, barrier=(3.48587,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.128987,'amu*angstrom^2'), symmetry=1, barrier=(3.48587,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.128987,'amu*angstrom^2'), symmetry=1, barrier=(3.48587,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.128987,'amu*angstrom^2'), symmetry=1, barrier=(3.48587,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.128987,'amu*angstrom^2'), symmetry=1, barrier=(3.48587,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (100.159,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.34777,0.0715198,-4.30863e-05,7.30174e-09,2.09627e-12,4343.21,33.5579], Tmin=(100,'K'), Tmax=(1035.63,'K')), NASAPolynomial(coeffs=[13.7005,0.0353387,-1.29755e-05,2.2696e-09,-1.53289e-13,752.086,-35.3138], Tmin=(1035.63,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(34.9552,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJCO) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]C([CH2])C(O)CC(10618)',
    structure = SMILES('[CH2]C([CH2])C(O)CC'),
    E0 = (40.1354,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (100.159,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.133395,0.0788675,-6.57621e-05,3.12011e-08,-6.10624e-12,4971.55,32.9187], Tmin=(100,'K'), Tmax=(1218.8,'K')), NASAPolynomial(coeffs=[13.3073,0.0356311,-1.25489e-05,2.09358e-09,-1.35582e-13,1760.37,-33.2439], Tmin=(1218.8,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(40.1354,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Isobutyl) + radical(Isobutyl)"""),
)

species(
    label = 'C[CH]C([O])C(C)C(10619)',
    structure = SMILES('C[CH]C([O])C(C)C'),
    E0 = (60.2336,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (100.159,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.490205,0.0658286,-2.44402e-05,-1.083e-08,7.69494e-12,7380.51,30.3826], Tmin=(100,'K'), Tmax=(1056.4,'K')), NASAPolynomial(coeffs=[14.066,0.0365617,-1.43167e-05,2.61789e-09,-1.81951e-13,3276.99,-41.7041], Tmin=(1056.4,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(60.2336,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(CCJCO)"""),
)

species(
    label = '[CH2]CC(O)C([CH2])C(10620)',
    ...
    molecularWeight = (100.159,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.235436,0.076909,-6.00176e-05,2.5869e-08,-4.62199e-12,4987.25,33.2523], Tmin=(100,'K'), Tmax=(1315.64,'K')), NASAPolynomial(coeffs=[13.6108,0.0362437,-1.36543e-05,2.37569e-09,-1.57794e-13,1467.8,-34.9453], Tmin=(1315.64,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(40.2995,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJ) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]CC([O])C(C)C(10621)',
    ...
    molecularWeight = (100.159,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0974386,0.0741947,-5.03409e-05,1.75032e-08,-2.46948e-12,8037.42,31.1064], Tmin=(100,'K'), Tmax=(1650.43,'K')), NASAPolynomial(coeffs=[17.3949,0.0322718,-1.22386e-05,2.11214e-09,-1.38079e-13,2327.84,-61.0104], Tmin=(1650.43,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(65.5779,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJ) + radical(CC(C)OJ)"""),
)

species(
    label = 'C=C(C)C(O)CC(10622)',
    structure = SMILES('C=C(C)C(O)CC'),
    E0 = (-252.164,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (100.159,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.2645,0.0718565,-4.35743e-05,9.44007e-09,4.96493e-13,-30185.2,29.7622], Tmin=(100,'K'), Tmax=(1165.75,'K')), NASAPolynomial(coeffs=[14.9228,0.0351951,-1.3946e-05,2.52983e-09,-1.73323e-13,-34529.3,-47.1775], Tmin=(1165.75,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-252.164,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH)"""),
)

species(
    label = 'CCC(=O)C(C)C(10623)',
    structure = SMILES('CCC(=O)C(C)C'),
    E0 = (-313.152,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (100.159,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.05676,0.0702144,-5.04907e-05,2.19127e-08,-4.46992e-12,-37562.1,24.3036], Tmin=(100,'K'), Tmax=(1056.85,'K')), NASAPolynomial(coeffs=[6.25949,0.050523,-2.25426e-05,4.28299e-09,-2.99587e-13,-38661.8,-1.08426], Tmin=(1056.85,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-313.152,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)CsCsH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdCsCs)"""),
)
...
species(
    label = '[CH2]C(C)C(C)[O](1219)',
    structure = SMILES('[CH2]C(C)C(C)[O]'),
    E0 = (89.1941,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,3000,3100,440,815,1455,1000,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,180,3176.33],'cm^-1')),
        HinderedRotor(inertia=(0.237756,'amu*angstrom^2'), symmetry=1, barrier=(5.46647,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0358833,'amu*angstrom^2'), symmetry=1, barrier=(15.0964,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0359045,'amu*angstrom^2'), symmetry=1, barrier=(15.0954,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(3.53158,'amu*angstrom^2'), symmetry=1, barrier=(81.1979,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.1323,'amu'),
...
species(
    label = 'CCC1OCC1C(10583)',
    structure = SMILES('CCC1OCC1C'),
    E0 = (-189.345,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (100.159,'amu'),
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'C=C(C)C([O])CC(10612)'],
    products = ['[CH2]C(C)C([O])CC(10581)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', '[CH2]C(C)C(=O)CC(6784)'],
    products = ['[CH2]C(C)C([O])CC(10581)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['CH3(17)', 'C=CC([O])CC(10590)'],
    products = ['[CH2]C(C)C([O])CC(10581)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['C2H5(29)', 'iC4H7OJ_48(1671)'],
    products = ['[CH2]C(C)C([O])CC(10581)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]C(C)C(O)[CH]C(10617)'],
    products = ['[CH2]C(C)C([O])CC(10581)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2]C([CH2])C(O)CC(10618)'],
    products = ['[CH2]C(C)C([O])CC(10581)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]CC(O)C([CH2])C(10620)'],
    products = ['[CH2]C(C)C([O])CC(10581)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]CC([O])C(C)C(10621)'],
    products = ['[CH2]C(C)C([O])CC(10581)'],
...
reaction(
    label = 'reaction20',
    reactants = ['CH2(S)(23)', '[CH2]CC([O])CC(10552)'],
    products = ['[CH2]C(C)C([O])CC(10581)'],
...
reaction(
    label = 'reaction21',
    reactants = ['CH2(S)(23)', '[CH2]C(C)C(C)[O](1219)'],
    products = ['[CH2]C(C)C([O])CC(10581)'],
...
reaction(
    label = 'reaction25',
    reactants = ['CH2(19)', 'C[CH]C([O])CC(10592)'],
    products = ['[CH2]C(C)C([O])CC(10581)'],
...
reaction(
    label = 'reaction26',
    reactants = ['O(4)', '[CH2]C(C)[CH]CC(528)'],
    products = ['[CH2]C(C)C([O])CC(10581)'],
