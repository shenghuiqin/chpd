...
species(
    label = '[CH2]C(O)OC=CCCC(12717)',
    structure = SMILES('[CH2]C(O)OC=CCCC'),
    E0 = (-256.6,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,1380,1390,370,380,2900,435,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3100,440,815,1455,1000,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.34967,0.101551,-6.6499e-05,4.52239e-09,8.00544e-12,-30655,38.6404], Tmin=(100,'K'), Tmax=(990.558,'K')), NASAPolynomial(coeffs=[24.64,0.0307562,-1.10159e-05,1.99048e-09,-1.40859e-13,-37479.5,-94.9566], Tmin=(990.558,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-256.6,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(CJCO)"""),
)

species(
    label = 'C=C(O)O[CH]CCCC(12718)',
    structure = SMILES('C=C(O)O[CH]CCCC'),
    E0 = (-220.057,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (129.177,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.02792,0.121621,-0.000124828,6.49622e-08,-1.32278e-11,-26240.4,36.3147], Tmin=(100,'K'), Tmax=(1203.22,'K')), NASAPolynomial(coeffs=[25.4264,0.0303512,-1.10456e-05,1.91857e-09,-1.28809e-13,-32847.1,-101.216], Tmin=(1203.22,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-220.057,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(CCsJOC(O))"""),
)
...
species(
    ...
    molecularWeight = (130.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.51404,0.102813,-9.02949e-05,4.42733e-08,-9.21707e-12,-15891.2,40.2193], Tmin=(100,'K'), Tmax=(1117.16,'K')), NASAPolynomial(coeffs=[13.3528,0.053163,-2.363e-05,4.49101e-09,-3.14515e-13,-18989.5,-28.2163], Tmin=(1117.16,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-133.454,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(523.812,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJCO) + radical(CCJCO)"""),
)

species(
    label = 'CCCC[CH]O[C](C)O(12026)',
    structure = SMILES('CCCC[CH]O[C](C)O'),
    E0 = (-159.242,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (130.185,'amu'),
...
species(
    label = '[CH2][C](O)OCCCCC(12720)',
    structure = SMILES('[CH2][C](O)OCCCCC'),
    E0 = (-128.109,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (130.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.614176,0.107894,-0.000105541,6.01169e-08,-1.46625e-11,-15247.2,38.784], Tmin=(100,'K'), Tmax=(963.458,'K')), NASAPolynomial(coeffs=[11.7178,0.0566939,-2.58252e-05,4.956e-09,-3.48845e-13,-17623.4,-20.2513], Tmin=(963.458,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-128.109,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(523.812,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Cs_P) + radical(CJCO)"""),
)

species(
    label = '[CH2]C(O)OCC[CH]CC(12721)',
    ...
    molecularWeight = (130.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.135338,0.0984267,-6.74567e-05,-2.77061e-08,5.57304e-11,-16579.6,38.1257], Tmin=(100,'K'), Tmax=(516.322,'K')), NASAPolynomial(coeffs=[7.5151,0.063273,-2.92954e-05,5.61244e-09,-3.9267e-13,-17635.2,4.55872], Tmin=(516.322,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-138.897,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(523.812,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJCO) + radical(RCCJCC)"""),
)

species(
    label = 'CCCC[CH]OC(C)[O](11951)',
...
species(
    ...
    molecularWeight = (130.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.630152,0.1095,-0.000122264,8.71211e-08,-2.6977e-11,-16547.2,40.8864], Tmin=(100,'K'), Tmax=(768.474,'K')), NASAPolynomial(coeffs=[8.64859,0.0612038,-2.79954e-05,5.34284e-09,-3.73354e-13,-17973.3,-1.43478], Tmin=(768.474,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-138.909,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(523.812,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJCO) + radical(RCCJC)"""),
)

species(
    label = '[CH2]C([O])OCCCCC(12031)',
    structure = SMILES('[CH2]C([O])OCCCCC'),
    E0 = (-107.65,'kJ/mol'),
    modes = [
...
species(
    ...
    molecularWeight = (130.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.614176,0.107894,-0.000105541,6.01169e-08,-1.46625e-11,-15247.2,39.8827], Tmin=(100,'K'), Tmax=(963.458,'K')), NASAPolynomial(coeffs=[11.7178,0.0566939,-2.58252e-05,4.956e-09,-3.48845e-13,-17623.4,-19.1527], Tmin=(963.458,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-128.109,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(523.812,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJCO) + radical(RCCJ)"""),
)

species(
    label = 'CC[CH]C[CH]OC(C)O(12034)',
...
species(
    ...
    molecularWeight = (130.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.719732,0.110584,-0.000118818,7.74133e-08,-2.1552e-11,-20287.4,40.0226], Tmin=(100,'K'), Tmax=(854.619,'K')), NASAPolynomial(coeffs=[10.5954,0.0576252,-2.58681e-05,4.90713e-09,-3.42341e-13,-22221.4,-12.7888], Tmin=(854.619,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-170.042,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(523.812,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJC) + radical(CCsJOCs)"""),
)

species(
    label = '[CH2]CCC[CH]OC(C)O(12036)',
...
species(
    label = 'C=C(O)OCCCCC(12724)',
    structure = SMILES('C=C(O)OCCCCC'),
    E0 = (-413.984,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (130.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.7977,0.113738,-0.000102742,4.77941e-08,-8.80869e-12,-49570.5,36.0212], Tmin=(100,'K'), Tmax=(1315.38,'K')), NASAPolynomial(coeffs=[24.1282,0.0348999,-1.28391e-05,2.22969e-09,-1.48857e-13,-56391.1,-96.1633], Tmin=(1315.38,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-413.984,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(527.969,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH)"""),
)

species(
    label = 'CCCC=COC(C)O(12038)',
    ...
    molecularWeight = (130.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.19485,0.0963253,-4.65876e-05,-1.49049e-08,1.4305e-11,-56107.2,37.4513], Tmin=(100,'K'), Tmax=(990.328,'K')), NASAPolynomial(coeffs=[23.8577,0.0344853,-1.25214e-05,2.28377e-09,-1.62456e-13,-62998.8,-92.9114], Tmin=(990.328,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-468.189,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(527.969,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH)"""),
)
...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.448314,0.101182,-0.000107138,6.28159e-08,-1.51546e-11,-15372,34.6929], Tmin=(100,'K'), Tmax=(993.97,'K')), NASAPolynomial(coeffs=[14.1021,0.0426271,-1.87723e-05,3.54818e-09,-2.47774e-13,-18264.6,-35.4166], Tmin=(993.97,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-129.119,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJCO) + radical(CCsJOCs)"""),
)

species(
    label = '[CH2]C(O)OC([CH2])CCC(12726)',
    structure = SMILES('[CH2]C(O)OC([CH2])CCC'),
    E0 = (-133.396,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1277.5,1000,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (130.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.1237,0.119132,-0.000132474,8.41813e-08,-2.2261e-11,-15864.9,39.3323], Tmin=(100,'K'), Tmax=(906.591,'K')), NASAPolynomial(coeffs=[13.6945,0.0537516,-2.42973e-05,4.63186e-09,-3.24336e-13,-18551.7,-30.7036], Tmin=(906.591,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-133.396,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(523.812,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJCO) + radical(CJC(C)OC)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(O)O[CH]CCCC(12029)'],
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', '[CH2]C(O)OC=CCCC(12717)'],
    products = ['[CH2]C(O)O[CH]CCCC(12029)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'C=C(O)O[CH]CCCC(12718)'],
    products = ['[CH2]C(O)O[CH]CCCC(12029)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['npropyl(83)', '[CH2]C(O)OC=C(4702)'],
    products = ['[CH2]C(O)O[CH]CCCC(12029)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['OH(5)', 'C=CO[CH]CCCC(10647)'],
    products = ['[CH2]C(O)O[CH]CCCC(12029)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2]C(O)OC[CH]CCC(12719)'],
    products = ['[CH2]C(O)O[CH]CCCC(12029)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]C(O)O[CH]CCCC(12029)'],
    products = ['CCCC[CH]O[C](C)O(12026)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2][C](O)OCCCCC(12720)'],
    products = ['[CH2]C(O)O[CH]CCCC(12029)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]C(O)OCC[CH]CC(12721)'],
    products = ['[CH2]C(O)O[CH]CCCC(12029)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CCCC[CH]OC(C)[O](11951)'],
    products = ['[CH2]C(O)O[CH]CCCC(12029)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]C(O)OCCC[CH]C(12722)'],
    products = ['[CH2]C(O)O[CH]CCCC(12029)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2]C([O])OCCCCC(12031)'],
    products = ['[CH2]C(O)O[CH]CCCC(12029)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]C(O)O[CH]CCCC(12029)'],
    products = ['CCC[CH][CH]OC(C)O(12032)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]CCCCOC([CH2])O(12723)'],
    products = ['[CH2]C(O)O[CH]CCCC(12029)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]C(O)O[CH]CCCC(12029)'],
    products = ['CC[CH]C[CH]OC(C)O(12034)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]C(O)O[CH]CCCC(12029)'],
    products = ['C[CH]CC[CH]OC(C)O(12035)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2]C(O)O[CH]CCCC(12029)'],
    products = ['[CH2]CCC[CH]OC(C)O(12036)'],
...
reaction(
    label = 'reaction22',
    reactants = ['CH2(S)(23)', '[CH2]C(O)O[CH]CCC(12725)'],
    products = ['[CH2]C(O)O[CH]CCCC(12029)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH2]C(O)OC([CH2])CCC(12726)'],
    products = ['[CH2]C(O)O[CH]CCCC(12029)'],
