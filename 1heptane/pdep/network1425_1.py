...
species(
    label = 'C[CH]O[C](O)CC(C)OO(7498)',
    structure = SMILES('C[CH]O[C](O)CC(C)OO'),
    E0 = (-236.427,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (148.157,'amu'),
...
species(
    label = '[CH2]COC([O])CC(C)OO(7499)',
    structure = SMILES('[CH2]COC([O])CC(C)OO'),
    E0 = (-184.836,'kJ/mol'),
    modes = [
...
species(
    label = 'CCO[C]([O])CC(C)OO(7500)',
    structure = SMILES('CCO[C]([O])CC(C)OO'),
    E0 = (-191.178,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (148.157,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.200261,0.108383,-8.65308e-05,-2.34216e-08,6.52194e-11,-22858.2,38.5879], Tmin=(100,'K'), Tmax=(503.697,'K')), NASAPolynomial(coeffs=[8.70436,0.0637369,-3.12063e-05,6.10157e-09,-4.30774e-13,-24086,-1.54768], Tmin=(503.697,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-191.178,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(498.868,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Cs_P) + radical(CCOJ)"""),
)

species(
    label = 'C[CH]OC(O)[CH]C(C)OO(7501)',
    structure = SMILES('C[CH]OC(O)[CH]C(C)OO'),
    E0 = (-241.259,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3050,390,425,1340,1360,335,370,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,3615,1310,387.5,850,1000,3615,1277.5,1000,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'C[CH]OC(O)C[C](C)OO(7502)',
    structure = SMILES('C[CH]OC(O)C[C](C)OO'),
    E0 = (-254.775,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (148.157,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.42533,0.130697,-0.000165992,1.12271e-07,-2.74133e-11,-30457.5,41.0197], Tmin=(100,'K'), Tmax=(643.218,'K')), NASAPolynomial(coeffs=[13.2081,0.0552456,-2.62985e-05,5.06971e-09,-3.54868e-13,-32661.6,-25.6212], Tmin=(643.218,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-254.775,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(494.711,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(C2CsJOOH) + radical(CCsJOCs)"""),
)

species(
    label = 'CCOC([O])[CH]C(C)OO(7503)',
    structure = SMILES('CCOC([O])[CH]C(C)OO'),
    E0 = (-196.01,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3025,407.5,1350,352.5,3615,1310,387.5,850,1000,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (148.157,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0648614,0.104541,-5.99644e-05,-9.63136e-08,1.3024e-10,-23451.4,39.3479], Tmin=(100,'K'), Tmax=(469.547,'K')), NASAPolynomial(coeffs=[8.51633,0.0640703,-3.13927e-05,6.11413e-09,-4.29529e-13,-24592.6,1.26286], Tmin=(469.547,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-196.01,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(498.868,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(CCJCOOH)"""),
)

species(
    label = '[CH2][CH]OC(O)CC(C)OO(7504)',
...
species(
    label = '[CH2]C(CC(O)O[CH]C)OO(7505)',
    structure = SMILES('[CH2]C(CC(O)O[CH]C)OO'),
    E0 = (-227.711,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (148.157,'amu'),
...
species(
    label = 'CCOC([O])C[C](C)OO(7506)',
    structure = SMILES('CCOC([O])C[C](C)OO'),
    E0 = (-209.526,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,360,370,350,3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (148.157,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.16523,0.126643,-0.000184612,1.67375e-07,-6.1824e-11,-25026.7,41.4455], Tmin=(100,'K'), Tmax=(794.433,'K')), NASAPolynomial(coeffs=[6.14591,0.0682656,-3.36679e-05,6.53662e-09,-4.56717e-13,-25507.9,12.1392], Tmin=(794.433,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-209.526,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(498.868,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(C2CsJOOH)"""),
)

species(
    label = 'C[CH]OC(O)CC(C)O[O](7507)',
    structure = SMILES('C[CH]OC(O)CC(C)O[O]'),
    E0 = (-289.669,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (148.157,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.44916,0.12695,-0.00015744,1.09216e-07,-3.09526e-11,-34649.2,41.5377], Tmin=(100,'K'), Tmax=(855.314,'K')), NASAPolynomial(coeffs=[14.9542,0.0502381,-2.29085e-05,4.35815e-09,-3.03856e-13,-37455.2,-35.0354], Tmin=(855.314,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-289.669,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(498.868,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(CCsJOCs)"""),
)

species(
    label = '[CH2]C(CC([O])OCC)OO(7508)',
    structure = SMILES('[CH2]C(CC([O])OCC)OO'),
    E0 = (-182.462,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1310,387.5,850,1000,3000,3100,440,815,1455,1000,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (148.157,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.549885,0.114576,-0.000113239,3.18047e-08,2.26621e-11,-21795.4,41.0834], Tmin=(100,'K'), Tmax=(542.393,'K')), NASAPolynomial(coeffs=[9.569,0.0622916,-3.04235e-05,5.949e-09,-4.20367e-13,-23221.6,-4.57316], Tmin=(542.393,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-182.462,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(498.868,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJCOOH) + radical(CCOJ)"""),
)

species(
    label = 'CCOC([O])CC(C)O[O](7509)',
    structure = SMILES('CCOC([O])CC(C)O[O]'),
    E0 = (-244.42,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,492.5,1135,1000,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (148.157,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.430547,0.0964117,-3.19636e-05,-1.51086e-07,1.7448e-10,-29287.2,36.5399], Tmin=(100,'K'), Tmax=(452.044,'K')), NASAPolynomial(coeffs=[7.84218,0.0633791,-3.0364e-05,5.8484e-09,-4.07835e-13,-30289.8,2.98914], Tmin=(452.044,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-244.42,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(CCOJ)"""),
)
...
species(
    label = 'CCOC(=O)CC(C)OO(7510)',
    structure = SMILES('CCOC(=O)CC(C)OO'),
    E0 = (-613.65,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (148.157,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.327667,0.103599,-9.68522e-05,5.41781e-08,-1.34334e-11,-73656.3,36.0963], Tmin=(100,'K'), Tmax=(930.312,'K')), NASAPolynomial(coeffs=[9.43199,0.0616363,-2.91928e-05,5.69299e-09,-4.04159e-13,-75472.2,-10.2834], Tmin=(930.312,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-613.65,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(498.868,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdCsOs)"""),
)

species(
    label = 'C=COC(O)CC(C)OO(7511)',
    structure = SMILES('C=COC(O)CC(C)OO'),
    E0 = (-534.264,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (148.157,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.38929,0.123156,-0.000119601,5.74327e-08,-1.0724e-11,-64012.4,42.3963], Tmin=(100,'K'), Tmax=(1312.76,'K')), NASAPolynomial(coeffs=[29.1111,0.0271725,-9.92647e-06,1.73571e-09,-1.17107e-13,-72282.8,-118.147], Tmin=(1312.76,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-534.264,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(498.868,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH)"""),
)
...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.905944,0.117885,-0.000173053,1.48331e-07,-5.16817e-11,-21427.3,37.7706], Tmin=(100,'K'), Tmax=(788.904,'K')), NASAPolynomial(coeffs=[9.86304,0.0517254,-2.52841e-05,4.8884e-09,-3.40769e-13,-22766.8,-9.35063], Tmin=(788.904,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-179.546,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(428.195,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCsJOCs) + radical(CCOJ)"""),
)
...
species(
    label = 'C[CH]OC1CC(C)OO1(7513)',
    structure = SMILES('C[CH]OC1CC(C)OO1'),
    E0 = (-197.421,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (131.15,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.344644,0.0798504,-2.31997e-05,-3.68202e-08,2.36769e-11,-23573.2,30.8325], Tmin=(100,'K'), Tmax=(917.042,'K')), NASAPolynomial(coeffs=[20.7266,0.0292401,-7.96961e-06,1.2171e-09,-8.05748e-14,-29174.4,-78.4673], Tmin=(917.042,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-197.421,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(465.61,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(12dioxolane) + radical(CCsJOCs)"""),
)

species(
    label = 'CC1CC([O])OC(C)O1(7514)',
    structure = SMILES('CC1CC([O])OC(C)O1'),
    E0 = (-419.142,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (131.15,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.735069,0.0561627,2.72643e-05,-7.62799e-08,3.50877e-11,-50279,26.1752], Tmin=(100,'K'), Tmax=(908.402,'K')), NASAPolynomial(coeffs=[14.1833,0.0381356,-1.09835e-05,1.70529e-09,-1.11617e-13,-54421.8,-46.7671], Tmin=(908.402,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-419.142,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(473.925,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(1,3-Dioxane) + radical(CCOJ)"""),
)

species(
    label = 'CC(CC1OC(C)O1)OO(7401)',
    structure = SMILES('CC(CC1OC(C)O1)OO'),
    E0 = (-473.598,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (148.157,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.11037,0.0971025,-6.50302e-05,1.83204e-08,-1.3366e-12,-56764.1,38.1374], Tmin=(100,'K'), Tmax=(1307.42,'K')), NASAPolynomial(coeffs=[22.7655,0.0398412,-1.74456e-05,3.29163e-09,-2.28737e-13,-64356.4,-88.6094], Tmin=(1307.42,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-473.598,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Cyclobutane)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['C[CH]OC([O])CC(C)OO(7398)'],
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'C[CH]OC(=O)CC(C)OO(4305)'],
    products = ['C[CH]OC([O])CC(C)OO(7398)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'C=COC([O])CC(C)OO(7497)'],
    products = ['C[CH]OC([O])CC(C)OO(7398)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CH3CHO(37)', 'CC(C[CH][O])OO(1991)'],
    products = ['C[CH]OC([O])CC(C)OO(7398)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['QOOH_3(717)', 'C[CH]OC=O(2205)'],
    products = ['C[CH]OC([O])CC(C)OO(7398)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['C[CH]OC([O])CC(C)OO(7398)'],
    products = ['C[CH]O[C](O)CC(C)OO(7498)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2]COC([O])CC(C)OO(7499)'],
    products = ['C[CH]OC([O])CC(C)OO(7398)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['CCO[C]([O])CC(C)OO(7500)'],
    products = ['C[CH]OC([O])CC(C)OO(7398)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['C[CH]OC(O)[CH]C(C)OO(7501)'],
    products = ['C[CH]OC([O])CC(C)OO(7398)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['C[CH]OC([O])CC(C)OO(7398)'],
    products = ['C[CH]OC(O)C[C](C)OO(7502)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CCOC([O])[CH]C(C)OO(7503)'],
    products = ['C[CH]OC([O])CC(C)OO(7398)'],
...
reaction(
    label = 'reaction12',
    reactants = ['C[CH]OC([O])CC(C)OO(7398)'],
    products = ['[CH2][CH]OC(O)CC(C)OO(7504)'],
...
reaction(
    label = 'reaction13',
    reactants = ['C[CH]OC([O])CC(C)OO(7398)'],
    products = ['[CH2]C(CC(O)O[CH]C)OO(7505)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CCOC([O])C[C](C)OO(7506)'],
    products = ['C[CH]OC([O])CC(C)OO(7398)'],
...
reaction(
    label = 'reaction15',
    reactants = ['C[CH]OC([O])CC(C)OO(7398)'],
    products = ['C[CH]OC(O)CC(C)O[O](7507)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]C(CC([O])OCC)OO(7508)'],
    products = ['C[CH]OC([O])CC(C)OO(7398)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CCOC([O])CC(C)O[O](7509)'],
    products = ['C[CH]OC([O])CC(C)OO(7398)'],
...
reaction(
    label = 'reaction21',
    reactants = ['CH2(S)(23)', 'C[CH]OC([O])CCOO(7512)'],
    products = ['C[CH]OC([O])CC(C)OO(7398)'],
...
reaction(
    label = 'reaction22',
    reactants = ['C[CH]OC([O])CC(C)OO(7398)'],
    products = ['OH(5)', 'C[CH]OC1CC(C)OO1(7513)'],
...
reaction(
    label = 'reaction23',
    reactants = ['C[CH]OC([O])CC(C)OO(7398)'],
    products = ['OH(5)', 'CC1CC([O])OC(C)O1(7514)'],
...
reaction(
    label = 'reaction24',
    reactants = ['C[CH]OC([O])CC(C)OO(7398)'],
    products = ['CC(CC1OC(C)O1)OO(7401)'],
...
reaction(
    label = 'reaction25',
    reactants = ['CHCH3(T)(95)', 'CC(CC([O])[O])OO(7426)'],
    products = ['C[CH]OC([O])CC(C)OO(7398)'],
...
reaction(
    label = 'reaction26',
    reactants = ['O(4)', 'C[CH]O[CH]CC(C)OO(6140)'],
    products = ['C[CH]OC([O])CC(C)OO(7398)'],
