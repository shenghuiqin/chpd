...
species(
    label = 'CCC=CCC[CH]O(3568)',
    structure = SMILES('CCC=CCC[CH]O'),
    E0 = (-78.5027,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2995,3025,975,1000,1300,1375,400,500,1630,1680,3025,407.5,1350,352.5,3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (113.178,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0328638,0.0872433,-6.94422e-05,3.05304e-08,-5.6853e-12,-9299.04,33.5323], Tmin=(100,'K'), Tmax=(1238.46,'K')), NASAPolynomial(coeffs=[12.8248,0.0459278,-1.94017e-05,3.5934e-09,-2.47699e-13,-12467.5,-30.917], Tmin=(1238.46,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-78.5027,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(482.239,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(CCsJOH)"""),
)

species(
    label = 'CCCC=CC[CH]O(3569)',
    structure = SMILES('CCCC=CC[CH]O'),
    E0 = (-78.5027,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2995,3025,975,1000,1300,1375,400,500,1630,1680,3025,407.5,1350,352.5,3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    ...
    molecularWeight = (113.178,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.354588,0.0842319,-5.11296e-05,6.26589e-09,3.88707e-12,-12124.6,34.8644], Tmin=(100,'K'), Tmax=(1025.94,'K')), NASAPolynomial(coeffs=[17.2478,0.0371386,-1.37627e-05,2.44499e-09,-1.67605e-13,-16869.8,-56.0314], Tmin=(1025.94,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-102.197,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(482.239,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(RCCJCC)"""),
)
...
species(
    label = 'CC[CH]CCC[CH]O(3571)',
    structure = SMILES('CC[CH]CCC[CH]O'),
    E0 = (-0.716092,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,3000,3050,390,425,1340,1360,335,370,3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'C[CH]CCCC[CH]O(3572)',
    structure = SMILES('C[CH]CCCC[CH]O'),
    E0 = (-0.728118,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (114.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.357878,0.0902842,-6.6433e-05,-9.08092e-10,2.66673e-11,33.867,34.5128], Tmin=(100,'K'), Tmax=(556.143,'K')), NASAPolynomial(coeffs=[7.10951,0.0585096,-2.60057e-05,4.90138e-09,-3.40378e-13,-976.694,3.5676], Tmin=(556.143,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-0.728118,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(RCCJC) + radical(CCsJOH)"""),
)

species(
    label = 'CCCCC[CH][CH]O(3573)',
    structure = SMILES('CCCCC[CH][CH]O'),
    E0 = (4.72766,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,3000,3050,390,425,1340,1360,335,370,3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (114.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.116299,0.0923681,-7.66193e-05,3.60211e-08,-7.24205e-12,715.213,35.8648], Tmin=(100,'K'), Tmax=(1149.9,'K')), NASAPolynomial(coeffs=[12.0645,0.0499965,-2.13473e-05,3.97658e-09,-2.75241e-13,-2086.12,-24.6016], Tmin=(1149.9,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(4.72766,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCsJOH) + radical(CCJCO)"""),
)
...
species(
    label = '[CH2]CCCCC[CH]O(3574)',
    structure = SMILES('[CH2]CCCCC[CH]O'),
    E0 = (10.072,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (114.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.193099,0.0971837,-9.09878e-05,5.07994e-08,-1.2263e-11,1358.2,35.444], Tmin=(100,'K'), Tmax=(969.356,'K')), NASAPolynomial(coeffs=[10.3604,0.0536353,-2.36006e-05,4.45456e-09,-3.10602e-13,-687.833,-15.1422], Tmin=(969.356,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(10.072,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCsJOH) + radical(RCCJ)"""),
)
...
species(
    label = 'CCCCCC=CO(3575)',
    structure = SMILES('CCCCCC=CO'),
    E0 = (-296.655,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (114.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.579953,0.0834489,-2.62767e-05,-3.07412e-08,1.939e-11,-35499,33.1083], Tmin=(100,'K'), Tmax=(969.168,'K')), NASAPolynomial(coeffs=[21.2779,0.0335718,-1.15093e-05,2.04354e-09,-1.44135e-13,-41630.1,-81.4317], Tmin=(969.168,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-296.655,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH)"""),
)
...
species(
    label = '[CH2]C(CC)CC[CH]O(3576)',
    structure = SMILES('[CH2]C(CC)CC[CH]O'),
    E0 = (7.56083,'kJ/mol'),
    modes = [
...
species(
    label = 'CCCC1CCC1O(1294)',
    structure = SMILES('CCCC1CCC1O'),
    E0 = (-238.98,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (114.185,'amu'),
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'CCC[CH]CCC=O(1225)'],
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'CCC=CCC[CH]O(3568)'],
    products = ['CCC[CH]CC[CH]O(1289)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', 'CCCC=CC[CH]O(3569)'],
    products = ['CCC[CH]CC[CH]O(1289)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(1.46e+08,'cm^3/(mol*s)'), n=1.64, Ea=(5.73208,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""From training reaction 2555 used for Cds-CsH_Cds-CsH;HJ
Exact match found for rate rule [Cds-CsH_Cds-CsH;HJ]
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)', 'CCC[CH]CC=CO(3570)'],
    products = ['CCC[CH]CC[CH]O(1289)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['C2H5(29)', 'C=CCC[CH]O(2985)'],
    products = ['CCC[CH]CC[CH]O(1289)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction26',
    reactants = ['CH2(S)(23)', 'CC[CH]CC[CH]O(1269)'],
    products = ['CCC[CH]CC[CH]O(1289)'],
...
reaction(
    label = 'reaction27',
    reactants = ['[CH2]C(CC)CC[CH]O(3576)'],
    products = ['CCC[CH]CC[CH]O(1289)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[CH2]C(O)C[CH]CCC(1291)'],
    products = ['CCC[CH]CC[CH]O(1289)'],
...
reaction(
    label = 'reaction31',
    reactants = ['[CH]CCC(133)', '[CH2]C[CH]O(562)'],
    products = ['CCC[CH]CC[CH]O(1289)'],
...
reaction(
    label = 'reaction32',
    reactants = ['HCOH(T)(285)', '[CH2]C[CH]CCC(203)'],
    products = ['CCC[CH]CC[CH]O(1289)'],
