...
species(
    ...
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0972182,0.0893048,-8.13822e-05,4.20774e-08,-9.05186e-12,13787.7,34.8393], Tmin=(100,'K'), Tmax=(1104.12,'K')), NASAPolynomial(coeffs=[13.0525,0.0416661,-1.66629e-05,2.99994e-09,-2.03759e-13,10884,-29.9028], Tmin=(1104.12,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(113.405,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(C2CsJOH) + radical(Isobutyl)"""),
)
...
species(
    label = '[CH2]C(C=C)C(O)[CH]C(20842)',
    structure = SMILES('[CH2]C(C=C)C(O)[CH]C'),
    E0 = (136.68,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,3000,3100,440,815,1455,1000,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0560173,0.0790213,-4.86979e-05,7.4698e-09,2.9811e-12,16593.6,37.7603], Tmin=(100,'K'), Tmax=(1022.66,'K')), NASAPolynomial(coeffs=[15.7485,0.0360153,-1.32106e-05,2.32323e-09,-1.58006e-13,12377.4,-43.6511], Tmin=(1022.66,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(136.68,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Isobutyl) + radical(CCJCO)"""),
)
...
species(
    label = '[CH2]CC(O)C([CH2])C=C(20845)',
    structure = SMILES('[CH2]CC(O)C([CH2])C=C'),
    E0 = (142.024,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3010,987.5,1337.5,450,1655,3615,1277.5,1000,2950,3100,1380,975,1025,1650,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,2750,2850,1437.5,1250,1305,750,350,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.258186,0.0854312,-6.90155e-05,3.01643e-08,-5.38378e-12,17241.6,37.7795], Tmin=(100,'K'), Tmax=(1330.67,'K')), NASAPolynomial(coeffs=[16.1373,0.0361461,-1.34588e-05,2.33032e-09,-1.54466e-13,12878.2,-46.0034], Tmin=(1330.67,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(142.024,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(RCCJ) + radical(Isobutyl)"""),
)
...
species(
    label = '[CH]=CC([CH2])C(O)CC(20847)',
    structure = SMILES('[CH]=CC([CH2])C(O)CC'),
    E0 = (183.874,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.329382,0.0877785,-7.38111e-05,3.36652e-08,-6.25537e-12,22276.9,36.65], Tmin=(100,'K'), Tmax=(1283.79,'K')), NASAPolynomial(coeffs=[16.239,0.0361552,-1.34936e-05,2.34253e-09,-1.5572e-13,18022.9,-47.4218], Tmin=(1283.79,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(183.874,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_P) + radical(Isobutyl)"""),
)
...
species(
    label = 'C=C[CH]C([O])CC(20854)',
    structure = SMILES('C=C[CH]C([O])CC'),
    E0 = (110.725,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,2750,2800,2850,1350,1500,750,1050,1375,1000,2950,3100,1380,975,1025,1650,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,180,180,711.058,711.384],'cm^-1')),
        HinderedRotor(inertia=(0.859127,'amu*angstrom^2'), symmetry=1, barrier=(19.753,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.859273,'amu*angstrom^2'), symmetry=1, barrier=(19.7564,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0550706,'amu*angstrom^2'), symmetry=1, barrier=(19.7547,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.829782,'amu*angstrom^2'), symmetry=1, barrier=(119.627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.319317,0.0703133,-4.31093e-05,7.28013e-09,1.72133e-12,13458.6,27.1489], Tmin=(100,'K'), Tmax=(1112.3,'K')), NASAPolynomial(coeffs=[15.7881,0.0311835,-1.25892e-05,2.32247e-09,-1.61499e-13,8996.81,-53.7131], Tmin=(1112.3,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(110.725,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(390.78,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CC(C)OJ) + radical(C=CCJCO)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]C(C=C)C([O])CC(20587)'],
    products = ['[CH2]C1CC1C([O])CC(20835)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)', '[CH2]C(C=C)C(=O)CC(20148)'],
    products = ['[CH2]C(C=C)C([O])CC(20587)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['C2H3(30)', 'C=CC([O])CC(10590)'],
    products = ['[CH2]C(C=C)C([O])CC(20587)'],
    transitionState = 'TS7',
...
reaction(
    ...
    products = ['[CH2]C(C=C)C([O])CC(20587)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(0.0403742,'m^3/(mol*s)'), n=2.2105, Ea=(96.7547,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [CO-CsH_O;YJ] for rate rule [CO-CsH_O;CJ]
Euclidian distance = 1.0
Multiplied by reaction path degeneracy 2.0
family: R_Addition_MultipleBond
Ea raised from 92.1 to 96.8 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction9',
    reactants = ['C2H5(29)', '[CH2]C(C=C)C=O(19526)'],
    products = ['[CH2]C(C=C)C([O])CC(20587)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]C(C=C)C([O])CC(20587)'],
    products = ['[CH2]C(C=C)[C](O)CC(20838)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]C(C=C)C(O)[CH]C(20842)'],
    products = ['[CH2]C(C=C)C([O])CC(20587)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2]CC(O)C([CH2])C=C(20845)'],
    products = ['[CH2]C(C=C)C([O])CC(20587)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2]C(C=C)C([O])CC(20587)'],
    products = ['[CH]=CC([CH2])C(O)CC(20847)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH2]CC([O])C(C)C=C(20848)'],
    products = ['[CH2]C(C=C)C([O])CC(20587)'],
...
reaction(
    label = 'reaction27',
    reactants = ['CH2(S)(23)', '[CH2]C(C=C)C(C)[O](18950)'],
    products = ['[CH2]C(C=C)C([O])CC(20587)'],
...
reaction(
    label = 'reaction31',
    reactants = ['CH2(19)', 'C=C[CH]C([O])CC(20854)'],
    products = ['[CH2]C(C=C)C([O])CC(20587)'],
...
reaction(
    label = 'reaction32',
    reactants = ['O(4)', '[CH2]C([CH]CC)C=C(3297)'],
    products = ['[CH2]C(C=C)C([O])CC(20587)'],
