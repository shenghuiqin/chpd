...
reaction(
    label = 'reaction1',
    reactants = ['OH(5)', 'CCCCCC(C)[O](230)'],
    products = ['CCCCCC(C)OO(301)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['C[CH]CCCCC(88)', 'HO2(10)'],
    products = ['CCCCCC(C)OO(301)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'CCCCCC(C)O[O](206)'],
    products = ['CCCCCC(C)OO(301)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CH3CHOOH(63)', '[CH2]CCCC(84)'],
    products = ['CCCCCC(C)OO(301)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CH3(17)', 'CCCCC[CH]OO(570)'],
    products = ['CCCCCC(C)OO(301)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['H(3)', 'CCCCC[C](C)OO(209)'],
    products = ['CCCCCC(C)OO(301)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['butyl_1(82)', 'QOOH_3(717)'],
    products = ['CCCCCC(C)OO(301)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(3)', 'CCCC[CH]C(C)OO(210)'],
    products = ['CCCCCC(C)OO(301)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['npropyl(83)', '[CH2]CC(C)OO(2102)'],
    products = ['CCCCCC(C)OO(301)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(8.73e+14,'cm^3/(mol*s)'), n=-0.699, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(200,'K'), Tmax=(2000,'K'), comment="""From training reaction 11 used for C_rad/H2/Cs;C_rad/H2/Cs
Exact match found for rate rule [C_rad/H2/Cs;C_rad/H2/Cs]
...
reaction(
    label = 'reaction10',
    reactants = ['C2H5(29)', '[CH2]CCC(C)OO(1958)'],
    products = ['CCCCCC(C)OO(301)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(3)', 'CC[CH]CCC(C)OO(213)'],
    products = ['CCCCCC(C)OO(301)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(3)', 'CCC[CH]CC(C)OO(212)'],
    products = ['CCCCCC(C)OO(301)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CH3(17)', '[CH2]CCCC(C)OO(586)'],
    products = ['CCCCCC(C)OO(301)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(3)', 'C[CH]CCCC(C)OO(214)'],
    products = ['CCCCCC(C)OO(301)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(3)', '[CH2]C(CCCCC)OO(211)'],
    products = ['CCCCCC(C)OO(301)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(3)', '[CH2]CCCCC(C)OO(215)'],
    products = ['CCCCCC(C)OO(301)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CH2(S)(23)', 'CCCCCCOO(593)'],
    products = ['CCCCCC(C)OO(301)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CH2(S)(23)', 'CCCCC(C)OO(594)'],
    products = ['CCCCCC(C)OO(301)'],
...
network(
    ...
    reactants = [
        ('C[CH]CCCCC(88)', 'HO2(10)'),
        ('H(3)', 'CCCCCC(C)O[O](206)'),
        ('CH3CHOOH(63)', '[CH2]CCCC(84)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
