...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.254739,0.10357,-0.000137017,1.21671e-07,-4.51291e-11,-49645.6,34.105], Tmin=(100,'K'), Tmax=(792.729,'K')), NASAPolynomial(coeffs=[4.5014,0.0632879,-2.99861e-05,5.74872e-09,-3.99804e-13,-49888.1,15.4911], Tmin=(792.729,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-413.971,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(482.239,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsCs) + group(Cds-OdCsH)"""),
)
...
species(
    label = 'CCC[C]([O])CCC=O(18181)',
    structure = SMILES('CCC[C]([O])CCC=O'),
    E0 = (-63.926,'kJ/mol'),
    modes = [
...
species(
    label = 'CC[CH]C([O])CCC=O(18183)',
    structure = SMILES('CC[CH]C([O])CCC=O'),
    E0 = (-40.6517,'kJ/mol'),
    modes = [
...
species(
    label = 'CCCC([O])[CH]CC=O(18184)',
    structure = SMILES('CCCC([O])[CH]CC=O'),
    E0 = (-40.6517,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2782.5,750,1395,475,1775,1000,3025,407.5,1350,352.5,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'C[CH]CC([O])CCC=O(18186)',
    structure = SMILES('C[CH]CC([O])CCC=O'),
    E0 = (-46.1075,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2782.5,750,1395,475,1775,1000,3025,407.5,1350,352.5,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2]CC([O])CCC(10645)',
    structure = SMILES('[CH2]CC([O])CCC'),
    E0 = (71.2722,'kJ/mol'),
    modes = [
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.391626,0.0733777,-4.9881e-05,1.75531e-08,-2.55091e-12,8706.55,31.0034], Tmin=(100,'K'), Tmax=(1570.6,'K')), NASAPolynomial(coeffs=[14.8389,0.0365835,-1.47407e-05,2.63728e-09,-1.76687e-13,4168.37,-45.2186], Tmin=(1570.6,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(71.2722,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(RCCJ)"""),
)

species(
    label = 'CCCC([O])C[CH]C=O(18187)',
    structure = SMILES('CCCC([O])CC=C[O]'),
    E0 = (-97.3022,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2995,3025,975,1000,1300,1375,400,500,1630,1680,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (128.169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.776325,0.0905262,-5.29216e-05,8.41648e-10,6.94285e-12,-11518.1,37.3912], Tmin=(100,'K'), Tmax=(1021.35,'K')), NASAPolynomial(coeffs=[20.7624,0.0348391,-1.32382e-05,2.41961e-09,-1.69887e-13,-17413,-74.2955], Tmin=(1021.35,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-97.3022,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(486.397,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(CC(C)OJ) + radical(C=COJ)"""),
)

species(
    label = '[CH2]CCC([O])CCC=O(18188)',
    structure = SMILES('[CH2]CCC([O])CCC=O'),
    E0 = (-35.3074,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (128.169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0678603,0.0927617,-8.27894e-05,4.38249e-08,-1.02209e-11,-4110.17,36.4559], Tmin=(100,'K'), Tmax=(987.015,'K')), NASAPolynomial(coeffs=[9.44586,0.0547556,-2.50295e-05,4.81106e-09,-3.38944e-13,-5961.38,-8.66477], Tmin=(987.015,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-35.3074,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(482.239,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(RCCJ) + radical(CC(C)OJ)"""),
)

species(
    label = 'CCCC([O])CC[C]=O(18189)',
    structure = SMILES('CCCC([O])CC[C]=O'),
    E0 = (-80.5932,'kJ/mol'),
    modes = [
...
species(
    ...
    molecularWeight = (129.177,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.438146,0.0643625,7.85245e-06,-4.86976e-08,2.19533e-11,-30777.9,30.0156], Tmin=(100,'K'), Tmax=(973.901,'K')), NASAPolynomial(coeffs=[12.4995,0.0476756,-1.70445e-05,2.98116e-09,-2.03639e-13,-34685.2,-35.8532], Tmin=(973.901,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-257.072,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(519.654,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + ring(Tetrahydrofuran) + radical(CCOJ)"""),
)

species(
    label = 'CCC[C](O)CCC=O(18192)',
    structure = SMILES('CCC[C](O)CCC=O'),
    E0 = (-294.287,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (129.177,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0597466,0.100499,-9.04051e-05,2.49016e-08,1.51321e-11,-35259,34.8302], Tmin=(100,'K'), Tmax=(565.744,'K')), NASAPolynomial(coeffs=[8.26924,0.0591382,-2.72164e-05,5.2049e-09,-3.64067e-13,-36481.9,-3.08717], Tmin=(565.744,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-294.287,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(C2CsJOH)"""),
)

species(
    label = 'CC[CH]C(O)CCC=O(18193)',
    structure = SMILES('CC[CH]C(O)CCC=O'),
    E0 = (-271.013,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1277.5,1000,1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2782.5,750,1395,475,1775,1000,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (129.177,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.00251929,0.0917773,-7.38455e-05,3.35534e-08,-6.61175e-12,-32454.4,37.5953], Tmin=(100,'K'), Tmax=(1155.68,'K')), NASAPolynomial(coeffs=[11.2426,0.0528561,-2.33283e-05,4.41209e-09,-3.07832e-13,-35053.6,-18.2831], Tmin=(1155.68,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-271.013,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(CCJCO)"""),
)

species(
    label = 'CCCC(O)[CH]CC=O(18194)',
    structure = SMILES('CCCC(O)[CH]CC=O'),
    E0 = (-271.013,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1277.5,1000,1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2782.5,750,1395,475,1775,1000,200,800,1200,1600],'cm^-1')),
...
species(
    ...
    molecularWeight = (129.177,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.585611,0.0871919,-4.67451e-05,-4.58247e-08,6.21335e-11,-33140.5,35.8943], Tmin=(100,'K'), Tmax=(507.962,'K')), NASAPolynomial(coeffs=[6.36625,0.0612441,-2.79187e-05,5.32166e-09,-3.71761e-13,-33980.3,9.43602], Tmin=(507.962,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-276.468,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(RCCJC)"""),
)

species(
    label = 'CCCC(O)C[CH]C=O(18196)',
    structure = SMILES('CCCC(O)CC=C[O]'),
    E0 = (-327.663,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (129.177,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.944683,0.0945862,-5.90602e-05,6.17583e-09,5.21236e-12,-39218.4,38.1873], Tmin=(100,'K'), Tmax=(1025.1,'K')), NASAPolynomial(coeffs=[20.8594,0.0365779,-1.37928e-05,2.49972e-09,-1.74261e-13,-45111.1,-74.4831], Tmin=(1025.1,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-327.663,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(C=COJ)"""),
)

species(
    label = '[CH2]CCC(O)CCC=O(18197)',
    structure = SMILES('[CH2]CCC(O)CCC=O'),
    E0 = (-265.668,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (129.177,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.12273,0.0970509,-8.95899e-05,4.98593e-08,-1.21993e-11,-31809.4,37.334], Tmin=(100,'K'), Tmax=(947.839,'K')), NASAPolynomial(coeffs=[9.44393,0.0566777,-2.56966e-05,4.91896e-09,-3.457e-13,-33622.9,-8.30691], Tmin=(947.839,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-265.668,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(RCCJ)"""),
)

species(
    label = 'CCCC(O)CC[C]=O(18198)',
    structure = SMILES('CCCC(O)CC[C]=O'),
    E0 = (-310.954,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (129.177,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.31104,0.100244,-9.77173e-05,5.66832e-08,-1.41331e-11,-37248.5,37.0392], Tmin=(100,'K'), Tmax=(943.738,'K')), NASAPolynomial(coeffs=[10.6497,0.0537875,-2.38792e-05,4.5237e-09,-3.15993e-13,-39317.3,-15.2056], Tmin=(943.738,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-310.954,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(CCCJ=O)"""),
)

species(
    label = 'CCCC1CC[CH]OO1(18199)',
    structure = SMILES('CCCC1CC[CH]OO1'),
    E0 = (-53.9985,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (129.177,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0233585,0.0682453,1.93691e-05,-7.73198e-08,3.66156e-11,-6333.65,29.5651], Tmin=(100,'K'), Tmax=(927.219,'K')), NASAPolynomial(coeffs=[18.3993,0.0380778,-1.12681e-05,1.82558e-09,-1.23968e-13,-11852.3,-69.0826], Tmin=(927.219,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-53.9985,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(519.654,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(12dioxane) + radical(CCsJOOC)"""),
)
...
species(
    label = 'CCCC([O])CC(10557)',
    structure = SMILES('CCCC([O])CC'),
    E0 = (-133.974,'kJ/mol'),
    modes = [
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0729187,0.075669,-4.87893e-05,1.59635e-08,-2.12564e-12,-15963.1,30.3821], Tmin=(100,'K'), Tmax=(1726.04,'K')), NASAPolynomial(coeffs=[17.5786,0.0351005,-1.35336e-05,2.34635e-09,-1.53317e-13,-22006.2,-63.6277], Tmin=(1726.04,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-133.974,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ)"""),
)

species(
    label = 'C=COCC([O])CCC(18200)',
    structure = SMILES('C=COCC([O])CCC'),
    E0 = (-198.957,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (129.177,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.23427,0.0989083,-5.92933e-05,-1.14951e-09,9.53662e-12,-23726.2,36.3702], Tmin=(100,'K'), Tmax=(991.874,'K')), NASAPolynomial(coeffs=[23.6726,0.0330297,-1.19388e-05,2.15621e-09,-1.52063e-13,-30367.4,-92.1592], Tmin=(991.874,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-198.957,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CC(C)OJ)"""),
)

species(
    label = 'CCCC([O])CC=CO(18201)',
    structure = SMILES('CCCC([O])CC=CO'),
    E0 = (-238.765,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,3615,1277.5,1000,1380,1390,370,380,2900,435,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (129.177,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.16078,0.097213,-5.55301e-05,-6.06579e-09,1.18072e-11,-28516.4,37.3591], Tmin=(100,'K'), Tmax=(974.163,'K')), NASAPolynomial(coeffs=[23.7139,0.0316507,-1.08964e-05,1.93038e-09,-1.35662e-13,-35098.3,-90.9033], Tmin=(974.163,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-238.765,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(CC(C)OJ)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['H(3)', 'CCCC(=O)CCC=O(18180)'],
    products = ['CCCC([O])CCC=O(17491)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['npropyl(83)', 'O=CCCC=O(5767)'],
    products = ['CCCC([O])CCC=O(17491)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CCCC=O(1713)', 'CH2CH2CHO(560)'],
    products = ['CCCC([O])CCC=O(17491)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['npropyl(83)', '[O][CH]CCC=O(5764)'],
    products = ['CCCC([O])CCC=O(17491)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CCC[CH][O](1709)', 'CH2CH2CHO(560)'],
    products = ['CCCC([O])CCC=O(17491)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['H(3)', 'CCC[C]([O])CCC=O(18181)'],
    products = ['CCCC([O])CCC=O(17491)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['C2H5(29)', '[CH2]C([O])CCC=O(18182)'],
    products = ['CCCC([O])CCC=O(17491)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(3)', 'CC[CH]C([O])CCC=O(18183)'],
    products = ['CCCC([O])CCC=O(17491)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['CH2CHO(40)', '[CH2]C([O])CCC(1786)'],
    products = ['CCCC([O])CCC=O(17491)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(3)', 'CCCC([O])[CH]CC=O(18184)'],
    products = ['CCCC([O])CCC=O(17491)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CH3(17)', '[CH2]CC([O])CCC=O(18185)'],
    products = ['CCCC([O])CCC=O(17491)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(3)', 'C[CH]CC([O])CCC=O(18186)'],
    products = ['CCCC([O])CCC=O(17491)'],
...
reaction(
    label = 'reaction13',
    reactants = ['HCO(16)', '[CH2]CC([O])CCC(10645)'],
    products = ['CCCC([O])CCC=O(17491)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(3)', 'CCCC([O])C[CH]C=O(18187)'],
    products = ['CCCC([O])CCC=O(17491)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(3)', '[CH2]CCC([O])CCC=O(18188)'],
    products = ['CCCC([O])CCC=O(17491)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(3)', 'CCCC([O])CC[C]=O(18189)'],
    products = ['CCCC([O])CCC=O(17491)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CH2(S)(23)', 'CCC([O])CCC=O(18190)'],
    products = ['CCCC([O])CCC=O(17491)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CCCC([O])CCC=O(17491)'],
    products = ['CCCC1CCC([O])O1(18191)'],
...
reaction(
    label = 'reaction20',
    reactants = ['CC[CH]C(O)CCC=O(18193)'],
    products = ['CCCC([O])CCC=O(17491)'],
...
reaction(
    label = 'reaction21',
    reactants = ['CCCC(O)[CH]CC=O(18194)'],
    products = ['CCCC([O])CCC=O(17491)'],
...
reaction(
    label = 'reaction22',
    reactants = ['CCCC([O])CCC=O(17491)'],
    products = ['C[CH]CC(O)CCC=O(18195)'],
...
reaction(
    label = 'reaction23',
    reactants = ['CCCC([O])CCC=O(17491)'],
    products = ['CCCC(O)C[CH]C=O(18196)'],
...
reaction(
    label = 'reaction24',
    reactants = ['CCCC([O])CCC=O(17491)'],
    products = ['[CH2]CCC(O)CCC=O(18197)'],
...
reaction(
    label = 'reaction27',
    reactants = ['CO(12)', 'CCCC([O])CC(10557)'],
    products = ['CCCC([O])CCC=O(17491)'],
...
reaction(
    label = 'reaction30',
    reactants = ['O(4)', 'CCC[CH]CCC=O(1225)'],
    products = ['CCCC([O])CCC=O(17491)'],
