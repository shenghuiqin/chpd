species(
    ...
    E0 = (-196.303,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2782.5,750,1395,475,1775,1000,3025,407.5,1350,352.5,3615,1277.5,1000,1380,1390,370,380,2900,435,200,800,1066.67,1333.33,1600],'cm^-1')),
...
species(
    label = '[O]C1CCC(C[CH]O)O1(22163)',
    structure = SMILES('[O]C1CCC(C[CH]O)O1'),
    E0 = (-212.821,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (130.142,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0836689,0.080019,-6.12655e-05,2.64398e-08,-4.7106e-12,-25441.2,31.9006], Tmin=(100,'K'), Tmax=(1331.82,'K')), NASAPolynomial(coeffs=[14.3312,0.0367257,-1.25057e-05,2.0324e-09,-1.29068e-13,-29280.9,-41.7735], Tmin=(1331.82,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-212.821,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(444.824,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + ring(Tetrahydrofuran) + radical(CCOJ) + radical(CCsJOH)"""),
)
...
species(
    label = 'O=CCCC(=O)C[CH]O(22165)',
    structure = SMILES('O=CCCC(=O)C[CH]O'),
    E0 = (-369.72,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2782.5,750,1395,475,1775,1000,3025,407.5,1350,352.5,3615,1277.5,1000,375,552.5,462.5,1710,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (129.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.603485,0.117259,-0.000199506,1.8829e-07,-6.80167e-11,-44316.7,35.3636], Tmin=(100,'K'), Tmax=(855.489,'K')), NASAPolynomial(coeffs=[5.42348,0.0537508,-2.62075e-05,4.9702e-09,-3.38775e-13,-44055.1,14.7833], Tmin=(855.489,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-369.72,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(407.409,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cds-OdCsCs) + group(Cds-OdCsH) + radical(CCsJOH)"""),
)

species(
    label = '[O]C(C=CO)CCC=O(22166)',
    structure = SMILES('[O]C(C=CO)CCC=O'),
    E0 = (-298.12,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2782.5,750,1395,475,1775,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,3615,1277.5,1000,1380,1390,370,380,2900,435,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (129.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.668906,0.0901287,-7.06641e-05,1.78378e-08,2.12759e-12,-35676.4,36.2907], Tmin=(100,'K'), Tmax=(997.671,'K')), NASAPolynomial(coeffs=[22.1634,0.0236923,-8.52405e-06,1.53792e-09,-1.0853e-13,-41481.7,-80.0707], Tmin=(997.671,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-298.12,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-(Cds-O2d)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-OdCsH) + radical(CC(C)OJ)"""),
)
...
species(
    label = '[O]CCC([O])CCC=O(22167)',
    structure = SMILES('[O]CCC([O])CCC=O'),
    E0 = (-150.896,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (130.142,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0819867,0.0992227,-0.000135265,1.19706e-07,-4.39562e-11,-18010.7,36.5057], Tmin=(100,'K'), Tmax=(790.651,'K')), NASAPolynomial(coeffs=[5.38594,0.0569305,-2.72751e-05,5.24853e-09,-3.65602e-13,-18418.1,14.3022], Tmin=(790.651,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-150.896,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cds-OdCsH) + radical(CC(C)OJ) + radical(CCOJ)"""),
)

species(
    label = 'O=CCC[C](O)C[CH]O(22168)',
    structure = SMILES('O=CCC[C](O)C[CH]O'),
    E0 = (-250.036,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (130.142,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.05775,0.123739,-0.000197973,1.74632e-07,-5.99846e-11,-29902.3,38.313], Tmin=(100,'K'), Tmax=(854.77,'K')), NASAPolynomial(coeffs=[9.74012,0.04856,-2.27898e-05,4.2647e-09,-2.89073e-13,-30847.7,-6.8188], Tmin=(854.77,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-250.036,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(428.195,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cds-OdCsH) + radical(CCsJOH) + radical(C2CsJOH)"""),
)

species(
    label = '[O]C([CH]CO)CCC=O(22169)',
    structure = SMILES('[O]C([CH]CO)CCC=O'),
    E0 = (-176.699,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2782.5,750,1395,475,1775,1000,3025,407.5,1350,352.5,3615,1277.5,1000,1380,1390,370,380,2900,435,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (130.142,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0368178,0.0930435,-9.95909e-05,6.2949e-08,-1.69046e-11,-21114.3,37.7363], Tmin=(100,'K'), Tmax=(885.243,'K')), NASAPolynomial(coeffs=[10.2409,0.0469361,-2.14644e-05,4.11288e-09,-2.88809e-13,-22921,-10.2486], Tmin=(885.243,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-176.699,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cds-OdCsH) + radical(CCJCO) + radical(CC(C)OJ)"""),
)

species(
    label = 'O=CC[CH]C(O)C[CH]O(22170)',
    structure = SMILES('O=CC[CH]C(O)C[CH]O'),
    E0 = (-226.762,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2782.5,750,1395,475,1775,1000,3000,3050,390,425,1340,1360,335,370,3580,3650,1210,1345,900,1100,1380,1390,370,380,2900,435,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (130.142,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.628629,0.108762,-0.000148317,1.17224e-07,-3.78828e-11,-27113.1,39.8504], Tmin=(100,'K'), Tmax=(786.852,'K')), NASAPolynomial(coeffs=[11.3454,0.0447826,-2.04254e-05,3.84618e-09,-2.64813e-13,-28901.2,-14.4353], Tmin=(786.852,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-226.762,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(428.195,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cds-OdCsH) + radical(CCsJOH) + radical(CCJCO)"""),
)

species(
    label = 'O=CCCC(O)[CH][CH]O(22171)',
    structure = SMILES('O=CCCC(O)[CH][CH]O'),
    E0 = (-226.762,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (130.142,'amu'),
...
species(
    label = '[O][C](CCO)CCC=O(22172)',
    structure = SMILES('[O][C](CCO)CCC=O'),
    E0 = (-199.973,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (130.142,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.615112,0.110881,-0.00016048,1.37022e-07,-4.72353e-11,-23894.1,36.9839], Tmin=(100,'K'), Tmax=(816.942,'K')), NASAPolynomial(coeffs=[8.95789,0.05014,-2.34875e-05,4.44893e-09,-3.06116e-13,-24995.4,-4.43226], Tmin=(816.942,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-199.973,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cds-OdCsH) + radical(C2CsJOH) + radical(CC(C)OJ)"""),
)

species(
    label = 'O=C[CH]CC(O)C[CH]O(22173)',
    structure = SMILES('[O]C=CCC(O)C[CH]O'),
    E0 = (-283.412,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (130.142,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.06295,0.105562,-0.000112196,6.1181e-08,-1.31291e-11,-33899.3,38.6199], Tmin=(100,'K'), Tmax=(1139.37,'K')), NASAPolynomial(coeffs=[20.841,0.0286639,-1.09601e-05,1.94634e-09,-1.32012e-13,-38890.7,-69.9122], Tmin=(1139.37,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-283.412,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(CCsJOH) + radical(C=COJ)"""),
)

species(
    label = '[O]C([CH]CC=O)CCO(22174)',
    structure = SMILES('[O]C([CH]CC=O)CCO'),
    E0 = (-176.699,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2782.5,750,1395,475,1775,1000,3025,407.5,1350,352.5,3615,1277.5,1000,1380,1390,370,380,2900,435,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    ...
    molecularWeight = (130.142,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.956425,0.117699,-0.000174828,1.44844e-07,-4.76343e-11,-31906.8,39.3456], Tmin=(100,'K'), Tmax=(842.082,'K')), NASAPolynomial(coeffs=[11.8593,0.0437474,-1.98051e-05,3.67451e-09,-2.49052e-13,-33601.6,-17.5274], Tmin=(842.082,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-266.703,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(428.195,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cds-OdCsH) + radical(CCCJ=O) + radical(CCsJOH)"""),
)

species(
    label = '[O]C(C[CH]C=O)CCO(22176)',
    structure = SMILES('[O]C=CCC([O])CCO'),
    E0 = (-233.349,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (130.142,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.01527,0.0972417,-8.99347e-05,4.22479e-08,-7.80255e-12,-27873.9,38.7148], Tmin=(100,'K'), Tmax=(1319.25,'K')), NASAPolynomial(coeffs=[22.2851,0.0265942,-9.6077e-06,1.65555e-09,-1.10223e-13,-34021.7,-80.1516], Tmin=(1319.25,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-233.349,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(CC(C)OJ) + radical(C=COJ)"""),
)

species(
    label = '[O][CH]CC(O)CCC=O(22177)',
    structure = SMILES('[O][CH]CC(O)CCC=O'),
    E0 = (-200.959,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (130.142,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.533604,0.112181,-0.000173062,1.57561e-07,-5.66953e-11,-24018.6,37.8672], Tmin=(100,'K'), Tmax=(832.759,'K')), NASAPolynomial(coeffs=[6.24829,0.0552081,-2.64926e-05,5.04381e-09,-3.4683e-13,-24302.1,11.469], Tmin=(832.759,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-200.959,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cds-OdCsH) + radical(CCsJOH) + radical(CCOJ)"""),
)

species(
    label = '[O]C(CCO)CC[C]=O(22178)',
    structure = SMILES('[O]C(CCO)CC[C]=O'),
    E0 = (-216.64,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (130.142,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.241244,0.101072,-0.00012101,8.02142e-08,-1.98919e-11,-25910.2,37.0712], Tmin=(100,'K'), Tmax=(664.846,'K')), NASAPolynomial(coeffs=[10.666,0.0460899,-2.09702e-05,3.97411e-09,-2.75981e-13,-27595.7,-12.8665], Tmin=(664.846,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-216.64,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cds-OdCsH) + radical(CC(C)OJ) + radical(CCCJ=O)"""),
)

species(
    label = 'O[CH]CC1CC[CH]OO1(22179)',
    structure = SMILES('O[CH]CC1CC[CH]OO1'),
    E0 = (-9.74783,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (130.142,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.2528,0.0926475,-7.98014e-05,3.63287e-08,-6.38892e-12,-963.673,34.1684], Tmin=(100,'K'), Tmax=(1581.23,'K')), NASAPolynomial(coeffs=[20.1827,0.0268857,-6.47348e-06,7.98359e-10,-4.18558e-14,-6300.27,-74.5066], Tmin=(1581.23,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-9.74783,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(444.824,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + ring(12dioxane) + radical(CCsJOOC) + radical(CCsJOH)"""),
)
...
species(
    label = 'O=CCCC(=O)CCO(22180)',
    structure = SMILES('O=CCCC(=O)CCO'),
    E0 = (-550.018,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (130.142,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.342178,0.108626,-0.000168772,1.56862e-07,-5.73649e-11,-66008.2,34.8762], Tmin=(100,'K'), Tmax=(835.118,'K')), NASAPolynomial(coeffs=[4.79651,0.0569643,-2.73965e-05,5.21911e-09,-3.58882e-13,-65923.3,16.6581], Tmin=(835.118,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-550.018,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cds-OdCsCs) + group(Cds-OdCsH)"""),
)

species(
    label = 'O=CCCC(O)C=CO(22181)',
    ...
    molecularWeight = (130.142,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.834042,0.0941514,-7.66775e-05,2.30189e-08,4.57631e-13,-63376.8,37.0751], Tmin=(100,'K'), Tmax=(999.512,'K')), NASAPolynomial(coeffs=[22.2405,0.0254642,-9.09745e-06,1.62241e-09,-1.13263e-13,-69171.1,-80.1458], Tmin=(999.512,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-528.481,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-(Cds-O2d)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-OdCsH)"""),
)

species(
    label = 'O=CCCC(O)CC=O(22182)',
    structure = SMILES('O=CCCC(O)CC=O'),
    E0 = (-529.934,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (130.142,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.799377,0.0831277,-5.19229e-05,-4.8004e-08,7.18985e-11,-63633.9,32.1952], Tmin=(100,'K'), Tmax=(492.519,'K')), NASAPolynomial(coeffs=[7.24576,0.0524917,-2.47635e-05,4.766e-09,-3.33523e-13,-64532.4,2.98636], Tmin=(492.519,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-529.934,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cds-OdCsH) + group(Cds-OdCsH)"""),
)
...
species(
    label = 'C=COCC([O])C[CH]O(22183)',
    structure = SMILES('C=COCC([O])C[CH]O'),
    E0 = (-154.707,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,3615,1277.5,1000,2950,3100,1380,975,1025,1650,1380,1390,370,380,2900,435,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (130.142,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.58323,0.112586,-0.000121764,6.57483e-08,-1.37694e-11,-18397.2,37.6312], Tmin=(100,'K'), Tmax=(1176.38,'K')), NASAPolynomial(coeffs=[24.6088,0.0235253,-8.20249e-06,1.39175e-09,-9.24552e-14,-24559.5,-92.9849], Tmin=(1176.38,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-154.707,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CCsJOH) + radical(CC(C)OJ)"""),
)

species(
    label = '[O]C(C[CH]O)CC=CO(22184)',
    structure = SMILES('[O]C(C[CH]O)CC=CO'),
    E0 = (-194.514,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2995,3025,975,1000,1300,1375,400,500,1630,1680,3025,407.5,1350,352.5,3580,3650,1210,1345,900,1100,1380,1390,370,380,2900,435,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (130.142,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.41753,0.109826,-0.000114424,5.64629e-08,-9.77511e-12,-23191.3,38.2882], Tmin=(100,'K'), Tmax=(986.268,'K')), NASAPolynomial(coeffs=[23.9979,0.0232246,-7.7697e-06,1.30781e-09,-8.76938e-14,-29005.9,-88.0377], Tmin=(986.268,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-194.514,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(CCsJOH) + radical(CC(C)OJ)"""),
)
...
species(
    label = 'O=CCC[CH]C[CH]O(22185)',
    structure = SMILES('O=CCC[CH]C[CH]O'),
    E0 = (-59.7352,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2782.5,750,1395,475,1775,1000,3615,1277.5,1000,3000,3050,390,425,1340,1360,335,370,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.104577,0.0976033,-0.000149338,1.38457e-07,-5.03953e-11,-7055.73,34.922], Tmin=(100,'K'), Tmax=(845.752,'K')), NASAPolynomial(coeffs=[4.177,0.0528633,-2.4799e-05,4.66818e-09,-3.18611e-13,-6833.31,21.3445], Tmin=(845.752,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-59.7352,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(407.409,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cds-OdCsH) + radical(CCsJOH) + radical(RCCJCC)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[O]C(C[CH]O)CCC=O(21341)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[O]C(C[CH]O)CCC=O(21341)'],
    products = ['[O]C1CCC(C[CH]O)O1(22163)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', '[O]C(CC=O)CCC=O(22164)'],
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)', 'O=CCCC(=O)C[CH]O(22165)'],
    products = ['[O]C(C[CH]O)CCC=O(21341)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['H(3)', '[O]C(C=CO)CCC=O(22166)'],
    products = ['[O]C(C[CH]O)CCC=O(21341)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['CH2CH2CHO(560)', 'O=CC[CH]O(3984)'],
    products = ['[O]C(C[CH]O)CCC=O(21341)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction11',
    reactants = ['[O]C(C[CH]O)CCC=O(21341)'],
    products = ['O=CCC[C](O)C[CH]O(22168)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O]C([CH]CO)CCC=O(22169)'],
    products = ['[O]C(C[CH]O)CCC=O(21341)'],
...
reaction(
    label = 'reaction13',
    reactants = ['O=CC[CH]C(O)C[CH]O(22170)'],
    products = ['[O]C(C[CH]O)CCC=O(21341)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[O]C(C[CH]O)CCC=O(21341)'],
    products = ['O=CCCC(O)[CH][CH]O(22171)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[O]C(C[CH]O)CCC=O(21341)'],
    products = ['O=C[CH]CC(O)C[CH]O(22173)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[O]C([CH]CC=O)CCO(22174)'],
    products = ['[O]C(C[CH]O)CCC=O(21341)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[O]C(C[CH]O)CCC=O(21341)'],
    products = ['O=[C]CCC(O)C[CH]O(22175)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[O]C(C[CH]O)CCC=O(21341)'],
    products = ['[O]C(C[CH]C=O)CCO(22176)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[O]C(C[CH]O)CCC=O(21341)'],
    products = ['[O][CH]CC(O)CCC=O(22177)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[O]C(C[CH]O)CCC=O(21341)'],
    products = ['O[CH]CC1CC[CH]OO1(22179)'],
...
reaction(
    label = 'reaction28',
    reactants = ['CO(12)', 'CCC([O])C[CH]O(10716)'],
    products = ['[O]C(C[CH]O)CCC=O(21341)'],
...
reaction(
    label = 'reaction31',
    reactants = ['C=COCC([O])C[CH]O(22183)'],
    products = ['[O]C(C[CH]O)CCC=O(21341)'],
...
reaction(
    label = 'reaction32',
    reactants = ['[O]C(C[CH]O)CC=CO(22184)'],
    products = ['[O]C(C[CH]O)CCC=O(21341)'],
...
reaction(
    label = 'reaction33',
    reactants = ['O(4)', 'O=CCC[CH]C[CH]O(22185)'],
    products = ['[O]C(C[CH]O)CCC=O(21341)'],
...
reaction(
    label = 'reaction34',
    reactants = ['HCOH(T)(285)', '[CH2]C([O])CCC=O(18182)'],
    products = ['[O]C(C[CH]O)CCC=O(21341)'],
