...
species(
    label = 'CC[CH]COC=CC(C)OO(8274)',
    structure = SMILES('CC[CH]COC=CC(C)OO'),
    E0 = (-193.138,'kJ/mol'),
    modes = [
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.53707,0.124714,-8.64852e-05,1.4654e-08,5.33093e-12,-22977.2,47.8812], Tmin=(100,'K'), Tmax=(1024.68,'K')), NASAPolynomial(coeffs=[28.4919,0.0398187,-1.52474e-05,2.8131e-09,-1.99124e-13,-31238.2,-111.853], Tmin=(1024.68,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-193.138,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(594.485,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(CCJCO)"""),
)

species(
    label = 'CC=CCO[CH]CC(C)OO(8275)',
    structure = SMILES('CC=CCO[CH]CC(C)OO'),
    E0 = (-167.909,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,2995,3025,975,1000,1300,1375,400,500,1630,1680,3615,1310,387.5,850,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,1380,1390,370,380,2900,435,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (159.203,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.77271,0.134971,-0.000143585,8.79378e-08,-2.26863e-11,-19993.8,43.6973], Tmin=(100,'K'), Tmax=(922.249,'K')), NASAPolynomial(coeffs=[14.344,0.0650659,-2.98833e-05,5.74259e-09,-4.04159e-13,-22966.4,-32.7512], Tmin=(922.249,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-167.909,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(594.485,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(CCsJOCs)"""),
)

species(
    label = 'CCC=CO[CH]CC(C)OO(8276)',
    structure = SMILES('CCC=CO[CH]CC(C)OO'),
    E0 = (-198.777,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,2995,3025,975,1000,1300,1375,400,500,1630,1680,3615,1310,387.5,850,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,1380,1390,370,380,2900,435,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (159.203,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-3.31639,0.144414,-0.000140328,6.85242e-08,-1.31072e-11,-23630,46.7525], Tmin=(100,'K'), Tmax=(1276.71,'K')), NASAPolynomial(coeffs=[31.0713,0.0366754,-1.3747e-05,2.42661e-09,-1.6423e-13,-32410.6,-127.549], Tmin=(1276.71,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-198.777,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(594.485,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(CCsJOC(O))"""),
)
...
species(
    label = 'CC[CH]COC[CH]C(C)OO(8277)',
    structure = SMILES('CC[CH]COC[CH]C(C)OO'),
    E0 = (-69.1423,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3000,3050,390,425,1340,1360,335,370,3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (160.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.63439,0.132769,-0.000133157,7.84446e-08,-1.98633e-11,-8120.48,48.1406], Tmin=(100,'K'), Tmax=(928.827,'K')), NASAPolynomial(coeffs=[12.8161,0.0705358,-3.26495e-05,6.30212e-09,-4.44809e-13,-10804.8,-20.5071], Tmin=(928.827,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-69.1423,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(615.271,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJCO) + radical(CCJCOOH)"""),
)

species(
    label = 'C[CH]CCO[CH]CC(C)OO(8278)',
    structure = SMILES('C[CH]CCO[CH]CC(C)OO'),
    E0 = (-94.557,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (160.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.21762,0.146386,-0.000176362,1.27607e-07,-3.88267e-11,-11157.5,47.605], Tmin=(100,'K'), Tmax=(790.788,'K')), NASAPolynomial(coeffs=[12.7978,0.0704336,-3.22907e-05,6.14887e-09,-4.28512e-13,-13532.3,-21.3112], Tmin=(790.788,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-94.557,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(615.271,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCsJOCs) + radical(RCCJC)"""),
)
...
species(
    label = 'CC[CH][CH]OCCC(C)OO(8279)',
    structure = SMILES('CC[CH][CH]OCCC(C)OO'),
    E0 = (-89.1012,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3000,3050,390,425,1340,1360,335,370,3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'CC[CH]COCC[C](C)OO(8280)',
    structure = SMILES('CC[CH]COCC[C](C)OO'),
    E0 = (-82.6581,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (160.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.67611,0.135055,-0.000148523,1.02219e-07,-3.06262e-11,-9746.25,46.2799], Tmin=(100,'K'), Tmax=(791.167,'K')), NASAPolynomial(coeffs=[10.132,0.0753517,-3.53217e-05,6.82558e-09,-4.80838e-13,-11614.6,-7.9208], Tmin=(791.167,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-82.6581,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(615.271,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(C2CsJOOH) + radical(CCJCO)"""),
)

species(
    label = '[CH2]CCCO[CH]CC(C)OO(8281)',
    structure = SMILES('[CH2]CCCO[CH]CC(C)OO'),
    E0 = (-83.7569,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (160.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.21462,0.144883,-0.000159775,1.00518e-07,-2.63889e-11,-9856.84,46.6512], Tmin=(100,'K'), Tmax=(911.322,'K')), NASAPolynomial(coeffs=[15.7081,0.0662186,-3.03014e-05,5.80671e-09,-4.07834e-13,-13123.6,-38.1519], Tmin=(911.322,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-83.7569,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(615.271,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCsJOCs) + radical(RCCJ)"""),
)

species(
    label = '[CH2]C(CCOC[CH]CC)OO(8282)',
    structure = SMILES('[CH2]C(CCOC[CH]CC)OO'),
    E0 = (-55.5947,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1310,387.5,850,1000,2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,3000,3100,440,815,1455,1000,1380,1390,370,380,2900,435,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (160.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.74616,0.133804,-0.000132,7.44077e-08,-1.78007e-11,-6485.76,48.2257], Tmin=(100,'K'), Tmax=(984.869,'K')), NASAPolynomial(coeffs=[14.6085,0.0673801,-3.08337e-05,5.92761e-09,-4.17675e-13,-9707.21,-30.4268], Tmin=(984.869,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-55.5947,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(615.271,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJCO) + radical(CJCOOH)"""),
)

species(
    label = 'CCCCO[CH][CH]C(C)OO(8283)',
    structure = SMILES('CCCCO[CH][CH]C(C)OO'),
    E0 = (-88.5883,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (160.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.25548,0.146496,-0.000166268,1.0869e-07,-2.96773e-11,-10437.2,47.3175], Tmin=(100,'K'), Tmax=(877.924,'K')), NASAPolynomial(coeffs=[15.1267,0.0672989,-3.09532e-05,5.93548e-09,-4.16632e-13,-13489.2,-34.2783], Tmin=(877.924,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-88.5883,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(615.271,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCsJOCs) + radical(CCJCOOH)"""),
)

species(
    label = 'CC[CH]COCCC(C)O[O](8284)',
    structure = SMILES('CC[CH]COCCC(C)O[O]'),
    E0 = (-117.553,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (160.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.45336,0.127883,-0.000124758,7.25637e-08,-1.82558e-11,-13948.7,45.9413], Tmin=(100,'K'), Tmax=(932.254,'K')), NASAPolynomial(coeffs=[12.014,0.0701,-3.17851e-05,6.07835e-09,-4.268e-13,-16459.7,-18.0864], Tmin=(932.254,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-117.553,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(619.428,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(CCJCO)"""),
)

species(
    label = 'C[CH][CH]COCCC(C)OO(8285)',
    structure = SMILES('C[CH][CH]COCCC(C)OO'),
    E0 = (-75.111,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3000,3050,390,425,1340,1360,335,370,3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (160.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.58912,0.132466,-0.000142061,9.50772e-08,-2.77023e-11,-8840.99,48.4083], Tmin=(100,'K'), Tmax=(812.213,'K')), NASAPolynomial(coeffs=[10.2649,0.0740861,-3.42432e-05,6.579e-09,-4.62147e-13,-10766.6,-6.31496], Tmin=(812.213,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-75.111,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(615.271,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJC) + radical(CCJCO)"""),
)

species(
    label = '[CH2]C[CH]COCCC(C)OO(8286)',
    structure = SMILES('[CH2]C[CH]COCCC(C)OO'),
    E0 = (-64.3109,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1310,387.5,850,1000,2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,3000,3100,440,815,1455,1000,1380,1390,370,380,2900,435,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (160.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.60419,0.131324,-0.00012744,7.15233e-08,-1.72056e-11,-7539.75,47.5096], Tmin=(100,'K'), Tmax=(974.585,'K')), NASAPolynomial(coeffs=[13.5265,0.0692228,-3.18577e-05,6.13925e-09,-4.33117e-13,-10488.9,-25.0974], Tmin=(974.585,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-64.3109,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(615.271,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJ) + radical(CCJCO)"""),
)

species(
    label = 'CCCCO[CH]C[C](C)OO(8287)',
    structure = SMILES('CCCCO[CH]C[C](C)OO'),
    E0 = (-102.104,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (160.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.30408,0.148983,-0.000182919,1.34983e-07,-4.19053e-11,-12062.8,45.4739], Tmin=(100,'K'), Tmax=(775.465,'K')), NASAPolynomial(coeffs=[12.6859,0.0716586,-3.33436e-05,6.389e-09,-4.46642e-13,-14387.5,-23.0317], Tmin=(775.465,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-102.104,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(615.271,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCsJOCs) + radical(C2CsJOOH)"""),
)

species(
    label = '[CH2]C(C[CH]OCCCC)OO(8288)',
    structure = SMILES('[CH2]C(C[CH]OCCCC)OO'),
    E0 = (-75.0407,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1310,387.5,850,1000,2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,3000,3100,440,815,1455,1000,1380,1390,370,380,2900,435,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (160.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.34689,0.147244,-0.000163903,1.0282e-07,-2.67251e-11,-8803.27,47.3329], Tmin=(100,'K'), Tmax=(923.015,'K')), NASAPolynomial(coeffs=[16.7655,0.0644175,-2.93013e-05,5.60068e-09,-3.92855e-13,-12331.4,-43.342], Tmin=(923.015,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-75.0407,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(615.271,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCsJOCs) + radical(CJCOOH)"""),
)

species(
    label = 'CCCCO[CH]CC(C)O[O](8289)',
    structure = SMILES('CCCCO[CH]CC(C)O[O]'),
    E0 = (-136.999,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (160.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.07211,0.141583,-0.000157776,1.0269e-07,-2.80192e-11,-16265.5,45.1098], Tmin=(100,'K'), Tmax=(877.774,'K')), NASAPolynomial(coeffs=[14.325,0.0668617,-3.00877e-05,5.7114e-09,-3.98594e-13,-19144.1,-31.8592], Tmin=(877.774,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-136.999,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(619.428,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(CCsJOCs)"""),
)
...
species(
    label = 'CCC=COCCC(C)OO(8290)',
    structure = SMILES('CCC=COCCC(C)OO'),
    E0 = (-392.704,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (160.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-3.1431,0.137122,-0.000119972,5.31807e-08,-9.31113e-12,-46957.5,46.669], Tmin=(100,'K'), Tmax=(1383.09,'K')), NASAPolynomial(coeffs=[30.2818,0.0404559,-1.51355e-05,2.64843e-09,-1.77256e-13,-56203.5,-125.428], Tmin=(1383.09,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-392.704,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(619.428,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH)"""),
)

species(
    label = 'CCCCOC=CC(C)OO(8291)',
    structure = SMILES('CCCCOC=CC(C)OO'),
    E0 = (-393.04,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (160.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.76705,0.130312,-9.62681e-05,2.5327e-08,1.13957e-12,-47012.2,46.212], Tmin=(100,'K'), Tmax=(1054.58,'K')), NASAPolynomial(coeffs=[28.3226,0.043463,-1.69355e-05,3.11616e-09,-2.18594e-13,-55297.5,-113.622], Tmin=(1054.58,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-393.04,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(619.428,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH)"""),
)

species(
    label = 'CC=CCOCCC(C)OO(8292)',
    structure = SMILES('CC=CCOCCC(C)OO'),
    E0 = (-348.365,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (160.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.32327,0.126165,-0.000117973,6.55949e-08,-1.5997e-11,-41714.6,42.6416], Tmin=(100,'K'), Tmax=(950.541,'K')), NASAPolynomial(coeffs=[11.3583,0.0727978,-3.37548e-05,6.52682e-09,-4.61274e-13,-44125.5,-17.8962], Tmin=(950.541,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-348.365,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(619.428,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH)"""),
)
...
species(
    label = 'CC[CH]CO[CH]CCOO(8293)',
    structure = SMILES('CC[CH]CO[CH]CCOO'),
    E0 = (-52.6781,'kJ/mol'),
    modes = [
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.43927,0.126734,-0.000139359,8.75907e-08,-2.29876e-11,-6145.91,42.6748], Tmin=(100,'K'), Tmax=(911.453,'K')), NASAPolynomial(coeffs=[14.1802,0.0581879,-2.65516e-05,5.08126e-09,-3.56607e-13,-8993.23,-31.2321], Tmin=(911.453,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-52.6781,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(544.598,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCJCO) + radical(CCsJOCs)"""),
)

species(
    label = 'C[CH]CO[CH]CC(C)OO(7402)',
    structure = SMILES('C[CH]CO[CH]CC(C)OO'),
    E0 = (-65.321,'kJ/mol'),
    modes = [
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.44082,0.124642,-0.00012914,7.43564e-08,-1.77549e-11,-7664.49,42.3287], Tmin=(100,'K'), Tmax=(999.071,'K')), NASAPolynomial(coeffs=[15.9167,0.0551463,-2.47993e-05,4.73018e-09,-3.31944e-13,-11132.7,-41.3949], Tmin=(999.071,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-65.321,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(544.598,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCsJOCs) + radical(CCJCO)"""),
)
...
species(
    label = 'CC[CH]COC1CC(C)O1(8294)',
    structure = SMILES('CC[CH]COC1CC(C)O1'),
    E0 = (-197.434,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (143.203,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.76803,0.0900226,-2.74048e-05,-2.64844e-08,1.68214e-11,-23560.9,39.1033], Tmin=(100,'K'), Tmax=(967.82,'K')), NASAPolynomial(coeffs=[17.3235,0.0493762,-1.7299e-05,2.98755e-09,-2.02709e-13,-28661,-55.8433], Tmin=(967.82,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-197.434,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(582.013,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Oxetane) + radical(CCJCO)"""),
)

species(
    label = '[CH2]C(OC[CH]CC)C(C)OO(8295)',
    structure = SMILES('[CH2]C(OC[CH]CC)C(C)OO'),
    E0 = (-69.5981,'kJ/mol'),
    modes = [
...
species(
    label = '[CH2]C(C)CO[CH]CC(C)OO(8296)',
    structure = SMILES('[CH2]C(C)CO[CH]CC(C)OO'),
    E0 = (-92.9625,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (160.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.3489,0.144932,-0.000157886,9.69097e-08,-2.45266e-11,-10956.6,46.8397], Tmin=(100,'K'), Tmax=(949.869,'K')), NASAPolynomial(coeffs=[17.3295,0.0620614,-2.70163e-05,5.05563e-09,-3.5046e-13,-14694.9,-47.0847], Tmin=(949.869,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-92.9625,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(615.271,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Isobutyl) + radical(CCsJOCs)"""),
)
...
species(
    label = 'CC[CH]COC(O)CC(C)[O](8297)',
    structure = SMILES('CC[CH]COC(O)CC(C)[O]'),
    E0 = (-310.932,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (160.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.51929,0.12535,-0.000110768,5.41001e-08,-1.11626e-11,-37201.2,47.6052], Tmin=(100,'K'), Tmax=(1129.36,'K')), NASAPolynomial(coeffs=[16.0256,0.0632079,-2.82317e-05,5.37783e-09,-3.771e-13,-41164,-39.1728], Tmin=(1129.36,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-310.932,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(619.428,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(CCJCO)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['CC[CH]CO[CH]CC(C)OO(8049)'],
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'CC[CH]COC=CC(C)OO(8274)'],
    products = ['CC[CH]CO[CH]CC(C)OO(8049)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'CC=CCO[CH]CC(C)OO(8275)'],
    products = ['CC[CH]CO[CH]CC(C)OO(8049)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', 'CCC=CO[CH]CC(C)OO(8276)'],
    products = ['CC[CH]CO[CH]CC(C)OO(8049)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['CH3CHOOH(63)', 'C=COC[CH]CC(2004)'],
    products = ['CC[CH]CO[CH]CC(C)OO(8049)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['CH3(17)', 'C=CCO[CH]CC(C)OO(7625)'],
    products = ['CC[CH]CO[CH]CC(C)OO(8049)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['CC[CH]COC[CH]C(C)OO(8277)'],
    products = ['CC[CH]CO[CH]CC(C)OO(8049)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['CC[CH]CO[CH]CC(C)OO(8049)'],
    products = ['C[CH]CCO[CH]CC(C)OO(8278)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['CC[CH]CO[CH]CC(C)OO(8049)'],
    products = ['CCC[CH]O[CH]CC(C)OO(8100)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CC[CH][CH]OCCC(C)OO(8279)'],
    products = ['CC[CH]CO[CH]CC(C)OO(8049)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CC[CH]COCC[C](C)OO(8280)'],
    products = ['CC[CH]CO[CH]CC(C)OO(8049)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2]CCCO[CH]CC(C)OO(8281)'],
    products = ['CC[CH]CO[CH]CC(C)OO(8049)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]C(CCOC[CH]CC)OO(8282)'],
    products = ['CC[CH]CO[CH]CC(C)OO(8049)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CC[CH]CO[CH]CC(C)OO(8049)'],
    products = ['CCCCO[CH][CH]C(C)OO(8283)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CC[CH]COCCC(C)O[O](8284)'],
    products = ['CC[CH]CO[CH]CC(C)OO(8049)'],
...
reaction(
    label = 'reaction17',
    reactants = ['C[CH][CH]COCCC(C)OO(8285)'],
    products = ['CC[CH]CO[CH]CC(C)OO(8049)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2]C[CH]COCCC(C)OO(8286)'],
    products = ['CC[CH]CO[CH]CC(C)OO(8049)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CC[CH]CO[CH]CC(C)OO(8049)'],
    products = ['CCCCO[CH]C[C](C)OO(8287)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2]C(C[CH]OCCCC)OO(8288)'],
    products = ['CC[CH]CO[CH]CC(C)OO(8049)'],
...
reaction(
    label = 'reaction21',
    reactants = ['CC[CH]CO[CH]CC(C)OO(8049)'],
    products = ['CCCCO[CH]CC(C)O[O](8289)'],
...
reaction(
    label = 'reaction26',
    reactants = ['CH2(S)(23)', 'CC[CH]CO[CH]CCOO(8293)'],
    products = ['CC[CH]CO[CH]CC(C)OO(8049)'],
...
reaction(
    label = 'reaction27',
    reactants = ['CH2(S)(23)', 'C[CH]CO[CH]CC(C)OO(7402)'],
    products = ['CC[CH]CO[CH]CC(C)OO(8049)'],
...
reaction(
    label = 'reaction28',
    reactants = ['CC[CH]CO[CH]CC(C)OO(8049)'],
    products = ['OH(5)', 'CC[CH]COC1CC(C)O1(8294)'],
...
reaction(
    label = 'reaction29',
    reactants = ['[CH2]C(OC[CH]CC)C(C)OO(8295)'],
    products = ['CC[CH]CO[CH]CC(C)OO(8049)'],
...
reaction(
    label = 'reaction30',
    reactants = ['CC[CH]CO[CH]CC(C)OO(8049)'],
    products = ['[CH2]C(C)CO[CH]CC(C)OO(8296)'],
...
reaction(
    label = 'reaction32',
    reactants = ['CC[CH]CO[CH]CC(C)OO(8049)'],
    products = ['CC[CH]COC(O)CC(C)[O](8297)'],
...
reaction(
    label = 'reaction33',
    reactants = ['[CH]CC(C)OO(1806)', 'CC[CH]C[O](1679)'],
    products = ['CC[CH]CO[CH]CC(C)OO(8049)'],
...
reaction(
    label = 'reaction34',
    reactants = ['[CH]CC(144)', '[CH2]O[CH]CC(C)OO(1955)'],
    products = ['CC[CH]CO[CH]CC(C)OO(8049)'],
