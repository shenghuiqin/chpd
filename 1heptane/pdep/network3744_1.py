species(
    label = '[CH]=CO[CH]CCC=O(21334)',
    structure = SMILES('[CH]=CO[CH]CCC=O'),
    E0 = (125.157,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3010,987.5,1337.5,450,1655,3120,650,792.5,1650,2782.5,750,1395,475,1775,1000,3025,407.5,1350,352.5,200,800,1200,1600],'cm^-1')),
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.702267,0.0947732,-0.000103006,5.53755e-08,-1.15256e-11,15229.6,31.9599], Tmin=(100,'K'), Tmax=(1183.9,'K')), NASAPolynomial(coeffs=[21.7849,0.0187961,-6.74242e-06,1.16819e-09,-7.87017e-14,9905.09,-80.3236], Tmin=(1183.9,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(125.157,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cds-OdCsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(Cds_P) + radical(CCsJOC(O))"""),
)
...
species(
    label = '[CH]=COC1CCC1[O](21983)',
    structure = SMILES('[CH]=COC1CCC1[O]'),
    E0 = (217.453,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.381242,0.0536912,3.50237e-05,-9.97654e-08,4.63126e-11,26307.6,27.2602], Tmin=(100,'K'), Tmax=(939.686,'K')), NASAPolynomial(coeffs=[25.8055,0.0109726,-1.35111e-06,2.2589e-10,-2.63857e-14,18637.4,-109.204], Tmin=(939.686,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(217.453,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(374.151,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + ring(Cyclobutane) + radical(CC(C)OJ) + radical(Cds_P)"""),
)
...
species(
    label = '[CH]=COC=CCC=O(21984)',
    structure = SMILES('[CH]=COC=CCC=O'),
    E0 = (81.6219,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3120,650,792.5,1650,2995,3010,3025,975,987.5,1000,1300,1337.5,1375,400,450,500,1630,1655,1680,2782.5,750,1395,475,1775,1000,266.49,266.49,266.494],'cm^-1')),
        HinderedRotor(inertia=(0.411578,'amu*angstrom^2'), symmetry=1, barrier=(20.7411,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.411565,'amu*angstrom^2'), symmetry=1, barrier=(20.7412,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.411579,'amu*angstrom^2'), symmetry=1, barrier=(20.7411,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.411564,'amu*angstrom^2'), symmetry=1, barrier=(20.7412,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (111.119,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.502702,0.0622968,-2.3772e-05,-1.74252e-08,1.13749e-11,9955.45,30.3046], Tmin=(100,'K'), Tmax=(1038.81,'K')), NASAPolynomial(coeffs=[19.0862,0.021538,-9.38861e-06,1.88344e-09,-1.40101e-13,4432.74,-68.056], Tmin=(1038.81,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(81.6219,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-OdCsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(Cds_P)"""),
)
...
species(
    label = '[CH]=COC[CH]CC=O(21986)',
    structure = SMILES('[CH]=COC[CH]CC=O'),
    E0 = (131.131,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3010,987.5,1337.5,450,1655,3120,650,792.5,1650,2782.5,750,1395,475,1775,1000,3025,407.5,1350,352.5,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0840223,0.079518,-6.53749e-05,2.0736e-08,-3.14452e-13,15927.5,32.7629], Tmin=(100,'K'), Tmax=(1013.78,'K')), NASAPolynomial(coeffs=[19.3397,0.021817,-8.01976e-06,1.44491e-09,-1.0106e-13,11016.1,-66.0107], Tmin=(1013.78,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(131.131,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cds-OdCsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(Cds_P) + radical(CCJCO)"""),
)
...
species(
    label = '[CH]=[C]OCCCC=O(21987)',
    structure = SMILES('[CH]=[C]OCCCC=O'),
    E0 = (170.973,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3120,650,792.5,1650,2782.5,750,1395,475,1775,1000,1685,370,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.326587,0.0817354,-8.38285e-05,4.6279e-08,-1.04086e-11,20694.9,31.9283], Tmin=(100,'K'), Tmax=(1067.23,'K')), NASAPolynomial(coeffs=[13.5924,0.0320157,-1.39482e-05,2.62757e-09,-1.83367e-13,17863.3,-32.9349], Tmin=(1067.23,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(170.973,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cds-OdCsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C=CJO) + radical(Cds_P)"""),
)

species(
    label = '[CH]=COCC[CH]C=O(21988)',
    structure = SMILES('[CH]=COCCC=C[O]'),
    E0 = (74.4809,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.279784,0.0734656,-1.92863e-05,-4.77807e-08,2.93457e-11,9131.17,30.6811], Tmin=(100,'K'), Tmax=(929.356,'K')), NASAPolynomial(coeffs=[27.0808,0.00870205,-2.96239e-07,-4.17488e-11,-2.64506e-15,1756.9,-111.627], Tmin=(929.356,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(74.4809,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C=COJ) + radical(Cds_P)"""),
)

species(
    label = '[CH]=COCCC[C]=O(21989)',
    structure = SMILES('[CH]=COCCC[C]=O'),
    E0 = (91.1899,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.431528,0.0886159,-9.21048e-05,4.81789e-08,-9.81545e-12,11134.7,32.3336], Tmin=(100,'K'), Tmax=(1206.04,'K')), NASAPolynomial(coeffs=[20.1634,0.0203099,-7.15005e-06,1.21821e-09,-8.09792e-14,6167.03,-70.8834], Tmin=(1206.04,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(91.1899,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsOsH) + group(Cds-OdCsH) + group(Cds-CdsHH) + radical(Cds_P) + radical(CCCJ=O)"""),
)

species(
    label = 'C=CO[CH][CH]CC=O(21990)',
    structure = SMILES('C=CO[CH][CH]CC=O'),
    E0 = (77.9626,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.359795,0.0851926,-7.49547e-05,2.52552e-08,-5.56448e-13,9543.23,32.8227], Tmin=(100,'K'), Tmax=(986.087,'K')), NASAPolynomial(coeffs=[21.4207,0.0184717,-6.36472e-06,1.12842e-09,-7.94048e-14,4196.1,-77.2829], Tmin=(986.087,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(77.9626,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cds-OdCsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CCsJOC(O)) + radical(CCJCO)"""),
)

species(
    label = 'C=CO[CH]C[CH]C=O(21991)',
    structure = SMILES('C=CO[CH]CC=C[O]'),
    E0 = (21.3121,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.571505,0.0793114,-2.93683e-05,-4.27851e-08,2.89936e-11,2747.55,30.799], Tmin=(100,'K'), Tmax=(923.867,'K')), NASAPolynomial(coeffs=[29.3192,0.00509538,1.50709e-06,-3.92834e-10,2.18536e-14,-5131.18,-123.789], Tmin=(923.867,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(21.3121,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CCsJOC(O)) + radical(C=COJ)"""),
)

species(
    label = 'C=CO[CH]CC[C]=O(21992)',
    structure = SMILES('C=CO[CH]CC[C]=O'),
    E0 = (38.0211,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.622825,0.0933229,-9.84616e-05,4.8796e-08,-8.52988e-12,4746.71,32.0887], Tmin=(100,'K'), Tmax=(996.905,'K')), NASAPolynomial(coeffs=[21.6314,0.0179716,-6.06131e-06,1.03306e-09,-7.00665e-14,-383.126,-78.6805], Tmin=(996.905,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(38.0211,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsOsH) + group(Cds-OdCsH) + group(Cds-CdsHH) + radical(CCsJOC(O)) + radical(CCCJ=O)"""),
)
...
species(
    label = '[CH]=COC1CC[CH]O1(21993)',
    structure = SMILES('[CH]=COC1CC[CH]O1'),
    E0 = (99.8231,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.432823,0.0529912,4.13332e-05,-1.15742e-07,5.65606e-11,12158.5,24.1988], Tmin=(100,'K'), Tmax=(892.49,'K')), NASAPolynomial(coeffs=[26.5109,0.00548098,4.59775e-06,-1.21558e-09,8.57703e-14,4740.88,-114.124], Tmin=(892.49,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(99.8231,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(374.151,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + ring(Tetrahydrofuran) + radical(Cds_P) + radical(CCsJOCs)"""),
)

species(
    label = '[CH]1CC[CH]OC=CO1(21994)',
    structure = SMILES('[CH]1CC[CH]OC=CO1'),
    E0 = (70.4879,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.164582,0.0461732,8.68734e-05,-1.75491e-07,7.89378e-11,8651.32,20.8252], Tmin=(100,'K'), Tmax=(921.39,'K')), NASAPolynomial(coeffs=[34.5618,-0.00414616,7.6096e-06,-1.51752e-09,9.05688e-14,-1890.02,-165.111], Tmin=(921.39,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(70.4879,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + ring(Cyclooctane) + radical(CCsJOC(O)) + radical(CCsJOC(O))"""),
)

species(
    label = 'C=COC=CCC=O(21995)',
    structure = SMILES('C=COC=CCC=O'),
    E0 = (-165.474,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.583135,0.0587012,-6.89013e-06,-3.50473e-08,1.73679e-11,-19764.6,29.6125], Tmin=(100,'K'), Tmax=(1026.48,'K')), NASAPolynomial(coeffs=[18.7745,0.0244884,-1.04888e-05,2.09756e-09,-1.56225e-13,-25431.4,-68.0375], Tmin=(1026.48,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-165.474,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-OdCsH) + group(Cds-CdsOsH) + group(Cds-CdsHH)"""),
)
...
species(
    label = '[CH]=CO[CH]CC(10715)',
    structure = SMILES('[CH]=CO[CH]CC'),
    E0 = (231.736,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,3120,650,792.5,1650,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.831036,'amu*angstrom^2'), symmetry=1, barrier=(19.1072,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.828393,'amu*angstrom^2'), symmetry=1, barrier=(19.0464,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.828455,'amu*angstrom^2'), symmetry=1, barrier=(19.0478,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.828811,'amu*angstrom^2'), symmetry=1, barrier=(19.056,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.389616,0.0662051,-3.76616e-05,-1.29517e-08,1.39413e-11,28013.6,23.7639], Tmin=(100,'K'), Tmax=(931.281,'K')), NASAPolynomial(coeffs=[21.2197,0.0103802,-1.93501e-06,2.65294e-10,-2.04145e-14,22674.9,-83.0795], Tmin=(931.281,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(231.736,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(Cds_P) + radical(CCsJOC(O))"""),
)

species(
    label = '[CH]=COC([CH2])CC=O(21996)',
    structure = SMILES('[CH]=COC([CH2])CC=O'),
    E0 = (129.096,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.598257,0.0949016,-0.000105048,5.81965e-08,-1.25462e-11,15697.7,31.5198], Tmin=(100,'K'), Tmax=(1140.68,'K')), NASAPolynomial(coeffs=[20.4836,0.0209736,-7.83081e-06,1.37796e-09,-9.32893e-14,10888.2,-72.9627], Tmin=(1140.68,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(129.096,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(Cds_P) + radical(CJC(C)OC)"""),
)
...
species(
    label = '[CH]=CO[CH]COC=C(21997)',
    structure = SMILES('[CH]=CO[CH]COC=C'),
    E0 = (166.753,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2950,3100,1380,975,1025,1650,3120,650,792.5,1650,2995,3025,975,1000,1300,1375,400,500,1630,1680,3025,407.5,1350,352.5,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.86777,0.111547,-0.000121529,5.98917e-08,-1.06967e-11,20337.1,36.8113], Tmin=(100,'K'), Tmax=(1642.72,'K')), NASAPolynomial(coeffs=[32.0022,0.000115661,4.44042e-06,-1.05959e-09,7.512e-14,12459.5,-137.831], Tmin=(1642.72,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(166.753,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cds_P) + radical(CCsJOC(O))"""),
)

species(
    label = '[CH]=CO[CH]CC=CO(21998)',
    structure = SMILES('[CH]=CO[CH]CC=CO'),
    E0 = (126.946,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3025,407.5,1350,352.5,3615,1277.5,1000,3120,650,792.5,1650,2995,3010,3025,975,987.5,1000,1300,1337.5,1375,400,450,500,1630,1655,1680,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.89325,0.111033,-0.000121966,6.05365e-08,-1.08489e-11,15551.3,38.1545], Tmin=(100,'K'), Tmax=(1648.06,'K')), NASAPolynomial(coeffs=[31.5025,-0.000527041,5.12624e-06,-1.21207e-09,8.60763e-14,8027.18,-133.4], Tmin=(1648.06,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(126.946,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(Cds_P) + radical(CCsJOC(O))"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH]=CO[CH]CCC=O(21334)'],
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', '[CH]=COC=CCC=O(21984)'],
    products = ['[CH]=CO[CH]CCC=O(21334)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)', 'C#CO[CH]CCC=O(21985)'],
    products = ['[CH]=CO[CH]CCC=O(21334)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['CH2CHO(40)', '[CH]=COC=C(4301)'],
    products = ['[CH]=CO[CH]CCC=O(21334)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH]=COC[CH]CC=O(21986)'],
    products = ['[CH]=CO[CH]CCC=O(21334)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction13',
    reactants = ['[CH]=CO[CH]CCC=O(21334)'],
    products = ['C=CO[CH][CH]CC=O(21990)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH]=CO[CH]CCC=O(21334)'],
    products = ['C=CO[CH]C[CH]C=O(21991)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH]=CO[CH]CCC=O(21334)'],
    products = ['[CH]=COC1CC[CH]O1(21993)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH]=CO[CH]CCC=O(21334)'],
    products = ['[CH]1CC[CH]OC=CO1(21994)'],
...
reaction(
    label = 'reaction20',
    reactants = ['CO(12)', '[CH]=CO[CH]CC(10715)'],
    products = ['[CH]=CO[CH]CCC=O(21334)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH]=COC([CH2])CC=O(21996)'],
    products = ['[CH]=CO[CH]CCC=O(21334)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH]=CO[CH]COC=C(21997)'],
    products = ['[CH]=CO[CH]CCC=O(21334)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[CH]=CO[CH]CC=CO(21998)'],
    products = ['[CH]=CO[CH]CCC=O(21334)'],
...
reaction(
    label = 'reaction25',
    reactants = ['CHCHO(47)', '[CH]CCC=O(18484)'],
    products = ['[CH]=CO[CH]CCC=O(21334)'],
