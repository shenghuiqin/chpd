...
species(
    label = 'C=C[C]=CCC=CC(27074)',
    structure = SMILES('C=C[C]=CCC=CC'),
    E0 = (303.492,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2950,3100,1380,975,1025,1650,1685,370,2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3005,3015,3025,975,983.333,991.667,1000,1300,1325,1350,1375,400,433.333,466.667,500,1630,1646.67,1663.33,1680,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.757112,'amu*angstrom^2'), symmetry=1, barrier=(17.4075,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.757093,'amu*angstrom^2'), symmetry=1, barrier=(17.407,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.757784,'amu*angstrom^2'), symmetry=1, barrier=(17.4229,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.757336,'amu*angstrom^2'), symmetry=1, barrier=(17.4126,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (107.173,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0826016,0.0761941,-4.87152e-05,1.15466e-08,5.45127e-13,36651.1,30.925], Tmin=(100,'K'), Tmax=(1094.1,'K')), NASAPolynomial(coeffs=[15.0632,0.0360492,-1.37261e-05,2.44318e-09,-1.66203e-13,32497.7,-46.6952], Tmin=(1094.1,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(303.492,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(440.667,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + radical(C=CJC=C)"""),
)

species(
    label = 'C=C[C]=CC=CCC(27075)',
    structure = SMILES('C=C[C]=CC=CCC'),
    E0 = (286.018,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2950,3100,1380,975,1025,1650,1685,370,2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3005,3015,3025,975,983.333,991.667,1000,1300,1325,1350,1375,400,433.333,466.667,500,1630,1646.67,1663.33,1680,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.924576,'amu*angstrom^2'), symmetry=1, barrier=(21.2578,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.921509,'amu*angstrom^2'), symmetry=1, barrier=(21.1873,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.924617,'amu*angstrom^2'), symmetry=1, barrier=(21.2588,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.92181,'amu*angstrom^2'), symmetry=1, barrier=(21.1942,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (107.173,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0451345,0.0761056,-3.50813e-05,-1.26761e-08,1.17116e-11,34557.1,29.4639], Tmin=(100,'K'), Tmax=(968.8,'K')), NASAPolynomial(coeffs=[18.0301,0.0308994,-1.06444e-05,1.85678e-09,-1.28255e-13,29674.1,-64.292], Tmin=(968.8,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(286.018,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(440.667,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + radical(C=CJC=C)"""),
)

species(
    label = 'C=CC#CC[CH]CC(27076)',
    structure = SMILES('C=CC#CC[CH]CC'),
    E0 = (352.932,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2100,2250,500,550,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,2750,2800,2850,1350,1500,750,1050,1375,1000,2950,3100,1380,975,1025,1650,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (107.173,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.543965,0.069162,-4.21527e-05,1.33278e-08,-1.7523e-12,42577.7,32.9177], Tmin=(100,'K'), Tmax=(1702.64,'K')), NASAPolynomial(coeffs=[13.8949,0.0377971,-1.45209e-05,2.50868e-09,-1.63731e-13,38031.3,-38.5979], Tmin=(1702.64,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(352.932,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CtCsHH) + group(Cs-CsHHH) + group(Cds-CdsCtH) + group(Cds-CdsHH) + group(Ct-CtCs) + group(Ct-Ct(Cds-Cds)) + radical(RCCJCC)"""),
)

species(
    label = 'C=C=C=CC[CH]CC(27077)',
    structure = SMILES('C=C=C=CC[CH]CC'),
    E0 = (411.533,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([540,563.333,586.667,610,1970,2140,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,2750,2800,2850,1350,1500,750,1050,1375,1000,2950,3100,1380,975,1025,1650,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,231.411,231.536,231.578],'cm^-1')),
        HinderedRotor(inertia=(0.156348,'amu*angstrom^2'), symmetry=1, barrier=(5.95066,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156369,'amu*angstrom^2'), symmetry=1, barrier=(5.95089,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00314359,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.364477,'amu*angstrom^2'), symmetry=1, barrier=(13.8527,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (107.173,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.835051,0.0753467,-6.00128e-05,2.98498e-08,-6.91356e-12,49605.2,30.2297], Tmin=(100,'K'), Tmax=(961.202,'K')), NASAPolynomial(coeffs=[6.46796,0.0519054,-2.34312e-05,4.47738e-09,-3.14372e-13,48522.3,3.27712], Tmin=(961.202,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(411.533,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(440.667,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + group(Cdd-CdsCds) + radical(RCCJCC)"""),
)
...
species(
    ...
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.277907,0.0800008,-5.96218e-05,2.5076e-08,-4.50882e-12,45974.9,32.8924], Tmin=(100,'K'), Tmax=(1274.31,'K')), NASAPolynomial(coeffs=[11.5981,0.0444671,-1.7795e-05,3.19397e-09,-2.15919e-13,43089.8,-24.4653], Tmin=(1274.31,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(381.131,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + radical(RCCJC) + radical(C=CJC=C)"""),
)
...
species(
    ...
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.541591,0.0764233,-5.31679e-05,2.02062e-08,-3.30921e-12,50636.9,32.6481], Tmin=(100,'K'), Tmax=(1360.07,'K')), NASAPolynomial(coeffs=[11.0445,0.0455342,-1.91008e-05,3.50762e-09,-2.39788e-13,47779.9,-21.2523], Tmin=(1360.07,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(419.99,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + radical(Cds_S) + radical(RCCJCC)"""),
)

species(
    label = 'C=[C]C=CC[CH]CC(27080)',
    structure = SMILES('C=[C]C=CC[CH]CC'),
    E0 = (381.143,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,3025,407.5,1350,352.5,2995,3025,975,1000,1300,1375,400,500,1630,1680,2750,2800,2850,1350,1500,750,1050,1375,1000,2950,3100,1380,975,1025,1650,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,200,800,1200,1600],'cm^-1')),
...
species(
    ...
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.263562,0.0848787,-6.52315e-05,2.68107e-08,-4.51125e-12,47299.3,33.8947], Tmin=(100,'K'), Tmax=(1400.38,'K')), NASAPolynomial(coeffs=[16.4596,0.0371117,-1.4067e-05,2.45351e-09,-1.62975e-13,42615.5,-52.4162], Tmin=(1400.38,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(391.931,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + radical(RCCJ) + radical(C=CJC=C)"""),
)

species(
    label = 'C=C[C]=[C]CCCC(27082)',
    structure = SMILES('[CH2][CH]C#CCCCC'),
    E0 = (388.804,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2100,2250,500,550,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,3025,407.5,1350,352.5,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.00434708,0.0791999,-5.90138e-05,2.53643e-08,-4.55609e-12,46913.9,35.6607], Tmin=(100,'K'), Tmax=(1312.78,'K')), NASAPolynomial(coeffs=[13.122,0.0392044,-1.33145e-05,2.15696e-09,-1.36588e-13,43467.5,-31.2386], Tmin=(1312.78,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(388.804,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CtCsHH) + group(Cs-CtCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtCs) + radical(RCCJ) + radical(Sec_Propargyl)"""),
)

species(
    label = 'C=CC=C[CH][CH]CC(27083)',
    ...
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.423538,0.062374,5.93581e-06,-4.95366e-08,2.27434e-11,28360.6,30.0523], Tmin=(100,'K'), Tmax=(989.808,'K')), NASAPolynomial(coeffs=[15.9211,0.0376326,-1.39858e-05,2.55262e-09,-1.80406e-13,23436.7,-53.9308], Tmin=(989.808,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(234.613,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + radical(C=CC=CCJ) + radical(Allyl_S)"""),
)

species(
    label = '[CH]=CC=CC[CH]CC(27084)',
    structure = SMILES('[CH]=CC=CC[CH]CC'),
    E0 = (429.244,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2995,3010,3025,975,987.5,1000,1300,1337.5,1375,400,450,500,1630,1655,1680,3120,650,792.5,1650,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    ...
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0814446,0.0794721,-5.76912e-05,2.33709e-08,-3.97336e-12,40880,33.0357], Tmin=(100,'K'), Tmax=(1365.44,'K')), NASAPolynomial(coeffs=[13.2985,0.0407537,-1.51578e-05,2.60444e-09,-1.71242e-13,37270.5,-34.8458], Tmin=(1365.44,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(338.677,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CtCsHH) + group(Cs-CsHHH) + group(Cs-CtHHH) + group(Ct-CtCs) + group(Ct-CtCs) + radical(Propargyl) + radical(Sec_Propargyl)"""),
)

species(
    label = '[CH2]C[CH]CC=CC=C(27086)',
...
species(
    label = '[CH]=C[C]=CCCCC(27087)',
    structure = SMILES('[CH]C=C=CCCCC'),
    E0 = (411.155,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,540,610,2055,2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.052458,0.0822051,-5.12407e-05,1.60944e-08,-2.08319e-12,49601.7,32.8991], Tmin=(100,'K'), Tmax=(1730.21,'K')), NASAPolynomial(coeffs=[16.7901,0.0432673,-1.74834e-05,3.08737e-09,-2.03772e-13,43773.5,-57.59], Tmin=(1730.21,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(411.155,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cdd-CdsCds) + radical(AllylJ2_triplet)"""),
)

species(
    label = 'CC[CH]CC=C1[CH]C1(27088)',
    structure = SMILES('CC[CH]CC=C1[CH]C1'),
    E0 = (416.284,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.65916,0.0625583,-1.45954e-05,-1.4912e-08,7.35384e-12,50196.7,30.8419], Tmin=(100,'K'), Tmax=(1134.79,'K')), NASAPolynomial(coeffs=[11.7258,0.0443848,-1.81135e-05,3.33437e-09,-2.3036e-13,46343.5,-29.8583], Tmin=(1134.79,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(416.284,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(465.61,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + ring(Methylene_cyclopropane) + radical(RCCJCC) + radical(Allyl_S)"""),
)
...
species(
    label = 'C=CC=CC=CCC(27089)',
    structure = SMILES('C=CC=CC=CCC'),
    E0 = (87.0221,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0393159,0.069481,-5.67867e-06,-4.5994e-08,2.36869e-11,10624.8,29.5643], Tmin=(100,'K'), Tmax=(969.722,'K')), NASAPolynomial(coeffs=[19.5488,0.03085,-1.06481e-05,1.91983e-09,-1.37319e-13,4873.6,-74.1022], Tmin=(969.722,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(87.0221,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(465.61,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH)"""),
)
...
species(
    ...
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.123085,0.0804735,-5.63197e-05,2.0442e-08,-3.07338e-12,26251.2,30.2037], Tmin=(100,'K'), Tmax=(1517.59,'K')), NASAPolynomial(coeffs=[15.3354,0.0403772,-1.66879e-05,3.03194e-09,-2.05306e-13,21634,-49.5324], Tmin=(1517.59,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(217.075,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(465.61,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + group(Cdd-CdsCds)"""),
)
...
species(
    ...
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.144847,0.0819483,-5.30661e-05,1.03236e-08,2.56559e-12,46188.6,33.1768], Tmin=(100,'K'), Tmax=(988.958,'K')), NASAPolynomial(coeffs=[15.4444,0.0372871,-1.3222e-05,2.26923e-09,-1.52035e-13,42205.8,-46.4062], Tmin=(988.958,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(382.726,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + radical(Isobutyl) + radical(C=CJC=C)"""),
)
...
species(
    ...
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.917478,0.0721094,-4.2384e-05,-9.55153e-10,1.21814e-11,45417.2,31.5937], Tmin=(100,'K'), Tmax=(648.546,'K')), NASAPolynomial(coeffs=[6.30262,0.050585,-1.96368e-05,3.45315e-09,-2.30745e-13,44472.9,6.05011], Tmin=(648.546,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(376.728,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CtCsHH) + group(Cs-CsHHH) + group(Cs-CtHHH) + group(Ct-CtCs) + group(Ct-CtCs) + radical(RCCJCC) + radical(Sec_Propargyl)"""),
)

species(
    label = 'CC=C=[C]C[CH]CC(27093)',
    ...
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.625365,0.0740674,-5.54732e-05,2.72196e-08,-6.04938e-12,45586.4,33.4858], Tmin=(100,'K'), Tmax=(1029.71,'K')), NASAPolynomial(coeffs=[7.19128,0.048561,-1.83168e-05,3.16283e-09,-2.086e-13,44234.3,1.61696], Tmin=(1029.71,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(378.016,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CtCsHH) + group(Cs-CtCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtCs) + radical(RCCJCC) + radical(Sec_Propargyl)"""),
)

species(
    label = 'CC=C=C[CH][CH]CC(27094)',
    ...
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.254219,0.0812776,-5.70411e-05,2.09926e-08,-3.15129e-12,38115.6,30.5442], Tmin=(100,'K'), Tmax=(1559.02,'K')), NASAPolynomial(coeffs=[17.4927,0.0357444,-1.32318e-05,2.25902e-09,-1.47233e-13,32582,-62.955], Tmin=(1559.02,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(315.552,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + radical(Allyl_S) + radical(C=CJC=C)"""),
)
...
species(
    label = '[CH2]C[CH]CC=C=CC(27095)',
    structure = SMILES('[CH2]C[CH]CC=C=CC'),
    E0 = (440.175,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([540,610,2055,3025,407.5,1350,352.5,2995,3025,975,1000,1300,1375,400,500,1630,1680,2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3100,440,815,1455,1000,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.764071,0.0771756,-6.36967e-05,3.63353e-08,-1.01069e-11,53052.1,33.2224], Tmin=(100,'K'), Tmax=(803.947,'K')), NASAPolynomial(coeffs=[4.84148,0.0568896,-2.58488e-05,4.95174e-09,-3.4811e-13,52396.5,14.4408], Tmin=(803.947,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(440.175,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cdd-CdsCds) + radical(RCCJ) + radical(RCCJCC)"""),
)

species(
    label = '[CH2]C=C1[CH]CC1CC(27096)',
    structure = SMILES('[CH2]C=C1[CH]CC1CC'),
    E0 = (301.408,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[9.60455,-0.000490682,0.000134056,-1.33482e-07,3.12751e-11,35941.6,-12.42], Tmin=(100,'K'), Tmax=(1687.74,'K')), NASAPolynomial(coeffs=[73.1335,0.0435731,-7.80846e-05,1.86418e-08,-1.37957e-12,-13222.4,-434.282], Tmin=(1687.74,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(301.408,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(469.768,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + ring(methylenecyclobutane) + radical(Allyl_S) + radical(Allyl_P)"""),
)
...
species(
    label = 'CC=C=CC=CCC(27097)',
    structure = SMILES('CC=C=CC=CCC'),
    E0 = (139.803,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0328623,0.0770571,-4.20027e-05,2.90301e-09,3.5254e-12,16969.5,29.8584], Tmin=(100,'K'), Tmax=(1090.49,'K')), NASAPolynomial(coeffs=[15.9622,0.0378692,-1.4898e-05,2.71634e-09,-1.87818e-13,12322.6,-54.0055], Tmin=(1090.49,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(139.803,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(465.61,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cdd-CdsCds)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['C=C[C]=CC[CH]CC(26536)'],
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'C=C[C]=CCC=CC(27074)'],
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', 'C=C[C]=CC=CCC(27075)'],
    products = ['C=C[C]=CC[CH]CC(26536)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)', 'C=CC#CC[CH]CC(27076)'],
    products = ['C=C[C]=CC[CH]CC(26536)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['H(3)', 'C=C=C=CC[CH]CC(27077)'],
    products = ['C=C[C]=CC[CH]CC(26536)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['CH3(17)', 'C=C[C]=CCC=C(26886)'],
    products = ['C=C[C]=CC[CH]CC(26536)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction12',
    reactants = ['C=CC=[C]C[CH]CC(27079)'],
    products = ['C=C[C]=CC[CH]CC(26536)'],
...
reaction(
    label = 'reaction13',
    reactants = ['C=[C]C=CC[CH]CC(27080)'],
    products = ['C=C[C]=CC[CH]CC(26536)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]CCCC=[C]C=C(27081)'],
    products = ['C=C[C]=CC[CH]CC(26536)'],
...
reaction(
    label = 'reaction16',
    reactants = ['C=C[C]=CC[CH]CC(26536)'],
    products = ['C=CC=C[CH][CH]CC(27083)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH]=CC=CC[CH]CC(27084)'],
    products = ['C=C[C]=CC[CH]CC(26536)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2]C[CH]CC=CC=C(27086)'],
    products = ['C=C[C]=CC[CH]CC(26536)'],
...
reaction(
    label = 'reaction23',
    reactants = ['C=C[C]=CC[CH]CC(26536)'],
    products = ['CC[CH]CC=C1[CH]C1(27088)'],
...
reaction(
    label = 'reaction28',
    reactants = ['CH2(S)(23)', 'C=C[C]=CC[CH]C(26546)'],
    products = ['C=C[C]=CC[CH]CC(26536)'],
...
reaction(
    label = 'reaction29',
    reactants = ['[CH2]C(C)CC=[C]C=C(27091)'],
    products = ['C=C[C]=CC[CH]CC(26536)'],
...
reaction(
    label = 'reaction32',
    reactants = ['[CH]CC(144)', '[CH2]C=[C]C=C(26613)'],
    products = ['C=C[C]=CC[CH]CC(26536)'],
...
reaction(
    label = 'reaction36',
    reactants = ['C=C[C]=CC[CH]CC(26536)'],
    products = ['CC=C=C[CH][CH]CC(27094)'],
...
reaction(
    label = 'reaction38',
    reactants = ['[CH2]C[CH]CC=C=CC(27095)'],
    products = ['C=C[C]=CC[CH]CC(26536)'],
...
reaction(
    label = 'reaction39',
    reactants = ['C=C[C]=CC[CH]CC(26536)'],
    products = ['[CH2]C=C1[CH]CC1CC(27096)'],
