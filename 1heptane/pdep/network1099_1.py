species(
    label = 'CCC(CCC(C)OO)OO(3817)',
    structure = SMILES('CCC(CCC(C)OO)OO'),
    E0 = (-417.576,'kJ/mol'),
    modes = [
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.85734,0.134759,-0.000127364,6.66495e-08,-1.46832e-11,-50016.7,43.619], Tmin=(100,'K'), Tmax=(1065.92,'K')), NASAPolynomial(coeffs=[16.5695,0.0656093,-3.00523e-05,5.78616e-09,-4.08204e-13,-53945,-46.4561], Tmin=(1065.92,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-417.576,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(615.271,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH)"""),
)
...
species(
    label = 'CCC(CC[CH]OO)OO(4223)',
    structure = SMILES('CCC(CC[CH]OO)OO'),
    E0 = (-192.57,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,3580,3650,1300,1320,350,425,825,875,900,1100,1380,1390,370,380,2900,435,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.32774,0.126142,-0.000144782,9.67742e-08,-2.72543e-11,-22976.8,39.9807], Tmin=(100,'K'), Tmax=(848.901,'K')), NASAPolynomial(coeffs=[12.625,0.0604009,-2.86248e-05,5.55738e-09,-3.92625e-13,-25345.8,-25.0485], Tmin=(848.901,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-192.57,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(519.654,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCsJOOH)"""),
)
...
species(
    label = 'CCC(CCCOO)OO(4224)',
    structure = SMILES('CCC(CCCOO)OO'),
    E0 = (-381.152,'kJ/mol'),
    modes = [
    ...
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (150.173,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.20386,0.121964,-0.000123198,7.09105e-08,-1.73084e-11,-45660.9,39.3826], Tmin=(100,'K'), Tmax=(966.601,'K')), NASAPolynomial(coeffs=[13.5679,0.060837,-2.83412e-05,5.48886e-09,-3.88261e-13,-48516.7,-31.381], Tmin=(966.601,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-381.152,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(544.598,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH)"""),
)

species(
    label = 'CC(CCC(C)OO)OO(4225)',
    structure = SMILES('CC(CCC(C)OO)OO'),
    E0 = (-393.795,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3580,3650,1300,1320,350,425,825,875,900,1100,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (150.173,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.24102,0.120346,-0.000114854,6.03498e-08,-1.32987e-11,-47178.1,38.467], Tmin=(100,'K'), Tmax=(1067.98,'K')), NASAPolynomial(coeffs=[15.5938,0.0572922,-2.6294e-05,5.06729e-09,-3.57699e-13,-50773.9,-43.8585], Tmin=(1067.98,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-393.795,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(544.598,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['OH(5)', 'CCC(CCC(C)[O])OO(4222)'],
    products = ['CCC(CCC(C)OO)OO(3817)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['C[CH]CCC(CC)OO(236)', 'HO2(10)'],
    products = ['CCC(CCC(C)OO)OO(3817)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['OH(5)', 'CCC([O])CCC(C)OO(3749)'],
    products = ['CCC(CCC(C)OO)OO(3817)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(2e+13,'cm^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""From training reaction 103 used for O_pri_rad;O_rad/NonDe
...
reaction(
    label = 'reaction4',
    reactants = ['CC[CH]CCC(C)OO(213)', 'HO2(10)'],
    products = ['CCC(CCC(C)OO)OO(3817)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(6.03e+12,'cm^3/(mol*s)','*|/',5), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2500,'K'), comment="""From training reaction 84 used for C_rad/H/NonDeC;O_rad/NonDe
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)', 'CCC(CCC(C)O[O])OO(3734)'],
    products = ['CCC(CCC(C)OO)OO(3817)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['H(3)', 'CCC(CCC(C)OO)O[O](3726)'],
    products = ['CCC(CCC(C)OO)OO(3817)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['CC[CH]OO(288)', '[CH2]CC(C)OO(2102)'],
    products = ['CCC(CCC(C)OO)OO(3817)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['C2H5(29)', 'CC(CC[CH]OO)OO(1644)'],
    products = ['CCC(CCC(C)OO)OO(3817)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(1.15e+14,'cm^3/(mol*s)','*|/',2), n=-0.35, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2500,'K'), comment="""Estimated using template [C_rad/H/NonDe;C_rad/H2/Cs] for rate rule [C_rad/H/CsO;C_rad/H2/Cs]
Euclidian distance = 2.0
...
reaction(
    label = 'reaction9',
    reactants = ['H(3)', 'CC[C](CCC(C)OO)OO(3727)'],
    products = ['CCC(CCC(C)OO)OO(3817)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['CH3CHOOH(63)', '[CH2]CC(CC)OO(2965)'],
    products = ['CCC(CCC(C)OO)OO(3817)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CH3(17)', 'CCC(CC[CH]OO)OO(4223)'],
    products = ['CCC(CCC(C)OO)OO(3817)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(3)', 'CCC(CC[C](C)OO)OO(3732)'],
    products = ['CCC(CCC(C)OO)OO(3817)'],
...
reaction(
    label = 'reaction13',
    reactants = ['QOOH_3(717)', '[CH2]C(CC)OO(715)'],
    products = ['CCC(CCC(C)OO)OO(3817)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(3)', 'CCC(C[CH]C(C)OO)OO(3730)'],
    products = ['CCC(CCC(C)OO)OO(3817)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(3)', 'CCC([CH]CC(C)OO)OO(3728)'],
    products = ['CCC(CCC(C)OO)OO(3817)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CH3(17)', '[CH2]C(CCC(C)OO)OO(4084)'],
    products = ['CCC(CCC(C)OO)OO(3817)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(3)', 'C[CH]C(CCC(C)OO)OO(3729)'],
    products = ['CCC(CCC(C)OO)OO(3817)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(3)', '[CH2]C(CCC(CC)OO)OO(3733)'],
    products = ['CCC(CCC(C)OO)OO(3817)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(3)', '[CH2]CC(CCC(C)OO)OO(3731)'],
    products = ['CCC(CCC(C)OO)OO(3817)'],
...
reaction(
    label = 'reaction20',
    reactants = ['CH2(S)(23)', 'CCC(CCCOO)OO(4224)'],
    products = ['CCC(CCC(C)OO)OO(3817)'],
...
reaction(
    label = 'reaction21',
    reactants = ['CH2(S)(23)', 'CC(CCC(C)OO)OO(4225)'],
    products = ['CCC(CCC(C)OO)OO(3817)'],
...
network(
    label = '1099',
    isomers = [
        'CCC(CCC(C)OO)OO(3817)',
    ],
    reactants = [
        ('CC[CH]CCC(C)OO(213)', 'HO2(10)'),
        ('H(3)', 'CCC(CCC(C)OO)O[O](3726)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
