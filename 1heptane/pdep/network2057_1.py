...
species(
    label = 'C=COOO(666)',
    structure = SMILES('C=COOO'),
    E0 = (-6.17149,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,3100,1380,975,1025,1650,3010,987.5,1337.5,450,1655,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.20773,0.0280386,9.32162e-06,-4.01108e-08,1.9602e-11,-667.254,19.8094], Tmin=(100,'K'), Tmax=(934.636,'K')), NASAPolynomial(coeffs=[14.2941,0.00525493,-5.63326e-07,7.27783e-11,-8.95425e-15,-4190.68,-44.4463], Tmin=(934.636,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-6.17149,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsOs) + group(O2s-OsH) + group(Cds-CdsOsH) + group(Cds-CdsHH)"""),
)
...
species(
    label = '[CH2][CH]OOO(665)',
    structure = SMILES('[CH2][CH]OOO'),
    E0 = (252.321,'kJ/mol'),
    modes = [
...
species(
    label = '[CH2]OOO(701)',
    structure = SMILES('[CH2]OOO'),
    E0 = (82.6062,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,598.602,598.602,598.606,598.61,598.614,598.625],'cm^-1')),
        HinderedRotor(inertia=(0.00532428,'amu*angstrom^2'), symmetry=1, barrier=(1.35386,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00532389,'amu*angstrom^2'), symmetry=1, barrier=(1.35374,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00532489,'amu*angstrom^2'), symmetry=1, barrier=(1.35405,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (63.0327,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.7238,0.0217118,-1.30812e-06,-1.69899e-08,8.87799e-12,9986.93,15.0407], Tmin=(100,'K'), Tmax=(958.875,'K')), NASAPolynomial(coeffs=[9.98344,0.00685233,-2.19217e-06,4.00769e-10,-3.00354e-14,7885.62,-23.3755], Tmin=(958.875,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(82.6062,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(145.503,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsOs) + group(O2s-OsH) + group(Cs-OsHHH) + radical(CsJOO)"""),
)

species(
    label = '[CH]COOO(11376)',
    structure = SMILES('[CH]COOO'),
    E0 = (299.126,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (76.0514,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.87449,0.0411029,-3.33427e-05,9.93298e-09,1.23319e-13,36058,21.3283], Tmin=(100,'K'), Tmax=(1020.57,'K')), NASAPolynomial(coeffs=[12.1998,0.0109396,-4.15639e-06,7.61828e-10,-5.38042e-14,33413.8,-31.325], Tmin=(1020.57,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(299.126,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(191.233,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsOs) + group(O2s-OsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCJ2_triplet)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]COOO(11241)'],
    products = ['HO2(10)', 'cC2H4O(44)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'C=COOO(666)'],
    products = ['[CH2]COOO(11241)'],
    transitionState = 'TS2',
