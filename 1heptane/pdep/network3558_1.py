...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0681242,0.0847508,-6.29263e-05,2.56853e-08,-4.39951e-12,24031.6,32.4622], Tmin=(100,'K'), Tmax=(1349.78,'K')), NASAPolynomial(coeffs=[13.8595,0.0434768,-1.70587e-05,3.03082e-09,-2.0354e-13,20271.8,-38.908], Tmin=(1349.78,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(198.562,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(486.397,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)CsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Isobutyl)"""),
)
...
species(
    label = '[CH2]C(C=C)C(C)[CH]C(19179)',
...
species(
    label = '[CH2]CC(C)C([CH2])C=C(19183)',
...
species(
    label = '[CH2]C([CH]C=C)CC(19192)',
    structure = SMILES('[CH2]C=CC([CH2])CC'),
    E0 = (248.502,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2995,3025,975,1000,1300,1375,400,500,1630,1680,1380,1390,370,380,2900,435,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,2750,2800,2850,1350,1500,750,1050,1375,1000,180,1149.92],'cm^-1')),
        HinderedRotor(inertia=(0.617778,'amu*angstrom^2'), symmetry=1, barrier=(14.2039,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0151215,'amu*angstrom^2'), symmetry=1, barrier=(14.1972,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0151254,'amu*angstrom^2'), symmetry=1, barrier=(14.197,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.256117,'amu*angstrom^2'), symmetry=1, barrier=(5.88863,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(3.40288,'amu*angstrom^2'), symmetry=1, barrier=(78.239,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (96.1702,'amu'),
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]C(C=C)C([CH2])CC(18958)'],
    products = ['[CH2]C(CC)C1CC1[CH2](19172)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', '[CH2]C(C=C)C(=C)CC(19174)'],
...
reaction(
    label = 'reaction7',
    reactants = ['C2H5(29)', '[CH2]C(C=C)C=C(18999)'],
    products = ['[CH2]C(C=C)C([CH2])CC(18958)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['C2H3(30)', '[CH2]C(C=C)CC(420)'],
    products = ['[CH2]C(C=C)C([CH2])CC(18958)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]C(C=C)C([CH2])CC(18958)'],
    products = ['[CH2]C(C=C)[C](C)CC(19176)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2]C(C=C)C([CH2])CC(18958)'],
    products = ['[CH2]C(C=C)C(C)[CH]C(19179)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2]CC(C)C([CH2])C=C(19183)'],
    products = ['[CH2]C(C=C)C([CH2])CC(18958)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2]CC([CH2])C(C)C=C(19185)'],
    products = ['[CH2]C(C=C)C([CH2])CC(18958)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH]=CC([CH2])C(C)CC(19186)'],
    products = ['[CH2]C(C=C)C([CH2])CC(18958)'],
...
reaction(
    label = 'reaction27',
    reactants = ['CH2(S)(23)', '[CH2]C(C)C([CH2])C=C(18971)'],
    products = ['[CH2]C(C=C)C([CH2])CC(18958)'],
...
reaction(
    label = 'reaction31',
    reactants = ['[CH2]C(C=C)C([CH2])CC(18958)'],
    products = ['[CH2]C([CH]CC=C)CC(19191)'],
...
reaction(
    label = 'reaction33',
    reactants = ['CH2(19)', '[CH2]C([CH]CC)C=C(3297)'],
    products = ['[CH2]C(C=C)C([CH2])CC(18958)'],
...
reaction(
    label = 'reaction34',
    reactants = ['CH2(19)', '[CH2]C([CH]C=C)CC(19192)'],
    products = ['[CH2]C(C=C)C([CH2])CC(18958)'],
