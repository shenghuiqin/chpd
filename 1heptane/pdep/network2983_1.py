species(
    label = 'CC[CH]OC([O])CC(C)OO(13590)',
    structure = SMILES('CC[CH]OC([O])CC(C)OO'),
    E0 = (-239.749,'kJ/mol'),
    modes = [
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.99069,0.14243,-0.00017811,1.31934e-07,-4.10216e-11,-28629.2,45.8335], Tmin=(100,'K'), Tmax=(774.351,'K')), NASAPolynomial(coeffs=[12.6003,0.0670588,-3.21066e-05,6.23477e-09,-4.39282e-13,-30888.9,-20.8283], Tmin=(774.351,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-239.749,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(569.541,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCsJOCs) + radical(CCOJ)"""),
)
...
species(
    label = 'CC=COC([O])CC(C)OO(13632)',
    structure = SMILES('CC=COC([O])CC(C)OO'),
    E0 = (-344.584,'kJ/mol'),
    modes = [
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.84845,0.126376,-0.000119358,5.85625e-08,-1.16399e-11,-41231.5,43.1145], Tmin=(100,'K'), Tmax=(1200.53,'K')), NASAPolynomial(coeffs=[21.7448,0.0477671,-2.11399e-05,4.02132e-09,-2.82191e-13,-46896.4,-75.0212], Tmin=(1200.53,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-344.584,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(548.755,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(CCOJ)"""),
)

species(
    label = 'CC[CH]OC(=O)CC(C)OO(13633)',
    structure = SMILES('CC[CH]OC(=O)CC(C)OO'),
    E0 = (-443.503,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (161.176,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.45276,0.12907,-0.000142023,9.06279e-08,-2.44794e-11,-53152.6,41.855], Tmin=(100,'K'), Tmax=(880.823,'K')), NASAPolynomial(coeffs=[13.0346,0.0632812,-2.99884e-05,5.83407e-09,-4.1309e-13,-55704.8,-26.2001], Tmin=(880.823,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-443.503,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(544.598,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdCsOs) + radical(CCsJOC(O))"""),
)
...
species(
    label = 'C[CH]COC([O])CC(C)OO(13634)',
    structure = SMILES('C[CH]COC([O])CC(C)OO'),
    E0 = (-220.303,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3025,407.5,1350,352.5,3615,1310,387.5,850,1000,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (162.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.36095,0.128482,-0.00014364,9.90707e-08,-2.9697e-11,-26312.7,46.6331], Tmin=(100,'K'), Tmax=(790.455,'K')), NASAPolynomial(coeffs=[10.0481,0.0707485,-3.40824e-05,6.67076e-09,-4.73425e-13,-28116.4,-5.72605], Tmin=(790.455,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-220.303,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(569.541,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJCO) + radical(CCOJ)"""),
)

species(
    label = 'CC[CH]O[C](O)CC(C)OO(13635)',
    structure = SMILES('CC[CH]O[C](O)CC(C)OO'),
    E0 = (-260.208,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (162.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.2051,0.144588,-0.000171498,1.12514e-07,-3.02529e-11,-31079.3,46.4317], Tmin=(100,'K'), Tmax=(897.656,'K')), NASAPolynomial(coeffs=[17.1995,0.0581196,-2.70065e-05,5.20325e-09,-3.66239e-13,-34563,-45.089], Tmin=(897.656,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-260.208,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(565.384,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCsJOCs) + radical(Cs_P)"""),
)

species(
    label = 'CCCO[C]([O])CC(C)OO(13636)',
    structure = SMILES('CCCO[C]([O])CC(C)OO'),
    E0 = (-214.959,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (162.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.987012,0.125746,-0.000116375,2.40888e-08,3.02692e-11,-25689.6,43.6113], Tmin=(100,'K'), Tmax=(537.709,'K')), NASAPolynomial(coeffs=[9.39866,0.0725835,-3.52923e-05,6.9019e-09,-4.88297e-13,-27154.8,-3.28911], Tmin=(537.709,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-214.959,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(569.541,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(Cs_P)"""),
)

species(
    label = '[CH2]CCOC([O])CC(C)OO(13637)',
    structure = SMILES('[CH2]CCOC([O])CC(C)OO'),
    E0 = (-214.959,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (162.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.987012,0.125746,-0.000116375,2.40888e-08,3.02692e-11,-25689.6,44.7099], Tmin=(100,'K'), Tmax=(537.709,'K')), NASAPolynomial(coeffs=[9.39866,0.0725835,-3.52923e-05,6.9019e-09,-4.88297e-13,-27154.8,-2.1905], Tmin=(537.709,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-214.959,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(569.541,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(RCCJ)"""),
)

species(
    label = 'CC[CH]OC(O)[CH]C(C)OO(13638)',
    structure = SMILES('CC[CH]OC(O)[CH]C(C)OO'),
    E0 = (-265.039,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (162.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.24714,0.146226,-0.00017813,1.20936e-07,-3.36777e-11,-31659.6,48.2002], Tmin=(100,'K'), Tmax=(867.881,'K')), NASAPolynomial(coeffs=[16.6457,0.0591489,-2.76272e-05,5.32435e-09,-3.74381e-13,-34938.9,-40.2696], Tmin=(867.881,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-265.039,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(565.384,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJCOOH) + radical(CCsJOCs)"""),
)

species(
    label = 'CC[CH]OC(O)C[C](C)OO(13639)',
    structure = SMILES('CC[CH]OC(O)C[C](C)OO'),
    E0 = (-278.555,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (162.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.2923,0.148692,-0.000194803,1.47396e-07,-4.60384e-11,-33285.3,46.343], Tmin=(100,'K'), Tmax=(775.945,'K')), NASAPolynomial(coeffs=[14.2461,0.06343,-2.99684e-05,5.76555e-09,-4.03324e-13,-35851.7,-29.2486], Tmin=(775.945,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-278.555,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(565.384,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(C2CsJOOH) + radical(CCsJOCs)"""),
)

species(
    label = 'CCCOC([O])[CH]C(C)OO(13640)',
    structure = SMILES('CCCOC([O])[CH]C(C)OO'),
    E0 = (-219.79,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3025,407.5,1350,352.5,3615,1310,387.5,850,1000,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (162.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.704072,0.121838,-9.12135e-05,-4.07107e-08,8.47017e-11,-26283.7,44.3012], Tmin=(100,'K'), Tmax=(498.187,'K')), NASAPolynomial(coeffs=[9.14744,0.0730468,-3.5564e-05,6.9365e-09,-4.89003e-13,-27641.4,-0.137076], Tmin=(498.187,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-219.79,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(569.541,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(CCJCOOH)"""),
)

species(
    label = 'C[CH][CH]OC(O)CC(C)OO(13641)',
    structure = SMILES('C[CH][CH]OC(O)CC(C)OO'),
    E0 = (-265.552,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (162.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.04156,0.138655,-0.000152853,9.17959e-08,-2.25707e-11,-31725.8,47.6474], Tmin=(100,'K'), Tmax=(977.611,'K')), NASAPolynomial(coeffs=[18.2611,0.0555844,-2.53945e-05,4.87759e-09,-3.43565e-13,-35695.4,-49.8416], Tmin=(977.611,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-265.552,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(565.384,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJCO) + radical(CCsJOCs)"""),
)

species(
    label = '[CH2]C(CC(O)O[CH]CC)OO(13642)',
    structure = SMILES('[CH2]C(CC(O)O[CH]CC)OO'),
    E0 = (-251.492,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (162.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.33562,0.146925,-0.00017553,1.14672e-07,-3.05194e-11,-30025.8,48.2059], Tmin=(100,'K'), Tmax=(908.875,'K')), NASAPolynomial(coeffs=[18.2476,0.0563351,-2.60164e-05,4.99962e-09,-3.51463e-13,-33767.2,-49.129], Tmin=(908.875,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-251.492,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(565.384,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCsJOCs) + radical(CJCOOH)"""),
)

species(
    label = 'CCCOC([O])C[C](C)OO(13643)',
    structure = SMILES('CCCOC([O])C[C](C)OO'),
    E0 = (-233.306,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,360,370,350,3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (162.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.82509,0.14159,-0.000199128,1.76618e-07,-6.46933e-11,-27863.5,46.0597], Tmin=(100,'K'), Tmax=(783.59,'K')), NASAPolynomial(coeffs=[7.0571,0.0767028,-3.75e-05,7.27378e-09,-5.08794e-13,-28655.4,9.20337], Tmin=(783.59,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-233.306,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(569.541,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(C2CsJOOH) + radical(CCOJ)"""),
)

species(
    label = 'CC[CH]OC(O)CC(C)O[O](13644)',
    structure = SMILES('CC[CH]OC(O)CC(C)O[O]'),
    E0 = (-313.449,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (162.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.06323,0.141307,-0.00016962,1.14917e-07,-3.20125e-11,-37487.9,45.9905], Tmin=(100,'K'), Tmax=(867.231,'K')), NASAPolynomial(coeffs=[15.8454,0.058709,-2.676e-05,5.09982e-09,-3.56304e-13,-40594.2,-37.8581], Tmin=(867.231,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-313.449,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(569.541,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCsJOCs) + radical(ROOJ)"""),
)

species(
    label = '[CH2]C(CC([O])OCCC)OO(13645)',
    structure = SMILES('[CH2]C(CC([O])OCCC)OO'),
    E0 = (-206.242,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1310,387.5,850,1000,3000,3100,440,815,1455,1000,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (162.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.35756,0.13207,-0.000142283,7.37166e-08,-5.03481e-12,-24625.7,46.1864], Tmin=(100,'K'), Tmax=(582.98,'K')), NASAPolynomial(coeffs=[10.3359,0.0709927,-3.44157e-05,6.72538e-09,-4.75786e-13,-26314.6,-6.70965], Tmin=(582.98,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-206.242,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(569.541,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJCOOH) + radical(CCOJ)"""),
)

species(
    label = '[CH2]C[CH]OC(O)CC(C)OO(13646)',
    structure = SMILES('[CH2]C[CH]OC(O)CC(C)OO'),
    E0 = (-260.208,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (162.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.2051,0.144588,-0.000171498,1.12514e-07,-3.02529e-11,-31079.3,47.5303], Tmin=(100,'K'), Tmax=(897.656,'K')), NASAPolynomial(coeffs=[17.1995,0.0581196,-2.70065e-05,5.20325e-09,-3.66239e-13,-34563,-43.9904], Tmin=(897.656,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-260.208,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(565.384,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCsJOCs) + radical(RCCJ)"""),
)

species(
    label = 'CCCOC([O])CC(C)O[O](13647)',
    structure = SMILES('CCCOC([O])CC(C)O[O]'),
    E0 = (-268.2,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (162.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.339437,0.113862,-6.51704e-05,-8.77997e-08,1.19862e-10,-32119.6,41.4904], Tmin=(100,'K'), Tmax=(480.741,'K')), NASAPolynomial(coeffs=[8.4447,0.0724155,-3.45749e-05,6.6811e-09,-4.6823e-13,-33329.8,1.74295], Tmin=(480.741,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-268.2,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(573.699,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(ROOJ)"""),
)
...
species(
    label = 'CCCOC(=O)CC(C)OO(13648)',
    structure = SMILES('CCCOC(=O)CC(C)OO'),
    E0 = (-637.43,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (162.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.938175,0.117942,-0.000109106,6.01362e-08,-1.46687e-11,-76495.2,40.5345], Tmin=(100,'K'), Tmax=(944.869,'K')), NASAPolynomial(coeffs=[10.3912,0.0699809,-3.29666e-05,6.41546e-09,-4.54959e-13,-78636.1,-13.4807], Tmin=(944.869,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-637.43,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(569.541,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdCsOs)"""),
)

species(
    label = 'CC=COC(O)CC(C)OO(13649)',
    structure = SMILES('CC=COC(O)CC(C)OO'),
    E0 = (-570.29,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (162.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.75851,0.135545,-0.000129371,6.22796e-08,-1.18227e-11,-68335.7,45.5221], Tmin=(100,'K'), Tmax=(1279.17,'K')), NASAPolynomial(coeffs=[28.3938,0.0381334,-1.51462e-05,2.75059e-09,-1.88768e-13,-76305.7,-112.441], Tmin=(1279.17,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-570.29,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(569.541,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH)"""),
)
...
species(
    label = 'CC[CH]OC([O])CCOO(13650)',
    structure = SMILES('CC[CH]OC([O])CCOO'),
    E0 = (-203.326,'kJ/mol'),
    modes = [
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.55318,0.132663,-0.000186877,1.56506e-07,-5.40063e-11,-24264.5,42.3407], Tmin=(100,'K'), Tmax=(771.441,'K')), NASAPolynomial(coeffs=[10.7488,0.0602092,-2.91446e-05,5.63253e-09,-3.93442e-13,-25904.7,-12.1456], Tmin=(771.441,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-203.326,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(498.868,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(CCsJOCs)"""),
)

species(
    label = 'C[CH]OC([O])CC(C)OO(7398)',
...
species(
    label = 'CC[CH]OC1CC(C)OO1(13651)',
    structure = SMILES('CC[CH]OC1CC(C)OO1'),
    E0 = (-221.201,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (145.176,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.07671,0.0956785,-4.08981e-05,-2.34131e-08,1.90768e-11,-26406.9,35.7034], Tmin=(100,'K'), Tmax=(932.404,'K')), NASAPolynomial(coeffs=[21.9672,0.0371006,-1.14622e-05,1.87281e-09,-1.25818e-13,-32455.1,-83.247], Tmin=(932.404,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-221.201,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(536.283,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(12dioxolane) + radical(CCsJOCs)"""),
)

species(
    label = 'CCC1OC(C)CC([O])O1(13652)',
    structure = SMILES('CCC1OC(C)CC([O])O1'),
    E0 = (-442.922,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (145.176,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.00578709,0.0719608,9.65275e-06,-6.29495e-08,3.04995e-11,-53112.8,31.0359], Tmin=(100,'K'), Tmax=(923.02,'K')), NASAPolynomial(coeffs=[15.3987,0.0460389,-1.45006e-05,2.36679e-09,-1.57339e-13,-57691.7,-51.404], Tmin=(923.02,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-442.922,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(544.598,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(1,3-Dioxane) + radical(CCOJ)"""),
)

species(
    label = '[CH2]C(C)OC([O])CC(C)OO(13653)',
    structure = SMILES('[CH2]C(C)OC([O])CC(C)OO'),
    E0 = (-220.246,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (162.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.24408,0.148651,-0.000202319,1.64955e-07,-5.60241e-11,-26275.3,46.6865], Tmin=(100,'K'), Tmax=(747.335,'K')), NASAPolynomial(coeffs=[11.9257,0.0685735,-3.30899e-05,6.40768e-09,-4.48988e-13,-28274.9,-16.7561], Tmin=(747.335,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-220.246,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(569.541,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(CJC(C)OC)"""),
)

species(
    label = 'CCC1OC(CC(C)OO)O1(13594)',
    structure = SMILES('CCC1OC(CC(C)OO)O1'),
    E0 = (-497.378,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (162.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.84419,0.112753,-8.11756e-05,2.83892e-08,-3.95782e-12,-59597.4,41.6414], Tmin=(100,'K'), Tmax=(1680.13,'K')), NASAPolynomial(coeffs=[27.9263,0.0418768,-1.78983e-05,3.28117e-09,-2.21819e-13,-69601.1,-117.431], Tmin=(1680.13,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-497.378,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(577.856,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Cyclobutane)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['CC[CH]OC([O])CC(C)OO(13590)'],
    products = ['C2H5CHO(70)', 'CC(CC=O)OO(1957)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'CC=COC([O])CC(C)OO(13632)'],
    products = ['CC[CH]OC([O])CC(C)OO(13590)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'CC[CH]OC(=O)CC(C)OO(13633)'],
    products = ['CC[CH]OC([O])CC(C)OO(13590)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['C2H5CHO(70)', 'CC(C[CH][O])OO(1991)'],
    products = ['CC[CH]OC([O])CC(C)OO(13590)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CH3(17)', 'C=COC([O])CC(C)OO(7497)'],
    products = ['CC[CH]OC([O])CC(C)OO(13590)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['QOOH_3(717)', 'CC[CH]OC=O(10830)'],
    products = ['CC[CH]OC([O])CC(C)OO(13590)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['C[CH]COC([O])CC(C)OO(13634)'],
    products = ['CC[CH]OC([O])CC(C)OO(13590)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['CC[CH]OC([O])CC(C)OO(13590)'],
    products = ['CC[CH]O[C](O)CC(C)OO(13635)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['CCCO[C]([O])CC(C)OO(13636)'],
    products = ['CC[CH]OC([O])CC(C)OO(13590)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]CCOC([O])CC(C)OO(13637)'],
    products = ['CC[CH]OC([O])CC(C)OO(13590)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CC[CH]OC(O)[CH]C(C)OO(13638)'],
    products = ['CC[CH]OC([O])CC(C)OO(13590)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CC[CH]OC([O])CC(C)OO(13590)'],
    products = ['CC[CH]OC(O)C[C](C)OO(13639)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CCCOC([O])[CH]C(C)OO(13640)'],
    products = ['CC[CH]OC([O])CC(C)OO(13590)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CC[CH]OC([O])CC(C)OO(13590)'],
    products = ['C[CH][CH]OC(O)CC(C)OO(13641)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CC[CH]OC([O])CC(C)OO(13590)'],
    products = ['[CH2]C(CC(O)O[CH]CC)OO(13642)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CCCOC([O])C[C](C)OO(13643)'],
    products = ['CC[CH]OC([O])CC(C)OO(13590)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CC[CH]OC([O])CC(C)OO(13590)'],
    products = ['CC[CH]OC(O)CC(C)O[O](13644)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2]C(CC([O])OCCC)OO(13645)'],
    products = ['CC[CH]OC([O])CC(C)OO(13590)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CC[CH]OC([O])CC(C)OO(13590)'],
    products = ['[CH2]C[CH]OC(O)CC(C)OO(13646)'],
...
reaction(
    label = 'reaction20',
    reactants = ['CC[CH]OC([O])CC(C)OO(13590)'],
    products = ['CCCOC([O])CC(C)O[O](13647)'],
...
reaction(
    label = 'reaction21',
    reactants = ['CC[CH][O](563)', 'CC(C[CH][O])OO(1991)'],
    products = ['CC[CH]OC([O])CC(C)OO(13590)'],
...
reaction(
    label = 'reaction22',
    reactants = ['CC[CH]OC([O])CC(C)OO(13590)'],
    products = ['CCCOC(=O)CC(C)OO(13648)'],
...
reaction(
    label = 'reaction23',
    reactants = ['CC[CH]OC([O])CC(C)OO(13590)'],
    products = ['CC=COC(O)CC(C)OO(13649)'],
...
reaction(
    label = 'reaction24',
    reactants = ['CH2(S)(23)', 'CC[CH]OC([O])CCOO(13650)'],
    products = ['CC[CH]OC([O])CC(C)OO(13590)'],
...
reaction(
    label = 'reaction25',
    reactants = ['CH2(S)(23)', 'C[CH]OC([O])CC(C)OO(7398)'],
    products = ['CC[CH]OC([O])CC(C)OO(13590)'],
...
reaction(
    label = 'reaction26',
    reactants = ['CC[CH]OC([O])CC(C)OO(13590)'],
    products = ['OH(5)', 'CC[CH]OC1CC(C)OO1(13651)'],
...
reaction(
    label = 'reaction27',
    reactants = ['CC[CH]OC([O])CC(C)OO(13590)'],
    products = ['OH(5)', 'CCC1OC(C)CC([O])O1(13652)'],
...
reaction(
    label = 'reaction28',
    reactants = ['[CH2]C(C)OC([O])CC(C)OO(13653)'],
    products = ['CC[CH]OC([O])CC(C)OO(13590)'],
...
reaction(
    label = 'reaction29',
    reactants = ['CC[CH]OC([O])CC(C)OO(13590)'],
    products = ['CCC1OC(CC(C)OO)O1(13594)'],
...
reaction(
    label = 'reaction30',
    reactants = ['[CH]CC(144)', 'CC(CC([O])[O])OO(7426)'],
    products = ['CC[CH]OC([O])CC(C)OO(13590)'],
...
reaction(
    label = 'reaction31',
    reactants = ['O(4)', 'CC[CH]O[CH]CC(C)OO(7627)'],
    products = ['CC[CH]OC([O])CC(C)OO(13590)'],
...
network(
    label = '2983',
    isomers = [
        'CC[CH]OC([O])CC(C)OO(13590)',
    ],
    reactants = [
        ('C2H5CHO(70)', 'CC(CC=O)OO(1957)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
