...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.322809,0.087777,-7.61408e-05,4.53157e-08,-1.29003e-11,-39704.4,30.0282], Tmin=(100,'K'), Tmax=(795.447,'K')), NASAPolynomial(coeffs=[5.33269,0.0625846,-2.86352e-05,5.50167e-09,-3.87316e-13,-40501.4,7.0049], Tmin=(795.447,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-331.171,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdCsCs)"""),
)
...
species(
    label = 'CCCC[C]([O])CC(10550)',
    structure = SMILES('CCCC[C]([O])CC'),
    E0 = (18.8734,'kJ/mol'),
    modes = [
...
species(
    label = '[CH2]CCC([O])CC(10555)',
    structure = SMILES('[CH2]CCC([O])CC'),
    E0 = (71.2722,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (100.159,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.391625,0.0733777,-4.9881e-05,1.75531e-08,-2.55091e-12,8706.55,31.0034], Tmin=(100,'K'), Tmax=(1570.59,'K')), NASAPolynomial(coeffs=[14.8389,0.0365835,-1.47408e-05,2.63729e-09,-1.76688e-13,4168.38,-45.2186], Tmin=(1570.59,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(71.2722,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJ) + radical(CC(C)OJ)"""),
)
...
species(
    label = '[CH2]CCCC([O])CC(10556)',
    structure = SMILES('[CH2]CCCC([O])CC'),
    E0 = (47.492,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
reaction(
    label = 'reaction1',
    reactants = ['H(3)', 'CCCCC(=O)CC(10549)'],
    products = ['CCCCC([O])CC(252)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['C2H5CHO(70)', 'butyl_1(82)'],
    products = ['CCCCC([O])CC(252)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['C2H5(29)', 'CCCCC=O(1733)'],
    products = ['CCCCC([O])CC(252)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(7.94e+10,'cm^3/(mol*s)'), n=0, Ea=(28.0328,'kJ/mol'), T0=(1,'K'), Tmin=(333,'K'), Tmax=(363,'K'), comment="""Estimated using template [CO_O;CsJ-CsHH] for rate rule [CO-CsH_O;CsJ-CsHH]
Euclidian distance = 2.0
...
reaction(
    label = 'reaction4',
    reactants = ['butyl_1(82)', 'CC[CH][O](563)'],
    products = ['CCCCC([O])CC(252)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['C2H5(29)', 'CCCC[CH][O](1728)'],
    products = ['CCCCC([O])CC(252)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['H(3)', 'CCCC[C]([O])CC(10550)'],
    products = ['CCCCC([O])CC(252)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['npropyl(83)', '[CH2]C([O])CC(1666)'],
    products = ['CCCCC([O])CC(252)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(3)', 'CCC[CH]C([O])CC(10551)'],
    products = ['CCCCC([O])CC(252)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['C2H5(29)', '[CH2]CC([O])CC(10552)'],
    products = ['CCCCC([O])CC(252)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(8.73e+14,'cm^3/(mol*s)'), n=-0.699, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(200,'K'), Tmax=(2000,'K'), comment="""From training reaction 11 used for C_rad/H2/Cs;C_rad/H2/Cs
Exact match found for rate rule [C_rad/H2/Cs;C_rad/H2/Cs]
...
reaction(
    label = 'reaction10',
    reactants = ['H(3)', 'CC[CH]CC([O])CC(10553)'],
    products = ['CCCCC([O])CC(252)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CH3(17)', '[CH2]C([O])CCCC(1842)'],
    products = ['CCCCC([O])CC(252)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(3)', 'C[CH]C([O])CCCC(10554)'],
    products = ['CCCCC([O])CC(252)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CH3(17)', '[CH2]CCC([O])CC(10555)'],
    products = ['CCCCC([O])CC(252)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(3)', 'C[CH]CCC([O])CC(9700)'],
    products = ['CCCCC([O])CC(252)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(3)', '[CH2]CC([O])CCCC(2132)'],
    products = ['CCCCC([O])CC(252)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(3)', '[CH2]CCCC([O])CC(10556)'],
    products = ['CCCCC([O])CC(252)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CH2(S)(23)', 'CCCC([O])CC(10557)'],
    products = ['CCCCC([O])CC(252)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CCCCC([O])CC(252)'],
    products = ['CCCC[C](O)CC(10558)'],
