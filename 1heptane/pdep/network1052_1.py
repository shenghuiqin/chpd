...
reaction(
    label = 'reaction1',
    reactants = ['CCCCC([O])CC(252)', 'OH(5)'],
    products = ['CCCCC(CC)OO(302)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['CC[CH]CCCC(85)', 'HO2(10)'],
    products = ['CCCCC(CC)OO(302)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'CCCCC(CC)O[O](207)'],
    products = ['CCCCC(CC)OO(302)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CC[CH]OO(288)', 'butyl_1(82)'],
    products = ['CCCCC(CC)OO(302)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CCCC[CH]OO(274)', 'C2H5(29)'],
    products = ['CCCCC(CC)OO(302)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(1.15e+14,'cm^3/(mol*s)','*|/',2), n=-0.35, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2500,'K'), comment="""Estimated using template [C_rad/H/NonDe;C_rad/H2/Cs] for rate rule [C_rad/H/CsO;C_rad/H2/Cs]
Euclidian distance = 2.0
...
reaction(
    label = 'reaction6',
    reactants = ['H(3)', 'CCCC[C](CC)OO(231)'],
    products = ['CCCCC(CC)OO(302)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['npropyl(83)', '[CH2]C(CC)OO(715)'],
    products = ['CCCCC(CC)OO(302)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(3)', 'CCC[CH]C(CC)OO(232)'],
    products = ['CCCCC(CC)OO(302)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['C2H5(29)', '[CH2]CC(CC)OO(2965)'],
    products = ['CCCCC(CC)OO(302)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(8.73e+14,'cm^3/(mol*s)'), n=-0.699, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(200,'K'), Tmax=(2000,'K'), comment="""From training reaction 11 used for C_rad/H2/Cs;C_rad/H2/Cs
Exact match found for rate rule [C_rad/H2/Cs;C_rad/H2/Cs]
...
reaction(
    label = 'reaction10',
    reactants = ['H(3)', 'CC[CH]CC(CC)OO(234)'],
    products = ['CCCCC(CC)OO(302)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CH3(17)', '[CH2]C(CCCC)OO(583)'],
    products = ['CCCCC(CC)OO(302)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(3)', 'C[CH]C(CCCC)OO(233)'],
    products = ['CCCCC(CC)OO(302)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CH3(17)', '[CH2]CCC(CC)OO(2966)'],
    products = ['CCCCC(CC)OO(302)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(3)', 'C[CH]CCC(CC)OO(236)'],
    products = ['CCCCC(CC)OO(302)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(3)', '[CH2]CCCC(CC)OO(237)'],
    products = ['CCCCC(CC)OO(302)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(3)', '[CH2]CC(CCCC)OO(235)'],
    products = ['CCCCC(CC)OO(302)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CH2(S)(23)', 'CCCC(CC)OO(2967)'],
    products = ['CCCCC(CC)OO(302)'],
...
network(
    ...
    reactants = [
        ('CC[CH]CCCC(85)', 'HO2(10)'),
        ('H(3)', 'CCCCC(CC)O[O](207)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
