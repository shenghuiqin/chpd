...
species(
    label = 'CCCC[C](C)O[O](587)',
    structure = SMILES('CCCC[C](C)O[O]'),
    E0 = (46.0739,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,360,370,350,492.5,1135,1000,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'CCC[CH]C(C)O[O](588)',
    structure = SMILES('CCC[CH]C(C)O[O]'),
    E0 = (59.5897,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3025,407.5,1350,352.5,492.5,1135,1000,1380,1390,370,380,2900,435,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    ...
    molecularWeight = (116.158,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.1687,0.0735537,-2.2658e-05,-7.83e-08,8.38382e-11,6541.06,30.8953], Tmin=(100,'K'), Tmax=(482.913,'K')), NASAPolynomial(coeffs=[5.54351,0.0558554,-2.52679e-05,4.79756e-09,-3.3433e-13,5902.36,10.7358], Tmin=(482.913,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(53.6331,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(ROOJ)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['CCC[CH]C(C)OO(582)'],
    products = ['CCCCC(C)O[O](229)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction8',
    reactants = ['C[CH]O[O](97)', 'butyl_1(82)'],
    products = ['CCCCC(C)O[O](229)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction9',
    reactants = ['CCCC[CH]O[O](239)', 'CH3(17)'],
    products = ['CCCCC(C)O[O](229)'],
...
reaction(
    label = 'reaction10',
    reactants = ['H(3)', 'CCCC[C](C)O[O](587)'],
    products = ['CCCCC(C)O[O](229)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]C(C)O[O](218)', 'npropyl(83)'],
    products = ['CCCCC(C)O[O](229)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(3)', 'CCC[CH]C(C)O[O](588)'],
    products = ['CCCCC(C)O[O](229)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2]CC(C)O[O](220)', 'C2H5(29)'],
    products = ['CCCCC(C)O[O](229)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(3)', 'CC[CH]CC(C)O[O](589)'],
    products = ['CCCCC(C)O[O](229)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]CCC(C)O[O](221)', 'CH3(17)'],
    products = ['CCCCC(C)O[O](229)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(3)', 'C[CH]CCC(C)O[O](590)'],
    products = ['CCCCC(C)O[O](229)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(3)', '[CH2]C(CCCC)O[O](245)'],
    products = ['CCCCC(C)O[O](229)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(3)', '[CH2]CCCC(C)O[O](224)'],
    products = ['CCCCC(C)O[O](229)'],
...
reaction(
    label = 'reaction21',
    reactants = ['CH2(S)(23)', 'CCCC(C)O[O](591)'],
    products = ['CCCCC(C)O[O](229)'],
