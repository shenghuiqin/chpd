...
species(
    label = 'C#COC([O])CC(11036)',
    structure = SMILES('C#COC([O])CC'),
    E0 = (25.5134,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,750,770,3400,2100,2175,525,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,261.423,261.423,261.429,261.431],'cm^-1')),
        HinderedRotor(inertia=(0.00246665,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.488593,'amu*angstrom^2'), symmetry=1, barrier=(23.697,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.488644,'amu*angstrom^2'), symmetry=1, barrier=(23.6972,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.488619,'amu*angstrom^2'), symmetry=1, barrier=(23.6973,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.638631,0.069628,-6.40513e-05,2.98269e-08,-5.55069e-12,3193.09,24.4725], Tmin=(100,'K'), Tmax=(1288.67,'K')), NASAPolynomial(coeffs=[15.5799,0.0232501,-1.00673e-05,1.89901e-09,-1.32655e-13,-657.737,-51.3995], Tmin=(1288.67,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(25.5134,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Ct-CtOs) + group(Ct-CtH) + radical(CCOJ)"""),
)
...
species(
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.359684,0.0712037,-6.02183e-05,2.21197e-08,-2.01723e-12,4405.06,30.9709], Tmin=(100,'K'), Tmax=(1046.98,'K')), NASAPolynomial(coeffs=[17.2135,0.0207079,-7.7798e-06,1.40498e-09,-9.76573e-14,114.418,-54.7495], Tmin=(1046.98,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(35.4723,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C=CJO) + radical(Cs_P)"""),
)
...
species(
    label = 'C=CO[C]([O])CC(11039)',
    structure = SMILES('[CH2][CH]OC(=O)CC'),
    E0 = (-83.3879,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.939965,0.0721692,-7.61555e-05,4.74889e-08,-1.26573e-11,-9923.24,26.9695], Tmin=(100,'K'), Tmax=(888.564,'K')), NASAPolynomial(coeffs=[8.68364,0.0373099,-1.73088e-05,3.33759e-09,-2.3523e-13,-11299.4,-9.47432], Tmin=(888.564,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-83.3879,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdCsOs) + radical(CJCO) + radical(CCsJOC(O))"""),
)

species(
    label = 'C=[C]OC(O)[CH]C(11040)',
    structure = SMILES('C=[C]OC(O)[CH]C'),
    E0 = (30.128,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.553144,0.0648514,-3.98471e-05,-1.08078e-09,6.77315e-12,3757.42,32.084], Tmin=(100,'K'), Tmax=(984.19,'K')), NASAPolynomial(coeffs=[17.6613,0.0192429,-6.79702e-06,1.23017e-09,-8.764e-14,-768.772,-56.0668], Tmin=(984.19,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(30.128,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CCJCO) + radical(C=CJO)"""),
)

species(
    label = '[CH2]CC(O)O[C]=C(11041)',
    structure = SMILES('[CH2]CC(O)O[C]=C'),
    E0 = (35.4723,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.359691,0.0712036,-6.02181e-05,2.21194e-08,-2.01709e-12,4405.06,32.0695], Tmin=(100,'K'), Tmax=(1046.97,'K')), NASAPolynomial(coeffs=[17.2135,0.0207079,-7.77983e-06,1.40499e-09,-9.76579e-14,114.432,-53.6507], Tmin=(1046.97,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(35.4723,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(RCCJ) + radical(C=CJO)"""),
)

species(
    label = 'C=COC([O])[CH]C(11042)',
    structure = SMILES('C=COC([O])[CH]C'),
    E0 = (16.089,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.676111,0.0606709,-2.62504e-05,-1.37741e-08,1.06213e-11,2065.73,29.3757], Tmin=(100,'K'), Tmax=(996.594,'K')), NASAPolynomial(coeffs=[17.3247,0.0211735,-7.92878e-06,1.48143e-09,-1.07056e-13,-2609.59,-57.6954], Tmin=(996.594,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(16.089,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CCJCO) + radical(CCOJ)"""),
)

species(
    label = '[CH]=[C]OC(O)CC(11043)',
    structure = SMILES('[CH]=[C]OC(O)CC'),
    E0 = (77.3221,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0698454,0.0760173,-7.30895e-05,3.52712e-08,-6.64244e-12,9449.99,31.7315], Tmin=(100,'K'), Tmax=(1300.38,'K')), NASAPolynomial(coeffs=[18.8546,0.0182355,-6.43821e-06,1.10131e-09,-7.32783e-14,4564.5,-63.8279], Tmin=(1300.38,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(77.3221,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C=CJO) + radical(Cds_P)"""),
)

species(
    label = '[CH2]CC([O])OC=C(11044)',
    structure = SMILES('[CH2]CC([O])OC=C'),
    E0 = (21.4333,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.493487,0.0668883,-4.61158e-05,8.72053e-09,2.15439e-12,2712.91,29.3228], Tmin=(100,'K'), Tmax=(1048.39,'K')), NASAPolynomial(coeffs=[16.8628,0.022665,-8.9279e-06,1.66028e-09,-1.17419e-13,-1721.34,-55.2018], Tmin=(1048.39,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(21.4333,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(RCCJ) + radical(CCOJ)"""),
)
...
species(
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.726891,0.0647962,-4.99837e-05,1.96364e-08,-3.11547e-12,-45036.8,24.5257], Tmin=(100,'K'), Tmax=(1484.64,'K')), NASAPolynomial(coeffs=[15.2381,0.0256996,-1.04829e-05,1.89903e-09,-1.28677e-13,-49345.7,-51.2172], Tmin=(1484.64,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-375.486,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-Cd)) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsOs) + group(Cds-CdsOsH) + group(Cds-CdsHH)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'C=[C]OC(=O)CC(9490)'],
    products = ['C=[C]OC([O])CC(10711)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'C#COC([O])CC(11036)'],
    products = ['C=[C]OC([O])CC(10711)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['C2H5(29)', 'C=[C]OC=O(2719)'],
    products = ['C=[C]OC([O])CC(10711)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]CC(O)O[C]=C(11041)'],
    products = ['C=[C]OC([O])CC(10711)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CH2(S)(23)', 'C=[C]OC(C)[O](1084)'],
    products = ['C=[C]OC([O])CC(10711)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H2CC(41)', 'CCC([O])[O](3172)'],
    products = ['C=[C]OC([O])CC(10711)'],
