...
species(
    label = 'CC[CH]OCC=CC(C)OO(14560)',
    structure = SMILES('CC[CH]OCC=CC(C)OO'),
    E0 = (-167.111,'kJ/mol'),
    modes = [
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.7088,0.128878,-0.00012087,6.17576e-08,-1.31315e-11,-19896,45.0269], Tmin=(100,'K'), Tmax=(1109.32,'K')), NASAPolynomial(coeffs=[17.6366,0.0591211,-2.65459e-05,5.07133e-09,-3.56385e-13,-24188,-50.3104], Tmin=(1109.32,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-167.111,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(594.485,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(CCsJOCs)"""),
)

species(
    label = 'CC=COC[CH]CC(C)OO(14561)',
    structure = SMILES('CC=COC[CH]CC(C)OO'),
    E0 = (-193.937,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,2995,3025,975,1000,1300,1375,400,500,1630,1680,3615,1310,387.5,850,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,1380,1390,370,380,2900,435,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (159.203,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.85794,0.133898,-0.000120094,5.46568e-08,-9.8347e-12,-23064.1,47.4673], Tmin=(100,'K'), Tmax=(1345.85,'K')), NASAPolynomial(coeffs=[28.8112,0.0397731,-1.51871e-05,2.69086e-09,-1.81623e-13,-31588.4,-114.724], Tmin=(1345.85,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-193.937,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(594.485,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(CCJCO)"""),
)

species(
    label = 'CC[CH]OC=CCC(C)OO(14562)',
    structure = SMILES('CC[CH]OC=CCC(C)OO'),
    E0 = (-198.777,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,2995,3025,975,1000,1300,1375,400,500,1630,1680,3615,1310,387.5,850,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,1380,1390,370,380,2900,435,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'C=CCO[CH]CC(10627)',
    structure = SMILES('C=CCO[CH]CC'),
    E0 = (-7.13821,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2950,3100,1380,975,1025,1650,3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.633875,0.0739155,-5.8412e-05,2.5384e-08,-4.66927e-12,-737.416,27.8595], Tmin=(100,'K'), Tmax=(1252.14,'K')), NASAPolynomial(coeffs=[11.5946,0.0389009,-1.64661e-05,3.05099e-09,-2.10297e-13,-3482.29,-27.4844], Tmin=(1252.14,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-7.13821,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CCsJOCs)"""),
)
...
species(
    label = 'CC[CH]OCC[CH]C(C)OO(14563)',
    structure = SMILES('CC[CH]OCC[CH]C(C)OO'),
    E0 = (-88.5883,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3000,3050,390,425,1340,1360,335,370,3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'C[CH]COC[CH]CC(C)OO(14564)',
    structure = SMILES('C[CH]COC[CH]CC(C)OO'),
    E0 = (-69.6552,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3000,3050,390,425,1340,1360,335,370,3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (160.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.49674,0.126169,-0.000111988,5.54754e-08,-1.16952e-11,-8184.08,47.8191], Tmin=(100,'K'), Tmax=(1102.22,'K')), NASAPolynomial(coeffs=[15.1769,0.0656602,-2.96419e-05,5.66897e-09,-3.98321e-13,-11859.7,-34.2441], Tmin=(1102.22,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-69.6552,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(615.271,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJCO) + radical(CCJCO)"""),
)
...
species(
    label = 'CCCO[CH][CH]CC(C)OO(14566)',
    structure = SMILES('CCCO[CH][CH]CC(C)OO'),
    E0 = (-89.1012,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3000,3050,390,425,1340,1360,335,370,3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'CC[CH]OCCC[C](C)OO(14567)',
    structure = SMILES('CC[CH]OCCC[C](C)OO'),
    E0 = (-102.104,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (160.211,'amu'),
...
species(
    label = '[CH2]CCOC[CH]CC(C)OO(14568)',
    structure = SMILES('[CH2]CCOC[CH]CC(C)OO'),
    E0 = (-64.3109,'kJ/mol'),
    modes = [
...
species(
    label = '[CH2]C(CCCO[CH]CC)OO(14569)',
    structure = SMILES('[CH2]C(CCCO[CH]CC)OO'),
    E0 = (-75.0407,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1310,387.5,850,1000,2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,3000,3100,440,815,1455,1000,1380,1390,370,380,2900,435,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'C[CH][CH]OCCCC(C)OO(14570)',
    structure = SMILES('C[CH][CH]OCCCC(C)OO'),
    E0 = (-89.1012,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3000,3050,390,425,1340,1360,335,370,3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'CC[CH]OCCCC(C)O[O](14571)',
    structure = SMILES('CC[CH]OCCCC(C)O[O]'),
    E0 = (-136.999,'kJ/mol'),
    modes = [
...
species(
    label = 'CCCOC[CH][CH]C(C)OO(14572)',
    structure = SMILES('CCCOC[CH][CH]C(C)OO'),
    E0 = (-69.1423,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3000,3050,390,425,1340,1360,335,370,3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'CCCOC[CH]C[C](C)OO(14573)',
    structure = SMILES('CCCOC[CH]C[C](C)OO'),
    E0 = (-82.6581,'kJ/mol'),
    modes = [
...
species(
    label = '[CH2]C[CH]OCCCC(C)OO(14574)',
    structure = SMILES('[CH2]C[CH]OCCCC(C)OO'),
    E0 = (-83.7569,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1310,387.5,850,1000,2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,3000,3100,440,815,1455,1000,1380,1390,370,380,2900,435,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2]C(C[CH]COCCC)OO(14575)',
    structure = SMILES('[CH2]C(C[CH]COCCC)OO'),
    E0 = (-55.5947,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1310,387.5,850,1000,2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,3000,3100,440,815,1455,1000,1380,1390,370,380,2900,435,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'CCCOC[CH]CC(C)O[O](14576)',
    structure = SMILES('CCCOC[CH]CC(C)O[O]'),
    E0 = (-117.553,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (160.211,'amu'),
...
species(
    label = 'CCCOC=CCC(C)OO(14577)',
    structure = SMILES('CCCOC=CCC(C)OO'),
    E0 = (-392.704,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (160.211,'amu'),
...
species(
    label = 'CC=COCCCC(C)OO(14578)',
    structure = SMILES('CC=COCCCC(C)OO'),
    E0 = (-393.839,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (160.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.87447,0.13707,-0.000121815,5.54562e-08,-1.00585e-11,-47108.6,45.0261], Tmin=(100,'K'), Tmax=(1327.76,'K')), NASAPolynomial(coeffs=[27.7127,0.0449231,-1.77132e-05,3.18672e-09,-2.16764e-13,-55231.1,-111.211], Tmin=(1327.76,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-393.839,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(619.428,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH)"""),
)

species(
    label = 'CCCOCC=CC(C)OO(14579)',
    structure = SMILES('CCCOCC=CC(C)OO'),
    E0 = (-347.567,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (160.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.28513,0.120524,-9.73872e-05,4.27032e-08,-7.9836e-12,-41616.2,44.0518], Tmin=(100,'K'), Tmax=(1221.23,'K')), NASAPolynomial(coeffs=[15.5952,0.0652354,-2.94787e-05,5.63271e-09,-3.94942e-13,-45739.2,-40.7598], Tmin=(1221.23,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-347.567,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(619.428,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH)"""),
)
...
species(
    label = 'CC[CH]OC[CH]CCOO(14580)',
    structure = SMILES('CC[CH]OC[CH]CCOO'),
    E0 = (-52.6781,'kJ/mol'),
    modes = [
...
species(
    label = 'CC[CH]OCC1CC(C)O1(14581)',
    structure = SMILES('CC[CH]OCC1CC(C)O1'),
    E0 = (-189.119,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (143.203,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.30638,0.104758,-6.20534e-05,2.69706e-09,8.54206e-12,-22543.9,37.1844], Tmin=(100,'K'), Tmax=(939.645,'K')), NASAPolynomial(coeffs=[19.1568,0.0466547,-1.56053e-05,2.59553e-09,-1.71679e-13,-27670.1,-67.0785], Tmin=(939.645,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-189.119,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(582.013,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Oxetane) + radical(CCsJOCs)"""),
)

species(
    label = '[CH2]C(CO[CH]CC)C(C)OO(14582)',
    structure = SMILES('[CH2]C(CO[CH]CC)C(C)OO'),
    E0 = (-89.6153,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (160.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.3489,0.144932,-0.000157886,9.69097e-08,-2.45266e-11,-10554.1,46.8397], Tmin=(100,'K'), Tmax=(949.869,'K')), NASAPolynomial(coeffs=[17.3295,0.0620614,-2.70163e-05,5.05563e-09,-3.5046e-13,-14292.3,-47.0847], Tmin=(949.869,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-89.6153,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(615.271,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Isobutyl) + radical(CCsJOCs)"""),
)

species(
    label = '[CH2]C(C)OC[CH]CC(C)OO(14583)',
    structure = SMILES('[CH2]C(C)OC[CH]CC(C)OO'),
    E0 = (-69.5981,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3615,1310,387.5,850,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3100,440,815,1455,1000,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'CCC1OCC1CC(C)OO(13572)',
    structure = SMILES('CCC1OCC1CC(C)OO'),
    E0 = (-337.871,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (160.211,'amu'),
...
species(
    label = 'CC[CH]OCC(O)CC(C)[O](14584)',
    structure = SMILES('CC[CH]OCC(O)CC(C)[O]'),
    E0 = (-302.618,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (160.211,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.20459,0.141681,-0.000150474,8.93361e-08,-2.19058e-11,-36177.4,46.2238], Tmin=(100,'K'), Tmax=(977.226,'K')), NASAPolynomial(coeffs=[17.4498,0.0612331,-2.69912e-05,5.09701e-09,-3.5556e-13,-40018.8,-48.1446], Tmin=(977.226,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-302.618,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(619.428,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(CCsJOCs)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['CC[CH]OC[CH]CC(C)OO(13569)'],
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'CC[CH]OCC=CC(C)OO(14560)'],
    products = ['CC[CH]OC[CH]CC(C)OO(13569)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'CC=COC[CH]CC(C)OO(14561)'],
    products = ['CC[CH]OC[CH]CC(C)OO(13569)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', 'CC[CH]OC=CCC(C)OO(14562)'],
    products = ['CC[CH]OC[CH]CC(C)OO(13569)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['CH3CHOOH(63)', 'C=CCO[CH]CC(10627)'],
    products = ['CC[CH]OC[CH]CC(C)OO(13569)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['CH3(17)', 'C=COC[CH]CC(C)OO(6076)'],
    products = ['CC[CH]OC[CH]CC(C)OO(13569)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['CC[CH]OCC[CH]C(C)OO(14563)'],
    products = ['CC[CH]OC[CH]CC(C)OO(13569)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['C[CH]COC[CH]CC(C)OO(14564)'],
    products = ['CC[CH]OC[CH]CC(C)OO(13569)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['CCCO[CH][CH]CC(C)OO(14566)'],
    products = ['CC[CH]OC[CH]CC(C)OO(13569)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CC[CH]OC[CH]CC(C)OO(13569)'],
    products = ['CC[CH]OCCC[C](C)OO(14567)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2]CCOC[CH]CC(C)OO(14568)'],
    products = ['CC[CH]OC[CH]CC(C)OO(13569)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]C(CCCO[CH]CC)OO(14569)'],
    products = ['CC[CH]OC[CH]CC(C)OO(13569)'],
...
reaction(
    label = 'reaction15',
    reactants = ['C[CH][CH]OCCCC(C)OO(14570)'],
    products = ['CC[CH]OC[CH]CC(C)OO(13569)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CC[CH]OCCCC(C)O[O](14571)'],
    products = ['CC[CH]OC[CH]CC(C)OO(13569)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CCCOC[CH][CH]C(C)OO(14572)'],
    products = ['CC[CH]OC[CH]CC(C)OO(13569)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CCCOC[CH]C[C](C)OO(14573)'],
    products = ['CC[CH]OC[CH]CC(C)OO(13569)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2]C[CH]OCCCC(C)OO(14574)'],
    products = ['CC[CH]OC[CH]CC(C)OO(13569)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2]C(C[CH]COCCC)OO(14575)'],
    products = ['CC[CH]OC[CH]CC(C)OO(13569)'],
...
reaction(
    label = 'reaction21',
    reactants = ['CC[CH]OC[CH]CC(C)OO(13569)'],
    products = ['CCCOC[CH]CC(C)O[O](14576)'],
...
reaction(
    label = 'reaction26',
    reactants = ['CH2(S)(23)', 'CC[CH]OC[CH]CCOO(14580)'],
    products = ['CC[CH]OC[CH]CC(C)OO(13569)'],
...
reaction(
    label = 'reaction27',
    reactants = ['CH2(S)(23)', 'C[CH]OC[CH]CC(C)OO(5879)'],
    products = ['CC[CH]OC[CH]CC(C)OO(13569)'],
...
reaction(
    label = 'reaction28',
    reactants = ['CC[CH]OC[CH]CC(C)OO(13569)'],
    products = ['OH(5)', 'CC[CH]OCC1CC(C)O1(14581)'],
...
reaction(
    label = 'reaction29',
    reactants = ['[CH2]C(CO[CH]CC)C(C)OO(14582)'],
    products = ['CC[CH]OC[CH]CC(C)OO(13569)'],
...
reaction(
    label = 'reaction30',
    reactants = ['[CH2]C(C)OC[CH]CC(C)OO(14583)'],
    products = ['CC[CH]OC[CH]CC(C)OO(13569)'],
...
reaction(
    label = 'reaction31',
    reactants = ['CC[CH]OC[CH]CC(C)OO(13569)'],
    products = ['CCC1OCC1CC(C)OO(13572)'],
...
reaction(
    label = 'reaction32',
    reactants = ['CC[CH]OC[CH]CC(C)OO(13569)'],
    products = ['CC[CH]OCC(O)CC(C)[O](14584)'],
...
reaction(
    label = 'reaction33',
    reactants = ['[CH]CC(144)', 'CC(C[CH]C[O])OO(1792)'],
    products = ['CC[CH]OC[CH]CC(C)OO(13569)'],
...
reaction(
    label = 'reaction34',
    reactants = ['[CH]CC(C)OO(1806)', '[CH2]O[CH]CC(1682)'],
    products = ['CC[CH]OC[CH]CC(C)OO(13569)'],
