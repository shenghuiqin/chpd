...
species(
    label = 'CCC=CC(C)[O](2057)',
    structure = SMILES('CCC=CC(C)[O]'),
    E0 = (-17.6388,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2995,3025,975,1000,1300,1375,400,500,1630,1680,1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,369.14,369.143,369.144],'cm^-1')),
        HinderedRotor(inertia=(0.00123711,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.121813,'amu*angstrom^2'), symmetry=1, barrier=(11.7789,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.121815,'amu*angstrom^2'), symmetry=1, barrier=(11.779,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.121816,'amu*angstrom^2'), symmetry=1, barrier=(11.7789,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (99.1509,'amu'),
...
species(
    label = 'CC=CCC(C)[O](2058)',
    structure = SMILES('CC=CCC(C)[O]'),
    E0 = (-18.4372,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2995,3025,975,1000,1300,1375,400,500,1630,1680,1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,318.49,318.566,318.699],'cm^-1')),
        HinderedRotor(inertia=(0.00165967,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.147463,'amu*angstrom^2'), symmetry=1, barrier=(10.6187,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.14753,'amu*angstrom^2'), symmetry=1, barrier=(10.6182,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.147462,'amu*angstrom^2'), symmetry=1, barrier=(10.6182,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (99.1509,'amu'),
...
species(
    ...
    molecularWeight = (100.159,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.4934,0.0835809,-9.93056e-05,8.1593e-08,-2.8775e-11,932.049,31.0279], Tmin=(100,'K'), Tmax=(797.71,'K')), NASAPolynomial(coeffs=[5.11623,0.0517404,-2.31492e-05,4.33808e-09,-2.98431e-13,470.049,11.4973], Tmin=(797.71,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(6.7512,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(C2CsJOH)"""),
)

species(
    label = 'CCC[CH]C(C)[O](2040)',
...
species(
    ...
    molecularWeight = (100.159,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.10678,0.0665977,-4.30408e-05,1.53935e-08,-2.45403e-12,3712.47,31.8891], Tmin=(100,'K'), Tmax=(1338.79,'K')), NASAPolynomial(coeffs=[8.20698,0.0453838,-1.92724e-05,3.55766e-09,-2.43847e-13,1811.34,-4.43679], Tmin=(1338.79,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(30.0254,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(CCJCO)"""),
)
...
species(
    ...
    molecularWeight = (100.159,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.647926,0.0762035,-5.89815e-05,2.5829e-08,-4.92062e-12,5248.53,27.7168], Tmin=(100,'K'), Tmax=(1188.42,'K')), NASAPolynomial(coeffs=[9.9606,0.0448592,-1.94199e-05,3.63646e-09,-2.52174e-13,3035.03,-18.8192], Tmin=(1188.42,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(42.6537,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(C2CsJOH)"""),
)
...
species(
    ...
    molecularWeight = (100.159,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.877938,0.0746844,-8.04428e-05,6.63949e-08,-2.43237e-11,3061.67,32.9587], Tmin=(100,'K'), Tmax=(796.982,'K')), NASAPolynomial(coeffs=[3.15821,0.0539433,-2.39086e-05,4.46851e-09,-3.0727e-13,2993.46,24.3275], Tmin=(796.982,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(24.5697,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(RCCJC)"""),
)

species(
    label = '[CH2]C[CH]CC(C)O(2065)',
...
species(
    ...
    molecularWeight = (100.159,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.20141,0.0650496,-3.73283e-05,1.05626e-08,-1.25018e-12,-36677.4,25.4925], Tmin=(100,'K'), Tmax=(1769.08,'K')), NASAPolynomial(coeffs=[11.2939,0.0422298,-1.79792e-05,3.27094e-09,-2.19741e-13,-40248.2,-28.955], Tmin=(1769.08,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-305.754,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)HHH) + group(Cds-OdCsCs)"""),
)

species(
    label = 'CCC=CC(C)O(2067)',
    structure = SMILES('CCC=CC(C)O'),
    E0 = (-248,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
reaction(
    label = 'reaction1',
    reactants = ['CC[CH]CC(C)[O](1201)'],
    products = ['butene1(127)', 'CH3CHO(37)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'CC[CH]CC(C)=O(2056)'],
    products = ['CC[CH]CC(C)[O](1201)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['[CH2][CH]CC(130)', 'CH3CHO(37)'],
    products = ['CC[CH]CC(C)[O](1201)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['CH3(17)', 'CC[CH]CC=O(1724)'],
    products = ['CC[CH]CC(C)[O](1201)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['butene1(127)', 'C[CH][O](176)'],
    products = ['CC[CH]CC(C)[O](1201)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['CH3(17)', 'C=CCC(C)[O](1922)'],
    products = ['CC[CH]CC(C)[O](1201)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2][CH]CC(130)', 'C[CH][O](176)'],
    products = ['CC[CH]CC(C)[O](1201)'],
