...
species(
    ...
    molecularWeight = (130.142,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.228233,0.0930006,-8.7965e-05,4.43181e-08,-9.14021e-12,-17773.8,36.7227], Tmin=(100,'K'), Tmax=(1153.21,'K')), NASAPolynomial(coeffs=[15.5413,0.0383015,-1.68151e-05,3.18546e-09,-2.23e-13,-21410.8,-41.6035], Tmin=(1153.21,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-149.046,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-(Cds-O2d)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)OsHH) + group(Cs-OsHHH) + group(Cds-OdCsCs) + radical(C=OCOJ) + radical(CsJOCC2)"""),
)

species(
    label = 'CC[CH]OCC(=O)C[O](5452)',
    structure = SMILES('CC[CH]OCC(=O)C[O]'),
    E0 = (-139.677,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,375,552.5,462.5,1710,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (130.142,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.459983,0.102836,-0.000117211,7.41711e-08,-1.92498e-11,-16642.7,35.2485], Tmin=(100,'K'), Tmax=(928.755,'K')), NASAPolynomial(coeffs=[13.674,0.0419613,-1.88909e-05,3.59413e-09,-2.51453e-13,-19268.1,-31.8949], Tmin=(928.755,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-139.677,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-O2d)OsHH) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)OsHH) + group(Cds-OdCsCs) + radical(CCsJOCs) + radical(C=OCOJ)"""),
)
...
species(
    ...
    molecularWeight = (130.142,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.28817,0.10083,-0.000101143,5.34196e-08,-1.08447e-11,-14374.9,34.4764], Tmin=(100,'K'), Tmax=(1354.17,'K')), NASAPolynomial(coeffs=[20.7144,0.0252247,-5.63926e-06,6.14407e-10,-2.75574e-14,-19360.8,-74.7509], Tmin=(1354.17,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-121.213,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(440.667,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Oxetane) + radical(CCsJOCs) + radical(CC(C)2OJ)"""),
)
...
species(
    ...
    molecularWeight = (130.142,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.990198,0.0907523,-8.00831e-05,3.78952e-08,-6.96343e-12,-12043.8,36.4699], Tmin=(100,'K'), Tmax=(1499.07,'K')), NASAPolynomial(coeffs=[19.0207,0.0273951,-6.71885e-06,8.35722e-10,-4.37305e-14,-16924.1,-64.4393], Tmin=(1499.07,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-101.767,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(440.667,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Oxetane) + radical(CC(C)2OJ) + radical(CCJCO)"""),
)
...
species(
    ...
    molecularWeight = (130.142,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.820477,0.0929627,-8.65882e-05,4.39345e-08,-8.76977e-12,-11412.3,35.1425], Tmin=(100,'K'), Tmax=(1328.84,'K')), NASAPolynomial(coeffs=[18.1819,0.0296347,-8.18618e-06,1.13067e-09,-6.40281e-14,-15921.4,-59.8997], Tmin=(1328.84,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-96.4223,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(440.667,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Oxetane) + radical(RCCJ) + radical(CC(C)2OJ)"""),
)
...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.780726,0.0671445,-4.7481e-05,1.23952e-08,1.79206e-12,-6156.8,26.2329], Tmin=(100,'K'), Tmax=(873.6,'K')), NASAPolynomial(coeffs=[11.1968,0.0326453,-1.08982e-05,1.76534e-09,-1.13155e-13,-8480.13,-25.4924], Tmin=(873.6,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-52.1833,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(374.151,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Oxetane) + radical(CCOJ) + radical(CC(C)2OJ)"""),
)

species(
    label = 'CCC1OCC12COO2(5275)',
...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.07558,0.0557416,-5.74469e-06,-2.68274e-08,1.38008e-11,3613.8,27.8362], Tmin=(100,'K'), Tmax=(942.751,'K')), NASAPolynomial(coeffs=[9.72234,0.039919,-1.3767e-05,2.32126e-09,-1.54139e-13,1056.25,-18.2872], Tmin=(942.751,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(29.107,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(419.881,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Oxetane) + radical(CCJ(C)CO) + radical(CCOJ)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]OC(CC)C(=O)C[O](5451)'],
    products = ['CCC1OCC1([O])C[O](5271)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CC[CH]OCC(=O)C[O](5452)'],
    products = ['CCC1OCC1([O])C[O](5271)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', 'CCC1OCC1([O])C=O(5453)'],
    products = ['CCC1OCC1([O])C[O](5271)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['CH2O(15)', 'CCC1OC[C]1[O](5301)'],
    products = ['CCC1OCC1([O])C[O](5271)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['CCC1OCC1([O])[CH]O(5454)'],
    products = ['CCC1OCC1([O])C[O](5271)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['CCC1OCC1([O])C[O](5271)'],
    products = ['CCC1O[CH]C1(O)C[O](5455)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction12',
    reactants = ['CCC1OCC1([O])C[O](5271)'],
    products = ['CCC1O[CH]C1([O])CO(5458)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CCC1OCC1([O])C[O](5271)'],
    products = ['C[CH]C1OCC1(O)C[O](5459)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CCC1OCC1([O])C[O](5271)'],
    products = ['C[CH]C1OCC1([O])CO(5460)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CCC1OCC1([O])C[O](5271)'],
    products = ['[CH2]CC1OCC1(O)C[O](5461)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CCC1OCC1([O])C[O](5271)'],
    products = ['[CH2]CC1OCC1([O])CO(5462)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CH2(S)(23)', 'CC1OCC1([O])C[O](5464)'],
    products = ['CCC1OCC1([O])C[O](5271)'],
...
reaction(
    label = 'reaction21',
    reactants = ['C2H5CHO(70)', 'C=C([O])C[O](939)'],
    products = ['CCC1OCC1([O])C[O](5271)'],
...
reaction(
    label = 'reaction22',
    reactants = ['CH2O(15)', 'CCC=C([O])C[O](3185)'],
    products = ['CCC1OCC1([O])C[O](5271)'],
...
reaction(
    label = 'reaction23',
    reactants = ['O(4)', 'CCC1OC[C]1C[O](5465)'],
    products = ['CCC1OCC1([O])C[O](5271)'],
...
reaction(
    label = 'reaction24',
    reactants = ['O(4)', '[CH2]C1([O])COC1CC(5466)'],
    products = ['CCC1OCC1([O])C[O](5271)'],
