species(
    label = 'CCC(CCC(C)OO)O[O](3726)',
    structure = SMILES('CCC(CCC(C)OO)O[O]'),
    E0 = (-265.571,'kJ/mol'),
    modes = [
...
species(
    label = 'CCC(CCC(C)[O])O[O](3735)',
    structure = SMILES('CCC(CCC(C)[O])O[O]'),
    E0 = (-106.715,'kJ/mol'),
    modes = [
...
species(
    label = 'CCC(CCC(C)O[O])O[O](3736)',
    structure = SMILES('CCC(CCC(C)O[O])O[O]'),
    E0 = (-113.566,'kJ/mol'),
    modes = [
...
species(
    label = 'CC(CC[CH]O[O])OO(3737)',
    structure = SMILES('CC(CC[CH]O[O])OO'),
    E0 = (-16.785,'kJ/mol'),
    modes = [
...
species(
    label = 'CC[C](CCC(C)OO)O[O](3738)',
    structure = SMILES('CC[C](CCC(C)OO)O[O]'),
    E0 = (-78.6718,'kJ/mol'),
    modes = [
...
species(
    label = 'CCC(CC[CH]OO)O[O](3739)',
    structure = SMILES('CCC(CC[CH]OO)O[O]'),
    E0 = (-40.5652,'kJ/mol'),
    modes = [
...
species(
    label = 'CCC(CC[C](C)OO)O[O](3740)',
    structure = SMILES('CCC(CC[C](C)OO)O[O]'),
    E0 = (-78.6718,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,492.5,1135,1000,360,370,350,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'CCC(C[CH]C(C)OO)O[O](3741)',
    structure = SMILES('CCC(C[CH]C(C)OO)O[O]'),
    E0 = (-65.156,'kJ/mol'),
    modes = [
...
species(
    label = 'CCC([CH]CC(C)OO)O[O](3742)',
    structure = SMILES('CCC([CH]CC(C)OO)O[O]'),
    E0 = (-65.156,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,492.5,1135,1000,3615,1310,387.5,850,1000,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2]C(CCC(C)OO)O[O](3743)',
    structure = SMILES('[CH2]C(CCC(C)OO)O[O]'),
    E0 = (-27.8281,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (148.157,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.20149,0.121233,-0.000138413,8.91675e-08,-2.3786e-11,-3165.51,41.7805], Tmin=(100,'K'), Tmax=(900.721,'K')), NASAPolynomial(coeffs=[14.2397,0.0526603,-2.42159e-05,4.64489e-09,-3.2622e-13,-5947.15,-31.0999], Tmin=(900.721,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-27.8281,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(498.868,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(CJCOOH)"""),
)

species(
    label = 'C[CH]C(CCC(C)OO)O[O](3744)',
    structure = SMILES('C[CH]C(CCC(C)OO)O[O]'),
    E0 = (-65.156,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,492.5,1135,1000,3615,1310,387.5,850,1000,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2]C(CCC(CC)O[O])OO(3745)',
    structure = SMILES('[CH2]C(CCC(CC)O[O])OO'),
    E0 = (-51.6084,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (162.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.81774,0.13563,-0.000150791,9.52117e-08,-2.50301e-11,-6004.11,46.2403], Tmin=(100,'K'), Tmax=(911.004,'K')), NASAPolynomial(coeffs=[15.163,0.0610722,-2.80313e-05,5.37769e-09,-3.77909e-13,-9098.04,-34.0992], Tmin=(911.004,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-51.6084,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(569.541,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJCOOH) + radical(ROOJ)"""),
)

species(
    label = '[CH2]CC(CCC(C)OO)O[O](3746)',
    structure = SMILES('[CH2]CC(CCC(C)OO)O[O]'),
    E0 = (-60.3245,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,492.5,1135,1000,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3000,3100,440,815,1455,1000,3615,1310,387.5,850,1000,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'CC(CCC(C)OO)O[O](3748)',
    structure = SMILES('CC(CCC(C)OO)O[O]'),
    E0 = (-241.791,'kJ/mol'),
    modes = [
...
species(
    label = 'CC[C](CCC(C)OO)OO(3727)',
    structure = SMILES('CC[C](CCC(C)OO)OO'),
    E0 = (-230.676,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (163.192,'amu'),
...
species(
    label = 'CCC([CH]CC(C)OO)OO(3728)',
    structure = SMILES('CCC([CH]CC(C)OO)OO'),
    E0 = (-217.161,'kJ/mol'),
    modes = [
...
species(
    label = 'C[CH]C(CCC(C)OO)OO(3729)',
    structure = SMILES('C[CH]C(CCC(C)OO)OO'),
    E0 = (-217.161,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3025,407.5,1350,352.5,3580,3650,1300,1320,350,425,825,875,900,1100,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2]CC(CCC(C)OO)OO(3731)',
    structure = SMILES('[CH2]CC(CCC(C)OO)OO'),
    E0 = (-212.329,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (163.192,'amu'),
...
species(
    label = 'CCC(CC[C](C)OO)OO(3732)',
    structure = SMILES('CCC(CC[C](C)OO)OO'),
    E0 = (-230.676,'kJ/mol'),
    modes = [
...
species(
    label = '[CH2]C(CCC(CC)OO)OO(3733)',
    structure = SMILES('[CH2]C(CCC(CC)OO)OO'),
    E0 = (-203.613,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (163.192,'amu'),
...
species(
    label = 'CCC(CCC(C)O[O])OO(3734)',
    structure = SMILES('CCC(CCC(C)O[O])OO'),
    E0 = (-265.571,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,3615,1310,387.5,850,1000,492.5,1135,1000,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
reaction(
    label = 'reaction10',
    reactants = ['OH(5)', 'CCC(CCC(C)[O])O[O](3735)'],
    products = ['CCC(CCC(C)OO)O[O](3726)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction11',
    reactants = ['C[CH]CCC(CC)O[O](248)', 'HO2(10)'],
    products = ['CCC(CCC(C)OO)O[O](3726)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction1',
    reactants = ['O2(2)', 'CC[CH]CCC(C)OO(213)'],
    products = ['CCC(CCC(C)OO)O[O](3726)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction12',
    reactants = ['H(3)', 'CCC(CCC(C)O[O])O[O](3736)'],
    products = ['CCC(CCC(C)OO)O[O](3726)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction13',
    reactants = ['CC[CH]O[O](238)', '[CH2]CC(C)OO(2102)'],
    products = ['CCC(CCC(C)OO)O[O](3726)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction14',
    reactants = ['C2H5(29)', 'CC(CC[CH]O[O])OO(3737)'],
    products = ['CCC(CCC(C)OO)O[O](3726)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction15',
    reactants = ['H(3)', 'CC[C](CCC(C)OO)O[O](3738)'],
    products = ['CCC(CCC(C)OO)O[O](3726)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction16',
    reactants = ['CH3CHOOH(63)', '[CH2]CC(CC)O[O](243)'],
    products = ['CCC(CCC(C)OO)O[O](3726)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(1.15e+14,'cm^3/(mol*s)','*|/',2), n=-0.35, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2500,'K'), comment="""Estimated using template [C_rad/H/NonDe;C_rad/H2/Cs] for rate rule [C_rad/H/CsO;C_rad/H2/Cs]
Euclidian distance = 2.0
...
reaction(
    label = 'reaction17',
    reactants = ['CH3(17)', 'CCC(CC[CH]OO)O[O](3739)'],
    products = ['CCC(CCC(C)OO)O[O](3726)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction18',
    reactants = ['H(3)', 'CCC(CC[C](C)OO)O[O](3740)'],
    products = ['CCC(CCC(C)OO)O[O](3726)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2]C(CC)O[O](241)', 'QOOH_3(717)'],
    products = ['CCC(CCC(C)OO)O[O](3726)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(3)', 'CCC(C[CH]C(C)OO)O[O](3741)'],
    products = ['CCC(CCC(C)OO)O[O](3726)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(3)', 'CCC([CH]CC(C)OO)O[O](3742)'],
    products = ['CCC(CCC(C)OO)O[O](3726)'],
...
reaction(
    label = 'reaction22',
    reactants = ['CH3(17)', '[CH2]C(CCC(C)OO)O[O](3743)'],
    products = ['CCC(CCC(C)OO)O[O](3726)'],
...
reaction(
    label = 'reaction23',
    reactants = ['H(3)', 'C[CH]C(CCC(C)OO)O[O](3744)'],
    products = ['CCC(CCC(C)OO)O[O](3726)'],
...
reaction(
    label = 'reaction24',
    reactants = ['H(3)', '[CH2]C(CCC(CC)O[O])OO(3745)'],
    products = ['CCC(CCC(C)OO)O[O](3726)'],
...
reaction(
    label = 'reaction25',
    reactants = ['H(3)', '[CH2]CC(CCC(C)OO)O[O](3746)'],
    products = ['CCC(CCC(C)OO)O[O](3726)'],
...
reaction(
    label = 'reaction26',
    reactants = ['CH2(S)(23)', 'CCC(CCCOO)O[O](3747)'],
    products = ['CCC(CCC(C)OO)O[O](3726)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CH2(S)(23)', 'CC(CCC(C)OO)O[O](3748)'],
    products = ['CCC(CCC(C)OO)O[O](3726)'],
...
reaction(
    label = 'reaction2',
    reactants = ['CCC(CCC(C)OO)O[O](3726)'],
    products = ['CC[C](CCC(C)OO)OO(3727)'],
...
reaction(
    label = 'reaction3',
    reactants = ['CCC([CH]CC(C)OO)OO(3728)'],
    products = ['CCC(CCC(C)OO)O[O](3726)'],
...
reaction(
    label = 'reaction4',
    reactants = ['C[CH]C(CCC(C)OO)OO(3729)'],
    products = ['CCC(CCC(C)OO)O[O](3726)'],
...
reaction(
    label = 'reaction5',
    reactants = ['CCC(C[CH]C(C)OO)OO(3730)'],
    products = ['CCC(CCC(C)OO)O[O](3726)'],
...
reaction(
    label = 'reaction6',
    reactants = ['CCC(CCC(C)OO)O[O](3726)'],
    products = ['[CH2]CC(CCC(C)OO)OO(3731)'],
...
reaction(
    label = 'reaction7',
    reactants = ['CCC(CC[C](C)OO)OO(3732)'],
    products = ['CCC(CCC(C)OO)O[O](3726)'],
    transitionState = 'TS25',
    kinetics = Arrhenius(A=(85.2996,'s^-1'), n=2.53443, Ea=(58.4462,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R6H_SSSSS;C_rad_out_single;XH_out] for rate rule [R6H_SSSSS;C_rad_out_NDMustO;O_H_out]
...
reaction(
    label = 'reaction8',
    reactants = ['CCC(CCC(C)OO)O[O](3726)'],
    products = ['[CH2]C(CCC(CC)OO)OO(3733)'],
...
reaction(
    label = 'reaction9',
    reactants = ['CCC(CCC(C)O[O])OO(3734)'],
    products = ['CCC(CCC(C)OO)O[O](3726)'],
...
reaction(
    label = 'reaction28',
    reactants = ['CCC(CCC(C)OO)O[O](3726)'],
    products = ['HO2(10)', 'CCC=CCC(C)OO(2086)'],
...
reaction(
    label = 'reaction29',
    reactants = ['CCC(CCC(C)OO)O[O](3726)'],
    products = ['HO2(10)', 'CC=CCCC(C)OO(2087)'],
...
reaction(
    label = 'reaction30',
    reactants = ['O(4)', 'CCC([O])CCC(C)OO(3749)'],
    products = ['CCC(CCC(C)OO)O[O](3726)'],
...
network(
    label = '1098',
    isomers = [
        'CCC(CCC(C)OO)O[O](3726)',
    ],
    reactants = [
        ('O2(2)', 'CC[CH]CCC(C)OO(213)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
