species(
    label = 'C=[C]OO[C]=O(801)',
    structure = SMILES('C=[C]OO[C]=O'),
    E0 = (151.603,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,1685,370,1855,455,950,2950,3100,1380,975,1025,1650],'cm^-1')),
        HinderedRotor(inertia=(1.79054,'amu*angstrom^2'), symmetry=1, barrier=(41.1681,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.79102,'amu*angstrom^2'), symmetry=1, barrier=(41.1791,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.79096,'amu*angstrom^2'), symmetry=1, barrier=(41.1777,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.0462,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.95491,0.0361768,-1.53848e-05,-1.13147e-08,8.01757e-12,18315,23.1525], Tmin=(100,'K'), Tmax=(992.878,'K')), NASAPolynomial(coeffs=[13.742,0.00846048,-3.37989e-06,6.79373e-10,-5.21016e-14,14999.9,-38.5363], Tmin=(992.878,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(151.603,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(170.447,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-O2s(Cds-O2d)) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(Cds-OdOsH) + radical((O)CJOC) + radical(C=CJO)"""),
)
...
species(
    label = '[CH]=[C]OOC=O(5632)',
    structure = SMILES('[CH]=[C]OOC=O'),
    E0 = (202.25,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,3120,650,792.5,1650,2782.5,750,1395,475,1775,1000,1685,370],'cm^-1')),
    ...
    molecularWeight = (86.0462,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.08995,0.0319345,-3.89512e-06,-2.23226e-08,1.15304e-11,24402.8,24.444], Tmin=(100,'K'), Tmax=(999.231,'K')), NASAPolynomial(coeffs=[13.7093,0.00861439,-3.70434e-06,7.78936e-10,-6.1052e-14,20922.8,-37.3975], Tmin=(999.231,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(202.25,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(170.447,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-O2s(Cds-O2d)) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(Cds-OdOsH) + radical(Cds_P) + radical(C=CJO)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'C#COO[C]=O(5630)'],
    products = ['C=[C]OO[C]=O(801)'],
    transitionState = 'TS2',
