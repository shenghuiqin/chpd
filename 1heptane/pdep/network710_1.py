...
species(
    label = 'C=C(CC)C[C]=O(2880)',
    structure = SMILES('C=C(CC)C[C]=O'),
    E0 = (5.12134,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2950,3100,1380,975,1025,1650,1855,455,950,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,261.236,261.237],'cm^-1')),
        HinderedRotor(inertia=(0.00247026,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00247004,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.333977,'amu*angstrom^2'), symmetry=1, barrier=(16.1731,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.333993,'amu*angstrom^2'), symmetry=1, barrier=(16.1731,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
species(
    label = '[CH2]C([CH]C)CC=O(2887)',
    structure = SMILES('[CH2]C([CH]C)CC=O'),
    E0 = (119.266,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2782.5,750,1395,475,1775,1000,180,1567.72],'cm^-1')),
        HinderedRotor(inertia=(0.0996291,'amu*angstrom^2'), symmetry=1, barrier=(2.29067,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0959677,'amu*angstrom^2'), symmetry=1, barrier=(2.20649,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.09843,'amu*angstrom^2'), symmetry=1, barrier=(2.2631,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0983761,'amu*angstrom^2'), symmetry=1, barrier=(2.26186,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0957121,'amu*angstrom^2'), symmetry=1, barrier=(2.20061,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.31692,0.0633592,-4.98601e-05,2.59935e-08,-6.48188e-12,14437.3,29.8302], Tmin=(100,'K'), Tmax=(892.216,'K')), NASAPolynomial(coeffs=[5.25572,0.0457002,-2.01709e-05,3.80904e-09,-2.65587e-13,13734.5,11.2771], Tmin=(892.216,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(119.266,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(Isobutyl) + radical(Cs_S)"""),
)

species(
    label = '[CH2]CC(C)C[C]=O(2888)',
    structure = SMILES('[CH2]CC(C)C[C]=O'),
    E0 = (84.8487,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,1855,455,950,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,180,2716.33],'cm^-1')),
        HinderedRotor(inertia=(0.130885,'amu*angstrom^2'), symmetry=1, barrier=(3.0093,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0197804,'amu*angstrom^2'), symmetry=1, barrier=(13.097,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.569577,'amu*angstrom^2'), symmetry=1, barrier=(13.0957,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.569559,'amu*angstrom^2'), symmetry=1, barrier=(13.0953,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.130192,'amu*angstrom^2'), symmetry=1, barrier=(2.99336,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (98.143,'amu'),
...
species(
    label = '[CH2]CC([CH2])CC=O(2889)',
    structure = SMILES('[CH2]CC([CH2])CC=O'),
    E0 = (129.97,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2782.5,750,1395,475,1775,1000,1380,1390,370,380,2900,435,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,258.418,3017.79],'cm^-1')),
        HinderedRotor(inertia=(0.0176255,'amu*angstrom^2'), symmetry=1, barrier=(15.5915,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.140409,'amu*angstrom^2'), symmetry=1, barrier=(6.64083,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00102565,'amu*angstrom^2'), symmetry=1, barrier=(6.62772,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(3.39108,'amu*angstrom^2'), symmetry=1, barrier=(77.9715,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.64677,'amu*angstrom^2'), symmetry=1, barrier=(77.9753,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (98.143,'amu'),
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'C=C(CC)C[C]=O(2880)'],
    products = ['[CH2]C(CC)C[C]=O(1131)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['C2H5(29)', 'C=CC[C]=O(2390)'],
    products = ['[CH2]C(CC)C[C]=O(1131)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]C([CH]C)CC=O(2887)'],
    products = ['[CH2]C(CC)C[C]=O(1131)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]CC([CH2])CC=O(2889)'],
    products = ['[CH2]C(CC)C[C]=O(1131)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CH2(S)(23)', '[CH2]C(C)C[C]=O(1155)'],
    products = ['[CH2]C(CC)C[C]=O(1131)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH2]C([CH2])CC(429)', 'CO(12)'],
    products = ['[CH2]C(CC)C[C]=O(1131)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[C]=O(361)', '[CH2]C([CH2])CC(429)'],
    products = ['[CH2]C(CC)C[C]=O(1131)'],
