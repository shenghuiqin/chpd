...
reaction(
    label = 'reaction6',
    reactants = ['CH3CH2OH(54)'],
    products = ['C2H4(21)', 'H2O(7)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'CH3CH2O(38)'],
    products = ['CH3CH2OH(54)'],
    transitionState = 'TS3',
