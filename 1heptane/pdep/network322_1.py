...
reaction(
    label = 'reaction1',
    reactants = ['CH3C(O)O(68)'],
    products = ['CO2(13)', 'CH3(17)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction3',
    reactants = ['CH3(17)', '[O][C]=O(669)'],
    products = ['CH3C(O)O(68)'],
    transitionState = 'TS3',
...
reaction(
    ...
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(1.55936e+11,'s^-1'), n=0.551275, Ea=(348.018,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R3_linear;multiplebond_intra;radadd_intra] for rate rule [R3_CO;carbonyl_intra_Nd;radadd_intra_O]
Euclidian distance = 2.44948974278
family: Intra_R_Add_Endocyclic
Ea raised from 347.7 to 348.0 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction6',
    reactants = ['CH3CO(57)', 'O(4)'],
    products = ['CH3C(O)O(68)'],
    transitionState = 'TS6',
