species(
    label = 'C=[C]OC([O])CCC=O(21328)',
    structure = SMILES('C=[C]OC([O])CCC=O'),
    E0 = (-50.6485,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2950,3100,1380,975,1025,1650,1685,370,1380,1390,370,380,2900,435,2782.5,750,1395,475,1775,1000,200,800,1000,1200,1400,1600],'cm^-1')),
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.31595,0.0874593,-9.5188e-05,5.98037e-08,-1.59291e-11,-5964.45,35.6003], Tmin=(100,'K'), Tmax=(891.323,'K')), NASAPolynomial(coeffs=[10.1892,0.0431514,-2.06231e-05,4.03309e-09,-2.86535e-13,-7724.51,-10.8963], Tmin=(891.323,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-50.6485,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-(Cds-O2d)CsHH) + group(Cds-OdCsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C=CJO) + radical(CCOJ)"""),
)
...
species(
    label = 'C=[C]OC1CCC([O])O1(21552)',
    structure = SMILES('C=[C]OC1CCC([O])O1'),
    E0 = (-62.5107,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.126,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.694022,0.0565887,9.82126e-06,-5.88537e-08,2.89126e-11,-7384.43,29.8637], Tmin=(100,'K'), Tmax=(928.87,'K')), NASAPolynomial(coeffs=[17.3264,0.0261076,-7.39645e-06,1.18938e-09,-8.19448e-14,-12249.2,-58.7049], Tmin=(928.87,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-62.5107,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(399.095,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsOsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + ring(Tetrahydrofuran) + radical(C=CJO) + radical(CCOJ)"""),
)
...
species(
    label = 'C=[C]OC(=O)CCC=O(21553)',
    structure = SMILES('C=[C]OC(=O)CCC=O'),
    E0 = (-242.321,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,1685,370,2782.5,750,1395,475,1775,1000,2950,3100,1380,975,1025,1650,180,180,180,196.616,960.966,1600,1828.57,2971.43,3200],'cm^-1')),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.3526,0.0721494,-2.46666e-05,-1.22076e-07,1.43283e-10,-29063.9,29.9582], Tmin=(100,'K'), Tmax=(446.48,'K')), NASAPolynomial(coeffs=[7.22248,0.0454877,-2.21959e-05,4.29225e-09,-2.99312e-13,-29846.4,3.47875], Tmin=(446.48,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-242.321,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-Cd)) + group(Cs-(Cds-O2d)CsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cds-OdCsOs) + group(Cds-OdCsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C=CJO)"""),
)

species(
    label = 'C#COC([O])CCC=O(21554)',
    structure = SMILES('C#COC([O])CCC=O'),
    E0 = (-81.0662,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,750,770,3400,2100,2175,525,1380,1390,370,380,2900,435,2782.5,750,1395,475,1775,1000,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (127.118,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.112508,0.0913043,-0.00010446,6.50048e-08,-1.66567e-11,-9614.9,30.656], Tmin=(100,'K'), Tmax=(936.161,'K')), NASAPolynomial(coeffs=[12.7097,0.0374799,-1.82183e-05,3.5904e-09,-2.56269e-13,-11973.5,-29.2873], Tmin=(936.161,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-81.0662,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-(Cds-O2d)CsHH) + group(Cds-OdCsH) + group(Ct-CtOs) + group(Ct-CtH) + radical(CCOJ)"""),
)
...
species(
    ...
    molecularWeight = (128.126,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.135899,0.0926491,-0.0001003,5.73055e-08,-1.3218e-11,-8404.62,37.0349], Tmin=(100,'K'), Tmax=(1045.98,'K')), NASAPolynomial(coeffs=[15.4464,0.0330593,-1.48442e-05,2.83881e-09,-1.99842e-13,-11664.4,-38.8412], Tmin=(1045.98,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-71.1073,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-(Cds-O2d)CsHH) + group(Cds-OdCsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(Cs_P) + radical(C=CJO)"""),
)
...
species(
    ...
    molecularWeight = (128.126,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.246319,0.102149,-0.000148077,1.27244e-07,-4.45702e-11,-22703.3,35.4865], Tmin=(100,'K'), Tmax=(791.725,'K')), NASAPolynomial(coeffs=[8.54928,0.0468535,-2.27413e-05,4.38384e-09,-3.05139e-13,-23755.8,-2.74387], Tmin=(791.725,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-189.968,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-(Cds-O2d)CsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdCsOs) + group(Cds-OdCsH) + radical(CCsJOC(O)) + radical(CJCO)"""),
)

species(
    label = 'C=[C]OC(O)[CH]CC=O(21558)',
    structure = SMILES('C=[C]OC(O)[CH]CC=O'),
    E0 = (-76.4516,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,3025,407.5,1350,352.5,3615,1277.5,1000,2950,3100,1380,975,1025,1650,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2782.5,750,1395,475,1775,1000,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (128.126,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.153693,0.0888517,-8.9077e-05,4.61096e-08,-9.5497e-12,-9043.31,38.9006], Tmin=(100,'K'), Tmax=(1165.1,'K')), NASAPolynomial(coeffs=[17.1382,0.0294861,-1.26482e-05,2.37781e-09,-1.6611e-13,-13072.7,-47.1655], Tmin=(1165.1,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-76.4516,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-(Cds-O2d)CsHH) + group(Cds-OdCsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CCJCO) + radical(C=CJO)"""),
)

species(
    label = 'C=[C]OC(O)C[CH]C=O(21559)',
    structure = SMILES('C=[C]OC(O)CC=C[O]'),
    E0 = (-133.102,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.126,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.659112,0.0865038,-5.62448e-05,-4.66778e-09,1.22505e-11,-15826.2,37.9265], Tmin=(100,'K'), Tmax=(955.297,'K')), NASAPolynomial(coeffs=[25.3435,0.0155768,-4.46523e-06,7.82522e-10,-5.86828e-14,-22525.9,-95.3953], Tmin=(955.297,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-133.102,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsOsH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C=COJ) + radical(C=CJO)"""),
)

species(
    label = 'C=COC([O])[CH]CC=O(21560)',
    structure = SMILES('C=COC([O])[CH]CC=O'),
    E0 = (-90.4907,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.126,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0845275,0.085309,-7.76652e-05,3.60817e-08,-6.73223e-12,-10732.8,36.3842], Tmin=(100,'K'), Tmax=(1281.21,'K')), NASAPolynomial(coeffs=[17.5932,0.0301185,-1.305e-05,2.4598e-09,-1.71678e-13,-15262.6,-53.2812], Tmin=(1281.21,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-90.4907,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-(Cds-O2d)CsHH) + group(Cds-CdsOsH) + group(Cds-OdCsH) + group(Cds-CdsHH) + radical(CCJCO) + radical(CCOJ)"""),
)

species(
    label = '[CH]=[C]OC(O)CCC=O(21561)',
    structure = SMILES('[CH]=[C]OC(O)CCC=O'),
    E0 = (-29.2575,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,3615,1277.5,1000,1685,370,1380,1390,370,380,2900,435,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2782.5,750,1395,475,1775,1000,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (128.126,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.257491,0.0955508,-0.00010685,6.283e-08,-1.48509e-11,-3367.06,37.1874], Tmin=(100,'K'), Tmax=(1024.26,'K')), NASAPolynomial(coeffs=[15.8716,0.0325623,-1.46049e-05,2.7893e-09,-1.96162e-13,-6671.12,-41.0125], Tmin=(1024.26,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-29.2575,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-(Cds-O2d)CsHH) + group(Cds-OdCsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(Cds_P) + radical(C=CJO)"""),
)

species(
    label = 'C=[C]OC(O)CC[C]=O(21562)',
    structure = SMILES('C=[C]OC(O)CC[C]=O'),
    E0 = (-116.393,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.126,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.327868,0.0958679,-0.000108445,6.40712e-08,-1.51004e-11,-13843.5,37.8531], Tmin=(100,'K'), Tmax=(1031.74,'K')), NASAPolynomial(coeffs=[16.5887,0.0302834,-1.30955e-05,2.46028e-09,-1.71556e-13,-17334.2,-44.2882], Tmin=(1031.74,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-116.393,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-(Cds-O2d)CsHH) + group(Cds-OdCsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C=CJO) + radical(CCCJ=O)"""),
)

species(
    label = 'C=COC([O])C[CH]C=O(21563)',
    structure = SMILES('C=COC([O])CC=C[O]'),
    E0 = (-147.141,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.126,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.538699,0.0823621,-4.28291e-05,-1.70515e-08,1.59292e-11,-17517.8,35.2268], Tmin=(100,'K'), Tmax=(966.067,'K')), NASAPolynomial(coeffs=[24.9796,0.017551,-5.62098e-06,1.03925e-09,-7.85403e-14,-24354.4,-96.8687], Tmin=(966.067,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-147.141,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(390.78,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsOsH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CCOJ) + radical(C=COJ)"""),
)

species(
    label = 'C=COC([O])CC[C]=O(21564)',
    structure = SMILES('C=COC([O])CC[C]=O'),
    E0 = (-130.432,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.126,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.175367,0.0913826,-9.39512e-05,5.03811e-08,-1.08712e-11,-15536.6,35.0355], Tmin=(100,'K'), Tmax=(1116.48,'K')), NASAPolynomial(coeffs=[16.4257,0.031906,-1.40438e-05,2.66716e-09,-1.87223e-13,-19243.5,-46.8843], Tmin=(1116.48,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-130.432,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-(Cds-O2d)CsHH) + group(Cds-CdsOsH) + group(Cds-OdCsH) + group(Cds-CdsHH) + radical(CCOJ) + radical(CCCJ=O)"""),
)
...
species(
    label = 'C=[C]OC1CC[CH]OO1(21565)',
    structure = SMILES('C=[C]OC1CC[CH]OO1'),
    E0 = (140.562,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.126,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.25129,0.0607792,2.03977e-05,-8.65262e-08,4.33246e-11,17061,29.5146], Tmin=(100,'K'), Tmax=(905.864,'K')), NASAPolynomial(coeffs=[23.4633,0.0161102,-1.39113e-06,-2.00173e-11,2.17344e-15,10483,-93.271], Tmin=(905.864,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(140.562,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(399.095,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + ring(12dioxane) + radical(C=CJO) + radical(CCsJOOC)"""),
)
...
species(
    ...
    molecularWeight = (128.126,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.418928,0.0840612,-8.27028e-05,4.58462e-08,-1.0795e-11,-57854.5,29.9158], Tmin=(100,'K'), Tmax=(997.374,'K')), NASAPolynomial(coeffs=[10.8284,0.0423132,-1.99155e-05,3.87745e-09,-2.75139e-13,-59931,-20.2766], Tmin=(997.374,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-482.065,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-Cd)) + group(Cs-(Cds-O2d)CsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cds-OdCsOs) + group(Cds-OdCsH) + group(Cds-CdsOsH) + group(Cds-CdsHH)"""),
)
...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.900189,0.0651502,-5.27628e-05,2.21867e-08,-3.82037e-12,6840.85,29.2043], Tmin=(100,'K'), Tmax=(1359.53,'K')), NASAPolynomial(coeffs=[13.4181,0.0283202,-1.21274e-05,2.2605e-09,-1.56192e-13,3437.17,-35.0319], Tmin=(1359.53,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(55.9311,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C=CJO) + radical(CCOJ)"""),
)
...
species(
    label = 'C=[C]OC([O])COC=C(21569)',
    structure = SMILES('C=[C]OC([O])COC=C'),
    E0 = (-9.05211,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2950,3000,3050,3100,1330,1430,900,1050,1000,1050,1600,1700,1685,370,1380,1390,370,380,2900,435,3010,987.5,1337.5,450,1655,200,800,933.333,1066.67,1200,1333.33,1466.67,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (128.126,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.826538,0.0929426,-7.74626e-05,2.12394e-08,1.81592e-12,-903.196,36.7253], Tmin=(100,'K'), Tmax=(990.699,'K')), NASAPolynomial(coeffs=[24.1218,0.0192478,-6.81654e-06,1.24536e-09,-8.96798e-14,-7173.19,-90.0989], Tmin=(990.699,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-9.05211,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(CCOJ) + radical(C=CJO)"""),
)

species(
    label = 'C=[C]OC([O])CC=CO(21570)',
    structure = SMILES('C=[C]OC([O])CC=CO'),
    E0 = (-48.8596,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (128.126,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.751791,0.0912306,-7.36308e-05,1.62184e-08,4.13892e-12,-5693.41,37.7098], Tmin=(100,'K'), Tmax=(968.407,'K')), NASAPolynomial(coeffs=[24.1657,0.017865,-5.77222e-06,1.01911e-09,-7.32458e-14,-11905.4,-88.8581], Tmin=(968.407,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-48.8596,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsOsH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C=CJO) + radical(CCOJ)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['C=[C]OC([O])CCC=O(21328)'],
...
reaction(
    label = 'reaction2',
    reactants = ['C=[C]OC([O])CCC=O(21328)'],
    products = ['C=[C]OC1CCC([O])O1(21552)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', 'C=[C]OC(=O)CCC=O(21553)'],
    products = ['C=[C]OC([O])CCC=O(21328)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)', 'C#COC([O])CCC=O(21554)'],
    products = ['C=[C]OC([O])CCC=O(21328)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['CH2CH2CHO(560)', 'C=[C]OC=O(2719)'],
    products = ['C=[C]OC([O])CCC=O(21328)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['C=[C]OC([O])CCC=O(21328)'],
    products = ['C=[C]O[C](O)CCC=O(21555)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH]=COC([O])CCC=O(21556)'],
    products = ['C=[C]OC([O])CCC=O(21328)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['C=[C]OC(O)[CH]CC=O(21558)'],
    products = ['C=[C]OC([O])CCC=O(21328)'],
...
reaction(
    label = 'reaction12',
    reactants = ['C=[C]OC([O])CCC=O(21328)'],
    products = ['C=[C]OC(O)C[CH]C=O(21559)'],
...
reaction(
    label = 'reaction13',
    reactants = ['C=[C]OC([O])CCC=O(21328)'],
    products = ['C=COC([O])[CH]CC=O(21560)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH]=[C]OC(O)CCC=O(21561)'],
    products = ['C=[C]OC([O])CCC=O(21328)'],
...
reaction(
    label = 'reaction15',
    reactants = ['C=[C]OC([O])CCC=O(21328)'],
    products = ['C=[C]OC(O)CC[C]=O(21562)'],
...
reaction(
    label = 'reaction16',
    reactants = ['C=[C]OC([O])CCC=O(21328)'],
    products = ['C=COC([O])C[CH]C=O(21563)'],
    transitionState = 'TS16',
    kinetics = Arrhenius(A=(11666.7,'s^-1'), n=1.90389, Ea=(51.5755,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R5H_SSSS;Y_rad_out;Cs_H_out_H/OneDe] for rate rule [R5H_SSSS_OCC;Cd_rad_out_Cd;Cs_H_out_H/CO]
...
reaction(
    label = 'reaction17',
    reactants = ['C=[C]OC([O])CCC=O(21328)'],
    products = ['C=COC([O])CC[C]=O(21564)'],
    transitionState = 'TS17',
    kinetics = Arrhenius(A=(7637.19,'s^-1'), n=1.97227, Ea=(66.6414,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R6H_SSSSS_OO;Y_rad_out;XH_out] for rate rule [R6H_SSSSS_OO;Cd_rad_out_Cd;CO_H_out]
...
reaction(
    label = 'reaction19',
    reactants = ['C=[C]OC([O])CCC=O(21328)'],
    products = ['C=[C]OC1CC[CH]OO1(21565)'],
...
reaction(
    label = 'reaction22',
    reactants = ['CO(12)', 'C=[C]OC([O])CC(10711)'],
    products = ['C=[C]OC([O])CCC=O(21328)'],
...
reaction(
    label = 'reaction24',
    reactants = ['C=[C]OC([O])COC=C(21569)'],
    products = ['C=[C]OC([O])CCC=O(21328)'],
...
reaction(
    label = 'reaction25',
    reactants = ['C=[C]OC([O])CC=CO(21570)'],
    products = ['C=[C]OC([O])CCC=O(21328)'],
...
reaction(
    label = 'reaction26',
    reactants = ['H2CC(41)', '[O]C([O])CCC=O(18653)'],
    products = ['C=[C]OC([O])CCC=O(21328)'],
