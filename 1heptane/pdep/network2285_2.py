species(
    label = 'CC(C[CH]COO)OO(1643)',
    structure = SMILES('CC(C[CH]COO)OO'),
    E0 = (-156.957,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,3580,3650,1300,1320,350,425,825,875,900,1100,1380,1390,370,380,2900,435,200,800,1600],'cm^-1')),
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.683241,0.11097,-0.000131343,8.98579e-08,-2.575e-11,-18716,37.5741], Tmin=(100,'K'), Tmax=(837.07,'K')), NASAPolynomial(coeffs=[11.7948,0.0513443,-2.44984e-05,4.76558e-09,-3.36846e-13,-20805,-20.4065], Tmin=(837.07,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-156.957,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(448.981,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCJCOOH)"""),
)

species(
    label = 'CC(CCCOO)O[O](1639)',
...
species(
    label = 'CC(CC1CO1)OO(1801)',
    structure = SMILES('CC(CC1CO1)OO'),
    E0 = (-251.956,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,1380,1390,370,380,2900,435,3615,1310,387.5,850,1000,2750,2950,3150,900,1000,1100,200,800,900,1000,1100,1200,1300,1400,1500,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    collisionModel = TransportData(shapeIndex=2, epsilon=(4103.21,'J/mol'), sigma=(6.99662,'angstroms'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with Tc=640.91 K, Pc=27.18 bar (from Joback method)"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.482345,0.0862193,-7.75178e-05,3.81128e-08,-7.43073e-12,-30131.5,30.4552], Tmin=(100,'K'), Tmax=(1336.94,'K')), NASAPolynomial(coeffs=[17.1168,0.0291449,-8.52381e-06,1.23628e-09,-7.26962e-14,-34442.3,-58.084], Tmin=(1336.94,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-251.956,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Ethylene_oxide)"""),
)
...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.805461,0.0758166,-7.39107e-05,4.90738e-08,-1.49599e-11,-7342.11,29.5333], Tmin=(100,'K'), Tmax=(763.021,'K')), NASAPolynomial(coeffs=[5.77387,0.0497716,-2.27118e-05,4.34199e-09,-3.04288e-13,-8100.34,6.90726], Tmin=(763.021,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-61.9605,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(407.409,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(RCCJC)"""),
)
...
species(
    label = 'CC(C=CCOO)OO(1788)',
    structure = SMILES('CC(C=CCOO)OO'),
    E0 = (-235.48,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,3580,3650,1300,1320,350,425,825,875,900,1100,1380,1390,370,380,2900,435,200,800],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0980496,0.0929011,-8.4349e-05,4.07491e-08,-8.19458e-12,-28176.5,35.1447], Tmin=(100,'K'), Tmax=(1164.05,'K')), NASAPolynomial(coeffs=[14.4452,0.0429267,-1.99521e-05,3.86839e-09,-2.73845e-13,-31562.3,-37.2274], Tmin=(1164.05,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-235.48,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(428.195,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH)"""),
)

species(
    label = 'CC(CC=COO)OO(1789)',
    structure = SMILES('CC(CC=COO)OO'),
    E0 = (-225.565,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,3580,3650,1300,1320,350,425,825,875,900,1100,1380,1390,370,380,2900,435,200,800],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (134.13,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.555297,0.0985695,-9.48105e-05,4.75203e-08,-9.63653e-12,-26963.9,35.6981], Tmin=(100,'K'), Tmax=(1179.68,'K')), NASAPolynomial(coeffs=[17.6923,0.0366966,-1.61372e-05,3.06002e-09,-2.14427e-13,-31269.1,-55.351], Tmin=(1179.68,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-225.565,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(428.195,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH)"""),
)
...
species(
    ...
    molecularWeight = (135.138,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.720983,0.111876,-0.000132945,9.15619e-08,-2.6426e-11,-20137.8,35.5538], Tmin=(100,'K'), Tmax=(831.345,'K')), NASAPolynomial(coeffs=[11.7405,0.0519187,-2.4767e-05,4.81424e-09,-3.40057e-13,-22209.8,-22.2643], Tmin=(831.345,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-168.79,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(448.981,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCsJOOH)"""),
)

species(
    label = 'C[C](CCCOO)OO(1640)',
    ...
    molecularWeight = (135.138,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.156144,0.104571,-0.000103249,2.72004e-08,2.2445e-11,-20366.3,33.7774], Tmin=(100,'K'), Tmax=(543.888,'K')), NASAPolynomial(coeffs=[9.36819,0.0557068,-2.69028e-05,5.2247e-09,-3.67472e-13,-21715.6,-9.25168], Tmin=(543.888,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-170.473,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(448.981,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(C2CsJOOH)"""),
)

species(
    label = 'CC(CCCO[O])OO(1645)',
...
species(
    label = '[CH2]C(CCCOO)OO(1642)',
    structure = SMILES('[CH2]C(CCCOO)OO'),
    E0 = (-143.41,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3580,3650,1300,1320,350,425,825,875,900,1100,3000,3100,440,815,1455,1000,1380,1390,370,380,2900,435,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'CC([O])C[CH]COO(1791)',
    structure = SMILES('CC([O])C[CH]COO'),
    E0 = (1.89856,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (118.131,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.162131,0.0900559,-9.47109e-05,5.74918e-08,-1.47707e-11,361.76,33.5803], Tmin=(100,'K'), Tmax=(923.394,'K')), NASAPolynomial(coeffs=[10.696,0.0444235,-2.05818e-05,3.97108e-09,-2.80132e-13,-1583.57,-16.3998], Tmin=(923.394,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(1.89856,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(407.409,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCJCOOH) + radical(CC(C)OJ)"""),
)

species(
    label = 'C[CH]C[CH]COO(1471)',
    structure = SMILES('C[CH]C[CH]COO'),
    E0 = (138.454,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3050,390,425,1340,1360,335,370,3615,1310,387.5,850,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (102.132,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.642718,0.0803152,-9.97831e-05,8.33057e-08,-2.96896e-11,16766.9,32.4062], Tmin=(100,'K'), Tmax=(781.357,'K')), NASAPolynomial(coeffs=[5.51155,0.047597,-2.20119e-05,4.18512e-09,-2.90279e-13,16243.9,11.6405], Tmin=(781.357,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(138.454,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(RCCJC) + radical(CCJCOOH)"""),
)
...
species(
    label = 'CC(C[CH]CO[O])OO(1794)',
    structure = SMILES('CC(C[CH]CO[O])OO'),
    E0 = (-4.95253,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,1380,1390,370,380,2900,435,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,492.5,1135,1000,3615,1310,387.5,850,1000,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (134.13,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.22998,0.104059,-0.00011741,5.94403e-08,-1.65323e-12,-453.752,36.7642], Tmin=(100,'K'), Tmax=(587.617,'K')), NASAPolynomial(coeffs=[10.4428,0.0492986,-2.32935e-05,4.47595e-09,-3.12772e-13,-2016.94,-11.6798], Tmin=(587.617,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-4.95253,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(428.195,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCJCOOH) + radical(ROOJ)"""),
)

species(
    label = 'CC(C[CH]COO)O[O](1651)',
...
species(
    label = 'C[C](C[CH]COO)OO(1796)',
    structure = SMILES('C[C](C[CH]COO)OO'),
    E0 = (29.9419,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,360,370,350,3580,3650,1300,1320,350,425,825,875,900,1100,3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (134.13,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.887272,0.117915,-0.000173944,1.5078e-07,-5.2997e-11,3767.13,38.5742], Tmin=(100,'K'), Tmax=(796.275,'K')), NASAPolynomial(coeffs=[9.20334,0.0533178,-2.60573e-05,5.02937e-09,-3.50008e-13,2601.07,-5.0397], Tmin=(796.275,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(29.9419,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(424.038,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCJCOOH) + radical(C2CsJOOH)"""),
)

species(
    label = 'CC([CH][CH]COO)OO(1797)',
    structure = SMILES('CC([CH][CH]COO)OO'),
    E0 = (43.4577,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3050,390,425,1340,1360,335,370,3580,3650,1300,1320,350,425,825,875,900,1100,1380,1390,370,380,2900,435,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (134.13,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.876397,0.115806,-0.000158295,1.2538e-07,-4.10044e-11,5394.35,40.5572], Tmin=(100,'K'), Tmax=(742.363,'K')), NASAPolynomial(coeffs=[11.4586,0.0493161,-2.38923e-05,4.63256e-09,-3.24926e-13,3563.69,-15.2721], Tmin=(742.363,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(43.4577,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(424.038,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCJCOOH) + radical(CCJCOOH)"""),
)

species(
    label = 'CC(C[CH][CH]OO)OO(1798)',
    structure = SMILES('CC(C[CH][CH]OO)OO'),
    E0 = (31.6253,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3050,390,425,1340,1360,335,370,3580,3650,1300,1320,350,425,825,875,900,1100,1380,1390,370,380,2900,435,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (134.13,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.570547,0.111663,-0.000136164,8.37487e-08,-1.49042e-11,3957.8,37.3597], Tmin=(100,'K'), Tmax=(607.721,'K')), NASAPolynomial(coeffs=[11.1992,0.0502915,-2.44154e-05,4.74554e-09,-3.33743e-13,2230.01,-16.0062], Tmin=(607.721,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(31.6253,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(424.038,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCJCOOH) + radical(CCsJOOH)"""),
)

species(
    label = '[CH2]C(C[CH]COO)OO(1799)',
    structure = SMILES('[CH2]C(C[CH]COO)OO'),
    E0 = (57.0053,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3025,407.5,1350,352.5,3580,3650,1300,1320,350,425,825,875,900,1100,3000,3100,440,815,1455,1000,1380,1390,370,380,2900,435,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'OOC[CH]CCOO(1800)',
    structure = SMILES('OOC[CH]CCOO'),
    E0 = (-120.534,'kJ/mol'),
    modes = [
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.260322,0.101337,-0.000140389,1.14517e-07,-3.86532e-11,-14350.7,34.1359], Tmin=(100,'K'), Tmax=(751.475,'K')), NASAPolynomial(coeffs=[9.85985,0.0446573,-2.16394e-05,4.18936e-09,-2.93272e-13,-15792.3,-11.2684], Tmin=(751.475,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-120.534,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(378.308,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + radical(CCJCOOH)"""),
)

species(
    label = 'CC1CC(COO)O1(1802)',
    structure = SMILES('CC1CC(COO)O1'),
    E0 = (-257.488,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (118.131,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.432701,0.0671787,-1.95336e-05,-2.66165e-08,1.72449e-11,-30829.8,26.8483], Tmin=(100,'K'), Tmax=(915.868,'K')), NASAPolynomial(coeffs=[15.4284,0.0313841,-9.54872e-06,1.52029e-09,-9.97812e-14,-34822.2,-50.9793], Tmin=(915.868,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-257.488,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(415.724,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Oxetane)"""),
)

species(
    label = '[CH2]C(COO)C(C)OO(1803)',
    structure = SMILES('[CH2]C(COO)C(C)OO'),
    E0 = (-157.984,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3580,3650,1300,1320,350,425,825,875,900,1100,3000,3100,440,815,1455,1000,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,200,800],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (135.138,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.73652,0.108908,-0.000121101,7.54746e-08,-1.93918e-11,-18834.6,36.954], Tmin=(100,'K'), Tmax=(935.84,'K')), NASAPolynomial(coeffs=[13.9294,0.0462234,-2.06287e-05,3.90158e-09,-2.71987e-13,-21579.6,-32.8283], Tmin=(935.84,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-157.984,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(448.981,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Isobutyl)"""),
)

species(
    label = 'CC(CC(O)C[O])OO(1804)',
    ...
    molecularWeight = (135.138,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0788573,0.101539,-0.000102567,3.6936e-08,1.18253e-11,-45043.8,35.6386], Tmin=(100,'K'), Tmax=(561.512,'K')), NASAPolynomial(coeffs=[9.21292,0.0540508,-2.56713e-05,4.95929e-09,-3.48108e-13,-46382.1,-6.45183], Tmin=(561.512,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-375.642,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCOJ)"""),
)

species(
    label = 'CC([O])CC(O)COO(1805)',
    structure = SMILES('CC([O])CC(O)COO'),
    E0 = (-370.987,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (135.138,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.587759,0.105604,-0.000113499,6.76502e-08,-1.66615e-11,-44458.1,36.3221], Tmin=(100,'K'), Tmax=(972.051,'K')), NASAPolynomial(coeffs=[14.0399,0.0454112,-2.06129e-05,3.9451e-09,-2.77261e-13,-47301.9,-33.833], Tmin=(972.051,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-370.987,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CC(C)OJ)"""),
)
...
species(
    label = 'CC(C[C]COO)OO(1807)',
    structure = SMILES('CC(C[C]COO)OO'),
    E0 = (90.843,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3580,3650,1300,1320,350,425,825,875,900,1100,1380,1390,370,380,2900,435,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (134.13,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.762191,0.112037,-0.000135177,9.075e-08,-2.50949e-11,11091,35.4565], Tmin=(100,'K'), Tmax=(871.71,'K')), NASAPolynomial(coeffs=[13.5515,0.0463559,-2.21544e-05,4.31198e-09,-3.04959e-13,8595.57,-31.6336], Tmin=(871.71,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(90.843,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(424.038,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCJ2_triplet)"""),
)

species(
    label = 'CC(CCC[O])O[O](1646)',
    ...
    molecularWeight = (118.131,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.270939,0.0898684,-0.000117899,1.01368e-07,-3.64788e-11,-6027.3,32.6768], Tmin=(100,'K'), Tmax=(792.973,'K')), NASAPolynomial(coeffs=[5.6315,0.0515577,-2.41105e-05,4.59554e-09,-3.18638e-13,-6523.11,10.2929], Tmin=(792.973,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-51.1673,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(CCOJ)"""),
)

species(
    label = '[CH2]CCC(C)O[O](221)',
...
species(
    ...
    molecularWeight = (134.13,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.478431,0.105603,-0.000139936,1.1145e-07,-3.676e-11,-6263.53,36.0303], Tmin=(100,'K'), Tmax=(783.707,'K')), NASAPolynomial(coeffs=[9.88286,0.048385,-2.21242e-05,4.17484e-09,-2.88003e-13,-7754.45,-10.5823], Tmin=(783.707,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-53.3628,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(ROOJ)"""),
)
...
species(
    label = '[O]O[CH]CCCOO(1648)',
    structure = SMILES('[O]O[CH]CCCOO'),
    E0 = (19.6382,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3025,407.5,1350,352.5,3615,1310,387.5,850,1000,492.5,1135,1000,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'C[C](CCCOO)O[O](1649)',
    structure = SMILES('C[C](CCCOO)O[O]'),
    E0 = (-18.4684,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350,3615,1310,387.5,850,1000,492.5,1135,1000,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (134.13,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.656204,0.112382,-0.00016297,1.41013e-07,-4.94292e-11,-2063.18,36.199], Tmin=(100,'K'), Tmax=(809.409,'K')), NASAPolynomial(coeffs=[8.34641,0.0529797,-2.52511e-05,4.81968e-09,-3.33186e-13,-3032.06,-2.31232], Tmin=(809.409,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-18.4684,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(428.195,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(C2CsJOOH)"""),
)
...
species(
    ...
    molecularWeight = (134.13,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.723223,0.111729,-0.000151261,1.21039e-07,-4.00646e-11,-1856.1,36.301], Tmin=(100,'K'), Tmax=(763.037,'K')), NASAPolynomial(coeffs=[10.6454,0.0493701,-2.32428e-05,4.44386e-09,-3.08942e-13,-3510.6,-14.9443], Tmin=(763.037,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-16.785,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(428.195,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCsJOOH) + radical(ROOJ)"""),
)

species(
    label = '[CH2]C(CCCOO)O[O](1653)',
...
species(
    ...
    molecularWeight = (121.112,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0488859,0.0960648,-0.000130478,1.06362e-07,-3.58874e-11,-20180.2,31.8292], Tmin=(100,'K'), Tmax=(776.359,'K')), NASAPolynomial(coeffs=[9.0539,0.0442256,-2.07763e-05,3.96567e-09,-2.75255e-13,-21444.7,-8.82357], Tmin=(776.359,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-168.944,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + radical(ROOJ)"""),
)
...
species(
    ...
    E0 = (-140.87,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2995,3025,975,1000,1300,1375,400,500,1630,1680,3615,1310,387.5,850,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,301.361,301.919],'cm^-1')),
        HinderedRotor(inertia=(0.13409,'amu*angstrom^2'), symmetry=1, barrier=(8.64675,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.134571,'amu*angstrom^2'), symmetry=1, barrier=(8.64885,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.134144,'amu*angstrom^2'), symmetry=1, barrier=(8.64954,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.272827,'amu*angstrom^2'), symmetry=1, barrier=(17.6126,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.483755,'amu*angstrom^2'), symmetry=1, barrier=(31.1303,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (102.132,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.00993,0.0677654,-4.96072e-05,1.94517e-08,-3.27034e-12,-16837.1,26.0772], Tmin=(100,'K'), Tmax=(1329.14,'K')), NASAPolynomial(coeffs=[10.507,0.0391844,-1.7352e-05,3.27324e-09,-2.27303e-13,-19361.7,-22.4428], Tmin=(1329.14,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-140.87,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH)"""),
)
...
species(
    ...
    molecularWeight = (102.132,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.802581,0.0694053,-5.13207e-05,1.99086e-08,-3.23496e-12,-15354.5,27.2611], Tmin=(100,'K'), Tmax=(1400.31,'K')), NASAPolynomial(coeffs=[12.4692,0.0360797,-1.56229e-05,2.91359e-09,-2.00843e-13,-18621.9,-32.952], Tmin=(1400.31,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-128.625,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH)"""),
)
...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.152271,0.0880083,-7.93979e-05,3.98662e-08,-8.47713e-12,-23740.3,31.2994], Tmin=(100,'K'), Tmax=(1097.44,'K')), NASAPolynomial(coeffs=[12.0556,0.0446208,-2.00928e-05,3.83842e-09,-2.69571e-13,-26352.8,-27.2334], Tmin=(1097.44,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-198.516,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CC(C)OJ)"""),
)
...
reaction(
    label = 'reaction46',
    reactants = ['CC(C[CH]COO)OO(1643)'],
    products = ['OH(5)', 'CC(CC1CO1)OO(1801)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction24',
    reactants = ['H(3)', 'CC(C=CCOO)OO(1788)'],
    products = ['CC(C[CH]COO)OO(1643)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction25',
    reactants = ['H(3)', 'CC(CC=COO)OO(1789)'],
    products = ['CC(C[CH]COO)OO(1643)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction26',
    reactants = ['CH3CHOOH(63)', 'CH2CHCH2OOH(465)'],
    products = ['CC(C[CH]COO)OO(1643)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction27',
    reactants = ['HO2(10)', 'C=CCC(C)OO(1790)'],
    products = ['CC(C[CH]COO)OO(1643)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction33',
    reactants = ['OH(5)', 'CC([O])C[CH]COO(1791)'],
    products = ['CC(C[CH]COO)OO(1643)'],
...
reaction(
    label = 'reaction34',
    reactants = ['HO2(10)', 'C[CH]C[CH]COO(1471)'],
    products = ['CC(C[CH]COO)OO(1643)'],
...
reaction(
    label = 'reaction35',
    reactants = ['OH(5)', 'CC(C[CH]C[O])OO(1792)'],
    products = ['CC(C[CH]COO)OO(1643)'],
...
reaction(
    label = 'reaction36',
    reactants = ['HO2(10)', '[CH2][CH]CC(C)OO(1793)'],
    products = ['CC(C[CH]COO)OO(1643)'],
...
reaction(
    label = 'reaction37',
    reactants = ['H(3)', 'CC(C[CH]CO[O])OO(1794)'],
    products = ['CC(C[CH]COO)OO(1643)'],
...
reaction(
    label = 'reaction38',
    reactants = ['H(3)', 'CC(C[CH]COO)O[O](1651)'],
    products = ['CC(C[CH]COO)OO(1643)'],
...
reaction(
    label = 'reaction39',
    reactants = ['CH3CHOOH(63)', '[CH2][CH]COO(467)'],
    products = ['CC(C[CH]COO)OO(1643)'],
...
reaction(
    label = 'reaction40',
    reactants = ['CH3(17)', 'OO[CH]C[CH]COO(1795)'],
    products = ['CC(C[CH]COO)OO(1643)'],
...
reaction(
    label = 'reaction41',
    reactants = ['H(3)', 'C[C](C[CH]COO)OO(1796)'],
    products = ['CC(C[CH]COO)OO(1643)'],
...
reaction(
    label = 'reaction42',
    reactants = ['H(3)', 'CC([CH][CH]COO)OO(1797)'],
    products = ['CC(C[CH]COO)OO(1643)'],
...
reaction(
    label = 'reaction43',
    reactants = ['H(3)', 'CC(C[CH][CH]OO)OO(1798)'],
    products = ['CC(C[CH]COO)OO(1643)'],
...
reaction(
    label = 'reaction44',
    reactants = ['H(3)', '[CH2]C(C[CH]COO)OO(1799)'],
    products = ['CC(C[CH]COO)OO(1643)'],
...
reaction(
    label = 'reaction45',
    reactants = ['CH2(S)(23)', 'OOC[CH]CCOO(1800)'],
    products = ['CC(C[CH]COO)OO(1643)'],
...
reaction(
    label = 'reaction47',
    reactants = ['CC(C[CH]COO)OO(1643)'],
    products = ['OH(5)', 'CC1CC(COO)O1(1802)'],
...
reaction(
    label = 'reaction48',
    reactants = ['[CH2]C(COO)C(C)OO(1803)'],
    products = ['CC(C[CH]COO)OO(1643)'],
...
reaction(
    label = 'reaction51',
    reactants = ['[CH]COO(106)', 'QOOH_3(717)'],
    products = ['CC(C[CH]COO)OO(1643)'],
...
reaction(
    label = 'reaction52',
    reactants = ['CH2OOH(35)', '[CH]CC(C)OO(1806)'],
    products = ['CC(C[CH]COO)OO(1643)'],
...
reaction(
    label = 'reaction53',
    reactants = ['H(3)', 'CC(C[C]COO)OO(1807)'],
    products = ['CC(C[CH]COO)OO(1643)'],
...
reaction(
    label = 'reaction8',
    reactants = ['OH(5)', 'CC(CCC[O])O[O](1646)'],
    products = ['CC(CCCOO)O[O](1639)'],
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]CCC(C)O[O](221)', 'HO2(10)'],
    products = ['CC(CCCOO)O[O](1639)'],
...
reaction(
    label = 'reaction10',
    reactants = ['H(3)', 'CC(CCCO[O])O[O](1647)'],
    products = ['CC(CCCOO)O[O](1639)'],
...
reaction(
    label = 'reaction11',
    reactants = ['QOOH_1(290)', 'C[CH]O[O](97)'],
    products = ['CC(CCCOO)O[O](1639)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CH3(17)', '[O]O[CH]CCCOO(1648)'],
    products = ['CC(CCCOO)O[O](1639)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(3)', 'C[C](CCCOO)O[O](1649)'],
    products = ['CC(CCCOO)O[O](1639)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]C(C)O[O](218)', 'CH2CH2OOH(45)'],
    products = ['CC(CCCOO)O[O](1639)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(3)', 'CC([CH]CCOO)O[O](1650)'],
    products = ['CC(CCCOO)O[O](1639)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]CC(C)O[O](220)', 'CH2OOH(35)'],
    products = ['CC(CCCOO)O[O](1639)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(3)', 'CC(CC[CH]OO)O[O](1652)'],
    products = ['CC(CCCOO)O[O](1639)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(3)', '[CH2]C(CCCOO)O[O](1653)'],
    products = ['CC(CCCOO)O[O](1639)'],
...
reaction(
    label = 'reaction20',
    reactants = ['CH2(S)(23)', '[O]OCCCCOO(1654)'],
    products = ['CC(CCCOO)O[O](1639)'],
...
network(
    ...
    reactants = [
        ('OH(5)', 'CC(CC1CO1)OO(1801)'),
        ('HO2(10)', 'C=CCC(C)OO(1790)'),
        ('O2(2)', 'C[CH]CCCOO(277)'),
    ],
    bathGas = {
        'N2': 0.5,
