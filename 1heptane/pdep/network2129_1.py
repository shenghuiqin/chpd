...
species(
    label = 'CCC([O])OC=O(11562)',
    structure = SMILES('CCC([O])OC=O'),
    E0 = (-405.924,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2782.5,750,1395,475,1775,1000,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,346.282,346.282,1545.17,1545.17],'cm^-1')),
        HinderedRotor(inertia=(0.0873595,'amu*angstrom^2'), symmetry=1, barrier=(7.43322,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.429992,'amu*angstrom^2'), symmetry=1, barrier=(36.5879,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00438732,'amu*angstrom^2'), symmetry=1, barrier=(7.43325,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.429994,'amu*angstrom^2'), symmetry=1, barrier=(36.5879,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (103.097,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.97795,0.0477238,-2.45893e-05,5.07018e-09,-3.45321e-13,-48751.7,25.0672], Tmin=(100,'K'), Tmax=(2160.64,'K')), NASAPolynomial(coeffs=[21.2462,0.0184994,-8.77625e-06,1.57201e-09,-1.00347e-13,-58582.8,-86.2175], Tmin=(2160.64,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-405.924,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cds-OdOsH) + radical(CCOJ)"""),
)
...
species(
    ...
    molecularWeight = (104.105,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.7081,0.0564286,-3.58108e-05,1.09104e-08,-1.38693e-12,-23820.8,26.0072], Tmin=(100,'K'), Tmax=(1659.59,'K')), NASAPolynomial(coeffs=[10.5746,0.0350583,-1.64954e-05,3.1513e-09,-2.18108e-13,-26763.7,-21.2601], Tmin=(1659.59,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-198.69,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-OsOsHH) + radical(CCOJ) + radical(OCOJ)"""),
)

species(
    label = 'CC[C](O)O[CH]O(11565)',
    structure = SMILES('CC[C](O)O[CH]O'),
    E0 = (-257.587,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (104.105,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.379383,0.0834331,-0.000104077,7.03429e-08,-1.9161e-11,-30853.4,29.9547], Tmin=(100,'K'), Tmax=(893.389,'K')), NASAPolynomial(coeffs=[12.4754,0.0292753,-1.31464e-05,2.48878e-09,-1.73241e-13,-33014.7,-27.038], Tmin=(893.389,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-257.587,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(332.579,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-OsOsHH) + radical(Cs_P) + radical(OCJO)"""),
)

species(
    label = 'CC[C]([O])OCO(11566)',
    structure = SMILES('CC[C]([O])OCO'),
    E0 = (-220.842,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,360,370,350,3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (104.105,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.420672,0.0688373,-5.21554e-05,1.34906e-08,9.61539e-13,-26423.6,30.8664], Tmin=(100,'K'), Tmax=(1035.59,'K')), NASAPolynomial(coeffs=[17.4514,0.0206841,-7.94176e-06,1.46528e-09,-1.03558e-13,-30896.3,-56.4569], Tmin=(1035.59,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-220.842,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-OsOsHH) + radical(CCOJ) + radical(Cs_P)"""),
)

species(
    label = 'C[CH]C(O)O[CH]O(11567)',
    structure = SMILES('C[CH]C(O)O[CH]O'),
    E0 = (-262.931,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3050,390,425,1340,1360,335,370,2750,2800,2850,1350,1500,750,1050,1375,1000,3580,3650,1210,1345,900,1100,1380,1390,370,380,2900,435,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (104.105,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.504803,0.0779359,-8.68971e-05,5.14564e-08,-1.22404e-11,-31498.2,31.308], Tmin=(100,'K'), Tmax=(1019.33,'K')), NASAPolynomial(coeffs=[13.5572,0.0267168,-1.15258e-05,2.16199e-09,-1.50531e-13,-34159.2,-31.912], Tmin=(1019.33,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-262.931,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(332.579,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-OsOsHH) + radical(OCJO) + radical(CCJCO)"""),
)

species(
    label = '[CH2]CC(O)O[CH]O(11568)',
    structure = SMILES('[CH2]CC(O)O[CH]O'),
    E0 = (-257.587,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3025,407.5,1350,352.5,3580,3650,1210,1345,900,1100,3000,3100,440,815,1455,1000,1380,1390,370,380,2900,435,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (104.105,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.379384,0.0834331,-0.000104077,7.03429e-08,-1.9161e-11,-30853.4,31.0533], Tmin=(100,'K'), Tmax=(893.394,'K')), NASAPolynomial(coeffs=[12.4754,0.0292753,-1.31464e-05,2.48878e-09,-1.73241e-13,-33014.7,-25.9394], Tmin=(893.394,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-257.587,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(332.579,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-OsOsHH) + radical(OCJO) + radical(RCCJ)"""),
)

species(
    label = 'C[CH]C([O])OCO(11569)',
    structure = SMILES('C[CH]C([O])OCO'),
    E0 = (-226.186,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,3615,1277.5,1000,1380,1390,370,380,2900,435,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (104.105,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.601964,0.0626282,-3.22808e-05,-9.07671e-09,9.48823e-12,-27070.8,32.0231], Tmin=(100,'K'), Tmax=(987.456,'K')), NASAPolynomial(coeffs=[17.9598,0.0191179,-6.90131e-06,1.27696e-09,-9.24281e-14,-31805.5,-58.1159], Tmin=(987.456,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-226.186,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-OsOsHH) + radical(CCJCO) + radical(CCOJ)"""),
)

species(
    label = 'CCC(O)O[CH][O](11570)',
    structure = SMILES('CCC(O)O[CH][O]'),
    E0 = (-235.435,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,3615,1277.5,1000,1380,1390,370,380,2900,435,200,800,1066.67,1333.33,1600],'cm^-1')),
    ...
    molecularWeight = (104.105,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.73753,0.0819462,-0.000126538,1.20384e-07,-4.55657e-11,-28208.7,28.4413], Tmin=(100,'K'), Tmax=(810.898,'K')), NASAPolynomial(coeffs=[3.82737,0.0463865,-2.31751e-05,4.50651e-09,-3.1431e-13,-28041.8,18.3013], Tmin=(810.898,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-235.435,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-OsOsHH) + radical(OCOJ) + radical(OCJO)"""),
)

species(
    label = '[CH2]CC([O])OCO(11571)',
    structure = SMILES('[CH2]CC([O])OCO'),
    E0 = (-220.842,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3615,1277.5,1000,3000,3100,440,815,1455,1000,1380,1390,370,380,2900,435,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (104.105,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.420672,0.0688373,-5.21554e-05,1.34906e-08,9.61539e-13,-26423.6,31.965], Tmin=(100,'K'), Tmax=(1035.59,'K')), NASAPolynomial(coeffs=[17.4514,0.0206841,-7.94176e-06,1.46528e-09,-1.03558e-13,-30896.3,-55.3582], Tmin=(1035.59,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-220.842,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-OsOsHH) + radical(CCOJ) + radical(RCCJ)"""),
)
...
species(
    label = 'CCC(=O)OCO(11572)',
    structure = SMILES('CCC(=O)OCO'),
    E0 = (-643.313,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (104.105,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.864951,0.0539409,-4.14371e-06,-3.95899e-08,2.07391e-11,-77246.3,26.5], Tmin=(100,'K'), Tmax=(960.664,'K')), NASAPolynomial(coeffs=[17.9759,0.0189656,-6.1673e-06,1.11683e-09,-8.21781e-14,-82207.5,-64.0751], Tmin=(960.664,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-643.313,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cs-OsOsHH) + group(Cds-OdCsOs)"""),
)

species(
    label = 'CCC(O)OC=O(11573)',
    structure = SMILES('CCC(O)OC=O'),
    E0 = (-631.629,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (104.105,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.962489,0.0579135,-3.73414e-05,1.14715e-08,-1.3983e-12,-75850.5,27.8706], Tmin=(100,'K'), Tmax=(1900.84,'K')), NASAPolynomial(coeffs=[17.7754,0.022533,-9.42144e-06,1.67921e-09,-1.104e-13,-82242.2,-64.0407], Tmin=(1900.84,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-631.629,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cds-OdOsH)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'CCC([O])OC=O(11562)'],
    products = ['CCC([O])O[CH]O(11394)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'CCC(=O)O[CH]O(11563)'],
    products = ['CCC([O])O[CH]O(11394)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['C2H5(29)', 'O=CO[CH]O(4540)'],
    products = ['CCC([O])O[CH]O(11394)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction9',
    reactants = ['C[CH]C(O)O[CH]O(11567)'],
    products = ['CCC([O])O[CH]O(11394)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]CC(O)O[CH]O(11568)'],
    products = ['CCC([O])O[CH]O(11394)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CH2(S)(23)', 'CC([O])O[CH]O(1196)'],
    products = ['CCC([O])O[CH]O(11394)'],
...
reaction(
    label = 'reaction19',
    reactants = ['HCOH(T)(285)', 'CCC([O])[O](3172)'],
    products = ['CCC([O])O[CH]O(11394)'],
