...
species(
    label = 'C=CC(CC)OO(31603)',
    structure = SMILES('C=CC(CC)OO'),
    E0 = (-141.604,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,3615,1310,387.5,850,1000,2750,2850,1437.5,1250,1305,750,350,1380,1390,370,380,2900,435,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.163023,'amu*angstrom^2'), symmetry=1, barrier=(3.74821,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0220571,'amu*angstrom^2'), symmetry=1, barrier=(19.5939,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.852214,'amu*angstrom^2'), symmetry=1, barrier=(19.5941,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.852217,'amu*angstrom^2'), symmetry=1, barrier=(19.5941,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.852222,'amu*angstrom^2'), symmetry=1, barrier=(19.5943,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (102.132,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.369509,0.0694482,-4.61161e-05,1.26606e-08,-6.29882e-13,-16891.7,29.3951], Tmin=(100,'K'), Tmax=(1218.27,'K')), NASAPolynomial(coeffs=[15.9931,0.030123,-1.24379e-05,2.29777e-09,-1.58692e-13,-21586.9,-52.7107], Tmin=(1218.27,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-141.604,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH)"""),
)
...
species(
    ...
    molecularWeight = (102.132,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.794757,0.0764362,-7.78494e-05,5.07547e-08,-1.47583e-11,14915.2,28.5749], Tmin=(100,'K'), Tmax=(805.129,'K')), NASAPolynomial(coeffs=[6.87209,0.0462425,-2.15958e-05,4.17444e-09,-2.94466e-13,13936.6,0.572615], Tmin=(805.129,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(123.096,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(C2CsJOOH) + radical(RCCJ)"""),
)
...
species(
    label = '[CH2]CC([CH]C)OO(31605)',
    structure = SMILES('[CH2]CC([CH]C)OO'),
    E0 = (136.612,'kJ/mol'),
    modes = [
...
species(
    ...
    molecularWeight = (103.14,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.603805,0.0738523,-5.84659e-05,2.53678e-08,-4.63626e-12,-32353.3,28.9068], Tmin=(100,'K'), Tmax=(1264.79,'K')), NASAPolynomial(coeffs=[11.9527,0.0379607,-1.59e-05,2.93159e-09,-2.0151e-13,-35224.1,-28.511], Tmin=(1264.79,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-270.021,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CC(C)OJ)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['H(3)', 'C=CC(CC)OO(31603)'],
    products = ['[CH2]CC(CC)OO(2965)'],
...
reaction(
    label = 'reaction2',
    reactants = ['CC[CH]OO(288)', 'C2H4(21)'],
    products = ['[CH2]CC(CC)OO(2965)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]CC(CC)OO(2965)'],
    products = ['C[CH]C(CC)OO(31606)'],
...
reaction(
    label = 'reaction3',
    reactants = ['OH(5)', '[CH2]CC([O])CC(10552)'],
    products = ['[CH2]CC(CC)OO(2965)'],
...
reaction(
    label = 'reaction4',
    reactants = ['[CH2]C[CH]CC(135)', 'HO2(10)'],
    products = ['[CH2]CC(CC)OO(2965)'],
...
reaction(
    label = 'reaction6',
    reactants = ['C2H5(29)', '[CH2]C[CH]OO(468)'],
    products = ['[CH2]CC(CC)OO(2965)'],
...
reaction(
    label = 'reaction7',
    reactants = ['CC[CH]OO(288)', 'C2H4(T)(94)'],
    products = ['[CH2]CC(CC)OO(2965)'],
...
reaction(
    label = 'reaction8',
    reactants = ['H(3)', '[CH2]C[C](CC)OO(31604)'],
    products = ['[CH2]CC(CC)OO(2965)'],
...
reaction(
    label = 'reaction9',
    reactants = ['CH3(17)', '[CH2]CC([CH2])OO(2134)'],
    products = ['[CH2]CC(CC)OO(2965)'],
...
reaction(
    label = 'reaction10',
    reactants = ['H(3)', '[CH2]CC([CH]C)OO(31605)'],
    products = ['[CH2]CC(CC)OO(2965)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(3)', '[CH2][CH]C(CC)OO(11109)'],
    products = ['[CH2]CC(CC)OO(2965)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(3)', '[CH2]CC(C[CH2])OO(2136)'],
    products = ['[CH2]CC(CC)OO(2965)'],
...
reaction(
    label = 'reaction27',
    reactants = ['CH2(S)(23)', '[CH2]CC(C)OO(2102)'],
    products = ['[CH2]CC(CC)OO(2965)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CH2(19)', '[CH2]C(CC)OO(715)'],
    products = ['[CH2]CC(CC)OO(2965)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(3)', '[CH]CC(CC)OO(31609)'],
    products = ['[CH2]CC(CC)OO(2965)'],
