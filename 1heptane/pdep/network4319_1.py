...
species(
    label = 'CC#CCO[O](26152)',
    structure = SMILES('CC#CCO[O]'),
    E0 = (200.267,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2100,2250,500,550,492.5,1135,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,180],'cm^-1')),
        HinderedRotor(inertia=(0.301186,'amu*angstrom^2'), symmetry=1, barrier=(6.92485,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.306875,'amu*angstrom^2'), symmetry=1, barrier=(7.05566,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.71247,'amu*angstrom^2'), symmetry=1, barrier=(62.3649,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (85.0813,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.87428,0.0476247,-5.26855e-05,3.64561e-08,-1.03217e-11,24162.2,21.1075], Tmin=(100,'K'), Tmax=(963.325,'K')), NASAPolynomial(coeffs=[6.82487,0.0230547,-8.17752e-06,1.32928e-09,-8.31764e-14,23394.6,-1.62464], Tmin=(963.325,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(200.267,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CtOsHH) + group(Cs-CtHHH) + group(Ct-CtCs) + group(Ct-CtCs) + radical(ROOJ)"""),
)
...
species(
    ...
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.47048,0.0504214,-3.81161e-05,1.44014e-08,-2.19496e-12,29394,23.6467], Tmin=(100,'K'), Tmax=(1535.73,'K')), NASAPolynomial(coeffs=[13.0808,0.0201811,-8.57964e-06,1.57955e-09,-1.07729e-13,25828,-37.3472], Tmin=(1535.73,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(243.604,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Cds_S) + radical(C=CCJO)"""),
)
...
species(
    label = 'C[C]=[C]COO(26155)',
    structure = SMILES('C[C]=[C]COO'),
    E0 = (364.151,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,1670,1700,300,440,3615,1310,387.5,850,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,180],'cm^-1')),
        HinderedRotor(inertia=(0.312825,'amu*angstrom^2'), symmetry=1, barrier=(7.19247,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.312849,'amu*angstrom^2'), symmetry=1, barrier=(7.19301,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.312792,'amu*angstrom^2'), symmetry=1, barrier=(7.19171,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.79769,'amu*angstrom^2'), symmetry=1, barrier=(41.3323,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.41273,0.0641119,-9.71953e-05,8.91208e-08,-3.25152e-11,43883.4,23.7207], Tmin=(100,'K'), Tmax=(825.039,'K')), NASAPolynomial(coeffs=[4.82323,0.0335704,-1.62027e-05,3.09837e-09,-2.13866e-13,43797.4,10.8119], Tmin=(825.039,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(364.151,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Cds_S) + radical(Cds_S)"""),
)
...
species(
    ...
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.39709,0.0542959,-4.84042e-05,2.25109e-08,-4.23258e-12,7601.66,21.2708], Tmin=(100,'K'), Tmax=(1268.92,'K')), NASAPolynomial(coeffs=[12.0878,0.0205957,-8.56688e-06,1.58116e-09,-1.09046e-13,4888.52,-32.8519], Tmin=(1268.92,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(62.4046,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cdd-CdsCds)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'CC=C=CO[O](26151)'],
    products = ['CC=[C]CO[O](18412)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['CH3(17)', 'C#CCO[O](26153)'],
    products = ['CC=[C]CO[O](18412)'],
    transitionState = 'TS4',
...
reaction(
    ...
    products = ['CC=[C]CO[O](18412)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(1.973e+06,'cm^3/(mol*s)'), n=2.037, Ea=(141.32,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Cds-HH_Ca;OJ] for rate rule [Cds-HH_Ca;O2b]
Euclidian distance = 1.0
Multiplied by reaction path degeneracy 2.0
family: R_Addition_MultipleBond
Ea raised from -6.0 to 141.3 kJ/mol to match endothermicity of reaction."""),
)
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2]O[O](92)', '[C]=CC(24199)'],
    products = ['CC=[C]CO[O](18412)'],
