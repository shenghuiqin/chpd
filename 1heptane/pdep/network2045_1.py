...
species(
    label = 'C=C(CCC)O[CH]CC(10804)',
    structure = SMILES('C=C(CCC)O[CH]CC'),
    E0 = (-103.577,'kJ/mol'),
    modes = [
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.68693,0.110719,-8.55643e-05,2.85936e-08,-2.10168e-12,-12240.5,37.9781], Tmin=(100,'K'), Tmax=(1081.31,'K')), NASAPolynomial(coeffs=[23.1759,0.0393198,-1.50583e-05,2.71974e-09,-1.87712e-13,-18820.1,-89.4761], Tmin=(1081.31,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-103.577,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(552.912,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(CCsJOC(O))"""),
)

species(
    label = '[CH2]C(CCC)OC=CC(10805)',
    structure = SMILES('[CH2]C(CCC)OC=CC'),
    E0 = (-95.0062,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (127.204,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.75123,0.112437,-8.70449e-05,2.75502e-08,-9.83121e-13,-11207.4,37.2734], Tmin=(100,'K'), Tmax=(1038.87,'K')), NASAPolynomial(coeffs=[23.4361,0.0387983,-1.44218e-05,2.57359e-09,-1.77149e-13,-17700.2,-91.2633], Tmin=(1038.87,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-95.0062,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(552.912,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(CJC(C)OC)"""),
)
...
species(
    label = 'CC[CH]O[C](C)CCC(10806)',
    structure = SMILES('CC[CH]O[C](C)CCC'),
    E0 = (-17.885,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.212,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.13201,0.120431,-0.000131789,8.94686e-08,-2.60809e-11,-1973.05,37.4532], Tmin=(100,'K'), Tmax=(817.298,'K')), NASAPolynomial(coeffs=[10.3372,0.0643,-2.87729e-05,5.44077e-09,-3.78482e-13,-3847.83,-15.5652], Tmin=(817.298,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-17.885,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(573.699,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCsJOCs) + radical(C2CsJOCs)"""),
)

species(
    label = '[CH2]C(CCC)OC[CH]C(10807)',
    structure = SMILES('[CH2]C(CCC)OC[CH]C'),
    E0 = (31.3673,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3025,407.5,1350,352.5,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2][C](CCC)OCCC(10808)',
    structure = SMILES('[CH2][C](CCC)OCCC'),
    E0 = (12.1691,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.212,'amu'),
...
species(
    label = 'C[CH]CC(C)O[CH]CC(10811)',
    structure = SMILES('C[CH]CC(C)O[CH]CC'),
    E0 = (-4.14252,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.212,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.681463,0.108212,-9.49009e-05,4.96232e-08,-1.13438e-11,-334.051,38.6198], Tmin=(100,'K'), Tmax=(1012.04,'K')), NASAPolynomial(coeffs=[10.841,0.0626698,-2.7398e-05,5.15554e-09,-3.5888e-13,-2666.23,-17.107], Tmin=(1012.04,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-4.14252,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(573.699,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJC) + radical(CCsJOCs)"""),
)

species(
    label = '[CH2]C([CH]CC)OCCC(10812)',
    structure = SMILES('[CH2]C([CH]CC)OCCC'),
    E0 = (31.3673,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3025,407.5,1350,352.5,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'C[CH][CH]OC(C)CCC(10813)',
    structure = SMILES('C[CH][CH]OC(C)CCC'),
    E0 = (1.31325,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.212,'amu'),
...
species(
    label = '[CH2]CCC(C)O[CH]CC(10814)',
    structure = SMILES('[CH2]CCC(C)O[CH]CC'),
    E0 = (6.65755,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.212,'amu'),
...
species(
    label = '[CH2]C(C[CH]C)OCCC(10815)',
    structure = SMILES('[CH2]C(C[CH]C)OCCC'),
    E0 = (25.9115,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3025,407.5,1350,352.5,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2]CCC([CH2])OCCC(10816)',
    structure = SMILES('[CH2]CCC([CH2])OCCC'),
    E0 = (36.7116,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,1380,1390,370,380,2900,435,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2]C[CH]OC(C)CCC(10817)',
    structure = SMILES('[CH2]C[CH]OC(C)CCC'),
    E0 = (6.65755,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.212,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.988776,0.110638,-9.32395e-05,4.34983e-08,-8.55638e-12,979.462,38.7598], Tmin=(100,'K'), Tmax=(1182.95,'K')), NASAPolynomial(coeffs=[15.1596,0.0560352,-2.40029e-05,4.4795e-09,-3.10397e-13,-2841.11,-41.8598], Tmin=(1182.95,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(6.65755,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(573.699,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJ) + radical(CCsJOCs)"""),
)
...
species(
    label = 'C=C(CCC)OCCC(10818)',
    structure = SMILES('C=C(CCC)OCCC'),
    E0 = (-297.504,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.212,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.29439,0.101013,-5.75428e-05,4.38692e-09,5.03114e-12,-35577.7,37.0964], Tmin=(100,'K'), Tmax=(1068.93,'K')), NASAPolynomial(coeffs=[20.6557,0.0458317,-1.7938e-05,3.27973e-09,-2.27925e-13,-41810.5,-77.4673], Tmin=(1068.93,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-297.504,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(577.856,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH)"""),
)

species(
    label = 'CC=COC(C)CCC(10819)',
    structure = SMILES('CC=COC(C)CCC'),
    E0 = (-305.516,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.212,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.33916,0.098971,-4.11549e-05,-2.01583e-08,1.55906e-11,-36536.6,36.0418], Tmin=(100,'K'), Tmax=(998.756,'K')), NASAPolynomial(coeffs=[22.9006,0.0418916,-1.55045e-05,2.82028e-09,-1.98715e-13,-43373.6,-90.8585], Tmin=(998.756,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-305.516,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(577.856,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH)"""),
)
...
species(
    label = 'CCCC1CC(CC)O1(10736)',
    structure = SMILES('CCCC1CC(CC)O1'),
    E0 = (-240.507,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.212,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.297718,0.0771985,6.84244e-06,-6.22554e-08,3.0096e-11,-28755.7,32.0433], Tmin=(100,'K'), Tmax=(939.452,'K')), NASAPolynomial(coeffs=[16.6352,0.0482276,-1.57592e-05,2.64798e-09,-1.7904e-13,-33840.4,-58.7195], Tmin=(939.452,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-240.507,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(586.17,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Oxetane)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(CCC)O[CH]CC(10735)'],
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'C=C(CCC)O[CH]CC(10804)'],
    products = ['[CH2]C(CCC)O[CH]CC(10735)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', '[CH2]C(CCC)OC=CC(10805)'],
    products = ['[CH2]C(CCC)O[CH]CC(10735)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['npropyl(83)', 'C=CO[CH]CC(10587)'],
    products = ['[CH2]C(CCC)O[CH]CC(10735)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['CH3(17)', '[CH2]C(CCC)OC=C(1226)'],
    products = ['[CH2]C(CCC)O[CH]CC(10735)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2]C(CCC)O[CH]CC(10735)'],
    products = ['CC[CH]O[C](C)CCC(10806)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]C(CCC)OC[CH]C(10807)'],
    products = ['[CH2]C(CCC)O[CH]CC(10735)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]C(CCC)O[CH]CC(10735)'],
    products = ['CC[CH]OC(C)[CH]CC(10809)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]CCOC([CH2])CCC(10810)'],
    products = ['[CH2]C(CCC)O[CH]CC(10735)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]C(CCC)O[CH]CC(10735)'],
    products = ['C[CH]CC(C)O[CH]CC(10811)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2]C([CH]CC)OCCC(10812)'],
    products = ['[CH2]C(CCC)O[CH]CC(10735)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]C(CCC)O[CH]CC(10735)'],
    products = ['C[CH][CH]OC(C)CCC(10813)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]C(CCC)O[CH]CC(10735)'],
    products = ['[CH2]CCC(C)O[CH]CC(10814)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]C(C[CH]C)OCCC(10815)'],
    products = ['[CH2]C(CCC)O[CH]CC(10735)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]CCC([CH2])OCCC(10816)'],
    products = ['[CH2]C(CCC)O[CH]CC(10735)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2]C(CCC)O[CH]CC(10735)'],
    products = ['[CH2]C[CH]OC(C)CCC(10817)'],
...
reaction(
    label = 'reaction22',
    reactants = ['CH2(S)(23)', '[CH2]C(CC)O[CH]CC(10723)'],
    products = ['[CH2]C(CCC)O[CH]CC(10735)'],
...
reaction(
    label = 'reaction23',
    reactants = ['CH2(S)(23)', '[CH2]C(CCC)O[CH]C(1216)'],
    products = ['[CH2]C(CCC)O[CH]CC(10735)'],
...
reaction(
    label = 'reaction27',
    reactants = ['[CH]CC(144)', '[CH2]C([O])CCC(1786)'],
    products = ['[CH2]C(CCC)O[CH]CC(10735)'],
...
reaction(
    label = 'reaction28',
    reactants = ['CH2(19)', 'CC[CH]O[CH]CCC(10821)'],
    products = ['[CH2]C(CCC)O[CH]CC(10735)'],
