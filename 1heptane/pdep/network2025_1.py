...
species(
    label = 'CC=COC[CH]O(11144)',
    structure = SMILES('CC=COC[CH]O'),
    E0 = (-201.062,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (101.124,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.390634,0.0851715,-8.62454e-05,4.40077e-08,-8.71037e-12,-24014.4,28.504], Tmin=(100,'K'), Tmax=(1262.33,'K')), NASAPolynomial(coeffs=[20.3825,0.0183992,-5.77537e-06,9.14938e-10,-5.82382e-14,-29183.5,-76.2548], Tmin=(1262.33,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-201.062,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(CCsJOH)"""),
)

species(
    label = 'CC[CH]OC=CO(11145)',
    ...
    molecularWeight = (101.124,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.577838,0.0784607,-2.53933e-05,-5.19723e-08,3.42252e-11,-26773.6,26.6944], Tmin=(100,'K'), Tmax=(907.191,'K')), NASAPolynomial(coeffs=[30.825,0.000113489,4.75348e-06,-1.08248e-09,7.20491e-14,-34945,-135.381], Tmin=(907.191,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-224.152,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + radical(CCsJOC(O))"""),
)
...
species(
    ...
    molecularWeight = (102.132,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.62614,0.0657956,1.74723e-06,-1.73732e-07,1.8503e-10,-6041.18,25.0875], Tmin=(100,'K'), Tmax=(431.815,'K')), NASAPolynomial(coeffs=[6.64515,0.0458466,-2.11595e-05,3.9837e-09,-2.7303e-13,-6722.11,2.22293], Tmin=(431.815,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-50.8195,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCsJOCs) + radical(CCOJ)"""),
)

species(
    label = 'C[CH]COC[CH]O(11147)',
    structure = SMILES('C[CH]COC[CH]O'),
    E0 = (-76.7807,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3050,390,425,1340,1360,335,370,3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (102.132,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.432254,0.0836335,-9.90724e-05,7.10788e-08,-2.14683e-11,-9110.83,30.7973], Tmin=(100,'K'), Tmax=(796.471,'K')), NASAPolynomial(coeffs=[8.97356,0.0407355,-1.82781e-05,3.44837e-09,-2.39075e-13,-10471.3,-8.46545], Tmin=(796.471,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-76.7807,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCsJOH) + radical(CCJCO)"""),
)

species(
    label = 'CC[CH]O[CH]CO(11148)',
    structure = SMILES('CC[CH]O[CH]CO'),
    E0 = (-96.0686,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3050,390,425,1340,1360,335,370,3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (102.132,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.18726,0.0952775,-0.000119008,8.12914e-08,-2.22865e-11,-11406.4,29.8629], Tmin=(100,'K'), Tmax=(890.516,'K')), NASAPolynomial(coeffs=[13.7205,0.0328066,-1.37803e-05,2.51483e-09,-1.71045e-13,-13883.4,-35.6216], Tmin=(890.516,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-96.0686,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCsJOCs) + radical(CCsJOCs)"""),
)

species(
    label = 'CCCO[CH][CH]O(11149)',
    structure = SMILES('CCCO[CH][CH]O'),
    E0 = (-96.2267,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3050,390,425,1340,1360,335,370,3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2]CCOC[CH]O(11150)',
    structure = SMILES('[CH2]CCOC[CH]O'),
    E0 = (-71.4364,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (102.132,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.162447,0.0910662,-0.000124161,1.01948e-07,-3.43217e-11,-8460.01,31.0456], Tmin=(100,'K'), Tmax=(807.36,'K')), NASAPolynomial(coeffs=[8.47702,0.0422394,-1.92647e-05,3.62081e-09,-2.4869e-13,-9553.81,-5.74762], Tmin=(807.36,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-71.4364,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCsJOH) + radical(RCCJ)"""),
)

species(
    label = 'C[CH][CH]OCCO(11151)',
    structure = SMILES('C[CH][CH]OCCO'),
    E0 = (-76.6226,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3050,390,425,1340,1360,335,370,3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (102.132,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.401113,0.0819287,-8.71833e-05,5.26878e-08,-1.3173e-11,-9088.3,30.8038], Tmin=(100,'K'), Tmax=(959.725,'K')), NASAPolynomial(coeffs=[11.4065,0.0360588,-1.54897e-05,2.88536e-09,-1.99595e-13,-11200.7,-21.8383], Tmin=(959.725,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-76.6226,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCJCO) + radical(CCsJOCs)"""),
)

species(
    label = 'CCCOC[CH][O](11152)',
    structure = SMILES('CCCOC[CH][O]'),
    E0 = (-50.9776,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (102.132,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.449073,0.0880895,-0.00012804,1.179e-07,-4.35785e-11,-6013.01,29.0876], Tmin=(100,'K'), Tmax=(823.586,'K')), NASAPolynomial(coeffs=[4.02872,0.0508833,-2.4177e-05,4.60477e-09,-3.17581e-13,-5930.43,16.5936], Tmin=(823.586,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-50.9776,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(CCsJOH)"""),
)

species(
    label = '[CH2]C[CH]OCCO(11153)',
    structure = SMILES('[CH2]C[CH]OCCO'),
    E0 = (-71.2783,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3615,1277.5,1000,3000,3100,440,815,1455,1000,3025,407.5,1350,352.5,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (102.132,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.199197,0.0883896,-0.000108023,7.67453e-08,-2.24972e-11,-8440.28,30.8193], Tmin=(100,'K'), Tmax=(825.754,'K')), NASAPolynomial(coeffs=[10.5582,0.0382103,-1.68714e-05,3.15499e-09,-2.1752e-13,-10151.1,-17.1735], Tmin=(825.754,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-71.2783,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(RCCJ) + radical(CCsJOCs)"""),
)
...
species(
    label = 'CCCOC=CO(11154)',
    structure = SMILES('CCCOC=CO'),
    E0 = (-418.08,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (102.132,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.215118,0.0691349,1.1415e-06,-7.39857e-08,4.02837e-11,-50109.7,25.9179], Tmin=(100,'K'), Tmax=(915.883,'K')), NASAPolynomial(coeffs=[28.317,0.00660182,1.88849e-06,-5.26192e-10,3.21544e-14,-57939.7,-123.44], Tmin=(915.883,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-418.08,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsOsH)"""),
)

species(
    label = 'CC=COCCO(11155)',
    structure = SMILES('CC=COCCO'),
    E0 = (-381.36,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (102.132,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.13065,0.0735263,-4.52185e-05,-4.7522e-10,7.42423e-12,-45717.3,27.0804], Tmin=(100,'K'), Tmax=(972.449,'K')), NASAPolynomial(coeffs=[18.5767,0.0235384,-8.04249e-06,1.41297e-09,-9.86624e-14,-50528.9,-67.6891], Tmin=(972.449,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-381.36,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH)"""),
)

species(
    label = 'CCCOCC=O(11156)',
    structure = SMILES('CCCOCC=O'),
    E0 = (-363.742,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (102.132,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.03732,0.0644353,-4.27334e-05,1.4406e-08,-2.02746e-12,-43641.5,26.0677], Tmin=(100,'K'), Tmax=(1576.81,'K')), NASAPolynomial(coeffs=[12.3744,0.0356757,-1.53746e-05,2.83874e-09,-1.93482e-13,-47216.8,-33.7898], Tmin=(1576.81,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-363.742,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-O2d)OsHH) + group(Cs-CsHHH) + group(Cds-OdCsH)"""),
)
...
species(
    label = '[CH2]C(C)OC[CH]O(11157)',
    structure = SMILES('[CH2]C(C)OC[CH]O'),
    E0 = (-76.7236,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (102.132,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.282351,0.10155,-0.000148452,1.22437e-07,-4.02541e-11,-9080.56,30.2621], Tmin=(100,'K'), Tmax=(839.66,'K')), NASAPolynomial(coeffs=[10.5707,0.0390749,-1.75983e-05,3.26202e-09,-2.21185e-13,-10523.4,-17.9393], Tmin=(839.66,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-76.7236,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCsJOH) + radical(CJC(C)OC)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'CC[CH]OCC=O(11143)'],
    products = ['CC[CH]OC[CH]O(10717)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'CC=COC[CH]O(11144)'],
    products = ['CC[CH]OC[CH]O(10717)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', 'CC[CH]OC=CO(11145)'],
    products = ['CC[CH]OC[CH]O(10717)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['CH3(17)', 'C=COC[CH]O(4708)'],
    products = ['CC[CH]OC[CH]O(10717)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction19',
    reactants = ['CH2(S)(23)', 'C[CH]OC[CH]O(1185)'],
    products = ['CC[CH]OC[CH]O(10717)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2]C(C)OC[CH]O(11157)'],
    products = ['CC[CH]OC[CH]O(10717)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH]CC(144)', '[O]C[CH]O(1827)'],
    products = ['CC[CH]OC[CH]O(10717)'],
...
reaction(
    label = 'reaction23',
    reactants = ['HCOH(T)(285)', '[CH2]O[CH]CC(1682)'],
    products = ['CC[CH]OC[CH]O(10717)'],
