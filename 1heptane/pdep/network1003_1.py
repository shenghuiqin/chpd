...
species(
    label = 'CC[CH]CCC=CCC(1607)',
    structure = SMILES('CC[CH]CCC=CCC'),
    E0 = (47.9247,'kJ/mol'),
    modes = [
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.146353,0.0904459,-5.00316e-05,1.3406e-08,-1.46444e-12,5912.3,38.9667], Tmin=(100,'K'), Tmax=(1976.24,'K')), NASAPolynomial(coeffs=[18.4139,0.0528795,-2.15183e-05,3.78742e-09,-2.47673e-13,-1423.67,-63.2191], Tmin=(1976.24,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(47.9247,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(602.799,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(RCCJCC)"""),
)

species(
    label = 'CC[CH]CC=CCCC(1608)',
    structure = SMILES('CC[CH]CC=CCCC'),
    E0 = (47.9247,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,2995,3025,975,1000,1300,1375,400,500,1630,1680,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3025,407.5,1350,352.5,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'CCC=CC[CH]CCC(1609)',
    structure = SMILES('CCC=CC[CH]CCC'),
    E0 = (47.9247,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,2995,3025,975,1000,1300,1375,400,500,1630,1680,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3025,407.5,1350,352.5,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'CC[CH]CCC[CH]CC(1611)',
    structure = SMILES('CC[CH]CCC[CH]CC'),
    E0 = (125.711,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2761.11,2772.22,2783.33,2794.44,2805.56,2816.67,2827.78,2838.89,2850,1425,1431.25,1437.5,1443.75,1450,1225,1237.5,1250,1262.5,1275,1270,1287.5,1305,1322.5,1340,700,725,750,775,800,300,325,350,375,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3000,3050,390,425,1340,1360,335,370,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'CC[CH][CH]CCCCC(1613)',
    structure = SMILES('CC[CH][CH]CCCCC'),
    E0 = (125.711,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2761.11,2772.22,2783.33,2794.44,2805.56,2816.67,2827.78,2838.89,2850,1425,1431.25,1437.5,1443.75,1450,1225,1237.5,1250,1262.5,1275,1270,1287.5,1305,1322.5,1340,700,725,750,775,800,300,325,350,375,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3000,3050,390,425,1340,1360,335,370,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2]CCCC[CH]CCC(1614)',
    structure = SMILES('[CH2]CCCC[CH]CCC'),
    E0 = (136.499,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (126.239,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0320686,0.0960235,-5.8271e-05,1.90633e-08,-2.83284e-12,16551.7,39.4025], Tmin=(100,'K'), Tmax=(1358.41,'K')), NASAPolynomial(coeffs=[8.29908,0.0716803,-3.13905e-05,5.87125e-09,-4.04995e-13,14305.7,-3.01336], Tmin=(1358.41,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(136.499,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(623.585,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(RCCJ)"""),
)

species(
    label = '[CH2]CCCCC[CH]CC(1615)',
    structure = SMILES('[CH2]CCCCC[CH]CC'),
    E0 = (136.499,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2759.09,2768.18,2777.27,2786.36,2795.45,2804.55,2813.64,2822.73,2831.82,2840.91,2850,1425,1430,1435,1440,1445,1450,1225,1235,1245,1255,1265,1275,1270,1284,1298,1312,1326,1340,700,720,740,760,780,800,300,320,340,360,380,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,3025,407.5,1350,352.5,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2]C[CH]CCCCCC(1616)',
    structure = SMILES('[CH2]C[CH]CCCCCC'),
    E0 = (136.499,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2759.09,2768.18,2777.27,2786.36,2795.45,2804.55,2813.64,2822.73,2831.82,2840.91,2850,1425,1430,1435,1440,1445,1450,1225,1235,1245,1255,1265,1275,1270,1284,1298,1312,1326,1340,700,720,740,760,780,800,300,320,340,360,380,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,3025,407.5,1350,352.5,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2]CC[CH]CCCCC(1617)',
    structure = SMILES('[CH2]CC[CH]CCCCC'),
    E0 = (136.499,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2759.09,2768.18,2777.27,2786.36,2795.45,2804.55,2813.64,2822.73,2831.82,2840.91,2850,1425,1430,1435,1440,1445,1450,1225,1235,1245,1255,1265,1275,1270,1284,1298,1312,1326,1340,700,720,740,760,780,800,300,320,340,360,380,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,3025,407.5,1350,352.5,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'CCC=CCCCCC(1618)',
    structure = SMILES('CCC=CCCCCC'),
    E0 = (-146.534,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (126.239,'amu'),
...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.70778,0.0726084,-3.2785e-05,6.20385e-09,-4.23475e-13,18038.8,31.124], Tmin=(100,'K'), Tmax=(2765.76,'K')), NASAPolynomial(coeffs=[46.2104,0.0165949,-6.93415e-06,1.06411e-09,-5.75424e-14,-9771.1,-234.621], Tmin=(2765.76,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(149.492,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(552.912,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(RCCJCC)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['CC[CH]CC[CH]CCC(1412)'],
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'CC[CH]CCC=CCC(1607)'],
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'CC[CH]CC=CCCC(1608)'],
    products = ['CC[CH]CC[CH]CCC(1412)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(1.46e+08,'cm^3/(mol*s)'), n=1.64, Ea=(5.73208,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""From training reaction 2555 used for Cds-CsH_Cds-CsH;HJ
Exact match found for rate rule [Cds-CsH_Cds-CsH;HJ]
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', 'CCC=CC[CH]CCC(1609)'],
    products = ['CC[CH]CC[CH]CCC(1412)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(1.46e+08,'cm^3/(mol*s)'), n=1.64, Ea=(5.73208,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""From training reaction 2555 used for Cds-CsH_Cds-CsH;HJ
Exact match found for rate rule [Cds-CsH_Cds-CsH;HJ]
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)', 'CC=CCC[CH]CCC(1610)'],
    products = ['CC[CH]CC[CH]CCC(1412)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(1.46e+08,'cm^3/(mol*s)'), n=1.64, Ea=(5.73208,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""From training reaction 2555 used for Cds-CsH_Cds-CsH;HJ
Exact match found for rate rule [Cds-CsH_Cds-CsH;HJ]
...
reaction(
    label = 'reaction6',
    reactants = ['C2H5(29)', 'C=CCC[CH]CC(1493)'],
    products = ['CC[CH]CC[CH]CCC(1412)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['CH3(17)', 'C=CCC[CH]CCC(614)'],
    products = ['CC[CH]CC[CH]CCC(1412)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['CC[CH]CCC[CH]CC(1611)'],
    products = ['CC[CH]CC[CH]CCC(1412)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]CCCC[CH]CCC(1614)'],
    products = ['CC[CH]CC[CH]CCC(1412)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2]CCCCC[CH]CC(1615)'],
    products = ['CC[CH]CC[CH]CCC(1412)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(1.52375e+06,'s^-1'), n=1.61967, Ea=(193.608,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [RnH;C_rad_out_H/NonDeC;Cs_H_out_H/NonDeC] for rate rule [R6HJ_3;C_rad_out_H/NonDeC;Cs_H_out_H/NonDeC]
...
reaction(
    label = 'reaction21',
    reactants = ['[CH2]C[CH]CCCCCC(1616)'],
    products = ['CC[CH]CC[CH]CCC(1412)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH2]CC[CH]CCCCC(1617)'],
    products = ['CC[CH]CC[CH]CCC(1412)'],
...
reaction(
    label = 'reaction27',
    reactants = ['CH2(S)(23)', 'CC[CH]CC[CH]CC(1408)'],
    products = ['CC[CH]CC[CH]CCC(1412)'],
...
reaction(
    label = 'reaction34',
    reactants = ['[CH]CCC(133)', '[CH2]C[CH]CC(135)'],
    products = ['CC[CH]CC[CH]CCC(1412)'],
...
reaction(
    label = 'reaction35',
    reactants = ['[CH]CC(144)', '[CH2]C[CH]CCC(203)'],
    products = ['CC[CH]CC[CH]CCC(1412)'],
