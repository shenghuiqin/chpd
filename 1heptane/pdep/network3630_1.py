...
species(
    label = 'CCC1OCC1([O])OC1CCC1[O](20449)',
    structure = SMILES('CCC1OCC1([O])OC1CCC1[O]'),
    E0 = (-170.108,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (186.205,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.99499,0.106228,-1.34053e-05,-6.8129e-08,3.69955e-11,-20220.1,44.2478], Tmin=(100,'K'), Tmax=(946.989,'K')), NASAPolynomial(coeffs=[27.8205,0.0433321,-1.36359e-05,2.33058e-09,-1.63596e-13,-28693.8,-112.896], Tmin=(946.989,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-170.108,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(640.214,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Cyclobutane) + ring(Oxetane) + radical(CC(C)(O)OJ) + radical(CC(C)OJ)"""),
)
...
species(
    label = '[CH2]OC(CC)C(=O)O[CH]CCC=O(20450)',
    ...
    molecularWeight = (186.205,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.1718,0.143994,-0.000147851,8.43499e-08,-2.01608e-11,-49657.6,51.1559], Tmin=(100,'K'), Tmax=(991.205,'K')), NASAPolynomial(coeffs=[16.8672,0.0671609,-3.15776e-05,6.14587e-09,-4.36064e-13,-53431.9,-40.5279], Tmin=(991.205,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-414.668,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(615.271,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-Cs(Cds-O2d)) + group(Cs-(Cds-O2d)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + group(Cds-OdCsOs) + group(Cds-OdCsH) + radical(CCsJOC(O)) + radical(CsJOCC2)"""),
)

species(
    label = 'CC[CH]OCC(=O)O[CH]CCC=O(20451)',
    structure = SMILES('CC[CH]OCC(=O)O[CH]CCC=O'),
    E0 = (-405.3,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,2782.5,750,1395,475,1775,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3050,390,425,1340,1360,335,370,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (186.205,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.64229,0.15673,-0.000187585,1.28243e-07,-3.64479e-11,-48516.5,50.5314], Tmin=(100,'K'), Tmax=(846.383,'K')), NASAPolynomial(coeffs=[15.8318,0.0694218,-3.28539e-05,6.36705e-09,-4.49057e-13,-51643.7,-35.5145], Tmin=(846.383,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-405.3,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(615.271,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-Cs(Cds-O2d)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-O2d)OsHH) + group(Cs-CsHHH) + group(Cds-OdCsOs) + group(Cds-OdCsH) + radical(CCsJOCs) + radical(CCsJOC(O))"""),
)
...
species(
    label = 'CCC1OCC1([O])OC=CCC=O(20452)',
    structure = SMILES('CCC1OCC1([O])OC=CCC=O'),
    E0 = (-373.394,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2782.5,750,1395,475,1775,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,2750,2950,3150,900,1000,1100,2750,2800,2850,1350,1500,750,1050,1375,1000,300,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.39037,0.111515,-2.09055e-05,-6.94771e-08,3.93796e-11,-44652.4,44.4856], Tmin=(100,'K'), Tmax=(949.96,'K')), NASAPolynomial(coeffs=[33.0828,0.0333581,-9.93604e-06,1.73427e-09,-1.27557e-13,-54605.1,-141.742], Tmin=(949.96,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-373.394,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(606.956,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-OdCsH) + ring(Oxetane) + radical(CC(C)(O)OJ)"""),
)
...
species(
    label = 'CCC1OCC1([O])OC[CH]CC=O(20453)',
    structure = SMILES('CCC1OCC1([O])OC[CH]CC=O'),
    E0 = (-256.43,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2782.5,750,1395,475,1775,1000,3025,407.5,1350,352.5,2750,2950,3150,900,1000,1100,2750,2800,2850,1350,1500,750,1050,1375,1000,300,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (186.205,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.5399,0.132961,-0.000116734,5.56793e-08,-1.07713e-11,-30596.8,50.0376], Tmin=(100,'K'), Tmax=(1240.67,'K')), NASAPolynomial(coeffs=[22.4616,0.0523536,-1.92768e-05,3.31075e-09,-2.18699e-13,-36800.5,-75.9715], Tmin=(1240.67,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-256.43,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(627.743,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + ring(Oxetane) + radical(CC(C)(O)OJ) + radical(CCJCO)"""),
)
...
species(
    label = 'CCC1OCC1([O])OCC[CH]C=O(20455)',
    structure = SMILES('CCC1OCC1([O])OCCC=C[O]'),
    E0 = (-313.08,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (186.205,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.64996,0.125931,-6.74703e-05,-1.64494e-08,2.01499e-11,-37396.8,47.647], Tmin=(100,'K'), Tmax=(937.177,'K')), NASAPolynomial(coeffs=[29.0624,0.0411182,-1.26137e-05,2.07066e-09,-1.40496e-13,-45560.3,-115.131], Tmin=(937.177,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-313.08,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(631.9,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsOsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + ring(Oxetane) + radical(C=COJ) + radical(CC(C)(O)OJ)"""),
)
...
species(
    label = 'CCC1O[CH]C1([O])OCCCC=O(20458)',
    structure = SMILES('CCC1O[CH]C1([O])OCCCC=O'),
    E0 = (-275.876,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (186.205,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.93565,0.144051,-0.000140763,7.43845e-08,-1.57705e-11,-32923.2,48.4054], Tmin=(100,'K'), Tmax=(1144.15,'K')), NASAPolynomial(coeffs=[23.7299,0.050825,-1.85392e-05,3.16599e-09,-2.08639e-13,-39025,-83.8307], Tmin=(1144.15,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-275.876,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(627.743,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + ring(Oxetane) + radical(CC(C)(O)OJ) + radical(CCsJOCs)"""),
)

species(
    label = 'CCC1OCC1([O])OCCC[C]=O(20459)',
    structure = SMILES('CCC1OCC1([O])OCCC[C]=O'),
    E0 = (-296.371,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (186.205,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.61152,0.138858,-0.000132591,6.96127e-08,-1.4809e-11,-35401.6,48.6159], Tmin=(100,'K'), Tmax=(1134.31,'K')), NASAPolynomial(coeffs=[21.5226,0.0537505,-2.0044e-05,3.46431e-09,-2.29763e-13,-40876.6,-70.858], Tmin=(1134.31,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-296.371,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(627.743,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + ring(Oxetane) + radical(CCCJ=O) + radical(CC(C)(O)OJ)"""),
)
...
species(
    label = 'C[CH]C1OCC1([O])OCCCC=O(20462)',
    structure = SMILES('C[CH]C1OCC1([O])OCCCC=O'),
    E0 = (-256.43,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2782.5,750,1395,475,1775,1000,3025,407.5,1350,352.5,2750,2950,3150,900,1000,1100,2750,2800,2850,1350,1500,750,1050,1375,1000,300,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2]CC1OCC1([O])OCCCC=O(20463)',
    structure = SMILES('[CH2]CC1OCC1([O])OCCCC=O'),
    E0 = (-251.085,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,2782.5,750,1395,475,1775,1000,2750,2950,3150,900,1000,1100,3000,3100,440,815,1455,1000,300,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (186.205,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.42747,0.135741,-0.000124833,6.33671e-08,-1.31478e-11,-29962.4,48.924], Tmin=(100,'K'), Tmax=(1154.82,'K')), NASAPolynomial(coeffs=[20.5013,0.0563223,-2.16756e-05,3.81527e-09,-2.55768e-13,-35258.2,-64.9945], Tmin=(1154.82,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-251.085,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(627.743,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + ring(Oxetane) + radical(RCCJ) + radical(CC(C)(O)OJ)"""),
)
...
species(
    label = 'CCC1OCC1([O])OC1CC[CH]O1(20466)',
    structure = SMILES('CCC1OCC1([O])OC1CC[CH]O1'),
    E0 = (-287.738,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (186.205,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.89705,0.104962,-5.02896e-06,-8.68901e-08,4.84689e-11,-34371.3,41.0215], Tmin=(100,'K'), Tmax=(894.034,'K')), NASAPolynomial(coeffs=[28.3476,0.0381485,-7.86676e-06,9.31917e-10,-5.50128e-14,-42517,-116.815], Tmin=(894.034,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-287.738,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(640.214,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Tetrahydrofuran) + ring(Oxetane) + radical(CC(C)(O)OJ) + radical(CCsJOCs)"""),
)
...
species(
    label = 'CC1OCC1([O])O[CH]CCC=O(20468)',
    structure = SMILES('CC1OCC1([O])O[CH]CCC=O'),
    E0 = (-252.096,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2782.5,750,1395,475,1775,1000,3025,407.5,1350,352.5,2750,2950,3150,900,1000,1100,2750,2800,2850,1350,1500,750,1050,1375,1000,300,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.33047,0.129751,-0.000128582,6.84292e-08,-1.45055e-11,-30084.1,43.9878], Tmin=(100,'K'), Tmax=(1149.63,'K')), NASAPolynomial(coeffs=[22.7314,0.0425529,-1.48097e-05,2.4544e-09,-1.58769e-13,-35846.6,-80.4165], Tmin=(1149.63,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-252.096,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(557.07,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + ring(Oxetane) + radical(CCsJOCs) + radical(CC(C)(O)OJ)"""),
)
...
species(
    label = '[CH2]C(CC=O)OC1([O])COC1CC(20469)',
    structure = SMILES('[CH2]C(CC=O)OC1([O])COC1CC'),
    E0 = (-256.373,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (186.205,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.81803,0.145573,-0.000146862,8.11325e-08,-1.80962e-11,-30585.2,47.9477], Tmin=(100,'K'), Tmax=(1085.52,'K')), NASAPolynomial(coeffs=[21.975,0.0542135,-2.06192e-05,3.60086e-09,-2.40256e-13,-35967.9,-73.699], Tmin=(1085.52,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-256.373,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(627.743,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + ring(Oxetane) + radical(CJC(C)OC) + radical(CC(C)(O)OJ)"""),
)
...
species(
    label = 'C=COC[CH]OC1([O])COC1CC(20470)',
    structure = SMILES('C=COC[CH]OC1([O])COC1CC'),
    E0 = (-234.279,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2950,3150,900,1000,1100,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,2750,2800,2850,1350,1500,750,1050,1375,1000,2950,3100,1380,975,1025,1650,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,300,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (186.205,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-5.01005,0.159901,-0.000156629,7.6082e-08,-1.3953e-11,-27820.1,52.9181], Tmin=(100,'K'), Tmax=(1524.63,'K')), NASAPolynomial(coeffs=[37.2031,0.0274402,-4.94786e-06,4.17385e-10,-1.44239e-14,-38168.7,-160.264], Tmin=(1524.63,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-234.279,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(627.743,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + ring(Oxetane) + radical(CC(C)(O)OJ) + radical(CCsJOCs)"""),
)

species(
    label = 'CCC1OCC1([O])O[CH]CC=CO(20471)',
    structure = SMILES('CCC1OCC1([O])O[CH]CC=CO'),
    E0 = (-274.087,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2950,3150,900,1000,1100,3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,300,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (186.205,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-5.03475,0.159377,-0.000157037,7.66934e-08,-1.40928e-11,-32606,54.2585], Tmin=(100,'K'), Tmax=(1533.72,'K')), NASAPolynomial(coeffs=[36.8782,0.0265567,-4.1437e-06,2.40167e-10,-1.60256e-15,-42697.4,-156.859], Tmin=(1533.72,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-274.087,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(627.743,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsOsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + ring(Oxetane) + radical(CC(C)(O)OJ) + radical(CCsJOCs)"""),
)
...
species(
    label = 'CCC=C([O])O[CH]CCC=O(20473)',
    structure = SMILES('CC[CH]C(=O)O[CH]CCC=O'),
    E0 = (-249.215,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2782.5,750,1395,475,1775,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3050,390,425,1340,1360,335,370,300,800,800,800,800,800,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.949325,0.118061,-0.000134146,9.47055e-08,-2.89484e-11,-29803.7,43.6956], Tmin=(100,'K'), Tmax=(777.892,'K')), NASAPolynomial(coeffs=[9.49599,0.0643491,-3.05707e-05,5.93727e-09,-4.19222e-13,-31428.8,-4.07315], Tmin=(777.892,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-249.215,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(523.812,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdCsOs) + group(Cds-OdCsH) + radical(CCJCO) + radical(CCsJOC(O))"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CCC1OCC1([O])O[CH]CCC=O(20301)'],
    products = ['CCC1OCC1([O])OC1CCC1[O](20449)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['[CH2]OC(CC)C(=O)O[CH]CCC=O(20450)'],
    products = ['CCC1OCC1([O])O[CH]CCC=O(20301)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CC[CH]OCC(=O)O[CH]CCC=O(20451)'],
    products = ['CCC1OCC1([O])O[CH]CCC=O(20301)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['H(3)', 'CCC1OCC1([O])OC=CCC=O(20452)'],
    products = ['CCC1OCC1([O])O[CH]CCC=O(20301)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['CH2CHO(40)', 'C=COC1([O])COC1CC(5616)'],
    products = ['CCC1OCC1([O])O[CH]CCC=O(20301)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['CCC1OCC1([O])OC[CH]CC=O(20453)'],
    products = ['CCC1OCC1([O])O[CH]CCC=O(20301)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['CCC1OCC1([O])O[CH]CCC=O(20301)'],
    products = ['CCC1O[CH]C1(O)O[CH]CCC=O(20454)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CCC1OCC1([O])O[CH]CCC=O(20301)'],
    products = ['CCC1OCC1([O])OCC[CH]C=O(20455)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CCC1OCC1([O])O[CH]CCC=O(20301)'],
    products = ['C[CH]C1OCC1(O)O[CH]CCC=O(20456)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CCC1OCC1([O])O[CH]CCC=O(20301)'],
    products = ['CC[C]1OCC1([O])OCCCC=O(20457)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CCC1O[CH]C1([O])OCCCC=O(20458)'],
    products = ['CCC1OCC1([O])O[CH]CCC=O(20301)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CCC1OCC1([O])O[CH]CCC=O(20301)'],
    products = ['CCC1OCC1([O])OCCC[C]=O(20459)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CCC1OCC1([O])O[CH]CCC=O(20301)'],
    products = ['CCC1OCC1(O)O[CH][CH]CC=O(20460)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CCC1OCC1([O])O[CH]CCC=O(20301)'],
    products = ['[CH2]CC1OCC1(O)O[CH]CCC=O(20461)'],
...
reaction(
    label = 'reaction19',
    reactants = ['C[CH]C1OCC1([O])OCCCC=O(20462)'],
    products = ['CCC1OCC1([O])O[CH]CCC=O(20301)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2]CC1OCC1([O])OCCCC=O(20463)'],
    products = ['CCC1OCC1([O])O[CH]CCC=O(20301)'],
...
reaction(
    label = 'reaction24',
    reactants = ['CCC1OCC1([O])O[CH]CCC=O(20301)'],
    products = ['CCC1OCC1([O])OC1CC[CH]O1(20466)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(5.649e+12,'s^-1'), n=0.287, Ea=(60.3927,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R6plus;carbonyl_intra_H;radadd_intra] for rate rule [R8_linear;carbonyl_intra_H;radadd_intra_O]
Euclidian distance = 2.2360679775
family: Intra_R_Add_Endocyclic"""),
)
...
reaction(
    label = 'reaction27',
    reactants = ['CH2(S)(23)', 'CC1OCC1([O])O[CH]CCC=O(20468)'],
    products = ['CCC1OCC1([O])O[CH]CCC=O(20301)'],
...
reaction(
    label = 'reaction28',
    reactants = ['CO(12)', 'CC[CH]OC1([O])COC1CC(13614)'],
    products = ['CCC1OCC1([O])O[CH]CCC=O(20301)'],
...
reaction(
    label = 'reaction29',
    reactants = ['[CH2]C(CC=O)OC1([O])COC1CC(20469)'],
    products = ['CCC1OCC1([O])O[CH]CCC=O(20301)'],
...
reaction(
    label = 'reaction31',
    reactants = ['C=COC[CH]OC1([O])COC1CC(20470)'],
    products = ['CCC1OCC1([O])O[CH]CCC=O(20301)'],
...
reaction(
    label = 'reaction32',
    reactants = ['CCC1OCC1([O])O[CH]CC=CO(20471)'],
    products = ['CCC1OCC1([O])O[CH]CCC=O(20301)'],
...
reaction(
    label = 'reaction33',
    reactants = ['C2H5CHO(70)', 'C=C([O])O[CH]CCC=O(20472)'],
    products = ['CCC1OCC1([O])O[CH]CCC=O(20301)'],
...
reaction(
    label = 'reaction34',
    reactants = ['CH2O(15)', 'CCC=C([O])O[CH]CCC=O(20473)'],
    products = ['CCC1OCC1([O])O[CH]CCC=O(20301)'],
...
reaction(
    label = 'reaction35',
    reactants = ['CCC1OCC1([O])[O](5311)', '[CH]CCC=O(18484)'],
    products = ['CCC1OCC1([O])O[CH]CCC=O(20301)'],
