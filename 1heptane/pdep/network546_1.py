...
species(
    label = 'C=C(C[O])CCC(1748)',
    structure = SMILES('C=C(C[O])CCC'),
    E0 = (-6.7877,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2950,3100,1380,975,1025,1650,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,294.64,295.119,295.208,2021.36],'cm^-1')),
        HinderedRotor(inertia=(0.00194255,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00193892,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.123536,'amu*angstrom^2'), symmetry=1, barrier=(7.61674,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.123206,'amu*angstrom^2'), symmetry=1, barrier=(7.61616,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (99.1509,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.68691,0.0590576,-3.10641e-05,7.57686e-09,-7.4478e-13,-742.513,25.9445], Tmin=(100,'K'), Tmax=(2094.61,'K')), NASAPolynomial(coeffs=[12.2272,0.0389293,-1.66498e-05,2.98918e-09,-1.97228e-13,-5158.13,-32.6997], Tmin=(2094.61,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-6.7877,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(415.724,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(CCOJ)"""),
)
...
species(
    ...
    molecularWeight = (100.159,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.19227,0.0626619,-3.18214e-05,7.28912e-09,-6.46692e-13,2612.46,27.6611], Tmin=(100,'K'), Tmax=(2572.63,'K')), NASAPolynomial(coeffs=[24.9616,0.025704,-1.02723e-05,1.70483e-09,-1.04019e-13,-9617.25,-109.472], Tmin=(2572.63,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(20.8927,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJ(C)CO) + radical(CCOJ)"""),
)
...
species(
    ...
    molecularWeight = (100.159,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.904,0.0597586,-2.9133e-05,6.11287e-09,-4.83991e-13,7621.15,27.3859], Tmin=(100,'K'), Tmax=(2992.46,'K')), NASAPolynomial(coeffs=[35.7669,0.0144932,-6.4427e-06,1.05775e-09,-6.16591e-14,-12645,-173.099], Tmin=(2992.46,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(62.861,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Cs_S) + radical(CCOJ)"""),
)

species(
    label = 'CCCC(C)[CH][O](1753)',
...
species(
    ...
    molecularWeight = (100.159,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.459502,0.0718199,-4.93547e-05,1.84803e-08,-2.90474e-12,164.726,31.2037], Tmin=(100,'K'), Tmax=(1457.57,'K')), NASAPolynomial(coeffs=[12.8196,0.0378999,-1.4447e-05,2.51397e-09,-1.66203e-13,-3438.38,-33.0833], Tmin=(1457.57,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(0.269919,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Isobutyl) + radical(CCJ(C)CO)"""),
)

species(
    label = '[CH2]C([CH]CC)CO(1755)',
    ...
    molecularWeight = (100.159,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.791909,0.0723958,-5.52973e-05,2.50077e-08,-4.99931e-12,5193.98,32.3724], Tmin=(100,'K'), Tmax=(1132.87,'K')), NASAPolynomial(coeffs=[8.64076,0.0446828,-1.86033e-05,3.41431e-09,-2.34118e-13,3415.63,-6.47297], Tmin=(1132.87,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(42.2381,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Isobutyl) + radical(Cs_S)"""),
)

species(
    label = 'C[CH]CC(C)C[O](1756)',
    ...
    molecularWeight = (100.159,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.27826,0.0574756,-2.65172e-05,5.18585e-09,-3.76136e-13,7589.69,26.173], Tmin=(100,'K'), Tmax=(2962.38,'K')), NASAPolynomial(coeffs=[42.5743,0.00758272,-3.54134e-06,5.30045e-10,-2.66678e-14,-18266.9,-215.339], Tmin=(2962.38,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(62.7651,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJC) + radical(CCOJ)"""),
)

species(
    label = '[CH2]C(CO)C[CH]C(1757)',
    ...
    molecularWeight = (100.159,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.750999,0.0743033,-6.46729e-05,3.67668e-08,-9.3695e-12,5183.05,32.7055], Tmin=(100,'K'), Tmax=(911.077,'K')), NASAPolynomial(coeffs=[7.04282,0.0466794,-1.91925e-05,3.48693e-09,-2.37403e-13,4036.6,2.93708], Tmin=(911.077,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(42.1423,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJC) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]CCC(C)C[O](1758)',
    ...
    molecularWeight = (100.159,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.3463,0.0657269,-3.97885e-05,1.31119e-08,-2.0179e-12,8936.79,28.6835], Tmin=(100,'K'), Tmax=(1275.88,'K')), NASAPolynomial(coeffs=[5.89002,0.0514819,-2.30413e-05,4.36121e-09,-3.03258e-13,7777.34,5.6557], Tmin=(1275.88,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(73.5652,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJ) + radical(CCOJ)"""),
)

species(
    label = '[CH2]CCC([CH2])CO(1759)',
...
species(
    ...
    molecularWeight = (100.159,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.537026,0.0703846,-4.6304e-05,1.58713e-08,-2.25739e-12,-27833.3,29.2695], Tmin=(100,'K'), Tmax=(1593.95,'K')), NASAPolynomial(coeffs=[14.0052,0.0365865,-1.44981e-05,2.56858e-09,-1.70959e-13,-32126.9,-41.9857], Tmin=(1593.95,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-232.493,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH)"""),
)

species(
    label = 'CCCC(C)C=O(1761)',
    ...
    molecularWeight = (100.159,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.782159,0.0672955,-4.0023e-05,1.18619e-08,-1.4468e-12,-33609.3,27.5403], Tmin=(100,'K'), Tmax=(1807.25,'K')), NASAPolynomial(coeffs=[14.3249,0.0373215,-1.5145e-05,2.68479e-09,-1.77331e-13,-38504.3,-45.8101], Tmin=(1807.25,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-280.424,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdCsH)"""),
)
...
species(
    ...
    molecularWeight = (100.159,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.22151,0.0469339,3.20059e-05,-7.41468e-08,3.29896e-11,-21139.1,23.2069], Tmin=(100,'K'), Tmax=(910.368,'K')), NASAPolynomial(coeffs=[12.2513,0.0355574,-1.0356e-05,1.6239e-09,-1.06792e-13,-24684.1,-37.4104], Tmin=(910.368,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-176.702,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(444.824,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Oxetane)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'C=C(C[O])CCC(1748)'],
    products = ['[CH2]C(C[O])CCC(999)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', '[CH2]C(C=O)CCC(1749)'],
    products = ['[CH2]C(C[O])CCC(999)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['npropyl(83)', 'allyloxy(559)'],
    products = ['[CH2]C(C[O])CCC(999)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction20',
    reactants = ['CH2(S)(23)', '[CH2]C(CC)C[O](987)'],
    products = ['[CH2]C(C[O])CCC(999)'],
...
reaction(
    label = 'reaction24',
    reactants = ['CH2(19)', 'CCC[CH]C[O](1725)'],
    products = ['[CH2]C(C[O])CCC(999)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[CH2]C([CH2])CCC(453)', 'O(4)'],
    products = ['[CH2]C(C[O])CCC(999)'],
