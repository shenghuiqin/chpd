...
species(
    label = 'CCCC=CCC[C]=O(3045)',
    structure = SMILES('CCCC=CCC[C]=O'),
    E0 = (-45.5921,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,1855,455,950,2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,200,800,1200,1600],'cm^-1')),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.105467,0.0874962,-6.37019e-05,2.53224e-08,-4.33656e-12,-5345.2,36.1104], Tmin=(100,'K'), Tmax=(1307.78,'K')), NASAPolynomial(coeffs=[11.9561,0.0512498,-2.21279e-05,4.1293e-09,-2.85214e-13,-8444.81,-24.2419], Tmin=(1307.78,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-45.5921,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-OdCsH) + radical(CCCJ=O)"""),
)

species(
    label = 'CCCCC=CC[C]=O(3046)',
    ...
    molecularWeight = (125.188,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.414679,0.0844998,-4.92061e-05,1.10209e-08,-3.14706e-13,-4570.65,37.5759], Tmin=(100,'K'), Tmax=(1401.89,'K')), NASAPolynomial(coeffs=[19.7532,0.0411054,-1.79154e-05,3.34074e-09,-2.2908e-13,-11615.8,-71.4948], Tmin=(1401.89,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-39.4097,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-OdCsH) + radical(CCCJ=O)"""),
)
...
species(
    label = 'CCCC[CH][CH]CC=O(3053)',
    structure = SMILES('CCCC[CH][CH]CC=O'),
    E0 = (72.1359,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,2782.5,750,1395,475,1775,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3050,390,425,1340,1360,335,370,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (126.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.1099,0.0758982,-1.07913e-07,-1.21987e-07,1.14107e-10,8767.37,36.2906], Tmin=(100,'K'), Tmax=(460.688,'K')), NASAPolynomial(coeffs=[4.07321,0.0677991,-3.11414e-05,5.99264e-09,-4.22341e-13,8307.25,22.2605], Tmin=(460.688,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(72.1359,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(527.969,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(RCCJCC) + radical(CCJCC=O)"""),
)

species(
    label = 'C[CH]CCCCC[C]=O(3054)',
    ...
    molecularWeight = (126.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.662374,0.0859986,-3.22864e-05,-7.42508e-08,8.26843e-11,3978.18,36.3542], Tmin=(100,'K'), Tmax=(493.033,'K')), NASAPolynomial(coeffs=[5.82598,0.0645349,-2.91382e-05,5.53349e-09,-3.85896e-13,3220.72,12.5763], Tmin=(493.033,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(32.1825,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(527.969,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(RCCJC) + radical(CCCJ=O)"""),
)

species(
    label = '[CH2]CCCCCC[C]=O(3055)',
    structure = SMILES('[CH2]CCCCCC[C]=O'),
    E0 = (42.9825,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2759.09,2768.18,2777.27,2786.36,2795.45,2804.55,2813.64,2822.73,2831.82,2840.91,2850,1425,1430,1435,1440,1445,1450,1225,1235,1245,1255,1265,1275,1270,1284,1298,1312,1326,1340,700,720,740,760,780,800,300,320,340,360,380,400,3000,3100,440,815,1455,1000,1855,455,950,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (126.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.15542,0.0977415,-8.5913e-05,4.6059e-08,-1.10042e-11,5313.89,38.1558], Tmin=(100,'K'), Tmax=(961.419,'K')), NASAPolynomial(coeffs=[8.94015,0.0598997,-2.68732e-05,5.12013e-09,-3.58915e-13,3564.94,-5.36734], Tmin=(961.419,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(42.9825,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(527.969,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(CCCJ=O) + radical(RCCJ)"""),
)

species(
    label = 'CCC[CH][CH]CCC=O(3056)',
    structure = SMILES('CCC[CH][CH]CCC=O'),
    E0 = (66.6922,'kJ/mol'),
    modes = [
...
species(
    label = 'C[CH]CC[CH]CCC=O(3058)',
    structure = SMILES('C[CH]CC[CH]CCC=O'),
    E0 = (66.6802,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,2782.5,750,1395,475,1775,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3050,390,425,1340,1360,335,370,180,180,829.472,1503.35,3200],'cm^-1')),
        HinderedRotor(inertia=(0.11058,'amu*angstrom^2'), symmetry=1, barrier=(2.54245,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.11058,'amu*angstrom^2'), symmetry=1, barrier=(2.54245,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.11058,'amu*angstrom^2'), symmetry=1, barrier=(2.54245,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.11058,'amu*angstrom^2'), symmetry=1, barrier=(2.54245,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.11058,'amu*angstrom^2'), symmetry=1, barrier=(2.54245,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (126.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0417508,0.0994996,-0.000122432,1.11794e-07,-4.2986e-11,8155.01,40.4191], Tmin=(100,'K'), Tmax=(807.746,'K')), NASAPolynomial(coeffs=[1.19785,0.072472,-3.34501e-05,6.33788e-09,-4.37824e-13,8636.21,38.9217], Tmin=(807.746,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(66.6802,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(527.969,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(RCCJCC) + radical(RCCJC)"""),
)

species(
    label = '[CH2]CCC[CH]CCC=O(3059)',
    structure = SMILES('[CH2]CCC[CH]CCC=O'),
    E0 = (77.4803,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (126.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.147203,0.0992919,-0.000110545,9.1336e-08,-3.3791e-11,9460.34,39.8537], Tmin=(100,'K'), Tmax=(758.803,'K')), NASAPolynomial(coeffs=[3.92601,0.0686089,-3.16827e-05,6.05164e-09,-4.2201e-13,9107.37,23.0744], Tmin=(758.803,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(77.4803,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(527.969,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(RCCJ) + radical(RCCJCC)"""),
)

species(
    label = 'CCCCC=CCC=O(3060)',
    structure = SMILES('CCCCC=CCC=O'),
    E0 = (-199.37,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (126.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.292813,0.0810595,-3.29142e-05,-4.39796e-09,4.26096e-12,-23813.4,36.3122], Tmin=(100,'K'), Tmax=(1265.03,'K')), NASAPolynomial(coeffs=[17.4715,0.0481338,-2.14351e-05,4.07795e-09,-2.84654e-13,-30167.7,-60.9178], Tmin=(1265.03,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-199.37,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(532.126,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-OdCsH)"""),
)
...
species(
    label = 'CCCC=CCCC=O(3062)',
    structure = SMILES('CCCC=CCCC=O'),
    E0 = (-205.553,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (126.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0586065,0.0859661,-5.35127e-05,1.67517e-08,-2.18518e-12,-24581,35.454], Tmin=(100,'K'), Tmax=(1676.39,'K')), NASAPolynomial(coeffs=[15.2759,0.0496564,-2.10235e-05,3.83141e-09,-2.58373e-13,-29683,-45.8224], Tmin=(1676.39,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-205.553,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(532.126,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-OdCsH)"""),
)
...
species(
    ...
    molecularWeight = (126.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.31685,0.0981349,-8.53261e-05,4.42573e-08,-9.95784e-12,5020.36,38.4399], Tmin=(100,'K'), Tmax=(1033.24,'K')), NASAPolynomial(coeffs=[10.6912,0.0555185,-2.34574e-05,4.33793e-09,-2.98944e-13,2745.58,-15.0276], Tmin=(1033.24,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(40.4714,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(527.969,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(CCCJ=O) + radical(Isobutyl)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'CCCC=CCC[C]=O(3045)'],
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'CCCCC=CC[C]=O(3046)'],
    products = ['CCCC[CH]CC[C]=O(1138)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(1.46e+08,'cm^3/(mol*s)'), n=1.64, Ea=(5.73208,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""From training reaction 2555 used for Cds-CsH_Cds-CsH;HJ
Exact match found for rate rule [Cds-CsH_Cds-CsH;HJ]
...
reaction(
    label = 'reaction5',
    reactants = ['npropyl(83)', 'C=CCC[C]=O(2430)'],
    products = ['CCCC[CH]CC[C]=O(1138)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction13',
    reactants = ['CCCC[CH][CH]CC=O(3053)'],
    products = ['CCCC[CH]CC[C]=O(1138)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CCC[CH][CH]CCC=O(3056)'],
    products = ['CCCC[CH]CC[C]=O(1138)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CC[CH]C[CH]CCC=O(3057)'],
    products = ['CCCC[CH]CC[C]=O(1138)'],
...
reaction(
    label = 'reaction18',
    reactants = ['C[CH]CC[CH]CCC=O(3058)'],
    products = ['CCCC[CH]CC[C]=O(1138)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2]CCC[CH]CCC=O(3059)'],
    products = ['CCCC[CH]CC[C]=O(1138)'],
...
reaction(
    label = 'reaction24',
    reactants = ['CH2(S)(23)', 'CCC[CH]CC[C]=O(1146)'],
    products = ['CCCC[CH]CC[C]=O(1138)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[CH2]C(CCC)CC[C]=O(3063)'],
    products = ['CCCC[CH]CC[C]=O(1138)'],
...
reaction(
    label = 'reaction29',
    reactants = ['[CH2]C[CH]CCCC(199)', 'CO(12)'],
    products = ['CCCC[CH]CC[C]=O(1138)'],
...
reaction(
    label = 'reaction30',
    reactants = ['[CH]CCCC(141)', '[CH2]C[C]=O(2129)'],
    products = ['CCCC[CH]CC[C]=O(1138)'],
...
reaction(
    label = 'reaction31',
    reactants = ['[CH2]C[CH]CCCC(199)', '[C]=O(361)'],
    products = ['CCCC[CH]CC[C]=O(1138)'],
