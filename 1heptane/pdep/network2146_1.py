...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.136952,0.0696223,1.35428e-06,-6.08402e-08,3.06491e-11,-23281.1,31.0504], Tmin=(100,'K'), Tmax=(961.526,'K')), NASAPolynomial(coeffs=[23.3985,0.0235299,-7.57522e-06,1.39703e-09,-1.05e-13,-30202.4,-94.0271], Tmin=(961.526,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-194.969,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-OsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(OCOJ)"""),
)
...
species(
    label = 'CC[CH]CCOC[O](11684)',
    structure = SMILES('CC[CH]CCOC[O]'),
    E0 = (-77.2663,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (116.158,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.92089,0.074816,-4.94295e-05,1.77511e-08,-2.88542e-12,-9188.54,31.8857], Tmin=(100,'K'), Tmax=(1282.32,'K')), NASAPolynomial(coeffs=[7.85504,0.053186,-2.41276e-05,4.59684e-09,-3.20878e-13,-10966.9,-3.29192], Tmin=(1282.32,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-77.2663,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsOsHH) + radical(RCCJCC) + radical(OCOJ)"""),
)

species(
    label = 'C[CH]CCCOC[O](11685)',
    structure = SMILES('C[CH]CCCOC[O]'),
    E0 = (-77.2783,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (116.158,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.7467,0.0760382,-5.04746e-05,1.77601e-08,-2.72824e-12,-9181.77,32.6756], Tmin=(100,'K'), Tmax=(1395.46,'K')), NASAPolynomial(coeffs=[10.0109,0.0494829,-2.19299e-05,4.12306e-09,-2.85127e-13,-11767.3,-15.1057], Tmin=(1395.46,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-77.2783,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsOsHH) + radical(OCOJ) + radical(RCCJC)"""),
)
...
species(
    label = '[CH2]CCCCOC[O](11686)',
    structure = SMILES('[CH2]CCCCOC[O]'),
    E0 = (-66.4782,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2761.11,2772.22,2783.33,2794.44,2805.56,2816.67,2827.78,2838.89,2850,1425,1431.25,1437.5,1443.75,1450,1225,1237.5,1250,1262.5,1275,1270,1287.5,1305,1322.5,1340,700,725,750,775,800,300,325,350,375,400,3000,3100,440,815,1455,1000,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (116.158,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.177767,0.081204,-5.69243e-05,2.03629e-08,-3.01711e-12,-7856.17,33.7788], Tmin=(100,'K'), Tmax=(1528.74,'K')), NASAPolynomial(coeffs=[15.4279,0.041301,-1.7771e-05,3.28839e-09,-2.24823e-13,-12518.8,-46.267], Tmin=(1528.74,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-66.4782,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsOsHH) + radical(RCCJ) + radical(OCOJ)"""),
)

species(
    label = 'CC[CH]C[CH]OCO(11687)',
    structure = SMILES('CC[CH]C[CH]OCO'),
    E0 = (-124.208,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (116.158,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.769626,0.0945274,-7.89196e-05,2.83014e-08,-1.96338e-12,-14757.9,36.9271], Tmin=(100,'K'), Tmax=(1000.29,'K')), NASAPolynomial(coeffs=[20.2075,0.029773,-1.05027e-05,1.82218e-09,-1.23824e-13,-19911.6,-69.0656], Tmin=(1000.29,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-124.208,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsOsHH) + radical(CCsJOCs) + radical(RCCJCC)"""),
)

species(
    label = 'C[CH]CC[CH]OCO(11688)',
    structure = SMILES('C[CH]CC[CH]OCO'),
    E0 = (-124.22,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (116.158,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.77944,0.0937422,-7.27349e-05,1.8807e-08,2.25062e-12,-14758,37.1336], Tmin=(100,'K'), Tmax=(968.856,'K')), NASAPolynomial(coeffs=[21.088,0.0281788,-9.49731e-06,1.62602e-09,-1.10852e-13,-20155.4,-73.6592], Tmin=(968.856,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-124.22,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsOsHH) + radical(CCsJOCs) + radical(RCCJC)"""),
)

species(
    label = '[CH2]CCC[CH]OCO(11689)',
    structure = SMILES('[CH2]CCC[CH]OCO'),
    E0 = (-113.42,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (116.158,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.960678,0.0944939,-6.44775e-05,3.33377e-09,9.27318e-12,-13449.4,36.8354], Tmin=(100,'K'), Tmax=(954.193,'K')), NASAPolynomial(coeffs=[24.123,0.0237633,-7.39825e-06,1.2591e-09,-8.81984e-14,-19803.4,-91.2137], Tmin=(954.193,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-113.42,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsOsHH) + radical(CCsJOCs) + radical(RCCJ)"""),
)
...
species(
    label = 'CCC[CH]OC[O](11690)',
    structure = SMILES('CCC[CH]OC[O]'),
    E0 = (-67.4883,'kJ/mol'),
    modes = [
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.252476,0.0753596,-6.07944e-05,2.52724e-08,-4.24847e-12,-7976.34,28.9327], Tmin=(100,'K'), Tmax=(1407.57,'K')), NASAPolynomial(coeffs=[16.3421,0.0296359,-1.20677e-05,2.19384e-09,-1.49416e-13,-12505.8,-54.191], Tmin=(1407.57,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-67.4883,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsOsHH) + radical(OCOJ) + radical(CCsJOCs)"""),
)
...
species(
    label = 'CCCCC1OCO1(11661)',
    structure = SMILES('CCCCC1OCO1'),
    E0 = (-350.59,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (116.158,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.323329,0.0520511,6.14534e-05,-1.24475e-07,5.30231e-11,-42007.8,29.698], Tmin=(100,'K'), Tmax=(959.062,'K')), NASAPolynomial(coeffs=[24.094,0.0245713,-7.64854e-06,1.47e-09,-1.16043e-13,-49863,-101.17], Tmin=(959.062,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-350.59,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(465.61,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-OsOsHH) + ring(Cyclobutane)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'CCCC=COC[O](11682)'],
    products = ['CCCC[CH]OC[O](11658)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'CCCC[CH]OC=O(11683)'],
    products = ['CCCC[CH]OC[O](11658)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['npropyl(83)', 'C=COC[O](961)'],
    products = ['CCCC[CH]OC[O](11658)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction19',
    reactants = ['CH2(S)(23)', 'CCC[CH]OC[O](11690)'],
    products = ['CCCC[CH]OC[O](11658)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[O]C[O](170)', '[CH]CCCC(141)'],
    products = ['CCCC[CH]OC[O](11658)'],
...
reaction(
    label = 'reaction23',
    reactants = ['O(4)', '[CH2]O[CH]CCCC(1766)'],
    products = ['CCCC[CH]OC[O](11658)'],
