...
species(
    label = '[CH2]C(C)C1(O)CC1(O)[CH]C(32264)',
    structure = SMILES('[CH2]C(C)C1(O)CC1(O)[CH]C'),
    E0 = (-61.7939,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (142.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.60512,0.107627,-6.73368e-05,-6.31344e-10,1.17144e-11,-7216.03,41.8091], Tmin=(100,'K'), Tmax=(945.235,'K')), NASAPolynomial(coeffs=[24.6947,0.0341522,-1.07558e-05,1.79158e-09,-1.21829e-13,-13877.5,-92.5284], Tmin=(945.235,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-61.7939,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(552.912,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsCsOs) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(CCJCO) + radical(Isobutyl)"""),
)
...
species(
    label = '[CH2]C(O)(C(=C)C)C(O)=CC(32266)',
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.72026,0.117959,-0.000112336,5.52883e-08,-1.08476e-11,-25832.2,39.8549], Tmin=(100,'K'), Tmax=(1231.52,'K')), NASAPolynomial(coeffs=[22.7894,0.0383515,-1.53722e-05,2.79839e-09,-1.92078e-13,-31869,-83.494], Tmin=(1231.52,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-216.548,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(527.969,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)(Cds-Cds)CsOs) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(C=CC(C)(O)CJ)"""),
)
...
species(
    label = '[CH2]C(C)C(=C)C(O)=CC(32268)',
...
species(
    label = '[CH2]C(O)([C](C)C)C(O)=CC(32269)',
    structure = SMILES('[CH2]C(O)([C](C)C)C(O)=CC'),
    E0 = (-175.97,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (142.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.89811,0.116451,-9.57738e-05,3.34509e-08,-2.0884e-12,-20940.3,41.4915], Tmin=(100,'K'), Tmax=(1009.61,'K')), NASAPolynomial(coeffs=[24.1152,0.037168,-1.33118e-05,2.32915e-09,-1.58956e-13,-27404.9,-90.2585], Tmin=(1009.61,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-175.97,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(548.755,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsOs) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsCsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + radical(C=CC(C)(O)CJ) + radical(CCJ(C)CO)"""),
)

species(
    label = '[CH2]C(C)C(C)([O])C(O)=CC(32270)',
    structure = SMILES('[CH2]C(C)C(C)([O])C(O)=CC'),
    E0 = (-107.803,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2762.5,2775,2787.5,2800,2812.5,2825,2837.5,2850,1350,1380,1410,1440,1470,1500,700,750,800,1000,1050,1100,1350,1375,1400,900,1000,1100,3010,987.5,1337.5,450,1655,1380,1390,370,380,2900,435,350,440,435,1725,3000,3100,440,815,1455,1000,180,180,180,180,1563.41,1600,2933.33,3200],'cm^-1')),
        HinderedRotor(inertia=(0.149811,'amu*angstrom^2'), symmetry=1, barrier=(3.44446,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.149811,'amu*angstrom^2'), symmetry=1, barrier=(3.44446,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.149811,'amu*angstrom^2'), symmetry=1, barrier=(3.44446,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.149811,'amu*angstrom^2'), symmetry=1, barrier=(3.44446,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.149811,'amu*angstrom^2'), symmetry=1, barrier=(3.44446,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (142.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.99041,0.116425,-0.000103767,4.86044e-08,-9.04472e-12,-12737.1,44.4492], Tmin=(100,'K'), Tmax=(1304.61,'K')), NASAPolynomial(coeffs=[23.8124,0.0373127,-1.28068e-05,2.12295e-09,-1.37591e-13,-19469.6,-86.8953], Tmin=(1304.61,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-107.803,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(552.912,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsOs) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsCsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + radical(Isobutyl) + radical(C=CC(C)2OJ)"""),
)

species(
    label = '[CH2][C](C)C(C)(O)C(O)=CC(32271)',
    structure = SMILES('[CH2][C](C)C(C)(O)C(O)=CC'),
    E0 = (-184.331,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (142.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.691,0.111389,-8.00008e-05,1.42805e-08,5.95902e-12,-21952.6,42.3479], Tmin=(100,'K'), Tmax=(951.62,'K')), NASAPolynomial(coeffs=[23.9031,0.0359534,-1.17634e-05,1.97292e-09,-1.3303e-13,-28279.2,-87.5071], Tmin=(951.62,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-184.331,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(548.755,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsOs) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsCsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + radical(Isobutyl) + radical(CCJ(C)CO)"""),
)

species(
    label = '[CH2]C([O])(C(O)=CC)C(C)C(32272)',
    ...
    molecularWeight = (142.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.83667,0.117275,-0.00010499,4.90996e-08,-9.1852e-12,-11740.7,42.295], Tmin=(100,'K'), Tmax=(1288.17,'K')), NASAPolynomial(coeffs=[22.9517,0.0403026,-1.53586e-05,2.71264e-09,-1.82658e-13,-18127,-83.5716], Tmin=(1288.17,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-99.4415,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(552.912,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsOs) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsCsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + radical(C=CC(C)2OJ) + radical(C=CC(C)(O)CJ)"""),
)

species(
    label = '[CH2]C([CH2])C(C)(O)C(O)=CC(32273)',
    ...
    molecularWeight = (142.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.51052,0.1264,-0.000127177,6.66647e-08,-1.35672e-11,-15605.9,46.1809], Tmin=(100,'K'), Tmax=(1288.84,'K')), NASAPolynomial(coeffs=[25.9268,0.031307,-8.54897e-06,1.18813e-09,-6.82941e-14,-22368.4,-96.0258], Tmin=(1288.84,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-131.823,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(548.755,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsOs) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsCsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + radical(Isobutyl) + radical(Isobutyl)"""),
)
...
species(
    label = '[CH2]C(C)C(C)(O)C(O)=[C]C(32274)',
    structure = SMILES('[CH2]C(C)C(C)(O)C(O)=[C]C'),
    E0 = (-99.0635,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (142.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.26293,0.125789,-0.000127109,6.73617e-08,-1.40391e-11,-11678.9,44.6781], Tmin=(100,'K'), Tmax=(1176.54,'K')), NASAPolynomial(coeffs=[24.4126,0.0350974,-1.14832e-05,1.84417e-09,-1.17399e-13,-17955.8,-88.3525], Tmin=(1176.54,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-99.0635,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(548.755,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsOs) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsCsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + radical(Cds_S) + radical(Isobutyl)"""),
)
...
species(
    label = '[CH2]C(O)(C(O)=[C]C)C(C)C(32275)',
    ...
    molecularWeight = (142.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.14431,0.126993,-0.000129327,6.88739e-08,-1.45204e-11,-10680.8,42.6545], Tmin=(100,'K'), Tmax=(1156.83,'K')), NASAPolynomial(coeffs=[23.5666,0.0380901,-1.40479e-05,2.43885e-09,-1.63001e-13,-16629.3,-85.1311], Tmin=(1156.83,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-90.7024,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(548.755,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsOs) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsCsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + radical(C=CC(C)(O)CJ) + radical(Cds_S)"""),
)

species(
    label = '[CH2]C=C(O)C(C)(O)C([CH2])C(32276)',
    structure = SMILES('[CH2]C=C(O)C(C)(O)C([CH2])C'),
    E0 = (-185.406,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (142.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.91968,0.126597,-0.000120396,5.79406e-08,-1.06989e-11,-22028.2,46.8569], Tmin=(100,'K'), Tmax=(1464.87,'K')), NASAPolynomial(coeffs=[29.2846,0.0271732,-6.82572e-06,9.01314e-10,-5.07564e-14,-30230.8,-116.598], Tmin=(1464.87,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-185.406,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(548.755,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsOs) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsCsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + radical(Allyl_P) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]C=C(O)C([CH2])(O)C(C)C(32277)',
    structure = SMILES('[CH2]C=C(O)C([CH2])(O)C(C)C'),
    E0 = (-177.045,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (142.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.12051,0.120018,-9.64912e-05,2.70849e-08,1.99347e-12,-21060.1,42.3752], Tmin=(100,'K'), Tmax=(970.478,'K')), NASAPolynomial(coeffs=[26.5265,0.033406,-1.12485e-05,1.93246e-09,-1.32377e-13,-28102,-102.605], Tmin=(970.478,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-177.045,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(548.755,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsOs) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsCsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + radical(Allyl_P) + radical(C=CC(C)(O)CJ)"""),
)

species(
    label = '[CH2]C(C)C1(O)CC(C)[C]1O(32278)',
    structure = SMILES('[CH2]C(C)C1(O)CC(C)[C]1O'),
    E0 = (-80.5453,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (142.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.41816,0.105488,-7.04277e-05,1.20398e-08,4.47481e-12,-9480.22,40.0324], Tmin=(100,'K'), Tmax=(993.863,'K')), NASAPolynomial(coeffs=[21.5072,0.0408508,-1.45752e-05,2.54782e-09,-1.73957e-13,-15401.8,-77.2936], Tmin=(993.863,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-80.5453,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(557.07,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Cyclobutane) + radical(Isobutyl) + radical(C2CsJOH)"""),
)
...
species(
    label = 'C=C(C)C(C)(O)C(O)=CC(32280)',
    ...
    molecularWeight = (142.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.99112,0.116474,-0.000101699,4.54224e-08,-8.04656e-12,-51487.6,39.962], Tmin=(100,'K'), Tmax=(1363.86,'K')), NASAPolynomial(coeffs=[25.2925,0.0364559,-1.36942e-05,2.40483e-09,-1.61341e-13,-58929.8,-100.132], Tmin=(1363.86,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-429.992,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(552.912,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)(Cds-Cds)CsOs) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + group(Cds-CdsHH)"""),
)
...
species(
    label = '[CH2]C(C)C([CH2])(O)C(=C)O(32281)',
    structure = SMILES('[CH2]C(C)C([CH2])(O)C(=C)O'),
    E0 = (-87.4362,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,3580,3650,1210,1345,900,1100,2950,3100,1380,975,1025,1650,1380,1390,370,380,2900,435,350,440,435,1725,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (128.169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.97525,0.114727,-0.000118219,6.18629e-08,-1.24507e-11,-10286.8,42.2423], Tmin=(100,'K'), Tmax=(1315.61,'K')), NASAPolynomial(coeffs=[25.5675,0.0236722,-6.06292e-06,8.03911e-10,-4.49785e-14,-16900.9,-95.7853], Tmin=(1315.61,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-87.4362,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(478.082,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsOs) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsCsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(C=CC(C)(O)CJ) + radical(Isobutyl)"""),
)
...
species(
    label = '[CH2]C(C)[C](O)CC(O)=CC(32282)',
    ...
    molecularWeight = (142.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.83796,0.125006,-0.000130011,7.28631e-08,-1.63704e-11,-16011.7,42.9152], Tmin=(100,'K'), Tmax=(1080.96,'K')), NASAPolynomial(coeffs=[20.2423,0.0432991,-1.66279e-05,2.93434e-09,-1.9734e-13,-20785.2,-65.3278], Tmin=(1080.96,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-134.901,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(548.755,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + radical(Isobutyl) + radical(C2CsJOH)"""),
)
...
species(
    label = '[CH2]C(C)[C](O)C(O)=CC(32284)',
    structure = SMILES('[CH2]C(C)C(O)=C(O)[CH]C'),
    E0 = (-131.078,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (128.169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.12611,0.0943091,-4.57103e-05,-2.70404e-08,2.32354e-11,-15563.3,39.5889], Tmin=(100,'K'), Tmax=(917.653,'K')), NASAPolynomial(coeffs=[27.0872,0.0200554,-3.98383e-06,5.09858e-10,-3.446e-14,-22792.9,-105.278], Tmin=(917.653,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-131.078,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(478.082,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsOs) + radical(CCJCO) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]C(O)([CH]C)C(O)=CC(32285)',
    structure = SMILES('[CH2]C(O)([CH]C)C(O)=CC'),
    E0 = (-99.1675,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,3580,3650,1210,1345,900,1100,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,350,440,435,1725,3000,3100,440,815,1455,1000,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (128.169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.67421,0.109446,-0.000107583,5.38942e-08,-1.05098e-11,-11709.8,41.7229], Tmin=(100,'K'), Tmax=(1289.59,'K')), NASAPolynomial(coeffs=[24.6631,0.0258084,-8.03484e-06,1.26182e-09,-7.96579e-14,-18340.8,-91.41], Tmin=(1289.59,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-99.1675,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(478.082,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + radical(C=CC(C)(O)CJ) + radical(CCJCO)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]C(C)C([CH2])(O)C(O)=CC(6746)'],
    products = ['[CH2]C(C)C1(O)CC1(O)[CH]C(32264)'],
    transitionState = 'TS2',
...
reaction(
    ...
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(8.65e+06,'s^-1'), n=1.3, Ea=(64.1824,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2500,'K'), comment="""Estimated using template [R5_SS_D;doublebond_intra_HNd;radadd_intra_cs2H] for rate rule [R5_SS_D;doublebond_intra_HNd_secNd;radadd_intra_cs2H]
Euclidian distance = 1.0
family: Intra_R_Add_Exocyclic
Ea raised from 62.1 to 64.2 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction4',
    reactants = ['H(3)', '[CH2]C(O)(C(=C)C)C(O)=CC(32266)'],
    products = ['[CH2]C(C)C([CH2])(O)C(O)=CC(6746)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2]C(C)C(=C)O(2940)', 'CC=[C]O(31159)'],
    products = ['[CH2]C(C)C([CH2])(O)C(O)=CC(6746)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['CH3(17)', '[CH2]C(O)(C=C)C(O)=CC(32267)'],
    products = ['[CH2]C(C)C([CH2])(O)C(O)=CC(6746)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['OH(5)', '[CH2]C(C)C(=C)C(O)=CC(32268)'],
    products = ['[CH2]C(C)C([CH2])(O)C(O)=CC(6746)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]C(C)C([CH2])(O)C(O)=CC(6746)'],
    products = ['[CH2]C(O)([C](C)C)C(O)=CC(32269)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]C(C)C(C)([O])C(O)=CC(32270)'],
    products = ['[CH2]C(C)C([CH2])(O)C(O)=CC(6746)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]C(C)C([CH2])(O)C(O)=CC(6746)'],
    products = ['[CH2][C](C)C(C)(O)C(O)=CC(32271)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2]C(C)C([CH2])(O)C(O)=CC(6746)'],
    products = ['[CH2]C([O])(C(O)=CC)C(C)C(32272)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]C(C)C([CH2])(O)C(O)=CC(6746)'],
    products = ['[CH2]C([CH2])C(C)(O)C(O)=CC(32273)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]C(C)C(C)(O)C(O)=[C]C(32274)'],
    products = ['[CH2]C(C)C([CH2])(O)C(O)=CC(6746)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2]C(O)(C(O)=[C]C)C(C)C(32275)'],
    products = ['[CH2]C(C)C([CH2])(O)C(O)=CC(6746)'],
    transitionState = 'TS18',
    kinetics = Arrhenius(A=(816000,'s^-1'), n=1.9199, Ea=(33.0402,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R5H;Cd_rad_out_single;Cs_H_out_2H] for rate rule [R5H_DSSS;Cd_rad_out_Cs;Cs_H_out_2H]
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2]C(C)C([CH2])(O)C(O)=CC(6746)'],
    products = ['[CH2]C=C(O)C(C)(O)C([CH2])C(32276)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2]C(C)C([CH2])(O)C(O)=CC(6746)'],
    products = ['[CH2]C=C(O)C([CH2])(O)C(C)C(32277)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH2]C(C)C([CH2])(O)C(O)=CC(6746)'],
    products = ['[CH2]C(C)C1(O)CC(C)[C]1O(32278)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[CH2]C(C)C([CH2])(O)C(O)=CC(6746)'],
    products = ['C=C(C)C(C)(O)C(O)=CC(32280)'],
...
reaction(
    label = 'reaction25',
    reactants = ['CH2(S)(23)', '[CH2]CC([CH2])(O)C(O)=CC(6395)'],
    products = ['[CH2]C(C)C([CH2])(O)C(O)=CC(6746)'],
...
reaction(
    label = 'reaction26',
    reactants = ['CH2(S)(23)', '[CH2]C(C)C([CH2])(O)C(=C)O(32281)'],
    products = ['[CH2]C(C)C([CH2])(O)C(O)=CC(6746)'],
...
reaction(
    label = 'reaction28',
    reactants = ['[CH2]C(C)C([CH2])(O)C(O)=CC(6746)'],
    products = ['[CH2]C(C)[C](O)CC(O)=CC(32282)'],
...
reaction(
    label = 'reaction30',
    reactants = ['[CH2]C(C)C([CH2])(O)C(O)=CC(6746)'],
    products = ['[CH2]C(O)([CH]CC)C(O)=CC(32283)'],
...
reaction(
    label = 'reaction33',
    reactants = ['CH2(19)', '[CH2]C(C)[C](O)C(O)=CC(32284)'],
    products = ['[CH2]C(C)C([CH2])(O)C(O)=CC(6746)'],
...
reaction(
    label = 'reaction34',
    reactants = ['CH2(19)', '[CH2]C(O)([CH]C)C(O)=CC(32285)'],
    products = ['[CH2]C(C)C([CH2])(O)C(O)=CC(6746)'],
