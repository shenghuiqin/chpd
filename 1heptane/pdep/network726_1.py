...
species(
    label = 'C=C(C[C]=O)CCC(2787)',
    structure = SMILES('C=C(C[C]=O)CCC'),
    E0 = (-18.6589,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2950,3100,1380,975,1025,1650,1855,455,950,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.175898,0.0726533,-4.09087e-05,6.85062e-09,8.02368e-13,-2097.12,32.1491], Tmin=(100,'K'), Tmax=(1295.2,'K')), NASAPolynomial(coeffs=[17.1466,0.0355351,-1.56322e-05,2.95651e-09,-2.05615e-13,-7775.91,-59.066], Tmin=(1295.2,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-18.6589,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-OdCsH) + group(Cds-CdsHH) + radical(CCCJ=O)"""),
)
...
species(
    ...
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.219691,0.091352,-0.000114763,9.91897e-08,-3.61307e-11,5088.8,33.6121], Tmin=(100,'K'), Tmax=(803.517,'K')), NASAPolynomial(coeffs=[4.34913,0.0573679,-2.62563e-05,4.95972e-09,-3.42186e-13,4858.64,17.2906], Tmin=(803.517,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(41.2448,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(CCCJ=O) + radical(Tertalkyl)"""),
)
...
species(
    ...
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.736331,0.0776154,-6.01296e-05,2.81542e-08,-6.06812e-12,6170.04,33.1944], Tmin=(100,'K'), Tmax=(1026.99,'K')), NASAPolynomial(coeffs=[7.13215,0.052704,-2.37439e-05,4.53415e-09,-3.18184e-13,4856.37,2.16802], Tmin=(1026.99,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(50.3643,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(Cs_S) + radical(CCCJ=O)"""),
)
...
species(
    label = '[CH2][C](CC=O)CCC(2793)',
    structure = SMILES('[CH2][C](CC=O)CCC'),
    E0 = (86.3665,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2782.5,750,1395,475,1775,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,360,370,350,244.498,856.198,1777.99],'cm^-1')),
    ...
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.269892,0.0905409,-0.000113756,9.91273e-08,-3.60409e-11,10513.6,34.3951], Tmin=(100,'K'), Tmax=(822.948,'K')), NASAPolynomial(coeffs=[3.66,0.0582822,-2.61939e-05,4.89183e-09,-3.34778e-13,10490,21.9471], Tmin=(822.948,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(86.3665,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(Tertalkyl) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]C([CH]CC)CC=O(2794)',
    ...
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.712855,0.0776269,-6.18541e-05,3.16174e-08,-7.57361e-12,11598.2,34.2453], Tmin=(100,'K'), Tmax=(933.064,'K')), NASAPolynomial(coeffs=[6.21378,0.0540449,-2.39439e-05,4.53117e-09,-3.16349e-13,10571.6,8.08751], Tmin=(933.064,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(95.486,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(Cs_S) + radical(Isobutyl)"""),
)

species(
    label = 'C[CH]CC(C)C[C]=O(2795)',
    ...
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.548145,0.0813183,-7.60467e-05,4.88033e-08,-1.44406e-11,6165.33,34.0513], Tmin=(100,'K'), Tmax=(783.493,'K')), NASAPolynomial(coeffs=[5.87195,0.0541398,-2.4016e-05,4.5331e-09,-3.15439e-13,5331.05,9.66575], Tmin=(783.493,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(50.2684,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(CCCJ=O) + radical(RCCJC)"""),
)

species(
    label = '[CH2]C(C[CH]C)CC=O(2796)',
    structure = SMILES('[CH2]C(C[CH]C)CC=O'),
    E0 = (95.3901,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,1380,1390,370,380,2900,435,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2782.5,750,1395,475,1775,1000,232.34,832.34,1858.72],'cm^-1')),
    ...
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.27031,0.0697899,-1.89049e-05,-6.77926e-08,6.8619e-11,11561.3,32.5717], Tmin=(100,'K'), Tmax=(499.425,'K')), NASAPolynomial(coeffs=[5.13083,0.0551867,-2.40504e-05,4.4918e-09,-3.10481e-13,10972.2,14.5901], Tmin=(499.425,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(95.3901,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(RCCJC) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]CCC(C)C[C]=O(2797)',
    ...
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.479138,0.0809155,-6.44245e-05,2.96122e-08,-5.9699e-12,7468.64,33.3384], Tmin=(100,'K'), Tmax=(1125.79,'K')), NASAPolynomial(coeffs=[9.62503,0.0484198,-2.11276e-05,3.97299e-09,-2.76329e-13,5409.35,-11.869], Tmin=(1125.79,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(61.0685,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(CCCJ=O) + radical(RCCJ)"""),
)

species(
    label = '[CH2]CCC([CH2])CC=O(2798)',
    ...
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.500724,0.0804098,-6.44178e-05,3.0942e-08,-6.61001e-12,12894.8,34.227], Tmin=(100,'K'), Tmax=(1063.93,'K')), NASAPolynomial(coeffs=[8.61602,0.0498983,-2.13996e-05,3.9857e-09,-2.75709e-13,11168,-5.42734], Tmin=(1063.93,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(106.19,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(RCCJ) + radical(Isobutyl)"""),
)

species(
    label = 'C=C(CC=O)CCC(2799)',
    ...
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.280978,0.06935,-2.48517e-05,-8.54025e-09,5.45473e-12,-21338.9,30.9502], Tmin=(100,'K'), Tmax=(1213.03,'K')), NASAPolynomial(coeffs=[15.7599,0.04125,-1.84741e-05,3.54661e-09,-2.49763e-13,-26782.1,-53.6735], Tmin=(1213.03,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-178.62,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-OdCsH) + group(Cds-CdsHH)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'C=C(C[C]=O)CCC(2787)'],
    products = ['[CH2]C(C[C]=O)CCC(1147)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['npropyl(83)', 'C=CC[C]=O(2390)'],
    products = ['[CH2]C(C[C]=O)CCC(1147)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]C([CH]CC)CC=O(2794)'],
    products = ['[CH2]C(C[C]=O)CCC(1147)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]C(C[CH]C)CC=O(2796)'],
    products = ['[CH2]C(C[C]=O)CCC(1147)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]CCC(C)C[C]=O(2797)'],
    products = ['[CH2]C(C[C]=O)CCC(1147)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]CCC([CH2])CC=O(2798)'],
    products = ['[CH2]C(C[C]=O)CCC(1147)'],
...
reaction(
    label = 'reaction20',
    reactants = ['CH2(S)(23)', '[CH2]C(CC)C[C]=O(1131)'],
    products = ['[CH2]C(C[C]=O)CCC(1147)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[CH2]C([CH2])CCC(453)', 'CO(12)'],
    products = ['[CH2]C(C[C]=O)CCC(1147)'],
...
reaction(
    label = 'reaction27',
    reactants = ['[C]=O(361)', '[CH2]C([CH2])CCC(453)'],
    products = ['[CH2]C(C[C]=O)CCC(1147)'],
