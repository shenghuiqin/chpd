species(
    ...
    E0 = (-201.765,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2782.5,750,1395,475,1775,1000,3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,1380,1390,370,380,2900,435,200,800,960,1120,1280,1440,1600],'cm^-1')),
...
species(
    label = 'CCCC[CH]OC1OC1[O](14410)',
    structure = SMILES('CCCC[CH]OC1OC1[O]'),
    E0 = (-149.451,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (144.168,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.0013,0.110806,-0.000113738,6.7455e-08,-1.65099e-11,-17795.4,38.6497], Tmin=(100,'K'), Tmax=(983.304,'K')), NASAPolynomial(coeffs=[14.2198,0.0488883,-1.92869e-05,3.41931e-09,-2.29429e-13,-20788.8,-34.5273], Tmin=(983.304,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-149.451,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CCsJOCs) + radical(CCOJ)"""),
)

species(
    label = 'CCCCC1OC([O])C1[O](14411)',
    structure = SMILES('CCCCC1OC([O])C1[O]'),
    E0 = (-120.719,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (144.168,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.840356,0.0938591,-6.9485e-05,2.82723e-08,-4.7352e-12,-14334.4,38.288], Tmin=(100,'K'), Tmax=(1409.12,'K')), NASAPolynomial(coeffs=[17.2023,0.0426431,-1.49667e-05,2.47966e-09,-1.59262e-13,-19419.3,-54.9457], Tmin=(1409.12,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-120.719,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(515.497,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + ring(Oxetane) + radical(CCOJ) + radical(CC(C)OJ)"""),
)
...
species(
    label = 'CCCC=COC([O])C=O(14412)',
    structure = SMILES('CCCC=COC([O])C=O'),
    E0 = (-305.465,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2782.5,750,1395,475,1775,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,2750,2800,2850,1350,1500,750,1050,1375,1000,1380,1390,370,380,2900,435,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.11785,0.0980834,-6.93874e-05,1.45179e-08,2.74889e-12,-36542.2,40.8675], Tmin=(100,'K'), Tmax=(1037.76,'K')), NASAPolynomial(coeffs=[22.6501,0.0326283,-1.25861e-05,2.31701e-09,-1.63152e-13,-42883.8,-81.4665], Tmin=(1037.76,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-305.465,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(482.239,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-OdCsH) + radical(C=OCOJ)"""),
)

species(
    label = 'CCCC[CH]OC(=O)C=O(14413)',
    structure = SMILES('CCCC[CH]OC(=O)C=O'),
    E0 = (-379.117,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2782.5,750,1395,475,1775,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,200,800,900,1000,1100,1200,1300,1400,1500,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (143.16,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.328202,0.102491,-9.5865e-05,5.04296e-08,-1.14033e-11,-45447.4,35.7383], Tmin=(100,'K'), Tmax=(1026.25,'K')), NASAPolynomial(coeffs=[11.9167,0.0547636,-2.61057e-05,5.11288e-09,-3.63954e-13,-47960.7,-23.6538], Tmin=(1026.25,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-379.117,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(478.082,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-O2d(Cds-O2d)O2s) + group(Cds-O2d(Cds-O2d)H) + radical(CCsJOC(O))"""),
)
...
species(
    label = 'CCC[CH]COC([O])C=O(14414)',
    structure = SMILES('CCC[CH]COC([O])C=O'),
    E0 = (-182.319,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2782.5,750,1395,475,1775,1000,3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,1380,1390,370,380,2900,435,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (144.168,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.104271,0.0971332,-8.50143e-05,4.32651e-08,-9.68025e-12,-21785.8,41.8169], Tmin=(100,'K'), Tmax=(1023.59,'K')), NASAPolynomial(coeffs=[10.1248,0.057159,-2.64335e-05,5.1104e-09,-3.61198e-13,-23879.8,-7.77084], Tmin=(1023.59,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-182.319,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(C=OCOJ) + radical(CCJCO)"""),
)

species(
    label = 'CCCC[CH]O[C](O)C=O(14415)',
    structure = SMILES('CCCC[CH]OC(O)=C[O]'),
    E0 = (-287.387,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (144.168,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-3.15623,0.136287,-0.000146274,7.62101e-08,-1.5125e-11,-34289,41.6371], Tmin=(100,'K'), Tmax=(1320.56,'K')), NASAPolynomial(coeffs=[33.178,0.019005,-4.84838e-06,6.70458e-10,-4.00151e-14,-43255.3,-141.372], Tmin=(1320.56,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-287.387,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsOsH) + radical(CCsJOC(O)) + radical(C=COJ)"""),
)

species(
    label = 'CCCCCO[C]([O])C=O(14416)',
    structure = SMILES('CCCCCOC([O])=C[O]'),
    E0 = (-339.852,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (144.168,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.82378,0.11346,-9.37134e-05,3.13304e-08,-1.47732e-12,-40652.3,38.7875], Tmin=(100,'K'), Tmax=(1030.18,'K')), NASAPolynomial(coeffs=[25.5621,0.0322607,-1.20822e-05,2.18835e-09,-1.52907e-13,-47628.6,-100.621], Tmin=(1030.18,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-339.852,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsOsH) + radical(C=COJ) + radical(C=COJ)"""),
)

species(
    label = 'CC[CH]CCOC([O])C=O(14417)',
    structure = SMILES('CC[CH]CCOC([O])C=O'),
    E0 = (-187.762,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (144.168,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.496748,0.108447,-0.00013895,1.19799e-07,-4.38518e-11,-22429.9,43.2743], Tmin=(100,'K'), Tmax=(776.727,'K')), NASAPolynomial(coeffs=[5.43377,0.0651861,-3.0839e-05,5.92362e-09,-4.13108e-13,-22967.4,18.6314], Tmin=(776.727,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-187.762,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(RCCJCC) + radical(C=OCOJ)"""),
)

species(
    label = 'CCCC[CH]OC(O)[C]=O(14418)',
    structure = SMILES('CCCC[CH]OC(O)[C]=O'),
    E0 = (-290.827,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (144.168,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.871502,0.113557,-0.000121482,7.33949e-08,-1.85307e-11,-34808.4,41.4216], Tmin=(100,'K'), Tmax=(944.135,'K')), NASAPolynomial(coeffs=[13.5918,0.052281,-2.41286e-05,4.65272e-09,-3.28247e-13,-37539.4,-27.5239], Tmin=(944.135,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-290.827,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(498.868,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(CsCJ=O) + radical(CCsJOCs)"""),
)

species(
    label = 'C[CH]CCCOC([O])C=O(14419)',
    structure = SMILES('C[CH]CCCOC([O])C=O'),
    E0 = (-187.774,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2782.5,750,1395,475,1775,1000,3025,407.5,1350,352.5,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (144.168,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.501984,0.107551,-0.000132073,1.08906e-07,-3.87898e-11,-22430,43.4678], Tmin=(100,'K'), Tmax=(757.817,'K')), NASAPolynomial(coeffs=[6.426,0.0634168,-2.97391e-05,5.70626e-09,-3.98449e-13,-23262.8,13.3989], Tmin=(757.817,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-187.774,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(C=OCOJ) + radical(RCCJC)"""),
)

species(
    label = 'CCCCCOC([O])[C]=O(14420)',
    structure = SMILES('CCCCCOC([O])[C]=O'),
    E0 = (-227.55,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (144.168,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.336115,0.103586,-0.000105535,6.65154e-08,-1.84714e-11,-27218.9,40.842], Tmin=(100,'K'), Tmax=(843.49,'K')), NASAPolynomial(coeffs=[8.8162,0.0601836,-2.83509e-05,5.51072e-09,-3.90194e-13,-28762.9,-1.75479], Tmin=(843.49,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-227.55,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(CsCJ=O) + radical(C=OCOJ)"""),
)

species(
    label = 'CCC[CH][CH]OC(O)C=O(14421)',
    structure = SMILES('CCC[CH][CH]OC(O)C=O'),
    E0 = (-245.596,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (144.168,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.776659,0.108707,-0.000106503,5.73016e-08,-1.2813e-11,-29369.3,42.8885], Tmin=(100,'K'), Tmax=(1060.07,'K')), NASAPolynomial(coeffs=[15.0286,0.0490689,-2.2117e-05,4.23271e-09,-2.97785e-13,-32720.3,-34.285], Tmin=(1060.07,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-245.596,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(498.868,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(CCJCO) + radical(CCsJOCs)"""),
)

species(
    label = '[CH2]CCCCOC([O])C=O(14422)',
    structure = SMILES('[CH2]CCCCOC([O])C=O'),
    E0 = (-176.974,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (144.168,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.359502,0.104079,-0.000106915,6.79112e-08,-1.89649e-11,-21135.3,42.0334], Tmin=(100,'K'), Tmax=(840.074,'K')), NASAPolynomial(coeffs=[8.89223,0.0600272,-2.82564e-05,5.48931e-09,-3.8851e-13,-22689.7,-0.988576], Tmin=(840.074,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-176.974,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(C=OCOJ) + radical(RCCJ)"""),
)

species(
    label = 'CC[CH]C[CH]OC(O)C=O(14423)',
    structure = SMILES('CC[CH]C[CH]OC(O)C=O'),
    E0 = (-251.039,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (144.168,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.946964,0.117162,-0.000149235,1.17383e-07,-3.89974e-11,-30022.8,43.5642], Tmin=(100,'K'), Tmax=(743.677,'K')), NASAPolynomial(coeffs=[9.74283,0.0581486,-2.71471e-05,5.19656e-09,-3.62384e-13,-31570.8,-4.56025], Tmin=(743.677,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-251.039,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(498.868,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(RCCJCC) + radical(CCsJOCs)"""),
)

species(
    label = 'C[CH]CC[CH]OC(O)C=O(14424)',
    structure = SMILES('C[CH]CC[CH]OC(O)C=O'),
    E0 = (-251.051,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (144.168,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.886167,0.115378,-0.000138655,1.00606e-07,-3.08114e-11,-30025.8,43.5273], Tmin=(100,'K'), Tmax=(784.552,'K')), NASAPolynomial(coeffs=[10.6596,0.0565181,-2.61317e-05,4.99997e-09,-3.495e-13,-31837.6,-9.37411], Tmin=(784.552,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-251.051,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(498.868,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(CCsJOCs) + radical(RCCJC)"""),
)

species(
    label = '[CH2]CCC[CH]OC(O)C=O(14425)',
    structure = SMILES('[CH2]CCC[CH]OC(O)C=O'),
    E0 = (-240.251,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (144.168,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.892335,0.114015,-0.000122716,7.45707e-08,-1.89159e-11,-28724.8,42.6042], Tmin=(100,'K'), Tmax=(940.56,'K')), NASAPolynomial(coeffs=[13.6554,0.0521467,-2.40474e-05,4.63455e-09,-3.26838e-13,-31461.4,-26.6888], Tmin=(940.56,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-240.251,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(498.868,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(CCsJOCs) + radical(RCCJ)"""),
)
...
species(
    label = 'CCCC[CH]OC1[CH]OO1(14426)',
    structure = SMILES('CCCC[CH]OC1[CH]OO1'),
    E0 = (63.8184,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (144.168,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.661798,0.110441,-0.000114428,7.02935e-08,-1.85823e-11,7836.68,34.5701], Tmin=(100,'K'), Tmax=(892.078,'K')), NASAPolynomial(coeffs=[10.8691,0.058739,-2.74951e-05,5.32847e-09,-3.76732e-13,5779.34,-19.7432], Tmin=(892.078,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(63.8184,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(12dioxetane) + radical(CCsJOO) + radical(CCsJOCs)"""),
)
...
species(
    ...
    molecularWeight = (144.168,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.18121,0.09178,-6.57619e-05,2.49763e-08,-4.15789e-12,-68790.9,34.4083], Tmin=(100,'K'), Tmax=(1300.42,'K')), NASAPolynomial(coeffs=[11.0103,0.0584705,-2.73401e-05,5.2791e-09,-3.71178e-13,-71607.4,-20.6802], Tmin=(1300.42,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-573.044,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-O2d(Cds-O2d)O2s) + group(Cds-O2d(Cds-O2d)H)"""),
)

species(
    label = 'CCCC=COC(O)C=O(14428)',
    structure = SMILES('CCCC=COC(O)C=O'),
    E0 = (-549.198,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (144.168,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.31727,0.100529,-6.39647e-05,4.36917e-09,7.12341e-12,-65847.5,40.8023], Tmin=(100,'K'), Tmax=(1016.29,'K')), NASAPolynomial(coeffs=[24.1558,0.0329851,-1.25597e-05,2.32358e-09,-1.65226e-13,-72714.6,-90.8144], Tmin=(1016.29,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-549.198,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-OdCsH)"""),
)
...
species(
    label = 'CCC[CH]OC([O])C=O(14429)',
    structure = SMILES('CCC[CH]OC([O])C=O'),
    E0 = (-177.984,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2782.5,750,1395,475,1775,1000,3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,1380,1390,370,380,2900,435,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.111423,0.0963993,-0.000105129,6.61803e-08,-1.75208e-11,-21263.6,36.5487], Tmin=(100,'K'), Tmax=(900.781,'K')), NASAPolynomial(coeffs=[11.236,0.0460116,-2.1225e-05,4.08506e-09,-2.87638e-13,-23308,-17.0107], Tmin=(900.781,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-177.984,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(CCsJOCs) + radical(C=OCOJ)"""),
)
...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.318169,0.0893119,-7.20019e-05,3.024e-08,-5.18626e-12,-10817.2,33.2219], Tmin=(100,'K'), Tmax=(1370.01,'K')), NASAPolynomial(coeffs=[17.2474,0.0380253,-1.58486e-05,2.91479e-09,-1.99895e-13,-15630.1,-57.0519], Tmin=(1370.01,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-91.2686,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsOsHH) + radical(CCsJOCs) + radical(OCOJ)"""),
)

species(
    label = '[CH2]C(CCC)OC([O])C=O(14430)',
    structure = SMILES('[CH2]C(CCC)OC([O])C=O'),
    E0 = (-182.261,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2782.5,750,1395,475,1775,1000,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (144.168,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.88424,0.115584,-0.000135185,9.42747e-08,-2.77906e-11,-21752.4,41.5319], Tmin=(100,'K'), Tmax=(812.645,'K')), NASAPolynomial(coeffs=[11.0785,0.0566998,-2.6494e-05,5.10751e-09,-3.59075e-13,-23696.7,-13.6996], Tmin=(812.645,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-182.261,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(C=OCOJ) + radical(CJC(C)OC)"""),
)
...
species(
    label = 'CCCC[CH]OC([O])=CO(14431)',
    structure = SMILES('CCCC[CH]OC(=O)[CH]O'),
    E0 = (-347.67,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3000,3050,390,425,1340,1360,335,370,3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,300,800,800,800,800,800,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (144.168,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.778784,0.110339,-0.000108422,5.98221e-08,-1.38933e-11,-41647.3,38.938], Tmin=(100,'K'), Tmax=(1016.5,'K')), NASAPolynomial(coeffs=[13.7035,0.0533506,-2.4326e-05,4.66847e-09,-3.28693e-13,-44591.5,-31.1677], Tmin=(1016.5,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-347.67,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(498.868,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)OsHH) + group(Cds-OdCsOs) + radical(CCsJOC(O)) + radical(OCJC=O)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['CCCC[CH]OC([O])C=O(13349)'],
...
reaction(
    label = 'reaction2',
    reactants = ['CCCC[CH]OC([O])C=O(13349)'],
    products = ['CCCC[CH]OC1OC1[O](14410)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CCCC[CH]OC([O])C=O(13349)'],
    products = ['CCCCC1OC([O])C1[O](14411)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', 'CCCC=COC([O])C=O(14412)'],
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)', 'CCCC[CH]OC(=O)C=O(14413)'],
    products = ['CCCC[CH]OC([O])C=O(13349)'],
    transitionState = 'TS5',
...
reaction(
    ...
    products = ['CCCC[CH]OC([O])C=O(13349)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(8e+09,'cm^3/(mol*s)'), n=1.39, Ea=(67.9652,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), comment="""Estimated using template [Od_CO-CsH;YJ] for rate rule [Od_CO-CsH;CJ]
...
reaction(
    label = 'reaction7',
    reactants = ['npropyl(83)', 'C=COC([O])C=O(4448)'],
    products = ['CCCC[CH]OC([O])C=O(13349)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['HCO(16)', 'CCCC[CH]OC=O(11683)'],
    products = ['CCCC[CH]OC([O])C=O(13349)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['CCC[CH]COC([O])C=O(14414)'],
    products = ['CCCC[CH]OC([O])C=O(13349)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['CCCC[CH]OC([O])C=O(13349)'],
    products = ['CCCC[CH]O[C](O)C=O(14415)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CC[CH]CCOC([O])C=O(14417)'],
    products = ['CCCC[CH]OC([O])C=O(13349)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CCCC[CH]OC([O])C=O(13349)'],
    products = ['CCCC[CH]OC(O)[C]=O(14418)'],
...
reaction(
    label = 'reaction14',
    reactants = ['C[CH]CCCOC([O])C=O(14419)'],
    products = ['CCCC[CH]OC([O])C=O(13349)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CCCC[CH]OC([O])C=O(13349)'],
    products = ['CCC[CH][CH]OC(O)C=O(14421)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]CCCCOC([O])C=O(14422)'],
    products = ['CCCC[CH]OC([O])C=O(13349)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CCCC[CH]OC([O])C=O(13349)'],
    products = ['CC[CH]C[CH]OC(O)C=O(14423)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CCCC[CH]OC([O])C=O(13349)'],
    products = ['C[CH]CC[CH]OC(O)C=O(14424)'],
...
reaction(
    label = 'reaction20',
    reactants = ['CCCC[CH]OC([O])C=O(13349)'],
    products = ['[CH2]CCC[CH]OC(O)C=O(14425)'],
...
reaction(
    label = 'reaction22',
    reactants = ['CCCC[CH]OC([O])C=O(13349)'],
    products = ['CCCC[CH]OC1[CH]OO1(14426)'],
...
reaction(
    label = 'reaction26',
    reactants = ['CH2(S)(23)', 'CCC[CH]OC([O])C=O(14429)'],
    products = ['CCCC[CH]OC([O])C=O(13349)'],
...
reaction(
    label = 'reaction27',
    reactants = ['CO(12)', 'CCCC[CH]OC[O](11658)'],
    products = ['CCCC[CH]OC([O])C=O(13349)'],
...
reaction(
    label = 'reaction28',
    reactants = ['[CH2]C(CCC)OC([O])C=O(14430)'],
    products = ['CCCC[CH]OC([O])C=O(13349)'],
...
reaction(
    label = 'reaction31',
    reactants = ['CCCC[CH]OC([O])=CO(14431)'],
    products = ['CCCC[CH]OC([O])C=O(13349)'],
...
reaction(
    label = 'reaction32',
    reactants = ['[CH]CCCC(141)', '[O]C([O])C=O(3622)'],
    products = ['CCCC[CH]OC([O])C=O(13349)'],
