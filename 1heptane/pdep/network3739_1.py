...
species(
    ...
    molecularWeight = (128.126,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.821974,0.0633027,-3.41981e-05,3.86677e-09,2.5188e-12,-18658,29.244], Tmin=(100,'K'), Tmax=(1003.01,'K')), NASAPolynomial(coeffs=[10.5402,0.0369289,-1.3274e-05,2.26727e-09,-1.50281e-13,-21230.3,-20.7751], Tmin=(1003.01,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-156.13,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(399.095,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-(Cds-O2d)CsHH) + group(Cds-OdCsH) + ring(Tetrahydrofuran) + radical(CCOJ) + radical(CCCJ=O)"""),
)
...
species(
    label = 'O=[C]CC(=O)CCC=O(21466)',
    structure = SMILES('O=[C]CC(=O)CCC=O'),
    E0 = (-299.696,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,1855,455,950,375,552.5,462.5,1710,2782.5,750,1395,475,1775,1000,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.173705,0.105817,-0.000180096,1.69032e-07,-6.08644e-11,-35908.2,33.1196], Tmin=(100,'K'), Tmax=(852.233,'K')), NASAPolynomial(coeffs=[5.88689,0.0469949,-2.30994e-05,4.39695e-09,-3.00419e-13,-35838.1,11.3217], Tmin=(852.233,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-299.696,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)CsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-(Cds-O2d)(Cds-O2d)HH) + group(Cds-OdCsCs) + group(Cds-OdCsH) + group(Cds-OdCsH) + radical(C=OCCJ=O)"""),
)
...
species(
    ...
    molecularWeight = (128.126,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.422541,0.110146,-0.000181499,1.65299e-07,-5.8184e-11,-23107.2,36.6306], Tmin=(100,'K'), Tmax=(854.874,'K')), NASAPolynomial(coeffs=[7.46686,0.0462865,-2.21716e-05,4.17915e-09,-2.84145e-13,-23471.5,5.56436], Tmin=(854.874,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-193.345,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cds-OdCsH) + group(Cds-OdCsH) + radical(CCCJ=O) + radical(C2CsJOH)"""),
)
...
species(
    label = 'O=[C]CC(O)[CH]CC=O(21470)',
    structure = SMILES('O=[C]CC(O)[CH]CC=O'),
    E0 = (-170.071,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,3615,1277.5,1000,1855,455,950,1380,1390,370,380,2900,435,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2782.5,750,1395,475,1775,1000,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[O][C](CC=O)CCC=O(21472)',
    structure = SMILES('[O][C](CC=O)CCC=O'),
    E0 = (-122.945,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,360,370,350,2695,2870,700,800,1380,1410,450,500,1750,1800,900,1100,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (128.126,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.165842,0.102965,-0.000159971,1.45716e-07,-5.25385e-11,-14647.8,34.6977], Tmin=(100,'K'), Tmax=(826.61,'K')), NASAPolynomial(coeffs=[6.37887,0.0497185,-2.41954e-05,4.63528e-09,-3.19961e-13,-14992.7,8.82824], Tmin=(826.61,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-122.945,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cds-OdCsH) + group(Cds-OdCsH) + radical(C2CsJOH) + radical(CC(C)OJ)"""),
)

species(
    label = 'O=[C]CC(O)C[CH]C=O(21473)',
    ...
    molecularWeight = (128.126,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.402256,0.0916498,-9.45088e-05,5.01016e-08,-1.04954e-11,-27105.4,36.8471], Tmin=(100,'K'), Tmax=(1163.2,'K')), NASAPolynomial(coeffs=[18.579,0.0263772,-1.03368e-05,1.85998e-09,-1.27042e-13,-31521.2,-57.596], Tmin=(1163.2,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-226.721,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-OdCsH) + radical(CCCJ=O) + radical(C=COJ)"""),
)

species(
    label = '[O]C([CH]CC=O)CC=O(21474)',
    structure = SMILES('[O]C([CH]CC=O)CC=O'),
    E0 = (-99.6709,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (128.126,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.665544,0.0821299,-8.30874e-05,3.91414e-08,-2.80431e-13,-11875.8,34.8542], Tmin=(100,'K'), Tmax=(581.074,'K')), NASAPolynomial(coeffs=[7.49955,0.0468523,-2.23949e-05,4.35692e-09,-3.07773e-13,-12868.7,3.88486], Tmin=(581.074,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-99.6709,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cds-OdCsH) + group(Cds-OdCsH) + radical(CCJCO) + radical(CC(C)OJ)"""),
)

species(
    label = 'O=[C]CCC(O)C[C]=O(21475)',
    structure = SMILES('O=[C]CCC(O)C[C]=O'),
    E0 = (-210.012,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.126,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.324598,0.10415,-0.000158527,1.35765e-07,-4.59585e-11,-25111.6,37.6751], Tmin=(100,'K'), Tmax=(843.136,'K')), NASAPolynomial(coeffs=[9.59347,0.0414605,-1.91789e-05,3.58701e-09,-2.43959e-13,-26228.3,-5.18566], Tmin=(843.136,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-210.012,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cds-OdCsH) + group(Cds-OdCsH) + radical(CCCJ=O) + radical(CCCJ=O)"""),
)

species(
    label = '[O]C(C[CH]C=O)CC=O(21476)',
    structure = SMILES('[O]C=CCC([O])CC=O'),
    E0 = (-156.321,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.126,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.290821,0.0860895,-7.80884e-05,3.60741e-08,-6.62614e-12,-18639.8,35.4401], Tmin=(100,'K'), Tmax=(1312.81,'K')), NASAPolynomial(coeffs=[18.9857,0.0273563,-1.09811e-05,1.99615e-09,-1.36678e-13,-23701.1,-62.8047], Tmin=(1312.81,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-156.321,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(390.78,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cds-CdsCsH) + group(Cds-OdCsH) + group(Cds-CdsOsH) + radical(C=COJ) + radical(CC(C)OJ)"""),
)

species(
    label = '[O]C(CC=O)CC[C]=O(21477)',
    structure = SMILES('[O]C(CC=O)CC[C]=O'),
    E0 = (-139.612,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,1855,455,950,1380,1390,370,380,2900,435,2782.5,750,1395,475,1775,1000,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    ...
    molecularWeight = (128.126,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.451915,0.0666241,-2.05472e-05,-2.77965e-08,1.86147e-11,5784.37,28.6352], Tmin=(100,'K'), Tmax=(902.131,'K')), NASAPolynomial(coeffs=[16.3419,0.0275025,-7.59846e-06,1.13587e-09,-7.2638e-14,1642.35,-53.4553], Tmin=(902.131,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(46.943,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(399.095,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cds-OdCsH) + ring(12dioxane) + radical(CCsJOOC) + radical(CCCJ=O)"""),
)
...
species(
    ...
    molecularWeight = (128.126,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.240683,0.092193,-0.000133053,1.20356e-07,-4.42961e-11,-55165.7,33.0305], Tmin=(100,'K'), Tmax=(801.983,'K')), NASAPolynomial(coeffs=[5.31651,0.050527,-2.45426e-05,4.73391e-09,-3.29476e-13,-55454,12.9406], Tmin=(801.983,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-459.722,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)CsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-(Cds-O2d)(Cds-O2d)HH) + group(Cds-OdCsCs) + group(Cds-OdCsH) + group(Cds-OdCsH)"""),
)
...
species(
    label = 'C=COCC([O])C[C]=O(21482)',
    structure = SMILES('C=COCC([O])C[C]=O'),
    E0 = (-98.0159,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2950,3100,1380,975,1025,1650,1855,455,950,1380,1390,370,380,2900,435,3010,987.5,1337.5,450,1655,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (128.126,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.931995,0.0987746,-0.000104383,5.50086e-08,-1.12586e-11,-11602.8,35.8931], Tmin=(100,'K'), Tmax=(1201.93,'K')), NASAPolynomial(coeffs=[22.3816,0.0211863,-7.55178e-06,1.29941e-09,-8.70193e-14,-17207,-80.8694], Tmin=(1201.93,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-98.0159,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsOsH) + group(Cds-OdCsH) + group(Cds-CdsHH) + radical(CCCJ=O) + radical(CC(C)OJ)"""),
)

species(
    label = '[O]C(C[C]=O)CC=CO(21483)',
    structure = SMILES('[O]C(C[C]=O)CC=CO'),
    E0 = (-137.823,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2995,3025,975,1000,1300,1375,400,500,1630,1680,1855,455,950,3615,1277.5,1000,1380,1390,370,380,2900,435,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (128.126,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.772916,0.0961055,-9.74141e-05,4.6285e-08,-7.53806e-12,-16396.6,36.5731], Tmin=(100,'K'), Tmax=(995.85,'K')), NASAPolynomial(coeffs=[21.7353,0.0209364,-7.14448e-06,1.22085e-09,-8.26651e-14,-21635.2,-75.7166], Tmin=(995.85,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-137.823,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-OdCsH) + radical(CC(C)OJ) + radical(CCCJ=O)"""),
)
...
species(
    label = 'O=[C]C[CH]CCC=O(21484)',
    structure = SMILES('O=[C]C[CH]CCC=O'),
    E0 = (2.39936,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,1855,455,950,2782.5,750,1395,475,1775,1000,3025,407.5,1350,352.5,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.4751,0.0658408,-3.57573e-05,-4.98695e-08,6.60028e-11,368.998,30.7001], Tmin=(100,'K'), Tmax=(486.561,'K')), NASAPolynomial(coeffs=[6.432,0.0429115,-2.00095e-05,3.83086e-09,-2.67272e-13,-324.32,8.18908], Tmin=(486.561,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(2.39936,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cds-OdCsH) + group(Cds-OdCsH) + radical(CCCJ=O) + radical(CCJCC=O)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[O]C(C[C]=O)CCC=O(21330)'],
    products = ['[O]C1CCC(C[C]=O)O1(21464)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', 'O=[C]CC(=O)CCC=O(21466)'],
    products = ['[O]C(C[C]=O)CCC=O(21330)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['O=[C]CC=O(732)', 'CH2CH2CHO(560)'],
    products = ['[O]C(C[C]=O)CCC=O(21330)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['[O]C(C[C]=O)CCC=O(21330)'],
    products = ['O=[C]C[C](O)CCC=O(21468)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['O=[C]CC(O)[CH]CC=O(21470)'],
    products = ['[O]C(C[C]=O)CCC=O(21330)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[O][C](CC=O)CCC=O(21472)'],
    products = ['[O]C(C[C]=O)CCC=O(21330)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[O]C(C[C]=O)CCC=O(21330)'],
    products = ['O=[C]CC(O)C[CH]C=O(21473)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[O]C([CH]CC=O)CC=O(21474)'],
    products = ['[O]C(C[C]=O)CCC=O(21330)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[O]C(C[C]=O)CCC=O(21330)'],
    products = ['O=[C]CCC(O)C[C]=O(21475)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[O]C(C[C]=O)CCC=O(21330)'],
    products = ['[O]C(C[CH]C=O)CC=O(21476)'],
    transitionState = 'TS17',
    kinetics = Arrhenius(A=(10364.8,'s^-1'), n=1.91833, Ea=(60.5402,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R5H_CCC;Y_rad_out;Cs_H_out_H/OneDe] for rate rule [R5H_CCC;CO_rad_out;Cs_H_out_H/CO]
Euclidian distance = 1.41421356237
Multiplied by reaction path degeneracy 2.0
family: intra_H_migration"""),
)
...
reaction(
    label = 'reaction18',
    reactants = ['[O]C(CC=O)CC[C]=O(21477)'],
    products = ['[O]C(C[C]=O)CCC=O(21330)'],
    transitionState = 'TS18',
    kinetics = Arrhenius(A=(564.492,'s^-1'), n=2.19647, Ea=(60.7245,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R6H_SSSSS;Y_rad_out;XH_out] for rate rule [R6H_SSSSS;CO_rad_out;CO_H_out]
Euclidian distance = 1.41421356237
family: intra_H_migration"""),
)
...
reaction(
    label = 'reaction20',
    reactants = ['[O]C(C[C]=O)CCC=O(21330)'],
    products = ['O=[C]CC1CC[CH]OO1(21478)'],
...
reaction(
    label = 'reaction24',
    reactants = ['CO(12)', 'CCC([O])C[C]=O(10713)'],
    products = ['[O]C(C[C]=O)CCC=O(21330)'],
...
reaction(
    label = 'reaction27',
    reactants = ['CO(12)', '[CH2]C([O])CCC=O(18182)'],
    products = ['[O]C(C[C]=O)CCC=O(21330)'],
...
reaction(
    label = 'reaction28',
    reactants = ['C=COCC([O])C[C]=O(21482)'],
    products = ['[O]C(C[C]=O)CCC=O(21330)'],
...
reaction(
    label = 'reaction29',
    reactants = ['[O]C(C[C]=O)CC=CO(21483)'],
    products = ['[O]C(C[C]=O)CCC=O(21330)'],
...
reaction(
    label = 'reaction30',
    reactants = ['O(4)', 'O=[C]C[CH]CCC=O(21484)'],
    products = ['[O]C(C[C]=O)CCC=O(21330)'],
...
reaction(
    label = 'reaction31',
    reactants = ['[C]=O(361)', '[CH2]C([O])CCC=O(18182)'],
    products = ['[O]C(C[C]=O)CCC=O(21330)'],
