...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.567034,0.0684633,-3.83082e-05,1.05906e-08,-1.19049e-12,11247.7,31.0738], Tmin=(100,'K'), Tmax=(1979.38,'K')), NASAPolynomial(coeffs=[16.5224,0.0362196,-1.3873e-05,2.36056e-09,-1.5099e-13,4931.44,-56.7953], Tmin=(1979.38,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(92.4438,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(RCCJC)"""),
)

species(
    label = '[CH2]C(C=CC)CC(1457)',
    structure = SMILES('[CH2]C(C=CC)CC'),
    E0 = (97.0026,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2995,3025,975,1000,1300,1375,400,500,1630,1680,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,321.487,321.487],'cm^-1')),
        HinderedRotor(inertia=(0.0828335,'amu*angstrom^2'), symmetry=1, barrier=(6.0752,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00163108,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0828336,'amu*angstrom^2'), symmetry=1, barrier=(6.0752,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0828334,'amu*angstrom^2'), symmetry=1, barrier=(6.0752,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.223599,'amu*angstrom^2'), symmetry=1, barrier=(16.3993,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (97.1781,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.511661,0.0669887,-2.75754e-05,-4.61875e-09,4.93198e-12,11800.5,30.4326], Tmin=(100,'K'), Tmax=(1080.01,'K')), NASAPolynomial(coeffs=[12.0559,0.0413764,-1.58137e-05,2.81851e-09,-1.91751e-13,8307.09,-30.7791], Tmin=(1080.01,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(97.0026,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Isobutyl)"""),
)
...
species(
    ...
    molecularWeight = (98.1861,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.14834,0.0620138,-2.77807e-05,5.23296e-09,-3.58258e-13,19513.2,26.447], Tmin=(100,'K'), Tmax=(2855.94,'K')), NASAPolynomial(coeffs=[43.4663,0.0110844,-4.67663e-06,6.90628e-10,-3.51196e-14,-6917.46,-221.203], Tmin=(2855.94,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(161.877,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(482.239,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Tertalkyl) + radical(RCCJC)"""),
)
...
species(
    ...
    molecularWeight = (98.1861,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.951017,0.0669517,-3.32002e-05,7.51639e-09,-6.61889e-13,20675.5,32.3084], Tmin=(100,'K'), Tmax=(2584.4,'K')), NASAPolynomial(coeffs=[25.6686,0.0286946,-1.09953e-05,1.78839e-09,-1.07789e-13,7899.57,-110.409], Tmin=(2584.4,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(170.997,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(482.239,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Cs_S) + radical(RCCJC)"""),
)

species(
    label = 'C[CH][CH]C(C)CC(1461)',
    ...
    molecularWeight = (98.1861,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.951017,0.0669517,-3.32002e-05,7.5164e-09,-6.61889e-13,20675.5,32.3084], Tmin=(100,'K'), Tmax=(2584.33,'K')), NASAPolynomial(coeffs=[25.6685,0.0286948,-1.09954e-05,1.78841e-09,-1.0779e-13,7899.66,-110.408], Tmin=(2584.33,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(170.997,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(482.239,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJC) + radical(Cs_S)"""),
)

species(
    label = '[CH2][C](CC)CCC(445)',
    ...
    molecularWeight = (98.1861,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.750935,0.0760595,-5.83798e-05,3.1446e-08,-8.32658e-12,20861.5,30.654], Tmin=(100,'K'), Tmax=(838.452,'K')), NASAPolynomial(coeffs=[4.70913,0.0571759,-2.45965e-05,4.584e-09,-3.17087e-13,20197.7,12.2555], Tmin=(838.452,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(172.513,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(482.239,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Tertalkyl) + radical(Isobutyl)"""),
)
...
species(
    label = '[CH2]CC(C)C[CH]C(447)',
    structure = SMILES('[CH2]CC(C)C[CH]C'),
    E0 = (181.701,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3025,407.5,1350,352.5,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,221.825,821.825,1746.16],'cm^-1')),
    ...
    molecularWeight = (98.1861,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.677792,0.0704954,-3.84818e-05,1.03226e-08,-1.13404e-12,21974.4,32.5042], Tmin=(100,'K'), Tmax=(1970.32,'K')), NASAPolynomial(coeffs=[15.0066,0.0414061,-1.63362e-05,2.82953e-09,-1.83301e-13,16327.9,-46.3418], Tmin=(1970.32,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(181.701,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(482.239,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJ) + radical(RCCJC)"""),
)
...
species(
    ...
    molecularWeight = (98.1861,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.677791,0.0704955,-3.84818e-05,1.03226e-08,-1.13404e-12,21974.4,32.5042], Tmin=(100,'K'), Tmax=(1970.3,'K')), NASAPolynomial(coeffs=[15.0065,0.0414062,-1.63362e-05,2.82954e-09,-1.83302e-13,16327.9,-46.3414], Tmin=(1970.3,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(181.701,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(482.239,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJC) + radical(RCCJ)"""),
)

species(
    label = 'C=C(CC)CCC(451)',
...
species(
    ...
    molecularWeight = (98.1861,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.501228,0.065168,-1.43763e-05,-1.83514e-08,9.2138e-12,-12863.1,28.6914], Tmin=(100,'K'), Tmax=(1090,'K')), NASAPolynomial(coeffs=[12.4945,0.0443832,-1.77371e-05,3.2537e-09,-2.25367e-13,-16857.5,-36.5319], Tmin=(1090,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-108.08,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(486.397,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH)"""),
)

species(
    label = 'C=CCC(C)CC(1464)',
    ...
    molecularWeight = (98.1861,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.462611,0.0651511,-1.10908e-05,-2.36781e-08,1.14817e-11,-11114.2,29.2324], Tmin=(100,'K'), Tmax=(1064.53,'K')), NASAPolynomial(coeffs=[13.148,0.0435199,-1.72954e-05,3.18165e-09,-2.21523e-13,-15290.1,-39.6892], Tmin=(1064.53,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-93.5568,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(486.397,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'C=C(CC)C[CH]C(1456)'],
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', '[CH2]C(C=CC)CC(1457)'],
    products = ['[CH2]C(CC)C[CH]C(448)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', '[CH2]C(CC)CC=C(1458)'],
    products = ['[CH2]C(CC)C[CH]C(448)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['C=CC[CH]C(380)', 'C2H5(29)'],
    products = ['[CH2]C(CC)C[CH]C(448)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction28',
    reactants = ['[CH2]C([CH2])CC(429)', 'CHCH3(T)(95)'],
    products = ['[CH2]C(CC)C[CH]C(448)'],
