...
species(
    label = 'CH3CHCHO(10571)',
    structure = SMILES('C[CH]C=O'),
    E0 = (-39.1063,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,2782.5,750,1395,475,1775,1000],'cm^-1')),
        HinderedRotor(inertia=(0.499799,'amu*angstrom^2'), symmetry=1, barrier=(11.4914,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00782855,'amu*angstrom^2'), symmetry=1, barrier=(30.7535,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
