...
species(
    label = 'C=C(C[CH]C)OO(15012)',
    structure = SMILES('C=C(C[CH]C)OO'),
    E0 = (64.0805,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,2950,3100,1380,975,1025,1650,3615,1310,387.5,850,1000,350,440,435,1725,2750,2850,1437.5,1250,1305,750,350,272.134,272.154],'cm^-1')),
        HinderedRotor(inertia=(0.165309,'amu*angstrom^2'), symmetry=1, barrier=(8.6878,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00227608,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0022762,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.165298,'amu*angstrom^2'), symmetry=1, barrier=(8.68777,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00753071,'amu*angstrom^2'), symmetry=1, barrier=(44.8483,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (101.124,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.27081,0.064839,-5.74958e-05,3.21872e-08,-8.19858e-12,7801.27,28.9722], Tmin=(100,'K'), Tmax=(898.257,'K')), NASAPolynomial(coeffs=[6.44107,0.0418155,-1.90487e-05,3.65251e-09,-2.5689e-13,6872.43,4.58347], Tmin=(898.257,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(64.0805,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(RCCJC)"""),
)

species(
    label = '[CH2]C(C=CC)OO(15013)',
    structure = SMILES('[CH2]C(C=CC)OO'),
    E0 = (60.1135,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,3615,1310,387.5,850,1000,3000,3100,440,815,1455,1000,1380,1390,370,380,2900,435,1614.04],'cm^-1')),
        HinderedRotor(inertia=(0.847522,'amu*angstrom^2'), symmetry=1, barrier=(19.4862,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.847451,'amu*angstrom^2'), symmetry=1, barrier=(19.4846,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.353887,'amu*angstrom^2'), symmetry=1, barrier=(8.13657,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.847415,'amu*angstrom^2'), symmetry=1, barrier=(19.4837,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.847482,'amu*angstrom^2'), symmetry=1, barrier=(19.4853,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (101.124,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.573986,0.069879,-5.5617e-05,2.25931e-08,-3.72073e-12,7357.64,30.2098], Tmin=(100,'K'), Tmax=(1427.51,'K')), NASAPolynomial(coeffs=[15.3916,0.0283586,-1.19879e-05,2.2176e-09,-1.52352e-13,3127.19,-46.5508], Tmin=(1427.51,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(60.1135,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(CJCOOH)"""),
)
...
species(
    label = 'C[CH]C[C](C)OO(1939)',
    structure = SMILES('C[CH]C[C](C)OO'),
    E0 = (112.296,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,360,370,350,3615,1310,387.5,850,1000,3025,407.5,1350,352.5,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,200,800],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (102.132,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.735433,0.0788415,-9.87986e-05,8.53863e-08,-3.13371e-11,13616.8,29.7161], Tmin=(100,'K'), Tmax=(790.917,'K')), NASAPolynomial(coeffs=[4.37541,0.0496814,-2.31055e-05,4.3975e-09,-3.04892e-13,13377.3,15.1349], Tmin=(790.917,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(112.296,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJC) + radical(C2CsJOOH)"""),
)
...
species(
    ...
    molecularWeight = (102.132,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.558801,0.0772713,-6.91932e-05,3.39242e-08,-6.96456e-12,18182.5,31.1064], Tmin=(100,'K'), Tmax=(1141.5,'K')), NASAPolynomial(coeffs=[12.0146,0.0371295,-1.64462e-05,3.11961e-09,-2.1826e-13,15567.1,-25.6779], Tmin=(1141.5,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(150.159,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJCOOH) + radical(RCCJ)"""),
)

species(
    label = 'C[CH][CH]C(C)OO(15014)',
    structure = SMILES('C[CH][CH]C(C)OO'),
    E0 = (125.812,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (102.132,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.784007,0.0762238,-8.10211e-05,5.66112e-08,-1.75654e-11,15242.4,31.5677], Tmin=(100,'K'), Tmax=(760.701,'K')), NASAPolynomial(coeffs=[6.57249,0.0457872,-2.10062e-05,4.01688e-09,-2.81195e-13,14361.7,5.22462], Tmin=(760.701,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(125.812,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJC) + radical(CCJCOOH)"""),
)
...
species(
    label = 'C[CH]CC(C)O[O](1941)',
    structure = SMILES('C[CH]CC(C)O[O]'),
    E0 = (77.4013,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3025,407.5,1350,352.5,492.5,1135,1000,1380,1390,370,380,2900,435,212.94,1691.28],'cm^-1')),
        HinderedRotor(inertia=(0.00371782,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.207373,'amu*angstrom^2'), symmetry=1, barrier=(6.67246,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.20737,'amu*angstrom^2'), symmetry=1, barrier=(6.67241,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.207352,'amu*angstrom^2'), symmetry=1, barrier=(6.67241,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.20737,'amu*angstrom^2'), symmetry=1, barrier=(6.6724,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (102.132,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.40703,0.0646267,-3.95767e-05,-1.32593e-08,2.63781e-11,9395.3,27.864], Tmin=(100,'K'), Tmax=(542.574,'K')), NASAPolynomial(coeffs=[5.60228,0.0456864,-2.03571e-05,3.84796e-09,-2.67996e-13,8763.59,8.56327], Tmin=(542.574,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(77.4013,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJC) + radical(ROOJ)"""),
)
...
species(
    label = 'CC=CC(C)OO(15015)',
    structure = SMILES('CC=CC(C)OO'),
    E0 = (-153.849,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (102.132,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.433018,0.0693644,-4.91652e-05,1.74054e-08,-2.48312e-12,-18367.9,28.7362], Tmin=(100,'K'), Tmax=(1634.13,'K')), NASAPolynomial(coeffs=[17.1413,0.0284663,-1.16243e-05,2.09016e-09,-1.40108e-13,-23828.7,-60.0774], Tmin=(1634.13,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-153.849,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH)"""),
)
...
species(
    label = 'CC1CC(C1)OO(13437)',
    structure = SMILES('CC1CC(C1)OO'),
    E0 = (-119.914,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (102.132,'amu'),
...
species(
    ...
    molecularWeight = (102.132,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.885378,0.0728849,-7.30642e-05,4.69925e-08,-1.32993e-11,-8981.33,30.6469], Tmin=(100,'K'), Tmax=(832.296,'K')), NASAPolynomial(coeffs=[7.15002,0.0427776,-1.88044e-05,3.53123e-09,-2.44922e-13,-10024.2,1.57352], Tmin=(832.296,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-75.5751,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(RCCJC)"""),
)

species(
    label = '[CH2]C([O])CC(C)O(15017)',
...
species(
    label = 'C=CCC(C)O[O](1930)',
    structure = SMILES('C=CCC(C)O[O]'),
    E0 = (10.7373,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,492.5,1135,1000,232.43,232.441],'cm^-1')),
        HinderedRotor(inertia=(0.310311,'amu*angstrom^2'), symmetry=1, barrier=(11.8969,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.310296,'amu*angstrom^2'), symmetry=1, barrier=(11.897,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0031201,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.310275,'amu*angstrom^2'), symmetry=1, barrier=(11.8972,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (101.124,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.96515,0.0647891,-4.9144e-05,1.99595e-08,-3.39071e-12,1402.03,27.0931], Tmin=(100,'K'), Tmax=(1355.11,'K')), NASAPolynomial(coeffs=[11.8189,0.0327512,-1.36806e-05,2.51279e-09,-1.72019e-13,-1539.57,-28.5681], Tmin=(1355.11,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(10.7373,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(ROOJ)"""),
)
...
species(
    label = 'C=CC[C](C)OO(1932)',
    structure = SMILES('C=CC[C](C)OO'),
    E0 = (45.6317,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3010,987.5,1337.5,450,1655,2750,2800,2850,1350,1500,750,1050,1375,1000,2950,3100,1380,975,1025,1650,360,370,350,2750,2850,1437.5,1250,1305,750,350,3615,1310,387.5,850,1000,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.0108194,'amu*angstrom^2'), symmetry=1, barrier=(32.2662,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(5.20297,'amu*angstrom^2'), symmetry=1, barrier=(119.627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.606745,'amu*angstrom^2'), symmetry=1, barrier=(13.9503,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.606671,'amu*angstrom^2'), symmetry=1, barrier=(13.9486,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.018923,'amu*angstrom^2'), symmetry=1, barrier=(0.435078,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (101.124,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.17181,0.066826,-5.46865e-05,2.55979e-08,-5.29579e-12,5586.16,25.8977], Tmin=(100,'K'), Tmax=(1090.62,'K')), NASAPolynomial(coeffs=[8.30547,0.0406627,-1.8703e-05,3.60256e-09,-2.53935e-13,4030.11,-9.13704], Tmin=(1090.62,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(45.6317,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(C2CsJOOH)"""),
)
...
species(
    label = 'C=C[CH]C(C)OO(1933)',
    structure = SMILES('C=C[CH]C(C)OO'),
    E0 = (-24.3507,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,285.55,285.595],'cm^-1')),
        HinderedRotor(inertia=(0.443994,'amu*angstrom^2'), symmetry=1, barrier=(25.7053,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.444767,'amu*angstrom^2'), symmetry=1, barrier=(25.7058,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.877675,'amu*angstrom^2'), symmetry=1, barrier=(50.8113,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.444481,'amu*angstrom^2'), symmetry=1, barrier=(25.7058,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.443911,'amu*angstrom^2'), symmetry=1, barrier=(25.7056,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (101.124,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.232336,0.0751361,-6.12583e-05,2.52372e-08,-4.17585e-12,-2786.81,26.1734], Tmin=(100,'K'), Tmax=(1433.69,'K')), NASAPolynomial(coeffs=[17.2605,0.0276273,-1.1552e-05,2.12373e-09,-1.45422e-13,-7669.43,-62.1122], Tmin=(1433.69,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-24.3507,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(C=CCJCO)"""),
)

species(
    label = 'C=[C]CC(C)OO(1935)',
    structure = SMILES('C=[C]CC(C)OO'),
    E0 = (96.5744,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,2750,2800,2850,1350,1500,750,1050,1375,1000,2950,3100,1380,975,1025,1650,3615,1310,387.5,850,1000,2750,2850,1437.5,1250,1305,750,350,1380,1390,370,380,2900,435,276.992,277.024],'cm^-1')),
        HinderedRotor(inertia=(0.224798,'amu*angstrom^2'), symmetry=1, barrier=(12.2435,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.224802,'amu*angstrom^2'), symmetry=1, barrier=(12.2434,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.345629,'amu*angstrom^2'), symmetry=1, barrier=(18.8187,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00219666,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.629317,'amu*angstrom^2'), symmetry=1, barrier=(34.2692,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (101.124,'amu'),
...
species(
    label = '[CH]=CCC(C)OO(1936)',
    structure = SMILES('[CH]=CCC(C)OO'),
    E0 = (105.829,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,3615,1310,387.5,850,1000,2750,2850,1437.5,1250,1305,750,350,1380,1390,370,380,2900,435,288.774],'cm^-1')),
        HinderedRotor(inertia=(0.145546,'amu*angstrom^2'), symmetry=1, barrier=(8.61197,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.145558,'amu*angstrom^2'), symmetry=1, barrier=(8.6119,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.44145,'amu*angstrom^2'), symmetry=1, barrier=(26.121,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.287199,'amu*angstrom^2'), symmetry=1, barrier=(16.9954,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.441442,'amu*angstrom^2'), symmetry=1, barrier=(26.1213,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (101.124,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.652696,0.0715838,-5.98813e-05,2.63254e-08,-4.76019e-12,12850.3,27.8604], Tmin=(100,'K'), Tmax=(1296.59,'K')), NASAPolynomial(coeffs=[13.6054,0.0316248,-1.36539e-05,2.55685e-09,-1.77345e-13,9491.38,-37.9934], Tmin=(1296.59,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(105.829,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_P)"""),
)

species(
    label = '[CH2]C[CH]C(C)OO(1937)',
...
species(
    ...
    molecularWeight = (102.132,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.584673,0.0808164,-7.95539e-05,4.73286e-08,-1.23109e-11,19315.3,36.5464], Tmin=(100,'K'), Tmax=(899.025,'K')), NASAPolynomial(coeffs=[8.43931,0.0458699,-2.12483e-05,4.09356e-09,-2.88446e-13,17902.9,-0.511817], Tmin=(899.025,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(159.614,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(CsJ2_singlet-CsH)"""),
)

species(
    label = '[CH]CCC(C)OO(1943)',
    structure = SMILES('[CH]CCC(C)OO'),
    E0 = (182.05,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (102.132,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.665346,0.0789663,-7.73087e-05,4.42694e-08,-1.09589e-11,22010.9,27.0988], Tmin=(100,'K'), Tmax=(944.625,'K')), NASAPolynomial(coeffs=[9.17094,0.0429497,-2.01169e-05,3.90652e-09,-2.76724e-13,20404,-13.4513], Tmin=(944.625,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(182.05,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(CsJ2_singlet-CsH)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'C=C(C[CH]C)OO(15012)'],
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', '[CH2]C(C=CC)OO(15013)'],
    products = ['[CH2]C(C[CH]C)OO(320)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', '[CH2]C(CC=C)OO(1934)'],
    products = ['[CH2]C(C[CH]C)OO(320)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['C=CC[CH]C(380)', 'HO2(10)'],
    products = ['[CH2]C(C[CH]C)OO(320)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2]C(C[CH]C)OO(320)'],
    products = ['OH(5)', 'C[CH]CC1CO1(1945)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH2]C(C[CH]C)OO(320)'],
    products = ['OH(5)', '[CH2]C1CC(C)O1(1234)'],
...
reaction(
    label = 'reaction27',
    reactants = ['C[CH]C[CH]OO(309)', 'CH2(19)'],
    products = ['[CH2]C(C[CH]C)OO(320)'],
...
reaction(
    label = 'reaction28',
    reactants = ['CHCH3(T)(95)', '[CH2]C([CH2])OO(5700)'],
    products = ['[CH2]C(C[CH]C)OO(320)'],
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'C=CCC(C)O[O](1930)'],
    products = ['C=CCC(C)OO(1790)'],
...
reaction(
    label = 'reaction4',
    reactants = ['CH3CHOOH(63)', 'CH2CHCH2(74)'],
    products = ['C=CCC(C)OO(1790)'],
...
reaction(
    label = 'reaction5',
    reactants = ['CH3(17)', 'C=CC[CH]OO(1931)'],
    products = ['C=CCC(C)OO(1790)'],
...
reaction(
    label = 'reaction6',
    reactants = ['H(3)', 'C=CC[C](C)OO(1932)'],
    products = ['C=CCC(C)OO(1790)'],
...
reaction(
    label = 'reaction8',
    reactants = ['H(3)', 'C=C[CH]C(C)OO(1933)'],
    products = ['C=CCC(C)OO(1790)'],
...
reaction(
    label = 'reaction10',
    reactants = ['H(3)', 'C=[C]CC(C)OO(1935)'],
    products = ['C=CCC(C)OO(1790)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(3)', '[CH]=CCC(C)OO(1936)'],
    products = ['C=CCC(C)OO(1790)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]C[CH]C(C)OO(1937)'],
    products = ['C=CCC(C)OO(1790)'],
...
reaction(
    label = 'reaction19',
    reactants = ['C=CCCOO(306)', 'CH2(S)(23)'],
    products = ['C=CCC(C)OO(1790)'],
