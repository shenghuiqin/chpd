...
species(
    ...
    molecularWeight = (75.0865,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.40532,0.0423077,-1.21297e-05,-5.84123e-08,6.42162e-11,-3937.67,16.596], Tmin=(100,'K'), Tmax=(465.061,'K')), NASAPolynomial(coeffs=[5.30539,0.0300773,-1.36871e-05,2.6009e-09,-1.80762e-13,-4344.89,3.34705], Tmin=(465.061,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-33.1547,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo library: DFT_QCI_thermo + radical(C2CsJOOH)"""),
)
...
reaction(
    label = 'reaction4',
    reactants = ['O2(2)', 'ipropyl(142)'],
    products = ['ipropylperoxy(718)'],
    transitionState = 'TS4',
