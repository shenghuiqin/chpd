...
species(
    label = 'C=[C]OC(=C)CC(2892)',
    structure = SMILES('C=[C]OC(=C)CC'),
    E0 = (145.121,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2950,3000,3050,3100,1330,1430,900,1050,1000,1050,1600,1700,1685,370,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,343.528,343.528,343.528,343.529],'cm^-1')),
        HinderedRotor(inertia=(0.00142848,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00142848,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.136443,'amu*angstrom^2'), symmetry=1, barrier=(11.4262,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.136443,'amu*angstrom^2'), symmetry=1, barrier=(11.4262,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.971977,0.0616404,-4.30142e-05,1.55632e-08,-2.32173e-12,17566.8,29.9583], Tmin=(100,'K'), Tmax=(1538,'K')), NASAPolynomial(coeffs=[13.1413,0.0299908,-1.21468e-05,2.18334e-09,-1.4686e-13,13823.6,-33.9903], Tmin=(1538,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(145.121,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(C=CJO)"""),
)

species(
    label = 'C#COC([CH2])CC(2893)',
    structure = SMILES('C#COC([CH2])CC'),
    E0 = (174.126,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,2175,525,750,770,3400,2100,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,1380,1390,370,380,2900,435,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    ...
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.483619,0.0636662,-1.9724e-05,-2.43178e-08,1.51326e-11,23463.9,31.0738], Tmin=(100,'K'), Tmax=(973.385,'K')), NASAPolynomial(coeffs=[17.6802,0.0247237,-8.6011e-06,1.54744e-09,-1.10156e-13,18613.2,-59.1461], Tmin=(973.385,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(193.936,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CCJCO) + radical(C=CJO)"""),
)

species(
    label = '[CH2]C([CH]C)OC=C(2898)',
    ...
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0718914,0.0746048,-3.61307e-05,-1.8589e-08,1.60462e-11,19969.3,29.6911], Tmin=(100,'K'), Tmax=(943.693,'K')), NASAPolynomial(coeffs=[21.9171,0.0182386,-5.08979e-06,8.46989e-10,-6.09356e-14,14178.8,-83.8094], Tmin=(943.693,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(164.702,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CJC(C)OC) + radical(CCJCO)"""),
)

species(
    label = '[CH2]CC(C)O[C]=C(2899)',
...
species(
    ...
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.229902,0.0805623,-5.52529e-05,3.22633e-09,7.72477e-12,20615.4,29.5481], Tmin=(100,'K'), Tmax=(955.903,'K')), NASAPolynomial(coeffs=[21.1805,0.0201819,-6.34326e-06,1.08486e-09,-7.61284e-14,15187.5,-79.76], Tmin=(955.903,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(170.046,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(RCCJ) + radical(CJC(C)OC)"""),
)
...
species(
    label = '[CH2]C(C)O[C]=C(1153)',
    structure = SMILES('[CH2]C(C)O[C]=C'),
    E0 = (228.324,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,3100,1380,975,1025,1650,1685,370,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,335.248,335.249,335.253],'cm^-1')),
        HinderedRotor(inertia=(0.191288,'amu*angstrom^2'), symmetry=1, barrier=(15.2566,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.191291,'amu*angstrom^2'), symmetry=1, barrier=(15.2566,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.1913,'amu*angstrom^2'), symmetry=1, barrier=(15.2566,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.191286,'amu*angstrom^2'), symmetry=1, barrier=(15.2565,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'C=[C]OC(=C)CC(2892)'],
    products = ['[CH2]C(CC)O[C]=C(1129)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'C#COC([CH2])CC(2893)'],
    products = ['[CH2]C(CC)O[C]=C(1129)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['C2H5(29)', 'C=[C]OC=C(2409)'],
    products = ['[CH2]C(CC)O[C]=C(1129)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction16',
    reactants = ['CH2(S)(23)', '[CH2]C(C)O[C]=C(1153)'],
    products = ['[CH2]C(CC)O[C]=C(1129)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H2CC(41)', '[CH2]C([O])CC(1666)'],
    products = ['[CH2]C(CC)O[C]=C(1129)'],
...
reaction(
    label = 'reaction20',
    reactants = ['CH2(19)', 'C=[C]O[CH]CC(2426)'],
    products = ['[CH2]C(CC)O[C]=C(1129)'],
