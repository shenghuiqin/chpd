species(
    ...
    E0 = (571.264,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,440,435,1725,2950,3100,1380,975,1025,1650,3120,650,792.5,1650,2750,2830,2910,2990,3070,3150,900,940,980,1020,1060,1100,3010,987.5,1337.5,450,1655,300,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
...
species(
    label = '[CH2]C1C=C1C1[CH]CC1(29948)',
    structure = SMILES('[CH2]C1C=C1C1[CH]CC1'),
    E0 = (674.946,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (106.165,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.911628,0.0532867,1.09564e-05,-4.92343e-08,2.19621e-11,81301.5,28.3423], Tmin=(100,'K'), Tmax=(984.373,'K')), NASAPolynomial(coeffs=[14.0954,0.034209,-1.25361e-05,2.2744e-09,-1.60402e-13,77034.7,-43.5429], Tmin=(984.373,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(674.946,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(424.038,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)(Cds-Cds)CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + ring(Cyclobutane) + ring(Cyclopropene) + radical(Isobutyl) + radical(cyclobutane)"""),
)
...
species(
    label = '[CH]=C(C=C)C1=CCC1(29950)',
    structure = SMILES('[CH]=C(C=C)C1=CCC1'),
    E0 = (512.643,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,440,435,1725,2950,3100,1380,975,1025,1650,3120,650,792.5,1650,2750,2850,2950,3050,3150,900,950,1000,1050,1100,3010,987.5,1337.5,450,1655,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.00289,0.0464322,3.43774e-05,-7.97725e-08,3.43178e-11,61782.2,24.9283], Tmin=(100,'K'), Tmax=(964.605,'K')), NASAPolynomial(coeffs=[17.3628,0.0264631,-9.01196e-06,1.66428e-09,-1.22719e-13,56398.9,-64.9534], Tmin=(964.605,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(512.643,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(399.095,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-Cds(Cds-Cds)(Cds-Cds)) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + group(Cds-CdsHH) + ring(Cyclobutene) + radical(Cds_P)"""),
)

species(
    label = '[CH]=C(C=C)C1C=CC1(29951)',
    structure = SMILES('[CH]=C(C=C)C1C=CC1'),
    E0 = (513.472,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,440,435,1725,2950,3100,1380,975,1025,1650,3120,650,792.5,1650,2750,2850,2950,3050,3150,900,950,1000,1050,1100,3010,987.5,1337.5,450,1655,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (105.157,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.509697,0.0608273,-5.30291e-06,-4.07599e-08,2.1059e-11,61896.4,25.2998], Tmin=(100,'K'), Tmax=(971.956,'K')), NASAPolynomial(coeffs=[18.2989,0.0253634,-8.82474e-06,1.61129e-09,-1.16505e-13,56655.4,-69.1888], Tmin=(971.956,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(513.472,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(399.095,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)CsH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + group(Cds-CdsHH) + ring(Cyclobutene) + radical(Cds_P)"""),
)
...
species(
    label = 'C#CC1[CH]CC1(23885)',
    structure = SMILES('C#CC1[CH]CC1'),
    E0 = (438.911,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2175,525,2750,2830,2910,2990,3070,3150,900,940,980,1020,1060,1100,750,770,3400,2100,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.37219,0.0218388,4.92851e-05,-7.6846e-08,3.04578e-11,52860.1,19.8872], Tmin=(100,'K'), Tmax=(954.465,'K')), NASAPolynomial(coeffs=[10.4436,0.0230383,-7.64493e-06,1.36538e-09,-9.81874e-14,49723.9,-27.0344], Tmin=(954.465,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(438.911,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(303.478,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CtCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Ct-CtCs) + group(Ct-CtH) + ring(Cyclobutane) + radical(cyclobutane)"""),
)

species(
    label = '[CH]=C(C=C)[C]1CCC1(29952)',
    ...
    molecularWeight = (106.165,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[9.65569,0.00416622,0.000121859,-1.24224e-07,2.90337e-11,58042.2,-13.5061], Tmin=(100,'K'), Tmax=(1709.4,'K')), NASAPolynomial(coeffs=[76.8695,0.0378969,-7.53515e-05,1.80564e-08,-1.33492e-12,7155.84,-455.439], Tmin=(1709.4,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(485.219,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(424.038,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + ring(methylenecyclobutane) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[CH]=C(C=C)C1C[CH]C1(29953)',
    structure = SMILES('[CH]=C(C=C)C1C[CH]C1'),
    E0 = (571.264,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,440,435,1725,2950,3100,1380,975,1025,1650,3120,650,792.5,1650,2750,2830,2910,2990,3070,3150,900,940,980,1020,1060,1100,3010,987.5,1337.5,450,1655,300,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'C=CC(=C)[C]1[CH]CC1(29954)',
    structure = SMILES('[CH2]C=C([CH2])C1=CCC1'),
    E0 = (390.613,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (106.165,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.714491,0.0493948,4.47637e-05,-9.89515e-08,4.30715e-11,47119,26.7681], Tmin=(100,'K'), Tmax=(948.663,'K')), NASAPolynomial(coeffs=[19.9852,0.0253125,-7.55682e-06,1.34359e-09,-1.00421e-13,40890.1,-78.7457], Tmin=(948.663,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(390.613,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(419.881,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cyclobutene) + radical(C=CC=CCJ) + radical(Allyl_P)"""),
)

species(
    label = 'C=[C]C(=C)C1[CH]CC1(29955)',
    ...
    molecularWeight = (106.165,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.792742,0.0539029,1.64061e-05,-5.92586e-08,2.64972e-11,63052.4,28.775], Tmin=(100,'K'), Tmax=(972.256,'K')), NASAPolynomial(coeffs=[15.8697,0.0318678,-1.13007e-05,2.04859e-09,-1.46072e-13,58230.4,-53.2597], Tmin=(972.256,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(523.164,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(424.038,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + group(Cds-CdsHH) + ring(Cyclobutane) + radical(C=CJC=C) + radical(cyclobutane)"""),
)

species(
    label = 'C=CC(=C)C1[CH]C[CH]1(29956)',
    ...
    molecularWeight = (106.165,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.03972,0.0478776,2.75712e-05,-6.63461e-08,2.76022e-11,61702,30.6403], Tmin=(100,'K'), Tmax=(994.012,'K')), NASAPolynomial(coeffs=[14.8681,0.0334222,-1.27745e-05,2.40235e-09,-1.73566e-13,56917.9,-46.2269], Tmin=(994.012,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(512.007,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(424.038,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + group(Cds-CdsHH) + ring(Cyclobutane) + radical(cyclobutane) + radical(cyclobutane)"""),
)

species(
    label = '[CH]=C([C]=C)C1CCC1(29957)',
    structure = SMILES('[CH]C(=C=C)C1CCC1'),
    E0 = (558.331,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (106.165,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.722111,0.0532885,3.09759e-05,-7.38056e-08,3.06644e-11,67286.4,28.3808], Tmin=(100,'K'), Tmax=(990.912,'K')), NASAPolynomial(coeffs=[15.4932,0.0385969,-1.48048e-05,2.75758e-09,-1.97558e-13,62152.9,-53.8781], Tmin=(990.912,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(558.331,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(424.038,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cdd-Cd)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + group(Cdd-CdsCds) + ring(Cyclobutane) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[CH]=CC(=C)C1[CH]CC1(29958)',
    ...
    molecularWeight = (106.165,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.804346,0.050791,2.91817e-05,-7.52247e-08,3.25649e-11,68839.8,29.54], Tmin=(100,'K'), Tmax=(972.559,'K')), NASAPolynomial(coeffs=[17.6248,0.0289918,-1.02739e-05,1.91368e-09,-1.40335e-13,63327.2,-62.6611], Tmin=(972.559,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(571.264,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(424.038,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + group(Cds-CdsHH) + ring(Cyclobutane) + radical(cyclobutane) + radical(Cds_P)"""),
)

species(
    label = 'C=CC(=C)C1[CH][CH]C1(29959)',
...
species(
    label = '[CH]=CC(=[CH])C1CCC1(29960)',
    structure = SMILES('[CH]=CC(=[CH])C1CCC1'),
    E0 = (630.522,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,440,435,1725,3115,3125,620,680,785,800,1600,1700,2750,2816.67,2883.33,2950,3016.67,3083.33,3150,900,933.333,966.667,1000,1033.33,1066.67,1100,3010,987.5,1337.5,450,1655,300,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    ...
    molecularWeight = (106.165,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.566936,0.053718,3.08011e-05,-8.42122e-08,3.76238e-11,75977.6,28.4477], Tmin=(100,'K'), Tmax=(956.886,'K')), NASAPolynomial(coeffs=[20.4429,0.0244605,-7.71651e-06,1.41188e-09,-1.06031e-13,69709.5,-79.4436], Tmin=(956.886,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(630.522,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(424.038,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + group(Cds-CdsHH) + ring(Cyclobutane) + radical(Cds_P) + radical(Cds_P)"""),
)

species(
    label = '[CH]1CC=C1C1[CH]CC1(29961)',
    structure = SMILES('[CH]1CC=C1C1[CH]CC1'),
    E0 = (537.793,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (106.165,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.80317,0.0215178,0.000108951,-1.52512e-07,5.83081e-11,64784.8,25.2139], Tmin=(100,'K'), Tmax=(969.224,'K')), NASAPolynomial(coeffs=[15.7629,0.031548,-1.12574e-05,2.17754e-09,-1.65349e-13,58901.6,-58.0874], Tmin=(969.224,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(537.793,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(428.195,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + ring(Cyclobutane) + ring(Cyclobutene) + radical(cyclobutene-allyl) + radical(cyclobutane)"""),
)
...
species(
    label = '[CH]=C(C=C)C=CC[CH2](29963)',
    structure = SMILES('[CH]=C(C=C)C=CC[CH2]'),
    E0 = (558.465,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,2995,3010,3025,975,987.5,1000,1300,1337.5,1375,400,450,500,1630,1655,1680,2950,3100,1380,975,1025,1650,350,440,435,1725,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,180,1053.55],'cm^-1')),
        HinderedRotor(inertia=(0.105746,'amu*angstrom^2'), symmetry=1, barrier=(2.43132,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.328656,'amu*angstrom^2'), symmetry=1, barrier=(18.4239,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.801618,'amu*angstrom^2'), symmetry=1, barrier=(18.4308,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.09494,'amu*angstrom^2'), symmetry=1, barrier=(25.1747,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (106.165,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.41482,0.0673237,-2.90334e-05,-8.33419e-09,7.44787e-12,67306.9,30.8105], Tmin=(100,'K'), Tmax=(1040.61,'K')), NASAPolynomial(coeffs=[15.1258,0.0334929,-1.30128e-05,2.38023e-09,-1.66018e-13,63015.2,-46.6569], Tmin=(1040.61,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(558.465,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(415.724,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-Cds(Cds-Cds)(Cds-Cds)) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(RCCJ) + radical(Cds_P)"""),
)

species(
    label = 'C=CC(=C)C1=CCC1(29964)',
    ...
    molecularWeight = (106.165,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.07634,0.0429122,5.10314e-05,-9.7161e-08,4.02417e-11,32062.5,24.2616], Tmin=(100,'K'), Tmax=(964.911,'K')), NASAPolynomial(coeffs=[17.1245,0.0292929,-1.00444e-05,1.8627e-09,-1.3756e-13,26502.5,-65.3511], Tmin=(964.911,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(265.547,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(424.038,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-Cds(Cds-Cds)(Cds-Cds)) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + group(Cds-CdsHH) + ring(Cyclobutene)"""),
)

species(
    label = 'C=CC(=C)C1C=CC1(29965)',
...
species(
    label = '[CH]=C([CH]C1CC1)C=C(29966)',
    structure = SMILES('[CH]C(C=C)=CC1CC1'),
    E0 = (499.188,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (106.165,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.48692,0.0556811,3.41664e-05,-8.70446e-08,3.81835e-11,60184.5,28.5849], Tmin=(100,'K'), Tmax=(957.962,'K')), NASAPolynomial(coeffs=[19.1328,0.030976,-1.03751e-05,1.87113e-09,-1.35916e-13,54173.3,-73.2989], Tmin=(957.962,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(499.188,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(419.881,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + ring(Cyclopropane) + radical(AllylJ2_triplet)"""),
)
...
species(
    ...
    E0 = (583.886,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,350,440,435,1725,3000,3100,440,815,1455,1000,300,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
...
reaction(
    label = 'reaction1',
    reactants = ['[CH]=C(C=C)C1[CH]CC1(27290)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[CH]=C(C=C)C1[CH]CC1(27290)'],
    products = ['[CH2]C1C=C1C1[CH]CC1(29948)'],
    transitionState = 'TS2',
...
reaction(
    ...
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(4.73e+06,'s^-1'), n=1.31, Ea=(67.4417,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2500,'K'), comment="""From training reaction 344 used for R5_SS_D;doublebond_intra_2H_pri;radadd_intra_csHNd
Exact match found for rate rule [R5_SS_D;doublebond_intra_2H_pri;radadd_intra_csHNd]
Euclidian distance = 0
family: Intra_R_Add_Exocyclic
Ea raised from 65.6 to 67.4 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction4',
    reactants = ['H(3)', '[CH]=C(C=C)C1=CCC1(29950)'],
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)', '[CH]=C(C=C)C1C=CC1(29951)'],
    products = ['[CH]=C(C=C)C1[CH]CC1(27290)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['C2H3(30)', 'C#CC1[CH]CC1(23885)'],
    products = ['[CH]=C(C=C)C1[CH]CC1(27290)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH]=C(C=C)C1[CH]CC1(27290)'],
    products = ['[CH]=C(C=C)[C]1CCC1(29952)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH]=C(C=C)C1C[CH]C1(29953)'],
    products = ['[CH]=C(C=C)C1[CH]CC1(27290)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH]=C(C=C)C1[CH]CC1(27290)'],
    products = ['C=CC(=C)[C]1[CH]CC1(29954)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH]=C(C=C)C1[CH]CC1(27290)'],
    products = ['C=[C]C(=C)C1[CH]CC1(29955)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH]=C(C=C)C1[CH]CC1(27290)'],
    products = ['C=CC(=C)C1[CH]C[CH]1(29956)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH]=C(C=C)C1[CH]CC1(27290)'],
    products = ['[CH]=C([C]=C)C1CCC1(29957)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH]=CC(=C)C1[CH]CC1(29958)'],
    products = ['[CH]=C(C=C)C1[CH]CC1(27290)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH]=C(C=C)C1[CH]CC1(27290)'],
    products = ['C=CC(=C)C1[CH][CH]C1(29959)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH]=CC(=[CH])C1CCC1(29960)'],
    products = ['[CH]=C(C=C)C1[CH]CC1(27290)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH]=C(C=C)C1[CH]CC1(27290)'],
    products = ['[CH]1CC=C1C1[CH]CC1(29961)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH]=C(C=C)C=CC[CH2](29963)'],
    products = ['[CH]=C(C=C)C1[CH]CC1(27290)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[CH]=C(C=C)C1[CH]CC1(27290)'],
    products = ['[CH]=C([CH]C1CC1)C=C(29966)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[CH]=C(C=C)C1CC1[CH2](27277)'],
    products = ['[CH]=C(C=C)C1[CH]CC1(27290)'],
