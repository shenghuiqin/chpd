...
species(
    label = 'CC=C=CC([O])=O(24834)',
    structure = SMILES('CC=C=CC([O])=O'),
    E0 = (76.4136,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([540,610,2055,2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,180,180,180,800.847,807.533,3915.55],'cm^-1')),
        HinderedRotor(inertia=(0.235492,'amu*angstrom^2'), symmetry=1, barrier=(5.41443,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.236702,'amu*angstrom^2'), symmetry=1, barrier=(5.44224,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (97.092,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[4.43877,0.0332291,-1.43224e-05,1.72428e-09,1.09119e-14,9129.61,12.9689], Tmin=(100,'K'), Tmax=(2819.88,'K')), NASAPolynomial(coeffs=[50.3343,-0.0162286,3.66373e-06,-5.60445e-10,3.90344e-14,-22974.6,-267.059], Tmin=(2819.88,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(76.4136,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cd-Cd(CO)H) + group(Cds-O2d(Cds-Cds)O2s) + group(Cdd-CdsCds) + radical(CCOJ)"""),
)

species(
    label = 'CC#CCC([O])=O(24835)',
    ...
    molecularWeight = (97.092,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.16003,0.035173,-5.41957e-06,-8.95471e-09,3.43639e-12,-1784.5,22.0559], Tmin=(100,'K'), Tmax=(1317.48,'K')), NASAPolynomial(coeffs=[8.68169,0.0285674,-1.29216e-05,2.44319e-09,-1.68911e-13,-4648.08,-15.5514], Tmin=(1317.48,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-15.4226,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-(Cds-O2d)CtHH) + group(Cs-CtHHH) + group(Cds-OdCsOs) + group(Ct-CtCs) + group(Ct-CtCs) + radical(CCOJ)"""),
)
...
species(
    label = 'C#CCC([O])=O(24836)',
    structure = SMILES('C#CCC([O])=O'),
    E0 = (26.7585,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,750,770,3400,2100,2175,525,537.261,537.266,537.266,537.277,537.283,537.292],'cm^-1')),
        HinderedRotor(inertia=(0.000584058,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.000584041,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
species(
    label = 'C[C]=[C]CC(=O)O(24838)',
    structure = SMILES('C[C]=[C]CC(=O)O'),
    E0 = (80.8328,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,1670,1700,300,440,3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'CC=[C]C[C]1OO1(24839)',
    structure = SMILES('CC=[C]C[C]1OO1'),
    E0 = (424.693,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.29826,0.050217,-2.04285e-05,-1.3706e-08,1.03695e-11,51184.4,26.154], Tmin=(100,'K'), Tmax=(947.888,'K')), NASAPolynomial(coeffs=[14.0398,0.0187823,-6.02578e-06,1.02062e-09,-7.02852e-14,47765.6,-39.9268], Tmin=(947.888,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(424.693,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsOsH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(dioxirane) + radical(Cds_S) + radical(Cs_P)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'CC=C=CC([O])=O(24834)'],
    products = ['CC=[C]CC([O])=O(21111)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', 'CC#CCC([O])=O(24835)'],
    products = ['CC=[C]CC([O])=O(21111)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['CH3(17)', 'C#CCC([O])=O(24836)'],
    products = ['CC=[C]CC([O])=O(21111)'],
    transitionState = 'TS6',
...
reaction(
    ...
    products = ['CC=[C]CC([O])=O(21111)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(8.04,'m^3/(mol*s)'), n=1.68, Ea=(110.771,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Cdd_Od;CJ] for rate rule [CO2;CJ]
Euclidian distance = 1.0
family: R_Addition_MultipleBond
...
reaction(
    label = 'reaction21',
    reactants = ['[CH2]C([O])=O(1440)', '[C]=CC(24199)'],
    products = ['CC=[C]CC([O])=O(21111)'],
...
reaction(
    label = 'reaction22',
    reactants = ['O(4)', 'CC=[C]C[C]=O(24134)'],
    products = ['CC=[C]CC([O])=O(21111)'],
