...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', '[CH2]CC(C)=O(1660)'],
    products = ['[CH2]CC(C)[O](1023)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['CH3(17)', 'CH2CH2CHO(560)'],
    products = ['[CH2]CC(C)[O](1023)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction13',
    reactants = ['C[CH][O](176)', 'C2H4(T)(94)'],
    products = ['[CH2]CC(C)[O](1023)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CH2(S)(23)', '[CH2]CC[O](466)'],
    products = ['[CH2]CC(C)[O](1023)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CH2(19)', '[CH2]C(C)[O](1669)'],
    products = ['[CH2]CC(C)[O](1023)'],
