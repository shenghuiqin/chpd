...
species(
    ...
    molecularWeight = (126.239,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.3809,0.101535,-7.12716e-05,2.99544e-08,-5.79384e-12,14899.3,38.9147], Tmin=(100,'K'), Tmax=(1126.43,'K')), NASAPolynomial(coeffs=[8.32744,0.0706112,-3.00934e-05,5.58374e-09,-3.85075e-13,12937.4,-4.1348], Tmin=(1126.43,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(122.605,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(623.585,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Tertalkyl) + radical(Isobutyl)"""),
)

species(
    label = '[CH2][C](CC)C(C)CCC(1566)',
    structure = SMILES('[CH2][C](CC)C(C)CCC'),
    E0 = (122.605,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
species(
    ...
    molecularWeight = (126.239,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.970972,0.100987,-6.34051e-05,2.07082e-08,-2.81665e-12,16028.1,42.4564], Tmin=(100,'K'), Tmax=(1648.97,'K')), NASAPolynomial(coeffs=[18.0122,0.0549384,-2.15157e-05,3.77245e-09,-2.48984e-13,9767.69,-58.6205], Tmin=(1648.97,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(131.725,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(623.585,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Isobutyl) + radical(Cs_S)"""),
)

species(
    label = '[CH2]C([CH]C)C(C)CCC(1571)',
...
species(
    label = '[CH2]C(CC)C(C)C[CH]C(1572)',
    ...
    molecularWeight = (126.239,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.71478,0.0997093,-6.30136e-05,2.15082e-08,-3.14051e-12,16003.7,41.7012], Tmin=(100,'K'), Tmax=(1512.45,'K')), NASAPolynomial(coeffs=[14.2532,0.0601232,-2.37534e-05,4.20293e-09,-2.80038e-13,11476,-36.7036], Tmin=(1512.45,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(131.629,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(623.585,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJC) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]CC(C)C([CH2])CCC(1573)',
...
species(
    ...
    molecularWeight = (126.239,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.714782,0.0997093,-6.30136e-05,2.15083e-08,-3.14052e-12,16003.7,41.7012], Tmin=(100,'K'), Tmax=(1512.44,'K')), NASAPolynomial(coeffs=[14.2532,0.0601232,-2.37534e-05,4.20294e-09,-2.80038e-13,11476,-36.7034], Tmin=(1512.44,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(131.629,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(623.585,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Isobutyl) + radical(RCCJC)"""),
)

species(
    label = '[CH2]CC([CH2])C(C)CCC(1575)',
...
species(
    ...
    molecularWeight = (112.213,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.142882,0.0865654,-5.26266e-05,1.65984e-08,-2.19711e-12,19137.4,37.5097], Tmin=(100,'K'), Tmax=(1663.82,'K')), NASAPolynomial(coeffs=[14.9004,0.0503993,-2.0021e-05,3.5337e-09,-2.3403e-13,14131.6,-42.7241], Tmin=(1663.82,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(157.852,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(552.912,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Cs_S) + radical(Isobutyl)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', '[CH2]C(CC)C(=C)CCC(1562)'],
    products = ['[CH2]C(CC)C([CH2])CCC(1415)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', '[CH2]C(CCC)C(=C)CC(1563)'],
    products = ['[CH2]C(CC)C([CH2])CCC(1415)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(0.0051739,'m^3/(mol*s)'), n=2.82163, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(303.03,'K'), Tmax=(2000,'K'), comment="""From training reaction 102 used for Cds-CsCs_Cds-HH;HJ
Exact match found for rate rule [Cds-CsCs_Cds-HH;HJ]
...
reaction(
    label = 'reaction5',
    reactants = ['npropyl(83)', '[CH2]C(C=C)CC(420)'],
    products = ['[CH2]C(CC)C([CH2])CCC(1415)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2]C(C=C)CCC(440)', 'C2H5(29)'],
    products = ['[CH2]C(CC)C([CH2])CCC(1415)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(1020,'cm^3/(mol*s)'), n=2.41, Ea=(27.3634,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""From training reaction 418 used for Cds-CsH_Cds-HH;CsJ-CsHH
Exact match found for rate rule [Cds-CsH_Cds-HH;CsJ-CsHH]
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]C(CC)C([CH2])CCC(1415)'],
    products = ['[CH2]C(CC)[C](C)CCC(1564)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]C(CC)C([CH2])CCC(1415)'],
    products = ['[CH2]C(CCC)[C](C)CC(1565)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(5.265e-07,'s^-1'), n=5.639, Ea=(102.68,'kJ/mol'), T0=(1,'K'), comment="""From training reaction 38 used for R2H_S;C_rad_out_2H;Cs_H_out_Cs2
Exact match found for rate rule [R2H_S;C_rad_out_2H;Cs_H_out_Cs2]
Euclidian distance = 0
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]C(CC)C([CH2])CCC(1415)'],
    products = ['[CH2][C](CC)C(C)CCC(1566)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]C(CC)C([CH2])CCC(1415)'],
    products = ['[CH2]C(CC)C(C)[CH]CC(1567)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]C(CC)C([CH2])CCC(1415)'],
    products = ['[CH2][C](CCC)C(C)CC(1568)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2]C(CC)C([CH2])CCC(1415)'],
    products = ['[CH2]C(CCC)C(C)[CH]C(1569)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]C(CC)C([CH2])CCC(1415)'],
    products = ['[CH2]C([CH]CC)C(C)CC(1570)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]C(CC)C([CH2])CCC(1415)'],
    products = ['[CH2]C([CH]C)C(C)CCC(1571)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]C(CC)C([CH2])CCC(1415)'],
    products = ['[CH2]C(CC)C(C)C[CH]C(1572)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]CC(C)C([CH2])CCC(1573)'],
    products = ['[CH2]C(CC)C([CH2])CCC(1415)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2]C(CC)C([CH2])CCC(1415)'],
    products = ['[CH2]C(C[CH]C)C(C)CC(1574)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2]CC([CH2])C(C)CCC(1575)'],
    products = ['[CH2]C(CC)C([CH2])CCC(1415)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2]CCC(C)C([CH2])CC(1576)'],
    products = ['[CH2]C(CC)C([CH2])CCC(1415)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH2]CCC([CH2])C(C)CC(1577)'],
    products = ['[CH2]C(CC)C([CH2])CCC(1415)'],
...
reaction(
    label = 'reaction25',
    reactants = ['CH2(S)(23)', '[CH2]C(CC)C([CH2])CC(1409)'],
    products = ['[CH2]C(CC)C([CH2])CCC(1415)'],
...
reaction(
    label = 'reaction28',
    reactants = ['[CH2]C(CC)C([CH2])CCC(1415)'],
    products = ['[CH2]C([CH]CCCC)CC(1580)'],
...
reaction(
    label = 'reaction30',
    reactants = ['[CH2]C(CC)C([CH2])CCC(1415)'],
    products = ['[CH2]C([CH]CCC)CCC(1513)'],
...
reaction(
    label = 'reaction32',
    reactants = ['CH2(19)', '[CH2]C([CH]CCC)CC(478)'],
    products = ['[CH2]C(CC)C([CH2])CCC(1415)'],
...
reaction(
    label = 'reaction33',
    reactants = ['CH2(19)', '[CH2]C([CH]CC)CCC(557)'],
    products = ['[CH2]C(CC)C([CH2])CCC(1415)'],
