species(
    label = '[CH2]C(OO)O[CH]CCC=O(22550)',
    structure = SMILES('[CH2]C(OO)O[CH]CCC=O'),
    E0 = (-138.04,'kJ/mol'),
    modes = [
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.20101,0.125511,-0.000166105,1.16192e-07,-2.98994e-11,-16425.4,41.5843], Tmin=(100,'K'), Tmax=(643.69,'K')), NASAPolynomial(coeffs=[13.2966,0.0500576,-2.43833e-05,4.73912e-09,-3.32916e-13,-18595.1,-24.3271], Tmin=(643.69,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-138.04,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(448.981,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(CCsJOCs) + radical(CJCOOH)"""),
)
...
species(
    label = '[CH2]C(OO)OC1CCC1[O](22755)',
    structure = SMILES('[CH2]C(OO)OC1CCC1[O]'),
    E0 = (-32.2724,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (146.141,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.19794,0.0990788,-8.06024e-05,3.21995e-08,-5.08496e-12,-3681.66,40.7713], Tmin=(100,'K'), Tmax=(1516.19,'K')), NASAPolynomial(coeffs=[24.8367,0.0303946,-1.26517e-05,2.32179e-09,-1.58518e-13,-11576.4,-95.6663], Tmin=(1516.19,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-32.2724,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + ring(Cyclobutane) + radical(CJCOOH) + radical(CC(C)OJ)"""),
)
...
species(
    label = '[CH2]C(OO)OC=CCC=O(22757)',
    structure = SMILES('[CH2]C(OO)OC=CCC=O'),
    E0 = (-235.559,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2995,3025,975,1000,1300,1375,400,500,1630,1680,3000,3100,440,815,1455,1000,3615,1310,387.5,850,1000,2750,2850,1437.5,1250,1305,750,350,2782.5,750,1395,475,1775,1000,1380,1390,370,380,2900,435,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.41905,0.102558,-8.29181e-05,2.56995e-08,-1.14125e-12,-28122,40.3671], Tmin=(100,'K'), Tmax=(1121.56,'K')), NASAPolynomial(coeffs=[26.9652,0.0252623,-1.15542e-05,2.30874e-09,-1.68955e-13,-35994.3,-106.538], Tmin=(1121.56,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-235.559,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(428.195,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsOsOsH) + group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-OdCsH) + radical(CJCOOH)"""),
)

species(
    label = 'C=C(OO)O[CH]CCC=O(22758)',
    structure = SMILES('C=C(OO)O[CH]CCC=O'),
    E0 = (-154.581,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2950,3100,1380,975,1025,1650,3615,1310,387.5,850,1000,350,440,435,1725,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2782.5,750,1395,475,1775,1000,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (145.133,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.40832,0.127416,-0.000181255,1.39852e-07,-4.34082e-11,-18404.9,37.9338], Tmin=(100,'K'), Tmax=(787.472,'K')), NASAPolynomial(coeffs=[15.1685,0.0432041,-2.08283e-05,4.02153e-09,-2.81063e-13,-21015.4,-38.0772], Tmin=(787.472,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-154.581,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(428.195,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsCs) + group(Cds-OdCsH) + group(Cds-CdsHH) + radical(CCsJOC(O))"""),
)
...
species(
    label = '[CH2]C(OO)OC=C(10667)',
    structure = SMILES('[CH2]C(OO)OC=C'),
    E0 = (-100.27,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,3100,1380,975,1025,1650,3010,987.5,1337.5,450,1655,3615,1310,387.5,850,1000,3000,3100,440,815,1455,1000,1380,1390,370,380,2900,435,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0876593,0.0727552,-5.04693e-05,2.21522e-10,8.51377e-12,-11906.9,28.6424], Tmin=(100,'K'), Tmax=(966.923,'K')), NASAPolynomial(coeffs=[22.1185,0.0121467,-3.80741e-06,7.03508e-10,-5.36226e-14,-17594.5,-84.2826], Tmin=(966.923,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-100.27,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CJCOOH)"""),
)
...
species(
    label = '[CH2]C(OO)OC[CH]CC=O(22759)',
    structure = SMILES('[CH2]C(OO)OC[CH]CC=O'),
    E0 = (-118.594,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,3615,1310,387.5,850,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2782.5,750,1395,475,1775,1000,1380,1390,370,380,2900,435,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (146.141,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.821292,0.115138,-0.000147855,1.11778e-07,-3.54128e-11,-14098.3,43.2455], Tmin=(100,'K'), Tmax=(760.68,'K')), NASAPolynomial(coeffs=[10.9173,0.0534152,-2.61509e-05,5.12293e-09,-3.62538e-13,-15884.3,-10.1761], Tmin=(760.68,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-118.594,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(448.981,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(CJCOOH) + radical(CCJCO)"""),
)

species(
    label = 'C[C](OO)O[CH]CCC=O(22760)',
    structure = SMILES('C[C](OO)O[CH]CCC=O'),
    E0 = (-146.756,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (146.141,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.36078,0.127323,-0.000180822,1.46635e-07,-4.86997e-11,-17466.6,40.8101], Tmin=(100,'K'), Tmax=(748.247,'K')), NASAPolynomial(coeffs=[12.5593,0.0512525,-2.50067e-05,4.8513e-09,-3.39797e-13,-19503.4,-21.9996], Tmin=(748.247,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-146.756,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(448.981,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(Cs_P) + radical(CCsJOCs)"""),
)

species(
    label = '[CH2][C](OO)OCCCC=O(22761)',
    structure = SMILES('[CH2][C](OO)OCCCC=O'),
    E0 = (-113.25,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2782.5,750,1395,475,1775,1000,3615,1310,387.5,850,1000,3000,3100,440,815,1455,1000,360,370,350,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (146.141,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.16037,0.123521,-0.000176991,1.49152e-07,-5.1728e-11,-13444.6,42.6357], Tmin=(100,'K'), Tmax=(762.205,'K')), NASAPolynomial(coeffs=[10.5545,0.0546696,-2.6984e-05,5.25738e-09,-3.68891e-13,-15016.2,-9.29599], Tmin=(762.205,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-113.25,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(448.981,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(Cs_P) + radical(CJCOOH)"""),
)

species(
    label = '[CH2]C(OO)OCC[CH]C=O(22762)',
    structure = SMILES('[CH2]C(OO)OCCC=C[O]'),
    E0 = (-175.245,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (146.141,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.23616,0.111892,-0.000112363,5.74887e-08,-1.1739e-11,-20885.8,41.9324], Tmin=(100,'K'), Tmax=(1181.45,'K')), NASAPolynomial(coeffs=[21.2223,0.0358549,-1.5825e-05,3.01444e-09,-2.12084e-13,-26192.5,-70.1616], Tmin=(1181.45,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-175.245,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-(Cds-Cd)H) + group(O2s-OsH) + group(Cs-CsOsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(C=COJ) + radical(CJCOOH)"""),
)

species(
    label = 'CC(O[O])O[CH]CCC=O(22763)',
    structure = SMILES('CC(O[O])O[CH]CCC=O'),
    E0 = (-199.998,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,492.5,1135,1000,1380,1390,370,380,2900,435,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2782.5,750,1395,475,1775,1000,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (146.141,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.2033,0.123889,-0.000178538,1.48623e-07,-5.02867e-11,-23875.9,40.3108], Tmin=(100,'K'), Tmax=(791.545,'K')), NASAPolynomial(coeffs=[11.3315,0.0516043,-2.46129e-05,4.71124e-09,-3.26704e-13,-25580.2,-15.4629], Tmin=(791.545,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-199.998,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(ROOJ) + radical(CCsJOCs)"""),
)

species(
    label = '[CH2]C(OO)OCCC[C]=O(22764)',
    structure = SMILES('[CH2]C(OO)OCCC[C]=O'),
    E0 = (-158.536,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (146.141,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.28568,0.125914,-0.000181996,1.5132e-07,-5.13229e-11,-18886.3,43.2169], Tmin=(100,'K'), Tmax=(774.135,'K')), NASAPolynomial(coeffs=[11.726,0.0518371,-2.51995e-05,4.8698e-09,-3.39814e-13,-20695.8,-14.9013], Tmin=(774.135,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-158.536,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(448.981,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(CJCOOH) + radical(CCCJ=O)"""),
)

species(
    label = 'CC(OO)O[CH][CH]CC=O(22765)',
    structure = SMILES('CC(OO)O[CH][CH]CC=O'),
    E0 = (-152.101,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (146.141,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.01724,0.118919,-0.000151788,1.09666e-07,-3.26914e-11,-18120.5,41.402], Tmin=(100,'K'), Tmax=(810.94,'K')), NASAPolynomial(coeffs=[12.9774,0.0498902,-2.41052e-05,4.69954e-09,-3.31935e-13,-20390.3,-23.1815], Tmin=(810.94,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-152.101,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(448.981,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(CCJCO) + radical(CCsJOCs)"""),
)

species(
    label = '[CH2]C(O[O])OCCCC=O(22766)',
    structure = SMILES('[CH2]C(O[O])OCCCC=O'),
    E0 = (-166.492,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (146.141,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.977993,0.11975,-0.000173292,1.48895e-07,-5.21328e-11,-19854.9,42.0497], Tmin=(100,'K'), Tmax=(793.14,'K')), NASAPolynomial(coeffs=[9.28461,0.0550994,-2.6638e-05,5.12912e-09,-3.56807e-13,-21077.3,-2.52634], Tmin=(793.14,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-166.492,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(CJCOOH) + radical(ROOJ)"""),
)

species(
    label = 'CC(OO)O[CH]C[CH]C=O(22767)',
    structure = SMILES('CC(OO)O[CH]CC=C[O]'),
    E0 = (-208.751,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (146.141,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.58554,0.117539,-0.000123163,6.49648e-08,-1.35158e-11,-24901.3,40.6362], Tmin=(100,'K'), Tmax=(1169.63,'K')), NASAPolynomial(coeffs=[23.3725,0.0321854,-1.37002e-05,2.57319e-09,-1.80055e-13,-30739.6,-83.6826], Tmin=(1169.63,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-208.751,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-(Cds-Cd)H) + group(O2s-OsH) + group(Cs-CsOsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(CCsJOCs) + radical(C=COJ)"""),
)

species(
    label = 'CC(OO)O[CH]CC[C]=O(22768)',
    structure = SMILES('CC(OO)O[CH]CC[C]=O'),
    E0 = (-192.042,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (146.141,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.11846,0.124364,-0.000160998,1.04164e-07,-2.11809e-11,-22924,40.1294], Tmin=(100,'K'), Tmax=(622.074,'K')), NASAPolynomial(coeffs=[13.4913,0.0488851,-2.35159e-05,4.5377e-09,-3.17153e-13,-25098.9,-26.2906], Tmin=(622.074,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-192.042,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(448.981,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(CCsJOCs) + radical(CCCJ=O)"""),
)
...
species(
    label = '[CH2]C(OO)OC1CC[CH]O1(22769)',
    structure = SMILES('[CH2]C(OO)OC1CC[CH]O1'),
    E0 = (-149.902,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (146.141,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.886874,0.0958568,-6.81801e-05,1.2548e-08,4.72014e-12,-17842.7,36.745], Tmin=(100,'K'), Tmax=(955.293,'K')), NASAPolynomial(coeffs=[20.5369,0.0328015,-1.10173e-05,1.85936e-09,-1.25129e-13,-23151.9,-71.9974], Tmin=(955.293,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-149.902,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Tetrahydrofuran) + radical(CCsJOCs) + radical(CJCOOH)"""),
)
...
species(
    label = 'C=C(OO)OCCCC=O(22771)',
    structure = SMILES('C=C(OO)OCCCC=O'),
    E0 = (-348.509,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (146.141,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.911681,0.116375,-0.000148054,1.08174e-07,-3.27392e-11,-41746.6,36.6856], Tmin=(100,'K'), Tmax=(798.329,'K')), NASAPolynomial(coeffs=[12.2518,0.050419,-2.41259e-05,4.6824e-09,-3.29784e-13,-43848.3,-23.8554], Tmin=(798.329,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-348.509,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsCs) + group(Cds-OdCsH) + group(Cds-CdsHH)"""),
)

species(
    label = 'CC(OO)OC=CCC=O(22772)',
    structure = SMILES('CC(OO)OC=CCC=O'),
    E0 = (-449.521,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (146.141,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.327,0.0995324,-6.87344e-05,1.18591e-08,3.24988e-12,-53858.1,38.041], Tmin=(100,'K'), Tmax=(1100.54,'K')), NASAPolynomial(coeffs=[26.1002,0.0293582,-1.33136e-05,2.65361e-09,-1.94129e-13,-61682.3,-105.027], Tmin=(1100.54,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-449.521,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsOsOsH) + group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-OdCsH)"""),
)
...
species(
    label = '[CH2]C(OO)O[CH]CC(13482)',
    structure = SMILES('[CH2]C(OO)O[CH]CC'),
    E0 = (-31.4606,'kJ/mol'),
    modes = [
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.320507,0.0999381,-0.000114186,7.11221e-08,-1.81188e-11,-3632.38,34.118], Tmin=(100,'K'), Tmax=(945.542,'K')), NASAPolynomial(coeffs=[13.9612,0.0395195,-1.83365e-05,3.54042e-09,-2.49891e-13,-6333.11,-33.9831], Tmin=(945.542,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-31.4606,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(403.252,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCsJOCs) + radical(CJCOOH)"""),
)
...
species(
    label = 'O=CCC[CH]OC1CO1(22773)',
    structure = SMILES('O=CCC[CH]OC1CO1'),
    E0 = (-233.944,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (129.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.261761,0.0948398,-0.000101606,5.79138e-08,-1.18844e-11,-27984.3,32.4624], Tmin=(100,'K'), Tmax=(796.035,'K')), NASAPolynomial(coeffs=[13.6827,0.0363661,-1.32717e-05,2.2344e-09,-1.4491e-13,-30571.8,-33.9381], Tmin=(796.035,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-233.944,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cds-OdCsH) + ring(Ethylene_oxide) + radical(CCsJOCs)"""),
)

species(
    label = '[CH2]C1OC(CCC=O)O1(22521)',
    structure = SMILES('[CH2]C1OC(CCC=O)O1'),
    E0 = (-243.843,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (129.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.155523,0.0762072,-5.21126e-05,1.69613e-08,-2.19903e-12,-29182.5,33.1364], Tmin=(100,'K'), Tmax=(1782.15,'K')), NASAPolynomial(coeffs=[20.6437,0.0302216,-1.34072e-05,2.48231e-09,-1.67906e-13,-36485,-77.5457], Tmin=(1782.15,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-243.843,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(415.724,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsOsH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + ring(Cyclobutane) + radical(CJCO)"""),
)

species(
    label = '[CH2]C(CC=O)OC([CH2])OO(22774)',
    structure = SMILES('[CH2]C(CC=O)OC([CH2])OO'),
    E0 = (-118.537,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2782.5,750,1395,475,1775,1000,3615,1310,387.5,850,1000,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (146.141,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.61446,0.134119,-0.000201685,1.70114e-07,-5.78015e-11,-14064.7,42.9838], Tmin=(100,'K'), Tmax=(789.832,'K')), NASAPolynomial(coeffs=[12.7126,0.0513884,-2.52472e-05,4.88144e-09,-3.39928e-13,-16010.6,-20.7471], Tmin=(789.832,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-118.537,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(448.981,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(CJCOOH) + radical(CJC(C)OC)"""),
)
...
species(
    label = '[O]C(CO)O[CH]CCC=O(22775)',
    structure = SMILES('[O]C(CO)O[CH]CCC=O'),
    E0 = (-357.63,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (146.141,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.2077,0.128235,-0.000203042,1.83292e-07,-6.52108e-11,-42838.7,42.3656], Tmin=(100,'K'), Tmax=(828.769,'K')), NASAPolynomial(coeffs=[8.32227,0.0568265,-2.78034e-05,5.3302e-09,-3.67706e-13,-43545.5,3.44423], Tmin=(828.769,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-357.63,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cds-OdCsH) + radical(CCOJ) + radical(CCsJOCs)"""),
)

species(
    label = '[CH2]C(OO)O[CH]COC=C(22776)',
    structure = SMILES('[CH2]C(OO)O[CH]COC=C'),
    E0 = (-96.4438,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,3615,1310,387.5,850,1000,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,1380,1390,370,380,2900,435,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (146.141,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.25255,0.13033,-0.000148588,8.31911e-08,-1.8066e-11,-11368.1,42.3609], Tmin=(100,'K'), Tmax=(1132.93,'K')), NASAPolynomial(coeffs=[27.2879,0.0260315,-1.04944e-05,1.92963e-09,-1.34098e-13,-18061.5,-103.841], Tmin=(1132.93,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-96.4438,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(448.981,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-Cs(Cds-Cd)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CCsJOCs) + radical(CJCOOH)"""),
)

species(
    label = '[CH2]C(OO)O[CH]CC=CO(22777)',
    structure = SMILES('[CH2]C(OO)O[CH]CC=CO'),
    E0 = (-136.251,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2995,3025,975,1000,1300,1375,400,500,1630,1680,3615,1277.5,1000,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,3615,1310,387.5,850,1000,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (146.141,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.28789,0.129927,-0.000149381,8.423e-08,-1.83548e-11,-16153.6,43.7396], Tmin=(100,'K'), Tmax=(1131.93,'K')), NASAPolynomial(coeffs=[27.6631,0.0240887,-9.12872e-06,1.62776e-09,-1.11412e-13,-22934.2,-104.469], Tmin=(1131.93,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-136.251,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(448.981,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-(Cds-Cd)H) + group(O2s-OsH) + group(Cs-CsOsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(CJCOOH) + radical(CCsJOCs)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(OO)O[CH]CCC=O(22550)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]C(OO)O[CH]CCC=O(22550)'],
    products = ['[CH2]C(OO)OC1CCC1[O](22755)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', '[CH2]C(OO)OC=CCC=O(22757)'],
    products = ['[CH2]C(OO)O[CH]CCC=O(22550)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)', 'C=C(OO)O[CH]CCC=O(22758)'],
    products = ['[CH2]C(OO)O[CH]CCC=O(22550)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['CH2CHO(40)', '[CH2]C(OO)OC=C(10667)'],
    products = ['[CH2]C(OO)O[CH]CCC=O(22550)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['HO2(10)', 'C=CO[CH]CCC=O(18468)'],
    products = ['[CH2]C(OO)O[CH]CCC=O(22550)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]C(OO)OC[CH]CC=O(22759)'],
    products = ['[CH2]C(OO)O[CH]CCC=O(22550)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]C(OO)O[CH]CCC=O(22550)'],
    products = ['C[C](OO)O[CH]CCC=O(22760)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2][C](OO)OCCCC=O(22761)'],
    products = ['[CH2]C(OO)O[CH]CCC=O(22550)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]C(OO)O[CH]CCC=O(22550)'],
    products = ['[CH2]C(OO)OCC[CH]C=O(22762)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CC(O[O])O[CH]CCC=O(22763)'],
    products = ['[CH2]C(OO)O[CH]CCC=O(22550)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]C(OO)O[CH]CCC=O(22550)'],
    products = ['[CH2]C(OO)OCCC[C]=O(22764)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]C(OO)O[CH]CCC=O(22550)'],
    products = ['CC(OO)O[CH][CH]CC=O(22765)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]C(OO)O[CH]CCC=O(22550)'],
    products = ['[CH2]C(O[O])OCCCC=O(22766)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]C(OO)O[CH]CCC=O(22550)'],
    products = ['CC(OO)O[CH]C[CH]C=O(22767)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2]C(OO)O[CH]CCC=O(22550)'],
    products = ['CC(OO)O[CH]CC[C]=O(22768)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2]C(OO)O[CH]CCC=O(22550)'],
    products = ['[CH2]C(OO)OC1CC[CH]O1(22769)'],
...
reaction(
    label = 'reaction24',
    reactants = ['CO(12)', '[CH2]C(OO)O[CH]CC(13482)'],
    products = ['[CH2]C(OO)O[CH]CCC=O(22550)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[CH2]C(OO)O[CH]CCC=O(22550)'],
    products = ['OH(5)', 'O=CCC[CH]OC1CO1(22773)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[CH2]C(OO)O[CH]CCC=O(22550)'],
    products = ['OH(5)', '[CH2]C1OC(CCC=O)O1(22521)'],
...
reaction(
    label = 'reaction27',
    reactants = ['[CH2]C(CC=O)OC([CH2])OO(22774)'],
    products = ['[CH2]C(OO)O[CH]CCC=O(22550)'],
...
reaction(
    label = 'reaction29',
    reactants = ['[CH2]C(OO)O[CH]CCC=O(22550)'],
    products = ['[O]C(CO)O[CH]CCC=O(22775)'],
...
reaction(
    label = 'reaction30',
    reactants = ['[CH2]C(OO)O[CH]COC=C(22776)'],
    products = ['[CH2]C(OO)O[CH]CCC=O(22550)'],
...
reaction(
    label = 'reaction31',
    reactants = ['[CH2]C(OO)O[CH]CC=CO(22777)'],
    products = ['[CH2]C(OO)O[CH]CCC=O(22550)'],
...
reaction(
    label = 'reaction32',
    reactants = ['[CH2]C([O])OO(3363)', '[CH]CCC=O(18484)'],
    products = ['[CH2]C(OO)O[CH]CCC=O(22550)'],
...
reaction(
    label = 'reaction33',
    reactants = ['CH2(19)', 'O=CCC[CH]O[CH]OO(22312)'],
    products = ['[CH2]C(OO)O[CH]CCC=O(22550)'],
