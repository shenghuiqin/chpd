...
species(
    label = '[CH2]C(C=C)CC(O)=C=O(19867)',
    structure = SMILES('[CH2]C(C=C)CC(O)=C=O'),
    E0 = (-8.7362,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2120,512.5,787.5,3010,987.5,1337.5,450,1655,3615,1277.5,1000,2950,3100,1380,975,1025,1650,1380,1390,370,380,2900,435,350,440,435,1725,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.17219,0.0987148,-0.000100145,5.14209e-08,-1.01688e-11,-851.687,36.9132], Tmin=(100,'K'), Tmax=(1331.66,'K')), NASAPolynomial(coeffs=[22.9451,0.0204737,-5.48212e-06,7.60099e-10,-4.41221e-14,-6760.79,-84.4163], Tmin=(1331.66,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-8.7362,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cdd-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-(Cdd-O2d)CsOs) + group(Cds-CdsHH) + radical(Isobutyl)"""),
)
...
species(
    label = '[CH2]C(C=C)CC1(O)O[C]1CC(19882)',
    structure = SMILES('[CH2]C(C=C)CC1(O)O[C]1CC'),
    E0 = (34.0754,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (154.206,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-4.08512,0.137911,-0.000132676,6.43465e-08,-1.16617e-11,4423.74,51.1759], Tmin=(100,'K'), Tmax=(1597.48,'K')), NASAPolynomial(coeffs=[30.2429,0.0258181,-2.88012e-06,-6.28423e-11,2.10605e-14,-3208.8,-120.078], Tmin=(1597.48,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(34.0754,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(577.856,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Ethylene_oxide) + radical(C2CsJO) + radical(Isobutyl)"""),
)
...
species(
    label = '[CH2]C(C=C)CC(O)=C(C)[O](19887)',
    structure = SMILES('[CH2]C(C=C)CC(O)=C(C)[O]'),
    E0 = (-90.3078,'kJ/mol'),
    modes = [
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.102,0.114964,-0.000110564,5.43336e-08,-1.03403e-11,-10625.5,44.1519], Tmin=(100,'K'), Tmax=(1378.64,'K')), NASAPolynomial(coeffs=[26.0458,0.0267905,-7.55031e-06,1.09683e-09,-6.57449e-14,-17768.4,-98.441], Tmin=(1378.64,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-90.3078,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(C=C(C)OJ) + radical(Isobutyl)"""),
)
...
species(
    label = '[CH2]C(C=C)C[C]=C(CC)OO(19890)',
    ...
    molecularWeight = (154.206,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.27789,0.118284,-0.000108793,5.60374e-08,-1.20968e-11,39413.5,47.0673], Tmin=(100,'K'), Tmax=(1092.13,'K')), NASAPolynomial(coeffs=[15.4787,0.0569117,-2.45e-05,4.58246e-09,-3.18159e-13,35753.4,-35.2501], Tmin=(1092.13,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(326.137,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(573.699,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Isobutyl) + radical(Cds_S)"""),
)

species(
    label = '[CH2]C(C=C)CC(=O)C([O])CC(19891)',
    structure = SMILES('[CH2]C(C=C)CC(=O)C([O])CC'),
    E0 = (20.0124,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (154.206,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.16067,0.112611,-9.54191e-05,4.46558e-08,-8.74663e-12,2593.38,47.4207], Tmin=(100,'K'), Tmax=(1195.26,'K')), NASAPolynomial(coeffs=[16.0968,0.0548576,-2.29407e-05,4.23012e-09,-2.91166e-13,-1532.02,-38.9145], Tmin=(1195.26,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(20.0124,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(577.856,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-O2d)CsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdCsCs) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Isobutyl) + radical(C=OCOJ)"""),
)
...
species(
    label = '[CH2]C(C=C)CC(O)=[C]CC(19892)',
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.57655,0.110048,-8.50337e-05,2.7456e-08,-1.06492e-12,24463.7,44.0863], Tmin=(100,'K'), Tmax=(1017.65,'K')), NASAPolynomial(coeffs=[21.8187,0.0401383,-1.44868e-05,2.53052e-09,-1.71813e-13,18560.4,-74.8008], Tmin=(1017.65,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(201.642,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(552.912,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Isobutyl) + radical(Cds_S)"""),
)
...
species(
    label = '[CH2]C(C=C)CC(=O)C(=O)CC(19894)',
    structure = SMILES('[CH2]C(C=C)CC(=O)C(=O)CC'),
    E0 = (-146.336,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (153.198,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.13704,0.121047,-0.000133843,9.14546e-08,-2.68597e-11,-17422.4,42.1907], Tmin=(100,'K'), Tmax=(810.877,'K')), NASAPolynomial(coeffs=[10.3059,0.0645992,-2.94233e-05,5.60519e-09,-3.91516e-13,-19278.2,-10.6158], Tmin=(810.877,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-146.336,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(552.912,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-O2d(Cds-O2d)Cs) + group(Cds-O2d(Cds-O2d)Cs) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]C(C=C)C=C(O)C(=O)CC(19895)',
    structure = SMILES('[CH2]C(C=C)C=C(O)C(=O)CC'),
    E0 = (-140.355,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,2950,3100,1380,975,1025,1650,1380,1390,370,380,2900,435,350,440,435,1725,2750,2850,1437.5,1250,1305,750,350,375,552.5,462.5,1710,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (153.198,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.60727,0.128608,-0.000142535,8.89636e-08,-2.28793e-11,-16683.3,40.385], Tmin=(100,'K'), Tmax=(935.599,'K')), NASAPolynomial(coeffs=[15.6804,0.0546944,-2.40292e-05,4.51864e-09,-3.14065e-13,-19918.1,-41.8665], Tmin=(935.599,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-140.355,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(552.912,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)(Cds-Cds)CsH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-O2d)O2s) + group(Cds-O2d(Cds-Cds)Cs) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]C(C=C)CC([O])C(=O)CC(19896)',
    structure = SMILES('[CH2]C(C=C)CC([O])C(=O)CC'),
    E0 = (20.0124,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,2750,2800,2850,1350,1500,750,1050,1375,1000,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,375,552.5,462.5,1710,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2]C([CH]C(O)C(=O)CC)C=C(19897)',
    structure = SMILES('[CH2]C([CH]C(O)C(=O)CC)C=C'),
    E0 = (-23.8187,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1277.5,1000,2950,3100,1380,975,1025,1650,3010,987.5,1337.5,450,1655,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,2750,2850,1437.5,1250,1305,750,350,375,552.5,462.5,1710,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2]CC(=O)C(O)CC([CH2])C=C(19901)',
    structure = SMILES('[CH2]CC(=O)C(O)CC([CH2])C=C'),
    E0 = (-12.1316,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,3010,987.5,1337.5,450,1655,3615,1277.5,1000,2950,3100,1380,975,1025,1650,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,375,552.5,462.5,1710,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (154.206,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.57194,0.120916,-0.000111975,5.64448e-08,-1.16848e-11,-1257.1,48.752], Tmin=(100,'K'), Tmax=(1150.01,'K')), NASAPolynomial(coeffs=[18.3897,0.0514847,-2.1412e-05,3.94479e-09,-2.718e-13,-5848.29,-50.3414], Tmin=(1150.01,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-12.1316,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(573.699,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsOsH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdCsCs) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CJCC=O) + radical(Isobutyl)"""),
)

species(
    label = '[CH]=CC([CH2])CC(O)C(=O)CC(19902)',
    structure = SMILES('[CH]=CC([CH2])CC(O)C(=O)CC'),
    E0 = (23.3754,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1277.5,1000,3010,987.5,1337.5,450,1655,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,375,552.5,462.5,1710,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (154.206,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.47386,0.11902,-0.000108068,5.35769e-08,-1.09559e-11,3009.64,48.1693], Tmin=(100,'K'), Tmax=(1159.9,'K')), NASAPolynomial(coeffs=[17.8523,0.0523717,-2.18775e-05,4.03778e-09,-2.78394e-13,-1473.63,-47.9349], Tmin=(1159.9,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(23.3754,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(573.699,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsOsH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdCsCs) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Isobutyl) + radical(Cds_P)"""),
)
...
species(
    label = '[CH2]C(C=C)CC(O)([C]=O)CC(19907)',
    structure = SMILES('[CH2]C(C=C)CC(O)([C]=O)CC'),
    E0 = (-44.7893,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1855,455,950,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,1380,1390,370,380,2900,435,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3100,440,815,1455,1000,180,180,180,409.348,736.715,1600,1828.57,2971.43,3200],'cm^-1')),
    ...
    molecularWeight = (154.206,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.92606,0.131087,-0.000137649,7.94607e-08,-1.8654e-11,-5174.06,46.0247], Tmin=(100,'K'), Tmax=(1027.87,'K')), NASAPolynomial(coeffs=[18.6039,0.0511956,-2.10641e-05,3.84676e-09,-2.63492e-13,-9394.6,-53.5856], Tmin=(1027.87,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-44.7893,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(573.699,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-O2d)CsCsOs) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-OdCsH) + group(Cds-CdsHH) + radical(CC(C)(O)CJ=O) + radical(Isobutyl)"""),
)
...
species(
    label = '[CH2]C(C=C)C[C](O)C(=C)OC(19908)',
    structure = SMILES('[CH2]C(OC)=C(O)CC([CH2])C=C'),
    E0 = (-50.5118,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (154.206,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.39323,0.123931,-9.10248e-05,1.34195e-08,8.85224e-12,-5829.76,46.0137], Tmin=(100,'K'), Tmax=(942.602,'K')), NASAPolynomial(coeffs=[28.7105,0.0324445,-9.89384e-06,1.62569e-09,-1.10534e-13,-13492.8,-111.75], Tmin=(942.602,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-50.5118,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(573.699,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-OsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Isobutyl) + radical(C=C(O)CJ)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]C(C=C)C[C](O)C(=O)CC(19808)'],
    products = ['[CH2]C1CC1CC(O)=C([O])CC(19864)'],
    transitionState = 'TS2',
...
reaction(
    ...
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(1.20551e+07,'s^-1'), n=1.225, Ea=(103.136,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [R5_SS_D;doublebond_intra;radadd_intra_cs2H]
Euclidian distance = 0
family: Intra_R_Add_Exocyclic
Ea raised from 101.8 to 103.1 kJ/mol to match endothermicity of reaction."""),
)
...
reaction(
    label = 'reaction7',
    reactants = ['C2H3(30)', 'C=CCC(O)=C([O])CC(6534)'],
    products = ['[CH2]C(C=C)C[C](O)C(=O)CC(19808)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['C2H5(29)', '[CH2]C(C=C)CC(O)=C=O(19867)'],
    products = ['[CH2]C(C=C)C[C](O)C(=O)CC(19808)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]C(C=C)C[C](O)C(=O)CC(19808)'],
    products = ['[CH2]C([CH]C(O)=C(O)CC)C=C(19874)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH2]CC([O])=C(O)CC(C)C=C(19881)'],
    products = ['[CH2]C(C=C)C[C](O)C(=O)CC(19808)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[CH2]C([CH2])C=C(2950)', 'CCC([O])=[C]O(4619)'],
    products = ['[CH2]C(C=C)C[C](O)C(=O)CC(19808)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[CH2]C(C=C)C[C](O)C(=O)CC(19808)'],
    products = ['[CH2]C(C=C)CC1(O)O[C]1CC(19882)'],
...
reaction(
    label = 'reaction30',
    reactants = ['CH2(S)(23)', '[CH2]C(C=C)CC(O)=C(C)[O](19887)'],
    products = ['[CH2]C(C=C)C[C](O)C(=O)CC(19808)'],
...
reaction(
    label = 'reaction32',
    reactants = ['[CH2]C(C=C)C[C](O)C(=O)CC(19808)'],
    products = ['C=CC[CH]CC(O)=C([O])CC(19888)'],
...
reaction(
    label = 'reaction34',
    reactants = ['[CH2]C(C=C)C[C]=C(CC)OO(19890)'],
    products = ['[CH2]C(C=C)C[C](O)C(=O)CC(19808)'],
...
reaction(
    label = 'reaction35',
    reactants = ['[CH2]C(C=C)C[C](O)C(=O)CC(19808)'],
    products = ['[CH2]C(C=C)CC(=O)C([O])CC(19891)'],
...
reaction(
    label = 'reaction38',
    reactants = ['O(4)', '[CH2]C(C=C)CC(O)=[C]CC(19892)'],
    products = ['[CH2]C(C=C)C[C](O)C(=O)CC(19808)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(999564,'s^-1'), n=1.52333, Ea=(104.471,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R5_SS_D;doublebond_intra_2H_pri;radadd_intra_cs] for rate rule [R5_SS_D;doublebond_intra_2H_pri;radadd_intra_csNdDe]
Euclidian distance = 1.0
family: Intra_R_Add_Exocyclic
Ea raised from 103.6 to 104.5 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction40',
    reactants = ['H(3)', '[CH2]C(C=C)CC(=O)C(=O)CC(19894)'],
    products = ['[CH2]C(C=C)C[C](O)C(=O)CC(19808)'],
...
reaction(
    label = 'reaction41',
    reactants = ['H(3)', '[CH2]C(C=C)C=C(O)C(=O)CC(19895)'],
    products = ['[CH2]C(C=C)C[C](O)C(=O)CC(19808)'],
...
reaction(
    label = 'reaction43',
    reactants = ['[CH2]C(C=C)CC([O])C(=O)CC(19896)'],
    products = ['[CH2]C(C=C)C[C](O)C(=O)CC(19808)'],
...
reaction(
    label = 'reaction44',
    reactants = ['[CH2]C([CH]C(O)C(=O)CC)C=C(19897)'],
    products = ['[CH2]C(C=C)C[C](O)C(=O)CC(19808)'],
...
reaction(
    label = 'reaction45',
    reactants = ['[CH2]C(C=C)C[C](O)C(=O)CC(19808)'],
    products = ['[CH2][C](C=C)CC(O)C(=O)CC(19898)'],
...
reaction(
    label = 'reaction46',
    reactants = ['[CH2]C(C=C)CC(O)C(=O)[CH]C(19899)'],
    products = ['[CH2]C(C=C)C[C](O)C(=O)CC(19808)'],
...
reaction(
    label = 'reaction48',
    reactants = ['[CH2]CC(=O)C(O)CC([CH2])C=C(19901)'],
    products = ['[CH2]C(C=C)C[C](O)C(=O)CC(19808)'],
...
reaction(
    label = 'reaction49',
    reactants = ['[CH]=CC([CH2])CC(O)C(=O)CC(19902)'],
    products = ['[CH2]C(C=C)C[C](O)C(=O)CC(19808)'],
...
reaction(
    label = 'reaction56',
    reactants = ['[CH2]C(C=C)CC(O)([C]=O)CC(19907)'],
    products = ['[CH2]C(C=C)C[C](O)C(=O)CC(19808)'],
...
reaction(
    label = 'reaction58',
    reactants = ['[CH2]C(C=C)C[C](O)C(=C)OC(19908)'],
    products = ['[CH2]C(C=C)C[C](O)C(=O)CC(19808)'],
