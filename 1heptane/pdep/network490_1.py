species(
    label = '[CH2]OC[C]=O(944)',
    structure = SMILES('[CH2]OC[C]=O'),
    E0 = (40.0284,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,1855,455,950,294.228,294.431],'cm^-1')),
        HinderedRotor(inertia=(0.00196592,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00196374,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00194417,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]O[CH2](103)', '[C]=O(361)'],
    products = ['[CH2]OC[C]=O(944)'],
