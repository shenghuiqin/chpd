species(
    label = 'CCC([O])O[CH]CC(C)OO(13591)',
    structure = SMILES('CCC([O])O[CH]CC(C)OO'),
    E0 = (-239.749,'kJ/mol'),
    modes = [
...
species(
    label = 'CCC([O])OC=CC(C)OO(13675)',
    structure = SMILES('CCC([O])OC=CC(C)OO'),
    E0 = (-343.786,'kJ/mol'),
    modes = [
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.22889,0.125172,-0.000112164,5.04795e-08,-9.02741e-12,-41113.9,46.0619], Tmin=(100,'K'), Tmax=(1344.41,'K')), NASAPolynomial(coeffs=[26.5638,0.0395045,-1.65807e-05,3.08131e-09,-2.13365e-13,-48855.7,-101.367], Tmin=(1344.41,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-343.786,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(548.755,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(CCOJ)"""),
)

species(
    label = 'CCC(=O)O[CH]CC(C)OO(13676)',
    structure = SMILES('CCC(=O)O[CH]CC(C)OO'),
    E0 = (-443.503,'kJ/mol'),
    modes = [
...
species(
    label = 'CCC([O])OC[CH]C(C)OO(13677)',
    structure = SMILES('CCC([O])OC[CH]C(C)OO'),
    E0 = (-219.79,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3025,407.5,1350,352.5,3615,1310,387.5,850,1000,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'CC[C](O)O[CH]CC(C)OO(13678)',
    structure = SMILES('CC[C](O)O[CH]CC(C)OO'),
    E0 = (-260.208,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (162.184,'amu'),
...
species(
    label = 'CC[C]([O])OCCC(C)OO(13679)',
    structure = SMILES('CC[C]([O])OCCC(C)OO'),
    E0 = (-214.959,'kJ/mol'),
    modes = [
...
species(
    label = 'CCC([O])OCC[C](C)OO(13680)',
    structure = SMILES('CCC([O])OCC[C](C)OO'),
    E0 = (-233.306,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,360,370,350,3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2]C(CCOC([O])CC)OO(13682)',
    structure = SMILES('[CH2]C(CCOC([O])CC)OO'),
    E0 = (-206.242,'kJ/mol'),
    modes = [
...
species(
    label = '[CH2]CC(O)O[CH]CC(C)OO(13683)',
    structure = SMILES('[CH2]CC(O)O[CH]CC(C)OO'),
    E0 = (-260.208,'kJ/mol'),
    modes = [
...
species(
    label = 'C[CH]C([O])OCCC(C)OO(13684)',
    structure = SMILES('C[CH]C([O])OCCC(C)OO'),
    E0 = (-220.303,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3025,407.5,1350,352.5,3615,1310,387.5,850,1000,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'CCC(O)O[CH][CH]C(C)OO(13685)',
    structure = SMILES('CCC(O)O[CH][CH]C(C)OO'),
    E0 = (-265.039,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (162.184,'amu'),
...
species(
    label = 'CCC([O])OCCC(C)O[O](13686)',
    structure = SMILES('CCC([O])OCCC(C)O[O]'),
    E0 = (-268.2,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (162.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.339153,0.113858,-6.51427e-05,-8.7863e-08,1.19911e-10,-32119.6,41.4895], Tmin=(100,'K'), Tmax=(480.727,'K')), NASAPolynomial(coeffs=[8.44464,0.0724156,-3.4575e-05,6.68112e-09,-4.68232e-13,-33329.8,1.74327], Tmin=(480.727,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-268.2,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(573.699,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(CCOJ)"""),
)

species(
    label = '[CH2]CC([O])OCCC(C)OO(13687)',
    structure = SMILES('[CH2]CC([O])OCCC(C)OO'),
    E0 = (-214.959,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1310,387.5,850,1000,3000,3100,440,815,1455,1000,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'CCC(O)O[CH]C[C](C)OO(13688)',
    structure = SMILES('CCC(O)O[CH]C[C](C)OO'),
    E0 = (-278.555,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (162.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.29231,0.148692,-0.000194803,1.47397e-07,-4.60387e-11,-33285.3,46.3431], Tmin=(100,'K'), Tmax=(775.889,'K')), NASAPolynomial(coeffs=[14.2461,0.06343,-2.99684e-05,5.76555e-09,-4.03325e-13,-35851.7,-29.2485], Tmin=(775.889,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-278.555,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(565.384,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCsJOCs) + radical(C2CsJOOH)"""),
)

species(
    label = '[CH2]C(C[CH]OC(O)CC)OO(13689)',
    structure = SMILES('[CH2]C(C[CH]OC(O)CC)OO'),
    E0 = (-251.492,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (162.184,'amu'),
...
species(
    label = 'CCC(O)O[CH]CC(C)O[O](13690)',
    structure = SMILES('CCC(O)O[CH]CC(C)O[O]'),
    E0 = (-313.449,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (162.184,'amu'),
...
species(
    label = 'CCC(=O)OCCC(C)OO(13691)',
    structure = SMILES('CCC(=O)OCCC(C)OO'),
    E0 = (-637.43,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (162.184,'amu'),
...
species(
    ...
    molecularWeight = (162.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.68296,0.129133,-0.000104892,3.3309e-08,-1.01979e-12,-68237.9,46.8241], Tmin=(100,'K'), Tmax=(1046.4,'K')), NASAPolynomial(coeffs=[29.5132,0.0358679,-1.39281e-05,2.58003e-09,-1.82548e-13,-76607.8,-117.762], Tmin=(1046.4,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-569.491,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(569.541,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH)"""),
)
...
species(
    label = 'CCC([O])O[CH]CCOO(13693)',
    structure = SMILES('CCC([O])O[CH]CCOO'),
    E0 = (-203.326,'kJ/mol'),
    modes = [
...
species(
    label = 'CCC([O])OC1CC(C)O1(13694)',
    structure = SMILES('CCC([O])OC1CC(C)O1'),
    E0 = (-348.082,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (145.176,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.754581,0.0938926,-6.47485e-05,2.41516e-08,-3.74715e-12,-41684.7,38.3459], Tmin=(100,'K'), Tmax=(1489.55,'K')), NASAPolynomial(coeffs=[16.7307,0.0469387,-1.74657e-05,2.98985e-09,-1.9548e-13,-46893.8,-52.9779], Tmin=(1489.55,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-348.082,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(536.283,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Oxetane) + radical(CCOJ)"""),
)

species(
    label = '[CH2]C(OC([O])CC)C(C)OO(13695)',
    structure = SMILES('[CH2]C(OC([O])CC)C(C)OO'),
    E0 = (-220.246,'kJ/mol'),
    modes = [
...
species(
    label = 'CCC([O])OC(O)CC(C)[O](13696)',
    structure = SMILES('CCC([O])OC(O)CC(C)[O]'),
    E0 = (-461.58,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (162.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.27996,0.126375,-0.000137606,9.0981e-08,-2.60657e-11,-55334.1,46.0525], Tmin=(100,'K'), Tmax=(825.25,'K')), NASAPolynomial(coeffs=[10.598,0.0688027,-3.29633e-05,6.44817e-09,-4.57875e-13,-57294.6,-8.97071], Tmin=(825.25,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-461.58,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(573.699,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(CC(C)OJ)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['CCC([O])O[CH]CC(C)OO(13591)'],
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'CCC([O])OC=CC(C)OO(13675)'],
    products = ['CCC([O])O[CH]CC(C)OO(13591)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'CCC(=O)O[CH]CC(C)OO(13676)'],
    products = ['CCC([O])O[CH]CC(C)OO(13591)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CC[CH][O](563)', 'CC(CC=O)OO(1957)'],
    products = ['CCC([O])O[CH]CC(C)OO(13591)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CH3CHOOH(63)', 'C=COC([O])CC(11164)'],
    products = ['CCC([O])O[CH]CC(C)OO(13591)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['C2H5(29)', 'CC(C[CH]OC=O)OO(7442)'],
    products = ['CCC([O])O[CH]CC(C)OO(13591)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['CCC([O])OC[CH]C(C)OO(13677)'],
    products = ['CCC([O])O[CH]CC(C)OO(13591)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['CCC([O])O[CH]CC(C)OO(13591)'],
    products = ['CC[C](O)O[CH]CC(C)OO(13678)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['CC[C]([O])OCCC(C)OO(13679)'],
    products = ['CCC([O])O[CH]CC(C)OO(13591)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['CCC([O])OCC[C](C)OO(13680)'],
    products = ['CCC([O])O[CH]CC(C)OO(13591)'],
...
reaction(
    label = 'reaction11',
    reactants = ['C[CH]C(O)O[CH]CC(C)OO(13681)'],
    products = ['CCC([O])O[CH]CC(C)OO(13591)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]C(CCOC([O])CC)OO(13682)'],
    products = ['CCC([O])O[CH]CC(C)OO(13591)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2]CC(O)O[CH]CC(C)OO(13683)'],
    products = ['CCC([O])O[CH]CC(C)OO(13591)'],
...
reaction(
    label = 'reaction14',
    reactants = ['C[CH]C([O])OCCC(C)OO(13684)'],
    products = ['CCC([O])O[CH]CC(C)OO(13591)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CCC([O])O[CH]CC(C)OO(13591)'],
    products = ['CCC(O)O[CH][CH]C(C)OO(13685)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CCC([O])OCCC(C)O[O](13686)'],
    products = ['CCC([O])O[CH]CC(C)OO(13591)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]CC([O])OCCC(C)OO(13687)'],
    products = ['CCC([O])O[CH]CC(C)OO(13591)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CCC([O])O[CH]CC(C)OO(13591)'],
    products = ['CCC(O)O[CH]C[C](C)OO(13688)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CCC([O])O[CH]CC(C)OO(13591)'],
    products = ['[CH2]C(C[CH]OC(O)CC)OO(13689)'],
...
reaction(
    label = 'reaction20',
    reactants = ['CCC([O])O[CH]CC(C)OO(13591)'],
    products = ['CCC(O)O[CH]CC(C)O[O](13690)'],
...
reaction(
    label = 'reaction22',
    reactants = ['CCC([O])O[CH]CC(C)OO(13591)'],
    products = ['CCC(=O)OCCC(C)OO(13691)'],
...
reaction(
    label = 'reaction23',
    reactants = ['CCC([O])O[CH]CC(C)OO(13591)'],
    products = ['CCC(O)OC=CC(C)OO(13692)'],
...
reaction(
    label = 'reaction24',
    reactants = ['CH2(S)(23)', 'CCC([O])O[CH]CCOO(13693)'],
    products = ['CCC([O])O[CH]CC(C)OO(13591)'],
...
reaction(
    label = 'reaction25',
    reactants = ['CH2(S)(23)', 'CC([O])O[CH]CC(C)OO(7397)'],
    products = ['CCC([O])O[CH]CC(C)OO(13591)'],
...
reaction(
    label = 'reaction26',
    reactants = ['CCC([O])O[CH]CC(C)OO(13591)'],
    products = ['OH(5)', 'CCC([O])OC1CC(C)O1(13694)'],
...
reaction(
    label = 'reaction27',
    reactants = ['[CH2]C(OC([O])CC)C(C)OO(13695)'],
    products = ['CCC([O])O[CH]CC(C)OO(13591)'],
...
reaction(
    label = 'reaction29',
    reactants = ['CCC([O])O[CH]CC(C)OO(13591)'],
    products = ['CCC([O])OC(O)CC(C)[O](13696)'],
...
reaction(
    label = 'reaction30',
    reactants = ['[CH]CC(C)OO(1806)', 'CCC([O])[O](3172)'],
    products = ['CCC([O])O[CH]CC(C)OO(13591)'],
