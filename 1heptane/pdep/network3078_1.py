species(
    label = '[CH2]COOOC(16954)',
    structure = SMILES('[CH2]COOOC'),
    E0 = (64.7977,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,200,800,1000,1200,1400,1600],'cm^-1')),
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.32743,0.0537115,-4.08018e-05,1.57501e-08,-2.46678e-12,7893.6,26.5441], Tmin=(100,'K'), Tmax=(1493.36,'K')), NASAPolynomial(coeffs=[13.017,0.0224007,-9.35184e-06,1.7102e-09,-1.16395e-13,4402.26,-34.5391], Tmin=(1493.36,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(64.7977,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(286.849,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsOs) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(CJCOOH)"""),
)
...
species(
    label = 'C=COOOC(16960)',
    structure = SMILES('C=COOOC'),
    E0 = (-6.24732,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,3100,1380,975,1025,1650,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.63425,0.0415495,-7.05625e-06,-2.28646e-08,1.21742e-11,-656.896,24.1233], Tmin=(100,'K'), Tmax=(990.378,'K')), NASAPolynomial(coeffs=[13.6431,0.0170841,-6.40709e-06,1.20452e-09,-8.76204e-14,-4214.39,-39.6479], Tmin=(990.378,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-6.24732,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(O2s-OsOs) + group(Cs-OsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH)"""),
)
...
species(
    label = '[CH2]OOOCC(10472)',
    structure = SMILES('[CH2]OOOCC'),
    E0 = (44.9826,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (91.0859,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.10095,0.0546598,-4.0459e-05,1.49214e-08,-2.19825e-12,5522.15,24.9719], Tmin=(100,'K'), Tmax=(1605.72,'K')), NASAPolynomial(coeffs=[15.0929,0.0198042,-7.89781e-06,1.40237e-09,-9.34055e-14,1028.79,-49.1569], Tmin=(1605.72,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(44.9826,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(286.849,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsOs) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(CsJOO)"""),
)
...
species(
    ...
    E0 = (216.878,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,180,180,684.392,685.907,2141.77],'cm^-1')),
        HinderedRotor(inertia=(0.00995458,'amu*angstrom^2'), symmetry=1, barrier=(3.32662,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0500098,'amu*angstrom^2'), symmetry=1, barrier=(16.8314,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.148001,'amu*angstrom^2'), symmetry=1, barrier=(3.40283,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.14361,0.036978,-3.10936e-05,1.15215e-08,-9.5109e-13,26154.7,22.1115], Tmin=(100,'K'), Tmax=(995.416,'K')), NASAPolynomial(coeffs=[10.1342,0.0120059,-4.2188e-06,7.25975e-10,-4.89727e-14,24210.2,-18.1782], Tmin=(995.416,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(216.878,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsOs) + group(O2s-OsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(CJCOOH)"""),
)
...
species(
    label = '[CH2][CH]OOOC(16961)',
    structure = SMILES('[CH2][CH]OOOC'),
    E0 = (252.245,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (90.0779,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.62723,0.0526388,-4.49932e-05,2.04261e-08,-3.86265e-12,30423,25.6858], Tmin=(100,'K'), Tmax=(1231.46,'K')), NASAPolynomial(coeffs=[10.1661,0.0249029,-1.12091e-05,2.13661e-09,-1.49671e-13,28320,-17.2871], Tmin=(1231.46,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(252.245,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(261.906,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsOs) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(CCsJOO) + radical(CJCOOH)"""),
)

species(
    label = '[CH2]COOO[CH2](16962)',
    structure = SMILES('[CH2]COOO[CH2]'),
    E0 = (258.945,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (90.0779,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.2364,0.0552373,-4.71081e-05,2.03215e-08,-3.50681e-12,31247.9,26.4652], Tmin=(100,'K'), Tmax=(1384.09,'K')), NASAPolynomial(coeffs=[13.7372,0.0191096,-7.95449e-06,1.46243e-09,-1.00366e-13,27787.5,-37.9073], Tmin=(1384.09,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(258.945,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(261.906,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsOs) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(CJCOOH) + radical(CsJOO)"""),
)
...
species(
    label = '[CH2]COOO(11241)',
    structure = SMILES('[CH2]COOO'),
    E0 = (64.8736,'kJ/mol'),
    modes = [
    ...
    collisionModel = TransportData(shapeIndex=2, epsilon=(3497.14,'J/mol'), sigma=(5.90784,'angstroms'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with Tc=546.24 K, Pc=38.48 bar (from Joback method)"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.85589,0.040835,-2.72298e-05,3.15488e-09,2.48093e-12,7885.24,22.3861], Tmin=(100,'K'), Tmax=(1007.42,'K')), NASAPolynomial(coeffs=[12.0275,0.0131464,-4.90921e-06,8.95539e-10,-6.31881e-14,5191.46,-29.9593], Tmin=(1007.42,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(64.8736,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsOs) + group(O2s-OsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CJCOOH)"""),
)
...
species(
    ...
    molecularWeight = (77.0593,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.11577,0.0355465,-1.83852e-05,4.59821e-10,1.70313e-12,9998.85,19.4838], Tmin=(100,'K'), Tmax=(1144.51,'K')), NASAPolynomial(coeffs=[9.97824,0.0176374,-7.45553e-06,1.3991e-09,-9.78636e-14,7572.35,-22.2475], Tmin=(1144.51,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(82.5304,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsOs) + group(Cs-OsHHH) + group(Cs-OsHHH) + radical(CsJOO)"""),
)

species(
    label = '[CH]COOOC(16963)',
    structure = SMILES('[CH]COOOC'),
    E0 = (299.05,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (90.0779,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.45481,0.052765,-4.29864e-05,1.78764e-08,-3.02209e-12,36061.6,25.0915], Tmin=(100,'K'), Tmax=(1389.48,'K')), NASAPolynomial(coeffs=[12.2677,0.0216372,-9.38268e-06,1.7535e-09,-1.21201e-13,33056.7,-30.631], Tmin=(1389.48,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(299.05,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(261.906,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsOs) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(CCJ2_triplet)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]COOOC(16954)'],
    products = ['CH3OO(27)', 'cC2H4O(44)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'C=COOOC(16960)'],
    products = ['[CH2]COOOC(16954)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction7',
    reactants = ['COO[O](464)', 'C2H4(T)(94)'],
    products = ['[CH2]COOOC(16954)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(7.75733e+07,'m^3/(mol*s)'), n=-0.180109, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [Y_rad;O_rad/NonDe]
Euclidian distance = 0
Multiplied by reaction path degeneracy 2.0
family: R_Recombination
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]COO[O](160)', 'CH3(17)'],
    products = ['[CH2]COOOC(16954)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(3)', '[CH2][CH]OOOC(16961)'],
    products = ['[CH2]COOOC(16954)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(3)', '[CH2]COOO[CH2](16962)'],
    products = ['[CH2]COOOC(16954)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CH2(S)(23)', '[CH2]COOO(11241)'],
    products = ['[CH2]COOOC(16954)'],
