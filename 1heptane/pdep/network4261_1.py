...
species(
    label = '[CH2]C=CCC=C=CC(24736)',
    structure = SMILES('[CH2]C=CCC=C=CC'),
    E0 = (308.776,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,540,610,2055,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,2995,3005,3015,3025,975,983.333,991.667,1000,1300,1325,1350,1375,400,433.333,466.667,500,1630,1646.67,1663.33,1680,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.809527,'amu*angstrom^2'), symmetry=1, barrier=(18.6126,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.807859,'amu*angstrom^2'), symmetry=1, barrier=(18.5743,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.275127,'amu*angstrom^2'), symmetry=1, barrier=(18.5884,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.376361,'amu*angstrom^2'), symmetry=1, barrier=(8.65329,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (107.173,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.139316,0.0740452,-4.46001e-05,1.00458e-08,1.56562e-13,37285.2,31.4459], Tmin=(100,'K'), Tmax=(1214.49,'K')), NASAPolynomial(coeffs=[15.525,0.0366519,-1.48184e-05,2.70133e-09,-1.84957e-13,32568.6,-49.8029], Tmin=(1214.49,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(308.776,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(440.667,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cdd-CdsCds) + radical(Allyl_P)"""),
)

species(
    label = '[CH2]C=CCCC#CC(24737)',
    structure = SMILES('[CH2]C=CCCC#CC'),
    E0 = (303.096,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2100,2250,500,550,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (107.173,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.447944,0.0683661,-2.81481e-05,-9.72764e-09,8.54253e-12,36590.5,31.1395], Tmin=(100,'K'), Tmax=(980.989,'K')), NASAPolynomial(coeffs=[13.2516,0.0374224,-1.33463e-05,2.3089e-09,-1.5588e-13,33055.3,-35.5999], Tmin=(980.989,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(303.096,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-CtCsHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-CtHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Ct-CtCs) + group(Ct-CtCs) + radical(Allyl_P)"""),
)

species(
    label = 'C=C=CCC[C]=CC(24738)',
    structure = SMILES('C=C=CCC[C]=CC'),
    E0 = (406.095,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([540,610,2055,1685,370,2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,2950,3100,1380,975,1025,1650,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,263.501,263.521,263.823],'cm^-1')),
        HinderedRotor(inertia=(0.238853,'amu*angstrom^2'), symmetry=1, barrier=(11.7635,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.238633,'amu*angstrom^2'), symmetry=1, barrier=(11.7637,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.239098,'amu*angstrom^2'), symmetry=1, barrier=(11.7636,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.238904,'amu*angstrom^2'), symmetry=1, barrier=(11.7638,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (107.173,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.630755,0.0745715,-5.23806e-05,1.95243e-08,-3.0955e-12,48962.3,30.2672], Tmin=(100,'K'), Tmax=(1408.24,'K')), NASAPolynomial(coeffs=[11.8837,0.0426084,-1.83348e-05,3.40687e-09,-2.34226e-13,45792.9,-27.8741], Tmin=(1408.24,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(406.095,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(440.667,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(Cds_S)"""),
)
...
species(
    label = 'C#CCCC=C[CH2](24739)',
    structure = SMILES('C#CCCC=C[CH2]'),
    E0 = (345.277,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,750,770,3400,2100,2175,525,2995,3025,975,1000,1300,1375,400,500,1630,1680,3000,3100,440,815,1455,1000,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.0469858,'amu*angstrom^2'), symmetry=1, barrier=(14.8561,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.193252,'amu*angstrom^2'), symmetry=1, barrier=(14.8733,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.31245,'amu*angstrom^2'), symmetry=1, barrier=(100.525,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(4.39222,'amu*angstrom^2'), symmetry=1, barrier=(100.986,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (93.1464,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.84546,0.0604197,-2.95626e-05,-4.31853e-09,6.16619e-12,41648.7,26.2925], Tmin=(100,'K'), Tmax=(996.171,'K')), NASAPolynomial(coeffs=[13.335,0.0290279,-1.05399e-05,1.85379e-09,-1.26716e-13,38229.6,-38.5861], Tmin=(996.171,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(345.277,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-CtCsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Ct-CtCs) + group(Ct-CtH) + radical(Allyl_P)"""),
)
...
species(
    label = 'CC=[C]CCC1[CH]C1(24744)',
    structure = SMILES('CC=[C]CCC1[CH]C1'),
    E0 = (493.421,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.548011,0.0649338,-2.0645e-05,-1.00024e-08,5.92763e-12,59478.2,33.1129], Tmin=(100,'K'), Tmax=(1149.95,'K')), NASAPolynomial(coeffs=[12.6938,0.0426018,-1.74937e-05,3.23133e-09,-2.23576e-13,55368,-32.9062], Tmin=(1149.95,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(493.421,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(465.61,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cyclopropane) + radical(Cds_S) + radical(cyclopropane)"""),
)
...
species(
    label = '[CH]=CCC[C]=CC(24747)',
    structure = SMILES('[CH]=CCC[C]=CC'),
    E0 = (512.612,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,1685,370,2750,2800,2850,1350,1500,750,1050,1375,1000,3120,650,792.5,1650,2995,3025,975,1000,1300,1375,400,500,1630,1680,318.701,318.713],'cm^-1')),
        HinderedRotor(inertia=(0.136391,'amu*angstrom^2'), symmetry=1, barrier=(9.81015,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.135517,'amu*angstrom^2'), symmetry=1, barrier=(9.81069,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.135975,'amu*angstrom^2'), symmetry=1, barrier=(9.80585,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.135505,'amu*angstrom^2'), symmetry=1, barrier=(9.81071,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.05212,0.064179,-4.39249e-05,1.58393e-08,-2.41599e-12,61759.2,28.2996], Tmin=(100,'K'), Tmax=(1463.61,'K')), NASAPolynomial(coeffs=[11.2539,0.0362977,-1.53502e-05,2.82352e-09,-1.92748e-13,58772.9,-24.8038], Tmin=(1463.61,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(512.612,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(390.78,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_P) + radical(Cds_S)"""),
)

species(
    label = 'C=CC=CC[C]=CC(24748)',
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.607665,'amu*angstrom^2'), symmetry=1, barrier=(13.9714,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.607623,'amu*angstrom^2'), symmetry=1, barrier=(13.9704,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.607513,'amu*angstrom^2'), symmetry=1, barrier=(13.9679,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.60783,'amu*angstrom^2'), symmetry=1, barrier=(13.9752,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (107.173,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.14057,0.0740651,-4.36018e-05,6.64797e-09,2.01015e-12,41321.8,31.596], Tmin=(100,'K'), Tmax=(1106.34,'K')), NASAPolynomial(coeffs=[15.54,0.0352654,-1.38788e-05,2.52596e-09,-1.74236e-13,36881.5,-48.9214], Tmin=(1106.34,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(342.338,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(440.667,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + radical(Cds_S)"""),
)
...
species(
    label = 'C=[C]CCC[C]=CC(24749)',
    structure = SMILES('C=[C]CCC[C]=CC'),
    E0 = (479.578,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2950,3100,1380,975,1025,1650,1670,1700,300,440,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.699861,0.0770247,-5.53694e-05,2.23338e-08,-4.00443e-12,57794.7,31.8841], Tmin=(100,'K'), Tmax=(1222.98,'K')), NASAPolynomial(coeffs=[9.01033,0.0498438,-2.20319e-05,4.16107e-09,-2.89612e-13,55762,-9.88204], Tmin=(1222.98,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(479.578,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_S) + radical(Cds_S)"""),
)

species(
    label = 'C=CCC[CH][C]=CC(24750)',
    structure = SMILES('C=CCC[CH][C]=CC'),
    E0 = (382.849,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,2950,3100,1380,975,1025,1650,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.271391,0.0746503,-4.61163e-05,1.41222e-08,-1.75943e-12,46186,31.8617], Tmin=(100,'K'), Tmax=(1811.41,'K')), NASAPolynomial(coeffs=[17.354,0.0369286,-1.488e-05,2.62624e-09,-1.7285e-13,39997.2,-60.701], Tmin=(1811.41,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(382.849,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_S) + radical(Allyl_S)"""),
)

species(
    label = '[CH]=CCCC[C]=CC(24751)',
    ...
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.473169,0.0782007,-5.52777e-05,2.09083e-08,-3.37514e-12,58918.8,32.621], Tmin=(100,'K'), Tmax=(1384.24,'K')), NASAPolynomial(coeffs=[11.9599,0.0450079,-1.93091e-05,3.58539e-09,-2.46552e-13,55738.8,-26.5307], Tmin=(1384.24,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(488.832,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_P) + radical(Cds_S)"""),
)

species(
    label = 'C=CCCC[C]=[C]C(24752)',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', '[CH2]C=CCC=C=CC(24736)'],
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', '[CH2]C=CCCC#CC(24737)'],
    products = ['[CH2]C=CCC[C]=CC(19736)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)', 'C=C=CCC[C]=CC(24738)'],
    products = ['[CH2]C=CCC[C]=CC(19736)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['CH3(17)', 'C#CCCC=C[CH2](24739)'],
    products = ['[CH2]C=CCC[C]=CC(19736)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]C=CCCC=[C]C(19735)'],
    products = ['[CH2]C=CCC[C]=CC(19736)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction20',
    reactants = ['[CH]=C[CH2](2461)', '[CH2]C[C]=CC(24198)'],
    products = ['[CH2]C=CCC[C]=CC(19736)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH2]C=CCC[C]=CC(19736)'],
    products = ['CC=[C]CCC1[CH]C1(24744)'],
...
reaction(
    label = 'reaction28',
    reactants = ['[CH2]C=CC[CH2](18993)', '[C]=CC(24199)'],
    products = ['[CH2]C=CCC[C]=CC(19736)'],
...
reaction(
    label = 'reaction29',
    reactants = ['CH2(19)', '[CH]=CCC[C]=CC(24747)'],
    products = ['[CH2]C=CCC[C]=CC(19736)'],
...
reaction(
    label = 'reaction30',
    reactants = ['H(3)', 'C=CC=CC[C]=CC(24748)'],
    products = ['[CH2]C=CCC[C]=CC(19736)'],
...
reaction(
    label = 'reaction32',
    reactants = ['C=CC[CH]C[C]=CC(24599)'],
    products = ['[CH2]C=CCC[C]=CC(19736)'],
...
reaction(
    label = 'reaction36',
    reactants = ['C=CCCC[C]=[C]C(24752)'],
    products = ['[CH2]C=CCC[C]=CC(19736)'],
    transitionState = 'TS36',
    kinetics = Arrhenius(A=(2.96149e+07,'s^-1'), n=1.545, Ea=(96.8388,'kJ/mol'), T0=(1,'K'), comment="""Estimated using average of templates [RnH;Cd_rad_out_single;Cs_H_out_H/Cd] + [RnH;Cd_rad_out_Cs;Cs_H_out_1H] for rate rule [R5HJ_1;Cd_rad_out_Cs;Cs_H_out_H/Cd]
Euclidian distance = 2.82842712475
Multiplied by reaction path degeneracy 2.0
family: intra_H_migration"""),
)
