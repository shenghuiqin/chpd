...
species(
    label = 'CCCCC1CC([CH][O])O1(4156)',
    structure = SMILES('CCCCC1CC([CH][O])O1'),
    E0 = (5.66899,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (142.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.919576,0.102803,-8.14597e-05,3.73968e-08,-7.2417e-12,863.399,38.0808], Tmin=(100,'K'), Tmax=(1211.98,'K')), NASAPolynomial(coeffs=[14.2276,0.0528119,-1.95881e-05,3.36348e-09,-2.21518e-13,-2808.22,-37.9077], Tmin=(1211.98,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(5.66899,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(561.227,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Oxetane) + radical(CCsJOH) + radical(CCOJ)"""),
)
...
species(
    label = 'C=C(CCCC)OC=C[O](4157)',
    structure = SMILES('C=C(CCCC)OC=C[O]'),
    E0 = (-209.514,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2950,3100,1380,975,1025,1650,2995,3025,975,1000,1300,1375,400,500,1630,1680,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.38874,0.101119,-5.58361e-05,-6.36615e-09,1.14007e-11,-24989.3,41.0559], Tmin=(100,'K'), Tmax=(996.322,'K')), NASAPolynomial(coeffs=[24.1617,0.0356261,-1.30696e-05,2.37844e-09,-1.68248e-13,-31921.3,-91.3536], Tmin=(996.322,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-209.514,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(532.126,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C=COJ)"""),
)

species(
    label = '[CH2]C(CCCC)OC=C=O(4158)',
    structure = SMILES('[CH2]C(CCCC)OC=C=O'),
    E0 = (-110.078,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2120,512.5,787.5,3010,987.5,1337.5,450,1655,2750,2800,2850,1350,1500,750,1050,1375,1000,1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3000,3100,440,815,1455,1000,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (141.188,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.16116,0.124987,-0.000124421,6.35139e-08,-1.27788e-11,-13008.5,39.8478], Tmin=(100,'K'), Tmax=(1212.14,'K')), NASAPolynomial(coeffs=[25.0898,0.0350605,-1.31393e-05,2.31021e-09,-1.55798e-13,-19615,-96.8653], Tmin=(1212.14,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-110.078,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(527.969,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-(Cdd-O2d)OsH) + radical(CJC(C)OC)"""),
)
...
species(
    label = 'CCCC[C](C)OC=C[O](4159)',
    structure = SMILES('CCCC[C](C)OC=C[O]'),
    E0 = (-160.385,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (142.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.1063,0.115981,-7.8315e-05,6.25297e-09,9.30166e-12,-19053.7,41.307], Tmin=(100,'K'), Tmax=(981.452,'K')), NASAPolynomial(coeffs=[28.1847,0.0323201,-1.12687e-05,2.02153e-09,-1.43372e-13,-26916,-114.026], Tmin=(981.452,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-160.385,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(552.912,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + radical(C2CsJOC(O)) + radical(C=COJ)"""),
)

species(
    label = '[CH2]C(CCCC)OC=[C]O(4160)',
    structure = SMILES('[CH2]C(CCCC)OC=[C]O'),
    E0 = (-51.8093,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (142.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-3.27137,0.137239,-0.000139546,7.03959e-08,-1.36168e-11,-5950.11,46.1624], Tmin=(100,'K'), Tmax=(1359,'K')), NASAPolynomial(coeffs=[32.2653,0.0247587,-6.69409e-06,9.55478e-10,-5.73265e-14,-14880.9,-133.504], Tmin=(1359,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-51.8093,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(548.755,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + radical(CJC(C)OC) + radical(C=CJO)"""),
)

species(
    label = 'CCC[CH]C(C)OC=C[O](4161)',
    structure = SMILES('CCC[CH]C(C)OC=C[O]'),
    E0 = (-160.699,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (142.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.7877,0.101995,-2.79471e-05,-5.3258e-08,3.23688e-11,-19096.2,41.8553], Tmin=(100,'K'), Tmax=(949.715,'K')), NASAPolynomial(coeffs=[30.6664,0.0272922,-7.86234e-06,1.36774e-09,-1.01524e-13,-28056.1,-127.76], Tmin=(949.715,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-160.699,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(552.912,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + radical(C=COJ) + radical(CCJCO)"""),
)

species(
    label = '[CH2]C(CCCC)O[C]=CO(4162)',
    structure = SMILES('[CH2]C(CCCC)O[C]=CO'),
    E0 = (-51.8093,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,1685,370,1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3000,3100,440,815,1455,1000,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'CCCCC(C)O[C]=C[O](4163)',
    structure = SMILES('CCCCC(C)O[C]=C[O]'),
    E0 = (-120.857,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (142.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.79934,0.109276,-6.44811e-05,-3.76407e-09,1.18425e-11,-14310.6,42.5295], Tmin=(100,'K'), Tmax=(983.96,'K')), NASAPolynomial(coeffs=[26.221,0.0352781,-1.25155e-05,2.24938e-09,-1.58881e-13,-21756.8,-102.017], Tmin=(983.96,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-120.857,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(552.912,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + radical(C=CJO) + radical(C=COJ)"""),
)

species(
    label = 'CC[CH]CC(C)OC=C[O](4164)',
    structure = SMILES('CC[CH]CC(C)OC=C[O]'),
    E0 = (-166.143,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (142.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.72835,0.107672,-6.03958e-05,-7.93248e-09,1.34331e-11,-19759.7,41.7099], Tmin=(100,'K'), Tmax=(976.442,'K')), NASAPolynomial(coeffs=[25.8983,0.035442,-1.23335e-05,2.1954e-09,-1.54556e-13,-27106.7,-100.909], Tmin=(976.442,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-166.143,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(552.912,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + radical(RCCJCC) + radical(C=COJ)"""),
)

species(
    label = 'CCCCC(C)OC=[C][O](4165)',
    structure = SMILES('CCCCC(C)OC=[C][O]'),
    E0 = (-120.857,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3010,987.5,1337.5,450,1655,1685,370,1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (142.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.79934,0.109276,-6.44811e-05,-3.76407e-09,1.18425e-11,-14310.6,42.5295], Tmin=(100,'K'), Tmax=(983.96,'K')), NASAPolynomial(coeffs=[26.221,0.0352781,-1.25155e-05,2.24938e-09,-1.58881e-13,-21756.8,-102.017], Tmin=(983.96,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-120.857,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(552.912,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + radical(C=COJ) + radical(C=CJO)"""),
)

species(
    label = 'C[CH]CCC(C)OC=C[O](4166)',
    structure = SMILES('C[CH]CCC(C)OC=C[O]'),
    E0 = (-166.155,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (142.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.75661,0.107104,-5.49664e-05,-1.64672e-08,1.72511e-11,-19759,41.9825], Tmin=(100,'K'), Tmax=(964.715,'K')), NASAPolynomial(coeffs=[26.8724,0.0336899,-1.12376e-05,1.97796e-09,-1.39825e-13,-27390.3,-106.031], Tmin=(964.715,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-166.155,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(552.912,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + radical(C=COJ) + radical(RCCJC)"""),
)

species(
    label = '[CH2][C](CCCC)OC=CO(4167)',
    structure = SMILES('[CH2][C](CCCC)OC=CO'),
    E0 = (-91.3378,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2995,3025,975,1000,1300,1375,400,500,1630,1680,3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3000,3100,440,815,1455,1000,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (142.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-3.53862,0.14352,-0.000152092,7.90029e-08,-1.56617e-11,-10695,45.4876], Tmin=(100,'K'), Tmax=(1326.22,'K')), NASAPolynomial(coeffs=[34.0197,0.0221326,-5.62872e-06,7.68771e-10,-4.51235e-14,-19944.1,-143.625], Tmin=(1326.22,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-91.3378,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(548.755,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + radical(CJC(C)OC) + radical(C2CsJOC(O))"""),
)

species(
    label = '[CH2]C([CH]CCC)OC=CO(4168)',
    structure = SMILES('[CH2]C([CH]CCC)OC=CO'),
    E0 = (-91.6514,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (142.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.54986,0.121709,-7.47325e-05,-1.49697e-08,2.18785e-11,-10766.7,42.9336], Tmin=(100,'K'), Tmax=(930.192,'K')), NASAPolynomial(coeffs=[34.1309,0.0210542,-4.46536e-06,6.38704e-10,-4.63271e-14,-20060.2,-144.649], Tmin=(930.192,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-91.6514,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(548.755,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + radical(CCJCO) + radical(CJC(C)OC)"""),
)

species(
    label = '[CH2]CCCC(C)OC=C[O](4169)',
    structure = SMILES('[CH2]CCCC(C)OC=C[O]'),
    E0 = (-155.355,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (142.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.94386,0.107929,-4.69754e-05,-3.15812e-08,2.41148e-11,-18450.2,41.7058], Tmin=(100,'K'), Tmax=(956.91,'K')), NASAPolynomial(coeffs=[29.9286,0.029238,-9.1174e-06,1.60601e-09,-1.16752e-13,-27047,-123.704], Tmin=(956.91,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-155.355,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(552.912,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + radical(RCCJ) + radical(C=COJ)"""),
)

species(
    label = '[CH2]C(C[CH]CC)OC=CO(4170)',
    structure = SMILES('[CH2]C(C[CH]CC)OC=CO'),
    E0 = (-97.0952,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (142.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-3.25838,0.136317,-0.000137845,6.93271e-08,-1.33556e-11,-11396.7,45.5512], Tmin=(100,'K'), Tmax=(1376.25,'K')), NASAPolynomial(coeffs=[31.9515,0.0248869,-6.48394e-06,8.93639e-10,-5.22788e-14,-20227,-132.432], Tmin=(1376.25,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-97.0952,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(548.755,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + radical(CJC(C)OC) + radical(RCCJCC)"""),
)

species(
    label = '[CH2]C(CC[CH]C)OC=CO(4171)',
    structure = SMILES('[CH2]C(CC[CH]C)OC=CO'),
    E0 = (-97.1072,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1277.5,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,1380,1390,370,380,2900,435,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3100,440,815,1455,1000,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (142.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-3.45784,0.137735,-0.000139232,6.94879e-08,-1.3198e-11,-11388.4,46.4404], Tmin=(100,'K'), Tmax=(1423.16,'K')), NASAPolynomial(coeffs=[32.9813,0.0229798,-5.27693e-06,6.4656e-10,-3.48946e-14,-20510.7,-137.827], Tmin=(1423.16,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-97.1072,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(548.755,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + radical(CJC(C)OC) + radical(RCCJC)"""),
)
...
species(
    label = '[CH2]C(CCCC)OC1[CH]O1(4172)',
    structure = SMILES('[CH2]C(CCCC)OC1[CH]O1'),
    E0 = (4.5203,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (142.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.93973,0.124818,-0.000126491,7.04567e-08,-1.57503e-11,762.526,41.0906], Tmin=(100,'K'), Tmax=(1088.31,'K')), NASAPolynomial(coeffs=[19.9133,0.0444967,-1.57839e-05,2.63911e-09,-1.71274e-13,-3993.93,-66.1863], Tmin=(1088.31,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(4.5203,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(552.912,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CJC(C)OC) + radical(CCsJO)"""),
)
...
species(
    label = 'C=C(CCCC)OC=CO(4174)',
    structure = SMILES('C=C(CCCC)OC=CO'),
    E0 = (-350.976,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (142.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.7815,0.107889,-5.8656e-05,-1.31338e-08,1.62729e-11,-41987.2,41.0545], Tmin=(100,'K'), Tmax=(963.578,'K')), NASAPolynomial(coeffs=[27.2266,0.0322518,-1.06234e-05,1.86501e-09,-1.32046e-13,-49656.4,-108.604], Tmin=(963.578,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-350.976,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(552.912,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + group(Cds-CdsHH)"""),
)

species(
    label = 'CCCCC(C)OC=C=O(4175)',
    structure = SMILES('CCCCC(C)OC=C=O'),
    E0 = (-320.588,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (142.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.80109,0.112147,-8.0808e-05,1.89288e-08,2.37385e-12,-38335.5,38.8022], Tmin=(100,'K'), Tmax=(1025.94,'K')), NASAPolynomial(coeffs=[24.3201,0.0385241,-1.44247e-05,2.60299e-09,-1.81081e-13,-45180.4,-95.1245], Tmin=(1025.94,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-320.588,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(552.912,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-(Cdd-O2d)OsH)"""),
)
...
species(
    label = '[CH]=COC([CH2])CCCC(3083)',
    structure = SMILES('[CH]=COC([CH2])CCCC'),
    E0 = (164.335,'kJ/mol'),
    modes = [
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.86792,0.115701,-9.89946e-05,3.7415e-08,-3.62443e-12,19987.9,38.5331], Tmin=(100,'K'), Tmax=(1026.69,'K')), NASAPolynomial(coeffs=[24.6478,0.0344644,-1.2551e-05,2.22045e-09,-1.52508e-13,13380,-95.7528], Tmin=(1026.69,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(164.335,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(527.969,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(Cds_P) + radical(CJC(C)OC)"""),
)

species(
    label = '[CH2]C(CCCC)OC[C]=O(4178)',
    structure = SMILES('[CH2]C(CCCC)OC[C]=O'),
    E0 = (-80.4528,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (142.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.02516,0.117297,-0.00011682,6.70445e-08,-1.63634e-11,-9500.95,40.3193], Tmin=(100,'K'), Tmax=(966.088,'K')), NASAPolynomial(coeffs=[12.9069,0.0596113,-2.72537e-05,5.2367e-09,-3.68841e-13,-12192.8,-26.4141], Tmin=(966.088,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-80.4528,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(548.755,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)OsHH) + group(Cds-OdCsH) + radical(CsCJ=O) + radical(CJC(C)OC)"""),
)

species(
    label = '[CH2][C](CCCC)OCC=O(4179)',
    structure = SMILES('[CH2][C](CCCC)OCC=O'),
    E0 = (-54.4199,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (142.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.59327,0.132892,-0.000178025,1.45965e-07,-4.96951e-11,-6353.21,41.6059], Tmin=(100,'K'), Tmax=(783.291,'K')), NASAPolynomial(coeffs=[10.1483,0.064228,-2.98671e-05,5.6808e-09,-3.9357e-13,-7925.63,-10.4684], Tmin=(783.291,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-54.4199,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(548.755,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)OsHH) + group(Cds-OdCsH) + radical(CJC(C)OC) + radical(C2CsJOCs)"""),
)

species(
    label = '[CH2]C([CH]CCC)OCC=O(4180)',
    structure = SMILES('[CH2]C([CH]CCC)OCC=O'),
    E0 = (-35.2216,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (142.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.942349,0.112618,-0.000102555,5.19936e-08,-1.1125e-11,-4061.48,41.8271], Tmin=(100,'K'), Tmax=(1094.01,'K')), NASAPolynomial(coeffs=[14.5146,0.0561032,-2.50689e-05,4.77535e-09,-3.34922e-13,-7443.52,-34.1326], Tmin=(1094.01,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-35.2216,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(548.755,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)OsHH) + group(Cds-OdCsH) + radical(CJC(C)OC) + radical(CCJCO)"""),
)

species(
    label = '[CH2]C(C[CH]CC)OCC=O(4181)',
    structure = SMILES('[CH2]C(C[CH]CC)OCC=O'),
    E0 = (-40.6654,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2782.5,750,1395,475,1775,1000,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (142.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.503788,0.111817,-0.000100008,2.57585e-08,1.85803e-11,-4740.9,40.433], Tmin=(100,'K'), Tmax=(560.673,'K')), NASAPolynomial(coeffs=[8.62489,0.0663196,-3.08034e-05,5.91446e-09,-4.14632e-13,-6073.07,-1.07701], Tmin=(560.673,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-40.6654,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(548.755,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)OsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(CJC(C)OC) + radical(RCCJCC)"""),
)

species(
    label = '[CH2]C(CC[CH]C)OCC=O(4182)',
    structure = SMILES('[CH2]C(CC[CH]C)OCC=O'),
    E0 = (-40.6774,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2782.5,750,1395,475,1775,1000,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (142.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.03654,0.119023,-0.000133407,9.31317e-08,-2.80065e-11,-4718.45,42.4168], Tmin=(100,'K'), Tmax=(792.25,'K')), NASAPolynomial(coeffs=[9.84429,0.06409,-2.94047e-05,5.62044e-09,-3.93219e-13,-6442.61,-7.54364], Tmin=(792.25,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-40.6774,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(548.755,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)OsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(RCCJC) + radical(CJC(C)OC)"""),
)

species(
    label = '[CH2]CCCC([CH2])OCC=O(4183)',
    structure = SMILES('[CH2]CCCC([CH2])OCC=O'),
    E0 = (-29.8773,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (142.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.04607,0.117754,-0.000118045,6.81994e-08,-1.67367e-11,-3417.38,41.5023], Tmin=(100,'K'), Tmax=(961.866,'K')), NASAPolynomial(coeffs=[12.9653,0.0594868,-2.71783e-05,5.21995e-09,-3.67552e-13,-6112.78,-25.5495], Tmin=(961.866,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-29.8773,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(548.755,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)OsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(CJC(C)OC) + radical(RCCJ)"""),
)
...
species(
    label = 'C=C(CCCC)OCC=O(4185)',
    structure = SMILES('C=C(CCCC)OCC=O'),
    E0 = (-364.093,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (142.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.49033,0.104882,-6.78531e-05,1.20318e-08,2.99011e-12,-43579.1,40.0098], Tmin=(100,'K'), Tmax=(1077.14,'K')), NASAPolynomial(coeffs=[22.6609,0.0416216,-1.6559e-05,3.06141e-09,-2.14328e-13,-50315,-85.4166], Tmin=(1077.14,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-364.093,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(552.912,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)OsHH) + group(Cds-CdsCsOs) + group(Cds-OdCsH) + group(Cds-CdsHH)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]C(CCCC)O[CH]C=O(1330)'],
    products = ['CCCCC1CC([CH][O])O1(4156)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'C=C(CCCC)OC=C[O](4157)'],
    products = ['[CH2]C(CCCC)O[CH]C=O(1330)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', '[CH2]C(CCCC)OC=C=O(4158)'],
    products = ['[CH2]C(CCCC)O[CH]C=O(1330)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['butyl_1(82)', 'C=COC=C[O](2535)'],
    products = ['[CH2]C(CCCC)O[CH]C=O(1330)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]C(CCCC)OC=[C]O(4160)'],
    products = ['[CH2]C(CCCC)O[CH]C=O(1330)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]C(CCCC)O[CH]C=O(1330)'],
    products = ['CCC[CH]C(C)OC=C[O](4161)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]C(CCCC)O[C]=CO(4162)'],
    products = ['[CH2]C(CCCC)O[CH]C=O(1330)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CCCCC(C)O[C]=C[O](4163)'],
    products = ['[CH2]C(CCCC)O[CH]C=O(1330)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]C(CCCC)O[CH]C=O(1330)'],
    products = ['CC[CH]CC(C)OC=C[O](4164)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]C(CCCC)O[CH]C=O(1330)'],
    products = ['C[CH]CCC(C)OC=C[O](4166)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2][C](CCCC)OC=CO(4167)'],
    products = ['[CH2]C(CCCC)O[CH]C=O(1330)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]C([CH]CCC)OC=CO(4168)'],
    products = ['[CH2]C(CCCC)O[CH]C=O(1330)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]C(CCCC)O[CH]C=O(1330)'],
    products = ['[CH2]CCCC(C)OC=C[O](4169)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2]C(C[CH]CC)OC=CO(4170)'],
    products = ['[CH2]C(CCCC)O[CH]C=O(1330)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2]C(CC[CH]C)OC=CO(4171)'],
    products = ['[CH2]C(CCCC)O[CH]C=O(1330)'],
...
reaction(
    label = 'reaction21',
    reactants = ['CHCHO(47)', '[CH2]C([O])CCCC(1842)'],
    products = ['[CH2]C(CCCC)O[CH]C=O(1330)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH2]C(CCCC)O[CH]C=O(1330)'],
    products = ['[CH2]C(CCCC)OC1[CH]O1(4172)'],
...
reaction(
    label = 'reaction26',
    reactants = ['CH2(S)(23)', '[CH2]C(CCC)O[CH]C=O(1336)'],
    products = ['[CH2]C(CCCC)O[CH]C=O(1330)'],
...
reaction(
    label = 'reaction30',
    reactants = ['CH2(19)', 'CCCC[CH]OC=C[O](3924)'],
    products = ['[CH2]C(CCCC)O[CH]C=O(1330)'],
...
reaction(
    label = 'reaction31',
    reactants = ['O(4)', '[CH]=COC([CH2])CCCC(3083)'],
    products = ['[CH2]C(CCCC)O[CH]C=O(1330)'],
...
reaction(
    label = 'reaction33',
    reactants = ['[CH2]C(CCCC)OC[C]=O(4178)'],
    products = ['[CH2]C(CCCC)O[CH]C=O(1330)'],
...
reaction(
    label = 'reaction34',
    reactants = ['[CH2][C](CCCC)OCC=O(4179)'],
    products = ['[CH2]C(CCCC)O[CH]C=O(1330)'],
...
reaction(
    label = 'reaction35',
    reactants = ['[CH2]C([CH]CCC)OCC=O(4180)'],
    products = ['[CH2]C(CCCC)O[CH]C=O(1330)'],
...
reaction(
    label = 'reaction36',
    reactants = ['[CH2]C(C[CH]CC)OCC=O(4181)'],
    products = ['[CH2]C(CCCC)O[CH]C=O(1330)'],
...
reaction(
    label = 'reaction37',
    reactants = ['[CH2]C(CC[CH]C)OCC=O(4182)'],
    products = ['[CH2]C(CCCC)O[CH]C=O(1330)'],
...
reaction(
    label = 'reaction38',
    reactants = ['[CH2]CCCC([CH2])OCC=O(4183)'],
    products = ['[CH2]C(CCCC)O[CH]C=O(1330)'],
