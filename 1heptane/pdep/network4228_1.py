...
species(
    label = 'CC=[C]COC=O(25326)',
    structure = SMILES('CC=[C]COC=O'),
    E0 = (-96.2429,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2782.5,750,1395,475,1775,1000,1685,370,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,286.44,286.475,2539.49],'cm^-1')),
        HinderedRotor(inertia=(0.117794,'amu*angstrom^2'), symmetry=1, barrier=(6.85794,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.638163,'amu*angstrom^2'), symmetry=1, barrier=(37.1602,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00205413,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.638004,'amu*angstrom^2'), symmetry=1, barrier=(37.1603,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.96123,0.0475515,-2.55512e-05,6.0576e-09,-5.53401e-13,-11505.2,24.2227], Tmin=(100,'K'), Tmax=(2490.04,'K')), NASAPolynomial(coeffs=[19.6443,0.0191455,-8.43947e-06,1.47624e-09,-9.34352e-14,-20311.6,-77.2204], Tmin=(2490.04,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-96.2429,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-(Cds-Cds)OsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-OdOsH) + radical(Cds_S)"""),
)

species(
    label = 'CC=C=CO[CH]O(25327)',
    structure = SMILES('CC=C=CO[CH]O'),
    E0 = (-46.4026,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,540,610,2055,2995,3025,975,1000,1300,1375,400,500,1630,1680,3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.887534,'amu*angstrom^2'), symmetry=1, barrier=(20.4062,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.887353,'amu*angstrom^2'), symmetry=1, barrier=(20.402,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.887823,'amu*angstrom^2'), symmetry=1, barrier=(20.4128,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.888664,'amu*angstrom^2'), symmetry=1, barrier=(20.4321,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.586583,0.083621,-8.96822e-05,4.58862e-08,-8.79557e-12,-5401.04,27.6862], Tmin=(100,'K'), Tmax=(1439.52,'K')), NASAPolynomial(coeffs=[22.9689,0.00827635,-8.65349e-07,-1.95993e-11,5.79072e-15,-11157.9,-90.9771], Tmin=(1439.52,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-46.4026,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-OsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cdd-CdsCds) + radical(OCJO)"""),
)

species(
    label = 'CC#CCO[CH]O(25328)',
    ...
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.913567,0.0702987,-7.6125e-05,3.98018e-08,-5.25455e-12,-551.59,26.0964], Tmin=(100,'K'), Tmax=(723.879,'K')), NASAPolynomial(coeffs=[11.1866,0.0257672,-9.20159e-06,1.51737e-09,-9.66239e-14,-2359.44,-22.3598], Tmin=(723.879,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-5.49372,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CtOsHH) + group(Cs-OsOsHH) + group(Cs-CtHHH) + group(Ct-CtCs) + group(Ct-CtCs) + radical(OCJO)"""),
)
...
species(
    label = 'C#CCO[CH]O(25329)',
    structure = SMILES('C#CCO[CH]O'),
    E0 = (36.6874,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,750,770,3400,2100,2175,525,3615,1277.5,1000,3025,407.5,1350,352.5,308.378,308.986,309.244],'cm^-1')),
        HinderedRotor(inertia=(0.00177518,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.130178,'amu*angstrom^2'), symmetry=1, barrier=(8.77901,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.26508,'amu*angstrom^2'), symmetry=1, barrier=(17.9571,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.01718,'amu*angstrom^2'), symmetry=1, barrier=(68.2942,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (85.0813,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.0913,0.0653355,-9.01468e-05,6.55184e-08,-1.85575e-11,4515.9,22.0146], Tmin=(100,'K'), Tmax=(933.541,'K')), NASAPolynomial(coeffs=[11.4319,0.0170585,-6.19733e-06,1.01259e-09,-6.31542e-14,2758.21,-26.2353], Tmin=(933.541,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(36.6874,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CtOsHH) + group(Cs-OsOsHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(OCJO)"""),
)

species(
    label = 'CC=[C]COC[O](25330)',
    structure = SMILES('CC=[C]COC[O]'),
    E0 = (110.991,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.54684,0.0575166,-3.96552e-05,1.42143e-08,-2.19424e-12,13433.9,25.7193], Tmin=(100,'K'), Tmax=(1406.02,'K')), NASAPolynomial(coeffs=[9.28396,0.0355052,-1.61726e-05,3.07994e-09,-2.14478e-13,11258.2,-14.2443], Tmin=(1406.02,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(110.991,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-OsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(OCOJ) + radical(Cds_S)"""),
)
...
species(
    label = 'CC=[C][CH]OCO(25331)',
    structure = SMILES('C[CH][C]=COCO'),
    E0 = (-19.6325,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.233679,0.0557217,2.845e-05,-1.03303e-07,5.14079e-11,-2200.32,26.3688], Tmin=(100,'K'), Tmax=(913.744,'K')), NASAPolynomial(coeffs=[29.7081,-0.0018884,5.78491e-06,-1.23035e-09,7.81109e-14,-10568.1,-129.483], Tmin=(913.744,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-19.6325,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-OsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(Cds_S) + radical(Allyl_S)"""),
)
...
species(
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.189584,0.0739204,-7.10981e-05,3.47936e-08,-6.65945e-12,14750.8,30.6014], Tmin=(100,'K'), Tmax=(1279.97,'K')), NASAPolynomial(coeffs=[17.8807,0.0186347,-6.30893e-06,1.04856e-09,-6.85096e-14,10222,-59.1149], Tmin=(1279.97,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(121.435,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-OsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Cds_S) + radical(Cds_S)"""),
)
...
species(
    label = 'CC=C=COCO(25333)',
    structure = SMILES('CC=C=COCO'),
    E0 = (-235.363,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.108201,0.0597128,1.70578e-05,-9.1633e-08,4.73125e-11,-28143.3,25.3995], Tmin=(100,'K'), Tmax=(912.989,'K')), NASAPolynomial(coeffs=[29.7457,-0.00172568,5.60478e-06,-1.19992e-09,7.67184e-14,-36406.2,-130.5], Tmin=(912.989,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-235.363,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-OsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cdd-CdsCds)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'CC=[C]COC=O(25326)'],
    products = ['CC=[C]CO[CH]O(21280)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'CC=C=CO[CH]O(25327)'],
    products = ['CC=[C]CO[CH]O(21280)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', 'CC#CCO[CH]O(25328)'],
    products = ['CC=[C]CO[CH]O(21280)'],
    transitionState = 'TS4',
...
reaction(
    ...
    products = ['CC=[C]CO[CH]O(21280)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(4000,'m^3/(mol*s)'), n=1.39, Ea=(100.708,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Od_CO-NdH;YJ] for rate rule [Od_CO-NdH;CJ]
Euclidian distance = 1.0
family: R_Addition_MultipleBond
Ea raised from 99.1 to 100.7 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction6',
    reactants = ['CH3(17)', 'C#CCO[CH]O(25329)'],
    products = ['CC=[C]CO[CH]O(21280)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction13',
    reactants = ['C[C]=[C]COCO(25332)'],
    products = ['CC=[C]CO[CH]O(21280)'],
    transitionState = 'TS13',
    kinetics = Arrhenius(A=(1.182e+10,'s^-1'), n=0.86, Ea=(149.369,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [RnH;Cd_rad_out_Cs;Cs_H_out_1H] for rate rule [R5HJ_1;Cd_rad_out_Cs;Cs_H_out_H/NonDeO]
Euclidian distance = 2.2360679775
Multiplied by reaction path degeneracy 2.0
family: intra_H_migration"""),
)
...
reaction(
    label = 'reaction14',
    reactants = ['CC=[C]CO[CH]O(21280)'],
    products = ['[CH2]C=[C]COCO(21281)'],
    transitionState = 'TS14',
    kinetics = Arrhenius(A=(138.3,'s^-1'), n=3.21, Ea=(60.7935,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R6Hall;C_rad_out_1H;Cs_H_out] for rate rule [R6HJ_3;C_rad_out_H/NonDeO;Cs_H_out_2H]
...
reaction(
    label = 'reaction20',
    reactants = ['HCOH(T)(285)', 'CC=[C]C[O](24539)'],
    products = ['CC=[C]CO[CH]O(21280)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH2]O[CH]O(1809)', '[C]=CC(24199)'],
    products = ['CC=[C]CO[CH]O(21280)'],
