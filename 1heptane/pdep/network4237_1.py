...
species(
    label = 'C=C(CC)C[C]=CC(24431)',
    structure = SMILES('C=C(CC)C[C]=CC'),
    E0 = (228.865,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,3010,987.5,1337.5,450,1655,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,2950,3100,1380,975,1025,1650,350,440,435,1725,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0929471,0.079614,-5.1752e-05,1.72187e-08,-2.36439e-12,27671.5,32.8042], Tmin=(100,'K'), Tmax=(1646.1,'K')), NASAPolynomial(coeffs=[16.0122,0.0409303,-1.65017e-05,2.94233e-09,-1.96182e-13,22430.6,-51.9314], Tmin=(1646.1,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(228.865,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(486.397,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_S)"""),
)

species(
    label = '[CH2]C(C=C=CC)CC(24432)',
    structure = SMILES('[CH2]C(C=C=CC)CC'),
    E0 = (237.581,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([540,610,2055,2995,3025,975,1000,1300,1375,400,500,1630,1680,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,250.213,250.214],'cm^-1')),
        HinderedRotor(inertia=(0.193415,'amu*angstrom^2'), symmetry=1, barrier=(8.5928,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.193413,'amu*angstrom^2'), symmetry=1, barrier=(8.5928,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00269266,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.193415,'amu*angstrom^2'), symmetry=1, barrier=(8.5928,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.539144,'amu*angstrom^2'), symmetry=1, barrier=(23.9521,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (109.189,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.110305,0.0822921,-5.69731e-05,2.11045e-08,-3.24715e-12,28728.9,33.5294], Tmin=(100,'K'), Tmax=(1497.23,'K')), NASAPolynomial(coeffs=[15.2943,0.0411369,-1.57415e-05,2.74543e-09,-1.81622e-13,24116.1,-47.0066], Tmin=(1497.23,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(237.581,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(486.397,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cdd-Cd)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cdd-CdsCds) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]C(CC)CC#CC(24433)',
    structure = SMILES('[CH2]C(CC)CC#CC'),
    E0 = (235.448,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2100,2250,500,550,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (109.189,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.163727,0.0771133,-4.23677e-05,3.52088e-09,4.32414e-12,28462.4,33.3454], Tmin=(100,'K'), Tmax=(952.716,'K')), NASAPolynomial(coeffs=[12.1156,0.0433618,-1.50937e-05,2.5355e-09,-1.66787e-13,25439.5,-27.6493], Tmin=(952.716,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(235.448,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(482.239,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CtCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CtHHH) + group(Ct-CtCs) + group(Ct-CtCs) + radical(Isobutyl)"""),
)
...
species(
    label = 'C#CCC([CH2])CC(24434)',
    structure = SMILES('C#CCC([CH2])CC'),
    E0 = (277.629,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,2175,525,750,770,3400,2100,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3100,440,815,1455,1000,1380,1390,370,380,2900,435,291.297,2330.85],'cm^-1')),
        HinderedRotor(inertia=(0.209528,'amu*angstrom^2'), symmetry=1, barrier=(12.617,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00198666,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.23239,'amu*angstrom^2'), symmetry=1, barrier=(74.2096,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.209529,'amu*angstrom^2'), symmetry=1, barrier=(12.617,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.23242,'amu*angstrom^2'), symmetry=1, barrier=(74.2096,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (95.1622,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.546721,0.0693487,-4.44701e-05,9.89911e-09,1.4987e-12,33521.2,28.5497], Tmin=(100,'K'), Tmax=(974.826,'K')), NASAPolynomial(coeffs=[12.228,0.0349153,-1.22561e-05,2.07283e-09,-1.36985e-13,30602.4,-30.7973], Tmin=(974.826,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(277.629,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CtCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(Isobutyl)"""),
)

species(
    label = 'CC=[C]C[C](C)CC(24435)',
    ...
    molecularWeight = (110.197,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.60409,0.0657928,3.73593e-05,-2.17097e-07,2.0229e-10,35394.2,28.8924], Tmin=(100,'K'), Tmax=(418.934,'K')), NASAPolynomial(coeffs=[3.96336,0.0637999,-2.90256e-05,5.54028e-09,-3.87659e-13,35016.3,17.4123], Tmin=(418.934,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(293.682,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Cds_S) + radical(Tertalkyl)"""),
)
...
species(
    ...
    molecularWeight = (110.197,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.569132,0.0773601,-4.49844e-05,1.28839e-08,-1.53156e-12,36539,33.6615], Tmin=(100,'K'), Tmax=(1794.49,'K')), NASAPolynomial(coeffs=[13.9264,0.0475862,-2.00966e-05,3.63792e-09,-2.43454e-13,31745.1,-38.5898], Tmin=(1794.49,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(302.801,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Cs_S) + radical(Cds_S)"""),
)

species(
    label = 'CC=[C][CH]C(C)CC(24437)',
    ...
    molecularWeight = (110.197,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0419021,0.077033,-3.43878e-05,-1.50508e-09,3.83619e-12,30010.4,32.9256], Tmin=(100,'K'), Tmax=(1161.05,'K')), NASAPolynomial(coeffs=[14.4998,0.0458258,-1.84764e-05,3.37254e-09,-2.31575e-13,25360.4,-44.8845], Tmin=(1161.05,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(248.229,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Cds_S) + radical(Allyl_S)"""),
)
...
species(
    ...
    molecularWeight = (110.197,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.186353,0.0818499,-5.23882e-05,1.73429e-08,-2.41295e-12,37844.2,34.28], Tmin=(100,'K'), Tmax=(1587.51,'K')), NASAPolynomial(coeffs=[13.9998,0.0470447,-1.95019e-05,3.53254e-09,-2.38126e-13,33458.3,-38.7463], Tmin=(1587.51,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(313.506,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(RCCJ) + radical(Cds_S)"""),
)
...
species(
    ...
    molecularWeight = (110.197,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.409934,0.0823216,-5.52826e-05,2.02495e-08,-3.25613e-12,41752.2,32.1621], Tmin=(100,'K'), Tmax=(1348.57,'K')), NASAPolynomial(coeffs=[10.2074,0.0532615,-2.29597e-05,4.2708e-09,-2.94005e-13,39109.7,-18.0349], Tmin=(1348.57,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(346.101,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Cds_S) + radical(Cds_S)"""),
)
...
species(
    ...
    molecularWeight = (110.197,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.270184,0.0820558,-4.85649e-05,1.26504e-08,-8.6313e-13,4072.2,32.3374], Tmin=(100,'K'), Tmax=(1338.97,'K')), NASAPolynomial(coeffs=[16.4289,0.0430606,-1.70812e-05,3.04969e-09,-2.04807e-13,-1376.06,-56.7465], Tmin=(1338.97,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(32.4989,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(511.34,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cdd-Cd)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cdd-CdsCds)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'C=C(CC)C[C]=CC(24431)'],
    products = ['[CH2]C(CC)C[C]=CC(19200)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', '[CH2]C(C=C=CC)CC(24432)'],
    products = ['[CH2]C(CC)C[C]=CC(19200)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', '[CH2]C(CC)CC#CC(24433)'],
    products = ['[CH2]C(CC)C[C]=CC(19200)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['C2H5(29)', 'C=CC[C]=CC(24188)'],
    products = ['[CH2]C(CC)C[C]=CC(19200)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['CH3(17)', 'C#CCC([CH2])CC(24434)'],
    products = ['[CH2]C(CC)C[C]=CC(19200)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]C(CC)CC=[C]C(19197)'],
    products = ['[CH2]C(CC)C[C]=CC(19200)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]C(CC)C[C]=CC(19200)'],
    products = ['C[CH]C(C)C[C]=CC(24436)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]C(CC)C[C]=CC(19200)'],
    products = ['[CH2]C([CH]C)CC=CC(18383)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]CC(C)C[C]=CC(24438)'],
    products = ['[CH2]C(CC)C[C]=CC(19200)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2]C(CC)C[C]=CC(19200)'],
    products = ['[CH2]CC([CH2])CC=CC(19206)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2]C(CC)C[C]=CC(19200)'],
    products = ['[CH2]C=[C]CC(C)CC(19202)'],
...
reaction(
    label = 'reaction24',
    reactants = ['CH2(S)(23)', '[CH2]C(C)C[C]=CC(19144)'],
    products = ['[CH2]C(CC)C[C]=CC(19200)'],
...
reaction(
    label = 'reaction31',
    reactants = ['[CH2]C([CH2])CC(429)', '[C]=CC(24199)'],
    products = ['[CH2]C(CC)C[C]=CC(19200)'],
