...
species(
    label = '[CH]=CCC=CCC(3397)',
    structure = SMILES('[CH]=CCC=CCC'),
    E0 = (277.175,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3120,650,792.5,1650,2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3010,3025,975,987.5,1000,1300,1337.5,1375,400,450,500,1630,1655,1680,364.839,364.852],'cm^-1')),
        HinderedRotor(inertia=(0.118764,'amu*angstrom^2'), symmetry=1, barrier=(11.2194,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.118759,'amu*angstrom^2'), symmetry=1, barrier=(11.2192,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.11877,'amu*angstrom^2'), symmetry=1, barrier=(11.2192,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.118763,'amu*angstrom^2'), symmetry=1, barrier=(11.2191,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (95.1622,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.773773,0.0600714,-1.90626e-05,-1.28471e-08,7.754e-12,33461.8,29.5289], Tmin=(100,'K'), Tmax=(1071.26,'K')), NASAPolynomial(coeffs=[13.1449,0.0351817,-1.40403e-05,2.59046e-09,-1.80704e-13,29588.9,-36.7114], Tmin=(1071.26,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(277.175,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(415.724,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_P)"""),
)

species(
    label = '[CH]=CC=CCCC(3398)',
    structure = SMILES('[CH]=CC=CCCC'),
    E0 = (258.566,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3120,650,792.5,1650,2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3010,3025,975,987.5,1000,1300,1337.5,1375,400,450,500,1630,1655,1680,211.654,212.879],'cm^-1')),
        HinderedRotor(inertia=(0.441772,'amu*angstrom^2'), symmetry=1, barrier=(14.2267,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.426596,'amu*angstrom^2'), symmetry=1, barrier=(14.228,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.425961,'amu*angstrom^2'), symmetry=1, barrier=(14.206,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.427509,'amu*angstrom^2'), symmetry=1, barrier=(14.2334,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (95.1622,'amu'),
...
species(
    label = '[CH]=[C]CCCCC(3402)',
    structure = SMILES('[CH]=[C]CCCCC'),
    E0 = (397.075,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,3120,650,792.5,1650,2750,2800,2850,1350,1500,750,1050,1375,1000,1685,370,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (96.1702,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.704784,0.0716595,-4.85695e-05,1.74343e-08,-2.65489e-12,47875.9,29.5099], Tmin=(100,'K'), Tmax=(1462.77,'K')), NASAPolynomial(coeffs=[11.8747,0.0411149,-1.72475e-05,3.15913e-09,-2.15133e-13,44608.1,-28.6267], Tmin=(1462.77,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(397.075,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_S) + radical(Cds_P)"""),
)
...
species(
    label = '[CH]=CCCCC[CH2](3404)',
    structure = SMILES('[CH]=CCCCC[CH2]'),
    E0 = (364.48,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,3120,650,792.5,1650,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (96.1702,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.408635,0.0718506,-4.72906e-05,1.59224e-08,-2.20163e-12,43971.7,31.9038], Tmin=(100,'K'), Tmax=(1648.77,'K')), NASAPolynomial(coeffs=[15.4533,0.0353514,-1.40848e-05,2.49603e-09,-1.6581e-13,39010.6,-48.201], Tmin=(1648.77,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(364.48,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_P) + radical(RCCJ)"""),
)

species(
    label = 'C=CC[CH][CH]CC(3405)',
    ...
    molecularWeight = (96.1702,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.2016,0.0546979,-2.29525e-05,3.5909e-09,-1.33118e-13,36258.1,28.3379], Tmin=(100,'K'), Tmax=(2446.24,'K')), NASAPolynomial(coeffs=[28.3428,0.0219286,-8.97593e-06,1.44897e-09,-8.45879e-14,20483.7,-127.264], Tmin=(2446.24,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(301.054,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(RCCJCC) + radical(RCCJCC)"""),
)
...
species(
    label = '[CH]=CC[CH]CC(1170)',
    structure = SMILES('[CH]=CC[CH]CC'),
    E0 = (377.472,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3010,987.5,1337.5,450,1655,3120,650,792.5,1650,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,281.687,1709.15],'cm^-1')),
        HinderedRotor(inertia=(0.00212411,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.111314,'amu*angstrom^2'), symmetry=1, barrier=(6.26803,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.111258,'amu*angstrom^2'), symmetry=1, barrier=(6.26994,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.112648,'amu*angstrom^2'), symmetry=1, barrier=(6.26593,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.85595,0.0503697,-2.60585e-05,6.36495e-09,-6.27103e-13,45472.4,25.2047], Tmin=(100,'K'), Tmax=(2139.23,'K')), NASAPolynomial(coeffs=[11.9444,0.0315061,-1.28318e-05,2.24303e-09,-1.45403e-13,41156,-31.1382], Tmin=(2139.23,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(377.472,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(RCCJCC) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH]=CC[CH]CCC(1174)'],
    products = ['C=CCCC(134)', 'C2H2(32)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', '[CH]=CCC=CCC(3397)'],
    products = ['[CH]=CC[CH]CCC(1174)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', 'C#CC[CH]CCC(3399)'],
    products = ['[CH]=CC[CH]CCC(1174)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['C2H5(29)', '[CH]=CCC=C(2955)'],
    products = ['[CH]=CC[CH]CCC(1174)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['C=CCCC(134)', 'C2H2(T)(175)'],
    products = ['[CH]=CC[CH]CCC(1174)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2][CH]CCC(137)', 'C2H2(32)'],
    products = ['[CH]=CC[CH]CCC(1174)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2][CH]CCC(137)', 'C2H2(T)(175)'],
    products = ['[CH]=CC[CH]CCC(1174)'],
...
reaction(
    label = 'reaction21',
    reactants = ['CH2(S)(23)', '[CH]=CC[CH]CC(1170)'],
    products = ['[CH]=CC[CH]CCC(1174)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[CH]CCC(133)', '[CH]=C[CH2](2461)'],
    products = ['[CH]=CC[CH]CCC(1174)'],
