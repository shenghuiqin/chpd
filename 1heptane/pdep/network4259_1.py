...
species(
    ...
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[10.7705,-0.00579472,0.00013563,-1.31039e-07,3.00602e-11,48643.6,-11.5109], Tmin=(100,'K'), Tmax=(1723.4,'K')), NASAPolynomial(coeffs=[76.8655,0.0400058,-7.76179e-05,1.8523e-08,-1.36511e-12,-3721.16,-452.185], Tmin=(1723.4,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(407.515,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(469.768,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + ring(methylenecyclobutane) + radical(RCCJ) + radical(Cs_S)"""),
)

species(
    label = '[CH2]C1([CH]C)CC=CC1(24703)',
    structure = SMILES('[CH2]C1([CH]C)CC=CC1'),
    E0 = (329.095,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.90067,0.0483222,4.12642e-05,-8.12861e-08,3.21882e-11,39710,29.8223], Tmin=(100,'K'), Tmax=(1010.86,'K')), NASAPolynomial(coeffs=[15.3298,0.0389764,-1.57237e-05,3.027e-09,-2.20399e-13,34353.1,-52.0134], Tmin=(1010.86,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(329.095,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(469.768,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsCs) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cyclopentene) + radical(Neopentyl) + radical(Cs_S)"""),
)
...
species(
    label = '[CH2]C(=CC)CC=C=C(24704)',
    structure = SMILES('[CH2]C(=CC)CC=C=C'),
    E0 = (305.747,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([540,610,2055,2995,3025,975,1000,1300,1375,400,500,1630,1680,2750,2800,2850,1350,1500,750,1050,1375,1000,2950,3100,1380,975,1025,1650,350,440,435,1725,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.872594,'amu*angstrom^2'), symmetry=1, barrier=(20.0626,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0573208,'amu*angstrom^2'), symmetry=1, barrier=(6.69539,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.872402,'amu*angstrom^2'), symmetry=1, barrier=(20.0582,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.872573,'amu*angstrom^2'), symmetry=1, barrier=(20.0622,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (107.173,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.143796,0.0793349,-5.69354e-05,2.08495e-08,-3.08376e-12,36931.8,31.423], Tmin=(100,'K'), Tmax=(1586.86,'K')), NASAPolynomial(coeffs=[18.4847,0.0323772,-1.25471e-05,2.2009e-09,-1.45734e-13,31019.8,-67.05], Tmin=(1586.86,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(305.747,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(440.667,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(Allyl_P)"""),
)
...
species(
    ...
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.602264,0.0612243,-3.09348e-06,-3.22126e-08,1.46159e-11,43136.9,31.2254], Tmin=(100,'K'), Tmax=(1045.23,'K')), NASAPolynomial(coeffs=[13.4373,0.0413201,-1.64542e-05,3.04965e-09,-2.14067e-13,38858,-38.8978], Tmin=(1045.23,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(357.547,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(465.61,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cyclopropane) + radical(Tertalkyl) + radical(Allyl_P)"""),
)

species(
    label = '[CH2]C(=CC)CC1[CH]C1(24713)',
    ...
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.527476,0.0614731,9.95104e-07,-3.93074e-08,1.76993e-11,47261.1,31.4976], Tmin=(100,'K'), Tmax=(1027.93,'K')), NASAPolynomial(coeffs=[14.627,0.0397728,-1.57357e-05,2.93166e-09,-2.07416e-13,42610.2,-45.436], Tmin=(1027.93,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(391.804,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(465.61,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + ring(Cyclopropane) + radical(cyclopropane) + radical(Allyl_P)"""),
)
...
species(
    label = '[CH2][C]1CC=CCC1C(24714)',
    structure = SMILES('[CH2][C]1CC=CCC1C'),
    E0 = (303.593,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.11789,0.0485352,2.88515e-05,-6.16043e-08,2.4317e-11,36630.5,27.7081], Tmin=(100,'K'), Tmax=(1010.38,'K')), NASAPolynomial(coeffs=[11.0561,0.0443362,-1.70909e-05,3.13603e-09,-2.20052e-13,32828.3,-29.218], Tmin=(1010.38,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(303.593,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(473.925,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cyclohexene) + radical(Isobutyl) + radical(Tertalkyl)"""),
)

species(
    label = 'C=C=CCC(C)=CC(24715)',
    ...
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.23043,0.0776752,-5.19848e-05,1.78821e-08,-2.54405e-12,18691.3,29.7805], Tmin=(100,'K'), Tmax=(1592.49,'K')), NASAPolynomial(coeffs=[15.3251,0.0397606,-1.62723e-05,2.93164e-09,-1.97035e-13,13883.6,-50.0659], Tmin=(1592.49,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(154.248,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(465.61,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cdd-CdsCds)"""),
)
...
species(
    label = '[CH2]C=CCC([CH2])=C(24716)',
    structure = SMILES('[CH2]C=CCC([CH2])=C'),
    E0 = (316.668,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2950,3100,1380,975,1025,1650,2995,3025,975,1000,1300,1375,400,500,1630,1680,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,350,440,435,1725,180,1202.28],'cm^-1')),
        HinderedRotor(inertia=(0.0195255,'amu*angstrom^2'), symmetry=1, barrier=(19.8941,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.23413,'amu*angstrom^2'), symmetry=1, barrier=(28.3751,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.864221,'amu*angstrom^2'), symmetry=1, barrier=(19.8701,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.211664,'amu*angstrom^2'), symmetry=1, barrier=(19.9295,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.721792,0.058912,-1.09028e-05,-2.72667e-08,1.4378e-11,38215.9,27.0217], Tmin=(100,'K'), Tmax=(1005.16,'K')), NASAPolynomial(coeffs=[15.3787,0.0299207,-1.14164e-05,2.1089e-09,-1.49647e-13,33787.4,-51.1368], Tmin=(1005.16,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(316.668,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(390.78,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Allyl_P) + radical(Allyl_P)"""),
)
...
species(
    label = 'CC=C1CC=CCC1(24181)',
    structure = SMILES('CC=C1CC=CCC1'),
    E0 = (29.9105,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.44163,0.0318377,9.15408e-05,-1.29254e-07,4.75318e-11,3710.93,23.2446], Tmin=(100,'K'), Tmax=(1010.13,'K')), NASAPolynomial(coeffs=[13.7673,0.0444994,-1.85412e-05,3.64078e-09,-2.68252e-13,-1915.28,-51.8672], Tmin=(1010.13,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(29.9105,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(478.082,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cyclohexane)"""),
)
...
species(
    label = '[CH]=CCC([CH2])=CC(24717)',
    structure = SMILES('[CH]=CCC([CH2])=CC'),
    E0 = (412.264,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,2995,3025,975,1000,1300,1375,400,500,1630,1680,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,1089.54],'cm^-1')),
        HinderedRotor(inertia=(0.771309,'amu*angstrom^2'), symmetry=1, barrier=(17.7339,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.772303,'amu*angstrom^2'), symmetry=1, barrier=(17.7568,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.348201,'amu*angstrom^2'), symmetry=1, barrier=(8.00582,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.772237,'amu*angstrom^2'), symmetry=1, barrier=(17.7552,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.570932,0.0657694,-3.86908e-05,6.25086e-09,1.53423e-12,49715.5,28.3834], Tmin=(100,'K'), Tmax=(1122.21,'K')), NASAPolynomial(coeffs=[14.2154,0.0316856,-1.25815e-05,2.29399e-09,-1.58143e-13,45736.9,-43.0986], Tmin=(1122.21,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(412.264,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(390.78,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_P) + radical(Allyl_P)"""),
)
...
species(
    label = '[CH2]C(C=CC=C)=CC(24718)',
    structure = SMILES('[CH2]C(C=CC=C)=CC'),
    E0 = (223.576,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,440,435,1725,2950,3100,1380,975,1025,1650,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,2995,3005,3015,3025,975,983.333,991.667,1000,1300,1325,1350,1375,400,433.333,466.667,500,1630,1646.67,1663.33,1680,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.947861,'amu*angstrom^2'), symmetry=1, barrier=(21.7932,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.948692,'amu*angstrom^2'), symmetry=1, barrier=(21.8123,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.94888,'amu*angstrom^2'), symmetry=1, barrier=(21.8166,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.947533,'amu*angstrom^2'), symmetry=1, barrier=(21.7856,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (107.173,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.126923,0.0747738,-2.40238e-05,-2.83494e-08,1.79901e-11,27053,28.1299], Tmin=(100,'K'), Tmax=(967.632,'K')), NASAPolynomial(coeffs=[20.2861,0.0278943,-9.49035e-06,1.69268e-09,-1.20399e-13,21346.7,-78.7521], Tmin=(967.632,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(223.576,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(440.667,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + radical(Allyl_P)"""),
)
...
species(
    ...
    E0 = (281.231,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2995,3025,975,1000,1300,1375,400,500,1630,1680,2750,2800,2850,1350,1500,750,1050,1375,1000,2950,3100,1380,975,1025,1650,350,440,435,1725,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    ...
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0762143,0.0804413,-5.65432e-05,2.06491e-08,-3.11536e-12,45603.8,32.4461], Tmin=(100,'K'), Tmax=(1519.48,'K')), NASAPolynomial(coeffs=[15.6386,0.0394737,-1.61007e-05,2.90516e-09,-1.95943e-13,40874.5,-49.1442], Tmin=(1519.48,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(377.96,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_S) + radical(Allyl_P)"""),
)

species(
    label = '[CH]=CCCC([CH2])=CC(24720)',
    structure = SMILES('[CH]=CCCC([CH2])=CC'),
    E0 = (387.215,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,2995,3025,975,1000,1300,1375,400,500,1630,1680,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3100,440,815,1455,1000,212.948,1143.78],'cm^-1')),
        HinderedRotor(inertia=(0.176745,'amu*angstrom^2'), symmetry=1, barrier=(5.70654,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.582506,'amu*angstrom^2'), symmetry=1, barrier=(18.8205,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.17687,'amu*angstrom^2'), symmetry=1, barrier=(5.70605,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.58205,'amu*angstrom^2'), symmetry=1, barrier=(18.822,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.584072,'amu*angstrom^2'), symmetry=1, barrier=(18.8244,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.265775,0.0827073,-5.92447e-05,2.17813e-08,-3.24865e-12,46733.9,33.618], Tmin=(100,'K'), Tmax=(1567.93,'K')), NASAPolynomial(coeffs=[18.3995,0.0350894,-1.36894e-05,2.41151e-09,-1.60198e-13,40880.8,-64.8257], Tmin=(1567.93,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(387.215,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_P) + radical(Allyl_P)"""),
)

species(
    label = '[CH2]C(=[C]C)CCC=C(24721)',
    ...
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0762143,0.0804413,-5.65432e-05,2.06491e-08,-3.11536e-12,45603.8,32.4461], Tmin=(100,'K'), Tmax=(1519.48,'K')), NASAPolynomial(coeffs=[15.6386,0.0394737,-1.61007e-05,2.90516e-09,-1.95943e-13,40874.5,-49.1442], Tmin=(1519.48,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(377.96,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Allyl_P) + radical(Cds_S)"""),
)
...
species(
    ...
    E0 = (291.618,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2950,3100,1380,975,1025,1650,2995,3025,975,1000,1300,1375,400,500,1630,1680,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,350,440,435,1725,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2][C]1CC(C=C)C1C(24723)',
    structure = SMILES('[CH2][C]1CC(C=C)C1C'),
    E0 = (410.984,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (108.181,'amu'),
...
species(
    label = 'CC=C1C[CH][CH]CC1(24724)',
    structure = SMILES('CC=C1C[CH][CH]CC1'),
    E0 = (281.183,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.39029,0.0444844,3.03778e-05,-5.24594e-08,1.77356e-11,33923,28.3531], Tmin=(100,'K'), Tmax=(1146.05,'K')), NASAPolynomial(coeffs=[9.15534,0.0513284,-2.301e-05,4.442e-09,-3.14817e-13,29913.9,-19.8932], Tmin=(1146.05,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(281.183,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(478.082,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + ring(Cyclohexanone) + radical(cyclohexane) + radical(cyclohexane)"""),
)

species(
    label = 'C=CC=CC(C)=CC(24725)',
    ...
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.155054,0.0776018,-3.37454e-05,-1.34614e-08,1.13199e-11,8830.62,27.9505], Tmin=(100,'K'), Tmax=(996.076,'K')), NASAPolynomial(coeffs=[18.2445,0.0335255,-1.22646e-05,2.20886e-09,-1.54521e-13,3686.23,-68.168], Tmin=(996.076,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(72.077,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(465.61,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH)"""),
)
...
species(
    ...
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0382771,0.0748079,-3.48382e-05,-4.43918e-09,5.99089e-12,41980.1,34.5899], Tmin=(100,'K'), Tmax=(1076.26,'K')), NASAPolynomial(coeffs=[15.9136,0.0382683,-1.52183e-05,2.79935e-09,-1.94904e-13,37261.9,-49.2097], Tmin=(1076.26,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(347.769,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Allyl_P) + radical(RCCJ)"""),
)
...
species(
    label = '[CH]=C(CC)CC=C[CH2](24728)',
    structure = SMILES('[CH]=C(CC)CC=C[CH2]'),
    E0 = (389.619,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,2995,3025,975,1000,1300,1375,400,500,1630,1680,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3100,440,815,1455,1000,180,758.832],'cm^-1')),
        HinderedRotor(inertia=(0.959199,'amu*angstrom^2'), symmetry=1, barrier=(22.0539,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.000881377,'amu*angstrom^2'), symmetry=1, barrier=(10.0072,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.959211,'amu*angstrom^2'), symmetry=1, barrier=(22.0541,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.9592,'amu*angstrom^2'), symmetry=1, barrier=(22.0539,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.959142,'amu*angstrom^2'), symmetry=1, barrier=(22.0526,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0843398,0.0777334,-4.15164e-05,1.29327e-09,4.25981e-12,47017.7,33.6466], Tmin=(100,'K'), Tmax=(1082.66,'K')), NASAPolynomial(coeffs=[16.4349,0.0376055,-1.48823e-05,2.72675e-09,-1.89295e-13,42215.6,-53.0189], Tmin=(1082.66,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(389.619,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Allyl_P) + radical(Cds_P)"""),
)
...
species(
    ...
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.285831,0.0813111,-5.67806e-05,2.02417e-08,-2.91662e-12,45912.4,34.4645], Tmin=(100,'K'), Tmax=(1625.14,'K')), NASAPolynomial(coeffs=[19.0326,0.0337617,-1.28921e-05,2.23753e-09,-1.46951e-13,39633.5,-68.1164], Tmin=(1625.14,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(380.365,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_S) + radical(Allyl_P)"""),
)
...
species(
    ...
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.00472392,0.0766794,-4.32878e-05,6.28076e-09,1.81956e-12,20314.7,31.735], Tmin=(100,'K'), Tmax=(1147.41,'K')), NASAPolynomial(coeffs=[15.6806,0.038712,-1.55026e-05,2.83197e-09,-1.95024e-13,15615,-50.8886], Tmin=(1147.41,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(167.628,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(465.61,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + group(Cdd-CdsCds)"""),
)
...
species(
    label = 'C=C1CC=CCC1C(24180)',
    structure = SMILES('C=C1CC=CCC1C'),
    E0 = (34.1839,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.43383,0.0285214,0.000108676,-1.52391e-07,5.70585e-11,4228.55,22.0777], Tmin=(100,'K'), Tmax=(991.064,'K')), NASAPolynomial(coeffs=[15.8068,0.0407892,-1.6259e-05,3.20068e-09,-2.39349e-13,-2071.75,-64.5472], Tmin=(991.064,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(34.1839,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(478.082,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Cyclohexane)"""),
)
...
species(
    ...
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.215151,0.0816863,-5.02142e-05,1.5421e-08,-1.92852e-12,43375.1,33.8751], Tmin=(100,'K'), Tmax=(1815.68,'K')), NASAPolynomial(coeffs=[18.8618,0.0396592,-1.54942e-05,2.67278e-09,-1.73227e-13,36447.6,-69.539], Tmin=(1815.68,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(359.304,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[CH]=C[CH]CC(=C)CC(24734)',
    structure = SMILES('[CH]C=CCC(=C)CC'),
    E0 = (361.708,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2950,3100,1380,975,1025,1650,2995,3025,975,1000,1300,1375,400,500,1630,1680,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,200,800,1000,1200,1400,1600],'cm^-1')),
...
reaction(
    label = 'reaction1',
    reactants = ['C=C[CH]CC(=C)[CH]C(24178)'],
...
reaction(
    label = 'reaction2',
    reactants = ['C=C[CH]CC(=C)[CH]C(24178)'],
    products = ['[CH2][CH]C1CC(=CC)C1(24702)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(1.20551e+07,'s^-1'), n=1.225, Ea=(129.746,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [R5_SS_D;doublebond_intra;radadd_intra_cs2H]
Euclidian distance = 0
...
reaction(
    label = 'reaction3',
    reactants = ['C=C[CH]CC(=C)[CH]C(24178)'],
    products = ['[CH2]C1([CH]C)CC=CC1(24703)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', '[CH2]C(=CC)CC=C=C(24704)'],
...
reaction(
    label = 'reaction6',
    reactants = ['C=C[CH]CC(=C)[CH]C(24178)'],
    products = ['[CH2]C(=CC)CC=[C]C(24705)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['C=C[CH]CC(=C)[CH]C(24178)'],
    products = ['[CH2]C=C[CH]C(C)=CC(24706)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]C=CCC(C)=[C]C(24707)'],
    products = ['C=C[CH]CC(=C)[CH]C(24178)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2][C]=CCC(C)=CC(24710)'],
    products = ['C=C[CH]CC(=C)[CH]C(24178)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2][C](C=C)CC=CC(19774)'],
    products = ['C=C[CH]CC(=C)[CH]C(24178)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH]=C[CH2](2461)', '[CH2]C([CH2])=CC(24219)'],
    products = ['C=C[CH]CC(=C)[CH]C(24178)'],
...
reaction(
    label = 'reaction18',
    reactants = ['C=C[CH]CC(=C)[CH]C(24178)'],
    products = ['[CH2]C=CC[C]1CC1C(24712)'],
...
reaction(
    label = 'reaction19',
    reactants = ['C=C[CH]CC(=C)[CH]C(24178)'],
    products = ['[CH2]C(=CC)CC1[CH]C1(24713)'],
...
reaction(
    label = 'reaction21',
    reactants = ['C=C[CH]CC(=C)[CH]C(24178)'],
    products = ['[CH2][C]1CC=CCC1C(24714)'],
...
reaction(
    label = 'reaction23',
    reactants = ['CH2(S)(23)', '[CH2]C=CCC([CH2])=C(24716)'],
    products = ['C=C[CH]CC(=C)[CH]C(24178)'],
...
reaction(
    label = 'reaction27',
    reactants = ['CH2(19)', '[CH]=CCC([CH2])=CC(24717)'],
    products = ['C=C[CH]CC(=C)[CH]C(24178)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(1e+10,'s^-1'), n=0, Ea=(140.779,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""Estimated using template [R4_S_D;doublebond_intra;radadd_intra_csHCd] for rate rule [R4_S_D;doublebond_intra_HNd;radadd_intra_csHCd]
Euclidian distance = 1.0
family: Intra_R_Add_Exocyclic
Ea raised from 138.4 to 140.8 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction29',
    reactants = ['H(3)', '[CH2]C(C=CC=C)=CC(24718)'],
    products = ['C=C[CH]CC(=C)[CH]C(24178)'],
...
reaction(
    label = 'reaction31',
    reactants = ['[CH2]C([CH]CC=C)=CC(24618)'],
    products = ['C=C[CH]CC(=C)[CH]C(24178)'],
...
reaction(
    label = 'reaction32',
    reactants = ['[CH2]C(=CC)CC[C]=C(24719)'],
    products = ['C=C[CH]CC(=C)[CH]C(24178)'],
...
reaction(
    label = 'reaction33',
    reactants = ['[CH]=CCCC([CH2])=CC(24720)'],
    products = ['C=C[CH]CC(=C)[CH]C(24178)'],
...
reaction(
    label = 'reaction34',
    reactants = ['[CH2]C(=[C]C)CCC=C(24721)'],
    products = ['C=C[CH]CC(=C)[CH]C(24178)'],
...
reaction(
    label = 'reaction35',
    reactants = ['[CH2][C](C=C)CCC=C(19786)'],
    products = ['C=C[CH]CC(=C)[CH]C(24178)'],
...
reaction(
    label = 'reaction36',
    reactants = ['[CH]=C[CH]CC(C)=CC(24722)'],
    products = ['C=C[CH]CC(=C)[CH]C(24178)'],
...
reaction(
    label = 'reaction37',
    reactants = ['C=C[CH]CC(=C)[CH]C(24178)'],
    products = ['[CH2][C]1CC(C=C)C1C(24723)'],
    transitionState = 'TS37',
    kinetics = Arrhenius(A=(3.78932e+07,'s^-1'), n=1.19089, Ea=(130.342,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4_Cs_HH_D;doublebond_intra;radadd_intra_cs] for rate rule [R4_Cs_HH_D;doublebond_intra;radadd_intra_csHCd]
Euclidian distance = 2.0
family: Intra_R_Add_Endocyclic
Ea raised from 127.3 to 130.3 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction38',
    reactants = ['C=C[CH]CC(=C)[CH]C(24178)'],
    products = ['CC=C1C[CH][CH]CC1(24724)'],
...
reaction(
    label = 'reaction43',
    reactants = ['[CH2]C=CCC(=C)C[CH2](24726)'],
    products = ['C=C[CH]CC(=C)[CH]C(24178)'],
...
reaction(
    label = 'reaction45',
    reactants = ['[CH]=C(CC)CC=C[CH2](24728)'],
    products = ['C=C[CH]CC(=C)[CH]C(24178)'],
...
reaction(
    label = 'reaction47',
    reactants = ['[CH2][C]=CCC(=C)CC(24730)'],
    products = ['C=C[CH]CC(=C)[CH]C(24178)'],
...
reaction(
    label = 'reaction48',
    reactants = ['[CH]=C([CH]C)CC=CC(24731)'],
    products = ['C=C[CH]CC(=C)[CH]C(24178)'],
...
reaction(
    label = 'reaction54',
    reactants = ['CHCH3(T)(95)', '[CH2]C=CC[C]=C(20266)'],
    products = ['C=C[CH]CC(=C)[CH]C(24178)'],
...
reaction(
    label = 'reaction55',
    reactants = ['[CH]=C([CH]C)CCC=C(24733)'],
    products = ['C=C[CH]CC(=C)[CH]C(24178)'],
...
reaction(
    label = 'reaction56',
    reactants = ['[CH]=C[CH]CC(=C)CC(24734)'],
    products = ['C=C[CH]CC(=C)[CH]C(24178)'],
