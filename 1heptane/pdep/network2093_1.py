...
species(
    label = 'C[CH]O[C](O)CC(11360)',
    structure = SMILES('C[CH]O[C](O)CC'),
    E0 = (-111.682,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (102.132,'amu'),
...
species(
    label = '[CH2]COC([O])CC(11361)',
    structure = SMILES('[CH2]COC([O])CC'),
    E0 = (-60.0899,'kJ/mol'),
    modes = [
...
species(
    label = 'CCO[C]([O])CC(11362)',
    structure = SMILES('CCO[C]([O])CC'),
    E0 = (-66.4327,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (102.132,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.933265,0.073708,-8.33628e-05,6.92884e-08,-2.6095e-11,-7885.5,28.9498], Tmin=(100,'K'), Tmax=(724.642,'K')), NASAPolynomial(coeffs=[4.20219,0.0503711,-2.41e-05,4.6879e-09,-3.30713e-13,-8220.3,15.1908], Tmin=(724.642,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-66.4327,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(Cs_P)"""),
)

species(
    label = 'C[CH]OC(O)[CH]C(11363)',
    structure = SMILES('C[CH]OC(O)[CH]C'),
    E0 = (-117.026,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3050,390,425,1340,1360,335,370,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3615,1277.5,1000,1380,1390,370,380,2900,435,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2]CC(O)O[CH]C(11364)',
    structure = SMILES('[CH2]CC(O)O[CH]C'),
    E0 = (-111.682,'kJ/mol'),
    modes = [
...
species(
    label = 'C[CH]C([O])OCC(11365)',
    structure = SMILES('C[CH]C([O])OCC'),
    E0 = (-71.777,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3025,407.5,1350,352.5,1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2]CC([O])OCC(11367)',
    structure = SMILES('[CH2]CC([O])OCC'),
    E0 = (-66.4327,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (102.132,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.933265,0.073708,-8.33628e-05,6.92884e-08,-2.6095e-11,-7885.5,30.0484], Tmin=(100,'K'), Tmax=(724.642,'K')), NASAPolynomial(coeffs=[4.20219,0.0503711,-2.41e-05,4.6879e-09,-3.30713e-13,-8220.3,16.2894], Tmin=(724.642,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-66.4327,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(RCCJ)"""),
)
...
species(
    ...
    molecularWeight = (102.132,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.47684,0.0576637,-3.05965e-05,7.39249e-09,-7.01234e-13,-58713.9,24.2153], Tmin=(100,'K'), Tmax=(2332.17,'K')), NASAPolynomial(coeffs=[18.2424,0.0289086,-1.21021e-05,2.1058e-09,-1.34527e-13,-66534.1,-70.8664], Tmin=(2332.17,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-488.904,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdCsOs)"""),
)

species(
    label = 'C=COC(O)CC(11369)',
    structure = SMILES('C=COC(O)CC'),
    E0 = (-409.518,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (102.132,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.164732,0.0681239,-2.09794e-05,-3.11092e-08,1.94292e-11,-49100.9,27.8528], Tmin=(100,'K'), Tmax=(957.916,'K')), NASAPolynomial(coeffs=[21.1442,0.0195689,-6.09478e-06,1.08781e-09,-8.01052e-14,-54911.8,-81.8105], Tmin=(957.916,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-409.518,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'C[CH]OC(=O)CC(6888)'],
    products = ['C[CH]OC([O])CC(11177)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'C=COC([O])CC(11164)'],
    products = ['C[CH]OC([O])CC(11177)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['C2H5(29)', 'C[CH]OC=O(2205)'],
    products = ['C[CH]OC([O])CC(11177)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction9',
    reactants = ['C[CH]OC(O)[CH]C(11363)'],
    products = ['C[CH]OC([O])CC(11177)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]CC(O)O[CH]C(11364)'],
    products = ['C[CH]OC([O])CC(11177)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CHCH3(T)(95)', 'CCC([O])[O](3172)'],
    products = ['C[CH]OC([O])CC(11177)'],
