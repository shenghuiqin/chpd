...
species(
    label = 'CCC([O])OC1CCC1[O](20341)',
    structure = SMILES('CCC([O])OC1CCC1[O]'),
    E0 = (-115.815,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (144.168,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.717104,0.0908934,-5.91656e-05,1.8531e-08,-2.31436e-12,-13748.8,39.4154], Tmin=(100,'K'), Tmax=(1850.03,'K')), NASAPolynomial(coeffs=[24.265,0.0368789,-1.53708e-05,2.74939e-09,-1.81744e-13,-22992.3,-96.4779], Tmin=(1850.03,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-115.815,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(515.497,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + ring(Cyclobutane) + radical(CCOJ) + radical(CC(C)OJ)"""),
)

species(
    label = 'CCC1O[CH]CCC([O])O1(20335)',
    structure = SMILES('CCC1O[CH]CCC([O])O1'),
    E0 = (-228.091,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (144.168,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.580137,0.055043,0.000115065,-2.20139e-07,9.7565e-11,-27225.6,37.3327], Tmin=(100,'K'), Tmax=(920.118,'K')), NASAPolynomial(coeffs=[38.6249,0.00315634,6.39158e-06,-1.37459e-09,8.02745e-14,-39458.5,-175.815], Tmin=(920.118,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-228.091,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(523.812,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Cycloheptane) + radical(CCsJOCs) + radical(CCOJ)"""),
)
...
species(
    label = 'CCC([O])OC=CCC=O(20342)',
    structure = SMILES('CCC([O])OC=CCC=O'),
    E0 = (-319.101,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2782.5,750,1395,475,1775,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.0689,0.0959533,-6.70684e-05,1.91379e-08,-1.25868e-12,-38183.7,39.4757], Tmin=(100,'K'), Tmax=(1269.51,'K')), NASAPolynomial(coeffs=[23.666,0.0353718,-1.59921e-05,3.08344e-09,-2.1753e-13,-45862.4,-91.2661], Tmin=(1269.51,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-319.101,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(482.239,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-OdCsH) + radical(CCOJ)"""),
)
...
species(
    label = 'CCC([O])OC[CH]CC=O(20343)',
    structure = SMILES('CCC([O])OC[CH]CC=O'),
    E0 = (-202.137,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2782.5,750,1395,475,1775,1000,3025,407.5,1350,352.5,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (144.168,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.567054,0.110258,-0.000141115,1.22115e-07,-4.53452e-11,-24156.4,42.6612], Tmin=(100,'K'), Tmax=(754.759,'K')), NASAPolynomial(coeffs=[5.52028,0.0667559,-3.23176e-05,6.28322e-09,-4.41698e-13,-24755.1,17.1272], Tmin=(754.759,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-202.137,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(CCOJ) + radical(CCJCO)"""),
)

species(
    label = 'CC[C](O)O[CH]CCC=O(20344)',
    structure = SMILES('CC[C](O)O[CH]CCC=O'),
    E0 = (-242.042,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (144.168,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.25238,0.124097,-0.000158961,1.19089e-07,-3.70348e-11,-28929.6,41.914], Tmin=(100,'K'), Tmax=(777.703,'K')), NASAPolynomial(coeffs=[12.1685,0.0550685,-2.58224e-05,4.95966e-09,-3.46886e-13,-31017.1,-19.46], Tmin=(777.703,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-242.042,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(498.868,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(Cs_P) + radical(CCsJOCs)"""),
)

species(
    label = 'CC[C]([O])OCCCC=O(20345)',
    structure = SMILES('CC[C]([O])OCCCC=O'),
    E0 = (-196.793,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (144.168,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.77258,0.116824,-0.00016257,1.47173e-07,-5.50903e-11,-23508.3,41.5868], Tmin=(100,'K'), Tmax=(786.524,'K')), NASAPolynomial(coeffs=[4.9584,0.0683804,-3.33779e-05,6.4738e-09,-4.52863e-13,-23812.9,19.1089], Tmin=(786.524,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-196.793,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(Cs_P) + radical(CCOJ)"""),
)

species(
    label = 'CCC([O])OCC[CH]C=O(20346)',
    structure = SMILES('CCC([O])OCCC=C[O]'),
    E0 = (-258.787,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (144.168,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.558105,0.101713,-8.53331e-05,3.82219e-08,-7.16564e-12,-30962.3,39.8445], Tmin=(100,'K'), Tmax=(1236.31,'K')), NASAPolynomial(coeffs=[15.4834,0.0498109,-2.23605e-05,4.26424e-09,-2.98818e-13,-34928.7,-40.9491], Tmin=(1236.31,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-258.787,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(CCOJ) + radical(C=COJ)"""),
)

species(
    label = 'C[CH]C(O)O[CH]CCC=O(20347)',
    structure = SMILES('C[CH]C(O)O[CH]CCC=O'),
    E0 = (-247.386,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3050,390,425,1340,1360,335,370,2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1277.5,1000,1380,1390,370,380,2900,435,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2782.5,750,1395,475,1775,1000,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (144.168,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.960159,0.116451,-0.000133382,8.79388e-08,-2.42097e-11,-29581.4,42.6807], Tmin=(100,'K'), Tmax=(871.082,'K')), NASAPolynomial(coeffs=[12.7848,0.0533328,-2.46896e-05,4.75039e-09,-3.34069e-13,-31976,-21.7335], Tmin=(871.082,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-247.386,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(498.868,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(CCsJOCs) + radical(CCJCO)"""),
)

species(
    label = '[CH2]CC(O)O[CH]CCC=O(20348)',
    structure = SMILES('[CH2]CC(O)O[CH]CCC=O'),
    E0 = (-242.042,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,3615,1277.5,1000,3000,3100,440,815,1455,1000,1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2782.5,750,1395,475,1775,1000,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (144.168,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.25238,0.124097,-0.000158961,1.19089e-07,-3.70348e-11,-28929.6,43.0126], Tmin=(100,'K'), Tmax=(777.703,'K')), NASAPolynomial(coeffs=[12.1685,0.0550685,-2.58224e-05,4.95966e-09,-3.46886e-13,-31017.1,-18.3613], Tmin=(777.703,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-242.042,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(498.868,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(CCsJOCs) + radical(RCCJ)"""),
)

species(
    label = 'CCC([O])OCCC[C]=O(20349)',
    structure = SMILES('CCC([O])OCCC[C]=O'),
    E0 = (-242.078,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (144.168,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.890583,0.119121,-0.000167188,1.48766e-07,-5.44073e-11,-28950.4,42.1424], Tmin=(100,'K'), Tmax=(794.948,'K')), NASAPolynomial(coeffs=[6.10904,0.0655863,-3.16167e-05,6.09192e-09,-4.24273e-13,-29484.6,13.6192], Tmin=(794.948,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-242.078,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(CCCJ=O) + radical(CCOJ)"""),
)

species(
    label = 'C[CH]C([O])OCCCC=O(20350)',
    structure = SMILES('C[CH]C([O])OCCCC=O'),
    E0 = (-202.137,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2782.5,750,1395,475,1775,1000,3025,407.5,1350,352.5,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'CCC(O)O[CH][CH]CC=O(20351)',
    structure = SMILES('CCC(O)O[CH][CH]CC=O'),
    E0 = (-247.386,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (144.168,'amu'),
...
species(
    label = '[CH2]CC([O])OCCCC=O(20352)',
    structure = SMILES('[CH2]CC([O])OCCCC=O'),
    E0 = (-196.793,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (144.168,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.772746,0.116826,-0.000162579,1.47188e-07,-5.5098e-11,-23508.3,42.686], Tmin=(100,'K'), Tmax=(786.488,'K')), NASAPolynomial(coeffs=[4.95866,0.06838,-3.33776e-05,6.47373e-09,-4.52857e-13,-23813,20.2061], Tmin=(786.488,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-196.793,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(CCOJ) + radical(RCCJ)"""),
)

species(
    label = 'CCC(O)O[CH]C[CH]C=O(20353)',
    structure = SMILES('CCC(O)O[CH]CC=C[O]'),
    E0 = (-304.036,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (144.168,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.79804,0.118266,-0.000116014,5.80177e-08,-1.1465e-11,-36350.6,42.8807], Tmin=(100,'K'), Tmax=(1229.85,'K')), NASAPolynomial(coeffs=[24.0484,0.0342022,-1.34838e-05,2.43864e-09,-1.67049e-13,-42708,-87.1606], Tmin=(1229.85,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-304.036,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(C=COJ) + radical(CCsJOCs)"""),
)

species(
    label = 'CCC(O)O[CH]CC[C]=O(20354)',
    structure = SMILES('CCC(O)O[CH]CC[C]=O'),
    E0 = (-287.327,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (144.168,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.40289,0.126835,-0.000165442,1.23644e-07,-3.79118e-11,-34370.3,42.5827], Tmin=(100,'K'), Tmax=(791.871,'K')), NASAPolynomial(coeffs=[13.3806,0.0521601,-2.39911e-05,4.56049e-09,-3.16814e-13,-36711.7,-25.2898], Tmin=(791.871,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-287.327,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(498.868,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(CCCJ=O) + radical(CCsJOCs)"""),
)
...
species(
    label = 'CCC([O])OC1CC[CH]O1(20355)',
    structure = SMILES('CCC([O])OC1CC[CH]O1'),
    E0 = (-233.445,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (144.168,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.571087,0.0898978,-5.57013e-05,1.19231e-08,1.41576e-12,-27903.3,35.9606], Tmin=(100,'K'), Tmax=(1048.75,'K')), NASAPolynomial(coeffs=[15.6673,0.0453059,-1.67275e-05,2.91636e-09,-1.9601e-13,-32263,-47.7003], Tmin=(1048.75,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-233.445,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(515.497,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Tetrahydrofuran) + radical(CCOJ) + radical(CCsJOCs)"""),
)
...
species(
    label = 'CCC(=O)OCCCC=O(20357)',
    structure = SMILES('CCC(=O)OCCCC=O'),
    E0 = (-619.264,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (144.168,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.78416,0.0843119,-2.27501e-05,-9.68956e-08,1.02472e-10,-74378.3,33.4688], Tmin=(100,'K'), Tmax=(468.621,'K')), NASAPolynomial(coeffs=[5.05644,0.0675532,-3.21905e-05,6.2772e-09,-4.44926e-13,-74995.2,13.7868], Tmin=(468.621,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-619.264,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdCsOs) + group(Cds-OdCsH)"""),
)

species(
    label = 'CCC(O)OC=CCC=O(20358)',
    structure = SMILES('CCC(O)OC=CCC=O'),
    E0 = (-544.806,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (144.168,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.3015,0.097525,-5.24101e-05,-6.3476e-09,9.79855e-12,-65317.8,39.4276], Tmin=(100,'K'), Tmax=(1057.13,'K')), NASAPolynomial(coeffs=[25.3463,0.0337215,-1.44159e-05,2.82469e-09,-2.0611e-13,-73020.8,-100.399], Tmin=(1057.13,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-544.806,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-OdCsH)"""),
)
...
species(
    label = '[CH2]C(CC=O)OC([O])CC(20359)',
    structure = SMILES('[CH2]C(CC=O)OC([O])CC'),
    E0 = (-202.08,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (144.168,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.20698,0.127162,-0.000186212,1.66548e-07,-6.03794e-11,-24129.3,41.8659], Tmin=(100,'K'), Tmax=(803.221,'K')), NASAPolynomial(coeffs=[7.06722,0.0651896,-3.1696e-05,6.11132e-09,-4.25048e-13,-24788.6,7.93106], Tmin=(803.221,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-202.08,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(CCOJ) + radical(CJC(C)OC)"""),
)

species(
    label = 'CCC1OC(CCC=O)O1(20317)',
    structure = SMILES('CCC1OC(CCC=O)O1'),
    E0 = (-479.212,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (144.168,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.686132,0.0893656,-5.65459e-05,1.67877e-08,-1.96466e-12,-57455.3,36.423], Tmin=(100,'K'), Tmax=(1981.98,'K')), NASAPolynomial(coeffs=[27.087,0.0333144,-1.41254e-05,2.51905e-09,-1.64865e-13,-68464.5,-116.566], Tmin=(1981.98,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-479.212,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(511.34,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsOsH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + ring(Cyclobutane)"""),
)

species(
    label = 'C=COC[CH]OC([O])CC(20360)',
    structure = SMILES('C=COC[CH]OC([O])CC'),
    E0 = (-179.986,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,2750,2800,2850,1350,1500,750,1050,1375,1000,2950,3100,1380,975,1025,1650,1380,1390,370,380,2900,435,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,180,180,180,335.397,796.8,1600,1828.57,2971.43,3200],'cm^-1')),
        HinderedRotor(inertia=(0.153567,'amu*angstrom^2'), symmetry=1, barrier=(3.53081,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.153567,'amu*angstrom^2'), symmetry=1, barrier=(3.53081,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.153567,'amu*angstrom^2'), symmetry=1, barrier=(3.53081,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.153567,'amu*angstrom^2'), symmetry=1, barrier=(3.53081,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.153567,'amu*angstrom^2'), symmetry=1, barrier=(3.53081,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (144.168,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.59262,0.120305,-0.000121875,6.41176e-08,-1.35153e-11,-21443.7,40.3427], Tmin=(100,'K'), Tmax=(1145.14,'K')), NASAPolynomial(coeffs=[21.2588,0.0404848,-1.73186e-05,3.24804e-09,-2.26549e-13,-26677.3,-72.999], Tmin=(1145.14,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-179.986,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CCOJ) + radical(CCsJOCs)"""),
)

species(
    label = 'CCC([O])O[CH]CC=CO(20361)',
    structure = SMILES('CCC([O])O[CH]CC=CO'),
    E0 = (-219.794,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (144.168,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.62899,0.119912,-0.000122693,6.51793e-08,-1.38108e-11,-26229.1,41.7253], Tmin=(100,'K'), Tmax=(1143.38,'K')), NASAPolynomial(coeffs=[21.6269,0.0385545,-1.59604e-05,2.94798e-09,-2.04016e-13,-31547.2,-73.5873], Tmin=(1143.38,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-219.794,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(CCOJ) + radical(CCsJOCs)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['CCC([O])O[CH]CCC=O(20313)'],
...
reaction(
    label = 'reaction2',
    reactants = ['CCC([O])O[CH]CCC=O(20313)'],
    products = ['CCC([O])OC1CCC1[O](20341)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CCC([O])O[CH]CCC=O(20313)'],
    products = ['CCC1O[CH]CCC([O])O1(20335)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', 'CCC([O])OC=CCC=O(20342)'],
    products = ['CCC([O])O[CH]CCC=O(20313)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)', 'CCC(=O)O[CH]CCC=O(19436)'],
    products = ['CCC([O])O[CH]CCC=O(20313)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['CC[CH][O](563)', 'O=CCCC=O(5767)'],
    products = ['CCC([O])O[CH]CCC=O(20313)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['CH2CHO(40)', 'C=COC([O])CC(11164)'],
    products = ['CCC([O])O[CH]CCC=O(20313)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['C2H5(29)', 'O=CCC[CH]OC=O(18676)'],
    products = ['CCC([O])O[CH]CCC=O(20313)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['CCC([O])OC[CH]CC=O(20343)'],
    products = ['CCC([O])O[CH]CCC=O(20313)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['CCC([O])O[CH]CCC=O(20313)'],
    products = ['CC[C](O)O[CH]CCC=O(20344)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CC[C]([O])OCCCC=O(20345)'],
    products = ['CCC([O])O[CH]CCC=O(20313)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CCC([O])O[CH]CCC=O(20313)'],
    products = ['CCC([O])OCC[CH]C=O(20346)'],
...
reaction(
    label = 'reaction13',
    reactants = ['C[CH]C(O)O[CH]CCC=O(20347)'],
    products = ['CCC([O])O[CH]CCC=O(20313)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]CC(O)O[CH]CCC=O(20348)'],
    products = ['CCC([O])O[CH]CCC=O(20313)'],
...
reaction(
    label = 'reaction16',
    reactants = ['C[CH]C([O])OCCCC=O(20350)'],
    products = ['CCC([O])O[CH]CCC=O(20313)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CCC([O])O[CH]CCC=O(20313)'],
    products = ['CCC(O)O[CH][CH]CC=O(20351)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2]CC([O])OCCCC=O(20352)'],
    products = ['CCC([O])O[CH]CCC=O(20313)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CCC([O])O[CH]CCC=O(20313)'],
    products = ['CCC(O)O[CH]C[CH]C=O(20353)'],
...
reaction(
    label = 'reaction20',
    reactants = ['CCC([O])O[CH]CCC=O(20313)'],
    products = ['CCC(O)O[CH]CC[C]=O(20354)'],
...
reaction(
    label = 'reaction22',
    reactants = ['CCC([O])O[CH]CCC=O(20313)'],
    products = ['CCC([O])OC1CC[CH]O1(20355)'],
...
reaction(
    label = 'reaction26',
    reactants = ['CH2(S)(23)', 'CC([O])O[CH]CCC=O(18428)'],
    products = ['CCC([O])O[CH]CCC=O(20313)'],
...
reaction(
    label = 'reaction27',
    reactants = ['CO(12)', 'CC[CH]OC([O])CC(10741)'],
    products = ['CCC([O])O[CH]CCC=O(20313)'],
...
reaction(
    label = 'reaction28',
    reactants = ['[CH2]C(CC=O)OC([O])CC(20359)'],
    products = ['CCC([O])O[CH]CCC=O(20313)'],
...
reaction(
    label = 'reaction29',
    reactants = ['CCC([O])O[CH]CCC=O(20313)'],
    products = ['CCC1OC(CCC=O)O1(20317)'],
...
reaction(
    label = 'reaction30',
    reactants = ['C=COC[CH]OC([O])CC(20360)'],
    products = ['CCC([O])O[CH]CCC=O(20313)'],
...
reaction(
    label = 'reaction31',
    reactants = ['CCC([O])O[CH]CC=CO(20361)'],
    products = ['CCC([O])O[CH]CCC=O(20313)'],
...
reaction(
    label = 'reaction32',
    reactants = ['CCC([O])[O](3172)', '[CH]CCC=O(18484)'],
    products = ['CCC([O])O[CH]CCC=O(20313)'],
...
reaction(
    label = 'reaction33',
    reactants = ['O(4)', 'CC[CH]O[CH]CCC=O(18522)'],
    products = ['CCC([O])O[CH]CCC=O(20313)'],
