species(
    label = '[CH]=CC=[C]O(1166)',
    structure = SMILES('[CH]=CC=[C]O'),
    E0 = (371.969,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,3120,650,792.5,1650,3615,1277.5,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680],'cm^-1')),
        HinderedRotor(inertia=(1.04552,'amu*angstrom^2'), symmetry=1, barrier=(24.0386,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.0451,'amu*angstrom^2'), symmetry=1, barrier=(24.0289,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (68.074,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.78297,0.0379193,-1.03153e-05,-2.84284e-08,1.82663e-11,44827.6,19.3457], Tmin=(100,'K'), Tmax=(895.99,'K')), NASAPolynomial(coeffs=[17.0365,-4.72768e-05,2.80342e-06,-6.57682e-10,4.55615e-14,40884.8,-59.3179], Tmin=(895.99,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(371.969,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(Cds_P) + radical(C=CJO)"""),
)
...
species(
    ...
    E0 = (376.338,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2100,2250,500,550,3120,650,792.5,1650,3615,1277.5,1000,3010,987.5,1337.5,450,1655],'cm^-1')),
        HinderedRotor(inertia=(1.35192,'amu*angstrom^2'), symmetry=1, barrier=(31.0834,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.35402,'amu*angstrom^2'), symmetry=1, barrier=(31.1317,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (67.066,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.35429,0.0295696,-1.25141e-05,-7.11135e-09,5.14882e-12,45328,16.5379], Tmin=(100,'K'), Tmax=(1023.95,'K')), NASAPolynomial(coeffs=[11.0371,0.00972163,-4.05123e-06,7.99112e-10,-5.91746e-14,42812.2,-29.159], Tmin=(1023.95,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(376.338,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CtH) + group(Cds-CdsCtH) + group(Cds-CdsHH) + group(Ct-Ct(Cds-Cds)) + group(Ct-CtOs) + radical(Cds_P)"""),
)
...
species(
    label = 'OC1C=CC=1(8477)',
    structure = SMILES('OC1C=CC=1'),
    E0 = (209.631,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (68.074,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.10805,0.0281841,1.59518e-05,-5.24462e-08,2.55674e-11,25293.4,12.1048], Tmin=(100,'K'), Tmax=(917.593,'K')), NASAPolynomial(coeffs=[16.2175,0.0017891,1.70294e-06,-3.92678e-10,2.37232e-14,21225.9,-62.8063], Tmin=(917.593,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(209.631,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cds-Cds(Cds-Cds)O2s) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + ring(cyclobutadiene_13)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH]=CC=[C]O(1166)'],
    products = ['HCCOH(50)', 'C2H2(32)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction13',
    reactants = ['C2H2(T)(175)', '[CH]=[C]O(172)'],
    products = ['[CH]=CC=[C]O(1166)'],
