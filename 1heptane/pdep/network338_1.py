species(
    label = 'C=[C]OC([O])=O(798)',
    structure = SMILES('C=[C]OC([O])=O'),
    E0 = (-48.0901,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,3100,1380,975,1025,1650,1685,370,180,180,671.965,671.973,671.978,671.983,671.989,672.022],'cm^-1')),
        HinderedRotor(inertia=(0.0955664,'amu*angstrom^2'), symmetry=1, barrier=(2.19726,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.039729,'amu*angstrom^2'), symmetry=1, barrier=(12.7325,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.0462,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.97993,0.0407244,-4.09818e-05,1.99735e-08,-3.79653e-12,-5708.08,20.9088], Tmin=(100,'K'), Tmax=(1282.4,'K')), NASAPolynomial(coeffs=[12.0972,0.00916738,-4.07025e-06,7.84783e-10,-5.57612e-14,-8302.96,-30.4176], Tmin=(1282.4,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-48.0901,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-Cd)) + group(O2s-(Cds-O2d)H) + group(Cds-CdsOsH) + group(Cds-OdOsOs) + group(Cds-CdsHH) + radical(C=CJO) + radical(OC=OOJ)"""),
)
...
species(
    label = 'C#COC([O])=O(5743)',
    structure = SMILES('C#COC([O])=O'),
    E0 = (-58.8728,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2175,525,750,770,3400,2100,528.004,528.869,528.893,528.91,529.285,529.317,529.601],'cm^-1')),
        HinderedRotor(inertia=(0.190484,'amu*angstrom^2'), symmetry=1, barrier=(37.7646,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.189934,'amu*angstrom^2'), symmetry=1, barrier=(37.768,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
species(
    label = '[CH]=[C]OC(=O)O(5745)',
    structure = SMILES('[CH]=[C]OC(=O)O'),
    E0 = (-44.7422,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,3615,1277.5,1000,3120,650,792.5,1650,180,180,312.148,619.645,619.667,619.696],'cm^-1')),
        HinderedRotor(inertia=(0.0803792,'amu*angstrom^2'), symmetry=1, barrier=(21.8979,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.080373,'amu*angstrom^2'), symmetry=1, barrier=(21.8977,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0803713,'amu*angstrom^2'), symmetry=1, barrier=(21.8977,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.0462,'amu'),
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'C#COC([O])=O(5743)'],
    products = ['C=[C]OC([O])=O(798)'],
    transitionState = 'TS3',
