...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'CH2OCHCH2(566)'],
    products = ['[CH2]CO[CH2](512)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]O[CH2](103)', 'CH2(19)'],
    products = ['[CH2]CO[CH2](512)'],
