...
species(
    label = 'CCCC=CCC[O](1874)',
    structure = SMILES('CCCC=CCC[O]'),
    E0 = (-33.0954,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.976088,0.0724987,-4.03396e-05,1.07476e-08,-1.17842e-12,-3878.76,31.42], Tmin=(100,'K'), Tmax=(1896.53,'K')), NASAPolynomial(coeffs=[13.0521,0.047029,-2.01951e-05,3.66643e-09,-2.44986e-13,-8459.26,-34.5687], Tmin=(1896.53,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-33.0954,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(486.397,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(CCOJ)"""),
)

species(
    label = 'CCCCC=CC[O](1875)',
    structure = SMILES('CCCCC=CC[O]'),
    E0 = (-27.5385,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (113.178,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.19932,0.0698619,-3.63806e-05,8.64645e-09,-8.12943e-13,-3221.12,30.9881], Tmin=(100,'K'), Tmax=(2270.05,'K')), NASAPolynomial(coeffs=[17.4823,0.04117,-1.74216e-05,3.07856e-09,-1.99752e-13,-10613.7,-60.9165], Tmin=(2270.05,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-27.5385,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(486.397,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(CCOJ)"""),
)
...
species(
    label = 'CCCC[CH][CH]CO(1881)',
    structure = SMILES('CCCC[CH][CH]CO'),
    E0 = (18.8881,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (114.185,'amu'),
...
species(
    label = 'CC[CH]C[CH]CCO(1885)',
    structure = SMILES('CC[CH]C[CH]CCO'),
    E0 = (13.4443,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (114.185,'amu'),
...
species(
    label = 'C[CH]CC[CH]CCO(1886)',
    structure = SMILES('C[CH]CC[CH]CCO'),
    E0 = (13.4323,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (114.185,'amu'),
...
species(
    label = '[CH2]CCC[CH]CCO(1887)',
    structure = SMILES('[CH2]CCC[CH]CCO'),
    E0 = (24.2324,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (114.185,'amu'),
...
species(
    label = 'CCCCC=CCO(1888)',
    structure = SMILES('CCCCC=CCO'),
    E0 = (-253.244,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (114.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0613959,0.0810599,-5.12565e-05,1.65997e-08,-2.22794e-12,-30312.4,34.27], Tmin=(100,'K'), Tmax=(1668.4,'K')), NASAPolynomial(coeffs=[15.7179,0.0435229,-1.75078e-05,3.11415e-09,-2.07179e-13,-35536.6,-49.2776], Tmin=(1668.4,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-253.244,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['CCCC[CH]CC[O](992)'],
    products = ['CH2O(15)', 'C=CCCCC(193)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'CCCC=CCC[O](1874)'],
    products = ['CCCC[CH]CC[O](992)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', 'CCCC[CH]CC=O(1876)'],
    products = ['CCCC[CH]CC[O](992)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['npropyl(83)', 'C=CCC[O](1706)'],
    products = ['CCCC[CH]CC[O](992)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2][O](167)', 'C=CCCCC(193)'],
    products = ['CCCC[CH]CC[O](992)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2][CH]CCCC(197)', 'CH2O(15)'],
    products = ['CCCC[CH]CC[O](992)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2][CH]CCCC(197)', '[CH2][O](167)'],
    products = ['CCCC[CH]CC[O](992)'],
...
reaction(
    label = 'reaction28',
    reactants = ['[CH2]C[O](96)', '[CH]CCCC(141)'],
    products = ['CCCC[CH]CC[O](992)'],
...
reaction(
    label = 'reaction29',
    reactants = ['[CH2]C[CH]CCCC(199)', 'O(4)'],
    products = ['CCCC[CH]CC[O](992)'],
