...
species(
    ...
    molecularWeight = (85.0813,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.23895,0.0220754,4.61641e-05,-7.68615e-08,3.06646e-11,35636.2,20.632], Tmin=(100,'K'), Tmax=(982.407,'K')), NASAPolynomial(coeffs=[14.1783,0.0147804,-5.78352e-06,1.20107e-09,-9.48541e-14,31296.5,-46.9039], Tmin=(982.407,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(295.645,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(253.591,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + ring(Cyclobutane) + radical(Cds_P)"""),
)

species(
    label = 'C#C[C](C)OO(26424)',
    structure = SMILES('[CH]=C=C(C)OO'),
    E0 = (211.115,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,440,435,1725,540,610,2055,3120,650,792.5,1650,3615,1310,387.5,850,1000,2750,2800,2850,1350,1500,750,1050,1375,1000],'cm^-1')),
        HinderedRotor(inertia=(0.677736,'amu*angstrom^2'), symmetry=1, barrier=(15.5825,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.675718,'amu*angstrom^2'), symmetry=1, barrier=(15.5361,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (85.0813,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.50148,0.0575454,-7.16632e-05,5.05832e-08,-1.45384e-11,25478.9,21.726], Tmin=(100,'K'), Tmax=(846.138,'K')), NASAPolynomial(coeffs=[8.88938,0.0226184,-9.74288e-06,1.79415e-09,-1.22462e-13,24228.8,-12.6817], Tmin=(846.138,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(211.115,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(C=C=CJ)"""),
)

species(
    label = 'C#CC([CH2])OO(26425)',
    ...
    molecularWeight = (85.0813,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.00558,0.0595106,-6.271e-05,3.32896e-08,-6.86408e-12,31635.3,24.4669], Tmin=(100,'K'), Tmax=(1194.86,'K')), NASAPolynomial(coeffs=[14.9037,0.0129835,-4.29995e-06,6.99496e-10,-4.51513e-14,28314,-45.0576], Tmin=(1194.86,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(262.089,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(CJCOOH)"""),
)

species(
    label = '[C]#CC(C)OO(26426)',
    structure = SMILES('[C]#CC(C)OO'),
    E0 = (385.27,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2175,525,2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,240.467],'cm^-1')),
        HinderedRotor(inertia=(1.79664,'amu*angstrom^2'), symmetry=1, barrier=(75.8469,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.265996,'amu*angstrom^2'), symmetry=1, barrier=(11.0962,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.644069,'amu*angstrom^2'), symmetry=1, barrier=(26.8994,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.83305,'amu*angstrom^2'), symmetry=1, barrier=(75.8465,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (85.0813,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.25981,0.0583907,-6.5421e-05,3.90834e-08,-9.23975e-12,46437.6,22.3011], Tmin=(100,'K'), Tmax=(1036.72,'K')), NASAPolynomial(coeffs=[11.8543,0.0175133,-6.27608e-06,1.04966e-09,-6.80139e-14,44240.9,-29.1932], Tmin=(1036.72,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(385.27,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(Acetyl)"""),
)
...
species(
    ...
    E0 = (242.448,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,750,770,3400,2100,492.5,1135,1000,2175,525],'cm^-1')),
        HinderedRotor(inertia=(0.595333,'amu*angstrom^2'), symmetry=1, barrier=(13.6879,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.74398,'amu*angstrom^2'), symmetry=1, barrier=(63.0895,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
species(
    ...
    E0 = (206.982,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2175,525,750,770,3400,2100,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,248.276],'cm^-1')),
        HinderedRotor(inertia=(0.59556,'amu*angstrom^2'), symmetry=1, barrier=(26.1247,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.599472,'amu*angstrom^2'), symmetry=1, barrier=(26.1303,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
species(
    label = 'CC=[C]C1OO1(26444)',
    structure = SMILES('CC=[C]C1OO1'),
    E0 = (242.092,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (85.0813,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.92585,0.0374182,-6.84714e-06,-2.13328e-08,1.2201e-11,29199.2,20.3014], Tmin=(100,'K'), Tmax=(934.098,'K')), NASAPolynomial(coeffs=[11.9097,0.01534,-4.59289e-06,7.52928e-10,-5.15419e-14,26432,-32.0121], Tmin=(934.098,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(242.092,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsOsOsH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(dioxirane) + radical(Cds_S)"""),
)

species(
    label = 'CC=C=[C]OO(26445)',
    structure = SMILES('C[CH]C#COO'),
    E0 = (270.905,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2100,2250,500,550,3615,1310,387.5,850,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,180],'cm^-1')),
        HinderedRotor(inertia=(0.0944594,'amu*angstrom^2'), symmetry=1, barrier=(68.623,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.9809,'amu*angstrom^2'), symmetry=1, barrier=(68.5367,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.79777,'amu*angstrom^2'), symmetry=1, barrier=(18.3423,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.98196,'amu*angstrom^2'), symmetry=1, barrier=(68.5612,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (85.0813,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.51579,0.0520602,-5.19603e-05,2.87445e-08,-6.40594e-12,32674,22.1832], Tmin=(100,'K'), Tmax=(1090.11,'K')), NASAPolynomial(coeffs=[10.4595,0.019243,-6.80387e-06,1.12882e-09,-7.27648e-14,30724.1,-21.7365], Tmin=(1090.11,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(270.905,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCt) + group(O2s-OsH) + group(Cs-CtCsHH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtOs) + radical(Sec_Propargyl)"""),
)

species(
    label = 'C[C]=C=COO(26446)',
    structure = SMILES('CC#C[CH]OO'),
    E0 = (236.844,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2100,2250,500,550,3615,1310,387.5,850,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,180],'cm^-1')),
        HinderedRotor(inertia=(3.31181,'amu*angstrom^2'), symmetry=1, barrier=(76.145,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(3.31434,'amu*angstrom^2'), symmetry=1, barrier=(76.2031,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(3.31397,'amu*angstrom^2'), symmetry=1, barrier=(76.1946,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.034449,'amu*angstrom^2'), symmetry=1, barrier=(76.174,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (85.0813,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.63074,0.0537289,-6.38756e-05,4.57086e-08,-1.33675e-11,28569.5,21.3739], Tmin=(100,'K'), Tmax=(901.181,'K')), NASAPolynomial(coeffs=[7.68422,0.0238685,-9.19438e-06,1.57377e-09,-1.02046e-13,27600,-6.52684], Tmin=(901.181,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(236.844,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CtOsHH) + group(Cs-CtHHH) + group(Ct-CtCs) + group(Ct-CtCs) + radical(CCsJOOH)"""),
)

species(
    label = '[CH2]C=C=COO(26447)',
    ...
    molecularWeight = (85.0813,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.900519,0.0589671,-6.07346e-05,3.13131e-08,-6.19374e-12,25210.5,22.6195], Tmin=(100,'K'), Tmax=(1337.77,'K')), NASAPolynomial(coeffs=[15.6301,0.0111608,-2.91038e-06,3.93636e-10,-2.24999e-14,21606.3,-51.4699], Tmin=(1337.77,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(208.619,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C=CJC=C)"""),
)
...
species(
    label = 'CC=C1[CH]OO1(26451)',
    structure = SMILES('CC=C1[CH]OO1'),
    E0 = (172.135,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (85.0813,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.58507,0.0121945,7.32773e-05,-1.02949e-07,3.93486e-11,20771,19.6583], Tmin=(100,'K'), Tmax=(977.501,'K')), NASAPolynomial(coeffs=[13.2717,0.0162455,-6.26065e-06,1.3029e-09,-1.03539e-13,16399,-43.3317], Tmin=(977.501,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(172.135,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(253.591,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-(Cds-Cds)OsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + ring(Cyclobutane) + radical(C=CCJO)"""),
)
...
species(
    label = 'CC=C=C[O](26452)',
    structure = SMILES('CC=C=C[O]'),
    E0 = (79.3724,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([540,610,2055,2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,180],'cm^-1')),
        HinderedRotor(inertia=(1.24785,'amu*angstrom^2'), symmetry=1, barrier=(28.6906,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (69.0819,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.06739,0.0324087,2.55945e-06,-3.12423e-08,1.56464e-11,9625.07,16.2312], Tmin=(100,'K'), Tmax=(948.971,'K')), NASAPolynomial(coeffs=[13.054,0.0110838,-3.22537e-06,5.65536e-10,-4.20947e-14,6414.88,-42.1248], Tmin=(948.971,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(79.3724,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cdd-CdsCds) + radical(C=COJ)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['O2(2)', 'CH3CHCCH(24127)'],
    products = ['C#CC(C)O[O](26146)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(3.19343e+07,'m^3/(mol*s)'), n=0.0113737, Ea=(2.96199,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [C_rad/H/OneDeC;Y_rad] for rate rule [C_rad/H/CtCs;O2_birad]
...
reaction(
    label = 'reaction6',
    reactants = ['CH3(17)', 'C#C[CH]O[O](26427)'],
    products = ['C#CC(C)O[O](26146)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['C[CH]O[O](97)', 'C2H(33)'],
    products = ['C#CC(C)O[O](26146)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(4.18e+12,'cm^3/(mol*s)'), n=-0.085, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Y_rad;C_rad/H/CsO] for rate rule [Ct_rad/Ct;C_rad/H/CsO]
Euclidian distance = 2.0
family: R_Recombination
...
reaction(
    label = 'reaction8',
    reactants = ['H(3)', 'C#C[C](C)O[O](26428)'],
    products = ['C#CC(C)O[O](26146)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(3)', 'C#CC([CH2])O[O](26429)'],
    products = ['C#CC(C)O[O](26146)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(3)', '[C]#CC(C)O[O](26430)'],
    products = ['C#CC(C)O[O](26146)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CH2(S)(23)', 'C#CCO[O](26153)'],
    products = ['C#CC(C)O[O](26146)'],
...
reaction(
    label = 'reaction13',
    reactants = ['C#CC(C)O[O](26146)'],
    products = ['HO2(10)', 'CH2CHCCH(26391)'],
...
reaction(
    label = 'reaction28',
    reactants = ['O2(2)', 'CH3CHCCH(24127)'],
    products = ['CC=C=CO[O](26151)'],
    transitionState = 'TS28',
    kinetics = Arrhenius(A=(8270,'cm^3/(mol*s)'), n=2.525, Ea=(8.32198,'kJ/mol'), T0=(1,'K'), comment="""From training reaction 42 used for Cd_allenic;O2_birad
Exact match found for rate rule [Cd_allenic;O2_birad]
Euclidian distance = 0
Multiplied by reaction path degeneracy 2.0
family: R_Recombination"""),
)
...
reaction(
    label = 'reaction31',
    reactants = ['C[C]=C=COO(26446)'],
    products = ['CC=C=CO[O](26151)'],
    transitionState = 'TS31',
    kinetics = Arrhenius(A=(3.38861e+07,'s^-1'), n=1.45253, Ea=(105.141,'kJ/mol'), T0=(1,'K'), comment="""Estimated using average of templates [RnH;Cd_rad_out_Cs;XH_out] + [R5H;Cd_rad_out_single;XH_out] for rate rule [R5H;Cd_rad_out_Cs;O_H_out]
Euclidian distance = 2.2360679775
family: intra_H_migration"""),
)
...
reaction(
    label = 'reaction34',
    reactants = ['H(3)', '[CH2]C=C=CO[O](26448)'],
    products = ['CC=C=CO[O](26151)'],
...
reaction(
    label = 'reaction35',
    reactants = ['H(3)', 'C[C]=C=CO[O](26449)'],
    products = ['CC=C=CO[O](26151)'],
...
reaction(
    label = 'reaction36',
    reactants = ['H(3)', 'CC=C=[C]O[O](26450)'],
    products = ['CC=C=CO[O](26151)'],
...
reaction(
    label = 'reaction38',
    reactants = ['CH2(S)(23)', 'C=C=CO[O](26147)'],
    products = ['CC=C=CO[O](26151)'],
