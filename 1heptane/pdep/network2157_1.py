species(
    label = '[CH2]C(CC)O[CH]CCCC(11668)',
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.95805,0.136461,-0.000135848,7.7643e-08,-1.86595e-11,-1216.27,42.4661], Tmin=(100,'K'), Tmax=(987.378,'K')), NASAPolynomial(coeffs=[15.4167,0.0660737,-2.89174e-05,5.4448e-09,-3.7922e-13,-4647.36,-41.1363], Tmin=(987.378,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-11.859,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(644.372,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCsJOCs) + radical(CJC(C)OC)"""),
)
...
species(
    label = 'C=C(CC)O[CH]CCCC(11704)',
    structure = SMILES('C=C(CC)O[CH]CCCC'),
    E0 = (-127.357,'kJ/mol'),
    modes = [
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.5897,0.128352,-0.000108531,4.7223e-08,-8.19503e-12,-15066.5,43.4744], Tmin=(100,'K'), Tmax=(1385.23,'K')), NASAPolynomial(coeffs=[26.872,0.0432785,-1.64089e-05,2.88763e-09,-1.936e-13,-23228.8,-108.262], Tmin=(1385.23,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-127.357,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(623.585,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(CCsJOC(O))"""),
)

species(
    label = '[CH2]C(CC)OC=CCCC(11705)',
    ...
    molecularWeight = (141.231,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.41367,0.124468,-9.00188e-05,2.26595e-08,1.76842e-12,-13904.9,42.5635], Tmin=(100,'K'), Tmax=(1030.44,'K')), NASAPolynomial(coeffs=[25.7984,0.0444921,-1.65989e-05,2.97829e-09,-2.06042e-13,-21287.3,-101.999], Tmin=(1030.44,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-117.652,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(623.585,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(CJC(C)OC)"""),
)
...
species(
    label = 'CCCC[CH]O[C](C)CC(11706)',
    structure = SMILES('CCCC[CH]O[C](C)CC'),
    E0 = (-41.6652,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (142.239,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.73787,0.13468,-0.000143532,9.45085e-08,-2.68116e-11,-4812.07,41.8773], Tmin=(100,'K'), Tmax=(836.985,'K')), NASAPolynomial(coeffs=[11.2095,0.072805,-3.26448e-05,6.18744e-09,-4.31353e-13,-6979.47,-18.2827], Tmin=(836.985,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-41.6652,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(644.372,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(C2CsJOCs) + radical(CCsJOCs)"""),
)

species(
    label = '[CH2]C(CC)OC[CH]CCC(11707)',
...
species(
    label = '[CH2][C](CC)OCCCCC(11708)',
    structure = SMILES('[CH2][C](CC)OCCCCC'),
    E0 = (-11.6112,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (142.239,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.08127,0.144234,-0.000183018,1.4828e-07,-5.06328e-11,-1187.52,43.394], Tmin=(100,'K'), Tmax=(784.888,'K')), NASAPolynomial(coeffs=[9.30483,0.0764508,-3.48339e-05,6.5786e-09,-4.54464e-13,-2674.37,-6.86512], Tmin=(784.888,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-11.6112,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(644.372,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(C2CsJOCs) + radical(CJC(C)OC)"""),
)

species(
    label = 'C[CH]C(C)O[CH]CCCC(11709)',
    structure = SMILES('C[CH]C(C)O[CH]CCCC'),
    E0 = (-22.467,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (142.239,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.68939,0.122023,-9.70916e-05,4.16865e-08,-7.46612e-12,-2495.06,44.2246], Tmin=(100,'K'), Tmax=(1296.88,'K')), NASAPolynomial(coeffs=[18.5385,0.0596339,-2.49307e-05,4.59192e-09,-3.15378e-13,-7741.69,-58.6217], Tmin=(1296.88,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-22.467,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(644.372,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCsJOCs) + radical(CCJCO)"""),
)

species(
    label = '[CH2]C(CC)OCC[CH]CC(11710)',
    ...
    molecularWeight = (142.239,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.676508,0.11809,-7.81421e-05,-2.85069e-08,5.85457e-11,411.28,41.1612], Tmin=(100,'K'), Tmax=(526.414,'K')), NASAPolynomial(coeffs=[7.76722,0.0785795,-3.57976e-05,6.81983e-09,-4.76226e-13,-819.239,2.59917], Tmin=(526.414,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(2.14332,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(644.372,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJC(C)OC) + radical(RCCJCC)"""),
)

species(
    label = '[CH2]C(CC)OCCC[CH]C(11711)',
    ...
    molecularWeight = (142.239,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.53298,0.130469,-0.000138786,9.5994e-08,-2.92076e-11,447.598,44.2349], Tmin=(100,'K'), Tmax=(777.927,'K')), NASAPolynomial(coeffs=[8.99857,0.0763184,-3.43755e-05,6.51934e-09,-4.54214e-13,-1191,-3.92928], Tmin=(777.927,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(2.1313,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(644.372,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJC(C)OC) + radical(RCCJC)"""),
)

species(
    label = '[CH2]C([CH]C)OCCCCC(11712)',
    structure = SMILES('[CH2]C([CH]C)OCCCCC'),
    E0 = (7.58707,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,3025,407.5,1350,352.5,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2]CC(C)O[CH]CCCC(11713)',
    ...
    molecularWeight = (142.239,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.59594,0.124954,-0.000105454,4.94703e-08,-9.82161e-12,-1859.58,43.1851], Tmin=(100,'K'), Tmax=(1169.87,'K')), NASAPolynomial(coeffs=[16.1248,0.0643644,-2.77657e-05,5.199e-09,-3.60928e-13,-6005.79,-45.0874], Tmin=(1169.87,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-17.1227,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(644.372,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJ) + radical(CCsJOCs)"""),
)

species(
    label = 'CCC[CH][CH]OC(C)CC(11714)',
    structure = SMILES('CCC[CH][CH]OC(C)CC'),
    E0 = (-22.467,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (142.239,'amu'),
...
species(
    ...
    molecularWeight = (142.239,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.51323,0.128826,-0.000121976,6.89479e-08,-1.69122e-11,1747.44,43.2172], Tmin=(100,'K'), Tmax=(952.767,'K')), NASAPolynomial(coeffs=[12.0693,0.0718029,-3.22007e-05,6.13116e-09,-4.29577e-13,-840.778,-21.6537], Tmin=(952.767,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(12.9314,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(644.372,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJC(C)OC) + radical(RCCJ)"""),
)

species(
    label = '[CH2]CC([CH2])OCCCCC(11716)',
    structure = SMILES('[CH2]CC([CH2])OCCCCC'),
    E0 = (12.9314,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2761.11,2772.22,2783.33,2794.44,2805.56,2816.67,2827.78,2838.89,2850,1425,1431.25,1437.5,1443.75,1450,1225,1237.5,1250,1262.5,1275,1270,1287.5,1305,1322.5,1340,700,725,750,775,800,300,325,350,375,400,1380,1390,370,380,2900,435,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'CC[CH]C[CH]OC(C)CC(11717)',
    structure = SMILES('CC[CH]C[CH]OC(C)CC'),
    E0 = (-27.9108,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (142.239,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.23969,0.122738,-0.000110803,6.12874e-08,-1.50075e-11,-3174.55,42.7063], Tmin=(100,'K'), Tmax=(944.783,'K')), NASAPolynomial(coeffs=[10.372,0.0735774,-3.27524e-05,6.213e-09,-4.34358e-13,-5368.68,-12.6541], Tmin=(944.783,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-27.9108,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(644.372,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCsJOCs) + radical(RCCJCC)"""),
)

species(
    label = 'C[CH]CC[CH]OC(C)CC(11718)',
    ...
    molecularWeight = (142.239,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.29892,0.122637,-0.000107441,5.59518e-08,-1.27373e-11,-3172.63,43.0829], Tmin=(100,'K'), Tmax=(1015.5,'K')), NASAPolynomial(coeffs=[11.8115,0.0709967,-3.11623e-05,5.87587e-09,-4.09511e-13,-5835.35,-20.3688], Tmin=(1015.5,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-27.9228,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(644.372,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJC) + radical(CCsJOCs)"""),
)

species(
    label = '[CH2]CCC[CH]OC(C)CC(11719)',
...
species(
    label = 'C=C(CC)OCCCCC(11720)',
    structure = SMILES('C=C(CC)OCCCCC'),
    E0 = (-321.285,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (142.239,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.10044,0.117603,-7.73383e-05,1.95925e-08,1.07694e-13,-38408.1,42.2395], Tmin=(100,'K'), Tmax=(1134.25,'K')), NASAPolynomial(coeffs=[22.8459,0.0521546,-2.0575e-05,3.7386e-09,-2.57167e-13,-45516.2,-87.6422], Tmin=(1134.25,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-321.285,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(648.529,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH)"""),
)

species(
    label = 'CCCC=COC(C)CC(11721)',
    structure = SMILES('CCCC=COC(C)CC'),
    E0 = (-328.162,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (142.239,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.00829,0.111079,-4.43897e-05,-2.47279e-08,1.8214e-11,-39233.8,41.356], Tmin=(100,'K'), Tmax=(999.51,'K')), NASAPolynomial(coeffs=[25.303,0.0475189,-1.76439e-05,3.21619e-09,-2.26887e-13,-46978.1,-101.821], Tmin=(999.51,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-328.162,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(648.529,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH)"""),
)
...
species(
    label = '[CH2]C(CC)OC([CH2])CCC(11724)',
    ...
    molecularWeight = (142.239,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.02641,0.140111,-0.000149085,9.3259e-08,-2.46238e-11,1129.88,42.6797], Tmin=(100,'K'), Tmax=(902.726,'K')), NASAPolynomial(coeffs=[14.0589,0.0688382,-3.06597e-05,5.80389e-09,-4.04807e-13,-1774.33,-33.2771], Tmin=(902.726,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(7.64418,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(644.372,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + longDistanceInteraction_noncyclic(OsCs-ST) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJC(C)OC) + radical(CJC(C)OC)"""),
)

species(
    label = 'CCCCC1CC(CC)O1(10730)',
    structure = SMILES('CCCCC1CC(CC)O1'),
    E0 = (-264.287,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (142.239,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.03706,0.0931039,-1.10763e-05,-4.86586e-08,2.5469e-11,-31589.1,36.9407], Tmin=(100,'K'), Tmax=(955.928,'K')), NASAPolynomial(coeffs=[17.9469,0.0559689,-1.91836e-05,3.2877e-09,-2.22963e-13,-37151.3,-63.8996], Tmin=(955.928,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-264.287,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(656.843,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Oxetane)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(CC)O[CH]CCCC(11668)'],
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'C=C(CC)O[CH]CCCC(11704)'],
    products = ['[CH2]C(CC)O[CH]CCCC(11668)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', '[CH2]C(CC)OC=CCCC(11705)'],
    products = ['[CH2]C(CC)O[CH]CCCC(11668)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['C2H5(29)', 'C=CO[CH]CCCC(10647)'],
    products = ['[CH2]C(CC)O[CH]CCCC(11668)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['npropyl(83)', '[CH2]C(CC)OC=C(2017)'],
    products = ['[CH2]C(CC)O[CH]CCCC(11668)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2]C(CC)O[CH]CCCC(11668)'],
    products = ['CCCC[CH]O[C](C)CC(11706)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]C(CC)OC[CH]CCC(11707)'],
    products = ['[CH2]C(CC)O[CH]CCCC(11668)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]C(CC)O[CH]CCCC(11668)'],
    products = ['[CH2][C](CC)OCCCCC(11708)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]C(CC)O[CH]CCCC(11668)'],
    products = ['C[CH]C(C)O[CH]CCCC(11709)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]C(CC)OCC[CH]CC(11710)'],
    products = ['[CH2]C(CC)O[CH]CCCC(11668)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]C(CC)OCCC[CH]C(11711)'],
    products = ['[CH2]C(CC)O[CH]CCCC(11668)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2]C([CH]C)OCCCCC(11712)'],
    products = ['[CH2]C(CC)O[CH]CCCC(11668)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]C(CC)O[CH]CCCC(11668)'],
    products = ['[CH2]CC(C)O[CH]CCCC(11713)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]C(CC)O[CH]CCCC(11668)'],
    products = ['CCC[CH][CH]OC(C)CC(11714)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]CCCCOC([CH2])CC(11715)'],
    products = ['[CH2]C(CC)O[CH]CCCC(11668)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]CC([CH2])OCCCCC(11716)'],
    products = ['[CH2]C(CC)O[CH]CCCC(11668)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2]C(CC)O[CH]CCCC(11668)'],
    products = ['CC[CH]C[CH]OC(C)CC(11717)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2]C(CC)O[CH]CCCC(11668)'],
    products = ['C[CH]CC[CH]OC(C)CC(11718)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2]C(CC)O[CH]CCCC(11668)'],
    products = ['[CH2]CCC[CH]OC(C)CC(11719)'],
...
reaction(
    label = 'reaction24',
    reactants = ['CH2(S)(23)', '[CH2]C(CC)O[CH]CCC(11722)'],
    products = ['[CH2]C(CC)O[CH]CCCC(11668)'],
...
reaction(
    label = 'reaction25',
    reactants = ['CH2(S)(23)', '[CH2]C(C)O[CH]CCCC(11276)'],
    products = ['[CH2]C(CC)O[CH]CCCC(11668)'],
...
reaction(
    label = 'reaction27',
    reactants = ['[CH2]C(CC)OC([CH2])CCC(11724)'],
    products = ['[CH2]C(CC)O[CH]CCCC(11668)'],
...
reaction(
    label = 'reaction29',
    reactants = ['[CH]CCCC(141)', '[CH2]C([O])CC(1666)'],
    products = ['[CH2]C(CC)O[CH]CCCC(11668)'],
...
reaction(
    label = 'reaction30',
    reactants = ['CH2(19)', 'CC[CH]O[CH]CCCC(10789)'],
    products = ['[CH2]C(CC)O[CH]CCCC(11668)'],
