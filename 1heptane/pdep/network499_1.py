...
species(
    ...
    E0 = (-5.10465,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,360,370,350,180,1736.95,1737.63],'cm^-1')),
        HinderedRotor(inertia=(0.19979,'amu*angstrom^2'), symmetry=1, barrier=(4.59356,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.199406,'amu*angstrom^2'), symmetry=1, barrier=(4.58474,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.19876,'amu*angstrom^2'), symmetry=1, barrier=(4.56987,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (74.0785,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.32039,0.0428941,-5.74364e-05,5.83471e-08,-2.42479e-11,-559.297,19.889], Tmin=(100,'K'), Tmax=(792.595,'K')), NASAPolynomial(coeffs=[1.2777,0.034884,-1.71594e-05,3.34221e-09,-2.34361e-13,22.8756,27.3069], Tmin=(792.595,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-5.10465,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(Cs_P) + radical(CCOJ)"""),
)

species(
    label = '[CH2]OC([CH2])O(967)',
    ...
    molecularWeight = (74.0785,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.82117,0.0495591,-5.15254e-05,2.93896e-08,-6.9003e-12,-4324.38,21.5655], Tmin=(100,'K'), Tmax=(1018.8,'K')), NASAPolynomial(coeffs=[9.12124,0.0208981,-9.32798e-06,1.77756e-09,-1.24775e-13,-5811.87,-13.7892], Tmin=(1018.8,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-36.5961,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(CJCO) + radical(CsJOCH3)"""),
)

species(
    label = '[CH2]C([O])OC(2200)',
    structure = SMILES('[CH2]C([O])OC'),
    E0 = (1.23808,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,180,886.979,1724.96],'cm^-1')),
        HinderedRotor(inertia=(0.149836,'amu*angstrom^2'), symmetry=1, barrier=(3.44501,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.149707,'amu*angstrom^2'), symmetry=1, barrier=(3.44206,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.151255,'amu*angstrom^2'), symmetry=1, barrier=(3.47766,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (74.0785,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.70063,0.0306887,-1.46019e-05,2.6804e-09,-1.70254e-13,133.531,14.7233], Tmin=(100,'K'), Tmax=(3044.33,'K')), NASAPolynomial(coeffs=[39.5587,-0.0101868,2.4641e-06,-3.83633e-10,2.60812e-14,-24590.4,-202.94], Tmin=(3044.33,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(1.23808,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(CJCO) + radical(CCOJ)"""),
)
...
species(
    ...
    molecularWeight = (74.0785,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.75062,0.0220813,1.21742e-05,-2.19213e-08,7.33618e-12,-51179.4,16.5002], Tmin=(100,'K'), Tmax=(1154.02,'K')), NASAPolynomial(coeffs=[5.62528,0.02611,-1.12501e-05,2.11765e-09,-1.47683e-13,-52774.6,-1.81702], Tmin=(1154.02,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-425.94,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-(Cds-O2d)HHH) + group(Cs-OsHHH) + group(Cds-OdCsOs)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]OC(C)[O](952)'],
    products = ['CH2O(15)', 'CH3CHO(37)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', '[CH2]OC(C)=O(2197)'],
    products = ['[CH2]OC(C)[O](952)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2][O](167)', 'C[CH][O](176)'],
    products = ['[CH2]OC(C)[O](952)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['CH2(S)(23)', '[CH2]OC[O](933)'],
    products = ['[CH2]OC(C)[O](952)'],
