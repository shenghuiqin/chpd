...
species(
    label = '[CH]=C(O)OC1CCC1[O](31355)',
    structure = SMILES('[CH]=C(O)OC1CCC1[O]'),
    E0 = (60.3165,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.126,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.532378,0.0797079,-2.94141e-05,-3.56384e-08,2.38478e-11,7435.8,30.3261], Tmin=(100,'K'), Tmax=(948.912,'K')), NASAPolynomial(coeffs=[26.6145,0.0143015,-3.52309e-06,6.20477e-10,-5.00573e-14,76.4965,-110.849], Tmin=(948.912,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(60.3165,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(394.937,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + ring(Cyclobutane) + radical(CC(C)OJ) + radical(Cds_P)"""),
)
...
species(
    label = '[CH]=C(O)OC=CCC=O(31357)',
    structure = SMILES('[CH]=C(O)OC=CCC=O'),
    E0 = (-75.5148,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,3615,1277.5,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,350,440,435,1725,2750,2850,1437.5,1250,1305,750,350,2782.5,750,1395,475,1775,1000,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.264177,0.0865292,-8.16087e-05,3.74292e-08,-6.75614e-12,-8922.88,32.8464], Tmin=(100,'K'), Tmax=(1337.14,'K')), NASAPolynomial(coeffs=[20.8581,0.0233421,-1.07249e-05,2.08783e-09,-1.48432e-13,-14571.5,-75.1929], Tmin=(1337.14,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-75.5148,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(Cds-CdsCsH) + group(Cds-CdsCsCs) + group(Cds-CdsOsH) + group(Cds-OdCsH) + group(Cds-CdsHH) + radical(Cds_P)"""),
)
...
species(
    label = '[CH]=C(O)OC[CH]CC=O(31358)',
    structure = SMILES('[CH]=C(O)OC[CH]CC=O'),
    E0 = (-26.0054,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,3025,407.5,1350,352.5,3615,1277.5,1000,350,440,435,1725,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2782.5,750,1395,475,1775,1000,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (128.126,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.729618,0.102315,-0.000118279,6.95178e-08,-1.60588e-11,-2955.84,34.8715], Tmin=(100,'K'), Tmax=(1060.01,'K')), NASAPolynomial(coeffs=[19.3685,0.0264731,-1.0957e-05,2.0202e-09,-1.39713e-13,-7216.67,-63.2616], Tmin=(1060.01,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-26.0054,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsCs) + group(Cds-OdCsH) + group(Cds-CdsHH) + radical(Cds_P) + radical(CCJCO)"""),
)

species(
    label = '[CH]=C(O)OCC[CH]C=O(31359)',
    structure = SMILES('[CH]=C(O)OCCC=C[O]'),
    E0 = (-82.6558,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.126,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.0534,0.109475,-0.000118014,5.99502e-08,-1.13763e-11,-9703,36.8425], Tmin=(100,'K'), Tmax=(1456.27,'K')), NASAPolynomial(coeffs=[29.7487,0.00879236,-5.76723e-07,-9.71202e-11,1.1158e-14,-17552,-123.685], Tmin=(1456.27,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-82.6558,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsCs) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(Cds_P) + radical(C=COJ)"""),
)
...
species(
    ...
    opticalIsomers = 1,
    molecularWeight = (128.126,'amu'),
    collisionModel = TransportData(shapeIndex=2, epsilon=(3997.16,'J/mol'), sigma=(6.55197,'angstroms'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with Tc=624.35 K, Pc=32.25 bar (from Joback method)"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
...
species(
    ...
    molecularWeight = (128.126,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.965911,0.110086,-0.000140354,9.10067e-08,-2.3096e-11,-7753.42,34.0447], Tmin=(100,'K'), Tmax=(969.218,'K')), NASAPolynomial(coeffs=[19.2944,0.0264706,-1.09464e-05,1.99507e-09,-1.36269e-13,-11680.7,-63.0661], Tmin=(969.218,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-65.9468,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsCs) + group(Cds-OdCsH) + group(Cds-CdsHH) + radical(CCCJ=O) + radical(Cds_P)"""),
)
...
species(
    label = '[CH]=C(O)OC1CC[CH]O1(31361)',
    structure = SMILES('[CH]=C(O)OC1CC[CH]O1'),
    E0 = (-57.3136,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.126,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.44608,0.101783,-0.000101352,4.87051e-08,-8.53857e-12,-6626.51,34.3475], Tmin=(100,'K'), Tmax=(1702.9,'K')), NASAPolynomial(coeffs=[24.5307,0.0118272,1.30722e-06,-6.53733e-10,5.38149e-14,-11959,-98.8409], Tmin=(1702.9,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-57.3136,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(394.937,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + ring(Tetrahydrofuran) + radical(CCsJOCs) + radical(Cds_P)"""),
)
...
species(
    label = '[CH]=C(O)OC([CH2])CC=O(31363)',
    structure = SMILES('[CH]=C(O)OC([CH2])CC=O'),
    E0 = (-28.0403,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,3615,1277.5,1000,3000,3100,440,815,1455,1000,1380,1390,370,380,2900,435,350,440,435,1725,2750,2850,1437.5,1250,1305,750,350,2782.5,750,1395,475,1775,1000,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (128.126,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.25278,0.117748,-0.000157918,1.06745e-07,-2.81519e-11,-3185.2,33.6645], Tmin=(100,'K'), Tmax=(934.361,'K')), NASAPolynomial(coeffs=[20.0964,0.0263517,-1.11913e-05,2.05452e-09,-1.40426e-13,-7174.75,-67.8836], Tmin=(934.361,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-28.0403,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsOsH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-OdCsH) + group(Cds-CdsHH) + radical(CJC(C)OC) + radical(Cds_P)"""),
)
...
species(
    label = '[CH]=C(O)O[CH]COC=C(31365)',
    structure = SMILES('[CH]=C(O)O[CH]COC=C'),
    E0 = (9.6164,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,3615,1277.5,1000,2950,3100,1380,975,1025,1650,350,440,435,1725,2750,2850,1437.5,1250,1305,750,350,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (128.126,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.88881,0.127528,-0.000152909,8.36489e-08,-1.68798e-11,1425.25,36.639], Tmin=(100,'K'), Tmax=(1381.72,'K')), NASAPolynomial(coeffs=[34.7179,0.0011836,3.22154e-06,-8.35737e-10,6.24897e-14,-7299.04,-150.915], Tmin=(1381.72,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(9.6164,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsCs) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(CCsJOC(O)) + radical(Cds_P)"""),
)

species(
    label = '[CH]=C(O)O[CH]CC=CO(31366)',
    structure = SMILES('[CH]=C(O)O[CH]CC=CO'),
    E0 = (-30.191,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,3025,407.5,1350,352.5,3580,3650,1210,1345,900,1100,2995,3025,975,1000,1300,1375,400,500,1630,1680,350,440,435,1725,2750,2850,1437.5,1250,1305,750,350,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (128.126,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.90734,0.126939,-0.000153123,8.40492e-08,-1.69451e-11,-3360.94,37.9567], Tmin=(100,'K'), Tmax=(1397.35,'K')), NASAPolynomial(coeffs=[34.5454,8.73114e-05,4.1315e-06,-1.03528e-09,7.70073e-14,-11910.3,-148.401], Tmin=(1397.35,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-30.191,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsCs) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(Cds_P) + radical(CCsJOC(O))"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[CH]=C(O)O[CH]CCC=O(21588)'],
    products = ['[CH]=C(O)OC1CCC1[O](31355)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', '[CH]=C(O)OC=CCC=O(31357)'],
    products = ['[CH]=C(O)O[CH]CCC=O(21588)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['CH2CHO(40)', '[CH]=C(O)OC=C(16328)'],
    products = ['[CH]=C(O)O[CH]CCC=O(21588)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['OH(5)', 'C#CO[CH]CCC=O(21985)'],
    products = ['[CH]=C(O)O[CH]CCC=O(21588)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH]=C(O)OC[CH]CC=O(31358)'],
    products = ['[CH]=C(O)O[CH]CCC=O(21588)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH]=C(O)O[CH]CCC=O(21588)'],
    products = ['[CH]=C(O)OCC[CH]C=O(31359)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['[CH]=C(O)O[CH]CCC=O(21588)'],
    products = ['[CH]=C(O)OCCC[C]=O(31360)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH]=C(O)O[CH]CCC=O(21588)'],
    products = ['C=C(O)O[CH][CH]CC=O(21590)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH]=C(O)O[CH]CCC=O(21588)'],
    products = ['C=C(O)O[CH]C[CH]C=O(21591)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH]=C(O)O[CH]CCC=O(21588)'],
    products = ['C=C(O)O[CH]CC[C]=O(21592)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH]=C(O)O[CH]CCC=O(21588)'],
    products = ['[CH]=C(O)OC1CC[CH]O1(31361)'],
...
reaction(
    label = 'reaction20',
    reactants = ['CO(12)', '[CH]=C(O)O[CH]CC(11066)'],
    products = ['[CH]=C(O)O[CH]CCC=O(21588)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH]=C(O)OC([CH2])CC=O(31363)'],
    products = ['[CH]=C(O)O[CH]CCC=O(21588)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH]=C(O)O[CH]COC=C(31365)'],
    products = ['[CH]=C(O)O[CH]CCC=O(21588)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[CH]=C(O)O[CH]CC=CO(31366)'],
    products = ['[CH]=C(O)O[CH]CCC=O(21588)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[CH]=C([O])O(7862)', '[CH]CCC=O(18484)'],
    products = ['[CH]=C(O)O[CH]CCC=O(21588)'],
