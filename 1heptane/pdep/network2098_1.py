...
species(
    label = 'C[CH]COC=CCCC(11278)',
    structure = SMILES('C[CH]COC=CCCC'),
    E0 = (-91.8365,'kJ/mol'),
    modes = [
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.06737,0.0921092,-2.88163e-05,-3.28627e-08,2.04207e-11,-10845.7,38.5752], Tmin=(100,'K'), Tmax=(982.577,'K')), NASAPolynomial(coeffs=[22.9988,0.0381693,-1.36908e-05,2.48207e-09,-1.7619e-13,-17700.6,-87.9234], Tmin=(982.577,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-91.8365,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(552.912,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(CCJCO)"""),
)

species(
    label = 'CC=CO[CH]CCCC(11279)',
    structure = SMILES('CC=CO[CH]CCCC'),
    E0 = (-98.9459,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (127.204,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.72765,0.110824,-7.9926e-05,1.83474e-08,2.6587e-12,-11681,37.2548], Tmin=(100,'K'), Tmax=(1017.98,'K')), NASAPolynomial(coeffs=[24.1158,0.037651,-1.39165e-05,2.49967e-09,-1.73711e-13,-18412.9,-95.107], Tmin=(1017.98,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-98.9459,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(552.912,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(CCsJOC(O))"""),
)
...
species(
    label = '[CH2]CCO[CH]CCCC(11281)',
    structure = SMILES('[CH2]CCO[CH]CCCC'),
    E0 = (17.2085,'kJ/mol'),
    modes = [
...
species(
    label = 'C[CH]COCC[CH]CC(11282)',
    structure = SMILES('C[CH]COCC[CH]CC'),
    E0 = (25.8665,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3000,3050,390,425,1340,1360,335,370,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'C[CH]CCCOC[CH]C(11283)',
    structure = SMILES('C[CH]CCCOC[CH]C'),
    E0 = (25.8544,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3000,3050,390,425,1340,1360,335,370,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2]CCCCOC[CH]C(11284)',
    structure = SMILES('[CH2]CCCCOC[CH]C'),
    E0 = (36.6545,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2761.11,2772.22,2783.33,2794.44,2805.56,2816.67,2827.78,2838.89,2850,1425,1431.25,1437.5,1443.75,1450,1225,1237.5,1250,1262.5,1275,1270,1287.5,1305,1322.5,1340,700,725,750,775,800,300,325,350,375,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,3025,407.5,1350,352.5,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2][CH]COCCCCC(11285)',
    structure = SMILES('[CH2][CH]COCCCCC'),
    E0 = (36.6545,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2761.11,2772.22,2783.33,2794.44,2805.56,2816.67,2827.78,2838.89,2850,1425,1431.25,1437.5,1443.75,1450,1225,1237.5,1250,1262.5,1275,1270,1287.5,1305,1322.5,1340,700,725,750,775,800,300,325,350,375,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,3025,407.5,1350,352.5,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'CC[CH]C[CH]OCCC(11286)',
    structure = SMILES('CC[CH]C[CH]OCCC'),
    E0 = (6.42042,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.212,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.751887,0.112061,-0.00011478,7.71475e-08,-2.30519e-11,936.497,39.0527], Tmin=(100,'K'), Tmax=(787.911,'K')), NASAPolynomial(coeffs=[7.97447,0.0677563,-3.04276e-05,5.76925e-09,-4.02175e-13,-438.51,-0.966146], Tmin=(787.911,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(6.42042,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(573.699,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCsJOCs) + radical(RCCJCC)"""),
)

species(
    label = 'C[CH]CC[CH]OCCC(11287)',
    structure = SMILES('C[CH]CC[CH]OCCC'),
    E0 = (6.40839,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.212,'amu'),
...
species(
    label = '[CH2]CCC[CH]OCCC(11288)',
    structure = SMILES('[CH2]CCC[CH]OCCC'),
    E0 = (17.2085,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2761.11,2772.22,2783.33,2794.44,2805.56,2816.67,2827.78,2838.89,2850,1425,1431.25,1437.5,1443.75,1450,1225,1237.5,1250,1262.5,1275,1270,1287.5,1305,1322.5,1340,700,725,750,775,800,300,325,350,375,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,3025,407.5,1350,352.5,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'C=CCOCCCCC(11289)',
    structure = SMILES('C=CCOCCCCC'),
    E0 = (-235.155,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.212,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.180809,0.0945822,-6.09809e-05,2.04618e-08,-2.93766e-12,-28135.4,35.8108], Tmin=(100,'K'), Tmax=(1506.93,'K')), NASAPolynomial(coeffs=[13.316,0.0587563,-2.53198e-05,4.68531e-09,-3.20343e-13,-32203.1,-34.8381], Tmin=(1506.93,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-235.155,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(577.856,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH)"""),
)
...
species(
    label = 'C[CH]CO[CH]CCC(11290)',
    structure = SMILES('C[CH]CO[CH]CCC'),
    E0 = (35.6444,'kJ/mol'),
    modes = [
...
reaction(
    label = 'reaction1',
    reactants = ['C[CH]CO[CH]CCCC(11274)'],
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'C[CH]COC=CCCC(11278)'],
    products = ['C[CH]CO[CH]CCCC(11274)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'CC=CO[CH]CCCC(11279)'],
    products = ['C[CH]CO[CH]CCCC(11274)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', 'C=CCO[CH]CCCC(11280)'],
    products = ['C[CH]CO[CH]CCCC(11274)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['npropyl(83)', 'C=COC[CH]C(1237)'],
    products = ['C[CH]CO[CH]CCCC(11274)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]CCO[CH]CCCC(11281)'],
    products = ['C[CH]CO[CH]CCCC(11274)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['C[CH]COCC[CH]CC(11282)'],
    products = ['C[CH]CO[CH]CCCC(11274)'],
...
reaction(
    label = 'reaction12',
    reactants = ['C[CH]CCCOC[CH]C(11283)'],
    products = ['C[CH]CO[CH]CCCC(11274)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]CCCCOC[CH]C(11284)'],
    products = ['C[CH]CO[CH]CCCC(11274)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2][CH]COCCCCC(11285)'],
    products = ['C[CH]CO[CH]CCCC(11274)'],
...
reaction(
    label = 'reaction16',
    reactants = ['C[CH]CO[CH]CCCC(11274)'],
    products = ['CC[CH]C[CH]OCCC(11286)'],
...
reaction(
    label = 'reaction17',
    reactants = ['C[CH]CO[CH]CCCC(11274)'],
    products = ['C[CH]CC[CH]OCCC(11287)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2]CCC[CH]OCCC(11288)'],
    products = ['C[CH]CO[CH]CCCC(11274)'],
...
reaction(
    label = 'reaction23',
    reactants = ['CH2(S)(23)', 'C[CH]CO[CH]CCC(11290)'],
    products = ['C[CH]CO[CH]CCCC(11274)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[CH]CCCC(141)', 'C[CH]C[O](561)'],
    products = ['C[CH]CO[CH]CCCC(11274)'],
...
reaction(
    label = 'reaction27',
    reactants = ['CHCH3(T)(95)', '[CH2]O[CH]CCCC(1766)'],
    products = ['C[CH]CO[CH]CCCC(11274)'],
