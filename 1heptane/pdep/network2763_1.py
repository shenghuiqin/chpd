species(
    label = 'CCCCC([O])C([O])O(13397)',
    structure = SMILES('CCCCC([O])C([O])O'),
    E0 = (-268.328,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1277.5,1000,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,200,800,1000,1200,1400,1600],'cm^-1')),
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0769865,0.0971549,-9.72931e-05,5.99831e-08,-1.62794e-11,-32132,37.6437], Tmin=(100,'K'), Tmax=(861.809,'K')), NASAPolynomial(coeffs=[8.70528,0.0563945,-2.63513e-05,5.10701e-09,-3.61121e-13,-33645.8,-3.41995], Tmin=(861.809,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-268.328,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(482.239,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + radical(CCOJ) + radical(CC(C)OJ)"""),
)
...
species(
    label = 'CCCCC(=O)C([O])O(14633)',
    structure = SMILES('CCCCC(=O)C([O])O'),
    E0 = (-421.926,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2800,2850,1350,1500,750,1050,1375,1000,375,552.5,462.5,1710,3615,1277.5,1000,1380,1390,370,380,2900,435,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.258235,0.0925116,-8.75593e-05,3.08813e-08,8.91794e-12,-50620.9,35.5999], Tmin=(100,'K'), Tmax=(570.272,'K')), NASAPolynomial(coeffs=[8.03463,0.0533188,-2.48515e-05,4.78157e-09,-3.35606e-13,-51757.5,0.262086], Tmin=(570.272,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-421.926,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cds-OdCsCs) + radical(C=OCOJ)"""),
)

species(
    label = 'CCCCC([O])C(=O)O(14634)',
    structure = SMILES('CCCCC([O])C(=O)O'),
    E0 = (-466.499,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1277.5,1000,1380,1390,370,380,2900,435,200,800,914.286,1028.57,1142.86,1257.14,1371.43,1485.71,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (131.15,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.228165,0.0829139,-5.8153e-05,2.05063e-08,-2.92797e-12,-55946.5,38.2232], Tmin=(100,'K'), Tmax=(1625.56,'K')), NASAPolynomial(coeffs=[19.0021,0.0355947,-1.44894e-05,2.59938e-09,-1.74047e-13,-62198.6,-63.8953], Tmin=(1625.56,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-466.499,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-O2d)H) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cds-OdCsOs) + radical(C=OCOJ)"""),
)
...
species(
    label = 'CCCC[C](O)C([O])O(14635)',
    structure = SMILES('CCCC[C](O)C([O])O'),
    E0 = (-322.06,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (132.158,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.787068,0.114937,-0.000160061,1.364e-07,-4.76892e-11,-38571.8,39.7815], Tmin=(100,'K'), Tmax=(799.633,'K')), NASAPolynomial(coeffs=[8.29522,0.0566593,-2.66436e-05,5.07871e-09,-3.51582e-13,-39613.7,0.563459], Tmin=(799.633,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-322.06,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(478.082,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + radical(CCOJ) + radical(C2CsJOH)"""),
)

species(
    label = 'CCCCC([O])[C](O)O(14636)',
    structure = SMILES('CCCCC([O])[C](O)O'),
    E0 = (-288.786,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (132.158,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.475069,0.101736,-0.000100383,5.4971e-08,-1.25215e-11,-34574.5,38.1905], Tmin=(100,'K'), Tmax=(1042.39,'K')), NASAPolynomial(coeffs=[13.9862,0.0462436,-2.05302e-05,3.90125e-09,-2.73378e-13,-37589.4,-32.1772], Tmin=(1042.39,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-288.786,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(478.082,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + radical(Cs_P) + radical(CC(C)OJ)"""),
)

species(
    label = 'CCC[CH]C(O)C([O])O(14637)',
    structure = SMILES('CCC[CH]C(O)C([O])O'),
    E0 = (-298.786,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,3580,3650,1210,1345,900,1100,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (132.158,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0720756,0.0962993,-9.60628e-05,5.77266e-08,-1.50737e-11,-35794.8,40.3112], Tmin=(100,'K'), Tmax=(898.575,'K')), NASAPolynomial(coeffs=[9.53627,0.0535272,-2.4662e-05,4.75245e-09,-3.35086e-13,-37521.6,-5.01586], Tmin=(898.575,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-298.786,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(478.082,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + radical(CCJCO) + radical(CCOJ)"""),
)

species(
    label = 'CCCCC(O)[C]([O])O(14638)',
    structure = SMILES('CCCCC(O)[C]([O])O'),
    E0 = (-293.442,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (132.158,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.39039,0.10424,-0.000122629,9.01356e-08,-2.8452e-11,-35141.9,39.6388], Tmin=(100,'K'), Tmax=(757.58,'K')), NASAPolynomial(coeffs=[8.86503,0.0553701,-2.58629e-05,4.97893e-09,-3.49404e-13,-36544.2,-2.44338], Tmin=(757.58,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-293.442,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(478.082,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + radical(Cs_P) + radical(CCOJ)"""),
)

species(
    label = 'CCCC[C]([O])C(O)O(14639)',
    structure = SMILES('CCCC[C]([O])C(O)O'),
    E0 = (-317.405,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (132.158,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.717688,0.110221,-0.000128172,8.59335e-08,-2.39439e-11,-38010.8,37.8061], Tmin=(100,'K'), Tmax=(863.459,'K')), NASAPolynomial(coeffs=[12.4242,0.0493386,-2.24041e-05,4.26856e-09,-2.9834e-13,-40280.2,-23.666], Tmin=(863.459,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-317.405,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(478.082,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(C2CsJOH)"""),
)

species(
    label = 'CC[CH]CC(O)C([O])O(14640)',
    ...
    molecularWeight = (132.158,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.37608,0.106657,-0.000146943,1.30393e-07,-4.74622e-11,-36442.9,41.4446], Tmin=(100,'K'), Tmax=(808.734,'K')), NASAPolynomial(coeffs=[5.29007,0.060732,-2.85641e-05,5.44151e-09,-3.7636e-13,-36774,18.9307], Tmin=(808.734,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-304.23,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(478.082,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(CCOJ)"""),
)

species(
    label = 'CCC[CH]C([O])C(O)O(14641)',
    structure = SMILES('CCC[CH]C([O])C(O)O'),
    E0 = (-294.131,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,3580,3650,1210,1345,900,1100,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,200,800,1066.67,1333.33,1600],'cm^-1')),
    ...
    molecularWeight = (132.158,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.475357,0.0977693,-8.87156e-05,4.33585e-08,-8.72519e-12,-35214.1,39.9906], Tmin=(100,'K'), Tmax=(1176.59,'K')), NASAPolynomial(coeffs=[15.7916,0.042467,-1.82124e-05,3.41068e-09,-2.37142e-13,-39042,-41.1336], Tmin=(1176.59,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-294.131,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(478.082,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + radical(CCJCO) + radical(CC(C)OJ)"""),
)

species(
    label = 'CCCCC(O)C([O])[O](14642)',
    structure = SMILES('CCCCC(O)C([O])[O]'),
    E0 = (-272.983,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (132.158,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.253788,0.103281,-0.00013489,1.19226e-07,-4.45306e-11,-32688.5,38.6094], Tmin=(100,'K'), Tmax=(776.266,'K')), NASAPolynomial(coeffs=[4.70366,0.063485,-3.04524e-05,5.88346e-09,-4.11505e-13,-33028.8,18.7139], Tmin=(776.266,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-272.983,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(482.239,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + radical(CCOJ) + radical(CCOJ)"""),
)

species(
    label = 'C[CH]CCC(O)C([O])O(14643)',
    ...
    molecularWeight = (132.158,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.402628,0.106042,-0.000141203,1.2121e-07,-4.3242e-11,-36442.2,41.7127], Tmin=(100,'K'), Tmax=(799.004,'K')), NASAPolynomial(coeffs=[6.33741,0.0588618,-2.74028e-05,5.20909e-09,-3.60417e-13,-37090.3,13.3925], Tmin=(799.004,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-304.242,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(478.082,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + radical(CCOJ) + radical(RCCJC)"""),
)

species(
    label = 'CC[CH]CC([O])C(O)O(14644)',
    structure = SMILES('CC[CH]CC([O])C(O)O'),
    E0 = (-299.574,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (132.158,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.339831,0.102328,-0.000116406,8.17244e-08,-2.45341e-11,-35880.4,39.5883], Tmin=(100,'K'), Tmax=(795.953,'K')), NASAPolynomial(coeffs=[9.37719,0.0534956,-2.43792e-05,4.64533e-09,-3.24348e-13,-37427.3,-5.07313], Tmin=(795.953,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-299.574,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(478.082,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(CC(C)OJ)"""),
)

species(
    label = '[CH2]CCCC(O)C([O])O(14645)',
    ...
    molecularWeight = (132.158,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.39039,0.10424,-0.000122629,9.01356e-08,-2.8452e-11,-35141.9,40.7374], Tmin=(100,'K'), Tmax=(757.58,'K')), NASAPolynomial(coeffs=[8.86503,0.0553701,-2.58629e-05,4.97893e-09,-3.49404e-13,-36544.2,-1.34476], Tmin=(757.58,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-293.442,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(478.082,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + radical(RCCJ) + radical(CCOJ)"""),
)

species(
    label = 'C[CH]CCC([O])C(O)O(14646)',
    structure = SMILES('C[CH]CCC([O])C(O)O'),
    E0 = (-299.586,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (132.158,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.326306,0.101239,-0.000108989,7.02731e-08,-1.92676e-11,-35881.4,39.7126], Tmin=(100,'K'), Tmax=(868.6,'K')), NASAPolynomial(coeffs=[10.465,0.0515428,-2.31641e-05,4.39905e-09,-3.0718e-13,-37756,-10.8284], Tmin=(868.6,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-299.586,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(478.082,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(RCCJC)"""),
)

species(
    label = '[CH2]CCCC([O])C(O)O(14647)',
    structure = SMILES('[CH2]CCCC([O])C(O)O'),
    E0 = (-288.786,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (132.158,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.475071,0.101736,-0.000100383,5.49711e-08,-1.25215e-11,-34574.5,39.2891], Tmin=(100,'K'), Tmax=(1042.39,'K')), NASAPolynomial(coeffs=[13.9862,0.0462436,-2.05302e-05,3.90125e-09,-2.73378e-13,-37589.4,-31.0786], Tmin=(1042.39,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-288.786,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(478.082,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(RCCJ)"""),
)

species(
    label = 'CCCCC(=O)C(O)O(14648)',
    structure = SMILES('CCCCC(=O)C(O)O'),
    E0 = (-665.659,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (132.158,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.18436,0.0990323,-0.000104157,6.64296e-08,-1.82933e-11,-79915.7,35.6494], Tmin=(100,'K'), Tmax=(858.446,'K')), NASAPolynomial(coeffs=[9.56627,0.0535969,-2.47631e-05,4.77036e-09,-3.35996e-13,-81589.8,-9.90313], Tmin=(858.446,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-665.659,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(478.082,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cds-OdCsCs)"""),
)

species(
    label = 'CCCCC(O)C(=O)O(14649)',
    structure = SMILES('CCCCC(O)C(=O)O'),
    E0 = (-710.232,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (132.158,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.514312,0.0864233,-5.66589e-05,1.57448e-08,-9.57901e-13,-85248,38.4667], Tmin=(100,'K'), Tmax=(1241.18,'K')), NASAPolynomial(coeffs=[18.6166,0.0387348,-1.59037e-05,2.9195e-09,-2.00532e-13,-91072.7,-62.2957], Tmin=(1241.18,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-710.232,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(478.082,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-O2d)H) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cds-OdCsOs)"""),
)
...
species(
    label = 'CCCC([O])C([O])O(14650)',
    structure = SMILES('CCCC([O])C([O])O'),
    E0 = (-244.547,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1277.5,1000,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.524226,0.0829464,-8.56238e-05,5.49432e-08,-1.55073e-11,-29292.8,33.2371], Tmin=(100,'K'), Tmax=(831.895,'K')), NASAPolynomial(coeffs=[7.80338,0.0479463,-2.25151e-05,4.36932e-09,-3.09029e-13,-30503.9,-0.540912], Tmin=(831.895,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-244.547,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + radical(CCOJ) + radical(CC(C)OJ)"""),
)
...
species(
    ...
    molecularWeight = (132.158,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.486159,0.105287,-0.000108425,6.48616e-08,-1.65118e-11,-3898.93,35.9995], Tmin=(100,'K'), Tmax=(928.919,'K')), NASAPolynomial(coeffs=[11.559,0.0534199,-2.46716e-05,4.75389e-09,-3.35143e-13,-6136.74,-21.2234], Tmin=(928.919,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-33.7142,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(478.082,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCsJOOH) + radical(CC(C)OJ)"""),
)

species(
    label = 'CCCCC([CH][O])OO(14652)',
    structure = SMILES('CCCCC([CH][O])OO'),
    E0 = (-46.6544,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (132.158,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.165692,0.0999408,-6.91638e-05,-5.3431e-08,8.78535e-11,-5489.04,34.3239], Tmin=(100,'K'), Tmax=(491.747,'K')), NASAPolynomial(coeffs=[8.65173,0.0586613,-2.78888e-05,5.36176e-09,-3.74033e-13,-6659.13,-4.00432], Tmin=(491.747,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-46.6544,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(478.082,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(CCsJOH)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'CCCCC(=O)C([O])O(14633)'],
    products = ['CCCCC([O])C([O])O(13397)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'CCCCC([O])C(=O)O(14634)'],
    products = ['CCCCC([O])C([O])O(13397)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['butyl_1(82)', '[O]C(O)C=O(4774)'],
    products = ['CCCCC([O])C([O])O(13397)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['OH(5)', 'CCCCC([O])C=O(11788)'],
    products = ['CCCCC([O])C([O])O(13397)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction10',
    reactants = ['CCC[CH]C(O)C([O])O(14637)'],
    products = ['CCCCC([O])C([O])O(13397)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CC[CH]CC(O)C([O])O(14640)'],
    products = ['CCCCC([O])C([O])O(13397)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CCC[CH]C([O])C(O)O(14641)'],
    products = ['CCCCC([O])C([O])O(13397)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CCCCC([O])C([O])O(13397)'],
    products = ['C[CH]CCC(O)C([O])O(14643)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CCCCC([O])C([O])O(13397)'],
    products = ['CC[CH]CC([O])C(O)O(14644)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CCCCC([O])C([O])O(13397)'],
    products = ['[CH2]CCCC(O)C([O])O(14645)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CCCCC([O])C([O])O(13397)'],
    products = ['C[CH]CCC([O])C(O)O(14646)'],
...
reaction(
    label = 'reaction20',
    reactants = ['CCCCC([O])C([O])O(13397)'],
    products = ['[CH2]CCCC([O])C(O)O(14647)'],
...
reaction(
    label = 'reaction24',
    reactants = ['CH2(S)(23)', 'CCCC([O])C([O])O(14650)'],
    products = ['CCCCC([O])C([O])O(13397)'],
...
reaction(
    label = 'reaction28',
    reactants = ['O(4)', 'CCCC[CH]C([O])O(4479)'],
    products = ['CCCCC([O])C([O])O(13397)'],
...
reaction(
    label = 'reaction29',
    reactants = ['O(4)', 'CCCCC([O])[CH]O(11790)'],
    products = ['CCCCC([O])C([O])O(13397)'],
