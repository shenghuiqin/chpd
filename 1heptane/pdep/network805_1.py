...
species(
    label = 'C[CH]OC=CC(1892)',
    structure = SMILES('C[CH]OC=CC'),
    E0 = (-27.6052,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,2995,3025,975,1000,1300,1375,400,500,1630,1680,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.797778,'amu*angstrom^2'), symmetry=1, barrier=(18.3425,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.798595,'amu*angstrom^2'), symmetry=1, barrier=(18.3613,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.798525,'amu*angstrom^2'), symmetry=1, barrier=(18.3597,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.798484,'amu*angstrom^2'), symmetry=1, barrier=(18.3587,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (85.1244,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.512557,0.0628875,-2.56313e-05,-2.2739e-08,1.64573e-11,-3181.93,22.4806], Tmin=(100,'K'), Tmax=(941.324,'K')), NASAPolynomial(coeffs=[19.884,0.014917,-3.91951e-06,6.44727e-10,-4.72007e-14,-8350.55,-77.8867], Tmin=(941.324,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-27.6052,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(CCsJOC(O))"""),
)

species(
    label = 'C=CCO[CH]C(1893)',
    structure = SMILES('C=CCO[CH]C'),
    E0 = (16.642,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2950,3100,1380,975,1025,1650,3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,239.995,240.433,240.566,3478.55],'cm^-1')),
        HinderedRotor(inertia=(0.00291227,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.425144,'amu*angstrom^2'), symmetry=1, barrier=(17.4461,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.545949,'amu*angstrom^2'), symmetry=1, barrier=(22.4119,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.426204,'amu*angstrom^2'), symmetry=1, barrier=(17.4465,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (85.1244,'amu'),
...
species(
    label = 'C=COC[CH]C(1237)',
    structure = SMILES('C=COC[CH]C'),
    E0 = (-9.38516,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2950,3100,1380,975,1025,1650,3010,987.5,1337.5,450,1655,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,330.226,330.227,330.228,330.248],'cm^-1')),
        HinderedRotor(inertia=(0.00154582,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.252704,'amu*angstrom^2'), symmetry=1, barrier=(19.5565,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.252723,'amu*angstrom^2'), symmetry=1, barrier=(19.5565,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.252716,'amu*angstrom^2'), symmetry=1, barrier=(19.5565,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (85.1244,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.01507,0.0481985,1.40203e-05,-6.17726e-08,2.97976e-11,-1005.31,24.1383], Tmin=(100,'K'), Tmax=(939.708,'K')), NASAPolynomial(coeffs=[19.0545,0.0153746,-3.76086e-06,6.27789e-10,-4.83736e-14,-6336.75,-72.0977], Tmin=(939.708,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-9.38516,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CCJCO)"""),
)
...
species(
    ...
    molecularWeight = (86.1323,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.489349,0.07619,-7.62465e-05,4.16562e-08,-9.24011e-12,7795.74,24.725], Tmin=(100,'K'), Tmax=(1086.14,'K')), NASAPolynomial(coeffs=[13.1438,0.0295859,-1.18834e-05,2.14985e-09,-1.4665e-13,5046.9,-37.3706], Tmin=(1086.14,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(63.7589,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCsJOCs) + radical(CCsJOCs)"""),
)

species(
    label = '[CH2]CCO[CH]C(1895)',
    ...
    molecularWeight = (86.1323,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.988976,0.0679608,-6.05185e-05,3.08161e-08,-6.66707e-12,10757,25.2758], Tmin=(100,'K'), Tmax=(1081.58,'K')), NASAPolynomial(coeffs=[9.84559,0.0352066,-1.50933e-05,2.8169e-09,-1.95278e-13,8841.15,-18.1468], Tmin=(1081.58,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(88.5492,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJ) + radical(CCsJOCs)"""),
)

species(
    label = '[CH2]COC[CH]C(1896)',
    ...
    molecularWeight = (86.1323,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.26342,0.0606678,-4.40764e-05,1.74835e-08,-2.97392e-12,13849.5,26.1799], Tmin=(100,'K'), Tmax=(1322.8,'K')), NASAPolynomial(coeffs=[9.78947,0.0348853,-1.48394e-05,2.74825e-09,-1.8898e-13,11593.9,-17.3384], Tmin=(1322.8,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(114.338,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJCO) + radical(CCJCO)"""),
)

species(
    label = 'C[CH][CH]OCC(1897)',
...
species(
    ...
    molecularWeight = (86.1323,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.765485,0.0727998,-7.1096e-05,3.93375e-08,-9.07349e-12,11528,24.9266], Tmin=(100,'K'), Tmax=(1031.2,'K')), NASAPolynomial(coeffs=[10.817,0.0338109,-1.43831e-05,2.67336e-09,-1.84933e-13,9454.92,-23.8751], Tmin=(1031.2,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(94.892,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJCO) + radical(CCsJOCs)"""),
)

species(
    label = '[CH2][CH]COCC(1899)',
    ...
    molecularWeight = (86.1323,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.43429,0.0564719,-3.5735e-05,1.16906e-08,-1.61962e-12,13080.5,26.7146], Tmin=(100,'K'), Tmax=(1573.2,'K')), NASAPolynomial(coeffs=[10.2715,0.0340023,-1.43107e-05,2.61163e-09,-1.76846e-13,10300,-19.924], Tmin=(1573.2,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(107.995,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJCO) + radical(RCCJ)"""),
)
...
species(
    ...
    molecularWeight = (86.1323,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.873638,0.0535672,9.62891e-07,-4.49739e-08,2.26897e-11,-26517.9,21.7108], Tmin=(100,'K'), Tmax=(954.445,'K')), NASAPolynomial(coeffs=[17.4401,0.0212982,-6.7236e-06,1.18678e-09,-8.59234e-14,-31372.8,-66.3073], Tmin=(954.445,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-221.533,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH)"""),
)
...
species(
    ...
    molecularWeight = (86.1323,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.42562,0.0537514,-3.00705e-05,8.08515e-09,-8.76193e-13,-19607.7,23.3381], Tmin=(100,'K'), Tmax=(2038.66,'K')), NASAPolynomial(coeffs=[14.3349,0.0284227,-1.14344e-05,1.99096e-09,-1.28871e-13,-24871.3,-48.1369], Tmin=(2038.66,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-163.814,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['C[CH]CO[CH]C(1220)'],
    products = ['CH3CHO(37)', 'C3H6(72)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'C[CH]OC=CC(1892)'],
    products = ['C[CH]CO[CH]C(1220)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['C3H6(T)(143)', 'CH3CHO(37)'],
    products = ['C[CH]CO[CH]C(1220)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction12',
    reactants = ['C[CH][O](176)', 'C3H6(T)(143)'],
    products = ['C[CH]CO[CH]C(1220)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CHCH3(T)(95)', 'C[CH]C[O](561)'],
    products = ['C[CH]CO[CH]C(1220)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CHCH3(T)(95)', '[CH2]O[CH]C(567)'],
    products = ['C[CH]CO[CH]C(1220)'],
