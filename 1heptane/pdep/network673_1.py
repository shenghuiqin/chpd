species(
    label = 'C=[C]OC[CH]O(1094)',
    structure = SMILES('C=[C]OC[CH]O'),
    E0 = (74.7076,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2950,3100,1380,975,1025,1650,1685,370,3615,1277.5,1000,3025,407.5,1350,352.5,300.231,300.634,300.676,300.798],'cm^-1')),
        HinderedRotor(inertia=(0.00189027,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.247489,'amu*angstrom^2'), symmetry=1, barrier=(15.9321,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.24317,'amu*angstrom^2'), symmetry=1, barrier=(15.9356,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.252272,'amu*angstrom^2'), symmetry=1, barrier=(15.9478,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
species(
    label = 'C#COC[CH]O(5790)',
    structure = SMILES('C#COC[CH]O'),
    E0 = (44.2899,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,750,770,3400,2100,2175,525,3615,1277.5,1000,3025,407.5,1350,352.5,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.949144,'amu*angstrom^2'), symmetry=1, barrier=(21.8227,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.950314,'amu*angstrom^2'), symmetry=1, barrier=(21.8496,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.950721,'amu*angstrom^2'), symmetry=1, barrier=(21.8589,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.949459,'amu*angstrom^2'), symmetry=1, barrier=(21.8299,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (85.0813,'amu'),
...
species(
    ...
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.64687,0.053342,-5.06113e-05,2.6914e-08,-6.00012e-12,14529.9,23.8288], Tmin=(100,'K'), Tmax=(1059.27,'K')), NASAPolynomial(coeffs=[9.01519,0.025518,-1.12109e-05,2.117e-09,-1.4777e-13,12968.9,-12.1433], Tmin=(1059.27,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(120.115,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CCOJ) + radical(C=CJO)"""),
)

species(
    label = 'C=[C]O[CH]CO(5792)',
    structure = SMILES('C=[C]O[CH]CO'),
    E0 = (88.3371,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2950,3100,1380,975,1025,1650,1685,370,3615,1277.5,1000,3025,407.5,1350,352.5,351.11,351.111,351.111,351.111],'cm^-1')),
        HinderedRotor(inertia=(0.160232,'amu*angstrom^2'), symmetry=1, barrier=(14.0174,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH]=[C]OCCO(5794)',
    structure = SMILES('[CH]=[C]OCCO'),
    E0 = (141.506,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3120,650,792.5,1650,3615,1277.5,1000,1685,370,260.596,260.599,260.6],'cm^-1')),
        HinderedRotor(inertia=(0.00248243,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.320153,'amu*angstrom^2'), symmetry=1, barrier=(15.4291,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.320187,'amu*angstrom^2'), symmetry=1, barrier=(15.429,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.320158,'amu*angstrom^2'), symmetry=1, barrier=(15.4291,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'C=[C]OCC=O(5788)'],
    products = ['C=[C]OC[CH]O(1094)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction16',
    reactants = ['H2CC(41)', '[O]C[CH]O(1827)'],
    products = ['C=[C]OC[CH]O(1094)'],
...
reaction(
    label = 'reaction17',
    reactants = ['HCOH(T)(285)', '[CH2]O[C]=C(2374)'],
    products = ['C=[C]OC[CH]O(1094)'],
