...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'CC(=O)C[C]=O(3210)'],
    products = ['CC([O])C[C]=O(1086)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction16',
    reactants = ['CH2(S)(23)', '[O]CC[C]=O(941)'],
    products = ['CC([O])C[C]=O(1086)'],
