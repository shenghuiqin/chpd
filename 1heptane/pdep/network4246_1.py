...
species(
    label = 'CC=[C]CC=CC(24296)',
    structure = SMILES('CC=[C]CC=CC'),
    E0 = (254.54,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,1685,370,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,2995,3010,3025,975,987.5,1000,1300,1337.5,1375,400,450,500,1630,1655,1680,224.712,234.255],'cm^-1')),
        HinderedRotor(inertia=(0.23825,'amu*angstrom^2'), symmetry=1, barrier=(8.84208,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.236544,'amu*angstrom^2'), symmetry=1, barrier=(8.84953,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.245931,'amu*angstrom^2'), symmetry=1, barrier=(8.87019,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.233721,'amu*angstrom^2'), symmetry=1, barrier=(8.85597,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (95.1622,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.02206,0.0623775,-3.62205e-05,1.03271e-08,-1.20218e-12,30723.2,27.6031], Tmin=(100,'K'), Tmax=(1891.78,'K')), NASAPolynomial(coeffs=[14.3625,0.0341699,-1.38543e-05,2.44509e-09,-1.60562e-13,25675.9,-45.2615], Tmin=(1891.78,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(254.54,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(415.724,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Cds_S)"""),
)

species(
    label = 'C[CH]CC=C=CC(24297)',
    structure = SMILES('C[CH]CC=C=CC'),
    E0 = (258.697,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,540,610,2055,2995,3025,975,1000,1300,1375,400,500,1630,1680,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3025,407.5,1350,352.5,240.145,240.149],'cm^-1')),
        HinderedRotor(inertia=(0.0029231,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.171039,'amu*angstrom^2'), symmetry=1, barrier=(6.99958,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.171036,'amu*angstrom^2'), symmetry=1, barrier=(6.99958,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.171033,'amu*angstrom^2'), symmetry=1, barrier=(6.99958,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (95.1622,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.45687,0.060399,-3.38439e-05,9.49995e-09,-1.13634e-12,31200.6,26.8249], Tmin=(100,'K'), Tmax=(1702.4,'K')), NASAPolynomial(coeffs=[9.16254,0.0422934,-1.78908e-05,3.25256e-09,-2.18894e-13,28577,-14.4501], Tmin=(1702.4,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(258.697,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(415.724,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cdd-CdsCds) + radical(RCCJC)"""),
)
...
species(
    label = 'CC#CCC[CH]C(24298)',
    structure = SMILES('CC#CCC[CH]C'),
    E0 = (254.286,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (95.1622,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.15965,0.0612584,-3.82108e-05,1.44088e-08,-2.47484e-12,30686.7,28.7576], Tmin=(100,'K'), Tmax=(1268.39,'K')), NASAPolynomial(coeffs=[7.08973,0.0425572,-1.60947e-05,2.78451e-09,-1.83692e-13,29182.3,-1.26151], Tmin=(1268.39,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(254.286,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CtCsHH) + group(Cs-CsHHH) + group(Cs-CtHHH) + group(Ct-CtCs) + group(Ct-CtCs) + radical(RCCJC)"""),
)
...
species(
    label = 'C#CCC[CH]C(24299)',
    structure = SMILES('C#CCC[CH]C'),
    E0 = (296.467,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,750,770,3400,2100,2175,525,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,269.932,2397.27],'cm^-1')),
        HinderedRotor(inertia=(1.41968,'amu*angstrom^2'), symmetry=1, barrier=(73.4466,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00281247,'amu*angstrom^2'), symmetry=1, barrier=(11.4751,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.222033,'amu*angstrom^2'), symmetry=1, barrier=(11.4764,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.41876,'amu*angstrom^2'), symmetry=1, barrier=(73.4475,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (81.1357,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.63098,0.0524062,-3.63394e-05,1.5468e-08,-2.9846e-12,35741.8,23.6487], Tmin=(100,'K'), Tmax=(1153.91,'K')), NASAPolynomial(coeffs=[6.63051,0.0350754,-1.38108e-05,2.45219e-09,-1.64674e-13,34588,-1.18691], Tmin=(1153.91,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(296.467,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CtCsHH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(RCCJC)"""),
)
...
species(
    label = 'C[C]=[C]CCCC(24302)',
    structure = SMILES('C[C]=[C]CCCC'),
    E0 = (375.576,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,1670,1700,300,440,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (96.1702,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.09124,0.0693072,-4.81887e-05,1.96043e-08,-3.70285e-12,45271.5,27.7673], Tmin=(100,'K'), Tmax=(1131.22,'K')), NASAPolynomial(coeffs=[6.67868,0.0495496,-2.19897e-05,4.16404e-09,-2.90493e-13,44007.4,0.122299], Tmin=(1131.22,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(375.576,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Cds_S) + radical(Cds_S)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'CC=[C]CC=CC(24296)'],
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'C[CH]CC=C=CC(24297)'],
    products = ['C[CH]CC[C]=CC(19228)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', 'C=CCC[C]=CC(24174)'],
    products = ['C[CH]CC[C]=CC(19228)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)', 'CC#CCC[CH]C(24298)'],
    products = ['C[CH]CC[C]=CC(19228)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['CH3(17)', 'C#CCC[CH]C(24299)'],
    products = ['C[CH]CC[C]=CC(19228)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction27',
    reactants = ['CHCH3(T)(95)', '[CH2]C[C]=CC(24198)'],
    products = ['C[CH]CC[C]=CC(19228)'],
...
reaction(
    label = 'reaction28',
    reactants = ['[CH2]C[CH]C(129)', '[C]=CC(24199)'],
    products = ['C[CH]CC[C]=CC(19228)'],
