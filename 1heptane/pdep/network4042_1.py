...
species(
    label = '[CH2]C1CC1C1[CH]CC1(23520)',
    ...
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.35369,0.0324827,9.31256e-05,-1.41451e-07,5.58601e-11,53897.7,29.7974], Tmin=(100,'K'), Tmax=(956.234,'K')), NASAPolynomial(coeffs=[16.3722,0.0343397,-1.12491e-05,2.05393e-09,-1.51737e-13,48068.3,-57.4487], Tmin=(956.234,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(447.145,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(473.925,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cyclopropane) + ring(Cyclobutane) + radical(Isobutyl) + radical(cyclobutane)"""),
)

species(
    label = '[CH2]C1C([CH2])C2CCC12(23521)',
...
species(
    label = '[CH2]C(C=C)C1=CCC1(23522)',
    structure = SMILES('[CH2]C(C=C)C1=CCC1'),
    E0 = (359.551,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,3100,1380,975,1025,1650,3010,987.5,1337.5,450,1655,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,2750,2850,2950,3050,3150,900,950,1000,1050,1100,300,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
...
species(
    label = '[CH2]C(C=C)C1C=CC1(23524)',
    structure = SMILES('[CH2]C(C=C)C1C=CC1'),
    E0 = (366.267,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,3100,1380,975,1025,1650,3010,987.5,1337.5,450,1655,2750,2850,2950,3050,3150,900,950,1000,1050,1100,3000,3100,440,815,1455,1000,1380,1390,370,380,2900,435,300,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
...
species(
    ...
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.859697,0.0559253,7.97054e-06,-4.12721e-08,1.75197e-11,50641.9,32.288], Tmin=(100,'K'), Tmax=(1023.33,'K')), NASAPolynomial(coeffs=[11.711,0.0431147,-1.66471e-05,3.03629e-09,-2.11491e-13,46870.9,-27.8874], Tmin=(1023.33,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(420.026,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(469.768,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Cyclobutane) + radical(Tertalkyl) + radical(Isobutyl)"""),
)
...
species(
    label = '[CH2]C(C=C)C1C[CH]C1(23527)',
    ...
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.962323,0.0488343,3.73404e-05,-7.7622e-08,3.17322e-11,50933.4,33.1308], Tmin=(100,'K'), Tmax=(982.047,'K')), NASAPolynomial(coeffs=[14.0113,0.0392033,-1.4421e-05,2.64126e-09,-1.87911e-13,46271.9,-40.271], Tmin=(982.047,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(422.442,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(469.768,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Cyclobutane) + radical(Isobutyl) + radical(cyclobutane)"""),
)
...
species(
    label = '[CH]=CC([CH2])C1CCC1(23535)',
    structure = SMILES('[CH]=CC([CH2])C1CCC1'),
    E0 = (481.699,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2816.67,2883.33,2950,3016.67,3083.33,3150,900,933.333,966.667,1000,1033.33,1066.67,1100,3120,650,792.5,1650,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,3010,987.5,1337.5,450,1655,300,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.727854,0.0517302,3.90483e-05,-8.66875e-08,3.6805e-11,58071.1,32.0277], Tmin=(100,'K'), Tmax=(963.314,'K')), NASAPolynomial(coeffs=[16.7969,0.034726,-1.18943e-05,2.1466e-09,-1.54193e-13,52668.2,-56.8697], Tmin=(963.314,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(481.699,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(469.768,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Cyclobutane) + radical(Isobutyl) + radical(Cds_P)"""),
)

species(
    label = '[CH]1CCC1C1[CH]CC1(23536)',
    ...
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.74495,0.0252223,0.000102481,-1.39709e-07,5.17003e-11,52363.8,29.2547], Tmin=(100,'K'), Tmax=(990.07,'K')), NASAPolynomial(coeffs=[12.787,0.0421653,-1.64455e-05,3.1653e-09,-2.32746e-13,47160.5,-39.1421], Tmin=(990.07,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(434.523,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(478.082,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + ring(Cyclobutane) + ring(Cyclobutane) + radical(cyclobutane) + radical(cyclobutane)"""),
)
...
species(
    ...
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.260544,0.0799744,-5.97518e-05,2.48133e-08,-4.37253e-12,49067.6,34.117], Tmin=(100,'K'), Tmax=(1302.86,'K')), NASAPolynomial(coeffs=[12.2479,0.0431712,-1.73799e-05,3.13186e-09,-2.12193e-13,45944,-26.8867], Tmin=(1302.86,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(406.838,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)CsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(RCCJ) + radical(Isobutyl)"""),
)
...
species(
    label = '[CH2]C([CH]C1CC1)C=C(23541)',
    structure = SMILES('[CH2]C([CH]C1CC1)C=C'),
    E0 = (433.565,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,3100,1380,975,1025,1650,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,2750,2850,2950,3050,3150,900,950,1000,1050,1100,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    ...
    E0 = (435.063,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,2950,3100,1380,975,1025,1650,1380,1390,370,380,2900,435,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,3010,987.5,1337.5,450,1655,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]C(C=C)C1[CH]CC1(19728)'],
    products = ['[CH2]C1CC1C1[CH]CC1(23520)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH2]C(C=C)C1[CH]CC1(19728)'],
    products = ['[CH2]C1C([CH2])C2CCC12(23521)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', '[CH2]C(C=C)C1=CCC1(23522)'],
...
reaction(
    label = 'reaction6',
    reactants = ['H(3)', '[CH2]C(C=C)C1C=CC1(23524)'],
    products = ['[CH2]C(C=C)C1[CH]CC1(19728)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['C2H3(30)', 'C=CC1[CH]CC1(22318)'],
    products = ['[CH2]C(C=C)C1[CH]CC1(19728)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]C(C=C)C1[CH]CC1(19728)'],
    products = ['[CH2]C(C=C)[C]1CCC1(23525)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]C(C=C)C1C[CH]C1(23527)'],
    products = ['[CH2]C(C=C)C1[CH]CC1(19728)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH]=CC([CH2])C1CCC1(23535)'],
    products = ['[CH2]C(C=C)C1[CH]CC1(19728)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH2]C(C=C)C1[CH]CC1(19728)'],
    products = ['[CH]1CCC1C1[CH]CC1(23536)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[CH2]CC=CC([CH2])C=C(23537)'],
    products = ['[CH2]C(C=C)C1[CH]CC1(19728)'],
...
reaction(
    label = 'reaction29',
    reactants = ['[CH2]C([CH]C1CC1)C=C(23541)'],
    products = ['[CH2]C(C=C)C1[CH]CC1(19728)'],
...
reaction(
    label = 'reaction31',
    reactants = ['[CH2]C(C=C)C1[CH]CC1(19728)'],
    products = ['C=CC[CH]C1[CH]CC1(23509)'],
...
reaction(
    label = 'reaction32',
    reactants = ['[CH2]C(C=C)C1CC1[CH2](19719)'],
    products = ['[CH2]C(C=C)C1[CH]CC1(19728)'],
...
reaction(
    label = 'reaction34',
    reactants = ['CH2(19)', 'C=C[CH]C1[CH]CC1(23542)'],
    products = ['[CH2]C(C=C)C1[CH]CC1(19728)'],
