...
species(
    label = 'C[CH]CC1=CCC1(23004)',
    structure = SMILES('C[CH]CC1=CCC1'),
    E0 = (253.433,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3025,407.5,1350,352.5,2750,2850,2950,3050,3150,900,950,1000,1050,1100,2750,2800,2850,1350,1500,750,1050,1375,1000,300,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.38302,0.0442786,2.17234e-05,-5.13248e-08,2.0502e-11,30586.7,27.3441], Tmin=(100,'K'), Tmax=(1017.02,'K')), NASAPolynomial(coeffs=[10.9342,0.0378744,-1.47906e-05,2.73732e-09,-1.93035e-13,27032.4,-26.819], Tmin=(1017.02,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(253.433,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(419.881,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + ring(Cyclobutene) + radical(RCCJC)"""),
)

species(
    label = 'CC=CC1[CH]CC1(23005)',
    ...
    molecularWeight = (95.1622,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.67229,0.0345198,5.1198e-05,-8.1418e-08,3.07415e-11,28715.5,26.3995], Tmin=(100,'K'), Tmax=(1007.26,'K')), NASAPolynomial(coeffs=[11.1184,0.038011,-1.50628e-05,2.85236e-09,-2.05216e-13,24732.5,-29.5657], Tmin=(1007.26,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(237.936,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(424.038,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cyclobutane) + radical(cyclobutane)"""),
)

species(
    label = 'C[CH]CC1C=CC1(23006)',
...
species(
    ...
    molecularWeight = (96.1702,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.41146,0.0494397,-2.08672e-06,-1.65653e-08,5.93349e-12,37787.6,28.806], Tmin=(100,'K'), Tmax=(1257.76,'K')), NASAPolynomial(coeffs=[7.78433,0.0465229,-1.93005e-05,3.52651e-09,-2.40111e-13,34812.1,-8.85659], Tmin=(1257.76,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(313.36,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(444.824,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cyclobutane) + radical(Tertalkyl) + radical(RCCJC)"""),
)
...
species(
    label = '[CH2]CCC1[CH]CC1(23010)',
    structure = SMILES('[CH2]CCC1[CH]CC1'),
    E0 = (326.576,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2830,2910,2990,3070,3150,900,940,980,1020,1060,1100,3000,3100,440,815,1455,1000,300,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (96.1702,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.33521,0.0433095,3.3669e-05,-6.42797e-08,2.46785e-11,39387.2,29.3267], Tmin=(100,'K'), Tmax=(1025.8,'K')), NASAPolynomial(coeffs=[11.3079,0.0410218,-1.65038e-05,3.10868e-09,-2.21385e-13,35415.5,-28.4256], Tmin=(1025.8,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(326.576,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(444.824,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cyclobutane) + radical(RCCJ) + radical(cyclobutane)"""),
)

species(
    label = 'C[CH][CH]C1CCC1(23011)',
    structure = SMILES('C[CH][CH]C1CCC1'),
    E0 = (322.479,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3050,390,425,1340,1360,335,370,2750,2816.67,2883.33,2950,3016.67,3083.33,3150,900,933.333,966.667,1000,1033.33,1066.67,1100,2750,2800,2850,1350,1500,750,1050,1375,1000,300,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
...
species(
    ...
    molecularWeight = (96.1702,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.35691,0.0500422,-1.56909e-06,-1.8114e-08,6.54243e-12,36995.3,29.3079], Tmin=(100,'K'), Tmax=(1246.84,'K')), NASAPolynomial(coeffs=[8.50612,0.0459999,-1.9435e-05,3.59148e-09,-2.46361e-13,33743.9,-12.6493], Tmin=(1246.84,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(306.752,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(444.824,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cyclobutane) + radical(Tertalkyl) + radical(cyclobutane)"""),
)

species(
    label = 'CCCC1[CH]C[CH]1(23013)',
    ...
    molecularWeight = (96.1702,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.45289,0.0432195,2.5963e-05,-5.07828e-08,1.86305e-11,37286.8,29.4688], Tmin=(100,'K'), Tmax=(1071.09,'K')), NASAPolynomial(coeffs=[9.3071,0.0444146,-1.84621e-05,3.4777e-09,-2.45206e-13,33853.2,-17.1369], Tmin=(1071.09,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(309.168,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(444.824,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cyclobutane) + radical(cyclobutane) + radical(cyclobutane)"""),
)

species(
    label = 'CCCC1[CH][CH]C1(23014)',
...
species(
    label = '[CH2][CH]CC1CCC1(23015)',
    structure = SMILES('[CH2][CH]CC1CCC1'),
    E0 = (333.183,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2816.67,2883.33,2950,3016.67,3083.33,3150,900,933.333,966.667,1000,1033.33,1066.67,1100,3000,3100,440,815,1455,1000,3025,407.5,1350,352.5,300,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
...
species(
    ...
    molecularWeight = (96.1702,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.16103,0.0443587,4.01089e-05,-7.84557e-08,3.16208e-11,7212.72,25.4044], Tmin=(100,'K'), Tmax=(989.008,'K')), NASAPolynomial(coeffs=[14.1014,0.0358719,-1.35253e-05,2.52795e-09,-1.82199e-13,2508.53,-47.7244], Tmin=(989.008,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(58.9868,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(444.824,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + ring(Cyclobutene)"""),
)

species(
    label = 'CC=CC1CCC1(23018)',
...
species(
    ...
    molecularWeight = (96.1702,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.26512,0.0405537,5.22447e-05,-9.19789e-08,3.66658e-11,7952.27,24.9119], Tmin=(100,'K'), Tmax=(980.418,'K')), NASAPolynomial(coeffs=[14.427,0.0349981,-1.29132e-05,2.41329e-09,-1.75141e-13,3057.61,-50.1266], Tmin=(980.418,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(65.1549,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(444.824,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cyclobutene)"""),
)

species(
    label = 'C=CCC1CCC1(23019)',
    ...
    molecularWeight = (96.1702,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.45786,0.0340457,7.22983e-05,-1.12541e-07,4.37459e-11,7480.51,25.2242], Tmin=(100,'K'), Tmax=(978.045,'K')), NASAPolynomial(coeffs=[14.4506,0.0352883,-1.30092e-05,2.45704e-09,-1.80302e-13,2338.07,-50.4666], Tmin=(978.045,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(61.273,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(448.981,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Cyclobutane)"""),
)

species(
    label = 'C[CH]C[CH]C1CC1(23020)',
    structure = SMILES('C[CH]C[CH]C1CC1'),
    E0 = (326.899,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3000,3050,390,425,1340,1360,335,370,2750,2850,2950,3050,3150,900,950,1000,1050,1100,2750,2800,2850,1350,1500,750,1050,1375,1000,302.967,815.372,815.372,815.372,815.372,815.372,815.372,1632.38,1632.38,1632.38,1632.38,1632.38,1632.38],'cm^-1')),
    ...
    molecularWeight = (96.1702,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.23136,0.0499948,5.50932e-06,-3.0999e-08,1.22825e-11,39425.6,30.8462], Tmin=(100,'K'), Tmax=(1087.75,'K')), NASAPolynomial(coeffs=[9.72783,0.0426573,-1.73393e-05,3.20943e-09,-2.2339e-13,36162.9,-17.3601], Tmin=(1087.75,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(326.899,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(440.667,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(RCCJC) + radical(Cs_S)"""),
)
...
species(
    label = '[CH2]C1CC1C[CH]C(19163)',
    structure = SMILES('[CH2]C1CC1C[CH]C'),
    E0 = (328.397,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,2750,2850,1437.5,1250,1305,750,350,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (96.1702,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.14782,0.0495723,1.67986e-05,-5.13038e-08,2.2031e-11,39611.5,29.3921], Tmin=(100,'K'), Tmax=(975.928,'K')), NASAPolynomial(coeffs=[11.6263,0.0379948,-1.36231e-05,2.41462e-09,-1.67164e-13,36072.3,-28.5592], Tmin=(975.928,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(328.397,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(440.667,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(RCCJC) + radical(Isobutyl)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['C[CH]CC1[CH]CC1(19170)'],
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'C[CH]CC1=CCC1(23004)'],
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'CC=CC1[CH]CC1(23005)'],
    products = ['C[CH]CC1[CH]CC1(19170)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', 'C[CH]CC1C=CC1(23006)'],
    products = ['C[CH]CC1[CH]CC1(19170)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(1.46e+08,'cm^3/(mol*s)'), n=1.64, Ea=(5.73208,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""From training reaction 2555 used for Cds-CsH_Cds-CsH;HJ
Exact match found for rate rule [Cds-CsH_Cds-CsH;HJ]
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)', 'C=CCC1[CH]CC1(23007)'],
    products = ['C[CH]CC1[CH]CC1(19170)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction9',
    reactants = ['CC[CH]C1[CH]CC1(23003)'],
    products = ['C[CH]CC1[CH]CC1(19170)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['C[CH]CC1C[CH]C1(23009)'],
    products = ['C[CH]CC1[CH]CC1(19170)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]CCC1[CH]CC1(23010)'],
    products = ['C[CH]CC1[CH]CC1(19170)'],
...
reaction(
    label = 'reaction12',
    reactants = ['C[CH][CH]C1CCC1(23011)'],
    products = ['C[CH]CC1[CH]CC1(19170)'],
...
reaction(
    label = 'reaction14',
    reactants = ['C[CH]CC1[CH]CC1(19170)'],
    products = ['CCCC1[CH]C[CH]1(23013)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2][CH]CC1CCC1(23015)'],
    products = ['C[CH]CC1[CH]CC1(19170)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2]CC=CC[CH]C(23016)'],
    products = ['C[CH]CC1[CH]CC1(19170)'],
...
reaction(
    label = 'reaction24',
    reactants = ['C[CH]C[CH]C1CC1(23020)'],
    products = ['C[CH]CC1[CH]CC1(19170)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[CH2]C1CC1C[CH]C(19163)'],
    products = ['C[CH]CC1[CH]CC1(19170)'],
...
reaction(
    label = 'reaction28',
    reactants = ['CHCH3(T)(95)', '[CH2]C1[CH]CC1(22328)'],
    products = ['C[CH]CC1[CH]CC1(19170)'],
