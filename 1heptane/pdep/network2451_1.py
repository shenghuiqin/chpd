...
species(
    label = 'CCC1(O[C]=O)OCC1=O(16590)',
    structure = SMILES('CCC1(O[C]=O)OCC1=O'),
    E0 = (-415.91,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,1855,455,950,2750,3150,900,1100,2750,2800,2850,1350,1500,750,1050,1375,1000,300,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.301442,0.0672167,1.84044e-05,-8.85161e-08,4.26236e-11,-49842.7,31.5765], Tmin=(100,'K'), Tmax=(955.834,'K')), NASAPolynomial(coeffs=[28.6727,0.0135553,-3.45426e-06,7.10551e-10,-6.36225e-14,-58469.2,-123.049], Tmin=(955.834,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-415.91,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(390.78,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-Cs(Cds-O2d)) + group(Cs-CsCsOsOs) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)OsHH) + group(Cs-CsHHH) + group(Cds-OdCsCs) + group(Cds-OdOsH) + ring(Cyclobutane) + radical((O)CJOC)"""),
)

species(
    label = 'CCC1(O[C]=O)OC=C1O(16591)',
    structure = SMILES('CCC1(O[C]=O)OC=C1O'),
    E0 = (-443.4,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2950,1000,1855,455,950,3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,300,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (143.117,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.41205,0.0806596,2.4881e-05,-1.32461e-07,6.85299e-11,-53098,30.0929], Tmin=(100,'K'), Tmax=(915.856,'K')), NASAPolynomial(coeffs=[42.8965,-0.0119421,1.12639e-05,-2.2375e-09,1.41965e-13,-65446.4,-202.882], Tmin=(915.856,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-443.4,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-Cs(Cds-O2d)) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsOsOs) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + group(Cds-OdOsH) + ring(Cyclobutene) + radical((O)CJOC)"""),
)
...
species(
    label = 'O=[C]OC1OCC=1O(16592)',
    structure = SMILES('O=[C]OC1OCC=1O'),
    E0 = (-297.983,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1855,455,950,3615,1277.5,1000,2750,3150,900,1100,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.392497,0.0767992,-8.46267e-05,4.22228e-08,-7.77291e-12,-35664,24.2041], Tmin=(100,'K'), Tmax=(1522.38,'K')), NASAPolynomial(coeffs=[24.0921,0.00104614,1.26555e-06,-3.18109e-10,2.22251e-14,-41795.5,-99.8637], Tmin=(1522.38,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-297.983,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-O2d)(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsCs) + group(Cds-OdOsH) + ring(Cyclobutene) + radical((O)CJOC)"""),
)

species(
    label = 'CCC1(O[C]=O)OCC1[O](16593)',
    structure = SMILES('CCC1(O[C]=O)OCC1[O]'),
    E0 = (-265.398,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (144.125,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.597212,0.0764536,4.62329e-06,-8.5722e-08,4.67028e-11,-31731.3,31.7574], Tmin=(100,'K'), Tmax=(899.809,'K')), NASAPolynomial(coeffs=[29.1638,0.0112217,1.5638e-06,-6.21154e-10,4.4293e-14,-39802.2,-123.767], Tmin=(899.809,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-265.398,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(415.724,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdOsH) + ring(Oxetane) + radical((O)CJOC) + radical(CC(C)OJ)"""),
)

species(
    label = 'CCC1(O[C]=O)O[CH]C1O(16594)',
    structure = SMILES('CCC1(O[C]=O)O[CH]C1O'),
    E0 = (-315.303,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,1855,455,950,3615,1277.5,1000,2750,3150,900,1100,300,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'C[CH]C1(O[C]=O)OCC1O(16595)',
    structure = SMILES('C[CH]C1(O[C]=O)OCC1O'),
    E0 = (-295.857,'kJ/mol'),
    modes = [
...
species(
    label = 'C[CH]C1(OC=O)OC[C]1O(16596)',
    structure = SMILES('C[CH]C1(OC=O)OC[C]1O'),
    E0 = (-315.677,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (144.125,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.512254,0.0762373,-1.78024e-06,-7.58819e-08,4.24797e-11,-37783.1,35.6304], Tmin=(100,'K'), Tmax=(899.992,'K')), NASAPolynomial(coeffs=[28.0701,0.0119029,9.44906e-07,-4.92733e-10,3.5688e-14,-45467.2,-113.358], Tmin=(899.992,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-315.677,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdOsH) + ring(Oxetane) + radical(C2CsJOH) + radical(CCJCO)"""),
)

species(
    label = '[CH2]CC1(O[C]=O)OCC1O(16597)',
    structure = SMILES('[CH2]CC1(O[C]=O)OCC1O'),
    E0 = (-290.512,'kJ/mol'),
    modes = [
...
species(
    label = 'CCC1(O[CH][C]1O)OC=O(16598)',
    structure = SMILES('CCC1(O[CH][C]1O)OC=O'),
    E0 = (-335.123,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (144.125,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-3.13141,0.113026,-0.000113666,5.46211e-08,-9.57439e-12,-40011.3,42.0146], Tmin=(100,'K'), Tmax=(1697.22,'K')), NASAPolynomial(coeffs=[27.6721,0.0114817,1.6623e-06,-7.28795e-10,5.88375e-14,-46298.2,-110.607], Tmin=(1697.22,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-335.123,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdOsH) + ring(Oxetane) + radical(CCsJOCs) + radical(C2CsJOH)"""),
)

species(
    label = '[CH2]CC1(OC=O)OC[C]1O(16599)',
    structure = SMILES('[CH2]CC1(OC=O)OC[C]1O'),
    E0 = (-310.333,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2782.5,750,1395,475,1775,1000,3615,1277.5,1000,3000,3100,440,815,1455,1000,2750,3150,900,1100,300,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (144.125,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.657119,0.0820387,-2.03579e-05,-5.47579e-08,3.44405e-11,-37137.6,35.4404], Tmin=(100,'K'), Tmax=(899.501,'K')), NASAPolynomial(coeffs=[27.266,0.0139615,-3.75172e-07,-2.39103e-10,1.91858e-14,-44430.3,-108.929], Tmin=(899.501,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-310.333,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdOsH) + ring(Oxetane) + radical(C2CsJOH) + radical(RCCJ)"""),
)

species(
    label = 'CCC1(OC=O)OC[C]1[O](16600)',
    structure = SMILES('CCC1(OC=O)OC[C]1[O]'),
    E0 = (-285.219,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2782.5,750,1395,475,1775,1000,2750,3150,900,1100,2750,2800,2850,1350,1500,750,1050,1375,1000,300,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (144.125,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.544519,0.0774766,-4.6422e-06,-7.11039e-08,4.00237e-11,-34119.2,33.0571], Tmin=(100,'K'), Tmax=(905.121,'K')), NASAPolynomial(coeffs=[27.4301,0.0144231,-5.34596e-07,-1.89478e-10,1.40198e-14,-41664.6,-112.823], Tmin=(905.121,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-285.219,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(415.724,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdOsH) + ring(Oxetane) + radical(CC(C)OJ) + radical(C2CsJOH)"""),
)
...
species(
    ...
    molecularWeight = (144.125,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.593688,0.106234,-0.000126008,8.05027e-08,-2.08768e-11,-40755.9,35.6567], Tmin=(100,'K'), Tmax=(932.774,'K')), NASAPolynomial(coeffs=[15.0194,0.0392789,-1.83349e-05,3.54496e-09,-2.50258e-13,-43668.5,-38.5803], Tmin=(932.774,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-340.203,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(407.409,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-Cd)) + group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsOs) + group(Cds-OdOsH) + radical(CCOJ) + radical((O)CJOC)"""),
)

species(
    label = 'CCC1(OC=O)OCC1=O(8732)',
    structure = SMILES('CCC1(OC=O)OCC1=O'),
    E0 = (-612.359,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (144.125,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0960502,0.0594974,4.63637e-05,-1.16618e-07,5.1907e-11,-73474.5,32.212], Tmin=(100,'K'), Tmax=(960.302,'K')), NASAPolynomial(coeffs=[28.3861,0.0165637,-4.82458e-06,1.01157e-09,-8.76565e-14,-82435.5,-122.219], Tmin=(960.302,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-612.359,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(415.724,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-Cs(Cds-O2d)) + group(Cs-CsCsOsOs) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)OsHH) + group(Cs-CsHHH) + group(Cds-OdCsCs) + group(Cds-OdOsH) + ring(Cyclobutane)"""),
)

species(
    label = 'CCC1(OC=O)OC=C1O(16602)',
    structure = SMILES('CCC1(OC=O)OC=C1O'),
    E0 = (-639.848,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (144.125,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.20987,0.0729943,5.2563e-05,-1.60046e-07,7.75091e-11,-76729.7,30.7389], Tmin=(100,'K'), Tmax=(921.751,'K')), NASAPolynomial(coeffs=[42.5588,-0.00884954,9.84623e-06,-1.9255e-09,1.17032e-13,-89390.4,-201.762], Tmin=(921.751,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-639.848,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-Cs(Cds-O2d)) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsOsOs) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + group(Cds-OdOsH) + ring(Cyclobutene)"""),
)
...
species(
    label = 'CC1(O[C]=O)OC[C]1O(16603)',
    structure = SMILES('CC1(O[C]=O)OC[C]1O'),
    E0 = (-295.351,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,1855,455,950,3615,1277.5,1000,2750,3150,900,1100,300,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.11551,0.095829,-9.81651e-05,4.7947e-08,-8.48852e-12,-35268.8,35.2966], Tmin=(100,'K'), Tmax=(1697.41,'K')), NASAPolynomial(coeffs=[23.4332,0.00883818,2.37804e-06,-8.38029e-10,6.58806e-14,-40083.5,-90.1131], Tmin=(1697.41,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-295.351,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdOsH) + ring(Oxetane) + radical((O)CJOC) + radical(C2CsJOH)"""),
)

species(
    label = 'CCC1(O)CO[C]1O[C]=O(16604)',
    structure = SMILES('CCC1(O)CO[C]1O[C]=O'),
    E0 = (-283.917,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,1855,455,950,3615,1277.5,1000,2750,3150,900,1100,300,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (144.125,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.96402,0.0952622,-9.09875e-05,4.59032e-08,-9.05482e-12,-33956.8,36.0859], Tmin=(100,'K'), Tmax=(1330.85,'K')), NASAPolynomial(coeffs=[20.0697,0.0266525,-7.58155e-06,1.0788e-09,-6.28291e-14,-39077.9,-69.608], Tmin=(1330.85,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-283.917,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdOsH) + ring(Oxetane) + radical(Cs_P) + radical((O)CJOC)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['CCC1(O[C]=O)OC[C]1O(10082)'],
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'CCC1(O[C]=O)OCC1=O(16590)'],
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'CCC1(O[C]=O)OC=C1O(16591)'],
    products = ['CCC1(O[C]=O)OC[C]1O(10082)'],
    transitionState = 'TS3',
...
reaction(
    ...
    products = ['CCC1(O[C]=O)OC[C]1O(10082)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(23.3993,'m^3/(mol*s)'), n=2.021, Ea=(55.6619,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Od_R;YJ] for rate rule [Od_Cdd-O2d;CJ]
Euclidian distance = 2.2360679775
Multiplied by reaction path degeneracy 2.0
family: R_Addition_MultipleBond
Ea raised from 51.1 to 55.7 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction5',
    reactants = ['C2H5(29)', 'O=[C]OC1OCC=1O(16592)'],
    products = ['CCC1(O[C]=O)OC[C]1O(10082)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['CCC1(O[C]=O)OCC1[O](16593)'],
    products = ['CCC1(O[C]=O)OC[C]1O(10082)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['CCC1(O[C]=O)O[CH]C1O(16594)'],
    products = ['CCC1(O[C]=O)OC[C]1O(10082)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['C[CH]C1(O[C]=O)OCC1O(16595)'],
    products = ['CCC1(O[C]=O)OC[C]1O(10082)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['CCC1(O[C]=O)OC[C]1O(10082)'],
    products = ['C[CH]C1(OC=O)OC[C]1O(16596)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]CC1(O[C]=O)OCC1O(16597)'],
    products = ['CCC1(O[C]=O)OC[C]1O(10082)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CCC1(O[C]=O)OC[C]1O(10082)'],
    products = ['CCC1(O[CH][C]1O)OC=O(16598)'],
    transitionState = 'TS11',
    kinetics = Arrhenius(A=(134341,'s^-1'), n=1.77845, Ea=(41.7861,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R5H_SSSS;Y_rad_out;XH_out] for rate rule [R5H_SSSS;CO_rad_out;XH_out]
Euclidian distance = 1.0
Multiplied by reaction path degeneracy 2.0
family: intra_H_migration"""),
)
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]CC1(OC=O)OC[C]1O(16599)'],
    products = ['CCC1(O[C]=O)OC[C]1O(10082)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CCC1(OC=O)OC[C]1[O](16600)'],
    products = ['CCC1(O[C]=O)OC[C]1O(10082)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CCC(O[C]=O)=C(O)C[O](16601)'],
    products = ['CCC1(O[C]=O)OC[C]1O(10082)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CCC1(O[C]=O)OC[C]1O(10082)'],
    products = ['CCC1(OC=O)OCC1=O(8732)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CCC1(O[C]=O)OC[C]1O(10082)'],
    products = ['CCC1(OC=O)OC=C1O(16602)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CH2(S)(23)', 'CC1(O[C]=O)OC[C]1O(16603)'],
    products = ['CCC1(O[C]=O)OC[C]1O(10082)'],
...
reaction(
    label = 'reaction20',
    reactants = ['CCC1(O)CO[C]1O[C]=O(16604)'],
    products = ['CCC1(O[C]=O)OC[C]1O(10082)'],
...
reaction(
    label = 'reaction22',
    reactants = ['CO(12)', 'CCC1([O])OC[C]1O(5521)'],
    products = ['CCC1(O[C]=O)OC[C]1O(10082)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[C]=O(361)', 'CCC1([O])OC[C]1O(5521)'],
    products = ['CCC1(O[C]=O)OC[C]1O(10082)'],
