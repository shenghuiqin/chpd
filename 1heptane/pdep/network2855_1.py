...
species(
    label = 'C=C(OO)C([O])CC(16225)',
    structure = SMILES('C=C(OO)C([O])CC'),
    E0 = (-72.8117,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (117.123,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.289089,0.0783558,-6.68022e-05,2.93695e-08,-5.25264e-12,-8621.11,32.8185], Tmin=(100,'K'), Tmax=(1319.28,'K')), NASAPolynomial(coeffs=[15.6514,0.0317784,-1.38451e-05,2.60923e-09,-1.8169e-13,-12674.6,-45.5527], Tmin=(1319.28,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-72.8117,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(CC(C)OJ)"""),
)
...
species(
    ...
    molecularWeight = (118.131,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.433078,0.103555,-0.000132227,9.47425e-08,-2.77033e-11,-5971.25,34.673], Tmin=(100,'K'), Tmax=(830.444,'K')), NASAPolynomial(coeffs=[12.6237,0.0406626,-1.86221e-05,3.5394e-09,-2.46247e-13,-8139.75,-25.8919], Tmin=(830.444,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-50.9297,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(403.252,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJCOOH) + radical(C2CsJOH)"""),
)
...
species(
    ...
    molecularWeight = (118.131,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.120616,0.0970605,-0.000119106,8.56358e-08,-2.56612e-11,-4747.52,34.4226], Tmin=(100,'K'), Tmax=(804.729,'K')), NASAPolynomial(coeffs=[10.5252,0.044143,-2.04664e-05,3.91785e-09,-2.7389e-13,-6460.89,-14.6244], Tmin=(804.729,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-40.6584,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(403.252,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(C2CsJOOH) + radical(CJCOOH)"""),
)

species(
    label = '[CH2]C(OO)C(O)[CH]C(16228)',
    structure = SMILES('[CH2]C(OO)C(O)[CH]C'),
    E0 = (-27.6555,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1277.5,1000,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,3000,3100,440,815,1455,1000,3615,1310,387.5,850,1000,200,800],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (118.131,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.115899,0.0901268,-8.89551e-05,4.67296e-08,-9.97426e-12,-3177.6,36.5958], Tmin=(100,'K'), Tmax=(1122.73,'K')), NASAPolynomial(coeffs=[15.4203,0.0347753,-1.5004e-05,2.81815e-09,-1.96453e-13,-6666.2,-40.156], Tmin=(1122.73,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-27.6555,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(403.252,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJCOOH) + radical(CCJCO)"""),
)

species(
    label = 'CC[C]([O])C(C)OO(16229)',
    structure = SMILES('CC[C]([O])C(C)OO'),
    E0 = (-34.5315,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (118.131,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0685669,0.0951696,-0.000107002,6.86651e-08,-1.83749e-11,-4011.56,31.1821], Tmin=(100,'K'), Tmax=(895.195,'K')), NASAPolynomial(coeffs=[11.5585,0.0432161,-1.99482e-05,3.83418e-09,-2.69619e-13,-6093.25,-23.6244], Tmin=(895.195,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-34.5315,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(407.409,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(C2CsJOH) + radical(CC(C)OJ)"""),
)

species(
    label = 'CCC([O])C(C)O[O](16230)',
    structure = SMILES('CCC([O])C(C)O[O]'),
    E0 = (-59.1546,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,492.5,1135,1000,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (118.131,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.309722,0.0834827,-7.76275e-05,4.04942e-08,-8.87741e-12,-6983.69,31.147], Tmin=(100,'K'), Tmax=(1074.27,'K')), NASAPolynomial(coeffs=[11.823,0.0406146,-1.77723e-05,3.35038e-09,-2.33639e-13,-9457.42,-25.2228], Tmin=(1074.27,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-59.1546,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(CC(C)OJ)"""),
)

species(
    label = 'C[CH]C([O])C(C)OO(16231)',
    structure = SMILES('C[CH]C([O])C(C)OO'),
    E0 = (-11.2573,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (118.131,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0380402,0.0843241,-7.31487e-05,3.32905e-08,-6.19163e-12,-1209.09,33.8525], Tmin=(100,'K'), Tmax=(1270.47,'K')), NASAPolynomial(coeffs=[15.6585,0.0351434,-1.5082e-05,2.82011e-09,-1.95661e-13,-5178.09,-45.2461], Tmin=(1270.47,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-11.2573,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(407.409,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJCO) + radical(CC(C)OJ)"""),
)

species(
    label = '[CH2]CC(O)C([CH2])OO(16232)',
    structure = SMILES('[CH2]CC(O)C([CH2])OO'),
    E0 = (-22.3112,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,3615,1310,387.5,850,1000,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,3615,1277.5,1000,200,800],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (118.131,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.150271,0.0945086,-0.000102079,6.01953e-08,-1.45328e-11,-2536.61,36.0178], Tmin=(100,'K'), Tmax=(995.196,'K')), NASAPolynomial(coeffs=[13.8818,0.0381093,-1.70713e-05,3.25037e-09,-2.279e-13,-5329.56,-31.6114], Tmin=(995.196,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-22.3112,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(403.252,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJ) + radical(CJCOOH)"""),
)

species(
    label = '[CH2]CC([O])C(C)OO(16233)',
    structure = SMILES('[CH2]CC([O])C(C)OO'),
    E0 = (-5.91295,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (118.131,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.10988,0.0875015,-8.23148e-05,4.20164e-08,-8.90163e-12,-572.7,32.8909], Tmin=(100,'K'), Tmax=(1114.83,'K')), NASAPolynomial(coeffs=[13.4956,0.0394756,-1.76986e-05,3.37757e-09,-2.37214e-13,-3557.36,-33.1428], Tmin=(1114.83,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-5.91295,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(407.409,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(RCCJ)"""),
)

species(
    label = '[CH2]C(O[O])C(O)CC(16234)',
    ...
    molecularWeight = (118.131,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0243284,0.0908036,-9.85434e-05,6.02117e-08,-1.51726e-11,-8946.57,34.3632], Tmin=(100,'K'), Tmax=(953.561,'K')), NASAPolynomial(coeffs=[12.386,0.0389486,-1.69725e-05,3.1825e-09,-2.20955e-13,-11304.1,-24.6869], Tmin=(953.561,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-75.5528,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(407.409,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(CJCOOH)"""),
)

species(
    label = 'CCC(=O)C(C)OO(16235)',
    structure = SMILES('CCC(=O)C(C)OO'),
    E0 = (-381.987,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (118.131,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.482519,0.0785252,-6.28075e-05,2.64897e-08,-4.68723e-12,-45817.1,30.5127], Tmin=(100,'K'), Tmax=(1296.37,'K')), NASAPolynomial(coeffs=[13.0439,0.0397671,-1.79621e-05,3.4281e-09,-2.39956e-13,-49074,-33.3497], Tmin=(1296.37,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-381.987,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(407.409,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-O2d)CsOsH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdCsCs)"""),
)

species(
    label = 'C=C(OO)C(O)CC(16236)',
    structure = SMILES('C=C(OO)C(O)CC'),
    E0 = (-303.172,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (118.131,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.172644,0.0818124,-7.08951e-05,3.21776e-08,-5.97048e-12,-36323.6,33.4281], Tmin=(100,'K'), Tmax=(1272.1,'K')), NASAPolynomial(coeffs=[15.3003,0.0342448,-1.48057e-05,2.78295e-09,-1.93686e-13,-40172.4,-43.1949], Tmin=(1272.1,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-303.172,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(407.409,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH)"""),
)
...
species(
    label = 'CCC([O])C1CO1(16237)',
    structure = SMILES('CCC([O])C1CO1'),
    E0 = (-93.1006,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
species(
    ...
    molecularWeight = (118.131,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.117309,0.0864205,-8.32467e-05,4.40068e-08,-9.60338e-12,-25374.5,32.8261], Tmin=(100,'K'), Tmax=(1090.36,'K')), NASAPolynomial(coeffs=[13.3924,0.0377214,-1.62525e-05,3.04579e-09,-2.11857e-13,-28269.4,-32.3669], Tmin=(1090.36,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-212.131,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(CC(C)OJ)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(OO)C([O])CC(13481)'],
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', '[CH2]C(OO)C(=O)CC(16224)'],
    products = ['[CH2]C(OO)C([O])CC(13481)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'C=C(OO)C([O])CC(16225)'],
    products = ['[CH2]C(OO)C([O])CC(13481)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['C2H5(29)', '[CH2]C(C=O)OO(10685)'],
    products = ['[CH2]C(OO)C([O])CC(13481)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['CH2CHOOH(64)', 'CC[CH][O](563)'],
    products = ['[CH2]C(OO)C([O])CC(13481)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['HO2(10)', 'C=CC([O])CC(10590)'],
    products = ['[CH2]C(OO)C([O])CC(13481)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]C(OO)C([O])CC(13481)'],
    products = ['[CH2]C(OO)[C](O)CC(16226)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]C(OO)C([O])CC(13481)'],
    products = ['[CH2][C](OO)C(O)CC(16227)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]C(OO)C(O)[CH]C(16228)'],
    products = ['[CH2]C(OO)C([O])CC(13481)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]C(OO)C([O])CC(13481)'],
    products = ['C[CH]C([O])C(C)OO(16231)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]CC(O)C([CH2])OO(16232)'],
    products = ['[CH2]C(OO)C([O])CC(13481)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]C(OO)C([O])CC(13481)'],
    products = ['[CH2]CC([O])C(C)OO(16233)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]C(OO)C([O])CC(13481)'],
    products = ['[CH2]C(O[O])C(O)CC(16234)'],
...
reaction(
    label = 'reaction21',
    reactants = ['CH2(S)(23)', '[CH2]C(OO)C(C)[O](8867)'],
    products = ['[CH2]C(OO)C([O])CC(13481)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH2]C(OO)C([O])CC(13481)'],
    products = ['OH(5)', 'CCC([O])C1CO1(16237)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH2]C(OO)C([O])CC(13481)'],
    products = ['OH(5)', '[CH2]C1OOC1CC(16238)'],
...
reaction(
    label = 'reaction27',
    reactants = ['O(4)', '[CH2]C([CH]CC)OO(5695)'],
    products = ['[CH2]C(OO)C([O])CC(13481)'],
...
reaction(
    label = 'reaction28',
    reactants = ['CH2(19)', 'CCC([O])[CH]OO(11587)'],
    products = ['[CH2]C(OO)C([O])CC(13481)'],
