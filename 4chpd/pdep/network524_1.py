species(
    label = '[CH2]CO[CH]C(2271)',
    structure = SMILES('[CH2]CO[CH]C'),
    E0 = (118.672,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,2750,2850,1437.5,1250,1305,750,350,3025,407.5,1350,352.5,289.026,289.037,289.041],'cm^-1')),
        HinderedRotor(inertia=(0.00201766,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00201793,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.218082,'amu*angstrom^2'), symmetry=1, barrier=(12.9301,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.218124,'amu*angstrom^2'), symmetry=1, barrier=(12.9301,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
species(
    label = '[CH2]COC=C(3585)',
    structure = SMILES('[CH2]COC=C'),
    E0 = (26.0821,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,3100,1380,975,1025,1650,3010,987.5,1337.5,450,1655,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,198.612,198.865,200.308],'cm^-1')),
        HinderedRotor(inertia=(0.750841,'amu*angstrom^2'), symmetry=1, barrier=(21.2895,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.757852,'amu*angstrom^2'), symmetry=1, barrier=(21.2912,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.759036,'amu*angstrom^2'), symmetry=1, barrier=(21.2884,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (71.0978,'amu'),
...
reaction(
    label = 'reaction2',
    reactants = ['H(19)', 'C=CO[CH]C(3584)'],
    products = ['[CH2]CO[CH]C(2271)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]C[O](362)', 'CHCH3(T)(359)'],
    products = ['[CH2]CO[CH]C(2271)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CH2(T)(33)', '[CH2]O[CH]C(3036)'],
    products = ['[CH2]CO[CH]C(2271)'],
