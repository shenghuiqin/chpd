...
species(
    ...
    E0 = (103.269,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,3615,1277.5,1000,2950,3100,1380,975,1025,1650],'cm^-1')),
