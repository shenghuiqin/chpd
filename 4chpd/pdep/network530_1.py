...
species(
    label = 'C[CH]OC1=CC=CCCC1(2459)',
    structure = SMILES('C[CH]OC1=CC=CCCC1'),
    E0 = (33.3556,'kJ/mol'),
    modes = [
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.95959,0.11196,-7.09599e-05,-3.41964e-10,1.13673e-11,4243.36,21.2666], Tmin=(100,'K'), Tmax=(984.607,'K')), NASAPolynomial(coeffs=[28.2719,0.0308346,-1.08822e-05,1.98431e-09,-1.42527e-13,-3730.71,-134.376], Tmin=(984.607,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(33.3556,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(544.598,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + ring(1,3-Cycloheptadiene) + radical(CCsJOC(O))"""),
)

species(
    label = 'C=COC1[CH]C=CCCC1(2460)',
    ...
    molecularWeight = (137.199,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.675983,0.0313853,0.000243606,-3.92862e-07,1.69166e-10,-664.484,32.6636], Tmin=(100,'K'), Tmax=(909.489,'K')), NASAPolynomial(coeffs=[53.7665,-0.0211475,2.1982e-05,-4.44636e-09,2.86074e-13,-18297.8,-267.323], Tmin=(909.489,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-7.48082,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(548.755,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + ring(Cycloheptene) + radical(C=CCJCO)"""),
)

species(
    label = 'C[CH]OC1C=C=CCCC1(2461)',
    ...
    molecularWeight = (137.199,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.764376,0.0892843,-4.00254e-05,-6.48078e-09,7.1528e-12,22707.3,32.025], Tmin=(100,'K'), Tmax=(1105.94,'K')), NASAPolynomial(coeffs=[18.8746,0.0460246,-1.9018e-05,3.56142e-09,-2.49907e-13,16665,-72.3775], Tmin=(1105.94,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(187.264,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(544.598,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cdd-CdsCds) + ring(1_2_cycloheptadiene) + radical(CCsJOCs)"""),
)
...
species(
    label = 'C[CH]O[C]1CC=CCCC1(2462)',
    structure = SMILES('C[CH]O[C]1CC=CCCC1'),
    E0 = (148.896,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2794.44,2838.89,2883.33,2927.78,2972.22,3016.67,3061.11,3105.56,3150,900,922.222,944.444,966.667,988.889,1011.11,1033.33,1055.56,1077.78,1100,3025,407.5,1350,352.5,300,800,800,800,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (138.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.741633,0.0558013,0.000131127,-2.4509e-07,1.08991e-10,18124.1,38.0855], Tmin=(100,'K'), Tmax=(910.594,'K')), NASAPolynomial(coeffs=[40.201,0.00311522,8.44132e-06,-1.90821e-09,1.21469e-13,5395.6,-184.553], Tmin=(910.594,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(148.896,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(569.541,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cycloheptene) + radical(C2CsJOCs) + radical(CCsJOCs)"""),
)

species(
    label = '[CH2]COC1[CH]C=CCCC1(2463)',
    structure = SMILES('[CH2]COC1[CH]C=CCCC1'),
    E0 = (116.242,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (138.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.728347,0.0474151,0.000172784,-2.96308e-07,1.28497e-10,14203.7,35.7853], Tmin=(100,'K'), Tmax=(915.265,'K')), NASAPolynomial(coeffs=[44.021,-0.000844727,1.04551e-05,-2.22125e-09,1.36856e-13,-157.911,-209.849], Tmin=(915.265,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(116.242,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(569.541,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cycloheptene) + radical(C=CCJCO) + radical(CJCO)"""),
)

species(
    label = 'C[CH]OC1C[C]=CCCC1(2464)',
    structure = SMILES('C[CH]OC1C[C]=CCCC1'),
    E0 = (206.034,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2794.44,2838.89,2883.33,2927.78,2972.22,3016.67,3061.11,3105.56,3150,900,922.222,944.444,966.667,988.889,1011.11,1033.33,1055.56,1077.78,1100,3025,407.5,1350,352.5,300,800,800,800,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
    ...
    molecularWeight = (138.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.683936,0.0497867,0.000156716,-2.76906e-07,1.21488e-10,24998.6,37.7129], Tmin=(100,'K'), Tmax=(911.332,'K')), NASAPolynomial(coeffs=[42.5701,-0.000759148,1.06252e-05,-2.30627e-09,1.46291e-13,11330.1,-198.685], Tmin=(911.332,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(206.034,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(569.541,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cycloheptene) + radical(CCsJOCs) + radical(Cds_S)"""),
)

species(
    label = 'CCO[C]1[CH]C=CCCC1(2465)',
    structure = SMILES('CCOC1=C[CH][CH]CCC1'),
    E0 = (79.1576,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (138.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.115255,0.0315689,0.000209294,-3.3106e-07,1.40605e-10,9723.66,35.8998], Tmin=(100,'K'), Tmax=(912.777,'K')), NASAPolynomial(coeffs=[42.4937,-0.00166237,1.16667e-05,-2.49127e-09,1.55872e-13,-4448.99,-200.801], Tmin=(912.777,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(79.1576,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(569.541,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + ring(Cycloheptene) + radical(RCCJCC) + radical(Allyl_S)"""),
)

species(
    label = 'C[CH]OC1[CH]CCC=CC1(2466)',
    structure = SMILES('C[CH]OC1[CH]CCC=CC1'),
    E0 = (168.095,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2794.44,2838.89,2883.33,2927.78,2972.22,3016.67,3061.11,3105.56,3150,900,922.222,944.444,966.667,988.889,1011.11,1033.33,1055.56,1077.78,1100,3025,407.5,1350,352.5,300,800,800,800,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (138.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.470362,0.0401328,0.000189609,-3.15076e-07,1.361e-10,20432.5,38.9693], Tmin=(100,'K'), Tmax=(911.215,'K')), NASAPolynomial(coeffs=[44.3564,-0.00461032,1.29903e-05,-2.75128e-09,1.74711e-13,5951.27,-207.76], Tmin=(911.215,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(168.095,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(569.541,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cycloheptene) + radical(CCsJOCs) + radical(CCJCO)"""),
)

species(
    label = 'C[CH]OC1CC=[C]CCC1(2467)',
    structure = SMILES('C[CH]OC1CC=[C]CCC1'),
    E0 = (206.034,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (138.207,'amu'),
...
species(
    label = 'C[CH]OC1C[CH]CC=CC1(2469)',
    structure = SMILES('C[CH]OC1C[CH]CC=CC1'),
    E0 = (162.651,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2794.44,2838.89,2883.33,2927.78,2972.22,3016.67,3061.11,3105.56,3150,900,922.222,944.444,966.667,988.889,1011.11,1033.33,1055.56,1077.78,1100,3025,407.5,1350,352.5,300,800,800,800,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (138.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.376726,0.0454138,0.000158477,-2.7131e-07,1.17741e-10,19767.5,38.7006], Tmin=(100,'K'), Tmax=(912.02,'K')), NASAPolynomial(coeffs=[39.3647,0.00391761,8.30188e-06,-1.87246e-09,1.17445e-13,6995.25,-179.649], Tmin=(912.02,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(162.651,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(569.541,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cycloheptene) + radical(RCCJCC) + radical(CCsJOCs)"""),
)

species(
    label = 'C[CH]OC1CC=C[CH]CC1(2470)',
    structure = SMILES('C[CH]OC1CC=C[CH]CC1'),
    E0 = (109.305,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2794.44,2838.89,2883.33,2927.78,2972.22,3016.67,3061.11,3105.56,3150,900,922.222,944.444,966.667,988.889,1011.11,1033.33,1055.56,1077.78,1100,3025,407.5,1350,352.5,300,800,800,800,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (138.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.458186,0.0400256,0.000190246,-3.14417e-07,1.35341e-10,13361.1,35.3222], Tmin=(100,'K'), Tmax=(912.725,'K')), NASAPolynomial(coeffs=[43.8517,-0.00282809,1.1967e-05,-2.54148e-09,1.5962e-13,-1031.02,-208.932], Tmin=(912.725,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(109.305,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(569.541,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cycloheptene) + radical(Allyl_S) + radical(CCsJOCs)"""),
)

species(
    label = '[CH2][CH]OC1CC=CCCC1(2471)',
    structure = SMILES('[CH2][CH]OC1CC=CCCC1'),
    E0 = (179.782,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (138.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.809031,0.0504377,0.000161584,-2.86887e-07,1.26296e-10,21847.6,38.3223], Tmin=(100,'K'), Tmax=(910.276,'K')), NASAPolynomial(coeffs=[44.5996,-0.0040839,1.24624e-05,-2.66118e-09,1.70252e-13,7572.73,-209.48], Tmin=(910.276,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(179.782,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(569.541,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cycloheptene) + radical(CJCO) + radical(CCsJOCs)"""),
)

species(
    label = 'CCOC1[CH]C=CC[CH]C1(2472)',
    structure = SMILES('CCOC1[CH]C=CC[CH]C1'),
    E0 = (99.1116,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2800,2850,2900,2950,3000,3050,3100,3150,900,925,950,975,1000,1025,1050,1075,1100,2750,2850,1437.5,1250,1305,750,350,300,800,800,800,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (138.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.296586,0.0423969,0.000169663,-2.80721e-07,1.19944e-10,12123.6,36.1656], Tmin=(100,'K'), Tmax=(917.469,'K')), NASAPolynomial(coeffs=[38.7924,0.00714624,6.30067e-06,-1.43396e-09,8.41673e-14,-738.012,-180.053], Tmin=(917.469,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(99.1116,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(569.541,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cycloheptene) + radical(RCCJCC) + radical(C=CCJCO)"""),
)

species(
    label = 'CCOC1[CH][C]=CCCC1(2473)',
    structure = SMILES('CCOC1[CH][C]=CCCC1'),
    E0 = (142.495,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2800,2850,2900,2950,3000,3050,3100,3150,900,925,950,975,1000,1025,1050,1075,1100,2750,2850,1437.5,1250,1305,750,350,300,800,800,800,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (138.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.6037,0.046769,0.000167902,-2.86313e-07,1.23686e-10,17354.7,35.1775], Tmin=(100,'K'), Tmax=(916.532,'K')), NASAPolynomial(coeffs=[41.9956,0.00247319,8.62181e-06,-1.86727e-09,1.12972e-13,3597.74,-199.076], Tmin=(916.532,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(142.495,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(569.541,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cycloheptene) + radical(Cds_S) + radical(C=CCJCO)"""),
)

species(
    label = 'CCOC1[CH]C=C[CH]CC1(2474)',
    structure = SMILES('CCOC1[CH]C=C[CH]CC1'),
    E0 = (45.7659,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (138.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.37693,0.0369944,0.000201487,-3.23907e-07,1.37581e-10,5717.14,32.7833], Tmin=(100,'K'), Tmax=(917.468,'K')), NASAPolynomial(coeffs=[43.2771,0.000404689,9.96333e-06,-2.10238e-09,1.26292e-13,-8763.36,-209.323], Tmin=(917.468,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(45.7659,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(569.541,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cycloheptene) + radical(C=CCJCO) + radical(Allyl_S)"""),
)

species(
    label = 'CCOC1[CH]C=[C]CCC1(2475)',
    structure = SMILES('CCOC1[CH]C=[C]CCC1'),
    E0 = (142.495,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2800,2850,2900,2950,3000,3050,3100,3150,900,925,950,975,1000,1025,1050,1075,1100,2750,2850,1437.5,1250,1305,750,350,300,800,800,800,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (138.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.6037,0.046769,0.000167902,-2.86313e-07,1.23686e-10,17354.7,35.1775], Tmin=(100,'K'), Tmax=(916.532,'K')), NASAPolynomial(coeffs=[41.9956,0.00247319,8.62181e-06,-1.86727e-09,1.12972e-13,3597.74,-199.076], Tmin=(916.532,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(142.495,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(569.541,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cycloheptene) + radical(C=CCJCO) + radical(Cds_S)"""),
)
...
species(
    label = 'C[CH]OC1CCCC2[CH]C21(2476)',
    structure = SMILES('C[CH]OC1CCCC2[CH]C21'),
    E0 = (242.343,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (138.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.423223,0.0819434,-2.1593e-05,-1.93647e-08,1.00401e-11,29319.1,33.905], Tmin=(100,'K'), Tmax=(1130.32,'K')), NASAPolynomial(coeffs=[16.192,0.0527644,-2.21774e-05,4.16329e-09,-2.91405e-13,23671,-56.6588], Tmin=(1130.32,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(242.343,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(569.541,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + polycyclic(s2_3_6_ane) + radical(CCsJOCs) + radical(bicyclo[4.1.0]heptane-C3-7)"""),
)
...
species(
    label = '[CH2]CCC=CC=CO[CH]C(2477)',
    structure = SMILES('[CH2]CCC=CC=CO[CH]C'),
    E0 = (182.987,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (138.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.14895,0.116056,-7.48776e-05,-8.41353e-10,1.28946e-11,22247,41.6114], Tmin=(100,'K'), Tmax=(963.457,'K')), NASAPolynomial(coeffs=[29.2162,0.0300324,-9.75476e-06,1.70809e-09,-1.21295e-13,14152,-119.185], Tmin=(963.457,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(182.987,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(552.912,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsOsH) + radical(CCsJOC(O)) + radical(RCCJ)"""),
)

species(
    label = 'CCOC1=CC=CCCC1(2478)',
    structure = SMILES('CCOC1=CC=CCCC1'),
    E0 = (-160.572,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (138.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.59626,0.102601,-4.41609e-05,-2.29567e-08,1.78199e-11,-19092.7,20.4895], Tmin=(100,'K'), Tmax=(992.323,'K')), NASAPolynomial(coeffs=[25.8741,0.0371411,-1.36447e-05,2.51681e-09,-1.80474e-13,-26773.5,-123.059], Tmin=(992.323,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-160.572,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(569.541,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + ring(1,3-Cycloheptadiene)"""),
)

species(
    label = 'C=COC1CC=CCCC1(2479)',
    structure = SMILES('C=COC1CC=CCCC1'),
    E0 = (-124.398,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (138.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.458706,0.0274456,0.000251282,-3.96573e-07,1.69482e-10,-14734.9,34.6844], Tmin=(100,'K'), Tmax=(909.434,'K')), NASAPolynomial(coeffs=[51.6372,-0.0171288,2.03914e-05,-4.16671e-09,2.67716e-13,-31842.7,-253.664], Tmin=(909.434,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-124.398,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(573.699,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + ring(Cycloheptene)"""),
)

species(
    label = 'CCOC1C=C=CCCC1(2480)',
    structure = SMILES('CCOC1C=C=CCCC1'),
    E0 = (6.8084,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (138.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.456124,0.0821127,-1.99569e-05,-2.19154e-08,1.10276e-11,992.525,31.4774], Tmin=(100,'K'), Tmax=(1123.22,'K')), NASAPolynomial(coeffs=[16.6132,0.0525669,-2.22207e-05,4.19064e-09,-2.9435e-13,-4812.73,-61.6282], Tmin=(1123.22,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(6.8084,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(569.541,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cdd-CdsCds) + ring(1_2_cycloheptadiene)"""),
)
...
species(
    label = 'C[CH]OC1C=CC=CCC1(2482)',
    structure = SMILES('C[CH]OC1C=CC=CCC1'),
    E0 = (63.6978,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2800,2850,2900,2950,3000,3050,3100,3150,900,925,950,975,1000,1025,1050,1075,1100,3025,407.5,1350,352.5,300,800,800,800,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (137.199,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.67964,0.108777,-7.6086e-05,1.601e-08,2.78284e-12,7879.5,22.456], Tmin=(100,'K'), Tmax=(1048.7,'K')), NASAPolynomial(coeffs=[24.4672,0.0374071,-1.45678e-05,2.69005e-09,-1.89368e-13,835.969,-112.366], Tmin=(1048.7,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(63.6978,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(544.598,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + ring(1,3-Cycloheptadiene) + radical(CCsJOCs)"""),
)
...
species(
    label = 'CCOC1[C]=C[CH]CCC1(2487)',
    structure = SMILES('CCOC1[C]=C[CH]CCC1'),
    E0 = (166.355,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,2900,2950,3000,3050,3100,3150,900,925,950,975,1000,1025,1050,1075,1100,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,300,800,800,800,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (138.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.148109,0.0345005,0.000196495,-3.12928e-07,1.3247e-10,20210,36.1452], Tmin=(100,'K'), Tmax=(917.542,'K')), NASAPolynomial(coeffs=[41.031,0.00210061,8.95107e-06,-1.91163e-09,1.14171e-13,6460.42,-192.724], Tmin=(917.542,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(166.355,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(569.541,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cycloheptene) + radical(Allyl_S) + radical(Cds_S)"""),
)
...
species(
    label = 'CC1OC2CCC[CH][CH]C12(2490)',
    structure = SMILES('CC1OC2CCC[CH][CH]C12'),
    E0 = (2.00952,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (138.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.557186,0.104904,-7.74123e-05,3.0148e-08,-5.02284e-12,401.169,3.5887], Tmin=(100,'K'), Tmax=(1336.82,'K')), NASAPolynomial(coeffs=[14.3109,0.0604159,-2.74941e-05,5.25402e-09,-3.67396e-13,-3574.02,-72.4572], Tmin=(1336.82,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(2.00952,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(577.856,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + polycyclic(PolycyclicRing) + radical(cycloheptane) + radical(cycloheptane)"""),
)

species(
    label = '[CH2]CC(C=CC=C)O[CH]C(2491)',
    structure = SMILES('[CH2]CC(C=CC=C)O[CH]C'),
    E0 = (207.564,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (138.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.96981,0.117309,-0.00010242,4.58525e-08,-8.16717e-12,25190.7,44.0623], Tmin=(100,'K'), Tmax=(1353.22,'K')), NASAPolynomial(coeffs=[24.8304,0.0380889,-1.46069e-05,2.59097e-09,-1.74772e-13,17937.5,-93.3395], Tmin=(1353.22,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(207.564,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(552.912,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + radical(CCsJOCs) + radical(RCCJ)"""),
)

species(
    label = 'CCOC1C=CC=CCC1(2492)',
    structure = SMILES('CCOC1C=CC=CCC1'),
    E0 = (-116.758,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (138.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.39655,0.101912,-5.71343e-05,2.07571e-09,5.99986e-12,-13834.2,21.9979], Tmin=(100,'K'), Tmax=(1077.11,'K')), NASAPolynomial(coeffs=[22.2282,0.043901,-1.77385e-05,3.31106e-09,-2.33088e-13,-20647.6,-101.736], Tmin=(1077.11,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-116.758,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(569.541,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + ring(1,3-Cycloheptadiene)"""),
)
...
species(
    label = '[CH2]C1C=CC(CC1)O[CH]C(2494)',
    structure = SMILES('[CH2]C1C=CC(CC1)O[CH]C'),
    E0 = (142.909,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,2750,2807.14,2864.29,2921.43,2978.57,3035.71,3092.86,3150,900,928.571,957.143,985.714,1014.29,1042.86,1071.43,1100,3025,407.5,1350,352.5,300,800,800,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (138.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.714984,0.0818348,2.10693e-06,-6.23522e-08,3.00203e-11,17377.2,36.4078], Tmin=(100,'K'), Tmax=(980.652,'K')), NASAPolynomial(coeffs=[21.7145,0.0417166,-1.51032e-05,2.76415e-09,-1.9763e-13,10508.1,-83.957], Tmin=(980.652,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(142.909,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(565.384,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cyclohexene) + radical(CCsJOCs) + radical(Isobutyl)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['C[CH]OC1[CH]C=CCCC1(2276)'],
...
reaction(
    label = 'reaction3',
    reactants = ['H(19)', 'C[CH]OC1=CC=CCCC1(2459)'],
...
reaction(
    label = 'reaction4',
    reactants = ['H(19)', 'C=COC1[CH]C=CCCC1(2460)'],
    products = ['C[CH]OC1[CH]C=CCCC1(2276)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H(19)', 'C[CH]OC1C=C=CCCC1(2461)'],
    products = ['C[CH]OC1[CH]C=CCCC1(2276)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['C[CH]O[C]1CC=CCCC1(2462)'],
    products = ['C[CH]OC1[CH]C=CCCC1(2276)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]COC1[CH]C=CCCC1(2463)'],
    products = ['C[CH]OC1[CH]C=CCCC1(2276)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['C[CH]OC1C[C]=CCCC1(2464)'],
    products = ['C[CH]OC1[CH]C=CCCC1(2276)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['C[CH]OC1[CH]C=CCCC1(2276)'],
    products = ['CCO[C]1[CH]C=CCCC1(2465)'],
...
reaction(
    label = 'reaction11',
    reactants = ['C[CH]OC1[CH]CCC=CC1(2466)'],
    products = ['C[CH]OC1[CH]C=CCCC1(2276)'],
...
reaction(
    label = 'reaction12',
    reactants = ['C[CH]OC1[CH]C=CCCC1(2276)'],
    products = ['C[CH]OC1CC=[C]CCC1(2467)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CCOC1[CH]C=CCC[CH]1(2468)'],
    products = ['C[CH]OC1[CH]C=CCCC1(2276)'],
...
reaction(
    label = 'reaction14',
    reactants = ['C[CH]OC1C[CH]CC=CC1(2469)'],
    products = ['C[CH]OC1[CH]C=CCCC1(2276)'],
...
reaction(
    label = 'reaction15',
    reactants = ['C[CH]OC1CC=C[CH]CC1(2470)'],
    products = ['C[CH]OC1[CH]C=CCCC1(2276)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2][CH]OC1CC=CCCC1(2471)'],
    products = ['C[CH]OC1[CH]C=CCCC1(2276)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CCOC1[CH]C=CC[CH]C1(2472)'],
    products = ['C[CH]OC1[CH]C=CCCC1(2276)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CCOC1[CH][C]=CCCC1(2473)'],
    products = ['C[CH]OC1[CH]C=CCCC1(2276)'],
...
reaction(
    label = 'reaction19',
    reactants = ['C[CH]OC1[CH]C=CCCC1(2276)'],
    products = ['CCOC1[CH]C=C[CH]CC1(2474)'],
    transitionState = 'TS19',
    kinetics = Arrhenius(A=(256.687,'s^-1'), n=2.005, Ea=(45.3964,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R6H_SSSSS;C_rad_out_single;Cs_H_out_H/Cd] for rate rule [R6H_SSSSS_OO;C_rad_out_H/NonDeC;Cs_H_out_H/Cd]
...
reaction(
    label = 'reaction20',
    reactants = ['CCOC1[CH]C=[C]CCC1(2475)'],
    products = ['C[CH]OC1[CH]C=CCCC1(2276)'],
...
reaction(
    label = 'reaction22',
    reactants = ['C[CH]OC1[CH]C=CCCC1(2276)'],
    products = ['C[CH]OC1CCCC2[CH]C21(2476)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[CH2]CCC=CC=CO[CH]C(2477)'],
    products = ['C[CH]OC1[CH]C=CCCC1(2276)'],
...
reaction(
    label = 'reaction28',
    reactants = ['C[CH]O[CH]C1C=CCCC1(2481)'],
    products = ['C[CH]OC1[CH]C=CCCC1(2276)'],
...
reaction(
    label = 'reaction30',
    reactants = ['CHCH3(T)(359)', '[O]C1C=C[CH]CCC1(1866)'],
    products = ['C[CH]OC1[CH]C=CCCC1(2276)'],
...
reaction(
    label = 'reaction31',
    reactants = ['H(19)', 'C[CH]OC1C=CC=CCC1(2482)'],
    products = ['C[CH]OC1[CH]C=CCCC1(2276)'],
...
reaction(
    label = 'reaction32',
    reactants = ['C[CH]OC1C=CC[CH]CC1(2483)'],
    products = ['C[CH]OC1[CH]C=CCCC1(2276)'],
...
reaction(
    label = 'reaction36',
    reactants = ['CCOC1[C]=C[CH]CCC1(2487)'],
    products = ['C[CH]OC1[CH]C=CCCC1(2276)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(1062,'s^-1'), n=1.81, Ea=(55.2288,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R7Hall;C_rad_out_2H;Cs_H_out_H/NonDeC] for rate rule [R7HJ_1;C_rad_out_2H;Cs_H_out_H/(NonDeC/Cs)]
...
reaction(
    label = 'reaction40',
    reactants = ['C[CH]OC1[CH]C=CCCC1(2276)'],
    products = ['CC1OC2CCC[CH][CH]C12(2490)'],
...
reaction(
    label = 'reaction41',
    reactants = ['[CH2]CC(C=CC=C)O[CH]C(2491)'],
    products = ['C[CH]OC1[CH]C=CCCC1(2276)'],
...
reaction(
    label = 'reaction44',
    reactants = ['[CH2]C1C=CC(CC1)O[CH]C(2494)'],
    products = ['C[CH]OC1[CH]C=CCCC1(2276)'],
