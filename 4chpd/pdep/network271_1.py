species(
    label = '[CH2]CC[CH]C=CCC=C(1674)',
    structure = SMILES('[CH2]CCC=C[CH]CC=C'),
    E0 = (327.608,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,3100,1380,975,1025,1650,2995,3010,3025,975,987.5,1000,1300,1337.5,1375,400,450,500,1630,1655,1680,3000,3100,440,815,1455,1000,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3025,407.5,1350,352.5,200,800,1066.67,1333.33,1600],'cm^-1')),
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.430446,0.0842238,-4.02635e-05,2.03378e-10,3.77666e-12,39572.5,38.5988], Tmin=(100,'K'), Tmax=(1163.67,'K')), NASAPolynomial(coeffs=[16.4243,0.0471085,-1.92599e-05,3.54638e-09,-2.44868e-13,34240.1,-51.3276], Tmin=(1163.67,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(327.608,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(532.126,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(RCCJ) + radical(Allyl_S)"""),
)
...
species(
    label = '[CH2]CCC=CC1CC1[CH2](1681)',
    structure = SMILES('[CH2]CCC=CC1CC1[CH2]'),
    E0 = (409.378,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (122.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0683381,0.0702674,1.11515e-05,-6.30634e-08,2.89621e-11,49400.5,38.0354], Tmin=(100,'K'), Tmax=(975.349,'K')), NASAPolynomial(coeffs=[18.0892,0.041465,-1.47794e-05,2.66157e-09,-1.8797e-13,43686.5,-60.2456], Tmin=(975.349,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(409.378,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(536.283,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cyclopropane) + radical(RCCJ) + radical(Isobutyl)"""),
)

species(
    label = 'C=CC[CH][CH]C1CCC1(1682)',
    structure = SMILES('C=CC[CH][CH]C1CCC1'),
    E0 = (402.713,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (122.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.414326,0.0650027,2.66599e-06,-3.48916e-08,1.38542e-11,48575.8,38.5907], Tmin=(100,'K'), Tmax=(1117.04,'K')), NASAPolynomial(coeffs=[12.0199,0.0535521,-2.23875e-05,4.18991e-09,-2.92751e-13,44104.6,-27.0917], Tmin=(1117.04,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(402.713,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(540.441,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Cyclobutane) + radical(Cs_S) + radical(RCCJCC)"""),
)

species(
    label = '[CH2]C1C[CH]C=CCCC1(1683)',
    structure = SMILES('[CH2]C1C[CH]C=CCCC1'),
    E0 = (269.501,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (122.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.840551,0.0436671,8.61448e-05,-1.35464e-07,5.29535e-11,32550.4,26.1993], Tmin=(100,'K'), Tmax=(971.24,'K')), NASAPolynomial(coeffs=[15.8965,0.0458776,-1.64479e-05,3.03388e-09,-2.19388e-13,26597,-61.5902], Tmin=(971.24,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(269.501,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(552.912,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(cis-Cyclooctene) + radical(Allyl_S) + radical(Isobutyl)"""),
)
...
species(
    label = 'C=CC[CH]C=CCC=C(1684)',
    structure = SMILES('C=CC[CH]C=CCC=C'),
    E0 = (251.413,'kJ/mol'),
    modes = [
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0863448,0.074847,-1.7728e-05,-2.40154e-08,1.26115e-11,30398,35.3775], Tmin=(100,'K'), Tmax=(1062.64,'K')), NASAPolynomial(coeffs=[16.2299,0.044199,-1.78998e-05,3.34133e-09,-2.35139e-13,25193,-52.5045], Tmin=(1062.64,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(251.413,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(511.34,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Allyl_S)"""),
)
...
species(
    label = '[CH2]CCC=C=CCC=C(1686)',
    structure = SMILES('[CH2]CCC=C=CCC=C'),
    E0 = (352.124,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,3100,1380,975,1025,1650,2995,3010,3025,975,987.5,1000,1300,1337.5,1375,400,450,500,1630,1655,1680,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,540,610,2055,3000,3100,440,815,1455,1000,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (121.2,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.542186,0.0890623,-6.123e-05,2.13941e-08,-3.04035e-12,42523,38.7573], Tmin=(100,'K'), Tmax=(1627.97,'K')), NASAPolynomial(coeffs=[19.4962,0.0398269,-1.58647e-05,2.81658e-09,-1.87476e-13,35998.6,-67.6816], Tmin=(1627.97,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(352.124,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(511.34,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(RCCJ)"""),
)
...
species(
    label = 'C=CC[CH]C=CC[CH]C(1687)',
    structure = SMILES('C=CC[CH]C=CC[CH]C'),
    E0 = (316.808,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (122.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.360307,0.0842971,-4.93411e-05,1.4152e-08,-1.63546e-12,38270,39.3307], Tmin=(100,'K'), Tmax=(1962.92,'K')), NASAPolynomial(coeffs=[21.4114,0.0399309,-1.54376e-05,2.63727e-09,-1.68923e-13,29722.8,-80.3886], Tmin=(1962.92,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(316.808,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(532.126,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(RCCJC) + radical(Allyl_S)"""),
)

species(
    label = '[CH2]CCC=CC[CH]C=C(1688)',
    structure = SMILES('[CH2]C=CCC=CCC[CH2]'),
    E0 = (327.018,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (122.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.56569,0.0869184,-4.44909e-05,1.98449e-09,3.75334e-12,39506.9,40.0568], Tmin=(100,'K'), Tmax=(1134.68,'K')), NASAPolynomial(coeffs=[17.2031,0.0457659,-1.84931e-05,3.39815e-09,-2.34989e-13,34091.3,-54.0075], Tmin=(1134.68,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(327.018,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(532.126,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Allyl_P) + radical(RCCJ)"""),
)

species(
    label = '[CH2]CCC=[C]CCC=C(1689)',
    structure = SMILES('[CH2]CCC=[C]CCC=C'),
    E0 = (424.337,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (122.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.314965,0.0901022,-6.06732e-05,2.10501e-08,-3.03164e-12,51194.6,39.753], Tmin=(100,'K'), Tmax=(1568.04,'K')), NASAPolynomial(coeffs=[16.5724,0.0470237,-1.94642e-05,3.52979e-09,-2.38316e-13,45898.5,-49.3152], Tmin=(1568.04,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(424.337,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(532.126,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(RCCJ) + radical(Cds_S)"""),
)

species(
    label = 'C=CC[CH]C=C[CH]CC(1690)',
    structure = SMILES('C=CC[CH]C=C[CH]CC'),
    E0 = (263.474,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (122.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.212577,0.0776829,-1.92592e-05,-2.19419e-08,1.14849e-11,31852.9,34.9182], Tmin=(100,'K'), Tmax=(1084.79,'K')), NASAPolynomial(coeffs=[15.8674,0.0482032,-1.97197e-05,3.67553e-09,-2.57452e-13,26610.1,-52.0523], Tmin=(1084.79,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(263.474,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(532.126,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Allyl_S) + radical(Allyl_S)"""),
)

species(
    label = '[CH2]CCC=CCC[C]=C(1691)',
    structure = SMILES('[CH2]CCC=CCC[C]=C'),
    E0 = (424.337,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,3100,1380,975,1025,1650,2995,3025,975,1000,1300,1375,400,500,1630,1680,1685,370,2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,3000,3100,440,815,1455,1000,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2]CC[C]=CCCC=C(1692)',
    structure = SMILES('[CH2]CC[C]=CCCC=C'),
    E0 = (424.337,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,3100,1380,975,1025,1650,2995,3025,975,1000,1300,1375,400,500,1630,1680,1685,370,2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,3000,3100,440,815,1455,1000,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'C=CC[CH]C=[C]CCC(1693)',
    structure = SMILES('C=CC[CH]C=[C]CCC'),
    E0 = (360.203,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (122.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.623268,0.0891782,-5.68294e-05,1.80567e-08,-2.32177e-12,43499.2,38.003], Tmin=(100,'K'), Tmax=(1784.62,'K')), NASAPolynomial(coeffs=[21.0819,0.0405289,-1.5939e-05,2.78159e-09,-1.81955e-13,35752.1,-79.2837], Tmin=(1784.62,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(360.203,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(532.126,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_S) + radical(Allyl_S)"""),
)

species(
    label = '[CH2]C[CH]C=CCCC=C(1694)',
    structure = SMILES('[CH2]C[CH]C=CCCC=C'),
    E0 = (327.608,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,3100,1380,975,1025,1650,2995,3010,3025,975,987.5,1000,1300,1337.5,1375,400,450,500,1630,1655,1680,3000,3100,440,815,1455,1000,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3025,407.5,1350,352.5,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (122.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.430431,0.0842237,-4.0263e-05,2.02763e-10,3.77689e-12,39572.5,38.5988], Tmin=(100,'K'), Tmax=(1163.67,'K')), NASAPolynomial(coeffs=[16.4242,0.0471087,-1.926e-05,3.54641e-09,-2.4487e-13,34240.2,-51.3269], Tmin=(1163.67,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(327.608,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(532.126,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Allyl_S) + radical(RCCJ)"""),
)

species(
    label = '[CH]=CCCC=CCC[CH2](1695)',
...
species(
    label = '[CH2][CH]CC=CCCC=C(1697)',
    structure = SMILES('[CH2][CH]CC=CCCC=C'),
    E0 = (380.941,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,3100,1380,975,1025,1650,2995,3010,3025,975,987.5,1000,1300,1337.5,1375,400,450,500,1630,1655,1680,3000,3100,440,815,1455,1000,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3025,407.5,1350,352.5,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (122.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.00359888,0.0847279,-5.2033e-05,1.62041e-08,-2.09955e-12,45962.2,40.8676], Tmin=(100,'K'), Tmax=(1698.99,'K')), NASAPolynomial(coeffs=[15.528,0.0481784,-1.97644e-05,3.54226e-09,-2.36417e-13,40687,-42.257], Tmin=(1698.99,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(380.941,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(532.126,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(RCCJ) + radical(RCCJC)"""),
)
...
species(
    label = 'C=[C]C[CH]C=CCCC(1699)',
    structure = SMILES('C=[C]C[CH]C=CCCC'),
    E0 = (360.203,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2995,3025,975,1000,1300,1375,400,500,1630,1680,2750,2800,2850,1350,1500,750,1050,1375,1000,2950,3100,1380,975,1025,1650,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,1685,370,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH]=C[CH]CC=C(1700)',
    structure = SMILES('[CH]C=CCC=C'),
    E0 = (423.409,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2995,3010,3025,975,987.5,1000,1300,1337.5,1375,400,450,500,1630,1655,1680,2750,2850,1437.5,1250,1305,750,350,2950,3100,1380,975,1025,1650,352.016,352.277,352.442,353.748,354.089],'cm^-1')),
        HinderedRotor(inertia=(0.581326,'amu*angstrom^2'), symmetry=1, barrier=(50.716,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.573998,'amu*angstrom^2'), symmetry=1, barrier=(50.6978,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.576088,'amu*angstrom^2'), symmetry=1, barrier=(50.6873,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
species(
    label = '[CH2]CCC1[CH]C1CC=C(1701)',
    structure = SMILES('[CH2]CCC1[CH]C1CC=C'),
    E0 = (440.25,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (122.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0711602,0.0733248,-6.78117e-06,-3.62119e-08,1.69617e-11,53110.3,38.3511], Tmin=(100,'K'), Tmax=(1043.2,'K')), NASAPolynomial(coeffs=[16.0182,0.0465886,-1.86006e-05,3.46272e-09,-2.44021e-13,47851.4,-49.0678], Tmin=(1043.2,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(440.25,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(536.283,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Cyclopropane) + radical(cyclopropane) + radical(RCCJ)"""),
)

species(
    label = '[CH2]CCC=CC1C[CH]C1(1702)',
    structure = SMILES('[CH2]CCC=CC1C[CH]C1'),
    E0 = (396.756,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (122.207,'amu'),
...
species(
    label = 'C=CCC=CCCC=C(1705)',
    structure = SMILES('C=CCC=CCCC=C'),
    E0 = (110.3,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (122.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.310126,0.0803505,-2.75341e-05,-1.46248e-08,9.35083e-12,13433.5,37.9818], Tmin=(100,'K'), Tmax=(1084.42,'K')), NASAPolynomial(coeffs=[16.4157,0.0463127,-1.87086e-05,3.46838e-09,-2.42307e-13,8179.7,-51.5643], Tmin=(1084.42,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(110.3,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(536.283,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cds-CdsHH)"""),
)

species(
    label = 'C=CCC=C=CCCC(1706)',
    structure = SMILES('C=CCC=C=CCCC'),
    E0 = (146.877,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (122.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.642958,0.0891095,-5.36809e-05,1.31658e-08,-4.2165e-13,17843.1,37.3307], Tmin=(100,'K'), Tmax=(1263.87,'K')), NASAPolynomial(coeffs=[17.7972,0.044938,-1.8097e-05,3.2789e-09,-2.23049e-13,12048.6,-60.4338], Tmin=(1263.87,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(146.877,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(536.283,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cdd-CdsCds)"""),
)
...
species(
    label = '[CH2]CCC=CC([CH2])C=C(1708)',
    structure = SMILES('[CH2]CCC=CC([CH2])C=C'),
    E0 = (383.057,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (122.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.3319,0.0941387,-7.15251e-05,3.0323e-08,-5.47948e-12,46227.8,38.4879], Tmin=(100,'K'), Tmax=(1268.42,'K')), NASAPolynomial(coeffs=[13.1711,0.0515567,-2.1169e-05,3.85651e-09,-2.63086e-13,42802.3,-29.8672], Tmin=(1268.42,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(383.057,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(532.126,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)CsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Isobutyl) + radical(RCCJ)"""),
)
...
species(
    label = '[CH2]CC=C[CH]CC=C(1709)',
    structure = SMILES('[CH2]CC=C[CH]CC=C'),
    E0 = (351.388,'kJ/mol'),
    modes = [
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.351986,0.0679226,-2.15237e-05,-1.35846e-08,8.081e-12,42403.9,33.5397], Tmin=(100,'K'), Tmax=(1094.7,'K')), NASAPolynomial(coeffs=[14.227,0.0407817,-1.66145e-05,3.08447e-09,-2.15312e-13,37954.6,-41.1018], Tmin=(1094.7,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(351.388,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(RCCJ) + radical(Allyl_S)"""),
)
...
species(
    ...
    E0 = (431.775,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3010,987.5,1337.5,450,1655,2750,2850,1437.5,1250,1305,750,350,2950,3100,1380,975,1025,1650,180,180,794.064,3346.94],'cm^-1')),
        HinderedRotor(inertia=(0.116368,'amu*angstrom^2'), symmetry=1, barrier=(2.67553,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0463347,'amu*angstrom^2'), symmetry=1, barrier=(21.3338,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
species(
    label = '[CH2]CCC1C=CCC1[CH2](1711)',
    structure = SMILES('[CH2]CCC1C=CCC1[CH2]'),
    E0 = (320.191,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (122.207,'amu'),
...
species(
    label = '[CH2]CC=CC=CCC=C(1712)',
    structure = SMILES('[CH2]CC=CC=CCC=C'),
    E0 = (287.097,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,3100,1380,975,1025,1650,2995,3002.5,3010,3017.5,3025,975,981.25,987.5,993.75,1000,1300,1318.75,1337.5,1356.25,1375,400,425,450,475,500,1630,1642.5,1655,1667.5,1680,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3100,440,815,1455,1000,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    ...
    molecularWeight = (122.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.243179,0.0828445,-4.93522e-05,1.47358e-08,-1.83704e-12,46104.5,39.8517], Tmin=(100,'K'), Tmax=(1728.71,'K')), NASAPolynomial(coeffs=[14.3839,0.050125,-2.09618e-05,3.78733e-09,-2.5372e-13,41215.4,-36.1096], Tmin=(1728.71,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(382.223,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(532.126,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(RCCJ) + radical(RCCJCC)"""),
)

species(
    label = '[CH2]CCC[C]=CCC=C(1714)',
    structure = SMILES('[CH2]CCC[C]=CCC=C'),
    E0 = (425.606,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,3100,1380,975,1025,1650,2995,3025,975,1000,1300,1375,400,500,1630,1680,1685,370,2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,3000,3100,440,815,1455,1000,200,800,1066.67,1333.33,1600],'cm^-1')),
    ...
    molecularWeight = (122.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.33559,0.09022,-6.09148e-05,2.11959e-08,-3.05866e-12,51348.3,39.8549], Tmin=(100,'K'), Tmax=(1567.74,'K')), NASAPolynomial(coeffs=[16.7172,0.0467107,-1.92854e-05,3.49338e-09,-2.35717e-13,46001.4,-50.0826], Tmin=(1567.74,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(425.606,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(532.126,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_S) + radical(RCCJ)"""),
)

species(
    label = '[CH2]CCCC=[C]CC=C(1715)',
...
species(
    label = '[CH2]CCCC=CC[C]=C(1717)',
    structure = SMILES('[CH2]CCCC=CC[C]=C'),
    E0 = (425.606,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,3100,1380,975,1025,1650,2995,3025,975,1000,1300,1375,400,500,1630,1680,1685,370,2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,3000,3100,440,815,1455,1000,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH]=CCC=CCCC[CH2](1718)',
    structure = SMILES('[CH]=CCC=CCCC[CH2]'),
    E0 = (434.861,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2995,3010,3025,975,987.5,1000,1300,1337.5,1375,400,450,500,1630,1655,1680,3120,650,792.5,1650,2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,3000,3100,440,815,1455,1000,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (122.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.683707,0.092542,-6.37526e-05,2.24454e-08,-3.22446e-12,52478.7,41.0502], Tmin=(100,'K'), Tmax=(1607.47,'K')), NASAPolynomial(coeffs=[19.5106,0.0422905,-1.68605e-05,2.99771e-09,-1.9987e-13,45986.4,-65.9612], Tmin=(1607.47,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(434.861,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(532.126,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(RCCJ) + radical(Cds_P)"""),
)

species(
    label = 'C=CC[C]=C[CH]CCC(1719)',
    ...
    molecularWeight = (122.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.644367,0.0892995,-5.70766e-05,1.82051e-08,-2.34896e-12,43653,38.1068], Tmin=(100,'K'), Tmax=(1781.04,'K')), NASAPolynomial(coeffs=[21.1796,0.0402849,-1.57958e-05,2.75293e-09,-1.79959e-13,35879.2,-79.7776], Tmin=(1781.04,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(361.473,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(532.126,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Allyl_S) + radical(Cds_S)"""),
)
...
species(
    label = '[CH2]CCC1C=CC[CH]C1(1721)',
    structure = SMILES('[CH2]CCC1C=CC[CH]C1'),
    E0 = (299.123,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (122.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.533908,0.0589419,2.71262e-05,-6.42081e-08,2.50693e-11,36115.9,33.8005], Tmin=(100,'K'), Tmax=(1039.78,'K')), NASAPolynomial(coeffs=[12.8166,0.051998,-2.10039e-05,3.93255e-09,-2.77916e-13,31382.7,-36.4133], Tmin=(1039.78,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(299.123,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(544.598,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cyclohexene) + radical(RCCJ) + radical(RCCJCC)"""),
)

species(
    label = 'C=CCC=CC=CCC(1722)',
    structure = SMILES('C=CCC=CC=CCC'),
    E0 = (81.8506,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (122.207,'amu'),
...
species(
    label = '[CH2]CC([CH2])C=CCC=C(1676)',
    structure = SMILES('[CH2]CC([CH2])C=CCC=C'),
    E0 = (384.875,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,3100,1380,975,1025,1650,1380,1390,370,380,2900,435,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2995,3010,3025,975,987.5,1000,1300,1337.5,1375,400,450,500,1630,1655,1680,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (122.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.547394,0.0877573,-4.86636e-05,5.54565e-09,3.07488e-12,46463.8,41.6794], Tmin=(100,'K'), Tmax=(1087.65,'K')), NASAPolynomial(coeffs=[16.3803,0.0452973,-1.74045e-05,3.11782e-09,-2.12992e-13,41610.8,-46.7915], Tmin=(1087.65,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(384.875,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(532.126,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Isobutyl) + radical(RCCJ)"""),
)

species(
    label = 'C=CCC=CC1CCC1(1680)',
    structure = SMILES('C=CCC=CC1CCC1'),
    E0 = (132.723,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (122.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.431048,0.0537707,5.93288e-05,-1.10231e-07,4.43081e-11,16113.4,34.1642], Tmin=(100,'K'), Tmax=(985.245,'K')), NASAPolynomial(coeffs=[17.9744,0.0429402,-1.61298e-05,3.04466e-09,-2.21989e-13,9725.28,-65.0874], Tmin=(985.245,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(132.723,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(544.598,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Cyclobutane)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]CC[CH]C=CCC=C(1674)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]CC[CH]C=CCC=C(1674)'],
    products = ['[CH2]CCC=CC1CC1[CH2](1681)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH2]CC[CH]C=CCC=C(1674)'],
    products = ['C=CC[CH][CH]C1CCC1(1682)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(1.20551e+07,'s^-1'), n=1.225, Ea=(75.1053,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [R5_SS_D;doublebond_intra;radadd_intra_cs2H]
Euclidian distance = 0
family: Intra_R_Add_Exocyclic
Ea raised from 72.5 to 75.1 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction4',
    reactants = ['[CH2]CC[CH]C=CCC=C(1674)'],
    products = ['[CH2]C1C[CH]C=CCCC1(1683)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H(19)', 'C=CC[CH]C=CCC=C(1684)'],
    products = ['[CH2]CC[CH]C=CCC=C(1674)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['H(19)', '[CH2]CCC=C=CCC=C(1686)'],
    products = ['[CH2]CC[CH]C=CCC=C(1674)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]CC[CH]C=CCC=C(1674)'],
    products = ['C=CC[CH]C=CC[CH]C(1687)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]CC[CH]C=CCC=C(1674)'],
    products = ['[CH2]CCC=CC[CH]C=C(1688)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]CCC=[C]CCC=C(1689)'],
    products = ['[CH2]CC[CH]C=CCC=C(1674)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2]CC[CH]C=CCC=C(1674)'],
    products = ['C=CC[CH]C=C[CH]CC(1690)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]CCC=CCC[C]=C(1691)'],
    products = ['[CH2]CC[CH]C=CCC=C(1674)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]CC[C]=CCCC=C(1692)'],
    products = ['[CH2]CC[CH]C=CCC=C(1674)'],
...
reaction(
    label = 'reaction16',
    reactants = ['C=CC[CH]C=[C]CCC(1693)'],
    products = ['[CH2]CC[CH]C=CCC=C(1674)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]C[CH]C=CCCC=C(1694)'],
    products = ['[CH2]CC[CH]C=CCC=C(1674)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH]=CCCC=CCC[CH2](1695)'],
    products = ['[CH2]CC[CH]C=CCC=C(1674)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2][CH]CC=CCCC=C(1697)'],
    products = ['[CH2]CC[CH]C=CCC=C(1674)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(5.18e+08,'s^-1'), n=1.01, Ea=(110.458,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R7Hall;C_rad_out_2H;Cs_H_out_H/Cd] for rate rule [R7HJ_5;C_rad_out_2H;Cs_H_out_H/Cd]
Euclidian distance = 1.0
Multiplied by reaction path degeneracy 2.0
family: intra_H_migration"""),
)
...
reaction(
    label = 'reaction22',
    reactants = ['C=[C]C[CH]C=CCCC(1699)'],
    products = ['[CH2]CC[CH]C=CCC=C(1674)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[CH2]C[CH2](171)', '[CH]=C[CH]CC=C(1700)'],
    products = ['[CH2]CC[CH]C=CCC=C(1674)'],
    transitionState = 'TS24',
    kinetics = Arrhenius(A=(4.99622e+08,'m^3/(mol*s)'), n=-0.468547, Ea=(0.3861,'kJ/mol'), T0=(1,'K'), comment="""Estimated using average of templates [Y_rad;C_rad/H2/Cs] + [Cd_rad;C_pri_rad] for rate rule [Cd_rad;C_rad/H2/Cs]
Euclidian distance = 1.0
Multiplied by reaction path degeneracy 2.0
family: R_Recombination"""),
)
...
reaction(
    label = 'reaction25',
    reactants = ['[CH2]CC[CH]C=CCC=C(1674)'],
    products = ['[CH2]CCC1[CH]C1CC=C(1701)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[CH2]CC[CH]C=CCC=C(1674)'],
    products = ['[CH2]CCC=CC1C[CH]C1(1702)'],
...
reaction(
    label = 'reaction27',
    reactants = ['[CH2]CC[CH]C=CCC=C(1674)'],
    products = ['C=CC[CH]C1[CH]CCC1(1703)'],
...
reaction(
    label = 'reaction32',
    reactants = ['[CH2]CCC=CC([CH2])C=C(1708)'],
    products = ['[CH2]CC[CH]C=CCC=C(1674)'],
...
reaction(
    label = 'reaction34',
    reactants = ['CH2(T)(33)', '[CH2]CC=C[CH]CC=C(1709)'],
    products = ['[CH2]CC[CH]C=CCC=C(1674)'],
...
reaction(
    label = 'reaction35',
    reactants = ['[CH]=CCC[CH2](174)', '[CH]CC=C(1710)'],
    products = ['[CH2]CC[CH]C=CCC=C(1674)'],
...
reaction(
    label = 'reaction36',
    reactants = ['[CH2]CC[CH]C=CCC=C(1674)'],
    products = ['[CH2]CCC1C=CCC1[CH2](1711)'],
    transitionState = 'TS36',
    kinetics = Arrhenius(A=(1.13e+11,'s^-1'), n=0.21, Ea=(92.5919,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""From training reaction 213 used for R6_SMS_D;doublebond_intra_2H_pri;radadd_intra_csHNd
Exact match found for rate rule [R6_SMS_D;doublebond_intra_2H_pri;radadd_intra_csHNd]
Euclidian distance = 0
family: Intra_R_Add_Exocyclic"""),
)
...
reaction(
    label = 'reaction37',
    reactants = ['H(19)', '[CH2]CC=CC=CCC=C(1712)'],
    products = ['[CH2]CC[CH]C=CCC=C(1674)'],
...
reaction(
    label = 'reaction39',
    reactants = ['[CH2]C[CH]CC=CCC=C(1713)'],
    products = ['[CH2]CC[CH]C=CCC=C(1674)'],
...
reaction(
    label = 'reaction40',
    reactants = ['[CH2]CCC[C]=CCC=C(1714)'],
    products = ['[CH2]CC[CH]C=CCC=C(1674)'],
...
reaction(
    label = 'reaction43',
    reactants = ['[CH2]CCCC=CC[C]=C(1717)'],
    products = ['[CH2]CC[CH]C=CCC=C(1674)'],
    transitionState = 'TS43',
    kinetics = Arrhenius(A=(319879,'s^-1'), n=1.73071, Ea=(38.1647,'kJ/mol'), T0=(1,'K'), comment="""Estimated using average of templates [R5H;Y_rad_out;Cs_H_out_H/NonDeC] + [R5H_RSMS;Cd_rad_out;Cs_H_out] for rate rule [R5H_SSMS;Cd_rad_out_Cd;Cs_H_out_H/(NonDeC/Cs)]
...
reaction(
    label = 'reaction44',
    reactants = ['[CH]=CCC=CCCC[CH2](1718)'],
    products = ['[CH2]CC[CH]C=CCC=C(1674)'],
...
reaction(
    label = 'reaction45',
    reactants = ['C=CC[C]=C[CH]CCC(1719)'],
    products = ['[CH2]CC[CH]C=CCC=C(1674)'],
...
reaction(
    label = 'reaction47',
    reactants = ['[CH2]CC[CH]C=CCC=C(1674)'],
    products = ['[CH2]CCC1C=CC[CH]C1(1721)'],
...
reaction(
    label = 'reaction49',
    reactants = ['[CH2]CC([CH2])C=CCC=C(1676)'],
    products = ['[CH2]CC[CH]C=CCC=C(1674)'],
