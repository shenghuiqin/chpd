...
species(
    label = 'C=CC1C(C=C)C1O[O](198)',
    structure = SMILES('C=CC1C(C=C)C1O[O]'),
    E0 = (237.612,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,3000,3050,3100,1330,1430,900,1050,1000,1050,1600,1700,2995,3025,975,1000,1300,1375,400,500,1630,1680,492.5,1135,1000,2750,2950,3150,900,1000,1100,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
...
reaction(
    label = 'reaction6',
    reactants = ['H(19)', '[O]OC1C=C[CH]CC=C1(192)'],
    products = ['[O]OC1C=CCCC=C1(143)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction7',
    reactants = ['H(19)', '[O]O[C]1C=CCCC=C1(193)'],
    products = ['[O]OC1C=CCCC=C1(143)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction8',
    reactants = ['H(19)', '[O]OC1C=[C]CCC=C1(194)'],
    products = ['[O]OC1C=CCCC=C1(143)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction9',
    reactants = ['H(19)', '[O]OC1[C]=CCCC=C1(195)'],
    products = ['[O]OC1C=CCCC=C1(143)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(1e+13,'cm^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""From training reaction 40 used for Cd_rad/NonDe;H_rad
Exact match found for rate rule [Cd_rad/NonDe;H_rad]
...
reaction(
    label = 'reaction3',
    reactants = ['[O]OC1C=CCCC=C1(143)'],
    products = ['OOC1[C]=CCCC=C1(189)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction13',
    reactants = ['C=CC1C(C=C)C1O[O](198)'],
    products = ['[O]OC1C=CCCC=C1(143)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[O]C1C=CCCC=C1(199)', 'O(20)'],
    products = ['[O]OC1C=CCCC=C1(143)'],
