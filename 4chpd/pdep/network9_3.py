...
species(
    ...
    molecularWeight = (124.137,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.442625,0.0894601,-8.32473e-05,3.98948e-08,-7.59704e-12,38960.5,16.5206], Tmin=(100,'K'), Tmax=(1270.92,'K')), NASAPolynomial(coeffs=[19.0346,0.0281592,-1.08976e-05,1.94368e-09,-1.31803e-13,34009.7,-82.1156], Tmin=(1270.92,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(322.549,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(403.252,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + ring(1,3-Cycloheptadiene) + radical(ROOJ) + radical(C=CJC=C)"""),
)

species(
    label = '[CH]1C2C=CCCC1OO2(196)',
...
reaction(
    label = 'reaction1',
    reactants = ['O2(2)', '[CH]1C=CC=CCC1(85)'],
...
reaction(
    label = 'reaction3',
    reactants = ['OOC1[CH]CC=CC=C1(201)'],
    products = ['[O]OC1C=CC=CCC1(144)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction9',
    reactants = ['H(19)', '[O]OC1[CH]CC=CC=C1(207)'],
    products = ['[O]OC1C=CC=CCC1(144)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(19)', '[O]O[C]1C=CC=CCC1(208)'],
    products = ['[O]OC1C=CC=CCC1(144)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(19)', '[O]OC1[C]=CC=CCC1(210)'],
    products = ['[O]OC1C=CC=CCC1(144)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(19)', '[O]OC1C=CC=[C]CC1(211)'],
    products = ['[O]OC1C=CC=CCC1(144)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(19)', '[O]OC1C=C[C]=CCC1(212)'],
    products = ['[O]OC1C=CC=CCC1(144)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(19)', '[O]OC1C=[C]C=CCC1(213)'],
    products = ['[O]OC1C=CC=CCC1(144)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[O]OC1C=CC=CCC1(144)'],
    products = ['HO2(26)', 'C1=CC=CCCC=1(124)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[O]C1C=CC=CCC1(219)', 'O(20)'],
    products = ['[O]OC1C=CC=CCC1(144)'],
