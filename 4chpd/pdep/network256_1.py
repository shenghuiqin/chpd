...
species(
    label = '[O]CC1=CCCCCC1OO(1586)',
    structure = SMILES('[O]CC1=CCCCCC1OO'),
    E0 = (-90.7785,'kJ/mol'),
    modes = [
...
species(
    label = '[O]CC1C=CCCCC1OO(1587)',
    structure = SMILES('[O]CC1C=CCCCC1OO'),
    E0 = (-89.831,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2794.44,2838.89,2883.33,2927.78,2972.22,3016.67,3061.11,3105.56,3150,900,922.222,944.444,966.667,988.889,1011.11,1033.33,1055.56,1077.78,1100,3615,1310,387.5,850,1000,2750,2850,1437.5,1250,1305,750,350,300,800,800,800,800,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (157.187,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.718542,0.05336,0.000142909,-2.55359e-07,1.11231e-10,-10587.4,40.3809], Tmin=(100,'K'), Tmax=(919.306,'K')), NASAPolynomial(coeffs=[40.097,0.00652337,5.98056e-06,-1.34212e-09,7.74968e-14,-23617.1,-183.148], Tmin=(919.306,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-89.831,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(569.541,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cycloheptene) + radical(CCOJ)"""),
)
...
species(
    label = '[O]C[C]1CCCCCC1OO(1589)',
    structure = SMILES('[O]C[C]1CCCCCC1OO'),
    E0 = (-12.4781,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (158.195,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.564794,0.0518023,0.000144179,-2.49785e-07,1.07138e-10,-1291.39,44.7781], Tmin=(100,'K'), Tmax=(924.093,'K')), NASAPolynomial(coeffs=[37.1246,0.0139718,2.18032e-06,-6.00154e-10,2.59017e-14,-13607.5,-163.026], Tmin=(924.093,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-12.4781,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(594.485,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + ring(Cycloheptane) + radical(C2CJCOOH) + radical(CCOJ)"""),
)

species(
    label = '[O]CC1C[CH]CCCC1OO(1590)',
    structure = SMILES('[O]CC1C[CH]CCCC1OO'),
    E0 = (-33.9601,'kJ/mol'),
    modes = [
...
species(
    label = 'O[CH]C1[CH]CCCCC1OO(1591)',
    structure = SMILES('O[CH]C1[CH]CCCCC1OO'),
    E0 = (-79.3674,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (158.195,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.53529,0.0761857,8.77383e-05,-2.03421e-07,9.41715e-11,-9303.92,43.7605], Tmin=(100,'K'), Tmax=(915.116,'K')), NASAPolynomial(coeffs=[41.5676,0.00698733,5.76931e-06,-1.36036e-09,8.33786e-14,-22184.1,-187.635], Tmin=(915.116,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-79.3674,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(590.328,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + ring(Cycloheptane) + radical(cycloheptane) + radical(CCsJOH)"""),
)

species(
    label = '[O]CC1CCCCC[C]1OO(1592)',
    structure = SMILES('[O]CC1CCCCC[C]1OO'),
    E0 = (-16.4898,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2790,2830,2870,2910,2950,2990,3030,3070,3110,3150,900,920,940,960,980,1000,1020,1040,1060,1080,1100,3615,1310,387.5,850,1000,2750,2850,1437.5,1250,1305,750,350,300,800,800,800,800,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[O][CH]C1CCCCCC1OO(1593)',
    structure = SMILES('[O][CH]C1CCCCCC1OO'),
    E0 = (-23.0911,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2786.36,2822.73,2859.09,2895.45,2931.82,2968.18,3004.55,3040.91,3077.27,3113.64,3150,900,918.182,936.364,954.545,972.727,990.909,1009.09,1027.27,1045.45,1063.64,1081.82,1100,3615,1310,387.5,850,1000,3025,407.5,1350,352.5,300,800,800,800,800,800,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
...
species(
    label = '[O]CC1CC[CH]CCC1OO(1594)',
    structure = SMILES('[O]CC1CC[CH]CCC1OO'),
    E0 = (-33.9601,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2790,2830,2870,2910,2950,2990,3030,3070,3110,3150,900,920,940,960,980,1000,1020,1040,1060,1080,1100,3615,1310,387.5,850,1000,2750,2850,1437.5,1250,1305,750,350,300,800,800,800,800,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'OC[C]1[CH]CCCCC1OO(1595)',
    structure = SMILES('OC[C]1[CH]CCCCC1OO'),
    E0 = (-68.7545,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (158.195,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.73296,0.054796,0.000139347,-2.49846e-07,1.08755e-10,-8053.02,46.8684], Tmin=(100,'K'), Tmax=(919.661,'K')), NASAPolynomial(coeffs=[39.0471,0.00957543,4.65704e-06,-1.10502e-09,6.20066e-14,-20774.4,-171.099], Tmin=(919.661,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-68.7545,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(590.328,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + ring(Cycloheptane) + radical(cycloheptane) + radical(C2CJCOOH)"""),
)

species(
    label = 'OCC1[CH]CCCC[C]1OO(1596)',
    structure = SMILES('OCC1[CH]CCCC[C]1OO'),
    E0 = (-72.7662,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (158.195,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.16805,0.0704372,9.21908e-05,-1.98646e-07,8.99882e-11,-8525.5,43.8794], Tmin=(100,'K'), Tmax=(919.396,'K')), NASAPolynomial(coeffs=[37.8119,0.0131504,2.43202e-06,-7.03703e-10,3.78728e-14,-20439.5,-166.713], Tmin=(919.396,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-72.7662,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(590.328,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + ring(Cycloheptane) + radical(cycloheptane) + radical(C2CsJOOH)"""),
)

species(
    label = '[O]CC1CCCC[CH]C1OO(1597)',
    structure = SMILES('[O]CC1CCCC[CH]C1OO'),
    E0 = (-2.97398,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3615,1310,387.5,850,1000,2750,2790,2830,2870,2910,2950,2990,3030,3070,3110,3150,900,920,940,960,980,1000,1020,1040,1060,1080,1100,300,800,800,800,800,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[O]CC1CCC[CH]CC1OO(1598)',
    structure = SMILES('[O]CC1CCC[CH]CC1OO'),
    E0 = (-33.9601,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3615,1310,387.5,850,1000,2750,2790,2830,2870,2910,2950,2990,3030,3070,3110,3150,900,920,940,960,980,1000,1020,1040,1060,1080,1100,300,800,800,800,800,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'OCC1[CH]CCC[CH]C1OO(1599)',
    structure = SMILES('OCC1[CH]CCC[CH]C1OO'),
    E0 = (-59.2503,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (158.195,'amu'),
...
species(
    label = 'OCC1[CH][CH]CCCC1OO(1600)',
    structure = SMILES('OCC1[CH][CH]CCCC1OO'),
    E0 = (-90.2364,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (158.195,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.13469,0.0684479,9.91085e-05,-2.07073e-07,9.32849e-11,-10626.7,45.1197], Tmin=(100,'K'), Tmax=(919.44,'K')), NASAPolynomial(coeffs=[38.4626,0.0117191,3.16532e-06,-8.34751e-10,4.60687e-14,-22791.8,-169.146], Tmin=(919.44,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-90.2364,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(590.328,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + ring(Cycloheptane) + radical(cycloheptane) + radical(cycloheptane)"""),
)

species(
    label = '[O]CC1CCCCCC1O[O](1601)',
    structure = SMILES('[O]CC1CCCCCC1O[O]'),
    E0 = (-51.3842,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (158.195,'amu'),
...
species(
    label = '[O]OC1CCCC[CH]C1CO(1602)',
    structure = SMILES('[O]OC1CCCC[CH]C1CO'),
    E0 = (-107.661,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (158.195,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.02033,0.0640751,0.000113438,-2.25324e-07,1.01125e-10,-12724.6,43.1217], Tmin=(100,'K'), Tmax=(913.55,'K')), NASAPolynomial(coeffs=[39.3476,0.00854752,5.56763e-06,-1.35133e-09,8.33331e-14,-25158.8,-175.667], Tmin=(913.55,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-107.661,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(594.485,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + ring(Cycloheptane) + radical(ROOJ) + radical(cycloheptane)"""),
)

species(
    label = 'OCC1[CH]CC[CH]CC1OO(1603)',
    structure = SMILES('OCC1[CH]CC[CH]CC1OO'),
    E0 = (-90.2364,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (158.195,'amu'),
...
species(
    label = 'OCC1[CH]C[CH]CCC1OO(1604)',
    structure = SMILES('OCC1[CH]C[CH]CCC1OO'),
    E0 = (-90.2364,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (158.195,'amu'),
...
species(
    label = '[CH2]CCC(OO)C(C=C)C[O](1605)',
    structure = SMILES('[CH2]CCC(OO)C(C=C)C[O]'),
    E0 = (50.5439,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (158.195,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.17083,0.12274,-0.000123558,7.43502e-08,-1.9426e-11,6257.54,45.8743], Tmin=(100,'K'), Tmax=(897.863,'K')), NASAPolynomial(coeffs=[11.1701,0.067759,-3.17028e-05,6.14584e-09,-4.34701e-13,4041.51,-12.3336], Tmin=(897.863,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(50.5439,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(573.699,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CCOJ) + radical(RCCJ)"""),
)

species(
    label = '[O]CC=CCCCC[CH]OO(1606)',
    structure = SMILES('[O]CC=CCCCC[CH]OO'),
    E0 = (48.9412,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2995,3025,975,1000,1300,1375,400,500,1630,1680,3025,407.5,1350,352.5,3615,1310,387.5,850,1000,2750,2761.11,2772.22,2783.33,2794.44,2805.56,2816.67,2827.78,2838.89,2850,1425,1431.25,1437.5,1443.75,1450,1225,1237.5,1250,1262.5,1275,1270,1287.5,1305,1322.5,1340,700,725,750,775,800,300,325,350,375,400,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (158.195,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.4612,0.13077,-0.000165986,1.38546e-07,-4.95422e-11,6072.77,46.4536], Tmin=(100,'K'), Tmax=(754.702,'K')), NASAPolynomial(coeffs=[7.40026,0.0744546,-3.54772e-05,6.84779e-09,-4.79509e-13,5001.45,7.95986], Tmin=(754.702,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(48.9412,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(573.699,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(CCsJOOH) + radical(CCOJ)"""),
)

species(
    label = 'OCC1=CCCCCC1OO(1607)',
    structure = SMILES('OCC1=CCCCCC1OO'),
    E0 = (-316.484,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (158.195,'amu'),
...
species(
    label = 'O=CC1CCCCCC1OO(1608)',
    structure = SMILES('O=CC1CCCCCC1OO'),
    E0 = (-348.785,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (158.195,'amu'),
...
species(
    label = 'OCC1C=CCCCC1OO(1609)',
    structure = SMILES('OCC1C=CCCCC1OO'),
    E0 = (-315.536,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (158.195,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.05964,0.0558526,0.00015611,-2.81639e-07,1.23849e-10,-37716.4,40.7452], Tmin=(100,'K'), Tmax=(914.321,'K')), NASAPolynomial(coeffs=[44.7086,0.000242673,1.00865e-05,-2.17482e-09,1.35081e-13,-52130.7,-209.018], Tmin=(914.321,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-315.536,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(590.328,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cycloheptene)"""),
)
...
species(
    label = '[O]CC1C2CCCCC1O2(1610)',
    structure = SMILES('[O]CC1C2CCCCC1O2'),
    E0 = (-247.19,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (141.188,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.581259,0.105565,-8.29211e-05,3.48871e-08,-6.27619e-12,-29569.5,-0.384952], Tmin=(100,'K'), Tmax=(1256.17,'K')), NASAPolynomial(coeffs=[14.1389,0.0586915,-2.69487e-05,5.18152e-09,-3.64223e-13,-33267.7,-74.7584], Tmin=(1256.17,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-247.19,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(552.912,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + polycyclic(PolycyclicRing) + radical(CCOJ)"""),
)

species(
    label = '[CH]1CCCCC2OOCC12(1611)',
    structure = SMILES('[CH]1CCCCC2OOCC12'),
    E0 = (-34.4138,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (141.188,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0160774,0.0756374,-1.72707e-05,-1.59353e-08,7.04468e-12,-3984.28,33.1751], Tmin=(100,'K'), Tmax=(1268.03,'K')), NASAPolynomial(coeffs=[15.1351,0.0548185,-2.45534e-05,4.6704e-09,-3.25497e-13,-9995.42,-52.07], Tmin=(1268.03,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-34.4138,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(557.07,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + polycyclic(s2_5_7) + radical(cycloheptane)"""),
)
...
species(
    label = '[CH2]C1CCCC(OO)C1C[O](1613)',
    structure = SMILES('[CH2]C1CCCC(OO)C1C[O]'),
    E0 = (-37.5167,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,3615,1310,387.5,850,1000,2750,2800,2850,2900,2950,3000,3050,3100,3150,900,925,950,975,1000,1025,1050,1075,1100,300,800,800,800,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (158.195,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.22096,0.100291,-5.33045e-05,9.25613e-09,5.05852e-13,-4312.4,38.7226], Tmin=(100,'K'), Tmax=(1391.15,'K')), NASAPolynomial(coeffs=[21.0476,0.0544246,-2.34332e-05,4.32629e-09,-2.94802e-13,-12265.7,-82.3787], Tmin=(1391.15,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-37.5167,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(590.328,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Cyclohexane) + radical(CCOJ) + radical(Isobutyl)"""),
)
...
species(
    label = '[O]CC1C([O])CCCCC1O(1614)',
    structure = SMILES('[O]CC1C([O])CCCCC1O'),
    E0 = (-217.004,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (158.195,'amu'),
...
reaction(
    label = 'reaction1',
    reactants = ['[O]CC1[CH]CCCCC1OO(1366)'],
...
reaction(
    label = 'reaction2',
    reactants = ['H(19)', '[O]CC1=CCCCCC1OO(1586)'],
...
reaction(
    label = 'reaction3',
    reactants = ['H(19)', '[O]CC1C=CCCCC1OO(1587)'],
    products = ['[O]CC1[CH]CCCCC1OO(1366)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(19)', 'O=CC1[CH]CCCCC1OO(1588)'],
    products = ['[O]CC1[CH]CCCCC1OO(1366)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['[O]CC1[CH]CCCCC1OO(1366)'],
    products = ['[O]C[C]1CCCCCC1OO(1589)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]CC1C[CH]CCCC1OO(1590)'],
    products = ['[O]CC1[CH]CCCCC1OO(1366)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[O]CC1[CH]CCCCC1OO(1366)'],
    products = ['O[CH]C1[CH]CCCCC1OO(1591)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]CC1CCCCC[C]1OO(1592)'],
    products = ['[O]CC1[CH]CCCCC1OO(1366)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[O][CH]C1CCCCCC1OO(1593)'],
    products = ['[O]CC1[CH]CCCCC1OO(1366)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O]CC1CC[CH]CCC1OO(1594)'],
    products = ['[O]CC1[CH]CCCCC1OO(1366)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[O]CC1[CH]CCCCC1OO(1366)'],
    products = ['OC[C]1[CH]CCCCC1OO(1595)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[O]CC1[CH]CCCCC1OO(1366)'],
    products = ['OCC1[CH]CCCC[C]1OO(1596)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[O]CC1CCCC[CH]C1OO(1597)'],
    products = ['[O]CC1[CH]CCCCC1OO(1366)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[O]CC1CCC[CH]CC1OO(1598)'],
    products = ['[O]CC1[CH]CCCCC1OO(1366)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[O]CC1[CH]CCCCC1OO(1366)'],
    products = ['OCC1[CH]CCC[CH]C1OO(1599)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[O]CC1[CH]CCCCC1OO(1366)'],
    products = ['OCC1[CH][CH]CCCC1OO(1600)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[O]CC1[CH]CCCCC1OO(1366)'],
    products = ['[O]OC1CCCC[CH]C1CO(1602)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[O]CC1[CH]CCCCC1OO(1366)'],
    products = ['OCC1[CH]CC[CH]CC1OO(1603)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[O]CC1[CH]CCCCC1OO(1366)'],
    products = ['OCC1[CH]C[CH]CCC1OO(1604)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[CH2]CCC(OO)C(C=C)C[O](1605)'],
    products = ['[O]CC1[CH]CCCCC1OO(1366)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[O]CC=CCCCC[CH]OO(1606)'],
    products = ['[O]CC1[CH]CCCCC1OO(1366)'],
...
reaction(
    label = 'reaction29',
    reactants = ['[O]CC1[CH]CCCCC1OO(1366)'],
    products = ['OH(21)', '[O]CC1C2CCCCC1O2(1610)'],
...
reaction(
    label = 'reaction30',
    reactants = ['[O]CC1[CH]CCCCC1OO(1366)'],
    products = ['OH(21)', '[CH]1CCCCC2OOCC12(1611)'],
...
reaction(
    label = 'reaction31',
    reactants = ['[O]C[CH]C1CCCCC1OO(1612)'],
    products = ['[O]CC1[CH]CCCCC1OO(1366)'],
...
reaction(
    label = 'reaction33',
    reactants = ['[CH2]C1CCCC(OO)C1C[O](1613)'],
    products = ['[O]CC1[CH]CCCCC1OO(1366)'],
...
reaction(
    label = 'reaction35',
    reactants = ['[O]CC1[CH]CCCCC1OO(1366)'],
    products = ['[O]CC1C([O])CCCCC1O(1614)'],
...
reaction(
    label = 'reaction36',
    reactants = ['[CH2]C1[CH]CCCCC1OO(746)', 'O(20)'],
    products = ['[O]CC1[CH]CCCCC1OO(1366)'],
