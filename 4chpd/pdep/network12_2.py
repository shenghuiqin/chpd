...
species(
    label = '[CH]=CC=CCC=[CH](248)',
    structure = SMILES('[CH]=CC=CCC=[CH]'),
    E0 = (634.714,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2995,3005,3015,3025,975,983.333,991.667,1000,1300,1325,1350,1375,400,433.333,466.667,500,1630,1646.67,1663.33,1680,2750,2850,1437.5,1250,1305,750,350,3115,3125,620,680,785,800,1600,1700,180],'cm^-1')),
        HinderedRotor(inertia=(0.835245,'amu*angstrom^2'), symmetry=1, barrier=(19.2039,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.832955,'amu*angstrom^2'), symmetry=1, barrier=(19.1513,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.834754,'amu*angstrom^2'), symmetry=1, barrier=(19.1926,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (92.1384,'amu'),
...
species(
    label = '[CH]=CC=CC=C[CH2](249)',
    structure = SMILES('[CH]=CC=CC=C[CH2]'),
    E0 = (474.819,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2995,3002.5,3010,3017.5,3025,975,981.25,987.5,993.75,1000,1300,1318.75,1337.5,1356.25,1375,400,425,450,475,500,1630,1642.5,1655,1667.5,1680,3000,3100,440,815,1455,1000,3120,650,792.5,1650,180],'cm^-1')),
        HinderedRotor(inertia=(1.27037,'amu*angstrom^2'), symmetry=1, barrier=(29.2084,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.26991,'amu*angstrom^2'), symmetry=1, barrier=(29.1977,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.27126,'amu*angstrom^2'), symmetry=1, barrier=(29.2287,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (92.1384,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.929631,0.0518045,4.89414e-06,-5.11141e-08,2.57339e-11,57232.5,25.4179], Tmin=(100,'K'), Tmax=(938.579,'K')), NASAPolynomial(coeffs=[18.0278,0.018481,-5.04836e-06,8.37777e-10,-6.08081e-14,52281.1,-65.2661], Tmin=(938.579,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(474.819,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + radical(Cds_P) + radical(C=CC=CCJ)"""),
)

species(
    label = '[C]1CC=CC=CC1(250)',
...
species(
    label = '[CH]1C=CC2C=CC12(1224)',
    structure = SMILES('[CH]1C=CC2C=CC12'),
    E0 = (387.606,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2816.67,2883.33,2950,3016.67,3083.33,3150,900,933.333,966.667,1000,1033.33,1066.67,1100,300,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
    ],
    ...
    molecularWeight = (91.1305,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.11647,0.0162677,9.63988e-05,-1.40714e-07,5.58928e-11,46709,17.1495], Tmin=(100,'K'), Tmax=(948.891,'K')), NASAPolynomial(coeffs=[17.3156,0.0160258,-4.11964e-06,7.97795e-10,-6.79005e-14,40951,-70.5218], Tmin=(948.891,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(387.606,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(332.579,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)(Cds-Cds)CsH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + polycyclic(s2_4_5_diene_1_5) + radical(cyclopentene-allyl)"""),
)

species(
    label = '[C]1=CC2C=CCC12(1225)',
...
species(
    label = '[C]1=CCC2C=CC12(1226)',
    structure = SMILES('[C]1=CCC2C=CC12'),
    E0 = (517.808,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2816.67,2883.33,2950,3016.67,3083.33,3150,900,933.333,966.667,1000,1033.33,1066.67,1100,300,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
    ],
...
species(
    label = '[CH]1C[C]2CC=CC12(1229)',
    structure = SMILES('[CH]1C[C]2CC=CC12'),
    E0 = (498.074,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2807.14,2864.29,2921.43,2978.57,3035.71,3092.86,3150,900,928.571,957.143,985.714,1014.29,1042.86,1071.43,1100,300,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
    ],
...
species(
    label = '[CH]1C[C]2C=CC2C1(1230)',
    structure = SMILES('[CH]1C[C]2C=CC2C1'),
    E0 = (471.588,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2807.14,2864.29,2921.43,2978.57,3035.71,3092.86,3150,900,928.571,957.143,985.714,1014.29,1042.86,1071.43,1100,300,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
    ],
    ...
    molecularWeight = (92.1384,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.7925,0.0110252,8.36193e-05,-1.02555e-07,3.60629e-11,56776.1,15.7733], Tmin=(100,'K'), Tmax=(1001.98,'K')), NASAPolynomial(coeffs=[6.50449,0.036388,-1.45032e-05,2.75452e-09,-1.98536e-13,54015.2,-12.2075], Tmin=(1001.98,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(471.588,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + Estimated bicyclic component: polycyclic(s2_4_5_ane) - ring(Cyclopentane) - ring(Cyclobutane) + ring(Cyclopentane) + ring(Cyclobutene) + radical(Allyl_T) + radical(cyclopentane)"""),
)

species(
    label = '[CH]1C[C]2C=CCC12(1231)',
...
species(
    label = '[CH]1CC2CC=C[C]12(1232)',
    structure = SMILES('[CH]1C=C2[CH]CC2C1'),
    E0 = (430.887,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2807.14,2864.29,2921.43,2978.57,3035.71,3092.86,3150,900,928.571,957.143,985.714,1014.29,1042.86,1071.43,1100,300,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
    ],
    ...
    molecularWeight = (92.1384,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.29105,0.0104288,0.000118674,-1.61901e-07,6.25237e-11,51909.9,17.793], Tmin=(100,'K'), Tmax=(953.931,'K')), NASAPolynomial(coeffs=[16.2664,0.0208377,-6.20754e-06,1.20992e-09,-9.81213e-14,46103.7,-65.4283], Tmin=(953.931,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(430.887,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + polycyclic(s2_4_5_ene_0) + radical(cyclopentene-allyl) + radical(Allyl_S)"""),
)

species(
    label = '[CH]1CC2[CH]C=CC12(1233)',
...
species(
    label = '[C]1=CC2C[CH]CC12(1236)',
    structure = SMILES('[C]1=CC2C[CH]CC12'),
    E0 = (592.093,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2807.14,2864.29,2921.43,2978.57,3035.71,3092.86,3150,900,928.571,957.143,985.714,1014.29,1042.86,1071.43,1100,300,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
    ],
    ...
    molecularWeight = (92.1384,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.47739,0.0210422,5.3451e-05,-7.08692e-08,2.47021e-11,71277.9,18.4336], Tmin=(100,'K'), Tmax=(1038.28,'K')), NASAPolynomial(coeffs=[6.75254,0.0365706,-1.52108e-05,2.9e-09,-2.07168e-13,68665.3,-10.6581], Tmin=(1038.28,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(592.093,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + Estimated bicyclic component: polycyclic(s2_4_5_ane) - ring(Cyclopentane) - ring(Cyclobutane) + ring(Cyclopentane) + ring(Cyclobutene) + radical(cyclobutene-vinyl) + radical(cyclopentane)"""),
)

species(
    label = '[CH]1CC[C]2C=CC12(1237)',
    structure = SMILES('[CH]1CC[C]2C=CC12'),
    E0 = (480.249,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2807.14,2864.29,2921.43,2978.57,3035.71,3092.86,3150,900,928.571,957.143,985.714,1014.29,1042.86,1071.43,1100,300,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
    ],
    ...
    molecularWeight = (92.1384,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.71512,0.00951714,9.54192e-05,-1.19336e-07,4.28572e-11,57823.5,16.0427], Tmin=(100,'K'), Tmax=(992.045,'K')), NASAPolynomial(coeffs=[8.79578,0.0331542,-1.31318e-05,2.54156e-09,-1.87112e-13,54247.5,-25.1873], Tmin=(992.045,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(480.249,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + Estimated bicyclic component: polycyclic(s2_4_5_ane) - ring(Cyclopentane) - ring(Cyclobutane) + ring(Cyclopentane) + ring(Cyclobutene) + radical(Cs_S) + radical(Allyl_T)"""),
)

species(
    label = '[C]1=CCC2C[CH]C12(1238)',
    structure = SMILES('[C]1=CCC2C[CH]C12'),
    E0 = (570.158,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2807.14,2864.29,2921.43,2978.57,3035.71,3092.86,3150,900,928.571,957.143,985.714,1014.29,1042.86,1071.43,1100,300,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
    ],
...
species(
    label = '[C]1=CC2CC[CH]C12(1239)',
    structure = SMILES('[C]1=CC2CC[CH]C12'),
    E0 = (600.754,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2807.14,2864.29,2921.43,2978.57,3035.71,3092.86,3150,900,928.571,957.143,985.714,1014.29,1042.86,1071.43,1100,300,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
    ],
    ...
    molecularWeight = (92.1384,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.40309,0.0195083,6.52866e-05,-8.7608e-08,3.14353e-11,72325.2,18.6914], Tmin=(100,'K'), Tmax=(1017.36,'K')), NASAPolynomial(coeffs=[8.96697,0.0334614,-1.39088e-05,2.70302e-09,-1.97043e-13,68931.9,-23.2013], Tmin=(1017.36,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(600.754,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + Estimated bicyclic component: polycyclic(s2_4_5_ane) - ring(Cyclopentane) - ring(Cyclobutane) + ring(Cyclopentane) + ring(Cyclobutene) + radical(cyclobutene-vinyl) + radical(Cs_S)"""),
)

species(
    label = '[CH]1[CH]C2C=CC2C1(1240)',
    structure = SMILES('[CH]1[CH]C2C=CC2C1'),
    E0 = (534.15,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2807.14,2864.29,2921.43,2978.57,3035.71,3092.86,3150,900,928.571,957.143,985.714,1014.29,1042.86,1071.43,1100,307.101,816.591,816.591,816.591,816.591,816.591,816.591,816.591,816.591,816.591,816.591,816.591,1614.89,1614.89,1614.89,1614.89,1614.89,1614.89,1614.89,1614.89,1614.89,1614.89,1614.89],'cm^-1')),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (92.1384,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.70963,0.0151056,6.73529e-05,-8.27479e-08,2.81743e-11,64301.2,19.6837], Tmin=(100,'K'), Tmax=(1041.48,'K')), NASAPolynomial(coeffs=[5.96562,0.0378061,-1.60467e-05,3.09407e-09,-2.22406e-13,61713.6,-5.32346], Tmin=(1041.48,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(534.15,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + Estimated bicyclic component: polycyclic(s2_4_5_ane) - ring(Cyclopentane) - ring(Cyclobutane) + ring(Cyclopentane) + ring(Cyclobutene) + radical(Cs_S) + radical(cyclopentane)"""),
)

species(
    label = '[CH]1CCC2C=C[C]12(1241)',
    structure = SMILES('[CH]1[CH]C2CCC=C12'),
    E0 = (498.123,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2807.14,2864.29,2921.43,2978.57,3035.71,3092.86,3150,900,928.571,957.143,985.714,1014.29,1042.86,1071.43,1100,300,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
    ],
    ...
    molecularWeight = (92.1384,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.28349,0.0144324,9.83538e-05,-1.35272e-07,5.16713e-11,59993.2,21.4833], Tmin=(100,'K'), Tmax=(966.105,'K')), NASAPolynomial(coeffs=[14.2016,0.0241309,-8.37687e-06,1.63689e-09,-1.26476e-13,54934.9,-49.8643], Tmin=(966.105,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(498.123,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + polycyclic(s2_4_5_ene_0) + radical(Allyl_S) + radical(Cs_S)"""),
)

species(
    label = '[C]1=CC2[CH]CCC12(1242)',
    structure = SMILES('[C]1=CC2[CH]CCC12'),
    E0 = (600.754,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2807.14,2864.29,2921.43,2978.57,3035.71,3092.86,3150,900,928.571,957.143,985.714,1014.29,1042.86,1071.43,1100,300,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
    ],
...
species(
    label = '[C]1=CC2[CH]CC2C1(1243)',
    structure = SMILES('[C]1=CC2[CH]CC2C1'),
    E0 = (570.158,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2807.14,2864.29,2921.43,2978.57,3035.71,3092.86,3150,900,928.571,957.143,985.714,1014.29,1042.86,1071.43,1100,300,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
    ],
...
species(
    label = '[CH]=CC1[CH]C=CC1(1245)',
    structure = SMILES('[CH]=CC1[CH]C=CC1'),
    E0 = (468.649,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2830,2910,2990,3070,3150,900,940,980,1020,1060,1100,3120,650,792.5,1650,3010,987.5,1337.5,450,1655,300,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
...
species(
    label = '[CH]=CC1[CH]CC=C1(1246)',
    structure = SMILES('[CH]=CC1[CH]CC=C1'),
    E0 = (527.797,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2830,2910,2990,3070,3150,900,940,980,1020,1060,1100,3120,650,792.5,1650,3010,987.5,1337.5,450,1655,300,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (92.1384,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.69207,0.0395259,1.23003e-05,-3.72643e-08,1.49998e-11,63572,23.3415], Tmin=(100,'K'), Tmax=(1043.99,'K')), NASAPolynomial(coeffs=[10.6155,0.0311458,-1.27428e-05,2.40851e-09,-1.71272e-13,60302.3,-26.8296], Tmin=(1043.99,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(527.797,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(353.365,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)CsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Cyclopentene) + radical(cyclopentene-4) + radical(Cds_P)"""),
)

species(
    label = '[CH]=CC1C=CC1[CH2](1247)',
    structure = SMILES('[CH]=CC1C=CC1[CH2]'),
    E0 = (636.596,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3010,987.5,1337.5,450,1655,3120,650,792.5,1650,2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,3000,3100,440,815,1455,1000,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    ...
    molecularWeight = (92.1384,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.32805,0.0462847,5.26034e-06,-4.09709e-08,1.95812e-11,76672.2,24.0202], Tmin=(100,'K'), Tmax=(958.175,'K')), NASAPolynomial(coeffs=[13.7852,0.0245969,-8.24694e-06,1.44738e-09,-1.01726e-13,72893.4,-42.8082], Tmin=(958.175,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(636.596,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(349.208,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)(Cds-Cds)CsH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Cyclobutene) + radical(Isobutyl) + radical(Cds_P)"""),
)

species(
    label = '[CH]=CCC1[CH]C=C1(1248)',
    structure = SMILES('[CH]=CCC1[CH]C=C1'),
    E0 = (604.576,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3010,987.5,1337.5,450,1655,3120,650,792.5,1650,2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,2750,2850,1437.5,1250,1305,750,350,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    ...
    molecularWeight = (92.1384,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.71532,0.0308591,5.48088e-05,-9.34684e-08,3.78311e-11,72813.5,23.0664], Tmin=(100,'K'), Tmax=(966.208,'K')), NASAPolynomial(coeffs=[15.2545,0.0230476,-7.95387e-06,1.50931e-09,-1.13764e-13,67945.4,-53.4391], Tmin=(966.208,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(604.576,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(349.208,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Cyclobutene) + radical(cyclobutene-allyl) + radical(Cds_P)"""),
)

species(
    label = '[CH2]C=CC1[CH]C=C1(1249)',
    structure = SMILES('[CH2]C=CC1[CH]C=C1'),
    E0 = (496.186,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,3000,3100,440,815,1455,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
...
species(
    ...
    molecularWeight = (92.1384,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.11306,0.0245751,6.30656e-05,-8.99716e-08,3.31542e-11,66650.7,26.8377], Tmin=(100,'K'), Tmax=(1007.66,'K')), NASAPolynomial(coeffs=[10.4719,0.0338102,-1.38228e-05,2.67197e-09,-1.94855e-13,62812.7,-24.2378], Tmin=(1007.66,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(553.477,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsCsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(CsJ2_singlet-CsH) + polycyclic(s2_4_5_ene_1)"""),
)

species(
    label = '[C]1CCC2C=CC12(1251)',
    structure = SMILES('[C]1CCC2C=CC12'),
    E0 = (580.186,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2807.14,2864.29,2921.43,2978.57,3035.71,3092.86,3150,900,928.571,957.143,985.714,1014.29,1042.86,1071.43,1100,300,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
    ],
    ...
    molecularWeight = (92.1384,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.0701,0.0286078,4.56292e-05,-6.82949e-08,2.47063e-11,69861.6,25.4534], Tmin=(100,'K'), Tmax=(1036.5,'K')), NASAPolynomial(coeffs=[9.04327,0.0361698,-1.52025e-05,2.91908e-09,-2.09686e-13,66564.4,-17.3708], Tmin=(1036.5,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(580.186,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(CsJ2_singlet-CsH) + Estimated bicyclic component: polycyclic(s2_4_5_ane) - ring(Cyclopentane) - ring(Cyclobutane) + ring(Cyclopentane) + ring(Cyclobutene)"""),
)

species(
    label = '[C]1CC2CC=CC12(1252)',
    structure = SMILES('[C]1CC2CC=CC12'),
    E0 = (551.272,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2807.14,2864.29,2921.43,2978.57,3035.71,3092.86,3150,900,928.571,957.143,985.714,1014.29,1042.86,1071.43,1100,300,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
    ],
    ...
    molecularWeight = (92.1384,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.051,0.0285117,4.76136e-05,-7.09391e-08,2.56934e-11,66385.3,26.3598], Tmin=(100,'K'), Tmax=(1035.33,'K')), NASAPolynomial(coeffs=[9.35639,0.0360919,-1.52434e-05,2.93878e-09,-2.11736e-13,62953.6,-18.4054], Tmin=(1035.33,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(551.272,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsCsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(CsJ2_singlet-CsH) + polycyclic(s2_4_5_ene_1)"""),
)

species(
    label = '[C]1CC2C=CC2C1(1253)',
    structure = SMILES('[C]1CC2C=CC2C1'),
    E0 = (582.39,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2807.14,2864.29,2921.43,2978.57,3035.71,3092.86,3150,900,928.571,957.143,985.714,1014.29,1042.86,1071.43,1100,300,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
    ],
    ...
    molecularWeight = (92.1384,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.13277,0.0246643,6.11037e-05,-8.73538e-08,3.21771e-11,70127,25.2359], Tmin=(100,'K'), Tmax=(1007.6,'K')), NASAPolynomial(coeffs=[10.1541,0.0338958,-1.37863e-05,2.65329e-09,-1.92888e-13,66425.4,-23.8698], Tmin=(1007.6,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(582.39,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(CsJ2_singlet-CsH) + Estimated bicyclic component: polycyclic(s2_4_5_ane) - ring(Cyclopentane) - ring(Cyclobutane) + ring(Cyclopentane) + ring(Cyclobutene)"""),
)

species(
    label = 'C=CC1C2C=CC12(1254)',
    structure = SMILES('C=CC1C2C=CC12'),
    E0 = (390.228,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3010,987.5,1337.5,450,1655,2750,2850,2950,3050,3150,900,950,1000,1050,1100,2950,3100,1380,975,1025,1650,300,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (92.1384,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.96648,0.0222717,8.01311e-05,-1.20151e-07,4.73225e-11,47027.1,20.1776], Tmin=(100,'K'), Tmax=(962.277,'K')), NASAPolynomial(coeffs=[15.6629,0.0218355,-7.25672e-06,1.40454e-09,-1.09107e-13,41775.4,-58.9644], Tmin=(962.277,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(390.228,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(353.365,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + polycyclic(s2_3_4_ene_1)"""),
)

species(
    label = '[CH]1C2[CH]C3C1CC23(1255)',
    structure = SMILES('[CH]1C2[CH]C3C1CC23'),
    E0 = (648.441,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2807.14,2864.29,2921.43,2978.57,3035.71,3092.86,3150,900,928.571,957.143,985.714,1014.29,1042.86,1071.43,1100,333.947,834.74,834.74,834.74,834.74,834.74,834.74,834.74,834.74,834.74,834.74,834.74,1677.49,1677.49,1677.49,1677.49,1677.49,1677.49,1677.49,1677.49,1677.49,1677.49,1677.49],'cm^-1')),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (92.1384,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.86818,0.0188157,4.52537e-05,-5.05569e-08,1.45415e-11,78034.7,11.4095], Tmin=(100,'K'), Tmax=(1240.74,'K')), NASAPolynomial(coeffs=[3.75713,0.0450093,-2.15448e-05,4.21148e-09,-2.9746e-13,75577.3,-2.08475], Tmin=(1240.74,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(648.441,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + polycyclic(s2_4_5_ane) + polycyclic(s3_4_5_ane) + polycyclic(s2_4_4_ane) - ring(Cyclopentane) - ring(Cyclobutane) - ring(Cyclobutane) + radical(bicyclo[2.1.1]hexane-C5) + radical(bicyclo[2.1.1]hexane-C2)"""),
)

species(
    label = '[CH]1C2CC3[CH]C2C13(1256)',
    structure = SMILES('[CH]1C2CC3[CH]C2C13'),
    E0 = (667.687,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2807.14,2864.29,2921.43,2978.57,3035.71,3092.86,3150,900,928.571,957.143,985.714,1014.29,1042.86,1071.43,1100,333.947,834.74,834.74,834.74,834.74,834.74,834.74,834.74,834.74,834.74,834.74,834.74,1677.49,1677.49,1677.49,1677.49,1677.49,1677.49,1677.49,1677.49,1677.49,1677.49,1677.49],'cm^-1')),
    ],
    ...
    molecularWeight = (92.1384,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.8682,0.0188155,4.52543e-05,-5.05576e-08,1.45417e-11,80349.5,10.7163], Tmin=(100,'K'), Tmax=(1240.73,'K')), NASAPolynomial(coeffs=[3.75694,0.0450095,-2.15449e-05,4.21151e-09,-2.97462e-13,77892.2,-2.77686], Tmin=(1240.73,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(667.687,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + polycyclic(s3_4_5_ane) + polycyclic(s2_4_5_ane) + polycyclic(s2_4_4_ane) - ring(Cyclobutane) - ring(Cyclopentane) - ring(Cyclobutane) + radical(bicyclo[2.1.1]hexane-C5) + radical(bicyclo[2.1.1]hexane-C5)"""),
)

species(
    label = '[CH]1CC2[CH]C3C1C23(1257)',
    structure = SMILES('[CH]1CC2[CH]C3C1C23'),
    E0 = (573.472,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2807.14,2864.29,2921.43,2978.57,3035.71,3092.86,3150,900,928.571,957.143,985.714,1014.29,1042.86,1071.43,1100,300.343,801.22,801.22,801.22,801.22,801.22,801.22,801.22,801.22,801.22,801.22,801.22,1602.57,1602.57,1602.57,1602.57,1602.57,1602.57,1602.57,1602.57,1602.57,1602.57,1602.57],'cm^-1')),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (92.1384,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.81533,0.0236224,3.11394e-05,-3.64222e-08,9.94065e-12,69016.9,13.4445], Tmin=(100,'K'), Tmax=(1346.15,'K')), NASAPolynomial(coeffs=[4.57356,0.0446643,-2.15753e-05,4.17885e-09,-2.91417e-13,66163.6,-4.40015], Tmin=(1346.15,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(573.472,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + polycyclic(s2_4_5_ane) + polycyclic(s2_3_5_ane) + polycyclic(s2_3_4_ane) - ring(Cyclobutane) - ring(Cyclopentane) - ring(Cyclopropane) + radical(bicyclo[3.1.1]heptane-C6) + radical(bicyclo[3.1.0]hexane-C5-2)"""),
)

species(
    label = '[CH]1CC2C3[CH]C2C13(1258)',
    structure = SMILES('[CH]1CC2C3[CH]C2C13'),
    E0 = (679.084,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2807.14,2864.29,2921.43,2978.57,3035.71,3092.86,3150,900,928.571,957.143,985.714,1014.29,1042.86,1071.43,1100,334.424,835.71,835.71,835.71,835.71,835.71,835.71,835.71,835.71,835.71,835.71,835.71,1691.16,1691.16,1691.16,1691.16,1691.16,1691.16,1691.16,1691.16,1691.16,1691.16,1691.16],'cm^-1')),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (92.1384,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.95993,0.0171082,4.83434e-05,-5.25221e-08,1.49575e-11,81716.6,9.81226], Tmin=(100,'K'), Tmax=(1244.43,'K')), NASAPolynomial(coeffs=[3.25305,0.0458114,-2.19885e-05,4.2997e-09,-3.03605e-13,79348.3,-0.888845], Tmin=(1244.43,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(679.084,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + polycyclic(s2_4_5_ane) + polycyclic(s2_4_5_ane) + polycyclic(s3_4_4_ane) - ring(Cyclobutane) - ring(Cyclobutane) - ring(Cyclopentane) + radical(bicyclo[1.1.1]pentane-C2) + radical(bicyclo[2.1.1]hexane-C2)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(19)', '[CH]1C=CC=CC=C1(241)'],
    products = ['C7H8(11)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(19)', '[C]1=CC=CC=CC1(242)'],
    products = ['C7H8(11)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(19)', '[C]1=CCC=CC=C1(243)'],
    products = ['C7H8(11)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H(19)', '[C]1=CC=CCC=C1(244)'],
    products = ['C7H8(11)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(6.117e+14,'cm^3/(mol*s)'), n=-0.152, Ea=(4.19655,'kJ/mol'), T0=(1,'K'), comment="""From training reaction 49 used for Cd_rad/Cd;H_rad
Exact match found for rate rule [Cd_rad/Cd;H_rad]
...
reaction(
    label = 'reaction6',
    reactants = ['[CH]1C=C[CH]CC=C1(125)'],
    products = ['C7H8(11)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction22',
    reactants = ['[CH]1C[CH]C2C=CC12(254)'],
    products = ['C7H8(11)'],
...
reaction(
    label = 'reaction23',
    reactants = ['H(19)', 'C1=CC2C=C[C]2C1(1222)'],
    products = ['C1=CC2C=CC2C1(253)'],
...
reaction(
    label = 'reaction24',
    reactants = ['H(19)', 'C1=C[C]2C=CC2C1(1223)'],
    products = ['C1=CC2C=CC2C1(253)'],
...
reaction(
    label = 'reaction25',
    reactants = ['H(19)', '[CH]1C=CC2C=CC12(1224)'],
    products = ['C1=CC2C=CC2C1(253)'],
...
reaction(
    label = 'reaction26',
    reactants = ['H(19)', '[C]1=CC2C=CCC12(1225)'],
    products = ['C1=CC2C=CC2C1(253)'],
...
reaction(
    label = 'reaction27',
    reactants = ['H(19)', '[C]1=CCC2C=CC12(1226)'],
    products = ['C1=CC2C=CC2C1(253)'],
...
reaction(
    label = 'reaction28',
    reactants = ['H(19)', '[C]1=CC2CC=CC12(1227)'],
    products = ['C1=CC2C=CC2C1(253)'],
...
reaction(
    label = 'reaction29',
    reactants = ['H(19)', '[C]1=CC2C=CC2C1(1228)'],
    products = ['C1=CC2C=CC2C1(253)'],
...
reaction(
    label = 'reaction30',
    reactants = ['[CH]1C[C]2CC=CC12(1229)'],
    products = ['C1=CC2C=CC2C1(253)'],
...
reaction(
    label = 'reaction31',
    reactants = ['[CH]1C[C]2C=CC2C1(1230)'],
    products = ['C1=CC2C=CC2C1(253)'],
...
reaction(
    label = 'reaction32',
    reactants = ['[CH]1C[C]2C=CCC12(1231)'],
    products = ['C1=CC2C=CC2C1(253)'],
...
reaction(
    label = 'reaction34',
    reactants = ['[CH]1CC2CC=C[C]12(1232)'],
    products = ['C1=CC2C=CC2C1(253)'],
...
reaction(
    label = 'reaction35',
    reactants = ['[CH]1CC2[CH]C=CC12(1233)'],
    products = ['C1=CC2C=CC2C1(253)'],
...
reaction(
    label = 'reaction36',
    reactants = ['[CH]1CC2C=CC[C]12(1234)'],
    products = ['C1=CC2C=CC2C1(253)'],
...
reaction(
    label = 'reaction37',
    reactants = ['[C]1=CCC2[CH]CC12(1235)'],
    products = ['C1=CC2C=CC2C1(253)'],
...
reaction(
    label = 'reaction38',
    reactants = ['[C]1=CC2C[CH]CC12(1236)'],
    products = ['C1=CC2C=CC2C1(253)'],
...
reaction(
    label = 'reaction39',
    reactants = ['[CH]1CC[C]2C=CC12(1237)'],
    products = ['C1=CC2C=CC2C1(253)'],
...
reaction(
    label = 'reaction40',
    reactants = ['[C]1=CCC2C[CH]C12(1238)'],
    products = ['C1=CC2C=CC2C1(253)'],
...
reaction(
    label = 'reaction41',
    reactants = ['[C]1=CC2CC[CH]C12(1239)'],
    products = ['C1=CC2C=CC2C1(253)'],
...
reaction(
    label = 'reaction42',
    reactants = ['[CH]1[CH]C2C=CC2C1(1240)'],
    products = ['C1=CC2C=CC2C1(253)'],
...
reaction(
    label = 'reaction43',
    reactants = ['[CH]1CCC2C=C[C]12(1241)'],
    products = ['C1=CC2C=CC2C1(253)'],
...
reaction(
    label = 'reaction44',
    reactants = ['[C]1=CC2[CH]CCC12(1242)'],
    products = ['C1=CC2C=CC2C1(253)'],
...
reaction(
    label = 'reaction45',
    reactants = ['[C]1=CC2[CH]CC2C1(1243)'],
    products = ['C1=CC2C=CC2C1(253)'],
...
reaction(
    label = 'reaction46',
    reactants = ['[C]1=CC2C[CH]C2C1(1244)'],
    products = ['C1=CC2C=CC2C1(253)'],
...
reaction(
    label = 'reaction47',
    reactants = ['[CH]=CC1[CH]C=CC1(1245)'],
    products = ['C1=CC2C=CC2C1(253)'],
...
reaction(
    label = 'reaction48',
    reactants = ['[CH]=CC1[CH]CC=C1(1246)'],
    products = ['C1=CC2C=CC2C1(253)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(3.6e+12,'s^-1'), n=-0.1525, Ea=(7.90776,'kJ/mol'), T0=(1,'K'), comment="""Estimated using average of templates [Rn;C_rad_out_1H;Cpri_rad_out_single] + [R4;C_rad_out_single;Cpri_rad_out_single] for rate rule [R4_SDS;C_rad_out_H/NonDeC;Cpri_rad_out_H/OneDe]
Euclidian distance = 3.0
Multiplied by reaction path degeneracy 2.0
family: Birad_recombination"""),
)
...
reaction(
    label = 'reaction50',
    reactants = ['[CH]=CC1C=CC1[CH2](1247)'],
    products = ['C1=CC2C=CC2C1(253)'],
...
reaction(
    label = 'reaction51',
    reactants = ['[CH]=CCC1[CH]C=C1(1248)'],
    products = ['C1=CC2C=CC2C1(253)'],
...
reaction(
    label = 'reaction52',
    reactants = ['[CH2]C=CC1[CH]C=C1(1249)'],
    products = ['C1=CC2C=CC2C1(253)'],
...
reaction(
    label = 'reaction58',
    reactants = ['[CH]1C2[CH]C3C1CC23(1255)'],
    products = ['C1=CC2C=CC2C1(253)'],
...
reaction(
    label = 'reaction59',
    reactants = ['[CH]1C2CC3[CH]C2C13(1256)'],
    products = ['C1=CC2C=CC2C1(253)'],
...
reaction(
    label = 'reaction60',
    reactants = ['[CH]1CC2[CH]C3C1C23(1257)'],
    products = ['C1=CC2C=CC2C1(253)'],
...
reaction(
    label = 'reaction61',
    reactants = ['[CH]1CC2C3[CH]C2C13(1258)'],
    products = ['C1=CC2C=CC2C1(253)'],
