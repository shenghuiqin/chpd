...
species(
    ...
    molecularWeight = (128.169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.225334,0.0380074,0.000142958,-2.4007e-07,1.03158e-10,14596.4,34.9039], Tmin=(100,'K'), Tmax=(916.551,'K')), NASAPolynomial(coeffs=[34.6711,0.00462597,6.1977e-06,-1.38452e-09,8.29223e-14,3370.02,-155.073], Tmin=(916.551,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(119.883,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(498.868,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + ring(Cycloheptane) + radical(C2CsJOOH) + radical(cycloheptane)"""),
)

species(
    label = 'OOC1[CH]C[CH]CCC1(506)',
...
species(
    ...
    molecularWeight = (128.169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.370093,0.0316809,0.000164079,-2.66584e-07,1.14227e-10,10397.5,34.1568], Tmin=(100,'K'), Tmax=(911.272,'K')), NASAPolynomial(coeffs=[36.2207,-7.89872e-07,9.34723e-06,-2.03546e-09,1.28658e-13,-1354.95,-164.104], Tmin=(911.272,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(84.9887,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + ring(Cycloheptane) + radical(ROOJ) + radical(cycloheptane)"""),
)

species(
    label = 'OOC1C[CH]CC[CH]C1(510)',
...
species(
    ...
    molecularWeight = (128.169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.713706,0.101938,-8.78921e-05,3.96963e-08,-7.3676e-12,16207.5,35.8368], Tmin=(100,'K'), Tmax=(1265.89,'K')), NASAPolynomial(coeffs=[17.5428,0.0442507,-1.95354e-05,3.69683e-09,-2.58034e-13,11585.3,-56.5443], Tmin=(1265.89,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(133.335,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(478.082,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(C=CCJCO) + radical(RCCJ)"""),
)

species(
    label = '[CH]=CCCCC[CH]OO(515)',
    structure = SMILES('[CH]=CCCCC[CH]OO'),
    E0 = (259.494,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,3120,650,792.5,1650,3615,1310,387.5,850,1000,3010,987.5,1337.5,450,1655,2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2]CCCC=C[CH]OO(516)',
    structure = SMILES('[CH2]CCCC=C[CH]OO'),
    E0 = (140.803,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2995,3025,975,1000,1300,1375,400,500,1630,1680,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,3615,1310,387.5,850,1000,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
reaction(
    label = 'reaction1',
    reactants = ['[CH]1C=CCCCC1(102)', 'HO2(26)'],
    products = ['OOC1C=CCCCC1(259)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['[O]C1C=CCCCC1(160)', 'OH(21)'],
    products = ['OOC1C=CCCCC1(259)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(19)', '[O]OC1C=CCCCC1(142)'],
    products = ['OOC1C=CCCCC1(259)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(19)', 'OOC1C=CCC[CH]C1(149)'],
    products = ['OOC1C=CCCCC1(259)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H(19)', 'OOC1[CH]CCCC=C1(147)'],
    products = ['OOC1C=CCCCC1(259)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(2e+13,'cm^3/(mol*s)','*|/',3.16), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), comment="""From training reaction 59 used for H_rad;C_rad/H/NonDeC
Exact match found for rate rule [C_rad/H/NonDeC;H_rad]
...
reaction(
    label = 'reaction6',
    reactants = ['H(19)', 'OO[C]1C=CCCCC1(146)'],
    products = ['OOC1C=CCCCC1(259)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(19)', 'OOC1C=CC[CH]CC1(151)'],
    products = ['OOC1C=CCCCC1(259)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(2e+13,'cm^3/(mol*s)','*|/',3.16), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), comment="""From training reaction 59 used for H_rad;C_rad/H/NonDeC
Exact match found for rate rule [C_rad/H/NonDeC;H_rad]
...
reaction(
    label = 'reaction8',
    reactants = ['H(19)', 'OOC1C=C[CH]CCC1(152)'],
    products = ['OOC1C=CCCCC1(259)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(19)', 'OOC1[C]=CCCCC1(148)'],
    products = ['OOC1C=CCCCC1(259)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(19)', 'OOC1C=[C]CCCC1(150)'],
    products = ['OOC1C=CCCCC1(259)'],
...
reaction(
    label = 'reaction11',
    reactants = ['OO[C]1C[CH]CCCC1(505)'],
    products = ['OOC1C=CCCCC1(259)'],
...
reaction(
    label = 'reaction12',
    reactants = ['OOC1[CH]C[CH]CCC1(506)'],
    products = ['OOC1C=CCCCC1(259)'],
...
reaction(
    label = 'reaction13',
    reactants = ['OOC1[CH]CCC[CH]C1(507)'],
    products = ['OOC1C=CCCCC1(259)'],
...
reaction(
    label = 'reaction14',
    reactants = ['OOC1[CH]CC[CH]CC1(508)'],
    products = ['OOC1C=CCCCC1(259)'],
...
reaction(
    label = 'reaction15',
    reactants = ['OOC1[CH]CCCC[CH]1(366)'],
    products = ['OOC1C=CCCCC1(259)'],
...
reaction(
    label = 'reaction16',
    reactants = ['OOC1C[CH]C[CH]CC1(509)'],
    products = ['OOC1C=CCCCC1(259)'],
...
reaction(
    label = 'reaction18',
    reactants = ['OOC1C[CH]CC[CH]C1(510)'],
    products = ['OOC1C=CCCCC1(259)'],
...
reaction(
    label = 'reaction20',
    reactants = ['OOC1C[CH][CH]CCC1(511)'],
    products = ['OOC1C=CCCCC1(259)'],
...
reaction(
    label = 'reaction21',
    reactants = ['OO[C]1[CH]CCCCC1(512)'],
    products = ['OOC1C=CCCCC1(259)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH]=CC(CCC[CH2])OO(513)'],
    products = ['OOC1C=CCCCC1(259)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH2]C=CC(CC[CH2])OO(514)'],
    products = ['OOC1C=CCCCC1(259)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[CH2]CCCC=C[CH]OO(516)'],
    products = ['OOC1C=CCCCC1(259)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[CH2]CC=CC(C[CH2])OO(517)'],
    products = ['OOC1C=CCCCC1(259)'],
...
reaction(
    label = 'reaction27',
    reactants = ['[CH2]CCC=CC([CH2])OO(518)'],
    products = ['OOC1C=CCCCC1(259)'],
...
network(
    ...
    reactants = [
        ('[CH]1C=CCCCC1(102)', 'HO2(26)'),
        ('H(19)', '[O]OC1C=CCCCC1(142)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
