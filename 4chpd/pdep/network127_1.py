...
species(
    label = 'C=CC=[C]CO[O](671)',
    structure = SMILES('C=CC=[C]CO[O]'),
    E0 = (366.111,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,3100,1380,975,1025,1650,2995,3025,975,1000,1300,1375,400,500,1630,1680,1685,370,492.5,1135,1000,2750,2850,1437.5,1250,1305,750,350,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.56495,'amu*angstrom^2'), symmetry=1, barrier=(12.9893,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.565091,'amu*angstrom^2'), symmetry=1, barrier=(12.9926,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.565523,'amu*angstrom^2'), symmetry=1, barrier=(13.0025,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (98.0999,'amu'),
...
species(
    label = 'C=C[C]=CCO[O](673)',
    structure = SMILES('C=C[C]=CCO[O]'),
    E0 = (327.265,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,3100,1380,975,1025,1650,2995,3025,975,1000,1300,1375,400,500,1630,1680,1685,370,492.5,1135,1000,2750,2850,1437.5,1250,1305,750,350,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.634515,'amu*angstrom^2'), symmetry=1, barrier=(14.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.633402,'amu*angstrom^2'), symmetry=1, barrier=(14.5632,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(3.04409,'amu*angstrom^2'), symmetry=1, barrier=(69.9897,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (98.0999,'amu'),
...
species(
    label = 'C=[C]C=CCO[O](674)',
    structure = SMILES('C=C=C[CH]CO[O]'),
    E0 = (304.656,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,540,610,2055,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,492.5,1135,1000,2750,2850,1437.5,1250,1305,750,350,180,180],'cm^-1')),
        HinderedRotor(inertia=(1.27776,'amu*angstrom^2'), symmetry=1, barrier=(29.3782,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.28586,'amu*angstrom^2'), symmetry=1, barrier=(29.5644,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.27636,'amu*angstrom^2'), symmetry=1, barrier=(29.346,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (98.0999,'amu'),
...
reaction(
    label = 'reaction2',
    reactants = ['C=CC=CCO[O](422)'],
    products = ['C=C[CH]C1COO1(667)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction9',
    reactants = ['CH2CHCHCH(170)', '[CH2]O[O](669)'],
    products = ['C=CC=CCO[O](422)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(19)', 'C=CC=C[CH]O[O](670)'],
    products = ['C=CC=CCO[O](422)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(19)', 'C=CC=[C]CO[O](671)'],
    products = ['C=CC=CCO[O](422)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH]=CCO[O](672)', 'C2H3(44)'],
    products = ['C=CC=CCO[O](422)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(19)', 'C=C[C]=CCO[O](673)'],
    products = ['C=CC=CCO[O](422)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(19)', 'C=[C]C=CCO[O](674)'],
    products = ['C=CC=CCO[O](422)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(19)', '[CH]=CC=CCO[O](675)'],
    products = ['C=CC=CCO[O](422)'],
