...
species(
    label = '[O]CC1C=CC=CCC=1(1517)',
    structure = SMILES('[O]CC1C=CC=CCC=1'),
    E0 = (200.482,'kJ/mol'),
    modes = [
...
species(
    label = 'O[CH]C1[CH]CC=CC=C1(1519)',
    structure = SMILES('O[CH]C1[CH]CC=CC=C1'),
    E0 = (256.111,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2807.14,2864.29,2921.43,2978.57,3035.71,3092.86,3150,900,928.571,957.143,985.714,1014.29,1042.86,1071.43,1100,3615,1277.5,1000,3025,407.5,1350,352.5,300,800,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    ...
    molecularWeight = (122.164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.617692,0.0933454,-8.24089e-05,3.74949e-08,-6.82956e-12,30976,19.5736], Tmin=(100,'K'), Tmax=(1317.34,'K')), NASAPolynomial(coeffs=[19.4639,0.0323689,-1.29769e-05,2.35719e-09,-1.61198e-13,25685.2,-82.843], Tmin=(1317.34,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(256.111,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(448.981,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + ring(1,3-Cycloheptadiene) + radical(CCsJOH) + radical(Cs_S)"""),
)
...
species(
    label = 'OC[C]1[CH]CC=CC=C1(1520)',
    structure = SMILES('OCC1[CH]CC=C[CH]C=1'),
    E0 = (140.995,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (122.164,'amu'),
...
species(
    label = 'OCC1[C]=CC=CC[CH]1(1521)',
    structure = SMILES('OCC1[C]=CC=CC[CH]1'),
    E0 = (313.655,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (122.164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.33709,0.0886981,-7.42664e-05,3.22781e-08,-5.67846e-12,37885.5,19.4899], Tmin=(100,'K'), Tmax=(1348.74,'K')), NASAPolynomial(coeffs=[17.8625,0.0347231,-1.42382e-05,2.60685e-09,-1.78642e-13,32976.2,-73.7572], Tmin=(1348.74,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(313.655,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(448.981,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + ring(1,3-Cycloheptadiene) + radical(Cds_S) + radical(Cs_S)"""),
)
...
species(
    label = 'OCC1[CH]CC=C[C]=C1(1522)',
    structure = SMILES('OCC1[CH]CC=C[C]=C1'),
    E0 = (274.808,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (122.164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.371241,0.0905539,-7.84861e-05,3.61433e-08,-6.76604e-12,33213.8,18.7333], Tmin=(100,'K'), Tmax=(1272.07,'K')), NASAPolynomial(coeffs=[16.8767,0.0363178,-1.45316e-05,2.62588e-09,-1.78836e-13,28825.7,-68.6288], Tmin=(1272.07,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(274.808,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(448.981,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + ring(1,3-Cycloheptadiene) + radical(C=CJC=C) + radical(Cs_S)"""),
)

species(
    label = 'OCC1[CH]C[C]=CC=C1(1523)',
    ...
    molecularWeight = (122.164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.33709,0.0886981,-7.42664e-05,3.22781e-08,-5.67846e-12,37885.5,19.4899], Tmin=(100,'K'), Tmax=(1348.74,'K')), NASAPolynomial(coeffs=[17.8625,0.0347231,-1.42382e-05,2.60685e-09,-1.78642e-13,32976.2,-73.7572], Tmin=(1348.74,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(313.655,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(448.981,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + ring(1,3-Cycloheptadiene) + radical(Cs_S) + radical(Cds_S)"""),
)

species(
    label = 'OCC1[CH]CC=[C]C=C1(1524)',
    structure = SMILES('OCC1[CH]CC=[C]C=C1'),
    E0 = (274.808,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
species(
    label = '[O]CC1[CH]C2C=CCC21(1525)',
    structure = SMILES('[O]CC1[CH]C2C=CCC21'),
    E0 = (345.707,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (122.164,'amu'),
...
species(
    label = '[O]CC1C=CC2[CH]CC21(1526)',
    structure = SMILES('[O]CC1C=CC2[CH]CC21'),
    E0 = (346.777,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (122.164,'amu'),
...
species(
    label = '[CH]1CC=CC2[CH]C1CO2(1443)',
    ...
    molecularWeight = (122.164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.294391,0.0806238,-4.43442e-05,2.4669e-09,3.6804e-12,24962.8,3.28019], Tmin=(100,'K'), Tmax=(1143.29,'K')), NASAPolynomial(coeffs=[18.8917,0.0360938,-1.55667e-05,2.97352e-09,-2.10536e-13,19099,-98.3092], Tmin=(1143.29,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(206.171,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + Estimated bicyclic component: polycyclic(PolycyclicRing) - ring(Cycloheptane) - ring(Tetrahydrofuran) + ring(Cycloheptene) + ring(Tetrahydrofuran) + radical(Cs_S) + radical(CCJCO)"""),
)

species(
    label = '[O]CC1C=C[CH]C2CC21(1527)',
    structure = SMILES('[O]CC1[CH]C=CC2CC12'),
    E0 = (277.616,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (122.164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.22939,0.0442592,3.88419e-05,-6.99298e-08,2.61554e-11,33503.6,24.0063], Tmin=(100,'K'), Tmax=(1044.88,'K')), NASAPolynomial(coeffs=[11.8475,0.043901,-1.8483e-05,3.54827e-09,-2.54578e-13,29085.3,-38.2105], Tmin=(1044.88,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(277.616,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + polycyclic(s2_3_6_ene_1) + radical(cyclohexene-allyl) + radical(CCOJ)"""),
)

species(
    label = '[O]CC1C2[CH]C=CCC21(1528)',
    structure = SMILES('[O]CC1C2C=C[CH]CC21'),
    E0 = (277.616,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (122.164,'amu'),
...
species(
    label = '[CH]1C=CC2C[CH]C1CO2(1379)',
...
species(
    label = 'OCC1C=CC=CCC=1(1531)',
    structure = SMILES('OCC1C=CC=CCC=1'),
    E0 = (-25.223,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (122.164,'amu'),
...
species(
    label = '[O]CC1[CH]CCC=CC=1(1532)',
    structure = SMILES('[O]CC1[CH]C=CCCC=1'),
    E0 = (225.588,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (122.164,'amu'),
...
species(
    label = '[O]CC1[CH]CC2C=CC12(1533)',
    structure = SMILES('[O]CC1[CH]CC2C=CC12'),
    E0 = (381.324,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (122.164,'amu'),
...
reaction(
    label = 'reaction2',
    reactants = ['H(19)', '[O]CC1C=CC=CCC=1(1517)'],
    products = ['[O]CC1[CH]CC=CC=C1(1354)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['H(19)', 'O=CC1[CH]CC=CC=C1(1518)'],
    products = ['[O]CC1[CH]CC=CC=C1(1354)'],
    transitionState = 'TS4',
...
reaction(
    ...
    products = ['[O]CC1[CH]CC=CC=C1(1354)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(450.719,'m^3/(mol*s)'), n=0.996465, Ea=(93.8721,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [CO-HH_O;CJ]
Euclidian distance = 0
Multiplied by reaction path degeneracy 2.0
family: R_Addition_MultipleBond"""),
)
...
reaction(
    label = 'reaction7',
    reactants = ['[O]C[C]1C=CC=CCC1(1507)'],
    products = ['[O]CC1[CH]CC=CC=C1(1354)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['O[CH]C1[CH]CC=CC=C1(1519)'],
    products = ['[O]CC1[CH]CC=CC=C1(1354)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]CC1[CH]CC=CC=C1(1354)'],
    products = ['[O][CH]C1C=CC=CCC1(1509)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[O]CC1[CH]CC=CC=C1(1354)'],
    products = ['OC[C]1[CH]CC=CC=C1(1520)'],
...
reaction(
    label = 'reaction14',
    reactants = ['OCC1[C]=CC=CC[CH]1(1521)'],
    products = ['[O]CC1[CH]CC=CC=C1(1354)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[O]CC1[CH]CC=CC=C1(1354)'],
    products = ['OCC1[CH]CC=C[C]=C1(1522)'],
...
reaction(
    label = 'reaction19',
    reactants = ['OCC1[CH]C[C]=CC=C1(1523)'],
    products = ['[O]CC1[CH]CC=CC=C1(1354)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[O]CC1[CH]CC=CC=C1(1354)'],
    products = ['OCC1[CH]CC=[C]C=C1(1524)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[O]CC1[CH]CC=CC=C1(1354)'],
    products = ['[O]CC1[CH]C2C=CCC21(1525)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[O]CC1[CH]CC=CC=C1(1354)'],
    products = ['[O]CC1C=CC2[CH]CC21(1526)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[O]CC1[CH]CC=CC=C1(1354)'],
    products = ['[CH]1CC=CC2[CH]C1CO2(1443)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[O]CC1[CH]CC=CC=C1(1354)'],
    products = ['[O]CC1C=C[CH]C2CC21(1527)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[O]CC1[CH]CC=CC=C1(1354)'],
    products = ['[O]CC1C2[CH]C=CCC21(1528)'],
...
reaction(
    label = 'reaction28',
    reactants = ['[O]CC1[CH]CC=CC=C1(1354)'],
    products = ['[CH]1C=CC2C[CH]C1CO2(1379)'],
...
reaction(
    label = 'reaction29',
    reactants = ['[O]CC1[CH]CC=CC=C1(1354)'],
    products = ['[CH]1CC=C[CH]C2OCC12(1456)'],
...
reaction(
    label = 'reaction30',
    reactants = ['[CH]=CC=CC(C=C)C[O](1529)'],
    products = ['[O]CC1[CH]CC=CC=C1(1354)'],
...
reaction(
    label = 'reaction35',
    reactants = ['[O]CC1[CH]CC=CC=C1(1354)'],
    products = ['[O]CC1[CH]CCC=CC=1(1532)'],
...
reaction(
    label = 'reaction36',
    reactants = ['[O]CC1[CH]CC=CC=C1(1354)'],
    products = ['[O]C[CH]C1C=CC=CC1(1504)'],
...
reaction(
    label = 'reaction37',
    reactants = ['[O]CC1[CH]CC=CC=C1(1354)'],
    products = ['[CH2]C1C=CC=CC1C[O](1516)'],
...
reaction(
    label = 'reaction39',
    reactants = ['[O]CC1[CH]CC=CC=C1(1354)'],
    products = ['[O]CC1[CH]CC2C=CC12(1533)'],
...
reaction(
    label = 'reaction40',
    reactants = ['O(20)', '[CH2]C1[CH]CC=CC=C1(582)'],
    products = ['[O]CC1[CH]CC=CC=C1(1354)'],
