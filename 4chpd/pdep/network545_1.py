...
species(
    label = 'CC([O])C1=CC(CCCC1)OO(2999)',
...
species(
    label = 'CC([O])C1C=C(CCCC1)OO(3000)',
    ...
    molecularWeight = (171.214,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.51304,0.064982,0.000149433,-2.78195e-07,1.22648e-10,-13062.9,45.7526], Tmin=(100,'K'), Tmax=(918.065,'K')), NASAPolynomial(coeffs=[45.6966,0.00553871,7.60406e-06,-1.68581e-09,1.0001e-13,-27894.4,-211.537], Tmin=(918.065,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-110.697,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(640.214,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + ring(Cycloheptene) + radical(CC(C)OJ)"""),
)

species(
    label = 'CC(=O)C1[CH]C(CCCC1)OO(3001)',
    structure = SMILES('CC(=O)C1[CH]C(CCCC1)OO'),
    E0 = (-203.241,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1310,387.5,850,1000,375,552.5,462.5,1710,2750,2790,2830,2870,2910,2950,2990,3030,3070,3110,3150,900,920,940,960,980,1000,1020,1040,1060,1080,1100,300,800,800,800,800,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (171.214,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.74544,0.0782422,0.000100082,-2.17825e-07,9.86958e-11,-24192.7,45.9847], Tmin=(100,'K'), Tmax=(921.813,'K')), NASAPolynomial(coeffs=[41.9331,0.0133705,2.79035e-06,-7.56654e-10,3.87293e-14,-37541.9,-189.911], Tmin=(921.813,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-203.241,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(640.214,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-O2d)CsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)HHH) + group(Cds-OdCsCs) + ring(Cycloheptane) + radical(CCJCOOH)"""),
)
...
species(
    label = 'CC([O])C1C=CCCCC1(3002)',
    structure = SMILES('CC([O])C1C=CCCCC1'),
    E0 = (-20.6332,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2790,2830,2870,2910,2950,2990,3030,3070,3110,3150,900,920,940,960,980,1000,1020,1040,1060,1080,1100,2750,2800,2850,1350,1500,750,1050,1375,1000,300,800,800,800,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.17668,0.0303924,0.000223144,-3.4821e-07,1.47075e-10,-2273.87,36.8566], Tmin=(100,'K'), Tmax=(913.935,'K')), NASAPolynomial(coeffs=[43.3955,-0.000474235,1.14744e-05,-2.45261e-09,1.51845e-13,-16913.6,-205.953], Tmin=(913.935,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-20.6332,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(598.642,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cycloheptene) + radical(CC(C)OJ)"""),
)

species(
    label = 'CC([O])[C]1CCCCC(C1)OO(3003)',
    structure = SMILES('CC([O])[C]1CCCCC(C1)OO'),
    E0 = (-82.5826,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (172.222,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.77354,0.0703696,0.000145948,-2.7587e-07,1.21552e-10,-9671.93,45.3139], Tmin=(100,'K'), Tmax=(920.925,'K')), NASAPolynomial(coeffs=[45.8882,0.00998943,5.45363e-06,-1.26515e-09,7.01831e-14,-24668.7,-214.461], Tmin=(920.925,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-82.5826,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(665.158,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cycloheptane) + radical(CC(C)OJ) + radical(CCJ(C)CO)"""),
)

species(
    label = 'CC([O])C1CCCC[C](C1)OO(3004)',
    structure = SMILES('CC([O])C1CCCC[C](C1)OO'),
    E0 = (-48.2574,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (172.222,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.90581,0.079504,0.000109708,-2.31649e-07,1.04247e-10,-5544.63,45.8874], Tmin=(100,'K'), Tmax=(922.049,'K')), NASAPolynomial(coeffs=[43.0337,0.0149796,2.49159e-06,-7.12972e-10,3.51299e-14,-19376.3,-197.338], Tmin=(922.049,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-48.2574,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(665.158,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cycloheptane) + radical(C2CsJOOH) + radical(CC(C)OJ)"""),
)

species(
    label = 'C[C](O)C1[CH]C(CCCC1)OO(3005)',
    ...
    molecularWeight = (172.222,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.32162,0.0915848,7.64257e-05,-2.00651e-07,9.44338e-11,-10369.3,48.3144], Tmin=(100,'K'), Tmax=(917.963,'K')), NASAPolynomial(coeffs=[44.2753,0.0123038,3.73789e-06,-9.87621e-10,5.7116e-14,-24138.6,-200.903], Tmin=(917.963,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-88.4745,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(661.001,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cycloheptane) + radical(C2CsJOH) + radical(CCJCOOH)"""),
)

species(
    label = 'CC([O])C1[CH]CCCC(C1)OO(3006)',
    structure = SMILES('CC([O])C1[CH]CCCC(C1)OO'),
    E0 = (-65.7277,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (172.222,'amu'),
...
species(
    label = 'C[C]([O])C1CCCCC(C1)OO(3007)',
    structure = SMILES('C[C]([O])C1CCCCC(C1)OO'),
    E0 = (-58.5286,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (172.222,'amu'),
...
species(
    label = 'CC([O])C1CCC[CH]C(C1)OO(3008)',
    structure = SMILES('CC([O])C1CCC[CH]C(C1)OO'),
    E0 = (-34.7415,'kJ/mol'),
    modes = [
...
species(
    label = 'CC(O)[C]1[CH]C(CCCC1)OO(3009)',
    structure = SMILES('CC(O)[C]1[CH]C(CCCC1)OO'),
    E0 = (-112.528,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (172.222,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.90438,0.0763061,0.000124445,-2.52099e-07,1.12934e-10,-13271.7,48.2806], Tmin=(100,'K'), Tmax=(919.748,'K')), NASAPolynomial(coeffs=[45.1885,0.0105153,5.02133e-06,-1.2014e-09,6.79055e-14,-27814.4,-206.941], Tmin=(919.748,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-112.528,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(661.001,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cycloheptane) + radical(CCJ(C)CO) + radical(CCJCOOH)"""),
)

species(
    label = '[CH2]C(O)C1[CH]C(CCCC1)OO(3010)',
    ...
    molecularWeight = (172.222,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.32561,0.0881023,9.35511e-05,-2.23576e-07,1.03873e-10,-6160.89,49.5384], Tmin=(100,'K'), Tmax=(916.863,'K')), NASAPolynomial(coeffs=[46.4686,0.00844155,5.93757e-06,-1.40367e-09,8.43045e-14,-20707.6,-212.165], Tmin=(916.863,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-53.5132,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(661.001,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cycloheptane) + radical(CCJCOOH) + radical(CJCO)"""),
)

species(
    label = 'CC([O])C1CCCCC(C1)O[O](3011)',
    structure = SMILES('CC([O])C1CCCCC(C1)O[O]'),
    E0 = (-83.1518,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (172.222,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.75852,0.073149,0.00013092,-2.5826e-07,1.15344e-10,-9743.7,45.1312], Tmin=(100,'K'), Tmax=(916.788,'K')), NASAPolynomial(coeffs=[44.5639,0.0103858,5.6221e-06,-1.35941e-09,8.04929e-14,-24093.2,-206.261], Tmin=(916.788,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-83.1518,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(669.315,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cycloheptane) + radical(ROOJ) + radical(CC(C)OJ)"""),
)

species(
    label = 'CC(O)C1[CH]CCCC([CH]1)OO(3012)',
    structure = SMILES('CC(O)C1[CH]CCCC([CH]1)OO'),
    E0 = (-95.6735,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2794.44,2838.89,2883.33,2927.78,2972.22,3016.67,3061.11,3105.56,3150,900,922.222,944.444,966.667,988.889,1011.11,1033.33,1055.56,1077.78,1100,3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,3615,1277.5,1000,300,800,800,800,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'CC([O])C1C[CH]CCC(C1)OO(3013)',
    structure = SMILES('CC([O])C1C[CH]CCC(C1)OO'),
    E0 = (-65.7277,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (172.222,'amu'),
...
species(
    label = 'CC([O])C1CC[CH]CC(C1)OO(3014)',
    structure = SMILES('CC([O])C1CC[CH]CC(C1)OO'),
    E0 = (-65.7277,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (172.222,'amu'),
...
species(
    label = '[CH2]C([O])C1CCCCC(C1)OO(3015)',
...
species(
    label = 'CC(O)C1[CH]C(CC[CH]C1)OO(3016)',
    ...
    molecularWeight = (172.222,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.00331,0.0834517,9.51204e-05,-2.16301e-07,9.89219e-11,-11245.6,50.0945], Tmin=(100,'K'), Tmax=(920.79,'K')), NASAPolynomial(coeffs=[42.9841,0.0140751,2.79211e-06,-7.80161e-10,4.10391e-14,-24874.1,-192.249], Tmin=(920.79,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-95.6735,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(661.001,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cycloheptane) + radical(CCJCOOH) + radical(cycloheptane)"""),
)

species(
    label = 'CC(O)C1[CH][C](CCCC1)OO(3017)',
    structure = SMILES('CC(O)C1[CH][C](CCCC1)OO'),
    E0 = (-78.2032,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (172.222,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.03688,0.0854435,8.81932e-05,-2.07861e-07,9.56191e-11,-9144.36,48.8549], Tmin=(100,'K'), Tmax=(920.794,'K')), NASAPolynomial(coeffs=[42.334,0.0155054,2.0594e-06,-6.49254e-10,3.28551e-14,-22522.1,-189.819], Tmin=(920.794,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-78.2032,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(661.001,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cycloheptane) + radical(C2CsJOOH) + radical(CCJCOOH)"""),
)

species(
    label = 'CC(O)C1[CH]C(C[CH]CC1)OO(3018)',
...
species(
    label = 'CC(O)C1[CH]C([CH]CCC1)OO(3019)',
    ...
    molecularWeight = (172.222,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.14748,0.0849357,9.73821e-05,-2.23508e-07,1.02766e-10,-7512,50.57], Tmin=(100,'K'), Tmax=(918.7,'K')), NASAPolynomial(coeffs=[44.8988,0.01094,4.56552e-06,-1.12952e-09,6.50419e-14,-21677.9,-202.463], Tmin=(918.7,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-64.6873,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(661.001,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cycloheptane) + radical(CCJCOOH) + radical(CCJCOOH)"""),
)

species(
    label = 'CC(O)C1[CH]C(CCCC1)O[O](3020)',
    ...
    molecularWeight = (172.222,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.88877,0.0790775,0.00010945,-2.34543e-07,1.06753e-10,-13343.5,48.0958], Tmin=(100,'K'), Tmax=(915.292,'K')), NASAPolynomial(coeffs=[43.8651,0.0109104,5.19051e-06,-1.29582e-09,7.82278e-14,-27239.3,-198.746], Tmin=(915.292,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-113.098,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(665.158,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cycloheptane) + radical(ROOJ) + radical(CCJCOOH)"""),
)

species(
    label = '[CH2]CCCC(C=COO)C(C)[O](3021)',
    ...
    molecularWeight = (172.222,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.46506,0.137291,-0.000121377,5.66618e-08,-1.07889e-11,4499.64,52.1161], Tmin=(100,'K'), Tmax=(1246.27,'K')), NASAPolynomial(coeffs=[22.8284,0.0561093,-2.36665e-05,4.39331e-09,-3.03828e-13,-1804.82,-75.4786], Tmin=(1246.27,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(35.444,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(644.372,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(CC(C)OJ) + radical(RCCJ)"""),
)

species(
    label = '[CH2]CCCC(C=CC(C)[O])OO(3022)',
    ...
    molecularWeight = (172.222,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.37317,0.13391,-0.000111389,4.77504e-08,-8.34012e-12,2034.14,53.2975], Tmin=(100,'K'), Tmax=(1346.6,'K')), NASAPolynomial(coeffs=[24.0189,0.0555126,-2.40609e-05,4.51587e-09,-3.13434e-13,-5073.7,-81.8825], Tmin=(1346.6,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(14.9651,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(644.372,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(RCCJ) + radical(CC(C)OJ)"""),
)

species(
    label = 'CC(O)C1=CC(CCCC1)OO(3023)',
    structure = SMILES('CC(O)C1=CC(CCCC1)OO'),
    E0 = (-358.8,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
species(
    label = 'CC(=O)C1CCCCC(C1)OO(3024)',
    structure = SMILES('CC(=O)C1CCCCC(C1)OO'),
    E0 = (-403.656,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (172.222,'amu'),
...
species(
    label = 'CC(O)C1C=C(CCCC1)OO(3025)',
    structure = SMILES('CC(O)C1C=C(CCCC1)OO'),
    E0 = (-341.058,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (172.222,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.67133,0.0689195,0.00014374,-2.73466e-07,1.21188e-10,-40763.6,46.5128], Tmin=(100,'K'), Tmax=(917.443,'K')), NASAPolynomial(coeffs=[45.7576,0.00733856,7.01425e-06,-1.59739e-09,9.49486e-14,-55577.3,-211.522], Tmin=(917.443,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-341.058,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(661.001,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + ring(Cycloheptene)"""),
)
...
species(
    label = 'CC([O])C1CCCCC2OC21(3026)',
    structure = SMILES('CC([O])C1CCCCC2OC21'),
    E0 = (-146.717,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (155.214,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.334268,0.0669752,6.01468e-05,-1.1534e-07,4.50396e-11,-17465.3,33.9166], Tmin=(100,'K'), Tmax=(1021.22,'K')), NASAPolynomial(coeffs=[20.0514,0.0554085,-2.31581e-05,4.51595e-09,-3.30091e-13,-25189.4,-82.2933], Tmin=(1021.22,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-146.717,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(623.585,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + polycyclic(s2_3_7_ane) + radical(CC(C)OJ)"""),
)
...
species(
    ...
    opticalIsomers = 1,
    molecularWeight = (172.222,'amu'),
    collisionModel = TransportData(shapeIndex=2, epsilon=(5235.42,'J/mol'), sigma=(8.98248,'angstroms'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with Tc=817.76 K, Pc=16.39 bar (from Joback method)"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.87252,0.0775157,0.000116622,-2.40071e-07,1.07541e-10,-7645.85,47.128], Tmin=(100,'K'), Tmax=(922.026,'K')), NASAPolynomial(coeffs=[43.6846,0.0135479,3.22512e-06,-8.44075e-10,4.33305e-14,-21728.7,-199.772], Tmin=(922.026,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-65.7277,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(665.158,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cycloheptane) + radical(CC(C)OJ) + radical(cycloheptane)"""),
)

species(
    label = 'CC([O])C1CCCCC1[CH]OO(3027)',
    structure = SMILES('CC([O])C1CCCCC1[CH]OO'),
    E0 = (-73.1412,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (172.222,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.13563,0.115773,-5.75415e-05,1.8064e-09,4.47377e-12,-8560.23,42.2422], Tmin=(100,'K'), Tmax=(1215.11,'K')), NASAPolynomial(coeffs=[23.6634,0.0607322,-2.64896e-05,5.01124e-09,-3.50107e-13,-17036.3,-96.3284], Tmin=(1215.11,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-73.1412,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(661.001,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Cyclohexane) + radical(CCsJOOH) + radical(CC(C)OJ)"""),
)

species(
    label = 'CC1OC2C(CCCCC12)OO(2296)',
    structure = SMILES('CC1OC2C(CCCCC12)OO'),
    E0 = (-437.814,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (172.222,'amu'),
...
species(
    label = 'CC([O])C1CCCCC([O])C1O(3028)',
    structure = SMILES('CC([O])C1CCCCC([O])C1O'),
    E0 = (-248.771,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (172.222,'amu'),
...
reaction(
    label = 'reaction2',
    reactants = ['H(19)', 'CC([O])C1=CC(CCCC1)OO(2999)'],
    products = ['CC([O])C1[CH]C(CCCC1)OO(2291)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(19)', 'CC([O])C1C=C(CCCC1)OO(3000)'],
    products = ['CC([O])C1[CH]C(CCCC1)OO(2291)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(19)', 'CC(=O)C1[CH]C(CCCC1)OO(3001)'],
    products = ['CC([O])C1[CH]C(CCCC1)OO(2291)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['CH3(34)', 'O=CC1[CH]C(CCCC1)OO(1642)'],
    products = ['CC([O])C1[CH]C(CCCC1)OO(2291)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['HO2(26)', 'CC([O])C1C=CCCCC1(3002)'],
    products = ['CC([O])C1[CH]C(CCCC1)OO(2291)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['CC([O])C1[CH]C(CCCC1)OO(2291)'],
    products = ['CC([O])[C]1CCCCC(C1)OO(3003)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['CC([O])C1[CH]C(CCCC1)OO(2291)'],
    products = ['CC([O])C1CCCC[C](C1)OO(3004)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CC([O])C1[CH]C(CCCC1)OO(2291)'],
    products = ['C[C](O)C1[CH]C(CCCC1)OO(3005)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CC([O])C1[CH]C(CCCC1)OO(2291)'],
    products = ['CC([O])C1[CH]CCCC(C1)OO(3006)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CC([O])C1[CH]C(CCCC1)OO(2291)'],
    products = ['C[C]([O])C1CCCCC(C1)OO(3007)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CC([O])C1CCC[CH]C(C1)OO(3008)'],
    products = ['CC([O])C1[CH]C(CCCC1)OO(2291)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CC([O])C1[CH]C(CCCC1)OO(2291)'],
    products = ['CC(O)[C]1[CH]C(CCCC1)OO(3009)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CC([O])C1[CH]C(CCCC1)OO(2291)'],
    products = ['[CH2]C(O)C1[CH]C(CCCC1)OO(3010)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CC([O])C1[CH]C(CCCC1)OO(2291)'],
    products = ['CC([O])C1CCCCC(C1)O[O](3011)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CC(O)C1[CH]CCCC([CH]1)OO(3012)'],
    products = ['CC([O])C1[CH]C(CCCC1)OO(2291)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CC([O])C1[CH]C(CCCC1)OO(2291)'],
    products = ['CC([O])C1C[CH]CCC(C1)OO(3013)'],
...
reaction(
    label = 'reaction20',
    reactants = ['CC([O])C1[CH]C(CCCC1)OO(2291)'],
    products = ['CC([O])C1CC[CH]CC(C1)OO(3014)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH2]C([O])C1CCCCC(C1)OO(3015)'],
    products = ['CC([O])C1[CH]C(CCCC1)OO(2291)'],
...
reaction(
    label = 'reaction22',
    reactants = ['CC([O])C1[CH]C(CCCC1)OO(2291)'],
    products = ['CC(O)C1[CH]C(CC[CH]C1)OO(3016)'],
...
reaction(
    label = 'reaction23',
    reactants = ['CC([O])C1[CH]C(CCCC1)OO(2291)'],
    products = ['CC(O)C1[CH][C](CCCC1)OO(3017)'],
...
reaction(
    label = 'reaction24',
    reactants = ['CC([O])C1[CH]C(CCCC1)OO(2291)'],
    products = ['CC(O)C1[CH]C(C[CH]CC1)OO(3018)'],
...
reaction(
    label = 'reaction25',
    reactants = ['CC([O])C1[CH]C(CCCC1)OO(2291)'],
    products = ['CC(O)C1[CH]C([CH]CCC1)OO(3019)'],
...
reaction(
    label = 'reaction26',
    reactants = ['CC([O])C1[CH]C(CCCC1)OO(2291)'],
    products = ['CC(O)C1[CH]C(CCCC1)O[O](3020)'],
...
reaction(
    label = 'reaction28',
    reactants = ['[CH2]CCCC(C=COO)C(C)[O](3021)'],
    products = ['CC([O])C1[CH]C(CCCC1)OO(2291)'],
...
reaction(
    label = 'reaction29',
    reactants = ['[CH2]CCCC(C=CC(C)[O])OO(3022)'],
    products = ['CC([O])C1[CH]C(CCCC1)OO(2291)'],
...
reaction(
    label = 'reaction30',
    reactants = ['CC([O])C1[CH]C(CCCC1)OO(2291)'],
    products = ['CC(O)C1=CC(CCCC1)OO(3023)'],
...
reaction(
    label = 'reaction31',
    reactants = ['CC([O])C1[CH]C(CCCC1)OO(2291)'],
    products = ['CC(=O)C1CCCCC(C1)OO(3024)'],
...
reaction(
    label = 'reaction32',
    reactants = ['CC([O])C1[CH]C(CCCC1)OO(2291)'],
    products = ['CC(O)C1C=C(CCCC1)OO(3025)'],
...
reaction(
    label = 'reaction33',
    reactants = ['CH2(S)(40)', '[O]CC1[CH]C(CCCC1)OO(1365)'],
    products = ['CC([O])C1[CH]C(CCCC1)OO(2291)'],
...
reaction(
    label = 'reaction34',
    reactants = ['CC([O])C1[CH]C(CCCC1)OO(2291)'],
    products = ['OH(21)', 'CC([O])C1CCCCC2OC21(3026)'],
...
reaction(
    label = 'reaction35',
    reactants = ['CC([O])C1[CH]C(CCCC1)OO(2291)'],
    products = ['CC([O])[CH]C1CCCCC1OO(2996)'],
...
reaction(
    label = 'reaction37',
    reactants = ['CC([O])C1[CH]C(CCCC1)OO(2291)'],
    products = ['CC([O])C1CCCCC1[CH]OO(3027)'],
...
reaction(
    label = 'reaction38',
    reactants = ['CC([O])C1[CH]C(CCCC1)OO(2291)'],
    products = ['CC1OC2C(CCCCC12)OO(2296)'],
...
reaction(
    label = 'reaction39',
    reactants = ['CC([O])C1[CH]C(CCCC1)OO(2291)'],
    products = ['CC([O])C1CCCCC([O])C1O(3028)'],
...
reaction(
    label = 'reaction40',
    reactants = ['O(20)', 'C[CH]C1[CH]C(CCCC1)OO(752)'],
    products = ['CC([O])C1[CH]C(CCCC1)OO(2291)'],
