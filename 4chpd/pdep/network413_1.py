...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]CO[CH2](2160)'],
    products = ['CH2O(35)', 'C2H4(45)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['H(19)', 'CH2OCHCH2(3035)'],
    products = ['[CH2]CO[CH2](2160)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction6',
    reactants = ['C2H4(T)(169)', '[CH2][O](354)'],
    products = ['[CH2]CO[CH2](2160)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['CH2(T)(33)', '[CH2]C[O](362)'],
    products = ['[CH2]CO[CH2](2160)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['CH2(T)(33)', '[CH2]O[CH2](3039)'],
    products = ['[CH2]CO[CH2](2160)'],
