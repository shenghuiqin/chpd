...
species(
    label = '[CH2]C1[CH]C(C)OC1(3144)',
    structure = SMILES('[CH2]C1[CH]C(C)OC1'),
    E0 = (137.177,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (98.143,'amu'),
...
species(
    label = '[CH2]OC(C)=CC=C(3145)',
    structure = SMILES('[CH2]OC(C)=CC=C'),
    E0 = (54.0287,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,3100,1380,975,1025,1650,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,350,440,435,1725,2995,3025,975,1000,1300,1375,400,500,1630,1680,369.4,371.172,371.22],'cm^-1')),
        HinderedRotor(inertia=(0.151969,'amu*angstrom^2'), symmetry=1, barrier=(14.7893,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.152204,'amu*angstrom^2'), symmetry=1, barrier=(14.7939,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.152051,'amu*angstrom^2'), symmetry=1, barrier=(14.7957,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.153202,'amu*angstrom^2'), symmetry=1, barrier=(14.7861,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (97.1351,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.575834,0.061572,-1.96417e-05,-2.4794e-08,1.56538e-11,6633.81,26.2685], Tmin=(100,'K'), Tmax=(965.77,'K')), NASAPolynomial(coeffs=[18.1999,0.0210081,-7.0099e-06,1.25692e-09,-9.05231e-14,1717.22,-65.9737], Tmin=(965.77,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(54.0287,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)HHH) + group(Cs-OsHHH) + group(Cds-CdsCsOs) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + radical(C=COCJ)"""),
)

species(
    label = '[CH2]OC(C)C=C=C(3146)',
    structure = SMILES('[CH2]OC(C)C=C=C'),
    E0 = (155.581,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([540,610,2055,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,180,180,629.404],'cm^-1')),
        HinderedRotor(inertia=(0.127832,'amu*angstrom^2'), symmetry=1, barrier=(14.9593,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.650633,'amu*angstrom^2'), symmetry=1, barrier=(14.9593,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.053283,'amu*angstrom^2'), symmetry=1, barrier=(14.9614,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.650655,'amu*angstrom^2'), symmetry=1, barrier=(14.9598,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (97.1351,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.432098,0.0717063,-5.93949e-05,2.52697e-08,-4.32926e-12,18846,27.7709], Tmin=(100,'K'), Tmax=(1387.64,'K')), NASAPolynomial(coeffs=[15.9777,0.0268945,-1.09544e-05,1.99721e-09,-1.3643e-13,14531.7,-52.3203], Tmin=(1387.64,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(155.581,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cs-OsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(CsJOCC2)"""),
)
...
species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.962733,'amu*angstrom^2'), symmetry=1, barrier=(22.1351,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.959731,'amu*angstrom^2'), symmetry=1, barrier=(22.0661,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.961154,'amu*angstrom^2'), symmetry=1, barrier=(22.0988,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (83.1085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.21026,0.0427324,2.00889e-05,-7.07413e-08,3.43423e-11,11642.2,21.9879], Tmin=(100,'K'), Tmax=(924.272,'K')), NASAPolynomial(coeffs=[20.66,0.00671349,3.94335e-07,-1.67522e-10,6.56509e-15,5990,-81.4409], Tmin=(924.272,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(95.8203,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-OsHHH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C=COCJ)"""),
)

species(
    label = '[CH2]O[C](C)CC=C(3148)',
    structure = SMILES('[CH2]O[C](C)CC=C'),
    E0 = (174.354,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,2950,3100,1380,975,1025,1650,360,370,350,3000,3100,440,815,1455,1000,3010,987.5,1337.5,450,1655,2750,2850,1437.5,1250,1305,750,350,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.515908,0.0819444,-9.52995e-05,6.85506e-08,-2.09884e-11,21090.6,27.8994], Tmin=(100,'K'), Tmax=(782.992,'K')), NASAPolynomial(coeffs=[8.30918,0.0421298,-1.90223e-05,3.60258e-09,-2.50412e-13,19870.2,-7.79182], Tmin=(782.992,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(174.354,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CsJOCC2) + radical(C2CsJOCs)"""),
)

species(
    label = '[CH2]OC(C)C[C]=C(3149)',
    structure = SMILES('[CH2]OC(C)C[C]=C'),
    E0 = (231.492,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,2950,3100,1380,975,1025,1650,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2850,1437.5,1250,1305,750,350,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.667108,0.0749318,-6.66051e-05,3.298e-08,-6.87838e-12,27960.7,27.8766], Tmin=(100,'K'), Tmax=(1122.4,'K')), NASAPolynomial(coeffs=[11.2458,0.0372315,-1.62218e-05,3.05409e-09,-2.12805e-13,25586,-24.3812], Tmin=(1122.4,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(231.492,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CsJOCC2) + radical(Cds_S)"""),
)

species(
    label = 'C=C[CH][C](C)OC(3150)',
    structure = SMILES('[CH2][CH]C=C(C)OC'),
    E0 = (97.9372,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.631545,0.0628612,-2.69558e-05,-8.98524e-09,7.60913e-12,11910.1,27.0411], Tmin=(100,'K'), Tmax=(1035.44,'K')), NASAPolynomial(coeffs=[15.0431,0.0297201,-1.15866e-05,2.1352e-09,-1.49972e-13,7717.8,-48.8206], Tmin=(1035.44,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(97.9372,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-OsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + radical(Allyl_S) + radical(RCCJ)"""),
)

species(
    label = '[CH2]OC([CH2])CC=C(3151)',
    structure = SMILES('[CH2]OC([CH2])CC=C'),
    E0 = (204.16,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,3100,1380,975,1025,1650,1380,1390,370,380,2900,435,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.302603,0.0835716,-8.67257e-05,5.00084e-08,-1.18775e-11,24686.1,28.4681], Tmin=(100,'K'), Tmax=(1008.71,'K')), NASAPolynomial(coeffs=[12.3918,0.0356332,-1.54404e-05,2.89612e-09,-2.01397e-13,22247.2,-29.9604], Tmin=(1008.71,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(204.16,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CJC(C)OC) + radical(CsJOCC2)"""),
)

species(
    label = '[CH]=CCC(C)O[CH2](3152)',
    structure = SMILES('[CH]=CCC(C)O[CH2]'),
    E0 = (240.746,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.463126,0.0758268,-6.55272e-05,3.03481e-08,-5.78578e-12,29084,28.5339], Tmin=(100,'K'), Tmax=(1237.53,'K')), NASAPolynomial(coeffs=[13.6125,0.0333243,-1.40097e-05,2.59489e-09,-1.7915e-13,25829.5,-37.7064], Tmin=(1237.53,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(240.746,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_P) + radical(CsJOCC2)"""),
)
...
species(
    label = 'C=[C][CH]C(C)OC(3154)',
    structure = SMILES('C=[C][CH]C(C)OC'),
    E0 = (164.824,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,3025,407.5,1350,352.5,1685,370,2950,3100,1380,975,1025,1650,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.842358,0.0713412,-5.52513e-05,2.31641e-08,-4.14825e-12,19935.6,25.0233], Tmin=(100,'K'), Tmax=(1266.42,'K')), NASAPolynomial(coeffs=[10.9175,0.0395189,-1.756e-05,3.32295e-09,-2.31507e-13,17383.7,-25.9635], Tmin=(1266.42,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(164.824,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(C=CCJCO) + radical(Cds_S)"""),
)

species(
    label = '[CH]=C[CH]C(C)OC(3155)',
    structure = SMILES('[CH]C=CC(C)OC'),
    E0 = (166.076,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2995,3025,975,1000,1300,1375,400,500,1630,1680,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.44819,0.0677986,-4.00236e-05,1.14345e-08,-1.3104e-12,20111.2,30.3915], Tmin=(100,'K'), Tmax=(1988.25,'K')), NASAPolynomial(coeffs=[18.8776,0.0307218,-1.20515e-05,2.0553e-09,-1.3107e-13,12782.7,-71.1855], Tmin=(1988.25,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(166.076,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-OsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(AllylJ2_triplet)"""),
)
...
species(
    label = '[CH2]OC(C)C1[CH]C1(3156)',
    structure = SMILES('[CH2]OC(C)C1[CH]C1'),
    E0 = (245.336,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.784167,0.0598594,-2.22948e-05,-1.0673e-08,7.43225e-12,29632.2,28.1275], Tmin=(100,'K'), Tmax=(1057.42,'K')), NASAPolynomial(coeffs=[13.9,0.0316292,-1.25834e-05,2.32904e-09,-1.63256e-13,25662.8,-41.5343], Tmin=(1057.42,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(245.336,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(390.78,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + ring(Cyclopropane) + radical(CsJOCC2) + radical(cyclopropane)"""),
)
...
species(
    label = 'C=CC=C(C)OC(3158)',
    structure = SMILES('C=CC=C(C)OC'),
    E0 = (-137.979,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.456883,0.0637004,-1.80738e-05,-2.73635e-08,1.6554e-11,-16454.7,24.2099], Tmin=(100,'K'), Tmax=(968.154,'K')), NASAPolynomial(coeffs=[18.2163,0.0237857,-8.0731e-06,1.44733e-09,-1.03536e-13,-21461.6,-68.9929], Tmin=(968.154,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-137.979,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(390.78,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)HHH) + group(Cs-OsHHH) + group(Cds-CdsCsOs) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH)"""),
)

species(
    label = 'C=C=CC(C)OC(3159)',
    structure = SMILES('C=C=CC(C)OC'),
    E0 = (-28.0039,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.701599,0.0653744,-4.34769e-05,1.44442e-08,-1.94808e-12,-3243.65,27.3979], Tmin=(100,'K'), Tmax=(1700.35,'K')), NASAPolynomial(coeffs=[15.768,0.0299315,-1.22104e-05,2.18538e-09,-1.45692e-13,-8367.32,-53.2868], Tmin=(1700.35,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-28.0039,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(390.78,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cs-OsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cdd-CdsCds)"""),
)
...
species(
    label = '[CH2]O[CH]C(C)C=C(3161)',
    structure = SMILES('[CH2]O[CH]C(C)C=C'),
    E0 = (180.872,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.142875,0.0743448,-6.1709e-05,2.69469e-08,-4.71212e-12,21901.5,31.1056], Tmin=(100,'K'), Tmax=(1375.98,'K')), NASAPolynomial(coeffs=[16.6641,0.0263176,-9.3531e-06,1.58036e-09,-1.03323e-13,17354.9,-53.8726], Tmin=(1375.98,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(180.872,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CsJOCC) + radical(CCsJOCs)"""),
)
...
species(
    ...
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.44935,0.0442488,2.11382e-05,-5.83472e-08,2.6617e-11,25413.4,26.3866], Tmin=(100,'K'), Tmax=(910.532,'K')), NASAPolynomial(coeffs=[11.3698,0.0317298,-9.40903e-06,1.48462e-09,-9.74903e-14,22319.2,-27.6148], Tmin=(910.532,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(210.444,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(394.937,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Oxetane) + radical(Cs_S) + radical(RCCJ)"""),
)
...
species(
    ...
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.792277,0.0660816,-4.52347e-05,1.5734e-08,-2.25049e-12,22337,28.7607], Tmin=(100,'K'), Tmax=(1591.73,'K')), NASAPolynomial(coeffs=[14.168,0.0324684,-1.35585e-05,2.46704e-09,-1.66743e-13,18078.8,-41.9868], Tmin=(1591.73,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(184.733,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-OsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Cds_S) + radical(Allyl_P)"""),
)
...
species(
    label = '[CH]=CC(C)O[CH2](3168)',
    structure = SMILES('[CH]=CC(C)O[CH2]'),
    E0 = (262.098,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,3120,650,792.5,1650,3000,3100,440,815,1455,1000,3010,987.5,1337.5,450,1655,2750,2800,2850,1350,1500,750,1050,1375,1000,180,421.306],'cm^-1')),
        HinderedRotor(inertia=(0.019047,'amu*angstrom^2'), symmetry=1, barrier=(2.39994,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.11718,'amu*angstrom^2'), symmetry=1, barrier=(14.7607,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.641999,'amu*angstrom^2'), symmetry=1, barrier=(14.7608,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.117135,'amu*angstrom^2'), symmetry=1, barrier=(14.7608,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]OC(C)[CH]C=C(2188)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]OC(C)[CH]C=C(2188)'],
    products = ['[CH2]C1[CH]C(C)OC1(3144)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(19)', '[CH2]OC(C)=CC=C(3145)'],
...
reaction(
    label = 'reaction4',
    reactants = ['H(19)', '[CH2]OC(C)C=C=C(3146)'],
    products = ['[CH2]OC(C)[CH]C=C(2188)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['CH3(34)', '[CH2]OC=CC=C(3147)'],
    products = ['[CH2]OC(C)[CH]C=C(2188)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]OC([CH2])CC=C(3151)'],
    products = ['[CH2]OC(C)[CH]C=C(2188)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]C([CH]C=C)OC(3153)'],
    products = ['[CH2]OC(C)[CH]C=C(2188)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]OC(C)[CH]C=C(2188)'],
    products = ['[CH2]OC(C)C1[CH]C1(3156)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH2]O[CH]C(C)C=C(3161)'],
    products = ['[CH2]OC(C)[CH]C=C(2188)'],
...
reaction(
    label = 'reaction23',
    reactants = ['CH2(T)(33)', 'C=C[CH]C(C)[O](3162)'],
    products = ['[CH2]OC(C)[CH]C=C(2188)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[CH]=C[CH2](321)', '[CH2]O[CH]C(3036)'],
    products = ['[CH2]OC(C)[CH]C=C(2188)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[CH2]OC(C)[CH]C=C(2188)'],
    products = ['[CH2][CH]C1COC1C(3163)'],
    transitionState = 'TS25',
    kinetics = Arrhenius(A=(1.20551e+07,'s^-1'), n=1.225, Ea=(99.8769,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [R5_SS_D;doublebond_intra;radadd_intra_cs2H]
Euclidian distance = 0
family: Intra_R_Add_Exocyclic
Ea raised from 95.2 to 99.9 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction26',
    reactants = ['[CH2]OC(C)[CH]C=C(2188)'],
    products = ['[CH2]OC(C)C=[C]C(3164)'],
...
reaction(
    label = 'reaction32',
    reactants = ['CH2(T)(33)', '[CH]=CC(C)O[CH2](3168)'],
    products = ['[CH2]OC(C)[CH]C=C(2188)'],
