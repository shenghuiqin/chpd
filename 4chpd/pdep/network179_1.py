...
species(
    ...
    E0 = (295.737,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,1685,370,2950,3100,1380,975,1025,1650,2995,3025,975,1000,1300,1375,400,500,1630,1680,180],'cm^-1')),
...
species(
    ...
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,1685,370,2950,3100,1380,975,1025,1650,2995,3025,975,1000,1300,1375,400,500,1630,1680,180],'cm^-1')),
        HinderedRotor(inertia=(1.08492,'amu*angstrom^2'), symmetry=1, barrier=(24.9445,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.08368,'amu*angstrom^2'), symmetry=1, barrier=(24.9159,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (67.1091,'amu'),
...
species(
    ...
    E0 = (304.992,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,3120,650,792.5,1650,2995,3010,3025,975,987.5,1000,1300,1337.5,1375,400,450,500,1630,1655,1680],'cm^-1')),
...
species(
    label = '[CH2]C[C]=CC(1115)',
    structure = SMILES('[CH2]C[C]=CC'),
    E0 = (390.541,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,1685,370,3000,3100,440,815,1455,1000,2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,216.299],'cm^-1')),
        HinderedRotor(inertia=(0.131861,'amu*angstrom^2'), symmetry=1, barrier=(4.69237,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.148218,'amu*angstrom^2'), symmetry=1, barrier=(4.66166,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.131618,'amu*angstrom^2'), symmetry=1, barrier=(4.6747,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (68.117,'amu'),
...
species(
    label = 'C=[C]C[CH]C(1116)',
    structure = SMILES('C=[C]C[CH]C'),
    E0 = (391.986,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,3100,1380,975,1025,1650,2750,2800,2850,1350,1500,750,1050,1375,1000,1685,370,2750,2850,1437.5,1250,1305,750,350,3025,407.5,1350,352.5,245.037,1764.89],'cm^-1')),
        HinderedRotor(inertia=(0.138734,'amu*angstrom^2'), symmetry=1, barrier=(5.86152,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00279696,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.137341,'amu*angstrom^2'), symmetry=1, barrier=(5.86753,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (68.117,'amu'),
...
species(
    label = '[CH2]CC=[C]C(1117)',
    structure = SMILES('[CH2]CC=[C]C'),
    E0 = (390.541,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,1685,370,3000,3100,440,815,1455,1000,2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,219.214],'cm^-1')),
        HinderedRotor(inertia=(0.137466,'amu*angstrom^2'), symmetry=1, barrier=(4.66589,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.13591,'amu*angstrom^2'), symmetry=1, barrier=(4.68539,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.1407,'amu*angstrom^2'), symmetry=1, barrier=(4.67788,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (68.117,'amu'),
...
species(
    label = '[CH]=CC[CH]C(1118)',
    structure = SMILES('[CH]=CC[CH]C'),
    E0 = (401.24,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,3120,650,792.5,1650,2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,3025,407.5,1350,352.5,180],'cm^-1')),
        HinderedRotor(inertia=(0.00456738,'amu*angstrom^2'), symmetry=1, barrier=(5.18686,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.225527,'amu*angstrom^2'), symmetry=1, barrier=(5.18531,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.225727,'amu*angstrom^2'), symmetry=1, barrier=(5.1899,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (68.117,'amu'),
...
species(
    label = 'C[C]=C[CH]C(1119)',
    structure = SMILES('C[C]=C[CH]C'),
    E0 = (326.407,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,1685,370,3010,987.5,1337.5,450,1655,3025,407.5,1350,352.5,310.889],'cm^-1')),
        HinderedRotor(inertia=(0.128699,'amu*angstrom^2'), symmetry=1, barrier=(8.59985,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00478246,'amu*angstrom^2'), symmetry=1, barrier=(8.57408,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.344418,'amu*angstrom^2'), symmetry=1, barrier=(23.5093,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (68.117,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.09539,0.0359648,-7.46024e-06,-8.14968e-09,3.70207e-12,39331.1,18.0957], Tmin=(100,'K'), Tmax=(1187.74,'K')), NASAPolynomial(coeffs=[7.89788,0.0277521,-1.13953e-05,2.08939e-09,-1.43356e-13,37153.6,-14.2602], Tmin=(1187.74,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(326.407,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Allyl_S) + radical(Cds_S)"""),
)

species(
    label = '[CH]=C[CH]CC(1120)',
    structure = SMILES('[CH]C=CCC'),
    E0 = (318.137,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2850,1437.5,1250,1305,750,350,2995,3025,975,1000,1300,1375,400,500,1630,1680,382.563,383.284,383.426,383.805],'cm^-1')),
        HinderedRotor(inertia=(0.50148,'amu*angstrom^2'), symmetry=1, barrier=(51.5171,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.496,'amu*angstrom^2'), symmetry=1, barrier=(51.52,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.494952,'amu*angstrom^2'), symmetry=1, barrier=(51.5273,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (68.117,'amu'),
...
species(
    ...
    E0 = (387.227,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,3100,1380,975,1025,1650,2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,180,180,672.284],'cm^-1')),
        HinderedRotor(inertia=(2.59728,'amu*angstrom^2'), symmetry=1, barrier=(59.7165,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.721741,'amu*angstrom^2'), symmetry=1, barrier=(16.5943,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.60085,'amu*angstrom^2'), symmetry=1, barrier=(59.7987,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (68.117,'amu'),
...
species(
    ...
    E0 = (397.418,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2850,1437.5,1250,1305,750,350,2995,3025,975,1000,1300,1375,400,500,1630,1680,189.835,189.843,1717.65,4000],'cm^-1')),
        HinderedRotor(inertia=(0.00467791,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.675486,'amu*angstrom^2'), symmetry=1, barrier=(17.2791,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.345095,'amu*angstrom^2'), symmetry=1, barrier=(8.82507,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (68.117,'amu'),
...
reaction(
    label = 'reaction1',
    reactants = ['CH2CHCHCH(170)', 'CH3(34)'],
    products = ['C=CC=CC(381)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction16',
    reactants = ['CH2(S)(40)', 'butadiene13(1121)'],
    products = ['C=CC=CC(381)'],
...
reaction(
    label = 'reaction21',
    reactants = ['C=CC=CC(381)'],
    products = ['CC1C=CC1(1126)'],
