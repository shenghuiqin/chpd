...
species(
    label = '[CH2]CC1CC1[CH]CC=C(1723)',
    structure = SMILES('[CH2]CC1CC1[CH]CC=C'),
    E0 = (408.879,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (122.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0375322,0.0714368,3.4131e-07,-4.46541e-08,2.01198e-11,49337.2,38.439], Tmin=(100,'K'), Tmax=(1033.02,'K')), NASAPolynomial(coeffs=[16.5312,0.0457668,-1.82683e-05,3.42042e-09,-2.42574e-13,43860.5,-51.973], Tmin=(1033.02,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(408.879,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(536.283,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Cyclopropane) + radical(Cs_S) + radical(RCCJ)"""),
)

species(
    label = '[CH2]C1CCC1[CH]CC=C(1724)',
    ...
    molecularWeight = (122.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.253056,0.0631412,2.51904e-05,-7.07482e-08,2.96447e-11,48777.4,37.403], Tmin=(100,'K'), Tmax=(999.49,'K')), NASAPolynomial(coeffs=[15.8016,0.0463024,-1.76538e-05,3.26255e-09,-2.3157e-13,43402.2,-48.9425], Tmin=(999.49,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(404.295,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(540.441,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Cyclobutane) + radical(Cs_S) + radical(Isobutyl)"""),
)
...
species(
    label = '[CH2]C1C=CCC([CH2])CC1(1726)',
    structure = SMILES('[CH2]C1C=CCC([CH2])CC1'),
    E0 = (322.6,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (122.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.479108,0.0170865,0.000239334,-3.63649e-07,1.54302e-10,38983.3,34.9309], Tmin=(100,'K'), Tmax=(901.101,'K')), NASAPolynomial(coeffs=[41.7722,-0.00766522,1.66106e-05,-3.6096e-09,2.39791e-13,25104.5,-195.701], Tmin=(901.101,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(322.6,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(548.755,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cycloheptene) + radical(Isobutyl) + radical(Isobutyl)"""),
)
...
species(
    ...
    molecularWeight = (121.2,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.427502,0.0897112,-6.51368e-05,2.53091e-08,-4.07374e-12,37072.6,37.5521], Tmin=(100,'K'), Tmax=(1440.41,'K')), NASAPolynomial(coeffs=[16.249,0.0434006,-1.691e-05,2.9881e-09,-1.99648e-13,32268.4,-48.9879], Tmin=(1440.41,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(306.863,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(511.34,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)CsH) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Isobutyl)"""),
)
...
species(
    label = '[CH2]C[C](C)C=CCC=C(1729)',
    structure = SMILES('[CH2]C[C](C)C=CCC=C'),
    E0 = (311.773,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,2950,3100,1380,975,1025,1650,360,370,350,3000,3100,440,815,1455,1000,2995,3010,3025,975,987.5,1000,1300,1337.5,1375,400,450,500,1630,1655,1680,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (122.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.268294,0.0804201,-2.96758e-05,-1.12321e-08,8.06962e-12,37662.7,37.151], Tmin=(100,'K'), Tmax=(1083.7,'K')), NASAPolynomial(coeffs=[15.4261,0.0475471,-1.88557e-05,3.44668e-09,-2.38493e-13,32789.9,-46.6149], Tmin=(1083.7,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(311.773,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(532.126,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Allyl_T) + radical(RCCJ)"""),
)

species(
    label = '[CH2]C([CH]C)C=CCC=C(1730)',
    structure = SMILES('[CH2]C([CH]C)C=CCC=C'),
    E0 = (374.171,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (122.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.50889,0.0869621,-5.26945e-05,1.4097e-08,-9.00265e-13,45174.7,42.3239], Tmin=(100,'K'), Tmax=(1266.53,'K')), NASAPolynomial(coeffs=[16.4184,0.0454677,-1.7723e-05,3.14856e-09,-2.11604e-13,39927.2,-47.129], Tmin=(1266.53,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(374.171,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(532.126,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cs_S) + radical(Isobutyl)"""),
)

species(
    label = '[CH2][CH]C(C)C=CCC=C(1731)',
    ...
    molecularWeight = (122.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.460837,0.0855634,-4.85846e-05,1.04871e-08,-4.27353e-15,45192.9,42.1635], Tmin=(100,'K'), Tmax=(1300.7,'K')), NASAPolynomial(coeffs=[17.1534,0.0454288,-1.84849e-05,3.35497e-09,-2.27867e-13,39423.6,-52.0096], Tmin=(1300.7,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(374.335,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(532.126,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(RCCJ) + radical(Cs_S)"""),
)

species(
    label = '[CH2]CC(C)[C]=CCC=C(1732)',
    structure = SMILES('[CH2]CC(C)[C]=CCC=C'),
    E0 = (417.634,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (122.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.680895,0.0913413,-6.18443e-05,2.14016e-08,-3.01861e-12,50407.8,40.8703], Tmin=(100,'K'), Tmax=(1637.86,'K')), NASAPolynomial(coeffs=[19.6751,0.0416273,-1.63144e-05,2.86913e-09,-1.89826e-13,43739.8,-67.3786], Tmin=(1637.86,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(417.634,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(532.126,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(RCCJ) + radical(Cds_S)"""),
)

species(
    label = '[CH2][C](C=CCC=C)CC(1733)',
    ...
    molecularWeight = (122.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.528634,0.0847026,-3.3134e-05,-1.20067e-08,9.06392e-12,31276.4,35.9502], Tmin=(100,'K'), Tmax=(1074.06,'K')), NASAPolynomial(coeffs=[17.5108,0.0458416,-1.84141e-05,3.40674e-09,-2.38027e-13,25767.7,-59.973], Tmin=(1074.06,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(258.586,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(532.126,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Allyl_P) + radical(Allyl_S)"""),
)

species(
    label = '[CH2]C([C]=CCC=C)CC(1734)',
    structure = SMILES('[CH2]C([C]=CCC=C)CC'),
    E0 = (417.47,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2995,3025,975,1000,1300,1375,400,500,1630,1680,1685,370,2950,3100,1380,975,1025,1650,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (122.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.708133,0.092535,-6.54121e-05,2.45239e-08,-3.78196e-12,50388.6,40.9531], Tmin=(100,'K'), Tmax=(1508.38,'K')), NASAPolynomial(coeffs=[17.9034,0.0431801,-1.63315e-05,2.83155e-09,-1.86665e-13,44773.9,-56.4869], Tmin=(1508.38,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(417.47,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(532.126,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Isobutyl) + radical(Cds_S)"""),
)

species(
    label = '[CH2]CC(C)C=[C]CC=C(1735)',
    ...
    molecularWeight = (122.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.680895,0.0913413,-6.18443e-05,2.14016e-08,-3.01861e-12,50407.8,40.8703], Tmin=(100,'K'), Tmax=(1637.86,'K')), NASAPolynomial(coeffs=[19.6751,0.0416273,-1.63144e-05,2.86913e-09,-1.89826e-13,43739.8,-67.3786], Tmin=(1637.86,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(417.634,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(532.126,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_S) + radical(RCCJ)"""),
)

species(
    label = '[CH2]C(C=[C]CC=C)CC(1736)',
    structure = SMILES('[CH2]C(C=[C]CC=C)CC'),
    E0 = (417.47,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2995,3025,975,1000,1300,1375,400,500,1630,1680,1685,370,2950,3100,1380,975,1025,1650,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2]CC(C)C=C[CH]C=C(1737)',
    structure = SMILES('[CH2]C=CC=CC(C)C[CH2]'),
    E0 = (266.994,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (122.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.432295,0.0810399,-1.83091e-05,-3.19349e-08,1.7571e-11,32286,38.0165], Tmin=(100,'K'), Tmax=(1000.75,'K')), NASAPolynomial(coeffs=[18.1144,0.0432569,-1.61586e-05,2.92668e-09,-2.04673e-13,26753.8,-60.5683], Tmin=(1000.75,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(266.994,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(532.126,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + radical(C=CC=CCJ) + radical(RCCJ)"""),
)

species(
    label = '[CH2]C(C=C[CH]C=C)CC(1738)',
    structure = SMILES('[CH2]C=CC=CC([CH2])CC'),
    E0 = (266.83,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (122.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.432258,0.081778,-1.96771e-05,-3.24834e-08,1.87003e-11,32265.9,38.0107], Tmin=(100,'K'), Tmax=(972.543,'K')), NASAPolynomial(coeffs=[17.9474,0.0424504,-1.49563e-05,2.6241e-09,-1.8091e-13,26975.7,-58.9668], Tmin=(972.543,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(266.83,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(532.126,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + radical(C=CC=CCJ) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]CC(C)C=CC[C]=C(1739)',
...
species(
    label = '[CH2]C(C=CC[C]=C)CC(1740)',
    structure = SMILES('[CH2]C(C=CC[C]=C)CC'),
    E0 = (417.47,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2995,3025,975,1000,1300,1375,400,500,1630,1680,1685,370,2950,3100,1380,975,1025,1650,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH]=CCC=CC(C)C[CH2](1741)',
    structure = SMILES('[CH]=CCC=CC(C)C[CH2]'),
    E0 = (426.889,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (122.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.687604,0.0900556,-5.3893e-05,1.10218e-08,8.69447e-13,51522.5,40.8112], Tmin=(100,'K'), Tmax=(1166.12,'K')), NASAPolynomial(coeffs=[17.7349,0.04439,-1.76975e-05,3.21796e-09,-2.20718e-13,46034.2,-56.0076], Tmin=(1166.12,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(426.889,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(532.126,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_P) + radical(RCCJ)"""),
)

species(
    label = '[CH]=CCC=CC([CH2])CC(1742)',
    structure = SMILES('[CH]=CCC=CC([CH2])CC'),
    E0 = (426.725,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2995,3010,3025,975,987.5,1000,1300,1337.5,1375,400,450,500,1630,1655,1680,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,3120,650,792.5,1650,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (122.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.675896,0.0907493,-5.55593e-05,1.15366e-08,1.24428e-12,51501.7,40.7574], Tmin=(100,'K'), Tmax=(1098.76,'K')), NASAPolynomial(coeffs=[16.9441,0.0445653,-1.70298e-05,3.03632e-09,-2.06658e-13,46545.5,-50.8419], Tmin=(1098.76,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(426.725,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(532.126,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Isobutyl) + radical(Cds_P)"""),
)

species(
    label = '[CH2]CC1[CH]C(CC=C)C1(1743)',
    structure = SMILES('[CH2]CC1[CH]C(CC=C)C1'),
    E0 = (397.756,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (122.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.238748,0.0640479,2.03598e-05,-6.30672e-08,2.59682e-11,47990.6,36.5594], Tmin=(100,'K'), Tmax=(1026.23,'K')), NASAPolynomial(coeffs=[15.4337,0.0479721,-1.9214e-05,3.61379e-09,-2.57326e-13,42599.7,-48.2116], Tmin=(1026.23,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(397.756,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(540.441,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Cyclobutane) + radical(cyclobutane) + radical(RCCJ)"""),
)
...
species(
    label = 'C=CCC=CC(=C)CC(1746)',
    structure = SMILES('C=CCC=CC(=C)CC'),
    E0 = (80.2856,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (122.207,'amu'),
...
species(
    label = 'C=CCC=CC(C)C=C(1747)',
    structure = SMILES('C=CCC=CC(C)C=C'),
    E0 = (101.781,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (122.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.69264,0.0905622,-5.98545e-05,2.00404e-08,-2.72507e-12,12420.7,36.7484], Tmin=(100,'K'), Tmax=(1697.25,'K')), NASAPolynomial(coeffs=[20.4036,0.0408437,-1.59143e-05,2.78108e-09,-1.82832e-13,5259.61,-76.1888], Tmin=(1697.25,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(101.781,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(536.283,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)CsH) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cds-CdsHH)"""),
)
...
species(
    ...
    opticalIsomers = 1,
    molecularWeight = (122.207,'amu'),
    collisionModel = TransportData(shapeIndex=2, epsilon=(3720.1,'J/mol'), sigma=(6.66301,'angstroms'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with Tc=581.07 K, Pc=28.54 bar (from Joback method)"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
...
species(
    label = '[CH2]C([CH2])C=CCC=C(1748)',
    structure = SMILES('[CH2]C([CH2])C=CCC=C'),
    E0 = (408.491,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.250993,0.0719651,-3.03062e-05,-1.03102e-08,9.2481e-12,49274.4,35.8671], Tmin=(100,'K'), Tmax=(977.968,'K')), NASAPolynomial(coeffs=[14.2521,0.037812,-1.33734e-05,2.3133e-09,-1.56553e-13,45430.6,-37.0193], Tmin=(977.968,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(408.491,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Isobutyl) + radical(Isobutyl)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]CC([CH2])C=CCC=C(1676)'],
    products = ['[CH2]CC1CC1[CH]CC=C(1723)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH2]CC([CH2])C=CCC=C(1676)'],
    products = ['[CH2]C1CCC1[CH]CC=C(1724)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['[CH2]CC([CH2])C=CCC=C(1676)'],
    products = ['[CH2]C1C=CCC([CH2])CC1(1726)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['H(19)', '[CH2]CC(=C)C=CCC=C(1727)'],
    products = ['[CH2]CC([CH2])C=CCC=C(1676)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(19)', '[CH2]C(C=C)C=CCC=C(1728)'],
    products = ['[CH2]CC([CH2])C=CCC=C(1676)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['buten3yl1(651)', '[CH]=CCC=C(281)'],
    products = ['[CH2]CC([CH2])C=CCC=C(1676)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]C[C](C)C=CCC=C(1729)'],
    products = ['[CH2]CC([CH2])C=CCC=C(1676)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]CC([CH2])C=CCC=C(1676)'],
    products = ['[CH2]C([CH]C)C=CCC=C(1730)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2]CC([CH2])C=CCC=C(1676)'],
    products = ['[CH2][CH]C(C)C=CCC=C(1731)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]CC(C)[C]=CCC=C(1732)'],
    products = ['[CH2]CC([CH2])C=CCC=C(1676)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]CC([CH2])C=CCC=C(1676)'],
    products = ['[CH2][C](C=CCC=C)CC(1733)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]C([C]=CCC=C)CC(1734)'],
    products = ['[CH2]CC([CH2])C=CCC=C(1676)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]CC(C)C=[C]CC=C(1735)'],
    products = ['[CH2]CC([CH2])C=CCC=C(1676)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2]C(C=[C]CC=C)CC(1736)'],
    products = ['[CH2]CC([CH2])C=CCC=C(1676)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2]CC([CH2])C=CCC=C(1676)'],
    products = ['[CH2]CC(C)C=C[CH]C=C(1737)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2]CC([CH2])C=CCC=C(1676)'],
    products = ['[CH2]C(C=C[CH]C=C)CC(1738)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH2]CC(C)C=CC[C]=C(1739)'],
    products = ['[CH2]CC([CH2])C=CCC=C(1676)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH2]C(C=CC[C]=C)CC(1740)'],
    products = ['[CH2]CC([CH2])C=CCC=C(1676)'],
    transitionState = 'TS22',
    kinetics = Arrhenius(A=(5.59786e+07,'s^-1'), n=1.58088, Ea=(142.57,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [RnH;Cd_rad_out_Cd;Cs_H_out_2H] for rate rule [R7H;Cd_rad_out_Cd;Cs_H_out_2H]
Euclidian distance = 2.0
Multiplied by reaction path degeneracy 3.0
family: intra_H_migration"""),
)
...
reaction(
    label = 'reaction23',
    reactants = ['[CH]=CCC=CC(C)C[CH2](1741)'],
    products = ['[CH2]CC([CH2])C=CCC=C(1676)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[CH]=CCC=CC([CH2])CC(1742)'],
    products = ['[CH2]CC([CH2])C=CCC=C(1676)'],
    transitionState = 'TS24',
    kinetics = Arrhenius(A=(22.7193,'s^-1'), n=3.21897, Ea=(132.277,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [RnH;Cd_rad_out_singleH;Cs_H_out_2H] for rate rule [R8H;Cd_rad_out_singleH;Cs_H_out_2H]
Euclidian distance = 2.0
Multiplied by reaction path degeneracy 3.0
family: intra_H_migration"""),
)
...
reaction(
    label = 'reaction26',
    reactants = ['[CH2]CC([CH2])C=CCC=C(1676)'],
    products = ['[CH2]CC1[CH]C(CC=C)C1(1743)'],
...
reaction(
    label = 'reaction28',
    reactants = ['[CH2]CC([CH2])C=CCC=C(1676)'],
    products = ['[CH2]CC1C=CC[CH]CC1(431)'],
...
reaction(
    label = 'reaction33',
    reactants = ['[CH2]CC([CH2])C=CCC=C(1676)'],
    products = ['[CH2]C[CH]CC=CCC=C(1713)'],
...
reaction(
    label = 'reaction36',
    reactants = ['CH2(T)(33)', '[CH2]C([CH2])C=CCC=C(1748)'],
    products = ['[CH2]CC([CH2])C=CCC=C(1676)'],
