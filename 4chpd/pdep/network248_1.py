...
species(
    label = '[CH2]OC1[CH]C=CCC=C1(1359)',
...
species(
    label = '[CH2]OC1C=CC2[CH]C2C1(1394)',
    ...
    molecularWeight = (122.164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.6664,0.0561587,1.46747e-05,-5.35193e-08,2.24181e-11,43841.2,27.9719], Tmin=(100,'K'), Tmax=(1032.94,'K')), NASAPolynomial(coeffs=[15.6813,0.0374963,-1.5559e-05,2.99803e-09,-2.16775e-13,38633,-55.1486], Tmin=(1032.94,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(363.395,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(448.981,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-OsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + polycyclic(s2_3_6_ene_1) + radical(CsJOCC2) + radical(cyclopropane)"""),
)

species(
    label = '[CH2]OC1CC=CC2[CH]C21(1395)',
...
species(
    label = '[CH]1[CH]C2COC2CC=C1(1397)',
...
species(
    label = '[CH2]OC=CC1[CH]C1C=C(1400)',
    structure = SMILES('[CH2]OC=CC1[CH]C1C=C'),
    E0 = (414.384,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2995,3010,3025,975,987.5,1000,1300,1337.5,1375,400,450,500,1630,1655,1680,3000,3100,440,815,1455,1000,2750,2950,3150,900,1000,1100,2950,3100,1380,975,1025,1650,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    ...
    molecularWeight = (122.164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.875479,0.0996979,-9.37241e-05,4.58281e-08,-8.94153e-12,36709.3,16.3979], Tmin=(100,'K'), Tmax=(1238.65,'K')), NASAPolynomial(coeffs=[19.804,0.032917,-1.28525e-05,2.30127e-09,-1.56364e-13,31586.4,-87.7944], Tmin=(1238.65,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(303.706,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(448.981,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-OsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + ring(1,3-Cycloheptadiene) + radical(C=CJC=C) + radical(CsJOCC2)"""),
)

species(
    label = 'COC1[CH]C=[C]C=CC1(1405)',
    structure = SMILES('COC1[CH]C=[C]C=CC1'),
    E0 = (237.038,'kJ/mol'),
    modes = [
...
species(
    label = '[CH2]OC1C[CH]C2C=CC21(1406)',
...
species(
    label = '[CH2]OC1CC2[CH]C=CC21(1407)',
...
species(
    label = '[CH2]C=CC=CC=CO[CH2](1409)',
    structure = SMILES('[CH2]C=CC=CC=CO[CH2]'),
    E0 = (229.622,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2995,3001,3007,3013,3019,3025,975,980,985,990,995,1000,1300,1315,1330,1345,1360,1375,400,420,440,460,480,500,1630,1640,1650,1660,1670,1680,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2]OC1[CH]C2C=CC2C1(1418)',
...
species(
    label = '[CH2]OC1=CC=CC[CH]C1(1420)',
...
reaction(
    label = 'reaction4',
    reactants = ['H(19)', '[CH2]OC1C=CC=C=CC1(1381)'],
    products = ['[CH2]OC1[CH]C=CC=CC1(1358)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H(19)', '[CH2]OC1C=C=CC=CC1(1382)'],
    products = ['[CH2]OC1[CH]C=CC=CC1(1358)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(1.149e+09,'cm^3/(mol*s)'), n=1.595, Ea=(16.7946,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Ca_Cds-OneDeH;HJ] for rate rule [Ca_Cds-CdH;HJ]
Euclidian distance = 1.0
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2]OC1C=CC[C]=CC1(1383)'],
    products = ['[CH2]OC1[CH]C=CC=CC1(1358)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]OC1C=[C]CC=CC1(1384)'],
    products = ['[CH2]OC1[CH]C=CC=CC1(1358)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(1.448e+10,'s^-1'), n=0.82, Ea=(156.9,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""From training reaction 154 used for R2H_S;Cd_rad_out_Cd;Cs_H_out_H/Cd
Exact match found for rate rule [R2H_S;Cd_rad_out_Cd;Cs_H_out_H/Cd]
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]OC1[CH]C=CC=CC1(1358)'],
    products = ['CO[C]1C=C[CH]C=CC1(1385)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]OC1C=CCC=[C]C1(1386)'],
    products = ['[CH2]OC1[CH]C=CC=CC1(1358)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]OC1[C]=CCC=CC1(1387)'],
    products = ['[CH2]OC1[CH]C=CC=CC1(1358)'],
...
reaction(
    label = 'reaction13',
    reactants = ['COC1[C]=C[CH]C=CC1(1389)'],
    products = ['[CH2]OC1[CH]C=CC=CC1(1358)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]O[C]1C=CCC=CC1(1390)'],
    products = ['[CH2]OC1[CH]C=CC=CC1(1358)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]OC1[CH]C=CC=CC1(1358)'],
    products = ['[CH2]OC1[CH]C=CCC=C1(1359)'],
...
reaction(
    label = 'reaction16',
    reactants = ['COC1C=C[CH]C=[C]C1(1391)'],
    products = ['[CH2]OC1[CH]C=CC=CC1(1358)'],
...
reaction(
    label = 'reaction17',
    reactants = ['COC1C=[C][CH]C=CC1(1392)'],
    products = ['[CH2]OC1[CH]C=CC=CC1(1358)'],
...
reaction(
    label = 'reaction18',
    reactants = ['COC1C=C[CH][C]=CC1(1393)'],
    products = ['[CH2]OC1[CH]C=CC=CC1(1358)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2]OC1[CH]C=CC=CC1(1358)'],
    products = ['[CH2]OC1C=CC2[CH]C2C1(1394)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH2]OC1[CH]C=CC=CC1(1358)'],
    products = ['[CH2]OC1CC=CC2[CH]C21(1395)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH2]OC1[CH]C=CC=CC1(1358)'],
    products = ['[CH]1[CH]C2COC2CC=C1(1397)'],
...
reaction(
    label = 'reaction27',
    reactants = ['[CH2]OC=CC1[CH]C1C=C(1400)'],
    products = ['[CH2]OC1[CH]C=CC=CC1(1358)'],
...
reaction(
    label = 'reaction28',
    reactants = ['CH2(T)(33)', '[O]C1[CH]C=CC=CC1(952)'],
    products = ['[CH2]OC1[CH]C=CC=CC1(1358)'],
...
reaction(
    label = 'reaction29',
    reactants = ['H(19)', '[CH2]OC1=CC=CC=CC1(1401)'],
    products = ['[CH2]OC1[CH]C=CC=CC1(1358)'],
...
reaction(
    label = 'reaction30',
    reactants = ['[CH2]O[C]1CC=CC=CC1(1402)'],
    products = ['[CH2]OC1[CH]C=CC=CC1(1358)'],
...
reaction(
    label = 'reaction31',
    reactants = ['[CH2]OC1C[C]=CC=CC1(1403)'],
    products = ['[CH2]OC1[CH]C=CC=CC1(1358)'],
...
reaction(
    label = 'reaction32',
    reactants = ['[CH2]OC1CC=[C]C=CC1(1404)'],
    products = ['[CH2]OC1[CH]C=CC=CC1(1358)'],
...
reaction(
    label = 'reaction33',
    reactants = ['COC1[CH]C=[C]C=CC1(1405)'],
    products = ['[CH2]OC1[CH]C=CC=CC1(1358)'],
...
reaction(
    label = 'reaction34',
    reactants = ['[CH2]OC1[CH]C=CC=CC1(1358)'],
    products = ['[CH2]OC1C[CH]C2C=CC21(1406)'],
...
reaction(
    label = 'reaction35',
    reactants = ['[CH2]OC1[CH]C=CC=CC1(1358)'],
    products = ['[CH2]OC1CC2[CH]C=CC21(1407)'],
...
reaction(
    label = 'reaction37',
    reactants = ['[CH2]C=CC=CC=CO[CH2](1409)'],
    products = ['[CH2]OC1[CH]C=CC=CC1(1358)'],
...
reaction(
    label = 'reaction40',
    reactants = ['[CH2]O[CH]C1C=CC=CC1(1411)'],
    products = ['[CH2]OC1[CH]C=CC=CC1(1358)'],
...
reaction(
    label = 'reaction48',
    reactants = ['[CH2]OC1[CH]C=CC=CC1(1358)'],
    products = ['[CH2]OC1[CH]C2C=CC2C1(1418)'],
...
reaction(
    label = 'reaction50',
    reactants = ['[CH2]OC1=CC=CC[CH]C1(1420)'],
    products = ['[CH2]OC1[CH]C=CC=CC1(1358)'],
...
reaction(
    label = 'reaction51',
    reactants = ['[CH2]OC1C=CC=CC1[CH2](1421)'],
    products = ['[CH2]OC1[CH]C=CC=CC1(1358)'],
