...
species(
    label = '[CH2]C=CC1OOC1C=C(348)',
    structure = SMILES('C=C[CH]C1OOC1C=C'),
    E0 = (212.247,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,3150,900,1100,2950,3000,3050,3100,1330,1430,900,1050,1000,1050,1600,1700,2995,3025,975,1000,1300,1375,400,500,1630,1680,3025,407.5,1350,352.5,300,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
...
reaction(
    label = 'reaction15',
    reactants = ['H(19)', 'C1=CC2OOC2=CCC1(333)'],
    products = ['[CH]1CCC=CC2OOC12(197)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(19)', 'C1=CC2OOC2C=CC1(334)'],
    products = ['[CH]1CCC=CC2OOC12(197)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH]1CCC=CC2OOC12(197)'],
    products = ['C1=CC2OO[C]2CCC1(335)'],
...
reaction(
    label = 'reaction23',
    reactants = ['H(19)', '[CH]1CCC=CC2OO[C]12(340)'],
    products = ['[CH]1CCC=CC2OOC12(197)'],
...
reaction(
    label = 'reaction24',
    reactants = ['H(19)', '[CH]1CCC=C[C]2OOC12(341)'],
    products = ['[CH]1CCC=CC2OOC12(197)'],
...
reaction(
    label = 'reaction25',
    reactants = ['H(19)', '[CH]1[CH]C2OOC2C=CC1(342)'],
    products = ['[CH]1CCC=CC2OOC12(197)'],
...
reaction(
    label = 'reaction26',
    reactants = ['H(19)', '[CH]1C=CC2OOC2[CH]C1(343)'],
    products = ['[CH]1CCC=CC2OOC12(197)'],
...
reaction(
    label = 'reaction27',
    reactants = ['H(19)', '[C]1=CCC[CH]C2OOC12(344)'],
    products = ['[CH]1CCC=CC2OOC12(197)'],
...
reaction(
    label = 'reaction28',
    reactants = ['H(19)', '[C]1=CC2OOC2[CH]CC1(345)'],
    products = ['[CH]1CCC=CC2OOC12(197)'],
...
reaction(
    label = 'reaction29',
    reactants = ['[CH]1CCC=CC2OOC12(197)'],
    products = ['[CH]1C2CCC2C2OOC12(346)'],
...
reaction(
    label = 'reaction30',
    reactants = ['[CH]1CCC=CC2OOC12(197)'],
    products = ['[CH]1CCC2C1C1OOC21(347)'],
...
reaction(
    label = 'reaction31',
    reactants = ['[CH2]C=CC1OOC1C=C(348)'],
    products = ['[CH]1CCC=CC2OOC12(197)'],
...
reaction(
    label = 'reaction33',
    reactants = ['[CH]1OOC2C=CCCC12(350)'],
    products = ['[CH]1CCC=CC2OOC12(197)'],
...
reaction(
    label = 'reaction34',
    reactants = ['[CH2]C1CC=CC2OOC12(351)'],
    products = ['[CH]1CCC=CC2OOC12(197)'],
...
reaction(
    label = 'reaction35',
    reactants = ['H(19)', '[C]1CCC=CC2OOC12(352)'],
    products = ['[CH]1CCC=CC2OOC12(197)'],
