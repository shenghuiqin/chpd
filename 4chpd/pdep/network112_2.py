...
species(
    label = 'C=CC=C[CH]CC(164)',
    structure = SMILES('[CH2]C=CC=CCC'),
    E0 = (117.28,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,2750,2850,1437.5,1250,1305,750,350,2995,3005,3015,3025,975,983.333,991.667,1000,1300,1325,1350,1375,400,433.333,466.667,500,1630,1646.67,1663.33,1680,309.341,655.026],'cm^-1')),
        HinderedRotor(inertia=(0.714483,'amu*angstrom^2'), symmetry=1, barrier=(16.4274,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0543606,'amu*angstrom^2'), symmetry=1, barrier=(16.4685,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(4.12085,'amu*angstrom^2'), symmetry=1, barrier=(94.7463,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.716534,'amu*angstrom^2'), symmetry=1, barrier=(16.4745,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (95.1622,'amu'),
...
species(
    label = 'C=CC=[C]CCC(165)',
    structure = SMILES('C=CC=[C]CCC'),
    E0 = (249.312,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,3100,1380,975,1025,1650,2750,2800,2850,1350,1500,750,1050,1375,1000,1685,370,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2995,3025,975,1000,1300,1375,400,500,1630,1680,300.474,300.474,300.474],'cm^-1')),
...
species(
    label = '[CH]=CC=CCCC(168)',
    structure = SMILES('[CH]=CC=CCCC'),
    E0 = (258.566,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,3120,650,792.5,1650,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2995,3010,3025,975,987.5,1000,1300,1337.5,1375,400,450,500,1630,1655,1680,214.626,214.635],'cm^-1')),
        HinderedRotor(inertia=(0.435079,'amu*angstrom^2'), symmetry=1, barrier=(14.2236,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.435149,'amu*angstrom^2'), symmetry=1, barrier=(14.2236,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.435141,'amu*angstrom^2'), symmetry=1, barrier=(14.2235,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.435078,'amu*angstrom^2'), symmetry=1, barrier=(14.2235,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (95.1622,'amu'),
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]C=CC=C(162)', 'C2H4(45)'],
    products = ['C7H11(5)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction3',
    reactants = ['C2H4(T)(169)', '[CH2]C=CC=C(162)'],
    products = ['C7H11(5)'],
...
reaction(
    label = 'reaction4',
    reactants = ['CH2CHCHCH(170)', '[CH2]C[CH2](171)'],
    products = ['C7H11(5)'],
...
reaction(
    label = 'reaction25',
    reactants = ['H(19)', '[CH2]C=CC=CC[CH2](98)'],
    products = ['C7H11(5)'],
...
reaction(
    label = 'reaction26',
    reactants = ['H(19)', '[CH2][CH]CC=CC=C(172)'],
    products = ['C7H11(5)'],
...
reaction(
    label = 'reaction27',
    reactants = ['H(19)', '[CH2]CC[C]=CC=C(173)'],
    products = ['C7H11(5)'],
...
reaction(
    label = 'reaction28',
    reactants = ['[CH]=CCC[CH2](174)', 'C2H3(44)'],
    products = ['C7H11(5)'],
...
reaction(
    label = 'reaction29',
    reactants = ['H(19)', '[CH2]CCC=[C]C=C(175)'],
    products = ['C7H11(5)'],
...
reaction(
    label = 'reaction30',
    reactants = ['H(19)', '[CH2]CCC=C[C]=C(176)'],
    products = ['C7H11(5)'],
...
reaction(
    label = 'reaction31',
    reactants = ['H(19)', '[CH]=CC=CCC[CH2](97)'],
    products = ['C7H11(5)'],
...
reaction(
    label = 'reaction35',
    reactants = ['[CH2]CC=CC=C(180)', 'CH2(T)(33)'],
    products = ['C7H11(5)'],
...
reaction(
    label = 'reaction36',
    reactants = ['H(19)', '[CH]CCC=CC=C(181)'],
    products = ['C7H11(5)'],
