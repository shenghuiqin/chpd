...
species(
    label = '[CH]1CC=CC2O[C]2C1(1028)',
    structure = SMILES('[CH]1CC=CC2O[C]2C1'),
    E0 = (338.709,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2807.14,2864.29,2921.43,2978.57,3035.71,3092.86,3150,900,928.571,957.143,985.714,1014.29,1042.86,1071.43,1100,300,800,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
    ],
    ...
    molecularWeight = (108.138,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.42758,0.0160315,8.80826e-05,-1.09876e-07,3.7959e-11,40809.9,23.464], Tmin=(100,'K'), Tmax=(1038.76,'K')), NASAPolynomial(coeffs=[8.75273,0.0406056,-1.80608e-05,3.59324e-09,-2.63718e-13,36856,-19.9985], Tmin=(1038.76,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(338.709,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + Estimated bicyclic component: polycyclic(s2_3_7_ane) - ring(Cycloheptane) - ring(Ethylene_oxide) + ring(Cycloheptene) + ring(Ethylene_oxide) + radical(RCCJCC) + radical(C2CsJO)"""),
)

species(
    label = '[CH]1C=CC2OC2[CH]C1(1029)',
...
species(
    label = '[CH]1CC=C[C]2OC2C1(1030)',
    structure = SMILES('[CH]1C=C2OC2C[CH]C1'),
    E0 = (255.567,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2807.14,2864.29,2921.43,2978.57,3035.71,3092.86,3150,900,928.571,957.143,985.714,1014.29,1042.86,1071.43,1100,300,800,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
    ],
    ...
    molecularWeight = (108.138,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.38795,0.00326115,0.000153277,-1.96759e-07,7.32618e-11,30824.6,20.069], Tmin=(100,'K'), Tmax=(972.92,'K')), NASAPolynomial(coeffs=[16.6285,0.0269749,-1.01101e-05,2.10166e-09,-1.67991e-13,24160.3,-68.2507], Tmin=(972.92,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(255.567,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + Estimated bicyclic component: polycyclic(s2_3_7_ane) - ring(Cycloheptane) - ring(Ethylene_oxide) + ring(Cycloheptene) + ring(Ethylene_oxide) + radical(RCCJCC) + radical(Allyl_S)"""),
)

species(
    label = '[C]1=CC2OC2[CH]CC1(1031)',
    structure = SMILES('[C]1=CC2OC2[CH]CC1'),
    E0 = (401.89,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2807.14,2864.29,2921.43,2978.57,3035.71,3092.86,3150,900,928.571,957.143,985.714,1014.29,1042.86,1071.43,1100,300,800,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
    ],
    ...
    molecularWeight = (108.138,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.30144,0.0093866,0.000128126,-1.65522e-07,6.08464e-11,48422.3,23.2034], Tmin=(100,'K'), Tmax=(988.295,'K')), NASAPolynomial(coeffs=[14.7489,0.0305294,-1.25179e-05,2.57677e-09,-1.99494e-13,42469,-54.373], Tmin=(988.295,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(401.89,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + Estimated bicyclic component: polycyclic(s2_3_7_ane) - ring(Cycloheptane) - ring(Ethylene_oxide) + ring(Cycloheptene) + ring(Ethylene_oxide) + radical(Cds_S) + radical(CCJCO)"""),
)

species(
    label = '[CH]1CCC=C[C]2OC12(1032)',
    structure = SMILES('[CH]1C=C2OC2[CH]CC1'),
    E0 = (261.011,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2807.14,2864.29,2921.43,2978.57,3035.71,3092.86,3150,900,928.571,957.143,985.714,1014.29,1042.86,1071.43,1100,300,800,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
    ],
    ...
    molecularWeight = (108.138,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.29942,-0.00205594,0.000184399,-2.40262e-07,9.13742e-11,31489.4,20.318], Tmin=(100,'K'), Tmax=(959.16,'K')), NASAPolynomial(coeffs=[21.4814,0.0186778,-5.55277e-06,1.25343e-09,-1.13241e-13,23176.2,-95.5781], Tmin=(959.16,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(261.011,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + Estimated bicyclic component: polycyclic(s2_3_7_ane) - ring(Cycloheptane) - ring(Ethylene_oxide) + ring(Cycloheptene) + ring(Ethylene_oxide) + radical(Allyl_S) + radical(CCJCO)"""),
)

species(
    label = '[C]1=CC2OC2C[CH]C1(1033)',
    structure = SMILES('[C]1=CC2OC2C[CH]C1'),
    E0 = (396.446,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2807.14,2864.29,2921.43,2978.57,3035.71,3092.86,3150,900,928.571,957.143,985.714,1014.29,1042.86,1071.43,1100,300,800,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
    ],
    ...
    molecularWeight = (108.138,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.38698,0.014698,9.72429e-05,-1.22698e-07,4.32082e-11,47757.6,22.9676], Tmin=(100,'K'), Tmax=(1022.57,'K')), NASAPolynomial(coeffs=[10.1335,0.0384392,-1.68588e-05,3.37501e-09,-2.5017e-13,43347.8,-28.3937], Tmin=(1022.57,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(396.446,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + Estimated bicyclic component: polycyclic(s2_3_7_ane) - ring(Cycloheptane) - ring(Ethylene_oxide) + ring(Cycloheptene) + ring(Ethylene_oxide) + radical(RCCJCC) + radical(Cds_S)"""),
)

species(
    label = '[C]1=CC[CH]CC2OC12(1034)',
    structure = SMILES('[C]1=CC[CH]CC2OC12'),
    E0 = (396.446,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2807.14,2864.29,2921.43,2978.57,3035.71,3092.86,3150,900,928.571,957.143,985.714,1014.29,1042.86,1071.43,1100,300,800,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
    ],
    ...
    molecularWeight = (108.138,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.38698,0.014698,9.72429e-05,-1.22698e-07,4.32082e-11,47757.6,22.9676], Tmin=(100,'K'), Tmax=(1022.57,'K')), NASAPolynomial(coeffs=[10.1335,0.0384392,-1.68588e-05,3.37501e-09,-2.5017e-13,43347.8,-28.3937], Tmin=(1022.57,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(396.446,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + Estimated bicyclic component: polycyclic(s2_3_7_ane) - ring(Cycloheptane) - ring(Ethylene_oxide) + ring(Cycloheptene) + ring(Ethylene_oxide) + radical(Cds_S) + radical(RCCJCC)"""),
)

species(
    label = '[C]1=CCC[CH]C2OC12(1035)',
    structure = SMILES('[C]1=CCC[CH]C2OC12'),
    E0 = (401.89,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2807.14,2864.29,2921.43,2978.57,3035.71,3092.86,3150,900,928.571,957.143,985.714,1014.29,1042.86,1071.43,1100,300,800,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
    ],
...
species(
    label = '[CH]1[CH]CC2OC2C=C1(1036)',
    structure = SMILES('[CH]1C=C[CH]C2OC2C1'),
    E0 = (222.512,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2807.14,2864.29,2921.43,2978.57,3035.71,3092.86,3150,900,928.571,957.143,985.714,1014.29,1042.86,1071.43,1100,300,800,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
    ],
    ...
    molecularWeight = (108.138,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.08521,0.0117655,0.000133798,-1.75931e-07,6.52534e-11,26858,16.1932], Tmin=(100,'K'), Tmax=(985.761,'K')), NASAPolynomial(coeffs=[16.4975,0.0306032,-1.25218e-05,2.59412e-09,-2.02323e-13,20259.9,-72.186], Tmin=(985.761,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(222.512,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + Estimated bicyclic component: polycyclic(s2_3_7_ane) - ring(Cycloheptane) - ring(Ethylene_oxide) + ring(Cycloheptene) + ring(Ethylene_oxide) + radical(C=CCJCO) + radical(Allyl_S)"""),
)

species(
    label = '[CH]1CCC=CC2O[C]12(1037)',
    structure = SMILES('[CH]1CCC=CC2O[C]12'),
    E0 = (344.153,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2807.14,2864.29,2921.43,2978.57,3035.71,3092.86,3150,900,928.571,957.143,985.714,1014.29,1042.86,1071.43,1100,300,800,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
    ],
    ...
    molecularWeight = (108.138,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.34185,0.0107382,0.000118821,-1.52381e-07,5.53977e-11,41474.5,23.6995], Tmin=(100,'K'), Tmax=(996.452,'K')), NASAPolynomial(coeffs=[13.2742,0.0328468,-1.38036e-05,2.81416e-09,-2.14594e-13,36019.5,-45.4437], Tmin=(996.452,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(344.153,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + Estimated bicyclic component: polycyclic(s2_3_7_ane) - ring(Cycloheptane) - ring(Ethylene_oxide) + ring(Cycloheptene) + ring(Ethylene_oxide) + radical(CCJCO) + radical(C2CsJO)"""),
)

species(
    label = '[CH]1C=CCC=C[CH]O1(1038)',
...
species(
    label = '[CH]=CC1OC1C=C[CH2](1039)',
    structure = SMILES('[CH]=CC1OC1[CH]C=C'),
    E0 = (408.047,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,3150,900,1100,3120,650,792.5,1650,2950,3100,1380,975,1025,1650,2995,3025,975,1000,1300,1375,400,500,1630,1680,3025,407.5,1350,352.5,180,1025.98,1025.98,1025.98,1025.98,1025.98,1025.98,1025.98,1025.98,1025.98,2287.77],'cm^-1')),
        HinderedRotor(inertia=(0.0687522,'amu*angstrom^2'), symmetry=1, barrier=(1.58075,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0687522,'amu*angstrom^2'), symmetry=1, barrier=(1.58075,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0687522,'amu*angstrom^2'), symmetry=1, barrier=(1.58075,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    ...
    molecularWeight = (108.138,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.402836,0.063029,-4.81315e-06,-5.21743e-08,2.94146e-11,49221.3,27.0715], Tmin=(100,'K'), Tmax=(901.997,'K')), NASAPolynomial(coeffs=[20.3262,0.0183651,-3.19113e-06,3.24805e-10,-1.92896e-14,43849.9,-76.8441], Tmin=(901.997,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(408.047,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(369.994,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + ring(Ethylene_oxide) + radical(Cds_P) + radical(C=CCJCO)"""),
)

species(
    label = '[CH]=CCC=CC1[CH]O1(1040)',
    structure = SMILES('[CH]=CCC=CC1[CH]O1'),
    E0 = (477.654,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,3150,900,1100,3120,650,792.5,1650,2750,2850,1437.5,1250,1305,750,350,2995,3010,3025,975,987.5,1000,1300,1337.5,1375,400,450,500,1630,1655,1680,200,800,914.286,1028.57,1142.86,1257.14,1371.43,1485.71,1600],'cm^-1')),
    ...
    molecularWeight = (108.138,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.552368,0.0609884,-6.24303e-06,-4.88942e-08,2.82272e-11,57586.7,30.8336], Tmin=(100,'K'), Tmax=(893.098,'K')), NASAPolynomial(coeffs=[19.4748,0.0175403,-2.63796e-06,1.95447e-10,-8.88955e-15,52559.6,-67.5385], Tmin=(893.098,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(477.654,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(369.994,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Ethylene_oxide) + radical(CCsJO) + radical(Cds_P)"""),
)

species(
    label = '[C]1CCC=CC2OC12(1041)',
    structure = SMILES('[C]1CCC=CC2OC12'),
    E0 = (396.994,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2807.14,2864.29,2921.43,2978.57,3035.71,3092.86,3150,900,928.571,957.143,985.714,1014.29,1042.86,1071.43,1100,300,800,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
    ],
    ...
    molecularWeight = (108.138,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.03698,0.0183789,0.000104714,-1.38988e-07,5.062e-11,47839.9,30.6336], Tmin=(100,'K'), Tmax=(1005.84,'K')), NASAPolynomial(coeffs=[13.5888,0.0356764,-1.53848e-05,3.11685e-09,-2.34954e-13,42317.2,-41.0658], Tmin=(1005.84,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(396.994,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsCsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(CsJ2_singlet-CsH) + Estimated bicyclic component: polycyclic(s2_3_7_ane) - ring(Cycloheptane) - ring(Ethylene_oxide) + ring(Cycloheptane) + ring(Ethylene_oxide)"""),
)

species(
    label = '[C]1CC=CC2OC2C1(1042)',
    structure = SMILES('[C]1CC=CC2OC2C1'),
    E0 = (395.859,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2807.14,2864.29,2921.43,2978.57,3035.71,3092.86,3150,900,928.571,957.143,985.714,1014.29,1042.86,1071.43,1100,300,800,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
    ],
    ...
    molecularWeight = (108.138,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.97729,0.0220168,9.07735e-05,-1.22091e-07,4.40638e-11,47703.3,30.1812], Tmin=(100,'K'), Tmax=(1019.13,'K')), NASAPolynomial(coeffs=[12.6178,0.0375988,-1.65642e-05,3.33658e-09,-2.48761e-13,42556.5,-35.9653], Tmin=(1019.13,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(395.859,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(CsJ2_singlet-CsH) + Estimated bicyclic component: polycyclic(s2_3_7_ane) - ring(Cycloheptane) - ring(Ethylene_oxide) + ring(Cycloheptane) + ring(Ethylene_oxide)"""),
)

species(
    label = '[CH]1C[CH]C2C1C1OC21(1043)',
    structure = SMILES('[CH]1C[CH]C2C1C1OC21'),
    E0 = (421.903,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2807.14,2864.29,2921.43,2978.57,3035.71,3092.86,3150,900,928.571,957.143,985.714,1014.29,1042.86,1071.43,1100,300,800,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
    ],
    ...
    molecularWeight = (108.138,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.13995,0.0287685,4.26943e-05,-5.97666e-08,1.99525e-11,50820.2,18.8694], Tmin=(100,'K'), Tmax=(1113.46,'K')), NASAPolynomial(coeffs=[7.74816,0.0415685,-1.89341e-05,3.70726e-09,-2.65765e-13,47529,-17.9609], Tmin=(1113.46,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(421.903,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + polycyclic(s2_4_5_ane) + polycyclic(s2_3_4_ane) - ring(Cyclobutane) + radical(bicyclo[3.2.0]heptane-C5-2) + radical(bicyclo[3.2.0]heptane-C5-2)"""),
)

species(
    label = '[CH]1C2CC2[CH]C2OC12(1044)',
    structure = SMILES('[CH]1C2CC2[CH]C2OC12'),
    E0 = (462.101,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2807.14,2864.29,2921.43,2978.57,3035.71,3092.86,3150,900,928.571,957.143,985.714,1014.29,1042.86,1071.43,1100,300,800,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
    ],
    ...
    molecularWeight = (108.138,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.07402,0.0242748,6.60971e-05,-9.74187e-08,3.72516e-11,55663.4,23.3781], Tmin=(100,'K'), Tmax=(979.836,'K')), NASAPolynomial(coeffs=[11.9192,0.0293177,-1.08699e-05,2.06332e-09,-1.5177e-13,51562.7,-34.9989], Tmin=(979.836,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(462.101,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + polycyclic(s2_3_6_ane) + polycyclic(s2_3_6_ane) - ring(Cyclohexane) + radical(CCJCO) + radical(CCJCO)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['H(19)', 'C1=C[C]2OC2C=CC1(1024)'],
    products = ['C7H8O(2)(14)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['H(19)', '[CH]1C=CC2OC2C=C1(1025)'],
    products = ['C7H8O(2)(14)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(19)', '[C]1=CCC=CC2OC12(1026)'],
    products = ['C7H8O(2)(14)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(19)', '[C]1=CC2OC2C=CC1(1027)'],
    products = ['C7H8O(2)(14)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(1e+13,'cm^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""From training reaction 40 used for Cd_rad/NonDe;H_rad
Exact match found for rate rule [Cd_rad/NonDe;H_rad]
...
reaction(
    label = 'reaction5',
    reactants = ['[CH]1CC=CC2O[C]2C1(1028)'],
    products = ['C7H8O(2)(14)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH]1C=CC2OC2[CH]C1(1029)'],
    products = ['C7H8O(2)(14)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH]1CC=C[C]2OC2C1(1030)'],
    products = ['C7H8O(2)(14)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[C]1=CC2OC2[CH]CC1(1031)'],
    products = ['C7H8O(2)(14)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH]1CCC=C[C]2OC12(1032)'],
    products = ['C7H8O(2)(14)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[C]1=CC2OC2C[CH]C1(1033)'],
    products = ['C7H8O(2)(14)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[C]1=CC[CH]CC2OC12(1034)'],
    products = ['C7H8O(2)(14)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[C]1=CCC[CH]C2OC12(1035)'],
    products = ['C7H8O(2)(14)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH]1[CH]CC2OC2C=C1(1036)'],
    products = ['C7H8O(2)(14)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH]1CCC=CC2O[C]12(1037)'],
    products = ['C7H8O(2)(14)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH]1C=CCC=C[CH]O1(1038)'],
    products = ['C7H8O(2)(14)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[O]C1[CH]C=CCC=C1(920)'],
    products = ['C7H8O(2)(14)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH]=CC1OC1C=C[CH2](1039)'],
    products = ['C7H8O(2)(14)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH]=CCC=CC1[CH]O1(1040)'],
    products = ['C7H8O(2)(14)'],
    transitionState = 'TS18',
    kinetics = Arrhenius(A=(1.61967e+11,'s^-1'), n=0.0247333, Ea=(7.86034,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Rn;Y_rad_out;Cpri_rad_out_single] for rate rule [R7;CdsingleH_rad_out;Cpri_rad_out_H/NonDeO]
Euclidian distance = 3.0
family: Birad_recombination"""),
)
...
reaction(
    label = 'reaction21',
    reactants = ['[CH]1C[CH]C2C1C1OC21(1043)'],
    products = ['C7H8O(2)(14)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH]1C2CC2[CH]C2OC12(1044)'],
    products = ['C7H8O(2)(14)'],
