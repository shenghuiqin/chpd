...
species(
    label = '[C]1=CC2[CH]CC(C1)OO2(695)',
...
species(
    ...
    molecularWeight = (125.145,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.50696,0.0356292,2.62843e-05,-3.59164e-08,9.52672e-12,27392.9,16.9191], Tmin=(100,'K'), Tmax=(1472.83,'K')), NASAPolynomial(coeffs=[10.0635,0.0519096,-2.77779e-05,5.52018e-09,-3.86527e-13,21175.3,-36.0137], Tmin=(1472.83,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(227.336,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + polycyclic(s3_6_6_ane) + polycyclic(s2_3_6_ane) + polycyclic(s2_3_6_ane) - ring(Cyclopropane) - ring(12dioxane) - ring(Cyclohexane) + radical(bicyclo[4.1.0]heptane-C6-2)"""),
)

species(
    label = 'C=CC1C=CC[CH]OO1(699)',
    structure = SMILES('C=CC1C=CC[CH]OO1'),
    E0 = (200.294,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2830,2910,2990,3070,3150,900,940,980,1020,1060,1100,2950,3100,1380,975,1025,1650,3010,987.5,1337.5,450,1655,300,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
species(
    label = '[CH]=CCC1CC=COO1(700)',
    structure = SMILES('[CH]=CCC1CC=COO1'),
    E0 = (253.114,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3010,987.5,1337.5,450,1655,3120,650,792.5,1650,2750,2850,2950,3050,3150,900,950,1000,1050,1100,2750,2850,1437.5,1250,1305,750,350,300,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
...
reaction(
    label = 'reaction34',
    reactants = ['H(19)', 'C1=CC2C=CC(C1)OO2(684)'],
    products = ['[CH]1CC2CC=CC1OO2(225)'],
...
reaction(
    label = 'reaction35',
    reactants = ['H(19)', 'C1=CC2=CCC(C1)OO2(685)'],
    products = ['[CH]1CC2CC=CC1OO2(225)'],
...
reaction(
    label = 'reaction36',
    reactants = ['[CH]1CC2C=CCC1OO2(686)'],
    products = ['[CH]1CC2CC=CC1OO2(225)'],
...
reaction(
    label = 'reaction37',
    reactants = ['[CH]1CC2CC=CC1OO2(225)'],
    products = ['C1=C[C]2CCC(C1)OO2(687)'],
...
reaction(
    label = 'reaction38',
    reactants = ['[CH]1CC2CC=CC1OO2(225)'],
    products = ['C1=CC2CC[C](C1)OO2(688)'],
...
reaction(
    label = 'reaction41',
    reactants = ['[C]1=CC2CCC(C1)OO2(690)'],
    products = ['[CH]1CC2CC=CC1OO2(225)'],
...
reaction(
    label = 'reaction42',
    reactants = ['H(19)', '[CH]1C[C]2CC=CC1OO2(691)'],
    products = ['[CH]1CC2CC=CC1OO2(225)'],
...
reaction(
    label = 'reaction43',
    reactants = ['H(19)', '[CH]1[CH]C2CC=CC1OO2(692)'],
    products = ['[CH]1CC2CC=CC1OO2(225)'],
...
reaction(
    label = 'reaction44',
    reactants = ['H(19)', '[CH]1CC2[CH]C=CC1OO2(693)'],
    products = ['[CH]1CC2CC=CC1OO2(225)'],
...
reaction(
    label = 'reaction45',
    reactants = ['H(19)', '[CH]1CC2CC=C[C]1OO2(694)'],
    products = ['[CH]1CC2CC=CC1OO2(225)'],
...
reaction(
    label = 'reaction46',
    reactants = ['H(19)', '[C]1=CC2[CH]CC(C1)OO2(695)'],
    products = ['[CH]1CC2CC=CC1OO2(225)'],
...
reaction(
    label = 'reaction47',
    reactants = ['H(19)', '[C]1=CCC2C[CH]C1OO2(696)'],
    products = ['[CH]1CC2CC=CC1OO2(225)'],
...
reaction(
    label = 'reaction48',
    reactants = ['[CH]1CC2CC=CC1OO2(225)'],
    products = ['[CH]1C2CC3CC2C1OO3(697)'],
...
reaction(
    label = 'reaction49',
    reactants = ['[CH]1CC2CC=CC1OO2(225)'],
    products = ['[CH]1CC2CC3C1C3OO2(698)'],
...
reaction(
    label = 'reaction50',
    reactants = ['C=CC1C=CC[CH]OO1(699)'],
    products = ['[CH]1CC2CC=CC1OO2(225)'],
...
reaction(
    label = 'reaction52',
    reactants = ['[CH2]C1C2C=CCC1OO2(701)'],
    products = ['[CH]1CC2CC=CC1OO2(225)'],
...
reaction(
    label = 'reaction54',
    reactants = ['H(19)', '[C]1CC2CC=CC1OO2(703)'],
    products = ['[CH]1CC2CC=CC1OO2(225)'],
