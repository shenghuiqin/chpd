...
species(
    label = 'C=CC([CH]C)C=C(1208)',
    structure = SMILES('C=CC([CH]C)C=C'),
    E0 = (225.942,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,3025,407.5,1350,352.5,2950,3000,3050,3100,1330,1430,900,1050,1000,1050,1600,1700,2995,3025,975,1000,1300,1375,400,500,1630,1680,2750,2800,2850,1350,1500,750,1050,1375,1000,219.909,219.91,219.911],'cm^-1')),
        HinderedRotor(inertia=(0.230817,'amu*angstrom^2'), symmetry=1, barrier=(7.92106,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00207712,'amu*angstrom^2'), symmetry=1, barrier=(23.5837,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00348591,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.687221,'amu*angstrom^2'), symmetry=1, barrier=(23.5837,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (95.1622,'amu'),
...
species(
    label = '[CH2]CC=CC(1129)',
    structure = SMILES('[CH2]CC=CC'),
    E0 = (152.699,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,2750,2850,1437.5,1250,1305,750,350,2995,3025,975,1000,1300,1375,400,500,1630,1680,180],'cm^-1')),
        HinderedRotor(inertia=(1.12586,'amu*angstrom^2'), symmetry=1, barrier=(25.8857,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.760575,'amu*angstrom^2'), symmetry=1, barrier=(17.4871,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.000585299,'amu*angstrom^2'), symmetry=1, barrier=(6.64552,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
species(
    label = 'C=[C]C([CH]C)CC(1215)',
    structure = SMILES('C=[C]C([CH]C)CC'),
    E0 = (336.549,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,1685,370,2950,3100,1380,975,1025,1650,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH]=CC(C[CH2])CC(1216)',
    structure = SMILES('[CH]=CC(C[CH2])CC'),
    E0 = (356.508,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3010,987.5,1337.5,450,1655,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,3120,650,792.5,1650,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.131233,'amu*angstrom^2'), symmetry=1, barrier=(3.01731,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0430535,'amu*angstrom^2'), symmetry=1, barrier=(14.6345,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00887721,'amu*angstrom^2'), symmetry=1, barrier=(3.01891,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.131185,'amu*angstrom^2'), symmetry=1, barrier=(3.01621,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.636522,'amu*angstrom^2'), symmetry=1, barrier=(14.6349,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (96.1702,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.36931,0.0697359,-3.85325e-05,5.67452e-09,1.48743e-12,43017.1,31.7952], Tmin=(100,'K'), Tmax=(1157.17,'K')), NASAPolynomial(coeffs=[14.0338,0.0368961,-1.46221e-05,2.64887e-09,-1.81273e-13,38891,-40.2867], Tmin=(1157.17,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(356.508,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_P) + radical(RCCJ)"""),
)

species(
    label = '[CH]=CC([CH]C)CC(1217)',
    structure = SMILES('[CH]=CC([CH]C)CC'),
    E0 = (345.804,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3120,650,792.5,1650,180,756.565],'cm^-1')),
        HinderedRotor(inertia=(0.00658438,'amu*angstrom^2'), symmetry=1, barrier=(2.67443,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.116312,'amu*angstrom^2'), symmetry=1, barrier=(2.67423,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.116308,'amu*angstrom^2'), symmetry=1, barrier=(2.67416,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.481924,'amu*angstrom^2'), symmetry=1, barrier=(11.0804,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.481924,'amu*angstrom^2'), symmetry=1, barrier=(11.0804,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
species(
    ...
    molecularWeight = (96.1702,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.39035,0.0403025,4.53674e-05,-7.86306e-08,3.03225e-11,38299.5,28.1544], Tmin=(100,'K'), Tmax=(1004.84,'K')), NASAPolynomial(coeffs=[12.0381,0.0394896,-1.54784e-05,2.91151e-09,-2.08723e-13,34060.8,-33.7096], Tmin=(1004.84,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(317.534,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(444.824,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Cyclobutane) + radical(RCCJ) + radical(cyclobutane)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]CC([CH]C)C=C(1131)'],
    products = ['[CH2]CC1C([CH2])C1C(1206)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['H(19)', '[CH2]CC(C=C)=CC(1207)'],
    products = ['[CH2]CC([CH]C)C=C(1131)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H(19)', 'C=CC([CH]C)C=C(1208)'],
    products = ['[CH2]CC([CH]C)C=C(1131)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['H(19)', '[CH2]CC(C=C)C=C(414)'],
    products = ['[CH2]CC([CH]C)C=C(1131)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['C2H3(44)', '[CH2]CC=CC(1129)'],
    products = ['[CH2]CC([CH]C)C=C(1131)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]CC(C=C)C[CH2](1211)'],
    products = ['[CH2]CC([CH]C)C=C(1131)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2][CH]C(C=C)CC(1212)'],
    products = ['[CH2]CC([CH]C)C=C(1131)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[CH2]C[CH]C(C)C=C(1168)'],
    products = ['[CH2]CC([CH]C)C=C(1131)'],
...
reaction(
    label = 'reaction27',
    reactants = ['[CH2]C[CH]C=C(376)', 'CHCH3(T)(359)'],
    products = ['[CH2]CC([CH]C)C=C(1131)'],
...
reaction(
    label = 'reaction28',
    reactants = ['CH2(T)(33)', '[CH2]C([CH]C)C=C(1221)'],
    products = ['[CH2]CC([CH]C)C=C(1131)'],
