...
species(
    label = 'C=CC1C=C[CH]CC=C1(583)',
    structure = SMILES('C=CC1[CH]C=CCC=C1'),
    E0 = (303.163,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3010,987.5,1337.5,450,1655,2750,2807.14,2864.29,2921.43,2978.57,3035.71,3092.86,3150,900,928.571,957.143,985.714,1014.29,1042.86,1071.43,1100,2950,3100,1380,975,1025,1650,300,800,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
species(
    label = '[CH2]CC1C=C=CCC=C1(584)',
    structure = SMILES('[CH2]CC1C=C=CCC=C1'),
    E0 = (463.525,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2816.67,2883.33,2950,3016.67,3083.33,3150,900,933.333,966.667,1000,1033.33,1066.67,1100,2750,2850,1437.5,1250,1305,750,350,300,800,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
...
species(
    label = '[CH2]CC1C=CCC2[CH]C21(595)',
...
species(
    label = '[CH2]CC1C=CC2C[CH]C12(596)',
...
species(
    label = '[CH2]CC1[CH]C2CC2C=C1(598)',
    ...
    molecularWeight = (120.192,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.934193,0.0470681,5.09982e-05,-8.98025e-08,3.45247e-11,54276.4,29.2272], Tmin=(100,'K'), Tmax=(1015.17,'K')), NASAPolynomial(coeffs=[14.1836,0.0442943,-1.79425e-05,3.43605e-09,-2.48551e-13,49039.2,-47.4383], Tmin=(1015.17,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(450.214,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(498.868,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + polycyclic(s2_3_6_ene_1) + radical(RCCJ) + radical(Cs_S)"""),
)

species(
    label = '[CH]1[CH]C2CCC2C=CC1(599)',
...
species(
    label = '[CH2]CC1C=CC([CH2])C=C1(603)',
...
species(
    label = '[CH2]CC1C=CCC=CC=1(605)',
    structure = SMILES('[CH2]CC1C=CCC=CC=1'),
    E0 = (310.514,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2850,1437.5,1250,1305,750,350,2750,2816.67,2883.33,2950,3016.67,3083.33,3150,900,933.333,966.667,1000,1033.33,1066.67,1100,300,800,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
...
species(
    label = '[CH2]CC1[CH]C2CC=CC12(613)',
...
species(
    label = '[CH2]CC1C2[CH]CC=CC21(615)',
    ...
    molecularWeight = (120.192,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.935619,0.0473265,4.96049e-05,-8.77812e-08,3.36505e-11,54147.4,29.1879], Tmin=(100,'K'), Tmax=(1018.81,'K')), NASAPolynomial(coeffs=[13.9942,0.044727,-1.82247e-05,3.49262e-09,-2.524e-13,48960.6,-46.4518], Tmin=(1018.81,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(449.144,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(498.868,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + polycyclic(s2_3_6_ene_1) + radical(RCCJ) + radical(Cs_S)"""),
)

species(
    label = '[CH]=CCC=CC=CC[CH2](616)',
...
species(
    ...
    molecularWeight = (120.192,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.282325,0.0690551,-1.71113e-05,-1.66273e-08,8.35196e-12,49753.7,33.7339], Tmin=(100,'K'), Tmax=(1138.31,'K')), NASAPolynomial(coeffs=[13.7596,0.0462268,-1.93547e-05,3.61836e-09,-2.52375e-13,45096.2,-40.0129], Tmin=(1138.31,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(412.476,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(494.711,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(1,4-Cyclohexadiene) + radical(RCCJ) + radical(Cs_S)"""),
)

species(
    label = 'C1=CC2CCC2C=CC1(402)',
...
reaction(
    label = 'reaction3',
    reactants = ['H(19)', 'C=CC1C=C[CH]CC=C1(583)'],
    products = ['[CH2]CC1[CH]C=CCC=C1(399)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['H(19)', '[CH2]CC1C=C=CCC=C1(584)'],
    products = ['[CH2]CC1[CH]C=CCC=C1(399)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2]CC1[CH]C=CCC=C1(399)'],
    products = ['C[CH]C1C=C[CH]CC=C1(585)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]CC1C=[C]CCC=C1(586)'],
    products = ['[CH2]CC1[CH]C=CCC=C1(399)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]CC1[CH]C=CCC=C1(399)'],
    products = ['CC[C]1C=C[CH]CC=C1(587)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]CC1[C]=CCCC=C1(588)'],
    products = ['[CH2]CC1[CH]C=CCC=C1(399)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CCC1[C]=CC[CH]C=C1(589)'],
    products = ['[CH2]CC1[CH]C=CCC=C1(399)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CCC1[C]=C[CH]CC=C1(590)'],
    products = ['[CH2]CC1[CH]C=CCC=C1(399)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2]C[C]1C=CCCC=C1(591)'],
    products = ['[CH2]CC1[CH]C=CCC=C1(399)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CCC1C=[C]C[CH]C=C1(592)'],
    products = ['[CH2]CC1[CH]C=CCC=C1(399)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CCC1C=[C][CH]CC=C1(593)'],
    products = ['[CH2]CC1[CH]C=CCC=C1(399)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2][CH]C1C=CCCC=C1(594)'],
    products = ['[CH2]CC1[CH]C=CCC=C1(399)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2]CC1[CH]C=CCC=C1(399)'],
    products = ['[CH2]CC1C=CCC2[CH]C21(595)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2]CC1[CH]C=CCC=C1(399)'],
    products = ['[CH2]CC1C=CC2C[CH]C12(596)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH2]CC1[CH]C=CCC=C1(399)'],
    products = ['[CH2]CC1[CH]C2CC2C=C1(598)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH2]CC1[CH]C=CCC=C1(399)'],
    products = ['[CH]1[CH]C2CCC2C=CC1(599)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[CH]=CC(C=CC=C)C[CH2](600)'],
    products = ['[CH2]CC1[CH]C=CCC=C1(399)'],
...
reaction(
    label = 'reaction29',
    reactants = ['[CH2]CC1C=CC([CH2])C=C1(603)'],
    products = ['[CH2]CC1[CH]C=CCC=C1(399)'],
...
reaction(
    label = 'reaction31',
    reactants = ['[CH2]C1C=C[CH]CC=C1(604)', 'CH2(T)(33)'],
    products = ['[CH2]CC1[CH]C=CCC=C1(399)'],
...
reaction(
    label = 'reaction32',
    reactants = ['H(19)', '[CH2]CC1C=CCC=CC=1(605)'],
    products = ['[CH2]CC1[CH]C=CCC=C1(399)'],
...
reaction(
    label = 'reaction34',
    reactants = ['[CH2]CC1[CH]C=CCC=C1(399)'],
    products = ['[CH2]C[C]1C=CCC=CC1(606)'],
...
reaction(
    label = 'reaction38',
    reactants = ['[CH2]CC1[CH]C=CCC=C1(399)'],
    products = ['[CH2]CC1C=CC[C]=CC1(610)'],
...
reaction(
    label = 'reaction41',
    reactants = ['CCC1[CH]C=[C]CC=C1(612)'],
    products = ['[CH2]CC1[CH]C=CCC=C1(399)'],
...
reaction(
    label = 'reaction42',
    reactants = ['[CH2]CC1[CH]C=CCC=C1(399)'],
    products = ['[CH2]CC1[CH]C2CC=CC12(613)'],
...
reaction(
    label = 'reaction44',
    reactants = ['[CH2]CC1[CH]C=CCC=C1(399)'],
    products = ['[CH2]CC1C2[CH]CC=CC21(615)'],
...
reaction(
    label = 'reaction45',
    reactants = ['[CH]=CCC=CC=CC[CH2](616)'],
    products = ['[CH2]CC1[CH]C=CCC=C1(399)'],
...
reaction(
    label = 'reaction48',
    reactants = ['[CH2]C[CH]C1C=CCC=C1(619)'],
    products = ['[CH2]CC1[CH]C=CCC=C1(399)'],
