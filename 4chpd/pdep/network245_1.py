...
species(
    label = '[CH]1C=CCC2[CH]C1OC2(1453)',
...
species(
    label = 'O[CH]C1C=C[CH]C=CC1(1473)',
...
species(
    label = 'OCC1[C]=C[CH]C=CC1(1480)',
    structure = SMILES('OCC1[C]=C[CH]C=CC1'),
    E0 = (238.335,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3615,1277.5,1000,2750,2816.67,2883.33,2950,3016.67,3083.33,3150,900,933.333,966.667,1000,1033.33,1066.67,1100,300,800,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
...
species(
    label = '[CH]1[CH]C2COC(C=C1)C2(1396)',
...
species(
    label = 'C=CC1[CH]C1C=CC[O](1492)',
    structure = SMILES('C=CC1[CH]C1C=CC[O]'),
    E0 = (449.029,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,3100,1380,975,1025,1650,2995,3010,3025,975,987.5,1000,1300,1337.5,1375,400,450,500,1630,1655,1680,2750,2950,3150,900,1000,1100,2750,2850,1437.5,1250,1305,750,350,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
...
species(
    ...
    molecularWeight = (122.164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.16976,0.0888827,-7.36935e-05,3.21863e-08,-5.78401e-12,34574.7,16.2321], Tmin=(100,'K'), Tmax=(1304.12,'K')), NASAPolynomial(coeffs=[15.9289,0.0395047,-1.68987e-05,3.15263e-09,-2.18219e-13,30375.8,-65.709], Tmin=(1304.12,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(286.204,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + ring(1,3-Cycloheptadiene) + radical(CCOJ) + radical(CCsJOH)"""),
)

species(
    label = '[O]CC1CC=[C]C=CC1(1497)',
...
species(
    ...
    molecularWeight = (122.164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.33753,0.0410727,4.77344e-05,-7.84055e-08,2.88773e-11,34409.4,24.056], Tmin=(100,'K'), Tmax=(1042.49,'K')), NASAPolynomial(coeffs=[11.6369,0.0444478,-1.88392e-05,3.63577e-09,-2.61837e-13,29931.2,-37.2401], Tmin=(1042.49,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(285.174,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + polycyclic(s2_4_5_ene_1) + radical(cyclopentene-allyl) + radical(CCOJ)"""),
)

species(
    label = '[CH]1[CH]C2C=CCC1CO2(1454)',
...
species(
    label = '[CH2]C=CC=CC=CC[O](1501)',
    structure = SMILES('[CH2]C=CC=CC=CC[O]'),
    E0 = (264.267,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2995,3001,3007,3013,3019,3025,975,980,985,990,995,1000,1300,1315,1330,1345,1360,1375,400,420,440,460,480,500,1630,1640,1650,1660,1670,1680,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,180,180,423.744,428.813],'cm^-1')),
        HinderedRotor(inertia=(0.153464,'amu*angstrom^2'), symmetry=1, barrier=(10.4661,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.214411,'amu*angstrom^2'), symmetry=1, barrier=(27.706,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0821031,'amu*angstrom^2'), symmetry=1, barrier=(10.4654,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.635785,'amu*angstrom^2'), symmetry=1, barrier=(80.8417,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (122.164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0278404,0.0778963,-4.92774e-05,1.15324e-08,4.44602e-13,31938,34.8784], Tmin=(100,'K'), Tmax=(1124.56,'K')), NASAPolynomial(coeffs=[15.6749,0.0368895,-1.43841e-05,2.58707e-09,-1.76733e-13,27467.4,-46.8959], Tmin=(1124.56,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(264.267,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(440.667,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + radical(C=CC=CCJ) + radical(CCOJ)"""),
)

species(
    label = 'OCC1=CC=CC=CC1(1502)',
...
species(
    ...
    molecularWeight = (122.164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.731526,0.0781233,-6.01691e-05,2.74746e-08,-5.74889e-12,36293.1,16.5634], Tmin=(100,'K'), Tmax=(1053.67,'K')), NASAPolynomial(coeffs=[7.41665,0.0527441,-2.40383e-05,4.6136e-09,-3.24599e-13,34884.4,-16.0377], Tmin=(1053.67,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(300.823,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + ring(1,3-Cycloheptadiene) + radical(CCOJ) + radical(RCCJCC)"""),
)

species(
    label = '[CH2]C1C=CC=CC1C[O](1516)',
    ...
    molecularWeight = (122.164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.726638,0.0573805,7.33581e-06,-4.51577e-08,1.9985e-11,35710.6,29.6715], Tmin=(100,'K'), Tmax=(1004.6,'K')), NASAPolynomial(coeffs=[13.8516,0.0386408,-1.47324e-05,2.70029e-09,-1.90016e-13,31382.1,-42.1276], Tmin=(1004.6,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(295.828,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(448.981,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + ring(1,3-Cyclohexadiene) + radical(CCOJ) + radical(Isobutyl)"""),
)

species(
    label = 'C1C=CC2CC(C=1)CO2(1422)',
...
reaction(
    label = 'reaction1',
    reactants = ['[O]CC1[CH]C=CC=CC1(1355)'],
...
reaction(
    label = 'reaction3',
    reactants = ['[O]CC1[CH]C=CC=CC1(1355)'],
    products = ['[CH]1C=CCC2[CH]C1OC2(1453)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(19)', 'O=CC1C=C[CH]C=CC1(1470)'],
...
reaction(
    label = 'reaction5',
    reactants = ['H(19)', '[O]CC1C=CC=C=CC1(1471)'],
    products = ['[O]CC1[CH]C=CC=CC1(1355)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['H(19)', '[O]CC1C=C=CC=CC1(1472)'],
    products = ['[O]CC1[CH]C=CC=CC1(1355)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(1.149e+09,'cm^3/(mol*s)'), n=1.595, Ea=(16.7946,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Ca_Cds-OneDeH;HJ] for rate rule [Ca_Cds-CdH;HJ]
Euclidian distance = 1.0
...
reaction(
    label = 'reaction8',
    reactants = ['[O]CC1[CH]C=CC=CC1(1355)'],
    products = ['O[CH]C1C=C[CH]C=CC1(1473)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[O]CC1C=CC[C]=CC1(1474)'],
    products = ['[O]CC1[CH]C=CC=CC1(1355)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['[O]CC1[CH]C=CC=CC1(1355)'],
    products = ['OC[C]1C=C[CH]C=CC1(1476)'],
...
reaction(
    label = 'reaction15',
    reactants = ['OCC1[C]=C[CH]C=CC1(1480)'],
    products = ['[O]CC1[CH]C=CC=CC1(1355)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[O]C[C]1C=CCC=CC1(1481)'],
    products = ['[O]CC1[CH]C=CC=CC1(1355)'],
...
reaction(
    label = 'reaction18',
    reactants = ['OCC1C=C[CH]C=[C]C1(1482)'],
    products = ['[O]CC1[CH]C=CC=CC1(1355)'],
...
reaction(
    label = 'reaction19',
    reactants = ['OCC1C=[C][CH]C=CC1(1483)'],
    products = ['[O]CC1[CH]C=CC=CC1(1355)'],
...
reaction(
    label = 'reaction21',
    reactants = ['OCC1C=C[CH][C]=CC1(1485)'],
    products = ['[O]CC1[CH]C=CC=CC1(1355)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[O]CC1[CH]C=CC=CC1(1355)'],
    products = ['[O]CC1C=CC2[CH]C2C1(1486)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[O]CC1[CH]C=CC=CC1(1355)'],
    products = ['[O]CC1CC=CC2[CH]C21(1487)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[O]CC1[CH]C=CC=CC1(1355)'],
    products = ['[CH]1[CH]C2COC(C=C1)C2(1396)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[O]CC1[CH]C=CC=CC1(1355)'],
    products = ['[CH]1[CH]C2OCC2CC=C1(1488)'],
...
reaction(
    label = 'reaction30',
    reactants = ['[O]CC1[CH]C=CC=CC1(1355)'],
    products = ['C1=CC2C=CC(C1)CO2(1361)'],
...
reaction(
    label = 'reaction31',
    reactants = ['C=CC1[CH]C1C=CC[O](1492)'],
    products = ['[O]CC1[CH]C=CC=CC1(1355)'],
...
reaction(
    label = 'reaction32',
    reactants = ['[CH2]C1C=C[CH]C=CC1(636)', 'O(20)'],
    products = ['[O]CC1[CH]C=CC=CC1(1355)'],
...
reaction(
    label = 'reaction33',
    reactants = ['H(19)', '[O]CC1=CC=CC=CC1(1493)'],
    products = ['[O]CC1[CH]C=CC=CC1(1355)'],
...
reaction(
    label = 'reaction35',
    reactants = ['[O]C[C]1CC=CC=CC1(1494)'],
    products = ['[O]CC1[CH]C=CC=CC1(1355)'],
...
reaction(
    label = 'reaction36',
    reactants = ['[O]CC1C[C]=CC=CC1(1495)'],
    products = ['[O]CC1[CH]C=CC=CC1(1355)'],
...
reaction(
    label = 'reaction37',
    reactants = ['[O][CH]C1CC=CC=CC1(1496)'],
    products = ['[O]CC1[CH]C=CC=CC1(1355)'],
...
reaction(
    label = 'reaction38',
    reactants = ['[O]CC1CC=[C]C=CC1(1497)'],
    products = ['[O]CC1[CH]C=CC=CC1(1355)'],
...
reaction(
    label = 'reaction39',
    reactants = ['OCC1[CH]C=[C]C=CC1(1498)'],
    products = ['[O]CC1[CH]C=CC=CC1(1355)'],
...
reaction(
    label = 'reaction40',
    reactants = ['[O]CC1[CH]C=CC=CC1(1355)'],
    products = ['[O]CC1C[CH]C2C=CC21(1499)'],
...
reaction(
    label = 'reaction41',
    reactants = ['[O]CC1[CH]C=CC=CC1(1355)'],
    products = ['[O]CC1CC2[CH]C=CC21(1500)'],
...
reaction(
    label = 'reaction42',
    reactants = ['[O]CC1[CH]C=CC=CC1(1355)'],
    products = ['[CH]1[CH]C2C=CCC1CO2(1454)'],
...
reaction(
    label = 'reaction43',
    reactants = ['[CH2]C=CC=CC=CC[O](1501)'],
    products = ['[O]CC1[CH]C=CC=CC1(1355)'],
...
reaction(
    label = 'reaction46',
    reactants = ['[O]CC1[CH]CC=CC=C1(1354)'],
    products = ['[O]CC1[CH]C=CC=CC1(1355)'],
...
reaction(
    label = 'reaction47',
    reactants = ['[O]C[CH]C1C=CC=CC1(1504)'],
    products = ['[O]CC1[CH]C=CC=CC1(1355)'],
...
reaction(
    label = 'reaction50',
    reactants = ['[O]CC1C=CC=[C]CC1(1506)'],
    products = ['[O]CC1[CH]C=CC=CC1(1355)'],
...
reaction(
    label = 'reaction51',
    reactants = ['[O]CC1[CH]C=CC=CC1(1355)'],
    products = ['[O]C[C]1C=CC=CCC1(1507)'],
...
reaction(
    label = 'reaction52',
    reactants = ['[O]CC1C=C[C]=CCC1(1508)'],
    products = ['[O]CC1[CH]C=CC=CC1(1355)'],
...
reaction(
    label = 'reaction53',
    reactants = ['[O][CH]C1C=CC=CCC1(1509)'],
    products = ['[O]CC1[CH]C=CC=CC1(1355)'],
...
reaction(
    label = 'reaction54',
    reactants = ['[O]CC1[C]=CC=CCC1(1510)'],
    products = ['[O]CC1[CH]C=CC=CC1(1355)'],
...
reaction(
    label = 'reaction55',
    reactants = ['[O]CC1C=[C]C=CCC1(1511)'],
    products = ['[O]CC1[CH]C=CC=CC1(1355)'],
...
reaction(
    label = 'reaction56',
    reactants = ['[O]CC1[CH]C=CC=CC1(1355)'],
    products = ['[O]CC1[CH]C2C=CC2C1(1512)'],
...
reaction(
    label = 'reaction59',
    reactants = ['[O]CC1=CC=CC[CH]C1(1515)'],
    products = ['[O]CC1[CH]C=CC=CC1(1355)'],
...
reaction(
    label = 'reaction60',
    reactants = ['[CH2]C1C=CC=CC1C[O](1516)'],
    products = ['[O]CC1[CH]C=CC=CC1(1355)'],
...
reaction(
    label = 'reaction61',
    reactants = ['[O]CC1[CH]C=CC=CC1(1355)'],
    products = ['C1C=CC2CC(C=1)CO2(1422)'],
