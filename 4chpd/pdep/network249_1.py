...
species(
    ...
    molecularWeight = (122.164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.15722,-0.00301589,0.00027374,-3.9396e-07,1.62924e-10,29783.3,32.4181], Tmin=(100,'K'), Tmax=(913.175,'K')), NASAPolynomial(coeffs=[43.3768,-0.0178301,1.86302e-05,-3.70692e-09,2.33265e-13,14979.4,-206.27], Tmin=(913.175,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(246.273,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(448.981,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-OsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(1,4-Cycloheptadiene) + radical(C=CCJC(O)C=C) + radical(Cds_S)"""),
)

species(
    label = 'COC1[CH][C]=CCC=C1(1449)',
...
species(
    label = '[CH2]OC1C=CCC2[CH]C21(1451)',
    ...
    molecularWeight = (122.164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.623832,0.0585281,5.56927e-06,-4.22353e-08,1.79794e-11,43924.4,27.7911], Tmin=(100,'K'), Tmax=(1055.99,'K')), NASAPolynomial(coeffs=[15.0857,0.038882,-1.64309e-05,3.16073e-09,-2.26945e-13,38911.1,-52.0422], Tmin=(1055.99,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(364.086,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(448.981,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-OsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + polycyclic(s2_3_6_ene_2) + radical(CsJOCC2) + radical(cyclopropane)"""),
)

species(
    label = '[CH2]OC1[CH]C2CC=CC21(1452)',
...
species(
    label = '[CH2]OC1C2[CH]CC=CC21(1455)',
...
species(
    label = '[CH2]O[CH]C1C=CCC=C1(1460)',
...
species(
    label = '[CH2]OC1C=CC2C[CH]C21(1465)',
...
species(
    label = '[CH2]OC1[CH]C2CC2C=C1(1466)',
...
species(
    ...
    molecularWeight = (122.164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.854801,0.0959475,-8.70481e-05,3.9902e-08,-7.23409e-12,49990.4,37.1268], Tmin=(100,'K'), Tmax=(1334.27,'K')), NASAPolynomial(coeffs=[21.6305,0.0285378,-1.12641e-05,2.03595e-09,-1.39069e-13,43990.2,-77.8358], Tmin=(1334.27,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(414.115,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)(Cds-Cds)OsH) + group(Cs-OsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cds_P) + radical(CsJOCC2)"""),
)
...
species(
    label = '[CH2]OC1C=CC([CH2])C=C1(1469)',
    ...
    molecularWeight = (122.164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.10472,0.0787776,-4.79103e-05,8.26212e-09,1.85016e-12,35256.2,31.2047], Tmin=(100,'K'), Tmax=(1104.41,'K')), NASAPolynomial(coeffs=[16.566,0.0362291,-1.43382e-05,2.61502e-09,-1.80626e-13,30486.6,-55.8005], Tmin=(1104.41,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(291.828,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(444.824,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)(Cds-Cds)CsH) + group(Cs-(Cds-Cds)(Cds-Cds)OsH) + group(Cs-CsHHH) + group(Cs-OsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(1,4-Cyclohexadiene) + radical(Isobutyl) + radical(CsJOCC2)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]OC1[CH]C=CCC=C1(1359)'],
...
reaction(
    label = 'reaction3',
    reactants = ['H(19)', '[CH2]OC1C=CCC=CC=1(1444)'],
...
reaction(
    label = 'reaction4',
    reactants = ['H(19)', '[CH2]OC1C=C=CCC=C1(1445)'],
    products = ['[CH2]OC1[CH]C=CCC=C1(1359)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]OC1[CH]C=CCC=C1(1359)'],
    products = ['CO[C]1[CH]C=CCC=C1(1446)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction11',
    reactants = ['COC1[C]=CCC=C[CH]1(1447)'],
    products = ['[CH2]OC1[CH]C=CCC=C1(1359)'],
...
reaction(
    label = 'reaction14',
    reactants = ['COC1[CH]C=CC[C]=C1(1448)'],
    products = ['[CH2]OC1[CH]C=CCC=C1(1359)'],
...
reaction(
    label = 'reaction15',
    reactants = ['COC1[CH][C]=CCC=C1(1449)'],
    products = ['[CH2]OC1[CH]C=CCC=C1(1359)'],
...
reaction(
    label = 'reaction17',
    reactants = ['COC1[CH]C=[C]CC=C1(1450)'],
    products = ['[CH2]OC1[CH]C=CCC=C1(1359)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2]OC1[CH]C=CCC=C1(1359)'],
    products = ['[CH2]OC1C=CCC2[CH]C21(1451)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2]OC1[CH]C=CCC=C1(1359)'],
    products = ['[CH2]OC1[CH]C2CC=CC21(1452)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH2]OC1[CH]C=CCC=C1(1359)'],
    products = ['[CH2]OC1C2[CH]CC=CC21(1455)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[CH]=CCC=CC=CO[CH2](1457)'],
    products = ['[CH2]OC1[CH]C=CCC=C1(1359)'],
...
reaction(
    label = 'reaction28',
    reactants = ['[CH2]O[CH]C1C=CCC=C1(1460)'],
    products = ['[CH2]OC1[CH]C=CCC=C1(1359)'],
...
reaction(
    label = 'reaction30',
    reactants = ['CH2(T)(33)', '[O]C1[CH]C=CCC=C1(920)'],
    products = ['[CH2]OC1[CH]C=CCC=C1(1359)'],
...
reaction(
    label = 'reaction32',
    reactants = ['[CH2]OC1C=[C]CCC=C1(1461)'],
    products = ['[CH2]OC1[CH]C=CCC=C1(1359)'],
...
reaction(
    label = 'reaction33',
    reactants = ['[CH2]OC1[C]=CCCC=C1(1462)'],
    products = ['[CH2]OC1[CH]C=CCC=C1(1359)'],
...
reaction(
    label = 'reaction34',
    reactants = ['COC1[C]=C[CH]CC=C1(1463)'],
    products = ['[CH2]OC1[CH]C=CCC=C1(1359)'],
...
reaction(
    label = 'reaction35',
    reactants = ['[CH2]O[C]1C=CCCC=C1(1464)'],
    products = ['[CH2]OC1[CH]C=CCC=C1(1359)'],
...
reaction(
    label = 'reaction36',
    reactants = ['[CH2]OC1[CH]C=CCC=C1(1359)'],
    products = ['[CH2]OC1C=CC2C[CH]C21(1465)'],
...
reaction(
    label = 'reaction37',
    reactants = ['[CH2]OC1[CH]C=CCC=C1(1359)'],
    products = ['[CH2]OC1[CH]C2CC2C=C1(1466)'],
...
reaction(
    label = 'reaction39',
    reactants = ['[CH]=CC(C=CC=C)O[CH2](1468)'],
    products = ['[CH2]OC1[CH]C=CCC=C1(1359)'],
...
reaction(
    label = 'reaction41',
    reactants = ['[CH2]OC1C=CC([CH2])C=C1(1469)'],
    products = ['[CH2]OC1[CH]C=CCC=C1(1359)'],
