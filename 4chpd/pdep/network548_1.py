species(
    label = 'C[CH]OC1[CH]CCCCC1OO(2294)',
    structure = SMILES('C[CH]OC1[CH]CCCCC1OO'),
    E0 = (-45.3591,'kJ/mol'),
    modes = [
...
species(
    label = 'C[CH]OC1=CCCCCC1OO(2911)',
    structure = SMILES('C[CH]OC1=CCCCCC1OO'),
    E0 = (-163.788,'kJ/mol'),
    modes = [
...
species(
    label = 'C[CH]OC1C=CCCCC1OO(2912)',
    structure = SMILES('C[CH]OC1C=CCCCC1OO'),
    E0 = (-133.109,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2794.44,2838.89,2883.33,2927.78,2972.22,3016.67,3061.11,3105.56,3150,900,922.222,944.444,966.667,988.889,1011.11,1033.33,1055.56,1077.78,1100,3025,407.5,1350,352.5,3615,1310,387.5,850,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,300,800,800,800,800,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (171.214,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.06625,0.0772003,0.000125616,-2.60443e-07,1.17842e-10,-15738.6,45.5356], Tmin=(100,'K'), Tmax=(917.933,'K')), NASAPolynomial(coeffs=[48.7191,0.00227922,8.84086e-06,-1.90616e-09,1.14969e-13,-31229.2,-228.718], Tmin=(917.933,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-133.109,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(636.057,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cycloheptene) + radical(CCsJOCs)"""),
)

species(
    label = 'C=COC1[CH]CCCCC1OO(2913)',
    structure = SMILES('C=COC1[CH]CCCCC1OO'),
    E0 = (-137.949,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,3100,1380,975,1025,1650,2750,2790,2830,2870,2910,2950,2990,3030,3070,3110,3150,900,920,940,960,980,1000,1020,1040,1060,1080,1100,3615,1310,387.5,850,1000,3010,987.5,1337.5,450,1655,300,800,800,800,800,800,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (171.214,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.13695,0.068617,0.000172788,-3.26215e-07,1.45735e-10,-16308.5,45.0772], Tmin=(100,'K'), Tmax=(912.811,'K')), NASAPolynomial(coeffs=[55.3811,-0.00973719,1.61184e-05,-3.33303e-09,2.11149e-13,-34045.4,-266.805], Tmin=(912.811,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-137.949,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(640.214,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + ring(Cycloheptane) + radical(CCJCO)"""),
)
...
species(
    label = 'C[CH]O[C]1CCCCCC1OO(2914)',
    structure = SMILES('C[CH]O[C]1CCCCCC1OO'),
    E0 = (-64.5573,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (172.222,'amu'),
...
species(
    label = 'C[CH]OC1C[CH]CCCC1OO(2915)',
    structure = SMILES('C[CH]OC1C[CH]CCCC1OO'),
    E0 = (-75.8323,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (172.222,'amu'),
...
species(
    label = '[CH2]COC1[CH]CCCCC1OO(2916)',
    structure = SMILES('[CH2]COC1[CH]CCCCC1OO'),
    E0 = (-14.226,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (172.222,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.19471,0.0847106,0.000101746,-2.29388e-07,1.04959e-10,-1440.07,48.2182], Tmin=(100,'K'), Tmax=(920.431,'K')), NASAPolynomial(coeffs=[45.6653,0.0105147,4.62103e-06,-1.11491e-09,6.25131e-14,-15917.9,-209.497], Tmin=(920.431,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-14.226,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(661.001,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Cycloheptane) + radical(CCJCO) + radical(CJCO)"""),
)

species(
    label = 'CCO[C]1[CH]CCCCC1OO(2917)',
    structure = SMILES('CCO[C]1[CH]CCCCC1OO'),
    E0 = (-45.1112,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (172.222,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.13026,0.0901097,7.11636e-05,-1.87428e-07,8.7585e-11,-5163.44,47.9919], Tmin=(100,'K'), Tmax=(922.516,'K')), NASAPolynomial(coeffs=[41.2806,0.0176902,6.13712e-07,-3.65225e-10,1.40031e-14,-18100.7,-184.648], Tmin=(922.516,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-45.1112,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(661.001,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Cycloheptane) + radical(CCJCO) + radical(C2CsJOCs)"""),
)

species(
    label = 'C[CH]OC1CCCCC[C]1OO(2918)',
    structure = SMILES('C[CH]OC1CCCCC[C]1OO'),
    E0 = (-58.362,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (172.222,'amu'),
...
species(
    label = 'C[CH]OC1CC[CH]CCC1OO(2919)',
    structure = SMILES('C[CH]OC1CC[CH]CCC1OO'),
    E0 = (-75.8323,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (172.222,'amu'),
...
species(
    label = 'C[CH]OC1CCCC[CH]C1OO(2920)',
    structure = SMILES('C[CH]OC1CCCC[CH]C1OO'),
    E0 = (-44.8462,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (172.222,'amu'),
...
species(
    ...
    molecularWeight = (172.222,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.90592,0.0820494,9.64054e-05,-2.13712e-07,9.67312e-11,-4423.55,47.5345], Tmin=(100,'K'), Tmax=(924.663,'K')), NASAPolynomial(coeffs=[41.5368,0.0175683,7.48685e-07,-3.61863e-10,1.11759e-14,-17734.9,-187.186], Tmin=(924.663,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-38.916,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(661.001,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Cycloheptane) + radical(C2CsJOOH) + radical(CCJCO)"""),
)

species(
    label = 'C[CH]OC1CCC[CH]CC1OO(2922)',
    structure = SMILES('C[CH]OC1CCC[CH]CC1OO'),
    E0 = (-75.8323,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (172.222,'amu'),
...
species(
    ...
    molecularWeight = (172.222,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.67809,0.0967845,7.45651e-05,-2.0711e-07,9.86982e-11,-3762.71,46.903], Tmin=(100,'K'), Tmax=(916.67,'K')), NASAPolynomial(coeffs=[47.7826,0.00759745,6.13739e-06,-1.4399e-09,8.72917e-14,-18517.9,-222.172], Tmin=(916.67,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-33.672,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(661.001,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Cycloheptane) + radical(CJCO) + radical(CCsJOCs)"""),
)

species(
    label = 'C[CH]OC1CCCCCC1O[O](2924)',
    structure = SMILES('C[CH]OC1CCCCCC1O[O]'),
    E0 = (-93.2564,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (172.222,'amu'),
...
species(
    label = 'CCOC1[CH]CCC[CH]C1OO(2925)',
    structure = SMILES('CCOC1[CH]CCC[CH]C1OO'),
    E0 = (-25.4001,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1310,387.5,850,1000,2750,2794.44,2838.89,2883.33,2927.78,2972.22,3016.67,3061.11,3105.56,3150,900,922.222,944.444,966.667,988.889,1011.11,1033.33,1055.56,1077.78,1100,300,800,800,800,800,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'CCOC1[CH][CH]CCCC1OO(2926)',
    structure = SMILES('CCOC1[CH][CH]CCCC1OO'),
    E0 = (-56.3862,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (172.222,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.87251,0.0800596,0.000103325,-2.22142e-07,1.00029e-10,-6524.77,48.7746], Tmin=(100,'K'), Tmax=(924.566,'K')), NASAPolynomial(coeffs=[42.1873,0.0161374,1.48178e-06,-4.92861e-10,1.93677e-14,-20087.1,-189.618], Tmin=(924.566,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-56.3862,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(661.001,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Cycloheptane) + radical(CCJCO) + radical(cycloheptane)"""),
)

species(
    label = 'CCOC1[CH]CCCCC1O[O](2927)',
    structure = SMILES('CCOC1[CH]CCCCC1O[O]'),
    E0 = (-73.8104,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,492.5,1135,1000,2750,2790,2830,2870,2910,2950,2990,3030,3070,3110,3150,900,920,940,960,980,1000,1020,1040,1060,1080,1100,300,800,800,800,800,800,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (172.222,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.7576,0.075683,0.000117652,-2.40359e-07,1.07838e-10,-8622.66,46.7746], Tmin=(100,'K'), Tmax=(918.884,'K')), NASAPolynomial(coeffs=[43.0585,0.012989,3.87085e-06,-1.00633e-09,5.63756e-14,-22448.2,-196.06], Tmin=(918.884,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-73.8104,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(665.158,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Cycloheptane) + radical(ROOJ) + radical(CCJCO)"""),
)

species(
    label = 'CCOC1[CH]CC[CH]CC1OO(2928)',
    structure = SMILES('CCOC1[CH]CC[CH]CC1OO'),
    E0 = (-56.3862,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (172.222,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.87233,0.0800573,0.000103334,-2.22153e-07,1.00034e-10,-6524.78,48.774], Tmin=(100,'K'), Tmax=(924.558,'K')), NASAPolynomial(coeffs=[42.1868,0.0161383,1.48123e-06,-4.9273e-10,1.93567e-14,-20086.9,-189.615], Tmin=(924.558,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-56.3862,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(661.001,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Cycloheptane) + radical(cycloheptane) + radical(CCJCO)"""),
)

species(
    label = 'CCOC1[CH]C[CH]CCC1OO(2929)',
    structure = SMILES('CCOC1[CH]C[CH]CCC1OO'),
    E0 = (-56.3862,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (172.222,'amu'),
...
species(
    label = '[CH2]CCC(OO)C(C=C)O[CH]C(2930)',
    structure = SMILES('[CH2]CCC(OO)C(C=C)O[CH]C'),
    E0 = (7.26585,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1310,387.5,850,1000,2950,3100,1380,975,1025,1650,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (172.222,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.5862,0.147675,-0.00014596,7.744e-08,-1.68649e-11,1108.77,51.2509], Tmin=(100,'K'), Tmax=(1093.97,'K')), NASAPolynomial(coeffs=[21.0391,0.0612914,-2.75152e-05,5.26013e-09,-3.70029e-13,-4060.33,-64.8495], Tmin=(1093.97,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(7.26585,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(640.214,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CCsJOCs) + radical(RCCJ)"""),
)

species(
    label = 'C[CH]OC=CCCCC[CH]OO(2931)',
    structure = SMILES('C[CH]OC=CCCCC[CH]OO'),
    E0 = (-21.3314,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3050,390,425,1340,1360,335,370,3615,1310,387.5,850,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,200,800,933.333,1066.67,1200,1333.33,1466.67,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (172.222,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-3.43155,0.158009,-0.000161039,8.48257e-08,-1.78118e-11,-2293.32,49.9015], Tmin=(100,'K'), Tmax=(1153.33,'K')), NASAPolynomial(coeffs=[27.6058,0.0503651,-2.10404e-05,3.9023e-09,-2.70665e-13,-9452.65,-104.264], Tmin=(1153.33,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-21.3314,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(640.214,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(CCsJOOH) + radical(CCsJOC(O))"""),
)

species(
    label = 'CCOC1=CCCCCC1OO(2932)',
    structure = SMILES('CCOC1=CCCCCC1OO'),
    E0 = (-357.715,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (172.222,'amu'),
...
species(
    label = 'C=COC1CCCCCC1OO(2933)',
    structure = SMILES('C=COC1CCCCCC1OO'),
    E0 = (-337.851,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (172.222,'amu'),
...
species(
    label = 'CCOC1C=CCCCC1OO(2934)',
    structure = SMILES('CCOC1C=CCCCC1OO'),
    E0 = (-313.565,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (172.222,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.76987,0.070253,0.000144462,-2.73576e-07,1.20384e-10,-37452.9,45.0254], Tmin=(100,'K'), Tmax=(923.021,'K')), NASAPolynomial(coeffs=[46.0341,0.00949841,5.26522e-06,-1.19181e-09,6.3647e-14,-52514.5,-215.557], Tmin=(923.021,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-313.565,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(661.001,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cycloheptene)"""),
)
...
species(
    label = 'C[CH]OC1C2CCCCC1O2(2935)',
    structure = SMILES('C[CH]OC1C2CCCCC1O2'),
    E0 = (-289.062,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (155.214,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.29406,0.136017,-0.000123792,5.89654e-08,-1.14488e-11,-34537.6,5.20911], Tmin=(100,'K'), Tmax=(1222.12,'K')), NASAPolynomial(coeffs=[22.534,0.0547545,-2.40518e-05,4.55719e-09,-3.18881e-13,-40606.2,-119.552], Tmin=(1222.12,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-289.062,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(619.428,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + polycyclic(PolycyclicRing) + radical(CCsJOCs)"""),
)

species(
    label = 'CC1OC2[CH]CCCCC2O1(2936)',
    structure = SMILES('CC1OC2[CH]CCCCC2O1'),
    E0 = (-251.478,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (155.214,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.740089,0.0865373,-1.50661e-05,-2.86501e-08,1.29187e-11,-30060.5,37.553], Tmin=(100,'K'), Tmax=(1150.11,'K')), NASAPolynomial(coeffs=[17.8595,0.0582008,-2.55191e-05,4.89081e-09,-3.45839e-13,-36743,-65.2324], Tmin=(1150.11,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-251.478,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(627.743,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + polycyclic(s2_5_7) + radical(CCJCO)"""),
)
...
species(
    label = '[CH2]C1CCCC(OO)C1O[CH]C(2938)',
    structure = SMILES('[CH2]C1CCCC(OO)C1O[CH]C'),
    E0 = (-79.3889,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (172.222,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.73268,0.12865,-8.80534e-05,2.69082e-08,-2.49252e-12,-9289.84,43.5753], Tmin=(100,'K'), Tmax=(1273.68,'K')), NASAPolynomial(coeffs=[26.838,0.0544414,-2.26314e-05,4.16624e-09,-2.86119e-13,-18336,-112.18], Tmin=(1273.68,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-79.3889,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(656.843,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Cyclohexane) + radical(Isobutyl) + radical(CCsJOCs)"""),
)
...
species(
    label = 'C[CH]OC1C([O])CCCCC1O(2939)',
    structure = SMILES('C[CH]OC1C([O])CCCCC1O'),
    E0 = (-258.876,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (172.222,'amu'),
...
reaction(
    label = 'reaction1',
    reactants = ['C[CH]OC1[CH]CCCCC1OO(2294)'],
...
reaction(
    label = 'reaction2',
    reactants = ['H(19)', 'C[CH]OC1=CCCCCC1OO(2911)'],
    products = ['C[CH]OC1[CH]CCCCC1OO(2294)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(19)', 'C[CH]OC1C=CCCCC1OO(2912)'],
    products = ['C[CH]OC1[CH]CCCCC1OO(2294)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(19)', 'C=COC1[CH]CCCCC1OO(2913)'],
    products = ['C[CH]OC1[CH]CCCCC1OO(2294)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['C[CH]OC1[CH]CCCCC1OO(2294)'],
    products = ['C[CH]O[C]1CCCCCC1OO(2914)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['C[CH]OC1[CH]CCCCC1OO(2294)'],
    products = ['C[CH]OC1C[CH]CCCC1OO(2915)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]COC1[CH]CCCCC1OO(2916)'],
    products = ['C[CH]OC1[CH]CCCCC1OO(2294)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['C[CH]OC1[CH]CCCCC1OO(2294)'],
    products = ['CCO[C]1[CH]CCCCC1OO(2917)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['C[CH]OC1[CH]CCCCC1OO(2294)'],
    products = ['C[CH]OC1CCCCC[C]1OO(2918)'],
...
reaction(
    label = 'reaction11',
    reactants = ['C[CH]OC1[CH]CCCCC1OO(2294)'],
    products = ['C[CH]OC1CC[CH]CCC1OO(2919)'],
...
reaction(
    label = 'reaction12',
    reactants = ['C[CH]OC1[CH]CCCCC1OO(2294)'],
    products = ['C[CH]OC1CCCC[CH]C1OO(2920)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CCOC1[CH]CCCC[C]1OO(2921)'],
    products = ['C[CH]OC1[CH]CCCCC1OO(2294)'],
...
reaction(
    label = 'reaction14',
    reactants = ['C[CH]OC1[CH]CCCCC1OO(2294)'],
    products = ['C[CH]OC1CCC[CH]CC1OO(2922)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2][CH]OC1CCCCCC1OO(2923)'],
    products = ['C[CH]OC1[CH]CCCCC1OO(2294)'],
...
reaction(
    label = 'reaction16',
    reactants = ['C[CH]OC1[CH]CCCCC1OO(2294)'],
    products = ['C[CH]OC1CCCCCC1O[O](2924)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CCOC1[CH]CCC[CH]C1OO(2925)'],
    products = ['C[CH]OC1[CH]CCCCC1OO(2294)'],
...
reaction(
    label = 'reaction18',
    reactants = ['C[CH]OC1[CH]CCCCC1OO(2294)'],
    products = ['CCOC1[CH][CH]CCCC1OO(2926)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CCOC1[CH]CCCCC1O[O](2927)'],
    products = ['C[CH]OC1[CH]CCCCC1OO(2294)'],
...
reaction(
    label = 'reaction20',
    reactants = ['C[CH]OC1[CH]CCCCC1OO(2294)'],
    products = ['CCOC1[CH]CC[CH]CC1OO(2928)'],
...
reaction(
    label = 'reaction21',
    reactants = ['C[CH]OC1[CH]CCCCC1OO(2294)'],
    products = ['CCOC1[CH]C[CH]CCC1OO(2929)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH2]CCC(OO)C(C=C)O[CH]C(2930)'],
    products = ['C[CH]OC1[CH]CCCCC1OO(2294)'],
...
reaction(
    label = 'reaction24',
    reactants = ['C[CH]OC=CCCCC[CH]OO(2931)'],
    products = ['C[CH]OC1[CH]CCCCC1OO(2294)'],
...
reaction(
    label = 'reaction28',
    reactants = ['C[CH]OC1[CH]CCCCC1OO(2294)'],
    products = ['OH(21)', 'C[CH]OC1C2CCCCC1O2(2935)'],
...
reaction(
    label = 'reaction29',
    reactants = ['C[CH]OC1[CH]CCCCC1OO(2294)'],
    products = ['OH(21)', 'CC1OC2[CH]CCCCC2O1(2936)'],
    transitionState = 'TS29',
    kinetics = Arrhenius(A=(3.63e+10,'s^-1','*|/',1.41), n=0, Ea=(54.392,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""Estimated using an average for rate rule [R4OO;C_rad/H/NonDeC_intra;OOH]
Euclidian distance = 0
family: Cyclic_Ether_Formation"""),
)
...
reaction(
    label = 'reaction31',
    reactants = ['C[CH]OC1[CH]CCCCC1OO(2294)'],
    products = ['[CH2]C1CCCC(OO)C1O[CH]C(2938)'],
...
reaction(
    label = 'reaction33',
    reactants = ['C[CH]OC1[CH]CCCCC1OO(2294)'],
    products = ['C[CH]OC1C([O])CCCCC1O(2939)'],
...
reaction(
    label = 'reaction34',
    reactants = ['CHCH3(T)(359)', '[O]C1[CH]CCCCC1OO(1585)'],
    products = ['C[CH]OC1[CH]CCCCC1OO(2294)'],
