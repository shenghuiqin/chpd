species(
    label = '[CH2]CC1[CH]CC=CC=C1(397)',
    structure = SMILES('[CH2]CC1[CH]CC=CC=C1'),
    E0 = (417.107,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2807.14,2864.29,2921.43,2978.57,3035.71,3092.86,3150,900,928.571,957.143,985.714,1014.29,1042.86,1071.43,1100,2750,2850,1437.5,1250,1305,750,350,300,800,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.411702,0.0825158,-3.77524e-05,-7.62017e-09,7.97835e-12,50337.6,20.613], Tmin=(100,'K'), Tmax=(1064.75,'K')), NASAPolynomial(coeffs=[18.3922,0.0394162,-1.58348e-05,2.9505e-09,-2.07678e-13,44772.1,-78.6162], Tmin=(1064.75,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(417.107,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(498.868,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + ring(1,3-Cycloheptadiene) + radical(RCCJ) + radical(Cs_S)"""),
)
...
species(
    label = '[CH2]CC1C=CC=CCC=1(549)',
    structure = SMILES('[CH2]CC1C=CC=CCC=1'),
    E0 = (310.514,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2816.67,2883.33,2950,3016.67,3083.33,3150,900,933.333,966.667,1000,1033.33,1066.67,1100,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,300,800,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
...
species(
    label = 'C=CC1[CH]CC=CC=C1(550)',
    structure = SMILES('C=CC1[CH]CC=CC=C1'),
    E0 = (339.094,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2807.14,2864.29,2921.43,2978.57,3035.71,3092.86,3150,900,928.571,957.143,985.714,1014.29,1042.86,1071.43,1100,2950,3100,1380,975,1025,1650,3010,987.5,1337.5,450,1655,300,800,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (119.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.606147,0.0878664,-6.4761e-05,2.40767e-08,-3.59112e-12,40960.6,17.6354], Tmin=(100,'K'), Tmax=(1582.27,'K')), NASAPolynomial(coeffs=[20.9268,0.0334307,-1.31554e-05,2.33332e-09,-1.55635e-13,34146.5,-96.129], Tmin=(1582.27,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(339.094,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(478.082,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)CsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + ring(1,3-Cycloheptadiene) + radical(Cs_S)"""),
)

species(
    label = '[CH2]CC1C=CC=CC=C1(551)',
...
species(
    label = '[CH2]C[C]1C=CC=CCC1(552)',
    structure = SMILES('[CH2]CC1=C[CH]C=CCC1'),
    E0 = (335.619,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2807.14,2864.29,2921.43,2978.57,3035.71,3092.86,3150,900,928.571,957.143,985.714,1014.29,1042.86,1071.43,1100,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,300,800,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    ...
    molecularWeight = (120.192,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.07137,-0.00258795,0.000287221,-4.12397e-07,1.70936e-10,40533.8,32.67], Tmin=(100,'K'), Tmax=(908.154,'K')), NASAPolynomial(coeffs=[43.405,-0.0145899,1.88917e-05,-3.89025e-09,2.50344e-13,25650.6,-207.095], Tmin=(908.154,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(335.619,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(498.868,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(1,4-Cycloheptadiene) + radical(C=CCJC=C) + radical(RCCJ)"""),
)
...
species(
    label = '[CH2][CH]C1C=CC=CCC1(554)',
    structure = SMILES('[CH2][CH]C1C=CC=CCC1'),
    E0 = (417.107,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,2900,2950,3000,3050,3100,3150,900,925,950,975,1000,1025,1050,1075,1100,3000,3100,440,815,1455,1000,3025,407.5,1350,352.5,300,800,800,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    ...
    molecularWeight = (120.192,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.411702,0.0825158,-3.77524e-05,-7.62016e-09,7.97835e-12,50337.6,20.613], Tmin=(100,'K'), Tmax=(1064.75,'K')), NASAPolynomial(coeffs=[18.3922,0.0394162,-1.58348e-05,2.9505e-09,-2.07678e-13,44772.1,-78.6162], Tmin=(1064.75,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(417.107,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(498.868,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + ring(1,3-Cycloheptadiene) + radical(Cs_S) + radical(RCCJ)"""),
)

species(
    label = '[CH2]CC1[C]=CC=CCC1(555)',
    structure = SMILES('[CH2]CC1[C]=CC=CCC1'),
    E0 = (460.406,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2807.14,2864.29,2921.43,2978.57,3035.71,3092.86,3150,900,928.571,957.143,985.714,1014.29,1042.86,1071.43,1100,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,300,800,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (120.192,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.646286,0.0884805,-5.1755e-05,4.392e-09,4.44833e-12,55553.1,19.3712], Tmin=(100,'K'), Tmax=(1064.23,'K')), NASAPolynomial(coeffs=[19.1855,0.0381696,-1.49925e-05,2.75488e-09,-1.9231e-13,49959.9,-83.9866], Tmin=(1064.23,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(460.406,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(498.868,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + ring(1,3-Cycloheptadiene) + radical(Cds_S) + radical(RCCJ)"""),
)

species(
    label = 'CC[C]1[CH]CC=CC=C1(556)',
    structure = SMILES('CCC1[CH]CC=C[CH]C=1'),
    E0 = (271.485,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (120.192,'amu'),
...
species(
    label = 'CCC1[C]=CC=CC[CH]1(558)',
    structure = SMILES('CCC1[C]=CC=CC[CH]1'),
    E0 = (449.702,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2816.67,2883.33,2950,3016.67,3083.33,3150,900,933.333,966.667,1000,1033.33,1066.67,1100,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,300,800,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    ...
    molecularWeight = (120.192,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.548577,0.0870801,-5.40918e-05,1.13195e-08,9.36848e-13,54261.2,19.7968], Tmin=(100,'K'), Tmax=(1152.51,'K')), NASAPolynomial(coeffs=[18.29,0.0397911,-1.60939e-05,2.96158e-09,-2.0497e-13,48717.2,-78.976], Tmin=(1152.51,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(449.702,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(498.868,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + ring(1,3-Cycloheptadiene) + radical(Cds_S) + radical(Cs_S)"""),
)

species(
    label = '[CH2]CC1C=[C]C=CCC1(559)',
    structure = SMILES('[CH2]CC1C=[C]C=CCC1'),
    E0 = (421.56,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2807.14,2864.29,2921.43,2978.57,3035.71,3092.86,3150,900,928.571,957.143,985.714,1014.29,1042.86,1071.43,1100,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,300,800,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (120.192,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.696282,0.0905111,-5.65051e-05,8.79514e-09,3.20371e-12,50882,18.6719], Tmin=(100,'K'), Tmax=(1049.41,'K')), NASAPolynomial(coeffs=[18.7046,0.0389642,-1.48475e-05,2.67417e-09,-1.84464e-13,45576.5,-81.7394], Tmin=(1049.41,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(421.56,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(498.868,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + ring(1,3-Cycloheptadiene) + radical(RCCJ) + radical(C=CJC=C)"""),
)

species(
    label = '[CH2]CC1C=C[C]=CCC1(560)',
    structure = SMILES('[CH2]CC1C=C[C]=CCC1'),
    E0 = (421.56,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2807.14,2864.29,2921.43,2978.57,3035.71,3092.86,3150,900,928.571,957.143,985.714,1014.29,1042.86,1071.43,1100,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,300,800,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
...
species(
    label = 'CCC1[CH]CC=C[C]=C1(562)',
    structure = SMILES('CCC1[CH]CC=C[C]=C1'),
    E0 = (410.856,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (120.192,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.626827,0.0894392,-5.99644e-05,1.71323e-08,-8.86157e-13,49591.4,19.1992], Tmin=(100,'K'), Tmax=(1160.83,'K')), NASAPolynomial(coeffs=[17.9459,0.0403592,-1.58208e-05,2.85102e-09,-1.94674e-13,44274.3,-77.5025], Tmin=(1160.83,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(410.856,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(498.868,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + ring(1,3-Cycloheptadiene) + radical(C=CJC=C) + radical(Cs_S)"""),
)

species(
    label = 'CCC1[CH]C[C]=CC=C1(563)',
...
species(
    label = '[CH2]CC1[CH]C2C=CCC21(565)',
    structure = SMILES('[CH2]CC1[CH]C2C=CCC21'),
    E0 = (461.296,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (120.192,'amu'),
...
species(
    label = '[CH2]CC1C=CC2[CH]CC21(566)',
    structure = SMILES('[CH2]CC1C=CC2[CH]CC21'),
    E0 = (462.365,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (120.192,'amu'),
...
species(
    label = '[CH2]CC1C=C[CH]C2CC21(568)',
    structure = SMILES('[CH2]CC1[CH]C=CC2CC12'),
    E0 = (393.204,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (120.192,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.953392,0.0432321,7.00818e-05,-1.14339e-07,4.43326e-11,47422.3,25.4592], Tmin=(100,'K'), Tmax=(992.547,'K')), NASAPolynomial(coeffs=[15.8512,0.0417746,-1.6247e-05,3.11005e-09,-2.27674e-13,41579.4,-60.8386], Tmin=(992.547,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(393.204,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(498.868,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + polycyclic(s2_3_6_ene_1) + radical(RCCJ) + radical(cyclohexene-allyl)"""),
)

species(
    label = '[CH2]CC1C2[CH]C=CCC21(569)',
    structure = SMILES('[CH2]CC1C2C=C[CH]CC21'),
    E0 = (393.204,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (120.192,'amu'),
...
species(
    label = '[CH]1C[CH]C2C=CC1CC2(570)',
    structure = SMILES('[CH]1C[CH]C2C=CC1CC2'),
    E0 = (265.877,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (120.192,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.442247,0.0899991,-6.88412e-05,2.7989e-08,-4.67051e-12,32143.7,3.72314], Tmin=(100,'K'), Tmax=(1404.32,'K')), NASAPolynomial(coeffs=[16.984,0.0403625,-1.58223e-05,2.81929e-09,-1.89716e-13,27249.3,-86.2657], Tmin=(1404.32,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(265.877,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + Estimated bicyclic component: polycyclic(PolycyclicRing) - ring(Cycloheptane) - ring(Cyclohexane) + ring(Cycloheptene) + ring(Cyclohexene) + radical(cycloheptane) + radical(cycloheptane)"""),
)

species(
    label = '[CH]1CC2[CH]C=CC1CC2(571)',
    structure = SMILES('[CH]1CC2[CH]C=CC1CC2'),
    E0 = (257.678,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (120.192,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.249126,0.077364,-2.00511e-05,-2.36701e-08,1.26546e-11,31158.1,-0.437295], Tmin=(100,'K'), Tmax=(1074.48,'K')), NASAPolynomial(coeffs=[17.7125,0.0432143,-1.80503e-05,3.42643e-09,-2.43351e-13,25409.7,-97.1704], Tmin=(1074.48,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(257.678,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + Estimated bicyclic component: polycyclic(PolycyclicRing) - ring(Cycloheptane) - ring(Cyclohexane) + ring(Cycloheptene) + ring(Cyclohexane) + radical(Allyl_S) + radical(Cs_S)"""),
)

species(
    label = '[CH]1C=CC[CH]C2CCC12(572)',
...
species(
    label = '[CH]=CC=CCC=CC[CH2](574)',
    structure = SMILES('[CH]=CC=CCC=CC[CH2]'),
    E0 = (534.193,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2995,3002.5,3010,3017.5,3025,975,981.25,987.5,993.75,1000,1300,1318.75,1337.5,1356.25,1375,400,425,450,475,500,1630,1642.5,1655,1667.5,1680,3120,650,792.5,1650,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3100,440,815,1455,1000,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'CCC1C=CC=CCC=1(575)',
    structure = SMILES('CCC1C=CC=CCC=1'),
    E0 = (105.267,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (120.192,'amu'),
...
species(
    label = 'C=CC1C=CC=CCC1(576)',
    structure = SMILES('C=CC1C=CC=CCC1'),
    E0 = (144.552,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (120.192,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.590138,0.0870015,-4.77315e-05,8.89271e-10,5.47775e-12,17562.8,14.9982], Tmin=(100,'K'), Tmax=(1064.53,'K')), NASAPolynomial(coeffs=[18.9384,0.038814,-1.53285e-05,2.82651e-09,-1.97717e-13,11977.7,-87.1414], Tmin=(1064.53,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(144.552,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)CsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + ring(1,3-Cycloheptadiene)"""),
)

species(
    label = 'CCC1C=CC=CC=C1(577)',
...
species(
    label = '[CH2]CC1[CH]CCC=CC=1(578)',
    structure = SMILES('[CH2]CC1[CH]C=CCCC=1'),
    E0 = (335.619,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (120.192,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.07137,-0.00258795,0.000287221,-4.12397e-07,1.70936e-10,40533.8,32.67], Tmin=(100,'K'), Tmax=(908.154,'K')), NASAPolynomial(coeffs=[43.405,-0.0145899,1.88917e-05,-3.89025e-09,2.50344e-13,25650.6,-207.095], Tmin=(908.154,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(335.619,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(498.868,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(1,4-Cycloheptadiene) + radical(RCCJ) + radical(C=CCJC=C)"""),
)

species(
    label = '[CH2]C[CH]C1C=CC=CC1(579)',
    structure = SMILES('[CH2]C[CH]C1C=CC=CC1'),
    E0 = (408.848,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (120.192,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.569228,0.056654,2.71381e-05,-6.87153e-08,2.81024e-11,49313.1,32.4177], Tmin=(100,'K'), Tmax=(1014.16,'K')), NASAPolynomial(coeffs=[15.4936,0.0420573,-1.6746e-05,3.17155e-09,-2.27934e-13,44009.4,-51.0174], Tmin=(1014.16,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(408.848,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(494.711,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + ring(1,3-Cyclohexadiene) + radical(RCCJ) + radical(Cs_S)"""),
)

species(
    label = '[CH2]CC1C=CC=CC1[CH2](580)',
    structure = SMILES('[CH2]CC1C=CC=CC1[CH2]'),
    E0 = (411.417,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (120.192,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.461092,0.05618,3.94413e-05,-9.11067e-08,3.90212e-11,49628.9,31.09], Tmin=(100,'K'), Tmax=(962.193,'K')), NASAPolynomial(coeffs=[18.0757,0.0361624,-1.23027e-05,2.21788e-09,-1.59545e-13,43776.1,-66.011], Tmin=(962.193,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(411.417,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(494.711,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + ring(1,3-Cyclohexadiene) + radical(Isobutyl) + radical(RCCJ)"""),
)

species(
    label = 'C1C=CC2CCC2CC=1(401)',
    structure = SMILES('C1C=CC2CCC2CC=1'),
    E0 = (17.8645,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (120.192,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.29611,0.146038,-0.000273907,2.90684e-07,-1.14913e-10,2310.62,-17.4139], Tmin=(100,'K'), Tmax=(837.47,'K')), NASAPolynomial(coeffs=[-4.71393,0.0911712,-4.81236e-05,9.44444e-09,-6.56985e-13,5379.61,13.374], Tmin=(837.47,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(17.8645,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + Estimated bicyclic component: polycyclic(PolycyclicRing) - ring(Cycloheptane) - ring(Cyclobutane) + ring(1,3-Cycloheptadiene) + ring(Cyclobutane)"""),
)

species(
    label = '[CH2]CC1[CH]CC2C=CC12(581)',
    structure = SMILES('[CH2]CC1[CH]CC2C=CC12'),
    E0 = (496.913,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (120.192,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.06141,0.0442527,5.64584e-05,-9.35471e-08,3.536e-11,59888.4,28.3363], Tmin=(100,'K'), Tmax=(1018.72,'K')), NASAPolynomial(coeffs=[13.4808,0.0453347,-1.85306e-05,3.5582e-09,-2.57427e-13,54771.5,-44.5053], Tmin=(1018.72,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(496.913,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(498.868,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + Estimated bicyclic component: polycyclic(s2_4_5_ane) - ring(Cyclopentane) - ring(Cyclobutane) + ring(Cyclopentane) + ring(Cyclobutene) + radical(Cs_S) + radical(RCCJ)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]CC1[CH]CC=CC=C1(397)'],
    products = ['C7H8(11)', 'C2H4(45)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['H(19)', '[CH2]CC1C=CC=CCC=1(549)'],
    products = ['[CH2]CC1[CH]CC=CC=C1(397)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(19)', 'C=CC1[CH]CC=CC=C1(550)'],
    products = ['[CH2]CC1[CH]CC=CC=C1(397)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(19)', '[CH2]CC1C=CC=CC=C1(551)'],
    products = ['[CH2]CC1[CH]CC=CC=C1(397)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH]1C=C[CH]CC=C1(125)', 'C2H4(45)'],
    products = ['[CH2]CC1[CH]CC=CC=C1(397)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(0.00620033,'m^3/(mol*s)'), n=2.49247, Ea=(48.5084,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [Cds-HH_Cds-HH;CJ]
Euclidian distance = 0
Multiplied by reaction path degeneracy 4.0
family: R_Addition_MultipleBond"""),
)
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2]C[C]1C=CC=CCC1(552)'],
    products = ['[CH2]CC1[CH]CC=CC=C1(397)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]CC1[CH]CC=CC=C1(397)'],
    products = ['C[CH]C1[CH]CC=CC=C1(553)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]CC1[CH]CC=CC=C1(397)'],
    products = ['[CH2]CC1[CH]C=CC=CC1(398)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2][CH]C1C=CC=CCC1(554)'],
    products = ['[CH2]CC1[CH]CC=CC=C1(397)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]CC1[C]=CC=CCC1(555)'],
    products = ['[CH2]CC1[CH]CC=CC=C1(397)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]CC1[CH]CC=CC=C1(397)'],
    products = ['CC[C]1[CH]CC=CC=C1(556)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2]CC1[CH]CC=CC=C1(397)'],
    products = ['[CH2]CC1C=CC=[C]CC1(557)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CCC1[C]=CC=CC[CH]1(558)'],
    products = ['[CH2]CC1[CH]CC=CC=C1(397)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]CC1C=[C]C=CCC1(559)'],
    products = ['[CH2]CC1[CH]CC=CC=C1(397)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]CC1C=C[C]=CCC1(560)'],
    products = ['[CH2]CC1[CH]CC=CC=C1(397)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]CC1[CH]CC=CC=C1(397)'],
    products = ['CCC1[CH][CH]C=CC=C1(561)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2]CC1[CH]CC=CC=C1(397)'],
    products = ['CCC1[CH]CC=C[C]=C1(562)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CCC1[CH]C[C]=CC=C1(563)'],
    products = ['[CH2]CC1[CH]CC=CC=C1(397)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2]CC1[CH]CC=CC=C1(397)'],
    products = ['CCC1[CH]CC=[C]C=C1(564)'],
...
reaction(
    label = 'reaction21',
    reactants = ['C2H4(T)(169)', '[CH]1C=C[CH]CC=C1(125)'],
    products = ['[CH2]CC1[CH]CC=CC=C1(397)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH2]CC1[CH]CC=CC=C1(397)'],
    products = ['[CH2]CC1[CH]C2C=CCC21(565)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH2]CC1[CH]CC=CC=C1(397)'],
    products = ['[CH2]CC1C=CC2[CH]CC21(566)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[CH2]CC1[CH]CC=CC=C1(397)'],
    products = ['[CH]1CC=CC2[CH]C1CC2(567)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[CH2]CC1[CH]CC=CC=C1(397)'],
    products = ['[CH2]CC1C=C[CH]C2CC21(568)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[CH2]CC1[CH]CC=CC=C1(397)'],
    products = ['[CH2]CC1C2[CH]C=CCC21(569)'],
...
reaction(
    label = 'reaction27',
    reactants = ['[CH2]CC1[CH]CC=CC=C1(397)'],
    products = ['[CH]1C[CH]C2C=CC1CC2(570)'],
...
reaction(
    label = 'reaction28',
    reactants = ['[CH2]CC1[CH]CC=CC=C1(397)'],
    products = ['[CH]1CC2[CH]C=CC1CC2(571)'],
...
reaction(
    label = 'reaction29',
    reactants = ['[CH2]CC1[CH]CC=CC=C1(397)'],
    products = ['[CH]1C=CC[CH]C2CCC12(572)'],
...
reaction(
    label = 'reaction30',
    reactants = ['[CH]=CC=CC(C=C)C[CH2](573)'],
    products = ['[CH2]CC1[CH]CC=CC=C1(397)'],
...
reaction(
    label = 'reaction31',
    reactants = ['[CH]=CC=CCC=CC[CH2](574)'],
    products = ['[CH2]CC1[CH]CC=CC=C1(397)'],
...
reaction(
    label = 'reaction35',
    reactants = ['[CH2]CC1[CH]CC=CC=C1(397)'],
    products = ['[CH2]CC1[CH]CCC=CC=1(578)'],
...
reaction(
    label = 'reaction36',
    reactants = ['[CH2]CC1[CH]CC=CC=C1(397)'],
    products = ['[CH2]C[CH]C1C=CC=CC1(579)'],
...
reaction(
    label = 'reaction37',
    reactants = ['[CH2]CC1[CH]CC=CC=C1(397)'],
    products = ['[CH2]CC1C=CC=CC1[CH2](580)'],
...
reaction(
    label = 'reaction39',
    reactants = ['[CH2]CC1[CH]CC=CC=C1(397)'],
    products = ['[CH2]CC1[CH]CC2C=CC12(581)'],
...
reaction(
    label = 'reaction40',
    reactants = ['CH2(T)(33)', '[CH2]C1[CH]CC=CC=C1(582)'],
    products = ['[CH2]CC1[CH]CC=CC=C1(397)'],
