...
species(
    label = '[CH2]C[CH]O(3031)',
    structure = SMILES('[CH2]C[CH]O'),
    E0 = (112.668,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,4000],'cm^-1')),
        HinderedRotor(inertia=(1.33788,'amu*angstrom^2'), symmetry=1, barrier=(30.7605,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.014492,'amu*angstrom^2'), symmetry=1, barrier=(3.49854,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.151977,'amu*angstrom^2'), symmetry=1, barrier=(3.49426,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (58.0791,'amu'),
...
reaction(
    label = 'reaction2',
    reactants = ['H(19)', 'allyloxy(3029)'],
    products = ['[CH2]CC[O](2159)'],
    transitionState = 'TS2',
