...
species(
    label = '[CH2]CC1C=CC1[CH2](116)',
    structure = SMILES('[CH2]CC1C=CC1[CH2]'),
    E0 = (467.512,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,2750,2850,1437.5,1250,1305,750,350,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,300,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
...
species(
    label = '[CH2]CCC1[CH]C=C1(117)',
    structure = SMILES('[CH2]CCC1[CH]C=C1'),
    E0 = (434.944,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3100,440,815,1455,1000,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
...
species(
    label = '[CH]=CCCCC=[CH](96)',
    structure = SMILES('[CH]=CCCCC=[CH]'),
    E0 = (534.112,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2995,3025,975,1000,1300,1375,400,500,1630,1680,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3115,3125,620,680,785,800,1600,1700,337.318,337.566],'cm^-1')),
        HinderedRotor(inertia=(0.574084,'amu*angstrom^2'), symmetry=1, barrier=(13.1993,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0283743,'amu*angstrom^2'), symmetry=1, barrier=(2.29056,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.163358,'amu*angstrom^2'), symmetry=1, barrier=(13.1997,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.574082,'amu*angstrom^2'), symmetry=1, barrier=(13.1993,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (94.1543,'amu'),
...
reaction(
    label = 'reaction19',
    reactants = ['H(19)', 'C1=CC2CCC[C]12(106)'],
    products = ['C1=CC2CCCC12(101)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction20',
    reactants = ['H(19)', '[CH]1CCC2C=CC12(107)'],
    products = ['C1=CC2CCCC12(101)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction21',
    reactants = ['H(19)', '[CH]1CC2C=CC2C1(108)'],
    products = ['C1=CC2CCCC12(101)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(2e+13,'cm^3/(mol*s)','*|/',3.16), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), comment="""From training reaction 59 used for H_rad;C_rad/H/NonDeC
Exact match found for rate rule [C_rad/H/NonDeC;H_rad]
...
reaction(
    label = 'reaction22',
    reactants = ['H(19)', '[C]1=CC2CCCC12(109)'],
    products = ['C1=CC2CCCC12(101)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction25',
    reactants = ['[CH]1CCC2[CH]CC12(112)'],
    products = ['C1=CC2CCCC12(101)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction26',
    reactants = ['[CH]1CCC2C[CH]C12(113)'],
    products = ['C1=CC2CCCC12(101)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction27',
    reactants = ['[CH]1CC2[CH]CC2C1(114)'],
    products = ['C1=CC2CCCC12(101)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction30',
    reactants = ['[CH2]CC1C=CC1[CH2](116)'],
    products = ['C1=CC2CCCC12(101)'],
...
reaction(
    label = 'reaction31',
    reactants = ['[CH2]CCC1[CH]C=C1(117)'],
    products = ['C1=CC2CCCC12(101)'],
...
reaction(
    label = 'reaction2',
    reactants = ['H(19)', '[CH]1C=CC=CCC1(85)'],
    products = ['CHPD(1)'],
...
reaction(
    label = 'reaction3',
    reactants = ['H(19)', '[C]1=CC=CCCC1(86)'],
    products = ['CHPD(1)'],
...
reaction(
    label = 'reaction4',
    reactants = ['H(19)', '[C]1=CCCCC=C1(87)'],
    products = ['CHPD(1)'],
