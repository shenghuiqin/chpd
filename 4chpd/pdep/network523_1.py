species(
    label = '[CH2]CC(C)[O](2270)',
    structure = SMILES('[CH2]CC(C)[O]'),
    E0 = (119.551,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,180,4000],'cm^-1')),
        HinderedRotor(inertia=(0.43791,'amu*angstrom^2'), symmetry=1, barrier=(10.0684,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0096776,'amu*angstrom^2'), symmetry=1, barrier=(19.0286,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.14994,'amu*angstrom^2'), symmetry=1, barrier=(26.4393,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
species(
    label = '[CH2]CC(C)=O(3573)',
    structure = SMILES('[CH2]CC(C)=O'),
    E0 = (-46.6048,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,2750,2850,1437.5,1250,1305,750,350,375,552.5,462.5,1710,180],'cm^-1')),
...
species(
    ...
    molecularWeight = (72.1057,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.82977,0.0513726,-4.79779e-05,2.8642e-08,-7.64545e-12,11011.7,17.5326], Tmin=(100,'K'), Tmax=(869.961,'K')), NASAPolynomial(coeffs=[6.10027,0.0317369,-1.41211e-05,2.69658e-09,-1.89421e-13,10268.6,-2.4751], Tmin=(869.961,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(90.9326,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo library: CBS_QB3_1dHR + radical(C2CsJOH) + radical(CC(C)OJ)"""),
)

species(
    label = '[CH2]C([O])CC(3580)',
    structure = SMILES('[CH2]C([O])CC'),
    E0 = (125.894,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,326.454,326.514],'cm^-1')),
        HinderedRotor(inertia=(0.00158293,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.102611,'amu*angstrom^2'), symmetry=1, barrier=(7.75211,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.102401,'amu*angstrom^2'), symmetry=1, barrier=(7.75001,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (72.1057,'amu'),
...
species(
    ...
    molecularWeight = (72.1057,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.16555,0.0387509,-1.87933e-05,3.93793e-09,-2.84722e-13,-30986.2,17.5897], Tmin=(100,'K'), Tmax=(2027.92,'K')), NASAPolynomial(coeffs=[13.5457,0.0202536,-8.03275e-06,1.36087e-09,-8.54221e-14,-36413.9,-47.361], Tmin=(2027.92,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-258.194,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)HHH) + group(Cds-OdCsCs)"""),
)
...
species(
    label = '[CH2]C[CH]C(652)',
    structure = SMILES('[CH2]C[CH]C'),
    E0 = (255.669,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,2750,2850,1437.5,1250,1305,750,350,3025,407.5,1350,352.5,2031.17],'cm^-1')),
        HinderedRotor(inertia=(0.245019,'amu*angstrom^2'), symmetry=1, barrier=(5.63347,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00192273,'amu*angstrom^2'), symmetry=1, barrier=(5.62982,'kJ/mol'), semiclassical=False),
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]CC(C)[O](2270)'],
    products = ['C2H4(45)', 'CH3CHO(52)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['H(19)', '[CH2]CC(C)=O(3573)'],
    products = ['[CH2]CC(C)[O](2270)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['C2H4(T)(169)', 'CH3CHO(52)'],
    products = ['[CH2]CC(C)[O](2270)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CH3(34)', 'CH2CH2CHO(2042)'],
    products = ['[CH2]CC(C)[O](2270)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction13',
    reactants = ['C2H4(T)(169)', 'C[CH][O](2420)'],
    products = ['[CH2]CC(C)[O](2270)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CH2(S)(40)', '[CH2]CC[O](2159)'],
    products = ['[CH2]CC(C)[O](2270)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CH2(T)(33)', '[CH2]C(C)[O](3583)'],
    products = ['[CH2]CC(C)[O](2270)'],
