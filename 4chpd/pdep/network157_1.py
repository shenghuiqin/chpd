species(
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.721255,0.090209,-6.3396e-05,1.45652e-08,1.45376e-12,-3199.83,16.2577], Tmin=(100,'K'), Tmax=(1077.13,'K')), NASAPolynomial(coeffs=[21.0577,0.0315773,-1.27256e-05,2.37773e-09,-1.67792e-13,-9182.09,-96.4219], Tmin=(1077.13,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-28.115,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(448.981,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + ring(1,3-Cycloheptadiene)"""),
)
...
species(
    label = 'OOC1[CH]C[CH]C=CC1(878)',
    structure = SMILES('OOC1[CH]C[CH]C=CC1'),
    E0 = (217.571,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,2750,2800,2850,2900,2950,3000,3050,3100,3150,900,925,950,975,1000,1025,1050,1075,1100,300,800,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (126.153,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.560785,0.0204634,0.00019856,-3.10337e-07,1.31865e-10,26343.2,32.1185], Tmin=(100,'K'), Tmax=(911.889,'K')), NASAPolynomial(coeffs=[40.6586,-0.0116078,1.47444e-05,-2.99898e-09,1.90171e-13,13050.7,-190.418], Tmin=(911.889,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(217.571,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(448.981,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cycloheptene) + radical(CCJCOOH) + radical(Allyl_S)"""),
)

species(
    label = 'OOC1C[CH]C[C]=CC1(879)',
    structure = SMILES('OOC1C[CH]C[C]=CC1'),
    E0 = (308.344,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,2750,2800,2850,2900,2950,3000,3050,3100,3150,900,925,950,975,1000,1025,1050,1075,1100,300,800,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (126.153,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.587982,0.0283812,0.000158047,-2.57268e-07,1.10549e-10,37251.6,33.8602], Tmin=(100,'K'), Tmax=(910.479,'K')), NASAPolynomial(coeffs=[35.7209,-0.00405118,1.06229e-05,-2.25131e-09,1.43472e-13,25800.8,-160.092], Tmin=(910.479,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(308.344,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(448.981,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cycloheptene) + radical(Cds_S) + radical(RCCJCC)"""),
)

species(
    label = 'OO[C]1CC=C[CH]CC1(880)',
    structure = SMILES('OO[C]1CC=C[CH]CC1'),
    E0 = (204.055,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,2750,2800,2850,2900,2950,3000,3050,3100,3150,900,925,950,975,1000,1025,1050,1075,1100,300,800,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (126.153,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.673349,0.020948,0.000189451,-2.94788e-07,1.24757e-10,24710.7,30.3963], Tmin=(100,'K'), Tmax=(913.281,'K')), NASAPolynomial(coeffs=[38.0828,-0.00702371,1.22274e-05,-2.51614e-09,1.5777e-13,12211.1,-177.712], Tmin=(913.281,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(204.055,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(448.981,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cycloheptene) + radical(Allyl_S) + radical(C2CsJOOH)"""),
)

species(
    label = 'OOC1C[C]=CC[CH]C1(881)',
    structure = SMILES('OOC1C[C]=CC[CH]C1'),
    E0 = (308.344,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,2750,2800,2850,2900,2950,3000,3050,3100,3150,900,925,950,975,1000,1025,1050,1075,1100,300,800,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'OO[C]1C[CH]CC=CC1(882)',
    structure = SMILES('OO[C]1C[CH]CC=CC1'),
    E0 = (257.401,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,2900,2950,3000,3050,3100,3150,900,925,950,975,1000,1025,1050,1075,1100,3615,1310,387.5,850,1000,300,800,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    ...
    molecularWeight = (126.153,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.754535,0.0263397,0.000157668,-2.51661e-07,1.07148e-10,31117.1,33.7756], Tmin=(100,'K'), Tmax=(912.582,'K')), NASAPolynomial(coeffs=[33.5964,-0.000279069,8.56292e-06,-1.84728e-09,1.15607e-13,20237.1,-148.432], Tmin=(912.582,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(257.401,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(448.981,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cycloheptene) + radical(RCCJCC) + radical(C2CsJOOH)"""),
)

species(
    label = 'OOC1C[C]=C[CH]CC1(883)',
    structure = SMILES('OOC1C[C]=C[CH]CC1'),
    E0 = (254.998,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,2750,2800,2850,2900,2950,3000,3050,3100,3150,900,925,950,975,1000,1025,1050,1075,1100,300,800,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (126.153,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.507022,0.0229867,0.000189839,-3.00405e-07,1.28162e-10,30845.3,30.4801], Tmin=(100,'K'), Tmax=(911.42,'K')), NASAPolynomial(coeffs=[40.206,-0.0107936,1.42861e-05,-2.91987e-09,1.85609e-13,17775.3,-189.364], Tmin=(911.42,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(254.998,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(448.981,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cycloheptene) + radical(Cds_S) + radical(Allyl_S)"""),
)

species(
    label = 'OOC1[CH][CH]C=CCC1(367)',
    ...
    molecularWeight = (126.153,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.316833,0.0223952,0.000206724,-3.25699e-07,1.38718e-10,16312.6,27.8883], Tmin=(100,'K'), Tmax=(912.767,'K')), NASAPolynomial(coeffs=[43.543,-0.014343,1.61719e-05,-3.25266e-09,2.05637e-13,2060.83,-211.55], Tmin=(912.767,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(134.073,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(448.981,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cycloheptene) + radical(C=CCJCO) + radical(Allyl_S)"""),
)

species(
    label = 'OOC1[CH]C=CC[CH]C1(884)',
    ...
    molecularWeight = (126.153,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.397947,0.0277878,0.000174938,-2.82568e-07,1.21107e-10,22719,31.2679], Tmin=(100,'K'), Tmax=(912.089,'K')), NASAPolynomial(coeffs=[39.057,-0.00759896,1.25078e-05,-2.58388e-09,1.63481e-13,10086.7,-182.272], Tmin=(912.089,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(187.418,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(448.981,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cycloheptene) + radical(C=CCJCO) + radical(RCCJCC)"""),
)

species(
    label = '[O]OC1C[CH]C=CCC1(371)',
    structure = SMILES('[O]OC1C[CH]C=CCC1'),
    E0 = (169.161,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (126.153,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.816601,0.0146389,0.000210515,-3.21234e-07,1.35802e-10,20511.8,29.6546], Tmin=(100,'K'), Tmax=(908.969,'K')), NASAPolynomial(coeffs=[39.6423,-0.0116673,1.53867e-05,-3.16939e-09,2.03698e-13,7482.02,-186.799], Tmin=(908.969,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(169.161,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cycloheptene) + radical(Allyl_S) + radical(ROOJ)"""),
)

species(
    label = '[O]OC1C[CH]CC=CC1(715)',
    ...
    molecularWeight = (126.153,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.898643,0.0200194,0.000178777,-2.78176e-07,1.18227e-10,26918.1,33.0309], Tmin=(100,'K'), Tmax=(907.656,'K')), NASAPolynomial(coeffs=[35.1554,-0.00492182,1.17216e-05,-2.50038e-09,1.61523e-13,15508.2,-157.517], Tmin=(907.656,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(222.506,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cycloheptene) + radical(ROOJ) + radical(RCCJCC)"""),
)

species(
    label = 'OOC1CC=[C][CH]CC1(885)',
    structure = SMILES('OOC1CC=[C][CH]CC1'),
    E0 = (254.998,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,2900,2950,3000,3050,3100,3150,900,925,950,975,1000,1025,1050,1075,1100,3615,1310,387.5,850,1000,300,800,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'OOC1[CH][CH]CC=CC1(886)',
    structure = SMILES('OOC1[CH][CH]CC=CC1'),
    E0 = (270.917,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,2900,2950,3000,3050,3100,3150,900,925,950,975,1000,1025,1050,1075,1100,3615,1310,387.5,850,1000,300,800,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (126.153,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.641575,0.02586,0.00016676,-2.67187e-07,1.14246e-10,32749.5,35.4992], Tmin=(100,'K'), Tmax=(911.049,'K')), NASAPolynomial(coeffs=[36.1737,-0.00486594,1.10815e-05,-2.3305e-09,1.48041e-13,21076.1,-161.147], Tmin=(911.049,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(270.917,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(448.981,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cycloheptene) + radical(RCCJCC) + radical(CCJCOOH)"""),
)

species(
    label = 'OOC1C=CC=CCC1(370)',
    ...
    molecularWeight = (126.153,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.644225,0.0866959,-5.01429e-05,-1.28846e-09,7.44583e-12,-3241.29,16.8886], Tmin=(100,'K'), Tmax=(1037.68,'K')), NASAPolynomial(coeffs=[21.8141,0.0302724,-1.21602e-05,2.30707e-09,-1.65719e-13,-9525.31,-100.111], Tmin=(1037.68,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-28.4513,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(448.981,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + ring(1,3-Cycloheptadiene)"""),
)

species(
    label = '[CH]=CCC(CC=[CH])OO(887)',
    structure = SMILES('[CH]=CCC(CC=[CH])OO'),
    E0 = (433.147,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,3115,3125,620,680,785,800,1600,1700,3615,1310,387.5,850,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,200,800],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (126.153,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.331984,0.0959871,-9.14989e-05,4.6362e-08,-9.62995e-12,52250.9,36.073], Tmin=(100,'K'), Tmax=(1143.88,'K')), NASAPolynomial(coeffs=[15.7469,0.039761,-1.77676e-05,3.39019e-09,-2.38209e-13,48572.5,-43.6596], Tmin=(1143.88,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(433.147,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cds_P) + radical(Cds_P)"""),
)

species(
    label = '[CH]=CC=CCC([CH2])OO(888)',
    structure = SMILES('[CH]=CC=CCC([CH2])OO'),
    E0 = (371.563,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2995,3010,3025,975,987.5,1000,1300,1337.5,1375,400,450,500,1630,1655,1680,3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,3120,650,792.5,1650,2750,2850,1437.5,1250,1305,750,350,200,800],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (126.153,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.875573,0.100733,-9.76077e-05,4.84268e-08,-9.55078e-12,44869.7,37.9783], Tmin=(100,'K'), Tmax=(1226.8,'K')), NASAPolynomial(coeffs=[20.3909,0.0313939,-1.28284e-05,2.35664e-09,-1.62613e-13,39651.7,-68.9676], Tmin=(1226.8,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(371.563,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + radical(CJCOOH) + radical(Cds_P)"""),
)

species(
    label = '[CH2]C=CC=CC[CH]OO(889)',
    structure = SMILES('[CH2]C=CC=CC[CH]OO'),
    E0 = (217.54,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2995,3005,3015,3025,975,983.333,991.667,1000,1300,1325,1350,1375,400,433.333,466.667,500,1630,1646.67,1663.33,1680,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,3615,1310,387.5,850,1000,2750,2850,1437.5,1250,1305,750,350,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (126.153,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.398954,0.0906639,-7.66005e-05,3.39796e-08,-6.13056e-12,26327.4,35.4832], Tmin=(100,'K'), Tmax=(1314.35,'K')), NASAPolynomial(coeffs=[17.3416,0.0366743,-1.49856e-05,2.72759e-09,-1.86232e-13,21663.9,-54.954], Tmin=(1314.35,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(217.54,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + radical(C=CC=CCJ) + radical(CCsJOOH)"""),
)

species(
    label = 'OOC1C[C]CC=CC1(890)',
    structure = SMILES('OOC1C[C]CC=CC1'),
    E0 = (307.757,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,2900,2950,3000,3050,3100,3150,900,925,950,975,1000,1025,1050,1075,1100,3615,1310,387.5,850,1000,300,800,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
    ...
    molecularWeight = (126.153,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.18243,0.0356509,0.000151747,-2.56871e-07,1.11485e-10,37197.2,41.0591], Tmin=(100,'K'), Tmax=(912.125,'K')), NASAPolynomial(coeffs=[38.19,-0.00486463,1.09015e-05,-2.28589e-09,1.44557e-13,25015.5,-167.578], Tmin=(912.125,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(307.757,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(448.981,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(CsJ2_singlet-CsH) + ring(Cycloheptane)"""),
)

species(
    label = 'OOC1CC=C[C]CC1(891)',
    structure = SMILES('OOC1CC=C[C]CC1'),
    E0 = (307.757,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,2900,2950,3000,3050,3100,3150,900,925,950,975,1000,1025,1050,1075,1100,3615,1310,387.5,850,1000,300,800,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
...
species(
    label = 'OOC1CC2C=CC2C1(892)',
    structure = SMILES('OOC1CC2C=CC2C1'),
    E0 = (52.7609,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (126.153,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.763564,0.0515374,3.27076e-05,-7.39882e-08,2.99472e-11,6479.39,23.973], Tmin=(100,'K'), Tmax=(1014.25,'K')), NASAPolynomial(coeffs=[16.248,0.0372073,-1.52201e-05,2.94766e-09,-2.1523e-13,934.418,-62.8004], Tmin=(1014.25,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(52.7609,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(448.981,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + Estimated bicyclic component: polycyclic(s2_4_5_ane) - ring(Cyclopentane) - ring(Cyclobutane) + ring(Cyclopentane) + ring(Cyclobutene)"""),
)
...
reaction(
    label = 'reaction5',
    reactants = ['H(19)', 'OOC1C=CC=C[CH]C1(203)'],
    products = ['C7H10O2(12)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['H(19)', 'OOC1C[C]=CC=CC1(220)'],
    products = ['C7H10O2(12)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(19)', 'OOC1CC=[C]C=CC1(221)'],
    products = ['C7H10O2(12)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['OOC1[CH]C[CH]C=CC1(878)'],
    products = ['C7H10O2(12)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['OOC1C[CH]C[C]=CC1(879)'],
    products = ['C7H10O2(12)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['OO[C]1CC=C[CH]CC1(880)'],
    products = ['C7H10O2(12)'],
...
reaction(
    label = 'reaction11',
    reactants = ['OOC1C[C]=CC[CH]C1(881)'],
    products = ['C7H10O2(12)'],
...
reaction(
    label = 'reaction12',
    reactants = ['OO[C]1C[CH]CC=CC1(882)'],
    products = ['C7H10O2(12)'],
...
reaction(
    label = 'reaction13',
    reactants = ['OOC1C[C]=C[CH]CC1(883)'],
    products = ['C7H10O2(12)'],
...
reaction(
    label = 'reaction14',
    reactants = ['OOC1[CH][CH]C=CCC1(367)'],
    products = ['C7H10O2(12)'],
...
reaction(
    label = 'reaction15',
    reactants = ['OOC1[CH]C=CC[CH]C1(884)'],
    products = ['C7H10O2(12)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[O]OC1C[CH]C=CCC1(371)'],
    products = ['C7H10O2(12)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[O]OC1C[CH]CC=CC1(715)'],
    products = ['C7H10O2(12)'],
...
reaction(
    label = 'reaction19',
    reactants = ['OOC1[CH][CH]CC=CC1(886)'],
    products = ['C7H10O2(12)'],
...
reaction(
    label = 'reaction20',
    reactants = ['C7H10O2(12)'],
    products = ['OOC1C=CC=CCC1(370)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH]=CC=CCC([CH2])OO(888)'],
    products = ['C7H10O2(12)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH2]C=CC=CC[CH]OO(889)'],
    products = ['C7H10O2(12)'],
    transitionState = 'TS23',
    kinetics = Arrhenius(A=(2e+12,'s^-1'), n=0, Ea=(7.5312,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Rn;C_rad_out_1H;Cpri_rad_out_2H] for rate rule [R7;C_rad_out_H/NonDeO;Cpri_rad_out_2H]
Euclidian distance = 1.41421356237
family: Birad_recombination"""),
)
