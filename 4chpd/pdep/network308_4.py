...
species(
    label = 'O=CCC1C=CCC1(2066)',
    structure = SMILES('O=CCC1C=CCC1'),
    E0 = (-116.335,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2782.5,750,1395,475,1775,1000,2750,2816.67,2883.33,2950,3016.67,3083.33,3150,900,933.333,966.667,1000,1033.33,1066.67,1100,2750,2850,1437.5,1250,1305,750,350,300,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
...
species(
    label = 'O=CC[C]1C[CH]CC1(2069)',
    structure = SMILES('O=CC[C]1C[CH]CC1'),
    E0 = (140.229,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2782.5,750,1395,475,1775,1000,2750,2816.67,2883.33,2950,3016.67,3083.33,3150,900,933.333,966.667,1000,1033.33,1066.67,1100,2750,2850,1437.5,1250,1305,750,350,301.329,813.028,813.028,813.028,813.028,813.028,813.028,813.028,813.028,813.028,1619.92,1619.92,1619.92,1619.92,1619.92,1619.92,1619.92,1619.92,1619.92],'cm^-1')),
...
species(
    label = 'O=CCC1[CH]C[CH]C1(2070)',
    structure = SMILES('O=CCC1[CH]C[CH]C1'),
    E0 = (149.348,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2816.67,2883.33,2950,3016.67,3083.33,3150,900,933.333,966.667,1000,1033.33,1066.67,1100,2750,2850,1437.5,1250,1305,750,350,2782.5,750,1395,475,1775,1000,300,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
...
species(
    ...
    molecularWeight = (110.154,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.67419,0.0413901,1.72102e-05,-3.6335e-08,1.27036e-11,18054.2,31.3286], Tmin=(100,'K'), Tmax=(1127.54,'K')), NASAPolynomial(coeffs=[7.34775,0.0448548,-1.87838e-05,3.50322e-09,-2.437e-13,15275,-3.37435], Tmin=(1127.54,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(149.348,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(424.038,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cds-OdCsH) + ring(Cyclopentane) + radical(Cs_S) + radical(cyclopentane)"""),
)

species(
    label = 'O=CCC1C[CH][CH]C1(2072)',
    structure = SMILES('O=CCC1C[CH][CH]C1'),
    E0 = (140.687,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2782.5,750,1395,475,1775,1000,2750,2816.67,2883.33,2950,3016.67,3083.33,3150,900,933.333,966.667,1000,1033.33,1066.67,1100,2750,2850,1437.5,1250,1305,750,350,302.471,823.364,823.364,823.364,823.364,823.364,823.364,823.364,823.364,823.364,1621.87,1621.87,1621.87,1621.87,1621.87,1621.87,1621.87,1621.87,1621.87],'cm^-1')),
...
species(
    ...
    molecularWeight = (82.1436,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.52526,0.0166841,7.73344e-05,-1.03883e-07,3.91836e-11,32116,23.212], Tmin=(100,'K'), Tmax=(952.212,'K')), NASAPolynomial(coeffs=[8.12811,0.0329811,-1.10864e-05,1.95382e-09,-1.37686e-13,29243.2,-13.0266], Tmin=(952.212,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(266.468,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(378.308,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cyclopentane) + radical(cyclopentane) + radical(Isobutyl)"""),
)

species(
    label = 'O=[C]CC1C[CH]CC1(2074)',
    structure = SMILES('O=[C]CC1C[CH]CC1'),
    E0 = (114.766,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1855,455,950,2750,2807.14,2864.29,2921.43,2978.57,3035.71,3092.86,3150,900,928.571,957.143,985.714,1014.29,1042.86,1071.43,1100,2750,2850,1437.5,1250,1305,750,350,300,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
...
species(
    label = '[CH2]C(CC=C)CC=O(2076)',
    structure = SMILES('[CH2]C(CC=C)CC=O'),
    E0 = (25.3789,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,2782.5,750,1395,475,1775,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'C=CCC[CH]CC=O(2077)',
    structure = SMILES('C=CCC[CH]CC=O'),
    E0 = (29.2402,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2782.5,750,1395,475,1775,1000,3025,407.5,1350,352.5,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2950,3100,1380,975,1025,1650,3010,987.5,1337.5,450,1655,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'CC1C[CH]CC1(2078)',
    structure = SMILES('CC1C[CH]CC1'),
    E0 = (61.3855,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2807.14,2864.29,2921.43,2978.57,3035.71,3092.86,3150,900,928.571,957.143,985.714,1014.29,1042.86,1071.43,1100,300,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
species(
    label = '[CH2]C1CCC1CC=O(2079)',
    structure = SMILES('[CH2]C1CCC1CC=O'),
    E0 = (46.7322,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2782.5,750,1395,475,1775,1000,3000,3100,440,815,1455,1000,2750,2830,2910,2990,3070,3150,900,940,980,1020,1060,1100,2750,2850,1437.5,1250,1305,750,350,300,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
...
species(
    label = 'C=COC1C[CH]CC1(2081)',
    structure = SMILES('C=COC1C[CH]CC1'),
    E0 = (-7.19912,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3010,987.5,1337.5,450,1655,2750,2807.14,2864.29,2921.43,2978.57,3035.71,3092.86,3150,900,928.571,957.143,985.714,1014.29,1042.86,1071.43,1100,2950,3100,1380,975,1025,1650,300,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
...
reaction(
    label = 'reaction68',
    reactants = ['H(19)', 'O=CCC1C=CCC1(2066)'],
    products = ['O=CCC1C[CH]CC1(1960)'],
...
reaction(
    label = 'reaction69',
    reactants = ['H(19)', 'O=CCC1CC=CC1(2067)'],
    products = ['O=CCC1C[CH]CC1(1960)'],
...
reaction(
    label = 'reaction73',
    reactants = ['CH2CHO(51)', '[CH]1C[CH]CC1(2068)'],
    products = ['O=CCC1C[CH]CC1(1960)'],
...
reaction(
    label = 'reaction74',
    reactants = ['H(19)', 'O=CC[C]1C[CH]CC1(2069)'],
    products = ['O=CCC1C[CH]CC1(1960)'],
...
reaction(
    label = 'reaction75',
    reactants = ['H(19)', 'O=CCC1[CH]C[CH]C1(2070)'],
    products = ['O=CCC1C[CH]CC1(1960)'],
...
reaction(
    label = 'reaction76',
    reactants = ['H(19)', 'O=CCC1[CH][CH]CC1(2071)'],
    products = ['O=CCC1C[CH]CC1(1960)'],
...
reaction(
    label = 'reaction77',
    reactants = ['H(19)', 'O=CCC1C[CH][CH]C1(2072)'],
    products = ['O=CCC1C[CH]CC1(1960)'],
...
reaction(
    label = 'reaction78',
    reactants = ['HCO(30)', '[CH2]C1C[CH]CC1(2073)'],
    products = ['O=CCC1C[CH]CC1(1960)'],
...
reaction(
    label = 'reaction80',
    reactants = ['H(19)', 'O=[C]CC1C[CH]CC1(2074)'],
    products = ['O=CCC1C[CH]CC1(1960)'],
...
reaction(
    label = 'reaction81',
    reactants = ['O=CCC1C[CH]CC1(1960)'],
    products = ['[CH]1CC2CCC(C2)O1(2075)'],
...
reaction(
    label = 'reaction82',
    reactants = ['[CH2]C(CC=C)CC=O(2076)'],
    products = ['O=CCC1C[CH]CC1(1960)'],
...
reaction(
    label = 'reaction84',
    reactants = ['CO(28)', 'CC1C[CH]CC1(2078)'],
    products = ['O=CCC1C[CH]CC1(1960)'],
...
reaction(
    label = 'reaction86',
    reactants = ['[CH2]C1CC(CC=O)C1(2080)'],
    products = ['O=CCC1C[CH]CC1(1960)'],
...
reaction(
    label = 'reaction89',
    reactants = ['H(19)', 'O=CCC1C[C]CC1(2082)'],
    products = ['O=CCC1C[CH]CC1(1960)'],
