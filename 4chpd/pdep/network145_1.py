...
reaction(
    label = 'reaction1',
    reactants = ['O2(2)', 'OH(21)'],
    products = ['[O]OO(775)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(6.10333e+07,'m^3/(mol*s)'), n=0.045, Ea=(20.7891,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Y_rad;O_pri_rad] for rate rule [O2_birad;O_pri_rad]
