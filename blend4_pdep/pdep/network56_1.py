...
species(
    label = '[CH]1C[C]2C=CC(C1)O2(1706)',
    ...
    molecularWeight = (108.138,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.04211,0.0304548,3.95351e-05,-5.90359e-08,2.04581e-11,36196.7,21.8986], Tmin=(100,'K'), Tmax=(1085.61,'K')), NASAPolynomial(coeffs=[8.4508,0.0392291,-1.73388e-05,3.37101e-09,-2.4173e-13,32896.7,-18.3361], Tmin=(1085.61,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(300.283,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + polycyclic(s3_5_6_ene_5) + radical(RCCJCC) + radical(C2CsJOCs)"""),
)

species(
    label = '[CH]1C[CH]C2C=CC1O2(1707)',
...
species(
    ...
    molecularWeight = (108.138,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.96492,0.0251005,7.02848e-05,-1.01239e-07,3.76205e-11,36860.9,22.1011], Tmin=(100,'K'), Tmax=(1007.89,'K')), NASAPolynomial(coeffs=[12.6709,0.0319539,-1.33488e-05,2.65308e-09,-1.97557e-13,32196.7,-42.0658], Tmin=(1007.89,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(305.726,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + polycyclic(s3_5_6_ene_5) + radical(CCJCO) + radical(C2CsJOCs)"""),
)

species(
    label = '[C]1=CC2CC[CH]C1O2(1712)',
...
species(
    label = '[C]1=CC2[CH]CC(C1)O2(1717)',
...
species(
    label = '[C]1=CC2C[CH]C(C1)O2(1718)',
...
species(
    ...
    molecularWeight = (108.138,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.324,0.0298694,9.25688e-05,-1.53831e-07,6.48884e-11,36332.9,21.9285], Tmin=(100,'K'), Tmax=(926.692,'K')), NASAPolynomial(coeffs=[22.4692,0.0130624,-7.59407e-07,2.17421e-11,-1.04919e-14,29216.5,-95.7265], Tmin=(926.692,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(301.065,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(378.308,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + ring(3,4-Dihydro-2H-pyran) + radical(Cds_P) + radical(Allyl_S)"""),
)

species(
    label = '[CH]=CC1C=CC[CH]O1(1722)',
...
species(
    label = '[CH]=CC1C=CC([CH2])O1(1724)',
    structure = SMILES('[CH]=CC1C=CC([CH2])O1'),
    E0 = (393.633,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,3120,650,792.5,1650,2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,3010,987.5,1337.5,450,1655,300,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
...
species(
    label = '[CH]1C2[CH]C3C1CC3O2(1730)',
...
species(
    label = '[CH]1C2CC3[CH]C2C1O3(1732)',
    ...
    molecularWeight = (108.138,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.33981,0.0235246,5.87084e-05,-7.31328e-08,2.27067e-11,48242.5,14.7491], Tmin=(100,'K'), Tmax=(1192.49,'K')), NASAPolynomial(coeffs=[9.85122,0.0437526,-2.38732e-05,4.97772e-09,-3.65516e-13,43221.3,-36.3533], Tmin=(1192.49,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(400.528,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + polycyclic(s3_5_5_ane) + polycyclic(s2_4_5_ane) + polycyclic(s2_4_5_ane) - ring(Cyclobutane) - ring(Cyclopentane) - ring(Tetrahydrofuran) + radical(CCJCO) + radical(CCJCO)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['H(3)(3)', 'C1=CC2C=C[C](C1)O2(1697)'],
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)(3)', 'C1=C[C]2C=CC(C1)O2(1698)'],
    products = ['C7H8O(552)(551)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)(3)', '[CH]1C=CC2C=CC1O2(1699)'],
    products = ['C7H8O(552)(551)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)(3)', '[C]1=CC2C=CCC1O2(1700)'],
    products = ['C7H8O(552)(551)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)(3)', '[C]1=CC2CC=CC1O2(1701)'],
    products = ['C7H8O(552)(551)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(1e+13,'cm^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""From training reaction 40 used for Cd_rad/NonDe;H_rad
Exact match found for rate rule [Cd_rad/NonDe;H_rad]
...
reaction(
    label = 'reaction6',
    reactants = ['H(3)(3)', '[C]1=CCC2C=CC1O2(1702)'],
    products = ['C7H8O(552)(551)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(1e+13,'cm^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""From training reaction 40 used for Cd_rad/NonDe;H_rad
Exact match found for rate rule [Cd_rad/NonDe;H_rad]
...
reaction(
    label = 'reaction7',
    reactants = ['H(3)(3)', '[C]1=CC2C=CC(C1)O2(1703)'],
    products = ['C7H8O(552)(551)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(1e+13,'cm^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""From training reaction 40 used for Cd_rad/NonDe;H_rad
...
reaction(
    label = 'reaction10',
    reactants = ['[CH]1C[C]2C=CC(C1)O2(1706)'],
    products = ['C7H8O(552)(551)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH]1C[CH]C2C=CC1O2(1707)'],
    products = ['C7H8O(552)(551)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH]1CC2[CH]C=CC1O2(1708)'],
    products = ['C7H8O(552)(551)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[C]1=CC2C[CH]CC1O2(1709)'],
    products = ['C7H8O(552)(551)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[C]1=CCC2[CH]CC1O2(1710)'],
    products = ['C7H8O(552)(551)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH]1CC[C]2C=CC1O2(1711)'],
    products = ['C7H8O(552)(551)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[C]1=CC2CC[CH]C1O2(1712)'],
    products = ['C7H8O(552)(551)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[C]1=CCC2C[CH]C1O2(1713)'],
    products = ['C7H8O(552)(551)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH]1CC2CC=C[C]1O2(1714)'],
    products = ['C7H8O(552)(551)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH]1CC2C=CC[C]1O2(1715)'],
    products = ['C7H8O(552)(551)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[C]1=CC2[CH]CCC1O2(1716)'],
    products = ['C7H8O(552)(551)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[C]1=CC2[CH]CC(C1)O2(1717)'],
    products = ['C7H8O(552)(551)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[C]1=CC2C[CH]C(C1)O2(1718)'],
    products = ['C7H8O(552)(551)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH]1[CH]C2C=CC(C1)O2(1719)'],
    products = ['C7H8O(552)(551)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[CH]1CCC2C=C[C]1O2(1720)'],
    products = ['C7H8O(552)(551)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[CH]=CC1CC=C[CH]O1(1721)'],
    products = ['C7H8O(552)(551)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[CH]=CC1C=CC[CH]O1(1722)'],
    products = ['C7H8O(552)(551)'],
...
reaction(
    label = 'reaction29',
    reactants = ['[CH]=CC1C=CC([CH2])O1(1724)'],
    products = ['C7H8O(552)(551)'],
...
reaction(
    label = 'reaction35',
    reactants = ['[C]1CC2C=CC(C1)O2(1729)'],
    products = ['C7H8O(552)(551)'],
...
reaction(
    label = 'reaction36',
    reactants = ['[CH]1C2[CH]C3C1CC3O2(1730)'],
    products = ['C7H8O(552)(551)'],
...
reaction(
    label = 'reaction38',
    reactants = ['[CH]1C2CC3[CH]C2C1O3(1732)'],
    products = ['C7H8O(552)(551)'],
