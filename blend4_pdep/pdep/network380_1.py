species(
    ...
    E0 = (-159.607,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,440,435,1725,2782.5,750,1395,475,1775,1000,492.5,1135,1000,3010,987.5,1337.5,450,1655,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,335.033,337.282],'cm^-1')),
        HinderedRotor(inertia=(0.104624,'amu*angstrom^2'), symmetry=1, barrier=(8.42144,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.104604,'amu*angstrom^2'), symmetry=1, barrier=(8.45012,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.106477,'amu*angstrom^2'), symmetry=1, barrier=(8.45529,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.106387,'amu*angstrom^2'), symmetry=1, barrier=(8.46364,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
species(
    ...
    E0 = (-140.03,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2120,512.5,787.5,492.5,1135,1000,1380,1390,370,380,2900,435,2782.5,750,1395,475,1775,1000,3010,987.5,1337.5,450,1655,180],'cm^-1')),
        HinderedRotor(inertia=(0.571044,'amu*angstrom^2'), symmetry=1, barrier=(13.1294,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.569606,'amu*angstrom^2'), symmetry=1, barrier=(13.0964,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.570684,'amu*angstrom^2'), symmetry=1, barrier=(13.1211,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
species(
    ...
    E0 = (-114.158,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,1380,1390,370,380,2900,435,2782.5,750,1395,475,1775,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,257.399,257.558],'cm^-1')),
        HinderedRotor(inertia=(0.391111,'amu*angstrom^2'), symmetry=1, barrier=(18.4084,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.391187,'amu*angstrom^2'), symmetry=1, barrier=(18.4086,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.390987,'amu*angstrom^2'), symmetry=1, barrier=(18.4072,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
species(
    ...
    molecularWeight = (130.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.757625,0.0613651,-3.17758e-05,-5.05488e-09,7.15825e-12,-11196.6,27.4024], Tmin=(100,'K'), Tmax=(987.574,'K')), NASAPolynomial(coeffs=[15.1052,0.0247814,-8.90885e-06,1.58239e-09,-1.09807e-13,-15080.3,-46.9522], Tmin=(987.574,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-94.1381,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(349.208,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsOsOsH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + ring(2,3-Dihydrofuran) + radical(ROOJ) + radical(CCOJ)"""),
)

species(
    label = 'CC([O])=C[C](C=O)OO(6447)',
...
species(
    label = '[CH2]C(O)=CC(C=O)O[O](6448)',
    structure = SMILES('C=C(O)[CH]C(C=O)O[O]'),
    E0 = (-167.115,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,440,435,1725,2782.5,750,1395,475,1775,1000,492.5,1135,1000,3025,407.5,1350,352.5,3615,1277.5,1000,2950,3100,1380,975,1025,1650,1380,1390,370,380,2900,435,310.066,310.066],'cm^-1')),
        HinderedRotor(inertia=(0.323211,'amu*angstrom^2'), symmetry=1, barrier=(22.0506,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.323212,'amu*angstrom^2'), symmetry=1, barrier=(22.0506,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.323212,'amu*angstrom^2'), symmetry=1, barrier=(22.0506,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.323212,'amu*angstrom^2'), symmetry=1, barrier=(22.0506,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.323211,'amu*angstrom^2'), symmetry=1, barrier=(22.0506,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (130.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.504031,0.0876091,-8.03881e-05,2.92049e-08,-1.78312e-12,-19927,34.1116], Tmin=(100,'K'), Tmax=(1005.37,'K')), NASAPolynomial(coeffs=[22.8344,0.0162364,-5.95224e-06,1.09942e-09,-7.92405e-14,-25705.5,-84.0071], Tmin=(1005.37,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-167.115,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-(Cds-Cd)H) + group(O2s-OsH) + group(Cs-(Cds-O2d)CsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsOs) + group(Cds-OdCsH) + group(Cds-CdsHH) + radical(C=CCJCO) + radical(ROOJ)"""),
)

species(
    label = 'CC(O)=[C]C(C=O)O[O](6449)',
    structure = SMILES('CC(O)=[C]C(C=O)O[O]'),
    E0 = (-59.5702,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,440,435,1725,2782.5,750,1395,475,1775,1000,492.5,1135,1000,3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,1380,1390,370,380,2900,435,1685,370,272.097],'cm^-1')),
        HinderedRotor(inertia=(0.229557,'amu*angstrom^2'), symmetry=1, barrier=(12.0605,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.229557,'amu*angstrom^2'), symmetry=1, barrier=(12.0605,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.229557,'amu*angstrom^2'), symmetry=1, barrier=(12.0605,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.229557,'amu*angstrom^2'), symmetry=1, barrier=(12.0605,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.229557,'amu*angstrom^2'), symmetry=1, barrier=(12.0605,'kJ/mol'), semiclassical=False),
...
species(
    label = 'CC([O])=CC([C]=O)OO(6451)',
    structure = SMILES('CC([O])=CC([C]=O)OO'),
    E0 = (-151.651,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,440,435,1725,1855,455,950,3010,987.5,1337.5,450,1655,3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,305.264,305.269],'cm^-1')),
        HinderedRotor(inertia=(0.217605,'amu*angstrom^2'), symmetry=1, barrier=(14.3897,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00180905,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.217604,'amu*angstrom^2'), symmetry=1, barrier=(14.3897,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.217602,'amu*angstrom^2'), symmetry=1, barrier=(14.3897,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.217604,'amu*angstrom^2'), symmetry=1, barrier=(14.3897,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.740943,'amu*angstrom^2'), symmetry=1, barrier=(17.0357,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.740609,'amu*angstrom^2'), symmetry=1, barrier=(17.0281,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.740876,'amu*angstrom^2'), symmetry=1, barrier=(17.0342,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.741674,'amu*angstrom^2'), symmetry=1, barrier=(17.0525,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (130.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.72344,0.0952341,-0.000101556,4.50647e-08,-4.91741e-12,-19232.2,32.1266], Tmin=(100,'K'), Tmax=(924.567,'K')), NASAPolynomial(coeffs=[23.8772,0.0115427,-2.66937e-06,3.63273e-10,-2.33172e-14,-24753.1,-89.8841], Tmin=(924.567,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-161.386,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(O2s-OsH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-Cds(Cds-Cds)O2s) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsOsH) + radical(ROOJ) + radical(C=COJ)"""),
)

species(
    label = 'CC(O)=CC([C]=O)O[O](6453)',
    structure = SMILES('CC(O)=CC([C]=O)O[O]'),
    E0 = (-137.451,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,440,435,1725,1855,455,950,492.5,1135,1000,3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,1380,1390,370,380,2900,435,3010,987.5,1337.5,450,1655,212.12],'cm^-1')),
        HinderedRotor(inertia=(0.378336,'amu*angstrom^2'), symmetry=1, barrier=(12.0734,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.383284,'amu*angstrom^2'), symmetry=1, barrier=(12.0712,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.379391,'amu*angstrom^2'), symmetry=1, barrier=(12.0773,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.382452,'amu*angstrom^2'), symmetry=1, barrier=(12.0783,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.383406,'amu*angstrom^2'), symmetry=1, barrier=(12.0721,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (130.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.238736,0.0889286,-0.000100907,5.72133e-08,-1.26347e-11,-16375.2,35.6735], Tmin=(100,'K'), Tmax=(1113,'K')), NASAPolynomial(coeffs=[19.0024,0.019777,-7.70907e-06,1.38839e-09,-9.51725e-14,-20658.2,-59.2132], Tmin=(1113,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-137.451,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-(Cds-Cd)H) + group(O2s-OsH) + group(Cs-(Cds-O2d)CsOsH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + group(Cds-OdCsH) + radical(ROOJ) + radical(CCCJ=O)"""),
)

species(
    label = '[CH2]C([O])=CC(C=O)OO(6454)',
...
species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.613742,'amu*angstrom^2'), symmetry=1, barrier=(14.1111,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.615651,'amu*angstrom^2'), symmetry=1, barrier=(14.155,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.613049,'amu*angstrom^2'), symmetry=1, barrier=(14.0952,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.613102,'amu*angstrom^2'), symmetry=1, barrier=(14.0964,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (130.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.799245,0.0930492,-0.000105173,5.7879e-08,-1.20803e-11,-8868.01,36.2874], Tmin=(100,'K'), Tmax=(1275.04,'K')), NASAPolynomial(coeffs=[22.9596,0.0121297,-2.46619e-06,2.50611e-10,-1.1026e-14,-14407.7,-82.0731], Tmin=(1275.04,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-75.2587,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(O2s-O2s(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(O2s-OsH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + radical(C=C(C)OJ) + radical(ROOJ)"""),
)

species(
    label = 'CC([O])=CC(=CO)O[O](6463)',
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.663098,'amu*angstrom^2'), symmetry=1, barrier=(15.2459,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.663536,'amu*angstrom^2'), symmetry=1, barrier=(15.256,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.663204,'amu*angstrom^2'), symmetry=1, barrier=(15.2484,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.663182,'amu*angstrom^2'), symmetry=1, barrier=(15.2479,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (130.099,'amu'),
...
species(
    label = 'CC([O])=CC([O])C=O(6464)',
    structure = SMILES('CC([O])=CC([O])C=O'),
    E0 = (-139.384,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2782.5,750,1395,475,1775,1000,350,440,435,1725,1380,1390,370,380,2900,435,3010,987.5,1337.5,450,1655,2750,2800,2850,1350,1500,750,1050,1375,1000,413.919,413.927,4000],'cm^-1')),
        HinderedRotor(inertia=(0.0870433,'amu*angstrom^2'), symmetry=1, barrier=(10.5851,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0870549,'amu*angstrom^2'), symmetry=1, barrier=(10.5847,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0870356,'amu*angstrom^2'), symmetry=1, barrier=(10.585,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (114.099,'amu'),
...
species(
    ...
    E0 = (154.988,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2782.5,750,1395,475,1775,1000,1685,370,2750,2800,2850,1350,1500,750,1050,1375,1000,1380,1390,370,380,2900,435,3010,987.5,1337.5,450,1655,294.336],'cm^-1')),
        HinderedRotor(inertia=(0.150712,'amu*angstrom^2'), symmetry=1, barrier=(9.3043,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.151263,'amu*angstrom^2'), symmetry=1, barrier=(9.30676,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.151206,'amu*angstrom^2'), symmetry=1, barrier=(9.30579,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.151026,'amu*angstrom^2'), symmetry=1, barrier=(9.30415,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (114.099,'amu'),
...
species(
    label = 'CC(=O)C[C](C=O)O[O](6468)',
    structure = SMILES('CC(=O)CC(=C[O])O[O]'),
    E0 = (-153.399,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,440,435,1725,375,552.5,462.5,1710,492.5,1135,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,392.037,394.16,395.173],'cm^-1')),
        HinderedRotor(inertia=(0.00105814,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.103959,'amu*angstrom^2'), symmetry=1, barrier=(11.6204,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.104407,'amu*angstrom^2'), symmetry=1, barrier=(11.6416,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.105214,'amu*angstrom^2'), symmetry=1, barrier=(11.6225,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (130.099,'amu'),
...
species(
    label = 'CC(=O)CC([C]=O)O[O](6469)',
    structure = SMILES('CC(=O)CC([C]=O)O[O]'),
    E0 = (-151.185,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,375,552.5,462.5,1710,2750,2850,1437.5,1250,1305,750,350,1855,455,950,2750,2800,2850,1350,1500,750,1050,1375,1000,1380,1390,370,380,2900,435,278.814,3222.11],'cm^-1')),
        HinderedRotor(inertia=(0.178826,'amu*angstrom^2'), symmetry=1, barrier=(9.86722,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00217779,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.177016,'amu*angstrom^2'), symmetry=1, barrier=(9.85338,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.294902,'amu*angstrom^2'), symmetry=1, barrier=(16.2458,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.17907,'amu*angstrom^2'), symmetry=1, barrier=(9.88072,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (130.099,'amu'),
...
species(
    label = '[CH2]C(=O)CC(C=O)O[O](6470)',
    structure = SMILES('C=C([O])CC(C=O)O[O]'),
    E0 = (-146.227,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,440,435,1725,2782.5,750,1395,475,1775,1000,492.5,1135,1000,2950,3100,1380,975,1025,1650,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,247.893,247.894,4000],'cm^-1')),
        HinderedRotor(inertia=(0.00274331,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.42766,'amu*angstrom^2'), symmetry=1, barrier=(18.6486,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.427646,'amu*angstrom^2'), symmetry=1, barrier=(18.6485,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.427664,'amu*angstrom^2'), symmetry=1, barrier=(18.6485,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (130.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.140143,0.078948,-7.74204e-05,3.85818e-08,-7.60131e-12,-17443.1,36.1031], Tmin=(100,'K'), Tmax=(1232.44,'K')), NASAPolynomial(coeffs=[17.4104,0.0228956,-9.19921e-06,1.6788e-09,-1.15542e-13,-21700,-50.8255], Tmin=(1232.44,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-146.227,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-(Cds-Cd)H) + group(O2s-OsH) + group(Cs-(Cds-O2d)CsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsOs) + group(Cds-OdCsH) + group(Cds-CdsHH) + radical(ROOJ) + radical(C=C(C)OJ)"""),
)

species(
    label = 'CC(=O)C1O[CH]C1O[O](6471)',
...
species(
    label = 'CC([C]=O)C(C=O)O[O](6474)',
    structure = SMILES('CC([C]=O)C(C=O)O[O]'),
    E0 = (-127.127,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,1855,455,950,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,2782.5,750,1395,475,1775,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,180],'cm^-1')),
        HinderedRotor(inertia=(0.499112,'amu*angstrom^2'), symmetry=1, barrier=(11.4756,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00501187,'amu*angstrom^2'), symmetry=1, barrier=(2.27249,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.498958,'amu*angstrom^2'), symmetry=1, barrier=(11.472,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0252962,'amu*angstrom^2'), symmetry=1, barrier=(11.4759,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.499065,'amu*angstrom^2'), symmetry=1, barrier=(11.4745,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (130.099,'amu'),
...
reaction(
    label = 'reaction4',
    reactants = ['S(260)(259)'],
    products = ['CC1=CC(O[O])C([O])O1(6446)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2]C(O)=CC(C=O)O[O](6448)'],
    products = ['S(260)(259)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['CC(O)=[C]C(C=O)O[O](6449)'],
    products = ['S(260)(259)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction11',
    reactants = ['CC(O)=C[C](C=O)O[O](6452)'],
    products = ['S(260)(259)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CC(O)=CC([C]=O)O[O](6453)'],
    products = ['S(260)(259)'],
...
reaction(
    label = 'reaction13',
    reactants = ['S(260)(259)'],
    products = ['[CH2]C([O])=CC(C=O)OO(6454)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[O]O[CH]C=O(4488)', '[CH]=C(C)[O](4269)'],
    products = ['S(260)(259)'],
...
reaction(
    label = 'reaction16',
    reactants = ['S(260)(259)'],
    products = ['C[C]1OC1C(C=O)O[O](6455)'],
...
reaction(
    label = 'reaction17',
    reactants = ['S(260)(259)'],
    products = ['CC1([O])[CH]C(C=O)OO1(6456)'],
...
reaction(
    label = 'reaction18',
    reactants = ['S(260)(259)'],
    products = ['CC([O])=CC1[CH]OOO1(6457)'],
...
reaction(
    label = 'reaction19',
    reactants = ['S(260)(259)'],
    products = ['CC1=CC([CH]OO1)O[O](6458)'],
...
reaction(
    label = 'reaction21',
    reactants = ['CO(10)(11)', 'CC([O])=CCO[O](6459)'],
    products = ['S(260)(259)'],
...
reaction(
    label = 'reaction22',
    reactants = ['S(260)(259)'],
    products = ['O(4)(4)', 'CC1=CC(C=O)OO1(6460)'],
...
reaction(
    label = 'reaction23',
    reactants = ['S(260)(259)'],
    products = ['HO2(8)(9)', 'CC(=O)[C]=CC=O(6096)'],
...
reaction(
    label = 'reaction24',
    reactants = ['S(260)(259)'],
    products = ['HO2(8)(9)', 'CC(=O)C=C[C]=O(6098)'],
...
reaction(
    label = 'reaction26',
    reactants = ['CC(=O)C=C[CH]OO[O](6363)'],
    products = ['S(260)(259)'],
...
reaction(
    label = 'reaction29',
    reactants = ['O(4)(4)', 'CC([O])=CC([O])C=O(6464)'],
    products = ['S(260)(259)'],
...
reaction(
    label = 'reaction30',
    reactants = ['O(4)(4)', 'C[C]=CC(C=O)O[O](5058)'],
    products = ['S(260)(259)'],
...
reaction(
    label = 'reaction31',
    reactants = ['S(260)(259)'],
    products = ['CC(=O)C1C([O])C1O[O](6465)'],
...
reaction(
    label = 'reaction32',
    reactants = ['H(3)(3)', 'CC(=O)C=C(C=O)O[O](6466)'],
    products = ['S(260)(259)'],
...
reaction(
    label = 'reaction33',
    reactants = ['HCO(14)(15)', 'CC(=O)C=CO[O](6467)'],
    products = ['S(260)(259)'],
...
reaction(
    label = 'reaction34',
    reactants = ['CC(=O)C[C](C=O)O[O](6468)'],
    products = ['S(260)(259)'],
...
reaction(
    label = 'reaction35',
    reactants = ['CC(=O)CC([C]=O)O[O](6469)'],
    products = ['S(260)(259)'],
...
reaction(
    label = 'reaction36',
    reactants = ['[CH2]C(=O)CC(C=O)O[O](6470)'],
    products = ['S(260)(259)'],
...
reaction(
    label = 'reaction37',
    reactants = ['S(260)(259)'],
    products = ['CC(=O)C1O[CH]C1O[O](6471)'],
...
reaction(
    label = 'reaction38',
    reactants = ['S(260)(259)'],
    products = ['C[C]1[CH]C(C=O)OOO1(6472)'],
...
reaction(
    label = 'reaction43',
    reactants = ['CC([C]=O)C(C=O)O[O](6474)'],
    products = ['S(260)(259)'],
