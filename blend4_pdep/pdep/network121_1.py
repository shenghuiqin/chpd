...
species(
    label = 'OC12C=CC=CC1C2(2264)',
    structure = SMILES('OC12C=CC=CC1C2'),
    E0 = (6.18214,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (108.138,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.31933,0.0383756,4.79277e-05,-9.25797e-08,3.8852e-11,858.685,21.4696], Tmin=(100,'K'), Tmax=(959.565,'K')), NASAPolynomial(coeffs=[17.3997,0.02252,-7.28568e-06,1.36032e-09,-1.03155e-13,-4583.4,-67.7217], Tmin=(959.565,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(6.18214,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(378.308,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + polycyclic(s2_3_6_diene_1_3)"""),
)
...
species(
    label = 'OC1[CH]C=CC=[C]C1(2272)',
    structure = SMILES('OC1C=C[CH]C=[C]C1'),
    E0 = (257.108,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2816.67,2883.33,2950,3016.67,3083.33,3150,900,933.333,966.667,1000,1033.33,1066.67,1100,300,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (108.138,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.7924,-0.0159922,0.000282983,-4.02257e-07,1.67528e-10,31063.1,27.675], Tmin=(100,'K'), Tmax=(903.158,'K')), NASAPolynomial(coeffs=[42.8954,-0.0293487,2.50081e-05,-5.03321e-09,3.30444e-13,16758.9,-204.524], Tmin=(903.158,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(257.108,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(378.308,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(1,4-Cycloheptadiene) + radical(C=CCJC=C) + radical(Cds_S)"""),
)
...
species(
    ...
    molecularWeight = (108.138,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.00736757,0.079952,-6.85729e-05,2.57858e-08,-2.14302e-12,30429.5,13.4813], Tmin=(100,'K'), Tmax=(985.875,'K')), NASAPolynomial(coeffs=[17.5031,0.0247092,-8.56485e-06,1.4658e-09,-9.87773e-14,26209,-74.6421], Tmin=(985.875,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(251.746,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(378.308,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + ring(1,3-Cycloheptadiene) + radical(C=CJC=C) + radical(RCCJCC)"""),
)
...
species(
    label = 'OC1=CC[CH]C=[C]C1(2274)',
    structure = SMILES('OC1=CC[CH]C=[C]C1'),
    E0 = (254.744,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2816.67,2883.33,2950,3016.67,3083.33,3150,900,933.333,966.667,1000,1033.33,1066.67,1100,300,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'OC1C=C[C]=C[CH]C1(2252)',
    structure = SMILES('OC1[CH]C=[C]C=CC1'),
    E0 = (216.292,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2816.67,2883.33,2950,3016.67,3083.33,3150,900,933.333,966.667,1000,1033.33,1066.67,1100,300,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (108.138,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.245319,0.0827268,-6.58703e-05,1.95236e-08,3.40224e-13,26176.1,10.5786], Tmin=(100,'K'), Tmax=(1007.67,'K')), NASAPolynomial(coeffs=[19.4969,0.0244122,-8.91504e-06,1.5915e-09,-1.10514e-13,21179.3,-89.869], Tmin=(1007.67,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(216.292,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(378.308,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + ring(1,3-Cycloheptadiene) + radical(C=CJC=C) + radical(C=CCJCO)"""),
)
...
species(
    ...
    molecularWeight = (108.138,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.24531,0.0827267,-6.58699e-05,1.95231e-08,3.40453e-13,26176.1,10.5786], Tmin=(100,'K'), Tmax=(1007.67,'K')), NASAPolynomial(coeffs=[19.4969,0.0244123,-8.91508e-06,1.59151e-09,-1.10515e-13,21179.3,-89.8687], Tmin=(1007.67,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(216.292,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(378.308,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + ring(1,3-Cycloheptadiene) + radical(C=CCJCO) + radical(C=CJC=C)"""),
)
...
species(
    label = 'OC1C=[C]C=C[CH]C1(2253)',
    structure = SMILES('OC1C=[C]C=C[CH]C1'),
    E0 = (240.152,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2816.67,2883.33,2950,3016.67,3083.33,3150,900,933.333,966.667,1000,1033.33,1066.67,1100,300,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (108.138,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.236389,0.0701489,-3.61954e-05,-8.47989e-09,9.7047e-12,29030.3,11.4528], Tmin=(100,'K'), Tmax=(985.647,'K')), NASAPolynomial(coeffs=[18.4011,0.0242611,-8.71277e-06,1.57702e-09,-1.11785e-13,24097.7,-82.7761], Tmin=(985.647,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(240.152,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(378.308,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + ring(1,3-Cycloheptadiene) + radical(Allyl_S) + radical(C=CJC=C)"""),
)
...
species(
    label = 'OC1=C=CC=CCC1(2279)',
    structure = SMILES('OC1=C=CC=CCC1'),
    E0 = (81.1914,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2816.67,2883.33,2950,3016.67,3083.33,3150,900,933.333,966.667,1000,1033.33,1066.67,1100,300,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'OC1C=CC=C=CC1(2280)',
    structure = SMILES('OC1C=CC=C=CC1'),
    E0 = (122.943,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2816.67,2883.33,2950,3016.67,3083.33,3150,900,933.333,966.667,1000,1033.33,1066.67,1100,300,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (108.138,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.20846,0.042197,3.67308e-05,-7.90674e-08,3.33166e-11,14904.4,20.4689], Tmin=(100,'K'), Tmax=(973.944,'K')), NASAPolynomial(coeffs=[16.8695,0.0248538,-8.90857e-06,1.69669e-09,-1.26751e-13,9625.78,-66.1111], Tmin=(973.944,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(122.943,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(378.308,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cdd-CdsCds) + ring(1_2_cycloheptadiene)"""),
)

species(
    label = '[CH]=CC=C(O)CC=[CH](2281)',
    structure = SMILES('[CH]=CC=C(O)CC=[CH]'),
    E0 = (420.155,'kJ/mol'),
    modes = [
        ...
        HinderedRotor(inertia=(0.843832,'amu*angstrom^2'), symmetry=1, barrier=(19.4014,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.844544,'amu*angstrom^2'), symmetry=1, barrier=(19.4177,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.843624,'amu*angstrom^2'), symmetry=1, barrier=(19.3966,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.84452,'amu*angstrom^2'), symmetry=1, barrier=(19.4172,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (108.138,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.200325,0.0782369,-4.95769e-05,-6.67848e-09,1.25356e-11,50697.2,31.3987], Tmin=(100,'K'), Tmax=(938.621,'K')), NASAPolynomial(coeffs=[23.1118,0.0141259,-3.43103e-06,5.40142e-10,-3.9509e-14,44768.9,-87.8602], Tmin=(938.621,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(420.155,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cds_P) + radical(Cds_P)"""),
)

species(
    label = '[CH]=CC=CCC(=[CH])O(2282)',
    structure = SMILES('[CH]=CC=CCC(=[CH])O'),
    E0 = (420.155,'kJ/mol'),
    modes = [
        ...
        HinderedRotor(inertia=(0.84408,'amu*angstrom^2'), symmetry=1, barrier=(19.4071,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.844193,'amu*angstrom^2'), symmetry=1, barrier=(19.4097,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.844071,'amu*angstrom^2'), symmetry=1, barrier=(19.4068,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.844234,'amu*angstrom^2'), symmetry=1, barrier=(19.4106,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (108.138,'amu'),
...
species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.11984,'amu*angstrom^2'), symmetry=1, barrier=(25.7474,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.1209,'amu*angstrom^2'), symmetry=1, barrier=(25.7717,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.12343,'amu*angstrom^2'), symmetry=1, barrier=(25.8298,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (108.138,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.177434,0.0657674,-9.62292e-06,-5.13195e-08,2.96929e-11,31266.1,30.7037], Tmin=(100,'K'), Tmax=(916.173,'K')), NASAPolynomial(coeffs=[23.4421,0.0124256,-1.2558e-06,5.32465e-11,-5.02174e-15,24979,-90.545], Tmin=(916.173,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(258.675,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsOsH) + radical(C=CC=CCJ) + radical(C=CJO)"""),
)

species(
    label = '[CH]=CC=CC=C([CH2])O(2284)',
    structure = SMILES('[CH]C=CC=CC(=C)O'),
    E0 = (266.459,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (108.138,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.329366,0.0799571,-3.98821e-05,-1.84994e-08,1.68269e-11,32217.5,28.3277], Tmin=(100,'K'), Tmax=(935.335,'K')), NASAPolynomial(coeffs=[22.5638,0.0203511,-5.70971e-06,9.20028e-10,-6.42592e-14,26259.7,-89.5435], Tmin=(935.335,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(266.459,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)HHH) + group(Cds-Cds(Cds-Cds)O2s) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + radical(AllylJ2_triplet)"""),
)

species(
    label = 'OC1=CC=CC[C]C1(2237)',
    structure = SMILES('OC1=CC=CC[C]C1'),
    E0 = (292.362,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2816.67,2883.33,2950,3016.67,3083.33,3150,900,933.333,966.667,1000,1033.33,1066.67,1100,300,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
...
species(
    ...
    molecularWeight = (108.138,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.077,0.00725781,0.000215197,-3.31283e-07,1.42025e-10,31841.2,27.4992], Tmin=(100,'K'), Tmax=(901.732,'K')), NASAPolynomial(coeffs=[42.6752,-0.0272262,2.29712e-05,-4.64143e-09,3.06678e-13,18239,-202.71], Tmin=(901.732,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(263.421,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(378.308,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsCsOsH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsCsH) + group(CsJ2_singlet-(Cds-Cds-Cds-Cds)Cs_6_ring) + ring(Cycloheptane)"""),
)

species(
    label = 'OC1=CC=C[C]CC1(2286)',
    structure = SMILES('OC1=CC=C[C]CC1'),
    E0 = (221.333,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2816.67,2883.33,2950,3016.67,3083.33,3150,900,933.333,966.667,1000,1033.33,1066.67,1100,300,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
    ...
    molecularWeight = (108.138,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.800442,0.008435,0.000227201,-3.55702e-07,1.53938e-10,26793.8,26.8855], Tmin=(100,'K'), Tmax=(899.222,'K')), NASAPolynomial(coeffs=[47.4472,-0.0355284,2.77427e-05,-5.5834e-09,3.71378e-13,11792.9,-229.967], Tmin=(899.222,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(221.333,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(378.308,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsCsHH) + group(Cds-CdsCsOs) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsCsH) + group(CsJ2_singlet-(Cds-Cds-Cds-Cds)Cs_6_ring) + ring(Cycloheptane)"""),
)

species(
    label = 'OC1=CC[C]C=CC1(2287)',
    structure = SMILES('OC1=CC[C]C=CC1'),
    E0 = (310.97,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2816.67,2883.33,2950,3016.67,3083.33,3150,900,933.333,966.667,1000,1033.33,1066.67,1100,300,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
...
reaction(
    label = 'reaction567',
    reactants = ['OH(5)(5)', '[C]1=CC=CC=CC1(1244)'],
...
reaction(
    label = 'reaction570',
    reactants = ['H(3)(3)', 'OC1=CC=CC=[C]C1(2265)'],
    products = ['C7H8O(577)(576)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction571',
    reactants = ['H(3)(3)', 'OC1=[C]C=CC=CC1(2266)'],
    products = ['C7H8O(577)(576)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction572',
    reactants = ['H(3)(3)', 'OC1=CC=C[C]=CC1(2267)'],
    products = ['C7H8O(577)(576)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(6.117e+14,'cm^3/(mol*s)'), n=-0.152, Ea=(4.19655,'kJ/mol'), T0=(1,'K'), comment="""From training reaction 49 used for Cd_rad/Cd;H_rad
Exact match found for rate rule [Cd_rad/Cd;H_rad]
...
reaction(
    label = 'reaction573',
    reactants = ['H(3)(3)', 'OC1=CC=[C]C=CC1(2268)'],
    products = ['C7H8O(577)(576)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(6.117e+14,'cm^3/(mol*s)'), n=-0.152, Ea=(4.19655,'kJ/mol'), T0=(1,'K'), comment="""From training reaction 49 used for Cd_rad/Cd;H_rad
Exact match found for rate rule [Cd_rad/Cd;H_rad]
...
reaction(
    label = 'reaction574',
    reactants = ['H(3)(3)', 'OC1=C[C]=CC=CC1(2269)'],
    products = ['C7H8O(577)(576)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(6.117e+14,'cm^3/(mol*s)'), n=-0.152, Ea=(4.19655,'kJ/mol'), T0=(1,'K'), comment="""From training reaction 49 used for Cd_rad/Cd;H_rad
Exact match found for rate rule [Cd_rad/Cd;H_rad]
...
reaction(
    label = 'reaction580',
    reactants = ['OC1=CC=[C]C[CH]C1(2224)'],
    products = ['C7H8O(577)(576)'],
...
reaction(
    label = 'reaction582',
    reactants = ['OC1[CH]C=CC=[C]C1(2272)'],
    products = ['C7H8O(577)(576)'],
...
reaction(
    label = 'reaction584',
    reactants = ['OC1=C[C]=CC[CH]C1(2229)'],
    products = ['C7H8O(577)(576)'],
...
reaction(
    label = 'reaction586',
    reactants = ['OC1=CC[CH]C=[C]C1(2274)'],
    products = ['C7H8O(577)(576)'],
...
reaction(
    label = 'reaction588',
    reactants = ['OC1C=C[C]=C[CH]C1(2252)'],
    products = ['C7H8O(577)(576)'],
...
reaction(
    label = 'reaction592',
    reactants = ['OC1C=CC=[C][CH]C1(2255)'],
    products = ['C7H8O(577)(576)'],
...
reaction(
    label = 'reaction594',
    reactants = ['OC1=[C]C=CC[CH]C1(2222)'],
    products = ['C7H8O(577)(576)'],
...
reaction(
    label = 'reaction598',
    reactants = ['O[C]1[C]=CCC=CC1(2230)'],
    products = ['C7H8O(577)(576)'],
...
reaction(
    label = 'reaction600',
    reactants = ['OC1C=[C]C=C[CH]C1(2253)'],
    products = ['C7H8O(577)(576)'],
...
reaction(
    label = 'reaction605',
    reactants = ['[CH]=CC=C(O)CC=[CH](2281)'],
    products = ['C7H8O(577)(576)'],
...
reaction(
    label = 'reaction607',
    reactants = ['[CH2]C=CC=CC=[C]O(2283)'],
    products = ['C7H8O(577)(576)'],
    transitionState = 'TS43',
    kinetics = Arrhenius(A=(7.38971e+10,'s^-1'), n=0.0476667, Ea=(8.08907,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Rn;C_rad_out_2H;Ypri_rad_out] for rate rule [R7;C_rad_out_2H;CdsinglepriND_rad_out]
...
reaction(
    label = 'reaction608',
    reactants = ['[CH]=CC=CC=C([CH2])O(2284)'],
    products = ['C7H8O(577)(576)'],
...
reaction(
    label = 'reaction617',
    reactants = ['O[C]1C[CH]C2C=CC12(2289)'],
    products = ['C7H8O(577)(576)'],
