species(
    ...
    E0 = (-287.896,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2950,3100,1380,975,1025,1650,2782.5,750,1395,475,1775,1000,350,440,435,1725],'cm^-1')),
        HinderedRotor(inertia=(0.962274,'amu*angstrom^2'), symmetry=1, barrier=(22.1246,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.958632,'amu*angstrom^2'), symmetry=1, barrier=(22.0408,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.79427,0.0406221,-2.75025e-05,3.77781e-10,4.12278e-12,-34539.5,15.0215], Tmin=(100,'K'), Tmax=(1004,'K')), NASAPolynomial(coeffs=[14.2809,0.00753011,-2.94618e-06,5.955e-10,-4.58424e-14,-37886.2,-49.4496], Tmin=(1004,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-287.896,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cds-Cds(Cds-O2d)O2s) + group(Cds-CdsHH) + group(Cds-O2d(Cds-Cds)H)"""),
)
...
species(
    label = 'C=C([O])C=O(4537)',
    structure = SMILES('[CH2]C(=O)C=O'),
    E0 = (-74.309,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,375,552.5,462.5,1710,2782.5,750,1395,475,1775,1000],'cm^-1')),
        HinderedRotor(inertia=(0.00740674,'amu*angstrom^2'), symmetry=1, barrier=(9.94815,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.34897,'amu*angstrom^2'), symmetry=1, barrier=(31.0155,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
species(
    label = '[CH]=C(O)C=O(4538)',
    structure = SMILES('[CH]=C(O)C=O'),
    E0 = (-40.7997,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,3120,650,792.5,1650,2782.5,750,1395,475,1775,1000,350,440,435,1725],'cm^-1')),
...
species(
    label = '[CH2]C([O])C=O(4540)',
    structure = SMILES('[CH2]C([O])C=O'),
    E0 = (82.1174,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,1380,1390,370,380,2900,435,2782.5,750,1395,475,1775,1000,4000],'cm^-1')),
        HinderedRotor(inertia=(0.0159147,'amu*angstrom^2'), symmetry=1, barrier=(18.8179,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.347118,'amu*angstrom^2'), symmetry=1, barrier=(18.8148,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (72.0627,'amu'),
...
species(
    label = '[CH2]C(O)[C]=O(4541)',
    structure = SMILES('[CH2]C(O)[C]=O'),
    E0 = (-1.65507,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1855,455,950,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000],'cm^-1')),
        HinderedRotor(inertia=(0.00095655,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0868959,'amu*angstrom^2'), symmetry=1, barrier=(10.8866,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0874844,'amu*angstrom^2'), symmetry=1, barrier=(10.8786,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (72.0627,'amu'),
...
species(
    label = '[CH]=C(O)C[O](4543)',
    structure = SMILES('[CH]=C(O)C[O]'),
    E0 = (111.231,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,3120,650,792.5,1650,350,440,435,1725,2750,2850,1437.5,1250,1305,750,350,350.094],'cm^-1')),
...
species(
    label = 'C=C([O])[CH]O(4544)',
    structure = SMILES('[CH2]C([O])=CO'),
    E0 = (-120.506,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,3000,3100,440,815,1455,1000,3010,987.5,1337.5,450,1655,350,440,435,1725,180],'cm^-1')),
        HinderedRotor(inertia=(0.933908,'amu*angstrom^2'), symmetry=1, barrier=(21.4724,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.930173,'amu*angstrom^2'), symmetry=1, barrier=(21.3865,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (72.0627,'amu'),
...
species(
    label = '[CH]=C(O)[CH]O(4545)',
    structure = SMILES('[CH]C(O)=CO'),
    E0 = (-46.5431,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3580,3650,1210,1345,900,1100,3010,987.5,1337.5,450,1655,350,440,435,1725,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(1.96931,'amu*angstrom^2'), symmetry=1, barrier=(45.2783,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.96875,'amu*angstrom^2'), symmetry=1, barrier=(45.2655,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.96918,'amu*angstrom^2'), symmetry=1, barrier=(45.2753,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (72.0627,'amu'),
...
species(
    ...
    E0 = (98.4302,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,3010,987.5,1337.5,450,1655,540,610,2055,2950,3100,1380,975,1025,1650],'cm^-1')),
        HinderedRotor(inertia=(1.22527,'amu*angstrom^2'), symmetry=1, barrier=(28.1713,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.22594,'amu*angstrom^2'), symmetry=1, barrier=(28.1867,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (72.0627,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.9391,0.0399649,-3.22954e-05,1.00945e-08,-1.84268e-13,11917.3,17.5189], Tmin=(100,'K'), Tmax=(1031.72,'K')), NASAPolynomial(coeffs=[11.7221,0.0113766,-4.3117e-06,7.87321e-10,-5.53028e-14,9401.48,-32.3932], Tmin=(1031.72,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(98.4302,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(Cdd-CdsCds)"""),
)

species(
    label = '[CH]C(O)C=O(4548)',
    structure = SMILES('[CH]C(O)C=O'),
    E0 = (77.0966,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,2782.5,750,1395,475,1775,1000,256.765,1054.44,2636.81],'cm^-1')),
        HinderedRotor(inertia=(0.00267825,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00282605,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.197205,'amu*angstrom^2'), symmetry=1, barrier=(9.01795,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (72.0627,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.40481,0.0380525,-4.11882e-05,2.67071e-08,-7.45723e-12,9327.44,18.5057], Tmin=(100,'K'), Tmax=(847.531,'K')), NASAPolynomial(coeffs=[6.1837,0.0202176,-9.62302e-06,1.87778e-09,-1.3319e-13,8686.9,0.89992], Tmin=(847.531,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(77.0966,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cds-OdCsH) + group(CsJ2_singlet-CsH)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['CO(10)(11)', 'C2H4O(40)(40)'],
    products = ['S(285)(284)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)(3)', 'C=C([O])C=O(4537)'],
    products = ['S(285)(284)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['HCO(14)(15)', 'CH2COH(1197)'],
    products = ['S(285)(284)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)(3)', '[CH]=C(O)C=O(4538)'],
    products = ['S(285)(284)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['H(3)(3)', 'C=C(O)[C]=O(4539)'],
    products = ['S(285)(284)'],
    transitionState = 'TS6',
