...
species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.74909,'amu*angstrom^2'), symmetry=1, barrier=(17.2231,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.749081,'amu*angstrom^2'), symmetry=1, barrier=(17.2229,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.748931,'amu*angstrom^2'), symmetry=1, barrier=(17.2194,'kJ/mol'), semiclassical=False),
...
reaction(
    label = 'reaction535',
    reactants = ['OH(5)(5)', '[CH]1C=CC=CC=C1(1243)'],
...
reaction(
    label = 'reaction538',
    reactants = ['H(3)(3)', 'OC1[C]=CC=CC=C1(2244)'],
    products = ['C7H8O(576)(575)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction539',
    reactants = ['H(3)(3)', 'OC1C=[C]C=CC=C1(2245)'],
    products = ['C7H8O(576)(575)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction540',
    reactants = ['H(3)(3)', 'OC1C=C[C]=CC=C1(2246)'],
    products = ['C7H8O(576)(575)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(6.117e+14,'cm^3/(mol*s)'), n=-0.152, Ea=(4.19655,'kJ/mol'), T0=(1,'K'), comment="""From training reaction 49 used for Cd_rad/Cd;H_rad
Exact match found for rate rule [Cd_rad/Cd;H_rad]
...
reaction(
    label = 'reaction545',
    reactants = ['OC1[C]=CC=C[CH]C1(2248)'],
    products = ['C7H8O(576)(575)'],
...
reaction(
    label = 'reaction559',
    reactants = ['[CH]=CC=CC(O)C=[CH](2257)'],
    products = ['C7H8O(576)(575)'],
