...
species(
    label = 'C=C=[C][CH]CO(4306)',
    structure = SMILES('[CH2]C#C[CH]CO'),
    E0 = (303.882,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,3000,3100,440,815,1455,1000,3025,407.5,1350,352.5,2100,2250,500,550,2750,2850,1437.5,1250,1305,750,350,180,3032.74],'cm^-1')),
        HinderedRotor(inertia=(0.666126,'amu*angstrom^2'), symmetry=1, barrier=(15.3156,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00373075,'amu*angstrom^2'), symmetry=1, barrier=(2.66692,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(3.51377,'amu*angstrom^2'), symmetry=1, barrier=(80.7884,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.112975,'amu*angstrom^2'), symmetry=1, barrier=(80.7903,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (82.1005,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.62817,0.0471714,-3.85517e-05,1.75475e-08,-3.26788e-12,36638.1,26.1113], Tmin=(100,'K'), Tmax=(1283.09,'K')), NASAPolynomial(coeffs=[10.2838,0.0201879,-7.00687e-06,1.15761e-09,-7.44805e-14,34416.9,-17.8049], Tmin=(1283.09,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(303.882,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CtCsHH) + group(Cs-CsOsHH) + group(Cs-CtHHH) + group(Ct-CtCs) + group(Ct-CtCs) + radical(CCJCO) + radical(Propargyl)"""),
)

species(
    label = '[CH]=C=C[CH]CO(4307)',
    structure = SMILES('[CH]=C=C[CH]CO'),
    E0 = (235.623,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3120,650,792.5,1650,540,610,2055,3025,407.5,1350,352.5,3615,1277.5,1000,3010,987.5,1337.5,450,1655,180],'cm^-1')),
        HinderedRotor(inertia=(1.35269,'amu*angstrom^2'), symmetry=1, barrier=(31.101,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.32722,'amu*angstrom^2'), symmetry=1, barrier=(30.5154,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.57795,'amu*angstrom^2'), symmetry=1, barrier=(36.2801,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (82.1005,'amu'),
...
species(
    label = 'C=C=CC[CH]O(4302)',
    structure = SMILES('C=C=CC[CH]O'),
    E0 = (144.527,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3025,407.5,1350,352.5,540,610,2055,3615,1277.5,1000,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,247.068,247.068],'cm^-1')),
        HinderedRotor(inertia=(0.292823,'amu*angstrom^2'), symmetry=1, barrier=(12.6842,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.292823,'amu*angstrom^2'), symmetry=1, barrier=(12.6842,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.292823,'amu*angstrom^2'), symmetry=1, barrier=(12.6842,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
...
species(
    label = 'C=C=[C]CCO(4303)',
    structure = SMILES('[CH2]C#CCCO'),
    E0 = (103.98,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,3000,3100,440,815,1455,1000,2100,2250,500,550,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,302.915,303.46],'cm^-1')),
        HinderedRotor(inertia=(0.0299814,'amu*angstrom^2'), symmetry=1, barrier=(1.94824,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00224994,'amu*angstrom^2'), symmetry=1, barrier=(14.9789,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.22539,'amu*angstrom^2'), symmetry=1, barrier=(79.8848,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.08582,'amu*angstrom^2'), symmetry=1, barrier=(79.8742,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (83.1085,'amu'),
...
species(
    label = '[CH]=CCC=CO(4297)',
    structure = SMILES('[CH]=CCC=CO'),
    E0 = (127.053,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,3120,650,792.5,1650,2995,3010,3025,975,987.5,1000,1300,1337.5,1375,400,450,500,1630,1655,1680,2750,2850,1437.5,1250,1305,750,350,180],'cm^-1')),
        HinderedRotor(inertia=(0.925328,'amu*angstrom^2'), symmetry=1, barrier=(21.2751,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.925746,'amu*angstrom^2'), symmetry=1, barrier=(21.2847,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.927209,'amu*angstrom^2'), symmetry=1, barrier=(21.3184,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (83.1085,'amu'),
...
reaction(
    label = 'reaction56',
    reactants = ['H(3)(3)', 'C=C=CC=CO(4279)'],
...
reaction(
    label = 'reaction57',
    reactants = ['H(3)(3)', 'C=C=C=CCO(4301)'],
    products = ['C5H7O(237)(236)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction58',
    reactants = ['OH(5)(5)', 'C=C=CC=C(1232)'],
    products = ['C5H7O(237)(236)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction63',
    reactants = ['OH(5)(5)', '[CH2]C=C[C]=C(1234)'],
    products = ['C5H7O(237)(236)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction65',
    reactants = ['H(3)(3)', '[CH2][C]=CC=CO(4286)'],
    products = ['C5H7O(237)(236)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction66',
    reactants = ['H(3)(3)', 'C=C=[C][CH]CO(4306)'],
    products = ['C5H7O(237)(236)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(4.34601e+06,'m^3/(mol*s)'), n=0.278532, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [Y_rad;H_rad]
Euclidian distance = 0
...
reaction(
    label = 'reaction67',
    reactants = ['H(3)(3)', '[CH]=C=C[CH]CO(4307)'],
    products = ['C5H7O(237)(236)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['CH2OH(22)(23)', '[CH]C=C=C(4310)'],
    products = ['C5H7O(237)(236)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(3)(3)', 'C=C=C[C]CO(4311)'],
    products = ['C5H7O(237)(236)'],
...
reaction(
    label = 'reaction71',
    reactants = ['H2CCCH(841)', '[CH]CO(1201)'],
    products = ['C5H7O(237)(236)'],
...
reaction(
    label = 'reaction77',
    reactants = ['H2CC(T)(1194)', '[CH]=CCO(4313)'],
    products = ['C5H7O(237)(236)'],
...
reaction(
    label = 'reaction29',
    reactants = ['OH(5)(5)', '[CH]=CC=C[CH2](922)'],
    products = ['C5H7O(224)(223)'],
...
reaction(
    label = 'reaction31',
    reactants = ['CHCHOH(49)(49)', '[CH]=C[CH2](924)'],
    products = ['C5H7O(224)(223)'],
...
reaction(
    label = 'reaction32',
    reactants = ['H(3)(3)', '[CH2]C=[C]C=CO(4284)'],
    products = ['C5H7O(224)(223)'],
...
reaction(
    label = 'reaction33',
    reactants = ['H(3)(3)', '[CH2]C=C[C]=CO(4285)'],
    products = ['C5H7O(224)(223)'],
...
reaction(
    label = 'reaction35',
    reactants = ['H(3)(3)', '[CH2]C=CC=[C]O(4287)'],
    products = ['C5H7O(224)(223)'],
...
reaction(
    label = 'reaction39',
    reactants = ['CH2(17)(18)', '[CH]=CC=CO(4291)'],
    products = ['C5H7O(224)(223)'],
...
reaction(
    label = 'reaction40',
    reactants = ['H(3)(3)', '[CH]C=CC=CO(4292)'],
    products = ['C5H7O(224)(223)'],
...
reaction(
    label = 'reaction41',
    reactants = ['H(3)(3)', 'C=CC=C=CO(4293)'],
    products = ['C5H7O(224)(223)'],
...
reaction(
    label = 'reaction48',
    reactants = ['C2H3(28)(29)', '[CH]=C[CH]O(2814)'],
    products = ['C5H7O(224)(223)'],
...
reaction(
    label = 'reaction55',
    reactants = ['CH2CHCHCH(1116)', 'HCOH(T)(1415)'],
    products = ['C5H7O(224)(223)'],
