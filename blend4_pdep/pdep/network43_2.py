...
species(
    label = '[CH]=CC1C=CC1[CH2](1446)',
    structure = SMILES('[CH]=CC1C=CC1[CH2]'),
    E0 = (636.596,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,3120,650,792.5,1650,2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,3010,987.5,1337.5,450,1655,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
...
species(
    label = '[CH]=CCC1[CH]C=C1(1447)',
    structure = SMILES('[CH]=CCC1[CH]C=C1'),
    E0 = (604.576,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3120,650,792.5,1650,2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,3010,987.5,1337.5,450,1655,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
...
species(
    ...
    molecularWeight = (92.1384,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.86823,0.0188151,4.52555e-05,-5.0559e-08,1.45422e-11,78034.7,11.4093], Tmin=(100,'K'), Tmax=(1240.72,'K')), NASAPolynomial(coeffs=[3.75656,0.0450102,-2.15453e-05,4.21159e-09,-2.97468e-13,75577.6,-2.08149], Tmin=(1240.72,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(648.441,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + polycyclic(s2_4_5_ane) + polycyclic(s3_4_5_ane) + polycyclic(s2_4_4_ane) - ring(Cyclobutane) - ring(Cyclobutane) - ring(Cyclopentane) + radical(bicyclo[2.1.1]hexane-C5) + radical(bicyclo[2.1.1]hexane-C2)"""),
)

species(
    label = '[CH]1C2CC3[CH]C2C13(1455)',
    ...
    molecularWeight = (92.1384,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.86818,0.0188157,4.52537e-05,-5.05569e-08,1.45415e-11,80349.5,10.7163], Tmin=(100,'K'), Tmax=(1240.74,'K')), NASAPolynomial(coeffs=[3.75713,0.0450093,-2.15448e-05,4.21148e-09,-2.9746e-13,77892.2,-2.7779], Tmin=(1240.74,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(667.687,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + polycyclic(s3_4_5_ane) + polycyclic(s2_4_5_ane) + polycyclic(s2_4_4_ane) - ring(Cyclobutane) - ring(Cyclobutane) - ring(Cyclopentane) + radical(bicyclo[2.1.1]hexane-C5) + radical(bicyclo[2.1.1]hexane-C5)"""),
)

species(
    label = '[CH]1CC2[CH]C3C1C23(1456)',
...
reaction(
    label = 'reaction23',
    reactants = ['H(3)(3)', 'C1=CC2C=C[C]2C1(1427)'],
...
reaction(
    label = 'reaction24',
    reactants = ['H(3)(3)', 'C1=C[C]2C=CC2C1(1428)'],
    products = ['C7H8(436)(435)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction25',
    reactants = ['H(3)(3)', '[CH]1C=CC2C=CC12(1429)'],
    products = ['C7H8(436)(435)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction26',
    reactants = ['H(3)(3)', '[C]1=CC2C=CCC12(1430)'],
    products = ['C7H8(436)(435)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction27',
    reactants = ['H(3)(3)', '[C]1=CCC2C=CC12(1431)'],
    products = ['C7H8(436)(435)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(1e+13,'cm^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""From training reaction 40 used for Cd_rad/NonDe;H_rad
...
reaction(
    label = 'reaction28',
    reactants = ['H(3)(3)', '[C]1=CC2CC=CC12(1432)'],
    products = ['C7H8(436)(435)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(1e+13,'cm^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""From training reaction 40 used for Cd_rad/NonDe;H_rad
Exact match found for rate rule [Cd_rad/NonDe;H_rad]
...
reaction(
    label = 'reaction29',
    reactants = ['H(3)(3)', '[C]1=CC2C=CC2C1(1433)'],
    products = ['C7H8(436)(435)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(1e+13,'cm^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""From training reaction 40 used for Cd_rad/NonDe;H_rad
Exact match found for rate rule [Cd_rad/NonDe;H_rad]
...
reaction(
    label = 'reaction30',
    reactants = ['[CH]1C[C]2CC=CC12(1434)'],
    products = ['C7H8(436)(435)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH]1C[C]2C=CC2C1(1435)'],
    products = ['C7H8(436)(435)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(5.10299e+10,'s^-1'), n=0.2847, Ea=(23.1459,'kJ/mol'), T0=(1,'K'), comment="""Estimated using average of templates [Rn;Y_rad_NDe;XH_Rrad_NDe] + [R2radExo;Y_rad;XH_Rrad_NDe] for rate rule [R2radExo;Y_rad_NDe;XH_Rrad_NDe]
Euclidian distance = 1.0
...
reaction(
    label = 'reaction32',
    reactants = ['[CH]1C[C]2C=CCC12(1021)'],
    products = ['C7H8(436)(435)'],
...
reaction(
    label = 'reaction33',
    reactants = ['[CH]1C[CH]C2C=CC12(1252)'],
    products = ['C7H8(436)(435)'],
...
reaction(
    label = 'reaction34',
    reactants = ['[CH]1CC2CC=C[C]12(1436)'],
    products = ['C7H8(436)(435)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH]1C=CC2C[CH]C12(1023)'],
    products = ['C7H8(436)(435)'],
...
reaction(
    label = 'reaction36',
    reactants = ['[CH]1CC2C=CC[C]12(1020)'],
    products = ['C7H8(436)(435)'],
...
reaction(
    label = 'reaction37',
    reactants = ['[C]1=CCC2[CH]CC12(1024)'],
    products = ['C7H8(436)(435)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[C]1=CC2C[CH]CC12(1437)'],
    products = ['C7H8(436)(435)'],
...
reaction(
    label = 'reaction39',
    reactants = ['[CH]1CC[C]2C=CC12(1438)'],
    products = ['C7H8(436)(435)'],
...
reaction(
    label = 'reaction40',
    reactants = ['[C]1=CCC2C[CH]C12(1439)'],
    products = ['C7H8(436)(435)'],
...
reaction(
    label = 'reaction41',
    reactants = ['[C]1=CC2CC[CH]C12(1440)'],
    products = ['C7H8(436)(435)'],
...
reaction(
    label = 'reaction42',
    reactants = ['[CH]1[CH]C2CC=CC12(1022)'],
    products = ['C7H8(436)(435)'],
...
reaction(
    label = 'reaction43',
    reactants = ['[CH]1CCC2C=C[C]12(1441)'],
    products = ['C7H8(436)(435)'],
...
reaction(
    label = 'reaction44',
    reactants = ['[C]1=CC2[CH]CCC12(1442)'],
    products = ['C7H8(436)(435)'],
...
reaction(
    label = 'reaction45',
    reactants = ['[C]1=CC2[CH]CC2C1(1443)'],
    products = ['C7H8(436)(435)'],
...
reaction(
    label = 'reaction46',
    reactants = ['[C]1=CC2C[CH]C2C1(1025)'],
    products = ['C7H8(436)(435)'],
...
reaction(
    label = 'reaction47',
    reactants = ['[CH]=CC1[CH]C=CC1(1444)'],
    products = ['C7H8(436)(435)'],
...
reaction(
    label = 'reaction48',
    reactants = ['[CH]=CC1[CH]CC=C1(1445)'],
    products = ['C7H8(436)(435)'],
...
reaction(
    label = 'reaction49',
    reactants = ['[CH]1[CH]CC=CC=C1(903)'],
    products = ['C7H8(436)(435)'],
...
reaction(
    label = 'reaction50',
    reactants = ['[CH]=CC1C=CC1[CH2](1446)'],
    products = ['C7H8(436)(435)'],
...
reaction(
    label = 'reaction51',
    reactants = ['[CH]=CCC1[CH]C=C1(1447)'],
    products = ['C7H8(436)(435)'],
...
reaction(
    label = 'reaction52',
    reactants = ['[CH2]C=CC1[CH]C=C1(1448)'],
    products = ['C7H8(436)(435)'],
...
reaction(
    label = 'reaction58',
    reactants = ['[CH]1C2[CH]C3C1CC23(1454)'],
    products = ['C7H8(436)(435)'],
...
reaction(
    label = 'reaction59',
    reactants = ['[CH]1C2CC3[CH]C2C13(1455)'],
    products = ['C7H8(436)(435)'],
...
reaction(
    label = 'reaction60',
    reactants = ['[CH]1CC2[CH]C3C1C23(1456)'],
    products = ['C7H8(436)(435)'],
...
reaction(
    label = 'reaction61',
    reactants = ['[CH]1CC2C3[CH]C2C13(1457)'],
    products = ['C7H8(436)(435)'],
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)(3)', '[CH]1C=CC=CC=C1(1243)'],
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)(3)', '[C]1=CC=CC=CC1(1244)'],
    products = ['C7H8(415)(414)'],
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)(3)', '[C]1=CCC=CC=C1(1245)'],
    products = ['C7H8(415)(414)'],
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)(3)', '[C]1=CC=CCC=C1(1246)'],
    products = ['C7H8(415)(414)'],
