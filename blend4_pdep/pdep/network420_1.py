...
species(
    label = 'CH3CHCH2OH(7837)',
    structure = SMILES('C[CH]CO'),
    E0 = (-74.8149,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2850,1437.5,1250,1305,750,350,2936.63],'cm^-1')),
        HinderedRotor(inertia=(0.151041,'amu*angstrom^2'), symmetry=1, barrier=(3.47272,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.685641,'amu*angstrom^2'), symmetry=1, barrier=(15.7642,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.151043,'amu*angstrom^2'), symmetry=1, barrier=(3.47278,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (59.0871,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.51532,0.0312457,-1.61816e-05,4.02431e-09,-4.02052e-13,-8943.85,17.5114], Tmin=(100,'K'), Tmax=(2194.67,'K')), NASAPolynomial(coeffs=[10.2172,0.0172079,-6.58695e-06,1.10972e-09,-7.00363e-14,-12324.4,-25.6994], Tmin=(2194.67,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-74.8149,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), label="""CH3CHCH2OH""", comment="""Thermo library: DFT_QCI_thermo"""),
)

species(
    label = 'CH2CH2CH2OH(6491)',
...
reaction(
    label = 'reaction1',
    reactants = ['H(3)(3)', 'C3H6O(201)(200)'],
    products = ['C3H7O(296)(295)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['CH2O(13)(14)', 'C2H5(27)(28)'],
    products = ['C3H7O(296)(295)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH3(15)(16)', '[CH2]C[O](1195)'],
    products = ['C3H7O(296)(295)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['C2H5(27)(28)', '[CH2][O](1408)'],
    products = ['C3H7O(296)(295)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction8',
    reactants = ['CH2(S)(21)(22)', 'C2H5O(36)(37)'],
    products = ['C3H7O(296)(295)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['C3H7O(296)(295)'],
    products = ['HOCHC2H5(7836)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(153000,'s^-1'), n=2.26, Ea=(88.9937,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2500,'K'), comment="""Matched reaction 325 C3H7O-5 <=> C3H7O-6 in intra_H_migration/training
This reaction matched rate rule [R2H_S;O_rad_out;Cs_H_out_H/(NonDeC/Cs)]
family: intra_H_migration"""),
)

reaction(
    label = 'reaction10',
    reactants = ['CH3CHCH2OH(7837)'],
    products = ['C3H7O(296)(295)'],
    transitionState = 'TS10',
    kinetics = Arrhenius(A=(5.71,'s^-1'), n=3.021, Ea=(105.562,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2500,'K'), comment="""Matched reaction 319 C3H7O-3 <=> C3H7O-4 in intra_H_migration/training
This reaction matched rate rule [R3H_SS_Cs;O_rad_out;Cs_H_out_H/NonDeC]
family: intra_H_migration"""),
)

reaction(
    label = 'reaction11',
    reactants = ['CH2CH2CH2OH(6491)'],
    products = ['C3H7O(296)(295)'],
    transitionState = 'TS11',
    kinetics = Arrhenius(A=(8.6e-09,'s^-1'), n=5.55, Ea=(83.68,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2500,'K'), comment="""Matched reaction 340 C3H7O-2 <=> C3H7O in intra_H_migration/training
...
network(
    ...
    reactants = [
        ('H(3)(3)', 'C3H6O(201)(200)'),
        ('CH2O(13)(14)', 'C2H5(27)(28)'),
        ('CH2(S)(21)(22)', 'C2H5O(36)(37)'),
        ('O(4)(4)', 'C3H7(69)(68)'),
    ],
    bathGas = {
        'Ne': 0.333333,
