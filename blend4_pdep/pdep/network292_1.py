species(
    label = '[CH2]CC[C]=O(3560)',
    structure = SMILES('[CH2]CC[C]=O'),
    E0 = (138.104,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,1855,455,950,3000,3100,440,815,1455,1000,180],'cm^-1')),
...
species(
    label = '[CH2]CC=C=O(7838)',
    structure = SMILES('[CH2]CC=C=O'),
    E0 = (100.881,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,2120,512.5,787.5,3000,3100,440,815,1455,1000,180],'cm^-1')),
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)(3)', 'C4H5O(93)(92)'],
    products = ['[CH2]CC[C]=O(3560)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)(3)', '[CH2]CC=C=O(7838)'],
    products = ['[CH2]CC[C]=O(3560)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['C2H4(19)(20)', '[CH2][C]=O(1196)'],
    products = ['[CH2]CC[C]=O(3560)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction15',
    reactants = ['CO(10)(11)', '[CH2]C[CH2](898)'],
    products = ['[CH2]CC[C]=O(3560)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CH2(17)(18)', 'C3H4O(116)(115)'],
    products = ['[CH2]CC[C]=O(3560)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]C[CH2](898)', '[C]=O(1191)'],
    products = ['[CH2]CC[C]=O(3560)'],
