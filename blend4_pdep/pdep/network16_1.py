...
species(
    label = '[CH2][CH]CCC(862)',
    structure = SMILES('[CH2][CH]CCC'),
    E0 = (231.608,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,2519.72,2520.45],'cm^-1')),
        HinderedRotor(inertia=(0.116103,'amu*angstrom^2'), symmetry=1, barrier=(4.8022,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.115903,'amu*angstrom^2'), symmetry=1, barrier=(4.78715,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.32337,'amu*angstrom^2'), symmetry=1, barrier=(54.7438,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00289258,'amu*angstrom^2'), symmetry=1, barrier=(0.119711,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (70.1329,'amu'),
...
reaction(
    label = 'reaction1',
    reactants = ['H(3)(3)', 'C5H10(82)(81)'],
    products = ['C5H11(67)(66)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['C3H7(69)(68)', 'C2H4(19)(20)'],
    products = ['C5H11(67)(66)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['C2H5(27)(28)', '[CH2]C[CH2](898)'],
    products = ['C5H11(67)(66)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['C3H7(69)(68)', 'C2H4(T)(899)'],
    products = ['C5H11(67)(66)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)(3)', '[CH2]C[CH]CC(886)'],
    products = ['C5H11(67)(66)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['CH3(15)(16)', '[CH2]CC[CH2](896)'],
    products = ['C5H11(67)(66)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(3)(3)', '[CH2]CC[CH]C(874)'],
    products = ['C5H11(67)(66)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(2e+13,'cm^3/(mol*s)','*|/',3.16), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), comment="""From training reaction 59 used for H_rad;C_rad/H/NonDeC
Exact match found for rate rule [C_rad/H/NonDeC;H_rad]
...
reaction(
    label = 'reaction8',
    reactants = ['H(3)(3)', '[CH2][CH]CCC(862)'],
    products = ['C5H11(67)(66)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(3)(3)', '[CH2]CCC[CH2](897)'],
    products = ['C5H11(67)(66)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['C4H9(68)(67)', 'CH2(S)(21)(22)'],
    products = ['C5H11(67)(66)'],
...
reaction(
    label = 'reaction11',
    reactants = ['C5H11(67)(66)'],
    products = ['C[CH]CCC(1209)'],
...
reaction(
    label = 'reaction13',
    reactants = ['C4H9(68)(67)', 'CH2(17)(18)'],
    products = ['C5H11(67)(66)'],
...
network(
    ...
    reactants = [
        ('H(3)(3)', 'C5H10(82)(81)'),
        ('C3H7(69)(68)', 'C2H4(19)(20)'),
        ('C4H9(68)(67)', 'CH2(S)(21)(22)'),
        ('C4H9(68)(67)', 'CH2(17)(18)'),
    ],
    bathGas = {
        'Ne': 0.333333,
        'N2': 0.333333,
