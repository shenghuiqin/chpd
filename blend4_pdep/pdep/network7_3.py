...
species(
    ...
    E0 = (-389.41,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,931.502,931.637,931.763,932.03,932.486],'cm^-1')),
        HinderedRotor(inertia=(0.00565816,'amu*angstrom^2'), symmetry=1, barrier=(3.48673,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.76241,-0.000943948,3.38782e-05,-4.04988e-08,1.43988e-11,-46821.2,7.63273], Tmin=(100,'K'), Tmax=(993.727,'K')), NASAPolynomial(coeffs=[5.64497,0.00755188,-3.20855e-06,6.58926e-10,-5.05061e-14,-47989,-5.43086], Tmin=(993.727,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-389.41,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(103.931,'J/(mol*K)'), label="""formic_acid""", comment="""Thermo library: thermo_DFT_CCSDTF12_BAC"""),
)
...
species(
    ...
    molecularWeight = (47.0333,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.7094,0.0254993,-3.14581e-05,1.89353e-08,-4.23676e-12,-26653.8,11.6233], Tmin=(100,'K'), Tmax=(1261.91,'K')), NASAPolynomial(coeffs=[8.67769,0.00277368,8.08869e-08,-1.17579e-10,1.15164e-14,-27857,-17.3575], Tmin=(1261.91,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-222.02,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(124.717,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-OsOsHH) + radical(OCJO)"""),
)
...
species(
    ...
    E0 = (5.37818,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,3025,407.5,1350,352.5,1989.68],'cm^-1')),
...
reaction(
    label = 'reaction1',
    reactants = ['CH3OO(25)(26)'],
    products = ['CH2OOH(33)(34)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)(3)', '[CH2]O[O](1192)'],
    products = ['CH3OO(25)(26)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['OH(5)(5)', 'CH2O(13)(14)'],
    products = ['CH2OOH(33)(34)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(2330,'cm^3/(mol*s)'), n=3.17, Ea=(145.57,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""Estimated using template [Od_CO-HH;YJ] for rate rule [Od_CO-HH;OJ_pri]
Euclidian distance = 2.0
family: R_Addition_MultipleBond
Ea raised from 141.0 to 145.6 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction6',
    reactants = ['OH(5)(5)', '[CH2][O](1408)'],
    products = ['CH2OOH(33)(34)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['CH2OOH(33)(34)'],
    products = ['HOCH2O(63)(62)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(5.53658e+10,'s^-1'), n=0, Ea=(99.0214,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [RnOOH;C_rad_out_2H] for rate rule [ROOH;C_rad_out_2H]
Euclidian distance = 1.0
...
reaction(
    label = 'reaction13',
    reactants = ['HOCH2O(63)(62)'],
    products = ['O[CH]O(1410)'],
