...
species(
    ...
    molecularWeight = (68.117,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.84618,0.0183381,3.27611e-05,-4.16411e-08,1.34602e-11,42661.3,19.4601], Tmin=(100,'K'), Tmax=(1105.35,'K')), NASAPolynomial(coeffs=[4.1456,0.03324,-1.40646e-05,2.64589e-09,-1.85264e-13,41176.4,7.64366], Tmin=(1105.35,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(354.312,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(303.478,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cyclobutane) + radical(cyclobutane) + radical(Tertalkyl)"""),
)

species(
    label = '[CH2]C1[CH]CC1(1651)',
...
species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.136519,'amu*angstrom^2'), symmetry=1, barrier=(3.13884,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.136033,'amu*angstrom^2'), symmetry=1, barrier=(3.12766,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.00715,'amu*angstrom^2'), symmetry=1, barrier=(23.1563,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (68.117,'amu'),
...
species(
    label = '[CH2]C[C]=CC(1545)',
    structure = SMILES('[CH2]C[C]=CC'),
    E0 = (390.541,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,1685,370,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,221.103],'cm^-1')),
        HinderedRotor(inertia=(0.139138,'amu*angstrom^2'), symmetry=1, barrier=(4.67515,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.138413,'amu*angstrom^2'), symmetry=1, barrier=(4.67851,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.138885,'amu*angstrom^2'), symmetry=1, barrier=(4.67549,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (68.117,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.04972,0.0405227,-2.17348e-05,5.57613e-09,-5.73513e-13,47043.1,21.1549], Tmin=(100,'K'), Tmax=(2150.75,'K')), NASAPolynomial(coeffs=[12.392,0.0212881,-8.32007e-06,1.41802e-09,-9.01848e-14,42594.3,-36.6611], Tmin=(2150.75,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(390.541,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Cds_S) + radical(RCCJ)"""),
)

species(
    label = 'C=[C]C[CH]C(1546)',
...
reaction(
    label = 'reaction22',
    reactants = ['CH3(15)(16)', '[CH]1C=CC1(1279)'],
...
reaction(
    label = 'reaction23',
    reactants = ['H(3)(3)', 'C[C]1C=CC1(1642)'],
    products = ['C5H8(205)(204)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction24',
    reactants = ['H(3)(3)', 'CC1[CH]C=C1(1643)'],
    products = ['C5H8(205)(204)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction25',
    reactants = ['H(3)(3)', '[CH2]C1C=CC1(1235)'],
    products = ['C5H8(205)(204)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction26',
    reactants = ['H(3)(3)', 'CC1[C]=CC1(1644)'],
    products = ['C5H8(205)(204)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction27',
    reactants = ['H(3)(3)', 'CC1C=[C]C1(1645)'],
    products = ['C5H8(205)(204)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(1e+13,'cm^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""From training reaction 40 used for Cd_rad/NonDe;H_rad
...
reaction(
    label = 'reaction1',
    reactants = ['CH3(15)(16)', 'CH2CHCHCH(1116)'],
...
reaction(
    label = 'reaction4',
    reactants = ['C2H3(28)(29)', 'CH3CHCH(839)'],
    products = ['C5H8(203)(202)'],
