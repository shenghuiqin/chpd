species(
    ...
    E0 = (134.426,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2950,3000,3050,3100,1330,1430,900,1050,1000,1050,1600,1700,1380,1390,370,380,2900,435,2995,3025,975,1000,1300,1375,400,500,1630,1680,180,608.157],'cm^-1')),
        HinderedRotor(inertia=(0.58833,'amu*angstrom^2'), symmetry=1, barrier=(13.5269,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.357306,'amu*angstrom^2'), symmetry=1, barrier=(13.5266,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.588331,'amu*angstrom^2'), symmetry=1, barrier=(13.5269,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
species(
    label = 'C=[C]C(C=C)O[O](1404)',
    structure = SMILES('C=[C]C(C=C)O[O]'),
    E0 = (372.268,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,1685,370,2950,3000,3050,3100,1330,1430,900,1050,1000,1050,1600,1700,1380,1390,370,380,2900,435,3010,987.5,1337.5,450,1655,292.836,295.261],'cm^-1')),
        HinderedRotor(inertia=(0.196707,'amu*angstrom^2'), symmetry=1, barrier=(11.9818,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.192669,'amu*angstrom^2'), symmetry=1, barrier=(11.9793,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.193082,'amu*angstrom^2'), symmetry=1, barrier=(11.9761,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.4871,0.0582291,-5.40433e-05,2.79233e-08,-6.11709e-12,44861.5,26.9232], Tmin=(100,'K'), Tmax=(1066.3,'K')), NASAPolynomial(coeffs=[9.1556,0.0294627,-1.35769e-05,2.62331e-09,-1.85434e-13,43226.1,-10.5652], Tmin=(1066.3,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(372.268,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)(Cds-Cds)OsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cds_S) + radical(ROOJ)"""),
)

species(
    label = '[CH]=CC(C=C)O[O](1405)',
    structure = SMILES('[CH]=CC(C=C)O[O]'),
    E0 = (381.522,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,3120,650,792.5,1650,2950,3100,1380,975,1025,1650,1380,1390,370,380,2900,435,2995,3025,975,1000,1300,1375,400,500,1630,1680,180],'cm^-1')),
        HinderedRotor(inertia=(0.603062,'amu*angstrom^2'), symmetry=1, barrier=(13.8656,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.603017,'amu*angstrom^2'), symmetry=1, barrier=(13.8645,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.60296,'amu*angstrom^2'), symmetry=1, barrier=(13.8632,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.31348,0.0588054,-5.20174e-05,2.42616e-08,-4.65637e-12,45983.4,27.4687], Tmin=(100,'K'), Tmax=(1226.44,'K')), NASAPolynomial(coeffs=[11.5055,0.0255643,-1.13616e-05,2.16191e-09,-1.51506e-13,43483.5,-23.7822], Tmin=(1226.44,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(381.522,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)(Cds-Cds)OsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cds_P) + radical(ROOJ)"""),
)

species(
    label = '[CH2]C1OOC1C=C(1398)',
...
species(
    label = 'C=CC([O])C=C(1407)',
    structure = SMILES('C=CC([O])C=C'),
    E0 = (141.277,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,3000,3050,3100,1330,1430,900,1050,1000,1050,1600,1700,1380,1390,370,380,2900,435,2995,3025,975,1000,1300,1375,400,500,1630,1680,426.969,426.985,426.989],'cm^-1')),
        HinderedRotor(inertia=(0.118284,'amu*angstrom^2'), symmetry=1, barrier=(15.3018,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.118288,'amu*angstrom^2'), symmetry=1, barrier=(15.302,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
reaction(
    label = 'reaction6',
    reactants = ['C2H3(28)(29)', 'C=C[CH]O[O](1402)'],
    products = ['S(212)(211)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction7',
    reactants = ['H(3)(3)', 'C=C[C](C=C)O[O](1403)'],
    products = ['S(212)(211)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction8',
    reactants = ['H(3)(3)', 'C=[C]C(C=C)O[O](1404)'],
    products = ['S(212)(211)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction9',
    reactants = ['H(3)(3)', '[CH]=CC(C=C)O[O](1405)'],
    products = ['S(212)(211)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction12',
    reactants = ['O(4)(4)', 'C=CC([O])C=C(1407)'],
    products = ['S(212)(211)'],
