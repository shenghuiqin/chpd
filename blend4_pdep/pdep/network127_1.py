...
species(
    ...
    molecularWeight = (108.138,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.97008,0.0220439,8.59565e-05,-1.23752e-07,4.75274e-11,40232,22.2624], Tmin=(100,'K'), Tmax=(973.598,'K')), NASAPolynomial(coeffs=[14.4669,0.027535,-1.00663e-05,1.95724e-09,-1.48227e-13,35105,-51.5265], Tmin=(973.598,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(333.732,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(378.308,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + Estimated bicyclic component: polycyclic(s2_4_5_ane) - ring(Cyclopentane) - ring(Cyclobutane) + ring(Cyclopentane) + ring(Cyclobutene) + radical(CCJ(C)CO) + radical(CCJCO)"""),
)

species(
    label = 'OC1=CCC2[CH]C[C]12(2469)',
...
species(
    label = 'OC1=C[CH]C2C[CH]C12(2471)',
...
species(
    label = 'OC1=C[CH]C2[CH]CC12(2476)',
...
species(
    label = '[CH]=C(O)C1C=CC1[CH2](2488)',
    structure = SMILES('[CH]=C(O)C1C=CC1[CH2]'),
    E0 = (422.037,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,3000,3100,440,815,1455,1000,3120,650,792.5,1650,350,440,435,1725,2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
...
species(
    label = 'O[C]=CCC1[CH]C=C1(2489)',
    structure = SMILES('O[C]=CCC1[CH]C=C1'),
    E0 = (388.432,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1685,370,3010,987.5,1337.5,450,1655,2750,2850,1437.5,1250,1305,750,350,2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (108.138,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.955228,0.0449424,3.97231e-05,-9.268e-08,4.12313e-11,46847.3,28.379], Tmin=(100,'K'), Tmax=(943.158,'K')), NASAPolynomial(coeffs=[20.5961,0.0171105,-4.22729e-06,7.39981e-10,-5.92152e-14,40675.4,-78.3061], Tmin=(943.158,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(388.432,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(369.994,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + ring(Cyclobutene) + radical(cyclobutene-allyl) + radical(C=CJO)"""),
)

species(
    label = '[CH2]C=C(O)C1[CH]C=C1(2490)',
    structure = SMILES('[CH2]C=C(O)C1[CH]C=C1'),
    E0 = (281.627,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,3000,3100,440,815,1455,1000,350,440,435,1725,3010,987.5,1337.5,450,1655,2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
...
species(
    label = 'O[C]1C2[CH]C3C1CC23(2496)',
...
species(
    label = 'OC12[CH]CC3[CH]C1C32(2498)',
    ...
    molecularWeight = (108.138,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.61427,0.0455969,-4.36374e-06,-1.42938e-08,5.1727e-12,50356.7,18.301], Tmin=(100,'K'), Tmax=(1326.3,'K')), NASAPolynomial(coeffs=[10.5988,0.0378909,-1.75783e-05,3.37158e-09,-2.34887e-13,46268,-34.0105], Tmin=(1326.3,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(417.931,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(378.308,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + polycyclic(s2_4_5_ane) + polycyclic(s2_3_5_ane) + polycyclic(s2_3_4_ane) - ring(Cyclopropane) - ring(Cyclopentane) - ring(Cyclobutane) + radical(CCJCO) + radical(bicyclo[3.1.1]heptane-C6)"""),
)

species(
    label = 'OC12[CH]CC3C1[CH]C32(2499)',
...
reaction(
    label = 'reaction845',
    reactants = ['OH(5)(5)', '[C]1=CCC2C=CC12(1431)'],
...
reaction(
    label = 'reaction846',
    reactants = ['H(3)(3)', '[O]C1=CCC2C=CC12(2459)'],
    products = ['C7H8O(589)(588)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction847',
    reactants = ['H(3)(3)', 'OC1=CC[C]2C=CC21(2460)'],
    products = ['C7H8O(589)(588)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction848',
    reactants = ['H(3)(3)', 'OC1=CCC2C=C[C]12(2461)'],
    products = ['C7H8O(589)(588)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction849',
    reactants = ['H(3)(3)', 'OC1=C[CH]C2C=CC12(2462)'],
    products = ['C7H8O(589)(588)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction850',
    reactants = ['H(3)(3)', 'OC1=CCC2[C]=CC12(2463)'],
    products = ['C7H8O(589)(588)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction851',
    reactants = ['H(3)(3)', 'OC1=CCC2C=[C]C12(2464)'],
    products = ['C7H8O(589)(588)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(1e+13,'cm^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""From training reaction 40 used for Cd_rad/NonDe;H_rad
Exact match found for rate rule [Cd_rad/NonDe;H_rad]
...
reaction(
    label = 'reaction852',
    reactants = ['H(3)(3)', 'OC1=[C]CC2C=CC12(2465)'],
    products = ['C7H8O(589)(588)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(1e+13,'cm^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""From training reaction 40 used for Cd_rad/NonDe;H_rad
Exact match found for rate rule [Cd_rad/NonDe;H_rad]
...
reaction(
    label = 'reaction853',
    reactants = ['[O]C1[CH]CC2C=CC12(2466)'],
    products = ['C7H8O(589)(588)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction854',
    reactants = ['OC1=CC[C]2C[CH]C21(2467)'],
    products = ['C7H8O(589)(588)'],
...
reaction(
    label = 'reaction855',
    reactants = ['OC1[CH]CC2C=C[C]12(2468)'],
    products = ['C7H8O(589)(588)'],
...
reaction(
    label = 'reaction856',
    reactants = ['OC1=CCC2[CH]C[C]12(2469)'],
    products = ['C7H8O(589)(588)'],
...
reaction(
    label = 'reaction858',
    reactants = ['OC1=CCC2C[CH][C]12(2470)'],
    products = ['C7H8O(589)(588)'],
...
reaction(
    label = 'reaction859',
    reactants = ['OC1=C[CH]C2C[CH]C12(2471)'],
    products = ['C7H8O(589)(588)'],
...
reaction(
    label = 'reaction860',
    reactants = ['OC1[CH]C[C]2C=CC21(2472)'],
    products = ['C7H8O(589)(588)'],
...
reaction(
    label = 'reaction861',
    reactants = ['OC1=CC[C]2[CH]CC21(2473)'],
    products = ['C7H8O(589)(588)'],
...
reaction(
    label = 'reaction862',
    reactants = ['OC1[CH]CC2C=[C]C12(2474)'],
    products = ['C7H8O(589)(588)'],
...
reaction(
    label = 'reaction863',
    reactants = ['O[C]1CC[C]2C=CC12(2475)'],
    products = ['C7H8O(589)(588)'],
...
reaction(
    label = 'reaction864',
    reactants = ['OC1=C[CH]C2[CH]CC12(2476)'],
    products = ['C7H8O(589)(588)'],
...
reaction(
    label = 'reaction865',
    reactants = ['O[C]1CCC2C=[C]C12(2477)'],
    products = ['C7H8O(589)(588)'],
...
reaction(
    label = 'reaction866',
    reactants = ['OC1[CH][CH]C2C=CC12(2478)'],
    products = ['C7H8O(589)(588)'],
...
reaction(
    label = 'reaction867',
    reactants = ['OC1[CH]CC2[C]=CC12(2479)'],
    products = ['C7H8O(589)(588)'],
...
reaction(
    label = 'reaction868',
    reactants = ['O[C]1CCC2C=C[C]12(2480)'],
    products = ['C7H8O(589)(588)'],
...
reaction(
    label = 'reaction869',
    reactants = ['O[C]1CCC2[C]=CC12(2481)'],
    products = ['C7H8O(589)(588)'],
...
reaction(
    label = 'reaction870',
    reactants = ['OC1=[C]CC2C[CH]C12(2482)'],
    products = ['C7H8O(589)(588)'],
...
reaction(
    label = 'reaction871',
    reactants = ['[O]C1=CCC2[CH]CC12(2483)'],
    products = ['C7H8O(589)(588)'],
...
reaction(
    label = 'reaction872',
    reactants = ['OC1=[C]CC2[CH]CC12(2484)'],
    products = ['C7H8O(589)(588)'],
...
reaction(
    label = 'reaction873',
    reactants = ['[O]C1=CCC2C[CH]C12(2485)'],
    products = ['C7H8O(589)(588)'],
...
reaction(
    label = 'reaction874',
    reactants = ['[CH]=CC1[CH]C(O)=CC1(2486)'],
    products = ['C7H8O(589)(588)'],
...
reaction(
    label = 'reaction875',
    reactants = ['[CH]=CC1[CH]CC=C1O(2487)'],
    products = ['C7H8O(589)(588)'],
...
reaction(
    label = 'reaction877',
    reactants = ['[CH]=C(O)C1C=CC1[CH2](2488)'],
    products = ['C7H8O(589)(588)'],
...
reaction(
    label = 'reaction878',
    reactants = ['O[C]=CCC1[CH]C=C1(2489)'],
    products = ['C7H8O(589)(588)'],
...
reaction(
    label = 'reaction879',
    reactants = ['[CH2]C=C(O)C1[CH]C=C1(2490)'],
    products = ['C7H8O(589)(588)'],
...
reaction(
    label = 'reaction881',
    reactants = ['OC1=CCC2[C]CC12(2492)'],
    products = ['C7H8O(589)(588)'],
...
reaction(
    label = 'reaction882',
    reactants = ['OC1=CCC2C[C]C12(2493)'],
    products = ['C7H8O(589)(588)'],
...
reaction(
    label = 'reaction883',
    reactants = ['OC1[C]CC2C=CC12(2494)'],
    products = ['C7H8O(589)(588)'],
...
reaction(
    label = 'reaction886',
    reactants = ['O[C]1C2[CH]C3C1CC23(2496)'],
    products = ['C7H8O(589)(588)'],
...
reaction(
    label = 'reaction888',
    reactants = ['OC12[CH]CC3[CH]C1C32(2498)'],
    products = ['C7H8O(589)(588)'],
...
reaction(
    label = 'reaction889',
    reactants = ['OC12[CH]CC3C1[CH]C32(2499)'],
    products = ['C7H8O(589)(588)'],
...
reaction(
    label = 'reaction885',
    reactants = ['C=CC1(O)C2C=CC21(2495)'],
    products = ['C7H8O(589)(588)'],
