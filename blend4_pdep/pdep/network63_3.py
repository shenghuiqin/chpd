...
species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.757086,'amu*angstrom^2'), symmetry=1, barrier=(17.4069,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.756946,'amu*angstrom^2'), symmetry=1, barrier=(17.4037,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
species(
    label = '[CH2][CH]OO(2766)',
    structure = SMILES('[CH2][CH]OO'),
    E0 = (224.967,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000],'cm^-1')),
        HinderedRotor(inertia=(0.00175286,'amu*angstrom^2'), symmetry=1, barrier=(5.64684,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.520078,'amu*angstrom^2'), symmetry=1, barrier=(11.9576,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.117898,'amu*angstrom^2'), symmetry=1, barrier=(39.2891,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (60.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.62834,0.0313265,-3.06559e-05,1.67869e-08,-3.81406e-12,27105.7,17.3047], Tmin=(100,'K'), Tmax=(1045.85,'K')), NASAPolynomial(coeffs=[7.09247,0.0142532,-6.16925e-06,1.17842e-09,-8.31048e-14,26171.9,-4.43241], Tmin=(1045.85,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(224.967,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: DFT_QCI_thermo + radical(CJCOOH) + radical(CCsJOOH)"""),
)
...
species(
    ...
    E0 = (320.126,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,327.41,327.683],'cm^-1')),
        HinderedRotor(inertia=(0.00157127,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0792701,'amu*angstrom^2'), symmetry=1, barrier=(6.02698,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (46.0254,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.53074,0.0263011,-3.25575e-05,1.75868e-08,-3.44157e-12,38560.4,12.4492], Tmin=(100,'K'), Tmax=(1444.13,'K')), NASAPolynomial(coeffs=[11.3479,-0.00245147,1.80561e-06,-3.531e-10,2.35585e-14,36465.3,-31.7654], Tmin=(1444.13,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(320.126,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(149.66,'J/(mol*K)'), comment="""Thermo library: FFCM1(-) + radical(CH2_triplet)"""),
)
...
species(
    ...
    E0 = (283.41,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,351.977],'cm^-1')),
        HinderedRotor(inertia=(0.137252,'amu*angstrom^2'), symmetry=1, barrier=(12.1663,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.135942,'amu*angstrom^2'), symmetry=1, barrier=(12.1642,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.138361,'amu*angstrom^2'), symmetry=1, barrier=(12.1645,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (60.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.33548,0.0334939,-3.16732e-05,1.49453e-08,-2.76444e-12,34148.9,14.9417], Tmin=(100,'K'), Tmax=(1313.33,'K')), NASAPolynomial(coeffs=[10.4183,0.00887583,-3.55595e-06,6.72526e-10,-4.75129e-14,32025.8,-26.2565], Tmin=(1313.33,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(283.41,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: DFT_QCI_thermo + radical(CH2_triplet)"""),
)
...
reaction(
    label = 'reaction10',
    reactants = ['OH(5)(5)', 'CH3CHO(35)(36)'],
    products = ['C2H5O2(61)(60)'],
    transitionState = 'TS10',
    kinetics = Arrhenius(A=(4e+09,'cm^3/(mol*s)'), n=1.39, Ea=(161.401,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), comment="""Estimated using template [Od_CO-CsH;YJ] for rate rule [Od_CO-CsH;OJ_pri]
Euclidian distance = 2.0
family: R_Addition_MultipleBond
Ea raised from 156.4 to 161.4 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction11',
    reactants = ['C2H5O2(61)(60)'],
    products = ['C2H5O2(43)(43)'],
...
reaction(
    label = 'reaction12',
    reactants = ['OH(5)(5)', 'C2H4O(197)(196)'],
    products = ['C2H5O2(61)(60)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(3)(3)', '[CH2][CH]OO(2766)'],
    products = ['C2H5O2(61)(60)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CH3(15)(16)', '[CH]OO(1409)'],
    products = ['C2H5O2(61)(60)'],
...
reaction(
    label = 'reaction24',
    reactants = ['C2H5O2(43)(43)'],
    products = ['HOCH2CH2O(2769)'],
...
reaction(
    label = 'reaction25',
    reactants = ['CH2(17)(18)', 'CH2OOH(33)(34)'],
    products = ['C2H5O2(43)(43)'],
...
network(
    ...
    reactants = [
        ...
        ('H(3)(3)', 'C2H4O2(62)(61)'),
        ('OH(5)(5)', 'CH3CHO(35)(36)'),
        ('OH(5)(5)', 'C2H4O(197)(196)'),
        ('CH2(17)(18)', 'CH2OOH(33)(34)'),
    ],
    bathGas = {
        'Ne': 0.333333,
        'N2': 0.333333,
