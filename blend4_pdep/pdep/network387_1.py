species(
    ...
    E0 = (14.9324,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2750,2850,1437.5,1250,1305,750,350,540,610,2055,3615,1277.5,1000,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,1380,1390,370,380,2900,435,214.398,214.401],'cm^-1')),
        HinderedRotor(inertia=(0.371403,'amu*angstrom^2'), symmetry=1, barrier=(12.115,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.371419,'amu*angstrom^2'), symmetry=1, barrier=(12.115,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.371418,'amu*angstrom^2'), symmetry=1, barrier=(12.1151,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.37141,'amu*angstrom^2'), symmetry=1, barrier=(12.115,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
species(
    label = '[CH2]C(C=C=C)O[O](5074)',
    structure = SMILES('[CH2]C(C=C=C)O[O]'),
    E0 = (388.722,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,3000,3100,440,815,1455,1000,540,610,2055,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,1380,1390,370,380,2900,435,180],'cm^-1')),
        HinderedRotor(inertia=(0.626375,'amu*angstrom^2'), symmetry=1, barrier=(14.4016,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.626309,'amu*angstrom^2'), symmetry=1, barrier=(14.4001,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.626413,'amu*angstrom^2'), symmetry=1, barrier=(14.4025,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.05721,0.0638673,-6.25419e-05,3.22147e-08,-6.7132e-12,46859.2,28.2858], Tmin=(100,'K'), Tmax=(1150.84,'K')), NASAPolynomial(coeffs=[12.596,0.0237614,-1.02677e-05,1.9328e-09,-1.34957e-13,44203.4,-29.0035], Tmin=(1150.84,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(388.722,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(ROOJ) + radical(CJCOOH)"""),
)
...
species(
    label = 'C=C=CC(C[O])O[O](5075)',
    structure = SMILES('C=C=CC(C[O])O[O]'),
    E0 = (240.638,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2750,2850,1437.5,1250,1305,750,350,540,610,2055,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,1380,1390,370,380,2900,435,180,180,180],'cm^-1')),
...
species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.386684,'amu*angstrom^2'), symmetry=1, barrier=(8.89062,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.386551,'amu*angstrom^2'), symmetry=1, barrier=(8.88757,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.386686,'amu*angstrom^2'), symmetry=1, barrier=(8.89067,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.386685,'amu*angstrom^2'), symmetry=1, barrier=(8.89065,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (114.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.38173,0.0840444,-0.000119422,9.34405e-08,-2.89361e-11,20054.7,30.9999], Tmin=(100,'K'), Tmax=(871.395,'K')), NASAPolynomial(coeffs=[11.0002,0.0284335,-1.18722e-05,2.11332e-09,-1.39688e-13,18464.9,-17.2702], Tmin=(871.395,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(165.696,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsOs) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + radical(C=CJC=C) + radical(ROOJ)"""),
)

species(
    label = 'C=C=CC([CH]O)O[O](5078)',
    structure = SMILES('C=C=CC([CH]O)O[O]'),
    E0 = (195.23,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,3025,407.5,1350,352.5,540,610,2055,3615,1277.5,1000,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,1380,1390,370,380,2900,435,188.199,188.202],'cm^-1')),
        HinderedRotor(inertia=(0.512783,'amu*angstrom^2'), symmetry=1, barrier=(12.8891,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.512788,'amu*angstrom^2'), symmetry=1, barrier=(12.8893,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.512749,'amu*angstrom^2'), symmetry=1, barrier=(12.8892,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.512906,'amu*angstrom^2'), symmetry=1, barrier=(12.8891,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (114.099,'amu'),
...
species(
    label = 'C=C=[C]C(CO)O[O](5079)',
    structure = SMILES('[CH2]C#CC(CO)O[O]'),
    E0 = (154.53,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,3000,3100,440,815,1455,1000,3615,1277.5,1000,2100,2250,500,550,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,222.245,222.259],'cm^-1')),
        HinderedRotor(inertia=(0.00341249,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00341315,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.251727,'amu*angstrom^2'), symmetry=1, barrier=(8.8227,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(3.41304,'amu*angstrom^2'), symmetry=1, barrier=(119.627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(3.4137,'amu*angstrom^2'), symmetry=1, barrier=(119.627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (114.099,'amu'),
...
species(
    label = '[CH]=C=CC(CO)O[O](5080)',
    structure = SMILES('[CH]=C=CC(CO)O[O]'),
    E0 = (169.409,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,3120,650,792.5,1650,2750,2850,1437.5,1250,1305,750,350,540,610,2055,3615,1277.5,1000,3010,987.5,1337.5,450,1655,1380,1390,370,380,2900,435,180],'cm^-1')),
        HinderedRotor(inertia=(0.564035,'amu*angstrom^2'), symmetry=1, barrier=(12.9683,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.567726,'amu*angstrom^2'), symmetry=1, barrier=(13.0531,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.564281,'amu*angstrom^2'), symmetry=1, barrier=(12.9739,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.567439,'amu*angstrom^2'), symmetry=1, barrier=(13.0465,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (114.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.350541,0.0825439,-0.000104821,7.15088e-08,-1.94312e-11,20504.6,32.1606], Tmin=(100,'K'), Tmax=(900.986,'K')), NASAPolynomial(coeffs=[13.0672,0.0260865,-1.08269e-05,1.95843e-09,-1.32414e-13,18213.1,-27.8636], Tmin=(900.986,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(169.409,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(ROOJ) + radical(C=C=CJ)"""),
)

species(
    label = 'C=[C]C1OOC1CO(5068)',
...
species(
    label = 'C=C=C[C](CO)OO(5069)',
    structure = SMILES('C=[C]C=C(CO)OO'),
    E0 = (13.6916,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,440,435,1725,2750,2850,1437.5,1250,1305,750,350,3615,1277.5,1000,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,3615,1310,387.5,850,1000,1685,370,284.01,284.011],'cm^-1')),
        HinderedRotor(inertia=(0.204497,'amu*angstrom^2'), symmetry=1, barrier=(11.7053,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.204496,'amu*angstrom^2'), symmetry=1, barrier=(11.7052,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.204496,'amu*angstrom^2'), symmetry=1, barrier=(11.7053,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.204497,'amu*angstrom^2'), symmetry=1, barrier=(11.7052,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.1762,'amu*angstrom^2'), symmetry=1, barrier=(67.3246,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (115.107,'amu'),
...
species(
    label = 'C=C=CC(C[O])OO(5072)',
    structure = SMILES('C=C=CC(C[O])OO'),
    E0 = (88.6329,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,540,610,2055,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,222.721,222.722,222.722],'cm^-1')),
        HinderedRotor(inertia=(0.267422,'amu*angstrom^2'), symmetry=1, barrier=(9.41342,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00339842,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.08545,'amu*angstrom^2'), symmetry=1, barrier=(38.2086,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.691037,'amu*angstrom^2'), symmetry=1, barrier=(24.3248,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (115.107,'amu'),
...
species(
    label = '[CH]=C=CC(CO)OO(5073)',
    structure = SMILES('[CH]=C=CC(CO)OO'),
    E0 = (17.4044,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3120,650,792.5,1650,540,610,2055,3615,1277.5,1000,3010,987.5,1337.5,450,1655,3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,185.696],'cm^-1')),
        HinderedRotor(inertia=(0.571406,'amu*angstrom^2'), symmetry=1, barrier=(13.9821,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.571413,'amu*angstrom^2'), symmetry=1, barrier=(13.9822,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.994163,'amu*angstrom^2'), symmetry=1, barrier=(24.3309,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.9512,'amu*angstrom^2'), symmetry=1, barrier=(72.2257,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.571205,'amu*angstrom^2'), symmetry=1, barrier=(13.9824,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (115.107,'amu'),
...
species(
    label = 'C=C=CC([O])CO(5084)',
    structure = SMILES('C=C=CC([O])CO'),
    E0 = (21.7835,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,540,610,2055,3615,1277.5,1000,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,1380,1390,370,380,2900,435,352.886,352.887,352.888],'cm^-1')),
        HinderedRotor(inertia=(0.149179,'amu*angstrom^2'), symmetry=1, barrier=(13.1827,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.149167,'amu*angstrom^2'), symmetry=1, barrier=(13.1825,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.149186,'amu*angstrom^2'), symmetry=1, barrier=(13.1826,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
reaction(
    label = 'reaction8',
    reactants = ['OH(5)(5)', '[CH2]C(C=C=C)O[O](5074)'],
    products = ['S(240)(239)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction9',
    reactants = ['H(3)(3)', 'C=C=CC(C[O])O[O](5075)'],
    products = ['S(240)(239)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction10',
    reactants = ['CH2OH(22)(23)', 'C=C=C[CH]O[O](5076)'],
    products = ['S(240)(239)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction11',
    reactants = ['H2CCCH(841)', '[O]O[CH]CO(4493)'],
    products = ['S(240)(239)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction12',
    reactants = ['H(3)(3)', 'C=C=C[C](CO)O[O](5077)'],
    products = ['S(240)(239)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction13',
    reactants = ['H(3)(3)', 'C=C=CC([CH]O)O[O](5078)'],
    products = ['S(240)(239)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction14',
    reactants = ['H(3)(3)', 'C=C=[C]C(CO)O[O](5079)'],
    products = ['S(240)(239)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction15',
    reactants = ['H(3)(3)', '[CH]=C=CC(CO)O[O](5080)'],
    products = ['S(240)(239)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(2.048e+13,'cm^3/(mol*s)'), n=0.206, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""From training reaction 44 used for Cd_allenic;H_rad
Exact match found for rate rule [Cd_allenic;H_rad]
...
reaction(
    label = 'reaction18',
    reactants = ['H2O(7)(7)', 'C=C=CC(=C)O[O](5083)'],
    products = ['S(240)(239)'],
...
reaction(
    label = 'reaction19',
    reactants = ['C2H3O2(44)(44)', 'C=C=CO(2815)'],
    products = ['S(240)(239)'],
...
reaction(
    label = 'reaction20',
    reactants = ['S(240)(239)'],
    products = ['HO2(8)(9)', 'C=C=CC=CO(4279)'],
...
reaction(
    label = 'reaction22',
    reactants = ['O(4)(4)', 'C=C=CC([O])CO(5084)'],
    products = ['S(240)(239)'],
