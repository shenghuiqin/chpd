...
species(
    label = '[CH2]CC(=C)[O](3558)',
    structure = SMILES('[CH2]CC(=C)[O]'),
    E0 = (111.971,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,350,440,435,1725,460.508,4000],'cm^-1')),
        HinderedRotor(inertia=(0.765425,'amu*angstrom^2'), symmetry=1, barrier=(17.5986,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.040105,'amu*angstrom^2'), symmetry=1, barrier=(17.5479,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
species(
    label = 'C=C([O])C[CH]C(7771)',
    structure = SMILES('C=C([O])C[CH]C'),
    E0 = (77.3905,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,440,435,1725,2750,2850,1437.5,1250,1305,750,350,2950,3100,1380,975,1025,1650,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,180,1155.56,2432.54],'cm^-1')),
        HinderedRotor(inertia=(0.616305,'amu*angstrom^2'), symmetry=1, barrier=(14.1701,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.202163,'amu*angstrom^2'), symmetry=1, barrier=(14.1585,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00337504,'amu*angstrom^2'), symmetry=1, barrier=(14.1681,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.48252,0.0510132,-3.58758e-05,1.38607e-08,-2.24437e-12,9402.05,25.654], Tmin=(100,'K'), Tmax=(1423.92,'K')), NASAPolynomial(coeffs=[10.2396,0.0264131,-9.96127e-06,1.72761e-09,-1.14142e-13,6908.19,-19.6887], Tmin=(1423.92,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(77.3905,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(C=C(C)OJ) + radical(RCCJC)"""),
)
...
species(
    label = 'C=C([O])[CH]CC(7772)',
    structure = SMILES('[CH2]C([O])=CCC'),
    E0 = (29.6155,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,440,435,1725,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,331.255,331.676],'cm^-1')),
        HinderedRotor(inertia=(0.00153075,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.110466,'amu*angstrom^2'), symmetry=1, barrier=(8.63344,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.110732,'amu*angstrom^2'), symmetry=1, barrier=(8.63561,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
...
species(
    label = '[CH2]CCC(=C)[O](7773)',
    structure = SMILES('[CH2]CCC(=C)[O]'),
    E0 = (88.1906,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,350,440,435,1725,180,180,4000],'cm^-1')),
        HinderedRotor(inertia=(0.00964205,'amu*angstrom^2'), symmetry=1, barrier=(1.72359,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0975531,'amu*angstrom^2'), symmetry=1, barrier=(17.4041,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0969712,'amu*angstrom^2'), symmetry=1, barrier=(17.4,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
...
species(
    label = 'C=C(O)[CH]CC(7776)',
    structure = SMILES('[CH2]C(O)=CCC'),
    E0 = (-108.189,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,440,435,1725,3000,3100,440,815,1455,1000,3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,361.509],'cm^-1')),
        HinderedRotor(inertia=(0.144103,'amu*angstrom^2'), symmetry=1, barrier=(13.3649,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.144109,'amu*angstrom^2'), symmetry=1, barrier=(13.3647,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.144124,'amu*angstrom^2'), symmetry=1, barrier=(13.3649,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.144146,'amu*angstrom^2'), symmetry=1, barrier=(13.3651,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (85.1244,'amu'),
...
species(
    label = '[CH]=C(O)CCC(7777)',
    structure = SMILES('[CH]=C(O)CCC'),
    E0 = (-7.76444,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,440,435,1725,3615,1277.5,1000,3120,650,792.5,1650,2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,305.974],'cm^-1')),
        HinderedRotor(inertia=(0.198719,'amu*angstrom^2'), symmetry=1, barrier=(13.1927,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.198345,'amu*angstrom^2'), symmetry=1, barrier=(13.192,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.198323,'amu*angstrom^2'), symmetry=1, barrier=(13.1933,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.198472,'amu*angstrom^2'), symmetry=1, barrier=(13.1925,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (85.1244,'amu'),
...
species(
    label = 'C=C(O)C[CH]C(7778)',
    structure = SMILES('C=C(O)C[CH]C'),
    E0 = (-60.4143,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,440,435,1725,2750,2850,1437.5,1250,1305,750,350,3025,407.5,1350,352.5,3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,2950,3100,1380,975,1025,1650,430.748,435.128],'cm^-1')),
        HinderedRotor(inertia=(0.000886935,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0767493,'amu*angstrom^2'), symmetry=1, barrier=(10.1257,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0765415,'amu*angstrom^2'), symmetry=1, barrier=(10.1469,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.075704,'amu*angstrom^2'), symmetry=1, barrier=(10.1442,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (85.1244,'amu'),
...
species(
    label = '[CH2]CCC(=C)O(7779)',
    structure = SMILES('[CH2]CCC(=C)O'),
    E0 = (-49.6142,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,350,440,435,1725,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,390.489,390.5],'cm^-1')),
        HinderedRotor(inertia=(0.00110548,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.12541,'amu*angstrom^2'), symmetry=1, barrier=(13.5709,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.125415,'amu*angstrom^2'), symmetry=1, barrier=(13.571,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.125409,'amu*angstrom^2'), symmetry=1, barrier=(13.5708,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (85.1244,'amu'),
...
species(
    label = '[CH2]CCC(C)=O(7783)',
    structure = SMILES('[CH2]CCC(C)=O'),
    E0 = (-76.7278,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,375,552.5,462.5,1710,190.969,4000],'cm^-1')),
        HinderedRotor(inertia=(0.324807,'amu*angstrom^2'), symmetry=1, barrier=(8.46103,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.326346,'amu*angstrom^2'), symmetry=1, barrier=(8.4606,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0167219,'amu*angstrom^2'), symmetry=1, barrier=(29.1449,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00459853,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (85.1244,'amu'),
...
species(
    label = '[CH2]C(=C)OCC(7785)',
    structure = SMILES('[CH2]C(=C)OCC'),
    E0 = (-68.3818,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,328.23,328.236,328.24],'cm^-1')),
        HinderedRotor(inertia=(0.00156463,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.22548,'amu*angstrom^2'), symmetry=1, barrier=(17.2389,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.225492,'amu*angstrom^2'), symmetry=1, barrier=(17.2389,'kJ/mol'), semiclassical=False),
...
reaction(
    label = 'reaction1',
    reactants = ['C3H7(69)(68)', 'CH2CO(26)(27)'],
    products = ['C5H9O(129)(128)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['C2H5(27)(28)', 'C3H4O(122)(121)'],
    products = ['C5H9O(129)(128)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH3(15)(16)', '[CH2]CC(=C)[O](3558)'],
    products = ['C5H9O(129)(128)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)(3)', 'C=C([O])C[CH]C(7771)'],
    products = ['C5H9O(129)(128)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['C3H7(69)(68)', '[CH2][C]=O(1196)'],
    products = ['C5H9O(129)(128)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['H(3)(3)', 'C=C([O])[CH]CC(7772)'],
    products = ['C5H9O(129)(128)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(3)(3)', '[CH2]CCC(=C)[O](7773)'],
    products = ['C5H9O(129)(128)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(3)(3)', '[CH]=C([O])CCC(7774)'],
    products = ['C5H9O(129)(128)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['CH2(S)(21)(22)', 'C=C([O])CC(7775)'],
    products = ['C5H9O(129)(128)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction14',
    reactants = ['C5H9O(129)(128)'],
    products = ['CCC[C]1CO1(7780)'],
...
reaction(
    label = 'reaction21',
    reactants = ['CH2(17)(18)', 'CCC[C]=O(6561)'],
    products = ['C5H9O(129)(128)'],
...
network(
    ...
    reactants = [
        ('C3H7(69)(68)', 'CH2CO(26)(27)'),
        ('C2H5(27)(28)', 'C3H4O(122)(121)'),
    ],
    bathGas = {
        'Ne': 0.333333,
        'N2': 0.333333,
