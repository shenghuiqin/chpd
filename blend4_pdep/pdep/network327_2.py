...
species(
    label = '[CH2]C[CH]C(873)',
    structure = SMILES('[CH2]C[CH]C'),
    E0 = (255.669,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,2031.2],'cm^-1')),
        HinderedRotor(inertia=(0.244955,'amu*angstrom^2'), symmetry=1, barrier=(5.632,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.244968,'amu*angstrom^2'), symmetry=1, barrier=(5.6323,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00192326,'amu*angstrom^2'), symmetry=1, barrier=(5.63125,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (56.1063,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.98997,0.0287412,-9.51473e-06,4.19256e-10,1.9052e-13,30780.1,16.8971], Tmin=(100,'K'), Tmax=(2154.58,'K')), NASAPolynomial(coeffs=[12.4234,0.0182237,-7.06296e-06,1.16765e-09,-7.1179e-14,25091.2,-39.6233], Tmin=(2154.58,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(255.669,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: DFT_QCI_thermo + radical(RCCJ) + radical(RCCJC)"""),
)

species(
    label = 'C[CH]CCO[O](4506)',
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.211134,'amu*angstrom^2'), symmetry=1, barrier=(4.85438,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.210153,'amu*angstrom^2'), symmetry=1, barrier=(4.83184,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.210945,'amu*angstrom^2'), symmetry=1, barrier=(4.85005,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.211156,'amu*angstrom^2'), symmetry=1, barrier=(4.8549,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (88.1051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.53013,0.0598852,-7.45205e-05,6.46922e-08,-2.34842e-11,13773.5,25.4289], Tmin=(100,'K'), Tmax=(824.016,'K')), NASAPolynomial(coeffs=[3.73808,0.038831,-1.7379e-05,3.23956e-09,-2.21488e-13,13760.5,17.3335], Tmin=(824.016,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(113.824,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(RCCJC)"""),
)
...
species(
    label = 'C[CH][CH]COO(4513)',
    structure = SMILES('C[CH][CH]COO'),
    E0 = (162.235,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,3000,3050,390,425,1340,1360,335,370,2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2850,1437.5,1250,1305,750,350,220.677,2184.72],'cm^-1')),
        HinderedRotor(inertia=(1.39005,'amu*angstrom^2'), symmetry=1, barrier=(48.3536,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(3.52918e-05,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.39078,'amu*angstrom^2'), symmetry=1, barrier=(48.3434,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.221218,'amu*angstrom^2'), symmetry=1, barrier=(7.71027,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.222935,'amu*angstrom^2'), symmetry=1, barrier=(7.70946,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (88.1051,'amu'),
...
species(
    label = '[CH2][CH]CCOO(4515)',
    structure = SMILES('[CH2][CH]CCOO'),
    E0 = (167.066,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,3000,3100,440,815,1455,1000,3025,407.5,1350,352.5,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,302.33,2072.33],'cm^-1')),
        HinderedRotor(inertia=(0.0888216,'amu*angstrom^2'), symmetry=1, barrier=(5.76048,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00189035,'amu*angstrom^2'), symmetry=1, barrier=(5.76083,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0888393,'amu*angstrom^2'), symmetry=1, barrier=(5.76096,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.774936,'amu*angstrom^2'), symmetry=1, barrier=(50.2951,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.775556,'amu*angstrom^2'), symmetry=1, barrier=(50.2949,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (88.1051,'amu'),
...
species(
    label = '[CH2]C(C)COO(4516)',
    structure = SMILES('[CH2]C(C)COO'),
    E0 = (-36.5857,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,198.625],'cm^-1')),
        HinderedRotor(inertia=(0.464213,'amu*angstrom^2'), symmetry=1, barrier=(12.955,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00426511,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.451715,'amu*angstrom^2'), symmetry=1, barrier=(12.9972,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.60254,'amu*angstrom^2'), symmetry=1, barrier=(74.8265,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0267247,'amu*angstrom^2'), symmetry=1, barrier=(74.802,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (89.1131,'amu'),
...
species(
    label = 'CC[CH]CO[O](3046)',
    structure = SMILES('CC[CH]CO[O]'),
    E0 = (119.793,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,294.099,1859.45],'cm^-1')),
        HinderedRotor(inertia=(0.13419,'amu*angstrom^2'), symmetry=1, barrier=(8.24312,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.134097,'amu*angstrom^2'), symmetry=1, barrier=(8.24416,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.134132,'amu*angstrom^2'), symmetry=1, barrier=(8.24416,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.134019,'amu*angstrom^2'), symmetry=1, barrier=(8.24294,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (88.1051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.78446,0.0552923,-4.00059e-05,-3.32756e-09,1.89417e-11,14481.3,24.1614], Tmin=(100,'K'), Tmax=(545.244,'K')), NASAPolynomial(coeffs=[5.82124,0.0361869,-1.6357e-05,3.10669e-09,-2.16674e-13,13884.8,5.70216], Tmin=(545.244,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(119.793,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(CCJCOOH)"""),
)
...
species(
    label = '[CH2]CCCO[O](4508)',
    structure = SMILES('[CH2]CCCO[O]'),
    E0 = (124.625,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,3000,3100,440,815,1455,1000,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,314.507,1633.79],'cm^-1')),
        HinderedRotor(inertia=(0.107718,'amu*angstrom^2'), symmetry=1, barrier=(7.5582,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.107667,'amu*angstrom^2'), symmetry=1, barrier=(7.55844,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.107916,'amu*angstrom^2'), symmetry=1, barrier=(7.55791,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.10761,'amu*angstrom^2'), symmetry=1, barrier=(7.55985,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (88.1051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.51474,0.0584856,-5.77492e-05,3.65979e-08,-1.02894e-11,15075,24.5481], Tmin=(100,'K'), Tmax=(833.738,'K')), NASAPolynomial(coeffs=[6.38667,0.0351122,-1.56985e-05,2.9745e-09,-2.07471e-13,14262.6,1.92963], Tmin=(833.738,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(124.625,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(RCCJ)"""),
)
...
reaction(
    label = 'reaction22',
    reactants = ['OH(5)(5)', 'C[CH]CC[O](4512)'],
    products = ['C4H9O2(96)(95)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction23',
    reactants = ['HO2(8)(9)', '[CH2]C[CH]C(873)'],
    products = ['C4H9O2(96)(95)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction24',
    reactants = ['H(3)(3)', 'C[CH]CCO[O](4506)'],
    products = ['C4H9O2(96)(95)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction25',
    reactants = ['CH2OOH(33)(34)', 'C3H6(T)(876)'],
    products = ['C4H9O2(96)(95)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction26',
    reactants = ['H(3)(3)', 'C[CH][CH]COO(4513)'],
    products = ['C4H9O2(96)(95)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction27',
    reactants = ['H(3)(3)', 'C[CH]C[CH]OO(4514)'],
    products = ['C4H9O2(96)(95)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction28',
    reactants = ['H(3)(3)', '[CH2][CH]CCOO(4515)'],
    products = ['C4H9O2(96)(95)'],
...
reaction(
    label = 'reaction32',
    reactants = ['C2H5O2(43)(43)', 'CHCH3(T)(883)'],
    products = ['C4H9O2(96)(95)'],
...
reaction(
    label = 'reaction33',
    reactants = ['CH3(15)(16)', '[CH]CCOO(4518)'],
    products = ['C4H9O2(96)(95)'],
...
reaction(
    label = 'reaction6',
    reactants = ['C2H5(27)(28)', '[CH2]CO[O](1359)'],
    products = ['C4H9O2(76)(75)'],
...
reaction(
    label = 'reaction7',
    reactants = ['C3H7(69)(68)', '[CH2]O[O](1192)'],
    products = ['C4H9O2(76)(75)'],
...
reaction(
    label = 'reaction8',
    reactants = ['H(3)(3)', 'CC[CH]CO[O](3046)'],
    products = ['C4H9O2(76)(75)'],
...
reaction(
    label = 'reaction9',
    reactants = ['CH3(15)(16)', '[CH2]CCO[O](4505)'],
    products = ['C4H9O2(76)(75)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(3)(3)', 'CCC[CH]O[O](4507)'],
    products = ['C4H9O2(76)(75)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(3)(3)', '[CH2]CCCO[O](4508)'],
    products = ['C4H9O2(76)(75)'],
