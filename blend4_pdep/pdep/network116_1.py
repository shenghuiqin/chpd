...
species(
    label = '[CH]1C[C]2C=CC(C2)O1(2126)',
...
species(
    label = '[CH]1CC2[CH]C(C=C2)O1(2129)',
...
species(
    label = '[C]1=CC2[CH]CC(C2)O1(2137)',
...
species(
    label = '[C]1=CC2C[CH]C(C2)O1(2142)',
...
species(
    label = '[CH]1C2[CH]C3C1OC3C2(2152)',
...
reaction(
    label = 'reaction330',
    reactants = ['H(3)(3)', 'C1=C[C]2C=CC(C2)O1(2118)'],
...
reaction(
    label = 'reaction331',
    reactants = ['H(3)(3)', '[CH]1C2C=COC1C=C2(2119)'],
    products = ['C7H8O(565)(564)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction332',
    reactants = ['H(3)(3)', 'C1=CC2C=C[C](C2)O1(2120)'],
    products = ['C7H8O(565)(564)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction333',
    reactants = ['H(3)(3)', '[C]1=CC2CC1C=CO2(2121)'],
    products = ['C7H8O(565)(564)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction334',
    reactants = ['H(3)(3)', '[C]1=CC2C=COC1C2(2122)'],
    products = ['C7H8O(565)(564)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(1e+13,'cm^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""From training reaction 40 used for Cd_rad/NonDe;H_rad
Exact match found for rate rule [Cd_rad/NonDe;H_rad]
...
reaction(
    label = 'reaction335',
    reactants = ['H(3)(3)', '[C]1=COC2C=CC1C2(2123)'],
    products = ['C7H8O(565)(564)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(1e+13,'cm^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""From training reaction 40 used for Cd_rad/NonDe;H_rad
Exact match found for rate rule [Cd_rad/NonDe;H_rad]
...
reaction(
    label = 'reaction336',
    reactants = ['H(3)(3)', '[C]1=CC2C=CC(C2)O1(2124)'],
    products = ['C7H8O(565)(564)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(1e+13,'cm^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""From training reaction 40 used for Cd_rad/NonDe;H_rad
...
reaction(
    label = 'reaction337',
    reactants = ['[CH]1C[C]2C=COC1C2(2125)'],
    products = ['C7H8O(565)(564)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction338',
    reactants = ['[CH]1C[C]2C=CC(C2)O1(2126)'],
    products = ['C7H8O(565)(564)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(5.10299e+10,'s^-1'), n=0.2847, Ea=(23.1459,'kJ/mol'), T0=(1,'K'), comment="""Estimated using average of templates [Rn;Y_rad_NDe;XH_Rrad_NDe] + [R2radExo;Y_rad;XH_Rrad_NDe] for rate rule [R2radExo;Y_rad_NDe;XH_Rrad_NDe]
Euclidian distance = 1.0
...
reaction(
    label = 'reaction339',
    reactants = ['[CH]1C[C]2CC1C=CO2(2127)'],
    products = ['C7H8O(565)(564)'],
...
reaction(
    label = 'reaction340',
    reactants = ['[CH]1CO[C]2C=CC1C2(2128)'],
    products = ['C7H8O(565)(564)'],
...
reaction(
    label = 'reaction341',
    reactants = ['[CH]1CC2[CH]C1OC=C2(2035)'],
    products = ['C7H8O(565)(564)'],
...
reaction(
    label = 'reaction342',
    reactants = ['[CH]1CC2[CH]C(C=C2)O1(2129)'],
    products = ['C7H8O(565)(564)'],
...
reaction(
    label = 'reaction343',
    reactants = ['[C]1=CC2CC1C[CH]O2(2130)'],
    products = ['C7H8O(565)(564)'],
...
reaction(
    label = 'reaction344',
    reactants = ['[C]1=COC2[CH]CC1C2(2131)'],
    products = ['C7H8O(565)(564)'],
...
reaction(
    label = 'reaction345',
    reactants = ['[CH]1CC2[CH]C1C=CO2(2132)'],
    products = ['C7H8O(565)(564)'],
...
reaction(
    label = 'reaction346',
    reactants = ['[CH]1CC2C=C[C](C2)O1(2133)'],
    products = ['C7H8O(565)(564)'],
...
reaction(
    label = 'reaction347',
    reactants = ['[CH]1COC2[CH]C1C=C2(2134)'],
    products = ['C7H8O(565)(564)'],
...
reaction(
    label = 'reaction348',
    reactants = ['[C]1=CC2CC1[CH]CO2(2135)'],
    products = ['C7H8O(565)(564)'],
...
reaction(
    label = 'reaction349',
    reactants = ['[C]1=COC2C[CH]C1C2(2136)'],
    products = ['C7H8O(565)(564)'],
...
reaction(
    label = 'reaction350',
    reactants = ['[C]1=CC2[CH]CC(C2)O1(2137)'],
    products = ['C7H8O(565)(564)'],
...
reaction(
    label = 'reaction351',
    reactants = ['[CH]1CC2C=CO[C]1C2(2138)'],
    products = ['C7H8O(565)(564)'],
...
reaction(
    label = 'reaction352',
    reactants = ['[CH]1CC2C[C]1C=CO2(2139)'],
    products = ['C7H8O(565)(564)'],
...
reaction(
    label = 'reaction353',
    reactants = ['[C]1=CC2[CH]COC1C2(2140)'],
    products = ['C7H8O(565)(564)'],
...
reaction(
    label = 'reaction354',
    reactants = ['[C]1=CC2C[CH]OC1C2(2141)'],
    products = ['C7H8O(565)(564)'],
...
reaction(
    label = 'reaction355',
    reactants = ['[C]1=CC2C[CH]C(C2)O1(2142)'],
    products = ['C7H8O(565)(564)'],
...
reaction(
    label = 'reaction356',
    reactants = ['[CH]1COC2C=C[C]1C2(2143)'],
    products = ['C7H8O(565)(564)'],
...
reaction(
    label = 'reaction357',
    reactants = ['[CH]=CC1C=CO[CH]C1(2144)'],
    products = ['C7H8O(565)(564)'],
...
reaction(
    label = 'reaction360',
    reactants = ['[CH2]C1C=C[CH]C=CO1(2145)'],
    products = ['C7H8O(565)(564)'],
...
reaction(
    label = 'reaction361',
    reactants = ['[CH]=COC1C=C[CH]C1(2146)'],
    products = ['C7H8O(565)(564)'],
...
reaction(
    label = 'reaction362',
    reactants = ['[CH]=CC1C=CC([O])C1(2147)'],
    products = ['C7H8O(565)(564)'],
...
reaction(
    label = 'reaction367',
    reactants = ['[C-]1CC2C=CC(C2)[O+]=1(2151)'],
    products = ['C7H8O(565)(564)'],
...
reaction(
    label = 'reaction368',
    reactants = ['[CH]1C2[CH]C3C1OC3C2(2152)'],
    products = ['C7H8O(565)(564)'],
