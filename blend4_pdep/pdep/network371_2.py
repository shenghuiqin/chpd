...
species(
    label = '[CH2]C([O])C=CC=O(6099)',
    structure = SMILES('[CH2]C([O])C=CC=O'),
    E0 = (129.133,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,1380,1390,370,380,2900,435,2782.5,750,1395,475,1775,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,396.576,401.251],'cm^-1')),
        HinderedRotor(inertia=(0.11889,'amu*angstrom^2'), symmetry=1, barrier=(13.4126,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.119137,'amu*angstrom^2'), symmetry=1, barrier=(13.4248,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.118341,'amu*angstrom^2'), symmetry=1, barrier=(13.3969,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (98.0999,'amu'),
...
species(
    label = 'CC(=O)C=[C]C[O](6101)',
    structure = SMILES('CC(=O)C=[C]C[O]'),
    E0 = (147.892,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,1685,370,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,375,552.5,462.5,1710,180,2170.26,2171.37],'cm^-1')),
        HinderedRotor(inertia=(0.238406,'amu*angstrom^2'), symmetry=1, barrier=(5.48143,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.238847,'amu*angstrom^2'), symmetry=1, barrier=(5.49156,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.238564,'amu*angstrom^2'), symmetry=1, barrier=(5.48506,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.73058,0.0609166,-9.78602e-05,1.04693e-07,-4.30929e-11,17858.2,26.4445], Tmin=(100,'K'), Tmax=(816.62,'K')), NASAPolynomial(coeffs=[-0.866258,0.0471679,-2.39873e-05,4.6944e-09,-3.28285e-13,19164.9,43.8504], Tmin=(816.62,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(147.892,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-(Cds-O2d)HHH) + group(Cds-CdsCsH) + group(Cds-O2d(Cds-Cds)Cs) + group(Cd-Cd(CO)H) + radical(CCOJ) + radical(Cds_S)"""),
)

species(
    label = 'CC(=O)[CH]C[C]=O(6102)',
    structure = SMILES('CC([O])=CC[C]=O'),
    E0 = (-45.9575,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,440,435,1725,2750,2850,1437.5,1250,1305,750,350,1855,455,950,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,411.518,411.52],'cm^-1')),
        HinderedRotor(inertia=(0.0790416,'amu*angstrom^2'), symmetry=1, barrier=(9.49932,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0790447,'amu*angstrom^2'), symmetry=1, barrier=(9.49937,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0790447,'amu*angstrom^2'), symmetry=1, barrier=(9.49925,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.09955,0.0556405,-4.28036e-05,1.58893e-08,-2.33272e-12,-5416.27,26.2785], Tmin=(100,'K'), Tmax=(1614.98,'K')), NASAPolynomial(coeffs=[16.2791,0.0180429,-7.88235e-06,1.47346e-09,-1.01106e-13,-10319.1,-54.2298], Tmin=(1614.98,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-45.9575,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + group(Cds-OdCsH) + radical(CCCJ=O) + radical(C=C(C)OJ)"""),
)

species(
    label = '[CH2]C(=O)C[CH]C=O(6103)',
...
species(
    label = '[CH2]C(=O)[CH]CC=O(6106)',
    structure = SMILES('[CH2]C([O])=CCC=O'),
    E0 = (-47.0015,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,3010,987.5,1337.5,450,1655,2782.5,750,1395,475,1775,1000,350,440,435,1725,464.41,464.626],'cm^-1')),
        HinderedRotor(inertia=(0.000787642,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0942044,'amu*angstrom^2'), symmetry=1, barrier=(14.4767,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0946158,'amu*angstrom^2'), symmetry=1, barrier=(14.4927,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (98.0999,'amu'),
...
species(
    label = 'CC(=O)[C]CC=O(6110)',
    structure = SMILES('CC(=O)[C]CC=O'),
    E0 = (67.471,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,2782.5,750,1395,475,1775,1000,375,552.5,462.5,1710,180,2598.61,2599.62],'cm^-1')),
        HinderedRotor(inertia=(1.04719,'amu*angstrom^2'), symmetry=1, barrier=(24.0771,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.31721,'amu*angstrom^2'), symmetry=1, barrier=(53.2773,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.31901,'amu*angstrom^2'), symmetry=1, barrier=(53.3185,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.31616,'amu*angstrom^2'), symmetry=1, barrier=(53.2531,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (98.0999,'amu'),
...
species(
    ...
    E0 = (-117.364,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,2782.5,750,1395,475,1775,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680],'cm^-1')),
...
species(
    label = 'C=C(O)C=CC=O(6114)',
    structure = SMILES('C=C(O)C=CC=O'),
    E0 = (-243.46,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2950,3100,1380,975,1025,1650,2995,3025,975,1000,1300,1375,400,500,1630,1680,2782.5,750,1395,475,1775,1000,350,440,435,1725,180],'cm^-1')),
        HinderedRotor(inertia=(0.941309,'amu*angstrom^2'), symmetry=1, barrier=(21.6425,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.938608,'amu*angstrom^2'), symmetry=1, barrier=(21.5804,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.939949,'amu*angstrom^2'), symmetry=1, barrier=(21.6113,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (98.0999,'amu'),
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)(3)', '[CH2]C(=O)C=CC=O(6095)'],
    products = ['S(247)(246)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH3CO(55)(54)', 'CHCHCHO(1679)'],
    products = ['S(247)(246)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['HCO(14)(15)', '[CH]=CC(C)=O(4552)'],
    products = ['S(247)(246)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['H(3)(3)', 'CC(=O)C=[C]C=O(6097)'],
    products = ['S(247)(246)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(6.117e+14,'cm^3/(mol*s)'), n=-0.152, Ea=(4.19655,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [Cd_rad/OneDe;H_rad]
Euclidian distance = 0
...
reaction(
    label = 'reaction7',
    reactants = ['H(3)(3)', 'CC(=O)C=C[C]=O(6098)'],
    products = ['S(247)(246)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]C(=O)C[CH]C=O(6103)'],
    products = ['S(247)(246)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]C(=O)[CH]CC=O(6106)'],
    products = ['S(247)(246)'],
...
reaction(
    label = 'reaction24',
    reactants = ['CO(10)(11)', 'C=CC(C)=O(6112)'],
    products = ['S(247)(246)'],
...
reaction(
    label = 'reaction25',
    reactants = ['CO(10)(11)', 'CC=CC=O(6113)'],
    products = ['S(247)(246)'],
