species(
    ...
    E0 = (-226.17,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2782.5,750,1395,475,1775,1000,180,1119.27,1119.92,1120.13,1121.12],'cm^-1')),
        HinderedRotor(inertia=(0.0315567,'amu*angstrom^2'), symmetry=1, barrier=(3.3129,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
species(
    ...
    E0 = (-75.547,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1855,455,950,212.291,526.244,1512.78,1512.8,1513.01],'cm^-1')),
        HinderedRotor(inertia=(0.00374357,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    ...
    collisionModel = TransportData(shapeIndex=2, epsilon=(3660.03,'J/mol'), sigma=(4.01,'angstroms'), dipoleMoment=(0,'De'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=2.0, comment="""NOx2018"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.25517,0.0153986,-1.14127e-05,4.27371e-09,-6.53609e-13,-9058.67,11.1484], Tmin=(100,'K'), Tmax=(1510.38,'K')), NASAPolynomial(coeffs=[6.45864,0.00691472,-2.98719e-06,5.54757e-10,-3.80441e-14,-10026.4,-5.62752], Tmin=(1510.38,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-75.547,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(108.088,'J/(mol*K)'), label="""OCHCO""", comment="""Thermo library: DFT_QCI_thermo"""),
)
