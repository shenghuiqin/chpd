...
reaction(
    label = 'reaction1',
    reactants = ['H(3)(3)', 'C1=C[CH]C=CC=1(1509)'],
    products = ['C6H6(468)(467)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(2.2e+14,'cm^3/(mol*s)','+|-',8e+13), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1200,'K'), comment="""Matched reaction 62 H + C6H5 <=> C6H6-4 in R_Recombination/training
This reaction matched rate rule [Cb_rad;H_rad]
family: R_Recombination"""),
)

reaction(
    label = 'reaction2',
    reactants = ['[C]1=CC=C[CH]C1(1463)'],
    products = ['C6H6(468)(467)'],
    transitionState = 'TS2',
