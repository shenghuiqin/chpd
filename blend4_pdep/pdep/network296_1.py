species(
    label = '[CH2]CO[CH]C(3563)',
    structure = SMILES('[CH2]CO[CH]C'),
    E0 = (118.672,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,289.001,289.107,289.133],'cm^-1')),
        HinderedRotor(inertia=(0.00201829,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00201884,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.218152,'amu*angstrom^2'), symmetry=1, barrier=(12.9299,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.21809,'amu*angstrom^2'), symmetry=1, barrier=(12.9303,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
species(
    label = 'C=CO[CH]C(5743)',
    structure = SMILES('C=CO[CH]C'),
    E0 = (8.42042,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,3100,1380,975,1025,1650,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,3025,407.5,1350,352.5,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.936322,'amu*angstrom^2'), symmetry=1, barrier=(21.5279,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.937646,'amu*angstrom^2'), symmetry=1, barrier=(21.5583,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.938584,'amu*angstrom^2'), symmetry=1, barrier=(21.5799,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
species(
    label = '[CH2]COC[CH2](5745)',
    structure = SMILES('[CH2]COC[CH2]'),
    E0 = (149.805,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,180,180,3221.49],'cm^-1')),
        HinderedRotor(inertia=(1.42456,'amu*angstrom^2'), symmetry=1, barrier=(32.7535,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.69458,'amu*angstrom^2'), symmetry=1, barrier=(15.9698,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0635292,'amu*angstrom^2'), symmetry=1, barrier=(11.5705,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00444751,'amu*angstrom^2'), symmetry=1, barrier=(32.7535,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (72.1057,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.60944,0.0555484,-5.52785e-05,3.29953e-08,-8.45219e-12,18101,20.1514], Tmin=(100,'K'), Tmax=(921.757,'K')), NASAPolynomial(coeffs=[7.58644,0.0296105,-1.30682e-05,2.46582e-09,-1.71773e-13,16999.1,-8.19709], Tmin=(921.757,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(149.805,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJCO) + radical(CJCO)"""),
)

species(
    label = '[CH2][CH]OCC(5746)',
...
species(
    ...
    E0 = (132.786,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,1071.61,3134.97],'cm^-1')),
        HinderedRotor(inertia=(0.569411,'amu*angstrom^2'), symmetry=1, barrier=(13.5442,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.589076,'amu*angstrom^2'), symmetry=1, barrier=(13.544,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.589104,'amu*angstrom^2'), symmetry=1, barrier=(13.5447,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]CO[CH]C(3563)'],
    products = ['C2H4(19)(20)', 'CH3CHO(35)(36)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)(3)', 'C=CO[CH]C(5743)'],
    products = ['[CH2]CO[CH]C(3563)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)(3)', '[CH2]COC=C(3567)'],
    products = ['[CH2]CO[CH]C(3563)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CH3CHO(35)(36)', 'C2H4(T)(899)'],
    products = ['[CH2]CO[CH]C(3563)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction8',
    reactants = ['C2H4O(197)(196)', 'C2H4(T)(899)'],
    products = ['[CH2]CO[CH]C(3563)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction11',
    reactants = ['CHCH3(T)(883)', '[CH2]C[O](1195)'],
    products = ['[CH2]CO[CH]C(3563)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CH2(17)(18)', '[CH2]O[CH]C(4894)'],
    products = ['[CH2]CO[CH]C(3563)'],
