...
species(
    label = '[CH2]C[CH]CC(886)',
    structure = SMILES('[CH2]C[CH]CC'),
    E0 = (231.62,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,1731.3,1731.42],'cm^-1')),
        HinderedRotor(inertia=(0.154585,'amu*angstrom^2'), symmetry=1, barrier=(3.55421,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.154495,'amu*angstrom^2'), symmetry=1, barrier=(3.55215,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.154506,'amu*angstrom^2'), symmetry=1, barrier=(3.55239,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.154554,'amu*angstrom^2'), symmetry=1, barrier=(3.55351,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (70.1329,'amu'),
...
species(
    label = '[CH2]CC[CH]C(874)',
    structure = SMILES('[CH2]CC[CH]C'),
    E0 = (231.608,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,2178.93,2179.39],'cm^-1')),
        HinderedRotor(inertia=(0.346183,'amu*angstrom^2'), symmetry=1, barrier=(7.95942,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0315822,'amu*angstrom^2'), symmetry=1, barrier=(10.6554,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0144417,'amu*angstrom^2'), symmetry=1, barrier=(48.7108,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.46253,'amu*angstrom^2'), symmetry=1, barrier=(10.6345,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (70.1329,'amu'),
...
species(
    ...
    E0 = (260.58,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,180,180,2094.97],'cm^-1')),
...
species(
    ...
    molecularWeight = (70.1329,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.73746,0.0485764,-2.66698e-05,6.98396e-09,-7.35874e-13,34120.6,20.1126], Tmin=(100,'K'), Tmax=(2079.1,'K')), NASAPolynomial(coeffs=[13.2219,0.0264816,-1.07292e-05,1.87265e-09,-1.21272e-13,29345.2,-43.699], Tmin=(2079.1,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(283.016,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(CsJ2_singlet-CsH)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['C2H5(27)(28)', 'C3H5(89)(88)'],
    products = ['C5H10(82)(81)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['CH3(15)(16)', 'C4H7(330)(329)'],
    products = ['C5H10(82)(81)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)(3)', 'C=CC[CH]C(1224)'],
    products = ['C5H10(82)(81)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['C3H7(69)(68)', 'C2H3(28)(29)'],
    products = ['C5H10(82)(81)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['H(3)(3)', '[CH2]CCC=C(1212)'],
    products = ['C5H10(82)(81)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction13',
    reactants = ['C4H8(80)(79)', 'CH2(S)(21)(22)'],
    products = ['C5H10(82)(81)'],
...
network(
    ...
    reactants = [
        ('C2H5(27)(28)', 'C3H5(89)(88)'),
        ('CH3(15)(16)', 'C4H7(330)(329)'),
        ('C3H7(69)(68)', 'C2H3(28)(29)'),
        ('H(3)(3)', 'C5H9(188)(187)'),
        ('C4H8(80)(79)', 'CH2(S)(21)(22)'),
    ],
    bathGas = {
        'Ne': 0.333333,
        'N2': 0.333333,
