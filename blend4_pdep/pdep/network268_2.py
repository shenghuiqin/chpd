...
species(
    ...
    E0 = (-95.7523,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,180,1237.36,1238.07,1238.13,1238.27,1238.46,3761.78,3763.26],'cm^-1')),
        HinderedRotor(inertia=(0.00156448,'amu*angstrom^2'), symmetry=1, barrier=(7.10053,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
species(
    ...
    molecularWeight = (58.0791,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.78963,0.0200505,1.20951e-05,-2.63569e-08,1.05545e-11,15957.9,19.5846], Tmin=(100,'K'), Tmax=(1008.9,'K')), NASAPolynomial(coeffs=[7.59895,0.0166731,-6.21133e-06,1.15453e-09,-8.24062e-14,14189,-7.61771], Tmin=(1008.9,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(132.272,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: DFT_QCI_thermo + radical(CCJCO) + radical(RCCJ)"""),
)

species(
    label = 'propen3ol(5347)',
    ...
    molecularWeight = (58.0791,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.70169,0.0329588,-1.64623e-05,-1.88051e-08,2.39387e-11,-17234.3,12.1894], Tmin=(100,'K'), Tmax=(515.479,'K')), NASAPolynomial(coeffs=[4.96612,0.023077,-1.00832e-05,1.88372e-09,-1.30032e-13,-17569.9,1.77446], Tmin=(515.479,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-143.647,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), label="""propen3ol""", comment="""Thermo library: DFT_QCI_thermo"""),
)
...
species(
    ...
    E0 = (-39.1063,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,2782.5,750,1395,475,1775,1000,3025,407.5,1350,352.5],'cm^-1')),
        HinderedRotor(inertia=(0.00292657,'amu*angstrom^2'), symmetry=1, barrier=(11.4843,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.33702,'amu*angstrom^2'), symmetry=1, barrier=(30.7406,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (57.0712,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.81534,0.0223479,-3.54601e-06,-5.96737e-09,2.51552e-12,-4657.75,13.3711], Tmin=(100,'K'), Tmax=(1196.39,'K')), NASAPolynomial(coeffs=[6.28593,0.0181142,-7.47799e-06,1.37248e-09,-9.41316e-14,-6015.63,-6.19907], Tmin=(1196.39,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-39.1063,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), label="""CH3CHCHO""", comment="""Thermo library: DFT_QCI_thermo"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)(3)', 'C3H5O(111)(110)'],
    products = ['[CH2]CC[O](2830)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['C2H4(19)(20)', '[CH2][O](1408)'],
    products = ['[CH2]CC[O](2830)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['CH2(S)(21)(22)', 'CH3CHO(35)(36)'],
    products = ['C3H6O(201)(200)'],
...
reaction(
    label = 'reaction9',
    reactants = ['C=COC(2832)'],
    products = ['C3H6O(201)(200)'],
    transitionState = 'TS23',
    kinetics = Arrhenius(A=(7040,'s^-1'), n=2.66, Ea=(313.8,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""Matched reaction 7 C3H6O <=> C3H6O-2 in ketoenol/training
This reaction matched rate rule [R_ROR;R1_doublebond_CH2;R2_doublebond_H;R_O_C]
family: ketoenol"""),
)

reaction(
    label = 'reaction24',
    reactants = ['propen1ol(2833)'],
    products = ['C3H6O(201)(200)'],
    transitionState = 'TS24',
    kinetics = Arrhenius(A=(605.045,'s^-1'), n=2.96, Ea=(143.867,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R_ROR;R1_doublebond;R2_doublebond_H;R_O_H] for rate rule [R_ROR;R1_doublebond_CHCH3;R2_doublebond_H;R_O_H]
