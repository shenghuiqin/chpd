...
species(
    ...
    E0 = (328.221,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,362.59],'cm^-1')),
        HinderedRotor(inertia=(0.118868,'amu*angstrom^2'), symmetry=1, barrier=(11.091,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.118898,'amu*angstrom^2'), symmetry=1, barrier=(11.091,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (42.0797,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.00371,0.0161454,1.44268e-05,-2.62511e-08,1.01943e-11,39516.8,10.8928], Tmin=(100,'K'), Tmax=(1003.27,'K')), NASAPolynomial(coeffs=[6.63826,0.0156478,-5.75067e-06,1.05874e-09,-7.51289e-14,38083.3,-10.1634], Tmin=(1003.27,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(328.221,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo library: DFT_QCI_thermo + radical(CCJ2_triplet)"""),
)
...
reaction(
    label = 'reaction10',
    reactants = ['H(3)(3)', 'C3H6(83)(82)'],
    products = ['C3H7(229)(228)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction12',
    reactants = ['CH3(15)(16)', 'CHCH3(T)(883)'],
    products = ['C3H7(229)(228)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction2',
    reactants = ['CH3(15)(16)', 'C2H4(19)(20)'],
    products = ['C3H7(69)(68)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction4',
    reactants = ['CH3(15)(16)', 'C2H4(T)(899)'],
    products = ['C3H7(69)(68)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction7',
    reactants = ['CH2(S)(21)(22)', 'C2H5(27)(28)'],
    products = ['C3H7(69)(68)'],
...
reaction(
    label = 'reaction8',
    reactants = ['CH2(17)(18)', 'C2H5(27)(28)'],
    products = ['C3H7(69)(68)'],
...
network(
    ...
    reactants = [
        ('H(3)(3)', 'C3H6(83)(82)'),
        ('CH3(15)(16)', 'C2H4(19)(20)'),
        ('CH2(S)(21)(22)', 'C2H5(27)(28)'),
        ('CH2(17)(18)', 'C2H5(27)(28)'),
    ],
    bathGas = {
        'Ne': 0.333333,
        'N2': 0.333333,
