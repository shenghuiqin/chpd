species(
    label = '[CH2]OO[CH2](3403)',
    structure = SMILES('[CH2]OO[CH2]'),
    E0 = (249.115,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,350,500,795,815],'cm^-1')),
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]OO[CH2](3403)'],
    products = ['CH2O(13)(14)', 'CH2O(13)(14)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2][O](1408)', '[CH2][O](1408)'],
    products = ['[CH2]OO[CH2](3403)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(17)(18)', '[CH2]O[O](1192)'],
    products = ['[CH2]OO[CH2](3403)'],
    transitionState = 'TS4',
