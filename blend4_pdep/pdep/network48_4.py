...
species(
    ...
    molecularWeight = (56.1063,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.2702,-0.00230965,0.00010246,-1.25882e-07,4.64171e-11,1711.44,10.4049], Tmin=(100,'K'), Tmax=(958.659,'K')), NASAPolynomial(coeffs=[9.08685,0.0204702,-6.80115e-06,1.29477e-09,-9.89856e-14,-1565.8,-28.6877], Tmin=(958.659,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(13.873,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(282.692,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + ring(Cyclobutane)"""),
)
...
species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(2.20568,'amu*angstrom^2'), symmetry=1, barrier=(50.713,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.20111,'amu*angstrom^2'), symmetry=1, barrier=(50.6079,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (42.0797,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.92363,0.021087,-1.82399e-06,-5.35947e-09,1.86095e-12,37101.5,19.8374], Tmin=(100,'K'), Tmax=(1330.25,'K')), NASAPolynomial(coeffs=[5.20769,0.0205522,-8.3624e-06,1.49634e-09,-1.00128e-13,35933.4,6.0602], Tmin=(1330.25,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(308.14,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsHHH) + group(Cs-CsHHH) + group(CsJ2_singlet-CsH)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]CC[CH2](896)'],
    products = ['C2H4(19)(20)', 'C2H4(19)(20)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction3',
    reactants = ['C2H4(19)(20)', 'C2H4(T)(899)'],
    products = ['[CH2]CC[CH2](896)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['C2H4(T)(899)', 'C2H4(T)(899)'],
    products = ['[CH2]CC[CH2](896)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['CH2(17)(18)', '[CH2]C[CH2](898)'],
    products = ['[CH2]CC[CH2](896)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction15',
    reactants = ['H(3)(3)', 'buten1yl1(1222)'],
    products = ['C4H8(80)(79)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CH2(S)(21)(22)', 'C[C]C(1230)'],
    products = ['C4H8(92)(91)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CH3(15)(16)', 'CH3CHCH(839)'],
    products = ['C4H8(94)(93)'],
...
reaction(
    label = 'reaction24',
    reactants = ['H(3)(3)', 'buten22yl(1426)'],
    products = ['C4H8(94)(93)'],
