...
species(
    ...
    E0 = (266.034,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,2750,2850,1437.5,1250,1305,750,350,317.658,317.771,317.802],'cm^-1')),
        HinderedRotor(inertia=(0.00406798,'amu*angstrom^2'), symmetry=1, barrier=(8.74144,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.12184,'amu*angstrom^2'), symmetry=1, barrier=(8.73935,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0188777,'amu*angstrom^2'), symmetry=1, barrier=(40.5654,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (60.052,'amu'),
...
reaction(
    label = 'reaction1',
    reactants = ['HO2(8)(9)', 'C2H3(28)(29)'],
    products = ['C2H4O2(62)(61)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction7',
    reactants = ['C2H4O2(62)(61)'],
    products = ['HOCH2CHO(2806)'],
    transitionState = 'TS7',
