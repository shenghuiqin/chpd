...
species(
    ...
    molecularWeight = (108.138,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.42755,0.0160318,8.80815e-05,-1.09875e-07,3.79585e-11,40809.9,23.4641], Tmin=(100,'K'), Tmax=(1038.76,'K')), NASAPolynomial(coeffs=[8.75286,0.0406054,-1.80607e-05,3.59321e-09,-2.63716e-13,36855.9,-19.9992], Tmin=(1038.76,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(338.709,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + Estimated bicyclic component: polycyclic(s2_3_7_ane) - ring(Cycloheptane) - ring(Ethylene_oxide) + ring(Cycloheptene) + ring(Ethylene_oxide) + radical(C2CsJO) + radical(RCCJCC)"""),
)
...
species(
    label = '[CH]=CCC=CC1[CH]O1(1669)',
    structure = SMILES('[CH]=CCC=CC1[CH]O1'),
    E0 = (477.654,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3120,650,792.5,1650,2750,3150,900,1100,2995,3010,3025,975,987.5,1000,1300,1337.5,1375,400,450,500,1630,1655,1680,200,800,914.286,1028.57,1142.86,1257.14,1371.43,1485.71,1600],'cm^-1')),
...
species(
    label = '[CH]1C[CH]C2C1C1OC21(1672)',
...
species(
    label = '[CH]1C2CC2[CH]C2OC12(1673)',
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)(3)', '[CH]1C=CC2OC2C=C1(1655)'],
    products = ['C7H8O(418)(417)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)(3)', '[C]1=CCC=CC2OC12(1656)'],
    products = ['C7H8O(418)(417)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)(3)', '[C]1=CC2OC2C=CC1(1657)'],
    products = ['C7H8O(418)(417)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(1e+13,'cm^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""From training reaction 40 used for Cd_rad/NonDe;H_rad
Exact match found for rate rule [Cd_rad/NonDe;H_rad]
...
reaction(
    label = 'reaction5',
    reactants = ['[CH]1CC=CC2O[C]2C1(1658)'],
    products = ['C7H8O(418)(417)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH]1C=CC2OC2[CH]C1(1659)'],
    products = ['C7H8O(418)(417)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH]1CC=C[C]2OC2C1(1660)'],
    products = ['C7H8O(418)(417)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[C]1=CC2OC2[CH]CC1(1661)'],
    products = ['C7H8O(418)(417)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH]1CCC=C[C]2OC12(1662)'],
    products = ['C7H8O(418)(417)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[C]1=CC2OC2C[CH]C1(1663)'],
    products = ['C7H8O(418)(417)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[C]1=CC[CH]CC2OC12(1664)'],
    products = ['C7H8O(418)(417)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[C]1=CCC[CH]C2OC12(1665)'],
    products = ['C7H8O(418)(417)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH]1[CH]CC2OC2C=C1(1666)'],
    products = ['C7H8O(418)(417)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH]1CCC=CC2O[C]12(1667)'],
    products = ['C7H8O(418)(417)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH]=CC1OC1C=C[CH2](1668)'],
    products = ['C7H8O(418)(417)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH]=CCC=CC1[CH]O1(1669)'],
    products = ['C7H8O(418)(417)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH]1C[CH]C2C1C1OC21(1672)'],
    products = ['C7H8O(418)(417)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH]1C2CC2[CH]C2OC12(1673)'],
    products = ['C7H8O(418)(417)'],
...
reaction(
    label = 'reaction23',
    reactants = ['C7H8(415)(414)', 'O(S)(1202)'],
    products = ['C7H8O(418)(417)'],
