...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]CC([O])=O(3311)'],
    products = ['CO2(11)(12)', 'C2H4(19)(20)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]CC([O])=O(3311)'],
    products = ['[O]C1([O])CC1(7639)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(1.34238e+09,'s^-1'), n=0.889391, Ea=(153.131,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4_S;multiplebond_intra;radadd_intra_cs2H] for rate rule [R4_S_CO;carbonylbond_intra;radadd_intra_cs2H]
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)(3)', 'tSPC_1553(7640)'],
    products = ['[CH2]CC([O])=O(3311)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['C2H4(19)(20)', '[O][C]=O(2802)'],
    products = ['[CH2]CC([O])=O(3311)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CO2(11)(12)', 'C2H4(T)(899)'],
    products = ['[CH2]CC([O])=O(3311)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(16.08,'m^3/(mol*s)'), n=1.68, Ea=(54.1828,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Cdd_Od;CJ] for rate rule [CO2;CJ]
...
reaction(
    label = 'reaction8',
    reactants = ['C2H4(T)(899)', '[O][C]=O(2802)'],
    products = ['[CH2]CC([O])=O(3311)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction13',
    reactants = ['CH2(17)(18)', '[CH2]C([O])=O(7645)'],
    products = ['[CH2]CC([O])=O(3311)'],
    transitionState = 'TS13',
    kinetics = Arrhenius(A=(2.23625e+06,'m^3/(mol*s)'), n=0.36814, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Y_rad;Birad] for rate rule [C_rad/H2/CO;Birad]
