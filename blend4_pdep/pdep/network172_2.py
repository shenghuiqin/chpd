...
species(
    ...
    molecularWeight = (73.0706,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.26984,0.0332921,-1.8297e-05,4.02502e-09,-1.2721e-13,19529.6,15.1975], Tmin=(100,'K'), Tmax=(1399.72,'K')), NASAPolynomial(coeffs=[9.19675,0.0183444,-7.47314e-06,1.34397e-09,-9.02649e-14,17115.6,-22.2464], Tmin=(1399.72,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(161.828,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(12dioxetane) + radical(CJCOOH)"""),
)

species(
    label = 'C=C[CH]OO(4521)',
...
species(
    ...
    E0 = (320.019,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,1685,370,2950,3100,1380,975,1025,1650,2750,2850,1437.5,1250,1305,750,350,180],'cm^-1')),
...
reaction(
    label = 'reaction1',
    reactants = ['O2(2)(2)', 'C3H5(89)(88)'],
    products = ['C3H5O2(91)(90)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['C3H5O2(91)(90)'],
    products = ['[CH2]C1COO1(4520)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction6',
    reactants = ['C2H3(28)(29)', '[CH2]O[O](1192)'],
    products = ['C3H5O2(91)(90)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(3)(3)', 'C=C[CH]O[O](1402)'],
    products = ['C3H5O2(91)(90)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction15',
    reactants = ['H(3)(3)', '[CH]1[CH]OOC1(4526)'],
    products = ['S(103)(102)'],
