...
reaction(
    label = 'reaction5',
    reactants = ['C2H5(27)(28)', '[CH2]O[O](1192)'],
...
reaction(
    label = 'reaction6',
    reactants = ['CH3(15)(16)', '[CH2]CO[O](1359)'],
    products = ['C3H7O2(77)(76)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction7',
    reactants = ['H(3)(3)', 'C[CH]CO[O](3050)'],
    products = ['C3H7O2(77)(76)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction8',
    reactants = ['H(3)(3)', 'CC[CH]O[O](2776)'],
    products = ['C3H7O2(77)(76)'],
    transitionState = 'TS5',
