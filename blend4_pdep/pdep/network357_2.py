species(
    ...
    E0 = (-237.399,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([375,552.5,462.5,1710,3615,1277.5,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,492.5,1135,1000,200,800,1600],'cm^-1')),
...
species(
    ...
    E0 = (-238.842,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,3025,407.5,1350,352.5,2750,2950,3150,900,1000,1100,2750,2850,1437.5,1250,1305,750,350,300,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
...
species(
    label = 'O=C([C]=CCO)COO(5376)',
    structure = SMILES('[O]C(=C=CCO)COO'),
    E0 = (-200.844,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,440,435,1725,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,540,610,2055,3615,1277.5,1000,3010,987.5,1337.5,450,1655,3615,1310,387.5,850,1000,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'O=C(C=[C]CO)COO(5377)',
    structure = SMILES('O=C(C=[C]CO)COO'),
    E0 = (-151.562,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,375,552.5,462.5,1710,3615,1277.5,1000,3010,987.5,1337.5,450,1655,3615,1310,387.5,850,1000,1685,370,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2]C=CC(=O)CO[O](5380)',
    structure = SMILES('C=CC=C([O])CO[O]'),
    E0 = (51.5158,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2950,3100,1380,975,1025,1650,350,440,435,1725,2995,3025,975,1000,1300,1375,400,500,1630,1680,2750,2850,1437.5,1250,1305,750,350,195.366,195.479,195.497],'cm^-1')),
        HinderedRotor(inertia=(0.409093,'amu*angstrom^2'), symmetry=1, barrier=(11.0948,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.410319,'amu*angstrom^2'), symmetry=1, barrier=(11.095,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.408885,'amu*angstrom^2'), symmetry=1, barrier=(11.0949,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (114.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.397457,0.0756614,-8.16803e-05,4.5854e-08,-1.0149e-11,6328.72,29.5654], Tmin=(100,'K'), Tmax=(1105.63,'K')), NASAPolynomial(coeffs=[15.4253,0.0212929,-7.91859e-06,1.37738e-09,-9.21024e-14,3005.69,-44.4441], Tmin=(1105.63,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(51.5158,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-(Cds-Cd)H) + group(O2s-OsH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsOs) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + radical(ROOJ) + radical(C=C(C)OJ)"""),
)
...
species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.184904,'amu*angstrom^2'), symmetry=1, barrier=(4.25131,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.184682,'amu*angstrom^2'), symmetry=1, barrier=(4.24621,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.184415,'amu*angstrom^2'), symmetry=1, barrier=(4.24007,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.184166,'amu*angstrom^2'), symmetry=1, barrier=(4.23433,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (130.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.508884,0.0896485,-0.000148133,1.45632e-07,-5.57632e-11,-1293.26,33.8435], Tmin=(100,'K'), Tmax=(819.84,'K')), NASAPolynomial(coeffs=[2.87751,0.0504472,-2.58296e-05,5.04947e-09,-3.52265e-13,-752.582,28.5528], Tmin=(819.84,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-11.6939,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-(Cds-O2d)OsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-O2d(Cds-Cds)Cs) + group(Cds-CdsCsH) + group(Cd-Cd(CO)H) + radical(CCOJ) + radical(ROOJ)"""),
)
...
species(
    label = '[O]OCC(=O)C=C[CH]O(5383)',
    structure = SMILES('[O]OCC([O])=CC=CO'),
    E0 = (-157.277,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2995,3010,3025,975,987.5,1000,1300,1337.5,1375,400,450,500,1630,1655,1680,492.5,1135,1000,350,440,435,1725,2750,2850,1437.5,1250,1305,750,350,3615,1277.5,1000,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.771819,'amu*angstrom^2'), symmetry=1, barrier=(17.7456,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.771915,'amu*angstrom^2'), symmetry=1, barrier=(17.7478,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.773305,'amu*angstrom^2'), symmetry=1, barrier=(17.7798,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.773177,'amu*angstrom^2'), symmetry=1, barrier=(17.7769,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (130.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.32932,0.0996207,-0.00011521,6.29377e-08,-1.27868e-11,-18709,35.6174], Tmin=(100,'K'), Tmax=(1370.03,'K')), NASAPolynomial(coeffs=[25.9812,0.00685293,6.25485e-07,-3.70935e-10,3.24121e-14,-24969.4,-100.275], Tmin=(1370.03,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-157.277,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(O2s-OsH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsOs) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsOsH) + radical(C=C(C)OJ) + radical(ROOJ)"""),
)
...
species(
    label = '[O]O[CH]C(=O)C=CCO(5384)',
    structure = SMILES('[O]OC=C([O])C=CCO'),
    E0 = (-103.621,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,440,435,1725,3615,1277.5,1000,2995,3010,3025,975,987.5,1000,1300,1337.5,1375,400,450,500,1630,1655,1680,2750,2850,1437.5,1250,1305,750,350,492.5,1135,1000,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.436362,'amu*angstrom^2'), symmetry=1, barrier=(10.0328,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.436347,'amu*angstrom^2'), symmetry=1, barrier=(10.0325,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.436459,'amu*angstrom^2'), symmetry=1, barrier=(10.035,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.436508,'amu*angstrom^2'), symmetry=1, barrier=(10.0362,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (130.099,'amu'),
...
species(
    label = '[O]OCC(=O)C=[C]CO(5385)',
    structure = SMILES('[O]OCC(=O)C=[C]CO'),
    E0 = (0.442711,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,375,552.5,462.5,1710,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3615,1277.5,1000,3010,987.5,1337.5,450,1655,1685,370,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[O]OCC(=O)[C]=CCO(5386)',
    structure = SMILES('[O]OCC([O])=C=CCO'),
    E0 = (-48.8389,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,350,440,435,1725,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,540,610,2055,3615,1277.5,1000,3010,987.5,1337.5,450,1655,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.253656,'amu*angstrom^2'), symmetry=1, barrier=(5.83205,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.2538,'amu*angstrom^2'), symmetry=1, barrier=(5.83535,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.253781,'amu*angstrom^2'), symmetry=1, barrier=(5.83493,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.253883,'amu*angstrom^2'), symmetry=1, barrier=(5.83726,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (130.099,'amu'),
...
species(
    label = 'OCC=C[C]1COOO1(5387)',
    structure = SMILES('OC[CH]C=C1COOO1'),
    E0 = (-56.5059,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3010,987.5,1337.5,450,1655,3615,1277.5,1000,3025,407.5,1350,352.5,2750,2850,1437.5,1250,1305,750,350,2750,3150,900,1100,300,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
...
species(
    label = 'C=C(C=CCO)OO[O](5332)',
    structure = SMILES('C=C(C=CCO)OO[O]'),
    E0 = (3.34347,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,440,435,1725,3615,1277.5,1000,2950,3100,1380,975,1025,1650,2995,3025,975,1000,1300,1375,400,500,1630,1680,2750,2850,1437.5,1250,1305,750,350,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[O]OC=C(O)C=CCO(5389)',
    structure = SMILES('[O]OC=C(O)C=CCO'),
    E0 = (-241.426,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,440,435,1725,3580,3650,1210,1345,900,1100,2995,3010,3025,975,987.5,1000,1300,1337.5,1375,400,450,500,1630,1655,1680,2750,2850,1437.5,1250,1305,750,350,492.5,1135,1000,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.606182,'amu*angstrom^2'), symmetry=1, barrier=(13.9373,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.606017,'amu*angstrom^2'), symmetry=1, barrier=(13.9335,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.606686,'amu*angstrom^2'), symmetry=1, barrier=(13.9489,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.606373,'amu*angstrom^2'), symmetry=1, barrier=(13.9417,'kJ/mol'), semiclassical=False),
...
species(
    label = '[O]OCC(O)=C=CCO(5390)',
    structure = SMILES('[O]OCC(O)=C=CCO'),
    E0 = (-186.644,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,350,440,435,1725,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,540,610,2055,3580,3650,1210,1345,900,1100,3010,987.5,1337.5,450,1655,190.943,190.946],'cm^-1')),
        HinderedRotor(inertia=(0.403589,'amu*angstrom^2'), symmetry=1, barrier=(10.4422,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.403597,'amu*angstrom^2'), symmetry=1, barrier=(10.4422,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.40345,'amu*angstrom^2'), symmetry=1, barrier=(10.4423,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.40359,'amu*angstrom^2'), symmetry=1, barrier=(10.4423,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.403536,'amu*angstrom^2'), symmetry=1, barrier=(10.4421,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (131.107,'amu'),
...
species(
    label = '[O]CC(=O)C=CCO(5391)',
    structure = SMILES('[O]CC(=O)C=CCO'),
    E0 = (-217.176,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([375,552.5,462.5,1710,3615,1277.5,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,180,180,4000,4000],'cm^-1')),
        HinderedRotor(inertia=(0.194773,'amu*angstrom^2'), symmetry=1, barrier=(4.47822,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.707432,'amu*angstrom^2'), symmetry=1, barrier=(16.2653,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.40654,'amu*angstrom^2'), symmetry=1, barrier=(32.3391,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.196752,'amu*angstrom^2'), symmetry=1, barrier=(4.52372,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
species(
    label = 'O=C1COOC1=CCO(5394)',
    structure = SMILES('O=C1COOC1=CCO'),
    E0 = (-296.796,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,3010,987.5,1337.5,450,1655,2750,2850,1437.5,1250,1305,750,350,2750,3150,900,1100,300,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
...
species(
    ...
    molecularWeight = (130.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.969269,0.0539148,-9.29877e-06,-2.23052e-08,1.0633e-11,-1460.15,34.1795], Tmin=(100,'K'), Tmax=(1092.98,'K')), NASAPolynomial(coeffs=[14.7209,0.0303031,-1.35581e-05,2.65599e-09,-1.91592e-13,-6061.92,-40.6865], Tmin=(1092.98,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-13.1371,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(349.208,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(Cs-(Cds-O2d)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-O2d)OsHH) + group(Cds-OdCsCs) + ring(Cyclopentane) + radical(CCOJ) + radical(CCJCOOH)"""),
)

species(
    label = 'O=C1COO[C]1[CH]CO(5403)',
...
species(
    ...
    molecularWeight = (130.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.628411,0.0592357,-1.26492e-05,-2.78701e-08,1.48452e-11,-11935.8,34.2924], Tmin=(100,'K'), Tmax=(1021.93,'K')), NASAPolynomial(coeffs=[17.7918,0.0248511,-1.03175e-05,2.01251e-09,-1.47615e-13,-17156.2,-57.2621], Tmin=(1021.93,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-100.357,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(Cs-(Cds-O2d)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-O2d)OsHH) + group(Cds-OdCsCs) + ring(Cyclopentane) + radical(CCJCOOH) + radical(OCJC=O)"""),
)

species(
    label = 'O=C1COOC1[CH][CH]O(5405)',
    ...
    molecularWeight = (130.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.407677,0.0646997,-2.64181e-05,-1.6308e-08,1.15015e-11,-6899.4,34.8765], Tmin=(100,'K'), Tmax=(1019.95,'K')), NASAPolynomial(coeffs=[18.9768,0.0224248,-9.17296e-06,1.78552e-09,-1.31183e-13,-12276.3,-62.8651], Tmin=(1019.95,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-58.5443,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(Cs-(Cds-O2d)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-O2d)OsHH) + group(Cds-OdCsCs) + ring(Cyclopentane) + radical(CCJCOOH) + radical(CCsJOH)"""),
)

species(
    label = 'OCC1O[C]2COOC21(5406)',
...
species(
    label = 'C=C1OOOC1[CH]CO(5409)',
    structure = SMILES('C=C1OOOC1[CH]CO'),
    E0 = (19.5668,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2950,3100,1380,975,1025,1650,3025,407.5,1350,352.5,2750,2850,1437.5,1250,1305,750,350,2950,1000,300,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
...
reaction(
    label = 'reaction7',
    reactants = ['S(267)(266)'],
    products = ['O=C(C=C[CH]O)COO(5378)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['OH(5)(5)', '[CH2]C=CC(=O)CO[O](5380)'],
    products = ['S(267)(266)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(3)(3)', '[O]CC=CC(=O)CO[O](5381)'],
    products = ['S(267)(266)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CH2OH(22)(23)', '[CH]=CC(=O)CO[O](5382)'],
    products = ['S(267)(266)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(3)(3)', '[O]OCC(=O)C=C[CH]O(5383)'],
    products = ['S(267)(266)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2]O[O](1192)', 'O=[C]C=CCO(5208)'],
    products = ['S(267)(266)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(3)(3)', '[O]O[CH]C(=O)C=CCO(5384)'],
    products = ['S(267)(266)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(3)(3)', '[O]OCC(=O)C=[C]CO(5385)'],
    products = ['S(267)(266)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[O]OC[C]=O(3029)', '[CH]=CCO(4313)'],
    products = ['S(267)(266)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(3)(3)', '[O]OCC(=O)[C]=CCO(5386)'],
    products = ['S(267)(266)'],
...
reaction(
    label = 'reaction19',
    reactants = ['S(267)(266)'],
    products = ['O=C1[CH]C(CO)OOC1(5388)'],
...
reaction(
    label = 'reaction23',
    reactants = ['O(4)(4)', '[O]CC(=O)C=CCO(5391)'],
    products = ['S(267)(266)'],
...
reaction(
    label = 'reaction26',
    reactants = ['H(3)(3)', 'O=C1COOC1=CCO(5394)'],
    products = ['S(658)(657)'],
...
reaction(
    label = 'reaction27',
    reactants = ['H(3)(3)', 'O=C1COOC1C=CO(5395)'],
    products = ['S(658)(657)'],
...
reaction(
    label = 'reaction28',
    reactants = ['OH(5)(5)', 'C=CC1OOCC1=O(5396)'],
    products = ['S(658)(657)'],
...
reaction(
    label = 'reaction33',
    reactants = ['OH(5)(5)', '[CH2][CH]C1OOCC1=O(5401)'],
    products = ['S(658)(657)'],
...
reaction(
    label = 'reaction34',
    reactants = ['H(3)(3)', '[O]C[CH]C1OOCC1=O(5402)'],
    products = ['S(658)(657)'],
...
reaction(
    label = 'reaction35',
    reactants = ['H(3)(3)', 'O=C1COO[C]1[CH]CO(5403)'],
    products = ['S(658)(657)'],
...
reaction(
    label = 'reaction36',
    reactants = ['H(3)(3)', 'O=C1[CH]OOC1[CH]CO(5404)'],
    products = ['S(658)(657)'],
...
reaction(
    label = 'reaction37',
    reactants = ['H(3)(3)', 'O=C1COOC1[CH][CH]O(5405)'],
    products = ['S(658)(657)'],
...
reaction(
    label = 'reaction41',
    reactants = ['OC[CH]C1OOCC=1O(5408)'],
    products = ['S(658)(657)'],
...
reaction(
    label = 'reaction42',
    reactants = ['C=C1OOOC1[CH]CO(5409)'],
    products = ['S(658)(657)'],
...
reaction(
    label = 'reaction43',
    reactants = ['OC[CH]C1OOC=C1O(5410)'],
    products = ['S(658)(657)'],
...
reaction(
    label = 'reaction44',
    reactants = ['[CH]CO(1201)', 'O=C1[CH]OOC1(5411)'],
    products = ['S(658)(657)'],
...
reaction(
    label = 'reaction45',
    reactants = ['CH2OH(22)(23)', '[CH]C1OOCC1=O(5412)'],
    products = ['S(658)(657)'],
...
reaction(
    label = 'reaction46',
    reactants = ['H(3)(3)', 'O=C1COOC1[C]CO(5413)'],
    products = ['S(658)(657)'],
