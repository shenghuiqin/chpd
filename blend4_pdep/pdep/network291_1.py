species(
    label = '[CH2]CO[C]=C(3559)',
    structure = SMILES('[CH2]CO[C]=C'),
    E0 = (265.826,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,1685,370,2950,3100,1380,975,1025,1650,3000,3100,440,815,1455,1000,408.514,408.514,408.514],'cm^-1')),
...
species(
    label = 'C#COC[CH2](8044)',
    structure = SMILES('C#COC[CH2]'),
    E0 = (235.409,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,750,770,3400,2100,2175,525,3000,3100,440,815,1455,1000,180,180],'cm^-1')),
        HinderedRotor(inertia=(1.17336,'amu*angstrom^2'), symmetry=1, barrier=(26.9779,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.17374,'amu*angstrom^2'), symmetry=1, barrier=(26.9865,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (69.0819,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.789003,0.0554534,-5.66784e-05,2.73259e-08,-4.90155e-12,28441.7,18.3114], Tmin=(100,'K'), Tmax=(1571.17,'K')), NASAPolynomial(coeffs=[17.2647,0.00496099,-3.1295e-07,-5.30767e-11,5.85111e-15,24319.5,-65.2608], Tmin=(1571.17,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(235.409,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Ct-CtOs) + group(Ct-CtH) + radical(CJCO)"""),
)
...
species(
    label = '[CH]=COC[CH2](8046)',
    structure = SMILES('[CH]=COC[CH2]'),
    E0 = (273.178,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3120,650,792.5,1650,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.955741,'amu*angstrom^2'), symmetry=1, barrier=(21.9744,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.955302,'amu*angstrom^2'), symmetry=1, barrier=(21.9643,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.95527,'amu*angstrom^2'), symmetry=1, barrier=(21.9635,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (70.0898,'amu'),
...
species(
    ...
    E0 = (301.333,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3120,650,792.5,1650,2750,2800,2850,1350,1500,750,1050,1375,1000,1685,370,286.357,286.393],'cm^-1')),
        HinderedRotor(inertia=(0.280675,'amu*angstrom^2'), symmetry=1, barrier=(16.3337,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.280468,'amu*angstrom^2'), symmetry=1, barrier=(16.3329,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.280471,'amu*angstrom^2'), symmetry=1, barrier=(16.3333,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (70.0898,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.68085,0.0429723,-2.09058e-05,-8.78212e-09,8.01964e-12,36332.8,20.5396], Tmin=(100,'K'), Tmax=(952.502,'K')), NASAPolynomial(coeffs=[13.413,0.0129936,-4.07319e-06,6.98387e-10,-4.91948e-14,33222.8,-40.0836], Tmin=(952.502,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(301.333,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(Cds_P) + radical(C=CJO)"""),
)
...
species(
    ...
    molecularWeight = (70.0898,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.46587,0.01355,7.59593e-05,-1.20377e-07,5.15042e-11,-6569.31,11.1175], Tmin=(100,'K'), Tmax=(900.041,'K')), NASAPolynomial(coeffs=[16.5772,0.00402626,3.18486e-06,-8.11766e-10,5.47376e-14,-11263.9,-67.4438], Tmin=(900.041,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-55.2374,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(257.749,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + ring(2methyleneoxetane)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]CO[C]=C(3559)'],
    products = ['C2H4(19)(20)', 'CH2CO(26)(27)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)(3)', 'C=[C]OC=C(8043)'],
    products = ['[CH2]CO[C]=C(3559)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)(3)', 'C#COC[CH2](8044)'],
    products = ['[CH2]CO[C]=C(3559)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CH2CO(26)(27)', 'C2H4(T)(899)'],
    products = ['[CH2]CO[C]=C(3559)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction9',
    reactants = ['C2H4(T)(899)', '[CH2][C]=O(1196)'],
    products = ['[CH2]CO[C]=C(3559)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction12',
    reactants = ['H2CC(T)(1194)', '[CH2]C[O](1195)'],
    products = ['[CH2]CO[C]=C(3559)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CH2(17)(18)', '[CH2]O[C]=C(4276)'],
    products = ['[CH2]CO[C]=C(3559)'],
