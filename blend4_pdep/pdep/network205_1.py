...
species(
    ...
    molecularWeight = (61.0168,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[4.39186,0.000408207,1.38938e-05,-1.01816e-08,2.05733e-12,2492.29,8.31431], Tmin=(100,'K'), Tmax=(1748.88,'K')), NASAPolynomial(coeffs=[3.06375,0.0141565,-7.0844e-06,1.31706e-09,-8.69745e-14,1318.87,10.7812], Tmin=(1748.88,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(20.9052,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(108.088,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(Cs-OsOsOsH) + ring(dioxirane) + radical(OCOJ)"""),
)
...
reaction(
    label = 'reaction6',
    reactants = ['HO2(8)(9)', 'CO(10)(11)'],
    products = ['CHO3(186)(185)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['CHO3(186)(185)'],
    products = ['[O]C1OO1(4482)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction7',
    reactants = ['O(4)(4)', 'OCHO(64)(63)'],
    products = ['CHO3(186)(185)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(109477,'m^3/(mol*s)'), n=0.884925, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(303.03,'K'), Tmax=(2000,'K'), comment="""Estimated using template [O_sec_rad;O_birad] for rate rule [O_rad/OneDe;O_birad]
Euclidian distance = 1.0
