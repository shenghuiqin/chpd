...
species(
    ...
    molecularWeight = (108.138,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.1168,0.0784046,-5.18509e-05,1.33594e-09,8.07273e-12,24101.3,9.38929], Tmin=(100,'K'), Tmax=(954.681,'K')), NASAPolynomial(coeffs=[20.3637,0.0211402,-6.72904e-06,1.14775e-09,-7.99508e-14,18889.9,-95.2806], Tmin=(954.681,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(199.066,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(378.308,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)O2s) + group(Cds-Cds(Cds-Cds)H) + ring(1,3-Cycloheptadiene) + radical(C=CJC=C) + radical(Allyl_S)"""),
)
...
reaction(
    label = 'reaction483',
    reactants = ['OH(5)(5)', '[C]1=CC=CCC=C1(1246)'],
...
reaction(
    label = 'reaction486',
    reactants = ['H(3)(3)', 'OC1C=[C]CC=CC=1(2213)'],
    products = ['C7H8O(575)(574)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction487',
    reactants = ['H(3)(3)', 'OC1C=CC[C]=CC=1(2214)'],
    products = ['C7H8O(575)(574)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(1e+13,'cm^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""From training reaction 40 used for Cd_rad/NonDe;H_rad
Exact match found for rate rule [Cd_rad/NonDe;H_rad]
...
reaction(
    label = 'reaction488',
    reactants = ['H(3)(3)', 'OC1[C]=CCC=CC=1(2215)'],
    products = ['C7H8O(575)(574)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction489',
    reactants = ['H(3)(3)', 'OC1=[C]C=CCC=C1(2216)'],
    products = ['C7H8O(575)(574)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(6.117e+14,'cm^3/(mol*s)'), n=-0.152, Ea=(4.19655,'kJ/mol'), T0=(1,'K'), comment="""From training reaction 49 used for Cd_rad/Cd;H_rad
Exact match found for rate rule [Cd_rad/Cd;H_rad]
...
reaction(
    label = 'reaction490',
    reactants = ['H(3)(3)', 'OC1C=CCC=[C]C=1(2217)'],
    products = ['C7H8O(575)(574)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(6.117e+14,'cm^3/(mol*s)'), n=-0.152, Ea=(4.19655,'kJ/mol'), T0=(1,'K'), comment="""From training reaction 49 used for Cd_rad/Cd;H_rad
Exact match found for rate rule [Cd_rad/Cd;H_rad]
...
reaction(
    label = 'reaction496',
    reactants = ['OC1C=[C]CC[CH]C=1(2220)'],
    products = ['C7H8O(575)(574)'],
...
reaction(
    label = 'reaction497',
    reactants = ['OC1[CH]CC[C]=CC=1(2221)'],
    products = ['C7H8O(575)(574)'],
...
reaction(
    label = 'reaction30',
    reactants = ['OC1[C]=CCC[CH]C=1(2227)'],
    products = ['C7H8O(575)(574)'],
...
reaction(
    label = 'reaction522',
    reactants = ['[CH]=CC=C(O)C=C[CH2](2233)'],
    products = ['C7H8O(575)(574)'],
...
reaction(
    label = 'reaction525',
    reactants = ['[CH]=CC(O)=CC=C[CH2](2236)'],
    products = ['C7H8O(575)(574)'],
