...
species(
    label = 'O=C[C]=C1CC=CC1(2713)',
    structure = SMILES('[O]C=C=C1CC=CC1'),
    E0 = (190.648,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2830,2910,2990,3070,3150,900,940,980,1020,1060,1100,540,610,2055,3010,987.5,1337.5,450,1655,300,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (107.13,'amu'),
...
species(
    label = '[O]C[C]=C1CC=CC1(2715)',
    structure = SMILES('[O]C[C]=C1CC=CC1'),
    E0 = (389.756,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2830,2910,2990,3070,3150,900,940,980,1020,1060,1100,1685,370,300,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
species(
    label = 'O=C[C]=C1C[CH]CC1(2718)',
    structure = SMILES('[O]C=C=C1C[CH]CC1'),
    E0 = (257.318,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2816.67,2883.33,2950,3016.67,3083.33,3150,900,933.333,966.667,1000,1033.33,1066.67,1100,540,610,2055,3010,987.5,1337.5,450,1655,300,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (108.138,'amu'),
...
species(
    label = 'O=[C]C=C1C[CH]CC1(2720)',
    structure = SMILES('O=[C]C=C1C[CH]CC1'),
    E0 = (216.15,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1855,455,950,2750,2816.67,2883.33,2950,3016.67,3083.33,3150,900,933.333,966.667,1000,1033.33,1066.67,1100,3010,987.5,1337.5,450,1655,300,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.01234,'amu*angstrom^2'), symmetry=1, barrier=(23.2756,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.01237,'amu*angstrom^2'), symmetry=1, barrier=(23.2764,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (108.138,'amu'),
...
species(
    label = '[CH2]C=CC[C]=CC=O(2723)',
    structure = SMILES('[CH2]C=CC[C]=CC=O'),
    E0 = (318.577,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,1685,370,2995,3010,3025,975,987.5,1000,1300,1337.5,1375,400,450,500,1630,1655,1680,2782.5,750,1395,475,1775,1000,3000,3100,440,815,1455,1000,180,1146.55],'cm^-1')),
        HinderedRotor(inertia=(0.357645,'amu*angstrom^2'), symmetry=1, barrier=(15.7009,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.680998,'amu*angstrom^2'), symmetry=1, barrier=(15.6575,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.681116,'amu*angstrom^2'), symmetry=1, barrier=(15.6602,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.680673,'amu*angstrom^2'), symmetry=1, barrier=(15.65,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (108.138,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.1376,0.0660774,-4.76017e-05,1.70612e-08,-2.55392e-12,38415.6,28.7242], Tmin=(100,'K'), Tmax=(1482.3,'K')), NASAPolynomial(coeffs=[12.3564,0.0358035,-1.69666e-05,3.28315e-09,-2.30193e-13,35089.6,-29.8161], Tmin=(1482.3,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(318.577,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cd-Cd(CO)H) + group(Cds-O2d(Cds-Cds)H) + radical(Allyl_P) + radical(Cds_S)"""),
)

species(
    label = 'O=CC=C1C[C]CC1(2725)',
    structure = SMILES('O=CC=C1C[C]CC1'),
    E0 = (302.229,'kJ/mol'),
    modes = [
...
reaction(
    label = 'reaction1198',
    reactants = ['H(3)(3)', 'O=CC=C1C[C]=CC1(2711)'],
    products = ['C7H8O(627)(626)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction1199',
    reactants = ['HCO(14)(15)', '[CH]=C1CC=CC1(2712)'],
    products = ['C7H8O(627)(626)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction1200',
    reactants = ['H(3)(3)', 'O=C[C]=C1CC=CC1(2713)'],
    products = ['C7H8O(627)(626)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction1201',
    reactants = ['H(3)(3)', 'O=[C]C=C1CC=CC1(2714)'],
    products = ['C7H8O(627)(626)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction1204',
    reactants = ['O=[C]C[C]1CC=CC1(2716)'],
    products = ['C7H8O(627)(626)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction1206',
    reactants = ['O=CC[C]1C[C]=CC1(2717)'],
    products = ['C7H8O(627)(626)'],
...
reaction(
    label = 'reaction1208',
    reactants = ['O=C[C]=C1C[CH]CC1(2718)'],
    products = ['C7H8O(627)(626)'],
...
reaction(
    label = 'reaction1212',
    reactants = ['O=[C]C=C1C[CH]CC1(2720)'],
    products = ['C7H8O(627)(626)'],
...
reaction(
    label = 'reaction1214',
    reactants = ['O=CC[C]1[CH]C=CC1(2071)'],
    products = ['C7H8O(627)(626)'],
...
reaction(
    label = 'reaction1216',
    reactants = ['[CH]=CCC([CH2])=CC=O(2722)'],
    products = ['C7H8O(627)(626)'],
...
reaction(
    label = 'reaction1217',
    reactants = ['[CH2]C=CC[C]=CC=O(2723)'],
    products = ['C7H8O(627)(626)'],
...
reaction(
    label = 'reaction1215',
    reactants = ['CO(10)(11)', 'C=C1CC=CC1(2721)'],
    products = ['C7H8O(627)(626)'],
