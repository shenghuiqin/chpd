...
reaction(
    label = 'reaction1',
    reactants = ['H2O2(9)(10)', 'CO(10)(11)'],
    products = ['CH2O3(272)(271)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction3',
    reactants = ['HO2(8)(9)', 'HCO(14)(15)'],
    products = ['CH2O3(272)(271)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(3.87866e+07,'m^3/(mol*s)'), n=-0.180109, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [O_rad/NonDe;Y_rad] for rate rule [O_rad/NonDe;CO_pri_rad]
