...
species(
    label = '[CH2]CC(C)[O](3562)',
    structure = SMILES('[CH2]CC(C)[O]'),
    E0 = (119.551,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,180,4000],'cm^-1')),
        HinderedRotor(inertia=(0.438607,'amu*angstrom^2'), symmetry=1, barrier=(10.0844,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0134027,'amu*angstrom^2'), symmetry=1, barrier=(26.4368,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2]C[C](C)OO(5527)',
    structure = SMILES('[CH2]C[C](C)OO'),
    E0 = (146.876,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,360,370,350,3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2850,1437.5,1250,1305,750,350,264.995],'cm^-1')),
        HinderedRotor(inertia=(0.189947,'amu*angstrom^2'), symmetry=1, barrier=(9.46581,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.891129,'amu*angstrom^2'), symmetry=1, barrier=(44.4115,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00401494,'amu*angstrom^2'), symmetry=1, barrier=(9.46621,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00401575,'amu*angstrom^2'), symmetry=1, barrier=(9.46806,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.890834,'amu*angstrom^2'), symmetry=1, barrier=(44.4114,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (88.1051,'amu'),
...
species(
    label = '[CH2][CH]C(C)OO(5528)',
    structure = SMILES('[CH2][CH]C(C)OO'),
    E0 = (160.392,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,211.203],'cm^-1')),
        HinderedRotor(inertia=(0.00306156,'amu*angstrom^2'), symmetry=1, barrier=(19.9184,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.162744,'amu*angstrom^2'), symmetry=1, barrier=(37.6407,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.003779,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.23905,'amu*angstrom^2'), symmetry=1, barrier=(7.56711,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.18913,'amu*angstrom^2'), symmetry=1, barrier=(37.6408,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (88.1051,'amu'),
...
species(
    label = '[CH2]CC([CH2])OO(5446)',
    structure = SMILES('[CH2]CC([CH2])OO'),
    E0 = (173.939,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,1475.88],'cm^-1')),
        HinderedRotor(inertia=(0.162793,'amu*angstrom^2'), symmetry=1, barrier=(8.36956,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.389419,'amu*angstrom^2'), symmetry=1, barrier=(19.9005,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0128723,'amu*angstrom^2'), symmetry=1, barrier=(19.9005,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.162033,'amu*angstrom^2'), symmetry=1, barrier=(8.37118,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.840942,'amu*angstrom^2'), symmetry=1, barrier=(42.7755,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (88.1051,'amu'),
...
species(
    ...
    E0 = (-3.51052,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,3000,3100,440,815,1455,1000,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000],'cm^-1')),
        HinderedRotor(inertia=(0.00875283,'amu*angstrom^2'), symmetry=1, barrier=(2.92003,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.458091,'amu*angstrom^2'), symmetry=1, barrier=(10.5324,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.458941,'amu*angstrom^2'), symmetry=1, barrier=(10.552,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.460156,'amu*angstrom^2'), symmetry=1, barrier=(10.5799,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (75.0865,'amu'),
...
reaction(
    label = 'reaction1',
    reactants = ['H(3)(3)', 'C=CC(C)OO(5526)'],
    products = ['S(209)(208)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction3',
    reactants = ['OH(5)(5)', '[CH2]CC(C)[O](3562)'],
    products = ['S(209)(208)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['C2H5O2(61)(60)', 'C2H4(T)(899)'],
    products = ['S(209)(208)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['CH3(15)(16)', '[CH2]C[CH]OO(5030)'],
    products = ['S(209)(208)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(3)(3)', '[CH2]C[C](C)OO(5527)'],
    products = ['S(209)(208)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(3)(3)', '[CH2][CH]C(C)OO(5528)'],
    products = ['S(209)(208)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(3)(3)', '[CH2]CC([CH2])OO(5446)'],
    products = ['S(209)(208)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CH2(17)(18)', 'QOOH_3(5164)'],
    products = ['S(209)(208)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(3)(3)', '[CH]CC(C)OO(5532)'],
    products = ['S(209)(208)'],
