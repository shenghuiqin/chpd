...
species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.00155062,'amu*angstrom^2'), symmetry=1, barrier=(7.85171,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0136052,'amu*angstrom^2'), symmetry=1, barrier=(68.7947,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00155446,'amu*angstrom^2'), symmetry=1, barrier=(7.85969,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (56.1063,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.62536,0.0229971,-1.74547e-06,-3.25078e-09,7.61424e-13,29450.7,14.8448], Tmin=(100,'K'), Tmax=(2137.09,'K')), NASAPolynomial(coeffs=[11.486,0.0201914,-8.13357e-06,1.34908e-09,-8.16542e-14,23371.8,-35.4093], Tmin=(2137.09,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(244.869,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: DFT_QCI_thermo + radical(RCCJC) + radical(RCCJC)"""),
)
...
species(
    ...
    E0 = (56.5721,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100],'cm^-1')),
        HinderedRotor(inertia=(0.00366264,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.212057,'amu*angstrom^2'), symmetry=1, barrier=(6.82733,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.208719,'amu*angstrom^2'), symmetry=1, barrier=(6.83852,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (57.1143,'amu'),
...
species(
    ...
    E0 = (304.191,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,333.924,334.02],'cm^-1')),
        HinderedRotor(inertia=(0.104474,'amu*angstrom^2'), symmetry=1, barrier=(8.27067,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.104483,'amu*angstrom^2'), symmetry=1, barrier=(8.27044,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.144985,'amu*angstrom^2'), symmetry=1, barrier=(11.4739,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (56.1063,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.09982,0.0375762,-2.10973e-05,5.90412e-09,-6.68311e-13,36657.6,15.5028], Tmin=(100,'K'), Tmax=(1987.25,'K')), NASAPolynomial(coeffs=[11.3193,0.0190193,-7.09066e-06,1.20536e-09,-7.72079e-14,32993.3,-35.3073], Tmin=(1987.25,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(304.191,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: DFT_QCI_thermo + radical(CCJ2_triplet)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['C2H4(19)(20)', 'C2H5(27)(28)'],
    products = ['C4H9(68)(67)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['C2H5(27)(28)', 'C2H4(T)(899)'],
    products = ['C4H9(68)(67)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CH3(15)(16)', '[CH2]C[CH2](898)'],
    products = ['C4H9(68)(67)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)(3)', '[CH2]C[CH]C(873)'],
    products = ['C4H9(68)(67)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['H(3)(3)', '[CH2]CC[CH2](896)'],
    products = ['C4H9(68)(67)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['C3H7(69)(68)', 'CH2(S)(21)(22)'],
    products = ['C4H9(68)(67)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['C4H9(68)(67)'],
    products = ['C4H9(225)(224)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['C3H7(69)(68)', 'CH2(17)(18)'],
    products = ['C4H9(68)(67)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CH3(15)(16)', 'C3H6(83)(82)'],
    products = ['C4H9(225)(224)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CH3(15)(16)', 'C3H6(T)(876)'],
    products = ['C4H9(225)(224)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(3)(3)', 'C[CH][CH]C(1422)'],
    products = ['C4H9(225)(224)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CH2(S)(21)(22)', 'C3H7(229)(228)'],
    products = ['C4H9(225)(224)'],
...
reaction(
    label = 'reaction21',
    reactants = ['C2H5(27)(28)', 'CHCH3(T)(883)'],
    products = ['C4H9(225)(224)'],
...
network(
    ...
    reactants = [
        ('H(3)(3)', 'C4H8(80)(79)'),
        ('C2H4(19)(20)', 'C2H5(27)(28)'),
        ('C3H7(69)(68)', 'CH2(S)(21)(22)'),
        ('C3H7(69)(68)', 'CH2(17)(18)'),
        ('H(3)(3)', 'C4H8(94)(93)'),
        ('CH3(15)(16)', 'C3H6(83)(82)'),
        ('CH2(S)(21)(22)', 'C3H7(229)(228)'),
    ],
    bathGas = {
        'Ne': 0.333333,
        'N2': 0.333333,
