species(
    label = '[CH2]CO[C]=O(3312)',
    structure = SMILES('[CH2]CO[C]=O'),
    E0 = (1.65298,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,1855,455,950,3000,3100,440,815,1455,1000,202.583,202.633],'cm^-1')),
        HinderedRotor(inertia=(0.302906,'amu*angstrom^2'), symmetry=1, barrier=(8.83319,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0178286,'amu*angstrom^2'), symmetry=1, barrier=(18.7402,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0178256,'amu*angstrom^2'), symmetry=1, barrier=(18.7406,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)(3)', 'C=CO[C]=O(6574)'],
    products = ['[CH2]CO[C]=O(3312)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction9',
    reactants = ['CO(10)(11)', '[CH2]C[O](1195)'],
    products = ['[CH2]CO[C]=O(3312)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]C[O](1195)', '[C]=O(1191)'],
    products = ['[CH2]CO[C]=O(3312)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CH2(17)(18)', '[CH2]O[C]=O(6578)'],
    products = ['[CH2]CO[C]=O(3312)'],
