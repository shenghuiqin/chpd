...
species(
    label = 'O[C]1C[C]2CC=CC12(2398)',
    structure = SMILES('O[C]1C[C]2CC=CC12'),
    E0 = (314.393,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2816.67,2883.33,2950,3016.67,3083.33,3150,900,933.333,966.667,1000,1033.33,1066.67,1100,300,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (108.138,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.36167,0.0503032,-1.56057e-05,-5.75936e-09,3.19393e-12,37913.9,23.8645], Tmin=(100,'K'), Tmax=(1282.29,'K')), NASAPolynomial(coeffs=[10.7386,0.0355096,-1.52118e-05,2.82813e-09,-1.94487e-13,34320.6,-28.3399], Tmin=(1282.29,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(314.393,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(378.308,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + polycyclic(s2_4_5_ene_1) + radical(Tertalkyl) + radical(C2CsJOH)"""),
)

species(
    label = 'OC1[CH]C2CC=C[C]12(2399)',
    structure = SMILES('OC1[CH]C2CC=C[C]12'),
    E0 = (304.818,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2816.67,2883.33,2950,3016.67,3083.33,3150,900,933.333,966.667,1000,1033.33,1066.67,1100,300,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'O[C]1CC2CC=C[C]12(2401)',
    structure = SMILES('O[C]1CC2CC=C[C]12'),
    E0 = (281.544,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2816.67,2883.33,2950,3016.67,3083.33,3150,900,933.333,966.667,1000,1033.33,1066.67,1100,300,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'OC1[CH][C]2CC=CC21(2403)',
    structure = SMILES('OC1[CH][C]2CC=CC21'),
    E0 = (337.667,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2816.67,2883.33,2950,3016.67,3083.33,3150,900,933.333,966.667,1000,1033.33,1066.67,1100,300,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (108.138,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.75173,0.0361173,2.96938e-05,-5.51899e-08,2.08762e-11,40704.4,24.8272], Tmin=(100,'K'), Tmax=(1039.35,'K')), NASAPolynomial(coeffs=[10.4716,0.0346086,-1.43839e-05,2.752e-09,-1.97367e-13,37160.7,-25.9054], Tmin=(1039.35,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(337.667,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(378.308,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + polycyclic(s2_4_5_ene_1) + radical(CCJCO) + radical(Tertalkyl)"""),
)
...
species(
    label = 'OC1[CH]C2CC=[C]C12(2405)',
    structure = SMILES('OC1[CH]C2CC=[C]C12'),
    E0 = (409.751,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2816.67,2883.33,2950,3016.67,3083.33,3150,900,933.333,966.667,1000,1033.33,1066.67,1100,300,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'OC1=C[C]2CC[CH]C21(2406)',
    structure = SMILES('OC1=C[C]2CC[CH]C21'),
    E0 = (265.691,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2816.67,2883.33,2950,3016.67,3083.33,3150,900,933.333,966.667,1000,1033.33,1066.67,1100,300,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (108.138,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.70933,0.0283329,7.23948e-05,-1.13696e-07,4.51527e-11,32057.6,19.7084], Tmin=(100,'K'), Tmax=(964.487,'K')), NASAPolynomial(coeffs=[15.7698,0.0252209,-8.61512e-06,1.63969e-09,-1.24329e-13,26777.9,-60.927], Tmin=(964.487,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(265.691,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(378.308,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + Estimated bicyclic component: polycyclic(s2_4_5_ane) - ring(Cyclopentane) - ring(Cyclobutane) + ring(Cyclopentane) + ring(Cyclobutene) + radical(Cs_S) + radical(Allyl_T)"""),
)
...
species(
    label = 'O[C]1CC2CC=[C]C12(2408)',
    structure = SMILES('O[C]1CC2CC=[C]C12'),
    E0 = (386.477,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2816.67,2883.33,2950,3016.67,3083.33,3150,900,933.333,966.667,1000,1033.33,1066.67,1100,300,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'OC1=CC2[CH][CH]CC12(2409)',
    structure = SMILES('OC1=CC2[CH][CH]CC12'),
    E0 = (319.591,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2816.67,2883.33,2950,3016.67,3083.33,3150,900,933.333,966.667,1000,1033.33,1066.67,1100,300,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (108.138,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.69879,0.0340213,4.37698e-05,-7.60425e-08,2.98489e-11,38535.4,23.365], Tmin=(100,'K'), Tmax=(994.192,'K')), NASAPolynomial(coeffs=[12.7416,0.0301913,-1.17062e-05,2.23257e-09,-1.62894e-13,34333.3,-39.9366], Tmin=(994.192,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(319.591,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(378.308,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + Estimated bicyclic component: polycyclic(s2_4_5_ane) - ring(Cyclopentane) - ring(Cyclobutane) + ring(Cyclopentane) + ring(Cyclobutene) + radical(cyclopentane) + radical(Cs_S)"""),
)
...
species(
    label = 'OC1=CC2CC[CH][C]12(2411)',
    structure = SMILES('O[C]1[CH]C2CCC=C12'),
    E0 = (366.192,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2816.67,2883.33,2950,3016.67,3083.33,3150,900,933.333,966.667,1000,1033.33,1066.67,1100,300,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (108.138,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.23071,0.0390663,4.90734e-05,-9.67581e-08,4.10401e-11,44162.2,28.9995], Tmin=(100,'K'), Tmax=(956.732,'K')), NASAPolynomial(coeffs=[18.8794,0.0197436,-6.02376e-06,1.13707e-09,-8.88745e-14,38292.5,-68.3917], Tmin=(956.732,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(366.192,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(378.308,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + polycyclic(s2_4_5_ene_0) + radical(CCJCO) + radical(C2CsJOH)"""),
)

species(
    label = 'OC1=[C]C2CC[CH]C12(2412)',
    structure = SMILES('OC1=[C]C2CC[CH]C12'),
    E0 = (386.196,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2816.67,2883.33,2950,3016.67,3083.33,3150,900,933.333,966.667,1000,1033.33,1066.67,1100,300,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    ...
    molecularWeight = (108.138,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.2728,0.0473843,5.57472e-06,-3.54426e-08,1.51198e-11,46591.4,22.8124], Tmin=(100,'K'), Tmax=(1044.17,'K')), NASAPolynomial(coeffs=[12.6172,0.0322083,-1.32532e-05,2.51871e-09,-1.79884e-13,42680.5,-39.7911], Tmin=(1044.17,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(386.477,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(378.308,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + polycyclic(s2_4_5_ene_1) + radical(cyclopentene-vinyl) + radical(C2CsJOH)"""),
)
...
species(
    label = '[O]C1=CC2CC[CH]C12(2416)',
    structure = SMILES('O=C1[CH]C2CC[CH]C12'),
    E0 = (270.778,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2807.14,2864.29,2921.43,2978.57,3035.71,3092.86,3150,900,928.571,957.143,985.714,1014.29,1042.86,1071.43,1100,300,800,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
    ],
    ...
    molecularWeight = (108.138,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.92844,0.026346,6.85961e-05,-9.96303e-08,3.7154e-11,32658.5,21.3485], Tmin=(100,'K'), Tmax=(1003.98,'K')), NASAPolynomial(coeffs=[12.2506,0.0333013,-1.36297e-05,2.66921e-09,-1.97062e-13,28162.7,-40.5588], Tmin=(1003.98,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(270.778,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-(Cds-O2d)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cds-OdCsCs) + polycyclic(s2_4_5_ane) + radical(CCJCC=O) + radical(CCJC=O)"""),
)
...
species(
    label = '[CH]=C(O)C1[CH]CC=C1(2417)',
    structure = SMILES('[CH]=C(O)C1[CH]CC=C1'),
    E0 = (313.238,'kJ/mol'),
    modes = [
...
species(
    label = '[CH]=CC1C(O)=CC1[CH2](2418)',
    structure = SMILES('[CH]=CC1C(O)=CC1[CH2]'),
    E0 = (422.037,'kJ/mol'),
    modes = [
...
species(
    ...
    molecularWeight = (108.138,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.705663,0.0496647,3.16593e-05,-8.93155e-08,4.13203e-11,51300.5,30.3505], Tmin=(100,'K'), Tmax=(938.398,'K')), NASAPolynomial(coeffs=[22.7861,0.0132485,-2.3683e-06,3.87304e-10,-3.5061e-14,44615.8,-88.3084], Tmin=(938.398,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(425.377,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(369.994,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Cyclobutene) + radical(Cds_P) + radical(CCJCO)"""),
)
...
species(
    ...
    molecularWeight = (108.138,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.36521,0.0423764,2.77901e-05,-6.0173e-08,2.39604e-11,45932.9,31.187], Tmin=(100,'K'), Tmax=(1019.06,'K')), NASAPolynomial(coeffs=[13.0357,0.0335783,-1.37371e-05,2.63263e-09,-1.90246e-13,41632.5,-34.7658], Tmin=(1019.06,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(381.006,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(378.308,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(CsJ2_singlet-CsH) + polycyclic(s2_4_5_ene_1)"""),
)

species(
    label = 'OC1=CC2CC[C]C12(2422)',
    structure = SMILES('OC1=CC2CC[C]C12'),
    E0 = (365.627,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2816.67,2883.33,2950,3016.67,3083.33,3150,900,933.333,966.667,1000,1033.33,1066.67,1100,300,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
...
species(
    label = 'O[C]1C2[CH]C3CC2C13(2425)',
    structure = SMILES('O[C]1C2[CH]C3CC2C13'),
    E0 = (429.196,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2816.67,2883.33,2950,3016.67,3083.33,3150,900,933.333,966.667,1000,1033.33,1066.67,1100,300,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (108.138,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.88618,0.0436149,-4.17612e-06,-1.16217e-08,3.81212e-12,51698.5,14.3808], Tmin=(100,'K'), Tmax=(1469.79,'K')), NASAPolynomial(coeffs=[10.697,0.0384895,-1.8186e-05,3.46008e-09,-2.37614e-13,47072.1,-38.4468], Tmin=(1469.79,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(429.196,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(378.308,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + polycyclic(s3_4_5_ane) + polycyclic(s2_4_5_ane) + polycyclic(s2_4_4_ane) - ring(Cyclobutane) - ring(Cyclopentane) - ring(Cyclobutane) + radical(C2CsJOH) + radical(bicyclo[2.1.1]hexane-C2)"""),
)

species(
    label = 'OC12[CH]C3CC1[CH]C32(2426)',
...
species(
    ...
    molecularWeight = (108.138,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.61427,0.0455969,-4.36374e-06,-1.42938e-08,5.1727e-12,45626.5,18.301], Tmin=(100,'K'), Tmax=(1326.3,'K')), NASAPolynomial(coeffs=[10.5988,0.0378909,-1.75783e-05,3.37158e-09,-2.34887e-13,41537.8,-34.0105], Tmin=(1326.3,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(378.601,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(378.308,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + polycyclic(s2_4_5_ane) + polycyclic(s2_3_5_ane) + polycyclic(s2_3_4_ane) - ring(Cyclobutane) - ring(Cyclopropane) - ring(Cyclopentane) + radical(CCJCO) + radical(bicyclo[3.1.0]hexane-C5-2)"""),
)

species(
    label = 'O[C]1C2C3[CH]CC2C13(2428)',
    structure = SMILES('O[C]1C2C3[CH]CC2C13'),
    E0 = (455.237,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2816.67,2883.33,2950,3016.67,3083.33,3150,900,933.333,966.667,1000,1033.33,1066.67,1100,300,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (108.138,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.98401,0.0418434,-8.94291e-07,-1.37953e-08,4.30163e-12,54826.6,12.7613], Tmin=(100,'K'), Tmax=(1462.78,'K')), NASAPolynomial(coeffs=[10.0983,0.0394327,-1.87034e-05,3.5645e-09,-2.4503e-13,50336.8,-36.7042], Tmin=(1462.78,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(455.237,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(378.308,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + polycyclic(s2_4_5_ane) + polycyclic(s2_4_5_ane) + polycyclic(s3_4_4_ane) - ring(Cyclobutane) - ring(Cyclobutane) - ring(Cyclopentane) + radical(bicyclo[2.1.1]hexane-C2) + radical(C2CsJOH)"""),
)

species(
    label = 'O=C1CC2CC=CC12(2420)',
    structure = SMILES('O=C1CC2CC=CC12'),
    E0 = (10.3628,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (108.138,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.65247,0.0410747,1.27934e-05,-3.40015e-08,1.24151e-11,1339.58,19.1066], Tmin=(100,'K'), Tmax=(1125.95,'K')), NASAPolynomial(coeffs=[9.50319,0.0382017,-1.67075e-05,3.19924e-09,-2.26307e-13,-2014.1,-26.7419], Tmin=(1125.95,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(10.3628,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-(Cds-O2d)CsCsH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-OdCsCs) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + polycyclic(s2_4_5_ene_1)"""),
)
...
species(
    label = 'C=CC1C2C=CC12O(2424)',
    structure = SMILES('C=CC1C2C=CC12O'),
    E0 = (200.353,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2950,3100,1380,975,1025,1650,3010,987.5,1337.5,450,1655,2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,300,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
...
reaction(
    label = 'reaction756',
    reactants = ['OH(5)(5)', '[C]1=CC2CC=CC12(1432)'],
...
reaction(
    label = 'reaction758',
    reactants = ['H(3)(3)', 'OC1=C[C]2CC=CC21(2392)'],
    products = ['C7H8O(586)(585)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction759',
    reactants = ['H(3)(3)', 'OC1=CC2CC=C[C]12(2393)'],
    products = ['C7H8O(586)(585)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction761',
    reactants = ['H(3)(3)', 'OC1=[C]C2CC=CC12(2395)'],
    products = ['C7H8O(586)(585)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction762',
    reactants = ['H(3)(3)', 'OC1=CC2CC=[C]C12(2396)'],
    products = ['C7H8O(586)(585)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(1e+13,'cm^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""From training reaction 40 used for Cd_rad/NonDe;H_rad
Exact match found for rate rule [Cd_rad/NonDe;H_rad]
...
reaction(
    label = 'reaction763',
    reactants = ['H(3)(3)', 'OC1=CC2C[C]=CC12(2397)'],
    products = ['C7H8O(586)(585)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(1e+13,'cm^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""From training reaction 40 used for Cd_rad/NonDe;H_rad
Exact match found for rate rule [Cd_rad/NonDe;H_rad]
...
reaction(
    label = 'reaction764',
    reactants = ['[O]C1[CH]C2CC=CC12(1752)'],
    products = ['C7H8O(586)(585)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction765',
    reactants = ['O[C]1C[C]2CC=CC12(2398)'],
    products = ['C7H8O(586)(585)'],
...
reaction(
    label = 'reaction766',
    reactants = ['OC1[CH]C2CC=C[C]12(2399)'],
    products = ['C7H8O(586)(585)'],
...
reaction(
    label = 'reaction769',
    reactants = ['O[C]1CC2CC=C[C]12(2401)'],
    products = ['C7H8O(586)(585)'],
...
reaction(
    label = 'reaction771',
    reactants = ['OC1[CH][C]2CC=CC21(2403)'],
    products = ['C7H8O(586)(585)'],
...
reaction(
    label = 'reaction773',
    reactants = ['OC1[CH]C2CC=[C]C12(2405)'],
    products = ['C7H8O(586)(585)'],
...
reaction(
    label = 'reaction774',
    reactants = ['OC1=C[C]2CC[CH]C21(2406)'],
    products = ['C7H8O(586)(585)'],
...
reaction(
    label = 'reaction776',
    reactants = ['O[C]1CC2CC=[C]C12(2408)'],
    products = ['C7H8O(586)(585)'],
...
reaction(
    label = 'reaction777',
    reactants = ['OC1=CC2[CH][CH]CC12(2409)'],
    products = ['C7H8O(586)(585)'],
...
reaction(
    label = 'reaction779',
    reactants = ['OC1=CC2CC[CH][C]12(2411)'],
    products = ['C7H8O(586)(585)'],
...
reaction(
    label = 'reaction780',
    reactants = ['OC1=[C]C2CC[CH]C12(2412)'],
    products = ['C7H8O(586)(585)'],
...
reaction(
    label = 'reaction781',
    reactants = ['O[C]1CC2C[C]=CC12(2413)'],
    products = ['C7H8O(586)(585)'],
...
reaction(
    label = 'reaction783',
    reactants = ['OC1[CH]C2C[C]=CC12(2415)'],
    products = ['C7H8O(586)(585)'],
    transitionState = 'TS28',
    kinetics = Arrhenius(A=(7.76e+08,'s^-1'), n=0.311, Ea=(8.368,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""Estimated using template [R4;Y_rad_NDe;XH_Rrad_NDe] for rate rule [R4radExo;Y_rad_NDe;XH_Rrad_NDe]
Euclidian distance = 1.0
family: Intra_Disproportionation"""),
)
...
reaction(
    label = 'reaction784',
    reactants = ['[O]C1=CC2CC[CH]C12(2416)'],
    products = ['C7H8O(586)(585)'],
...
reaction(
    label = 'reaction786',
    reactants = ['[CH]=C(O)C1[CH]CC=C1(2417)'],
    products = ['C7H8O(586)(585)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(2e+12,'s^-1'), n=0, Ea=(7.5312,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Rn;C_rad_out_H/OneDe;Cpri_rad_out_single] for rate rule [R4_SDS;C_rad_out_H/OneDe;Cpri_rad_out_H/NonDeC]
Euclidian distance = 2.82842712475
family: Birad_recombination"""),
)
...
reaction(
    label = 'reaction788',
    reactants = ['[CH]=CC1C(O)=CC1[CH2](2418)'],
    products = ['C7H8O(586)(585)'],
...
reaction(
    label = 'reaction789',
    reactants = ['[CH]=CCC1[CH]C(O)=C1(2419)'],
    products = ['C7H8O(586)(585)'],
...
reaction(
    label = 'reaction792',
    reactants = ['OC1[C]C2CC=CC12(2421)'],
    products = ['C7H8O(586)(585)'],
...
reaction(
    label = 'reaction793',
    reactants = ['OC1=CC2CC[C]C12(2422)'],
    products = ['C7H8O(586)(585)'],
...
reaction(
    label = 'reaction797',
    reactants = ['O[C]1C2[CH]C3CC2C13(2425)'],
    products = ['C7H8O(586)(585)'],
...
reaction(
    label = 'reaction798',
    reactants = ['OC12[CH]C3CC1[CH]C32(2426)'],
    products = ['C7H8O(586)(585)'],
...
reaction(
    label = 'reaction799',
    reactants = ['OC12[CH]C3C[CH]C1C32(2427)'],
    products = ['C7H8O(586)(585)'],
...
reaction(
    label = 'reaction800',
    reactants = ['O[C]1C2C3[CH]CC2C13(2428)'],
    products = ['C7H8O(586)(585)'],
...
reaction(
    label = 'reaction791',
    reactants = ['C7H8O(586)(585)'],
    products = ['O=C1CC2CC=CC12(2420)'],
