...
species(
    ...
    molecularWeight = (56.0633,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.88147,0.016737,1.67746e-05,-3.384e-08,1.41453e-11,35060.3,11.9351], Tmin=(100,'K'), Tmax=(970.467,'K')), NASAPolynomial(coeffs=[9.13419,0.0103808,-3.41095e-06,6.42091e-10,-4.82614e-14,32932.4,-22.7538], Tmin=(970.467,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(291.115,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), comment="""Thermo library: DFT_QCI_thermo + radical(C2CsJOH) + radical(CC(C)OJ)"""),
)
...
reaction(
    label = 'reaction21',
    reactants = ['CH2(17)(18)', '[CH2][C]=O(1196)'],
    products = ['C3H4O(116)(115)'],
    transitionState = 'TS21',
    kinetics = Arrhenius(A=(2.23625e+06,'m^3/(mol*s)'), n=0.36814, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [Y_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction22',
    reactants = ['C2H4(T)(899)', '[C]=O(1191)'],
    products = ['C3H4O(116)(115)'],
    transitionState = 'TS22',
    kinetics = Arrhenius(A=(4.4725e+06,'m^3/(mol*s)'), n=0.36814, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [Y_rad;Birad]
Euclidian distance = 0
Multiplied by reaction path degeneracy 2.0
family: Birad_R_Recombination
Ea raised from -1.7 to 0 kJ/mol."""),
...
reaction(
    label = 'reaction23',
    reactants = ['H(3)(3)', 'O=C1[CH]C1(4264)'],
    products = ['C3H4O(117)(116)'],
...
reaction(
    label = 'reaction47',
    reactants = ['H(3)(3)', 'C=C1[CH]O1(4272)'],
    products = ['C3H4O(124)(123)'],
...
reaction(
    label = 'reaction50',
    reactants = ['H2CCCH2(837)', 'O(S)(1202)'],
    products = ['C3H4O(124)(123)'],
