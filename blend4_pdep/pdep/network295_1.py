...
species(
    label = '[CH2]CC(C)=O(6385)',
    structure = SMILES('[CH2]CC(C)=O'),
    E0 = (-46.6048,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,375,552.5,462.5,1710,180],'cm^-1')),
        HinderedRotor(inertia=(0.0862025,'amu*angstrom^2'), symmetry=1, barrier=(1.98196,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0860171,'amu*angstrom^2'), symmetry=1, barrier=(1.9777,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0858782,'amu*angstrom^2'), symmetry=1, barrier=(1.97451,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
species(
    ...
    E0 = (41.0323,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,3100,1380,975,1025,1650,1380,1390,370,380,2900,435,3010,987.5,1337.5,450,1655,2750,2800,2850,1350,1500,750,1050,1375,1000,460.653,460.79],'cm^-1')),
...
species(
    ...
    molecularWeight = (72.1057,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.82977,0.0513727,-4.7978e-05,2.86422e-08,-7.64553e-12,11011.7,17.5327], Tmin=(100,'K'), Tmax=(869.945,'K')), NASAPolynomial(coeffs=[6.10026,0.031737,-1.41212e-05,2.69658e-09,-1.89421e-13,10268.6,-2.47505], Tmin=(869.945,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(90.9326,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo library: CBS_QB3_1dHR + radical(CC(C)OJ) + radical(C2CsJOH)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)(3)', '[CH2]CC(C)=O(6385)'],
    products = ['[CH2]CC(C)[O](3562)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction6',
    reactants = ['C2H4(19)(20)', 'C2H4O(197)(196)'],
    products = ['[CH2]CC(C)[O](3562)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction16',
    reactants = ['CH2(S)(21)(22)', '[CH2]CC[O](2830)'],
    products = ['[CH2]CC(C)[O](3562)'],
...
reaction(
    label = 'reaction18',
    reactants = ['O(4)(4)', '[CH2]C[CH]C(873)'],
    products = ['[CH2]CC(C)[O](3562)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CH2(17)(18)', '[CH2]C(C)[O](5507)'],
    products = ['[CH2]CC(C)[O](3562)'],
