...
reaction(
    label = 'reaction5',
    reactants = ['CH2OH(22)(23)'],
    products = ['H(3)(3)', 'CH2O(13)(14)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction6',
    reactants = ['H(3)(3)', '[CH2][O](1408)'],
    products = ['CH2OH(22)(23)'],
    transitionState = 'TS3',
