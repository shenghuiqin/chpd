...
species(
    ...
    E0 = (249.695,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2830,2910,2990,3070,3150,900,940,980,1020,1060,1100,3010,987.5,1337.5,450,1655,300,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
species(
    ...
    molecularWeight = (93.1464,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.0096,0.0224592,8.20034e-05,-1.17999e-07,4.52692e-11,22244.1,17.8055], Tmin=(100,'K'), Tmax=(972.465,'K')), NASAPolynomial(coeffs=[13.5321,0.0286804,-1.02939e-05,1.96983e-09,-1.47496e-13,17467.9,-50.4969], Tmin=(972.465,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(184.193,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(403.252,'J/(mol*K)'), comment="""QM MopacMolPM3 calculation attempt 1 + radical(cyclopentene-allyl)"""),
)
...
species(
    ...
    molecularWeight = (67.1091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.9959,0.00512056,8.38158e-05,-1.0783e-07,4.02205e-11,30819.4,14.4988], Tmin=(100,'K'), Tmax=(964.985,'K')), NASAPolynomial(coeffs=[9.80227,0.0201927,-6.89711e-06,1.3233e-09,-1.00718e-13,27490.5,-28.5379], Tmin=(964.985,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(255.82,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(307.635,'J/(mol*K)'), comment="""QM MopacMolPM3 calculation attempt 1 + radical(cyclopentene-vinyl)"""),
)

species(
    label = 'C=CC1=[C]CCC1(322)',
    structure = SMILES('C=CC1=[C]CCC1'),
    E0 = (314.394,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3010,987.5,1337.5,450,1655,2750,2830,2910,2990,3070,3150,900,940,980,1020,1060,1100,2950,3100,1380,975,1025,1650,300,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
    ...
    molecularWeight = (93.1464,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.77062,0.0323704,4.79859e-05,-7.99302e-08,3.12192e-11,37908,20.9371], Tmin=(100,'K'), Tmax=(988.633,'K')), NASAPolynomial(coeffs=[12.3537,0.0305763,-1.1537e-05,2.18188e-09,-1.58915e-13,33810.5,-40.1388], Tmin=(988.633,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(314.394,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(403.252,'J/(mol*K)'), comment="""QM MopacMolPM3 calculation attempt 1 + radical(cyclopentene-vinyl)"""),
)

species(
    label = 'C=[C]C1=CCCC1(323)',
    structure = SMILES('C=C=C1[CH]CCC1'),
    E0 = (240.353,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([540,610,2055,2750,2816.67,2883.33,2950,3016.67,3083.33,3150,900,933.333,966.667,1000,1033.33,1066.67,1100,2950,3100,1380,975,1025,1650,300,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (93.1464,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.96414,0.0238973,7.78829e-05,-1.13793e-07,4.38105e-11,28999.9,20.1028], Tmin=(100,'K'), Tmax=(973.16,'K')), NASAPolynomial(coeffs=[13.5513,0.0286894,-1.03005e-05,1.9674e-09,-1.46984e-13,24262.5,-48.2362], Tmin=(973.16,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(240.353,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(407.409,'J/(mol*K)'), comment="""QM MopacMolPM3 calculation attempt 1 + radical(Allyl_S)"""),
)

species(
    label = '[CH]=CC1=CCCC1(324)',
    ...
    molecularWeight = (93.1464,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.73053,0.0312909,5.60982e-05,-9.17536e-08,3.62236e-11,36659.2,21.01], Tmin=(100,'K'), Tmax=(976.866,'K')), NASAPolynomial(coeffs=[13.7367,0.0283205,-1.02688e-05,1.94422e-09,-1.43548e-13,32109.6,-47.9124], Tmin=(976.866,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(303.984,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(403.252,'J/(mol*K)'), comment="""QM MopacMolPM3 calculation attempt 1 + radical(Cds_P)"""),
)

species(
    label = '[CH2]CC1[CH]CCC=1(325)',
    ...
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.92328,0.0247914,8.01806e-05,-1.14609e-07,4.33564e-11,31776,21.5351], Tmin=(100,'K'), Tmax=(983.374,'K')), NASAPolynomial(coeffs=[12.8077,0.0329824,-1.23415e-05,2.36904e-09,-1.75435e-13,27098.6,-43.6918], Tmin=(983.374,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(263.424,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(448.981,'J/(mol*K)'), comment="""QM MopacMolPM3 calculation attempt 1 + radical(RCCJ) + radical(cyclopentene-allyl)"""),
)

species(
    label = '[CH2]CC1=[C]CCC1(326)',
    structure = SMILES('[CH2]CC1=[C]CCC1'),
    E0 = (393.625,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2830,2910,2990,3070,3150,900,940,980,1020,1060,1100,2750,2850,1437.5,1250,1305,750,350,300,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
    ...
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.68166,0.0347269,4.6115e-05,-7.65406e-08,2.93385e-11,47440,24.6765], Tmin=(100,'K'), Tmax=(1004.52,'K')), NASAPolynomial(coeffs=[11.6787,0.0347973,-1.35392e-05,2.57056e-09,-1.85993e-13,43419.5,-33.6134], Tmin=(1004.52,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(393.625,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(448.981,'J/(mol*K)'), comment="""QM MopacMolPM3 calculation attempt 1 + radical(cyclopentene-vinyl) + radical(RCCJ)"""),
)

species(
    label = 'C[CH]C1[CH]CCC=1(327)',
    ...
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.08757,0.0187961,9.97016e-05,-1.35474e-07,5.08064e-11,24058.8,18.0521], Tmin=(100,'K'), Tmax=(977.834,'K')), NASAPolynomial(coeffs=[13.0692,0.0327702,-1.20816e-05,2.33389e-09,-1.74742e-13,19095.4,-49.0792], Tmin=(977.834,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(199.291,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(448.981,'J/(mol*K)'), comment="""QM MopacMolPM3 calculation attempt 1 + radical(Allyl_S) + radical(cyclopentene-allyl)"""),
)

species(
    label = 'C[CH]C1=[C]CCC1(328)',
    structure = SMILES('C[CH]C1=[C]CCC1'),
    E0 = (329.492,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2830,2910,2990,3070,3150,900,940,980,1020,1060,1100,3025,407.5,1350,352.5,300,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
    ...
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.84912,0.0286982,6.57317e-05,-9.74925e-08,3.68067e-11,39722.6,21.1819], Tmin=(100,'K'), Tmax=(993.726,'K')), NASAPolynomial(coeffs=[11.9032,0.0346461,-1.33136e-05,2.54339e-09,-1.85954e-13,35432.5,-38.7918], Tmin=(993.726,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(329.492,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(448.981,'J/(mol*K)'), comment="""QM MopacMolPM3 calculation attempt 1 + radical(cyclopentene-vinyl) + radical(Allyl_S)"""),
)

species(
    label = '[CH2]CC1=CC[CH]C1(329)',
    ...
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.8821,0.0306646,5.2903e-05,-7.99255e-08,2.96009e-11,38952.5,25.8317], Tmin=(100,'K'), Tmax=(1015.55,'K')), NASAPolynomial(coeffs=[10.3243,0.0369425,-1.4756e-05,2.81811e-09,-2.03584e-13,35199.4,-25.0632], Tmin=(1015.55,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(323.12,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(448.981,'J/(mol*K)'), comment="""QM MopacMolPM3 calculation attempt 1 + radical(RCCJ) + radical(cyclopentene-4)"""),
)

species(
    label = '[CH]=C(C=C)CC[CH2](330)',
    structure = SMILES('[CH]=C(C=C)CC[CH2]'),
    E0 = (462.247,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,3120,650,792.5,1650,350,440,435,1725,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,292.153,292.184],'cm^-1')),
        HinderedRotor(inertia=(0.00197326,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.263633,'amu*angstrom^2'), symmetry=1, barrier=(16.0467,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.264464,'amu*angstrom^2'), symmetry=1, barrier=(16.0439,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.264587,'amu*angstrom^2'), symmetry=1, barrier=(16.0462,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.378746,0.0693587,-4.18915e-05,3.49304e-09,4.06155e-12,55734.8,28.9404], Tmin=(100,'K'), Tmax=(1024.59,'K')), NASAPolynomial(coeffs=[15.9439,0.0282953,-1.06201e-05,1.91451e-09,-1.32869e-13,51511.1,-51.5775], Tmin=(1024.59,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(462.247,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(390.78,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cds_P) + radical(RCCJ)"""),
)

species(
    label = '[CH2]C=C(C=C)C[CH2](331)',
    structure = SMILES('[CH2]C=C(C=C)C[CH2]'),
    E0 = (320.962,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2995,3025,975,1000,1300,1375,400,500,1630,1680,2950,3100,1380,975,1025,1650,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,2750,2850,1437.5,1250,1305,750,350,350,440,435,1725,670.823,670.859],'cm^-1')),
        HinderedRotor(inertia=(0.00820306,'amu*angstrom^2'), symmetry=1, barrier=(2.6205,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.943751,'amu*angstrom^2'), symmetry=1, barrier=(21.6987,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.943833,'amu*angstrom^2'), symmetry=1, barrier=(21.7006,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(3.43957,'amu*angstrom^2'), symmetry=1, barrier=(79.0826,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.825213,0.0566307,-4.85082e-06,-3.44979e-08,1.75493e-11,38728.9,27.3604], Tmin=(100,'K'), Tmax=(974.503,'K')), NASAPolynomial(coeffs=[15.0125,0.0293168,-1.04017e-05,1.85869e-09,-1.30467e-13,34495.6,-48.2517], Tmin=(974.503,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(320.962,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(390.78,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + radical(C=CC=CCJ) + radical(RCCJ)"""),
)

species(
    label = '[CH2]CC=C([CH2])C=C(332)',
    structure = SMILES('[CH2]CC=C([CH2])C=C'),
    E0 = (354.405,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2995,3025,975,1000,1300,1375,400,500,1630,1680,2950,3100,1380,975,1025,1650,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,2750,2850,1437.5,1250,1305,750,350,350,440,435,1725,180,933.475],'cm^-1')),
        HinderedRotor(inertia=(0.799037,'amu*angstrom^2'), symmetry=1, barrier=(18.3714,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.800894,'amu*angstrom^2'), symmetry=1, barrier=(18.4141,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0292961,'amu*angstrom^2'), symmetry=1, barrier=(18.3434,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.253396,'amu*angstrom^2'), symmetry=1, barrier=(18.3489,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.541294,0.0630763,-1.96543e-05,-2.18231e-08,1.3528e-11,42761.2,27.7954], Tmin=(100,'K'), Tmax=(985.662,'K')), NASAPolynomial(coeffs=[16.5938,0.0272939,-9.88313e-06,1.79007e-09,-1.26544e-13,38170.4,-56.652], Tmin=(985.662,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(354.405,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(390.78,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + radical(Allyl_P) + radical(RCCJ)"""),
)

species(
    label = 'C[C]C1=CCCC1(333)',
    ...
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.56673,0.0361598,4.73745e-05,-8.14749e-08,3.19708e-11,36731.3,22.3264], Tmin=(100,'K'), Tmax=(989.828,'K')), NASAPolynomial(coeffs=[12.7981,0.0332928,-1.27163e-05,2.39582e-09,-1.73513e-13,32424.9,-42.2654], Tmin=(989.828,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(304.545,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(399.095,'J/(mol*K)'), comment="""QM MopacMolPM3 calculation attempt 1"""),
)

species(
    label = '[CH]CC1=CCCC1(334)',
    structure = SMILES('[CH]CC1=CCCC1'),
    E0 = (382.663,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2816.67,2883.33,2950,3016.67,3083.33,3150,900,933.333,966.667,1000,1033.33,1066.67,1100,2750,2850,1437.5,1250,1305,750,350,300,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
    ...
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.47982,0.0374239,4.71094e-05,-8.32681e-08,3.30798e-11,46130.5,22.6115], Tmin=(100,'K'), Tmax=(985.156,'K')), NASAPolynomial(coeffs=[13.6238,0.0322305,-1.2152e-05,2.28876e-09,-1.66402e-13,41597,-46.6596], Tmin=(985.156,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(382.663,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(399.095,'J/(mol*K)'), comment="""QM MopacMolPM3 calculation attempt 1"""),
)

species(
    label = 'C1CC2CCCC=12(335)',
    ...
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.27244,0.0105621,0.000126831,-1.68451e-07,6.39344e-11,17935.1,18.8093], Tmin=(100,'K'), Tmax=(959.667,'K')), NASAPolynomial(coeffs=[14.8634,0.0278282,-9.17349e-06,1.76276e-09,-1.36346e-13,12306.7,-58.1501], Tmin=(959.667,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(148.397,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(407.409,'J/(mol*K)'), comment="""QM MopacMolPM3 calculation attempt 1"""),
)
...
reaction(
    label = 'reaction210',
    reactants = ['H(10)', 'C=CC1[CH]CCC=1(320)'],
    products = ['C=CC1=CCCC1(273)'],
...
reaction(
    label = 'reaction212',
    reactants = ['C2H3(32)', '[C]1=CCCC1(321)'],
    products = ['C=CC1=CCCC1(273)'],
...
reaction(
    label = 'reaction213',
    reactants = ['H(10)', 'C=CC1=[C]CCC1(322)'],
    products = ['C=CC1=CCCC1(273)'],
...
reaction(
    label = 'reaction214',
    reactants = ['H(10)', 'C=[C]C1=CCCC1(323)'],
    products = ['C=CC1=CCCC1(273)'],
...
reaction(
    label = 'reaction215',
    reactants = ['H(10)', '[CH]=CC1=CCCC1(324)'],
    products = ['C=CC1=CCCC1(273)'],
...
reaction(
    label = 'reaction219',
    reactants = ['[CH2]CC1[CH]CCC=1(325)'],
    products = ['C=CC1=CCCC1(273)'],
...
reaction(
    label = 'reaction222',
    reactants = ['C[CH]C1[CH]CCC=1(327)'],
    products = ['C=CC1=CCCC1(273)'],
...
reaction(
    label = 'reaction227',
    reactants = ['[CH2]CC1=CC[CH]C1(329)'],
    products = ['C=CC1=CCCC1(273)'],
...
reaction(
    label = 'reaction229',
    reactants = ['CC=C1[CH]C[CH]C1(256)'],
    products = ['C=CC1=CCCC1(273)'],
...
reaction(
    label = 'reaction234',
    reactants = ['[CH2]C=C(C=C)C[CH2](331)'],
    products = ['C=CC1=CCCC1(273)'],
...
reaction(
    label = 'reaction235',
    reactants = ['[CH2]CC=C([CH2])C=C(332)'],
    products = ['C=CC1=CCCC1(273)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(9.18294e+11,'s^-1'), n=0.345437, Ea=(91.3338,'kJ/mol'), T0=(1,'K'), Tmin=(303.03,'K'), Tmax=(2000,'K'), comment="""Estimated using template [CsJ2-C;CsJ2(CsC);CH] for rate rule [CsJ2-C;CsJ2(CsC);CH(C)C]
Euclidian distance = 1.0
family: Singlet_Carbene_Intra_Disproportionation"""),
)
