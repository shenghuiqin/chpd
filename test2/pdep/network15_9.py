...
species(
    ...
    E0 = (464.122,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,2950,3050,3150,900,950,1000,1050,1100,3000,3100,440,815,1455,1000,2750,2850,1437.5,1250,1305,750,350,3025,407.5,1350,352.5,670.289,906.043,906.043,906.043,906.043,906.043,906.043,906.043,906.043,906.043,906.043,906.043,906.043,2427.63,2427.63],'cm^-1')),
        HinderedRotor(inertia=(0.00373016,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00373016,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00373016,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
...
species(
    label = '[CH2]C=[C]CC1CC1(191)',
    structure = SMILES('[CH2]C=[C]CC1CC1'),
    E0 = (444.562,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,1685,370,2750,2850,2950,3050,3150,900,950,1000,1050,1100,2750,2850,1437.5,1250,1305,750,350,300,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.35518,0.0408837,3.82436e-05,-7.44641e-08,3.00484e-11,53579,24.9539], Tmin=(100,'K'), Tmax=(989.772,'K')), NASAPolynomial(coeffs=[13.9484,0.0320086,-1.19851e-05,2.25903e-09,-1.6423e-13,49028,-46.0687], Tmin=(989.772,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(444.562,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(444.824,'J/(mol*K)'), comment="""QM MopacMolPM3 calculation attempt 1 + radical(Allyl_P) + radical(Cds_S)"""),
)

species(
    label = 'C[C]=C[CH]C1CC1(192)',
    structure = SMILES('C[C]=C[CH]C1CC1'),
    E0 = (434.175,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.54728,0.0382161,3.84734e-05,-6.94281e-08,2.69644e-11,52321.3,22.8783], Tmin=(100,'K'), Tmax=(1008.53,'K')), NASAPolynomial(coeffs=[11.9244,0.0352007,-1.37712e-05,2.60717e-09,-1.8787e-13,48288.5,-36.8901], Tmin=(1008.53,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(434.175,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(444.824,'J/(mol*K)'), comment="""QM MopacMolPM3 calculation attempt 1 + radical(Cds_S) + radical(Allyl_S)"""),
)

species(
    label = '[CH2][C]=CCC1CC1(193)',
...
species(
    label = 'CC=[C][CH]C1CC1(194)',
    structure = SMILES('CC=[C][CH]C1CC1'),
    E0 = (434.175,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,1685,370,2750,2850,2950,3050,3150,900,950,1000,1050,1100,3025,407.5,1350,352.5,180,1075.59,1075.59,1075.59,1075.59,1075.59,1075.59,1075.59,1075.59,1075.59,1075.59,2261.16],'cm^-1')),
        HinderedRotor(inertia=(0.0556349,'amu*angstrom^2'), symmetry=1, barrier=(1.27916,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0556349,'amu*angstrom^2'), symmetry=1, barrier=(1.27916,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0556349,'amu*angstrom^2'), symmetry=1, barrier=(1.27916,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    ...
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.54728,0.0382161,3.84734e-05,-6.94281e-08,2.69644e-11,52321.3,22.8783], Tmin=(100,'K'), Tmax=(1008.53,'K')), NASAPolynomial(coeffs=[11.9244,0.0352007,-1.37712e-05,2.60717e-09,-1.8787e-13,48288.5,-36.8901], Tmin=(1008.53,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(434.175,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(444.824,'J/(mol*K)'), comment="""QM MopacMolPM3 calculation attempt 1 + radical(Allyl_S) + radical(Cds_S)"""),
)

species(
    label = '[CH2]C1[CH]C1C1CC1(195)',
    ...
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.83242,0.0312625,5.44203e-05,-8.5184e-08,3.27696e-11,63754.6,26.2074], Tmin=(100,'K'), Tmax=(983.482,'K')), NASAPolynomial(coeffs=[11.0118,0.0345948,-1.26862e-05,2.34892e-09,-1.68694e-13,59982.4,-27.9233], Tmin=(983.482,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(529.316,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(448.981,'J/(mol*K)'), comment="""QM MopacMolPM3 calculation attempt 1 + radical(Isobutyl) + radical(cyclopropane)"""),
)

species(
    label = '[CH]1CC1[CH]C1CC1(196)',
    ...
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.15481,0.022172,7.65138e-05,-1.03684e-07,3.77136e-11,63665.4,26.4826], Tmin=(100,'K'), Tmax=(1006.3,'K')), NASAPolynomial(coeffs=[10.265,0.0366363,-1.46613e-05,2.8381e-09,-2.07774e-13,59668.5,-24.4442], Tmin=(1006.3,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(528.657,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(448.981,'J/(mol*K)'), comment="""QM MopacMolPM3 calculation attempt 1 + radical(cyclopropane) + radical(Cs_S)"""),
)

species(
    label = 'CC=C=CC1CC1(197)',
    ...
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.4389,0.0406639,3.32831e-05,-6.69226e-08,2.69758e-11,25960.7,23.6591], Tmin=(100,'K'), Tmax=(991.941,'K')), NASAPolynomial(coeffs=[12.6686,0.0331941,-1.26033e-05,2.34799e-09,-1.68348e-13,21872.5,-39.8044], Tmin=(991.941,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(214.967,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(399.095,'J/(mol*K)'), comment="""QM MopacMolPM3 calculation attempt 1"""),
)

species(
    label = 'C=C=CCC1CC1(198)',
    ...
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.48936,0.0371648,4.74926e-05,-8.45419e-08,3.39172e-11,27836.5,22.9817], Tmin=(100,'K'), Tmax=(977.081,'K')), NASAPolynomial(coeffs=[13.8113,0.0311137,-1.1369e-05,2.1194e-09,-1.53983e-13,23309.5,-47.0228], Tmin=(977.081,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(230.56,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(399.095,'J/(mol*K)'), comment="""QM MopacMolPM3 calculation attempt 1"""),
)
...
species(
    ...
    E0 = (469.765,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,2950,3050,3150,900,950,1000,1050,1100,600,996.595,996.595,996.595,996.595,996.595,996.595,996.595,996.595,996.595,996.595,996.595,2278.32],'cm^-1')),
        HinderedRotor(inertia=(0.00273422,'amu*angstrom^2'), symmetry=1, barrier=(0.2243,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (54.0904,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.04424,0.00729049,6.14917e-05,-8.28469e-08,3.15571e-11,56546.5,13.8162], Tmin=(100,'K'), Tmax=(960.945,'K')), NASAPolynomial(coeffs=[9.63494,0.0147788,-4.71002e-06,9.00193e-10,-6.95608e-14,53667.4,-26.1072], Tmin=(960.945,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(469.765,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(278.535,'J/(mol*K)'), comment="""QM MopacMolPM3 calculation attempt 1 + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH]=C[CH]C1CC1(200)',
    structure = SMILES('[CH]C=CC1CC1'),
    E0 = (452.439,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2995,3025,975,1000,1300,1375,400,500,1630,1680,2750,2850,2950,3050,3150,900,950,1000,1050,1100,251.612,1070.95,1070.95,1070.95,1070.95,1070.95,1070.95,1070.95,1070.95,1070.95,1070.95,1070.95,1070.95,2256.48],'cm^-1')),
        HinderedRotor(inertia=(0.00975557,'amu*angstrom^2'), symmetry=1, barrier=(0.2243,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00975557,'amu*angstrom^2'), symmetry=1, barrier=(0.2243,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    ...
    molecularWeight = (80.1277,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.96623,0.0281764,5.56447e-05,-8.61578e-08,3.32106e-11,54503.8,21.1237], Tmin=(100,'K'), Tmax=(981.344,'K')), NASAPolynomial(coeffs=[11.3346,0.0310713,-1.15728e-05,2.16334e-09,-1.5661e-13,50686.9,-33.9754], Tmin=(981.344,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(452.439,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(374.151,'J/(mol*K)'), comment="""QM MopacMolPM3 calculation attempt 1 + radical(AllylJ2_triplet)"""),
)

species(
    label = '[CH]1[CH]C(C1)C1CC1(201)',
    ...
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.34595,0.0167219,9.11003e-05,-1.1808e-07,4.26678e-11,51499.1,24.4074], Tmin=(100,'K'), Tmax=(998.765,'K')), NASAPolynomial(coeffs=[9.89271,0.0367693,-1.45089e-05,2.80977e-09,-2.06586e-13,47484.2,-24.5444], Tmin=(998.765,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(427.548,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""QM MopacMolPM3 calculation attempt 1 + radical(cyclobutane) + radical(cyclobutane)"""),
)

species(
    label = 'C=CC[CH][C]1CC1(202)',
    structure = SMILES('C=CC[CH][C]1CC1'),
    E0 = (455.095,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2950,3100,1380,975,1025,1650,3010,987.5,1337.5,450,1655,2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,2750,2850,1437.5,1250,1305,750,350,180,1048.89,1048.89,1048.89,1048.89,1048.89,1048.89,1048.89,1048.89,1048.89,1048.89,2282.2],'cm^-1')),
        HinderedRotor(inertia=(0.0468859,'amu*angstrom^2'), symmetry=1, barrier=(1.078,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0468859,'amu*angstrom^2'), symmetry=1, barrier=(1.078,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0468859,'amu*angstrom^2'), symmetry=1, barrier=(1.078,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    ...
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.70399,0.0411773,1.18264e-05,-3.07062e-08,1.08742e-11,54825.6,27.0129], Tmin=(100,'K'), Tmax=(1148.34,'K')), NASAPolynomial(coeffs=[8.17054,0.0410975,-1.73878e-05,3.27467e-09,-2.29054e-13,51860.5,-11.5226], Tmin=(1148.34,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(455.095,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(444.824,'J/(mol*K)'), comment="""QM MopacMolPM3 calculation attempt 1 + radical(Cs_S) + radical(Tertalkyl)"""),
)
...
species(
    ...
    E0 = (309.846,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,2950,3050,3150,900,950,1000,1050,1100,718.718,1076.87,1076.87,1076.88,1076.88,1076.88,1076.88,1076.88,1076.88,1076.89,1821.44],'cm^-1')),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (53.0825,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.65599,-0.0109478,0.000106767,-1.29433e-07,4.82692e-11,37295.1,8.17233], Tmin=(100,'K'), Tmax=(946.806,'K')), NASAPolynomial(coeffs=[9.8639,0.0103879,-2.38687e-06,4.8093e-10,-4.35666e-14,33987.7,-32.696], Tmin=(946.806,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(309.846,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(232.805,'J/(mol*K)'), comment="""QM MopacMolPM3 calculation attempt 1 + radical(cyclobutene-allyl)"""),
)

species(
    label = 'C1=CC(C1)[C]1CC1(279)',
    ...
    molecularWeight = (93.1464,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.08414,0.0265885,5.54749e-05,-8.15423e-08,3.02975e-11,49581.8,21.5501], Tmin=(100,'K'), Tmax=(1004.6,'K')), NASAPolynomial(coeffs=[9.97207,0.0339374,-1.33656e-05,2.54285e-09,-1.83928e-13,46041.3,-26.2744], Tmin=(1004.6,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(411.559,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(403.252,'J/(mol*K)'), comment="""QM MopacMolPM3 calculation attempt 1 + radical(Tertalkyl)"""),
)

species(
    label = 'C1=C[C](C1)C1CC1(280)',
    ...
    molecularWeight = (93.1464,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.27689,0.0137854,0.000107631,-1.45854e-07,5.56805e-11,43155.4,18.6682], Tmin=(100,'K'), Tmax=(958.94,'K')), NASAPolynomial(coeffs=[13.7598,0.0270737,-8.86438e-06,1.67356e-09,-1.27487e-13,38139.9,-50.9173], Tmin=(958.94,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(358.117,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(403.252,'J/(mol*K)'), comment="""QM MopacMolPM3 calculation attempt 1 + radical(Allyl_T)"""),
)

species(
    label = '[CH]1CC1C1C=CC1(281)',
    ...
    molecularWeight = (93.1464,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.16723,0.0197232,8.40864e-05,-1.16968e-07,4.41475e-11,54453.4,22.4632], Tmin=(100,'K'), Tmax=(978.189,'K')), NASAPolynomial(coeffs=[12.3975,0.0298175,-1.1021e-05,2.1201e-09,-1.58067e-13,49967.6,-39.3649], Tmin=(978.189,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(452.049,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(403.252,'J/(mol*K)'), comment="""QM MopacMolPM3 calculation attempt 1 + radical(cyclopropane)"""),
)

species(
    label = '[CH]1C=CC1C1CC1(282)',
    ...
    molecularWeight = (93.1464,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.20169,0.0139082,0.000111275,-1.51731e-07,5.80356e-11,47075.9,18.885], Tmin=(100,'K'), Tmax=(961.627,'K')), NASAPolynomial(coeffs=[15.0269,0.025618,-8.47209e-06,1.6399e-09,-1.27374e-13,41601.2,-58.1278], Tmin=(961.627,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(390.68,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(403.252,'J/(mol*K)'), comment="""QM MopacMolPM3 calculation attempt 1 + radical(cyclobutene-allyl)"""),
)

species(
    label = '[C]1=CCC1C1CC1(283)',
    ...
    molecularWeight = (93.1464,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.9671,0.0237723,7.73948e-05,-1.13791e-07,4.40151e-11,57657,21.3074], Tmin=(100,'K'), Tmax=(970.753,'K')), NASAPolynomial(coeffs=[13.8016,0.0275919,-9.75939e-06,1.86227e-09,-1.3964e-13,52881.7,-48.1976], Tmin=(970.753,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(478.622,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(403.252,'J/(mol*K)'), comment="""QM MopacMolPM3 calculation attempt 1 + radical(cyclobutene-vinyl)"""),
)

species(
    label = '[C]1=CC(C1)C1CC1(284)',
...
species(
    ...
    molecularWeight = (80.1277,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.26746,0.019587,6.97215e-05,-1.02588e-07,4.0041e-11,26421.7,17.9987], Tmin=(100,'K'), Tmax=(961.582,'K')), NASAPolynomial(coeffs=[12.7617,0.022543,-7.59804e-06,1.42675e-09,-1.07242e-13,22248.6,-43.4236], Tmin=(961.582,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(219.025,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(328.422,'J/(mol*K)'), comment="""QM MopacMolPM3 calculation attempt 1"""),
)

species(
    label = '[CH]1C[C](C1)C1CC1(286)',
    ...
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.2624,0.0235709,6.26592e-05,-8.30596e-08,2.90802e-11,51206.8,23.4973], Tmin=(100,'K'), Tmax=(1035.64,'K')), NASAPolynomial(coeffs=[7.59321,0.0406861,-1.67408e-05,3.20663e-09,-2.30346e-13,48080.7,-12.1695], Tmin=(1035.64,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(425.133,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""QM MopacMolPM3 calculation attempt 1 + radical(cyclobutane) + radical(Tertalkyl)"""),
)

species(
    label = '[CH]1C[CH]C1C1CC1(287)',
...
species(
    ...
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.26237,0.0235713,6.26581e-05,-8.30581e-08,2.90796e-11,51206.8,23.4974], Tmin=(100,'K'), Tmax=(1035.64,'K')), NASAPolynomial(coeffs=[7.59335,0.0406858,-1.67407e-05,3.2066e-09,-2.30344e-13,48080.6,-12.1703], Tmin=(1035.64,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(425.133,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""QM MopacMolPM3 calculation attempt 1 + radical(Tertalkyl) + radical(cyclobutane)"""),
)

species(
    label = '[CH]1CC[C]1C1CC1(289)',
    ...
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.2624,0.0235709,6.26592e-05,-8.30596e-08,2.90802e-11,51206.8,24.1905], Tmin=(100,'K'), Tmax=(1035.64,'K')), NASAPolynomial(coeffs=[7.59321,0.0406861,-1.67408e-05,3.20663e-09,-2.30346e-13,48080.7,-11.4764], Tmin=(1035.64,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(425.133,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""QM MopacMolPM3 calculation attempt 1 + radical(cyclobutane) + radical(Tertalkyl)"""),
)

species(
    label = '[CH]1CCC1[C]1CC1(290)',
...
species(
    ...
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.34595,0.0167219,9.11003e-05,-1.1808e-07,4.26678e-11,56078.4,24.4074], Tmin=(100,'K'), Tmax=(998.765,'K')), NASAPolynomial(coeffs=[9.89271,0.0367693,-1.45089e-05,2.80977e-09,-2.06586e-13,52063.5,-24.5444], Tmin=(998.765,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(465.623,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""QM MopacMolPM3 calculation attempt 1 + radical(cyclobutane) + radical(cyclopropane)"""),
)

species(
    label = '[CH]1CC1C1[CH]CC1(292)',
...
species(
    label = '[CH2]C([CH2])C1C=CC1(293)',
    structure = SMILES('[CH2]C([CH2])C1C=CC1'),
    E0 = (474.642,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,2950,3050,3150,900,950,1000,1050,1100,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,1380,1390,370,380,2900,435,600,892.961,892.961,892.961,892.961,892.961,892.961,892.961,892.961,892.961,892.961,892.961,892.961,2336.92],'cm^-1')),
        HinderedRotor(inertia=(0.00243889,'amu*angstrom^2'), symmetry=1, barrier=(0.2243,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00243889,'amu*angstrom^2'), symmetry=1, barrier=(0.2243,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00243889,'amu*angstrom^2'), symmetry=1, barrier=(0.2243,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.48807,0.039209,3.99936e-05,-7.78923e-08,3.26348e-11,57191.3,25.5695], Tmin=(100,'K'), Tmax=(948.067,'K')), NASAPolynomial(coeffs=[13.0692,0.0304724,-9.66923e-06,1.67196e-09,-1.17743e-13,53192.1,-39.1958], Tmin=(948.067,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(474.642,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(444.824,'J/(mol*K)'), comment="""QM MopacMolPM3 calculation attempt 1 + radical(Isobutyl) + radical(Isobutyl)"""),
)

species(
    label = '[CH]=CC([CH2])C1CC1(294)',
    structure = SMILES('[CH]=CC([CH2])C1CC1'),
    E0 = (529.38,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,2950,3050,3150,900,950,1000,1050,1100,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,3120,650,792.5,1650,1380,1390,370,380,2900,435,600,831.441,831.441,831.441,831.441,831.441,831.441,831.441,831.441,831.441,2391.04],'cm^-1')),
        HinderedRotor(inertia=(0.00666258,'amu*angstrom^2'), symmetry=1, barrier=(0.2243,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00666258,'amu*angstrom^2'), symmetry=1, barrier=(0.2243,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00666258,'amu*angstrom^2'), symmetry=1, barrier=(0.2243,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    ...
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.28031,0.0443511,2.67005e-05,-6.37309e-08,2.70652e-11,63781.5,25.9712], Tmin=(100,'K'), Tmax=(970.731,'K')), NASAPolynomial(coeffs=[13.6767,0.0309247,-1.07368e-05,1.93881e-09,-1.38182e-13,59600.6,-42.6038], Tmin=(970.731,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(529.38,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(444.824,'J/(mol*K)'), comment="""QM MopacMolPM3 calculation attempt 1 + radical(Cds_P) + radical(Isobutyl)"""),
)

species(
    label = '[C]1CCC1C1CC1(295)',
    ...
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.92354,0.0213617,9.68088e-05,-1.37691e-07,5.30816e-11,55569.9,21.5065], Tmin=(100,'K'), Tmax=(964.909,'K')), NASAPolynomial(coeffs=[14.94,0.0287082,-9.91462e-06,1.89134e-09,-1.43171e-13,50204,-55.6139], Tmin=(964.909,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(461.231,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(403.252,'J/(mol*K)'), comment="""QM MopacMolPM3 calculation attempt 1"""),
)

species(
    label = '[C]1CC(C1)C1CC1(296)',
    ...
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.89633,0.0219124,9.59085e-05,-1.3726e-07,5.30605e-11,54406.8,20.4972], Tmin=(100,'K'), Tmax=(964.157,'K')), NASAPolynomial(coeffs=[15.1292,0.0284214,-9.75412e-06,1.85865e-09,-1.40837e-13,49000.8,-57.6623], Tmin=(964.157,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(451.551,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(403.252,'J/(mol*K)'), comment="""QM MopacMolPM3 calculation attempt 1"""),
)
...
reaction(
    label = 'reaction121',
    reactants = ['[CH2]C=C[CH]C1CC1(122)'],
    products = ['C[C]=C[CH]C1CC1(192)'],
...
reaction(
    label = 'reaction127',
    reactants = ['[CH2]C=C[CH]C1CC1(122)'],
    products = ['[CH2]C1[CH]C1C1CC1(195)'],
...
reaction(
    label = 'reaction129',
    reactants = ['CH2(S)(28)', '[CH2]C=CC=C[CH2](145)'],
    products = ['[CH2]C=C[CH]C1CC1(122)'],
...
reaction(
    label = 'reaction135',
    reactants = ['[CH]=C[CH2](138)', '[CH]C1CC1(199)'],
    products = ['[CH2]C=C[CH]C1CC1(122)'],
...
reaction(
    label = 'reaction136',
    reactants = ['CH2(T)(22)', '[CH]=C[CH]C1CC1(200)'],
    products = ['[CH2]C=C[CH]C1CC1(122)'],
...
reaction(
    label = 'reaction142',
    reactants = ['[CH2]C=C[CH]C1CC1(122)'],
    products = ['[CH]1[CH]C(C1)C1CC1(201)'],
...
reaction(
    label = 'reaction216',
    reactants = ['cC3H5(164)', '[CH]1C=CC1(278)'],
    products = ['C1=CC(C1)C1CC1(190)'],
...
reaction(
    label = 'reaction217',
    reactants = ['H(10)', 'C1=CC(C1)[C]1CC1(279)'],
    products = ['C1=CC(C1)C1CC1(190)'],
...
reaction(
    label = 'reaction218',
    reactants = ['H(10)', 'C1=C[C](C1)C1CC1(280)'],
    products = ['C1=CC(C1)C1CC1(190)'],
...
reaction(
    label = 'reaction219',
    reactants = ['H(10)', '[CH]1CC1C1C=CC1(281)'],
    products = ['C1=CC(C1)C1CC1(190)'],
...
reaction(
    label = 'reaction220',
    reactants = ['H(10)', '[CH]1C=CC1C1CC1(282)'],
    products = ['C1=CC(C1)C1CC1(190)'],
...
reaction(
    label = 'reaction221',
    reactants = ['H(10)', '[C]1=CCC1C1CC1(283)'],
    products = ['C1=CC(C1)C1CC1(190)'],
...
reaction(
    label = 'reaction222',
    reactants = ['H(10)', '[C]1=CC(C1)C1CC1(284)'],
    products = ['C1=CC(C1)C1CC1(190)'],
...
reaction(
    label = 'reaction223',
    reactants = ['CH2(S)(28)', 'C=CC1C=CC1(285)'],
    products = ['C1=CC(C1)C1CC1(190)'],
...
reaction(
    label = 'reaction224',
    reactants = ['[CH]1C[C](C1)C1CC1(286)'],
    products = ['C1=CC(C1)C1CC1(190)'],
...
reaction(
    label = 'reaction225',
    reactants = ['[CH]1C[CH]C1C1CC1(287)'],
    products = ['C1=CC(C1)C1CC1(190)'],
...
reaction(
    label = 'reaction226',
    reactants = ['[CH]1CC(C1)[C]1CC1(288)'],
    products = ['C1=CC(C1)C1CC1(190)'],
...
reaction(
    label = 'reaction227',
    reactants = ['[CH]1[CH]C(C1)C1CC1(201)'],
    products = ['C1=CC(C1)C1CC1(190)'],
...
reaction(
    label = 'reaction230',
    reactants = ['[CH]1CC(C1)C1[CH]C1(291)'],
    products = ['C1=CC(C1)C1CC1(190)'],
...
reaction(
    label = 'reaction231',
    reactants = ['[CH]1CC1C1[CH]CC1(292)'],
    products = ['C1=CC(C1)C1CC1(190)'],
...
reaction(
    label = 'reaction232',
    reactants = ['[CH2]C([CH2])C1C=CC1(293)'],
    products = ['C1=CC(C1)C1CC1(190)'],
...
reaction(
    label = 'reaction233',
    reactants = ['[CH2]C[CH]C1C=CC1(123)'],
    products = ['C1=CC(C1)C1CC1(190)'],
...
reaction(
    label = 'reaction237',
    reactants = ['[C]1CC(C1)C1CC1(296)'],
    products = ['C1=CC(C1)C1CC1(190)'],
    transitionState = 'TS237',
    kinetics = Arrhenius(A=(3.67318e+12,'s^-1'), n=0.345437, Ea=(91.3338,'kJ/mol'), T0=(1,'K'), Tmin=(303.03,'K'), Tmax=(2000,'K'), comment="""Estimated using template [CsJ2-C;CsJ2(CsC);CH] for rate rule [CsJ2-C;CsJ2(CsC);CH2(C)]
Euclidian distance = 1.0
Multiplied by reaction path degeneracy 4.0
family: Singlet_Carbene_Intra_Disproportionation"""),
)
