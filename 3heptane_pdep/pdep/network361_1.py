species(
    label = '[CH2]OC[C]=O(580)',
    structure = SMILES('[CH2]OC[C]=O'),
    E0 = (40.0284,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,1855,455,950,239.367,239.439],'cm^-1')),
        HinderedRotor(inertia=(0.00294472,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00294491,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2]OC=C=O(2984)',
    structure = SMILES('[CH2]OC=C=O'),
    E0 = (16.7315,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2120,512.5,787.5,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,330.641,331.149],'cm^-1')),
        HinderedRotor(inertia=(0.258631,'amu*angstrom^2'), symmetry=1, barrier=(19.9669,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.255544,'amu*angstrom^2'), symmetry=1, barrier=(19.9628,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (71.0547,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.13781,0.0311059,-4.53448e-06,-2.72113e-08,1.58826e-11,2088.57,16.687], Tmin=(100,'K'), Tmax=(914.8,'K')), NASAPolynomial(coeffs=[14.8714,0.00149128,1.28816e-06,-3.09998e-10,1.95724e-14,-1331.75,-49.572], Tmin=(914.8,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(16.7315,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-OsHHH) + group(Cds-(Cdd-O2d)OsH) + radical(C=COCJ)"""),
)
...
species(
    ...
    molecularWeight = (72.0627,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.87389,0.0270988,3.672e-05,-8.65747e-08,4.09043e-11,-2705.17,18.2411], Tmin=(100,'K'), Tmax=(908.354,'K')), NASAPolynomial(coeffs=[21.3379,-0.00659095,6.44866e-06,-1.30995e-09,8.529e-14,-8387.35,-85.6038], Tmin=(908.354,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-23.2817,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-OsHHH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + radical(C=COJ) + radical(C=COCJ)"""),
)

species(
    label = 'CO[CH][C]=O(2986)',
    ...
    molecularWeight = (72.0627,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.97536,0.0308683,1.17613e-05,-5.071e-08,2.56657e-11,3026.91,18.5197], Tmin=(100,'K'), Tmax=(912.301,'K')), NASAPolynomial(coeffs=[17.155,0.000412943,2.48062e-06,-5.54145e-10,3.5418e-14,-1245.05,-61.5534], Tmin=(912.301,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(24.4549,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-OsHHH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + radical(C=COJ) + radical(C=CJO)"""),
)
...
species(
    ...
    molecularWeight = (72.0627,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.02132,0.0332076,-2.88792e-06,-2.98548e-08,1.67984e-11,-21000,14.6195], Tmin=(100,'K'), Tmax=(918.918,'K')), NASAPolynomial(coeffs=[14.8646,0.00430798,2.02575e-07,-1.14335e-10,6.12565e-15,-24500.6,-52.46], Tmin=(918.918,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-175.276,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-OsHHH) + group(Cds-(Cdd-O2d)OsH)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', '[CH2]OC=C=O(2984)'],
    products = ['[CH2]OC[C]=O(580)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction9',
    reactants = ['CO(12)', '[CH2]O[CH2](1248)'],
    products = ['[CH2]OC[C]=O(580)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(2461.18,'m^3/(mol*s)'), n=1.0523, Ea=(25.6182,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [COm;C_pri_rad] for rate rule [COm;C_rad/H2/O]
Euclidian distance = 1.0
Multiplied by reaction path degeneracy 2.0
...
reaction(
    label = 'reaction11',
    reactants = ['[C]=O(261)', '[CH2]O[CH2](1248)'],
    products = ['[CH2]OC[C]=O(580)'],
