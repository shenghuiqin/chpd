species(
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.0887,0.0986718,-6.94276e-05,2.03002e-08,-8.01824e-13,19319.9,41.5565], Tmin=(100,'K'), Tmax=(1109.63,'K')), NASAPolynomial(coeffs=[19.9889,0.0408586,-1.58345e-05,2.85648e-09,-1.96092e-13,13523.8,-67.363], Tmin=(1109.63,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(159.018,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(527.969,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C=CJO) + radical(CCJCO)"""),
)
...
species(
    label = 'C=[C]OCC=CCCC(2747)',
    structure = SMILES('C=[C]OCC=CCCC'),
    E0 = (81.3448,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2950,3100,1380,975,1025,1650,2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.717983,0.0907399,-5.71372e-05,1.08333e-08,1.97244e-12,9964.43,38.8159], Tmin=(100,'K'), Tmax=(1088.47,'K')), NASAPolynomial(coeffs=[18.7197,0.0399634,-1.56269e-05,2.84272e-09,-1.96479e-13,4509.44,-62.2277], Tmin=(1088.47,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(81.3448,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C=CJO)"""),
)

species(
    label = 'C=[C]OC=CCCCC(2748)',
    ...
    molecularWeight = (125.188,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.78392,0.0931409,-6.92762e-05,2.67429e-08,-4.18823e-12,12609.5,40.5628], Tmin=(100,'K'), Tmax=(1502.49,'K')), NASAPolynomial(coeffs=[19.6728,0.0386802,-1.4906e-05,2.61849e-09,-1.74164e-13,6462.23,-66.4575], Tmin=(1502.49,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(103.326,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C=CJO)"""),
)

species(
    label = 'C#COC[CH]CCCC(2749)',
    ...
    molecularWeight = (125.188,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.26657,0.102215,-7.76718e-05,2.4276e-08,-1.08186e-12,15668.3,36.5206], Tmin=(100,'K'), Tmax=(1073.32,'K')), NASAPolynomial(coeffs=[22.018,0.0360125,-1.39023e-05,2.52489e-09,-1.75014e-13,9484.96,-82.9817], Tmin=(1073.32,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(128.601,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Ct-CtOs) + group(Ct-CtH) + radical(CCJCO)"""),
)
...
species(
    ...
    molecularWeight = (126.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.415231,0.0971882,-7.71691e-05,3.39526e-08,-6.34103e-12,18629.4,39.202], Tmin=(100,'K'), Tmax=(1233.62,'K')), NASAPolynomial(coeffs=[13.6269,0.051657,-2.18062e-05,4.03379e-09,-2.77818e-13,15164.9,-31.4912], Tmin=(1233.62,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(153.575,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(527.969,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C=CJO) + radical(RCCJCC)"""),
)
...
species(
    label = '[CH]=COC[CH]CCCC(2752)',
    structure = SMILES('[CH]=COC[CH]CCCC'),
    E0 = (166.37,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,3010,987.5,1337.5,450,1655,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    ...
    molecularWeight = (126.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.54947,0.105043,-6.55487e-05,6.4873e-11,1.02772e-11,13830,39.5494], Tmin=(100,'K'), Tmax=(979.906,'K')), NASAPolynomial(coeffs=[25.4443,0.0322036,-1.12243e-05,2.00391e-09,-1.41363e-13,6746.48,-99.2821], Tmin=(979.906,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(113.201,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(527.969,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CCsJOC(O)) + radical(CCJCO)"""),
)

species(
    label = 'C=[C]OCCC[CH]CC(2754)',
...
species(
    ...
    molecularWeight = (126.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.608608,0.0985673,-7.8523e-05,3.41463e-08,-6.20869e-12,18637.3,40.0666], Tmin=(100,'K'), Tmax=(1279.3,'K')), NASAPolynomial(coeffs=[15.3531,0.0486601,-2.00064e-05,3.65246e-09,-2.49642e-13,14553.3,-40.871], Tmin=(1279.3,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(153.562,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(527.969,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(RCCJC) + radical(C=CJO)"""),
)

species(
    label = '[CH]=[C]OCCCCCC(2756)',
    structure = SMILES('[CH]=[C]OCCCCCC'),
    E0 = (206.212,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,2750,2761.11,2772.22,2783.33,2794.44,2805.56,2816.67,2827.78,2838.89,2850,1425,1431.25,1437.5,1443.75,1450,1225,1237.5,1250,1262.5,1275,1270,1287.5,1305,1322.5,1340,700,725,750,775,800,300,325,350,375,400,2750,2800,2850,1350,1500,750,1050,1375,1000,1685,370,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    ...
    molecularWeight = (126.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.14488,0.103393,-8.39894e-05,3.5739e-08,-6.16552e-12,19961.5,41.0496], Tmin=(100,'K'), Tmax=(1374.78,'K')), NASAPolynomial(coeffs=[20.176,0.0413596,-1.63059e-05,2.91783e-09,-1.9714e-13,14099.1,-68.5979], Tmin=(1374.78,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(164.363,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(527.969,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C=CJO) + radical(RCCJ)"""),
)

species(
    label = 'C=COC[CH][CH]CCC(2758)',
    ...
    molecularWeight = (126.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.997314,0.0968579,-6.4767e-05,1.56301e-08,8.89915e-13,13869.9,40.6618], Tmin=(100,'K'), Tmax=(1077.91,'K')), NASAPolynomial(coeffs=[19.3982,0.041454,-1.58916e-05,2.85731e-09,-1.9621e-13,8294.71,-64.7304], Tmin=(1077.91,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(113.732,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(527.969,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(RCCJCC) + radical(CCJCO)"""),
)

species(
    label = 'C=COC[CH]C[CH]CC(2759)',
...
species(
    ...
    molecularWeight = (126.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.991223,0.0959238,-5.82598e-05,6.03128e-09,5.00001e-12,13869.1,40.8088], Tmin=(100,'K'), Tmax=(1028.19,'K')), NASAPolynomial(coeffs=[20.0052,0.0403008,-1.51307e-05,2.71726e-09,-1.8779e-13,8173.95,-67.7692], Tmin=(1028.19,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(113.72,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(527.969,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CCJCO) + radical(RCCJC)"""),
)

species(
    label = '[CH2]CCC[CH]COC=C(2761)',
...
species(
    ...
    molecularWeight = (126.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.812756,0.0895137,-3.71823e-05,-1.67677e-08,1.31309e-11,-16219.7,37.5213], Tmin=(100,'K'), Tmax=(1007.46,'K')), NASAPolynomial(coeffs=[20.4263,0.0398914,-1.49714e-05,2.72714e-09,-1.91539e-13,-22260.4,-73.8435], Tmin=(1007.46,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-136.418,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(532.126,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + group(Cds-CdsHH)"""),
)

species(
    label = 'C=COCC=CCCC(2763)',
    ...
    molecularWeight = (126.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.844755,0.0880835,-2.75509e-05,-3.07143e-08,1.90013e-11,-18860.2,36.1377], Tmin=(100,'K'), Tmax=(988.226,'K')), NASAPolynomial(coeffs=[21.9922,0.0372641,-1.35828e-05,2.47726e-09,-1.75993e-13,-25406,-84.0488], Tmin=(988.226,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-158.399,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(532.126,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-CdsHH)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'C=[C]OCC=CCCC(2747)'],
    products = ['C=[C]OC[CH]CCCC(690)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'C=[C]OC=CCCCC(2748)'],
    products = ['C=[C]OC[CH]CCCC(690)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', 'C#COC[CH]CCCC(2749)'],
    products = ['C=[C]OC[CH]CCCC(690)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['npropyl(70)', 'C=[C]OCC=C(2032)'],
    products = ['C=[C]OC[CH]CCCC(690)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction16',
    reactants = ['C=[C]OC[CH]CCCC(690)'],
    products = ['C=COC[CH]C[CH]CC(2759)'],
...
reaction(
    label = 'reaction17',
    reactants = ['C=[C]OC[CH]CCCC(690)'],
    products = ['C=COC[CH]CC[CH]C(2760)'],
...
reaction(
    label = 'reaction18',
    reactants = ['C=[C]OC[CH]CCCC(690)'],
    products = ['[CH2]CCC[CH]COC=C(2761)'],
...
reaction(
    label = 'reaction22',
    reactants = ['CH2(S)(24)', 'C=[C]OC[CH]CCC(682)'],
    products = ['C=[C]OC[CH]CCCC(690)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH2]C(CCC)CO[C]=C(2764)'],
    products = ['C=[C]OC[CH]CCCC(690)'],
...
reaction(
    label = 'reaction25',
    reactants = ['CCCC[CH]C[O](330)', 'H2CC(T)(265)'],
    products = ['C=[C]OC[CH]CCCC(690)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[CH]CCCC(98)', '[CH2]O[C]=C(1770)'],
    products = ['C=[C]OC[CH]CCCC(690)'],
