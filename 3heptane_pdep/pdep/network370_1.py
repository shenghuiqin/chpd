species(
    label = '[CH2]OO[CH]C(587)',
    structure = SMILES('[CH2]OO[CH]C'),
    E0 = (194.896,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,350,500,795,815,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5],'cm^-1')),
        HinderedRotor(inertia=(2.07116,'amu*angstrom^2'), symmetry=1, barrier=(47.6201,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.21419,'amu*angstrom^2'), symmetry=1, barrier=(4.92466,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.07223,'amu*angstrom^2'), symmetry=1, barrier=(47.6446,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0273218,'amu*angstrom^2'), symmetry=1, barrier=(47.6139,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (74.0785,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.18703,0.0439491,-3.50882e-05,1.63184e-08,-3.46742e-12,23502.4,17.3448], Tmin=(100,'K'), Tmax=(1039.22,'K')), NASAPolynomial(coeffs=[6.00786,0.0292426,-1.38611e-05,2.70108e-09,-1.91562e-13,22708.3,-1.23541], Tmin=(1039.22,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(194.896,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(CCsJOOC) + radical(CsJOOC)"""),
)
...
species(
    ...
    molecularWeight = (74.0785,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.02817,0.0459269,-3.83509e-05,1.76204e-08,-3.48925e-12,26819.5,19.6084], Tmin=(100,'K'), Tmax=(1151.58,'K')), NASAPolynomial(coeffs=[7.88015,0.0256002,-1.18743e-05,2.2928e-09,-1.61743e-13,25471.6,-9.44995], Tmin=(1151.58,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(222.418,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(CJCOOH) + radical(CsJOOC)"""),
)

species(
    label = '[CH2][CH]OOC(2820)',
    structure = SMILES('[CH2][CH]OOC'),
    E0 = (215.261,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,350,500,795,815,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5],'cm^-1')),
        HinderedRotor(inertia=(5.20297,'amu*angstrom^2'), symmetry=1, barrier=(119.627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0067159,'amu*angstrom^2'), symmetry=1, barrier=(42.2212,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.223339,'amu*angstrom^2'), symmetry=1, barrier=(5.13499,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.83606,'amu*angstrom^2'), symmetry=1, barrier=(42.2146,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (74.0785,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.32345,0.0431346,-2.54379e-05,-1.97339e-08,2.97295e-11,25944.1,19.2311], Tmin=(100,'K'), Tmax=(498.384,'K')), NASAPolynomial(coeffs=[5.06756,0.0303218,-1.45984e-05,2.85101e-09,-2.01973e-13,25556.2,6.75558], Tmin=(498.384,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(215.261,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(CJCOOH) + radical(CCsJOOC)"""),
)
...
species(
    ...
    molecularWeight = (74.0785,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.9747,0.0381673,-1.84064e-05,-9.20146e-10,2.3202e-12,-5000.17,18.7912], Tmin=(100,'K'), Tmax=(1127.51,'K')), NASAPolynomial(coeffs=[10.2353,0.0196668,-8.16859e-06,1.52573e-09,-1.06622e-13,-7549.76,-25.0983], Tmin=(1127.51,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-42.2243,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-OsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', '[CH2]OOC=C(2818)'],
    products = ['[CH2]OO[CH]C(587)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]O[O](203)', 'CHCH3(T)(80)'],
    products = ['[CH2]OO[CH]C(587)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['C[CH]O[O](159)', 'CH2(T)(17)'],
    products = ['[CH2]OO[CH]C(587)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(54738.4,'m^3/(mol*s)'), n=0.884925, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(303.03,'K'), Tmax=(2000,'K'), comment="""Estimated using an average for rate rule [O_rad/NonDe;Birad]
Euclidian distance = 0
