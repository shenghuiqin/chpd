...
species(
    label = '[CH2]C(C)C(=C)CC(1070)',
    structure = SMILES('[CH2]C(C)C(=C)CC'),
    E0 = (99.2919,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,2950,3100,1380,975,1025,1650,1380,1390,370,380,2900,435,350,440,435,1725,180,3814.35],'cm^-1')),
        HinderedRotor(inertia=(0.0392522,'amu*angstrom^2'), symmetry=1, barrier=(15.4908,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.673729,'amu*angstrom^2'), symmetry=1, barrier=(15.4904,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00862304,'amu*angstrom^2'), symmetry=1, barrier=(5.85413,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.673788,'amu*angstrom^2'), symmetry=1, barrier=(15.4917,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(3.73533,'amu*angstrom^2'), symmetry=1, barrier=(85.8826,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (97.1781,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.45007,0.0669043,-2.06825e-05,-1.64991e-08,1.02868e-11,12079.6,30.2697], Tmin=(100,'K'), Tmax=(1009.24,'K')), NASAPolynomial(coeffs=[13.4127,0.0391282,-1.44751e-05,2.57008e-09,-1.76212e-13,8261.27,-38.3408], Tmin=(1009.24,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(99.2919,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + longDistanceInteraction_noncyclic(CdCs-ST) + group(Cds-CdsHH) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]C(CC)C(=C)C(1071)',
    structure = SMILES('[CH2]C(CC)C(=C)C'),
    E0 = (98.1571,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,2950,3100,1380,975,1025,1650,1380,1390,370,380,2900,435,350,440,435,1725,180,3621.18],'cm^-1')),
        HinderedRotor(inertia=(0.0132419,'amu*angstrom^2'), symmetry=1, barrier=(14.9963,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.141186,'amu*angstrom^2'), symmetry=1, barrier=(3.24614,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.653082,'amu*angstrom^2'), symmetry=1, barrier=(15.0156,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.657537,'amu*angstrom^2'), symmetry=1, barrier=(15.1181,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(3.71268,'amu*angstrom^2'), symmetry=1, barrier=(85.3617,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (97.1781,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.329812,0.0712355,-3.69317e-05,3.19132e-09,2.63745e-12,11945.7,30.0358], Tmin=(100,'K'), Tmax=(1088.69,'K')), NASAPolynomial(coeffs=[12.847,0.0403824,-1.52777e-05,2.70224e-09,-1.82846e-13,8323.19,-35.5358], Tmin=(1088.69,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(98.1571,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + longDistanceInteraction_noncyclic(CdCs-ST) + group(Cds-CdsHH) + radical(Isobutyl)"""),
)
...
species(
    ...
    molecularWeight = (98.1861,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.293218,0.0717237,-3.67474e-05,6.09014e-09,6.99437e-13,21302,32.7394], Tmin=(100,'K'), Tmax=(1240.5,'K')), NASAPolynomial(coeffs=[12.6115,0.0436502,-1.68845e-05,2.98406e-09,-1.99908e-13,17349.7,-32.9558], Tmin=(1240.5,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(175.938,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(482.239,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Cs_S) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]C([CH2])C(C)CC(1078)',
    ...
    molecularWeight = (98.1861,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.259106,0.0732013,-3.3895e-05,-3.19676e-09,5.83493e-12,22570.8,32.0741], Tmin=(100,'K'), Tmax=(1000.26,'K')), NASAPolynomial(coeffs=[12.4663,0.042606,-1.53383e-05,2.64693e-09,-1.77347e-13,19217.2,-31.3783], Tmin=(1000.26,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(186.478,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(482.239,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Isobutyl) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]CC(C)C([CH2])C(1079)',
    structure = SMILES('[CH2]CC(C)C([CH2])C'),
    E0 = (186.643,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,2750,2850,1437.5,1250,1305,750,350,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,201.474,843.53],'cm^-1')),
...
species(
    ...
    molecularWeight = (98.1861,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.229666,0.072777,-3.34508e-05,-1.73566e-09,4.45509e-12,22592.2,32.1874], Tmin=(100,'K'), Tmax=(1071.64,'K')), NASAPolynomial(coeffs=[12.9459,0.042902,-1.62548e-05,2.88347e-09,-1.95724e-13,18856.8,-34.7534], Tmin=(1071.64,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(186.643,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(482.239,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJ) + radical(Isobutyl)"""),
)

species(
    label = 'C=C(CC)C(C)C(1081)',
    ...
    molecularWeight = (98.1861,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.420195,0.0653266,-8.39592e-06,-2.896e-08,1.39889e-11,-12583.2,27.9042], Tmin=(100,'K'), Tmax=(1034.91,'K')), NASAPolynomial(coeffs=[13.8544,0.0421212,-1.63873e-05,3.00205e-09,-2.09527e-13,-16901.8,-44.7995], Tmin=(1034.91,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-105.79,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(486.397,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + longDistanceInteraction_noncyclic(CdCs-ST) + group(Cds-CdsHH)"""),
)

species(
    label = 'C=C(C)C(C)CC(1082)',
    ...
    molecularWeight = (98.1861,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.321298,0.0693921,-2.36532e-05,-1.06434e-08,6.96211e-12,-12718,28.2878], Tmin=(100,'K'), Tmax=(1096.43,'K')), NASAPolynomial(coeffs=[13.2788,0.0434008,-1.72078e-05,3.13902e-09,-2.16594e-13,-16838.5,-41.2506], Tmin=(1096.43,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-106.925,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(486.397,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + longDistanceInteraction_noncyclic(CdCs-ST) + group(Cds-CdsHH)"""),
)
...
species(
    ...
    E0 = (202.066,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2850,1437.5,1250,1305,750,350,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,180,1249.07],'cm^-1')),
        HinderedRotor(inertia=(0.0906917,'amu*angstrom^2'), symmetry=1, barrier=(2.08518,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0905663,'amu*angstrom^2'), symmetry=1, barrier=(2.0823,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0908481,'amu*angstrom^2'), symmetry=1, barrier=(2.08878,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.090521,'amu*angstrom^2'), symmetry=1, barrier=(2.08126,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0904868,'amu*angstrom^2'), symmetry=1, barrier=(2.08047,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.1595,'amu'),
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', '[CH2]C(C)C(=C)CC(1070)'],
    products = ['[CH2]C(C)C([CH2])CC(799)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', '[CH2]C(CC)C(=C)C(1071)'],
    products = ['[CH2]C(C)C([CH2])CC(799)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(0.0051739,'m^3/(mol*s)'), n=2.82163, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(303.03,'K'), Tmax=(2000,'K'), comment="""From training reaction 102 used for Cds-CsCs_Cds-HH;HJ
Exact match found for rate rule [Cds-CsCs_Cds-HH;HJ]
...
reaction(
    label = 'reaction5',
    reactants = ['C2H5(32)', '[CH2]C(C)C=C(838)'],
    products = ['[CH2]C(C)C([CH2])CC(799)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['CH3(18)', '[CH2]C(C=C)CC(913)'],
    products = ['[CH2]C(C)C([CH2])CC(799)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]C(C)C([CH2])CC(799)'],
    products = ['[CH2]C(C)C(C)[CH]C(1075)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2]C(C)C([CH2])CC(799)'],
    products = ['[CH2]C([CH]C)C(C)C(1077)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]C([CH2])C(C)CC(1078)'],
    products = ['[CH2]C(C)C([CH2])CC(799)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]CC(C)C([CH2])C(1079)'],
    products = ['[CH2]C(C)C([CH2])CC(799)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]CC([CH2])C(C)C(1080)'],
    products = ['[CH2]C(C)C([CH2])CC(799)'],
...
reaction(
    label = 'reaction20',
    reactants = ['CH2(S)(24)', '[CH2]CC([CH2])CC(712)'],
    products = ['[CH2]C(C)C([CH2])CC(799)'],
...
reaction(
    label = 'reaction21',
    reactants = ['CH2(S)(24)', '[CH2]C(C)C([CH2])C(815)'],
    products = ['[CH2]C(C)C([CH2])CC(799)'],
...
reaction(
    label = 'reaction27',
    reactants = ['CH2(T)(17)', '[CH2]C(C)[CH]CC(968)'],
    products = ['[CH2]C(C)C([CH2])CC(799)'],
...
reaction(
    label = 'reaction28',
    reactants = ['[CH2]C([CH]C)CC(915)', 'CH2(T)(17)'],
    products = ['[CH2]C(C)C([CH2])CC(799)'],
