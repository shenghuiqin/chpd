...
species(
    label = 'C=C(CC)C[O](1373)',
    structure = SMILES('C=C(CC)C[O]'),
    E0 = (16.9926,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2950,3100,1380,975,1025,1650,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,270.559,270.669,1963.07],'cm^-1')),
        HinderedRotor(inertia=(0.00230208,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.116847,'amu*angstrom^2'), symmetry=1, barrier=(6.06907,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.116807,'amu*angstrom^2'), symmetry=1, barrier=(6.06902,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (85.1244,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.11914,0.0463176,-2.26501e-05,4.87551e-09,-4.00073e-13,2106.18,22.1878], Tmin=(100,'K'), Tmax=(2856.46,'K')), NASAPolynomial(coeffs=[25.2758,0.0138988,-5.63059e-06,9.04355e-10,-5.26034e-14,-11126.5,-113.841], Tmin=(2856.46,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(16.9926,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(CCOJ)"""),
)
...
species(
    ...
    molecularWeight = (86.1323,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.70059,0.0492685,-2.1959e-05,3.48375e-09,-3.74294e-14,5456.76,23.6105], Tmin=(100,'K'), Tmax=(1882.67,'K')), NASAPolynomial(coeffs=[14.6871,0.0292106,-1.19805e-05,2.07583e-09,-1.32723e-13,-768.235,-50.8041], Tmin=(1882.67,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(44.673,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJ(C)CO) + radical(CCOJ)"""),
)

species(
    label = '[CH2]C([CH]O)CC(1376)',
...
species(
    ...
    molecularWeight = (86.1323,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.32282,0.0471079,-2.08529e-05,3.47511e-09,-1.48165e-13,10470.9,23.6844], Tmin=(100,'K'), Tmax=(2347.06,'K')), NASAPolynomial(coeffs=[23.3558,0.0194041,-8.35097e-06,1.40206e-09,-8.47865e-14,-1644.8,-100.51], Tmin=(2347.06,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(86.6412,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(Cs_S)"""),
)

species(
    label = 'CCC(C)[CH][O](1378)',
    ...
    molecularWeight = (86.1323,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.85057,0.0548232,-1.85922e-05,-4.15091e-08,4.39195e-11,8777.27,22.5139], Tmin=(100,'K'), Tmax=(500.92,'K')), NASAPolynomial(coeffs=[4.49236,0.0445562,-2.02735e-05,3.88363e-09,-2.73007e-13,8376.75,10.239], Tmin=(500.92,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(72.397,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(CCsJOH)"""),
)

species(
    label = '[CH2][C](CC)CO(1379)',
...
species(
    ...
    molecularWeight = (86.1323,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.40417,0.058027,-4.29313e-05,1.88755e-08,-3.67852e-12,8032.79,27.9283], Tmin=(100,'K'), Tmax=(1157.5,'K')), NASAPolynomial(coeffs=[7.67834,0.0363454,-1.48344e-05,2.6931e-09,-1.8343e-13,6580.31,-3.25865], Tmin=(1157.5,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(66.0184,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Isobutyl) + radical(Cs_S)"""),
)

species(
    label = '[CH2]CC(C)C[O](1381)',
    structure = SMILES('[CH2]CC(C)C[O]'),
    E0 = (97.3454,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,180,1274.03,1274.06],'cm^-1')),
        HinderedRotor(inertia=(0.160975,'amu*angstrom^2'), symmetry=1, barrier=(3.70114,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.160945,'amu*angstrom^2'), symmetry=1, barrier=(3.70044,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (86.1323,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.09243,0.0503178,-2.54861e-05,5.85015e-09,-5.29528e-13,11767,23.7105], Tmin=(100,'K'), Tmax=(2327.23,'K')), NASAPolynomial(coeffs=[13.2318,0.0311719,-1.3146e-05,2.31523e-09,-1.498e-13,6582.08,-39.4401], Tmin=(2327.23,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(97.3454,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJ) + radical(CCOJ)"""),
)

species(
    label = '[CH2]CC([CH2])CO(1382)',
    ...
    molecularWeight = (86.1323,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.07574,0.062063,-4.93657e-05,2.26059e-08,-4.37794e-12,9334.72,28.3354], Tmin=(100,'K'), Tmax=(1206.86,'K')), NASAPolynomial(coeffs=[10.0554,0.0323011,-1.23748e-05,2.17223e-09,-1.45123e-13,7167.28,-16.6745], Tmin=(1206.86,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(76.7226,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJ) + radical(Isobutyl)"""),
)

species(
    label = 'C=C(CC)CO(1383)',
    ...
    molecularWeight = (86.1323,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.0642,0.0568394,-3.6126e-05,1.18278e-08,-1.58733e-12,-24990.3,25.1447], Tmin=(100,'K'), Tmax=(1704.84,'K')), NASAPolynomial(coeffs=[13.4814,0.0277053,-1.04924e-05,1.80397e-09,-1.17417e-13,-29224.1,-41.3855], Tmin=(1704.84,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-208.713,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH)"""),
)

species(
    label = 'CCC(C)C=O(1384)',
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'C=C(CC)C[O](1373)'],
    products = ['[CH2]C(CC)C[O](591)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', '[CH2]C(C=O)CC(1374)'],
    products = ['[CH2]C(CC)C[O](591)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['C2H5(32)', 'allyloxy(1251)'],
    products = ['[CH2]C(CC)C[O](591)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction22',
    reactants = ['CC[CH]C[O](1328)', 'CH2(T)(17)'],
    products = ['[CH2]C(CC)C[O](591)'],
...
reaction(
    label = 'reaction23',
    reactants = ['O(4)', '[CH2]C([CH2])CC(843)'],
    products = ['[CH2]C(CC)C[O](591)'],
