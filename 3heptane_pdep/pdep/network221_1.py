...
species(
    label = '[O]C(=O)C=C=O(3661)',
    structure = SMILES('[O]C(=O)C=C=O'),
    E0 = (-109.351,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2120,512.5,787.5,3010,987.5,1337.5,450,1655,180,180,180,2038.83,2038.97,2039.21],'cm^-1')),
        HinderedRotor(inertia=(0.159868,'amu*angstrom^2'), symmetry=1, barrier=(3.67569,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (85.0382,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.58342,0.0417191,-8.78341e-05,9.75361e-08,-3.91443e-11,-13111.1,18.5846], Tmin=(100,'K'), Tmax=(844.638,'K')), NASAPolynomial(coeffs=[0.136077,0.0269468,-1.47829e-05,2.92509e-09,-2.03604e-13,-11757.3,35.545], Tmin=(844.638,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-109.351,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(153.818,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cds-(Cdd-O2d)CsH) + group(Cds-O2d(Cds-Cds)O2s) + radical(CCOJ)"""),
)
...
species(
    ...
    molecularWeight = (86.0462,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.30699,0.041788,-4.47184e-05,2.47144e-08,-5.71093e-12,-19708.7,16.9935], Tmin=(100,'K'), Tmax=(1015.32,'K')), NASAPolynomial(coeffs=[8.20544,0.0185495,-1.03857e-05,2.17063e-09,-1.59868e-13,-20906.4,-11.5526], Tmin=(1015.32,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-164.343,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(178.761,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(Cd-Cd(CO)H) + group(Cds-CdsCsCs) + group(Cds-O2d(Cds-Cds)H) + radical(C=COJ) + radical(C=COJ)"""),
)

species(
    label = 'O=[C][CH]C(=O)O(3663)',
    ...
    molecularWeight = (86.0462,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.16066,0.04336,-5.75289e-05,4.23191e-08,-1.26903e-11,-21418.5,21.3558], Tmin=(100,'K'), Tmax=(810.173,'K')), NASAPolynomial(coeffs=[7.58219,0.0165938,-7.97421e-06,1.54361e-09,-1.08388e-13,-22297,-3.65888], Tmin=(810.173,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-178.613,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(170.447,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-(Cds-O2d)(Cds-O2d)HH) + group(Cds-OdCsOs) + group(Cds-OdCsH) + radical(C=OCCJ=O) + radical(CCJCO)"""),
)

species(
    label = 'O=[C]C[C]1OO1(3664)',
    ...
    molecularWeight = (86.0462,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.64681,0.0415318,-4.32254e-05,2.1983e-08,-4.15995e-12,23671.2,22.757], Tmin=(100,'K'), Tmax=(1511.91,'K')), NASAPolynomial(coeffs=[12.5857,0.00541098,-2.65539e-07,-1.00996e-10,1.1104e-14,21184.1,-31.825], Tmin=(1511.91,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(196.036,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsOsOsH) + group(Cs-(Cds-O2d)CsHH) + group(Cds-OdCsH) + ring(dioxirane) + radical(Cs_P) + radical(CCCJ=O)"""),
)
...
species(
    ...
    molecularWeight = (86.0462,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.25264,0.0440714,-7.40472e-05,7.03439e-08,-2.6062e-11,-40240.5,19.606], Tmin=(100,'K'), Tmax=(819.457,'K')), NASAPolynomial(coeffs=[4.75089,0.0206646,-1.06778e-05,2.09287e-09,-1.46079e-13,-40273.5,10.3478], Tmin=(819.457,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-335.056,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cds-(Cdd-O2d)CsH) + group(Cds-O2d(Cds-Cds)O2s)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', '[O]C(=O)C=C=O(3661)'],
