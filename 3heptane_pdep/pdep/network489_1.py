...
species(
    label = 'CC=CC[C]=O(1874)',
    structure = SMILES('CC=CC[C]=O'),
    E0 = (30.7963,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1855,455,950,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,390.668],'cm^-1')),
        HinderedRotor(inertia=(0.113295,'amu*angstrom^2'), symmetry=1, barrier=(11.8442,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.111038,'amu*angstrom^2'), symmetry=1, barrier=(11.8348,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.112786,'amu*angstrom^2'), symmetry=1, barrier=(11.889,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (83.1085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.83002,0.0398037,-9.11512e-06,-1.05209e-08,4.83664e-12,3788.49,22.0946], Tmin=(100,'K'), Tmax=(1207.67,'K')), NASAPolynomial(coeffs=[11.1224,0.0255306,-1.18873e-05,2.32623e-09,-1.65551e-13,340.466,-29.4725], Tmin=(1207.67,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(30.7963,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-OdCsH) + radical(CCCJ=O)"""),
)

species(
    label = 'C[CH]CC=C=O(1875)',
    structure = SMILES('C[CH]CC=C=O'),
    E0 = (68.9827,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2120,512.5,787.5,3010,987.5,1337.5,450,1655,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,246.59,1625.9],'cm^-1')),
        HinderedRotor(inertia=(0.114442,'amu*angstrom^2'), symmetry=1, barrier=(4.97988,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.115458,'amu*angstrom^2'), symmetry=1, barrier=(5.01792,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.114523,'amu*angstrom^2'), symmetry=1, barrier=(4.97267,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (83.1085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.1441,0.0442307,-3.17302e-05,1.54885e-08,-3.86235e-12,8360.58,22.4693], Tmin=(100,'K'), Tmax=(855.83,'K')), NASAPolynomial(coeffs=[4.1043,0.0350693,-1.56734e-05,2.98094e-09,-2.088e-13,8025.05,13.3176], Tmin=(855.83,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(68.9827,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cdd-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-(Cdd-O2d)CsH) + radical(RCCJC)"""),
)
...
species(
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.52127,0.0447419,-6.09339e-06,-2.34949e-08,1.22038e-11,10539.3,25.2239], Tmin=(100,'K'), Tmax=(982.149,'K')), NASAPolynomial(coeffs=[12.1696,0.0238803,-8.60434e-06,1.54068e-09,-1.07719e-13,7362.16,-31.4821], Tmin=(982.149,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(86.8142,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(C=COJ) + radical(RCCJC)"""),
)

species(
    label = '[CH2]CCC[C]=O(1879)',
    structure = SMILES('[CH2]CCC[C]=O'),
    E0 = (114.323,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3000,3100,440,815,1455,1000,1855,455,950,608.264,2599.6],'cm^-1')),
        HinderedRotor(inertia=(0.0488931,'amu*angstrom^2'), symmetry=1, barrier=(8.93595,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.388655,'amu*angstrom^2'), symmetry=1, barrier=(8.93595,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0340353,'amu*angstrom^2'), symmetry=1, barrier=(8.93595,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.388656,'amu*angstrom^2'), symmetry=1, barrier=(8.93596,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
...
species(
    label = 'C[CH][CH]CC=O(1881)',
    structure = SMILES('C[CH][CH]CC=O'),
    E0 = (143.465,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2782.5,750,1395,475,1775,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3050,390,425,1340,1360,335,370,1673.41,1676.72],'cm^-1')),
        HinderedRotor(inertia=(0.132139,'amu*angstrom^2'), symmetry=1, barrier=(3.03813,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.133457,'amu*angstrom^2'), symmetry=1, barrier=(3.06845,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.130724,'amu*angstrom^2'), symmetry=1, barrier=(3.00561,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.132772,'amu*angstrom^2'), symmetry=1, barrier=(3.05269,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.63677,0.0406294,-1.89001e-05,3.78118e-09,-2.83876e-13,17292.6,23.9473], Tmin=(100,'K'), Tmax=(3539.63,'K')), NASAPolynomial(coeffs=[10.8853,0.0248918,-9.51184e-06,1.50085e-09,-8.66486e-14,15472.7,-20.5954], Tmin=(3539.63,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(143.465,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(RCCJC) + radical(CCJCC=O)"""),
)

species(
    label = '[CH2][CH]CCC=O(1882)',
    structure = SMILES('[CH2][CH]CCC=O'),
    E0 = (148.809,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2782.5,750,1395,475,1775,1000,3025,407.5,1350,352.5,1550.46,1552.62],'cm^-1')),
        HinderedRotor(inertia=(0.143335,'amu*angstrom^2'), symmetry=1, barrier=(3.29556,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.144909,'amu*angstrom^2'), symmetry=1, barrier=(3.33175,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.145971,'amu*angstrom^2'), symmetry=1, barrier=(3.35615,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.13066,0.0398929,-1.8153e-05,3.39905e-09,-2.30727e-13,17906.2,21.3822], Tmin=(100,'K'), Tmax=(3053.9,'K')), NASAPolynomial(coeffs=[39.1419,-0.00225331,8.17972e-08,-4.32073e-11,6.99078e-15,-6430.25,-196.388], Tmin=(3053.9,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(148.809,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(RCCJ) + radical(RCCJC)"""),
)
...
species(
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.90697,0.0367836,6.16409e-06,-2.5176e-08,9.27766e-12,-15452,21.0001], Tmin=(100,'K'), Tmax=(1169.13,'K')), NASAPolynomial(coeffs=[10.3103,0.0303686,-1.42624e-05,2.8125e-09,-2.01477e-13,-18943.4,-27.3828], Tmin=(1169.13,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-129.164,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-OdCsH)"""),
)
...
species(
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.49049,0.0492973,-3.02035e-05,9.19995e-09,-1.13786e-12,-14994.7,22.0839], Tmin=(100,'K'), Tmax=(1833.23,'K')), NASAPolynomial(coeffs=[13.1322,0.0238958,-9.41931e-06,1.64164e-09,-1.07124e-13,-19263,-41.1362], Tmin=(1833.23,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-125.464,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cdd-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-(Cdd-O2d)CsH)"""),
)
...
species(
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.70236,0.0468755,-2.6297e-05,7.00462e-09,-7.44425e-13,-14720.1,22.6202], Tmin=(100,'K'), Tmax=(2109.18,'K')), NASAPolynomial(coeffs=[14.4303,0.0227374,-9.13054e-06,1.57869e-09,-1.01292e-13,-20089.2,-48.2835], Tmin=(2109.18,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-123.101,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cds-CdsCsH) + group(Cds-OdCsH) + group(Cds-CdsHH)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'C[CH]CC=C=O(1875)'],
    products = ['C[CH]CC[C]=O(700)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction21',
    reactants = ['CHCH3(T)(80)', '[CH2]C[C]=O(1724)'],
    products = ['C[CH]CC[C]=O(700)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH2]C[CH]C(86)', '[C]=O(261)'],
    products = ['C[CH]CC[C]=O(700)'],
