species(
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.745437,0.0736477,-7.66323e-05,4.40839e-08,-1.04386e-11,-7348.87,26.4986], Tmin=(100,'K'), Tmax=(1011.64,'K')), NASAPolynomial(coeffs=[11.4911,0.0311596,-1.36334e-05,2.56792e-09,-1.78989e-13,-9523.03,-25.4676], Tmin=(1011.64,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-62.0624,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdOsH) + radical(CJC(C)OC) + radical((O)CJOCC2)"""),
)
...
species(
    label = 'C=C(CC)O[C]=O(2301)',
    structure = SMILES('C=C(CC)O[C]=O'),
    E0 = (-162.188,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1855,455,950,2750,2850,1437.5,1250,1305,750,350,2950,3100,1380,975,1025,1650,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,180,489.915,1255.91],'cm^-1')),
        HinderedRotor(inertia=(0.790338,'amu*angstrom^2'), symmetry=1, barrier=(18.1714,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.79053,'amu*angstrom^2'), symmetry=1, barrier=(18.1758,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.790258,'amu*angstrom^2'), symmetry=1, barrier=(18.1696,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.790022,'amu*angstrom^2'), symmetry=1, barrier=(18.1642,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.938807,0.063906,-5.3984e-05,2.34057e-08,-4.11743e-12,-19393.8,23.6597], Tmin=(100,'K'), Tmax=(1342.49,'K')), NASAPolynomial(coeffs=[13.8478,0.0254433,-1.10088e-05,2.06478e-09,-1.43307e-13,-22859.9,-42.4209], Tmin=(1342.49,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-162.188,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-Cd)) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + group(Cds-OdOsH) + radical((O)CJOC)"""),
)
...
species(
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.984827,0.0687475,-6.95257e-05,3.99735e-08,-9.59292e-12,-8655.84,26.8292], Tmin=(100,'K'), Tmax=(992.495,'K')), NASAPolynomial(coeffs=[10.1155,0.0319475,-1.39066e-05,2.61249e-09,-1.8175e-13,-10468.2,-17.1519], Tmin=(992.495,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-72.8547,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdOsH) + radical((O)CJOCC2) + radical(C2CsJOC(O)H)"""),
)

species(
    label = '[CH2][C](CC)OC=O(2303)',
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.979127,0.071203,-7.71315e-05,4.98839e-08,-1.37636e-11,-6822.28,27.9164], Tmin=(100,'K'), Tmax=(861.518,'K')), NASAPolynomial(coeffs=[8.43692,0.0365778,-1.68472e-05,3.23567e-09,-2.274e-13,-8107.32,-6.95174], Tmin=(861.518,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-57.5936,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdOsH) + radical(CJC(C)OC) + radical(C2CsJOC(O)H)"""),
)

species(
    label = 'C[CH]C(C)O[C]=O(2304)',
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.830198,0.0611031,-4.33883e-05,1.40355e-08,-1.35286e-12,-8618.95,28.9374], Tmin=(100,'K'), Tmax=(1196.5,'K')), NASAPolynomial(coeffs=[14.175,0.025542,-1.01546e-05,1.84103e-09,-1.2598e-13,-12460.3,-40.5454], Tmin=(1196.5,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-72.6704,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdOsH) + radical(CCJCO) + radical((O)CJOCC2)"""),
)

species(
    label = '[CH2]C([CH]C)OC=O(2305)',
    structure = SMILES('[CH2]C([CH]C)OC=O'),
    E0 = (-57.4092,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.991943,0.0617205,-4.50622e-05,1.66947e-08,-2.52886e-12,-6793.1,28.7199], Tmin=(100,'K'), Tmax=(1523.71,'K')), NASAPolynomial(coeffs=[13.8171,0.0280522,-1.1918e-05,2.19322e-09,-1.4956e-13,-10701.5,-38.5556], Tmin=(1523.71,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-57.4092,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdOsH) + radical(CJC(C)OC) + radical(CCJCO)"""),
)

species(
    label = '[CH2]CC(C)O[C]=O(2306)',
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.964986,0.0637072,-5.11818e-05,2.16118e-08,-3.75221e-12,-7985.85,27.7365], Tmin=(100,'K'), Tmax=(1347.22,'K')), NASAPolynomial(coeffs=[12.8262,0.0284908,-1.19723e-05,2.20939e-09,-1.51817e-13,-11181.8,-33.0224], Tmin=(1347.22,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-67.3261,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdOsH) + radical((O)CJOCC2) + radical(RCCJ)"""),
)

species(
    label = '[CH2]CC([CH2])OC=O(2307)',
    structure = SMILES('[CH2]CC([CH2])OC=O'),
    E0 = (-52.0649,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.18887,0.0635881,-5.03698e-05,2.13259e-08,-3.82979e-12,-6162.46,27.2979], Tmin=(100,'K'), Tmax=(1268.75,'K')), NASAPolynomial(coeffs=[10.5814,0.0339763,-1.5361e-05,2.93053e-09,-2.05097e-13,-8545.82,-20.2514], Tmin=(1268.75,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-52.0649,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdOsH) + radical(RCCJ) + radical(CJC(C)OC)"""),
)
...
species(
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.887055,0.0590565,-3.53439e-05,6.4393e-09,8.01365e-13,-43014.2,25.2291], Tmin=(100,'K'), Tmax=(1207.73,'K')), NASAPolynomial(coeffs=[14.4791,0.0269737,-1.15611e-05,2.17852e-09,-1.52179e-13,-47240.6,-46.8152], Tmin=(1207.73,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-358.636,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-Cd)) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + group(Cds-OdOsH)"""),
)
...
species(
    label = '[CH2]C(C)O[C]=O(559)',
    structure = SMILES('[CH2]C(C)O[C]=O'),
    E0 = (-38.2821,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,1855,455,950,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,511.524,511.537],'cm^-1')),
        HinderedRotor(inertia=(0.485535,'amu*angstrom^2'), symmetry=1, barrier=(11.1634,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156525,'amu*angstrom^2'), symmetry=1, barrier=(3.59882,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.485534,'amu*angstrom^2'), symmetry=1, barrier=(11.1634,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0992307,'amu*angstrom^2'), symmetry=1, barrier=(18.4257,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
species(
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.453528,0.0727075,-6.91027e-05,3.40039e-08,-6.66463e-12,-7423.16,27.9302], Tmin=(100,'K'), Tmax=(1234.13,'K')), NASAPolynomial(coeffs=[15.6503,0.0234524,-9.23652e-06,1.66476e-09,-1.13618e-13,-11174.1,-48.5825], Tmin=(1234.13,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-62.8182,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdOsH) + radical(CCsJOC(O)H) + radical((O)CJOCC)"""),
)

species(
    label = 'CCC1CC(=O)O1(2309)',
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.98388,0.0277308,5.75125e-05,-9.39092e-08,3.84825e-11,-42809.4,22.1923], Tmin=(100,'K'), Tmax=(932.049,'K')), NASAPolynomial(coeffs=[12.2627,0.0258755,-7.50941e-06,1.24285e-09,-8.73256e-14,-46561,-36.5204], Tmin=(932.049,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-356.668,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(349.208,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsOs) + ring(Beta-Propiolactone)"""),
)
...
species(
    ...
    E0 = (-39.0379,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1855,455,950,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,370.434,370.434,370.435],'cm^-1')),
        HinderedRotor(inertia=(0.00122845,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.133236,'amu*angstrom^2'), symmetry=1, barrier=(12.9742,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.13323,'amu*angstrom^2'), symmetry=1, barrier=(12.9741,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.133235,'amu*angstrom^2'), symmetry=1, barrier=(12.9742,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'C=C(CC)O[C]=O(2301)'],
    products = ['[CH2]C(CC)O[C]=O(503)'],
    transitionState = 'TS2',
...
reaction(
    ...
    products = ['[CH2]C(CC)O[C]=O(503)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(23.3993,'m^3/(mol*s)'), n=2.021, Ea=(85.4002,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Od_R;YJ] for rate rule [Od_Cdd-O2d;CJ]
Euclidian distance = 2.2360679775
Multiplied by reaction path degeneracy 2.0
family: R_Addition_MultipleBond
Ea raised from 83.3 to 85.4 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction4',
    reactants = ['C2H5(32)', 'C=CO[C]=O(399)'],
    products = ['[CH2]C(CC)O[C]=O(503)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]CC([CH2])OC=O(2307)'],
    products = ['[CH2]C(CC)O[C]=O(503)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CH2(S)(24)', '[CH2]C(C)O[C]=O(559)'],
    products = ['[CH2]C(CC)O[C]=O(503)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]C([O])CC(1372)', 'CO(12)'],
    products = ['[CH2]C(CC)O[C]=O(503)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]C([O])CC(1372)', '[C]=O(261)'],
    products = ['[CH2]C(CC)O[C]=O(503)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CH2(T)(17)', 'CC[CH]O[C]=O(1996)'],
    products = ['[CH2]C(CC)O[C]=O(503)'],
