...
species(
    ...
    molecularWeight = (112.213,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.238684,0.0870937,-5.87111e-05,2.36325e-08,-4.41226e-12,17737.7,34.4433], Tmin=(100,'K'), Tmax=(1151.07,'K')), NASAPolynomial(coeffs=[7.39873,0.0622123,-2.62871e-05,4.85338e-09,-3.33607e-13,16089.4,-1.10712], Tmin=(1151.07,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(146.386,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(552.912,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Isobutyl) + radical(Tertalkyl)"""),
)

species(
    label = '[CH2][C](CC)C(C)CC(1109)',
    structure = SMILES('[CH2][C](CC)C(C)CC'),
    E0 = (146.386,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
species(
    ...
    molecularWeight = (112.213,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.799052,0.0917091,-6.01774e-05,2.08085e-08,-2.95872e-12,20174.7,38.8423], Tmin=(100,'K'), Tmax=(1625,'K')), NASAPolynomial(coeffs=[18.6077,0.0439385,-1.60814e-05,2.71773e-09,-1.7552e-13,13867.5,-64.2061], Tmin=(1625,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(166.209,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(552.912,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJ) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]CC([CH2])C(C)CC(1113)',
...
species(
    ...
    molecularWeight = (112.213,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.342839,0.0814531,-2.67807e-05,-1.52652e-08,9.56877e-12,-15415.5,33.5833], Tmin=(100,'K'), Tmax=(1074.8,'K')), NASAPolynomial(coeffs=[15.585,0.0491815,-1.94317e-05,3.55419e-09,-2.4632e-13,-20399.2,-51.6647], Tmin=(1074.8,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-129.571,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(557.07,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + longDistanceInteraction_noncyclic(CdCs-ST) + group(Cds-CdsHH)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', '[CH2]C(CC)C(=C)CC(1107)'],
    products = ['[CH2]C(CC)C([CH2])CC(788)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['C2H5(32)', '[CH2]C(C=C)CC(913)'],
    products = ['[CH2]C(CC)C([CH2])CC(788)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2]C(CC)C([CH2])CC(788)'],
    products = ['[CH2]C(CC)C(C)[CH]C(1110)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]C(CC)C([CH2])CC(788)'],
    products = ['[CH2]C([CH]C)C(C)CC(1111)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]C(CC)C([CH2])CC(788)'],
    products = ['[CH2]CC(C)C([CH2])CC(1112)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]C(CC)C([CH2])CC(788)'],
    products = ['[CH2]CC([CH2])C(C)CC(1113)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]C([CH]CC)CC(898)', 'CH2(T)(17)'],
    products = ['[CH2]C(CC)C([CH2])CC(788)'],
