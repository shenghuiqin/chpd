...
species(
    label = '[CH2]OC(=C)C(1329)',
    structure = SMILES('[CH2]OC(=C)C'),
    E0 = (2.25681,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,422.829,422.832],'cm^-1')),
        HinderedRotor(inertia=(0.00094293,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.105207,'amu*angstrom^2'), symmetry=1, barrier=(13.3466,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.1052,'amu*angstrom^2'), symmetry=1, barrier=(13.3465,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (71.0978,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.87534,0.0370391,-1.60314e-06,-2.59366e-08,1.30032e-11,356.597,18.9691], Tmin=(100,'K'), Tmax=(975.616,'K')), NASAPolynomial(coeffs=[12.3268,0.0170493,-6.01734e-06,1.09769e-09,-7.88346e-14,-2770.7,-36.771], Tmin=(975.616,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(2.25681,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)HHH) + group(Cs-OsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(C=COCJ)"""),
)
...
species(
    ...
    molecularWeight = (72.1057,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.44817,0.0609283,-8.04964e-05,6.71284e-08,-2.30599e-11,11408.8,18.8854], Tmin=(100,'K'), Tmax=(822.265,'K')), NASAPolynomial(coeffs=[5.91472,0.0319131,-1.42725e-05,2.65822e-09,-1.81567e-13,10920.6,-0.291093], Tmin=(822.265,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(94.1324,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(CsJOCC2) + radical(C2CsJOCs)"""),
)

species(
    label = '[CH2][C](C)OC(1331)',
    ...
    molecularWeight = (72.1057,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.37201,0.06749,-0.000109477,1.0418e-07,-3.79399e-11,14645.2,20.1851], Tmin=(100,'K'), Tmax=(867.257,'K')), NASAPolynomial(coeffs=[3.25931,0.0363508,-1.68169e-05,3.1237e-09,-2.10558e-13,15161.5,16.2129], Tmin=(867.257,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(121.058,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(CJC(C)OC) + radical(C2CsJOCs)"""),
)

species(
    label = '[CH2]C([CH2])OC(1332)',
    structure = SMILES('[CH2]C([CH2])OC'),
    E0 = (150.864,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,214.117,214.117],'cm^-1')),
        HinderedRotor(inertia=(0.175684,'amu*angstrom^2'), symmetry=1, barrier=(5.71561,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.175683,'amu*angstrom^2'), symmetry=1, barrier=(5.71561,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.175683,'amu*angstrom^2'), symmetry=1, barrier=(5.71561,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.175683,'amu*angstrom^2'), symmetry=1, barrier=(5.71561,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    ...
    molecularWeight = (72.1057,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.10971,0.0696331,-0.000102459,8.74379e-08,-2.95733e-11,18243,20.2408], Tmin=(100,'K'), Tmax=(854.907,'K')), NASAPolynomial(coeffs=[7.06221,0.0303719,-1.35521e-05,2.49553e-09,-1.68254e-13,17642.2,-5.10474], Tmin=(854.907,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(150.864,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(CJC(C)OC) + radical(CJC(C)OC)"""),
)
...
species(
    ...
    molecularWeight = (72.1057,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.75631,0.039168,-3.41533e-08,-2.85123e-08,1.39085e-11,-22731.9,16.9109], Tmin=(100,'K'), Tmax=(978.569,'K')), NASAPolynomial(coeffs=[12.346,0.0198223,-7.07799e-06,1.28751e-09,-9.17991e-14,-25950.7,-39.806], Tmin=(978.569,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-189.751,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)HHH) + group(Cs-OsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH)"""),
)
...
species(
    label = '[CH2]CO[CH2](583)',
    structure = SMILES('[CH2]CO[CH2]'),
    E0 = (163.919,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,414.312,2171.56],'cm^-1')),
        HinderedRotor(inertia=(0.0736157,'amu*angstrom^2'), symmetry=1, barrier=(9.17355,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0210152,'amu*angstrom^2'), symmetry=1, barrier=(2.57337,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.382784,'amu*angstrom^2'), symmetry=1, barrier=(9.21334,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.33619,0.0379301,-3.71703e-05,2.20965e-08,-5.55883e-12,19773.7,16.1041], Tmin=(100,'K'), Tmax=(945.79,'K')), NASAPolynomial(coeffs=[6.70521,0.0194526,-7.86563e-06,1.44049e-09,-9.89184e-14,18947.2,-4.73047], Tmin=(945.79,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(163.919,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: DFT_QCI_thermo + radical(CJCO) + radical(CsJOCC)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', '[CH2]OC(=C)C(1329)'],
    products = ['[CH2]OC([CH2])C(610)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['CH3(18)', 'CH2OCHCH2(1244)'],
    products = ['[CH2]OC([CH2])C(610)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction10',
    reactants = ['CH2(S)(24)', '[CH2]CO[CH2](583)'],
    products = ['[CH2]OC([CH2])C(610)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CH2(T)(17)', '[CH2]O[CH]C(1245)'],
    products = ['[CH2]OC([CH2])C(610)'],
