species(
    label = '[CH2]C(C[CH]CC)CCC(792)',
    structure = SMILES('[CH2]C(C[CH]CC)CCC'),
    E0 = (133.988,'kJ/mol'),
    modes = [
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.288349,0.0980475,-6.24111e-05,2.23105e-08,-3.58581e-12,16265.8,40.2754], Tmin=(100,'K'), Tmax=(1323.39,'K')), NASAPolynomial(coeffs=[9.61996,0.0680991,-2.84659e-05,5.21037e-09,-3.55426e-13,13643.3,-10.3027], Tmin=(1323.39,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(133.988,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(623.585,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Isobutyl) + radical(RCCJCC)"""),
)
...
species(
    ...
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (125.231,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.188519,0.0932005,-5.48903e-05,1.63439e-08,-2.04772e-12,5548.03,38.0587], Tmin=(100,'K'), Tmax=(1704.25,'K')), NASAPolynomial(coeffs=[14.6069,0.0584752,-2.43274e-05,4.38859e-09,-2.93999e-13,504.919,-41.2087], Tmin=(1704.25,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(44.8953,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(602.799,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(RCCJCC)"""),
)

species(
    label = '[CH2]C(C=CCC)CCC(1258)',
    structure = SMILES('[CH2]C(C=CCC)CCC'),
    E0 = (50.5768,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (125.231,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.948228,0.0955242,-5.01198e-05,5.51556e-09,2.78843e-12,6272.23,40.8339], Tmin=(100,'K'), Tmax=(1129.06,'K')), NASAPolynomial(coeffs=[16.4751,0.053605,-2.07439e-05,3.70852e-09,-2.52018e-13,1075.33,-50.9295], Tmin=(1129.06,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(50.5768,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(602.799,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]C(CC=CC)CCC(1259)',
    ...
    molecularWeight = (125.231,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.00219,0.0992365,-6.41304e-05,2.16921e-08,-3.03917e-12,6409.14,40.3347], Tmin=(100,'K'), Tmax=(1624.29,'K')), NASAPolynomial(coeffs=[18.6009,0.0509618,-1.95499e-05,3.39469e-09,-2.22961e-13,40.9168,-63.7476], Tmin=(1624.29,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(51.7197,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(602.799,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Isobutyl)"""),
)
...
species(
    label = '[CH2]C(CC=C)CCC(1207)',
    structure = SMILES('[CH2]C(CC=C)CCC'),
    E0 = (87.7453,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3000,3100,440,815,1455,1000,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.313748,0.0833492,-4.34087e-05,4.4859e-09,2.56109e-12,10718.2,36.0466], Tmin=(100,'K'), Tmax=(1123.17,'K')), NASAPolynomial(coeffs=[14.7287,0.0471111,-1.81613e-05,3.24027e-09,-2.19982e-13,6245.88,-43.1389], Tmin=(1123.17,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(87.7453,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(532.126,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Isobutyl)"""),
)

species(
    label = 'CC[CH]C[C](C)CCC(1260)',
    structure = SMILES('CC[CH]C[C](C)CCC'),
    E0 = (114.329,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (126.239,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.458418,0.106467,-0.000106227,8.55434e-08,-3.21994e-11,13903.1,40.2533], Tmin=(100,'K'), Tmax=(757.785,'K')), NASAPolynomial(coeffs=[2.3429,0.0815777,-3.69623e-05,7.01452e-09,-4.8797e-13,13768.6,29.4294], Tmin=(757.785,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(114.329,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(623.585,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(Tertalkyl)"""),
)

species(
    label = '[CH2]C([CH]CCC)CCC(1124)',
    structure = SMILES('[CH2]C([CH]CCC)CCC'),
    E0 = (134.072,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (126.239,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.687185,0.100259,-6.31374e-05,2.09039e-08,-2.93348e-12,16295.3,41.7006], Tmin=(100,'K'), Tmax=(1567.2,'K')), NASAPolynomial(coeffs=[15.2546,0.0595699,-2.41935e-05,4.33761e-09,-2.90822e-13,11298.5,-42.3718], Tmin=(1567.2,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(134.072,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(623.585,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Cs_S) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]C(CCC)CC[CH]C(1128)',
    structure = SMILES('[CH2]C(CCC)CC[CH]C'),
    E0 = (133.976,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (126.239,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.489735,0.0995203,-6.40731e-05,2.28587e-08,-3.58192e-12,16274,41.1685], Tmin=(100,'K'), Tmax=(1386.58,'K')), NASAPolynomial(coeffs=[11.552,0.0647821,-2.64932e-05,4.79018e-09,-3.24147e-13,12934.6,-20.8616], Tmin=(1386.58,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(133.976,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(623.585,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJC) + radical(Isobutyl)"""),
)

species(
    label = 'CC[CH]CC(C)[CH]CC(1261)',
    structure = SMILES('CC[CH]CC(C)[CH]CC'),
    E0 = (123.448,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (126.239,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.310797,0.0907371,-4.77798e-05,1.18154e-08,-1.18369e-12,14968.8,38.8431], Tmin=(100,'K'), Tmax=(2066.86,'K')), NASAPolynomial(coeffs=[16.57,0.0592708,-2.49436e-05,4.44963e-09,-2.92753e-13,8247.67,-51.4026], Tmin=(2066.86,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(123.448,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(623.585,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(Cs_S)"""),
)

species(
    label = 'CC[CH][CH]C(C)CCC(1262)',
    structure = SMILES('CC[CH][CH]C(C)CCC'),
    E0 = (123.448,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (126.239,'amu'),
...
species(
    label = '[CH2][C](CCC)CCCC(1123)',
    structure = SMILES('[CH2][C](CCC)CCCC'),
    E0 = (124.953,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (126.239,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.452373,0.10452,-8.2025e-05,4.21378e-08,-1.02247e-11,15183,39.468], Tmin=(100,'K'), Tmax=(920.394,'K')), NASAPolynomial(coeffs=[6.58404,0.0739401,-3.21877e-05,6.03929e-09,-4.19548e-13,13887.8,6.10511], Tmin=(920.394,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(124.953,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(623.585,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Tertalkyl) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]CCCC([CH2])CCC(1130)',
    structure = SMILES('[CH2]CCCC([CH2])CCC'),
    E0 = (144.776,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,2750,2761.11,2772.22,2783.33,2794.44,2805.56,2816.67,2827.78,2838.89,2850,1425,1431.25,1437.5,1443.75,1450,1225,1237.5,1250,1262.5,1275,1270,1287.5,1305,1322.5,1340,700,725,750,775,800,300,325,350,375,400,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (126.239,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.06022,0.104694,-7.05184e-05,2.54354e-08,-3.85726e-12,17599.7,42.2783], Tmin=(100,'K'), Tmax=(1493.17,'K')), NASAPolynomial(coeffs=[16.7899,0.0568762,-2.24826e-05,3.98872e-09,-2.66491e-13,12269,-50.9945], Tmin=(1493.17,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(144.776,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(623.585,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJ) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]C([CH]CC)CCCC(1119)',
...
species(
    label = 'C[CH]CC(C)C[CH]CC(1125)',
    structure = SMILES('C[CH]CC(C)C[CH]CC'),
    E0 = (123.352,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (126.239,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.140996,0.0933027,-5.66643e-05,2.06605e-08,-3.81678e-12,14967.6,39.7148], Tmin=(100,'K'), Tmax=(1054.84,'K')), NASAPolynomial(coeffs=[4.30998,0.0774937,-3.41837e-05,6.45259e-09,-4.49474e-13,14088.1,19.3793], Tmin=(1054.84,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(123.352,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(623.585,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJC) + radical(RCCJCC)"""),
)

species(
    label = '[CH2]C(C[CH]C)CCCC(810)',
    structure = SMILES('[CH2]C(C[CH]C)CCCC'),
    E0 = (133.976,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    opticalIsomers = 1,
    molecularWeight = (126.239,'amu'),
    collisionModel = TransportData(shapeIndex=2, epsilon=(3660.88,'J/mol'), sigma=(7.02286,'angstroms'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with Tc=571.82 K, Pc=23.98 bar (from Joback method)"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.489735,0.0995203,-6.40731e-05,2.28587e-08,-3.58192e-12,16274,41.1685], Tmin=(100,'K'), Tmax=(1386.58,'K')), NASAPolynomial(coeffs=[11.552,0.0647821,-2.64932e-05,4.79018e-09,-3.24147e-13,12934.6,-20.8616], Tmin=(1386.58,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(133.976,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(623.585,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJC) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]CCC(C)C[CH]CC(1263)',
    structure = SMILES('[CH2]CCC(C)C[CH]CC'),
    E0 = (134.152,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (126.239,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.123324,0.0956137,-5.58815e-05,1.66854e-08,-2.13673e-12,16277.5,39.6664], Tmin=(100,'K'), Tmax=(1623.57,'K')), NASAPolynomial(coeffs=[12.3715,0.0648298,-2.74404e-05,5.00686e-09,-3.38427e-13,12220.3,-26.669], Tmin=(1623.57,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(134.152,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(623.585,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(RCCJ)"""),
)

species(
    label = 'C[CH][CH]CC(C)CCC(1264)',
    structure = SMILES('C[CH][CH]CC(C)CCC'),
    E0 = (123.352,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (126.239,'amu'),
...
species(
    label = '[CH2]CCC([CH2])CCCC(1120)',
    structure = SMILES('[CH2]CCC([CH2])CCCC'),
    E0 = (144.776,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,2750,2761.11,2772.22,2783.33,2794.44,2805.56,2816.67,2827.78,2838.89,2850,1425,1431.25,1437.5,1443.75,1450,1225,1237.5,1250,1262.5,1275,1270,1287.5,1305,1322.5,1340,700,725,750,775,800,300,325,350,375,400,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'C=C(CCC)CCCC(1131)',
    structure = SMILES('C=C(CCC)CCCC'),
    E0 = (-149.563,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (126.239,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.43823,0.103563,-6.52872e-05,2.07149e-08,-2.66423e-12,-17779,40.0489], Tmin=(100,'K'), Tmax=(1787.19,'K')), NASAPolynomial(coeffs=[23.6865,0.0473306,-1.80911e-05,3.10976e-09,-2.01558e-13,-26759.6,-95.7524], Tmin=(1787.19,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-149.563,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(627.743,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH)"""),
)

species(
    label = 'CCC=CC(C)CCC(1266)',
    structure = SMILES('CCC=CC(C)CCC'),
    E0 = (-154.506,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (126.239,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.940187,0.0934927,-3.62191e-05,-9.06997e-09,7.40752e-12,-18392.2,39.026], Tmin=(100,'K'), Tmax=(1120.15,'K')), NASAPolynomial(coeffs=[16.7984,0.0568002,-2.2773e-05,4.16815e-09,-2.87629e-13,-24038.2,-56.0285], Tmin=(1120.15,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-154.506,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(627.743,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH)"""),
)

species(
    label = 'CC=CCC(C)CCC(1267)',
    structure = SMILES('CC=CCC(C)CCC'),
    E0 = (-153.363,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (126.239,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.12568,0.0986149,-5.45861e-05,1.2058e-08,-2.66923e-13,-18249.2,39.0094], Tmin=(100,'K'), Tmax=(1340.39,'K')), NASAPolynomial(coeffs=[18.4347,0.0548279,-2.19071e-05,3.92262e-09,-2.63701e-13,-24803.1,-65.9759], Tmin=(1340.39,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-153.363,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(627.743,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH)"""),
)
...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.318351,0.0837672,-5.04103e-05,1.66638e-08,-2.45926e-12,19104.6,35.8489], Tmin=(100,'K'), Tmax=(1417.47,'K')), NASAPolynomial(coeffs=[9.04089,0.0591528,-2.43628e-05,4.41308e-09,-2.98602e-13,16631.9,-9.27537], Tmin=(1417.47,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(157.768,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(552.912,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]C(C[CH]C)CCC(804)',
    structure = SMILES('[CH2]C(C[CH]C)CCC'),
    E0 = (157.756,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    collisionModel = TransportData(shapeIndex=2, epsilon=(3517.68,'J/mol'), sigma=(6.71113,'angstroms'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with Tc=549.45 K, Pc=26.41 bar (from Joback method)"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0942043,0.0854548,-5.26205e-05,1.77099e-08,-2.60231e-12,19114,36.8279], Tmin=(100,'K'), Tmax=(1467.61,'K')), NASAPolynomial(coeffs=[10.9189,0.0559522,-2.24669e-05,4.01264e-09,-2.6906e-13,15936.7,-19.5476], Tmin=(1467.61,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(157.756,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(552.912,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Isobutyl) + radical(RCCJC)"""),
)

species(
    label = 'CC[CH]C[CH]CCCC(1154)',
    structure = SMILES('CC[CH]C[CH]CCCC'),
    E0 = (125.711,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (126.239,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.34562,0.0848296,-4.02649e-05,8.33551e-09,-6.5888e-13,15185.1,35.2926], Tmin=(100,'K'), Tmax=(2804.79,'K')), NASAPolynomial(coeffs=[30.0491,0.0438948,-1.83731e-05,3.1321e-09,-1.95086e-13,-916.439,-132.788], Tmin=(2804.79,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(125.711,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(623.585,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(RCCJCC)"""),
)

species(
    label = 'CC[CH]CC[CH]CCC(791)',
    structure = SMILES('CC[CH]CC[CH]CCC'),
    E0 = (125.711,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (126.239,'amu'),
...
species(
    label = '[CH2]C(CC)C([CH2])CCC(794)',
    structure = SMILES('[CH2]C(CC)C([CH2])CCC'),
    E0 = (142.265,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (126.239,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.37611,0.106664,-7.44831e-05,2.84862e-08,-4.54197e-12,17313.5,43.1351], Tmin=(100,'K'), Tmax=(1452.99,'K')), NASAPolynomial(coeffs=[17.8859,0.0536362,-1.97387e-05,3.36793e-09,-2.20088e-13,11716.1,-56.9897], Tmin=(1452.99,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(142.265,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(623.585,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Isobutyl) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]C(C)CC([CH2])CCC(1155)',
    structure = SMILES('[CH2]C(C)CC([CH2])CCC'),
    E0 = (138.918,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (126.239,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.37611,0.106664,-7.44831e-05,2.84862e-08,-4.54197e-12,16911,43.1351], Tmin=(100,'K'), Tmax=(1452.99,'K')), NASAPolynomial(coeffs=[17.8859,0.0536362,-1.97387e-05,3.36793e-09,-2.20088e-13,11313.5,-56.9897], Tmin=(1452.99,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(138.918,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(623.585,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Isobutyl) + radical(Isobutyl)"""),
)

species(
    label = 'CCCC1CC(CC)C1(795)',
    structure = SMILES('CCCC1CC(CC)C1'),
    E0 = (-123.111,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (126.239,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.280269,0.0706461,3.89153e-05,-9.12034e-08,3.7116e-11,-14632.1,33.1197], Tmin=(100,'K'), Tmax=(1005.05,'K')), NASAPolynomial(coeffs=[17.5467,0.0554056,-2.14826e-05,4.01002e-09,-2.86084e-13,-21029.2,-66.9727], Tmin=(1005.05,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-123.111,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(636.057,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Cyclobutane)"""),
)
...
species(
    label = '[CH2]C([CH2])CCC(904)',
    structure = SMILES('[CH2]C([CH2])CCC'),
    E0 = (212.606,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,208.916,1747.12],'cm^-1')),
        HinderedRotor(inertia=(0.333833,'amu*angstrom^2'), symmetry=1, barrier=(10.3531,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.335504,'amu*angstrom^2'), symmetry=1, barrier=(10.3525,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00385981,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00392692,'amu*angstrom^2'), symmetry=1, barrier=(0.120843,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0324693,'amu*angstrom^2'), symmetry=1, barrier=(70.2513,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(C[CH]CC)CCC(792)'],
    products = ['C=CCCC(91)', 'butene1(85)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'C=C(C[CH]CC)CCC(1257)'],
    products = ['[CH2]C(C[CH]CC)CCC(792)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', '[CH2]C(C=CCC)CCC(1258)'],
    products = ['[CH2]C(C[CH]CC)CCC(792)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', '[CH2]C(CC=CC)CCC(1259)'],
    products = ['[CH2]C(C[CH]CC)CCC(792)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(1.46e+08,'cm^3/(mol*s)'), n=1.64, Ea=(5.73208,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""From training reaction 2555 used for Cds-CsH_Cds-CsH;HJ
Exact match found for rate rule [Cds-CsH_Cds-CsH;HJ]
...
reaction(
    label = 'reaction5',
    reactants = ['npropyl(70)', 'C=CC[CH]CC(282)'],
    products = ['[CH2]C(C[CH]CC)CCC(792)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['C=CCCC(91)', '[CH2][CH]CC(87)'],
    products = ['[CH2]C(C[CH]CC)CCC(792)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2][CH]CCC(94)', 'butene1(85)'],
    products = ['[CH2]C(C[CH]CC)CCC(792)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['CH3(18)', '[CH2]C(CC=C)CCC(1207)'],
    products = ['[CH2]C(C[CH]CC)CCC(792)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]C([CH]CCC)CCC(1124)'],
    products = ['[CH2]C(C[CH]CC)CCC(792)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]C(C[CH]CC)CCC(792)'],
    products = ['[CH2]C(CCC)CC[CH]C(1128)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]C(C[CH]CC)CCC(792)'],
    products = ['CC[CH]CC(C)[CH]CC(1261)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2]C(C[CH]CC)CCC(792)'],
    products = ['CC[CH][CH]C(C)CCC(1262)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]CCCC([CH2])CCC(1130)'],
    products = ['[CH2]C(C[CH]CC)CCC(792)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]C([CH]CC)CCCC(1119)'],
    products = ['[CH2]C(C[CH]CC)CCC(792)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]C(C[CH]CC)CCC(792)'],
    products = ['C[CH]CC(C)C[CH]CC(1125)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]C(C[CH]CC)CCC(792)'],
    products = ['[CH2]C(C[CH]C)CCCC(810)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2]CCC(C)C[CH]CC(1263)'],
    products = ['[CH2]C(C[CH]CC)CCC(792)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2]C(C[CH]CC)CCC(792)'],
    products = ['C[CH][CH]CC(C)CCC(1264)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH2]CCC([CH2])CCCC(1120)'],
    products = ['[CH2]C(C[CH]CC)CCC(792)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH2]C[CH]CC(C)CCC(1265)'],
    products = ['[CH2]C(C[CH]CC)CCC(792)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH2][CH]CC(87)', '[CH2][CH]CCC(94)'],
    products = ['[CH2]C(C[CH]CC)CCC(792)'],
...
reaction(
    label = 'reaction27',
    reactants = ['CH2(S)(24)', '[CH2]C(CC)C[CH]CC(787)'],
    products = ['[CH2]C(C[CH]CC)CCC(792)'],
...
reaction(
    label = 'reaction28',
    reactants = ['CH2(S)(24)', '[CH2]C(C[CH]C)CCC(804)'],
    products = ['[CH2]C(C[CH]CC)CCC(792)'],
...
reaction(
    label = 'reaction31',
    reactants = ['[CH2]C(CC)C([CH2])CCC(794)'],
    products = ['[CH2]C(C[CH]CC)CCC(792)'],
...
reaction(
    label = 'reaction32',
    reactants = ['[CH2]C(C)CC([CH2])CCC(1155)'],
    products = ['[CH2]C(C[CH]CC)CCC(792)'],
...
reaction(
    label = 'reaction34',
    reactants = ['CC[CH]C[CH]CCC(1015)', 'CH2(T)(17)'],
    products = ['[CH2]C(C[CH]CC)CCC(792)'],
...
reaction(
    label = 'reaction35',
    reactants = ['[CH]CC(84)', '[CH2]C([CH2])CCC(904)'],
    products = ['[CH2]C(C[CH]CC)CCC(792)'],
...
network(
    label = '603',
    isomers = [
        '[CH2]C(C[CH]CC)CCC(792)',
    ],
    reactants = [
        ('C=CCCC(91)', 'butene1(85)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
