species(
    label = '[CH2]OO[C]=C(579)',
    structure = SMILES('[CH2]OO[C]=C'),
    E0 = (391.117,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,350,500,795,815,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650],'cm^-1')),
        HinderedRotor(inertia=(0.53187,'amu*angstrom^2'), symmetry=1, barrier=(12.2287,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.70727,'amu*angstrom^2'), symmetry=1, barrier=(39.2534,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0154459,'amu*angstrom^2'), symmetry=1, barrier=(46.2994,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
species(
    label = 'C#COO[CH2](2988)',
    structure = SMILES('C#COO[CH2]'),
    E0 = (382.889,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,750,770,3400,2100,3000,3100,440,815,1455,1000,2175,525],'cm^-1')),
...
species(
    label = '[CH]=COO[CH2](2989)',
    structure = SMILES('[CH]=COO[CH2]'),
    E0 = (398.469,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,350,500,795,815,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000],'cm^-1')),
        HinderedRotor(inertia=(1.2617,'amu*angstrom^2'), symmetry=1, barrier=(29.0089,'kJ/mol'), semiclassical=False),
...
species(
    ...
    E0 = (444.616,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,350,500,795,815,2750,2800,2850,1350,1500,750,1050,1375,1000,1685,370],'cm^-1')),
        HinderedRotor(inertia=(0.370437,'amu*angstrom^2'), symmetry=1, barrier=(8.51707,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.371133,'amu*angstrom^2'), symmetry=1, barrier=(8.53308,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (72.0627,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.28309,0.0415174,-5.58593e-05,4.87443e-08,-1.78797e-11,53533.2,21.2114], Tmin=(100,'K'), Tmax=(769.393,'K')), NASAPolynomial(coeffs=[4.84167,0.0234684,-1.14161e-05,2.21557e-09,-1.55301e-13,53280,10.4516], Tmin=(769.393,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(444.616,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-OsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C=CJO) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'C#COO[CH2](2988)'],
    products = ['[CH2]OO[C]=C(579)'],
    transitionState = 'TS2',
...
reaction(
    ...
    products = ['[CH2]OO[C]=C(579)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(7.35017e+06,'m^3/(mol*s)'), n=0.0284742, Ea=(38.0282,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [Y_rad;Y_rad]
Euclidian distance = 0
family: R_Recombination
Ea raised from -14.4 to 38.0 kJ/mol to match endothermicity of reaction."""),
)
...
reaction(
    label = 'reaction7',
    reactants = ['CH2(T)(17)', 'C=[C]O[O](2971)'],
    products = ['[CH2]OO[C]=C(579)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]O[O](203)', 'H2CC(T)(265)'],
    products = ['[CH2]OO[C]=C(579)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(54738.4,'m^3/(mol*s)'), n=0.884925, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(303.03,'K'), Tmax=(2000,'K'), comment="""Estimated using an average for rate rule [O_rad/NonDe;Birad]
Euclidian distance = 0
