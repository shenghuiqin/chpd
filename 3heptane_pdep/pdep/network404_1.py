species(
    ...
    E0 = (288.128,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,3010,987.5,1337.5,450,1655,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,390.762],'cm^-1')),
        HinderedRotor(inertia=(0.127523,'amu*angstrom^2'), symmetry=1, barrier=(13.8294,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.127632,'amu*angstrom^2'), symmetry=1, barrier=(13.8306,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
species(
    label = '[CH]=CC(C)=O(3654)',
    structure = SMILES('[CH]=CC(C)=O'),
    E0 = (120.602,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,375,552.5,462.5,1710,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655],'cm^-1')),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.72572,0.0297242,-1.46438e-05,2.73927e-09,-1.34399e-13,14549.4,16.4009], Tmin=(100,'K'), Tmax=(2060.74,'K')), NASAPolynomial(coeffs=[13.653,0.0132563,-6.10903e-06,1.09499e-09,-7.04068e-14,9038.72,-46.6616], Tmin=(2060.74,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(120.602,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)HHH) + group(Cds-O2d(Cds-Cds)Cs) + group(Cd-Cd(CO)H) + group(Cds-CdsHH) + radical(Cds_P)"""),
)
...
species(
    ...
    E0 = (206.982,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2175,525,750,770,3400,2100,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,248.361],'cm^-1')),
        HinderedRotor(inertia=(0.596799,'amu*angstrom^2'), symmetry=1, barrier=(26.1314,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.598637,'amu*angstrom^2'), symmetry=1, barrier=(26.1236,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (69.0819,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.10536,0.0335724,-4.55921e-06,-2.27836e-08,1.28083e-11,24969.9,17.5704], Tmin=(100,'K'), Tmax=(925.944,'K')), NASAPolynomial(coeffs=[11.9496,0.0118726,-3.14447e-06,4.88933e-10,-3.35969e-14,22254.1,-33.9861], Tmin=(925.944,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(206.982,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(CC(C)OJ)"""),
)
...
species(
    ...
    E0 = (171.79,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,3010,987.5,1337.5,450,1655,180,512.528,1079.55,1079.79,1080.41],'cm^-1')),
        HinderedRotor(inertia=(0.0208485,'amu*angstrom^2'), symmetry=1, barrier=(17.2221,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (55.0553,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.95468,0.0145152,1.89382e-05,-3.59857e-08,1.47962e-11,20706.8,12.171], Tmin=(100,'K'), Tmax=(981.05,'K')), NASAPolynomial(coeffs=[9.63601,0.00810119,-3.09994e-06,6.30251e-10,-4.91519e-14,18393.6,-25.043], Tmin=(981.05,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(171.79,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(153.818,'J/(mol*K)'), label="""CHCHCHO""", comment="""Thermo library: DFT_QCI_thermo"""),
)
...
species(
    ...
    molecularWeight = (70.0898,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.65217,0.0426312,-9.45696e-06,-2.05997e-08,1.18496e-11,15273.9,18.5647], Tmin=(100,'K'), Tmax=(954.083,'K')), NASAPolynomial(coeffs=[12.4353,0.0190834,-6.48991e-06,1.12284e-09,-7.76736e-14,12230.5,-38.1176], Tmin=(954.083,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(126.224,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + radical(AllylJ2_triplet)"""),
)
...
species(
    ...
    molecularWeight = (70.0898,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.71122,0.0437539,-2.9121e-05,3.46851e-09,2.64633e-12,32484.3,22.5969], Tmin=(100,'K'), Tmax=(1001.08,'K')), NASAPolynomial(coeffs=[12.4187,0.0143872,-5.22235e-06,9.4152e-10,-6.60799e-14,29668.2,-32.43], Tmin=(1001.08,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(269.357,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_P) + radical(CJCO)"""),
)

species(
    label = '[CH]=[C]C(C)O(3658)',
    structure = SMILES('[CH]=[C]C(C)O'),
    E0 = (295.609,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,1685,370,2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1277.5,1000,1380,1390,370,380,2900,435],'cm^-1')),
        HinderedRotor(inertia=(0.143311,'amu*angstrom^2'), symmetry=1, barrier=(10.7862,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.143316,'amu*angstrom^2'), symmetry=1, barrier=(10.7862,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.143322,'amu*angstrom^2'), symmetry=1, barrier=(10.7862,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (70.0898,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.76724,0.0438308,-3.60782e-05,1.54152e-08,-2.64393e-12,35638.4,22.2405], Tmin=(100,'K'), Tmax=(1393.88,'K')), NASAPolynomial(coeffs=[11.4757,0.015971,-6.09777e-06,1.07629e-09,-7.22129e-14,32931.8,-27.8215], Tmin=(1393.88,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(295.609,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_P) + radical(Cds_S)"""),
)
...
species(
    ...
    molecularWeight = (70.0898,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.95361,0.0361666,-6.30014e-06,-1.92937e-08,1.03186e-11,30464.9,21.1321], Tmin=(100,'K'), Tmax=(988.715,'K')), NASAPolynomial(coeffs=[12.0825,0.0154804,-5.70155e-06,1.06018e-09,-7.65782e-14,27470.1,-32.6345], Tmin=(988.715,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(252.621,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CC(C)OJ) + radical(CJCO)"""),
)
...
species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.294841,'amu*angstrom^2'), symmetry=1, barrier=(6.77899,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.58778,0.0397934,-7.47336e-05,7.97916e-08,-3.12223e-11,39629.8,13.7846], Tmin=(100,'K'), Tmax=(857.495,'K')), NASAPolynomial(coeffs=[0.982534,0.0258293,-1.27807e-05,2.45092e-09,-1.68009e-13,40693.8,25.881], Tmin=(857.495,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(329.148,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo library: DFT_QCI_thermo + radical(Cds_P) + radical(CCOJ)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH]=CC(C)[O](619)'],
    products = ['CH3CHO(36)', 'C2H2(22)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', '[CH]=CC(C)=O(3654)'],
    products = ['[CH]=CC(C)[O](619)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['CH3CHO(36)', 'C2H2(T)(264)'],
    products = ['[CH]=CC(C)[O](619)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction13',
    reactants = ['C[CH][O](347)', 'C2H2(T)(264)'],
    products = ['[CH]=CC(C)[O](619)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH]=CC[O](573)', 'CH2(S)(24)'],
    products = ['[CH]=CC(C)[O](619)'],
