...
reaction(
    label = 'reaction2',
    reactants = ['CH3CH2OO(54)'],
    products = ['C[CH]OO(225)'],
    transitionState = 'TS1',
...
This reaction matched rate rule [O2_birad;C_rad/H2/Cs]
family: R_Recombination"""),
)

reaction(
    label = 'reaction3',
    reactants = ['[CH2]O[O](203)', 'CH3(18)'],
    products = ['CH3CH2OO(54)'],
    transitionState = 'TS3',
