...
species(
    ...
    molecularWeight = (56.1063,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.2703,-0.00231093,0.000102465,-1.25889e-07,4.64199e-11,1711.43,10.4045], Tmin=(100,'K'), Tmax=(958.645,'K')), NASAPolynomial(coeffs=[9.08649,0.0204708,-6.80151e-06,1.29486e-09,-9.89927e-14,-1565.65,-28.6856], Tmin=(958.645,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(13.873,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(282.692,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + ring(Cyclobutane)"""),
)
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]C[CH2](83)', 'CH2(T)(17)'],
    products = ['[CH2]CC[CH2](88)'],
    transitionState = 'TS9',
