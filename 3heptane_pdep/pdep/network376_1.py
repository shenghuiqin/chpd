species(
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.669782,0.0762019,-8.09792e-05,4.933e-08,-1.24933e-11,12163.7,24.433], Tmin=(100,'K'), Tmax=(945.873,'K')), NASAPolynomial(coeffs=[10.5151,0.0345672,-1.49534e-05,2.79412e-09,-1.93575e-13,10301.2,-22.5171], Tmin=(945.873,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(100.158,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(CsJOCC2) + radical(CJC(C)OC)"""),
)
...
species(
    label = '[CH2]OC(=C)CC(1364)',
    structure = SMILES('[CH2]OC(=C)CC'),
    E0 = (-20.3887,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2850,1437.5,1250,1305,750,350,2950,3100,1380,975,1025,1650,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,483.38,483.388,483.393],'cm^-1')),
        HinderedRotor(inertia=(0.0754486,'amu*angstrom^2'), symmetry=1, barrier=(12.5103,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.000721444,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0754482,'amu*angstrom^2'), symmetry=1, barrier=(12.5103,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0754472,'amu*angstrom^2'), symmetry=1, barrier=(12.5103,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (85.1244,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.207,0.049139,-4.81471e-06,-3.05264e-08,1.56301e-11,-2340.67,24.2804], Tmin=(100,'K'), Tmax=(981.225,'K')), NASAPolynomial(coeffs=[14.72,0.0226917,-8.16532e-06,1.49558e-09,-1.07169e-13,-6371.23,-47.6813], Tmin=(981.225,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-20.3887,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(C=COCJ)"""),
)
...
species(
    ...
    molecularWeight = (86.1323,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.793993,0.0757957,-9.4663e-05,7.57768e-08,-2.55894e-11,8571.81,24.173], Tmin=(100,'K'), Tmax=(791.539,'K')), NASAPolynomial(coeffs=[6.83043,0.0403425,-1.81001e-05,3.3943e-09,-2.33555e-13,7771.21,-2.55899], Tmin=(791.539,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(70.3521,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(CsJOCC2) + radical(C2CsJOCs)"""),
)

species(
    label = '[CH2][C](CC)OC(1366)',
    ...
    molecularWeight = (86.1323,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.686699,0.0827534,-0.000125162,1.14975e-07,-4.14544e-11,11809.6,24.8894], Tmin=(100,'K'), Tmax=(852.353,'K')), NASAPolynomial(coeffs=[4.28263,0.0445879,-2.05296e-05,3.83191e-09,-2.60188e-13,11969.9,12.6523], Tmin=(852.353,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(97.2773,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(C2CsJOCs) + radical(CJC(C)OC)"""),
)

species(
    label = '[CH2]OC(C)[CH]C(1367)',
    ...
    molecularWeight = (86.1323,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.77577,0.0634123,-4.68664e-05,1.80724e-08,-2.83912e-12,10892.6,26.7949], Tmin=(100,'K'), Tmax=(1492.45,'K')), NASAPolynomial(coeffs=[14.245,0.0273129,-1.05848e-05,1.86582e-09,-1.24385e-13,6872.14,-43.58], Tmin=(1492.45,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(89.5503,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(CCJCO) + radical(CsJOCC2)"""),
)

species(
    label = '[CH2]C([CH]C)OC(1368)',
    ...
    molecularWeight = (86.1323,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.24342,0.0635808,-5.36763e-05,2.67978e-08,-5.86514e-12,14105.6,25.4506], Tmin=(100,'K'), Tmax=(1049.74,'K')), NASAPolynomial(coeffs=[8.1062,0.0374303,-1.63089e-05,3.06646e-09,-2.13383e-13,12664.7,-7.99141], Tmin=(1049.74,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(116.476,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(CJC(C)OC) + radical(CCJCO)"""),
)
...
species(
    ...
    molecularWeight = (86.1323,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.01291,0.0703159,-7.52114e-05,5.14717e-08,-1.53695e-11,14754.9,25.5732], Tmin=(100,'K'), Tmax=(794.202,'K')), NASAPolynomial(coeffs=[7.03332,0.0399937,-1.79415e-05,3.39776e-09,-2.36577e-13,13798.7,-2.08453], Tmin=(794.202,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(121.82,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(RCCJ) + radical(CJC(C)OC)"""),
)
...
species(
    ...
    molecularWeight = (86.1323,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.08778,0.0512699,-3.25201e-06,-3.30958e-08,1.65337e-11,-25429.1,22.2229], Tmin=(100,'K'), Tmax=(983.456,'K')), NASAPolynomial(coeffs=[14.7412,0.0254616,-9.22417e-06,1.68498e-09,-1.20099e-13,-29552.1,-50.7271], Tmin=(983.456,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-212.396,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH)"""),
)
...
species(
    label = '[CH2]OC([CH2])C(610)',
    structure = SMILES('[CH2]OC([CH2])C'),
    E0 = (123.939,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,180,825.11],'cm^-1')),
        HinderedRotor(inertia=(0.137736,'amu*angstrom^2'), symmetry=1, barrier=(10.7732,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.468484,'amu*angstrom^2'), symmetry=1, barrier=(10.7714,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.468644,'amu*angstrom^2'), symmetry=1, barrier=(10.775,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0222656,'amu*angstrom^2'), symmetry=1, barrier=(10.7713,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
species(
    ...
    E0 = (108.622,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,180,1059.6,1060.53],'cm^-1')),
        HinderedRotor(inertia=(0.234274,'amu*angstrom^2'), symmetry=1, barrier=(5.38643,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0030842,'amu*angstrom^2'), symmetry=1, barrier=(15.5785,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.678444,'amu*angstrom^2'), symmetry=1, barrier=(15.5988,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.677853,'amu*angstrom^2'), symmetry=1, barrier=(15.5852,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (72.1057,'amu'),
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', '[CH2]OC(=C)CC(1364)'],
    products = ['[CH2]OC([CH2])CC(593)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['C2H5(32)', 'CH2OCHCH2(1244)'],
    products = ['[CH2]OC([CH2])CC(593)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction13',
    reactants = ['CH2(S)(24)', '[CH2]OC([CH2])C(610)'],
    products = ['[CH2]OC([CH2])CC(593)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]C([O])CC(1372)', 'CH2(T)(17)'],
    products = ['[CH2]OC([CH2])CC(593)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]O[CH]CC(1334)', 'CH2(T)(17)'],
    products = ['[CH2]OC([CH2])CC(593)'],
