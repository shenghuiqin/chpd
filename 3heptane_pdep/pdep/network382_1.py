...
species(
    label = '[CH2]OC(=C)CCC(1399)',
    structure = SMILES('[CH2]OC(=C)CCC'),
    E0 = (-44.1689,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2950,3100,1380,975,1025,1650,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.462853,0.0650763,-2.27111e-05,-1.71881e-08,1.12309e-11,-5173.8,29.1965], Tmin=(100,'K'), Tmax=(1010.74,'K')), NASAPolynomial(coeffs=[16.1697,0.0302068,-1.14628e-05,2.10592e-09,-1.48693e-13,-9742.89,-53.6435], Tmin=(1010.74,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-44.1689,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(C=COCJ)"""),
)
...
species(
    ...
    molecularWeight = (100.159,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.163827,0.0903434,-0.000107522,8.24214e-08,-2.71084e-11,5733.83,28.6835], Tmin=(100,'K'), Tmax=(758.428,'K')), NASAPolynomial(coeffs=[7.6887,0.0488773,-2.19918e-05,4.14612e-09,-2.86886e-13,4643.59,-5.20158], Tmin=(758.428,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(46.5719,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(CsJOCC2) + radical(C2CsJOCs)"""),
)

species(
    label = '[CH2][C](CCC)OC(1401)',
    ...
    molecularWeight = (100.159,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0077612,0.0979385,-0.000140561,1.25394e-07,-4.48124e-11,8973.64,29.571], Tmin=(100,'K'), Tmax=(838.143,'K')), NASAPolynomial(coeffs=[5.27709,0.0528758,-2.42724e-05,4.54739e-09,-3.1043e-13,8789.85,9.25282], Tmin=(838.143,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(73.4971,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(CJC(C)OC) + radical(C2CsJOCs)"""),
)

species(
    label = '[CH2]OC(C)[CH]CC(1402)',
    ...
    molecularWeight = (100.159,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.218304,0.0772386,-5.77454e-05,2.27345e-08,-3.68493e-12,8051.13,31.0345], Tmin=(100,'K'), Tmax=(1434.72,'K')), NASAPolynomial(coeffs=[15.0896,0.0357778,-1.43984e-05,2.59277e-09,-1.75255e-13,3783.89,-46.0788], Tmin=(1434.72,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(65.7701,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(CsJOCC2) + radical(CCJCO)"""),
)

species(
    label = '[CH2]OC(C)C[CH]C(1403)',
    ...
    molecularWeight = (100.159,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.705786,0.0768449,-6.51512e-05,3.3897e-08,-7.89379e-12,7369.06,29.535], Tmin=(100,'K'), Tmax=(982.279,'K')), NASAPolynomial(coeffs=[7.79699,0.047968,-2.10536e-05,3.96778e-09,-2.76389e-13,5975.97,-4.54903], Tmin=(982.279,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(60.3143,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(CsJOCC2) + radical(RCCJC)"""),
)

species(
    label = '[CH2]C([CH]CC)OC(1404)',
    ...
    molecularWeight = (100.159,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.626267,0.0780034,-6.62119e-05,3.31255e-08,-7.25976e-12,11267,29.9125], Tmin=(100,'K'), Tmax=(1048.51,'K')), NASAPolynomial(coeffs=[9.08028,0.0457506,-2.00693e-05,3.78585e-09,-2.63934e-13,9494.21,-11.2733], Tmin=(1048.51,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(92.6953,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(CCJCO) + radical(CJC(C)OC)"""),
)

species(
    label = '[CH2]CCC(C)O[CH2](1405)',
    ...
    molecularWeight = (100.159,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.394689,0.0793232,-6.36942e-05,2.80381e-08,-5.21116e-12,8682.69,29.6879], Tmin=(100,'K'), Tmax=(1242.55,'K')), NASAPolynomial(coeffs=[12.2795,0.0410631,-1.7506e-05,3.25626e-09,-2.24996e-13,5729.24,-30.2304], Tmin=(1242.55,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(71.1144,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(RCCJ) + radical(CsJOCC2)"""),
)

species(
    label = '[CH2]C(C[CH]C)OC(1406)',
    ...
    molecularWeight = (100.159,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.377901,0.08655,-0.000106091,8.82172e-08,-3.1127e-11,10616.3,31.0342], Tmin=(100,'K'), Tmax=(803.103,'K')), NASAPolynomial(coeffs=[5.32966,0.0520858,-2.34143e-05,4.39005e-09,-3.01812e-13,10137,10.1984], Tmin=(803.103,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(87.2396,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(RCCJC) + radical(CJC(C)OC)"""),
)

species(
    label = '[CH2]CCC([CH2])OC(1407)',
    ...
    molecularWeight = (100.159,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.411311,0.0845084,-8.67224e-05,5.61541e-08,-1.59181e-11,11915.7,29.9824], Tmin=(100,'K'), Tmax=(831.941,'K')), NASAPolynomial(coeffs=[7.89769,0.0485133,-2.18222e-05,4.14657e-09,-2.8963e-13,10670.1,-4.75754], Tmin=(831.941,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(98.0396,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(CJC(C)OC) + radical(RCCJ)"""),
)
...
species(
    ...
    molecularWeight = (100.159,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.342937,0.0672146,-2.1169e-05,-1.97388e-08,1.21305e-11,-28262.2,27.1416], Tmin=(100,'K'), Tmax=(1012.15,'K')), NASAPolynomial(coeffs=[16.1988,0.0329637,-1.25143e-05,2.29362e-09,-1.61484e-13,-32927.2,-56.7342], Tmin=(1012.15,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-236.176,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', '[CH2]OC(=C)CCC(1399)'],
    products = ['[CH2]OC([CH2])CCC(599)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['npropyl(70)', 'CH2OCHCH2(1244)'],
    products = ['[CH2]OC([CH2])CCC(599)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]C(C[CH]C)OC(1406)'],
    products = ['[CH2]OC([CH2])CCC(599)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CH2(S)(24)', '[CH2]OC([CH2])CC(593)'],
    products = ['[CH2]OC([CH2])CCC(599)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CH2(T)(17)', '[CH2]C([O])CCC(1410)'],
    products = ['[CH2]OC([CH2])CCC(599)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2]O[CH]CCC(1356)', 'CH2(T)(17)'],
    products = ['[CH2]OC([CH2])CCC(599)'],
