...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.21047,0.0547279,-1.47343e-05,-8.13947e-09,3.57394e-12,-22961.5,27.917], Tmin=(100,'K'), Tmax=(1414.82,'K')), NASAPolynomial(coeffs=[13.9342,0.038579,-1.86303e-05,3.5997e-09,-2.50309e-13,-28546,-44.8947], Tmin=(1414.82,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-191.791,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(390.78,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-OdCsOs) + radical(CCOJ)"""),
)

species(
    label = 'CCCC=CC([O])=O(2710)',
...
species(
    ...
    molecularWeight = (114.142,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.993479,0.0763779,-9.78745e-05,9.80415e-08,-4.05601e-11,-14356.9,30.9514], Tmin=(100,'K'), Tmax=(797.483,'K')), NASAPolynomial(coeffs=[-1.00259,0.0635253,-3.06936e-05,5.92917e-09,-4.139e-13,-13311.5,44.6881], Tmin=(797.483,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-120.187,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsOs) + radical(RCCJCC) + radical(CCOJ)"""),
)
...
species(
    ...
    molecularWeight = (114.142,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.91264,0.0544945,-2.31694e-05,3.2791e-09,-6.62406e-14,-14448.3,24.0938], Tmin=(100,'K'), Tmax=(2576.19,'K')), NASAPolynomial(coeffs=[40.8648,0.0100922,-5.77332e-06,9.65954e-10,-5.4153e-14,-38822.8,-204.273], Tmin=(2576.19,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-120.199,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsOs) + radical(RCCJC) + radical(CCOJ)"""),
)

species(
    label = 'CCC[CH][CH]C(=O)O(2714)',
...
species(
    ...
    molecularWeight = (114.142,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.35272,0.0596544,-2.98121e-05,6.20503e-09,-4.81799e-13,-13124,25.1534], Tmin=(100,'K'), Tmax=(3061.24,'K')), NASAPolynomial(coeffs=[38.2601,0.012736,-6.8223e-06,1.19843e-09,-7.29304e-14,-35108.4,-188.253], Tmin=(3061.24,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-109.399,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsOs) + radical(RCCJ) + radical(CCOJ)"""),
)

species(
    label = 'CC[CH][CH]CC(=O)O(2716)',
    ...
    molecularWeight = (114.142,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.05207,0.0537599,3.4295e-05,-1.87037e-07,1.74265e-10,-17500,29.7792], Tmin=(100,'K'), Tmax=(411.894,'K')), NASAPolynomial(coeffs=[3.72082,0.0538073,-2.50664e-05,4.84133e-09,-3.41365e-13,-17775.3,21.535], Tmin=(411.894,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-145.99,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(407.409,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsOs) + radical(RCCJCC) + radical(CCJCC=O)"""),
)

species(
    label = 'C[CH]C[CH]CC(=O)O(2717)',
    ...
    molecularWeight = (114.142,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.12713,0.0690089,-5.40032e-05,2.81901e-08,-7.25111e-12,-17461.6,33.0001], Tmin=(100,'K'), Tmax=(851.456,'K')), NASAPolynomial(coeffs=[4.7683,0.0519039,-2.38705e-05,4.59782e-09,-3.24309e-13,-18081.6,16.019], Tmin=(851.456,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-146.002,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(407.409,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsOs) + radical(CCJCC=O) + radical(RCCJC)"""),
)

species(
    label = '[CH2]CC[CH]CC(=O)O(2718)',
...
species(
    ...
    molecularWeight = (114.142,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.403148,0.0705332,-4.54715e-05,1.20584e-08,-1.0559e-13,29241.7,33.668], Tmin=(100,'K'), Tmax=(1093.45,'K')), NASAPolynomial(coeffs=[13.3761,0.0350043,-1.30959e-05,2.29564e-09,-1.5442e-13,25691.6,-33.3385], Tmin=(1093.45,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(241.993,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + ring(dioxirane) + radical(RCCJCC) + radical(Cs_P)"""),
)

species(
    label = 'CCCC1C[C]([O])O1(2720)',
    ...
    molecularWeight = (114.142,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.852453,0.0611557,-2.0521e-05,-1.22049e-08,8.56268e-12,6184.3,29.8652], Tmin=(100,'K'), Tmax=(968.902,'K')), NASAPolynomial(coeffs=[10.6766,0.0386675,-1.36804e-05,2.33659e-09,-1.55876e-13,3432.41,-21.5972], Tmin=(968.902,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(50.4174,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(419.881,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + ring(Oxetane) + radical(Cs_P) + radical(CCOJ)"""),
)

species(
    label = 'CCCC=CC(=O)O(528)',
    structure = SMILES('CCCC=CC(=O)O'),
    E0 = (-336.296,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (114.142,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.04278,0.0715545,-6.03324e-05,3.2167e-08,-8.04166e-12,-40346.1,29.5741], Tmin=(100,'K'), Tmax=(895.125,'K')), NASAPolynomial(coeffs=[5.99952,0.0494048,-2.32156e-05,4.52364e-09,-3.21212e-13,-41233.5,6.20984], Tmin=(895.125,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-336.296,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cd-Cd(CO)H) + group(Cds-O2d(Cds-Cds)O2s)"""),
)

species(
    label = 'CCC=CCC(=O)O(2721)',
    structure = SMILES('CCC=CCC(=O)O'),
    E0 = (-417.496,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (114.142,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.725982,0.0593043,-1.06462e-05,-2.00106e-08,8.94568e-12,-50084.9,29.4621], Tmin=(100,'K'), Tmax=(1168.06,'K')), NASAPolynomial(coeffs=[14.6816,0.0381095,-1.75819e-05,3.44088e-09,-2.45707e-13,-55159.4,-47.7999], Tmin=(1168.06,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-417.496,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-OdCsOs)"""),
)
...
species(
    ...
    molecularWeight = (114.142,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.25744,0.0434817,4.01408e-05,-8.10228e-08,3.4155e-11,-45643.3,27.0436], Tmin=(100,'K'), Tmax=(946.609,'K')), NASAPolynomial(coeffs=[13.5152,0.0337179,-1.09923e-05,1.89641e-09,-1.32399e-13,-49847.2,-41.3675], Tmin=(946.609,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-380.449,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(419.881,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsOs) + ring(Beta-Propiolactone)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'CCC=CCC([O])=O(2709)'],
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', 'CCCC=CC([O])=O(2710)'],
    products = ['CCC[CH]CC([O])=O(514)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['C2H5(32)', 'C=CCC([O])=O(2057)'],
    products = ['CCC[CH]CC([O])=O(514)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction14',
    reactants = ['CCC[CH]CC([O])=O(514)'],
    products = ['C[CH]C[CH]CC(=O)O(2717)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CCC[CH]CC([O])=O(514)'],
    products = ['[CH2]CC[CH]CC(=O)O(2718)'],
...
reaction(
    label = 'reaction21',
    reactants = ['CH2(S)(24)', 'CC[CH]CC([O])=O(500)'],
    products = ['CCC[CH]CC([O])=O(514)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH2]C(CC)CC([O])=O(2722)'],
    products = ['CCC[CH]CC([O])=O(514)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[CH]CCC(90)', '[CH2]C([O])=O(1740)'],
    products = ['CCC[CH]CC([O])=O(514)'],
...
reaction(
    label = 'reaction26',
    reactants = ['O(4)', 'CCC[CH]C[C]=O(2250)'],
    products = ['CCC[CH]CC([O])=O(514)'],
