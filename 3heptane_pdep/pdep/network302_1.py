...
species(
    label = 'CCCC=CCC([O])=O(2939)',
    structure = SMILES('CCCC=CCC([O])=O'),
    E0 = (-215.571,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,200,800,914.286,1028.57,1142.86,1257.14,1371.43,1485.71,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.520322,0.0698848,-2.92996e-05,1.45131e-10,1.59057e-12,-25796.7,32.65], Tmin=(100,'K'), Tmax=(1533.63,'K')), NASAPolynomial(coeffs=[18.1069,0.0421524,-1.99143e-05,3.7764e-09,-2.58357e-13,-33323.9,-66.6698], Tmin=(1533.63,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-215.571,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-OdCsOs) + radical(CCOJ)"""),
)

species(
    label = 'CCCCC=CC([O])=O(2940)',
    structure = SMILES('CCCCC=CC([O])=O'),
    E0 = (-134.371,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,180,180,180,354.543,804.563,1600,1828.57,2971.43,3200],'cm^-1')),
        HinderedRotor(inertia=(0.167189,'amu*angstrom^2'), symmetry=1, barrier=(3.844,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.167189,'amu*angstrom^2'), symmetry=1, barrier=(3.844,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.167189,'amu*angstrom^2'), symmetry=1, barrier=(3.844,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.167189,'amu*angstrom^2'), symmetry=1, barrier=(3.844,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.167189,'amu*angstrom^2'), symmetry=1, barrier=(3.844,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.358227,0.0887504,-0.000106943,9.62656e-08,-3.79686e-11,-16038.3,34.4171], Tmin=(100,'K'), Tmax=(752.691,'K')), NASAPolynomial(coeffs=[2.70086,0.0634023,-3.07229e-05,5.98911e-09,-4.2205e-13,-16025.6,26.208], Tmin=(752.691,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-134.371,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cd-Cd(CO)H) + group(Cds-O2d(Cds-Cds)O2s) + radical(CCOJ)"""),
)
...
species(
    label = 'C=CCC([O])=O(2057)',
    structure = SMILES('C=CCC([O])=O'),
    E0 = (-133.12,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,540.521,540.74,540.959,541.04,543.8,544.214,544.957],'cm^-1')),
        HinderedRotor(inertia=(0.000577359,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.000566866,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
species(
    ...
    molecularWeight = (128.169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.72607,0.0653783,-2.90355e-05,4.6873e-09,-2.05347e-13,-17307.8,26.7863], Tmin=(100,'K'), Tmax=(2681.04,'K')), NASAPolynomial(coeffs=[52.7027,0.0062806,-4.62387e-06,7.6865e-10,-4.05688e-14,-49663.9,-273.975], Tmin=(2681.04,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-143.967,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(482.239,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsOs) + radical(RCCJCC) + radical(CCOJ)"""),
)
...
species(
    ...
    molecularWeight = (128.169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.72607,0.0653783,-2.90355e-05,4.68728e-09,-2.05344e-13,-17307.8,26.7863], Tmin=(100,'K'), Tmax=(2681.03,'K')), NASAPolynomial(coeffs=[52.7011,0.00628238,-4.62461e-06,7.68783e-10,-4.05777e-14,-49662.8,-273.965], Tmin=(2681.03,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-143.967,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(482.239,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsOs) + radical(CCOJ) + radical(RCCJCC)"""),
)

species(
    label = 'CCCC[CH][CH]C(=O)O(2943)',
    ...
    molecularWeight = (128.169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.05664,0.0991131,-8.37821e-05,3.6498e-08,-6.35468e-12,-20400.5,34.9208], Tmin=(100,'K'), Tmax=(1378.47,'K')), NASAPolynomial(coeffs=[21.3252,0.0341661,-1.31089e-05,2.31831e-09,-1.55821e-13,-26571,-80.2423], Tmin=(1378.47,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-171.217,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(482.239,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsCs) + radical(Allyl_S) + radical(C=COJ)"""),
)

species(
    label = 'C[CH]CCCCC([O])=O(2944)',
    ...
    molecularWeight = (128.169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.51066,0.067012,-3.11859e-05,5.73894e-09,-3.64373e-13,-17299.2,27.7289], Tmin=(100,'K'), Tmax=(2831.93,'K')), NASAPolynomial(coeffs=[56.4055,0.00212203,-2.76601e-06,4.49441e-10,-2.10866e-14,-52329.5,-296.339], Tmin=(2831.93,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-143.979,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(482.239,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsOs) + radical(CCOJ) + radical(RCCJC)"""),
)

species(
    label = '[CH2]CCCCCC([O])=O(2945)',
    ...
    molecularWeight = (128.169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.266622,0.0896409,-9.13002e-05,7.25351e-08,-2.76053e-11,-15890.3,35.041], Tmin=(100,'K'), Tmax=(698.605,'K')), NASAPolynomial(coeffs=[3.46914,0.0666261,-3.18396e-05,6.20744e-09,-4.39335e-13,-16223.6,21.5564], Tmin=(698.605,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-133.179,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(482.239,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsOs) + radical(CCOJ) + radical(RCCJ)"""),
)

species(
    label = 'CCC[CH][CH]CC(=O)O(2946)',
    ...
    molecularWeight = (128.169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.06847,0.0751351,-2.35459e-05,-6.0537e-08,6.28711e-11,-20323.7,35.4254], Tmin=(100,'K'), Tmax=(492.618,'K')), NASAPolynomial(coeffs=[4.33207,0.062824,-2.92637e-05,5.67036e-09,-4.01426e-13,-20817.4,20.2436], Tmin=(492.618,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-169.77,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(478.082,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsOs) + radical(RCCJCC) + radical(CCJCC=O)"""),
)

species(
    label = 'CC[CH]C[CH]CC(=O)O(2947)',
    ...
    molecularWeight = (128.169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.06847,0.0751351,-2.35459e-05,-6.0537e-08,6.28711e-11,-20323.7,35.4254], Tmin=(100,'K'), Tmax=(492.618,'K')), NASAPolynomial(coeffs=[4.33207,0.062824,-2.92637e-05,5.67036e-09,-4.01426e-13,-20817.4,20.2436], Tmin=(492.618,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-169.77,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(478.082,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsOs) + radical(CCJCC=O) + radical(RCCJCC)"""),
)

species(
    label = 'C[CH]CC[CH]CC(=O)O(2948)',
    ...
    molecularWeight = (128.169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.540852,0.0830711,-6.52979e-05,3.29219e-08,-7.96119e-12,-20301.5,37.3511], Tmin=(100,'K'), Tmax=(909.729,'K')), NASAPolynomial(coeffs=[5.73693,0.0602242,-2.76266e-05,5.31541e-09,-3.7466e-13,-21246.9,12.7747], Tmin=(909.729,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-169.782,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(478.082,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsOs) + radical(RCCJC) + radical(CCJCC=O)"""),
)

species(
    label = '[CH2]CCC[CH]CC(=O)O(2949)',
    ...
    molecularWeight = (128.169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.370908,0.0841256,-5.98142e-05,2.28594e-08,-3.80006e-12,-18994.6,36.9795], Tmin=(100,'K'), Tmax=(1320.53,'K')), NASAPolynomial(coeffs=[10.9937,0.0519482,-2.32634e-05,4.40671e-09,-3.06617e-13,-21800.1,-17.2225], Tmin=(1320.53,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-158.982,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(478.082,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsOs) + radical(RCCJ) + radical(CCJCC=O)"""),
)

species(
    label = 'CCCC[CH]C[C]1OO1(2950)',
    structure = SMILES('CCCC[CH]C[C]1OO1'),
    E0 = (218.212,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.370078,0.0867274,-6.38141e-05,2.52574e-08,-4.12004e-12,26409.9,38.6935], Tmin=(100,'K'), Tmax=(1433.89,'K')), NASAPolynomial(coeffs=[16.3162,0.0401792,-1.51198e-05,2.61777e-09,-1.72807e-13,21624.6,-47.8218], Tmin=(1433.89,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(218.212,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(482.239,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + ring(dioxirane) + radical(Cs_P) + radical(RCCJCC)"""),
)

species(
    label = 'CCCCC1C[C]([O])O1(2951)',
    ...
    molecularWeight = (128.169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0619296,0.0776446,-4.03583e-05,3.65075e-09,3.09571e-12,3353.17,34.9472], Tmin=(100,'K'), Tmax=(1037.51,'K')), NASAPolynomial(coeffs=[12.3345,0.0458315,-1.67766e-05,2.89959e-09,-1.93486e-13,-27.7771,-28.7337], Tmin=(1037.51,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(26.6371,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(490.554,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + ring(Oxetane) + radical(Cs_P) + radical(CCOJ)"""),
)

species(
    label = 'CCCCC=CC(=O)O(546)',
    structure = SMILES('CCCCC=CC(=O)O'),
    E0 = (-360.076,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.444198,0.0857634,-7.21467e-05,3.75884e-08,-9.05721e-12,-43185.5,33.9692], Tmin=(100,'K'), Tmax=(931.048,'K')), NASAPolynomial(coeffs=[6.97071,0.0577238,-2.69724e-05,5.24167e-09,-3.71616e-13,-44400.8,2.94881], Tmin=(931.048,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-360.076,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(482.239,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cd-Cd(CO)H) + group(Cds-O2d(Cds-Cds)O2s)"""),
)

species(
    label = 'CCCC=CCC(=O)O(2952)',
    structure = SMILES('CCCC=CCC(=O)O'),
    E0 = (-441.276,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0309706,0.0752779,-2.81292e-05,-7.97932e-09,5.42943e-12,-52917.3,34.4318], Tmin=(100,'K'), Tmax=(1230.54,'K')), NASAPolynomial(coeffs=[17.1195,0.0440902,-2.00523e-05,3.86546e-09,-2.72412e-13,-58997.8,-59.4231], Tmin=(1230.54,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-441.276,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(482.239,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-OdCsOs)"""),
)
...
species(
    ...
    collisionModel = TransportData(shapeIndex=2, epsilon=(4298.73,'J/mol'), sigma=(6.89952,'angstroms'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with Tc=671.45 K, Pc=29.7 bar (from Joback method)"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.85757,0.0603999,-3.05743e-05,6.59573e-09,-5.36444e-13,-13737.6,27.7235], Tmin=(100,'K'), Tmax=(2892.18,'K')), NASAPolynomial(coeffs=[33.8868,0.0161001,-7.59753e-06,1.29917e-09,-7.85871e-14,-32263.5,-160.813], Tmin=(2892.18,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-114.743,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsOs) + radical(CCOJ) + radical(CCJCC=O)"""),
)

species(
    label = '[CH2]C(CCC)CC([O])=O(2953)',
    ...
    molecularWeight = (128.169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.936698,0.0775589,-3.00842e-05,-4.55483e-08,5.02415e-11,-16622,32.4879], Tmin=(100,'K'), Tmax=(510.401,'K')), NASAPolynomial(coeffs=[4.43944,0.063704,-2.93234e-05,5.64824e-09,-3.98538e-13,-17156.6,16.2101], Tmin=(510.401,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-139.037,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(482.239,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdCsOs) + radical(Isobutyl) + radical(CCOJ)"""),
)
...
species(
    ...
    opticalIsomers = 1,
    molecularWeight = (128.169,'amu'),
    collisionModel = TransportData(shapeIndex=2, epsilon=(4454.42,'J/mol'), sigma=(7.2432,'angstroms'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with Tc=695.77 K, Pc=26.6 bar (from Joback method)"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'CCCC=CCC([O])=O(2939)'],
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', 'CCCCC=CC([O])=O(2940)'],
    products = ['CCCC[CH]CC([O])=O(530)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['npropyl(70)', 'C=CCC([O])=O(2057)'],
    products = ['CCCC[CH]CC([O])=O(530)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction11',
    reactants = ['CCCC[CH]CC([O])=O(530)'],
    products = ['CCCC[CH][CH]C(=O)O(2943)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CCCC[CH]CC([O])=O(530)'],
    products = ['CCC[CH][CH]CC(=O)O(2946)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CCCC[CH]CC([O])=O(530)'],
    products = ['CC[CH]C[CH]CC(=O)O(2947)'],
    transitionState = 'TS15',
    kinetics = Arrhenius(A=(6.24e+09,'s^-1'), n=0, Ea=(79.7052,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""Estimated using template [R6Hall;O_rad_out;Cs_H_out_H/NonDeC] for rate rule [R6HJ_3;O_rad_out;Cs_H_out_H/(NonDeC/Cs)]
Euclidian distance = 1.41421356237
Multiplied by reaction path degeneracy 4.0
family: intra_H_migration"""),
)
...
reaction(
    label = 'reaction16',
    reactants = ['CCCC[CH]CC([O])=O(530)'],
    products = ['C[CH]CC[CH]CC(=O)O(2948)'],
    transitionState = 'TS16',
    kinetics = Arrhenius(A=(7.8e+08,'s^-1'), n=0, Ea=(106.901,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""Estimated using template [R7Hall;O_rad_out;Cs_H_out_H/NonDeC] for rate rule [R7HJ_3;O_rad_out;Cs_H_out_H/NonDeC]
Euclidian distance = 1.0
Multiplied by reaction path degeneracy 4.0
family: intra_H_migration"""),
)
...
reaction(
    label = 'reaction17',
    reactants = ['CCCC[CH]CC([O])=O(530)'],
    products = ['[CH2]CCC[CH]CC(=O)O(2949)'],
    transitionState = 'TS17',
    kinetics = Arrhenius(A=(2.36526e+09,'s^-1'), n=0.595, Ea=(106.847,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [RnH;O_rad_out;Cs_H_out_2H] for rate rule [R8Hall;O_rad_out;Cs_H_out_2H]
Euclidian distance = 1.0
...
reaction(
    label = 'reaction19',
    reactants = ['CCCC[CH]CC([O])=O(530)'],
    products = ['CCCC[CH]C[C]1OO1(2950)'],
...
reaction(
    label = 'reaction23',
    reactants = ['CH2(S)(24)', 'CCC[CH]CC([O])=O(514)'],
    products = ['CCCC[CH]CC([O])=O(530)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[CH2]C(CCC)CC([O])=O(2953)'],
    products = ['CCCC[CH]CC([O])=O(530)'],
...
reaction(
    label = 'reaction27',
    reactants = ['[CH]CCCC(98)', '[CH2]C([O])=O(1740)'],
    products = ['CCCC[CH]CC([O])=O(530)'],
...
reaction(
    label = 'reaction28',
    reactants = ['O(4)', 'CCCC[CH]C[C]=O(2422)'],
    products = ['CCCC[CH]CC([O])=O(530)'],
