...
species(
    ...
    E0 = (152.699,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,180],'cm^-1')),
        HinderedRotor(inertia=(0.76056,'amu*angstrom^2'), symmetry=1, barrier=(17.4868,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.12588,'amu*angstrom^2'), symmetry=1, barrier=(25.8861,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.000585304,'amu*angstrom^2'), symmetry=1, barrier=(6.64557,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (69.125,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.97547,0.0372871,-2.23051e-06,-1.60744e-08,6.82427e-12,18444.4,20.9417], Tmin=(100,'K'), Tmax=(1100.03,'K')), NASAPolynomial(coeffs=[8.32446,0.0292566,-1.18106e-05,2.17378e-09,-1.50623e-13,16136.6,-14.4344], Tmin=(1100.03,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(152.699,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(RCCJ)"""),
)
...
species(
    ...
    E0 = (98.9518,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,764.16],'cm^-1')),
        HinderedRotor(inertia=(0.831185,'amu*angstrom^2'), symmetry=1, barrier=(19.1106,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.160715,'amu*angstrom^2'), symmetry=1, barrier=(3.69515,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.830625,'amu*angstrom^2'), symmetry=1, barrier=(19.0977,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (69.125,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.97337,0.0336992,1.7749e-05,-4.25108e-08,1.74165e-11,11983.7,19.4395], Tmin=(100,'K'), Tmax=(999.848,'K')), NASAPolynomial(coeffs=[10.229,0.0264698,-1.01084e-05,1.86962e-09,-1.32725e-13,9043.31,-26.8364], Tmin=(999.848,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(98.9518,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Allyl_P)"""),
)
...
species(
    ...
    E0 = (197.54,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,2950,3100,1380,975,1025,1650,295.212,295.215],'cm^-1')),
        HinderedRotor(inertia=(0.00193144,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.153959,'amu*angstrom^2'), symmetry=1, barrier=(9.52465,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.153978,'amu*angstrom^2'), symmetry=1, barrier=(9.52497,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (69.125,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.82585,0.041274,-1.29345e-05,-5.56818e-09,3.3172e-12,23842.2,20.6067], Tmin=(100,'K'), Tmax=(1165.33,'K')), NASAPolynomial(coeffs=[8.83337,0.0287115,-1.15551e-05,2.10442e-09,-1.44141e-13,21428.8,-17.6204], Tmin=(1165.33,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(197.54,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_S)"""),
)
...
species(
    ...
    E0 = (206.794,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,202.269],'cm^-1')),
        HinderedRotor(inertia=(0.415669,'amu*angstrom^2'), symmetry=1, barrier=(12.0929,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00411919,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.415942,'amu*angstrom^2'), symmetry=1, barrier=(12.093,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (69.125,'amu'),
...
species(
    ...
    E0 = (260.58,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,187.798,187.8,3509.32],'cm^-1')),
        HinderedRotor(inertia=(0.597765,'amu*angstrom^2'), symmetry=1, barrier=(14.9605,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.04846,'amu*angstrom^2'), symmetry=1, barrier=(51.2677,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.04847,'amu*angstrom^2'), symmetry=1, barrier=(51.2679,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.04847,'amu*angstrom^2'), symmetry=1, barrier=(51.2679,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
species(
    ...
    molecularWeight = (70.1329,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.73746,0.0485764,-2.66697e-05,6.98395e-09,-7.35871e-13,34120.6,20.1126], Tmin=(100,'K'), Tmax=(2079.13,'K')), NASAPolynomial(coeffs=[13.222,0.0264815,-1.07292e-05,1.87264e-09,-1.21271e-13,29345.1,-43.6996], Tmin=(2079.13,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(283.016,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(CsJ2_singlet-CsH)"""),
)
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]C[CH2](83)', 'CHCH3(T)(80)'],
    products = ['[CH2]CC[CH]C(93)'],
...
This reaction matched rate rule [C_rad/H2/Cd;C_rad/H2/Cs]
family: R_Recombination
