species(
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.53664,0.0277016,-1.54808e-05,2.36394e-10,1.90189e-12,30018.1,13.5], Tmin=(100,'K'), Tmax=(1049.25,'K')), NASAPolynomial(coeffs=[9.01128,0.0114511,-4.30423e-06,7.94588e-10,-5.6107e-14,28195.3,-20.2596], Tmin=(1049.25,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(249.115,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: DFT_QCI_thermo + radical(CsJOOC) + radical(CsJOOC)"""),
)
...
reaction(
    label = 'reaction4',
    reactants = ['[CH2]O[O](203)', 'CH2(T)(17)'],
    products = ['[CH2]OO[CH2](570)'],
    transitionState = 'TS4',
