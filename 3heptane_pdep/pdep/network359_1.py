...
species(
    ...
    molecularWeight = (72.0627,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.3733,0.0109078,8.26186e-05,-1.30598e-07,5.48576e-11,16629.3,16.9288], Tmin=(100,'K'), Tmax=(929.236,'K')), NASAPolynomial(coeffs=[20.92,-0.00499451,5.08418e-06,-9.29203e-10,5.1616e-14,10422.2,-86.0397], Tmin=(929.236,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(137.586,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-OsOsHH) + ring(Cyclobutane) + radical(Cs_P) + radical(CJCO)"""),
)
...
species(
    label = '[CH]=C(O)O[CH2](2981)',
    structure = SMILES('[CH]=C(O)O[CH2]'),
    E0 = (134.008,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,3120,650,792.5,1650,3615,1277.5,1000,350,440,435,1725,304.853],'cm^-1')),
        HinderedRotor(inertia=(0.240198,'amu*angstrom^2'), symmetry=1, barrier=(16.2458,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.25247,'amu*angstrom^2'), symmetry=1, barrier=(16.2544,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.245207,'amu*angstrom^2'), symmetry=1, barrier=(16.2525,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (72.0627,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.10851,0.0526203,-6.00729e-05,3.19166e-08,-6.27149e-12,16230.9,19.9074], Tmin=(100,'K'), Tmax=(1428.79,'K')), NASAPolynomial(coeffs=[16.3118,0.00234388,8.07395e-07,-2.68403e-10,2.11723e-14,12673.8,-56.1096], Tmin=(1428.79,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(134.008,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-OsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(Cds_P) + radical(C=COCJ)"""),
)

species(
    label = '[CH]=C([O])OC(2982)',
    ...
    molecularWeight = (72.0627,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.70096,0.0250365,-6.69471e-06,-3.46029e-09,1.61644e-12,2728.68,17.6874], Tmin=(100,'K'), Tmax=(1337.18,'K')), NASAPolynomial(coeffs=[7.26295,0.018918,-8.27606e-06,1.5384e-09,-1.05282e-13,835.614,-8.16374], Tmin=(1337.18,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(22.2754,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-(Cds-O2d)HHH) + group(Cs-OsHHH) + group(Cds-OdCsOs) + radical(CCJ2_triplet)"""),
)
...
reaction(
    label = 'reaction9',
    reactants = ['CH2(T)(17)', '[CH2]O[C]=O(1743)'],
    products = ['[CH2]OC(=C)[O](578)'],
    transitionState = 'TS9',
