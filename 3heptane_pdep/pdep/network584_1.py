...
species(
    label = 'C=C(C)C(C)[O](1807)',
    structure = SMILES('C=C(C)C(C)[O]'),
    E0 = (1.97728,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,3100,1380,975,1025,1650,350,440,435,1725,1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,227.048,4000],'cm^-1')),
        HinderedRotor(inertia=(0.524398,'amu*angstrom^2'), symmetry=1, barrier=(19.1877,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.524386,'amu*angstrom^2'), symmetry=1, barrier=(19.1875,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.524364,'amu*angstrom^2'), symmetry=1, barrier=(19.1873,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (85.1244,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.23607,0.0512482,-1.78268e-05,-1.08057e-08,7.00463e-12,345.505,23.8327], Tmin=(100,'K'), Tmax=(1052,'K')), NASAPolynomial(coeffs=[12.5802,0.0272167,-1.07981e-05,2.00043e-09,-1.40458e-13,-3098.3,-36.4948], Tmin=(1052,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(1.97728,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(CC(C)OJ)"""),
)

species(
    label = '[CH2]C(C)C(C)=O(1808)',
    structure = SMILES('[CH2]C(C)C(C)=O'),
    E0 = (-77.224,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,375,552.5,462.5,1710,1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,295.054],'cm^-1')),
        HinderedRotor(inertia=(0.13891,'amu*angstrom^2'), symmetry=1, barrier=(8.56961,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.138787,'amu*angstrom^2'), symmetry=1, barrier=(8.567,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00265274,'amu*angstrom^2'), symmetry=1, barrier=(21.3881,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.138963,'amu*angstrom^2'), symmetry=1, barrier=(8.56646,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (85.1244,'amu'),
...
species(
    label = 'iC4H7OJ_48(1320)',
    structure = SMILES('[CH2]C(C)C=O'),
    E0 = (-23.7707,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2782.5,750,1395,475,1775,1000,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000],'cm^-1')),
        HinderedRotor(inertia=(0.270796,'amu*angstrom^2'), symmetry=1, barrier=(6.22613,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.271596,'amu*angstrom^2'), symmetry=1, barrier=(6.24453,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.271016,'amu*angstrom^2'), symmetry=1, barrier=(6.23119,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (71.0978,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.39251,0.0416925,-1.61914e-05,-3.94265e-08,4.47558e-11,-2807.51,16.5953], Tmin=(100,'K'), Tmax=(488.036,'K')), NASAPolynomial(coeffs=[5.16195,0.0298914,-1.3414e-05,2.5328e-09,-1.75696e-13,-3207.6,3.8915], Tmin=(488.036,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-23.7707,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), label="""iC4H7OJ_48""", comment="""Thermo library: CBS_QB3_1dHR"""),
)

species(
    label = 'C[C](C)C(C)[O](1809)',
    structure = SMILES('C[C](C)C(C)[O]'),
    E0 = (36.6857,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
species(
    ...
    molecularWeight = (86.1323,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.186,0.0539411,-2.17199e-05,-7.28594e-09,6.21438e-12,1480.23,26.0033], Tmin=(100,'K'), Tmax=(1004.78,'K')), NASAPolynomial(coeffs=[11.2246,0.0304068,-1.11129e-05,1.94956e-09,-1.32457e-13,-1366.42,-26.602], Tmin=(1004.78,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(11.4073,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Isobutyl) + radical(CCJ(C)CO)"""),
)

species(
    label = '[CH2]C(C)C([CH2])O(1813)',
...
species(
    label = '[CH2]C([CH2])C(C)O(1814)',
    structure = SMILES('[CH2]C([CH2])C(C)O'),
    E0 = (63.9157,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1277.5,1000,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,1950.31],'cm^-1')),
        HinderedRotor(inertia=(0.073825,'amu*angstrom^2'), symmetry=1, barrier=(7.26548,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00121563,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0738279,'amu*angstrom^2'), symmetry=1, barrier=(7.26549,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0738318,'amu*angstrom^2'), symmetry=1, barrier=(7.26517,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.710576,'amu*angstrom^2'), symmetry=1, barrier=(69.9285,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.1323,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.991276,0.0615607,-4.29684e-05,1.13988e-08,1.08876e-12,7799.82,27.5968], Tmin=(100,'K'), Tmax=(921.722,'K')), NASAPolynomial(coeffs=[11.2322,0.0291641,-9.84992e-06,1.62363e-09,-1.05642e-13,5400.27,-23.7507], Tmin=(921.722,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(63.9157,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Isobutyl) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]C([O])C(C)C(1815)',
    structure = SMILES('[CH2]C([O])C(C)C'),
    E0 = (95.7009,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,769.207,769.513],'cm^-1')),
        HinderedRotor(inertia=(0.0297429,'amu*angstrom^2'), symmetry=1, barrier=(12.4936,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.543375,'amu*angstrom^2'), symmetry=1, barrier=(12.4933,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.543319,'amu*angstrom^2'), symmetry=1, barrier=(12.492,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.162805,'amu*angstrom^2'), symmetry=1, barrier=(3.74321,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.1323,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.851388,0.0607027,-3.62503e-05,6.03788e-09,1.51275e-12,11630.7,24.9792], Tmin=(100,'K'), Tmax=(1093.29,'K')), NASAPolynomial(coeffs=[13.1699,0.0290597,-1.12569e-05,2.0301e-09,-1.39345e-13,8134.78,-39.2188], Tmin=(1093.29,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(95.7009,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(CJCO)"""),
)

species(
    label = 'C=C(C)C(C)O(1816)',
    structure = SMILES('C=C(C)C(C)O'),
    E0 = (-228.383,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (86.1323,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.06409,0.0553478,-2.40882e-05,-5.33761e-09,5.22895e-12,-27354.6,24.642], Tmin=(100,'K'), Tmax=(1062.37,'K')), NASAPolynomial(coeffs=[12.7117,0.0288993,-1.13214e-05,2.07331e-09,-1.44241e-13,-30811.7,-36.8786], Tmin=(1062.37,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-228.383,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH)"""),
)

species(
    label = 'CC(=O)C(C)C(1817)',
...
species(
    ...
    molecularWeight = (86.1323,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.93492,0.0291112,6.00497e-05,-1.0157e-07,4.3404e-11,-19823.1,18.0583], Tmin=(100,'K'), Tmax=(896.911,'K')), NASAPolynomial(coeffs=[12.5029,0.0251109,-5.39169e-06,6.86552e-10,-4.28505e-14,-23453.7,-41.4476], Tmin=(896.911,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-165.564,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(374.151,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Oxetane)"""),
)
...
species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.00169619,'amu*angstrom^2'), symmetry=1, barrier=(19.2586,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.28377,'amu*angstrom^2'), symmetry=1, barrier=(27.0318,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (72.1057,'amu'),
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'C=C(C)C(C)[O](1807)'],
    products = ['[CH2]C(C)C(C)[O](775)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', '[CH2]C(C)C(C)=O(1808)'],
    products = ['[CH2]C(C)C(C)[O](775)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['CH3(18)', 'C=CC(C)[O](1709)'],
    products = ['[CH2]C(C)C(C)[O](775)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['CH3(18)', 'iC4H7OJ_48(1320)'],
    products = ['[CH2]C(C)C(C)[O](775)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2]C([CH2])C(C)O(1814)'],
    products = ['[CH2]C(C)C(C)[O](775)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CH2(S)(24)', '[CH2]CC(C)[O](709)'],
    products = ['[CH2]C(C)C(C)[O](775)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CH2(S)(24)', '[CH2]C(C)C[O](608)'],
    products = ['[CH2]C(C)C(C)[O](775)'],
...
reaction(
    label = 'reaction23',
    reactants = ['CH2(T)(17)', 'C[CH]C(C)[O](1711)'],
    products = ['[CH2]C(C)C(C)[O](775)'],
...
reaction(
    label = 'reaction24',
    reactants = ['O(4)', '[CH2]C(C)[CH]C(840)'],
    products = ['[CH2]C(C)C(C)[O](775)'],
