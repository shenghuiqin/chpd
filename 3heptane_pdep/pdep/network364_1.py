...
species(
    label = '[CH2]C[CH]O(1253)',
    structure = SMILES('[CH2]C[CH]O'),
    E0 = (112.668,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2850,1437.5,1250,1305,750,350,3615,1277.5,1000,3025,407.5,1350,352.5,4000],'cm^-1')),
        HinderedRotor(inertia=(1.33787,'amu*angstrom^2'), symmetry=1, barrier=(30.7603,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0144426,'amu*angstrom^2'), symmetry=1, barrier=(3.48643,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.152496,'amu*angstrom^2'), symmetry=1, barrier=(3.50618,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (58.0791,'amu'),
...
species(
    ...
    molecularWeight = (58.0791,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.78966,0.0200502,1.20965e-05,-2.63587e-08,1.05553e-11,15957.9,19.5845], Tmin=(100,'K'), Tmax=(1008.88,'K')), NASAPolynomial(coeffs=[7.59882,0.0166734,-6.21146e-06,1.15456e-09,-8.24088e-14,14189,-7.61694], Tmin=(1008.88,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(132.272,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: DFT_QCI_thermo + radical(RCCJ) + radical(CCJCO)"""),
)

species(
    label = 'propen3ol(1256)',
    ...
    molecularWeight = (58.0791,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.70176,0.0329577,-1.64562e-05,-1.88184e-08,2.39485e-11,-17234.3,12.1892], Tmin=(100,'K'), Tmax=(515.464,'K')), NASAPolynomial(coeffs=[4.9661,0.0230771,-1.00832e-05,1.88373e-09,-1.30033e-13,-17569.9,1.77456], Tmin=(515.464,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-143.647,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), label="""propen3ol""", comment="""Thermo library: DFT_QCI_thermo"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]CC[O](253)'],
    products = ['C2H4(29)', 'CH2O(19)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'allyloxy(1251)'],
    products = ['[CH2]CC[O](253)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction14',
    reactants = ['CH2(T)(17)', '[CH2]C[O](258)'],
    products = ['[CH2]CC[O](253)'],
