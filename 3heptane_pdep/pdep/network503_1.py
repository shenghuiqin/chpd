...
species(
    ...
    E0 = (26.0821,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2950,3100,1380,975,1025,1650,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,199.332,199.333,199.356],'cm^-1')),
        HinderedRotor(inertia=(0.756869,'amu*angstrom^2'), symmetry=1, barrier=(21.2904,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.755401,'amu*angstrom^2'), symmetry=1, barrier=(21.2889,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.757205,'amu*angstrom^2'), symmetry=1, barrier=(21.2898,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (71.0978,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.3968,0.0428255,3.10464e-06,-4.61246e-08,2.41722e-11,3244.03,18.6615], Tmin=(100,'K'), Tmax=(926.089,'K')), NASAPolynomial(coeffs=[18.0715,0.00801355,-7.79675e-07,5.81247e-11,-7.24285e-15,-1440.06,-69.1188], Tmin=(926.089,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(26.0821,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CJCO)"""),
)
...
species(
    label = '[CH2]COC[CH2](1705)',
    structure = SMILES('[CH2]COC[CH2]'),
    E0 = (149.805,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,180,410.851,3002.79],'cm^-1')),
        HinderedRotor(inertia=(0.152166,'amu*angstrom^2'), symmetry=1, barrier=(3.49859,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.54303,'amu*angstrom^2'), symmetry=1, barrier=(12.4853,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0191474,'amu*angstrom^2'), symmetry=1, barrier=(12.4868,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (72.1057,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.60943,0.0555485,-5.52788e-05,3.29957e-08,-8.45233e-12,18101,20.1514], Tmin=(100,'K'), Tmax=(921.723,'K')), NASAPolynomial(coeffs=[7.58641,0.0296105,-1.30682e-05,2.46583e-09,-1.71773e-13,16999.1,-8.19696], Tmin=(921.723,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(149.805,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJCO) + radical(CJCO)"""),
)

species(
    label = '[CH2][CH]OCC(1706)',
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'C=CO[CH]C(1703)'],
    products = ['[CH2]CO[CH]C(710)'],
    transitionState = 'TS2',
