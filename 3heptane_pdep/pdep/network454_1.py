...
species(
    label = 'CC(=O)C[C]=O(2972)',
    structure = SMILES('CC(=O)C[C]=O'),
    E0 = (-167.699,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1855,455,950,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,375,552.5,462.5,1710,180],'cm^-1')),
        HinderedRotor(inertia=(0.259713,'amu*angstrom^2'), symmetry=1, barrier=(5.97132,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.259631,'amu*angstrom^2'), symmetry=1, barrier=(5.96943,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.259543,'amu*angstrom^2'), symmetry=1, barrier=(5.96739,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (85.0813,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.67584,0.0552227,-7.55452e-05,6.22647e-08,-2.10683e-11,-20089.8,20.8776], Tmin=(100,'K'), Tmax=(801.688,'K')), NASAPolynomial(coeffs=[6.69131,0.025678,-1.1808e-05,2.22926e-09,-1.53551e-13,-20748.7,-1.3046], Tmin=(801.688,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-167.699,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)(Cds-O2d)HH) + group(Cs-(Cds-O2d)HHH) + group(Cds-OdCsCs) + group(Cds-OdCsH) + radical(C=OCCJ=O)"""),
)

species(
    label = 'CC([O])C=C=O(2973)',
    structure = SMILES('CC([O])C=C=O'),
    E0 = (-52.1701,'kJ/mol'),
    modes = [
        ...
        HinderedRotor(inertia=(0.594742,'amu*angstrom^2'), symmetry=1, barrier=(13.6743,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (85.0813,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.49301,0.0581826,-7.45241e-05,5.47979e-08,-1.64645e-11,-6187.16,19.948], Tmin=(100,'K'), Tmax=(809.45,'K')), NASAPolynomial(coeffs=[8.50602,0.0235281,-1.03076e-05,1.9107e-09,-1.30716e-13,-7322.53,-12.4034], Tmin=(809.45,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-52.1701,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cdd-O2d)CsOsH) + group(Cs-CsHHH) + group(Cds-(Cdd-O2d)CsH) + radical(CC(C)OJ)"""),
)
...
species(
    ...
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.21532,0.0679113,-0.000105751,9.23973e-08,-3.14973e-11,-7481.5,24.2323], Tmin=(100,'K'), Tmax=(863.481,'K')), NASAPolynomial(coeffs=[6.93115,0.0278755,-1.26506e-05,2.33376e-09,-1.5693e-13,-7963.17,0.422371], Tmin=(863.481,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-62.9854,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(CCCJ=O) + radical(C2CsJOH)"""),
)
...
species(
    ...
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.69544,0.0523151,-5.37969e-05,3.16818e-08,-7.76288e-12,-4694.53,25.5875], Tmin=(100,'K'), Tmax=(975.787,'K')), NASAPolynomial(coeffs=[8.61453,0.0239517,-1.01956e-05,1.89275e-09,-1.30732e-13,-6044.82,-7.62342], Tmin=(975.787,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-39.7112,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(CCCJ=O) + radical(CCJCO)"""),
)

species(
    label = '[CH2]C(O)C[C]=O(2976)',
    ...
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.25023,0.0639353,-8.67334e-05,6.67782e-08,-2.08025e-11,-3274.77,25.319], Tmin=(100,'K'), Tmax=(811.804,'K')), NASAPolynomial(coeffs=[9.0018,0.024231,-1.05804e-05,1.949e-09,-1.32381e-13,-4483.57,-10.1552], Tmin=(811.804,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-28.0241,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(CJCO) + radical(CCCJ=O)"""),
)
...
species(
    ...
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.30005,0.0625661,-8.19608e-05,6.20731e-08,-1.91472e-11,-33886.4,20.8302], Tmin=(100,'K'), Tmax=(814.222,'K')), NASAPolynomial(coeffs=[8.67192,0.025141,-1.07859e-05,1.9721e-09,-1.33496e-13,-35046.8,-12.9735], Tmin=(814.222,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-282.531,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cdd-O2d)CsOsH) + group(Cs-CsHHH) + group(Cds-(Cdd-O2d)CsH)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'CC(=O)C[C]=O(2972)'],
    products = ['CC([O])C[C]=O(665)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction16',
    reactants = ['CH2(S)(24)', '[O]CC[C]=O(577)'],
    products = ['CC([O])C[C]=O(665)'],
