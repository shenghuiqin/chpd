...
species(
    label = 'C=C(C[C]=O)CCC(2408)',
    structure = SMILES('C=C(C[C]=O)CCC'),
    E0 = (-18.6589,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1855,455,950,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2950,3100,1380,975,1025,1650,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.175902,0.0726532,-4.09086e-05,6.85046e-09,8.02421e-13,-2097.12,32.1491], Tmin=(100,'K'), Tmax=(1295.19,'K')), NASAPolynomial(coeffs=[17.1465,0.0355352,-1.56323e-05,2.95652e-09,-2.05616e-13,-7775.88,-59.0656], Tmin=(1295.19,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-18.6589,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-OdCsH) + group(Cds-CdsHH) + radical(CCCJ=O)"""),
)

species(
    label = '[CH2]C(C=C=O)CCC(2409)',
    structure = SMILES('[CH2]C(C=C=O)CCC'),
    E0 = (28.6482,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3100,440,815,1455,1000,2120,512.5,787.5,3010,987.5,1337.5,450,1655,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (111.162,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.293271,0.0851269,-7.82332e-05,4.15595e-08,-9.44002e-12,3576.06,30.8619], Tmin=(100,'K'), Tmax=(1030.04,'K')), NASAPolynomial(coeffs=[10.626,0.0450015,-1.98006e-05,3.74059e-09,-2.61062e-13,1447.43,-19.2934], Tmin=(1030.04,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(28.6482,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cdd-O2d)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-(Cdd-O2d)CsH) + radical(CJC(C)C=C=O)"""),
)
...
species(
    ...
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.219633,0.0913528,-0.000114767,9.91946e-08,-3.61333e-11,5088.8,33.6123], Tmin=(100,'K'), Tmax=(803.498,'K')), NASAPolynomial(coeffs=[4.34923,0.0573677,-2.62562e-05,4.95969e-09,-3.42184e-13,4858.61,17.29], Tmin=(803.498,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(41.2448,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(Tertalkyl) + radical(CCCJ=O)"""),
)

species(
    label = '[CH2]C([CH]C=O)CCC(2411)',
    structure = SMILES('[CH2]C(C=C[O])CCC'),
    E0 = (41.9179,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0855232,0.074727,-2.14662e-05,-2.98402e-08,1.83696e-11,5202.31,34.2807], Tmin=(100,'K'), Tmax=(958.526,'K')), NASAPolynomial(coeffs=[18.8597,0.0317224,-1.05908e-05,1.8385e-09,-1.27885e-13,-85.8996,-64.9563], Tmin=(958.526,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(41.9179,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(Isobutyl) + radical(C=COJ)"""),
)

species(
    label = 'CC[CH]C(C)C[C]=O(2412)',
    ...
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.736312,0.0776156,-6.01302e-05,2.81548e-08,-6.06831e-12,6170.04,33.1944], Tmin=(100,'K'), Tmax=(1026.96,'K')), NASAPolynomial(coeffs=[7.13208,0.0527041,-2.3744e-05,4.53417e-09,-3.18186e-13,4856.39,2.16839], Tmin=(1026.96,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(50.3643,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(Cs_S) + radical(CCCJ=O)"""),
)

species(
    label = 'CCCC(C)[CH][C]=O(2413)',
    ...
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0959063,0.079869,-5.77346e-05,2.23915e-08,-3.61254e-12,2953.81,32.6841], Tmin=(100,'K'), Tmax=(1431.35,'K')), NASAPolynomial(coeffs=[14.4803,0.0396711,-1.5609e-05,2.77116e-09,-1.85656e-13,-1164.03,-41.8708], Tmin=(1431.35,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(23.3515,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(CCCJ=O) + radical(CCJCHO)"""),
)

species(
    label = '[CH2][C](CC=O)CCC(2414)',
    structure = SMILES('[CH2][C](CC=O)CCC'),
    E0 = (86.3665,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2782.5,750,1395,475,1775,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350,244.498,856.198,1777.99],'cm^-1')),
        HinderedRotor(inertia=(0.126941,'amu*angstrom^2'), symmetry=1, barrier=(3.46422,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.126941,'amu*angstrom^2'), symmetry=1, barrier=(3.46422,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.126941,'amu*angstrom^2'), symmetry=1, barrier=(3.46422,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.126941,'amu*angstrom^2'), symmetry=1, barrier=(3.46422,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.126941,'amu*angstrom^2'), symmetry=1, barrier=(3.46422,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.269827,0.0905418,-0.00011376,9.91326e-08,-3.60435e-11,10513.6,34.3953], Tmin=(100,'K'), Tmax=(822.93,'K')), NASAPolynomial(coeffs=[3.66012,0.058282,-2.61938e-05,4.8918e-09,-3.34776e-13,10489.9,21.9464], Tmin=(822.93,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(86.3665,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(Isobutyl) + radical(Tertalkyl)"""),
)

species(
    label = '[CH2]C([CH]CC)CC=O(2415)',
    structure = SMILES('[CH2]C([CH]CC)CC=O'),
    E0 = (95.486,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2782.5,750,1395,475,1775,1000,3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,201.556,803.111,1612.45],'cm^-1')),
    ...
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.712861,0.0776268,-6.18539e-05,3.16172e-08,-7.57353e-12,11598.2,34.2452], Tmin=(100,'K'), Tmax=(933.076,'K')), NASAPolynomial(coeffs=[6.2138,0.0540448,-2.39439e-05,4.53117e-09,-3.16349e-13,10571.6,8.08742], Tmin=(933.076,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(95.486,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(Isobutyl) + radical(Cs_S)"""),
)

species(
    label = 'C[CH]CC(C)C[C]=O(2416)',
    ...
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.548167,0.081318,-7.60459e-05,4.88022e-08,-1.44402e-11,6165.33,34.0513], Tmin=(100,'K'), Tmax=(783.58,'K')), NASAPolynomial(coeffs=[5.87199,0.0541397,-2.4016e-05,4.53309e-09,-3.15438e-13,5331.05,9.66558], Tmin=(783.58,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(50.2684,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(RCCJC) + radical(CCCJ=O)"""),
)

species(
    label = '[CH2]C(C[CH]C)CC=O(2417)',
    structure = SMILES('[CH2]C(C[CH]C)CC=O'),
    E0 = (95.3901,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2782.5,750,1395,475,1775,1000,3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,232.34,832.34,1858.72],'cm^-1')),
        HinderedRotor(inertia=(0.130677,'amu*angstrom^2'), symmetry=1, barrier=(3.51172,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.130677,'amu*angstrom^2'), symmetry=1, barrier=(3.51172,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.130677,'amu*angstrom^2'), symmetry=1, barrier=(3.51172,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.130677,'amu*angstrom^2'), symmetry=1, barrier=(3.51172,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.130677,'amu*angstrom^2'), symmetry=1, barrier=(3.51172,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.27014,0.0697928,-1.89209e-05,-6.77572e-08,6.85919e-11,11561.3,32.5723], Tmin=(100,'K'), Tmax=(499.443,'K')), NASAPolynomial(coeffs=[5.13087,0.0551866,-2.40503e-05,4.49178e-09,-3.10479e-13,10972.2,14.5898], Tmin=(499.443,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(95.3901,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(Isobutyl) + radical(RCCJC)"""),
)

species(
    label = '[CH2]CCC(C)C[C]=O(2418)',
    ...
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.479142,0.0809155,-6.44244e-05,2.96121e-08,-5.96986e-12,7468.64,33.3384], Tmin=(100,'K'), Tmax=(1125.8,'K')), NASAPolynomial(coeffs=[9.62505,0.0484198,-2.11276e-05,3.97299e-09,-2.76328e-13,5409.35,-11.8691], Tmin=(1125.8,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(61.0685,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(CCCJ=O) + radical(RCCJ)"""),
)

species(
    label = '[CH2]CCC([CH2])CC=O(2419)',
    structure = SMILES('[CH2]CCC([CH2])CC=O'),
    E0 = (106.19,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.500715,0.0804099,-6.44181e-05,3.09423e-08,-6.6101e-12,12894.8,34.227], Tmin=(100,'K'), Tmax=(1063.91,'K')), NASAPolynomial(coeffs=[8.61598,0.0498984,-2.13996e-05,3.98571e-09,-2.7571e-13,11168.1,-5.42712], Tmin=(1063.91,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(106.19,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(Isobutyl) + radical(RCCJ)"""),
)

species(
    label = 'C=C(CC=O)CCC(2420)',
    ...
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.280969,0.0693501,-2.48521e-05,-8.5399e-09,5.4546e-12,-21338.9,30.9503], Tmin=(100,'K'), Tmax=(1213.03,'K')), NASAPolynomial(coeffs=[15.76,0.0412499,-1.8474e-05,3.5466e-09,-2.49762e-13,-26782.2,-53.674], Tmin=(1213.03,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-178.62,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-OdCsH) + group(Cds-CdsHH)"""),
)

species(
    label = 'CCCC(C)C=C=O(2421)',
    ...
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.179662,0.0792291,-5.53042e-05,2.01523e-08,-3.04903e-12,-21801.1,30.8527], Tmin=(100,'K'), Tmax=(1507.55,'K')), NASAPolynomial(coeffs=[14.8891,0.0402008,-1.64719e-05,2.98019e-09,-2.01376e-13,-26236.2,-46.1502], Tmin=(1507.55,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-182.438,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cdd-O2d)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-(Cdd-O2d)CsH)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'C=C(C[C]=O)CCC(2408)'],
    products = ['[CH2]C(C[C]=O)CCC(685)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', '[CH2]C(C=C=O)CCC(2409)'],
    products = ['[CH2]C(C[C]=O)CCC(685)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['npropyl(70)', 'C=CC[C]=O(1717)'],
    products = ['[CH2]C(C[C]=O)CCC(685)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]C(C[C]=O)CCC(685)'],
    products = ['[CH2]C([CH]C=O)CCC(2411)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]C([CH]CC)CC=O(2415)'],
    products = ['[CH2]C(C[C]=O)CCC(685)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]C(C[CH]C)CC=O(2417)'],
    products = ['[CH2]C(C[C]=O)CCC(685)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]CCC(C)C[C]=O(2418)'],
    products = ['[CH2]C(C[C]=O)CCC(685)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]CCC([CH2])CC=O(2419)'],
    products = ['[CH2]C(C[C]=O)CCC(685)'],
...
reaction(
    label = 'reaction20',
    reactants = ['CH2(S)(24)', '[CH2]C(CC)C[C]=O(677)'],
    products = ['[CH2]C(C[C]=O)CCC(685)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[CH2]C([CH2])CCC(904)', 'CO(12)'],
    products = ['[CH2]C(C[C]=O)CCC(685)'],
...
reaction(
    label = 'reaction27',
    reactants = ['[CH2]C([CH2])CCC(904)', '[C]=O(261)'],
    products = ['[CH2]C(C[C]=O)CCC(685)'],
