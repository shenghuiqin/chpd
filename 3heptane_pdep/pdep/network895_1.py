...
species(
    label = '[CH2]OC(CC)C(=O)C[O](4052)',
    structure = SMILES('[CH2]OC(CC)C(=O)C[O]'),
    E0 = (-149.046,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,375,552.5,462.5,1710,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (130.142,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.228247,0.0930007,-8.79654e-05,4.43184e-08,-9.14031e-12,-17773.8,36.7228], Tmin=(100,'K'), Tmax=(1153.18,'K')), NASAPolynomial(coeffs=[15.5412,0.0383016,-1.68152e-05,3.18548e-09,-2.23002e-13,-21410.8,-41.6031], Tmin=(1153.18,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-149.046,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-(Cds-O2d)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)OsHH) + group(Cs-OsHHH) + group(Cds-OdCsCs) + radical(C=OCOJ) + radical(CsJOCC2)"""),
)

species(
    label = 'CC[CH]OCC(=O)C[O](4053)',
    structure = SMILES('CC[CH]OCC(=O)C[O]'),
    E0 = (-139.677,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2800,2850,1350,1500,750,1050,1375,1000,375,552.5,462.5,1710,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (130.142,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.460002,0.102836,-0.000117211,7.41718e-08,-1.925e-11,-16642.7,35.2486], Tmin=(100,'K'), Tmax=(928.714,'K')), NASAPolynomial(coeffs=[13.674,0.0419614,-1.88909e-05,3.59414e-09,-2.51455e-13,-19268.1,-31.8946], Tmin=(928.714,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-139.677,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-O2d)OsHH) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)OsHH) + group(Cds-OdCsCs) + radical(C=OCOJ) + radical(CCsJOCs)"""),
)
...
species(
    label = 'CCC1OCC1([O])[CH]O(4054)',
    structure = SMILES('CCC1OCC1([O])[CH]O'),
    E0 = (-121.371,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2950,3150,900,1000,1100,2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,300,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (130.142,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.477769,0.093153,-7.91836e-05,2.60865e-08,1.34458e-12,-14431.1,31.6862], Tmin=(100,'K'), Tmax=(857.598,'K')), NASAPolynomial(coeffs=[17.4116,0.0314758,-9.36974e-06,1.40522e-09,-8.62322e-14,-18299.8,-56.5375], Tmin=(857.598,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-121.371,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(440.667,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Oxetane) + radical(CCsJOH) + radical(CC(C)2OJ)"""),
)

species(
    label = 'CC[C]1OCC1(O)C[O](4055)',
    ...
    molecularWeight = (130.142,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.302808,0.0981128,-0.000119895,8.81199e-08,-2.60539e-11,-14783.3,32.9401], Tmin=(100,'K'), Tmax=(935.496,'K')), NASAPolynomial(coeffs=[10.1947,0.043256,-1.59468e-05,2.64875e-09,-1.67727e-13,-16311,-14.672], Tmin=(935.496,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-124.176,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(440.667,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Oxetane) + radical(C2CsJOCs) + radical(CCOJ)"""),
)

species(
    label = 'CCC1O[CH]C1(O)C[O](4056)',
    ...
    molecularWeight = (130.142,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.388109,0.0928716,-8.2046e-05,3.06036e-08,-3.34055e-13,-14803,32.0632], Tmin=(100,'K'), Tmax=(836.626,'K')), NASAPolynomial(coeffs=[16.2841,0.0329471,-1.00835e-05,1.53009e-09,-9.39079e-14,-18285.2,-49.5354], Tmin=(836.626,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-124.423,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(440.667,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Oxetane) + radical(CCsJOCs) + radical(CCOJ)"""),
)

species(
    label = 'CCC1OCC1(O)[CH][O](4057)',
    structure = SMILES('CCC1OCC1(O)[CH][O]'),
    E0 = (-124.582,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (130.142,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.543304,0.0970058,-0.000103577,6.32468e-08,-1.5544e-11,-14817.7,32.7103], Tmin=(100,'K'), Tmax=(1013.34,'K')), NASAPolynomial(coeffs=[14.4661,0.0365206,-1.22109e-05,1.93254e-09,-1.19789e-13,-17796,-39.5868], Tmin=(1013.34,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-124.582,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(440.667,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Oxetane) + radical(CCOJ) + radical(CCsJOH)"""),
)

species(
    label = 'CC[C]1OCC1([O])CO(4058)',
    ...
    molecularWeight = (130.142,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.159112,0.0930592,-8.97043e-05,4.04385e-08,-2.91872e-12,-14400,31.6516], Tmin=(100,'K'), Tmax=(748.373,'K')), NASAPolynomial(coeffs=[13.2904,0.0379762,-1.29791e-05,2.09317e-09,-1.3193e-13,-16883.6,-32.4799], Tmin=(748.373,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-120.965,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(440.667,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Oxetane) + radical(C2CsJOCs) + radical(CC(C)2OJ)"""),
)

species(
    label = 'CCC1O[CH]C1([O])CO(4059)',
    structure = SMILES('CCC1O[CH]C1([O])CO'),
    E0 = (-121.213,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (130.142,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.28816,0.10083,-0.000101143,5.34194e-08,-1.08446e-11,-14374.9,34.4763], Tmin=(100,'K'), Tmax=(1354.18,'K')), NASAPolynomial(coeffs=[20.7143,0.0252248,-5.63934e-06,6.14424e-10,-2.75587e-14,-19360.7,-74.7504], Tmin=(1354.18,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-121.213,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(440.667,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Oxetane) + radical(CC(C)2OJ) + radical(CCsJOCs)"""),
)

species(
    label = 'C[CH]C1OCC1(O)C[O](4060)',
    ...
    molecularWeight = (130.142,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.401687,0.0868458,-7.69761e-05,3.85712e-08,-7.78569e-12,-12459,35.1492], Tmin=(100,'K'), Tmax=(1257.2,'K')), NASAPolynomial(coeffs=[15.5271,0.0335488,-1.02637e-05,1.53932e-09,-9.24904e-14,-16257.3,-44.5213], Tmin=(1257.2,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-104.977,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(440.667,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Oxetane) + radical(CCOJ) + radical(CCJCO)"""),
)

species(
    label = 'C[CH]C1OCC1([O])CO(4061)',
    structure = SMILES('C[CH]C1OCC1([O])CO'),
    E0 = (-101.767,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (130.142,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.990214,0.0907524,-8.00836e-05,3.78956e-08,-6.96355e-12,-12043.8,36.47], Tmin=(100,'K'), Tmax=(1499.04,'K')), NASAPolynomial(coeffs=[19.0211,0.0273945,-6.71856e-06,8.35659e-10,-4.37256e-14,-16924.3,-64.4416], Tmin=(1499.04,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-101.767,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(440.667,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Oxetane) + radical(CC(C)2OJ) + radical(CCJCO)"""),
)

species(
    label = '[CH2]CC1OCC1(O)C[O](4062)',
    ...
    molecularWeight = (130.142,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0794858,0.0870132,-7.52298e-05,3.23703e-08,-3.6908e-12,-11833.6,33.2919], Tmin=(100,'K'), Tmax=(860.014,'K')), NASAPolynomial(coeffs=[13.3316,0.0379695,-1.29441e-05,2.11394e-09,-1.35593e-13,-14633.4,-32.2531], Tmin=(860.014,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-99.6331,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(440.667,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Oxetane) + radical(RCCJ) + radical(CCOJ)"""),
)

species(
    label = '[CH2]CC1OCC1([O])CO(4063)',
    structure = SMILES('[CH2]CC1OCC1([O])CO'),
    E0 = (-96.4223,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (130.142,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.820476,0.0929626,-8.65882e-05,4.39345e-08,-8.76976e-12,-11412.3,35.1425], Tmin=(100,'K'), Tmax=(1328.85,'K')), NASAPolynomial(coeffs=[18.1819,0.0296348,-8.18619e-06,1.13067e-09,-6.40282e-14,-15921.4,-59.8997], Tmin=(1328.85,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-96.4223,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(440.667,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Oxetane) + radical(RCCJ) + radical(CC(C)2OJ)"""),
)

species(
    label = 'CCC1OCC1(O)C=O(4064)',
    structure = SMILES('CCC1OCC1(O)C=O'),
    E0 = (-443.112,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (130.142,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.10232,0.0909408,-7.99857e-05,3.74698e-08,-6.77063e-12,-53092.1,33.3194], Tmin=(100,'K'), Tmax=(1546.01,'K')), NASAPolynomial(coeffs=[19.3198,0.0264205,-6.05108e-06,7.00376e-10,-3.44231e-14,-58010.5,-69.5876], Tmin=(1546.01,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-443.112,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(440.667,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-(Cds-O2d)CsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + ring(Oxetane)"""),
)
...
species(
    label = 'CC1OCC1([O])C[O](4065)',
    structure = SMILES('CC1OCC1([O])C[O]'),
    E0 = (-52.1833,'kJ/mol'),
    modes = [
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.780715,0.0671446,-4.74816e-05,1.2396e-08,1.79166e-12,-6156.8,26.233], Tmin=(100,'K'), Tmax=(873.605,'K')), NASAPolynomial(coeffs=[11.1968,0.0326452,-1.08982e-05,1.76533e-09,-1.13155e-13,-8480.14,-25.4925], Tmin=(873.605,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-52.1833,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(374.151,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Oxetane) + radical(CCOJ) + radical(CC(C)2OJ)"""),
)
...
species(
    label = 'CCC1OC[C]1C[O](4066)',
    structure = SMILES('CCC1OC[C]1C[O]'),
    E0 = (29.107,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2950,3150,900,1000,1100,2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,300,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.0756,0.0557414,-5.74389e-06,-2.68285e-08,1.38013e-11,3613.8,27.8361], Tmin=(100,'K'), Tmax=(942.746,'K')), NASAPolynomial(coeffs=[9.72228,0.0399191,-1.37671e-05,2.32127e-09,-1.54141e-13,1056.27,-18.2869], Tmin=(942.746,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(29.107,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(419.881,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Oxetane) + radical(CCOJ) + radical(CCJ(C)CO)"""),
)

species(
    label = '[CH2]C1([O])COC1CC(4067)',
    structure = SMILES('[CH2]C1([O])COC1CC'),
    E0 = (70.1749,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2950,3150,900,1000,1100,2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2850,1437.5,1250,1305,750,350,300,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (114.142,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.63465,0.0852208,-7.45465e-05,3.53263e-08,-6.54173e-12,8621.21,29.8313], Tmin=(100,'K'), Tmax=(1474.26,'K')), NASAPolynomial(coeffs=[17.6487,0.0272109,-6.97403e-06,9.03492e-10,-4.87979e-14,4143.49,-62.3752], Tmin=(1474.26,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(70.1749,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(419.881,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Oxetane) + radical(CJC(C)2O) + radical(CC(C)2OJ)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]OC(CC)C(=O)C[O](4052)'],
    products = ['CCC1OCC1([O])C[O](3362)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(1.46159e+06,'s^-1'), n=1.55572, Ea=(73.0821,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R5_SS;multiplebond_intra;radadd_intra_cs2H] for rate rule [R5_SS_CO;carbonylbond_intra_Nd;radadd_intra_cs2H]
Euclidian distance = 2.2360679775
family: Intra_R_Add_Exocyclic
Ea raised from 71.4 to 73.1 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction3',
    reactants = ['CC[CH]OCC(=O)C[O](4053)'],
    products = ['CCC1OCC1([O])C[O](3362)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(2.13771e+06,'s^-1'), n=1.58803, Ea=(63.7139,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R5_SS;multiplebond_intra;radadd_intra_csHNd] for rate rule [R5_SS_CO;carbonylbond_intra_Nd;radadd_intra_csHNd]
Euclidian distance = 2.2360679775
family: Intra_R_Add_Exocyclic
Ea raised from 62.6 to 63.7 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction4',
    reactants = ['H(3)', 'CCC1OCC1([O])C=O(3347)'],
    products = ['CCC1OCC1([O])C[O](3362)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['CCC1OCC1([O])[CH]O(4054)'],
    products = ['CCC1OCC1([O])C[O](3362)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['CCC1OCC1([O])C[O](3362)'],
    products = ['CC[C]1OCC1(O)C[O](4055)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['CCC1OCC1([O])C[O](3362)'],
    products = ['CCC1O[CH]C1(O)C[O](4056)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction12',
    reactants = ['CCC1OCC1([O])C[O](3362)'],
    products = ['CCC1O[CH]C1([O])CO(4059)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CCC1OCC1([O])C[O](3362)'],
    products = ['C[CH]C1OCC1(O)C[O](4060)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CCC1OCC1([O])C[O](3362)'],
    products = ['C[CH]C1OCC1([O])CO(4061)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CCC1OCC1([O])C[O](3362)'],
    products = ['[CH2]CC1OCC1(O)C[O](4062)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CCC1OCC1([O])C[O](3362)'],
    products = ['[CH2]CC1OCC1([O])CO(4063)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CH2(S)(24)', 'CC1OCC1([O])C[O](4065)'],
    products = ['CCC1OCC1([O])C[O](3362)'],
...
reaction(
    label = 'reaction21',
    reactants = ['C2H5CHO(57)', 'C=C([O])C[O](575)'],
    products = ['CCC1OCC1([O])C[O](3362)'],
...
reaction(
    label = 'reaction22',
    reactants = ['CH2O(19)', 'CCC=C([O])C[O](1966)'],
    products = ['CCC1OCC1([O])C[O](3362)'],
...
reaction(
    label = 'reaction23',
    reactants = ['O(4)', 'CCC1OC[C]1C[O](4066)'],
    products = ['CCC1OCC1([O])C[O](3362)'],
...
reaction(
    label = 'reaction24',
    reactants = ['O(4)', '[CH2]C1([O])COC1CC(4067)'],
    products = ['CCC1OCC1([O])C[O](3362)'],
