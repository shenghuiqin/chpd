...
species(
    ...
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.36598,0.0403472,-1.76014e-05,2.4552e-09,-3.70413e-14,-10444.7,19.0109], Tmin=(100,'K'), Tmax=(2577.03,'K')), NASAPolynomial(coeffs=[34.3221,0.00429965,-3.60516e-06,6.41651e-10,-3.64268e-14,-30384.9,-167.371], Tmin=(2577.03,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-86.8105,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cd-Cd(CO)H) + group(Cds-O2d(Cds-Cds)O2s) + radical(CCOJ)"""),
)
...
species(
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.63188,0.0607513,-7.73701e-05,7.92698e-08,-3.33182e-11,-11519.7,26.5874], Tmin=(100,'K'), Tmax=(800.758,'K')), NASAPolynomial(coeffs=[-0.885241,0.053252,-2.57207e-05,4.96462e-09,-3.46307e-13,-10473,42.1902], Tmin=(800.758,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-96.4186,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsOs) + radical(RCCJC) + radical(CCOJ)"""),
)
...
species(
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.73248,0.0472999,-2.20853e-05,3.91918e-09,-2.16387e-13,-10271.6,21.6077], Tmin=(100,'K'), Tmax=(2587.06,'K')), NASAPolynomial(coeffs=[33.2113,0.00909102,-5.10111e-06,8.7466e-10,-5.09149e-14,-29025.4,-160.173], Tmin=(2587.06,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-85.6186,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsOs) + radical(CCOJ) + radical(RCCJ)"""),
)

species(
    label = 'CC[CH][CH]C(=O)O(2325)',
...
species(
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.17015,0.0474658,-2.21785e-06,-6.36696e-08,5.79099e-11,-14641.3,27.1199], Tmin=(100,'K'), Tmax=(471.065,'K')), NASAPolynomial(coeffs=[3.70061,0.0438014,-2.02628e-05,3.91947e-09,-2.7749e-13,-14889,19.7895], Tmin=(471.065,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-122.222,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsOs) + radical(CCJCC=O) + radical(RCCJC)"""),
)

species(
    label = '[CH2]C[CH]CC(=O)O(2327)',
...
species(
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.20587,0.0539318,-2.53985e-05,-3.85635e-09,5.27169e-12,32072.3,28.5403], Tmin=(100,'K'), Tmax=(994.854,'K')), NASAPolynomial(coeffs=[11.5058,0.0281813,-1.01881e-05,1.77575e-09,-1.203e-13,29247.8,-24.9933], Tmin=(994.854,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(265.773,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + ring(dioxirane) + radical(RCCJCC) + radical(Cs_P)"""),
)

species(
    label = 'CCC1C[C]([O])O1(2329)',
...
species(
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.62723,0.0575219,-4.9178e-05,2.76685e-08,-7.45406e-12,-37506.1,25.2291], Tmin=(100,'K'), Tmax=(830.592,'K')), NASAPolynomial(coeffs=[5.0463,0.0410563,-1.94425e-05,3.80188e-09,-2.70507e-13,-38074.1,9.36868], Tmin=(830.592,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-312.516,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cd-Cd(CO)H) + group(Cds-O2d(Cds-Cds)O2s)"""),
)

species(
    label = 'CC=CCC(=O)O(2330)',
    structure = SMILES('CC=CCC(=O)O'),
    E0 = (-394.851,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
species(
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.53951,0.0586496,-5.57456e-05,4.33085e-08,-1.63094e-11,-11320.4,25.6947], Tmin=(100,'K'), Tmax=(734.084,'K')), NASAPolynomial(coeffs=[3.11804,0.0458579,-2.10453e-05,4.01921e-09,-2.80922e-13,-11439.2,19.3362], Tmin=(734.084,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-94.8241,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-CsCsCsH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdCsOs) + radical(Isobutyl) + radical(CCOJ)"""),
)
...
reaction(
    label = 'reaction5',
    reactants = ['CH3(18)', 'C=CCC([O])=O(2057)'],
    products = ['CC[CH]CC([O])=O(500)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction19',
    reactants = ['CH2(S)(24)', 'C[CH]CC([O])=O(556)'],
    products = ['CC[CH]CC([O])=O(500)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH]CC(84)', '[CH2]C([O])=O(1740)'],
    products = ['CC[CH]CC([O])=O(500)'],
...
reaction(
    label = 'reaction24',
    reactants = ['O(4)', 'CC[CH]C[C]=O(1877)'],
    products = ['CC[CH]CC([O])=O(500)'],
