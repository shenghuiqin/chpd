species(
    ...
    E0 = (377.472,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3010,987.5,1337.5,450,1655,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,281.401,1709.15],'cm^-1')),
        HinderedRotor(inertia=(0.00212993,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.111535,'amu*angstrom^2'), symmetry=1, barrier=(6.26794,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.111586,'amu*angstrom^2'), symmetry=1, barrier=(6.26796,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.111563,'amu*angstrom^2'), symmetry=1, barrier=(6.26797,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
species(
    label = '[CH]=CCC=CC(2505)',
    structure = SMILES('[CH]=CCC=CC'),
    E0 = (299.82,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3010,3025,975,987.5,1000,1300,1337.5,1375,400,450,500,1630,1655,1680,202.486],'cm^-1')),
        HinderedRotor(inertia=(0.388577,'amu*angstrom^2'), symmetry=1, barrier=(11.5943,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.359865,'amu*angstrom^2'), symmetry=1, barrier=(11.6044,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.391524,'amu*angstrom^2'), symmetry=1, barrier=(11.5931,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
species(
    label = '[CH]=CC=CCC(2506)',
    structure = SMILES('[CH]=CC=CCC'),
    E0 = (282.346,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3010,3025,975,987.5,1000,1300,1337.5,1375,400,450,500,1630,1655,1680,180],'cm^-1')),
        HinderedRotor(inertia=(0.736841,'amu*angstrom^2'), symmetry=1, barrier=(16.9414,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.736551,'amu*angstrom^2'), symmetry=1, barrier=(16.9348,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.736853,'amu*angstrom^2'), symmetry=1, barrier=(16.9417,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (81.1357,'amu'),
...
species(
    label = 'C#CC[CH]CC(2507)',
    structure = SMILES('C#CC[CH]CC'),
    E0 = (296.479,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,750,770,3400,2100,2175,525,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,180,1807.54],'cm^-1')),
        HinderedRotor(inertia=(0.144596,'amu*angstrom^2'), symmetry=1, barrier=(3.32455,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.14216,'amu*angstrom^2'), symmetry=1, barrier=(3.26853,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.142489,'amu*angstrom^2'), symmetry=1, barrier=(3.2761,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.85764,'amu*angstrom^2'), symmetry=1, barrier=(65.7028,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (81.1357,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.72739,0.052072,-3.82103e-05,1.89252e-08,-4.47983e-12,35738.3,23.1387], Tmin=(100,'K'), Tmax=(939.194,'K')), NASAPolynomial(coeffs=[5.064,0.0378616,-1.55147e-05,2.81533e-09,-1.91624e-13,35111.5,7.25081], Tmin=(939.194,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(296.479,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CtCsHH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(RCCJCC)"""),
)
...
species(
    ...
    molecularWeight = (82.1436,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.58457,0.0524453,-2.90832e-05,8.01019e-09,-9.13713e-13,45484.6,26.3683], Tmin=(100,'K'), Tmax=(1875.67,'K')), NASAPolynomial(coeffs=[11.0483,0.0322631,-1.29431e-05,2.27353e-09,-1.49094e-13,41934.5,-25.241], Tmin=(1875.67,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(377.46,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(RCCJC) + radical(Cds_P)"""),
)
...
species(
    label = '[CH]=CCCC[CH2](2509)',
    structure = SMILES('[CH]=CCCC[CH2]'),
    E0 = (388.26,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,180,803.565],'cm^-1')),
        HinderedRotor(inertia=(0.135045,'amu*angstrom^2'), symmetry=1, barrier=(3.10494,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.129261,'amu*angstrom^2'), symmetry=1, barrier=(2.97198,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.132341,'amu*angstrom^2'), symmetry=1, barrier=(3.04278,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.676864,'amu*angstrom^2'), symmetry=1, barrier=(15.5624,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (82.1436,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.924505,0.0584054,-3.73455e-05,1.20693e-08,-1.58148e-12,46815.4,27.8224], Tmin=(100,'K'), Tmax=(1759.63,'K')), NASAPolynomial(coeffs=[15.0124,0.0263809,-1.00462e-05,1.72652e-09,-1.12028e-13,41857.5,-48.1044], Tmin=(1759.63,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(388.26,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_P) + radical(RCCJ)"""),
)

species(
    label = '[CH]=[C]CCCC(2510)',
    structure = SMILES('[CH]=[C]CCCC'),
    E0 = (420.856,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2800,2850,1350,1500,750,1050,1375,1000,1685,370,311.449,311.498],'cm^-1')),
        HinderedRotor(inertia=(0.00173519,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.134874,'amu*angstrom^2'), symmetry=1, barrier=(9.30456,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.135493,'amu*angstrom^2'), symmetry=1, barrier=(9.30424,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.134974,'amu*angstrom^2'), symmetry=1, barrier=(9.30386,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (82.1436,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.26623,0.0578052,-3.76513e-05,1.27656e-08,-1.81465e-12,50717.1,25.2543], Tmin=(100,'K'), Tmax=(1568.95,'K')), NASAPolynomial(coeffs=[11.2905,0.0322489,-1.32183e-05,2.38384e-09,-1.60408e-13,47571.6,-27.622], Tmin=(1568.95,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(420.856,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_S) + radical(Cds_P)"""),
)

species(
    label = 'C=C[CH][CH]CC(2511)',
    ...
    molecularWeight = (82.1436,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.44247,0.0442315,9.44512e-06,-3.84923e-08,1.63444e-11,26115.5,22.4839], Tmin=(100,'K'), Tmax=(1019.33,'K')), NASAPolynomial(coeffs=[11.6914,0.0315515,-1.242e-05,2.31228e-09,-1.63786e-13,22595.5,-34.1753], Tmin=(1019.33,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(216.284,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Allyl_P) + radical(Allyl_S)"""),
)

species(
    label = 'C=CC[CH][CH]C(2512)',
    ...
    molecularWeight = (82.1436,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.41896,0.0435691,-1.65961e-05,1.84669e-09,7.85343e-14,39115.6,25.5241], Tmin=(100,'K'), Tmax=(2229.8,'K')), NASAPolynomial(coeffs=[18.1726,0.0243125,-9.69878e-06,1.59536e-09,-9.63128e-14,29851.8,-68.13], Tmin=(2229.8,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(324.822,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(RCCJC) + radical(RCCJCC)"""),
)

species(
    label = '[CH2]C[CH]CC=C(2513)',
    ...
    molecularWeight = (82.1436,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.79142,0.0492494,-2.42329e-05,5.42152e-09,-4.70612e-13,40444.5,26.8525], Tmin=(100,'K'), Tmax=(2628.46,'K')), NASAPolynomial(coeffs=[20.5879,0.0206452,-7.90932e-06,1.28135e-09,-7.68324e-14,30563.3,-81.9945], Tmin=(2628.46,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(335.622,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(RCCJ) + radical(RCCJCC)"""),
)
...
species(
    ...
    molecularWeight = (82.1436,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.53343,0.0442533,1.42877e-06,-2.63442e-08,1.12935e-11,6438.59,23.486], Tmin=(100,'K'), Tmax=(1054.99,'K')), NASAPolynomial(coeffs=[10.3549,0.0326291,-1.30708e-05,2.42483e-09,-1.69976e-13,3362.87,-25.3], Tmin=(1054.99,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(52.7242,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(369.994,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH)"""),
)
...
species(
    ...
    E0 = (401.24,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,180],'cm^-1')),
        HinderedRotor(inertia=(0.00457601,'amu*angstrom^2'), symmetry=1, barrier=(5.19673,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.225436,'amu*angstrom^2'), symmetry=1, barrier=(5.18321,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.225391,'amu*angstrom^2'), symmetry=1, barrier=(5.18218,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
species(
    label = '[CH]=CCC([CH2])C(2516)',
    structure = SMILES('[CH]=CCC([CH2])C'),
    E0 = (379.055,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,3120,650,792.5,1650,3010,987.5,1337.5,450,1655,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,258.93],'cm^-1')),
        HinderedRotor(inertia=(0.181081,'amu*angstrom^2'), symmetry=1, barrier=(4.30895,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0952005,'amu*angstrom^2'), symmetry=1, barrier=(4.46381,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00240759,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.443352,'amu*angstrom^2'), symmetry=1, barrier=(23.1912,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (82.1436,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.16285,0.0543376,-2.23381e-05,-6.72989e-09,5.98773e-12,45698.9,26.6552], Tmin=(100,'K'), Tmax=(1011.18,'K')), NASAPolynomial(coeffs=[11.3723,0.0303768,-1.11603e-05,1.96525e-09,-1.33806e-13,42794.5,-26.8655], Tmin=(1011.18,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(379.055,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_P) + radical(Isobutyl)"""),
)
...
reaction(
    label = 'reaction5',
    reactants = ['CH3(18)', '[CH]=CCC=C(2311)'],
    products = ['[CH]=CC[CH]CC(622)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction19',
    reactants = ['CH2(S)(24)', '[CH]=CC[CH]C(628)'],
    products = ['[CH]=CC[CH]CC(622)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH]CC(84)', '[CH]=C[CH2](1733)'],
    products = ['[CH]=CC[CH]CC(622)'],
