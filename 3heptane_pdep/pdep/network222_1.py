species(
    label = 'C=C([O])O[C]=O(453)',
    structure = SMILES('[CH2]C(=O)O[C]=O'),
    E0 = (-132.52,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,1855,455,950,364.782,364.797,364.798,2270.29,2270.32,4000],'cm^-1')),
        HinderedRotor(inertia=(0.30173,'amu*angstrom^2'), symmetry=1, barrier=(28.4922,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.114496,'amu*angstrom^2'), symmetry=1, barrier=(10.814,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.301677,'amu*angstrom^2'), symmetry=1, barrier=(28.492,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.0462,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.98997,0.0476176,-7.33379e-05,6.06197e-08,-1.98827e-11,-15869.3,22.61], Tmin=(100,'K'), Tmax=(810.445,'K')), NASAPolynomial(coeffs=[7.90579,0.0151866,-7.32957e-06,1.39926e-09,-9.64689e-14,-16722,-4.032], Tmin=(810.445,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-132.52,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(170.447,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-O2d)) + group(Cs-(Cds-O2d)HHH) + group(Cds-OdCsOs) + group(Cds-OdOsH) + radical(CJCO) + radical((O)CJOC)"""),
)
...
species(
    ...
    molecularWeight = (86.0462,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.72397,0.0395604,-3.76964e-05,1.90305e-08,-3.60591e-12,-1904.4,19.9017], Tmin=(100,'K'), Tmax=(1552.45,'K')), NASAPolynomial(coeffs=[9.96835,0.0101065,-1.30345e-06,-4.81676e-12,8.12635e-15,-3474.65,-20.3118], Tmin=(1552.45,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-16.5905,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-Cs(Cds-O2d)) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cds-OdOsH) + ring(Ethylene_oxide) + radical((O)CJOC) + radical(Cs_P)"""),
)
...
species(
    ...
    molecularWeight = (86.0462,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.07139,0.0106757,3.47795e-05,-5.07219e-08,1.92856e-11,-48605,17.498], Tmin=(100,'K'), Tmax=(989.816,'K')), NASAPolynomial(coeffs=[8.67131,0.0124785,-4.97923e-06,9.95048e-10,-7.54419e-14,-50910.5,-15.5071], Tmin=(989.816,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-404.475,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(182.918,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-O2d)) + group(Cs-(Cds-O2d)(Cds-O2d)HH) + group(Cds-OdCsOs) + group(Cds-OdCsOs) + ring(Cyclobutane)"""),
)
...
species(
    label = 'O=[C]O[C]=O(3465)',
    structure = SMILES('O=[C]O[C]=O'),
    E0 = (-91.7908,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1850,1860,440,470,900,1000,217.899],'cm^-1')),
        HinderedRotor(inertia=(0.366261,'amu*angstrom^2'), symmetry=1, barrier=(12.3332,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.366368,'amu*angstrom^2'), symmetry=1, barrier=(12.3334,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (72.0196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.47246,0.0374741,-6.98113e-05,6.12863e-08,-2.02076e-11,-10988.6,15.1735], Tmin=(100,'K'), Tmax=(882.864,'K')), NASAPolynomial(coeffs=[7.43584,0.00673308,-3.55935e-06,6.69641e-10,-4.43946e-14,-11543.3,-6.33194], Tmin=(882.864,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-91.7908,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(99.7737,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-O2d)) + group(Cds-OdOsH) + group(Cds-OdOsH) + radical((O)CJOC) + radical((O)CJOC)"""),
)

species(
    label = '[CH]=C(O)O[C]=O(3629)',
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.09135,'amu*angstrom^2'), symmetry=1, barrier=(25.0922,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.09124,'amu*angstrom^2'), symmetry=1, barrier=(25.0897,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.0462,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.19527,0.0631939,-9.46594e-05,6.7275e-08,-1.83235e-11,-837.412,18.0152], Tmin=(100,'K'), Tmax=(910.807,'K')), NASAPolynomial(coeffs=[13.7697,0.00796768,-3.70327e-06,6.96154e-10,-4.78408e-14,-3127.88,-41.4739], Tmin=(910.807,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-7.79146,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(170.447,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + group(Cds-OdOsH) + radical(Cds_P) + radical((O)CJOC)"""),
)

species(
    label = '[CH]=C([O])OC=O(3630)',
    ...
    molecularWeight = (86.0462,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.52742,0.0349298,-3.47206e-05,1.86385e-08,-4.20967e-12,-11055.3,21.7373], Tmin=(100,'K'), Tmax=(1038.26,'K')), NASAPolynomial(coeffs=[7.28172,0.0166135,-8.25866e-06,1.64737e-09,-1.18447e-13,-12042.5,-1.37796], Tmin=(1038.26,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-92.3422,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(170.447,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-O2d)) + group(Cs-(Cds-O2d)HHH) + group(Cds-OdCsOs) + group(Cds-OdOsH) + radical(CCJ2_triplet)"""),
)

species(
    label = '[O][C]1CC(=O)O1(3631)',
    ...
    molecularWeight = (86.0462,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.15528,0.0114333,3.10542e-05,-4.50405e-08,1.74513e-11,-7870.31,18.552], Tmin=(100,'K'), Tmax=(944.252,'K')), NASAPolynomial(coeffs=[6.20995,0.0164762,-5.52362e-06,9.53468e-10,-6.59903e-14,-9248.88,-0.254871], Tmin=(944.252,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-65.7444,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(182.918,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-(Cds-O2d)CsHH) + group(Cds-OdCsOs) + ring(Beta-Propiolactone) + radical(CCOJ) + radical(Cs_P)"""),
)
...
reaction(
    label = 'reaction8',
    reactants = ['CO(12)', '[CH2]C([O])=O(1740)'],
    products = ['C=C([O])O[C]=O(453)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[C]=O(261)', '[CH2]C([O])=O(1740)'],
    products = ['C=C([O])O[C]=O(453)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['CH2(T)(17)', 'O=[C]O[C]=O(3465)'],
    products = ['C=C([O])O[C]=O(453)'],
