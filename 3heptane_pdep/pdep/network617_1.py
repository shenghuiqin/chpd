...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.324044,0.0831744,-3.96308e-05,-1.98424e-09,5.47805e-12,9247.8,35.2946], Tmin=(100,'K'), Tmax=(1059.56,'K')), NASAPolynomial(coeffs=[15.1173,0.0462245,-1.75371e-05,3.1258e-09,-2.1327e-13,4777.49,-45.7482], Tmin=(1059.56,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(75.5117,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(532.126,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + longDistanceInteraction_noncyclic(CdCs-ST) + group(Cds-CdsHH) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]C(CCC)C(=C)C(1175)',
    ...
    molecularWeight = (111.205,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.579479,0.0888845,-5.97029e-05,2.1274e-08,-3.12688e-12,9120.08,35.56], Tmin=(100,'K'), Tmax=(1572.25,'K')), NASAPolynomial(coeffs=[17.4425,0.0430343,-1.59597e-05,2.72604e-09,-1.77611e-13,3453.05,-59.541], Tmin=(1572.25,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(74.3769,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(532.126,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + longDistanceInteraction_noncyclic(CdCs-ST) + group(Cds-CdsHH) + radical(Isobutyl)"""),
)
...
species(
    label = '[CH2]C(C=C)CCC(892)',
    structure = SMILES('[CH2]C(C=C)CCC'),
    E0 = (109.248,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3100,440,815,1455,1000,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.48919,0.0665057,-2.21728e-05,-1.28939e-08,8.46154e-12,13275.1,30.95], Tmin=(100,'K'), Tmax=(1032.93,'K')), NASAPolynomial(coeffs=[12.8267,0.0402028,-1.51601e-05,2.70646e-09,-1.85431e-13,9580.78,-34.5166], Tmin=(1032.93,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(109.248,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]C(C)[C](C)CCC(1176)',
    structure = SMILES('[CH2]C(C)[C](C)CCC'),
    E0 = (143.039,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.213,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.238684,0.0870937,-5.87111e-05,2.36325e-08,-4.41226e-12,17335.2,34.4433], Tmin=(100,'K'), Tmax=(1151.07,'K')), NASAPolynomial(coeffs=[7.39873,0.0622123,-2.62871e-05,4.85338e-09,-3.33607e-13,15686.8,-1.10712], Tmin=(1151.07,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(143.039,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(552.912,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Tertalkyl) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]C(CCC)[C](C)C(1177)',
    structure = SMILES('[CH2]C(CCC)[C](C)C'),
    E0 = (143.039,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.213,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.238684,0.0870937,-5.87111e-05,2.36325e-08,-4.41226e-12,17335.2,33.7501], Tmin=(100,'K'), Tmax=(1151.07,'K')), NASAPolynomial(coeffs=[7.39873,0.0622123,-2.62871e-05,4.85338e-09,-3.33607e-13,15686.8,-1.80027], Tmin=(1151.07,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(143.039,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(552.912,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Isobutyl) + radical(Tertalkyl)"""),
)

species(
    label = '[CH2][C](C)C(C)CCC(1178)',
    structure = SMILES('[CH2][C](C)C(C)CCC'),
    E0 = (143.039,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
species(
    ...
    molecularWeight = (112.213,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.44985,0.0874979,-5.33633e-05,1.67817e-08,-2.17865e-12,18469,38.3546], Tmin=(100,'K'), Tmax=(1737.48,'K')), NASAPolynomial(coeffs=[17.6383,0.0458565,-1.74141e-05,2.9883e-09,-1.94003e-13,12183.3,-58.9029], Tmin=(1737.48,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(152.158,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(552.912,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Cs_S) + radical(Isobutyl)"""),
)

species(
    label = '[CH2][C](CCC)C(C)C(1180)',
    structure = SMILES('[CH2][C](CCC)C(C)C'),
    E0 = (143.039,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
species(
    ...
    molecularWeight = (112.213,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.44985,0.0874979,-5.33633e-05,1.67817e-08,-2.17865e-12,18469,37.6615], Tmin=(100,'K'), Tmax=(1737.48,'K')), NASAPolynomial(coeffs=[17.6383,0.0458565,-1.74141e-05,2.9883e-09,-1.94003e-13,12183.3,-59.596], Tmin=(1737.48,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(152.158,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(552.912,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Cs_S) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]C([CH2])C(C)CCC(1182)',
    structure = SMILES('[CH2]C([CH2])C(C)CCC'),
    E0 = (162.698,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (112.213,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.568573,0.0900911,-5.4943e-05,1.39233e-08,-2.68169e-14,19741.3,37.2917], Tmin=(100,'K'), Tmax=(1097.42,'K')), NASAPolynomial(coeffs=[14.4816,0.0491891,-1.81105e-05,3.13525e-09,-2.08879e-13,15597.7,-40.5445], Tmin=(1097.42,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(162.698,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(552.912,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Isobutyl) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]C(C)C(C)C[CH]C(1183)',
    ...
    molecularWeight = (112.213,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.163119,0.0859452,-5.2318e-05,1.70337e-08,-2.35491e-12,18442.8,37.4827], Tmin=(100,'K'), Tmax=(1597.34,'K')), NASAPolynomial(coeffs=[13.6998,0.0512299,-1.9718e-05,3.4277e-09,-2.25407e-13,14014.1,-35.8903], Tmin=(1597.34,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(152.062,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(552.912,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Isobutyl) + radical(RCCJC)"""),
)

species(
    label = '[CH2]C(C[CH]C)C(C)C(1184)',
    ...
    molecularWeight = (112.213,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.163121,0.0859452,-5.2318e-05,1.70338e-08,-2.35491e-12,18442.8,36.7896], Tmin=(100,'K'), Tmax=(1597.33,'K')), NASAPolynomial(coeffs=[13.6998,0.05123,-1.9718e-05,3.4277e-09,-2.25407e-13,14014.1,-36.5832], Tmin=(1597.33,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(152.062,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(552.912,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJC) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]CCC(C)C([CH2])C(1185)',
    structure = SMILES('[CH2]CCC(C)C([CH2])C'),
    E0 = (162.862,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (112.213,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.799052,0.0917091,-6.01774e-05,2.08085e-08,-2.95872e-12,19772.1,38.8423], Tmin=(100,'K'), Tmax=(1625,'K')), NASAPolynomial(coeffs=[18.6077,0.0439385,-1.60814e-05,2.71773e-09,-1.7552e-13,13464.9,-64.2061], Tmin=(1625,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(162.862,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(552.912,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Isobutyl) + radical(RCCJ)"""),
)

species(
    label = '[CH2]CCC([CH2])C(C)C(1186)',
    structure = SMILES('[CH2]CCC([CH2])C(C)C'),
    E0 = (162.862,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (112.213,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.799052,0.0917091,-6.01774e-05,2.08085e-08,-2.95872e-12,19772.1,38.1491], Tmin=(100,'K'), Tmax=(1625,'K')), NASAPolynomial(coeffs=[18.6077,0.0439385,-1.60814e-05,2.71773e-09,-1.7552e-13,13464.9,-64.8993], Tmin=(1625,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(162.862,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(552.912,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJ) + radical(Isobutyl)"""),
)

species(
    label = 'C=C(CCC)C(C)C(1187)',
    ...
    molecularWeight = (112.213,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.342839,0.0814531,-2.67807e-05,-1.52652e-08,9.56877e-12,-15415.5,32.8901], Tmin=(100,'K'), Tmax=(1074.8,'K')), NASAPolynomial(coeffs=[15.585,0.0491815,-1.94317e-05,3.55419e-09,-2.4632e-13,-20399.2,-52.3578], Tmin=(1074.8,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-129.571,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(557.07,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + longDistanceInteraction_noncyclic(CdCs-ST) + group(Cds-CdsHH)"""),
)

species(
    label = 'C=C(C)C(C)CCC(1188)',
    structure = SMILES('C=C(C)C(C)CCC'),
    E0 = (-130.705,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.213,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.476603,0.0858608,-4.29084e-05,3.71301e-09,2.45711e-12,-15548.7,33.4033], Tmin=(100,'K'), Tmax=(1183.23,'K')), NASAPolynomial(coeffs=[15.644,0.0494617,-1.97077e-05,3.56786e-09,-2.43487e-13,-20630.4,-52.4352], Tmin=(1183.23,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-130.705,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(557.07,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + longDistanceInteraction_noncyclic(CdCs-ST) + group(Cds-CdsHH)"""),
)
...
species(
    label = '[CH2]C([CH]CC)CCC(1189)',
    structure = SMILES('[CH2]C([CH]CC)CCC'),
    E0 = (157.852,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.213,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.142884,0.0865654,-5.26266e-05,1.65984e-08,-2.19712e-12,19137.4,37.5097], Tmin=(100,'K'), Tmax=(1663.81,'K')), NASAPolynomial(coeffs=[14.9004,0.0503994,-2.00211e-05,3.53371e-09,-2.34031e-13,14131.6,-42.7239], Tmin=(1663.81,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(157.852,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(552.912,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Cs_S) + radical(Isobutyl)"""),
)

species(
    label = 'CCCC1CCC1C(807)',
    structure = SMILES('CCCC1CCC1C'),
    E0 = (-99.331,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.213,'amu'),
...
species(
    ...
    molecularWeight = (98.1861,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.377903,0.0730823,-4.26108e-05,1.27021e-08,-1.56913e-12,21980.8,33.4088], Tmin=(100,'K'), Tmax=(1793.01,'K')), NASAPolynomial(coeffs=[14.7747,0.0409644,-1.57414e-05,2.71154e-09,-1.76134e-13,16818.1,-44.4535], Tmin=(1793.01,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(181.633,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(482.239,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Cs_S) + radical(Isobutyl)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', '[CH2]C(C)C(=C)CCC(1174)'],
    products = ['[CH2]C(C)C([CH2])CCC(805)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', '[CH2]C(CCC)C(=C)C(1175)'],
    products = ['[CH2]C(C)C([CH2])CCC(805)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(0.0051739,'m^3/(mol*s)'), n=2.82163, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(303.03,'K'), Tmax=(2000,'K'), comment="""From training reaction 102 used for Cds-CsCs_Cds-HH;HJ
Exact match found for rate rule [Cds-CsCs_Cds-HH;HJ]
...
reaction(
    label = 'reaction5',
    reactants = ['npropyl(70)', '[CH2]C(C)C=C(838)'],
    products = ['[CH2]C(C)C([CH2])CCC(805)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['CH3(18)', '[CH2]C(C=C)CCC(892)'],
    products = ['[CH2]C(C)C([CH2])CCC(805)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]C(C)C([CH2])CCC(805)'],
    products = ['[CH2]C(C)C(C)[CH]CC(1179)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2]C(C)C([CH2])CCC(805)'],
    products = ['[CH2]C([CH]CC)C(C)C(1181)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]C([CH2])C(C)CCC(1182)'],
    products = ['[CH2]C(C)C([CH2])CCC(805)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]C(C)C([CH2])CCC(805)'],
    products = ['[CH2]C(C)C(C)C[CH]C(1183)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]C(C)C([CH2])CCC(805)'],
    products = ['[CH2]C(C[CH]C)C(C)C(1184)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]CCC(C)C([CH2])C(1185)'],
    products = ['[CH2]C(C)C([CH2])CCC(805)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2]CCC([CH2])C(C)C(1186)'],
    products = ['[CH2]C(C)C([CH2])CCC(805)'],
...
reaction(
    label = 'reaction22',
    reactants = ['CH2(S)(24)', '[CH2]CC([CH2])CCC(714)'],
    products = ['[CH2]C(C)C([CH2])CCC(805)'],
...
reaction(
    label = 'reaction23',
    reactants = ['CH2(S)(24)', '[CH2]C(C)C([CH2])CC(799)'],
    products = ['[CH2]C(C)C([CH2])CCC(805)'],
...
reaction(
    label = 'reaction29',
    reactants = ['CH2(T)(17)', '[CH2]C(C)[CH]CCC(1059)'],
    products = ['[CH2]C(C)C([CH2])CCC(805)'],
...
reaction(
    label = 'reaction30',
    reactants = ['[CH2]C([CH]C)CCC(894)', 'CH2(T)(17)'],
    products = ['[CH2]C(C)C([CH2])CCC(805)'],
