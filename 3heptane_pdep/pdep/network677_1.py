species(
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.538219,0.103719,-7.81467e-05,3.23616e-08,-5.80434e-12,-36399.1,36.09], Tmin=(100,'K'), Tmax=(1250.7,'K')), NASAPolynomial(coeffs=[12.7959,0.061074,-2.70008e-05,5.09906e-09,-3.54865e-13,-39734.4,-31.2222], Tmin=(1250.7,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-303.967,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(573.699,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['OH(5)', 'CCCCCCC[O](986)'],
    products = ['CCCCCCCOO(1032)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]CCCCCC(76)', 'HO2(10)'],
    products = ['CCCCCCCOO(1032)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['npropyl(70)', '[CH2]CCCOO(217)'],
    products = ['CCCCCCCOO(1032)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[CH2]CCCCOO(200)', 'C2H5(32)'],
    products = ['CCCCCCCOO(1032)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(8.73e+14,'cm^3/(mol*s)'), n=-0.699, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(200,'K'), Tmax=(2000,'K'), comment="""From training reaction 11 used for C_rad/H2/Cs;C_rad/H2/Cs
Exact match found for rate rule [C_rad/H2/Cs;C_rad/H2/Cs]
...
reaction(
    label = 'reaction6',
    reactants = ['H(3)', 'CC[CH]CCCCOO(976)'],
    products = ['CCCCCCCOO(1032)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['QOOH_1(211)', 'butyl_1(69)'],
    products = ['CCCCCCCOO(1032)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(8.73e+14,'cm^3/(mol*s)'), n=-0.699, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(200,'K'), Tmax=(2000,'K'), comment="""From training reaction 11 used for C_rad/H2/Cs;C_rad/H2/Cs
Exact match found for rate rule [C_rad/H2/Cs;C_rad/H2/Cs]
...
reaction(
    label = 'reaction8',
    reactants = ['H(3)', 'CCC[CH]CCCOO(975)'],
    products = ['CCCCCCCOO(1032)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(2e+13,'cm^3/(mol*s)','*|/',3.16), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), comment="""From training reaction 59 used for H_rad;C_rad/H/NonDeC
Exact match found for rate rule [C_rad/H/NonDeC;H_rad]
...
reaction(
    label = 'reaction9',
    reactants = ['CH2CH2OOH(55)', '[CH2]CCCC(71)'],
    products = ['CCCCCCCOO(1032)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(8.73e+14,'cm^3/(mol*s)'), n=-0.699, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(200,'K'), Tmax=(2000,'K'), comment="""From training reaction 11 used for C_rad/H2/Cs;C_rad/H2/Cs
Exact match found for rate rule [C_rad/H2/Cs;C_rad/H2/Cs]
...
reaction(
    label = 'reaction10',
    reactants = ['H(3)', 'CCCC[CH]CCOO(974)'],
    products = ['CCCCCCCOO(1032)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]CCCCC(74)', '[CH2]OO(239)'],
    products = ['CCCCCCCOO(1032)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(3)', 'CCCCC[CH]COO(973)'],
    products = ['CCCCCCCOO(1032)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CH3(18)', '[CH2]CCCCCOO(1024)'],
    products = ['CCCCCCCOO(1032)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(3)', 'C[CH]CCCCCOO(977)'],
    products = ['CCCCCCCOO(1032)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(3)', 'CCCCCC[CH]OO(972)'],
    products = ['CCCCCCCOO(1032)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(3)', '[CH2]CCCCCCOO(1861)'],
    products = ['CCCCCCCOO(1032)'],
...
network(
    ...
    reactants = [
        ('[CH2]CCCCCC(76)', 'HO2(10)'),
        ('H(3)', 'CCCCCCCO[O](971)'),
        ('QOOH_1(211)', 'butyl_1(69)'),
        ('H(3)', 'CCC[CH]CCCOO(975)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
