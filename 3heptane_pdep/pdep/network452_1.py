species(
    label = 'C=[C]OC(C)[O](663)',
    structure = SMILES('C=[C]OC(C)[O]'),
    E0 = (79.7113,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,2950,3100,1380,975,1025,1650,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,476.386,479.861,486.357,486.624],'cm^-1')),
        HinderedRotor(inertia=(0.0478364,'amu*angstrom^2'), symmetry=1, barrier=(2.17686,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.685386,'amu*angstrom^2'), symmetry=1, barrier=(15.875,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0986287,'amu*angstrom^2'), symmetry=1, barrier=(15.8929,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.47255,0.0511821,-4.15164e-05,1.7185e-08,-2.87283e-12,9681.58,24.9085], Tmin=(100,'K'), Tmax=(1413.67,'K')), NASAPolynomial(coeffs=[12.5243,0.0199106,-8.3347e-06,1.5367e-09,-1.05475e-13,6556.93,-32.2355], Tmin=(1413.67,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(79.7113,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CCOJ) + radical(C=CJO)"""),
)
...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.92789,0.0418917,-2.91008e-05,1.00732e-08,-1.41747e-12,-13191.6,22.0108], Tmin=(100,'K'), Tmax=(1632.01,'K')), NASAPolynomial(coeffs=[11.2787,0.0189729,-8.03562e-06,1.46809e-09,-9.92759e-14,-16243.7,-27.6817], Tmin=(1632.01,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-110.325,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-Cd)) + group(Cs-(Cds-O2d)HHH) + group(Cds-OdCsOs) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C=CJO)"""),
)

species(
    label = 'C#COC(C)[O](3042)',
    structure = SMILES('C#COC(C)[O]'),
    E0 = (49.2936,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2175,525,750,770,3400,2100,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,287.683,288.788,288.836],'cm^-1')),
        HinderedRotor(inertia=(0.405326,'amu*angstrom^2'), symmetry=1, barrier=(23.8503,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.403315,'amu*angstrom^2'), symmetry=1, barrier=(23.8512,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.404339,'amu*angstrom^2'), symmetry=1, barrier=(23.8581,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (85.0813,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.22169,0.0555526,-5.25065e-05,2.45274e-08,-4.50693e-12,6033.3,20.1369], Tmin=(100,'K'), Tmax=(1318.93,'K')), NASAPolynomial(coeffs=[14.6104,0.0149484,-6.32858e-06,1.18661e-09,-8.28012e-14,2501.49,-48.1624], Tmin=(1318.93,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(49.2936,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Ct-CtOs) + group(Ct-CtH) + radical(CCOJ)"""),
)
...
species(
    ...
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.12968,0.0549675,-4.13137e-05,7.5427e-09,2.87426e-12,7237.07,25.9618], Tmin=(100,'K'), Tmax=(980.783,'K')), NASAPolynomial(coeffs=[15.6059,0.0134553,-4.63125e-06,8.2941e-10,-5.89913e-14,3554.45,-47.8945], Tmin=(980.783,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(59.2526,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(Cs_P) + radical(C=CJO)"""),
)

species(
    label = '[CH]=COC(C)[O](3044)',
    structure = SMILES('[CH]=COC(C)[O]'),
    E0 = (87.0633,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,3010,987.5,1337.5,450,1655,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,325.051,325.055,325.153],'cm^-1')),
        HinderedRotor(inertia=(0.251364,'amu*angstrom^2'), symmetry=1, barrier=(18.847,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.251364,'amu*angstrom^2'), symmetry=1, barrier=(18.847,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.251363,'amu*angstrom^2'), symmetry=1, barrier=(18.847,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.13663,0.0536379,-3.41506e-05,2.91633e-10,5.10225e-12,10582.7,23.3849], Tmin=(100,'K'), Tmax=(996.726,'K')), NASAPolynomial(coeffs=[15.7423,0.0148021,-5.47126e-06,1.01833e-09,-7.3636e-14,6688.61,-51.9597], Tmin=(996.726,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(87.0633,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CCOJ) + radical(Cds_P)"""),
)
...
species(
    ...
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.05963,0.0552921,-3.72303e-05,2.10554e-09,4.81901e-12,6314.99,23.8916], Tmin=(100,'K'), Tmax=(989.676,'K')), NASAPolynomial(coeffs=[16.2633,0.0139417,-5.02046e-06,9.28694e-10,-6.73112e-14,2321.34,-54.2725], Tmin=(989.676,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(51.5562,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CCOJ) + radical(CJCO)"""),
)

species(
    label = '[CH]=[C]OC(C)O(3047)',
    structure = SMILES('[CH]=[C]OC(C)O'),
    E0 = (101.102,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,1685,370,2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1277.5,1000,1380,1390,370,380,2900,435,360.965,361.106],'cm^-1')),
        HinderedRotor(inertia=(0.161314,'amu*angstrom^2'), symmetry=1, barrier=(14.9025,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.16148,'amu*angstrom^2'), symmetry=1, barrier=(14.9037,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.161088,'amu*angstrom^2'), symmetry=1, barrier=(14.9021,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.161192,'amu*angstrom^2'), symmetry=1, barrier=(14.9018,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.01637,0.0577852,-4.7625e-05,1.28176e-08,1.32934e-12,12274.2,26.0836], Tmin=(100,'K'), Tmax=(977.732,'K')), NASAPolynomial(coeffs=[16.0716,0.0128843,-4.34703e-06,7.68872e-10,-5.43707e-14,8532.43,-50.2898], Tmin=(977.732,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(101.102,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C=CJO) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'C=[C]OC(C)=O(3041)'],
    products = ['C=[C]OC(C)[O](663)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['CH3(18)', 'C=[C]OC=O(3003)'],
    products = ['C=[C]OC(C)[O](663)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction14',
    reactants = ['CH2(S)(24)', 'C=[C]OC[O](576)'],
    products = ['C=[C]OC(C)[O](663)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H2CC(T)(265)', 'CC([O])[O](2817)'],
    products = ['C=[C]OC(C)[O](663)'],
