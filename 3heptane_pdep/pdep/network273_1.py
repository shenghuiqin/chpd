...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.36313,0.040999,-1.8471e-05,2.88325e-09,-1.05334e-13,-11325.7,18.5557], Tmin=(100,'K'), Tmax=(2658.82,'K')), NASAPolynomial(coeffs=[36.9579,0.00156549,-2.49063e-06,4.47586e-10,-2.4054e-14,-33116.3,-183.755], Tmin=(2658.82,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-94.1283,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cd-CdCs(CO)) + group(Cds-O2d(Cds-Cds)O2s) + group(Cds-CdsHH) + radical(CCOJ)"""),
)
...
species(
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.99546,0.0481279,-2.12318e-05,2.99786e-09,2.76225e-14,-17257,23.3201], Tmin=(100,'K'), Tmax=(2026.74,'K')), NASAPolynomial(coeffs=[18.1958,0.0254351,-1.13052e-05,1.99196e-09,-1.26985e-13,-25729.8,-70.9838], Tmin=(2026.74,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-144.052,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-(Cds-O2d)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdCsOs) + radical(CCJ(C)CO) + radical(CCOJ)"""),
)

species(
    label = 'C[CH]C(C)C([O])=O(2334)',
...
species(
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.386,0.0607248,-4.54768e-05,1.86182e-08,-3.32484e-12,-19061.7,25.6717], Tmin=(100,'K'), Tmax=(1244.63,'K')), NASAPolynomial(coeffs=[8.83288,0.0367916,-1.66326e-05,3.16807e-09,-2.21425e-13,-20915.4,-11.8847], Tmin=(1244.63,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-159.246,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-(Cds-O2d)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdCsOs) + radical(CCJ(C)CO) + radical(CJC(C)C=O)"""),
)

species(
    label = '[CH2]C([CH]C)C(=O)O(2336)',
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.21622,0.063216,-5.17663e-05,2.33902e-08,-4.51828e-12,-13362.1,27.8921], Tmin=(100,'K'), Tmax=(1187.09,'K')), NASAPolynomial(coeffs=[9.78691,0.0343363,-1.52742e-05,2.89634e-09,-2.02306e-13,-15397,-14.9265], Tmin=(1187.09,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-111.918,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-(Cds-O2d)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdCsOs) + radical(CJC(C)C=O) + radical(CCJCC=O)"""),
)

species(
    label = '[CH2]CC(C)C([O])=O(2337)',
...
species(
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.10272,0.0684404,-6.7465e-05,3.97868e-08,-1.01981e-11,-12717.5,27.6046], Tmin=(100,'K'), Tmax=(913.697,'K')), NASAPolynomial(coeffs=[8.04473,0.0380503,-1.75754e-05,3.38651e-09,-2.38735e-13,-13986.1,-5.26025], Tmin=(913.697,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-106.574,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-(Cds-O2d)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdCsOs) + radical(CJC(C)C=O) + radical(RCCJ)"""),
)

species(
    label = '[CH2]C(CC)[C]1OO1(2339)',
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.0474,0.0518238,-9.09183e-07,-4.40508e-08,2.37839e-11,32676.5,28.0489], Tmin=(100,'K'), Tmax=(910.286,'K')), NASAPolynomial(coeffs=[16.4295,0.0190996,-4.44245e-06,6.16894e-10,-4.03851e-14,28431.5,-52.6501], Tmin=(910.286,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(270.703,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(dioxirane) + radical(Isobutyl) + radical(Cs_P)"""),
)

species(
    label = 'CCC1CO[C]1[O](2340)',
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.66178,0.0442425,-1.04317e-06,-2.67926e-08,1.35041e-11,9447.84,24.7825], Tmin=(100,'K'), Tmax=(921.775,'K')), NASAPolynomial(coeffs=[8.81266,0.0316353,-1.05083e-05,1.73634e-09,-1.14307e-13,7346.84,-13.3795], Tmin=(921.775,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(77.799,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(349.208,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Oxetane) + radical(Cs_P) + radical(CCOJ)"""),
)

species(
    label = 'C=C(CC)C(=O)O(511)',
    structure = SMILES('C=C(CC)C(=O)O'),
    E0 = (-319.833,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.57897,0.05856,-5.08895e-05,2.86955e-08,-7.6305e-12,-38384.5,24.9497], Tmin=(100,'K'), Tmax=(846.969,'K')), NASAPolynomial(coeffs=[5.36873,0.0406621,-1.91922e-05,3.7461e-09,-2.66232e-13,-39026.4,7.29576], Tmin=(846.969,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-319.833,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cd-CdCs(CO)) + group(Cds-O2d(Cds-Cds)O2s) + group(Cds-CdsHH)"""),
)
...
species(
    label = '[CH2]C(C)C([O])=O(557)',
    structure = SMILES('[CH2]C(C)C([O])=O'),
    E0 = (-62.3345,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,180,180,180,704.553,704.607,704.714],'cm^-1')),
        HinderedRotor(inertia=(0.0101495,'amu*angstrom^2'), symmetry=1, barrier=(3.57517,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0101501,'amu*angstrom^2'), symmetry=1, barrier=(3.57546,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0101349,'amu*angstrom^2'), symmetry=1, barrier=(3.57182,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.8374,0.0532416,-6.76082e-05,6.27551e-08,-2.4814e-11,-7424.75,21.0855], Tmin=(100,'K'), Tmax=(773.415,'K')), NASAPolynomial(coeffs=[2.84197,0.0379819,-1.84938e-05,3.59461e-09,-2.52309e-13,-7279.13,18.4431], Tmin=(773.415,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-62.3345,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-(Cds-O2d)CsCsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdCsOs) + radical(CJC(C)C=O) + radical(CCOJ)"""),
)
...
species(
    ...
    opticalIsomers = 1,
    molecularWeight = (100.116,'amu'),
    collisionModel = TransportData(shapeIndex=2, epsilon=(4165.66,'J/mol'), sigma=(6.58732,'angstroms'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with Tc=650.67 K, Pc=33.07 bar (from Joback method)"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.27749,0.0477396,-2.22727e-05,3.9416e-09,-1.96754e-13,-10887.8,24.0178], Tmin=(100,'K'), Tmax=(2323.96,'K')), NASAPolynomial(coeffs=[24.2298,0.0180413,-8.32297e-06,1.43707e-09,-8.83879e-14,-23274.6,-105.099], Tmin=(2323.96,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-90.9629,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsOs) + radical(CCJCC=O) + radical(CCOJ)"""),
)

species(
    label = 'CCC1COC1=O(2341)',
...
species(
    label = '[CH2]C=C([O])OCC(2342)',
    structure = SMILES('[CH2]C=C([O])OCC'),
    E0 = (-85.7075,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2850,1437.5,1250,1305,750,350,350,440,435,1725,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,298.85,298.85,298.851,298.854],'cm^-1')),
        HinderedRotor(inertia=(0.343772,'amu*angstrom^2'), symmetry=1, barrier=(21.7869,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.343763,'amu*angstrom^2'), symmetry=1, barrier=(21.7869,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.343765,'amu*angstrom^2'), symmetry=1, barrier=(21.7869,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00188761,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.343571,0.0704095,-5.23135e-05,1.26291e-08,1.44751e-12,-10167.9,25.0923], Tmin=(100,'K'), Tmax=(1025.79,'K')), NASAPolynomial(coeffs=[17.4993,0.0219137,-8.30766e-06,1.51781e-09,-1.06669e-13,-14655.7,-62.8301], Tmin=(1025.79,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-85.7075,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsCs) + radical(C=COJ) + radical(Allyl_P)"""),
)
...
species(
    label = 'CC[CH]C([O])=O(1990)',
    structure = SMILES('CCC=C([O])[O]'),
    E0 = (-99.5259,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,350,440,435,1725,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,274.743,275.094,276.293],'cm^-1')),
        HinderedRotor(inertia=(0.00222777,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.310004,'amu*angstrom^2'), symmetry=1, barrier=(16.7544,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.45967,0.0487831,-3.32285e-05,8.4593e-09,1.32043e-13,-11872.8,21.6665], Tmin=(100,'K'), Tmax=(1120.9,'K')), NASAPolynomial(coeffs=[12.4208,0.0197755,-7.93679e-06,1.46182e-09,-1.01589e-13,-14965,-35.2983], Tmin=(1120.9,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-99.5259,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsCs) + radical(C=COJ) + radical(C=COJ)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(CC)C([O])=O(501)'],
    products = ['butene1(85)', 'CO2(13)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'C=C(CC)C([O])=O(2332)'],
    products = ['[CH2]C(CC)C([O])=O(501)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['C2H5(32)', 'tSPC_1553(456)'],
    products = ['[CH2]C(CC)C([O])=O(501)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['butene1(85)', '[O][C]=O(1735)'],
    products = ['[CH2]C(CC)C([O])=O(501)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]C(CC)C([O])=O(501)'],
    products = ['[CH2]C([CH]C)C(=O)O(2336)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]C(CC)C([O])=O(501)'],
    products = ['[CH2]CC([CH2])C(=O)O(2338)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2][CH]CC(87)', '[O][C]=O(1735)'],
    products = ['[CH2]C(CC)C([O])=O(501)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CH2(S)(24)', '[CH2]C(C)C([O])=O(557)'],
    products = ['[CH2]C(CC)C([O])=O(501)'],
...
reaction(
    label = 'reaction22',
    reactants = ['CH2(T)(17)', 'CC[CH]C([O])=O(1990)'],
    products = ['[CH2]C(CC)C([O])=O(501)'],
...
reaction(
    label = 'reaction23',
    reactants = ['O(4)', '[CH2]C([C]=O)CC(2343)'],
    products = ['[CH2]C(CC)C([O])=O(501)'],
