...
species(
    label = 'C=C(C[O])CCC(1453)',
    structure = SMILES('C=C(C[O])CCC'),
    E0 = (-6.7877,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2950,3100,1380,975,1025,1650,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,379.748,379.748,1335.48,1911.6],'cm^-1')),
        HinderedRotor(inertia=(0.0817238,'amu*angstrom^2'), symmetry=1, barrier=(8.36314,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0817239,'amu*angstrom^2'), symmetry=1, barrier=(8.36313,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0817242,'amu*angstrom^2'), symmetry=1, barrier=(8.36314,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0817239,'amu*angstrom^2'), symmetry=1, barrier=(8.36312,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (99.1509,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.68692,0.0590575,-3.1064e-05,7.57681e-09,-7.4477e-13,-742.513,25.9445], Tmin=(100,'K'), Tmax=(2094.67,'K')), NASAPolynomial(coeffs=[12.2277,0.0389287,-1.66495e-05,2.98912e-09,-1.97223e-13,-5158.37,-32.7023], Tmin=(2094.67,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-6.7877,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(415.724,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(CCOJ)"""),
)

species(
    label = '[CH2]C(C=O)CCC(1454)',
    structure = SMILES('[CH2]C(C=O)CCC'),
    E0 = (-69.9137,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2782.5,750,1395,475,1775,1000,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,258.345,258.633],'cm^-1')),
        HinderedRotor(inertia=(0.0025234,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00250921,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.182854,'amu*angstrom^2'), symmetry=1, barrier=(8.68594,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.182338,'amu*angstrom^2'), symmetry=1, barrier=(8.68522,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.182652,'amu*angstrom^2'), symmetry=1, barrier=(8.69005,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (99.1509,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.897254,0.0725354,-5.91259e-05,2.84699e-08,-6.10035e-12,-8300.56,27.4858], Tmin=(100,'K'), Tmax=(1057.15,'K')), NASAPolynomial(coeffs=[8.18472,0.0449614,-2.00012e-05,3.79688e-09,-2.65577e-13,-9841.36,-8.07708], Tmin=(1057.15,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-69.9137,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(CJC(C)C=O)"""),
)
...
species(
    ...
    molecularWeight = (100.159,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.19227,0.0626619,-3.18214e-05,7.28912e-09,-6.46694e-13,2612.46,27.6611], Tmin=(100,'K'), Tmax=(2572.52,'K')), NASAPolynomial(coeffs=[24.9613,0.0257043,-1.02725e-05,1.70486e-09,-1.04022e-13,-9617.08,-109.47], Tmin=(2572.52,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(20.8927,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJ(C)CO) + radical(CCOJ)"""),
)

species(
    label = '[CH2]C([CH]O)CCC(1456)',
    ...
    molecularWeight = (100.159,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.249063,0.0832959,-7.82818e-05,4.31195e-08,-9.98349e-12,3501.3,31.3161], Tmin=(100,'K'), Tmax=(1026.21,'K')), NASAPolynomial(coeffs=[11.0976,0.0410098,-1.64719e-05,2.96483e-09,-2.01108e-13,1274.76,-21.3021], Tmin=(1026.21,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(27.9939,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Isobutyl) + radical(CCsJOH)"""),
)

species(
    label = 'CC[CH]C(C)C[O](1457)',
    ...
    molecularWeight = (100.159,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.904,0.0597586,-2.9133e-05,6.11287e-09,-4.83991e-13,7621.15,27.3859], Tmin=(100,'K'), Tmax=(2992.41,'K')), NASAPolynomial(coeffs=[35.7668,0.0144933,-6.44275e-06,1.05775e-09,-6.16597e-14,-12644.9,-173.098], Tmin=(2992.41,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(62.861,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(Cs_S)"""),
)

species(
    label = 'CCCC(C)[CH][O](1458)',
    structure = SMILES('CCCC(C)[CH][O]'),
    E0 = (48.6167,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (100.159,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.791513,0.0762854,-6.79732e-05,4.12149e-08,-1.17559e-11,5957.71,28.4646], Tmin=(100,'K'), Tmax=(800.951,'K')), NASAPolynomial(coeffs=[5.49657,0.0527873,-2.39648e-05,4.58345e-09,-3.21721e-13,5204.03,6.80995], Tmin=(800.951,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(48.6167,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCsJOH) + radical(CCOJ)"""),
)

species(
    label = '[CH2][C](CO)CCC(1459)',
    structure = SMILES('[CH2][C](CO)CCC'),
    E0 = (0.269919,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (100.159,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.459499,0.0718199,-4.93548e-05,1.84803e-08,-2.90476e-12,164.726,31.2037], Tmin=(100,'K'), Tmax=(1457.54,'K')), NASAPolynomial(coeffs=[12.8195,0.0379,-1.44471e-05,2.51398e-09,-1.66204e-13,-3438.36,-33.083], Tmin=(1457.54,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(0.269919,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJ(C)CO) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]C([CH]CC)CO(1460)',
    structure = SMILES('[CH2]C([CH]CC)CO'),
    E0 = (42.2381,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3100,440,815,1455,1000,3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,1380,1390,370,380,2900,435,3615,1277.5,1000,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (100.159,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.791913,0.0723958,-5.52972e-05,2.50076e-08,-4.99927e-12,5193.98,32.3724], Tmin=(100,'K'), Tmax=(1132.88,'K')), NASAPolynomial(coeffs=[8.64079,0.0446827,-1.86033e-05,3.4143e-09,-2.34117e-13,3415.62,-6.4731], Tmin=(1132.88,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(42.2381,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Isobutyl) + radical(Cs_S)"""),
)

species(
    label = 'C[CH]CC(C)C[O](1461)',
    ...
    molecularWeight = (100.159,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.27827,0.0574756,-2.65172e-05,5.18585e-09,-3.76136e-13,7589.69,26.173], Tmin=(100,'K'), Tmax=(2962.35,'K')), NASAPolynomial(coeffs=[42.5729,0.00758419,-3.54192e-06,5.30146e-10,-2.66743e-14,-18265.9,-215.33], Tmin=(2962.35,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(62.7651,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(RCCJC)"""),
)

species(
    label = '[CH2]C(CO)C[CH]C(1462)',
    ...
    molecularWeight = (100.159,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.751,0.0743033,-6.46729e-05,3.67668e-08,-9.36948e-12,5183.05,32.7055], Tmin=(100,'K'), Tmax=(911.082,'K')), NASAPolynomial(coeffs=[7.04282,0.0466794,-1.91925e-05,3.48693e-09,-2.37403e-13,4036.59,2.93706], Tmin=(911.082,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(42.1423,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Isobutyl) + radical(RCCJC)"""),
)

species(
    label = '[CH2]CCC(C)C[O](1463)',
    ...
    molecularWeight = (100.159,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.3463,0.0657269,-3.97886e-05,1.31119e-08,-2.01791e-12,8936.79,28.6836], Tmin=(100,'K'), Tmax=(1275.88,'K')), NASAPolynomial(coeffs=[5.89001,0.051482,-2.30413e-05,4.36121e-09,-3.03259e-13,7777.35,5.65578], Tmin=(1275.88,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(73.5652,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(RCCJ)"""),
)

species(
    label = '[CH2]CCC([CH2])CO(1464)',
    ...
    molecularWeight = (100.159,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.473504,0.0763302,-6.14443e-05,2.84425e-08,-5.59864e-12,6495.43,32.7423], Tmin=(100,'K'), Tmax=(1182.37,'K')), NASAPolynomial(coeffs=[11.0334,0.0406053,-1.61219e-05,2.88779e-09,-1.95312e-13,3998.3,-19.9722], Tmin=(1182.37,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(52.9424,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJ) + radical(Isobutyl)"""),
)

species(
    label = 'C=C(CO)CCC(1465)',
    structure = SMILES('C=C(CO)CCC'),
    E0 = (-232.493,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (100.159,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.537031,0.0703846,-4.63039e-05,1.58712e-08,-2.25738e-12,-27833.3,29.2695], Tmin=(100,'K'), Tmax=(1594,'K')), NASAPolynomial(coeffs=[14.0053,0.0365863,-1.4498e-05,2.56856e-09,-1.70958e-13,-32126.9,-41.9863], Tmin=(1594,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-232.493,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH)"""),
)

species(
    label = 'CCCC(C)C=O(1466)',
    ...
    molecularWeight = (100.159,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.782161,0.0672955,-4.00229e-05,1.18618e-08,-1.4468e-12,-33609.3,27.5402], Tmin=(100,'K'), Tmax=(1807.27,'K')), NASAPolynomial(coeffs=[14.3249,0.0373214,-1.51449e-05,2.68478e-09,-1.77331e-13,-38504.3,-45.8105], Tmin=(1807.27,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-280.424,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdCsH)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'C=C(C[O])CCC(1453)'],
    products = ['[CH2]C(C[O])CCC(597)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', '[CH2]C(C=O)CCC(1454)'],
    products = ['[CH2]C(C[O])CCC(597)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['npropyl(70)', 'allyloxy(1251)'],
    products = ['[CH2]C(C[O])CCC(597)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction25',
    reactants = ['O(4)', '[CH2]C([CH2])CCC(904)'],
    products = ['[CH2]C(C[O])CCC(597)'],
