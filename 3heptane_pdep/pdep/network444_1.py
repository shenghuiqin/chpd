species(
    label = 'C=[C]OC[C]=O(655)',
    structure = SMILES('C=[C]OC[C]=O'),
    E0 = (142.319,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,2750,2850,1437.5,1250,1305,750,350,1855,455,950,2950,3100,1380,975,1025,1650,367.99,367.991,367.992],'cm^-1')),
        HinderedRotor(inertia=(0.200934,'amu*angstrom^2'), symmetry=1, barrier=(19.3082,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.200926,'amu*angstrom^2'), symmetry=1, barrier=(19.3081,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.200927,'amu*angstrom^2'), symmetry=1, barrier=(19.3081,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.0734,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.61323,0.0436488,-2.40371e-05,-6.99019e-09,7.59394e-12,17211,23.2671], Tmin=(100,'K'), Tmax=(967.128,'K')), NASAPolynomial(coeffs=[14.814,0.00960854,-3.12572e-06,5.73932e-10,-4.28528e-14,13696.2,-44.9483], Tmin=(967.128,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(142.319,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-O2d)OsHH) + group(Cds-CdsOsH) + group(Cds-OdCsH) + group(Cds-CdsHH) + radical(C=CJO) + radical(CsCJ=O)"""),
)
...
species(
    label = 'C=[C]OC=C=O(3453)',
    structure = SMILES('C=[C]OC=C=O'),
    E0 = (182.241,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,3100,1380,975,1025,1650,2120,512.5,787.5,3010,987.5,1337.5,450,1655,1685,370,310.423,310.438,310.44],'cm^-1')),
        HinderedRotor(inertia=(0.247736,'amu*angstrom^2'), symmetry=1, barrier=(16.9523,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.247914,'amu*angstrom^2'), symmetry=1, barrier=(16.9523,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (83.0654,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.83581,0.044507,-4.65403e-05,2.50014e-08,-5.27982e-12,21999.1,22.5996], Tmin=(100,'K'), Tmax=(1158.76,'K')), NASAPolynomial(coeffs=[11.2618,0.0119684,-4.41905e-06,7.67706e-10,-5.13933e-14,19814.6,-24.2643], Tmin=(1158.76,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(182.241,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cds-CdsOsH) + group(Cds-(Cdd-O2d)OsH) + group(Cds-CdsHH) + radical(C=CJO)"""),
)

species(
    label = 'C#COC[C]=O(3454)',
    structure = SMILES('C#COC[C]=O'),
    E0 = (111.902,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,750,770,3400,2100,1855,455,950,2175,525,180,180],'cm^-1')),
        HinderedRotor(inertia=(1.26472,'amu*angstrom^2'), symmetry=1, barrier=(29.0784,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.26469,'amu*angstrom^2'), symmetry=1, barrier=(29.0778,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.26152,'amu*angstrom^2'), symmetry=1, barrier=(29.0049,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (83.0654,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.40692,0.0474914,-3.31409e-05,-2.19473e-09,7.10298e-12,13560.7,18.3356], Tmin=(100,'K'), Tmax=(956.019,'K')), NASAPolynomial(coeffs=[17.1789,0.00421919,-8.9137e-07,1.72896e-10,-1.61321e-14,9506.83,-62.4756], Tmin=(956.019,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(111.902,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-O2d)OsHH) + group(Cds-OdCsH) + group(Ct-CtOs) + group(Ct-CtH) + radical(CsCJ=O)"""),
)
...
species(
    ...
    molecularWeight = (84.0734,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.59938,0.0401878,-4.28491e-06,-3.54582e-08,2.00895e-11,17204.2,24.0547], Tmin=(100,'K'), Tmax=(921.4,'K')), NASAPolynomial(coeffs=[17.409,0.00442154,4.3565e-07,-1.60506e-10,8.40336e-15,12895.7,-58.494], Tmin=(921.4,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(142.228,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C=CJO) + radical(C=COJ)"""),
)

species(
    label = '[CH]=COC[C]=O(3456)',
    structure = SMILES('[CH]=COC[C]=O'),
    E0 = (149.671,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,1855,455,950,180,180],'cm^-1')),
        HinderedRotor(inertia=(1.07246,'amu*angstrom^2'), symmetry=1, barrier=(24.6581,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.07115,'amu*angstrom^2'), symmetry=1, barrier=(24.6279,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.07199,'amu*angstrom^2'), symmetry=1, barrier=(24.6471,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.0734,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.33743,0.0453203,-1.34801e-05,-2.88325e-08,1.80932e-11,18109.4,21.5317], Tmin=(100,'K'), Tmax=(932.627,'K')), NASAPolynomial(coeffs=[19.13,0.00275851,6.92972e-07,-1.61928e-10,6.53068e-15,13322.8,-70.935], Tmin=(932.627,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(149.671,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-O2d)OsHH) + group(Cds-CdsOsH) + group(Cds-OdCsH) + group(Cds-CdsHH) + radical(Cds_P) + radical(CsCJ=O)"""),
)

species(
    label = 'C=CO[CH][C]=O(3457)',
    ...
    molecularWeight = (84.0734,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.04521,0.0511727,-2.35888e-05,-2.37961e-08,1.77205e-11,11725.8,21.6514], Tmin=(100,'K'), Tmax=(924.069,'K')), NASAPolynomial(coeffs=[21.3682,-0.000848029,2.49628e-06,-5.13016e-10,3.10301e-14,6434.85,-83.0958], Tmin=(924.069,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(96.5024,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-O2d)OsHH) + group(Cds-CdsOsH) + group(Cds-OdCsH) + group(Cds-CdsHH) + radical(CCsJOC(O)) + radical(CsCJ=O)"""),
)

species(
    label = '[CH]=[C]OCC=O(3458)',
    structure = SMILES('[CH]=[C]OCC=O'),
    E0 = (234.744,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,2750,2850,1437.5,1250,1305,750,350,2782.5,750,1395,475,1775,1000,1685,370,293.371,293.605],'cm^-1')),
        HinderedRotor(inertia=(0.309848,'amu*angstrom^2'), symmetry=1, barrier=(18.9807,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.308582,'amu*angstrom^2'), symmetry=1, barrier=(18.9801,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.309936,'amu*angstrom^2'), symmetry=1, barrier=(18.9772,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.0734,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.48639,0.0468387,-3.12815e-05,-9.33099e-10,5.83455e-12,28331.4,23.4468], Tmin=(100,'K'), Tmax=(962.599,'K')), NASAPolynomial(coeffs=[15.3343,0.00891774,-2.76824e-06,4.9701e-10,-3.69668e-14,24756.2,-47.556], Tmin=(962.599,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(234.744,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-O2d)OsHH) + group(Cds-CdsOsH) + group(Cds-OdCsH) + group(Cds-CdsHH) + radical(Cds_P) + radical(C=CJO)"""),
)

species(
    label = 'C=COC=C=O(3459)',
    structure = SMILES('C=COC=C=O'),
    E0 = (-57.5031,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (84.0734,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.64195,0.0425668,-1.90688e-05,-1.44394e-08,1.11602e-11,-6822.57,20.1667], Tmin=(100,'K'), Tmax=(933.429,'K')), NASAPolynomial(coeffs=[15.1385,0.00828253,-1.82271e-06,2.74644e-10,-2.05018e-14,-10368.2,-49.5128], Tmin=(933.429,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-57.5031,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cds-CdsOsH) + group(Cds-(Cdd-O2d)OsH) + group(Cds-CdsHH)"""),
)

species(
    label = 'C=C1OCC1=O(3460)',
    ...
    molecularWeight = (84.0734,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.25923,0.0180322,6.02627e-05,-9.83774e-08,4.03547e-11,-15747.1,14.1322], Tmin=(100,'K'), Tmax=(956.37,'K')), NASAPolynomial(coeffs=[17.2725,0.00626996,-1.32689e-06,3.48288e-10,-3.7212e-14,-20952.5,-69.8296], Tmin=(956.37,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-131.603,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(232.805,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-O2d)OsHH) + group(Cds-Cds(Cds-O2d)O2s) + group(Cds-O2d(Cds-Cds)Cs) + group(Cds-CdsHH) + ring(Cyclobutane)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'C=[C]OC=C=O(3453)'],
    products = ['C=[C]OC[C]=O(655)'],
    transitionState = 'TS2',
...
reaction(
    ...
    products = ['C=[C]OC[C]=O(655)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(11.6997,'m^3/(mol*s)'), n=2.021, Ea=(42.9524,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Od_R;YJ] for rate rule [Od_Cdd;CJ]
Euclidian distance = 1.41421356237
family: R_Addition_MultipleBond
Ea raised from 37.4 to 43.0 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction5',
    reactants = ['C=[C]OC[C]=O(655)'],
    products = ['C=[C]O[CH]C=O(3455)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction12',
    reactants = ['CO(12)', '[CH2]O[C]=C(1770)'],
    products = ['C=[C]OC[C]=O(655)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H2CC(T)(265)', '[O]C[C]=O(2962)'],
    products = ['C=[C]OC[C]=O(655)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[C]=O(261)', '[CH2]O[C]=C(1770)'],
    products = ['C=[C]OC[C]=O(655)'],
