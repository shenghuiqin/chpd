species(
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.95851,0.0414289,-2.74437e-05,9.49419e-09,-1.36273e-12,-9431.92,18.3292], Tmin=(100,'K'), Tmax=(1582.75,'K')), NASAPolynomial(coeffs=[9.88461,0.0213978,-8.45982e-06,1.49806e-09,-9.97237e-14,-11940.9,-23.5491], Tmin=(1582.75,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-79.0547,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), label="""ipropylperoxy""", comment="""Thermo library: DFT_QCI_thermo"""),
)
...
species(
    ...
    molecularWeight = (75.0865,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.40495,0.0423142,-1.21678e-05,-5.83231e-08,6.4144e-11,-3937.65,16.5973], Tmin=(100,'K'), Tmax=(465.103,'K')), NASAPolynomial(coeffs=[5.30546,0.0300772,-1.3687e-05,2.60087e-09,-1.8076e-13,-4344.91,3.34669], Tmin=(465.103,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-33.1547,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo library: DFT_QCI_thermo + radical(C2CsJOOH)"""),
)
...
reaction(
    label = 'reaction4',
    reactants = ['O2(2)', 'ipropyl(81)'],
    products = ['ipropylperoxy(385)'],
    transitionState = 'TS4',
...
This reaction matched rate rule [C_rad/H/NonDeC;O2_birad]
family: R_Recombination"""),
)

reaction(
    label = 'reaction5',
    reactants = ['C[CH]O[O](159)', 'CH3(18)'],
    products = ['ipropylperoxy(385)'],
    transitionState = 'TS5',
