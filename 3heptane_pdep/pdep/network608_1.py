...
species(
    label = 'CC=CC[CH]CC(1092)',
    structure = SMILES('CC=CC[CH]CC'),
    E0 = (94.3504,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2995,3025,975,1000,1300,1375,400,500,1630,1680,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3025,407.5,1350,352.5,200,800,1600],'cm^-1')),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.17635,0.0632238,-3.10354e-05,6.89249e-09,-5.91797e-13,11447.9,29.0838], Tmin=(100,'K'), Tmax=(2677.7,'K')), NASAPolynomial(coeffs=[26.9713,0.0246916,-9.45083e-06,1.5187e-09,-9.00914e-14,-2366.65,-120.77], Tmin=(2677.7,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(94.3504,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(RCCJCC)"""),
)

species(
    label = 'C[CH]CC=CCC(1093)',
    ...
    molecularWeight = (97.1781,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.665204,0.0651145,-3.17405e-05,5.97439e-09,-9.63802e-14,11609.6,31.7778], Tmin=(100,'K'), Tmax=(1529.27,'K')), NASAPolynomial(coeffs=[13.4993,0.0402464,-1.5883e-05,2.78202e-09,-1.82724e-13,6666.82,-38.9176], Tmin=(1529.27,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(95.4732,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(RCCJC)"""),
)

species(
    label = 'C[CH]CCC=CC(1094)',
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'CC=CC[CH]CC(1092)'],
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'C[CH]CC=CCC(1093)'],
    products = ['C[CH]CC[CH]CC(111)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(1.46e+08,'cm^3/(mol*s)'), n=1.64, Ea=(5.73208,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""From training reaction 2555 used for Cds-CsH_Cds-CsH;HJ
Exact match found for rate rule [Cds-CsH_Cds-CsH;HJ]
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', 'C[CH]CCC=CC(1094)'],
    products = ['C[CH]CC[CH]CC(111)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(1.46e+08,'cm^3/(mol*s)'), n=1.64, Ea=(5.73208,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""From training reaction 2555 used for Cds-CsH_Cds-CsH;HJ
Exact match found for rate rule [Cds-CsH_Cds-CsH;HJ]
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)', 'C=CCC[CH]CC(1095)'],
    products = ['C[CH]CC[CH]CC(111)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['CH3(18)', 'C=CCC[CH]C(283)'],
    products = ['C[CH]CC[CH]CC(111)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction22',
    reactants = ['CH2(S)(24)', 'C[CH]CC[CH]C(289)'],
    products = ['C[CH]CC[CH]CC(111)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[CH2]C(C)CC[CH]C(1060)'],
    products = ['C[CH]CC[CH]CC(111)'],
...
reaction(
    label = 'reaction27',
    reactants = ['CHCH3(T)(80)', '[CH2]C[CH]CC(92)'],
    products = ['C[CH]CC[CH]CC(111)'],
...
reaction(
    label = 'reaction28',
    reactants = ['[CH]CC(84)', '[CH2]C[CH]C(86)'],
    products = ['C[CH]CC[CH]CC(111)'],
