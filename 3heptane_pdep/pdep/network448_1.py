...
species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.302974,'amu*angstrom^2'), symmetry=1, barrier=(6.96597,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00829679,'amu*angstrom^2'), symmetry=1, barrier=(18.8285,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (69.0819,'amu'),
...
species(
    label = '[CH2][CH]CC=O(1722)',
    structure = SMILES('[CH2][CH]CC=O'),
    E0 = (178.045,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2850,1437.5,1250,1305,750,350,2782.5,750,1395,475,1775,1000,3025,407.5,1350,352.5,2113.91],'cm^-1')),
        HinderedRotor(inertia=(0.00228708,'amu*angstrom^2'), symmetry=1, barrier=(7.25307,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.03815,'amu*angstrom^2'), symmetry=1, barrier=(28.4255,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00426446,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (70.0898,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.45447,0.0334513,-1.78476e-05,4.44218e-09,-4.38458e-13,21469.5,21.4697], Tmin=(100,'K'), Tmax=(2242.12,'K')), NASAPolynomial(coeffs=[11.6167,0.0171055,-6.91203e-06,1.19059e-09,-7.58992e-14,17360.9,-30.1307], Tmin=(2242.12,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(178.045,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(CCJCC=O) + radical(RCCJ)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'C=CC[C]=O(1717)'],
    products = ['[CH2]CC[C]=O(659)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]C[CH2](83)', '[C]=O(261)'],
    products = ['[CH2]CC[C]=O(659)'],
