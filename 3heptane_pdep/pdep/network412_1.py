...
species(
    label = '[CH]=CC(=C)CCCC(3312)',
    structure = SMILES('[CH]=CC(=C)CCCC'),
    E0 = (233.221,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,350,440,435,1725,3120,650,792.5,1650,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'C#CC([CH2])CCCC(3313)',
    structure = SMILES('C#CC([CH2])CCCC'),
    E0 = (250.418,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3000,3100,440,815,1455,1000,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,2175,525,750,770,3400,2100,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (109.189,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.328817,0.0867947,-6.74003e-05,2.93326e-08,-5.28536e-12,30281.1,33.9393], Tmin=(100,'K'), Tmax=(1311.43,'K')), NASAPolynomial(coeffs=[14.8361,0.0405403,-1.44954e-05,2.43855e-09,-1.58546e-13,26303.5,-43.3345], Tmin=(1311.43,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(250.418,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(482.239,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CtCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(Isobutyl)"""),
)
...
species(
    ...
    molecularWeight = (110.197,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.290577,0.0869466,-5.17578e-05,1.53821e-08,-1.87814e-12,28005.7,33.6549], Tmin=(100,'K'), Tmax=(1820.36,'K')), NASAPolynomial(coeffs=[17.9969,0.0467623,-1.86453e-05,3.25536e-09,-2.12707e-13,21347.7,-65.5262], Tmin=(1820.36,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(231.522,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + radical(AllylJ2_triplet)"""),
)
...
species(
    ...
    molecularWeight = (110.197,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.124417,0.082395,-5.18004e-05,1.63295e-08,-2.10197e-12,38885.5,36.5936], Tmin=(100,'K'), Tmax=(1758.26,'K')), NASAPolynomial(coeffs=[18.1449,0.0408326,-1.63427e-05,2.88519e-09,-1.90377e-13,32461.1,-61.8551], Tmin=(1758.26,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(322.024,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cs_S) + radical(Cds_P)"""),
)

species(
    label = '[CH]=[C]C(C)CCCC(3316)',
    structure = SMILES('[CH]=[C]C(C)CCCC'),
    E0 = (365.323,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,1380,1390,370,380,2900,435,3120,650,792.5,1650,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    ...
    molecularWeight = (110.197,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.390494,0.0833945,-4.08099e-05,-1.67451e-09,5.29814e-12,19874.1,33.455], Tmin=(100,'K'), Tmax=(1090.75,'K')), NASAPolynomial(coeffs=[16.7691,0.043358,-1.72314e-05,3.15452e-09,-2.18516e-13,14769,-57.0626], Tmin=(1090.75,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(163.835,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + radical(Allyl_P) + radical(Allyl_P)"""),
)

species(
    label = '[CH2]C([CH]CCC)C=C(3318)',
    ...
    molecularWeight = (110.197,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.113649,0.0815702,-5.14754e-05,1.68411e-08,-2.27804e-12,33832.6,37.9298], Tmin=(100,'K'), Tmax=(1674.42,'K')), NASAPolynomial(coeffs=[16.3407,0.042263,-1.6263e-05,2.82148e-09,-1.84861e-13,28322.2,-49.935], Tmin=(1674.42,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(280.01,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Isobutyl) + radical(Cs_S)"""),
)

species(
    label = '[CH]=CC(C)C[CH]CC(3319)',
    ...
    molecularWeight = (110.197,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.417863,0.078875,-4.78879e-05,1.49925e-08,-1.99041e-12,38848.3,34.6225], Tmin=(100,'K'), Tmax=(1623.14,'K')), NASAPolynomial(coeffs=[12.5201,0.0490507,-2.03264e-05,3.67231e-09,-2.46855e-13,34919.5,-29.626], Tmin=(1623.14,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(321.94,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(RCCJCC) + radical(Cds_P)"""),
)

species(
    label = '[CH2]C(C=C)C[CH]CC(3320)',
    ...
    molecularWeight = (110.197,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.395048,0.0783517,-4.82793e-05,1.61026e-08,-2.32709e-12,33797.2,36.087], Tmin=(100,'K'), Tmax=(1498.32,'K')), NASAPolynomial(coeffs=[10.9077,0.0502863,-2.01823e-05,3.60094e-09,-2.41142e-13,30647,-18.8813], Tmin=(1498.32,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(279.926,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Isobutyl) + radical(RCCJCC)"""),
)

species(
    label = '[CH]=CC(C)CC[CH]C(3321)',
    ...
    molecularWeight = (110.197,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.16367,0.0808279,-5.07138e-05,1.65413e-08,-2.26609e-12,38859.3,35.7167], Tmin=(100,'K'), Tmax=(1614.84,'K')), NASAPolynomial(coeffs=[14.0535,0.0464227,-1.87554e-05,3.34773e-09,-2.2355e-13,34373.3,-37.9502], Tmin=(1614.84,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(321.928,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_P) + radical(RCCJC)"""),
)

species(
    label = '[CH2]C(C=C)CC[CH]C(3322)',
    ...
    molecularWeight = (110.197,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.15331,0.0801971,-5.08638e-05,1.74619e-08,-2.55491e-12,33807.5,37.1332], Tmin=(100,'K'), Tmax=(1519.58,'K')), NASAPolynomial(coeffs=[12.6323,0.0473489,-1.84391e-05,3.2367e-09,-2.14609e-13,30014.9,-28.2925], Tmin=(1519.58,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(279.914,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(RCCJC) + radical(Isobutyl)"""),
)

species(
    label = '[CH]=CC(C)CCC[CH2](3323)',
    ...
    molecularWeight = (110.197,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.47433,0.0866098,-5.86139e-05,2.03482e-08,-2.87811e-12,40188.7,37.0843], Tmin=(100,'K'), Tmax=(1636.98,'K')), NASAPolynomial(coeffs=[18.9428,0.0391633,-1.51375e-05,2.64217e-09,-1.74029e-13,33831.6,-66.162], Tmin=(1636.98,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(332.728,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_P) + radical(RCCJ)"""),
)

species(
    label = '[CH2]CCCC([CH2])C=C(3324)',
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', '[CH]=CC(=C)CCCC(3312)'],
    products = ['[CH]=CC([CH2])CCCC(627)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'C#CC([CH2])CCCC(3313)'],
    products = ['[CH]=CC([CH2])CCCC(627)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['butyl_1(69)', 'CH2CHCHCH(1725)'],
    products = ['[CH]=CC([CH2])CCCC(627)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction12',
    reactants = ['[CH]=CC([CH2])CCCC(627)'],
    products = ['[CH2]C([CH]CCC)C=C(3318)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH]=CC([CH2])CCCC(627)'],
    products = ['[CH2]C(C=C)C[CH]CC(3320)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH]=CC([CH2])CCCC(627)'],
    products = ['[CH2]C(C=C)CC[CH]C(3322)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH]=CC(C)CCC[CH2](3323)'],
    products = ['[CH]=CC([CH2])CCCC(627)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH]=CC([CH2])CCCC(627)'],
    products = ['[CH2]CCCC([CH2])C=C(3324)'],
...
reaction(
    label = 'reaction21',
    reactants = ['CH2(S)(24)', '[CH]=CC([CH2])CCC(625)'],
    products = ['[CH]=CC([CH2])CCCC(627)'],
...
reaction(
    label = 'reaction25',
    reactants = ['CH2(T)(17)', '[CH]=C[CH]CCCC(3289)'],
    products = ['[CH]=CC([CH2])CCCC(627)'],
