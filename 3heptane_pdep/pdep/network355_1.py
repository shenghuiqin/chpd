...
species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.34778,'amu*angstrom^2'), symmetry=1, barrier=(30.9881,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.34733,'amu*angstrom^2'), symmetry=1, barrier=(30.9777,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (55.0553,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.29726,0.0273104,-9.97283e-07,-3.00106e-08,1.68455e-11,30047.2,11.2126], Tmin=(100,'K'), Tmax=(914.816,'K')), NASAPolynomial(coeffs=[15.0391,-0.00160273,2.46714e-06,-5.1158e-10,3.26286e-14,26594.5,-55.2545], Tmin=(914.816,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(249.238,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(149.66,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-OsHHH) + group(Ct-CtOs) + group(Ct-CtH) + radical(CsJOCH3)"""),
)
...
species(
    ...
    E0 = (338.881,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,2750,2800,2850,1350,1500,750,1050,1375,1000,3120,650,792.5,1650,207.881],'cm^-1')),
        HinderedRotor(inertia=(0.500941,'amu*angstrom^2'), symmetry=1, barrier=(15.8883,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.499385,'amu*angstrom^2'), symmetry=1, barrier=(15.8901,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (56.0633,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.53115,0.0255659,-3.74201e-06,-1.83291e-08,1.04209e-11,40817.1,15.6578], Tmin=(100,'K'), Tmax=(927.161,'K')), NASAPolynomial(coeffs=[10.8839,0.0068575,-1.50749e-06,2.20872e-10,-1.59662e-14,38523.5,-28.0239], Tmin=(927.161,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(338.881,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-OsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(Cds_P) + radical(C=CJO)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'C#CO[CH2](3391)'],
    products = ['[CH]=CO[CH2](574)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction8',
    reactants = ['CH2(T)(17)', 'ketene(T)(262)'],
    products = ['[CH]=CO[CH2](574)'],
    transitionState = 'TS8',
