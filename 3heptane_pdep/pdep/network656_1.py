species(
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.77049,0.104279,-7.68135e-05,3.00291e-08,-4.94985e-12,-37907.7,36.5748], Tmin=(100,'K'), Tmax=(1376.17,'K')), NASAPolynomial(coeffs=[15.874,0.0558992,-2.4079e-05,4.48215e-09,-3.08803e-13,-42488.8,-49.0397], Tmin=(1376.17,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-316.61,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(573.699,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH)"""),
)
...
species(
    label = '[CH2]C(CC)OO(378)',
    structure = SMILES('[CH2]C(CC)OO'),
    E0 = (-31.3069,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,371.352],'cm^-1')),
        HinderedRotor(inertia=(0.0619251,'amu*angstrom^2'), symmetry=1, barrier=(6.05986,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0619244,'amu*angstrom^2'), symmetry=1, barrier=(6.05986,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0946455,'amu*angstrom^2'), symmetry=1, barrier=(9.26194,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.261452,'amu*angstrom^2'), symmetry=1, barrier=(25.5854,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.300344,'amu*angstrom^2'), symmetry=1, barrier=(29.3914,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (89.1131,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.01428,0.0636021,-5.1422e-05,2.20081e-08,-3.89367e-12,-3656.32,25.4357], Tmin=(100,'K'), Tmax=(1318.49,'K')), NASAPolynomial(coeffs=[12.2991,0.0293667,-1.24737e-05,2.31473e-09,-1.59616e-13,-6632.11,-32.1271], Tmin=(1318.49,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-31.3069,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJCOOH)"""),
)
...
species(
    ...
    molecularWeight = (103.14,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.591043,0.0750201,-5.79101e-05,2.39061e-08,-4.15845e-12,-7551.39,28.9885], Tmin=(100,'K'), Tmax=(1315.02,'K')), NASAPolynomial(coeffs=[12.3641,0.039209,-1.70615e-05,3.19731e-09,-2.21459e-13,-10647.7,-31.0336], Tmin=(1315.02,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-63.8033,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(407.409,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJ)"""),
)
...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.192142,0.0902595,-6.54523e-05,2.49397e-08,-3.98118e-12,-35067.3,32.256], Tmin=(100,'K'), Tmax=(1423.09,'K')), NASAPolynomial(coeffs=[15.0858,0.047317,-2.01894e-05,3.73588e-09,-2.56248e-13,-39415.7,-46.8418], Tmin=(1423.09,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-292.83,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH)"""),
)

species(
    label = 'CCCCC(C)OO(1218)',
...
reaction(
    label = 'reaction1',
    reactants = ['CCCCC([O])CC(195)', 'OH(5)'],
    products = ['CCCCC(CC)OO(226)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['CC[CH]CCCC(72)', 'HO2(10)'],
    products = ['CCCCC(CC)OO(226)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'CCCCC(CC)O[O](137)'],
    products = ['CCCCC(CC)OO(226)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CC[CH]OO(209)', 'butyl_1(69)'],
    products = ['CCCCC(CC)OO(226)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CCCC[CH]OO(196)', 'C2H5(32)'],
    products = ['CCCCC(CC)OO(226)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(1.15e+14,'cm^3/(mol*s)','*|/',2), n=-0.35, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2500,'K'), comment="""Estimated using template [C_rad/H/NonDe;C_rad/H2/Cs] for rate rule [C_rad/H/CsO;C_rad/H2/Cs]
Euclidian distance = 2.0
...
reaction(
    label = 'reaction6',
    reactants = ['H(3)', 'CCCC[C](CC)OO(175)'],
    products = ['CCCCC(CC)OO(226)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2]C(CC)OO(378)', 'npropyl(70)'],
    products = ['CCCCC(CC)OO(226)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(3)', 'CCC[CH]C(CC)OO(176)'],
    products = ['CCCCC(CC)OO(226)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['C2H5(32)', '[CH2]CC(CC)OO(1541)'],
    products = ['CCCCC(CC)OO(226)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(8.73e+14,'cm^3/(mol*s)'), n=-0.699, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(200,'K'), Tmax=(2000,'K'), comment="""From training reaction 11 used for C_rad/H2/Cs;C_rad/H2/Cs
Exact match found for rate rule [C_rad/H2/Cs;C_rad/H2/Cs]
...
reaction(
    label = 'reaction10',
    reactants = ['H(3)', 'CC[CH]CC(CC)OO(178)'],
    products = ['CCCCC(CC)OO(226)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CH3(18)', '[CH2]C(CCCC)OO(382)'],
    products = ['CCCCC(CC)OO(226)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(3)', 'C[CH]C(CCCC)OO(177)'],
    products = ['CCCCC(CC)OO(226)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CH3(18)', '[CH2]CCC(CC)OO(1542)'],
    products = ['CCCCC(CC)OO(226)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(3)', 'C[CH]CCC(CC)OO(180)'],
    products = ['CCCCC(CC)OO(226)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(3)', '[CH2]CCCC(CC)OO(181)'],
    products = ['CCCCC(CC)OO(226)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(3)', '[CH2]CC(CCCC)OO(179)'],
    products = ['CCCCC(CC)OO(226)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CH2(S)(24)', 'CCCC(CC)OO(1543)'],
    products = ['CCCCC(CC)OO(226)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CH2(S)(24)', 'CCCCC(C)OO(1218)'],
    products = ['CCCCC(CC)OO(226)'],
...
network(
    ...
    reactants = [
        ('CC[CH]CCCC(72)', 'HO2(10)'),
        ('H(3)', 'CCCCC(CC)O[O](137)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
