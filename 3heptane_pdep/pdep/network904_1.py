species(
    label = '[CH2]OO[CH]CCC(3853)',
    structure = SMILES('[CH2]OO[CH]CCC'),
    E0 = (147.335,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,350,500,795,815,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,200,800],'cm^-1')),
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.952891,0.0727926,-6.01548e-05,2.89693e-08,-6.25523e-12,17825.2,26.2681], Tmin=(100,'K'), Tmax=(1041.05,'K')), NASAPolynomial(coeffs=[7.95684,0.0458818,-2.13808e-05,4.13963e-09,-2.92645e-13,16366.9,-7.8038], Tmin=(1041.05,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(147.335,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(CCsJOOC) + radical(CsJOOC)"""),
)
...
species(
    label = '[CH2]OOC=CCC(3943)',
    structure = SMILES('[CH2]OOC=CCC'),
    E0 = (92.7014,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,350,500,795,815,2995,3025,975,1000,1300,1375,400,500,1630,1680,2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2850,1437.5,1250,1305,750,350,208.29],'cm^-1')),
        HinderedRotor(inertia=(0.00388573,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.222906,'amu*angstrom^2'), symmetry=1, barrier=(6.86291,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.04792,'amu*angstrom^2'), symmetry=1, barrier=(32.2612,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.650429,'amu*angstrom^2'), symmetry=1, barrier=(20.0271,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.04812,'amu*angstrom^2'), symmetry=1, barrier=(32.2611,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (101.124,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.399398,0.0683676,-5.0682e-05,1.88947e-08,-2.82256e-12,11288.1,28.8775], Tmin=(100,'K'), Tmax=(1582.09,'K')), NASAPolynomial(coeffs=[17.3381,0.0255413,-1.00778e-05,1.78476e-09,-1.1887e-13,5928.33,-60.6128], Tmin=(1582.09,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(92.7014,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(CsJOOC)"""),
)
...
species(
    label = '[CH2]OOC=C(2818)',
    structure = SMILES('[CH2]OOC=C'),
    E0 = (151.372,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,350,500,795,815,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650],'cm^-1')),
        HinderedRotor(inertia=(0.239834,'amu*angstrom^2'), symmetry=1, barrier=(25.9824,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.1301,'amu*angstrom^2'), symmetry=1, barrier=(25.9831,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2]OOC[CH]CC(3944)',
    structure = SMILES('[CH2]OOC[CH]CC'),
    E0 = (161.309,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,350,500,795,815,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,200,800],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (102.132,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.938299,0.0733065,-6.29015e-05,3.19686e-08,-7.29285e-12,19506.3,28.3336], Tmin=(100,'K'), Tmax=(993.019,'K')), NASAPolynomial(coeffs=[7.74241,0.045899,-2.15018e-05,4.17506e-09,-2.95713e-13,18155,-4.44468], Tmin=(993.019,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(161.309,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(CCJCOOH) + radical(CsJOOC)"""),
)

species(
    label = '[CH2]OOCC[CH]C(3945)',
    structure = SMILES('[CH2]OOCC[CH]C'),
    E0 = (155.341,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,350,500,795,815,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,200,800],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (102.132,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.48552,0.0647116,-2.69012e-05,-4.7177e-08,5.45815e-11,18764.3,26.9261], Tmin=(100,'K'), Tmax=(492.726,'K')), NASAPolynomial(coeffs=[5.00967,0.0498219,-2.33394e-05,4.51489e-09,-3.1862e-13,18250.5,10.7285], Tmin=(492.726,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(155.341,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(CsJOOC) + radical(RCCJC)"""),
)

species(
    label = '[CH2]CCCOO[CH2](3946)',
    structure = SMILES('[CH2]CCCOO[CH2]'),
    E0 = (166.141,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (102.132,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.959464,0.0720364,-5.80643e-05,2.64759e-08,-5.33548e-12,20087.2,27.7298], Tmin=(100,'K'), Tmax=(1114.02,'K')), NASAPolynomial(coeffs=[8.74907,0.044067,-2.04041e-05,3.93879e-09,-2.77859e-13,18351.7,-10.6916], Tmin=(1114.02,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(166.141,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(RCCJ) + radical(CsJOOC)"""),
)

species(
    label = 'CC[CH][CH]OOC(3947)',
    structure = SMILES('CC[CH][CH]OOC'),
    E0 = (154.153,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (102.132,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.43491,0.0668347,-2.77709e-05,-5.78625e-08,6.76663e-11,18622.2,27.2999], Tmin=(100,'K'), Tmax=(479.762,'K')), NASAPolynomial(coeffs=[5.3398,0.0499255,-2.38266e-05,4.63934e-09,-3.2818e-13,18067.4,9.45223], Tmin=(479.762,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(154.153,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(CCsJOOC) + radical(CCJCOOH)"""),
)

species(
    label = 'C[CH]C[CH]OOC(3948)',
    structure = SMILES('C[CH]C[CH]OOC'),
    E0 = (148.185,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (102.132,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.811018,0.0775609,-9.61785e-05,8.52676e-08,-3.23125e-11,17930.1,29.8009], Tmin=(100,'K'), Tmax=(783.735,'K')), NASAPolynomial(coeffs=[3.37908,0.0523343,-2.47006e-05,4.73499e-09,-3.2976e-13,17899.8,20.412], Tmin=(783.735,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(148.185,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(CCsJOOC) + radical(RCCJC)"""),
)

species(
    label = '[CH2]CC[CH]OOC(3949)',
    structure = SMILES('[CH2]CC[CH]OOC'),
    E0 = (158.985,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,350,500,795,815,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,200,800],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (102.132,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.870005,0.0751258,-7.49453e-05,4.9978e-08,-1.5307e-11,19228.5,28.6629], Tmin=(100,'K'), Tmax=(758.131,'K')), NASAPolynomial(coeffs=[5.82219,0.0489993,-2.32566e-05,4.5285e-09,-3.20775e-13,18477.6,6.14234], Tmin=(758.131,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(158.985,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(CCsJOOC) + radical(RCCJ)"""),
)
...
species(
    label = 'CCC=COOC(3950)',
    structure = SMILES('CCC=COOC'),
    E0 = (-100.895,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (102.132,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.523171,0.0671741,-4.55337e-05,1.54345e-08,-2.11343e-12,-12002.1,28.7383], Tmin=(100,'K'), Tmax=(1692.24,'K')), NASAPolynomial(coeffs=[16.7425,0.0288363,-1.15513e-05,2.04702e-09,-1.35674e-13,-17491.5,-58.0428], Tmin=(1692.24,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-100.895,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH)"""),
)
...
species(
    label = '[CH2]OO[CH]CC(3951)',
    structure = SMILES('[CH2]OO[CH]CC'),
    E0 = (171.115,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,350,500,795,815,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,2750,2850,1437.5,1250,1305,750,350,189.801],'cm^-1')),
        HinderedRotor(inertia=(0.240862,'amu*angstrom^2'), symmetry=1, barrier=(6.04714,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.81889,'amu*angstrom^2'), symmetry=1, barrier=(46.4653,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0162767,'amu*angstrom^2'), symmetry=1, barrier=(12.2832,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0195663,'amu*angstrom^2'), symmetry=1, barrier=(46.4618,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.8075,'amu*angstrom^2'), symmetry=1, barrier=(46.4591,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (88.1051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.57005,0.05837,-4.7619e-05,2.26413e-08,-4.86046e-12,20663.8,21.8061], Tmin=(100,'K'), Tmax=(1040.49,'K')), NASAPolynomial(coeffs=[6.98266,0.0375616,-1.76206e-05,3.42026e-09,-2.42096e-13,19537.5,-4.52134], Tmin=(1040.49,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(171.115,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(CsJOOC) + radical(CCsJOOC)"""),
)

species(
    label = '[CH2]OOC([CH2])CC(3952)',
    structure = SMILES('[CH2]OOC([CH2])CC'),
    E0 = (162.214,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,350,500,795,815,2750,2800,2850,1350,1500,750,1050,1375,1000,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,200],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (102.132,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.634665,0.0745582,-5.97744e-05,2.544e-08,-4.54253e-12,19630.3,28.7489], Tmin=(100,'K'), Tmax=(1288.2,'K')), NASAPolynomial(coeffs=[12.5342,0.0376086,-1.67494e-05,3.17365e-09,-2.21287e-13,16564.5,-31.6729], Tmin=(1288.2,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(162.214,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(CJCOOH) + radical(CsJOOC)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', '[CH2]OOC=CCC(3943)'],
    products = ['[CH2]OO[CH]CCC(3853)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['C2H5(32)', '[CH2]OOC=C(2818)'],
    products = ['[CH2]OO[CH]CCC(3853)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction12',
    reactants = ['CH2(S)(24)', '[CH2]OO[CH]CC(3951)'],
    products = ['[CH2]OO[CH]CCC(3853)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]O[O](203)', '[CH]CCC(90)'],
    products = ['[CH2]OO[CH]CCC(3853)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CCC[CH]O[O](143)', 'CH2(T)(17)'],
    products = ['[CH2]OO[CH]CCC(3853)'],
