...
species(
    label = 'CCCC(=O)CC1CO1(3407)',
    structure = SMILES('CCCC(=O)CC1CO1'),
    E0 = (-314.078,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,375,552.5,462.5,1710,2750,2950,3150,900,1000,1100,2750,2800,2850,1350,1500,750,1050,1375,1000,300,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.311917,0.0953285,-9.22832e-05,5.5182e-08,-1.39377e-11,-37620.1,31.6816], Tmin=(100,'K'), Tmax=(947.16,'K')), NASAPolynomial(coeffs=[10.7381,0.0486629,-1.838e-05,3.16496e-09,-2.08031e-13,-39713.3,-21.0285], Tmin=(947.16,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-314.078,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(486.397,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdCsCs) + ring(Ethylene_oxide)"""),
)
...
species(
    ...
    molecularWeight = (128.169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.635015,0.0974418,-9.09622e-05,4.94403e-08,-1.10365e-11,4914.67,35.6499], Tmin=(100,'K'), Tmax=(1080.14,'K')), NASAPolynomial(coeffs=[14.1764,0.0425913,-1.47903e-05,2.42632e-09,-1.5501e-13,1715.01,-36.9485], Tmin=(1080.14,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(39.4436,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(486.397,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(C2CsJO) + radical(CC(C)OJ)"""),
)
...
species(
    label = 'CCCC([O])[CH]C1CO1(3410)',
    structure = SMILES('CCCC([O])[CH]C1CO1'),
    E0 = (59.2409,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2950,3150,900,1000,1100,1380,1390,370,380,2900,435,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (128.169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.342745,0.084961,-4.32731e-05,-9.46843e-09,1.2481e-11,7291.19,35.9877], Tmin=(100,'K'), Tmax=(910.08,'K')), NASAPolynomial(coeffs=[17.0687,0.0370632,-1.15146e-05,1.8335e-09,-1.18981e-13,2936.43,-52.8856], Tmin=(910.08,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(59.2409,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(486.397,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CC(C)OJ) + radical(CCJCO)"""),
)

species(
    label = '[O][CH]CC1CO1(3411)',
    structure = SMILES('[O][CH]CC1CO1'),
    E0 = (118.965,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2950,3150,900,1000,1100,3025,407.5,1350,352.5,279.691,971.418,971.418,971.418,971.418,971.418,971.418,971.418,971.418,971.418,2377.77],'cm^-1')),
    ...
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.46697,0.0564386,-6.52439e-05,4.56537e-08,-1.26428e-11,14398.7,21.2046], Tmin=(100,'K'), Tmax=(1032.52,'K')), NASAPolynomial(coeffs=[7.56629,0.0248734,-7.85795e-06,1.15714e-09,-6.66062e-14,13562.2,-6.3677], Tmin=(1032.52,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(118.965,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + ring(Ethylene_oxide) + radical(CCOJ) + radical(CCsJOH)"""),
)

species(
    label = 'CCC[C]([O])CC1CO1(3412)',
    structure = SMILES('CCC[C]([O])CC1CO1'),
    E0 = (35.9667,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([360,370,350,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2950,3150,900,1000,1100,2750,2800,2850,1350,1500,750,1050,1375,1000,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (128.169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.65622,0.098482,-8.74125e-05,4.02132e-08,-6.09374e-12,4497.1,34.0417], Tmin=(100,'K'), Tmax=(895.334,'K')), NASAPolynomial(coeffs=[15.0613,0.0415525,-1.43015e-05,2.35393e-09,-1.51828e-13,1149.92,-43.0235], Tmin=(895.334,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(35.9667,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(486.397,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(C2CsJOH) + radical(CC(C)OJ)"""),
)
...
species(
    label = '[CH2]C([O])CC1CO1(3413)',
    structure = SMILES('[CH2]C([O])CC1CO1'),
    E0 = (118.488,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2850,1437.5,1250,1305,750,350,2750,2950,3150,900,1000,1100,1380,1390,370,380,2900,435,180,998.57,998.57,998.57,998.57,998.57,998.57,998.57,998.57,998.57,2321.85],'cm^-1')),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0436832,0.0724287,-6.73205e-05,3.36673e-08,-6.46825e-12,14405.8,28.2442], Tmin=(100,'K'), Tmax=(1466.53,'K')), NASAPolynomial(coeffs=[15.3633,0.0207416,-4.32538e-06,4.26224e-10,-1.67635e-14,10977.3,-47.8994], Tmin=(1466.53,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(118.488,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CJCO) + radical(CC(C)OJ)"""),
)

species(
    label = 'CC[CH]C([O])CC1CO1(3414)',
...
species(
    label = '[CH2]CC([O])CC1CO1(3415)',
    structure = SMILES('[CH2]CC([O])CC1CO1'),
    E0 = (88.3655,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2950,3150,900,1000,1100,1380,1390,370,380,2900,435,300,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.416868,0.0827452,-7.15739e-05,3.40662e-08,-6.40305e-12,10799.2,33.2989], Tmin=(100,'K'), Tmax=(1427.28,'K')), NASAPolynomial(coeffs=[16.5554,0.0286291,-7.81609e-06,1.06998e-09,-6.0218e-14,6621.58,-52.2833], Tmin=(1427.28,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(88.3655,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(415.724,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CC(C)OJ) + radical(RCCJ)"""),
)

species(
    label = 'C[CH]CC([O])CC1CO1(3416)',
    ...
    molecularWeight = (128.169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.271862,0.089586,-6.85398e-05,2.49785e-08,-1.61173e-12,6626.73,35.9732], Tmin=(100,'K'), Tmax=(896.14,'K')), NASAPolynomial(coeffs=[13.1096,0.0437444,-1.50545e-05,2.48283e-09,-1.60539e-13,3670.74,-30.2288], Tmin=(896.14,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(53.7851,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(486.397,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CC(C)OJ) + radical(RCCJC)"""),
)

species(
    label = 'CCCC([O])CC1[CH]O1(3417)',
    ...
    molecularWeight = (128.169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.4866,0.102522,-9.17168e-05,4.39317e-08,-8.24225e-12,5392.05,37.8013], Tmin=(100,'K'), Tmax=(1424.83,'K')), NASAPolynomial(coeffs=[21.0906,0.031339,-8.5658e-06,1.18344e-09,-6.74502e-14,-249.834,-76.3355], Tmin=(1424.83,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(43.0612,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(486.397,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CC(C)OJ) + radical(CCsJO)"""),
)

species(
    label = '[CH2]CCC([O])CC1CO1(3418)',
    structure = SMILES('[CH2]CCC([O])CC1CO1'),
    E0 = (64.5852,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2950,3150,900,1000,1100,1380,1390,370,380,2900,435,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (128.169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.02031,0.0970415,-8.37928e-05,4.00926e-08,-7.69501e-12,7959.87,37.7088], Tmin=(100,'K'), Tmax=(1323.1,'K')), NASAPolynomial(coeffs=[18.1665,0.0359474,-1.10289e-05,1.6649e-09,-1.00734e-13,3153,-59.2067], Tmin=(1323.1,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(64.5852,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(486.397,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(RCCJ) + radical(CC(C)OJ)"""),
)
...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.198278,0.0743029,-3.40329e-05,-1.36267e-08,1.33501e-11,-13911.9,29.3062], Tmin=(100,'K'), Tmax=(896.199,'K')), NASAPolynomial(coeffs=[15.2963,0.033444,-1.00464e-05,1.55896e-09,-9.96023e-14,-17683.4,-47.8217], Tmin=(896.199,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-116.881,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(440.667,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CC(C)OJ)"""),
)

species(
    label = 'CCC[C](O)CC1CO1(3420)',
    structure = SMILES('CCC[C](O)CC1CO1'),
    E0 = (-194.394,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
species(
    label = 'CCCC(O)[CH]C1CO1(3421)',
    structure = SMILES('CCCC(O)[CH]C1CO1'),
    E0 = (-171.12,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2950,3150,900,1000,1100,3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,1380,1390,370,380,2900,435,3615,1277.5,1000,300,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (129.177,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.495006,0.0888221,-4.86722e-05,-5.1608e-09,1.12212e-11,-20409.8,36.7266], Tmin=(100,'K'), Tmax=(905.381,'K')), NASAPolynomial(coeffs=[17.1162,0.038887,-1.21186e-05,1.92534e-09,-1.24331e-13,-24741.1,-52.7956], Tmin=(905.381,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-171.12,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CCJCO)"""),
)

species(
    label = 'CC[CH]C(O)CC1CO1(3422)',
    structure = SMILES('CC[CH]C(O)CC1CO1'),
    E0 = (-171.12,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2950,3150,900,1000,1100,3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,1380,1390,370,380,2900,435,3615,1277.5,1000,300,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
...
species(
    ...
    molecularWeight = (129.177,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.782126,0.101249,-9.62115e-05,5.36261e-08,-1.22838e-11,-22786.5,36.37], Tmin=(100,'K'), Tmax=(1053.71,'K')), NASAPolynomial(coeffs=[14.1632,0.0445159,-1.54515e-05,2.5315e-09,-1.61456e-13,-25936.2,-36.5147], Tmin=(1053.71,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-190.917,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(C2CsJO)"""),
)

species(
    label = 'C[CH]CC(O)CC1CO1(3424)',
    structure = SMILES('C[CH]CC(O)CC1CO1'),
    E0 = (-176.576,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (129.177,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.402526,0.0931704,-7.28602e-05,2.77092e-08,-2.10991e-12,-21075.2,36.6361], Tmin=(100,'K'), Tmax=(877.401,'K')), NASAPolynomial(coeffs=[13.1122,0.0456486,-1.57066e-05,2.58631e-09,-1.66873e-13,-23989.1,-29.8878], Tmin=(877.401,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-176.576,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(RCCJC)"""),
)

species(
    label = 'CCCC(O)CC1[CH]O1(3425)',
    structure = SMILES('CCCC(O)CC1[CH]O1'),
    E0 = (-187.3,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
species(
    ...
    molecularWeight = (129.177,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.1337,0.100483,-8.79e-05,4.29726e-08,-8.45294e-12,-19742.9,38.3056], Tmin=(100,'K'), Tmax=(1278.6,'K')), NASAPolynomial(coeffs=[18.0465,0.0380382,-1.17795e-05,1.7901e-09,-1.0877e-13,-24448.1,-58.1616], Tmin=(1278.6,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-165.776,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(RCCJ)"""),
)

species(
    label = 'CCCC([O])CC=O(3427)',
    ...
    molecularWeight = (115.15,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.678028,0.0774291,-5.99104e-05,2.61739e-08,-5.03383e-12,-25956,30.2193], Tmin=(100,'K'), Tmax=(1164.42,'K')), NASAPolynomial(coeffs=[9.41136,0.0474283,-2.12633e-05,4.04711e-09,-2.83203e-13,-27989.8,-13.2434], Tmin=(1164.42,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-216.774,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(CC(C)OJ)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['H(3)', 'CCCC(=O)CC1CO1(3407)'],
    products = ['CCCC([O])CC1CO1(2393)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['CCCC=O(1351)', 'oxiranylmethyl(1847)'],
    products = ['CCCC([O])CC1CO1(2393)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['npropyl(70)', 'O=CCC1CO1(3408)'],
    products = ['CCCC([O])CC1CO1(2393)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(7.94e+10,'cm^3/(mol*s)'), n=0, Ea=(28.0328,'kJ/mol'), T0=(1,'K'), Tmin=(333,'K'), Tmax=(363,'K'), comment="""Estimated using template [CO_O;CsJ-CsHH] for rate rule [CO-CsH_O;CsJ-CsHH]
Euclidian distance = 2.0
...
reaction(
    label = 'reaction4',
    reactants = ['cC2H3O(51)', '[CH2]C([O])CCC(1410)'],
    products = ['CCCC([O])CC1CO1(2393)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)', 'CCCC([O])C[C]1CO1(3409)'],
    products = ['CCCC([O])CC1CO1(2393)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['CCC[CH][O](1347)', 'oxiranylmethyl(1847)'],
    products = ['CCCC([O])CC1CO1(2393)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(3)', 'CCCC([O])[CH]C1CO1(3410)'],
    products = ['CCCC([O])CC1CO1(2393)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['npropyl(70)', '[O][CH]CC1CO1(3411)'],
    products = ['CCCC([O])CC1CO1(2393)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(3)', 'CCC[C]([O])CC1CO1(3412)'],
    products = ['CCCC([O])CC1CO1(2393)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['C2H5(32)', '[CH2]C([O])CC1CO1(3413)'],
    products = ['CCCC([O])CC1CO1(2393)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(3)', 'CC[CH]C([O])CC1CO1(3414)'],
    products = ['CCCC([O])CC1CO1(2393)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CH3(18)', '[CH2]CC([O])CC1CO1(3415)'],
    products = ['CCCC([O])CC1CO1(2393)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(3)', 'C[CH]CC([O])CC1CO1(3416)'],
    products = ['CCCC([O])CC1CO1(2393)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(3)', 'CCCC([O])CC1[CH]O1(3417)'],
    products = ['CCCC([O])CC1CO1(2393)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(3)', '[CH2]CCC([O])CC1CO1(3418)'],
    products = ['CCCC([O])CC1CO1(2393)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CH2(S)(24)', 'CCC([O])CC1CO1(3419)'],
    products = ['CCCC([O])CC1CO1(2393)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CCCC([O])CC1CO1(2393)'],
    products = ['CCC[C](O)CC1CO1(3420)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CCCC(O)[CH]C1CO1(3421)'],
    products = ['CCCC([O])CC1CO1(2393)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CC[CH]C(O)CC1CO1(3422)'],
    products = ['CCCC([O])CC1CO1(2393)'],
...
reaction(
    label = 'reaction21',
    reactants = ['CCCC([O])CC1CO1(2393)'],
    products = ['C[CH]CC(O)CC1CO1(3424)'],
...
reaction(
    label = 'reaction22',
    reactants = ['CCCC([O])CC1CO1(2393)'],
    products = ['CCCC(O)CC1[CH]O1(3425)'],
...
reaction(
    label = 'reaction23',
    reactants = ['CCCC([O])CC1CO1(2393)'],
    products = ['[CH2]CCC(O)CC1CO1(3426)'],
...
reaction(
    label = 'reaction24',
    reactants = ['CH2(S)(24)', 'CCCC([O])CC=O(3427)'],
    products = ['CCCC([O])CC1CO1(2393)'],
...
reaction(
    label = 'reaction25',
    reactants = ['O(S)(1856)', 'C=CCC([O])CCC(3428)'],
    products = ['CCCC([O])CC1CO1(2393)'],
...
reaction(
    label = 'reaction26',
    reactants = ['O(4)', 'CCC[CH]CC1CO1(2394)'],
    products = ['CCCC([O])CC1CO1(2393)'],
