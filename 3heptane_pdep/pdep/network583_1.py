...
species(
    label = 'C[CH]CC(C)=O(1699)',
    structure = SMILES('C[CH]CC(C)=O'),
    E0 = (-82.0721,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,375,552.5,462.5,1710,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3025,407.5,1350,352.5,265.068,4000],'cm^-1')),
        HinderedRotor(inertia=(0.00239562,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.168501,'amu*angstrom^2'), symmetry=1, barrier=(8.38583,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.557429,'amu*angstrom^2'), symmetry=1, barrier=(27.6086,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00439784,'amu*angstrom^2'), symmetry=1, barrier=(8.38412,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (85.1244,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.66914,0.049028,-2.71333e-05,7.19381e-09,-7.67635e-13,-9785.77,24.0978], Tmin=(100,'K'), Tmax=(2066.04,'K')), NASAPolynomial(coeffs=[13.509,0.0261051,-1.04906e-05,1.82355e-09,-1.17809e-13,-14678.1,-41.6142], Tmin=(2066.04,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-82.0721,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)HHH) + group(Cds-OdCsCs) + radical(CCJCC=O)"""),
)

species(
    label = 'CC=CC(C)[O](1885)',
    structure = SMILES('CC=CC(C)[O]'),
    E0 = (5.00671,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2995,3025,975,1000,1300,1375,400,500,1630,1680,1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,392.284,392.327],'cm^-1')),
        HinderedRotor(inertia=(0.0984052,'amu*angstrom^2'), symmetry=1, barrier=(10.755,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0987307,'amu*angstrom^2'), symmetry=1, barrier=(10.7518,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0983654,'amu*angstrom^2'), symmetry=1, barrier=(10.7563,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (85.1244,'amu'),
...
species(
    ...
    molecularWeight = (86.1323,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.06036,0.0525788,6.3964e-06,-1.27966e-07,1.27127e-10,3729.98,23.5626], Tmin=(100,'K'), Tmax=(443.474,'K')), NASAPolynomial(coeffs=[5.38672,0.0411844,-1.80035e-05,3.33092e-09,-2.27189e-13,3251.96,8.15655], Tmin=(443.474,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(30.5194,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJC) + radical(C2CsJOH)"""),
)
...
species(
    ...
    molecularWeight = (86.1323,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.4691,0.0541963,-3.37393e-05,1.12376e-08,-1.6016e-12,6561.75,28.518], Tmin=(100,'K'), Tmax=(1536.23,'K')), NASAPolynomial(coeffs=[9.50786,0.0332654,-1.33022e-05,2.36878e-09,-1.58338e-13,4091.85,-13.7157], Tmin=(1536.23,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(53.7937,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJCO) + radical(RCCJC)"""),
)

species(
    label = '[CH2]C(O)C[CH]C(1888)',
    ...
    molecularWeight = (86.1323,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.28958,0.0624583,-5.40642e-05,2.90173e-08,-6.90286e-12,7970.7,27.3141], Tmin=(100,'K'), Tmax=(971.438,'K')), NASAPolynomial(coeffs=[7.25315,0.0379032,-1.61496e-05,2.99842e-09,-2.07049e-13,6812.02,-1.28399], Tmin=(971.438,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(65.4807,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJCO) + radical(RCCJC)"""),
)

species(
    label = 'CCC[C](C)[O](1771)',
    ...
    molecularWeight = (86.1323,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.25614,0.0618806,-4.67646e-05,1.9871e-08,-3.66547e-12,8087.51,23.2873], Tmin=(100,'K'), Tmax=(1223.99,'K')), NASAPolynomial(coeffs=[9.0326,0.0364675,-1.56213e-05,2.90856e-09,-2.00949e-13,6183.81,-15.8015], Tmin=(1223.99,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(66.4339,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(C2CsJOH)"""),
)
...
species(
    ...
    molecularWeight = (86.1323,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.53095,0.0574175,-4.28239e-05,1.96922e-08,-4.17474e-12,7198.92,27.5987], Tmin=(100,'K'), Tmax=(1045.41,'K')), NASAPolynomial(coeffs=[6.25657,0.0393355,-1.68781e-05,3.14578e-09,-2.17679e-13,6210.91,4.5906], Tmin=(1045.41,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(59.138,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJC) + radical(RCCJ)"""),
)
...
species(
    ...
    molecularWeight = (86.1323,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.23974,0.0511716,-1.49657e-05,-1.28659e-08,7.41331e-12,-26996.3,25.0611], Tmin=(100,'K'), Tmax=(1059.8,'K')), NASAPolynomial(coeffs=[11.9621,0.0298253,-1.18191e-05,2.18073e-09,-1.52425e-13,-30343,-32.3577], Tmin=(1059.8,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-225.354,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH)"""),
)

species(
    label = 'C=CCC(C)O(1891)',
    structure = SMILES('C=CCC(C)O'),
    E0 = (-212.772,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (86.1323,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.13112,0.0543075,-2.31755e-05,-4.84017e-09,4.7694e-12,-25479.9,24.9805], Tmin=(100,'K'), Tmax=(1072.05,'K')), NASAPolynomial(coeffs=[12.0281,0.0298714,-1.16828e-05,2.12814e-09,-1.47258e-13,-28748.5,-32.6968], Tmin=(1072.05,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-212.772,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH)"""),
)
...
species(
    ...
    molecularWeight = (86.1323,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.88127,0.0299197,5.92155e-05,-1.01555e-07,4.35192e-11,-20254,17.4922], Tmin=(100,'K'), Tmax=(899.163,'K')), NASAPolynomial(coeffs=[12.9958,0.0245042,-5.19903e-06,6.61264e-10,-4.1678e-14,-24032.6,-44.8447], Tmin=(899.163,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-169.166,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(374.151,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Oxetane)"""),
)
...
species(
    label = 'C[CH]C[CH]C(279)',
    structure = SMILES('C[CH]C[CH]C'),
    E0 = (220.808,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3000,3050,390,425,1340,1360,335,370,1975.88,1978.06],'cm^-1')),
...
reaction(
    label = 'reaction1',
    reactants = ['C[CH]CC(C)[O](774)'],
    products = ['CH3CHO(36)', 'C3H6(59)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'C[CH]CC(C)=O(1699)'],
    products = ['C[CH]CC(C)[O](774)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction6',
    reactants = ['C4H7OJ_13(943)', 'CH3(18)'],
    products = ['C[CH]CC(C)[O](774)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction16',
    reactants = ['C[CH][O](347)', 'C3H6(T)(82)'],
    products = ['C[CH]CC(C)[O](774)'],
...
reaction(
    label = 'reaction20',
    reactants = ['CH2(S)(24)', 'C[CH]CC[O](240)'],
    products = ['C[CH]CC(C)[O](774)'],
...
reaction(
    label = 'reaction23',
    reactants = ['O(4)', 'C[CH]C[CH]C(279)'],
    products = ['C[CH]CC(C)[O](774)'],
    transitionState = 'TS23',
    kinetics = Arrhenius(A=(4171.1,'m^3/(mol*s)'), n=1.09077, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(303.03,'K'), Tmax=(2000,'K'), comment="""Estimated using template [Y_rad;O_birad] for rate rule [C_rad/H/NonDeC;O_birad]
...
reaction(
    label = 'reaction24',
    reactants = ['[CH2]C(C)[O](1335)', 'CHCH3(T)(80)'],
    products = ['C[CH]CC(C)[O](774)'],
