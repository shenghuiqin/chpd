species(
    label = 'CCCC(CCCOO)O[O](2129)',
    structure = SMILES('CCCC(CCCOO)O[O]'),
    E0 = (-252.928,'kJ/mol'),
    modes = [
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.71627,0.134636,-0.000146741,9.46463e-08,-2.59427e-11,-30222.1,44.2298], Tmin=(100,'K'), Tmax=(868.16,'K')), NASAPolynomial(coeffs=[12.7839,0.0678311,-3.13237e-05,6.02165e-09,-4.23417e-13,-32740,-23.6761], Tmin=(868.16,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-252.928,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(594.485,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(ROOJ)"""),
)

species(
    label = 'C[CH]CC(CCCOO)OO(2133)',
    structure = SMILES('C[CH]CC(CCCOO)OO'),
    E0 = (-210.486,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3580,3650,1300,1320,350,425,825,875,900,1100,1380,1390,370,380,2900,435,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    collisionModel = TransportData(shapeIndex=2, epsilon=(4793.85,'J/mol'), sigma=(8.21112,'angstroms'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with Tc=748.79 K, Pc=19.65 bar (from Joback method)"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.89793,0.1399,-0.000167125,1.2222e-07,-3.80625e-11,-25112.6,46.8525], Tmin=(100,'K'), Tmax=(769.582,'K')), NASAPolynomial(coeffs=[11.2913,0.0713434,-3.34922e-05,6.45093e-09,-4.52655e-13,-27142.5,-13.3229], Tmin=(769.582,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-210.486,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(590.328,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(RCCJC)"""),
)

species(
    label = 'CCCC(C[CH]COO)OO(2134)',
    structure = SMILES('CCCC(C[CH]COO)OO'),
    E0 = (-204.518,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3580,3650,1300,1320,350,425,825,875,900,1100,1380,1390,370,380,2900,435,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (163.192,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.89991,0.139552,-0.000155242,1.00655e-07,-2.76038e-11,-24393.8,46.4385], Tmin=(100,'K'), Tmax=(868.926,'K')), NASAPolynomial(coeffs=[13.5848,0.0682699,-3.21902e-05,6.24599e-09,-4.41478e-13,-27084.8,-26.0908], Tmin=(868.926,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-204.518,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(590.328,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCJCOOH)"""),
)
...
species(
    label = 'CCC[C](CCCOO)OO(2130)',
    structure = SMILES('CCC[C](CCCOO)OO'),
    E0 = (-218.034,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (163.192,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.99337,0.142618,-0.000174185,1.30393e-07,-4.15624e-11,-26017.5,44.7527], Tmin=(100,'K'), Tmax=(752.67,'K')), NASAPolynomial(coeffs=[11.1904,0.0725482,-3.45327e-05,6.68805e-09,-4.70529e-13,-28001.9,-15.1043], Tmin=(752.67,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-218.034,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(590.328,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(C2CsJOOH)"""),
)

species(
    label = 'CC[CH]C(CCCOO)OO(2131)',
    structure = SMILES('CC[CH]C(CCCOO)OO'),
    E0 = (-204.518,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3580,3650,1300,1320,350,425,825,875,900,1100,1380,1390,370,380,2900,435,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'CCCC([CH]CCOO)OO(2132)',
    structure = SMILES('CCCC([CH]CCOO)OO'),
    E0 = (-204.518,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3580,3650,1300,1320,350,425,825,875,900,1100,1380,1390,370,380,2900,435,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2]CCC(CCCOO)OO(2135)',
    structure = SMILES('[CH2]CCC(CCCOO)OO'),
    E0 = (-199.686,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2761.11,2772.22,2783.33,2794.44,2805.56,2816.67,2827.78,2838.89,2850,1425,1431.25,1437.5,1443.75,1450,1225,1237.5,1250,1262.5,1275,1270,1287.5,1305,1322.5,1340,700,725,750,775,800,300,325,350,375,400,3580,3650,1300,1320,350,425,825,875,900,1100,1380,1390,370,380,2900,435,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (163.192,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.84863,0.137818,-0.000148339,9.19603e-08,-2.40909e-11,-23813.9,45.7347], Tmin=(100,'K'), Tmax=(907.139,'K')), NASAPolynomial(coeffs=[14.1717,0.0671767,-3.15294e-05,6.11482e-09,-4.32462e-13,-26720.5,-29.9929], Tmin=(907.139,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-199.686,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(590.328,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(RCCJ)"""),
)

species(
    label = 'CCCC(CC[CH]OO)OO(2136)',
    structure = SMILES('CCCC(CC[CH]OO)OO'),
    E0 = (-216.35,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3580,3650,1300,1320,350,425,825,875,900,1100,1380,1390,370,380,2900,435,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (163.192,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.93625,0.140436,-0.00015675,1.02206e-07,-2.81999e-11,-25815.7,44.4134], Tmin=(100,'K'), Tmax=(863.858,'K')), NASAPolynomial(coeffs=[13.5225,0.068859,-3.24678e-05,6.29688e-09,-4.4488e-13,-28486.7,-27.9042], Tmin=(863.858,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-216.35,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(590.328,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCsJOOH)"""),
)

species(
    label = 'CCCC(CCCO[O])OO(2137)',
    structure = SMILES('CCCC(CCCO[O])OO'),
    E0 = (-252.928,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2761.11,2772.22,2783.33,2794.44,2805.56,2816.67,2827.78,2838.89,2850,1425,1431.25,1437.5,1443.75,1450,1225,1237.5,1250,1262.5,1275,1270,1287.5,1305,1322.5,1340,700,725,750,775,800,300,325,350,375,400,2750,2800,2850,1350,1500,750,1050,1375,1000,1380,1390,370,380,2900,435,3615,1310,387.5,850,1000,492.5,1135,1000,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.146936,0.100719,-4.68342e-05,-9.03618e-08,1.104e-10,-11751.8,37.8767], Tmin=(100,'K'), Tmax=(481.554,'K')), NASAPolynomial(coeffs=[7.25025,0.0688428,-3.20407e-05,6.13797e-09,-4.28785e-13,-12750.4,5.53222], Tmin=(481.554,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-98.7278,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(552.912,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(ROOJ)"""),
)
...
species(
    label = 'CCCC(CCCO[O])O[O](2139)',
    structure = SMILES('CCCC(CCCO[O])O[O]'),
    E0 = (-100.923,'kJ/mol'),
    modes = [
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.69218,0.134069,-0.00016301,1.20534e-07,-3.75721e-11,-11941.5,44.8892], Tmin=(100,'K'), Tmax=(772.285,'K')), NASAPolynomial(coeffs=[11.5297,0.0655836,-2.99866e-05,5.69795e-09,-3.96331e-13,-13983.6,-15.4817], Tmin=(772.285,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-100.923,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(573.699,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(ROOJ)"""),
)
...
species(
    ...
    molecularWeight = (162.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.96408,0.142114,-0.000191319,1.58395e-07,-5.45718e-11,-7737.12,45.386], Tmin=(100,'K'), Tmax=(778.095,'K')), NASAPolynomial(coeffs=[10.1582,0.069874,-3.29276e-05,6.29704e-09,-4.37602e-13,-9323.21,-8.12524], Tmin=(778.095,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-66.0289,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(569.541,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(C2CsJOOH)"""),
)
...
species(
    label = 'CC[CH]C(CCCOO)O[O](2141)',
    structure = SMILES('CC[CH]C(CCCOO)O[O]'),
    E0 = (-52.513,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (162.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.87782,0.138995,-0.00017148,1.26402e-07,-3.91255e-11,-6113.1,47.1058], Tmin=(100,'K'), Tmax=(778.074,'K')), NASAPolynomial(coeffs=[12.3073,0.0660674,-3.08815e-05,5.92941e-09,-4.15011e-13,-8320.41,-17.769], Tmin=(778.074,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-52.513,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(569.541,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(CCJCOOH)"""),
)
...
species(
    label = 'CCCC([CH]CCOO)O[O](2142)',
    structure = SMILES('CCCC([CH]CCOO)O[O]'),
    E0 = (-52.513,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,492.5,1135,1000,3615,1310,387.5,850,1000,3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,1380,1390,370,380,2900,435,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (162.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.87782,0.138995,-0.000171481,1.26403e-07,-3.91257e-11,-6113.1,47.1059], Tmin=(100,'K'), Tmax=(778.047,'K')), NASAPolynomial(coeffs=[12.3073,0.0660674,-3.08815e-05,5.92941e-09,-4.15011e-13,-8320.41,-17.769], Tmin=(778.047,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-52.513,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(569.541,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCJCOOH) + radical(ROOJ)"""),
)
...
species(
    label = 'CCCC(C[CH]COO)O[O](2143)',
    structure = SMILES('CCCC(C[CH]COO)O[O]'),
    E0 = (-52.513,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,492.5,1135,1000,3615,1310,387.5,850,1000,3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,1380,1390,370,380,2900,435,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2]CC(CCCOO)O[O](2144)',
    structure = SMILES('[CH2]CC(CCCOO)O[O]'),
    E0 = (-23.9014,'kJ/mol'),
    modes = [
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.19018,0.122572,-0.000150894,1.09532e-07,-3.32421e-11,-2695.42,41.8736], Tmin=(100,'K'), Tmax=(793.977,'K')), NASAPolynomial(coeffs=[11.878,0.0567345,-2.65108e-05,5.09147e-09,-3.56536e-13,-4770.57,-18.1578], Tmin=(793.977,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-23.9014,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(498.868,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(RCCJ)"""),
)

species(
    label = 'C[CH]CC(CCCOO)O[O](2145)',
    structure = SMILES('C[CH]CC(CCCOO)O[O]'),
    E0 = (-58.4817,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,492.5,1135,1000,3615,1310,387.5,850,1000,3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,1380,1390,370,380,2900,435,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (162.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.8745,0.139466,-0.000184502,1.50547e-07,-5.12212e-11,-6831.97,47.5068], Tmin=(100,'K'), Tmax=(781.051,'K')), NASAPolynomial(coeffs=[10.2514,0.0686849,-3.18973e-05,6.06257e-09,-4.19962e-13,-8461.4,-6.30244], Tmin=(781.051,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-58.4817,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(569.541,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(RCCJC) + radical(ROOJ)"""),
)

species(
    label = 'CCCC(CC[CH]OO)O[O](2146)',
    structure = SMILES('CCCC(CC[CH]OO)O[O]'),
    E0 = (-64.3455,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,492.5,1135,1000,3615,1310,387.5,850,1000,3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,1380,1390,370,380,2900,435,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (162.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.91825,0.139942,-0.000173276,1.28438e-07,-3.99842e-11,-7534.83,45.0946], Tmin=(100,'K'), Tmax=(773.827,'K')), NASAPolynomial(coeffs=[12.2662,0.0666168,-3.11346e-05,5.97422e-09,-4.1789e-13,-9729.99,-19.6996], Tmin=(773.827,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-64.3455,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(569.541,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCsJOOH) + radical(ROOJ)"""),
)

species(
    label = '[CH2]CCC(CCCOO)O[O](2147)',
    structure = SMILES('[CH2]CCC(CCCOO)O[O]'),
    E0 = (-47.6816,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (162.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.79262,0.136767,-0.000162376,1.1412e-07,-3.37236e-11,-5534.59,46.2863], Tmin=(100,'K'), Tmax=(812.507,'K')), NASAPolynomial(coeffs=[12.7291,0.0652797,-3.04076e-05,5.84432e-09,-4.09941e-13,-7894.5,-20.7582], Tmin=(812.507,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-47.6816,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(569.541,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(RCCJ) + radical(ROOJ)"""),
)
...
species(
    label = 'CCC(CCCOO)O[O](2148)',
    structure = SMILES('CCC(CCCOO)O[O]'),
    E0 = (-229.148,'kJ/mol'),
    modes = [
...
species(
    label = 'CCC=CCCCOO(1859)',
    structure = SMILES('CCC=CCCCOO'),
    E0 = (-187.296,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,2995,3025,975,1000,1300,1375,400,500,1630,1680,3615,1310,387.5,850,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (130.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.382592,0.095575,-6.98669e-05,2.68898e-08,-4.35142e-12,-22368.6,36.2313], Tmin=(100,'K'), Tmax=(1400.32,'K')), NASAPolynomial(coeffs=[15.2641,0.0508805,-2.19911e-05,4.09701e-09,-2.82228e-13,-26750.7,-44.5231], Tmin=(1400.32,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-187.296,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(527.969,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH)"""),
)

species(
    label = 'CCCC=CCCOO(1860)',
    structure = SMILES('CCCC=CCCOO'),
    E0 = (-187.296,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,2995,3025,975,1000,1300,1375,400,500,1630,1680,3615,1310,387.5,850,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'CCCC([O])CCCOO(2149)',
    structure = SMILES('CCCC([O])CCCOO'),
    E0 = (-246.077,'kJ/mol'),
    modes = [
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.07842,0.116815,-0.00010435,5.23868e-08,-1.12161e-11,-29417.6,40.21], Tmin=(100,'K'), Tmax=(1085.93,'K')), NASAPolynomial(coeffs=[14.004,0.0612592,-2.76113e-05,5.27655e-09,-3.70609e-13,-32693.3,-33.7974], Tmin=(1085.93,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-246.077,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(573.699,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CC(C)OJ)"""),
)

species(
    label = 'CC=CC(CCCOO)OO(2354)',
    structure = SMILES('CC=CC(CCCOO)OO'),
    E0 = (-289.732,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,3580,3650,1300,1320,350,425,825,875,900,1100,1380,1390,370,380,2900,435,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (162.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.42901,0.125891,-0.000120016,6.30237e-08,-1.39428e-11,-34656.6,43.3723], Tmin=(100,'K'), Tmax=(1060.32,'K')), NASAPolynomial(coeffs=[15.6967,0.0612852,-2.8621e-05,5.55985e-09,-3.94155e-13,-38288.3,-40.2523], Tmin=(1060.32,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-289.732,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(569.541,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH)"""),
)

species(
    label = 'C=CCC(CCCOO)OO(2355)',
    structure = SMILES('C=CCC(CCCOO)OO'),
    E0 = (-277.15,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,2950,3100,1380,975,1025,1650,3010,987.5,1337.5,450,1655,3580,3650,1300,1320,350,425,825,875,900,1100,1380,1390,370,380,2900,435,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (162.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.55987,0.129228,-0.000128679,7.13682e-08,-1.66403e-11,-33139,43.3759], Tmin=(100,'K'), Tmax=(1012.5,'K')), NASAPolynomial(coeffs=[15.5145,0.0617739,-2.87491e-05,5.57139e-09,-3.94415e-13,-36596.6,-39.2106], Tmin=(1012.5,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-277.15,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(569.541,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH)"""),
)
...
species(
    label = 'OO[CH]CCCOO(2356)',
    structure = SMILES('OO[CH]CCCOO'),
    E0 = (-132.367,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3580,3650,1300,1320,350,425,825,875,900,1100,3025,407.5,1350,352.5,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.297257,0.102239,-0.000142009,1.16287e-07,-3.93757e-11,-15772.6,32.1123], Tmin=(100,'K'), Tmax=(756.321,'K')), NASAPolynomial(coeffs=[9.81877,0.0452063,-2.18921e-05,4.23403e-09,-2.96138e-13,-17201.8,-13.1986], Tmin=(756.321,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-132.367,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(378.308,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + radical(CCsJOOH)"""),
)

species(
    label = 'C[CH]CC([O])CCCOO(2357)',
    structure = SMILES('C[CH]CC([O])CCCOO'),
    E0 = (-51.6306,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (146.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.00118,0.118258,-0.000127331,8.47901e-08,-2.44454e-11,-6036.97,42.6821], Tmin=(100,'K'), Tmax=(822.242,'K')), NASAPolynomial(coeffs=[9.98639,0.0648022,-2.98071e-05,5.71339e-09,-4.00809e-13,-7843.74,-8.17533], Tmin=(822.242,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-51.6306,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(548.755,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(RCCJC) + radical(CC(C)OJ)"""),
)

species(
    label = 'C[CH]C[CH]CCCOO(1864)',
    structure = SMILES('C[CH]C[CH]CCCOO'),
    E0 = (84.9373,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3050,390,425,1340,1360,335,370,2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,3615,1310,387.5,850,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (130.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.504934,0.109379,-0.000139587,1.22506e-07,-4.51275e-11,10367.9,41.2716], Tmin=(100,'K'), Tmax=(803.102,'K')), NASAPolynomial(coeffs=[4.00419,0.0693775,-3.2109e-05,6.08795e-09,-4.20711e-13,10209.3,24.0285], Tmin=(803.102,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(84.9373,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(523.812,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(RCCJC)"""),
)

species(
    label = 'C[CH]CC(CCC[O])OO(2358)',
    ...
    molecularWeight = (146.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.12667,0.123751,-0.000162547,1.40592e-07,-5.10037e-11,-6595.66,44.1586], Tmin=(100,'K'), Tmax=(788.308,'K')), NASAPolynomial(coeffs=[6.00364,0.0718511,-3.38797e-05,6.4823e-09,-4.50514e-13,-7231.41,14.553], Tmin=(788.308,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-56.2863,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(548.755,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(RCCJC) + radical(CCOJ)"""),
)

species(
    label = '[CH2]CCC(C[CH]C)OO(827)',
    structure = SMILES('[CH2]CCC(C[CH]C)OO'),
    E0 = (83.0824,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3000,3100,440,815,1455,1000,1380,1390,370,380,2900,435,3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1310,387.5,850,1000,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (130.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.334084,0.102459,-9.55927e-05,5.50954e-08,-1.41114e-11,10142.5,39.562], Tmin=(100,'K'), Tmax=(904.948,'K')), NASAPolynomial(coeffs=[8.87584,0.0617501,-2.81146e-05,5.38477e-09,-3.78381e-13,8475.59,-3.95064], Tmin=(904.948,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(83.0824,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(523.812,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJC) + radical(RCCJ)"""),
)

species(
    label = 'C[CH]CC(CCCO[O])OO(2359)',
    structure = SMILES('C[CH]CC(CCCO[O])OO'),
    E0 = (-58.4817,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,492.5,1135,1000,3615,1310,387.5,850,1000,3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,1380,1390,370,380,2900,435,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (162.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.87448,0.139466,-0.000184501,1.50545e-07,-5.12204e-11,-6831.97,47.5067], Tmin=(100,'K'), Tmax=(781.059,'K')), NASAPolynomial(coeffs=[10.2514,0.068685,-3.18974e-05,6.06257e-09,-4.19963e-13,-8461.39,-6.30229], Tmin=(781.059,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-58.4817,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(569.541,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(RCCJC)"""),
)
...
species(
    label = 'C[CH]C[C](CCCOO)OO(2360)',
    structure = SMILES('C[CH]C[C](CCCOO)OO'),
    E0 = (-23.5873,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([360,370,350,2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,3580,3650,1300,1320,350,425,825,875,900,1100,3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (162.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.05474,0.146275,-0.000207656,1.80275e-07,-6.39613e-11,-2631.51,47.6841], Tmin=(100,'K'), Tmax=(801.108,'K')), NASAPolynomial(coeffs=[8.72522,0.073261,-3.5013e-05,6.70467e-09,-4.64913e-13,-3742.93,1.91072], Tmin=(801.108,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-23.5873,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(565.384,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(RCCJC) + radical(C2CsJOOH)"""),
)
...
species(
    label = 'C[CH]CC([CH]CCOO)OO(2361)',
    structure = SMILES('C[CH]CC([CH]CCOO)OO'),
    E0 = (-10.0714,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3050,390,425,1340,1360,335,370,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3580,3650,1300,1320,350,425,825,875,900,1100,1380,1390,370,380,2900,435,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (162.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.09097,0.144807,-0.000194698,1.59148e-07,-5.42176e-11,-1002.28,49.831], Tmin=(100,'K'), Tmax=(765.998,'K')), NASAPolynomial(coeffs=[11.0688,0.0690954,-3.27475e-05,6.28305e-09,-4.37704e-13,-2813.24,-8.8103], Tmin=(765.998,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-10.0714,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(565.384,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(RCCJC) + radical(CCJCOOH)"""),
)

species(
    label = '[CH2]CC(C[CH]C)OO(824)',
    ...
    molecularWeight = (116.158,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.274092,0.0881539,-8.35146e-05,4.94222e-08,-1.30211e-11,12981.4,35.1315], Tmin=(100,'K'), Tmax=(881.652,'K')), NASAPolynomial(coeffs=[7.94396,0.0533561,-2.43111e-05,4.65506e-09,-3.26967e-13,11629,-0.905094], Tmin=(881.652,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(106.863,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJC) + radical(RCCJ)"""),
)

species(
    label = 'C[CH]CC(C[CH]COO)OO(2362)',
    structure = SMILES('C[CH]CC(C[CH]COO)OO'),
    E0 = (-10.0714,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3050,390,425,1340,1360,335,370,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3580,3650,1300,1320,350,425,825,875,900,1100,1380,1390,370,380,2900,435,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (162.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.09098,0.144807,-0.000194699,1.5915e-07,-5.42182e-11,-1002.28,49.831], Tmin=(100,'K'), Tmax=(765.991,'K')), NASAPolynomial(coeffs=[11.0688,0.0690954,-3.27475e-05,6.28304e-09,-4.37704e-13,-2813.24,-8.8104], Tmin=(765.991,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-10.0714,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(565.384,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCJCOOH) + radical(RCCJC)"""),
)

species(
    label = 'C[CH][CH]C(CCCOO)OO(2363)',
    structure = SMILES('C[CH][CH]C(CCCOO)OO'),
    E0 = (-10.0714,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3050,390,425,1340,1360,335,370,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3580,3650,1300,1320,350,425,825,875,900,1100,1380,1390,370,380,2900,435,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'C[CH]CC(CC[CH]OO)OO(2364)',
    structure = SMILES('C[CH]CC(CC[CH]OO)OO'),
    E0 = (-21.9039,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3050,390,425,1340,1360,335,370,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3580,3650,1300,1320,350,425,825,875,900,1100,1380,1390,370,380,2900,435,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (162.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.12613,0.145684,-0.000196216,1.60755e-07,-5.48541e-11,-2424.24,47.8012], Tmin=(100,'K'), Tmax=(768.55,'K')), NASAPolynomial(coeffs=[11.0243,0.0696508,-3.30041e-05,6.3287e-09,-4.40654e-13,-4221.41,-10.7215], Tmin=(768.55,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-21.9039,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(565.384,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(RCCJC) + radical(CCsJOOH)"""),
)

species(
    label = '[CH2][CH]CC(CCCOO)OO(2365)',
    structure = SMILES('[CH2][CH]CC(CCCOO)OO'),
    E0 = (-5.24004,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,3580,3650,1300,1320,350,425,825,875,900,1100,3000,3100,440,815,1455,1000,1380,1390,370,380,2900,435,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (162.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.02037,0.142742,-0.000186127,1.47523e-07,-4.90963e-11,-423.147,49.0643], Tmin=(100,'K'), Tmax=(742.468,'K')), NASAPolynomial(coeffs=[11.4543,0.0683796,-3.23196e-05,6.20965e-09,-4.33657e-13,-2375.29,-11.6022], Tmin=(742.468,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-5.24004,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(565.384,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(RCCJC) + radical(RCCJ)"""),
)

species(
    label = 'CC1CC(CCCOO)O1(2366)',
    structure = SMILES('CC1CC(CCCOO)O1'),
    E0 = (-305.049,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (146.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.06173,0.0991909,-5.6154e-05,1.72034e-09,7.43898e-12,-36495.8,36.6986], Tmin=(100,'K'), Tmax=(968.268,'K')), NASAPolynomial(coeffs=[18.0735,0.0468268,-1.63735e-05,2.79384e-09,-1.87128e-13,-41452.4,-61.4606], Tmin=(968.268,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-305.049,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(557.07,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Oxetane)"""),
)

species(
    label = '[CH2]C(C)C(CCCOO)OO(2367)',
    structure = SMILES('[CH2]C(C)C(CCCOO)OO'),
    E0 = (-205.545,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (163.192,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.97393,0.13777,-0.000146148,8.80036e-08,-2.20944e-11,-24511.6,45.8904], Tmin=(100,'K'), Tmax=(951.284,'K')), NASAPolynomial(coeffs=[15.8117,0.0629831,-2.82211e-05,5.35786e-09,-3.74575e-13,-27895.3,-39.0265], Tmin=(951.284,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-205.545,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(590.328,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Isobutyl)"""),
)

species(
    label = 'CC(O)CC([O])CCCOO(2368)',
    structure = SMILES('CC(O)CC([O])CCCOO'),
    E0 = (-418.547,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (163.192,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.82507,0.134474,-0.000138613,8.0311e-08,-1.94369e-11,-50135.1,45.2575], Tmin=(100,'K'), Tmax=(982.778,'K')), NASAPolynomial(coeffs=[15.9531,0.0621151,-2.81716e-05,5.39317e-09,-3.79152e-13,-53629.5,-40.2032], Tmin=(982.778,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-418.547,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(594.485,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CC(C)OJ)"""),
)
...
species(
    ...
    E0 = (-143.41,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3580,3650,1300,1320,350,425,825,875,900,1100,1380,1390,370,380,2900,435,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH]CC(CCCOO)OO(2369)',
    structure = SMILES('[CH]CC(CCCOO)OO'),
    E0 = (67.0627,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,3580,3650,1300,1320,350,425,825,875,900,1100,1380,1390,370,380,2900,435,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (148.157,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.37556,0.126394,-0.000147387,9.65359e-08,-2.62111e-11,8252.32,41.0049], Tmin=(100,'K'), Tmax=(884.646,'K')), NASAPolynomial(coeffs=[14.4592,0.0547961,-2.59868e-05,5.04892e-09,-3.57e-13,5450.69,-33.4477], Tmin=(884.646,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(67.0627,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(494.711,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCJ2_triplet)"""),
)

species(
    label = 'C[C]CC(CCCOO)OO(2370)',
    structure = SMILES('C[C]CC(CCCOO)OO'),
    E0 = (43.2825,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3580,3650,1300,1320,350,425,825,875,900,1100,1380,1390,370,380,2900,435,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (162.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.98958,0.140762,-0.000159654,1.02418e-07,-2.73781e-11,5413.63,44.3583], Tmin=(100,'K'), Tmax=(895.791,'K')), NASAPolynomial(coeffs=[15.3754,0.0632204,-2.98096e-05,5.78349e-09,-4.08837e-13,2302.59,-37.5065], Tmin=(895.791,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(43.2825,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(565.384,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCJ2_triplet)"""),
)

species(
    label = 'CCCC(C=CCOO)OO(2371)',
    ...
    molecularWeight = (162.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.31934,0.121606,-0.000108987,5.2917e-08,-1.08032e-11,-33854.3,44.0209], Tmin=(100,'K'), Tmax=(1141.35,'K')), NASAPolynomial(coeffs=[16.3763,0.0595888,-2.74818e-05,5.30873e-09,-3.75039e-13,-37893.6,-43.6896], Tmin=(1141.35,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-283.04,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(569.541,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH)"""),
)

species(
    label = 'CCCC(CC=COO)OO(2372)',
    structure = SMILES('CCCC(CC=COO)OO'),
    E0 = (-273.126,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,3580,3650,1300,1320,350,425,825,875,900,1100,1380,1390,370,380,2900,435,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (162.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.76658,0.127174,-0.000119171,5.94085e-08,-1.21524e-11,-32642.1,44.5371], Tmin=(100,'K'), Tmax=(1159.82,'K')), NASAPolynomial(coeffs=[19.6523,0.0533033,-2.36324e-05,4.49174e-09,-3.14878e-13,-37610.5,-61.9721], Tmin=(1159.82,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-273.126,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(569.541,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH)"""),
)
...
species(
    label = 'CCCC([O])C[CH]COO(2373)',
    structure = SMILES('CCCC([O])C[CH]COO'),
    E0 = (-45.6619,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (146.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.06933,0.118852,-0.000119545,6.97646e-08,-1.73703e-11,-5315.51,42.4951], Tmin=(100,'K'), Tmax=(946.849,'K')), NASAPolynomial(coeffs=[12.5847,0.0611699,-2.81654e-05,5.42506e-09,-3.82516e-13,-7901.16,-22.6319], Tmin=(946.849,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-45.6619,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(548.755,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(CCJCOOH)"""),
)

species(
    label = 'CCC[CH]C[CH]COO(1862)',
    structure = SMILES('CCC[CH]C[CH]COO'),
    E0 = (90.906,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3050,390,425,1340,1360,335,370,2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,3615,1310,387.5,850,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (130.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.636377,0.110634,-0.000133765,1.09733e-07,-3.90028e-11,11092.2,41.3174], Tmin=(100,'K'), Tmax=(762.392,'K')), NASAPolynomial(coeffs=[6.26216,0.0663868,-3.08652e-05,5.89869e-09,-4.10961e-13,10274.3,11.4423], Tmin=(762.392,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(90.906,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(523.812,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(CCJCOOH)"""),
)

species(
    label = 'CCCC(C[CH]C[O])OO(2374)',
    structure = SMILES('CCCC(C[CH]C[O])OO'),
    E0 = (-50.8305,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (146.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.746728,0.113288,-0.000114176,7.17663e-08,-1.9968e-11,-5950.32,42.5884], Tmin=(100,'K'), Tmax=(840.468,'K')), NASAPolynomial(coeffs=[9.00208,0.0668909,-3.13694e-05,6.08278e-09,-4.30091e-13,-7589.02,-2.74957], Tmin=(840.468,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-50.8305,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(548.755,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(CCJCO)"""),
)

species(
    label = '[CH2][CH]CC(CCC)OO(828)',
    ...
    molecularWeight = (130.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.334111,0.10246,-9.55936e-05,5.50964e-08,-1.41118e-11,10142.5,39.5621], Tmin=(100,'K'), Tmax=(904.907,'K')), NASAPolynomial(coeffs=[8.87578,0.0617502,-2.81147e-05,5.38479e-09,-3.78383e-13,8475.61,-3.9503], Tmin=(904.907,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(83.0824,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(523.812,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJ) + radical(RCCJC)"""),
)

species(
    label = 'CCCC(C[CH]CO[O])OO(2375)',
    structure = SMILES('CCCC(C[CH]CO[O])OO'),
    E0 = (-52.513,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,492.5,1135,1000,3615,1310,387.5,850,1000,3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,1380,1390,370,380,2900,435,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'OO[CH]C[CH]COO(1418)',
    structure = SMILES('OO[CH]C[CH]COO'),
    E0 = (68.0484,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3580,3650,1300,1320,350,425,825,875,900,1100,3000,3050,390,425,1340,1360,335,370,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (120.104,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.355624,0.105326,-0.00016197,1.41156e-07,-4.91842e-11,8332,34.6216], Tmin=(100,'K'), Tmax=(808.664,'K')), NASAPolynomial(coeffs=[9.37608,0.0433655,-2.13965e-05,4.12751e-09,-2.86439e-13,7210.05,-7.46689], Tmin=(808.664,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(68.0484,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(353.365,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + radical(CCJCOOH) + radical(CCsJOOH)"""),
)
...
species(
    label = 'CCC[C](C[CH]COO)OO(2376)',
    structure = SMILES('CCC[C](C[CH]COO)OO'),
    E0 = (-17.6186,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([360,370,350,2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,3580,3650,1300,1320,350,425,825,875,900,1100,3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (162.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.18264,0.147483,-0.000201637,1.67193e-07,-5.76755e-11,-1907.35,47.7175], Tmin=(100,'K'), Tmax=(764.301,'K')), NASAPolynomial(coeffs=[10.9773,0.0702812,-3.37758e-05,6.51702e-09,-4.55301e-13,-3675.72,-10.643], Tmin=(764.301,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-17.6186,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(565.384,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCJCOOH) + radical(C2CsJOOH)"""),
)

species(
    label = '[CH2]C(C[CH]COO)OO(1422)',
    structure = SMILES('[CH2]C(C[CH]COO)OO'),
    E0 = (57.0053,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3580,3650,1300,1320,350,425,825,875,900,1100,3000,3100,440,815,1455,1000,1380,1390,370,380,2900,435,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (134.13,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.872754,0.115243,-0.000150367,1.10709e-07,-3.34842e-11,7024.31,40.2435], Tmin=(100,'K'), Tmax=(801.252,'K')), NASAPolynomial(coeffs=[12.8014,0.0469785,-2.25716e-05,4.37914e-09,-3.08099e-13,4833.01,-22.6966], Tmin=(801.252,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(57.0053,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(424.038,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCJCOOH) + radical(CJCOOH)"""),
)

species(
    label = 'CC[CH]C(C[CH]COO)OO(2377)',
    structure = SMILES('CC[CH]C(C[CH]COO)OO'),
    E0 = (-4.10277,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3050,390,425,1340,1360,335,370,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3580,3650,1300,1320,350,425,825,875,900,1100,1380,1390,370,380,2900,435,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (162.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.06312,0.143919,-0.00017995,1.32282e-07,-4.06898e-11,-284.733,49.3212], Tmin=(100,'K'), Tmax=(783.243,'K')), NASAPolynomial(coeffs=[13.0873,0.0665464,-3.17733e-05,6.16011e-09,-4.33624e-13,-2658.04,-20.0695], Tmin=(783.243,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-4.10277,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(565.384,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCJCOOH) + radical(CCJCOOH)"""),
)

species(
    label = '[CH2]CC(C[CH]COO)OO(2378)',
    structure = SMILES('[CH2]CC(C[CH]COO)OO'),
    E0 = (24.5089,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3580,3650,1300,1320,350,425,825,875,900,1100,3000,3100,440,815,1455,1000,1380,1390,370,380,2900,435,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (148.157,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.37559,0.127501,-0.000159398,1.15484e-07,-3.4852e-11,3132.94,44.0892], Tmin=(100,'K'), Tmax=(798.856,'K')), NASAPolynomial(coeffs=[12.663,0.0572039,-2.73966e-05,5.32064e-09,-3.75017e-13,890.086,-20.4855], Tmin=(798.856,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(24.5089,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(494.711,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(RCCJ) + radical(CCJCOOH)"""),
)

species(
    label = 'CCCC([CH][CH]COO)OO(2379)',
    structure = SMILES('CCCC([CH][CH]COO)OO'),
    E0 = (-4.10277,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3050,390,425,1340,1360,335,370,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3580,3650,1300,1320,350,425,825,875,900,1100,1380,1390,370,380,2900,435,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'CCCC(C[CH][CH]OO)OO(2380)',
    structure = SMILES('CCCC(C[CH][CH]OO)OO'),
    E0 = (-15.9352,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3050,390,425,1340,1360,335,370,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3580,3650,1300,1320,350,425,825,875,900,1100,1380,1390,370,380,2900,435,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (162.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.10356,0.144865,-0.000181737,1.34297e-07,-4.1535e-11,-1706.47,47.3101], Tmin=(100,'K'), Tmax=(779.158,'K')), NASAPolynomial(coeffs=[13.0447,0.0670987,-3.20282e-05,6.20538e-09,-4.36543e-13,-4067.1,-21.9919], Tmin=(779.158,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-15.9352,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(565.384,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCJCOOH) + radical(CCsJOOH)"""),
)

species(
    label = '[CH2]CCC(C[CH]COO)OO(2381)',
    structure = SMILES('[CH2]CCC(C[CH]COO)OO'),
    E0 = (0.728629,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,3580,3650,1300,1320,350,425,825,875,900,1100,3000,3100,440,815,1455,1000,1380,1390,370,380,2900,435,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (162.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.97773,0.141695,-0.000170894,1.20115e-07,-3.53634e-11,293.767,48.5006], Tmin=(100,'K'), Tmax=(816.1,'K')), NASAPolynomial(coeffs=[13.5194,0.0657388,-3.12869e-05,6.07187e-09,-4.2828e-13,-2235.69,-23.1148], Tmin=(816.1,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(0.728629,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(565.384,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(RCCJ) + radical(CCJCOOH)"""),
)

species(
    label = 'CCC(C[CH]COO)OO(2382)',
    structure = SMILES('CCC(C[CH]COO)OO'),
    E0 = (-180.737,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3580,3650,1300,1320,350,425,825,875,900,1100,1380,1390,370,380,2900,435,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (149.165,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.29075,0.125248,-0.000143232,9.51545e-08,-2.66229e-11,-21554.9,42.0035], Tmin=(100,'K'), Tmax=(854.297,'K')), NASAPolynomial(coeffs=[12.6836,0.0598186,-2.83514e-05,5.50752e-09,-3.89311e-13,-23942.6,-23.2144], Tmin=(854.297,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-180.737,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(519.654,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCJCOOH)"""),
)

species(
    label = 'CCCC(CC1CO1)OO(2383)',
    structure = SMILES('CCCC(CC1CO1)OO'),
    E0 = (-299.517,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (146.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.67998,0.114702,-0.000101595,4.97696e-08,-9.88391e-12,-35810.5,39.2421], Tmin=(100,'K'), Tmax=(1213.72,'K')), NASAPolynomial(coeffs=[19.4045,0.045214,-1.5716e-05,2.59755e-09,-1.67368e-13,-40928.5,-66.5622], Tmin=(1213.72,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-299.517,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(552.912,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Ethylene_oxide)"""),
)

species(
    label = 'CCCC1CC(COO)O1(2384)',
    structure = SMILES('CCCC1CC(COO)O1'),
    E0 = (-305.049,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (146.184,'amu'),
...
species(
    label = '[CH2]C(COO)C(CCC)OO(2385)',
    structure = SMILES('[CH2]C(COO)C(CCC)OO'),
    E0 = (-205.545,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3580,3650,1300,1320,350,425,825,875,900,1100,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'CCCC(CC(O)C[O])OO(2386)',
    structure = SMILES('CCCC(CC(O)C[O])OO'),
    E0 = (-423.203,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (163.192,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.80364,0.137774,-0.000163854,1.1965e-07,-3.72728e-11,-50699.8,46.236], Tmin=(100,'K'), Tmax=(768.76,'K')), NASAPolynomial(coeffs=[11.059,0.0708494,-3.32756e-05,6.4164e-09,-4.50638e-13,-52677.5,-12.4365], Tmin=(768.76,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-423.203,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(594.485,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCOJ)"""),
)

species(
    label = 'CCCC([O])CC(O)COO(2387)',
    structure = SMILES('CCCC([O])CC(O)COO'),
    E0 = (-418.547,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (163.192,'amu'),
...
species(
    ...
    E0 = (270.637,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3615,1310,387.5,850,1000,885.034,885.064,885.074],'cm^-1')),
        HinderedRotor(inertia=(0.179571,'amu*angstrom^2'), symmetry=1, barrier=(4.1287,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.179521,'amu*angstrom^2'), symmetry=1, barrier=(4.12755,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.179553,'amu*angstrom^2'), symmetry=1, barrier=(4.12827,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (60.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.49959,0.0305755,-2.6029e-05,1.1512e-08,-2.04186e-12,32606.1,16.6239], Tmin=(100,'K'), Tmax=(1347.31,'K')), NASAPolynomial(coeffs=[9.04307,0.0111485,-4.40002e-06,8.09536e-10,-5.59422e-14,30842.9,-16.8953], Tmin=(1347.31,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(270.637,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: DFT_QCI_thermo + radical(CCJ2_triplet)"""),
)
...
species(
    label = '[CH]CC(CCC)OO(832)',
    structure = SMILES('[CH]CC(CCC)OO'),
    E0 = (155.385,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (116.158,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.104717,0.0916072,-7.89101e-05,3.69363e-08,-7.2502e-12,18835.1,32.9531], Tmin=(100,'K'), Tmax=(1187.18,'K')), NASAPolynomial(coeffs=[13.7761,0.0448377,-1.98164e-05,3.75164e-09,-2.62025e-13,15539.3,-36.3956], Tmin=(1187.18,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(155.385,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJ2_triplet)"""),
)

species(
    label = 'CCCC(C[C]COO)OO(2388)',
    structure = SMILES('CCCC(C[C]COO)OO'),
    E0 = (43.2825,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3580,3650,1300,1320,350,425,825,875,900,1100,1380,1390,370,380,2900,435,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
reaction(
    label = 'reaction1',
    reactants = ['O2(2)', 'CCC[CH]CCCOO(975)'],
    products = ['CCCC(CCCOO)O[O](2129)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['CCCC(CCCOO)O[O](2129)'],
    products = ['CCC[C](CCCOO)OO(2130)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CC[CH]C(CCCOO)OO(2131)'],
    products = ['CCCC(CCCOO)O[O](2129)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CCCC([CH]CCOO)OO(2132)'],
    products = ['CCCC(CCCOO)O[O](2129)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(2960,'s^-1'), n=2.11, Ea=(84.0984,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2500,'K'), comment="""From training reaction 323 used for R4H_SSS;C_rad_out_H/NonDeC;O_H_out
Exact match found for rate rule [R4H_SSS;C_rad_out_H/NonDeC;O_H_out]
...
reaction(
    label = 'reaction5',
    reactants = ['CCCC(CCCOO)O[O](2129)'],
    products = ['C[CH]CC(CCCOO)OO(2133)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['CCCC(CCCOO)O[O](2129)'],
    products = ['CCCC(C[CH]COO)OO(2134)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(6.76e+10,'s^-1'), n=0.21, Ea=(77.404,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""From training reaction 261 used for R5H_SSSS_OCC_C;O_rad_out;Cs_H_out_H/NonDeC
Exact match found for rate rule [R5H_SSSS_OCC_C;O_rad_out;Cs_H_out_H/NonDeC]
Euclidian distance = 0
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2]CCC(CCCOO)OO(2135)'],
    products = ['CCCC(CCCOO)O[O](2129)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['CCCC(CCCOO)O[O](2129)'],
    products = ['CCCC(CC[CH]OO)OO(2136)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['OH(5)', 'CCCC(CCC[O])O[O](2138)'],
    products = ['CCCC(CCCOO)O[O](2129)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]CCC(CCC)O[O](149)', 'HO2(10)'],
    products = ['CCCC(CCCOO)O[O](2129)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(3)', 'CCCC(CCCO[O])O[O](2139)'],
    products = ['CCCC(CCCOO)O[O](2129)'],
...
reaction(
    label = 'reaction13',
    reactants = ['npropyl(70)', '[O]O[CH]CCCOO(930)'],
    products = ['CCCC(CCCOO)O[O](2129)'],
...
reaction(
    label = 'reaction14',
    reactants = ['QOOH_1(211)', 'CCC[CH]O[O](143)'],
    products = ['CCCC(CCCOO)O[O](2129)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(3)', 'CCC[C](CCCOO)O[O](2140)'],
    products = ['CCCC(CCCOO)O[O](2129)'],
...
reaction(
    label = 'reaction16',
    reactants = ['C2H5(32)', '[CH2]C(CCCOO)O[O](935)'],
    products = ['CCCC(CCCOO)O[O](2129)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(3)', 'CC[CH]C(CCCOO)O[O](2141)'],
    products = ['CCCC(CCCOO)O[O](2129)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2]C(CCC)O[O](145)', 'CH2CH2OOH(55)'],
    products = ['CCCC(CCCOO)O[O](2129)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(3)', 'CCCC([CH]CCOO)O[O](2142)'],
    products = ['CCCC(CCCOO)O[O](2129)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2]CC(CCC)O[O](147)', '[CH2]OO(239)'],
    products = ['CCCC(CCCOO)O[O](2129)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(3)', 'CCCC(C[CH]COO)O[O](2143)'],
    products = ['CCCC(CCCOO)O[O](2129)'],
...
reaction(
    label = 'reaction22',
    reactants = ['CH3(18)', '[CH2]CC(CCCOO)O[O](2144)'],
    products = ['CCCC(CCCOO)O[O](2129)'],
...
reaction(
    label = 'reaction23',
    reactants = ['H(3)', 'C[CH]CC(CCCOO)O[O](2145)'],
    products = ['CCCC(CCCOO)O[O](2129)'],
...
reaction(
    label = 'reaction24',
    reactants = ['H(3)', 'CCCC(CC[CH]OO)O[O](2146)'],
    products = ['CCCC(CCCOO)O[O](2129)'],
...
reaction(
    label = 'reaction25',
    reactants = ['H(3)', '[CH2]CCC(CCCOO)O[O](2147)'],
    products = ['CCCC(CCCOO)O[O](2129)'],
...
reaction(
    label = 'reaction26',
    reactants = ['CH2(S)(24)', 'CCC(CCCOO)O[O](2148)'],
    products = ['CCCC(CCCOO)O[O](2129)'],
...
reaction(
    label = 'reaction27',
    reactants = ['CCCC(CCCOO)O[O](2129)'],
    products = ['HO2(10)', 'CCC=CCCCOO(1859)'],
...
reaction(
    label = 'reaction28',
    reactants = ['CCCC(CCCOO)O[O](2129)'],
    products = ['HO2(10)', 'CCCC=CCCOO(1860)'],
...
reaction(
    label = 'reaction29',
    reactants = ['O(4)', 'CCCC([O])CCCOO(2149)'],
    products = ['CCCC(CCCOO)O[O](2129)'],
...
reaction(
    label = 'reaction30',
    reactants = ['H(3)', 'CC=CC(CCCOO)OO(2354)'],
    products = ['C[CH]CC(CCCOO)OO(2133)'],
...
reaction(
    label = 'reaction31',
    reactants = ['H(3)', 'C=CCC(CCCOO)OO(2355)'],
    products = ['C[CH]CC(CCCOO)OO(2133)'],
...
reaction(
    label = 'reaction32',
    reactants = ['C3H6(59)', 'OO[CH]CCCOO(2356)'],
    products = ['C[CH]CC(CCCOO)OO(2133)'],
...
reaction(
    label = 'reaction35',
    reactants = ['C[CH]CC(CCCOO)OO(2133)'],
    products = ['CCC[C](CCCOO)OO(2130)'],
...
reaction(
    label = 'reaction37',
    reactants = ['CCCC(C[CH]COO)OO(2134)'],
    products = ['C[CH]CC(CCCOO)OO(2133)'],
...
reaction(
    label = 'reaction38',
    reactants = ['CCCC(CC[CH]OO)OO(2136)'],
    products = ['C[CH]CC(CCCOO)OO(2133)'],
...
reaction(
    label = 'reaction40',
    reactants = ['OH(5)', 'C[CH]CC([O])CCCOO(2357)'],
    products = ['C[CH]CC(CCCOO)OO(2133)'],
...
reaction(
    label = 'reaction41',
    reactants = ['HO2(10)', 'C[CH]C[CH]CCCOO(1864)'],
    products = ['C[CH]CC(CCCOO)OO(2133)'],
...
reaction(
    label = 'reaction42',
    reactants = ['OH(5)', 'C[CH]CC(CCC[O])OO(2358)'],
    products = ['C[CH]CC(CCCOO)OO(2133)'],
...
reaction(
    label = 'reaction43',
    reactants = ['HO2(10)', '[CH2]CCC(C[CH]C)OO(827)'],
    products = ['C[CH]CC(CCCOO)OO(2133)'],
...
reaction(
    label = 'reaction44',
    reactants = ['H(3)', 'C[CH]CC(CCCO[O])OO(2359)'],
    products = ['C[CH]CC(CCCOO)OO(2133)'],
...
reaction(
    label = 'reaction46',
    reactants = ['QOOH_1(211)', 'C[CH]C[CH]OO(242)'],
    products = ['C[CH]CC(CCCOO)OO(2133)'],
...
reaction(
    label = 'reaction47',
    reactants = ['C3H6(T)(82)', 'OO[CH]CCCOO(2356)'],
    products = ['C[CH]CC(CCCOO)OO(2133)'],
...
reaction(
    label = 'reaction48',
    reactants = ['H(3)', 'C[CH]C[C](CCCOO)OO(2360)'],
    products = ['C[CH]CC(CCCOO)OO(2133)'],
...
reaction(
    label = 'reaction49',
    reactants = ['CH2CH2OOH(55)', '[CH2]C(C[CH]C)OO(822)'],
    products = ['C[CH]CC(CCCOO)OO(2133)'],
...
reaction(
    label = 'reaction50',
    reactants = ['H(3)', 'C[CH]CC([CH]CCOO)OO(2361)'],
    products = ['C[CH]CC(CCCOO)OO(2133)'],
...
reaction(
    label = 'reaction51',
    reactants = ['[CH2]OO(239)', '[CH2]CC(C[CH]C)OO(824)'],
    products = ['C[CH]CC(CCCOO)OO(2133)'],
...
reaction(
    label = 'reaction52',
    reactants = ['H(3)', 'C[CH]CC(C[CH]COO)OO(2362)'],
    products = ['C[CH]CC(CCCOO)OO(2133)'],
...
reaction(
    label = 'reaction53',
    reactants = ['H(3)', 'C[CH][CH]C(CCCOO)OO(2363)'],
    products = ['C[CH]CC(CCCOO)OO(2133)'],
...
reaction(
    label = 'reaction54',
    reactants = ['H(3)', 'C[CH]CC(CC[CH]OO)OO(2364)'],
    products = ['C[CH]CC(CCCOO)OO(2133)'],
...
reaction(
    label = 'reaction55',
    reactants = ['H(3)', '[CH2][CH]CC(CCCOO)OO(2365)'],
    products = ['C[CH]CC(CCCOO)OO(2133)'],
...
reaction(
    label = 'reaction56',
    reactants = ['C[CH]CC(CCCOO)OO(2133)'],
    products = ['OH(5)', 'CC1CC(CCCOO)O1(2366)'],
...
reaction(
    label = 'reaction57',
    reactants = ['[CH2]C(C)C(CCCOO)OO(2367)'],
    products = ['C[CH]CC(CCCOO)OO(2133)'],
...
reaction(
    label = 'reaction59',
    reactants = ['CHCH3(T)(80)', '[CH2]C(CCCOO)OO(924)'],
    products = ['C[CH]CC(CCCOO)OO(2133)'],
...
reaction(
    label = 'reaction60',
    reactants = ['CH3(18)', '[CH]CC(CCCOO)OO(2369)'],
    products = ['C[CH]CC(CCCOO)OO(2133)'],
...
reaction(
    label = 'reaction61',
    reactants = ['H(3)', 'C[C]CC(CCCOO)OO(2370)'],
    products = ['C[CH]CC(CCCOO)OO(2133)'],
...
reaction(
    label = 'reaction62',
    reactants = ['H(3)', 'CCCC(C=CCOO)OO(2371)'],
    products = ['CCCC(C[CH]COO)OO(2134)'],
...
reaction(
    label = 'reaction63',
    reactants = ['H(3)', 'CCCC(CC=COO)OO(2372)'],
    products = ['CCCC(C[CH]COO)OO(2134)'],
...
reaction(
    label = 'reaction64',
    reactants = ['CCC[CH]OO(214)', 'CH2CHCH2OOH(252)'],
    products = ['CCCC(C[CH]COO)OO(2134)'],
...
reaction(
    label = 'reaction65',
    reactants = ['HO2(10)', 'C=CCC(CCC)OO(819)'],
    products = ['CCCC(C[CH]COO)OO(2134)'],
    transitionState = 'TS65',
    kinetics = Arrhenius(A=(791,'cm^3/(mol*s)'), n=2.78, Ea=(39.748,'kJ/mol'), T0=(1,'K'), Tmin=(400,'K'), Tmax=(1100,'K'), comment="""Estimated using an average for rate rule [Cds-HH_Cds-CsH;OJ-O2s]
Euclidian distance = 0
family: R_Addition_MultipleBond"""),
)
...
reaction(
    label = 'reaction72',
    reactants = ['OH(5)', 'CCCC([O])C[CH]COO(2373)'],
    products = ['CCCC(C[CH]COO)OO(2134)'],
...
reaction(
    label = 'reaction73',
    reactants = ['HO2(10)', 'CCC[CH]C[CH]COO(1862)'],
    products = ['CCCC(C[CH]COO)OO(2134)'],
...
reaction(
    label = 'reaction74',
    reactants = ['OH(5)', 'CCCC(C[CH]C[O])OO(2374)'],
    products = ['CCCC(C[CH]COO)OO(2134)'],
...
reaction(
    label = 'reaction75',
    reactants = ['HO2(10)', '[CH2][CH]CC(CCC)OO(828)'],
    products = ['CCCC(C[CH]COO)OO(2134)'],
...
reaction(
    label = 'reaction76',
    reactants = ['H(3)', 'CCCC(C[CH]CO[O])OO(2375)'],
    products = ['CCCC(C[CH]COO)OO(2134)'],
...
reaction(
    label = 'reaction78',
    reactants = ['OO[CH]C[CH]COO(1418)', 'npropyl(70)'],
    products = ['CCCC(C[CH]COO)OO(2134)'],
...
reaction(
    label = 'reaction79',
    reactants = ['CCC[CH]OO(214)', '[CH2][CH]COO(254)'],
    products = ['CCCC(C[CH]COO)OO(2134)'],
...
reaction(
    label = 'reaction80',
    reactants = ['H(3)', 'CCC[C](C[CH]COO)OO(2376)'],
    products = ['CCCC(C[CH]COO)OO(2134)'],
...
reaction(
    label = 'reaction81',
    reactants = ['[CH2]C(C[CH]COO)OO(1422)', 'C2H5(32)'],
    products = ['CCCC(C[CH]COO)OO(2134)'],
...
reaction(
    label = 'reaction82',
    reactants = ['H(3)', 'CC[CH]C(C[CH]COO)OO(2377)'],
    products = ['CCCC(C[CH]COO)OO(2134)'],
...
reaction(
    label = 'reaction83',
    reactants = ['CH3(18)', '[CH2]CC(C[CH]COO)OO(2378)'],
    products = ['CCCC(C[CH]COO)OO(2134)'],
...
reaction(
    label = 'reaction85',
    reactants = ['H(3)', 'CCCC([CH][CH]COO)OO(2379)'],
    products = ['CCCC(C[CH]COO)OO(2134)'],
...
reaction(
    label = 'reaction86',
    reactants = ['H(3)', 'CCCC(C[CH][CH]OO)OO(2380)'],
    products = ['CCCC(C[CH]COO)OO(2134)'],
...
reaction(
    label = 'reaction87',
    reactants = ['H(3)', '[CH2]CCC(C[CH]COO)OO(2381)'],
    products = ['CCCC(C[CH]COO)OO(2134)'],
...
reaction(
    label = 'reaction88',
    reactants = ['CH2(S)(24)', 'CCC(C[CH]COO)OO(2382)'],
    products = ['CCCC(C[CH]COO)OO(2134)'],
...
reaction(
    label = 'reaction89',
    reactants = ['CCCC(C[CH]COO)OO(2134)'],
    products = ['OH(5)', 'CCCC(CC1CO1)OO(2383)'],
...
reaction(
    label = 'reaction90',
    reactants = ['CCCC(C[CH]COO)OO(2134)'],
    products = ['OH(5)', 'CCCC1CC(COO)O1(2384)'],
...
reaction(
    label = 'reaction91',
    reactants = ['[CH2]C(COO)C(CCC)OO(2385)'],
    products = ['CCCC(C[CH]COO)OO(2134)'],
...
reaction(
    label = 'reaction92',
    reactants = ['CCCC(C[CH]COO)OO(2134)'],
    products = ['CCCC(CC(O)C[O])OO(2386)'],
...
reaction(
    label = 'reaction94',
    reactants = ['[CH]COO(1429)', '[CH2]C(CCC)OO(380)'],
    products = ['CCCC(C[CH]COO)OO(2134)'],
...
reaction(
    label = 'reaction95',
    reactants = ['[CH2]OO(239)', '[CH]CC(CCC)OO(832)'],
    products = ['CCCC(C[CH]COO)OO(2134)'],
...
reaction(
    label = 'reaction96',
    reactants = ['H(3)', 'CCCC(C[C]COO)OO(2388)'],
    products = ['CCCC(C[CH]COO)OO(2134)'],
...
network(
    ...
    isomers = [
        'CCCC(CCCOO)O[O](2129)',
        'C[CH]CC(CCCOO)OO(2133)',
        'CCCC(C[CH]COO)OO(2134)',
    ],
    reactants = [
        ('O2(2)', 'CCC[CH]CCCOO(975)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
