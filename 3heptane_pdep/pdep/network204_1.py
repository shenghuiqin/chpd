species(
    label = 'O=[C]OO[C]=O(435)',
    structure = SMILES('O=[C]OO[C]=O'),
    E0 = (-239.429,'kJ/mol'),
    modes = [
        ...
        HinderedRotor(inertia=(1.88973,'amu*angstrom^2'), symmetry=1, barrier=(43.4485,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (88.019,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.06026,0.0235155,3.48154e-05,-7.80728e-08,3.54791e-11,-28709.1,18.2992], Tmin=(100,'K'), Tmax=(937.228,'K')), NASAPolynomial(coeffs=[20.392,-0.00598468,4.0257e-06,-6.86065e-10,3.62436e-14,-34285.9,-80.3723], Tmin=(937.228,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-239.429,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(120.56,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-O2d)) + group(O2s-O2s(Cds-O2d)) + group(Cds-OdOsH) + group(Cds-OdOsH) + radical((O)CJOC) + radical((O)CJOC)"""),
)
