species(
    label = 'C=[C]OO[CH]C(664)',
    structure = SMILES('C=[C]OO[CH]C'),
    E0 = (346.413,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,350,500,795,815,2950,3100,1380,975,1025,1650,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,260.441],'cm^-1')),
        HinderedRotor(inertia=(0.00326218,'amu*angstrom^2'), symmetry=1, barrier=(9.9809,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.207373,'amu*angstrom^2'), symmetry=1, barrier=(9.97953,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.905128,'amu*angstrom^2'), symmetry=1, barrier=(43.5753,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.90537,'amu*angstrom^2'), symmetry=1, barrier=(43.5753,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.71902,0.0546224,-6.02804e-05,4.32505e-08,-1.37786e-11,41741.9,24.9714], Tmin=(100,'K'), Tmax=(741.216,'K')), NASAPolynomial(coeffs=[5.81452,0.0325226,-1.55603e-05,3.03139e-09,-2.14437e-13,41134.7,6.43908], Tmin=(741.216,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(346.413,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C=CJO) + radical(CCsJOOC)"""),
)
...
species(
    label = 'C=[C]OOC=C(2963)',
    structure = SMILES('C=[C]OOC=C'),
    E0 = (302.89,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,350,500,795,815,3010,987.5,1337.5,450,1655,2950,3000,3050,3100,1330,1430,900,1050,1000,1050,1600,1700,180],'cm^-1')),
        HinderedRotor(inertia=(0.939625,'amu*angstrom^2'), symmetry=1, barrier=(21.6038,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0804162,'amu*angstrom^2'), symmetry=1, barrier=(10.1558,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.61701,0.0472731,-3.89653e-05,1.6305e-08,-2.73503e-12,36519.2,25.7161], Tmin=(100,'K'), Tmax=(1419.42,'K')), NASAPolynomial(coeffs=[12.3675,0.0169774,-6.94949e-06,1.26784e-09,-8.65496e-14,33467.3,-29.9142], Tmin=(1419.42,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(302.89,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-O2s(Cds-Cd)) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(C=CJO)"""),
)

species(
    label = 'C#COO[CH]C(2964)',
    structure = SMILES('C#COO[CH]C'),
    E0 = (338.185,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,750,770,3400,2100,2175,525,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5],'cm^-1')),
        HinderedRotor(inertia=(1.54028,'amu*angstrom^2'), symmetry=1, barrier=(35.4141,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.54029,'amu*angstrom^2'), symmetry=1, barrier=(35.4144,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.54023,'amu*angstrom^2'), symmetry=1, barrier=(35.413,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.54025,'amu*angstrom^2'), symmetry=1, barrier=(35.4135,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (85.0813,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.53522,0.0587323,-6.73275e-05,4.39917e-08,-1.20962e-11,40759.1,20.1142], Tmin=(100,'K'), Tmax=(867.723,'K')), NASAPolynomial(coeffs=[8.28481,0.027618,-1.35407e-05,2.66727e-09,-1.90034e-13,39587.8,-11.491], Tmin=(867.723,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(338.185,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCt) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Ct-CtOs) + group(Ct-CtH) + radical(CCsJOOC)"""),
)

species(
    label = '[CH2]COO[C]=C(2965)',
    ...
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.68996,0.0549444,-5.71715e-05,3.54175e-08,-9.47631e-12,45053.6,26.778], Tmin=(100,'K'), Tmax=(880.479,'K')), NASAPolynomial(coeffs=[7.26932,0.0295974,-1.39899e-05,2.72189e-09,-1.92835e-13,44071.1,0.571054], Tmin=(880.479,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(373.935,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CJCOOH) + radical(C=CJO)"""),
)

species(
    label = '[CH]=COO[CH]C(2966)',
    structure = SMILES('[CH]=COO[CH]C'),
    E0 = (353.765,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,350,500,795,815,3010,987.5,1337.5,450,1655,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5],'cm^-1')),
        HinderedRotor(inertia=(0.474811,'amu*angstrom^2'), symmetry=1, barrier=(24.9845,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.427882,'amu*angstrom^2'), symmetry=1, barrier=(9.83785,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.08698,'amu*angstrom^2'), symmetry=1, barrier=(24.9917,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(3.78589,'amu*angstrom^2'), symmetry=1, barrier=(87.0452,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.39919,0.0569618,-5.26172e-05,2.56105e-08,-5.10512e-12,42641.9,23.3828], Tmin=(100,'K'), Tmax=(1188.86,'K')), NASAPolynomial(coeffs=[11.3175,0.023591,-1.0513e-05,2.00016e-09,-1.40222e-13,40283.6,-26.1833], Tmin=(1188.86,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(353.765,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CCsJOOC) + radical(Cds_P)"""),
)

species(
    label = '[CH2][CH]OOC=C(2967)',
    ...
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.3316,0.0570618,-5.22952e-05,2.49259e-08,-4.82038e-12,38660.4,25.2167], Tmin=(100,'K'), Tmax=(1230.98,'K')), NASAPolynomial(coeffs=[12.1085,0.0220424,-9.62191e-06,1.81474e-09,-1.26646e-13,36007.2,-29.0148], Tmin=(1230.98,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(320.631,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CJCOOH) + radical(CCsJOOC)"""),
)

species(
    label = '[CH]=[C]OOCC(2968)',
    structure = SMILES('[CH]=[C]OOCC'),
    E0 = (407.068,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,350,500,795,815,2750,2800,2850,1350,1500,750,1050,1375,1000,3120,650,792.5,1650,2750,2850,1437.5,1250,1305,750,350],'cm^-1')),
        HinderedRotor(inertia=(0.23178,'amu*angstrom^2'), symmetry=1, barrier=(7.01224,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.241349,'amu*angstrom^2'), symmetry=1, barrier=(7.0149,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.460083,'amu*angstrom^2'), symmetry=1, barrier=(13.5071,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.60848,'amu*angstrom^2'), symmetry=1, barrier=(47.1584,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.64907,0.0561341,-6.2051e-05,4.21075e-08,-1.23861e-11,49039.7,25.3325], Tmin=(100,'K'), Tmax=(805.61,'K')), NASAPolynomial(coeffs=[6.78055,0.0306542,-1.46068e-05,2.84423e-09,-2.01288e-13,48213,1.68547], Tmin=(805.61,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(407.068,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C=CJO) + radical(Cds_P)"""),
)
...
species(
    ...
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.43231,0.0453159,-1.19153e-05,-2.18085e-08,1.27683e-11,7697.08,23.2449], Tmin=(100,'K'), Tmax=(975.905,'K')), NASAPolynomial(coeffs=[15.192,0.0149522,-5.2602e-06,9.80585e-10,-7.22132e-14,3771.73,-49.1537], Tmin=(975.905,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(63.1454,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-O2s(Cds-Cd)) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(Cds-CdsHH)"""),
)
...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.15935,0.0239693,-4.52773e-05,4.81915e-08,-1.8592e-11,40635.7,16.5561], Tmin=(100,'K'), Tmax=(873.251,'K')), NASAPolynomial(coeffs=[2.07181,0.015386,-7.23304e-06,1.35895e-09,-9.18716e-14,41342.9,24.6168], Tmin=(873.251,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(337.657,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo library: DFT_QCI_thermo + radical(ROOJ) + radical(C=CJO)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'C=[C]OOC=C(2963)'],
    products = ['C=[C]OO[CH]C(664)'],
    transitionState = 'TS2',
...
reaction(
    ...
    products = ['C=[C]OO[CH]C(664)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(7.35017e+06,'m^3/(mol*s)'), n=0.0284742, Ea=(28.6273,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [Y_rad;Y_rad]
Euclidian distance = 0
family: R_Recombination
Ea raised from -14.4 to 28.6 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction9',
    reactants = ['C=[C]OO[CH]C(664)'],
    products = ['C=COOC=C(2969)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['CHCH3(T)(80)', 'C=[C]O[O](2971)'],
    products = ['C=[C]OO[CH]C(664)'],
...
reaction(
    label = 'reaction12',
    reactants = ['C[CH]O[O](159)', 'H2CC(T)(265)'],
    products = ['C=[C]OO[CH]C(664)'],
