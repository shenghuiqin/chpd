...
species(
    label = 'C[CH]CC([CH]CC)OO(823)',
    structure = SMILES('C[CH]CC([CH]CC)OO'),
    E0 = (78.251,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3050,390,425,1340,1360,335,370,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (130.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.405968,0.104439,-0.000103375,6.49743e-08,-1.81588e-11,9563.47,40.3395], Tmin=(100,'K'), Tmax=(836.396,'K')), NASAPolynomial(coeffs=[8.29245,0.0628413,-2.87762e-05,5.51649e-09,-3.87466e-13,8108.35,-0.0716975], Tmin=(836.396,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(78.251,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(523.812,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJC) + radical(CCJCOOH)"""),
)
...
species(
    ...
    molecularWeight = (130.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.649051,0.0878317,-2.47386e-05,-1.07109e-07,1.14661e-10,8799.73,36.5204], Tmin=(100,'K'), Tmax=(474.113,'K')), NASAPolynomial(coeffs=[6.06632,0.0658154,-3.00281e-05,5.71098e-09,-3.97869e-13,8019.82,11.6205], Tmin=(474.113,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(72.2824,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(523.812,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJC) + radical(RCCJC)"""),
)

species(
    label = 'C[CH][CH]C(CCC)OO(826)',
...
species(
    ...
    molecularWeight = (114.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.434713,0.0613698,2.45221e-05,-7.56001e-08,3.46488e-11,-25922.1,27.8641], Tmin=(100,'K'), Tmax=(924.73,'K')), NASAPolynomial(coeffs=[15.3787,0.0403935,-1.22816e-05,1.99578e-09,-1.34084e-13,-30552.9,-53.1572], Tmin=(924.73,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-216.726,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(515.497,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Oxetane)"""),
)

species(
    label = '[CH2]C(C)C(CCC)OO(830)',
    structure = SMILES('[CH2]C(C)C(CCC)OO'),
    E0 = (-117.222,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3615,1310,387.5,850,1000,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    ...
    molecularWeight = (131.193,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.825036,0.102837,-8.08709e-05,3.41725e-08,-6.01332e-12,-39540.7,38.1788], Tmin=(100,'K'), Tmax=(1319.22,'K')), NASAPolynomial(coeffs=[16.5936,0.0500218,-2.08179e-05,3.8247e-09,-2.62205e-13,-44136.5,-50.6819], Tmin=(1319.22,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-330.225,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(552.912,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ)"""),
)
...
reaction(
    label = 'reaction16',
    reactants = ['H(3)', 'CC=CC(CCC)OO(818)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(3)', 'C=CCC(CCC)OO(819)'],
    products = ['C[CH]CC(CCC)OO(141)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction18',
    reactants = ['CCC[CH]OO(214)', 'C3H6(59)'],
    products = ['C[CH]CC(CCC)OO(141)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction22',
    reactants = ['OH(5)', 'C[CH]CC([O])CCC(820)'],
    products = ['C[CH]CC(CCC)OO(141)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction23',
    reactants = ['C[CH]C[CH]CCC(112)', 'HO2(10)'],
    products = ['C[CH]CC(CCC)OO(141)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction25',
    reactants = ['npropyl(70)', 'C[CH]C[CH]OO(242)'],
    products = ['C[CH]CC(CCC)OO(141)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction26',
    reactants = ['CCC[CH]OO(214)', 'C3H6(T)(82)'],
    products = ['C[CH]CC(CCC)OO(141)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction27',
    reactants = ['H(3)', 'C[CH]C[C](CCC)OO(821)'],
    products = ['C[CH]CC(CCC)OO(141)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction28',
    reactants = ['C2H5(32)', '[CH2]C(C[CH]C)OO(822)'],
    products = ['C[CH]CC(CCC)OO(141)'],
...
reaction(
    label = 'reaction29',
    reactants = ['H(3)', 'C[CH]CC([CH]CC)OO(823)'],
    products = ['C[CH]CC(CCC)OO(141)'],
...
reaction(
    label = 'reaction30',
    reactants = ['CH3(18)', '[CH2]CC(C[CH]C)OO(824)'],
    products = ['C[CH]CC(CCC)OO(141)'],
...
reaction(
    label = 'reaction31',
    reactants = ['H(3)', 'C[CH]CC(C[CH]C)OO(825)'],
    products = ['C[CH]CC(CCC)OO(141)'],
...
reaction(
    label = 'reaction32',
    reactants = ['H(3)', 'C[CH][CH]C(CCC)OO(826)'],
    products = ['C[CH]CC(CCC)OO(141)'],
...
reaction(
    label = 'reaction33',
    reactants = ['H(3)', '[CH2]CCC(C[CH]C)OO(827)'],
    products = ['C[CH]CC(CCC)OO(141)'],
...
reaction(
    label = 'reaction34',
    reactants = ['H(3)', '[CH2][CH]CC(CCC)OO(828)'],
    products = ['C[CH]CC(CCC)OO(141)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CH2(S)(24)', 'C[CH]CC(CC)OO(829)'],
    products = ['C[CH]CC(CCC)OO(141)'],
...
reaction(
    label = 'reaction36',
    reactants = ['C[CH]CC(CCC)OO(141)'],
    products = ['OH(5)', 'CCCC1CC(C)O1(766)'],
...
reaction(
    label = 'reaction37',
    reactants = ['[CH2]C(C)C(CCC)OO(830)'],
    products = ['C[CH]CC(CCC)OO(141)'],
...
reaction(
    label = 'reaction39',
    reactants = ['CHCH3(T)(80)', '[CH2]C(CCC)OO(380)'],
    products = ['C[CH]CC(CCC)OO(141)'],
...
reaction(
    label = 'reaction40',
    reactants = ['CH3(18)', '[CH]CC(CCC)OO(832)'],
    products = ['C[CH]CC(CCC)OO(141)'],
...
reaction(
    label = 'reaction41',
    reactants = ['H(3)', 'C[C]CC(CCC)OO(833)'],
    products = ['C[CH]CC(CCC)OO(141)'],
