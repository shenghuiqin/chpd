...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.89427,0.0754764,-9.48692e-05,8.32003e-08,-3.05765e-11,10936.2,29.7841], Tmin=(100,'K'), Tmax=(813.668,'K')), NASAPolynomial(coeffs=[3.62267,0.0491011,-2.235e-05,4.20368e-09,-2.89044e-13,10921.2,19.8205], Tmin=(813.668,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(90.0562,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(ROOJ)"""),
)
...
species(
    ...
    molecularWeight = (102.132,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.827914,0.0748845,-7.81758e-05,5.31417e-08,-1.59737e-11,11657.3,29.7783], Tmin=(100,'K'), Tmax=(785.036,'K')), NASAPolynomial(coeffs=[6.79337,0.0444884,-2.00964e-05,3.81926e-09,-2.66537e-13,10720.7,2.44223], Tmin=(785.036,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(96.0129,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(CCJCOOH)"""),
)
...
species(
    ...
    molecularWeight = (102.132,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.868193,0.0748547,-8.90986e-05,7.3963e-08,-2.63243e-11,10936.8,30.0505], Tmin=(100,'K'), Tmax=(800.828,'K')), NASAPolynomial(coeffs=[4.67107,0.047229,-2.11876e-05,3.971e-09,-2.7308e-13,10604.5,14.2764], Tmin=(800.828,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(90.0442,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(RCCJC)"""),
)
...
species(
    ...
    molecularWeight = (103.14,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.742767,0.0768242,-6.60511e-05,3.3544e-08,-7.55105e-12,-8044.43,27.1696], Tmin=(100,'K'), Tmax=(1014.3,'K')), NASAPolynomial(coeffs=[8.43196,0.0465011,-2.12077e-05,4.06991e-09,-2.8642e-13,-9604.26,-10.0355], Tmin=(1014.3,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-67.8243,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(407.409,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCsJOOH)"""),
)

species(
    label = 'CCC[CH]COO(197)',
    ...
    molecularWeight = (103.14,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.773667,0.076018,-6.48777e-05,3.25038e-08,-7.20338e-12,-6622.32,29.2132], Tmin=(100,'K'), Tmax=(1029.32,'K')), NASAPolynomial(coeffs=[8.54306,0.0458255,-2.08788e-05,4.00661e-09,-2.81973e-13,-8221.75,-8.49413], Tmin=(1029.32,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-55.9918,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(407.409,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCJCOOH)"""),
)

species(
    label = 'CC[CH]CCOO(198)',
    ...
    molecularWeight = (103.14,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.74849,0.0609333,8.09715e-06,-1.41911e-07,1.39194e-10,-7381.62,26.2198], Tmin=(100,'K'), Tmax=(438.025,'K')), NASAPolynomial(coeffs=[4.84726,0.0514349,-2.37535e-05,4.5462e-09,-3.17896e-13,-7833.43,11.7694], Tmin=(438.025,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-61.9485,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(407.409,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(RCCJCC)"""),
)

species(
    label = '[CH2]CCCCOO(200)',
...
species(
    ...
    E0 = (-102.207,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,2750,2800,2850,1350,1500,750,1050,1375,1000,317.573,317.643,317.669,2306.21],'cm^-1')),
        HinderedRotor(inertia=(0.0853762,'amu*angstrom^2'), symmetry=1, barrier=(6.11053,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00167105,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0853758,'amu*angstrom^2'), symmetry=1, barrier=(6.11103,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0853844,'amu*angstrom^2'), symmetry=1, barrier=(6.11029,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (87.1402,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.99416,0.0524083,-2.52597e-05,5.29933e-09,-4.20646e-13,-12229.1,22.5801], Tmin=(100,'K'), Tmax=(3189.55,'K')), NASAPolynomial(coeffs=[27.0274,0.0173474,-7.04667e-06,1.13208e-09,-6.57605e-14,-26332.9,-124.302], Tmin=(3189.55,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-102.207,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(390.78,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCOJ)"""),
)
...
species(
    label = 'C[CH]CCC[O](312)',
    structure = SMILES('C[CH]CCC[O]'),
    E0 = (92.2397,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,180,1732.75,1732.77,1732.92],'cm^-1')),
        HinderedRotor(inertia=(0.217951,'amu*angstrom^2'), symmetry=1, barrier=(5.01112,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.217996,'amu*angstrom^2'), symmetry=1, barrier=(5.01215,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.217944,'amu*angstrom^2'), symmetry=1, barrier=(5.01097,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.217927,'amu*angstrom^2'), symmetry=1, barrier=(5.01057,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.1323,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.62941,0.0589619,-6.64136e-05,6.28784e-08,-2.55287e-11,11172.6,26.6556], Tmin=(100,'K'), Tmax=(804.103,'K')), NASAPolynomial(coeffs=[0.397963,0.0504416,-2.31981e-05,4.39765e-09,-3.04222e-13,11844.1,35.2724], Tmin=(804.103,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(92.2397,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(RCCJC)"""),
)
...
species(
    label = 'C[CH]C[CH]COO(313)',
    structure = SMILES('C[CH]C[CH]COO'),
    E0 = (138.454,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3050,390,425,1340,1360,335,370,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3615,1310,387.5,850,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (102.132,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.642774,0.0803145,-9.978e-05,8.33007e-08,-2.9687e-11,16766.9,32.406], Tmin=(100,'K'), Tmax=(781.387,'K')), NASAPolynomial(coeffs=[5.51147,0.0475972,-2.2012e-05,4.18515e-09,-2.90281e-13,16244,11.6409], Tmin=(781.387,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(138.454,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(RCCJC) + radical(CCJCOOH)"""),
)

species(
    label = 'C[CH][CH]CCOO(314)',
    structure = SMILES('C[CH][CH]CCOO'),
    E0 = (132.498,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3050,390,425,1340,1360,335,370,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3615,1310,387.5,850,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,206.784,808.031,1636.36],'cm^-1')),
    ...
    molecularWeight = (102.132,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.83363,0.0792471,-0.000109658,1.02803e-07,-3.88704e-11,16040.5,31.9768], Tmin=(100,'K'), Tmax=(829.527,'K')), NASAPolynomial(coeffs=[2.10577,0.0526404,-2.45272e-05,4.63374e-09,-3.18262e-13,16533.8,30.3228], Tmin=(829.527,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(132.498,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(RCCJC) + radical(RCCJCC)"""),
)

species(
    label = 'C[CH]CC[CH]OO(315)',
    ...
    molecularWeight = (102.132,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.609584,0.0811657,-0.000101188,8.47372e-08,-3.0236e-11,15344.9,30.3694], Tmin=(100,'K'), Tmax=(784.171,'K')), NASAPolynomial(coeffs=[5.46283,0.0481602,-2.22732e-05,4.23194e-09,-2.93328e-13,14837.3,9.75248], Tmin=(784.171,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(126.622,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(RCCJC) + radical(CCsJOOH)"""),
)

species(
    label = '[CH2][CH]CCCOO(316)',
    structure = SMILES('[CH2][CH]CCCOO'),
    E0 = (143.286,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3615,1310,387.5,850,1000,3025,407.5,1350,352.5,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (102.132,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.49992,0.0655715,-2.35844e-05,-7.25618e-08,8.174e-11,17312.5,28.9966], Tmin=(100,'K'), Tmax=(475.686,'K')), NASAPolynomial(coeffs=[5.84451,0.0470008,-2.16668e-05,4.13384e-09,-2.88233e-13,16695.9,9.12832], Tmin=(475.686,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(143.286,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(RCCJC) + radical(RCCJ)"""),
)
...
species(
    ...
    molecularWeight = (86.1323,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.23156,0.0203289,8.32978e-05,-1.23425e-07,5.04033e-11,-28181.2,15.7654], Tmin=(100,'K'), Tmax=(906.301,'K')), NASAPolynomial(coeffs=[11.8893,0.0259202,-5.7576e-06,7.84818e-10,-5.18966e-14,-31911.9,-40.8019], Tmin=(906.301,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-234.985,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(378.308,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Tetrahydrofuran)"""),
)

species(
    label = '[CH2]C(C)CCOO(318)',
...
species(
    ...
    molecularWeight = (103.14,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.899161,0.0736973,-7.0666e-05,4.65405e-08,-1.41875e-11,-32929.3,28.919], Tmin=(100,'K'), Tmax=(760.411,'K')), NASAPolynomial(coeffs=[5.54113,0.0492784,-2.24957e-05,4.30761e-09,-3.02284e-13,-33635.3,7.79569], Tmin=(760.411,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-274.677,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCOJ)"""),
)
...
species(
    ...
    molecularWeight = (88.1051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.2489,0.063427,-5.89518e-05,3.08359e-08,-6.84941e-12,26026,23.9566], Tmin=(100,'K'), Tmax=(1053.34,'K')), NASAPolynomial(coeffs=[9.4376,0.0323308,-1.46694e-05,2.80924e-09,-1.97541e-13,24300.9,-15.9747], Tmin=(1053.34,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(215.589,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCJ2_triplet)"""),
)
...
species(
    ...
    molecularWeight = (102.132,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.631903,0.0778479,-7.14825e-05,3.71585e-08,-8.24223e-12,23187.4,27.3193], Tmin=(100,'K'), Tmax=(1051.71,'K')), NASAPolynomial(coeffs=[10.4121,0.0406503,-1.84292e-05,3.5285e-09,-2.4808e-13,21130.2,-20.3578], Tmin=(1051.71,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(191.808,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCJ2_triplet)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['O2(2)', '[CH2]CCCC(71)'],
    products = ['CCCCCO[O](108)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2]CO[O](102)', 'npropyl(70)'],
    products = ['CCCCCO[O](108)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction8',
    reactants = ['C2H5(32)', '[CH2]CCO[O](201)'],
    products = ['CCCCCO[O](108)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(8.73e+14,'cm^3/(mol*s)'), n=-0.699, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(200,'K'), Tmax=(2000,'K'), comment="""From training reaction 11 used for C_rad/H2/Cs;C_rad/H2/Cs
Exact match found for rate rule [C_rad/H2/Cs;C_rad/H2/Cs]
...
reaction(
    label = 'reaction10',
    reactants = ['butyl_1(69)', '[CH2]O[O](203)'],
    products = ['CCCCCO[O](108)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]CCCO[O](205)', 'CH3(18)'],
    products = ['CCCCCO[O](108)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction11',
    reactants = ['CH2(S)(24)', 'CCCCO[O](107)'],
    products = ['CCCCCO[O](108)'],
...
reaction(
    label = 'reaction2',
    reactants = ['CCCCCO[O](108)'],
    products = ['CCCC[CH]OO(196)'],
...
reaction(
    label = 'reaction21',
    reactants = ['CH2CH2OOH(55)', 'C3H6(59)'],
    products = ['C[CH]CCCOO(199)'],
...
reaction(
    label = 'reaction27',
    reactants = ['[CH2]CC[CH]C(93)', 'HO2(10)'],
    products = ['C[CH]CCCOO(199)'],
...
reaction(
    label = 'reaction29',
    reactants = ['C3H6(T)(82)', 'CH2CH2OOH(55)'],
    products = ['C[CH]CCCOO(199)'],
    transitionState = 'TS29',
    kinetics = Arrhenius(A=(9.73519e+06,'m^3/(mol*s)'), n=0.0484062, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [C_rad/H2/Cs;Y_rad]
Euclidian distance = 0
family: R_Recombination
Ea raised from -0.3 to 0 kJ/mol."""),
)
...
reaction(
    label = 'reaction30',
    reactants = ['[CH2]C[CH]C(86)', '[CH2]OO(239)'],
    products = ['C[CH]CCCOO(199)'],
...
reaction(
    label = 'reaction31',
    reactants = ['H(3)', 'C[CH]C[CH]COO(313)'],
    products = ['C[CH]CCCOO(199)'],
...
reaction(
    label = 'reaction32',
    reactants = ['H(3)', 'C[CH][CH]CCOO(314)'],
    products = ['C[CH]CCCOO(199)'],
...
reaction(
    label = 'reaction33',
    reactants = ['H(3)', 'C[CH]CC[CH]OO(315)'],
    products = ['C[CH]CCCOO(199)'],
...
reaction(
    label = 'reaction34',
    reactants = ['H(3)', '[CH2][CH]CCCOO(316)'],
    products = ['C[CH]CCCOO(199)'],
...
reaction(
    label = 'reaction35',
    reactants = ['C[CH]CCCOO(199)'],
    products = ['OH(5)', 'CC1CCCO1(317)'],
...
reaction(
    label = 'reaction38',
    reactants = ['QOOH_1(211)', 'CHCH3(T)(80)'],
    products = ['C[CH]CCCOO(199)'],
