...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0657917,0.0894452,-6.60907e-05,2.65915e-08,-4.61898e-12,-33559.9,31.6755], Tmin=(100,'K'), Tmax=(1287.73,'K')), NASAPolynomial(coeffs=[11.935,0.0525767,-2.31448e-05,4.35815e-09,-3.02597e-13,-36616.8,-28.588], Tmin=(1287.73,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-280.187,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['CCCCCC(C)[O](174)', 'OH(5)'],
    products = ['CCCCCC(C)OO(228)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['C[CH]CCCCC(75)', 'HO2(10)'],
    products = ['CCCCCC(C)OO(228)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'CCCCCC(C)O[O](136)'],
    products = ['CCCCCC(C)OO(228)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[CH2]CCCC(71)', 'C[CH]OO(225)'],
    products = ['CCCCCC(C)OO(228)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CCCCC[CH]OO(1020)', 'CH3(18)'],
    products = ['CCCCCC(C)OO(228)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['H(3)', 'CCCCC[C](C)OO(152)'],
    products = ['CCCCCC(C)OO(228)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['butyl_1(69)', 'QOOH_3(384)'],
    products = ['CCCCCC(C)OO(228)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(3)', 'CCCC[CH]C(C)OO(153)'],
    products = ['CCCCCC(C)OO(228)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['npropyl(70)', '[CH2]CC(C)OO(1544)'],
    products = ['CCCCCC(C)OO(228)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(8.73e+14,'cm^3/(mol*s)'), n=-0.699, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(200,'K'), Tmax=(2000,'K'), comment="""From training reaction 11 used for C_rad/H2/Cs;C_rad/H2/Cs
Exact match found for rate rule [C_rad/H2/Cs;C_rad/H2/Cs]
...
reaction(
    label = 'reaction10',
    reactants = ['C2H5(32)', '[CH2]CCC(C)OO(1545)'],
    products = ['CCCCCC(C)OO(228)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(3)', 'CC[CH]CCC(C)OO(156)'],
    products = ['CCCCCC(C)OO(228)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(3)', 'CCC[CH]CC(C)OO(155)'],
    products = ['CCCCCC(C)OO(228)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CH3(18)', '[CH2]CCCC(C)OO(1049)'],
    products = ['CCCCCC(C)OO(228)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(3)', 'C[CH]CCCC(C)OO(157)'],
    products = ['CCCCCC(C)OO(228)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(3)', '[CH2]C(CCCCC)OO(154)'],
    products = ['CCCCCC(C)OO(228)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(3)', '[CH2]CCCCC(C)OO(158)'],
    products = ['CCCCCC(C)OO(228)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CCCCCCOO(1030)', 'CH2(S)(24)'],
    products = ['CCCCCC(C)OO(228)'],
...
network(
    ...
    reactants = [
        ('C[CH]CCCCC(75)', 'HO2(10)'),
        ('H(3)', 'CCCCCC(C)O[O](136)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
