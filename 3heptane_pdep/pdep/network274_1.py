...
species(
    label = 'CC=CCO[C]=O(2344)',
    structure = SMILES('CC=CCO[C]=O'),
    E0 = (-136.403,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1855,455,950,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,198.491,198.491,198.491],'cm^-1')),
        HinderedRotor(inertia=(0.873517,'amu*angstrom^2'), symmetry=1, barrier=(24.422,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00427876,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.988193,'amu*angstrom^2'), symmetry=1, barrier=(27.6281,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00122283,'amu*angstrom^2'), symmetry=1, barrier=(13.8841,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.3657,0.0540213,-3.76379e-05,1.33255e-08,-1.9359e-12,-16307.7,25.5287], Tmin=(100,'K'), Tmax=(1574.88,'K')), NASAPolynomial(coeffs=[12.4524,0.0258616,-1.08162e-05,1.97111e-09,-1.33426e-13,-19799.7,-32.9933], Tmin=(1574.88,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-136.403,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-(Cds-Cds)OsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-OdOsH) + radical((O)CJOCC)"""),
)

species(
    label = 'CCC=CO[C]=O(2345)',
    structure = SMILES('CCC=CO[C]=O'),
    E0 = (-156.422,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1855,455,950,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.922904,'amu*angstrom^2'), symmetry=1, barrier=(21.2194,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.922955,'amu*angstrom^2'), symmetry=1, barrier=(21.2205,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.922836,'amu*angstrom^2'), symmetry=1, barrier=(21.2178,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.922843,'amu*angstrom^2'), symmetry=1, barrier=(21.218,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.682269,0.063556,-4.52763e-05,1.00584e-08,1.42638e-12,-18685.6,24.3821], Tmin=(100,'K'), Tmax=(1048.85,'K')), NASAPolynomial(coeffs=[16.0776,0.0212928,-8.35983e-06,1.54687e-09,-1.08987e-13,-22820,-54.9393], Tmin=(1048.85,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-156.422,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-Cd)) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-OdOsH) + radical((O)CJOC)"""),
)
...
species(
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.48401,0.0587094,-4.65822e-05,2.16988e-08,-4.50978e-12,-7495.46,27.4235], Tmin=(100,'K'), Tmax=(1083.07,'K')), NASAPolynomial(coeffs=[7.39145,0.0368916,-1.63651e-05,3.0987e-09,-2.16341e-13,-8775.07,-1.54776], Tmin=(1083.07,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-63.0503,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdOsH) + radical(RCCJC) + radical((O)CJOCC)"""),
)
...
species(
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.741009,0.062537,-4.42313e-05,1.39128e-08,-1.24309e-12,-7163.33,29.7684], Tmin=(100,'K'), Tmax=(1211.27,'K')), NASAPolynomial(coeffs=[14.8948,0.0255061,-1.03976e-05,1.90905e-09,-1.31499e-13,-11304.4,-44.1688], Tmin=(1211.27,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-60.598,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdOsH) + radical(CCJCO) + radical(CCsJOC(O)H)"""),
)

species(
    label = '[CH2]CCCO[C]=O(2348)',
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.05878,0.0624267,-4.89735e-05,2.0202e-08,-3.44746e-12,-6176.72,27.993], Tmin=(100,'K'), Tmax=(1359.94,'K')), NASAPolynomial(coeffs=[12.3052,0.0293477,-1.24876e-05,2.31599e-09,-1.59459e-13,-9235.61,-29.722], Tmin=(1359.94,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-52.2503,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdOsH) + radical((O)CJOCC) + radical(RCCJ)"""),
)

species(
    label = 'C[CH][CH]COC=O(2349)',
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.63107,0.0499953,-2.59407e-05,5.96335e-09,-5.15564e-13,-7229.06,29.7799], Tmin=(100,'K'), Tmax=(2143.61,'K')), NASAPolynomial(coeffs=[18.5321,0.0222268,-9.14698e-06,1.56072e-09,-9.77636e-14,-15340.9,-66.6646], Tmin=(2143.61,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-60.8301,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdOsH) + radical(CCJCO) + radical(RCCJC)"""),
)

species(
    label = '[CH2]C[CH]COC=O(2350)',
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.19384,0.0538434,-2.87615e-05,5.04411e-09,2.82417e-13,-5909.78,30.3933], Tmin=(100,'K'), Tmax=(1374.11,'K')), NASAPolynomial(coeffs=[13.0108,0.0291838,-1.24744e-05,2.30028e-09,-1.5683e-13,-10076.8,-33.7178], Tmin=(1374.11,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-50.0301,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdOsH) + radical(RCCJ) + radical(CCJCO)"""),
)
...
species(
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.910711,0.0555643,-1.63648e-05,-1.92708e-08,1.12285e-11,-42318.5,24.935], Tmin=(100,'K'), Tmax=(1023.83,'K')), NASAPolynomial(coeffs=[15.6771,0.0244916,-9.83855e-06,1.87326e-09,-1.35111e-13,-46737.2,-53.465], Tmin=(1023.83,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-352.87,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-Cd)) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-OdOsH)"""),
)

species(
    label = 'CC=CCOC=O(2351)',
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.48968,0.0485294,-1.88331e-05,-1.42204e-09,1.71385e-12,-40085.4,25.4701], Tmin=(100,'K'), Tmax=(1374.25,'K')), NASAPolynomial(coeffs=[11.311,0.0319966,-1.39443e-05,2.58883e-09,-1.76883e-13,-43923,-29.1754], Tmin=(1374.25,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-334.085,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-(Cds-Cds)OsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-OdOsH)"""),
)
...
species(
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.753811,0.0643097,-5.27709e-05,2.31547e-08,-4.11824e-12,-7268.67,28.8071], Tmin=(100,'K'), Tmax=(1342.07,'K')), NASAPolynomial(coeffs=[13.7659,0.0255272,-9.42421e-06,1.62219e-09,-1.07152e-13,-10761.3,-37.7971], Tmin=(1342.07,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-61.4558,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CsCsCsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdOsH) + radical(Isobutyl) + radical((O)CJOCC)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'CC=CCO[C]=O(2344)'],
    products = ['CC[CH]CO[C]=O(502)'],
    transitionState = 'TS2',
...
reaction(
    ...
    products = ['CC[CH]CO[C]=O(502)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(23.3993,'m^3/(mol*s)'), n=2.021, Ea=(89.868,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Od_R;YJ] for rate rule [Od_Cdd-O2d;CJ]
Euclidian distance = 2.2360679775
Multiplied by reaction path degeneracy 2.0
family: R_Addition_MultipleBond
Ea raised from 85.2 to 89.9 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction5',
    reactants = ['CH3(18)', 'C=CCO[C]=O(1995)'],
    products = ['CC[CH]CO[C]=O(502)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction15',
    reactants = ['CH2(S)(24)', 'C[CH]CO[C]=O(558)'],
    products = ['CC[CH]CO[C]=O(502)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CC[CH]C[O](1328)', 'CO(12)'],
    products = ['CC[CH]CO[C]=O(502)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CC[CH]C[O](1328)', '[C]=O(261)'],
    products = ['CC[CH]CO[C]=O(502)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH]CC(84)', '[CH2]O[C]=O(1743)'],
    products = ['CC[CH]CO[C]=O(502)'],
