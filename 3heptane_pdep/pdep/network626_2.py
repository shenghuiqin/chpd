...
species(
    label = 'C[CH]CC=CC(1034)',
    structure = SMILES('C[CH]CC=CC'),
    E0 = (118.119,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2995,3025,975,1000,1300,1375,400,500,1630,1680,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3025,407.5,1350,352.5,310.96,1832.91],'cm^-1')),
        HinderedRotor(inertia=(0.0991372,'amu*angstrom^2'), symmetry=1, barrier=(6.80507,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.101249,'amu*angstrom^2'), symmetry=1, barrier=(6.79388,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.100081,'amu*angstrom^2'), symmetry=1, barrier=(6.80248,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0835806,'amu*angstrom^2'), symmetry=1, barrier=(6.80514,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (83.1515,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.47152,0.0514182,-2.3141e-05,3.93234e-09,-7.4959e-14,14301,25.9702], Tmin=(100,'K'), Tmax=(1757.11,'K')), NASAPolynomial(coeffs=[12.8225,0.032391,-1.27139e-05,2.18284e-09,-1.40002e-13,9260.29,-38.1824], Tmin=(1757.11,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(118.119,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(390.78,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(RCCJC)"""),
)

species(
    label = 'C=CCC[CH]C(283)',
    structure = SMILES('C=CCC[CH]C'),
    E0 = (130.364,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2950,3100,1380,975,1025,1650,3010,987.5,1337.5,450,1655,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,318.689,1188.38,1188.58],'cm^-1')),
        HinderedRotor(inertia=(0.0934311,'amu*angstrom^2'), symmetry=1, barrier=(6.68663,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0932583,'amu*angstrom^2'), symmetry=1, barrier=(6.69044,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0935312,'amu*angstrom^2'), symmetry=1, barrier=(6.68539,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0936709,'amu*angstrom^2'), symmetry=1, barrier=(6.69209,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (83.1515,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.31776,0.0525266,-2.34132e-05,3.02391e-09,3.6733e-13,15781,26.9544], Tmin=(100,'K'), Tmax=(1482.99,'K')), NASAPolynomial(coeffs=[10.9173,0.0348273,-1.37979e-05,2.42685e-09,-1.60043e-13,12032.9,-26.1782], Tmin=(1482.99,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(130.364,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(390.78,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(RCCJC)"""),
)
...
species(
    label = '[CH2]CCC[CH]C(113)',
    structure = SMILES('[CH2]CCC[CH]C'),
    E0 = (207.828,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,196.011,408.561,2850.35],'cm^-1')),
...
species(
    label = 'C=C[CH]CCC(284)',
    structure = SMILES('[CH2]C=CCCC'),
    E0 = (75.1716,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,180,474.322],'cm^-1')),
        HinderedRotor(inertia=(0.0988562,'amu*angstrom^2'), symmetry=1, barrier=(2.2729,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0990898,'amu*angstrom^2'), symmetry=1, barrier=(2.27827,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.11853,'amu*angstrom^2'), symmetry=1, barrier=(18.919,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.822854,'amu*angstrom^2'), symmetry=1, barrier=(18.919,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (83.1515,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.22847,0.049634,-7.96161e-08,-2.93552e-08,1.31409e-11,9150.61,24.359], Tmin=(100,'K'), Tmax=(1034.49,'K')), NASAPolynomial(coeffs=[11.7434,0.0338806,-1.33481e-05,2.4667e-09,-1.73174e-13,5642.5,-33.1668], Tmin=(1034.49,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(75.1716,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(390.78,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Allyl_P)"""),
)

species(
    label = '[CH2]CCCC=C(285)',
    structure = SMILES('[CH2]CCCC=C'),
    E0 = (141.164,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2950,3100,1380,975,1025,1650,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.91475,'amu*angstrom^2'), symmetry=1, barrier=(21.0319,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0763356,'amu*angstrom^2'), symmetry=1, barrier=(1.75511,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0100475,'amu*angstrom^2'), symmetry=1, barrier=(21.0351,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00185256,'amu*angstrom^2'), symmetry=1, barrier=(21.0341,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (83.1515,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.17123,0.0531402,-1.58874e-05,-9.87023e-09,5.64041e-12,17087.5,26.5129], Tmin=(100,'K'), Tmax=(1116.8,'K')), NASAPolynomial(coeffs=[10.9832,0.034888,-1.40592e-05,2.58112e-09,-1.78431e-13,13842.5,-26.6244], Tmin=(1116.8,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(141.164,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(390.78,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(RCCJ)"""),
)
...
species(
    ...
    E0 = (173.76,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2800,2850,1350,1500,750,1050,1375,1000,2950,3100,1380,975,1025,1650,314.061,314.908,4000],'cm^-1')),
        HinderedRotor(inertia=(0.1176,'amu*angstrom^2'), symmetry=1, barrier=(8.27672,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.229322,'amu*angstrom^2'), symmetry=1, barrier=(16.0885,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.117338,'amu*angstrom^2'), symmetry=1, barrier=(8.27832,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.399379,'amu*angstrom^2'), symmetry=1, barrier=(28.0163,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (83.1515,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.927627,0.0586121,-3.39837e-05,9.70483e-09,-1.11655e-12,21016.8,26.1062], Tmin=(100,'K'), Tmax=(1977.21,'K')), NASAPolynomial(coeffs=[16.2843,0.027544,-1.04133e-05,1.75728e-09,-1.11626e-13,14944.3,-58.4488], Tmin=(1977.21,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(173.76,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(390.78,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_S)"""),
)
...
species(
    ...
    E0 = (183.014,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,327.065,327.072],'cm^-1')),
        HinderedRotor(inertia=(0.00157584,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.13792,'amu*angstrom^2'), symmetry=1, barrier=(10.47,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.137922,'amu*angstrom^2'), symmetry=1, barrier=(10.47,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.137915,'amu*angstrom^2'), symmetry=1, barrier=(10.4701,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (83.1515,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.04463,0.0561071,-2.26829e-05,-4.02491e-09,3.87783e-12,22125.3,25.5843], Tmin=(100,'K'), Tmax=(1132.61,'K')), NASAPolynomial(coeffs=[11.5612,0.0341355,-1.36741e-05,2.49737e-09,-1.71925e-13,18770.1,-30.7568], Tmin=(1132.61,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(183.014,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(390.78,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_P)"""),
)
...
species(
    ...
    molecularWeight = (84.1595,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.25185,0.0626912,-3.52398e-05,9.76469e-09,-1.12882e-12,28576.1,33.234], Tmin=(100,'K'), Tmax=(1814.31,'K')), NASAPolynomial(coeffs=[11.2892,0.0405616,-1.69436e-05,3.0417e-09,-2.0242e-13,24934,-21.1696], Tmin=(1814.31,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(236.799,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(CsJ2_singlet-CsH)"""),
)
...
species(
    ...
    molecularWeight = (84.1595,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.23417,0.0618979,-3.62908e-05,1.05471e-08,-1.2753e-12,31276.3,24.1473], Tmin=(100,'K'), Tmax=(1769.95,'K')), NASAPolynomial(coeffs=[11.8524,0.037901,-1.59538e-05,2.887e-09,-1.93326e-13,27517.6,-33.1423], Tmin=(1769.95,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(259.235,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(CsJ2_singlet-CsH)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'C[CH]CC=CC(1034)'],
    products = ['C[CH]CC[CH]C(289)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction14',
    reactants = ['CHCH3(T)(80)', '[CH2]C[CH]C(86)'],
    products = ['C[CH]CC[CH]C(289)'],
...
reaction(
    label = 'reaction25',
    reactants = ['C2H5(32)', 'buten3yl1(269)'],
    products = ['C=CCCCC(123)'],
...
reaction(
    label = 'reaction2',
    reactants = ['npropyl(70)', 'CH2CHCH2(61)'],
    products = ['C=CCCCC(123)'],
...
reaction(
    label = 'reaction4',
    reactants = ['CH3(18)', '[CH2]CCC=C(276)'],
    products = ['C=CCCCC(123)'],
