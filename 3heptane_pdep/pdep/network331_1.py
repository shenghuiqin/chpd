...
species(
    label = 'C=C(C)O[C]=O(2000)',
    structure = SMILES('C=C(C)O[C]=O'),
    E0 = (-139.542,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1855,455,950,2950,3100,1380,975,1025,1650,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,233.814,333.715],'cm^-1')),
        HinderedRotor(inertia=(0.527603,'amu*angstrom^2'), symmetry=1, barrier=(21.0267,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.523195,'amu*angstrom^2'), symmetry=1, barrier=(20.9995,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.384921,'amu*angstrom^2'), symmetry=1, barrier=(16.0591,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (85.0813,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.72868,0.0503838,-4.59153e-05,2.19698e-08,-4.32515e-12,-16701.7,17.9126], Tmin=(100,'K'), Tmax=(1197,'K')), NASAPolynomial(coeffs=[10.3319,0.0216343,-9.88819e-06,1.90452e-09,-1.34374e-13,-18761.3,-25.1401], Tmin=(1197,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-139.542,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-Cd)) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + group(Cds-OdOsH) + radical((O)CJOC)"""),
)
...
species(
    ...
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.604,0.0543063,-5.69461e-05,3.36125e-08,-8.19191e-12,-5817.35,21.6666], Tmin=(100,'K'), Tmax=(983.839,'K')), NASAPolynomial(coeffs=[9.15684,0.023599,-1.01292e-05,1.88892e-09,-1.30843e-13,-7303.53,-14.6486], Tmin=(983.839,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-49.0745,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdOsH) + radical((O)CJOCC2) + radical(C2CsJOC(O)H)"""),
)

species(
    label = '[CH2][C](C)OC=O(2002)',
    ...
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.58674,0.0569245,-6.52431e-05,4.4591e-08,-1.28941e-11,-3983.32,23.4865], Tmin=(100,'K'), Tmax=(827.44,'K')), NASAPolynomial(coeffs=[7.54899,0.0281019,-1.29932e-05,2.49347e-09,-1.74912e-13,-4970.01,-4.14855], Tmin=(827.44,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-33.8133,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdOsH) + radical(C2CsJOC(O)H) + radical(CJC(C)OC)"""),
)

species(
    label = '[CH2]C([CH2])OC=O(2003)',
    structure = SMILES('[CH2]C([CH2])OC=O'),
    E0 = (-23.021,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2782.5,750,1395,475,1775,1000,1380,1390,370,380,2900,435,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,180,984.794],'cm^-1')),
        HinderedRotor(inertia=(0.593284,'amu*angstrom^2'), symmetry=1, barrier=(13.6408,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.593832,'amu*angstrom^2'), symmetry=1, barrier=(13.6534,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.66997,'amu*angstrom^2'), symmetry=1, barrier=(38.3959,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0070041,'amu*angstrom^2'), symmetry=1, barrier=(38.3854,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.3843,0.0613653,-7.06322e-05,4.6305e-08,-1.26351e-11,-2677.91,21.6386], Tmin=(100,'K'), Tmax=(879.468,'K')), NASAPolynomial(coeffs=[8.83813,0.0274625,-1.28062e-05,2.46933e-09,-1.73849e-13,-3988.95,-13.3642], Tmin=(879.468,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-23.021,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdOsH) + radical(CJC(C)OC) + radical(CJC(C)OC)"""),
)
...
species(
    ...
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.50755,0.0473374,-3.27001e-05,1.08473e-08,-1.4279e-12,-40314.4,20.103], Tmin=(100,'K'), Tmax=(1776.88,'K')), NASAPolynomial(coeffs=[14.8538,0.0172928,-7.33676e-06,1.33108e-09,-8.89911e-14,-45057.2,-51.957], Tmin=(1776.88,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-335.991,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-Cd)) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + group(Cds-OdOsH)"""),
)
...
species(
    label = '[CH2]CO[C]=O(462)',
    structure = SMILES('[CH2]CO[C]=O'),
    E0 = (1.65298,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,1855,455,950,202.639,202.643],'cm^-1')),
        HinderedRotor(inertia=(0.303104,'amu*angstrom^2'), symmetry=1, barrier=(8.83319,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0178271,'amu*angstrom^2'), symmetry=1, barrier=(18.7404,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0178271,'amu*angstrom^2'), symmetry=1, barrier=(18.7404,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'C=C(C)O[C]=O(2000)'],
    products = ['[CH2]C(C)O[C]=O(559)'],
    transitionState = 'TS2',
...
reaction(
    ...
    products = ['[CH2]C(C)O[C]=O(559)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(23.3993,'m^3/(mol*s)'), n=2.021, Ea=(79.984,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Od_R;YJ] for rate rule [Od_Cdd-O2d;CJ]
Euclidian distance = 2.2360679775
Multiplied by reaction path degeneracy 2.0
family: R_Addition_MultipleBond
Ea raised from 77.5 to 80.0 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction4',
    reactants = ['CH3(18)', 'C=CO[C]=O(399)'],
    products = ['[CH2]C(C)O[C]=O(559)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction10',
    reactants = ['CH2(S)(24)', '[CH2]CO[C]=O(462)'],
    products = ['[CH2]C(C)O[C]=O(559)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2]C(C)[O](1335)', 'CO(12)'],
    products = ['[CH2]C(C)O[C]=O(559)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]C(C)[O](1335)', '[C]=O(261)'],
    products = ['[CH2]C(C)O[C]=O(559)'],
