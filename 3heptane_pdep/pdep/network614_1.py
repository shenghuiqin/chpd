...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0704793,0.07933,-4.37243e-05,1.17101e-08,-1.26561e-12,8769.74,36.1539], Tmin=(100,'K'), Tmax=(2057.37,'K')), NASAPolynomial(coeffs=[19.6288,0.0413042,-1.60002e-05,2.72645e-09,-1.73961e-13,722.011,-72.3134], Tmin=(2057.37,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(71.6929,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(532.126,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(RCCJC)"""),
)

species(
    label = 'CC=CC[CH]CCC(1237)',
    structure = SMILES('CC=CC[CH]CCC'),
    E0 = (70.5702,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2995,3025,975,1000,1300,1375,400,500,1630,1680,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3025,407.5,1350,352.5,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (111.205,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.758729,0.0758533,-3.92445e-05,9.46463e-09,-9.1076e-13,8598.2,32.7821], Tmin=(100,'K'), Tmax=(2226.78,'K')), NASAPolynomial(coeffs=[18.1326,0.0446448,-1.8222e-05,3.17089e-09,-2.04173e-13,860.546,-64.9458], Tmin=(2226.78,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(70.5702,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(532.126,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(RCCJCC)"""),
)

species(
    label = 'C[CH]CC=CCCC(1238)',
    structure = SMILES('C[CH]CC=CCCC'),
    E0 = (71.6929,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2995,3025,975,1000,1300,1375,400,500,1630,1680,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3025,407.5,1350,352.5,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2]CCC[CH]CCC(1007)',
    structure = SMILES('[CH2]CCC[CH]CCC'),
    E0 = (160.28,'kJ/mol'),
    modes = [
...
species(
    label = 'C[CH]CCCC[CH]C(1241)',
    structure = SMILES('C[CH]CCCC[CH]C'),
    E0 = (149.468,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.213,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.41831,0.0680111,2.7171e-05,-1.5615e-07,1.31995e-10,18058.1,32.8836], Tmin=(100,'K'), Tmax=(447.832,'K')), NASAPolynomial(coeffs=[2.83749,0.0703965,-3.12669e-05,5.94383e-09,-4.16982e-13,17780,25.4907], Tmin=(447.832,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(149.468,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(552.912,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJC) + radical(RCCJC)"""),
)

species(
    label = 'CCC[CH][CH]CCC(1014)',
    structure = SMILES('CCC[CH][CH]CCC'),
    E0 = (149.492,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3000,3050,390,425,1340,1360,335,370,180,180,400,2041.17,3200],'cm^-1')),
        HinderedRotor(inertia=(0.0363047,'amu*angstrom^2'), symmetry=1, barrier=(3.33887,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2]CCCCC[CH]C(1012)',
    structure = SMILES('[CH2]CCCCC[CH]C'),
    E0 = (160.268,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2761.11,2772.22,2783.33,2794.44,2805.56,2816.67,2827.78,2838.89,2850,1425,1431.25,1437.5,1443.75,1450,1225,1237.5,1250,1262.5,1275,1270,1287.5,1305,1322.5,1340,700,725,750,775,800,300,325,350,375,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (112.213,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.447735,0.083168,-4.79776e-05,1.41591e-08,-1.80074e-12,19397.9,35.825], Tmin=(100,'K'), Tmax=(1617.37,'K')), NASAPolynomial(coeffs=[10.707,0.057795,-2.44458e-05,4.45946e-09,-3.01436e-13,16079.3,-18.6028], Tmin=(1617.37,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(160.268,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(552.912,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJ) + radical(RCCJC)"""),
)

species(
    label = '[CH2][CH]CCCCCC(1010)',
    structure = SMILES('[CH2][CH]CCCCCC'),
    E0 = (160.268,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2761.11,2772.22,2783.33,2794.44,2805.56,2816.67,2827.78,2838.89,2850,1425,1431.25,1437.5,1443.75,1450,1225,1237.5,1250,1262.5,1275,1270,1287.5,1305,1322.5,1340,700,725,750,775,800,300,325,350,375,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (112.213,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.447735,0.083168,-4.79776e-05,1.41591e-08,-1.80074e-12,19397.9,35.825], Tmin=(100,'K'), Tmax=(1617.37,'K')), NASAPolynomial(coeffs=[10.707,0.057795,-2.44458e-05,4.45946e-09,-3.01436e-13,16079.3,-18.6027], Tmin=(1617.37,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(160.268,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(552.912,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJC) + radical(RCCJ)"""),
)

species(
    label = 'CC[CH][CH]CCCC(1011)',
...
species(
    ...
    molecularWeight = (112.213,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.55411,0.0867123,-5.06134e-05,1.44888e-08,-1.66707e-12,-14724.7,35.0217], Tmin=(100,'K'), Tmax=(1981.86,'K')), NASAPolynomial(coeffs=[22.6407,0.0398965,-1.5179e-05,2.56884e-09,-1.63381e-13,-23918.2,-92.7451], Tmin=(1981.86,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-123.888,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(557.07,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH)"""),
)

species(
    label = 'CCCC=CCCC(1018)',
    structure = SMILES('CCCC=CCCC'),
    E0 = (-122.753,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.213,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.262025,0.0809411,-3.17244e-05,-5.78578e-09,5.24161e-12,-14599.8,33.9021], Tmin=(100,'K'), Tmax=(1159.54,'K')), NASAPolynomial(coeffs=[14.681,0.0508555,-2.05692e-05,3.76327e-09,-2.5875e-13,-19508.1,-46.6228], Tmin=(1159.54,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-122.753,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(557.07,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH)"""),
)

species(
    label = 'C=CCCCCCC(1017)',
    structure = SMILES('C=CCCCCCC'),
    E0 = (-111.643,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.213,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.426648,0.0849512,-4.26978e-05,5.19309e-09,1.55005e-12,-13258,34.9638], Tmin=(100,'K'), Tmax=(1248.81,'K')), NASAPolynomial(coeffs=[15.7327,0.0496311,-2.00188e-05,3.62701e-09,-2.46632e-13,-18575.9,-51.7183], Tmin=(1248.81,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-111.643,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(557.07,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH)"""),
)

species(
    label = 'CCC=CCCCC(1016)',
    ...
    molecularWeight = (112.213,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.262025,0.0809411,-3.17244e-05,-5.78578e-09,5.24161e-12,-14599.8,34.5953], Tmin=(100,'K'), Tmax=(1159.54,'K')), NASAPolynomial(coeffs=[14.681,0.0508555,-2.05692e-05,3.76327e-09,-2.5875e-13,-19508.1,-45.9296], Tmin=(1159.54,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-122.753,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(557.07,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'C[CH]CCC=CCC(1236)'],
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'CC=CC[CH]CCC(1237)'],
    products = ['C[CH]CC[CH]CCC(802)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(1.46e+08,'cm^3/(mol*s)'), n=1.64, Ea=(5.73208,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""From training reaction 2555 used for Cds-CsH_Cds-CsH;HJ
Exact match found for rate rule [Cds-CsH_Cds-CsH;HJ]
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', 'C[CH]CC=CCCC(1238)'],
    products = ['C[CH]CC[CH]CCC(802)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(1.46e+08,'cm^3/(mol*s)'), n=1.64, Ea=(5.73208,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""From training reaction 2555 used for Cds-CsH_Cds-CsH;HJ
Exact match found for rate rule [Cds-CsH_Cds-CsH;HJ]
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)', 'C=CCC[CH]CCC(1239)'],
    products = ['C[CH]CC[CH]CCC(802)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['C2H5(32)', 'C=CCC[CH]C(283)'],
    products = ['C[CH]CC[CH]CCC(802)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction25',
    reactants = ['CH2(S)(24)', 'C[CH]CC[CH]CC(111)'],
    products = ['C[CH]CC[CH]CCC(802)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[CH2]C(CC)CC[CH]C(997)'],
    products = ['C[CH]CC[CH]CCC(802)'],
...
reaction(
    label = 'reaction30',
    reactants = ['[CH2]C[CH]CCC(133)', 'CHCH3(T)(80)'],
    products = ['C[CH]CC[CH]CCC(802)'],
...
reaction(
    label = 'reaction31',
    reactants = ['[CH]CCC(90)', '[CH2]C[CH]C(86)'],
    products = ['C[CH]CC[CH]CCC(802)'],
