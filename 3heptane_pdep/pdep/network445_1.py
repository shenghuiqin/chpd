...
species(
    label = 'O=[C]CC=C=O(3449)',
    structure = SMILES('O=[C]CC=C=O'),
    E0 = (-22.7318,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2120,512.5,787.5,3010,987.5,1337.5,450,1655,1855,455,950,329.025],'cm^-1')),
        HinderedRotor(inertia=(0.109927,'amu*angstrom^2'), symmetry=1, barrier=(8.44375,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.109961,'amu*angstrom^2'), symmetry=1, barrier=(8.44565,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
species(
    ...
    molecularWeight = (84.0734,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.88818,0.0328175,9.85636e-06,-4.13901e-08,1.88828e-11,27.0453,21.3343], Tmin=(100,'K'), Tmax=(992.314,'K')), NASAPolynomial(coeffs=[15.7297,0.00949102,-3.96267e-06,8.6722e-10,-7.04813e-14,-4318.53,-53.3907], Tmin=(992.314,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-0.508181,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-OdCsH) + radical(CCCJ=O) + radical(C=COJ)"""),
)

species(
    label = 'O=[C][CH]CC=O(3451)',
    structure = SMILES('O=[C][CH]CC=O'),
    E0 = (49.9599,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1855,455,950,2750,2850,1437.5,1250,1305,750,350,2782.5,750,1395,475,1775,1000,3025,407.5,1350,352.5,2417.03],'cm^-1')),
        HinderedRotor(inertia=(0.0984899,'amu*angstrom^2'), symmetry=1, barrier=(6.65045,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0984206,'amu*angstrom^2'), symmetry=1, barrier=(6.65021,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0984197,'amu*angstrom^2'), symmetry=1, barrier=(6.65195,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.0734,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.05098,0.0477841,-6.88497e-05,6.17831e-08,-2.23784e-11,6074.21,23.9783], Tmin=(100,'K'), Tmax=(820.154,'K')), NASAPolynomial(coeffs=[4.69391,0.0258595,-1.22273e-05,2.32583e-09,-1.60384e-13,5944.55,13.6041], Tmin=(820.154,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(49.9599,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)CsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cds-OdCsH) + group(Cds-OdCsH) + radical(CCJCC=O) + radical(CCCJ=O)"""),
)

species(
    label = 'O=C=CCC=O(3452)',
    ...
    molecularWeight = (84.0734,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.32867,0.0352417,-2.25199e-05,7.01362e-09,-8.89684e-13,-21911.8,19.7252], Tmin=(100,'K'), Tmax=(1762.69,'K')), NASAPolynomial(coeffs=[10.0007,0.017832,-7.70474e-06,1.41039e-09,-9.49876e-14,-24616.5,-21.6367], Tmin=(1762.69,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-182.692,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cdd-O2d)CsHH) + group(Cds-(Cdd-O2d)CsH) + group(Cds-OdCsH)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'O=[C]CC=C=O(3449)'],
    products = ['O=[C]CC[C]=O(656)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction10',
    reactants = ['CO(12)', '[CH2]C[C]=O(1724)'],
    products = ['O=[C]CC[C]=O(656)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[C]=O(261)', '[CH2]C[C]=O(1724)'],
    products = ['O=[C]CC[C]=O(656)'],
