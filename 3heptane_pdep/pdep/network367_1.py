species(
    ...
    E0 = (3.24426,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,209.586,212.367,1893.68],'cm^-1')),
        HinderedRotor(inertia=(0.102209,'amu*angstrom^2'), symmetry=1, barrier=(3.24458,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.10423,'amu*angstrom^2'), symmetry=1, barrier=(3.28068,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (74.0785,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.27005,0.0413379,-4.22395e-05,3.35685e-08,-1.25327e-11,449.385,19.3025], Tmin=(100,'K'), Tmax=(728.849,'K')), NASAPolynomial(coeffs=[3.76815,0.0303928,-1.41095e-05,2.71181e-09,-1.90208e-13,303.342,13.0451], Tmin=(728.849,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(3.24426,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(CC(C)OJ)"""),
)
...
species(
    label = 'CH3COCH2O(2827)',
    structure = SMILES('CC(=O)C[O]'),
    E0 = (-147.861,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,375,552.5,462.5,1710,180,603.742],'cm^-1')),
        HinderedRotor(inertia=(0.019467,'amu*angstrom^2'), symmetry=1, barrier=(13.5271,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0194694,'amu*angstrom^2'), symmetry=1, barrier=(13.5273,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (73.0706,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.34419,0.0284803,2.09197e-06,-2.15819e-08,9.66853e-12,-17717,17.6523], Tmin=(100,'K'), Tmax=(1024.44,'K')), NASAPolynomial(coeffs=[10.0095,0.0165278,-6.72996e-06,1.28902e-09,-9.31498e-14,-20230.9,-24.1178], Tmin=(1024.44,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-147.861,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), label="""CH3COCH2O""", comment="""Thermo library: DFT_QCI_thermo"""),
)

species(
    label = 'CH3CHOCHO(2801)',
    structure = SMILES('CC([O])C=O'),
    E0 = (-131.41,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2782.5,750,1395,475,1775,1000,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,180],'cm^-1')),
        HinderedRotor(inertia=(0.035235,'amu*angstrom^2'), symmetry=1, barrier=(10.9571,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.127116,'amu*angstrom^2'), symmetry=1, barrier=(11.0203,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (73.0706,'amu'),
...
species(
    ...
    molecularWeight = (74.0785,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.86129,0.0552053,-8.93898e-05,8.63888e-08,-3.20555e-11,-6003.24,20.3815], Tmin=(100,'K'), Tmax=(856.569,'K')), NASAPolynomial(coeffs=[2.93631,0.0314135,-1.48539e-05,2.79313e-09,-1.89938e-13,-5498.76,19.3814], Tmin=(856.569,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-50.4887,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(C2CsJOH)"""),
)

species(
    label = 'CC([O])[CH]O(2829)',
...
species(
    ...
    molecularWeight = (74.0785,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.87813,0.0514663,-7.13262e-05,6.22164e-08,-2.20877e-11,-1795.74,21.5316], Tmin=(100,'K'), Tmax=(823.398,'K')), NASAPolynomial(coeffs=[5.03922,0.0277105,-1.27484e-05,2.39974e-09,-1.64655e-13,-2031.58,8.62444], Tmin=(823.398,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-15.5274,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CJCO) + radical(CCOJ)"""),
)

species(
    label = 'CC(O)[CH][O](2831)',
    structure = SMILES('CC(O)[CH][O]'),
    E0 = (-46.8186,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (74.0785,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.78663,0.0547149,-8.17115e-05,7.3908e-08,-2.64681e-11,-5557.1,20.7753], Tmin=(100,'K'), Tmax=(843.293,'K')), NASAPolynomial(coeffs=[4.72098,0.0285045,-1.32262e-05,2.48235e-09,-1.69324e-13,-5614.95,9.71024], Tmin=(843.293,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-46.8186,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCsJOH) + radical(CCOJ)"""),
)
...
species(
    ...
    molecularWeight = (74.0785,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.93711,0.0500478,-5.35414e-05,2.53458e-08,5.24647e-14,-5442.52,19.0951], Tmin=(100,'K'), Tmax=(608.37,'K')), NASAPolynomial(coeffs=[7.28515,0.0237171,-1.03976e-05,1.93182e-09,-1.3246e-13,-6256.68,-5.39165], Tmin=(608.37,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-45.8331,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(C2CsJOH) + radical(CC(C)OJ)"""),
)

species(
    label = '[CH2]C([O])CO(2833)',
    structure = SMILES('[CH2]C([O])CO'),
    E0 = (-10.8718,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2850,1437.5,1250,1305,750,350,3615,1277.5,1000,1380,1390,370,380,2900,435,381.764,381.833],'cm^-1')),
        HinderedRotor(inertia=(0.00115642,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0805205,'amu*angstrom^2'), symmetry=1, barrier=(8.33001,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0805429,'amu*angstrom^2'), symmetry=1, barrier=(8.32996,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (74.0785,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.73893,0.0494775,-5.03167e-05,2.79752e-08,-6.32001e-12,-1225.91,20.9805], Tmin=(100,'K'), Tmax=(1066.61,'K')), NASAPolynomial(coeffs=[9.79202,0.0192767,-7.84461e-06,1.42871e-09,-9.78167e-14,-2943.81,-18.3903], Tmin=(1066.61,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-10.8718,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(CJCO)"""),
)
...
species(
    ...
    molecularWeight = (74.0785,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.31586,0.027373,1.2589e-05,-3.52398e-08,1.51342e-11,-44816.9,20.2503], Tmin=(100,'K'), Tmax=(987.555,'K')), NASAPolynomial(coeffs=[10.6723,0.0166464,-6.23573e-06,1.17476e-09,-8.55401e-14,-47594.8,-25.6681], Tmin=(987.555,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-373.205,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-O2d)CsOsH) + group(Cs-CsHHH) + group(Cds-OdCsH)"""),
)
...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.06296,0.030692,-6.02123e-05,7.38395e-08,-3.15467e-11,4234.93,14.9107], Tmin=(100,'K'), Tmax=(854.471,'K')), NASAPolynomial(coeffs=[-2.91918,0.0321473,-1.61619e-05,3.10894e-09,-2.13693e-13,6226.42,48.5014], Tmin=(854.471,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(35.0118,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(178.761,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + radical(CCOJ) + radical(CCOJ)"""),
)
...
species(
    ...
    molecularWeight = (74.0785,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.38448,0.0300756,-3.76544e-06,-9.86654e-09,4.14128e-12,-6207.69,12.7849], Tmin=(100,'K'), Tmax=(1165.02,'K')), NASAPolynomial(coeffs=[7.46423,0.0237447,-9.91853e-06,1.83998e-09,-1.27317e-13,-8145.25,-15.7336], Tmin=(1165.02,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-52.1343,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(253.591,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(12dioxetane)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'CH3COCH2O(2827)'],
    products = ['CC([O])C[O](584)'],
    transitionState = 'TS2',
