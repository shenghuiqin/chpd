species(
    label = 'O=[C]CO[C]=O(455)',
    structure = SMILES('O=[C]CO[C]=O'),
    E0 = (-121.854,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,1850,1860,440,470,900,1000,180,744.055],'cm^-1')),
        HinderedRotor(inertia=(0.00645332,'amu*angstrom^2'), symmetry=1, barrier=(2.54212,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.948769,'amu*angstrom^2'), symmetry=1, barrier=(21.8141,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.948632,'amu*angstrom^2'), symmetry=1, barrier=(21.8109,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.0462,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.06199,0.0375154,-3.42725e-05,1.51226e-08,-2.60834e-12,-14581.6,21.0114], Tmin=(100,'K'), Tmax=(1405.72,'K')), NASAPolynomial(coeffs=[12.0417,0.00911812,-3.97073e-06,7.51918e-10,-5.26004e-14,-17387.4,-30.5335], Tmin=(1405.72,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-121.854,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(170.447,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-(Cds-O2d)OsHH) + group(Cds-OdCsH) + group(Cds-OdOsH) + radical((O)CJOCC) + radical(CsCJ=O)"""),
)
...
species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.41377,'amu*angstrom^2'), symmetry=1, barrier=(32.5055,'kJ/mol'), semiclassical=False),
...
species(
    ...
    molecularWeight = (86.0462,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.87199,0.0405829,-3.45228e-05,1.06264e-08,-5.90222e-14,-38587.5,17.4291], Tmin=(100,'K'), Tmax=(1044,'K')), NASAPolynomial(coeffs=[13.1705,0.00810442,-3.39139e-06,6.65936e-10,-4.91119e-14,-41535.8,-40.388], Tmin=(1044,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-321.516,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-Cd)) + group(Cds-(Cdd-O2d)OsH) + group(Cds-OdOsH)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'O=[C]OC=C=O(3543)'],
    products = ['O=[C]CO[C]=O(455)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction9',
    reactants = ['CO(12)', '[CH2]O[C]=O(1743)'],
    products = ['O=[C]CO[C]=O(455)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['[C]=O(261)', '[O]C[C]=O(2962)'],
    products = ['O=[C]CO[C]=O(455)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[C]=O(261)', '[CH2]O[C]=O(1743)'],
    products = ['O=[C]CO[C]=O(455)'],
