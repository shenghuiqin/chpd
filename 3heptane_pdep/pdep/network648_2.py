...
species(
    ...
    E0 = (26.362,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3025,407.5,1350,352.5,1583.99,1584.35],'cm^-1')),
        HinderedRotor(inertia=(0.00424396,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.291254,'amu*angstrom^2'), symmetry=1, barrier=(8.10752,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.289492,'amu*angstrom^2'), symmetry=1, barrier=(8.10477,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.289259,'amu*angstrom^2'), symmetry=1, barrier=(8.10445,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (71.1408,'amu'),
...
species(
    label = '[CH2]C(C)CCC(566)',
    structure = SMILES('[CH2]C(C)CCC'),
    E0 = (7.5235,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,180,3558.54],'cm^-1')),
        HinderedRotor(inertia=(3.66611,'amu*angstrom^2'), symmetry=1, barrier=(84.291,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.12852,'amu*angstrom^2'), symmetry=1, barrier=(2.95492,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.627377,'amu*angstrom^2'), symmetry=1, barrier=(14.4246,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00489458,'amu*angstrom^2'), symmetry=1, barrier=(2.9553,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.627365,'amu*angstrom^2'), symmetry=1, barrier=(14.4244,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (85.1674,'amu'),
...
reaction(
    label = 'reaction17',
    reactants = ['H(3)', 'CC=CCCC(910)'],
    products = ['C[CH]CCCC(118)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction21',
    reactants = ['C2H5(32)', '[CH2]C[CH]C(86)'],
    products = ['C[CH]CCCC(118)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction22',
    reactants = ['npropyl(70)', 'C3H6(T)(82)'],
    products = ['C[CH]CCCC(118)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction23',
    reactants = ['H(3)', 'C[CH]C[CH]CC(288)'],
    products = ['C[CH]CCCC(118)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction24',
    reactants = ['[CH2]CC[CH]C(93)', 'CH3(18)'],
    products = ['C[CH]CCCC(118)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction25',
    reactants = ['H(3)', 'C[CH]CC[CH]C(289)'],
    products = ['C[CH]CCCC(118)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction27',
    reactants = ['H(3)', '[CH2]CCC[CH]C(113)'],
    products = ['C[CH]CCCC(118)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CH2(S)(24)', 'C[CH]CCC(96)'],
    products = ['C[CH]CCCC(118)'],
...
reaction(
    label = 'reaction31',
    reactants = ['butyl_1(69)', 'CHCH3(T)(80)'],
    products = ['C[CH]CCCC(118)'],
...
reaction(
    label = 'reaction5',
    reactants = ['npropyl(70)', '[CH2]C[CH2](83)'],
    products = ['[CH2]CCCCC(74)'],
...
reaction(
    label = 'reaction6',
    reactants = ['C2H5(32)', '[CH2]CC[CH2](88)'],
    products = ['[CH2]CCCCC(74)'],
...
reaction(
    label = 'reaction7',
    reactants = ['H(3)', '[CH2]CC[CH]CC(125)'],
    products = ['[CH2]CCCCC(74)'],
...
reaction(
    label = 'reaction8',
    reactants = ['butyl_1(69)', 'C2H4(T)(79)'],
    products = ['[CH2]CCCCC(74)'],
...
reaction(
    label = 'reaction9',
    reactants = ['H(3)', '[CH2]C[CH]CCC(133)'],
    products = ['[CH2]CCCCC(74)'],
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]CCC[CH2](95)', 'CH3(18)'],
    products = ['[CH2]CCCCC(74)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(3)', '[CH2]CCCC[CH2](290)'],
    products = ['[CH2]CCCCC(74)'],
...
reaction(
    label = 'reaction31',
    reactants = ['CH2(S)(24)', '[CH2]CCCC(71)'],
    products = ['[CH2]CCCCC(74)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]CCCC(71)', 'CH2(T)(17)'],
    products = ['[CH2]CCCCC(74)'],
...
network(
    ...
    reactants = [
        ...
        ('npropyl(70)', 'C3H6(59)'),
        ('C2H4(29)', 'butyl_1(69)'),
        ('CH2(S)(24)', '[CH2]CCCC(71)'),
        ('[CH2]CCCC(71)', 'CH2(T)(17)'),
    ],
    bathGas = {
        'N2': 0.5,
        'Ne': 0.5,
