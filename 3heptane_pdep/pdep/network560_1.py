species(
    label = 'C[CH]OO[CH]C(751)',
    structure = SMILES('C[CH]OO[CH]C'),
    E0 = (150.192,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3000,3050,390,425,1340,1360,335,370,293.363],'cm^-1')),
        HinderedRotor(inertia=(0.122278,'amu*angstrom^2'), symmetry=1, barrier=(7.46042,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.801444,'amu*angstrom^2'), symmetry=1, barrier=(48.8984,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.801221,'amu*angstrom^2'), symmetry=1, barrier=(48.8991,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.122233,'amu*angstrom^2'), symmetry=1, barrier=(7.45991,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0254568,'amu*angstrom^2'), symmetry=1, barrier=(48.9,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (88.1051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.37554,0.0629954,-6.42927e-05,4.32562e-08,-1.32334e-11,18153.7,22.6948], Tmin=(100,'K'), Tmax=(761.985,'K')), NASAPolynomial(coeffs=[5.74824,0.0400417,-1.91085e-05,3.72518e-09,-2.63949e-13,17487.3,2.78762], Tmin=(761.985,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(150.192,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCsJOOC) + radical(CCsJOOC)"""),
)
...
species(
    label = 'C=COO[CH]C(2389)',
    structure = SMILES('C=COO[CH]C'),
    E0 = (106.669,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2950,3100,1380,975,1025,1650,3010,987.5,1337.5,450,1655,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,276.56],'cm^-1')),
        HinderedRotor(inertia=(0.111789,'amu*angstrom^2'), symmetry=1, barrier=(6.31209,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.373131,'amu*angstrom^2'), symmetry=1, barrier=(20.5206,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.768429,'amu*angstrom^2'), symmetry=1, barrier=(43.2686,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.526618,'amu*angstrom^2'), symmetry=1, barrier=(28.8328,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (87.0972,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.28575,0.0556077,-4.32865e-05,1.72513e-08,-2.80126e-12,12930.2,23.388], Tmin=(100,'K'), Tmax=(1439.64,'K')), NASAPolynomial(coeffs=[12.7744,0.0236869,-1.00275e-05,1.84986e-09,-1.26739e-13,9622.25,-36.2246], Tmin=(1439.64,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(106.669,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CCsJOOC)"""),
)

species(
    label = '[CH2]COO[CH]C(2390)',
    ...
    molecularWeight = (88.1051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.34694,0.0633468,-6.14627e-05,3.60542e-08,-9.33073e-12,21465.3,24.4977], Tmin=(100,'K'), Tmax=(898.118,'K')), NASAPolynomial(coeffs=[7.26163,0.0370048,-1.74684e-05,3.39824e-09,-2.40838e-13,20402.9,-3.40183], Tmin=(898.118,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(177.714,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCsJOOC) + radical(CJCOOH)"""),
)

species(
    label = '[CH2][CH]OOCC(2391)',
    structure = SMILES('[CH2][CH]OOCC'),
    E0 = (177.714,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,350,500,795,815,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,2750,2850,1437.5,1250,1305,750,350,180],'cm^-1')),
        HinderedRotor(inertia=(0.032129,'amu*angstrom^2'), symmetry=1, barrier=(0.738709,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.81229,'amu*angstrom^2'), symmetry=1, barrier=(41.6681,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00754666,'amu*angstrom^2'), symmetry=1, barrier=(41.6687,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.546772,'amu*angstrom^2'), symmetry=1, barrier=(12.5714,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.81229,'amu*angstrom^2'), symmetry=1, barrier=(41.6681,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'C=COO[CH]C(2389)'],
    products = ['C[CH]OO[CH]C(751)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction8',
    reactants = ['C[CH]O[O](159)', 'CHCH3(T)(80)'],
    products = ['C[CH]OO[CH]C(751)'],
    transitionState = 'TS8',
