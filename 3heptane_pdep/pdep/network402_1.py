species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.182443,'amu*angstrom^2'), symmetry=1, barrier=(15.5143,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.181877,'amu*angstrom^2'), symmetry=1, barrier=(15.5197,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.62617,0.0324476,-3.35588e-05,2.11259e-08,-5.75987e-12,33183.8,15.6519], Tmin=(100,'K'), Tmax=(865.472,'K')), NASAPolynomial(coeffs=[5.79528,0.0177999,-8.17078e-06,1.56863e-09,-1.10274e-13,32635.2,0.820792], Tmin=(865.472,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(275.51,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(178.761,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cd-Cd(CCO)H) + group(Cds-(Cdd-O2d)CsH) + group(Cds-CdsHH) + radical(Cds_P)"""),
)
...
species(
    ...
    molecularWeight = (68.074,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.45042,0.0332272,-1.49834e-05,1.57221e-09,2.41261e-13,30523.8,16.9403], Tmin=(100,'K'), Tmax=(1750.19,'K')), NASAPolynomial(coeffs=[11.9105,0.018893,-8.94304e-06,1.65011e-09,-1.09647e-13,26096.4,-37.1824], Tmin=(1750.19,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(253.32,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cd-Cd(CO)H) + group(Cds-O2d(Cds-Cds)H) + radical(AllylJ2_triplet)"""),
)
...
species(
    label = '[CH]=[C]CC=O(3997)',
    structure = SMILES('[CH]=[C]CC=O'),
    E0 = (391.799,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,2750,2850,1437.5,1250,1305,750,350,2782.5,750,1395,475,1775,1000,1685,370],'cm^-1')),
        HinderedRotor(inertia=(0.729348,'amu*angstrom^2'), symmetry=1, barrier=(16.7692,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0415619,'amu*angstrom^2'), symmetry=1, barrier=(16.7681,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (68.074,'amu'),
...
species(
    ...
    molecularWeight = (68.074,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.70096,0.0290788,-1.80137e-05,5.6589e-09,-7.49153e-13,3463.32,14.9666], Tmin=(100,'K'), Tmax=(1629.67,'K')), NASAPolynomial(coeffs=[7.32087,0.0177392,-7.57631e-06,1.38911e-09,-9.41395e-14,1957.55,-9.57808], Tmin=(1629.67,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(28.414,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cd-Cd(CCO)H) + group(Cds-(Cdd-O2d)CsH) + group(Cds-CdsHH)"""),
)
...
species(
    ...
    molecularWeight = (68.074,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.41648,0.0452198,-4.57103e-05,2.25525e-08,-4.15487e-12,31966.6,18.4199], Tmin=(100,'K'), Tmax=(1540.91,'K')), NASAPolynomial(coeffs=[13.6857,0.00610853,-5.68317e-07,-3.63524e-11,6.20014e-15,29047.6,-43.2792], Tmin=(1540.91,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(264.929,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cds-Cds(Cds-Cds)O2s) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cds_P) + radical(C=C(C)OJ)"""),
)

species(
    label = 'O=C1C=CC1(4000)',
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', '[CH]=CC=C=O(3994)'],
    products = ['[CH]=CC[C]=O(617)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2][C]=O(266)', 'C2H2(T)(264)'],
    products = ['[CH]=CC[C]=O(617)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[C]=O(261)', '[CH]=C[CH2](1733)'],
    products = ['[CH]=CC[C]=O(617)'],
    transitionState = 'TS15',
    kinetics = Arrhenius(A=(2.23625e+06,'m^3/(mol*s)'), n=0.36814, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Y_rad;Birad] for rate rule [C_rad/H2/Cd;Birad]
