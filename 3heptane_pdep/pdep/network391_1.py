...
species(
    ...
    E0 = (42.6675,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,180,2508.36],'cm^-1')),
        HinderedRotor(inertia=(0.278509,'amu*angstrom^2'), symmetry=1, barrier=(6.40347,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.27841,'amu*angstrom^2'), symmetry=1, barrier=(6.40119,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (71.0978,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.98728,0.0295951,-8.24173e-06,-1.1556e-09,5.49976e-13,5161.52,17.2236], Tmin=(100,'K'), Tmax=(1995.15,'K')), NASAPolynomial(coeffs=[12.0274,0.0211774,-9.21075e-06,1.60667e-09,-1.01698e-13,-377.685,-37.4757], Tmin=(1995.15,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(42.6675,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(CCOJ)"""),
)
...
species(
    ...
    molecularWeight = (72.1057,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.13078,0.0443944,-4.17011e-05,3.19896e-08,-1.17386e-11,12425.3,23.7507], Tmin=(100,'K'), Tmax=(746.889,'K')), NASAPolynomial(coeffs=[3.50257,0.0340758,-1.50093e-05,2.8372e-09,-1.97451e-13,12303.3,18.0879], Tmin=(746.889,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(102.776,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo library: CBS_QB3_1dHR + radical(RCCJC) + radical(RCCJ)"""),
)
...
species(
    ...
    molecularWeight = (72.1057,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.8616,0.0407203,-1.67187e-05,-3.01889e-09,3.01638e-12,-21127.6,20.4595], Tmin=(100,'K'), Tmax=(1102.34,'K')), NASAPolynomial(coeffs=[9.38422,0.0244475,-9.57659e-06,1.73402e-09,-1.19057e-13,-23455.9,-19.6038], Tmin=(1102.34,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-176.349,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH)"""),
)

species(
    label = '[CH2]C(C)C[O](608)',
    structure = SMILES('[CH2]C(C)C[O]'),
    E0 = (124.665,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2850,1437.5,1250,1305,750,350,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,1467.77,1467.77],'cm^-1')),
        HinderedRotor(inertia=(0.200888,'amu*angstrom^2'), symmetry=1, barrier=(4.61881,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.200746,'amu*angstrom^2'), symmetry=1, barrier=(4.61555,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.200796,'amu*angstrom^2'), symmetry=1, barrier=(4.6167,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (72.1057,'amu'),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.58462,0.0372281,-1.72727e-05,3.62731e-09,-2.93639e-13,15037.7,19.8952], Tmin=(100,'K'), Tmax=(2792.21,'K')), NASAPolynomial(coeffs=[16.5172,0.0172688,-6.55037e-06,1.06723e-09,-6.44222e-14,7257.23,-61.6278], Tmin=(2792.21,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(124.665,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo library: CBS_QB3_1dHR + radical(Isobutyl) + radical(CCOJ)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'CC=CC[O](1343)'],
    products = ['C[CH]CC[O](240)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction19',
    reactants = ['CHCH3(T)(80)', '[CH2]C[O](258)'],
    products = ['C[CH]CC[O](240)'],
