...
species(
    label = 'C=[C]OC(=C)CCC(2628)',
    structure = SMILES('C=[C]OC(=C)CCC'),
    E0 = (121.341,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2950,3000,3050,3100,1330,1430,900,1050,1000,1050,1600,1700,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.41558,0.0754528,-5.38451e-05,2.01701e-08,-3.14833e-12,14725.3,34.1942], Tmin=(100,'K'), Tmax=(1461.46,'K')), NASAPolynomial(coeffs=[13.8683,0.0386327,-1.60538e-05,2.93093e-09,-1.99358e-13,10793.2,-35.8117], Tmin=(1461.46,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(121.341,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(C=CJO)"""),
)

species(
    label = 'C#COC([CH2])CCC(2629)',
    structure = SMILES('C#COC([CH2])CCC'),
    E0 = (150.346,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3100,440,815,1455,1000,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,2175,525,750,770,3400,2100,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    ...
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.359976,0.0909792,-7.86436e-05,3.5926e-08,-6.67766e-12,20663.7,34.656], Tmin=(100,'K'), Tmax=(1278.04,'K')), NASAPolynomial(coeffs=[16.9521,0.0367963,-1.50512e-05,2.75445e-09,-1.88958e-13,16238.5,-53.1122], Tmin=(1278.04,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(170.469,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C2CsJOC(O)) + radical(C=CJO)"""),
)

species(
    label = '[CH]=COC([CH2])CCC(2631)',
    structure = SMILES('[CH]=COC([CH2])CCC'),
    E0 = (188.116,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3100,440,815,1455,1000,3120,650,792.5,1650,3010,987.5,1337.5,450,1655,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.09153,0.0993825,-7.97715e-05,2.23785e-08,1.4837e-12,22819.6,33.5014], Tmin=(100,'K'), Tmax=(982.544,'K')), NASAPolynomial(coeffs=[23.0415,0.0272127,-9.40414e-06,1.6455e-09,-1.13906e-13,16818.5,-88.9068], Tmin=(982.544,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(188.116,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CJC(C)OC) + radical(Cds_P)"""),
)

species(
    label = '[CH2][C](CCC)OC=C(2632)',
...
species(
    ...
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.261251,0.0796175,-3.76969e-05,-1.08347e-08,1.06493e-11,20630.8,35.9921], Tmin=(100,'K'), Tmax=(999.57,'K')), NASAPolynomial(coeffs=[19.1068,0.0322759,-1.19191e-05,2.16247e-09,-1.52059e-13,15252,-64.9767], Tmin=(999.57,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(170.156,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CCJCO) + radical(C=CJO)"""),
)

species(
    label = 'C=[C]OC(C)C[CH]C(2634)',
    ...
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.312684,0.0855694,-6.69667e-05,2.7721e-08,-4.67002e-12,19971.7,36.423], Tmin=(100,'K'), Tmax=(1403.92,'K')), NASAPolynomial(coeffs=[17.2102,0.0356441,-1.3625e-05,2.39135e-09,-1.59522e-13,15051.5,-54.06], Tmin=(1403.92,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(164.7,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(RCCJC) + radical(C=CJO)"""),
)

species(
    label = '[CH2]C([CH]CC)OC=C(2635)',
    ...
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.808054,0.0904683,-5.38794e-05,-5.25075e-09,1.15485e-11,17135.8,34.5774], Tmin=(100,'K'), Tmax=(962.901,'K')), NASAPolynomial(coeffs=[23.2307,0.0259775,-8.51331e-06,1.48657e-09,-1.04852e-13,10866.8,-89.0009], Tmin=(962.901,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(140.921,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CCJCO) + radical(CJC(C)OC)"""),
)

species(
    label = '[CH]=[C]OC(C)CCC(2636)',
    structure = SMILES('[CH]=[C]OC(C)CCC'),
    E0 = (217.35,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,1380,1390,370,380,2900,435,3120,650,792.5,1650,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    ...
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.455524,0.0859709,-5.80286e-05,1.22456e-08,1.9431e-12,21278.5,35.9811], Tmin=(100,'K'), Tmax=(1050.13,'K')), NASAPolynomial(coeffs=[18.7075,0.0336629,-1.28587e-05,2.3274e-09,-1.61277e-13,16113.2,-62.8374], Tmin=(1050.13,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(175.5,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C=CJO) + radical(RCCJ)"""),
)

species(
    label = '[CH2]C(C[CH]C)OC=C(2638)',
    ...
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.03623,0.0985318,-9.0695e-05,4.33734e-08,-8.20316e-12,16484.4,35.6409], Tmin=(100,'K'), Tmax=(1286.79,'K')), NASAPolynomial(coeffs=[21.1435,0.0295859,-1.03256e-05,1.73532e-09,-1.13649e-13,10776.2,-76.9564], Tmin=(1286.79,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(135.466,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CJC(C)OC) + radical(RCCJC)"""),
)

species(
    label = '[CH2]CCC([CH2])OC=C(2639)',
    ...
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.978282,0.0965655,-7.34617e-05,1.71044e-08,3.02891e-12,17782.4,34.4784], Tmin=(100,'K'), Tmax=(984.391,'K')), NASAPolynomial(coeffs=[22.5768,0.0277821,-9.6875e-06,1.70584e-09,-1.1851e-13,11840.1,-85.4181], Tmin=(984.391,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(146.266,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CJC(C)OC) + radical(RCCJ)"""),
)
...
species(
    ...
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0690437,0.0769177,-3.83293e-05,-3.44146e-09,6.3153e-12,-14083.4,32.8081], Tmin=(100,'K'), Tmax=(1053.05,'K')), NASAPolynomial(coeffs=[16.8398,0.0363335,-1.41988e-05,2.60344e-09,-1.8163e-13,-18955.5,-55.8657], Tmin=(1053.05,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-118.403,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(Cds-CdsHH)"""),
)
...
species(
    label = '[CH2]C(CC)O[C]=C(675)',
    structure = SMILES('[CH2]C(CC)O[C]=C'),
    E0 = (204.544,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,1685,370,2950,3100,1380,975,1025,1650,1380,1390,370,380,2900,435,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'C=[C]OC(=C)CCC(2628)'],
    products = ['[CH2]C(CCC)O[C]=C(683)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', 'C#COC([CH2])CCC(2629)'],
    products = ['[CH2]C(CCC)O[C]=C(683)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['npropyl(70)', 'C=[C]OC=C(1763)'],
    products = ['[CH2]C(CCC)O[C]=C(683)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]C(CCC)O[C]=C(683)'],
    products = ['[CH2]C([CH]CC)OC=C(2635)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]C(CCC)O[C]=C(683)'],
    products = ['[CH2]C(C[CH]C)OC=C(2638)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]C(CCC)O[C]=C(683)'],
    products = ['[CH2]CCC([CH2])OC=C(2639)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CH2(S)(24)', '[CH2]C(CC)O[C]=C(675)'],
    products = ['[CH2]C(CCC)O[C]=C(683)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH2]C([O])CCC(1410)', 'H2CC(T)(265)'],
    products = ['[CH2]C(CCC)O[C]=C(683)'],
...
reaction(
    label = 'reaction22',
    reactants = ['CH2(T)(17)', 'C=[C]O[CH]CCC(2262)'],
    products = ['[CH2]C(CCC)O[C]=C(683)'],
