species(
    label = 'CC([O])O[C]=O(482)',
    structure = SMILES('CC([O])O[C]=O'),
    E0 = (-185.695,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1855,455,950,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,275.073,277.311,2433.91],'cm^-1')),
        HinderedRotor(inertia=(0.689117,'amu*angstrom^2'), symmetry=1, barrier=(37.031,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.693967,'amu*angstrom^2'), symmetry=1, barrier=(37.0171,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0088325,'amu*angstrom^2'), symmetry=1, barrier=(37.0254,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (88.0621,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.21222,0.0433785,-4.9929e-05,4.31045e-08,-1.71802e-11,-22273.4,20.5927], Tmin=(100,'K'), Tmax=(689.338,'K')), NASAPolynomial(coeffs=[3.83041,0.030781,-1.55368e-05,3.09305e-09,-2.21202e-13,-22420.3,13.9407], Tmin=(689.338,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-185.695,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cds-OdOsH) + radical((O)CJOC) + radical(CCOJ)"""),
)
...
species(
    label = 'CC(=O)O[C]=O(3669)',
    structure = SMILES('CC(=O)O[C]=O'),
    E0 = (-344.109,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,1855,455,950,211.552,462.39,462.391,462.397,2193.8,4000],'cm^-1')),
        HinderedRotor(inertia=(0.0556894,'amu*angstrom^2'), symmetry=1, barrier=(8.44909,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.209126,'amu*angstrom^2'), symmetry=1, barrier=(31.7283,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0556884,'amu*angstrom^2'), symmetry=1, barrier=(8.44908,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (87.0541,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.28559,0.0406005,-4.6514e-05,3.12304e-08,-8.8502e-12,-41327.5,20.2311], Tmin=(100,'K'), Tmax=(843.499,'K')), NASAPolynomial(coeffs=[6.70113,0.019661,-9.27648e-06,1.79887e-09,-1.27015e-13,-42072.4,-0.319734], Tmin=(843.499,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-344.109,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-O2d)) + group(Cs-(Cds-O2d)HHH) + group(Cds-OdCsOs) + group(Cds-OdOsH) + radical((O)CJOC)"""),
)
...
species(
    ...
    E0 = (-288.239,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2782.5,750,1395,475,1775,1000,1855,455,950,378.418],'cm^-1')),
        HinderedRotor(inertia=(0.0785097,'amu*angstrom^2'), symmetry=1, barrier=(7.99313,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0786504,'amu*angstrom^2'), symmetry=1, barrier=(7.9927,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
species(
    ...
    molecularWeight = (88.0621,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.02235,0.0452124,-4.1783e-05,2.05277e-08,-4.203e-12,-24724.9,21.103], Tmin=(100,'K'), Tmax=(1143.66,'K')), NASAPolynomial(coeffs=[8.97873,0.0208823,-9.87225e-06,1.92621e-09,-1.36809e-13,-26316,-13.3913], Tmin=(1143.66,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-206.154,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cds-OdOsH) + radical(Cs_P) + radical((O)CJOC)"""),
)

species(
    label = 'C[C]([O])OC=O(3671)',
    ...
    molecularWeight = (88.0621,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.3732,0.042676,-6.13079e-05,6.59995e-08,-2.83576e-11,-24187.7,20.0169], Tmin=(100,'K'), Tmax=(788.986,'K')), NASAPolynomial(coeffs=[0.302315,0.0367514,-1.882e-05,3.71533e-09,-2.62167e-13,-23349.7,32.7564], Tmin=(788.986,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-201.538,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(Cs-OsOsHH) + group(Cs-(Cds-O2d)HHH) + group(Cds-OdCsOs) + radical(OCOJ) + radical(OCJO)"""),
)

species(
    label = '[CH2]C(O)O[C]=O(3672)',
    ...
    molecularWeight = (88.0621,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.80141,0.0500087,-5.2166e-05,2.87572e-08,-6.47642e-12,-23953.9,21.8442], Tmin=(100,'K'), Tmax=(1061.45,'K')), NASAPolynomial(coeffs=[9.86003,0.0196406,-9.25125e-06,1.80382e-09,-1.28222e-13,-25664.7,-17.5146], Tmin=(1061.45,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-199.811,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cds-OdOsH) + radical((O)CJOC) + radical(CJCO)"""),
)

species(
    label = '[CH2]C([O])OC=O(3673)',
    structure = SMILES('[CH2]C([O])OC=O'),
    E0 = (-170.555,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2782.5,750,1395,475,1775,1000,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,433.956,434.033,434.037],'cm^-1')),
        HinderedRotor(inertia=(0.000895198,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.000895236,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
...
species(
    ...
    E0 = (-138.18,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,1855,455,950,555.489,555.784,556.608],'cm^-1')),
        HinderedRotor(inertia=(0.205632,'amu*angstrom^2'), symmetry=1, barrier=(45.1295,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.205596,'amu*angstrom^2'), symmetry=1, barrier=(45.1318,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'CC(=O)O[C]=O(3669)'],
    products = ['CC([O])O[C]=O(482)'],
    transitionState = 'TS2',
...
reaction(
    ...
    products = ['CC([O])O[C]=O(482)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(23.3993,'m^3/(mol*s)'), n=2.021, Ea=(59.8354,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Od_R;YJ] for rate rule [Od_Cdd-O2d;CJ]
Euclidian distance = 2.2360679775
Multiplied by reaction path degeneracy 2.0
family: R_Addition_MultipleBond
Ea raised from 55.8 to 59.8 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction4',
    reactants = ['CH3(18)', 'O=[C]OC=O(436)'],
    products = ['CC([O])O[C]=O(482)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction11',
    reactants = ['CH2(S)(24)', '[O]CO[C]=O(442)'],
    products = ['CC([O])O[C]=O(482)'],
