...
species(
    label = '[CH]=CCC=CCC(3296)',
    structure = SMILES('[CH]=CCC=CCC'),
    E0 = (277.175,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3010,3025,975,987.5,1000,1300,1337.5,1375,400,450,500,1630,1655,1680,237.773,239.427],'cm^-1')),
        HinderedRotor(inertia=(0.00294719,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.317231,'amu*angstrom^2'), symmetry=1, barrier=(12.6626,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.314149,'amu*angstrom^2'), symmetry=1, barrier=(12.65,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.309272,'amu*angstrom^2'), symmetry=1, barrier=(12.6094,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
species(
    label = '[CH]=CC=CCCC(3297)',
    structure = SMILES('[CH]=CC=CCCC'),
    E0 = (258.566,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3010,3025,975,987.5,1000,1300,1337.5,1375,400,450,500,1630,1655,1680,215.629,216.746],'cm^-1')),
        HinderedRotor(inertia=(0.433156,'amu*angstrom^2'), symmetry=1, barrier=(14.2265,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.437098,'amu*angstrom^2'), symmetry=1, barrier=(14.2225,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.448742,'amu*angstrom^2'), symmetry=1, barrier=(14.2236,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.434443,'amu*angstrom^2'), symmetry=1, barrier=(14.2215,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (95.1622,'amu'),
...
species(
    ...
    molecularWeight = (96.1702,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.04657,0.066069,-3.939e-05,1.21143e-08,-1.58904e-12,42642.3,30.5366], Tmin=(100,'K'), Tmax=(1621.75,'K')), NASAPolynomial(coeffs=[10.548,0.0426344,-1.7715e-05,3.20425e-09,-2.15537e-13,39560.5,-19.8965], Tmin=(1621.75,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(353.68,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(RCCJC) + radical(Cds_P)"""),
)

species(
    label = '[CH]=[C]CCCCC(3301)',
    structure = SMILES('[CH]=[C]CCCCC'),
    E0 = (397.075,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,2750,2800,2850,1350,1500,750,1050,1375,1000,1685,370,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (96.1702,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.704789,0.0716595,-4.85694e-05,1.74343e-08,-2.65487e-12,47875.9,29.5099], Tmin=(100,'K'), Tmax=(1462.79,'K')), NASAPolynomial(coeffs=[11.8748,0.0411148,-1.72474e-05,3.15911e-09,-2.15132e-13,44608.1,-28.6271], Tmin=(1462.79,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(397.075,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_S) + radical(Cds_P)"""),
)

species(
    label = 'C=C[CH][CH]CCC(3302)',
...
species(
    ...
    molecularWeight = (96.1702,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.408638,0.0718506,-4.72905e-05,1.59224e-08,-2.20162e-12,43971.7,31.9038], Tmin=(100,'K'), Tmax=(1648.79,'K')), NASAPolynomial(coeffs=[15.4534,0.0353514,-1.40848e-05,2.49602e-09,-1.65809e-13,39010.6,-48.2014], Tmin=(1648.79,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(364.48,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_P) + radical(RCCJ)"""),
)

species(
    label = 'C=CC[CH][CH]CC(3304)',
    structure = SMILES('C=CC[CH][CH]CC'),
    E0 = (301.054,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (96.1702,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.20161,0.0546979,-2.29525e-05,3.59089e-09,-1.33115e-13,36258.1,28.3379], Tmin=(100,'K'), Tmax=(2446.23,'K')), NASAPolynomial(coeffs=[28.3422,0.0219293,-8.97626e-06,1.44903e-09,-8.45921e-14,20484.1,-127.26], Tmin=(2446.23,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(301.054,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(RCCJCC) + radical(RCCJCC)"""),
)

species(
    label = 'C=CC[CH]C[CH]C(3305)',
...
species(
    ...
    molecularWeight = (96.1702,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.599054,0.0608353,-5.36958e-06,-3.39986e-08,1.67139e-11,1514.24,27.1653], Tmin=(100,'K'), Tmax=(1002.43,'K')), NASAPolynomial(coeffs=[15.0954,0.0344561,-1.29813e-05,2.37755e-09,-1.67698e-13,-2973.02,-50.692], Tmin=(1002.43,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(11.4699,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(440.667,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH)"""),
)

species(
    label = 'C=CCC=CCC(3308)',
    ...
    molecularWeight = (96.1702,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.863928,0.0563692,-1.84952e-06,-3.08323e-08,1.38707e-11,3741.37,28.8014], Tmin=(100,'K'), Tmax=(1044.39,'K')), NASAPolynomial(coeffs=[12.7392,0.038285,-1.52259e-05,2.82427e-09,-1.98432e-13,-233.324,-36.1591], Tmin=(1044.39,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(30.0787,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(440.667,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH)"""),
)
...
species(
    label = '[CH]=CCC([CH2])CC(3309)',
    structure = SMILES('[CH]=CCC([CH2])CC'),
    E0 = (358.622,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3100,440,815,1455,1000,3120,650,792.5,1650,3010,987.5,1337.5,450,1655,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,180,3490.65],'cm^-1')),
        HinderedRotor(inertia=(0.703453,'amu*angstrom^2'), symmetry=1, barrier=(16.1738,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.703498,'amu*angstrom^2'), symmetry=1, barrier=(16.1748,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00267609,'amu*angstrom^2'), symmetry=1, barrier=(3.99583,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.703491,'amu*angstrom^2'), symmetry=1, barrier=(16.1746,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(3.68894,'amu*angstrom^2'), symmetry=1, barrier=(84.816,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (96.1702,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.363298,0.0708898,-4.21817e-05,8.80264e-09,8.11031e-13,43270.8,31.7724], Tmin=(100,'K'), Tmax=(1105.49,'K')), NASAPolynomial(coeffs=[13.2944,0.03712,-1.40253e-05,2.47561e-09,-1.67171e-13,39616.2,-35.5076], Tmin=(1105.49,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(358.622,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Isobutyl) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', 'C#CC[CH]CCC(3298)'],
    products = ['[CH]=CC[CH]CCC(624)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['C2H5(32)', '[CH]=CCC=C(2311)'],
    products = ['[CH]=CC[CH]CCC(624)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction21',
    reactants = ['CH2(S)(24)', '[CH]=CC[CH]CC(622)'],
    products = ['[CH]=CC[CH]CCC(624)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[CH]CCC(90)', '[CH]=C[CH2](1733)'],
    products = ['[CH]=CC[CH]CCC(624)'],
