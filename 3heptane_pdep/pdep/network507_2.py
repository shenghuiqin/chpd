...
species(
    label = '[CH2]CC=CCC(905)',
    structure = SMILES('[CH2]CC=CCC'),
    E0 = (130.054,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,319.498,319.502],'cm^-1')),
        HinderedRotor(inertia=(0.00165095,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00164965,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.137328,'amu*angstrom^2'), symmetry=1, barrier=(9.93812,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.137625,'amu*angstrom^2'), symmetry=1, barrier=(9.93714,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (83.1515,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.30635,0.0494055,-5.55137e-06,-2.04577e-08,9.33523e-12,15747.1,26.2551], Tmin=(100,'K'), Tmax=(1072.64,'K')), NASAPolynomial(coeffs=[10.6589,0.0349908,-1.40082e-05,2.58284e-09,-1.79849e-13,12563.6,-25.0085], Tmin=(1072.64,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(130.054,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(390.78,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(RCCJ)"""),
)

species(
    label = '[CH2]CCC=CC(906)',
    structure = SMILES('[CH2]CCC=CC'),
    E0 = (128.919,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,344.18,344.182],'cm^-1')),
        HinderedRotor(inertia=(0.00142329,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0885826,'amu*angstrom^2'), symmetry=1, barrier=(7.44547,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0885781,'amu*angstrom^2'), symmetry=1, barrier=(7.44543,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0885626,'amu*angstrom^2'), symmetry=1, barrier=(7.44568,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (83.1515,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.19759,0.0535201,-2.06693e-05,-2.75425e-09,2.74678e-12,15612.8,25.9855], Tmin=(100,'K'), Tmax=(1213.83,'K')), NASAPolynomial(coeffs=[10.6474,0.0353965,-1.43586e-05,2.61442e-09,-1.7852e-13,12359.8,-25.3857], Tmin=(1213.83,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(128.919,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(390.78,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(RCCJ)"""),
)
...
species(
    label = '[CH2]CC([CH2])CC(712)',
    structure = SMILES('[CH2]CC([CH2])CC'),
    E0 = (216.117,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,180,2798.55],'cm^-1')),
        HinderedRotor(inertia=(0.109335,'amu*angstrom^2'), symmetry=1, barrier=(2.51382,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00298367,'amu*angstrom^2'), symmetry=1, barrier=(2.44907,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.691256,'amu*angstrom^2'), symmetry=1, barrier=(15.8933,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.108819,'amu*angstrom^2'), symmetry=1, barrier=(2.50195,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(3.52507,'amu*angstrom^2'), symmetry=1, barrier=(81.0483,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.1595,'amu'),
...
species(
    ...
    molecularWeight = (84.1595,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.86779,0.0261952,7.96262e-05,-1.15157e-07,4.39206e-11,-5043.82,21.0342], Tmin=(100,'K'), Tmax=(975.47,'K')), NASAPolynomial(coeffs=[12.5643,0.0342258,-1.25187e-05,2.35316e-09,-1.72258e-13,-9599.53,-42.9594], Tmin=(975.47,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-42.729,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(424.038,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cyclobutane)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', '[CH2]CC=CCC(905)'],
    products = ['[CH2]CC[CH]CC(125)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['C2H4(T)(79)', 'butene1(85)'],
    products = ['[CH2]CC[CH]CC(125)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['C2H4(29)', '[CH2][CH]CC(87)'],
    products = ['[CH2]CC[CH]CC(125)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction15',
    reactants = ['C2H4(T)(79)', '[CH2][CH]CC(87)'],
    products = ['[CH2]CC[CH]CC(125)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CH2(S)(24)', '[CH2]CC[CH]C(93)'],
    products = ['[CH2]CC[CH]CC(125)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH2]C[CH2](83)', '[CH]CC(84)'],
    products = ['[CH2]CC[CH]CC(125)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[CH2]C[CH]CC(92)', 'CH2(T)(17)'],
    products = ['[CH2]CC[CH]CC(125)'],
