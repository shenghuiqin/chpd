...
species(
    label = '[CH2]COC[O](2836)',
    structure = SMILES('[CH2]COC[O]'),
    E0 = (11.2052,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3100,440,815,1455,1000,180,541.702,541.765,542.036],'cm^-1')),
        HinderedRotor(inertia=(0.0141365,'amu*angstrom^2'), symmetry=1, barrier=(2.94896,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0141519,'amu*angstrom^2'), symmetry=1, barrier=(2.94894,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.36023,'amu*angstrom^2'), symmetry=1, barrier=(31.2743,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (74.0785,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.70059,0.0437292,-3.21688e-05,1.17765e-08,-1.72382e-12,1436.16,20.4439], Tmin=(100,'K'), Tmax=(1611.77,'K')), NASAPolynomial(coeffs=[12.8067,0.0161664,-6.51713e-06,1.16626e-09,-7.80489e-14,-2143.9,-38.4377], Tmin=(1611.77,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(11.2052,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsOsHH) + radical(OCOJ) + radical(CJCO)"""),
)

species(
    label = 'C[CH]O[CH]O(2837)',
    ...
    molecularWeight = (74.0785,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.16954,0.062401,-8.0762e-05,5.3888e-08,-1.4043e-11,-6917.97,20.4624], Tmin=(100,'K'), Tmax=(946.41,'K')), NASAPolynomial(coeffs=[12.3848,0.0149995,-5.63344e-06,9.6602e-10,-6.32764e-14,-9040.81,-33.0269], Tmin=(946.41,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-58.3656,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsOsHH) + radical(CCsJOCs) + radical(OCJO)"""),
)
...
species(
    ...
    E0 = (-11.4237,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,180,180,956.149,958.599],'cm^-1')),
        HinderedRotor(inertia=(0.0963414,'amu*angstrom^2'), symmetry=1, barrier=(2.21508,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0989881,'amu*angstrom^2'), symmetry=1, barrier=(2.27593,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0980996,'amu*angstrom^2'), symmetry=1, barrier=(2.2555,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (74.0785,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[4.24718,0.0287734,-1.15344e-05,1.1207e-09,6.02946e-14,-1418.39,10.2438], Tmin=(100,'K'), Tmax=(2745.93,'K')), NASAPolynomial(coeffs=[38.9545,-0.00824128,1.28705e-06,-1.95963e-10,1.66382e-14,-25585.1,-201.555], Tmin=(2745.93,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-11.4237,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsOsHH) + radical(OCJO) + radical(OCOJ)"""),
)

species(
    label = '[CH2][CH]OCO(2839)',
...
species(
    ...
    molecularWeight = (74.0785,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.37649,0.0287191,6.81039e-05,-1.38407e-07,6.39716e-11,-40760.7,18.1829], Tmin=(100,'K'), Tmax=(903.019,'K')), NASAPolynomial(coeffs=[28.5138,-0.014446,1.18314e-05,-2.3846e-09,1.57677e-13,-48803,-127.363], Tmin=(903.019,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-339.916,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-OsOsHH) + group(Cds-CdsOsH) + group(Cds-CdsHH)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'C=COC[O](2835)'],
    products = ['C[CH]OC[O](585)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction13',
    reactants = ['CHCH3(T)(80)', '[O]C[O](1747)'],
    products = ['C[CH]OC[O](585)'],
