...
species(
    label = 'C#COC[CH2](1764)',
    structure = SMILES('C#COC[CH2]'),
    E0 = (235.409,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,750,770,3400,2100,3000,3100,440,815,1455,1000,2175,525,180,180],'cm^-1')),
        HinderedRotor(inertia=(1.17342,'amu*angstrom^2'), symmetry=1, barrier=(26.9793,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.1733,'amu*angstrom^2'), symmetry=1, barrier=(26.9766,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (69.0819,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.789006,0.0554533,-5.66783e-05,2.73258e-08,-4.90152e-12,28441.7,18.3114], Tmin=(100,'K'), Tmax=(1571.18,'K')), NASAPolynomial(coeffs=[17.2646,0.00496115,-3.13033e-07,-5.3059e-11,5.84975e-15,24319.6,-65.2602], Tmin=(1571.18,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(235.409,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Ct-CtOs) + group(Ct-CtH) + radical(CJCO)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', 'C=[C]OC=C(1763)'],
    products = ['[CH2]CO[C]=C(658)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]C[O](258)', 'H2CC(T)(265)'],
    products = ['[CH2]CO[C]=C(658)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CH2(T)(17)', '[CH2]O[C]=C(1770)'],
    products = ['[CH2]CO[C]=C(658)'],
