...
species(
    ...
    molecularWeight = (125.145,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.658911,0.089149,-6.73153e-05,1.91471e-08,-1.27228e-13,20861.5,19.2488], Tmin=(100,'K'), Tmax=(1091.26,'K')), NASAPolynomial(coeffs=[21.4984,0.0282722,-1.15962e-05,2.1885e-09,-1.55276e-13,14814.5,-95.1319], Tmin=(1091.26,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(171.964,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(424.038,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + ring(1,3-Cycloheptadiene) + radical(CCJCOOH)"""),
)

species(
    label = 'OOC1[C]=CC=CCC1(324)',
...
species(
    ...
    molecularWeight = (125.145,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.10658,-0.00314237,0.000274723,-4.00552e-07,1.67307e-10,11084,30.4239], Tmin=(100,'K'), Tmax=(908.526,'K')), NASAPolynomial(coeffs=[45.455,-0.0243332,2.23258e-05,-4.46596e-09,2.87774e-13,-4158.1,-218.813], Tmin=(908.526,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(90.7715,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(424.038,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(1,4-Cycloheptadiene) + radical(C=CCJC=C)"""),
)

species(
    label = 'OOC1C=[C]C=CCC1(326)',
    ...
    molecularWeight = (125.145,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.898047,0.095186,-8.54111e-05,3.86295e-08,-6.89359e-12,20698.6,17.404], Tmin=(100,'K'), Tmax=(1357.8,'K')), NASAPolynomial(coeffs=[22.101,0.0274323,-1.0562e-05,1.87945e-09,-1.27153e-13,14452.9,-100.588], Tmin=(1357.8,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(170.544,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(424.038,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + ring(1,3-Cycloheptadiene) + radical(C=CJC=C)"""),
)

species(
    label = 'OOC1C=CC=[C]CC1(327)',
...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.46111,-0.00430505,0.000252772,-3.67842e-07,1.5419e-10,30698.8,30.6753], Tmin=(100,'K'), Tmax=(903.536,'K')), NASAPolynomial(coeffs=[41.0596,-0.02226,2.13562e-05,-4.35253e-09,2.8566e-13,17120.2,-191.891], Tmin=(903.536,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(254.014,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(403.252,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(1,4-Cycloheptadiene) + radical(C=CCJC=C) + radical(ROOJ)"""),
)

species(
    label = '[O]OC1[CH]CC=CC=C1(330)',
    ...
    molecularWeight = (124.137,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.535351,0.0870906,-7.68198e-05,3.38976e-08,-5.88872e-12,39138.3,19.5722], Tmin=(100,'K'), Tmax=(1394.61,'K')), NASAPolynomial(coeffs=[21.3088,0.0244375,-9.43222e-06,1.68428e-09,-1.14122e-13,33045.4,-93.0791], Tmin=(1394.61,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(323.968,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(403.252,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + ring(1,3-Cycloheptadiene) + radical(CCJCOOH) + radical(ROOJ)"""),
)

species(
    label = '[O]OC1C=CC=C[CH]C1(331)',
    ...
    molecularWeight = (124.137,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.38823,-0.00695034,0.000270816,-3.92364e-07,1.6408e-10,29353.7,30.1724], Tmin=(100,'K'), Tmax=(905.184,'K')), NASAPolynomial(coeffs=[43.6934,-0.0256928,2.31407e-05,-4.6646e-09,3.04381e-13,14804,-207.775], Tmin=(905.184,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(242.776,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(403.252,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(1,4-Cycloheptadiene) + radical(ROOJ) + radical(C=CCJC=C)"""),
)

species(
    label = '[O]OC1[C]=CC=CCC1(332)',
    ...
    molecularWeight = (124.137,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.41392,0.087652,-7.9135e-05,3.61122e-08,-6.52926e-12,43632.5,17.298], Tmin=(100,'K'), Tmax=(1335.54,'K')), NASAPolynomial(coeffs=[19.9337,0.026709,-1.06864e-05,1.9439e-09,-1.33197e-13,38197.6,-86.7545], Tmin=(1335.54,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(361.395,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(403.252,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + ring(1,3-Cycloheptadiene) + radical(Cds_S) + radical(ROOJ)"""),
)

species(
    label = '[O]OC1C=CC=[C]CC1(333)',
...
species(
    ...
    molecularWeight = (124.137,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.442626,0.0894601,-8.32473e-05,3.98948e-08,-7.59704e-12,38960.5,16.5206], Tmin=(100,'K'), Tmax=(1270.91,'K')), NASAPolynomial(coeffs=[19.0346,0.0281593,-1.08976e-05,1.94368e-09,-1.31803e-13,34009.7,-82.1155], Tmin=(1270.91,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(322.549,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(403.252,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + ring(1,3-Cycloheptadiene) + radical(C=CJC=C) + radical(ROOJ)"""),
)

species(
    label = '[O]OC1C=C[C]=CCC1(335)',
    structure = SMILES('[O]OC1C=C[C]=CCC1'),
    E0 = (322.549,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2750,2807.14,2864.29,2921.43,2978.57,3035.71,3092.86,3150,900,928.571,957.143,985.714,1014.29,1042.86,1071.43,1100,300,800,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
...
species(
    ...
    molecularWeight = (125.145,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.913445,0.0919416,-5.9782e-05,8.42996e-09,3.46557e-12,634.328,-3.52536], Tmin=(100,'K'), Tmax=(1107.32,'K')), NASAPolynomial(coeffs=[23.3622,0.0311448,-1.38575e-05,2.71494e-09,-1.96171e-13,-6390.74,-130.562], Tmin=(1107.32,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(3.68984,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + Estimated bicyclic component: polycyclic(PolycyclicRing) - ring(Cycloheptane) - ring(12dioxane) + ring(Cycloheptane) + ring(12dioxane) + radical(C=CCJCO)"""),
)

species(
    label = '[CH]1C=CCCC2OOC12(339)',
...
species(
    ...
    molecularWeight = (125.145,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.475782,0.0868282,-6.88131e-05,2.47693e-08,-2.68068e-12,15071.4,16.1361], Tmin=(100,'K'), Tmax=(1122.95,'K')), NASAPolynomial(coeffs=[19.4857,0.0299141,-1.17432e-05,2.1408e-09,-1.48088e-13,9693.64,-86.4646], Tmin=(1122.95,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(123.89,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(428.195,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + ring(1,3-Cycloheptadiene) + radical(ROOJ)"""),
)
...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.281632,0.0647968,-9.96608e-06,-3.82156e-08,2.02733e-11,15833,12.6089], Tmin=(100,'K'), Tmax=(985.763,'K')), NASAPolynomial(coeffs=[19.8087,0.0249109,-9.1513e-06,1.72862e-09,-1.27032e-13,10071.3,-91.0153], Tmin=(985.763,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(130.404,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(407.409,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + ring(1,3-Cycloheptadiene) + radical(CC(C)OJ)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['OOC1[CH]CC=CC=C1(323)'],
    products = ['C7H9O2(68)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction9',
    reactants = ['H(25)', '[O]O[C]1C=CC=CCC1(329)'],
    products = ['C7H9O2(68)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(25)', '[O]OC1[CH]CC=CC=C1(330)'],
    products = ['C7H9O2(68)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(25)', '[O]OC1C=CC=C[CH]C1(331)'],
    products = ['C7H9O2(68)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(25)', '[O]OC1[C]=CC=CCC1(332)'],
    products = ['C7H9O2(68)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(25)', '[O]OC1C=CC=[C]CC1(333)'],
    products = ['C7H9O2(68)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(25)', '[O]OC1C=[C]C=CCC1(334)'],
    products = ['C7H9O2(68)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(25)', '[O]OC1C=C[C]=CCC1(335)'],
    products = ['C7H9O2(68)'],
...
reaction(
    label = 'reaction23',
    reactants = ['C7H9O2(68)'],
    products = ['C1=CC=CCCC=1(255)', '[O]O(43)'],
...
reaction(
    label = 'reaction25',
    reactants = ['O(T)(344)', '[O]C1C=CC=CCC1(343)'],
    products = ['C7H9O2(68)'],
