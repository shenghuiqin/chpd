species(
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.656098,0.0167896,0.000213411,-3.27002e-07,1.38244e-10,3506.45,32.246], Tmin=(100,'K'), Tmax=(910.164,'K')), NASAPolynomial(coeffs=[40.6592,-0.0109826,1.52136e-05,-3.12938e-09,1.99947e-13,-9906.98,-190.664], Tmin=(910.164,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(27.7118,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(478.082,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cycloheptene) + radical(ROOJ)"""),
)
...
species(
    ...
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.644871,0.0180262,0.000208198,-3.19117e-07,1.34541e-10,3547.45,31.1848], Tmin=(100,'K'), Tmax=(912.699,'K')), NASAPolynomial(coeffs=[39.8673,-0.00873909,1.36671e-05,-2.80221e-09,1.76402e-13,-9657.05,-187.573], Tmin=(912.699,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(28.0578,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(473.925,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + ring(Cycloheptene) + radical(Allyl_S)"""),
)

species(
    label = 'OOC1[CH]CCCC=C1(346)',
    ...
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.400511,0.0226108,0.000201472,-3.16129e-07,1.34321e-10,9337.79,34.7091], Tmin=(100,'K'), Tmax=(913.019,'K')), NASAPolynomial(coeffs=[41.6765,-0.0109247,1.45722e-05,-2.95917e-09,1.86437e-13,-4338.73,-194.289], Tmin=(913.019,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(76.1221,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(473.925,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cycloheptene) + radical(CCJCOOH)"""),
)

species(
    label = 'OOC1[C]=CCCCC1(347)',
    ...
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.345642,0.0251481,0.000192698,-3.06123e-07,1.30583e-10,13839.9,33.0747], Tmin=(100,'K'), Tmax=(912.63,'K')), NASAPolynomial(coeffs=[41.2268,-0.0101155,1.41169e-05,-2.88077e-09,1.81934e-13,384.737,-193.251], Tmin=(912.63,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(113.549,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(473.925,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cycloheptene) + radical(Cds_S)"""),
)

species(
    label = 'OOC1C=CCC[CH]C1(348)',
    ...
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.653543,0.0207665,0.000194492,-3.00574e-07,1.26859e-10,8608.76,34.0599], Tmin=(100,'K'), Tmax=(913.33,'K')), NASAPolynomial(coeffs=[38.0198,-0.00543598,1.1792e-05,-2.44657e-09,1.53055e-13,-3949.47,-174.207], Tmin=(913.33,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(70.1655,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(473.925,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cycloheptene) + radical(RCCJCC)"""),
)

species(
    label = 'OOC1C=[C]CCCC1(349)',
...
species(
    ...
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.117366,0.0276352,0.000197715,-3.17138e-07,1.35711e-10,-652.954,29.7108], Tmin=(100,'K'), Tmax=(912.75,'K')), NASAPolynomial(coeffs=[43.4712,-0.0118086,1.51275e-05,-3.07113e-09,1.94022e-13,-14838.4,-209.842], Tmin=(912.75,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-7.03987,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(473.925,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cycloheptene) + radical(C=CCJCO)"""),
)
...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.93675,0.0169411,0.000190639,-2.92443e-07,1.23646e-10,26878.4,33.8028], Tmin=(100,'K'), Tmax=(909.17,'K')), NASAPolynomial(coeffs=[36.2458,-0.00677437,1.25947e-05,-2.64231e-09,1.69421e-13,15017.8,-163.099], Tmin=(909.17,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(222.17,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cycloheptene) + radical(ROOJ) + radical(RCCJCC)"""),
)

species(
    label = '[O]OC1[CH]CCCC=C1(42)',
    ...
    molecularWeight = (126.153,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.683048,0.0187937,0.000197588,-3.07954e-07,1.31089e-10,27607.4,34.4544], Tmin=(100,'K'), Tmax=(909.163,'K')), NASAPolynomial(coeffs=[39.9045,-0.0122668,1.53771e-05,-3.15544e-09,2.02847e-13,14627.6,-183.193], Tmin=(909.163,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(228.127,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cycloheptene) + radical(CCJCOOH) + radical(ROOJ)"""),
)

species(
    label = '[O]O[C]1C=CCCCC1(353)',
    ...
    molecularWeight = (126.153,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.928056,0.0142008,0.000204347,-3.1099e-07,1.31332e-10,21817.1,30.9278], Tmin=(100,'K'), Tmax=(908.747,'K')), NASAPolynomial(coeffs=[38.0942,-0.0100792,1.44707e-05,-2.99818e-09,1.92787e-13,9309.77,-176.471], Tmin=(908.747,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(180.062,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + ring(Cycloheptene) + radical(ROOJ) + radical(Allyl_S)"""),
)

species(
    label = '[O]OC1C=CC[CH]CC1(354)',
...
species(
    ...
    molecularWeight = (126.153,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.40034,0.0238125,0.000193853,-3.08995e-07,1.32494e-10,17616.7,29.4546], Tmin=(100,'K'), Tmax=(908.956,'K')), NASAPolynomial(coeffs=[41.6985,-0.0131493,1.59315e-05,-3.2672e-09,2.10415e-13,4128.28,-198.742], Tmin=(908.956,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(144.965,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cycloheptene) + radical(C=CCJCO) + radical(ROOJ)"""),
)

species(
    label = '[O]OC1[C]=CCCCC1(355)',
    ...
    molecularWeight = (126.153,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.629572,0.0213133,0.000188882,-2.98046e-07,1.27397e-10,32109.5,32.815], Tmin=(100,'K'), Tmax=(908.612,'K')), NASAPolynomial(coeffs=[39.4518,-0.0114523,1.49186e-05,-3.07627e-09,1.9828e-13,19352.3,-182.139], Tmin=(908.612,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(265.554,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cycloheptene) + radical(ROOJ) + radical(Cds_S)"""),
)

species(
    label = '[O]OC1C=[C]CCCC1(356)',
...
species(
    ...
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.620574,0.0985376,-7.91258e-05,3.20938e-08,-5.31584e-12,-3337.29,-1.09449], Tmin=(100,'K'), Tmax=(1404.04,'K')), NASAPolynomial(coeffs=[19.0369,0.0425356,-1.92969e-05,3.68606e-09,-2.57673e-13,-8857.31,-102.601], Tmin=(1404.04,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-29.1479,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(482.239,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + polycyclic(PolycyclicRing) + radical(CCJCOOH)"""),
)

species(
    label = '[CH]1CCCCC2OOC12(358)',
    ...
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.620574,0.0985376,-7.91258e-05,3.20938e-08,-5.31584e-12,-3337.29,-0.401344], Tmin=(100,'K'), Tmax=(1404.04,'K')), NASAPolynomial(coeffs=[19.0369,0.0425356,-1.92969e-05,3.68606e-09,-2.57673e-13,-8857.31,-101.908], Tmin=(1404.04,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-29.1479,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(482.239,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + polycyclic(PolycyclicRing) + radical(CCJCOOH)"""),
)
...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.24668,-0.00073123,0.000255856,-3.70636e-07,1.54013e-10,4313.43,28.4137], Tmin=(100,'K'), Tmax=(909.88,'K')), NASAPolynomial(coeffs=[40.9946,-0.0159466,1.79532e-05,-3.63648e-09,2.32488e-13,-9523.07,-195.88], Tmin=(909.88,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(34.5629,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cycloheptene) + radical(CC(C)OJ)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['O2(2)', 'C7H11(22)'],
    products = ['S(66)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(1.06514e+08,'m^3/(mol*s)'), n=0.108445, Ea=(5.74998,'kJ/mol'), T0=(1,'K'), Tmin=(303.03,'K'), Tmax=(2000,'K'), comment="""Estimated using template [C_rad/H/CdCs;Y_rad] for rate rule [C_rad/H/CdCs;O2_birad]
...
reaction(
    label = 'reaction9',
    reactants = ['H(25)', '[O]OC1C=CCC[CH]C1(352)'],
    products = ['S(66)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(25)', '[O]OC1[CH]CCCC=C1(42)'],
    products = ['S(66)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(25)', '[O]O[C]1C=CCCCC1(353)'],
    products = ['S(66)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(25)', '[O]OC1C=CC[CH]CC1(354)'],
    products = ['S(66)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(25)', '[O]OC1[CH]C=CCCC1(41)'],
    products = ['S(66)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(25)', '[O]OC1[C]=CCCCC1(355)'],
    products = ['S(66)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(25)', '[O]OC1C=[C]CCCC1(356)'],
    products = ['S(66)'],
...
reaction(
    label = 'reaction19',
    reactants = ['S(66)'],
    products = ['C1=CCCCCC=1(264)', '[O]O(43)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[O]C1C=CCCCC1(359)', 'O(T)(344)'],
    products = ['S(66)'],
