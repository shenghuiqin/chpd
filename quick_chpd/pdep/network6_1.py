...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.90398,0.027639,5.95847e-05,-9.39094e-08,3.68149e-11,35662.5,15.3987], Tmin=(100,'K'), Tmax=(974.914,'K')), NASAPolynomial(coeffs=[13.3104,0.0267798,-9.77728e-06,1.85693e-09,-1.37527e-13,31255.2,-50.5378], Tmin=(974.914,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(295.75,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cdd-CdsCds) + ring(1_2_cycloheptadiene)"""),
)
...
species(
    ...
    molecularWeight = (92.1384,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.48168,-0.0304727,0.000305548,-4.16697e-07,1.70842e-10,51821.5,22.627], Tmin=(100,'K'), Tmax=(902.927,'K')), NASAPolynomial(coeffs=[39.3536,-0.0274529,2.41572e-05,-4.87724e-09,3.20025e-13,38381.4,-189.047], Tmin=(902.927,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(429.915,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(1,4-Cycloheptadiene) + radical(C=CCJC=C) + radical(Cds_S)"""),
)

species(
    label = '[C]1[CH]C=CCCC=1(258)',
    ...
    molecularWeight = (92.1384,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.932234,0.0555865,-1.33235e-05,-2.33495e-08,1.32168e-11,49788.4,6.38153], Tmin=(100,'K'), Tmax=(987.672,'K')), NASAPolynomial(coeffs=[14.8428,0.0261858,-9.58084e-06,1.73711e-09,-1.22551e-13,45726.8,-67.2077], Tmin=(987.672,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(412.959,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + ring(1,3-Cycloheptadiene) + radical(C=CJC=C) + radical(Allyl_S)"""),
)

species(
    label = '[CH]1C2C=CCCC12(259)',
...
species(
    ...
    molecularWeight = (92.1384,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.932197,0.0555869,-1.33251e-05,-2.33474e-08,1.32159e-11,49788.4,5.68851], Tmin=(100,'K'), Tmax=(987.681,'K')), NASAPolynomial(coeffs=[14.843,0.0261856,-9.58069e-06,1.73708e-09,-1.22548e-13,45726.7,-67.9016], Tmin=(987.681,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(412.959,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + ring(1,3-Cycloheptadiene) + radical(Allyl_S) + radical(C=CJC=C)"""),
)
...
species(
    ...
    molecularWeight = (93.1464,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.42553,0.0108304,0.000112129,-1.45538e-07,5.38353e-11,30400.8,14.6166], Tmin=(100,'K'), Tmax=(977.797,'K')), NASAPolynomial(coeffs=[12.3357,0.0309149,-1.16848e-05,2.28886e-09,-1.72848e-13,25564.6,-47.7914], Tmin=(977.797,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(252.118,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + polycyclic(s2_4_5_ene_1) + radical(cyclopentene-allyl)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['H(25)', 'C1=CC=CCCC=1(255)'],
    products = ['C7H9(5)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction5',
    reactants = ['H(25)', '[CH]1C=C[CH]CC=C1(256)'],
    products = ['C7H9(5)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['H(25)', '[C]1=C[CH]C=CCC1(257)'],
    products = ['C7H9(5)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(25)', '[C]1[CH]C=CCCC=1(258)'],
    products = ['C7H9(5)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction10',
    reactants = ['H(25)', '[C]1C=CCCC=C1(261)'],
    products = ['C7H9(5)'],
