...
species(
    label = 'C#CC=CC(C)C(928)',
    structure = SMILES('C#CC=CC(C)C'),
    E0 = (180.284,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,750,770,3400,2100,2175,525,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,2995,3025,975,1000,1300,1375,400,500,1630,1680,180],'cm^-1')),
        HinderedRotor(inertia=(0.915413,'amu*angstrom^2'), symmetry=1, barrier=(21.0471,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.915562,'amu*angstrom^2'), symmetry=1, barrier=(21.0506,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.915407,'amu*angstrom^2'), symmetry=1, barrier=(21.047,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.915681,'amu*angstrom^2'), symmetry=1, barrier=(21.0533,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.793096,0.0572067,-7.72314e-06,-3.0106e-08,1.53274e-11,21810.4,24.4247], Tmin=(100,'K'), Tmax=(1002.08,'K')), NASAPolynomial(coeffs=[15.2222,0.0295808,-1.12333e-05,2.07593e-09,-1.47564e-13,17413.7,-52.7258], Tmin=(1002.08,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(180.284,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(390.78,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCtH) + group(Ct-Ct(Cds-Cds)) + group(Ct-CtH)"""),
)
...
species(
    label = 'C=[C]C=C[C](C)C(929)',
    structure = SMILES('C=[C]C=C[C](C)C'),
    E0 = (334.474,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([360,370,350,2950,3100,1380,975,1025,1650,1685,370,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,2995,3025,975,1000,1300,1375,400,500,1630,1680,333.537,333.538],'cm^-1')),
        HinderedRotor(inertia=(1.21482,'amu*angstrom^2'), symmetry=1, barrier=(95.8999,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.165003,'amu*angstrom^2'), symmetry=1, barrier=(13.0258,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.165006,'amu*angstrom^2'), symmetry=1, barrier=(13.0258,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.21478,'amu*angstrom^2'), symmetry=1, barrier=(95.8999,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.857274,0.0586488,-1.56057e-05,-2.07608e-08,1.2391e-11,40350.5,23.8423], Tmin=(100,'K'), Tmax=(968.44,'K')), NASAPolynomial(coeffs=[13.3051,0.0314616,-1.10201e-05,1.91388e-09,-1.30731e-13,36803.4,-41.6775], Tmin=(968.44,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(334.474,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(390.78,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + radical(Allyl_T) + radical(C=CJC=C)"""),
)

species(
    label = 'C=[C]C=[C]C(C)C(930)',
    structure = SMILES('C=[C]C=[C]C(C)C'),
    E0 = (440.335,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2950,3100,1380,975,1025,1650,1670,1700,300,440,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3010,987.5,1337.5,450,1655,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.645087,'amu*angstrom^2'), symmetry=1, barrier=(14.8318,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.14241,'amu*angstrom^2'), symmetry=1, barrier=(26.3368,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.644944,'amu*angstrom^2'), symmetry=1, barrier=(14.8285,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.644921,'amu*angstrom^2'), symmetry=1, barrier=(14.828,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.479433,0.069424,-4.85081e-05,1.45795e-08,-5.74248e-13,53093.7,26.7263], Tmin=(100,'K'), Tmax=(1059.22,'K')), NASAPolynomial(coeffs=[13.7582,0.0312936,-1.15248e-05,2.0113e-09,-1.35369e-13,49606.7,-41.2815], Tmin=(1059.22,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(440.335,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(390.78,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + radical(Cds_S) + radical(C=CJC=C)"""),
)

species(
    label = '[CH]=[C]C=CC(C)C(931)',
    structure = SMILES('[CH]=C=C[CH]C(C)C'),
    E0 = (363.044,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([540,610,2055,1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3120,650,792.5,1650,3010,987.5,1337.5,450,1655,3025,407.5,1350,352.5,832.256],'cm^-1')),
        HinderedRotor(inertia=(0.0937252,'amu*angstrom^2'), symmetry=1, barrier=(2.15493,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.910648,'amu*angstrom^2'), symmetry=1, barrier=(20.9376,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.620884,'amu*angstrom^2'), symmetry=1, barrier=(14.2753,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(3.33452,'amu*angstrom^2'), symmetry=1, barrier=(76.6672,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.80049,0.0603827,-2.26836e-05,-1.1199e-08,8.18129e-12,43788.1,25.4573], Tmin=(100,'K'), Tmax=(1011.37,'K')), NASAPolynomial(coeffs=[13.13,0.0324273,-1.20832e-05,2.15617e-09,-1.48409e-13,40229.9,-39.426], Tmin=(1011.37,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(363.044,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(390.78,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(Allyl_S) + radical(C=C=CJ)"""),
)

species(
    label = 'C=C1[CH]C1C(C)C(932)',
    structure = SMILES('C=C1[CH]C1C(C)C'),
    E0 = (239.703,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (95.1622,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.16894,0.0432098,4.23682e-05,-8.42413e-08,3.48544e-11,28948.6,22.053], Tmin=(100,'K'), Tmax=(970.722,'K')), NASAPolynomial(coeffs=[15.4978,0.0309429,-1.0959e-05,2.02405e-09,-1.47176e-13,23962.8,-58.0018], Tmin=(970.722,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(239.703,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(419.881,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + ring(Methylene_cyclopropane) + radical(Allyl_S)"""),
)
...
species(
    ...
    E0 = (198.822,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,3120,650,792.5,1650,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3010,987.5,1337.5,450,1655],'cm^-1')),
        HinderedRotor(inertia=(0.130183,'amu*angstrom^2'), symmetry=1, barrier=(12.4323,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.127824,'amu*angstrom^2'), symmetry=1, barrier=(12.4337,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.130917,'amu*angstrom^2'), symmetry=1, barrier=(12.4169,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (69.125,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.88317,0.0364861,9.45741e-06,-3.47453e-08,1.50026e-11,23997.9,19.3855], Tmin=(100,'K'), Tmax=(995.759,'K')), NASAPolynomial(coeffs=[10.4635,0.0255697,-9.57543e-06,1.74946e-09,-1.2331e-13,21121.5,-27.8361], Tmin=(995.759,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(198.822,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_P)"""),
)
...
species(
    label = 'C=C=CC=C(C)C(934)',
    structure = SMILES('C=C=CC=C(C)C'),
    E0 = (159.419,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2995,3025,975,1000,1300,1375,400,500,1630,1680,2950,3100,1380,975,1025,1650,540,610,2055,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,350,440,435,1725,180],'cm^-1')),
        HinderedRotor(inertia=(0.832521,'amu*angstrom^2'), symmetry=1, barrier=(19.1413,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.832475,'amu*angstrom^2'), symmetry=1, barrier=(19.1402,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.832432,'amu*angstrom^2'), symmetry=1, barrier=(19.1393,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.297461,0.0708707,-5.31742e-05,2.07206e-08,-3.26001e-12,19315.8,24.7225], Tmin=(100,'K'), Tmax=(1505.01,'K')), NASAPolynomial(coeffs=[16.4078,0.0280524,-1.04981e-05,1.81645e-09,-1.19775e-13,14466.6,-59.5863], Tmin=(1505.01,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(159.419,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(394.937,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + group(Cdd-CdsCds)"""),
)

species(
    label = 'C=C=CC[C](C)C(935)',
    structure = SMILES('C=C=CC[C](C)C'),
    E0 = (252.878,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([360,370,350,540,610,2055,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3010,987.5,1337.5,450,1655,2750,2850,1437.5,1250,1305,750,350,2950,3100,1380,975,1025,1650,237.56,237.587],'cm^-1')),
        HinderedRotor(inertia=(0.00190314,'amu*angstrom^2'), symmetry=1, barrier=(9.28423,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.231837,'amu*angstrom^2'), symmetry=1, barrier=(9.2834,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.231797,'amu*angstrom^2'), symmetry=1, barrier=(9.28381,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.401677,'amu*angstrom^2'), symmetry=1, barrier=(16.0865,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (95.1622,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.34161,0.0640958,-4.24497e-05,1.63567e-08,-2.98163e-12,30505,25.1364], Tmin=(100,'K'), Tmax=(1138.7,'K')), NASAPolynomial(coeffs=[5.87697,0.0481641,-2.14628e-05,4.06955e-09,-2.84006e-13,29472.1,2.66687], Tmin=(1138.7,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(252.878,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(415.724,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(Tertalkyl)"""),
)

species(
    label = 'C=C=[C]CC(C)C(936)',
    structure = SMILES('[CH2]C#CCC(C)C'),
    E0 = (207.206,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (95.1622,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.839267,0.0601753,-2.1243e-05,-1.00149e-08,7.02627e-12,25042.9,27.2591], Tmin=(100,'K'), Tmax=(1033.88,'K')), NASAPolynomial(coeffs=[11.7233,0.0365426,-1.37626e-05,2.44749e-09,-1.67098e-13,21804.9,-30.3882], Tmin=(1033.88,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(207.206,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CtCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CtHHH) + group(Ct-CtCs) + group(Ct-CtCs) + radical(Propargyl)"""),
)

species(
    label = '[CH2]C(C)CC=C=C(937)',
    structure = SMILES('[CH2]C(C)CC=C=C'),
    E0 = (272.537,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,540,610,2055,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,296.203,296.652],'cm^-1')),
        HinderedRotor(inertia=(0.00192608,'amu*angstrom^2'), symmetry=1, barrier=(0.11977,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.148696,'amu*angstrom^2'), symmetry=1, barrier=(9.41972,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.149964,'amu*angstrom^2'), symmetry=1, barrier=(9.3918,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.467864,'amu*angstrom^2'), symmetry=1, barrier=(29.1532,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (95.1622,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.561608,0.0667925,-3.77196e-05,5.51615e-09,1.84076e-12,32909.9,29.2719], Tmin=(100,'K'), Tmax=(1084.38,'K')), NASAPolynomial(coeffs=[12.8785,0.0352688,-1.33555e-05,2.36703e-09,-1.60526e-13,29420.8,-34.919], Tmin=(1084.38,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(272.537,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(415.724,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(Isobutyl)"""),
)

species(
    label = '[CH]=C=CCC(C)C(938)',
    structure = SMILES('C#C[CH]CC(C)C'),
    E0 = (218.757,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([750,770,3400,2100,2175,525,1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,2750,2850,1437.5,1250,1305,750,350,3025,407.5,1350,352.5,360.334,3769.32],'cm^-1')),
        HinderedRotor(inertia=(0.135308,'amu*angstrom^2'), symmetry=1, barrier=(12.4656,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.914751,'amu*angstrom^2'), symmetry=1, barrier=(84.244,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.914635,'amu*angstrom^2'), symmetry=1, barrier=(84.2446,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.135309,'amu*angstrom^2'), symmetry=1, barrier=(12.4655,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.91443,'amu*angstrom^2'), symmetry=1, barrier=(84.2444,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (95.1622,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.56987,0.0680135,-3.88395e-05,3.25027e-09,4.00268e-12,26440.5,25.83], Tmin=(100,'K'), Tmax=(967.626,'K')), NASAPolynomial(coeffs=[12.5387,0.0346558,-1.21168e-05,2.05512e-09,-1.36544e-13,23369.6,-35.4181], Tmin=(967.626,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(218.757,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CtCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(Sec_Propargyl)"""),
)

species(
    label = 'CC(C)C1C=[C]C1(939)',
    structure = SMILES('CC(C)C1C=[C]C1'),
    E0 = (308.599,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (95.1622,'amu'),
...
species(
    ...
    molecularWeight = (95.1622,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.659414,0.0641972,-3.5793e-05,7.93828e-09,-2.00605e-13,31767.5,29.7497], Tmin=(100,'K'), Tmax=(1357.98,'K')), NASAPolynomial(coeffs=[13.8543,0.0349761,-1.41699e-05,2.55327e-09,-1.72127e-13,27294.4,-41.2203], Tmin=(1357.98,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(263.067,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(415.724,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cdd-Cd)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(Cs_S)"""),
)
...
reaction(
    label = 'reaction465',
    reactants = ['H(25)', 'C#CC=CC(C)C(928)'],
    products = ['C=[C]C=CC(C)C(699)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(1.11e+08,'s^-1'), n=1.1915, Ea=(103.605,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1600,'K'), comment="""Estimated using template [R4H_SDS;Cd_rad_out_Cd;Cs_H_out] for rate rule [R4H_SDS;Cd_rad_out_Cd;Cs_H_out_Cs2]
Euclidian distance = 3.0
family: intra_H_migration"""),
)
...
reaction(
    label = 'reaction470',
    reactants = ['[CH]=C[C]=C(910)', 'C[CH]C(867)'],
    products = ['C=[C]C=CC(C)C(699)'],
...
reaction(
    label = 'reaction471',
    reactants = ['H(25)', 'C=[C]C=C[C](C)C(929)'],
    products = ['C=[C]C=CC(C)C(699)'],
...
reaction(
    label = 'reaction473',
    reactants = ['H(25)', 'C=[C]C=[C]C(C)C(930)'],
    products = ['C=[C]C=CC(C)C(699)'],
...
reaction(
    label = 'reaction475',
    reactants = ['H(25)', '[CH]=[C]C=CC(C)C(931)'],
    products = ['C=[C]C=CC(C)C(699)'],
...
reaction(
    label = 'reaction478',
    reactants = ['[CH]=CC(C)C(933)', '[C]=C(913)'],
    products = ['C=[C]C=CC(C)C(699)'],
...
reaction(
    label = 'reaction479',
    reactants = ['H(25)', 'C=C=CC=C(C)C(934)'],
    products = ['C=[C]C=CC(C)C(699)'],
...
reaction(
    label = 'reaction484',
    reactants = ['[CH]=C=CCC(C)C(938)'],
    products = ['C=[C]C=CC(C)C(699)'],
    transitionState = 'TS484',
    kinetics = Arrhenius(A=(74200,'s^-1'), n=2.23, Ea=(44.3086,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4H;Cd_rad_out_singleH;Cs_H_out_1H] for rate rule [R4H_MMS;Cd_rad_out_singleH;Cs_H_out_H/(NonDeC/Cs/Cs)]
Euclidian distance = 3.16227766017
Multiplied by reaction path degeneracy 2.0
family: intra_H_migration"""),
)
...
reaction(
    label = 'reaction487',
    reactants = ['[CH]=C=C(785)', '[CH]C(C)C(941)'],
    products = ['C=[C]C=CC(C)C(699)'],
