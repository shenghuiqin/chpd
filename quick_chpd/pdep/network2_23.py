...
species(
    label = 'C=CCCC1C=C1(835)',
    structure = SMILES('C=CCCC1C=C1'),
    E0 = (297.523,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2950,3100,1380,975,1025,1650,2750,2950,3150,900,1000,1100,3010,987.5,1337.5,450,1655,300,800,800,800,800,800,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.769496,0.0612906,-2.89341e-05,-1.81214e-09,3.90279e-12,35908.3,24.4554], Tmin=(100,'K'), Tmax=(1104.4,'K')), NASAPolynomial(coeffs=[13.2435,0.0328883,-1.31446e-05,2.41167e-09,-1.6707e-13,32129.9,-41.595], Tmin=(1104.4,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(297.523,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(394.937,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)CsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Cyclopropene)"""),
)
...
species(
    label = '[CH2]C[CH]CC=C=C(790)',
    structure = SMILES('[CH2]C[CH]CC=C=C'),
    E0 = (476.201,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([540,610,2055,3000,3100,440,815,1455,1000,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2950,3100,1380,975,1025,1650,180,716.436,2411.94],'cm^-1')),
        HinderedRotor(inertia=(0.509495,'amu*angstrom^2'), symmetry=1, barrier=(11.7143,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00285096,'amu*angstrom^2'), symmetry=1, barrier=(11.6824,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.71859,'amu*angstrom^2'), symmetry=1, barrier=(39.5138,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.155989,'amu*angstrom^2'), symmetry=1, barrier=(3.5865,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.44515,0.0613502,-4.29323e-05,1.83993e-08,-3.80071e-12,57361.4,28.9609], Tmin=(100,'K'), Tmax=(1025.63,'K')), NASAPolynomial(coeffs=[5.34547,0.0461388,-2.06853e-05,3.93862e-09,-2.75867e-13,56561.3,10.0454], Tmin=(1025.63,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(476.201,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(390.78,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(RCCJCC) + radical(RCCJ)"""),
)
...
species(
    label = 'C=C=CC[C]CC(795)',
    structure = SMILES('C=C=CC[C]CC'),
    E0 = (504.026,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2950,3100,1380,975,1025,1650,540,610,2055,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,194.58,194.581,194.581,194.581],'cm^-1')),
        HinderedRotor(inertia=(0.904372,'amu*angstrom^2'), symmetry=1, barrier=(24.2984,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.53236,'amu*angstrom^2'), symmetry=1, barrier=(68.039,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.369197,'amu*angstrom^2'), symmetry=1, barrier=(9.91944,'kJ/mol'), semiclassical=False),
...
species(
    label = 'C1=CC[CH]CCC=1(813)',
    structure = SMILES('C1=CC[CH]CCC=1'),
    E0 = (390.875,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,2900,2950,3000,3050,3100,3150,900,925,950,975,1000,1025,1050,1075,1100,300,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
    ],
    ...
    molecularWeight = (93.1464,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.00451,0.0349002,2.05529e-05,-3.68478e-08,1.25829e-11,47090.6,19.465], Tmin=(100,'K'), Tmax=(1128.7,'K')), NASAPolynomial(coeffs=[6.71842,0.0407906,-1.73044e-05,3.24938e-09,-2.26907e-13,44587.2,-10.2236], Tmin=(1128.7,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(390.875,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cdd-CdsCds) + ring(1_2_cycloheptadiene) + radical(RCCJCC)"""),
)

species(
    label = '[CH]1CCC2[CH]C2C1(814)',
    structure = SMILES('[CH]1CCC2[CH]C2C1'),
    E0 = (441.927,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2794.44,2838.89,2883.33,2927.78,2972.22,3016.67,3061.11,3105.56,3150,900,922.222,944.444,966.667,988.889,1011.11,1033.33,1055.56,1077.78,1100,300,800,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
    ],
    ...
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.30289,0.0245946,5.60144e-05,-7.22939e-08,2.42008e-11,53223.3,22.1848], Tmin=(100,'K'), Tmax=(1077.17,'K')), NASAPolynomial(coeffs=[6.13811,0.0444889,-1.9225e-05,3.69234e-09,-2.62943e-13,50416.6,-5.79562], Tmin=(1077.17,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(441.927,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(407.409,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + polycyclic(s2_3_6_ane) + radical(bicyclo[4.1.0]heptane-C6-3) + radical(bicyclo[4.1.0]heptane-C3-7)"""),
)

species(
    label = '[CH]1[CH]C2CCC2C1(815)',
    structure = SMILES('[CH]1[CH]C2CCC2C1'),
    E0 = (411.732,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.45787,0.018827,7.43115e-05,-9.21008e-08,3.1297e-11,49588.3,20.6582], Tmin=(100,'K'), Tmax=(1047.63,'K')), NASAPolynomial(coeffs=[6.44153,0.0437034,-1.87028e-05,3.61408e-09,-2.59789e-13,46553.8,-9.24498], Tmin=(1047.63,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(411.732,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(407.409,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + polycyclic(s2_4_5_ane) + radical(bicyclo[3.2.0]heptane-C5-2) + radical(bicyclo[3.2.0]heptane-C5-3)"""),
)
...
species(
    label = 'C1=CC2CCC2C1(816)',
    structure = SMILES('C1=CC2CCC2C1'),
    E0 = (124.813,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.22097,0.0161288,0.000102929,-1.36753e-07,5.07478e-11,15096.1,17.1507], Tmin=(100,'K'), Tmax=(981.003,'K')), NASAPolynomial(coeffs=[12.3009,0.0333872,-1.26936e-05,2.46203e-09,-1.83771e-13,10310.3,-45.5981], Tmin=(981.003,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(124.813,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(407.409,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + polycyclic(s2_4_5_ene_1)"""),
)

species(
    label = 'C1=CC2C[C]2CC1(821)',
    ...
    molecularWeight = (93.1464,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.19856,0.0266722,4.77355e-05,-6.76096e-08,2.38608e-11,35120.9,18.6254], Tmin=(100,'K'), Tmax=(1045.21,'K')), NASAPolynomial(coeffs=[7.72106,0.0383158,-1.60152e-05,3.05674e-09,-2.18277e-13,32176,-16.8266], Tmin=(1045.21,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(291.38,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + polycyclic(s2_3_6_ene_1) + radical(Tertalkyl)"""),
)

species(
    label = 'C1=C[C]2CC2CC1(822)',
    ...
    molecularWeight = (93.1464,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.39555,0.0138604,9.97038e-05,-1.31317e-07,4.88077e-11,28694.4,15.0326], Tmin=(100,'K'), Tmax=(974.265,'K')), NASAPolynomial(coeffs=[11.2587,0.0318577,-1.174e-05,2.23949e-09,-1.6607e-13,24386.2,-40.7428], Tmin=(974.265,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(237.939,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + polycyclic(s2_3_6_ene_1) + radical(Allyl_T)"""),
)

species(
    label = '[CH]1C2C=CCCC12(213)',
    ...
    molecularWeight = (93.1464,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.28484,0.0197959,7.62465e-05,-1.02679e-07,3.74495e-11,39992.4,18.8323], Tmin=(100,'K'), Tmax=(1000.78,'K')), NASAPolynomial(coeffs=[9.97747,0.034469,-1.38224e-05,2.66887e-09,-1.95249e-13,36178.1,-29.65], Tmin=(1000.78,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(331.871,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + polycyclic(s2_3_6_ene_1) + radical(cyclopropane)"""),
)

species(
    label = '[CH]1CC=CC2CC12(823)',
    ...
    molecularWeight = (93.1464,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.31118,0.0179879,8.31203e-05,-1.10851e-07,4.0518e-11,36219.5,18.9466], Tmin=(100,'K'), Tmax=(997.139,'K')), NASAPolynomial(coeffs=[10.5596,0.0335339,-1.34264e-05,2.61181e-09,-1.92597e-13,32156.7,-32.9474], Tmin=(997.139,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(300.5,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + polycyclic(s2_3_6_ene_1) + radical(Cs_S)"""),
)

species(
    label = '[CH]1C=CC2CC2C1(824)',
    ...
    molecularWeight = (93.1464,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.32118,0.0139717,0.000103397,-1.37273e-07,5.12045e-11,29494.8,15.2466], Tmin=(100,'K'), Tmax=(976.245,'K')), NASAPolynomial(coeffs=[12.5301,0.0303954,-1.13441e-05,2.205e-09,-1.6589e-13,24725.6,-47.9773], Tmin=(976.245,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(244.56,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + polycyclic(s2_3_6_ene_1) + radical(cyclohexene-allyl)"""),
)

species(
    label = '[C]1=CCCC2CC12(825)',
    ...
    molecularWeight = (93.1464,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.08382,0.0238615,6.94657e-05,-9.93343e-08,3.72193e-11,41434.7,17.6793], Tmin=(100,'K'), Tmax=(991.686,'K')), NASAPolynomial(coeffs=[11.3549,0.0322866,-1.25848e-05,2.41654e-09,-1.77269e-13,37342.8,-38.3308], Tmin=(991.686,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(343.8,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + polycyclic(s2_3_6_ene_1) + radical(Cds_S)"""),
)

species(
    label = '[C]1=CC2CC2CC1(826)',
...
species(
    label = '[CH]1CCC2C[C]2C1(827)',
    structure = SMILES('[CH]1CCC2C[C]2C1'),
    E0 = (429.888,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2794.44,2838.89,2883.33,2927.78,2972.22,3016.67,3061.11,3105.56,3150,900,922.222,944.444,966.667,988.889,1011.11,1033.33,1055.56,1077.78,1100,300,800,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
    ],
    ...
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.24515,0.0310048,2.97481e-05,-4.10216e-08,1.26087e-11,51772.7,21.8841], Tmin=(100,'K'), Tmax=(1201.36,'K')), NASAPolynomial(coeffs=[4.84552,0.0468443,-2.06162e-05,3.90061e-09,-2.71672e-13,49380.1,1.5042], Tmin=(1201.36,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(429.888,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(407.409,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + polycyclic(s2_3_6_ane) + radical(bicyclo[4.1.0]heptane-C6-3) + radical(bicyclo[4.1.0]heptane-tertiary)"""),
)
...
species(
    label = '[CH]1CC[C]2CC2C1(828)',
    structure = SMILES('[CH]1CC[C]2CC2C1'),
    E0 = (429.888,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2794.44,2838.89,2883.33,2927.78,2972.22,3016.67,3061.11,3105.56,3150,900,922.222,944.444,966.667,988.889,1011.11,1033.33,1055.56,1077.78,1100,300,800,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
    ],
...
species(
    label = '[CH]1[CH]CC2CC2C1(829)',
    structure = SMILES('[CH]1[CH]CC2CC2C1'),
    E0 = (397.995,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2794.44,2838.89,2883.33,2927.78,2972.22,3016.67,3061.11,3105.56,3150,900,922.222,944.444,966.667,988.889,1011.11,1033.33,1055.56,1077.78,1100,300,800,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
    ],
    ...
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.30289,0.0245946,5.60144e-05,-7.22939e-08,2.42008e-11,47939.5,21.4917], Tmin=(100,'K'), Tmax=(1077.17,'K')), NASAPolynomial(coeffs=[6.13811,0.0444889,-1.9225e-05,3.69234e-09,-2.62943e-13,45132.8,-6.48877], Tmin=(1077.17,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(397.995,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(407.409,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + polycyclic(s2_3_6_ane) + radical(bicyclo[4.1.0]heptane-C6-3) + radical(bicyclo[4.1.0]heptane-C6-3)"""),
)
...
species(
    label = '[CH]=CCCC1[CH]C1(830)',
    structure = SMILES('[CH]=CCCC1[CH]C1'),
    E0 = (538.701,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,3010,987.5,1337.5,450,1655,3120,650,792.5,1650,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,300,800,800,800,800,800,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.24413,0.0473588,1.05525e-05,-4.24331e-08,1.81e-11,64901.6,28.7288], Tmin=(100,'K'), Tmax=(1016.96,'K')), NASAPolynomial(coeffs=[12.7117,0.0327467,-1.28717e-05,2.4071e-09,-1.71308e-13,60992.4,-34.5409], Tmin=(1016.96,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(538.701,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(394.937,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Cyclopropane) + radical(cyclopropane) + radical(Cds_P)"""),
)

species(
    label = '[C]1CCCC2CC12(831)',
    ...
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.85129,0.0321223,5.13445e-05,-7.58342e-08,2.72104e-11,53626.4,28.4052], Tmin=(100,'K'), Tmax=(1039.88,'K')), NASAPolynomial(coeffs=[9.08555,0.0421211,-1.76412e-05,3.37235e-09,-2.41303e-13,50076.7,-16.6125], Tmin=(1039.88,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(445.124,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(407.409,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(CsJ2_singlet-CsH) + polycyclic(s2_3_6_ane)"""),
)

species(
    label = '[C]1CCC2CC2C1(832)',
    structure = SMILES('[C]1CCC2CC2C1'),
    E0 = (445.124,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2794.44,2838.89,2883.33,2927.78,2972.22,3016.67,3061.11,3105.56,3150,900,922.222,944.444,966.667,988.889,1011.11,1033.33,1055.56,1077.78,1100,300,800,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
    ],
...
species(
    ...
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.45601,0.0359666,5.6422e-05,-9.95003e-08,4.10602e-11,60904.9,26.4767], Tmin=(100,'K'), Tmax=(950.291,'K')), NASAPolynomial(coeffs=[15.5025,0.0269533,-8.45085e-06,1.50224e-09,-1.09875e-13,55972.6,-52.4787], Tmin=(950.291,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(505.48,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(399.095,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Cyclobutane) + radical(Isobutyl) + radical(Cds_P)"""),
)

species(
    label = '[CH]=C=CCCC=C(834)',
    structure = SMILES('C#C[CH]CCC=C'),
    E0 = (352.233,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([750,770,3400,2100,2175,525,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2950,3100,1380,975,1025,1650,294.704,294.737,4000],'cm^-1')),
        HinderedRotor(inertia=(0.293512,'amu*angstrom^2'), symmetry=1, barrier=(18.0928,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.36993,'amu*angstrom^2'), symmetry=1, barrier=(84.4392,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.37038,'amu*angstrom^2'), symmetry=1, barrier=(84.4407,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.36984,'amu*angstrom^2'), symmetry=1, barrier=(84.4396,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (93.1464,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.841005,0.063036,-4.03708e-05,7.46499e-09,2.30305e-12,42483.4,26.3042], Tmin=(100,'K'), Tmax=(964.144,'K')), NASAPolynomial(coeffs=[12.2363,0.0297466,-1.03403e-05,1.74678e-09,-1.15789e-13,39635.9,-31.6268], Tmin=(964.144,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(352.233,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CtCsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(Sec_Propargyl)"""),
)
...
species(
    ...
    E0 = (437.463,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2950,3150,900,1000,1100,990.336,990.341,990.357,990.361,990.368,990.381],'cm^-1')),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (39.0559,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.94487,-0.0154335,9.82911e-05,-1.21181e-07,4.69198e-11,52632.1,4.83153], Tmin=(100,'K'), Tmax=(915.264,'K')), NASAPolynomial(coeffs=[10.1923,3.64674e-05,2.83816e-06,-5.94881e-10,3.54984e-14,49696.9,-34.5426], Tmin=(915.264,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(437.463,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(133.032,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cyclopropene) + radical(cyclopropenyl-allyl)"""),
)

species(
    label = 'C=CCC[C]1C=C1(845)',
    structure = SMILES('C=CCC[C]1C=C1'),
    E0 = (429.504,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2950,3100,1380,975,1025,1650,2750,3150,900,1100,3010,987.5,1337.5,450,1655,200,800,900,1000,1100,1200,1300,1400,1500,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (93.1464,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.05863,0.0557802,-2.31733e-05,-4.81225e-09,4.59294e-12,51770.8,21.6696], Tmin=(100,'K'), Tmax=(1087.51,'K')), NASAPolynomial(coeffs=[11.8424,0.0321439,-1.2679e-05,2.30681e-09,-1.59071e-13,48477.5,-35.618], Tmin=(1087.51,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(429.504,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(369.994,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)CsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Cyclopropene) + radical(Allyl_T)"""),
)

species(
    label = '[CH2]C1C=C1(846)',
    structure = SMILES('[CH2]C1C=C1'),
    E0 = (446.164,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2950,3150,900,1000,1100,3000,3100,440,815,1455,1000,180,180,658.724,1341.95,1341.98,1341.99,1342.06,1342.13],'cm^-1')),
        HinderedRotor(inertia=(0.247883,'amu*angstrom^2'), symmetry=1, barrier=(5.69932,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (53.0825,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.73383,0.0227302,3.27419e-06,-2.03266e-08,9.85322e-12,53711.4,11.9746], Tmin=(100,'K'), Tmax=(922.381,'K')), NASAPolynomial(coeffs=[7.72009,0.0142823,-4.41419e-06,7.16687e-10,-4.76715e-14,52231.1,-14.7165], Tmin=(922.381,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(446.164,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)CsH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cyclopropene) + radical(Isobutyl)"""),
)

species(
    label = 'C=CC[CH]C1C=C1(847)',
    structure = SMILES('C=CC[CH]C1C=C1'),
    E0 = (492.065,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2950,3150,900,1000,1100,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,3025,407.5,1350,352.5,2750,2850,1437.5,1250,1305,750,350,300,800,800,800,800,800,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (93.1464,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.967395,0.0597655,-3.81974e-05,1.21145e-08,-1.55703e-12,59296.5,26.316], Tmin=(100,'K'), Tmax=(1775.74,'K')), NASAPolynomial(coeffs=[15.1446,0.0278303,-1.12212e-05,1.98692e-09,-1.31199e-13,54261.5,-50.2215], Tmin=(1775.74,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(492.065,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(369.994,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)CsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Cyclopropene) + radical(Cs_S)"""),
)

species(
    label = '[CH2]CC1C=C1(848)',
    structure = SMILES('[CH2]CC1C=C1'),
    E0 = (422.548,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2950,3150,900,1000,1100,3000,3100,440,815,1455,1000,2750,2850,1437.5,1250,1305,750,350,200,800,914.286,1028.57,1142.86,1257.14,1371.43,1485.71,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    ...
    molecularWeight = (67.1091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.97883,0.0380562,-1.36975e-05,-5.85435e-09,4.06334e-12,50898.9,16.9354], Tmin=(100,'K'), Tmax=(1074.66,'K')), NASAPolynomial(coeffs=[9.41598,0.0224765,-8.84344e-06,1.61344e-09,-1.11648e-13,48601.6,-22.7314], Tmin=(1074.66,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(422.548,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)CsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cyclopropene) + radical(RCCJ)"""),
)

species(
    label = 'C=C[CH]CC1C=C1(849)',
    structure = SMILES('[CH2]C=CCC1C=C1'),
    E0 = (436.777,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,2750,2950,3150,900,1000,1100,2995,3025,975,1000,1300,1375,400,500,1630,1680,200,800,900,1000,1100,1200,1300,1400,1500,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (93.1464,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.863426,0.0585076,-2.34585e-05,-9.32727e-09,7.14579e-12,52654.1,23.9575], Tmin=(100,'K'), Tmax=(1045.24,'K')), NASAPolynomial(coeffs=[13.898,0.0294275,-1.15781e-05,2.13492e-09,-1.49618e-13,48792.9,-44.9391], Tmin=(1045.24,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(436.777,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(369.994,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)CsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cyclopropene) + radical(Allyl_P)"""),
)

species(
    label = 'C=CCCC1[C]=C1(850)',
    structure = SMILES('C=CCCC1[C]=C1'),
    E0 = (525.742,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2950,3100,1380,975,1025,1650,2750,3150,900,1100,3010,987.5,1337.5,450,1655,180,180,180,180,1074.04,1152.75,1600,1800,3000,3200],'cm^-1')),
        HinderedRotor(inertia=(0.175174,'amu*angstrom^2'), symmetry=1, barrier=(4.0276,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.175174,'amu*angstrom^2'), symmetry=1, barrier=(4.0276,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.175174,'amu*angstrom^2'), symmetry=1, barrier=(4.0276,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    ...
    molecularWeight = (93.1464,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.928997,0.063661,-4.60182e-05,1.74474e-08,-2.74075e-12,63345.6,24.353], Tmin=(100,'K'), Tmax=(1463.38,'K')), NASAPolynomial(coeffs=[12.7745,0.0312829,-1.28303e-05,2.32827e-09,-1.57858e-13,59878.7,-37.3049], Tmin=(1463.38,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(525.742,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(369.994,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)CsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Cyclopropene) + radical(cyclopropenyl-vinyl)"""),
)

species(
    label = 'C=[C]CCC1C=C1(851)',
    structure = SMILES('C=[C]CCC1C=C1'),
    E0 = (535.365,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,1685,370,2750,2950,3150,900,1000,1100,2950,3100,1380,975,1025,1650,300,800,800,800,800,800,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (93.1464,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.928997,0.063661,-4.60182e-05,1.74474e-08,-2.74075e-12,64503,24.353], Tmin=(100,'K'), Tmax=(1463.38,'K')), NASAPolynomial(coeffs=[12.7745,0.0312829,-1.28303e-05,2.32827e-09,-1.57858e-13,61036.1,-37.3049], Tmin=(1463.38,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(535.365,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(369.994,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)CsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Cyclopropene) + radical(Cds_S)"""),
)

species(
    label = '[CH]=CCCC1C=C1(852)',
    structure = SMILES('[CH]=CCCC1C=C1'),
    E0 = (544.619,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2950,3150,900,1000,1100,3010,987.5,1337.5,450,1655,3120,650,792.5,1650,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,180,180,180,180,1107.68,1118.02,1600,1800,3000,3200],'cm^-1')),
        HinderedRotor(inertia=(0.173171,'amu*angstrom^2'), symmetry=1, barrier=(3.98153,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.173171,'amu*angstrom^2'), symmetry=1, barrier=(3.98153,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.173171,'amu*angstrom^2'), symmetry=1, barrier=(3.98153,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    ...
    molecularWeight = (93.1464,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.596209,0.0658426,-4.85127e-05,1.83996e-08,-2.82351e-12,65632.5,25.4899], Tmin=(100,'K'), Tmax=(1533.04,'K')), NASAPolynomial(coeffs=[15.5184,0.0269075,-1.04166e-05,1.83288e-09,-1.21898e-13,61057.3,-52.8768], Tmin=(1533.04,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(544.619,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(369.994,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)CsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Cyclopropene) + radical(Cds_P)"""),
)

species(
    label = 'C=CCC[C]1[CH]C1(853)',
    structure = SMILES('C=CCC[C]1[CH]C1'),
    E0 = (477.028,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,2750,2950,3150,900,1000,1100,300,800,800,800,800,800,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.36238,0.0513973,-1.84968e-05,-1.75207e-09,1.72307e-12,57473.5,29.7523], Tmin=(100,'K'), Tmax=(1387.62,'K')), NASAPolynomial(coeffs=[10.5319,0.0366748,-1.52401e-05,2.76477e-09,-1.86368e-13,53801.3,-21.5513], Tmin=(1387.62,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(477.028,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(394.937,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Cyclopropane) + radical(Tertalkyl) + radical(cyclopropane)"""),
)

species(
    label = '[CH2]C[CH]CC1C=C1(854)',
    structure = SMILES('[CH2]C[CH]CC1C=C1'),
    E0 = (569.445,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2950,3150,900,1000,1100,3000,3100,440,815,1455,1000,3025,407.5,1350,352.5,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,300,800,800,800,800,800,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.34001,0.0632234,-4.76592e-05,2.27776e-08,-5.18422e-12,68580.3,26.2951], Tmin=(100,'K'), Tmax=(962.088,'K')), NASAPolynomial(coeffs=[5.55017,0.0457195,-2.03693e-05,3.86773e-09,-2.70583e-13,67770.1,6.14614], Tmin=(962.088,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(569.445,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(390.78,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cyclopropene) + radical(RCCJ) + radical(RCCJCC)"""),
)

species(
    label = '[CH2]CC[CH]C1C=C1(855)',
    structure = SMILES('[CH2]CC[CH]C1C=C1'),
    E0 = (569.529,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2950,3150,900,1000,1100,3000,3100,440,815,1455,1000,3025,407.5,1350,352.5,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,300,800,800,800,800,800,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.17875,0.0630042,-4.14194e-05,1.41101e-08,-2.04041e-12,68598.6,26.8409], Tmin=(100,'K'), Tmax=(1513.65,'K')), NASAPolynomial(coeffs=[10.813,0.0375445,-1.61891e-05,2.99775e-09,-2.05039e-13,65682.1,-23.6323], Tmin=(1513.65,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(569.529,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(390.78,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cyclopropene) + radical(Cs_S) + radical(RCCJ)"""),
)

species(
    label = 'C[CH]C[CH]C1C=C1(856)',
    structure = SMILES('C[CH]C[CH]C1C=C1'),
    E0 = (558.729,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2950,3150,900,1000,1100,3000,3050,390,425,1340,1360,335,370,2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2850,1437.5,1250,1305,750,350,300,800,800,800,800,800,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.49287,0.0603579,-4.18694e-05,1.83715e-08,-4.01005e-12,67285.5,26.6888], Tmin=(100,'K'), Tmax=(960.662,'K')), NASAPolynomial(coeffs=[4.66575,0.0471468,-2.12413e-05,4.05627e-09,-2.84708e-13,66675.9,11.5088], Tmin=(960.662,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(558.729,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(390.78,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cyclopropene) + radical(RCCJC) + radical(Cs_S)"""),
)

species(
    label = '[CH2]CCC[C]1C=C1(857)',
    structure = SMILES('[CH2]CCC[C]1C=C1'),
    E0 = (506.968,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3000,3100,440,815,1455,1000,2750,3150,900,1100,200,800,900,1000,1100,1200,1300,1400,1500,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.803958,0.0640104,-4.16343e-05,1.40522e-08,-1.96225e-12,61094.2,23.9018], Tmin=(100,'K'), Tmax=(1626.39,'K')), NASAPolynomial(coeffs=[13.4904,0.0328092,-1.28581e-05,2.25685e-09,-1.49148e-13,56967.5,-43.4735], Tmin=(1626.39,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(506.968,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(390.78,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cyclopropene) + radical(Allyl_T) + radical(RCCJ)"""),
)

species(
    label = 'C[CH]CC[C]1C=C1(858)',
    structure = SMILES('C[CH]CC[C]1C=C1'),
    E0 = (496.168,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,3150,900,1100,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,200,800,900,1000,1100,1200,1300,1400,1500,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.42991,0.0583319,-3.39637e-05,1.04233e-08,-1.39457e-12,59765.4,22.5808], Tmin=(100,'K'), Tmax=(1555.74,'K')), NASAPolynomial(coeffs=[8.41728,0.0403665,-1.66421e-05,3.00065e-09,-2.01781e-13,57591.3,-14.2173], Tmin=(1555.74,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(496.168,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(390.78,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cyclopropene) + radical(RCCJC) + radical(Allyl_T)"""),
)

species(
    label = '[CH2]CCCC1[C]=C1(859)',
    structure = SMILES('[CH2]CCCC1[C]=C1'),
    E0 = (603.206,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,3150,900,1100,3000,3100,440,815,1455,1000,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,180,180,180,180,1012.63,1215.32,1600,1800,3000,3200],'cm^-1')),
        HinderedRotor(inertia=(0.173094,'amu*angstrom^2'), symmetry=1, barrier=(3.97977,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.173094,'amu*angstrom^2'), symmetry=1, barrier=(3.97977,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.173094,'amu*angstrom^2'), symmetry=1, barrier=(3.97977,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.173094,'amu*angstrom^2'), symmetry=1, barrier=(3.97977,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.970186,0.0685344,-5.35229e-05,2.34477e-08,-4.43812e-12,72656.3,25.5174], Tmin=(100,'K'), Tmax=(1201.01,'K')), NASAPolynomial(coeffs=[9.74416,0.0393127,-1.70267e-05,3.18927e-09,-2.21196e-13,70548.7,-18.4191], Tmin=(1201.01,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(603.206,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(390.78,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cyclopropene) + radical(cyclopropenyl-vinyl) + radical(RCCJ)"""),
)

species(
    label = 'C=[C]CCC1[CH]C1(860)',
    structure = SMILES('C=[C]CCC1[CH]C1'),
    E0 = (529.447,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,1685,370,2950,3100,1380,975,1025,1650,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,300,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.27323,0.0485473,2.1679e-06,-3.04362e-08,1.31094e-11,63785.7,28.6966], Tmin=(100,'K'), Tmax=(1050.07,'K')), NASAPolynomial(coeffs=[11.4987,0.0347254,-1.39849e-05,2.60901e-09,-1.8376e-13,60252.7,-27.7323], Tmin=(1050.07,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(529.447,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(394.937,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Cyclopropane) + radical(Cds_S) + radical(cyclopropane)"""),
)

species(
    label = 'C[CH]CCC1[C]=C1(861)',
    structure = SMILES('C[CH]CCC1[C]=C1'),
    E0 = (592.406,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,3150,900,1100,3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,180,180,180,180,967.272,1268.35,1600,1800,3000,3200],'cm^-1')),
        HinderedRotor(inertia=(0.175577,'amu*angstrom^2'), symmetry=1, barrier=(4.03687,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.175577,'amu*angstrom^2'), symmetry=1, barrier=(4.03687,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.175577,'amu*angstrom^2'), symmetry=1, barrier=(4.03687,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.175577,'amu*angstrom^2'), symmetry=1, barrier=(4.03687,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.11529,0.0679956,-6.16669e-05,3.7877e-08,-1.07615e-11,71349.8,25.9607], Tmin=(100,'K'), Tmax=(811.183,'K')), NASAPolynomial(coeffs=[5.65933,0.0455883,-2.0232e-05,3.82356e-09,-2.66418e-13,70612.6,4.9893], Tmin=(811.183,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(592.406,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(390.78,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cyclopropene) + radical(cyclopropenyl-vinyl) + radical(RCCJC)"""),
)

species(
    label = 'C=CCCC1[C]C1(862)',
    structure = SMILES('C=CCCC1[C]C1'),
    E0 = (494.356,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2950,3150,900,1000,1100,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,300,800,800,800,800,800,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.04028,0.0517758,5.22168e-06,-3.8733e-08,1.70367e-11,59575.5,36.0084], Tmin=(100,'K'), Tmax=(1019.93,'K')), NASAPolynomial(coeffs=[13.1533,0.0344123,-1.35715e-05,2.52654e-09,-1.78939e-13,55536.8,-30.3548], Tmin=(1019.93,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(494.356,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(394.937,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsCsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(CsJ2_singlet-CsH) + ring(Cyclopropane)"""),
)

species(
    label = 'C[C]CCC1C=C1(863)',
    structure = SMILES('C[C]CCC1C=C1'),
    E0 = (598.405,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2950,3150,900,1000,1100,2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,300,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.94117,0.0706502,-5.46167e-05,2.41356e-08,-4.70561e-12,72078.7,32.6627], Tmin=(100,'K'), Tmax=(1151.91,'K')), NASAPolynomial(coeffs=[8.78354,0.0434177,-1.9155e-05,3.61231e-09,-2.51435e-13,70271.9,-6.28128], Tmin=(1151.91,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(598.405,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(390.78,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(CsJ2_singlet-CsH) + ring(Cyclopropene)"""),
)

species(
    label = '[CH]CCCC1C=C1(864)',
    structure = SMILES('[CH]CCCC1C=C1'),
    E0 = (620.841,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2950,3150,900,1000,1100,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.974516,0.0693708,-5.43978e-05,2.37145e-08,-4.47549e-12,74776.3,23.3836], Tmin=(100,'K'), Tmax=(1199.26,'K')), NASAPolynomial(coeffs=[9.7447,0.040119,-1.78106e-05,3.37586e-09,-2.35673e-13,72672.7,-20.5211], Tmin=(1199.26,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(620.841,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(390.78,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(CsJ2_singlet-CsH) + ring(Cyclopropene)"""),
)
...
reaction(
    label = 'reaction445',
    reactants = ['[CH3](425)', '[CH2]C=CC=C=C(782)'],
    products = ['C=C=CC=CCC(80)'],
...
reaction(
    label = 'reaction446',
    reactants = ['C[CH2](421)', '[CH]=CC=C=C(783)'],
    products = ['C=C=CC=CCC(80)'],
...
reaction(
    label = 'reaction449',
    reactants = ['H(25)', 'C=C=CC=[C]CC(784)'],
    products = ['C=C=CC=CCC(80)'],
...
reaction(
    label = 'reaction450',
    reactants = ['[CH]=CCC(571)', '[CH]=C=C(785)'],
    products = ['C=C=CC=CCC(80)'],
...
reaction(
    label = 'reaction452',
    reactants = ['H(25)', 'C=C=[C]C=CCC(786)'],
    products = ['C=C=CC=CCC(80)'],
...
reaction(
    label = 'reaction453',
    reactants = ['H(25)', '[CH]=C=CC=CCC(787)'],
    products = ['C=C=CC=CCC(80)'],
...
reaction(
    label = 'reaction473',
    reactants = ['CH2(S)(137)', 'C=C=CC=CC(712)'],
    products = ['C=C=CC=CCC(80)'],
...
reaction(
    label = 'reaction493',
    reactants = ['[CH]=C[CH2](73)', '[CH]C=CC(598)'],
    products = ['[CH2]C=CC=C[CH]C(63)'],
...
reaction(
    label = 'reaction500',
    reactants = ['[CH]=CC=C[CH2](62)', '[CH]C(603)'],
    products = ['[CH2]C=CC=C[CH]C(63)'],
...
reaction(
    label = 'reaction501',
    reactants = ['[CH]=C[CH]C=CC(593)', 'CH2(T)(82)'],
    products = ['[CH2]C=CC=C[CH]C(63)'],
...
reaction(
    label = 'reaction533',
    reactants = ['[CH]1C=CCC[CH]C1(28)'],
    products = ['[CH]1CCC2C[CH]C12(51)'],
    transitionState = 'TS533',
    kinetics = Arrhenius(A=(1e+10,'s^-1'), n=0, Ea=(196.02,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""Estimated using an average for rate rule [R5;doublebond_intra_HNd_pri;radadd_intra_csHNd]
Euclidian distance = 0
family: Intra_R_Add_Exocyclic"""),
)
...
reaction(
    label = 'reaction536',
    reactants = ['H(25)', 'C1=CC[CH]CCC=1(813)'],
    products = ['[CH]1C=CCC[CH]C1(28)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(3.32e+09,'s^-1'), n=0.99, Ea=(141.419,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""Estimated using template [R3H_SS_Cs;Cd_rad_out_Cd;Cs_H_out_H/NonDeC] for rate rule [R3H_SS_Cs;Cd_rad_out_Cd;Cs_H_out_H/(NonDeC/Cs)]
Euclidian distance = 1.0
Multiplied by reaction path degeneracy 2.0
family: intra_H_migration"""),
)
...
reaction(
    label = 'reaction552',
    reactants = ['[CH]1C=CCC[CH]C1(28)'],
    products = ['[CH]1[CH]C2CC2CC1(343)'],
    transitionState = 'TS552',
    kinetics = Arrhenius(A=(2.1e+12,'s^-1'), n=0.14, Ea=(77.4325,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Rn0c7_beta_long_SS_D;doublebond_intra_pri_HNd_Cs;radadd_intra] for rate rule [Rn0c7_beta_long_SS_D;doublebond_intra_pri_HNd_Cs;radadd_intra_csHCs]
Euclidian distance = 3.0
family: Intra_R_Add_Endocyclic"""),
)
...
reaction(
    label = 'reaction554',
    reactants = ['[CH2]C1C=CC[CH]C1(317)'],
    products = ['[CH]1C=CCC[CH]C1(28)'],
...
reaction(
    label = 'reaction557',
    reactants = ['H(25)', 'C1=CC2C[C]2CC1(821)'],
    products = ['C1=CC2CC2CC1(121)'],
...
reaction(
    label = 'reaction558',
    reactants = ['H(25)', 'C1=C[C]2CC2CC1(822)'],
    products = ['C1=CC2CC2CC1(121)'],
...
reaction(
    label = 'reaction559',
    reactants = ['H(25)', '[CH]1C2C=CCCC12(213)'],
    products = ['C1=CC2CC2CC1(121)'],
...
reaction(
    label = 'reaction560',
    reactants = ['H(25)', '[CH]1CC=CC2CC12(823)'],
    products = ['C1=CC2CC2CC1(121)'],
...
reaction(
    label = 'reaction561',
    reactants = ['H(25)', '[CH]1C=CC2CC2C1(824)'],
    products = ['C1=CC2CC2CC1(121)'],
...
reaction(
    label = 'reaction562',
    reactants = ['H(25)', '[C]1=CCCC2CC12(825)'],
    products = ['C1=CC2CC2CC1(121)'],
...
reaction(
    label = 'reaction563',
    reactants = ['H(25)', '[C]1=CC2CC2CC1(826)'],
    products = ['C1=CC2CC2CC1(121)'],
...
reaction(
    label = 'reaction564',
    reactants = ['CH2(S)(137)', 'C1C=CCCC=1(484)'],
    products = ['C1=CC2CC2CC1(121)'],
...
reaction(
    label = 'reaction566',
    reactants = ['[CH]1C[CH]C2CC2C1(342)'],
    products = ['C1=CC2CC2CC1(121)'],
...
reaction(
    label = 'reaction568',
    reactants = ['[CH]1CCC2[CH]C2C1(814)'],
    products = ['C1=CC2CC2CC1(121)'],
...
reaction(
    label = 'reaction571',
    reactants = ['[CH]1CCCC2[CH]C12(341)'],
    products = ['C1=CC2CC2CC1(121)'],
...
reaction(
    label = 'reaction572',
    reactants = ['[CH]1[CH]CC2CC2C1(829)'],
    products = ['C1=CC2CC2CC1(121)'],
...
reaction(
    label = 'reaction575',
    reactants = ['[CH2]C1[CH]CCC=C1(316)'],
    products = ['C1=CC2CC2CC1(121)'],
...
reaction(
    label = 'reaction577',
    reactants = ['[CH2]C1CC1[CH]C=C(477)'],
    products = ['C1=CC2CC2CC1(121)'],
...
reaction(
    label = 'reaction578',
    reactants = ['[CH]=CCCC1[CH]C1(830)'],
    products = ['C1=CC2CC2CC1(121)'],
    transitionState = 'TS578',
    kinetics = Arrhenius(A=(2e+12,'s^-1'), n=0, Ea=(7.5312,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R6;C_rad_out_1H;Ypri_rad_out] for rate rule [R6_SSSSD;C_rad_out_H/NonDeC;CdsinglepriH_rad_out]
Euclidian distance = 2.44948974278
family: Birad_recombination"""),
)
...
reaction(
    ...
    kinetics = Arrhenius(A=(2e+12,'s^-1'), n=0, Ea=(7.5312,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R6;C_rad_out_1H;Cpri_rad_out_2H] for rate rule [R6_SSDSS;C_rad_out_H/NonDeC;Cpri_rad_out_2H]
Euclidian distance = 1.41421356237
family: Birad_recombination"""),
)
...
reaction(
    label = 'reaction582',
    reactants = ['[CH]C(C=C)CC=C(528)'],
    products = ['[CH]=C[CH]CCC=C(114)'],
...
reaction(
    label = 'reaction583',
    reactants = ['[CH]=C[CH]CCC=C(114)'],
    products = ['[CH]=CC1CCC1[CH2](833)'],
    transitionState = 'TS583',
    kinetics = Arrhenius(A=(2.15e+11,'s^-1'), n=0.21, Ea=(107.121,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""From training reaction 159 used for R5_SS_D;doublebond_intra_2H_pri;radadd_intra_csHCd
Exact match found for rate rule [R5_SS_D;doublebond_intra_2H_pri;radadd_intra_csHCd]
Euclidian distance = 0
family: Intra_R_Add_Exocyclic
Ea raised from 106.2 to 107.1 kJ/mol to match endothermicity of reaction."""),
)
...
reaction(
    ...
    kinetics = Arrhenius(A=(4.76955,'m^3/(mol*s)'), n=1.94497, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [Cds-CsH_Cds-OneDeH;HJ]
Euclidian distance = 0
family: R_Addition_MultipleBond
...
reaction(
    label = 'reaction586',
    reactants = ['H(25)', '[CH]=C=CCCC=C(834)'],
    products = ['[CH]=C[CH]CCC=C(114)'],
    transitionState = 'TS586',
    kinetics = Arrhenius(A=(1473.32,'m^3/(mol*s)'), n=1.53934, Ea=(19.2498,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [Cdd_Cds;HJ]
Euclidian distance = 0
family: R_Addition_MultipleBond"""),
)
...
reaction(
    label = 'reaction587',
    reactants = ['C#C(354)', '[CH]CCC=C(417)'],
    products = ['[CH]=C[CH]CCC=C(114)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(122593,'s^-1'), n=1.90159, Ea=(35.9101,'kJ/mol'), T0=(1,'K'), comment="""Estimated using average of templates [R5H;Cd_rad_out_singleH;Cs_H_out] + [R5H_RSSR;Y_rad_out;Cs_H_out_H/OneDe] for rate rule [R5H_DSSS;Cd_rad_out_singleH;Cs_H_out_H/OneDe]
...
reaction(
    label = 'reaction597',
    reactants = ['[CH]=C[CH]CCC=C(114)'],
    products = ['[CH]=CC1C[CH]CC1(383)'],
    transitionState = 'TS597',
    kinetics = Arrhenius(A=(4.11e+10,'s^-1'), n=0.19, Ea=(96.1065,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""From training reaction 267 used for R5_CsCs_HH_D;doublebond_intra_pri_2H;radadd_intra_csHCd
Exact match found for rate rule [R5_CsCs_HH_D;doublebond_intra_pri_2H;radadd_intra_csHCd]
Euclidian distance = 0
family: Intra_R_Add_Endocyclic"""),
)
...
reaction(
    label = 'reaction601',
    reactants = ['[CH]=[CH](359)', '[CH]CCC=C(417)'],
    products = ['[CH]=C[CH]CCC=C(114)'],
    transitionState = 'TS601',
    kinetics = Arrhenius(A=(1.5183e+06,'m^3/(mol*s)'), n=0.575199, Ea=(34.3157,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [Y_rad;Birad]
Euclidian distance = 0
Multiplied by reaction path degeneracy 2.0
family: Birad_R_Recombination"""),
)
...
reaction(
    label = 'reaction602',
    reactants = ['[CH2]CC=C(358)', '[CH]1C=C1(844)'],
    products = ['C=CCCC1C=C1(835)'],
    transitionState = 'TS602',
    kinetics = Arrhenius(A=(5.004e+15,'cm^3/(mol*s)'), n=-0.7, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [C_rad/H2/Cs;C_rad/H/CdCd]
Euclidian distance = 0
Multiplied by reaction path degeneracy 3.0
family: R_Recombination
...
reaction(
    label = 'reaction603',
    reactants = ['H(25)', 'C=CCC[C]1C=C1(845)'],
    products = ['C=CCCC1C=C1(835)'],
...
reaction(
    label = 'reaction604',
    reactants = ['[CH2]C=C(98)', '[CH2]C1C=C1(846)'],
    products = ['C=CCCC1C=C1(835)'],
...
reaction(
    label = 'reaction605',
    reactants = ['H(25)', 'C=CC[CH]C1C=C1(847)'],
    products = ['C=CCCC1C=C1(835)'],
...
reaction(
    label = 'reaction606',
    reactants = ['[CH]=C(100)', '[CH2]CC1C=C1(848)'],
    products = ['C=CCCC1C=C1(835)'],
...
reaction(
    label = 'reaction607',
    reactants = ['H(25)', 'C=C[CH]CC1C=C1(849)'],
    products = ['C=CCCC1C=C1(835)'],
    transitionState = 'TS607',
    kinetics = Arrhenius(A=(2.66284e+07,'m^3/(mol*s)'), n=0.108445, Ea=(5.74998,'kJ/mol'), T0=(1,'K'), Tmin=(303.03,'K'), Tmax=(2000,'K'), comment="""From training reaction 36 used for C_rad/H/CdCs;H_rad
Exact match found for rate rule [C_rad/H/CdCs;H_rad]
Euclidian distance = 0
family: R_Recombination"""),
...
reaction(
    label = 'reaction608',
    reactants = ['H(25)', 'C=CCCC1[C]=C1(850)'],
    products = ['C=CCCC1C=C1(835)'],
    transitionState = 'TS608',
...
reaction(
    label = 'reaction609',
    reactants = ['H(25)', 'C=[C]CCC1C=C1(851)'],
    products = ['C=CCCC1C=C1(835)'],
    transitionState = 'TS609',
    kinetics = Arrhenius(A=(1e+13,'cm^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""From training reaction 40 used for Cd_rad/NonDe;H_rad
Exact match found for rate rule [Cd_rad/NonDe;H_rad]
Euclidian distance = 0
family: R_Recombination"""),
...
reaction(
    label = 'reaction610',
    reactants = ['H(25)', '[CH]=CCCC1C=C1(852)'],
    products = ['C=CCCC1C=C1(835)'],
    transitionState = 'TS610',
    kinetics = Arrhenius(A=(1.21e+14,'cm^3/(mol*s)','+|-',4.82e+13), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(298,'K'), comment="""From training reaction 60 used for H_rad;Cd_pri_rad
Exact match found for rate rule [Cd_pri_rad;H_rad]
Euclidian distance = 0
family: R_Recombination"""),
...
reaction(
    label = 'reaction611',
    reactants = ['C=CCC[C]1[CH]C1(853)'],
    products = ['C=CCCC1C=C1(835)'],
    transitionState = 'TS611',
    kinetics = Arrhenius(A=(4.48818e+10,'s^-1'), n=0.34095, Ea=(22.3009,'kJ/mol'), T0=(1,'K'), comment="""Estimated using average of templates [Rn;Y_rad_NDe;XH_Rrad] + [R2radExo;Y_rad;XH_Rrad] for rate rule [R2radExo;Y_rad_NDe;XH_Rrad]
Euclidian distance = 1.0
Multiplied by reaction path degeneracy 2.0
family: Intra_Disproportionation"""),
...
reaction(
    label = 'reaction612',
    reactants = ['[CH2]C[CH]CC1C=C1(854)'],
    products = ['C=CCCC1C=C1(835)'],
    transitionState = 'TS612',
    kinetics = Arrhenius(A=(4.48818e+10,'s^-1'), n=0.34095, Ea=(22.3009,'kJ/mol'), T0=(1,'K'), comment="""Estimated using average of templates [Rn;Y_rad_NDe;XH_Rrad] + [R2radExo;Y_rad;XH_Rrad] for rate rule [R2radExo;Y_rad_NDe;XH_Rrad]
Euclidian distance = 1.0
Multiplied by reaction path degeneracy 2.0
family: Intra_Disproportionation"""),
...
reaction(
    label = 'reaction614',
    reactants = ['[CH2]CC[CH]C1C=C1(855)'],
    products = ['C=CCCC1C=C1(835)'],
    transitionState = 'TS614',
    kinetics = Arrhenius(A=(1.4874e+09,'s^-1'), n=1.045, Ea=(63.4002,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [R3radExo;Y_rad_NDe;XH_Rrad]
Euclidian distance = 0
Multiplied by reaction path degeneracy 2.0
family: Intra_Disproportionation"""),
...
reaction(
    label = 'reaction615',
    reactants = ['C[CH]C[CH]C1C=C1(856)'],
    products = ['C=CCCC1C=C1(835)'],
    transitionState = 'TS615',
    kinetics = Arrhenius(A=(2.328e+09,'s^-1'), n=0.311, Ea=(8.368,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""Estimated using template [R4;Y_rad_NDe;XH_Rrad] for rate rule [R4radEndo;Y_rad_NDe;XH_Rrad]
Euclidian distance = 1.0
Multiplied by reaction path degeneracy 3.0
family: Intra_Disproportionation"""),
...
reaction(
    label = 'reaction617',
    reactants = ['[CH2]CCC[C]1C=C1(857)'],
    products = ['C=CCCC1C=C1(835)'],
    transitionState = 'TS617',
    kinetics = Arrhenius(A=(8.96625e+08,'s^-1'), n=0.311, Ea=(39.225,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4;Y_rad_De;XH_Rrad] for rate rule [R4radExo;Y_rad_De;XH_Rrad]
Euclidian distance = 1.0
Multiplied by reaction path degeneracy 2.0
family: Intra_Disproportionation"""),
...
reaction(
    label = 'reaction618',
    reactants = ['C[CH]CC[C]1C=C1(858)'],
    products = ['C=CCCC1C=C1(835)'],
    transitionState = 'TS618',
    kinetics = Arrhenius(A=(5.55988e+09,'s^-1'), n=0.137, Ea=(39.225,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R5;Y_rad_De;XH_Rrad] for rate rule [R5radEndo;Y_rad_De;XH_Rrad]
Euclidian distance = 1.0
Multiplied by reaction path degeneracy 3.0
family: Intra_Disproportionation"""),
...
reaction(
    label = 'reaction619',
    reactants = ['[CH2]CCCC1[C]=C1(859)'],
    products = ['C=CCCC1C=C1(835)'],
    transitionState = 'TS619',
    kinetics = Arrhenius(A=(3.70659e+09,'s^-1'), n=0.137, Ea=(39.225,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R5;Y_rad_De;XH_Rrad] for rate rule [R5radExo;Y_rad_De;XH_Rrad]
Euclidian distance = 1.0
Multiplied by reaction path degeneracy 2.0
family: Intra_Disproportionation"""),
...
reaction(
    label = 'reaction620',
    reactants = ['C=[C]CCC1[CH]C1(860)'],
    products = ['C=CCCC1C=C1(835)'],
    transitionState = 'TS620',
    kinetics = Arrhenius(A=(3.70659e+09,'s^-1'), n=0.137, Ea=(39.225,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R5;Y_rad_De;XH_Rrad] for rate rule [R5radExo;Y_rad_De;XH_Rrad]
Euclidian distance = 1.0
Multiplied by reaction path degeneracy 2.0
family: Intra_Disproportionation"""),
...
reaction(
    label = 'reaction621',
    reactants = ['C[CH]CCC1[C]=C1(861)'],
    products = ['C=CCCC1C=C1(835)'],
    transitionState = 'TS621',
    kinetics = Arrhenius(A=(5.55988e+09,'s^-1'), n=0.137, Ea=(39.225,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R6;Y_rad_De;XH_Rrad] for rate rule [R6radEndo;Y_rad_De;XH_Rrad]
Euclidian distance = 1.0
Multiplied by reaction path degeneracy 3.0
family: Intra_Disproportionation"""),
...
reaction(
    label = 'reaction623',
    reactants = ['C=CCCC1[C]C1(862)'],
    products = ['C=CCCC1C=C1(835)'],
    transitionState = 'TS623',
    kinetics = Arrhenius(A=(3.23663e+16,'s^-1'), n=-0.885455, Ea=(87.4392,'kJ/mol'), T0=(1,'K'), Tmin=(303.03,'K'), Tmax=(2000,'K'), comment="""Estimated using template [CsJ2-C;CsJ2(CsC);CH] for rate rule [CsJ2-C;CsJ2(CsC);CH2(C)]
Euclidian distance = 1.0
Multiplied by reaction path degeneracy 2.0
family: Singlet_Carbene_Intra_Disproportionation"""),
...
reaction(
    label = 'reaction624',
    reactants = ['C[C]CCC1C=C1(863)'],
    products = ['C=CCCC1C=C1(835)'],
    transitionState = 'TS624',
    kinetics = Arrhenius(A=(4.85495e+16,'s^-1'), n=-0.885455, Ea=(87.4392,'kJ/mol'), T0=(1,'K'), Tmin=(303.03,'K'), Tmax=(2000,'K'), comment="""Estimated using template [CsJ2-C;CsJ2(CsC);CH] for rate rule [CsJ2-C;CsJ2(CsC);CH3]
Euclidian distance = 1.0
Multiplied by reaction path degeneracy 3.0
family: Singlet_Carbene_Intra_Disproportionation"""),
...
reaction(
    label = 'reaction625',
    reactants = ['[CH]CCCC1C=C1(864)'],
    products = ['C=CCCC1C=C1(835)'],
    transitionState = 'TS625',
    kinetics = Arrhenius(A=(2.90176e+13,'s^-1'), n=-0.332469, Ea=(37.038,'kJ/mol'), T0=(1,'K'), comment="""Estimated using average of templates [singletcarbene_CH;singletcarbene;CH2(C)] + [CsJ2-C;singletcarbene;CH] for rate rule [CsJ2-C;CsJ2H;CH2(C)]
Euclidian distance = 1.41421356237
Multiplied by reaction path degeneracy 2.0
family: Singlet_Carbene_Intra_Disproportionation"""),
