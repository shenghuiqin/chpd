...
species(
    label = 'C=CC1[CH]C=C1(855)',
    structure = SMILES('C=CC1[CH]C=C1'),
    E0 = (380.712,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,2950,3100,1380,975,1025,1650,3010,987.5,1337.5,450,1655,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (79.1198,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.26047,0.0233281,4.76141e-05,-7.54772e-08,2.95509e-11,45865.1,16.0766], Tmin=(100,'K'), Tmax=(976.929,'K')), NASAPolynomial(coeffs=[11.481,0.0226745,-8.34587e-06,1.58294e-09,-1.16769e-13,42293.2,-37.2528], Tmin=(976.929,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(380.712,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(303.478,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)CsH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Cyclobutene) + radical(cyclobutene-allyl)"""),
)

species(
    label = 'C=CC1C=C[C]1C(856)',
    structure = SMILES('C=CC1C=C[C]1C'),
    E0 = (316.398,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,2750,2950,3150,900,1000,1100,2750,2800,2850,1350,1500,750,1050,1375,1000,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    ...
    molecularWeight = (93.1464,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.65482,0.0357524,3.96627e-05,-7.33699e-08,2.96705e-11,38152.5,19.6094], Tmin=(100,'K'), Tmax=(974.604,'K')), NASAPolynomial(coeffs=[12.6015,0.0296547,-1.07151e-05,1.97053e-09,-1.41696e-13,34174.6,-42.3814], Tmin=(974.604,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(316.398,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(374.151,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)(Cds-Cds)CsH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Cyclobutene) + radical(Allyl_T)"""),
)
...
species(
    label = 'C=C[C]1C=CC1C(858)',
    structure = SMILES('[CH2]C=C1C=CC1C'),
    E0 = (268.185,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,2750,2950,3150,900,1000,1100,2750,2800,2850,1350,1500,750,1050,1375,1000,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    ...
    molecularWeight = (93.1464,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.33919,0.0405489,3.81158e-05,-8.03151e-08,3.43677e-11,32367.3,20.3203], Tmin=(100,'K'), Tmax=(951.478,'K')), NASAPolynomial(coeffs=[15.7015,0.0249563,-7.90816e-06,1.40315e-09,-1.02079e-13,27606.9,-58.9085], Tmin=(951.478,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(268.185,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(374.151,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)CsH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + ring(Cyclobutene) + radical(C=CC=CCJ)"""),
)

species(
    label = '[CH2]C1C=CC1C=C(859)',
    structure = SMILES('[CH2]C1C=CC1C=C'),
    E0 = (389.5,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,2950,3100,1380,975,1025,1650,3000,3100,440,815,1455,1000,3010,987.5,1337.5,450,1655,300,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
...
species(
    label = 'C=CC1C=[C]C1C(860)',
    structure = SMILES('C=CC1C=[C]C1C'),
    E0 = (436.903,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2950,3150,900,1000,1100,2950,3100,1380,975,1025,1650,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    ...
    molecularWeight = (93.1464,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.33291,0.0458726,9.01535e-06,-4.08749e-08,1.78743e-11,52654.6,22.2927], Tmin=(100,'K'), Tmax=(1004.01,'K')), NASAPolynomial(coeffs=[12.755,0.0299873,-1.15049e-05,2.13468e-09,-1.5183e-13,48868,-40.2928], Tmin=(1004.01,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(436.903,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(374.151,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)(Cds-Cds)CsH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Cyclobutene) + radical(cyclobutene-vinyl)"""),
)

species(
    label = 'C=CC1[C]=CC1C(861)',
...
species(
    ...
    molecularWeight = (93.1464,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.33291,0.0458726,9.01535e-06,-4.08749e-08,1.78743e-11,50893.3,22.2927], Tmin=(100,'K'), Tmax=(1004.01,'K')), NASAPolynomial(coeffs=[12.755,0.0299873,-1.15049e-05,2.13468e-09,-1.5183e-13,47106.8,-40.2928], Tmin=(1004.01,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(422.259,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(374.151,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)(Cds-Cds)CsH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Cyclobutene) + radical(Cds_S)"""),
)

species(
    label = '[CH]=CC1C=CC1C(863)',
    ...
    molecularWeight = (93.1464,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.29831,0.0447312,1.7327e-05,-5.29256e-08,2.2959e-11,52009.4,22.3457], Tmin=(100,'K'), Tmax=(984.749,'K')), NASAPolynomial(coeffs=[14.0945,0.0278036,-1.02777e-05,1.90656e-09,-1.37248e-13,47789.7,-47.8209], Tmin=(984.749,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(431.513,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(374.151,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)(Cds-Cds)CsH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Cyclobutene) + radical(Cds_P)"""),
)

species(
    label = 'C=CC1[CH]C[C]1C(864)',
    ...
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.73645,0.0389698,2.02588e-05,-4.16091e-08,1.52315e-11,51394.2,27.467], Tmin=(100,'K'), Tmax=(1079.4,'K')), NASAPolynomial(coeffs=[8.42516,0.0398086,-1.65181e-05,3.09981e-09,-2.17762e-13,48457.4,-12.2282], Tmin=(1079.4,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(426.562,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(399.095,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Cyclobutane) + radical(cyclobutane) + radical(Tertalkyl)"""),
)

species(
    label = 'C=C[C]1C[CH]C1C(865)',
    ...
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.95177,0.0259678,7.27571e-05,-1.05784e-07,4.0273e-11,44966.8,23.8069], Tmin=(100,'K'), Tmax=(977.31,'K')), NASAPolynomial(coeffs=[11.7128,0.0337568,-1.24695e-05,2.33479e-09,-1.69807e-13,40779,-34.7243], Tmin=(977.31,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(373.12,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(399.095,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Cyclobutane) + radical(Allyl_T) + radical(cyclobutane)"""),
)

species(
    label = '[CH2]C[C]1C=CC1C(866)',
    ...
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.63515,0.0325867,6.06074e-05,-9.94126e-08,3.9747e-11,47539.3,23.378], Tmin=(100,'K'), Tmax=(962.486,'K')), NASAPolynomial(coeffs=[14.0216,0.0295393,-1.01188e-05,1.85404e-09,-1.35311e-13,42911.7,-47.5589], Tmin=(962.486,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(394.41,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(394.937,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cyclobutene) + radical(RCCJ) + radical(Allyl_T)"""),
)

species(
    label = 'C=C[C]1[CH]CC1C(867)',
    structure = SMILES('[CH2]C=C1[CH]CC1C'),
    E0 = (325.188,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,298.9,1221.09,1221.09,1221.09,1221.09,4000,4000,4000,4000,4000,4000,4000,4000,4000,4000],'cm^-1')),
        HinderedRotor(inertia=(1.36852,'amu*angstrom^2'), symmetry=1, barrier=(31.465,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.36852,'amu*angstrom^2'), symmetry=1, barrier=(31.465,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[10.1944,-0.0146329,0.000145767,-1.38902e-07,3.23362e-11,38781.5,-16.7808], Tmin=(100,'K'), Tmax=(1678.77,'K')), NASAPolynomial(coeffs=[68.9853,0.0397631,-7.66025e-05,1.84097e-08,-1.36649e-12,-8362.29,-412.491], Tmin=(1678.77,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(325.188,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(399.095,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + ring(methylenecyclobutane) + radical(Allyl_P) + radical(Allyl_S)"""),
)

species(
    label = '[CH2]C1C[CH]C1C=C(868)',
    structure = SMILES('[CH2]C1C[CH]C1C=C'),
    E0 = (446.222,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,2950,3050,3150,900,950,1000,1050,1100,2950,3100,1380,975,1025,1650,3000,3100,440,815,1455,1000,3010,987.5,1337.5,450,1655,300,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    ...
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.69437,0.0330316,5.48121e-05,-9.04932e-08,3.5976e-11,53767,27.5654], Tmin=(100,'K'), Tmax=(965.957,'K')), NASAPolynomial(coeffs=[12.6643,0.0315179,-1.1027e-05,2.00842e-09,-1.44538e-13,49599.1,-35.5823], Tmin=(965.957,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(446.222,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(399.095,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Cyclobutane) + radical(Isobutyl) + radical(cyclobutane)"""),
)

species(
    label = 'C=CC1C[CH][C]1C(869)',
...
species(
    label = '[CH2]CC1[C]=CC1C(871)',
    structure = SMILES('[CH2]CC1[C]=CC1C'),
    E0 = (514.915,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,2750,2950,3150,900,1000,1100,2750,2800,2850,1350,1500,750,1050,1375,1000,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.31985,0.0426375,3.01553e-05,-6.70873e-08,2.79799e-11,62041,26.037], Tmin=(100,'K'), Tmax=(980.05,'K')), NASAPolynomial(coeffs=[14.0981,0.029999,-1.09803e-05,2.0349e-09,-1.46815e-13,57638.6,-45.035], Tmin=(980.05,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(514.915,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(394.937,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cyclobutene) + radical(cyclobutene-vinyl) + radical(RCCJ)"""),
)

species(
    label = 'C=[C]C1C[CH]C1C(872)',
    structure = SMILES('C=[C]C1C[CH]C1C'),
    E0 = (478.981,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,3100,1380,975,1025,1650,2750,2850,2950,3050,3150,900,950,1000,1050,1100,1685,370,2750,2800,2850,1350,1500,750,1050,1375,1000,300,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    ...
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.63547,0.0360209,4.23487e-05,-7.36029e-08,2.86117e-11,57707.4,26.4701], Tmin=(100,'K'), Tmax=(999.473,'K')), NASAPolynomial(coeffs=[11.8429,0.0341291,-1.32821e-05,2.50432e-09,-1.80387e-13,53721,-32.5041], Tmin=(999.473,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(478.981,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(399.095,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Cyclobutane) + radical(Cds_S) + radical(cyclobutane)"""),
)
...
species(
    label = 'C[CH]C1C=C[C]1C(873)',
    structure = SMILES('C[CH]C1C=C[C]1C'),
    E0 = (383.706,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2950,3150,900,1000,1100,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.78502,0.0306704,5.95771e-05,-9.34087e-08,3.62749e-11,46245,23.6102], Tmin=(100,'K'), Tmax=(977.695,'K')), NASAPolynomial(coeffs=[12.2817,0.0325144,-1.19679e-05,2.23177e-09,-1.61813e-13,42051.9,-37.7408], Tmin=(977.695,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(383.706,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(394.937,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cyclobutene) + radical(Allyl_T) + radical(Cs_S)"""),
)

species(
    label = 'C[CH]C1[C]=CC1C(874)',
    ...
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.46667,0.0407471,2.90891e-05,-6.11303e-08,2.45754e-11,60746.9,26.2808], Tmin=(100,'K'), Tmax=(1002.28,'K')), NASAPolynomial(coeffs=[12.4247,0.0328652,-1.27682e-05,2.39844e-09,-1.72157e-13,56749.6,-35.5932], Tmin=(1002.28,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(504.211,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(394.937,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cyclobutene) + radical(cyclobutene-vinyl) + radical(Cs_S)"""),
)

species(
    label = 'C=[C]C1[CH]CC1C(875)',
...
species(
    label = '[CH]=CC1C[CH]C1C(877)',
    structure = SMILES('[CH]=CC1C[CH]C1C'),
    E0 = (488.236,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3010,987.5,1337.5,450,1655,3120,650,792.5,1650,2750,2850,2950,3050,3150,900,950,1000,1050,1100,2750,2800,2850,1350,1500,750,1050,1375,1000,300,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    ...
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.597,0.0349253,5.05003e-05,-8.54485e-08,3.36109e-11,58823.7,26.5371], Tmin=(100,'K'), Tmax=(985.391,'K')), NASAPolynomial(coeffs=[13.2015,0.0319134,-1.20364e-05,2.27189e-09,-1.65449e-13,54395.9,-40.1394], Tmin=(985.391,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(488.236,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(399.095,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Cyclobutane) + radical(cyclobutane) + radical(Cds_P)"""),
)
...
species(
    ...
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.59693,0.0349261,5.04975e-05,-8.54449e-08,3.36093e-11,58823.7,26.5373], Tmin=(100,'K'), Tmax=(985.401,'K')), NASAPolynomial(coeffs=[13.2017,0.0319129,-1.20362e-05,2.27183e-09,-1.65444e-13,54395.8,-40.1408], Tmin=(985.401,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(488.236,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(399.095,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Cyclobutane) + radical(Cds_P) + radical(cyclobutane)"""),
)

species(
    label = '[CH]=CC(C)[CH]C=C(880)',
    structure = SMILES('[CH]=CC(C)C=C[CH2]'),
    E0 = (417.75,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,3120,650,792.5,1650,2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3010,3025,975,987.5,1000,1300,1337.5,1375,400,450,500,1630,1655,1680,230.173],'cm^-1')),
        HinderedRotor(inertia=(0.246259,'amu*angstrom^2'), symmetry=1, barrier=(9.25767,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.548446,'amu*angstrom^2'), symmetry=1, barrier=(20.6177,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.246273,'amu*angstrom^2'), symmetry=1, barrier=(9.25762,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.662324,'amu*angstrom^2'), symmetry=1, barrier=(24.9009,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (94.1543,'amu'),
...
species(
    label = '[CH]=CC([CH]C)C=C(881)',
    structure = SMILES('[CH]=CC([CH]C)C=C'),
    E0 = (473.038,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,3120,650,792.5,1650,2995,3025,975,1000,1300,1375,400,500,1630,1680,2950,3100,1380,975,1025,1650,338.743,338.745],'cm^-1')),
        HinderedRotor(inertia=(0.114432,'amu*angstrom^2'), symmetry=1, barrier=(9.3178,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.114426,'amu*angstrom^2'), symmetry=1, barrier=(9.3178,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00146908,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.11443,'amu*angstrom^2'), symmetry=1, barrier=(9.31779,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (94.1543,'amu'),
...
species(
    ...
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.39564,0.0393139,4.52622e-05,-8.1857e-08,3.25879e-11,58076.7,33.8076], Tmin=(100,'K'), Tmax=(986.741,'K')), NASAPolynomial(coeffs=[13.6245,0.0336098,-1.27538e-05,2.39541e-09,-1.73414e-13,53527.7,-35.848], Tmin=(986.741,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(481.965,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(399.095,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(CsJ2_singlet-CsH) + ring(Cyclobutane)"""),
)

species(
    label = 'C=CC1[C]CC1C(883)',
    structure = SMILES('C=CC1[C]CC1C'),
    E0 = (479.761,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,2950,3100,1380,975,1025,1650,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,300,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
    ...
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.32973,0.0433106,2.95252e-05,-6.23363e-08,2.48622e-11,57811.5,33.3426], Tmin=(100,'K'), Tmax=(1008.94,'K')), NASAPolynomial(coeffs=[12.4443,0.0359943,-1.42307e-05,2.67501e-09,-1.91326e-13,53698.3,-29.6467], Tmin=(1008.94,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(479.761,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(399.095,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(CsJ2_singlet-CsH) + ring(Cyclobutane)"""),
)

species(
    label = 'C[C]C1C=CC1C(884)',
    structure = SMILES('C[C]C1C=CC1C'),
    E0 = (483.643,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.12935,0.049904,9.19944e-06,-4.1468e-08,1.76753e-11,58283.6,33.058], Tmin=(100,'K'), Tmax=(1021.56,'K')), NASAPolynomial(coeffs=[12.4845,0.0355985,-1.40749e-05,2.61735e-09,-1.85024e-13,54390.1,-29.6679], Tmin=(1021.56,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(483.643,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(394.937,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsCsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(CsJ2_singlet-CsH) + ring(Cyclobutene)"""),
)

species(
    label = '[CH]CC1C=CC1C(885)',
    structure = SMILES('[CH]CC1C=CC1C'),
    E0 = (508.283,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,2750,2800,2850,1350,1500,750,1050,1375,1000,300,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.24426,0.0444144,2.59992e-05,-6.25736e-08,2.61327e-11,61245.9,24.19], Tmin=(100,'K'), Tmax=(991.223,'K')), NASAPolynomial(coeffs=[14.3267,0.0304233,-1.15463e-05,2.17047e-09,-1.5709e-13,56746.2,-48.425], Tmin=(991.223,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(508.283,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(394.937,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(CsJ2_singlet-CsH) + ring(Cyclobutene)"""),
)

species(
    label = 'CC1C2[CH]CC1[CH]2(886)',
...
reaction(
    label = 'reaction347',
    reactants = ['[CH3](423)', 'C=CC1[CH]C=C1(855)'],
    products = ['C=CC1C=CC1C(510)'],
...
reaction(
    label = 'reaction348',
    reactants = ['H(25)', 'C=CC1C=C[C]1C(856)'],
    products = ['C=CC1C=CC1C(510)'],
...
reaction(
    label = 'reaction349',
    reactants = ['[CH]=C(100)', 'CC1[CH]C=C1(857)'],
    products = ['C=CC1C=CC1C(510)'],
...
reaction(
    label = 'reaction350',
    reactants = ['H(25)', 'C=C[C]1C=CC1C(858)'],
    products = ['C=CC1C=CC1C(510)'],
...
reaction(
    label = 'reaction351',
    reactants = ['H(25)', '[CH2]C1C=CC1C=C(859)'],
    products = ['C=CC1C=CC1C(510)'],
...
reaction(
    label = 'reaction352',
    reactants = ['H(25)', 'C=CC1C=[C]C1C(860)'],
    products = ['C=CC1C=CC1C(510)'],
...
reaction(
    label = 'reaction353',
    reactants = ['H(25)', 'C=CC1[C]=CC1C(861)'],
    products = ['C=CC1C=CC1C(510)'],
...
reaction(
    label = 'reaction354',
    reactants = ['H(25)', 'C=[C]C1C=CC1C(862)'],
    products = ['C=CC1C=CC1C(510)'],
...
reaction(
    label = 'reaction355',
    reactants = ['H(25)', '[CH]=CC1C=CC1C(863)'],
    products = ['C=CC1C=CC1C(510)'],
...
reaction(
    label = 'reaction360',
    reactants = ['[CH2]C1C[CH]C1C=C(868)'],
    products = ['C=CC1C=CC1C(510)'],
...
reaction(
    label = 'reaction365',
    reactants = ['[CH2]C1[CH]CC1C=C(374)'],
    products = ['C=CC1C=CC1C(510)'],
...
reaction(
    label = 'reaction372',
    reactants = ['[CH2]C1C=CC1[CH]C(584)'],
    products = ['C=CC1C=CC1C(510)'],
...
reaction(
    label = 'reaction384',
    reactants = ['CC1C2[CH]CC1[CH]2(886)'],
    products = ['C=CC1C=CC1C(510)'],
