...
species(
    label = '[CH2]CC=C[C]=C(721)',
    structure = SMILES('[CH2]CC=C[C]=C'),
    E0 = (439.492,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2950,3100,1380,975,1025,1650,3000,3100,440,815,1455,1000,1685,370,2995,3025,975,1000,1300,1375,400,500,1630,1680,269.531,269.678],'cm^-1')),
        HinderedRotor(inertia=(0.3,'amu*angstrom^2'), symmetry=1, barrier=(15.4021,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.297319,'amu*angstrom^2'), symmetry=1, barrier=(15.3852,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.97175,'amu*angstrom^2'), symmetry=1, barrier=(102.095,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (80.1277,'amu'),
...
species(
    label = '[CH2]CCCC=C=C(730)',
    structure = SMILES('[CH2]CCCC=C=C'),
    E0 = (281.743,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([540,610,2055,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2950,3100,1380,975,1025,1650,3000,3100,440,815,1455,1000,3010,987.5,1337.5,450,1655,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.00229097,'amu*angstrom^2'), symmetry=1, barrier=(26.0118,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.173352,'amu*angstrom^2'), symmetry=1, barrier=(26.0134,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.639673,'amu*angstrom^2'), symmetry=1, barrier=(14.7073,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.172186,'amu*angstrom^2'), symmetry=1, barrier=(3.95889,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (95.1622,'amu'),
...
species(
    label = '[CH]=C=CC[CH]C(831)',
    structure = SMILES('C#C[CH]C[CH]C'),
    E0 = (442.678,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,750,770,3400,2100,2175,525,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3050,390,425,1340,1360,335,370,241.421,1726.4],'cm^-1')),
        HinderedRotor(inertia=(0.124387,'amu*angstrom^2'), symmetry=1, barrier=(5.16661,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.60701,'amu*angstrom^2'), symmetry=1, barrier=(66.4297,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.123393,'amu*angstrom^2'), symmetry=1, barrier=(5.1666,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0314188,'amu*angstrom^2'), symmetry=1, barrier=(66.4274,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (80.1277,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.77571,0.0510668,-3.4692e-05,5.45753e-09,5.4952e-12,53320.1,22.9952], Tmin=(100,'K'), Tmax=(685.535,'K')), NASAPolynomial(coeffs=[6.61866,0.0316859,-1.17087e-05,1.9956e-09,-1.30669e-13,52447.6,-0.0621029], Tmin=(685.535,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(442.678,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CtCsHH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(Sec_Propargyl) + radical(RCCJC)"""),
)

species(
    label = 'C[CH]C[C]=C=CC(832)',
...
species(
    ...
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.38505,0.0589559,-3.3263e-05,5.16234e-10,7.29496e-12,48261.7,27.8167], Tmin=(100,'K'), Tmax=(715.498,'K')), NASAPolynomial(coeffs=[6.53726,0.040084,-1.45201e-05,2.45237e-09,-1.60002e-13,47270.2,2.90861], Tmin=(715.498,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(400.496,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CtCsHH) + group(Cs-CsHHH) + group(Cs-CtHHH) + group(Ct-CtCs) + group(Ct-CtCs) + radical(RCCJC) + radical(Sec_Propargyl)"""),
)

species(
    label = 'CC=C1[CH]CC1C(834)',
    structure = SMILES('CC=C1[CH]CC1C'),
    E0 = (173.689,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (95.1622,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[10.5049,-0.0156892,0.000149181,-1.40499e-07,3.24884e-11,20544.2,-18.1828], Tmin=(100,'K'), Tmax=(1686.65,'K')), NASAPolynomial(coeffs=[69.1623,0.0424897,-7.80153e-05,1.86534e-08,-1.38085e-12,-27305.1,-415.023], Tmin=(1686.65,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(173.689,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(424.038,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + ring(methylenecyclobutane) + radical(Allyl_S)"""),
)

species(
    label = 'CC1[C]=CCC1C(835)',
    structure = SMILES('CC1[C]=CCC1C'),
    E0 = (214.93,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (95.1622,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.56965,0.0330984,6.54252e-05,-1.04029e-07,4.08185e-11,25955.8,22.4395], Tmin=(100,'K'), Tmax=(973.7,'K')), NASAPolynomial(coeffs=[14.0065,0.0326111,-1.178e-05,2.20571e-09,-1.61502e-13,21135,-49.5477], Tmin=(973.7,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(214.93,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(424.038,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cyclopentene) + radical(cyclopentene-vinyl)"""),
)

species(
    label = 'C=C=CC[CH]C(836)',
    structure = SMILES('C=C=CC[CH]C'),
    E0 = (294.723,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([540,610,2055,3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,2750,2850,1437.5,1250,1305,750,350,2950,3100,1380,975,1025,1650,275.408,275.471],'cm^-1')),
        HinderedRotor(inertia=(0.171807,'amu*angstrom^2'), symmetry=1, barrier=(9.22805,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.171358,'amu*angstrom^2'), symmetry=1, barrier=(9.22722,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (81.1357,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.71742,0.0490471,-2.67642e-05,7.13538e-09,-7.77854e-13,35529.4,24.1081], Tmin=(100,'K'), Tmax=(1979.92,'K')), NASAPolynomial(coeffs=[11.6661,0.0289479,-1.15368e-05,2.00805e-09,-1.30433e-13,31589.9,-30.6837], Tmin=(1979.92,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(294.723,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(RCCJC)"""),
)

species(
    label = '[CH2]C(C)C=C=CC(837)',
    structure = SMILES('[CH2]C(C)C=C=CC'),
    E0 = (261.362,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([540,610,2055,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,2995,3025,975,1000,1300,1375,400,500,1630,1680,236.185],'cm^-1')),
        HinderedRotor(inertia=(0.19894,'amu*angstrom^2'), symmetry=1, barrier=(7.8925,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.199307,'amu*angstrom^2'), symmetry=1, barrier=(7.89242,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.199359,'amu*angstrom^2'), symmetry=1, barrier=(7.89229,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.673818,'amu*angstrom^2'), symmetry=1, barrier=(26.6713,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (95.1622,'amu'),
...
species(
    label = '[CH2]C=C=CC(838)',
    structure = SMILES('C=C[C]=CC'),
    E0 = (256.891,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2995,3025,975,1000,1300,1375,400,500,1630,1680,1685,370,2750,2800,2850,1350,1500,750,1050,1375,1000,2950,3100,1380,975,1025,1650,180],'cm^-1')),
        HinderedRotor(inertia=(1.08471,'amu*angstrom^2'), symmetry=1, barrier=(24.9395,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.08337,'amu*angstrom^2'), symmetry=1, barrier=(24.9088,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (67.1091,'amu'),
...
species(
    label = '[CH]CC=C=CC(839)',
    structure = SMILES('[CH]CC=C=CC'),
    E0 = (536.246,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,540,610,2055,2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,301.021,301.021,301.021,301.022],'cm^-1')),
        HinderedRotor(inertia=(0.000483462,'amu*angstrom^2'), symmetry=1, barrier=(5.48925,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.501069,'amu*angstrom^2'), symmetry=1, barrier=(32.2196,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.269304,'amu*angstrom^2'), symmetry=1, barrier=(17.3166,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (80.1277,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.35559,0.0539094,-3.75507e-05,1.35246e-08,-2.00833e-12,64594,23.2434], Tmin=(100,'K'), Tmax=(1543.38,'K')), NASAPolynomial(coeffs=[12.0157,0.0262817,-1.06999e-05,1.92638e-09,-1.2965e-13,61303.5,-32.8117], Tmin=(1543.38,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(536.246,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cdd-CdsCds) + radical(CCJ2_triplet)"""),
)

species(
    label = 'C[C]CC=C=CC(840)',
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.392516,'amu*angstrom^2'), symmetry=1, barrier=(9.02472,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.155461,'amu*angstrom^2'), symmetry=1, barrier=(16.7661,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.729069,'amu*angstrom^2'), symmetry=1, barrier=(16.7627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.72922,'amu*angstrom^2'), symmetry=1, barrier=(16.7662,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.798553,0.0677275,-4.83949e-05,1.81424e-08,-2.83787e-12,61752.5,26.3832], Tmin=(100,'K'), Tmax=(1456.04,'K')), NASAPolynomial(coeffs=[12.7351,0.0349361,-1.4614e-05,2.67561e-09,-1.82283e-13,58276.4,-35.6888], Tmin=(1456.04,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(512.466,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(390.78,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cdd-CdsCds) + radical(CCJ2_triplet)"""),
)
...
species(
    label = 'C=CC=[C]C(C)C(844)',
    structure = SMILES('C=CC=[C]C(C)C'),
    E0 = (241.34,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2950,3100,1380,975,1025,1650,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,1685,370,2995,3025,975,1000,1300,1375,400,500,1630,1680,248.371,248.401],'cm^-1')),
        HinderedRotor(inertia=(0.331066,'amu*angstrom^2'), symmetry=1, barrier=(14.4949,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.331059,'amu*angstrom^2'), symmetry=1, barrier=(14.4946,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.331061,'amu*angstrom^2'), symmetry=1, barrier=(14.4946,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.331111,'amu*angstrom^2'), symmetry=1, barrier=(14.4947,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (95.1622,'amu'),
...
species(
    label = 'C=C[C]=CC(C)C(845)',
    structure = SMILES('C=C[C]=CC(C)C'),
    E0 = (202.493,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2950,3100,1380,975,1025,1650,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,1685,370,2995,3025,975,1000,1300,1375,400,500,1630,1680,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.781501,'amu*angstrom^2'), symmetry=1, barrier=(17.9683,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.78344,'amu*angstrom^2'), symmetry=1, barrier=(18.0128,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.781618,'amu*angstrom^2'), symmetry=1, barrier=(17.9709,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.78299,'amu*angstrom^2'), symmetry=1, barrier=(18.0025,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (95.1622,'amu'),
...
species(
    label = 'CCCC12[CH]C1C2(920)',
    structure = SMILES('CCCC12[CH]C1C2'),
    E0 = (317.583,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (95.1622,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.27572,0.0439081,2.95986e-05,-6.14131e-08,2.38365e-11,38308.3,24.3267], Tmin=(100,'K'), Tmax=(1037.5,'K')), NASAPolynomial(coeffs=[12.94,0.0370429,-1.55683e-05,3.01075e-09,-2.17699e-13,33837.1,-42.2597], Tmin=(1037.5,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(317.583,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(419.881,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsCs) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + polycyclic(s2_3_3_ane) + radical(bicyclo[1.1.0]butane-secondary)"""),
)

species(
    label = 'CCC[C]1C2CC12(921)',
    structure = SMILES('CCC[C]1C2CC12'),
    E0 = (300.613,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (95.1622,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.32571,0.0489775,4.41875e-07,-2.34261e-08,9.17852e-12,36259.7,23.9688], Tmin=(100,'K'), Tmax=(1142.29,'K')), NASAPolynomial(coeffs=[9.62988,0.041183,-1.72728e-05,3.22495e-09,-2.24439e-13,32974,-23.277], Tmin=(1142.29,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(300.613,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(419.881,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + polycyclic(s2_3_3_ane) + radical(Tertalkyl)"""),
)

species(
    label = '[CH]=C(C=C)CCC(922)',
    structure = SMILES('[CH]=C(C=C)CCC'),
    E0 = (257.001,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,440,435,1725,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3120,650,792.5,1650,2950,3100,1380,975,1025,1650,274.758,275.983],'cm^-1')),
        HinderedRotor(inertia=(0.269408,'amu*angstrom^2'), symmetry=1, barrier=(14.6323,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.271159,'amu*angstrom^2'), symmetry=1, barrier=(14.629,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.27245,'amu*angstrom^2'), symmetry=1, barrier=(14.6211,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.272224,'amu*angstrom^2'), symmetry=1, barrier=(14.6336,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (95.1622,'amu'),
...
species(
    label = 'C=C1C=C1CCC(923)',
    structure = SMILES('C=C1C=C1CCC'),
    E0 = (323.681,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2950,3100,1380,975,1025,1650,2750,2800,2850,1350,1500,750,1050,1375,1000,2950,1000,300,800,800,800,800,800,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.756847,0.0593373,-1.62256e-05,-2.01237e-08,1.16068e-11,39057.1,24.007], Tmin=(100,'K'), Tmax=(1011.97,'K')), NASAPolynomial(coeffs=[14.7035,0.0301743,-1.14838e-05,2.10592e-09,-1.48269e-13,34904.9,-50.0122], Tmin=(1011.97,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(323.681,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(394.937,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-Cds(Cds-Cds)(Cds-Cds)) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + ring(methylenecyclopropene)"""),
)

species(
    label = 'CCCC1=C[C]1C(924)',
    structure = SMILES('CCC[C]1C=C1C'),
    E0 = (286.447,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (95.1622,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.69414,0.0670481,-4.28783e-05,1.43051e-08,-1.98698e-12,34574.9,21.712], Tmin=(100,'K'), Tmax=(1621.8,'K')), NASAPolynomial(coeffs=[13.3065,0.0359411,-1.41075e-05,2.47837e-09,-1.63902e-13,30484,-45.234], Tmin=(1621.8,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(286.447,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(415.724,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + ring(Cyclopropene) + radical(Allyl_T)"""),
)

species(
    label = 'CCCC1=[C]C1C(925)',
    structure = SMILES('CCCC1=[C]C1C'),
    E0 = (383.819,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2950,1000,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,180,180,180,180,1031.95,1194.79,1600,1800,3000,3200],'cm^-1')),
        HinderedRotor(inertia=(0.172187,'amu*angstrom^2'), symmetry=1, barrier=(3.95891,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.172187,'amu*angstrom^2'), symmetry=1, barrier=(3.95891,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.172187,'amu*angstrom^2'), symmetry=1, barrier=(3.95891,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.172187,'amu*angstrom^2'), symmetry=1, barrier=(3.95891,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (95.1622,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.656637,0.0710012,-5.12915e-05,1.98868e-08,-3.24137e-12,46284.9,24.0333], Tmin=(100,'K'), Tmax=(1399.82,'K')), NASAPolynomial(coeffs=[12.3702,0.0375296,-1.54244e-05,2.80504e-09,-1.90676e-13,43005.5,-36.4177], Tmin=(1399.82,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(383.819,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(415.724,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)CsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + ring(Cyclopropene) + radical(cyclopropenyl-vinyl)"""),
)

species(
    label = 'CC[CH]C1=CC1C(926)',
    structure = SMILES('CCC=C1[CH]C1C'),
    E0 = (237.634,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (95.1622,'amu'),
...
species(
    label = 'C[CH]CC1=CC1C(927)',
    structure = SMILES('C[CH]CC1=CC1C'),
    E0 = (350.047,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (95.1622,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.990777,0.0654604,-4.21636e-05,1.4547e-08,-2.15273e-12,42209.3,25.0912], Tmin=(100,'K'), Tmax=(1483.35,'K')), NASAPolynomial(coeffs=[10.4461,0.0399633,-1.63804e-05,2.95919e-09,-1.99743e-13,39404.2,-24.2533], Tmin=(1483.35,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(350.047,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(415.724,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)CsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + ring(Cyclopropene) + radical(RCCJC)"""),
)

species(
    label = '[CH2]CCC1=CC1C(928)',
    structure = SMILES('[CH2]CCC1=CC1C'),
    E0 = (360.847,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3100,440,815,1455,1000,2750,3150,900,1100,2750,2800,2850,1350,1500,750,1050,1375,1000,300,800,800,800,800,800,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (95.1622,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.378319,0.0710171,-4.95427e-05,1.79298e-08,-2.6534e-12,43537.3,26.3607], Tmin=(100,'K'), Tmax=(1567.95,'K')), NASAPolynomial(coeffs=[15.5308,0.0323609,-1.25611e-05,2.20556e-09,-1.46208e-13,38785.7,-53.5559], Tmin=(1567.95,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(360.847,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(415.724,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)CsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + ring(Cyclopropene) + radical(RCCJ)"""),
)

species(
    label = '[CH2][C]1C=C1CCC(929)',
    structure = SMILES('C=C1[CH][C]1CCC'),
    E0 = (380.725,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2950,3100,1380,975,1025,1650,2750,2800,2850,1350,1500,750,1050,1375,1000,2950,1000,300,800,800,800,800,800,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.39828,0.0407575,3.62669e-05,-7.26948e-08,2.9821e-11,45899,21.1495], Tmin=(100,'K'), Tmax=(975.781,'K')), NASAPolynomial(coeffs=[13.4181,0.0316497,-1.14749e-05,2.10641e-09,-1.51043e-13,41641.2,-46.3424], Tmin=(975.781,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(380.725,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(394.937,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + ring(Methylene_cyclopropane) + radical(Allyl_T) + radical(Allyl_S)"""),
)

species(
    label = '[CH2]C1=CC1[CH2](930)',
    structure = SMILES('[CH2]C1[CH]C1=C'),
    E0 = (501.387,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,3100,1380,975,1025,1650,2750,3150,900,1100,3000,3100,440,815,1455,1000,180,180,883.337,883.346,883.358,883.36,883.362,883.362,883.366,883.396],'cm^-1')),
        HinderedRotor(inertia=(0.00706701,'amu*angstrom^2'), symmetry=1, barrier=(3.91423,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (66.1011,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.59684,0.0162857,5.31663e-05,-8.32758e-08,3.42035e-11,60366.9,15.1942], Tmin=(100,'K'), Tmax=(927.962,'K')), NASAPolynomial(coeffs=[11.8376,0.0137715,-3.09255e-06,4.78996e-10,-3.61281e-14,57045.1,-37.3537], Tmin=(927.962,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(501.387,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(253.591,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + ring(Methylene_cyclopropane) + radical(Isobutyl) + radical(Allyl_S)"""),
)

species(
    label = '[CH2]CC1=CC1[CH2](931)',
    ...
    molecularWeight = (80.1277,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.14179,0.0569176,-4.54912e-05,2.0003e-08,-3.60295e-12,71033.5,23.146], Tmin=(100,'K'), Tmax=(1320.03,'K')), NASAPolynomial(coeffs=[11.7853,0.0246652,-8.84165e-06,1.49356e-09,-9.74601e-14,68223.6,-31.1582], Tmin=(1320.03,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(589.71,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)CsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + ring(Cyclopropene) + radical(RCCJ) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]C1C=C1C[CH]C(932)',
    structure = SMILES('[CH2]C1C=C1C[CH]C'),
    E0 = (555.129,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3025,407.5,1350,352.5,2750,3150,900,1100,3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,300,800,800,800,800,800,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.98382,0.0673207,-5.4945e-05,2.72942e-08,-5.93458e-12,66874.4,26.9088], Tmin=(100,'K'), Tmax=(1063.29,'K')), NASAPolynomial(coeffs=[8.3199,0.0397236,-1.6014e-05,2.88551e-09,-1.95738e-13,65314.3,-8.93383], Tmin=(1063.29,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(555.129,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(390.78,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)CsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + ring(Cyclopropene) + radical(RCCJC) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]C1[C]=C1(933)',
    structure = SMILES('[CH2]C1[C]=C1'),
    E0 = (674.382,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,3150,900,1100,3000,3100,440,815,1455,1000,214.33,214.838,214.96,215.051,1438.85,1438.88,1438.91],'cm^-1')),
        HinderedRotor(inertia=(0.00235534,'amu*angstrom^2'), symmetry=1, barrier=(3.46042,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (52.0746,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.7312,0.0269507,-2.0088e-05,6.94897e-09,-1.94507e-13,81156.1,12.4592], Tmin=(100,'K'), Tmax=(863.072,'K')), NASAPolynomial(coeffs=[6.45475,0.0139153,-4.7701e-06,7.84462e-10,-5.05739e-14,80356.1,-5.86732], Tmin=(863.072,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(674.382,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(178.761,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)CsH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cyclopropene) + radical(Isobutyl) + radical(cyclopropenyl-vinyl)"""),
)

species(
    label = '[CH2]C1C=C1[CH]CC(934)',
    structure = SMILES('[CH2]C1[CH]C1=CCC'),
    E0 = (442.716,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,2750,3150,900,1100,3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,300,800,800,800,800,800,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.2604,0.0442322,2.83428e-05,-6.78867e-08,2.93158e-11,53359.6,24.7087], Tmin=(100,'K'), Tmax=(957.168,'K')), NASAPolynomial(coeffs=[14.3479,0.0290278,-9.71285e-06,1.72031e-09,-1.22216e-13,49045.3,-47.3072], Tmin=(957.168,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(442.716,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(394.937,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + ring(Methylene_cyclopropane) + radical(Allyl_S) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]CCC1=CC1[CH2](935)',
    structure = SMILES('[CH2]CCC1=CC1[CH2]'),
    E0 = (565.929,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,3150,900,1100,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,300,800,800,800,800,800,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.558735,0.0709932,-5.70378e-05,2.53054e-08,-4.648e-12,68193.3,27.4815], Tmin=(100,'K'), Tmax=(1283.14,'K')), NASAPolynomial(coeffs=[12.7593,0.0329597,-1.25764e-05,2.20504e-09,-1.47239e-13,65062.3,-34.4208], Tmin=(1283.14,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(565.929,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(390.78,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)CsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + ring(Cyclopropene) + radical(Isobutyl) + radical(RCCJ)"""),
)

species(
    label = '[CH2]C1[C]=C1CCC(936)',
    structure = SMILES('[CH2]C1[C]=C1CCC'),
    E0 = (588.902,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3100,440,815,1455,1000,2950,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,180,180,180,180,1019.96,1213.15,1600,1800,3000,3200],'cm^-1')),
        HinderedRotor(inertia=(0.164955,'amu*angstrom^2'), symmetry=1, barrier=(3.79265,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.164955,'amu*angstrom^2'), symmetry=1, barrier=(3.79265,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.164955,'amu*angstrom^2'), symmetry=1, barrier=(3.79265,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.164955,'amu*angstrom^2'), symmetry=1, barrier=(3.79265,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.68755,0.0724977,-6.31065e-05,3.16893e-08,-6.71204e-12,70948.1,25.7084], Tmin=(100,'K'), Tmax=(1111.62,'K')), NASAPolynomial(coeffs=[10.663,0.0366028,-1.46709e-05,2.64133e-09,-1.79286e-13,68730.3,-23.4729], Tmin=(1111.62,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(588.902,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(390.78,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)CsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + ring(Cyclopropene) + radical(Isobutyl) + radical(cyclopropenyl-vinyl)"""),
)

species(
    label = '[CH2]C1C=C1CC(937)',
    structure = SMILES('[CH2]C1C=C1CC'),
    E0 = (384.463,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,2750,3150,900,1100,2750,2800,2850,1350,1500,750,1050,1375,1000,180,180,180,180,975.759,1254.94,1600,1800,3000,3200],'cm^-1')),
        HinderedRotor(inertia=(0.165335,'amu*angstrom^2'), symmetry=1, barrier=(3.80137,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.165335,'amu*angstrom^2'), symmetry=1, barrier=(3.80137,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.165335,'amu*angstrom^2'), symmetry=1, barrier=(3.80137,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    ...
    molecularWeight = (81.1357,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.17792,0.0553597,-3.2376e-05,4.65613e-09,1.98356e-12,46347.7,21.2275], Tmin=(100,'K'), Tmax=(1025.7,'K')), NASAPolynomial(coeffs=[11.2593,0.0281436,-1.02686e-05,1.78765e-09,-1.20383e-13,43643.1,-30.7678], Tmin=(1025.7,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(384.463,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)CsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + ring(Cyclopropene) + radical(Isobutyl)"""),
)

species(
    label = 'CCCC1[CH]CC=1(938)',
    structure = SMILES('CCCC1[CH]CC=1'),
    E0 = (223.53,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (95.1622,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.36781,0.0390346,4.93964e-05,-8.73475e-08,3.47508e-11,26996,22.8624], Tmin=(100,'K'), Tmax=(984.014,'K')), NASAPolynomial(coeffs=[14.1228,0.0334222,-1.25295e-05,2.35782e-09,-1.71526e-13,22247.3,-49.8416], Tmin=(984.014,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(223.53,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(419.881,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + ring(Cyclobutene) + radical(cyclobutene-allyl)"""),
)

species(
    label = 'CCCC1[CH]C=1(939)',
    structure = SMILES('CCC[C]1C=C1'),
    E0 = (325.502,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,2750,3150,900,1100,200,800,914.286,1028.57,1142.86,1257.14,1371.43,1485.71,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (81.1357,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.47219,0.0478892,-1.5717e-05,-7.57098e-09,4.81612e-12,39246.3,17.4664], Tmin=(100,'K'), Tmax=(1091.96,'K')), NASAPolynomial(coeffs=[9.92621,0.0311309,-1.22165e-05,2.20946e-09,-1.51564e-13,36552.8,-27.9423], Tmin=(1091.96,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(325.502,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cyclopropene) + radical(Allyl_T)"""),
)

species(
    label = '[CH]C1C=C1CCC(940)',
    structure = SMILES('[CH]C1C=C1CCC'),
    E0 = (603.816,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,3150,900,1100,2750,2800,2850,1350,1500,750,1050,1375,1000,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.373494,0.0724524,-5.60233e-05,2.27091e-08,-3.75066e-12,72758.8,25.588], Tmin=(100,'K'), Tmax=(1425.43,'K')), NASAPolynomial(coeffs=[15.2617,0.0306732,-1.20581e-05,2.14659e-09,-1.44263e-13,68514.4,-51.5163], Tmin=(1425.43,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(603.816,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(390.78,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)CsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + ring(Cyclopropene) + radical(CCJ2_triplet)"""),
)
...
reaction(
    label = 'reaction284',
    reactants = ['[CH3](423)', '[CH2]CC=C[C]=C(721)'],
    products = ['C=[C]C=CCCC(274)'],
...
reaction(
    label = 'reaction286',
    reactants = ['[CH2]CC(431)', '[CH]=C[C]=C(722)'],
    products = ['C=[C]C=CCCC(274)'],
...
reaction(
    label = 'reaction291',
    reactants = ['H(25)', '[CH]=C=C[CH]CCC(599)'],
    products = ['C=[C]C=CCCC(274)'],
...
reaction(
    label = 'reaction293',
    reactants = ['CH2(S)(137)', 'C=[C]C=CCC(724)'],
    products = ['C=[C]C=CCCC(274)'],
...
reaction(
    label = 'reaction304',
    reactants = ['[CH]=C=C(588)', '[CH]CCC(734)'],
    products = ['C=[C]C=CCCC(274)'],
...
reaction(
    label = 'reaction396',
    reactants = ['C[CH2](419)', 'C#C[CH]C[CH2](796)'],
    products = ['[CH]=C=CCCCC(731)'],
...
reaction(
    label = 'reaction398',
    reactants = ['H(25)', '[CH]=C=CC[CH]CC(597)'],
    products = ['[CH]=C=CCCCC(731)'],
...
reaction(
    label = 'reaction399',
    reactants = ['[CH3](423)', 'C#C[CH]CC[CH2](797)'],
    products = ['[CH]=C=CCCCC(731)'],
...
reaction(
    label = 'reaction400',
    reactants = ['H(25)', 'C#C[CH]CC[CH]C(798)'],
    products = ['[CH]=C=CCCCC(731)'],
...
reaction(
    label = 'reaction402',
    reactants = ['H(25)', 'C#C[CH]CCC[CH2](799)'],
    products = ['[CH]=C=CCCCC(731)'],
...
reaction(
    label = 'reaction403',
    reactants = ['H(25)', '[C]#C[CH]CCCC(800)'],
    products = ['[CH]=C=CCCCC(731)'],
...
reaction(
    label = 'reaction405',
    reactants = ['CH2(S)(137)', '[CH]=C=CCCC(538)'],
    products = ['[CH]=C=CCCCC(731)'],
...
reaction(
    label = 'reaction407',
    reactants = ['[CH]C#C(804)', '[CH2]CCC(803)'],
    products = ['[CH]=C=CCCCC(731)'],
...
reaction(
    label = 'reaction417',
    reactants = ['C=CC(551)', '[CH]=C=CC(830)'],
    products = ['C[CH]CC=C=CC(535)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(38714.7,'s^-1'), n=2.045, Ea=(142.308,'kJ/mol'), T0=(1,'K'), comment="""Estimated using average of templates [RnH;C_rad_out_H/NonDeC;Cd_H_out_singleNd] + [R5H;C_rad_out_H/NonDeC;XH_out] for rate rule [R5H;C_rad_out_H/NonDeC;Cd_H_out_singleNd]
Euclidian distance = 2.0
family: intra_H_migration"""),
)
...
reaction(
    label = 'reaction422',
    reactants = ['[CH2][CH]C(552)', '[CH]=C=CC(830)'],
    products = ['C[CH]CC=C=CC(535)'],
...
reaction(
    label = 'reaction424',
    reactants = ['H(25)', 'C=CCC=[C][CH]C(582)'],
    products = ['C[CH]CC=C=CC(535)'],
...
reaction(
    label = 'reaction425',
    reactants = ['[CH3](423)', '[CH]=C=CC[CH]C(831)'],
    products = ['C[CH]CC=C=CC(535)'],
...
reaction(
    label = 'reaction427',
    reactants = ['H(25)', 'C[CH]C[C]=C=CC(832)'],
    products = ['C[CH]CC=C=CC(535)'],
...
reaction(
    label = 'reaction428',
    reactants = ['H(25)', 'C[C]=C=CC[CH]C(833)'],
    products = ['C[CH]CC=C=CC(535)'],
...
reaction(
    label = 'reaction431',
    reactants = ['CH2(S)(137)', 'C=C=CC[CH]C(836)'],
    products = ['C[CH]CC=C=CC(535)'],
...
reaction(
    label = 'reaction433',
    reactants = ['[CH]C(495)', '[CH2]C=C=CC(838)'],
    products = ['C[CH]CC=C=CC(535)'],
...
reaction(
    label = 'reaction434',
    reactants = ['[CH3](423)', '[CH]CC=C=CC(839)'],
    products = ['C[CH]CC=C=CC(535)'],
...
reaction(
    label = 'reaction435',
    reactants = ['H(25)', 'C[C]CC=C=CC(840)'],
    products = ['C[CH]CC=C=CC(535)'],
...
reaction(
    label = 'reaction450',
    reactants = ['H(25)', 'C=CC=CC(=C)C(808)'],
    products = ['[CH2]C(C)C=CC=C(452)'],
...
reaction(
    label = 'reaction460',
    reactants = ['H(25)', '[CH2]C=CC=C([CH2])C(825)'],
    products = ['[CH2]C(C)C=CC=C(452)'],
...
reaction(
    label = 'reaction462',
    reactants = ['H(25)', '[CH2]C(C)[C]=CC=C(848)'],
    products = ['[CH2]C(C)C=CC=C(452)'],
...
reaction(
    label = 'reaction463',
    reactants = ['[CH]=C(100)', '[CH]=CC([CH2])C(849)'],
    products = ['[CH2]C(C)C=CC=C(452)'],
...
reaction(
    label = 'reaction464',
    reactants = ['H(25)', '[CH2]C(C)C=[C]C=C(850)'],
    products = ['[CH2]C(C)C=CC=C(452)'],
...
reaction(
    label = 'reaction465',
    reactants = ['H(25)', '[CH2]C(C)C=C[C]=C(851)'],
    products = ['[CH2]C(C)C=CC=C(452)'],
...
reaction(
    label = 'reaction466',
    reactants = ['H(25)', '[CH]=CC=CC([CH2])C(783)'],
    products = ['[CH2]C(C)C=CC=C(452)'],
...
reaction(
    label = 'reaction473',
    reactants = ['H(25)', '[CH]C(C)C=CC=C(854)'],
    products = ['[CH2]C(C)C=CC=C(452)'],
...
reaction(
    label = 'reaction499',
    reactants = ['[CH2]C1C=C1CCC(416)'],
    products = ['CCCC12[CH]C1C2(920)'],
...
reaction(
    label = 'reaction502',
    reactants = ['H(25)', 'C=C1C=C1CCC(923)'],
    products = ['[CH2]C1C=C1CCC(416)'],
...
reaction(
    label = 'reaction505',
    reactants = ['[CH2]C1C=C1CCC(416)'],
    products = ['CC[CH]C1=CC1C(926)'],
    transitionState = 'TS505',
    kinetics = Arrhenius(A=(754000,'s^-1'), n=1.63, Ea=(74.8936,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4H_SSS;C_rad_out_2H;Cs_H_out_H/(NonDeC/Cs)] for rate rule [R4H_SS(Cd)S;C_rad_out_2H;Cs_H_out_H/(NonDeC/Cs)]
Euclidian distance = 1.0
Multiplied by reaction path degeneracy 2.0
family: intra_H_migration"""),
)
...
reaction(
    label = 'reaction508',
    reactants = ['H(25)', '[CH2][C]1C=C1CCC(929)'],
    products = ['[CH2]C1C=C1CCC(416)'],
...
reaction(
    label = 'reaction509',
    reactants = ['C[CH2](419)', '[CH2]C1=CC1[CH2](930)'],
    products = ['[CH2]C1C=C1CCC(416)'],
...
reaction(
    label = 'reaction510',
    reactants = ['[CH3](423)', '[CH2]CC1=CC1[CH2](931)'],
    products = ['[CH2]C1C=C1CCC(416)'],
...
reaction(
    label = 'reaction511',
    reactants = ['H(25)', '[CH2]C1C=C1C[CH]C(932)'],
    products = ['[CH2]C1C=C1CCC(416)'],
...
reaction(
    label = 'reaction512',
    reactants = ['[CH2]CC(431)', '[CH2]C1[C]=C1(933)'],
    products = ['[CH2]C1C=C1CCC(416)'],
...
reaction(
    label = 'reaction513',
    reactants = ['H(25)', '[CH2]C1C=C1[CH]CC(934)'],
    products = ['[CH2]C1C=C1CCC(416)'],
...
reaction(
    label = 'reaction514',
    reactants = ['H(25)', '[CH2]CCC1=CC1[CH2](935)'],
    products = ['[CH2]C1C=C1CCC(416)'],
...
reaction(
    label = 'reaction515',
    reactants = ['H(25)', '[CH2]C1[C]=C1CCC(936)'],
    products = ['[CH2]C1C=C1CCC(416)'],
...
reaction(
    label = 'reaction516',
    reactants = ['CH2(S)(137)', '[CH2]C1C=C1CC(937)'],
    products = ['[CH2]C1C=C1CCC(416)'],
...
reaction(
    label = 'reaction519',
    reactants = ['CH2(T)(82)', 'CCCC1[CH]C=1(939)'],
    products = ['[CH2]C1C=C1CCC(416)'],
    transitionState = 'TS519',
    kinetics = Arrhenius(A=(1.5183e+06,'m^3/(mol*s)'), n=0.575199, Ea=(34.3157,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Y_rad;Birad] for rate rule [C_rad/H/TwoDe;Birad]
Euclidian distance = 3.0
Multiplied by reaction path degeneracy 2.0
family: Birad_R_Recombination"""),
)
...
reaction(
    label = 'reaction520',
    reactants = ['H(25)', '[CH]C1C=C1CCC(940)'],
    products = ['[CH2]C1C=C1CCC(416)'],
