...
species(
    label = '[CH2]C1=CC=CO1(2389)',
    structure = SMILES('C=C1C=C[CH]O1'),
    E0 = (66.7415,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2950,3150,900,1000,1100,2950,3100,1380,975,1025,1650,300,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
species(
    label = 'C=[C]CC1=CC=CO1(2390)',
    structure = SMILES('C=[C]CC1=CC=CO1'),
    E0 = (231.478,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,1685,370,2950,3100,1380,975,1025,1650,2750,2950,3150,900,1000,1100,300,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
...
species(
    label = '[CH]=CCC1=CC=CO1(2394)',
    structure = SMILES('[CH]=CCC1=CC=CO1'),
    E0 = (240.732,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2950,3150,900,1000,1100,3120,650,792.5,1650,3010,987.5,1337.5,450,1655,300,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
...
species(
    label = '[CH2]C[CH]C1=CC=CO1(2395)',
    structure = SMILES('[CH2]CC=C1C=C[CH]O1'),
    E0 = (213.317,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,2750,2950,3150,900,1000,1100,300,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
...
species(
    ...
    molecularWeight = (108.138,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.878225,0.0519547,1.19632e-05,-6.20965e-08,3.08451e-11,42623.9,25.6852], Tmin=(100,'K'), Tmax=(920.988,'K')), NASAPolynomial(coeffs=[18.5906,0.0183861,-3.98255e-06,5.63805e-10,-3.97018e-14,37522.5,-68.2921], Tmin=(920.988,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(353.332,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(374.151,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + ring(2,3-Dihydrofuran) + radical(C2CsJOC(O)) + radical(Cds_S)"""),
)
...
species(
    label = '[CH]=COC(=[CH])CC=C(2413)',
    structure = SMILES('[CH]=COC(=[CH])CC=C'),
    E0 = (504.841,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2950,3100,1380,975,1025,1650,2995,3025,975,1000,1300,1375,400,500,1630,1680,3115,3125,620,680,785,800,1600,1700,350,440,435,1725,338.811,338.966,339.056],'cm^-1')),
        HinderedRotor(inertia=(0.191439,'amu*angstrom^2'), symmetry=1, barrier=(15.611,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.190775,'amu*angstrom^2'), symmetry=1, barrier=(15.6112,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.191428,'amu*angstrom^2'), symmetry=1, barrier=(15.6112,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.191306,'amu*angstrom^2'), symmetry=1, barrier=(15.6112,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (108.138,'amu'),
...
species(
    label = '[CH]1CC2=CC([CH]O2)C1(2424)',
...
reaction(
    label = 'reaction934',
    reactants = ['C3H5(89)(88)', '[C]1=CC=CO1(2388)'],
...
reaction(
    label = 'reaction935',
    reactants = ['C2H3(28)(29)', '[CH2]C1=CC=CO1(2389)'],
    products = ['C7H8O(596)(595)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction937',
    reactants = ['H(3)(3)', 'C=[C]CC1=CC=CO1(2390)'],
    products = ['C7H8O(596)(595)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction938',
    reactants = ['H(3)(3)', 'C=CCC1=[C]C=CO1(2391)'],
    products = ['C7H8O(596)(595)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction939',
    reactants = ['H(3)(3)', 'C=CCC1=C[C]=CO1(2392)'],
    products = ['C7H8O(596)(595)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(6.117e+14,'cm^3/(mol*s)'), n=-0.152, Ea=(4.19655,'kJ/mol'), T0=(1,'K'), comment="""From training reaction 49 used for Cd_rad/Cd;H_rad
Exact match found for rate rule [Cd_rad/Cd;H_rad]
...
reaction(
    label = 'reaction940',
    reactants = ['H(3)(3)', 'C=CCC1=CC=[C]O1(2393)'],
    products = ['C7H8O(596)(595)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(1e+13,'cm^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""From training reaction 40 used for Cd_rad/NonDe;H_rad
Exact match found for rate rule [Cd_rad/NonDe;H_rad]
...
reaction(
    label = 'reaction941',
    reactants = ['H(3)(3)', '[CH]=CCC1=CC=CO1(2394)'],
    products = ['C7H8O(596)(595)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction942',
    reactants = ['[CH2]C[CH]C1=CC=CO1(2395)'],
    products = ['C7H8O(596)(595)'],
...
reaction(
    label = 'reaction943',
    reactants = ['C=CCC1=[C]C[CH]O1(2396)'],
    products = ['C7H8O(596)(595)'],
...
reaction(
    label = 'reaction944',
    reactants = ['C=CC[C]1C[C]=CO1(2397)'],
    products = ['C7H8O(596)(595)'],
...
reaction(
    label = 'reaction947',
    reactants = ['C=CC[C]1CC=[C]O1(2398)'],
    products = ['C7H8O(596)(595)'],
...
reaction(
    label = 'reaction948',
    reactants = ['C=[C]C[C]1CC=CO1(2399)'],
    products = ['C7H8O(596)(595)'],
...
reaction(
    label = 'reaction950',
    reactants = ['C=CCC1=[C][CH]CO1(2400)'],
    products = ['C7H8O(596)(595)'],
...
reaction(
    label = 'reaction951',
    reactants = ['[CH2]CCC1=[C]C=CO1(2401)'],
    products = ['C7H8O(596)(595)'],
...
reaction(
    label = 'reaction952',
    reactants = ['C=C[CH]C1=CC[CH]O1(2402)'],
    products = ['C7H8O(596)(595)'],
...
reaction(
    label = 'reaction955',
    reactants = ['C[CH]CC1=[C]C=CO1(2403)'],
    products = ['C7H8O(596)(595)'],
...
reaction(
    label = 'reaction956',
    reactants = ['[CH]=CC[C]1CC=CO1(2404)'],
    products = ['C7H8O(596)(595)'],
...
reaction(
    label = 'reaction957',
    reactants = ['[CH2]CCC1=CC=[C]O1(2405)'],
    products = ['C7H8O(596)(595)'],
...
reaction(
    label = 'reaction958',
    reactants = ['C=[C]CC1=C[CH]CO1(2406)'],
    products = ['C7H8O(596)(595)'],
...
reaction(
    label = 'reaction959',
    reactants = ['C=[C]CC1=CC[CH]O1(2407)'],
    products = ['C7H8O(596)(595)'],
...
reaction(
    label = 'reaction960',
    reactants = ['[CH2]CCC1=C[C]=CO1(2408)'],
    products = ['C7H8O(596)(595)'],
...
reaction(
    label = 'reaction961',
    reactants = ['C[CH]CC1=CC=[C]O1(2409)'],
    products = ['C7H8O(596)(595)'],
...
reaction(
    label = 'reaction962',
    reactants = ['C[CH]CC1=C[C]=CO1(2410)'],
    products = ['C7H8O(596)(595)'],
...
reaction(
    label = 'reaction963',
    reactants = ['[CH]=CCC1=C[CH]CO1(2411)'],
    products = ['C7H8O(596)(595)'],
...
reaction(
    label = 'reaction964',
    reactants = ['[CH]=CCC1=CC[CH]O1(2412)'],
    products = ['C7H8O(596)(595)'],
...
reaction(
    label = 'reaction974',
    reactants = ['C=CCC1=CC[C-]=[O+]1(2421)'],
    products = ['C7H8O(596)(595)'],
...
reaction(
    label = 'reaction978',
    reactants = ['[CH]1CC2=CC([CH]O2)C1(2424)'],
    products = ['C7H8O(596)(595)'],
