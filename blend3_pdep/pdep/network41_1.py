...
species(
    label = '[CH]=CC1OC1C=C[CH2](1476)',
    structure = SMILES('[CH]=CC1OC1[CH]C=C'),
    E0 = (408.047,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,3100,1380,975,1025,1650,3120,650,792.5,1650,2750,3150,900,1100,2995,3025,975,1000,1300,1375,400,500,1630,1680,3025,407.5,1350,352.5,180,1025.98,1025.98,1025.98,1025.98,1025.98,1025.98,1025.98,1025.98,1025.98,2287.77],'cm^-1')),
...
species(
    label = '[CH]=CCC=CC1[CH]O1(1477)',
    structure = SMILES('[CH]=CCC=CC1[CH]O1'),
    E0 = (477.654,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,3150,900,1100,3120,650,792.5,1650,2995,3010,3025,975,987.5,1000,1300,1337.5,1375,400,450,500,1630,1655,1680,200,800,914.286,1028.57,1142.86,1257.14,1371.43,1485.71,1600],'cm^-1')),
...
species(
    label = '[CH]1C[CH]C2C1C1OC21(1480)',
...
species(
    label = '[CH]1C2CC2[CH]C2OC12(1481)',
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)(3)', '[CH]1C=CC2OC2C=C1(1463)'],
    products = ['C7H8O(418)(417)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)(3)', '[C]1=CCC=CC2OC12(1464)'],
    products = ['C7H8O(418)(417)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)(3)', '[C]1=CC2OC2C=CC1(1465)'],
    products = ['C7H8O(418)(417)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(1e+13,'cm^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""From training reaction 40 used for Cd_rad/NonDe;H_rad
Exact match found for rate rule [Cd_rad/NonDe;H_rad]
...
reaction(
    label = 'reaction5',
    reactants = ['[CH]1CC=CC2O[C]2C1(1466)'],
    products = ['C7H8O(418)(417)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH]1C=CC2OC2[CH]C1(1467)'],
    products = ['C7H8O(418)(417)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH]1CC=C[C]2OC2C1(1468)'],
    products = ['C7H8O(418)(417)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[C]1=CC2OC2[CH]CC1(1469)'],
    products = ['C7H8O(418)(417)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH]1CCC=C[C]2OC12(1470)'],
    products = ['C7H8O(418)(417)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[C]1=CC2OC2C[CH]C1(1471)'],
    products = ['C7H8O(418)(417)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[C]1=CC[CH]CC2OC12(1472)'],
    products = ['C7H8O(418)(417)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[C]1=CCC[CH]C2OC12(1473)'],
    products = ['C7H8O(418)(417)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH]1[CH]CC2OC2C=C1(1474)'],
    products = ['C7H8O(418)(417)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH]1CCC=CC2O[C]12(1475)'],
    products = ['C7H8O(418)(417)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH]=CC1OC1C=C[CH2](1476)'],
    products = ['C7H8O(418)(417)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH]=CCC=CC1[CH]O1(1477)'],
    products = ['C7H8O(418)(417)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH]1C[CH]C2C1C1OC21(1480)'],
    products = ['C7H8O(418)(417)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH]1C2CC2[CH]C2OC12(1481)'],
    products = ['C7H8O(418)(417)'],
...
reaction(
    label = 'reaction23',
    reactants = ['C7H8(415)(414)', 'O(S)(1482)'],
    products = ['C7H8O(418)(417)'],
