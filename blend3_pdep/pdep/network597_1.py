species(
    ...
    E0 = (47.4434,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,1380,1390,370,380,2900,435,492.5,1135,1000,2782.5,750,1395,475,1775,1000,285.878,847.389],'cm^-1')),
        HinderedRotor(inertia=(0.246136,'amu*angstrom^2'), symmetry=1, barrier=(14.2745,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.49891,'amu*angstrom^2'), symmetry=1, barrier=(28.9341,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.49891,'amu*angstrom^2'), symmetry=1, barrier=(28.9343,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.498911,'amu*angstrom^2'), symmetry=1, barrier=(28.9341,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
species(
    ...
    molecularWeight = (114.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.853905,0.0565531,-1.95651e-05,-2.04274e-08,1.32129e-11,26975.6,27.5817], Tmin=(100,'K'), Tmax=(978.432,'K')), NASAPolynomial(coeffs=[17.1266,0.0191204,-6.77929e-06,1.25019e-09,-9.08049e-14,22398.7,-57.6859], Tmin=(978.432,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(223.252,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(324.264,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Cyclopropane) + radical(CC(C)OJ) + radical(ROOJ)"""),
)

species(
    label = 'C=C[CH]C1OOC1[O](7256)',
...
species(
    label = 'C=CC=C(C=O)O[O](7258)',
    structure = SMILES('C=CC=C(C=O)O[O]'),
    E0 = (40.3756,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2950,3100,1380,975,1025,1650,2782.5,750,1395,475,1775,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,350,440,435,1725,180],'cm^-1')),
        HinderedRotor(inertia=(0.665526,'amu*angstrom^2'), symmetry=1, barrier=(15.3017,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.666427,'amu*angstrom^2'), symmetry=1, barrier=(15.3225,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.666074,'amu*angstrom^2'), symmetry=1, barrier=(15.3143,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
species(
    label = 'C=C=CC(C=O)O[O](7259)',
    structure = SMILES('C=C=CC(C=O)O[O]'),
    E0 = (93.7509,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([540,610,2055,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,1380,1390,370,380,2900,435,492.5,1135,1000,2782.5,750,1395,475,1775,1000,180],'cm^-1')),
        HinderedRotor(inertia=(0.677616,'amu*angstrom^2'), symmetry=1, barrier=(15.5797,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.677848,'amu*angstrom^2'), symmetry=1, barrier=(15.5851,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.677487,'amu*angstrom^2'), symmetry=1, barrier=(15.5768,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (113.091,'amu'),
...
species(
    label = 'C=CC[C](C=O)O[O](7260)',
    structure = SMILES('C=CCC(=C[O])O[O]'),
    E0 = (83.3607,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2950,3100,1380,975,1025,1650,2995,3025,975,1000,1300,1375,400,500,1630,1680,350,440,435,1725,2750,2850,1437.5,1250,1305,750,350,307.333,307.496,308.096],'cm^-1')),
        HinderedRotor(inertia=(0.174153,'amu*angstrom^2'), symmetry=1, barrier=(11.7148,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.174603,'amu*angstrom^2'), symmetry=1, barrier=(11.7151,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.174955,'amu*angstrom^2'), symmetry=1, barrier=(11.7185,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (114.099,'amu'),
...
species(
    label = 'C=[C]CC(C=O)O[O](7261)',
    structure = SMILES('C=[C]CC(C=O)O[O]'),
    E0 = (168.368,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,2950,3100,1380,975,1025,1650,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,492.5,1135,1000,2782.5,750,1395,475,1775,1000,654.688,656.798],'cm^-1')),
        HinderedRotor(inertia=(0.542476,'amu*angstrom^2'), symmetry=1, barrier=(12.4726,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.155934,'amu*angstrom^2'), symmetry=1, barrier=(3.58523,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0945989,'amu*angstrom^2'), symmetry=1, barrier=(12.4834,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.543009,'amu*angstrom^2'), symmetry=1, barrier=(12.4848,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (114.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.08552,0.0647403,-5.79422e-05,2.7523e-08,-5.40829e-12,20354.4,31.6256], Tmin=(100,'K'), Tmax=(1195.43,'K')), NASAPolynomial(coeffs=[11.7705,0.0289874,-1.308e-05,2.50423e-09,-1.76083e-13,17799.8,-21.8304], Tmin=(1195.43,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(168.368,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-O2d)CsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-OdCsH) + group(Cds-CdsHH) + radical(ROOJ) + radical(Cds_S)"""),
)

species(
    label = 'C=C[CH][C](C=O)OO(7262)',
...
species(
    label = 'C=CCC([C]=O)O[O](7263)',
    structure = SMILES('C=CCC([C]=O)O[O]'),
    E0 = (90.4873,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1855,455,950,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,492.5,1135,1000,426.217,426.366],'cm^-1')),
        HinderedRotor(inertia=(0.0834924,'amu*angstrom^2'), symmetry=1, barrier=(10.7653,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0834622,'amu*angstrom^2'), symmetry=1, barrier=(10.7641,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.083487,'amu*angstrom^2'), symmetry=1, barrier=(10.7655,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0835039,'amu*angstrom^2'), symmetry=1, barrier=(10.7675,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (114.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.749863,0.0665799,-6.02636e-05,2.80209e-08,-5.21596e-12,11004.2,33.1754], Tmin=(100,'K'), Tmax=(1289.51,'K')), NASAPolynomial(coeffs=[14.8424,0.0228657,-9.41419e-06,1.73235e-09,-1.19377e-13,7369.64,-38.3964], Tmin=(1289.51,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(90.4873,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-O2d)CsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-OdCsH) + group(Cds-CdsHH) + radical(CCCJ=O) + radical(ROOJ)"""),
)

species(
    label = '[CH]=CCC(C=O)O[O](7264)',
    structure = SMILES('[CH]=CCC(C=O)O[O]'),
    E0 = (177.623,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3010,987.5,1337.5,450,1655,2782.5,750,1395,475,1775,1000,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,492.5,1135,1000,3120,650,792.5,1650,180],'cm^-1')),
        HinderedRotor(inertia=(0.0250224,'amu*angstrom^2'), symmetry=1, barrier=(14.5566,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.634092,'amu*angstrom^2'), symmetry=1, barrier=(14.579,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.169673,'amu*angstrom^2'), symmetry=1, barrier=(3.90113,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.630669,'amu*angstrom^2'), symmetry=1, barrier=(14.5003,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (114.099,'amu'),
...
species(
    label = 'C=C[CH]C([C]=O)OO(7265)',
    structure = SMILES('C=C[CH]C([C]=O)OO'),
    E0 = (55.3993,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2950,3100,1380,975,1025,1650,1855,455,950,3010,987.5,1337.5,450,1655,3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,337.282,337.389],'cm^-1')),
        HinderedRotor(inertia=(0.322013,'amu*angstrom^2'), symmetry=1, barrier=(26.0081,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.321997,'amu*angstrom^2'), symmetry=1, barrier=(26.0072,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.322322,'amu*angstrom^2'), symmetry=1, barrier=(26.0063,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.322069,'amu*angstrom^2'), symmetry=1, barrier=(26.0073,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.48081,'amu*angstrom^2'), symmetry=1, barrier=(119.627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (114.099,'amu'),
...
species(
    label = 'C=[C][CH]C(C=O)OO(7266)',
    structure = SMILES('C=[C][CH]C(C=O)OO'),
    E0 = (133.28,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2950,3100,1380,975,1025,1650,1685,370,3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,2782.5,750,1395,475,1775,1000,410.746,412.892],'cm^-1')),
        HinderedRotor(inertia=(0.465903,'amu*angstrom^2'), symmetry=1, barrier=(26.2878,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.217428,'amu*angstrom^2'), symmetry=1, barrier=(26.3035,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.219915,'amu*angstrom^2'), symmetry=1, barrier=(26.3018,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.219812,'amu*angstrom^2'), symmetry=1, barrier=(26.3035,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.335725,'amu*angstrom^2'), symmetry=1, barrier=(40.512,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (114.099,'amu'),
...
species(
    label = '[CH]=C[CH]C(C=O)OO(7267)',
    structure = SMILES('[CH]C=CC(C=O)OO'),
    E0 = (135.826,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,2782.5,750,1395,475,1775,1000,1380,1390,370,380,2900,435,2995,3025,975,1000,1300,1375,400,500,1630,1680,200,800,1200,1600],'cm^-1')),
...
species(
    ...
    molecularWeight = (114.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.425952,0.0733366,-6.89348e-05,3.30114e-08,-5.88591e-12,24525.4,31.5293], Tmin=(100,'K'), Tmax=(1648.76,'K')), NASAPolynomial(coeffs=[17.0703,0.01505,-1.4967e-06,-8.35037e-11,1.57498e-14,20908.9,-55.0996], Tmin=(1648.76,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(202.418,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(324.264,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Oxetane) + radical(ROOJ) + radical(CCsJOCs)"""),
)

species(
    label = 'C=C[CH]C1[CH]OOO1(7270)',
...
species(
    label = 'C=CC([CH]O[O])C=O(7275)',
    structure = SMILES('C=CC([CH]O[O])C=O'),
    E0 = (122.268,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,1380,1390,370,380,2900,435,492.5,1135,1000,2782.5,750,1395,475,1775,1000,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.20462,'amu*angstrom^2'), symmetry=1, barrier=(4.70462,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.204536,'amu*angstrom^2'), symmetry=1, barrier=(4.70268,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.204799,'amu*angstrom^2'), symmetry=1, barrier=(4.70873,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (114.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.573887,0.0839736,-0.000129017,1.15124e-07,-4.06861e-11,14820.5,30.2185], Tmin=(100,'K'), Tmax=(832.94,'K')), NASAPolynomial(coeffs=[6.67141,0.0386393,-1.84688e-05,3.50687e-09,-2.40753e-13,14361.6,5.25874], Tmin=(832.94,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(122.268,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-O2d)CsCsH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-OdCsH) + group(Cds-CdsHH) + radical(CCsJOOH) + radical(ROOJ)"""),
)
...
species(
    ...
    molecularWeight = (114.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.817925,0.0555016,-1.01646e-05,-3.7991e-08,2.2153e-11,33760.3,31.5562], Tmin=(100,'K'), Tmax=(925.084,'K')), NASAPolynomial(coeffs=[19.1677,0.0135545,-2.7852e-06,3.89118e-10,-2.83024e-14,28765.2,-64.1906], Tmin=(925.084,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(279.635,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsOs) + group(O2s-OsH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsOsH) + radical(ROOJ) + radical(C=CC=CCJ)"""),
)

species(
    label = 'C=C[CH]C(=CO)O[O](7277)',
...
species(
    label = 'C=C[CH]C([O])C=O(7278)',
    structure = SMILES('C=C[CH]C([O])C=O'),
    E0 = (67.6668,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,3100,1380,975,1025,1650,2782.5,750,1395,475,1775,1000,1380,1390,370,380,2900,435,3010,987.5,1337.5,450,1655,3025,407.5,1350,352.5,180,878.307,887.224],'cm^-1')),
        HinderedRotor(inertia=(0.0405612,'amu*angstrom^2'), symmetry=1, barrier=(22.4249,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.975473,'amu*angstrom^2'), symmetry=1, barrier=(22.428,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.352693,'amu*angstrom^2'), symmetry=1, barrier=(22.4363,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (98.0999,'amu'),
...
species(
    ...
    molecularWeight = (114.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.02218,0.0588185,-4.17082e-05,1.44395e-08,-2.00645e-12,25744.1,29.7135], Tmin=(100,'K'), Tmax=(1670.63,'K')), NASAPolynomial(coeffs=[15.6574,0.0237774,-1.02462e-05,1.88463e-09,-1.27702e-13,20854.1,-48.404], Tmin=(1670.63,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(213.113,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsOsH) + group(Cs-(Cds-O2d)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + ring(12dioxetane) + radical(CCJCOOH) + radical(RCCJ)"""),
)

species(
    label = '[O]OC1C=CCC1[O](7280)',
...
species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.695118,'amu*angstrom^2'), symmetry=1, barrier=(15.9821,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.693973,'amu*angstrom^2'), symmetry=1, barrier=(15.9558,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.693355,'amu*angstrom^2'), symmetry=1, barrier=(15.9416,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (114.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.202975,0.0773826,-8.20211e-05,4.40911e-08,-9.25946e-12,6537.09,28.7436], Tmin=(100,'K'), Tmax=(1168.78,'K')), NASAPolynomial(coeffs=[17.3359,0.0187469,-6.76811e-06,1.16682e-09,-7.79687e-14,2532.2,-56.5848], Tmin=(1168.78,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(53.1722,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(O2s-OsH) + group(Cs-(Cds-Cds)HHH) + group(Cds-Cds(Cds-Cds)O2s) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsOsH) + radical(ROOJ) + radical(C=COJ)"""),
)

species(
    label = 'CC=CC([C]=O)O[O](7285)',
    structure = SMILES('CC=CC([C]=O)O[O]'),
    E0 = (77.1072,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,1855,455,950,1380,1390,370,380,2900,435,2995,3025,975,1000,1300,1375,400,500,1630,1680,2750,2800,2850,1350,1500,750,1050,1375,1000,240.535],'cm^-1')),
        HinderedRotor(inertia=(0.231886,'amu*angstrom^2'), symmetry=1, barrier=(9.52135,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.231901,'amu*angstrom^2'), symmetry=1, barrier=(9.52124,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.231912,'amu*angstrom^2'), symmetry=1, barrier=(9.52117,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.231911,'amu*angstrom^2'), symmetry=1, barrier=(9.52126,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (114.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.06358,0.0665647,-6.5268e-05,3.49799e-08,-7.76931e-12,9377.97,30.9481], Tmin=(100,'K'), Tmax=(1068.49,'K')), NASAPolynomial(coeffs=[10.9578,0.0295247,-1.32694e-05,2.5363e-09,-1.7833e-13,7263.59,-17.4413], Tmin=(1068.49,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(77.1072,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-O2d)CsOsH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-OdCsH) + radical(CCCJ=O) + radical(ROOJ)"""),
)

species(
    label = '[O]OC1[CH]OCC=C1(7286)',
...
species(
    label = '[CH]=CC(C=O)O[O](7290)',
    structure = SMILES('[CH]=CC(C=O)O[O]'),
    E0 = (200.268,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2782.5,750,1395,475,1775,1000,1380,1390,370,380,2900,435,3120,650,792.5,1650,3010,987.5,1337.5,450,1655],'cm^-1')),
        HinderedRotor(inertia=(0.664525,'amu*angstrom^2'), symmetry=1, barrier=(15.2787,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.126764,'amu*angstrom^2'), symmetry=1, barrier=(6.7586,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.664649,'amu*angstrom^2'), symmetry=1, barrier=(15.2816,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
reaction(
    label = 'reaction4',
    reactants = ['S(221)(220)'],
    products = ['[CH2]C1[CH]C(C=O)OO1(7257)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)(3)', 'C=CC=C(C=O)O[O](7258)'],
    products = ['S(221)(220)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['H(3)(3)', 'C=C=CC(C=O)O[O](7259)'],
    products = ['S(221)(220)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['HCO(14)(15)', 'C=CC=CO[O](2629)'],
    products = ['S(221)(220)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction13',
    reactants = ['C=C[CH]C([C]=O)OO(7265)'],
    products = ['S(221)(220)'],
...
reaction(
    label = 'reaction14',
    reactants = ['C=[C][CH]C(C=O)OO(7266)'],
    products = ['S(221)(220)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH]=C[CH]C(C=O)OO(7267)'],
    products = ['S(221)(220)'],
...
reaction(
    label = 'reaction17',
    reactants = ['S(221)(220)'],
    products = ['[O]OC(C=O)C1[CH]C1(7268)'],
...
reaction(
    label = 'reaction19',
    reactants = ['S(221)(220)'],
    products = ['C=C[CH]C1[CH]OOO1(7270)'],
...
reaction(
    label = 'reaction20',
    reactants = ['S(221)(220)'],
    products = ['O=CC1[CH][CH]COO1(7271)'],
...
reaction(
    label = 'reaction24',
    reactants = ['CO(10)(11)', 'C=C[CH]CO[O](4828)'],
    products = ['S(221)(220)'],
...
reaction(
    label = 'reaction25',
    reactants = ['S(221)(220)'],
    products = ['O(4)(4)', 'C=CC1OC1C=O(7274)'],
...
reaction(
    label = 'reaction26',
    reactants = ['C=CC([CH]O[O])C=O(7275)'],
    products = ['S(221)(220)'],
...
reaction(
    label = 'reaction27',
    reactants = ['S(221)(220)'],
    products = ['HO2(8)(9)', 'C=CC=C[C]=O(6615)'],
...
reaction(
    label = 'reaction30',
    reactants = ['C=C[CH]C(=CO)O[O](7277)'],
    products = ['S(221)(220)'],
...
reaction(
    label = 'reaction31',
    reactants = ['O(4)(4)', 'C=C[CH]C([O])C=O(7278)'],
    products = ['S(221)(220)'],
...
reaction(
    label = 'reaction32',
    reactants = ['[CH]=C[CH2](891)', '[O]O[CH]C=O(4102)'],
    products = ['S(221)(220)'],
...
reaction(
    label = 'reaction33',
    reactants = ['S(221)(220)'],
    products = ['[CH2][CH]C1OOC1C=O(7279)'],
...
reaction(
    label = 'reaction37',
    reactants = ['S(221)(220)'],
    products = ['[CH2]C=[C]C(C=O)OO(7283)'],
...
reaction(
    label = 'reaction41',
    reactants = ['S(221)(220)'],
    products = ['O(4)(4)', 'O=CC1C=CCO1(7287)'],
...
reaction(
    label = 'reaction42',
    reactants = ['S(221)(220)'],
    products = ['HO2(8)(9)', 'C=C[C]=CC=O(6612)'],
...
reaction(
    label = 'reaction45',
    reactants = ['CH2(17)(18)', '[CH]=CC(C=O)O[O](7290)'],
    products = ['S(221)(220)'],
