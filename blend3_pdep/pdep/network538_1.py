...
species(
    label = 'C=[C]C=CCOO(2603)',
    structure = SMILES('C=C=C[CH]COO'),
    E0 = (152.651,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([540,610,2055,2950,3100,1380,975,1025,1650,3010,987.5,1337.5,450,1655,3615,1310,387.5,850,1000,2750,2850,1437.5,1250,1305,750,350,3025,407.5,1350,352.5,180,180],'cm^-1')),
        HinderedRotor(inertia=(1.48404,'amu*angstrom^2'), symmetry=1, barrier=(34.121,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.484,'amu*angstrom^2'), symmetry=1, barrier=(34.1201,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.48449,'amu*angstrom^2'), symmetry=1, barrier=(34.1314,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.48429,'amu*angstrom^2'), symmetry=1, barrier=(34.1268,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (99.1079,'amu'),
...
species(
    label = '[CH]=CC=CCOO(2604)',
    structure = SMILES('[CH]=CC=CCOO'),
    E0 = (223.361,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,2995,3010,3025,975,987.5,1000,1300,1337.5,1375,400,450,500,1630,1655,1680,3120,650,792.5,1650,2750,2850,1437.5,1250,1305,750,350,180],'cm^-1')),
        HinderedRotor(inertia=(0.905912,'amu*angstrom^2'), symmetry=1, barrier=(20.8287,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.903427,'amu*angstrom^2'), symmetry=1, barrier=(20.7716,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.904286,'amu*angstrom^2'), symmetry=1, barrier=(20.7913,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.905103,'amu*angstrom^2'), symmetry=1, barrier=(20.8101,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (99.1079,'amu'),
...
species(
    label = 'C=C[CH]C[CH]OO(7065)',
    structure = SMILES('[CH2]C=CC[CH]OO'),
    E0 = (199.212,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,3025,407.5,1350,352.5,2995,3025,975,1000,1300,1375,400,500,1630,1680,3000,3100,440,815,1455,1000,2750,2850,1437.5,1250,1305,750,350,312.89,2071.54],'cm^-1')),
        HinderedRotor(inertia=(0.338702,'amu*angstrom^2'), symmetry=1, barrier=(23.5454,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.339186,'amu*angstrom^2'), symmetry=1, barrier=(23.5395,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.139374,'amu*angstrom^2'), symmetry=1, barrier=(9.69812,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.614171,'amu*angstrom^2'), symmetry=1, barrier=(42.6813,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.95194,'amu*angstrom^2'), symmetry=1, barrier=(66.178,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (100.116,'amu'),
...
species(
    label = '[CH2]C[C]=CCOO(7066)',
    structure = SMILES('[CH2]C[C]=CCOO'),
    E0 = (308.91,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,1685,370,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,341.88,3156.17],'cm^-1')),
        HinderedRotor(inertia=(0.1087,'amu*angstrom^2'), symmetry=1, barrier=(9.01582,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.470695,'amu*angstrom^2'), symmetry=1, barrier=(39.0403,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.108699,'amu*angstrom^2'), symmetry=1, barrier=(9.0159,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.108697,'amu*angstrom^2'), symmetry=1, barrier=(9.01587,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.470677,'amu*angstrom^2'), symmetry=1, barrier=(39.0403,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (100.116,'amu'),
...
species(
    label = 'C[CH]C=[C]COO(7070)',
    structure = SMILES('C[CH]C=[C]COO'),
    E0 = (244.776,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,1685,370,2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1310,387.5,850,1000,2750,2850,1437.5,1250,1305,750,350,279.595,315.69],'cm^-1')),
        HinderedRotor(inertia=(0.296505,'amu*angstrom^2'), symmetry=1, barrier=(17.3268,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00247939,'amu*angstrom^2'), symmetry=1, barrier=(10.8408,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00641737,'amu*angstrom^2'), symmetry=1, barrier=(0.372905,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.790777,'amu*angstrom^2'), symmetry=1, barrier=(42.0335,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.793594,'amu*angstrom^2'), symmetry=1, barrier=(42.0413,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (100.116,'amu'),
...
species(
    label = '[CH2]C=CCCO[O](6673)',
    structure = SMILES('[CH2]C=CCCO[O]'),
    E0 = (162.634,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,3000,3100,440,815,1455,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,180,3806.79],'cm^-1')),
        HinderedRotor(inertia=(0.550503,'amu*angstrom^2'), symmetry=1, barrier=(12.6571,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.55049,'amu*angstrom^2'), symmetry=1, barrier=(12.6569,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(3.81136,'amu*angstrom^2'), symmetry=1, barrier=(87.6306,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.24379,'amu*angstrom^2'), symmetry=1, barrier=(28.5971,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.11992,0.063438,-5.17592e-05,2.31362e-08,-4.36012e-12,19663.9,26.7264], Tmin=(100,'K'), Tmax=(1228.63,'K')), NASAPolynomial(coeffs=[10.6475,0.0324195,-1.38897e-05,2.58791e-09,-1.78997e-13,17322.7,-21.2004], Tmin=(1228.63,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(162.634,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Allyl_P) + radical(ROOJ)"""),
)

species(
    label = '[CH2]CC=C[CH]OO(7072)',
    structure = SMILES('[CH2]CC=C[CH]OO'),
    E0 = (188.363,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,3025,407.5,1350,352.5,2995,3025,975,1000,1300,1375,400,500,1630,1680,3000,3100,440,815,1455,1000,2750,2850,1437.5,1250,1305,750,350,437.393,437.4],'cm^-1')),
        HinderedRotor(inertia=(0.0210087,'amu*angstrom^2'), symmetry=1, barrier=(2.85094,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0210898,'amu*angstrom^2'), symmetry=1, barrier=(2.85336,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.235265,'amu*angstrom^2'), symmetry=1, barrier=(31.9582,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.234893,'amu*angstrom^2'), symmetry=1, barrier=(31.9575,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.235347,'amu*angstrom^2'), symmetry=1, barrier=(31.9573,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (100.116,'amu'),
...
species(
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.01131,0.0530507,-9.33707e-06,-2.48315e-08,1.26504e-11,15060,26.6216], Tmin=(100,'K'), Tmax=(1031.53,'K')), NASAPolynomial(coeffs=[14.9457,0.0265758,-1.09131e-05,2.08655e-09,-1.50299e-13,10719,-48.1433], Tmin=(1031.53,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(124.23,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(C=CCJO) + radical(Allyl_S)"""),
)

species(
    label = '[CH2]CC=CCO[O](7075)',
    structure = SMILES('[CH2]CC=CCO[O]'),
    E0 = (223.073,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,3000,3100,440,815,1455,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,311.824,1766.85],'cm^-1')),
        HinderedRotor(inertia=(0.123901,'amu*angstrom^2'), symmetry=1, barrier=(8.54134,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.12387,'amu*angstrom^2'), symmetry=1, barrier=(8.54288,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.123982,'amu*angstrom^2'), symmetry=1, barrier=(8.5434,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.123955,'amu*angstrom^2'), symmetry=1, barrier=(8.54471,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (100.116,'amu'),
...
reaction(
    label = 'reaction4',
    reactants = ['CH2OOH(33)(34)', 'CH2CHCHCH(913)'],
    products = ['S(214)(213)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)(3)', 'C=CC=C[CH]OO(2600)'],
    products = ['S(214)(213)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['H(3)(3)', 'C=CC=[C]COO(2601)'],
    products = ['S(214)(213)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['C2H3(28)(29)', '[CH]=CCOO(7064)'],
    products = ['S(214)(213)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(3)(3)', 'C=C[C]=CCOO(2602)'],
    products = ['S(214)(213)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(3)(3)', 'C=[C]C=CCOO(2603)'],
    products = ['S(214)(213)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(6.117e+14,'cm^3/(mol*s)'), n=-0.152, Ea=(4.19655,'kJ/mol'), T0=(1,'K'), comment="""From training reaction 49 used for Cd_rad/Cd;H_rad
Exact match found for rate rule [Cd_rad/Cd;H_rad]
...
reaction(
    label = 'reaction10',
    reactants = ['H(3)(3)', '[CH]=CC=CCOO(2604)'],
    products = ['S(214)(213)'],
