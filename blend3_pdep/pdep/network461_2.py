...
reaction(
    label = 'reaction3',
    reactants = ['C2H4O(197)(196)'],
    products = ['[CH2][CH]O(1705)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(4.71e+08,'s^-1'), n=1.45, Ea=(176.858,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""Estimated using template [R3Hall;O_rad_out;Cs_H_out_2H] for rate rule [R3HJ;O_rad_out;Cs_H_out_2H]
...
reaction(
    ...
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(2.7e+22,'s^-1'), n=-1.74, Ea=(86355,'cal/mol'), T0=(1,'K'), comment="""Kinetics taken from the arrheniusHigh attribute of a Troe/Lindemann exprssion. Originally from reaction library Klippenstein_Glarborg2016"""),
)
