...
species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.09591,'amu*angstrom^2'), symmetry=1, barrier=(25.1972,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.09689,'amu*angstrom^2'), symmetry=1, barrier=(25.2196,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.09622,'amu*angstrom^2'), symmetry=1, barrier=(25.2044,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.09754,'amu*angstrom^2'), symmetry=1, barrier=(25.2346,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (108.138,'amu'),
...
species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.36826,'amu*angstrom^2'), symmetry=1, barrier=(31.4591,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.35833,'amu*angstrom^2'), symmetry=1, barrier=(31.2306,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.35975,'amu*angstrom^2'), symmetry=1, barrier=(31.2634,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.36162,'amu*angstrom^2'), symmetry=1, barrier=(31.3062,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (108.138,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.340421,0.0607607,5.3354e-06,-6.54919e-08,3.42071e-11,34443,27.7947], Tmin=(100,'K'), Tmax=(921.225,'K')), NASAPolynomial(coeffs=[22.9275,0.0139611,-1.95116e-06,1.99755e-10,-1.64131e-14,28105.7,-91.1305], Tmin=(921.225,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(285.127,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)HHH) + group(Cds-Cds(Cds-Cds)(Cds-Cds)) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C=CC=CCJ) + radical(Cds_P)"""),
)

species(
    label = '[CH]=C(C=C[CH2])C=CO(2525)',
...
species(
    label = 'OC1[CH]C2[CH]C1CC=2(2533)',
...
reaction(
    label = 'reaction1078',
    reactants = ['OH(5)(5)', '[CH]=CC1C=CCC=1(2499)'],
...
reaction(
    label = 'reaction1079',
    reactants = ['H(3)(3)', '[O]C=CC1C=CCC=1(2500)'],
    products = ['C7H8O(612)(611)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction1081',
    reactants = ['CHCHOH(49)(49)', '[C]1=CCC=C1(2501)'],
    products = ['C7H8O(612)(611)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction1082',
    reactants = ['H(3)(3)', 'OC=CC1=[C]CC=C1(2502)'],
    products = ['C7H8O(612)(611)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction1083',
    reactants = ['H(3)(3)', 'OC=CC1C=[C]CC=1(2503)'],
    products = ['C7H8O(612)(611)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(1e+13,'cm^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""From training reaction 40 used for Cd_rad/NonDe;H_rad
Exact match found for rate rule [Cd_rad/NonDe;H_rad]
...
reaction(
    label = 'reaction1084',
    reactants = ['H(3)(3)', 'OC=CC1[C]=CCC=1(2504)'],
    products = ['C7H8O(612)(611)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction1085',
    reactants = ['H(3)(3)', 'OC=[C]C1C=CCC=1(2505)'],
    products = ['C7H8O(612)(611)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(6.117e+14,'cm^3/(mol*s)'), n=-0.152, Ea=(4.19655,'kJ/mol'), T0=(1,'K'), comment="""From training reaction 49 used for Cd_rad/Cd;H_rad
Exact match found for rate rule [Cd_rad/Cd;H_rad]
...
reaction(
    label = 'reaction1086',
    reactants = ['H(3)(3)', 'O[C]=CC1C=CCC=1(2506)'],
    products = ['C7H8O(612)(611)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(1e+13,'cm^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""From training reaction 40 used for Cd_rad/NonDe;H_rad
Exact match found for rate rule [Cd_rad/NonDe;H_rad]
...
reaction(
    label = 'reaction1090',
    reactants = ['OC=CC1[C]=CC[CH]1(2508)'],
    products = ['C7H8O(612)(611)'],
...
reaction(
    label = 'reaction1091',
    reactants = ['OC=[C]C1[CH]CC=C1(2509)'],
    products = ['C7H8O(612)(611)'],
...
reaction(
    label = 'reaction1092',
    reactants = ['OC=CC1=[C]CC[CH]1(2510)'],
    products = ['C7H8O(612)(611)'],
...
reaction(
    label = 'reaction1093',
    reactants = ['OC=C[C]1C=[C]CC1(2511)'],
    products = ['C7H8O(612)(611)'],
...
reaction(
    label = 'reaction1095',
    reactants = ['O[CH]CC1=[C]CC=C1(2512)'],
    products = ['C7H8O(612)(611)'],
...
reaction(
    label = 'reaction1096',
    reactants = ['O[CH]CC1[C]=CCC=1(2513)'],
    products = ['C7H8O(612)(611)'],
...
reaction(
    label = 'reaction1098',
    reactants = ['OC=CC1[CH]C[C]=C1(2514)'],
    products = ['C7H8O(612)(611)'],
...
reaction(
    label = 'reaction1100',
    reactants = ['OC[CH]C1=[C]CC=C1(2515)'],
    products = ['C7H8O(612)(611)'],
...
reaction(
    label = 'reaction1102',
    reactants = ['OC=[C]C1[CH]CCC=1(2517)'],
    products = ['C7H8O(612)(611)'],
...
reaction(
    label = 'reaction1107',
    reactants = ['O[CH]CC1C=[C]CC=1(2518)'],
    products = ['C7H8O(612)(611)'],
...
reaction(
    label = 'reaction1112',
    reactants = ['O[C]=CC1[CH]CCC=1(2520)'],
    products = ['C7H8O(612)(611)'],
...
reaction(
    label = 'reaction1115',
    reactants = ['[O]C=CC1[CH]CCC=1(2521)'],
    products = ['C7H8O(612)(611)'],
...
reaction(
    label = 'reaction1117',
    reactants = ['OC1C=C2C3CC3C21(2522)'],
    products = ['C7H8O(612)(611)'],
...
reaction(
    label = 'reaction1119',
    reactants = ['[CH]=CC(C=CO)=C[CH2](2524)'],
    products = ['C7H8O(612)(611)'],
...
reaction(
    label = 'reaction1120',
    reactants = ['[CH]=C(C=C[CH2])C=CO(2525)'],
    products = ['C7H8O(612)(611)'],
...
reaction(
    label = 'reaction1126',
    reactants = ['[OH+]=[C-]CC1C=CCC=1(2530)'],
    products = ['C7H8O(612)(611)'],
...
reaction(
    label = 'reaction1129',
    reactants = ['OC1[CH]C2[CH]C1CC=2(2533)'],
    products = ['C7H8O(612)(611)'],
