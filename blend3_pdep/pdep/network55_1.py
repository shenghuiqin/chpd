...
reaction(
    label = 'reaction1',
    reactants = ['O2(2)(2)', 'OH(5)(5)'],
    products = ['[O]OO(1615)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(6.10333e+07,'m^3/(mol*s)'), n=0.045, Ea=(20.7891,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [O_pri_rad;Y_rad] for rate rule [O_pri_rad;O2_birad]
Euclidian distance = 1.0
Multiplied by reaction path degeneracy 2.0
family: R_Recombination
Ea raised from 14.4 to 20.8 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction2',
    reactants = ['H(3)(3)', '[O]O[O](4614)'],
    products = ['[O]OO(1615)'],
    transitionState = 'TS2',
