...
species(
    ...
    molecularWeight = (122.164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.641984,0.00671006,0.000260894,-3.91449e-07,1.64974e-10,18525.7,26.87], Tmin=(100,'K'), Tmax=(909.19,'K')), NASAPolynomial(coeffs=[47.3631,-0.023678,2.20422e-05,-4.41007e-09,2.83684e-13,2790.3,-233.898], Tmin=(909.19,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(152.503,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(448.981,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-OsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(1,4-Cycloheptadiene) + radical(C=CCJCO) + radical(Allyl_S)"""),
)
...
species(
    ...
    molecularWeight = (122.164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.395939,0.0840288,-5.66488e-05,1.30701e-08,8.96762e-13,43290.6,19.5466], Tmin=(100,'K'), Tmax=(1112.68,'K')), NASAPolynomial(coeffs=[19.1043,0.0329278,-1.33751e-05,2.4901e-09,-1.74432e-13,37774.8,-81.8985], Tmin=(1112.68,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(358.533,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(448.981,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-OsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + ring(1,3-Cycloheptadiene) + radical(CCJCO) + radical(Cds_S)"""),
)

species(
    label = 'COC1[CH]CC=[C]C=C1(8649)',
    structure = SMILES('COC1[CH]CC=[C]C=C1'),
    E0 = (319.687,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2816.67,2883.33,2950,3016.67,3083.33,3150,900,933.333,966.667,1000,1033.33,1066.67,1100,2750,2800,2850,1350,1500,750,1050,1375,1000,300,800,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
...
species(
    label = '[CH2]OC1[CH]C2C=CCC21(8650)',
...
species(
    label = '[CH2]OC1C=CC2[CH]CC21(8651)',
...
species(
    label = '[CH2]OC1C=C[CH]C2CC21(8653)',
...
species(
    label = '[CH2]OC1C2[CH]C=CCC21(8654)',
...
species(
    ...
    molecularWeight = (122.164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.606225,0.0819032,-2.81202e-05,-3.61668e-08,2.36853e-11,47031.6,36.3739], Tmin=(100,'K'), Tmax=(948.132,'K')), NASAPolynomial(coeffs=[25.3428,0.0200462,-5.59234e-06,9.62881e-10,-7.17546e-14,39970.7,-98.7201], Tmin=(948.132,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(389.517,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-OsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(Cds_P) + radical(C=COCJ)"""),
)

species(
    label = 'COC1C=CC=CCC=1(8660)',
...
species(
    label = '[CH2]OC1[CH]CCC=CC=1(8661)',
...
species(
    label = '[CH2]OC1[CH]CC2C=CC21(8662)',
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)(3)', '[CH2]OC1C=CC=CCC=1(8644)'],
    products = ['[CH2]OC1[CH]CC=CC=C1(8448)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2]OC1[CH]CC=CC=C1(8448)'],
    products = ['CO[C]1[CH]CC=CC=C1(8645)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction10',
    reactants = ['COC1[C]=CC=CC[CH]1(8646)'],
    products = ['[CH2]OC1[CH]CC=CC=C1(8448)'],
...
reaction(
    label = 'reaction14',
    reactants = ['COC1[CH]CC=C[C]=C1(8647)'],
    products = ['[CH2]OC1[CH]CC=CC=C1(8448)'],
...
reaction(
    label = 'reaction15',
    reactants = ['COC1[CH]C[C]=CC=C1(8648)'],
    products = ['[CH2]OC1[CH]CC=CC=C1(8448)'],
...
reaction(
    label = 'reaction16',
    reactants = ['COC1[CH]CC=[C]C=C1(8649)'],
    products = ['[CH2]OC1[CH]CC=CC=C1(8448)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2]OC1[CH]CC=CC=C1(8448)'],
    products = ['[CH2]OC1[CH]C2C=CCC21(8650)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2]OC1[CH]CC=CC=C1(8448)'],
    products = ['[CH2]OC1C=CC2[CH]CC21(8651)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH2]OC1[CH]CC=CC=C1(8448)'],
    products = ['[CH2]OC1C=C[CH]C2CC21(8653)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH2]OC1[CH]CC=CC=C1(8448)'],
    products = ['[CH2]OC1C2[CH]C=CCC21(8654)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH2]OC1[CH]CC=CC=C1(8448)'],
    products = ['[CH]1C[CH]C2C=CC1CO2(8655)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[CH]=CC=CC(C=C)O[CH2](8658)'],
    products = ['[CH2]OC1[CH]CC=CC=C1(8448)'],
...
reaction(
    label = 'reaction27',
    reactants = ['[CH]=CC=CCC=CO[CH2](8659)'],
    products = ['[CH2]OC1[CH]CC=CC=C1(8448)'],
...
reaction(
    label = 'reaction30',
    reactants = ['[CH2]OC1[CH]CC=CC=C1(8448)'],
    products = ['[CH2]OC1[CH]CCC=CC=1(8661)'],
...
reaction(
    label = 'reaction31',
    reactants = ['[CH2]OC1[CH]CC=CC=C1(8448)'],
    products = ['[CH2]O[CH]C1C=CC=CC1(8634)'],
...
reaction(
    label = 'reaction32',
    reactants = ['[CH2]OC1[CH]CC=CC=C1(8448)'],
    products = ['[CH2]OC1C=CC=CC1[CH2](8642)'],
...
reaction(
    label = 'reaction34',
    reactants = ['[CH2]OC1[CH]CC=CC=C1(8448)'],
    products = ['[CH2]OC1[CH]CC2C=CC21(8662)'],
...
reaction(
    label = 'reaction35',
    reactants = ['CH2(17)(18)', '[O]C1[CH]CC=CC=C1(2109)'],
    products = ['[CH2]OC1[CH]CC=CC=C1(8448)'],
