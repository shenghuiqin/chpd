...
species(
    label = '[CH]1C=CC2=C[CH]C1O2(9160)',
...
species(
    label = '[CH]1[CH]C2C=C(C=C1)O2(4721)',
...
species(
    label = 'O=C1C=CC2[CH][CH]C12(4745)',
...
species(
    label = '[C]1=CC=C[CH]C=C1(4804)',
    structure = SMILES('[C]1=CC=C[CH]C=C1'),
    E0 = (466.224,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2830,2910,2990,3070,3150,900,940,980,1020,1060,1100,300,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
    ],
...
species(
    ...
    molecularWeight = (106.122,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.547637,0.0813027,-8.10564e-05,3.96784e-08,-7.32736e-12,34867.5,23.6532], Tmin=(100,'K'), Tmax=(1504.38,'K')), NASAPolynomial(coeffs=[21.4039,0.0126043,-2.2568e-06,1.93329e-10,-7.06645e-15,29431.9,-87.3294], Tmin=(1504.38,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(288.411,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(332.579,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)O2s) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + ring(1,3,5-Cycloheptatriene) + radical(C=CJC=C) + radical(C=C(C)OJ)"""),
)

species(
    label = '[O]C1[C]=CC=CCC=1(9170)',
...
species(
    ...
    molecularWeight = (106.122,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.88186,0.027015,5.92992e-05,-9.60374e-08,3.82109e-11,52434.7,23.1616], Tmin=(100,'K'), Tmax=(972.559,'K')), NASAPolynomial(coeffs=[14.9959,0.0218216,-7.86791e-06,1.53622e-09,-1.17322e-13,47578.7,-51.5922], Tmin=(972.559,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(435.187,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(332.579,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + polycyclic(s2_3_6_diene_1_3) + radical(C=CC(C)2OJ) + radical(CCJCO)"""),
)

species(
    label = 'O=C1[CH]C2[CH]C=CC12(4791)',
...
species(
    ...
    molecularWeight = (106.122,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.47362,0.0402873,2.05735e-05,-5.51906e-08,2.3534e-11,51890.7,20.0185], Tmin=(100,'K'), Tmax=(992.872,'K')), NASAPolynomial(coeffs=[14.7307,0.0233913,-9.06327e-06,1.74824e-09,-1.29144e-13,47458.5,-52.9075], Tmin=(992.872,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(430.575,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(332.579,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsOsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + polycyclic(s2_3_6_diene_1_3) + radical(C2CsJOH) + radical(CC(C)OJ)"""),
)

species(
    label = '[O]C1[CH]C=C=CC=C1(9179)',
    structure = SMILES('[O]C1C=C[C]=CC=C1'),
    E0 = (417.026,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2830,2910,2990,3070,3150,900,940,980,1020,1060,1100,300,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
...
species(
    label = '[CH]=C[CH]C=CC=C=O(9180)',
    structure = SMILES('[CH]=CC=C[CH]C=C=O'),
    E0 = (402.265,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,2995,3005,3015,3025,975,983.333,991.667,1000,1300,1325,1350,1375,400,433.333,466.667,500,1630,1646.67,1663.33,1680,2120,512.5,787.5,3025,407.5,1350,352.5,180,180],'cm^-1')),
        HinderedRotor(inertia=(1.17299,'amu*angstrom^2'), symmetry=1, barrier=(26.9694,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.17285,'amu*angstrom^2'), symmetry=1, barrier=(26.9661,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.17263,'amu*angstrom^2'), symmetry=1, barrier=(26.9611,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (106.122,'amu'),
...
species(
    ...
    molecularWeight = (106.122,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.56797,0.0366251,3.02489e-05,-5.76529e-08,2.01373e-11,14661.2,12.1662], Tmin=(100,'K'), Tmax=(1173.79,'K')), NASAPolynomial(coeffs=[18.2192,0.0271357,-1.80107e-05,4.05366e-09,-3.10037e-13,7496.94,-84.7008], Tmin=(1173.79,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(121.058,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(332.579,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsOsH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)O2s) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + Estimated bicyclic component: polycyclic(s3_5_6_ane) - ring(Oxane) - ring(Tetrahydrofuran) + ring(36dihydro2hpyran) + ring(2,3-Dihydrofuran) + polycyclic(s2_3_6_ene_1) + polycyclic(s2_3_5_ene_1) - ring(2,3-Dihydrofuran) - ring(36dihydro2hpyran) - ring(Cyclopropane)"""),
)

species(
    label = 'C1=C[C]2C=CC(=C1)O2(9186)',
...
species(
    label = '[C]1=CC2C[CH]C(=C1)O2(9208)',
...
species(
    label = '[C]1=CC2[CH]CC(=C1)O2(9209)',
...
species(
    label = '[C]1[CH]C2C=CC(C=1)O2(9211)',
...
species(
    ...
    molecularWeight = (106.122,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.71057,0.0286191,2.27716e-05,-3.36386e-08,9.35046e-12,54795.3,17.8002], Tmin=(100,'K'), Tmax=(1436.88,'K')), NASAPolynomial(coeffs=[12.7701,0.0363718,-2.26489e-05,4.7537e-09,-3.42578e-13,48213.3,-47.222], Tmin=(1436.88,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(455.216,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(332.579,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsOsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + polycyclic(s3_5_6_ene_1) + polycyclic(s2_3_6_ene_1) + polycyclic(s2_3_5_ane) - ring(36dihydro2hpyran) - ring(Tetrahydrofuran) - ring(Cyclopropane) + radical(C2CsJOCs) + radical(CCJCO)"""),
)

species(
    label = '[CH]1C2C=C3[CH]C2C1O3(9229)',
    ...
    molecularWeight = (106.122,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.72727,0.0256653,7.04463e-05,-1.08491e-07,4.11067e-11,80704.6,20.1489], Tmin=(100,'K'), Tmax=(1023.37,'K')), NASAPolynomial(coeffs=[18.7998,0.0198769,-1.03954e-05,2.36346e-09,-1.895e-13,74019.1,-78.2025], Tmin=(1023.37,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(670.159,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(332.579,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + polycyclic(s3_5_5_ene_0) + polycyclic(s2_4_5_ane) + polycyclic(s2_4_5_ene_1) - ring(Cyclobutane) - ring(Tetrahydrofuran) - ring(Cyclopentene) + radical(CCJCO) + radical(CCJCO)"""),
)

species(
    label = 'C1=CC23CC2C=C1O3(9230)',
...
species(
    ...
    molecularWeight = (106.122,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.35588,0.044414,1.98554e-06,-3.0877e-08,1.27997e-11,48323.6,17.5007], Tmin=(100,'K'), Tmax=(1123.71,'K')), NASAPolynomial(coeffs=[15.9386,0.0239285,-1.26151e-05,2.6705e-09,-2.00234e-13,43062.3,-63.3809], Tmin=(1123.71,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(400.898,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(332.579,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-Cds(Cds-Cds)O2s) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + Estimated bicyclic component: polycyclic(s3_5_6_ane) - ring(Oxane) - ring(Tetrahydrofuran) + ring(36dihydro2hpyran) + ring(2,3-Dihydrofuran) + radical(Cds_S) + radical(C2CsJOC(O))"""),
)

species(
    label = '[C]1=CC2=C[CH]C(C1)O2(9237)',
...
species(
    label = '[C]1C=C2C[CH]CC=1O2(9238)',
    structure = SMILES('[C]1C=C2C[CH]CC=1O2'),
    E0 = (331.7,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2830,2910,2990,3070,3150,900,940,980,1020,1060,1100,304.887,814.268,814.268,814.268,814.268,814.268,814.268,814.268,814.268,814.268,814.268,814.268,1626.66,1626.66,1626.66,1626.66,1626.66,1626.66,1626.66,1626.66,1626.66,1626.66,1626.66,1626.66],'cm^-1')),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (106.122,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.9335,0.022054,3.18602e-05,-3.78752e-08,1.03147e-11,39933.2,20.9868], Tmin=(100,'K'), Tmax=(1377.87,'K')), NASAPolynomial(coeffs=[7.244,0.0404697,-2.18587e-05,4.40751e-09,-3.1297e-13,35809.4,-11.8446], Tmin=(1377.87,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(331.7,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(332.579,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsOs) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + Estimated bicyclic component: polycyclic(s3_5_6_ane) - ring(Oxane) - ring(Tetrahydrofuran) + ring(Oxane) + ring(Furan) + radical(RCCJCC) + radical(C=CJC=C)"""),
)

species(
    label = '[C]1=CC2=CC[C](C1)O2(9239)',
    structure = SMILES('[C]1=CC2=CC[C](C1)O2'),
    E0 = (400.898,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2830,2910,2990,3070,3150,900,940,980,1020,1060,1100,300,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
...
species(
    label = '[C]1=C[C]2CC=C(C1)O2(9241)',
...
species(
    label = '[CH]=CC1=CC=C([CH2])O1(9249)',
    structure = SMILES('[CH]=CC1=CC=C([CH2])O1'),
    E0 = (363.694,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,3150,900,1100,3120,650,792.5,1650,3010,987.5,1337.5,450,1655,300,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
...
species(
    label = '[CH]=CCC1=CC=[C]O1(9250)',
    structure = SMILES('[CH]=CCC1=CC=[C]O1'),
    E0 = (480.476,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,3150,900,1100,3120,650,792.5,1650,3010,987.5,1337.5,450,1655,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
...
species(
    label = '[CH2]C=CC1=CC=[C]O1(9251)',
    structure = SMILES('[CH2]C=CC1=CC=[C]O1'),
    E0 = (321.247,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,2750,3150,900,1100,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    ...
    molecularWeight = (106.122,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.7364,0.0386023,1.12981e-05,-3.62545e-08,1.4739e-11,38728.3,26.6325], Tmin=(100,'K'), Tmax=(1042.6,'K')), NASAPolynomial(coeffs=[10.8726,0.0292035,-1.20865e-05,2.29759e-09,-1.64001e-13,35429,-24.5117], Tmin=(1042.6,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(321.247,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(324.264,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cs-(Cds-Cds)HHH) + group(Cds-Cds(Cds-Cds)O2s) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsOsH) + ring(Furan) + radical(C=CJO) + radical(C=CC=CCJ)"""),
)

species(
    label = 'O=C1CC=CC2=CC12(9252)',
...
species(
    ...
    molecularWeight = (106.122,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.44753,0.0390488,2.29161e-05,-5.38176e-08,2.06525e-11,80745.6,20.1634], Tmin=(100,'K'), Tmax=(1094.67,'K')), NASAPolynomial(coeffs=[16.9836,0.0238517,-1.3226e-05,2.8866e-09,-2.20841e-13,74853.4,-67.5713], Tmin=(1094.67,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(670.473,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(332.579,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + polycyclic(s3_5_5_ene_0) + polycyclic(s2_4_5_ene_1) + polycyclic(s2_4_5_ane) - ring(Cyclopentene) - ring(Cyclobutane) - ring(Tetrahydrofuran) + radical(C2CsJOC(O)) + radical(CCJCO)"""),
)

species(
    label = '[CH]1CC2=CC3[C](O2)C13(9262)',
    ...
    molecularWeight = (106.122,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.2951,0.0337282,1.75648e-05,-3.39391e-08,1.01471e-11,53343.4,18.084], Tmin=(100,'K'), Tmax=(1393.97,'K')), NASAPolynomial(coeffs=[16.3781,0.0318529,-2.18847e-05,4.75956e-09,-3.50006e-13,45673.1,-67.9658], Tmin=(1393.97,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(442.992,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(332.579,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + Estimated bicyclic component: polycyclic(s3_5_6_ane) - ring(Oxane) - ring(Tetrahydrofuran) + ring(Oxane) + ring(2,3-Dihydrofuran) + polycyclic(s2_3_6_ane) + polycyclic(s2_3_5_ene_1) - ring(2,3-Dihydrofuran) - ring(Oxane) - ring(Cyclopropane) + radical(Cs_S) + radical(C2CsJOC(O))"""),
)

species(
    label = '[CH]=CC=CC(=O)C=[CH](9263)',
...
species(
    label = 'O=C1C=CC2[CH]C[C]12(9273)',
...
species(
    label = 'O=C1C=C[C]2C[CH]C21(4743)',
...
species(
    label = 'O=C1[CH]C[C]2C=CC21(9275)',
...
species(
    ...
    molecularWeight = (106.122,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.83294,0.040476,-4.69395e-06,-1.29431e-08,5.0926e-12,59217.3,20.5968], Tmin=(100,'K'), Tmax=(1236.88,'K')), NASAPolynomial(coeffs=[9.30364,0.0323493,-1.42822e-05,2.70479e-09,-1.88382e-13,56142.8,-21.9909], Tmin=(1236.88,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(491.664,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(332.579,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-O2d)CsCsH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cds-OdCsCs) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + Estimated bicyclic component: polycyclic(s2_4_5_ane) - ring(Cyclopentane) - ring(Cyclobutane) + ring(Cyclopentane) + ring(Cyclobutene) + radical(CCJCC=O) + radical(cyclobutene-vinyl)"""),
)

species(
    label = '[O]C1C=CC2[C]=CC12(9292)',
    structure = SMILES('[O]C1C=CC2[C]=CC12'),
    E0 = (570.341,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2830,2910,2990,3070,3150,900,940,980,1020,1060,1100,300,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
...
species(
    ...
    molecularWeight = (106.122,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.946,0.0388567,-2.10413e-07,-1.60622e-08,5.55063e-12,53995.1,21.7793], Tmin=(100,'K'), Tmax=(1314.62,'K')), NASAPolynomial(coeffs=[10.0514,0.03347,-1.6058e-05,3.12795e-09,-2.1982e-13,50198.3,-25.8769], Tmin=(1314.62,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(448.285,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(332.579,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)CsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cds-O2d(Cds-Cds)Cs) + group(Cds-CdsCsH) + group(Cd-Cd(CO)H) + polycyclic(s2_4_5_ene_1) + radical(cyclobutane) + radical(C=CJC=O)"""),
)

species(
    label = 'O=C1[C]=CC2C[CH]C12(4747)',
...
species(
    label = '[CH]=CC1C=CC1[C]=O(9299)',
    structure = SMILES('[CH]=CC1C=CC1[C]=O'),
    E0 = (508.479,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1855,455,950,2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,3120,650,792.5,1650,3010,987.5,1337.5,450,1655,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    ...
    molecularWeight = (106.122,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.948994,0.0602501,-4.62752e-05,1.80952e-08,-2.85625e-12,61271.3,26.2366], Tmin=(100,'K'), Tmax=(1492.36,'K')), NASAPolynomial(coeffs=[14.5276,0.0238552,-9.69406e-06,1.75368e-09,-1.18721e-13,57218.5,-44.7085], Tmin=(1492.36,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(508.479,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(324.264,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)CsH) + group(Cs-(Cds-O2d)CsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-OdCsH) + group(Cds-CdsHH) + ring(Cyclobutene) + radical(Cds_P) + radical(CC(C)CJ=O)"""),
)

species(
    label = '[CH]=CC(=O)C1[CH]C=C1(9300)',
...
species(
    label = '[CH]1C2O[C]3C=CC2C13(9310)',
...
species(
    label = 'O=C1C2[CH]C3C1[CH]C23(9312)',
...
species(
    ...
    molecularWeight = (106.122,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.71738,0.0270302,6.55716e-05,-1.01128e-07,3.77632e-11,58976.1,16.9095], Tmin=(100,'K'), Tmax=(1039.05,'K')), NASAPolynomial(coeffs=[18.0258,0.022546,-1.21153e-05,2.71437e-09,-2.13984e-13,52440,-77.5379], Tmin=(1039.05,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(489.505,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(332.579,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + polycyclic(s2_4_5_ene_0) + polycyclic(s2_4_5_ene_1) + polycyclic(s2_4_4_ane) - ring(Oxetane) - ring(Cyclobutane) - ring(Cyclopentene) + radical(cyclopentene-allyl) + radical(CCJCO)"""),
)

species(
    label = 'O=C1[CH]C2C3[CH]C1C23(9314)',
    ...
    molecularWeight = (106.122,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.90312,0.0356746,1.43165e-05,-3.49763e-08,1.30675e-11,48602,17.2518], Tmin=(100,'K'), Tmax=(1096.8,'K')), NASAPolynomial(coeffs=[9.7638,0.0316699,-1.3936e-05,2.69791e-09,-1.92838e-13,45394.2,-28.1604], Tmin=(1096.8,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(403.399,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(332.579,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + polycyclic(s2_4_5_ene_1) + polycyclic(s2_3_5_ene_1) + polycyclic(s2_3_4_ane) - ring(Cyclobutane) - ring(Cyclopentene) - ring(Cyclopropane) + radical(bicyclo[2.1.0]pentane-secondary-C4) + radical(C=C(C)OJ)"""),
)

species(
    label = 'O=C1[CH]C2C3[CH]C2C13(9315)',
...
species(
    label = 'C1C=C[C]2C[C](C=1)O2(9323)',
...
species(
    label = '[C]1=CC2=CC([CH]C1)O2(4723)',
...
species(
    label = '[C]1=CC2[CH]C(C=C1)O2(9329)',
...
species(
    label = '[C]1=CCC2[CH]C(=C1)O2(4764)',
...
species(
    label = '[CH]=CC=CC1C=[C]O1(9339)',
    structure = SMILES('[CH]=CC=CC1C=[C]O1'),
    E0 = (601.36,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,2750,3150,900,1100,2995,3010,3025,975,987.5,1000,1300,1337.5,1375,400,450,500,1630,1655,1680,300,800,800,800,800,800,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
...
species(
    label = '[CH]=CC=CC1=C[CH]O1(9340)',
    structure = SMILES('[CH]=C[CH]C=C1C=CO1'),
    E0 = (492.675,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,3025,407.5,1350,352.5,2995,3025,975,1000,1300,1375,400,500,1630,1680,2750,3150,900,1100,300,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    ...
    molecularWeight = (106.122,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.08536,0.0407104,4.58973e-05,-1.02655e-07,4.62932e-11,59381.6,25.317], Tmin=(100,'K'), Tmax=(929.26,'K')), NASAPolynomial(coeffs=[22.2981,0.00938047,-3.49578e-07,-1.68943e-11,-6.4598e-15,52849.5,-89.4001], Tmin=(929.26,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(492.675,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(324.264,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cds-Cds(Cds-Cds)O2s) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsOsH) + group(Cds-CdsHH) + ring(Cyclobutene) + radical(C=CCJC=C) + radical(Cds_P)"""),
)

species(
    label = '[C]1C2C=CC=CC1O2(9341)',
...
species(
    ...
    molecularWeight = (106.122,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.28636,0.0384562,3.62778e-05,-7.4098e-08,2.90326e-11,30748.7,16.4467], Tmin=(100,'K'), Tmax=(1053.3,'K')), NASAPolynomial(coeffs=[19.6481,0.020322,-1.13749e-05,2.56895e-09,-2.02459e-13,24018.5,-86.678], Tmin=(1053.3,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(254.695,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(332.579,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)(Cds-Cds)CsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + polycyclic(s2_4_5_ene_1) + polycyclic(s2_4_5_diene_1_5) + Estimated bicyclic component: polycyclic(s2_4_4_ane) - ring(Oxetane) - ring(Cyclobutane) + ring(Cyclobutene) + ring(Oxetane) - ring(Oxetane) - ring(Cyclobutene) - ring(Cyclopentene)"""),
)

species(
    label = 'C1=CC2C3C=C(O3)C12(9347)',
...
species(
    label = '[CH]1C2[CH]C3(C=CC13)O2(9348)',
...
reaction(
    label = 'reaction51',
    reactants = ['C7H6O(488)(487)'],
    products = ['[CH]1C=CC2=C[CH]C1O2(9160)'],
...
reaction(
    label = 'reaction52',
    reactants = ['C7H6O(488)(487)'],
    products = ['[CH]1[CH]C2C=C(C=C1)O2(4721)'],
...
reaction(
    label = 'reaction53',
    reactants = ['H(3)(3)', '[O]C1C=C=CC=CC=1(9161)'],
...
reaction(
    label = 'reaction54',
    reactants = ['H(3)(3)', '[O]C1C=CC=C=CC=1(9162)'],
    products = ['C7H6O(488)(487)'],
...
reaction(
    label = 'reaction55',
    reactants = ['[O]C1C=[C]CC=CC=1(4673)'],
    products = ['C7H6O(488)(487)'],
...
reaction(
    label = 'reaction56',
    reactants = ['[O]C1C=CC[C]=CC=1(4672)'],
    products = ['C7H6O(488)(487)'],
...
reaction(
    label = 'reaction57',
    reactants = ['[O]C1[C]=CCC=CC=1(4675)'],
    products = ['C7H6O(488)(487)'],
...
reaction(
    label = 'reaction58',
    reactants = ['OC1[C]=C[CH]C=CC=1(4805)'],
    products = ['C7H6O(488)(487)'],
...
reaction(
    label = 'reaction59',
    reactants = ['[O]C1C=CCC=[C]C=1(4674)'],
    products = ['C7H6O(488)(487)'],
...
reaction(
    label = 'reaction60',
    reactants = ['OC1C=[C][CH]C=CC=1(4807)'],
    products = ['C7H6O(488)(487)'],
...
reaction(
    label = 'reaction61',
    reactants = ['[O]C1=[C]C=CCC=C1(4676)'],
    products = ['C7H6O(488)(487)'],
...
reaction(
    label = 'reaction62',
    reactants = ['OC1C=C[CH][C]=CC=1(4806)'],
    products = ['C7H6O(488)(487)'],
...
reaction(
    label = 'reaction63',
    reactants = ['C7H6O(488)(487)'],
    products = ['[O]C1=CC=CC2[CH]C12(9163)'],
...
reaction(
    label = 'reaction64',
    reactants = ['C7H6O(488)(487)'],
    products = ['[CH]1[CH]C=C2OC2C=C1(4533)'],
...
reaction(
    label = 'reaction65',
    reactants = ['C7H6O(488)(487)'],
    products = ['[O]C1C=CC2[CH]C2C=1(4695)'],
...
reaction(
    label = 'reaction66',
    reactants = ['C7H6O(488)(487)'],
    products = ['O=C1C=CC2[CH][CH]C12(4745)'],
...
reaction(
    label = 'reaction67',
    reactants = ['C7H6O(488)(487)'],
    products = ['[O]C12[CH]C=CC1C=C2(9164)'],
...
reaction(
    label = 'reaction70',
    reactants = ['[O]C1C=C=C[CH]CC=1(9165)'],
    products = ['C7H6O(488)(487)'],
...
reaction(
    label = 'reaction72',
    reactants = ['O(4)(4)', '[C]1=CC=C[CH]C=C1(4804)'],
    products = ['C7H6O(488)(487)'],
...
reaction(
    label = 'reaction73',
    reactants = ['H(3)(3)', '[O]C1=C=CC=CC=C1(9166)'],
    products = ['C7H6O(488)(487)'],
...
reaction(
    label = 'reaction74',
    reactants = ['[O]C1=[C]CC=CC=C1(9167)'],
    products = ['C7H6O(488)(487)'],
...
reaction(
    label = 'reaction75',
    reactants = ['[O]C1C=CC=[C]CC=1(9168)'],
    products = ['C7H6O(488)(487)'],
...
reaction(
    label = 'reaction76',
    reactants = ['[O]C1C=C[C]=CCC=1(9169)'],
    products = ['C7H6O(488)(487)'],
...
reaction(
    label = 'reaction77',
    reactants = ['[O]C1[C]=CC=CCC=1(9170)'],
    products = ['C7H6O(488)(487)'],
...
reaction(
    label = 'reaction78',
    reactants = ['C7H6O(488)(487)'],
    products = ['[O]C12[CH]C1C=CC=C2(9171)'],
...
reaction(
    label = 'reaction79',
    reactants = ['C7H6O(488)(487)'],
    products = ['O=C1[CH]C2[CH]C=CC12(4791)'],
...
reaction(
    label = 'reaction80',
    reactants = ['C7H6O(488)(487)'],
    products = ['[O]C1[CH]C2C=CC2C=1(9172)'],
...
reaction(
    label = 'reaction83',
    reactants = ['O(4)(4)', 'C1=CC=CC=CC=1(4811)'],
    products = ['C7H6O(488)(487)'],
...
reaction(
    label = 'reaction84',
    reactants = ['[O]C1=CC=CC=[C]C1(9173)'],
    products = ['C7H6O(488)(487)'],
...
reaction(
    label = 'reaction85',
    reactants = ['[O]C1=CC=C[C]=CC1(9174)'],
    products = ['C7H6O(488)(487)'],
...
reaction(
    label = 'reaction86',
    reactants = ['[O]C1=[C]C=CC=CC1(9175)'],
    products = ['C7H6O(488)(487)'],
...
reaction(
    label = 'reaction87',
    reactants = ['[O]C1=CC=[C]C=CC1(9176)'],
    products = ['C7H6O(488)(487)'],
...
reaction(
    label = 'reaction88',
    reactants = ['[O]C1=C[C]=CC=CC1(9177)'],
    products = ['C7H6O(488)(487)'],
...
reaction(
    label = 'reaction89',
    reactants = ['C7H6O(488)(487)'],
    products = ['[O][C]1C2C=CC=CC12(9178)'],
...
reaction(
    label = 'reaction90',
    reactants = ['C7H6O(488)(487)'],
    products = ['[O]C1[CH]C=C=CC=C1(9179)'],
...
reaction(
    label = 'reaction91',
    reactants = ['[CH]=C[CH]C=CC=C=O(9180)'],
    products = ['C7H6O(488)(487)'],
...
reaction(
    label = 'reaction95',
    reactants = ['O=[C]C1C=C[CH]C=C1(9183)'],
    products = ['C7H6O(488)(487)'],
...
reaction(
    label = 'reaction100',
    reactants = ['[O]C1C=[C]C=CC=C1(9184)'],
    products = ['C7H6O(488)(487)'],
...
reaction(
    ...
    products = ['C1=CC2C3C=C1OC23(9185)'],
...
reaction(
    label = 'reaction102',
    reactants = ['H(3)(3)', 'C1=C[C]2C=CC(=C1)O2(9186)'],
    products = ['C7H6O(489)(488)'],
...
reaction(
    label = 'reaction103',
    reactants = ['H(3)(3)', '[C]1=CC2=CC=CC1O2(9187)'],
    products = ['C7H6O(489)(488)'],
...
reaction(
    label = 'reaction104',
    reactants = ['H(3)(3)', '[C]1=CC=C2C=CC1O2(9188)'],
    products = ['C7H6O(489)(488)'],
...
reaction(
    label = 'reaction105',
    reactants = ['H(3)(3)', '[C]1=CC2C=CC=C1O2(9189)'],
    products = ['C7H6O(489)(488)'],
...
reaction(
    label = 'reaction106',
    reactants = ['H(3)(3)', '[C]1C=CC2C=CC=1O2(9190)'],
    products = ['C7H6O(489)(488)'],
...
reaction(
    label = 'reaction107',
    reactants = ['H(3)(3)', '[C]1=CC2C=CC(=C1)O2(9191)'],
    products = ['C7H6O(489)(488)'],
...
reaction(
    label = 'reaction108',
    reactants = ['[CH]1C[C]2C=CC=C1O2(9192)'],
    products = ['C7H6O(489)(488)'],
...
reaction(
    label = 'reaction109',
    reactants = ['[CH]1C=C2C=C[C](C1)O2(9193)'],
    products = ['C7H6O(489)(488)'],
...
reaction(
    label = 'reaction110',
    reactants = ['[C]1=CC2C=C[CH]C1O2(9194)'],
    products = ['C7H6O(489)(488)'],
...
reaction(
    label = 'reaction111',
    reactants = ['[C]1C[CH]C2C=CC=1O2(9195)'],
    products = ['C7H6O(489)(488)'],
...
reaction(
    label = 'reaction112',
    reactants = ['[C]1=CC2C=C[C](C1)O2(9196)'],
    products = ['C7H6O(489)(488)'],
...
reaction(
    label = 'reaction113',
    reactants = ['[CH]1C=CC2=C[CH]C1O2(9160)'],
    products = ['C7H6O(489)(488)'],
...
reaction(
    label = 'reaction114',
    reactants = ['[C]1=CC2=C[CH]CC1O2(9197)'],
    products = ['C7H6O(489)(488)'],
...
reaction(
    label = 'reaction115',
    reactants = ['[C]1=CC=C2[CH]CC1O2(9198)'],
    products = ['C7H6O(489)(488)'],
...
reaction(
    label = 'reaction116',
    reactants = ['[C]1C=CC2[CH]CC=1O2(9199)'],
    products = ['C7H6O(489)(488)'],
...
reaction(
    label = 'reaction117',
    reactants = ['[C]1=CC[C]2C=CC1O2(9200)'],
    products = ['C7H6O(489)(488)'],
...
reaction(
    label = 'reaction118',
    reactants = ['[C]1=CC2=CC[CH]C1O2(9201)'],
    products = ['C7H6O(489)(488)'],
...
reaction(
    label = 'reaction119',
    reactants = ['[C]1=CC=C2C[CH]C1O2(9202)'],
    products = ['C7H6O(489)(488)'],
...
reaction(
    label = 'reaction120',
    reactants = ['[C]1C=CC2C[CH]C=1O2(9203)'],
    products = ['C7H6O(489)(488)'],
...
reaction(
    label = 'reaction121',
    reactants = ['[C]1=C[C]2CC=CC1O2(9204)'],
    products = ['C7H6O(489)(488)'],
...
reaction(
    label = 'reaction122',
    reactants = ['[C]1=C[CH]C2C=CC1O2(9205)'],
    products = ['C7H6O(489)(488)'],
...
reaction(
    label = 'reaction123',
    reactants = ['[C]1=CC2[CH]CC=C1O2(9206)'],
    products = ['C7H6O(489)(488)'],
...
reaction(
    label = 'reaction124',
    reactants = ['[C]1=CC2C[CH]C=C1O2(9207)'],
    products = ['C7H6O(489)(488)'],
...
reaction(
    label = 'reaction125',
    reactants = ['[C]1=CC2C[CH]C(=C1)O2(9208)'],
    products = ['C7H6O(489)(488)'],
...
reaction(
    label = 'reaction126',
    reactants = ['[C]1=CC2[CH]CC(=C1)O2(9209)'],
    products = ['C7H6O(489)(488)'],
...
reaction(
    label = 'reaction127',
    reactants = ['[C]1[CH]CC2C=CC=1O2(9210)'],
    products = ['C7H6O(489)(488)'],
...
reaction(
    label = 'reaction128',
    reactants = ['[C]1[CH]C2C=CC(C=1)O2(9211)'],
    products = ['C7H6O(489)(488)'],
...
reaction(
    label = 'reaction129',
    reactants = ['[CH]1CC=C2C=C[C]1O2(9212)'],
    products = ['C7H6O(489)(488)'],
...
reaction(
    label = 'reaction130',
    reactants = ['[C]1=CC2C=CC[C]1O2(9213)'],
    products = ['C7H6O(489)(488)'],
...
reaction(
    label = 'reaction131',
    reactants = ['C1=CC2=CCC(C=1)O2(9214)'],
    products = ['C7H6O(489)(488)'],
...
reaction(
    label = 'reaction133',
    reactants = ['C1=CC2CC=CC=1O2(9215)'],
    products = ['C7H6O(489)(488)'],
...
reaction(
    label = 'reaction134',
    reactants = ['[CH]=CC1C=CC=[C]O1(9216)'],
    products = ['C7H6O(489)(488)'],
...
reaction(
    label = 'reaction135',
    reactants = ['[CH]=CC1=CC=C[CH]O1(9217)'],
    products = ['C7H6O(489)(488)'],
...
reaction(
    label = 'reaction136',
    reactants = ['[O]C1[CH]C=C=CC=C1(9179)'],
    products = ['C7H6O(489)(488)'],
...
reaction(
    label = 'reaction137',
    reactants = ['[CH]=CC1C=CC(=[CH])O1(9218)'],
    products = ['C7H6O(489)(488)'],
...
reaction(
    label = 'reaction138',
    reactants = ['[CH]=CC=C1C=C[CH]O1(9219)'],
    products = ['C7H6O(489)(488)'],
...
reaction(
    label = 'reaction140',
    reactants = ['[C]1CC2=CC=CC1O2(9220)'],
    products = ['C7H6O(489)(488)'],
...
reaction(
    label = 'reaction141',
    reactants = ['[C]1CC=C2C=CC1O2(9221)'],
    products = ['C7H6O(489)(488)'],
...
reaction(
    label = 'reaction142',
    reactants = ['[C]1CC2C=CC=C1O2(9222)'],
    products = ['C7H6O(489)(488)'],
...
reaction(
    label = 'reaction143',
    reactants = ['[C]1C=CC2C=CC1O2(9223)'],
    products = ['C7H6O(489)(488)'],
...
reaction(
    label = 'reaction144',
    reactants = ['[C]1C=C2C=CC(C1)O2(9224)'],
    products = ['C7H6O(489)(488)'],
...
reaction(
    label = 'reaction145',
    reactants = ['C7H6O(489)(488)'],
    products = ['C1=CC2C3=CC2C1O3(9225)'],
...
reaction(
    label = 'reaction146',
    reactants = ['C7H6O(489)(488)'],
    products = ['C1=CC23C=CC2C1O3(9226)'],
...
reaction(
    label = 'reaction147',
    reactants = ['[CH]1C2[CH]C3C(=CC13)O2(9227)'],
    products = ['C7H6O(489)(488)'],
...
reaction(
    label = 'reaction148',
    reactants = ['[CH]1C2C=CC3[C](O2)C13(9228)'],
    products = ['C7H6O(489)(488)'],
...
reaction(
    label = 'reaction149',
    reactants = ['[CH]1C2C=C3[CH]C2C1O3(9229)'],
    products = ['C7H6O(489)(488)'],
...
reaction(
    ...
    products = ['C1=CC23CC2C=C1O3(9230)'],
...
reaction(
    label = 'reaction152',
    reactants = ['H(3)(3)', '[C]1=CC2=CC=C(C1)O2(9231)'],
    products = ['C7H6O(490)(489)'],
...
reaction(
    label = 'reaction153',
    reactants = ['H(3)(3)', '[C]1=CCC2=CC=C1O2(9232)'],
    products = ['C7H6O(490)(489)'],
...
reaction(
    label = 'reaction154',
    reactants = ['H(3)(3)', '[C]1C=C2C=CCC=1O2(9233)'],
    products = ['C7H6O(490)(489)'],
...
reaction(
    label = 'reaction155',
    reactants = ['H(3)(3)', '[C]1C=C2CC=CC=1O2(9234)'],
    products = ['C7H6O(490)(489)'],
...
reaction(
    label = 'reaction159',
    reactants = ['[C]1C[C]2C=CCC=1O2(9235)'],
    products = ['C7H6O(490)(489)'],
...
reaction(
    label = 'reaction160',
    reactants = ['[C]1C[C]2CC=CC=1O2(9236)'],
    products = ['C7H6O(490)(489)'],
...
reaction(
    label = 'reaction161',
    reactants = ['[C]1=CC2=C[CH]C(C1)O2(9237)'],
    products = ['C7H6O(490)(489)'],
...
reaction(
    label = 'reaction162',
    reactants = ['[C]1C=C2C[CH]CC=1O2(9238)'],
    products = ['C7H6O(490)(489)'],
...
reaction(
    label = 'reaction164',
    reactants = ['[C]1=CC2=CC[C](C1)O2(9239)'],
    products = ['C7H6O(490)(489)'],
...
reaction(
    label = 'reaction165',
    reactants = ['[C]1C=C2CC[CH]C=1O2(9240)'],
    products = ['C7H6O(490)(489)'],
...
reaction(
    label = 'reaction166',
    reactants = ['[C]1=C[C]2CC=C(C1)O2(9241)'],
    products = ['C7H6O(490)(489)'],
...
reaction(
    label = 'reaction168',
    reactants = ['[C]1C=C2[CH]CCC=1O2(9242)'],
    products = ['C7H6O(490)(489)'],
...
reaction(
    label = 'reaction172',
    reactants = ['[C]1=CC[C]2CC=C1O2(9243)'],
    products = ['C7H6O(490)(489)'],
...
reaction(
    label = 'reaction174',
    reactants = ['[C]1=CCC2=CC[C]1O2(9244)'],
    products = ['C7H6O(490)(489)'],
...
reaction(
    label = 'reaction175',
    reactants = ['C1=CC2=CCCC=1O2(9245)'],
    products = ['C7H6O(490)(489)'],
...
reaction(
    label = 'reaction176',
    reactants = ['C1=CC2=CCC(=C1)O2(9246)'],
    products = ['C7H6O(490)(489)'],
...
reaction(
    label = 'reaction177',
    reactants = ['C1=CCC2C=CC=1O2(9247)'],
    products = ['C7H6O(490)(489)'],
...
reaction(
    label = 'reaction178',
    reactants = ['[CH]=C1C=CCC(=[CH])O1(9248)'],
    products = ['C7H6O(490)(489)'],
...
reaction(
    label = 'reaction181',
    reactants = ['[CH]=CC1=CC=C([CH2])O1(9249)'],
    products = ['C7H6O(490)(489)'],
...
reaction(
    label = 'reaction182',
    reactants = ['[CH]=CCC1=CC=[C]O1(9250)'],
    products = ['C7H6O(490)(489)'],
...
reaction(
    label = 'reaction183',
    reactants = ['[CH2]C=CC1=CC=[C]O1(9251)'],
    products = ['C7H6O(490)(489)'],
...
reaction(
    label = 'reaction186',
    reactants = ['[C]1CC2=CC=C(C1)O2(9254)'],
    products = ['C7H6O(490)(489)'],
...
reaction(
    label = 'reaction187',
    reactants = ['[C]1CCC2=CC=C1O2(9255)'],
    products = ['C7H6O(490)(489)'],
...
reaction(
    label = 'reaction188',
    reactants = ['[C]1C=C2C=CCC1O2(9256)'],
    products = ['C7H6O(490)(489)'],
...
reaction(
    label = 'reaction189',
    reactants = ['[C]1C=C2CC=CC1O2(9257)'],
    products = ['C7H6O(490)(489)'],
...
reaction(
    label = 'reaction190',
    reactants = ['C7H6O(490)(489)'],
    products = ['C1=C2CC3C=C(O2)C13(9258)'],
...
reaction(
    label = 'reaction191',
    reactants = ['C7H6O(490)(489)'],
    products = ['C1=CC23C=CC2(C1)O3(9259)'],
...
reaction(
    label = 'reaction192',
    reactants = ['[CH]1C[C]2OC3=CC2C13(9260)'],
    products = ['C7H6O(490)(489)'],
...
reaction(
    label = 'reaction193',
    reactants = ['[CH]1C2=CC3[C](CC13)O2(9261)'],
    products = ['C7H6O(490)(489)'],
...
reaction(
    label = 'reaction194',
    reactants = ['[CH]1CC2=CC3[C](O2)C13(9262)'],
    products = ['C7H6O(490)(489)'],
...
reaction(
    label = 'reaction217',
    reactants = ['[CH]=CC=CC(=O)C=[CH](9263)'],
    products = ['C7H6O(492)(491)'],
...
reaction(
    label = 'reaction220',
    reactants = ['O=C1[C]CC=CC=C1(9264)'],
    products = ['C7H6O(492)(491)'],
...
reaction(
    label = 'reaction221',
    reactants = ['O=C1C=CC=C[C]C1(9265)'],
    products = ['C7H6O(492)(491)'],
...
reaction(
    label = 'reaction222',
    reactants = ['O=C1C=C[C]CC=C1(9266)'],
    products = ['C7H6O(492)(491)'],
...
reaction(
    label = 'reaction224',
    reactants = ['[O]C1[CH]C2C=CC2C=1(9172)'],
    products = ['C7H6O(492)(491)'],
...
reaction(
    label = 'reaction225',
    reactants = ['H(3)(3)', 'O=C1C=CC2C=C[C]12(9267)'],
    products = ['C7H6O(535)(534)'],
...
reaction(
    label = 'reaction226',
    reactants = ['H(3)(3)', 'O=C1C=C[C]2C=CC21(9268)'],
    products = ['C7H6O(535)(534)'],
...
reaction(
    label = 'reaction227',
    reactants = ['H(3)(3)', 'O=C1C=CC2C=[C]C12(9269)'],
    products = ['C7H6O(535)(534)'],
...
reaction(
    label = 'reaction228',
    reactants = ['H(3)(3)', 'O=C1C=CC2[C]=CC12(9270)'],
    products = ['C7H6O(535)(534)'],
...
reaction(
    label = 'reaction229',
    reactants = ['H(3)(3)', 'O=C1C=[C]C2C=CC12(9271)'],
    products = ['C7H6O(535)(534)'],
...
reaction(
    label = 'reaction230',
    reactants = ['H(3)(3)', 'O=C1[C]=CC2C=CC12(9272)'],
    products = ['C7H6O(535)(534)'],
...
reaction(
    label = 'reaction231',
    reactants = ['O=C1C=CC2[CH]C[C]12(9273)'],
    products = ['C7H6O(535)(534)'],
...
reaction(
    label = 'reaction232',
    reactants = ['[O]C1C=CC2C=C[C]12(9274)'],
    products = ['C7H6O(535)(534)'],
...
reaction(
    label = 'reaction233',
    reactants = ['O=C1C=C[C]2C[CH]C21(4743)'],
    products = ['C7H6O(535)(534)'],
...
reaction(
    label = 'reaction234',
    reactants = ['O=C1[CH]C[C]2C=CC21(9275)'],
    products = ['C7H6O(535)(534)'],
...
reaction(
    label = 'reaction235',
    reactants = ['[O]C1[C]=CC2C=CC12(9276)'],
    products = ['C7H6O(535)(534)'],
...
reaction(
    label = 'reaction236',
    reactants = ['O=C1C=C[C]2[CH]CC21(9277)'],
    products = ['C7H6O(535)(534)'],
...
reaction(
    label = 'reaction237',
    reactants = ['[O]C1C=C[C]2C=CC21(9278)'],
    products = ['C7H6O(535)(534)'],
...
reaction(
    label = 'reaction238',
    reactants = ['[O]C1C=CC2C=[C]C12(9279)'],
    products = ['C7H6O(535)(534)'],
...
reaction(
    label = 'reaction239',
    reactants = ['O=C1C=CC2C[CH][C]12(4744)'],
    products = ['C7H6O(535)(534)'],
...
reaction(
    label = 'reaction240',
    reactants = ['O=C1[CH]CC2C=C[C]12(9280)'],
    products = ['C7H6O(535)(534)'],
...
reaction(
    label = 'reaction241',
    reactants = ['O=C1[CH]CC2[C]=CC12(9281)'],
    products = ['C7H6O(535)(534)'],
...
reaction(
    label = 'reaction242',
    reactants = ['O=C1C=[C]C2C[CH]C12(4746)'],
    products = ['C7H6O(535)(534)'],
...
reaction(
    label = 'reaction243',
    reactants = ['O=C1C[CH]C2C=C[C]12(9282)'],
    products = ['C7H6O(535)(534)'],
...
reaction(
    label = 'reaction244',
    reactants = ['[O]C1C=[C]C2C=CC12(9283)'],
    products = ['C7H6O(535)(534)'],
...
reaction(
    label = 'reaction245',
    reactants = ['O[C]1C=C[C]2C=CC12(9284)'],
    products = ['C7H6O(535)(534)'],
...
reaction(
    label = 'reaction246',
    reactants = ['O[C]1C=CC2C=[C]C12(9285)'],
    products = ['C7H6O(535)(534)'],
...
reaction(
    label = 'reaction247',
    reactants = ['O=C1C[CH]C2[C]=CC12(9286)'],
    products = ['C7H6O(535)(534)'],
...
reaction(
    label = 'reaction248',
    reactants = ['O=C1C=[C]C2[CH]CC12(9287)'],
    products = ['C7H6O(535)(534)'],
...
reaction(
    label = 'reaction249',
    reactants = ['O[C]1C=[C]C2C=CC12(9288)'],
    products = ['C7H6O(535)(534)'],
...
reaction(
    label = 'reaction250',
    reactants = ['O=C1[CH]CC2C=[C]C12(9289)'],
    products = ['C7H6O(535)(534)'],
...
reaction(
    label = 'reaction251',
    reactants = ['O=C1C[CH][C]2C=CC21(9290)'],
    products = ['C7H6O(535)(534)'],
...
reaction(
    label = 'reaction252',
    reactants = ['O=C1C[CH]C2C=[C]C12(9291)'],
    products = ['C7H6O(535)(534)'],
...
reaction(
    label = 'reaction253',
    reactants = ['[O]C1C=CC2[C]=CC12(9292)'],
    products = ['C7H6O(535)(534)'],
...
reaction(
    label = 'reaction254',
    reactants = ['O=C1[C]=CC2[CH]CC12(9293)'],
    products = ['C7H6O(535)(534)'],
...
reaction(
    label = 'reaction255',
    reactants = ['O=C1[C]=CC2C[CH]C12(4747)'],
    products = ['C7H6O(535)(534)'],
...
reaction(
    label = 'reaction256',
    reactants = ['O[C]1C=CC2[C]=CC12(9294)'],
    products = ['C7H6O(535)(534)'],
...
reaction(
    label = 'reaction257',
    reactants = ['O[C]1[C]=CC2C=CC12(9295)'],
    products = ['C7H6O(535)(534)'],
...
reaction(
    label = 'reaction258',
    reactants = ['O[C]1C=CC2C=C[C]12(9296)'],
    products = ['C7H6O(535)(534)'],
...
reaction(
    label = 'reaction259',
    reactants = ['[CH]=CC1[CH]C=CC1=O(9297)'],
    products = ['C7H6O(535)(534)'],
...
reaction(
    label = 'reaction260',
    reactants = ['[CH]=CC1[CH]C(=O)C=C1(9298)'],
    products = ['C7H6O(535)(534)'],
...
reaction(
    label = 'reaction261',
    reactants = ['[CH]=CC1C=CC1[C]=O(9299)'],
    products = ['C7H6O(535)(534)'],
...
reaction(
    label = 'reaction262',
    reactants = ['[CH]=CC(=O)C1[CH]C=C1(9300)'],
    products = ['C7H6O(535)(534)'],
...
reaction(
    label = 'reaction263',
    reactants = ['O=[C]C=CC1[CH]C=C1(9301)'],
    products = ['C7H6O(535)(534)'],
...
reaction(
    label = 'reaction264',
    reactants = ['C1=CC2C=CC(=C2)O1(9302)'],
    products = ['C7H6O(535)(534)'],
...
reaction(
    label = 'reaction265',
    reactants = ['OC1C=CC2C=CC=12(9303)'],
    products = ['C7H6O(535)(534)'],
...
reaction(
    label = 'reaction266',
    reactants = ['OC1=C=CC2C=CC12(9304)'],
    products = ['C7H6O(535)(534)'],
...
reaction(
    label = 'reaction267',
    reactants = ['O=C1C=CC2C[C]C12(9305)'],
    products = ['C7H6O(535)(534)'],
...
reaction(
    label = 'reaction268',
    reactants = ['O=C1C=CC2[C]CC12(9306)'],
    products = ['C7H6O(535)(534)'],
...
reaction(
    label = 'reaction269',
    reactants = ['O=C1C[C]C2C=CC12(9307)'],
    products = ['C7H6O(535)(534)'],
...
reaction(
    label = 'reaction270',
    reactants = ['O=C1[C]CC2C=CC12(9308)'],
    products = ['C7H6O(535)(534)'],
...
reaction(
    label = 'reaction271',
    reactants = ['O=C=CC1C2C=CC12(9309)'],
    products = ['C7H6O(535)(534)'],
...
reaction(
    label = 'reaction272',
    reactants = ['[CH]1C2O[C]3C=CC2C13(9310)'],
    products = ['C7H6O(535)(534)'],
...
reaction(
    label = 'reaction273',
    reactants = ['O=C1C2[CH]C3[CH]C2C13(9311)'],
    products = ['C7H6O(535)(534)'],
...
reaction(
    label = 'reaction274',
    reactants = ['O=C1C2[CH]C3C1[CH]C23(9312)'],
    products = ['C7H6O(535)(534)'],
...
reaction(
    label = 'reaction275',
    reactants = ['[CH]1C2C=C[C]3OC1C32(9313)'],
    products = ['C7H6O(535)(534)'],
...
reaction(
    label = 'reaction277',
    reactants = ['O=C1[CH]C2C3[CH]C1C23(9314)'],
    products = ['C7H6O(535)(534)'],
...
reaction(
    label = 'reaction278',
    reactants = ['O=C1[CH]C2C3[CH]C2C13(9315)'],
    products = ['C7H6O(535)(534)'],
...
reaction(
    label = 'reaction279',
    reactants = ['S(801)(800)'],
    products = ['C1=CC2C3OC(=C1)C23(9316)'],
...
reaction(
    label = 'reaction280',
    reactants = ['H(3)(3)', 'C1C=CC2=C[C](C=1)O2(9317)'],
    products = ['S(801)(800)'],
...
reaction(
    label = 'reaction281',
    reactants = ['H(3)(3)', '[C]1=C2C=CC=CC1O2(9318)'],
    products = ['S(801)(800)'],
...
reaction(
    label = 'reaction282',
    reactants = ['H(3)(3)', '[C]1=CC=CC2=CC1O2(9319)'],
    products = ['S(801)(800)'],
...
reaction(
    label = 'reaction283',
    reactants = ['H(3)(3)', '[C]1=CC2C=C(C=C1)O2(9320)'],
    products = ['S(801)(800)'],
...
reaction(
    label = 'reaction284',
    reactants = ['H(3)(3)', '[C]1=CC=CC2C=C1O2(9321)'],
    products = ['S(801)(800)'],
...
reaction(
    label = 'reaction285',
    reactants = ['H(3)(3)', '[C]1=CC2=CC(C=C1)O2(9322)'],
    products = ['S(801)(800)'],
...
reaction(
    label = 'reaction286',
    reactants = ['C1C=C[C]2C[C](C=1)O2(9323)'],
    products = ['S(801)(800)'],
...
reaction(
    label = 'reaction287',
    reactants = ['[CH]1[C]2CC=CC=C1O2(4762)'],
    products = ['S(801)(800)'],
...
reaction(
    label = 'reaction288',
    reactants = ['[C]1=CC2C=C([CH]C1)O2(9324)'],
    products = ['S(801)(800)'],
...
reaction(
    label = 'reaction289',
    reactants = ['[C]1=CC=CC2[CH]C1O2(9325)'],
    products = ['S(801)(800)'],
...
reaction(
    label = 'reaction290',
    reactants = ['[C]1=CC2=CC([CH]C1)O2(4723)'],
    products = ['S(801)(800)'],
...
reaction(
    label = 'reaction291',
    reactants = ['[CH]1[CH]C2C=C(C=C1)O2(4721)'],
    products = ['S(801)(800)'],
...
reaction(
    label = 'reaction292',
    reactants = ['[C]1C2=CC=CCC1O2(4772)'],
    products = ['S(801)(800)'],
...
reaction(
    label = 'reaction293',
    reactants = ['[C]1=CC=C[C]2CC1O2(9326)'],
    products = ['S(801)(800)'],
...
reaction(
    label = 'reaction294',
    reactants = ['[C]1=C2C[CH]C=CC1O2(9327)'],
    products = ['S(801)(800)'],
...
reaction(
    label = 'reaction295',
    reactants = ['[C]1=CC[CH]C2=CC1O2(9328)'],
    products = ['S(801)(800)'],
...
reaction(
    label = 'reaction296',
    reactants = ['[C]1=CC2[CH]C(C=C1)O2(9329)'],
    products = ['S(801)(800)'],
...
reaction(
    label = 'reaction297',
    reactants = ['[C]1=CC[CH]C2C=C1O2(4724)'],
    products = ['S(801)(800)'],
...
reaction(
    label = 'reaction298',
    reactants = ['[C]1=C2C=CC[CH]C1O2(4722)'],
    products = ['S(801)(800)'],
...
reaction(
    label = 'reaction299',
    reactants = ['[C]1=C2[CH]CC=CC1O2(9330)'],
    products = ['S(801)(800)'],
...
reaction(
    label = 'reaction300',
    reactants = ['[C]1=C[CH]CC2=CC1O2(9331)'],
    products = ['S(801)(800)'],
...
reaction(
    label = 'reaction301',
    reactants = ['[C]1=C[C]2CC(C=C1)O2(9332)'],
    products = ['S(801)(800)'],
...
reaction(
    label = 'reaction302',
    reactants = ['[C]1C=CCC2[CH]C=1O2(4765)'],
    products = ['S(801)(800)'],
...
reaction(
    label = 'reaction303',
    reactants = ['[C]1=CC2C[C](C=C1)O2(9333)'],
    products = ['S(801)(800)'],
...
reaction(
    label = 'reaction304',
    reactants = ['[CH]1CC=CC2=C[C]1O2(4720)'],
    products = ['S(801)(800)'],
...
reaction(
    label = 'reaction305',
    reactants = ['[C]1[CH]CC2=CC(C=1)O2(9334)'],
    products = ['S(801)(800)'],
...
reaction(
    label = 'reaction306',
    reactants = ['[C]1=CCC2[CH]C(=C1)O2(4764)'],
    products = ['S(801)(800)'],
...
reaction(
    label = 'reaction307',
    reactants = ['[C]1=CC=CC2C[C]1O2(9335)'],
    products = ['S(801)(800)'],
...
reaction(
    label = 'reaction308',
    reactants = ['C1=CC2=CC(=CC1)O2(4715)'],
    products = ['S(801)(800)'],
...
reaction(
    label = 'reaction309',
    reactants = ['C1=CCC2=CC(=C1)O2(4757)'],
    products = ['S(801)(800)'],
...
reaction(
    label = 'reaction310',
    reactants = ['C1=CC=C2CC(C=1)O2(9336)'],
    products = ['S(801)(800)'],
...
reaction(
    label = 'reaction311',
    reactants = ['[CH]=C1C=CC=C[CH]O1(9337)'],
    products = ['S(801)(800)'],
...
reaction(
    label = 'reaction313',
    reactants = ['[CH]=CC1=CC(C=[CH])O1(9338)'],
    products = ['S(801)(800)'],
...
reaction(
    label = 'reaction314',
    reactants = ['[CH]=CC=CC1C=[C]O1(9339)'],
    products = ['S(801)(800)'],
...
reaction(
    label = 'reaction315',
    reactants = ['[CH]=CC=CC1=C[CH]O1(9340)'],
    products = ['S(801)(800)'],
...
reaction(
    label = 'reaction316',
    reactants = ['[C]1C2C=CC=CC1O2(9341)'],
    products = ['S(801)(800)'],
...
reaction(
    label = 'reaction317',
    reactants = ['[C]1CC=CC2=CC1O2(9342)'],
    products = ['S(801)(800)'],
...
reaction(
    label = 'reaction318',
    reactants = ['[C]1C=CC2=CC(C1)O2(9343)'],
    products = ['S(801)(800)'],
...
reaction(
    label = 'reaction319',
    reactants = ['[C]1CC=CC2C=C1O2(9344)'],
    products = ['S(801)(800)'],
...
reaction(
    label = 'reaction320',
    reactants = ['[C]1C=CC2C=C(C1)O2(9345)'],
    products = ['S(801)(800)'],
...
reaction(
    label = 'reaction321',
    reactants = ['S(801)(800)'],
    products = ['C1=CC2OC3=CC1C32(9346)'],
...
reaction(
    label = 'reaction322',
    reactants = ['S(801)(800)'],
    products = ['C1=CC2C3C=C(O3)C12(9347)'],
...
reaction(
    label = 'reaction323',
    reactants = ['[CH]1C2[CH]C3(C=CC13)O2(9348)'],
    products = ['S(801)(800)'],
