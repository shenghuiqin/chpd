species(
    label = '[CH2]CC[CH]CC=CC=C(6392)',
    structure = SMILES('[CH2]CC[CH]CC=CC=C'),
    E0 = (363.614,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2950,3100,1380,975,1025,1650,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,2995,3010,3025,975,987.5,1000,1300,1337.5,1375,400,450,500,1630,1655,1680,200,800,1066.67,1333.33,1600],'cm^-1')),
...
species(
    label = '[CH2]CC=CCC=CC=C(6528)',
    structure = SMILES('[CH2]CC=CCC=CC=C'),
    E0 = (287.097,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2950,3100,1380,975,1025,1650,2995,3002.5,3010,3017.5,3025,975,981.25,987.5,993.75,1000,1300,1318.75,1337.5,1356.25,1375,400,425,450,475,500,1630,1642.5,1655,1667.5,1680,3000,3100,440,815,1455,1000,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'C=CC=CC[CH]CC=C(6529)',
    structure = SMILES('C=CC=CC[CH]CC=C'),
    E0 = (286.15,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2950,3000,3050,3100,1330,1430,900,1050,1000,1050,1600,1700,3025,407.5,1350,352.5,2995,3005,3015,3025,975,983.333,991.667,1000,1300,1325,1350,1375,400,433.333,466.667,500,1630,1646.67,1663.33,1680,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    ...
    molecularWeight = (122.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.503088,0.0918059,-6.41208e-05,2.35952e-08,-3.60088e-12,43898.9,40.1368], Tmin=(100,'K'), Tmax=(1503.19,'K')), NASAPolynomial(coeffs=[16.7669,0.04585,-1.8262e-05,3.25659e-09,-2.18272e-13,38707,-50.2197], Tmin=(1503.19,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(363.602,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(532.126,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + radical(RCCJC) + radical(RCCJ)"""),
)

species(
    label = 'C=CC=CC[CH][CH]CC(6532)',
...
species(
    label = '[CH2]CCCCC=[C]C=C(6534)',
    structure = SMILES('[CH2]CCCCC=[C]C=C'),
    E0 = (368.151,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,1685,370,2950,3100,1380,975,1025,1650,2995,3025,975,1000,1300,1375,400,500,1630,1680,3000,3100,440,815,1455,1000,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (122.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.834004,0.0988298,-7.6439e-05,3.17813e-08,-5.45077e-12,44458.4,38.1831], Tmin=(100,'K'), Tmax=(1365.63,'K')), NASAPolynomial(coeffs=[17.3818,0.0454743,-1.78331e-05,3.17113e-09,-2.13184e-13,39483.2,-55.3739], Tmin=(1365.63,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(368.151,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(532.126,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + radical(RCCJ) + radical(C=CJC=C)"""),
)

species(
    label = 'C=C[CH][CH]C=CCCC(6470)',
...
species(
    label = 'C=CC=[C]C[CH]CCC(6536)',
    structure = SMILES('C=CC=[C]C[CH]CCC'),
    E0 = (396.209,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2995,3025,975,1000,1300,1375,400,500,1630,1680,1685,370,2750,2800,2850,1350,1500,750,1050,1375,1000,2950,3100,1380,975,1025,1650,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    ...
    molecularWeight = (122.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.238566,0.0637756,2.17981e-05,-6.51401e-08,2.68612e-11,48119.5,37.2874], Tmin=(100,'K'), Tmax=(1021.74,'K')), NASAPolynomial(coeffs=[15.613,0.0475561,-1.89412e-05,3.5594e-09,-2.53655e-13,42682.7,-48.4474], Tmin=(1021.74,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(398.825,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(540.441,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Cyclobutane) + radical(RCCJ) + radical(cyclobutane)"""),
)

species(
    label = '[CH2]CCC1C[CH]C=CC1(6541)',
...
species(
    label = '[CH]CC=CC=C(6548)',
    structure = SMILES('[CH]CC=CC=C'),
    E0 = (483.465,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2995,3010,3025,975,987.5,1000,1300,1337.5,1375,400,450,500,1630,1655,1680,2950,3100,1380,975,1025,1650,407.936,410.149,410.548,411.585,412.777],'cm^-1')),
        HinderedRotor(inertia=(0.0010008,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.121938,'amu*angstrom^2'), symmetry=1, barrier=(14.8345,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.124303,'amu*angstrom^2'), symmetry=1, barrier=(14.8215,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
species(
    label = '[CH2]C[CH]CC=CC=C(6453)',
    structure = SMILES('[CH2]C[CH]CC=CC=C'),
    E0 = (387.394,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2950,3100,1380,975,1025,1650,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,2995,3010,3025,975,987.5,1000,1300,1337.5,1375,400,450,500,1630,1655,1680,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]CC[CH]CC=CC=C(6392)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]CC[CH]CC=CC=C(6392)'],
    products = ['[CH2]CCC1CC1[CH]C=C(6526)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH2]CC[CH]CC=CC=C(6392)'],
    products = ['[CH2]CCC1CC=CC1[CH2](6527)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['[CH2]CC[CH]CC=CC=C(6392)'],
    products = ['[CH2]C1C=CC[CH]CCC1(6423)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['H(3)(3)', '[CH2]CC=CCC=CC=C(6528)'],
    products = ['[CH2]CC[CH]CC=CC=C(6392)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(3)(3)', 'C=CC=CC[CH]CC=C(6529)'],
    products = ['[CH2]CC[CH]CC=CC=C(6392)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(3)(3)', '[CH2]CCC=CC=CC=C(6458)'],
    products = ['[CH2]CC[CH]CC=CC=C(6392)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]CCC=C(3546)', 'CH2CHCHCH(913)'],
    products = ['[CH2]CC[CH]CC=CC=C(6392)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]C[CH]CCC=CC=C(6451)'],
    products = ['[CH2]CC[CH]CC=CC=C(6392)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2]CC[CH]CC=CC=C(6392)'],
    products = ['C=CC=CC[CH]C[CH]C(6530)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]CC[CH]CC=CC=C(6392)'],
    products = ['[CH2]CCCC=C[CH]C=C(6485)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]CC[CH]CC=CC=C(6392)'],
    products = ['[CH2][CH]CCCC=CC=C(6531)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]CC[CH]CC=CC=C(6392)'],
    products = ['C=CC=CC[CH][CH]CC(6532)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2]CCCCC=[C]C=C(6534)'],
    products = ['[CH2]CC[CH]CC=CC=C(6392)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2]CC[CH]CC=CC=C(6392)'],
    products = ['C=C[CH][CH]C=CCCC(6470)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2]CCCCC=C[C]=C(6535)'],
    products = ['[CH2]CC[CH]CC=CC=C(6392)'],
...
reaction(
    label = 'reaction21',
    reactants = ['C=CC=[C]C[CH]CCC(6536)'],
    products = ['[CH2]CC[CH]CC=CC=C(6392)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH]=CC=CCCCC[CH2](6537)'],
    products = ['[CH2]CC[CH]CC=CC=C(6392)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[CH2]CC[CH]CC=CC=C(6392)'],
    products = ['[CH2]CCC1C[CH]C1C=C(6540)'],
...
reaction(
    label = 'reaction27',
    reactants = ['[CH2]CC[CH]CC=CC=C(6392)'],
    products = ['[CH2]CCC1C[CH]C=CC1(6541)'],
...
reaction(
    label = 'reaction29',
    reactants = ['[CH2]CC[CH]CC=CC=C(6392)'],
    products = ['[CH]1C=CCCCC[CH]C1(6475)'],
...
reaction(
    label = 'reaction33',
    reactants = ['[CH2]CC[CH]CC=CC=C(6392)'],
    products = ['[CH2]CC[CH]C=CC=CC(6545)'],
...
reaction(
    label = 'reaction34',
    reactants = ['[CH2]CC([CH2])CC=CC=C(6395)'],
    products = ['[CH2]CC[CH]CC=CC=C(6392)'],
...
reaction(
    label = 'reaction35',
    reactants = ['[CH2]CCC([CH2])C=CC=C(6546)'],
    products = ['[CH2]CC[CH]CC=CC=C(6392)'],
...
reaction(
    label = 'reaction37',
    reactants = ['[CH2]CC[CH]CC=CC=C(6392)'],
    products = ['[CH2]CC[CH]CC1C=CC1(6547)'],
...
reaction(
    label = 'reaction38',
    reactants = ['[CH2]C[CH2](1090)', '[CH]CC=CC=C(6548)'],
    products = ['[CH2]CC[CH]CC=CC=C(6392)'],
...
reaction(
    label = 'reaction39',
    reactants = ['CH2(17)(18)', '[CH2]C[CH]CC=CC=C(6453)'],
    products = ['[CH2]CC[CH]CC=CC=C(6392)'],
