species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.0319422,'amu*angstrom^2'), symmetry=1, barrier=(13.9807,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.09511,'amu*angstrom^2'), symmetry=1, barrier=(48.1707,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0225693,'amu*angstrom^2'), symmetry=1, barrier=(105.004,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.306026,'amu*angstrom^2'), symmetry=1, barrier=(7.03614,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.305192,'amu*angstrom^2'), symmetry=1, barrier=(7.01696,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.304973,'amu*angstrom^2'), symmetry=1, barrier=(7.01192,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (76.0514,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.69166,0.0578189,-0.000100915,9.09188e-08,-3.08708e-11,-1437.89,19.8769], Tmin=(100,'K'), Tmax=(893.39,'K')), NASAPolynomial(coeffs=[6.58179,0.0194602,-8.86833e-06,1.60359e-09,-1.05109e-13,-1654.62,0.513289], Tmin=(893.39,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-12.5909,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + radical(ROOJ) + radical(CCsJOH)"""),
)

species(
    label = 'O[CH][CH]OO(1707)',
...
reaction(
    label = 'reaction17',
    reactants = ['OH(5)(5)', '[O]C[CH]O(1704)'],
    products = ['S(146)(145)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction18',
    reactants = ['HO2(8)(9)', '[CH2][CH]O(1705)'],
    products = ['S(146)(145)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction20',
    reactants = ['H(3)(3)', '[O]OC[CH]O(1439)'],
    products = ['S(146)(145)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(3)(3)', 'O[CH][CH]OO(1707)'],
    products = ['S(146)(145)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CH2OOH(33)(34)', 'HCOH(T)(1710)'],
    products = ['S(146)(145)'],
...
reaction(
    label = 'reaction5',
    reactants = ['OH(5)(5)', '[CH2]CO[O](1430)'],
    products = ['C2H5O3(54)(53)'],
...
reaction(
    label = 'reaction7',
    reactants = ['CH2OH(22)(23)', '[CH2]O[O](1428)'],
    products = ['C2H5O3(54)(53)'],
...
reaction(
    label = 'reaction8',
    reactants = ['H(3)(3)', '[O]O[CH]CO(1438)'],
    products = ['C2H5O3(54)(53)'],
...
reaction(
    label = 'reaction26',
    reactants = ['O(4)(4)', 'HOCH2CH2O(1440)'],
    products = ['C2H5O3(54)(53)'],
