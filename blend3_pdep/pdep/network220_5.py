species(
    ...
    E0 = (17.676,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2782.5,750,1395,475,1775,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,3000,3100,440,815,1455,1000,200,800,1600],'cm^-1')),
...
species(
    ...
    E0 = (-45.1941,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2807.14,2864.29,2921.43,2978.57,3035.71,3092.86,3150,900,928.571,957.143,985.714,1014.29,1042.86,1071.43,1100,2782.5,750,1395,475,1775,1000,2750,2850,1437.5,1250,1305,750,350,300,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (111.162,'amu'),
    collisionModel = TransportData(shapeIndex=2, epsilon=(4004.79,'J/mol'), sigma=(6.90641,'angstroms'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with Tc=625.54 K, Pc=27.58 bar (from Joback method)"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
...
species(
    label = 'S(513)(512)',
    structure = SMILES('[CH]1CC2CCC(C2)O1'),
    E0 = (-20.5926,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2790,2830,2870,2910,2950,2990,3030,3070,3110,3150,900,920,940,960,980,1000,1020,1040,1060,1080,1100,300,800,800,800,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
    ],
    ...
    opticalIsomers = 1,
    molecularWeight = (111.162,'amu'),
    collisionModel = TransportData(shapeIndex=2, epsilon=(3975.64,'J/mol'), sigma=(7.00253,'angstroms'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with Tc=620.99 K, Pc=26.27 bar (from Joback method)"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.44902,0.0330033,7.94164e-05,-1.19446e-07,4.56239e-11,-2364.34,18.8966], Tmin=(100,'K'), Tmax=(988.247,'K')), NASAPolynomial(coeffs=[14.625,0.0372369,-1.43828e-05,2.77192e-09,-2.04666e-13,-7779.51,-58.7358], Tmin=(988.247,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-20.5926,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + polycyclic(s3_5_6_ane) + radical(CCsJOCs)"""),
)
...
species(
    label = 'O=C=CC1CCCC1(3773)',
    structure = SMILES('O=C=CC1CCCC1'),
    E0 = (-106.027,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2120,512.5,787.5,2750,2800,2850,2900,2950,3000,3050,3100,3150,900,925,950,975,1000,1025,1050,1075,1100,3010,987.5,1337.5,450,1655,300,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
species(
    ...
    molecularWeight = (110.154,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.46623,0.031434,8.25757e-05,-1.30334e-07,5.24923e-11,12035.6,29.2539], Tmin=(100,'K'), Tmax=(949.497,'K')), NASAPolynomial(coeffs=[16.8686,0.0278009,-8.4517e-06,1.52127e-09,-1.14012e-13,6349.55,-58.7954], Tmin=(949.497,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(99.1271,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(428.195,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + ring(Cyclopentane) + radical(C=COJ) + radical(cyclopentane)"""),
)
...
species(
    label = '[O][C]=CC1CCCC1(3784)',
    structure = SMILES('O=[C][CH]C1CCCC1'),
    E0 = (96.4148,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1855,455,950,2750,2800,2850,2900,2950,3000,3050,3100,3150,900,925,950,975,1000,1025,1050,1075,1100,3025,407.5,1350,352.5,300,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
...
species(
    label = 'OC=CC1[CH]CCC1(3777)',
    structure = SMILES('OC=CC1[CH]CCC1'),
    E0 = (-33.6745,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2807.14,2864.29,2921.43,2978.57,3035.71,3092.86,3150,900,928.571,957.143,985.714,1014.29,1042.86,1071.43,1100,2995,3025,975,1000,1300,1375,400,500,1630,1680,300,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
...
species(
    label = '[CH]=CC1CCCC1(3786)',
    structure = SMILES('[CH]=CC1CCCC1'),
    E0 = (227.672,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,2750,2800,2850,2900,2950,3000,3050,3100,3150,900,925,950,975,1000,1025,1050,1075,1100,3010,987.5,1337.5,450,1655,300,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
species(
    label = 'O=CC[C]1CCCC1(3787)',
    structure = SMILES('O=CC[C]1CCCC1'),
    E0 = (-45.6526,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2807.14,2864.29,2921.43,2978.57,3035.71,3092.86,3150,900,928.571,957.143,985.714,1014.29,1042.86,1071.43,1100,2782.5,750,1395,475,1775,1000,300,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
...
species(
    label = 'O=[C]CC1CCCC1(3788)',
    structure = SMILES('O=[C]CC1CCCC1'),
    E0 = (-71.1147,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,2900,2950,3000,3050,3100,3150,900,925,950,975,1000,1025,1050,1075,1100,1855,455,950,300,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
...
species(
    label = 'C=CCCC=CC=O(3754)',
    structure = SMILES('C=CCCC=CC=O'),
    E0 = (-59.7881,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2782.5,750,1395,475,1775,1000,2995,3010,3025,975,987.5,1000,1300,1337.5,1375,400,450,500,1630,1655,1680,2950,3100,1380,975,1025,1650,214.112,444.963,444.969],'cm^-1')),
        HinderedRotor(inertia=(0.0884086,'amu*angstrom^2'), symmetry=1, barrier=(12.421,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.540235,'amu*angstrom^2'), symmetry=1, barrier=(12.4211,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0884082,'amu*angstrom^2'), symmetry=1, barrier=(12.421,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.540233,'amu*angstrom^2'), symmetry=1, barrier=(12.421,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (110.154,'amu'),
...
species(
    label = 'CCCC[C]=CC=O(3759)',
    structure = SMILES('CCCC[C]=CC=O'),
    E0 = (50.2715,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,1685,370,2782.5,750,1395,475,1775,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2]C[CH]CC=CC=O(3762)',
    structure = SMILES('[CH2]C[CH]CC=CC=O'),
    E0 = (212.134,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2782.5,750,1395,475,1775,1000,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2]CC[CH]C=CC=O(3763)',
    structure = SMILES('[CH2]CCC=CC=C[O]'),
    E0 = (149.386,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2995,3005,3015,3025,975,983.333,991.667,1000,1300,1325,1350,1375,400,433.333,466.667,500,1630,1646.67,1663.33,1680,3000,3100,440,815,1455,1000,329.47,329.795,329.796,329.82],'cm^-1')),
        HinderedRotor(inertia=(0.224986,'amu*angstrom^2'), symmetry=1, barrier=(17.3399,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.224539,'amu*angstrom^2'), symmetry=1, barrier=(17.3391,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.225432,'amu*angstrom^2'), symmetry=1, barrier=(17.3402,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.224991,'amu*angstrom^2'), symmetry=1, barrier=(17.3381,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (110.154,'amu'),
...
species(
    label = '[CH2][CH]CCC=CC=O(3764)',
    structure = SMILES('[CH2][CH]CCC=CC=O'),
    E0 = (212.122,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2782.5,750,1395,475,1775,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,3000,3100,440,815,1455,1000,3025,407.5,1350,352.5,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2]CCC[C]=CC=O(3765)',
    structure = SMILES('[CH2]CCC[C]=CC=O'),
    E0 = (255.518,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,1685,370,2782.5,750,1395,475,1775,1000,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH]=CCCC[CH2](3766)',
    structure = SMILES('[CH]=CCCC[CH2]'),
    E0 = (388.26,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3010,987.5,1337.5,450,1655,3120,650,792.5,1650,3000,3100,440,815,1455,1000,180,804.727],'cm^-1')),
        HinderedRotor(inertia=(0.130379,'amu*angstrom^2'), symmetry=1, barrier=(2.99768,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.132504,'amu*angstrom^2'), symmetry=1, barrier=(3.04652,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.134284,'amu*angstrom^2'), symmetry=1, barrier=(3.08746,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.677115,'amu*angstrom^2'), symmetry=1, barrier=(15.5682,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (82.1436,'amu'),
...
species(
    label = '[CH2]CCCC=[C]C=O(3767)',
    structure = SMILES('[CH2]CCCC=C=C[O]'),
    E0 = (214.413,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2995,3025,975,1000,1300,1375,400,500,1630,1680,540,610,2055,3000,3100,440,815,1455,1000,345.731,346.146,346.232,346.285],'cm^-1')),
        HinderedRotor(inertia=(0.116291,'amu*angstrom^2'), symmetry=1, barrier=(9.88664,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.116496,'amu*angstrom^2'), symmetry=1, barrier=(9.88556,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.40903,'amu*angstrom^2'), symmetry=1, barrier=(119.627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.40984,'amu*angstrom^2'), symmetry=1, barrier=(119.627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (110.154,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0519789,0.0771259,-4.69796e-05,3.29462e-09,4.90729e-12,25944.2,33.027], Tmin=(100,'K'), Tmax=(1026.08,'K')), NASAPolynomial(coeffs=[18.0859,0.0295517,-1.12503e-05,2.05316e-09,-1.43822e-13,21004.3,-60.879], Tmin=(1026.08,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(214.413,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(415.724,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cdd-CdsCds) + radical(RCCJ) + radical(C=COJ)"""),
)
...
species(
    label = '[CH2]CCCC=C(3548)',
    structure = SMILES('[CH2]CCCC=C'),
    E0 = (141.164,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2950,3100,1380,975,1025,1650,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,180,927.056,927.057],'cm^-1')),
        HinderedRotor(inertia=(0.10252,'amu*angstrom^2'), symmetry=1, barrier=(2.35713,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.46969,'amu*angstrom^2'), symmetry=1, barrier=(10.7991,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.469729,'amu*angstrom^2'), symmetry=1, barrier=(10.8,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0177064,'amu*angstrom^2'), symmetry=1, barrier=(10.7989,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
species(
    label = '[CH2]CCCC=C=CO(3770)',
    structure = SMILES('[CH2]CCCC=C=CO'),
    E0 = (72.9501,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([540,610,2055,3615,1277.5,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,3000,3100,440,815,1455,1000,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2]CCC=CC=O(3771)',
    structure = SMILES('[CH2]CCC=CC=O'),
    E0 = (41.4563,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2782.5,750,1395,475,1775,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,3000,3100,440,815,1455,1000,180,413.848],'cm^-1')),
        HinderedRotor(inertia=(0.0768108,'amu*angstrom^2'), symmetry=1, barrier=(1.76603,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0768031,'amu*angstrom^2'), symmetry=1, barrier=(1.76585,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.106847,'amu*angstrom^2'), symmetry=1, barrier=(12.9937,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.565129,'amu*angstrom^2'), symmetry=1, barrier=(12.9934,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
species(
    label = '[CH]CCCC=CC=O(3772)',
    structure = SMILES('[CH]CCCC=CC=O'),
    E0 = (260.645,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2995,3025,975,1000,1300,1375,400,500,1630,1680,2782.5,750,1395,475,1775,1000,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH]=CCCCCC=O(3583)',
    structure = SMILES('[CH]=CCCCCC=O'),
    E0 = (76.4342,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,3010,987.5,1337.5,450,1655,3120,650,792.5,1650,2782.5,750,1395,475,1775,1000,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[O]C1CC2CCC1C2(3791)',
    structure = SMILES('[O]C1CC2CCC1C2'),
    E0 = (12.927,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (111.162,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.76494,0.0229332,0.000108321,-1.4928e-07,5.61234e-11,1658.65,19.8239], Tmin=(100,'K'), Tmax=(980.283,'K')), NASAPolynomial(coeffs=[14.6453,0.0365733,-1.38443e-05,2.6897e-09,-2.01377e-13,-4047.28,-58.2831], Tmin=(980.283,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(12.927,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + polycyclic(s3_5_5_ane) + radical(CC(C)OJ)"""),
)

species(
    label = 'O=CCC1C=CCC1(3792)',
    structure = SMILES('O=CCC1C=CCC1'),
    E0 = (-116.335,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2816.67,2883.33,2950,3016.67,3083.33,3150,900,933.333,966.667,1000,1033.33,1066.67,1100,2782.5,750,1395,475,1775,1000,2750,2850,1437.5,1250,1305,750,350,300,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    ...
    molecularWeight = (110.154,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.28329,0.04314,3.4594e-05,-6.85815e-08,2.70674e-11,-13879.5,26.0009], Tmin=(100,'K'), Tmax=(1011.37,'K')), NASAPolynomial(coeffs=[13.0631,0.0364047,-1.45261e-05,2.76046e-09,-1.98975e-13,-18300.5,-41.0399], Tmin=(1011.37,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-116.335,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(424.038,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-OdCsH) + ring(Cyclopentene)"""),
)

species(
    label = 'O=CCC1CC=CC1(3793)',
    structure = SMILES('O=CCC1CC=CC1'),
    E0 = (-117.404,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2816.67,2883.33,2950,3016.67,3083.33,3150,900,933.333,966.667,1000,1033.33,1066.67,1100,2782.5,750,1395,475,1775,1000,2750,2850,1437.5,1250,1305,750,350,300,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (110.154,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.28427,0.0434041,3.31789e-05,-6.65291e-08,2.61785e-11,-14008.4,25.9631], Tmin=(100,'K'), Tmax=(1015.88,'K')), NASAPolynomial(coeffs=[12.8735,0.0368374,-1.48084e-05,2.81702e-09,-2.02823e-13,-18378.9,-40.0524], Tmin=(1015.88,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-117.404,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(424.038,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-OdCsH) + ring(Cyclopentene)"""),
)
...
species(
    label = '[CH]1C[CH]CC1(3794)',
    structure = SMILES('[CH]1C[CH]CC1'),
    E0 = (280.088,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2807.14,2864.29,2921.43,2978.57,3035.71,3092.86,3150,900,928.571,957.143,985.714,1014.29,1042.86,1071.43,1100,990.169,1194.38,1194.38,1194.38,1194.38,1194.38,1194.38,1194.38,1194.38,1194.38,1194.38,1194.38,1194.38,1194.38,1194.38,1194.38,4000],'cm^-1')),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (68.117,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.45008,0.00251927,7.23059e-05,-7.97174e-08,2.65564e-11,33715,18.712], Tmin=(100,'K'), Tmax=(1006.71,'K')), NASAPolynomial(coeffs=[1.96921,0.0342026,-1.33436e-05,2.45861e-09,-1.72536e-13,32705.8,19.3732], Tmin=(1006.71,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(280.088,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(307.635,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + ring(Cyclopentane) + radical(cyclopentane) + radical(cyclopentane)"""),
)

species(
    label = 'O=CC[C]1C[CH]CC1(3795)',
    structure = SMILES('O=CC[C]1C[CH]CC1'),
    E0 = (140.229,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2816.67,2883.33,2950,3016.67,3083.33,3150,900,933.333,966.667,1000,1033.33,1066.67,1100,2782.5,750,1395,475,1775,1000,2750,2850,1437.5,1250,1305,750,350,301.329,813.028,813.028,813.028,813.028,813.028,813.028,813.028,813.028,813.028,1619.92,1619.92,1619.92,1619.92,1619.92,1619.92,1619.92,1619.92,1619.92],'cm^-1')),
        HinderedRotor(inertia=(0.150521,'amu*angstrom^2'), symmetry=1, barrier=(3.53087,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.150521,'amu*angstrom^2'), symmetry=1, barrier=(3.53087,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (110.154,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.72874,0.0478216,-9.08897e-06,-6.38839e-09,2.26191e-12,16948.9,30.428], Tmin=(100,'K'), Tmax=(1555.89,'K')), NASAPolynomial(coeffs=[9.08938,0.0429455,-1.79307e-05,3.20286e-09,-2.11604e-13,12958.2,-13.8006], Tmin=(1555.89,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(140.229,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(424.038,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cds-OdCsH) + ring(Cyclopentane) + radical(Tertalkyl) + radical(cyclopentane)"""),
)

species(
    label = 'O=CCC1[CH]C[CH]C1(3796)',
    structure = SMILES('O=CCC1[CH]C[CH]C1'),
    E0 = (149.348,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2816.67,2883.33,2950,3016.67,3083.33,3150,900,933.333,966.667,1000,1033.33,1066.67,1100,2782.5,750,1395,475,1775,1000,2750,2850,1437.5,1250,1305,750,350,300,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (110.154,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.67424,0.0413896,1.7212e-05,-3.63372e-08,1.27045e-11,18054.2,31.3284], Tmin=(100,'K'), Tmax=(1127.52,'K')), NASAPolynomial(coeffs=[7.34742,0.0448554,-1.87842e-05,3.50329e-09,-2.43706e-13,15275.2,-3.37244], Tmin=(1127.52,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(149.348,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(424.038,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cds-OdCsH) + ring(Cyclopentane) + radical(cyclopentane) + radical(Cs_S)"""),
)

species(
    label = 'O=CCC1[CH][CH]CC1(3797)',
    structure = SMILES('O=CCC1[CH][CH]CC1'),
    E0 = (149.348,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2816.67,2883.33,2950,3016.67,3083.33,3150,900,933.333,966.667,1000,1033.33,1066.67,1100,2782.5,750,1395,475,1775,1000,300,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
...
species(
    label = 'O=CCC1C[CH][CH]C1(3798)',
    structure = SMILES('O=CCC1C[CH][CH]C1'),
    E0 = (140.687,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2816.67,2883.33,2950,3016.67,3083.33,3150,900,933.333,966.667,1000,1033.33,1066.67,1100,2782.5,750,1395,475,1775,1000,302.471,823.364,823.364,823.364,823.364,823.364,823.364,823.364,823.364,823.364,1621.87,1621.87,1621.87,1621.87,1621.87,1621.87,1621.87,1621.87,1621.87],'cm^-1')),
        HinderedRotor(inertia=(0.147481,'amu*angstrom^2'), symmetry=1, barrier=(3.51305,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.147481,'amu*angstrom^2'), symmetry=1, barrier=(3.51305,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (110.154,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.75038,0.042799,6.28628e-06,-2.14359e-08,7.02242e-12,17007,31.071], Tmin=(100,'K'), Tmax=(1247.91,'K')), NASAPolynomial(coeffs=[6.0769,0.0465112,-1.93077e-05,3.52633e-09,-2.40008e-13,14558.3,3.75516], Tmin=(1247.91,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(140.687,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(424.038,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cds-OdCsH) + ring(Cyclopentane) + radical(cyclopentane) + radical(cyclopentane)"""),
)

species(
    label = '[CH2]C1C[CH]CC1(3799)',
    structure = SMILES('[CH2]C1C[CH]CC1'),
    E0 = (266.468,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2807.14,2864.29,2921.43,2978.57,3035.71,3092.86,3150,900,928.571,957.143,985.714,1014.29,1042.86,1071.43,1100,3000,3100,440,815,1455,1000,303.182,814.776,814.776,814.776,814.776,814.776,814.776,814.776,814.776,814.776,1625.2,1625.2,1625.2,1625.2,1625.2,1625.2,1625.2,1625.2,1625.2],'cm^-1')),
        HinderedRotor(inertia=(0.14691,'amu*angstrom^2'), symmetry=1, barrier=(3.4848,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (82.1436,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.52526,0.0166841,7.73344e-05,-1.03883e-07,3.91836e-11,32116,23.212], Tmin=(100,'K'), Tmax=(952.212,'K')), NASAPolynomial(coeffs=[8.12811,0.0329811,-1.10864e-05,1.95382e-09,-1.37686e-13,29243.2,-13.0266], Tmin=(952.212,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(266.468,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(378.308,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cyclopentane) + radical(Isobutyl) + radical(cyclopentane)"""),
)

species(
    label = 'O=[C]CC1C[CH]CC1(3800)',
    structure = SMILES('O=[C]CC1C[CH]CC1'),
    E0 = (114.766,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2807.14,2864.29,2921.43,2978.57,3035.71,3092.86,3150,900,928.571,957.143,985.714,1014.29,1042.86,1071.43,1100,1855,455,950,2750,2850,1437.5,1250,1305,750,350,300,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    ...
    molecularWeight = (110.154,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.42578,0.0455181,1.31335e-05,-3.87488e-08,1.529e-11,13905.4,30.4748], Tmin=(100,'K'), Tmax=(1045.17,'K')), NASAPolynomial(coeffs=[9.2975,0.0406143,-1.60269e-05,2.94042e-09,-2.04639e-13,10882.3,-14.4398], Tmin=(1045.17,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(114.766,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(424.038,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cds-OdCsH) + ring(Cyclopentane) + radical(cyclopentane) + radical(CCCJ=O)"""),
)

species(
    label = '[CH2]C(CC=C)CC=O(3801)',
    structure = SMILES('[CH2]C(CC=C)CC=O'),
    E0 = (25.3789,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2782.5,750,1395,475,1775,1000,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (111.162,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.583739,0.0742497,-5.31664e-05,2.09889e-08,-3.55002e-12,3175.79,32.6042], Tmin=(100,'K'), Tmax=(1335.18,'K')), NASAPolynomial(coeffs=[11.1763,0.0425161,-1.75155e-05,3.18812e-09,-2.16994e-13,347.197,-21.5607], Tmin=(1335.18,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(25.3789,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-OdCsH) + group(Cds-CdsHH) + radical(Isobutyl)"""),
)

species(
    label = 'C=CCC[CH]CC=O(3802)',
    structure = SMILES('C=CCC[CH]CC=O'),
    E0 = (29.2402,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2950,3100,1380,975,1025,1650,2782.5,750,1395,475,1775,1000,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (111.162,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.665168,0.070794,-4.49659e-05,1.43683e-08,-1.90037e-12,3638.17,33.3081], Tmin=(100,'K'), Tmax=(1678.18,'K')), NASAPolynomial(coeffs=[14.1699,0.038605,-1.61943e-05,2.93863e-09,-1.97664e-13,-894.47,-38.8357], Tmin=(1678.18,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(29.2402,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cds-CdsCsH) + group(Cds-OdCsH) + group(Cds-CdsHH) + radical(CCJCC=O)"""),
)

species(
    label = 'CC1C[CH]CC1(3803)',
    structure = SMILES('CC1C[CH]CC1'),
    E0 = (61.3855,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2807.14,2864.29,2921.43,2978.57,3035.71,3092.86,3150,900,928.571,957.143,985.714,1014.29,1042.86,1071.43,1100,2750,2800,2850,1350,1500,750,1050,1375,1000,300,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (83.1515,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.50131,0.0150659,8.96061e-05,-1.16064e-07,4.26358e-11,7452.95,21.5166], Tmin=(100,'K'), Tmax=(972.445,'K')), NASAPolynomial(coeffs=[8.38991,0.0362672,-1.31623e-05,2.42358e-09,-1.74079e-13,4159.96,-17.7709], Tmin=(972.445,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(61.3855,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(403.252,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cyclopentane) + radical(cyclopentane)"""),
)

species(
    label = '[CH2]C1CCC1CC=O(3804)',
    structure = SMILES('[CH2]C1CCC1CC=O'),
    E0 = (46.7322,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2830,2910,2990,3070,3150,900,940,980,1020,1060,1100,2782.5,750,1395,475,1775,1000,3000,3100,440,815,1455,1000,2750,2850,1437.5,1250,1305,750,350,300,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (111.162,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.936601,0.0523924,1.72257e-05,-5.36657e-08,2.26816e-11,5744.06,29.4621], Tmin=(100,'K'), Tmax=(999.668,'K')), NASAPolynomial(coeffs=[13.1633,0.0385483,-1.46372e-05,2.68563e-09,-1.89438e-13,1546.75,-38.2875], Tmin=(999.668,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(46.7322,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(444.824,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + ring(Cyclobutane) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]C1CC(CC=O)C1(3805)',
    structure = SMILES('[CH2]C1CC(CC=O)C1'),
    E0 = (46.7322,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2830,2910,2990,3070,3150,900,940,980,1020,1060,1100,2782.5,750,1395,475,1775,1000,3000,3100,440,815,1455,1000,2750,2850,1437.5,1250,1305,750,350,300,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'C=COC1C[CH]CC1(3806)',
    structure = SMILES('C=COC1C[CH]CC1'),
    E0 = (-7.19912,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,3100,1380,975,1025,1650,2750,2807.14,2864.29,2921.43,2978.57,3035.71,3092.86,3150,900,928.571,957.143,985.714,1014.29,1042.86,1071.43,1100,3010,987.5,1337.5,450,1655,300,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    ...
    molecularWeight = (111.162,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.938988,0.0410642,7.34562e-05,-1.29816e-07,5.42323e-11,-731.658,28.3829], Tmin=(100,'K'), Tmax=(944.752,'K')), NASAPolynomial(coeffs=[20.2602,0.0255227,-7.07501e-06,1.25028e-09,-9.56745e-14,-7339.58,-79.3832], Tmin=(944.752,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-7.19912,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(448.981,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + ring(Cyclopentane) + radical(cyclopentane)"""),
)

species(
    label = 'O=CCC1C[C]CC1(3807)',
    ...
    molecularWeight = (110.154,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.18665,0.045245,3.19663e-05,-6.82097e-08,2.76721e-11,26231.9,27.8538], Tmin=(100,'K'), Tmax=(996.065,'K')), NASAPolynomial(coeffs=[13.5119,0.0356509,-1.36749e-05,2.55561e-09,-1.83267e-13,21797.1,-41.4961], Tmin=(996.065,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(217.14,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(424.038,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cds-OdCsH) + ring(Cyclopentane) + radical(CCJ2_triplet)"""),
)

species(
    label = 'C1=CC2CCC(C2)O1(3808)',
    structure = SMILES('C1=CC2CCC(C2)O1'),
    E0 = (-124.101,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2794.44,2838.89,2883.33,2927.78,2972.22,3016.67,3061.11,3105.56,3150,900,922.222,944.444,966.667,988.889,1011.11,1033.33,1055.56,1077.78,1100,300,800,800,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
    ],
    ...
    molecularWeight = (110.154,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.43816,0.0225066,0.000127821,-1.8754e-07,7.45568e-11,-14802.8,16.6663], Tmin=(100,'K'), Tmax=(950.035,'K')), NASAPolynomial(coeffs=[22.1353,0.0211589,-5.51242e-06,1.08005e-09,-9.22572e-14,-22607.2,-102.502], Tmin=(950.035,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-124.101,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + polycyclic(s3_5_6_ene_1)"""),
)

species(
    label = '[CH]1COC2CCC1C2(3809)',
    structure = SMILES('[CH]1COC2CCC1C2'),
    E0 = (-1.14653,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2790,2830,2870,2910,2950,2990,3030,3070,3110,3150,900,920,940,960,980,1000,1020,1040,1060,1080,1100,300,800,800,800,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
    ],
    ...
    molecularWeight = (111.162,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.94226,0.020789,0.000107217,-1.42749e-07,5.24362e-11,-42.117,20.1779], Tmin=(100,'K'), Tmax=(991.918,'K')), NASAPolynomial(coeffs=[12.563,0.0400654,-1.58501e-05,3.08568e-09,-2.28537e-13,-5204.38,-46.3757], Tmin=(991.918,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1.14653,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + polycyclic(s3_5_6_ane) + radical(CCJCO)"""),
)

species(
    label = 'C1CC2CC[C](C2)O1(3810)',
    structure = SMILES('C1CC2CC[C](C2)O1'),
    E0 = (-20.3448,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (111.162,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.63751,0.0367566,4.82082e-05,-7.29684e-08,2.58654e-11,-2348.93,19.4198], Tmin=(100,'K'), Tmax=(1059.04,'K')), NASAPolynomial(coeffs=[9.10315,0.046651,-1.9759e-05,3.78052e-09,-2.69667e-13,-6066.35,-27.1111], Tmin=(1059.04,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-20.3448,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + polycyclic(s3_5_6_ane) + radical(C2CsJOCs)"""),
)

species(
    label = 'C1C[C]2CCC(C2)O1(3811)',
    structure = SMILES('C1C[C]2CCC(C2)O1'),
    E0 = (-15.6259,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (111.162,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.83146,0.0333166,5.27854e-05,-7.37876e-08,2.52019e-11,-1789.22,19.9152], Tmin=(100,'K'), Tmax=(1078.71,'K')), NASAPolynomial(coeffs=[7.65726,0.0491113,-2.11807e-05,4.06381e-09,-2.89253e-13,-5221.91,-18.7176], Tmin=(1078.71,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-15.6259,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + polycyclic(s3_5_6_ane) + radical(Tertalkyl)"""),
)

species(
    label = '[CH]1C2CCOC1CC2(3812)',
    structure = SMILES('[CH]1C2CCOC1CC2'),
    E0 = (-1.14653,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2790,2830,2870,2910,2950,2990,3030,3070,3110,3150,900,920,940,960,980,1000,1020,1040,1060,1080,1100,300,800,800,800,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
    ],
...
species(
    label = '[CH]1CC2CC1CCO2(3813)',
    structure = SMILES('[CH]1CC2CC1CCO2'),
    E0 = (-6.50645,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2790,2830,2870,2910,2950,2990,3030,3070,3110,3150,900,920,940,960,980,1000,1020,1040,1060,1080,1100,300,800,800,800,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
    ],
    ...
    molecularWeight = (111.162,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.94363,0.0246735,8.78466e-05,-1.1633e-07,4.14316e-11,-690.627,20.2358], Tmin=(100,'K'), Tmax=(1021.61,'K')), NASAPolynomial(coeffs=[10.2665,0.0446944,-1.87925e-05,3.66459e-09,-2.6726e-13,-5136.53,-33.5318], Tmin=(1021.61,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-6.50645,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + polycyclic(s3_5_6_ane) + radical(Cs_S)"""),
)

species(
    label = '[CH]1CC2CCOC1C2(3814)',
    structure = SMILES('[CH]1CC2CCOC1C2'),
    E0 = (-1.14653,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2790,2830,2870,2910,2950,2990,3030,3070,3110,3150,900,920,940,960,980,1000,1020,1040,1060,1080,1100,300,800,800,800,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
    ],
...
species(
    label = '[CH]1C[C]2CCC(C2)O1(3815)',
    structure = SMILES('[CH]1C[C]2CCC(C2)O1'),
    E0 = (164.83,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2794.44,2838.89,2883.33,2927.78,2972.22,3016.67,3061.11,3105.56,3150,900,922.222,944.444,966.667,988.889,1011.11,1033.33,1055.56,1077.78,1100,300,800,800,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
    ],
    ...
    molecularWeight = (110.154,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.52272,0.0404818,3.27974e-05,-5.854e-08,2.14414e-11,19925.6,20.4654], Tmin=(100,'K'), Tmax=(1061.52,'K')), NASAPolynomial(coeffs=[10.0157,0.0424176,-1.78962e-05,3.41619e-09,-2.43341e-13,16210.3,-30.0223], Tmin=(1061.52,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(164.83,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + polycyclic(s3_5_6_ane) + radical(Tertalkyl) + radical(CCsJOCs)"""),
)

species(
    label = '[CH]1CC2CC[C](C2)O1(3816)',
    structure = SMILES('[CH]1CC2CC[C](C2)O1'),
    E0 = (160.111,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2794.44,2838.89,2883.33,2927.78,2972.22,3016.67,3061.11,3105.56,3150,900,922.222,944.444,966.667,988.889,1011.11,1033.33,1055.56,1077.78,1100,300,800,800,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
    ],
    ...
    molecularWeight = (110.154,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.334,0.0438538,2.8487e-05,-5.81086e-08,2.22883e-11,19365.6,19.9517], Tmin=(100,'K'), Tmax=(1040.25,'K')), NASAPolynomial(coeffs=[11.4832,0.0399256,-1.64582e-05,3.12937e-09,-2.23482e-13,15355.1,-38.5407], Tmin=(1040.25,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(160.111,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + polycyclic(s3_5_6_ane) + radical(C2CsJOCs) + radical(CCsJOCs)"""),
)

species(
    label = '[CH]1CC2[CH]C(CC2)O1(3817)',
    structure = SMILES('[CH]1CC2[CH]C(CC2)O1'),
    E0 = (179.309,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2794.44,2838.89,2883.33,2927.78,2972.22,3016.67,3061.11,3105.56,3150,900,922.222,944.444,966.667,988.889,1011.11,1033.33,1055.56,1077.78,1100,300,800,800,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
    ],
    ...
    molecularWeight = (110.154,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.64318,0.0278055,8.79232e-05,-1.28673e-07,4.93025e-11,21672.3,20.6956], Tmin=(100,'K'), Tmax=(979.413,'K')), NASAPolynomial(coeffs=[15.0901,0.0331057,-1.24205e-05,2.40518e-09,-1.79983e-13,16150,-58.6429], Tmin=(979.413,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(179.309,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + polycyclic(s3_5_6_ane) + radical(CCJCO) + radical(CCsJOCs)"""),
)

species(
    label = '[CH]1CC2[CH]CC(C2)O1(3818)',
    structure = SMILES('[CH]1CC2[CH]CC(C2)O1'),
    E0 = (173.95,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2794.44,2838.89,2883.33,2927.78,2972.22,3016.67,3061.11,3105.56,3150,900,922.222,944.444,966.667,988.889,1011.11,1033.33,1055.56,1077.78,1100,300,800,800,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
    ],
    ...
    molecularWeight = (110.154,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.64183,0.0317362,6.83181e-05,-1.01832e-07,3.80604e-11,21023.9,20.7624], Tmin=(100,'K'), Tmax=(1007.29,'K')), NASAPolynomial(coeffs=[12.729,0.0378383,-1.542e-05,2.99715e-09,-2.19763e-13,16247.1,-45.4313], Tmin=(1007.29,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(173.95,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + polycyclic(s3_5_6_ane) + radical(Cs_S) + radical(CCsJOCs)"""),
)

species(
    label = '[CH]1CC2C[CH]C(C2)O1(3819)',
    structure = SMILES('[CH]1CC2C[CH]C(C2)O1'),
    E0 = (179.309,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2794.44,2838.89,2883.33,2927.78,2972.22,3016.67,3061.11,3105.56,3150,900,922.222,944.444,966.667,988.889,1011.11,1033.33,1055.56,1077.78,1100,300,800,800,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
    ],
    ...
    molecularWeight = (110.154,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.64318,0.0278055,8.79232e-05,-1.28673e-07,4.93025e-11,21672.3,20.6956], Tmin=(100,'K'), Tmax=(979.413,'K')), NASAPolynomial(coeffs=[15.0901,0.0331057,-1.24205e-05,2.40518e-09,-1.79983e-13,16150,-58.6429], Tmin=(979.413,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(179.309,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + polycyclic(s3_5_6_ane) + radical(CCsJOCs) + radical(CCJCO)"""),
)

species(
    label = '[CH]1[CH]C2CCC(C2)O1(3820)',
    structure = SMILES('[CH]1[CH]C2CCC(C2)O1'),
    E0 = (179.309,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2794.44,2838.89,2883.33,2927.78,2972.22,3016.67,3061.11,3105.56,3150,900,922.222,944.444,966.667,988.889,1011.11,1033.33,1055.56,1077.78,1100,300,800,800,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
    ],
...
species(
    label = '[CH2]C1OC2CCC1C2(3821)',
    structure = SMILES('[CH2]C1OC2CCC1C2'),
    E0 = (20.2335,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2800,2850,2900,2950,3000,3050,3100,3150,900,925,950,975,1000,1025,1050,1075,1100,300,800,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (111.162,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.19576,0.0414853,5.32882e-05,-9.1412e-08,3.54234e-11,2552.25,20.426], Tmin=(100,'K'), Tmax=(1004.72,'K')), NASAPolynomial(coeffs=[14.4505,0.0380536,-1.52474e-05,2.93857e-09,-2.14655e-13,-2601.49,-55.9757], Tmin=(1004.72,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(20.2335,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + polycyclic(s3_5_5_ane) + radical(CJC(C)OC)"""),
)

species(
    label = '[C]1CC2CCC(C2)O1(3822)',
    structure = SMILES('[C]1CC2CCC(C2)O1'),
    E0 = (259.94,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2794.44,2838.89,2883.33,2927.78,2972.22,3016.67,3061.11,3105.56,3150,900,922.222,944.444,966.667,988.889,1011.11,1033.33,1055.56,1077.78,1100,300,800,800,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
    ],
    ...
    molecularWeight = (110.154,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.54985,0.031754,7.42333e-05,-1.11244e-07,4.19911e-11,31371.3,17.8228], Tmin=(100,'K'), Tmax=(1001.63,'K')), NASAPolynomial(coeffs=[14.31,0.0359476,-1.46384e-05,2.87884e-09,-2.13653e-13,26048.5,-57.5684], Tmin=(1001.63,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(259.94,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + polycyclic(s3_5_6_ane) + radical(CH2_triplet)"""),
)
...
reaction(
    label = 'reaction46',
    reactants = ['H(3)(3)', 'O=C=CC1CCCC1(3773)'],
    products = ['S(439)(438)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction52',
    reactants = ['CHCHO(45)(45)', '[CH]1CCCC1(3779)'],
    products = ['S(439)(438)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction53',
    reactants = ['H(3)(3)', '[O]C=C[C]1CCCC1(3780)'],
    products = ['S(439)(438)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction54',
    reactants = ['H(3)(3)', '[O]C=CC1[CH]CCC1(3781)'],
    products = ['S(439)(438)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction55',
    reactants = ['H(3)(3)', '[O]C=CC1C[CH]CC1(3782)'],
    products = ['S(439)(438)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(2e+13,'cm^3/(mol*s)','*|/',3.16), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), comment="""From training reaction 59 used for H_rad;C_rad/H/NonDeC
Exact match found for rate rule [C_rad/H/NonDeC;H_rad]
...
reaction(
    label = 'reaction56',
    reactants = ['H(3)(3)', '[O]C=[C]C1CCCC1(3783)'],
    products = ['S(439)(438)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction57',
    reactants = ['H(3)(3)', '[O][C]=CC1CCCC1(3784)'],
    products = ['S(439)(438)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction59',
    reactants = ['O(4)(4)', '[CH]=CC1CCCC1(3786)'],
    products = ['S(439)(438)'],
...
reaction(
    label = 'reaction66',
    reactants = ['HCO(14)(15)', '[CH]C1CCCC1(3790)'],
    products = ['S(439)(438)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(3)(3)', 'C=CCCC=CC=O(3754)'],
    products = ['S(438)(437)'],
...
reaction(
    label = 'reaction23',
    reactants = ['C2H4(19)(20)', '[CH2]CC=CC=O(3755)'],
    products = ['S(438)(437)'],
...
reaction(
    label = 'reaction30',
    reactants = ['[CH2]C[CH2](1090)', 'C=C[CH]C=O(2767)'],
    products = ['S(438)(437)'],
...
reaction(
    label = 'reaction31',
    reactants = ['C2H4(T)(890)', '[CH2]CC=CC=O(3755)'],
    products = ['S(438)(437)'],
    transitionState = 'TS33',
    kinetics = Arrhenius(A=(1.0512e+07,'m^3/(mol*s)'), n=0.135617, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [C_rad/H2/Cs;Y_rad]
Euclidian distance = 0
Multiplied by reaction path degeneracy 2.0
family: R_Recombination
...
reaction(
    label = 'reaction32',
    reactants = ['H(3)(3)', '[CH2]C[CH]CC=CC=O(3762)'],
    products = ['S(438)(437)'],
...
reaction(
    label = 'reaction33',
    reactants = ['[CH2]CC[CH2](1088)', 'CHCHCHO(2768)'],
    products = ['S(438)(437)'],
...
reaction(
    label = 'reaction34',
    reactants = ['H(3)(3)', '[CH2]CC[CH]C=CC=O(3763)'],
    products = ['S(438)(437)'],
...
reaction(
    label = 'reaction35',
    reactants = ['H(3)(3)', '[CH2][CH]CCC=CC=O(3764)'],
    products = ['S(438)(437)'],
...
reaction(
    label = 'reaction36',
    reactants = ['H(3)(3)', '[CH2]CCC[C]=CC=O(3765)'],
    products = ['S(438)(437)'],
...
reaction(
    label = 'reaction37',
    reactants = ['HCO(14)(15)', '[CH]=CCCC[CH2](3766)'],
    products = ['S(438)(437)'],
...
reaction(
    label = 'reaction38',
    reactants = ['H(3)(3)', '[CH2]CCCC=[C]C=O(3767)'],
    products = ['S(438)(437)'],
...
reaction(
    label = 'reaction39',
    reactants = ['H(3)(3)', '[CH2]CCCC=C[C]=O(1581)'],
    products = ['S(438)(437)'],
...
reaction(
    label = 'reaction42',
    reactants = ['CO(10)(11)', '[CH2]CCCC=C(3548)'],
    products = ['S(438)(437)'],
...
reaction(
    label = 'reaction44',
    reactants = ['CH2(17)(18)', '[CH2]CCC=CC=O(3771)'],
    products = ['S(438)(437)'],
...
reaction(
    label = 'reaction45',
    reactants = ['H(3)(3)', '[CH]CCCC=CC=O(3772)'],
    products = ['S(438)(437)'],
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)(3)', '[O]C1C=CCC[CH]C1(1567)'],
    products = ['S(437)(436)'],
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)(3)', '[O]C1[CH]CCCC=C1(1564)'],
    products = ['S(437)(436)'],
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)(3)', '[O]C1C=CC[CH]CC1(1574)'],
    products = ['S(437)(436)'],
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)(3)', '[O]C1=C[CH]CCCC1(1411)'],
    products = ['S(437)(436)'],
...
reaction(
    label = 'reaction6',
    reactants = ['H(3)(3)', '[O]C1C=C[CH]CCC1(1576)'],
    products = ['S(437)(436)'],
...
reaction(
    label = 'reaction7',
    reactants = ['H(3)(3)', '[O]C1[C]=CCCCC1(1565)'],
    products = ['S(437)(436)'],
...
reaction(
    label = 'reaction8',
    reactants = ['H(3)(3)', '[O]C1C=[C]CCCC1(1569)'],
    products = ['S(437)(436)'],
...
reaction(
    label = 'reaction67',
    reactants = ['S(441)(440)'],
    products = ['[O]C1CC2CCC1C2(3791)'],
    transitionState = 'TS67',
    kinetics = Arrhenius(A=(13013.2,'s^-1'), n=1.81618, Ea=(58.1211,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R6_SSS;multiplebond_intra;radadd_intra_csHNd] for rate rule [R6_SSS_CO;carbonylbond_intra_H;radadd_intra_csHNd]
Euclidian distance = 2.2360679775
family: Intra_R_Add_Exocyclic
Ea raised from 56.0 to 58.1 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction68',
    reactants = ['H(3)(3)', 'O=CCC1C=CCC1(3792)'],
    products = ['S(441)(440)'],
...
reaction(
    label = 'reaction69',
    reactants = ['H(3)(3)', 'O=CCC1CC=CC1(3793)'],
    products = ['S(441)(440)'],
...
reaction(
    label = 'reaction73',
    reactants = ['CH2CHO(38)(39)', '[CH]1C[CH]CC1(3794)'],
    products = ['S(441)(440)'],
    transitionState = 'TS73',
    kinetics = Arrhenius(A=(2.3e+08,'m^3/(mol*s)'), n=-0.35, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [C_pri_rad;C_rad/H/NonDeC] for rate rule [C_rad/H2/CO;C_rad/H/NonDeC]
Euclidian distance = 1.0
Multiplied by reaction path degeneracy 2.0
family: R_Recombination
...
reaction(
    label = 'reaction74',
    reactants = ['H(3)(3)', 'O=CC[C]1C[CH]CC1(3795)'],
    products = ['S(441)(440)'],
...
reaction(
    label = 'reaction75',
    reactants = ['H(3)(3)', 'O=CCC1[CH]C[CH]C1(3796)'],
    products = ['S(441)(440)'],
...
reaction(
    label = 'reaction76',
    reactants = ['H(3)(3)', 'O=CCC1[CH][CH]CC1(3797)'],
    products = ['S(441)(440)'],
...
reaction(
    label = 'reaction77',
    reactants = ['H(3)(3)', 'O=CCC1C[CH][CH]C1(3798)'],
    products = ['S(441)(440)'],
...
reaction(
    label = 'reaction78',
    reactants = ['HCO(14)(15)', '[CH2]C1C[CH]CC1(3799)'],
    products = ['S(441)(440)'],
...
reaction(
    label = 'reaction80',
    reactants = ['H(3)(3)', 'O=[C]CC1C[CH]CC1(3800)'],
    products = ['S(441)(440)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(487000,'s^-1'), n=1.17, Ea=(26.3592,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R6_SSS;multiplebond_intra;radadd_intra_csHCs] for rate rule [R6_SSS_CO;carbonyl_intra_H;radadd_intra_csHCs]
Euclidian distance = 2.2360679775
family: Intra_R_Add_Endocyclic"""),
)
...
reaction(
    label = 'reaction82',
    reactants = ['[CH2]C(CC=C)CC=O(3801)'],
    products = ['S(441)(440)'],
...
reaction(
    label = 'reaction83',
    reactants = ['C=CCC[CH]CC=O(3802)'],
    products = ['S(441)(440)'],
    transitionState = 'TS83',
    kinetics = Arrhenius(A=(4.64e+06,'s^-1'), n=1.15, Ea=(58.1576,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2500,'K'), comment="""From training reaction 25 used for R5_CsCs_HH_D;doublebond_intra_pri_2H;radadd_intra_csHCs
Exact match found for rate rule [R5_CsCs_HH_D;doublebond_intra_pri_2H;radadd_intra_csHCs]
Euclidian distance = 0
family: Intra_R_Add_Endocyclic"""),
)
...
reaction(
    label = 'reaction84',
    reactants = ['CO(10)(11)', 'CC1C[CH]CC1(3803)'],
    products = ['S(441)(440)'],
...
reaction(
    label = 'reaction86',
    reactants = ['[CH2]C1CC(CC=O)C1(3805)'],
    products = ['S(441)(440)'],
...
reaction(
    label = 'reaction89',
    reactants = ['H(3)(3)', 'O=CCC1C[C]CC1(3807)'],
    products = ['S(441)(440)'],
...
reaction(
    label = 'reaction90',
    reactants = ['H(3)(3)', 'C1=CC2CCC(C2)O1(3808)'],
    products = ['S(513)(512)'],
...
reaction(
    label = 'reaction92',
    reactants = ['S(513)(512)'],
    products = ['C1CC2CC[C](C2)O1(3810)'],
    transitionState = 'TS92',
    kinetics = Arrhenius(A=(7.5e+08,'s^-1'), n=0.9, Ea=(143.093,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""Estimated using template [R3H_SS;C_rad_out_H/NonDeC;Cs_H_out_Cs2_cy5] for rate rule [R3H_SS_O;C_rad_out_H/NonDeC;Cs_H_out_Cs2_cy5]
Euclidian distance = 1.0
family: intra_H_migration"""),
)
...
reaction(
    label = 'reaction93',
    reactants = ['S(513)(512)'],
    products = ['C1C[C]2CCC(C2)O1(3811)'],
...
reaction(
    label = 'reaction97',
    reactants = ['H(3)(3)', '[CH]1C[C]2CCC(C2)O1(3815)'],
    products = ['S(513)(512)'],
...
reaction(
    label = 'reaction98',
    reactants = ['H(3)(3)', '[CH]1CC2CC[C](C2)O1(3816)'],
    products = ['S(513)(512)'],
...
reaction(
    label = 'reaction99',
    reactants = ['H(3)(3)', '[CH]1CC2[CH]C(CC2)O1(3817)'],
    products = ['S(513)(512)'],
...
reaction(
    label = 'reaction100',
    reactants = ['H(3)(3)', '[CH]1CC2[CH]CC(C2)O1(3818)'],
    products = ['S(513)(512)'],
...
reaction(
    label = 'reaction101',
    reactants = ['H(3)(3)', '[CH]1CC2C[CH]C(C2)O1(3819)'],
    products = ['S(513)(512)'],
...
reaction(
    label = 'reaction102',
    reactants = ['H(3)(3)', '[CH]1[CH]C2CCC(C2)O1(3820)'],
    products = ['S(513)(512)'],
...
reaction(
    label = 'reaction104',
    reactants = ['[CH2]C1OC2CCC1C2(3821)'],
    products = ['S(513)(512)'],
...
reaction(
    label = 'reaction105',
    reactants = ['H(3)(3)', '[C]1CC2CCC(C2)O1(3822)'],
    products = ['S(513)(512)'],
