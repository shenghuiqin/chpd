...
species(
    ...
    E0 = (-39.1063,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2782.5,750,1395,475,1775,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5],'cm^-1')),
        HinderedRotor(inertia=(0.00292674,'amu*angstrom^2'), symmetry=1, barrier=(11.4836,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.33694,'amu*angstrom^2'), symmetry=1, barrier=(30.739,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (57.0712,'amu'),
