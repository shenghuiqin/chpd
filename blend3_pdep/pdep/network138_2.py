...
species(
    label = 'O=C[C-]=[OH+](3719)',
    structure = SMILES('O=C[C-]=[OH+]'),
    E0 = (172.12,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2782.5,750,1395,475,1775,1000,180,972.546,2226.65,2229.61,2230.32],'cm^-1')),
        HinderedRotor(inertia=(0.342081,'amu*angstrom^2'), symmetry=1, barrier=(7.8651,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (58.0361,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.1596,0.0251737,-4.96094e-05,5.72798e-08,-2.38623e-11,20725,13.3183], Tmin=(100,'K'), Tmax=(838.252,'K')), NASAPolynomial(coeffs=[0.5066,0.0207016,-1.09507e-05,2.15321e-09,-1.49987e-13,21771.7,29.2396], Tmin=(838.252,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(172.12,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(128.874,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cds-OdCsH) + group(CsJ2_singlet-CsH)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['H(3)(3)', 'OCHCO(59)(58)'],
    products = ['OCHCHO(46)(46)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction10',
    reactants = ['O=C[C-]=[OH+](3719)'],
    products = ['S(303)(302)'],
    transitionState = 'TS10',
    kinetics = Arrhenius(A=(6.14647e+14,'s^-1'), n=-1.07844, Ea=(56.8484,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [CsJ2-C;singletcarbene;CH]
Euclidian distance = 0
