...
species(
    ...
    E0 = (273.347,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2782.5,750,1395,475,1775,1000,1775.3,2035.28],'cm^-1')),
        HinderedRotor(inertia=(0.10891,'amu*angstrom^2'), symmetry=1, barrier=(2.857,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (42.0367,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.66977,0.00698953,2.70402e-06,-4.66686e-09,1.29289e-12,32888.1,9.36099], Tmin=(100,'K'), Tmax=(1428.7,'K')), NASAPolynomial(coeffs=[4.57088,0.00902816,-4.2255e-06,8.01352e-10,-5.50005e-14,32165.1,3.06293], Tmin=(1428.7,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(273.347,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(103.931,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cds-OdCsH) + group(CsJ2_singlet-CsH)"""),
)
...
species(
    ...
    E0 = (499.402,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,1000,180,430.239,2270.75,2271.99],'cm^-1')),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (41.0287,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.53856,0.0135512,-2.71187e-05,2.95077e-08,-1.15126e-11,60077.6,11.1074], Tmin=(100,'K'), Tmax=(870.434,'K')), NASAPolynomial(coeffs=[2.73235,0.00877372,-4.26828e-06,8.1101e-10,-5.50997e-14,60539.3,16.7308], Tmin=(870.434,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(499.402,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(108.088,'J/(mol*K)'), comment="""Thermo library: DFT_QCI_thermo + radical(C=CJO)"""),
)
...
species(
    label = '[C-]1C[O+]=1(6179)',
    structure = SMILES('[C-]1C[O+]=1'),
    E0 = (531.698,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,3150,900,1100,394.409,394.932,397.391,4000,4000],'cm^-1')),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (42.0367,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.33875,0.0122035,-6.27e-06,-3.2082e-10,6.50275e-13,63974.1,-3.68947], Tmin=(100,'K'), Tmax=(1310,'K')), NASAPolynomial(coeffs=[7.44152,0.00436674,-2.66781e-06,5.79431e-10,-4.31763e-14,62496.7,-26.1271], Tmin=(1310,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(531.698,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(108.088,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsCs) + group(CsJ2_singlet-CsH) + ring(Cyclopropene)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['H(3)(3)', 'HCCO(47)(47)'],
    products = ['CHCHO(45)(45)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction4',
    reactants = ['CHCHO(45)(45)'],
    products = ['[CH2][C]=O(3723)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['CHCHO(45)(45)'],
    products = ['C2H2O(100)(99)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(2.18e+16,'s^-1'), n=0, Ea=(13.9134,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R3;Y_rad_out;Ypri_rad_out] for rate rule [R3_SD;O_rad;CdsinglepriH_rad_out]
