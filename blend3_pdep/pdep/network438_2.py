species(
    ...
    E0 = (-104.402,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,200,800,1600],'cm^-1')),
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.950451,0.0711904,-5.67144e-05,2.69631e-08,-5.75195e-12,-12450.3,27.0285], Tmin=(100,'K'), Tmax=(1056.25,'K')), NASAPolynomial(coeffs=[7.78237,0.045318,-1.99725e-05,3.77287e-09,-2.63131e-13,-13893.6,-6.30545], Tmin=(1056.25,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-104.402,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(ROOJ)"""),
)
...
species(
    ...
    E0 = (-61.9605,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'CC[CH]CCO[O](5640)',
    structure = SMILES('CC[CH]CCO[O]'),
    E0 = (90.0562,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.894159,0.0754778,-9.48752e-05,8.32094e-08,-3.05811e-11,10936.2,29.7845], Tmin=(100,'K'), Tmax=(813.63,'K')), NASAPolynomial(coeffs=[3.62287,0.0491007,-2.23498e-05,4.20362e-09,-2.8904e-13,10921.2,19.8194], Tmin=(813.63,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(90.0562,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(RCCJCC)"""),
)
...
species(
    label = 'CCC[CH]CO[O](5491)',
    structure = SMILES('CCC[CH]CO[O]'),
    E0 = (96.0129,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (102.132,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.827919,0.0748844,-7.81756e-05,5.31414e-08,-1.59736e-11,11657.3,29.7783], Tmin=(100,'K'), Tmax=(785.058,'K')), NASAPolynomial(coeffs=[6.79338,0.0444884,-2.00964e-05,3.81926e-09,-2.66537e-13,10720.7,2.44219], Tmin=(785.058,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(96.0129,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCJCOOH) + radical(ROOJ)"""),
)
...
species(
    label = 'C[CH]CCCO[O](5641)',
    structure = SMILES('C[CH]CCCO[O]'),
    E0 = (90.0442,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (102.132,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.868161,0.0748552,-8.91004e-05,7.39658e-08,-2.63257e-11,10936.8,30.0506], Tmin=(100,'K'), Tmax=(800.812,'K')), NASAPolynomial(coeffs=[4.67113,0.0472289,-2.11875e-05,3.97098e-09,-2.73078e-13,10604.5,14.2762], Tmin=(800.812,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(90.0442,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(RCCJC)"""),
)

species(
    label = 'CCCC[CH]O[O](3988)',
...
species(
    label = 'CCC[CH]COO(5638)',
    structure = SMILES('CCC[CH]COO'),
    E0 = (-55.9918,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (103.14,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.773662,0.076018,-6.48778e-05,3.2504e-08,-7.20342e-12,-6622.32,29.2132], Tmin=(100,'K'), Tmax=(1029.32,'K')), NASAPolynomial(coeffs=[8.54304,0.0458255,-2.08788e-05,4.00662e-09,-2.81973e-13,-8221.74,-8.49404], Tmin=(1029.32,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-55.9918,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(407.409,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCJCOOH)"""),
)

species(
    label = 'CC[CH]CCOO(5639)',
    structure = SMILES('CC[CH]CCOO'),
    E0 = (-61.9485,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (103.14,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.74869,0.0609296,8.11909e-06,-1.41965e-07,1.39239e-10,-7381.62,26.2191], Tmin=(100,'K'), Tmax=(438.012,'K')), NASAPolynomial(coeffs=[4.84723,0.051435,-2.37536e-05,4.54621e-09,-3.17897e-13,-7833.42,11.7695], Tmin=(438.012,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-61.9485,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(407.409,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(RCCJCC)"""),
)

species(
    label = '[CH2]CCCCOO(5135)',
    structure = SMILES('[CH2]CCCCOO'),
    E0 = (-51.1604,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,3000,3100,440,815,1455,1000,2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (103.14,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.769014,0.0750264,-6.09012e-05,2.79895e-08,-5.6142e-12,-6040.22,28.7037], Tmin=(100,'K'), Tmax=(1131.53,'K')), NASAPolynomial(coeffs=[9.53865,0.0440256,-1.98055e-05,3.77715e-09,-2.64751e-13,-8024.86,-14.6884], Tmin=(1131.53,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-51.1604,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(407.409,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(RCCJ)"""),
)
...
species(
    ...
    E0 = (-102.207,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,2750,2800,2850,1350,1500,750,1050,1375,1000,262.415,262.442,262.567,2309.23],'cm^-1')),
        HinderedRotor(inertia=(0.138268,'amu*angstrom^2'), symmetry=1, barrier=(6.76461,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.138522,'amu*angstrom^2'), symmetry=1, barrier=(6.76345,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00244605,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00244749,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (87.1402,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.99416,0.0524083,-2.52597e-05,5.29933e-09,-4.20646e-13,-12229.1,22.5801], Tmin=(100,'K'), Tmax=(3189.54,'K')), NASAPolynomial(coeffs=[27.028,0.0173468,-7.04642e-06,1.13204e-09,-6.57579e-14,-26333.4,-124.306], Tmin=(3189.54,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-102.207,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(390.78,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCOJ)"""),
)
...
species(
    ...
    E0 = (-140.87,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,301.408,301.41],'cm^-1')),
        HinderedRotor(inertia=(0.134149,'amu*angstrom^2'), symmetry=1, barrier=(8.64839,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.134149,'amu*angstrom^2'), symmetry=1, barrier=(8.64834,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.13415,'amu*angstrom^2'), symmetry=1, barrier=(8.64835,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.273203,'amu*angstrom^2'), symmetry=1, barrier=(17.6127,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.482893,'amu*angstrom^2'), symmetry=1, barrier=(31.1301,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (102.132,'amu'),
...
species(
    label = 'C[CH]C[CH]COO(5645)',
    structure = SMILES('C[CH]C[CH]COO'),
    E0 = (138.454,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,3000,3050,390,425,1340,1360,335,370,2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'C[CH][CH]CCOO(5646)',
    structure = SMILES('C[CH][CH]CCOO'),
    E0 = (132.498,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,3000,3050,390,425,1340,1360,335,370,2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,206.784,808.031,1636.36],'cm^-1')),
        HinderedRotor(inertia=(0.148382,'amu*angstrom^2'), symmetry=1, barrier=(3.56841,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.148382,'amu*angstrom^2'), symmetry=1, barrier=(3.56841,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.148382,'amu*angstrom^2'), symmetry=1, barrier=(3.56841,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.148382,'amu*angstrom^2'), symmetry=1, barrier=(3.56841,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.148382,'amu*angstrom^2'), symmetry=1, barrier=(3.56841,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (102.132,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.833569,0.0792479,-0.000109662,1.02807e-07,-3.88729e-11,16040.5,31.977], Tmin=(100,'K'), Tmax=(829.513,'K')), NASAPolynomial(coeffs=[2.10589,0.0526402,-2.45271e-05,4.63371e-09,-3.1826e-13,16533.8,30.3222], Tmin=(829.513,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(132.498,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(RCCJC) + radical(RCCJCC)"""),
)

species(
    label = 'C[CH]CC[CH]OO(4024)',
    structure = SMILES('C[CH]CC[CH]OO'),
    E0 = (126.622,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,3000,3050,390,425,1340,1360,335,370,2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (102.132,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.609505,0.0811668,-0.000101192,8.47442e-08,-3.02397e-11,15344.9,30.3697], Tmin=(100,'K'), Tmax=(784.131,'K')), NASAPolynomial(coeffs=[5.46295,0.04816,-2.22731e-05,4.23191e-09,-2.93325e-13,14837.3,9.75182], Tmin=(784.131,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(126.622,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCsJOOH) + radical(RCCJC)"""),
)
...
species(
    label = 'CC1CCCO1(5647)',
    structure = SMILES('CC1CCCO1'),
    E0 = (-234.985,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (86.1323,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.23153,0.0203293,8.32964e-05,-1.23423e-07,5.04024e-11,-28181.2,15.7655], Tmin=(100,'K'), Tmax=(906.305,'K')), NASAPolynomial(coeffs=[11.8894,0.0259201,-5.75752e-06,7.84799e-10,-5.1895e-14,-31912,-40.8024], Tmin=(906.305,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-234.985,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(378.308,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Tetrahydrofuran)"""),
)

species(
    label = '[CH2]C(C)CCOO(5648)',
    ...
    molecularWeight = (103.14,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.519386,0.076376,-6.32924e-05,2.96057e-08,-5.86702e-12,-6732.37,29.31], Tmin=(100,'K'), Tmax=(1174.67,'K')), NASAPolynomial(coeffs=[11.297,0.0396751,-1.6426e-05,3.00687e-09,-2.05982e-13,-9264.35,-24.4207], Tmin=(1174.67,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-57.0187,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(407.409,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Isobutyl)"""),
)

species(
    label = 'CC(O)CCC[O](5649)',
    ...
    molecularWeight = (103.14,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.89916,0.0736973,-7.06661e-05,4.65406e-08,-1.41876e-11,-32929.3,28.919], Tmin=(100,'K'), Tmax=(760.406,'K')), NASAPolynomial(coeffs=[5.54113,0.0492784,-2.24957e-05,4.30761e-09,-3.02284e-13,-33635.3,7.7957], Tmin=(760.406,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-274.677,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCOJ)"""),
)
...
species(
    label = 'C[C]CCCOO(5650)',
    structure = SMILES('C[C]CCCOO'),
    E0 = (191.808,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (102.132,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.6319,0.077848,-7.14825e-05,3.71586e-08,-8.24226e-12,23187.4,27.3193], Tmin=(100,'K'), Tmax=(1051.7,'K')), NASAPolynomial(coeffs=[10.4121,0.0406503,-1.84292e-05,3.5285e-09,-2.48081e-13,21130.2,-20.3577], Tmin=(1051.7,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(191.808,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCJ2_triplet)"""),
)
...
reaction(
    label = 'reaction7',
    reactants = ['C3H7(69)(68)', '[CH2]CO[O](1430)'],
    products = ['S(75)(74)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction8',
    reactants = ['C2H5(27)(28)', '[CH2]CCO[O](4258)'],
    products = ['S(75)(74)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(8.73e+14,'cm^3/(mol*s)'), n=-0.699, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(200,'K'), Tmax=(2000,'K'), comment="""From training reaction 11 used for C_rad/H2/Cs;C_rad/H2/Cs
Exact match found for rate rule [C_rad/H2/Cs;C_rad/H2/Cs]
...
reaction(
    label = 'reaction9',
    reactants = ['H(3)(3)', 'CC[CH]CCO[O](5640)'],
    products = ['S(75)(74)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction10',
    reactants = ['C4H9(68)(67)', '[CH2]O[O](1428)'],
    products = ['S(75)(74)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction11',
    reactants = ['H(3)(3)', 'CCC[CH]CO[O](5491)'],
    products = ['S(75)(74)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(2e+13,'cm^3/(mol*s)','*|/',3.16), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), comment="""From training reaction 59 used for H_rad;C_rad/H/NonDeC
Exact match found for rate rule [C_rad/H/NonDeC;H_rad]
...
reaction(
    label = 'reaction12',
    reactants = ['CH3(15)(16)', '[CH2]CCCO[O](4255)'],
    products = ['S(75)(74)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction13',
    reactants = ['H(3)(3)', 'C[CH]CCCO[O](5641)'],
    products = ['S(75)(74)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(2e+13,'cm^3/(mol*s)','*|/',3.16), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), comment="""From training reaction 59 used for H_rad;C_rad/H/NonDeC
Exact match found for rate rule [C_rad/H/NonDeC;H_rad]
...
reaction(
    label = 'reaction14',
    reactants = ['H(3)(3)', 'CCCC[CH]O[O](3988)'],
    products = ['S(75)(74)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction15',
    reactants = ['H(3)(3)', '[CH2]CCCCO[O](4256)'],
    products = ['S(75)(74)'],
...
reaction(
    label = 'reaction11',
    reactants = ['C4H9O2(76)(75)', 'CH2(S)(21)(22)'],
    products = ['S(75)(74)'],
...
reaction(
    label = 'reaction21',
    reactants = ['C3H6(83)(82)', 'C2H5O2(43)(43)'],
    products = ['S(104)(103)'],
...
reaction(
    label = 'reaction26',
    reactants = ['OH(5)(5)', 'C[CH]CCC[O](5644)'],
    products = ['S(104)(103)'],
...
reaction(
    label = 'reaction27',
    reactants = ['HO2(8)(9)', '[CH2]CC[CH]C(1013)'],
    products = ['S(104)(103)'],
...
reaction(
    label = 'reaction29',
    reactants = ['C2H5O2(43)(43)', 'C3H6(T)(1015)'],
    products = ['S(104)(103)'],
...
reaction(
    label = 'reaction30',
    reactants = ['CH2OOH(33)(34)', '[CH2]C[CH]C(1012)'],
    products = ['S(104)(103)'],
...
reaction(
    label = 'reaction31',
    reactants = ['H(3)(3)', 'C[CH]C[CH]COO(5645)'],
    products = ['S(104)(103)'],
...
reaction(
    label = 'reaction32',
    reactants = ['H(3)(3)', 'C[CH][CH]CCOO(5646)'],
    products = ['S(104)(103)'],
...
reaction(
    label = 'reaction33',
    reactants = ['H(3)(3)', 'C[CH]CC[CH]OO(4024)'],
    products = ['S(104)(103)'],
...
reaction(
    label = 'reaction34',
    reactants = ['H(3)(3)', '[CH2][CH]CCCOO(4272)'],
    products = ['S(104)(103)'],
...
reaction(
    label = 'reaction37',
    reactants = ['S(104)(103)'],
    products = ['CC(O)CCC[O](5649)'],
    transitionState = 'TS37',
    kinetics = Arrhenius(A=(1e+10,'s^-1'), n=0, Ea=(65.2704,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""Matched reaction 7 C5H11O2-3 <=> C5H11O2-4 in intra_OH_migration/training
This reaction matched rate rule [R4OOH_SSS;C_rad_out_H/NonDeC]
family: intra_OH_migration"""),
)

reaction(
    label = 'reaction38',
    reactants = ['QOOH_1(97)(96)', 'CHCH3(T)(1022)'],
    products = ['S(104)(103)'],
...
reaction(
    label = 'reaction39',
    reactants = ['CH3(15)(16)', '[CH]CCCOO(4283)'],
    products = ['S(104)(103)'],
...
reaction(
    label = 'reaction40',
    reactants = ['H(3)(3)', 'C[C]CCCOO(5650)'],
    products = ['S(104)(103)'],
...
network(
    ...
    reactants = [
        ('O2(2)(2)', 'C5H11(67)(66)'),
        ('C4H9O2(76)(75)', 'CH2(S)(21)(22)'),
        ('HO2(8)(9)', 'C5H10(82)(81)'),
        ('C3H6(83)(82)', 'C2H5O2(43)(43)'),
    ],
    bathGas = {
        'Ne': 0.333333,
        'N2': 0.333333,
