...
species(
    ...
    E0 = (330.576,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,180,701.527,4000],'cm^-1')),
        HinderedRotor(inertia=(1.13973,'amu*angstrom^2'), symmetry=1, barrier=(26.2046,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00148404,'amu*angstrom^2'), symmetry=1, barrier=(5.90688,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (42.0797,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.96962,0.0196527,-1.06346e-06,-6.43555e-09,2.33648e-12,39798.6,11.2068], Tmin=(100,'K'), Tmax=(1253.31,'K')), NASAPolynomial(coeffs=[5.57598,0.0181989,-7.53911e-06,1.37907e-09,-9.40165e-14,38606.1,-4.10666], Tmin=(1253.31,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(330.576,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsHHH) + group(CsJ2_singlet-CsH)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['C2H4(19)(20)', 'CH2(S)(21)(22)'],
    products = ['C3H6(83)(82)'],
    transitionState = 'TS2',
