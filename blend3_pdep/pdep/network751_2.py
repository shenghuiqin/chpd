species(
    ...
    E0 = (-265.571,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,492.5,1135,1000,200,800,1200,1600],'cm^-1')),
...
species(
    ...
    E0 = (-432.137,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,1380,1390,370,380,2900,435,375,552.5,462.5,1710,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'C=C(CCC)OO(8009)',
    structure = SMILES('C=C(CCC)OO'),
    E0 = (-130.366,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,2950,3100,1380,975,1025,1650,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.61035,'amu*angstrom^2'), symmetry=1, barrier=(14.0332,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00266638,'amu*angstrom^2'), symmetry=1, barrier=(1.91141,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0831496,'amu*angstrom^2'), symmetry=1, barrier=(1.91177,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.6104,'amu*angstrom^2'), symmetry=1, barrier=(14.0343,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.610347,'amu*angstrom^2'), symmetry=1, barrier=(14.0331,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
species(
    label = 'C=C(CC(C)OO)OO(8010)',
    structure = SMILES('C=C(CC(C)OO)OO'),
    E0 = (-231.331,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,3100,1380,975,1025,1650,2750,2800,2850,1350,1500,750,1050,1375,1000,3580,3650,1300,1320,350,425,825,875,900,1100,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,350,440,435,1725,200,800],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2][C](CCC)OO(8014)',
    structure = SMILES('[CH2][C](CCC)OO'),
    E0 = (131.812,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,360,370,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,200,800],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'CCC[C](C[CH]OO)OO(8015)',
    structure = SMILES('CCC[C](C[CH]OO)OO'),
    E0 = (-5.67083,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3580,3650,1300,1320,350,425,825,875,900,1100,360,370,350,3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.57417,0.133631,-0.000189525,1.60922e-07,-5.6135e-11,-491.898,41.1303], Tmin=(100,'K'), Tmax=(782.586,'K')), NASAPolynomial(coeffs=[10.0561,0.062336,-3.01617e-05,5.81602e-09,-4.05363e-13,-1949.39,-9.80965], Tmin=(782.586,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-5.67083,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(494.711,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(C2CsJOOH) + radical(CCsJOOH)"""),
)

species(
    label = 'CCC[C](C[C](C)OO)OO(8016)',
    structure = SMILES('CCC[C](C[C](C)OO)OO'),
    E0 = (-43.7774,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3580,3650,1300,1320,350,425,825,875,900,1100,360,363.333,366.667,370,300,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2][C](CC(C)OO)OO(8017)',
    structure = SMILES('[CH2][C](CC(C)OO)OO'),
    E0 = (30.8466,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([360,370,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3580,3650,1300,1320,350,425,825,875,900,1100,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,200,800],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2]C[C](CC(C)OO)OO(8018)',
    structure = SMILES('[CH2]C[C](CC(C)OO)OO'),
    E0 = (-1.64988,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([360,370,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3580,3650,1300,1320,350,425,825,875,900,1100,1380,1390,370,380,2900,435,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3100,440,815,1455,1000,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (148.157,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.31938,0.126494,-0.000160246,1.20308e-07,-3.78807e-11,-15.6027,41.5278], Tmin=(100,'K'), Tmax=(765.383,'K')), NASAPolynomial(coeffs=[11.5461,0.0592564,-2.84722e-05,5.52888e-09,-3.89294e-13,-1984.98,-17.1005], Tmin=(765.383,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1.64988,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(494.711,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(C2CsJOOH) + radical(RCCJ)"""),
)

species(
    label = 'C[CH]C[C](CC(C)OO)OO(8019)',
    structure = SMILES('C[CH]C[C](CC(C)OO)OO'),
    E0 = (-36.2302,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,360,370,350,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3580,3650,1300,1320,350,425,825,875,900,1100,1380,1390,370,380,2900,435,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (162.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.739473,0.123292,-8.85265e-05,-5.88793e-08,1.0286e-10,-4206.16,42.8998], Tmin=(100,'K'), Tmax=(494.607,'K')), NASAPolynomial(coeffs=[9.8967,0.0712797,-3.39164e-05,6.51649e-09,-4.5428e-13,-5674.25,-5.13055], Tmin=(494.607,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-36.2302,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(565.384,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJC) + radical(C2CsJOOH)"""),
)

species(
    label = 'CCC[C]([CH]C(C)OO)OO(8020)',
...
species(
    label = '[CH2]C(C[C](CCC)OO)OO(8022)',
    structure = SMILES('[CH2]C(C[C](CCC)OO)OO'),
    E0 = (-16.7139,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([360,370,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3580,3650,1300,1320,350,425,825,875,900,1100,1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3000,3100,440,815,1455,1000,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (162.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.0095,0.142461,-0.000173474,1.23574e-07,-3.68726e-11,-1803.06,46.4661], Tmin=(100,'K'), Tmax=(805.857,'K')), NASAPolynomial(coeffs=[13.361,0.0661691,-3.14702e-05,6.10032e-09,-4.29807e-13,-4280.42,-24.3705], Tmin=(805.857,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-16.7139,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(565.384,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(C2CsJOOH) + radical(CJCOOH)"""),
)

species(
    label = '[CH2]CC[C](CC(C)OO)OO(8023)',
...
species(
    label = 'CCC[C](CCOO)OO(8024)',
    structure = SMILES('CCC[C](CCOO)OO'),
    E0 = (-194.253,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3580,3650,1300,1320,350,425,825,875,900,1100,360,370,350,2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'CC[C](CC(C)OO)OO(8025)',
    structure = SMILES('CC[C](CC(C)OO)OO'),
    E0 = (-206.896,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3580,3650,1300,1320,350,425,825,875,900,1100,360,370,350,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,1380,1390,370,380,2900,435,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'CCCC([CH]C(C)OO)OO(7985)',
    structure = SMILES('CCCC([CH]C(C)OO)OO'),
    E0 = (-217.161,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3580,3650,1300,1320,350,425,825,875,900,1100,3025,407.5,1350,352.5,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2]C(CCC)(OO)C(C)OO(8027)',
    structure = SMILES('[CH2]C(CCC)(OO)C(C)OO'),
    E0 = (-214.902,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3580,3650,1300,1320,350,425,825,875,900,1100,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,200,800,933.333,1066.67,1200,1333.33,1466.67,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2]C(CC)(CC(C)OO)OO(8028)',
...
species(
    label = 'CC(C[C]OO)OO(8033)',
    structure = SMILES('CC(C[C]OO)OO'),
    E0 = (127.396,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3580,3650,1300,1320,350,425,825,875,900,1100,2750,2800,2850,1350,1500,750,1050,1375,1000,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'CCCC([O])CC(C)O[O](7991)',
    structure = SMILES('CCCC([O])CC(C)O[O]'),
    E0 = (-106.715,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'CCCC(CC(C)O[O])O[O](7992)',
    structure = SMILES('CCCC(CC(C)O[O])O[O]'),
    E0 = (-113.566,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([470,515,1100,1170,900,1100,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'CC(C[CH]OO)O[O](7993)',
    structure = SMILES('CC(C[CH]OO)O[O]'),
    E0 = (6.99526,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,492.5,1135,1000,200,800],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'CCCC(C[CH]O[O])OO(7995)',
    structure = SMILES('CCCC(C[CH]O[O])OO'),
    E0 = (-40.5652,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,492.5,1135,1000,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'CCCC([CH]C(C)O[O])OO(7997)',
    structure = SMILES('CCCC([CH]C(C)O[O])OO'),
    E0 = (-65.156,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3615,1310,387.5,850,1000,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,492.5,1135,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (162.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.73968,0.135049,-0.000153784,1.01964e-07,-2.83937e-11,-7637.47,46.2722], Tmin=(100,'K'), Tmax=(859.648,'K')), NASAPolynomial(coeffs=[13.5492,0.0639106,-2.96582e-05,5.70657e-09,-4.01193e-13,-10266.2,-25.1761], Tmin=(859.648,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-65.156,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(569.541,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJCOOH) + radical(ROOJ)"""),
)

species(
    label = '[CH2]C(CC(C)O[O])OO(7998)',
    structure = SMILES('[CH2]C(CC(C)O[O])OO'),
    E0 = (-4.04784,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,492.5,1135,1000,3615,1310,387.5,850,1000,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,3000,3100,440,815,1455,1000,2750,2850,1437.5,1250,1305,750,350,200,800],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'CC[CH]C(CC(C)O[O])OO(7999)',
...
species(
    label = 'C[CH]CC(CC(C)O[O])OO(8001)',
...
species(
    label = '[CH2]C(CC(CCC)OO)O[O](7735)',
...
species(
    label = '[CH2]CCC(CC(C)O[O])OO(8002)',
    ...
    molecularWeight = (162.184,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.68936,0.133315,-0.000146829,9.31308e-08,-2.4792e-11,-7057.52,45.5726], Tmin=(100,'K'), Tmax=(897.027,'K')), NASAPolynomial(coeffs=[14.1091,0.0628679,-2.90285e-05,5.5831e-09,-3.92839e-13,-9891.87,-28.9292], Tmin=(897.027,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-60.3245,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(569.541,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(RCCJ)"""),
)

species(
    label = 'CCCC(CCO[O])OO(8003)',
...
species(
    label = 'CCC(CC(C)O[O])OO(8004)',
    structure = SMILES('CCC(CC(C)O[O])OO'),
    E0 = (-241.791,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,492.5,1135,1000,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
reaction(
    label = 'reaction32',
    reactants = ['H(3)(3)', 'CCCC(=CC(C)OO)OO(8007)'],
    products = ['S(118)(117)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction33',
    reactants = ['H(3)(3)', 'CCC=C(CC(C)OO)OO(8008)'],
    products = ['S(118)(117)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(137.12,'m^3/(mol*s)'), n=1.63155, Ea=(4.2466,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Cds-CsH_Cds;HJ] for rate rule [Cds-CsH_Cds-OsCs;HJ]
Euclidian distance = 1.0
...
reaction(
    label = 'reaction34',
    reactants = ['C2H5O2(61)(60)', 'C=C(CCC)OO(8009)'],
    products = ['S(118)(117)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction35',
    reactants = ['C2H5(27)(28)', 'C=C(CC(C)OO)OO(8010)'],
    products = ['S(118)(117)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction44',
    reactants = ['OH(5)(5)', 'CCC[C](CC(C)[O])OO(8011)'],
    products = ['S(118)(117)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction45',
    reactants = ['HO2(8)(9)', 'C[CH]C[C](CCC)OO(4384)'],
    products = ['S(118)(117)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction46',
    reactants = ['OH(5)(5)', 'CCC[C]([O])CC(C)OO(8012)'],
    products = ['S(118)(117)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction47',
    reactants = ['H(3)(3)', 'CCC[C](CC(C)O[O])OO(7994)'],
    products = ['S(118)(117)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction48',
    reactants = ['H(3)(3)', 'CCC[C](CC(C)OO)O[O](8013)'],
    products = ['S(118)(117)'],
...
reaction(
    label = 'reaction49',
    reactants = ['C2H5O2(61)(60)', '[CH2][C](CCC)OO(8014)'],
    products = ['S(118)(117)'],
...
reaction(
    label = 'reaction50',
    reactants = ['CH3(15)(16)', 'CCC[C](C[CH]OO)OO(8015)'],
    products = ['S(118)(117)'],
...
reaction(
    label = 'reaction51',
    reactants = ['H(3)(3)', 'CCC[C](C[C](C)OO)OO(8016)'],
    products = ['S(118)(117)'],
...
reaction(
    label = 'reaction52',
    reactants = ['C2H5(27)(28)', '[CH2][C](CC(C)OO)OO(8017)'],
    products = ['S(118)(117)'],
...
reaction(
    label = 'reaction53',
    reactants = ['CH3(15)(16)', '[CH2]C[C](CC(C)OO)OO(8018)'],
    products = ['S(118)(117)'],
...
reaction(
    label = 'reaction54',
    reactants = ['H(3)(3)', 'C[CH]C[C](CC(C)OO)OO(8019)'],
    products = ['S(118)(117)'],
...
reaction(
    label = 'reaction55',
    reactants = ['H(3)(3)', 'CCC[C]([CH]C(C)OO)OO(8020)'],
    products = ['S(118)(117)'],
...
reaction(
    label = 'reaction56',
    reactants = ['H(3)(3)', 'CC[CH][C](CC(C)OO)OO(8021)'],
    products = ['S(118)(117)'],
...
reaction(
    label = 'reaction57',
    reactants = ['H(3)(3)', '[CH2]C(C[C](CCC)OO)OO(8022)'],
    products = ['S(118)(117)'],
...
reaction(
    label = 'reaction58',
    reactants = ['H(3)(3)', '[CH2]CC[C](CC(C)OO)OO(8023)'],
    products = ['S(118)(117)'],
...
reaction(
    label = 'reaction59',
    reactants = ['CH2(S)(21)(22)', 'CCC[C](CCOO)OO(8024)'],
    products = ['S(118)(117)'],
...
reaction(
    label = 'reaction22',
    reactants = ['CH2(S)(21)(22)', 'CC[C](CC(C)OO)OO(8025)'],
    products = ['S(118)(117)'],
...
reaction(
    label = 'reaction37',
    reactants = ['CCCC([CH]C(C)OO)OO(7985)'],
    products = ['S(118)(117)'],
...
reaction(
    label = 'reaction38',
    reactants = ['CC[CH]C(CC(C)OO)OO(7987)'],
    products = ['S(118)(117)'],
...
reaction(
    label = 'reaction39',
    reactants = ['CCCC(CC(C)OO)O[O](7988)'],
    products = ['S(118)(117)'],
...
reaction(
    label = 'reaction40',
    reactants = ['CCCC(C[C](C)OO)OO(7984)'],
    products = ['S(118)(117)'],
...
reaction(
    label = 'reaction41',
    reactants = ['C[CH]CC(CC(C)OO)OO(7989)'],
    products = ['S(118)(117)'],
...
reaction(
    label = 'reaction42',
    reactants = ['[CH2]C(CC(CCC)OO)OO(7986)'],
    products = ['S(118)(117)'],
...
reaction(
    label = 'reaction43',
    reactants = ['[CH2]CCC(CC(C)OO)OO(7990)'],
    products = ['S(118)(117)'],
...
reaction(
    label = 'reaction61',
    reactants = ['S(118)(117)'],
    products = ['OH(5)(5)', 'CCCC1(CC(C)O1)OO(8026)'],
...
reaction(
    label = 'reaction62',
    reactants = ['[CH2]C(CCC)(OO)C(C)OO(8027)'],
    products = ['S(118)(117)'],
...
reaction(
    label = 'reaction63',
    reactants = ['[CH2]C(CC)(CC(C)OO)OO(8028)'],
    products = ['S(118)(117)'],
...
reaction(
    label = 'reaction64',
    reactants = ['S(118)(117)'],
    products = ['CCCC([O])(O)CC(C)OO(8029)'],
...
reaction(
    label = 'reaction65',
    reactants = ['S(118)(117)'],
    products = ['CCCC(O)(CC(C)[O])OO(8030)'],
...
reaction(
    label = 'reaction66',
    reactants = ['HO2(8)(9)', 'CCC[C]CC(C)OO(8031)'],
    products = ['S(118)(117)'],
...
reaction(
    label = 'reaction67',
    reactants = ['QOOH_3(3953)', 'CCC[C]OO(8032)'],
    products = ['S(118)(117)'],
...
reaction(
    label = 'reaction68',
    reactants = ['C3H7(69)(68)', 'CC(C[C]OO)OO(8033)'],
    products = ['S(118)(117)'],
...
reaction(
    label = 'reaction2',
    reactants = ['S(102)(101)'],
    products = ['CCCC(C[C](C)OO)OO(7984)'],
...
reaction(
    label = 'reaction4',
    reactants = ['S(102)(101)'],
    products = ['[CH2]C(CC(CCC)OO)OO(7986)'],
...
reaction(
    label = 'reaction8',
    reactants = ['S(102)(101)'],
    products = ['C[CH]CC(CC(C)OO)OO(7989)'],
...
reaction(
    label = 'reaction10',
    reactants = ['OH(5)(5)', 'CCCC([O])CC(C)O[O](7991)'],
    products = ['S(102)(101)'],
...
reaction(
    label = 'reaction11',
    reactants = ['HO2(8)(9)', 'CCC[CH]CC(C)O[O](3946)'],
    products = ['S(102)(101)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(3)(3)', 'CCCC(CC(C)O[O])O[O](7992)'],
    products = ['S(102)(101)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CCC[CH]OO(4381)', '[CH2]C(C)O[O](3941)'],
    products = ['S(102)(101)'],
...
reaction(
    label = 'reaction14',
    reactants = ['C3H7(69)(68)', 'CC(C[CH]OO)O[O](7993)'],
    products = ['S(102)(101)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]C(CCC)OO(4396)', 'C[CH]O[O](1429)'],
    products = ['S(102)(101)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CH3(15)(16)', 'CCCC(C[CH]O[O])OO(7995)'],
    products = ['S(102)(101)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(3)(3)', 'CCCC(C[C](C)O[O])OO(7996)'],
    products = ['S(102)(101)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(3)(3)', 'CCCC([CH]C(C)O[O])OO(7997)'],
    products = ['S(102)(101)'],
...
reaction(
    label = 'reaction20',
    reactants = ['C2H5(27)(28)', '[CH2]C(CC(C)O[O])OO(7998)'],
    products = ['S(102)(101)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(3)(3)', 'CC[CH]C(CC(C)O[O])OO(7999)'],
    products = ['S(102)(101)'],
...
reaction(
    label = 'reaction22',
    reactants = ['CH3(15)(16)', '[CH2]CC(CC(C)O[O])OO(8000)'],
    products = ['S(102)(101)'],
...
reaction(
    label = 'reaction23',
    reactants = ['H(3)(3)', 'C[CH]CC(CC(C)O[O])OO(8001)'],
    products = ['S(102)(101)'],
...
reaction(
    label = 'reaction24',
    reactants = ['H(3)(3)', '[CH2]C(CC(CCC)OO)O[O](7735)'],
    products = ['S(102)(101)'],
...
reaction(
    label = 'reaction25',
    reactants = ['H(3)(3)', '[CH2]CCC(CC(C)O[O])OO(8002)'],
    products = ['S(102)(101)'],
...
reaction(
    label = 'reaction26',
    reactants = ['CH2(S)(21)(22)', 'CCCC(CCO[O])OO(8003)'],
    products = ['S(102)(101)'],
...
reaction(
    label = 'reaction64',
    reactants = ['CH2(S)(21)(22)', 'CCC(CC(C)O[O])OO(8004)'],
    products = ['S(102)(101)'],
...
reaction(
    label = 'reaction28',
    reactants = ['S(102)(101)'],
    products = ['OH(5)(5)', 'CCCC1CC(C)OOO1(8005)'],
...
reaction(
    label = 'reaction29',
    reactants = ['S(102)(101)'],
    products = ['HO2(8)(9)', 'CC=CC(CCC)OO(4380)'],
...
reaction(
    label = 'reaction31',
    reactants = ['O(4)(4)', 'CCCC(CC(C)[O])OO(8006)'],
    products = ['S(102)(101)'],
