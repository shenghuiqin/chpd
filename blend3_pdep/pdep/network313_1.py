...
species(
    label = '[CH2]CCC(CC)OO(5137)',
    structure = SMILES('[CH2]CCC(CC)OO'),
    E0 = (-87.5836,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
reaction(
    label = 'reaction4',
    reactants = ['C4H9(68)(67)', 'CC[CH]OO(4023)'],
    products = ['S(199)(198)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['C2H5(27)(28)', 'CCCC[CH]OO(4002)'],
    products = ['S(199)(198)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(1.15e+14,'cm^3/(mol*s)','*|/',2), n=-0.35, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2500,'K'), comment="""Estimated using template [C_rad/H/NonDe;C_rad/H2/Cs] for rate rule [C_rad/H/CsO;C_rad/H2/Cs]
Euclidian distance = 2.0
...
reaction(
    label = 'reaction6',
    reactants = ['H(3)(3)', 'CCCC[C](CC)OO(3982)'],
    products = ['S(199)(198)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['C3H7(69)(68)', '[CH2]C(CC)OO(4021)'],
    products = ['S(199)(198)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(3)(3)', 'CCC[CH]C(CC)OO(3983)'],
    products = ['S(199)(198)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['C2H5(27)(28)', '[CH2]CC(CC)OO(4033)'],
    products = ['S(199)(198)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(8.73e+14,'cm^3/(mol*s)'), n=-0.699, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(200,'K'), Tmax=(2000,'K'), comment="""From training reaction 11 used for C_rad/H2/Cs;C_rad/H2/Cs
Exact match found for rate rule [C_rad/H2/Cs;C_rad/H2/Cs]
...
reaction(
    label = 'reaction10',
    reactants = ['H(3)(3)', 'CC[CH]CC(CC)OO(3985)'],
    products = ['S(199)(198)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CH3(15)(16)', '[CH2]C(CCCC)OO(4017)'],
    products = ['S(199)(198)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(3)(3)', 'C[CH]C(CCCC)OO(3984)'],
    products = ['S(199)(198)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CH3(15)(16)', '[CH2]CCC(CC)OO(5137)'],
    products = ['S(199)(198)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(3)(3)', '[CH2]CCCC(CC)OO(3986)'],
    products = ['S(199)(198)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CH2(S)(21)(22)', 'CCCC(CC)OO(5138)'],
    products = ['S(199)(198)'],
