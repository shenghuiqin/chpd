...
species(
    ...
    E0 = (1.79774,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,243.82,243.823,243.848,910.622,1364.17,1364.17,1364.17,1364.18,1364.18,1364.19],'cm^-1')),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (56.0633,'amu'),
...
species(
    ...
    E0 = (110.41,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,440,435,1725,2950,3100,1380,975,1025,1650,3000,3100,440,815,1455,1000,1477.82],'cm^-1')),
...
species(
    ...
    molecularWeight = (56.0633,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.80212,0.0232241,-1.45862e-05,5.09515e-09,-7.41945e-13,14857.5,14.5102], Tmin=(100,'K'), Tmax=(1579.91,'K')), NASAPolynomial(coeffs=[7.15126,0.0122129,-4.13185e-06,6.83753e-10,-4.38947e-14,13483.3,-8.46104], Tmin=(1579.91,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(123.153,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo library: DFT_QCI_thermo + radical(CCJCHO) + radical(CCCJ=O)"""),
)
...
species(
    label = 'O=C1[CH]C1(3724)',
    structure = SMILES('O=C1[CH]C1'),
    E0 = (163.926,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2950,3150,900,1000,1100,825.93,825.989,826.028,826.069,826.075,826.088,826.113,826.161,826.191],'cm^-1')),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (55.0553,'amu'),
...
species(
    label = '[O]C1[CH]C1(3725)',
    structure = SMILES('[O]C1[CH]C1'),
    E0 = (314.389,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,558.295,874.616,875.281,875.393,876.312,876.5,878.834,879.018,880.035,3573.97],'cm^-1')),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (56.0633,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.22489,0.00285183,6.22335e-05,-8.52852e-08,3.34903e-11,37853.1,13.7745], Tmin=(100,'K'), Tmax=(942.455,'K')), NASAPolynomial(coeffs=[11.012,0.00611404,-7.53268e-07,1.52367e-10,-1.79716e-14,34772.7,-31.8881], Tmin=(942.455,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(314.389,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), comment="""Thermo library: DFT_QCI_thermo + radical(CC(C)OJ) + radical(CCJCO)"""),
)

species(
    label = 'O[C]1[CH]C1(3726)',
    structure = SMILES('O[C]1[CH]C1'),
    E0 = (260.655,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2950,3150,900,1000,1100,180,839.622,839.622,839.626,839.628,839.628,839.64,3922.08],'cm^-1')),
        HinderedRotor(inertia=(0.199675,'amu*angstrom^2'), symmetry=1, barrier=(4.59091,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (56.0633,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.91308,0.0155297,1.94131e-05,-3.81371e-08,1.62944e-11,31396.3,15.2021], Tmin=(100,'K'), Tmax=(948.767,'K')), NASAPolynomial(coeffs=[9.71713,0.00795532,-1.98904e-06,3.54525e-10,-2.79743e-14,29155.1,-22.2732], Tmin=(948.767,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(260.655,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), comment="""Thermo library: DFT_QCI_thermo + radical(C2CsJOH) + radical(CCJCO)"""),
)
...
species(
    ...
    E0 = (60.0927,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2950,3150,900,1000,1100,516.173,516.307,516.414,516.69,516.732,516.776,516.838,1817.83],'cm^-1')),
        HinderedRotor(inertia=(0.000632388,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (56.0633,'amu'),
...
species(
    ...
    E0 = (160.123,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2120,512.5,787.5,2750,2800,2850,1350,1500,750,1050,1375,1000,1685,370],'cm^-1')),
        HinderedRotor(inertia=(0.378746,'amu*angstrom^2'), symmetry=1, barrier=(8.70812,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (55.0553,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.44025,0.0156634,1.33655e-05,-6.47172e-08,6.07655e-11,19274.9,11.0101], Tmin=(100,'K'), Tmax=(403.564,'K')), NASAPolynomial(coeffs=[3.93938,0.0159531,-7.17686e-06,1.37349e-09,-9.63755e-14,19191.9,8.52662], Tmin=(403.564,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(160.123,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(178.761,'J/(mol*K)'), comment="""Thermo library: DFT_QCI_thermo + radical(Cds_S)"""),
)
...
species(
    ...
    E0 = (212.355,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,180],'cm^-1')),
        HinderedRotor(inertia=(0.306785,'amu*angstrom^2'), symmetry=1, barrier=(7.05358,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (56.0633,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.87679,0.0291902,-4.12631e-05,4.28084e-08,-1.76381e-11,25576.5,13.3616], Tmin=(100,'K'), Tmax=(807.452,'K')), NASAPolynomial(coeffs=[1.96525,0.0233719,-1.12572e-05,2.18411e-09,-1.52721e-13,26060.6,19.6504], Tmin=(807.452,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(212.355,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo library: DFT_QCI_thermo + radical(C=COJ) + radical(Cds_S)"""),
)

species(
    label = '[CH2]C=[C]O(3730)',
    structure = SMILES('[CH2]C=[C]O'),
    E0 = (224.294,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1685,370,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000],'cm^-1')),
...
species(
    label = '[CH]=C([CH2])O(3731)',
    structure = SMILES('[CH]C(=C)O'),
    E0 = (184.373,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2950,3100,1380,975,1025,1650,350,440,435,1725,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(2.15785,'amu*angstrom^2'), symmetry=1, barrier=(49.6133,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.15943,'amu*angstrom^2'), symmetry=1, barrier=(49.6495,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (56.0633,'amu'),
...
species(
    ...
    molecularWeight = (56.0633,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.88149,0.0167368,1.67752e-05,-3.38408e-08,1.41457e-11,35060.3,11.9351], Tmin=(100,'K'), Tmax=(970.463,'K')), NASAPolynomial(coeffs=[9.13414,0.0103809,-3.41099e-06,6.42102e-10,-4.82623e-14,32932.4,-22.7535], Tmin=(970.463,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(291.115,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), comment="""Thermo library: DFT_QCI_thermo + radical(CC(C)OJ) + radical(C2CsJOH)"""),
)
...
species(
    ...
    E0 = (395.31,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,1685,370,2950,3100,1380,975,1025,1650],'cm^-1')),
        HinderedRotor(inertia=(0.110742,'amu*angstrom^2'), symmetry=1, barrier=(23.6191,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (40.0639,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.2858,0.0103674,1.67979e-05,-2.70066e-08,1.05238e-11,47575.3,10.4037], Tmin=(100,'K'), Tmax=(980.878,'K')), NASAPolynomial(coeffs=[6.52788,0.0104289,-3.6086e-06,6.68502e-10,-4.85541e-14,46300.3,-8.43206], Tmin=(980.878,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(395.31,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), comment="""Thermo library: DFT_QCI_thermo + radical(Allyl_P) + radical(Cds_S)"""),
)

species(
    label = 'C=C1[CH]O1(3735)',
    structure = SMILES('C=C1[CH]O1'),
    E0 = (141.58,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,3100,1380,975,1025,1650,2950,1000,596.366,596.368,596.37,596.371,596.371,596.374,596.376],'cm^-1')),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (55.0553,'amu'),
...
species(
    label = 'C[C]1[CH]O1(3738)',
    structure = SMILES('C[C]1[CH]O1'),
    E0 = (256.542,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,2950,1000,180,180,1025.04,1025.13,1026.16,4000],'cm^-1')),
        HinderedRotor(inertia=(0.657803,'amu*angstrom^2'), symmetry=1, barrier=(15.1242,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (56.0633,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.84749,0.0204205,-7.02956e-07,-1.19182e-08,5.5098e-12,30900.7,14.5064], Tmin=(100,'K'), Tmax=(1033.93,'K')), NASAPolynomial(coeffs=[7.81244,0.0121735,-4.64061e-06,8.74424e-10,-6.2718e-14,29288.1,-12.4456], Tmin=(1033.93,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(256.542,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), comment="""Thermo library: DFT_QCI_thermo + radical(C2CsJO) + radical(CCsJO)"""),
)
...
reaction(
    label = 'reaction15',
    reactants = ['CH2(17)(18)', 'CH2CO(26)(27)'],
    products = ['C3H4O(116)(115)'],
    transitionState = 'TS15',
    kinetics = Arrhenius(A=(8.08719,'m^3/(mol*s)'), n=1.77401, Ea=(28.3131,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Cds-HH_Ck;YJ] for rate rule [Cds-HH_Ck;CH2_triplet]
...
reaction(
    label = 'reaction20',
    reactants = ['CO(10)(11)', 'C2H4(T)(890)'],
    products = ['C3H4O(116)(115)'],
    transitionState = 'TS20',
    kinetics = Arrhenius(A=(2259.43,'m^3/(mol*s)'), n=0.633378, Ea=(16.7988,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [COm;Y_rad]
Euclidian distance = 0
Multiplied by reaction path degeneracy 2.0
...
reaction(
    label = 'reaction21',
    reactants = ['CH2(17)(18)', '[CH2][C]=O(3723)'],
    products = ['C3H4O(116)(115)'],
    transitionState = 'TS21',
    kinetics = Arrhenius(A=(1.06732e+06,'m^3/(mol*s)'), n=0.472793, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [Y_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction22',
    reactants = ['C2H4(T)(890)', '[C]=O(3676)'],
    products = ['C3H4O(116)(115)'],
    transitionState = 'TS22',
    kinetics = Arrhenius(A=(2.13464e+06,'m^3/(mol*s)'), n=0.472793, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [Y_rad;Birad]
Euclidian distance = 0
Multiplied by reaction path degeneracy 2.0
family: Birad_R_Recombination
Ea raised from -3.5 to 0 kJ/mol."""),
...
reaction(
    label = 'reaction23',
    reactants = ['H(3)(3)', 'O=C1[CH]C1(3724)'],
    products = ['C3H4O(117)(116)'],
...
reaction(
    label = 'reaction24',
    reactants = ['CH2(S)(21)(22)', 'CH2CO(26)(27)'],
    products = ['C3H4O(117)(116)'],
...
reaction(
    label = 'reaction30',
    reactants = ['CH3(15)(16)', 'HCCO(47)(47)'],
    products = ['C3H4O(121)(120)'],
...
reaction(
    label = 'reaction38',
    reactants = ['CH2(17)(18)', 'CH2CO(26)(27)'],
    products = ['C3H4O(122)(121)'],
    transitionState = 'TS38',
    kinetics = Arrhenius(A=(1.54607e+06,'m^3/(mol*s)'), n=0.466452, Ea=(32.4943,'kJ/mol'), T0=(1,'K'), Tmin=(303.03,'K'), Tmax=(2000,'K'), comment="""Estimated using template [Ck_O;YJ] for rate rule [Ck_O;CH2_triplet]
Euclidian distance = 2.0
family: R_Addition_MultipleBond"""),
)
...
reaction(
    label = 'reaction43',
    reactants = ['C3H4O(122)(121)'],
    products = ['[O][C]1CC1(3734)'],
    transitionState = 'TS43',
    kinetics = Arrhenius(A=(3.68393e+12,'s^-1'), n=-0.105173, Ea=(180.704,'kJ/mol'), T0=(1,'K'), Tmin=(303.03,'K'), Tmax=(2000,'K'), comment="""From training reaction 135 used for R3_D;doublebond_intra;radadd_intra_cs2H
Exact match found for rate rule [R3_D;doublebond_intra;radadd_intra_cs2H]
Euclidian distance = 0
family: Intra_R_Add_Endocyclic
Ea raised from 179.8 to 180.7 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction44',
    reactants = ['C3H4O(122)(121)'],
    products = ['C3H4O(124)(123)'],
...
reaction(
    label = 'reaction47',
    reactants = ['H(3)(3)', 'C=C1[CH]O1(3735)'],
    products = ['C3H4O(124)(123)'],
...
reaction(
    label = 'reaction50',
    reactants = ['H2CCCH2(838)', 'O(S)(1482)'],
    products = ['C3H4O(124)(123)'],
...
network(
    ...
    reactants = [
        ...
        ('CO(10)(11)', 'C2H4(19)(20)'),
        ('CH2(17)(18)', 'CH2CO(26)(27)'),
        ('CH2(S)(21)(22)', 'CH2CO(26)(27)'),
        ('CH3(15)(16)', 'HCCO(47)(47)'),
    ],
    bathGas = {
        'Ne': 0.333333,
        'N2': 0.333333,
