...
species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.844059,'amu*angstrom^2'), symmetry=1, barrier=(19.4066,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.841993,'amu*angstrom^2'), symmetry=1, barrier=(19.3591,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.84678,'amu*angstrom^2'), symmetry=1, barrier=(19.4691,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.844274,'amu*angstrom^2'), symmetry=1, barrier=(19.4115,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (108.138,'amu'),
...
reaction(
    label = 'reaction567',
    reactants = ['OH(5)(5)', '[C]1=CC=CC=CC1(1454)'],
...
reaction(
    label = 'reaction570',
    reactants = ['H(3)(3)', 'OC1=CC=CC=[C]C1(2124)'],
    products = ['C7H8O(577)(576)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction571',
    reactants = ['H(3)(3)', 'OC1=[C]C=CC=CC1(2125)'],
    products = ['C7H8O(577)(576)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction572',
    reactants = ['H(3)(3)', 'OC1=CC=C[C]=CC1(2126)'],
    products = ['C7H8O(577)(576)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(6.117e+14,'cm^3/(mol*s)'), n=-0.152, Ea=(4.19655,'kJ/mol'), T0=(1,'K'), comment="""From training reaction 49 used for Cd_rad/Cd;H_rad
Exact match found for rate rule [Cd_rad/Cd;H_rad]
...
reaction(
    label = 'reaction573',
    reactants = ['H(3)(3)', 'OC1=CC=[C]C=CC1(2127)'],
    products = ['C7H8O(577)(576)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(6.117e+14,'cm^3/(mol*s)'), n=-0.152, Ea=(4.19655,'kJ/mol'), T0=(1,'K'), comment="""From training reaction 49 used for Cd_rad/Cd;H_rad
Exact match found for rate rule [Cd_rad/Cd;H_rad]
...
reaction(
    label = 'reaction574',
    reactants = ['H(3)(3)', 'OC1=C[C]=CC=CC1(2128)'],
    products = ['C7H8O(577)(576)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(6.117e+14,'cm^3/(mol*s)'), n=-0.152, Ea=(4.19655,'kJ/mol'), T0=(1,'K'), comment="""From training reaction 49 used for Cd_rad/Cd;H_rad
Exact match found for rate rule [Cd_rad/Cd;H_rad]
...
reaction(
    label = 'reaction582',
    reactants = ['OC1[CH]C=CC=[C]C1(2131)'],
    products = ['C7H8O(577)(576)'],
...
reaction(
    label = 'reaction586',
    reactants = ['OC1=CC[CH]C=[C]C1(2133)'],
    products = ['C7H8O(577)(576)'],
...
reaction(
    label = 'reaction605',
    reactants = ['[CH]=CC=C(O)CC=[CH](2140)'],
    products = ['C7H8O(577)(576)'],
...
reaction(
    label = 'reaction607',
    reactants = ['[CH2]C=CC=CC=[C]O(2142)'],
    products = ['C7H8O(577)(576)'],
...
reaction(
    label = 'reaction608',
    reactants = ['[CH]=CC=CC=C([CH2])O(2143)'],
    products = ['C7H8O(577)(576)'],
