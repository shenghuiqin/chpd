species(
    ...
    E0 = (-63.0631,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,1073.95,1074.08,1074.15,1074.17,1074.25,1074.35,2368.97],'cm^-1')),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
reaction(
    label = 'reaction1',
    reactants = ['H(3)(3)', 'cC2H3O(56)(55)'],
    products = ['cC2H4O(42)(42)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['CH2O(13)(14)', 'CH2(S)(21)(22)'],
    products = ['cC2H4O(42)(42)'],
    transitionState = 'TS2',
