...
species(
    label = 'C=CC[CH]CC(3545)',
    structure = SMILES('C=CC[CH]CC'),
    E0 = (130.376,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2950,3100,1380,975,1025,1650,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,3025,407.5,1350,352.5,242.95,1471.99,1472.14],'cm^-1')),
        HinderedRotor(inertia=(0.00284808,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.183808,'amu*angstrom^2'), symmetry=1, barrier=(7.77025,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.184862,'amu*angstrom^2'), symmetry=1, barrier=(7.77946,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.183487,'amu*angstrom^2'), symmetry=1, barrier=(7.78383,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (83.1515,'amu'),
...
species(
    label = 'C=CCC[CH]C(3547)',
    structure = SMILES('C=CCC[CH]C'),
    E0 = (130.364,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2950,3100,1380,975,1025,1650,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,3025,407.5,1350,352.5,317.78,1188.49,1188.49],'cm^-1')),
        HinderedRotor(inertia=(0.0933384,'amu*angstrom^2'), symmetry=1, barrier=(6.68869,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0933387,'amu*angstrom^2'), symmetry=1, barrier=(6.68869,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0933378,'amu*angstrom^2'), symmetry=1, barrier=(6.68869,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0933385,'amu*angstrom^2'), symmetry=1, barrier=(6.68869,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (83.1515,'amu'),
...
species(
    ...
    E0 = (183.014,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3120,650,792.5,1650,3010,987.5,1337.5,450,1655,326.998,327.143],'cm^-1')),
        HinderedRotor(inertia=(0.00157471,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.13783,'amu*angstrom^2'), symmetry=1, barrier=(10.4729,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.138059,'amu*angstrom^2'), symmetry=1, barrier=(10.4683,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.137971,'amu*angstrom^2'), symmetry=1, barrier=(10.4689,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (83.1515,'amu'),
...
reaction(
    label = 'reaction1',
    reactants = ['C2H5(27)(28)', 'C4H7(330)(329)'],
    products = ['C6H12(79)(78)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['C3H7(69)(68)', 'C3H5(89)(88)'],
    products = ['C6H12(79)(78)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)(3)', 'C=CC[CH]CC(3545)'],
    products = ['C6H12(79)(78)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CH3(15)(16)', '[CH2]CCC=C(3546)'],
    products = ['C6H12(79)(78)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)(3)', 'C=CCC[CH]C(3547)'],
    products = ['C6H12(79)(78)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(2e+13,'cm^3/(mol*s)','*|/',3.16), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), comment="""From training reaction 59 used for H_rad;C_rad/H/NonDeC
Exact match found for rate rule [C_rad/H/NonDeC;H_rad]
...
reaction(
    label = 'reaction6',
    reactants = ['C4H9(68)(67)', 'C2H3(28)(29)'],
    products = ['C6H12(79)(78)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['H(3)(3)', '[CH2]CCCC=C(3548)'],
    products = ['C6H12(79)(78)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction17',
    reactants = ['CH2(S)(21)(22)', 'C5H10(82)(81)'],
    products = ['C6H12(79)(78)'],
...
network(
    ...
    reactants = [
        ('C2H5(27)(28)', 'C4H7(330)(329)'),
        ('C3H7(69)(68)', 'C3H5(89)(88)'),
        ('C4H9(68)(67)', 'C2H3(28)(29)'),
        ('H(3)(3)', 'C6H11(331)(330)'),
        ('CH2(S)(21)(22)', 'C5H10(82)(81)'),
    ],
    bathGas = {
        'Ne': 0.333333,
        'N2': 0.333333,
