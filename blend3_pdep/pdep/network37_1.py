...
species(
    ...
    molecularWeight = (67.1091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.7846,0.0119353,6.36183e-05,-8.75743e-08,3.33264e-11,40977.9,18.3406], Tmin=(100,'K'), Tmax=(965.144,'K')), NASAPolynomial(coeffs=[9.88731,0.0199065,-6.90878e-06,1.30062e-09,-9.6972e-14,37864.6,-24.6999], Tmin=(965.144,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(340.235,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(278.535,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Cyclopropane) + radical(cyclopropane)"""),
)
...
species(
    ...
    E0 = (326.592,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,1685,370,3010,987.5,1337.5,450,1655,2950,3000,3050,3100,1330,1430,900,1050,1000,1050,1600,1700,375.329,375.409],'cm^-1')),
        HinderedRotor(inertia=(0.12196,'amu*angstrom^2'), symmetry=1, barrier=(12.1521,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.121782,'amu*angstrom^2'), symmetry=1, barrier=(12.1499,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (67.1091,'amu'),
...
reaction(
    label = 'reaction1',
    reactants = ['H(3)(3)', 'C=C=CC=C(1443)'],
    products = ['C5H7(211)(210)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['C2H3(28)(29)', '[CH]=C[CH2](891)'],
    products = ['C5H7(211)(210)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)(3)', '[CH2]C=[C]C=C(1444)'],
    products = ['C5H7(211)(210)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)(3)', '[CH2]C=C[C]=C(1445)'],
    products = ['C5H7(211)(210)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)(3)', '[CH]=CC=C[CH2](880)'],
    products = ['C5H7(211)(210)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['C5H7(211)(210)'],
    products = ['[CH2]C1C=CC1(971)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(9.426e+10,'s^-1'), n=0.481, Ea=(141.846,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R5_SM;doublebond_intra_2H_pri;radadd_intra_cs2H] for rate rule [R5_SD_D;doublebond_intra_2H_pri;radadd_intra_cs2H]
Euclidian distance = 2.0
Multiplied by reaction path degeneracy 2.0
family: Intra_R_Add_Exocyclic
Ea raised from 140.0 to 141.8 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction7',
    reactants = ['C5H7(211)(210)'],
    products = ['C=CC=[C]C(1446)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['C5H7(211)(210)'],
    products = ['C=C[C]=CC(1447)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(1.59e+07,'s^-1'), n=1.4638, Ea=(277.467,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1600,'K'), comment="""Matched reaction 287 C5H7-7 <=> C5H7-8 in intra_H_migration/training
This reaction matched rate rule [R3H_SD;C_rad_out_2H;Cd_H_out_singleDe]
family: intra_H_migration"""),
)
...
reaction(
    label = 'reaction9',
    reactants = ['C5H7(211)(210)'],
    products = ['C=[C]C=CC(1448)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(1.32e+06,'s^-1'), n=1.6229, Ea=(184.393,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1600,'K'), comment="""Matched reaction 283 C5H7-3 <=> C5H7-4 in intra_H_migration/training
This reaction matched rate rule [R4H_SDS;C_rad_out_2H;Cd_H_out_doubleC]
family: intra_H_migration"""),
)
...
reaction(
    label = 'reaction10',
    reactants = ['C5H7(211)(210)'],
    products = ['[CH]=CC=CC(1449)'],
    transitionState = 'TS10',
    kinetics = Arrhenius(A=(438000,'s^-1'), n=1.7613, Ea=(160.143,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1600,'K'), comment="""Matched reaction 285 C5H7-5 <=> C5H7-6 in intra_H_migration/training
This reaction matched rate rule [R5H_SMSD;C_rad_out_2H;Cd_H_out_singleH]
family: intra_H_migration"""),
)
...
reaction(
    label = 'reaction11',
    reactants = ['C5H7(211)(210)'],
    products = ['C=CC1[CH]C1(1450)'],
    transitionState = 'TS11',
    kinetics = Arrhenius(A=(1.05e+08,'s^-1'), n=1.192, Ea=(225.936,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1600,'K'), comment="""Matched reaction 142 C5H7-5 <=> C5H7-6 in Intra_R_Add_Endocyclic/training
This reaction matched rate rule [R3_D;doublebond_intra_pri_HCd;radadd_intra_cs2H]
...
reaction(
    label = 'reaction12',
    reactants = ['C5H7(211)(210)'],
    products = ['[CH]1C=CCC1(1451)'],
    transitionState = 'TS12',
    kinetics = Arrhenius(A=(1.02676e+11,'s^-1'), n=0.55665, Ea=(157.071,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1600,'K'), comment="""Matched reaction 141 C5H7-3 <=> C5H7-4 in Intra_R_Add_Endocyclic/training
This reaction matched rate rule [R5_SD_D;doublebond_intra_pri_2H;radadd_intra_cs2H]
family: Intra_R_Add_Endocyclic"""),
)

reaction(
    label = 'reaction13',
    reactants = ['CH2(17)(18)', 'CH2CHCHCH(913)'],
    products = ['C5H7(211)(210)'],
...
reaction(
    label = 'reaction14',
    reactants = ['C=[C]CC=C(1452)'],
    products = ['C5H7(211)(210)'],
    transitionState = 'TS14',
    kinetics = Arrhenius(A=(1.448e+10,'s^-1'), n=0.82, Ea=(156.9,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""Matched reaction 154 C5H7 <=> C5H7-2 in intra_H_migration/training
This reaction matched rate rule [R2H_S;C_rad_out_H/Cd;Cd_H_out_doubleC]
family: intra_H_migration"""),
)

reaction(
    label = 'reaction15',
    reactants = ['[CH]=CCC=C(916)'],
    products = ['C5H7(211)(210)'],
