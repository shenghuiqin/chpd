...
species(
    label = 'CCC[CH]CCO[O](7190)',
    structure = SMILES('CCC[CH]CCO[O]'),
    E0 = (66.276,'kJ/mol'),
    modes = [
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.233509,0.0904319,-0.0001094,9.24193e-08,-3.34037e-11,8099.47,34.4015], Tmin=(100,'K'), Tmax=(795.621,'K')), NASAPolynomial(coeffs=[4.54746,0.0575138,-2.61674e-05,4.93726e-09,-3.40818e-13,7768.44,16.8091], Tmin=(795.621,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(66.276,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(ROOJ)"""),
)
...
species(
    label = 'CC[CH]CCCO[O](7191)',
    structure = SMILES('CC[CH]CCCO[O]'),
    E0 = (66.276,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'CCCC[CH]CO[O](7192)',
    structure = SMILES('CCCC[CH]CO[O]'),
    E0 = (72.2326,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (116.158,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.22988,0.0890307,-8.95028e-05,5.75468e-08,-1.6383e-11,8817.93,34.175], Tmin=(100,'K'), Tmax=(824.515,'K')), NASAPolynomial(coeffs=[7.65375,0.0530151,-2.39813e-05,4.56907e-09,-3.19674e-13,7593.71,-0.208375], Tmin=(824.515,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(72.2326,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCJCOOH) + radical(ROOJ)"""),
)
...
species(
    label = 'C[CH]CCCCO[O](7193)',
    structure = SMILES('C[CH]CCCCO[O]'),
    E0 = (66.264,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (116.158,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.220106,0.0896433,-0.000102957,8.21704e-08,-2.86515e-11,8099.62,34.6236], Tmin=(100,'K'), Tmax=(777.896,'K')), NASAPolynomial(coeffs=[5.56439,0.0556991,-2.50398e-05,4.7131e-09,-3.25579e-13,7463.72,11.4397], Tmin=(777.896,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(66.264,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(RCCJC) + radical(ROOJ)"""),
)
...
species(
    label = 'CCCCC[CH]OO(5130)',
    structure = SMILES('CCCCC[CH]OO'),
    E0 = (-91.6045,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (117.166,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.126177,0.0912405,-7.85666e-05,3.9848e-08,-8.93638e-12,-10883,31.6295], Tmin=(100,'K'), Tmax=(1019.23,'K')), NASAPolynomial(coeffs=[9.40593,0.0548214,-2.49679e-05,4.78924e-09,-3.36965e-13,-12774.7,-13.3166], Tmin=(1019.23,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-91.6045,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(478.082,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCsJOOH)"""),
)

species(
    label = 'CCCC[CH]COO(7188)',
    structure = SMILES('CCCC[CH]COO'),
    E0 = (-79.7721,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (117.166,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.156638,0.0904392,-7.74089e-05,3.88265e-08,-8.5961e-12,-9460.91,33.6746], Tmin=(100,'K'), Tmax=(1031.64,'K')), NASAPolynomial(coeffs=[9.51721,0.0541457,-2.4639e-05,4.72597e-09,-3.3252e-13,-11392.3,-11.7764], Tmin=(1031.64,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-79.7721,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(478.082,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCJCOOH)"""),
)

species(
    label = 'CCC[CH]CCOO(7189)',
    structure = SMILES('CCC[CH]CCOO'),
    E0 = (-85.7287,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2]CCCCCOO(5136)',
    structure = SMILES('[CH2]CCCCCOO'),
    E0 = (-74.9407,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (117.166,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.153311,0.0894308,-7.33703e-05,3.42309e-08,-6.97304e-12,-8878.87,33.1605], Tmin=(100,'K'), Tmax=(1116.44,'K')), NASAPolynomial(coeffs=[10.4968,0.0523725,-2.35808e-05,4.50003e-09,-3.15588e-13,-11188.5,-17.88], Tmin=(1116.44,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-74.9407,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(478.082,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(RCCJ)"""),
)
...
reaction(
    label = 'reaction8',
    reactants = ['C3H7(69)(68)', '[CH2]CCO[O](4258)'],
    products = ['S(95)(94)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction9',
    reactants = ['C4H9(68)(67)', '[CH2]CO[O](1430)'],
    products = ['S(95)(94)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(8.73e+14,'cm^3/(mol*s)'), n=-0.699, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(200,'K'), Tmax=(2000,'K'), comment="""From training reaction 11 used for C_rad/H2/Cs;C_rad/H2/Cs
Exact match found for rate rule [C_rad/H2/Cs;C_rad/H2/Cs]
...
reaction(
    label = 'reaction10',
    reactants = ['H(3)(3)', 'CCC[CH]CCO[O](7190)'],
    products = ['S(95)(94)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction11',
    reactants = ['C2H5(27)(28)', '[CH2]CCCO[O](4255)'],
    products = ['S(95)(94)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(8.73e+14,'cm^3/(mol*s)'), n=-0.699, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(200,'K'), Tmax=(2000,'K'), comment="""From training reaction 11 used for C_rad/H2/Cs;C_rad/H2/Cs
Exact match found for rate rule [C_rad/H2/Cs;C_rad/H2/Cs]
...
reaction(
    label = 'reaction12',
    reactants = ['H(3)(3)', 'CC[CH]CCCO[O](7191)'],
    products = ['S(95)(94)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(2e+13,'cm^3/(mol*s)','*|/',3.16), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), comment="""From training reaction 59 used for H_rad;C_rad/H/NonDeC
Exact match found for rate rule [C_rad/H/NonDeC;H_rad]
...
reaction(
    label = 'reaction13',
    reactants = ['C5H11(67)(66)', '[CH2]O[O](1428)'],
    products = ['S(95)(94)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction14',
    reactants = ['H(3)(3)', 'CCCC[CH]CO[O](7192)'],
    products = ['S(95)(94)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(2e+13,'cm^3/(mol*s)','*|/',3.16), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), comment="""From training reaction 59 used for H_rad;C_rad/H/NonDeC
Exact match found for rate rule [C_rad/H/NonDeC;H_rad]
...
reaction(
    label = 'reaction15',
    reactants = ['CH3(15)(16)', '[CH2]CCCCO[O](4256)'],
    products = ['S(95)(94)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction16',
    reactants = ['H(3)(3)', 'C[CH]CCCCO[O](7193)'],
    products = ['S(95)(94)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(3)(3)', 'CCCCC[CH]O[O](3939)'],
    products = ['S(95)(94)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(3)(3)', '[CH2]CCCCCO[O](4262)'],
    products = ['S(95)(94)'],
...
reaction(
    label = 'reaction6',
    reactants = ['S(95)(94)'],
    products = ['C[CH]CCCCOO(3979)'],
    transitionState = 'TS18',
    kinetics = Arrhenius(A=(2.74e+06,'s^-1'), n=0.99, Ea=(76.0233,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""Matched reaction 267 C6H13O2-5 <=> C6H13O2-6 in intra_H_migration/training
This reaction matched rate rule [R7H_OOCCCC(Cs/Cs);O_rad_out;Cs_H_out_H/NonDeC]
family: intra_H_migration"""),
)

reaction(
    label = 'reaction7',
    reactants = ['[CH2]CCCCCOO(5136)'],
    products = ['S(95)(94)'],
