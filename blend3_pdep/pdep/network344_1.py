...
species(
    label = 'C=CC[CH]OO(5388)',
    structure = SMILES('C=CC[CH]OO'),
    E0 = (83.7382,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,3025,407.5,1350,352.5,2950,3100,1380,975,1025,1650,3010,987.5,1337.5,450,1655,2750,2850,1437.5,1250,1305,750,350,180.001,577.772],'cm^-1')),
        HinderedRotor(inertia=(1.69717,'amu*angstrom^2'), symmetry=1, barrier=(50.1924,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.398598,'amu*angstrom^2'), symmetry=1, barrier=(9.28125,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0393319,'amu*angstrom^2'), symmetry=1, barrier=(9.26953,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.147881,'amu*angstrom^2'), symmetry=1, barrier=(33.3827,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
species(
    label = 'C=CC[C](CCC)OO(5389)',
    structure = SMILES('C=CC[C](CCC)OO'),
    E0 = (-1.92882,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([360,370,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,3615,1310,387.5,850,1000,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2950,3100,1380,975,1025,1650,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (129.177,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0636277,0.0956805,-7.97747e-05,3.82595e-08,-8.08293e-12,-90.9577,34.8258], Tmin=(100,'K'), Tmax=(1074.54,'K')), NASAPolynomial(coeffs=[10.2387,0.0573298,-2.62393e-05,5.04509e-09,-3.55353e-13,-2305.02,-15.6178], Tmin=(1074.54,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1.92882,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(C2CsJOOH)"""),
)
...
species(
    label = '[CH2]C(CC=C)OO(5390)',
    structure = SMILES('[CH2]C(CC=C)OO'),
    E0 = (72.6951,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,3100,1380,975,1025,1650,3010,987.5,1337.5,450,1655,3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,225.714,225.895],'cm^-1')),
        HinderedRotor(inertia=(0.00330911,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00330575,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.732002,'amu*angstrom^2'), symmetry=1, barrier=(26.5154,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.734149,'amu*angstrom^2'), symmetry=1, barrier=(26.5188,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.500409,'amu*angstrom^2'), symmetry=1, barrier=(18.0908,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
species(
    label = 'C=CCC([CH]CC)OO(5391)',
    structure = SMILES('C=CCC([CH]CC)OO'),
    E0 = (11.587,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (129.177,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.359361,0.0975417,-7.96029e-05,3.51098e-08,-6.5371e-12,1548.93,37.8841], Tmin=(100,'K'), Tmax=(1236.93,'K')), NASAPolynomial(coeffs=[14.2532,0.0502876,-2.22991e-05,4.22499e-09,-2.94906e-13,-2066.04,-35.7203], Tmin=(1236.93,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(11.587,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CCJCOOH)"""),
)
...
species(
    label = '[CH2]CC(CC=C)OO(5392)',
    structure = SMILES('[CH2]CC(CC=C)OO'),
    E0 = (40.1987,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,3100,1380,975,1025,1650,3010,987.5,1337.5,450,1655,3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3100,440,815,1455,1000,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.147441,0.0832512,-6.6482e-05,2.79952e-08,-4.89616e-12,4974.41,33.3004], Tmin=(100,'K'), Tmax=(1324.65,'K')), NASAPolynomial(coeffs=[14.531,0.0398182,-1.73e-05,3.24328e-09,-2.24797e-13,1163.75,-40.1358], Tmin=(1324.65,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(40.1987,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(RCCJ)"""),
)
...
species(
    label = 'C=C[CH]C(CCC)OO(5394)',
    structure = SMILES('C=C[CH]C(CCC)OO'),
    E0 = (-71.9112,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2950,3100,1380,975,1025,1650,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (129.177,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.907713,0.103028,-8.36364e-05,3.51347e-08,-6.03915e-12,-8468.5,34.7472], Tmin=(100,'K'), Tmax=(1362.32,'K')), NASAPolynomial(coeffs=[19.0436,0.0444473,-1.91353e-05,3.57039e-09,-2.46753e-13,-13904.5,-67.6753], Tmin=(1362.32,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-71.9112,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(C=CCJCO)"""),
)

species(
    label = '[CH2]CCC(CC=C)OO(5395)',
    structure = SMILES('[CH2]CCC(CC=C)OO'),
    E0 = (16.4184,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,3100,1380,975,1025,1650,3010,987.5,1337.5,450,1655,3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3000,3100,440,815,1455,1000,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (129.177,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.442441,0.0973888,-7.8177e-05,3.34227e-08,-5.97524e-12,2134.56,37.6619], Tmin=(100,'K'), Tmax=(1291.9,'K')), NASAPolynomial(coeffs=[15.4325,0.0482358,-2.11058e-05,3.97157e-09,-2.75973e-13,-1967.16,-42.9912], Tmin=(1291.9,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(16.4184,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(RCCJ)"""),
)

species(
    label = 'C=[C]CC(CCC)OO(5396)',
    structure = SMILES('C=[C]CC(CCC)OO'),
    E0 = (49.0138,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,3100,1380,975,1025,1650,2750,2800,2850,1350,1500,750,1050,1375,1000,1685,370,3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (129.177,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.339932,0.0991251,-8.47654e-05,4.01921e-08,-8.12232e-12,6048.13,35.9894], Tmin=(100,'K'), Tmax=(1143.25,'K')), NASAPolynomial(coeffs=[12.9975,0.0524599,-2.35379e-05,4.48808e-09,-3.14706e-13,2998.55,-30.1414], Tmin=(1143.25,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(49.0138,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_S)"""),
)

species(
    label = '[CH]=CCC(CCC)OO(5397)',
    structure = SMILES('[CH]=CCC(CCC)OO'),
    E0 = (58.2682,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3120,650,792.5,1650,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (129.177,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.536264,0.0999551,-8.35533e-05,3.74774e-08,-7.01954e-12,7171.01,36.6172], Tmin=(100,'K'), Tmax=(1241.55,'K')), NASAPolynomial(coeffs=[15.48,0.0483541,-2.12105e-05,4.00148e-09,-2.78769e-13,3194.03,-44.1171], Tmin=(1241.55,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(58.2682,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_P)"""),
)

species(
    label = '[CH2]C[CH]C(CCC)OO(5398)',
    structure = SMILES('[CH2]C[CH]C(CCC)OO'),
    E0 = (89.0511,'kJ/mol'),
    modes = [
...
species(
    label = '[CH2]CC[C](CCC)OO(5399)',
    structure = SMILES('[CH2]CC[C](CCC)OO'),
    E0 = (75.5353,'kJ/mol'),
    modes = [
...
species(
    label = '[CH2]CCC([CH]CC)OO(5400)',
    structure = SMILES('[CH2]CCC([CH]CC)OO'),
    E0 = (89.0511,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3000,3100,440,815,1455,1000,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'C=CCC(CC)OO(5402)',
    structure = SMILES('C=CCC(CC)OO'),
    E0 = (-165.048,'kJ/mol'),
    modes = [
...
species(
    ...
    molecularWeight = (130.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.639024,0.109521,-0.000104072,5.91922e-08,-1.47338e-11,13637.7,45.4333], Tmin=(100,'K'), Tmax=(935.019,'K')), NASAPolynomial(coeffs=[10.3244,0.0626206,-2.88334e-05,5.54776e-09,-3.90839e-13,11587.4,-6.72249], Tmin=(935.019,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(112.054,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(523.812,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(CsJ2_singlet-CsH)"""),
)

species(
    label = '[CH]CCC(CCC)OO(5404)',
    structure = SMILES('[CH]CCC(CCC)OO'),
    E0 = (134.49,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (130.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.564485,0.107753,-0.000102152,5.66039e-08,-1.3603e-11,16333.6,36.007], Tmin=(100,'K'), Tmax=(968.851,'K')), NASAPolynomial(coeffs=[11.0883,0.0596435,-2.76685e-05,5.35267e-09,-3.78441e-13,14075.6,-19.8424], Tmin=(968.851,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(134.49,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(523.812,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(CsJ2_singlet-CsH)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['HO2(8)(9)', 'C=CC[CH]CCC(5386)'],
    products = ['S(180)(179)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)(3)', 'C=CCC(CCC)O[O](5387)'],
    products = ['S(180)(179)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['C3H7(69)(68)', 'C=CC[CH]OO(5388)'],
    products = ['S(180)(179)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['C3H5(89)(88)', 'CCC[CH]OO(4381)'],
    products = ['S(180)(179)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['H(3)(3)', 'C=CC[C](CCC)OO(5389)'],
    products = ['S(180)(179)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['C2H5(27)(28)', '[CH2]C(CC=C)OO(5390)'],
    products = ['S(180)(179)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(3)(3)', 'C=CCC([CH]CC)OO(5391)'],
    products = ['S(180)(179)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['CH3(15)(16)', '[CH2]CC(CC=C)OO(5392)'],
    products = ['S(180)(179)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(3)(3)', 'C=CCC(C[CH]C)OO(5393)'],
    products = ['S(180)(179)'],
...
reaction(
    label = 'reaction11',
    reactants = ['C2H3(28)(29)', '[CH2]C(CCC)OO(4396)'],
    products = ['S(180)(179)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(3)(3)', 'C=C[CH]C(CCC)OO(5394)'],
    products = ['S(180)(179)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(3)(3)', '[CH2]CCC(CC=C)OO(5395)'],
    products = ['S(180)(179)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(3)(3)', 'C=[C]CC(CCC)OO(5396)'],
    products = ['S(180)(179)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(3)(3)', '[CH]=CCC(CCC)OO(5397)'],
    products = ['S(180)(179)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]C[CH]C(CCC)OO(5398)'],
    products = ['S(180)(179)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]CC[C](CCC)OO(5399)'],
    products = ['S(180)(179)'],
...
reaction(
    label = 'reaction18',
    reactants = ['C[CH]C[C](CCC)OO(4384)'],
    products = ['S(180)(179)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2]CCC([CH]CC)OO(5400)'],
    products = ['S(180)(179)'],
...
reaction(
    label = 'reaction20',
    reactants = ['C[CH]CC([CH]CC)OO(4386)'],
    products = ['S(180)(179)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH2]CCC(CCC)O[O](4378)'],
    products = ['S(180)(179)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH2]CCC(C[CH]C)OO(4390)'],
    products = ['S(180)(179)'],
...
reaction(
    label = 'reaction23',
    reactants = ['C[CH]CC(CCC)O[O](4377)'],
    products = ['S(180)(179)'],
...
reaction(
    label = 'reaction24',
    reactants = ['C[CH]CC(C[CH]C)OO(4388)'],
    products = ['S(180)(179)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[CH2]CCC(CC[CH2])OO(5401)'],
    products = ['S(180)(179)'],
...
reaction(
    label = 'reaction26',
    reactants = ['CH2(S)(21)(22)', 'C=CCC(CC)OO(5402)'],
    products = ['S(180)(179)'],
