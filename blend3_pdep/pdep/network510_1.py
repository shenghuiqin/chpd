...
species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.880822,'amu*angstrom^2'), symmetry=1, barrier=(20.2518,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.881965,'amu*angstrom^2'), symmetry=1, barrier=(20.2781,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.879061,'amu*angstrom^2'), symmetry=1, barrier=(20.2113,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.877354,'amu*angstrom^2'), symmetry=1, barrier=(20.1721,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (108.138,'amu'),
...
species(
    label = 'OC1[CH]C2[CH]C1C=C2(2569)',
...
reaction(
    label = 'reaction1163',
    reactants = ['OH(5)(5)', '[CH]=CC1C=CC=C1(2557)'],
...
reaction(
    label = 'reaction1164',
    reactants = ['H(3)(3)', '[O]C=CC1C=CC=C1(1920)'],
    products = ['C7H8O(618)(617)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction1165',
    reactants = ['CHCHOH(49)(49)', '[CH]1C=CC=C1(2558)'],
    products = ['C7H8O(618)(617)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction1167',
    reactants = ['H(3)(3)', 'OC=CC1[C]=CC=C1(2559)'],
    products = ['C7H8O(618)(617)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction1168',
    reactants = ['H(3)(3)', 'OC=[C]C1C=CC=C1(2560)'],
    products = ['C7H8O(618)(617)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(1e+13,'cm^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""From training reaction 40 used for Cd_rad/NonDe;H_rad
Exact match found for rate rule [Cd_rad/NonDe;H_rad]
...
reaction(
    label = 'reaction1169',
    reactants = ['H(3)(3)', 'OC=CC1C=[C]C=C1(2561)'],
    products = ['C7H8O(618)(617)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction1170',
    reactants = ['H(3)(3)', 'O[C]=CC1C=CC=C1(2562)'],
    products = ['C7H8O(618)(617)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(1e+13,'cm^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""From training reaction 40 used for Cd_rad/NonDe;H_rad
Exact match found for rate rule [Cd_rad/NonDe;H_rad]
...
reaction(
    label = 'reaction1175',
    reactants = ['OC=CC1[C]=C[CH]C1(1926)'],
    products = ['C7H8O(618)(617)'],
...
reaction(
    label = 'reaction1176',
    reactants = ['O[CH]CC1[C]=CC=C1(2563)'],
    products = ['C7H8O(618)(617)'],
...
reaction(
    label = 'reaction1182',
    reactants = ['O[CH]CC1C=[C]C=C1(2564)'],
    products = ['C7H8O(618)(617)'],
...
reaction(
    label = 'reaction1188',
    reactants = ['[CH]=CC(C=[CH])C=CO(2565)'],
    products = ['C7H8O(618)(617)'],
...
reaction(
    label = 'reaction1194',
    reactants = ['[OH+]=[C-]CC1C=CC=C1(2567)'],
    products = ['C7H8O(618)(617)'],
...
reaction(
    label = 'reaction1196',
    reactants = ['OC1[CH]C2[CH]C1C=C2(2569)'],
    products = ['C7H8O(618)(617)'],
