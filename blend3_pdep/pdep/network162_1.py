...
species(
    label = 'C=[C]C1C2C=COC12(1863)',
    structure = SMILES('C=[C]C1C2C=COC12'),
    E0 = (306.665,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,2950,3050,3150,900,950,1000,1050,1100,1685,370,2950,3100,1380,975,1025,1650,300,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
species(
    label = '[CH]=CC1C2C=COC12(1865)',
    structure = SMILES('[CH]=CC1C2C=COC12'),
    E0 = (315.919,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,2950,3050,3150,900,950,1000,1050,1100,3010,987.5,1337.5,450,1655,3120,650,792.5,1650,300,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
species(
    ...
    molecularWeight = (108.138,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.48941,0.0423796,1.62423e-05,-4.3507e-08,1.71871e-11,46403.2,25.6268], Tmin=(100,'K'), Tmax=(1051.92,'K')), NASAPolynomial(coeffs=[11.5205,0.0340053,-1.4266e-05,2.73079e-09,-1.95447e-13,42645.8,-31.1038], Tmin=(1051.92,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(384.975,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(378.308,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + polycyclic(s2_3_5_ane) + radical(CCJCO) + radical(C2CsJOCs)"""),
)

species(
    label = 'C=C[C]1C2C[CH]OC12(1869)',
    structure = SMILES('[CH2]C=C1C2C[CH]OC12'),
    E0 = (318.644,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,2950,3050,3150,900,950,1000,1050,1100,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,300,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
species(
    label = 'C[CH]C1[C]2C=COC21(1874)',
    structure = SMILES('C[CH]C1[C]2C=COC21'),
    E0 = (287.087,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,300,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
...
species(
    label = '[CH]=COC1[CH]C1C=C(1885)',
    structure = SMILES('[CH]=COC1[CH]C1C=C'),
    E0 = (459.914,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2950,3150,900,1000,1100,2995,3025,975,1000,1300,1375,400,500,1630,1680,3120,650,792.5,1650,2950,3100,1380,975,1025,1650,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
...
species(
    label = '[CH]1OC2C3[CH]CC1C32(1893)',
...
reaction(
    label = 'reaction191',
    reactants = ['H(3)(3)', 'C=CC1[C]2C=COC21(1858)'],
...
reaction(
    label = 'reaction192',
    reactants = ['C2H3(28)(29)', '[CH]1C2C=COC12(1859)'],
    products = ['C7H8O(553)(552)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction193',
    reactants = ['H(3)(3)', 'C=C[C]1C2C=COC12(1860)'],
    products = ['C7H8O(553)(552)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(2.92e+13,'cm^3/(mol*s)'), n=0.18, Ea=(0.518816,'kJ/mol'), T0=(1,'K'), Tmin=(200,'K'), Tmax=(2000,'K'), comment="""From training reaction 123 used for H_rad;C_rad/OneDeCs2
Exact match found for rate rule [C_rad/OneDeCs2;H_rad]
...
reaction(
    label = 'reaction194',
    reactants = ['H(3)(3)', 'C=CC1[C]2OC=CC21(1861)'],
    products = ['C7H8O(553)(552)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction195',
    reactants = ['H(3)(3)', 'C=CC1C2[C]=COC21(1862)'],
    products = ['C7H8O(553)(552)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction196',
    reactants = ['H(3)(3)', 'C=[C]C1C2C=COC12(1863)'],
    products = ['C7H8O(553)(552)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(1e+13,'cm^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""From training reaction 40 used for Cd_rad/NonDe;H_rad
Exact match found for rate rule [Cd_rad/NonDe;H_rad]
...
reaction(
    label = 'reaction197',
    reactants = ['H(3)(3)', 'C=CC1C2C=[C]OC12(1864)'],
    products = ['C7H8O(553)(552)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(1e+13,'cm^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""From training reaction 40 used for Cd_rad/NonDe;H_rad
Exact match found for rate rule [Cd_rad/NonDe;H_rad]
...
reaction(
    label = 'reaction198',
    reactants = ['H(3)(3)', '[CH]=CC1C2C=COC12(1865)'],
    products = ['C7H8O(553)(552)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction199',
    reactants = ['C=CC1[C]2C[CH]OC21(1866)'],
    products = ['C7H8O(553)(552)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction200',
    reactants = ['[CH2]C[C]1C2C=COC12(1867)'],
    products = ['C7H8O(553)(552)'],
...
reaction(
    label = 'reaction201',
    reactants = ['C=CC1[C]2OC[CH]C21(1868)'],
    products = ['C7H8O(553)(552)'],
...
reaction(
    label = 'reaction202',
    reactants = ['C=C[C]1C2C[CH]OC12(1869)'],
    products = ['C7H8O(553)(552)'],
...
reaction(
    label = 'reaction203',
    reactants = ['C=CC1[C]2O[CH]CC21(1870)'],
    products = ['C7H8O(553)(552)'],
...
reaction(
    label = 'reaction204',
    reactants = ['[CH2]CC1[C]2C=COC21(1871)'],
    products = ['C7H8O(553)(552)'],
...
reaction(
    label = 'reaction205',
    reactants = ['[CH2]CC1[C]2OC=CC21(1872)'],
    products = ['C7H8O(553)(552)'],
...
reaction(
    label = 'reaction206',
    reactants = ['C=C[C]1C2[CH]COC12(1873)'],
    products = ['C7H8O(553)(552)'],
...
reaction(
    label = 'reaction207',
    reactants = ['C[CH]C1[C]2C=COC21(1874)'],
    products = ['C7H8O(553)(552)'],
...
reaction(
    label = 'reaction208',
    reactants = ['C[CH]C1[C]2OC=CC21(1875)'],
    products = ['C7H8O(553)(552)'],
...
reaction(
    label = 'reaction209',
    reactants = ['[CH2]CC1C2[C]=COC21(1876)'],
    products = ['C7H8O(553)(552)'],
...
reaction(
    label = 'reaction210',
    reactants = ['C=[C]C1C2C[CH]OC12(1877)'],
    products = ['C7H8O(553)(552)'],
...
reaction(
    label = 'reaction211',
    reactants = ['C=CC1[C]2[CH]COC21(1878)'],
    products = ['C7H8O(553)(552)'],
...
reaction(
    label = 'reaction212',
    reactants = ['C[CH]C1C2[C]=COC21(1879)'],
    products = ['C7H8O(553)(552)'],
...
reaction(
    label = 'reaction213',
    reactants = ['C=[C]C1C2[CH]COC12(1880)'],
    products = ['C7H8O(553)(552)'],
...
reaction(
    label = 'reaction214',
    reactants = ['[CH2]CC1C2C=[C]OC21(1881)'],
    products = ['C7H8O(553)(552)'],
...
reaction(
    label = 'reaction215',
    reactants = ['[CH]=CC1C2C[CH]OC12(1882)'],
    products = ['C7H8O(553)(552)'],
...
reaction(
    label = 'reaction216',
    reactants = ['C[CH]C1C2C=[C]OC12(1883)'],
    products = ['C7H8O(553)(552)'],
...
reaction(
    label = 'reaction217',
    reactants = ['[CH]=CC1C2[CH]COC21(1884)'],
    products = ['C7H8O(553)(552)'],
...
reaction(
    label = 'reaction218',
    reactants = ['[CH2]C=CC1[CH]OC=C1(1835)'],
    products = ['C7H8O(553)(552)'],
...
reaction(
    label = 'reaction219',
    reactants = ['C=CC1[CH]O[CH]C=C1(1851)'],
    products = ['C7H8O(553)(552)'],
...
reaction(
    label = 'reaction220',
    reactants = ['[CH]=COC1[CH]C1C=C(1885)'],
    products = ['C7H8O(553)(552)'],
...
reaction(
    label = 'reaction221',
    reactants = ['[CH]=CC1C([O])C1C=C(1886)'],
    products = ['C7H8O(553)(552)'],
...
reaction(
    label = 'reaction222',
    reactants = ['C=CC1[CH]C1C=C[O](1887)'],
    products = ['C7H8O(553)(552)'],
...
reaction(
    label = 'reaction224',
    reactants = ['C=CC1C2[C]COC21(1889)'],
    products = ['C7H8O(553)(552)'],
...
reaction(
    label = 'reaction225',
    reactants = ['C[C]C1C2C=COC12(1890)'],
    products = ['C7H8O(553)(552)'],
...
reaction(
    label = 'reaction226',
    reactants = ['C=CC1C2C[C-]=[O+]C12(1891)'],
    products = ['C7H8O(553)(552)'],
...
reaction(
    label = 'reaction227',
    reactants = ['[CH]CC1C2C=COC21(1892)'],
    products = ['C7H8O(553)(552)'],
...
reaction(
    label = 'reaction229',
    reactants = ['[CH]1OC2C3[CH]CC1C32(1893)'],
    products = ['C7H8O(553)(552)'],
...
reaction(
    ...
    products = ['C=CC1C2C(C=O)C12(1888)'],
