...
species(
    label = '[CH2]OC1[CH]C2CCCC21(7498)',
...
species(
    label = '[CH2]OC1C2[CH]CCCC21(7500)',
...
species(
    label = '[CH]=CCCCC=CO[CH2](7502)',
    structure = SMILES('[CH]=CCCCC=CO[CH2]'),
    E0 = (288.915,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2995,3010,3025,975,987.5,1000,1300,1337.5,1375,400,450,500,1630,1655,1680,3120,650,792.5,1650,3000,3100,440,815,1455,1000,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)(3)', '[CH2]OC1C=CCCCC=1(7491)'],
    products = ['[CH2]OC1[CH]CCCC=C1(7133)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)(3)', '[CH2]OC1C=CCCC=C1(7492)'],
    products = ['[CH2]OC1[CH]CCCC=C1(7133)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2]OC1[CH]CCCC=C1(7133)'],
    products = ['CO[C]1[CH]CCCC=C1(7493)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]OC1[CH]CCCC=C1(7133)'],
    products = ['[CH2]OC1C=CC[CH]CC1(7160)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['COC1[C]=CCCC[CH]1(7494)'],
    products = ['[CH2]OC1[CH]CCCC=C1(7133)'],
...
reaction(
    label = 'reaction13',
    reactants = ['COC1[CH][CH]CCC=C1(7495)'],
    products = ['[CH2]OC1[CH]CCCC=C1(7133)'],
...
reaction(
    label = 'reaction14',
    reactants = ['COC1[CH]CCC[C]=C1(7496)'],
    products = ['[CH2]OC1[CH]CCCC=C1(7133)'],
...
reaction(
    label = 'reaction15',
    reactants = ['COC1[CH]C[CH]CC=C1(7497)'],
    products = ['[CH2]OC1[CH]CCCC=C1(7133)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2]OC1[CH]CCCC=C1(7133)'],
    products = ['[CH2]OC1[CH]C2CCCC21(7498)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2]OC1[CH]CCCC=C1(7133)'],
    products = ['[CH2]OC1C2[CH]CCCC21(7500)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH]=CCCCC=CO[CH2](7502)'],
    products = ['[CH2]OC1[CH]CCCC=C1(7133)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH2]CC=CC(C=C)O[CH2](7503)'],
    products = ['[CH2]OC1[CH]CCCC=C1(7133)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[CH2]OC1[CH]CCCC=C1(7133)'],
    products = ['[CH2]O[CH]C1C=CCCC1(7158)'],
...
reaction(
    label = 'reaction27',
    reactants = ['[CH2]OC1[CH]CCCC=C1(7133)'],
    products = ['[CH2]OC1C=CCCC1[CH2](7506)'],
...
reaction(
    label = 'reaction29',
    reactants = ['CH2(17)(18)', '[O]C1[CH]CCCC=C1(1564)'],
    products = ['[CH2]OC1[CH]CCCC=C1(7133)'],
