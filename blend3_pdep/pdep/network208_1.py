...
reaction(
    label = 'reaction1',
    reactants = ['H(3)(3)', 'C2H2(30)(31)'],
    products = ['C2H3(28)(29)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(1.7e+10,'cm^3/(mol*s)'), n=1.266, Ea=(2709,'cal/mol'), T0=(1,'K'), comment="""Kinetics taken from the arrheniusHigh attribute of a Troe/Lindemann exprssion. Originally from reaction library Klippenstein_Glarborg2016"""),
)

reaction(
    label = 'reaction2',
    reactants = ['H(3)(3)', 'C2H2(T)(4186)'],
    products = ['C2H3(28)(29)'],
    transitionState = 'TS2',
