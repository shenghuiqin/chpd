...
species(
    label = '[CH]1CC=CC2[CH]C1OC2(8652)',
...
species(
    label = 'O[CH]C1C=C[CH]CC=C1(8666)',
    structure = SMILES('O[CH]C1C=C[CH]CC=C1'),
    E0 = (218.362,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,3025,407.5,1350,352.5,2750,2807.14,2864.29,2921.43,2978.57,3035.71,3092.86,3150,900,928.571,957.143,985.714,1014.29,1042.86,1071.43,1100,300,800,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
...
species(
    label = 'OCC1[C]=CC[CH]C=C1(8670)',
    structure = SMILES('OCC1[C]=CC[CH]C=C1'),
    E0 = (275.905,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,2750,2816.67,2883.33,2950,3016.67,3083.33,3150,900,933.333,966.667,1000,1033.33,1066.67,1100,300,800,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
...
species(
    ...
    molecularWeight = (122.164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0423623,0.0808517,-5.6374e-05,1.97869e-08,-2.8251e-12,30092.6,14.8206], Tmin=(100,'K'), Tmax=(1614.99,'K')), NASAPolynomial(coeffs=[17.9286,0.0363404,-1.50313e-05,2.72039e-09,-1.8316e-13,24288.1,-80.4928], Tmin=(1614.99,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(248.942,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + ring(1,3-Cycloheptadiene) + radical(CCOJ) + radical(Allyl_S)"""),
)

species(
    label = 'OCC1C=[C]C[CH]C=C1(8673)',
...
species(
    label = '[CH]1C=CC[CH]C2OCC12(8657)',
...
species(
    label = '[CH]=CC(C=CC=C)C[O](8680)',
    structure = SMILES('[CH]=CC(C=CC=C)C[O]'),
    E0 = (419.926,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2950,3100,1380,975,1025,1650,1380,1390,370,380,2900,435,3120,650,792.5,1650,2995,3005,3015,3025,975,983.333,991.667,1000,1300,1325,1350,1375,400,433.333,466.667,500,1630,1646.67,1663.33,1680,278.117,278.142,278.145,278.153],'cm^-1')),
        HinderedRotor(inertia=(0.218795,'amu*angstrom^2'), symmetry=1, barrier=(12.0124,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.218807,'amu*angstrom^2'), symmetry=1, barrier=(12.0126,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.2188,'amu*angstrom^2'), symmetry=1, barrier=(12.0124,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.218865,'amu*angstrom^2'), symmetry=1, barrier=(12.0124,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (122.164,'amu'),
...
species(
    label = '[CH2]C1C=CC(C=C1)C[O](8684)',
...
species(
    label = '[CH]=CCC=CC=CC[O](8695)',
    structure = SMILES('[CH]=CCC=CC=CC[O]'),
    E0 = (424.162,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2995,3002.5,3010,3017.5,3025,975,981.25,987.5,993.75,1000,1300,1318.75,1337.5,1356.25,1375,400,425,450,475,500,1630,1642.5,1655,1667.5,1680,3120,650,792.5,1650,220.24,220.249,220.571,4000],'cm^-1')),
        HinderedRotor(inertia=(0.309856,'amu*angstrom^2'), symmetry=1, barrier=(10.6571,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.606137,'amu*angstrom^2'), symmetry=1, barrier=(20.9095,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.422236,'amu*angstrom^2'), symmetry=1, barrier=(14.5343,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.607319,'amu*angstrom^2'), symmetry=1, barrier=(20.9097,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (122.164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.366595,0.0795351,-6.03455e-05,2.44453e-08,-4.17034e-12,51145.6,35.3224], Tmin=(100,'K'), Tmax=(1338.33,'K')), NASAPolynomial(coeffs=[13.0005,0.0417752,-1.80245e-05,3.36388e-09,-2.32365e-13,47763.9,-29.3107], Tmin=(1338.33,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(424.162,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(440.667,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + radical(CCOJ) + radical(Cds_P)"""),
)

species(
    label = 'OCC1C=CCC=CC=1(8696)',
...
species(
    label = '[O]C[CH]C1C=CCC=C1(8698)',
    structure = SMILES('[O]C[CH]C1C=CCC=C1'),
    E0 = (302.247,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2816.67,2883.33,2950,3016.67,3083.33,3150,900,933.333,966.667,1000,1033.33,1066.67,1100,3025,407.5,1350,352.5,2750,2850,1437.5,1250,1305,750,350,300,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
...
reaction(
    label = 'reaction2',
    reactants = ['[O]CC1[CH]C=CCC=C1(8447)'],
    products = ['[CH]1CC=CC2[CH]C1OC2(8652)'],
    transitionState = 'TS2',
...
reaction(
    ...
    products = ['[O]CC1[CH]C=CCC=C1(8447)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)(3)', 'O=CC1C=C[CH]CC=C1(8664)'],
    products = ['[O]CC1[CH]C=CCC=C1(8447)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)(3)', '[O]CC1C=C=CCC=C1(8665)'],
    products = ['[O]CC1[CH]C=CCC=C1(8447)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['O[CH]C1C=C[CH]CC=C1(8666)'],
    products = ['[O]CC1[CH]C=CCC=C1(8447)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]CC1C=[C]CCC=C1(8667)'],
    products = ['[O]CC1[CH]C=CCC=C1(8447)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[O]CC1[CH]C=CCC=C1(8447)'],
    products = ['OC[C]1C=C[CH]CC=C1(8668)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]CC1[C]=CCCC=C1(8669)'],
    products = ['[O]CC1[CH]C=CCC=C1(8447)'],
...
reaction(
    label = 'reaction11',
    reactants = ['OCC1[C]=CC[CH]C=C1(8670)'],
    products = ['[O]CC1[CH]C=CCC=C1(8447)'],
...
reaction(
    label = 'reaction12',
    reactants = ['OCC1[C]=C[CH]CC=C1(8671)'],
    products = ['[O]CC1[CH]C=CCC=C1(8447)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[O]C[C]1C=CCCC=C1(8672)'],
    products = ['[O]CC1[CH]C=CCC=C1(8447)'],
...
reaction(
    label = 'reaction14',
    reactants = ['OCC1C=[C]C[CH]C=C1(8673)'],
    products = ['[O]CC1[CH]C=CCC=C1(8447)'],
...
reaction(
    label = 'reaction15',
    reactants = ['OCC1C=[C][CH]CC=C1(8674)'],
    products = ['[O]CC1[CH]C=CCC=C1(8447)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[O][CH]C1C=CCCC=C1(8675)'],
    products = ['[O]CC1[CH]C=CCC=C1(8447)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[O]CC1[CH]C=CCC=C1(8447)'],
    products = ['[O]CC1C=CCC2[CH]C21(8677)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[O]CC1[CH]C=CCC=C1(8447)'],
    products = ['[O]CC1C=CC2C[CH]C12(8678)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[O]CC1[CH]C=CCC=C1(8447)'],
    products = ['[O]CC1[CH]C2CC2C=C1(8679)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[O]CC1[CH]C=CCC=C1(8447)'],
    products = ['[CH]1C=CC[CH]C2OCC12(8657)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[CH]=CC(C=CC=C)C[O](8680)'],
    products = ['[O]CC1[CH]C=CCC=C1(8447)'],
...
reaction(
    label = 'reaction29',
    reactants = ['[CH2]C1C=CC(C=C1)C[O](8684)'],
    products = ['[O]CC1[CH]C=CCC=C1(8447)'],
...
reaction(
    label = 'reaction31',
    reactants = ['O(4)(4)', '[CH2]C1C=C[CH]CC=C1(4353)'],
    products = ['[O]CC1[CH]C=CCC=C1(8447)'],
...
reaction(
    label = 'reaction32',
    reactants = ['H(3)(3)', '[O]CC1C=CCC=CC=1(8685)'],
    products = ['[O]CC1[CH]C=CCC=C1(8447)'],
...
reaction(
    label = 'reaction34',
    reactants = ['[O]CC1[CH]C=CCC=C1(8447)'],
    products = ['[O]C[C]1C=CCC=CC1(8686)'],
...
reaction(
    label = 'reaction41',
    reactants = ['OCC1[CH]C=[C]CC=C1(8692)'],
    products = ['[O]CC1[CH]C=CCC=C1(8447)'],
...
reaction(
    label = 'reaction42',
    reactants = ['[O]CC1[CH]C=CCC=C1(8447)'],
    products = ['[O]CC1[CH]C2CC=CC12(8693)'],
...
reaction(
    label = 'reaction44',
    reactants = ['[O]CC1[CH]C=CCC=C1(8447)'],
    products = ['[O]CC1C2[CH]CC=CC21(8694)'],
...
reaction(
    label = 'reaction48',
    reactants = ['[O]C[CH]C1C=CCC=C1(8698)'],
    products = ['[O]CC1[CH]C=CCC=C1(8447)'],
