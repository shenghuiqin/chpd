species(
    label = 'S(683)(682)',
    structure = SMILES('C=C1CCC=CC1O[O]'),
    E0 = (111.613,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2950,3100,1380,975,1025,1650,2750,2816.67,2883.33,2950,3016.67,3083.33,3150,900,933.333,966.667,1000,1033.33,1066.67,1100,300,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.960543,0.046743,4.15281e-05,-7.93271e-08,3.05574e-11,13550.7,26.3796], Tmin=(100,'K'), Tmax=(1036.96,'K')), NASAPolynomial(coeffs=[15.602,0.0387337,-1.6998e-05,3.37453e-09,-2.48076e-13,7908.26,-57.3535], Tmin=(1036.96,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(111.613,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(428.195,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)(Cds-Cds)OsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Cyclohexane) + radical(ROOJ)"""),
)
...
species(
    label = '[CH2]C12CCC=CC1OO2(3489)',
    structure = SMILES('[CH2]C12CCC=CC1OO2'),
    E0 = (219.615,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (125.145,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.598856,0.0547647,2.41755e-05,-6.74817e-08,2.80649e-11,26553.5,24.7257], Tmin=(100,'K'), Tmax=(1021.11,'K')), NASAPolynomial(coeffs=[17.9499,0.0338905,-1.43431e-05,2.83472e-09,-2.09378e-13,20554.8,-71.368], Tmin=(1021.11,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(219.615,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(428.195,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsCsOs) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + polycyclic(s2_4_6_ene_1) + radical(CJCOOH)"""),
)

species(
    label = 'C=C1CCC=C[C]1OO(3490)',
    structure = SMILES('[CH2]C1CCC=CC=1OO'),
    E0 = (77.9752,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (125.145,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.475613,0.0634579,-1.08769e-05,-2.78945e-08,1.40915e-11,9517.31,28.2167], Tmin=(100,'K'), Tmax=(1032.29,'K')), NASAPolynomial(coeffs=[15.5189,0.0354476,-1.41758e-05,2.65196e-09,-1.88027e-13,4798.11,-52.6513], Tmin=(1032.29,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(77.9752,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(419.881,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-Cds(Cds-Cds)O2s) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + ring(1,3-Cyclohexadiene) + radical(C=CC=CCJ)"""),
)

species(
    label = 'C=C1CCC=[C]C1OO(3491)',
    structure = SMILES('C=C1CCC=[C]C1OO'),
    E0 = (197.45,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (125.145,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.639788,0.0551559,2.09814e-05,-5.92667e-08,2.35494e-11,23884.7,27.2492], Tmin=(100,'K'), Tmax=(1064.41,'K')), NASAPolynomial(coeffs=[16.5871,0.0389212,-1.7715e-05,3.53554e-09,-2.58952e-13,18014.5,-62.3101], Tmin=(1064.41,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(197.45,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(424.038,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)(Cds-Cds)OsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Cyclohexane) + radical(Cds_S)"""),
)

species(
    label = 'C=C1[CH]CC=CC1OO(3492)',
    structure = SMILES('C=C1[CH]CC=CC1OO'),
    E0 = (100.721,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (125.145,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.886914,0.0451971,5.4915e-05,-9.68235e-08,3.71874e-11,12246.2,25.4717], Tmin=(100,'K'), Tmax=(1027.89,'K')), NASAPolynomial(coeffs=[17.4369,0.0375553,-1.6766e-05,3.39099e-09,-2.5301e-13,5845.31,-69.4136], Tmin=(1027.89,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(100.721,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(424.038,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)(Cds-Cds)OsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Cyclohexane) + radical(Allyl_S)"""),
)

species(
    label = '[CH]=C1CCC=CC1OO(3493)',
    structure = SMILES('[CH]=C1CCC=CC1OO'),
    E0 = (206.704,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (125.145,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.600909,0.0540932,2.88761e-05,-7.05551e-08,2.82057e-11,25001,28.009], Tmin=(100,'K'), Tmax=(1043.02,'K')), NASAPolynomial(coeffs=[17.777,0.036975,-1.66179e-05,3.33699e-09,-2.4675e-13,18766.1,-68.2915], Tmin=(1043.02,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(206.704,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(424.038,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)(Cds-Cds)OsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Cyclohexane) + radical(Cds_P)"""),
)

species(
    label = 'C=C1CC[C]=CC1OO(3494)',
...
species(
    ...
    molecularWeight = (125.145,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.958976,0.0337499,0.000107351,-1.63691e-07,6.37174e-11,4321.89,26.6104], Tmin=(100,'K'), Tmax=(984.275,'K')), NASAPolynomial(coeffs=[22.4732,0.0291208,-1.17829e-05,2.4703e-09,-1.95338e-13,-3924.24,-97.2175], Tmin=(984.275,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(34.7778,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(424.038,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Cyclohexane) + radical(C=CCJC(O)C=C)"""),
)
...
species(
    label = 'C=C1CC[CH]C2OOC12(3501)',
    structure = SMILES('C=C1CC[CH]C2OOC12'),
    E0 = (233.367,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (125.145,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.13003,0.0418866,5.36029e-05,-9.15339e-08,3.48647e-11,28189.4,24.4736], Tmin=(100,'K'), Tmax=(1026.32,'K')), NASAPolynomial(coeffs=[15.4933,0.0378548,-1.64275e-05,3.2727e-09,-2.42047e-13,22505.2,-58.523], Tmin=(1026.32,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(233.367,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + polycyclic(s2_4_6_ane) + radical(CCJCOOH)"""),
)
...
species(
    label = 'C=CC1CC(=C)C1O[O](3502)',
    structure = SMILES('C=CC1CC(=C)C1O[O]'),
    E0 = (223.307,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2950,3000,3050,3100,1330,1430,900,1050,1000,1050,1600,1700,2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,3010,987.5,1337.5,450,1655,262.424,787.519,787.519,787.519,787.519,787.519,787.519,787.519,787.519,787.519,4000,4000,4000,4000,4000,4000,4000,4000],'cm^-1')),
        HinderedRotor(inertia=(0.00379192,'amu*angstrom^2'), symmetry=1, barrier=(19.4068,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00379192,'amu*angstrom^2'), symmetry=1, barrier=(19.4068,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (125.145,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[10.0007,0.00355287,0.000114141,-1.17822e-07,2.74631e-11,26522.8,-10.9888], Tmin=(100,'K'), Tmax=(1728.22,'K')), NASAPolynomial(coeffs=[81.3346,0.0281603,-7.18763e-05,1.74534e-08,-1.29382e-12,-26464.1,-476.125], Tmin=(1728.22,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(223.307,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(424.038,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + ring(methylenecyclobutane) + radical(ROOJ)"""),
)
...
species(
    label = 'C=C1CCC=CC1[O](3503)',
    structure = SMILES('C=C1CCC=CC1[O]'),
    E0 = (118.464,'kJ/mol'),
    modes = [
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.57557,0.0289858,8.45136e-05,-1.23167e-07,4.61589e-11,14356.6,22.4565], Tmin=(100,'K'), Tmax=(1005.17,'K')), NASAPolynomial(coeffs=[15.5313,0.0344382,-1.4635e-05,2.95485e-09,-2.22691e-13,8470.04,-60.2695], Tmin=(1005.17,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(118.464,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(407.409,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)(Cds-Cds)OsH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Cyclohexane) + radical(CC(C)OJ)"""),
)
...
reaction(
    label = 'reaction9',
    reactants = ['H(3)(3)', 'C=C1[CH]CC=CC1O[O](3496)'],
    products = ['S(683)(682)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction10',
    reactants = ['H(3)(3)', 'C=C1CCC=C[C]1O[O](3497)'],
    products = ['S(683)(682)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction12',
    reactants = ['H(3)(3)', 'C=C1CC[C]=CC1O[O](3498)'],
    products = ['S(683)(682)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction13',
    reactants = ['H(3)(3)', 'C=C1CCC=[C]C1O[O](3499)'],
    products = ['S(683)(682)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(1e+13,'cm^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""From training reaction 40 used for Cd_rad/NonDe;H_rad
Exact match found for rate rule [Cd_rad/NonDe;H_rad]
...
reaction(
    label = 'reaction14',
    reactants = ['H(3)(3)', '[CH]=C1CCC=CC1O[O](3500)'],
    products = ['S(683)(682)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction19',
    reactants = ['H2CCCH2(838)', 'C=CC=CO[O](2629)'],
    products = ['S(683)(682)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(0.354,'cm^3/(mol*s)'), n=2.94, Ea=(121.336,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""Estimated using an average for rate rule [diene_out;diene_in_2H;allene_unsub]
Euclidian distance = 0
Multiplied by reaction path degeneracy 2.0
...
reaction(
    label = 'reaction2',
    reactants = ['S(683)(682)'],
    products = ['[CH2]C12CCC=CC1OO2(3489)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(4.20137e+08,'s^-1'), n=0.864, Ea=(109.089,'kJ/mol'), T0=(1,'K'), comment="""Estimated using average of templates [R5_SS_D;doublebond_intra_2H;radadd_intra_O] + [R5_SS_D;doublebond_intra_2H_secNd;radadd_intra] for rate rule [R5_SS_D;doublebond_intra_2H_secNd;radadd_intra_O]
Euclidian distance = 1.0
...
reaction(
    label = 'reaction5',
    reactants = ['S(683)(682)'],
    products = ['C=C1[CH]CC=CC1OO(3492)'],
...
reaction(
    label = 'reaction8',
    reactants = ['S(683)(682)'],
    products = ['C=C1C[CH]C=CC1OO(3495)'],
...
reaction(
    label = 'reaction17',
    reactants = ['S(683)(682)'],
    products = ['C=C1CC[CH]C2OOC12(3501)'],
    transitionState = 'TS18',
    kinetics = Arrhenius(A=(1.99832e+10,'s^-1'), n=0.37247, Ea=(121.754,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R6plus;doublebond_intra_pri;radadd_intra] for rate rule [Rn2c6_alpha_long;doublebond_intra_pri;radadd_intra_O]
Euclidian distance = 3.16227766017
family: Intra_R_Add_Endocyclic
Ea raised from 121.0 to 121.8 kJ/mol to match endothermicity of reaction."""),
)
...
reaction(
    label = 'reaction20',
    reactants = ['C=CC1CC(=C)C1O[O](3502)'],
    products = ['S(683)(682)'],
...
reaction(
    label = 'reaction21',
    reactants = ['O(4)(4)', 'C=C1CCC=CC1[O](3503)'],
    products = ['S(683)(682)'],
