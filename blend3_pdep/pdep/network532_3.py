...
reaction(
    label = 'reaction15',
    reactants = ['H(3)(3)', '[CH2][CH]OO(1697)'],
    products = ['C2H5O2(43)(43)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction3',
    reactants = ['O2(2)(2)', 'C2H5(27)(28)'],
    products = ['C2H5O2(37)(38)'],
    transitionState = 'TS13',
    kinetics = Arrhenius(A=(1.5e+15,'cm^3/(mol*s)'), n=-1, Ea=(0,'cal/mol'), T0=(1,'K'), comment="""Kinetics taken from the arrheniusHigh attribute of a Troe/Lindemann exprssion. Originally from reaction library Klippenstein_Glarborg2016"""),
)

reaction(
    label = 'reaction4',
    reactants = ['CH3(15)(16)', '[CH2]O[O](1428)'],
    products = ['C2H5O2(37)(38)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(2.98e+15,'s^-1'), n=-0.09, Ea=(62630.2,'cal/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), comment="""Matched reaction 3 CH3CH2OO = CH3CH2O + O in Birad_R_Recombination/training
This reaction matched rate rule [O_rad/NonDe;O_birad]
family: Birad_R_Recombination
Ea raised from 257.7 to 262.0 kJ/mol to match endothermicity of reaction."""),
)
...
reaction(
    label = 'reaction20',
    reactants = ['C2H5O2(61)(60)'],
    products = ['OH(5)(5)', 'CH3CHO(35)(36)'],
    transitionState = 'TS20',
    kinetics = Arrhenius(A=(5.75e+14,'s^-1'), n=-1.012, Ea=(1068,'cal/mol'), T0=(1,'K')),
)
...
reaction(
    label = 'reaction25',
    reactants = ['HO2(8)(9)', 'CHCH3(T)(1022)'],
    products = ['C2H5O2(61)(60)'],
...
reaction(
    label = 'reaction26',
    reactants = ['CH3(15)(16)', '[CH]OO(1700)'],
    products = ['C2H5O2(61)(60)'],
