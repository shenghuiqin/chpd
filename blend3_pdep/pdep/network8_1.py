species(
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.00291681,0.0769374,-3.48026e-05,1.86095e-09,2.01574e-12,-25782.9,30.0312], Tmin=(100,'K'), Tmax=(1262.73,'K')), NASAPolynomial(coeffs=[13.8378,0.0485945,-1.95475e-05,3.52837e-09,-2.39065e-13,-30514.2,-44.8643], Tmin=(1262.73,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-215.645,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(532.126,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH)"""),
)
...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.793255,0.0605341,-1.59687e-05,-1.17105e-08,6.10126e-12,-22952.3,24.9186], Tmin=(100,'K'), Tmax=(1144.98,'K')), NASAPolynomial(coeffs=[11.0309,0.0431955,-1.73946e-05,3.17574e-09,-2.18144e-13,-26504.5,-31.1328], Tmin=(1144.98,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-191.865,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['C4H9(68)(67)', 'C3H7(69)(68)'],
    products = ['C7H16(1)(1)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['C5H11(67)(66)', 'C2H5(27)(28)'],
    products = ['C7H16(1)(1)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(8.73e+14,'cm^3/(mol*s)'), n=-0.699, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(200,'K'), Tmax=(2000,'K'), comment="""From training reaction 11 used for C_rad/H2/Cs;C_rad/H2/Cs
Exact match found for rate rule [C_rad/H2/Cs;C_rad/H2/Cs]
...
reaction(
    label = 'reaction5',
    reactants = ['C6H13(78)(77)', 'CH3(15)(16)'],
    products = ['C7H16(1)(1)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['CH2(S)(21)(22)', 'CCCCCC(844)'],
    products = ['C7H16(1)(1)'],
    transitionState = 'TS8',
...
network(
    ...
    reactants = [
        ('C4H9(68)(67)', 'C3H7(69)(68)'),
        ('C5H11(67)(66)', 'C2H5(27)(28)'),
        ('H(3)(3)', 'C7H15(72)(71)'),
        ('H(3)(3)', 'C7H15(70)(69)'),
        ('C6H13(78)(77)', 'CH3(15)(16)'),
        ('H(3)(3)', 'C7H15(71)(70)'),
        ('H(3)(3)', 'C7H15(85)(84)'),
    ],
    bathGas = {
