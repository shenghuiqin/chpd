species(
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.770507,0.104279,-7.68139e-05,3.00294e-08,-4.94993e-12,-37907.7,36.5748], Tmin=(100,'K'), Tmax=(1376.13,'K')), NASAPolynomial(coeffs=[15.8738,0.0558995,-2.40792e-05,4.48219e-09,-3.08806e-13,-42488.7,-49.0386], Tmin=(1376.13,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-316.61,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(573.699,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH)"""),
)
...
species(
    label = 'CCCCC(C)OO(5133)',
    structure = SMILES('CCCCC(C)OO'),
    E0 = (-292.83,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
reaction(
    label = 'reaction4',
    reactants = ['C2H5O2(61)(60)', 'C5H11(67)(66)'],
    products = ['S(165)(164)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CH3(15)(16)', 'CCCCC[CH]OO(5130)'],
    products = ['S(165)(164)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['H(3)(3)', 'CCCCC[C](C)OO(3934)'],
    products = ['S(165)(164)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['C4H9(68)(67)', 'QOOH_3(3953)'],
    products = ['S(165)(164)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(3)(3)', 'CCCC[CH]C(C)OO(3935)'],
    products = ['S(165)(164)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['C3H7(69)(68)', 'S(209)(208)'],
    products = ['S(165)(164)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(8.73e+14,'cm^3/(mol*s)'), n=-0.699, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(200,'K'), Tmax=(2000,'K'), comment="""From training reaction 11 used for C_rad/H2/Cs;C_rad/H2/Cs
Exact match found for rate rule [C_rad/H2/Cs;C_rad/H2/Cs]
...
reaction(
    label = 'reaction10',
    reactants = ['C2H5(27)(28)', 'S(336)(335)'],
    products = ['S(165)(164)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(3)(3)', 'CCC[CH]CC(C)OO(3937)'],
    products = ['S(165)(164)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CH3(15)(16)', '[CH2]CCCC(C)OO(5131)'],
    products = ['S(165)(164)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(3)(3)', '[CH2]C(CCCCC)OO(3936)'],
    products = ['S(165)(164)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(3)(3)', '[CH2]CCCCC(C)OO(3938)'],
    products = ['S(165)(164)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CH2(S)(21)(22)', 'CCCCC(C)OO(5133)'],
    products = ['S(165)(164)'],
...
network(
    ...
    reactants = [
        ...
        ('HO2(8)(9)', 'C7H15(71)(70)'),
        ('H(3)(3)', 'S(74)(73)'),
        ('C2H5O2(61)(60)', 'C5H11(67)(66)'),
        ('C3H7(69)(68)', 'S(209)(208)'),
        ('C2H5(27)(28)', 'S(336)(335)'),
        ('H(3)(3)', 'S(142)(141)'),
        ('H(3)(3)', 'S(290)(289)'),
    ],
    bathGas = {
