...
species(
    label = 'OC1[CH]C2C[CH]C2C=1(2184)',
...
species(
    label = '[CH2]C1C=CC1C=[C]O(2198)',
    structure = SMILES('[CH2]C1C=CC1C=[C]O'),
    E0 = (420.451,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1685,370,2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,3000,3100,440,815,1455,1000,3010,987.5,1337.5,450,1655,300,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
...
species(
    label = '[CH]=C(O)CC1[CH]C=C1(2199)',
    structure = SMILES('[CH]=C(O)CC1[CH]C=C1'),
    E0 = (390.018,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,3120,650,792.5,1650,2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,350,440,435,1725,2750,2850,1437.5,1250,1305,750,350,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
...
species(
    label = '[CH2]C(O)=CC1[CH]C=C1(2200)',
    structure = SMILES('[CH2]C(O)=CC1[CH]C=C1'),
    E0 = (289.045,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,3000,3100,440,815,1455,1000,2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,350,440,435,1725,3010,987.5,1337.5,450,1655,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
...
species(
    label = 'OC12[CH]C3[CH]C1C3C2(2206)',
    ...
    molecularWeight = (108.138,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.73611,0.0400182,1.22488e-05,-3.13702e-08,1.08964e-11,55748.3,16.0157], Tmin=(100,'K'), Tmax=(1183.67,'K')), NASAPolynomial(coeffs=[9.59952,0.0385656,-1.7744e-05,3.4514e-09,-2.44888e-13,52127,-30.6802], Tmin=(1183.67,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(462.774,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(378.308,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + polycyclic(s3_4_5_ane) + polycyclic(s2_4_5_ane) + polycyclic(s2_4_4_ane) - ring(Cyclobutane) - ring(Cyclobutane) - ring(Cyclopentane) + radical(CCJCO) + radical(bicyclo[2.1.1]hexane-C5)"""),
)

species(
    label = 'OC12[CH]C3C([CH]C31)C2(2207)',
    ...
    molecularWeight = (108.138,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.73611,0.0400182,1.22488e-05,-3.13702e-08,1.08964e-11,55748.3,16.0157], Tmin=(100,'K'), Tmax=(1183.67,'K')), NASAPolynomial(coeffs=[9.59952,0.0385656,-1.7744e-05,3.4514e-09,-2.44888e-13,52127,-30.6802], Tmin=(1183.67,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(462.774,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(378.308,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + polycyclic(s3_4_5_ane) + polycyclic(s2_4_5_ane) + polycyclic(s2_4_4_ane) - ring(Cyclopentane) - ring(Cyclobutane) - ring(Cyclobutane) + radical(CCJCO) + radical(bicyclo[2.1.1]hexane-C5)"""),
)

species(
    label = 'O[C]1CC2[CH]C3C1C23(2208)',
    ...
    molecularWeight = (108.138,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.015,0.0464314,-1.20508e-05,-4.5471e-09,1.7828e-12,48610.6,15.7541], Tmin=(100,'K'), Tmax=(1697.09,'K')), NASAPolynomial(coeffs=[14.1493,0.0347145,-1.66174e-05,3.10885e-09,-2.08555e-13,42060.6,-56.3683], Tmin=(1697.09,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(403.599,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(378.308,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + polycyclic(s2_4_5_ane) + polycyclic(s2_3_5_ane) + polycyclic(s2_3_4_ane) - ring(Cyclopentane) - ring(Cyclopropane) - ring(Cyclobutane) + radical(bicyclo[3.1.1]heptane-C6) + radical(C2CsJOH)"""),
)

species(
    label = 'O[C]1CC2C3[CH]C2C13(2209)',
...
reaction(
    label = 'reaction669',
    reactants = ['OH(5)(5)', '[C]1=CC2C=CC2C1(1721)'],
...
reaction(
    label = 'reaction670',
    reactants = ['H(3)(3)', '[O]C1=CC2C=CC2C1(2172)'],
    products = ['C7H8O(583)(582)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction671',
    reactants = ['H(3)(3)', 'OC1=CC2C=C[C]2C1(2173)'],
    products = ['C7H8O(583)(582)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction672',
    reactants = ['H(3)(3)', 'OC1=C[C]2C=CC2C1(2174)'],
    products = ['C7H8O(583)(582)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction673',
    reactants = ['H(3)(3)', 'OC1[CH]C2C=CC2C=1(2175)'],
    products = ['C7H8O(583)(582)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction674',
    reactants = ['H(3)(3)', 'OC1=[C]C2C=CC2C1(2176)'],
    products = ['C7H8O(583)(582)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction675',
    reactants = ['H(3)(3)', 'OC1=CC2C=[C]C2C1(2177)'],
    products = ['C7H8O(583)(582)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(1e+13,'cm^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""From training reaction 40 used for Cd_rad/NonDe;H_rad
Exact match found for rate rule [Cd_rad/NonDe;H_rad]
...
reaction(
    label = 'reaction676',
    reactants = ['H(3)(3)', 'OC1=CC2[C]=CC2C1(2178)'],
    products = ['C7H8O(583)(582)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(1e+13,'cm^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""From training reaction 40 used for Cd_rad/NonDe;H_rad
Exact match found for rate rule [Cd_rad/NonDe;H_rad]
...
reaction(
    label = 'reaction677',
    reactants = ['[O]C1[CH]C2C=CC2C1(2179)'],
    products = ['C7H8O(583)(582)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction678',
    reactants = ['OC1=CC2[CH]C[C]2C1(2180)'],
    products = ['C7H8O(583)(582)'],
...
reaction(
    label = 'reaction11',
    reactants = ['O[C]1C[C]2C=CC2C1(2181)'],
    products = ['C7H8O(583)(582)'],
...
reaction(
    label = 'reaction680',
    reactants = ['OC1=C[C]2C[CH]C2C1(2182)'],
    products = ['C7H8O(583)(582)'],
...
reaction(
    label = 'reaction682',
    reactants = ['OC1=C[C]2[CH]CC2C1(2183)'],
    products = ['C7H8O(583)(582)'],
...
reaction(
    label = 'reaction15',
    reactants = ['OC1[CH]C2C[CH]C2C=1(2184)'],
    products = ['C7H8O(583)(582)'],
...
reaction(
    label = 'reaction684',
    reactants = ['OC1=CC2C[CH][C]2C1(2185)'],
    products = ['C7H8O(583)(582)'],
...
reaction(
    label = 'reaction685',
    reactants = ['OC1=[C]C2C[CH]C2C1(2186)'],
    products = ['C7H8O(583)(582)'],
...
reaction(
    label = 'reaction18',
    reactants = ['O[C]1CC2[C]=CC2C1(2187)'],
    products = ['C7H8O(583)(582)'],
...
reaction(
    label = 'reaction687',
    reactants = ['OC1[CH]C2C=C[C]2C1(2188)'],
    products = ['C7H8O(583)(582)'],
...
reaction(
    label = 'reaction688',
    reactants = ['OC1=[C]C2[CH]CC2C1(2189)'],
    products = ['C7H8O(583)(582)'],
...
reaction(
    label = 'reaction689',
    reactants = ['OC1[CH]C2[C]=CC2C1(2190)'],
    products = ['C7H8O(583)(582)'],
...
reaction(
    label = 'reaction690',
    reactants = ['O[C]1[CH]C2C=CC2C1(2191)'],
    products = ['C7H8O(583)(582)'],
...
reaction(
    label = 'reaction691',
    reactants = ['OC1[CH][C]2C=CC2C1(2192)'],
    products = ['C7H8O(583)(582)'],
...
reaction(
    label = 'reaction692',
    reactants = ['OC1[CH]C2C=[C]C2C1(2193)'],
    products = ['C7H8O(583)(582)'],
...
reaction(
    label = 'reaction693',
    reactants = ['[O]C1=CC2[CH]CC2C1(2194)'],
    products = ['C7H8O(583)(582)'],
...
reaction(
    label = 'reaction694',
    reactants = ['[O]C1=CC2C[CH]C2C1(2195)'],
    products = ['C7H8O(583)(582)'],
...
reaction(
    label = 'reaction695',
    reactants = ['[CH]=CC1[CH]C=C(O)C1(2196)'],
    products = ['C7H8O(583)(582)'],
...
reaction(
    label = 'reaction696',
    reactants = ['[CH]=CC1[CH]CC(O)=C1(2197)'],
    products = ['C7H8O(583)(582)'],
...
reaction(
    label = 'reaction698',
    reactants = ['[CH2]C1C=CC1C=[C]O(2198)'],
    products = ['C7H8O(583)(582)'],
...
reaction(
    label = 'reaction699',
    reactants = ['[CH]=C(O)CC1[CH]C=C1(2199)'],
    products = ['C7H8O(583)(582)'],
...
reaction(
    label = 'reaction700',
    reactants = ['[CH2]C(O)=CC1[CH]C=C1(2200)'],
    products = ['C7H8O(583)(582)'],
...
reaction(
    label = 'reaction702',
    reactants = ['OC1[C]C2C=CC2C1(2202)'],
    products = ['C7H8O(583)(582)'],
...
reaction(
    label = 'reaction703',
    reactants = ['OC1=CC2C[C]C2C1(2203)'],
    products = ['C7H8O(583)(582)'],
...
reaction(
    label = 'reaction704',
    reactants = ['OC1=CC2[C]CC2C1(2204)'],
    products = ['C7H8O(583)(582)'],
...
reaction(
    label = 'reaction707',
    reactants = ['OC12[CH]C3[CH]C1C3C2(2206)'],
    products = ['C7H8O(583)(582)'],
...
reaction(
    label = 'reaction708',
    reactants = ['OC12[CH]C3C([CH]C31)C2(2207)'],
    products = ['C7H8O(583)(582)'],
...
reaction(
    label = 'reaction709',
    reactants = ['O[C]1CC2[CH]C3C1C23(2208)'],
    products = ['C7H8O(583)(582)'],
...
reaction(
    label = 'reaction710',
    reactants = ['O[C]1CC2C3[CH]C2C13(2209)'],
    products = ['C7H8O(583)(582)'],
...
reaction(
    label = 'reaction706',
    reactants = ['C=C(O)C1C2C=CC21(2205)'],
    products = ['C7H8O(583)(582)'],
