species(
    label = '[CH2]CCC=C[CH]C(1602)',
    structure = SMILES('[CH2]CC[CH]C=CC'),
    E0 = (246.251,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,3025,407.5,1350,352.5,200,800,1600],'cm^-1')),
...
species(
    ...
    E0 = (204.471,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,2995,3005,3015,3025,975,983.333,991.667,1000,1300,1325,1350,1375,400,433.333,466.667,500,1630,1646.67,1663.33,1680,323.523,324.392],'cm^-1')),
        HinderedRotor(inertia=(0.167583,'amu*angstrom^2'), symmetry=1, barrier=(12.4558,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.164411,'amu*angstrom^2'), symmetry=1, barrier=(12.4478,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.166619,'amu*angstrom^2'), symmetry=1, barrier=(12.4527,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.166488,'amu*angstrom^2'), symmetry=1, barrier=(12.4523,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (95.1622,'amu'),
...
species(
    label = 'C=CCC=C[CH]C(1598)',
    structure = SMILES('C=CC[CH]C=CC'),
    E0 = (168.787,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2950,3100,1380,975,1025,1650,2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3010,3025,975,987.5,1000,1300,1337.5,1375,400,450,500,1630,1655,1680,3025,407.5,1350,352.5,180,752.647,755.606],'cm^-1')),
        HinderedRotor(inertia=(0.132122,'amu*angstrom^2'), symmetry=1, barrier=(3.03775,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.129357,'amu*angstrom^2'), symmetry=1, barrier=(2.97416,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.81735,'amu*angstrom^2'), symmetry=1, barrier=(18.7925,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.819315,'amu*angstrom^2'), symmetry=1, barrier=(18.8377,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (95.1622,'amu'),
...
species(
    label = '[CH2]CCC=C=CC(5935)',
    structure = SMILES('[CH2]CCC=C=CC'),
    E0 = (269.497,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([540,610,2055,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.516283,'amu*angstrom^2'), symmetry=1, barrier=(11.8704,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.183696,'amu*angstrom^2'), symmetry=1, barrier=(4.22354,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.516264,'amu*angstrom^2'), symmetry=1, barrier=(11.8699,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0201667,'amu*angstrom^2'), symmetry=1, barrier=(11.8706,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (95.1622,'amu'),
...
species(
    label = '[CH2]C[CH]CC=CC(5914)',
    structure = SMILES('[CH2]C[CH]CC=CC'),
    E0 = (299.597,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,3025,407.5,1350,352.5,214.772,807.593,1631.43],'cm^-1')),
        HinderedRotor(inertia=(0.132736,'amu*angstrom^2'), symmetry=1, barrier=(3.52369,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.132736,'amu*angstrom^2'), symmetry=1, barrier=(3.52369,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.132736,'amu*angstrom^2'), symmetry=1, barrier=(3.52369,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.132736,'amu*angstrom^2'), symmetry=1, barrier=(3.52369,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.132736,'amu*angstrom^2'), symmetry=1, barrier=(3.52369,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (96.1702,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.62686,0.0598346,-2.97711e-05,6.71861e-09,-5.9385e-13,36109.6,29.1914], Tmin=(100,'K'), Tmax=(2449.15,'K')), NASAPolynomial(coeffs=[17.5654,0.0338037,-1.38285e-05,2.37901e-09,-1.50884e-13,28302.3,-61.9801], Tmin=(2449.15,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(299.597,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(RCCJ) + radical(RCCJCC)"""),
)

species(
    label = 'C[CH]C[CH]C=CC(5936)',
...
species(
    label = '[CH2][CH]CCC=CC(5938)',
    structure = SMILES('[CH2][CH]CCC=CC'),
    E0 = (299.585,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    ...
    molecularWeight = (96.1702,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.48624,0.0666522,-2.92929e-05,-3.18687e-09,4.31068e-12,31001.8,31.0591], Tmin=(100,'K'), Tmax=(1124.49,'K')), NASAPolynomial(coeffs=[13.5588,0.0381822,-1.53686e-05,2.81793e-09,-1.9465e-13,26921.7,-38.6114], Tmin=(1124.49,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(256.638,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(RCCJ) + radical(Allyl_P)"""),
)

species(
    label = 'CC=[C][CH]CCC(5941)',
    structure = SMILES('CC=[C][CH]CCC'),
    E0 = (278.847,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,1685,370,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3010,987.5,1337.5,450,1655,3025,407.5,1350,352.5,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2]C[CH]C=CC(5915)',
    structure = SMILES('[CH2]C[CH]C=CC'),
    E0 = (270.031,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,3025,407.5,1350,352.5,180,4000],'cm^-1')),
        HinderedRotor(inertia=(0.275678,'amu*angstrom^2'), symmetry=1, barrier=(27.8885,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.21438,'amu*angstrom^2'), symmetry=1, barrier=(27.921,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.21426,'amu*angstrom^2'), symmetry=1, barrier=(27.9182,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.000929676,'amu*angstrom^2'), symmetry=1, barrier=(3.26119,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (82.1436,'amu'),
...
species(
    ...
    molecularWeight = (96.1702,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.766533,0.0600201,-1.40276e-05,-1.63936e-08,8.32493e-12,29879.4,29.3329], Tmin=(100,'K'), Tmax=(1097.84,'K')), NASAPolynomial(coeffs=[12.3066,0.0397758,-1.61561e-05,2.98808e-09,-2.07883e-13,26031.7,-33.4023], Tmin=(1097.84,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(247.386,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Allyl_S) + radical(RCCJ)"""),
)

species(
    label = '[CH2][CH]CC=CCC(5956)',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)(3)', '[CH2]CC=CC=CC(1234)'],
    products = ['[CH2]CCC=C[CH]C(1602)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)(3)', 'C=CCC=C[CH]C(1598)'],
    products = ['[CH2]CCC=C[CH]C(1602)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)(3)', '[CH2]CCC=C=CC(5935)'],
    products = ['[CH2]CCC=C[CH]C(1602)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction27',
    reactants = ['[CH2]C[CH2](1090)', '[CH]C=CC(5950)'],
    products = ['[CH2]CCC=C[CH]C(1602)'],
...
reaction(
    label = 'reaction28',
    reactants = ['CH2(17)(18)', '[CH2]C[CH]C=CC(5915)'],
    products = ['[CH2]CCC=C[CH]C(1602)'],
...
reaction(
    label = 'reaction40',
    reactants = ['CHCH3(T)(1022)', '[CH]=CCC[CH2](1232)'],
    products = ['[CH2]CCC=C[CH]C(1602)'],
