...
species(
    label = 'C=CCCC(C)OO(3954)',
    structure = SMILES('C=CCCC(C)OO'),
    E0 = (-165.048,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,3100,1380,975,1025,1650,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2]C[CH]CC(1025)',
    structure = SMILES('[CH2]C[CH]CC'),
    E0 = (231.62,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,3025,407.5,1350,352.5,1731.48,1732.59],'cm^-1')),
        HinderedRotor(inertia=(0.154985,'amu*angstrom^2'), symmetry=1, barrier=(3.5634,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.154854,'amu*angstrom^2'), symmetry=1, barrier=(3.56039,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.154108,'amu*angstrom^2'), symmetry=1, barrier=(3.54324,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.15479,'amu*angstrom^2'), symmetry=1, barrier=(3.55894,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
species(
    ...
    molecularWeight = (116.158,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.274077,0.0881541,-8.35151e-05,4.94228e-08,-1.30213e-11,12981.4,35.1315], Tmin=(100,'K'), Tmax=(881.625,'K')), NASAPolynomial(coeffs=[7.94393,0.0533562,-2.43112e-05,4.65507e-09,-3.26967e-13,11629,-0.904923], Tmin=(881.625,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(106.863,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJ) + radical(RCCJC)"""),
)
...
species(
    label = '[CH]CCC(C)OO(3969)',
    structure = SMILES('[CH]CCC(C)OO'),
    E0 = (179.165,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,1380,1390,370,380,2900,435,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
reaction(
    label = 'reaction27',
    reactants = ['H(3)(3)', 'CCC=CCC(C)OO(3951)'],
    products = ['S(142)(141)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction3',
    reactants = ['C4H8(80)(79)', 'QOOH_3(3953)'],
    products = ['S(142)(141)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction30',
    reactants = ['CH3(15)(16)', 'C=CCCC(C)OO(3954)'],
    products = ['S(142)(141)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction37',
    reactants = ['OH(5)(5)', 'CC[CH]CCC(C)[O](3955)'],
    products = ['S(142)(141)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction39',
    reactants = ['H(3)(3)', 'CC[CH]CCC(C)O[O](3945)'],
    products = ['S(142)(141)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction40',
    reactants = ['C2H5O2(61)(60)', '[CH2]C[CH]CC(1025)'],
    products = ['S(142)(141)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction41',
    reactants = ['CH3(15)(16)', 'CC[CH]CC[CH]OO(3956)'],
    products = ['S(142)(141)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction42',
    reactants = ['H(3)(3)', 'CC[CH]CC[C](C)OO(3957)'],
    products = ['S(142)(141)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2][CH]CC(1026)', 'QOOH_3(3953)'],
    products = ['S(142)(141)'],
...
reaction(
    label = 'reaction44',
    reactants = ['H(3)(3)', 'CC[CH]C[CH]C(C)OO(3958)'],
    products = ['S(142)(141)'],
...
reaction(
    label = 'reaction45',
    reactants = ['H(3)(3)', 'CC[CH][CH]CC(C)OO(3959)'],
    products = ['S(142)(141)'],
...
reaction(
    label = 'reaction46',
    reactants = ['CH3(15)(16)', '[CH2][CH]CCC(C)OO(3960)'],
    products = ['S(142)(141)'],
...
reaction(
    label = 'reaction48',
    reactants = ['H(3)(3)', '[CH2]C(CC[CH]CC)OO(3962)'],
    products = ['S(142)(141)'],
...
reaction(
    label = 'reaction49',
    reactants = ['H(3)(3)', '[CH2]C[CH]CCC(C)OO(3963)'],
    products = ['S(142)(141)'],
...
reaction(
    label = 'reaction53',
    reactants = ['[CH2]C(CC)CC(C)OO(3966)'],
    products = ['S(142)(141)'],
...
reaction(
    label = 'reaction56',
    reactants = ['S(209)(208)', '[CH]CC(1032)'],
    products = ['S(142)(141)'],
...
reaction(
    label = 'reaction57',
    reactants = ['C2H5(27)(28)', '[CH]CCC(C)OO(3969)'],
    products = ['S(142)(141)'],
...
reaction(
    label = 'reaction58',
    reactants = ['H(3)(3)', 'CC[C]CCC(C)OO(3970)'],
    products = ['S(142)(141)'],
...
reaction(
    label = 'reaction9',
    reactants = ['C5H11(67)(66)', 'C[CH]O[O](1429)'],
    products = ['S(74)(73)'],
...
reaction(
    label = 'reaction10',
    reactants = ['CH3(15)(16)', 'CCCCC[CH]O[O](3939)'],
    products = ['S(74)(73)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(3)(3)', 'CCCCC[C](C)O[O](3940)'],
    products = ['S(74)(73)'],
...
reaction(
    label = 'reaction12',
    reactants = ['C4H9(68)(67)', '[CH2]C(C)O[O](3941)'],
    products = ['S(74)(73)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(3)(3)', 'CCCC[CH]C(C)O[O](3942)'],
    products = ['S(74)(73)'],
...
reaction(
    label = 'reaction14',
    reactants = ['C3H7(69)(68)', '[CH2]CC(C)O[O](3943)'],
    products = ['S(74)(73)'],
...
reaction(
    label = 'reaction15',
    reactants = ['C2H5(27)(28)', '[CH2]CCC(C)O[O](3944)'],
    products = ['S(74)(73)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(3)(3)', 'CCC[CH]CC(C)O[O](3946)'],
    products = ['S(74)(73)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CH3(15)(16)', '[CH2]CCCC(C)O[O](3947)'],
    products = ['S(74)(73)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(3)(3)', '[CH2]C(CCCCC)O[O](3949)'],
    products = ['S(74)(73)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(3)(3)', '[CH2]CCCCC(C)O[O](3950)'],
    products = ['S(74)(73)'],
