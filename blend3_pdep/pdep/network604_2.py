...
species(
    ...
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.420723,0.0482443,4.91958e-05,-1.31134e-07,6.3739e-11,36257.4,24.1029], Tmin=(100,'K'), Tmax=(901.625,'K')), NASAPolynomial(coeffs=[32.0109,-0.0102577,1.06925e-05,-2.23025e-09,1.48783e-13,27242.3,-143.433], Tmin=(901.625,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(300.151,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsOsOs) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(dioxirane) + radical(C=CCJCO) + radical(CJCOOH)"""),
)

species(
    label = '[CH2]C1(C=CC[O])OO1(7407)',
...
species(
    label = '[CH2]C1(C=C[CH]O)OO1(7409)',
    structure = SMILES('[CH2]C1([CH]C=CO)OO1'),
    E0 = (91.3581,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,200,800,914.286,1028.57,1142.86,1257.14,1371.43,1485.71,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
reaction(
    label = 'reaction24',
    reactants = ['C=C1OO1(3711)', '[CH]=CCO(6223)'],
    products = ['S(243)(242)'],
...
reaction(
    label = 'reaction27',
    reactants = ['S(243)(242)'],
    products = ['CC1(C=C[CH]O)OO1(7404)'],
...
reaction(
    label = 'reaction29',
    reactants = ['OH(5)(5)', '[CH2]C=CC1([CH2])OO1(7406)'],
    products = ['S(243)(242)'],
...
reaction(
    label = 'reaction30',
    reactants = ['H(3)(3)', '[CH2]C1(C=CC[O])OO1(7407)'],
    products = ['S(243)(242)'],
...
reaction(
    label = 'reaction31',
    reactants = ['[CH2][C]1OO1(3713)', '[CH]=CCO(6223)'],
    products = ['S(243)(242)'],
...
reaction(
    label = 'reaction32',
    reactants = ['CH2OH(22)(23)', '[CH]=CC1([CH2])OO1(7408)'],
    products = ['S(243)(242)'],
...
reaction(
    label = 'reaction33',
    reactants = ['H(3)(3)', '[CH2]C1(C=C[CH]O)OO1(7409)'],
    products = ['S(243)(242)'],
...
reaction(
    label = 'reaction34',
    reactants = ['H(3)(3)', '[CH2]C1([C]=CCO)OO1(7410)'],
    products = ['S(243)(242)'],
...
reaction(
    label = 'reaction35',
    reactants = ['H(3)(3)', '[CH2]C1(C=[C]CO)OO1(7411)'],
    products = ['S(243)(242)'],
...
reaction(
    label = 'reaction36',
    reactants = ['S(243)(242)'],
    products = ['OCC1[CH]C2(C1)OO2(7412)'],
...
reaction(
    label = 'reaction39',
    reactants = ['CH2(17)(18)', 'OCC=C[C]1OO1(7414)'],
    products = ['S(243)(242)'],
...
reaction(
    label = 'reaction40',
    reactants = ['H(3)(3)', '[CH]C1(C=CCO)OO1(7415)'],
    products = ['S(243)(242)'],
