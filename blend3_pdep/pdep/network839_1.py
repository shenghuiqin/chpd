species(
    label = '[CH2]CO[CH]C(OO)C1CCCC1(9135)',
    structure = SMILES('[CH2]CO[CH]C(OO)C1CCCC1'),
    E0 = (-33.8256,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,2900,2950,3000,3050,3100,3150,900,925,950,975,1000,1025,1050,1075,1100,3025,407.5,1350,352.5,3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,2750,2850,1437.5,1250,1305,750,350,300,800,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
...
species(
    label = '[CH2]COC=C(OO)C1CCCC1(9137)',
...
species(
    label = 'C=CO[CH]C(OO)C1CCCC1(9138)',
    structure = SMILES('C=CO[CH]C(OO)C1CCCC1'),
    E0 = (-144.077,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2950,3100,1380,975,1025,1650,2750,2800,2850,2900,2950,3000,3050,3100,3150,900,925,950,975,1000,1025,1050,1075,1100,3010,987.5,1337.5,450,1655,3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,300,800,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2]COC=COO(9139)',
    structure = SMILES('[CH2]COC=COO'),
    E0 = (-58.2157,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,3000,3100,440,815,1455,1000,2750,2850,1437.5,1250,1305,750,350,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2]COC[C](OO)C1CCCC1(9140)',
    structure = SMILES('[CH2]COC[C](OO)C1CCCC1'),
    E0 = (-27.3825,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,360,370,350,2750,2800,2850,2900,2950,3000,3050,3100,3150,900,925,950,975,1000,1025,1050,1075,1100,3000,3100,440,815,1455,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,300,800,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (172.222,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.83021,0.12179,-8.79915e-05,3.28571e-08,-5.0726e-12,-3078.83,46.6642], Tmin=(100,'K'), Tmax=(1484.25,'K')), NASAPolynomial(coeffs=[21.2639,0.0595512,-2.50922e-05,4.60496e-09,-3.139e-13,-9934.25,-73.8713], Tmin=(1484.25,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-27.3825,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(652.686,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Cyclopentane) + radical(C2CsJOOH) + radical(CJCO)"""),
)

species(
    label = 'C[CH]O[CH]C(OO)C1CCCC1(9141)',
...
species(
    label = '[CH2][CH]OCC(OO)C1CCCC1(9142)',
...
species(
    label = '[CH2]COCC(OO)[C]1CCCC1(9143)',
...
species(
    label = '[CH2]COCC(OO)C1[CH]CCC1(9145)',
...
species(
    label = 'CCO[CH]C(OO)C1[CH]CCC1(9150)',
...
species(
    label = 'CCO[CH]C(OO)C1C[CH]CC1(9151)',
    ...
    molecularWeight = (172.222,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.99563,0.123105,-9.15605e-05,3.55859e-08,-5.69589e-12,-6937.59,48.3434], Tmin=(100,'K'), Tmax=(1448.18,'K')), NASAPolynomial(coeffs=[21.7837,0.0574249,-2.35297e-05,4.26814e-09,-2.8948e-13,-13824.9,-75.1836], Tmin=(1448.18,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-59.5335,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(652.686,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Cyclopentane) + radical(CCsJOCs) + radical(cyclopentane)"""),
)

species(
    label = '[O][CH]C(OO)C1CCCC1(9152)',
    structure = SMILES('[O][CH]C(OO)C1CCCC1'),
    E0 = (-3.06575,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,3025,407.5,1350,352.5,1380,1390,370,380,2900,435,2750,2800,2850,2900,2950,3000,3050,3100,3150,900,925,950,975,1000,1025,1050,1075,1100,300,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    ...
    molecularWeight = (172.222,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.35599,0.126427,-9.4387e-05,3.60827e-08,-5.60336e-12,-2599.7,48.4222], Tmin=(100,'K'), Tmax=(1506.2,'K')), NASAPolynomial(coeffs=[25.1229,0.053452,-2.17125e-05,3.91596e-09,-2.64332e-13,-10877.5,-95.403], Tmin=(1506.2,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-23.6071,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(652.686,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Cyclopentane) + radical(CJCO) + radical(CCsJOOH)"""),
)

species(
    label = 'OOC(C1CCCC1)C1CCO1(9136)',
...
species(
    label = '[CH]C(OO)C1CCCC1(9158)',
    structure = SMILES('[CH]C(OO)C1CCCC1'),
    E0 = (198.974,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,2750,2800,2850,2900,2950,3000,3050,3100,3150,900,925,950,975,1000,1025,1050,1075,1100,300,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2]O[CH]C(OO)C1CCCC1(9159)',
    structure = SMILES('[CH2]O[CH]C(OO)C1CCCC1'),
    E0 = (-20.0954,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,3025,407.5,1350,352.5,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,2750,2800,2850,2900,2950,3000,3050,3100,3150,900,925,950,975,1000,1025,1050,1075,1100,300,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.57447,0.10489,-5.31414e-05,-7.7182e-09,1.08919e-11,-2200.76,44.1225], Tmin=(100,'K'), Tmax=(1019.54,'K')), NASAPolynomial(coeffs=[22.9803,0.0444107,-1.69147e-05,3.0888e-09,-2.1655e-13,-9071.26,-83.9544], Tmin=(1019.54,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-20.0954,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(582.013,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-OsHHH) + ring(Cyclopentane) + radical(CsJOCC) + radical(CCsJOCs)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]CO[CH]C(OO)C1CCCC1(9135)'],
    products = ['C2H4(19)(20)', 'S(443)(442)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)(3)', '[CH2]COC=C(OO)C1CCCC1(9137)'],
    products = ['[CH2]CO[CH]C(OO)C1CCCC1(9135)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)(3)', 'C=CO[CH]C(OO)C1CCCC1(9138)'],
    products = ['[CH2]CO[CH]C(OO)C1CCCC1(9135)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['S(443)(442)', 'C2H4(T)(890)'],
    products = ['[CH2]CO[CH]C(OO)C1CCCC1(9135)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[CH]1CCCC1(3779)', '[CH2]COC=COO(9139)'],
    products = ['[CH2]CO[CH]C(OO)C1CCCC1(9135)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['HO2(8)(9)', '[CH2]COC=CC1CCCC1(8462)'],
    products = ['[CH2]CO[CH]C(OO)C1CCCC1(9135)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2]COC[C](OO)C1CCCC1(9140)'],
    products = ['[CH2]CO[CH]C(OO)C1CCCC1(9135)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]CO[CH]C(OO)C1CCCC1(9135)'],
    products = ['C[CH]O[CH]C(OO)C1CCCC1(9141)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2][CH]OCC(OO)C1CCCC1(9142)'],
    products = ['[CH2]CO[CH]C(OO)C1CCCC1(9135)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]COCC(OO)[C]1CCCC1(9143)'],
    products = ['[CH2]CO[CH]C(OO)C1CCCC1(9135)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]COCC(O[O])C1CCCC1(9144)'],
    products = ['[CH2]CO[CH]C(OO)C1CCCC1(9135)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]COCC(OO)C1[CH]CCC1(9145)'],
    products = ['[CH2]CO[CH]C(OO)C1CCCC1(9135)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2]CO[CH]C(OO)C1CCCC1(9135)'],
    products = ['CCO[CH][C](OO)C1CCCC1(9146)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]CO[CH]C(OO)C1CCCC1(9135)'],
    products = ['[CH2]COCC(OO)C1C[CH]CC1(9147)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]CO[CH]C(OO)C1CCCC1(9135)'],
    products = ['CCO[CH]C(OO)[C]1CCCC1(9148)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]CO[CH]C(OO)C1CCCC1(9135)'],
    products = ['CCO[CH]C(O[O])C1CCCC1(9149)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]CO[CH]C(OO)C1CCCC1(9135)'],
    products = ['CCO[CH]C(OO)C1[CH]CCC1(9150)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2]CO[CH]C(OO)C1CCCC1(9135)'],
    products = ['CCO[CH]C(OO)C1C[CH]CC1(9151)'],
...
reaction(
    label = 'reaction19',
    reactants = ['C2H4(T)(890)', '[O][CH]C(OO)C1CCCC1(9152)'],
    products = ['[CH2]CO[CH]C(OO)C1CCCC1(9135)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2]CO[CH]C(OO)C1CCCC1(9135)'],
    products = ['C=COCC(OO)C1CCCC1(9153)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH2]CO[CH]C(OO)C1CCCC1(9135)'],
    products = ['CCOC=C(OO)C1CCCC1(9154)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH2]CO[CH]C(OO)C1CCCC1(9135)'],
    products = ['OH(5)(5)', '[CH2]COC1OC1C1CCCC1(9155)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH2]COC([CH]OO)C1CCCC1(9156)'],
    products = ['[CH2]CO[CH]C(OO)C1CCCC1(9135)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[CH2]CO[CH]C(OO)C1CCCC1(9135)'],
    products = ['OOC(C1CCCC1)C1CCO1(9136)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[CH2]CO[CH]C(OO)C1CCCC1(9135)'],
    products = ['[CH2]COC(O)C([O])C1CCCC1(9157)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[CH2]C[O](1432)', '[CH]C(OO)C1CCCC1(9158)'],
    products = ['[CH2]CO[CH]C(OO)C1CCCC1(9135)'],
...
reaction(
    label = 'reaction27',
    reactants = ['CH2(17)(18)', '[CH2]O[CH]C(OO)C1CCCC1(9159)'],
    products = ['[CH2]CO[CH]C(OO)C1CCCC1(9135)'],
...
network(
    label = '839',
    isomers = [
        '[CH2]CO[CH]C(OO)C1CCCC1(9135)',
    ],
    reactants = [
        ('C2H4(19)(20)', 'S(443)(442)'),
    ],
    bathGas = {
        'Ne': 0.333333,
        'N2': 0.333333,
