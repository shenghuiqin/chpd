...
species(
    label = '[O]C[CH]CC=O(8413)',
    structure = SMILES('[O]C[CH]CC=O'),
    E0 = (38.6763,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3025,407.5,1350,352.5,2782.5,750,1395,475,1775,1000,330.318,1564.44,1564.44],'cm^-1')),
        HinderedRotor(inertia=(0.0963203,'amu*angstrom^2'), symmetry=1, barrier=(7.45768,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0963205,'amu*angstrom^2'), symmetry=1, barrier=(7.45768,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00429398,'amu*angstrom^2'), symmetry=1, barrier=(7.45768,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
...
species(
    label = 'O=C[CH]C[CH]O(8415)',
    structure = SMILES('[O]C=CC[CH]O'),
    E0 = (-63.3814,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,3025,407.5,1350,352.5,2995,3025,975,1000,1300,1375,400,500,1630,1680,2750,2850,1437.5,1250,1305,750,350,333.354,333.429,333.459],'cm^-1')),
        HinderedRotor(inertia=(0.20063,'amu*angstrom^2'), symmetry=1, barrier=(15.8108,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.200514,'amu*angstrom^2'), symmetry=1, barrier=(15.8101,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.200572,'amu*angstrom^2'), symmetry=1, barrier=(15.811,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.663181,0.0617871,-6.12455e-05,3.00646e-08,-5.64515e-12,-7493.01,25.5823], Tmin=(100,'K'), Tmax=(1420.24,'K')), NASAPolynomial(coeffs=[17.0255,0.0111208,-2.89325e-06,4.01628e-10,-2.37254e-14,-11678.4,-57.4692], Tmin=(1420.24,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-63.3814,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(C=COJ) + radical(CCsJOH)"""),
)

species(
    label = '[O]CCC[C]=O(8416)',
...
species(
    label = 'O=[C]CC[CH]O(8417)',
    structure = SMILES('O=[C]CC[CH]O'),
    E0 = (-46.6724,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1855,455,950,3025,407.5,1350,352.5,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.205671,'amu*angstrom^2'), symmetry=1, barrier=(4.72877,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.205655,'amu*angstrom^2'), symmetry=1, barrier=(4.72842,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.205695,'amu*angstrom^2'), symmetry=1, barrier=(4.72934,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.205632,'amu*angstrom^2'), symmetry=1, barrier=(4.72789,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.13723,0.0696786,-0.000109335,9.50827e-08,-3.21784e-11,-5516.73,24.9827], Tmin=(100,'K'), Tmax=(866.82,'K')), NASAPolynomial(coeffs=[7.34062,0.0273505,-1.23768e-05,2.27656e-09,-1.52674e-13,-6077.4,-1.08907], Tmin=(866.82,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-46.6724,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cds-OdCsH) + radical(CCCJ=O) + radical(CCsJOH)"""),
)

species(
    label = '[CH]1CC[CH]OO1(8418)',
...
species(
    ...
    E0 = (-301.931,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2782.5,750,1395,475,1775,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,2750,2850,1437.5,1250,1305,750,350,180],'cm^-1')),
        HinderedRotor(inertia=(0.969996,'amu*angstrom^2'), symmetry=1, barrier=(22.3021,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.969643,'amu*angstrom^2'), symmetry=1, barrier=(22.294,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.970028,'amu*angstrom^2'), symmetry=1, barrier=(22.3028,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
...
reaction(
    label = 'reaction1',
    reactants = ['CH2CHO(38)(39)', 'CH2CHO(38)(39)'],
    products = ['S(207)(206)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)(3)', 'O=C[CH]CC=O(8412)'],
    products = ['S(207)(206)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction11',
    reactants = ['CO(10)(11)', 'C3H6O(201)(200)'],
    products = ['S(207)(206)'],
...
network(
    ...
    reactants = [
        ('CH2CHO(38)(39)', 'CH2CHO(38)(39)'),
        ('HCO(14)(15)', 'S(337)(336)'),
        ('H(3)(3)', 'S(338)(337)'),
        ('CO(10)(11)', 'C3H6O(201)(200)'),
    ],
    bathGas = {
        'Ne': 0.333333,
        'N2': 0.333333,
