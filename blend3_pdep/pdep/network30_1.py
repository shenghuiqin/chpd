...
reaction(
    label = 'reaction3',
    reactants = ['CH2O(13)(14)'],
    products = ['H(3)(3)', 'HCO(14)(15)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(8e+15,'s^-1'), n=0, Ea=(87726,'cal/mol'), T0=(1,'K'), comment="""Kinetics taken from the arrheniusHigh attribute of a Troe/Lindemann exprssion. Originally from reaction library Klippenstein_Glarborg2016"""),
)
...
reaction(
    ...
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(3.7e+13,'s^-1'), n=0, Ea=(71969,'cal/mol'), T0=(1,'K'), comment="""Kinetics taken from the arrheniusHigh attribute of a Troe/Lindemann exprssion. Originally from reaction library Klippenstein_Glarborg2016"""),
)
