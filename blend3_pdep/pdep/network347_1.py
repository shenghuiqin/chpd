...
species(
    label = 'CCCC[CH][O](5432)',
    structure = SMILES('CCCC[CH][O]'),
    E0 = (78.0912,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,230.45,230.451,230.454,2080.78],'cm^-1')),
        HinderedRotor(inertia=(0.00317444,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00317421,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.180373,'amu*angstrom^2'), symmetry=1, barrier=(6.79815,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.180382,'amu*angstrom^2'), symmetry=1, barrier=(6.79822,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.1323,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.20771,0.0668891,-7.57574e-05,6.29972e-08,-2.32109e-11,9487.51,24.9864], Tmin=(100,'K'), Tmax=(767.597,'K')), NASAPolynomial(coeffs=[4.00998,0.0455649,-2.09522e-05,3.99077e-09,-2.77681e-13,9255.32,13.4981], Tmin=(767.597,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(78.0912,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCsJOH) + radical(CCOJ)"""),
)

species(
    label = 'CCCC[C]([O])CC(5433)',
...
reaction(
    label = 'reaction1',
    reactants = ['H(3)(3)', 'CCCCC(=O)CC(5429)'],
    products = ['S(200)(199)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['C4H9(68)(67)', 'C3H6O(201)(200)'],
    products = ['S(200)(199)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['C2H5(27)(28)', 'CCCCC=O(5430)'],
    products = ['S(200)(199)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(7.94e+10,'cm^3/(mol*s)'), n=0, Ea=(28.0328,'kJ/mol'), T0=(1,'K'), Tmin=(333,'K'), Tmax=(363,'K'), comment="""Estimated using template [CO_O;CsJ-CsHH] for rate rule [CO-CsH_O;CsJ-CsHH]
Euclidian distance = 2.0
...
reaction(
    label = 'reaction4',
    reactants = ['C4H9(68)(67)', 'CC[CH][O](5431)'],
    products = ['S(200)(199)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['C2H5(27)(28)', 'CCCC[CH][O](5432)'],
    products = ['S(200)(199)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['H(3)(3)', 'CCCC[C]([O])CC(5433)'],
    products = ['S(200)(199)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['C3H7(69)(68)', '[CH2]C([O])CC(5434)'],
    products = ['S(200)(199)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(3)(3)', 'CCC[CH]C([O])CC(5435)'],
    products = ['S(200)(199)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['C2H5(27)(28)', '[CH2]CC([O])CC(5436)'],
    products = ['S(200)(199)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(8.73e+14,'cm^3/(mol*s)'), n=-0.699, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(200,'K'), Tmax=(2000,'K'), comment="""From training reaction 11 used for C_rad/H2/Cs;C_rad/H2/Cs
Exact match found for rate rule [C_rad/H2/Cs;C_rad/H2/Cs]
...
reaction(
    label = 'reaction10',
    reactants = ['H(3)(3)', 'CC[CH]CC([O])CC(5437)'],
    products = ['S(200)(199)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CH3(15)(16)', '[CH2]C([O])CCCC(5438)'],
    products = ['S(200)(199)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(3)(3)', 'C[CH]C([O])CCCC(5439)'],
    products = ['S(200)(199)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CH3(15)(16)', '[CH2]CCC([O])CC(5440)'],
    products = ['S(200)(199)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(3)(3)', 'C[CH]CCC([O])CC(4022)'],
    products = ['S(200)(199)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(3)(3)', '[CH2]CC([O])CCCC(4003)'],
    products = ['S(200)(199)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(3)(3)', '[CH2]CCCC([O])CC(5441)'],
    products = ['S(200)(199)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CH2(S)(21)(22)', 'CCCC([O])CC(5442)'],
    products = ['S(200)(199)'],
