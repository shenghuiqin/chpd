species(
    ...
    E0 = (127.654,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,2750,2800,2850,1350,1500,750,1050,1375,1000,2950,3100,1380,975,1025,1650,1380,1390,370,380,2900,435,492.5,1135,1000,197.544,199.213],'cm^-1')),
        HinderedRotor(inertia=(4.24799,'amu*angstrom^2'), symmetry=1, barrier=(119.627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.469457,'amu*angstrom^2'), symmetry=1, barrier=(13.0285,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(4.26841,'amu*angstrom^2'), symmetry=1, barrier=(119.627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(4.32964,'amu*angstrom^2'), symmetry=1, barrier=(119.627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
species(
    label = 'C=C=CC(C)O[O](4815)',
    structure = SMILES('C=C=CC(C)O[O]'),
    E0 = (174.76,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([540,610,2055,3010,987.5,1337.5,450,1655,2750,2800,2850,1350,1500,750,1050,1375,1000,2950,3100,1380,975,1025,1650,1380,1390,370,380,2900,435,492.5,1135,1000,180],'cm^-1')),
        HinderedRotor(inertia=(0.683152,'amu*angstrom^2'), symmetry=1, barrier=(15.707,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.683179,'amu*angstrom^2'), symmetry=1, barrier=(15.7076,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.682177,'amu*angstrom^2'), symmetry=1, barrier=(15.6846,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (99.1079,'amu'),
...
species(
    label = 'C=CC[C](C)O[O](4816)',
    structure = SMILES('C=CC[C](C)O[O]'),
    E0 = (197.636,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,3100,1380,975,1025,1650,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,360,370,350,2750,2850,1437.5,1250,1305,750,350,492.5,1135,1000,180,180],'cm^-1')),
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.23499,0.0655217,-6.71057e-05,4.4744e-08,-1.32925e-11,23865.5,26.4354], Tmin=(100,'K'), Tmax=(790.732,'K')), NASAPolynomial(coeffs=[6.33576,0.0397179,-1.81548e-05,3.4719e-09,-2.43291e-13,23058.9,3.02498], Tmin=(790.732,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(197.636,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(C2CsJOOH) + radical(ROOJ)"""),
)

species(
    label = 'C=[C]CC(C)O[O](4817)',
    structure = SMILES('C=[C]CC(C)O[O]'),
    E0 = (248.579,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,1685,370,2950,3100,1380,975,1025,1650,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,492.5,1135,1000,327.918,327.944],'cm^-1')),
        HinderedRotor(inertia=(0.124131,'amu*angstrom^2'), symmetry=1, barrier=(9.46863,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.124142,'amu*angstrom^2'), symmetry=1, barrier=(9.46949,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.124146,'amu*angstrom^2'), symmetry=1, barrier=(9.46895,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.124074,'amu*angstrom^2'), symmetry=1, barrier=(9.46906,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (100.116,'amu'),
...
species(
    label = 'C=C[CH][C](C)OO(4818)',
    structure = SMILES('C=C[CH][C](C)OO'),
    E0 = (162.548,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([360,370,350,3025,407.5,1350,352.5,2950,3100,1380,975,1025,1650,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,3615,1310,387.5,850,1000,285.279,1009.08],'cm^-1')),
        HinderedRotor(inertia=(0.701464,'amu*angstrom^2'), symmetry=1, barrier=(40.5111,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.375667,'amu*angstrom^2'), symmetry=1, barrier=(21.6956,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.849207,'amu*angstrom^2'), symmetry=1, barrier=(49.0441,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.201085,'amu*angstrom^2'), symmetry=1, barrier=(11.6131,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.849218,'amu*angstrom^2'), symmetry=1, barrier=(49.044,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (100.116,'amu'),
...
species(
    label = '[CH2]C(CC=C)O[O](4819)',
    structure = SMILES('[CH2]C(CC=C)O[O]'),
    E0 = (224.7,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,492.5,1135,1000,2750,2850,1437.5,1250,1305,750,350,180,827.83],'cm^-1')),
        HinderedRotor(inertia=(0.222855,'amu*angstrom^2'), symmetry=1, barrier=(5.12387,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.515644,'amu*angstrom^2'), symmetry=1, barrier=(11.8557,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0396735,'amu*angstrom^2'), symmetry=1, barrier=(11.8556,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.515484,'amu*angstrom^2'), symmetry=1, barrier=(11.852,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.96154,0.0667496,-5.96032e-05,2.91324e-08,-5.91314e-12,27134.6,29.1048], Tmin=(100,'K'), Tmax=(1161.88,'K')), NASAPolynomial(coeffs=[11.4292,0.0307119,-1.30771e-05,2.43591e-09,-1.68765e-13,24702.2,-22.9658], Tmin=(1161.88,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(224.7,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(ROOJ) + radical(CJCOOH)"""),
)

species(
    label = '[CH]=CCC(C)O[O](4820)',
...
species(
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.303791,0.0763382,-6.95816e-05,3.22402e-08,-5.98028e-12,22942.2,27.9063], Tmin=(100,'K'), Tmax=(1291.81,'K')), NASAPolynomial(coeffs=[16.5528,0.0260241,-1.11584e-05,2.08945e-09,-1.45277e-13,18744.1,-54.646], Tmin=(1291.81,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(189.612,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(C=CCJCO) + radical(CJCOOH)"""),
)

species(
    label = 'C=[C][CH]C(C)OO(4822)',
    structure = SMILES('C=[C][CH]C(C)OO'),
    E0 = (213.491,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2950,3100,1380,975,1025,1650,1685,370,2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,296.148,296.17],'cm^-1')),
        HinderedRotor(inertia=(0.350093,'amu*angstrom^2'), symmetry=1, barrier=(21.8024,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.01689,'amu*angstrom^2'), symmetry=1, barrier=(63.2324,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.604325,'amu*angstrom^2'), symmetry=1, barrier=(37.6245,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.349935,'amu*angstrom^2'), symmetry=1, barrier=(21.8021,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.350233,'amu*angstrom^2'), symmetry=1, barrier=(21.8018,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (100.116,'amu'),
...
species(
    label = 'C=CC(C)[CH]O[O](4830)',
    structure = SMILES('C=CC(C)[CH]O[O]'),
    E0 = (203.991,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,2750,2800,2850,1350,1500,750,1050,1375,1000,2950,3100,1380,975,1025,1650,1380,1390,370,380,2900,435,492.5,1135,1000,180,2412.38],'cm^-1')),
        HinderedRotor(inertia=(0.0796159,'amu*angstrom^2'), symmetry=1, barrier=(12.5519,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.206331,'amu*angstrom^2'), symmetry=1, barrier=(12.5522,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.545935,'amu*angstrom^2'), symmetry=1, barrier=(12.5521,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(3.17541,'amu*angstrom^2'), symmetry=1, barrier=(73.0089,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.16786,0.0646332,-5.70414e-05,2.90015e-08,-6.32661e-12,24634.4,26.6231], Tmin=(100,'K'), Tmax=(1066.48,'K')), NASAPolynomial(coeffs=[9.095,0.0349016,-1.52246e-05,2.86172e-09,-1.99109e-13,22943.6,-12.1311], Tmin=(1066.48,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(203.991,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CCsJOOH) + radical(ROOJ)"""),
)

species(
    label = 'C=CC1OOC1C(4831)',
...
species(
    label = '[CH2]C=[C]C(C)OO(4836)',
    structure = SMILES('[CH2]C=[C]C(C)OO'),
    E0 = (235.492,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,1685,370,3010,987.5,1337.5,450,1655,3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,1063.96],'cm^-1')),
        HinderedRotor(inertia=(0.652029,'amu*angstrom^2'), symmetry=1, barrier=(26.7386,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.346471,'amu*angstrom^2'), symmetry=1, barrier=(14.2062,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.22469,'amu*angstrom^2'), symmetry=1, barrier=(9.21226,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.652189,'amu*angstrom^2'), symmetry=1, barrier=(26.7384,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.651893,'amu*angstrom^2'), symmetry=1, barrier=(26.7397,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.640155,0.0688787,-5.74166e-05,2.43772e-08,-4.17959e-12,28448.1,28.7303], Tmin=(100,'K'), Tmax=(1380.06,'K')), NASAPolynomial(coeffs=[15.2728,0.0264674,-1.13197e-05,2.10928e-09,-1.45753e-13,24409.3,-46.5773], Tmin=(1380.06,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(235.492,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Cds_S) + radical(Allyl_P)"""),
)

species(
    label = 'CC=C[C](C)O[O](4837)',
...
reaction(
    label = 'reaction2',
    reactants = ['S(210)(209)'],
    products = ['[CH2]C1[CH]C(C)OO1(4813)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)(3)', 'C=CC=C(C)O[O](4814)'],
    products = ['S(210)(209)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)(3)', 'C=C=CC(C)O[O](4815)'],
    products = ['S(210)(209)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CH3(15)(16)', 'C=CC=CO[O](2629)'],
    products = ['S(210)(209)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction14',
    reactants = ['O2(2)(2)', '[CH2]C=C[CH]C(1593)'],
    products = ['S(210)(209)'],
...
reaction(
    label = 'reaction20',
    reactants = ['CH2(S)(21)(22)', 'C=C[CH]CO[O](4828)'],
    products = ['S(210)(209)'],
...
reaction(
    label = 'reaction25',
    reactants = ['O(4)(4)', 'C=C[CH]C(C)[O](4832)'],
    products = ['S(210)(209)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[CH]=C[CH2](891)', 'C[CH]O[O](1429)'],
    products = ['S(210)(209)'],
...
reaction(
    label = 'reaction34',
    reactants = ['S(210)(209)'],
    products = ['HO2(8)(9)', 'C=C[C]=CC(1447)'],
...
reaction(
    label = 'reaction36',
    reactants = ['CH2(17)(18)', '[CH]=CC(C)O[O](4840)'],
    products = ['S(210)(209)'],
