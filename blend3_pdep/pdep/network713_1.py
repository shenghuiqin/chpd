...
species(
    ...
    E0 = (-98.9365,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,3615,1277.5,1000],'cm^-1')),
...
reaction(
    label = 'reaction5',
    reactants = ['HCO(14)(15)', '[CH2]O[O](1428)'],
    products = ['C2H3O3(88)(87)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['H(3)(3)', '[O]O[CH]C=O(4102)'],
    products = ['C2H3O3(88)(87)'],
    transitionState = 'TS6',
