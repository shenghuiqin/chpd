...
species(
    label = '[CH2]CC1CC1[CH]C1CC1(5735)',
    structure = SMILES('[CH2]CC1CC1[CH]C1CC1'),
    E0 = (434.651,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (122.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.375472,0.0545916,5.81412e-05,-1.10965e-07,4.51435e-11,52429.4,35.7532], Tmin=(100,'K'), Tmax=(980.113,'K')), NASAPolynomial(coeffs=[18.7733,0.0409774,-1.50994e-05,2.84268e-09,-2.07966e-13,45870.6,-67.698], Tmin=(980.113,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(434.651,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(540.441,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cyclopropane) + ring(Cyclopropane) + radical(RCCJ) + radical(Cs_S)"""),
)
...
species(
    label = '[CH2]CC(=C)C=CC1CC1(5737)',
    structure = SMILES('[CH2]CC(=C)C=CC1CC1'),
    E0 = (311.105,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,2950,3050,3150,900,950,1000,1050,1100,2995,3025,975,1000,1300,1375,400,500,1630,1680,350,440,435,1725,2950,3100,1380,975,1025,1650,3000,3100,440,815,1455,1000,2750,2850,1437.5,1250,1305,750,350,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2]C(C=C)C=CC1CC1(5738)',
    structure = SMILES('[CH2]C(C=C)C=CC1CC1'),
    E0 = (332.436,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,2750,2850,2950,3050,3150,900,950,1000,1050,1100,2995,3010,3025,975,987.5,1000,1300,1337.5,1375,400,450,500,1630,1655,1680,1380,1390,370,380,2900,435,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (121.2,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0584619,0.0732665,-8.68116e-06,-3.87481e-08,1.96715e-11,40143,35.0297], Tmin=(100,'K'), Tmax=(989.85,'K')), NASAPolynomial(coeffs=[16.938,0.0410161,-1.50189e-05,2.7041e-09,-1.89079e-13,34993.4,-55.8109], Tmin=(989.85,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(332.436,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(515.497,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)(Cds-Cds)CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Cyclopropane) + radical(Isobutyl)"""),
)
...
species(
    label = '[CH2]C[C](C)C=CC1CC1(5739)',
    structure = SMILES('[CH2]C[C](C)C=CC1CC1'),
    E0 = (337.346,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2995,3025,975,1000,1300,1375,400,500,1630,1680,2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350,2750,2850,2950,3050,3150,900,950,1000,1050,1100,3000,3100,440,815,1455,1000,2750,2850,1437.5,1250,1305,750,350,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (122.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.185716,0.0629621,3.04624e-05,-8.03937e-08,3.41681e-11,40729.3,34.3235], Tmin=(100,'K'), Tmax=(983.179,'K')), NASAPolynomial(coeffs=[17.368,0.0432044,-1.5902e-05,2.92267e-09,-2.0868e-13,34926.9,-60.6057], Tmin=(983.179,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(337.346,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(536.283,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cyclopropane) + radical(Allyl_T) + radical(RCCJ)"""),
)

species(
    label = '[CH2]C([CH]C)C=CC1CC1(5740)',
    structure = SMILES('[CH2]C([CH]C)C=CC1CC1'),
    E0 = (399.743,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (122.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0730722,0.0681676,1.12979e-05,-5.88797e-08,2.63197e-11,48235.5,39.0259], Tmin=(100,'K'), Tmax=(990.8,'K')), NASAPolynomial(coeffs=[16.6172,0.043878,-1.62731e-05,2.96569e-09,-2.09226e-13,42871,-51.1644], Tmin=(990.8,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(399.743,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(536.283,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cyclopropane) + radical(Isobutyl) + radical(Cs_S)"""),
)

species(
    label = '[CH2][CH]C(C)C=CC1CC1(5741)',
    ...
    molecularWeight = (122.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.084981,0.067276,1.32656e-05,-5.92057e-08,2.5609e-11,48255.2,38.9897], Tmin=(100,'K'), Tmax=(1013.06,'K')), NASAPolynomial(coeffs=[16.7873,0.0446834,-1.74765e-05,3.26885e-09,-2.33056e-13,42646.3,-52.7867], Tmin=(1013.06,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(399.907,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(536.283,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cyclopropane) + radical(RCCJ) + radical(Cs_S)"""),
)

species(
    label = '[CH2]CC(C)[C]=CC1CC1(5742)',
    structure = SMILES('[CH2]CC(C)[C]=CC1CC1'),
    E0 = (443.207,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,2750,2850,2950,3050,3150,900,950,1000,1050,1100,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (122.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.140975,0.0731353,-3.50749e-07,-4.77183e-08,2.23128e-11,53470.3,37.7172], Tmin=(100,'K'), Tmax=(1007.57,'K')), NASAPolynomial(coeffs=[17.5634,0.0434677,-1.66526e-05,3.07768e-09,-2.18063e-13,47840.9,-58.0608], Tmin=(1007.57,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(443.207,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(536.283,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cyclopropane) + radical(RCCJ) + radical(Cds_S)"""),
)

species(
    label = '[CH2][C](C=CC1CC1)CC(5743)',
...
species(
    label = '[CH2]C([C]=CC1CC1)CC(5744)',
    structure = SMILES('[CH2]C([C]=CC1CC1)CC'),
    E0 = (443.043,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,2750,2850,2950,3050,3150,900,950,1000,1050,1100,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (122.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.148672,0.0739723,-2.10322e-06,-4.77091e-08,2.31763e-11,53450.5,37.7386], Tmin=(100,'K'), Tmax=(983.282,'K')), NASAPolynomial(coeffs=[17.3974,0.0426569,-1.54468e-05,2.77409e-09,-1.94206e-13,48063.2,-56.4635], Tmin=(983.282,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(443.043,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(536.283,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cyclopropane) + radical(Cds_S) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]CC(C)C=[C]C1CC1(5745)',
...
species(
    label = '[CH2]C(C=[C]C1CC1)CC(5746)',
    structure = SMILES('[CH2]C(C=[C]C1CC1)CC'),
    E0 = (443.043,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,2750,2850,2950,3050,3150,900,950,1000,1050,1100,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (122.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.148672,0.0739723,-2.10322e-06,-4.77091e-08,2.31763e-11,53450.5,37.7386], Tmin=(100,'K'), Tmax=(983.282,'K')), NASAPolynomial(coeffs=[17.3974,0.0426569,-1.54468e-05,2.77409e-09,-1.94206e-13,48063.2,-56.4635], Tmin=(983.282,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(443.043,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(536.283,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cyclopropane) + radical(Isobutyl) + radical(Cds_S)"""),
)

species(
    label = '[CH2]CC(C)C=C[C]1CC1(5747)',
    ...
    molecularWeight = (122.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.185716,0.0629621,3.04624e-05,-8.03937e-08,3.41681e-11,40729.3,34.3235], Tmin=(100,'K'), Tmax=(983.179,'K')), NASAPolynomial(coeffs=[17.368,0.0432044,-1.5902e-05,2.92267e-09,-2.0868e-13,34926.9,-60.6057], Tmin=(983.179,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(337.346,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(536.283,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cyclopropane) + radical(RCCJ) + radical(Allyl_T)"""),
)

species(
    label = '[CH2]CC(C)C=CC1[CH]C1(5748)',
    structure = SMILES('[CH2]CC(C)C=CC1[CH]C1'),
    E0 = (431.278,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,300,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (122.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0544516,0.0691316,6.23564e-06,-5.08494e-08,2.24713e-11,52028.2,38.8905], Tmin=(100,'K'), Tmax=(1019.42,'K')), NASAPolynomial(coeffs=[16.2359,0.0455676,-1.78437e-05,3.31919e-09,-2.35157e-13,46654.3,-49.6632], Tmin=(1019.42,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(431.278,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(536.283,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cyclopropane) + radical(RCCJ) + radical(cyclopropane)"""),
)

species(
    label = '[CH2]C(C=C[C]1CC1)CC(5749)',
    structure = SMILES('[CH2]C(C=C[C]1CC1)CC'),
    E0 = (337.182,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (122.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.174885,0.0638227,2.8699e-05,-8.04909e-08,3.51378e-11,40709.6,34.3569], Tmin=(100,'K'), Tmax=(964.256,'K')), NASAPolynomial(coeffs=[17.2842,0.0422595,-1.46211e-05,2.60171e-09,-1.83404e-13,35113,-59.4742], Tmin=(964.256,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(337.182,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(536.283,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cyclopropane) + radical(Isobutyl) + radical(Allyl_T)"""),
)

species(
    label = '[CH2]C(C=CC1[CH]C1)CC(5750)',
    structure = SMILES('[CH2]C(C=CC1[CH]C1)CC'),
    E0 = (431.114,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (122.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0442993,0.0700054,4.31455e-06,-5.05579e-08,2.3184e-11,52008.5,38.9202], Tmin=(100,'K'), Tmax=(994.851,'K')), NASAPolynomial(coeffs=[16.0413,0.0448023,-1.66626e-05,3.02122e-09,-2.1175e-13,46889.8,-47.902], Tmin=(994.851,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(431.114,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(536.283,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cyclopropane) + radical(cyclopropane) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]CC1[CH]C(C1)C1CC1(5751)',
    structure = SMILES('[CH2]CC1[CH]C(C1)C1CC1'),
    E0 = (423.528,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (122.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.644132,0.0472897,7.78727e-05,-1.29037e-07,5.08616e-11,51083.2,34.5943], Tmin=(100,'K'), Tmax=(980.141,'K')), NASAPolynomial(coeffs=[17.7304,0.0430922,-1.5994e-05,3.02414e-09,-2.2174e-13,44586,-63.5522], Tmin=(980.141,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(423.528,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(544.598,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cyclopropane) + ring(Cyclobutane) + radical(RCCJ) + radical(cyclobutane)"""),
)
...
species(
    label = 'C=C(C=CC1CC1)CC(5754)',
    structure = SMILES('C=C(C=CC1CC1)CC'),
    E0 = (105.858,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (122.207,'amu'),
...
species(
    ...
    molecularWeight = (122.207,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0871396,0.0716848,3.56696e-06,-5.10753e-08,2.32764e-11,15480.2,33.3524], Tmin=(100,'K'), Tmax=(1009.29,'K')), NASAPolynomial(coeffs=[17.3194,0.0441062,-1.69849e-05,3.14841e-09,-2.23393e-13,9857.53,-61.233], Tmin=(1009.29,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(127.353,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(540.441,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)(Cds-Cds)CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Cyclopropane)"""),
)
...
species(
    label = '[CH2]C([CH2])C=CC1CC1(5758)',
    structure = SMILES('[CH2]C([CH2])C=CC1CC1'),
    E0 = (434.064,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,2950,3050,3150,900,950,1000,1050,1100,1380,1390,370,380,2900,435,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,2995,3025,975,1000,1300,1375,400,500,1630,1680,300,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.655872,0.0549864,2.8686e-05,-7.88704e-08,3.55287e-11,52343.2,33.2218], Tmin=(100,'K'), Tmax=(937.725,'K')), NASAPolynomial(coeffs=[16.9571,0.0322247,-9.72342e-06,1.62847e-09,-1.13626e-13,47229.6,-55.339], Tmin=(937.725,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(434.064,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(465.61,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cyclopropane) + radical(Isobutyl) + radical(Isobutyl)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]CC([CH2])C=CC1CC1(5525)'],
    products = ['[CH2]CC1CC1[CH]C1CC1(5735)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)(3)', '[CH2]CC(=C)C=CC1CC1(5737)'],
    products = ['[CH2]CC([CH2])C=CC1CC1(5525)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)(3)', '[CH2]C(C=C)C=CC1CC1(5738)'],
    products = ['[CH2]CC([CH2])C=CC1CC1(5525)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['C4H7(330)(329)', '[CH]=CC1CC1(946)'],
    products = ['[CH2]CC([CH2])C=CC1CC1(5525)'],
    transitionState = 'TS7',
...
reaction(
    ...
    products = ['[CH2]CC([CH2])C=CC1CC1(5525)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(0.00310016,'m^3/(mol*s)'), n=2.49247, Ea=(22.3269,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [Cds-HH_Cds-HH;CJ]
Euclidian distance = 0
Multiplied by reaction path degeneracy 2.0
family: R_Addition_MultipleBond
Ea raised from 21.5 to 22.3 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction9',
    reactants = ['[CH2]C[C](C)C=CC1CC1(5739)'],
    products = ['[CH2]CC([CH2])C=CC1CC1(5525)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]CC([CH2])C=CC1CC1(5525)'],
    products = ['[CH2]C([CH]C)C=CC1CC1(5740)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]CC([CH2])C=CC1CC1(5525)'],
    products = ['[CH2][CH]C(C)C=CC1CC1(5741)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]CC(C)[C]=CC1CC1(5742)'],
    products = ['[CH2]CC([CH2])C=CC1CC1(5525)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2]CC([CH2])C=CC1CC1(5525)'],
    products = ['[CH2][C](C=CC1CC1)CC(5743)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]C([C]=CC1CC1)CC(5744)'],
    products = ['[CH2]CC([CH2])C=CC1CC1(5525)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]CC(C)C=[C]C1CC1(5745)'],
    products = ['[CH2]CC([CH2])C=CC1CC1(5525)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]C(C=[C]C1CC1)CC(5746)'],
    products = ['[CH2]CC([CH2])C=CC1CC1(5525)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]CC([CH2])C=CC1CC1(5525)'],
    products = ['[CH2]CC(C)C=C[C]1CC1(5747)'],
    transitionState = 'TS17',
    kinetics = Arrhenius(A=(1.99186e+09,'s^-1'), n=0.575, Ea=(72.1112,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R5H;Y_rad_out;Cs_H_out_Cs2] for rate rule [R5H_SSMS;C_rad_out_2H;Cs_H_out_Cs2_cy3]
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2]CC(C)C=CC1[CH]C1(5748)'],
    products = ['[CH2]CC([CH2])C=CC1CC1(5525)'],
    transitionState = 'TS18',
    kinetics = Arrhenius(A=(138.3,'s^-1'), n=3.21, Ea=(60.7935,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R6H;C_rad_out_H/NonDeC;Cs_H_out] for rate rule [R6H_RSMSR;C_rad_out_H/NonDeC;Cs_H_out_2H]
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2]CC([CH2])C=CC1CC1(5525)'],
    products = ['[CH2]C(C=C[C]1CC1)CC(5749)'],
    transitionState = 'TS19',
    kinetics = Arrhenius(A=(1.00971e+09,'s^-1'), n=0.07625, Ea=(70.4978,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R6H;Y_rad_out;Cs_H_out_Cs2] for rate rule [R6H_RSSMS;C_rad_out_2H;Cs_H_out_Cs2_cy3]
Euclidian distance = 2.44948974278
family: intra_H_migration"""),
)
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2]CC([CH2])C=CC1CC1(5525)'],
    products = ['[CH2]C(C=CC1[CH]C1)CC(5750)'],
    transitionState = 'TS20',
    kinetics = Arrhenius(A=(2124,'s^-1'), n=1.81, Ea=(55.2288,'kJ/mol'), T0=(1,'K'), comment="""From training reaction 116 used for R7H;C_rad_out_2H;Cs_H_out_H/NonDeC
...
reaction(
    label = 'reaction22',
    reactants = ['[CH2]CC([CH2])C=CC1CC1(5525)'],
    products = ['[CH2]CC1[CH]C(C1)C1CC1(5751)'],
...
reaction(
    label = 'reaction24',
    reactants = ['CH2(S)(21)(22)', '[CH2]CC([CH2])C=CC=C(5753)'],
    products = ['[CH2]CC([CH2])C=CC1CC1(5525)'],
...
reaction(
    label = 'reaction28',
    reactants = ['[CH2]CC([CH2])C=CC1CC1(5525)'],
    products = ['[CH2]C[CH]CC=CC1CC1(5756)'],
...
reaction(
    label = 'reaction31',
    reactants = ['CH2(17)(18)', '[CH2]C([CH2])C=CC1CC1(5758)'],
    products = ['[CH2]CC([CH2])C=CC1CC1(5525)'],
