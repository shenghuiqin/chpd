...
species(
    ...
    molecularWeight = (108.138,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.23735,0.0359138,6.58417e-05,-1.19324e-07,5.05069e-11,30491.4,26.4865], Tmin=(100,'K'), Tmax=(942.914,'K')), NASAPolynomial(coeffs=[20.528,0.016929,-3.93865e-06,7.02853e-10,-5.87255e-14,24059.6,-80.2612], Tmin=(942.914,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(252.504,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(374.151,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + ring(Cyclopentene) + radical(cyclopentene-allyl) + radical(C=CJO)"""),
)
...
species(
    ...
    molecularWeight = (108.138,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.45829,0.0673191,-4.04506e-05,2.36933e-09,4.40347e-12,42107.7,28.2554], Tmin=(100,'K'), Tmax=(1029.09,'K')), NASAPolynomial(coeffs=[16.2977,0.0260827,-9.97781e-06,1.82542e-09,-1.27994e-13,37771.2,-53.845], Tmin=(1029.09,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(348.967,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(369.994,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-CsOsHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + ring(Cyclopentadiene) + radical(1,3-cyclopentadiene-vinyl-2) + radical(CCsJOH)"""),
)
...
species(
    ...
    molecularWeight = (108.138,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.65996,0.0352517,4.20014e-05,-7.55203e-08,3.02238e-11,34429.3,28.1063], Tmin=(100,'K'), Tmax=(979.591,'K')), NASAPolynomial(coeffs=[12.6304,0.0302061,-1.114e-05,2.0692e-09,-1.49354e-13,30372.8,-34.3281], Tmin=(979.591,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(285.441,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(374.151,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(4-Methylenecyclopentene) + radical(C=CCJC=C) + radical(cyclopentene-vinyl)"""),
)
...
species(
    ...
    molecularWeight = (108.138,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.857244,0.0441606,5.06218e-05,-1.10031e-07,4.89701e-11,27854.2,25.2566], Tmin=(100,'K'), Tmax=(934.461,'K')), NASAPolynomial(coeffs=[22.9251,0.0132959,-1.92175e-06,2.86639e-10,-2.85426e-14,20953.1,-94.5698], Tmin=(934.461,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(230.461,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(374.151,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsOsH) + ring(Cyclopentene) + radical(C=CJO) + radical(cyclopentene-allyl)"""),
)

species(
    label = 'O[C]=CC1=CC[CH]C1(2484)',
...
species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.985342,'amu*angstrom^2'), symmetry=1, barrier=(22.655,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.98495,'amu*angstrom^2'), symmetry=1, barrier=(22.6459,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.991519,'amu*angstrom^2'), symmetry=1, barrier=(22.797,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.987384,'amu*angstrom^2'), symmetry=1, barrier=(22.7019,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (108.138,'amu'),
...
species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.27038,'amu*angstrom^2'), symmetry=1, barrier=(29.2085,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.26917,'amu*angstrom^2'), symmetry=1, barrier=(29.1807,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.26949,'amu*angstrom^2'), symmetry=1, barrier=(29.188,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.26855,'amu*angstrom^2'), symmetry=1, barrier=(29.1665,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (108.138,'amu'),
...
species(
    label = 'OC1[CH]C2=CC1[CH]C2(2498)',
...
reaction(
    label = 'reaction1026',
    reactants = ['OH(5)(5)', '[CH]=CC1=CC=CC1(2459)'],
...
reaction(
    label = 'reaction1029',
    reactants = ['CHCHOH(49)(49)', '[C]1=CC=CC1(2461)'],
    products = ['C7H8O(615)(614)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction1030',
    reactants = ['H(3)(3)', 'OC=CC1=CC=[C]C1(2462)'],
    products = ['C7H8O(615)(614)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction1031',
    reactants = ['H(3)(3)', 'OC=CC1=[C]C=CC1(2463)'],
    products = ['C7H8O(615)(614)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction1032',
    reactants = ['H(3)(3)', 'OC=[C]C1=CC=CC1(2464)'],
    products = ['C7H8O(615)(614)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(6.117e+14,'cm^3/(mol*s)'), n=-0.152, Ea=(4.19655,'kJ/mol'), T0=(1,'K'), comment="""From training reaction 49 used for Cd_rad/Cd;H_rad
Exact match found for rate rule [Cd_rad/Cd;H_rad]
...
reaction(
    label = 'reaction1033',
    reactants = ['H(3)(3)', 'OC=CC1=C[C]=CC1(2465)'],
    products = ['C7H8O(615)(614)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(6.117e+14,'cm^3/(mol*s)'), n=-0.152, Ea=(4.19655,'kJ/mol'), T0=(1,'K'), comment="""From training reaction 49 used for Cd_rad/Cd;H_rad
Exact match found for rate rule [Cd_rad/Cd;H_rad]
...
reaction(
    label = 'reaction1034',
    reactants = ['H(3)(3)', 'O[C]=CC1=CC=CC1(2466)'],
    products = ['C7H8O(615)(614)'],
...
reaction(
    label = 'reaction1036',
    reactants = ['OC=CC1[CH]C=C[CH]1(1907)'],
    products = ['C7H8O(615)(614)'],
...
reaction(
    label = 'reaction1038',
    reactants = ['OC=CC1=[C]C[CH]C1(2469)'],
    products = ['C7H8O(615)(614)'],
...
reaction(
    label = 'reaction1039',
    reactants = ['OC=[C]C1[CH]C=CC1(1904)'],
    products = ['C7H8O(615)(614)'],
...
reaction(
    label = 'reaction1041',
    reactants = ['OC=CC1[CH]C=[C]C1(1908)'],
    products = ['C7H8O(615)(614)'],
...
reaction(
    label = 'reaction1043',
    reactants = ['O[CH]CC1=[C]C=CC1(2472)'],
    products = ['C7H8O(615)(614)'],
...
reaction(
    label = 'reaction1044',
    reactants = ['O[C]=CC1[CH]C=CC1(1902)'],
    products = ['C7H8O(615)(614)'],
...
reaction(
    label = 'reaction1045',
    reactants = ['OC[CH]C1[CH]C=CC=1(2473)'],
    products = ['C7H8O(615)(614)'],
...
reaction(
    label = 'reaction1047',
    reactants = ['O[C]=C[C]1CC=CC1(2475)'],
    products = ['C7H8O(615)(614)'],
...
reaction(
    label = 'reaction1048',
    reactants = ['O[CH]CC1=CC=[C]C1(2476)'],
    products = ['C7H8O(615)(614)'],
...
reaction(
    label = 'reaction1049',
    reactants = ['OC=CC1=[C][CH]CC1(2477)'],
    products = ['C7H8O(615)(614)'],
...
reaction(
    label = 'reaction1050',
    reactants = ['OC=[C]C1=C[CH]CC1(2478)'],
    products = ['C7H8O(615)(614)'],
...
reaction(
    label = 'reaction1051',
    reactants = ['OC=[C]C1=CC[CH]C1(2479)'],
    products = ['C7H8O(615)(614)'],
...
reaction(
    label = 'reaction1052',
    reactants = ['OC=CC1[CH][C]=CC1(1909)'],
    products = ['C7H8O(615)(614)'],
...
reaction(
    label = 'reaction1054',
    reactants = ['O[CH]CC1=C[C]=CC1(2480)'],
    products = ['C7H8O(615)(614)'],
...
reaction(
    label = 'reaction1055',
    reactants = ['OC[CH]C1=CC=[C]C1(2481)'],
    products = ['C7H8O(615)(614)'],
...
reaction(
    label = 'reaction1057',
    reactants = ['[O]C=C[C]1CC=CC1(1900)'],
    products = ['C7H8O(615)(614)'],
...
reaction(
    label = 'reaction1058',
    reactants = ['O[C]=CC1=C[CH]CC1(2483)'],
    products = ['C7H8O(615)(614)'],
...
reaction(
    label = 'reaction1059',
    reactants = ['O[C]=CC1=CC[CH]C1(2484)'],
    products = ['C7H8O(615)(614)'],
...
reaction(
    label = 'reaction1066',
    reactants = ['[CH]=CC=C([CH2])C=CO(2488)'],
    products = ['C7H8O(615)(614)'],
...
reaction(
    label = 'reaction1067',
    reactants = ['[CH2]C=CC=[C]C=CO(2489)'],
    products = ['C7H8O(615)(614)'],
...
reaction(
    label = 'reaction1073',
    reactants = ['[OH+]=[C-]CC1=CC=CC1(2494)'],
    products = ['C7H8O(615)(614)'],
...
reaction(
    label = 'reaction1077',
    reactants = ['OC1[CH]C2=CC1[CH]C2(2498)'],
    products = ['C7H8O(615)(614)'],
