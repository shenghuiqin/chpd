...
species(
    label = 'OO[C]1C[CH]CCCC1(3504)',
    structure = SMILES('OO[C]1C[CH]CCCC1'),
    E0 = (119.883,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,2750,2790,2830,2870,2910,2950,2990,3030,3070,3110,3150,900,920,940,960,980,1000,1020,1040,1060,1080,1100,300,800,800,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (128.169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.225374,0.0380069,0.000142959,-2.40072e-07,1.0316e-10,14596.4,34.9038], Tmin=(100,'K'), Tmax=(916.549,'K')), NASAPolynomial(coeffs=[34.671,0.00462617,6.19759e-06,-1.38449e-09,8.29199e-14,3370.07,-155.072], Tmin=(916.549,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(119.883,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(498.868,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + ring(Cycloheptane) + radical(cycloheptane) + radical(C2CsJOOH)"""),
)

species(
    label = 'OOC1[CH]C[CH]CCC1(3505)',
    structure = SMILES('OOC1[CH]C[CH]CCC1'),
    E0 = (133.399,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,2750,2790,2830,2870,2910,2950,2990,3030,3070,3110,3150,900,920,940,960,980,1000,1020,1040,1060,1080,1100,300,800,800,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'OOC1[CH]CCC[CH]C1(3506)',
    structure = SMILES('OOC1[CH]CCC[CH]C1'),
    E0 = (133.399,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,2750,2790,2830,2870,2910,2950,2990,3030,3070,3110,3150,900,920,940,960,980,1000,1020,1040,1060,1080,1100,300,800,800,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'OOC1[CH]CC[CH]CC1(3507)',
    structure = SMILES('OOC1[CH]CC[CH]CC1'),
    E0 = (133.399,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,2750,2790,2830,2870,2910,2950,2990,3030,3070,3110,3150,900,920,940,960,980,1000,1020,1040,1060,1080,1100,300,800,800,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'OOC1[CH]CCCC[CH]1(1645)',
    structure = SMILES('OOC1[CH]CCCC[CH]1'),
    E0 = (164.385,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,2750,2790,2830,2870,2910,2950,2990,3030,3070,3110,3150,900,920,940,960,980,1000,1020,1040,1060,1080,1100,300,800,800,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (128.169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0324326,0.0390191,0.000154287,-2.62774e-07,1.1409e-10,19962.5,37.1054], Tmin=(100,'K'), Tmax=(912.909,'K')), NASAPolynomial(coeffs=[39.1673,-0.00310303,1.04938e-05,-2.21806e-09,1.39438e-13,7403.44,-178.025], Tmin=(912.909,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(164.385,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(498.868,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + ring(Cycloheptane) + radical(CCJCOOH) + radical(CCJCOOH)"""),
)

species(
    label = 'OOC1C[CH]C[CH]CC1(3508)',
    structure = SMILES('OOC1C[CH]C[CH]CC1'),
    E0 = (102.413,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,2750,2790,2830,2870,2910,2950,2990,3030,3070,3110,3150,900,920,940,960,980,1000,1020,1040,1060,1080,1100,300,800,800,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (128.169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.258759,0.0360174,0.000149878,-2.485e-07,1.06457e-10,12495.2,36.144], Tmin=(100,'K'), Tmax=(916.667,'K')), NASAPolynomial(coeffs=[35.3216,0.00319512,6.93074e-06,-1.51551e-09,9.1113e-14,1017.83,-157.504], Tmin=(916.667,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(102.413,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(498.868,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + ring(Cycloheptane) + radical(cycloheptane) + radical(cycloheptane)"""),
)

species(
    label = '[O]OC1C[CH]CCCC1(1606)',
    structure = SMILES('[O]OC1C[CH]CCCC1'),
    E0 = (84.9887,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2750,2786.36,2822.73,2859.09,2895.45,2931.82,2968.18,3004.55,3040.91,3077.27,3113.64,3150,900,918.182,936.364,954.545,972.727,990.909,1009.09,1027.27,1045.45,1063.64,1081.82,1100,300,800,800,800,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (128.169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.370175,0.0316799,0.000164083,-2.66589e-07,1.14229e-10,10397.5,34.1565], Tmin=(100,'K'), Tmax=(911.269,'K')), NASAPolynomial(coeffs=[36.2205,-3.89704e-07,9.347e-06,-2.0354e-09,1.28654e-13,-1354.86,-164.102], Tmin=(911.269,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(84.9887,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + ring(Cycloheptane) + radical(cycloheptane) + radical(ROOJ)"""),
)

species(
    label = 'OOC1C[CH]CC[CH]C1(3509)',
    structure = SMILES('OOC1C[CH]CC[CH]C1'),
    E0 = (102.413,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,2750,2790,2830,2870,2910,2950,2990,3030,3070,3110,3150,900,920,940,960,980,1000,1020,1040,1060,1080,1100,300,800,800,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[O]OC1[CH]CCCCC1(1607)',
    structure = SMILES('[O]OC1[CH]CCCCC1'),
    E0 = (115.975,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2750,2786.36,2822.73,2859.09,2895.45,2931.82,2968.18,3004.55,3040.91,3077.27,3113.64,3150,900,918.182,936.364,954.545,972.727,990.909,1009.09,1027.27,1045.45,1063.64,1081.82,1100,300,800,800,800,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (128.169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.22477,0.0331775,0.000166304,-2.73757e-07,1.18065e-10,14131.1,34.6366], Tmin=(100,'K'), Tmax=(909.602,'K')), NASAPolynomial(coeffs=[38.146,-0.00315381,1.1131e-05,-2.38725e-09,1.52863e-13,1836.82,-174.378], Tmin=(909.602,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(115.975,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + ring(Cycloheptane) + radical(ROOJ) + radical(CCJCOOH)"""),
)

species(
    label = 'OOC1C[CH][CH]CCC1(3510)',
    structure = SMILES('OOC1C[CH][CH]CCC1'),
    E0 = (102.413,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,2750,2790,2830,2870,2910,2950,2990,3030,3070,3110,3150,900,920,940,960,980,1000,1020,1040,1060,1080,1100,300,800,800,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'OO[C]1[CH]CCCCC1(3511)',
    structure = SMILES('OO[C]1[CH]CCCCC1'),
    E0 = (150.869,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,2750,2790,2830,2870,2910,2950,2990,3030,3070,3110,3150,900,920,940,960,980,1000,1020,1040,1060,1080,1100,300,800,800,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (128.169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0801829,0.0395028,0.000145181,-2.47233e-07,1.06986e-10,18330.1,35.383], Tmin=(100,'K'), Tmax=(914.531,'K')), NASAPolynomial(coeffs=[36.5921,0.00148012,7.97734e-06,-1.73535e-09,1.07047e-13,6563.6,-165.323], Tmin=(914.531,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(150.869,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(498.868,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + ring(Cycloheptane) + radical(C2CsJOOH) + radical(CCJCOOH)"""),
)

species(
    label = '[CH]=CC(CCC[CH2])OO(3512)',
    structure = SMILES('[CH]=CC(CCC[CH2])OO'),
    E0 = (263.178,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3010,987.5,1337.5,450,1655,3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3000,3100,440,815,1455,1000,3120,650,792.5,1650,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (128.169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.510944,0.0981926,-8.41341e-05,3.79684e-08,-7.06678e-12,31816.1,39.2218], Tmin=(100,'K'), Tmax=(1259.18,'K')), NASAPolynomial(coeffs=[16.6106,0.0438028,-1.93419e-05,3.6643e-09,-2.55958e-13,27504.3,-47.3256], Tmin=(1259.18,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(263.178,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(478.082,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(RCCJ) + radical(Cds_P)"""),
)

species(
    label = '[CH2]C=CC(CC[CH2])OO(3513)',
    structure = SMILES('[CH2]CCC([CH]C=C)OO'),
    E0 = (133.335,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2950,3100,1380,975,1025,1650,3010,987.5,1337.5,450,1655,3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3100,440,815,1455,1000,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (128.169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.713722,0.101939,-8.78924e-05,3.96967e-08,-7.3677e-12,16207.5,35.8369], Tmin=(100,'K'), Tmax=(1265.85,'K')), NASAPolynomial(coeffs=[17.5426,0.0442509,-1.95355e-05,3.69686e-09,-2.58037e-13,11585.4,-56.5437], Tmin=(1265.85,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(133.335,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(478.082,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(RCCJ) + radical(C=CCJCO)"""),
)

species(
    label = '[CH]=CCCCC[CH]OO(3514)',
    structure = SMILES('[CH]=CCCCC[CH]OO'),
    E0 = (259.494,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,3120,650,792.5,1650,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (128.169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.376501,0.102763,-0.000102754,5.97414e-08,-1.4859e-11,31362,36.5608], Tmin=(100,'K'), Tmax=(946.423,'K')), NASAPolynomial(coeffs=[11.2735,0.0535225,-2.471e-05,4.76428e-09,-3.36099e-13,29156.9,-19.0018], Tmin=(946.423,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(259.494,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(478.082,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CCsJOOH) + radical(Cds_P)"""),
)

species(
    label = '[CH2]CCCC=C[CH]OO(3515)',
    structure = SMILES('[CH2]CCCC=C[CH]OO'),
    E0 = (140.803,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,3025,407.5,1350,352.5,2995,3025,975,1000,1300,1375,400,500,1630,1680,3000,3100,440,815,1455,1000,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (128.169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.802492,0.0924866,-6.85344e-05,2.54541e-08,-3.79496e-12,17118.4,40.5371], Tmin=(100,'K'), Tmax=(1579.3,'K')), NASAPolynomial(coeffs=[21.7309,0.0354139,-1.43267e-05,2.57116e-09,-1.7259e-13,10001.1,-78.4704], Tmin=(1579.3,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(140.803,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(478.082,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(C=CCJO) + radical(RCCJ)"""),
)

species(
    label = '[CH2]CC=CC(C[CH2])OO(3516)',
    structure = SMILES('[CH2]CC=CC(C[CH2])OO'),
    E0 = (210.218,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,1380,1390,370,380,2900,435,2995,3025,975,1000,1300,1375,400,500,1630,1680,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (128.169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.445376,0.0937431,-7.45076e-05,3.06099e-08,-5.15948e-12,25446.4,40.5993], Tmin=(100,'K'), Tmax=(1382.3,'K')), NASAPolynomial(coeffs=[17.5402,0.0416974,-1.803e-05,3.3713e-09,-2.33125e-13,20474.1,-51.9935], Tmin=(1382.3,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(210.218,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(478.082,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(RCCJ) + radical(RCCJ)"""),
)

species(
    label = '[CH2]CCC=CC([CH2])OO(3517)',
    structure = SMILES('[CH2]CCC=CC([CH2])OO'),
    E0 = (218.934,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,1380,1390,370,380,2900,435,2995,3025,975,1000,1300,1375,400,500,1630,1680,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (128.169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.605068,0.0963917,-7.9513e-05,3.39343e-08,-5.9064e-12,26501.3,41.3822], Tmin=(100,'K'), Tmax=(1350.81,'K')), NASAPolynomial(coeffs=[18.3173,0.0403591,-1.7292e-05,3.22646e-09,-2.23182e-13,21389.1,-55.5975], Tmin=(1350.81,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(218.934,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(478.082,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(CJCOOH) + radical(RCCJ)"""),
)

species(
    label = 'OOC1[C]CCCCC1(3518)',
    structure = SMILES('OOC1[C]CCCCC1'),
    E0 = (192.219,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,2750,2790,2830,2870,2910,2950,2990,3030,3070,3110,3150,900,920,940,960,980,1000,1020,1040,1060,1080,1100,300,800,800,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
    ...
    molecularWeight = (128.169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.183042,0.0433508,0.000146299,-2.54134e-07,1.10695e-10,23314.6,42.3341], Tmin=(100,'K'), Tmax=(913.777,'K')), NASAPolynomial(coeffs=[38.6575,0.000202563,8.86031e-06,-1.91471e-09,1.1917e-13,10919.4,-170.531], Tmin=(913.777,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(192.219,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(498.868,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(CsJ2_singlet-CsH) + ring(Cycloheptane)"""),
)

species(
    label = 'OOC1C[C]CCCC1(3519)',
    structure = SMILES('OOC1C[C]CCCC1'),
    E0 = (192.219,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,2750,2790,2830,2870,2910,2950,2990,3030,3070,3110,3150,900,920,940,960,980,1000,1020,1040,1060,1080,1100,300,800,800,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
...
reaction(
    label = 'reaction1',
    reactants = ['HO2(8)(9)', 'C7H11(427)(426)'],
    products = ['S(433)(432)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)(3)', 'OOC1C=CCC[CH]C1(1377)'],
    products = ['S(433)(432)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)(3)', 'OOC1[CH]CCCC=C1(1375)'],
    products = ['S(433)(432)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(2e+13,'cm^3/(mol*s)','*|/',3.16), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), comment="""From training reaction 59 used for H_rad;C_rad/H/NonDeC
Exact match found for rate rule [C_rad/H/NonDeC;H_rad]
...
reaction(
    label = 'reaction7',
    reactants = ['H(3)(3)', 'OOC1C=CC[CH]CC1(1379)'],
    products = ['S(433)(432)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(2e+13,'cm^3/(mol*s)','*|/',3.16), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), comment="""From training reaction 59 used for H_rad;C_rad/H/NonDeC
Exact match found for rate rule [C_rad/H/NonDeC;H_rad]
...
reaction(
    label = 'reaction8',
    reactants = ['H(3)(3)', 'OOC1C=C[CH]CCC1(1380)'],
    products = ['S(433)(432)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(3)(3)', 'OOC1[C]=CCCCC1(1376)'],
    products = ['S(433)(432)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(3)(3)', 'OOC1C=[C]CCCC1(1378)'],
    products = ['S(433)(432)'],
...
reaction(
    label = 'reaction11',
    reactants = ['OO[C]1C[CH]CCCC1(3504)'],
    products = ['S(433)(432)'],
...
reaction(
    label = 'reaction12',
    reactants = ['OOC1[CH]C[CH]CCC1(3505)'],
    products = ['S(433)(432)'],
...
reaction(
    label = 'reaction13',
    reactants = ['OOC1[CH]CCC[CH]C1(3506)'],
    products = ['S(433)(432)'],
...
reaction(
    label = 'reaction14',
    reactants = ['OOC1[CH]CC[CH]CC1(3507)'],
    products = ['S(433)(432)'],
...
reaction(
    label = 'reaction15',
    reactants = ['OOC1[CH]CCCC[CH]1(1645)'],
    products = ['S(433)(432)'],
...
reaction(
    label = 'reaction16',
    reactants = ['OOC1C[CH]C[CH]CC1(3508)'],
    products = ['S(433)(432)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[O]OC1C[CH]CCCC1(1606)'],
    products = ['S(433)(432)'],
...
reaction(
    label = 'reaction18',
    reactants = ['OOC1C[CH]CC[CH]C1(3509)'],
    products = ['S(433)(432)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[O]OC1[CH]CCCCC1(1607)'],
    products = ['S(433)(432)'],
...
reaction(
    label = 'reaction20',
    reactants = ['OOC1C[CH][CH]CCC1(3510)'],
    products = ['S(433)(432)'],
...
reaction(
    label = 'reaction21',
    reactants = ['OO[C]1[CH]CCCCC1(3511)'],
    products = ['S(433)(432)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH]=CC(CCC[CH2])OO(3512)'],
    products = ['S(433)(432)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH2]C=CC(CC[CH2])OO(3513)'],
    products = ['S(433)(432)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[CH2]CCCC=C[CH]OO(3515)'],
    products = ['S(433)(432)'],
    transitionState = 'TS25',
    kinetics = Arrhenius(A=(7.38971e+10,'s^-1'), n=0.0476667, Ea=(8.08907,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Rn;C_rad_out_2H;Cpri_rad_out_single] for rate rule [R7;C_rad_out_2H;Cpri_rad_out_H/NonDeO]
Euclidian distance = 2.2360679775
family: Birad_recombination"""),
)
...
reaction(
    label = 'reaction26',
    reactants = ['[CH2]CC=CC(C[CH2])OO(3516)'],
    products = ['S(433)(432)'],
...
reaction(
    label = 'reaction27',
    reactants = ['[CH2]CCC=CC([CH2])OO(3517)'],
    products = ['S(433)(432)'],
