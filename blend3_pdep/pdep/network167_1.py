...
species(
    label = 'OC1C2C=CC=CC12(2102)',
    structure = SMILES('OC1C2C=CC=CC12'),
    E0 = (23.5864,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (108.138,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.47083,0.035485,5.18982e-05,-9.25561e-08,3.75793e-11,2945.93,20.7955], Tmin=(100,'K'), Tmax=(973.434,'K')), NASAPolynomial(coeffs=[16.0691,0.0252789,-9.0838e-06,1.74297e-09,-1.31e-13,-2254.71,-61.3542], Tmin=(973.434,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(23.5864,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(378.308,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsOsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + polycyclic(s2_3_6_diene_1_3)"""),
)
...
species(
    ...
    molecularWeight = (108.138,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.277938,0.0682128,-3.22046e-05,-1.31026e-08,1.13802e-11,40772.6,15.7839], Tmin=(100,'K'), Tmax=(989.772,'K')), NASAPolynomial(coeffs=[19.2081,0.0219745,-7.99648e-06,1.48526e-09,-1.0758e-13,35542.9,-82.8372], Tmin=(989.772,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(337.788,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(378.308,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + ring(1,3-Cycloheptadiene) + radical(Cds_S) + radical(CCJCO)"""),
)

species(
    label = 'OC1[C]=C[CH]CC=C1(1549)',
...
species(
    ...
    molecularWeight = (108.138,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.236375,0.070149,-3.6196e-05,-8.47908e-09,9.70435e-12,29030.3,11.4528], Tmin=(100,'K'), Tmax=(985.65,'K')), NASAPolynomial(coeffs=[18.4011,0.024261,-8.71271e-06,1.577e-09,-1.11784e-13,24097.7,-82.7764], Tmin=(985.65,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(240.152,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(378.308,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + ring(1,3-Cycloheptadiene) + radical(C=CJC=C) + radical(Allyl_S)"""),
)
...
species(
    label = '[CH]=CC=CC(O)C=[CH](2116)',
    structure = SMILES('[CH]=CC=CC(O)C=[CH]'),
    E0 = (456.881,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,3115,3125,620,680,785,800,1600,1700,2995,3005,3015,3025,975,983.333,991.667,1000,1300,1325,1350,1375,400,433.333,466.667,500,1630,1646.67,1663.33,1680,180],'cm^-1')),
        HinderedRotor(inertia=(0.748413,'amu*angstrom^2'), symmetry=1, barrier=(17.2075,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.748524,'amu*angstrom^2'), symmetry=1, barrier=(17.21,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.749552,'amu*angstrom^2'), symmetry=1, barrier=(17.2337,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.750349,'amu*angstrom^2'), symmetry=1, barrier=(17.252,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (108.138,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0260246,0.0773616,-6.42936e-05,2.26593e-08,-1.75836e-12,55101.8,33.6075], Tmin=(100,'K'), Tmax=(1054.04,'K')), NASAPolynomial(coeffs=[18.6201,0.0225085,-8.5891e-06,1.56744e-09,-1.09621e-13,50309.4,-61.2163], Tmin=(1054.04,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(456.881,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)(Cds-Cds)OsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cds_P) + radical(Cds_P)"""),
)

species(
    label = '[CH]=CC=CC=C[CH]O(2117)',
...
species(
    label = 'OC1C=CC=C[C]C1(2119)',
    structure = SMILES('OC1C=CC=C[C]C1'),
    E0 = (263.085,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2816.67,2883.33,2950,3016.67,3083.33,3150,900,933.333,966.667,1000,1033.33,1066.67,1100,300,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (108.138,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.11492,0.00418283,0.000227041,-3.45512e-07,1.47421e-10,31801.4,28.2717], Tmin=(100,'K'), Tmax=(903.217,'K')), NASAPolynomial(coeffs=[43.762,-0.0290728,2.38408e-05,-4.78257e-09,3.14511e-13,17750.1,-208.272], Tmin=(903.217,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(263.085,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(378.308,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsCsH) + group(CsJ2_singlet-(Cds-Cds-Cds-Cds)Cs_6_ring) + ring(Cycloheptane)"""),
)

species(
    label = 'OC1C=C[C]CC=C1(2120)',
    structure = SMILES('OC1C=C[C]CC=C1'),
    E0 = (347.696,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2816.67,2883.33,2950,3016.67,3083.33,3150,900,933.333,966.667,1000,1033.33,1066.67,1100,300,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
    ...
    molecularWeight = (108.138,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.29741,0.00980141,0.000190774,-2.89267e-07,1.22242e-10,41961.9,37.0783], Tmin=(100,'K'), Tmax=(908.215,'K')), NASAPolynomial(coeffs=[35.9927,-0.0133744,1.49539e-05,-3.05131e-09,1.96896e-13,30313.5,-156.399], Tmin=(908.215,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(347.696,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(378.308,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)(Cds-Cds)OsH) + group(Cs-CsCsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(CsJ2_singlet-CsH) + ring(Cycloheptane)"""),
)

species(
    label = 'OC1C=CC2C=CC12(2121)',
    structure = SMILES('OC1C=CC2C=CC12'),
    E0 = (87.4942,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (108.138,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.22058,0.0360754,6.45093e-05,-1.17288e-07,4.93851e-11,10646,24.7386], Tmin=(100,'K'), Tmax=(950.066,'K')), NASAPolynomial(coeffs=[20.8135,0.0166164,-4.28511e-06,8.16691e-10,-6.85401e-14,4078.42,-83.7533], Tmin=(950.066,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(87.4942,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(378.308,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)(Cds-Cds)CsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + polycyclic(s2_4_5_diene_1_5)"""),
)

species(
    label = 'OC1[CH]C2C=CC2[CH]1(2122)',
...
reaction(
    label = 'reaction535',
    reactants = ['OH(5)(5)', '[CH]1C=CC=CC=C1(1453)'],
    products = ['C7H8O(576)(575)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(2.07469e+08,'m^3/(mol*s)'), n=-0.00388889, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Y_rad;C_rad/H/CdCd] for rate rule [O_pri_rad;C_rad/H/CdCd]
...
reaction(
    label = 'reaction536',
    reactants = ['H(3)(3)', '[O]C1C=CC=CC=C1(1526)'],
    products = ['C7H8O(576)(575)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction538',
    reactants = ['H(3)(3)', 'OC1[C]=CC=CC=C1(2103)'],
    products = ['C7H8O(576)(575)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction539',
    reactants = ['H(3)(3)', 'OC1C=[C]C=CC=C1(2104)'],
    products = ['C7H8O(576)(575)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction540',
    reactants = ['H(3)(3)', 'OC1C=C[C]=CC=C1(2105)'],
    products = ['C7H8O(576)(575)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(6.117e+14,'cm^3/(mol*s)'), n=-0.152, Ea=(4.19655,'kJ/mol'), T0=(1,'K'), comment="""From training reaction 49 used for Cd_rad/Cd;H_rad
Exact match found for rate rule [Cd_rad/Cd;H_rad]
...
reaction(
    label = 'reaction543',
    reactants = ['OC1[CH]C[C]=CC=C1(2106)'],
    products = ['C7H8O(576)(575)'],
...
reaction(
    label = 'reaction545',
    reactants = ['OC1[C]=CC=C[CH]C1(2107)'],
    products = ['C7H8O(576)(575)'],
...
reaction(
    label = 'reaction547',
    reactants = ['OC1[CH]CC=[C]C=C1(2108)'],
    products = ['C7H8O(576)(575)'],
...
reaction(
    label = 'reaction548',
    reactants = ['[O]C1[CH]CC=CC=C1(2109)'],
    products = ['C7H8O(576)(575)'],
...
reaction(
    label = 'reaction549',
    reactants = ['OC1[C]=CC=CC[CH]1(2110)'],
    products = ['C7H8O(576)(575)'],
...
reaction(
    label = 'reaction550',
    reactants = ['OC1[C]=C[CH]CC=C1(1549)'],
    products = ['C7H8O(576)(575)'],
...
reaction(
    label = 'reaction551',
    reactants = ['OC1C=C[C]=C[CH]C1(2111)'],
    products = ['C7H8O(576)(575)'],
...
reaction(
    label = 'reaction552',
    reactants = ['OC1C=[C]C=C[CH]C1(2112)'],
    products = ['C7H8O(576)(575)'],
...
reaction(
    label = 'reaction554',
    reactants = ['OC1[CH]CC=C[C]=C1(2113)'],
    products = ['C7H8O(576)(575)'],
...
reaction(
    label = 'reaction556',
    reactants = ['OC1C=CC=[C][CH]C1(2114)'],
    products = ['C7H8O(576)(575)'],
...
reaction(
    label = 'reaction559',
    reactants = ['[CH]=CC=CC(O)C=[CH](2116)'],
    products = ['C7H8O(576)(575)'],
...
reaction(
    label = 'reaction560',
    reactants = ['[CH]=CC=CC=C[CH]O(2117)'],
    products = ['C7H8O(576)(575)'],
...
reaction(
    label = 'reaction565',
    reactants = ['OC1[CH]C2C=CC2[CH]1(2122)'],
    products = ['C7H8O(576)(575)'],
