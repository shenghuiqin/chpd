...
species(
    label = '[CH2]CC1=CC(CCCC1)OO(4490)',
...
species(
    label = '[CH2]CC1C=C(CCCC1)OO(4491)',
...
species(
    label = 'C=CC1[CH]C(CCCC1)OO(4492)',
...
species(
    label = '[CH2]C[C]1CCCCC(C1)OO(4494)',
...
species(
    label = '[CH2]CC1CCCC[C](C1)OO(4495)',
...
species(
    label = 'C[CH]C1[CH]C(CCCC1)OO(4496)',
...
species(
    label = '[CH2]CC1[CH]CCCC(C1)OO(4497)',
...
species(
    label = '[CH2][CH]C1CCCCC(C1)OO(4498)',
...
species(
    label = '[CH2]CC1CCC[CH]C(C1)OO(4499)',
    structure = SMILES('[CH2]CC1CCC[CH]C(C1)OO'),
    E0 = (112.614,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,2750,2790,2830,2870,2910,2950,2990,3030,3070,3110,3150,900,920,940,960,980,1000,1020,1040,1060,1080,1100,3000,3100,440,815,1455,1000,2750,2850,1437.5,1250,1305,750,350,300,800,800,800,800,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'CC[C]1[CH]C(CCCC1)OO(4500)',
...
species(
    label = 'CCC1[CH]CCCC([CH]1)OO(4502)',
...
species(
    label = '[CH2]CC1C[CH]CCC(C1)OO(4503)',
...
species(
    label = '[CH2]CC1CC[CH]CC(C1)OO(4504)',
...
species(
    label = 'CCC1[CH]C(CC[CH]C1)OO(4505)',
...
species(
    label = 'CCC1[CH]C(C[CH]CC1)OO(4507)',
...
species(
    label = 'CCC1[CH]C([CH]CCC1)OO(4508)',
...
species(
    label = 'CCC1[CH]C(CCCC1)O[O](4509)',
...
species(
    label = '[CH2]CC=CC(CCC[CH2])OO(4511)',
...
species(
    label = '[CH2]CC1CCCCC1[CH]OO(4516)',
...
species(
    label = '[CH2]C1[CH]C(CCCC1)OO(4518)',
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)(3)', '[CH2]CC1=CC(CCCC1)OO(4490)'],
    products = ['[CH2]CC1[CH]C(CCCC1)OO(4221)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)(3)', '[CH2]CC1C=C(CCCC1)OO(4491)'],
    products = ['[CH2]CC1[CH]C(CCCC1)OO(4221)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)(3)', 'C=CC1[CH]C(CCCC1)OO(4492)'],
    products = ['[CH2]CC1[CH]C(CCCC1)OO(4221)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['HO2(8)(9)', '[CH2]CC1C=CCCCC1(4493)'],
    products = ['[CH2]CC1[CH]C(CCCC1)OO(4221)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]CC1[CH]C(CCCC1)OO(4221)'],
    products = ['[CH2]C[C]1CCCCC(C1)OO(4494)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]CC1[CH]C(CCCC1)OO(4221)'],
    products = ['[CH2]CC1CCCC[C](C1)OO(4495)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]CC1[CH]C(CCCC1)OO(4221)'],
    products = ['C[CH]C1[CH]C(CCCC1)OO(4496)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]CC1[CH]C(CCCC1)OO(4221)'],
    products = ['[CH2]CC1[CH]CCCC(C1)OO(4497)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]CC1[CH]C(CCCC1)OO(4221)'],
    products = ['[CH2][CH]C1CCCCC(C1)OO(4498)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2]CC1CCC[CH]C(C1)OO(4499)'],
    products = ['[CH2]CC1[CH]C(CCCC1)OO(4221)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]CC1[CH]C(CCCC1)OO(4221)'],
    products = ['CC[C]1[CH]C(CCCC1)OO(4500)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]CC1[CH]C(CCCC1)OO(4221)'],
    products = ['[CH2]CC1CCCCC(C1)O[O](4501)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]CC1[CH]C(CCCC1)OO(4221)'],
    products = ['CCC1[CH]CCCC([CH]1)OO(4502)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]CC1[CH]C(CCCC1)OO(4221)'],
    products = ['[CH2]CC1C[CH]CCC(C1)OO(4503)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2]CC1[CH]C(CCCC1)OO(4221)'],
    products = ['[CH2]CC1CC[CH]CC(C1)OO(4504)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2]CC1[CH]C(CCCC1)OO(4221)'],
    products = ['CCC1[CH]C(CC[CH]C1)OO(4505)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2]CC1[CH]C(CCCC1)OO(4221)'],
    products = ['CCC1[CH][C](CCCC1)OO(4506)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH2]CC1[CH]C(CCCC1)OO(4221)'],
    products = ['CCC1[CH]C(C[CH]CC1)OO(4507)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH2]CC1[CH]C(CCCC1)OO(4221)'],
    products = ['CCC1[CH]C([CH]CCC1)OO(4508)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH2]CC1[CH]C(CCCC1)OO(4221)'],
    products = ['CCC1[CH]C(CCCC1)O[O](4509)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[CH2]CCCC(C=COO)C[CH2](4510)'],
    products = ['[CH2]CC1[CH]C(CCCC1)OO(4221)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[CH2]CC=CC(CCC[CH2])OO(4511)'],
    products = ['[CH2]CC1[CH]C(CCCC1)OO(4221)'],
...
reaction(
    label = 'reaction27',
    reactants = ['[CH2]CC1[CH]C(CCCC1)OO(4221)'],
    products = ['CCC1=CC(CCCC1)OO(4512)'],
...
reaction(
    label = 'reaction28',
    reactants = ['[CH2]CC1[CH]C(CCCC1)OO(4221)'],
    products = ['C=CC1CCCCC(C1)OO(4513)'],
...
reaction(
    label = 'reaction29',
    reactants = ['[CH2]CC1[CH]C(CCCC1)OO(4221)'],
    products = ['CCC1C=C(CCCC1)OO(4514)'],
...
reaction(
    label = 'reaction30',
    reactants = ['[CH2]CC1[CH]C(CCCC1)OO(4221)'],
    products = ['OH(5)(5)', '[CH2]CC1CCCCC2OC12(4515)'],
...
reaction(
    label = 'reaction33',
    reactants = ['[CH2]CC1[CH]C(CCCC1)OO(4221)'],
    products = ['[CH2]CC1CCCCC1[CH]OO(4516)'],
...
reaction(
    label = 'reaction35',
    reactants = ['[CH2]CC1[CH]C(CCCC1)OO(4221)'],
    products = ['[CH2]CC1CCCCC([O])C1O(4517)'],
...
reaction(
    label = 'reaction36',
    reactants = ['CH2(17)(18)', '[CH2]C1[CH]C(CCCC1)OO(4518)'],
    products = ['[CH2]CC1[CH]C(CCCC1)OO(4221)'],
