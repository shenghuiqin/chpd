...
reaction(
    label = 'reaction1',
    reactants = ['H(3)(3)', 'C2H4(19)(20)'],
    products = ['C2H5(27)(28)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(1.4e+09,'cm^3/(mol*s)'), n=1.463, Ea=(1355,'cal/mol'), T0=(1,'K'), comment="""Kinetics taken from the arrheniusHigh attribute of a Troe/Lindemann exprssion. Originally from reaction library Klippenstein_Glarborg2016"""),
)

reaction(
    label = 'reaction2',
    reactants = ['H(3)(3)', 'C2H4(T)(890)'],
    products = ['C2H5(27)(28)'],
    transitionState = 'TS2',
