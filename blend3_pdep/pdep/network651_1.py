species(
    ...
    E0 = (-299.068,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,1380,1390,370,380,2900,435,492.5,1135,1000,375,552.5,462.5,1710,188.28,4000],'cm^-1')),
        HinderedRotor(inertia=(0.308705,'amu*angstrom^2'), symmetry=1, barrier=(7.7657,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.01338,'amu*angstrom^2'), symmetry=1, barrier=(25.4935,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.308713,'amu*angstrom^2'), symmetry=1, barrier=(7.76579,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.308714,'amu*angstrom^2'), symmetry=1, barrier=(7.76578,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.3087,'amu*angstrom^2'), symmetry=1, barrier=(7.76575,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.520027,'amu*angstrom^2'), symmetry=1, barrier=(11.9565,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.519184,'amu*angstrom^2'), symmetry=1, barrier=(11.9371,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.520218,'amu*angstrom^2'), symmetry=1, barrier=(11.9608,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (130.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.574307,0.100727,-0.000135931,9.22579e-08,-2.42443e-11,-12859.4,32.2275], Tmin=(100,'K'), Tmax=(941.624,'K')), NASAPolynomial(coeffs=[18.4224,0.0200291,-7.38068e-06,1.24459e-09,-8.04421e-14,-16437,-58.2783], Tmin=(941.624,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-108.288,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(O2s-OsH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsCsCs) + radical(C=C(C)OJ) + radical(ROOJ)"""),
)
...
species(
    label = '[O]OC(O)C=C[C]=O(7706)',
    structure = SMILES('[O]OC(O)[CH]C=C=O'),
    E0 = (-121.316,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2120,512.5,787.5,3025,407.5,1350,352.5,3615,1277.5,1000,3010,987.5,1337.5,450,1655,1380,1390,370,380,2900,435,492.5,1135,1000,279.619,279.62],'cm^-1')),
        HinderedRotor(inertia=(0.204974,'amu*angstrom^2'), symmetry=1, barrier=(11.3726,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.53592,'amu*angstrom^2'), symmetry=1, barrier=(29.7346,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.874321,'amu*angstrom^2'), symmetry=1, barrier=(48.5102,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.204973,'amu*angstrom^2'), symmetry=1, barrier=(11.3726,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (116.072,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.544891,0.0814303,-0.000115448,8.72034e-08,-2.6414e-11,-14471.4,27.8088], Tmin=(100,'K'), Tmax=(806.875,'K')), NASAPolynomial(coeffs=[11.6646,0.0263043,-1.29655e-05,2.52761e-09,-1.77776e-13,-16265.8,-23.4511], Tmin=(806.875,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-121.316,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsOsOsH) + group(Cs-(Cds-Cdd-O2d)CsHH) + group(Cds-(Cdd-O2d)CsH) + radical(ROOJ) + radical(C=CCJCO)"""),
)

species(
    label = '[CH2]C(=O)C=CC(O)O[O](7707)',
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.507641,'amu*angstrom^2'), symmetry=1, barrier=(11.6717,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.508386,'amu*angstrom^2'), symmetry=1, barrier=(11.6888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.507564,'amu*angstrom^2'), symmetry=1, barrier=(11.6699,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.508092,'amu*angstrom^2'), symmetry=1, barrier=(11.682,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (130.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.282734,0.0971692,-0.000129448,8.95656e-08,-2.44277e-11,-18459.5,33.3085], Tmin=(100,'K'), Tmax=(900.68,'K')), NASAPolynomial(coeffs=[15.7003,0.0261875,-1.12356e-05,2.06745e-09,-1.41184e-13,-21338.6,-42.1288], Tmin=(900.68,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-154.741,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(O2s-OsH) + group(Cs-CsOsOsH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)O2s) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + radical(ROOJ) + radical(C=C(C)OJ)"""),
)

species(
    label = 'CC(=O)C=[C]C(O)O[O](7708)',
    structure = SMILES('CC(=O)C=[C]C(O)O[O]'),
    E0 = (-61.2263,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1685,370,3010,987.5,1337.5,450,1655,2750,2800,2850,1350,1500,750,1050,1375,1000,1380,1390,370,380,2900,435,492.5,1135,1000,375,552.5,462.5,1710,180,4000],'cm^-1')),
        HinderedRotor(inertia=(0.314065,'amu*angstrom^2'), symmetry=1, barrier=(7.22097,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.00708,'amu*angstrom^2'), symmetry=1, barrier=(23.1547,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.314479,'amu*angstrom^2'), symmetry=1, barrier=(7.23049,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.314463,'amu*angstrom^2'), symmetry=1, barrier=(7.23013,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.313487,'amu*angstrom^2'), symmetry=1, barrier=(7.20768,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (130.099,'amu'),
...
species(
    label = 'CC(=O)[C]=CC(O)O[O](7709)',
    structure = SMILES('CC([O])=C=CC(O)O[O]'),
    E0 = (-102.626,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([540,610,2055,3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,1380,1390,370,380,2900,435,492.5,1135,1000,350,440,435,1725,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.426292,'amu*angstrom^2'), symmetry=1, barrier=(9.80129,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.426552,'amu*angstrom^2'), symmetry=1, barrier=(9.80727,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.426452,'amu*angstrom^2'), symmetry=1, barrier=(9.80497,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.426703,'amu*angstrom^2'), symmetry=1, barrier=(9.81075,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (130.099,'amu'),
...
species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.652356,'amu*angstrom^2'), symmetry=1, barrier=(14.9989,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.652776,'amu*angstrom^2'), symmetry=1, barrier=(15.0086,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.652766,'amu*angstrom^2'), symmetry=1, barrier=(15.0084,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.651637,'amu*angstrom^2'), symmetry=1, barrier=(14.9824,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.652729,'amu*angstrom^2'), symmetry=1, barrier=(15.0075,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (131.107,'amu'),
...
species(
    label = 'CC(=O)[C]=CC(O)OO(7701)',
    structure = SMILES('CC([O])=C=CC(O)OO'),
    E0 = (-254.63,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([540,610,2055,3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,350,440,435,1725,229.557,231.142],'cm^-1')),
        HinderedRotor(inertia=(0.326497,'amu*angstrom^2'), symmetry=1, barrier=(12.5288,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.341591,'amu*angstrom^2'), symmetry=1, barrier=(12.4907,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.331926,'amu*angstrom^2'), symmetry=1, barrier=(12.5351,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.505758,'amu*angstrom^2'), symmetry=1, barrier=(19.1821,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.33336,'amu*angstrom^2'), symmetry=1, barrier=(12.527,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (131.107,'amu'),
...
species(
    label = 'C=C(O)C=CC(O)O[O](7712)',
    structure = SMILES('C=C(O)C=CC(O)O[O]'),
    E0 = (-292.546,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3580,3650,1210,1345,900,1100,2995,3025,975,1000,1300,1375,400,500,1630,1680,2950,3100,1380,975,1025,1650,1380,1390,370,380,2900,435,492.5,1135,1000,350,440,435,1725,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.681435,'amu*angstrom^2'), symmetry=1, barrier=(15.6675,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.68186,'amu*angstrom^2'), symmetry=1, barrier=(15.6773,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.6817,'amu*angstrom^2'), symmetry=1, barrier=(15.6736,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.68181,'amu*angstrom^2'), symmetry=1, barrier=(15.6761,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.681821,'amu*angstrom^2'), symmetry=1, barrier=(15.6764,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (131.107,'amu'),
...
species(
    label = 'CC(O)=C=CC(O)O[O](7713)',
    structure = SMILES('CC(O)=C=CC(O)O[O]'),
    E0 = (-240.431,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([540,610,2055,3580,3650,1210,1345,900,1100,3010,987.5,1337.5,450,1655,2750,2800,2850,1350,1500,750,1050,1375,1000,1380,1390,370,380,2900,435,492.5,1135,1000,350,440,435,1725,180],'cm^-1')),
        HinderedRotor(inertia=(0.60167,'amu*angstrom^2'), symmetry=1, barrier=(13.8336,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.602361,'amu*angstrom^2'), symmetry=1, barrier=(13.8495,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.601004,'amu*angstrom^2'), symmetry=1, barrier=(13.8183,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.602005,'amu*angstrom^2'), symmetry=1, barrier=(13.8413,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.600984,'amu*angstrom^2'), symmetry=1, barrier=(13.8178,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (131.107,'amu'),
...
reaction(
    label = 'reaction9',
    reactants = ['OH(5)(5)', 'CC(=O)C=C[CH]O[O](7703)'],
    products = ['S(246)(245)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction10',
    reactants = ['H(3)(3)', 'CC(=O)C=CC([O])O[O](7704)'],
    products = ['S(246)(245)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction11',
    reactants = ['[CH]=CC(C)=O(7465)', '[O]O[CH]O(7358)'],
    products = ['S(246)(245)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction12',
    reactants = ['H(3)(3)', 'CC(=O)C=C[C](O)O[O](7705)'],
    products = ['S(246)(245)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction13',
    reactants = ['CH3(15)(16)', '[O]OC(O)C=C[C]=O(7706)'],
    products = ['S(246)(245)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction14',
    reactants = ['H(3)(3)', '[CH2]C(=O)C=CC(O)O[O](7707)'],
    products = ['S(246)(245)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction15',
    reactants = ['H(3)(3)', 'CC(=O)C=[C]C(O)O[O](7708)'],
    products = ['S(246)(245)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction16',
    reactants = ['CH3CO(55)(54)', '[CH]=CC(O)O[O](7361)'],
    products = ['S(246)(245)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction17',
    reactants = ['H(3)(3)', 'CC(=O)[C]=CC(O)O[O](7709)'],
    products = ['S(246)(245)'],
...
reaction(
    label = 'reaction3',
    reactants = ['S(246)(245)'],
    products = ['CC1([O])C=CC(O)OO1(7697)'],
...
reaction(
    label = 'reaction4',
    reactants = ['CC(=O)C=C[C](O)OO(7698)'],
    products = ['S(246)(245)'],
...
reaction(
    label = 'reaction8',
    reactants = ['S(246)(245)'],
    products = ['[CH2]C(=O)C=CC(O)OO(7702)'],
...
reaction(
    label = 'reaction19',
    reactants = ['S(246)(245)'],
    products = ['C[C]1C=CC(O)OOO1(7710)'],
...
reaction(
    label = 'reaction20',
    reactants = ['CO(10)(11)', 'CC=CC(O)O[O](7711)'],
    products = ['S(246)(245)'],
...
reaction(
    label = 'reaction23',
    reactants = ['C=C(O)C=CC(O)O[O](7712)'],
    products = ['S(246)(245)'],
...
reaction(
    label = 'reaction24',
    reactants = ['CC(O)=C=CC(O)O[O](7713)'],
    products = ['S(246)(245)'],
...
reaction(
    label = 'reaction25',
    reactants = ['O(4)(4)', 'CC(=O)C=CC([O])O(7714)'],
    products = ['S(246)(245)'],
