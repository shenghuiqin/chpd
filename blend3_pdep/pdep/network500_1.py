...
species(
    label = '[CH2]C=CC1OC2[CH]C21(1828)',
...
species(
    label = '[CH2]C=CC1[CH]C1C=O(1836)',
    structure = SMILES('[CH2]C=CC1[CH]C1C=O'),
    E0 = (317.358,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2950,3150,900,1000,1100,2995,3025,975,1000,1300,1375,400,500,1630,1680,3000,3100,440,815,1455,1000,2782.5,750,1395,475,1775,1000,300,800,800,800,800,800,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
...
species(
    ...
    molecularWeight = (108.138,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.38704,0.0312983,7.95223e-05,-1.29166e-07,5.21128e-11,32146.9,27.536], Tmin=(100,'K'), Tmax=(963.175,'K')), NASAPolynomial(coeffs=[19.5562,0.0213721,-7.07068e-06,1.40534e-09,-1.12075e-13,25607.3,-75.2167], Tmin=(963.175,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(266.305,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(374.151,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(25dihydrofuran) + radical(Cds_S) + radical(C=CCJC(O)C=C)"""),
)

species(
    label = '[CH2]C=[C]C1C=CCO1(1856)',
    ...
    molecularWeight = (108.138,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.16793,0.045577,2.23755e-05,-5.98493e-08,2.52384e-11,40006.1,27.2049], Tmin=(100,'K'), Tmax=(1000.63,'K')), NASAPolynomial(coeffs=[15.4282,0.0282677,-1.11832e-05,2.15487e-09,-1.58062e-13,35164.9,-51.5318], Tmin=(1000.63,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(331.659,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(374.151,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)(Cds-Cds)OsH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(25dihydrofuran) + radical(Allyl_P) + radical(Cds_S)"""),
)

species(
    label = 'C=[C][CH]C1C=CCO1(1847)',
    structure = SMILES('C=[C][CH]C1C=CCO1'),
    E0 = (266.305,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,3100,1380,975,1025,1650,1685,370,2750,2850,2950,3050,3150,900,950,1000,1050,1100,3025,407.5,1350,352.5,300,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
...
species(
    label = '[CH2]C1[CH]C2C=CC1O2(1839)',
...
species(
    label = 'C=CC1C2[CH]OC1[CH]2(1838)',
...
species(
    label = '[CH]=C[CH]C1C=CCO1(1848)',
    structure = SMILES('[CH]=C[CH]C1C=CCO1'),
    E0 = (275.56,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,2950,3050,3150,900,950,1000,1050,1100,3025,407.5,1350,352.5,3120,650,792.5,1650,3010,987.5,1337.5,450,1655,300,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
...
reaction(
    label = 'reaction99',
    reactants = ['H(3)(3)', '[CH2]C=CC1=CC=CO1(1813)'],
...
reaction(
    label = 'reaction100',
    reactants = ['H(3)(3)', '[CH2]C=CC1C=C=CO1(1814)'],
    products = ['C7H8O(550)(549)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction101',
    reactants = ['H(3)(3)', 'C=C=CC1[CH]C=CO1(1815)'],
    products = ['C7H8O(550)(549)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction102',
    reactants = ['[CH]=C[CH2](891)', 'C1C=COC=1(1816)'],
    products = ['C7H8O(550)(549)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction113',
    reactants = ['[CH]=C[CH2](891)', '[CH]1[CH]OC=C1(1827)'],
    products = ['C7H8O(550)(549)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction97',
    reactants = ['C7H8O(550)(549)'],
    products = ['[CH2][CH]C1C2C=COC12(1811)'],
...
reaction(
    label = 'reaction98',
    reactants = ['C7H8O(550)(549)'],
    products = ['[CH]1OC2[CH]C1CC=C2(1812)'],
...
reaction(
    label = 'reaction103',
    reactants = ['[CH2]C=C[C]1CC=CO1(1817)'],
    products = ['C7H8O(550)(549)'],
...
reaction(
    label = 'reaction104',
    reactants = ['[CH2]C=CC1C[C]=CO1(1818)'],
    products = ['C7H8O(550)(549)'],
...
reaction(
    label = 'reaction105',
    reactants = ['C7H8O(550)(549)'],
    products = ['C[C]=CC1[CH]C=CO1(1819)'],
...
reaction(
    label = 'reaction106',
    reactants = ['[CH2]C=[C]C1CC=CO1(1820)'],
    products = ['C7H8O(550)(549)'],
...
reaction(
    label = 'reaction107',
    reactants = ['C7H8O(550)(549)'],
    products = ['[CH2]C=CC1CC=[C]O1(1821)'],
...
reaction(
    label = 'reaction108',
    reactants = ['CC=[C]C1[CH]C=CO1(1822)'],
    products = ['C7H8O(550)(549)'],
...
reaction(
    label = 'reaction109',
    reactants = ['[CH2][C]=CC1CC=CO1(1823)'],
    products = ['C7H8O(550)(549)'],
...
reaction(
    label = 'reaction110',
    reactants = ['CC=C[C]1[CH]C=CO1(1824)'],
    products = ['C7H8O(550)(549)'],
...
reaction(
    label = 'reaction111',
    reactants = ['CC=CC1[CH]C=[C]O1(1825)'],
    products = ['C7H8O(550)(549)'],
...
reaction(
    label = 'reaction112',
    reactants = ['CC=CC1[CH][C]=CO1(1826)'],
    products = ['C7H8O(550)(549)'],
...
reaction(
    label = 'reaction114',
    reactants = ['C7H8O(550)(549)'],
    products = ['[CH2]C=CC1OC2[CH]C21(1828)'],
...
reaction(
    label = 'reaction115',
    reactants = ['C7H8O(550)(549)'],
    products = ['[CH]1CC1C1[CH]C=CO1(1829)'],
...
reaction(
    label = 'reaction116',
    reactants = ['C7H8O(550)(549)'],
    products = ['[CH2]C1[CH]C2OC=CC12(1830)'],
...
reaction(
    label = 'reaction117',
    reactants = ['C7H8O(550)(549)'],
    products = ['[CH]1[CH]C2C=CC(C1)O2(1511)'],
...
reaction(
    label = 'reaction118',
    reactants = ['[CH2]C=CC=CC=C[O](1831)'],
    products = ['C7H8O(550)(549)'],
...
reaction(
    label = 'reaction123',
    reactants = ['C7H8O(550)(549)'],
    products = ['[CH2]C=CC1[CH]C1C=O(1836)'],
...
reaction(
    label = 'reaction124',
    reactants = ['CH2(17)(18)', '[CH]=CC1[CH]C=CO1(1837)'],
    products = ['C7H8O(550)(549)'],
...
reaction(
    label = 'reaction38',
    reactants = ['C7H8O(550)(549)'],
    products = ['C=CC1C2[CH][CH]C1O2(1854)'],
...
reaction(
    label = 'reaction129',
    reactants = ['C=C[CH]C1C=[C]CO1(1841)'],
    products = ['C7H8O(550)(549)'],
...
reaction(
    label = 'reaction131',
    reactants = ['C=C[CH][C]1C=CCO1(1843)'],
    products = ['C7H8O(550)(549)'],
...
reaction(
    label = 'reaction133',
    reactants = ['C=C[CH]C1[C]=CCO1(1845)'],
    products = ['C7H8O(550)(549)'],
...
reaction(
    label = 'reaction150',
    reactants = ['[CH2]C=[C]C1C=CCO1(1856)'],
    products = ['C7H8O(550)(549)'],
...
reaction(
    label = 'reaction136',
    reactants = ['C=[C][CH]C1C=CCO1(1847)'],
    products = ['C7H8O(550)(549)'],
...
reaction(
    label = 'reaction151',
    reactants = ['CC=CC1[C]=C[CH]O1(1857)'],
    products = ['C7H8O(550)(549)'],
...
reaction(
    label = 'reaction45',
    reactants = ['C7H8O(550)(549)'],
    products = ['[CH2]C1[CH]C2C=CC1O2(1839)'],
...
reaction(
    label = 'reaction146',
    reactants = ['C7H8O(550)(549)'],
    products = ['[CH]1[CH]C2CC=CC2O1(1768)'],
...
reaction(
    label = 'reaction125',
    reactants = ['C7H8O(550)(549)'],
    products = ['C=CC1C2[CH]OC1[CH]2(1838)'],
...
reaction(
    label = 'reaction128',
    reactants = ['C=CC[C]1C=C[CH]O1(1840)'],
    products = ['C7H8O(550)(549)'],
...
reaction(
    label = 'reaction130',
    reactants = ['C=[C]CC1C=C[CH]O1(1842)'],
    products = ['C7H8O(550)(549)'],
...
reaction(
    label = 'reaction143',
    reactants = ['C=CCC1[CH]C=[C]O1(1852)'],
    products = ['C7H8O(550)(549)'],
...
reaction(
    label = 'reaction135',
    reactants = ['C=CCC1C=[C][CH]O1(1846)'],
    products = ['C7H8O(550)(549)'],
...
reaction(
    label = 'reaction144',
    reactants = ['[CH]=C[CH]C1CC=CO1(1853)'],
    products = ['C7H8O(550)(549)'],
...
reaction(
    label = 'reaction127',
    reactants = ['[CH]=C[CH]OC=CC=C(1762)'],
    products = ['C7H8O(550)(549)'],
...
reaction(
    label = 'reaction132',
    reactants = ['C=CCC1[C]=C[CH]O1(1844)'],
    products = ['C7H8O(550)(549)'],
...
reaction(
    label = 'reaction137',
    reactants = ['[CH]=C[CH]C1C=CCO1(1848)'],
    products = ['C7H8O(550)(549)'],
