...
species(
    ...
    molecularWeight = (108.138,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.94992,0.0418728,-2.87936e-06,-1.1449e-08,3.68876e-12,41069.9,25.3926], Tmin=(100,'K'), Tmax=(1448.49,'K')), NASAPolynomial(coeffs=[8.83442,0.039503,-1.76589e-05,3.28505e-09,-2.23214e-13,37329.7,-16.3983], Tmin=(1448.49,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(340.842,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(378.308,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-(Cds-O2d)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cds-OdCsH) + polycyclic(s2_3_5_ane) + radical(bicyclo[3.1.0]hexane-tertiary) + radical(bicyclo[3.1.0]hexane-C5-3)"""),
)

species(
    label = '[O]C[C]1C2C=CCC12(1951)',
    structure = SMILES('[O]C[C]1C2C=CCC12'),
    E0 = (331.009,'kJ/mol'),
    modes = [
...
species(
    label = 'O=CC1C2[CH]C[CH]C21(1952)',
...
species(
    ...
    molecularWeight = (108.138,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.67755,0.0447779,-5.3015e-06,-1.20345e-08,4.40572e-12,43850.6,24.78], Tmin=(100,'K'), Tmax=(1327.34,'K')), NASAPolynomial(coeffs=[9.16813,0.0386608,-1.69854e-05,3.17415e-09,-2.17992e-13,40412.4,-18.9396], Tmin=(1327.34,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(363.858,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(378.308,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + polycyclic(s2_3_5_ene_1) + radical(CCOJ) + radical(Tertalkyl)"""),
)

species(
    label = '[O]CC1[C]2C=CCC21(1955)',
    structure = SMILES('[O]CC1[C]2C=CCC21'),
    E0 = (310.416,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2830,2910,2990,3070,3150,900,940,980,1020,1060,1100,2750,2850,1437.5,1250,1305,750,350,300,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
...
species(
    ...
    molecularWeight = (108.138,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.32322,0.0464055,7.762e-06,-3.61354e-08,1.48814e-11,43252.7,23.7516], Tmin=(100,'K'), Tmax=(1059.15,'K')), NASAPolynomial(coeffs=[12.08,0.0338486,-1.42041e-05,2.71075e-09,-1.93404e-13,39399.8,-36.1935], Tmin=(1059.15,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(358.733,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(378.308,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + polycyclic(s2_3_5_ene_1) + radical(CCsJOH) + radical(CCOJ)"""),
)

species(
    label = '[O]CC1C2[CH]C=CC21(1960)',
    structure = SMILES('[O]CC1C2[CH]C=CC21'),
    E0 = (305.741,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2830,2910,2990,3070,3150,900,940,980,1020,1060,1100,2750,2850,1437.5,1250,1305,750,350,300,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
...
species(
    label = 'O[CH]C1C2[CH]C=CC12(1964)',
...
species(
    ...
    molecularWeight = (108.138,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.78389,0.0351854,3.28005e-05,-5.74516e-08,2.12867e-11,31529.3,25.2872], Tmin=(100,'K'), Tmax=(1049.83,'K')), NASAPolynomial(coeffs=[10.2541,0.0358547,-1.52236e-05,2.93407e-09,-2.10824e-13,27935.5,-24.6345], Tmin=(1049.83,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(261.389,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(378.308,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-(Cds-O2d)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cds-OdCsH) + polycyclic(s2_3_5_ane) + radical(bicyclo[3.1.0]hexane-C5-2) + radical(CC(C)CJ=O)"""),
)

species(
    label = '[O]CC1C2C=[C]CC21(1967)',
    ...
    molecularWeight = (108.138,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.52678,0.0426278,1.30323e-05,-3.78482e-08,1.46277e-11,52530.7,23.9472], Tmin=(100,'K'), Tmax=(1079.05,'K')), NASAPolynomial(coeffs=[10.6378,0.0359363,-1.53138e-05,2.92503e-09,-2.07941e-13,48987.8,-28.007], Tmin=(1079.05,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(435.942,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(378.308,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + polycyclic(s2_3_5_ene_1) + radical(CCOJ) + radical(cyclopentene-vinyl)"""),
)

species(
    label = 'O[CH]C1C2C=[C]CC12(1968)',
    ...
    molecularWeight = (108.138,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.964256,0.0534098,-4.00847e-06,-3.20567e-08,1.56307e-11,47091.5,24.6484], Tmin=(100,'K'), Tmax=(1008.87,'K')), NASAPolynomial(coeffs=[14.988,0.0279085,-1.08469e-05,2.03599e-09,-1.46038e-13,42730,-50.7236], Tmin=(1008.87,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(390.535,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(374.151,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + polycyclic(s2_3_5_ene_1) + radical(CCsJOH) + radical(cyclopentene-vinyl)"""),
)
...
species(
    label = '[CH]=CCC1[CH]C1C=O(1971)',
    structure = SMILES('[CH]=CCC1[CH]C1C=O'),
    E0 = (424.131,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2950,3150,900,1000,1100,2782.5,750,1395,475,1775,1000,3010,987.5,1337.5,450,1655,3120,650,792.5,1650,2750,2850,1437.5,1250,1305,750,350,300,800,800,800,800,800,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
...
species(
    label = '[CH]1CC2C3[CH]OC1C32(1977)',
...
reaction(
    label = 'reaction290',
    reactants = ['H(3)(3)', 'O=CC1[C]2CC=CC21(1942)'],
...
reaction(
    label = 'reaction291',
    reactants = ['H(3)(3)', 'O=CC1[C]2C=CCC21(1943)'],
    products = ['C7H8O(562)(561)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction292',
    reactants = ['HCO(14)(15)', '[CH]1C2C=CCC12(1944)'],
    products = ['C7H8O(562)(561)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction293',
    reactants = ['H(3)(3)', 'O=C[C]1C2C=CCC12(1945)'],
    products = ['C7H8O(562)(561)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(2.92e+13,'cm^3/(mol*s)'), n=0.18, Ea=(0.518816,'kJ/mol'), T0=(1,'K'), Tmin=(200,'K'), Tmax=(2000,'K'), comment="""From training reaction 123 used for H_rad;C_rad/OneDeCs2
Exact match found for rate rule [C_rad/OneDeCs2;H_rad]
...
reaction(
    label = 'reaction294',
    reactants = ['H(3)(3)', 'O=CC1C2[CH]C=CC21(1946)'],
    products = ['C7H8O(562)(561)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction295',
    reactants = ['H(3)(3)', 'O=CC1C2[C]=CCC21(1947)'],
    products = ['C7H8O(562)(561)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction296',
    reactants = ['H(3)(3)', 'O=CC1C2C=[C]CC12(1948)'],
    products = ['C7H8O(562)(561)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(1e+13,'cm^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""From training reaction 40 used for Cd_rad/NonDe;H_rad
Exact match found for rate rule [Cd_rad/NonDe;H_rad]
...
reaction(
    label = 'reaction297',
    reactants = ['H(3)(3)', 'O=[C]C1C2C=CCC12(1949)'],
    products = ['C7H8O(562)(561)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['O=CC1[C]2C[CH]CC21(1950)'],
    products = ['C7H8O(562)(561)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction299',
    reactants = ['[O]C[C]1C2C=CCC12(1951)'],
    products = ['C7H8O(562)(561)'],
...
reaction(
    label = 'reaction300',
    reactants = ['O=CC1C2[CH]C[CH]C21(1952)'],
    products = ['C7H8O(562)(561)'],
...
reaction(
    label = 'reaction301',
    reactants = ['O=C[C]1C2C[CH]CC12(1953)'],
    products = ['C7H8O(562)(561)'],
...
reaction(
    label = 'reaction302',
    reactants = ['[O]CC1[C]2CC=CC21(1954)'],
    products = ['C7H8O(562)(561)'],
...
reaction(
    label = 'reaction303',
    reactants = ['[O]CC1[C]2C=CCC21(1955)'],
    products = ['C7H8O(562)(561)'],
...
reaction(
    label = 'reaction304',
    reactants = ['O=CC1[C]2CC[CH]C21(1956)'],
    products = ['C7H8O(562)(561)'],
...
reaction(
    label = 'reaction305',
    reactants = ['O=C[C]1C2[CH]CCC12(1957)'],
    products = ['C7H8O(562)(561)'],
...
reaction(
    label = 'reaction306',
    reactants = ['O[CH]C1[C]2CC=CC21(1958)'],
    products = ['C7H8O(562)(561)'],
...
reaction(
    label = 'reaction307',
    reactants = ['O[CH]C1[C]2C=CCC21(1959)'],
    products = ['C7H8O(562)(561)'],
...
reaction(
    label = 'reaction308',
    reactants = ['[O][CH]C1C2C=CCC12(1894)'],
    products = ['C7H8O(562)(561)'],
...
reaction(
    label = 'reaction309',
    reactants = ['[O]CC1C2[CH]C=CC21(1960)'],
    products = ['C7H8O(562)(561)'],
...
reaction(
    label = 'reaction310',
    reactants = ['O=CC1[C]2[CH]CCC21(1961)'],
    products = ['C7H8O(562)(561)'],
...
reaction(
    label = 'reaction311',
    reactants = ['[O]CC1C2[C]=CCC21(1962)'],
    products = ['C7H8O(562)(561)'],
...
reaction(
    label = 'reaction312',
    reactants = ['O=[C]C1C2C[CH]CC12(1963)'],
    products = ['C7H8O(562)(561)'],
...
reaction(
    label = 'reaction313',
    reactants = ['O[CH]C1C2[CH]C=CC12(1964)'],
    products = ['C7H8O(562)(561)'],
...
reaction(
    label = 'reaction314',
    reactants = ['O[CH]C1C2[C]=CCC21(1965)'],
    products = ['C7H8O(562)(561)'],
...
reaction(
    label = 'reaction315',
    reactants = ['O=[C]C1C2[CH]CCC12(1966)'],
    products = ['C7H8O(562)(561)'],
...
reaction(
    label = 'reaction316',
    reactants = ['[O]CC1C2C=[C]CC21(1967)'],
    products = ['C7H8O(562)(561)'],
...
reaction(
    label = 'reaction317',
    reactants = ['O[CH]C1C2C=[C]CC12(1968)'],
    products = ['C7H8O(562)(561)'],
...
reaction(
    label = 'reaction319',
    reactants = ['[O]C=CC1[CH]CC=C1(1917)'],
    products = ['C7H8O(562)(561)'],
...
reaction(
    label = 'reaction320',
    reactants = ['O=CC1[CH]C[CH]C=C1(1771)'],
    products = ['C7H8O(562)(561)'],
...
reaction(
    label = 'reaction321',
    reactants = ['[CH]=CC1C([CH2])C1C=O(1970)'],
    products = ['C7H8O(562)(561)'],
...
reaction(
    label = 'reaction322',
    reactants = ['[CH]=CCC1[CH]C1C=O(1971)'],
    products = ['C7H8O(562)(561)'],
...
reaction(
    label = 'reaction323',
    reactants = ['[CH2]C=CC1[CH]C1C=O(1836)'],
    products = ['C7H8O(562)(561)'],
...
reaction(
    label = 'reaction326',
    reactants = ['O=CC1C2[C]CCC21(1974)'],
    products = ['C7H8O(562)(561)'],
...
reaction(
    label = 'reaction327',
    reactants = ['O=CC1C2C[C]CC12(1975)'],
    products = ['C7H8O(562)(561)'],
...
reaction(
    label = 'reaction329',
    reactants = ['[CH]1CC2C3[CH]OC1C32(1977)'],
    products = ['C7H8O(562)(561)'],
...
reaction(
    label = 'reaction318',
    reactants = ['CO(10)(11)', 'C1=CC2CC2C1(1969)'],
    products = ['C7H8O(562)(561)'],
