...
species(
    ...
    molecularWeight = (114.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.45166,0.0670012,-3.07793e-05,5.79623e-09,-3.93695e-13,5395.24,27.8121], Tmin=(100,'K'), Tmax=(2979.59,'K')), NASAPolynomial(coeffs=[59.0595,-0.000330151,-1.24411e-06,1.63657e-10,-2.9689e-15,-32183.8,-313.544], Tmin=(2979.59,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(44.6912,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(CCOJ)"""),
)
...
species(
    ...
    molecularWeight = (114.185,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.414627,0.0858084,-7.16932e-05,4.21343e-08,-1.22057e-11,6795.54,34.5852], Tmin=(100,'K'), Tmax=(772.013,'K')), NASAPolynomial(coeffs=[4.60761,0.064083,-2.94802e-05,5.68061e-09,-4.0068e-13,6148.15,15.4415], Tmin=(772.013,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(55.4792,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(RCCJ)"""),
)

species(
    label = 'CCCCCC[CH][O](5422)',
...
species(
    ...
    E0 = (-200.13,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2950,3100,1380,975,1025,1650,3010,987.5,1337.5,450,1655,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,202.516,202.516,4000],'cm^-1')),
        HinderedRotor(inertia=(0.00411037,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.641098,'amu*angstrom^2'), symmetry=1, barrier=(18.6583,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.829414,'amu*angstrom^2'), symmetry=1, barrier=(24.1388,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.355041,'amu*angstrom^2'), symmetry=1, barrier=(10.333,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (86.1323,'amu'),
...
species(
    label = '[CH2][CH]CCCO(5564)',
    structure = SMILES('[CH2][CH]CCCO'),
    E0 = (71.7809,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,232.335,429.209,3053.67],'cm^-1')),
        HinderedRotor(inertia=(0.0616092,'amu*angstrom^2'), symmetry=1, barrier=(2.12763,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0616092,'amu*angstrom^2'), symmetry=1, barrier=(2.12763,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0616092,'amu*angstrom^2'), symmetry=1, barrier=(2.12763,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0616092,'amu*angstrom^2'), symmetry=1, barrier=(2.12763,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0616092,'amu*angstrom^2'), symmetry=1, barrier=(2.12763,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (86.1323,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.04563,0.0508585,-4.99509e-06,-7.24562e-08,6.95194e-11,8695.58,26.2403], Tmin=(100,'K'), Tmax=(476.143,'K')), NASAPolynomial(coeffs=[4.60446,0.0422669,-1.85823e-05,3.48843e-09,-2.41835e-13,8305.62,14.258], Tmin=(476.143,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(71.7809,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(RCCJC) + radical(RCCJ)"""),
)

species(
    label = '[CH2]C[CH]CCCO(5565)',
    structure = SMILES('[CH2]C[CH]CCCO'),
    E0 = (48.0127,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,248.592,860.646,1246.83,1858.76],'cm^-1')),
...
species(
    label = 'CC[CH][CH]CCCO(5567)',
    structure = SMILES('CC[CH][CH]CCCO'),
    E0 = (13.4443,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,3000,3050,390,425,1340,1360,335,370,2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,210.861,228.836,452.155,2016.59,3289.78],'cm^-1')),
...
species(
    label = 'CCC[CH]CO(5571)',
    structure = SMILES('CCC[CH]CO'),
    E0 = (-128.01,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    ...
    E0 = (151.298,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'CCC[C]CCCO(5577)',
    structure = SMILES('CCC[C]CCCO'),
    E0 = (72.7429,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2761.11,2772.22,2783.33,2794.44,2805.56,2816.67,2827.78,2838.89,2850,1425,1431.25,1437.5,1443.75,1450,1225,1237.5,1250,1262.5,1275,1270,1287.5,1305,1322.5,1340,700,725,750,775,800,300,325,350,375,400,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
reaction(
    label = 'reaction1',
    reactants = ['H(3)(3)', 'CCCCCCC=O(5412)'],
    products = ['S(192)(191)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['CH2O(13)(14)', 'C6H13(78)(77)'],
    products = ['S(192)(191)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['C3H7(69)(68)', '[CH2]CCC[O](5413)'],
    products = ['S(192)(191)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['C2H5(27)(28)', '[CH2]CCCC[O](5414)'],
    products = ['S(192)(191)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(8.73e+14,'cm^3/(mol*s)'), n=-0.699, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(200,'K'), Tmax=(2000,'K'), comment="""From training reaction 11 used for C_rad/H2/Cs;C_rad/H2/Cs
Exact match found for rate rule [C_rad/H2/Cs;C_rad/H2/Cs]
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)(3)', 'CC[CH]CCCC[O](5415)'],
    products = ['S(192)(191)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['C4H9(68)(67)', '[CH2]CC[O](5416)'],
    products = ['S(192)(191)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(8.73e+14,'cm^3/(mol*s)'), n=-0.699, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(200,'K'), Tmax=(2000,'K'), comment="""From training reaction 11 used for C_rad/H2/Cs;C_rad/H2/Cs
Exact match found for rate rule [C_rad/H2/Cs;C_rad/H2/Cs]
...
reaction(
    label = 'reaction7',
    reactants = ['H(3)(3)', 'CCC[CH]CCC[O](4270)'],
    products = ['S(192)(191)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(2e+13,'cm^3/(mol*s)','*|/',3.16), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), comment="""From training reaction 59 used for H_rad;C_rad/H/NonDeC
Exact match found for rate rule [C_rad/H/NonDeC;H_rad]
...
reaction(
    label = 'reaction8',
    reactants = ['C5H11(67)(66)', '[CH2]C[O](1432)'],
    products = ['S(192)(191)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(8.73e+14,'cm^3/(mol*s)'), n=-0.699, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(200,'K'), Tmax=(2000,'K'), comment="""From training reaction 11 used for C_rad/H2/Cs;C_rad/H2/Cs
Exact match found for rate rule [C_rad/H2/Cs;C_rad/H2/Cs]
...
reaction(
    label = 'reaction9',
    reactants = ['H(3)(3)', 'CCCC[CH]CC[O](5417)'],
    products = ['S(192)(191)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(2e+13,'cm^3/(mol*s)','*|/',3.16), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), comment="""From training reaction 59 used for H_rad;C_rad/H/NonDeC
Exact match found for rate rule [C_rad/H/NonDeC;H_rad]
...
reaction(
    label = 'reaction10',
    reactants = ['CH3(15)(16)', '[CH2]CCCCC[O](5418)'],
    products = ['S(192)(191)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(3)(3)', 'C[CH]CCCCC[O](5419)'],
    products = ['S(192)(191)'],
...
reaction(
    label = 'reaction12',
    reactants = ['C6H13(78)(77)', '[CH2][O](3706)'],
    products = ['S(192)(191)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(3)(3)', 'CCCCC[CH]C[O](5420)'],
    products = ['S(192)(191)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(3)(3)', '[CH2]CCCCCC[O](5421)'],
    products = ['S(192)(191)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(3)(3)', 'CCCCCC[CH][O](5422)'],
    products = ['S(192)(191)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CH2(S)(21)(22)', 'CCCCCC[O](5377)'],
    products = ['S(192)(191)'],
...
reaction(
    label = 'reaction25',
    reactants = ['H(3)(3)', 'CCC=CCCCO(5560)'],
    products = ['S(194)(193)'],
...
reaction(
    label = 'reaction26',
    reactants = ['H(3)(3)', 'CCCC=CCCO(5561)'],
    products = ['S(194)(193)'],
...
reaction(
    label = 'reaction27',
    reactants = ['C2H5(27)(28)', 'C=CCCCO(5562)'],
    products = ['S(194)(193)'],
...
reaction(
    label = 'reaction28',
    reactants = ['C5H10(82)(81)', 'C2H5O(41)(41)'],
    products = ['S(194)(193)'],
...
reaction(
    label = 'reaction35',
    reactants = ['OH(5)(5)', '[CH2]CC[CH]CCC(1005)'],
    products = ['S(194)(193)'],
...
reaction(
    label = 'reaction37',
    reactants = ['C2H5O(41)(41)', '[CH2][CH]CCC(1001)'],
    products = ['S(194)(193)'],
...
reaction(
    label = 'reaction38',
    reactants = ['CH2OH(22)(23)', '[CH2]C[CH]CCC(1002)'],
    products = ['S(194)(193)'],
...
reaction(
    label = 'reaction39',
    reactants = ['H(3)(3)', 'CCC[CH]C[CH]CO(5563)'],
    products = ['S(194)(193)'],
...
reaction(
    label = 'reaction40',
    reactants = ['C2H5(27)(28)', '[CH2][CH]CCCO(5564)'],
    products = ['S(194)(193)'],
...
reaction(
    label = 'reaction41',
    reactants = ['CH3(15)(16)', '[CH2]C[CH]CCCO(5565)'],
    products = ['S(194)(193)'],
...
reaction(
    label = 'reaction42',
    reactants = ['H(3)(3)', 'C[CH]C[CH]CCCO(5566)'],
    products = ['S(194)(193)'],
...
reaction(
    label = 'reaction43',
    reactants = ['H(3)(3)', 'CC[CH][CH]CCCO(5567)'],
    products = ['S(194)(193)'],
...
reaction(
    label = 'reaction44',
    reactants = ['H(3)(3)', 'CCC[CH][CH]CCO(5568)'],
    products = ['S(194)(193)'],
...
reaction(
    label = 'reaction45',
    reactants = ['H(3)(3)', 'CCC[CH]CC[CH]O(5569)'],
    products = ['S(194)(193)'],
...
reaction(
    label = 'reaction46',
    reactants = ['H(3)(3)', '[CH2]CC[CH]CCCO(5570)'],
    products = ['S(194)(193)'],
...
reaction(
    label = 'reaction47',
    reactants = ['H2O(7)(7)', 'C=CC[CH]CCC(5386)'],
    products = ['S(194)(193)'],
...
reaction(
    label = 'reaction48',
    reactants = ['C2H4(19)(20)', 'CCC[CH]CO(5571)'],
    products = ['S(194)(193)'],
...
reaction(
    label = 'reaction49',
    reactants = ['CH2(S)(21)(22)', 'CC[CH]CCCO(5572)'],
    products = ['S(194)(193)'],
...
reaction(
    label = 'reaction52',
    reactants = ['C3H7(69)(68)', '[CH]CCCO(5575)'],
    products = ['S(194)(193)'],
...
reaction(
    label = 'reaction53',
    reactants = ['[CH]CCC(1008)', 'CH2CH2CH2OH(5576)'],
    products = ['S(194)(193)'],
...
reaction(
    label = 'reaction54',
    reactants = ['H(3)(3)', 'CCC[C]CCCO(5577)'],
    products = ['S(194)(193)'],
...
network(
    ...
    reactants = [
        ('CH2O(13)(14)', 'C6H13(78)(77)'),
        ('O(4)(4)', 'C7H15(85)(84)'),
        ('C5H10(82)(81)', 'C2H5O(41)(41)'),
    ],
    bathGas = {
        'Ne': 0.333333,
        'N2': 0.333333,
