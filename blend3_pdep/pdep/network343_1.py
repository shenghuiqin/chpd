...
reaction(
    label = 'reaction1',
    reactants = ['H(3)(3)', 'CCCCCC(C)=O(5366)'],
    products = ['S(166)(165)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['C5H11(67)(66)', 'CH3CHO(35)(36)'],
    products = ['S(166)(165)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH3(15)(16)', 'CCCCCC=O(5367)'],
    products = ['S(166)(165)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['C4H9(68)(67)', '[CH2]C(C)[O](5368)'],
    products = ['S(166)(165)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['C5H11(67)(66)', 'C2H4O(197)(196)'],
    products = ['S(166)(165)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['H(3)(3)', 'CCCC[CH]C(C)[O](5369)'],
    products = ['S(166)(165)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['C3H7(69)(68)', '[CH2]CC(C)[O](4520)'],
    products = ['S(166)(165)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(8.73e+14,'cm^3/(mol*s)'), n=-0.699, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(200,'K'), Tmax=(2000,'K'), comment="""From training reaction 11 used for C_rad/H2/Cs;C_rad/H2/Cs
Exact match found for rate rule [C_rad/H2/Cs;C_rad/H2/Cs]
...
reaction(
    label = 'reaction8',
    reactants = ['H(3)(3)', 'CCC[CH]CC(C)[O](5370)'],
    products = ['S(166)(165)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(2e+13,'cm^3/(mol*s)','*|/',3.16), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), comment="""From training reaction 59 used for H_rad;C_rad/H/NonDeC
Exact match found for rate rule [C_rad/H/NonDeC;H_rad]
...
reaction(
    label = 'reaction9',
    reactants = ['C2H5(27)(28)', '[CH2]CCC(C)[O](5371)'],
    products = ['S(166)(165)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(8.73e+14,'cm^3/(mol*s)'), n=-0.699, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(200,'K'), Tmax=(2000,'K'), comment="""From training reaction 11 used for C_rad/H2/Cs;C_rad/H2/Cs
Exact match found for rate rule [C_rad/H2/Cs;C_rad/H2/Cs]
...
reaction(
    label = 'reaction10',
    reactants = ['H(3)(3)', 'CC[CH]CCC(C)[O](3955)'],
    products = ['S(166)(165)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CH3(15)(16)', 'CCCCC[CH][O](5372)'],
    products = ['S(166)(165)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(3)(3)', 'CCCCC[C](C)[O](5373)'],
    products = ['S(166)(165)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CH3(15)(16)', '[CH2]CCCC(C)[O](5374)'],
    products = ['S(166)(165)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(3)(3)', 'C[CH]CCCC(C)[O](3972)'],
    products = ['S(166)(165)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(3)(3)', '[CH2]C([O])CCCCC(5375)'],
    products = ['S(166)(165)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(3)(3)', '[CH2]CCCCC(C)[O](5376)'],
    products = ['S(166)(165)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CH2(S)(21)(22)', 'CCCCC(C)[O](5378)'],
    products = ['S(166)(165)'],
...
network(
    ...
    reactants = [
        ('C5H11(67)(66)', 'CH3CHO(35)(36)'),
        ('C5H11(67)(66)', 'C2H4O(197)(196)'),
        ('O(4)(4)', 'C7H15(71)(70)'),
    ],
    bathGas = {
        'Ne': 0.333333,
