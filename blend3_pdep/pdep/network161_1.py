...
species(
    label = '[CH]=COC1[CH]CC=C1(1799)',
    structure = SMILES('[CH]=COC1[CH]CC=C1'),
    E0 = (367.253,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,2750,2830,2910,2990,3070,3150,900,940,980,1020,1060,1100,3010,987.5,1337.5,450,1655,300,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
...
species(
    ...
    molecularWeight = (108.138,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.03307,0.0378059,7.3578e-05,-1.42249e-07,6.40551e-11,43327.8,25.3163], Tmin=(100,'K'), Tmax=(901.806,'K')), NASAPolynomial(coeffs=[24.3838,0.00705611,3.59616e-06,-9.68764e-10,6.53447e-14,36155,-101.342], Tmin=(901.806,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(359.145,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(374.151,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + ring(2,3-Dihydrofuran) + radical(Isobutyl) + radical(Cds_P)"""),
)

species(
    label = '[CH]=CCC1[CH]OC=C1(1802)',
...
species(
    label = '[CH]1C2CC3C1O[CH]C23(1808)',
    ...
    molecularWeight = (108.138,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.91414,0.0333016,3.73317e-05,-5.61168e-08,1.80442e-11,47131.8,13.0637], Tmin=(100,'K'), Tmax=(1204.31,'K')), NASAPolynomial(coeffs=[11.8948,0.040542,-2.19936e-05,4.57217e-09,-3.35053e-13,41798.8,-49.103], Tmin=(1204.31,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(391.168,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + polycyclic(s2_5_5_ane) + polycyclic(s2_4_5_ane) + polycyclic(s3_4_5_ane) - ring(Cyclopentane) - ring(Cyclobutane) - ring(Tetrahydrofuran) + radical(CCsJOCs) + radical(CCJCO)"""),
)

species(
    label = '[CH]1C2CC3[CH]C2OC13(1809)',
    ...
    molecularWeight = (108.138,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.63779,0.0149146,8.42213e-05,-9.70006e-08,2.94464e-11,40922.8,14.3029], Tmin=(100,'K'), Tmax=(1204.72,'K')), NASAPolynomial(coeffs=[11.4433,0.0452582,-2.77427e-05,6.00917e-09,-4.48703e-13,34477.6,-47.7628], Tmin=(1204.72,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(339.746,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + polycyclic(s2_5_5_ane) + polycyclic(s3_5_5_ane) + polycyclic(s3_5_5_ane) - ring(Cyclopentane) - ring(Tetrahydrofuran) - ring(Tetrahydrofuran) + radical(CCJCO) + radical(CCJCO)"""),
)

species(
    label = '[CH]1C2C[CH]C3C1OC23(1810)',
...
reaction(
    label = 'reaction55',
    reactants = ['H(3)(3)', 'C1=CC2OC=C[C]2C1(1772)'],
...
reaction(
    label = 'reaction56',
    reactants = ['H(3)(3)', 'C1=C[C]2OC=CC2C1(1773)'],
    products = ['C7H8O(549)(548)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction57',
    reactants = ['H(3)(3)', '[CH]1C=CC2OC=CC12(1774)'],
    products = ['C7H8O(549)(548)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction58',
    reactants = ['H(3)(3)', '[C]1=COC2C=CCC12(1775)'],
    products = ['C7H8O(549)(548)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction59',
    reactants = ['H(3)(3)', '[C]1=CCC2C=COC12(1776)'],
    products = ['C7H8O(549)(548)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(1e+13,'cm^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""From training reaction 40 used for Cd_rad/NonDe;H_rad
Exact match found for rate rule [Cd_rad/NonDe;H_rad]
...
reaction(
    label = 'reaction60',
    reactants = ['H(3)(3)', '[C]1=CC2OC=CC2C1(1777)'],
    products = ['C7H8O(549)(548)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(1e+13,'cm^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""From training reaction 40 used for Cd_rad/NonDe;H_rad
Exact match found for rate rule [Cd_rad/NonDe;H_rad]
...
reaction(
    label = 'reaction61',
    reactants = ['H(3)(3)', '[C]1=CC2CC=CC2O1(1778)'],
    products = ['C7H8O(549)(548)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(1e+13,'cm^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""From training reaction 40 used for Cd_rad/NonDe;H_rad
...
reaction(
    label = 'reaction62',
    reactants = ['[CH]1C[C]2CC=CC2O1(1779)'],
    products = ['C7H8O(549)(548)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction63',
    reactants = ['[CH]1C[C]2OC=CC2C1(1780)'],
    products = ['C7H8O(549)(548)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(5.10299e+10,'s^-1'), n=0.2847, Ea=(23.1459,'kJ/mol'), T0=(1,'K'), comment="""Estimated using average of templates [Rn;Y_rad_NDe;XH_Rrad_NDe] + [R2radExo;Y_rad;XH_Rrad_NDe] for rate rule [R2radExo;Y_rad_NDe;XH_Rrad_NDe]
Euclidian distance = 1.0
...
reaction(
    label = 'reaction64',
    reactants = ['[CH]1C[CH]C2OC=CC12(1781)'],
    products = ['C7H8O(549)(548)'],
...
reaction(
    label = 'reaction65',
    reactants = ['[CH]1CO[C]2C=CCC12(1782)'],
    products = ['C7H8O(549)(548)'],
...
reaction(
    label = 'reaction66',
    reactants = ['[CH]1CC2CC=C[C]2O1(1783)'],
    products = ['C7H8O(549)(548)'],
...
reaction(
    label = 'reaction67',
    reactants = ['[CH]1CC2[CH]C=CC2O1(1784)'],
    products = ['C7H8O(549)(548)'],
...
reaction(
    label = 'reaction68',
    reactants = ['[CH]1C[C]2C=COC2C1(1785)'],
    products = ['C7H8O(549)(548)'],
...
reaction(
    label = 'reaction69',
    reactants = ['[CH]1CC[C]2C=COC12(1786)'],
    products = ['C7H8O(549)(548)'],
...
reaction(
    label = 'reaction70',
    reactants = ['[CH]1C=CC2OC[CH]C12(1787)'],
    products = ['C7H8O(549)(548)'],
...
reaction(
    label = 'reaction71',
    reactants = ['[C]1=CC2C[CH]CC2O1(1788)'],
    products = ['C7H8O(549)(548)'],
...
reaction(
    label = 'reaction72',
    reactants = ['[CH]1[CH]C2C=COC2C1(1789)'],
    products = ['C7H8O(549)(548)'],
...
reaction(
    label = 'reaction73',
    reactants = ['[C]1=COC2C[CH]CC12(1790)'],
    products = ['C7H8O(549)(548)'],
...
reaction(
    label = 'reaction74',
    reactants = ['[CH]1CCC2C=CO[C]12(1791)'],
    products = ['C7H8O(549)(548)'],
...
reaction(
    label = 'reaction75',
    reactants = ['[C]1=COC2[CH]CCC12(1792)'],
    products = ['C7H8O(549)(548)'],
...
reaction(
    label = 'reaction76',
    reactants = ['[CH]1COC2C=CC[C]12(1793)'],
    products = ['C7H8O(549)(548)'],
...
reaction(
    label = 'reaction77',
    reactants = ['[C]1=CCC2[CH]COC12(1794)'],
    products = ['C7H8O(549)(548)'],
...
reaction(
    label = 'reaction78',
    reactants = ['[C]1=CCC2C[CH]OC12(1795)'],
    products = ['C7H8O(549)(548)'],
...
reaction(
    label = 'reaction79',
    reactants = ['[C]1=CC2O[CH]CC2C1(1796)'],
    products = ['C7H8O(549)(548)'],
...
reaction(
    label = 'reaction80',
    reactants = ['[C]1=CC2CC[CH]C2O1(1797)'],
    products = ['C7H8O(549)(548)'],
...
reaction(
    label = 'reaction81',
    reactants = ['[C]1=CC2OC[CH]C2C1(1798)'],
    products = ['C7H8O(549)(548)'],
...
reaction(
    label = 'reaction82',
    reactants = ['[CH]=COC1[CH]CC=C1(1799)'],
    products = ['C7H8O(549)(548)'],
...
reaction(
    label = 'reaction84',
    reactants = ['[CH]=CC1OC=CC1[CH2](1801)'],
    products = ['C7H8O(549)(548)'],
...
reaction(
    label = 'reaction85',
    reactants = ['[CH]=CCC1[CH]OC=C1(1802)'],
    products = ['C7H8O(549)(548)'],
...
reaction(
    label = 'reaction92',
    reactants = ['[C-]1CC2CC=CC2[O+]=1(1806)'],
    products = ['C7H8O(549)(548)'],
...
reaction(
    label = 'reaction94',
    reactants = ['[CH]1C2CC3C1O[CH]C23(1808)'],
    products = ['C7H8O(549)(548)'],
...
reaction(
    label = 'reaction95',
    reactants = ['[CH]1C2CC3[CH]C2OC13(1809)'],
    products = ['C7H8O(549)(548)'],
...
reaction(
    label = 'reaction96',
    reactants = ['[CH]1C2C[CH]C3C1OC23(1810)'],
    products = ['C7H8O(549)(548)'],
