...
species(
    label = '[CH]=CC([O])C=CC=C(1555)',
    structure = SMILES('[CH]=CC([O])C=CC=C'),
    E0 = (440.145,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,3100,1380,975,1025,1650,1380,1390,370,380,2900,435,3120,650,792.5,1650,2995,3005,3015,3025,975,983.333,991.667,1000,1300,1325,1350,1375,400,433.333,466.667,500,1630,1646.67,1663.33,1680,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.822386,'amu*angstrom^2'), symmetry=1, barrier=(18.9083,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.820818,'amu*angstrom^2'), symmetry=1, barrier=(18.8722,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.82367,'amu*angstrom^2'), symmetry=1, barrier=(18.9378,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (108.138,'amu'),
...
species(
    ...
    molecularWeight = (108.138,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.03843,0.0523384,-1.23935e-06,-3.34291e-08,1.58355e-11,38347.3,26.1509], Tmin=(100,'K'), Tmax=(1005.04,'K')), NASAPolynomial(coeffs=[13.8624,0.0302899,-1.15992e-05,2.14273e-09,-1.51875e-13,34305.5,-43.0658], Tmin=(1005.04,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(317.858,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(378.308,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)(Cds-Cds)CsH) + group(Cs-(Cds-Cds)(Cds-Cds)OsH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(1,4-Cyclohexadiene) + radical(Isobutyl) + radical(CC(C)OJ)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)(3)', '[O]C1C=C=CCC=C1(1525)'],
    products = ['C7H8O(572)(571)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction12',
    reactants = ['C7H8O(572)(571)'],
    products = ['[CH]1CC=CC2[CH]C1O2(1529)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH]=CCC=C[CH]C=O(1530)'],
    products = ['C7H8O(572)(571)'],
...
reaction(
    label = 'reaction14',
    reactants = ['C7H8O(572)(571)'],
    products = ['O[C]1[CH]C=CCC=C1(1531)'],
...
reaction(
    label = 'reaction24',
    reactants = ['C7H8O(572)(571)'],
    products = ['OC1[CH]C=C[CH]C=C1(1540)'],
...
reaction(
    label = 'reaction26',
    reactants = ['C7H8O(572)(571)'],
    products = ['[O]C1C=CCC2[CH]C12(1542)'],
...
reaction(
    label = 'reaction27',
    reactants = ['C7H8O(572)(571)'],
    products = ['[CH]1C=CCC2[CH]C1O2(1543)'],
...
reaction(
    label = 'reaction28',
    reactants = ['C7H8O(572)(571)'],
    products = ['[O]C1[CH]C2CC=CC12(1544)'],
...
reaction(
    label = 'reaction30',
    reactants = ['C7H8O(572)(571)'],
    products = ['[O]C1C2[CH]CC=CC12(1545)'],
...
reaction(
    label = 'reaction31',
    reactants = ['C7H8O(572)(571)'],
    products = ['[CH]1C=CC2OC2[CH]C1(1467)'],
...
reaction(
    label = 'reaction32',
    reactants = ['[O][CH]C1C=CCC=C1(1546)'],
    products = ['C7H8O(572)(571)'],
...
reaction(
    label = 'reaction33',
    reactants = ['O(4)(4)', '[CH]1[CH]CC=CC=C1(1035)'],
    products = ['C7H8O(572)(571)'],
...
reaction(
    label = 'reaction34',
    reactants = ['[CH]=C[CH]CC=CC=O(1547)'],
    products = ['C7H8O(572)(571)'],
...
reaction(
    label = 'reaction39',
    reactants = ['C7H8O(572)(571)'],
    products = ['[O]C1C=CC2C[CH]C12(1552)'],
...
reaction(
    label = 'reaction40',
    reactants = ['C7H8O(572)(571)'],
    products = ['[O]C1[CH]C2CC2C=C1(1553)'],
...
reaction(
    label = 'reaction41',
    reactants = ['C7H8O(572)(571)'],
    products = ['[CH]1[CH]C2OC2C=CC1(1554)'],
...
reaction(
    label = 'reaction43',
    reactants = ['[CH2]C1C=CC([O])C=C1(1556)'],
    products = ['C7H8O(572)(571)'],
