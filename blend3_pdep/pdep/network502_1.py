...
species(
    ...
    molecularWeight = (108.138,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.23072,0.0390661,4.9074e-05,-9.6759e-08,4.10405e-11,44162.2,28.9995], Tmin=(100,'K'), Tmax=(956.73,'K')), NASAPolynomial(coeffs=[18.8794,0.0197437,-6.02381e-06,1.13708e-09,-8.88756e-14,38292.5,-68.3915], Tmin=(956.73,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(366.192,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(378.308,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + polycyclic(s2_4_5_ene_0) + radical(C2CsJOH) + radical(CCJCO)"""),
)

species(
    label = 'OC1=[C]C2CC[CH]C12(2271)',
...
species(
    ...
    molecularWeight = (108.138,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.702779,0.0581773,-1.03103e-05,-3.18885e-08,1.7272e-11,37805.4,26.9461], Tmin=(100,'K'), Tmax=(980.148,'K')), NASAPolynomial(coeffs=[17.3423,0.0236175,-8.45335e-06,1.55924e-09,-1.12786e-13,32941.8,-61.1672], Tmin=(980.148,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(313.238,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(374.151,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)(Cds-Cds)CsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Cyclopentene) + radical(Cds_P) + radical(cyclopentene-4)"""),
)
...
species(
    label = 'O[C]1C2[CH]C3CC2C13(2284)',
    ...
    molecularWeight = (108.138,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.88619,0.0436148,-4.17593e-06,-1.16219e-08,3.81217e-12,51698.5,14.3808], Tmin=(100,'K'), Tmax=(1469.78,'K')), NASAPolynomial(coeffs=[10.6968,0.0384897,-1.81861e-05,3.46011e-09,-2.37616e-13,47072.2,-38.446], Tmin=(1469.78,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(429.196,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(378.308,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + polycyclic(s3_4_5_ane) + polycyclic(s2_4_5_ane) + polycyclic(s2_4_4_ane) - ring(Cyclopentane) - ring(Cyclobutane) - ring(Cyclobutane) + radical(C2CsJOH) + radical(bicyclo[2.1.1]hexane-C2)"""),
)
...
species(
    label = 'OC12[CH]C3C[CH]C1C32(2286)',
...
species(
    ...
    molecularWeight = (108.138,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.98403,0.0418431,-8.9354e-07,-1.3796e-08,4.30186e-12,54826.6,12.7612], Tmin=(100,'K'), Tmax=(1462.76,'K')), NASAPolynomial(coeffs=[10.0977,0.0394336,-1.87039e-05,3.5646e-09,-2.45038e-13,50337.1,-36.7007], Tmin=(1462.76,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(455.237,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(378.308,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + polycyclic(s2_4_5_ane) + polycyclic(s2_4_5_ane) + polycyclic(s3_4_4_ane) - ring(Cyclobutane) - ring(Cyclobutane) - ring(Cyclopentane) + radical(C2CsJOH) + radical(bicyclo[2.1.1]hexane-C2)"""),
)

species(
    label = 'O=C1CC2CC=CC12(2279)',
...
reaction(
    label = 'reaction756',
    reactants = ['OH(5)(5)', '[C]1=CC2CC=CC12(1720)'],
...
reaction(
    label = 'reaction758',
    reactants = ['H(3)(3)', 'OC1=C[C]2CC=CC21(2251)'],
    products = ['C7H8O(586)(585)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction759',
    reactants = ['H(3)(3)', 'OC1=CC2CC=C[C]12(2252)'],
    products = ['C7H8O(586)(585)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction761',
    reactants = ['H(3)(3)', 'OC1=[C]C2CC=CC12(2254)'],
    products = ['C7H8O(586)(585)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction762',
    reactants = ['H(3)(3)', 'OC1=CC2CC=[C]C12(2255)'],
    products = ['C7H8O(586)(585)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(1e+13,'cm^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""From training reaction 40 used for Cd_rad/NonDe;H_rad
Exact match found for rate rule [Cd_rad/NonDe;H_rad]
...
reaction(
    label = 'reaction763',
    reactants = ['H(3)(3)', 'OC1=CC2C[C]=CC12(2256)'],
    products = ['C7H8O(586)(585)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(1e+13,'cm^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""From training reaction 40 used for Cd_rad/NonDe;H_rad
Exact match found for rate rule [Cd_rad/NonDe;H_rad]
...
reaction(
    label = 'reaction764',
    reactants = ['[O]C1[CH]C2CC=CC12(1544)'],
    products = ['C7H8O(586)(585)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction765',
    reactants = ['O[C]1C[C]2CC=CC12(2257)'],
    products = ['C7H8O(586)(585)'],
...
reaction(
    label = 'reaction766',
    reactants = ['OC1[CH]C2CC=C[C]12(2258)'],
    products = ['C7H8O(586)(585)'],
...
reaction(
    label = 'reaction769',
    reactants = ['O[C]1CC2CC=C[C]12(2260)'],
    products = ['C7H8O(586)(585)'],
...
reaction(
    label = 'reaction771',
    reactants = ['OC1[CH][C]2CC=CC21(2262)'],
    products = ['C7H8O(586)(585)'],
...
reaction(
    label = 'reaction773',
    reactants = ['OC1[CH]C2CC=[C]C12(2264)'],
    products = ['C7H8O(586)(585)'],
...
reaction(
    label = 'reaction774',
    reactants = ['OC1=C[C]2CC[CH]C21(2265)'],
    products = ['C7H8O(586)(585)'],
...
reaction(
    label = 'reaction776',
    reactants = ['O[C]1CC2CC=[C]C12(2267)'],
    products = ['C7H8O(586)(585)'],
...
reaction(
    label = 'reaction777',
    reactants = ['OC1=CC2[CH][CH]CC12(2268)'],
    products = ['C7H8O(586)(585)'],
...
reaction(
    label = 'reaction779',
    reactants = ['OC1=CC2CC[CH][C]12(2270)'],
    products = ['C7H8O(586)(585)'],
...
reaction(
    label = 'reaction780',
    reactants = ['OC1=[C]C2CC[CH]C12(2271)'],
    products = ['C7H8O(586)(585)'],
...
reaction(
    label = 'reaction781',
    reactants = ['O[C]1CC2C[C]=CC12(2272)'],
    products = ['C7H8O(586)(585)'],
...
reaction(
    label = 'reaction783',
    reactants = ['OC1[CH]C2C[C]=CC12(2274)'],
    products = ['C7H8O(586)(585)'],
...
reaction(
    label = 'reaction784',
    reactants = ['[O]C1=CC2CC[CH]C12(2275)'],
    products = ['C7H8O(586)(585)'],
...
reaction(
    label = 'reaction786',
    reactants = ['[CH]=C(O)C1[CH]CC=C1(2276)'],
    products = ['C7H8O(586)(585)'],
...
reaction(
    label = 'reaction788',
    reactants = ['[CH]=CC1C(O)=CC1[CH2](2277)'],
    products = ['C7H8O(586)(585)'],
...
reaction(
    label = 'reaction789',
    reactants = ['[CH]=CCC1[CH]C(O)=C1(2278)'],
    products = ['C7H8O(586)(585)'],
...
reaction(
    label = 'reaction790',
    reactants = ['[CH2]C=CC1C=C[C]1O(2242)'],
    products = ['C7H8O(586)(585)'],
...
reaction(
    label = 'reaction792',
    reactants = ['OC1[C]C2CC=CC12(2280)'],
    products = ['C7H8O(586)(585)'],
...
reaction(
    label = 'reaction793',
    reactants = ['OC1=CC2CC[C]C12(2281)'],
    products = ['C7H8O(586)(585)'],
...
reaction(
    label = 'reaction797',
    reactants = ['O[C]1C2[CH]C3CC2C13(2284)'],
    products = ['C7H8O(586)(585)'],
...
reaction(
    label = 'reaction799',
    reactants = ['OC12[CH]C3C[CH]C1C32(2286)'],
    products = ['C7H8O(586)(585)'],
...
reaction(
    label = 'reaction800',
    reactants = ['O[C]1C2C3[CH]CC2C13(2287)'],
    products = ['C7H8O(586)(585)'],
