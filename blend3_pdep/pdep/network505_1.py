...
species(
    ...
    molecularWeight = (108.138,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.13708,0.0372912,6.70899e-05,-1.20249e-07,5.01495e-11,28296.6,21.9055], Tmin=(100,'K'), Tmax=(954.92,'K')), NASAPolynomial(coeffs=[20.7973,0.0192715,-5.6606e-06,1.09225e-09,-8.83936e-14,21608.6,-87.3952], Tmin=(954.92,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(234.22,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(378.308,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + polycyclic(s2_4_5_ene_0) + radical(C=CCJCO) + radical(cyclopentene-allyl)"""),
)

species(
    label = 'OC1[CH]C2[CH]C=CC12(2266)',
...
species(
    ...
    molecularWeight = (108.138,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.52594,0.0373319,3.99483e-05,-7.37438e-08,2.91551e-11,30927,20.3218], Tmin=(100,'K'), Tmax=(1001.37,'K')), NASAPolynomial(coeffs=[13.5817,0.030662,-1.2206e-05,2.35195e-09,-1.72162e-13,26432.5,-48.2426], Tmin=(1001.37,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(256.276,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(378.308,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + polycyclic(s2_4_5_ene_1) + radical(cyclopentene-allyl) + radical(C2CsJOH)"""),
)

species(
    label = 'OC1=[C]C2[CH]CCC12(2372)',
...
species(
    ...
    molecularWeight = (108.138,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.00096,0.031761,3.76068e-05,-5.70753e-08,1.98234e-11,30962.9,21.1624], Tmin=(100,'K'), Tmax=(1083.12,'K')), NASAPolynomial(coeffs=[8.01453,0.0406002,-1.76319e-05,3.38978e-09,-2.41439e-13,27839.1,-16.7367], Tmin=(1083.12,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(256.757,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-(Cds-O2d)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cds-OdCsCs) + polycyclic(s2_4_5_ane) + radical(CCJC=O) + radical(cyclopentane)"""),
)

species(
    label = '[O]C1=CC2[CH]CCC12(2378)',
...
species(
    label = '[CH2]C=CC1[CH]C(O)=C1(2382)',
    structure = SMILES('[CH2]C=CC1[CH]C(O)=C1'),
    E0 = (316.986,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2950,3150,900,1000,1100,3000,3100,440,815,1455,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
...
species(
    label = 'OC12[CH]C3[CH]C1CC32(2386)',
...
species(
    label = 'O[C]1C2C[CH]C3C1C23(2387)',
...
reaction(
    label = 'reaction890',
    reactants = ['OH(5)(5)', '[C]1=CC2C=CCC12(1718)'],
...
reaction(
    label = 'reaction891',
    reactants = ['H(3)(3)', '[O]C1=CC2C=CCC12(2359)'],
    products = ['C7H8O(592)(591)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction892',
    reactants = ['H(3)(3)', 'OC1=CC2C=CC[C]12(2360)'],
    products = ['C7H8O(592)(591)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction893',
    reactants = ['H(3)(3)', 'OC1=C[C]2C=CCC21(2361)'],
    products = ['C7H8O(592)(591)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction894',
    reactants = ['H(3)(3)', 'OC1=CC2[CH]C=CC12(2253)'],
    products = ['C7H8O(592)(591)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction895',
    reactants = ['H(3)(3)', 'OC1=[C]C2C=CCC12(2362)'],
    products = ['C7H8O(592)(591)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction896',
    reactants = ['H(3)(3)', 'OC1=CC2[C]=CCC12(2363)'],
    products = ['C7H8O(592)(591)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(1e+13,'cm^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""From training reaction 40 used for Cd_rad/NonDe;H_rad
Exact match found for rate rule [Cd_rad/NonDe;H_rad]
...
reaction(
    label = 'reaction897',
    reactants = ['H(3)(3)', 'OC1=CC2C=[C]CC12(2364)'],
    products = ['C7H8O(592)(591)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(1e+13,'cm^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""From training reaction 40 used for Cd_rad/NonDe;H_rad
Exact match found for rate rule [Cd_rad/NonDe;H_rad]
...
reaction(
    label = 'reaction898',
    reactants = ['[O]C1[CH]C2C=CCC12(2365)'],
    products = ['C7H8O(592)(591)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction899',
    reactants = ['OC1[CH]C2C=CC[C]12(2366)'],
    products = ['C7H8O(592)(591)'],
...
reaction(
    label = 'reaction900',
    reactants = ['O[C]1C[C]2C=CCC12(2367)'],
    products = ['C7H8O(592)(591)'],
...
reaction(
    label = 'reaction901',
    reactants = ['OC1=C[C]2C[CH]CC21(2263)'],
    products = ['C7H8O(592)(591)'],
...
reaction(
    label = 'reaction903',
    reactants = ['OC1[CH][C]2C=CCC21(2368)'],
    products = ['C7H8O(592)(591)'],
...
reaction(
    label = 'reaction904',
    reactants = ['OC1[CH]C2[CH]C=CC12(2266)'],
    products = ['C7H8O(592)(591)'],
...
reaction(
    label = 'reaction905',
    reactants = ['O[C]1CC2C=CC[C]12(2369)'],
    products = ['C7H8O(592)(591)'],
...
reaction(
    label = 'reaction906',
    reactants = ['OC1=CC2C[CH]C[C]12(2259)'],
    products = ['C7H8O(592)(591)'],
...
reaction(
    label = 'reaction907',
    reactants = ['OC1=[C]C2C[CH]CC12(2269)'],
    products = ['C7H8O(592)(591)'],
...
reaction(
    label = 'reaction908',
    reactants = ['O[C]1CC2[C]=CCC12(2370)'],
    products = ['C7H8O(592)(591)'],
...
reaction(
    label = 'reaction909',
    reactants = ['OC1=CC2[CH]CC[C]12(2371)'],
    products = ['C7H8O(592)(591)'],
...
reaction(
    label = 'reaction910',
    reactants = ['O[C]1CC2[CH]C=CC12(2261)'],
    products = ['C7H8O(592)(591)'],
...
reaction(
    label = 'reaction911',
    reactants = ['OC1=[C]C2[CH]CCC12(2372)'],
    products = ['C7H8O(592)(591)'],
...
reaction(
    label = 'reaction912',
    reactants = ['OC1[CH]C2[C]=CCC12(2373)'],
    products = ['C7H8O(592)(591)'],
...
reaction(
    label = 'reaction913',
    reactants = ['OC1=CC2C[CH][CH]C12(2374)'],
    products = ['C7H8O(592)(591)'],
...
reaction(
    label = 'reaction914',
    reactants = ['OC1=C[C]2[CH]CCC21(2375)'],
    products = ['C7H8O(592)(591)'],
...
reaction(
    label = 'reaction915',
    reactants = ['OC1[CH]C2C=[C]CC12(2376)'],
    products = ['C7H8O(592)(591)'],
...
reaction(
    label = 'reaction916',
    reactants = ['O[C]1CC2C=[C]CC12(2377)'],
    products = ['C7H8O(592)(591)'],
...
reaction(
    label = 'reaction917',
    reactants = ['[O]C1=CC2C[CH]CC12(2273)'],
    products = ['C7H8O(592)(591)'],
...
reaction(
    label = 'reaction918',
    reactants = ['[O]C1=CC2[CH]CCC12(2378)'],
    products = ['C7H8O(592)(591)'],
...
reaction(
    label = 'reaction919',
    reactants = ['[CH]=C(O)C1[CH]C=CC1(2379)'],
    products = ['C7H8O(592)(591)'],
...
reaction(
    label = 'reaction920',
    reactants = ['O[C]=CC1[CH]CC=C1(2380)'],
    products = ['C7H8O(592)(591)'],
...
reaction(
    label = 'reaction922',
    reactants = ['[CH]=CC1C=C(O)C1[CH2](2381)'],
    products = ['C7H8O(592)(591)'],
...
reaction(
    label = 'reaction924',
    reactants = ['[CH2]C=CC1[CH]C(O)=C1(2382)'],
    products = ['C7H8O(592)(591)'],
...
reaction(
    label = 'reaction926',
    reactants = ['OC1[C]C2C=CCC12(2384)'],
    products = ['C7H8O(592)(591)'],
...
reaction(
    label = 'reaction927',
    reactants = ['OC1=CC2[C]CCC12(2385)'],
    products = ['C7H8O(592)(591)'],
...
reaction(
    label = 'reaction928',
    reactants = ['OC1=CC2C[C]CC12(2282)'],
    products = ['C7H8O(592)(591)'],
...
reaction(
    label = 'reaction930',
    reactants = ['OC12[CH]C3[CH]C1CC32(2386)'],
    products = ['C7H8O(592)(591)'],
...
reaction(
    label = 'reaction932',
    reactants = ['O[C]1C2C[CH]C3C1C23(2387)'],
    products = ['C7H8O(592)(591)'],
...
reaction(
    label = 'reaction929',
    reactants = ['C=CC1C2C=C(O)C12(2247)'],
    products = ['C7H8O(592)(591)'],
