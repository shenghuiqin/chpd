...
species(
    ...
    E0 = (62.7482,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,3100,1380,975,1025,1650,2750,2950,3150,900,1000,1100,3010,987.5,1337.5,450,1655,300,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
species(
    ...
    E0 = (388.374,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,3100,1380,975,1025,1650,1380,1390,370,380,2900,435,3120,650,792.5,1650,2995,3025,975,1000,1300,1375,400,500,1630,1680,358.763,358.831],'cm^-1')),
        HinderedRotor(inertia=(0.174049,'amu*angstrom^2'), symmetry=1, barrier=(15.8975,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.173951,'amu*angstrom^2'), symmetry=1, barrier=(15.8976,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (82.1005,'amu'),
...
species(
    label = 'O=[C]C1C=CC1(6705)',
    structure = SMILES('O=[C]C1C=CC1'),
    E0 = (189.681,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,2950,3050,3150,900,950,1000,1050,1100,1855,455,950,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
species(
    ...
    molecularWeight = (82.1005,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.64532,0.0184042,4.16974e-05,-6.0007e-08,2.20335e-11,34850.3,23.0182], Tmin=(100,'K'), Tmax=(1012.13,'K')), NASAPolynomial(coeffs=[8.22372,0.0248606,-1.01127e-05,1.94269e-09,-1.40831e-13,32261.1,-11.1737], Tmin=(1012.13,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(289.273,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(278.535,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cds-OdCsH) + ring(Cyclobutane) + radical(CCJCC=O) + radical(cyclobutane)"""),
)
...
species(
    ...
    molecularWeight = (82.1005,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.95665,0.0319234,2.05449e-05,-5.18143e-08,2.27308e-11,35893.8,19.0863], Tmin=(100,'K'), Tmax=(960.21,'K')), NASAPolynomial(coeffs=[13.3625,0.0164771,-5.42025e-06,9.93424e-10,-7.36032e-14,32225.1,-43.1749], Tmin=(960.21,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(297.729,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cyclobutene) + radical(CCsJOH) + radical(cyclobutene-allyl)"""),
)

species(
    label = 'O[CH]C1[C]=CC1(6715)',
    ...
    molecularWeight = (82.1005,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.71249,0.0419012,-1.37332e-05,-1.33632e-08,8.4966e-12,46475.4,21.5429], Tmin=(100,'K'), Tmax=(987.835,'K')), NASAPolynomial(coeffs=[12.1842,0.0183714,-6.66181e-06,1.20501e-09,-8.4977e-14,43485.7,-33.5095], Tmin=(987.835,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(385.672,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cyclobutene) + radical(cyclobutene-vinyl) + radical(CCsJOH)"""),
)

species(
    label = 'O=[C]C1[CH]CC1(6716)',
    structure = SMILES('O=[C]C1[CH]CC1'),
    E0 = (260.124,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1855,455,950,2750,2830,2910,2990,3070,3150,900,940,980,1020,1060,1100,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
species(
    label = 'O[CH]C1C=[C]C1(6718)',
    structure = SMILES('O[CH]C1C=[C]C1'),
    E0 = (385.672,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,3025,407.5,1350,352.5,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
...
species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.38576,'amu*angstrom^2'), symmetry=1, barrier=(8.86939,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.385743,'amu*angstrom^2'), symmetry=1, barrier=(8.86899,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.547207,'amu*angstrom^2'), symmetry=1, barrier=(12.5814,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (82.1005,'amu'),
...
species(
    label = 'OC=C1C=CC1(6721)',
    structure = SMILES('OC=C1C=CC1'),
    E0 = (10.9316,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,3010,987.5,1337.5,450,1655,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
species(
    label = '[CH2]C[C]=CC=O(6616)',
    structure = SMILES('[CH2]C[C]=CC=O'),
    E0 = (303.078,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,1685,370,2782.5,750,1395,475,1775,1000,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,389.244],'cm^-1')),
        HinderedRotor(inertia=(0.0818017,'amu*angstrom^2'), symmetry=1, barrier=(8.79492,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.081802,'amu*angstrom^2'), symmetry=1, barrier=(8.79492,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.081804,'amu*angstrom^2'), symmetry=1, barrier=(8.79492,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (82.1005,'amu'),
...
species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.48755,'amu*angstrom^2'), symmetry=1, barrier=(34.2016,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.02446,'amu*angstrom^2'), symmetry=1, barrier=(23.5545,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.48807,'amu*angstrom^2'), symmetry=1, barrier=(34.2136,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (82.1005,'amu'),
...
species(
    label = 'C=CC[C]C=O(6627)',
    structure = SMILES('C=CC[C]C=O'),
    E0 = (306.218,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2782.5,750,1395,475,1775,1000,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,180,180,896.144],'cm^-1')),
        HinderedRotor(inertia=(5.20297,'amu*angstrom^2'), symmetry=1, barrier=(119.627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(3.3047,'amu*angstrom^2'), symmetry=1, barrier=(75.9816,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(5.20297,'amu*angstrom^2'), symmetry=1, barrier=(119.627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
species(
    ...
    molecularWeight = (82.1005,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.83028,0.0199877,8.64499e-05,-1.43059e-07,6.078e-11,41462,22.0924], Tmin=(100,'K'), Tmax=(927.252,'K')), NASAPolynomial(coeffs=[23.0964,-0.000392226,3.98315e-06,-7.73188e-10,4.14207e-14,34450.5,-95.4397], Tmin=(927.252,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(343.871,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + ring(Cyclobutene) + radical(CCJCO) + radical(RCCJ)"""),
)
...
species(
    label = '[CH2]C=[C]CC=O(6738)',
    structure = SMILES('[CH2]C=[C]CC=O'),
    E0 = (260.177,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,1685,370,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,2782.5,750,1395,475,1775,1000,1226.01],'cm^-1')),
        HinderedRotor(inertia=(0.0379083,'amu*angstrom^2'), symmetry=1, barrier=(20.3003,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.882986,'amu*angstrom^2'), symmetry=1, barrier=(20.3016,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.883155,'amu*angstrom^2'), symmetry=1, barrier=(20.3055,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (82.1005,'amu'),
...
species(
    ...
    molecularWeight = (82.1005,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.26063,0.025586,3.26219e-05,-6.21198e-08,2.63561e-11,36383.8,22.8444], Tmin=(100,'K'), Tmax=(939.287,'K')), NASAPolynomial(coeffs=[11.7735,0.0170941,-4.94995e-06,8.3916e-10,-6.04683e-14,33184.3,-29.9726], Tmin=(939.287,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(301.895,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-(Cds-O2d)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + ring(Cyclopropane) + radical(Isobutyl) + radical(CCJCC=O)"""),
)

species(
    label = 'CC=C=CC=O(6741)',
...
species(
    label = 'C=C[C]1C=CO1(6745)',
    structure = SMILES('[CH2]C=C1C=CO1'),
    E0 = (179.283,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,3150,900,1100,3010,987.5,1337.5,450,1655,425.436,1037.8,1037.8,1037.8,1037.8,1037.8,1037.8,1037.8,1037.8,1037.8,2274.1],'cm^-1')),
        HinderedRotor(inertia=(0.00975557,'amu*angstrom^2'), symmetry=1, barrier=(0.2243,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (81.0926,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.18695,0.0209552,5.79279e-05,-9.84413e-08,4.17299e-11,21645.5,17.19], Tmin=(100,'K'), Tmax=(927.767,'K')), NASAPolynomial(coeffs=[16.3118,0.00861319,-6.22624e-07,4.27968e-11,-8.95514e-15,16934.9,-61.1572], Tmin=(927.767,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(179.283,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(253.591,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cs-(Cds-Cds)HHH) + group(Cds-Cds(Cds-Cds)O2s) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsOsH) + ring(Cyclobutene) + radical(C=CC=CCJ)"""),
)

species(
    label = 'C=CC1[C]=CO1(6746)',
    structure = SMILES('C=CC1[C]=CO1'),
    E0 = (300.59,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,3100,1380,975,1025,1650,2750,3150,900,1100,3010,987.5,1337.5,450,1655,300,800,800,800,800,800,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
species(
    label = 'C=[C]C1C=CO1(6747)',
    structure = SMILES('C=[C]C1C=CO1'),
    E0 = (300.59,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,3100,1380,975,1025,1650,2750,2950,3150,900,1000,1100,1685,370,300,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
species(
    label = '[CH]=CC1C=CO1(6749)',
    structure = SMILES('[CH]=CC1C=CO1'),
    E0 = (309.844,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,2750,2950,3150,900,1000,1100,3010,987.5,1337.5,450,1655,300,800,800,800,800,800,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
species(
    label = 'C=C[C]1C[CH]O1(6750)',
    structure = SMILES('[CH2]C=C1C[CH]O1'),
    E0 = (254.164,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2950,3150,900,1000,1100,3010,987.5,1337.5,450,1655,300,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (82.1005,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.4453,0.0360899,3.69397e-05,-9.26655e-08,4.44298e-11,30679.7,17.0347], Tmin=(100,'K'), Tmax=(896.491,'K')), NASAPolynomial(coeffs=[21.407,0.00124908,4.50603e-06,-1.07686e-09,7.39644e-14,24921.6,-89.2409], Tmin=(896.491,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(254.164,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(278.535,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + ring(2methyleneoxetane) + radical(Allyl_P) + radical(CCsJOC(O))"""),
)

species(
    label = '[CH2]C[C]1C=CO1(6751)',
    structure = SMILES('[CH2]CC1=C[CH]O1'),
    E0 = (339.556,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,3150,900,1100,3000,3100,440,815,1455,1000,300,800,800,800,800,800,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    ...
    molecularWeight = (82.1005,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.50428,0.0377187,2.0555e-05,-6.43503e-08,3.02404e-11,40944.8,21.1799], Tmin=(100,'K'), Tmax=(939.537,'K')), NASAPolynomial(coeffs=[18.7276,0.00781921,-1.04272e-06,1.71588e-10,-1.88122e-14,35791.7,-71.039], Tmin=(939.537,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(339.556,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + ring(Cyclobutene) + radical(CCsJOC(O)) + radical(RCCJ)"""),
)

species(
    label = 'C=C[C]1[CH]CO1(6752)',
...
species(
    ...
    molecularWeight = (82.1005,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.61404,0.0296728,5.34508e-05,-1.04761e-07,4.61189e-11,46028.2,20.8456], Tmin=(100,'K'), Tmax=(931.386,'K')), NASAPolynomial(coeffs=[21.3261,0.00343154,1.63388e-06,-3.31933e-10,1.33129e-14,39822.6,-86.4545], Tmin=(931.386,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(381.811,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + ring(Cyclobutene) + radical(Cds_S) + radical(RCCJ)"""),
)

species(
    label = 'C=[C]C1C[CH]O1(6754)',
    structure = SMILES('C=[C]C1C[CH]O1'),
    E0 = (389.221,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,3100,1380,975,1025,1650,2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,1685,370,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
species(
    label = 'C[CH]C1[C]=CO1(6755)',
    structure = SMILES('C[CH]C1[C]=CO1'),
    E0 = (376.467,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,3150,900,1100,2750,2800,2850,1350,1500,750,1050,1375,1000,300,800,800,800,800,800,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
...
species(
    label = 'C=[C]C1[CH]CO1(6756)',
    structure = SMILES('C=[C]C1[CH]CO1'),
    E0 = (408.667,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,3100,1380,975,1025,1650,2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,1685,370,405.172,1045.72,1045.72,1045.72,1045.72,1045.72,1045.72,1045.72,1045.72,1045.72,1045.72,1045.72,2284.94],'cm^-1')),
        HinderedRotor(inertia=(0.00975557,'amu*angstrom^2'), symmetry=1, barrier=(0.2243,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
species(
    ...
    molecularWeight = (82.1005,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.87271,0.031504,3.51648e-05,-8.18778e-08,3.92219e-11,48016.7,20.4892], Tmin=(100,'K'), Tmax=(874.911,'K')), NASAPolynomial(coeffs=[16.3623,0.00805119,2.00809e-06,-7.09866e-10,5.4719e-14,43843.5,-56.8384], Tmin=(874.911,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(398.475,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(278.535,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Oxetane) + radical(Cds_P) + radical(CCsJOCs)"""),
)

species(
    label = 'C[CH]C1C=[C]O1(6759)',
...
species(
    label = '[CH]CC1C=CO1(6764)',
    structure = SMILES('[CH]CC1C=CO1'),
    E0 = (389.823,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2950,3150,900,1000,1100,300,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
...
species(
    label = 'C[C]1C=CC1=O(6779)',
    structure = SMILES('C[C]1C=CC1=O'),
    E0 = (121.884,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,2750,3150,900,1100,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (81.0926,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.76781,0.0148341,4.82769e-05,-6.58561e-08,2.37088e-11,14714.3,15.041], Tmin=(100,'K'), Tmax=(1023.54,'K')), NASAPolynomial(coeffs=[8.53864,0.0235024,-1.01804e-05,2.0202e-09,-1.48926e-13,11897.6,-20.9231], Tmin=(1023.54,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(121.884,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(253.591,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)CsCsH) + group(Cs-CsHHH) + group(Cds-O2d(Cds-Cds)Cs) + group(Cds-CdsCsH) + group(Cd-Cd(CO)H) + ring(Cyclobutene) + radical(C=CCJ(C)C=O)"""),
)

species(
    label = '[CH2]C1C=CC1=O(6780)',
    structure = SMILES('[CH2]C1C=CC1=O'),
    E0 = (212.694,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2950,3150,900,1000,1100,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
species(
    ...
    molecularWeight = (82.1005,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.24569,0.0243847,4.19096e-05,-7.25653e-08,2.99596e-11,20941.7,17.6487], Tmin=(100,'K'), Tmax=(945.321,'K')), NASAPolynomial(coeffs=[12.0554,0.0186234,-5.67098e-06,9.92027e-10,-7.23527e-14,17489.8,-37.5739], Tmin=(945.321,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(173.486,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(278.535,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)CsCsH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsCs) + ring(Cyclobutanone) + radical(CCJC=O) + radical(C2CJCHO)"""),
)

species(
    label = 'C[C]1C=CC1[O](6784)',
...
species(
    ...
    molecularWeight = (82.1005,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.16773,0.0252644,4.06875e-05,-7.08047e-08,2.86655e-11,27401.6,20.1844], Tmin=(100,'K'), Tmax=(970.409,'K')), NASAPolynomial(coeffs=[12.8226,0.0186071,-6.61931e-06,1.26372e-09,-9.49232e-14,23579.3,-39.9389], Tmin=(970.409,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(227.169,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(278.535,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)CsCsH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsCs) + ring(Cyclobutanone) + radical(CCJC=O) + radical(CJC(C)C=O)"""),
)

species(
    label = 'CC1[C]=CC1[O](6787)',
    structure = SMILES('CC1[C]=CC1[O]'),
    E0 = (422.755,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2950,3150,900,1000,1100,2750,2800,2850,1350,1500,750,1050,1375,1000,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
...
species(
    label = '[CH2]C1C=C[C]1O(6790)',
    structure = SMILES('[CH2]C1[CH]C=C1O'),
    E0 = (267.782,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2950,3150,900,1000,1100,3000,3100,440,815,1455,1000,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
...
species(
    ...
    molecularWeight = (82.1005,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.88955,0.0270946,4.86629e-05,-9.20337e-08,3.9925e-11,38001.9,17.6059], Tmin=(100,'K'), Tmax=(932.314,'K')), NASAPolynomial(coeffs=[17.7676,0.00836637,-6.76728e-07,7.4931e-11,-1.21953e-14,32894.5,-69.3967], Tmin=(932.314,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(315.186,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + ring(Cyclobutene) + radical(cyclobutene-allyl) + radical(cyclobutene-vinyl)"""),
)

species(
    label = 'C[C]1C=C[C]1O(6793)',
...
species(
    label = '[CH]=CC(=O)[CH]C(6796)',
    structure = SMILES('[CH]=CC([O])=CC'),
    E0 = (228.904,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,440,435,1725,2750,2800,2850,1350,1500,750,1050,1375,1000,3120,650,792.5,1650,2995,3025,975,1000,1300,1375,400,500,1630,1680,180],'cm^-1')),
        HinderedRotor(inertia=(0.730933,'amu*angstrom^2'), symmetry=1, barrier=(16.8056,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.731337,'amu*angstrom^2'), symmetry=1, barrier=(16.8149,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (82.1005,'amu'),
...
species(
    label = 'COC1C=CC=1(6797)',
    structure = SMILES('COC1C=CC=1'),
    E0 = (228.315,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2950,3150,900,1000,1100,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
...
species(
    ...
    molecularWeight = (82.1005,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.90402,0.0299057,3.44102e-05,-7.19525e-08,3.13687e-11,7454.24,16.6469], Tmin=(100,'K'), Tmax=(942.802,'K')), NASAPolynomial(coeffs=[15.6051,0.0126334,-3.11307e-06,5.45329e-10,-4.36844e-14,3054.92,-58.2759], Tmin=(942.802,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(61.2274,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(278.535,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cs-(Cds-Cds)HHH) + group(Cds-Cds(Cds-Cds)O2s) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsOsH) + ring(Cyclobutene)"""),
)
...
species(
    ...
    molecularWeight = (82.1005,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.7037,0.00982112,8.39915e-05,-1.18594e-07,4.74283e-11,27302.1,14.8682], Tmin=(100,'K'), Tmax=(923.286,'K')), NASAPolynomial(coeffs=[12.5096,0.0153134,-2.87263e-06,4.05534e-10,-3.18434e-14,23446.5,-42.7304], Tmin=(923.286,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(226.47,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(282.692,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + ring(3,4-Dihydro-2H-pyran) + radical(C=CJO) + radical(Allyl_S)"""),
)

species(
    label = '[C]1[CH]CCOC=1(6816)',
...
species(
    ...
    molecularWeight = (82.1005,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.60345,0.0406249,8.34636e-06,-5.35758e-08,2.90201e-11,50912.6,21.2375], Tmin=(100,'K'), Tmax=(866.549,'K')), NASAPolynomial(coeffs=[16.0875,0.00933717,9.32101e-07,-5.0122e-10,4.15902e-14,47066.8,-54.2711], Tmin=(866.549,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(422.497,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Ethylene_oxide) + radical(CJCO) + radical(Cds_P)"""),
)

species(
    label = '[CH]=CC(=O)C=C(6840)',
    structure = SMILES('[CH]=CC(=O)C=C'),
    E0 = (223.941,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,3100,1380,975,1025,1650,375,552.5,462.5,1710,3120,650,792.5,1650,2995,3025,975,1000,1300,1375,400,500,1630,1680,180],'cm^-1')),
...
species(
    ...
    molecularWeight = (82.1005,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.17417,0.0501354,-1.56171e-05,-2.77881e-08,1.81638e-11,25268.4,21.1491], Tmin=(100,'K'), Tmax=(912.559,'K')), NASAPolynomial(coeffs=[17.8094,0.00925452,-1.07828e-06,5.98794e-11,-4.11313e-15,20898.4,-64.8927], Tmin=(912.559,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(209.155,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)HHH) + group(Cds-Cds(Cds-Cds)O2s) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + radical(Cds_P) + radical(C=CC=CCJ)"""),
)

species(
    label = 'C=[C]C([O])C=C(6843)',
    ...
    molecularWeight = (82.1005,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.50041,0.0473327,-3.39146e-05,1.20433e-08,-1.70894e-12,45693.9,25.1741], Tmin=(100,'K'), Tmax=(1658.06,'K')), NASAPolynomial(coeffs=[13.7755,0.0177195,-7.12434e-06,1.27161e-09,-8.48009e-14,41623.3,-40.2532], Tmin=(1658.06,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(379.119,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)(Cds-Cds)OsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(CC(C)OJ) + radical(Cds_S)"""),
)

species(
    label = '[CH]=CC(O)[C]=C(6844)',
    structure = SMILES('[CH]=CC(O)[C]=C'),
    E0 = (395.855,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1685,370,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,1380,1390,370,380,2900,435,3120,650,792.5,1650,334.931],'cm^-1')),
        HinderedRotor(inertia=(0.155904,'amu*angstrom^2'), symmetry=1, barrier=(12.1155,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.153169,'amu*angstrom^2'), symmetry=1, barrier=(12.125,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.153174,'amu*angstrom^2'), symmetry=1, barrier=(12.1079,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (82.1005,'amu'),
...
species(
    label = '[CH]=CC(O)C=[CH](6847)',
    structure = SMILES('[CH]=CC(O)C=[CH]'),
    E0 = (405.109,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,3115,3125,620,680,785,800,1600,1700,2995,3025,975,1000,1300,1375,400,500,1630,1680],'cm^-1')),
...
reaction(
    label = 'reaction32',
    reactants = ['HCO(14)(15)', '[CH]1C=CC1(969)'],
...
reaction(
    label = 'reaction33',
    reactants = ['H(3)(3)', 'O=C[C]1C=CC1(6701)'],
    products = ['C5H6O(218)(217)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction34',
    reactants = ['H(3)(3)', 'O=CC1[CH]C=C1(6702)'],
    products = ['C5H6O(218)(217)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction35',
    reactants = ['H(3)(3)', 'O=CC1[C]=CC1(6703)'],
    products = ['C5H6O(218)(217)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction36',
    reactants = ['H(3)(3)', 'O=CC1C=[C]C1(6704)'],
    products = ['C5H6O(218)(217)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(1e+13,'cm^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""From training reaction 40 used for Cd_rad/NonDe;H_rad
Exact match found for rate rule [Cd_rad/NonDe;H_rad]
...
reaction(
    label = 'reaction37',
    reactants = ['H(3)(3)', 'O=[C]C1C=CC1(6705)'],
    products = ['C5H6O(218)(217)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction40',
    reactants = ['O=CC1[CH]C[CH]1(6708)'],
    products = ['C5H6O(218)(217)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(1.0206e+11,'s^-1'), n=0.2847, Ea=(23.1459,'kJ/mol'), T0=(1,'K'), comment="""Estimated using average of templates [Rn;Y_rad_NDe;XH_Rrad_NDe] + [R2radExo;Y_rad;XH_Rrad_NDe] for rate rule [R2radExo;Y_rad_NDe;XH_Rrad_NDe]
Euclidian distance = 1.0
...
reaction(
    label = 'reaction46',
    reactants = ['O[CH]C1[CH]C=C1(6714)'],
    products = ['C5H6O(218)(217)'],
...
reaction(
    label = 'reaction60',
    reactants = ['[CH]1OC2[CH]C1C2(6724)'],
    products = ['C5H6O(218)(217)'],
...
reaction(
    label = 'reaction1',
    reactants = ['C2H3(28)(29)', 'CHCHCHO(2768)'],
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)(3)', 'C=C[C]=CC=O(6612)'],
    products = ['C5H6O(217)(216)'],
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)(3)', 'C=[C]C=CC=O(6613)'],
    products = ['C5H6O(217)(216)'],
...
reaction(
    label = 'reaction4',
    reactants = ['HCO(14)(15)', 'CH2CHCHCH(913)'],
    products = ['C5H6O(217)(216)'],
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)(3)', 'C=CC=[C]C=O(6614)'],
    products = ['C5H6O(217)(216)'],
...
reaction(
    label = 'reaction6',
    reactants = ['H(3)(3)', '[CH]=CC=CC=O(3611)'],
    products = ['C5H6O(217)(216)'],
...
reaction(
    label = 'reaction74',
    reactants = ['CHCHO(45)(45)', '[CH]=C[CH2](891)'],
    products = ['C5H6O(219)(218)'],
...
reaction(
    label = 'reaction82',
    reactants = ['CH2(17)(18)', '[CH]=CC=C[O](2898)'],
    products = ['C5H6O(219)(218)'],
...
reaction(
    label = 'reaction83',
    reactants = ['O(4)(4)', '[CH]=CC=C[CH2](880)'],
    products = ['C5H6O(219)(218)'],
...
reaction(
    label = 'reaction113',
    reactants = ['C2H3(28)(29)', '[CH]1C=CO1(6744)'],
    products = ['C5H6O(220)(219)'],
...
reaction(
    label = 'reaction114',
    reactants = ['H(3)(3)', 'C=C[C]1C=CO1(6745)'],
    products = ['C5H6O(220)(219)'],
...
reaction(
    label = 'reaction115',
    reactants = ['H(3)(3)', 'C=CC1[C]=CO1(6746)'],
    products = ['C5H6O(220)(219)'],
...
reaction(
    label = 'reaction116',
    reactants = ['H(3)(3)', 'C=[C]C1C=CO1(6747)'],
    products = ['C5H6O(220)(219)'],
...
reaction(
    label = 'reaction117',
    reactants = ['H(3)(3)', 'C=CC1C=[C]O1(6748)'],
    products = ['C5H6O(220)(219)'],
...
reaction(
    label = 'reaction118',
    reactants = ['H(3)(3)', '[CH]=CC1C=CO1(6749)'],
    products = ['C5H6O(220)(219)'],
...
reaction(
    label = 'reaction136',
    reactants = ['[CH]1CC2[CH]C1O2(6765)'],
    products = ['C5H6O(220)(219)'],
...
reaction(
    label = 'reaction160',
    reactants = ['CH3(15)(16)', 'O=C1[CH]C=C1(6778)'],
    products = ['C5H6O(223)(222)'],
...
reaction(
    label = 'reaction161',
    reactants = ['H(3)(3)', 'C[C]1C=CC1=O(6779)'],
    products = ['C5H6O(223)(222)'],
...
reaction(
    label = 'reaction162',
    reactants = ['H(3)(3)', '[CH2]C1C=CC1=O(6780)'],
    products = ['C5H6O(223)(222)'],
...
reaction(
    label = 'reaction163',
    reactants = ['H(3)(3)', 'CC1[C]=CC1=O(6781)'],
    products = ['C5H6O(223)(222)'],
...
reaction(
    label = 'reaction164',
    reactants = ['H(3)(3)', 'CC1C=[C]C1=O(6782)'],
    products = ['C5H6O(223)(222)'],
...
reaction(
    label = 'reaction168',
    reactants = ['[CH2]C1C[CH]C1=O(6786)'],
    products = ['C5H6O(223)(222)'],
...
reaction(
    label = 'reaction172',
    reactants = ['[CH2]C1[CH]CC1=O(6789)'],
    products = ['C5H6O(223)(222)'],
...
reaction(
    label = 'reaction177',
    reactants = ['CH2(S)(21)(22)', 'O=C1C=CC1(6794)'],
    products = ['C5H6O(223)(222)'],
...
reaction(
    label = 'reaction187',
    reactants = ['CC1[CH]C2O[C]12(6803)'],
    products = ['C5H6O(223)(222)'],
...
reaction(
    label = 'reaction188',
    reactants = ['H(3)(3)', '[CH]1C=CC=CO1(6804)'],
    products = ['C5H6O(231)(230)'],
...
reaction(
    label = 'reaction189',
    reactants = ['H(3)(3)', '[C]1=CC=COC1(6805)'],
    products = ['C5H6O(231)(230)'],
...
reaction(
    label = 'reaction190',
    reactants = ['H(3)(3)', '[C]1=CCOC=C1(6806)'],
    products = ['C5H6O(231)(230)'],
...
reaction(
    label = 'reaction191',
    reactants = ['H(3)(3)', '[C]1=COCC=C1(6807)'],
    products = ['C5H6O(231)(230)'],
...
reaction(
    label = 'reaction192',
    reactants = ['H(3)(3)', '[C]1=CC=CCO1(6808)'],
    products = ['C5H6O(231)(230)'],
...
reaction(
    label = 'reaction234',
    reactants = ['H(3)(3)', '[CH]=CC(=O)C=C(6840)'],
...
reaction(
    label = 'reaction235',
    reactants = ['H(3)(3)', 'C#CC([O])C=C(6841)'],
    products = ['C5H6O(543)(542)'],
...
reaction(
    label = 'reaction237',
    reactants = ['C3H4O(113)(112)', 'C2H2(T)(4186)'],
    products = ['C5H6O(543)(542)'],
...
reaction(
    label = 'reaction238',
    reactants = ['C2H2(30)(31)', 'acrolein(T)(2910)'],
    products = ['C5H6O(543)(542)'],
...
reaction(
    label = 'reaction245',
    reactants = ['acrolein(T)(2910)', 'C2H2(T)(4186)'],
    products = ['C5H6O(543)(542)'],
