species(
    ...
    E0 = (-310.491,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,2750,2800,2850,1350,1500,750,1050,1375,1000,1380,1390,370,380,2900,435,492.5,1135,1000,375,552.5,462.5,1710,276.529,277.44],'cm^-1')),
        HinderedRotor(inertia=(0.272266,'amu*angstrom^2'), symmetry=1, barrier=(14.8183,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.272457,'amu*angstrom^2'), symmetry=1, barrier=(14.8234,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.272531,'amu*angstrom^2'), symmetry=1, barrier=(14.8199,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.272811,'amu*angstrom^2'), symmetry=1, barrier=(14.8174,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.274834,'amu*angstrom^2'), symmetry=1, barrier=(14.8238,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
species(
    label = 'CC(=O)[C](C=CO)OO(7676)',
    structure = SMILES('CC([O])=C(C=CO)OO'),
    E0 = (-317.049,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2995,3025,975,1000,1300,1375,400,500,1630,1680,3615,1310,387.5,850,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,325,375,415,465,420,450,1700,1750,3615,1277.5,1000,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.796277,'amu*angstrom^2'), symmetry=1, barrier=(18.308,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.796377,'amu*angstrom^2'), symmetry=1, barrier=(18.3103,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.797297,'amu*angstrom^2'), symmetry=1, barrier=(18.3314,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.796534,'amu*angstrom^2'), symmetry=1, barrier=(18.3139,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.795583,'amu*angstrom^2'), symmetry=1, barrier=(18.292,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (131.107,'amu'),
...
species(
    label = '[CH2]C(=O)C(C=CO)OO(7678)',
    structure = SMILES('C=C([O])C(C=CO)OO'),
    E0 = (-303.125,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,3100,1380,975,1025,1650,3615,1277.5,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,350,440,435,1725,200,800,1600],'cm^-1')),
...
species(
    label = 'CC(=O)C(C=[C]O)OO(7679)',
    structure = SMILES('CC(=O)C(C=[C]O)OO'),
    E0 = (-222.752,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1685,370,3010,987.5,1337.5,450,1655,2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,375,552.5,462.5,1710,200,800],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'CC(=CO[O])OC=CO(7692)',
    structure = SMILES('CC(=CO[O])OC=CO'),
    E0 = (-213.063,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2995,3010,3025,975,987.5,1000,1300,1337.5,1375,400,450,500,1630,1655,1680,492.5,1135,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,3615,1277.5,1000,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'CC(O)=C(C=CO)O[O](7693)',
    structure = SMILES('CC(O)=C(C=CO)O[O]'),
    E0 = (-302.849,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2995,3025,975,1000,1300,1375,400,500,1630,1680,3580,3650,1210,1345,900,1100,2750,2800,2850,1350,1500,750,1050,1375,1000,325,375,415,465,420,450,1700,1750,492.5,1135,1000,180],'cm^-1')),
        HinderedRotor(inertia=(0.772573,'amu*angstrom^2'), symmetry=1, barrier=(17.763,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.772046,'amu*angstrom^2'), symmetry=1, barrier=(17.7508,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.769401,'amu*angstrom^2'), symmetry=1, barrier=(17.6901,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.774236,'amu*angstrom^2'), symmetry=1, barrier=(17.8012,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.770659,'amu*angstrom^2'), symmetry=1, barrier=(17.719,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (131.107,'amu'),
...
species(
    label = 'C=C(O)C(C=CO)O[O](7694)',
    structure = SMILES('C=C(O)C(C=CO)O[O]'),
    E0 = (-288.925,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3580,3650,1210,1345,900,1100,2995,3025,975,1000,1300,1375,400,500,1630,1680,2950,3100,1380,975,1025,1650,1380,1390,370,380,2900,435,350,440,435,1725,492.5,1135,1000,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.859385,'amu*angstrom^2'), symmetry=1, barrier=(19.759,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.858002,'amu*angstrom^2'), symmetry=1, barrier=(19.7272,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.85824,'amu*angstrom^2'), symmetry=1, barrier=(19.7326,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.85792,'amu*angstrom^2'), symmetry=1, barrier=(19.7253,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.859303,'amu*angstrom^2'), symmetry=1, barrier=(19.7571,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (131.107,'amu'),
...
species(
    label = 'CC(=O)C([O])C=CO(7695)',
    structure = SMILES('CC(=O)C([O])C=CO'),
    E0 = (-290.268,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2995,3025,975,1000,1300,1375,400,500,1630,1680,3615,1277.5,1000,1380,1390,370,380,2900,435,375,552.5,462.5,1710,2750,2800,2850,1350,1500,750,1050,1375,1000,296.869,298.375,301.858],'cm^-1')),
        HinderedRotor(inertia=(0.00188977,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.216064,'amu*angstrom^2'), symmetry=1, barrier=(13.8219,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.212464,'amu*angstrom^2'), symmetry=1, barrier=(13.8547,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.216269,'amu*angstrom^2'), symmetry=1, barrier=(13.8382,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
reaction(
    label = 'reaction3',
    reactants = ['S(659)(658)'],
    products = ['CC(=O)C1OOC1[CH]O(7675)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2]C(=O)C(C=CO)OO(7678)'],
    products = ['S(659)(658)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['CC(=O)C(C=[C]O)OO(7679)'],
    products = ['S(659)(658)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['OH(5)(5)', '[CH]=CC(O[O])C(C)=O(7681)'],
    products = ['S(659)(658)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['CH3CO(55)(54)', '[O]O[CH]C=CO(7317)'],
    products = ['S(659)(658)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CHCHOH(49)(49)', 'CC(=O)[CH]O[O](7682)'],
    products = ['S(659)(658)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(3)(3)', 'CC(=O)[C](C=CO)O[O](7683)'],
    products = ['S(659)(658)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CH3(15)(16)', '[O]OC([C]=O)C=CO(7684)'],
    products = ['S(659)(658)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(3)(3)', '[CH2]C(=O)C(C=CO)O[O](7685)'],
    products = ['S(659)(658)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(3)(3)', 'CC(=O)C([C]=CO)O[O](7686)'],
    products = ['S(659)(658)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(3)(3)', 'CC(=O)C(C=[C]O)O[O](7687)'],
    products = ['S(659)(658)'],
...
reaction(
    label = 'reaction19',
    reactants = ['S(659)(658)'],
    products = ['CC(=O)C1[CH]C(O)OO1(7689)'],
...
reaction(
    label = 'reaction20',
    reactants = ['CO(10)(11)', 'CC(C=CO)O[O](7690)'],
    products = ['S(659)(658)'],
...
reaction(
    label = 'reaction21',
    reactants = ['S(659)(658)'],
    products = ['HO2(8)(9)', 'CC(=O)C=C=CO(7463)'],
...
reaction(
    label = 'reaction25',
    reactants = ['CC(O)=C(C=CO)O[O](7693)'],
    products = ['S(659)(658)'],
...
reaction(
    label = 'reaction26',
    reactants = ['C=C(O)C(C=CO)O[O](7694)'],
    products = ['S(659)(658)'],
...
reaction(
    label = 'reaction27',
    reactants = ['O(4)(4)', 'CC(=O)C([O])C=CO(7695)'],
    products = ['S(659)(658)'],
