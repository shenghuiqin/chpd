...
species(
    label = 'C=C(O)O[O](8411)',
    structure = SMILES('C=C(O)O[O]'),
    E0 = (-47.2805,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2950,3100,1380,975,1025,1650,350,440,435,1725,3615,1277.5,1000],'cm^-1')),
...
reaction(
    label = 'reaction1',
    reactants = ['C2H3O3(58)(57)'],
    products = ['CC1([O])OO1(8407)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction3',
    reactants = ['CH3(15)(16)', 'CO3t2(7846)'],
    products = ['C2H3O3(58)(57)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)(3)', '[CH2]C(=O)O[O](8409)'],
    products = ['C2H3O3(58)(57)'],
    transitionState = 'TS4',
