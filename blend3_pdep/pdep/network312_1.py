species(
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.538221,0.103719,-7.81467e-05,3.23617e-08,-5.80435e-12,-36399.1,36.09], Tmin=(100,'K'), Tmax=(1250.69,'K')), NASAPolynomial(coeffs=[12.7959,0.0610741,-2.70008e-05,5.09906e-09,-3.54865e-13,-39734.4,-31.2222], Tmin=(1250.69,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-303.967,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(573.699,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH)"""),
)
...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0657823,0.0894453,-6.60909e-05,2.65917e-08,-4.61904e-12,-33559.9,31.6755], Tmin=(100,'K'), Tmax=(1287.71,'K')), NASAPolynomial(coeffs=[11.9349,0.0525769,-2.31448e-05,4.35817e-09,-3.02599e-13,-36616.7,-28.5875], Tmin=(1287.71,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-280.187,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH)"""),
)
...
reaction(
    label = 'reaction4',
    reactants = ['C3H7(69)(68)', '[CH2]CCCOO(5134)'],
    products = ['S(191)(190)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['C2H5(27)(28)', '[CH2]CCCCOO(5135)'],
    products = ['S(191)(190)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(8.73e+14,'cm^3/(mol*s)'), n=-0.699, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(200,'K'), Tmax=(2000,'K'), comment="""From training reaction 11 used for C_rad/H2/Cs;C_rad/H2/Cs
Exact match found for rate rule [C_rad/H2/Cs;C_rad/H2/Cs]
...
reaction(
    label = 'reaction6',
    reactants = ['H(3)(3)', 'CC[CH]CCCCOO(4253)'],
    products = ['S(191)(190)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['C4H9(68)(67)', 'QOOH_1(97)(96)'],
    products = ['S(191)(190)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(8.73e+14,'cm^3/(mol*s)'), n=-0.699, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(200,'K'), Tmax=(2000,'K'), comment="""From training reaction 11 used for C_rad/H2/Cs;C_rad/H2/Cs
Exact match found for rate rule [C_rad/H2/Cs;C_rad/H2/Cs]
...
reaction(
    label = 'reaction9',
    reactants = ['C5H11(67)(66)', 'C2H5O2(43)(43)'],
    products = ['S(191)(190)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(8.73e+14,'cm^3/(mol*s)'), n=-0.699, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(200,'K'), Tmax=(2000,'K'), comment="""From training reaction 11 used for C_rad/H2/Cs;C_rad/H2/Cs
Exact match found for rate rule [C_rad/H2/Cs;C_rad/H2/Cs]
...
reaction(
    label = 'reaction10',
    reactants = ['H(3)(3)', 'CCCC[CH]CCOO(4252)'],
    products = ['S(191)(190)'],
...
reaction(
    label = 'reaction11',
    reactants = ['C6H13(78)(77)', 'CH2OOH(33)(34)'],
    products = ['S(191)(190)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(3)(3)', 'CCCCC[CH]COO(4251)'],
    products = ['S(191)(190)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CH3(15)(16)', '[CH2]CCCCCOO(5136)'],
    products = ['S(191)(190)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(3)(3)', 'C[CH]CCCCCOO(4254)'],
    products = ['S(191)(190)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(3)(3)', 'CCCCCC[CH]OO(4250)'],
    products = ['S(191)(190)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(3)(3)', '[CH2]CCCCCCOO(4269)'],
    products = ['S(191)(190)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CH2(S)(21)(22)', 'CCCCCCOO(5132)'],
    products = ['S(191)(190)'],
...
network(
    ...
    reactants = [
        ...
        ('HO2(8)(9)', 'C7H15(85)(84)'),
        ('H(3)(3)', 'S(99)(98)'),
        ('C4H9(68)(67)', 'QOOH_1(97)(96)'),
        ('H(3)(3)', 'S(164)(163)'),
        ('C5H11(67)(66)', 'C2H5O2(43)(43)'),
        ('C6H13(78)(77)', 'CH2OOH(33)(34)'),
    ],
    bathGas = {
        'Ne': 0.333333,
        'N2': 0.333333,
