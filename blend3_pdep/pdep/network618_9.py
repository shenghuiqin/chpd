...
species(
    label = '[CH2]C1C2C=CCOOC12(7908)',
    structure = SMILES('[CH2]C1C2C=CCOOC12'),
    E0 = (225.619,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (125.145,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.61056,0.0255018,0.000106073,-1.4805e-07,5.54617e-11,27245.7,24.9271], Tmin=(100,'K'), Tmax=(990.094,'K')), NASAPolynomial(coeffs=[15.5705,0.0372491,-1.49654e-05,2.96613e-09,-2.23e-13,21141.3,-59.1503], Tmin=(990.094,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(225.619,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(428.195,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + Estimated bicyclic component: polycyclic(s2_3_7_ane) - ring(Cycloheptane) - ring(Cyclopropane) + ring(Cycloheptane) + ring(Cyclopropane) + radical(Isobutyl)"""),
)

species(
    label = 'C=CC1=CC=CCOO1(7909)',
    structure = SMILES('C=CC1=CC=CCOO1'),
    E0 = (117.065,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (124.137,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.690371,0.0153491,0.000206807,-3.24514e-07,1.39189e-10,14252.7,27.511], Tmin=(100,'K'), Tmax=(906.409,'K')), NASAPolynomial(coeffs=[43.3905,-0.0225243,2.03189e-05,-4.0902e-09,2.66356e-13,326.939,-208.415], Tmin=(906.409,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(117.065,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(403.252,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-(Cds-Cds)OsHH) + group(Cds-Cds(Cds-Cds)O2s) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + ring(Cycloheptane)"""),
)

species(
    label = 'C=CC1C=C=CCOO1(7910)',
    structure = SMILES('C=CC1C=C=CCOO1'),
    E0 = (234.634,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,3100,1380,975,1025,1650,2750,2850,2950,3050,3150,900,950,1000,1050,1100,3010,987.5,1337.5,450,1655,300,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (124.137,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.745876,0.0592213,-1.19016e-05,-1.84807e-08,8.49433e-12,28347.3,25.053], Tmin=(100,'K'), Tmax=(1162.03,'K')), NASAPolynomial(coeffs=[14.2618,0.0380292,-1.72472e-05,3.34707e-09,-2.37995e-13,23495.8,-49.5424], Tmin=(1162.03,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(234.634,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(403.252,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-(Cds-Cds)(Cds-Cds)OsH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + ring(1_2_cycloheptadiene)"""),
)

species(
    label = 'C1C=COOCC=1(7911)',
    structure = SMILES('C1C=COOCC=1'),
    E0 = (70.393,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.98451,-0.0160347,0.000258149,-3.70608e-07,1.55321e-10,8595.65,20.8476], Tmin=(100,'K'), Tmax=(902.415,'K')), NASAPolynomial(coeffs=[41.7803,-0.0344408,2.61303e-05,-5.19498e-09,3.41851e-13,-5019.81,-202.701], Tmin=(902.415,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(70.393,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(307.635,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsOsH) + ring(Cycloheptane)"""),
)

species(
    label = 'C=C[C]1CC=CCOO1(7912)',
    structure = SMILES('[CH2]C=C1CC=CCOO1'),
    E0 = (174.929,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2830,2910,2990,3070,3150,900,940,980,1020,1060,1100,3010,987.5,1337.5,450,1655,300,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (125.145,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.9553,0.0108745,0.00021527,-3.2409e-07,1.36015e-10,21201.1,31.6518], Tmin=(100,'K'), Tmax=(912.99,'K')), NASAPolynomial(coeffs=[39.7635,-0.0132824,1.53007e-05,-3.07384e-09,1.93721e-13,8035.25,-185.337], Tmin=(912.99,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(174.929,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(428.195,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cycloheptane) + radical(Allyl_P)"""),
)

species(
    label = 'C=CC1C[C]=CCOO1(7913)',
    structure = SMILES('C=CC1C[C]=CCOO1'),
    E0 = (261.009,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (125.145,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.799449,0.0152629,0.000203846,-3.12232e-07,1.31595e-10,31558.8,32.051], Tmin=(100,'K'), Tmax=(914.435,'K')), NASAPolynomial(coeffs=[39.9469,-0.0126852,1.46377e-05,-2.92545e-09,1.83031e-13,18408.2,-186.069], Tmin=(914.435,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(261.009,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(428.195,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Cycloheptane) + radical(Cds_S)"""),
)

species(
    label = 'C=[C]C1CC=CCOO1(7914)',
    structure = SMILES('C=[C]C1CC=CCOO1'),
    E0 = (261.009,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2816.67,2883.33,2950,3016.67,3083.33,3150,900,933.333,966.667,1000,1033.33,1066.67,1100,1685,370,2950,3100,1380,975,1025,1650,300,800,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
species(
    label = 'C=CC1CC=[C]COO1(7915)',
    structure = SMILES('C=CC1CC=[C]COO1'),
    E0 = (261.009,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,3100,1380,975,1025,1650,2750,2830,2910,2990,3070,3150,900,940,980,1020,1060,1100,3010,987.5,1337.5,450,1655,300,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    ...
    molecularWeight = (125.145,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.966047,0.000467134,0.000265715,-3.88535e-07,1.61481e-10,17064.8,31.5772], Tmin=(100,'K'), Tmax=(914.917,'K')), NASAPolynomial(coeffs=[45.2902,-0.021385,1.96596e-05,-3.84688e-09,2.40649e-13,1758.21,-217.646], Tmin=(914.917,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(140.462,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(428.195,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Cycloheptane) + radical(C=CCJO)"""),
)

species(
    label = '[CH]=CC1CC=CCOO1(7917)',
    structure = SMILES('[CH]=CC1CC=CCOO1'),
    E0 = (270.263,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,2750,2816.67,2883.33,2950,3016.67,3083.33,3150,900,933.333,966.667,1000,1033.33,1066.67,1100,3010,987.5,1337.5,450,1655,300,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (125.145,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.753689,0.0142386,0.000211832,-3.24012e-07,1.36646e-10,32675.4,32.1449], Tmin=(100,'K'), Tmax=(913.911,'K')), NASAPolynomial(coeffs=[41.4149,-0.0150826,1.59862e-05,-3.18186e-09,1.99939e-13,19035.6,-194.324], Tmin=(913.911,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(270.263,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(428.195,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Cycloheptane) + radical(Cds_P)"""),
)

species(
    label = '[CH]1[CH]OOCC=C1(7918)',
    structure = SMILES('[CH]1C=C[CH]OOC1'),
    E0 = (190.137,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2830,2910,2990,3070,3150,900,940,980,1020,1060,1100,300,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
    ],
    ...
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.83408,-0.0137606,0.000259353,-3.70705e-07,1.53978e-10,23003.6,20.8278], Tmin=(100,'K'), Tmax=(909.713,'K')), NASAPolynomial(coeffs=[41.9193,-0.0302457,2.30953e-05,-4.51152e-09,2.89766e-13,9099.31,-205.103], Tmin=(909.713,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(190.137,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(307.635,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cycloheptane) + radical(C=CCJCO) + radical(C=CCJO)"""),
)

species(
    label = 'C=C[C]1[CH]C=CCOO1(7919)',
    structure = SMILES('[CH2]C=C1C=C[CH]COO1'),
    E0 = (234.902,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2850,2950,3050,3150,900,950,1000,1050,1100,3010,987.5,1337.5,450,1655,300,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (124.137,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.568315,0.018661,0.000202084,-3.18691e-07,1.36493e-10,28428.9,27.7365], Tmin=(100,'K'), Tmax=(908.409,'K')), NASAPolynomial(coeffs=[42.7854,-0.0186202,1.82475e-05,-3.68433e-09,2.38021e-13,14627,-205.632], Tmin=(908.409,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(234.902,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(403.252,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-Cds(Cds-Cds)O2s) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + ring(Cycloheptane) + radical(C=CCJCO) + radical(C=CC=CCJ)"""),
)

species(
    label = 'C=CC1[CH]C=C[CH]OO1(7920)',
    structure = SMILES('C=CC1[CH]C=C[CH]OO1'),
    E0 = (210.606,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,3100,1380,975,1025,1650,2750,2850,2950,3050,3150,900,950,1000,1050,1100,3010,987.5,1337.5,450,1655,300,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (124.137,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.21457,-0.0136313,0.000315439,-4.48578e-07,1.84865e-10,25500.2,31.4837], Tmin=(100,'K'), Tmax=(915.191,'K')), NASAPolynomial(coeffs=[49.3951,-0.030085,2.42308e-05,-4.67484e-09,2.92694e-13,8551.52,-241.105], Tmin=(915.191,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(210.606,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(403.252,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Cycloheptane) + radical(C=CCJC(O)C=C) + radical(C=CCJO)"""),
)

species(
    label = 'C=CC1[CH]C=[C]COO1(7921)',
    structure = SMILES('C=CC1[CH]C=[C]COO1'),
    E0 = (331.152,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,3100,1380,975,1025,1650,2750,2850,2950,3050,3150,900,950,1000,1050,1100,3010,987.5,1337.5,450,1655,300,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (124.137,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.04806,0.00116341,0.000253574,-3.7228e-07,1.54982e-10,39994.2,31.9572], Tmin=(100,'K'), Tmax=(914.817,'K')), NASAPolynomial(coeffs=[44.0514,-0.0213846,1.92085e-05,-3.75332e-09,2.35069e-13,25201.7,-209.527], Tmin=(914.817,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(331.152,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(403.252,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Cycloheptane) + radical(Cds_S) + radical(C=CCJC(O)C=C)"""),
)

species(
    label = 'C=[C]C1[CH]C=CCOO1(7922)',
    structure = SMILES('C=[C]C1[CH]C=CCOO1'),
    E0 = (331.152,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,3100,1380,975,1025,1650,2750,2830,2910,2990,3070,3150,900,940,980,1020,1060,1100,1685,370,300,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
species(
    label = '[CH]=CC1[CH]C=CCOO1(7924)',
    structure = SMILES('[CH]=CC1[CH]C=CCOO1'),
    E0 = (340.407,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,2750,2830,2910,2990,3070,3150,900,940,980,1020,1060,1100,3010,987.5,1337.5,450,1655,300,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (124.137,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.00204,0.000142457,0.000261547,-3.84041e-07,1.60024e-10,41110.8,32.0521], Tmin=(100,'K'), Tmax=(914.358,'K')), NASAPolynomial(coeffs=[45.5201,-0.0237831,2.05577e-05,-4.0099e-09,2.51992e-13,25828.8,-217.785], Tmin=(914.358,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(340.407,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(403.252,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Cycloheptane) + radical(Cds_P) + radical(C=CCJC(O)C=C)"""),
)

species(
    label = 'C=CC1OOCC2[CH]C21(7925)',
    structure = SMILES('C=CC1OOCC2[CH]C21'),
    E0 = (278.791,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (125.145,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.05904,0.0476439,2.92835e-05,-6.17968e-08,2.34326e-11,33651.1,27.7095], Tmin=(100,'K'), Tmax=(1066.91,'K')), NASAPolynomial(coeffs=[13.7662,0.0406861,-1.81316e-05,3.57108e-09,-2.59226e-13,28624.2,-45.2694], Tmin=(1066.91,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(278.791,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(428.195,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + polycyclic(s2_3_6_ane) + radical(cyclopropane)"""),
)

species(
    label = '[CH]1CC2C=CCOOC12(7926)',
    structure = SMILES('[CH]1CC2C=CCOOC12'),
    E0 = (97.7523,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (125.145,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.334095,0.0880622,-6.83424e-05,2.62303e-08,-4.0547e-12,11918.5,-0.231919], Tmin=(100,'K'), Tmax=(1513.63,'K')), NASAPolynomial(coeffs=[19.9022,0.0345858,-1.53486e-05,2.89014e-09,-1.99782e-13,5792.33,-106.249], Tmin=(1513.63,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(97.7523,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + Estimated bicyclic component: polycyclic(PolycyclicRing) - ring(Cycloheptane) - ring(Cyclobutane) + ring(Cycloheptane) + ring(Cyclobutane) + radical(CCJCOOH)"""),
)

species(
    label = 'C=CC1[CH]OOCC=C1(7927)',
    structure = SMILES('C=CC1[CH]OOCC=C1'),
    E0 = (214.067,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,3100,1380,975,1025,1650,2750,2830,2910,2990,3070,3150,900,940,980,1020,1060,1100,3010,987.5,1337.5,450,1655,300,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (125.145,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.624763,0.0259537,0.000164755,-2.65294e-07,1.13489e-10,25912.9,29.3047], Tmin=(100,'K'), Tmax=(912.929,'K')), NASAPolynomial(coeffs=[36.7445,-0.00650244,1.13814e-05,-2.34944e-09,1.47859e-13,14075.6,-170.374], Tmin=(912.929,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(214.067,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(428.195,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-(Cds-Cds)(Cds-Cds)CsH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Cycloheptane) + radical(CCsJOOC)"""),
)

species(
    label = 'C=CC1[C]C=CCOO1(7928)',
    structure = SMILES('C=CC1[C]=C[CH]COO1'),
    E0 = (368.612,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,3100,1380,975,1025,1650,2750,2850,2950,3050,3150,900,950,1000,1050,1100,3010,987.5,1337.5,450,1655,300,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (124.137,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.47557,0.0229018,0.000185056,-2.95953e-07,1.26402e-10,44511.6,29.8662], Tmin=(100,'K'), Tmax=(915.684,'K')), NASAPolynomial(coeffs=[41.7619,-0.0154578,1.5293e-05,-3.01118e-09,1.8794e-13,30997.7,-198.185], Tmin=(915.684,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(368.612,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(403.252,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-(Cds-Cds)(Cds-Cds)OsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Cycloheptane) + radical(C=CCJCO) + radical(Cds_S)"""),
)

species(
    label = 'C=CC1C=CC=COO1(7929)',
    structure = SMILES('C=CC1C=CC=COO1'),
    E0 = (128.322,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,3100,1380,975,1025,1650,2750,2850,2950,3050,3150,900,950,1000,1050,1100,3010,987.5,1337.5,450,1655,300,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (124.137,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.7942,0.00581806,0.000245739,-3.72124e-07,1.5758e-10,15609.5,29.4061], Tmin=(100,'K'), Tmax=(909.058,'K')), NASAPolynomial(coeffs=[46.9375,-0.0283042,2.33219e-05,-4.60947e-09,2.97097e-13,240.67,-227.198], Tmin=(909.058,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(128.322,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(403.252,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-(Cds-Cds)(Cds-Cds)OsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsOsH) + group(Cds-CdsHH) + ring(Cycloheptane)"""),
)
...
species(
    ...
    molecularWeight = (125.145,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.692129,0.0189711,0.000192698,-2.99617e-07,1.26696e-10,30441.2,31.8896], Tmin=(100,'K'), Tmax=(915.743,'K')), NASAPolynomial(coeffs=[39.6346,-0.0114427,1.37045e-05,-2.73202e-09,1.69623e-13,17451.9,-184.537], Tmin=(915.743,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(251.695,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(428.195,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-(Cds-Cds)(Cds-Cds)OsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Cycloheptane) + radical(Cds_S)"""),
)

species(
    label = 'C=CC1[C]=CCCOO1(7931)',
    structure = SMILES('C=CC1[C]=CCCOO1'),
    E0 = (251.695,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,3100,1380,975,1025,1650,2750,2830,2910,2990,3070,3150,900,940,980,1020,1060,1100,3010,987.5,1337.5,450,1655,300,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'C=C[C]1C=CCCOO1(7932)',
    structure = SMILES('[CH2]C=C1C=CCCOO1'),
    E0 = (117.985,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2830,2910,2990,3070,3150,900,940,980,1020,1060,1100,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,300,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (125.145,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.785414,0.0147236,0.000209751,-3.22391e-07,1.36803e-10,14358.5,29.758], Tmin=(100,'K'), Tmax=(908.329,'K')), NASAPolynomial(coeffs=[40.6566,-0.0146024,1.66575e-05,-3.40481e-09,2.19673e-13,1081.82,-191.976], Tmin=(908.329,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(117.985,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(428.195,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-Cds(Cds-Cds)O2s) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + ring(Cycloheptane) + radical(C=CC=CCJ)"""),
)

species(
    label = 'C=[C]C1C=CCCOO1(7933)',
    structure = SMILES('C=[C]C1C=CCCOO1'),
    E0 = (251.695,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2816.67,2883.33,2950,3016.67,3083.33,3150,900,933.333,966.667,1000,1033.33,1066.67,1100,1685,370,2950,3100,1380,975,1025,1650,300,800,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH]=CC1C=CCCOO1(7934)',
    structure = SMILES('[CH]=CC1C=CCCOO1'),
    E0 = (260.95,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2816.67,2883.33,2950,3016.67,3083.33,3150,900,933.333,966.667,1000,1033.33,1066.67,1100,3010,987.5,1337.5,450,1655,3120,650,792.5,1650,300,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (125.145,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.646678,0.017943,0.000200697,-3.11415e-07,1.31754e-10,31557.8,31.9825], Tmin=(100,'K'), Tmax=(915.145,'K')), NASAPolynomial(coeffs=[41.1015,-0.0138379,1.50518e-05,-2.98815e-09,1.86507e-13,18079.8,-192.785], Tmin=(915.145,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(260.95,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(428.195,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-(Cds-Cds)(Cds-Cds)OsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Cycloheptane) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction170',
    reactants = ['C=CC1C=C[CH]COO1(3465)'],
    products = ['[CH2]C1C2C=CCOOC12(7908)'],
    transitionState = 'TS170',
    kinetics = Arrhenius(A=(1e+10,'s^-1'), n=0, Ea=(134.907,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""From training reaction 29 used for R4_S_D;doublebond_intra_2H_pri;radadd_intra_csHCd
...
reaction(
    label = 'reaction171',
    reactants = ['H(3)(3)', 'C=CC1=CC=CCOO1(7909)'],
    products = ['C=CC1C=C[CH]COO1(3465)'],
...
reaction(
    label = 'reaction172',
    reactants = ['H(3)(3)', 'C=CC1C=C=CCOO1(7910)'],
    products = ['C=CC1C=C[CH]COO1(3465)'],
...
reaction(
    label = 'reaction173',
    reactants = ['C2H3(28)(29)', 'C1C=COOCC=1(7911)'],
    products = ['C=CC1C=C[CH]COO1(3465)'],
...
reaction(
    label = 'reaction174',
    reactants = ['C=C[C]1CC=CCOO1(7912)'],
    products = ['C=CC1C=C[CH]COO1(3465)'],
...
reaction(
    label = 'reaction178',
    reactants = ['C=CC1CC=C[CH]OO1(7916)'],
    products = ['C=CC1C=C[CH]COO1(3465)'],
    transitionState = 'TS178',
    kinetics = Arrhenius(A=(2e+10,'s^-1'), n=0, Ea=(418.4,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4H_SDS;C_rad_out_1H;Cs_H_out_H/NonDeC] for rate rule [R4H_SDS;C_rad_out_H/NonDeO;Cs_H_out_H/NonDeC]
Euclidian distance = 1.0
Multiplied by reaction path degeneracy 2.0
family: intra_H_migration"""),
)
...
reaction(
    label = 'reaction180',
    reactants = ['C2H3(28)(29)', '[CH]1[CH]OOCC=C1(7918)'],
    products = ['C=CC1C=C[CH]COO1(3465)'],
...
reaction(
    label = 'reaction181',
    reactants = ['H(3)(3)', 'C=C[C]1[CH]C=CCOO1(7919)'],
    products = ['C=CC1C=C[CH]COO1(3465)'],
...
reaction(
    label = 'reaction182',
    reactants = ['H(3)(3)', 'C=CC1[CH]C=C[CH]OO1(7920)'],
    products = ['C=CC1C=C[CH]COO1(3465)'],
...
reaction(
    label = 'reaction183',
    reactants = ['H(3)(3)', 'C=CC1[CH]C=[C]COO1(7921)'],
    products = ['C=CC1C=C[CH]COO1(3465)'],
...
reaction(
    label = 'reaction184',
    reactants = ['H(3)(3)', 'C=[C]C1[CH]C=CCOO1(7922)'],
    products = ['C=CC1C=C[CH]COO1(3465)'],
...
reaction(
    label = 'reaction185',
    reactants = ['H(3)(3)', 'C=CC1[CH][C]=CCOO1(7923)'],
    products = ['C=CC1C=C[CH]COO1(3465)'],
...
reaction(
    label = 'reaction186',
    reactants = ['H(3)(3)', '[CH]=CC1[CH]C=CCOO1(7924)'],
    products = ['C=CC1C=C[CH]COO1(3465)'],
...
reaction(
    label = 'reaction187',
    reactants = ['C=CC1C=C[CH]COO1(3465)'],
    products = ['C=CC1OOCC2[CH]C21(7925)'],
...
reaction(
    label = 'reaction188',
    reactants = ['C=CC1C=C[CH]COO1(3465)'],
    products = ['[CH]1CC2C=CCOOC12(7926)'],
...
reaction(
    label = 'reaction189',
    reactants = ['C=CC1[CH]OOCC=C1(7927)'],
    products = ['C=CC1C=C[CH]COO1(3465)'],
...
reaction(
    label = 'reaction190',
    reactants = ['H(3)(3)', 'C=CC1[C]C=CCOO1(7928)'],
    products = ['C=CC1C=C[CH]COO1(3465)'],
...
reaction(
    label = 'reaction191',
    reactants = ['C=CC1C=C[CH]COO1(3465)'],
    products = ['[CH2]C1C2C=CC1OOC2(3466)'],
...
reaction(
    label = 'reaction192',
    reactants = ['H(3)(3)', 'C=CC1C=CC=COO1(7929)'],
    products = ['C=CC1C=C[CH]COO1(3465)'],
...
reaction(
    label = 'reaction196',
    reactants = ['C=C[C]1C=CCCOO1(7932)'],
    products = ['C=CC1C=C[CH]COO1(3465)'],
...
reaction(
    label = 'reaction197',
    reactants = ['C=[C]C1C=CCCOO1(7933)'],
    products = ['C=CC1C=C[CH]COO1(3465)'],
    transitionState = 'TS197',
    kinetics = Arrhenius(A=(272000,'s^-1'), n=1.9199, Ea=(33.0402,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R5H_RSMS;Cd_rad_out;Cs_H_out] for rate rule [R5H_SSMS;Cd_rad_out_Cd;Cs_H_out_H/NonDeC]
Euclidian distance = 3.0
Multiplied by reaction path degeneracy 2.0
family: intra_H_migration"""),
)
