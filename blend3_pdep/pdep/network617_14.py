...
species(
    label = 'C7H9(460)(459)',
    structure = SMILES('[CH]1CC2C=CCC12'),
    E0 = (312.651,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,2900,2950,3000,3050,3100,3150,900,925,950,975,1000,1025,1050,1075,1100,300,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
    ],
...
species(
    ...
    E0 = (389.5,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,2950,3100,1380,975,1025,1650,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,300,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
...
species(
    label = '[CH]1C=CC2CCC12(1048)',
    structure = SMILES('[CH]1C=CC2CCC12'),
    E0 = (252.118,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,2900,2950,3000,3050,3100,3150,900,925,950,975,1000,1025,1050,1075,1100,300,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
    ],
    ...
    molecularWeight = (93.1464,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.4256,0.0108296,0.000112132,-1.45541e-07,5.3837e-11,30400.8,14.6164], Tmin=(100,'K'), Tmax=(977.79,'K')), NASAPolynomial(coeffs=[12.3355,0.0309153,-1.16851e-05,2.28892e-09,-1.72853e-13,25564.7,-47.7901], Tmin=(977.79,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(252.118,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + polycyclic(s2_4_5_ene_1) + radical(cyclopentene-allyl)"""),
)
...
species(
    label = 'C1=CC2CC2=CC1(1099)',
    structure = SMILES('C1=CC2CC2=CC1'),
    E0 = (313.593,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2807.14,2864.29,2921.43,2978.57,3035.71,3092.86,3150,900,928.571,957.143,985.714,1014.29,1042.86,1071.43,1100,300,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
    ],
    ...
    molecularWeight = (92.1384,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.74552,0.0324258,4.32694e-05,-7.68101e-08,3.06009e-11,37812.9,20.3929], Tmin=(100,'K'), Tmax=(989.58,'K')), NASAPolynomial(coeffs=[13.9151,0.0253235,-9.76289e-06,1.89684e-09,-1.41161e-13,33343.5,-48.6035], Tmin=(989.58,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(313.593,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)CsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + polycyclic(s2_3_6_diene_0_3)"""),
)
...
species(
    label = '[CH]1CC=CC2C[C]12(1105)',
    structure = SMILES('[CH]1CC=CC2C[C]12'),
    E0 = (485.923,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2807.14,2864.29,2921.43,2978.57,3035.71,3092.86,3150,900,928.571,957.143,985.714,1014.29,1042.86,1071.43,1100,300,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
    ],
    ...
    molecularWeight = (92.1384,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.39883,0.0252598,3.74302e-05,-5.14632e-08,1.7125e-11,58508.9,20.4681], Tmin=(100,'K'), Tmax=(1104.09,'K')), NASAPolynomial(coeffs=[6.16714,0.0383762,-1.67567e-05,3.21488e-09,-2.2798e-13,56045.2,-5.47374], Tmin=(1104.09,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(485.923,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + polycyclic(s2_3_6_ene_1) + radical(Tertalkyl) + radical(Cs_S)"""),
)

species(
    label = '[CH]1CC=C[C]2CC12(1106)',
    structure = SMILES('[CH]1CC=C[C]2CC12'),
    E0 = (432.481,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2807.14,2864.29,2921.43,2978.57,3035.71,3092.86,3150,900,928.571,957.143,985.714,1014.29,1042.86,1071.43,1100,300,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
    ],
    ...
    molecularWeight = (92.1384,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.59031,0.012579,8.86091e-05,-1.13629e-07,4.11738e-11,52082.5,16.8908], Tmin=(100,'K'), Tmax=(991.38,'K')), NASAPolynomial(coeffs=[9.30637,0.0325513,-1.28288e-05,2.47665e-09,-1.8214e-13,48437.8,-27.1182], Tmin=(991.38,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(432.481,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + polycyclic(s2_3_6_ene_1) + radical(Cs_S) + radical(Allyl_T)"""),
)

species(
    label = '[CH]1CC=CC2[CH]C12(1107)',
    structure = SMILES('[CH]1CC=CC2[CH]C12'),
    E0 = (526.413,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2807.14,2864.29,2921.43,2978.57,3035.71,3092.86,3150,900,928.571,957.143,985.714,1014.29,1042.86,1071.43,1100,300,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
    ],
...
species(
    label = '[C]1=CC[CH]C2CC12(1109)',
    structure = SMILES('[C]1=CC[CH]C2CC12'),
    E0 = (538.342,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2807.14,2864.29,2921.43,2978.57,3035.71,3092.86,3150,900,928.571,957.143,985.714,1014.29,1042.86,1071.43,1100,300,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
    ],
    ...
    molecularWeight = (92.1384,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.27728,0.0225823,5.84322e-05,-8.18408e-08,2.97252e-11,64822.9,19.543], Tmin=(100,'K'), Tmax=(1017.44,'K')), NASAPolynomial(coeffs=[9.48042,0.0328535,-1.36029e-05,2.63742e-09,-1.92015e-13,61359.8,-25.1483], Tmin=(1017.44,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(538.342,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + polycyclic(s2_3_6_ene_1) + radical(Cs_S) + radical(Cds_S)"""),
)

species(
    label = '[C]1=CC2CC2[CH]C1(1110)',
    structure = SMILES('[C]1=CC2CC2[CH]C1'),
    E0 = (538.342,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2807.14,2864.29,2921.43,2978.57,3035.71,3092.86,3150,900,928.571,957.143,985.714,1014.29,1042.86,1071.43,1100,300,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
    ],
    ...
    molecularWeight = (92.1384,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.27728,0.0225823,5.84322e-05,-8.18408e-08,2.97252e-11,64822.9,19.543], Tmin=(100,'K'), Tmax=(1017.44,'K')), NASAPolynomial(coeffs=[9.48042,0.0328535,-1.36029e-05,2.63742e-09,-1.92015e-13,61359.8,-25.1483], Tmin=(1017.44,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(538.342,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + polycyclic(s2_3_6_ene_1) + radical(Cds_S) + radical(Cs_S)"""),
)

species(
    label = '[CH]1CC2C1C1CC21(1111)',
    structure = SMILES('[CH]1CC2C1C1CC21'),
    E0 = (451.657,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (93.1464,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.46793,0.0156886,8.43654e-05,-1.07579e-07,3.81175e-11,54392.6,16.5102], Tmin=(100,'K'), Tmax=(1015.13,'K')), NASAPolynomial(coeffs=[8.91875,0.0367299,-1.53767e-05,3.00936e-09,-2.20535e-13,50689.1,-26.4989], Tmin=(1015.13,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(451.657,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + polycyclic(s2_4_4_ane) + polycyclic(s2_3_4_ane) - ring(Cyclobutane) + radical(bicyclo[2.2.0]hexane-secondary)"""),
)

species(
    label = '[CH]1C2CC2C2CC12(1112)',
    structure = SMILES('[CH]1C2CC2C2CC12'),
    E0 = (347.724,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (93.1464,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.36907,0.0195077,7.2345e-05,-9.29868e-08,3.22069e-11,41894.3,15.9698], Tmin=(100,'K'), Tmax=(1044.85,'K')), NASAPolynomial(coeffs=[8.47781,0.0389869,-1.71582e-05,3.3857e-09,-2.46918e-13,38278,-24.9663], Tmin=(1044.85,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(347.724,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + polycyclic(s2_3_5_ane) + polycyclic(s2_3_5_ane) - ring(Cyclopentane) + radical(bicyclo[3.1.0]hexane-C5-2)"""),
)

species(
    label = '[CH]=CC1CC1C=C(1113)',
    structure = SMILES('[CH]=CC1CC1C=C'),
    E0 = (433.668,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,2995,3025,975,1000,1300,1375,400,500,1630,1680,3120,650,792.5,1650,2950,3100,1380,975,1025,1650,300,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
...
species(
    label = '[C]1CC=CC2CC12(1116)',
    structure = SMILES('[C]1CC=CC2CC12'),
    E0 = (554.173,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2807.14,2864.29,2921.43,2978.57,3035.71,3092.86,3150,900,928.571,957.143,985.714,1014.29,1042.86,1071.43,1100,300,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
    ],
    ...
    molecularWeight = (92.1384,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.06879,0.0222762,7.4826e-05,-1.08951e-07,4.17753e-11,66739.2,17.1644], Tmin=(100,'K'), Tmax=(977.527,'K')), NASAPolynomial(coeffs=[13.3166,0.0269147,-1.00355e-05,1.94444e-09,-1.45903e-13,62119.6,-49.2258], Tmin=(977.527,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(554.173,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + polycyclic(s2_3_6_ene_1) + radical(CCJ2_triplet)"""),
)
...
species(
    ...
    molecularWeight = (92.1384,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.54866,0.0438673,2.70561e-06,-3.0037e-08,1.35128e-11,60614.7,22.6005], Tmin=(100,'K'), Tmax=(1003.06,'K')), NASAPolynomial(coeffs=[10.6188,0.0305225,-1.14715e-05,2.07158e-09,-1.44066e-13,57646.9,-26.909], Tmin=(1003.06,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(503.172,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(353.365,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)CsH) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(1,4-Cyclohexadiene) + radical(Isobutyl) + radical(Cds_S)"""),
)

species(
    label = '[CH]C1C=CCC=C1(1125)',
...
species(
    label = 'C1=CC2CC=C2C1(1126)',
    structure = SMILES('C1=CC2CC=C2C1'),
    E0 = (261.951,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2807.14,2864.29,2921.43,2978.57,3035.71,3092.86,3150,900,928.571,957.143,985.714,1014.29,1042.86,1071.43,1100,300,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
    ],
    ...
    molecularWeight = (92.1384,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.9311,0.0327551,3.05293e-05,-5.32162e-08,1.95528e-11,31590.7,13.482], Tmin=(100,'K'), Tmax=(1059.9,'K')), NASAPolynomial(coeffs=[10.0137,0.0334006,-1.44665e-05,2.81294e-09,-2.02846e-13,28127.8,-34.2358], Tmin=(1059.9,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(261.951,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)CsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + Estimated bicyclic component: polycyclic(s2_4_5_ane) - ring(Cyclopentane) - ring(Cyclobutane) + ring(Cyclopentene) + ring(Cyclobutene)"""),
)

species(
    label = 'C1=CC2CC[C]2C1(1127)',
    structure = SMILES('C1=CC2CC[C]2C1'),
    E0 = (310.235,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (93.1464,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.30646,0.0234885,5.66184e-05,-7.6073e-08,2.65776e-11,37385.5,18.6759], Tmin=(100,'K'), Tmax=(1042.34,'K')), NASAPolynomial(coeffs=[7.51162,0.0388606,-1.63704e-05,3.14398e-09,-2.25516e-13,34380.2,-15.8626], Tmin=(1042.34,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(310.235,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + polycyclic(s2_4_5_ene_1) + radical(Tertalkyl)"""),
)

species(
    label = 'C1=C[C]2CCC2C1(1128)',
    structure = SMILES('C1=C[C]2CCC2C1'),
    E0 = (256.794,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (93.1464,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.49982,0.0107203,0.000108431,-1.39574e-07,5.14347e-11,30959.1,15.0961], Tmin=(100,'K'), Tmax=(976.008,'K')), NASAPolynomial(coeffs=[11.0641,0.0323778,-1.2081e-05,2.3234e-09,-1.73033e-13,26584,-39.8621], Tmin=(976.008,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(256.794,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + polycyclic(s2_4_5_ene_1) + radical(Allyl_T)"""),
)

species(
    label = '[C]1=CCC2CCC12(1129)',
    structure = SMILES('[C]1=CCC2CCC12'),
    E0 = (382.319,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,2900,2950,3000,3050,3100,3150,900,925,950,975,1000,1025,1050,1075,1100,300,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
    ],
...
species(
    label = '[CH]1CC2C=CC[C]12(1131)',
    structure = SMILES('[CH]1CC2C=CC[C]12'),
    E0 = (498.074,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2807.14,2864.29,2921.43,2978.57,3035.71,3092.86,3150,900,928.571,957.143,985.714,1014.29,1042.86,1071.43,1100,300,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
    ],
...
species(
    ...
    molecularWeight = (92.1384,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.59609,0.0113301,9.42632e-05,-1.19824e-07,4.32017e-11,52982.4,17.0462], Tmin=(100,'K'), Tmax=(996.256,'K')), NASAPolynomial(coeffs=[9.79898,0.0325479,-1.31722e-05,2.58373e-09,-1.91627e-13,49059.1,-30.1641], Tmin=(996.256,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(439.957,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + polycyclic(s2_4_5_ene_1) + radical(cyclobutane) + radical(cyclopentene-allyl)"""),
)

species(
    label = '[C]1=CCC2[CH]CC12(1135)',
    structure = SMILES('[C]1=CCC2[CH]CC12'),
    E0 = (570.158,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2807.14,2864.29,2921.43,2978.57,3035.71,3092.86,3150,900,928.571,957.143,985.714,1014.29,1042.86,1071.43,1100,300,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
    ],
    ...
    molecularWeight = (92.1384,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.35639,0.021232,6.03711e-05,-8.20716e-08,2.93625e-11,68646.3,19.4882], Tmin=(100,'K'), Tmax=(1023.57,'K')), NASAPolynomial(coeffs=[8.72132,0.0342806,-1.43245e-05,2.77488e-09,-2.01346e-13,65356.8,-21.0711], Tmin=(1023.57,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(570.158,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + polycyclic(s2_4_5_ene_1) + radical(cyclobutane) + radical(cyclopentene-vinyl)"""),
)

species(
    label = '[C]1=CC2C[CH]C2C1(1136)',
    structure = SMILES('[C]1=CC2C[CH]C2C1'),
    E0 = (570.158,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2807.14,2864.29,2921.43,2978.57,3035.71,3092.86,3150,900,928.571,957.143,985.714,1014.29,1042.86,1071.43,1100,300,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
    ],
...
species(
    label = '[CH]1C2CC3C1CC23(1137)',
    structure = SMILES('[CH]1C2CC3C1CC23'),
    E0 = (425.038,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (93.1464,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.61354,0.0194674,5.83434e-05,-6.90103e-08,2.16303e-11,51179.2,9.27091], Tmin=(100,'K'), Tmax=(1137.58,'K')), NASAPolynomial(coeffs=[5.09614,0.0451981,-2.10236e-05,4.13079e-09,-2.95593e-13,48384.6,-12.8265], Tmin=(1137.58,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(425.038,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + polycyclic(s3_4_5_ane) + polycyclic(s2_4_5_ane) + polycyclic(s2_4_4_ane) - ring(Cyclobutane) - ring(Cyclobutane) - ring(Cyclopentane) + radical(bicyclo[2.1.1]hexane-C2)"""),
)

species(
    label = '[CH]1CC2C3CC2C13(1138)',
    structure = SMILES('[CH]1CC2C3CC2C13'),
    E0 = (451.079,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (93.1464,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.69917,0.0178323,6.1181e-05,-7.06534e-08,2.19128e-11,54307.8,8.38879], Tmin=(100,'K'), Tmax=(1142.42,'K')), NASAPolynomial(coeffs=[4.58097,0.0460129,-2.14723e-05,4.21981e-09,-3.01782e-13,51608.9,-10.8707], Tmin=(1142.42,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(451.079,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + polycyclic(s2_4_5_ane) + polycyclic(s2_4_5_ane) + polycyclic(s3_4_4_ane) - ring(Cyclobutane) - ring(Cyclobutane) - ring(Cyclopentane) + radical(bicyclo[2.1.1]hexane-C2)"""),
)

species(
    label = '[CH2]C1C2C=CCC12(1140)',
    structure = SMILES('[CH2]C1C2C=CCC12'),
    E0 = (317.64,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2816.67,2883.33,2950,3016.67,3083.33,3150,900,933.333,966.667,1000,1033.33,1066.67,1100,300,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (93.1464,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.00086,0.022135,8.43701e-05,-1.23783e-07,4.85939e-11,38295.1,19.9822], Tmin=(100,'K'), Tmax=(953.955,'K')), NASAPolynomial(coeffs=[14.2375,0.0259375,-8.26671e-06,1.51617e-09,-1.13655e-13,33452.8,-51.6194], Tmin=(953.955,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(317.64,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(378.308,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + polycyclic(s2_3_5_ene_1) + radical(Isobutyl)"""),
)

species(
    label = '[C]1CC2C=CCC12(1141)',
    structure = SMILES('[C]1CC2C=CCC12'),
    E0 = (573.028,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2807.14,2864.29,2921.43,2978.57,3035.71,3092.86,3150,900,928.571,957.143,985.714,1014.29,1042.86,1071.43,1100,300,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
    ],
...
species(
    label = 'CC1C=C2C=CC21(1158)',
    structure = SMILES('CC1C=C2C=CC21'),
    E0 = (336.333,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,2950,3050,3150,900,950,1000,1050,1100,2750,2800,2850,1350,1500,750,1050,1375,1000,300,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (92.1384,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.45647,0.0413606,1.95625e-05,-5.40421e-08,2.32582e-11,40556.1,14.3074], Tmin=(100,'K'), Tmax=(983.291,'K')), NASAPolynomial(coeffs=[13.9995,0.0253244,-9.34899e-06,1.74745e-09,-1.26834e-13,36398,-54.5951], Tmin=(983.291,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(336.333,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(353.365,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)(Cds-Cds)CsH) + group(Cs-CsHHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + Estimated bicyclic component: polycyclic(s2_4_4_ane) - ring(Cyclobutane) - ring(Cyclobutane) + ring(Cyclobutene) + ring(Cyclobutene)"""),
)

species(
    label = 'C1=CC2C=CC12(1159)',
...
species(
    label = 'C[C]1CC2C=CC12(1160)',
    structure = SMILES('C[C]1CC2C=CC12'),
    E0 = (261.759,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (93.1464,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.92358,0.0354267,2.17956e-05,-4.10966e-08,1.47546e-11,31565.6,19.5931], Tmin=(100,'K'), Tmax=(1086.48,'K')), NASAPolynomial(coeffs=[7.92062,0.0380624,-1.5964e-05,3.00937e-09,-2.11777e-13,28803.8,-16.5495], Tmin=(1086.48,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(261.759,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(378.308,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + polycyclic(s2_4_4_ene_1) + radical(Tertalkyl)"""),
)

species(
    label = 'CC1C[C]2C=CC21(1161)',
    structure = SMILES('CC1C[C]2C=CC21'),
    E0 = (208.317,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (93.1464,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.13479,0.0224806,7.40625e-05,-1.04917e-07,3.96202e-11,25138.4,15.9472], Tmin=(100,'K'), Tmax=(978.733,'K')), NASAPolynomial(coeffs=[11.1809,0.0320524,-1.19377e-05,2.24929e-09,-1.64211e-13,21138.5,-38.8886], Tmin=(978.733,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(208.317,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(378.308,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + polycyclic(s2_4_4_ene_1) + radical(Allyl_T)"""),
)

species(
    label = 'CC1CC2C=C[C]12(1162)',
    structure = SMILES('CC1CC2C=C[C]12'),
    E0 = (208.317,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (93.1464,'amu'),
...
species(
    label = 'CC1CC2[C]=CC12(1164)',
    structure = SMILES('CC1CC2[C]=CC12'),
    E0 = (328.822,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2830,2910,2990,3070,3150,900,940,980,1020,1060,1100,2750,2800,2850,1350,1500,750,1050,1375,1000,300,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'CC1[CH]C2C=C[C]12(1166)',
    structure = SMILES('CC1[CH]C2C=C[C]12'),
    E0 = (396.155,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,2950,3050,3150,900,950,1000,1050,1100,2750,2800,2850,1350,1500,750,1050,1375,1000,300,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'CC1[CH][C]2C=CC21(1169)',
    structure = SMILES('CC1[CH][C]2C=CC21'),
    E0 = (396.155,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,2950,3050,3150,900,950,1000,1050,1100,2750,2800,2850,1350,1500,750,1050,1375,1000,300,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (92.1384,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.2999,0.0230424,5.5992e-05,-7.89616e-08,2.88959e-11,47720.3,17.7032], Tmin=(100,'K'), Tmax=(1006.09,'K')), NASAPolynomial(coeffs=[8.68362,0.0336196,-1.33877e-05,2.53544e-09,-1.82273e-13,44615.9,-22.1774], Tmin=(1006.09,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(396.155,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(353.365,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + polycyclic(s2_4_4_ene_1) + radical(cyclobutane) + radical(Allyl_T)"""),
)
...
species(
    label = 'CC1[CH]C2C=[C]C12(1171)',
    structure = SMILES('CC1[CH]C2C=[C]C12'),
    E0 = (516.66,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,2950,3050,3150,900,950,1000,1050,1100,2750,2800,2850,1350,1500,750,1050,1375,1000,300,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    ...
    molecularWeight = (92.1384,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.97858,0.0331262,2.56239e-05,-4.70727e-08,1.74752e-11,62222.3,20.3862], Tmin=(100,'K'), Tmax=(1052.29,'K')), NASAPolynomial(coeffs=[9.00098,0.0336891,-1.4032e-05,2.66629e-09,-1.89712e-13,59235.3,-21.0212], Tmin=(1052.29,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(516.66,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(353.365,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + polycyclic(s2_4_4_ene_1) + radical(cyclobutane) + radical(cyclobutene-vinyl)"""),
)

species(
    label = 'CC1C2C3[CH]C2C13(1173)',
    structure = SMILES('CC1C2C3[CH]C2C13'),
    E0 = (549.27,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (93.1464,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.43476,0.0229351,5.0885e-05,-6.46996e-08,2.11187e-11,66127.8,12.0191], Tmin=(100,'K'), Tmax=(1107.77,'K')), NASAPolynomial(coeffs=[6.06563,0.0421691,-1.89565e-05,3.68929e-09,-2.63639e-13,63338.8,-14.827], Tmin=(1107.77,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(549.27,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(378.308,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + polycyclic(s2_4_4_ane) + polycyclic(s2_4_4_ane) + polycyclic(s3_4_4_ane) - ring(Cyclobutane) - ring(Cyclobutane) - ring(Cyclobutane) + radical(bicyclo[1.1.1]pentane-C2)"""),
)

species(
    label = 'CC1C2[CH]C3C1C23(1174)',
    structure = SMILES('CC1C2[CH]C3C1C23'),
    E0 = (479.69,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (93.1464,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.27365,0.0277547,3.79396e-05,-5.20715e-08,1.69402e-11,57763.9,14.4492], Tmin=(100,'K'), Tmax=(1134.94,'K')), NASAPolynomial(coeffs=[6.42866,0.0419154,-1.88456e-05,3.64636e-09,-2.58898e-13,54965.6,-14.2952], Tmin=(1134.94,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(479.69,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(378.308,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + polycyclic(s2_4_4_ane) + polycyclic(s2_3_4_ane) + polycyclic(s2_3_4_ane) - ring(Cyclobutane) - ring(Cyclopropane) - ring(Cyclobutane) + radical(bicyclo[2.1.1]hexane-C5)"""),
)

species(
    label = 'CC=CC1[CH]C=C1(1175)',
    structure = SMILES('CC=CC1[CH]C=C1'),
    E0 = (344.687,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,2995,3025,975,1000,1300,1375,400,500,1630,1680,2750,2800,2850,1350,1500,750,1050,1375,1000,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    ...
    molecularWeight = (93.1464,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.5787,0.0393006,2.57585e-05,-5.5529e-08,2.22309e-11,41555.6,20.331], Tmin=(100,'K'), Tmax=(1009.86,'K')), NASAPolynomial(coeffs=[11.8389,0.0318904,-1.25934e-05,2.37407e-09,-1.70236e-13,37789,-37.6586], Tmin=(1009.86,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(344.687,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(374.151,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)CsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cyclobutene) + radical(cyclobutene-allyl)"""),
)

species(
    label = '[CH]=CC1C=CC1C(1176)',
    structure = SMILES('[CH]=CC1C=CC1C'),
    E0 = (431.513,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,3010,987.5,1337.5,450,1655,2750,2800,2850,1350,1500,750,1050,1375,1000,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
...
species(
    ...
    molecularWeight = (93.1464,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.84413,0.0291642,5.75977e-05,-9.0262e-08,3.47501e-11,54928.1,22.6655], Tmin=(100,'K'), Tmax=(991.652,'K')), NASAPolynomial(coeffs=[12.9334,0.0296643,-1.15762e-05,2.23766e-09,-1.65209e-13,50504.8,-41.9543], Tmin=(991.652,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(455.918,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(374.151,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + polycyclic(s2_3_4_ene_1) + radical(Cs_S)"""),
)

species(
    label = 'CC1C2[CH]C1C=C2(1178)',
    structure = SMILES('CC1C2[CH]C1C=C2'),
    E0 = (426.333,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2830,2910,2990,3070,3150,900,940,980,1020,1060,1100,2750,2800,2850,1350,1500,750,1050,1375,1000,300,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    ...
    molecularWeight = (92.1384,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.49088,0.0144824,8.54867e-05,-1.11493e-07,4.05385e-11,56655.7,16.986], Tmin=(100,'K'), Tmax=(995.342,'K')), NASAPolynomial(coeffs=[9.99221,0.0320299,-1.28323e-05,2.50004e-09,-1.84681e-13,52799.9,-31.0364], Tmin=(995.342,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(470.473,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + polycyclic(s2_3_6_ene_1) + radical(cyclohexene-allyl) + radical(cyclopropane)"""),
)

species(
    label = '[C]1=C[CH]CC2CC12(1184)',
...
species(
    label = 'C=C=CC1C=CC1(7892)',
    structure = SMILES('C=C=CC1C=CC1'),
    E0 = (356.748,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,2950,3050,3150,900,950,1000,1050,1100,3010,987.5,1337.5,450,1655,540,610,2055,2950,3100,1380,975,1025,1650,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (92.1384,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.42296,0.044134,7.87854e-06,-3.8781e-08,1.70189e-11,43010.7,21.0498], Tmin=(100,'K'), Tmax=(1008.83,'K')), NASAPolynomial(coeffs=[12.856,0.0277578,-1.08258e-05,2.03091e-09,-1.45412e-13,39230.4,-41.5115], Tmin=(1008.83,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(356.748,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(353.365,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)CsH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + ring(Cyclobutene)"""),
)

species(
    label = 'C[C]=CC1C=CC1(7893)',
    structure = SMILES('C[C]=CC1C=CC1'),
    E0 = (417.986,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (93.1464,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.30911,0.0495255,-9.10905e-06,-1.67612e-08,8.07811e-12,50377.1,22.882], Tmin=(100,'K'), Tmax=(1086.07,'K')), NASAPolynomial(coeffs=[11.0837,0.0330979,-1.34521e-05,2.49747e-09,-1.74434e-13,47099.6,-30.3961], Tmin=(1086.07,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(417.986,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(374.151,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)CsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cyclobutene) + radical(Cds_S)"""),
)

species(
    label = 'CC=[C]C1C=CC1(7894)',
    structure = SMILES('CC=[C]C1C=CC1'),
    E0 = (417.986,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,2750,2850,2950,3050,3150,900,950,1000,1050,1100,3010,987.5,1337.5,450,1655,2750,2800,2850,1350,1500,750,1050,1375,1000,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
...
species(
    label = 'CC=C[C]1C=CC1(7895)',
    structure = SMILES('C[CH]C=C1C=CC1'),
    E0 = (302.166,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (93.1464,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.52099,0.0319803,6.63805e-05,-1.12206e-07,4.60414e-11,36451.9,21.0225], Tmin=(100,'K'), Tmax=(952.705,'K')), NASAPolynomial(coeffs=[17.4695,0.0216532,-6.5277e-06,1.20813e-09,-9.32829e-14,30842.9,-68.6359], Tmin=(952.705,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(302.166,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(374.151,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-CsHHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + ring(Cyclobutene) + radical(Allyl_S)"""),
)

species(
    label = 'CC=CC1[C]=CC1(7896)',
    ...
    molecularWeight = (93.1464,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.30911,0.0495255,-9.10905e-06,-1.67612e-08,8.07811e-12,52138.3,22.882], Tmin=(100,'K'), Tmax=(1086.07,'K')), NASAPolynomial(coeffs=[11.0837,0.0330979,-1.34521e-05,2.49747e-09,-1.74434e-13,48860.8,-30.3961], Tmin=(1086.07,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(432.63,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(374.151,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)CsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cyclobutene) + radical(cyclobutene-vinyl)"""),
)

species(
    label = 'CC=CC1C=[C]C1(7897)',
...
species(
    label = '[CH2]C=C[C]1C=CC1(7898)',
    structure = SMILES('[CH2]C=CC1=C[CH]C1'),
    E0 = (441.248,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,2995,3025,975,1000,1300,1375,400,500,1630,1680,3000,3100,440,815,1455,1000,180,1062.85,1062.85,1062.85,1062.85,1062.85,1062.85,1062.85,1062.85,1062.85,1062.85,1062.85,2242.48],'cm^-1')),
        HinderedRotor(inertia=(0.0431736,'amu*angstrom^2'), symmetry=1, barrier=(0.992645,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0431736,'amu*angstrom^2'), symmetry=1, barrier=(0.992645,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (92.1384,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.74702,0.0267783,7.52825e-05,-1.20525e-07,4.9139e-11,53171.8,21.0743], Tmin=(100,'K'), Tmax=(944.954,'K')), NASAPolynomial(coeffs=[16.942,0.0200656,-5.50765e-06,9.8793e-10,-7.71154e-14,47728,-64.9818], Tmin=(944.954,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(441.248,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(349.208,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + ring(Cyclobutene) + radical(cyclobutene-allyl) + radical(C=CC=CCJ)"""),
)

species(
    label = '[CH2]C=CC1[CH]C=C1(1736)',
    structure = SMILES('[CH2]C=CC1[CH]C=C1'),
    E0 = (496.186,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,2995,3025,975,1000,1300,1375,400,500,1630,1680,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    ...
    molecularWeight = (92.1384,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.59484,0.0366263,3.4881e-05,-6.95442e-08,2.84835e-11,59778.5,20.5525], Tmin=(100,'K'), Tmax=(982.485,'K')), NASAPolynomial(coeffs=[13.8796,0.0262568,-9.81615e-06,1.8569e-09,-1.36014e-13,55451.1,-48.2352], Tmin=(982.485,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(496.186,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(349.208,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)CsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cyclobutene) + radical(Allyl_P) + radical(cyclobutene-allyl)"""),
)

species(
    label = '[CH2]C=CC1[C]=CC1(7899)',
    ...
    molecularWeight = (92.1384,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.34511,0.0466563,4.93129e-07,-3.10751e-08,1.43045e-11,70360.3,23.0299], Tmin=(100,'K'), Tmax=(1015.99,'K')), NASAPolynomial(coeffs=[12.7983,0.0279921,-1.09684e-05,2.04779e-09,-1.45697e-13,66669.1,-39.1191], Tmin=(1015.99,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(584.129,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(349.208,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)CsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cyclobutene) + radical(cyclobutene-vinyl) + radical(Allyl_P)"""),
)

species(
    label = '[CH2]C=[C]C1C=CC1(7900)',
    structure = SMILES('[CH2]C=[C]C1C=CC1'),
    E0 = (569.485,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,1685,370,2750,2850,2950,3050,3150,900,950,1000,1050,1100,3010,987.5,1337.5,450,1655,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    ...
    molecularWeight = (92.1384,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.34511,0.0466563,4.93129e-07,-3.10751e-08,1.43045e-11,68599,23.0299], Tmin=(100,'K'), Tmax=(1015.99,'K')), NASAPolynomial(coeffs=[12.7983,0.0279921,-1.09684e-05,2.04779e-09,-1.45697e-13,64907.8,-39.1191], Tmin=(1015.99,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(569.485,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(349.208,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)CsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cyclobutene) + radical(Allyl_P) + radical(Cds_S)"""),
)

species(
    label = '[CH2]C=CC1C=[C]C1(7901)',
    structure = SMILES('[CH2]C=CC1C=[C]C1'),
    E0 = (584.129,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,2995,3025,975,1000,1300,1375,400,500,1630,1680,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2][C]=CC1C=CC1(7902)',
    structure = SMILES('[CH2][C]=CC1C=CC1'),
    E0 = (569.485,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,2950,3050,3150,900,950,1000,1050,1100,1685,370,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
...
species(
    ...
    molecularWeight = (92.1384,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.37965,0.0444544,1.72166e-05,-4.77466e-08,1.96254e-11,66355.2,23.2607], Tmin=(100,'K'), Tmax=(1012.62,'K')), NASAPolynomial(coeffs=[11.6303,0.0346502,-1.37181e-05,2.54717e-09,-1.80044e-13,62705.8,-34.0899], Tmin=(1012.62,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(550.828,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(349.208,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)CsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cyclobutene) + radical(AllylJ2_triplet)"""),
)

species(
    label = 'C=CC=C1C=CC1(7904)',
    structure = SMILES('C=CC=C1C=CC1'),
    E0 = (271.496,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,3100,1380,975,1025,1650,2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,2995,3025,975,1000,1300,1375,400,500,1630,1680,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (92.1384,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.35136,0.0338917,6.38557e-05,-1.17499e-07,5.0406e-11,32771.2,20.6552], Tmin=(100,'K'), Tmax=(935.496,'K')), NASAPolynomial(coeffs=[20.7945,0.0128323,-1.91095e-06,2.99688e-10,-2.9843e-14,26417.1,-86.3683], Tmin=(935.496,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(271.496,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(353.365,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + ring(Cyclobutene)"""),
)
...
species(
    label = 'C=CC1C2[CH]C1C2(7905)',
    structure = SMILES('C=CC1C2[CH]C1C2'),
    E0 = (496.145,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (93.1464,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.36193,0.0138296,9.99411e-05,-1.32229e-07,4.90917e-11,59751.3,19.9759], Tmin=(100,'K'), Tmax=(980.258,'K')), NASAPolynomial(coeffs=[12.144,0.0302929,-1.15238e-05,2.25093e-09,-1.6915e-13,55124.7,-40.8387], Tmin=(980.258,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(496.145,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(378.308,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + polycyclic(s3_4_4_ane) + radical(bicyclo[1.1.1]pentane-C2)"""),
)

species(
    label = 'C=CC1C2[CH]CC21(7906)',
    structure = SMILES('C=CC1C2[CH]CC21'),
    E0 = (415.034,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (93.1464,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.12015,0.0222479,7.42825e-05,-1.04964e-07,3.93507e-11,50001.7,21.7337], Tmin=(100,'K'), Tmax=(989.024,'K')), NASAPolynomial(coeffs=[11.7563,0.0312554,-1.21472e-05,2.34613e-09,-1.7327e-13,45749,-36.5121], Tmin=(989.024,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(415.034,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(378.308,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + polycyclic(s2_3_4_ane) + radical(bicyclo[2.1.0]pentane-secondary-C4)"""),
)
...
species(
    label = '[CH]C1C=CC1(7907)',
    structure = SMILES('[CH]C1C=CC1'),
    E0 = (560.931,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,2950,3050,3150,900,950,1000,1050,1100,300,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (66.1011,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.67097,0.0120704,6.74537e-05,-9.77905e-08,3.86866e-11,67527.9,16.3807], Tmin=(100,'K'), Tmax=(948.035,'K')), NASAPolynomial(coeffs=[12.6426,0.013527,-3.72384e-06,6.94223e-10,-5.58676e-14,63681,-41.5113], Tmin=(948.035,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(560.931,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(253.591,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cyclobutene) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH2]C1CC=CC1=C(7935)',
    structure = SMILES('[CH2]C1CC=CC1=C'),
    E0 = (270.287,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (93.1464,'amu'),
...
species(
    label = 'C=C=C=CCC=C(7936)',
    structure = SMILES('C=C=C=CCC=C'),
    E0 = (369.907,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2995,3025,975,1000,1300,1375,400,500,1630,1680,540,563.333,586.667,610,1970,2140,2950,3000,3050,3100,1330,1430,900,1050,1000,1050,1600,1700,180,180],'cm^-1')),
        HinderedRotor(inertia=(1.00243,'amu*angstrom^2'), symmetry=1, barrier=(23.0478,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.00894,'amu*angstrom^2'), symmetry=1, barrier=(23.1976,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (92.1384,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.868855,0.0601342,-4.01832e-05,1.18495e-08,-9.19007e-13,44609.5,25.7921], Tmin=(100,'K'), Tmax=(1231.24,'K')), NASAPolynomial(coeffs=[13.9059,0.0269044,-1.08158e-05,1.96712e-09,-1.34515e-13,40707.6,-42.6245], Tmin=(1231.24,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(369.907,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(349.208,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + group(Cdd-CdsCds)"""),
)

species(
    label = 'C#CC=CCC=C(7937)',
    structure = SMILES('C#CC=CCC=C'),
    E0 = (317.308,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,750,770,3400,2100,2995,3010,3025,975,987.5,1000,1300,1337.5,1375,400,450,500,1630,1655,1680,2175,525,2950,3100,1380,975,1025,1650,180,180],'cm^-1')),
        HinderedRotor(inertia=(1.08999,'amu*angstrom^2'), symmetry=1, barrier=(25.0611,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.09032,'amu*angstrom^2'), symmetry=1, barrier=(25.0686,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.09006,'amu*angstrom^2'), symmetry=1, barrier=(25.0625,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (92.1384,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.06366,0.052401,-1.02385e-05,-2.44895e-08,1.3023e-11,38279.7,24.8934], Tmin=(100,'K'), Tmax=(1007.32,'K')), NASAPolynomial(coeffs=[14.8179,0.024881,-9.60885e-06,1.79869e-09,-1.28933e-13,34134,-48.3872], Tmin=(1007.32,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(317.308,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCtH) + group(Cds-CdsHH) + group(Ct-Ct(Cds-Cds)) + group(Ct-CtH)"""),
)
...
species(
    label = 'C=[C][C]=CCC=C(7940)',
    structure = SMILES('[CH2]C#C[CH]CC=C'),
    E0 = (490.24,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2950,3100,1380,975,1025,1650,3010,987.5,1337.5,450,1655,2100,2250,500,550,3000,3100,440,815,1455,1000,2750,2850,1437.5,1250,1305,750,350,679.938,679.97,2985.45],'cm^-1')),
        HinderedRotor(inertia=(0.217708,'amu*angstrom^2'), symmetry=1, barrier=(14.1501,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(3.43823,'amu*angstrom^2'), symmetry=1, barrier=(79.0518,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(3.43822,'amu*angstrom^2'), symmetry=1, barrier=(79.0515,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.240961,'amu*angstrom^2'), symmetry=1, barrier=(79.052,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (92.1384,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.18661,0.0551577,-2.84008e-05,-1.37882e-09,4.74494e-12,59069.5,27.2966], Tmin=(100,'K'), Tmax=(968.813,'K')), NASAPolynomial(coeffs=[11.2235,0.0284962,-1.00021e-05,1.70553e-09,-1.13931e-13,56431.2,-24.3868], Tmin=(968.813,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(490.24,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-CtCsHH) + group(Cs-CtHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Ct-CtCs) + group(Ct-CtCs) + radical(Propargyl) + radical(Sec_Propargyl)"""),
)

species(
    label = '[CH]=CCC=C[C]=C(7941)',
...
species(
    label = '[CH]=[C]C=CCC=C(7942)',
    structure = SMILES('[CH]=C=C[CH]CC=C'),
    E0 = (499.868,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2995,3025,975,1000,1300,1375,400,500,1630,1680,2950,3100,1380,975,1025,1650,2750,2850,1437.5,1250,1305,750,350,3120,650,792.5,1650,540,610,2055,180,365.575],'cm^-1')),
        HinderedRotor(inertia=(0.792938,'amu*angstrom^2'), symmetry=1, barrier=(18.2312,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.792942,'amu*angstrom^2'), symmetry=1, barrier=(18.2313,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0923256,'amu*angstrom^2'), symmetry=1, barrier=(77.6223,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (92.1384,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.0704,0.0554199,-2.42674e-05,-6.91507e-09,6.45175e-12,60233.6,25.9359], Tmin=(100,'K'), Tmax=(1014.56,'K')), NASAPolynomial(coeffs=[12.8333,0.0275086,-1.03012e-05,1.84653e-09,-1.27546e-13,56896.4,-35.6668], Tmin=(1014.56,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(499.868,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(Allyl_S) + radical(C=C=CJ)"""),
)

species(
    label = 'C=CCC1[CH]C1=C(7943)',
    structure = SMILES('C=CCC1[CH]C1=C'),
    E0 = (376.527,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (93.1464,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.43779,0.0382602,4.07348e-05,-7.98883e-08,3.30933e-11,45394.2,22.5353], Tmin=(100,'K'), Tmax=(970.108,'K')), NASAPolynomial(coeffs=[15.2031,0.0260206,-9.17486e-06,1.71389e-09,-1.26269e-13,40628.6,-54.2532], Tmin=(970.108,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(376.527,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(374.151,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + ring(Methylene_cyclopropane) + radical(Allyl_S)"""),
)
...
species(
    ...
    molecularWeight = (93.1464,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.34442,0.0411398,3.37939e-05,-7.60375e-08,3.31455e-11,51487,25.0752], Tmin=(100,'K'), Tmax=(945.386,'K')), NASAPolynomial(coeffs=[15.6948,0.0236835,-7.14933e-06,1.23862e-09,-8.96171e-14,46840.5,-53.5756], Tmin=(945.386,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(427.162,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(374.151,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-(Cds-Cdd-Cd)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + ring(Cyclopropane) + radical(Isobutyl)"""),
)
...
species(
    label = 'C=C=CC[CH]C=C(7945)',
    structure = SMILES('[CH2]C=CCC=C=C'),
    E0 = (344.802,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2950,3100,1380,975,1025,1650,2995,3010,3025,975,987.5,1000,1300,1337.5,1375,400,450,500,1630,1655,1680,540,610,2055,3000,3100,440,815,1455,1000,237.794,237.963],'cm^-1')),
        HinderedRotor(inertia=(0.499854,'amu*angstrom^2'), symmetry=1, barrier=(20.0604,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.499966,'amu*angstrom^2'), symmetry=1, barrier=(20.0606,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.500042,'amu*angstrom^2'), symmetry=1, barrier=(20.0605,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (93.1464,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.914151,0.0571207,-2.01275e-05,-1.22247e-08,7.98944e-12,41590.4,26.8485], Tmin=(100,'K'), Tmax=(1047.87,'K')), NASAPolynomial(coeffs=[13.7878,0.0296337,-1.17793e-05,2.18573e-09,-1.53734e-13,37703.5,-41.5347], Tmin=(1047.87,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(344.802,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(369.994,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(Allyl_P)"""),
)

species(
    label = 'C=C=[C]CCC=C(7946)',
    ...
    molecularWeight = (93.1464,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.10823,0.0552223,-2.28535e-05,-5.70814e-09,5.29255e-12,41488.5,27.7411], Tmin=(100,'K'), Tmax=(1041.38,'K')), NASAPolynomial(coeffs=[11.4387,0.0316042,-1.19697e-05,2.13531e-09,-1.4603e-13,38465.9,-26.6981], Tmin=(1041.38,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(344.029,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-CtCsHH) + group(Cs-CtHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Ct-CtCs) + group(Ct-CtCs) + radical(Propargyl)"""),
)

species(
    label = 'C=[C]CCC=C=C(7947)',
    structure = SMILES('C=[C]CCC=C=C'),
    E0 = (442.12,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,1685,370,3010,987.5,1337.5,450,1655,540,610,2055,2950,3000,3050,3100,1330,1430,900,1050,1000,1050,1600,1700,294.602,294.646,296.061],'cm^-1')),
        HinderedRotor(inertia=(0.224773,'amu*angstrom^2'), symmetry=1, barrier=(13.9041,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.22672,'amu*angstrom^2'), symmetry=1, barrier=(13.9075,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.225641,'amu*angstrom^2'), symmetry=1, barrier=(13.9063,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (93.1464,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.964073,0.0625494,-4.36541e-05,1.57365e-08,-2.34245e-12,53287.2,27.2743], Tmin=(100,'K'), Tmax=(1535.62,'K')), NASAPolynomial(coeffs=[13.1234,0.0308766,-1.27159e-05,2.30517e-09,-1.55815e-13,49552.8,-36.603], Tmin=(1535.62,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(442.12,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(369.994,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(Cds_S)"""),
)

species(
    label = '[CH]=CCCC=C=C(7948)',
    structure = SMILES('[CH]=CCCC=C=C'),
    E0 = (451.375,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3120,650,792.5,1650,2995,3025,975,1000,1300,1375,400,500,1630,1680,540,610,2055,2950,3100,1380,975,1025,1650,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.68382,'amu*angstrom^2'), symmetry=1, barrier=(15.7224,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (93.1464,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.618173,0.0648506,-4.644e-05,1.694e-08,-2.49522e-12,54417.5,28.4612], Tmin=(100,'K'), Tmax=(1592.29,'K')), NASAPolynomial(coeffs=[15.8848,0.0264992,-1.03115e-05,1.81361e-09,-1.2027e-13,49555.7,-52.2932], Tmin=(1592.29,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(451.375,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(369.994,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(Cds_P)"""),
)

species(
    label = '[CH]=C=CCCC=C(7949)',
    structure = SMILES('C#C[CH]CCC=C'),
    E0 = (352.233,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2175,525,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,750,770,3400,2100,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,357.035,357.727,358.747],'cm^-1')),
...
species(
    label = '[CH2]C(C=C)C=C=C(7951)',
    structure = SMILES('[CH2]C(C=C)C=C=C'),
    E0 = (400.841,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2950,3000,3050,3100,1330,1430,900,1050,1000,1050,1600,1700,1380,1390,370,380,2900,435,540,610,2055,2995,3025,975,1000,1300,1375,400,500,1630,1680,180,180],'cm^-1')),
...
reaction(
    label = 'reaction1',
    reactants = ['H(3)(3)', 'C1=CC=CCCC=1(1040)'],
...
reaction(
    label = 'reaction10',
    reactants = ['C7H9(449)(448)'],
    products = ['C7H9(424)(423)'],
    transitionState = 'TS33',
    kinetics = Arrhenius(A=(570153,'s^-1'), n=1.88833, Ea=(191.836,'kJ/mol'), T0=(1,'K'), comment="""Estimated using average of templates [R4H;C_rad_out_H/NonDeC;Cs_H_out_H/Cd] + [R4H_SDS;C_rad_out_single;Cs_H_out_H/Cd] + [R4H_SDS;C_rad_out_H/NonDeC;Cs_H_out_1H] for rate rule [R4H_SDS;C_rad_out_H/NonDeC;Cs_H_out_H/Cd]
Euclidian distance = 2.0
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)(3)', '[CH]1[CH]CC=CC=C1(1035)'],
    products = ['C7H9(424)(423)'],
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)(3)', '[C]1=C[CH]C=CCC1(1041)'],
    products = ['C7H9(424)(423)'],
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)(3)', '[C]1[CH]C=CCCC=1(1042)'],
    products = ['C7H9(424)(423)'],
...
reaction(
    label = 'reaction11',
    reactants = ['C7H9(424)(423)'],
    products = ['[CH]1C2C=CCCC12(1046)'],
    transitionState = 'TS37',
    kinetics = Arrhenius(A=(8.00127e+13,'s^-1'), n=-0.283562, Ea=(245.321,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Rn0cx_beta;doublebond_intra_pri_HNd_Cs;radadd_intra_csHDe] for rate rule [Rn0c7_beta_short;doublebond_intra_pri_HNd_Cs;radadd_intra_csHCd]
Euclidian distance = 1.41421356237
Multiplied by reaction path degeneracy 2.0
family: Intra_R_Add_Endocyclic"""),
)
...
reaction(
    label = 'reaction23',
    reactants = ['H(3)(3)', '[C]1=C[CH]CCC=C1(1043)'],
    products = ['C7H9(424)(423)'],
...
reaction(
    label = 'reaction2',
    reactants = ['C7H9(424)(423)'],
    products = ['H(3)(3)', 'C7H8(415)(414)'],
    transitionState = 'TS40',
    kinetics = Arrhenius(A=(3.58e+10,'s^-1'), n=1.38, Ea=(48.4,'kcal/mol'), T0=(1,'K'), comment="""Matched reaction 20 C7H9-12 <=> C7H8-8 + H in R_Addition_MultipleBond/training
...
reaction(
    label = 'reaction41',
    reactants = ['C7H9(424)(423)'],
    products = ['C7H9(408)(407)'],
    transitionState = 'TS41',
    kinetics = Arrhenius(A=(5.11e+09,'s^-1'), n=1.34, Ea=(47.7,'kcal/mol'), T0=(1,'K'), comment="""Matched reaction 9 C7H9-11 <=> C7H9-12 in intra_H_migration/training
This reaction matched rate rule [R2H_S;C_rad_out_H/(Cd-Cd-Cd);Cs_H_out_H/NonDeC]
family: intra_H_migration"""),
)
...
reaction(
    label = 'reaction16',
    reactants = ['[CH]1C=CC2CCC12(1048)'],
    products = ['C7H9(424)(423)'],
    transitionState = 'TS45',
    kinetics = Arrhenius(A=(1.56e+11,'s^-1'), n=0.55, Ea=(26.5,'kcal/mol'), T0=(1,'K'), comment="""Matched reaction 112 C7H9-17 <=> C7H9-18 in Intra_R_Add_Endocyclic/training
This reaction matched rate rule [Rn0c7_gamma_long_SSS_D;doublebond_intra_pri_HNd_Cs;radadd_intra_csHCs]
family: Intra_R_Add_Endocyclic"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)(3)', '[C]1=CC=CC[CH]C1(1036)'],
    products = ['C7H9(408)(407)'],
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)(3)', '[C]1=CC[CH]CC=C1(1037)'],
    products = ['C7H9(408)(407)'],
...
reaction(
    label = 'reaction9',
    reactants = ['[CH]1CC2CC=CC12(1038)'],
    products = ['C7H9(408)(407)'],
    transitionState = 'TS53',
    kinetics = Arrhenius(A=(1.01e+11,'s^-1'), n=0.59, Ea=(21.3,'kcal/mol'), T0=(1,'K'), comment="""Matched reaction 116 C7H9-25 <=> C7H9-26 in Intra_R_Add_Endocyclic/training
This reaction matched rate rule [Rn0c7_gamma_short_SSDS_D;doublebond_intra_pri_HCd;radadd_intra_csHCs]
family: Intra_R_Add_Endocyclic"""),
)
...
reaction(
    label = 'reaction13',
    reactants = ['H(3)(3)', '[C]1CC=CC=CC1(1039)'],
    products = ['C7H9(408)(407)'],
...
reaction(
    label = 'reaction32',
    reactants = ['H(3)(3)', 'C1=CCC=CCC=1(1094)'],
    products = ['C7H9(449)(448)'],
...
reaction(
    label = 'reaction36',
    reactants = ['H(3)(3)', '[C]1=CCC=C[CH]C1(1095)'],
    products = ['C7H9(449)(448)'],
...
reaction(
    label = 'reaction65',
    reactants = ['H(3)(3)', '[C]1=C[CH]CC=CC1(1096)'],
    products = ['C7H9(449)(448)'],
...
reaction(
    label = 'reaction38',
    reactants = ['H(3)(3)', '[C]1[CH]CC=CCC=1(1097)'],
    products = ['C7H9(449)(448)'],
...
reaction(
    label = 'reaction40',
    reactants = ['C7H9(449)(448)'],
    products = ['C7H9(460)(459)'],
    transitionState = 'TS68',
    kinetics = Arrhenius(A=(1.08454e+19,'s^-1'), n=-0.859165, Ea=(130.857,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Rn0c7_gamma_short;doublebond_intra_pri;radadd_intra_cs] for rate rule [Rn0c7_gamma_short;doublebond_intra_pri_HNd_Cs;radadd_intra_csHCd]
Euclidian distance = 2.82842712475
Multiplied by reaction path degeneracy 2.0
family: Intra_R_Add_Endocyclic"""),
)
...
reaction(
    ...
    kinetics = Arrhenius(A=(4.2e+12,'s^-1'), n=0.14, Ea=(73.8271,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Rn0c7_beta_long_SS_D;doublebond_intra_pri_HNd_Cs;radadd_intra] for rate rule [Rn0c7_beta_long_SS_D;doublebond_intra_pri_HNd_Cs;radadd_intra_csHCs]
Euclidian distance = 3.0
Multiplied by reaction path degeneracy 2.0
family: Intra_R_Add_Endocyclic"""),
)
...
reaction(
    label = 'reaction44',
    reactants = ['H(3)(3)', 'C1=CC2CC2=CC1(1099)'],
    products = ['C7H9(452)(451)'],
...
reaction(
    label = 'reaction45',
    reactants = ['H(3)(3)', 'C1C=CC2CC2C=1(1100)'],
    products = ['C7H9(452)(451)'],
    transitionState = 'TS73',
    kinetics = Arrhenius(A=(2334.12,'m^3/(mol*s)'), n=1.41424, Ea=(5.49872,'kJ/mol'), T0=(1,'K'), Tmin=(303.03,'K'), Tmax=(2000,'K'), comment="""From training reaction 103 used for Cds-CdH_Cds-(CsH-Cs-Cds)_cyc6;HJ
Exact match found for rate rule [Cds-CdH_Cds-(CsH-Cs-Cds)_cyc6;HJ]
Euclidian distance = 0
Multiplied by reaction path degeneracy 2.0
family: R_Addition_MultipleBond"""),
)
...
reaction(
    label = 'reaction52',
    reactants = ['H(3)(3)', '[CH]1CC=CC2C[C]12(1105)'],
    products = ['C7H9(452)(451)'],
...
reaction(
    label = 'reaction53',
    reactants = ['H(3)(3)', '[CH]1CC=C[C]2CC12(1106)'],
    products = ['C7H9(452)(451)'],
...
reaction(
    label = 'reaction54',
    reactants = ['H(3)(3)', '[CH]1CC=CC2[CH]C12(1107)'],
    products = ['C7H9(452)(451)'],
...
reaction(
    label = 'reaction55',
    reactants = ['H(3)(3)', '[CH]1[CH]C2CC2C=C1(1108)'],
    products = ['C7H9(452)(451)'],
...
reaction(
    label = 'reaction56',
    reactants = ['H(3)(3)', '[C]1=CC[CH]C2CC12(1109)'],
    products = ['C7H9(452)(451)'],
...
reaction(
    label = 'reaction57',
    reactants = ['H(3)(3)', '[C]1=CC2CC2[CH]C1(1110)'],
    products = ['C7H9(452)(451)'],
...
reaction(
    label = 'reaction58',
    reactants = ['C7H9(452)(451)'],
    products = ['[CH]1CC2C1C1CC21(1111)'],
    transitionState = 'TS86',
    kinetics = Arrhenius(A=(5.4227e+18,'s^-1'), n=-0.859165, Ea=(151.157,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Rn0cx_gamma;doublebond_intra_pri;radadd_intra_csHCs] for rate rule [Rn0c6_gamma;doublebond_intra_pri_HNd_Cs;radadd_intra_csHCs]
Euclidian distance = 2.2360679775
family: Intra_R_Add_Endocyclic
...
reaction(
    label = 'reaction59',
    reactants = ['C7H9(452)(451)'],
    products = ['[CH]1C2CC2C2CC12(1112)'],
    transitionState = 'TS87',
    kinetics = Arrhenius(A=(1.307e+12,'s^-1'), n=0.256, Ea=(153.959,'kJ/mol'), T0=(1,'K'), comment="""From training reaction 83 used for Rn0c6_beta_long_SS_D_HH;doublebond_intra_pri_HNd_Cs;radadd_intra_csHCs
...
reaction(
    label = 'reaction65',
    reactants = ['[CH2]C1C=CC2CC12(1115)'],
    products = ['C7H9(452)(451)'],
...
reaction(
    label = 'reaction66',
    reactants = ['H(3)(3)', '[C]1CC=CC2CC12(1116)'],
    products = ['C7H9(452)(451)'],
...
reaction(
    label = 'reaction68',
    reactants = ['H(3)(3)', 'C=C1C=CCC=C1(1117)'],
    products = ['C7H9(453)(452)'],
...
reaction(
    label = 'reaction73',
    reactants = ['H(3)(3)', '[CH2][C]1C=CCC=C1(1121)'],
    products = ['C7H9(453)(452)'],
...
reaction(
    label = 'reaction75',
    reactants = ['H(3)(3)', '[CH2]C1[C]=CCC=C1(1123)'],
    products = ['C7H9(453)(452)'],
...
reaction(
    label = 'reaction76',
    reactants = ['H(3)(3)', '[CH2]C1C=[C]CC=C1(1124)'],
    products = ['C7H9(453)(452)'],
...
reaction(
    label = 'reaction80',
    reactants = ['H(3)(3)', '[CH]C1C=CCC=C1(1125)'],
    products = ['C7H9(453)(452)'],
...
reaction(
    label = 'reaction81',
    reactants = ['H(3)(3)', 'C1=CC2CC=C2C1(1126)'],
    products = ['C7H9(460)(459)'],
...
reaction(
    label = 'reaction89',
    reactants = ['H(3)(3)', '[CH]1CC2C=CC[C]12(1131)'],
    products = ['C7H9(460)(459)'],
...
reaction(
    label = 'reaction90',
    reactants = ['H(3)(3)', '[CH]1C[C]2C=CCC12(1132)'],
    products = ['C7H9(460)(459)'],
...
reaction(
    label = 'reaction91',
    reactants = ['H(3)(3)', '[CH]1[CH]C2CC=CC12(1133)'],
    products = ['C7H9(460)(459)'],
...
reaction(
    label = 'reaction92',
    reactants = ['H(3)(3)', '[CH]1C=CC2C[CH]C12(1134)'],
    products = ['C7H9(460)(459)'],
...
reaction(
    label = 'reaction93',
    reactants = ['H(3)(3)', '[C]1=CCC2[CH]CC12(1135)'],
    products = ['C7H9(460)(459)'],
...
reaction(
    label = 'reaction94',
    reactants = ['H(3)(3)', '[C]1=CC2C[CH]C2C1(1136)'],
    products = ['C7H9(460)(459)'],
...
reaction(
    label = 'reaction95',
    reactants = ['C7H9(460)(459)'],
    products = ['[CH]1C2CC3C1CC23(1137)'],
    transitionState = 'TS123',
    kinetics = Arrhenius(A=(8.03578e+12,'s^-1'), n=-0.324073, Ea=(180.216,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R5_cyclic;doublebond_intra_pri_HNd_Cs;radadd_intra_csHCs] for rate rule [Rn1c5_beta_long;doublebond_intra_pri_HNd_Cs;radadd_intra_csHCs]
Euclidian distance = 1.0
family: Intra_R_Add_Endocyclic"""),
)
...
reaction(
    label = 'reaction100',
    reactants = ['[CH2]C1C2C=CCC12(1140)'],
    products = ['C7H9(460)(459)'],
...
reaction(
    label = 'reaction101',
    reactants = ['H(3)(3)', '[C]1CC2C=CCC12(1141)'],
    products = ['C7H9(460)(459)'],
...
reaction(
    label = 'reaction131',
    reactants = ['H(3)(3)', 'CC1C=C=CC=C1(1142)'],
    products = ['C7H9(527)(526)'],
...
reaction(
    label = 'reaction111',
    reactants = ['CH3(15)(16)', '[CH]1[CH]C=CC=C1(1148)'],
    products = ['C7H9(527)(526)'],
    transitionState = 'TS139',
    kinetics = Arrhenius(A=(8.06808e+07,'m^3/(mol*s)'), n=0.0549843, Ea=(0.0928142,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [Y_rad;C_methyl]
Euclidian distance = 0
...
reaction(
    label = 'reaction142',
    reactants = ['H(3)(3)', 'CC1[C]=CC=C[CH]1(1149)'],
    products = ['C7H9(527)(526)'],
...
reaction(
    label = 'reaction143',
    reactants = ['H(3)(3)', 'CC1[CH]C=C[C]=C1(1150)'],
    products = ['C7H9(527)(526)'],
...
reaction(
    label = 'reaction116',
    reactants = ['H(3)(3)', 'CC1[CH]C=[C]C=C1(1151)'],
    products = ['C7H9(527)(526)'],
...
reaction(
    label = 'reaction119',
    reactants = ['CC1C2[CH]C=CC12(1153)'],
    products = ['C7H9(527)(526)'],
...
reaction(
    label = 'reaction127',
    reactants = ['H(3)(3)', 'CC1=CC2C=CC12(1157)'],
    products = ['C7H9(536)(535)'],
...
reaction(
    label = 'reaction128',
    reactants = ['H(3)(3)', 'CC1C=C2C=CC21(1158)'],
    products = ['C7H9(536)(535)'],
...
reaction(
    label = 'reaction129',
    reactants = ['CH3(15)(16)', 'C1=CC2C=CC12(1159)'],
    products = ['C7H9(536)(535)'],
    transitionState = 'TS157',
    kinetics = Arrhenius(A=(40400,'cm^3/(mol*s)'), n=2.41, Ea=(28.4512,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""Estimated using template [Cds-CsH_Cds-CsH;CsJ-HHH] for rate rule [Cds-CsH_Cds-(CsH-Cds-Cds)_cyc6;CsJ-HHH]
Euclidian distance = 1.0
Multiplied by reaction path degeneracy 4.0
family: R_Addition_MultipleBond"""),
)
...
reaction(
    label = 'reaction130',
    reactants = ['C7H9(536)(535)'],
    products = ['C[C]1CC2C=CC12(1160)'],
...
reaction(
    label = 'reaction132',
    reactants = ['C7H9(536)(535)'],
    products = ['CC1CC2C=C[C]12(1162)'],
    transitionState = 'TS160',
    kinetics = Arrhenius(A=(7.27e+09,'s^-1'), n=0.66, Ea=(144.766,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""Estimated using an average for rate rule [R3H_SS_Cs;C_rad_out_H/NonDeC;Cs_H_out_noH]
Euclidian distance = 0
family: intra_H_migration"""),
)
...
reaction(
    label = 'reaction133',
    reactants = ['[CH2]C1CC2C=CC12(1163)'],
    products = ['C7H9(536)(535)'],
    transitionState = 'TS161',
    kinetics = Arrhenius(A=(1.064e+06,'s^-1'), n=1.93, Ea=(141.419,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R3H_SS;C_rad_out_2H;Cs_H_out_H/(NonDeC/Cs)] for rate rule [R3H_SS_23cy4;C_rad_out_2H;Cs_H_out_H/(NonDeC/Cs)]
Euclidian distance = 1.0
Multiplied by reaction path degeneracy 2.0
family: intra_H_migration"""),
)
...
reaction(
    label = 'reaction134',
    reactants = ['CC1CC2[C]=CC12(1164)'],
    products = ['C7H9(536)(535)'],
    transitionState = 'TS162',
    kinetics = Arrhenius(A=(3.32e+09,'s^-1'), n=0.99, Ea=(141.419,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""Estimated using template [R3H_SS;Cd_rad_out_Cd;Cs_H_out_H/NonDeC] for rate rule [R3H_SS_12cy4;Cd_rad_out_Cd;Cs_H_out_H/(NonDeC/Cs/Cs)]
Euclidian distance = 2.2360679775
Multiplied by reaction path degeneracy 2.0
family: intra_H_migration"""),
)
...
reaction(
    label = 'reaction136',
    reactants = ['H(3)(3)', 'CC1[CH]C2C=C[C]12(1166)'],
    products = ['C7H9(536)(535)'],
...
reaction(
    label = 'reaction137',
    reactants = ['CH3(15)(16)', '[CH]1[CH]C2C=CC12(1167)'],
    products = ['C7H9(536)(535)'],
...
reaction(
    label = 'reaction138',
    reactants = ['H(3)(3)', 'C[C]1[CH]C2C=CC12(1168)'],
    products = ['C7H9(536)(535)'],
...
reaction(
    label = 'reaction139',
    reactants = ['H(3)(3)', 'CC1[CH][C]2C=CC21(1169)'],
    products = ['C7H9(536)(535)'],
...
reaction(
    label = 'reaction140',
    reactants = ['H(3)(3)', '[CH2]C1[CH]C2C=CC12(1170)'],
    products = ['C7H9(536)(535)'],
...
reaction(
    label = 'reaction141',
    reactants = ['H(3)(3)', 'CC1[CH]C2C=[C]C12(1171)'],
    products = ['C7H9(536)(535)'],
...
reaction(
    label = 'reaction142',
    reactants = ['H(3)(3)', 'CC1[CH]C2[C]=CC12(1172)'],
    products = ['C7H9(536)(535)'],
...
reaction(
    label = 'reaction143',
    reactants = ['C7H9(536)(535)'],
    products = ['CC1C2C3[CH]C2C13(1173)'],
...
reaction(
    label = 'reaction144',
    reactants = ['C7H9(536)(535)'],
    products = ['CC1C2[CH]C3C1C23(1174)'],
    transitionState = 'TS172',
    kinetics = Arrhenius(A=(2.26887e+10,'s^-1'), n=0.505957, Ea=(215.516,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [Rn0c6_beta_long_SS_D;doublebond_intra_pri_HNd_Cs;radadd_intra_csHCs]
Euclidian distance = 0
family: Intra_R_Add_Endocyclic
...
reaction(
    label = 'reaction145',
    reactants = ['CC=CC1[CH]C=C1(1175)'],
    products = ['C7H9(536)(535)'],
    transitionState = 'TS173',
    kinetics = Arrhenius(A=(3.22e+08,'s^-1'), n=0.96, Ea=(123.01,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4_Cs_RR_D;doublebond_intra_pri_HNd_Cs;radadd_intra_cs] for rate rule [R4_Cs_RR_D;doublebond_intra_pri_HNd_Cs;radadd_intra_csHCd]
Euclidian distance = 2.0
Multiplied by reaction path degeneracy 2.0
family: Intra_R_Add_Endocyclic"""),
)
...
reaction(
    label = 'reaction147',
    reactants = ['CH2(S)(21)(22)', 'C6H7(467)(466)'],
    products = ['C7H9(536)(535)'],
...
reaction(
    label = 'reaction148',
    reactants = ['C[CH]C1C2C=CC12(1177)'],
    products = ['C7H9(536)(535)'],
...
reaction(
    label = 'reaction150',
    reactants = ['CC1C2[CH]C1C=C2(1178)'],
    products = ['C7H9(536)(535)'],
...
reaction(
    label = 'reaction151',
    reactants = ['H(3)(3)', 'CC1[C]C2C=CC12(1179)'],
    products = ['C7H9(536)(535)'],
...
reaction(
    label = 'reaction153',
    reactants = ['H(3)(3)', 'C1=CCC2CC2C=1(1180)'],
    products = ['C7H9(680)(679)'],
...
reaction(
    label = 'reaction159',
    reactants = ['H(3)(3)', '[CH]1C=CC2C[C]2C1(1181)'],
    products = ['C7H9(680)(679)'],
...
reaction(
    label = 'reaction160',
    reactants = ['H(3)(3)', '[CH]1C=C[C]2CC2C1(1182)'],
    products = ['C7H9(680)(679)'],
...
reaction(
    label = 'reaction161',
    reactants = ['H(3)(3)', '[CH]1C=CC2[CH]C2C1(1183)'],
    products = ['C7H9(680)(679)'],
...
reaction(
    label = 'reaction163',
    reactants = ['H(3)(3)', '[C]1=C[CH]CC2CC12(1184)'],
    products = ['C7H9(680)(679)'],
...
reaction(
    label = 'reaction164',
    reactants = ['H(3)(3)', '[C]1[CH]CC2CC2C=1(1185)'],
    products = ['C7H9(680)(679)'],
...
reaction(
    label = 'reaction169',
    reactants = ['H(3)(3)', '[C]1C=CC2CC2C1(1187)'],
    products = ['C7H9(680)(679)'],
...
reaction(
    label = 'reaction170',
    reactants = ['H(3)(3)', 'C1=CCC2CC2=C1(1188)'],
    products = ['C7H9(680)(679)'],
...
reaction(
    label = 'reaction259',
    reactants = ['H(3)(3)', 'C=C=CC1C=CC1(7892)'],
    products = ['C=C[CH]C1C=CC1(972)'],
...
reaction(
    label = 'reaction266',
    reactants = ['[CH]=C[CH2](891)', '[CH]1C=CC1(969)'],
    products = ['C=C[CH]C1C=CC1(972)'],
    transitionState = 'TS266',
    kinetics = Arrhenius(A=(5.42928e+07,'m^3/(mol*s)'), n=0.107721, Ea=(5.76381,'kJ/mol'), T0=(1,'K'), Tmin=(303.03,'K'), Tmax=(2000,'K'), comment="""Estimated using template [Y_rad;C_rad/H/CdCs] for rate rule [Cd_rad;C_rad/H/CdCs]
Euclidian distance = 1.0
Multiplied by reaction path degeneracy 2.0
family: R_Recombination"""),
)
...
reaction(
    label = 'reaction267',
    reactants = ['H(3)(3)', '[CH2]C=C[C]1C=CC1(7898)'],
    products = ['C=C[CH]C1C=CC1(972)'],
...
reaction(
    label = 'reaction268',
    reactants = ['H(3)(3)', '[CH2]C=CC1[CH]C=C1(1736)'],
    products = ['C=C[CH]C1C=CC1(972)'],
...
reaction(
    label = 'reaction269',
    reactants = ['H(3)(3)', '[CH2]C=CC1[C]=CC1(7899)'],
    products = ['C=C[CH]C1C=CC1(972)'],
...
reaction(
    label = 'reaction270',
    reactants = ['H(3)(3)', '[CH2]C=[C]C1C=CC1(7900)'],
    products = ['C=C[CH]C1C=CC1(972)'],
...
reaction(
    label = 'reaction271',
    reactants = ['H(3)(3)', '[CH2]C=CC1C=[C]C1(7901)'],
    products = ['C=C[CH]C1C=CC1(972)'],
...
reaction(
    label = 'reaction272',
    reactants = ['H(3)(3)', '[CH2][C]=CC1C=CC1(7902)'],
    products = ['C=C[CH]C1C=CC1(972)'],
...
reaction(
    label = 'reaction276',
    reactants = ['CH2(17)(18)', '[CH]=CC1C=CC1(6270)'],
    products = ['C=C[CH]C1C=CC1(972)'],
...
reaction(
    label = 'reaction277',
    reactants = ['H(3)(3)', '[CH]C=CC1C=CC1(7903)'],
    products = ['C=C[CH]C1C=CC1(972)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(5.41e+10,'s^-1'), n=0.21, Ea=(53.5552,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""Estimated using template [R5_DS_D;doublebond_intra;radadd_intra_cdsingleH] for rate rule [R5_DS_D;doublebond_intra_HCd_pri;radadd_intra_cdsingleH]
Euclidian distance = 3.0
family: Intra_R_Add_Exocyclic"""),
)
...
reaction(
    label = 'reaction279',
    reactants = ['H(3)(3)', 'C=CC=C1C=CC1(7904)'],
    products = ['C=C[CH]C1C=CC1(972)'],
...
reaction(
    label = 'reaction282',
    reactants = ['C=CCC1[CH]C=C1(973)'],
    products = ['C=C[CH]C1C=CC1(972)'],
    transitionState = 'TS282',
    kinetics = Arrhenius(A=(7.6e+10,'s^-1'), n=0.87, Ea=(144.348,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R3H_SS;C_rad_out_H/Cd;Cs_H_out_H/Cd] for rate rule [R3H_SS_12cy4;C_rad_out_H/Cd;Cs_H_out_H/Cd]
Euclidian distance = 1.0
Multiplied by reaction path degeneracy 4.0
family: intra_H_migration"""),
)
...
reaction(
    label = 'reaction283',
    reactants = ['C=CCC1[C]=CC1(974)'],
    products = ['C=C[CH]C1C=CC1(972)'],
    transitionState = 'TS283',
    kinetics = Arrhenius(A=(3.32e+09,'s^-1'), n=0.99, Ea=(141.419,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R3H_SS;Cd_rad_out_Cd;Cs_H_out_1H] for rate rule [R3H_SS_12cy4;Cd_rad_out_Cd;Cs_H_out_H/Cd]
Euclidian distance = 2.2360679775
Multiplied by reaction path degeneracy 2.0
family: intra_H_migration"""),
)
...
reaction(
    label = 'reaction286',
    reactants = ['C=C[CH]C1C=CC1(972)'],
    products = ['C=CC1C2[CH]C1C2(7905)'],
    transitionState = 'TS286',
    kinetics = Arrhenius(A=(5.4227e+18,'s^-1'), n=-0.859165, Ea=(164.502,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4_cyclic;doublebond_intra_pri;radadd_intra_cs] for rate rule [Rn1c4_beta;doublebond_intra_pri_HNd_Cs;radadd_intra_csHCd]
Euclidian distance = 3.46410161514
family: Intra_R_Add_Endocyclic
Ea raised from 160.7 to 164.5 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction287',
    reactants = ['C=C[CH]C1C=CC1(972)'],
    products = ['C=CC1C2[CH]CC21(7906)'],
    transitionState = 'TS287',
    kinetics = Arrhenius(A=(1.51711e+16,'s^-1'), n=-0.468007, Ea=(170.836,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R5_cyclic;doublebond_intra_pri;radadd_intra_csHCd] for rate rule [Rn1c4_alpha_long;doublebond_intra_pri;radadd_intra_csHCd]
Euclidian distance = 1.0
family: Intra_R_Add_Endocyclic"""),
)
...
reaction(
    label = 'reaction290',
    reactants = ['C2H3(28)(29)', '[CH]C1C=CC1(7907)'],
    products = ['C=C[CH]C1C=CC1(972)'],
...
reaction(
    label = 'reaction291',
    reactants = ['C=[C]C=CCC=C(918)'],
    products = ['[CH2]C1CC=CC1=C(7935)'],
    transitionState = 'TS291',
    kinetics = Arrhenius(A=(5.249e+08,'s^-1'), n=0.846, Ea=(80.7428,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R6_SMS_D;doublebond_intra_2H_pri;radadd_intra] for rate rule [R6_SMS_D;doublebond_intra_2H_pri;radadd_intra_cddouble]
Euclidian distance = 1.0
family: Intra_R_Add_Exocyclic"""),
)
...
reaction(
    label = 'reaction292',
    reactants = ['H(3)(3)', 'C=C=C=CCC=C(7936)'],
    products = ['C=[C]C=CCC=C(918)'],
...
reaction(
    label = 'reaction293',
    reactants = ['H(3)(3)', 'C#CC=CCC=C(7937)'],
    products = ['C=[C]C=CCC=C(918)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(136000,'s^-1'), n=1.9199, Ea=(33.0402,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R5H_RSMS;Cd_rad_out;XH_out] for rate rule [R5H_SSMS;Cd_rad_out_Cd;Cd_H_out_doubleC]
Euclidian distance = 3.0
family: intra_H_migration"""),
)
...
reaction(
    ...
    kinetics = Arrhenius(A=(1.24929e+07,'s^-1'), n=1.719, Ea=(309.087,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [RnH;Cd_rad_out_singleH;Cd_H_out_doubleC] for rate rule [R6H_RSSMS;Cd_rad_out_singleH;Cd_H_out_doubleC]
Euclidian distance = 3.0
family: intra_H_migration"""),
)
...
reaction(
    label = 'reaction299',
    reactants = ['C3H5(89)(88)', '[CH]C=C=C(6220)'],
    products = ['C=[C]C=CCC=C(918)'],
...
reaction(
    label = 'reaction300',
    reactants = ['C2H3(28)(29)', '[CH2]C=C[C]=C(1445)'],
    products = ['C=[C]C=CCC=C(918)'],
...
reaction(
    label = 'reaction302',
    reactants = ['H(3)(3)', 'C=[C]C=[C]CC=C(7938)'],
    products = ['C=[C]C=CCC=C(918)'],
...
reaction(
    label = 'reaction303',
    reactants = ['H(3)(3)', 'C=[C]C=CC[C]=C(7939)'],
    products = ['C=[C]C=CCC=C(918)'],
...
reaction(
    label = 'reaction304',
    reactants = ['H(3)(3)', 'C=[C][C]=CCC=C(7940)'],
    products = ['C=[C]C=CCC=C(918)'],
...
reaction(
    label = 'reaction305',
    reactants = ['H(3)(3)', '[CH]=CCC=C[C]=C(7941)'],
    products = ['C=[C]C=CCC=C(918)'],
...
reaction(
    label = 'reaction306',
    reactants = ['H(3)(3)', '[CH]=[C]C=CCC=C(7942)'],
    products = ['C=[C]C=CCC=C(918)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(5.041e+08,'s^-1'), n=0.7, Ea=(84.7093,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R6_SDS_D;doublebond_intra_pri_2H;radadd_intra] for rate rule [R6_SDS_D;doublebond_intra_pri_2H;radadd_intra_cddouble]
Euclidian distance = 1.0
family: Intra_R_Add_Endocyclic"""),
)
...
reaction(
    label = 'reaction309',
    reactants = ['[CH]=CCC=C(916)', 'H2CC(836)'],
    products = ['C=[C]C=CCC=C(918)'],
...
reaction(
    label = 'reaction310',
    reactants = ['C=[C]C=CCC=C(918)'],
    products = ['[CH2]C1CC1C=C=C(7944)'],
    transitionState = 'TS310',
    kinetics = Arrhenius(A=(1e+10,'s^-1'), n=0, Ea=(108.156,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""From training reaction 29 used for R4_S_D;doublebond_intra_2H_pri;radadd_intra_csHCd
Exact match found for rate rule [R4_S_D;doublebond_intra_2H_pri;radadd_intra_csHCd]
Euclidian distance = 0
family: Intra_R_Add_Exocyclic"""),
)
...
reaction(
    label = 'reaction312',
    reactants = ['C2H3(28)(29)', 'C=C=CC=C(1443)'],
    products = ['C=[C]C=CCC=C(918)'],
    transitionState = 'TS312',
    kinetics = Arrhenius(A=(19565,'cm^3/(mol*s)'), n=2.404, Ea=(1.75728,'kJ/mol'), T0=(1,'K'), comment="""From training reaction 100 used for Cds-HH_Cds-CdH;CdsJ-H
...
reaction(
    label = 'reaction314',
    reactants = ['C=[C]C=CCC=C(918)'],
    products = ['C=C=[C]CCC=C(7946)'],
    transitionState = 'TS314',
    kinetics = Arrhenius(A=(6.786e+11,'s^-1'), n=0.407625, Ea=(267.656,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R2H_S;C_rad_out_1H;Cd_H_out_doubleC] for rate rule [R2H_S;C_rad_out_H/NonDeC;Cd_H_out_doubleC]
Euclidian distance = 1.0
family: intra_H_migration"""),
)
...
reaction(
    label = 'reaction320',
    reactants = ['[CH2]C(C=C)C=C=C(7951)'],
    products = ['C=[C]C=CCC=C(918)'],
...
reaction(
    label = 'reaction321',
    reactants = ['H2CCCH(842)', '[CH]CC=C(6480)'],
    products = ['C=[C]C=CCC=C(918)'],
