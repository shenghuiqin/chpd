...
species(
    ...
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.09079,0.0657543,-7.43895e-05,4.81961e-08,-1.27883e-11,39464.1,25.1212], Tmin=(100,'K'), Tmax=(912.607,'K')), NASAPolynomial(coeffs=[9.86408,0.0272976,-1.11755e-05,2.01412e-09,-1.36166e-13,37862.9,-16.4019], Tmin=(912.607,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(327.265,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + radical(C=CJC=C) + radical(ROOJ)"""),
)

species(
    label = 'C=[C]C=CCO[O](2609)',
    structure = SMILES('C=C=C[CH]CO[O]'),
    E0 = (304.656,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([540,610,2055,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,2750,2850,1437.5,1250,1305,750,350,492.5,1135,1000,3025,407.5,1350,352.5,180,180],'cm^-1')),
        HinderedRotor(inertia=(1.27988,'amu*angstrom^2'), symmetry=1, barrier=(29.4269,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.28014,'amu*angstrom^2'), symmetry=1, barrier=(29.4329,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.27978,'amu*angstrom^2'), symmetry=1, barrier=(29.4246,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (98.0999,'amu'),
...
reaction(
    label = 'reaction9',
    reactants = ['CH2CHCHCH(913)', '[CH2]O[O](1428)'],
    products = ['S(213)(212)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(3)(3)', 'C=CC=C[CH]O[O](2605)'],
    products = ['S(213)(212)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(3)(3)', 'C=CC=[C]CO[O](2606)'],
    products = ['S(213)(212)'],
...
reaction(
    label = 'reaction12',
    reactants = ['C2H3(28)(29)', '[CH]=CCO[O](2607)'],
    products = ['S(213)(212)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(3)(3)', 'C=C[C]=CCO[O](2608)'],
    products = ['S(213)(212)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(3)(3)', 'C=[C]C=CCO[O](2609)'],
    products = ['S(213)(212)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(3)(3)', '[CH]=CC=CCO[O](2610)'],
    products = ['S(213)(212)'],
...
reaction(
    label = 'reaction19',
    reactants = ['S(213)(212)'],
    products = ['HO2(8)(9)', 'C=C=CC=C(1443)'],
