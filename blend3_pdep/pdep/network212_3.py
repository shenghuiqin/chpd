...
species(
    ...
    E0 = (80.0402,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2175,525,287.694,287.7,1588.42],'cm^-1')),
...
species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.73599,'amu*angstrom^2'), symmetry=1, barrier=(39.9138,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (42.0367,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.14157,0.0198351,-2.11871e-05,1.21018e-08,-2.80886e-12,50492.9,10.9044], Tmin=(100,'K'), Tmax=(1033.85,'K')), NASAPolynomial(coeffs=[6.29373,0.00763958,-3.4931e-06,6.92224e-10,-4.99135e-14,49841.2,-4.40794], Tmin=(1033.85,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(419.572,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(153.818,'J/(mol*K)'), comment="""Thermo library: Klippenstein_Glarborg2016 + radical(CdCdJ2_triplet)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['CH2CHO(38)(39)'],
    products = ['H(3)(3)', 'CH2CO(26)(27)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(1.2e+36,'s^-1'), n=-6.48, Ea=(55191,'cal/mol'), T0=(1,'K')),
)

reaction(
    label = 'reaction2',
    reactants = ['CH2CHO(38)(39)'],
    products = ['CH3CO(55)(54)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)(3)', '[CH2][C]=O(3723)'],
    products = ['CH2CHO(38)(39)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction11',
    reactants = ['OH(5)(5)', 'C2H2(T)(4186)'],
    products = ['CHCHOH(49)(49)'],
...
reaction(
    label = 'reaction1',
    reactants = ['H(3)(3)', 'CH2CO(26)(27)'],
    products = ['CH3CO(55)(54)'],
    transitionState = 'TS15',
    kinetics = Arrhenius(A=(2.3e+08,'cm^3/(mol*s)'), n=1.61, Ea=(2627,'cal/mol'), T0=(1,'K'), comment="""Reaction library: 'Klippenstein_Glarborg2016'"""),
)
...
reaction(
    label = 'reaction17',
    reactants = ['CH3CO(55)(54)'],
    products = ['CO(10)(11)', 'CH3(15)(16)'],
