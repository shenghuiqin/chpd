...
species(
    ...
    E0 = (-22.5905,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2950,3100,1380,975,1025,1650,3000,3100,440,815,1455,1000,350,440,435,1725],'cm^-1')),
...
species(
    ...
    molecularWeight = (57.0712,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.04034,0.00790373,5.42721e-05,-7.6764e-08,3.00997e-11,13816.6,11.9457], Tmin=(100,'K'), Tmax=(949.676,'K')), NASAPolynomial(coeffs=[10.3889,0.0105074,-2.84078e-06,5.34768e-10,-4.33871e-14,10907.7,-31.0939], Tmin=(949.676,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(114.49,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), comment="""Thermo library: DFT_QCI_thermo + radical(CC(C)OJ)"""),
)
...
species(
    ...
    E0 = (243.878,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2782.5,750,1395,475,1775,1000,216.297,1936.8,1938.25],'cm^-1')),
...
species(
    ...
    E0 = (123.153,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1855,455,950,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5],'cm^-1')),
...
species(
    ...
    E0 = (60.788,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,3120,650,792.5,1650,350,440,435,1725],'cm^-1')),
        HinderedRotor(inertia=(0.68423,'amu*angstrom^2'), symmetry=1, barrier=(15.7318,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (57.0712,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.30808,0.0310283,-1.27435e-05,-9.36266e-09,7.00248e-12,7377.65,13.9634], Tmin=(100,'K'), Tmax=(947.804,'K')), NASAPolynomial(coeffs=[10.9726,0.00959372,-2.76898e-06,4.65976e-10,-3.30289e-14,5055.52,-30.9588], Tmin=(947.804,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(60.788,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo library: DFT_QCI_thermo + radical(Cds_P)"""),
)
...
species(
    ...
    molecularWeight = (57.0712,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.72501,0.0206226,1.13127e-05,-2.94463e-08,1.2838e-11,7359.93,12.6928], Tmin=(100,'K'), Tmax=(964.506,'K')), NASAPolynomial(coeffs=[9.11533,0.0123126,-4.05581e-06,7.3204e-10,-5.29853e-14,5281.06,-22.2924], Tmin=(964.506,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(60.7567,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), comment="""Thermo library: DFT_QCI_thermo + radical(C2CsJOH)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['S(337)(336)'],
    products = ['[O]C1CC1(8421)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(1.34238e+09,'s^-1'), n=0.889391, Ea=(103.228,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4_S;multiplebond_intra;radadd_intra_cs2H] for rate rule [R4_S_CO;carbonylbond_intra_H;radadd_intra_cs2H]
Euclidian distance = 2.2360679775
family: Intra_R_Add_Exocyclic
Ea raised from 100.5 to 103.2 kJ/mol to match endothermicity of reaction."""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['HCO(14)(15)', 'C2H4(19)(20)'],
    products = ['S(337)(336)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(0.00310016,'m^3/(mol*s)'), n=2.49247, Ea=(21.458,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Cds-HH_Cds-HH;CJ] for rate rule [Cds-HH_Cds-HH;CO_pri_rad]
...
reaction(
    label = 'reaction4',
    reactants = ['S(337)(336)'],
    products = ['CH3CHCHO(5847)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(3.06759e+06,'s^-1'), n=1.9155, Ea=(119.238,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R2H_S;C_rad_out_2H;Cs_H_out_H/OneDe] for rate rule [R2H_S;C_rad_out_2H;Cs_H_out_H/CO]
...
reaction(
    label = 'reaction6',
    reactants = ['HCO(14)(15)', 'C2H4(T)(890)'],
    products = ['S(337)(336)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction15',
    reactants = ['C3H5O(279)(278)'],
    products = ['CH3(15)(16)', 'CH2CO(26)(27)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CH3(15)(16)', '[CH2][C]=O(3723)'],
    products = ['C3H5O(279)(278)'],
...
reaction(
    label = 'reaction20',
    reactants = ['CH2(S)(21)(22)', 'CH3CO(55)(54)'],
    products = ['C3H5O(279)(278)'],
...
reaction(
    label = 'reaction32',
    reactants = ['CH2(17)(18)', 'CH3CO(55)(54)'],
    products = ['S(341)(340)'],
...
reaction(
    label = 'reaction33',
    reactants = ['OH(5)(5)', 'H2CCCH2(838)'],
    products = ['S(374)(373)'],
    transitionState = 'TS33',
    kinetics = Arrhenius(A=(41610,'cm^3/(mol*s)'), n=2.487, Ea=(0,'kcal/mol'), T0=(1,'K'), comment="""Matched reaction 214 C3H4 + OH <=> C3H5O-7 in R_Addition_MultipleBond/training
This reaction matched rate rule [Ca_Cds-HH;OJ_pri]
family: R_Addition_MultipleBond
...
reaction(
    label = 'reaction37',
    reactants = ['H(3)(3)', '[CH]=C([CH2])O(3731)'],
    products = ['S(374)(373)'],
...
reaction(
    label = 'reaction39',
    reactants = ['CH2(17)(18)', 'CH2COH(1431)'],
    products = ['S(374)(373)'],
...
network(
    ...
    reactants = [
        ('H(3)(3)', 'C3H4O(113)(112)'),
        ('HCO(14)(15)', 'C2H4(19)(20)'),
        ('H(3)(3)', 'C3H4O(116)(115)'),
        ('CO(10)(11)', 'C2H5(27)(28)'),
        ('CH2(17)(18)', 'CH2CHO(38)(39)'),
        ('H(3)(3)', 'C3H4O(121)(120)'),
        ('CH3(15)(16)', 'CH2CO(26)(27)'),
        ('CH2(S)(21)(22)', 'CH3CO(55)(54)'),
        ('H(3)(3)', 'C3H4O(122)(121)'),
        ('CH2(S)(21)(22)', 'CH2CHO(38)(39)'),
        ('CH2(17)(18)', 'CH3CO(55)(54)'),
    ],
    bathGas = {
        'Ne': 0.333333,
        'N2': 0.333333,
