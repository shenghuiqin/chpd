...
species(
    ...
    molecularWeight = (117.166,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.282418,0.0884878,-7.43525e-05,3.76722e-08,-8.63044e-12,-12612.3,30.8718], Tmin=(100,'K'), Tmax=(986.596,'K')), NASAPolynomial(coeffs=[8.12488,0.0566916,-2.60099e-05,5.00587e-09,-3.52862e-13,-14159.8,-6.85768], Tmin=(986.596,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-105.931,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(478.082,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(C2CsJOOH)"""),
)

species(
    label = 'CCC[CH]C(C)OO(7195)',
    ...
    molecularWeight = (117.166,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0674695,0.0894758,-7.14795e-05,3.14599e-08,-5.94017e-12,-10976.1,33.6349], Tmin=(100,'K'), Tmax=(1207.15,'K')), NASAPolynomial(coeffs=[12.0607,0.0497355,-2.2099e-05,4.18906e-09,-2.9246e-13,-13871.6,-26.4836], Tmin=(1207.15,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-92.415,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(478.082,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJCOOH)"""),
)
...
species(
    ...
    molecularWeight = (117.166,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.350009,0.0869632,-7.4803e-05,4.07743e-08,-1.02354e-11,-11705.6,32.9032], Tmin=(100,'K'), Tmax=(903.565,'K')), NASAPolynomial(coeffs=[6.93444,0.0578144,-2.64132e-05,5.07129e-09,-3.56967e-13,-12895.5,1.80482], Tmin=(903.565,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-98.3716,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(478.082,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJCC)"""),
)
...
species(
    label = 'CCCC[C](C)O[O](7197)',
    structure = SMILES('CCCC[C](C)O[O]'),
    E0 = (46.0739,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,360,370,350,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.59251,0.083396,-6.79097e-05,2.01453e-08,7.43435e-12,5656.24,30.5701], Tmin=(100,'K'), Tmax=(582.545,'K')), NASAPolynomial(coeffs=[6.302,0.0555302,-2.5352e-05,4.85215e-09,-3.40493e-13,4798.65,4.45907], Tmin=(582.545,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(46.0739,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(C2CsJOOH)"""),
)
...
species(
    label = 'CCC[CH]C(C)O[O](7198)',
    structure = SMILES('CCC[CH]C(C)O[O]'),
    E0 = (59.5897,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,3025,407.5,1350,352.5,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,1380,1390,370,380,2900,435,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (116.158,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.308412,0.0859854,-7.59049e-05,3.98101e-08,-9.14847e-12,7295.91,33.5422], Tmin=(100,'K'), Tmax=(1004.86,'K')), NASAPolynomial(coeffs=[9.3347,0.0500549,-2.22701e-05,4.22656e-09,-2.95649e-13,5481.87,-10.0482], Tmin=(1004.86,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(59.5897,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJCOOH) + radical(ROOJ)"""),
)
...
species(
    ...
    molecularWeight = (116.158,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.16936,0.0735425,-2.25942e-05,-7.84454e-08,8.39522e-11,6541.03,30.8931], Tmin=(100,'K'), Tmax=(482.859,'K')), NASAPolynomial(coeffs=[5.54337,0.0558557,-2.52681e-05,4.79761e-09,-3.34335e-13,5902.4,10.7365], Tmin=(482.859,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(53.6331,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(RCCJCC)"""),
)
...
species(
    ...
    molecularWeight = (116.158,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.376145,0.0853683,-8.34991e-05,5.4468e-08,-1.60332e-11,6574.52,33.7328], Tmin=(100,'K'), Tmax=(794.089,'K')), NASAPolynomial(coeffs=[6.62653,0.0538849,-2.40305e-05,4.54378e-09,-3.16392e-13,5581.81,5.01912], Tmin=(794.089,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(53.621,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(RCCJC)"""),
)
...
species(
    label = 'CCCC(C)O[O](7201)',
    structure = SMILES('CCCC(C)O[O]'),
    E0 = (-117.045,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,1380,1390,370,380,2900,435,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,362.928,362.928],'cm^-1')),
        HinderedRotor(inertia=(0.0904756,'amu*angstrom^2'), symmetry=1, barrier=(8.45667,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0904756,'amu*angstrom^2'), symmetry=1, barrier=(8.45667,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0904757,'amu*angstrom^2'), symmetry=1, barrier=(8.45667,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0904757,'amu*angstrom^2'), symmetry=1, barrier=(8.45667,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0904757,'amu*angstrom^2'), symmetry=1, barrier=(8.45667,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    ...
    molecularWeight = (103.14,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.819521,0.0706875,-5.22391e-05,2.12644e-08,-3.71969e-12,-13963.6,27.1405], Tmin=(100,'K'), Tmax=(1290.5,'K')), NASAPolynomial(coeffs=[10.5251,0.0406044,-1.72721e-05,3.20061e-09,-2.20297e-13,-16468.6,-22.1584], Tmin=(1290.5,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-117.045,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ)"""),
)
...
species(
    ...
    E0 = (-76.3276,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,2995,3025,975,1000,1300,1375,400,500,1630,1680,251.279,251.483],'cm^-1')),
        HinderedRotor(inertia=(0.00266822,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.210079,'amu*angstrom^2'), symmetry=1, barrier=(9.42702,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.209811,'amu*angstrom^2'), symmetry=1, barrier=(9.42671,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.210059,'amu*angstrom^2'), symmetry=1, barrier=(9.42744,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (84.1595,'amu'),
...
reaction(
    label = 'reaction8',
    reactants = ['C4H9(68)(67)', 'C[CH]O[O](1429)'],
    products = ['S(90)(89)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['CH3(15)(16)', 'CCCC[CH]O[O](3988)'],
    products = ['S(90)(89)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(3)(3)', 'CCCC[C](C)O[O](7197)'],
    products = ['S(90)(89)'],
...
reaction(
    label = 'reaction11',
    reactants = ['C3H7(69)(68)', '[CH2]C(C)O[O](3941)'],
    products = ['S(90)(89)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(3)(3)', 'CCC[CH]C(C)O[O](7198)'],
    products = ['S(90)(89)'],
...
reaction(
    label = 'reaction13',
    reactants = ['C2H5(27)(28)', '[CH2]CC(C)O[O](3943)'],
    products = ['S(90)(89)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(3)(3)', 'CC[CH]CC(C)O[O](7199)'],
    products = ['S(90)(89)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CH3(15)(16)', '[CH2]CCC(C)O[O](3944)'],
    products = ['S(90)(89)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(3)(3)', 'C[CH]CCC(C)O[O](7200)'],
    products = ['S(90)(89)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(3)(3)', '[CH2]C(CCCC)O[O](3994)'],
    products = ['S(90)(89)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(3)(3)', '[CH2]CCCC(C)O[O](3947)'],
    products = ['S(90)(89)'],
...
reaction(
    label = 'reaction20',
    reactants = ['CH2(S)(21)(22)', 'CCCC(C)O[O](7201)'],
    products = ['S(90)(89)'],
...
reaction(
    label = 'reaction23',
    reactants = ['O(4)(4)', 'CCCCC(C)[O](5378)'],
    products = ['S(90)(89)'],
