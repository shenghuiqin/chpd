...
species(
    label = '[CH2]C(C)CCC(4203)',
    structure = SMILES('[CH2]C(C)CCC'),
    E0 = (7.5235,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,180,3558.52],'cm^-1')),
        HinderedRotor(inertia=(3.66618,'amu*angstrom^2'), symmetry=1, barrier=(84.2927,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00489422,'amu*angstrom^2'), symmetry=1, barrier=(2.9551,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.12853,'amu*angstrom^2'), symmetry=1, barrier=(2.95515,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.627375,'amu*angstrom^2'), symmetry=1, barrier=(14.4246,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.627369,'amu*angstrom^2'), symmetry=1, barrier=(14.4244,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (85.1674,'amu'),
...
species(
    ...
    molecularWeight = (84.1595,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.559608,0.065392,-4.03687e-05,1.25377e-08,-1.57984e-12,30964.4,26.3799], Tmin=(100,'K'), Tmax=(1818.32,'K')), NASAPolynomial(coeffs=[16.4428,0.030452,-1.15458e-05,1.97027e-09,-1.2694e-13,25188.2,-59.7446], Tmin=(1818.32,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(256.351,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJ2_triplet)"""),
)
...
reaction(
    label = 'reaction17',
    reactants = ['H(3)(3)', 'CC=CCCC(4201)'],
    products = ['C6H13(81)(80)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction19',
    reactants = ['C3H7(69)(68)', 'C3H6(83)(82)'],
    products = ['C6H13(81)(80)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction21',
    reactants = ['C2H5(27)(28)', '[CH2]C[CH]C(1012)'],
    products = ['C6H13(81)(80)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction22',
    reactants = ['C3H7(69)(68)', 'C3H6(T)(1015)'],
    products = ['C6H13(81)(80)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction23',
    reactants = ['H(3)(3)', 'C[CH]C[CH]CC(3551)'],
    products = ['C6H13(81)(80)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction24',
    reactants = ['CH3(15)(16)', '[CH2]CC[CH]C(1013)'],
    products = ['C6H13(81)(80)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction25',
    reactants = ['H(3)(3)', 'C[CH]CC[CH]C(3552)'],
    products = ['C6H13(81)(80)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction26',
    reactants = ['H(3)(3)', 'C[CH][CH]CCC(4202)'],
    products = ['C6H13(81)(80)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction27',
    reactants = ['H(3)(3)', '[CH2]CCC[CH]C(1016)'],
    products = ['C6H13(81)(80)'],
...
reaction(
    label = 'reaction28',
    reactants = ['H(3)(3)', '[CH2][CH]CCCC(1029)'],
    products = ['C6H13(81)(80)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CH2(S)(21)(22)', 'C[CH]CCC(4187)'],
    products = ['C6H13(81)(80)'],
...
reaction(
    label = 'reaction31',
    reactants = ['C4H9(68)(67)', 'CHCH3(T)(1022)'],
    products = ['C6H13(81)(80)'],
...
reaction(
    label = 'reaction32',
    reactants = ['CH3(15)(16)', '[CH]CCCC(1033)'],
    products = ['C6H13(81)(80)'],
...
reaction(
    label = 'reaction2',
    reactants = ['C4H9(68)(67)', 'C2H4(19)(20)'],
    products = ['C6H13(78)(77)'],
...
reaction(
    label = 'reaction3',
    reactants = ['C3H7(69)(68)', '[CH2]C[CH2](1090)'],
    products = ['C6H13(78)(77)'],
...
reaction(
    label = 'reaction4',
    reactants = ['C2H5(27)(28)', '[CH2]CC[CH2](1088)'],
    products = ['C6H13(78)(77)'],
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)(3)', '[CH2]CC[CH]CC(1028)'],
    products = ['C6H13(78)(77)'],
...
reaction(
    label = 'reaction6',
    reactants = ['C4H9(68)(67)', 'C2H4(T)(890)'],
    products = ['C6H13(78)(77)'],
...
reaction(
    label = 'reaction7',
    reactants = ['H(3)(3)', '[CH2]C[CH]CCC(1002)'],
    products = ['C6H13(78)(77)'],
...
reaction(
    label = 'reaction8',
    reactants = ['CH3(15)(16)', '[CH2]CCC[CH2](1089)'],
    products = ['C6H13(78)(77)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(3)(3)', '[CH2]CCCC[CH2](1091)'],
    products = ['C6H13(78)(77)'],
...
reaction(
    label = 'reaction31',
    reactants = ['C5H11(67)(66)', 'CH2(S)(21)(22)'],
    products = ['C6H13(78)(77)'],
...
reaction(
    label = 'reaction15',
    reactants = ['C5H11(67)(66)', 'CH2(17)(18)'],
    products = ['C6H13(78)(77)'],
...
network(
    ...
    reactants = [
        ('H(3)(3)', 'C6H12(79)(78)'),
        ('C3H7(69)(68)', 'C3H6(83)(82)'),
        ('C4H9(68)(67)', 'C2H4(19)(20)'),
        ('C5H11(67)(66)', 'CH2(S)(21)(22)'),
        ('C5H11(67)(66)', 'CH2(17)(18)'),
    ],
    bathGas = {
        'Ne': 0.333333,
        'N2': 0.333333,
