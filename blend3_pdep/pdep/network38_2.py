species(
    ...
    E0 = (216.716,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2950,3100,1380,975,1025,1650,2995,3010,3025,975,987.5,1000,1300,1337.5,1375,400,450,500,1630,1655,1680,3000,3100,440,815,1455,1000,312.708,312.714,312.765],'cm^-1')),
        HinderedRotor(inertia=(0.00172359,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.215109,'amu*angstrom^2'), symmetry=1, barrier=(14.9295,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.215159,'amu*angstrom^2'), symmetry=1, barrier=(14.9295,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.215114,'amu*angstrom^2'), symmetry=1, barrier=(14.9293,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
species(
    ...
    molecularWeight = (95.1622,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.3049,0.0412566,4.1902e-05,-7.98689e-08,3.22902e-11,32634.8,26.5557], Tmin=(100,'K'), Tmax=(983.085,'K')), NASAPolynomial(coeffs=[14.2021,0.0327353,-1.21627e-05,2.27489e-09,-1.64878e-13,27975,-46.2484], Tmin=(983.085,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(270.401,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(419.881,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cyclobutene) + radical(RCCJ)"""),
)

species(
    label = 'C=C[CH]C1CCC1(1225)',
    ...
    molecularWeight = (95.1622,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.51949,0.0313195,7.83171e-05,-1.21381e-07,4.77595e-11,24356.7,24.8794], Tmin=(100,'K'), Tmax=(967.699,'K')), NASAPolynomial(coeffs=[15.7249,0.0306975,-1.07722e-05,2.03436e-09,-1.51734e-13,18887.2,-57.2422], Tmin=(967.699,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(201.596,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(424.038,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cyclobutane) + radical(Allyl_P)"""),
)

species(
    label = '[CH2]C1C=CCCC1(1053)',
    structure = SMILES('[CH2]C1C=CCCC1'),
    E0 = (152.061,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2800,2850,2900,2950,3000,3050,3100,3150,900,925,950,975,1000,1025,1050,1075,1100,300,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
...
species(
    label = 'C=CC=C[CH]CC(1227)',
    structure = SMILES('[CH2]C=CC=CCC'),
    E0 = (117.28,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,2995,3005,3015,3025,975,983.333,991.667,1000,1300,1325,1350,1375,400,433.333,466.667,500,1630,1646.67,1663.33,1680,308.53,649.143],'cm^-1')),
        HinderedRotor(inertia=(0.71581,'amu*angstrom^2'), symmetry=1, barrier=(16.4579,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.715357,'amu*angstrom^2'), symmetry=1, barrier=(16.4475,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.306881,'amu*angstrom^2'), symmetry=1, barrier=(94.8392,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.716415,'amu*angstrom^2'), symmetry=1, barrier=(16.4718,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (95.1622,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.953835,0.0518394,1.42961e-05,-5.37079e-08,2.39199e-11,14228.8,27.0107], Tmin=(100,'K'), Tmax=(975.282,'K')), NASAPolynomial(coeffs=[14.5098,0.0324682,-1.16282e-05,2.09938e-09,-1.48485e-13,9861.7,-46.8825], Tmin=(975.282,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(117.28,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(415.724,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + radical(C=CC=CCJ)"""),
)

species(
    label = 'C=CC=[C]CCC(1228)',
    structure = SMILES('C=CC=[C]CCC'),
    E0 = (249.312,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,1685,370,2950,3100,1380,975,1025,1650,2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,300.474,300.474,300.474],'cm^-1')),
        HinderedRotor(inertia=(0.202887,'amu*angstrom^2'), symmetry=1, barrier=(12.9985,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.202887,'amu*angstrom^2'), symmetry=1, barrier=(12.9985,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.202887,'amu*angstrom^2'), symmetry=1, barrier=(12.9985,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.202887,'amu*angstrom^2'), symmetry=1, barrier=(12.9985,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (95.1622,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.532369,0.0658056,-3.131e-05,-3.47447e-09,5.33134e-12,30119.1,27.8799], Tmin=(100,'K'), Tmax=(1057.22,'K')), NASAPolynomial(coeffs=[14.2362,0.0334118,-1.2952e-05,2.35523e-09,-1.63184e-13,26134.2,-44.1377], Tmin=(1057.22,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(249.312,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(415.724,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + radical(Cds_S)"""),
)

species(
    label = 'C=C[C]=CCCC(1229)',
...
species(
    label = '[CH]=CC=CCCC(1231)',
    structure = SMILES('[CH]=CC=CCCC'),
    E0 = (258.566,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3120,650,792.5,1650,2995,3010,3025,975,987.5,1000,1300,1337.5,1375,400,450,500,1630,1655,1680,212.233,215.542],'cm^-1')),
        HinderedRotor(inertia=(0.434877,'amu*angstrom^2'), symmetry=1, barrier=(14.2242,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.433838,'amu*angstrom^2'), symmetry=1, barrier=(14.2368,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.440427,'amu*angstrom^2'), symmetry=1, barrier=(14.2124,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.42544,'amu*angstrom^2'), symmetry=1, barrier=(14.2208,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (95.1622,'amu'),
...
species(
    ...
    molecularWeight = (95.1622,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.01074,0.0211629,9.54731e-05,-1.32332e-07,5.0204e-11,21153.8,26.0226], Tmin=(100,'K'), Tmax=(969.137,'K')), NASAPolynomial(coeffs=[12.8137,0.0335706,-1.19474e-05,2.24597e-09,-1.65873e-13,16383.3,-39.5659], Tmin=(969.137,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(175.118,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(428.195,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Cyclopentane) + radical(Cs_S)"""),
)
...
species(
    ...
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.549838,0.0638586,-2.48033e-05,-1.43747e-08,1.03329e-11,55422.1,28.3458], Tmin=(100,'K'), Tmax=(1003.62,'K')), NASAPolynomial(coeffs=[15.9201,0.0284975,-1.06606e-05,1.943e-09,-1.36721e-13,51032.6,-52.3606], Tmin=(1003.62,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(459.685,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(390.78,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + radical(CCJ2_triplet)"""),
)

species(
    label = 'C1=CCCCCC=1(1049)',
...
reaction(
    label = 'reaction15',
    reactants = ['H(3)(3)', 'C7H10(409)(408)'],
    products = ['C7H11(410)(409)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction16',
    reactants = ['C2H4(19)(20)', 'C5H7(211)(210)'],
    products = ['C7H11(410)(409)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction23',
    reactants = ['C5H7(211)(210)', 'C2H4(T)(890)'],
    products = ['C7H11(410)(409)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction24',
    reactants = ['CH2CHCHCH(913)', '[CH2]C[CH2](1090)'],
    products = ['C7H11(410)(409)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction26',
    reactants = ['H(3)(3)', '[CH2][CH]C=CCC=C(905)'],
    products = ['C7H11(410)(409)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction27',
    reactants = ['H(3)(3)', '[CH2]CC[C]=CC=C(910)'],
    products = ['C7H11(410)(409)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction28',
    reactants = ['C2H3(28)(29)', '[CH]=CCC[CH2](1232)'],
    products = ['C7H11(410)(409)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction29',
    reactants = ['H(3)(3)', '[CH2]CCC=[C]C=C(911)'],
    products = ['C7H11(410)(409)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction30',
    reactants = ['H(3)(3)', '[CH2]CCC=C[C]=C(912)'],
    products = ['C7H11(410)(409)'],
...
reaction(
    label = 'reaction31',
    reactants = ['H(3)(3)', '[CH]=CC=CCC[CH2](856)'],
    products = ['C7H11(410)(409)'],
...
reaction(
    label = 'reaction33',
    reactants = ['C7H11(410)(409)'],
    products = ['[CH2]CC=CC=CC(1234)'],
...
reaction(
    label = 'reaction35',
    reactants = ['CH2(17)(18)', '[CH2]CC=CC=C(1236)'],
    products = ['C7H11(410)(409)'],
...
reaction(
    label = 'reaction36',
    reactants = ['H(3)(3)', '[CH]CCC=CC=C(1237)'],
    products = ['C7H11(410)(409)'],
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)(3)', 'C1=CCCCCC=1(1049)'],
    products = ['C7H11(427)(426)'],
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)(3)', '[CH]1C=CCC[CH]C1(847)'],
    products = ['C7H11(427)(426)'],
...
reaction(
    label = 'reaction32',
    reactants = ['H(3)(3)', '[CH]1C=C[CH]CCC1(852)'],
    products = ['C7H11(427)(426)'],
...
reaction(
    label = 'reaction33',
    reactants = ['H(3)(3)', '[C]1=C[CH]CCCC1(851)'],
    products = ['C7H11(427)(426)'],
...
reaction(
    label = 'reaction6',
    reactants = ['H(3)(3)', '[C]1[CH]CCCCC=1(853)'],
    products = ['C7H11(427)(426)'],
...
reaction(
    label = 'reaction10',
    reactants = ['C7H11(427)(426)'],
    products = ['[CH]1C2CCCCC12(1052)'],
