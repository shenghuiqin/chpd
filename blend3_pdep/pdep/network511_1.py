...
species(
    label = '[CH]=CCC(=O)CC=[CH](2593)',
    structure = SMILES('[CH]=CCC(=O)CC=[CH]'),
    E0 = (430.95,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,375,552.5,462.5,1710,3115,3125,620,680,785,800,1600,1700,2995,3025,975,1000,1300,1375,400,500,1630,1680,365.927,373.42],'cm^-1')),
        HinderedRotor(inertia=(0.00128279,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.204101,'amu*angstrom^2'), symmetry=1, barrier=(19.654,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.203403,'amu*angstrom^2'), symmetry=1, barrier=(19.6658,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.207438,'amu*angstrom^2'), symmetry=1, barrier=(19.6007,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (108.138,'amu'),
...
reaction(
    label = 'reaction1223',
    reactants = ['H(3)(3)', 'O=C1C[C]=CC=CC1(2586)'],
    products = ['C7H8O(679)(678)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction1224',
    reactants = ['H(3)(3)', 'O=C1CC=[C]C=CC1(2587)'],
    products = ['C7H8O(679)(678)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction1230',
    reactants = ['O[C]1C[C]=CC=CC1(2130)'],
    products = ['C7H8O(679)(678)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction1231',
    reactants = ['O=C1C[C]=C[CH]CC1(2589)'],
    products = ['C7H8O(679)(678)'],
...
reaction(
    label = 'reaction1235',
    reactants = ['O[C]1CC=[C]C=CC1(2132)'],
    products = ['C7H8O(679)(678)'],
...
reaction(
    label = 'reaction1236',
    reactants = ['O=C1CC=[C][CH]CC1(2591)'],
    products = ['C7H8O(679)(678)'],
...
reaction(
    label = 'reaction1239',
    reactants = ['C1=CC2CC23CC1O3(2592)'],
    products = ['C7H8O(679)(678)'],
...
reaction(
    label = 'reaction1241',
    reactants = ['[CH]=CC=CCC([CH2])=O(2594)'],
    products = ['C7H8O(679)(678)'],
...
reaction(
    label = 'reaction1242',
    reactants = ['[CH2]C=CC=CC[C]=O(2595)'],
    products = ['C7H8O(679)(678)'],
