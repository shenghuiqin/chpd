...
reaction(
    label = 'reaction1',
    reactants = ['C2H5O(41)(41)'],
    products = ['H(3)(3)', 'C2H4O(40)(40)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['C2H5O(53)(52)'],
    products = ['C2H5O(41)(41)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction6',
    reactants = ['CH2(17)(18)', 'CH2OH(22)(23)'],
    products = ['C2H5O(41)(41)'],
    transitionState = 'TS6',
...
This reaction matched rate rule [R2H_S;C_rad_out_H/NonDeC;O_H_out]
family: intra_H_migration"""),
)

reaction(
    label = 'reaction11',
    reactants = ['H(3)(3)', 'C2H4O(197)(196)'],
    products = ['C2H5O(53)(52)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CH3(15)(16)', 'HCOH(T)(1710)'],
    products = ['C2H5O(53)(52)'],
...
reaction(
    label = 'reaction17',
    reactants = ['C2H5O(36)(37)'],
    products = ['CH2O(13)(14)', 'CH3(15)(16)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CH3(15)(16)', '[CH2][O](3706)'],
    products = ['C2H5O(36)(37)'],
...
reaction(
    label = 'reaction21',
    reactants = ['CH2(S)(21)(22)', 'CH3O(23)(24)'],
    products = ['C2H5O(36)(37)'],
...
network(
    ...
    reactants = [
        ('H(3)(3)', 'C2H4O(40)(40)'),
        ('CH2(17)(18)', 'CH2OH(22)(23)'),
        ('H(3)(3)', 'CH3CHO(35)(36)'),
        ('H(3)(3)', 'C2H4O(197)(196)'),
        ('CH2O(13)(14)', 'CH3(15)(16)'),
        ('CH2(S)(21)(22)', 'CH3O(23)(24)'),
        ('O(4)(4)', 'C2H5(27)(28)'),
    ],
    bathGas = {
        'Ne': 0.333333,
