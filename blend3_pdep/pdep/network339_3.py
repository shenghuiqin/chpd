...
species(
    ...
    E0 = (-183.391,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,257.148],'cm^-1')),
        HinderedRotor(inertia=(0.00255052,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (47.0333,'amu'),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.97309,0.0426372,-5.84444e-05,4.12219e-08,-1.13585e-11,-21382.8,32.869], Tmin=(298,'K'), Tmax=(1000,'K')), NASAPolynomial(coeffs=[3.64142,0.0146739,-8.24143e-06,2.2479e-09,-2.38671e-13,-22230.4,7.15858], Tmin=(1000,'K'), Tmax=(3000,'K'))], Tmin=(298,'K'), Tmax=(3000,'K'), E0=(-183.391,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(128.874,'J/(mol*K)'), label="""HOCH2O""", comment="""Thermo library: Klippenstein_Glarborg2016"""),
)
...
species(
    ...
    E0 = (5.37818,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,3025,407.5,1350,352.5,1989.73],'cm^-1')),
        HinderedRotor(inertia=(0.0937211,'amu*angstrom^2'), symmetry=1, barrier=(2.15483,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (46.0254,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.40206,0.0209568,-4.96189e-05,5.95336e-08,-2.44625e-11,660.881,10.3083], Tmin=(100,'K'), Tmax=(868.745,'K')), NASAPolynomial(coeffs=[-0.343287,0.0179326,-9.40009e-06,1.81363e-09,-1.23837e-13,2076.5,32.2526], Tmin=(868.745,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(5.37818,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(103.931,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-OsOsHH) + radical(OCOJ) + radical(OCJO)"""),
)
...
reaction(
    ...
    products = ['H(3)(3)', 'HOCHO(57)(56)'],
    transitionState = 'TS11',
    kinetics = Arrhenius(A=(1e+14,'s^-1'), n=0, Ea=(14900,'cal/mol'), T0=(1,'K'), comment="""Reaction library: 'Klippenstein_Glarborg2016'"""),
)
...
reaction(
    ...
    kinetics = Arrhenius(A=(6.3e+06,'cm^3/(mol*s)'), n=1.63, Ea=(4282,'cal/mol'), T0=(1,'K'), comment="""Reaction library: 'Klippenstein_Glarborg2016'"""),
)

reaction(
    label = 'reaction13',
    reactants = ['HOCH2O(63)(62)'],
    products = ['O[CH]O(3707)'],
